var Fi=Object.defineProperty;var Ri=(e,a,r)=>a in e?Fi(e,a,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[a]=r;var Xn=(e,a,r)=>Ri(e,typeof a!="symbol"?a+"":a,r);import{r as p,u as Oi,a as Mi,b as Di,R as ba,L as Ii,j as t,P as Ja,f as Zn,p as Te,c as Pi,d as _i,C as er,e as Bi,g as $i,l as Xa,o as Aa,i as wo,h as Ui,k as Hi,m as Vi,n as tr,q as Wi,s as ar,t as nr,v as rr,w as Gi,x as Yi,y as Qi,z as Ki,A as Ji,S as ha,B as Xi,D as yo,E as _e,F as Mn,G as ut,H as Ft,I as ko,J as Zi,K as es,M as Eo,N as Ra,O as ts,_ as hn,Q as as,T as ns,U as rs,V as Ue,W as os,X as is,Y as Ct,Z as ss,$ as Qt,a0 as ls,a1 as ds,a2 as ps,a3 as Dn,a4 as or,a5 as ir,a6 as Kt,a7 as gn,a8 as Ot,a9 as tt,aa as sr,ab as cs,ac as us,ad as ms,ae as lr,af as In,ag as jo,ah as No,ai as Qa,aj as fs,ak as So,al as hs,am as gs,an as zo,ao as xs,ap as bs,aq as vs,ar as ws,as as ys,at as Vt,au as ga,av as Oa,aw as ks,ax as Co,ay as dr,az as Pt,aA as Es,aB as Ao,aC as qo,aD as pr,aE as js,aF as Ns,aG as la,aH as xn,aI as Ss,aJ as zs,aK as Cs,aL as cr,aM as As,aN as qs,aO as To,aP as Lo,aQ as Ma,aR as Ts,aS as Pn,aT as Ls,aU as Fs,aV as ur,aW as Rs,aX as Za,aY as Fo,aZ as Ro,a_ as mr,a$ as Os,b0 as Ms,b1 as wt,b2 as Ds,b3 as fr,b4 as Is,b5 as Ps,b6 as hr,b7 as _s,b8 as Bs,b9 as gr,ba as $s,bb as Us,bc as Hs,bd as Vs,be as Ws,bf as Gs,bg as Ys,bh as Qs,bi as xr,bj as Ks,bk as Js,bl as Xs,bm as Zs,bn as en,bo as el,bp as tl,bq as al}from"./index-246UfLD7.js";const nl=({filloutId:e,domain:a,inheritParameters:r,parameters:n,dynamicResize:o,onInit:i,onPageChange:d,onSubmit:s})=>{const[l,f]=p.useState(!0),c=Oi({filloutId:e,domain:a,inheritParameters:r,parameters:n,dynamicResize:o});Mi(c,{onInit:i,onPageChange:d,onSubmit:s});const[g,u]=p.useState();return Di(c,"form_resized",b=>{const h=b.size;typeof h=="number"&&u(h)},{disabled:!o}),ba.createElement("div",{className:"fillout-standard-embed",style:{height:o?typeof g=="number"?g:256:"100%",transition:o?"height 150ms ease":void 0}},l&&ba.createElement("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",width:"100%",height:"100%",minHeight:256}},ba.createElement(Ii,null)),c&&ba.createElement("iframe",{src:c.iframeUrl,allow:"microphone; camera; geolocation",title:"Embedded Form",onLoad:()=>f(!1),style:{width:l?0:"100%",height:l?0:"100%",opacity:l?0:1,borderRadius:10,border:0,minHeight:256}}))};function $e(e){return(e||"").trim().toLowerCase()}function rl(e,a){const r=Math.max(60,a*60);return Math.max(2,Math.min(97,Math.round(e/r*100)))}function br(e){const a=Math.max(0,Math.floor(e)),r=Math.floor(a/60),n=a%60;return r+":"+String(n).padStart(2,"0")}function ol(e){const a=new Date(e);return String(a.getHours()).padStart(2,"0")+":"+String(a.getMinutes()).padStart(2,"0")}const il=300;function Da({item:e,serverOff:a,bootLbl:r,endLabel:n}){const[o,i]=p.useState(()=>Date.now()/1e3);p.useEffect(()=>{const u=window.setInterval(()=>i(Date.now()/1e3),1e3);return()=>window.clearInterval(u)},[]);const d=e.memoType==="detailed"?"mémo détaillé ~"+(e.estMin||40)+" min":"mémo éclair ~"+(e.estMin||15)+" min";if(e.status==="boot"||!(e.started>0)){const u=o-(e.started||o);return u>il?t.jsx("span",{className:"runerr",children:"⚠ le moteur n'a pas pris le dossier ("+Math.round(u/60)+" min) — relancez l'analyse"}):t.jsxs("span",{className:"runtrack boot",children:[t.jsx("span",{className:"runchrono",children:r+" · "+d+(u>20?" · "+br(u):"")}),t.jsx("span",{className:"runbar",children:t.jsx("i",{className:"ind"})})]})}if(e.status==="error")return t.jsx("span",{className:"runerr",children:e.error||"erreur"});if(e.status==="done")return t.jsx("span",{className:"rundone",children:"✓"});const s=o-a-e.started,l=e.estMin||15,f=l*60-s,c=rl(s,l),g=f>0&&n?" · "+n.replace("{t}",ol((e.started+l*60+a)*1e3)):"";return t.jsxs("span",{className:"runtrack",children:[t.jsx("span",{className:"runchrono",children:d+" · ⏱ "+br(s)+" · "+c+"%"+(f>0?" · reste ~"+Math.ceil(f/60)+" min":" · …")+g}),!!e.note&&t.jsx("span",{className:"runnote",children:e.note}),t.jsx("span",{className:"runbar",children:t.jsx("i",{style:{width:c+"%"}})})]})}function sl({items:e,serverOff:a,labels:r,onOpen:n}){const o=e.filter(i=>i.status!=="done"||Date.now()/1e3-(i.started||0)<1200);return o.length?t.jsxs("div",{className:"livestrip",role:"button",onClick:n,title:r.open,children:[t.jsx("span",{className:"ls-ico",children:"⚡"}),t.jsx("span",{className:"ls-lab",children:r.strip}),o.slice(0,6).map(i=>t.jsxs("span",{className:"ls-chip"+(i.status==="error"?" err":i.status==="done"?" done":""),children:[t.jsx("b",{children:i.name}),i.status==="done"&&i.url?t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:r.memo}):t.jsx(Da,{item:i,serverOff:a,bootLbl:r.boot,endLabel:r.end})]},i.name)),o.length>6&&t.jsxs("span",{className:"ls-more",children:["+",o.length-6]}),t.jsxs("span",{className:"ls-go",children:[r.open," →"]})]}):null}const vr={rss:"RSS",google_news:"Google News",google_alerts:"Google Alerts",pappers_fr:"Pappers FR",crt:"CRT",github:"GitHub",hn:"Hacker News",fundraising:"Fundraising",backfill:"Backfill",websets_engine:"Exa Websets",websets:"Exa Websets",linkedin_posts:"LinkedIn Posts",linkedin_jobs:"LinkedIn Jobs",exa_semantic:"Exa Semantic",exa_similar:"Exa Similar",crunchbase_search:"Crunchbase",other_custom:"Autres (Make sur-mesure)",manual_paste:"Saisie manuelle",find_similar_qualified:"Similaires aux qualifiés",editorial:"Éditorial (médias experts)",daily_news:"Daily news thèse",alumni:"Alumni fondateurs",competitor_exodus:"Départs concurrents",hackernews:"Hacker News",crt_sh:"CRT",pappers:"Pappers FR",pappers_intl:"Pappers International",opencorporates:"OpenCorporates",tavily:"Tavily",registre_gouv:"Registre officiel (gouv)",hunter:"Hunter",sales_nav:"Sales Navigator",sourcing:"Sourcing Proplace",local:"Moteur local (Google Maps + BODACC)"},ll={rss:"Lit chaque matin des centaines de médias et de flux spécialisés pour repérer les sociétés qui bougent dans votre secteur.",editorial:"Suit en continu les médias experts et lettres spécialisées de votre secteur pour repérer les sociétés dont on commence à parler.",google_news:"Balaie l'actualité mondiale en continu pour capter les sociétés qui font parler d'elles (levées, lancements, nominations).",google_alerts:"Surveille des mots-clés précis sur tout le web et remonte chaque société correspondante dès qu'elle apparaît.",pappers_fr:"Interroge les registres officiels français (SIRENE, codes d'activité) pour trouver des sociétés par métier, en temps réel.",crt:"Détecte les toutes nouvelles sociétés dès la mise en ligne de leur site web — un signal très précoce, avant tout le monde.",github:"Détecte les sociétés tech par l'activité de leurs développeurs — un signal très en amont, avant qu'elles ne fassent parler d'elles.",hn:"Scrute Hacker News, le forum de référence des fondateurs tech, pour repérer les projets qui émergent en premier.",fundraising:"Repère les sociétés qui viennent de lever des fonds — le moment précis où elles accélèrent et deviennent intéressantes.",backfill:"Repasse sur les périodes passées pour rattraper les sociétés qui auraient pu passer entre les mailles du filet.",websets:"Construit des listes de sociétés sur mesure à partir d'une simple description, en explorant tout le web.",websets_engine:"Construit des listes de sociétés sur mesure à partir d'une simple description, en explorant tout le web.",linkedin_posts:"Analyse les publications LinkedIn pour repérer les sociétés et dirigeants qui annoncent quelque chose d'intéressant.",linkedin_jobs:"Lit les offres d'emploi LinkedIn : une société qui recrute massivement dans un domaine trahit sa stratégie et sa croissance.",exa_semantic:"Recherche sémantique sur tout le web : vous décrivez ce que vous cherchez en langage naturel, et il trouve les sociétés qui y ressemblent.",exa_similar:"Partez d'une société que vous aimez, et il trouve toutes celles qui lui ressemblent sur le web.",crunchbase_search:"Interroge la base mondiale des startups et de leurs financements pour trouver des sociétés par profil.",other_custom:"Moteurs branchés spécialement pour votre thèse — chaque signal utile peut devenir un moteur sur mesure.",manual_paste:"Les sociétés que vous ajoutez vous-même à la main, évaluées selon vos critères exactement comme les autres.",find_similar_qualified:"Part des sociétés que vous avez déjà retenues pour en trouver d'autres, très proches, partout sur le web.",daily_news:"Relit l'actualité du jour à travers le prisme exact de votre thèse pour n'en garder que ce qui vous concerne.",alumni:"Suit les diplômés des meilleures écoles pour repérer ceux qui viennent de fonder une société.",competitor_exodus:"Détecte les départs de talents des sociétés concurrentes — souvent le signe d'une nouvelle société en création.",hackernews:"Scrute Hacker News, le forum de référence des fondateurs tech, pour repérer les projets qui émergent en premier.",crt_sh:"Détecte les toutes nouvelles sociétés dès la mise en ligne de leur site web — un signal très précoce, avant tout le monde.",pappers:"Interroge les registres officiels français (SIRENE, codes d'activité) pour trouver des sociétés par métier, en temps réel.",pappers_intl:"Interroge les registres d'entreprises internationaux pour trouver des sociétés par pays et par activité, en temps réel.",opencorporates:"Explore la plus grande base mondiale de registres d'entreprises pour retrouver des sociétés officielles partout dans le monde.",tavily:"Recherche web en temps réel : interroge tout le web à la volée pour capter les sociétés qui collent à votre thèse.",registre_gouv:"Interroge le registre officiel des entreprises françaises (recherche-entreprises) pour trouver des sociétés par activité.",local:"Trouve les commerces de proximité de votre métier, ville par ville. Sur Google Maps : les magasins physiques avec leur note, leurs avis et leur site (tri « leaders » ou « à reprendre »). Via le BODACC officiel : les affaires acquérables — liquidations, ventes & cessions de fonds, cessations (locaux à récupérer). Tourne à la demande (Google Maps payant) ; option radar quotidien gratuit via BODACC.",hunter:"Retrouve les coordonnées professionnelles des sociétés (emails, domaines) pour identifier les bons interlocuteurs à contacter."},dl={rss:"Reads hundreds of media outlets and specialist feeds every morning to spot the companies moving in your sector.",editorial:"Continuously follows the expert media and specialist newsletters in your sector to catch companies just starting to get noticed.",google_news:"Sweeps world news in real time to catch companies making headlines (raises, launches, appointments).",google_alerts:"Watches precise keywords across the whole web and surfaces every matching company the moment it appears.",pappers_fr:"Queries the official French registries (SIRENE, activity codes) to find companies by line of business, in real time.",crt:"Detects brand-new companies the moment their website goes live — a very early signal, ahead of everyone else.",github:"Detects tech companies from their developers' activity — a very early signal, before they make any noise.",hn:"Scans Hacker News, the go-to forum for tech founders, to catch the projects emerging first.",fundraising:"Spots companies that have just raised funds — the exact moment they accelerate and become interesting.",backfill:"Re-combs past periods to catch companies that might have slipped through the cracks.",websets:"Builds tailored company lists from a simple description, exploring the whole web.",websets_engine:"Builds tailored company lists from a simple description, exploring the whole web.",linkedin_posts:"Reads LinkedIn posts to spot the companies and executives announcing something worth knowing.",linkedin_jobs:"Reads LinkedIn job ads: a company hiring heavily in one area reveals its strategy and its growth.",exa_semantic:"Semantic search across the whole web: describe what you're looking for in plain language, and it finds the companies that match.",exa_similar:"Start from a company you like, and it finds every similar one across the web.",crunchbase_search:"Queries the global database of startups and their funding to find companies by profile.",other_custom:"Engines wired specifically for your thesis — any useful signal can become a custom engine.",manual_paste:"The companies you add yourself by hand, scored against your criteria exactly like the rest.",find_similar_qualified:"Starts from companies you've already kept to find others, very close to them, across the web.",daily_news:"Re-reads today's news through the exact lens of your thesis, keeping only what concerns you.",alumni:"Tracks graduates of top schools to spot those who have just founded a company.",competitor_exodus:"Detects talent leaving competitor companies — often the sign of a new company being born.",hackernews:"Scans Hacker News, the go-to forum for tech founders, to catch the projects emerging first.",crt_sh:"Detects brand-new companies the moment their website goes live — a very early signal, ahead of everyone else.",pappers:"Queries the official French registries (SIRENE, activity codes) to find companies by line of business, in real time.",pappers_intl:"Queries international company registries to find companies by country and activity, in real time.",opencorporates:"Explores the world's largest database of company registries to surface official companies anywhere in the world.",tavily:"Real-time web search: queries the whole web on the fly to catch companies matching your thesis.",registre_gouv:"Queries the official French company register (recherche-entreprises) to find companies by activity.",local:"Finds the main-street businesses in your trade, town by town. On Google Maps: the physical storefronts with their rating, reviews and website (sort 'leaders' or 'turnaround'). Via the official BODACC bulletin: acquirable businesses — insolvencies, sales & transfers of goodwill, closures (premises to take over). Runs on demand (Google Maps is paid); optional free daily BODACC radar.",hunter:"Finds companies' professional contact details (emails, domains) to identify the right people to reach."};function tn(e){const a=(e||"").trim().toLowerCase();if(!a)return"";const r=vr[a]||vr[a+"_engine"];return r||a.replace(/_/g," ").split(" ").filter(Boolean).map(n=>n.charAt(0).toUpperCase()+n.slice(1)).join(" ")}function pl(e,a){const r=(e||"").trim().toLowerCase(),n=a?dl:ll;return n[r]||n[r+"_engine"]||""}const Oo=e=>"cbeng:"+e,cl="",ul=()=>{try{return!!new URL(window.location.href).searchParams.get("preview")}catch{return!1}};function Mo(e){try{const a=JSON.parse(localStorage.getItem(Oo(e))||"null");return a&&typeof a=="object"&&!Array.isArray(a)?a:{}}catch{return{}}}function Do(e,a){if(!ul())try{localStorage.setItem(Oo(e),JSON.stringify(a))}catch{}}const _n=e=>{const a=new Set,r=[];for(const n of e){const o=(n||"").trim();o&&!a.has(o.toLowerCase())&&(a.add(o.toLowerCase()),r.push(o))}return r};function Io(e,a){const r=Mo(e),n={},o={};let i=!1;for(const[d,s]of Object.entries(a)){const l=_n(s||[]);if(!l.length)continue;const f=Array.isArray(r[d])?r[d]:null;if(!f||!f.length){o[d]=l,i=!0;continue}const c=new Set(f.map(u=>u.toLowerCase())),g=l.filter(u=>!c.has(u.toLowerCase()));if(g.length===l.length&&l.length>=5){o[d]=l,i=!0;continue}g.length?n[d]={noms:g}:(o[d]=l,i=!0)}return i&&Do(e,{...r,...o}),n}function Po(e,a){const r=Mo(e);for(const[n,o]of Object.entries(a)){const i=_n(o||[]);i.length&&(r[n]=i)}Do(e,r)}function ml(e){return _n(e).map(a=>a.toLowerCase()).sort().join(cl)}const wr=e=>(Array.isArray(e)?e:[]).map(a=>String(a??"").trim()).filter(Boolean);function fl(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const a=e,r=wr(a.chips),n=wr(a.more);return!r.length&&!n.length?null:{chips:r,more:n,note:typeof a.note=="string"?a.note.trim():"",shared:!!a.shared,example:!!a.example}}function yr(e,a){const r=(e||{})[a]??(e||{})[`${a}_engine`];return fl(r)}function hl(e,a=8){return e?[...e.chips,...e.more].slice(0,a).join(" · "):""}const kr=[["1",1],["7",7],["30",30],["all",90]],gl={exa_semantic:"exa_semantic",exa_similar:"exa_similar",find_similar:"find_similar_qualified",find_similar_qualified:"find_similar_qualified",github:"github",news:"google_news",google_news:"google_news",jobs:"linkedin_jobs",linkedin_jobs:"linkedin_jobs",hn:"hn",hackernews:"hn",crunchbase:"crunchbase_search",crunchbase_search:"crunchbase_search",pappers:"pappers_fr",pappers_fr:"pappers_fr",registre_gouv:"pappers_fr",webset:"websets",websets:"websets",alumni:"alumni",competitor_exodus:"competitor_exodus",backfill:"backfill",manual:"manual_paste",manual_paste:"manual_paste",editorial:"editorial",daily_news:"daily_news",crt:"crt",crt_sh:"crt",rss:"rss",fundraising:"fundraising",local:"local"},xl=e=>gl[String(e||"").toLowerCase().replace(/_engine$/,"")]||"";function bl(e){return e?(Array.isArray(e)?e.map(r=>Number(r)||0):Object.keys(e).sort().map(r=>Number(e[r])||0)).slice(-14):[]}function vl({vals:e}){if(!e.length||!e.some(d=>d>0))return null;const a=Math.max(...e,1),r=56,n=16,o=r/Math.max(e.length-1,1),i=e.map((d,s)=>`${(s*o).toFixed(1)},${(n-d/a*(n-2)).toFixed(1)}`).join(" ");return t.jsx("svg",{className:"se-spark",viewBox:`0 0 ${r} ${n}`,width:r,height:n,"aria-hidden":"true",children:t.jsx("polyline",{points:i,fill:"none",stroke:"currentColor",strokeWidth:"1.5"})})}function wl(){const{t:e,lang:a,data:r,dossiers:n,canWrite:o,flash:i,flashErr:d}=Z(),s=a==="en",l=r.session.token||"",f=r.fund||"",[c,g]=p.useState(!1),[u,b]=p.useState("7"),[h,v]=p.useState({}),[y,m]=p.useState(!1),[w,E]=p.useState(""),[k,j]=p.useState(null),[N,q]=p.useState({}),[T,L]=p.useState(""),[C,O]=p.useState(""),[U,V]=p.useState(""),[I,x]=p.useState(!1),[F,z]=p.useState(""),[$,G]=p.useState({}),S=p.useRef(null),P=p.useRef(null),D=h[u],Q=p.useCallback(async _=>{var ie;const J=((ie=kr.find(([oe])=>oe===_))==null?void 0:ie[1])||7;m(!0),E("");try{const oe=await fetch(`${Ja}/engines-drilldown-batch`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({fund_slug:f,days:J,fund_scoped:!0,token:l,cibles_token:l})}),me=await oe.json();if(!oe.ok||me.error)throw new Error(me.error||`HTTP ${oe.status}`);v(W=>({...W,[_]:me}))}catch(oe){E(String(oe.message||oe))}finally{m(!1)}},[f,l]);p.useEffect(()=>{c&&!h[u]&&!y&&Q(u),c&&!Object.keys(N).length&&o&&Zn(l).then(_=>{const J={};_.forEach(ie=>{ie.engine&&(J[ie.engine]=ie)}),q(J)})},[c,u]),p.useEffect(()=>()=>{P.current&&window.clearInterval(P.current)},[]);const H=p.useMemo(()=>{const _=(D==null?void 0:D.engines)||{};return Object.entries(_).map(([J,ie])=>{const oe=ie.summary||{};return{key:J,sourced:oe.sourced||0,matched:oe.matched||0,noMatch:oe.no_match||0,rate:typeof oe.match_rate=="number"?Math.round(oe.match_rate*(oe.match_rate<=1?100:1)):0,spark:bl(oe.by_day),leads:ie.leads||[]}}).sort((J,ie)=>ie.sourced-J.sourced)},[D]),ce=p.useMemo(()=>{const _={};return H.forEach(J=>{_[J.key]=J.leads.map(ie=>{const oe=(ie.verdicts||[]).reduce((me,W)=>!me||String(W.check_date||"")>String(me.check_date||"")?W:me,null);return((oe==null?void 0:oe.status)||"").trim().toUpperCase()==="MATCH"?(ie.company_name||"").trim():""}).filter(Boolean)}),_},[H]),te=p.useMemo(()=>Object.entries(ce).map(([_,J])=>_+":"+ml(J)).sort().join("|"),[ce]),le=p.useMemo(()=>l?Io(l,ce):{},[l,te]),xe=p.useMemo(()=>Object.values(le).reduce((_,J)=>_+J.noms.length,0),[le]),he=p.useMemo(()=>{const _=new Date().toISOString().slice(0,10),J={};return H.forEach(ie=>{J[ie.key]=ie.leads.map(oe=>{const me=(oe.verdicts||[]).reduce((se,ve)=>!se||String(ve.check_date||"")>String(se.check_date||"")?ve:se,null);return String((me==null?void 0:me.check_date)||"").slice(0,10)===_?(oe.company_name||"").trim():""}).filter(Boolean)}),J},[H]),we=p.useRef(c);p.useEffect(()=>{we.current&&!c&&l&&Po(l,ce),we.current=c},[c]);const pe=p.useMemo(()=>H.reduce((_,J)=>_+J.sourced,0),[H]),Ne=p.useMemo(()=>H.filter(_=>_.sourced>0).length,[H]),Ce=p.useMemo(()=>{const _=new Map;return n.forEach(J=>{const ie=(J.name||"").trim().toLowerCase();ie&&!_.has(ie)&&_.set(ie,Te(J))}),_},[n]),ue=p.useMemo(()=>{const _=new Map;return n.forEach(J=>{const ie=(J.name||"").trim().toLowerCase();ie&&!_.has(ie)&&_.set(ie,J.id)}),_},[n]),be=_=>_===void 0?s?"not on this page":"pas sur cette page":e.plabels[_]||"",ye=_=>{const J=hl(yr(D==null?void 0:D.params,_)),ie=s?`Adjust the "${tn(_)}" engine`:`Ajuste le moteur « ${tn(_)} »`,oe=J?s?` (current settings: ${J})`:` (réglages actuels : ${J})`:"";return`${ie}${oe} : `},ee=async()=>{var J;const _=(((J=S.current)==null?void 0:J.value)||"").trim();if(!(_.length<8||I)){x(!0),z("");try{const ie=await fetch(`${Ja}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:l,message:_,who:"cockpit-v2"})}),oe=await ie.json();if(!ie.ok||oe.ok===!1)throw new Error(oe.error||`HTTP ${ie.status}`);if(oe.reply&&!oe.async){z(String(oe.reply)),x(!1);return}const me=oe.job_id;if(!me){z(s?"Sent.":"Envoyé."),x(!1);return}P.current=window.setInterval(async()=>{try{const se=await(await fetch(`${Ja}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:me})})).json();se.done&&(P.current&&window.clearInterval(P.current),P.current=null,z(String(se.reply||se.error||(s?"Done — settings updated.":"Terminé — réglages mis à jour."))),x(!1))}catch{}},3e3)}catch(ie){z((s?"Error: ":"Erreur : ")+String(ie.message||ie)),x(!1)}}};return l?t.jsxs("div",{className:"srceng"+(c?" on":""),children:[t.jsxs("button",{type:"button",className:"se-head","aria-expanded":c,onClick:()=>g(_=>!_),children:[t.jsx("span",{className:"se-ico",children:"🔎"}),t.jsx("b",{children:s?"Your sourcing engines":"Vos moteurs de sourcing"}),D&&t.jsx("span",{className:"se-sum",children:s?`${Ne} active · ${pe.toLocaleString("en-US")} companies found`:`${Ne} actifs · ${pe.toLocaleString("fr-FR")} sociétés trouvées`}),xe>0&&t.jsx("span",{className:"se-newsum",children:e.engFreshAll(xe)}),t.jsx("span",{className:"se-arr",children:c?"▾":"▸"})]}),c&&t.jsxs("div",{className:"se-body",children:[t.jsxs("div",{className:"se-bar",children:[kr.map(([_])=>t.jsx("button",{type:"button",className:"se-win"+(u===_?" on":""),onClick:()=>b(_),children:_==="1"?s?"Today":"Aujourd'hui":_==="all"?s?"All":"Tout":s?`${_} d`:`${_} j`},_)),t.jsx("span",{className:"se-note",children:s?"Panel totals = the chosen window; the funnel above counts the screened view.":"Les totaux du panneau = la fenêtre choisie ; le tunnel compte les criblées de la vue."})]}),y&&t.jsx("div",{className:"se-load",children:s?"Reading engines…":"Lecture des moteurs…"}),!!w&&t.jsxs("div",{className:"se-err",children:[w," ",t.jsx("button",{type:"button",onClick:()=>void Q(u),children:"↻"})]}),!y&&!w&&D&&t.jsx("div",{className:"se-cards",children:H.map(_=>{var J,ie,oe,me;return t.jsxs("div",{className:"se-card"+(_.sourced===0?" idle":"")+((J=le[_.key])!=null&&J.noms.length||(ie=he[_.key])!=null&&ie.length?" has-new":""),children:[t.jsxs("div",{className:"se-ct",children:[t.jsx("b",{children:tn(_.key)}),(oe=le[_.key])!=null&&oe.noms.length?t.jsx("button",{type:"button",className:"se-new",title:e.engFreshHint,onClick:W=>{W.stopPropagation(),j(k&&k.eng===_.key&&k.kind==="neuf"?null:{eng:_.key,kind:"neuf"})},children:e.engFresh(le[_.key].noms.length)}):!!((me=he[_.key])!=null&&me.length)&&t.jsx("button",{type:"button",className:"se-new today",title:e.engTodayHint,onClick:W=>{W.stopPropagation(),j(k&&k.eng===_.key&&k.kind==="today"?null:{eng:_.key,kind:"today"})},children:e.engToday(he[_.key].length)}),(()=>{const W=xl(_.key),se=W?N[W]:void 0;if(!se||!o)return null;const ve=!!se.opt_in,ke=ve?!!se.fund_on:se.fund_on!==!1,Ee=!ve&&se.global_enabled===!1,ge=Ee?e.engGlobalOff:ke?e.engOn:ve?e.engOptOff:e.engOff;return t.jsx("button",{type:"button",className:"se-sw"+(ke?" on":"")+(Ee?" dead":""),disabled:Ee||T===W,title:ve?e.engHintOpt:e.engHint,onClick:Pe=>{Pe.stopPropagation(),L(W),Pi(l,W,!ke).then(Je=>{if(L(""),!Je.ok){d(Je.error||e.engToggleFail);return}q(at=>({...at,[W]:{...se,fund_on:!ke}})),i(e.engToggleNote)})},children:T===W?"…":ge})})(),t.jsx("span",{className:"se-st"+(_.sourced>0?" ok":""),children:_.sourced>0?s?"⚡ actively sourcing":"⚡ source activement":s?"standby":"en veille"}),t.jsx(vl,{vals:_.spark})]}),t.jsx("p",{className:"se-desc",children:pl(_.key,s)||(s?"Engine wired for your thesis.":"Moteur branché pour votre thèse.")}),t.jsxs("div",{className:"se-hero",children:[t.jsx("b",{children:_.sourced.toLocaleString(s?"en-US":"fr-FR")}),t.jsx("span",{children:s?"companies found":"sociétés trouvées"})]}),(_.matched>0||_.noMatch>0)&&t.jsxs("div",{className:"se-split",children:[s?"incl.":"dont"," ",t.jsxs("button",{type:"button",onClick:()=>j({eng:_.key,kind:"kept"}),children:[_.matched," MATCH"]})," · ",t.jsxs("button",{type:"button",onClick:()=>j({eng:_.key,kind:"rej"}),children:[_.noMatch," ",s?"ruled out":"écartées"]}),_.rate>0&&t.jsxs("em",{children:[" · ",_.rate,"%"]})]}),(()=>{const W=yr(D.params,_.key);if(!W)return null;const se=!!$[_.key],ve=se?[...W.chips,...W.more]:W.chips,ke=W.shared&&e.engParamsShared||W.example&&e.engParamsExample||W.note||"";return t.jsxs("div",{className:"se-params",children:[t.jsx("i",{children:e.engParams}),t.jsxs("div",{className:"se-chips",children:[ve.map((Ee,ge)=>t.jsx("span",{className:"se-chip"+(W.shared?" soft":""),children:Ee},Ee+ge)),W.more.length>0&&t.jsx("button",{type:"button",className:"se-chipmore",onClick:Ee=>{Ee.stopPropagation(),G(ge=>({...ge,[_.key]:!se}))},children:se?e.engParamsLess:e.engMore(W.more.length)})]}),ke&&t.jsx("span",{className:"se-pnote",children:ke})]})})(),t.jsxs("div",{className:"se-acts",children:[_.key==="local"&&o&&t.jsxs(t.Fragment,{children:[t.jsx("button",{type:"button",className:"se-bod",disabled:C==="run",onClick:W=>{W.stopPropagation(),O("run"),_i(l,f||"").then(se=>{if(O(se.ok?"ok":"ko"),!se.ok){d(se.error||e.engBodaccKo);return}i(e.engBodaccOk),Zn(l).then(ve=>{const ke={};ve.forEach(Ee=>{Ee.engine&&(ke[Ee.engine]=Ee)}),q(ke)})})},children:C==="run"?e.engBodaccRun:e.engBodacc}),t.jsx("p",{className:"se-desc",style:{margin:"4px 0 0"},children:e.engBodaccNote})]}),t.jsxs("button",{type:"button",className:"se-adj",onClick:()=>{V(ye(_.key)),z(""),window.setTimeout(()=>{S.current&&(S.current.focus(),S.current.setSelectionRange(S.current.value.length,S.current.value.length))},60)},children:["✎ ",s?"Adjust this engine":"Ajuster ce moteur"]})]}),k&&k.eng===_.key&&t.jsxs("div",{className:"se-ovl",children:[t.jsxs("div",{className:"se-ovl-h",children:[t.jsx("b",{children:k.kind==="neuf"?e.engFreshT:k.kind==="today"?e.engTodayT:k.kind==="kept"?s?"MATCH via this engine":"MATCH via ce moteur":s?"Ruled out via this engine":"Écartées via ce moteur"}),t.jsx("button",{type:"button",onClick:()=>j(null),children:"×"})]}),t.jsx("ul",{children:_.leads.map(W=>{const se=(W.verdicts||[]).reduce((ve,ke)=>!ve||String(ke.check_date||"")>String(ve.check_date||"")?ke:ve,null);return{l:W,dernier:se}}).filter(({l:W,dernier:se})=>{var ke;const ve=((se==null?void 0:se.status)||"").trim().toUpperCase();if(k.kind==="neuf"){const Ee=new Set((((ke=le[_.key])==null?void 0:ke.noms)||[]).map(ge=>ge.toLowerCase()));return ve==="MATCH"&&Ee.has((W.company_name||"").trim().toLowerCase())}return k.kind==="today"?new Set((he[_.key]||[]).map(ge=>ge.toLowerCase())).has((W.company_name||"").trim().toLowerCase()):ve===(k.kind==="kept"?"MATCH":"NO MATCH")}).slice(0,100).map(({l:W,dernier:se},ve)=>{const ke=(W.company_name||"").trim(),Ee=ke&&ue.has(ke.toLowerCase());return t.jsxs("li",{children:[Ee?t.jsx("button",{type:"button",className:"se-jump",onClick:()=>{const ge=ue.get(ke.toLowerCase());if(ge)try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:ge,name:ke}}))}catch{}},children:ke}):t.jsx("b",{children:ke||"—"}),t.jsxs("span",{children:[be(Ce.get(ke.toLowerCase())),typeof(se==null?void 0:se.score)=="number"&&se.score>0?` · ${Math.round(se.score)}`:""]})]},ke+ve)})}),(()=>{const W=_.leads.filter(se=>{var Ee;const ve=(se.verdicts||[]).reduce((ge,Pe)=>!ge||String(Pe.check_date||"")>String(ge.check_date||"")?Pe:ge,null),ke=((ve==null?void 0:ve.status)||"").trim().toUpperCase();if(k.kind==="neuf"){const ge=new Set((((Ee=le[_.key])==null?void 0:Ee.noms)||[]).map(Pe=>Pe.toLowerCase()));return ke==="MATCH"&&ge.has((se.company_name||"").trim().toLowerCase())}return k.kind==="today"?new Set((he[_.key]||[]).map(Pe=>Pe.toLowerCase())).has((se.company_name||"").trim().toLowerCase()):ke===(k.kind==="kept"?"MATCH":"NO MATCH")}).length-100;return W>0?t.jsx("p",{className:"se-more",children:e.engMore(W)}):null})()]})]},_.key)})}),!!U&&t.jsxs("div",{className:"se-nl",children:[t.jsxs("div",{className:"se-nl-h",children:["✎ ",s?"Correct this thesis":"Corriger cette thèse"]}),t.jsx("textarea",{ref:S,rows:3,maxLength:12e3,defaultValue:U,placeholder:s?"Say what to change, in plain words…":"Dites ce qu’il faut changer, en langage naturel…"},U),t.jsxs("div",{className:"se-nl-a",children:[t.jsx("button",{type:"button",disabled:I,onClick:()=>void ee(),children:I?s?"⏳ applying…":"⏳ application…":s?"Apply":"Appliquer"}),t.jsx("button",{type:"button",className:"gh",onClick:()=>{V(""),z("")},children:s?"Close":"Fermer"})]}),!!F&&t.jsx("div",{className:"se-nl-r",children:F})]})]})]}):null}const yl={plabels:["À évaluer","Retenues","Analysées","À trancher","Validées","Écartées","Favoris","Évaluées"],phelp:["Tout ce que STAN a passé au crible sur la fenêtre : chaque société évaluée selon vos critères, retenue ou écartée automatiquement.","STAN a retenu ces sociétés selon vos critères, décision justifiée. NOUS vérifions ses choix — écartez, validez, ou lancez une analyse sur les incertaines.","Les mémos de STAN, relus par NOUS : synergies chiffrées, verdict argumenté. Validez celles à contacter, mettez « à trancher » celles où vous hésitez.","À VOUS de jouer : les meilleures cibles, présentées le lundi par votre Corporate Developer. Tranchez OUI ou NON — vos oui passent en Validées.","Vos OUI — la short-list à contacter. NOUS préparons l’approche, ou l’engageons en votre nom (offre Entreprise).","Écartées par STAN ou par VOUS. Chaque NON affine les critères de Stan. Repêchez-en une à tout moment.","Vos épingles, tous statuts confondus.","Vue : tout ce que Stan a tranché."],tuto:{0:{p:"Arrivées par les moteurs et pas encore criblées.",a:"⚡ Tout évaluer"},1:{p:"MATCH au crible, sans mémo. Lancez l’analyse : elle les enverra en Analysées ou À trancher.",a:"⚡ Analyser la sélection"},2:{p:"Mémo produit, verdict CONSIDER ou MONITOR. Remontez un dossier pour saisir le dirigeant le jour même.",a:"↑ Remonter en À trancher"},3:{p:"Verdict CALL : votre OUI ou NON est attendu sur chaque dossier.",a:null},4:{p:"Vos OUI. Stan rédige la séquence d’approche, vous validez et vous envoyez.",a:"✉ Préparer l’approche"},5:{p:"Hors crible, ou écartées après mémo. Un dossier reste repêchable à tout moment.",a:"↩ Repêcher la sélection"},6:{p:"Les cibles que vous avez épinglées à la main, tous statuts confondus.",a:null},7:{p:"Tout ce que Stan a tranché, sous-états confondus — le vivier complet des moteurs.",a:null}},tutoPending:(e,a,r)=>`<b>${e} CALL de Stan</b>, <b>${a} remontée${a>1?"s":""} par vous</b>. <b>${r} sans réponse.</b>`,morningThesis:(e,a,r)=>`Ce matin, <b>${e}</b> société${e===1?"":"s"} criblée${e===1?"":"s"} par vos moteurs`+(typeof r=="number"?`, <b>${r}</b> retenue${r===1?"":"s"}.`:".")+(a?` <b>${a}</b> attend${a>1?"ent":""} votre évaluation.`:' <span class="ok">Tout est évalué.</span>'),morningEnginesTitle:"Ces sociétés viennent UNIQUEMENT du sourcing de votre thèse : vos codes d’activité, vos pays, vos angles d’acquisition, vos critères d’exclusion. Aucune société d’un autre fonds n’entre ici. Seule la veille d’actualité part d’un ratissage commun pour des raisons de coût — mais chaque opération qui en sort est ensuite confrontée à vos critères, et n’entre dans votre page que si elle les passe.",morningLast:(e,a,r)=>`Dernier passage des moteurs le <b>${r}</b> : <b>${e}</b> société${e===1?"":"s"} sourcée${e===1?"":"s"}.`+(a?` <b>${a}</b> restante${a>1?"s":""} pas encore évaluée${a>1?"s":""}.`:' <span class="ok">Tout est évalué.</span>'),morningEval:e=>`▶ Les traiter (${e})`,identTitle:e=>`Cibles pour ${e}`,identCoverage:"Couverture du marché",identCoverageOf:(e,a)=>`<b>${e}</b> sur ~${a.toLocaleString("fr-FR")}`,identEngine:"Moteur de mémos",identPerDay:"mémo/jour",identEtaDays:e=>e<=0?"file déjà traitée":`file traitée en ${e} jour${e>1?"s":""}`,analyseLock:"Analyser tous · Entreprise",analyseLockHint:"Analyser toute la sélection d’un coup lance plusieurs mémos en parallèle. L’offre Entreprise (verdict sous 24 h) le permet ; en Standard et en essai, on analyse ligne par ligne.",feedToEval:"→ À évaluer",feedToExtract:"Coller l’URL",identPending:e=>`→ ${e} en attente`,identPendingWait:"→ lecture de la file…",identExport:"Exporter — CSV, tableur, lien vivant",identPlug:"Connecter cette page à vos outils",identBell:"Vos alertes email",identSync:"Relancer le sourcing",identSyncDone:"Sourcing relancé — les moteurs repartent sur votre thèse",identSearch:"Rechercher une cible",identHelp:"Aide",identTuto:"Prise en main",toolUndo:"Annuler la dernière décision",toolReset:"Réinitialiser les filtres",toolSort:"Trier la liste",toolTuto:"Prise en main",toolCrit:"Le paramétrage de Stan",undoDone:e=>`Décision annulée sur ${e}`,undoNone:"Rien à annuler",undoLockedTitle:"Annulation impossible : le statut précédent était vide (aucune opération « effacer » côté serveur)",resetDone:"Filtres réinitialisés",actAnalyse:"⚡ Analyser",actAnalyseQueued:"⏳ En file…",actPromote:"↑ À trancher",actYes:"✓ Oui",actNo:"✗ Non",actYesTitle:"Oui : elle passe en Validées, Stan prépare la séquence",actNoTitle:"Non : elle rejoint les Écartées",actApproach:"✉ Préparer l’approche",actApproachSent:"✓ Séquence prête — voir votre email",actMemo:"📄 Voir le mémo",actMemoQueue:"mémo à lancer",actLocked:"🔒 Analyser",actToEval:"à évaluer",promoted:e=>`${e} remontée pour décision`,thumbUp:"Bon choix — Stan en tiendra compte",thumbDn:"Mauvais choix — Stan corrigera",thumbUpDone:"Bon choix enregistré — Stan en tiendra compte",thumbDnDone:"Correction enregistrée — Stan ajustera sa sélection",colThumbs:"STAN",colVerdict:"Crible · mémo",colCrible:"Crible",fVerdict:"Verdict",colMemo:"Mémo",colScore:"Score",orgAuto:"⚡ CALL de Stan",orgAutoTitle:"Verdict CALL PENDING : Stan propose l’appel",orgCd:"👤 remonté par vous",orgCdTitle:"Remonté à la main en À trancher",waitTitle:e=>`Depuis le verdict de Stan : ${e} j`,waitChip:e=>`⏱ ${e} j`,densList:"Liste",densOpen:"Déplié",densLigne:"Ligne",densMaxi:"Maxi",unfoldAll:"Tout déplier",foldAllLbl:"Tout replier",foldArts:"Articles",zoomSrc:"Source",viewLink:"Voir l’article",viewSite:"Site",viewSrc:"Source",viewSiteBusy:"Site…",viewSiteHint:"Site web de la société",viewSiteBusyHint:"Recherche du site web…",viewSrcHint:"Article source",viewLinkClose:"Fermer l’article",viewLinkTab:"Ouvrir dans un onglet",viewLinkHint:"S’ouvre dans une nouvelle fenêtre",zoomSimilar:"Voir les similaires",zoomInCockpit:"Isoler dans la liste",zoomArt:"Edito du jour",zoomEvalHint:"Crible selon vos critères",zoomSimilarHint:"Même secteur dans la liste",zoomIsolateHint:"Ne garder que cette société",zoomNewsMark:"Décryptage de l’édition — le texte s’ouvre à droite",zoomPulseEval:"évaluables",zoomPulseExplore:"à explorer",zoomPulseArts:"actualités",doNews:"📰 Actualités",zoomPulseEd:"dans l’article du jour",zoomPulseBtn:"Édition du jour",zoomPulseWeek:"7 derniers jours",zoomPulseWeekEd:"cette semaine",doAll:"Tout",doEdito:"📖 Edito du jour",doBrief:"📖 Brief du jour",doEval:"⚡ Évaluables",doExplore:"🔎 À explorer",doAna:"⚡ À analyser",doBriefHint:"Afficher le brief du jour",doTodo:"⚡ À évaluer",doDone:"✓ Déjà évaluées",cdMemoTab:"📖 Mémo",evalPickSite:"plusieurs sites portent ce nom — ouvrez pour vérifier, puis validez celui qui est le bon.",evalPickGo:"✓ C’est celui-ci",evalPickChip:"Site à confirmer",eqNamePh:"Nom de société ou URL…",eqAdd:"Ajouter une ligne",eqNoSite:"aucun site trouvé — le nom sera évalué tel quel",eqReady:"prête",eqPick:"choisir le site →",eqRunning:"⏳ évaluation…",eqGo:e=>`⚡ Évaluer les ${e} lignes`,eqHint:"Vos lignes restent ici : remplissez en déplacement, lancez plus tard.",eqColName:"Société",eqColSite:"Site",eqColDesc:"Ce qu’elle fait",eqColState:"État",eqLookup:"recherche du site…",eqDescBusy:"lecture du site…",eqDescNone:"le site ne dit rien d’exploitable",eqDescQuota:"plafond de lecture atteint aujourd’hui",eqRunOne:"Évaluer cette ligne",eqRunOneShort:"Évaluer",sgGo:"💡 Trouver des sociétés proches",sgBusy:e=>`🔎 jumelles de ${e}…`,sgFrom:(e,a)=>`à partir de vos retenues (${e}${a>1?` +${a-1}`:""})`,sgQuota:"plafond du jour atteint (5 recherches) — à demain",sgNone:"rien de neuf : les jumelles trouvées sont déjà dans votre liste",sgVia:e=>`trouvée à partir de ${e}`,pxThesis:"votre thèse",pxGoThesis:"🎯 Chercher sur ma thèse",pxGoFree:"🔎 Chercher",pxPlace:"un mot porteur, ou un code NAF (66.22Z)",eqClearDone:"Retirer les évaluées",chainMemoGo:"⚡ Lancer le mémo (1 crédit)",analyseConfirm:e=>`Lancer ${e} mémo${e>1?"s":""} d’analyse ?
...
.atl2 .bulk .side .hint{white-space:nowrap}`,Al=`
...
.atl2 .dfacts{display:flex;flex-direction:row;align-items:center;gap:14px;flex:none}
...
`,Ll=Cl+Al+ql+Tl;function bn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Fl(){const e=bn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Rl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Fl();return r==="0"?"client":r==="1"||bn("embed")==="1"&&bn("chrome")==="1"?"apercu":"client"}const Ol={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ml=e=>Ol[e];function Ia(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Lt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!wo(a)||Ia(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Xi(e.cc)})};function an(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Dl=60*60*1e3;function Il(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Dl?null:a}catch{return null}}function va(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Pl=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function _l(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:Bi(),[e,n]),i=p.useMemo(()=>n?"visiteur":Rl(e,o),[e,o,n]),d=p.useMemo(()=>Ml(i),[i]),s=i!=="visiteur",l=Pl(r),[f,c]=p.useState([]),[g,u]=p.useState(""),[b,h]=p.useState(null),[v,y]=p.useState(null),[m,w]=p.useState(null),[E,k]=p.useState(()=>new Map),[j,N]=p.useState(()=>new Map),[q,T]=p.useState(""),[L,C]=p.useState(new Set),[O,U]=p.useState(null),[V,I]=p.useState(!0),[x,F]=p.useState(!1),[z,$]=p.useState(0),[G,S]=p.useState(0),P=p.useRef(0),D=p.useMemo(()=>{var H;if(i!=="client")return"";try{return((H=$i())==null?void 0:H.email)||""}catch{return""}},[i]);p.useEffect(()=>{const H=++P.current;let ce=!0;const te=()=>ce&&H===P.current,le=(s&&o.token?o.token:"pub:"+a)+(l?":"+l:""),xe=Il(le);return xe?(c(xe.objs.map(Lt)),xe.fund&&u(xe.fund),h(xe.marketEstimate??null),y(xe.criteria??null),w(xe.stats??null),T(xe.generatedAt||""),I(!1)):I(!0),(async()=>{try{if(r==="ops"){const he=await Xa(),we=((he==null?void 0:he.recent_ops)||[]).map(pe=>{const Ne=Aa(pe.company_name||pe.title?pe:{...pe,title:(pe.headline_fr||pe.headline||"").slice(0,120)},a),Ce=String(pe.rubrique||"").toLowerCase();return Ne&&(Ce==="nominations"||Ce==="recrutements")&&(Ne.engine=Ce),Ne&&!String(pe.company_name||"").trim()&&(Ne.noCo=!0),Ne}).filter(pe=>!!pe).map(pe=>(wo((pe.name||"").trim())||(pe.noCo=!0),pe));try{const pe=Ui(),Ne=await Hi(),Ce=((Ne==null?void 0:Ne.date)||"").slice(0,10),ue=pe?pe.doc:Ne,be=Vi(ue),ye=((pe==null?void 0:pe.day)||(ue==null?void 0:ue.date)||Ce||"").slice(0,10);if(ye&&be.length){const ee=new Set;for(const _ of we){if((_.date||"").slice(0,10)!==ye)continue;const J=tr(be,ee,_.name,"");J>=0&&(ee.add(J),_.decryptHtml=be[J].html)}for(const _ of we){if(_.decryptHtml||(_.date||"").slice(0,10)!==ye)continue;const J=tr(be,ee,"",_.headline||_.tagline||_.name);J>=0&&(ee.add(J),_.decryptHtml=be[J].html)}}if(ye){const ee=((ue==null?void 0:ue.title_fr)||"").trim(),_=((ue==null?void 0:ue.lead_fr)||"").trim(),J=Wi(ue),ie=((ue==null?void 0:ue.url)||"").trim();ee&&(J||ie)&&we.unshift({id:`edito:${ye}`,kind:"op",name:ee,cc:null,date:ye,engine:"edito",dealKind:"other",headline:ee,tagline:_||ee,decryptHtml:J||void 0,url:ie,noCo:!0})}}catch{}if(!te())return;c(we.map(Lt)),va(le,{objs:we})}else if(typeof r=="object"){const we=(await ar()||[]).filter(Ne=>(Ne.slug||"")===r.research).map(Ne=>nr(Ne,a)).filter(Ne=>!!Ne),pe=an(await rr(we,a));if(!te())return;c(pe.map(Lt)),va(le,{objs:pe})}else if(s&&o.token){const he=Gi(o.token),we=Xa(),pe=Yi(o.token),Ne=Qi(o.token),Ce=Ki(o.token),ue=await he;let be=ue?ue.targets:[];te()&&ue&&(u(ue.fund||""),h(ue.marketEstimate??null),y(ue.criteria??null),w(ue.stats??null),T(ue.generatedAt||""),c(be.map(Lt)),I(!1),F(!1));const[ye,ee,_,J]=await Promise.all([we,pe,Ne,Ce]),ie=((ye==null?void 0:ye.recent_ops)||[]).map(W=>Aa(W,a)).filter(W=>!!W),oe=new Set(be.map(W=>W.id));if(be=[...be,...ie.filter(W=>!oe.has(W.id)&&(oe.add(W.id),!0))],!te())return;c(be.map(Lt));const me=new Set;for(const W of ee){const se=(W.id||W.co||"").toString().trim().toLowerCase();se&&me.add(se.startsWith("t:")?se:"t:"+se)}C(me),k(_),N(J),ue&&va(le,{fund:ue.fund,marketEstimate:ue.marketEstimate,criteria:ue.criteria,stats:ue.stats,generatedAt:ue.generatedAt,objs:be})}else{const he=Ji(),we=ar(),pe=Xa(),Ne=await he;te()&&Ne.length&&(c(an(Ne).map(Lt)),I(!1),F(!1));const[Ce,ue]=await Promise.all([we,pe]),be=(Ce||[]).map(J=>nr(J,a)).filter(J=>!!J),ye=await rr(be,a),ee=((ue==null?void 0:ue.recent_ops)||[]).map(J=>Aa(J,a)).filter(J=>!!J),_=an([...Ne,...ye,...ee]);if(!te())return;c(_.map(Lt)),va(le,{objs:_})}te()&&F(!1)}catch{te()&&!xe&&F(!0)}finally{te()&&I(!1)}})(),()=>{ce=!1}},[s,o.token,a,z,l]),p.useEffect(()=>{if(!d.showCredits||!D){U(null);return}let H=!0;return(async()=>{try{const ce=await fetch(`${ha}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:D})});if(!ce.ok)return;const te=await ce.json();H&&te&&te.ok!==!1&&U(te)}catch{}})(),()=>{H=!1}},[d.showCredits,D,G]);const Q=p.useCallback(H=>C(new Set(H)),[]);return{session:o,mode:i,caps:d,fund:g,email:D,marketEstimate:b,generatedAt:q,criteria:v,thesisMode:String((v==null?void 0:v.mode)||""),stats:m,thumbs:E,stages:j,dossiers:f,patchStatuses:(H,ce)=>{c(te=>{let le=!1;const xe=te.map(he=>{if(!he.checkId)return he;const we=H.get(he.checkId);return!we||we===(he.ceoStatus||"")||!ce(he.id)?he:(le=!0,{...he,ceoStatus:we})});return le?xe:te})},favIds:L,setFavIds:Q,credits:O,reloadCredits:()=>S(H=>H+1),loading:V,error:x,refresh:()=>$(H=>H+1)}}function Be(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const qa=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Pa(e){return qa.has(e.engine||"")}function Ke(e){return!!e.noCo||Pa(e)&&!!e.url}const _o=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Bl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{..._o(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),$l=new Set(["signal","amount","score","crible","memo"]);function Ul(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:_o(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:$l.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Bo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Bo=80;function _a(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!_e(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Mn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ut(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ft(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(ko(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function Rt(e,a,r){return Be(e)?_a(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:_a(e,a.filters,r)}function Hl(e,a,r,n){return!(!Rt(e,a,r)||r&&!yo(e,a.ptab,n))}function Bn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-ut(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return es(o)||null;case"memo":return Zi(o)||null;case"signal":{const i=_e(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),s=n(i);return d===null||s===null?d===s?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<s?-a.dir:d>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const nn={},Er=(nn==null?void 0:nn.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function jr(){return new Date().toISOString().slice(0,10)}const $n=p.createContext(null);function $o(){return p.useContext($n)}function Vl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(l=>l.remove()),s.querySelectorAll("*").forEach(l=>{const f=l.tagName==="A"?l.getAttribute("href"):null;[...l.attributes].forEach(c=>l.removeAttribute(c.name)),f&&/^https?:\/\//i.test(f)&&(l.setAttribute("href",f),l.setAttribute("target","_blank"),l.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Uo(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Wl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),l=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!s&&!l&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Uo(r),r.innerHTML):e}catch{return e}}function Nr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Uo(r),r.innerHTML):e}catch{return e}}function Sr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Ho(){const e=p.useContext($n);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Gl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Z(),[i,d]=p.useState(()=>n.filters.day||jr()),[s,l]=p.useState(null),[f,c]=p.useState(!1),g=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){d(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{d(jr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=y=>{var w;const m=(w=y.detail)==null?void 0:w.day;typeof m=="string"&&g(m)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[g]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let v=!1;c(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Er}/cibles/edition.json?${y}`).then(m=>m.json()).then(m=>{v||l(m)}).catch(()=>{v||l({ok:!1,error:"network"})}).finally(()=>{v||c(!1)}),()=>{v=!0}},[e,i]);const b=p.useMemo(()=>`${Er}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),h=p.useMemo(()=>({token:e,day:i,ed:s,loading:f,pickDay:g,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,f,g,u,n.filters.day,b,o]);return t.jsx($n.Provider,{value:h,children:a})}function Yl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Ho(),[o,i]=p.useState(()=>n||Eo());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const d=s=>{var l;return i(!!((l=s.detail)!=null&&l.open))};return window.addEventListener(Ra,d),()=>window.removeEventListener(Ra,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(ts,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Ql(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function zr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Cr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Kl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Ho(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!d,l=a&&!a.ok,f=p.useRef(null),[c,g]=p.useState("fonds"),[u,b]=p.useState(null),[h,v]=p.useState("idle"),y=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),y.current=!1,g("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||y.current)return;y.current=!0;let j=!0;return v("load"),Ql(e).then(N=>{j&&(b(N),v("fait"))}),()=>{j=!1}},[c,e]);const m=p.useMemo(()=>Wl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),w=p.useRef(null);p.useEffect(()=>{const j=w.current;if(!j||!m)return;let N=!1;return hn(()=>import("./fit-DX-mzLKR.js"),[]).then(async q=>{await q.ensureEditoCss(),!(N||!j.isConnected)&&(q.beautifyEditoRows(j),q.mountCardFits(j))}),()=>{N=!0}},[m]);const E=p.useMemo(()=>Nr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>Nr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const j=f.current;if(!j||!E)return;let N=!1;return hn(()=>import("./fit-DX-mzLKR.js"),[]).then(async q=>{await q.ensureEditoCss(),!(N||!j.isConnected)&&(q.beautifyEditoRows(j),q.mountCardFits(j))}),()=>{N=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const j=(a==null?void 0:a.date)||e,N=/^(\d{4})-(\d{2})-(\d{2})/.exec(j);return N?i?`${N[2]}/${N[3]}/${N[1]}`:`${N[3]}/${N[2]}/${N[1]}`:j})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>g("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>g("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&l&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?zr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Sr(e,!0)}),"."]}):zr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Sr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>g("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&d&&E?t.jsx("div",{ref:f,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,c==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(m?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title thesis-brief__jour-h",children:u.title}),t.jsx("div",{ref:w,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:m}})]}):t.jsx("p",{className:h==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:h!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Cr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Cr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Jl=300,wa=7,Xl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Vo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Zl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function ya(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(os(r)&&r!=="media")return"news:"+r;const n=_e(e);return n?"sig:"+(n.theme&&Vo.fr[n.theme]?n.theme:"other"):"actualites"}function ed(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:s}=Z(),l=$o(),f=d==="en",[c,g]=p.useState("all"),[u,b]=p.useState(!1),h=p.useMemo(()=>{var ce;const x=(a.filters.day||"").slice(0,10),F=te=>!(!i&&a.continent!=="monde"&&te.continent!==a.continent||x&&(te.date||"").slice(0,10)!==x),z=e.filter(te=>F(te)&&_e(te)&&(!i||te.kind!=="target"||Te(te)!==5)),$=i&&(((ce=l==null?void 0:l.ed)==null?void 0:ce.ops)||[]).length?l.ed.ops.map(te=>Aa(te,d)).filter(te=>!!te).map(te=>(te.briefOnly=!0,te)).filter(te=>!x||(te.date||"").slice(0,10)===x):[],G=e.filter(te=>F(te)&&te.kind==="op"&&(x?!0:ut(te.date)<=wa)),S=i?$.length?$:G.filter(te=>{const le=(s||"").trim().toLowerCase();if(!le)return!1;const xe=te.match||null;return xe?Object.keys(xe).map(he=>he.trim().toLowerCase()).includes(le):!1}):G,P=x||new Date().toISOString().slice(0,10),D=te=>{const le=ya(te);return le==="ma"?0:le==="levees"?1:2};S.sort((te,le)=>{const xe=D(te)-D(le);if(xe)return xe;const he=(te.date||"").slice(0,10)===P?0:1,we=(le.date||"").slice(0,10)===P?0:1;return he!==we?he-we:(le.amountEur||0)-(te.amountEur||0)});const Q=new Set,H=[];for(const te of[...S,...Bn(z,{key:"signal",dir:-1})]){const le=te.id||te.name;!le||Q.has(le)||(Q.add(le),H.push(te))}return i&&H.length===0?e.filter(le=>F(le)&&ut(le.date)<=wa).sort((le,xe)=>(xe.date||"").localeCompare(le.date||"")).slice(0,80):H},[e,a.continent,a.filters.day,i,s,d,l]),v=p.useMemo(()=>{const x={};for(const F of h){const z=ya(F);x[z]=(x[z]||0)+1}return x},[h]),y=p.useMemo(()=>c==="all"?h:h.filter(x=>ya(x)===c),[h,c]),m=p.useMemo(()=>y.slice(0,Jl),[y]),w=y.length-m.length,E=p.useRef(null);p.useEffect(()=>{var S,P;const x=E.current;if(!x)return;const F=()=>{const D=x.scrollWidth;D<200||(x.style.animationDuration=Math.max(18,Math.round(D/130))+"s")};F();const z=requestAnimationFrame(F),$=window.setTimeout(F,1200);let G=!0;return(P=(S=document.fonts)==null?void 0:S.ready)==null||P.then(()=>{G&&F()}),()=>{G=!1,cancelAnimationFrame(z),window.clearTimeout($)}},[m.length,c]);const k=x=>x==="all"?h.length:v[x]||0,j=x=>{if(x==="all")return f?"All":"Tout";if(x.startsWith("sig:"))return Vo[f?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const F=x.slice(5);return ns[F]?rs(F,f?"en":"fr"):x}return Xl[f?"en":"fr"][x]},N=[{k:"all"}],q=["ma","levees"].filter(x=>k(x)>0||x===c);if(q.length){N.push({g:f?"Deals":"Opérations"});for(const x of q)N.push({k:x})}const T=["nominations","recrutements"].filter(x=>k(x)>0||x===c),L=as.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===c),C=k("actualites")>0||c==="actualites"?["actualites"]:[];if(T.length||L.length||C.length){N.push({g:f?"News":"Actualités"});for(const x of T)N.push({k:x});for(const x of L)N.push({k:x});for(const x of C)N.push({k:x})}const O=Zl.map(x=>"sig:"+x).filter(x=>k(x)>0||x===c);if(O.length){N.push({g:f?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of O)N.push({k:x})}const U=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},V=(()=>{const x=(a.filters.day||"").slice(0,10),F=!i&&a.continent!=="monde"&&o?f?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(f?`LIVE covers the events of ${U(x)}.`:`Le LIVE regroupe les événements du ${U(x)}.`)+F:(f?`LIVE covers the still-open signals and the deals of the last ${wa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${wa} derniers jours.`)+F})(),I=x=>m.map(F=>t.jsxs("button",{type:"button",className:"tk"+(Ue(F)?" spent":""),onClick:z=>{const $=F.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:$?"":F.id,name:F.name,url:F.url||"",text:F.tagline||F.headline||"",card:F.card}}))}catch{}if($||n({type:"focus",id:F.id}),a.dens!=="liste"){const G=z.currentTarget.getBoundingClientRect();n({type:"popup",id:F.id,anchor:{x:G.left+G.width/2,y:G.bottom}})}},title:Ue(F)?f?`${F.name} — already screened (dimmed)`:`${F.name} — déjà évaluée (grisée)`:F.name+(F.tagline?" — "+F.tagline:""),children:[t.jsx(zt,{o:F}),t.jsxs("span",{className:"who",children:[t.jsx(Ci,{o:F}),t.jsx("span",{className:"co",children:F.name})]}),(()=>{const z=(F.tagline||F.headline||"").trim();if(z&&z!==F.name)return t.jsx("span",{className:"what",children:z});const $=ya(F),G=$==="ma"?f?"M&A deal":"opération M&A":$==="levees"?f?"fundraising":"levée de fonds":$==="nominations"?f?"appointment":"nomination":$==="recrutements"?f?"hiring":"recrutement":$.startsWith("sig:")?f?"engine signal":"signal moteur":$.startsWith("news:")?f?"news":"actualité":F.kind==="target"?f?"sourced target":"cible sourcée":f?"news item":"actualité";return t.jsx("span",{className:"what dim",children:G})})(),typeof F.amountEur=="number"&&F.amountEur>0&&t.jsx("span",{className:"am",children:Zc(F.amountEur)}),F.sector&&t.jsx("span",{className:"mt",children:F.sector}),t.jsx(Ka,{o:F}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(F.id||F.name))).concat(w>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${w} more — filter by section to see them`:`+ ${w} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(x=>!x),children:[j(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:V}),N.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===c,onClick:()=>{g(x.k),b(!1)},children:[j(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:m.length?t.jsxs("div",{className:"run",ref:E,children:[I(0),I(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!l&&t.jsxs("button",{type:"button",className:"tk-edito",title:f?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",f?"Today's editorial":"Edito du jour"]}),!!l&&t.jsx(ad,{isEn:f})]})}const td=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function ad({isEn:e}){const[a,r]=p.useState(()=>Eo());p.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Ra,o),()=>window.removeEventListener(Ra,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>is(!a),children:td})}class pt extends p.Component{constructor(){super(...arguments);Xn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Wo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Ar(e,a){if((Ct(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return Wo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const qr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",nd={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function rd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=Z(),[s,l]=p.useState(""),[f,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!g)return;const w=E=>{b.current&&!b.current.contains(E.target)&&(u(!1),c(!1))};return document.addEventListener("click",w,!0),()=>document.removeEventListener("click",w,!0)},[g]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const h=(e.ceoStatus||"").trim(),v=async w=>{if(s)return;if(w==="Analysé"&&!e.memoUrl){c(!0);return}l(w);const E=(Ar(e,a).find(([j])=>j===w)||[w,w])[1],k=await o(e,w,{msg:a.csMoved(e.name,E)});l(""),k&&(c(!1),u(!1))},y=Ar(e,a),m=w=>(y.find(([E])=>E===w)||[])[1]||w;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:w=>w.stopPropagation(),children:y.map(([w,E])=>t.jsx("button",{type:"button",className:"rsd "+(w==="Validé"?"yes":"no")+(s===w?" busy":""),disabled:!!s,onClick:()=>{v(w)},children:E},w))}):t.jsxs("span",{className:"rstat"+(g||f?" rs-open":""),ref:b,onClick:w=>w.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":g,disabled:!!s,title:a.csLabel,className:"rsel rs-"+qr(h),onClick:()=>{u(w=>!w),c(!1)},children:s?m(s)+"…":h?m(h):a.csNone}),g&&!f&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([w,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":h===w,className:"rsopt"+(h===w?" on":"")+(s===w?" busy":""),disabled:!!s,onClick:()=>{if(w===h){u(!1);return}v(w)},children:[t.jsx("i",{className:"pt2",style:{background:nd[qr(w)]}}),E]},w))}),f&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),c(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const w=await o(e,"Analysé");l(""),w&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function od({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Z(),[i,d]=p.useState(""),[s,l]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),c=(Ct(e)||"").startsWith("CALL")&&Te(e)===3,g=Te(e)>=2,u=async h=>{if(i||h==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(h);const v=await o(e,h);d(""),v&&(l(!0),setTimeout(()=>l(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:Wo.filter(([h])=>!(g&&h==="Retenu")).map(([h,v])=>[h,a[v]]);return t.jsxs("div",{className:"csp",onClick:h=>h.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([h,v])=>t.jsx("button",{type:"button",className:"csb"+(f===h?" on":"")+(i===h?" busy":""),disabled:!!i,onClick:()=>{u(h)},children:v},h)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(id,{o:e})]})}function id({o:e}){const{t:a,saveNote:r,flash:n}=Z(),[o,i]=p.useState(e.ceoNote||""),[d,s]=p.useState(!1),[l,f]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),g=async()=>{if(d||!c)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&g()}}),t.jsx("button",{type:"button",disabled:d||!c,onClick:()=>{g()},children:l?a.csNoteSaved:a.csNoteOk})]})}function Tr({placeholder:e,onDone:a}){const{t:r}=Z(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function sd({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:s}=Z(),[l,f]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Te(e)!==4)return null;const c=i(e),g=(c==null?void 0:c.stage)||"todo",u=async m=>{if(l||m===g)return;f(!0);const w=c;d(e,{stage:m,stamps:(c==null?void 0:c.stamps)||{}});const E=Math.max(Date.now(),Lr+=1);Lr=E;const k=await ss(r,{company:e.name||"",stage:m,cts:E,deal_id:e.airtableId,check_id:e.checkId});f(!1),!k.stale&&(k.ok||(d(e,w),s(a.actErr)))},b=(y=c==null?void 0:c.stamps)==null?void 0:y.sent,h=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=g==="sent"&&b&&h>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,w])=>t.jsx("button",{type:"button",className:"stgb"+(g===m?" on":""),disabled:l,onClick:()=>{u(m)},children:w},m)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(h)})]})}let Lr=0;const Zt=8,Nt=360;function Fr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Rr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Fr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Fr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function ld({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Z(),[d,s]=p.useState(0),[l,f]=p.useState(null),[c,g]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),h=p.useRef(!1);p.useEffect(()=>{const q=b.current;return()=>{h.current||(n({type:"ptab",tab:q.ptab}),n({type:"dens",dens:q.dens}),n({type:"modal",modal:q.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,g(e.filter(q=>!!document.querySelector(q.need||q.sel))))},[e]);const v=c[d],y=d>=c.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const q=v.click,T=window.setTimeout(()=>{const L=document.querySelector(q);L&&L.getAttribute("aria-selected")!=="true"&&L.click()},60);return()=>window.clearTimeout(T)}},[d,v]);const m=p.useRef(-1),w=p.useCallback(()=>{if(!v){f(null);return}const q=C=>{if(!C)return null;for(const O of document.querySelectorAll(C)){const U=O.getBoundingClientRect();if(U.width>1&&U.height>1)return O}return null},T=q(v.sel)||q(v.need);if(!T){f(null);return}m.current!==d&&(m.current=d,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=T.getBoundingClientRect();f(C=>C&&Math.abs(C.top-L.top)<1&&Math.abs(C.left-L.left)<1&&Math.abs(C.width-L.width)<1&&Math.abs(C.height-L.height)<1?C:L)},[v,d]);p.useLayoutEffect(()=>{w();const q=[90,300,700,1300].map(C=>window.setTimeout(w,C)),T=window.setInterval(w,400),L=()=>w();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{q.forEach(C=>window.clearTimeout(C)),window.clearInterval(T),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[w]);const E=p.useRef(a);if(E.current=a,p.useEffect(()=>{const q=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),E.current()):T.key==="ArrowRight"?s(L=>L+1):T.key==="ArrowLeft"&&s(L=>Math.max(0,L-1))};return document.addEventListener("keydown",q,!0),()=>document.removeEventListener("keydown",q,!0)},[]),!c.length)return null;let k=null;const j=q=>()=>{h.current=!0,n({type:"modal",modal:null}),q()};if(y){const q=o[3]||0;q>0?k={title:q===1?r.ahaATitle1:r.ahaATitleN(q),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let N={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Nt};if(!y&&l){const q=l.bottom+14,T=window.innerHeight-q;let L=T>190?q:Math.max(12,l.top-200),C=Math.min(Math.max(12,l.left+l.width/2-Nt/2),window.innerWidth-Nt-12);T<=190&&l.top<212&&(window.innerWidth-l.right>=Nt+40?C=Math.min(l.right+26,window.innerWidth-Nt-12):l.left>=Nt+40&&(C=Math.max(12,l.left-Nt-26)),L=Math.max(12,l.top-Zt)),N={left:C,top:L,width:Nt}}return Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&l&&t.jsx("div",{className:"tour-hole",style:{left:l.left-Zt,top:l.top-Zt,width:l.width+Zt*2,height:l.height+Zt*2}}),(y||!l)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:N,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Rr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(Rr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>s(q=>Math.max(0,q-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(q=>q+1),children:d===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Go(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Yo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function dd(){var T,L;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:s,dispatch:l}=Z(),f=r?a:e,c=p.useMemo(()=>f.filter(C=>ut(C.date)===0&&C.kind==="target"),[f]),g=p.useMemo(()=>r?a.filter(C=>C.kind==="target"&&Te(C)===0).slice().sort((C,O)=>(O.date||"").localeCompare(C.date||"")):[],[a,r]),u=p.useMemo(()=>c.filter(C=>r?Te(C)===0:!Ue(C)),[c,r]),b=r?g:u,h=r?a.length-g.length:c.length-u.length,v=r?a.length:c.length,y=v?Math.min(100,h/v*100):100,m=p.useMemo(()=>Go(f),[f]),w=!!m&&ut(m)>0,E=p.useMemo(()=>w?f.filter(C=>(C.date||"").slice(0,10)===m):[],[f,m,w]),k=typeof((T=s.stats)==null?void 0:T.kept_today)=="number"?s.stats.kept_today:null,j=typeof((L=s.stats)==null?void 0:L.screened_today)=="number"?s.stats.screened_today:c.length;let N;w?N=o.morningLast(E.length,g.length,Yo(m,d)):r?N=o.morningThesis(j,g.length,k):c.length?h===0?N=o.goalSourced(c.length):h>=c.length?N=o.goalCleared:N=o.goalDone(h,c.length):N=o.goalSourced(0);const q=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&g.length&&l({type:"chainStart",queue:g.map(C=>C.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:q,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function pd(){const{t:e,st:a,dispatch:r,fund:n,data:o,mode:i,doSync:d,startTour:s}=Z(),l=i==="client",[f,c]=p.useState(!1),[g,u]=p.useState(""),b=()=>{!l||f||!n||(c(!0),u(""),ls(n).then(y=>{if(c(!1),y.pending){u(e.refreshSlow);return}if(!y.ok){y.error&&console.warn("[republish]",y.error),u(e.refreshKo);return}const m=y.entered??0,w=y.left??0;u(y.unchanged||!m&&!w?e.refreshSame:e.refreshDone(m,w)),o.refresh()}))},h=(n||"P").split(/\s+/).map(y=>y[0]).join("").slice(0,2).toUpperCase(),v=(()=>{const y=Date.parse(o.generatedAt||"");if(Number.isNaN(y))return"";const m=new Date(y),w=E=>String(E).padStart(2,"0");return`${w(m.getDate())}/${w(m.getMonth()+1)} à ${w(m.getHours())}:${w(m.getMinutes())}`})();return t.jsx("div",{className:"ident",children:t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:n?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:n||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:n?e.identTitle(n):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),v?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(v)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!l||f,onClick:b,children:f?"⏳":"📰"}),(f||!!g)&&t.jsxs("span",{className:"repubst",children:[f?e.refreshRun:g,!f&&t.jsx("button",{type:"button",onClick:()=>u(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!l,onClick:d,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:a.filters.search,onChange:y=>r({type:"filters",patch:{search:y.target.value}})})]})]})})}class Mt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,s=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);s&&(r[n++]=s),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*cd(e){for(const a of e)yield*a}function Qo(e){return Array.from(cd(e))}var Le=1e-6,Se=Math.PI,it=Se/2,Or=Se/4,lt=Se*2,vt=180/Se,et=Se/180,Fe=Math.abs,ud=Math.atan,da=Math.atan2,Oe=Math.cos,Me=Math.sin,md=Math.sign||function(e){return e>0?1:e<0?-1:0},_t=Math.sqrt;function fd(e){return e>1?0:e<-1?Se:Math.acos(e)}function pa(e){return e>1?it:e<-1?-it:Math.asin(e)}function st(){}function Ba(e,a){e&&Dr.hasOwnProperty(e.type)&&Dr[e.type](e,a)}var Mr={Feature:function(e,a){Ba(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ba(r[n].geometry,a)}},Dr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){vn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)vn(r[n],a,0)},Polygon:function(e,a){Ir(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Ir(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ba(r[n],a)}};function vn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Ir(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)vn(e[r],a,1);a.polygonEnd()}function Ut(e,a){e&&Mr.hasOwnProperty(e.type)?Mr[e.type](e,a):Ba(e,a)}function wn(e){return[da(e[1],e[0]),pa(e[2])]}function Wt(e){var a=e[0],r=e[1],n=Oe(r);return[n*Oe(a),n*Me(a),Me(r)]}function ka(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function $a(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function rn(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Ea(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function yn(e){var a=_t(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function kn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function En(e,a){return Fe(e)>Se&&(e-=Math.round(e/lt)*lt),[e,a]}En.invert=En;function hd(e,a,r){return(e%=lt)?a||r?kn(_r(e),Br(a,r)):_r(e):a||r?Br(a,r):En}function Pr(e){return function(a,r){return a+=e,Fe(a)>Se&&(a-=Math.round(a/lt)*lt),[a,r]}}function _r(e){var a=Pr(e);return a.invert=Pr(-e),a}function Br(e,a){var r=Oe(e),n=Me(e),o=Oe(a),i=Me(a);function d(s,l){var f=Oe(l),c=Oe(s)*f,g=Me(s)*f,u=Me(l),b=u*r+c*n;return[da(g*o-b*i,c*r-u*n),pa(b*o+g*i)]}return d.invert=function(s,l){var f=Oe(l),c=Oe(s)*f,g=Me(s)*f,u=Me(l),b=u*o-g*i;return[da(g*o+u*i,c*r+b*n),pa(b*r-c*n)]},d}function gd(e,a,r,n,o,i){if(r){var d=Oe(a),s=Me(a),l=n*r;o==null?(o=a+n*lt,i=a-l/2):(o=$r(d,o),i=$r(d,i),(n>0?o<i:o>i)&&(o+=n*lt));for(var f,c=o;n>0?c>i:c<i;c-=l)f=wn([d,-s*Oe(c),-s*Me(c)]),e.point(f[0],f[1])}}function $r(e,a){a=Wt(a),a[0]-=e,yn(a);var r=fd(-a[1]);return((-a[2]<0?-r:r)+lt-Le)%lt}function Ko(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:st,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ta(e,a){return Fe(e[0]-a[0])<Le&&Fe(e[1]-a[1])<Le}function ja(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Jo(e,a,r,n,o){var i=[],d=[],s,l;if(e.forEach(function(h){if(!((v=h.length-1)<=0)){var v,y=h[0],m=h[v],w;if(Ta(y,m)){if(!y[2]&&!m[2]){for(o.lineStart(),s=0;s<v;++s)o.point((y=h[s])[0],y[1]);o.lineEnd();return}m[0]+=2*Le}i.push(w=new ja(y,h,null,!0)),d.push(w.o=new ja(y,null,w,!1)),i.push(w=new ja(m,h,null,!1)),d.push(w.o=new ja(m,null,w,!0))}}),!!i.length){for(d.sort(a),Ur(i),Ur(d),s=0,l=d.length;s<l;++s)d[s].e=r=!r;for(var f=i[0],c,g;;){for(var u=f,b=!0;u.v;)if((u=u.n)===f)return;c=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,l=c.length;s<l;++s)o.point((g=c[s])[0],g[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(c=u.p.z,s=c.length-1;s>=0;--s)o.point((g=c[s])[0],g[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Ur(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function on(e){return Fe(e[0])<=Se?e[0]:md(e[0])*((Fe(e[0])+Se)%lt-Se)}function xd(e,a){var r=on(a),n=a[1],o=Me(n),i=[Me(r),-Oe(r),0],d=0,s=0,l=new Mt;o===1?n=it+Le:o===-1&&(n=-it-Le);for(var f=0,c=e.length;f<c;++f)if(u=(g=e[f]).length)for(var g,u,b=g[u-1],h=on(b),v=b[1]/2+Or,y=Me(v),m=Oe(v),w=0;w<u;++w,h=k,y=N,m=q,b=E){var E=g[w],k=on(E),j=E[1]/2+Or,N=Me(j),q=Oe(j),T=k-h,L=T>=0?1:-1,C=L*T,O=C>Se,U=y*N;if(l.add(da(U*L*Me(C),m*q+U*Oe(C))),d+=O?T+L*lt:T,O^h>=r^k>=r){var V=$a(Wt(b),Wt(E));yn(V);var I=$a(i,V);yn(I);var x=(O^T>=0?-1:1)*pa(I[2]);(n>x||n===x&&(V[0]||V[1]))&&(s+=O^T>=0?1:-1)}}return(d<-Le||d<Le&&l<-1e-12)^s&1}function Xo(e,a,r,n){return function(o){var i=a(o),d=Ko(),s=a(d),l=!1,f,c,g,u={point:b,lineStart:v,lineEnd:y,polygonStart:function(){u.point=m,u.lineStart=w,u.lineEnd=E,c=[],f=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=y,c=Qo(c);var k=xd(f,n);c.length?(l||(o.polygonStart(),l=!0),Jo(c,vd,k,r,o)):k&&(l||(o.polygonStart(),l=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),l&&(o.polygonEnd(),l=!1),c=f=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function h(k,j){i.point(k,j)}function v(){u.point=h,i.lineStart()}function y(){u.point=b,i.lineEnd()}function m(k,j){g.push([k,j]),s.point(k,j)}function w(){s.lineStart(),g=[]}function E(){m(g[0][0],g[0][1]),s.lineEnd();var k=s.clean(),j=d.result(),N,q=j.length,T,L,C;if(g.pop(),f.push(g),g=null,!!q){if(k&1){if(L=j[0],(T=L.length-1)>0){for(l||(o.polygonStart(),l=!0),o.lineStart(),N=0;N<T;++N)o.point((C=L[N])[0],C[1]);o.lineEnd()}return}q>1&&k&2&&j.push(j.pop().concat(j.shift())),c.push(j.filter(bd))}}return u}}function bd(e){return e.length>1}function vd(e,a){return((e=e.x)[0]<0?e[1]-it-Le:it-e[1])-((a=a.x)[0]<0?a[1]-it-Le:it-a[1])}const Hr=Xo(function(){return!0},wd,kd,[-Se,-it]);function wd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var s=i>0?Se:-Se,l=Fe(i-a);Fe(l-Se)<Le?(e.point(a,r=(r+d)/2>0?it:-it),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&l>=Se&&(Fe(a-n)<Le&&(a-=n*Le),Fe(i-s)<Le&&(i-=s*Le),r=yd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=d),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function yd(e,a,r,n){var o,i,d=Me(e-r);return Fe(d)>Le?ud((Me(a)*(i=Oe(n))*Me(r)-Me(n)*(o=Oe(a))*Me(e))/(o*i*d)):(a+n)/2}function kd(e,a,r,n){var o;if(e==null)o=r*it,n.point(-Se,o),n.point(0,o),n.point(Se,o),n.point(Se,0),n.point(Se,-o),n.point(0,-o),n.point(-Se,-o),n.point(-Se,0),n.point(-Se,o);else if(Fe(e[0]-a[0])>Le){var i=e[0]<a[0]?Se:-Se;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Ed(e){var a=Oe(e),r=2*et,n=a>0,o=Fe(a)>Le;function i(c,g,u,b){gd(b,e,r,u,c,g)}function d(c,g){return Oe(c)*Oe(g)>a}function s(c){var g,u,b,h,v;return{lineStart:function(){h=b=!1,v=1},point:function(y,m){var w=[y,m],E,k=d(y,m),j=n?k?0:f(y,m):k?f(y+(y<0?Se:-Se),m):0;if(!g&&(h=b=k)&&c.lineStart(),k!==b&&(E=l(g,w),(!E||Ta(g,E)||Ta(w,E))&&(w[2]=1)),k!==b)v=0,k?(c.lineStart(),E=l(w,g),c.point(E[0],E[1])):(E=l(g,w),c.point(E[0],E[1],2),c.lineEnd()),g=E;else if(o&&g&&n^k){var N;!(j&u)&&(N=l(w,g,!0))&&(v=0,n?(c.lineStart(),c.point(N[0][0],N[0][1]),c.point(N[1][0],N[1][1]),c.lineEnd()):(c.point(N[1][0],N[1][1]),c.lineEnd(),c.lineStart(),c.point(N[0][0],N[0][1],3)))}k&&(!g||!Ta(g,w))&&c.point(w[0],w[1]),g=w,b=k,u=j},lineEnd:function(){b&&c.lineEnd(),g=null},clean:function(){return v|(h&&b)<<1}}}function l(c,g,u){var b=Wt(c),h=Wt(g),v=[1,0,0],y=$a(b,h),m=ka(y,y),w=y[0],E=m-w*w;if(!E)return!u&&c;var k=a*m/E,j=-a*w/E,N=$a(v,y),q=Ea(v,k),T=Ea(y,j);rn(q,T);var L=N,C=ka(q,L),O=ka(L,L),U=C*C-O*(ka(q,q)-1);if(!(U<0)){var V=_t(U),I=Ea(L,(-C-V)/O);if(rn(I,q),I=wn(I),!u)return I;var x=c[0],F=g[0],z=c[1],$=g[1],G;F<x&&(G=x,x=F,F=G);var S=F-x,P=Fe(S-Se)<Le,D=P||S<Le;if(!P&&$<z&&(G=z,z=$,$=G),D?P?z+$>0^I[1]<(Fe(I[0]-x)<Le?z:$):z<=I[1]&&I[1]<=$:S>Se^(x<=I[0]&&I[0]<=F)){var Q=Ea(L,(-C+V)/O);return rn(Q,q),[I,wn(Q)]}}}function f(c,g){var u=n?e:Se-e,b=0;return c<-u?b|=1:c>u&&(b|=2),g<-u?b|=4:g>u&&(b|=8),b}return Xo(d,s,i,n?[0,-e]:[-Se,e-Se])}function jd(e,a,r,n,o,i){var d=e[0],s=e[1],l=a[0],f=a[1],c=0,g=1,u=l-d,b=f-s,h;if(h=r-d,!(!u&&h>0)){if(h/=u,u<0){if(h<c)return;h<g&&(g=h)}else if(u>0){if(h>g)return;h>c&&(c=h)}if(h=o-d,!(!u&&h<0)){if(h/=u,u<0){if(h>g)return;h>c&&(c=h)}else if(u>0){if(h<c)return;h<g&&(g=h)}if(h=n-s,!(!b&&h>0)){if(h/=b,b<0){if(h<c)return;h<g&&(g=h)}else if(b>0){if(h>g)return;h>c&&(c=h)}if(h=i-s,!(!b&&h<0)){if(h/=b,b<0){if(h>g)return;h>c&&(c=h)}else if(b>0){if(h<c)return;h<g&&(g=h)}return c>0&&(e[0]=d+c*u,e[1]=s+c*b),g<1&&(a[0]=d+g*u,a[1]=s+g*b),!0}}}}}var ta=1e9,Na=-ta;function Nd(e,a,r,n){function o(f,c){return e<=f&&f<=r&&a<=c&&c<=n}function i(f,c,g,u){var b=0,h=0;if(f==null||(b=d(f,g))!==(h=d(c,g))||l(f,c)<0^g>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+g+4)%4)!==h);else u.point(c[0],c[1])}function d(f,c){return Fe(f[0]-e)<Le?c>0?0:3:Fe(f[0]-r)<Le?c>0?2:1:Fe(f[1]-a)<Le?c>0?1:0:c>0?3:2}function s(f,c){return l(f.x,c.x)}function l(f,c){var g=d(f,1),u=d(c,1);return g!==u?g-u:g===0?c[1]-f[1]:g===1?f[0]-c[0]:g===2?f[1]-c[1]:c[0]-f[0]}return function(f){var c=f,g=Ko(),u,b,h,v,y,m,w,E,k,j,N,q={point:T,lineStart:U,lineEnd:V,polygonStart:C,polygonEnd:O};function T(x,F){o(x,F)&&c.point(x,F)}function L(){for(var x=0,F=0,z=b.length;F<z;++F)for(var $=b[F],G=1,S=$.length,P=$[0],D,Q,H=P[0],ce=P[1];G<S;++G)D=H,Q=ce,P=$[G],H=P[0],ce=P[1],Q<=n?ce>n&&(H-D)*(n-Q)>(ce-Q)*(e-D)&&++x:ce<=n&&(H-D)*(n-Q)<(ce-Q)*(e-D)&&--x;return x}function C(){c=g,u=[],b=[],N=!0}function O(){var x=L(),F=N&&x,z=(u=Qo(u)).length;(F||z)&&(f.polygonStart(),F&&(f.lineStart(),i(null,null,1,f),f.lineEnd()),z&&Jo(u,s,x,i,f),f.polygonEnd()),c=f,u=b=h=null}function U(){q.point=I,b&&b.push(h=[]),j=!0,k=!1,w=E=NaN}function V(){u&&(I(v,y),m&&k&&g.rejoin(),u.push(g.result())),q.point=T,k&&c.lineEnd()}function I(x,F){var z=o(x,F);if(b&&h.push([x,F]),j)v=x,y=F,m=z,j=!1,z&&(c.lineStart(),c.point(x,F));else if(z&&k)c.point(x,F);else{var $=[w=Math.max(Na,Math.min(ta,w)),E=Math.max(Na,Math.min(ta,E))],G=[x=Math.max(Na,Math.min(ta,x)),F=Math.max(Na,Math.min(ta,F))];jd($,G,e,a,r,n)?(k||(c.lineStart(),c.point($[0],$[1])),c.point(G[0],G[1]),z||c.lineEnd(),N=!1):z&&(c.lineStart(),c.point(x,F),N=!1)}w=x,E=F,k=z}return q}}const jn=e=>e;var sn=new Mt,Nn=new Mt,Zo,ei,Sn,zn,yt={point:st,lineStart:st,lineEnd:st,polygonStart:function(){yt.lineStart=Sd,yt.lineEnd=Cd},polygonEnd:function(){yt.lineStart=yt.lineEnd=yt.point=st,sn.add(Fe(Nn)),Nn=new Mt},result:function(){var e=sn/2;return sn=new Mt,e}};function Sd(){yt.point=zd}function zd(e,a){yt.point=ti,Zo=Sn=e,ei=zn=a}function ti(e,a){Nn.add(zn*e-Sn*a),Sn=e,zn=a}function Cd(){ti(Zo,ei)}var Gt=1/0,Ua=Gt,ca=-Gt,Ha=ca,Va={point:Ad,lineStart:st,lineEnd:st,polygonStart:st,polygonEnd:st,result:function(){var e=[[Gt,Ua],[ca,Ha]];return ca=Ha=-(Ua=Gt=1/0),e}};function Ad(e,a){e<Gt&&(Gt=e),e>ca&&(ca=e),a<Ua&&(Ua=a),a>Ha&&(Ha=a)}var Cn=0,An=0,aa=0,Wa=0,Ga=0,Ht=0,qn=0,Tn=0,na=0,ai,ni,gt,xt,ot={point:Dt,lineStart:Vr,lineEnd:Wr,polygonStart:function(){ot.lineStart=Ld,ot.lineEnd=Fd},polygonEnd:function(){ot.point=Dt,ot.lineStart=Vr,ot.lineEnd=Wr},result:function(){var e=na?[qn/na,Tn/na]:Ht?[Wa/Ht,Ga/Ht]:aa?[Cn/aa,An/aa]:[NaN,NaN];return Cn=An=aa=Wa=Ga=Ht=qn=Tn=na=0,e}};function Dt(e,a){Cn+=e,An+=a,++aa}function Vr(){ot.point=qd}function qd(e,a){ot.point=Td,Dt(gt=e,xt=a)}function Td(e,a){var r=e-gt,n=a-xt,o=_t(r*r+n*n);Wa+=o*(gt+e)/2,Ga+=o*(xt+a)/2,Ht+=o,Dt(gt=e,xt=a)}function Wr(){ot.point=Dt}function Ld(){ot.point=Rd}function Fd(){ri(ai,ni)}function Rd(e,a){ot.point=ri,Dt(ai=gt=e,ni=xt=a)}function ri(e,a){var r=e-gt,n=a-xt,o=_t(r*r+n*n);Wa+=o*(gt+e)/2,Ga+=o*(xt+a)/2,Ht+=o,o=xt*e-gt*a,qn+=o*(gt+e),Tn+=o*(xt+a),na+=o*3,Dt(gt=e,xt=a)}function oi(e){this._context=e}oi.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,lt);break}}},result:st};var Ln=new Mt,ln,ii,si,ra,oa,ua={point:st,lineStart:function(){ua.point=Od},lineEnd:function(){ln&&li(ii,si),ua.point=st},polygonStart:function(){ln=!0},polygonEnd:function(){ln=null},result:function(){var e=+Ln;return Ln=new Mt,e}};function Od(e,a){ua.point=li,ii=ra=e,si=oa=a}function li(e,a){ra-=e,oa-=a,Ln.add(_t(ra*ra+oa*oa)),ra=e,oa=a}let Gr,Ya,Yr,Qr;class Kr{constructor(a){this._append=a==null?di:Md(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Yr||this._append!==Ya){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Yr=n,Ya=this._append,Qr=this._,this._=o}this._+=Qr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function di(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Md(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return di;if(a!==Gr){const r=10**a;Gr=a,Ya=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ya}function Dd(e,a){let r=3,n=4.5,o,i;function d(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Ut(s,o(i))),i.result()}return d.area=function(s){return Ut(s,o(yt)),yt.result()},d.measure=function(s){return Ut(s,o(ua)),ua.result()},d.bounds=function(s){return Ut(s,o(Va)),Va.result()},d.centroid=function(s){return Ut(s,o(ot)),ot.result()},d.projection=function(s){return arguments.length?(o=s==null?(e=null,jn):(e=s).stream,d):e},d.context=function(s){return arguments.length?(i=s==null?(a=null,new Kr(r)):new oi(a=s),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),d):n},d.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const l=Math.floor(s);if(!(l>=0))throw new RangeError(`invalid digits: ${s}`);r=l}return a===null&&(i=new Kr(r)),d},d.projection(e).digits(r).context(a)}function Un(e){return function(a){var r=new Fn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Fn(){}Fn.prototype={constructor:Fn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Hn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ut(r,e.stream(Va)),a(Va.result()),n!=null&&e.clipExtent(n),e}function pi(e,a,r){return Hn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,l=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([s,l])},r)}function Id(e,a,r){return pi(e,[[0,0],a],r)}function Pd(e,a,r){return Hn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([d,s])},r)}function _d(e,a,r){return Hn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,s])},r)}var Jr=16,Bd=Oe(30*et);function Xr(e,a){return+a?Ud(e,a):$d(e)}function $d(e){return Un({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Ud(e,a){function r(n,o,i,d,s,l,f,c,g,u,b,h,v,y){var m=f-n,w=c-o,E=m*m+w*w;if(E>4*a&&v--){var k=d+u,j=s+b,N=l+h,q=_t(k*k+j*j+N*N),T=pa(N/=q),L=Fe(Fe(N)-1)<Le||Fe(i-g)<Le?(i+g)/2:da(j,k),C=e(L,T),O=C[0],U=C[1],V=O-n,I=U-o,x=w*V-m*I;(x*x/E>a||Fe((m*V+w*I)/E-.5)>.3||d*u+s*b+l*h<Bd)&&(r(n,o,i,d,s,l,O,U,L,k/=q,j/=q,N,v,y),y.point(O,U),r(O,U,L,k,j,N,f,c,g,u,b,h,v,y))}}return function(n){var o,i,d,s,l,f,c,g,u,b,h,v,y={point:m,lineStart:w,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=j},polygonEnd:function(){n.polygonEnd(),y.lineStart=w}};function m(T,L){T=e(T,L),n.point(T[0],T[1])}function w(){g=NaN,y.point=E,n.lineStart()}function E(T,L){var C=Wt([T,L]),O=e(T,L);r(g,u,c,b,h,v,g=O[0],u=O[1],c=T,b=C[0],h=C[1],v=C[2],Jr,n),n.point(g,u)}function k(){y.point=m,n.lineEnd()}function j(){w(),y.point=N,y.lineEnd=q}function N(T,L){E(o=T,L),i=g,d=u,s=b,l=h,f=v,y.point=E}function q(){r(g,u,c,b,h,v,i,d,o,s,l,f,Jr,n),y.lineEnd=k,k()}return y}}var Hd=Un({point:function(e,a){this.stream.point(e*et,a*et)}});function Vd(e){return Un({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Wd(e,a,r,n,o){function i(d,s){return d*=n,s*=o,[a+e*d,r-e*s]}return i.invert=function(d,s){return[(d-a)/e*n,(r-s)/e*o]},i}function Zr(e,a,r,n,o,i){if(!i)return Wd(e,a,r,n,o);var d=Oe(i),s=Me(i),l=d*e,f=s*e,c=d/e,g=s/e,u=(s*r-d*a)/e,b=(s*a+d*r)/e;function h(v,y){return v*=n,y*=o,[l*v-f*y+a,r-f*v-l*y]}return h.invert=function(v,y){return[n*(c*v-g*y+u),o*(b-g*v-c*y)]},h}function Gd(e){return Yd(function(){return e})()}function Yd(e){var a,r=150,n=480,o=250,i=0,d=0,s=0,l=0,f=0,c,g=0,u=1,b=1,h=null,v=Hr,y=null,m,w,E,k=jn,j=.5,N,q,T,L,C;function O(x){return T(x[0]*et,x[1]*et)}function U(x){return x=T.invert(x[0],x[1]),x&&[x[0]*vt,x[1]*vt]}O.stream=function(x){return L&&C===x?L:L=Hd(Vd(c)(v(N(k(C=x)))))},O.preclip=function(x){return arguments.length?(v=x,h=void 0,I()):v},O.postclip=function(x){return arguments.length?(k=x,y=m=w=E=null,I()):k},O.clipAngle=function(x){return arguments.length?(v=+x?Ed(h=x*et):(h=null,Hr),I()):h*vt},O.clipExtent=function(x){return arguments.length?(k=x==null?(y=m=w=E=null,jn):Nd(y=+x[0][0],m=+x[0][1],w=+x[1][0],E=+x[1][1]),I()):y==null?null:[[y,m],[w,E]]},O.scale=function(x){return arguments.length?(r=+x,V()):r},O.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],V()):[n,o]},O.center=function(x){return arguments.length?(i=x[0]%360*et,d=x[1]%360*et,V()):[i*vt,d*vt]},O.rotate=function(x){return arguments.length?(s=x[0]%360*et,l=x[1]%360*et,f=x.length>2?x[2]%360*et:0,V()):[s*vt,l*vt,f*vt]},O.angle=function(x){return arguments.length?(g=x%360*et,V()):g*vt},O.reflectX=function(x){return arguments.length?(u=x?-1:1,V()):u<0},O.reflectY=function(x){return arguments.length?(b=x?-1:1,V()):b<0},O.precision=function(x){return arguments.length?(N=Xr(q,j=x*x),I()):_t(j)},O.fitExtent=function(x,F){return pi(O,x,F)},O.fitSize=function(x,F){return Id(O,x,F)},O.fitWidth=function(x,F){return Pd(O,x,F)},O.fitHeight=function(x,F){return _d(O,x,F)};function V(){var x=Zr(r,0,0,u,b,g).apply(null,a(i,d)),F=Zr(r,n-x[0],o-x[1],u,b,g);return c=hd(s,l,f),q=kn(a,F),T=kn(c,q),N=Xr(q,j),I()}function I(){return L=C=null,O}return function(){return a=e.apply(this,arguments),O.invert=a.invert&&U,V()}}function ci(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}ci.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Fe(o)>Le&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Qd(){return Gd(ci).scale(175.295)}function Kd(e){return e}function Jd(e){if(e==null)return Kd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(s,l){l||(a=r=0);var f=2,c=s.length,g=new Array(c);for(g[0]=(a+=s[0])*n+i,g[1]=(r+=s[1])*o+d;f<c;)g[f]=s[f],++f;return g}}function Xd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Zd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return eo(e,r)})}:eo(e,a)}function eo(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=ep(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function ep(e,a){var r=Jd(e.transform),n=e.arcs;function o(c,g){g.length&&g.pop();for(var u=n[c<0?~c:c],b=0,h=u.length;b<h;++b)g.push(r(u[b],b));c<0&&Xd(g,h)}function i(c){return r(c)}function d(c){for(var g=[],u=0,b=c.length;u<b;++u)o(c[u],g);return g.length<2&&g.push(g[0]),g}function s(c){for(var g=d(c);g.length<4;)g.push(g[0]);return g}function l(c){return c.map(s)}function f(c){var g=c.type,u;switch(g){case"GeometryCollection":return{type:g,geometries:c.geometries.map(f)};case"Point":u=i(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(i);break;case"LineString":u=d(c.arcs);break;case"MultiLineString":u=c.arcs.map(d);break;case"Polygon":u=l(c.arcs);break;case"MultiPolygon":u=c.arcs.map(l);break;default:return null}return{type:g,coordinates:u}}return f(a)}const ui={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},tp=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ap(e,a,r){const n=ui[e];if(!n||!n.length)return-1;const o=tp(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let Sa=null;function np(){return Sa||(Sa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Zd(r,n),i=Qd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Dd(i),s=(o.features||[]).filter(c=>{var g;return(((g=c.properties)==null?void 0:g.name)||"")!=="Antarctica"}).map(c=>{var b;const g=((b=c.properties)==null?void 0:b.name)||"",u=d(c)||"";return u?{i2:ds(g)||null,n:g,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const l={};for(const[c,g]of Object.entries(ps)){const u=i(g);u&&(l[c]={x:u[0],y:u[1]})}const f={};for(const[c,g]of Object.entries(ui)){const u=g.map(b=>i(b.ll)).filter(b=>!!b).map(([b,h])=>({x:b,y:h}));u.length&&(f[c]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:l,metros:f}}catch{return null}})(),Sa)}function rp(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return np().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const op="8 40 984 210",ip={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},to=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function ao(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function sp(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const d=()=>{var f;if(!o)return;const l=(f=e.current)==null?void 0:f.getScreenCTM();l&&l.a>0?n(l.a):i=requestAnimationFrame(d)};d();const s=new ResizeObserver(()=>d());return e.current&&s.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function no({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function lp(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:s,t:l,data:f,dossiers:c,source:g}=Z(),u=f.loading&&!c.length,b=p.useRef(null),h=p.useRef(null),v=rp(e.continent==="monde"),y=e.continent==="monde"?v:Dn.find(x=>x.key===e.continent)||null,m=sp(b,e.continent+":"+e.mapFolded+":"+!!y),[w,E]=p.useState(new Map),[k,j]=p.useState(null);p.useEffect(()=>{const x=b.current;if(!x)return;const F=new Map;x.querySelectorAll("path[data-i2]").forEach(z=>{const $=z.dataset.i2;if($)try{const G=z.getBBox();G.width>0&&F.set($,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),E(F)},[e.continent,m,y]);const N=p.useMemo(()=>r.filter(x=>x.cc),[r]),q=p.useMemo(()=>{const x=new Map;return N.forEach(F=>x.set(F.cc,(x.get(F.cc)||0)+1)),x},[N]),T=e.continent==="monde"&&v?v.anchors:null,L=e.continent==="monde"&&v?v.metros:null,C=p.useMemo(()=>N.map(x=>{const F=ao(x.name||x.id||""),z=ao((x.id||x.name||"")+"·y");if(T&&x.cc){const D=L?L[x.cc]:void 0;if(D&&D.length){const H=ap(x.cc,x.city,F);if(H>=0&&D[H])return{d:x,x:D[H].x+(F-.5)*5,y:D[H].y+(z-.5)*5}}const Q=T[x.cc];if(Q)return{d:x,x:Q.x+(F-.5)*10,y:Q.y+(z-.5)*10}}const $=x.cc?w.get(x.cc):void 0;if(!$)return null;const G=ip[`${e.continent}:${x.cc||""}`];if(G)return{d:x,x:$.x+$.w*(G.fx+(F-.5)*G.sx),y:$.y+$.h*(G.fy+(z-.5)*G.sy)};const S=(F-.5)*Math.min($.w*.55,60),P=(z-.5)*Math.min($.h*.55,60);return{d:x,x:$.x+$.w/2+S,y:$.y+$.h/2+P}}).filter(x=>!!x),[N,w,T,L,e.continent]),O=x=>m>0?x/m:x,U=p.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:to[x],fr:l.plabels[x],en:l.plabels[x],n:r.filter(F=>F.kind==="target"&&Te(F)===x).length})).filter(x=>x.n>0):or.map((x,F)=>({...x,n:r.filter(z=>ir(z)===F).length})),[r,n,l.plabels]),V=i?d.get(i):null,I=V?C.find(x=>x.d.id===V.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:h,children:[u&&t.jsx(no,{msgs:l.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?op:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?y.fr:y.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:y.countries.map((x,F)=>t.jsx("g",{className:"ct"+(x.i2&&q.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},F))}),t.jsx("g",{children:C.map(x=>{const F=or[ir(x.d)],z=!!_e(x.d),$=x.d.kind==="target",G=n&&$?to[Te(x.d)]:F.c,S=!n&&Ue(x.d);return t.jsxs("g",{className:"co"+(S?" done":""),onMouseEnter:()=>{var Q,H;const P=(Q=h.current)==null?void 0:Q.getBoundingClientRect(),D=(H=b.current)==null?void 0:H.createSVGPoint();if(D&&b.current&&P){D.x=x.x,D.y=x.y;const ce=D.matrixTransform(b.current.getScreenCTM());j({x:ce.x-P.left,y:ce.y-P.top,label:x.d.name+" · "+(Kt(x.d.cc,s)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var Q;if(g==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const P=(Q=b.current)==null?void 0:Q.createSVGPoint();let D=null;if(P&&b.current){P.x=x.x,P.y=x.y;const H=P.matrixTransform(b.current.getScreenCTM());D={x:H.x,y:H.y}}a({type:"popup",id:x.d.id,anchor:D})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:O(Math.max(11,F.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:O(F.px),fill:G,stroke:z?"#E5484D":"#ffffff",strokeWidth:O(z?2.2:1.3)})]},x.d.id||x.d.name)})}),I&&t.jsx("circle",{className:"ring on",cx:I.x,cy:I.y,r:O(13),fill:"none",stroke:"#16233A",strokeWidth:O(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:U.map((x,F)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),s==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},F))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",l.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:h,children:t.jsx(no,{msgs:l.loadMsgs})})}function dp(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function mi({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:s}=Z(),l=a.filters,[f,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null),h=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(I=>I.continent===a.continent),[n,a.continent]),y=I=>v.filter(x=>I!=="country"&&l.country.length&&!l.country.includes(x.cc||"")?!1:_a(x,l,i,I==="country"?void 0:I)),m=I=>!i||I.kind!=="op",w=p.useMemo(()=>{const I=y("win").filter(m),x=F=>I.filter(z=>(z.date?Math.max(0,Math.floor((Date.now()-Date.parse(z.date))/864e5)):9999)<=F).length;return[x(0),x(7),x(30),I.length]},[v,l,i]),E=p.useMemo(()=>l.day?y("win").filter(m).filter(I=>(I.date||"").slice(0,10)===l.day).length:0,[v,l,i]),k=(l.signalOnly?1:0)+l.sector.length+l.market.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+l.crible.length,j=k+(l.acquirer.trim()?1:0)+(l.day||l.win!=="all"?1:0)+(l.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!f&&!g)return;const I=F=>{var $,G;const z=F.target;f&&!(($=b.current)!=null&&$.contains(z))&&c(!1),g&&!((G=h.current)!=null&&G.contains(z))&&u(!1)},x=F=>{F.key==="Escape"&&(c(!1),u(!1))};return document.addEventListener("mousedown",I),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",I),document.removeEventListener("keydown",x)}},[f,g]);const N=(I,x,F,z="fbtn")=>t.jsxs("button",{type:"button",className:z,"aria-expanded":a.openFacet===I,onClick:()=>r({type:"openFacet",facet:I}),children:[t.jsx("span",{className:"fl",children:x}),F>0&&t.jsx("span",{className:"n",children:F}),t.jsx("span",{className:"cv",children:"▾"})]},I),q=["1","7","30","all"],T=Math.max(0,q.indexOf(l.win||"all")),L=l.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(dp(l.day,s))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:h,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>u(I=>!I),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:w[T]}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:q.map((I,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":l.win===I,onClick:()=>{r({type:"filters",patch:{win:I}}),u(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:w[x]})]},I))})]}):t.jsx("div",{className:"seg",children:q.map((I,x)=>t.jsxs("button",{type:"button","aria-pressed":l.win===I,onClick:()=>r({type:"filters",patch:{win:I}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:w[x]})]},I))}),C=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:l.search,onChange:I=>r({type:"filters",patch:{search:I.target.value}})})]}),O=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),l.signalOnly&&t.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),l.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:l.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",o.fSector,l.sector.length),(n.some(I=>!!I.market)||l.market.length>0)&&N("mar",o.fMarket,l.market.length),N("pay",o.fCountry,l.country.length),N("det",o.fEngine,l.engine.length),N("sta",o.fStage,l.stage.length),i&&N("crib",o.fVerdict,l.crible.length),i&&N("ang","Angle",l.angle.length),i&&N("mem","Mémo",l.memoLevel.length)]}),U=(I=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),I&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),V=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{c(I=>!I),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:O})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(l.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:L}),t.jsxs("div",{className:"fstrip-b",children:[C,V,U(!1)]})]}),a.openFacet&&t.jsx(ro,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[L,C,O,t.jsx("span",{className:"fgrow"}),U()]}),a.openFacet&&t.jsx(ro,{poolFor:y})]})}function ro({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=Z(),s=a.filters,l=a.openFacet,{title:f,cols:c,options:g}=p.useMemo(()=>{if(l==="sig"){const y=e("signal").filter(E=>_e(E)),m=new Map;y.forEach(E=>{const k=E.engine||"";m.set(k,(m.get(k)||0)+1)});const w=[{v:"*",label:n.fpSigAll,n:y.length,html:!0,on:s.signalOnly&&!s.signalEngines.length},...gn([...m.keys()],o).map(E=>({v:E,label:Ot(E)+" "+tt(E,o),n:m.get(E)||0,html:!1,on:s.signalOnly&&s.signalEngines.includes(E)}))];return{title:n.fpSigTitle,cols:2,options:w}}if(l==="crib"){const y=e("crible").filter(w=>!i||yo(w,a.ptab,d.favIds)),m=new Map;return y.forEach(w=>{const E=ko(w);E&&E!=="NEW"&&m.set(E,(m.get(E)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...m.entries()].sort((w,E)=>(sr[w[0]]??9)-(sr[E[0]]??9)||E[1]-w[1]).map(([w,E])=>({v:w,label:'<span class="fdot" style="background:'+(cs[w]||"#94A3B8")+'"></span>'+w,n:E,html:!0,on:s.crible.includes(w)}))}}if(l==="sec"){const y=e("sector"),m=new Map;return y.forEach(w=>{w.sector&&m.set(w.sector,(m.get(w.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...m.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:w,n:E,html:!1,on:s.sector.includes(w)}))}}if(l==="mar"){const y=e("market"),m=new Map;return y.forEach(w=>{w.market&&m.set(w.market,(m.get(w.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...m.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:w,n:E,html:!1,on:s.market.includes(w)}))}}if(l==="pay"){const y=e("country"),m=new Map;return y.forEach(w=>{w.cc&&m.set(w.cc,(m.get(w.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...m.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:Kt(w,o)||w,n:E,html:!1,on:s.country.includes(w)}))}}if(l==="det"){const y=e("engine"),m=new Map;return y.forEach(w=>{w.engine&&m.set(w.engine,(m.get(w.engine)||0)+1)}),{title:n.fEngine,cols:2,options:gn([...m.keys()],o).map(w=>({v:w,label:Ot(w)+" "+tt(w,o)+' <span style="color:var(--dim);font-size:10px">· '+us(ms(w),o)+"</span>",n:m.get(w)||0,html:!0,on:s.engine.includes(w)}))}}if(l==="ang"){const y=e("angle"),m=new Map;return y.forEach(w=>{w.angle&&m.set(w.angle,(m.get(w.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...m.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:w.replace(/[_-]+/g," "),n:E,html:!1,on:s.angle.includes(w)}))}}if(l==="mem"){const y=e("memoLevel"),m=new Map;y.forEach(E=>{if(E.kind==="target"){const k=Mn(E);m.set(k,(m.get(k)||0)+1)}});const w=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(E=>({v:String(E),label:w[E],n:m.get(E)||0,html:!1,on:s.memoLevel.includes(E)}))}}const h=e("stage"),v=new Map;return h.forEach(y=>{y.stage&&v.set(y.stage,(v.get(y.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...v.entries()].sort((y,m)=>m[1]-y[1]).map(([y,m])=>({v:y,label:y,n:m,html:!1,on:s.stage.includes(y)}))}},[l,a,o]),u=h=>{if(l==="sig"){if(h==="*")r({type:"filters",patch:{signalOnly:!(s.signalOnly&&!s.signalEngines.length),signalEngines:[]}});else{const y=s.signalEngines.includes(h)?s.signalEngines.filter(m=>m!==h):[...s.signalEngines,h];r({type:"filters",patch:{signalOnly:!0,signalEngines:y}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(h)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage",value:h})},b=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:f}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(h=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":h.on,onClick:()=>u(h.v),children:[t.jsx("span",{className:"bx"}),h.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:h.label}}):t.jsx("span",{className:"l",children:h.label}),t.jsx("span",{className:"n",children:h.n})]},h.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function fi({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:s}=Z(),l=p.useMemo(()=>{const b={};return r.forEach(h=>{_a(h,n.filters,i)&&(b.monde=(b.monde||0)+1,h.continent&&(b[h.continent]=(b[h.continent]||0)+1))}),b},[r,n.filters,i]),[f,c]=p.useState(!1),g=p.useRef(null);p.useEffect(()=>{if(!f)return;const b=v=>{var y;(y=g.current)!=null&&y.contains(v.target)||c(!1)},h=v=>{v.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",h)}},[f]);const u=b=>{const h=Dn.find(v=>v.key===b);return b==="monde"?s.contWorld:d==="fr"?h.fr:h.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:g,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:l[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:lr.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:s.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:s.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[lr.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:s.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:s.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]})]})}function Rn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function hi(e){return"atl2:evalq:"+(e||"anon")}function pp(e,a){const r=hi(e),n=Rn(r),o=new Set(n.map(s=>(s.name||"").trim().toLowerCase())),i=a.map(s=>(s||"").trim()).filter(s=>s&&!o.has(s.toLowerCase())).map(s=>({name:s,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function cp(){const{t:e,lang:a,data:r,dossiers:n}=Z(),o=r.session.token||"",i=hi(o),[d,s]=p.useState(()=>Rn(i)),l=p.useRef(!1),[f,c]=p.useState(!1);p.useEffect(()=>{try{const S=d.slice(0,30).map(({descBusy:P,evalBusy:D,...Q})=>Q);localStorage.setItem(i,JSON.stringify(S)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[d,i]),p.useEffect(()=>{const S=()=>{if(l.current)return;const P=Rn(i);s(D=>JSON.stringify(D.map(({descBusy:Q,evalBusy:H,...ce})=>ce))===JSON.stringify(P)?D:P)};return window.addEventListener("atl2:evalq",S),window.addEventListener("storage",S),()=>{window.removeEventListener("atl2:evalq",S),window.removeEventListener("storage",S)}},[i]);const[g,u]=p.useState([]),[b,h]=p.useState(""),[v,y]=p.useState(!1),[m,w]=p.useState(!1),[E,k]=p.useState(""),j=p.useCallback((S,P)=>s(D=>D.map((Q,H)=>H===S?{...Q,...P}:Q)),[]),N=p.useCallback((S,P)=>{const D=P.trim();D&&(j(S,{name:D,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),In(D).then(Q=>{const H=Q.candidates||[];Q.website?j(S,{site:Q.website,status:"ready"}):H.length===1?j(S,{site:H[0].url,status:"ready"}):H.length>1?j(S,{status:"pick",candidates:H.slice(0,6)}):j(S,{status:"ready"})}).catch(()=>j(S,{status:"ready"})))},[j]),q=p.useCallback((S,P,D)=>{j(S,{descBusy:!0}),jo(o,P,D).then(Q=>{if(Q.quota){c(!0),j(S,{descBusy:!1,descDone:!0});return}const H=Q.blocs||{},ce=(H.synthese||H.value_prop||H.produit||H.modele||"").trim();j(S,{descBusy:!1,descDone:!0,desc:ce})}).catch(()=>j(S,{descBusy:!1,descDone:!0}))},[j,o]);p.useEffect(()=>{const S=d.findIndex(D=>D.auto&&D.name.trim()&&D.status==="");if(S>=0){N(S,d[S].name);return}if(f)return;const P=d.findIndex(D=>D.status==="ready"&&D.site&&!D.descDone&&!D.descBusy);P>=0&&q(P,d[P].name,d[P].site)},[d,N,q,f]);const[T,L]=p.useState(!1),C=p.useCallback(async(S,P)=>{j(S,{evalBusy:!0});const D=(P.site||P.name).trim(),Q=await No(o,D,"atelier2");return Q.verdict==="quota"?(j(S,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:Q.reason||"",remaining:0}})),!1):(j(S,{evalBusy:!1,status:Q.verdict==="kept"?"kept":"out",reason:Q.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:Q.company||P.name,verdict:Q.verdict,reason:Q.reason||"",remaining:Q.remaining??null}})),!0)},[j,o]),O=async()=>{if(T)return;const S=d.map((P,D)=>({r:P,i:D})).filter(({r:P})=>P.name.trim()&&P.status!=="kept"&&P.status!=="out"&&P.status!=="resolving");if(S.length){L(!0);for(const{r:P,i:D}of S)if(!await C(D,P))break;L(!1)}},U=p.useMemo(()=>{const S=new Set,P=[];return d.filter(D=>D.status==="kept").forEach(D=>{const Q=D.name.trim().toLowerCase();Q&&!S.has(Q)&&(S.add(Q),P.push(D.name.trim()))}),n.filter(D=>Te(D)>=1&&Te(D)<=4&&(D.website||D.domain)).forEach(D=>{const Q=(D.name||"").trim().toLowerCase();Q&&!S.has(Q)&&(S.add(Q),P.push((D.name||"").trim()))}),P},[d,n]),V=p.useMemo(()=>{const S=new Set;return n.forEach(P=>{const D=(P.name||"").trim().toLowerCase();D&&S.add(D)}),d.forEach(P=>{const D=P.name.trim().toLowerCase();D&&S.add(D)}),S},[n,d]),I=async()=>{if(b||!U.length)return;w(!1);const S=[];for(const P of U.slice(0,2)){h(P);const D=await So(o,P);if(D){if(D.verdict==="quota"){y(!0);break}(D.results||[]).forEach(Q=>{const H=(Q.company||"").trim().toLowerCase();!H||V.has(H)||S.some(ce=>ce.name.toLowerCase()===H)||S.push({name:(Q.company||"").trim(),verdict:Q.verdict||"",reason:Q.reason,from:P})})}}h(""),w(!0),u(P=>[...S,...P].slice(0,24))},x=async(S,P)=>{if(b)return;w(!1),h(S==="thesis"?e.pxThesis:P);const D=await hs(o,S,P,6);if(h(""),w(!0),!D)return;if(D.verdict==="quota"){y(!0);return}const Q=[];(D.results||[]).forEach(H=>{const ce=(H.company||"").trim().toLowerCase();!ce||V.has(ce)||Q.some(te=>te.name.toLowerCase()===ce)||Q.push({name:(H.company||"").trim(),verdict:H.verdict||"",reason:H.reason,from:S==="thesis"?e.pxThesis:P})}),u(H=>[...Q,...H].slice(0,24))},F=()=>{const S=E.trim();S.length<3||x(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(S)?"registry":"keyword",S)},z=S=>{s(P=>[...P,{name:S.name,site:"",status:"",auto:!0}].slice(0,30)),u(P=>P.filter(D=>D.name!==S.name))},$=d.filter(S=>S.name.trim()&&S.status!=="kept"&&S.status!=="out").length,G=S=>S.name.trim()&&S.status!=="kept"&&S.status!=="out"&&S.status!=="resolving"&&!S.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{className:"eq-h-go",children:e.eqRunOneShort})]}),d.map((S,P)=>t.jsxs("div",{className:"eq-item"+(S.status==="kept"?" r-kept":S.status==="out"?" r-out":""),children:[t.jsxs("div",{className:"eq-row"+(S.status==="kept"?" r-kept":S.status==="out"?" r-out":""),children:[t.jsx("input",{value:S.name,placeholder:e.eqNamePh,onChange:D=>{const Q=D.target.value.split(`
`).map(H=>H.trim()).filter(Boolean);Q.length>1?s(H=>{const ce=[...H];return ce.splice(P,1,...Q.map(te=>({name:te,site:"",status:"",auto:!0}))),ce.slice(0,30)}):j(P,{name:D.target.value})},onBlur:()=>{S.name.trim()&&!S.site&&S.status!=="resolving"&&S.status!=="pick"&&N(P,S.name)},onKeyDown:D=>{D.key==="Enter"&&N(P,S.name)}}),t.jsxs("span",{className:"eq-site",children:[S.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),S.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:D=>{const Q=D.target.value;Q&&j(P,{site:Q,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(S.candidates||[]).map(D=>t.jsx("option",{value:D.url,children:(D.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},D.url))]}),S.status!=="resolving"&&S.status!=="pick"&&(S.site?t.jsxs("a",{href:S.site.startsWith("http")?S.site:"https://"+S.site,target:"_blank",rel:"nofollow noopener",children:[S.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:S.name.trim()&&S.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:S.desc||"",children:S.descBusy?t.jsx("i",{children:e.eqDescBusy}):S.desc?S.desc:t.jsx("em",{children:S.descDone?f?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(S.status||"vide"),title:S.reason||"",children:S.status==="kept"?"✓ "+e.kept:S.status==="out"?"✗ "+e.dropped:S.status==="ready"?e.eqReady:S.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>s(D=>D.filter((Q,H)=>H!==P)),children:"×"}),(S.name.trim()||S.site)&&S.status!=="kept"&&S.status!=="out"?t.jsxs(Qa,{lang:a,storeKey:(S.site||S.name).trim(),className:"eq-go",title:e.eqRunOne,disabled:!G(S)||T,confirmLabel:"⚡ "+e.eqRunOneShort,onConfirm:()=>{C(P,S)},children:[S.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}):t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!G(S)||T,onClick:()=>{C(P,S)},children:[S.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]})]}),(S.name.trim()||S.site)&&S.status!=="kept"&&S.status!=="out"&&t.jsx(fs,{lang:a,variant:"row",storeKey:(S.site||S.name).trim()})]},P)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>s(S=>[...S,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!b,onClick:()=>{x("thesis","")},children:b===e.pxThesis?e.sgBusy(b):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:E,placeholder:e.pxPlace,onChange:S=>k(S.target.value),onKeyDown:S=>{S.key==="Enter"&&F()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b||E.trim().length<3,onClick:F,children:e.pxGoFree}),!!U.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b,onClick:()=>{I()},children:b&&b!==e.pxThesis&&b!==E?e.sgBusy(b):e.sgGo}),!!U.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(U[0],U.length)}),v&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),m&&!g.length&&!v&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),g.map(S=>t.jsxs("span",{className:"eq-sc"+(S.verdict==="kept"?" ok":""),title:(S.reason||"")+" — "+e.sgVia(S.from),children:[t.jsx("b",{children:S.name}),S.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>z(S),children:"+"})]},S.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),d.some(S=>S.status==="kept"||S.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>s(S=>S.filter(P=>P.status!=="kept"&&P.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(T?" loading":""),style:{justifyContent:"center"},disabled:T||!$,onClick:()=>{O()},children:[t.jsx("span",{className:"fill"}),T?e.eqRunning:e.eqGo($)]})]})]})]})}const up={deals:"ma-deals",news:"veille"};function oo(e){return(e.url||e.title||"").trim()}function io(e){const a=(e.title||"").replace(/\s+/g," ").trim();if(!a)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const r=/^(.{2,72}?)[:–—|]/.exec(a);return r?r[1].trim():(a.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||a).slice(0,72).trim()}function mp({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,canWrite:i,flash:d}=Z(),[s,l]=p.useState(null),[f,c]=p.useState({deals:[],news:[]}),[g,u]=p.useState({deals:!1,news:!1}),[b,h]=p.useState(null),[v,y]=p.useState(""),m=p.useCallback(async C=>{if(!o)return[];if(g[C])return f[C];h(C),y("");const O=Date.now(),U=await gs(up[C],o,n),V=700-(Date.now()-O);return V>0&&await new Promise(I=>window.setTimeout(I,V)),h(null),!U.ok&&U.error?(y(U.error),[]):(c(I=>({...I,[C]:U.items})),u(I=>({...I,[C]:!0})),U.items)},[o,n,g,f]);p.useEffect(()=>{s&&m(s)},[s,m]);const w=p.useCallback(C=>f[C].map(oo).filter(Boolean),[f]),E=p.useMemo(()=>{var U,V;if(!o)return{deals:[],news:[]};const C={deals:w("deals"),news:w("news")},O=Io("feed:"+o,C);return{deals:((U=O.deals)==null?void 0:U.noms)||[],news:((V=O.news)==null?void 0:V.noms)||[]}},[o,w]),k=p.useRef(null);p.useEffect(()=>{k.current&&!s&&o&&Po("feed:"+o,{deals:w("deals"),news:w("news")}),k.current=s},[s,o,w]);const j=C=>{const O=C.map(io).filter(Boolean);O.length&&(a(O),l(null),d(r.feedSent(O.length)))},N=C=>{const O=io(C);O&&(window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:O,url:(C.url||"").trim()}})),l(null),d(r.feedPasted(O)),requestAnimationFrame(()=>{var U;(U=document.querySelector(".atl2 .eval-stick, .atl2 .demand"))==null||U.scrollIntoView({block:"center",behavior:"smooth"})}))},q=(C,O)=>{const U=(C.url||"").trim();if(O==="news"&&U&&/^https?:\/\//i.test(U)){window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:U}})),l(null),d(r.feedExtractReady);return}N(C)},T=C=>{l(O=>O===C?null:C)},L=C=>{const O=f[C],U=new Set(E[C].map(I=>I.toLowerCase())),V=b===C||s===C&&!g[C]&&!v;return t.jsxs("div",{className:"dfpane"+(s===C?" on":""),hidden:s!==C,children:[t.jsxs("div",{className:"dfhow",children:[t.jsx("p",{className:"dfh",children:C==="deals"?r.feedDealsH:r.feedNewsH}),t.jsx("p",{className:"dfh2",children:C==="deals"?r.feedDealsHow:r.feedNewsHow})]}),V&&t.jsxs("div",{className:"dfwait",role:"status","aria-live":"polite",children:[t.jsx("i",{className:"dfspin","aria-hidden":"true"}),t.jsxs("div",{children:[t.jsx("b",{children:C==="deals"?r.feedWaitDeals:r.feedWaitNews}),t.jsx("span",{className:"dfbar",children:t.jsx("i",{})})]})]}),s===C&&!!v&&t.jsx("p",{className:"dferr",children:v}),g[C]&&!O.length&&!b&&t.jsx("p",{className:"dfempty",children:C==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!O.length&&!V&&t.jsxs(t.Fragment,{children:[C==="deals"&&i&&O.length>1&&t.jsxs("button",{type:"button",className:"dfall",onClick:()=>j(O),children:[r.feedPutAll," (",O.length,")"]}),t.jsx("ul",{className:"dflist",children:O.map((I,x)=>{const F=oo(I),z=U.has(F.toLowerCase()),$=(I.url||"").trim();return t.jsxs("li",{className:z?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:I.title||$}),t.jsx("span",{children:[I.source,I.sector_fr,(I.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[$&&t.jsx("a",{href:$,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),i&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>q(I,C),children:C==="deals"?r.feedPutEval:r.rowExtract})]})]},F||x)})})]})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(C=>{const O=E[C].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(C==="deals"?"ddeals":"dnews")+(s===C?" on":"")+(b===C?" busy":""),title:C==="deals"?r.feedDealsH:r.feedNewsH,"aria-busy":b===C||void 0,onClick:()=>T(C),children:[b===C?n==="en"?"Loading…":"Chargement…":C==="deals"?r.feedDeals:r.feedNews,O>0&&b!==C&&t.jsx("em",{title:r.feedHint,children:r.feedNew(O)})]},C)}),s&&L(s)]})}function gi(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function fp(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function so({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:s}=Z();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(l=>l.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(l=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:l.name}),l.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),l.line1&&t.jsx("p",{className:"w",children:l.line1}),l.line2&&t.jsx("p",{className:"r",children:l.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(l.name),children:s.rsEvalOne})]},l.name))})]}):null}function xi({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=Z(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(so,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(so,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function hp({card:e,onEvaluate:a,onAddAll:r}){var s,l,f;const{t:n}=Z(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:gi(e.summary_md||"").map((c,g)=>t.jsx("p",{children:c},g))})]}),t.jsx(xi,{card:e,onEvaluate:a,onAddAll:r}),(((l=e.prospective)==null?void 0:l.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(c=>t.jsx("li",{children:c},c))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function gp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function xp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=Z(),s=o,[l,f]=p.useState(null),[c,g]=p.useState(null),[u,b]=p.useState(null),[h,v]=p.useState(!1);p.useEffect(()=>{let m=!0;return(async()=>{const w=await zo({email:d,cbToken:s});m&&f(w)})(),()=>{m=!1}},[d,s,n]);const y=m=>{g(m),b(null),v(!0),(async()=>{const w=await xs(m.id);b(w),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{g(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&l&&t.jsx("span",{className:"n",children:l.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[l===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),l!==null&&l.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(l||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[gp(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?i.rsPub:i.rsPriv})]},m.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?i.rsPub:i.rsPriv})]}),h&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!h&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!h&&u&&t.jsx(hp,{card:u,onEvaluate:a,onAddAll:r})]})]})}const La=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ia(e){return/^https?:\/\//i.test((e||"").trim())}function ct(e){const a=(e||"").trim();return a?ia(a)?a:La.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function bp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function vp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:s,evalBusy:l,evalCards:f,caps:c,data:g,canWrite:u,source:b,dossiers:h,doAnalyse:v,liveMemos:y,pipe:m}=Z(),w=r==="client",E=p.useMemo(()=>n||(b!=="default"?bs():""),[n,b]),[k,j]=p.useState(""),[N,q]=p.useState(!1),[T,L]=p.useState(""),[C,O]=p.useState(""),[U,V]=p.useState(""),[I,x]=p.useState(!1),[F,z]=p.useState(!1),[$,G]=p.useState([]);p.useEffect(()=>{const R=B=>{const Y=B.detail;Y&&G(ae=>[Y,...ae].slice(0,8))};return window.addEventListener("ppmap:evalcard",R),()=>window.removeEventListener("ppmap:evalcard",R)},[]);const[S,P]=p.useState(!1),[D,Q]=p.useState(!1),[H,ce]=p.useState(!1),te=p.useRef(!1),[le,xe]=p.useState(""),[he,we]=p.useState(""),[pe,Ne]=p.useState(!1),[Ce,ue]=p.useState(!1),[be,ye]=p.useState(0),[ee,_]=p.useState(""),[J,ie]=p.useState(null),[oe,me]=p.useState(null),[W,se]=p.useState(!1),[ve,ke]=p.useState(null),[Ee,ge]=p.useState(0),Pe=p.useRef(!1),Je=k.trim()?La.test(k.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const R=new URLSearchParams(window.location.search),B=(R.get("rs")||"").trim(),Y=(R.get("rstext")||"").trim();B&&/^https?:\/\//i.test(B)&&xe(B),Y&&we(Y),(B&&/^https?:\/\//i.test(B)||Y)&&P(!0)},[]),p.useEffect(()=>{const R=B=>{const Y=B.detail||{},ae=String(Y.url||"").trim(),re=String(Y.text||"").trim();ae&&/^https?:\/\//i.test(ae)&&xe(ae),re&&we(re),(ae&&/^https?:\/\//i.test(ae)||re)&&(P(!0),j(""),L(""),Ne(!0),window.setTimeout(()=>Ne(!1),900))};return window.addEventListener("ppmap:research",R),()=>window.removeEventListener("ppmap:research",R)},[]),p.useEffect(()=>{const R=B=>{const Y=B.detail||{},ae=String(Y.name||"").trim();if(!ae)return;P(!1),j(ae),L(ae);const re=ct(String(Y.website||Y.domain||""));O(re),V(ct(String(Y.url||""))),x(!re),q(!0),window.setTimeout(()=>q(!1),900)};return window.addEventListener("ppmap:prefill",R),()=>window.removeEventListener("ppmap:prefill",R)},[]),p.useEffect(()=>{const R=(T||"").trim();if(!R||S||C){(C||!R||S)&&x(!1);return}const B=$e(R),Y=h.find(Ae=>$e(Ae.name)===B)||h.find(Ae=>{const de=$e(Ae.name);return de.length>=3&&(B.includes(de)||de.includes(B))}),ae=ct((Y==null?void 0:Y.website)||"")||ct((Y==null?void 0:Y.domain)||""),re=ct((Y==null?void 0:Y.url)||"");if(re&&V(Ae=>Ae||re),ae){O(ae),x(!1);return}let je=!0;return x(!0),In(R).then(Ae=>{var He,jt;if(!je)return;const de=ct(Ae.website||"")||ct(((jt=(He=Ae.candidates)==null?void 0:He[0])==null?void 0:jt.url)||"");de&&O(de)}).catch(()=>{}).finally(()=>{je&&x(!1)}),()=>{je=!1}},[T,S,C,h]),p.useEffect(()=>{const R=B=>{var ae;const Y=String(((ae=B.detail)==null?void 0:ae.url)||"").trim();ia(Y)&&window.open(Y,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",R),()=>window.removeEventListener("ppmap:view",R)},[]),p.useEffect(()=>{if(te.current===S)return;te.current=S,ce(!0);const R=window.setTimeout(()=>ce(!1),560);return()=>window.clearTimeout(R)},[S]),p.useEffect(()=>{if(typeof window>"u")return;const R=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),B=document.querySelector(".atl2.ops, .atl2.cibles");if(!R||!B)return;const Y=B.classList.contains("cibles")?document.querySelector(".atl2.cibles .live-stack"):null,ae=()=>{const je=parseFloat(window.getComputedStyle(R).top)||0,Ae=R.getBoundingClientRect().top<=je+1;R.classList.toggle("is-stuck",Ae),B.classList.toggle("url-stuck",Ae);const de=Math.round(R.getBoundingClientRect().height);B.style.setProperty("--demand-h",`${de}px`);const He=window.matchMedia("(min-width: 861px)").matches;Y&&He?B.style.setProperty("--pp-live-h",`${Math.round(Y.getBoundingClientRect().height)}px`):B.classList.contains("cibles")&&B.style.setProperty("--pp-live-h","0px")};ae();const re=new ResizeObserver(ae);return re.observe(R),Y&&re.observe(Y),window.addEventListener("scroll",ae,!0),window.addEventListener("resize",ae),()=>{re.disconnect(),R.classList.remove("is-stuck"),B.classList.remove("url-stuck"),window.removeEventListener("scroll",ae,!0),window.removeEventListener("resize",ae)}},[b,N,pe,F,S,H,I]),p.useEffect(()=>{if(!u&&!E){ke(null);return}let R=!0;return(async()=>{const B=await zo({email:o,cbToken:E});R&&ke(B.length)})(),()=>{R=!1}},[u,E,o,Ee]);const at=$.length?$:f,ze=g.credits,dt=p.useCallback(R=>{pp(n,R)&&(z(!1),s({type:"ptab",tab:0}),requestAnimationFrame(()=>{const B=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!B)return;const Y=window.scrollY+B.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,Y),behavior:"smooth"})}))},[n,s]);p.useEffect(()=>{if(!Ce)return;ye(0);const R=window.setInterval(()=>ye(B=>B+1),1e3);return()=>window.clearInterval(R)},[Ce]);const nt=p.useMemo(()=>{const R=k.trim().toLowerCase();return!R||!m?null:h.find(B=>$e(B.name)===R&&Te(B)===1)||null},[k,h,m]),Xe=()=>{const R=k.trim();if(R){if(nt){v(nt);return}i(null,R),w&&j("")}},rt=async()=>{var Y,ae,re;if(Pe.current)return;const R=le.trim().replace(/\s+/g,""),B=he.trim();if(!R&&!B){_(e.rsNeed);return}if(!w&&!E){i(null,R||B.slice(0,80));return}Pe.current=!0,_(""),ie(null),me(null),ue(!0);try{const je=await ws({url:R,text:B,email:o,cbToken:E});if(ue(!1),!je||je.status!=="success"){_((je==null?void 0:je.message)||"Erreur");return}ie(je),P(!1),dt((((Y=je.prospective)==null?void 0:Y.companies_to_evaluate)||[]).map(de=>(de==null?void 0:de.name)||"")),me({state:"pending"});const Ae=await ys(je,{email:o,cbToken:E});me(Ae.ok?{state:"ok",scopeLabel:((ae=Ae.summary)==null?void 0:ae.scope_label)||"",scope:((re=Ae.summary)==null?void 0:re.scope)||""}:{state:"fail",msg:Ae.error||""}),Ae.ok&&ge(de=>de+1)}finally{Pe.current=!1,ue(!1)}},At=[J==null?void 0:J.industry,...(J==null?void 0:J.market_tags)||[],J==null?void 0:J.author].map(R=>(R||"").trim()).filter(Boolean),bt=(oe==null?void 0:oe.state)==="pending",Bt=oe&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):oe.state==="ok"?t.jsx("span",{className:"rslink ok",children:oe.scope&&oe.scope!=="public"?e.rsSavedIn(oe.scopeLabel||oe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:oe.msg,children:e.rsSaveFail})),$t=fp(J).length,De=S,Ze=(T||k).trim(),Ge=h.find(R=>$e(R.name)===$e(Ze)),mt=ct(k)||C||ct((Ge==null?void 0:Ge.website)||"")||ct((Ge==null?void 0:Ge.domain)||""),Et=U||ct((Ge==null?void 0:Ge.url)||""),qt=nt?e.actAnalyse:Ze?e.evalGoOn(Ze.length>22?Ze.slice(0,21)+"…":Ze):e.evalGo,M=Ce?`${vs(le.trim())==="youtube"&&le.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(be)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(De?" rs-mode":"")+(T&&k.trim()===T||N||pe?" pair":"")+(N||pe||H?" echo":"")+(H?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:De?a==="en"?"Extract companies from an article":"Extraire les sociétés d’un article":a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:De?a==="en"?"Paste an article or video URL — Stan lists the companies, then you pick which ones to screen.":"Collez l’URL d’un article ou d’une vidéo — Stan en sort les sociétés, vous choisissez lesquelles évaluer.":a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((De?pe:N)||H?" flash":"")+((De?le.trim():La.test(k.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:De?le:k,placeholder:De?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:De?600:200,spellCheck:De?!1:void 0,inputMode:De?"url":void 0,onChange:R=>{if(De){xe(R.target.value);return}j(R.target.value),T&&R.target.value.trim()!==T&&(L(""),O(""),V(""),x(!1))},onKeyDown:R=>{R.key==="Enter"&&(De?rt():Xe())}}),t.jsx("span",{className:"detect"+(De?" off":"")+(La.test(k.trim())?" url":""),children:Je})]}),t.jsx("span",{className:"dacts",children:De?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Ce?" loading":""),disabled:Ce||bt||!le.trim()&&!he.trim(),onClick:()=>{rt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:M})]}),t.jsxs("a",{className:"viewbtn"+(ia(le)?"":" off"),href:ia(le)?le.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:R=>{ia(le)||R.preventDefault()},children:[t.jsx(bp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs(Qa,{lang:a,storeKey:((nt==null?void 0:nt.name)||k).trim(),className:"evalbtn"+(nt?" analyse":"")+(l?" loading":""),disabled:l,confirmLabel:qt,onConfirm:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:qt})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(I?" searching":mt?"":" off"),href:mt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":I||void 0,title:I?e.viewSiteBusyHint:e.viewSiteHint,onClick:R=>{mt||R.preventDefault()},children:[I&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),I?e.viewSiteBusy:e.viewSite,!I&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(Et?"":" off"),href:Et||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:R=>{Et||R.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),c.showCredits&&ze&&b==="ops"&&t.jsxs("button",{type:"button",className:"credits"+(ze.total_available<=0&&!ze.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ze.unlimited?"∞":ze.total_available}),!ze.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ze.daily_grant+ze.purchased]}),ze.total_available<=0&&!ze.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{s({type:"ptab",tab:0}),z(!1),requestAnimationFrame(()=>{const R=document.querySelector(".atl2.cibles .desk-list");if(!R)return;const B=window.scrollY+R.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,B),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(S?" on":""),title:e.rsOpenHint,onClick:()=>P(!S),children:e.rsOpen}),ve!==null&&ve>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(W?" on":""),onClick:()=>se(!W),children:e.rsArchOpen(ve)}),c.pipe&&!!n&&t.jsx(mp,{pageToken:E,onAddNames:dt})]}),W&&t.jsx(xp,{bump:Ee,cbToken:E,onClose:()=>se(!1),onEvaluate:R=>i(null,R),onAddAll:dt}),t.jsx("div",{className:"rsp slim"+(S?" on":" off"),"aria-hidden":!S,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:S?void 0:-1,onClick:()=>Q(R=>!R),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:D?"▴":"▾"})]}),D&&t.jsx("textarea",{className:"rstext",value:he,placeholder:e.rsTextPh,tabIndex:S?void 0:-1,onChange:R=>we(R.target.value)})]})}),ee&&t.jsx("div",{className:"rserr",children:ee}),J&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:J.title}),J.source_url&&t.jsx("a",{href:J.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ie(null),me(null)},children:"×"})]}),J.market&&t.jsx("p",{className:"rsmk",children:J.market}),At.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),At.map(R=>t.jsx("span",{children:R},R))]}),t.jsxs("div",{className:"rsbody",children:[J.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${J.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:gi(J.summary_md||"").map((R,B)=>t.jsx("p",{children:R},B))})]}),t.jsx(xi,{card:J,onEvaluate:R=>i(null,R),onAddAll:dt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound($t)}),Bt]})]}),at.slice(0,1).map((R,B)=>{const Y=R.verdict==="kept",ae=R.verdict==="quota",re=R.verdict==="unresolved",je=Y?"var(--brand)":ae?"var(--bolt)":re?"var(--blue)":"var(--red)",Ae=Y?"var(--brand-l)":ae?"#FFF3D6":re?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":je,"--bgc":Ae},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:Y?"✓ "+e.kept:ae?"⏳":re?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),R.name&&t.jsx("span",{className:"rn",children:R.name}),t.jsx("span",{className:"rr",children:R.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",R.reason]}):null}),!!(R.candidates&&R.candidates.length)&&t.jsx("span",{className:"sitepick",children:R.candidates.map(de=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:de.url.startsWith("http")?de.url:`https://${de.url}`,target:"_blank",rel:"nofollow noopener",children:[(de.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,de.url,R.name),children:e.evalPickGo})]},de.url))}),!ae&&!re&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:Y?1:5});const de=(R.name||"").trim().toLowerCase();window.setTimeout(()=>{const He=[...document.querySelectorAll(".atl2 .list .row")].find(jt=>{var Tt;return(((Tt=jt.querySelector(".rnm"))==null?void 0:Tt.textContent)||"").trim().toLowerCase().includes(de)});He&&(He.scrollIntoView({behavior:"smooth",block:"center"}),He.classList.add("flashrow"),window.setTimeout(()=>He.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(Y?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},B)}),w&&(d.kept+d.dropped>0||at.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function wp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function yp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Z(),i=e.memoConsole?r.get(e.memoConsole):null,d=p.useMemo(()=>i?[i.reasoning||"",wp(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const s=Ct(i),l=Mn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:d?d.split(`

`).map((f,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Vt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:l===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Vn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Z(),[d,s]=p.useState(!1),[l,f]=p.useState(null),c=n.pipe&&o==="client"&&!n.lockActions,g=async()=>{if(!c||d)return;s(!0);const u=await So(r,e);if(s(!1),!u){i(a.actErr);return}f(u.results||[])};return p.useEffect(()=>{if(!c)return;const u=b=>{var v;const h=String(((v=b.detail)==null?void 0:v.name)||"").trim();h&&h.toLowerCase()===e.toLowerCase()&&g()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,c]),p.useEffect(()=>{if(c)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),g())}catch{}},[e,c]),c?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{g()},children:d?a.similarBusy:a.similar}),l&&(l.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:l.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const kp=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),za=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ma(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}function On(e){const a=ma(e);if(!a)return"";try{return new URL(a).hostname.replace(/^www\./,"")}catch{return""}}function Ep(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=za(a.slice(n));break}r+=za(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=za(a.slice(o));break}const d=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(d),l=s?s[2].toLowerCase():"";s&&kp.has(l)?r+=`<${s[1]}${l}>`:r+=za(a.slice(o,i+1)),n=i+1}return r}const jp=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),lo={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function bi(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(jp.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const s=d.name.toLowerCase();(!(lo["*"].has(s)||((r=lo[o])==null?void 0:r.has(s)))||s.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(s=>s.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(s)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}bi(n)}}function Fa(e){const a=e.cloneNode(!0);return bi(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Np={swot:null,summary:"",syn:"",pnl:"",cf:"",roi:"",reco:"",plan:"",pruned:[]},Sp=/chiffre|revenu|revenue|\barr\b|ebitda|marge|gross|fcf|free cash|net|total|r[ée]sultat|cash|capex|nopat|moic|irr|\btri\b|roi|entry|\bev\b|invested|synerg/i,zp=[["syn",/synerg/i],["pnl",/compte de r[ée]sultat|p\s*&\s*l|profit\s*(?:and|&)\s*loss|income statement/i],["cf",/flux de tr[ée]sorerie|cash\s*-?\s*flow/i],["roi",/\broi\b|return on investment|retour sur investissement/i],["reco",/verdict post|post[- ]model verdict|conviction quantitative/i]];function It(e){return String(e||"").replace(/<script[\s\S]*?<\/script>/gi," ").replace(/<style[\s\S]*?<\/style>/gi," ").replace(/<[^>]+>/g," ").replace(/&nbsp;/gi," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#39;|&apos;/g,"'").replace(/&quot;/g,'"').replace(/\s+/g," ").trim()}function vi(e,a){const r=e.slice(a),n=/<div\b|<\/div\s*>/gi;let o=0,i;for(;i=n.exec(r);)if(i[0][1]!=="/")o+=1;else if(o-=1,o===0)return e.slice(a,a+i.index+i[0].length);return""}function dn(e,a){const n=new RegExp(`<div\\b[^>]*\\bid="${a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}"`,"i").exec(e);return n?vi(e,n.index):""}function Cp(e,a=14){const r=e.match(/<tr\b[\s\S]*?<\/tr\s*>/gi)||[];if(r.length<=a)return{html:e,pruned:!1};const n=[];for(let d=0;d<r.length-1;d+=1){const s=r[d],l=/<t[dh]\b[^>]*>([\s\S]*?)<\/t[dh]\s*>/i.exec(s),f=l?It(l[1]):"";if((d<2||/<th/i.test(s)||Sp.test(f))&&n.push(s),n.length>=a-1)break}n.push(r[r.length-1]);const o=n.length<3?r.slice(0,a):n;return{html:(/^\s*<table\b[^>]*>/i.exec(e)||["<table>"])[0]+o.join("")+"</table>",pruned:!0}}function Ap(e,a=14){let r=!1;return{html:e.replace(/<table\b[\s\S]*?<\/table\s*>/gi,o=>{const i=Cp(o,a);return r=r||i.pruned,i.html}),pruned:r}}function qp(e){const a={s:[],w:[],o:[],t:[]},r=[["s","s-green"],["w","s-red"],["o","s-blue"],["t","s-orange"]];for(const[n,o]of r){const i=new RegExp(`<div\\b[^>]*class="[^"]*swot-item[^"]*\\b${o}\\b[^"]*"`,"i").exec(e);if(!i)return null;const d=vi(e,i.index);let s=(d.match(/<li\b[^>]*>([\s\S]*?)<\/li\s*>/gi)||[]).map(l=>It(l));if(!s.length){const l=/<p\b[^>]*>([\s\S]*?)<\/p\s*>/i.exec(d);l&&(s=[It(l[1])])}if(s=s.filter(l=>l&&!/not available/i.test(l)&&!/non disponible/i.test(l)).map(l=>l.slice(0,260)).slice(0,4),!s.length)return null;a[n]=s}return a}function Tp(e){const a=e.search(/id=["']company-summary["']/i);if(a<0)return"";const r=e.slice(a,a+9e3),n=/(?:EN R[ÉE]SUM[ÉE]|EN QUELQUES MOTS|IN SUMMARY|IN A FEW WORDS|IN A NUTSHELL|TL;DR)[\s:]*(?:<\/?span[^>]*>[\s:]*)*([\s\S]+?)(?=<br|<hr|<\/div|<h[23]|⚠|✅|🚀|❓|$)/i.exec(r);return n?It(n[1]).slice(0,600):""}function Lp(e,a,r){if(r<0)return"";const n=/<h3\b[^>]*>([\s\S]*?)<\/h3\s*>/gi;n.lastIndex=r;let o;for(;o=n.exec(e);){if(!a.test(It(o[1])))continue;const i=/<h3\b[^>]*>/i.exec(e.slice(o.index+o[0].length));return i?e.slice(o.index,o.index+o[0].length+i.index):e.slice(o.index,Math.min(e.length,o.index+o[0].length+6e4))}return""}function po(e){let a=e.replace(/^\s*<div\b[^>]*>/i,"").replace(/<\/div\s*>\s*$/i,"");return a=a.replace(/<h2\b[^>]*class="[^"]*section-title[^"]*"[^>]*>[\s\S]*?<\/h2\s*>/gi,""),a=a.replace(/<details\b[\s\S]*?<\/details\s*>/gi,""),a.trim()}function pn(e,a){if(e.length<=a)return e;const r=e.slice(0,a),n=r.lastIndexOf(">");return n>=0?r.slice(0,n+1):r}function Fp(e){const a={...Np,pruned:[]};if(!e)return a;try{const n=dn(e,"swot");n&&(a.swot=qp(n))}catch{}try{a.summary=Tp(e)}catch{}try{const n=dn(e,"action-plan");if(n){const o=po(n);a.plan=pn(o,12e3)}}catch{}const r=e.search(/id=["']financial-forecast["']/i);for(const[n,o]of zp)try{let i=Lp(e,o,r);if(!i)continue;const d=Ap(i);i=pn(d.html,45e3),It(i)&&(a[n]=i,d.pruned&&a.pruned.push(n))}catch{}if(!a.reco)try{const n=dn(e,"conviction");if(n){const o=pn(po(n),8e3);It(o)&&(a.reco=o)}}catch{}return a}function Rp(e){return e?!!(e.swot||e.summary||e.syn||e.pnl||e.cf||e.roi||e.reco||e.plan):!1}const cn=new Map;function wi(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=cn.get(a);return r||(r=Op(a).catch(()=>null),r.then(n=>{n||cn.delete(a)}),cn.set(a,r)),r}async function Op(e){var u,b;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=await a.text(),n=new DOMParser().parseFromString(r,"text/html"),o=h=>{var v;return(((v=n.querySelector(h))==null?void 0:v.textContent)||"").trim()},i=n.querySelector(".sb-score"),d=((u=Array.from((i==null?void 0:i.classList)||[]).find(h=>h.startsWith("sb-score-")))==null?void 0:u.slice(9))||"",s=[];let l=null;const f=Array.from(n.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const h of f){if(h.classList.contains("sb-nav-heading")){l={label:(h.textContent||"").trim(),items:[]},s.push(l);continue}const v=h.getAttribute("href")||"";if(!v.startsWith("#"))continue;const y=v.slice(1),m=Dp(n,y);m&&(l||(l={label:"",items:[]},s.push(l)),l.items.push({id:y,title:(h.textContent||"").trim(),html:m,poids:m.length}))}const c=((b=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:b[1])||"",g={score:o(".sb-score"),scoreTone:d,tags:Array.from(n.querySelectorAll(".sb-tag")).map(h=>(h.textContent||"").trim()).filter(Boolean),name:o(".sidebar-company-name"),tagline:o(".sidebar-tagline"),desc:o(".meta-desc"),groups:s.filter(h=>h.items.length),mindmapSlug:n.querySelector(".cm-mindmap-png")?c:"",comite:Mp(n,Fp(r))};return g.groups.length?g:null}function Mp(e,a){const r=n=>{if(!n)return"";const o=e.createElement("div");return o.innerHTML=n,Fa(o)};return{...a,syn:r(a.syn),pnl:r(a.pnl),cf:r(a.cf),roi:r(a.roi),reco:r(a.reco),plan:r(a.plan)}}const co={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Dp(e,a){const r=e.getElementById(a),n=r?uo(e,r):"";if(n)return n;const o=co[a]?e.querySelector(co[a]):null;return o&&o!==r?uo(e,o):""}function uo(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Fa(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(l=>/^h3$/i.test(l.tagName))[0]===a)for(const l of i){if(l===a)break;/^h2$/i.test(l.tagName)||o.appendChild(l.cloneNode(!0))}let s=a.nextElementSibling;for(;s&&!/^h3$/i.test(s.tagName);)o.appendChild(s.cloneNode(!0)),s=s.nextElementSibling;return o.children.length?Fa(o):""}return Fa(a)}const un=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function We({k:e,v:a,href:r,wide:n}){return a==null||a===""?null:t.jsxs("div",{className:"cdl"+(n?" cdw":""),children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ip({k:e,vals:a}){const r=(a||[]).filter(Boolean);return r.length?t.jsxs("div",{className:"cdl cdw",children:[t.jsx("span",{className:"cdk",children:e}),t.jsx("span",{className:"cdtags",children:r.map(n=>t.jsx("span",{className:"cdtag",children:n},n))})]}):null}function mo(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function fo({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const mn=new Map;function Pp(e,a){const{token:r}=Z(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=mn.get(i);d||(d=ks(r,e.name,e.checkId),mn.set(i,d),d.then(l=>{(!l||!l.reasoning&&!l.summaryHtml)&&mn.delete(i)}));let s=!0;return d.then(l=>{s&&l&&o({id:e.id,d:l})}),()=>{s=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const _p=6e4;function Bp({o:e}){const{t:a,doDeep:r}=Z(),[n,o]=p.useState(null),[i,d]=p.useState(e.memoUrl?"load":"off"),[s,l]=p.useState(()=>new Set),[f,c]=p.useState(!1),g=p.useRef(new Map);p.useEffect(()=>{let v=!0;if(l(new Set),c(!1),g.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),wi(e.memoUrl).then(y=>{v&&(o(y),d(y?"ok":"err"))}),()=>{v=!1}},[e.memoUrl]);const u=Ct(e),b=v=>{var y;return(y=g.current.get(v))==null?void 0:y.scrollIntoView({behavior:"smooth",block:"start"})},h=t.jsxs("div",{className:"cdacts",children:[Vt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:v=>{v.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const v=[e.reasoning||"",mo(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[v.length?v.join(`

`).split(`

`).map((y,m)=>t.jsx("p",{className:"cdtxt",children:y},m)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),h]})}if(i!=="ok"){const v=[e.reasoning||"",mo(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),v.length>0&&v.join(`

`).split(`

`).map((y,m)=>t.jsx("p",{className:"cdtxt",children:y},m)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:y=>{y.stopPropagation(),c(m=>!m)},children:f?a.memoHideHere:a.memoReadHere})}),f&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:y=>y.stopPropagation()}),h,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(v=>t.jsx("span",{className:"md-tag",children:v},v)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(v=>v.items.map(y=>t.jsx("button",{type:"button",className:"md-jump",onClick:m=>{m.stopPropagation(),b(y.id)},children:y.title},y.id)))}),n.groups.map((v,y)=>t.jsxs("div",{className:"md-grp",children:[v.label&&t.jsx("div",{className:"md-grp-h",children:v.label}),v.items.map(m=>{const w=m.poids>_p&&!s.has(m.id),E=m.id==="fiche-contact"||m.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:k=>{k&&g.current.set(m.id,k)},children:[t.jsx("h4",{className:"md-h",children:m.title}),E&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:k=>k.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:"LinkedIn"})]}),w?t.jsx("button",{type:"button",className:"abtn md-more",onClick:k=>{k.stopPropagation(),l(j=>new Set(j).add(m.id))},children:a.memoUnfold(Math.round(m.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:E?m.html.replace(/>\s*unavailable(\s+unavailable)*\s*</gi,"><"):m.html}}),!w&&n.mindmapSlug&&m.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${ha}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:k=>k.stopPropagation()})]})]},m.id)})]},v.label||y)),h,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:a.memoOpenFull})]})}function $p({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:s}=Z(),[l,f]=p.useState(!1),[c,g]=p.useState(!1),[u,b]=p.useState(!1),[h,v]=p.useState(null),[y,m]=p.useState(""),[w,E]=p.useState(null),[k,j]=p.useState(""),N={airtableId:e.airtableId,checkId:e.checkId},q=!!(e.airtableId||e.checkId),T=h&&h.id===e.id?h.entries:[],L=!!h&&h.id===e.id;if(p.useEffect(()=>{m(""),E(null),b(!1)},[e.id]),p.useEffect(()=>{if(!l||L||!q||!o)return;let O=!0;g(!0),b(!1);const U=e.id;return dr(r,"list",N).then(V=>{if(!(!O||U!==e.id)){if(g(!1),!V.ok){b(!0);return}v({id:U,entries:V.entries})}}),()=>{O=!1}},[l,L,q,r,e.id,o]),!n.pipe||!o||!q)return null;const C=(O,U)=>{g(!0);const V=e.id;dr(r,O,N,U).then(I=>{if(V===e.id){if(g(!1),!I.ok){d(a.notesErr);return}v({id:V,entries:I.entries}),b(!1),O==="add"&&(m(""),i(a.notesAdded)),O==="edit"&&E(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":l,onClick:O=>{O.stopPropagation(),f(U=>!U)},children:[t.jsx("b",{children:a.notesT}),T.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(T.length)}),t.jsx("i",{children:l?"▾":"▸"})]}),l&&t.jsxs("div",{className:"dn-b",onClick:O=>O.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),c&&!T.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!c&&!u&&L&&!T.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),T.map(O=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:s==="fr"?O.date.split("-").reverse().join("/"):O.date}),w===O.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:k,rows:3,onChange:U=>j(U.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||!k.trim(),onClick:()=>C("edit",{entryId:O.id,text:k.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>E(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:O.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{E(O.id),j(O.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:c,onClick:()=>{window.confirm(a.notesDelAsk)&&C("delete",{entryId:O.id})},children:a.notesDel})]})]})]},O.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:y,onChange:O=>m(O.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:c||!y.trim(),onClick:()=>C("add",{text:y.trim()}),children:a.notesAdd})]})]})]})}function Wn({o:e}){var j;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:d}=Z(),s=ga(e),l=Ct(e),f=(e.cribleStatus||"").trim().toUpperCase()||(s==="NO MATCH"?"NO MATCH":s==="MATCH"?"MATCH":""),c=[e.sector,e.market,(e.tags||[]).filter(Boolean).length?"1":"",e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.provQuery,On(e.provUrl||""),Oa(e),e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,u=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(f?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Vt(e)?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:u}].filter(N=>N.n>0),[e,a,o,f,l,c,g,u]),[h,v]=p.useState(""),y=b.some(N=>N.k===h)?h:((j=b[0])==null?void 0:j.k)||"";p.useEffect(()=>{const N=q=>{var L;const T=String(((L=q.detail)==null?void 0:L.tab)||"");T&&b.some(C=>C.k===T)&&v(T)};return window.addEventListener("ppmap:card-tab",N),()=>window.removeEventListener("ppmap:card-tab",N)},[b]);const m=Pp(e,y==="eval"||y==="conv");if(!b.length)return null;const w=((m==null?void 0:m.reasoning)||"").length>(e.reasoning||"").length?m.reasoning:e.reasoning||"",E=((m==null?void 0:m.summaryHtml)||"").length>(e.summary||"").length?m.summaryHtml:e.summary||"",k=(m==null?void 0:m.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(N=>t.jsx("button",{type:"button",role:"tab","aria-selected":y===N.k,"data-tour":"tab-"+N.k,className:y===N.k?"on":"",onClick:q=>{q.stopPropagation(),v(N.k)},children:N.lib},N.k))}),t.jsxs("div",{className:"cdbody",onClick:N=>N.stopPropagation(),children:[y==="eval"&&t.jsxs(t.Fragment,{children:[f&&t.jsxs("div",{className:"cdv1"+(f==="NO MATCH"?" out":""),children:[t.jsx("b",{children:f==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(fo,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),w&&w.split(`

`).map((N,q)=>t.jsx("p",{className:"cdtxt",children:N},q)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Up,{o:e})]}),y==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof k=="number"&&t.jsx(fo,{v:k,sur:100,k:a.cdConvScore}),un(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",un(e.verdictDate,r)]})]}),E&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:Ep(E)}})]}),y==="memo"&&t.jsx(Bp,{o:e}),y==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(We,{k:a.cdSector,v:e.sector}),t.jsx(We,{k:a.cdMarket,v:e.market,wide:!0}),t.jsx(Ip,{k:a.cdTags,vals:e.tags}),t.jsx(We,{k:a.cdStage,v:e.stage}),t.jsx(We,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(We,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(We,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(We,{k:a.cdAngle,v:e.angle}),t.jsx(We,{k:a.cdDetected,v:un(e.date,r)}),t.jsx(We,{k:a.cdQuery,v:e.provQuery,wide:!0}),t.jsx(We,{k:a.cdSrc,v:On(e.provUrl||""),href:ma(e.provUrl||"")}),t.jsx(We,{k:a.cdAngleSrc,v:Oa(e)})]}),y==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(We,{k:a.cdName,v:e.contactName}),t.jsx(We,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(We,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(We,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),y==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(We,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx($p,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(e),children:a.actRegen})]})]})]})]})}const Ca=new Map;function Up({o:e}){const{t:a,token:r}=Z(),[n,o]=p.useState(!1),[i,d]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const g=`${r}:${e.name.toLowerCase()}`;let u=Ca.get(g);u||(u=Co(r,[e.name]).then(h=>h[e.name]||Object.values(h)[0]||null).catch(()=>null),Ca.set(g,u),u.then(h=>{(!h||!h.ok)&&Ca.delete(g)}));let b=!0;return u.then(h=>{b&&h&&h.ok&&d(h)}),()=>{b=!1}},[r,e.id,e.name]);const s=async()=>{if(n)return;o(!0);const g=await jo(r,e.name,e.website||e.domain||"");d(g),g.ok&&Ca.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(g)),o(!1)},l=(i==null?void 0:i.blocs)||{},f=[[a.qaVP,l.value_prop],[a.qaProduct,l.produit],[a.qaModel,l.modele],[a.qaSummary,l.synthese]],c=f.some(([,g])=>g);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&c&&t.jsxs(t.Fragment,{children:[f.filter(([,g])=>g).map(([g,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:g}),t.jsx("p",{children:u})]},g)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!c&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function Jt({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const s=()=>{const f=Math.max(280,Math.min(560,i.clientWidth||320));pr({kind:"op",card:e},f).then(c=>{!d&&c&&i.isConnected&&i.replaceChildren(c)})},l=window.requestAnimationFrame(s);return()=>{d=!0,window.cancelAnimationFrame(l),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;pr({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(l=>{!d&&l&&i.isConnected&&i.replaceChildren(l)});const s=l=>{l.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{d=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Hp=`
...
`;function Vp(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:d,top:s}}function Wp(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:s,doAnalyse:l,doDecide:f,doPromote:c,doRepeche:g,doApproach:u,doDeep:b,doOnboard:h,outbound:v,evalBusy:y}=Z(),m=e.popupId?r.get(e.popupId):null;if(!m)return null;const w=_e(m),E=Te(m),k=Ct(m),j=ga(m),N=m.kind==="target",q=T=>{a({type:"filters",patch:T}),a({type:"popup",id:null})};return Qt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Hp}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Vp(e.popupAnchor,!!m.card),onClick:T=>T.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:m.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ut(m.date)),tt(m.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[m.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>q({country:[m.cc]}),children:(Kt(m.cc,o)||m.countryLabel||"").toUpperCase()}),m.sector&&t.jsx("button",{type:"button",onClick:()=>q({sector:[m.sector]}),children:m.sector.toUpperCase()}),m.stage&&t.jsx("button",{type:"button",onClick:()=>q({stage:[m.stage]}),children:m.stage.toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{className:"am2",children:Pt(m.amountEur,o)})]}),i.pipe&&N&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),m.ceoStatus&&t.jsx("span",{className:"pstep own",children:m.ceoStatus})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ot(m.engine)," ",t.jsx("b",{children:tt(m.engine,o)})," — ",Es(m.engine,o),m.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",m.noteTitle]})]}),w?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(zt,{o:m,lg:!0})," ",t.jsx(Ka,{o:m,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Ao(w,o))," · ",n.win7(qo(w,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),m.card?t.jsx(Jt,{spec:m.card}):null,m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),i.pipe&&N&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof m.score=="number"&&m.score>0?" · "+n.score(m.score):""]})}),i.pipe&&N&&t.jsx(Wn,{o:m})]}),t.jsx(Vn,{name:m.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>s(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)]}),E===1&&t.jsxs(Qa,{lang:o,storeKey:m.name,className:"evalbtn memo",style:{flex:1,justifyContent:"center"},confirmLabel:n.actAnalyse,onConfirm:()=>{l(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(m,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(m,!1),a({type:"popup",id:null})},children:n.actNo}),Vt(m)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(m),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),m.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:m.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{h(m),a({type:"popup",id:null})},children:"🚀"})]}):m.engine==="media"&&m.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var T;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"popup",id:null}),(T=document.querySelector(".atl2 .demand"))==null||T.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(m.name),onClick:()=>s(m),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>s(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)," →"]}),m.website&&t.jsx("a",{className:"psite",href:m.website.startsWith("http")?m.website:"https://"+m.website,target:"_blank",rel:"noopener noreferrer",title:m.website,children:"🌐"})]})]})]}),document.body)}function Gp(){const{lang:e,token:a,dossiers:r,caps:n}=Z(),o=a||"home",{names:i,verdicts:d}=p.useMemo(()=>{const l=[],f={};return r.forEach(c=>{c.kind!=="target"||!c.name||(l.push(c.name),f[c.name]=js(c)||"")}),{names:l,verdicts:f}},[r]);return{diff:p.useMemo(()=>i.length?Ns(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function Yp(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:s}=Z(),[l,f]=p.useState(!1),[c,g]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!l)return;const E=k=>{u.current&&!u.current.contains(k.target)&&f(!1)};return document.addEventListener("click",E,!0),()=>document.removeEventListener("click",E,!0)},[l]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...s.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],h=i.loading&&!d.length,v=p.useRef({});p.useEffect(()=>{v.current={...r}},[r]);const y=E=>{const k=v.current[E],j=k!==void 0?r[E]-k:0;return t.jsxs("button",{type:"button",className:"step"+(E===3&&r[3]>0?" wait":""),style:{"--c":`var(${la[E]})`,"--tc":E<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsxs("span",{className:"l",children:[n.plabels[E],E===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(j>0?" up":j<0?" down":""),children:[r[E],j!==0&&t.jsxs("em",{className:"delta",children:[j>0?"+":"−",Math.abs(j)]})]})]},E)},m=(E,k,j)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),"data-off":E,style:{"--c":`var(${la[E]})`},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsx("span",{className:"l",children:j}),t.jsx("span",{className:"n",children:r[E]})]},E),w=(E,k,j,N=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:N,onClick:j,children:E},k);return t.jsxs("div",{className:"funnel"+(h?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(y)}),t.jsxs("div",{className:"offtrack",children:[m(5,!1,n.plabels[5]),m(7,!0,n.plabels[7]),m(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[w("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(c?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"}),a({type:"ptab",tab:1}),a({type:"continent",key:s.pipe?"europe":"monde"}),a({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}g(!0),window.setTimeout(()=>g(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":l,title:n.toolSort,onClick:()=>f(E=>!E),children:"⇅"}),l&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([E,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===E,className:"sortopt"+(e.sort.key===E?" on":""),onClick:()=>a({type:"sort",key:E}),children:[k,t.jsx("i",{children:e.sort.key===E?e.sort.dir===1?"↑":"↓":""})]},E))})]}),w("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),w("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Qp(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,mode:s,data:l}=Z(),f=p.useRef(null),[c,g]=p.useState(60);p.useEffect(()=>{let q=0;const T=()=>{var V;const L=f.current;if(!L)return;const C=(V=L.parentElement)==null?void 0:V.querySelector('.funnel [aria-selected="true"]');if(!C)return;const O=C.getBoundingClientRect(),U=L.getBoundingClientRect();g(Math.max(20,Math.min(O.left+O.width/2-U.left,U.width-30)))};return q=requestAnimationFrame(T),window.addEventListener("resize",T),()=>{cancelAnimationFrame(q),window.removeEventListener("resize",T)}},[e.ptab]);const u=e.ptab;let b=r.tuto[u].p;if(u===3){const q=i.filter(C=>C.kind==="target"&&Te(C)===3),T=q.filter(C=>xn(C)==="auto").length,L=q.filter(C=>xn(C)==="cd").length;b=r.tutoPending(T,L,q.length)}const h=(()=>{var q;if(s!=="client")return null;if(u===0&&i.length)return{label:r.tuto[0].a,locked:!1,run:()=>a({type:"chainStart",queue:i.map(T=>T.id)})};if(u===1){const T=i.filter(L=>L.kind==="target"&&Te(L)===1&&!d.has(L.id)).slice(0,10);if(T.length){const L=String(((q=l.credits)==null?void 0:q.plan)||"").toLowerCase(),C=L==="enterprise"||L==="entreprise";return{label:r.tuto[1].a,locked:!C,run:()=>{C&&a({type:"chainStart",queue:T.map(O=>O.id)})}}}}return null})(),v=Ss(u),y=u===1||u===2,m=u===5,w=u===7,E=u===6,k=v||m||w,j=r.plabels[u]+" · "+(o[u]??0),N=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:f,className:"tuto mini"+(k?"":" on-dark")+(y?" etape-on":"")+(m?" etape-out":"")+(w?" etape-view":"")+(E?" etape-fav":""),style:{"--bg":`var(${la[u]})`,"--ax":c+"px","--stc":k?"var(--ink)":"#fff","--stt":k?"#fff":"var(--ink)","--tc":k?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:j}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),h&&t.jsx("button",{type:"button",className:"tprim"+(h.locked?" lock":""),disabled:!!h.locked,title:h.locked?r.analyseLockHint:void 0,onClick:h.run,children:h.locked?"🔒 "+r.analyseLock:h.label}),u!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:N})]})}const fn=600,St=62,ho="atl2:fstats";function Kp(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Z(),[d,s]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(ho)==="on"}catch{return!1}}),l=r.stats,f=p.useMemo(()=>((l==null?void 0:l.by_day)||[]).slice(-30),[l]),c=(l==null?void 0:l.since)||"";if(!n.showFunnel||!l||typeof l.screened!="number")return null;const g=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,u=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),b=f.reduce((j,N)=>Math.max(j,N.s||0),0),h=f.length?fn/f.length:0,v=Math.max(4,h-4),y=f.length>=5&&b>0,m=r.marketEstimate||0,w=g(new Date().toISOString().slice(0,10)),E=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof l.kept=="number"?[[l.kept,e.funKept]]:[],...typeof l.analyzed=="number"?[[l.analyzed,e.funAnalyzed]]:[],...typeof l.shown=="number"?[[l.shown,e.funShown]]:[]],k=[];return typeof l.screened_window=="number"&&c&&k.push({cle:"fenetre",periode:e.funPerWindow(g(c),w),etapes:[[l.screened_window,e.funScreened("","")]]}),typeof l.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:E(l.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([N,q],T)=>t.jsxs("span",{className:"fst-t",children:[T>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(N)}),t.jsx("i",{children:q})]},j.cle+q)),j.cle==="total"&&m>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(m),Math.min(100,Math.round((l.screened||0)/m*100)))})]}),j.cle==="total"&&(l.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),j.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const N=!d;s(N),N&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(ho,N?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},j.cle)),d&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${fn} ${St}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((j,N)=>{const q=(j.s||0)/b*(St-4),T=(j.m||0)/b*(St-4),L=N*h+(h-v)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===j.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}),onKeyDown:C=>{C.key!=="Enter"&&C.key!==" "||(C.preventDefault(),i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}))},children:[t.jsx("title",{children:`${g(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:L-1,y:0,width:v+2,height:St,fill:"transparent"}),t.jsx("rect",{x:L,y:St-2-q,width:v,height:q,fill:"#cfe0d6"}),t.jsx("rect",{x:L,y:St-2-T,width:v,height:T,fill:"#0E7F3F"})]},j.d)}),t.jsx("line",{x1:0,y1:St-1.5,x2:fn,y2:St-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:g(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const yi={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Gn({o:e,locked:a=!1}){const{t:r}=Z(),n=ga(e),o=Ct(e),i=Te(e),d=xn(e),s=zs(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(yi[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(rd,{o:e})]})}const Yt=e=>e.length>22?e.slice(0,21)+"…":e;function fa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function ki(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .fzone:has(.stage.folded), .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .fzone:has(.stage.folded), .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Jp({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const d=()=>{var h,v,y;const s=document.querySelector(".atl2.ops .desk-list"),l=document.querySelector(".atl2.ops .listhead");if(!s){n(null);return}const f=s.getBoundingClientRect(),c=l?l.getBoundingClientRect().bottom:f.top;i({top:Math.round(c),left:Math.round(f.left),width:Math.round(f.width)});const g=[...s.querySelectorAll(":scope .grp")];let u=null;for(const m of g){const w=m.querySelector(".grp-h");w&&w.getBoundingClientRect().bottom<=c+2&&(u=m)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((h=b.querySelector(".ic"))==null?void 0:h.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Xp(e){const r=()=>{const n=ki(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function go({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Z(),[i,d]=p.useState(!1);if(p.useEffect(()=>{n||d(!1)},[n]),Ue(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const l=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(l?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Yt(e.name))})]})}function sa(e,a){e({type:"focus",id:a.id}),window.setTimeout(()=>{var r;window.dispatchEvent(new CustomEvent("ppmap:card-tab",{detail:{tab:"memo"}})),(r=document.querySelector(".atl2 .readpane"))==null||r.scrollIntoView({block:"nearest"})},40)}function Yn({o:e}){const{t:a,lang:r,caps:n,memoQueued:o,approachDone:i,doAnalyse:d,doDecide:s,doPromote:l,doRepeche:f,doApproach:c,dispatch:g,liveMemos:u}=Z(),b=v=>y=>{y.stopPropagation(),v()};if(n.lockActions){const v=b(()=>g({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:v,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const y=Te(e);return y===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:v,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Yt(e.name))})]})}):y===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:v,children:a.actAnalyse})}):y===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:v,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:v,children:a.actNo})]})}):y===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:v,children:a.actPromote})}):y===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:v,children:a.actApproach})}):y===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:v,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:v,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:v=>{v.stopPropagation(),fa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Pa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:v=>{v.stopPropagation(),fa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!n.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(go,{o:e})});const h=Te(e);if(h===0)return t.jsx("span",{className:"cell",children:t.jsx(go,{o:e})});if(h===1){const v=u.liveOf(e.name);if(v&&(v.status==="boot"||v.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Da,{item:v,serverOff:u.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const y=o.has(e.id);return t.jsx("span",{className:"cell cell-an",children:t.jsx(Qa,{lang:r,storeKey:e.name,className:"memobtn",disabled:y,confirmLabel:a.actAnalyse,onConfirm:()=>d(e),children:y?a.actAnalyseQueued:a.actAnalyse})})}if(h===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>sa(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(h===4){const v=i.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:v,onClick:b(()=>c(e)),children:v?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:b(()=>g({type:"modal",modal:"plug"})),children:a.actConn}),t.jsx("button",{type:"button",className:"lk sm dsrow",title:a.dsBtn,onClick:b(()=>g({type:"dossierOpen",id:e.id})),children:a.dsBtn})]})}return h===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>sa(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):h===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>f(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>sa(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>sa(g,e)),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Zp({o:e}){const{t:a,doThumb:r,thumbOf:n}=Z(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function ec({o:e}){const{lang:a}=Z();return _e(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(zt,{o:e}),t.jsx(Ka,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ot(e.engine||"")," ",tt(e.engine||"",a)]})})}function tc({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:s}){const{dispatch:l,caps:f,markRow:c,markedId:g,favIds:u,toggleFav:b,t:h}=Z(),v=Te(e),y=["#16233A","#475C6E","#8798A8","#B9C6D2"],m=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,w=m<=0?0:m<=7?1:m<=30?2:3,E=f.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][v]:y[w],k=u.has(e.id),j=N=>{if(a)return;if(d){d(e.id);return}if(f.pipe||e.kind==="op"){n();return}const q=N.currentTarget.getBoundingClientRect();l({type:"popup",id:e.id,anchor:{x:q.left+Math.min(280,q.width/3),y:q.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(g===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(f.pipe&&e.kind==="target"?" p"+v:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>c(e.id),onMouseLeave:()=>c(null),onClick:j,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx(Ci,{o:e}),t.jsxs("span",{className:"nd",children:[s&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${h.cdEngagement} ${Math.round(e.engagement*10)/10} · ${h.cdEngagementHint}`,children:"🔥"}),_e(e)&&t.jsx(zt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[f.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Ke(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(N=>N&&N!==e.name)||""]}),f.pipe&&!f.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:N=>N.stopPropagation(),children:[e.website&&t.jsx("a",{href:ma(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":h.rowSite,title:h.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:ma(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":h.rowLi,title:h.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":h.rowMail,title:h.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":h.rowTel,title:h.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:h.acqSee(e.acquirer),onClick:N=>{N.stopPropagation(),l({type:"acquirer",value:e.acquirer||""})},children:["← ",Yt(e.acquirer)]}),Be(e)?t.jsx("span",{className:"rdec",title:h.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:h.zoomNewsMark,children:"📰"}):null]}),t.jsx(ac,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(ec,{o:e}),f.pipe&&t.jsx(Gn,{o:e,locked:a}),f.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Yn,{o:e}),f.showThumbs&&t.jsx(Zp,{o:e})]}),r&&!a&&!d&&t.jsx(oc,{o:e})]})}function ac({o:e}){const{lang:a,caps:r}=Z();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Pt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function nc({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Z(),d=(u,b=!1)=>h=>{h.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),l=Pt(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=Ue(e),g=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),l&&t.jsx("span",{className:"oc-amt",children:l}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped})]}):Ke(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),fa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Yt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Jt,{spec:e.card})})]})}function rc({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Z();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=[e.tagline,e.headline,e.reasoning].find(f=>f&&f!==e.name)||"",s=Pt(e.amountEur,r),l=(()=>{const f=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return f?f[1].replace(/^www\./,"").slice(0,40):""})();return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[tt(e.engine||"",r),i?` · ${i}`:"",s?` · ${s}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Yn,{o:e})})]}),(e.sector||e.countryLabel||e.stage||e.acquirer)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null,e.acquirer?t.jsxs("span",{children:["← ",e.acquirer]}):null]}),(d||e.decryptHtml||e.url||e.card)&&t.jsxs("div",{className:"zoom-news",children:[d?t.jsx("p",{className:"zoom-lead",children:d}):null,e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):null,e.card?t.jsx("div",{className:"zoom-card",children:t.jsx(Jt,{spec:e.card})}):null,e.url?t.jsxs("a",{className:"zoom-src",href:e.url,target:"_blank",rel:"nofollow noopener",children:[a.zoomSrc,l?` · ${l}`:""," ↗"]}):null]}),t.jsx(Wn,{o:e})]})}function Ei({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:s,dossiers:l}=Z(),f=p.useRef(null),c=Be(e);if(p.useEffect(()=>{if(!c||!(e!=null&&e.decryptHtml))return;const x=f.current;if(!x)return;let F=!1;return hn(()=>import("./fit-DX-mzLKR.js"),[]).then(async z=>{await z.ensureEditoCss(),!(F||!x.isConnected)&&(z.beautifyEditoRows(x),z.mountCardFits(x))}),()=>{F=!0}},[c,e==null?void 0:e.decryptHtml]),!e&&!a){const x=l.find(Be);if(x)return t.jsx(Ei,{o:x})}const g=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||g,h=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!g||Ia(g),y=(e==null?void 0:e.engine)||"",m=Be(e),w=e?Pt(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const x=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return x?x[1].replace(/^www\./,"").slice(0,40):""})(),j=l.find(Be),N=((j==null?void 0:j.url)||"").trim(),q=!!u&&!!N&&(u===N||u.endsWith(N)||N.endsWith(u)),T=(x,F=!1)=>z=>{z.stopPropagation(),F&&d({type:"continent",key:"monde"}),d({type:"filters",patch:x})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const L=()=>{g&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:g}}))},C=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},O=()=>{fa({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:g})},U=e?Ue(e):!1,V=U&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",I=m?r.doEdito.replace(/^📖\s*/,""):y?tt(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[I,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!m&&(v||Pa({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:x=>x.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:f,className:"ed-decrypt-b zoom-body"+(m?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:T({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:T({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:T({stage:[e.stage]}),children:e.stage}),w&&t.jsx("span",{className:"oc-amt",children:w})]}),h&&t.jsx("div",{className:"zoom-card",children:t.jsx(Jt,{spec:h})}),(u&&!q&&!m||j&&!m)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!q&&!m&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:x=>x.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!m&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:x=>{x.stopPropagation(),d({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[U?t.jsxs("span",{className:"verdict",style:{"--c":V?"var(--brand)":"var(--red)"},children:[V?"✓":"✗"," ",t.jsx("b",{children:V?r.kept:r.dropped})]}):!v&&g?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:x=>{x.stopPropagation(),o(e,g)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Yt(g))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!m&&(v||Pa({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&g?" ghost":""),onClick:x=>{x.stopPropagation(),O()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&g&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!s.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),C()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),L()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Yt(g)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&g&&s.pipe&&t.jsx(Vn,{name:g})]})]})}function oc({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=Z();return!o.pipe&&e.kind==="op"?t.jsx(nc,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Wn,{o:e}),t.jsx(od,{o:e}),t.jsx(sd,{o:e}),t.jsx(Vn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Gn,{o:e})})]}),e.card&&t.jsx(Jt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ot(e.engine||"")," ",tt(e.engine||"",r)]}),_e(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(zt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function ic({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:s,lang:l}=Z();if(!d.pipe&&e.kind==="op"){const g=Pt(e.amountEur,l),u=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return h?h[1].slice(0,32):""})(),b=(h,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:h})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Jt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),g&&t.jsx("span",{className:"damt",children:g})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Ot(e.engine||"")," ",tt(e.engine||"",l)]}),_e(e)&&t.jsx(zt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Yn,{o:e})})]})}const f=Te(e),c=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][f];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":c},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Gn,{o:e}),_e(e)&&t.jsx(zt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&f===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>s(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>s(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>sa(i,e),children:[o.actMemoOf(e.memoType)," →"]})]})}function sc(){const{t:e}=Z(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function lc({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Z(),i=o==="en",d=c=>n.plabels[c]||"",s=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),l=s.includes(0)?0:s.sort((c,g)=>(e[g]||0)-(e[c]||0))[0];if(l===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[l]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:l===0?i?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:i?`${f} ${f>1?"files":"file"} in “${d(l)}”`:`${f} dossier${f>1?"s":""} dans « ${d(l)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:l}),children:[(i?"Open ":"Ouvrir ")+d(l)," →"]})]})}function dc(){var Ge,mt,Et,qt;const e=Z(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:s,markRow:l,lang:f,sessTally:c,data:g,dossiers:u,source:b,focusExtra:h,byId:v,token:y}=e,m=$o(),w=p.useMemo(()=>{var B,Y,ae,re;if(!y||b==="ops")return null;const M=(((B=m==null?void 0:m.ed)==null?void 0:B.date)||(m==null?void 0:m.day)||"").slice(0,10),R=[(Y=m==null?void 0:m.ed)==null?void 0:Y.html,(ae=m==null?void 0:m.ed)==null?void 0:ae.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:f==="en"?"Today's brief":"Brief du jour",headline:f==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((re=m==null?void 0:m.ed)==null?void 0:re.date)||M,decryptHtml:R||void 0,date:M,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,f,(Ge=m==null?void 0:m.ed)==null?void 0:Ge.html,(mt=m==null?void 0:m.ed)==null?void 0:mt.acquirers_html,(Et=m==null?void 0:m.ed)==null?void 0:Et.date,m==null?void 0:m.day]),E=M=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Bo,[k,j]=p.useState(new Set);p.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[N,q]=p.useState(null);p.useEffect(()=>{q(null)},[a.ptab,a.continent]);const[T,L]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){L(!1);return}const M=document.getElementById("atl2-stage");if(!M){L(!1);return}const R=new IntersectionObserver(([B])=>L(!!B&&B.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return R.observe(M),()=>R.disconnect()},[a.mapFolded]);const C=a.mapFolded||!T,O=M=>j(R=>{const B=new Set(R);return B.has(M)?B.delete(M):B.add(M),B}),U=b==="ops"||o.pipe,[V,I]=p.useState("all"),[x,F]=p.useState(!1),[z,$]=p.useState(null),[G,S]=p.useState(!1),P=p.useRef(!0);p.useEffect(()=>{if(P.current){P.current=!1;return}I("all"),S(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!G)return;const M=R=>{var B,Y;(Y=(B=R.target)==null?void 0:B.closest)!=null&&Y.call(B,".atl2 .doable")||S(!1)};return document.addEventListener("click",M,!0),()=>document.removeEventListener("click",M,!0)},[G]);const D=p.useMemo(()=>{var R;const M=new Map;for(const B of Vl(((R=m==null?void 0:m.ed)==null?void 0:R.html)||""))M.has(B.t)||M.set(B.t,B.html);return M},[(qt=m==null?void 0:m.ed)==null?void 0:qt.html]),Q=p.useCallback(M=>{if(M.decryptHtml)return M.decryptHtml;if(!D.size)return;const R=(M.name||"").trim().toLowerCase();if(R.length<3)return;const B=D.get(R);if(B)return B;for(const[Y,ae]of D)if(Y.includes(R)||R.includes(Y))return ae},[D]),{diff:H}=Gp(),[ce,te]=p.useState(!1),le=a.filters.win==="1"&&!a.filters.day,[xe,he]=p.useState(!1),[we,pe]=p.useState(!1),Ne=p.useMemo(()=>{const M={...a,filters:{...a.filters,win:"all",day:""}};return u.filter(R=>!Be(R)&&ut(R.date)===0&&Rt(R,M,o.pipe)).length},[u,a,o.pipe]),Ce=p.useMemo(()=>new Set(((H==null?void 0:H.added)||[]).map(M=>M.trim().toLowerCase()).filter(Boolean)),[H]),ue=p.useMemo(()=>{if(!Ce.size)return 0;const M={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(R=>!Be(R)&&Ce.has((R.name||"").trim().toLowerCase())&&Rt(R,M,o.pipe)).length},[u,Ce,a,o.pipe]);p.useEffect(()=>{const M=()=>{pe(!1),F(!1),he(!1),I("all"),S(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",M),()=>window.removeEventListener("ppmap:tunnel",M)},[]),p.useEffect(()=>{pe(!1),F(!1),he(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const be=p.useMemo(()=>{const M=s.filter(B=>!Be(B)&&Ke(B));let R="";for(const B of M){const Y=(B.date||"").slice(0,10);Y&&(!R||Y<R)&&(R=Y)}return{n:M.length,since:R?R.split("-").reverse().slice(0,2).join("/"):""}},[s]),ye=be.n,ee=p.useMemo(()=>{const R=we&&Ce.size>0||a.filters.signalOnly||V!=="all"||x||xe?s:d;let B=Bn(R,a.sort);return B=B.filter(Y=>!Be(Y)),xe&&(B=B.filter(Y=>ut(Y.date)===0)),we&&Ce.size&&(B=B.filter(Y=>Ce.has((Y.name||"").trim().toLowerCase()))),x||V==="explore"?B=B.filter(Ke):V==="eval"?B=B.filter(Y=>!Ke(Y)&&!Y.noCo&&(Y.kind==="op"||!Ue(Y))):o.pipe&&(B=B.filter(Y=>!Ke(Y))),B},[d,s,a.sort,V,we,Ce,x,xe,o.pipe]),J=p.useMemo(()=>o.pipe?u.filter(M=>M.kind==="target"&&!Be(M)&&_e(M)&&(a.continent==="monde"||M.continent===a.continent)):ee.filter(M=>_e(M)&&!Ue(M)),[o.pipe,u,ee,a.continent]).length,ie=p.useMemo(()=>o.pipe?ee:ee.filter(M=>!Ue(M)&&!M.noCo&&!Ke(M)),[ee,o.pipe]),oe=b==="ops"?ee.filter(Ke).length:0,me=xe?n.morningList:we?n.sinceList:o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,W=a.filters,se=W.sector.length+W.market.length+W.country.length+W.engine.length+W.stage.length+W.crible.length+W.angle.length+W.memoLevel.length+W.dealKind.length+(W.signalOnly?1:0)+(W.acquirer.trim()?1:0)+(W.search.trim()?1:0),ve=[];if(W.day)ve.push({k:"day",lib:n.fDay(W.day.slice(8,10)+"/"+W.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(W.win&&W.win!=="all"){const M=["1","7","30"].indexOf(W.win);M>=0&&ve.push({k:"win",lib:n.dates[M],off:()=>r({type:"filters",patch:{win:"all"}})})}const ke=M=>M.length<=2?M.join(", "):`${M.length} ${n.fSelected}`;for(const M of["sector","market","country","engine","crible"]){const R=W[M];R&&R.length&&ve.push({k:M,lib:ke(R),off:()=>r({type:"clearFacet",facet:M})})}W.search&&ve.push({k:"search",lib:"🔍 "+W.search,off:()=>r({type:"filters",patch:{search:""}})}),we&&Ce.size&&ve.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>pe(!1)}),W.signalOnly&&ve.push({k:"sig",lib:"🔴 "+n.sigDock(J||W.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const Ee=(M,R,B="",Y=!1)=>t.jsxs("button",{type:"button","data-s":M,className:B,"aria-sort":a.sort.key===M?a.sort.dir===1?"ascending":"descending":"none",style:Y?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:M}),children:[R,t.jsx("span",{className:"ar",children:a.sort.key===M&&a.sort.dir===1?"▴":"▾"})]},M),ge=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const M=new Map;ee.forEach(Y=>{const ae=Y.engine||"?";M.has(ae)||M.set(ae,[]),M.get(ae).push(Y)});const R={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},B=gn([...M.keys()],f);return[...M.entries()].sort((Y,ae)=>{const re=R[Y[0]]??10+B.indexOf(Y[0]),je=R[ae[0]]??10+B.indexOf(ae[0]);return re-je})},[ee,o.pipe,a.groupBy,f]),Pe=ge?ge.filter(([M])=>qa.has(M)).length:0,Je=(()=>{var R;return((R=(ge?ge.flatMap(([,B])=>B):ee)[0])==null?void 0:R.id)??null})(),at=p.useRef(!1),ze=p.useMemo(()=>u.find(Be)||w,[u,w]),[dt,nt]=p.useState(!1);p.useEffect(()=>{const M=()=>{at.current=!0,pe(!1)};return window.addEventListener("ppmap:reveal",M),window.addEventListener("ppmap:focus",M),()=>{window.removeEventListener("ppmap:reveal",M),window.removeEventListener("ppmap:focus",M)}},[]),p.useEffect(()=>{const M=()=>{ze&&r({type:"focus",id:ze.id})};return window.addEventListener("ppmap:edito",M),()=>window.removeEventListener("ppmap:edito",M)},[ze,r]),p.useEffect(()=>{if(!a.focusId)return;$(a.focusId);const M=window.setTimeout(()=>$(null),900);return()=>window.clearTimeout(M)},[a.focusId]),p.useEffect(()=>{if(U&&!(a.focusId&&(ee.some(M=>M.id===a.focusId)||u.some(M=>M.id===a.focusId)||a.focusId===(ze==null?void 0:ze.id)))&&!h){if(ze){r({type:"focus",id:ze.id});return}Je&&r({type:"focus",id:Je})}},[U,a.focusId,ee,Je,h,r,u,b,ze]),p.useEffect(()=>{if(!U||!a.focusId||ze&&a.focusId===ze.id||ee.some(R=>R.id===a.focusId))return;const M=u.find(R=>R.id===a.focusId);if(M){if(at.current){M.kind==="op"?I(Ke(M)?"explore":"eval"):V!=="all"&&I("all");return}V!=="all"&&Je&&r({type:"focus",id:Je})}},[U,a.focusId,V,ee,u,Je,r,ze]),p.useEffect(()=>{if(!U||!a.focusId||!at.current)return;const M=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!M){const ae=ee.findIndex(re=>re.id===a.focusId);if(ae>=0){const re=ge?"":"pt"+a.ptab;if(re){const je=a.shown[re]||E();ae>=je&&r({type:"more",group:re,by:ae-je+8})}}return}at.current=!1;const R=ki(),B=M.getBoundingClientRect();B.top>=R-2&&B.bottom<=window.innerHeight-4||Xp(M)},[U,a.focusId,a.ptab,ee,a.shown,ge,r]),p.useEffect(()=>{if(typeof window>"u")return;const M=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),R=document.querySelector(".atl2.ops, .atl2.cibles");if(!M||!R)return;const B=document.querySelector(".atl2 .fzone"),Y=()=>{R.style.setProperty("--listhead-h",`${M.offsetHeight}px`);const re=!!(B&&B.querySelector(".stage.folded"));R.style.setProperty("--fold-h",re&&B?`${B.offsetHeight}px`:"0px")};Y();const ae=new ResizeObserver(Y);return ae.observe(M),B&&ae.observe(B),()=>ae.disconnect()},[C,a.dens,a.mapFolded]);const Xe=p.useMemo(()=>{if(!U||!a.focusId)return null;if(w&&a.focusId===w.id)return w;const M=ee.find(B=>B.id===a.focusId)||u.find(B=>B.id===a.focusId)||null;if(!M)return null;const R=Q(M);return R&&R!==M.decryptHtml?{...M,decryptHtml:R}:M},[U,a.focusId,ee,u,Q,w]),rt=o.lockRowsAfter;let At=0;const bt=(M,R)=>{let B=a.shown[R]||E();return M.length-B<=4&&(B=M.length),M.slice(0,B).map(re=>{const je=rt!==null&&At>=rt;At++;const Ae=Q(re),de=Ae&&Ae!==re.decryptHtml?{...re,decryptHtml:Ae}:re,He=!U&&a.dens!=="maxi"&&(a.dens==="deplie"||(N?N==="open":!!Ae)),jt=k.has(re.id)?!He:He,Tt=U?xa=>{at.current=!0,r({type:"focus",id:xa});const ft=v.get(xa);ft&&(Ke(ft)?fa(ft):ft.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ft.name,url:ft.url||"",website:ft.website||"",domain:ft.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(ic,{o:de,locked:je,selected:U&&a.focusId===re.id,onSelect:Tt},re.id):t.jsx(tc,{o:de,locked:je,open:jt,onToggle:()=>O(re.id),selected:U&&a.focusId===re.id,echo:z===re.id,fresh:Ce.has((re.name||"").trim().toLowerCase()),onSelect:Tt},re.id)})},Bt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ee.length?"":" list-empty"),$t=t.jsxs(t.Fragment,{children:[ge?ge.map(([M,R])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ot(M)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:M==="ma"?n.grpMa:M==="fundraising"?n.grpLev:qa.has(M)&&Pe<=1?n.grpNews:M==="nominations"?n.grpNom:M==="media"?n.grpNewsOther:M==="recrutements"?n.grpHire:qa.has(M)?n.grpNews+" · "+tt(M,f):tt(M,f)}),t.jsx("div",{className:"s",children:n.grpCount(R.filter(B=>!Ue(B)).length,R.length)})]})]}),bt(R,M)]},M)):bt(ee,"pt"+a.ptab),g.loading&&!u.length&&t.jsx(sc,{}),o.pipe&&a.ptab===0&&!x&&!we&&!xe&&V==="all"&&!a.filters.signalOnly&&!g.loading&&t.jsx(cp,{}),!ee.length&&!(g.loading&&!u.length)&&(o.pipe&&V==="all"?t.jsx(lc,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(W.win!=="all"||!!W.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),se>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(se)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),De=t.jsxs(t.Fragment,{children:[!x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+la[a.ptab]+")"},children:ee.length})," ",me]}),x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+la[a.ptab]+")"},children:ee.length})," ",n.newsWord]}),t.jsx("span",{className:"dot",children:"·"}),C&&!a.mapFolded&&t.jsx(fi,{variant:"compact",mapToggle:!1}),t.jsxs("span",{className:"ctx",children:[C?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ve.map(M=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:R=>{R.stopPropagation(),M.off()},children:[M.lib,t.jsx("i",{children:"×"})]},M.k)),b==="ops"&&ee.length>0&&!C&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ee.length-oe," ",n.zoomPulseEval,oe>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",oe," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),Ze=t.jsxs("div",{className:"listhead"+(C?" mapoff":""),children:[C&&t.jsx("div",{className:"lh-tools",children:t.jsx(mi,{compact:!0})}),o.showFunnel&&ce&&le&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(dd,{}),t.jsx(Kp,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:De}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Yp,{}),t.jsx(Qp,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(xe?" on":""),"aria-pressed":xe,title:n.morningDockTitle,onClick:()=>{if(xe){he(!1),te(!1);return}pe(!1),F(!1),I("all"),he(!0),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}}),te(!1)},children:["📊 ",n.morningDock(Ne)]}),H&&!H.firstVisit&&(H.added.length>0||H.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(we?" on":""),"aria-pressed":we,title:n.sinceSub,onClick:()=>{const M=!we;pe(M),F(!1),he(!1),te(!1),I("all"),M&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(ue),H!=null&&H.lastDate?` · ${n.sinceSince(H.lastDate)}`:""]}),J>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{pe(!1),F(!1),he(!1),te(!1),I("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(J)]}),o.pipe&&ye>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(x?" on":""),"aria-pressed":x,title:n.newsDockHint,onClick:()=>{const M=!x;F(M),pe(!1),he(!1),te(!1),I("all"),M&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ye),be.since?` · ${n.newsSince(be.since)}`:""]})]}),!o.showFunnel&&De,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([M,R])=>t.jsxs("button",{type:"button","data-d":M,"aria-pressed":a.dens===M||M==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:M}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:R})]},M))}),!U&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":N==="open",onClick:()=>{q("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":N==="closed",onClick:()=>{q("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var Ae;const M={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},R=u.filter(de=>Rt(de,M,o.pipe)&&!Be(de)),B=R.filter(de=>!Ke(de)&&!de.noCo&&(de.kind==="op"||!Ue(de))).length,Y=R.filter(Ke).length,ae=o.pipe?R.filter(de=>de.kind!=="op"&&Te(de)===1).length:0,re=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ae?` ${ae}`:""}`]]:[],["eval",`${n.doEval}${B?` ${B}`:""}`],["explore",`${n.doExplore}${Y?` ${Y}`:""}`]],je=((Ae=re.find(([de])=>de===V))==null?void 0:Ae[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":G,onClick:()=>S(de=>!de),children:[je,t.jsx("i",{children:"▾"})]}),G&&t.jsx("div",{className:"dolist",children:re.map(([de,He])=>t.jsx("button",{type:"button","aria-pressed":V===de,onClick:()=>{if(S(!1),de==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}I(de),de!=="all"&&(pe(!1),F(!1),te(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:He},de))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:M=>r({type:"sort",key:M.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([M,R])=>t.jsx("option",{value:M,children:R},M))})]}),o.showChain&&t.jsxs("span",{className:"chainwrap"+(ie.length===0?" empty":""),children:[t.jsxs("button",{type:"button",className:"chain",disabled:ie.length===0,title:n.chainHint,onClick:()=>{ie.length&&r({type:"chainStart",queue:ie.map(M=>M.id)})},children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ie.length):n.chainAll(ie.length)]}),!o.pipe&&t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!U&&Ze,a.dens!=="maxi"&&!U&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Ee("country",n.colCountry),Ee("name",n.colCompany),Ee("amount",n.colAmount,"h-amt",!0),Ee("stage",n.colStage,"h-stade"),Ee("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Ee("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Ee("memo",n.colMemo)]}),o.pipe&&Ee("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),U?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[Ze,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Ee("country",n.colCountry),Ee("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Ee("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Ee("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:Bt,children:$t})]}),t.jsxs("aside",{className:"readpane"+((Xe?Be(Xe):!h&&ze)?" is-edito":""),"aria-label":f==="fr"?"Dossier":"File",children:[ze&&(()=>{const M=a.focusId===ze.id&&!dt,R=(ze.headline||ze.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":M,onClick:()=>{if(M){nt(!0);return}nt(!1),r({type:"focus",id:ze.id})},children:[t.jsx("span",{className:"eg-t",children:f==="en"?"Today’s editorial":"Édito du jour"}),R&&t.jsx("span",{className:"eg-sub",children:R}),t.jsx("span",{className:"eg-chev",children:M?f==="en"?"Collapse ▴":"Replier ▴":f==="en"?"Read ▾":"Lire ▾"})]})})(),!!(ze&&(Xe?Be(Xe):!h))&&dt?null:w&&a.focusId===w.id?t.jsx("div",{className:"zoom",children:t.jsx(Kl,{})}):Xe&&o.pipe?t.jsx(rc,{o:Xe}):t.jsx(Ei,{o:Xe,extra:Xe?null:h})]})]}):t.jsx("div",{className:Bt,children:$t}),(()=>{const M=ge||[["pt"+a.ptab,ee]];let R=0,B=0;for(const[ae,re]of M){B+=re.length;let je=a.shown[ae]||E();re.length-je<=4&&(je=re.length),R+=Math.min(re.length,je)}const Y=B-R;return Y<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>M.forEach(([ae,re])=>r({type:"more",group:ae,by:re.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(Y,Y)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(R,B)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}}),U&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Jp,{on:!!ge,rev:(ge||[]).map(([M,R])=>M+R.length).join("|")})]})}function xo(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function pc(e,a){const r=Cs(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function cc(e,a){const n=[a.head.split("|").map(xo).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",pc(o,a.plabels),ga(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(xo).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function uc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const mc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ye({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function ea({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function fc({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=Z(),d=(e.cribleStatus||"").trim().toUpperCase()||(ga(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=Ct(e),l=(a==null?void 0:a.blocs)||{},f=[[n.qaVP,l.value_prop],[n.qaProduct,l.produit],[n.qaModel,l.modele],[n.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Ye,{k:n.cdSector,v:e.sector}),t.jsx(Ye,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(Ye,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(Ye,{k:n.cdStage,v:e.stage}),t.jsx(Ye,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ye,{k:n.cdSite,v:e.domain||e.website}),t.jsx(Ye,{k:n.cdName,v:e.contactName}),t.jsx(Ye,{k:n.cdEmail,v:e.contactEmail}),t.jsx(Ye,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Ye,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Ye,{k:n.cdAngle,v:e.angle}),t.jsx(Ye,{k:n.cdDetected,v:mc(e.date,o)})]}),!!(e.provQuery||e.provUrl||Oa(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(Ye,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(Ye,{k:n.cdSrc,v:On(e.provUrl||""),href:ma(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(Ye,{k:n.cdAngleSrc,v:Oa(e)})]})]}),f.some(([,c])=>c)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),f.filter(([,c])=>c).map(([c,g])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:c}),t.jsx("p",{children:g})]},c))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([c,g,u])=>t.jsxs("div",{className:"dssq "+c,children:[t.jsx("b",{children:g}),t.jsx("ul",{children:u.map(b=>t.jsx("li",{children:b},b))})]},c))})]}),t.jsx(ea,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(ea,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(ea,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(ea,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(ea,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function hc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d,st:s}=Z(),[l,f]=p.useState({}),[c,g]=p.useState({}),u=25,b=12,h=p.useMemo(()=>{if(s.dossierId){const m=n.find(w=>w.id===s.dossierId)||i.dossiers.find(w=>w.id===s.dossierId);return m?[m]:n.slice(0,u)}return n.slice(0,u)},[n,s.dossierId,i.dossiers]);p.useEffect(()=>{h.length&&Co(r,h.map(m=>m.name)).then(f)},[r,h]),p.useEffect(()=>{const m=h.filter(k=>!!k.memoUrl).slice(0,b);if(!m.length){g({});return}let w=!1;const E={};return(async()=>{for(const k of m){if(w)return;try{const j=await wi(k.memoUrl||"");if(w)return;j&&Rp(j.comite)&&(E[k.id]=j.comite,g({...E}))}catch{}}})(),()=>{w=!0}},[h]);const v=i.stats,y=m=>m.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(h.length)}),!s.dossierId&&n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),v&&typeof v.screened=="number"&&t.jsxs("p",{children:[y(v.screened)," ",e.funScreened(""),typeof v.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",y(v.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(y(i.marketEstimate)),", ",Math.round(v.screened/i.marketEstimate*100)," %"]})]})]}),h.map(m=>t.jsx(fc,{o:m,qa:l[m.name],comite:c[m.id]},m.id)),!h.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const gc=50;function Qn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Z(),[i,d]=p.useState(null),[s,l]=p.useState(!1),[f,c]=p.useState(""),[g,u]=p.useState(0),[b,h]=p.useState(""),[v,y]=p.useState(!1),[m,w]=p.useState(0),E=p.useRef(null),k=p.useRef(null),j=()=>{w(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>w(L=>L+1),1e3)},N=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};p.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),k.current&&window.clearInterval(k.current)},[]);const q=async L=>{l(!0),c(""),j();const C=await a();if(l(!1),N(),C.ok){d(C);return}if(C.busy){c(o.alertPreviewBusy);return}if(!L){c(o.alertPreviewFail);return}u(gc),N(),E.current=window.setInterval(()=>{u(O=>O>1?O-1:(E.current&&window.clearInterval(E.current),q(!1),0))},1e3)},T=async()=>{if(n||v||s)return;y(!0),h(""),j();const L=await r();y(!1),N(),h(L.ok?o.alertTestOk(L.sentTo||""):L.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||v||g>0,onClick:()=>{q(!0)},children:s?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||s,onClick:()=>{T()},children:v?o.alertBtnTestBusy:o.alertTest})]}),s&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(m)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(m)]}),g>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(g)}),f&&t.jsx("p",{className:"mnote warn",children:f}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const kt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Qe({title:e,icon:a,children:r,wide:n,kind:o,lead:i}){const{dispatch:d}=Z(),s=o==="plug"?"min(720px,100%)":"min(760px,100%)";return Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:l=>{l.target===l.currentTarget&&d({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard"+(o?" m-"+o:""),style:n?{width:s}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsxs("div",{className:"mh-txt",children:[t.jsx("h2",{children:e}),i&&t.jsx("p",{className:"mh-lead",children:i})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>d({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function xc(){const{st:e}=Z();switch(e.modal){case"chain":return t.jsx(vc,{});case"space":return t.jsx(wc,{});case"alert":return t.jsx(yc,{});case"queue":return t.jsx(Sc,{});case"export":return t.jsx(zc,{});case"plug":return t.jsx(qc,{});case"approach":return t.jsx(Tc,{});case"recharge":return t.jsx(Rc,{});case"cover":return t.jsx(Mc,{});case"dossier":return t.jsx(Oc,{});case"crit":return t.jsx(_c,{});case"tuto":return t.jsx(Bc,{});case"rdv":return t.jsx(bc,{});case"memoalert":return t.jsx(Cc,{});default:return null}}function bc(){const{dispatch:e,fund:a,t:r}=Z(),n=a||r.rdvCoFallback;return Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Lo,children:To}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Ma}`,children:Ma})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(nl,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function vc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:s,caps:l,memoQueued:f,doAnalyse:c}=Z(),g=i==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,h=u[b],v=b>=u.length;return Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!h?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:h.name}),t.jsx("div",{className:"sub",children:[Kt(h.cc,o)||h.countryLabel,h.sector,h.stage,n.daysAgo(ut(h.date))].filter(Boolean).map(y=>String(y)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:tt(h.engine,o)}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{children:Pt(h.amountEur,o)})]}),_e(h)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(zt,{o:h,lg:!0})," ",t.jsx(Ka,{o:h,src:!0})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),h.reasoning&&!(g&&Ue(h))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),g&&Ue(h)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Ft(h)==="retenu"?"var(--brand)":Ft(h)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ft(h)==="retenu"?"✓ "+n.kept:Ft(h)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:h.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&h&&l.pipe&&Te(h)===1&&!f.has(h.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(h),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&h&&!(g&&Ue(h))&&(h.noCo&&h.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{d(h)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function wc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Z(),i=o==="client",d=p.useMemo(()=>i?r.filter(g=>Ue(g)):[],[r,i]),s=p.useMemo(()=>Bn(d.filter(g=>Ft(g)==="retenu"),{key:"signal",dir:-1}),[d]),l=p.useMemo(()=>d.filter(g=>Ft(g)==="ecarte"),[d]),f=e.spaceTab==="retenu"?s:l,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Qe,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:l.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(g=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof g.score=="number"&&g.score>0?g.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:g.name}),t.jsx("div",{className:"rr",children:g.reasoning||g.tagline||""})]})]},g.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function yc(){const{mode:e}=Z();return e==="client"||e==="apercu"?t.jsx(kc,{}):t.jsx(Nc,{})}function kc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Z(),[i,d]=p.useState("d"),s=o!=="client";return t.jsxs(Qe,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Ec,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(jc,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(ji,{})]})}function Ec({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[s,l]=p.useState(!1),[f,c]=p.useState(0);p.useEffect(()=>{let T=!0;return l(!1),hr(a).then(L=>{T&&(L?d(L):l(!0))}),()=>{T=!1}},[a,f]);const g=p.useRef({}),[u,b]=p.useState({}),[h,v]=p.useState(!1),[y,m]=p.useState(!1),w=p.useRef(null);p.useEffect(()=>()=>{w.current&&window.clearTimeout(w.current)},[]);const E=T=>{const L=g.current;Object.keys(L).length&&(v(!0),hr(a,L).then(C=>{if(!C){v(!1),o(e.actErr);return}if(C.throttled&&T<3){w.current=window.setTimeout(()=>E(T+1),5400);return}if(g.current={},b({}),d(C),v(!1),C.throttled){o(e.alertThrottled);return}m(!0),window.setTimeout(()=>m(!1),2e3),n(e.alertSaved)}))},k=T=>{r||(g.current={...g.current,...T},b(L=>({...L,...T})),w.current&&window.clearTimeout(w.current),w.current=window.setTimeout(()=>E(1),700))};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(T=>T+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...u},N=T=>!j.sections||j.sections.includes(T),q=T=>{const L=j.sections||e.alertSec.map(([C])=>C);k({sections:N(T)?L.filter(C=>C!==T):[...L,T]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,h&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!h&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([T,L])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:N(T),disabled:r,onChange:()=>q(T)}),t.jsxs("span",{children:[L,T==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},T))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Qn,{label:e.alertPreview,readOnly:r,onPreview:()=>Bs(a),onTest:()=>_s(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function jc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[s,l]=p.useState(!1),[f,c]=p.useState(0);p.useEffect(()=>{let h=!0;return l(!1),gr(a).then(v=>{h&&(v?d(v):l(!0))}),()=>{h=!1}},[a,f]);const g=h=>{r||gr(a,h).then(v=>{if(!v){o(e.actErr);return}d(v),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(h=>h+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:h=>g({dow:Number(h.target.value)}),children:e.alertDow.map((h,v)=>t.jsx("option",{value:v,children:h},h))}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Qn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Us(a),onTest:()=>$s(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function ji(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Z(),[d,s]=p.useState(i||""),[l,f]=p.useState(!1),[c,g]=p.useState(!1);p.useEffect(()=>{i&&s(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(m=>_e(m)).length,[n]),h=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(d)||c)){g(!0);try{await fetch(`${ha}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{g(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[h]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(m=>tt(m,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(m=>Kt(m,r)||m).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return l?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([m,w])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:m}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:w}})]},m))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:m=>s(m.target.value),onKeyDown:m=>{m.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Nc(){const{t:e}=Z();return t.jsx(Qe,{title:e.alertTitle,icon:"🔔",children:t.jsx(ji,{})})}function Sc(){var x,F;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:s,dispatch:l,liveMemos:f,data:c,flash:g}=Z(),[u,b]=p.useState(()=>Za(r)),[h,v]=p.useState(()=>!Za(r)),[y,m]=p.useState([]),[w,E]=p.useState(0),[k,j]=p.useState(!1),N=n==="client",q=p.useMemo(()=>{const z=new Map;return o.forEach($=>{const G=($.name||"").trim().toLowerCase();G&&!z.has(G)&&z.set(G,$)}),z},[o]);p.useEffect(()=>{let z=!0;return(!Za(r)||w>0)&&v(!0),(async()=>{const[$,G]=await Promise.all([Pn(r,w>0),Fo(a)]);z&&($&&b($),v(!1),m(G))})(),()=>{z=!1}},[a,r,w]);const T=h&&!u,L=(u==null?void 0:u.per_day)??0,C=((x=u==null?void 0:u.analyzed_today)==null?void 0:x.length)??0,O=u==null?void 0:u.offre,U=(u==null?void 0:u.pool_meta)||[],V=p.useMemo(()=>{const z=new Map;for(const $ of(u==null?void 0:u.scheduled)||[])for(const G of $.names||[])z.has(G)||z.set(G,{label:$.day_label,date:$.date});return z},[u==null?void 0:u.scheduled]),I=(u==null?void 0:u.in_progress)||[];return t.jsxs(Qe,{title:e.queueTitle,wide:!0,children:[O&&t.jsxs("div",{className:"qoffre"+(O.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:O.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:O.delai})]}),t.jsx("span",{className:"osp"}),O.rythme>0?t.jsx("span",{className:"or",children:e.qRate(O.rythme)}):O.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(O.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:T?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(C,C+(((F=u==null?void 0:u.pool_order)==null?void 0:F.length)??0))}})}),O&&t.jsxs("div",{className:"qeta",children:[O.file===0?e.qEtaDone:O.rythme<=0?e.qEtaPaused:e.qEta(O.file,O.rythme,O.jours_restants),O.en_retard&&t.jsxs("em",{children:[" ",e.qLate(O.delai,O.plafond)]})]}),!T&&t.jsxs("div",{className:"qrate",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate})," — ",t.jsx("b",{children:e.covRateNow(L)}),(O==null?void 0:O.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]}),N&&t.jsx("div",{className:"covrb",role:"group","aria-label":e.covRate,children:[0,1,2,3,5,10].map(z=>t.jsx("button",{type:"button",className:L===z?"on":"",disabled:k,title:z===0?e.identPauseTitle:e.covRateNow(z),onClick:()=>{k||!a||(j(!0),Ro(a,z).then($=>{j(!1),$!==null&&(b(G=>G&&{...G,per_day:$}),g(e.alertSaved))}))},children:z===0?"⏸":z},z))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint}),!!c.credits&&!c.credits.unlimited&&!!(c.credits.packs||[]).length&&t.jsxs("div",{className:"qpacks-mini",children:[t.jsxs("span",{children:[e.creditsCap," ",c.credits.total_available,"/",c.credits.daily_grant+c.credits.purchased," · ",e.creditsPacksLbl]}),t.jsx("div",{children:c.credits.packs.map(z=>t.jsxs("button",{type:"button",className:"qpack-mini",onClick:()=>{const $=c.email;if(!$)return;const G=window.location.href.split("?")[0];fetch(`${ha}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:$,lookup_key:z.lookup_key,success_url:G+"?credits=ok",cancel_url:G+"?credits=cancel"})}).then(S=>S.json()).then(S=>{S.url&&(window.location.href=S.url)}).catch(()=>{})},children:[z.credits," · ",z.price_eur," €"]},z.lookup_key))})]})]})]}),(I.length>0||f.items.some(z=>z.status==="boot"||z.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[f.items.filter(z=>z.status==="boot"||z.status==="running"||z.status==="error").map(z=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:z.name}),t.jsx("span",{className:"qd",children:z.memoType||""}),t.jsx(Da,{item:z,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+z.name)),I.filter(z=>!f.liveOf(z.name)).map(z=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:z.name}),t.jsxs("span",{className:"qd",children:[z.memo_type||"",z.age_min?` · ${Math.round(z.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:z.state||""})]},"ip-"+z.name))]})]}),y.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:y.map(z=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:z.company}),t.jsxs("span",{className:"qd",children:[z.memo_type,typeof z.est_min=="number"?` · ~${z.est_min} min`:""]}),t.jsx("span",{className:"qt",children:z.status}),z.url&&t.jsx("a",{className:"qgo",href:z.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(z.memo_type)}),N&&z.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{mr(a,z.company,"retry").then(()=>E($=>$+1))},children:e.queueRetry}),N&&z.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{mr(a,z.company,"delete").then(()=>E($=>$+1))},children:e.queueDelete})]},z.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",T?e.qUpNextWait:e.qUpNext(U.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[T&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!T&&U.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),U.map((z,$)=>{const G=V.get(z.name),S=q.get((z.name||"").trim().toLowerCase()),P=f.liveOf(z.name),D=!!(S&&d.has(S.id))||!!(P&&(P.status==="boot"||P.status==="running")),Q=!!(S&&Te(S)===1&&!S.memoUrl)&&!P;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",$+1]}),G?t.jsx("span",{className:"qwhen"+(G.label==="demain"?" soon":""),children:G.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:z.name}),z.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof z.score=="number"&&t.jsx("span",{className:"qs2",children:z.score}),P&&(P.status==="boot"||P.status==="running")&&t.jsx(Da,{item:P,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),Q&&(s.lockActions||!N?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>l({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:D,onClick:()=>{i(S),E(H=>H+1)},children:D?e.actAnalyseQueued:e.actAnalyse})),z.excerpt&&t.jsx("span",{className:"qex",children:z.excerpt})]},z.name+":"+$)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([z,$])=>t.jsxs("li",{children:[t.jsx("b",{children:z})," — ",$]},z))})]})}function zc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=Z(),s=`${kt}/cibles/list.csv?token=${a}`,l=`${kt}/cibles/list.json?token=${a}`,f=`${kt}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,g=y=>{var m;(m=navigator.clipboard)==null||m.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:l,href:l},{def:e.exportXlsx,value:f,href:f}],b=!o.lockActions&&n.length>0,h=()=>{uc(cc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([m])=>m===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Qe,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:h,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:m,href:w})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>g(m),children:e.exportCopy}),w&&t.jsx("a",{className:"exb",href:w,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Cc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Z(),i=o!=="client",[d,s]=p.useState(null),[l,f]=p.useState(!1),[c,g]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let m=!0;return f(!1),cr(a).then(w=>{m&&(w?s(w):f(!0))}),()=>{m=!1}},[a,c]);const h=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=m=>{if(i||!d)return;const w={enabled:m.enabled??!!d.enabled,email:m.email??(d.email||""),sections:m.sections??h()};b(!0),cr(a,w).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}s(E),r(e.memoAlertSaved)})};if(l)return t.jsx(Qe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>g(m=>m+1),children:e.retry})]})});if(!d)return t.jsx(Qe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=h();return t.jsxs(Qe,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||u,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(Ac,{value:d.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:m=>v({email:m})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([m,w])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[m],disabled:i||u,onChange:()=>v({sections:{...y,[m]:!y[m]}})}),t.jsx("span",{children:w})]},m))}),t.jsx(Qn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>qs(a,y),onTest:()=>As(a,y)})]})}function Ac({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=p.useState(e);p.useEffect(()=>{d(e)},[e]);const s=i.trim()!==e.trim(),l=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:f=>d(f.target.value),onKeyDown:f=>{f.key==="Enter"&&s&&l&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!l,onClick:()=>o(i.trim()),children:n})]})]})}function qc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Z(),[i,d]=p.useState(null),[s,l]=p.useState(!1),[f,c]=p.useState(null),[g,u]=p.useState(!1),[b,h]=p.useState(""),[v,y]=p.useState(0),[m,w]=p.useState("webhook"),[E,k]=p.useState("webhook"),[j,N]=p.useState(""),q=p.useRef(!1);p.useEffect(()=>{let z=!0;return l(!1),ur(a).then($=>{z&&($?d({configured:$.configured,url_hint:$.url_hint}):l(!0))}),Rs(a).then($=>{if(z){if(!$){u(!0);return}u(!1),c($),q.current||(q.current=!0,$.destination==="instantly"&&(w(G=>G==="webhook"?"instantly":G),k(G=>G==="webhook"?"instantly":G)),$.campaign_id&&N(G=>G||$.campaign_id||""))}}),()=>{z=!1}},[a,v]);const T=(z,$)=>{o&&ur(a,z).then(G=>{if(!G||G.ok===!1){n(e.actErr);return}z.test&&G.sent===!1?n(e.plugTestThrottled):r($),y(S=>S+1)})},L='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',C=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),O=`curl -X POST ${kt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,U=`curl -X POST ${kt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`,V=[{k:"webhook",t:e.plugDestCrm,s:e.plugDestCrmS},{k:"instantly",t:e.plugDestInst,s:e.plugAideInst},{k:"script",t:e.plugDestScript,s:e.plugDestScriptS}],I=E==="instantly"?e.plugStep2Inst:E==="script"?e.plugStep2Script:e.plugStep2Wh,x=E==="instantly"?e.plugAideInst:E==="script"?e.plugAideScript:e.plugAideWh,F=z=>{k(z),z!=="script"&&w(z)};return t.jsxs(Qe,{title:e.plugTitle,icon:"🔌",wide:!0,kind:"plug",lead:e.plugLead,children:[f&&t.jsxs("div",{className:"plugetat"+(f.enabled?" on":""),children:[t.jsx("i",{}),t.jsx("b",{children:f.enabled?e.plugEtatOn:e.plugEtatOff})]}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>y(z=>z+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"1"}),t.jsx("h4",{children:e.plugStep1})]}),t.jsx("div",{className:"plugdests",children:V.map(z=>{const $=E===z.k;return t.jsxs("button",{type:"button",className:"plugdest"+($?" on":""),onClick:()=>F(z.k),children:[t.jsx("span",{className:"pradio","aria-hidden":"true"}),t.jsx("b",{children:z.t}),t.jsx("em",{children:z.s})]},z.k)})}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"2"}),t.jsx("h4",{children:I})]}),E==="script"?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:O}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var z;(z=navigator.clipboard)==null||z.writeText(O).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}):E==="instantly"?t.jsx("div",{className:"mfield pill",children:t.jsx("input",{type:"text",maxLength:80,placeholder:e.plugCampPh,value:j,disabled:!o,onChange:z=>N(z.target.value)})}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"mfield pill",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:z=>h(z.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>T({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>T({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>T({remove:!0},e.plugRemoved),children:e.plugRemove})]})]}),t.jsx("p",{className:"mnote dim",children:x}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"3"}),t.jsx("h4",{children:e.plugStep3})]}),t.jsx(Lc,{auto:f,autoKo:g,destKind:m,camp:j,onRetry:()=>y(z=>z+1),onDone:z=>{c(z),u(!1)}}),t.jsx("p",{className:"mnote dim",children:e.plugHow3}),t.jsxs("details",{className:"plugex plugpay",children:[t.jsxs("summary",{children:[t.jsx("b",{children:e.plugExT}),t.jsx("span",{children:e.plugPayloadSub})]}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:C}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var z;(z=navigator.clipboard)==null||z.writeText(C).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult}),t.jsx("p",{className:"mnote dim",children:e.plugVars})]}),t.jsx("div",{"data-tour":"plug-bulk",children:t.jsx(Fc,{destKind:m,setDestKind:z=>{w(z),k(z)},camp:j,setCamp:N,whHint:i!=null&&i.configured?i.url_hint||"webhook":null})}),E!=="script"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:O}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var z;(z=navigator.clipboard)==null||z.writeText(O).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var z;(z=navigator.clipboard)==null||z.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm","data-tour":"plug-crm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:U}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var z;(z=navigator.clipboard)==null||z.writeText(U).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Tc(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:s}=Z(),l=p.useMemo(()=>r.find(x=>x.id===n.approachId)||null,[r,n.approachId]),[f,c]=p.useState("email"),[g,u]=p.useState(0),[b,h]=p.useState({}),[v,y]=p.useState(!1),[m,w]=p.useState(""),[E,k]=p.useState({});if(p.useEffect(()=>{!l||b[f]||v||(y(!0),w(""),Fs(a,l.name,f).then(x=>{if(y(!1),!x||x.ok===!1){w((x==null?void 0:x.error)||e.apprFail);return}h(F=>({...F,[f]:x}))}))},[l,f,a]),!l)return null;const j=b[f],N=(j==null?void 0:j.sequence)||[],q=N[g],T=x=>`${f}|${g}|${x}`,L=x=>{const F=T(x);return F in E?E[F]:String(((q==null?void 0:q[x])??"")||"")},C=(x,F)=>k(z=>({...z,[T(x)]:F})),O=T("subject")in E||T("body")in E||T("message")in E,U=L(f==="email"?"body":"message"),V=L("subject"),I=f==="email"&&V?`${V}

${U}`:U;return t.jsxs(Qe,{title:e.apprT(l.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(x=>t.jsx("button",{type:"button",className:"apch"+(f===x?" on":""),"aria-pressed":f===x,onClick:()=>{c(x),u(0)},children:x==="email"?e.apprChEmail:e.apprChLi},x)),t.jsx("span",{className:"sp"}),N.map((x,F)=>t.jsxs("button",{type:"button",className:"apday"+(g===F?" on":""),"aria-pressed":g===F,onClick:()=>u(F),children:[x.day||`J${F}`,[`${f}|${F}|subject`,`${f}|${F}|body`,`${f}|${F}|message`].some(z=>z in E)&&t.jsx("i",{children:"✎"})]},x.day||F))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,j!=null&&j.sender?" · "+e.apprSender(j.sender):""]}),v&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!m&&!v&&t.jsxs("p",{className:"mnote warn",children:[m," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{h(x=>{const F={...x};return delete F[f],F}),w("")},children:e.retry})]}),!v&&!m&&!q&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),q&&t.jsxs(t.Fragment,{children:[f==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:V,onChange:x=>C("subject",x.target.value)})]}),f==="linkedin"&&g===0&&(j==null?void 0:j.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:U,onChange:x=>C(f==="email"?"body":"message",x.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var x;(x=navigator.clipboard)==null||x.writeText(I).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),f==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(l.contactEmail||"")}?subject=${encodeURIComponent(V)}&body=${encodeURIComponent(U)}`,children:e.apprMailto}),O&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Lc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:s,flash:l,flashErr:f,canWrite:c}=Z(),[g,u]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,h=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),v=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,y=()=>{if(g||!c||h)return;u(!0),(b?fr(s,!1):fr(s,!0,r,n.trim()||void 0)).then(w=>{if(u(!1),!w){f(d.actErr);return}o(w),l(w.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:g||!c||!!h,title:h||void 0,onClick:y,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),h===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:h}),v&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function Fc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:s,canWrite:l}=Z(),[f,c]=p.useState("valides"),[g,u]=p.useState(!1),[b,h]=p.useState(null),[v,y]=p.useState(null),[m,w]=p.useState(!1),[E,k]=p.useState(!1),[j,N]=p.useState(null),[q,T]=p.useState(null),L=`atl2:bulk:${d}:${f}:${e}`;p.useEffect(()=>{h(null),y(null),w(!1),N(null);try{const S=localStorage.getItem(L)||localStorage.getItem(`atl2:bulk:${d}:${f}`),P=JSON.parse(S||"null");T(P&&Date.now()-Date.parse(P.t)<24*3600*1e3?P:null)}catch{T(null)}},[L,f,d]);const C=e==="instantly"&&!r.trim(),O=`${f}|${e}|${r.trim()}`,U=async()=>{if(C||!l)return;u(!0),w(!1),N(null);const S=await Is(d,f,e,r.trim()||void 0);h(S),y(S.ok?O:null),u(!1)},V=p.useRef(!1);if(!l)return null;const I=async()=>{if(V.current||!l)return;V.current=!0,k(!0);const S=`${d}:${f}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let P;try{P=await Ps(d,f,e,r.trim()||void 0,S)}finally{V.current=!1}if(k(!1),w(!1),N(P),P.ok&&(P.pushed||0)>0){const D={t:new Date().toISOString(),n:P.pushed||0};T(D);try{localStorage.setItem(L,JSON.stringify(D))}catch{}}};m&&v!==null&&v!==O&&w(!1);const x=o,F=b!=null&&b.ok&&b.ready||0,z=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":x||"",$=!!(b!=null&&b.ok)&&v===O&&F>0&&!!z&&!q,G=q?new Date(q.t).toLocaleString(s==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:f,onChange:S=>c(S.target.value),children:i.plugBulkTabs.map(([S,P])=>t.jsx("option",{value:S,children:P},S))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:S=>a(S.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:S=>n(S.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:g||C,onClick:()=>{U()},children:g?"…":i.plugBulkPreview})]}),C&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),q&&t.jsx("p",{className:"mnote",children:i.bulkLocked(G,q.n)}),!q&&!!(b!=null&&b.ok)&&!z&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!q&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),$&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>w(!0),children:i.bulkArm}),$&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(F,z)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:E,onClick:()=>{I()},children:E?i.bulkSending:i.bulkConfirm(z)}),t.jsx("button",{type:"button",className:"abtn",disabled:E,onClick:()=>w(!1),children:i.bulkCancel})]}),j&&(j.ok?j.replayed?t.jsx("p",{className:"mnote",children:j.pending?i.bulkPending:i.bulkReplayed}):(j.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(j.pushed||0,j.linkedinReady||0,j.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:j.error||i.actErr}))]})}function Rc(){const{t:e,data:a,lang:r}=Z(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const s=window.location.href.split("?")[0];try{const f=await(await fetch(`${ha}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(Qe,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("b",{className:"pk-n",children:d.credits}),t.jsx("span",{className:"pk-u",children:e.creditsUnit}),t.jsxs("span",{className:"pk-p",children:[d.price_eur," €"]}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Oc(){const{t:e}=Z();return t.jsx(Qe,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(hc,{})})}function Mc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:s}=Z(),[l,f]=p.useState(null),[c,g]=p.useState(!1);p.useEffect(()=>{let L=!0;if(i)return Pn(i).then(C=>{L&&C&&typeof C.per_day=="number"&&f(C.per_day)}),()=>{L=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let L=!0;return Ls(o).then(C=>{L&&b(C)}),()=>{L=!1}},[o]);const h=r.stats,v=typeof(h==null?void 0:h.screened)=="number"?h.screened:n.filter(L=>L.kind==="target"&&Ue(L)).length,y=r.marketEstimate||0,m=y>0?Math.min(100,Math.round(v/y*100)):null,w=(h==null?void 0:h.window_days)||30,E=v>0?v/w:0,k=y>0?Math.max(0,y-v):0,N=y>0&&E>0&&v>=100?Math.round(k/E):null,q=L=>Math.round(L).toLocaleString(a==="en"?"en-US":"fr-FR"),T=L=>{c||!d||(g(!0),Ro(o,L).then(C=>{if(g(!1),C===null){s(e.actErr);return}f(C),s(e.alertSaved)}))};return t.jsxs(Qe,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(q(v))}),y>0&&t.jsx("span",{children:e.covOf(q(y))})]}),m!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:m+"%"}}),t.jsxs("em",{children:[m," %"]})]}),N!==null&&t.jsx("p",{className:"mnote",children:e.covEta(N)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(q(E))}),h&&t.jsxs("div",{className:"covf",children:[typeof h.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(h.kept)})," ",e.covKept]}),typeof h.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(h.analyzed)})," ",e.covAna]}),typeof h.shown=="number"&&h.shown!==h.kept&&t.jsxs("span",{children:[t.jsx("b",{children:q(h.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((L,C)=>t.jsxs("tr",{className:L.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[L.code,L.geo?` · ${L.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof L.n=="number"?q(L.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:L.source}),L.elargi&&t.jsx("em",{children:e.covWide(String(L.demande||""))}),L.erreur&&t.jsx("em",{children:e.covMissing})]})]},C)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:q(u.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&l!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(l)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(L=>t.jsx("button",{type:"button",className:l===L?"on":"",disabled:c,onClick:()=>T(L),children:L===0?"⏸":L},L))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function Ni(e,a,r){const n=await fetch(`${kt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${kt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Dc(){const{t:e,token:a,canWrite:r}=Z(),[n,o]=p.useState(null),[i,d]=p.useState(""),[s,l]=p.useState(""),[f,c]=p.useState(!1),g=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=p.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const h=JSON.parse(localStorage.getItem(g)||"null");return!!h&&Date.now()-(h.t||0)<14*24*3600*1e3}catch{return!1}},[g,n==null?void 0:n.pattern]);if(p.useEffect(()=>{if(!r)return;let h=!0;return Ms(a).then(v=>{h&&o(v)}),()=>{h=!1}},[a,r]),!r||f||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),Ni(a,n.instruction||"","atelier2-avis").then(h=>{if(d(h.applied?"ok":"ko"),h.applied||l(h.encours?e.propSlow:h.reply),h.applied)try{localStorage.setItem(g,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:s||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{c(!0);try{localStorage.setItem(g,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Ic(){var j;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=Z(),[i,d]=p.useState(!1),[s,l]=p.useState(null),[f,c]=p.useState(!1),[g,u]=p.useState([]),[b,h]=p.useState(null),[v,y]=p.useState([]);if(!r)return null;const m=()=>{d(!0),c(!1),u([]),y([]),Ds(a).then(N=>{if(d(!1),!N){c(!0),l(null);return}l(N)})},w=N=>{b||(h(N.title),Ni(a,N.instruction,"atelier2-prop").then(q=>{h(null),q.applied?(y(T=>[...T,N.title]),n(e.propApplied)):q.encours?n(e.propSlow):o(q.reply||e.propApplyFail)}))},E=((s==null?void 0:s.proposals)||[]).filter(N=>!g.includes(N.title)&&!v.includes(N.title)),k=((j=s==null?void 0:s.counts)==null?void 0:j.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:m,children:i?e.propWait:e.propBtn}),!i&&f&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!f&&s&&!(s.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:s.reason==="not_enough_signals"?e.propFew(k):e.propNone}),E.map(N=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[N.section]||N.section}),t.jsx("p",{className:"propt",children:N.title}),N.why&&t.jsx("p",{className:"mnote dim",children:N.why}),N.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",N.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>w(N),children:b===N.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(q=>[...q,N.title]),children:e.propSkip})]})]},N.title))]})}function Pc(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=Z(),[s,l]=p.useState(null),[f,c]=p.useState(!1),[g,u]=p.useState(!1),[b,h]=p.useState(""),[v,y]=p.useState(""),[m,w]=p.useState(!1),E=p.useRef(!1);if(p.useEffect(()=>{if(!a||!r)return;let N=!0;return Os(a).then(q=>{N&&(c(!0),!(!q||E.current)&&(l(q),h(q.fit),y(q.note)))}),()=>{N=!1}},[a,r]),!r)return null;const k=()=>{if(!(!b||m)){if(s&&s.fit===b&&s.note===v.trim()){u(!1);return}w(!0),wt(a,"thesis_fit",b,v.trim(),"",d.email||"").then(N=>{if(w(!1),!N.ok){o(e.fitKo);return}l({fit:b,note:v.trim(),ts:new Date().toISOString()}),u(!1),n(e.fitSaved)})}},j=N=>N==="yes"?e.fitYes:N==="partial"?e.fitPartial:e.fitNo;if(s&&!g){const N=new Date(String(s.ts||"")),q=Number.isNaN(N.getTime())?"":N.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:j(s.fit)}),s.note?` — ${s.note}`:""]}),!!q&&t.jsx("p",{className:"mnote dim",children:q}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(N=>t.jsx("button",{type:"button","aria-pressed":b===N,className:"fitopt"+(b===N?" on":""),onClick:()=>{E.current=!0,h(N)},children:j(N)},N))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:v,onChange:N=>{E.current=!0,y(N.target.value)},onKeyDown:N=>{N.key==="Enter"&&k()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||m,onClick:k,children:m?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!f&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function _c(){var m,w,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:s}=Z(),l=n==="client",f=p.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[c,g]=p.useState(""),[u,b]=p.useState(""),[h,v]=p.useState(!1),y=async()=>{const k=c.trim();if(!(!k||h||!l)){v(!0),b("");try{const N=await(await fetch(`${kt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(N.reply&&b(String(N.reply)),N.job_id){b(e.critChatRunning);const q=async()=>{const T=await fetch(`${kt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:N.job_id})}).then(L=>L.json()).catch(()=>null);if(T&&T.done){b(String(T.reply||T.clarification||T.summary||"✓")),v(!1),T.applied&&o(e.alertSaved);return}setTimeout(()=>{q()},8e3)};setTimeout(()=>{q()},8e3),g("");return}g("")}finally{u.startsWith("⏳")||v(!1)}}};return t.jsxs(Qe,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((m=i.points)!=null&&m.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((w=i==null?void 0:i.angles)!=null&&w.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,N;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(q=>t.jsx("li",{children:q},q))})]}),!!((N=k.out)!=null&&N.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(q=>t.jsx("li",{children:q},q))})]})]})]},k.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsx(Pc,{}),t.jsx(Dc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!l||h,onChange:k=>g(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(h?" loading":""),style:{padding:"12px 18px"},disabled:!l||h||!c.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(Ic,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Ts,{fund:d,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(yi[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Bc(){const{t:e,dispatch:a,startTour:r}=Z(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Qe,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const Si="atl2:mapfold",$c=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Si);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Uc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},zi=p.createContext(null),Z=()=>{const e=p.useContext(zi);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function zt({o:e,lg:a}){const{lang:r}=Z(),n=_e(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:xr(n,r),children:[n.emoji," ",xr(n,r)]}):null}function Ka({o:e,src:a}){const{lang:r,t:n}=Z(),o=_e(e);if(!o)return null;const i=Ks(o),d=Js(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(Ao(o,r))+" · "+n.win7(qo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,l)=>t.jsx("i",{className:l<i?"on":""},l))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Hc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=$e(a);if(o)return e.find(i=>$e(i.name)===o)||e.find(i=>{const d=$e(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Vc(){const{scoped:e,t:a,st:r,dispatch:n}=Z(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(g=>!Be(g)),s=d.length,l=d.filter(g=>!g.noCo).length,f=d.filter(g=>!!g.noCo).length,c=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:c?"7":"all"}});else{const g=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:g,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:s}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",l," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",f," ",a.zoomPulseExplore]})]})]})}function Wc(){var v;const{t:e,lang:a,data:r,dispatch:n,dossiers:o,st:i,caps:d}=Z(),s=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),l={...i,filters:{...i.filters,win:"all",day:""}},f=o.filter(y=>!Be(y)&&Rt(y,l,d.pipe)),c=f.length,g=f.filter(y=>Te(y)===1).length,u=f.filter(y=>Te(y)===2).length,b=typeof((v=r.stats)==null?void 0:v.screened)=="number"?r.stats.screened:0;if(c<=0&&b<=0)return null;const h=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:s(c)}),t.jsx("span",{children:h>0?e.covOf(s(h)):e.covScreened("").trim()}),t.jsxs("ul",{children:[t.jsxs("li",{children:["✅ ",s(g)," ",e.covKept]}),t.jsxs("li",{children:["⚡ ",s(u)," ",e.covAna]})]})]})}function Gc(){var y;const{t:e,token:a,fund:r,dispatch:n,data:o}=Z(),[i,d]=p.useState(null),[s,l]=p.useState(!0),[f,c]=p.useState([]),g=o.credits,u=!!g&&!g.unlimited;p.useEffect(()=>{if(!a||!r)return;let m=!0;return l(!0),(async()=>{const[w,E]=await Promise.all([Pn(r),Fo(a)]);m&&(w&&d(w),l(!1),c(E))})(),()=>{m=!1}},[a,r]);const b=(i==null?void 0:i.per_day)??null,h=((y=i==null?void 0:i.pool_order)==null?void 0:y.length)??0,v=f.filter(m=>m.status==="running").length;return t.jsxs("div",{className:"map-pulse map-engine",children:[t.jsxs("button",{type:"button",className:"map-engine-hit",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("em",{children:e.identEngine}),t.jsx("b",{children:b===null?"—":b}),t.jsx("span",{children:e.identPerDay}),t.jsxs("ul",{children:[b===0&&t.jsx("li",{children:t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause})}),v>0&&t.jsxs("li",{children:["⏳ ",v]}),t.jsx("li",{children:s?e.identPendingWait:e.identPending(h)})]})]}),t.jsxs("button",{type:"button",className:"map-engine-alert",title:e.memoAlertSub,onClick:()=>n({type:"modal",modal:"memoalert"}),children:["🔔 ",e.memoAlertBtn]}),u&&g&&t.jsxs("div",{className:"map-engine-credits",children:[t.jsx("em",{children:e.creditsCap}),t.jsxs("b",{children:[g.total_available,t.jsxs("span",{children:[" / ",g.daily_grant+g.purchased]})]}),t.jsx("span",{children:e.creditsToday})]})]})}function Ci({o:e}){const{lang:a}=Z(),r=Qs(e.cc),n=e.cc?Kt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:16,height:16,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Yc=!1;function Qc(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Ai=e=>`atl2:tour:${e||"anon"}`;function Kc(e){try{return localStorage.getItem(Ai(e))==="1"}catch{return!0}}function bo(e){try{localStorage.setItem(Ai(e),"1")}catch{}}function Jc(e,a,r,n,o,i,d,s){const l=e.tourT,f=e.howto;return[{sel:".atl2 .ident",title:l.ident,body:e.fhintIdent},o?{sel:".atl2 .map-pulse",title:l.cover,body:e.fhintCover,need:".atl2 .map-hud"}:null,{sel:".atl2 .map-engine",title:l.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:l.live,body:e.fhintLive},{sel:".atl2 .goal",title:l.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:l.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:l.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:l.tuto,body:f[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:l.demand,body:f[1][0]},{sel:".atl2 .dmulti.ddeals",title:l.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:l.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:l.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:l.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:l.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:l.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:l.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:l.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:l.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:l.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-bulk"]',need:".atl2 .ic[data-tour=plug]",title:l.campout,body:e.fhintCampout,modal:"plug"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-crm"]',need:".atl2 .ic[data-tour=plug]",title:l.addcrm,body:e.fhintAddcrm,modal:"plug"}:null,...[2,4,5].filter(c=>(s[c]||0)>0).map(c=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:c===2?l.tabAna:c===4?l.tabValid:l.tabRej,body:c===2?e.fhintTabAna:c===4?e.fhintTabValid:e.fhintTabRej,ptab:c})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:l.rank,body:e.fhintRank},{sel:".atl2 .learn",title:l.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:l.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:l.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:l.tools,body:f[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:l.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:l.crit,body:f[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:l.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:l.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:l.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function au({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Jn;const{lang:d}=Hs(),s=_l(e,d,a),l=p.useMemo(()=>({...zl[d],...Sl(d,s.thesisMode)}),[d,s.thesisMode]),[f,c]=p.useReducer(Ul,void 0,()=>Bl((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Uc():$c()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),g=p.useRef(!0);p.useEffect(()=>{if(g.current){g.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Si,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const A=()=>{window.innerWidth<=760&&c({type:"mapFold",folded:!0})};return A(),window.addEventListener("resize",A),()=>window.removeEventListener("resize",A)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var A;(A=u.current)==null||A.call(u,f.filters)},[f.filters]);const[b,h]=p.useState(()=>{if(typeof window>"u")return"both";try{const A=localStorage.getItem("atl2:chrome-mode");if(A==="eval"||A==="filt"||A==="both")return A;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=p.useState(null),[m,w]=p.useState(null),[E,k]=p.useState(null),[j,N]=p.useState({kept:0,dropped:0}),[q,T]=p.useState(!1),[L,C]=p.useState(""),[O,U]=p.useState(!1),[V,I]=p.useState(null),[x,F]=p.useState(null),[z,$]=p.useState(!1),[G,S]=p.useState(!1),[,P]=p.useState(0),D=()=>P(A=>A+1),Q=p.useRef([]),H=p.useRef(new Set),ce=p.useRef(new Set),[te,le]=p.useState([]),[xe,he]=p.useState([]),[we,pe]=p.useState(0),Ne=p.useRef(new Map),Ce=p.useRef(null),{mode:ue}=s,be=p.useMemo(()=>({...s.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[s.caps,o,a]),ye=be.pipe,ee=s.session.token||"",_=ue==="client"&&!e;p.useEffect(()=>{if(!ee||!ye)return;let A=!0;const X=async()=>{const fe=await Xs(ee);!A||!fe||(he(fe.runs),pe(Date.now()/1e3-fe.now),le(Re=>Re.filter(qe=>!fe.runs.some(Ve=>$e(Ve.company)===$e(qe.name)))))};X();const K=te.length>0||xe.some(fe=>fe.status==="running"),ne=window.setInterval(()=>{X()},K?8e3:25e3);return()=>{A=!1,window.clearInterval(ne)}},[ee,ye,te.length,xe.some(A=>A.status==="running")]),p.useEffect(()=>{if(!ee||!ye||!_)return;let A=!0;const X=async()=>{const ne=await Zs(ee);if(!A||!ne.length)return;const fe=new Map;ne.forEach(Re=>{const qe=String(Re.ceo_status||"").trim();qe&&Re.check_id&&fe.set(String(Re.check_id),qe)}),s.patchStatuses(fe,Re=>Date.now()-(re.current.get(Re)||0)>9e4)};X();const K=window.setInterval(()=>{X()},6e4);return()=>{A=!1,window.clearInterval(K)}},[ee,ye,_]);const J=p.useMemo(()=>{const A=[],X=new Set;for(const K of te){const ne=$e(K.name);!ne||X.has(ne)||(X.add(ne),A.push({name:K.name,id:K.id,status:"boot",started:K.started,estMin:K.estMin,memoType:"instant"}))}for(const K of xe){const ne=$e(K.company);if(!ne||X.has(ne))continue;X.add(ne);const fe=K.status==="error"?"error":K.status==="done"?"done":"running";A.push({name:K.company,status:fe,started:K.started||0,estMin:K.est_min||(K.memo_type==="detailed"?40:15),url:K.url,error:K.error,memoType:K.memo_type,note:K.note})}return A},[te,xe]),ie=A=>J.find(X=>$e(X.name)===$e(A))||null,oe=(A,X)=>{le(K=>K.some(ne=>$e(ne.name)===$e(A.name))?K:[...K,{name:A.name,id:A.id,started:Date.now()/1e3,estMin:X==="detailed"?40:15}]),H.current.add(A.id),D()},me=(A,X=!1)=>{C(A),U(X),Ce.current&&clearTimeout(Ce.current),Ce.current=setTimeout(()=>C(""),X?4200:2400)},W=A=>me(A,!0),se=p.useMemo(()=>{const A=new Map;return s.dossiers.forEach(X=>{X.id&&A.set(X.id,X)}),A},[s.dossiers]),ve=p.useMemo(()=>s.dossiers.filter(A=>Rt(A,f,ye)),[s.dossiers,f,ye]),ke=p.useRef(!1);p.useEffect(()=>{if(ke.current||s.loading||!s.dossiers.length)return;if(e&&!s.session.token){ke.current=!0;return}if(!be.showFunnel||Kc(s.session.token||"")){ke.current=!0;return}ke.current=!0;const A=window.setTimeout(()=>{bo(s.session.token||""),$(!0)},700);return()=>window.clearTimeout(A)},[e,s.loading,s.dossiers.length,be.showFunnel,s.session.token]);const Ee=p.useMemo(()=>s.dossiers.filter(A=>Hl(A,f,ye,s.favIds)),[s.dossiers,f,ye,s.favIds]),ge=p.useMemo(()=>Vs(ve.filter(A=>!Ke(A)),s.favIds),[ve,s.favIds]),Pe=p.useRef(!1);p.useEffect(()=>{if(Pe.current)return;if(!ye||a==="ops"){Pe.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Pe.current=!0;return}if(s.loading)return;Pe.current=!0;const A=Ws(ge);A!==f.ptab&&c({type:"ptab",tab:A})},[ye,a,n==null?void 0:n.ptab,s.loading,ge,f.ptab]);const Je=p.useMemo(()=>{const A=Go(s.dossiers);return A?ut(A)===0?l.tourToday:Yo(A,d):l.tourNoRun},[s.dossiers,l,d]),at=p.useMemo(()=>s.dossiers.some(A=>!!A.memoUrl||!!A.summary||Vt(A)),[s.dossiers]),[ze,dt]=p.useState(!1);p.useEffect(()=>{if(s.loading){dt(!1);return}if(s.dossiers.length>0||s.error){dt(!0);return}const A=window.setTimeout(()=>dt(!0),6e3);return()=>window.clearTimeout(A)},[s.loading,s.dossiers.length,s.error]);const nt=(s.marketEstimate||0)>0||typeof((Jn=s.stats)==null?void 0:Jn.screened)=="number"&&s.stats.screened>0,Xe=p.useMemo(()=>[1,0,2,4,5,3].find(A=>(ge[A]||0)>0)??0,[ge]),rt=Dn.find(A=>A.key===f.continent),At=f.continent==="monde"?l.contWorld:(d==="fr"?rt==null?void 0:rt.fr:rt==null?void 0:rt.en)||"";p.useEffect(()=>{const A=X=>{var ne;const K=(((ne=X.detail)==null?void 0:ne.name)||"").trim();K&&bt(null,K)};return window.addEventListener("ppmap:evaluate",A),()=>window.removeEventListener("ppmap:evaluate",A)}),p.useEffect(()=>{const A=X=>{const K=X.detail||{},ne=String(K.id||"").trim(),fe=String(K.name||"").trim(),Re=String(K.url||"").trim(),qe=ne&&se.get(ne)||Hc(s.dossiers,fe,Re);if(qe){if(w(null),Rt(qe,f,ye)||(f.continent!=="monde"&&qe.continent!==f.continent&&c({type:"continent",key:qe.continent||"monde"}),c({type:"reset"})),ye&&qe.kind!=="op"){const ht=Te(qe);typeof ht=="number"&&ht!==f.ptab&&c({type:"ptab",tab:ht})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),c({type:"focus",id:qe.id}),(qe.noCo||["media","nominations","recrutements"].includes(qe.engine||""))&&(qe.url||qe.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:qe.url||"",text:[qe.headline,qe.tagline].filter(Boolean).join(`
`)}})):qe.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:qe.name,url:qe.url||"",website:qe.website||"",domain:qe.domain||""}}));return}!fe&&!Re||(c({type:"focus",id:ne||null}),w({name:fe,headline:String(K.text||"").trim()||fe,url:Re,card:K.card}),Re&&(Ia(fe)||!fe)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Re,text:String(K.text||"").trim()}})):fe&&!Ia(fe)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:fe}})))};return window.addEventListener("ppmap:focus",A),()=>window.removeEventListener("ppmap:focus",A)}),p.useEffect(()=>{const A=ne=>{const fe={},Re=String((ne==null?void 0:ne.sector)||"").trim();Re&&(fe.sector=[Re]);const qe=String((ne==null?void 0:ne.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(qe)&&(fe.day=qe);const Ve=String((ne==null?void 0:ne.search)||"").trim();Ve&&(fe.search=Ve);const ht=String((ne==null?void 0:ne.dealKind)||"").trim();(ht==="ma"||ht==="levee"||ht==="other")&&(fe.dealKind=[ht]),Object.keys(fe).length&&c({type:"filters",patch:fe})},X=ne=>A(ne.detail),K=ne=>{ne.data&&ne.data.type==="pp-filter"&&A(ne.data)};return window.addEventListener("ppmap:filter",X),window.addEventListener("message",K),()=>{window.removeEventListener("ppmap:filter",X),window.removeEventListener("message",K)}},[]),p.useEffect(()=>{const A=X=>{var fe;const K=(((fe=X.detail)==null?void 0:fe.name)||"").trim().toLowerCase();if(!K)return;const ne=s.dossiers.find(Re=>(Re.name||"").trim().toLowerCase()===K);ne&&c(a==="ops"?{type:"focus",id:ne.id}:{type:"popup",id:ne.id})};return window.addEventListener("ppmap:similar",A),()=>window.removeEventListener("ppmap:similar",A)});const bt=(A,X,K)=>{const ne=(K||(A==null?void 0:A.name)||X||"").trim();if(!_){k({kicker:ne});return}!ne||q||(T(!0),(async()=>{try{let fe=(X||ne).trim();const Re=((A==null?void 0:A.website)||(A==null?void 0:A.domain)||"").trim();if(!(/^https?:\/\//i.test(fe)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(fe)&&!/\s/.test(fe)))if(Re)fe=Re;else try{const Ie=await In(ne);if(Ie!=null&&Ie.website)fe=Ie.website;else if(((Ie==null?void 0:Ie.candidates)||[]).length===1)fe=Ie.candidates[0].url;else if(((Ie==null?void 0:Ie.candidates)||[]).length>1){Q.current=[{name:ne,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(Ie.candidates||[]).slice(0,5)},...Q.current].slice(0,8),D();return}}catch{}const Ve=await No(ee,fe,"atelier2"),ht={name:Ve.company||ne,verdict:Ve.verdict,reason:Ve.reason||"",remaining:Ve.remaining??null};Q.current=[ht,...Q.current].slice(0,8),Ve.verdict==="kept"&&N(Ie=>({...Ie,kept:Ie.kept+1})),Ve.verdict==="ruled_out"&&N(Ie=>({...Ie,dropped:Ie.dropped+1}));const Xt=A||s.dossiers.find(Ie=>(Ie.name||"").toLowerCase()===ne.toLowerCase());Xt&&(Ve.verdict==="kept"?Xt.verdict=Xt.verdict||"MATCH":Ve.verdict==="ruled_out"&&(Xt.verdict="NO MATCH"),Ve.reason&&(Xt.reasoning=Ve.reason)),D()}finally{T(!1)}})())},Bt=A=>{if(!_){k({kicker:A.name});return}oe(A,"instant"),wt(ee,"fast_request",A.name||"",""),me(l.memoInstantSent(A.name))},$t=A=>Ne.current.get(A.id)??s.thumbs.get((A.name||"").trim().toLowerCase()),De=(A,X)=>c({type:"undoPush",entry:{id:A.id,name:A.name,prevCeoStatus:X}}),Ze=async(A,X,K)=>{const ne=A.ceoStatus||"";re.current.set(A.id,Date.now()),A.ceoStatus=X,D();const fe=await en(ee,{status:X,airtable_id:A.airtableId,check_id:A.checkId,company:A.name,...(K==null?void 0:K.note)!==void 0?{note:K.note}:{},...K!=null&&K.via?{via:K.via}:{}});return fe.ok?fe.skipped?(A.ceoStatus=ne,D(),W(l.actNotPersisted),!1):((K==null?void 0:K.undo)!==!1&&De(A,ne),K!=null&&K.msg&&me(K.msg),(X==="Validé"||X==="Écarté")&&!A.ceoNote&&(K==null?void 0:K.note)===void 0&&I({o:A,yes:X==="Validé"}),!0):(A.ceoStatus=ne,D(),W(l.actErr),!1)},Ge=async(A,X)=>{const K=await en(ee,{status:A.ceoStatus||"Retenu",airtable_id:A.airtableId,check_id:A.checkId,company:A.name,note:X,via:"note"});return!K.ok||K.skipped?(W(K.skipped?l.actNotPersisted:l.actErr),!1):(A.ceoNote=X,D(),!0)},mt=p.useRef(new Map),Et=A=>mt.current.has(A.id)?mt.current.get(A.id):s.stages.get((A.name||"").trim().toLowerCase()),qt=(A,X)=>{mt.current.set(A.id,X),D()},M=(A,X)=>{_&&Ze(A,X?"Validé":"Écarté",{msg:X?l.decidedYes(A.name):l.decidedNo(A.name)})},R=A=>{_&&Ze(A,"À trancher",{msg:l.promoted(A.name)})},B=A=>{_&&(async()=>{const X=A.ceoStatus||"";A.ceoStatus="Retenu",D();const K=await en(ee,{status:"Retenu",check_id:A.checkId,company:A.name});if(!K.ok||K.skipped){A.ceoStatus=X,D(),W(K.skipped?l.actNotPersisted:l.actErr);return}De(A,X),me(l.repeched(A.name))})()},Y=()=>{const A=f.undo[f.undo.length-1];if(!A){me(l.undoNone);return}const X=se.get(A.id);if(!X){c({type:"undoPop"}),me(l.undoNone);return}let K=A.prevCeoStatus;if(!K)if((X.verdict||"").toUpperCase().includes("CALL"))K="À trancher";else{me(l.undoLockedTitle);return}(async()=>await Ze(X,K,{undo:!1})&&(c({type:"undoPop"}),X.ceoStatus=A.prevCeoStatus,D(),me(l.undoDone(X.name))))()},ae=A=>{_&&(ce.current.add(A.id),D(),c({type:"approachOpen",id:A.id}),wt(ee,"approach",A.name||"","","",s.email||""))},re=p.useRef(new Map),je=p.useRef(!1),[Ae,de]=p.useState(0);p.useEffect(()=>{if(!ee||e||!_||je.current)return;je.current=!0;const A=new Date().toISOString().slice(0,10),X=s.email||"",K=`cbv_${ee}_${X}_${A}`,ne=`atl2:vue:${ee}:${A}`;try{if(localStorage.getItem(K)||localStorage.getItem(ne))return}catch{}wt(ee,"view","","","",X).then(fe=>{if(!fe.ok){je.current=!1;return}try{localStorage.setItem(K,"1")}catch{}})},[ee,e,_,s.email]),p.useEffect(()=>{if(!ee||!ye||e||!_||!s.generatedAt)return;let A=!0;const X=()=>{document.hidden||el(ee,s.generatedAt||"").then(ne=>{A&&de(ne)})};X();const K=window.setInterval(X,6e4);return()=>{A=!1,window.clearInterval(K)}},[ee,ye,e,s.generatedAt]);const He=(A,X)=>{_&&(async()=>{if(!(await wt(ee,X?"yes":"no",A.name||"",(A.ceoNote||"").slice(0,400),A.sector||"",s.email||"")).ok){W(l.actErr);return}Ne.current.set(A.id,X?"yes":"no"),D(),me(X?l.thumbUpDone:l.thumbDnDone),F({o:A,up:X})})()},jt=A=>{!_||!Vt(A)||(oe(A,"detailed"),wt(ee,"detailed_request",A.name||"","","",s.email||""),me(l.memoDeepSent(A.name)))},Tt=A=>{!_||!A.memoUrl||window.confirm(l.memoRegenAsk(A.name))&&(oe(A,"detailed"),wt(ee,"detailed_regen",A.name||"","","",s.email||""),me(l.memoDeepSent(A.name)))},xa=A=>{const X=new Set(s.favIds),K=X.has(A.id);K?X.delete(A.id):X.add(A.id),s.setFavIds(X),_&&tl(ee,{id:A.id,co:A.name},K)},ft=()=>{!_||G||window.confirm(l.identSyncConfirm)&&(S(!0),(async()=>{const A=await al(ee);S(!1),A?me(l.identSyncDone):W(l.actErr)})())},Kn=/proplace/i.test(s.fund||""),qi=A=>{!_||!Kn||(wt(ee,"onboard_request",A.name||"",""),me(l.onboardSent(A.name)))},Ti={st:f,dispatch:c,t:l,lang:d,mode:ue,caps:be,pipe:ye,token:ee,fund:s.fund,email:s.email,criteria:s.criteria,source:a||"default",data:s,doRepeche:B,thumbOf:$t,canWrite:_,commitStatus:Ze,saveNote:Ge,stageOf:Et,setStage:qt,flashErr:W,startTour:()=>$(!0),dossiers:s.dossiers,scopedAll:ve,scoped:Ee,counts:ge,byId:se,contName:At,favIds:s.favIds,toggleFav:xa,askEvaluate:bt,doAnalyse:Bt,doDecide:M,doPromote:R,doApproach:ae,doThumb:He,doDeep:jt,doRegen:Tt,doUndo:Y,doSync:ft,doOnboard:qi,outbound:Kn,memoQueued:H.current,liveMemos:{items:J,serverOff:we,liveOf:ie},approachDone:ce.current,sessTally:j,evalCards:Q.current,evalBusy:q,markRow:y,markedId:v,flash:me,focusExtra:m};p.useEffect(()=>{const A=X=>{X.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[]);const Li=A=>ee?t.jsx(Gl,{token:ee,children:A}):t.jsx(t.Fragment,{children:A});return t.jsx(zi.Provider,{value:Ti,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ee?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Ll}),Li(t.jsxs("div",{className:"app"+(ye?" pipe":"")+(ee?" has-thesis":""),children:[be.showTicker&&t.jsx(pt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ee?" live-stack--cibles":""),children:[t.jsx(ed,{}),!!ee&&t.jsx(Yl,{})]})}),be.showIdent&&t.jsx(pt,{name:"identite",children:t.jsx(pd,{})}),!1,Yc,be.showFunnel&&t.jsx(pt,{name:"entonnoir",children:t.jsx(Xc,{})}),t.jsx(pt,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(fi,{variant:"tabs"}),!f.mapFolded&&t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Vc,{}),a!=="ops"&&(be.showFunnel||be.showIdent)&&t.jsxs("div",{className:"map-hud",children:[be.showFunnel&&t.jsx(Wc,{}),be.showIdent&&t.jsx(Gc,{})]}),t.jsx(lp,{}),t.jsx(mi,{})]})]})}),be.showDemand&&ye&&t.jsx(pt,{name:"direct",children:t.jsx(sl,{items:J,serverOff:we,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([A,X])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===A,onClick:()=>{h(A);try{localStorage.setItem("atl2:chrome-mode",A)}catch{}},children:X},A))}),be.showDemand&&t.jsx(pt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(vp,{})})}),be.showDemand&&f.memoConsole&&t.jsx(pt,{name:"console",children:t.jsx(yp,{})}),be.pipe&&!!ee&&t.jsx(pt,{name:"moteurs",children:t.jsx(wl,{})}),Ae>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:l.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{de(0),s.refresh()},children:l.freshGo})]}),t.jsx(pt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(dc,{})}),be.pipe&&!!ee&&t.jsx("p",{className:"privnote",children:l.privLink}),s.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),s.error&&!s.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:s.refresh,children:l.retry})]})]})),f.popupId&&f.dens!=="liste"&&a!=="ops"&&t.jsx(pt,{name:"fiche",children:t.jsx(Wp,{})}),t.jsx(pt,{name:"modales",children:t.jsx(xc,{})}),t.jsx(Gs,{}),x&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:x.o.name}),t.jsx(Tr,{placeholder:x.up?l.thumbWhyUpPh:l.thumbWhyDnPh,onDone:A=>{const X=x.o;F(null),A&&wt(ee,"note",X.name||"",A,X.sector||"",s.email||"").then(K=>{K.ok&&me(l.csNoteSaved)})}})]}),V&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:V.o.name}),t.jsx(Tr,{placeholder:V.yes?l.whyYesPh:l.whyNoPh,onDone:A=>{const X=V.o;I(null),A&&Ge(X,A).then(K=>{K&&me(l.csNoteSaved)})}})]}),z&&ze&&t.jsx(ld,{steps:Jc(l,Je,at,Xe,nt,ge[3]||0,ge[4]||0,ge),onClose:()=>{$(!1),bo(ee)}}),t.jsx(Qc,{}),be.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:Lo,children:To}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${Ma}`,children:Ma})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),L&&t.jsx("div",{className:"flash on"+(O?" err":""),children:L}),E&&t.jsx(Ys,{variant:"acquirer",initialCompany:vo().co,initialWebsite:vo().site,onClose:()=>k(null)})]})})}function Xc(){const{t:e}=Z(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function vo(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Zc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Ci as FlagCell,zt as SigBadge,Ka as SigWin,au as default,Zc as fmtShort,Z as useV2};
