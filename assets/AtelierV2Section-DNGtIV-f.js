...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,Yo=Ho+Wo;function da(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Go(){const e=da("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ko(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Go();return r==="0"?"client":r==="1"||da("embed")==="1"&&da("chrome")==="1"?"apercu":"client"}const Qo={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Jo=e=>Qo[e];function Xo(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const We=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!In(a)||Xo(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Kr(e.cc)})};function Xt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Zo=60*60*1e3;function ei(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Zo?null:a}catch{return null}}function Et(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ti=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function ai(e,a,r="default"){const n=r!=="default",i=x.useMemo(()=>e||n?{mode:"anon"}:$r(),[e,n]),o=x.useMemo(()=>n?"visiteur":Ko(e,i),[e,i,n]),l=x.useMemo(()=>Jo(o),[o]),s=o!=="visiteur",c=ti(r),[h,d]=x.useState([]),[m,u]=x.useState(""),[b,p]=x.useState(null),[g,v]=x.useState(null),[f,y]=x.useState(null),[C,w]=x.useState(()=>new Map),[E,z]=x.useState(()=>new Map),[A,T]=x.useState(""),[j,M]=x.useState(new Set),[q,B]=x.useState(null),[H,k]=x.useState(!0),[N,R]=x.useState(!1),[V,G]=x.useState(0),[X,L]=x.useState(0),O=x.useRef(0),$=x.useMemo(()=>{var D;if(o!=="client")return"";try{return((D=Br())==null?void 0:D.email)||""}catch{return""}},[o]);x.useEffect(()=>{const D=++O.current;let U=!0;const Y=()=>U&&D===O.current,J=(s&&i.token?i.token:"pub:"+a)+(c?":"+c:""),re=ei(J);return re?(d(re.objs.map(We)),re.fund&&u(re.fund),p(re.marketEstimate??null),v(re.criteria??null),y(re.stats??null),T(re.generatedAt||""),k(!1)):k(!0),(async()=>{try{if(r==="ops"){const fe=await Kt(),pe=((fe==null?void 0:fe.recent_ops)||[]).map(K=>{const te=Qt(K.company_name||K.title?K:{...K,title:(K.headline_fr||K.headline||"").slice(0,120)},a),xe=String(K.rubrique||"").toLowerCase();return te&&(xe==="nominations"||xe==="recrutements")&&(te.engine=xe),te&&!String(K.company_name||"").trim()&&(te.noCo=!0),te}).filter(K=>!!K).map(K=>(In((K.name||"").trim())||(K.noCo=!0),K));try{const K=await Ur(),te=_r(K),xe=((K==null?void 0:K.date)||"").slice(0,10);if(te.length&&xe){const Z=new Set;for(const se of pe){if(se.noCo||(se.date||"").slice(0,10)!==xe)continue;const ae=Ba(te,Z,se.name,"");ae>=0&&(Z.add(ae),se.decryptHtml=te[ae].html)}for(const se of pe){if(se.decryptHtml||(se.date||"").slice(0,10)!==xe)continue;const ae=Ba(te,Z,"",se.headline||se.tagline||se.name);ae>=0&&(Z.add(ae),se.decryptHtml=te[ae].html)}}}catch{}if(!Y())return;d(pe.map(We)),Et(J,{objs:pe})}else if(typeof r=="object"){const pe=(await Ua()||[]).filter(te=>(te.slug||"")===r.research).map(te=>_a(te,a)).filter(te=>!!te),K=Xt(await Va(pe,a));if(!Y())return;d(K.map(We)),Et(J,{objs:K})}else if(s&&i.token){const fe=Vr(i.token),pe=Kt(),K=Hr(i.token),te=Wr(i.token),xe=Yr(i.token),Z=await fe;let se=Z?Z.targets:[];Y()&&Z&&(u(Z.fund||""),p(Z.marketEstimate??null),v(Z.criteria??null),y(Z.stats??null),T(Z.generatedAt||""),d(se.map(We)),k(!1),R(!1));const[ae,Oe,he,ve]=await Promise.all([pe,K,te,xe]),Me=((ae==null?void 0:ae.recent_ops)||[]).map(Ee=>Qt(Ee,a)).filter(Ee=>!!Ee);if(se=[...se,...Me],!Y())return;d(se.map(We));const tt=new Set;for(const Ee of Oe){const Be=(Ee.id||Ee.co||"").toString().trim().toLowerCase();Be&&tt.add(Be.startsWith("t:")?Be:"t:"+Be)}M(tt),w(he),z(ve),Z&&Et(J,{fund:Z.fund,marketEstimate:Z.marketEstimate,criteria:Z.criteria,stats:Z.stats,generatedAt:Z.generatedAt,objs:se})}else{const fe=Gr(),pe=Ua(),K=Kt(),te=await fe;Y()&&te.length&&(d(Xt(te).map(We)),k(!1),R(!1));const[xe,Z]=await Promise.all([pe,K]),se=(xe||[]).map(ve=>_a(ve,a)).filter(ve=>!!ve),ae=await Va(se,a),Oe=((Z==null?void 0:Z.recent_ops)||[]).map(ve=>Qt(ve,a)).filter(ve=>!!ve),he=Xt([...te,...ae,...Oe]);if(!Y())return;d(he.map(We)),Et(J,{objs:he})}Y()&&R(!1)}catch{Y()&&!re&&R(!0)}finally{Y()&&k(!1)}})(),()=>{U=!1}},[s,i.token,a,V,c]),x.useEffect(()=>{if(!l.showCredits||!$){B(null);return}let D=!0;return(async()=>{try{const U=await fetch(`${Ca}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:$})});if(!U.ok)return;const Y=await U.json();D&&Y&&Y.ok!==!1&&B(Y)}catch{}})(),()=>{D=!1}},[l.showCredits,$,X]);const P=x.useCallback(D=>M(new Set(D)),[]);return{session:i,mode:o,caps:l,fund:m,email:$,marketEstimate:b,generatedAt:A,criteria:g,stats:f,thumbs:C,stages:E,dossiers:h,favIds:j,setFavIds:P,credits:q,reloadCredits:()=>L(D=>D+1),loading:H,error:N,refresh:()=>G(D=>D+1)}}const Hn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),ni=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Hn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function ri(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Hn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Wn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Wn=40;function Ta(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ge(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ea(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(He(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ge(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Yn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ta(e,a.filters,r)}function oi(e,a,r,n){return!(!Yn(e,a,r)||r&&!Qr(e,a.ptab,n))}function La(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-He(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=ge(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const ii=["ma","levees","nominations","recrutements","actualites"],si=300,Zt=7,li={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Gn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},di=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Za(e){const a=ge(e);if(a)return"sig:"+(a.theme&&Gn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function ci(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=F(),s=l==="en",[c,h]=x.useState("all"),[d,m]=x.useState(!1),u=x.useMemo(()=>{const j=(a.filters.day||"").slice(0,10),M=k=>!(!o&&a.continent!=="monde"&&k.continent!==a.continent||j&&(k.date||"").slice(0,10)!==j),q=e.filter(k=>M(k)&&ge(k)),B=e.filter(k=>M(k)&&k.kind==="op"&&!ge(k)&&(j?!0:He(k.date)<=Zt)),H=j||new Date().toISOString().slice(0,10);return B.sort((k,N)=>{const R=(k.date||"").slice(0,10)===H?0:1,V=(N.date||"").slice(0,10)===H?0:1;return R!==V?R-V:(N.amountEur||0)-(k.amountEur||0)}),[...La(q,{key:"signal",dir:-1}),...B]},[e,a.continent,a.filters.day,o]),b=x.useMemo(()=>{const j={};for(const M of u){const q=Za(M);j[q]=(j[q]||0)+1}return j},[u]),p=x.useMemo(()=>c==="all"?u:u.filter(j=>Za(j)===c),[u,c]),g=x.useMemo(()=>p.slice(0,si),[p]),v=p.length-g.length,f=j=>j==="all"?u.length:b[j]||0,y=j=>j==="all"?s?"All":"Tout":j.startsWith("sig:")?Gn[s?"en":"fr"][j.slice(4)]||"🔔":li[s?"en":"fr"][j],C=[{k:"all"}],w=ii.filter(j=>f(j)>0||j===c);if(w.length){C.push({g:s?"DEALS":"OPÉRATIONS"});for(const j of w)C.push({k:j})}const E=di.map(j=>"sig:"+j).filter(j=>f(j)>0||j===c);if(E.length){C.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const j of E)C.push({k:j})}const z=j=>{try{return new Date(j+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return j}},A=(()=>{const j=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?s?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return j?(s?`LIVE covers the events of ${z(j)}.`:`Le LIVE regroupe les événements du ${z(j)}.`)+M:(s?`LIVE covers the still-open signals and the deals of the last ${Zt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Zt} derniers jours.`)+M})(),T=j=>g.map(M=>t.jsxs("button",{type:"button",className:"tk"+(Ce(M)?" spent":""),onClick:q=>{const B=q.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:B.left+B.width/2,y:B.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(Xe,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(Sr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Vl(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(Yt,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},j+(M.id||M.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},j+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:j=>{j.currentTarget.contains(j.relatedTarget)||m(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":d,onClick:()=>m(j=>!j),children:[y(c),t.jsx("b",{children:f(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!d,children:[t.jsx("span",{className:"tkfilscope",children:A}),C.map(j=>"g"in j?t.jsx("span",{className:"tkfilg",children:j.g},j.g):t.jsxs("button",{type:"button","aria-pressed":j.k===c,onClick:()=>{h(j.k),m(!1)},children:[y(j.k),t.jsx("b",{children:f(j.k)})]},j.k))]})]}),t.jsx("div",{className:"win",children:g.length?t.jsxs("div",{className:"run",children:[T(0),T(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const pi="aDx8z7Hzksus",Kn="+33 6 83 10 72 86",en="alexandre@proplace.co",ui=`tel:${Kn.replace(/[^\d+]/g,"")}`,tn="pp-rdv-slot";function mi(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function fi(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:hi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:ui,children:Kn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${en}`,children:en})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Bo,{filloutId:pi,parameters:r?{company_name:r}:void 0})})]})}function xi(){const[e,a]=x.useState(()=>typeof document>"u"?null:document.getElementById(tn));return x.useEffect(()=>{e||a(document.getElementById(tn))},[e]),e?lt.createPortal(t.jsx(fi,{}),e):null}const hi=`
...
`;class be extends x.Component{constructor(){super(...arguments);Ia(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const gi=8;function bi(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=F(),[s,c]=x.useState(!1),[h,d]=x.useState(!1),[m,u]=x.useState(!1),b=r||"home",{names:p,verdicts:g}=x.useMemo(()=>{const w=[],E={};return n.forEach(z=>{z.kind!=="target"||!z.name||(w.push(z.name),E[z.name]=Jr(z)||"")}),{names:w,verdicts:E}},[n]),v=x.useMemo(()=>p.length?Xr(b,p,g,a):null,[b,p.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const f=h?v.added:v.added.slice(0,gi),y=v.added.length-f.length,C=w=>{const E=n.find(z=>z.name===w);E&&(o(E.id),l({type:"popup",id:E.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{c(!0),Zr(b,p,g,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[f.map(w=>t.jsx("button",{type:"button",onClick:()=>C(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),m&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const ea=600,Ye=62,an="atl2:fstats";function vi(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=F(),[l,s]=x.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(an)==="on"}catch{return!1}}),c=r.stats,h=x.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=x.useMemo(()=>{if(c!=null&&c.since)return c.since;const y=new Date;return y.setDate(y.getDate()-((c==null?void 0:c.window_days)||30)),y.toISOString().slice(0,10)},[c==null?void 0:c.since,c==null?void 0:c.window_days]);if(!n.showFunnel||!c||typeof c.screened!="number")return null;const m=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),b=h.reduce((y,C)=>Math.max(y,C.s||0),0),p=h.length?ea/h.length:0,g=Math.max(4,p-4),v=h.length>=5&&b>0,f=[[c.screened,e.funScreened(m(d)),c.screened_today],...typeof c.kept=="number"?[[c.kept,e.funKept,c.kept_today]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed,c.analyzed_today]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[f.map(([y,C,w],E)=>t.jsxs("span",{className:"fst-t",children:[E>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:C}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},C)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(an,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ea} ${Ye}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((y,C)=>{const w=(y.s||0)/b*(Ye-4),E=(y.m||0)/b*(Ye-4),z=C*p+(p-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:Ye-2-w,width:g,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:Ye-2-E,width:g,height:E,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Ye-1.5,x2:ea,y2:Ye-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const yi=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function wi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=F(),[o,l]=x.useState(""),[s,c]=x.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),d=(Ze(e)||"").startsWith("CALL")&&ke(e)===3,m=ke(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const g=await i(e,p);l(""),g&&(c(!0),setTimeout(()=>c(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:yi.filter(([p])=>!(m&&p==="Retenu")).map(([p,g])=>[p,a[g]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,g])=>t.jsx("button",{type:"button",className:"csb"+(h===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:g},p)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ki,{o:e})]})}function ki({o:e}){const{t:a,saveNote:r,flash:n}=F(),[i,o]=x.useState(e.ceoNote||""),[l,s]=x.useState(!1),[c,h]=x.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!d)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{m()},children:c?a.csNoteSaved:a.csNoteOk})]})}function ji({placeholder:e,onDone:a}){const{t:r}=F(),[n,i]=x.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Ni({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=F(),[c,h]=x.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const d=o(e),m=(d==null?void 0:d.stage)||"todo",u=async f=>{if(c||f===m)return;h(!0);const y=d;l(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const C=Math.max(Date.now(),nn+=1);nn=C;const w=await eo(r,{company:e.name||"",stage:f,cts:C,deal_id:e.airtableId,check_id:e.checkId});h(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},b=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=m==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(m===f?" on":""),disabled:c,onClick:()=>{u(f)},children:y},f)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let nn=0;const At=8,zt=360;function rn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function on({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(rn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(rn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function Si({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=F(),[l,s]=x.useState(0),[c,h]=x.useState(null),[d,m]=x.useState([]),u=x.useRef(!1),b=x.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=x.useRef(!1);x.useEffect(()=>{const A=b.current;return()=>{p.current||(n({type:"ptab",tab:A.ptab}),n({type:"dens",dens:A.dens}),n({type:"modal",modal:A.modal}))}},[]),x.useEffect(()=>{u.current||(u.current=!0,m(e.filter(A=>!!document.querySelector(A.need||A.sel))))},[e]);const g=d[l],v=l>=d.length;x.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const A=g.click,T=window.setTimeout(()=>{const j=document.querySelector(A);j&&j.getAttribute("aria-selected")!=="true"&&j.click()},60);return()=>window.clearTimeout(T)}},[l,g]);const f=x.useRef(-1),y=x.useCallback(()=>{if(!g){h(null);return}const A=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!A){h(null);return}f.current!==l&&(f.current=l,A.scrollIntoView({block:"nearest",behavior:"smooth"}));const T=A.getBoundingClientRect();h(j=>j&&Math.abs(j.top-T.top)<1&&Math.abs(j.left-T.left)<1&&Math.abs(j.width-T.width)<1&&Math.abs(j.height-T.height)<1?j:T)},[g,l]);x.useLayoutEffect(()=>{y();const A=[90,300,700,1300].map(j=>window.setTimeout(y,j)),T=()=>y();return window.addEventListener("scroll",T,!0),window.addEventListener("resize",T),()=>{A.forEach(j=>window.clearTimeout(j)),window.removeEventListener("scroll",T,!0),window.removeEventListener("resize",T)}},[y]);const C=x.useRef(a);if(C.current=a,x.useEffect(()=>{const A=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),C.current()):T.key==="ArrowRight"?s(j=>j+1):T.key==="ArrowLeft"&&s(j=>Math.max(0,j-1))};return document.addEventListener("keydown",A,!0),()=>document.removeEventListener("keydown",A,!0)},[]),!d.length)return null;let w=null;const E=A=>()=>{p.current=!0,n({type:"modal",modal:null}),A()};if(v){const A=i[3]||0;A>0?w={title:A===1?r.ahaATitle1:r.ahaATitleN(A),body:r.ahaABody,btn:r.ahaABtn,go:E(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?w={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:E(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?w={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:E(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:E(()=>{n({type:"modal",modal:"crit"}),a()})}}let z={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:zt};if(!v&&c){const A=c.bottom+14,j=window.innerHeight-A>190?A:Math.max(12,c.top-200);z={left:Math.min(Math.max(12,c.left+c.width/2-zt/2),window.innerWidth-zt-12),top:j,width:zt}}return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-At,top:c.top-At,width:c.width+At*2,height:c.height+At*2}}),(v||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:z,children:[v&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(on,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(on,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(A=>Math.max(0,A-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(A=>A+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Qn(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Jn(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Ci(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,dispatch:s}=F(),c=r?a:e,h=x.useMemo(()=>c.filter(E=>He(E.date)===0&&E.kind==="target"),[c]),d=x.useMemo(()=>r?a.filter(E=>ke(E)===0).slice().sort((E,z)=>(z.date||"").localeCompare(E.date||"")):[],[a,r]),m=x.useMemo(()=>h.filter(E=>r?ke(E)===0:!Ce(E)),[h,r]),u=r?d:m,b=r?a.length-d.length:h.length-m.length,p=r?a.length:h.length,g=p?Math.min(100,b/p*100):100,v=x.useMemo(()=>Qn(c),[c]),f=!!v&&He(v)>0,y=x.useMemo(()=>f?c.filter(E=>(E.date||"").slice(0,10)===v):[],[c,v,f]);let C;f?C=i.morningLast(y.length,d.length,Jn(v,l)):r?C=i.morningThesis(h.length,d.length):h.length?b===0?C=i.goalSourced(h.length):b>=h.length?C=i.goalCleared:C=i.goalDone(b,h.length):C=i.goalSourced(0);const w=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&d.length&&s({type:"chainStart",queue:d.map(E=>E.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:C}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:g+"%"}})}),u.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:w,children:r?i.morningEval(u.length):o.pileMode?i.goalContinue(u.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ei(){var B,H;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:c,doSync:h,startTour:d}=F(),[m,u]=x.useState(null),[b,p]=x.useState(!0),[g,v]=x.useState([]),f=c==="client";x.useEffect(()=>{if(!i||!o)return;let k=!0;return p(!0),(async()=>{const[N,R]=await Promise.all([Aa(o),$n(i)]);k&&(N&&u(N),p(!1),v(R))})(),()=>{k=!1}},[i,o]);const y=(m==null?void 0:m.per_day)??null,C=((B=m==null?void 0:m.pool_order)==null?void 0:B.length)??0,w=g.filter(k=>k.status==="running").length,E=x.useMemo(()=>s.filter(k=>k.kind==="target"&&Ce(k)).length,[s]),z=l.marketEstimate,A=typeof((H=l.stats)==null?void 0:H.screened)=="number"?l.stats.screened:E,T=z&&z>0?Math.min(100,Math.round(A/z*100)):null,j=k=>k.toLocaleString(a==="en"?"en-US":"fr-FR"),M=(o||"P").split(/\s+/).map(k=>k[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const k=Date.parse(l.generatedAt||"");if(Number.isNaN(k))return"";const N=new Date(k),R=V=>String(V).padStart(2,"0");return`${R(N.getDate())}/${R(N.getMonth()+1)} à ${R(N.getHours())}:${R(N.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:M}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),q&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[T===null&&A>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:j(A)})})]}),T!==null&&z&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:T+"%"}})}),t.jsxs("b",{children:[T," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(A,z)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),y!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:y})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),y===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),w>0&&t.jsxs("span",{className:"ev",children:["⏳ ",w]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(C)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:k=>{k.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!f,onClick:h,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:k=>n({type:"filters",patch:{search:k.target.value}})})]})]})]})}function Ai(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const zi=["--p0","--p1","--p2","--p3","--p4"];function Ti(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=F(),s=o.loading&&!l.length,c=x.useRef({});x.useEffect(()=>{c.current={...r}},[r]);const h=u=>{const b=c.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${zi[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},d=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,p,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(h)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Li=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Ri(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=F(),s=x.useRef(null),[c,h]=x.useState(60);x.useEffect(()=>{let b=0;const p=()=>{var C;const g=s.current;if(!g)return;const v=(C=g.parentElement)==null?void 0:C.querySelector('.funnel [aria-selected="true"]');if(!v)return;const f=v.getBoundingClientRect(),y=g.getBoundingClientRect();h(Math.max(20,Math.min(f.left+f.width/2-y.left,y.width-30)))};return b=requestAnimationFrame(p),window.addEventListener("resize",p),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",p)}},[e.ptab]);const d=e.ptab;let m=r.tuto[d].p;if(d===3){const b=n.filter(v=>v.kind==="target"&&ke(v)===3),p=b.filter(v=>ia(v)==="auto").length,g=b.filter(v=>ia(v)==="cd").length;m=r.tutoPending(p,g,b.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(b=>b.id)})};if(d===1){const b=n.filter(p=>p.kind==="target"&&ke(p)===1&&!i.has(p.id)).slice(0,10);if(b.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:b.map(p=>p.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Li[d],"--ax":c+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Qe{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Mi(e){for(const a of e)yield*a}function Xn(e){return Array.from(Mi(e))}var ne=1e-6,Q=Math.PI,Te=Q/2,sn=Q/4,Re=Q*2,Ue=180/Q,Se=Q/180,ie=Math.abs,qi=Math.atan,vt=Math.atan2,de=Math.cos,ce=Math.sin,Oi=Math.sign||function(e){return e>0?1:e<0?-1:0},et=Math.sqrt;function Fi(e){return e>1?0:e<-1?Q:Math.acos(e)}function yt(e){return e>1?Te:e<-1?-Te:Math.asin(e)}function Le(){}function Pt(e,a){e&&dn.hasOwnProperty(e.type)&&dn[e.type](e,a)}var ln={Feature:function(e,a){Pt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Pt(r[n].geometry,a)}},dn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ca(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ca(r[n],a,0)},Polygon:function(e,a){cn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)cn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Pt(r[n],a)}};function ca(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function cn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ca(e[r],a,1);a.polygonEnd()}function nt(e,a){e&&ln.hasOwnProperty(e.type)?ln[e.type](e,a):Pt(e,a)}function pa(e){return[vt(e[1],e[0]),yt(e[2])]}function it(e){var a=e[0],r=e[1],n=de(r);return[n*de(a),n*ce(a),ce(r)]}function Tt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Dt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ta(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Lt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ua(e){var a=et(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ma(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function fa(e,a){return ie(e)>Q&&(e-=Math.round(e/Re)*Re),[e,a]}fa.invert=fa;function Pi(e,a,r){return(e%=Re)?a||r?ma(un(e),mn(a,r)):un(e):a||r?mn(a,r):fa}function pn(e){return function(a,r){return a+=e,ie(a)>Q&&(a-=Math.round(a/Re)*Re),[a,r]}}function un(e){var a=pn(e);return a.invert=pn(-e),a}function mn(e,a){var r=de(e),n=ce(e),i=de(a),o=ce(a);function l(s,c){var h=de(c),d=de(s)*h,m=ce(s)*h,u=ce(c),b=u*r+d*n;return[vt(m*i-b*o,d*r-u*n),yt(b*i+m*o)]}return l.invert=function(s,c){var h=de(c),d=de(s)*h,m=ce(s)*h,u=ce(c),b=u*i-m*o;return[vt(m*i+u*o,d*r+b*n),yt(b*r-d*n)]},l}function Di(e,a,r,n,i,o){if(r){var l=de(a),s=ce(a),c=n*r;i==null?(i=a+n*Re,o=a-c/2):(i=fn(l,i),o=fn(l,o),(n>0?i<o:i>o)&&(i+=n*Re));for(var h,d=i;n>0?d>o:d<o;d-=c)h=pa([l,-s*de(d),-s*ce(d)]),e.point(h[0],h[1])}}function fn(e,a){a=it(a),a[0]-=e,ua(a);var r=Fi(-a[1]);return((-a[2]<0?-r:r)+Re-ne)%Re}function Zn(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Le,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ft(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Rt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function er(e,a,r,n,i){var o=[],l=[],s,c;if(e.forEach(function(p){if(!((g=p.length-1)<=0)){var g,v=p[0],f=p[g],y;if(Ft(v,f)){if(!v[2]&&!f[2]){for(i.lineStart(),s=0;s<g;++s)i.point((v=p[s])[0],v[1]);i.lineEnd();return}f[0]+=2*ne}o.push(y=new Rt(v,p,null,!0)),l.push(y.o=new Rt(v,null,y,!1)),o.push(y=new Rt(f,p,null,!1)),l.push(y.o=new Rt(f,null,y,!0))}}),!!o.length){for(l.sort(a),xn(o),xn(l),s=0,c=l.length;s<c;++s)l[s].e=r=!r;for(var h=o[0],d,m;;){for(var u=h,b=!0;u.v;)if((u=u.n)===h)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,c=d.length;s<c;++s)i.point((m=d[s])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(d=u.p.z,s=d.length-1;s>=0;--s)i.point((m=d[s])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);i.lineEnd()}}}function xn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function aa(e){return ie(e[0])<=Q?e[0]:Oi(e[0])*((ie(e[0])+Q)%Re-Q)}function Ii(e,a){var r=aa(a),n=a[1],i=ce(n),o=[ce(r),-de(r),0],l=0,s=0,c=new Qe;i===1?n=Te+ne:i===-1&&(n=-Te-ne);for(var h=0,d=e.length;h<d;++h)if(u=(m=e[h]).length)for(var m,u,b=m[u-1],p=aa(b),g=b[1]/2+sn,v=ce(g),f=de(g),y=0;y<u;++y,p=w,v=z,f=A,b=C){var C=m[y],w=aa(C),E=C[1]/2+sn,z=ce(E),A=de(E),T=w-p,j=T>=0?1:-1,M=j*T,q=M>Q,B=v*z;if(c.add(vt(B*j*ce(M),f*A+B*de(M))),l+=q?T+j*Re:T,q^p>=r^w>=r){var H=Dt(it(b),it(C));ua(H);var k=Dt(o,H);ua(k);var N=(q^T>=0?-1:1)*yt(k[2]);(n>N||n===N&&(H[0]||H[1]))&&(s+=q^T>=0?1:-1)}}return(l<-ne||l<ne&&c<-1e-12)^s&1}function tr(e,a,r,n){return function(i){var o=a(i),l=Zn(),s=a(l),c=!1,h,d,m,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=C,d=[],h=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,d=Xn(d);var w=Ii(h,n);d.length?(c||(i.polygonStart(),c=!0),er(d,Bi,w,r,i)):w&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),d=h=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(w,E){e(w,E)&&i.point(w,E)}function p(w,E){o.point(w,E)}function g(){u.point=p,o.lineStart()}function v(){u.point=b,o.lineEnd()}function f(w,E){m.push([w,E]),s.point(w,E)}function y(){s.lineStart(),m=[]}function C(){f(m[0][0],m[0][1]),s.lineEnd();var w=s.clean(),E=l.result(),z,A=E.length,T,j,M;if(m.pop(),h.push(m),m=null,!!A){if(w&1){if(j=E[0],(T=j.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),z=0;z<T;++z)i.point((M=j[z])[0],M[1]);i.lineEnd()}return}A>1&&w&2&&E.push(E.pop().concat(E.shift())),d.push(E.filter($i))}}return u}}function $i(e){return e.length>1}function Bi(e,a){return((e=e.x)[0]<0?e[1]-Te-ne:Te-e[1])-((a=a.x)[0]<0?a[1]-Te-ne:Te-a[1])}const hn=tr(function(){return!0},Ui,Vi,[-Q,-Te]);function Ui(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?Q:-Q,c=ie(o-a);ie(c-Q)<ne?(e.point(a,r=(r+l)/2>0?Te:-Te),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&c>=Q&&(ie(a-n)<ne&&(a-=n*ne),ie(o-s)<ne&&(o-=s*ne),r=_i(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function _i(e,a,r,n){var i,o,l=ce(e-r);return ie(l)>ne?qi((ce(a)*(o=de(n))*ce(r)-ce(n)*(i=de(a))*ce(e))/(i*o*l)):(a+n)/2}function Vi(e,a,r,n){var i;if(e==null)i=r*Te,n.point(-Q,i),n.point(0,i),n.point(Q,i),n.point(Q,0),n.point(Q,-i),n.point(0,-i),n.point(-Q,-i),n.point(-Q,0),n.point(-Q,i);else if(ie(e[0]-a[0])>ne){var o=e[0]<a[0]?Q:-Q;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Hi(e){var a=de(e),r=2*Se,n=a>0,i=ie(a)>ne;function o(d,m,u,b){Di(b,e,r,u,d,m)}function l(d,m){return de(d)*de(m)>a}function s(d){var m,u,b,p,g;return{lineStart:function(){p=b=!1,g=1},point:function(v,f){var y=[v,f],C,w=l(v,f),E=n?w?0:h(v,f):w?h(v+(v<0?Q:-Q),f):0;if(!m&&(p=b=w)&&d.lineStart(),w!==b&&(C=c(m,y),(!C||Ft(m,C)||Ft(y,C))&&(y[2]=1)),w!==b)g=0,w?(d.lineStart(),C=c(y,m),d.point(C[0],C[1])):(C=c(m,y),d.point(C[0],C[1],2),d.lineEnd()),m=C;else if(i&&m&&n^w){var z;!(E&u)&&(z=c(y,m,!0))&&(g=0,n?(d.lineStart(),d.point(z[0][0],z[0][1]),d.point(z[1][0],z[1][1]),d.lineEnd()):(d.point(z[1][0],z[1][1]),d.lineEnd(),d.lineStart(),d.point(z[0][0],z[0][1],3)))}w&&(!m||!Ft(m,y))&&d.point(y[0],y[1]),m=y,b=w,u=E},lineEnd:function(){b&&d.lineEnd(),m=null},clean:function(){return g|(p&&b)<<1}}}function c(d,m,u){var b=it(d),p=it(m),g=[1,0,0],v=Dt(b,p),f=Tt(v,v),y=v[0],C=f-y*y;if(!C)return!u&&d;var w=a*f/C,E=-a*y/C,z=Dt(g,v),A=Lt(g,w),T=Lt(v,E);ta(A,T);var j=z,M=Tt(A,j),q=Tt(j,j),B=M*M-q*(Tt(A,A)-1);if(!(B<0)){var H=et(B),k=Lt(j,(-M-H)/q);if(ta(k,A),k=pa(k),!u)return k;var N=d[0],R=m[0],V=d[1],G=m[1],X;R<N&&(X=N,N=R,R=X);var L=R-N,O=ie(L-Q)<ne,$=O||L<ne;if(!O&&G<V&&(X=V,V=G,G=X),$?O?V+G>0^k[1]<(ie(k[0]-N)<ne?V:G):V<=k[1]&&k[1]<=G:L>Q^(N<=k[0]&&k[0]<=R)){var P=Lt(j,(-M+H)/q);return ta(P,A),[k,pa(P)]}}}function h(d,m){var u=n?e:Q-e,b=0;return d<-u?b|=1:d>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return tr(l,s,o,n?[0,-e]:[-Q,e-Q])}function Wi(e,a,r,n,i,o){var l=e[0],s=e[1],c=a[0],h=a[1],d=0,m=1,u=c-l,b=h-s,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<d)return;p<m&&(m=p)}else if(u>0){if(p>m)return;p>d&&(d=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>m)return;p>d&&(d=p)}else if(u>0){if(p<d)return;p<m&&(m=p)}if(p=n-s,!(!b&&p>0)){if(p/=b,b<0){if(p<d)return;p<m&&(m=p)}else if(b>0){if(p>m)return;p>d&&(d=p)}if(p=o-s,!(!b&&p<0)){if(p/=b,b<0){if(p>m)return;p>d&&(d=p)}else if(b>0){if(p<d)return;p<m&&(m=p)}return d>0&&(e[0]=l+d*u,e[1]=s+d*b),m<1&&(a[0]=l+m*u,a[1]=s+m*b),!0}}}}}var mt=1e9,Mt=-mt;function Yi(e,a,r,n){function i(h,d){return e<=h&&h<=r&&a<=d&&d<=n}function o(h,d,m,u){var b=0,p=0;if(h==null||(b=l(h,m))!==(p=l(d,m))||c(h,d)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==p);else u.point(d[0],d[1])}function l(h,d){return ie(h[0]-e)<ne?d>0?0:3:ie(h[0]-r)<ne?d>0?2:1:ie(h[1]-a)<ne?d>0?1:0:d>0?3:2}function s(h,d){return c(h.x,d.x)}function c(h,d){var m=l(h,1),u=l(d,1);return m!==u?m-u:m===0?d[1]-h[1]:m===1?h[0]-d[0]:m===2?h[1]-d[1]:d[0]-h[0]}return function(h){var d=h,m=Zn(),u,b,p,g,v,f,y,C,w,E,z,A={point:T,lineStart:B,lineEnd:H,polygonStart:M,polygonEnd:q};function T(N,R){i(N,R)&&d.point(N,R)}function j(){for(var N=0,R=0,V=b.length;R<V;++R)for(var G=b[R],X=1,L=G.length,O=G[0],$,P,D=O[0],U=O[1];X<L;++X)$=D,P=U,O=G[X],D=O[0],U=O[1],P<=n?U>n&&(D-$)*(n-P)>(U-P)*(e-$)&&++N:U<=n&&(D-$)*(n-P)<(U-P)*(e-$)&&--N;return N}function M(){d=m,u=[],b=[],z=!0}function q(){var N=j(),R=z&&N,V=(u=Xn(u)).length;(R||V)&&(h.polygonStart(),R&&(h.lineStart(),o(null,null,1,h),h.lineEnd()),V&&er(u,s,N,o,h),h.polygonEnd()),d=h,u=b=p=null}function B(){A.point=k,b&&b.push(p=[]),E=!0,w=!1,y=C=NaN}function H(){u&&(k(g,v),f&&w&&m.rejoin(),u.push(m.result())),A.point=T,w&&d.lineEnd()}function k(N,R){var V=i(N,R);if(b&&p.push([N,R]),E)g=N,v=R,f=V,E=!1,V&&(d.lineStart(),d.point(N,R));else if(V&&w)d.point(N,R);else{var G=[y=Math.max(Mt,Math.min(mt,y)),C=Math.max(Mt,Math.min(mt,C))],X=[N=Math.max(Mt,Math.min(mt,N)),R=Math.max(Mt,Math.min(mt,R))];Wi(G,X,e,a,r,n)?(w||(d.lineStart(),d.point(G[0],G[1])),d.point(X[0],X[1]),V||d.lineEnd(),z=!1):V&&(d.lineStart(),d.point(N,R),z=!1)}y=N,C=R,w=V}return A}}const xa=e=>e;var na=new Qe,ha=new Qe,ar,nr,ga,ba,_e={point:Le,lineStart:Le,lineEnd:Le,polygonStart:function(){_e.lineStart=Gi,_e.lineEnd=Qi},polygonEnd:function(){_e.lineStart=_e.lineEnd=_e.point=Le,na.add(ie(ha)),ha=new Qe},result:function(){var e=na/2;return na=new Qe,e}};function Gi(){_e.point=Ki}function Ki(e,a){_e.point=rr,ar=ga=e,nr=ba=a}function rr(e,a){ha.add(ba*e-ga*a),ga=e,ba=a}function Qi(){rr(ar,nr)}var st=1/0,It=st,wt=-st,$t=wt,Bt={point:Ji,lineStart:Le,lineEnd:Le,polygonStart:Le,polygonEnd:Le,result:function(){var e=[[st,It],[wt,$t]];return wt=$t=-(It=st=1/0),e}};function Ji(e,a){e<st&&(st=e),e>wt&&(wt=e),a<It&&(It=a),a>$t&&($t=a)}var va=0,ya=0,ft=0,Ut=0,_t=0,rt=0,wa=0,ka=0,xt=0,or,ir,De,Ie,ze={point:Je,lineStart:gn,lineEnd:bn,polygonStart:function(){ze.lineStart=es,ze.lineEnd=ts},polygonEnd:function(){ze.point=Je,ze.lineStart=gn,ze.lineEnd=bn},result:function(){var e=xt?[wa/xt,ka/xt]:rt?[Ut/rt,_t/rt]:ft?[va/ft,ya/ft]:[NaN,NaN];return va=ya=ft=Ut=_t=rt=wa=ka=xt=0,e}};function Je(e,a){va+=e,ya+=a,++ft}function gn(){ze.point=Xi}function Xi(e,a){ze.point=Zi,Je(De=e,Ie=a)}function Zi(e,a){var r=e-De,n=a-Ie,i=et(r*r+n*n);Ut+=i*(De+e)/2,_t+=i*(Ie+a)/2,rt+=i,Je(De=e,Ie=a)}function bn(){ze.point=Je}function es(){ze.point=as}function ts(){sr(or,ir)}function as(e,a){ze.point=sr,Je(or=De=e,ir=Ie=a)}function sr(e,a){var r=e-De,n=a-Ie,i=et(r*r+n*n);Ut+=i*(De+e)/2,_t+=i*(Ie+a)/2,rt+=i,i=Ie*e-De*a,wa+=i*(De+e),ka+=i*(Ie+a),xt+=i*3,Je(De=e,Ie=a)}function lr(e){this._context=e}lr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Re);break}}},result:Le};var ja=new Qe,ra,dr,cr,ht,gt,kt={point:Le,lineStart:function(){kt.point=ns},lineEnd:function(){ra&&pr(dr,cr),kt.point=Le},polygonStart:function(){ra=!0},polygonEnd:function(){ra=null},result:function(){var e=+ja;return ja=new Qe,e}};function ns(e,a){kt.point=pr,dr=ht=e,cr=gt=a}function pr(e,a){ht-=e,gt-=a,ja.add(et(ht*ht+gt*gt)),ht=e,gt=a}let vn,Vt,yn,wn;class kn{constructor(a){this._append=a==null?ur:rs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==yn||this._append!==Vt){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,yn=n,Vt=this._append,wn=this._,this._=i}this._+=wn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ur(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function rs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ur;if(a!==vn){const r=10**a;vn=a,Vt=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Vt}function os(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),nt(s,i(o))),o.result()}return l.area=function(s){return nt(s,i(_e)),_e.result()},l.measure=function(s){return nt(s,i(kt)),kt.result()},l.bounds=function(s){return nt(s,i(Bt)),Bt.result()},l.centroid=function(s){return nt(s,i(ze)),ze.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,xa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new kn(r)):new lr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const c=Math.floor(s);if(!(c>=0))throw new RangeError(`invalid digits: ${s}`);r=c}return a===null&&(o=new kn(r)),l},l.projection(e).digits(r).context(a)}function Ra(e){return function(a){var r=new Na;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Na(){}Na.prototype={constructor:Na,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ma(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),nt(r,e.stream(Bt)),a(Bt.result()),n!=null&&e.clipExtent(n),e}function mr(e,a,r){return Ma(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,c])},r)}function is(e,a,r){return mr(e,[[0,0],a],r)}function ss(e,a,r){return Ma(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function ls(e,a,r){return Ma(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var jn=16,ds=de(30*Se);function Nn(e,a){return+a?ps(e,a):cs(e)}function cs(e){return Ra({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ps(e,a){function r(n,i,o,l,s,c,h,d,m,u,b,p,g,v){var f=h-n,y=d-i,C=f*f+y*y;if(C>4*a&&g--){var w=l+u,E=s+b,z=c+p,A=et(w*w+E*E+z*z),T=yt(z/=A),j=ie(ie(z)-1)<ne||ie(o-m)<ne?(o+m)/2:vt(E,w),M=e(j,T),q=M[0],B=M[1],H=q-n,k=B-i,N=y*H-f*k;(N*N/C>a||ie((f*H+y*k)/C-.5)>.3||l*u+s*b+c*p<ds)&&(r(n,i,o,l,s,c,q,B,j,w/=A,E/=A,z,g,v),v.point(q,B),r(q,B,j,w,E,z,h,d,m,u,b,p,g,v))}}return function(n){var i,o,l,s,c,h,d,m,u,b,p,g,v={point:f,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=E},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function f(T,j){T=e(T,j),n.point(T[0],T[1])}function y(){m=NaN,v.point=C,n.lineStart()}function C(T,j){var M=it([T,j]),q=e(T,j);r(m,u,d,b,p,g,m=q[0],u=q[1],d=T,b=M[0],p=M[1],g=M[2],jn,n),n.point(m,u)}function w(){v.point=f,n.lineEnd()}function E(){y(),v.point=z,v.lineEnd=A}function z(T,j){C(i=T,j),o=m,l=u,s=b,c=p,h=g,v.point=C}function A(){r(m,u,d,b,p,g,o,l,i,s,c,h,jn,n),v.lineEnd=w,w()}return v}}var us=Ra({point:function(e,a){this.stream.point(e*Se,a*Se)}});function ms(e){return Ra({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function fs(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function Sn(e,a,r,n,i,o){if(!o)return fs(e,a,r,n,i);var l=de(o),s=ce(o),c=l*e,h=s*e,d=l/e,m=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function p(g,v){return g*=n,v*=i,[c*g-h*v+a,r-h*g-c*v]}return p.invert=function(g,v){return[n*(d*g-m*v+u),i*(b-m*g-d*v)]},p}function xs(e){return hs(function(){return e})()}function hs(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,c=0,h=0,d,m=0,u=1,b=1,p=null,g=hn,v=null,f,y,C,w=xa,E=.5,z,A,T,j,M;function q(N){return T(N[0]*Se,N[1]*Se)}function B(N){return N=T.invert(N[0],N[1]),N&&[N[0]*Ue,N[1]*Ue]}q.stream=function(N){return j&&M===N?j:j=us(ms(d)(g(z(w(M=N)))))},q.preclip=function(N){return arguments.length?(g=N,p=void 0,k()):g},q.postclip=function(N){return arguments.length?(w=N,v=f=y=C=null,k()):w},q.clipAngle=function(N){return arguments.length?(g=+N?Hi(p=N*Se):(p=null,hn),k()):p*Ue},q.clipExtent=function(N){return arguments.length?(w=N==null?(v=f=y=C=null,xa):Yi(v=+N[0][0],f=+N[0][1],y=+N[1][0],C=+N[1][1]),k()):v==null?null:[[v,f],[y,C]]},q.scale=function(N){return arguments.length?(r=+N,H()):r},q.translate=function(N){return arguments.length?(n=+N[0],i=+N[1],H()):[n,i]},q.center=function(N){return arguments.length?(o=N[0]%360*Se,l=N[1]%360*Se,H()):[o*Ue,l*Ue]},q.rotate=function(N){return arguments.length?(s=N[0]%360*Se,c=N[1]%360*Se,h=N.length>2?N[2]%360*Se:0,H()):[s*Ue,c*Ue,h*Ue]},q.angle=function(N){return arguments.length?(m=N%360*Se,H()):m*Ue},q.reflectX=function(N){return arguments.length?(u=N?-1:1,H()):u<0},q.reflectY=function(N){return arguments.length?(b=N?-1:1,H()):b<0},q.precision=function(N){return arguments.length?(z=Nn(A,E=N*N),k()):et(E)},q.fitExtent=function(N,R){return mr(q,N,R)},q.fitSize=function(N,R){return is(q,N,R)},q.fitWidth=function(N,R){return ss(q,N,R)},q.fitHeight=function(N,R){return ls(q,N,R)};function H(){var N=Sn(r,0,0,u,b,m).apply(null,a(o,l)),R=Sn(r,n-N[0],i-N[1],u,b,m);return d=Pi(s,c,h),A=ma(a,R),T=ma(d,A),z=Nn(A,E),k()}function k(){return j=M=null,q}return function(){return a=e.apply(this,arguments),q.invert=a.invert&&B,H()}}function fr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}fr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function gs(){return xs(fr).scale(175.295)}function bs(e){return e}function vs(e){if(e==null)return bs;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,c){c||(a=r=0);var h=2,d=s.length,m=new Array(d);for(m[0]=(a+=s[0])*n+o,m[1]=(r+=s[1])*i+l;h<d;)m[h]=s[h],++h;return m}}function ys(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ws(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Cn(e,r)})}:Cn(e,a)}function Cn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=ks(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function ks(e,a){var r=vs(e.transform),n=e.arcs;function i(d,m){m.length&&m.pop();for(var u=n[d<0?~d:d],b=0,p=u.length;b<p;++b)m.push(r(u[b],b));d<0&&ys(m,p)}function o(d){return r(d)}function l(d){for(var m=[],u=0,b=d.length;u<b;++u)i(d[u],m);return m.length<2&&m.push(m[0]),m}function s(d){for(var m=l(d);m.length<4;)m.push(m[0]);return m}function c(d){return d.map(s)}function h(d){var m=d.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:d.geometries.map(h)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=c(d.arcs);break;case"MultiPolygon":u=d.arcs.map(c);break;default:return null}return{type:m,coordinates:u}}return h(a)}const xr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},js=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Ns(e,a,r){const n=xr[e];if(!n||!n.length)return-1;const i=js(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let qt=null;function Ss(){return qt||(qt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ws(r,n),o=gs().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=os(o),s=(i.features||[]).filter(d=>{var m;return(((m=d.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(d=>{var b;const m=((b=d.properties)==null?void 0:b.name)||"",u=l(d)||"";return u?{i2:to(m)||null,n:m,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const c={};for(const[d,m]of Object.entries(ao)){const u=o(m);u&&(c[d]={x:u[0],y:u[1]})}const h={};for(const[d,m]of Object.entries(xr)){const u=m.map(b=>o(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(h[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:c,metros:h}}catch{return null}})(),qt)}function Cs(e){const[a,r]=x.useState(null);return x.useEffect(()=>{if(!e||a)return;let n=!1;return Ss().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const Es={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},En=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function An(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function As(e,a){const[r,n]=x.useState(1);return x.useEffect(()=>{let i=!0,o=0;const l=()=>{var h;if(!i)return;const c=(h=e.current)==null?void 0:h.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function zs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:c,data:h,dossiers:d}=F(),m=h.loading&&!d.length,u=x.useRef(null),b=x.useRef(null),p=Cs(e.continent==="monde"),g=e.continent==="monde"?p:za.find(k=>k.key===e.continent)||null,v=As(u,e.continent+":"+e.mapFolded+":"+!!g),[f,y]=x.useState(new Map),[C,w]=x.useState(null);x.useEffect(()=>{const k=u.current;if(!k)return;const N=new Map;k.querySelectorAll("path[data-i2]").forEach(R=>{const V=R.dataset.i2;if(V)try{const G=R.getBBox();G.width>0&&N.set(V,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(N)},[e.continent,v,g]);const E=x.useMemo(()=>r.filter(k=>k.cc),[r]),z=x.useMemo(()=>{const k=new Map;return E.forEach(N=>k.set(N.cc,(k.get(N.cc)||0)+1)),k},[E]),A=e.continent==="monde"&&p?p.anchors:null,T=e.continent==="monde"&&p?p.metros:null,j=x.useMemo(()=>E.map(k=>{const N=An(k.name||k.id||""),R=An((k.id||k.name||"")+"·y");if(A&&k.cc){const O=T?T[k.cc]:void 0;if(O&&O.length){const P=Ns(k.cc,k.city,N);if(P>=0&&O[P])return{d:k,x:O[P].x+(N-.5)*5,y:O[P].y+(R-.5)*5}}const $=A[k.cc];if($)return{d:k,x:$.x+(N-.5)*10,y:$.y+(R-.5)*10}}const V=k.cc?f.get(k.cc):void 0;if(!V)return null;const G=Es[`${e.continent}:${k.cc||""}`];if(G)return{d:k,x:V.x+V.w*(G.fx+(N-.5)*G.sx),y:V.y+V.h*(G.fy+(R-.5)*G.sy)};const X=(N-.5)*Math.min(V.w*.55,60),L=(R-.5)*Math.min(V.h*.55,60);return{d:k,x:V.x+V.w/2+X,y:V.y+V.h/2+L}}).filter(k=>!!k),[E,f,A,T,e.continent]),M=k=>v>0?k/v:k,q=x.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:En[k],fr:c.plabels[k].toUpperCase(),en:c.plabels[k].toUpperCase(),n:r.filter(N=>N.kind==="target"&&ke(N)===k).length})).filter(k=>k.n>0):Ha.map((k,N)=>({...k,n:r.filter(R=>Wa(R)===N).length})),[r,n,c.plabels]),B=o?l.get(o):null,H=B?j.find(k=>k.d.id===B.id):null;return g?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?g.fr:g.en,onMouseLeave:()=>{w(null),i(null)},children:[t.jsx("g",{children:g.countries.map((k,N)=>t.jsx("g",{className:"ct"+(k.i2&&z.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},N))}),t.jsx("g",{children:j.map(k=>{const N=Ha[Wa(k.d)],R=!!ge(k.d),V=k.d.kind==="target",G=n&&V?En[ke(k.d)]:N.c,X=!n&&Ce(k.d);return t.jsxs("g",{className:"co"+(X?" done":""),onMouseEnter:()=>{var $,P;const L=($=b.current)==null?void 0:$.getBoundingClientRect(),O=(P=u.current)==null?void 0:P.createSVGPoint();if(O&&u.current&&L){O.x=k.x,O.y=k.y;const D=O.matrixTransform(u.current.getScreenCTM());w({x:D.x-L.left,y:D.y-L.top,label:k.d.name+" · "+(dt(k.d.cc,s)||k.d.countryLabel||"")})}i(k.d.id)},onMouseLeave:()=>{w(null),i(null)},onClick:()=>{var $;const L=($=u.current)==null?void 0:$.createSVGPoint();let O=null;if(L&&u.current){L.x=k.x,L.y=k.y;const P=L.matrixTransform(u.current.getScreenCTM());O={x:P.x,y:P.y}}a({type:"popup",id:k.d.id,anchor:O})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:M(Math.max(11,N.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:M(N.px),fill:G,stroke:R?"#DC2626":"#ffffff",strokeWidth:M(R?2.2:1.3)})]},k.d.id||k.d.name)})}),H&&t.jsx("circle",{className:"ring on",cx:H.x,cy:H.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(C?" on":""),style:C?{left:C.x,top:C.y}:void 0,children:C==null?void 0:C.label}),t.jsx("div",{className:"legend",children:q.map((k,N)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},N))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:b})}function Ts(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Ls(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=F(),s=e.filters,c=x.useMemo(()=>e.continent==="monde"?r:r.filter(p=>p.continent===e.continent),[r,e.continent]),h=p=>c.filter(g=>p!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:Ta(g,s,i,p==="country"?void 0:p)),d=x.useMemo(()=>{const p=h("win"),g=v=>p.filter(f=>(f.date?Math.max(0,Math.floor((Date.now()-Date.parse(f.date))/864e5)):9999)<=v).length;return[g(0),g(7),g(30),p.length]},[c,s,i]),m=x.useMemo(()=>s.day?h("win").filter(p=>(p.date||"").slice(0,10)===s.day).length:0,[c,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),b=(p,g,v,f="fbtn")=>t.jsxs("button",{type:"button",className:f,"aria-expanded":e.openFacet===p,onClick:()=>a({type:"openFacet",facet:p}),children:[t.jsx("span",{className:"fl",children:g}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},p);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(Ts(s.day,l)),t.jsx("b",{children:m})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((p,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===p,onClick:()=>a({type:"filters",patch:{win:p}}),children:[n.dates[g],t.jsx("b",{children:d[g]})]},p))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:p=>a({type:"filters",patch:{search:p.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):b("sec",n.fSector,s.sector.length),b("pay",n.fCountry,s.country.length),b("det",n.fEngine,s.engine.length),b("sta",n.fStage,s.stage.length),i&&b("ang","Angle",s.angle.length),i&&b("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(c.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Rs,{poolFor:h})]})}function Rs({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=a.filters,l=a.openFacet,{title:s,cols:c,options:h}=x.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(f=>ge(f)),g=new Map;p.forEach(f=>{const y=f.engine||"";g.set(y,(g.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...sa([...g.keys()],i).map(f=>({v:f,label:Ke(f)+" "+$e(f,i),n:g.get(f)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const p=e("sector"),g=new Map;return p.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v,n:f,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const p=e("country"),g=new Map;return p.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:dt(v,i)||v,n:f,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const p=e("engine"),g=new Map;return p.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:sa([...g.keys()],i).map(v=>({v,label:Ke(v)+" "+$e(v,i)+' <span style="color:var(--dim);font-size:10px">· '+no(ro(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const p=e("angle"),g=new Map;return p.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v.replace(/[_-]+/g," "),n:f,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const p=e("memoLevel"),g=new Map;p.forEach(f=>{if(f.kind==="target"){const y=Ea(f);g.set(y,(g.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:v[f],n:g.get(f)||0,html:!1,on:o.memoLevel.includes(f)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,g)=>g[1]-p[1]).map(([p,g])=>({v:p,label:p,n:g,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:h.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function hr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ms(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function zn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=F();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:s.rsEvalOne})]},c.name))})]}):null}function gr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=F(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(zn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(zn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function qs({card:e,onEvaluate:a,onAddAll:r}){var s,c,h;const{t:n}=F(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:hr(e.summary_md||"").map((d,m)=>t.jsx("p",{children:d},m))})]}),t.jsx(gr,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Os(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Fs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=F(),s=i,[c,h]=x.useState(null),[d,m]=x.useState(null),[u,b]=x.useState(null),[p,g]=x.useState(!1);x.useEffect(()=>{let f=!0;return(async()=>{const y=await Bn({email:l,cbToken:s});f&&h(y)})(),()=>{f=!1}},[l,s,n]);const v=f=>{m(f),b(null),g(!0),(async()=>{const y=await oo(f.id);b(y),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Os(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?o.rsPub:o.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(qs,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Tn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Ps(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:c,caps:h,data:d,canWrite:m,source:u}=F(),b=a==="client",p=x.useMemo(()=>r||(u!=="default"?io():""),[r,u]),[g,v]=x.useState(""),[f,y]=x.useState(!1),[C,w]=x.useState(""),[E,z]=x.useState(!1),[A,T]=x.useState(""),[j,M]=x.useState([]),q=x.useRef(!1),[B,H]=x.useState(!1),[k,N]=x.useState(""),[R,V]=x.useState(""),[G,X]=x.useState(!1),[L,O]=x.useState(0),[$,P]=x.useState(""),[D,U]=x.useState(null),[Y,J]=x.useState(null),[re,fe]=x.useState(!1),[pe,K]=x.useState(null),[te,xe]=x.useState(0),Z=x.useRef(!1),se=g.trim()?Tn.test(g.trim())?e.evalUrl:e.evalName:e.evalWaiting,ae=x.useMemo(()=>C.split(`
`).map(I=>I.trim()).filter(Boolean).slice(0,15),[C]);x.useEffect(()=>{if(typeof window>"u")return;const I=(new URLSearchParams(window.location.search).get("rs")||"").trim();!I||!/^https?:\/\//i.test(I)||(N(I),H(!0))},[]),x.useEffect(()=>{const I=ee=>{var ye;const oe=String(((ye=ee.detail)==null?void 0:ye.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(N(oe),H(!0))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),x.useEffect(()=>{if(!m&&!p){K(null);return}let I=!0;return(async()=>{const ee=await Bn({email:n,cbToken:p});I&&K(ee.length)})(),()=>{I=!1}},[m,p,n,te]);const Oe=j.length?j:c,he=d.credits,ve=x.useCallback(I=>{const ee=I.map(oe=>(oe||"").trim()).filter(Boolean);ee.length&&(w(oe=>{const ye=oe.split(`
...
`)}),y(!0))},[]);x.useEffect(()=>{if(!G)return;O(0);const I=window.setInterval(()=>O(ee=>ee+1),1e3);return()=>window.clearInterval(I)},[G]);const Me=()=>{const I=g.trim();I&&(i(null,I),v(""))},tt=async()=>{if(!b){i(null,ae[0]||"");return}if(!ae.length||E)return;z(!0),q.current=!1;const I=[];for(let ee=0;ee<ae.length&&!q.current;ee++){T(e.evaluating(ee+1,ae.length,ae[ee]));const oe=await Un(r,ae[ee],"atelier2");if(I.unshift({name:oe.company||ae[ee],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),M([...I]),oe.verdict==="quota"){I.unshift({name:"",verdict:"quota",reason:e.quota(ae.length-ee-1),remaining:0}),M([...I]),w(ae.slice(ee+1).join(`
`)),T(""),z(!1);return}}T(""),w(q.current?ae.slice(I.length).join(`
`):""),z(!1)},Ee=async()=>{var oe,ye,Ve;if(Z.current)return;const I=k.trim().replace(/\s+/g,""),ee=R.trim();if(!I&&!ee){P(e.rsNeed);return}if(!b&&!p){i(null,I||ee.slice(0,80));return}Z.current=!0,P(""),U(null),J(null),X(!0);try{const je=await lo({url:I,text:ee,email:n,cbToken:p});if(X(!1),!je||je.status!=="success"){P((je==null?void 0:je.message)||"Erreur");return}U(je),H(!1),ve((((oe=je.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),J({state:"pending"});const le=await co(je,{email:n,cbToken:p});J(le.ok?{state:"ok",scopeLabel:((ye=le.summary)==null?void 0:ye.scope_label)||"",scope:((Ve=le.summary)==null?void 0:Ve.scope)||""}:{state:"fail",msg:le.error||""}),le.ok&&xe(Ae=>Ae+1)}finally{Z.current=!1,X(!1)}},Be=[D==null?void 0:D.industry,...(D==null?void 0:D.market_tags)||[],D==null?void 0:D.author].map(I=>(I||"").trim()).filter(Boolean),ct=(Y==null?void 0:Y.state)==="pending",Nt=Y&&(ct?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Y.state==="ok"?t.jsx("span",{className:"rslink ok",children:Y.scope&&Y.scope!=="public"?e.rsSavedIn(Y.scopeLabel||Y.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Y.msg,children:e.rsSaveFail})),at=Ms(D).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:g,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:I=>v(I.target.value),onKeyDown:I=>{I.key==="Enter"&&Me()}}),t.jsx("span",{className:"detect"+(Tn.test(g.trim())?" url":""),children:se})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:Me,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),h.showCredits&&he&&t.jsxs("button",{type:"button",className:"credits"+(he.total_available<=0&&!he.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:he.unlimited?"∞":he.total_available}),!he.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",he.daily_grant+he.purchased]}),he.total_available<=0&&!he.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(B?" on":""),onClick:()=>H(!B),children:e.rsOpen}),pe!==null&&pe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>fe(!re),children:e.rsArchOpen(pe)})]}),re&&t.jsx(Fs,{bump:te,cbToken:p,onClose:()=>fe(!1),onEvaluate:I=>i(null,I),onAddAll:ve}),B&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:k,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:I=>N(I.target.value),onKeyDown:I=>{I.key==="Enter"&&Ee()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:R,placeholder:e.rsTextPh,onChange:I=>V(I.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(G?" loading":""),style:{justifyContent:"center"},disabled:G||ct||!k.trim()&&!R.trim(),onClick:()=>{Ee()},children:[t.jsx("span",{className:"fill"}),G?`${so(k.trim())==="youtube"&&k.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(L)}`:ct?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),$&&t.jsx("div",{className:"rserr",children:$}),D&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:D.title}),D.source_url&&t.jsx("a",{href:D.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{U(null),J(null)},children:"×"})]}),D.market&&t.jsx("p",{className:"rsmk",children:D.market}),Be.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Be.map(I=>t.jsx("span",{children:I},I))]}),t.jsxs("div",{className:"rsbody",children:[D.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${D.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:hr(D.summary_md||"").map((I,ee)=>t.jsx("p",{children:I},ee))})]}),t.jsx(gr,{card:D,onEvaluate:I=>i(null,I),onAddAll:ve}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(at)}),Nt]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:C,placeholder:e.bulkPh,onChange:I=>w(I.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(E?" loading":""),style:{justifyContent:"center"},disabled:E||!ae.length,onClick:()=>{tt()},children:[t.jsx("span",{className:"fill"}),E&&A?A:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(ae.length)})]})]}),Oe.slice(0,1).map((I,ee)=>{const oe=I.verdict==="kept",ye=I.verdict==="quota",Ve=oe?"var(--brand)":ye?"var(--bolt)":"var(--red)",je=oe?"var(--brand-l)":ye?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ve,"--bgc":je},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:ye?"⏳":"✗ "+e.dropped})}),I.name&&t.jsx("span",{className:"rn",children:I.name}),t.jsx("span",{className:"rr",children:I.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",I.reason]}):null}),!!(I.candidates&&I.candidates.length)&&t.jsx("span",{className:"sitepick",children:I.candidates.map(le=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:le.url.startsWith("http")?le.url:`https://${le.url}`,target:"_blank",rel:"nofollow noopener",children:[(le.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,le.url),children:e.evalPickGo})]},le.url))}),!ye&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:oe?1:5});const le=(I.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ae=[...document.querySelectorAll(".atl2 .list .row")].find(Gt=>{var St;return(((St=Gt.querySelector(".rnm"))==null?void 0:St.textContent)||"").trim().toLowerCase().includes(le)});Ae&&(Ae.scrollIntoView({behavior:"smooth",block:"center"}),Ae.classList.add("flashrow"),window.setTimeout(()=>Ae.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ee)}),b&&(o.kept+o.dropped>0||Oe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Ds(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Is(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=F(),o=e.memoConsole?r.get(e.memoConsole):null,l=x.useMemo(()=>o?[o.reasoning||"",Ds(o.summary||"")].filter(Boolean).join(`
