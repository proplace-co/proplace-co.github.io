...
`,Qi=Gi+Ki;function Qa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ji(){const e=Qa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Xi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ji();return r==="0"?"client":r==="1"||Qa("embed")==="1"&&Qa("chrome")==="1"?"apercu":"client"}const Zi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},es=e=>Zi[e];function wa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const vt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Cr(a)||wa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Bo(e.cc)})};function Pa(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const ts=60*60*1e3;function as(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>ts?null:a}catch{return null}}function ia(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ns=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function rs(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:Ao(),[e,n]),o=m.useMemo(()=>n?"visiteur":Xi(e,i),[e,i,n]),l=m.useMemo(()=>es(o),[o]),d=o!=="visiteur",c=ns(r),[g,s]=m.useState([]),[f,p]=m.useState(""),[v,u]=m.useState(null),[b,y]=m.useState(null),[x,N]=m.useState(null),[S,k]=m.useState(()=>new Map),[E,T]=m.useState(()=>new Map),[C,L]=m.useState(""),[q,D]=m.useState(new Set),[P,I]=m.useState(null),[j,R]=m.useState(!0),[h,A]=m.useState(!1),[B,Y]=m.useState(0),[V,K]=m.useState(0),X=m.useRef(0),Q=m.useMemo(()=>{var ae;if(o!=="client")return"";try{return((ae=To())==null?void 0:ae.email)||""}catch{return""}},[o]);m.useEffect(()=>{const ae=++X.current;let ce=!0;const W=()=>ce&&ae===X.current,re=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),ee=as(re);return ee?(s(ee.objs.map(vt)),ee.fund&&p(ee.fund),u(ee.marketEstimate??null),y(ee.criteria??null),N(ee.stats??null),L(ee.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const Le=await Ma(),je=((Le==null?void 0:Le.recent_ops)||[]).map(oe=>{const me=ha(oe.company_name||oe.title?oe:{...oe,title:(oe.headline_fr||oe.headline||"").slice(0,120)},a),de=String(oe.rubrique||"").toLowerCase();return me&&(de==="nominations"||de==="recrutements")&&(me.engine=de),me&&!String(oe.company_name||"").trim()&&(me.noCo=!0),me}).filter(oe=>!!oe).map(oe=>(Cr((oe.name||"").trim())||(oe.noCo=!0),oe));try{const oe=qo(),me=await Lo(),de=((me==null?void 0:me.date)||"").slice(0,10),G=oe?oe.doc:me,Z=Fo(G),he=((oe==null?void 0:oe.day)||(G==null?void 0:G.date)||de||"").slice(0,10);if(he&&Z.length){const se=new Set;for(const fe of je){if((fe.date||"").slice(0,10)!==he)continue;const ge=An(Z,se,fe.name,"");ge>=0&&(se.add(ge),fe.decryptHtml=Z[ge].html)}for(const fe of je){if(fe.decryptHtml||(fe.date||"").slice(0,10)!==he)continue;const ge=An(Z,se,"",fe.headline||fe.tagline||fe.name);ge>=0&&(se.add(ge),fe.decryptHtml=Z[ge].html)}}if(he){const se=((G==null?void 0:G.title_fr)||"").trim(),fe=((G==null?void 0:G.lead_fr)||"").trim(),ge=Ro(G),be=((G==null?void 0:G.url)||"").trim();se&&(ge||be)&&je.unshift({id:`edito:${he}`,kind:"op",name:se,cc:null,date:he,engine:"edito",dealKind:"other",headline:se,tagline:fe||se,decryptHtml:ge||void 0,url:be,noCo:!0})}}catch{}if(!W())return;s(je.map(vt)),ia(re,{objs:je})}else if(typeof r=="object"){const je=(await Tn()||[]).filter(me=>(me.slug||"")===r.research).map(me=>qn(me,a)).filter(me=>!!me),oe=Pa(await Ln(je,a));if(!W())return;s(oe.map(vt)),ia(re,{objs:oe})}else if(d&&i.token){const Le=Mo(i.token),je=Ma(),oe=Oo(i.token),me=Do(i.token),de=Po(i.token),G=await Le;let Z=G?G.targets:[];W()&&G&&(p(G.fund||""),u(G.marketEstimate??null),y(G.criteria??null),N(G.stats??null),L(G.generatedAt||""),s(Z.map(vt)),R(!1),A(!1));const[he,se,fe,ge]=await Promise.all([je,oe,me,de]),be=((he==null?void 0:he.recent_ops)||[]).map(ve=>ha(ve,a)).filter(ve=>!!ve);if(Z=[...Z,...be],!W())return;s(Z.map(vt));const qe=new Set;for(const ve of se){const Fe=(ve.id||ve.co||"").toString().trim().toLowerCase();Fe&&qe.add(Fe.startsWith("t:")?Fe:"t:"+Fe)}D(qe),k(fe),T(ge),G&&ia(re,{fund:G.fund,marketEstimate:G.marketEstimate,criteria:G.criteria,stats:G.stats,generatedAt:G.generatedAt,objs:Z})}else{const Le=Io(),je=Tn(),oe=Ma(),me=await Le;W()&&me.length&&(s(Pa(me).map(vt)),R(!1),A(!1));const[de,G]=await Promise.all([je,oe]),Z=(de||[]).map(ge=>qn(ge,a)).filter(ge=>!!ge),he=await Ln(Z,a),se=((G==null?void 0:G.recent_ops)||[]).map(ge=>ha(ge,a)).filter(ge=>!!ge),fe=Pa([...me,...he,...se]);if(!W())return;s(fe.map(vt)),ia(re,{objs:fe})}W()&&A(!1)}catch{W()&&!ee&&A(!0)}finally{W()&&R(!1)}})(),()=>{ce=!1}},[d,i.token,a,B,c]),m.useEffect(()=>{if(!l.showCredits||!Q){I(null);return}let ae=!0;return(async()=>{try{const ce=await fetch(`${mn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Q})});if(!ce.ok)return;const W=await ce.json();ae&&W&&W.ok!==!1&&I(W)}catch{}})(),()=>{ae=!1}},[l.showCredits,Q,V]);const ie=m.useCallback(ae=>D(new Set(ae)),[]);return{session:i,mode:o,caps:l,fund:f,email:Q,marketEstimate:v,generatedAt:C,criteria:b,stats:x,thumbs:S,stages:E,dossiers:g,favIds:q,setFavIds:ie,credits:P,reloadCredits:()=>K(ae=>ae+1),loading:j,error:h,refresh:()=>Y(ae=>ae+1)}}function Ze(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Or=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),os=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Or(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),is=new Set(["signal","amount","score","crible","memo"]);function ss(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Or(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:is.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Dr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Dr=80;function ka(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(fn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(ct(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&kt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function Pr(e,a,r){return Ze(e)?ka(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ka(e,a.filters,r)}function ls(e,a,r,n){return!(!Pr(e,a,r)||r&&!$o(e,a.ptab,n))}function gn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ct(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Uo(i);case"memo":return _o(i);case"signal":{const o=Me(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const Ia={},_n=(Ia==null?void 0:Ia.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Un(){return new Date().toISOString().slice(0,10)}const bn=m.createContext(null);function Ir(){return m.useContext(bn)}function ds(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function Hn(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const i=n.tagName==="A"?n.getAttribute("href"):null;[...n.attributes].forEach(o=>n.removeAttribute(o.name)),i&&/^https?:\/\//i.test(i)&&(n.setAttribute("href",i),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("div,section,p")]){const i=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(i)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Vn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Br(){const e=m.useContext(bn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function cs({token:e,children:a}){const{dispatch:r,st:n,lang:i}=H(),[o,l]=m.useState(()=>n.filters.day||Un()),[d,c]=m.useState(null),[g,s]=m.useState(!1),f=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),p=m.useCallback(()=>{l(Un());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=y=>{var N;const x=(N=y.detail)==null?void 0:N.day;typeof x=="string"&&f(x)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[f]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${_n}/cibles/edition.json?${y}`).then(x=>x.json()).then(x=>{b||c(x)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const v=m.useMemo(()=>`${_n}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),u=m.useMemo(()=>({token:e,day:o,ed:d,loading:g,pickDay:f,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:v,isEn:i==="en"}),[e,o,d,g,f,p,n.filters.day,v,i]);return t.jsx(bn.Provider,{value:u,children:a})}function ps(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Br(),[i,o]=m.useState(()=>n||zr());return m.useEffect(()=>{n&&o(!0)},[n]),m.useEffect(()=>{const l=d=>{var c;return o(!!((c=d.detail)!=null&&c.open))};return window.addEventListener(ya,l),()=>window.removeEventListener(ya,l)},[]),i?t.jsx("div",{className:"thesis-days",children:t.jsx(Ho,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}function us(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Br(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok,g=m.useRef(null),s=m.useMemo(()=>Hn((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),f=m.useMemo(()=>Hn((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return m.useEffect(()=>{const p=g.current;if(!p||!s)return;let v=!1;return Ar(()=>import("./fit-BnaWm7z_.js"),[]).then(async u=>{await u.ensureEditoCss(),!(v||!p.isConnected)&&(u.beautifyEditoRows(p),u.mountCardFits(p))}),()=>{v=!0}},[s]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:Vn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:Vn(e)}),"."]})}),l&&s?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:s}}):null,l&&f?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:f}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const ms=300,sa=7,fs={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},$r={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},xs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ba(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Go(r)&&r!=="media")return"news:"+r;const n=Me(e);return n?"sig:"+(n.theme&&$r.fr[n.theme]?n.theme:"other"):"actualites"}function hs(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:d}=H(),c=Ir(),g=l==="en",[s,f]=m.useState("all"),[p,v]=m.useState(!1),u=m.useMemo(()=>{var ce;const h=(a.filters.day||"").slice(0,10),A=W=>!(!o&&a.continent!=="monde"&&W.continent!==a.continent||h&&(W.date||"").slice(0,10)!==h),B=e.filter(W=>A(W)&&Me(W)&&(!o||W.kind!=="target"||ze(W)!==5)),Y=o&&(((ce=c==null?void 0:c.ed)==null?void 0:ce.ops)||[]).length?c.ed.ops.map(W=>ha(W,l)).filter(W=>!!W).filter(W=>!h||(W.date||"").slice(0,10)===h):[],V=e.filter(W=>A(W)&&W.kind==="op"&&(h?!0:ct(W.date)<=sa)),K=o?Y.length?Y:V.filter(W=>{const re=(d||"").trim().toLowerCase();if(!re)return!1;const ee=W.match||null;return ee?Object.keys(ee).map(Le=>Le.trim().toLowerCase()).includes(re):!1}):V,X=h||new Date().toISOString().slice(0,10),Q=W=>{const re=Ba(W);return re==="ma"?0:re==="levees"?1:2};K.sort((W,re)=>{const ee=Q(W)-Q(re);if(ee)return ee;const Le=(W.date||"").slice(0,10)===X?0:1,je=(re.date||"").slice(0,10)===X?0:1;return Le!==je?Le-je:(re.amountEur||0)-(W.amountEur||0)});const ie=new Set,ae=[];for(const W of[...K,...gn(B,{key:"signal",dir:-1})]){const re=W.id||W.name;!re||ie.has(re)||(ie.add(re),ae.push(W))}return o&&ae.length===0?e.filter(re=>A(re)&&ct(re.date)<=sa).sort((re,ee)=>(ee.date||"").localeCompare(re.date||"")).slice(0,80):ae},[e,a.continent,a.filters.day,o,d,l,c]),b=m.useMemo(()=>{const h={};for(const A of u){const B=Ba(A);h[B]=(h[B]||0)+1}return h},[u]),y=m.useMemo(()=>s==="all"?u:u.filter(h=>Ba(h)===s),[u,s]),x=m.useMemo(()=>y.slice(0,ms),[y]),N=y.length-x.length,S=m.useRef(null);m.useEffect(()=>{var K,X;const h=S.current;if(!h)return;const A=()=>{const Q=h.scrollWidth;Q<200||(h.style.animationDuration=Math.max(18,Math.round(Q/130))+"s")};A();const B=requestAnimationFrame(A),Y=window.setTimeout(A,1200);let V=!0;return(X=(K=document.fonts)==null?void 0:K.ready)==null||X.then(()=>{V&&A()}),()=>{V=!1,cancelAnimationFrame(B),window.clearTimeout(Y)}},[x.length,s]);const k=h=>h==="all"?u.length:b[h]||0,E=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return $r[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const A=h.slice(5);return Wo[A]?Yo(A,g?"en":"fr"):h}return fs[g?"en":"fr"][h]},T=[{k:"all"}],C=["ma","levees"].filter(h=>k(h)>0||h===s);if(C.length){T.push({g:g?"Deals":"Opérations"});for(const h of C)T.push({k:h})}const L=["nominations","recrutements"].filter(h=>k(h)>0||h===s),q=Vo.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>k(h)>0||h===s),D=k("actualites")>0||s==="actualites"?["actualites"]:[];if(L.length||q.length||D.length){T.push({g:g?"News":"Actualités"});for(const h of L)T.push({k:h});for(const h of q)T.push({k:h});for(const h of D)T.push({k:h})}const P=xs.map(h=>"sig:"+h).filter(h=>k(h)>0||h===s);if(P.length){T.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of P)T.push({k:h})}const I=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},j=(()=>{const h=(a.filters.day||"").slice(0,10),A=!o&&a.continent!=="monde"&&i?g?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return h?(g?`LIVE covers the events of ${I(h)}.`:`Le LIVE regroupe les événements du ${I(h)}.`)+A:(g?`LIVE covers the still-open signals and the deals of the last ${sa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${sa} derniers jours.`)+A})(),R=h=>x.map(A=>t.jsxs("button",{type:"button",className:"tk"+(Ie(A)?" spent":""),onClick:B=>{try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(n({type:"focus",id:A.id}),a.dens!=="liste"){const Y=B.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:Y.left+Y.width/2,y:Y.bottom}})}},title:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(Ct,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(wo,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:Ud(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx(Fa,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(A.id||A.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||v(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>v(h=>!h),children:[E(s),t.jsx("b",{children:k(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:j}),T.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===s,onClick:()=>{f(h.k),v(!1)},children:[E(h.k),t.jsx("b",{children:k(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:x.length?t.jsxs("div",{className:"run",ref:S,children:[R(0),R(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(bs,{isEn:g})]})}const gs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function bs({isEn:e}){const[a,r]=m.useState(()=>zr());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(ya,i),()=>window.removeEventListener(ya,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Ko(!a),children:gs})}const vn="+33 6 83 10 72 86",ja="alexandre@proplace.co",_r=`tel:${vn.replace(/[^\d+]/g,"")}`;function vs(){return null}class at extends m.Component{constructor(){super(...arguments);Cn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Ur=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ys(e,a){if((mt(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return Ur.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function ws({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=H(),[d,c]=m.useState(!1),[g,s]=m.useState(""),[f,p]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const v=(e.ceoStatus||"").trim(),u=async b=>{if(g)return;if(b==="Analysé"&&!e.memoUrl){p(!0);return}s(b);const y=await i(e,b);s(""),y&&(c(!1),p(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(b=>!b),p(!1)},children:[v||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:f?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),p(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(c(!1),p(!1))})()},children:a.csAnaAnyway})]}):ys(e,a).map(([b,y])=>t.jsx("button",{type:"button",className:"rsti"+(v===b?" on":"")+(g===b?" busy":""),disabled:!!g,onClick:()=>{u(b)},children:y},b))})]})}function ks({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=H(),[o,l]=m.useState(""),[d,c]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),s=(mt(e)||"").startsWith("CALL")&&ze(e)===3,f=ze(e)>=2,p=async u=>{if(o||u==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(u);const b=await i(e,u);l(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},v=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Ur.filter(([u])=>!(f&&u==="Retenu")).map(([u,b])=>[u,a[b]]);return t.jsxs("div",{className:"csp",onClick:u=>u.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([u,b])=>t.jsx("button",{type:"button",className:"csb"+(g===u?" on":"")+(o===u?" busy":""),disabled:!!o,onClick:()=>{p(u)},children:b},u)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(js,{o:e})]})}function js({o:e}){const{t:a,saveNote:r,flash:n}=H(),[i,o]=m.useState(e.ceoNote||""),[l,d]=m.useState(!1),[c,g]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(l||!s)return;d(!0);const p=await r(e,i.trim());d(!1),p&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:p=>o(p.target.value),onKeyDown:p=>{p.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{f()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Ns({placeholder:e,onDone:a}){const{t:r}=H(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Es({o:e}){var y;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:d}=H(),[c,g]=m.useState(!1);if(!n.pipe||!i||n.lockActions||ze(e)!==4)return null;const s=o(e),f=(s==null?void 0:s.stage)||"todo",p=async x=>{if(c||x===f)return;g(!0);const N=s;l(e,{stage:x,stamps:(s==null?void 0:s.stamps)||{}});const S=Math.max(Date.now(),Wn+=1);Wn=S;const k=await Qo(r,{company:e.name||"",stage:x,cts:S,deal_id:e.airtableId,check_id:e.checkId});g(!1),!k.stale&&(k.ok||(l(e,N),d(a.actErr)))},v=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,u=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,b=f==="sent"&&v&&u>=4;return t.jsxs("div",{className:"stg",onClick:x=>x.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([x,N])=>t.jsx("button",{type:"button",className:"stgb"+(f===x?" on":""),disabled:c,onClick:()=>{p(x)},children:N},x)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(u)})]})}let Wn=0;const la=8,da=360;function Yn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Gn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(Yn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(Yn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function Ss({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=H(),[l,d]=m.useState(0),[c,g]=m.useState(null),[s,f]=m.useState([]),p=m.useRef(!1),v=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),u=m.useRef(!1);m.useEffect(()=>{const C=v.current;return()=>{u.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),m.useEffect(()=>{p.current||(p.current=!0,f(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const b=s[l],y=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const C=b.click,L=window.setTimeout(()=>{const q=document.querySelector(C);q&&q.getAttribute("aria-selected")!=="true"&&q.click()},60);return()=>window.clearTimeout(L)}},[l,b]);const x=m.useRef(-1),N=m.useCallback(()=>{if(!b){g(null);return}const C=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!C){g(null);return}x.current!==l&&(x.current=l,C.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=C.getBoundingClientRect();g(q=>q&&Math.abs(q.top-L.top)<1&&Math.abs(q.left-L.left)<1&&Math.abs(q.width-L.width)<1&&Math.abs(q.height-L.height)<1?q:L)},[b,l]);m.useLayoutEffect(()=>{N();const C=[90,300,700,1300].map(q=>window.setTimeout(N,q)),L=()=>N();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{C.forEach(q=>window.clearTimeout(q)),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[N]);const S=m.useRef(a);if(S.current=a,m.useEffect(()=>{const C=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),S.current()):L.key==="ArrowRight"?d(q=>q+1):L.key==="ArrowLeft"&&d(q=>Math.max(0,q-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!s.length)return null;let k=null;const E=C=>()=>{u.current=!0,n({type:"modal",modal:null}),C()};if(y){const C=i[3]||0;C>0?k={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:E(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?k={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:E(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?k={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:E(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:E(()=>{n({type:"modal",modal:"crit"}),a()})}}let T={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:da};if(!y&&c){const C=c.bottom+14,q=window.innerHeight-C>190?C:Math.max(12,c.top-200);T={left:Math.min(Math.max(12,c.left+c.width/2-da/2),window.innerWidth-da-12),top:q,width:da}}return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-la,top:c.top-la,width:c.width+la*2,height:c.height+la*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:T,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Gn,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Gn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(C=>C+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Hr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Vr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Cs(){var L,q;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:d,dispatch:c}=H(),g=r?a:e,s=m.useMemo(()=>g.filter(D=>ct(D.date)===0&&D.kind==="target"),[g]),f=m.useMemo(()=>r?a.filter(D=>D.kind==="target"&&ze(D)===0).slice().sort((D,P)=>(P.date||"").localeCompare(D.date||"")):[],[a,r]),p=m.useMemo(()=>s.filter(D=>r?ze(D)===0:!Ie(D)),[s,r]),v=r?f:p,u=r?a.length-f.length:s.length-p.length,b=r?a.length:s.length,y=b?Math.min(100,u/b*100):100,x=m.useMemo(()=>Hr(g),[g]),N=!!x&&ct(x)>0,S=m.useMemo(()=>N?g.filter(D=>(D.date||"").slice(0,10)===x):[],[g,x,N]),k=typeof((L=d.stats)==null?void 0:L.kept_today)=="number"?d.stats.kept_today:null,E=typeof((q=d.stats)==null?void 0:q.screened_today)=="number"?d.stats.screened_today:s.length;let T;N?T=i.morningLast(S.length,f.length,Vr(x,l)):r?T=i.morningThesis(E,f.length,k):s.length?u===0?T=i.goalSourced(s.length):u>=s.length?T=i.goalCleared:T=i.goalDone(u,s.length):T=i.goalSourced(0);const C=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&f.length&&c({type:"chainStart",queue:f.map(D=>D.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:T}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),v.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?i.morningEval(v.length):o.pileMode?i.goalContinue(v.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function zs(){var B,Y;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:g,startTour:s,flash:f,flashErr:p}=H(),[v,u]=m.useState(null),[b,y]=m.useState(!0),[x,N]=m.useState([]),S=c==="client";m.useEffect(()=>{if(!i||!o)return;let V=!0;return y(!0),(async()=>{const[K,X]=await Promise.all([xn(o),Tr(i)]);V&&(K&&u(K),y(!1),N(X))})(),()=>{V=!1}},[i,o]);const[k,E]=m.useState(!1),T=()=>{!S||k||!o||(E(!0),Jo(o).then(V=>{E(!1),V?f(e.identRepubDone):p(e.actErr)}))},C=(v==null?void 0:v.per_day)??null,L=((B=v==null?void 0:v.pool_order)==null?void 0:B.length)??0,q=x.filter(V=>V.status==="running").length,D=m.useMemo(()=>d.filter(V=>V.kind==="target"&&Ie(V)).length,[d]),P=l.marketEstimate,I=typeof((Y=l.stats)==null?void 0:Y.screened)=="number"?l.stats.screened:D,j=P&&P>0?Math.min(100,Math.round(I/P*100)):null,R=V=>V.toLocaleString(a==="en"?"en-US":"fr-FR"),h=(o||"P").split(/\s+/).map(V=>V[0]).join("").slice(0,2).toUpperCase(),A=(()=>{const V=Date.parse(l.generatedAt||"");if(Number.isNaN(V))return"";const K=new Date(V),X=Q=>String(Q).padStart(2,"0");return`${X(K.getDate())}/${X(K.getMonth()+1)} à ${X(K.getHours())}:${X(K.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),A?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(A)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[j===null&&I>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(I)})})]}),j!==null&&P&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:j+"%"}})}),t.jsxs("b",{children:[j," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(I,P)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),C===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),q>0&&t.jsxs("span",{className:"ev",children:["⏳ ",q]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:V=>{V.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!S||k,onClick:T,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!S,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:V=>n({type:"filters",patch:{search:V.target.value}})})]})]})]})}class Nt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,d=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*As(e){for(const a of e)yield*a}function Wr(e){return Array.from(As(e))}var ke=1e-6,ue=Math.PI,Ye=ue/2,Kn=ue/4,Ke=ue*2,lt=180/ue,_e=ue/180,Ce=Math.abs,Ts=Math.atan,Jt=Math.atan2,Ae=Math.cos,Te=Math.sin,qs=Math.sign||function(e){return e>0?1:e<0?-1:0},zt=Math.sqrt;function Ls(e){return e>1?0:e<-1?ue:Math.acos(e)}function Xt(e){return e>1?Ye:e<-1?-Ye:Math.asin(e)}function Ge(){}function Na(e,a){e&&Jn.hasOwnProperty(e.type)&&Jn[e.type](e,a)}var Qn={Feature:function(e,a){Na(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Na(r[n].geometry,a)}},Jn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Ja(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Ja(r[n],a,0)},Polygon:function(e,a){Xn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Xn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Na(r[n],a)}};function Ja(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Xn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Ja(e[r],a,1);a.polygonEnd()}function Lt(e,a){e&&Qn.hasOwnProperty(e.type)?Qn[e.type](e,a):Na(e,a)}function Xa(e){return[Jt(e[1],e[0]),Xt(e[2])]}function Ot(e){var a=e[0],r=e[1],n=Ae(r);return[n*Ae(a),n*Te(a),Te(r)]}function ca(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ea(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function $a(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function pa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Za(e){var a=zt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function en(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function tn(e,a){return Ce(e)>ue&&(e-=Math.round(e/Ke)*Ke),[e,a]}tn.invert=tn;function Fs(e,a,r){return(e%=Ke)?a||r?en(er(e),tr(a,r)):er(e):a||r?tr(a,r):tn}function Zn(e){return function(a,r){return a+=e,Ce(a)>ue&&(a-=Math.round(a/Ke)*Ke),[a,r]}}function er(e){var a=Zn(e);return a.invert=Zn(-e),a}function tr(e,a){var r=Ae(e),n=Te(e),i=Ae(a),o=Te(a);function l(d,c){var g=Ae(c),s=Ae(d)*g,f=Te(d)*g,p=Te(c),v=p*r+s*n;return[Jt(f*i-v*o,s*r-p*n),Xt(v*i+f*o)]}return l.invert=function(d,c){var g=Ae(c),s=Ae(d)*g,f=Te(d)*g,p=Te(c),v=p*i-f*o;return[Jt(f*i+p*o,s*r+v*n),Xt(v*r-s*n)]},l}function Rs(e,a,r,n,i,o){if(r){var l=Ae(a),d=Te(a),c=n*r;i==null?(i=a+n*Ke,o=a-c/2):(i=ar(l,i),o=ar(l,o),(n>0?i<o:i>o)&&(i+=n*Ke));for(var g,s=i;n>0?s>o:s<o;s-=c)g=Xa([l,-d*Ae(s),-d*Te(s)]),e.point(g[0],g[1])}}function ar(e,a){a=Ot(a),a[0]-=e,Za(a);var r=Ls(-a[1]);return((-a[2]<0?-r:r)+Ke-ke)%Ke}function Yr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ge,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ga(e,a){return Ce(e[0]-a[0])<ke&&Ce(e[1]-a[1])<ke}function ua(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Gr(e,a,r,n,i){var o=[],l=[],d,c;if(e.forEach(function(u){if(!((b=u.length-1)<=0)){var b,y=u[0],x=u[b],N;if(ga(y,x)){if(!y[2]&&!x[2]){for(i.lineStart(),d=0;d<b;++d)i.point((y=u[d])[0],y[1]);i.lineEnd();return}x[0]+=2*ke}o.push(N=new ua(y,u,null,!0)),l.push(N.o=new ua(y,null,N,!1)),o.push(N=new ua(x,u,null,!1)),l.push(N.o=new ua(x,null,N,!0))}}),!!o.length){for(l.sort(a),nr(o),nr(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var g=o[0],s,f;;){for(var p=g,v=!0;p.v;)if((p=p.n)===g)return;s=p.z,i.lineStart();do{if(p.v=p.o.v=!0,p.e){if(v)for(d=0,c=s.length;d<c;++d)i.point((f=s[d])[0],f[1]);else n(p.x,p.n.x,1,i);p=p.n}else{if(v)for(s=p.p.z,d=s.length-1;d>=0;--d)i.point((f=s[d])[0],f[1]);else n(p.x,p.p.x,-1,i);p=p.p}p=p.o,s=p.z,v=!v}while(!p.v);i.lineEnd()}}}function nr(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function _a(e){return Ce(e[0])<=ue?e[0]:qs(e[0])*((Ce(e[0])+ue)%Ke-ue)}function Ms(e,a){var r=_a(a),n=a[1],i=Te(n),o=[Te(r),-Ae(r),0],l=0,d=0,c=new Nt;i===1?n=Ye+ke:i===-1&&(n=-Ye-ke);for(var g=0,s=e.length;g<s;++g)if(p=(f=e[g]).length)for(var f,p,v=f[p-1],u=_a(v),b=v[1]/2+Kn,y=Te(b),x=Ae(b),N=0;N<p;++N,u=k,y=T,x=C,v=S){var S=f[N],k=_a(S),E=S[1]/2+Kn,T=Te(E),C=Ae(E),L=k-u,q=L>=0?1:-1,D=q*L,P=D>ue,I=y*T;if(c.add(Jt(I*q*Te(D),x*C+I*Ae(D))),l+=P?L+q*Ke:L,P^u>=r^k>=r){var j=Ea(Ot(v),Ot(S));Za(j);var R=Ea(o,j);Za(R);var h=(P^L>=0?-1:1)*Xt(R[2]);(n>h||n===h&&(j[0]||j[1]))&&(d+=P^L>=0?1:-1)}}return(l<-ke||l<ke&&c<-1e-12)^d&1}function Kr(e,a,r,n){return function(i){var o=a(i),l=Yr(),d=a(l),c=!1,g,s,f,p={point:v,lineStart:b,lineEnd:y,polygonStart:function(){p.point=x,p.lineStart=N,p.lineEnd=S,s=[],g=[]},polygonEnd:function(){p.point=v,p.lineStart=b,p.lineEnd=y,s=Wr(s);var k=Ms(g,n);s.length?(c||(i.polygonStart(),c=!0),Gr(s,Ds,k,r,i)):k&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),s=g=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function v(k,E){e(k,E)&&i.point(k,E)}function u(k,E){o.point(k,E)}function b(){p.point=u,o.lineStart()}function y(){p.point=v,o.lineEnd()}function x(k,E){f.push([k,E]),d.point(k,E)}function N(){d.lineStart(),f=[]}function S(){x(f[0][0],f[0][1]),d.lineEnd();var k=d.clean(),E=l.result(),T,C=E.length,L,q,D;if(f.pop(),g.push(f),f=null,!!C){if(k&1){if(q=E[0],(L=q.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),T=0;T<L;++T)i.point((D=q[T])[0],D[1]);i.lineEnd()}return}C>1&&k&2&&E.push(E.pop().concat(E.shift())),s.push(E.filter(Os))}}return p}}function Os(e){return e.length>1}function Ds(e,a){return((e=e.x)[0]<0?e[1]-Ye-ke:Ye-e[1])-((a=a.x)[0]<0?a[1]-Ye-ke:Ye-a[1])}const rr=Kr(function(){return!0},Ps,Bs,[-ue,-Ye]);function Ps(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var d=o>0?ue:-ue,c=Ce(o-a);Ce(c-ue)<ke?(e.point(a,r=(r+l)/2>0?Ye:-Ye),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(o,r),i=0):n!==d&&c>=ue&&(Ce(a-n)<ke&&(a-=n*ke),Ce(o-d)<ke&&(o-=d*ke),r=Is(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),i=0),e.point(a=o,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Is(e,a,r,n){var i,o,l=Te(e-r);return Ce(l)>ke?Ts((Te(a)*(o=Ae(n))*Te(r)-Te(n)*(i=Ae(a))*Te(e))/(i*o*l)):(a+n)/2}function Bs(e,a,r,n){var i;if(e==null)i=r*Ye,n.point(-ue,i),n.point(0,i),n.point(ue,i),n.point(ue,0),n.point(ue,-i),n.point(0,-i),n.point(-ue,-i),n.point(-ue,0),n.point(-ue,i);else if(Ce(e[0]-a[0])>ke){var o=e[0]<a[0]?ue:-ue;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function $s(e){var a=Ae(e),r=2*_e,n=a>0,i=Ce(a)>ke;function o(s,f,p,v){Rs(v,e,r,p,s,f)}function l(s,f){return Ae(s)*Ae(f)>a}function d(s){var f,p,v,u,b;return{lineStart:function(){u=v=!1,b=1},point:function(y,x){var N=[y,x],S,k=l(y,x),E=n?k?0:g(y,x):k?g(y+(y<0?ue:-ue),x):0;if(!f&&(u=v=k)&&s.lineStart(),k!==v&&(S=c(f,N),(!S||ga(f,S)||ga(N,S))&&(N[2]=1)),k!==v)b=0,k?(s.lineStart(),S=c(N,f),s.point(S[0],S[1])):(S=c(f,N),s.point(S[0],S[1],2),s.lineEnd()),f=S;else if(i&&f&&n^k){var T;!(E&p)&&(T=c(N,f,!0))&&(b=0,n?(s.lineStart(),s.point(T[0][0],T[0][1]),s.point(T[1][0],T[1][1]),s.lineEnd()):(s.point(T[1][0],T[1][1]),s.lineEnd(),s.lineStart(),s.point(T[0][0],T[0][1],3)))}k&&(!f||!ga(f,N))&&s.point(N[0],N[1]),f=N,v=k,p=E},lineEnd:function(){v&&s.lineEnd(),f=null},clean:function(){return b|(u&&v)<<1}}}function c(s,f,p){var v=Ot(s),u=Ot(f),b=[1,0,0],y=Ea(v,u),x=ca(y,y),N=y[0],S=x-N*N;if(!S)return!p&&s;var k=a*x/S,E=-a*N/S,T=Ea(b,y),C=pa(b,k),L=pa(y,E);$a(C,L);var q=T,D=ca(C,q),P=ca(q,q),I=D*D-P*(ca(C,C)-1);if(!(I<0)){var j=zt(I),R=pa(q,(-D-j)/P);if($a(R,C),R=Xa(R),!p)return R;var h=s[0],A=f[0],B=s[1],Y=f[1],V;A<h&&(V=h,h=A,A=V);var K=A-h,X=Ce(K-ue)<ke,Q=X||K<ke;if(!X&&Y<B&&(V=B,B=Y,Y=V),Q?X?B+Y>0^R[1]<(Ce(R[0]-h)<ke?B:Y):B<=R[1]&&R[1]<=Y:K>ue^(h<=R[0]&&R[0]<=A)){var ie=pa(q,(-D+j)/P);return $a(ie,C),[R,Xa(ie)]}}}function g(s,f){var p=n?e:ue-e,v=0;return s<-p?v|=1:s>p&&(v|=2),f<-p?v|=4:f>p&&(v|=8),v}return Kr(l,d,o,n?[0,-e]:[-ue,e-ue])}function _s(e,a,r,n,i,o){var l=e[0],d=e[1],c=a[0],g=a[1],s=0,f=1,p=c-l,v=g-d,u;if(u=r-l,!(!p&&u>0)){if(u/=p,p<0){if(u<s)return;u<f&&(f=u)}else if(p>0){if(u>f)return;u>s&&(s=u)}if(u=i-l,!(!p&&u<0)){if(u/=p,p<0){if(u>f)return;u>s&&(s=u)}else if(p>0){if(u<s)return;u<f&&(f=u)}if(u=n-d,!(!v&&u>0)){if(u/=v,v<0){if(u<s)return;u<f&&(f=u)}else if(v>0){if(u>f)return;u>s&&(s=u)}if(u=o-d,!(!v&&u<0)){if(u/=v,v<0){if(u>f)return;u>s&&(s=u)}else if(v>0){if(u<s)return;u<f&&(f=u)}return s>0&&(e[0]=l+s*p,e[1]=d+s*v),f<1&&(a[0]=l+f*p,a[1]=d+f*v),!0}}}}}var Ht=1e9,ma=-Ht;function Us(e,a,r,n){function i(g,s){return e<=g&&g<=r&&a<=s&&s<=n}function o(g,s,f,p){var v=0,u=0;if(g==null||(v=l(g,f))!==(u=l(s,f))||c(g,s)<0^f>0)do p.point(v===0||v===3?e:r,v>1?n:a);while((v=(v+f+4)%4)!==u);else p.point(s[0],s[1])}function l(g,s){return Ce(g[0]-e)<ke?s>0?0:3:Ce(g[0]-r)<ke?s>0?2:1:Ce(g[1]-a)<ke?s>0?1:0:s>0?3:2}function d(g,s){return c(g.x,s.x)}function c(g,s){var f=l(g,1),p=l(s,1);return f!==p?f-p:f===0?s[1]-g[1]:f===1?g[0]-s[0]:f===2?g[1]-s[1]:s[0]-g[0]}return function(g){var s=g,f=Yr(),p,v,u,b,y,x,N,S,k,E,T,C={point:L,lineStart:I,lineEnd:j,polygonStart:D,polygonEnd:P};function L(h,A){i(h,A)&&s.point(h,A)}function q(){for(var h=0,A=0,B=v.length;A<B;++A)for(var Y=v[A],V=1,K=Y.length,X=Y[0],Q,ie,ae=X[0],ce=X[1];V<K;++V)Q=ae,ie=ce,X=Y[V],ae=X[0],ce=X[1],ie<=n?ce>n&&(ae-Q)*(n-ie)>(ce-ie)*(e-Q)&&++h:ce<=n&&(ae-Q)*(n-ie)<(ce-ie)*(e-Q)&&--h;return h}function D(){s=f,p=[],v=[],T=!0}function P(){var h=q(),A=T&&h,B=(p=Wr(p)).length;(A||B)&&(g.polygonStart(),A&&(g.lineStart(),o(null,null,1,g),g.lineEnd()),B&&Gr(p,d,h,o,g),g.polygonEnd()),s=g,p=v=u=null}function I(){C.point=R,v&&v.push(u=[]),E=!0,k=!1,N=S=NaN}function j(){p&&(R(b,y),x&&k&&f.rejoin(),p.push(f.result())),C.point=L,k&&s.lineEnd()}function R(h,A){var B=i(h,A);if(v&&u.push([h,A]),E)b=h,y=A,x=B,E=!1,B&&(s.lineStart(),s.point(h,A));else if(B&&k)s.point(h,A);else{var Y=[N=Math.max(ma,Math.min(Ht,N)),S=Math.max(ma,Math.min(Ht,S))],V=[h=Math.max(ma,Math.min(Ht,h)),A=Math.max(ma,Math.min(Ht,A))];_s(Y,V,e,a,r,n)?(k||(s.lineStart(),s.point(Y[0],Y[1])),s.point(V[0],V[1]),B||s.lineEnd(),T=!1):B&&(s.lineStart(),s.point(h,A),T=!1)}N=h,S=A,k=B}return C}}const an=e=>e;var Ua=new Nt,nn=new Nt,Qr,Jr,rn,on,dt={point:Ge,lineStart:Ge,lineEnd:Ge,polygonStart:function(){dt.lineStart=Hs,dt.lineEnd=Ws},polygonEnd:function(){dt.lineStart=dt.lineEnd=dt.point=Ge,Ua.add(Ce(nn)),nn=new Nt},result:function(){var e=Ua/2;return Ua=new Nt,e}};function Hs(){dt.point=Vs}function Vs(e,a){dt.point=Xr,Qr=rn=e,Jr=on=a}function Xr(e,a){nn.add(on*e-rn*a),rn=e,on=a}function Ws(){Xr(Qr,Jr)}var Dt=1/0,Sa=Dt,Zt=-Dt,Ca=Zt,za={point:Ys,lineStart:Ge,lineEnd:Ge,polygonStart:Ge,polygonEnd:Ge,result:function(){var e=[[Dt,Sa],[Zt,Ca]];return Zt=Ca=-(Sa=Dt=1/0),e}};function Ys(e,a){e<Dt&&(Dt=e),e>Zt&&(Zt=e),a<Sa&&(Sa=a),a>Ca&&(Ca=a)}var sn=0,ln=0,Vt=0,Aa=0,Ta=0,Ft=0,dn=0,cn=0,Wt=0,Zr,eo,ot,it,We={point:Et,lineStart:or,lineEnd:ir,polygonStart:function(){We.lineStart=Qs,We.lineEnd=Js},polygonEnd:function(){We.point=Et,We.lineStart=or,We.lineEnd=ir},result:function(){var e=Wt?[dn/Wt,cn/Wt]:Ft?[Aa/Ft,Ta/Ft]:Vt?[sn/Vt,ln/Vt]:[NaN,NaN];return sn=ln=Vt=Aa=Ta=Ft=dn=cn=Wt=0,e}};function Et(e,a){sn+=e,ln+=a,++Vt}function or(){We.point=Gs}function Gs(e,a){We.point=Ks,Et(ot=e,it=a)}function Ks(e,a){var r=e-ot,n=a-it,i=zt(r*r+n*n);Aa+=i*(ot+e)/2,Ta+=i*(it+a)/2,Ft+=i,Et(ot=e,it=a)}function ir(){We.point=Et}function Qs(){We.point=Xs}function Js(){to(Zr,eo)}function Xs(e,a){We.point=to,Et(Zr=ot=e,eo=it=a)}function to(e,a){var r=e-ot,n=a-it,i=zt(r*r+n*n);Aa+=i*(ot+e)/2,Ta+=i*(it+a)/2,Ft+=i,i=it*e-ot*a,dn+=i*(ot+e),cn+=i*(it+a),Wt+=i*3,Et(ot=e,it=a)}function ao(e){this._context=e}ao.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Ke);break}}},result:Ge};var pn=new Nt,Ha,no,ro,Yt,Gt,ea={point:Ge,lineStart:function(){ea.point=Zs},lineEnd:function(){Ha&&oo(no,ro),ea.point=Ge},polygonStart:function(){Ha=!0},polygonEnd:function(){Ha=null},result:function(){var e=+pn;return pn=new Nt,e}};function Zs(e,a){ea.point=oo,no=Yt=e,ro=Gt=a}function oo(e,a){Yt-=e,Gt-=a,pn.add(zt(Yt*Yt+Gt*Gt)),Yt=e,Gt=a}let sr,qa,lr,dr;class cr{constructor(a){this._append=a==null?io:el(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==lr||this._append!==qa){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,lr=n,qa=this._append,dr=this._,this._=i}this._+=dr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function io(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function el(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return io;if(a!==sr){const r=10**a;sr=a,qa=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return qa}function tl(e,a){let r=3,n=4.5,i,o;function l(d){return d&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Lt(d,i(o))),o.result()}return l.area=function(d){return Lt(d,i(dt)),dt.result()},l.measure=function(d){return Lt(d,i(ea)),ea.result()},l.bounds=function(d){return Lt(d,i(za)),za.result()},l.centroid=function(d){return Lt(d,i(We)),We.result()},l.projection=function(d){return arguments.length?(i=d==null?(e=null,an):(e=d).stream,l):e},l.context=function(d){return arguments.length?(o=d==null?(a=null,new cr(r)):new ao(a=d),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(o.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(o=new cr(r)),l},l.projection(e).digits(r).context(a)}function yn(e){return function(a){var r=new un;for(var n in e)r[n]=e[n];return r.stream=a,r}}function un(){}un.prototype={constructor:un,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function wn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Lt(r,e.stream(za)),a(za.result()),n!=null&&e.clipExtent(n),e}function so(e,a,r){return wn(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),d=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function al(e,a,r){return so(e,[[0,0],a],r)}function nl(e,a,r){return wn(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,d=-o*n[0][1];e.scale(150*o).translate([l,d])},r)}function rl(e,a,r){return wn(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],d=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,d])},r)}var pr=16,ol=Ae(30*_e);function ur(e,a){return+a?sl(e,a):il(e)}function il(e){return yn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function sl(e,a){function r(n,i,o,l,d,c,g,s,f,p,v,u,b,y){var x=g-n,N=s-i,S=x*x+N*N;if(S>4*a&&b--){var k=l+p,E=d+v,T=c+u,C=zt(k*k+E*E+T*T),L=Xt(T/=C),q=Ce(Ce(T)-1)<ke||Ce(o-f)<ke?(o+f)/2:Jt(E,k),D=e(q,L),P=D[0],I=D[1],j=P-n,R=I-i,h=N*j-x*R;(h*h/S>a||Ce((x*j+N*R)/S-.5)>.3||l*p+d*v+c*u<ol)&&(r(n,i,o,l,d,c,P,I,q,k/=C,E/=C,T,b,y),y.point(P,I),r(P,I,q,k,E,T,g,s,f,p,v,u,b,y))}}return function(n){var i,o,l,d,c,g,s,f,p,v,u,b,y={point:x,lineStart:N,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=E},polygonEnd:function(){n.polygonEnd(),y.lineStart=N}};function x(L,q){L=e(L,q),n.point(L[0],L[1])}function N(){f=NaN,y.point=S,n.lineStart()}function S(L,q){var D=Ot([L,q]),P=e(L,q);r(f,p,s,v,u,b,f=P[0],p=P[1],s=L,v=D[0],u=D[1],b=D[2],pr,n),n.point(f,p)}function k(){y.point=x,n.lineEnd()}function E(){N(),y.point=T,y.lineEnd=C}function T(L,q){S(i=L,q),o=f,l=p,d=v,c=u,g=b,y.point=S}function C(){r(f,p,s,v,u,b,o,l,i,d,c,g,pr,n),y.lineEnd=k,k()}return y}}var ll=yn({point:function(e,a){this.stream.point(e*_e,a*_e)}});function dl(e){return yn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function cl(e,a,r,n,i){function o(l,d){return l*=n,d*=i,[a+e*l,r-e*d]}return o.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*i]},o}function mr(e,a,r,n,i,o){if(!o)return cl(e,a,r,n,i);var l=Ae(o),d=Te(o),c=l*e,g=d*e,s=l/e,f=d/e,p=(d*r-l*a)/e,v=(d*a+l*r)/e;function u(b,y){return b*=n,y*=i,[c*b-g*y+a,r-g*b-c*y]}return u.invert=function(b,y){return[n*(s*b-f*y+p),i*(v-f*b-s*y)]},u}function pl(e){return ul(function(){return e})()}function ul(e){var a,r=150,n=480,i=250,o=0,l=0,d=0,c=0,g=0,s,f=0,p=1,v=1,u=null,b=rr,y=null,x,N,S,k=an,E=.5,T,C,L,q,D;function P(h){return L(h[0]*_e,h[1]*_e)}function I(h){return h=L.invert(h[0],h[1]),h&&[h[0]*lt,h[1]*lt]}P.stream=function(h){return q&&D===h?q:q=ll(dl(s)(b(T(k(D=h)))))},P.preclip=function(h){return arguments.length?(b=h,u=void 0,R()):b},P.postclip=function(h){return arguments.length?(k=h,y=x=N=S=null,R()):k},P.clipAngle=function(h){return arguments.length?(b=+h?$s(u=h*_e):(u=null,rr),R()):u*lt},P.clipExtent=function(h){return arguments.length?(k=h==null?(y=x=N=S=null,an):Us(y=+h[0][0],x=+h[0][1],N=+h[1][0],S=+h[1][1]),R()):y==null?null:[[y,x],[N,S]]},P.scale=function(h){return arguments.length?(r=+h,j()):r},P.translate=function(h){return arguments.length?(n=+h[0],i=+h[1],j()):[n,i]},P.center=function(h){return arguments.length?(o=h[0]%360*_e,l=h[1]%360*_e,j()):[o*lt,l*lt]},P.rotate=function(h){return arguments.length?(d=h[0]%360*_e,c=h[1]%360*_e,g=h.length>2?h[2]%360*_e:0,j()):[d*lt,c*lt,g*lt]},P.angle=function(h){return arguments.length?(f=h%360*_e,j()):f*lt},P.reflectX=function(h){return arguments.length?(p=h?-1:1,j()):p<0},P.reflectY=function(h){return arguments.length?(v=h?-1:1,j()):v<0},P.precision=function(h){return arguments.length?(T=ur(C,E=h*h),R()):zt(E)},P.fitExtent=function(h,A){return so(P,h,A)},P.fitSize=function(h,A){return al(P,h,A)},P.fitWidth=function(h,A){return nl(P,h,A)},P.fitHeight=function(h,A){return rl(P,h,A)};function j(){var h=mr(r,0,0,p,v,f).apply(null,a(o,l)),A=mr(r,n-h[0],i-h[1],p,v,f);return s=Fs(d,c,g),C=en(a,A),L=en(s,C),T=ur(C,E),R()}function R(){return q=D=null,P}return function(){return a=e.apply(this,arguments),P.invert=a.invert&&I,j()}}function lo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}lo.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(Ce(i)>ke&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ml(){return pl(lo).scale(175.295)}function fl(e){return e}function xl(e){if(e==null)return fl;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var g=2,s=d.length,f=new Array(s);for(f[0]=(a+=d[0])*n+o,f[1]=(r+=d[1])*i+l;g<s;)f[g]=d[g],++g;return f}}function hl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function gl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return fr(e,r)})}:fr(e,a)}function fr(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=bl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function bl(e,a){var r=xl(e.transform),n=e.arcs;function i(s,f){f.length&&f.pop();for(var p=n[s<0?~s:s],v=0,u=p.length;v<u;++v)f.push(r(p[v],v));s<0&&hl(f,u)}function o(s){return r(s)}function l(s){for(var f=[],p=0,v=s.length;p<v;++p)i(s[p],f);return f.length<2&&f.push(f[0]),f}function d(s){for(var f=l(s);f.length<4;)f.push(f[0]);return f}function c(s){return s.map(d)}function g(s){var f=s.type,p;switch(f){case"GeometryCollection":return{type:f,geometries:s.geometries.map(g)};case"Point":p=o(s.coordinates);break;case"MultiPoint":p=s.coordinates.map(o);break;case"LineString":p=l(s.arcs);break;case"MultiLineString":p=s.arcs.map(l);break;case"Polygon":p=c(s.arcs);break;case"MultiPolygon":p=s.arcs.map(c);break;default:return null}return{type:f,coordinates:p}}return g(a)}const co={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},vl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function yl(e,a,r){const n=co[e];if(!n||!n.length)return-1;const i=vl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let fa=null;function wl(){return fa||(fa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=gl(r,n),o=ml().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=tl(o),d=(i.features||[]).filter(s=>{var f;return(((f=s.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(s=>{var v;const f=((v=s.properties)==null?void 0:v.name)||"",p=l(s)||"";return p?{i2:Xo(f)||null,n:f,d:p}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,f]of Object.entries(Zo)){const p=o(f);p&&(c[s]={x:p[0],y:p[1]})}const g={};for(const[s,f]of Object.entries(co)){const p=f.map(v=>o(v.ll)).filter(v=>!!v).map(([v,u])=>({x:v,y:u}));p.length&&(g[s]=p)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:d,anchors:c,metros:g}}catch{return null}})(),fa)}function kl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return wl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const jl="8 40 984 210",Nl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},xr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function hr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function El(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var g;if(!i)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function gr({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Sl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:d,t:c,data:g,dossiers:s,source:f}=H(),p=g.loading&&!s.length,v=m.useRef(null),u=m.useRef(null),b=kl(e.continent==="monde"),y=e.continent==="monde"?b:hn.find(h=>h.key===e.continent)||null,x=El(v,e.continent+":"+e.mapFolded+":"+!!y),[N,S]=m.useState(new Map),[k,E]=m.useState(null);m.useEffect(()=>{const h=v.current;if(!h)return;const A=new Map;h.querySelectorAll("path[data-i2]").forEach(B=>{const Y=B.dataset.i2;if(Y)try{const V=B.getBBox();V.width>0&&A.set(Y,{x:V.x,y:V.y,w:V.width,h:V.height})}catch{}}),S(A)},[e.continent,x,y]);const T=m.useMemo(()=>r.filter(h=>h.cc),[r]),C=m.useMemo(()=>{const h=new Map;return T.forEach(A=>h.set(A.cc,(h.get(A.cc)||0)+1)),h},[T]),L=e.continent==="monde"&&b?b.anchors:null,q=e.continent==="monde"&&b?b.metros:null,D=m.useMemo(()=>T.map(h=>{const A=hr(h.name||h.id||""),B=hr((h.id||h.name||"")+"·y");if(L&&h.cc){const Q=q?q[h.cc]:void 0;if(Q&&Q.length){const ae=yl(h.cc,h.city,A);if(ae>=0&&Q[ae])return{d:h,x:Q[ae].x+(A-.5)*5,y:Q[ae].y+(B-.5)*5}}const ie=L[h.cc];if(ie)return{d:h,x:ie.x+(A-.5)*10,y:ie.y+(B-.5)*10}}const Y=h.cc?N.get(h.cc):void 0;if(!Y)return null;const V=Nl[`${e.continent}:${h.cc||""}`];if(V)return{d:h,x:Y.x+Y.w*(V.fx+(A-.5)*V.sx),y:Y.y+Y.h*(V.fy+(B-.5)*V.sy)};const K=(A-.5)*Math.min(Y.w*.55,60),X=(B-.5)*Math.min(Y.h*.55,60);return{d:h,x:Y.x+Y.w/2+K,y:Y.y+Y.h/2+X}}).filter(h=>!!h),[T,N,L,q,e.continent]),P=h=>x>0?h/x:h,I=m.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:xr[h],fr:c.plabels[h].toUpperCase(),en:c.plabels[h].toUpperCase(),n:r.filter(A=>A.kind==="target"&&ze(A)===h).length})).filter(h=>h.n>0):Fn.map((h,A)=>({...h,n:r.filter(B=>Rn(B)===A).length})),[r,n,c.plabels]),j=o?l.get(o):null,R=j?D.find(h=>h.d.id===j.id):null;return y?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:[p&&t.jsx(gr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:v,viewBox:f==="ops"&&e.continent==="monde"?jl:y.viewBox,preserveAspectRatio:f==="ops"&&e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{E(null),i(null)},children:[t.jsx("g",{children:y.countries.map((h,A)=>t.jsx("g",{className:"ct"+(h.i2&&C.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},A))}),t.jsx("g",{children:D.map(h=>{const A=Fn[Rn(h.d)],B=!!Me(h.d),Y=h.d.kind==="target",V=n&&Y?xr[ze(h.d)]:A.c,K=!n&&Ie(h.d);return t.jsxs("g",{className:"co"+(K?" done":""),onMouseEnter:()=>{var ie,ae;const X=(ie=u.current)==null?void 0:ie.getBoundingClientRect(),Q=(ae=v.current)==null?void 0:ae.createSVGPoint();if(Q&&v.current&&X){Q.x=h.x,Q.y=h.y;const ce=Q.matrixTransform(v.current.getScreenCTM());E({x:ce.x-X.left,y:ce.y-X.top,label:h.d.name+" · "+(It(h.d.cc,d)||h.d.countryLabel||"")})}i(h.d.id)},onMouseLeave:()=>{E(null),i(null)},onClick:()=>{var ie;if(f==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const X=(ie=v.current)==null?void 0:ie.createSVGPoint();let Q=null;if(X&&v.current){X.x=h.x,X.y=h.y;const ae=X.matrixTransform(v.current.getScreenCTM());Q={x:ae.x,y:ae.y}}a({type:"popup",id:h.d.id,anchor:Q})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:P(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:P(A.px),fill:V,stroke:B?"#DC2626":"#ffffff",strokeWidth:P(B?2.2:1.3)})]},h.d.id||h.d.name)})}),R&&t.jsx("circle",{className:"ring on",cx:R.x,cy:R.y,r:P(13),fill:"none",stroke:"#0F172A",strokeWidth:P(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:I.map((h,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),d==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},A))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:t.jsx(gr,{msgs:c.loadMsgs})})}function Cl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function po({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:d}=H(),c=a.filters,[g,s]=m.useState(!1),[f,p]=m.useState(!1),v=m.useRef(null),u=m.useRef(null),b=m.useMemo(()=>a.continent==="monde"?n:n.filter(j=>j.continent===a.continent),[n,a.continent]),y=j=>b.filter(R=>j!=="country"&&c.country.length&&!c.country.includes(R.cc||"")?!1:ka(R,c,o,j==="country"?void 0:j)),x=m.useMemo(()=>{const j=y("win"),R=h=>j.filter(A=>(A.date?Math.max(0,Math.floor((Date.now()-Date.parse(A.date))/864e5)):9999)<=h).length;return[R(0),R(7),R(30),j.length]},[b,c,o]),N=m.useMemo(()=>c.day?y("win").filter(j=>(j.date||"").slice(0,10)===c.day).length:0,[b,c,o]),S=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,k=S+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!g&&!f)return;const j=h=>{var B,Y;const A=h.target;g&&!((B=v.current)!=null&&B.contains(A))&&s(!1),f&&!((Y=u.current)!=null&&Y.contains(A))&&p(!1)},R=h=>{h.key==="Escape"&&(s(!1),p(!1))};return document.addEventListener("mousedown",j),document.addEventListener("keydown",R),()=>{document.removeEventListener("mousedown",j),document.removeEventListener("keydown",R)}},[g,f]);const E=(j,R,h,A="fbtn")=>t.jsxs("button",{type:"button",className:A,"aria-expanded":a.openFacet===j,onClick:()=>r({type:"openFacet",facet:j}),children:[t.jsx("span",{className:"fl",children:R}),h>0&&t.jsx("span",{className:"n",children:h}),t.jsx("span",{className:"cv",children:"▾"})]},j),T=["1","7","30","all"],C=Math.max(0,T.indexOf(c.win||"all")),L=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(Cl(c.day,d))}),t.jsx("b",{children:N})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:u,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>p(j=>!j),children:[t.jsx("span",{className:"winpick-k",children:i.winMenu}),t.jsx("span",{className:"winpick-v",children:i.datesShort[C]}),t.jsx("b",{children:x[C]}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:T.map((j,R)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===j,onClick:()=>{r({type:"filters",patch:{win:j}}),p(!1)},children:[i.datesShort[R],t.jsx("span",{className:"n",children:x[R]})]},j))})]}):t.jsx("div",{className:"seg",children:T.map((j,R)=>t.jsxs("button",{type:"button","aria-pressed":c.win===j,onClick:()=>r({type:"filters",patch:{win:j}}),children:[t.jsx("span",{className:"sl",children:i.dates[R]}),t.jsx("b",{children:x[R]})]},j))}),q=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:c.search,onChange:j=>r({type:"filters",patch:{search:j.target.value}})})]}),D=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):E("sec",i.fSector,c.sector.length),E("pay",i.fCountry,c.country.length),E("det",i.fEngine,c.engine.length),E("sta",i.fStage,c.stage.length),o&&E("ang","Angle",c.angle.length),o&&E("mem","Mémo",c.memoLevel.length)]}),P=(j=!1)=>t.jsxs("div",{className:"frow2",children:[k>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(b.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(k)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),j&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),I=t.jsxs("div",{className:"fmenu",ref:v,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(S?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{s(j=>!j),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),S>0&&t.jsx("span",{className:"n",children:S}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:D})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:L}),t.jsxs("div",{className:"fstrip-b",children:[q,I,P(!1)]})]}),a.openFacet&&t.jsx(br,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[L,q,D,t.jsx("span",{className:"fgrow"}),P()]}),a.openFacet&&t.jsx(br,{poolFor:y})]})}function br({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=H(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:g}=m.useMemo(()=>{if(l==="sig"){const u=e("signal").filter(x=>Me(x)),b=new Map;u.forEach(x=>{const N=x.engine||"";b.set(N,(b.get(N)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:u.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Wa([...b.keys()],i).map(x=>({v:x,label:jt(x)+" "+Ue(x,i),n:b.get(x)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(x)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const u=e("sector"),b=new Map;return u.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:y,n:x,html:!1,on:o.sector.includes(y)}))}}if(l==="pay"){const u=e("country"),b=new Map;return u.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:It(y,i)||y,n:x,html:!1,on:o.country.includes(y)}))}}if(l==="det"){const u=e("engine"),b=new Map;return u.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Wa([...b.keys()],i).map(y=>({v:y,label:jt(y)+" "+Ue(y,i)+' <span style="color:var(--dim);font-size:10px">· '+ei(ti(y),i)+"</span>",n:b.get(y)||0,html:!0,on:o.engine.includes(y)}))}}if(l==="ang"){const u=e("angle"),b=new Map;return u.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:y.replace(/[_-]+/g," "),n:x,html:!1,on:o.angle.includes(y)}))}}if(l==="mem"){const u=e("memoLevel"),b=new Map;u.forEach(x=>{if(x.kind==="target"){const N=fn(x);b.set(N,(b.get(N)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(x=>({v:String(x),label:y[x],n:b.get(x)||0,html:!1,on:o.memoLevel.includes(x)}))}}const p=e("stage"),v=new Map;return p.forEach(u=>{u.stage&&v.set(u.stage,(v.get(u.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((u,b)=>b[1]-u[1]).map(([u,b])=>({v:u,label:u,n:b,html:!1,on:o.stage.includes(u)}))}},[l,a,i]),s=p=>{if(l==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const u=o.signalEngines.includes(p)?o.signalEngines.filter(b=>b!==p):[...o.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:u}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:p})},f=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>s(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function uo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:d}=H(),c=m.useMemo(()=>{const v={};return r.forEach(u=>{ka(u,n.filters,o)&&(v.monde=(v.monde||0)+1,u.continent&&(v[u.continent]=(v[u.continent]||0)+1))}),v},[r,n.filters,o]),[g,s]=m.useState(!1),f=m.useRef(null);m.useEffect(()=>{if(!g)return;const v=b=>{var y;(y=f.current)!=null&&y.contains(b.target)||s(!1)},u=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",v),document.addEventListener("keydown",u),()=>{document.removeEventListener("mousedown",v),document.removeEventListener("keydown",u)}},[g]);const p=v=>{const u=hn.find(b=>b.key===v);return v==="monde"?d.contWorld:l==="fr"?u.fr:u.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:f,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>s(v=>!v),children:[p(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Mn.map(v=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===v,onClick:()=>{i({type:"continent",key:v}),s(!1)},children:[p(v),t.jsx("span",{className:"n",children:c[v]||0})]},v))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Mn.map(v=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===v,onClick:()=>i({type:"continent",key:v}),children:[p(v),t.jsx("span",{className:"n",children:c[v]||0})]},v)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function mo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function zl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function vr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:d}=H();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function fo({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=H(),i=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(vr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(vr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Al({card:e,onEvaluate:a,onAddAll:r}){var d,c,g;const{t:n}=H(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:mo(e.summary_md||"").map((s,f)=>t.jsx("p",{children:s},f))})]}),t.jsx(fo,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Tl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function ql({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=H(),d=i,[c,g]=m.useState(null),[s,f]=m.useState(null),[p,v]=m.useState(null),[u,b]=m.useState(!1);m.useEffect(()=>{let x=!0;return(async()=>{const N=await qr({email:l,cbToken:d});x&&g(N)})(),()=>{x=!1}},[l,d,n]);const y=x=>{f(x),v(null),b(!0),(async()=>{const N=await ai(x.id);v(N),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),v(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(x=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(x),children:[t.jsx("span",{className:"ti",children:x.title}),t.jsxs("span",{className:"me",children:[Tl(x.created_at),x.industry?` · ${x.industry}`:"",x.author?` · ${x.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(x.cited_n||0,x.evaluate_n||0)}),t.jsx("span",{className:"st"+(x.published?" on":""),children:x.published?o.rsPub:o.rsPriv})]},x.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!u&&!p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!u&&p&&t.jsx(Al,{card:p,onEvaluate:a,onAddAll:r})]})]})}const ba=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Kt(e){return/^https?:\/\//i.test((e||"").trim())}function nt(e){const a=(e||"").trim();return a?Kt(a)?a:ba.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Ll(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Fl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:d,evalCards:c,caps:g,data:s,canWrite:f,source:p,dossiers:v,doAnalyse:u,liveMemos:b,pipe:y}=H(),x=a==="client",N=m.useMemo(()=>r||(p!=="default"?ni():""),[r,p]),[S,k]=m.useState(""),[E,T]=m.useState(!1),[C,L]=m.useState(""),[q,D]=m.useState(""),[P,I]=m.useState(""),[j,R]=m.useState(!1),[h,A]=m.useState(!1),[B,Y]=m.useState(""),[V,K]=m.useState(!1),[X,Q]=m.useState(""),[ie,ae]=m.useState([]),ce=m.useRef(!1),[W,re]=m.useState(!1),[ee,Le]=m.useState(!1),[je,oe]=m.useState(!1),me=m.useRef(!1),[de,G]=m.useState(""),[Z,he]=m.useState(""),[se,fe]=m.useState(!1),[ge,be]=m.useState(!1),[qe,ve]=m.useState(0),[Fe,et]=m.useState(""),[Ne,He]=m.useState(null),[Re,st]=m.useState(null),[pt,ft]=m.useState(!1),[tt,xt]=m.useState(null),[ht,Qe]=m.useState(0),z=m.useRef(!1),U=S.trim()?ba.test(S.trim())?e.evalUrl:e.evalName:e.evalWaiting,_=m.useMemo(()=>B.split(`
`).map(M=>M.trim()).filter(Boolean).slice(0,15),[B]);m.useEffect(()=>{if(typeof window>"u")return;const M=new URLSearchParams(window.location.search),J=(M.get("rs")||"").trim(),ne=(M.get("rstext")||"").trim();J&&/^https?:\/\//i.test(J)&&G(J),ne&&he(ne),(J&&/^https?:\/\//i.test(J)||ne)&&re(!0)},[]),m.useEffect(()=>{const M=J=>{const ne=J.detail||{},w=String(ne.url||"").trim(),O=String(ne.text||"").trim();w&&/^https?:\/\//i.test(w)&&G(w),O&&he(O),(w&&/^https?:\/\//i.test(w)||O)&&(re(!0),k(""),L(""),fe(!0),window.setTimeout(()=>fe(!1),900))};return window.addEventListener("ppmap:research",M),()=>window.removeEventListener("ppmap:research",M)},[]),m.useEffect(()=>{const M=J=>{const ne=J.detail||{},w=String(ne.name||"").trim();if(!w)return;re(!1),k(w),L(w);const O=nt(String(ne.website||ne.domain||""));D(O),I(nt(String(ne.url||""))),R(!O),T(!0),window.setTimeout(()=>T(!1),900)};return window.addEventListener("ppmap:prefill",M),()=>window.removeEventListener("ppmap:prefill",M)},[]),m.useEffect(()=>{const M=(C||"").trim();if(!M||W||q){(q||!M||W)&&R(!1);return}const J=v.find(O=>Oe(O.name)===Oe(M)),ne=nt((J==null?void 0:J.website)||"")||nt((J==null?void 0:J.domain)||"");if(ne){D(ne),R(!1);return}let w=!0;return R(!0),Lr(M).then(O=>{var $,te;if(!w)return;const F=nt(O.website||"")||nt(((te=($=O.candidates)==null?void 0:$[0])==null?void 0:te.url)||"");F&&D(F)}).catch(()=>{}).finally(()=>{w&&R(!1)}),()=>{w=!1}},[C,W,q,v]),m.useEffect(()=>{const M=J=>{var w;const ne=String(((w=J.detail)==null?void 0:w.url)||"").trim();Kt(ne)&&window.open(ne,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",M),()=>window.removeEventListener("ppmap:view",M)},[]),m.useEffect(()=>{if(me.current===W)return;me.current=W,oe(!0);const M=window.setTimeout(()=>oe(!1),560);return()=>window.clearTimeout(M)},[W]),m.useEffect(()=>{if(typeof window>"u")return;const M=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),J=document.querySelector(".atl2.ops, .atl2.cibles");if(!M||!J)return;const ne=()=>J.style.setProperty("--demand-h",`${M.offsetHeight}px`);ne();const w=new ResizeObserver(ne);return w.observe(M),()=>w.disconnect()},[p,E,se,h,W,je,j]),m.useEffect(()=>{if(!f&&!N){xt(null);return}let M=!0;return(async()=>{const J=await qr({email:n,cbToken:N});M&&xt(J.length)})(),()=>{M=!1}},[f,N,n,ht]);const pe=ie.length?ie:c,xe=s.credits,le=m.useCallback(M=>{const J=M.map(ne=>(ne||"").trim()).filter(Boolean);J.length&&(Y(ne=>{const w=ne.split(`
`).map($=>$.trim()).filter(Boolean),O=new Set(w.map($=>$.toLowerCase())),F=J.filter($=>!O.has($.toLowerCase()));return[...w,...F].slice(0,15).join(`
`)}),A(!0))},[]);m.useEffect(()=>{if(!ge)return;ve(0);const M=window.setInterval(()=>ve(J=>J+1),1e3);return()=>window.clearInterval(M)},[ge]);const ye=m.useMemo(()=>{const M=S.trim().toLowerCase();return!M||!y?null:v.find(J=>Oe(J.name)===M&&ze(J)===1)||null},[S,v,y]),$e=()=>{const M=S.trim();if(M){if(ye){u(ye);return}i(null,M),x&&k("")}},At=async()=>{if(!x){i(null,_[0]||"");return}if(!_.length||V)return;K(!0),ce.current=!1;const M=[];for(let J=0;J<_.length&&!ce.current;J++){Q(e.evaluating(J+1,_.length,_[J]));const ne=await Fr(r,_[J],"atelier2");if(M.unshift({name:ne.company||_[J],verdict:ne.verdict,reason:ne.reason||"",remaining:ne.remaining??null}),ae([...M]),ne.verdict==="quota"){M.unshift({name:"",verdict:"quota",reason:e.quota(_.length-J-1),remaining:0}),ae([...M]),Y(_.slice(J+1).join(`
`)),Q(""),K(!1);return}}Q(""),Y(ce.current?_.slice(M.length).join(`
`):""),K(!1)},gt=async()=>{var ne,w,O;if(z.current)return;const M=de.trim().replace(/\s+/g,""),J=Z.trim();if(!M&&!J){et(e.rsNeed);return}if(!x&&!N){i(null,M||J.slice(0,80));return}z.current=!0,et(""),He(null),st(null),be(!0);try{const F=await oi({url:M,text:J,email:n,cbToken:N});if(be(!1),!F||F.status!=="success"){et((F==null?void 0:F.message)||"Erreur");return}He(F),re(!1),le((((ne=F.prospective)==null?void 0:ne.companies_to_evaluate)||[]).map(te=>(te==null?void 0:te.name)||"")),st({state:"pending"});const $=await ii(F,{email:n,cbToken:N});st($.ok?{state:"ok",scopeLabel:((w=$.summary)==null?void 0:w.scope_label)||"",scope:((O=$.summary)==null?void 0:O.scope)||""}:{state:"fail",msg:$.error||""}),$.ok&&Qe(te=>te+1)}finally{z.current=!1,be(!1)}},Tt=[Ne==null?void 0:Ne.industry,...(Ne==null?void 0:Ne.market_tags)||[],Ne==null?void 0:Ne.author].map(M=>(M||"").trim()).filter(Boolean),ut=(Re==null?void 0:Re.state)==="pending",qt=Re&&(ut?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Re.state==="ok"?t.jsx("span",{className:"rslink ok",children:Re.scope&&Re.scope!=="public"?e.rsSavedIn(Re.scopeLabel||Re.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Re.msg,children:e.rsSaveFail})),Ve=zl(Ne).length,Pe=W,bt=(C||S).trim(),Je=v.find(M=>Oe(M.name)===Oe(bt)),$t=nt(S)||q||nt((Je==null?void 0:Je.website)||"")||nt((Je==null?void 0:Je.domain)||""),_t=P||nt((Je==null?void 0:Je.url)||""),ra=ye?e.actAnalyse:bt?e.evalGoOn(bt.length>22?bt.slice(0,21)+"…":bt):e.evalGo,Ra=ge?`${ri(de.trim())==="youtube"&&de.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(qe)}`:ut?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Pe?" rs-mode":"")+(C&&S.trim()===C||E||se?" pair":"")+(E||se||je?" echo":"")+(je?" swap":""),children:[t.jsxs("div",{className:"drow"+((Pe?se:E)||je?" flash":"")+((Pe?de.trim():ba.test(S.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Pe?de:S,placeholder:Pe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Pe?600:200,spellCheck:Pe?!1:void 0,inputMode:Pe?"url":void 0,onChange:M=>{if(Pe){G(M.target.value);return}k(M.target.value),C&&M.target.value.trim()!==C&&(L(""),D(""),I(""),R(!1))},onKeyDown:M=>{M.key==="Enter"&&(Pe?gt():$e())}}),t.jsx("span",{className:"detect"+(Pe?" off":"")+(ba.test(S.trim())?" url":""),children:U})]}),t.jsx("span",{className:"dacts",children:Pe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ge?" loading":""),disabled:ge||ut||!de.trim()&&!Z.trim(),onClick:()=>{gt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Ra})]}),t.jsxs("a",{className:"viewbtn"+(Kt(de)?"":" off"),href:Kt(de)?de.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:M=>{Kt(de)||M.preventDefault()},children:[t.jsx(Ll,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ye?" analyse":"")+(d?" loading":""),disabled:d,onClick:$e,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ra})]}),t.jsxs("a",{className:"viewbtn sm"+(j?" searching":$t?"":" off"),href:$t||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":j||void 0,title:j?e.viewSiteBusyHint:e.viewSiteHint,onClick:M=>{$t||M.preventDefault()},children:[j&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),j?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(_t?"":" off"),href:_t||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:M=>{_t||M.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&xe&&t.jsxs("button",{type:"button",className:"credits"+(xe.total_available<=0&&!xe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:xe.unlimited?"∞":xe.total_available}),!xe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",xe.daily_grant+xe.purchased]}),xe.total_available<=0&&!xe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(M=>M.status==="boot"||M.status==="running").map(M=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:M.name}),t.jsx(Qt,{item:M,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+M.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>A(!h),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(W?" on":""),onClick:()=>re(!W),children:e.rsOpen}),tt!==null&&tt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(pt?" on":""),onClick:()=>ft(!pt),children:e.rsArchOpen(tt)})]}),pt&&t.jsx(ql,{bump:ht,cbToken:N,onClose:()=>ft(!1),onEvaluate:M=>i(null,M),onAddAll:le}),t.jsx("div",{className:"rsp slim"+(W?" on":" off"),"aria-hidden":!W,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:W?void 0:-1,onClick:()=>Le(M=>!M),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:ee?"▴":"▾"})]}),ee&&t.jsx("textarea",{className:"rstext",value:Z,placeholder:e.rsTextPh,tabIndex:W?void 0:-1,onChange:M=>he(M.target.value)})]})}),Fe&&t.jsx("div",{className:"rserr",children:Fe}),Ne&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:Ne.title}),Ne.source_url&&t.jsx("a",{href:Ne.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{He(null),st(null)},children:"×"})]}),Ne.market&&t.jsx("p",{className:"rsmk",children:Ne.market}),Tt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Tt.map(M=>t.jsx("span",{children:M},M))]}),t.jsxs("div",{className:"rsbody",children:[Ne.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${Ne.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:mo(Ne.summary_md||"").map((M,J)=>t.jsx("p",{children:M},J))})]}),t.jsx(fo,{card:Ne,onEvaluate:M=>i(null,M),onAddAll:le}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Ve)}),qt]})]}),h&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:B,placeholder:e.bulkPh,onChange:M=>Y(M.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(V?" loading":""),style:{justifyContent:"center"},disabled:V||!_.length,onClick:()=>{At()},children:[t.jsx("span",{className:"fill"}),V&&X?X:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(_.length)})]})]}),pe.slice(0,1).map((M,J)=>{const ne=M.verdict==="kept",w=M.verdict==="quota",O=ne?"var(--brand)":w?"var(--bolt)":"var(--red)",F=ne?"var(--brand-l)":w?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":O,"--bgc":F},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ne?"✓ "+e.kept:w?"⏳":"✗ "+e.dropped})}),M.name&&t.jsx("span",{className:"rn",children:M.name}),t.jsx("span",{className:"rr",children:M.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",M.reason]}):null}),!!(M.candidates&&M.candidates.length)&&t.jsx("span",{className:"sitepick",children:M.candidates.map($=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:$.url.startsWith("http")?$.url:`https://${$.url}`,target:"_blank",rel:"nofollow noopener",children:[($.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,$.url),children:e.evalPickGo})]},$.url))}),!w&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:ne?1:5});const $=(M.name||"").trim().toLowerCase();window.setTimeout(()=>{const te=[...document.querySelectorAll(".atl2 .list .row")].find(Ee=>{var Se;return(((Se=Ee.querySelector(".rnm"))==null?void 0:Se.textContent)||"").trim().toLowerCase().includes($)});te&&(te.scrollIntoView({behavior:"smooth",block:"center"}),te.classList.add("flashrow"),window.setTimeout(()=>te.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ne?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),x&&(o.kept+o.dropped>0||pe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Rl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ml(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=H(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",Rl(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const d=mt(o),c=fn(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Mt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function kn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=H(),[l,d]=m.useState(!1),[c,g]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,f=async()=>{if(!s||l)return;d(!0);const p=await si(r,e);if(d(!1),!p){o(a.actErr);return}g(p.results||[])};return m.useEffect(()=>{if(!s)return;const p=v=>{var b;const u=String(((b=v.detail)==null?void 0:b.name)||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&f()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,s]),m.useEffect(()=>{if(s)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),f())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{f()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Ol=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),xa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Dl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=xa(a.slice(n));break}r+=xa(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=xa(a.slice(i));break}const l=a.slice(i+1,o).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Ol.has(c)?r+=`<${d[1]}${c}>`:r+=xa(a.slice(i,o+1)),n=o+1}return r}const yr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function De({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Pl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Il({o:e}){const{t:a,doDeep:r}=H(),[n,i]=m.useState(!1),o=mt(e),l=[e.reasoning||"",Pl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Mt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),i(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function jn({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=H(),o=aa(e),l=mt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),f=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Mt(e)?1:0}].filter(b=>b.n>0),[e,a,d,l,c,g,s]),[p,v]=m.useState("");if(!f.length)return null;const u=f.some(b=>b.k===p)?p:f[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:f.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":u===b.k,"data-tour":"tab-"+b.k,className:u===b.k?"on":"",onClick:y=>{y.stopPropagation(),v(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[u==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(De,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(De,{k:a.cdVerdictDate,v:yr(e.verdictDate,r)})]})]}),u==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Dl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Bl,{o:e})]}),u==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdSector,v:e.sector}),t.jsx(De,{k:a.cdStage,v:e.stage}),t.jsx(De,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(De,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(De,{k:a.cdAngle,v:e.angle}),t.jsx(De,{k:a.cdDetected,v:yr(e.date,r)})]}),u==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdName,v:e.contactName}),t.jsx(De,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),u==="memo"&&t.jsx(Il,{o:e}),u==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(De,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Bl({o:e}){const{t:a,token:r}=H(),[n,i]=m.useState(!1),[o,l]=m.useState(null),d=async()=>{n||(i(!0),l(await li(r,e.name,e.website||e.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},g=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=g.some(([,f])=>f);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[g.filter(([,f])=>f).map(([f,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:f}),t.jsx("p",{children:p})]},f)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function na({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const d=()=>{const g=Math.max(280,Math.min(560,o.clientWidth||320));On({kind:"op",card:e},g).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;On({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&o.isConnected&&o.replaceChildren(c)});const d=c=>{c.key==="Escape"&&i(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const $l=`
...
`;function _l(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let d=e.y+10;return d+n>o-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function Ul(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:d,doAnalyse:c,doDecide:g,doPromote:s,doRepeche:f,doApproach:p,doDeep:v,doOnboard:u,outbound:b,evalBusy:y}=H(),x=e.popupId?r.get(e.popupId):null;if(!x)return null;const N=Me(x),S=ze(x),k=mt(x),E=aa(x),T=x.kind==="target",C=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Pt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:$l}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:_l(e.popupAnchor,!!x.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:x.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ct(x.date)),Ue(x.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[x.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[x.cc]}),children:(It(x.cc,i)||x.countryLabel||"").toUpperCase()}),x.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[x.sector]}),children:x.sector.toUpperCase()}),x.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[x.stage]}),children:x.stage.toUpperCase()}),typeof x.amountEur=="number"&&x.amountEur>0&&t.jsx("span",{className:"am2",children:Bt(x.amountEur,i)})]}),o.pipe&&T&&t.jsxs("div",{className:"pstat",children:[E&&t.jsx("span",{className:"vd "+(E==="MATCH"?"v-ok":"v-no"),title:n.vt[E],children:E}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[S]}),x.ceoStatus&&t.jsx("span",{className:"pstep own",children:x.ceoStatus})]}),(x.tagline||x.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:x.tagline||x.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[jt(x.engine)," ",t.jsx("b",{children:Ue(x.engine,i)})," — ",di(x.engine,i),x.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",x.noteTitle]})]}),N?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ct,{o:x,lg:!0})," ",t.jsx(Fa,{o:x,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Rr(N,i))," · ",n.win7(Mr(N,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),x.card?t.jsx(na,{spec:x.card}):null,x.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&S>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:x.reasoning})]}),o.pipe&&T&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof x.score=="number"&&x.score>0?" · "+n.score(x.score):""]})}),o.pipe&&T&&t.jsx(jn,{o:x})]}),t.jsx(kn,{name:x.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[S===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)]}),S===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),S===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),S===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(x,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(x,!1),a({type:"popup",id:null})},children:n.actNo}),Mt(x)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(x),a({type:"popup",id:null})},children:n.memoDeep})]}),S===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),S===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),x.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:x.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{u(x),a({type:"popup",id:null})},children:"🚀"})]}):x.engine==="media"&&x.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(x.name),onClick:()=>d(x),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)," →"]}),x.website&&t.jsx("a",{className:"psite",href:x.website.startsWith("http")?x.website:"https://"+x.website,target:"_blank",rel:"noopener noreferrer",title:x.website,children:"🌐"})]})]})]}),document.body)}function Hl(){const{lang:e,token:a,dossiers:r,caps:n}=H(),i=a||"home",{names:o,verdicts:l}=m.useMemo(()=>{const c=[],g={};return r.forEach(s=>{s.kind!=="target"||!s.name||(c.push(s.name),g[s.name]=ci(s)||"")}),{names:c,verdicts:g}},[r]);return{diff:m.useMemo(()=>o.length?pi(i,o,l,e):null,[i,o.length]),names:o,verdicts:l,scope:i,caps:n}}function Vl(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=H(),d=o.loading&&!l.length,c=m.useRef({});m.useEffect(()=>{c.current={...r}},[r]);const g=p=>{const v=c.current[p],u=v!==void 0?r[p]-v:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ya[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(u>0?" up":u<0?" down":""),children:[r[p],u!==0&&t.jsxs("em",{className:"delta",children:[u>0?"+":"−",Math.abs(u)]})]})]},p)},s=(p,v,u)=>t.jsxs("button",{type:"button",className:"off"+(v?" view":""),style:{"--c":`var(${Ya[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsx("span",{className:"l",children:u.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),f=(p,v,u,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:v,disabled:b,onClick:u,children:p},v);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[f("↩",n.toolUndo,i,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Wl(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=H(),d=m.useRef(null),[c,g]=m.useState(60);m.useEffect(()=>{let u=0;const b=()=>{var k;const y=d.current;if(!y)return;const x=(k=y.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!x)return;const N=x.getBoundingClientRect(),S=y.getBoundingClientRect();g(Math.max(20,Math.min(N.left+N.width/2-S.left,S.width-30)))};return u=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(u),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let f=r.tuto[s].p;if(s===3){const u=n.filter(x=>x.kind==="target"&&ze(x)===3),b=u.filter(x=>Ga(x)==="auto").length,y=u.filter(x=>Ga(x)==="cd").length;f=r.tutoPending(b,y,u.length)}const p=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(u=>u.id)})};if(s===1){const u=n.filter(b=>b.kind==="target"&&ze(b)===1&&!i.has(b.id)).slice(0,10);if(u.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:u.map(b=>b.id)})}}return null})(),v=ui(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(v?"":" on-dark"),style:{"--bg":`var(${Ya[s]})`,"--ax":c+"px","--stc":v?"var(--ink)":"#fff","--stt":v?"#fff":"var(--ink)","--tc":v?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:f}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}const Va=600,yt=62,wr="atl2:fstats";function Yl(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=H(),[l,d]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(wr)==="on"}catch{return!1}}),c=r.stats,g=m.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const f=E=>a==="en"?E.slice(5,10):`${E.slice(8,10)}/${E.slice(5,7)}`,p=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),v=g.reduce((E,T)=>Math.max(E,T.s||0),0),u=g.length?Va/g.length:0,b=Math.max(4,u-4),y=g.length>=5&&v>0,x=r.marketEstimate||0,N=f(new Date().toISOString().slice(0,10)),S=E=>[...typeof E=="number"?[[E,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],k=[];return typeof c.screened_window=="number"&&s&&k.push({cle:"fenetre",periode:e.funPerWindow(f(s),N),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:S(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[k.map(E=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:E.periode}),E.etapes.map(([T,C],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(T)}),t.jsx("i",{children:C})]},E.cle+C)),E.cle==="total"&&x>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(x),Math.min(100,Math.round((c.screened||0)/x*100)))})]}),E.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const T=!l;d(T),T&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(wr,T?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},E.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Va} ${yt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((E,T)=>{const C=(E.s||0)/v*(yt-4),L=(E.m||0)/v*(yt-4),q=T*u+(u-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(E.d)} — ${E.s} ${e.actScreened} · ${E.m} ${e.actKept}`}),t.jsx("rect",{x:q,y:yt-2-C,width:b,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:q,y:yt-2-L,width:b,height:L,fill:"#185c38"})]},E.d)}),t.jsx("line",{x1:0,y1:yt-1.5,x2:Va,y2:yt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const xo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Nn({o:e,locked:a=!1}){const{t:r}=H(),n=aa(e),i=mt(e),o=ze(e),l=Ga(e),d=fi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(xo[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(ws,{o:e})]})}const St=e=>e.length>22?e.slice(0,21)+"…":e,va=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function La(e){return va.has(e.engine||"")}function wt(e){return!!e.noCo||La(e)&&!!e.url}function ta(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function ho(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Gl({on:e,rev:a}){const[r,n]=m.useState(null),[i,o]=m.useState({top:0,left:0,width:0});return m.useEffect(()=>{if(!e){n(null);return}const l=()=>{var u,b,y;const d=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!d){n(null);return}const g=d.getBoundingClientRect(),s=c?c.getBoundingClientRect().bottom:g.top;o({top:Math.round(s),left:Math.round(g.left),width:Math.round(g.width)});const f=[...d.querySelectorAll(":scope .grp")];let p=null;for(const x of f){const N=x.querySelector(".grp-h");N&&N.getBoundingClientRect().bottom<=s+2&&(p=x)}if(!p){n(null);return}const v=p.querySelector(".grp-h");if(!v){n(null);return}n({ic:(((u=v.querySelector(".ic"))==null?void 0:u.textContent)||"").trim(),t:(((b=v.querySelector(".t"))==null?void 0:b.textContent)||"").trim(),s:(((y=v.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||i.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:i.top,left:i.left,width:i.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Kl(e){const r=()=>{const n=ho(),i=e.getBoundingClientRect().top-n-8;Math.abs(i)<2||window.scrollBy({top:i,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function kr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=H(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),Ie(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(St(e.name))})]})}function En({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:d,doRepeche:c,doApproach:g,dispatch:s,liveMemos:f}=H(),p=u=>b=>{b.stopPropagation(),u()};if(r.lockActions){const u=p(()=>s({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:u,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const b=ze(e);return b===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:u,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(St(e.name))})]})}):b===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:u,children:a.actAnalyse})}):b===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:u,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:u,children:a.actNo})]})}):b===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:u,children:a.actPromote})}):b===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:u,children:a.actApproach})}):b===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:u,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:u,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{u.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return La(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{u.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(kr,{o:e})});const v=ze(e);if(v===0)return t.jsx("span",{className:"cell",children:t.jsx(kr,{o:e})});if(v===1){const u=f.liveOf(e.name);if(u&&(u.status==="boot"||u.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Qt,{item:u,serverOff:f.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:p(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(v===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:p(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:p(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(v===4){const u=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:u,onClick:p(()=>g(e)),children:u?a.actApproachSent:a.actApproach})})}return v===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):v===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:p(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Ql({o:e}){const{t:a,doThumb:r,thumbOf:n}=H(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Jl({o:e}){const{lang:a}=H();return Me(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ct,{o:e}),t.jsx(Fa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[jt(e.engine||"")," ",Ue(e.engine||"",a)]})})}function Xl({o:e,locked:a,open:r,onToggle:n,selected:i,echo:o,onSelect:l}){const{dispatch:d,caps:c,markRow:g,markedId:s,favIds:f,toggleFav:p,t:v}=H(),u=ze(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,x=y<=0?0:y<=7?1:y<=30?2:3,N=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:b[x],S=f.has(e.id),k=E=>{if(a)return;if(l){l(e.id);return}if(c.pipe||e.kind==="op"){n();return}const T=E.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:T.left+Math.min(280,T.width/3),y:T.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(o?" echo":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>g(e.id),onMouseLeave:()=>g(null),onClick:k,children:[t.jsx("span",{className:"pt",style:{"--c":N}}),t.jsx(wo,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:S?1:.35,padding:0,marginRight:4},onClick:E=>{E.stopPropagation(),p(e)},children:S?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(E=>E&&E!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:v.acqSee(e.acquirer),onClick:E=>{E.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",St(e.acquirer)]}),Ze(e)?t.jsx("span",{className:"rdec",title:v.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:v.zoomNewsMark,children:"📰"}):null]}),t.jsx(Zl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Jl,{o:e}),c.pipe&&t.jsx(Nn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(En,{o:e}),c.showThumbs&&t.jsx(Ql,{o:e})]}),r&&!a&&!l&&t.jsx(ad,{o:e})]})}function Zl({o:e}){const{lang:a,caps:r}=H();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Bt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function ed({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=H(),l=(p,v=!1)=>u=>{u.stopPropagation(),v&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})},d=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),c=Bt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=Ie(e),f=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):wt(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{p.stopPropagation(),ta(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(St(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(St(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(na,{spec:e.card})})]})}function td({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=H();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ue(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(En,{o:e})}),t.jsx(jn,{o:e})]})}function go({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:d,dossiers:c}=H(),g=m.useRef(null),s=Ze(e);if(m.useEffect(()=>{if(!s||!(e!=null&&e.decryptHtml))return;const h=g.current;if(!h)return;let A=!1;return Ar(()=>import("./fit-BnaWm7z_.js"),[]).then(async B=>{await B.ensureEditoCss(),!(A||!h.isConnected)&&(B.beautifyEditoRows(h),B.mountCardFits(h))}),()=>{A=!0}},[s,e==null?void 0:e.decryptHtml]),!e&&!a){const h=c.find(Ze);if(h)return t.jsx(go,{o:h})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),p=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),v=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),b=e?!!e.noCo:!f||wa(f),y=(e==null?void 0:e.engine)||"",x=Ze(e),N=e?Bt(e.amountEur,n):"",S=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(p);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),E=c.find(Ze),T=((E==null?void 0:E.url)||"").trim(),C=!!p&&!!T&&(p===T||p.endsWith(T)||T.endsWith(p)),L=(h,A=!1)=>B=>{B.stopPropagation(),A&&l({type:"continent",key:"monde"}),l({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const q=()=>{f&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:f}}))},D=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},P=()=>{ta({url:p,headline:v,tagline:e==null?void 0:e.tagline,name:f})},I=e?Ie(e):!1,j=I&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",R=x?r.doEdito.replace(/^📖\s*/,""):y?Ue(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[R,S?` · ${S}`:""]}),t.jsx("h3",{className:"zoom-h",children:v}),p&&!x&&(b||La({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:p,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(x?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),N&&t.jsx("span",{className:"oc-amt",children:N})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(na,{spec:u})}),(p&&!C&&!x||E&&!x)&&t.jsxs("div",{className:"zoom-srcbox",children:[p&&!C&&!x&&t.jsxs("a",{className:"zoom-src",href:p,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),E&&!x&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),l({type:"focus",id:E.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[I?t.jsxs("span",{className:"verdict",style:{"--c":j?"var(--brand)":"var(--red)"},children:[j?"✓":"✗"," ",t.jsx("b",{children:j?r.kept:r.dropped})]}):!b&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:o,onClick:h=>{h.stopPropagation(),i(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(St(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,p&&!x&&(b||La({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!b&&f?" ghost":""),onClick:h=>{h.stopPropagation(),P()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!b&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),q()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:St(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!b&&f&&d.pipe&&t.jsx(kn,{name:f})]})]})}function ad({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=H();return!i.pipe&&e.kind==="op"?t.jsx(ed,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(jn,{o:e}),t.jsx(ks,{o:e}),t.jsx(Es,{o:e}),t.jsx(kn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Nn,{o:e})})]}),e.card&&t.jsx(na,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[jt(e.engine||"")," ",Ue(e.engine||"",r)]}),Me(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ct,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function nd({o:e,locked:a,selected:r,onSelect:n}){const{t:i,dispatch:o,caps:l,doDecide:d,lang:c}=H();if(!l.pipe&&e.kind==="op"){const f=Bt(e.amountEur,c),p=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),v=(u,b=!1)=>y=>{y.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(na,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:v({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:v({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:v({stage:[e.stage]}),children:e.stage}),f&&t.jsx("span",{className:"damt",children:f})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[jt(e.engine||"")," ",Ue(e.engine||"",c)]}),Me(e)&&t.jsx(Ct,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(p?` · ${p}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(En,{o:e})})]})}const g=ze(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Nn,{o:e}),Me(e)&&t.jsx(Ct,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:i.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:i.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>o({type:"memoConsole",id:e.id}),children:[i.actMemo," →"]})]})}function rd(){const{t:e}=H(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function od({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=H(),o=i==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,f)=>(e[f]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?o?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:o?`${g} ${g>1?"files":"file"} in “${l(c)}”`:`${g} dossier${g>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(o?"Open ":"Ouvrir ")+l(c)," →"]})]})}function id(){var ft,tt,xt,ht,Qe;const e=H(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:d,markRow:c,lang:g,sessTally:s,data:f,dossiers:p,source:v,focusExtra:u,byId:b,token:y}=e,x=Ir(),N=m.useMemo(()=>{var _,pe,xe,le;if(!y||v==="ops")return null;const z=(((_=x==null?void 0:x.ed)==null?void 0:_.date)||(x==null?void 0:x.day)||"").slice(0,10),U=[(pe=x==null?void 0:x.ed)==null?void 0:pe.html,(xe=x==null?void 0:x.ed)==null?void 0:xe.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((le=x==null?void 0:x.ed)==null?void 0:le.date)||z,decryptHtml:U||void 0,date:z,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,v,g,(ft=x==null?void 0:x.ed)==null?void 0:ft.html,(tt=x==null?void 0:x.ed)==null?void 0:tt.acquirers_html,(xt=x==null?void 0:x.ed)==null?void 0:xt.date,x==null?void 0:x.day]),S=z=>i.lockRowsAfter!==null||v==="ops"?Number.MAX_SAFE_INTEGER:Dr,[k,E]=m.useState(new Set);m.useEffect(()=>{E(new Set)},[a.ptab,a.continent]);const[T,C]=m.useState(null);m.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[L,q]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){q(!1);return}const z=document.getElementById("atl2-stage");if(!z){q(!1);return}const U=new IntersectionObserver(([_])=>q(!!_&&_.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return U.observe(z),()=>U.disconnect()},[a.mapFolded]);const D=a.mapFolded||!L,P=z=>E(U=>{const _=new Set(U);return _.has(z)?_.delete(z):_.add(z),_}),I=v==="ops"||i.pipe,[j,R]=m.useState("all"),[h,A]=m.useState(null),[B,Y]=m.useState(!1),V=m.useRef(!0);m.useEffect(()=>{if(V.current){V.current=!1;return}R("all"),Y(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!B)return;const z=U=>{var _,pe;(pe=(_=U.target)==null?void 0:_.closest)!=null&&pe.call(_,".atl2 .doable")||Y(!1)};return document.addEventListener("click",z),()=>document.removeEventListener("click",z)},[B]);const K=m.useMemo(()=>{var U;const z=new Map;for(const _ of ds(((U=x==null?void 0:x.ed)==null?void 0:U.html)||""))z.has(_.t)||z.set(_.t,_.html);return z},[(ht=x==null?void 0:x.ed)==null?void 0:ht.html]),X=m.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!K.size)return;const U=(z.name||"").trim().toLowerCase();if(U.length<3)return;const _=K.get(U);if(_)return _;for(const[pe,xe]of K)if(pe.includes(U)||U.includes(pe))return xe},[K]),{diff:Q}=Hl(),[ie,ae]=m.useState(!1),[ce,W]=m.useState(!1),re=m.useMemo(()=>new Set(((Q==null?void 0:Q.added)||[]).map(z=>z.trim().toLowerCase()).filter(Boolean)),[Q]),ee=m.useMemo(()=>{const z=ce&&re.size?d:l;let U=gn(z,a.sort);return U=U.filter(_=>!Ze(_)),ce&&re.size&&(U=U.filter(_=>re.has((_.name||"").trim().toLowerCase()))),j==="explore"?U=U.filter(wt):j==="eval"&&(U=U.filter(_=>!wt(_)&&!_.noCo)),U},[l,d,a.sort,j,ce,re]),je=m.useMemo(()=>i.pipe?d.filter(z=>Me(z)&&mi(z)):ee.filter(z=>Me(z)&&!Ie(z)),[i.pipe,d,ee]).length,oe=m.useMemo(()=>i.pipe?ee:ee.filter(z=>!Ie(z)&&!z.noCo),[ee,i.pipe]),me=v==="ops"?ee.filter(wt).length:0,de=ce?n.sinceDock(ee.length):i.pipe?n.plabels[a.ptab].toLowerCase():v==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,G=a.filters,Z=[];if(G.day)Z.push({k:"day",lib:n.fDay(G.day.slice(8,10)+"/"+G.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(G.win&&G.win!=="all"){const z=["1","7","30"].indexOf(G.win);z>=0&&Z.push({k:"win",lib:n.dates[z],off:()=>r({type:"filters",patch:{win:"all"}})})}const he=z=>z.length<=2?z.join(", "):`${z.length} ${n.fSelected}`;for(const z of["sector","country","engine"]){const U=G[z];U&&U.length&&Z.push({k:z,lib:he(U),off:()=>r({type:"clearFacet",facet:z})})}G.search&&Z.push({k:"search",lib:"🔍 "+G.search,off:()=>r({type:"filters",patch:{search:""}})}),ce&&re.size&&Z.push({k:"since",lib:"✨ "+n.sinceDock(re.size),off:()=>W(!1)}),G.signalOnly&&Z.push({k:"sig",lib:"🔴 "+n.sigDock(je||G.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const se=(z,U,_="",pe=!1)=>t.jsxs("button",{type:"button","data-s":z,className:_,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:pe?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[U,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),fe=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const z=new Map;ee.forEach(pe=>{const xe=pe.engine||"?";z.has(xe)||z.set(xe,[]),z.get(xe).push(pe)});const U={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},_=Wa([...z.keys()],g);return[...z.entries()].sort((pe,xe)=>{const le=U[pe[0]]??10+_.indexOf(pe[0]),ye=U[xe[0]]??10+_.indexOf(xe[0]);return le-ye})},[ee,i.pipe,a.groupBy,g]),ge=fe?fe.filter(([z])=>va.has(z)).length:0,be=(()=>{var U;return((U=(fe?fe.flatMap(([,_])=>_):ee)[0])==null?void 0:U.id)??null})(),qe=m.useRef(!1),ve=m.useMemo(()=>p.find(Ze)||N,[p,N]);m.useEffect(()=>{const z=()=>{qe.current=!0};return window.addEventListener("ppmap:reveal",z),window.addEventListener("ppmap:focus",z),()=>{window.removeEventListener("ppmap:reveal",z),window.removeEventListener("ppmap:focus",z)}},[]),m.useEffect(()=>{const z=()=>{ve&&r({type:"focus",id:ve.id})};return window.addEventListener("ppmap:edito",z),()=>window.removeEventListener("ppmap:edito",z)},[ve,r]),m.useEffect(()=>{if(!a.focusId)return;A(a.focusId);const z=window.setTimeout(()=>A(null),900);return()=>window.clearTimeout(z)},[a.focusId]),m.useEffect(()=>{if(I&&!(a.focusId&&(ee.some(z=>z.id===a.focusId)||p.some(z=>z.id===a.focusId)||a.focusId===(ve==null?void 0:ve.id)))&&!u){if(ve){r({type:"focus",id:ve.id});return}be&&r({type:"focus",id:be})}},[I,a.focusId,ee,be,u,r,p,v,ve]),m.useEffect(()=>{if(!(!I||!a.focusId)&&j!=="all"&&!(ve&&a.focusId===ve.id)&&!ee.some(z=>z.id===a.focusId)&&p.some(z=>z.id===a.focusId)){if(qe.current){R("all");return}be&&r({type:"focus",id:be})}},[I,a.focusId,j,ee,p,be,r]),m.useEffect(()=>{if(!I||!a.focusId||!qe.current)return;const z=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!z)return;qe.current=!1;const U=ho(),_=z.getBoundingClientRect();_.top>=U-2&&_.bottom<=window.innerHeight-4||Kl(z)},[I,a.focusId,a.ptab,ee]),m.useEffect(()=>{if(typeof window>"u")return;const z=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),U=document.querySelector(".atl2.ops, .atl2.cibles");if(!z||!U)return;const _=()=>U.style.setProperty("--listhead-h",`${z.offsetHeight}px`);_();const pe=new ResizeObserver(_);return pe.observe(z),()=>pe.disconnect()},[D,a.dens,a.mapFolded]);const Fe=m.useMemo(()=>{if(!I||!a.focusId)return null;if(N&&a.focusId===N.id)return N;const z=ee.find(_=>_.id===a.focusId)||p.find(_=>_.id===a.focusId)||null;if(!z)return null;const U=X(z);return U&&U!==z.decryptHtml?{...z,decryptHtml:U}:z},[I,a.focusId,ee,p,X,N]),et=i.lockRowsAfter;let Ne=0;const He=(z,U)=>{let _=a.shown[U]||S();return z.length-_<=4&&(_=z.length),z.slice(0,_).map(le=>{const ye=et!==null&&Ne>=et;Ne++;const $e=X(le),At=$e&&$e!==le.decryptHtml?{...le,decryptHtml:$e}:le,gt=!I&&a.dens!=="maxi"&&(a.dens==="deplie"||(T?T==="open":!!$e)),Tt=k.has(le.id)?!gt:gt,ut=I?qt=>{qe.current=!0,r({type:"focus",id:qt});const Ve=b.get(qt);Ve&&(wt(Ve)?ta(Ve):Ve.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ve.name,url:Ve.url||"",website:Ve.website||"",domain:Ve.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(nd,{o:At,locked:ye,selected:I&&a.focusId===le.id,onSelect:ut},le.id):t.jsx(Xl,{o:At,locked:ye,open:Tt,onToggle:()=>P(le.id),selected:I&&a.focusId===le.id,echo:h===le.id,onSelect:ut},le.id)})},Re="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(v==="ops"?" opsl":"")+(ee.length?"":" list-empty"),st=t.jsxs(t.Fragment,{children:[fe?fe.map(([z,U])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:jt(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:z==="ma"?n.grpMa:z==="fundraising"?n.grpLev:va.has(z)&&ge<=1?n.grpNews:z==="nominations"?n.grpNom:z==="media"?n.grpNewsOther:z==="recrutements"?n.grpHire:va.has(z)?n.grpNews+" · "+Ue(z,g):Ue(z,g)}),t.jsx("div",{className:"s",children:n.grpCount(U.filter(_=>!Ie(_)).length,U.length)})]})]}),He(U,z)]},z)):He(ee,"pt"+a.ptab),f.loading&&!p.length&&t.jsx(rd,{}),!ee.length&&!(f.loading&&!p.length)&&(i.pipe?t.jsx(od,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),pt=t.jsxs("div",{className:"listhead"+(D?" mapoff":""),children:[D&&t.jsx("div",{className:"lh-tools",children:t.jsx(po,{compact:!0})}),i.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ie?" on":""),"aria-expanded":ie,onClick:()=>ae(z=>!z),children:["📊 ",n.morningDock(typeof((Qe=f.stats)==null?void 0:Qe.screened_today)=="number"?f.stats.screened_today:0)]}),Q&&!Q.firstVisit&&(Q.added.length>0||Q.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(ce?" on":""),"aria-pressed":ce,title:n.sinceSub,onClick:()=>W(z=>!z),children:["✨ ",n.sinceDock(Q.added.length)]}),je>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[]}}),children:["🔴 ",n.sigDock(je)]})]}),i.showFunnel&&ie&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(Cs,{}),t.jsx(Yl,{})]}),i.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Vl,{}),t.jsx(Wl,{})]}),t.jsxs("div",{className:"lh-top",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:ee.length})," ",de]}),t.jsx("span",{className:"dot",children:"·"}),D&&t.jsx(uo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[D?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),Z.map(z=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:U=>{U.stopPropagation(),z.off()},children:[z.lib,t.jsx("i",{children:"×"})]},z.k)),v==="ops"&&ee.length>0&&!D&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ee.length-me," ",n.zoomPulseEval,me>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",me," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(i.showFunnel||v==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,U])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:U})]},z))}),!I&&i.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":T==="open",onClick:()=>{C("open"),E(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":T==="closed",onClick:()=>{C("closed"),E(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||v==="ops")&&(()=>{var le;const z=l.filter(ye=>!Ze(ye)),U=z.filter(ye=>!wt(ye)&&!ye.noCo).length,_=z.filter(wt).length,pe=[["all",n.doAll],["eval",`${n.doEval}${U?` ${U}`:""}`],["explore",`${n.doExplore}${_?` ${_}`:""}`]],xe=((le=pe.find(([ye])=>ye===j))==null?void 0:le[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":B,onClick:()=>Y(ye=>!ye),children:[xe,t.jsx("i",{children:"▾"})]}),B&&t.jsx("div",{className:"dolist",children:pe.map(([ye,$e])=>t.jsx("button",{type:"button","aria-pressed":j===ye,onClick:()=>{R(ye),Y(!1)},children:$e},ye))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([z,U])=>t.jsx("option",{value:z,children:U},z))})]}),i.showChain&&oe.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:oe.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(oe.length):n.chainAll(oe.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!I&&pt,a.dens!=="maxi"&&!I&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),se("country",n.colCountry),se("name",n.colCompany),se("amount",n.colAmount,"h-amt",!0),se("stage",n.colStage,"h-stade"),se("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[se("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),se("memo",n.colMemo)]}),i.pipe&&se("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),I?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[pt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),se("country",n.colCountry),se("name",n.colCompany),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[se("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),se("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:Re,children:st})]}),t.jsxs("aside",{className:"readpane"+((Fe?Ze(Fe):!u&&ve)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[ve&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===ve.id,onClick:()=>r({type:"focus",id:ve.id}),children:n.doEdito}),N&&a.focusId===N.id?t.jsx("div",{className:"zoom",children:t.jsx(us,{})}):Fe&&i.pipe?t.jsx(td,{o:Fe}):t.jsx(go,{o:Fe,extra:Fe?null:u})]})]}):t.jsx("div",{className:Re,children:st}),(()=>{const z=fe||[["pt"+a.ptab,ee]];let U=0,_=0;for(const[xe,le]of z){_+=le.length;let ye=a.shown[xe]||S();le.length-ye<=4&&(ye=le.length),U+=Math.min(le.length,ye)}const pe=_-U;return pe<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([xe,le])=>r({type:"more",group:xe,by:le.length,base:S()})),children:[t.jsx("span",{className:"more-label",children:n.more(pe,pe)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(U,_)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}}),I&&v==="ops"&&a.dens!=="maxi"&&t.jsx(Gl,{on:!!fe,rev:(fe||[]).map(([z,U])=>z+U.length).join("|")})]})}function jr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function sd(e,a){const r=xi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function ld(e,a){const n=[a.head.split("|").map(jr).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",sd(i,a.plabels),aa(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(jr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function dd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const cd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function rt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function pd({o:e,qa:a}){const{t:r,lang:n,fund:i}=H(),o=(e.cribleStatus||"").trim().toUpperCase()||(aa(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=mt(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(rt,{k:r.cdSector,v:e.sector}),t.jsx(rt,{k:r.cdStage,v:e.stage}),t.jsx(rt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(rt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(rt,{k:r.cdName,v:e.contactName}),t.jsx(rt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(rt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(rt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(rt,{k:r.cdAngle,v:e.angle}),t.jsx(rt,{k:r.cdDetected,v:cd(e.date,n)})]}),c.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,g])=>g).map(([g,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:s})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function ud(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=H(),[d,c]=m.useState({}),g=25,s=m.useMemo(()=>n.slice(0,g),[n]);m.useEffect(()=>{s.length&&hi(r,s.map(v=>v.name)).then(c)},[r,s]);const f=o.stats,p=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),f&&typeof f.screened=="number"&&t.jsxs("p",{children:[p(f.screened)," ",e.funScreened(""),typeof f.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(f.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(o.marketEstimate)),", ",Math.round(f.screened/o.marketEstimate*100)," %"]})]})]}),s.map(v=>t.jsx(pd,{o:v,qa:d[v.name]},v.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const md=50;function Sn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=H(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[g,s]=m.useState(""),[f,p]=m.useState(0),[v,u]=m.useState(""),[b,y]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>()=>{x.current&&window.clearInterval(x.current)},[]);const N=async k=>{c(!0),s("");const E=await a();if(c(!1),E.ok){l(E);return}if(E.busy){s(i.alertPreviewBusy);return}if(!k){s(i.alertPreviewFail);return}p(md),x.current=window.setInterval(()=>{p(T=>T>1?T-1:(x.current&&window.clearInterval(x.current),N(!1),0))},1e3)},S=async()=>{if(n||b)return;y(!0),u("");const k=await r();y(!1),u(k.ok?i.alertTestOk(k.sentTo||""):k.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||f>0,onClick:()=>{N(!0)},children:d?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{S()},children:b?"…":i.alertTest})]}),f>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(f)}),g&&t.jsx("p",{className:"mnote warn",children:g}),v&&t.jsx("p",{className:"mnote",children:v}),!v&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const Rt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Be({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=H();return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function fd(){const{st:e}=H();switch(e.modal){case"chain":return t.jsx(hd,{});case"space":return t.jsx(gd,{});case"alert":return t.jsx(bd,{});case"queue":return t.jsx(jd,{});case"export":return t.jsx(Nd,{});case"plug":return t.jsx(Cd,{});case"recharge":return t.jsx(Ad,{});case"cover":return t.jsx(qd,{});case"dossier":return t.jsx(Td,{});case"crit":return t.jsx(Ld,{});case"tuto":return t.jsx(Fd,{});case"rdv":return t.jsx(xd,{});case"memoalert":return t.jsx(Ed,{});default:return null}}function xd(){const{dispatch:e,fund:a,t:r}=H(),n=a||r.rdvCoFallback;return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:_r,children:vn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Bi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function hd(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:d,caps:c,memoQueued:g,doAnalyse:s}=H(),f=o==="client",p=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),v=e.chain.idx,u=p[v],b=v>=p.length;return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${v+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:v/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!u?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:u.name}),t.jsx("div",{className:"sub",children:[It(u.cc,i)||u.countryLabel,u.sector,u.stage,n.daysAgo(ct(u.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ue(u.engine,i).toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{children:Bt(u.amountEur,i)})]}),Me(u)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ct,{o:u,lg:!0})," ",t.jsx(Fa,{o:u,src:!0})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),f&&Ie(u)&&t.jsxs("div",{className:"vbox",style:{"--c":kt(u)==="retenu"?"var(--brand)":kt(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:kt(u)==="retenu"?"✓ "+n.kept:kt(u)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&u&&c.pipe&&ze(u)===1&&!g.has(u.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(u),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&u&&!(f&&Ie(u))&&(u.noCo&&u.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(u)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function gd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=H(),o=i==="client",l=m.useMemo(()=>o?r.filter(f=>Ie(f)):[],[r,o]),d=m.useMemo(()=>gn(l.filter(f=>kt(f)==="retenu"),{key:"signal",dir:-1}),[l]),c=m.useMemo(()=>l.filter(f=>kt(f)==="ecarte"),[l]),g=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Be,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(f=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof f.score=="number"&&f.score>0?f.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:f.name}),t.jsx("div",{className:"rr",children:f.reasoning||f.tagline||""})]})]},f.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function bd(){const{mode:e}=H();return e==="client"||e==="apercu"?t.jsx(vd,{}):t.jsx(kd,{})}function vd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=H(),[o,l]=m.useState("d"),d=i!=="client";return t.jsxs(Be,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(yd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="w"&&t.jsx(wd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="m"&&t.jsx(bo,{})]})}function yd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[g,s]=m.useState(0);m.useEffect(()=>{let u=!0;return c(!1),In(a).then(b=>{u&&(b?l(b):c(!0))}),()=>{u=!1}},[a,g]);const f=u=>{r||In(a,u).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=u=>!o.sections||o.sections.includes(u),v=u=>{const b=o.sections||e.alertSec.map(([y])=>y);f({sections:p(u)?b.filter(y=>y!==u):[...b,u]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([u,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:p(u),disabled:r,onChange:()=>v(u)}),t.jsxs("span",{children:[b,u==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},u))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Sn,{label:e.alertPreview,readOnly:r,onPreview:()=>Si(a),onTest:()=>Ei(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function wd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[g,s]=m.useState(0);m.useEffect(()=>{let u=!0;return c(!1),Bn(a).then(b=>{u&&(b?l(b):c(!0))}),()=>{u=!1}},[a,g]);const f=u=>{r||Bn(a,u).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=o.dow??0,v=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:u=>f({dow:Number(u.target.value)}),children:e.alertDow.map((u,b)=>t.jsx("option",{value:b,children:u},u))}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[v," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,v+1)}),disabled:r,children:"+"})]})]}),t.jsx(Sn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>zi(a),onTest:()=>Ci(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function bo(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=H(),[l,d]=m.useState(o||""),[c,g]=m.useState(!1),[s,f]=m.useState(!1);m.useEffect(()=>{o&&d(o)},[o]);const p=e.filters,v=m.useMemo(()=>n.filter(x=>Me(x)).length,[n]),u=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){f(!0);try{await fetch(`${mn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:p.sector,countries:p.country,source:o?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{f(!1)}}},y=[[a.amRows.continent,i],[a.amRows.since,a.amSince[u]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(x=>Ue(x,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(x=>It(x,r)||x).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([x,N])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:x}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:N}})]},x))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:x=>d(x.target.value),onKeyDown:x=>{x.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function kd(){const{t:e}=H();return t.jsx(Be,{title:e.alertTitle,icon:"🔔",children:t.jsx(bo,{})})}function jd(){var P,I;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:d,dispatch:c,liveMemos:g}=H(),[s,f]=m.useState(()=>Oa(r)),[p,v]=m.useState(()=>!Oa(r)),[u,b]=m.useState([]),[y,x]=m.useState(0),N=n==="client",S=m.useMemo(()=>{const j=new Map;return i.forEach(R=>{const h=(R.name||"").trim().toLowerCase();h&&!j.has(h)&&j.set(h,R)}),j},[i]);m.useEffect(()=>{let j=!0;return(!Oa(r)||y>0)&&v(!0),(async()=>{const[R,h]=await Promise.all([xn(r,y>0),Tr(a)]);j&&(R&&f(R),v(!1),b(h))})(),()=>{j=!1}},[a,r,y]);const k=p&&!s,E=(s==null?void 0:s.per_day)??0,T=((P=s==null?void 0:s.analyzed_today)==null?void 0:P.length)??0,C=s==null?void 0:s.offre,L=(s==null?void 0:s.pool_meta)||[],q=m.useMemo(()=>{const j=new Map;for(const R of(s==null?void 0:s.scheduled)||[])for(const h of R.names||[])j.has(h)||j.set(h,{label:R.day_label,date:R.date});return j},[s==null?void 0:s.scheduled]),D=(s==null?void 0:s.in_progress)||[];return t.jsxs(Be,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(T,T+(((I=s==null?void 0:s.pool_order)==null?void 0:I.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(E)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(D.length>0||g.items.some(j=>j.status==="boot"||j.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(j=>j.status==="boot"||j.status==="running"||j.status==="error").map(j=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:j.name}),t.jsx("span",{className:"qd",children:j.memoType||""}),t.jsx(Qt,{item:j,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+j.name)),D.filter(j=>!g.liveOf(j.name)).map(j=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:j.name}),t.jsxs("span",{className:"qd",children:[j.memo_type||"",j.age_min?` · ${Math.round(j.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:j.state||""})]},"ip-"+j.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(j=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:j.company}),t.jsxs("span",{className:"qd",children:[j.memo_type,typeof j.est_min=="number"?` · ~${j.est_min} min`:""]}),t.jsx("span",{className:"qt",children:j.status}),j.url&&t.jsx("a",{className:"qgo",href:j.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),N&&j.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Pn(a,j.company,"retry").then(()=>x(R=>R+1))},children:e.queueRetry}),N&&j.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Pn(a,j.company,"delete").then(()=>x(R=>R+1))},children:e.queueDelete})]},j.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((j,R)=>{const h=q.get(j.name),A=S.get((j.name||"").trim().toLowerCase()),B=g.liveOf(j.name),Y=!!(A&&l.has(A.id))||!!(B&&(B.status==="boot"||B.status==="running")),V=!!(A&&ze(A)===1&&!A.memoUrl)&&!B;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:j.name}),j.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof j.score=="number"&&t.jsx("span",{className:"qs2",children:j.score}),B&&(B.status==="boot"||B.status==="running")&&t.jsx(Qt,{item:B,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),V&&(d.lockActions||!N?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:Y,onClick:()=>{o(A),x(K=>K+1)},children:Y?e.actAnalyseQueued:e.actAnalyse})),j.excerpt&&t.jsx("span",{className:"qex",children:j.excerpt})]},j.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([j,R])=>t.jsxs("li",{children:[t.jsx("b",{children:j})," — ",R]},j))})]})}function Nd(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=H(),d=`${Rt}/cibles/list.csv?token=${a}`,c=`${Rt}/cibles/list.json?token=${a}`,g=`${Rt}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,f=y=>{var x;(x=navigator.clipboard)==null||x.writeText(y).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:g,href:g}],v=!i.lockActions&&n.length>0,u=()=>{dd(ld(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:y=>(e.stg.find(([x])=>x===y)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Be,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:u,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:y,value:x,href:N})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>f(x),children:e.exportCopy}),N&&t.jsx("a",{className:"exb",href:N,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Ed(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=H(),o=i!=="client",[l,d]=m.useState(null),[c,g]=m.useState(!1),[s,f]=m.useState(0),[p,v]=m.useState(!1);m.useEffect(()=>{let x=!0;return g(!1),Dn(a).then(N=>{x&&(N?d(N):g(!0))}),()=>{x=!1}},[a,s]);const u=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=x=>{if(o||!l)return;const N={enabled:x.enabled??!!l.enabled,email:x.email??(l.email||""),sections:x.sections??u()};v(!0),Dn(a,N).then(S=>{if(v(!1),!S){n(e.memoAlertErr);return}d(S),r(e.memoAlertSaved)})};if(c)return t.jsx(Be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(x=>x+1),children:e.retry})]})});if(!l)return t.jsx(Be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=u();return t.jsxs(Be,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||p,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Sd,{value:l.email||"",readOnly:o||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:x=>b({email:x})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([x,N])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[x],disabled:o||p,onChange:()=>b({sections:{...y,[x]:!y[x]}})}),t.jsx("span",{children:N})]},x))}),t.jsx(Sn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>bi(a,y),onTest:()=>gi(a,y)})]})}function Sd({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const d=o.trim()!==e.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&d&&c&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>i(o.trim()),children:n})]})]})}function Cd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=H(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[g,s]=m.useState(null),[f,p]=m.useState(""),[v,u]=m.useState(0);m.useEffect(()=>{let S=!0;return c(!1),Ka(a).then(k=>{S&&(k?l({configured:k.configured,url_hint:k.url_hint}):c(!0))}),wi(a).then(k=>{S&&s(k)}),()=>{S=!1}},[a,v]);const b=(S,k)=>{i&&Ka(a,S).then(E=>{if(!E||E.ok===!1){n(e.actErr);return}S.test&&E.sent===!1?n(e.plugTestThrottled):r(k),u(T=>T+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',x=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),N=`curl -X POST ${Rt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Be,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>u(S=>S+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:f,disabled:!i,onChange:S=>p(S.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!f.trim(),onClick:()=>b({url:f.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:x}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(x).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(zd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:N}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(N).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function zd(){const{t:e,token:a,lang:r}=H(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[d,c]=m.useState(null),[g,s]=m.useState(null),[f,p]=m.useState(!1),[v,u]=m.useState(!1),[b,y]=m.useState(null),[x,N]=m.useState(null),[S,k]=m.useState(null),E=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Ka(a).then(I=>{N(I&&I.configured?I.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{c(null),s(null),p(!1),y(null);try{const I=JSON.parse(localStorage.getItem(E)||"null");k(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{k(null)}},[E]);const T=async()=>{l(!0),p(!1),y(null);const I=await ji(a,n);c(I),s(I.ok?n:null),l(!1)},C=m.useRef(!1),L=async()=>{if(C.current)return;C.current=!0,u(!0);const I=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let j;try{j=await Ni(a,n,"webhook",void 0,I)}finally{C.current=!1}if(u(!1),p(!1),y(j),j.ok&&(j.pushed||0)>0){const R={t:new Date().toISOString(),n:j.pushed||0};k(R);try{localStorage.setItem(E,JSON.stringify(R))}catch{}}},q=d!=null&&d.ok&&d.ready||0,D=!!(d!=null&&d.ok)&&g===n&&q>0&&!!x&&!S,P=S?new Date(S.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:I=>i(I.target.value),children:e.plugBulkTabs.map(([I,j])=>t.jsx("option",{value:I,children:j},I))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{T()},children:o?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),S&&t.jsx("p",{className:"mnote",children:e.bulkLocked(P,S.n)}),!S&&!!(d!=null&&d.ok)&&!x&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!S&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),D&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),D&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(q,x||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{L()},children:v?e.bulkSending:e.bulkConfirm(x||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>p(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function Ad(){const{t:e,data:a,lang:r}=H(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const d=window.location.href.split("?")[0];try{const g=await(await fetch(`${mn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Be,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Td(){const{t:e}=H();return t.jsx(Be,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(ud,{})})}function qd(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:d}=H(),[c,g]=m.useState(null),[s,f]=m.useState(!1);m.useEffect(()=>{let q=!0;if(o)return xn(o).then(D=>{q&&D&&typeof D.per_day=="number"&&g(D.per_day)}),()=>{q=!1}},[o]);const[p,v]=m.useState(null);m.useEffect(()=>{if(!i)return;let q=!0;return yi(i).then(D=>{q&&v(D)}),()=>{q=!1}},[i]);const u=r.stats,b=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(q=>q.kind==="target"&&Ie(q)).length,y=r.marketEstimate||0,x=y>0?Math.min(100,Math.round(b/y*100)):null,N=(u==null?void 0:u.window_days)||30,S=b>0?b/N:0,k=y>0?Math.max(0,y-b):0,T=y>0&&S>0&&b>=100?Math.round(k/S):null,C=q=>Math.round(q).toLocaleString(a==="en"?"en-US":"fr-FR"),L=q=>{s||!l||(f(!0),ki(i,q).then(D=>{if(f(!1),D===null){d(e.actErr);return}g(D),d(e.alertSaved)}))};return t.jsxs(Be,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(b))}),y>0&&t.jsx("span",{children:e.covOf(C(y))})]}),x!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:x+"%"}}),t.jsxs("em",{children:[x," %"]})]}),T!==null&&t.jsx("p",{className:"mnote",children:e.covEta(T)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),S>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(S))}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&u.shown!==u.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(u.shown)})," ",e.funShown]})]}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((q,D)=>t.jsxs("tr",{className:q.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[q.code,q.geo?` · ${q.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof q.n=="number"?C(q.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:q.source}),q.elargi&&t.jsx("em",{children:e.covWide(String(q.demande||""))}),q.erreur&&t.jsx("em",{children:e.covMissing})]})]},D)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(p.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(q=>t.jsx("button",{type:"button",className:c===q?"on":"",disabled:s,onClick:()=>L(q),children:q===0?"⏸":q},q))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Ld(){var x,N,S;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:d}=H(),c=n==="client",g=m.useMemo(()=>{const k=new Set;return a.forEach(E=>{E.angle&&k.add(E.angle)}),[...k]},[a]),[s,f]=m.useState(""),[p,v]=m.useState(""),[u,b]=m.useState(!1),y=async()=>{const k=s.trim();if(!(!k||u||!c)){b(!0),v("");try{const T=await(await fetch(`${Rt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&v(String(T.reply)),T.job_id){v(e.critChatRunning);const C=async()=>{const L=await fetch(`${Rt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(q=>q.json()).catch(()=>null);if(L&&L.done){v(String(L.reply||L.clarification||L.summary||"✓")),b(!1),L.applied&&i(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),f("");return}f("")}finally{p.startsWith("⏳")||b(!1)}}};return t.jsxs(Be,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((x=o.points)!=null&&x.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((N=o==null?void 0:o.angles)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(k=>{var E,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((E=k.look)!=null&&E.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((T=k.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},k.title)})]}),!!((S=o==null?void 0:o.gate)!=null&&S.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||u,onChange:k=>f(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},disabled:!c||u||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(vi,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(xo[k]||"v-cons"),children:k}),t.jsx("span",{children:E})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",E]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Fd(){const{t:e,dispatch:a,startTour:r}=H(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Be,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const vo="atl2:mapfold",Rd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(vo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Md=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},yo=m.createContext(null),H=()=>{const e=m.useContext(yo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ct({o:e,lg:a}){const{lang:r}=H(),n=Me(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:$n(n,r),children:[n.emoji," ",$n(n,r)]}):null}function Fa({o:e,src:a}){const{lang:r,t:n}=H(),i=Me(e);if(!i)return null;const o=Ri(i),l=Mi(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Rr(i,r))+" · "+n.win7(Mr(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<o?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Od(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=Oe(a);if(i)return e.find(o=>Oe(o.name)===i)||e.find(o=>{const l=Oe(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function Dd(){const{scoped:e,t:a,st:r,dispatch:n}=H(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.filter(f=>!Ze(f)),d=l.length,c=l.filter(f=>!f.noCo).length,g=l.filter(f=>!!f.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const f=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:f,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function wo({o:e}){const{lang:a}=H(),r=Fi(e.cc),n=e.cc?It(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Nr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Pd=!1;function Id(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const ko=e=>`atl2:tour:${e||"anon"}`;function Bd(e){try{return localStorage.getItem(ko(e))==="1"}catch{return!0}}function Er(e){try{localStorage.setItem(ko(e),"1")}catch{}}function $d(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Wd({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var ne;const{lang:l}=Ai(),d=Yi[l],c=rs(e,l,a),[g,s]=m.useReducer(ss,void 0,()=>os((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Md():Rd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),f=m.useRef(!0);m.useEffect(()=>{if(f.current){f.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(vo,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),m.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const w=()=>{window.innerWidth<=760&&s({type:"mapFold",folded:!0})};return w(),window.addEventListener("resize",w),()=>window.removeEventListener("resize",w)},[a]);const p=m.useRef(o);p.current=o,m.useEffect(()=>{var w;(w=p.current)==null||w.call(p,g.filters)},[g.filters]);const[v,u]=m.useState(()=>{if(typeof window>"u")return"both";try{const w=localStorage.getItem("atl2:chrome-mode");if(w==="eval"||w==="filt"||w==="both")return w;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[b,y]=m.useState(null),[x,N]=m.useState(null),[S,k]=m.useState(null),[E,T]=m.useState({kept:0,dropped:0}),[C,L]=m.useState(!1),[q,D]=m.useState(""),[P,I]=m.useState(!1),[j,R]=m.useState(null),[h,A]=m.useState(!1),[B,Y]=m.useState(!1),[,V]=m.useState(0),K=()=>V(w=>w+1),X=m.useRef([]),Q=m.useRef(new Set),ie=m.useRef(new Set),[ae,ce]=m.useState([]),[W,re]=m.useState([]),[ee,Le]=m.useState(0),je=m.useRef(new Map),oe=m.useRef(null),{mode:me}=c,de=m.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),G=de.pipe,Z=c.session.token||"",he=me==="client"&&!e;m.useEffect(()=>{if(!Z||!G)return;let w=!0;const O=async()=>{const te=await Oi(Z);!w||!te||(re(te.runs),Le(Date.now()/1e3-te.now),ce(Ee=>Ee.filter(Se=>!te.runs.some(Xe=>Oe(Xe.company)===Oe(Se.name)))))};O();const F=ae.length>0||W.some(te=>te.status==="running"),$=window.setInterval(()=>{O()},F?8e3:25e3);return()=>{w=!1,window.clearInterval($)}},[Z,G,ae.length,W.some(w=>w.status==="running")]);const se=m.useMemo(()=>{const w=[],O=new Set;for(const F of ae){const $=Oe(F.name);!$||O.has($)||(O.add($),w.push({name:F.name,id:F.id,status:"boot",started:F.started,estMin:F.estMin,memoType:"instant"}))}for(const F of W){const $=Oe(F.company);if(!$||O.has($))continue;O.add($);const te=F.status==="error"?"error":F.status==="done"?"done":"running";w.push({name:F.company,status:te,started:F.started||0,estMin:F.est_min||(F.memo_type==="detailed"?40:15),url:F.url,error:F.error,memoType:F.memo_type})}return w},[ae,W]),fe=w=>se.find(O=>Oe(O.name)===Oe(w))||null,ge=(w,O)=>{ce(F=>F.some($=>Oe($.name)===Oe(w.name))?F:[...F,{name:w.name,id:w.id,started:Date.now()/1e3,estMin:O==="detailed"?40:15}]),Q.current.add(w.id),K()};m.useEffect(()=>{if(document.querySelector(`link[href="${Nr}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=Nr,document.head.appendChild(w)},[]);const be=(w,O=!1)=>{D(w),I(O),oe.current&&clearTimeout(oe.current),oe.current=setTimeout(()=>D(""),O?4200:2400)},qe=w=>be(w,!0),ve=m.useMemo(()=>{const w=new Map;return c.dossiers.forEach(O=>{O.id&&w.set(O.id,O)}),w},[c.dossiers]),Fe=m.useMemo(()=>c.dossiers.filter(w=>Pr(w,g,G)),[c.dossiers,g,G]),et=m.useRef(!1);m.useEffect(()=>{if(et.current||e||c.loading||!c.dossiers.length)return;if(!de.showFunnel||Bd(c.session.token||"")){et.current=!0;return}et.current=!0;const w=window.setTimeout(()=>{Er(c.session.token||""),A(!0)},700);return()=>window.clearTimeout(w)},[e,c.loading,c.dossiers.length,de.showFunnel,c.session.token]);const Ne=m.useMemo(()=>c.dossiers.filter(w=>ls(w,g,G,c.favIds)),[c.dossiers,g,G,c.favIds]),He=m.useMemo(()=>Ti(Fe,c.favIds),[Fe,c.favIds]),Re=m.useRef(!1);m.useEffect(()=>{if(Re.current)return;if(!G||a==="ops"){Re.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Re.current=!0;return}if(c.loading)return;Re.current=!0;const w=qi(He);w!==g.ptab&&s({type:"ptab",tab:w})},[G,a,n==null?void 0:n.ptab,c.loading,He,g.ptab]);const st=m.useMemo(()=>{const w=Hr(c.dossiers);return w?ct(w)===0?d.tourToday:Vr(w,l):d.tourNoRun},[c.dossiers,d,l]),pt=m.useMemo(()=>c.dossiers.some(w=>!!w.memoUrl||!!w.summary||Mt(w)),[c.dossiers]),[ft,tt]=m.useState(!1);m.useEffect(()=>{if(c.loading){tt(!1);return}if(c.dossiers.length>0||c.error){tt(!0);return}const w=window.setTimeout(()=>tt(!0),6e3);return()=>window.clearTimeout(w)},[c.loading,c.dossiers.length,c.error]);const xt=(c.marketEstimate||0)>0||typeof((ne=c.stats)==null?void 0:ne.screened)=="number"&&c.stats.screened>0,ht=m.useMemo(()=>[1,0,2,4,5,3].find(w=>(He[w]||0)>0)??0,[He]),Qe=hn.find(w=>w.key===g.continent),z=g.continent==="monde"?d.contWorld:(l==="fr"?Qe==null?void 0:Qe.fr:Qe==null?void 0:Qe.en)||"";m.useEffect(()=>{const w=O=>{var $;const F=((($=O.detail)==null?void 0:$.name)||"").trim();F&&U(null,F)};return window.addEventListener("ppmap:evaluate",w),()=>window.removeEventListener("ppmap:evaluate",w)}),m.useEffect(()=>{const w=O=>{const F=O.detail||{},$=String(F.id||"").trim(),te=String(F.name||"").trim(),Ee=String(F.url||"").trim(),Se=$&&ve.get($)||Od(c.dossiers,te,Ee);if(Se){if(N(null),G){const we=ze(Se);typeof we=="number"&&we!==g.ptab&&s({type:"ptab",tab:we})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Se.id}),(Se.noCo||["media","nominations","recrutements"].includes(Se.engine||""))&&(Se.url||Se.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Se.url||"",text:[Se.headline,Se.tagline].filter(Boolean).join(`
`)}})):Se.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Se.name,url:Se.url||"",website:Se.website||"",domain:Se.domain||""}}));return}!te&&!Ee||(s({type:"focus",id:$||null}),N({name:te,headline:String(F.text||"").trim()||te,url:Ee,card:F.card}),Ee&&(wa(te)||!te)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee,text:String(F.text||"").trim()}})):te&&!wa(te)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:te}})))};return window.addEventListener("ppmap:focus",w),()=>window.removeEventListener("ppmap:focus",w)}),m.useEffect(()=>{const w=$=>{const te={},Ee=String(($==null?void 0:$.sector)||"").trim();Ee&&(te.sector=[Ee]);const Se=String(($==null?void 0:$.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Se)&&(te.day=Se);const Xe=String(($==null?void 0:$.search)||"").trim();Xe&&(te.search=Xe);const we=String(($==null?void 0:$.dealKind)||"").trim();(we==="ma"||we==="levee"||we==="other")&&(te.dealKind=[we]),Object.keys(te).length&&s({type:"filters",patch:te})},O=$=>w($.detail),F=$=>{$.data&&$.data.type==="pp-filter"&&w($.data)};return window.addEventListener("ppmap:filter",O),window.addEventListener("message",F),()=>{window.removeEventListener("ppmap:filter",O),window.removeEventListener("message",F)}},[]),m.useEffect(()=>{const w=O=>{var te;const F=(((te=O.detail)==null?void 0:te.name)||"").trim().toLowerCase();if(!F)return;const $=c.dossiers.find(Ee=>(Ee.name||"").trim().toLowerCase()===F);$&&s(a==="ops"?{type:"focus",id:$.id}:{type:"popup",id:$.id})};return window.addEventListener("ppmap:similar",w),()=>window.removeEventListener("ppmap:similar",w)});const U=(w,O)=>{const F=((w==null?void 0:w.name)||O||"").trim();if(!he){k({kicker:F});return}!F||C||(L(!0),(async()=>{try{let $=F;const te=((w==null?void 0:w.website)||(w==null?void 0:w.domain)||"").trim();if(te)$=te;else try{const we=await Lr(F);if(we!=null&&we.website)$=we.website;else if(((we==null?void 0:we.candidates)||[]).length===1)$=we.candidates[0].url;else if(((we==null?void 0:we.candidates)||[]).length>1){X.current=[{name:F,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(we.candidates||[]).slice(0,5)},...X.current].slice(0,8),K();return}}catch{}const Ee=await Fr(Z,$,"atelier2"),Se={name:Ee.company||F,verdict:Ee.verdict,reason:Ee.reason||"",remaining:Ee.remaining??null};X.current=[Se,...X.current].slice(0,8),Ee.verdict==="kept"&&T(we=>({...we,kept:we.kept+1})),Ee.verdict==="ruled_out"&&T(we=>({...we,dropped:we.dropped+1}));const Xe=w||c.dossiers.find(we=>(we.name||"").toLowerCase()===F.toLowerCase());Xe&&(Ee.verdict==="kept"?Xe.verdict=Xe.verdict||"MATCH":Ee.verdict==="ruled_out"&&(Xe.verdict="NO MATCH"),Ee.reason&&(Xe.reasoning=Ee.reason)),K()}finally{L(!1)}})())},_=w=>{if(!he){k({kicker:w.name});return}ge(w,"instant"),Ut(Z,"fast_request",w.name||"",""),be(d.memoInstantSent(w.name))},pe=w=>je.current.get(w.id)??c.thumbs.get((w.name||"").trim().toLowerCase()),xe=(w,O)=>s({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:O}}),le=async(w,O,F)=>{const $=w.ceoStatus||"";w.ceoStatus=O,K();const te=await Da(Z,{status:O,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(F==null?void 0:F.note)!==void 0?{note:F.note}:{},...F!=null&&F.via?{via:F.via}:{}});return te.ok?te.skipped?(w.ceoStatus=$,K(),qe(d.actNotPersisted),!1):((F==null?void 0:F.undo)!==!1&&xe(w,$),F!=null&&F.msg&&be(F.msg),(O==="Validé"||O==="Écarté")&&!w.ceoNote&&(F==null?void 0:F.note)===void 0&&R({o:w,yes:O==="Validé"}),!0):(w.ceoStatus=$,K(),qe(d.actErr),!1)},ye=async(w,O)=>{const F=await Da(Z,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:O,via:"note"});return!F.ok||F.skipped?(qe(F.skipped?d.actNotPersisted:d.actErr),!1):(w.ceoNote=O,K(),!0)},$e=m.useRef(new Map),At=w=>$e.current.has(w.id)?$e.current.get(w.id):c.stages.get((w.name||"").trim().toLowerCase()),gt=(w,O)=>{$e.current.set(w.id,O),K()},Tt=(w,O)=>{he&&le(w,O?"Validé":"Écarté",{msg:O?d.decidedYes(w.name):d.decidedNo(w.name)})},ut=w=>{he&&le(w,"À trancher",{msg:d.promoted(w.name)})},qt=w=>{he&&(async()=>{const O=w.ceoStatus||"";w.ceoStatus="Retenu",K();const F=await Da(Z,{status:"Retenu",check_id:w.checkId,company:w.name});if(!F.ok||F.skipped){w.ceoStatus=O,K(),qe(F.skipped?d.actNotPersisted:d.actErr);return}xe(w,O),be(d.repeched(w.name))})()},Ve=()=>{const w=g.undo[g.undo.length-1];if(!w){be(d.undoNone);return}const O=ve.get(w.id);if(!O){s({type:"undoPop"}),be(d.undoNone);return}let F=w.prevCeoStatus;if(!F)if((O.verdict||"").toUpperCase().includes("CALL"))F="À trancher";else{be(d.undoLockedTitle);return}(async()=>await le(O,F,{undo:!1})&&(s({type:"undoPop"}),O.ceoStatus=w.prevCeoStatus,K(),be(d.undoDone(O.name))))()},Pe=w=>{he&&(ie.current.add(w.id),K(),(async()=>{const O=await Di(Z,w.name,"email");if(!O||O.ok===!1){ie.current.delete(w.id),K(),qe(d.actErr);return}Ut(Z,"approach",w.name||"",""),be(d.actApproachSent)})())},bt=(w,O)=>{he&&(async()=>{if(!(await Ut(Z,O?"yes":"no",w.name||"","")).ok){qe(d.actErr);return}je.current.set(w.id,O?"yes":"no"),K(),be(O?d.thumbUpDone:d.thumbDnDone)})()},Je=w=>{!he||!Mt(w)||(ge(w,"detailed"),Ut(Z,"detailed_request",w.name||"",""),be(d.memoDeepSent(w.name)))},$t=w=>{const O=new Set(c.favIds),F=O.has(w.id);F?O.delete(w.id):O.add(w.id),c.setFavIds(O),he&&Pi(Z,{id:w.id,co:w.name},F)},_t=()=>{!he||B||window.confirm(d.identSyncConfirm)&&(Y(!0),(async()=>{const w=await Ii(Z);Y(!1),w?be(d.identSyncDone):qe(d.actErr)})())},ra=/proplace/i.test(c.fund||""),Ra=w=>{!he||!ra||(Ut(Z,"onboard_request",w.name||"",""),be(d.onboardSent(w.name)))},M={st:g,dispatch:s,t:d,lang:l,mode:me,caps:de,pipe:G,token:Z,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:qt,thumbOf:pe,canWrite:he,commitStatus:le,saveNote:ye,stageOf:At,setStage:gt,flashErr:qe,startTour:()=>A(!0),dossiers:c.dossiers,scopedAll:Fe,scoped:Ne,counts:He,byId:ve,contName:z,favIds:c.favIds,toggleFav:$t,askEvaluate:U,doAnalyse:_,doDecide:Tt,doPromote:ut,doApproach:Pe,doThumb:bt,doDeep:Je,doUndo:Ve,doSync:_t,doOnboard:Ra,outbound:ra,memoQueued:Q.current,liveMemos:{items:se,serverOff:ee,liveOf:fe},approachDone:ie.current,sessTally:E,evalCards:X.current,evalBusy:C,markRow:y,markedId:b,flash:be,focusExtra:x};m.useEffect(()=>{const w=O=>{O.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]);const J=w=>Z?t.jsx(cs,{token:Z,children:w}):t.jsx(t.Fragment,{children:w});return t.jsx(yo.Provider,{value:M,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(Z?" cibles":"")+" chrome-"+v,children:[t.jsx("style",{children:Qi}),J(t.jsxs("div",{className:"app"+(G?" pipe":"")+(Z?" has-thesis":""),children:[de.showTicker&&t.jsx(at,{name:"live",children:t.jsxs("div",{className:"live-stack"+(Z?" live-stack--cibles":""),children:[t.jsx(hs,{}),!!Z&&t.jsx(ps,{})]})}),de.showIdent&&t.jsx(at,{name:"identite",children:t.jsx(zs,{})}),!1,Pd,de.showFunnel&&t.jsx(at,{name:"entonnoir",children:t.jsx(_d,{})}),!g.mapFolded&&t.jsx(at,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(uo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Dd,{}),t.jsx(Sl,{}),t.jsx(po,{})]})]})}),de.showDemand&&G&&t.jsx(at,{name:"direct",children:t.jsx(Hi,{items:se,serverOff:ee,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":d.chromeBoth,children:[["eval",d.chromeEval],["filt",d.chromeFilt],["both",d.chromeBoth]].map(([w,O])=>t.jsx("button",{type:"button",role:"tab","aria-selected":v===w,onClick:()=>{u(w);try{localStorage.setItem("atl2:chrome-mode",w)}catch{}},children:O},w))}),de.showDemand&&t.jsx(at,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Fl,{})})}),de.showDemand&&g.memoConsole&&t.jsx(at,{name:"console",children:t.jsx(Ml,{})}),t.jsx(at,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(id,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(at,{name:"fiche",children:t.jsx(Ul,{})}),t.jsx(at,{name:"modales",children:t.jsx(fd,{})}),t.jsx(vs,{}),j&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:j.o.name}),t.jsx(Ns,{placeholder:j.yes?d.whyYesPh:d.whyNoPh,onDone:w=>{const O=j.o;R(null),w&&ye(O,w).then(F=>{F&&be(d.csNoteSaved)})}})]}),h&&ft&&t.jsx(Ss,{steps:$d(d,st,pt,ht,xt),onClose:()=>{A(!1),Er(Z)}}),t.jsx(Id,{}),de.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:_r,children:vn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),q&&t.jsx("div",{className:"flash on"+(P?" err":""),children:q}),S&&t.jsx(Li,{variant:"acquirer",initialCompany:Sr().co,initialWebsite:Sr().site,onClose:()=>k(null)})]})})}function _d(){const{t:e}=H(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Sr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ud(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{wo as FlagCell,Ct as SigBadge,Fa as SigWin,Wd as default,Ud as fmtShort,H as useV2};
