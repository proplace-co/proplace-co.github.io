...
.atl2 .bulk .side .hint{white-space:nowrap}`,ls=`
...
`,cs=ss+ls+ds;function en(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function ps(){const e=en("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function us(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=ps();return r==="0"?"client":r==="1"||en("embed")==="1"&&en("chrome")==="1"?"apercu":"client"}const ms={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},fs=e=>ms[e];function wa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const jt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Dr(a)||wa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Yo(e.cc)})};function _a(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const hs=60*60*1e3;function xs(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>hs?null:a}catch{return null}}function sa(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const gs=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function bs(e,a,r="default"){const n=r!=="default",o=u.useMemo(()=>e||n?{mode:"anon"}:Do(),[e,n]),i=u.useMemo(()=>n?"visiteur":us(e,o),[e,o,n]),s=u.useMemo(()=>fs(i),[i]),l=i!=="visiteur",c=gs(r),[g,d]=u.useState([]),[h,p]=u.useState(""),[b,m]=u.useState(null),[v,y]=u.useState(null),[f,N]=u.useState(null),[C,k]=u.useState(()=>new Map),[j,A]=u.useState(()=>new Map),[E,q]=u.useState(""),[z,R]=u.useState(new Set),[D,B]=u.useState(null),[L,F]=u.useState(!0),[x,T]=u.useState(!1),[$,Q]=u.useState(0),[H,M]=u.useState(0),K=u.useRef(0),_=u.useMemo(()=>{var X;if(i!=="client")return"";try{return((X=Io())==null?void 0:X.email)||""}catch{return""}},[i]);u.useEffect(()=>{const X=++K.current;let me=!0;const U=()=>me&&X===K.current,le=(l&&o.token?o.token:"pub:"+a)+(c?":"+c:""),fe=xs(le);return fe?(d(fe.objs.map(jt)),fe.fund&&p(fe.fund),m(fe.marketEstimate??null),y(fe.criteria??null),N(fe.stats??null),q(fe.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const Le=await Da(),ae=((Le==null?void 0:Le.recent_ops)||[]).map(ue=>{const xe=ha(ue.company_name||ue.title?ue:{...ue,title:(ue.headline_fr||ue.headline||"").slice(0,120)},a),ce=String(ue.rubrique||"").toLowerCase();return xe&&(ce==="nominations"||ce==="recrutements")&&(xe.engine=ce),xe&&!String(ue.company_name||"").trim()&&(xe.noCo=!0),xe}).filter(ue=>!!ue).map(ue=>(Dr((ue.name||"").trim())||(ue.noCo=!0),ue));try{const ue=Po(),xe=await Bo(),ce=((xe==null?void 0:xe.date)||"").slice(0,10),Z=ue?ue.doc:xe,ne=_o(Z),se=((ue==null?void 0:ue.day)||(Z==null?void 0:Z.date)||ce||"").slice(0,10);if(se&&ne.length){const ge=new Set;for(const Se of ae){if((Se.date||"").slice(0,10)!==se)continue;const oe=Rn(ne,ge,Se.name,"");oe>=0&&(ge.add(oe),Se.decryptHtml=ne[oe].html)}for(const Se of ae){if(Se.decryptHtml||(Se.date||"").slice(0,10)!==se)continue;const oe=Rn(ne,ge,"",Se.headline||Se.tagline||Se.name);oe>=0&&(ge.add(oe),Se.decryptHtml=ne[oe].html)}}if(se){const ge=((Z==null?void 0:Z.title_fr)||"").trim(),Se=((Z==null?void 0:Z.lead_fr)||"").trim(),oe=$o(Z),pe=((Z==null?void 0:Z.url)||"").trim();ge&&(oe||pe)&&ae.unshift({id:`edito:${se}`,kind:"op",name:ge,cc:null,date:se,engine:"edito",dealKind:"other",headline:ge,tagline:Se||ge,decryptHtml:oe||void 0,url:pe,noCo:!0})}}catch{}if(!U())return;d(ae.map(jt)),sa(le,{objs:ae})}else if(typeof r=="object"){const ae=(await Fn()||[]).filter(xe=>(xe.slug||"")===r.research).map(xe=>Mn(xe,a)).filter(xe=>!!xe),ue=_a(await On(ae,a));if(!U())return;d(ue.map(jt)),sa(le,{objs:ue})}else if(l&&o.token){const Le=Uo(o.token),ae=Da(),ue=Ho(o.token),xe=Vo(o.token),ce=Wo(o.token),Z=await Le;let ne=Z?Z.targets:[];U()&&Z&&(p(Z.fund||""),m(Z.marketEstimate??null),y(Z.criteria??null),N(Z.stats??null),q(Z.generatedAt||""),d(ne.map(jt)),F(!1),T(!1));const[se,ge,Se,oe]=await Promise.all([ae,ue,xe,ce]),pe=((se==null?void 0:se.recent_ops)||[]).map(Ce=>ha(Ce,a)).filter(Ce=>!!Ce),Pe=new Set(ne.map(Ce=>Ce.id));if(ne=[...ne,...pe.filter(Ce=>!Pe.has(Ce.id)&&(Pe.add(Ce.id),!0))],!U())return;d(ne.map(jt));const Oe=new Set;for(const Ce of ge){const ve=(Ce.id||Ce.co||"").toString().trim().toLowerCase();ve&&Oe.add(ve.startsWith("t:")?ve:"t:"+ve)}R(Oe),k(Se),A(oe),Z&&sa(le,{fund:Z.fund,marketEstimate:Z.marketEstimate,criteria:Z.criteria,stats:Z.stats,generatedAt:Z.generatedAt,objs:ne})}else{const Le=Go(),ae=Fn(),ue=Da(),xe=await Le;U()&&xe.length&&(d(_a(xe).map(jt)),F(!1),T(!1));const[ce,Z]=await Promise.all([ae,ue]),ne=(ce||[]).map(oe=>Mn(oe,a)).filter(oe=>!!oe),se=await On(ne,a),ge=((Z==null?void 0:Z.recent_ops)||[]).map(oe=>ha(oe,a)).filter(oe=>!!oe),Se=_a([...xe,...se,...ge]);if(!U())return;d(Se.map(jt)),sa(le,{objs:Se})}U()&&T(!1)}catch{U()&&!fe&&T(!0)}finally{U()&&F(!1)}})(),()=>{me=!1}},[l,o.token,a,$,c]),u.useEffect(()=>{if(!s.showCredits||!_){B(null);return}let X=!0;return(async()=>{try{const me=await fetch(`${gn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:_})});if(!me.ok)return;const U=await me.json();X&&U&&U.ok!==!1&&B(U)}catch{}})(),()=>{X=!1}},[s.showCredits,_,H]);const J=u.useCallback(X=>R(new Set(X)),[]);return{session:o,mode:i,caps:s,fund:h,email:_,marketEstimate:b,generatedAt:E,criteria:v,stats:f,thumbs:C,stages:j,dossiers:g,favIds:z,setFavIds:J,credits:D,reloadCredits:()=>M(X=>X+1),loading:L,error:x,refresh:()=>Q(X=>X+1)}}function Ve(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Vr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),vs=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Vr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ys=new Set(["signal","amount","score","crible","memo"]);function ws(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Vr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ys.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Wr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Wr=80;function ka(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Fe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(bn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(pt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Et(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function ja(e,a,r){return Ve(e)?ka(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ka(e,a.filters,r)}function ks(e,a,r,n){return!(!ja(e,a,r)||r&&!Ko(e,a.ptab,n))}function wn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-pt(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Jo(o);case"memo":return Qo(o);case"signal":{const i=Fe(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const s=n(o),l=n(i);return s<l?-a.dir:s>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const $a={},Kn=($a==null?void 0:$a.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Qn(){return new Date().toISOString().slice(0,10)}const kn=u.createContext(null);function Gr(){return u.useContext(kn)}function js(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),s=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),l.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(d=>c.removeAttribute(d.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Ns(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),s=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(s);!l&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function Jn(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),s=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),s&&n.setAttribute("class",s),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Xn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${i} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${i} ${r[1]}`}function Yr(){const e=u.useContext(kn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Es({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Y(),[i,s]=u.useState(()=>n.filters.day||Qn()),[l,c]=u.useState(null),[g,d]=u.useState(!1),h=u.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){s(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),p=u.useCallback(()=>{s(Qn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);u.useEffect(()=>{const v=y=>{var N;const f=(N=y.detail)==null?void 0:N.day;typeof f=="string"&&h(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[h]),u.useEffect(()=>{n.filters.day&&n.filters.day!==i&&s(n.filters.day)},[n.filters.day]),u.useEffect(()=>{if(!e||!i)return;let v=!1;d(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Kn}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{v||c(f)}).catch(()=>{v||c({ok:!1,error:"network"})}).finally(()=>{v||d(!1)}),()=>{v=!0}},[e,i]);const b=u.useMemo(()=>`${Kn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=u.useMemo(()=>({token:e,day:i,ed:l,loading:g,pickDay:h,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,g,h,p,n.filters.day,b,o]);return t.jsx(kn.Provider,{value:m,children:a})}function Ss(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Yr(),[o,i]=u.useState(()=>n||Ir());return u.useEffect(()=>{n&&i(!0)},[n]),u.useEffect(()=>{const s=l=>{var c;return i(!!((c=l.detail)!=null&&c.open))};return window.addEventListener(va,s),()=>window.removeEventListener(va,s)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Xo,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Cs(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Zn(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function er(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function zs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Yr(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!s,c=a&&!a.ok,g=u.useRef(null),[d,h]=u.useState("fonds"),[p,b]=u.useState(null),[m,v]=u.useState("idle"),y=u.useRef(!1);u.useEffect(()=>{b(null),v("idle"),y.current=!1,h("fonds")},[e]),u.useEffect(()=>{if(d!=="jour"||y.current)return;y.current=!0;let j=!0;return v("load"),Cs(e).then(A=>{j&&(b(A),v("fait"))}),()=>{j=!1}},[d,e]);const f=u.useMemo(()=>Ns((p==null?void 0:p.html)||""),[p==null?void 0:p.html]),N=u.useRef(null);u.useEffect(()=>{const j=N.current;if(!j||!f)return;let A=!1;return Ka(()=>import("./fit-BnaWm7z_.js"),[]).then(async E=>{await E.ensureEditoCss(),!(A||!j.isConnected)&&(E.beautifyEditoRows(j),E.mountCardFits(j))}),()=>{A=!0}},[f]);const C=u.useMemo(()=>Jn((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=u.useMemo(()=>Jn((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return u.useEffect(()=>{const j=g.current;if(!j||!C)return;let A=!1;return Ka(()=>import("./fit-BnaWm7z_.js"),[]).then(async E=>{await E.ensureEditoCss(),!(A||!j.isConnected)&&(E.beautifyEditoRows(j),E.mountCardFits(j))}),()=>{A=!0}},[C]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":d==="fonds",onClick:()=>h("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":d==="jour",onClick:()=>h("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),d==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),d==="fonds"&&r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Zn(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Xn(e,!0)}),"."]}):Zn(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Xn(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>h("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),d==="fonds"&&s&&C?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:C}}):null,d==="fonds"&&s&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,d==="jour"&&(f?t.jsxs(t.Fragment,{children:[(p==null?void 0:p.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:p.title}),t.jsx("div",{ref:N,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:er(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:er(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const As=300,la=7,Ts={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Kr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},qs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ua(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(ai(r)&&r!=="media")return"news:"+r;const n=Fe(e);return n?"sig:"+(n.theme&&Kr.fr[n.theme]?n.theme:"other"):"actualites"}function Ls(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:s,fund:l}=Y(),c=Gr(),g=s==="en",[d,h]=u.useState("all"),[p,b]=u.useState(!1),m=u.useMemo(()=>{var me;const x=(a.filters.day||"").slice(0,10),T=U=>!(!i&&a.continent!=="monde"&&U.continent!==a.continent||x&&(U.date||"").slice(0,10)!==x),$=e.filter(U=>T(U)&&Fe(U)&&(!i||U.kind!=="target"||Ae(U)!==5)),Q=i&&(((me=c==null?void 0:c.ed)==null?void 0:me.ops)||[]).length?c.ed.ops.map(U=>ha(U,s)).filter(U=>!!U).map(U=>(U.briefOnly=!0,U)).filter(U=>!x||(U.date||"").slice(0,10)===x):[],H=e.filter(U=>T(U)&&U.kind==="op"&&(x?!0:pt(U.date)<=la)),M=i?Q.length?Q:H.filter(U=>{const le=(l||"").trim().toLowerCase();if(!le)return!1;const fe=U.match||null;return fe?Object.keys(fe).map(Le=>Le.trim().toLowerCase()).includes(le):!1}):H,K=x||new Date().toISOString().slice(0,10),_=U=>{const le=Ua(U);return le==="ma"?0:le==="levees"?1:2};M.sort((U,le)=>{const fe=_(U)-_(le);if(fe)return fe;const Le=(U.date||"").slice(0,10)===K?0:1,ae=(le.date||"").slice(0,10)===K?0:1;return Le!==ae?Le-ae:(le.amountEur||0)-(U.amountEur||0)});const J=new Set,X=[];for(const U of[...M,...wn($,{key:"signal",dir:-1})]){const le=U.id||U.name;!le||J.has(le)||(J.add(le),X.push(U))}return i&&X.length===0?e.filter(le=>T(le)&&pt(le.date)<=la).sort((le,fe)=>(fe.date||"").localeCompare(le.date||"")).slice(0,80):X},[e,a.continent,a.filters.day,i,l,s,c]),v=u.useMemo(()=>{const x={};for(const T of m){const $=Ua(T);x[$]=(x[$]||0)+1}return x},[m]),y=u.useMemo(()=>d==="all"?m:m.filter(x=>Ua(x)===d),[m,d]),f=u.useMemo(()=>y.slice(0,As),[y]),N=y.length-f.length,C=u.useRef(null);u.useEffect(()=>{var M,K;const x=C.current;if(!x)return;const T=()=>{const _=x.scrollWidth;_<200||(x.style.animationDuration=Math.max(18,Math.round(_/130))+"s")};T();const $=requestAnimationFrame(T),Q=window.setTimeout(T,1200);let H=!0;return(K=(M=document.fonts)==null?void 0:M.ready)==null||K.then(()=>{H&&T()}),()=>{H=!1,cancelAnimationFrame($),window.clearTimeout(Q)}},[f.length,d]);const k=x=>x==="all"?m.length:v[x]||0,j=x=>{if(x==="all")return g?"All":"Tout";if(x.startsWith("sig:"))return Kr[g?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const T=x.slice(5);return ei[T]?ti(T,g?"en":"fr"):x}return Ts[g?"en":"fr"][x]},A=[{k:"all"}],E=["ma","levees"].filter(x=>k(x)>0||x===d);if(E.length){A.push({g:g?"Deals":"Opérations"});for(const x of E)A.push({k:x})}const q=["nominations","recrutements"].filter(x=>k(x)>0||x===d),z=Zo.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===d),R=k("actualites")>0||d==="actualites"?["actualites"]:[];if(q.length||z.length||R.length){A.push({g:g?"News":"Actualités"});for(const x of q)A.push({k:x});for(const x of z)A.push({k:x});for(const x of R)A.push({k:x})}const D=qs.map(x=>"sig:"+x).filter(x=>k(x)>0||x===d);if(D.length){A.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of D)A.push({k:x})}const B=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},L=(()=>{const x=(a.filters.day||"").slice(0,10),T=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(g?`LIVE covers the events of ${B(x)}.`:`Le LIVE regroupe les événements du ${B(x)}.`)+T:(g?`LIVE covers the still-open signals and the deals of the last ${la} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${la} derniers jours.`)+T})(),F=x=>f.map(T=>t.jsxs("button",{type:"button",className:"tk"+(_e(T)?" spent":""),onClick:$=>{const Q=T.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:Q?"":T.id,name:T.name,url:T.url||"",text:T.tagline||T.headline||"",card:T.card}}))}catch{}if(Q||n({type:"focus",id:T.id}),a.dens!=="liste"){const H=$.currentTarget.getBoundingClientRect();n({type:"popup",id:T.id,anchor:{x:H.left+H.width/2,y:H.bottom}})}},title:T.name+(T.tagline?" — "+T.tagline:""),children:[t.jsx(xt,{o:T}),t.jsxs("span",{className:"who",children:[t.jsx(Ao,{o:T}),t.jsx("span",{className:"co",children:T.name})]}),typeof T.amountEur=="number"&&T.amountEur>0&&t.jsx("span",{className:"am",children:oc(T.amountEur)}),T.sector&&t.jsx("span",{className:"mt",children:T.sector}),t.jsx(Fa,{o:T}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(T.id||T.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>b(x=>!x),children:[j(d),t.jsx("b",{children:k(d)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:L}),A.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===d,onClick:()=>{h(x.k),b(!1)},children:[j(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:C,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(Fs,{isEn:g})]})}const Rs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Fs({isEn:e}){const[a,r]=u.useState(()=>Ir());u.useEffect(()=>{const o=i=>{var s;return r(!!((s=i.detail)!=null&&s.open))};return window.addEventListener(va,o),()=>window.removeEventListener(va,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>ni(!a),children:Rs})}const jn="+33 6 83 10 72 86",Na="alexandre@proplace.co",Qr=`tel:${jn.replace(/[^\d+]/g,"")}`;function Ms(){return null}class tt extends u.Component{constructor(){super(...arguments);qn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Jr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function tr(e,a){if((gt(e)||"").startsWith("CALL")&&Ae(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ae(e)>=2;return Jr.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}function Os({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:s}=Y(),[l,c]=u.useState(""),[g,d]=u.useState(!1);if(!r.pipe||!n||r.lockActions||e.kind==="op")return null;const h=(e.ceoStatus||"").trim(),p=async m=>{if(l)return;if(m==="Analysé"&&!e.memoUrl){d(!0);return}c(m);const v=(tr(e,a).find(([f])=>f===m)||[m,m])[1],y=await o(e,m,{msg:a.csMoved(e.name,v)});c(""),y&&d(!1)},b=tr(e,a);return b.length===2?t.jsx("span",{className:"rstat rst2",onClick:m=>m.stopPropagation(),children:b.map(([m,v])=>t.jsx("button",{type:"button",className:"rsd "+(m==="Validé"?"yes":"no")+(l===m?" busy":""),disabled:!!l,onClick:()=>{p(m)},children:v},m))}):t.jsxs("span",{className:"rstat",onClick:m=>m.stopPropagation(),children:[t.jsxs("select",{className:"rsel rs-"+(h==="Retenu"?"ret":h==="Analysé"?"ana":h==="À trancher"?"tra":h==="Validé"?"val":h==="Écarté"?"eca":"off"),value:h,disabled:!!l,title:a.csLabel,onChange:m=>{const v=m.target.value;v&&v!==h&&p(v)},children:[!h&&t.jsx("option",{value:"",children:a.csNone}),b.map(([m,v])=>t.jsx("option",{value:m,children:v},m))]}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{i(e),d(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const m=await o(e,"Analysé");c(""),m&&d(!1)})()},children:a.csAnaAnyway})]})})]})}function Ds({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Y(),[i,s]=u.useState(""),[l,c]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(gt(e)||"").startsWith("CALL")&&Ae(e)===3,h=Ae(e)>=2,p=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(m);const v=await o(e,m);s(""),v&&(c(!0),setTimeout(()=>c(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:Jr.filter(([m])=>!(h&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{p(m)},children:v},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Is,{o:e})]})}function Is({o:e}){const{t:a,saveNote:r,flash:n}=Y(),[o,i]=u.useState(e.ceoNote||""),[s,l]=u.useState(!1),[c,g]=u.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),h=async()=>{if(s||!d)return;l(!0);const p=await r(e,o.trim());l(!1),p&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:s,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&h()}}),t.jsx("button",{type:"button",disabled:s||!d,onClick:()=>{h()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Ps({placeholder:e,onDone:a}){const{t:r}=Y(),[n,o]=u.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Bs({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:s,flashErr:l}=Y(),[c,g]=u.useState(!1);if(!n.pipe||!o||n.lockActions||Ae(e)!==4)return null;const d=i(e),h=(d==null?void 0:d.stage)||"todo",p=async f=>{if(c||f===h)return;g(!0);const N=d;s(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const C=Math.max(Date.now(),ar+=1);ar=C;const k=await ri(r,{company:e.name||"",stage:f,cts:C,deal_id:e.airtableId,check_id:e.checkId});g(!1),!k.stale&&(k.ok||(s(e,N),l(a.actErr)))},b=(y=d==null?void 0:d.stamps)==null?void 0:y.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=h==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,N])=>t.jsx("button",{type:"button",className:"stgb"+(h===f?" on":""),disabled:c,onClick:()=>{p(f)},children:N},f)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let ar=0;const Vt=8,ht=360;function nr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function rr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(nr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(nr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function _s({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Y(),[s,l]=u.useState(0),[c,g]=u.useState(null),[d,h]=u.useState([]),p=u.useRef(!1),b=u.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=u.useRef(!1);u.useEffect(()=>{const E=b.current;return()=>{m.current||(n({type:"ptab",tab:E.ptab}),n({type:"dens",dens:E.dens}),n({type:"modal",modal:E.modal}))}},[]),u.useEffect(()=>{p.current||(p.current=!0,h(e.filter(E=>!!document.querySelector(E.need||E.sel))))},[e]);const v=d[s],y=s>=d.length;u.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const E=v.click,q=window.setTimeout(()=>{const z=document.querySelector(E);z&&z.getAttribute("aria-selected")!=="true"&&z.click()},60);return()=>window.clearTimeout(q)}},[s,v]);const f=u.useRef(-1),N=u.useCallback(()=>{if(!v){g(null);return}const E=R=>{if(!R)return null;for(const D of document.querySelectorAll(R)){const B=D.getBoundingClientRect();if(B.width>1&&B.height>1)return D}return null},q=E(v.sel)||E(v.need);if(!q){g(null);return}f.current!==s&&(f.current=s,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const z=q.getBoundingClientRect();g(R=>R&&Math.abs(R.top-z.top)<1&&Math.abs(R.left-z.left)<1&&Math.abs(R.width-z.width)<1&&Math.abs(R.height-z.height)<1?R:z)},[v,s]);u.useLayoutEffect(()=>{N();const E=[90,300,700,1300].map(R=>window.setTimeout(N,R)),q=window.setInterval(N,400),z=()=>N();return window.addEventListener("scroll",z,!0),window.addEventListener("resize",z),()=>{E.forEach(R=>window.clearTimeout(R)),window.clearInterval(q),window.removeEventListener("scroll",z,!0),window.removeEventListener("resize",z)}},[N]);const C=u.useRef(a);if(C.current=a,u.useEffect(()=>{const E=q=>{q.key==="Escape"?(q.preventDefault(),q.stopPropagation(),C.current()):q.key==="ArrowRight"?l(z=>z+1):q.key==="ArrowLeft"&&l(z=>Math.max(0,z-1))};return document.addEventListener("keydown",E,!0),()=>document.removeEventListener("keydown",E,!0)},[]),!d.length)return null;let k=null;const j=E=>()=>{m.current=!0,n({type:"modal",modal:null}),E()};if(y){const E=o[3]||0;E>0?k={title:E===1?r.ahaATitle1:r.ahaATitleN(E),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let A={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:ht};if(!y&&c){const E=c.bottom+14,q=window.innerHeight-E;let z=q>190?E:Math.max(12,c.top-200),R=Math.min(Math.max(12,c.left+c.width/2-ht/2),window.innerWidth-ht-12);q<=190&&c.top<212&&(window.innerWidth-c.right>=ht+40?R=Math.min(c.right+26,window.innerWidth-ht-12):c.left>=ht+40&&(R=Math.max(12,c.left-ht-26)),z=Math.max(12,c.top-Vt)),A={left:R,top:z,width:ht}}return It.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Vt,top:c.top-Vt,width:c.width+Vt*2,height:c.height+Vt*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:A,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(rr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(rr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>l(E=>Math.max(0,E-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(E=>E+1),children:s===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Xr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Zr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function $s(){var q,z;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:s,data:l,dispatch:c}=Y(),g=r?a:e,d=u.useMemo(()=>g.filter(R=>pt(R.date)===0&&R.kind==="target"),[g]),h=u.useMemo(()=>r?a.filter(R=>R.kind==="target"&&Ae(R)===0).slice().sort((R,D)=>(D.date||"").localeCompare(R.date||"")):[],[a,r]),p=u.useMemo(()=>d.filter(R=>r?Ae(R)===0:!_e(R)),[d,r]),b=r?h:p,m=r?a.length-h.length:d.length-p.length,v=r?a.length:d.length,y=v?Math.min(100,m/v*100):100,f=u.useMemo(()=>Xr(g),[g]),N=!!f&&pt(f)>0,C=u.useMemo(()=>N?g.filter(R=>(R.date||"").slice(0,10)===f):[],[g,f,N]),k=typeof((q=l.stats)==null?void 0:q.kept_today)=="number"?l.stats.kept_today:null,j=typeof((z=l.stats)==null?void 0:z.screened_today)=="number"?l.stats.screened_today:d.length;let A;N?A=o.morningLast(C.length,h.length,Zr(f,s)):r?A=o.morningThesis(j,h.length,k):d.length?m===0?A=o.goalSourced(d.length):m>=d.length?A=o.goalCleared:A=o.goalDone(m,d.length):A=o.goalSourced(0);const E=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&h.length&&c({type:"chainStart",queue:h.map(R=>R.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:A}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:E,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Us(){var $,Q;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:s,dossiers:l,mode:c,doSync:g,startTour:d,flash:h,flashErr:p}=Y(),[b,m]=u.useState(null),[v,y]=u.useState(!0),[f,N]=u.useState([]),C=c==="client";u.useEffect(()=>{if(!o||!i)return;let H=!0;return y(!0),(async()=>{const[M,K]=await Promise.all([vn(i),Pr(o)]);H&&(M&&m(M),y(!1),N(K))})(),()=>{H=!1}},[o,i]);const[k,j]=u.useState(!1),A=()=>{!C||k||!i||(j(!0),oi(i).then(H=>{j(!1),H?h(e.identRepubDone):p(e.actErr)}))},E=(b==null?void 0:b.per_day)??null,q=(($=b==null?void 0:b.pool_order)==null?void 0:$.length)??0,z=f.filter(H=>H.status==="running").length,R=u.useMemo(()=>l.filter(H=>H.kind==="target"&&_e(H)).length,[l]),D=s.marketEstimate,B=typeof((Q=s.stats)==null?void 0:Q.screened)=="number"?s.stats.screened:R,L=D&&D>0?Math.min(100,Math.round(B/D*100)):null,F=H=>H.toLocaleString(a==="en"?"en-US":"fr-FR"),x=(i||"P").split(/\s+/).map(H=>H[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const H=Date.parse(s.generatedAt||"");if(Number.isNaN(H))return"";const M=new Date(H),K=_=>String(_).padStart(2,"0");return`${K(M.getDate())}/${K(M.getMonth()+1)} à ${K(M.getHours())}:${K(M.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?x:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),T?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(T)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&B>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:F(B)})})]}),L!==null&&D&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(B,D)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),E!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:E})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),E===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),z>0&&t.jsxs("span",{className:"ev",children:["⏳ ",z]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(q)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:H=>{H.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!C||k,onClick:A,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!C,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:H=>n({type:"filters",patch:{search:H.target.value}})})]})]})]})}class Ct{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],s=a+i,l=Math.abs(a)<Math.abs(i)?a-(s-i):i-(s-a);l&&(r[n++]=l),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,o=a[--r],s=n+o,i=o-(s-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=s+o,o==n-s&&(s=n))}return s}}function*Hs(e){for(const a of e)yield*a}function eo(e){return Array.from(Hs(e))}var Ne=1e-6,he=Math.PI,Ye=he/2,or=he/4,Qe=he*2,lt=180/he,He=he/180,ze=Math.abs,Vs=Math.atan,Xt=Math.atan2,Te=Math.cos,qe=Math.sin,Ws=Math.sign||function(e){return e>0?1:e<0?-1:0},At=Math.sqrt;function Gs(e){return e>1?0:e<-1?he:Math.acos(e)}function Zt(e){return e>1?Ye:e<-1?-Ye:Math.asin(e)}function Ke(){}function Ea(e,a){e&&sr.hasOwnProperty(e.type)&&sr[e.type](e,a)}var ir={Feature:function(e,a){Ea(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ea(r[n].geometry,a)}},sr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){tn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)tn(r[n],a,0)},Polygon:function(e,a){lr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)lr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ea(r[n],a)}};function tn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function lr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)tn(e[r],a,1);a.polygonEnd()}function qt(e,a){e&&ir.hasOwnProperty(e.type)?ir[e.type](e,a):Ea(e,a)}function an(e){return[Xt(e[1],e[0]),Zt(e[2])]}function Mt(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*qe(a),qe(r)]}function da(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Sa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ha(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ca(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function nn(e){var a=At(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function rn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function on(e,a){return ze(e)>he&&(e-=Math.round(e/Qe)*Qe),[e,a]}on.invert=on;function Ys(e,a,r){return(e%=Qe)?a||r?rn(cr(e),pr(a,r)):cr(e):a||r?pr(a,r):on}function dr(e){return function(a,r){return a+=e,ze(a)>he&&(a-=Math.round(a/Qe)*Qe),[a,r]}}function cr(e){var a=dr(e);return a.invert=dr(-e),a}function pr(e,a){var r=Te(e),n=qe(e),o=Te(a),i=qe(a);function s(l,c){var g=Te(c),d=Te(l)*g,h=qe(l)*g,p=qe(c),b=p*r+d*n;return[Xt(h*o-b*i,d*r-p*n),Zt(b*o+h*i)]}return s.invert=function(l,c){var g=Te(c),d=Te(l)*g,h=qe(l)*g,p=qe(c),b=p*o-h*i;return[Xt(h*o+p*i,d*r+b*n),Zt(b*r-d*n)]},s}function Ks(e,a,r,n,o,i){if(r){var s=Te(a),l=qe(a),c=n*r;o==null?(o=a+n*Qe,i=a-c/2):(o=ur(s,o),i=ur(s,i),(n>0?o<i:o>i)&&(o+=n*Qe));for(var g,d=o;n>0?d>i:d<i;d-=c)g=an([s,-l*Te(d),-l*qe(d)]),e.point(g[0],g[1])}}function ur(e,a){a=Mt(a),a[0]-=e,nn(a);var r=Gs(-a[1]);return((-a[2]<0?-r:r)+Qe-Ne)%Qe}function to(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Ke,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function xa(e,a){return ze(e[0]-a[0])<Ne&&ze(e[1]-a[1])<Ne}function pa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function ao(e,a,r,n,o){var i=[],s=[],l,c;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,y=m[0],f=m[v],N;if(xa(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),l=0;l<v;++l)o.point((y=m[l])[0],y[1]);o.lineEnd();return}f[0]+=2*Ne}i.push(N=new pa(y,m,null,!0)),s.push(N.o=new pa(y,null,N,!1)),i.push(N=new pa(f,m,null,!1)),s.push(N.o=new pa(f,null,N,!0))}}),!!i.length){for(s.sort(a),mr(i),mr(s),l=0,c=s.length;l<c;++l)s[l].e=r=!r;for(var g=i[0],d,h;;){for(var p=g,b=!0;p.v;)if((p=p.n)===g)return;d=p.z,o.lineStart();do{if(p.v=p.o.v=!0,p.e){if(b)for(l=0,c=d.length;l<c;++l)o.point((h=d[l])[0],h[1]);else n(p.x,p.n.x,1,o);p=p.n}else{if(b)for(d=p.p.z,l=d.length-1;l>=0;--l)o.point((h=d[l])[0],h[1]);else n(p.x,p.p.x,-1,o);p=p.p}p=p.o,d=p.z,b=!b}while(!p.v);o.lineEnd()}}}function mr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Va(e){return ze(e[0])<=he?e[0]:Ws(e[0])*((ze(e[0])+he)%Qe-he)}function Qs(e,a){var r=Va(a),n=a[1],o=qe(n),i=[qe(r),-Te(r),0],s=0,l=0,c=new Ct;o===1?n=Ye+Ne:o===-1&&(n=-Ye-Ne);for(var g=0,d=e.length;g<d;++g)if(p=(h=e[g]).length)for(var h,p,b=h[p-1],m=Va(b),v=b[1]/2+or,y=qe(v),f=Te(v),N=0;N<p;++N,m=k,y=A,f=E,b=C){var C=h[N],k=Va(C),j=C[1]/2+or,A=qe(j),E=Te(j),q=k-m,z=q>=0?1:-1,R=z*q,D=R>he,B=y*A;if(c.add(Xt(B*z*qe(R),f*E+B*Te(R))),s+=D?q+z*Qe:q,D^m>=r^k>=r){var L=Sa(Mt(b),Mt(C));nn(L);var F=Sa(i,L);nn(F);var x=(D^q>=0?-1:1)*Zt(F[2]);(n>x||n===x&&(L[0]||L[1]))&&(l+=D^q>=0?1:-1)}}return(s<-Ne||s<Ne&&c<-1e-12)^l&1}function no(e,a,r,n){return function(o){var i=a(o),s=to(),l=a(s),c=!1,g,d,h,p={point:b,lineStart:v,lineEnd:y,polygonStart:function(){p.point=f,p.lineStart=N,p.lineEnd=C,d=[],g=[]},polygonEnd:function(){p.point=b,p.lineStart=v,p.lineEnd=y,d=eo(d);var k=Qs(g,n);d.length?(c||(o.polygonStart(),c=!0),ao(d,Xs,k,r,o)):k&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),d=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function m(k,j){i.point(k,j)}function v(){p.point=m,i.lineStart()}function y(){p.point=b,i.lineEnd()}function f(k,j){h.push([k,j]),l.point(k,j)}function N(){l.lineStart(),h=[]}function C(){f(h[0][0],h[0][1]),l.lineEnd();var k=l.clean(),j=s.result(),A,E=j.length,q,z,R;if(h.pop(),g.push(h),h=null,!!E){if(k&1){if(z=j[0],(q=z.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),A=0;A<q;++A)o.point((R=z[A])[0],R[1]);o.lineEnd()}return}E>1&&k&2&&j.push(j.pop().concat(j.shift())),d.push(j.filter(Js))}}return p}}function Js(e){return e.length>1}function Xs(e,a){return((e=e.x)[0]<0?e[1]-Ye-Ne:Ye-e[1])-((a=a.x)[0]<0?a[1]-Ye-Ne:Ye-a[1])}const fr=no(function(){return!0},Zs,tl,[-he,-Ye]);function Zs(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,s){var l=i>0?he:-he,c=ze(i-a);ze(c-he)<Ne?(e.point(a,r=(r+s)/2>0?Ye:-Ye),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&c>=he&&(ze(a-n)<Ne&&(a-=n*Ne),ze(i-l)<Ne&&(i-=l*Ne),r=el(a,r,i,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=s),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function el(e,a,r,n){var o,i,s=qe(e-r);return ze(s)>Ne?Vs((qe(a)*(i=Te(n))*qe(r)-qe(n)*(o=Te(a))*qe(e))/(o*i*s)):(a+n)/2}function tl(e,a,r,n){var o;if(e==null)o=r*Ye,n.point(-he,o),n.point(0,o),n.point(he,o),n.point(he,0),n.point(he,-o),n.point(0,-o),n.point(-he,-o),n.point(-he,0),n.point(-he,o);else if(ze(e[0]-a[0])>Ne){var i=e[0]<a[0]?he:-he;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function al(e){var a=Te(e),r=2*He,n=a>0,o=ze(a)>Ne;function i(d,h,p,b){Ks(b,e,r,p,d,h)}function s(d,h){return Te(d)*Te(h)>a}function l(d){var h,p,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(y,f){var N=[y,f],C,k=s(y,f),j=n?k?0:g(y,f):k?g(y+(y<0?he:-he),f):0;if(!h&&(m=b=k)&&d.lineStart(),k!==b&&(C=c(h,N),(!C||xa(h,C)||xa(N,C))&&(N[2]=1)),k!==b)v=0,k?(d.lineStart(),C=c(N,h),d.point(C[0],C[1])):(C=c(h,N),d.point(C[0],C[1],2),d.lineEnd()),h=C;else if(o&&h&&n^k){var A;!(j&p)&&(A=c(N,h,!0))&&(v=0,n?(d.lineStart(),d.point(A[0][0],A[0][1]),d.point(A[1][0],A[1][1]),d.lineEnd()):(d.point(A[1][0],A[1][1]),d.lineEnd(),d.lineStart(),d.point(A[0][0],A[0][1],3)))}k&&(!h||!xa(h,N))&&d.point(N[0],N[1]),h=N,b=k,p=j},lineEnd:function(){b&&d.lineEnd(),h=null},clean:function(){return v|(m&&b)<<1}}}function c(d,h,p){var b=Mt(d),m=Mt(h),v=[1,0,0],y=Sa(b,m),f=da(y,y),N=y[0],C=f-N*N;if(!C)return!p&&d;var k=a*f/C,j=-a*N/C,A=Sa(v,y),E=ca(v,k),q=ca(y,j);Ha(E,q);var z=A,R=da(E,z),D=da(z,z),B=R*R-D*(da(E,E)-1);if(!(B<0)){var L=At(B),F=ca(z,(-R-L)/D);if(Ha(F,E),F=an(F),!p)return F;var x=d[0],T=h[0],$=d[1],Q=h[1],H;T<x&&(H=x,x=T,T=H);var M=T-x,K=ze(M-he)<Ne,_=K||M<Ne;if(!K&&Q<$&&(H=$,$=Q,Q=H),_?K?$+Q>0^F[1]<(ze(F[0]-x)<Ne?$:Q):$<=F[1]&&F[1]<=Q:M>he^(x<=F[0]&&F[0]<=T)){var J=ca(z,(-R+L)/D);return Ha(J,E),[F,an(J)]}}}function g(d,h){var p=n?e:he-e,b=0;return d<-p?b|=1:d>p&&(b|=2),h<-p?b|=4:h>p&&(b|=8),b}return no(s,l,i,n?[0,-e]:[-he,e-he])}function nl(e,a,r,n,o,i){var s=e[0],l=e[1],c=a[0],g=a[1],d=0,h=1,p=c-s,b=g-l,m;if(m=r-s,!(!p&&m>0)){if(m/=p,p<0){if(m<d)return;m<h&&(h=m)}else if(p>0){if(m>h)return;m>d&&(d=m)}if(m=o-s,!(!p&&m<0)){if(m/=p,p<0){if(m>h)return;m>d&&(d=m)}else if(p>0){if(m<d)return;m<h&&(h=m)}if(m=n-l,!(!b&&m>0)){if(m/=b,b<0){if(m<d)return;m<h&&(h=m)}else if(b>0){if(m>h)return;m>d&&(d=m)}if(m=i-l,!(!b&&m<0)){if(m/=b,b<0){if(m>h)return;m>d&&(d=m)}else if(b>0){if(m<d)return;m<h&&(h=m)}return d>0&&(e[0]=s+d*p,e[1]=l+d*b),h<1&&(a[0]=s+h*p,a[1]=l+h*b),!0}}}}}var Wt=1e9,ua=-Wt;function rl(e,a,r,n){function o(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function i(g,d,h,p){var b=0,m=0;if(g==null||(b=s(g,h))!==(m=s(d,h))||c(g,d)<0^h>0)do p.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+h+4)%4)!==m);else p.point(d[0],d[1])}function s(g,d){return ze(g[0]-e)<Ne?d>0?0:3:ze(g[0]-r)<Ne?d>0?2:1:ze(g[1]-a)<Ne?d>0?1:0:d>0?3:2}function l(g,d){return c(g.x,d.x)}function c(g,d){var h=s(g,1),p=s(d,1);return h!==p?h-p:h===0?d[1]-g[1]:h===1?g[0]-d[0]:h===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,h=to(),p,b,m,v,y,f,N,C,k,j,A,E={point:q,lineStart:B,lineEnd:L,polygonStart:R,polygonEnd:D};function q(x,T){o(x,T)&&d.point(x,T)}function z(){for(var x=0,T=0,$=b.length;T<$;++T)for(var Q=b[T],H=1,M=Q.length,K=Q[0],_,J,X=K[0],me=K[1];H<M;++H)_=X,J=me,K=Q[H],X=K[0],me=K[1],J<=n?me>n&&(X-_)*(n-J)>(me-J)*(e-_)&&++x:me<=n&&(X-_)*(n-J)<(me-J)*(e-_)&&--x;return x}function R(){d=h,p=[],b=[],A=!0}function D(){var x=z(),T=A&&x,$=(p=eo(p)).length;(T||$)&&(g.polygonStart(),T&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),$&&ao(p,l,x,i,g),g.polygonEnd()),d=g,p=b=m=null}function B(){E.point=F,b&&b.push(m=[]),j=!0,k=!1,N=C=NaN}function L(){p&&(F(v,y),f&&k&&h.rejoin(),p.push(h.result())),E.point=q,k&&d.lineEnd()}function F(x,T){var $=o(x,T);if(b&&m.push([x,T]),j)v=x,y=T,f=$,j=!1,$&&(d.lineStart(),d.point(x,T));else if($&&k)d.point(x,T);else{var Q=[N=Math.max(ua,Math.min(Wt,N)),C=Math.max(ua,Math.min(Wt,C))],H=[x=Math.max(ua,Math.min(Wt,x)),T=Math.max(ua,Math.min(Wt,T))];nl(Q,H,e,a,r,n)?(k||(d.lineStart(),d.point(Q[0],Q[1])),d.point(H[0],H[1]),$||d.lineEnd(),A=!1):$&&(d.lineStart(),d.point(x,T),A=!1)}N=x,C=T,k=$}return E}}const sn=e=>e;var Wa=new Ct,ln=new Ct,ro,oo,dn,cn,ct={point:Ke,lineStart:Ke,lineEnd:Ke,polygonStart:function(){ct.lineStart=ol,ct.lineEnd=sl},polygonEnd:function(){ct.lineStart=ct.lineEnd=ct.point=Ke,Wa.add(ze(ln)),ln=new Ct},result:function(){var e=Wa/2;return Wa=new Ct,e}};function ol(){ct.point=il}function il(e,a){ct.point=io,ro=dn=e,oo=cn=a}function io(e,a){ln.add(cn*e-dn*a),dn=e,cn=a}function sl(){io(ro,oo)}var Ot=1/0,Ca=Ot,ea=-Ot,za=ea,Aa={point:ll,lineStart:Ke,lineEnd:Ke,polygonStart:Ke,polygonEnd:Ke,result:function(){var e=[[Ot,Ca],[ea,za]];return ea=za=-(Ca=Ot=1/0),e}};function ll(e,a){e<Ot&&(Ot=e),e>ea&&(ea=e),a<Ca&&(Ca=a),a>za&&(za=a)}var pn=0,un=0,Gt=0,Ta=0,qa=0,Lt=0,mn=0,fn=0,Yt=0,so,lo,ot,it,Ge={point:zt,lineStart:hr,lineEnd:xr,polygonStart:function(){Ge.lineStart=pl,Ge.lineEnd=ul},polygonEnd:function(){Ge.point=zt,Ge.lineStart=hr,Ge.lineEnd=xr},result:function(){var e=Yt?[mn/Yt,fn/Yt]:Lt?[Ta/Lt,qa/Lt]:Gt?[pn/Gt,un/Gt]:[NaN,NaN];return pn=un=Gt=Ta=qa=Lt=mn=fn=Yt=0,e}};function zt(e,a){pn+=e,un+=a,++Gt}function hr(){Ge.point=dl}function dl(e,a){Ge.point=cl,zt(ot=e,it=a)}function cl(e,a){var r=e-ot,n=a-it,o=At(r*r+n*n);Ta+=o*(ot+e)/2,qa+=o*(it+a)/2,Lt+=o,zt(ot=e,it=a)}function xr(){Ge.point=zt}function pl(){Ge.point=ml}function ul(){co(so,lo)}function ml(e,a){Ge.point=co,zt(so=ot=e,lo=it=a)}function co(e,a){var r=e-ot,n=a-it,o=At(r*r+n*n);Ta+=o*(ot+e)/2,qa+=o*(it+a)/2,Lt+=o,o=it*e-ot*a,mn+=o*(ot+e),fn+=o*(it+a),Yt+=o*3,zt(ot=e,it=a)}function po(e){this._context=e}po.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Qe);break}}},result:Ke};var hn=new Ct,Ga,uo,mo,Kt,Qt,ta={point:Ke,lineStart:function(){ta.point=fl},lineEnd:function(){Ga&&fo(uo,mo),ta.point=Ke},polygonStart:function(){Ga=!0},polygonEnd:function(){Ga=null},result:function(){var e=+hn;return hn=new Ct,e}};function fl(e,a){ta.point=fo,uo=Kt=e,mo=Qt=a}function fo(e,a){Kt-=e,Qt-=a,hn.add(At(Kt*Kt+Qt*Qt)),Kt=e,Qt=a}let gr,La,br,vr;class yr{constructor(a){this._append=a==null?ho:hl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==br||this._append!==La){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,br=n,La=this._append,vr=this._,this._=o}this._+=vr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ho(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function hl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ho;if(a!==gr){const r=10**a;gr=a,La=function(o){let i=1;this._+=o[0];for(const s=o.length;i<s;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return La}function xl(e,a){let r=3,n=4.5,o,i;function s(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),qt(l,o(i))),i.result()}return s.area=function(l){return qt(l,o(ct)),ct.result()},s.measure=function(l){return qt(l,o(ta)),ta.result()},s.bounds=function(l){return qt(l,o(Aa)),Aa.result()},s.centroid=function(l){return qt(l,o(Ge)),Ge.result()},s.projection=function(l){return arguments.length?(o=l==null?(e=null,sn):(e=l).stream,s):e},s.context=function(l){return arguments.length?(i=l==null?(a=null,new yr(r)):new po(a=l),typeof n!="function"&&i.pointRadius(n),s):a},s.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),s):n},s.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const c=Math.floor(l);if(!(c>=0))throw new RangeError(`invalid digits: ${l}`);r=c}return a===null&&(i=new yr(r)),s},s.projection(e).digits(r).context(a)}function Nn(e){return function(a){var r=new xn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function xn(){}xn.prototype={constructor:xn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function En(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),qt(r,e.stream(Aa)),a(Aa.result()),n!=null&&e.clipExtent(n),e}function xo(e,a,r){return En(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],s=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-s*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([l,c])},r)}function gl(e,a,r){return xo(e,[[0,0],a],r)}function bl(e,a,r){return En(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),s=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([s,l])},r)}function vl(e,a,r){return En(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),s=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([s,l])},r)}var wr=16,yl=Te(30*He);function kr(e,a){return+a?kl(e,a):wl(e)}function wl(e){return Nn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function kl(e,a){function r(n,o,i,s,l,c,g,d,h,p,b,m,v,y){var f=g-n,N=d-o,C=f*f+N*N;if(C>4*a&&v--){var k=s+p,j=l+b,A=c+m,E=At(k*k+j*j+A*A),q=Zt(A/=E),z=ze(ze(A)-1)<Ne||ze(i-h)<Ne?(i+h)/2:Xt(j,k),R=e(z,q),D=R[0],B=R[1],L=D-n,F=B-o,x=N*L-f*F;(x*x/C>a||ze((f*L+N*F)/C-.5)>.3||s*p+l*b+c*m<yl)&&(r(n,o,i,s,l,c,D,B,z,k/=E,j/=E,A,v,y),y.point(D,B),r(D,B,z,k,j,A,g,d,h,p,b,m,v,y))}}return function(n){var o,i,s,l,c,g,d,h,p,b,m,v,y={point:f,lineStart:N,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=j},polygonEnd:function(){n.polygonEnd(),y.lineStart=N}};function f(q,z){q=e(q,z),n.point(q[0],q[1])}function N(){h=NaN,y.point=C,n.lineStart()}function C(q,z){var R=Mt([q,z]),D=e(q,z);r(h,p,d,b,m,v,h=D[0],p=D[1],d=q,b=R[0],m=R[1],v=R[2],wr,n),n.point(h,p)}function k(){y.point=f,n.lineEnd()}function j(){N(),y.point=A,y.lineEnd=E}function A(q,z){C(o=q,z),i=h,s=p,l=b,c=m,g=v,y.point=C}function E(){r(h,p,d,b,m,v,i,s,o,l,c,g,wr,n),y.lineEnd=k,k()}return y}}var jl=Nn({point:function(e,a){this.stream.point(e*He,a*He)}});function Nl(e){return Nn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function El(e,a,r,n,o){function i(s,l){return s*=n,l*=o,[a+e*s,r-e*l]}return i.invert=function(s,l){return[(s-a)/e*n,(r-l)/e*o]},i}function jr(e,a,r,n,o,i){if(!i)return El(e,a,r,n,o);var s=Te(i),l=qe(i),c=s*e,g=l*e,d=s/e,h=l/e,p=(l*r-s*a)/e,b=(l*a+s*r)/e;function m(v,y){return v*=n,y*=o,[c*v-g*y+a,r-g*v-c*y]}return m.invert=function(v,y){return[n*(d*v-h*y+p),o*(b-h*v-d*y)]},m}function Sl(e){return Cl(function(){return e})()}function Cl(e){var a,r=150,n=480,o=250,i=0,s=0,l=0,c=0,g=0,d,h=0,p=1,b=1,m=null,v=fr,y=null,f,N,C,k=sn,j=.5,A,E,q,z,R;function D(x){return q(x[0]*He,x[1]*He)}function B(x){return x=q.invert(x[0],x[1]),x&&[x[0]*lt,x[1]*lt]}D.stream=function(x){return z&&R===x?z:z=jl(Nl(d)(v(A(k(R=x)))))},D.preclip=function(x){return arguments.length?(v=x,m=void 0,F()):v},D.postclip=function(x){return arguments.length?(k=x,y=f=N=C=null,F()):k},D.clipAngle=function(x){return arguments.length?(v=+x?al(m=x*He):(m=null,fr),F()):m*lt},D.clipExtent=function(x){return arguments.length?(k=x==null?(y=f=N=C=null,sn):rl(y=+x[0][0],f=+x[0][1],N=+x[1][0],C=+x[1][1]),F()):y==null?null:[[y,f],[N,C]]},D.scale=function(x){return arguments.length?(r=+x,L()):r},D.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],L()):[n,o]},D.center=function(x){return arguments.length?(i=x[0]%360*He,s=x[1]%360*He,L()):[i*lt,s*lt]},D.rotate=function(x){return arguments.length?(l=x[0]%360*He,c=x[1]%360*He,g=x.length>2?x[2]%360*He:0,L()):[l*lt,c*lt,g*lt]},D.angle=function(x){return arguments.length?(h=x%360*He,L()):h*lt},D.reflectX=function(x){return arguments.length?(p=x?-1:1,L()):p<0},D.reflectY=function(x){return arguments.length?(b=x?-1:1,L()):b<0},D.precision=function(x){return arguments.length?(A=kr(E,j=x*x),F()):At(j)},D.fitExtent=function(x,T){return xo(D,x,T)},D.fitSize=function(x,T){return gl(D,x,T)},D.fitWidth=function(x,T){return bl(D,x,T)},D.fitHeight=function(x,T){return vl(D,x,T)};function L(){var x=jr(r,0,0,p,b,h).apply(null,a(i,s)),T=jr(r,n-x[0],o-x[1],p,b,h);return d=Ys(l,c,g),E=rn(a,T),q=rn(d,E),A=kr(E,j),F()}function F(){return z=R=null,D}return function(){return a=e.apply(this,arguments),D.invert=a.invert&&B,L()}}function go(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}go.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,s=i*i;r-=o=(r*(1.007226+i*(.015085+s*(-.044475+.028874*i-.005916*s)))-a)/(1.007226+i*(.015085*3+s*(-.044475*7+.028874*9*i-.005916*11*s)))}while(ze(o)>Ne&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function zl(){return Sl(go).scale(175.295)}function Al(e){return e}function Tl(e){if(e==null)return Al;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],s=e.translate[1];return function(l,c){c||(a=r=0);var g=2,d=l.length,h=new Array(d);for(h[0]=(a+=l[0])*n+i,h[1]=(r+=l[1])*o+s;g<d;)h[g]=l[g],++g;return h}}function ql(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Ll(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Nr(e,r)})}:Nr(e,a)}function Nr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Rl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Rl(e,a){var r=Tl(e.transform),n=e.arcs;function o(d,h){h.length&&h.pop();for(var p=n[d<0?~d:d],b=0,m=p.length;b<m;++b)h.push(r(p[b],b));d<0&&ql(h,m)}function i(d){return r(d)}function s(d){for(var h=[],p=0,b=d.length;p<b;++p)o(d[p],h);return h.length<2&&h.push(h[0]),h}function l(d){for(var h=s(d);h.length<4;)h.push(h[0]);return h}function c(d){return d.map(l)}function g(d){var h=d.type,p;switch(h){case"GeometryCollection":return{type:h,geometries:d.geometries.map(g)};case"Point":p=i(d.coordinates);break;case"MultiPoint":p=d.coordinates.map(i);break;case"LineString":p=s(d.arcs);break;case"MultiLineString":p=d.arcs.map(s);break;case"Polygon":p=c(d.arcs);break;case"MultiPolygon":p=d.arcs.map(c);break;default:return null}return{type:h,coordinates:p}}return g(a)}const bo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Fl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Ml(e,a,r){const n=bo[e];if(!n||!n.length)return-1;const o=Fl(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(s=>o.includes(s)))return i}return Math.floor(r*n.length)%n.length}let ma=null;function Ol(){return ma||(ma=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Ll(r,n),i=zl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=xl(i),l=(o.features||[]).filter(d=>{var h;return(((h=d.properties)==null?void 0:h.name)||"")!=="Antarctica"}).map(d=>{var b;const h=((b=d.properties)==null?void 0:b.name)||"",p=s(d)||"";return p?{i2:ii(h)||null,n:h,d:p}:null}).filter(d=>!!d);if(!l.length)return null;const c={};for(const[d,h]of Object.entries(si)){const p=i(h);p&&(c[d]={x:p[0],y:p[1]})}const g={};for(const[d,h]of Object.entries(bo)){const p=h.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));p.length&&(g[d]=p)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:c,metros:g}}catch{return null}})(),ma)}function Dl(e){const[a,r]=u.useState(null);return u.useEffect(()=>{if(!e||a)return;let n=!1;return Ol().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Il="8 40 984 210",Pl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Er=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Sr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Bl(e,a){const[r,n]=u.useState(1);return u.useEffect(()=>{let o=!0,i=0;const s=()=>{var g;if(!o)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(s)};s();const l=new ResizeObserver(()=>s());return e.current&&l.observe(e.current),window.addEventListener("resize",s),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function Cr({msgs:e}){const[a,r]=u.useState(0);u.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],s)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function _l(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:s,lang:l,t:c,data:g,dossiers:d,source:h}=Y(),p=g.loading&&!d.length,b=u.useRef(null),m=u.useRef(null),v=Dl(e.continent==="monde"),y=e.continent==="monde"?v:yn.find(x=>x.key===e.continent)||null,f=Bl(b,e.continent+":"+e.mapFolded+":"+!!y),[N,C]=u.useState(new Map),[k,j]=u.useState(null);u.useEffect(()=>{const x=b.current;if(!x)return;const T=new Map;x.querySelectorAll("path[data-i2]").forEach($=>{const Q=$.dataset.i2;if(Q)try{const H=$.getBBox();H.width>0&&T.set(Q,{x:H.x,y:H.y,w:H.width,h:H.height})}catch{}}),C(T)},[e.continent,f,y]);const A=u.useMemo(()=>r.filter(x=>x.cc),[r]),E=u.useMemo(()=>{const x=new Map;return A.forEach(T=>x.set(T.cc,(x.get(T.cc)||0)+1)),x},[A]),q=e.continent==="monde"&&v?v.anchors:null,z=e.continent==="monde"&&v?v.metros:null,R=u.useMemo(()=>A.map(x=>{const T=Sr(x.name||x.id||""),$=Sr((x.id||x.name||"")+"·y");if(q&&x.cc){const _=z?z[x.cc]:void 0;if(_&&_.length){const X=Ml(x.cc,x.city,T);if(X>=0&&_[X])return{d:x,x:_[X].x+(T-.5)*5,y:_[X].y+($-.5)*5}}const J=q[x.cc];if(J)return{d:x,x:J.x+(T-.5)*10,y:J.y+($-.5)*10}}const Q=x.cc?N.get(x.cc):void 0;if(!Q)return null;const H=Pl[`${e.continent}:${x.cc||""}`];if(H)return{d:x,x:Q.x+Q.w*(H.fx+(T-.5)*H.sx),y:Q.y+Q.h*(H.fy+($-.5)*H.sy)};const M=(T-.5)*Math.min(Q.w*.55,60),K=($-.5)*Math.min(Q.h*.55,60);return{d:x,x:Q.x+Q.w/2+M,y:Q.y+Q.h/2+K}}).filter(x=>!!x),[A,N,q,z,e.continent]),D=x=>f>0?x/f:x,B=u.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:Er[x],fr:c.plabels[x].toUpperCase(),en:c.plabels[x].toUpperCase(),n:r.filter(T=>T.kind==="target"&&Ae(T)===x).length})).filter(x=>x.n>0):Dn.map((x,T)=>({...x,n:r.filter($=>In($)===T).length})),[r,n,c.plabels]),L=i?s.get(i):null,F=L?R.find(x=>x.d.id===L.id):null;return y?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:[p&&t.jsx(Cr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?Il:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?y.fr:y.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:y.countries.map((x,T)=>t.jsx("g",{className:"ct"+(x.i2&&E.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},T))}),t.jsx("g",{children:R.map(x=>{const T=Dn[In(x.d)],$=!!Fe(x.d),Q=x.d.kind==="target",H=n&&Q?Er[Ae(x.d)]:T.c,M=!n&&_e(x.d);return t.jsxs("g",{className:"co"+(M?" done":""),onMouseEnter:()=>{var J,X;const K=(J=m.current)==null?void 0:J.getBoundingClientRect(),_=(X=b.current)==null?void 0:X.createSVGPoint();if(_&&b.current&&K){_.x=x.x,_.y=x.y;const me=_.matrixTransform(b.current.getScreenCTM());j({x:me.x-K.left,y:me.y-K.top,label:x.d.name+" · "+(Pt(x.d.cc,l)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var J;if(h==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const K=(J=b.current)==null?void 0:J.createSVGPoint();let _=null;if(K&&b.current){K.x=x.x,K.y=x.y;const X=K.matrixTransform(b.current.getScreenCTM());_={x:X.x,y:X.y}}a({type:"popup",id:x.d.id,anchor:_})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:D(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:D(T.px),fill:H,stroke:$?"#DC2626":"#ffffff",strokeWidth:D($?2.2:1.3)})]},x.d.id||x.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:D(13),fill:"none",stroke:"#0F172A",strokeWidth:D(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:B.map((x,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),l==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},T))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:t.jsx(Cr,{msgs:c.loadMsgs})})}function $l(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function vo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:s,lang:l}=Y(),c=a.filters,[g,d]=u.useState(!1),[h,p]=u.useState(!1),b=u.useRef(null),m=u.useRef(null),v=u.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),y=F=>v.filter(x=>F!=="country"&&c.country.length&&!c.country.includes(x.cc||"")?!1:ka(x,c,i,F==="country"?void 0:F)),f=F=>!i||F.kind!=="op",N=u.useMemo(()=>{const F=y("win").filter(f),x=T=>F.filter($=>($.date?Math.max(0,Math.floor((Date.now()-Date.parse($.date))/864e5)):9999)<=T).length;return[x(0),x(7),x(30),F.length]},[v,c,i]),C=u.useMemo(()=>c.day?y("win").filter(f).filter(F=>(F.date||"").slice(0,10)===c.day).length:0,[v,c,i]),k=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,j=k+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);u.useEffect(()=>{a.openFacet&&d(!1)},[a.openFacet]),u.useEffect(()=>{if(!g&&!h)return;const F=T=>{var Q,H;const $=T.target;g&&!((Q=b.current)!=null&&Q.contains($))&&d(!1),h&&!((H=m.current)!=null&&H.contains($))&&p(!1)},x=T=>{T.key==="Escape"&&(d(!1),p(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",x)}},[g,h]);const A=(F,x,T,$="fbtn")=>t.jsxs("button",{type:"button",className:$,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:x}),T>0&&t.jsx("span",{className:"n",children:T}),t.jsx("span",{className:"cv",children:"▾"})]},F),E=["1","7","30","all"],q=Math.max(0,E.indexOf(c.win||"all")),z=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay($l(c.day,l))}),t.jsx("b",{children:C})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>p(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[q]}),t.jsx("b",{children:N[q]}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:E.map((F,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),p(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:N[x]})]},F))})]}):t.jsx("div",{className:"seg",children:E.map((F,x)=>t.jsxs("button",{type:"button","aria-pressed":c.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:N[x]})]},F))}),R=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),D=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):A("sec",o.fSector,c.sector.length),A("pay",o.fCountry,c.country.length),A("det",o.fEngine,c.engine.length),A("sta",o.fStage,c.stage.length),i&&A("ang","Angle",c.angle.length),i&&A("mem","Mémo",c.memoLevel.length)]}),B=(F=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{d(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:D})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:z}),t.jsxs("div",{className:"fstrip-b",children:[R,L,B(!1)]})]}),a.openFacet&&t.jsx(zr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[z,R,D,t.jsx("span",{className:"fgrow"}),B()]}),a.openFacet&&t.jsx(zr,{poolFor:y})]})}function zr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=Y(),i=a.filters,s=a.openFacet,{title:l,cols:c,options:g}=u.useMemo(()=>{if(s==="sig"){const m=e("signal").filter(f=>Fe(f)),v=new Map;m.forEach(f=>{const N=f.engine||"";v.set(N,(v.get(N)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Qa([...v.keys()],o).map(f=>({v:f,label:St(f)+" "+We(f,o),n:v.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(s==="sec"){const m=e("sector"),v=new Map;return m.forEach(y=>{y.sector&&v.set(y.sector,(v.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:i.sector.includes(y)}))}}if(s==="pay"){const m=e("country"),v=new Map;return m.forEach(y=>{y.cc&&v.set(y.cc,(v.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:Pt(y,o)||y,n:f,html:!1,on:i.country.includes(y)}))}}if(s==="det"){const m=e("engine"),v=new Map;return m.forEach(y=>{y.engine&&v.set(y.engine,(v.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Qa([...v.keys()],o).map(y=>({v:y,label:St(y)+" "+We(y,o)+' <span style="color:var(--dim);font-size:10px">· '+li(di(y),o)+"</span>",n:v.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(s==="ang"){const m=e("angle"),v=new Map;return m.forEach(y=>{y.angle&&v.set(y.angle,(v.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(y)}))}}if(s==="mem"){const m=e("memoLevel"),v=new Map;m.forEach(f=>{if(f.kind==="target"){const N=bn(f);v.set(N,(v.get(N)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:y[f],n:v.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const p=e("stage"),b=new Map;return p.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,v)=>v[1]-m[1]).map(([m,v])=>({v:m,label:m,n:v,html:!1,on:i.stage.includes(m)}))}},[s,a,o]),d=p=>{if(s==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(p)?i.signalEngines.filter(v=>v!==p):[...i.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:p})},h=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:h,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>d(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function yo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:s,t:l}=Y(),c=u.useMemo(()=>{const b={};return r.forEach(m=>{ka(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,d]=u.useState(!1),h=u.useRef(null);u.useEffect(()=>{if(!g)return;const b=v=>{var y;(y=h.current)!=null&&y.contains(v.target)||d(!1)},m=v=>{v.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const p=b=>{const m=yn.find(v=>v.key===b);return b==="monde"?l.contWorld:s==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:h,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>d(b=>!b),children:[p(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Pn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),d(!1)},children:[p(b),t.jsx("span",{className:"n",children:c[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[Pn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[p(b),t.jsx("span",{className:"n",children:c[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function wo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ul(e){var o;const a=[],r=new Set,n=i=>{const s=(i||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Ar({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:s}){const{t:l}=Y();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:l.rsEvalOne})]},c.name))})]}):null}function ko({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=Y(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Ar,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Ar,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Hl({card:e,onEvaluate:a,onAddAll:r}){var l,c,g;const{t:n}=Y(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:wo(e.summary_md||"").map((d,h)=>t.jsx("p",{children:d},h))})]}),t.jsx(ko,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Vl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Wl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:s}=Y(),l=o,[c,g]=u.useState(null),[d,h]=u.useState(null),[p,b]=u.useState(null),[m,v]=u.useState(!1);u.useEffect(()=>{let f=!0;return(async()=>{const N=await Br({email:s,cbToken:l});f&&g(N)})(),()=>{f=!1}},[s,l,n]);const y=f=>{h(f),b(null),v(!0),(async()=>{const N=await ci(f.id);b(N),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{h(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Vl(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!p&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&p&&t.jsx(Hl,{card:p,onEvaluate:a,onAddAll:r})]})]})}const ga=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Jt(e){return/^https?:\/\//i.test((e||"").trim())}function nt(e){const a=(e||"").trim();return a?Jt(a)?a:ga.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Gl(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Yl(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:s,evalBusy:l,evalCards:c,caps:g,data:d,canWrite:h,source:p,dossiers:b,doAnalyse:m,liveMemos:v,pipe:y}=Y(),f=a==="client",N=u.useMemo(()=>r||(p!=="default"?pi():""),[r,p]),[C,k]=u.useState(""),[j,A]=u.useState(!1),[E,q]=u.useState(""),[z,R]=u.useState(""),[D,B]=u.useState(""),[L,F]=u.useState(!1),[x,T]=u.useState(!1),[$,Q]=u.useState(""),[H,M]=u.useState(!1),[K,_]=u.useState(""),[J,X]=u.useState([]),me=u.useRef(!1),[U,le]=u.useState(!1),[fe,Le]=u.useState(!1),[ae,ue]=u.useState(!1),xe=u.useRef(!1),[ce,Z]=u.useState(""),[ne,se]=u.useState(""),[ge,Se]=u.useState(!1),[oe,pe]=u.useState(!1),[Pe,Oe]=u.useState(0),[Ce,ve]=u.useState(""),[ye,Ue]=u.useState(null),[Re,st]=u.useState(null),[ut,bt]=u.useState(!1),[at,vt]=u.useState(null),[yt,Je]=u.useState(0),mt=u.useRef(!1),wt=C.trim()?ga.test(C.trim())?e.evalUrl:e.evalName:e.evalWaiting,S=u.useMemo(()=>$.split(`
`).map(I=>I.trim()).filter(Boolean).slice(0,15),[$]);u.useEffect(()=>{if(typeof window>"u")return;const I=new URLSearchParams(window.location.search),ee=(I.get("rs")||"").trim(),ie=(I.get("rstext")||"").trim();ee&&/^https?:\/\//i.test(ee)&&Z(ee),ie&&se(ie),(ee&&/^https?:\/\//i.test(ee)||ie)&&le(!0)},[]),u.useEffect(()=>{const I=ee=>{const ie=ee.detail||{},w=String(ie.url||"").trim(),P=String(ie.text||"").trim();w&&/^https?:\/\//i.test(w)&&Z(w),P&&se(P),(w&&/^https?:\/\//i.test(w)||P)&&(le(!0),k(""),q(""),Se(!0),window.setTimeout(()=>Se(!1),900))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),u.useEffect(()=>{const I=ee=>{const ie=ee.detail||{},w=String(ie.name||"").trim();if(!w)return;le(!1),k(w),q(w);const P=nt(String(ie.website||ie.domain||""));R(P),B(nt(String(ie.url||""))),F(!P),A(!0),window.setTimeout(()=>A(!1),900)};return window.addEventListener("ppmap:prefill",I),()=>window.removeEventListener("ppmap:prefill",I)},[]),u.useEffect(()=>{const I=(E||"").trim();if(!I||U||z){(z||!I||U)&&F(!1);return}const ee=b.find(P=>Ie(P.name)===Ie(I)),ie=nt((ee==null?void 0:ee.website)||"")||nt((ee==null?void 0:ee.domain)||"");if(ie){R(ie),F(!1);return}let w=!0;return F(!0),_r(I).then(P=>{var W,te;if(!w)return;const O=nt(P.website||"")||nt(((te=(W=P.candidates)==null?void 0:W[0])==null?void 0:te.url)||"");O&&R(O)}).catch(()=>{}).finally(()=>{w&&F(!1)}),()=>{w=!1}},[E,U,z,b]),u.useEffect(()=>{const I=ee=>{var w;const ie=String(((w=ee.detail)==null?void 0:w.url)||"").trim();Jt(ie)&&window.open(ie,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",I),()=>window.removeEventListener("ppmap:view",I)},[]),u.useEffect(()=>{if(xe.current===U)return;xe.current=U,ue(!0);const I=window.setTimeout(()=>ue(!1),560);return()=>window.clearTimeout(I)},[U]),u.useEffect(()=>{if(typeof window>"u")return;const I=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ee=document.querySelector(".atl2.ops, .atl2.cibles");if(!I||!ee)return;const ie=()=>ee.style.setProperty("--demand-h",`${I.offsetHeight}px`);ie();const w=new ResizeObserver(ie);return w.observe(I),()=>w.disconnect()},[p,j,ge,x,U,ae,L]),u.useEffect(()=>{if(!h&&!N){vt(null);return}let I=!0;return(async()=>{const ee=await Br({email:n,cbToken:N});I&&vt(ee.length)})(),()=>{I=!1}},[h,N,n,yt]);const G=J.length?J:c,V=d.credits,re=u.useCallback(I=>{const ee=I.map(ie=>(ie||"").trim()).filter(Boolean);ee.length&&(Q(ie=>{const w=ie.split(`
`).map(W=>W.trim()).filter(Boolean),P=new Set(w.map(W=>W.toLowerCase())),O=ee.filter(W=>!P.has(W.toLowerCase()));return[...w,...O].slice(0,15).join(`
`)}),T(!0))},[]);u.useEffect(()=>{if(!oe)return;Oe(0);const I=window.setInterval(()=>Oe(ee=>ee+1),1e3);return()=>window.clearInterval(I)},[oe]);const be=u.useMemo(()=>{const I=C.trim().toLowerCase();return!I||!y?null:b.find(ee=>Ie(ee.name)===I&&Ae(ee)===1)||null},[C,b,y]),de=()=>{const I=C.trim();if(I){if(be){m(be);return}o(null,I),f&&k("")}},je=async()=>{if(!f){o(null,S[0]||"");return}if(!S.length||H)return;M(!0),me.current=!1;const I=[];for(let ee=0;ee<S.length&&!me.current;ee++){_(e.evaluating(ee+1,S.length,S[ee]));const ie=await $r(r,S[ee],"atelier2");if(I.unshift({name:ie.company||S[ee],verdict:ie.verdict,reason:ie.reason||"",remaining:ie.remaining??null}),X([...I]),ie.verdict==="quota"){I.unshift({name:"",verdict:"quota",reason:e.quota(S.length-ee-1),remaining:0}),X([...I]),Q(S.slice(ee+1).join(`
`)),_(""),M(!1);return}}_(""),Q(me.current?S.slice(I.length).join(`
`):""),M(!1)},Xe=async()=>{var ie,w,P;if(mt.current)return;const I=ce.trim().replace(/\s+/g,""),ee=ne.trim();if(!I&&!ee){ve(e.rsNeed);return}if(!f&&!N){o(null,I||ee.slice(0,80));return}mt.current=!0,ve(""),Ue(null),st(null),pe(!0);try{const O=await mi({url:I,text:ee,email:n,cbToken:N});if(pe(!1),!O||O.status!=="success"){ve((O==null?void 0:O.message)||"Erreur");return}Ue(O),le(!1),re((((ie=O.prospective)==null?void 0:ie.companies_to_evaluate)||[]).map(te=>(te==null?void 0:te.name)||"")),st({state:"pending"});const W=await fi(O,{email:n,cbToken:N});st(W.ok?{state:"ok",scopeLabel:((w=W.summary)==null?void 0:w.scope_label)||"",scope:((P=W.summary)==null?void 0:P.scope)||""}:{state:"fail",msg:W.error||""}),W.ok&&Je(te=>te+1)}finally{mt.current=!1,pe(!1)}},kt=[ye==null?void 0:ye.industry,...(ye==null?void 0:ye.market_tags)||[],ye==null?void 0:ye.author].map(I=>(I||"").trim()).filter(Boolean),ft=(Re==null?void 0:Re.state)==="pending",_t=Re&&(ft?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Re.state==="ok"?t.jsx("span",{className:"rslink ok",children:Re.scope&&Re.scope!=="public"?e.rsSavedIn(Re.scopeLabel||Re.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Re.msg,children:e.rsSaveFail})),Tt=Ul(ye).length,Me=U,De=(E||C).trim(),Ze=b.find(I=>Ie(I.name)===Ie(De)),$t=nt(C)||z||nt((Ze==null?void 0:Ze.website)||"")||nt((Ze==null?void 0:Ze.domain)||""),Ut=D||nt((Ze==null?void 0:Ze.url)||""),oa=be?e.actAnalyse:De?e.evalGoOn(De.length>22?De.slice(0,21)+"…":De):e.evalGo,Ma=oe?`${ui(ce.trim())==="youtube"&&ce.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Pe)}`:ft?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Me?" rs-mode":"")+(E&&C.trim()===E||j||ge?" pair":"")+(j||ge||ae?" echo":"")+(ae?" swap":""),children:[t.jsxs("div",{className:"drow"+((Me?ge:j)||ae?" flash":"")+((Me?ce.trim():ga.test(C.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Me?ce:C,placeholder:Me?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Me?600:200,spellCheck:Me?!1:void 0,inputMode:Me?"url":void 0,onChange:I=>{if(Me){Z(I.target.value);return}k(I.target.value),E&&I.target.value.trim()!==E&&(q(""),R(""),B(""),F(!1))},onKeyDown:I=>{I.key==="Enter"&&(Me?Xe():de())}}),t.jsx("span",{className:"detect"+(Me?" off":"")+(ga.test(C.trim())?" url":""),children:wt})]}),t.jsx("span",{className:"dacts",children:Me?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(oe?" loading":""),disabled:oe||ft||!ce.trim()&&!ne.trim(),onClick:()=>{Xe()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Ma})]}),t.jsxs("a",{className:"viewbtn"+(Jt(ce)?"":" off"),href:Jt(ce)?ce.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:I=>{Jt(ce)||I.preventDefault()},children:[t.jsx(Gl,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(be?" analyse":"")+(l?" loading":""),disabled:l,onClick:de,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:oa})]}),t.jsxs("a",{className:"viewbtn sm"+(L?" searching":$t?"":" off"),href:$t||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":L||void 0,title:L?e.viewSiteBusyHint:e.viewSiteHint,onClick:I=>{$t||I.preventDefault()},children:[L&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),L?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(Ut?"":" off"),href:Ut||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:I=>{Ut||I.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&V&&t.jsxs("button",{type:"button",className:"credits"+(V.total_available<=0&&!V.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:V.unlimited?"∞":V.total_available}),!V.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",V.daily_grant+V.purchased]}),V.total_available<=0&&!V.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>T(!x),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(U?" on":""),onClick:()=>le(!U),children:e.rsOpen}),at!==null&&at>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ut?" on":""),onClick:()=>bt(!ut),children:e.rsArchOpen(at)})]}),ut&&t.jsx(Wl,{bump:yt,cbToken:N,onClose:()=>bt(!1),onEvaluate:I=>o(null,I),onAddAll:re}),t.jsx("div",{className:"rsp slim"+(U?" on":" off"),"aria-hidden":!U,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:U?void 0:-1,onClick:()=>Le(I=>!I),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:fe?"▴":"▾"})]}),fe&&t.jsx("textarea",{className:"rstext",value:ne,placeholder:e.rsTextPh,tabIndex:U?void 0:-1,onChange:I=>se(I.target.value)})]})}),Ce&&t.jsx("div",{className:"rserr",children:Ce}),ye&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ye.title}),ye.source_url&&t.jsx("a",{href:ye.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{Ue(null),st(null)},children:"×"})]}),ye.market&&t.jsx("p",{className:"rsmk",children:ye.market}),kt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),kt.map(I=>t.jsx("span",{children:I},I))]}),t.jsxs("div",{className:"rsbody",children:[ye.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ye.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:wo(ye.summary_md||"").map((I,ee)=>t.jsx("p",{children:I},ee))})]}),t.jsx(ko,{card:ye,onEvaluate:I=>o(null,I),onAddAll:re}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Tt)}),_t]})]}),x&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:$,placeholder:e.bulkPh,onChange:I=>Q(I.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(H?" loading":""),style:{justifyContent:"center"},disabled:H||!S.length,onClick:()=>{je()},children:[t.jsx("span",{className:"fill"}),H&&K?K:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(S.length)})]})]}),G.slice(0,1).map((I,ee)=>{const ie=I.verdict==="kept",w=I.verdict==="quota",P=ie?"var(--brand)":w?"var(--bolt)":"var(--red)",O=ie?"var(--brand-l)":w?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":P,"--bgc":O},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ie?"✓ "+e.kept:w?"⏳":"✗ "+e.dropped})}),I.name&&t.jsx("span",{className:"rn",children:I.name}),t.jsx("span",{className:"rr",children:I.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",I.reason]}):null}),!!(I.candidates&&I.candidates.length)&&t.jsx("span",{className:"sitepick",children:I.candidates.map(W=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:W.url.startsWith("http")?W.url:`https://${W.url}`,target:"_blank",rel:"nofollow noopener",children:[(W.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,W.url),children:e.evalPickGo})]},W.url))}),!w&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:ie?1:5});const W=(I.name||"").trim().toLowerCase();window.setTimeout(()=>{const te=[...document.querySelectorAll(".atl2 .list .row")].find(Ee=>{var we;return(((we=Ee.querySelector(".rnm"))==null?void 0:we.textContent)||"").trim().toLowerCase().includes(W)});te&&(te.scrollIntoView({behavior:"smooth",block:"center"}),te.classList.add("flashrow"),window.setTimeout(()=>te.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ie?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ee)}),f&&(i.kept+i.dropped>0||G.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Kl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ql(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Y(),i=e.memoConsole?r.get(e.memoConsole):null,s=u.useMemo(()=>i?[i.reasoning||"",Kl(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=gt(i),c=bn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:s?s.split(`

`).map((g,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Ft(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Sn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Y(),[s,l]=u.useState(!1),[c,g]=u.useState(null),d=n.pipe&&o==="client"&&!n.lockActions,h=async()=>{if(!d||s)return;l(!0);const p=await hi(r,e);if(l(!1),!p){i(a.actErr);return}g(p.results||[])};return u.useEffect(()=>{if(!d)return;const p=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&h()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,d]),u.useEffect(()=>{if(d)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),h())}catch{}},[e,d]),d?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{h()},children:s?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Jl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),fa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Xl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=fa(a.slice(n));break}r+=fa(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=fa(a.slice(o));break}const s=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(s),c=l?l[2].toLowerCase():"";l&&Jl.has(c)?r+=`<${l[1]}${c}>`:r+=fa(a.slice(o,i+1)),n=i+1}return r}const Tr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Be({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Zl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ed({o:e}){const{t:a,doDeep:r}=Y(),[n,o]=u.useState(!1),i=gt(e),s=[e.reasoning||"",Zl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[i&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:i}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),s.length?s.join(`

`).split(`

`).map((l,c)=>t.jsx("p",{className:"cdtxt",children:l},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Ft(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:l=>{l.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:l=>{l.stopPropagation(),o(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:l=>l.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:l=>l.stopPropagation()})]})}function Cn({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=Y(),i=na(e),s=gt(e),l=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),h=u.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.reasoning?1:0)+(s?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Ft(e)?1:0}].filter(v=>v.n>0),[e,a,l,s,c,g,d]),[p,b]=u.useState("");if(!h.length)return null;const m=h.some(v=>v.k===p)?p:h[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:h.map(v=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===v.k,"data-tour":"tab-"+v.k,className:m===v.k?"on":"",onClick:y=>{y.stopPropagation(),b(v.k)},children:v.lib},v.k))}),t.jsxs("div",{className:"cdbody",onClick:v=>v.stopPropagation(),children:[m==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[t.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Be,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Be,{k:a.cdVerdictDate,v:Tr(e.verdictDate,r)})]})]}),m==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Xl(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(td,{o:e})]}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdSector,v:e.sector}),t.jsx(Be,{k:a.cdStage,v:e.stage}),t.jsx(Be,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Be,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Be,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Be,{k:a.cdAngle,v:e.angle}),t.jsx(Be,{k:a.cdDetected,v:Tr(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdName,v:e.contactName}),t.jsx(Be,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Be,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="memo"&&t.jsx(ed,{o:e}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Be,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function td({o:e}){const{t:a,token:r}=Y(),[n,o]=u.useState(!1),[i,s]=u.useState(null),l=async()=>{n||(o(!0),s(await xi(r,e.name,e.website||e.domain||"")),o(!1))},c=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],d=g.some(([,h])=>h);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[g.filter(([,h])=>h).map(([h,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:h}),t.jsx("p",{children:p})]},h)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function ra({spec:e}){const a=u.useRef(null),r=u.useRef(null),[n,o]=u.useState(!1);return u.useEffect(()=>{const i=a.current;if(!i)return;let s=!1;const l=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Bn({kind:"op",card:e},g).then(d=>{!s&&d&&i.isConnected&&i.replaceChildren(d)})},c=window.requestAnimationFrame(l);return()=>{s=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),u.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let s=!1;Bn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!s&&c&&i.isConnected&&i.replaceChildren(c)});const l=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{s=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&It.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const ad=`
...
`;function nd(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:s,top:l}}function rd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:s,askEvaluate:l,doAnalyse:c,doDecide:g,doPromote:d,doRepeche:h,doApproach:p,doDeep:b,doOnboard:m,outbound:v,evalBusy:y}=Y(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const N=Fe(f),C=Ae(f),k=gt(f),j=na(f),A=f.kind==="target",E=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return It.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:ad}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:nd(e.popupAnchor,!!f.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(pt(f.date)),We(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>E({country:[f.cc]}),children:(Pt(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>E({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>E({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Bt(f.amountEur,o)})]}),i.pipe&&A&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[C]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[St(f.engine)," ",t.jsx("b",{children:We(f.engine,o)})," — ",gi(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),N?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(xt,{o:f,lg:!0})," ",t.jsx(Fa,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Ur(N,o))," · ",n.win7(Hr(N,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(ra,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&C>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&A&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&A&&t.jsx(Cn,{o:f})]}),t.jsx(Sn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||s!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[C===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),C===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),C===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),C===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),Ft(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),C===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),C===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function od(){const{lang:e,token:a,dossiers:r,caps:n}=Y(),o=a||"home",{names:i,verdicts:s}=u.useMemo(()=>{const c=[],g={};return r.forEach(d=>{d.kind!=="target"||!d.name||(c.push(d.name),g[d.name]=bi(d)||"")}),{names:c,verdicts:g}},[r]);return{diff:u.useMemo(()=>i.length?vi(o,i,s,e):null,[o,i.length]),names:i,verdicts:s,scope:o,caps:n}}function id(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:s}=Y(),l=i.loading&&!s.length,c=u.useRef({});u.useEffect(()=>{c.current={...r}},[r]);const g=p=>{const b=c.current[p],m=b!==void 0?r[p]-b:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ja[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:p})},children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(m>0?" up":m<0?" down":""),children:[r[p],m!==0&&t.jsxs("em",{className:"delta",children:[m>0?"+":"−",Math.abs(m)]})]})]},p)},d=(p,b,m)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${Ja[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:p})},children:[t.jsx("span",{className:"l",children:m.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),h=(p,b,m,v=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:v,onClick:m,children:p},b);return t.jsxs("div",{className:"funnel"+(l?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[h("↩",n.toolUndo,o,e.undo.length===0),h("↺",n.toolReset,()=>{a({type:"reset"})}),h("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),h("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),h("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function sd(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:s}=Y(),l=u.useRef(null),[c,g]=u.useState(60);u.useEffect(()=>{let m=0;const v=()=>{var k;const y=l.current;if(!y)return;const f=(k=y.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!f)return;const N=f.getBoundingClientRect(),C=y.getBoundingClientRect();g(Math.max(20,Math.min(N.left+N.width/2-C.left,C.width-30)))};return m=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",v)}},[e.ptab]);const d=e.ptab;let h=r.tuto[d].p;if(d===3){const m=n.filter(f=>f.kind==="target"&&Ae(f)===3),v=m.filter(f=>Xa(f)==="auto").length,y=m.filter(f=>Xa(f)==="cd").length;h=r.tutoPending(v,y,m.length)}const p=(()=>{if(s!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(d===1){const m=n.filter(v=>v.kind==="target"&&Ae(v)===1&&!o.has(v.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(v=>v.id)})}}return null})(),b=yi(d);return t.jsxs("div",{ref:l,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Ja[d]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:h}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}const Ya=600,Nt=62,qr="atl2:fstats";function ld(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Y(),[s,l]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(qr)==="on"}catch{return!1}}),c=r.stats,g=u.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const h=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,p=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((j,A)=>Math.max(j,A.s||0),0),m=g.length?Ya/g.length:0,v=Math.max(4,m-4),y=g.length>=5&&b>0,f=r.marketEstimate||0,N=h(new Date().toISOString().slice(0,10)),C=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],k=[];return typeof c.screened_window=="number"&&d&&k.push({cle:"fenetre",periode:e.funPerWindow(h(d),N),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:C(c.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([A,E],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(A)}),t.jsx("i",{children:E})]},j.cle+E)),j.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(f),Math.min(100,Math.round((c.screened||0)/f*100)))})]}),j.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const A=!s;l(A),A&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(qr,A?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},j.cle)),s&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ya} ${Nt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((j,A)=>{const E=(j.s||0)/b*(Nt-4),q=(j.m||0)/b*(Nt-4),z=A*m+(m-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${h(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:Nt-2-E,width:v,height:E,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:Nt-2-q,width:v,height:q,fill:"#185c38"})]},j.d)}),t.jsx("line",{x1:0,y1:Nt-1.5,x2:Ya,y2:Nt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:h(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const jo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function zn({o:e,locked:a=!1}){const{t:r}=Y(),n=na(e),o=gt(e),i=Ae(e),s=Xa(e),l=wi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(jo[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&s==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&s==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(Os,{o:e})]})}const Dt=e=>e.length>22?e.slice(0,21)+"…":e,ba=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ra(e){return ba.has(e.engine||"")}function dt(e){return!!e.noCo||Ra(e)&&!!e.url}function aa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function No(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function dd({on:e,rev:a}){const[r,n]=u.useState(null),[o,i]=u.useState({top:0,left:0,width:0});return u.useEffect(()=>{if(!e){n(null);return}const s=()=>{var m,v,y;const l=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const g=l.getBoundingClientRect(),d=c?c.getBoundingClientRect().bottom:g.top;i({top:Math.round(d),left:Math.round(g.left),width:Math.round(g.width)});const h=[...l.querySelectorAll(":scope .grp")];let p=null;for(const f of h){const N=f.querySelector(".grp-h");N&&N.getBoundingClientRect().bottom<=d+2&&(p=f)}if(!p){n(null);return}const b=p.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return s(),window.addEventListener("scroll",s,{passive:!0}),window.addEventListener("resize",s),()=>{window.removeEventListener("scroll",s),window.removeEventListener("resize",s)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function cd(e){const r=()=>{const n=No(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Lr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Y(),[i,s]=u.useState(!1);if(u.useEffect(()=>{n||s(!1)},[n]),_e(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Dt(e.name))})]})}function An({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:s,doPromote:l,doRepeche:c,doApproach:g,dispatch:d,liveMemos:h}=Y(),p=m=>v=>{v.stopPropagation(),m()};if(r.lockActions){const m=p(()=>d({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Ae(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Dt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),aa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return Ra(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),aa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Lr,{o:e})});const b=Ae(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Lr,{o:e})});if(b===1){const m=h.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(ya,{item:m,serverOff:h.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:p(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:p(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:p(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:p(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:p(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function pd({o:e}){const{t:a,doThumb:r,thumbOf:n}=Y(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function ud({o:e}){const{lang:a}=Y();return Fe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(xt,{o:e}),t.jsx(Fa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[St(e.engine||"")," ",We(e.engine||"",a)]})})}function md({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:s,fresh:l}){const{dispatch:c,caps:g,markRow:d,markedId:h,favIds:p,toggleFav:b,t:m}=Y(),v=Ae(e),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,N=f<=0?0:f<=7?1:f<=30?2:3,C=g.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][v]:y[N],k=p.has(e.id),j=A=>{if(a)return;if(s){s(e.id);return}if(g.pipe||e.kind==="op"){n();return}const E=A.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:E.left+Math.min(280,E.width/3),y:E.bottom}})};return t.jsxs(u.Fragment,{children:[t.jsxs("div",{className:"row"+(h===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+v:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:j,children:[t.jsx("span",{className:"pt",style:{"--c":C}}),t.jsx(Ao,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),Fe(e)&&t.jsx(xt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:A=>{A.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(A=>A&&A!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:A=>{A.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",Dt(e.acquirer)]}),Ve(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(fd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(ud,{o:e}),g.pipe&&t.jsx(zn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(An,{o:e}),g.showThumbs&&t.jsx(pd,{o:e})]}),r&&!a&&!s&&t.jsx(gd,{o:e})]})}function fd({o:e}){const{lang:a,caps:r}=Y();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Bt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function hd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Y(),s=(p,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:p})},l=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),c=Bt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=_e(e),h=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped})]}):dt(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{p.stopPropagation(),aa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Dt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ra,{spec:e.card})})]})}function xd({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Y();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[We(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(An,{o:e})}),t.jsx(Cn,{o:e})]})}function Eo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:s,caps:l,dossiers:c}=Y(),g=u.useRef(null),d=Ve(e);if(u.useEffect(()=>{if(!d||!(e!=null&&e.decryptHtml))return;const x=g.current;if(!x)return;let T=!1;return Ka(()=>import("./fit-BnaWm7z_.js"),[]).then(async $=>{await $.ensureEditoCss(),!(T||!x.isConnected)&&($.beautifyEditoRows(x),$.mountCardFits(x))}),()=>{T=!0}},[d,e==null?void 0:e.decryptHtml]),!e&&!a){const x=c.find(Ve);if(x)return t.jsx(Eo,{o:x})}const h=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),p=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||h,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!h||wa(h),y=(e==null?void 0:e.engine)||"",f=Ve(e),N=e?Bt(e.amountEur,n):"",C=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const x=/https?:\/\/(?:www\.)?([^/]+)/.exec(p);return x?x[1].replace(/^www\./,"").slice(0,40):""})(),j=c.find(Ve),A=((j==null?void 0:j.url)||"").trim(),E=!!p&&!!A&&(p===A||p.endsWith(A)||A.endsWith(p)),q=(x,T=!1)=>$=>{$.stopPropagation(),T&&s({type:"continent",key:"monde"}),s({type:"filters",patch:x})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const z=()=>{h&&(s({type:"continent",key:"monde"}),s({type:"filters",patch:{search:h}}))},R=()=>{e!=null&&e.sector&&s({type:"filters",patch:{sector:[e.sector]}})},D=()=>{aa({url:p,headline:b,tagline:e==null?void 0:e.tagline,name:h})},B=e?_e(e):!1,L=B&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",F=f?r.doEdito.replace(/^📖\s*/,""):y?We(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[F,C?` · ${C}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),p&&!f&&(v||Ra({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:p,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:x=>x.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),N&&t.jsx("span",{className:"oc-amt",children:N})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(ra,{spec:m})}),(p&&!E&&!f||j&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[p&&!E&&!f&&t.jsxs("a",{className:"zoom-src",href:p,target:"_blank",rel:"nofollow noopener",onClick:x=>x.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:x=>{x.stopPropagation(),s({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[B?t.jsxs("span",{className:"verdict",style:{"--c":L?"var(--brand)":"var(--red)"},children:[L?"✓":"✗"," ",t.jsx("b",{children:L?r.kept:r.dropped})]}):!v&&h?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:x=>{x.stopPropagation(),o(e,h)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Dt(h))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,p&&!f&&(v||Ra({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&h?" ghost":""),onClick:x=>{x.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&h&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),R()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),z()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Dt(h)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&h&&l.pipe&&t.jsx(Sn,{name:h})]})]})}function gd({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:s}=Y();return!o.pipe&&e.kind==="op"?t.jsx(hd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Cn,{o:e}),t.jsx(Ds,{o:e}),t.jsx(Bs,{o:e}),t.jsx(Sn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(zn,{o:e})})]}),e.card&&t.jsx(ra,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[St(e.engine||"")," ",We(e.engine||"",r)]}),Fe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(xt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function bd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:s,doDecide:l,lang:c}=Y();if(!s.pipe&&e.kind==="op"){const h=Bt(e.amountEur,c),p=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ra,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),h&&t.jsx("span",{className:"damt",children:h})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[St(e.engine||"")," ",We(e.engine||"",c)]}),Fe(e)&&t.jsx(xt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(p?` · ${p}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(An,{o:e})})]})}const g=Ae(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":d},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(zn,{o:e}),Fe(e)&&t.jsx(xt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&s.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemo," →"]})]})}function vd(){const{t:e}=Y(),[a,r]=u.useState(0);return u.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function yd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Y(),i=o==="en",s=d=>n.plabels[d]||"",l=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),c=l.includes(0)?0:l.sort((d,h)=>(e[h]||0)-(e[d]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${s(c)}”`:`${g} dossier${g>1?"s":""} dans « ${s(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+s(c)," →"]})]})}function wd(){var vt,yt,Je,mt,wt;const e=Y(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:s,scopedAll:l,markRow:c,lang:g,sessTally:d,data:h,dossiers:p,source:b,focusExtra:m,byId:v,token:y}=e,f=Gr(),N=u.useMemo(()=>{var V,re,be,de;if(!y||b==="ops")return null;const S=(((V=f==null?void 0:f.ed)==null?void 0:V.date)||(f==null?void 0:f.day)||"").slice(0,10),G=[(re=f==null?void 0:f.ed)==null?void 0:re.html,(be=f==null?void 0:f.ed)==null?void 0:be.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((de=f==null?void 0:f.ed)==null?void 0:de.date)||S,decryptHtml:G||void 0,date:S,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,g,(vt=f==null?void 0:f.ed)==null?void 0:vt.html,(yt=f==null?void 0:f.ed)==null?void 0:yt.acquirers_html,(Je=f==null?void 0:f.ed)==null?void 0:Je.date,f==null?void 0:f.day]),C=S=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Wr,[k,j]=u.useState(new Set);u.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[A,E]=u.useState(null);u.useEffect(()=>{E(null)},[a.ptab,a.continent]);const[q,z]=u.useState(!a.mapFolded);u.useEffect(()=>{if(a.mapFolded){z(!1);return}const S=document.getElementById("atl2-stage");if(!S){z(!1);return}const G=new IntersectionObserver(([V])=>z(!!V&&V.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return G.observe(S),()=>G.disconnect()},[a.mapFolded]);const R=a.mapFolded||!q,D=S=>j(G=>{const V=new Set(G);return V.has(S)?V.delete(S):V.add(S),V}),B=b==="ops"||o.pipe,[L,F]=u.useState("all"),[x,T]=u.useState(null),[$,Q]=u.useState(!1),H=u.useRef(!0);u.useEffect(()=>{if(H.current){H.current=!1;return}F("all"),Q(!1)},[a.ptab,a.continent]),u.useEffect(()=>{if(!$)return;const S=G=>{var V,re;(re=(V=G.target)==null?void 0:V.closest)!=null&&re.call(V,".atl2 .doable")||Q(!1)};return document.addEventListener("click",S),()=>document.removeEventListener("click",S)},[$]);const M=u.useMemo(()=>{var G;const S=new Map;for(const V of js(((G=f==null?void 0:f.ed)==null?void 0:G.html)||""))S.has(V.t)||S.set(V.t,V.html);return S},[(mt=f==null?void 0:f.ed)==null?void 0:mt.html]),K=u.useCallback(S=>{if(S.decryptHtml)return S.decryptHtml;if(!M.size)return;const G=(S.name||"").trim().toLowerCase();if(G.length<3)return;const V=M.get(G);if(V)return V;for(const[re,be]of M)if(re.includes(G)||G.includes(re))return be},[M]),{diff:_}=od(),[J,X]=u.useState(!1),me=a.filters.win==="1"&&!a.filters.day,[U,le]=u.useState(!1),fe=u.useMemo(()=>new Set(((_==null?void 0:_.added)||[]).map(S=>S.trim().toLowerCase()).filter(Boolean)),[_]),Le=u.useMemo(()=>{if(!fe.size)return 0;const S={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return p.filter(G=>!Ve(G)&&fe.has((G.name||"").trim().toLowerCase())&&ja(G,S,o.pipe)).length},[p,fe,a,o.pipe]);u.useEffect(()=>{const S=()=>{le(!1),F("all"),Q(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",S),()=>window.removeEventListener("ppmap:tunnel",S)},[]),u.useEffect(()=>{le(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const ae=u.useMemo(()=>{const G=U&&fe.size>0||a.filters.signalOnly||L!=="all"?l:s;let V=wn(G,a.sort);return V=V.filter(re=>!Ve(re)),U&&fe.size&&(V=V.filter(re=>fe.has((re.name||"").trim().toLowerCase()))),L==="explore"?V=V.filter(dt):L==="eval"&&(V=V.filter(re=>!dt(re)&&!re.noCo)),V},[s,l,a.sort,L,U,fe]),xe=u.useMemo(()=>o.pipe?p.filter(S=>S.kind==="target"&&!Ve(S)&&Fe(S)&&(a.continent==="monde"||S.continent===a.continent)):ae.filter(S=>Fe(S)&&!_e(S)),[o.pipe,p,ae,a.continent]).length,ce=u.useMemo(()=>o.pipe?ae:ae.filter(S=>!_e(S)&&!S.noCo&&!dt(S)),[ae,o.pipe]),Z=b==="ops"?ae.filter(dt).length:0,ne=U?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,se=a.filters,ge=[];if(se.day)ge.push({k:"day",lib:n.fDay(se.day.slice(8,10)+"/"+se.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(se.win&&se.win!=="all"){const S=["1","7","30"].indexOf(se.win);S>=0&&ge.push({k:"win",lib:n.dates[S],off:()=>r({type:"filters",patch:{win:"all"}})})}const Se=S=>S.length<=2?S.join(", "):`${S.length} ${n.fSelected}`;for(const S of["sector","country","engine"]){const G=se[S];G&&G.length&&ge.push({k:S,lib:Se(G),off:()=>r({type:"clearFacet",facet:S})})}se.search&&ge.push({k:"search",lib:"🔍 "+se.search,off:()=>r({type:"filters",patch:{search:""}})}),U&&fe.size&&ge.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>le(!1)}),se.signalOnly&&ge.push({k:"sig",lib:"🔴 "+n.sigDock(xe||se.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const oe=(S,G,V="",re=!1)=>t.jsxs("button",{type:"button","data-s":S,className:V,"aria-sort":a.sort.key===S?a.sort.dir===1?"ascending":"descending":"none",style:re?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:S}),children:[G,t.jsx("span",{className:"ar",children:a.sort.key===S&&a.sort.dir===1?"▴":"▾"})]},S),pe=u.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const S=new Map;ae.forEach(re=>{const be=re.engine||"?";S.has(be)||S.set(be,[]),S.get(be).push(re)});const G={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},V=Qa([...S.keys()],g);return[...S.entries()].sort((re,be)=>{const de=G[re[0]]??10+V.indexOf(re[0]),je=G[be[0]]??10+V.indexOf(be[0]);return de-je})},[ae,o.pipe,a.groupBy,g]),Pe=pe?pe.filter(([S])=>ba.has(S)).length:0,Oe=(()=>{var G;return((G=(pe?pe.flatMap(([,V])=>V):ae)[0])==null?void 0:G.id)??null})(),Ce=u.useRef(!1),ve=u.useMemo(()=>p.find(Ve)||N,[p,N]);u.useEffect(()=>{const S=()=>{Ce.current=!0,le(!1)};return window.addEventListener("ppmap:reveal",S),window.addEventListener("ppmap:focus",S),()=>{window.removeEventListener("ppmap:reveal",S),window.removeEventListener("ppmap:focus",S)}},[]),u.useEffect(()=>{const S=()=>{ve&&r({type:"focus",id:ve.id})};return window.addEventListener("ppmap:edito",S),()=>window.removeEventListener("ppmap:edito",S)},[ve,r]),u.useEffect(()=>{if(!a.focusId)return;T(a.focusId);const S=window.setTimeout(()=>T(null),900);return()=>window.clearTimeout(S)},[a.focusId]),u.useEffect(()=>{if(B&&!(a.focusId&&(ae.some(S=>S.id===a.focusId)||p.some(S=>S.id===a.focusId)||a.focusId===(ve==null?void 0:ve.id)))&&!m){if(ve){r({type:"focus",id:ve.id});return}Oe&&r({type:"focus",id:Oe})}},[B,a.focusId,ae,Oe,m,r,p,b,ve]),u.useEffect(()=>{if(!B||!a.focusId||ve&&a.focusId===ve.id||ae.some(G=>G.id===a.focusId))return;const S=p.find(G=>G.id===a.focusId);if(S){if(Ce.current){S.kind==="op"?F(dt(S)?"explore":"eval"):L!=="all"&&F("all");return}L!=="all"&&Oe&&r({type:"focus",id:Oe})}},[B,a.focusId,L,ae,p,Oe,r,ve]),u.useEffect(()=>{if(!B||!a.focusId||!Ce.current)return;const S=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!S){const be=ae.findIndex(de=>de.id===a.focusId);if(be>=0){const de=pe?"":"pt"+a.ptab;if(de){const je=a.shown[de]||C();be>=je&&r({type:"more",group:de,by:be-je+8})}}return}Ce.current=!1;const G=No(),V=S.getBoundingClientRect();V.top>=G-2&&V.bottom<=window.innerHeight-4||cd(S)},[B,a.focusId,a.ptab,ae,a.shown,pe,r]),u.useEffect(()=>{if(typeof window>"u")return;const S=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),G=document.querySelector(".atl2.ops, .atl2.cibles");if(!S||!G)return;const V=()=>G.style.setProperty("--listhead-h",`${S.offsetHeight}px`);V();const re=new ResizeObserver(V);return re.observe(S),()=>re.disconnect()},[R,a.dens,a.mapFolded]);const ye=u.useMemo(()=>{if(!B||!a.focusId)return null;if(N&&a.focusId===N.id)return N;const S=ae.find(V=>V.id===a.focusId)||p.find(V=>V.id===a.focusId)||null;if(!S)return null;const G=K(S);return G&&G!==S.decryptHtml?{...S,decryptHtml:G}:S},[B,a.focusId,ae,p,K,N]),Ue=o.lockRowsAfter;let Re=0;const st=(S,G)=>{let V=a.shown[G]||C();return S.length-V<=4&&(V=S.length),S.slice(0,V).map(de=>{const je=Ue!==null&&Re>=Ue;Re++;const Xe=K(de),kt=Xe&&Xe!==de.decryptHtml?{...de,decryptHtml:Xe}:de,ft=!B&&a.dens!=="maxi"&&(a.dens==="deplie"||(A?A==="open":!!Xe)),_t=k.has(de.id)?!ft:ft,Tt=B?Me=>{Ce.current=!0,r({type:"focus",id:Me});const De=v.get(Me);De&&(dt(De)?aa(De):De.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:De.name,url:De.url||"",website:De.website||"",domain:De.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(bd,{o:kt,locked:je,selected:B&&a.focusId===de.id,onSelect:Tt},de.id):t.jsx(md,{o:kt,locked:je,open:_t,onToggle:()=>D(de.id),selected:B&&a.focusId===de.id,echo:x===de.id,fresh:fe.has((de.name||"").trim().toLowerCase()),onSelect:Tt},de.id)})},ut="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ae.length?"":" list-empty"),bt=t.jsxs(t.Fragment,{children:[pe?pe.map(([S,G])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:St(S)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:S==="ma"?n.grpMa:S==="fundraising"?n.grpLev:ba.has(S)&&Pe<=1?n.grpNews:S==="nominations"?n.grpNom:S==="media"?n.grpNewsOther:S==="recrutements"?n.grpHire:ba.has(S)?n.grpNews+" · "+We(S,g):We(S,g)}),t.jsx("div",{className:"s",children:n.grpCount(G.filter(V=>!_e(V)).length,G.length)})]})]}),st(G,S)]},S)):st(ae,"pt"+a.ptab),h.loading&&!p.length&&t.jsx(vd,{}),!ae.length&&!(h.loading&&!p.length)&&(o.pipe?t.jsx(yd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),at=t.jsxs("div",{className:"listhead"+(R?" mapoff":""),children:[R&&t.jsx("div",{className:"lh-tools",children:t.jsx(vo,{compact:!0})}),o.showFunnel&&J&&me&&t.jsxs("div",{className:"lh-stats",children:[t.jsx($s,{}),t.jsx(ld,{})]}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(id,{}),t.jsx(sd,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(me?" on":""),"aria-pressed":me,title:n.morningDockTitle,onClick:()=>{if(me){r({type:"filters",patch:{win:"all",day:""}}),X(!1);return}le(!1),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),X(!0)},children:["📊 ",n.morningDock(typeof((wt=h.stats)==null?void 0:wt.screened_today)=="number"?h.stats.screened_today:0)]}),_&&!_.firstVisit&&(_.added.length>0||_.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(U?" on":""),"aria-pressed":U,title:n.sinceSub,onClick:()=>{const S=!U;le(S),X(!1),S&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(Le),_!=null&&_.lastDate?` · ${n.sinceSince(_.lastDate)}`:""]}),xe>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{le(!1),X(!1),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(xe)]})]}),!U&&t.jsxs("span",{className:"main",children:[t.jsx("b",{children:ae.length})," ",ne]}),t.jsx("span",{className:"dot",children:"·"}),R&&t.jsx(yo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[R?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ge.map(S=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:G=>{G.stopPropagation(),S.off()},children:[S.lib,t.jsx("i",{children:"×"})]},S.k)),b==="ops"&&ae.length>0&&!R&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ae.length-Z," ",n.zoomPulseEval,Z>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",Z," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([S,G])=>t.jsxs("button",{type:"button","data-d":S,"aria-pressed":a.dens===S||S==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:S}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:G})]},S))}),!B&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":A==="open",onClick:()=>{E("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":A==="closed",onClick:()=>{E("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var de;const S=l.filter(je=>!Ve(je)),G=S.filter(je=>!dt(je)&&!je.noCo).length,V=S.filter(dt).length,re=[["all",n.doAll],["eval",`${n.doEval}${G?` ${G}`:""}`],["explore",`${n.doExplore}${V?` ${V}`:""}`]],be=((de=re.find(([je])=>je===L))==null?void 0:de[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":$,onClick:()=>Q(je=>!je),children:[be,t.jsx("i",{children:"▾"})]}),$&&t.jsx("div",{className:"dolist",children:re.map(([je,Xe])=>t.jsx("button",{type:"button","aria-pressed":L===je,onClick:()=>{F(je),Q(!1)},children:Xe},je))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:S=>r({type:"sort",key:S.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([S,G])=>t.jsx("option",{value:S,children:G},S))})]}),o.showChain&&ce.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ce.map(S=>S.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ce.length):n.chainAll(ce.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!B&&at,a.dens!=="maxi"&&!B&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),oe("country",n.colCountry),oe("name",n.colCompany),oe("amount",n.colAmount,"h-amt",!0),oe("stage",n.colStage,"h-stade"),oe("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[oe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),oe("memo",n.colMemo)]}),o.pipe&&oe("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),B?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[at,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),oe("country",n.colCountry),oe("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[oe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),oe("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ut,children:bt})]}),t.jsxs("aside",{className:"readpane"+((ye?Ve(ye):!m&&ve)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[ve&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===ve.id,onClick:()=>r({type:"focus",id:ve.id}),children:n.doEdito}),N&&a.focusId===N.id?t.jsx("div",{className:"zoom",children:t.jsx(zs,{})}):ye&&o.pipe?t.jsx(xd,{o:ye}):t.jsx(Eo,{o:ye,extra:ye?null:m})]})]}):t.jsx("div",{className:ut,children:bt}),(()=>{const S=pe||[["pt"+a.ptab,ae]];let G=0,V=0;for(const[be,de]of S){V+=de.length;let je=a.shown[be]||C();de.length-je<=4&&(je=de.length),G+=Math.min(de.length,je)}const re=V-G;return re<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>S.forEach(([be,de])=>r({type:"more",group:be,by:de.length,base:C()})),children:[t.jsx("span",{className:"more-label",children:n.more(re,re)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(G,V)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}}),B&&b==="ops"&&a.dens!=="maxi"&&t.jsx(dd,{on:!!pe,rev:(pe||[]).map(([S,G])=>S+G.length).join("|")})]})}function Rr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function kd(e,a){const r=ki(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function jd(e,a){const n=[a.head.split("|").map(Rr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",kd(o,a.plabels),na(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Rr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Nd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Ed=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function rt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Sd({o:e,qa:a}){const{t:r,lang:n,fund:o}=Y(),i=(e.cribleStatus||"").trim().toUpperCase()||(na(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=gt(e),l=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(rt,{k:r.cdSector,v:e.sector}),t.jsx(rt,{k:r.cdStage,v:e.stage}),t.jsx(rt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(rt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(rt,{k:r.cdName,v:e.contactName}),t.jsx(rt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(rt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(rt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(rt,{k:r.cdAngle,v:e.angle}),t.jsx(rt,{k:r.cdDetected,v:Ed(e.date,n)})]}),c.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,g])=>g).map(([g,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:d})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Cd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:s}=Y(),[l,c]=u.useState({}),g=25,d=u.useMemo(()=>n.slice(0,g),[n]);u.useEffect(()=>{d.length&&ji(r,d.map(b=>b.name)).then(c)},[r,d]);const h=i.stats,p=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),h&&typeof h.screened=="number"&&t.jsxs("p",{children:[p(h.screened)," ",e.funScreened(""),typeof h.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(h.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(i.marketEstimate)),", ",Math.round(h.screened/i.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(Sd,{o:b,qa:l[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const zd=50;function Tn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Y(),[i,s]=u.useState(null),[l,c]=u.useState(!1),[g,d]=u.useState(""),[h,p]=u.useState(0),[b,m]=u.useState(""),[v,y]=u.useState(!1),[f,N]=u.useState(0),C=u.useRef(null),k=u.useRef(null),j=()=>{N(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>N(z=>z+1),1e3)},A=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};u.useEffect(()=>()=>{C.current&&window.clearInterval(C.current),k.current&&window.clearInterval(k.current)},[]);const E=async z=>{c(!0),d(""),j();const R=await a();if(c(!1),A(),R.ok){s(R);return}if(R.busy){d(o.alertPreviewBusy);return}if(!z){d(o.alertPreviewFail);return}p(zd),A(),C.current=window.setInterval(()=>{p(D=>D>1?D-1:(C.current&&window.clearInterval(C.current),E(!1),0))},1e3)},q=async()=>{if(n||v||l)return;y(!0),m(""),j();const z=await r();y(!1),A(),m(z.ok?o.alertTestOk(z.sentTo||""):z.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||v||h>0,onClick:()=>{E(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||l,onClick:()=>{q()},children:v?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),h>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(h)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Rt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function $e({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=Y();return It.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Ad(){const{st:e}=Y();switch(e.modal){case"chain":return t.jsx(qd,{});case"space":return t.jsx(Ld,{});case"alert":return t.jsx(Rd,{});case"queue":return t.jsx(Id,{});case"export":return t.jsx(Pd,{});case"plug":return t.jsx($d,{});case"recharge":return t.jsx(Hd,{});case"cover":return t.jsx(Wd,{});case"dossier":return t.jsx(Vd,{});case"crit":return t.jsx(Gd,{});case"tuto":return t.jsx(Yd,{});case"rdv":return t.jsx(Td,{});case"memoalert":return t.jsx(Bd,{});default:return null}}function Td(){const{dispatch:e,fund:a,t:r}=Y(),n=a||r.rdvCoFallback;return It.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Qr,children:jn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Na}`,children:Na})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],s)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(s+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Gi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function qd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:s,evalBusy:l,caps:c,memoQueued:g,doAnalyse:d}=Y(),h=i==="client",p=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,m=p[b],v=b>=p.length;return It.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Pt(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(pt(m.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:We(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Bt(m.amountEur,o)})]}),Fe(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(xt,{o:m,lg:!0})," ",t.jsx(Fa,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(h&&_e(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),h&&_e(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Et(m)==="retenu"?"var(--brand)":Et(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Et(m)==="retenu"?"✓ "+n.kept:Et(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&c.pipe&&Ae(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(h&&_e(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{s(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function Ld(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Y(),i=o==="client",s=u.useMemo(()=>i?r.filter(h=>_e(h)):[],[r,i]),l=u.useMemo(()=>wn(s.filter(h=>Et(h)==="retenu"),{key:"signal",dir:-1}),[s]),c=u.useMemo(()=>s.filter(h=>Et(h)==="ecarte"),[s]),g=e.spaceTab==="retenu"?l:c,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs($e,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(h=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof h.score=="number"&&h.score>0?h.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:h.name}),t.jsx("div",{className:"rr",children:h.reasoning||h.tagline||""})]})]},h.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Rd(){const{mode:e}=Y();return e==="client"||e==="apercu"?t.jsx(Fd,{}):t.jsx(Dd,{})}function Fd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Y(),[i,s]=u.useState("d"),l=o!=="client";return t.jsxs($e,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Md,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(Od,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(So,{})]})}function Md({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=u.useState(null),[l,c]=u.useState(!1),[g,d]=u.useState(0);u.useEffect(()=>{let q=!0;return c(!1),Un(a).then(z=>{q&&(z?s(z):c(!0))}),()=>{q=!1}},[a,g]);const h=u.useRef({}),[p,b]=u.useState({}),[m,v]=u.useState(!1),[y,f]=u.useState(!1),N=u.useRef(null);u.useEffect(()=>()=>{N.current&&window.clearTimeout(N.current)},[]);const C=q=>{const z=h.current;Object.keys(z).length&&(v(!0),Un(a,z).then(R=>{if(!R){v(!1),o(e.actErr);return}if(R.throttled&&q<3){N.current=window.setTimeout(()=>C(q+1),5400);return}if(h.current={},b({}),s(R),v(!1),R.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},k=q=>{r||(h.current={...h.current,...q},b(z=>({...z,...q})),N.current&&window.clearTimeout(N.current),N.current=window.setTimeout(()=>C(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(q=>q+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...p},A=q=>!j.sections||j.sections.includes(q),E=q=>{const z=j.sections||e.alertSec.map(([R])=>R);k({sections:A(q)?z.filter(R=>R!==q):[...z,q]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([q,z])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:A(q),disabled:r,onChange:()=>E(q)}),t.jsxs("span",{children:[z,q==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},q))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Tn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ri(a),onTest:()=>Li(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Od({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=u.useState(null),[l,c]=u.useState(!1),[g,d]=u.useState(0);u.useEffect(()=>{let m=!0;return c(!1),Hn(a).then(v=>{m&&(v?s(v):c(!0))}),()=>{m=!1}},[a,g]);const h=m=>{r||Hn(a,m).then(v=>{if(!v){o(e.actErr);return}s(v),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const p=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>h({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:m=>h({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Tn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Mi(a),onTest:()=>Fi(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function So(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Y(),[s,l]=u.useState(i||""),[c,g]=u.useState(!1),[d,h]=u.useState(!1);u.useEffect(()=>{i&&l(i)},[i]);const p=e.filters,b=u.useMemo(()=>n.filter(f=>Fe(f)).length,[n]),m=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(s)||d)){h(!0);try{await fetch(`${gn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:p.sector,countries:p.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{h(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(f=>We(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(f=>Pt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,N])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:N}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Dd(){const{t:e}=Y();return t.jsx($e,{title:e.alertTitle,icon:"🔔",children:t.jsx(So,{})})}function Id(){var D,B;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:s,caps:l,dispatch:c,liveMemos:g}=Y(),[d,h]=u.useState(()=>Ia(r)),[p,b]=u.useState(()=>!Ia(r)),[m,v]=u.useState([]),[y,f]=u.useState(0),N=n==="client",C=u.useMemo(()=>{const L=new Map;return o.forEach(F=>{const x=(F.name||"").trim().toLowerCase();x&&!L.has(x)&&L.set(x,F)}),L},[o]);u.useEffect(()=>{let L=!0;return(!Ia(r)||y>0)&&b(!0),(async()=>{const[F,x]=await Promise.all([vn(r,y>0),Pr(a)]);L&&(F&&h(F),b(!1),v(x))})(),()=>{L=!1}},[a,r,y]);const k=p&&!d,j=(d==null?void 0:d.per_day)??0,A=((D=d==null?void 0:d.analyzed_today)==null?void 0:D.length)??0,E=d==null?void 0:d.offre,q=(d==null?void 0:d.pool_meta)||[],z=u.useMemo(()=>{const L=new Map;for(const F of(d==null?void 0:d.scheduled)||[])for(const x of F.names||[])L.has(x)||L.set(x,{label:F.day_label,date:F.date});return L},[d==null?void 0:d.scheduled]),R=(d==null?void 0:d.in_progress)||[];return t.jsxs($e,{title:e.queueTitle,wide:!0,children:[E&&t.jsxs("div",{className:"qoffre"+(E.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:E.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:E.delai})]}),t.jsx("span",{className:"osp"}),E.rythme>0?t.jsx("span",{className:"or",children:e.qRate(E.rythme)}):E.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(E.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(A,A+(((B=d==null?void 0:d.pool_order)==null?void 0:B.length)??0))}})}),E&&t.jsxs("div",{className:"qeta",children:[E.file===0?e.qEtaDone:E.rythme<=0?e.qEtaPaused:e.qEta(E.file,E.rythme,E.jours_restants),E.en_retard&&t.jsxs("em",{children:[" ",e.qLate(E.delai,E.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(E==null?void 0:E.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(R.length>0||g.items.some(L=>L.status==="boot"||L.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(L=>L.status==="boot"||L.status==="running"||L.status==="error").map(L=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:L.name}),t.jsx("span",{className:"qd",children:L.memoType||""}),t.jsx(ya,{item:L,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+L.name)),R.filter(L=>!g.liveOf(L.name)).map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.name}),t.jsxs("span",{className:"qd",children:[L.memo_type||"",L.age_min?` · ${Math.round(L.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:L.state||""})]},"ip-"+L.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.company}),t.jsxs("span",{className:"qd",children:[L.memo_type,typeof L.est_min=="number"?` · ~${L.est_min} min`:""]}),t.jsx("span",{className:"qt",children:L.status}),L.url&&t.jsx("a",{className:"qgo",href:L.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),N&&L.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{$n(a,L.company,"retry").then(()=>f(F=>F+1))},children:e.queueRetry}),N&&L.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{$n(a,L.company,"delete").then(()=>f(F=>F+1))},children:e.queueDelete})]},L.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(q.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&q.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),q.map((L,F)=>{const x=z.get(L.name),T=C.get((L.name||"").trim().toLowerCase()),$=g.liveOf(L.name),Q=!!(T&&s.has(T.id))||!!($&&($.status==="boot"||$.status==="running")),H=!!(T&&Ae(T)===1&&!T.memoUrl)&&!$;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",F+1]}),x?t.jsx("span",{className:"qwhen"+(x.label==="demain"?" soon":""),children:x.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:L.name}),L.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof L.score=="number"&&t.jsx("span",{className:"qs2",children:L.score}),$&&($.status==="boot"||$.status==="running")&&t.jsx(ya,{item:$,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),H&&(l.lockActions||!N?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:Q,onClick:()=>{i(T),f(M=>M+1)},children:Q?e.actAnalyseQueued:e.actAnalyse})),L.excerpt&&t.jsx("span",{className:"qex",children:L.excerpt})]},L.name+":"+F)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([L,F])=>t.jsxs("li",{children:[t.jsx("b",{children:L})," — ",F]},L))})]})}function Pd(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:s}=Y(),l=`${Rt}/cibles/list.csv?token=${a}`,c=`${Rt}/cibles/list.json?token=${a}`,g=`${Rt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${l}")`,h=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:d},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{Nd(jd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs($e,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:y,value:f,href:N})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>h(f),children:e.exportCopy}),N&&t.jsx("a",{className:"exb",href:N,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Bd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Y(),i=o!=="client",[s,l]=u.useState(null),[c,g]=u.useState(!1),[d,h]=u.useState(0),[p,b]=u.useState(!1);u.useEffect(()=>{let f=!0;return g(!1),_n(a).then(N=>{f&&(N?l(N):g(!0))}),()=>{f=!1}},[a,d]);const m=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=f=>{if(i||!s)return;const N={enabled:f.enabled??!!s.enabled,email:f.email??(s.email||""),sections:f.sections??m()};b(!0),_n(a,N).then(C=>{if(b(!1),!C){n(e.memoAlertErr);return}l(C),r(e.memoAlertSaved)})};if(c)return t.jsx($e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>h(f=>f+1),children:e.retry})]})});if(!s)return t.jsx($e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs($e,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:i||p,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(_d,{value:s.email||"",readOnly:i||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>v({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,N])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:i||p,onChange:()=>v({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:N})]},f))}),t.jsx(Tn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Ei(a,y),onTest:()=>Ni(a,y)})]})}function _d({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,s]=u.useState(e);u.useEffect(()=>{s(e)},[e]);const l=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>s(g.target.value),onKeyDown:g=>{g.key==="Enter"&&l&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!c,onClick:()=>o(i.trim()),children:n})]})]})}function $d(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Y(),[i,s]=u.useState(null),[l,c]=u.useState(!1),[g,d]=u.useState(null),[h,p]=u.useState(""),[b,m]=u.useState(0);u.useEffect(()=>{let C=!0;return c(!1),Za(a).then(k=>{C&&(k?s({configured:k.configured,url_hint:k.url_hint}):c(!0))}),zi(a).then(k=>{C&&d(k)}),()=>{C=!1}},[a,b]);const v=(C,k)=>{o&&Za(a,C).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}C.test&&j.sent===!1?n(e.plugTestThrottled):r(k),m(A=>A+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',f=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),N=`curl -X POST ${Rt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs($e,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(C=>C+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:h,disabled:!o,onChange:C=>p(C.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!h.trim(),onClick:()=>v({url:h.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:f}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(f).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Ud,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:N}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(N).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Ud(){const{t:e,token:a,lang:r}=Y(),[n,o]=u.useState("valides"),[i,s]=u.useState(!1),[l,c]=u.useState(null),[g,d]=u.useState(null),[h,p]=u.useState(!1),[b,m]=u.useState(!1),[v,y]=u.useState(null),[f,N]=u.useState(null),[C,k]=u.useState(null),j=`atl2:bulk:${a}:${n}`;u.useEffect(()=>{Za(a).then(B=>{N(B&&B.configured?B.url_hint||"webhook":null)})},[a]),u.useEffect(()=>{c(null),d(null),p(!1),y(null);try{const B=JSON.parse(localStorage.getItem(j)||"null");k(B&&Date.now()-Date.parse(B.t)<24*3600*1e3?B:null)}catch{k(null)}},[j]);const A=async()=>{s(!0),p(!1),y(null);const B=await Ti(a,n);c(B),d(B.ok?n:null),s(!1)},E=u.useRef(!1),q=async()=>{if(E.current)return;E.current=!0,m(!0);const B=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await qi(a,n,"webhook",void 0,B)}finally{E.current=!1}if(m(!1),p(!1),y(L),L.ok&&(L.pushed||0)>0){const F={t:new Date().toISOString(),n:L.pushed||0};k(F);try{localStorage.setItem(j,JSON.stringify(F))}catch{}}},z=l!=null&&l.ok&&l.ready||0,R=!!(l!=null&&l.ok)&&g===n&&z>0&&!!f&&!C,D=C?new Date(C.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:B=>o(B.target.value),children:e.plugBulkTabs.map(([B,L])=>t.jsx("option",{value:B,children:L},B))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{A()},children:i?"…":e.plugBulkPreview})]}),l&&(l.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(l.ready||0,l.linkedinReady||0,(l.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(l!=null&&l.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),C&&t.jsx("p",{className:"mnote",children:e.bulkLocked(D,C.n)}),!C&&!!(l!=null&&l.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!C&&!l&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),R&&!h&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),R&&h&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(z,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{q()},children:b?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>p(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function Hd(){const{t:e,data:a,lang:r}=Y(),n=a.credits,o=a.email,i=async s=>{if(!o)return;const l=window.location.href.split("?")[0];try{const g=await(await fetch(`${gn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:s,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs($e,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Vd(){const{t:e}=Y();return t.jsx($e,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Cd,{})})}function Wd(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:s,flash:l}=Y(),[c,g]=u.useState(null),[d,h]=u.useState(!1);u.useEffect(()=>{let z=!0;if(i)return vn(i).then(R=>{z&&R&&typeof R.per_day=="number"&&g(R.per_day)}),()=>{z=!1}},[i]);const[p,b]=u.useState(null);u.useEffect(()=>{if(!o)return;let z=!0;return Ci(o).then(R=>{z&&b(R)}),()=>{z=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(z=>z.kind==="target"&&_e(z)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(v/y*100)):null,N=(m==null?void 0:m.window_days)||30,C=v>0?v/N:0,k=y>0?Math.max(0,y-v):0,A=y>0&&C>0&&v>=100?Math.round(k/C):null,E=z=>Math.round(z).toLocaleString(a==="en"?"en-US":"fr-FR"),q=z=>{d||!s||(h(!0),Ai(o,z).then(R=>{if(h(!1),R===null){l(e.actErr);return}g(R),l(e.alertSaved)}))};return t.jsxs($e,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(E(v))}),y>0&&t.jsx("span",{children:e.covOf(E(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),A!==null&&t.jsx("p",{className:"mnote",children:e.covEta(A)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),C>=1&&t.jsx("p",{className:"mnote",children:e.covPace(E(C))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.shown)})," ",e.funShown]})]}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((z,R)=>t.jsxs("tr",{className:z.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[z.code,z.geo?` · ${z.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof z.n=="number"?E(z.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:z.source}),z.elargi&&t.jsx("em",{children:e.covWide(String(z.demande||""))}),z.erreur&&t.jsx("em",{children:e.covMissing})]})]},R)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:E(p.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),s&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(z=>t.jsx("button",{type:"button",className:c===z?"on":"",disabled:d,onClick:()=>q(z),children:z===0?"⏸":z},z))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Gd(){var f,N,C;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:s,lang:l}=Y(),c=n==="client",g=u.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[d,h]=u.useState(""),[p,b]=u.useState(""),[m,v]=u.useState(!1),y=async()=>{const k=d.trim();if(!(!k||m||!c)){v(!0),b("");try{const A=await(await fetch(`${Rt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&b(String(A.reply)),A.job_id){b(e.critChatRunning);const E=async()=>{const q=await fetch(`${Rt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(z=>z.json()).catch(()=>null);if(q&&q.done){b(String(q.reply||q.clarification||q.summary||"✓")),v(!1),q.applied&&o(e.alertSaved);return}setTimeout(()=>{E()},8e3)};setTimeout(()=>{E()},8e3),h("");return}h("")}finally{p.startsWith("⏳")||v(!1)}}};return t.jsxs($e,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((N=i==null?void 0:i.angles)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(E=>t.jsx("li",{children:E},E))})]}),!!((A=k.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(E=>t.jsx("li",{children:E},E))})]})]})]},k.title)})]}),!!((C=i==null?void 0:i.gate)!=null&&C.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||m,onChange:k=>h(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!d.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Si,{fund:s,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(jo[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Yd(){const{t:e,dispatch:a,startTour:r}=Y(),n=o=>{var i,s;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs($e,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+s))})]})}const Co="atl2:mapfold",Kd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Co);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Qd=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},zo=u.createContext(null),Y=()=>{const e=u.useContext(zo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function xt({o:e,lg:a}){const{lang:r}=Y(),n=Fe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Vn(n,r),children:[n.emoji," ",Vn(n,r)]}):null}function Fa({o:e,src:a}){const{lang:r,t:n}=Y(),o=Fe(e);if(!o)return null;const i=_i(o),s=$i(o);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(Ur(o,r))+" · "+n.win7(Hr(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Jd(e,a,r){const n=(r||"").trim();if(n){const i=e.find(s=>(s.url||"")===n);if(i)return i}const o=Ie(a);if(o)return e.find(i=>Ie(i.name)===o)||e.find(i=>{const s=Ie(i.name);return s.length>=3&&(o.includes(s)||s.includes(o))})}function Xd(){const{scoped:e,t:a,st:r,dispatch:n}=Y(),o=u.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,s=e.filter(h=>!Ve(h)),l=s.length,c=s.filter(h=>!h.noCo).length,g=s.filter(h=>!!h.noCo).length,d=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:d?"7":"all"}});else{const h=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:h,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function Zd(){const{t:e,lang:a,data:r,dispatch:n}=Y(),o=r.stats,i=l=>l.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const s=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:s>0?e.covOf(i(s)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function Ao({o:e}){const{lang:a}=Y(),r=Bi(e.cc),n=e.cc?Pt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Fr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",ec=!1;function tc(){const[e,a]=u.useState(!1);return u.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const To=e=>`atl2:tour:${e||"anon"}`;function ac(e){try{return localStorage.getItem(To(e))==="1"}catch{return!0}}function Mr(e){try{localStorage.setItem(To(e),"1")}catch{}}function nc(e,a,r,n,o,i){const s=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function lc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var ie;const{lang:s}=Oi(),l=is[s],c=bs(e,s,a),[g,d]=u.useReducer(ws,void 0,()=>vs((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Qd():Kd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),h=u.useRef(!0);u.useEffect(()=>{if(h.current){h.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Co,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),u.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const w=()=>{window.innerWidth<=760&&d({type:"mapFold",folded:!0})};return w(),window.addEventListener("resize",w),()=>window.removeEventListener("resize",w)},[a]);const p=u.useRef(i);p.current=i,u.useEffect(()=>{var w;(w=p.current)==null||w.call(p,g.filters)},[g.filters]);const[b,m]=u.useState(()=>{if(typeof window>"u")return"both";try{const w=localStorage.getItem("atl2:chrome-mode");if(w==="eval"||w==="filt"||w==="both")return w;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=u.useState(null),[f,N]=u.useState(null),[C,k]=u.useState(null),[j,A]=u.useState({kept:0,dropped:0}),[E,q]=u.useState(!1),[z,R]=u.useState(""),[D,B]=u.useState(!1),[L,F]=u.useState(null),[x,T]=u.useState(!1),[$,Q]=u.useState(!1),[,H]=u.useState(0),M=()=>H(w=>w+1),K=u.useRef([]),_=u.useRef(new Set),J=u.useRef(new Set),[X,me]=u.useState([]),[U,le]=u.useState([]),[fe,Le]=u.useState(0),ae=u.useRef(new Map),ue=u.useRef(null),{mode:xe}=c,ce=u.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),Z=ce.pipe,ne=c.session.token||"",se=xe==="client"&&!e;u.useEffect(()=>{if(!ne||!Z)return;let w=!0;const P=async()=>{const te=await Ui(ne);!w||!te||(le(te.runs),Le(Date.now()/1e3-te.now),me(Ee=>Ee.filter(we=>!te.runs.some(et=>Ie(et.company)===Ie(we.name)))))};P();const O=X.length>0||U.some(te=>te.status==="running"),W=window.setInterval(()=>{P()},O?8e3:25e3);return()=>{w=!1,window.clearInterval(W)}},[ne,Z,X.length,U.some(w=>w.status==="running")]);const ge=u.useMemo(()=>{const w=[],P=new Set;for(const O of X){const W=Ie(O.name);!W||P.has(W)||(P.add(W),w.push({name:O.name,id:O.id,status:"boot",started:O.started,estMin:O.estMin,memoType:"instant"}))}for(const O of U){const W=Ie(O.company);if(!W||P.has(W))continue;P.add(W);const te=O.status==="error"?"error":O.status==="done"?"done":"running";w.push({name:O.company,status:te,started:O.started||0,estMin:O.est_min||(O.memo_type==="detailed"?40:15),url:O.url,error:O.error,memoType:O.memo_type,note:O.note})}return w},[X,U]),Se=w=>ge.find(P=>Ie(P.name)===Ie(w))||null,oe=(w,P)=>{me(O=>O.some(W=>Ie(W.name)===Ie(w.name))?O:[...O,{name:w.name,id:w.id,started:Date.now()/1e3,estMin:P==="detailed"?40:15}]),_.current.add(w.id),M()};u.useEffect(()=>{if(document.querySelector(`link[href="${Fr}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=Fr,document.head.appendChild(w)},[]);const pe=(w,P=!1)=>{R(w),B(P),ue.current&&clearTimeout(ue.current),ue.current=setTimeout(()=>R(""),P?4200:2400)},Pe=w=>pe(w,!0),Oe=u.useMemo(()=>{const w=new Map;return c.dossiers.forEach(P=>{P.id&&w.set(P.id,P)}),w},[c.dossiers]),Ce=u.useMemo(()=>c.dossiers.filter(w=>ja(w,g,Z)),[c.dossiers,g,Z]),ve=u.useRef(!1);u.useEffect(()=>{if(ve.current||e||c.loading||!c.dossiers.length)return;if(!ce.showFunnel||ac(c.session.token||"")){ve.current=!0;return}ve.current=!0;const w=window.setTimeout(()=>{Mr(c.session.token||""),T(!0)},700);return()=>window.clearTimeout(w)},[e,c.loading,c.dossiers.length,ce.showFunnel,c.session.token]);const ye=u.useMemo(()=>c.dossiers.filter(w=>ks(w,g,Z,c.favIds)),[c.dossiers,g,Z,c.favIds]),Ue=u.useMemo(()=>Di(Ce,c.favIds),[Ce,c.favIds]),Re=u.useRef(!1);u.useEffect(()=>{if(Re.current)return;if(!Z||a==="ops"){Re.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Re.current=!0;return}if(c.loading)return;Re.current=!0;const w=Ii(Ue);w!==g.ptab&&d({type:"ptab",tab:w})},[Z,a,n==null?void 0:n.ptab,c.loading,Ue,g.ptab]);const st=u.useMemo(()=>{const w=Xr(c.dossiers);return w?pt(w)===0?l.tourToday:Zr(w,s):l.tourNoRun},[c.dossiers,l,s]),ut=u.useMemo(()=>c.dossiers.some(w=>!!w.memoUrl||!!w.summary||Ft(w)),[c.dossiers]),[bt,at]=u.useState(!1);u.useEffect(()=>{if(c.loading){at(!1);return}if(c.dossiers.length>0||c.error){at(!0);return}const w=window.setTimeout(()=>at(!0),6e3);return()=>window.clearTimeout(w)},[c.loading,c.dossiers.length,c.error]);const vt=(c.marketEstimate||0)>0||typeof((ie=c.stats)==null?void 0:ie.screened)=="number"&&c.stats.screened>0,yt=u.useMemo(()=>[1,0,2,4,5,3].find(w=>(Ue[w]||0)>0)??0,[Ue]),Je=yn.find(w=>w.key===g.continent),mt=g.continent==="monde"?l.contWorld:(s==="fr"?Je==null?void 0:Je.fr:Je==null?void 0:Je.en)||"";u.useEffect(()=>{const w=P=>{var W;const O=(((W=P.detail)==null?void 0:W.name)||"").trim();O&&wt(null,O)};return window.addEventListener("ppmap:evaluate",w),()=>window.removeEventListener("ppmap:evaluate",w)}),u.useEffect(()=>{const w=P=>{const O=P.detail||{},W=String(O.id||"").trim(),te=String(O.name||"").trim(),Ee=String(O.url||"").trim(),we=W&&Oe.get(W)||Jd(c.dossiers,te,Ee);if(we){if(N(null),ja(we,g,Z)||(g.continent!=="monde"&&we.continent!==g.continent&&d({type:"continent",key:we.continent||"monde"}),d({type:"reset"})),Z&&we.kind!=="op"){const ke=Ae(we);typeof ke=="number"&&ke!==g.ptab&&d({type:"ptab",tab:ke})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),d({type:"focus",id:we.id}),(we.noCo||["media","nominations","recrutements"].includes(we.engine||""))&&(we.url||we.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:we.url||"",text:[we.headline,we.tagline].filter(Boolean).join(`
`)}})):we.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:we.name,url:we.url||"",website:we.website||"",domain:we.domain||""}}));return}!te&&!Ee||(d({type:"focus",id:W||null}),N({name:te,headline:String(O.text||"").trim()||te,url:Ee,card:O.card}),Ee&&(wa(te)||!te)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee,text:String(O.text||"").trim()}})):te&&!wa(te)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:te}})))};return window.addEventListener("ppmap:focus",w),()=>window.removeEventListener("ppmap:focus",w)}),u.useEffect(()=>{const w=W=>{const te={},Ee=String((W==null?void 0:W.sector)||"").trim();Ee&&(te.sector=[Ee]);const we=String((W==null?void 0:W.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(we)&&(te.day=we);const et=String((W==null?void 0:W.search)||"").trim();et&&(te.search=et);const ke=String((W==null?void 0:W.dealKind)||"").trim();(ke==="ma"||ke==="levee"||ke==="other")&&(te.dealKind=[ke]),Object.keys(te).length&&d({type:"filters",patch:te})},P=W=>w(W.detail),O=W=>{W.data&&W.data.type==="pp-filter"&&w(W.data)};return window.addEventListener("ppmap:filter",P),window.addEventListener("message",O),()=>{window.removeEventListener("ppmap:filter",P),window.removeEventListener("message",O)}},[]),u.useEffect(()=>{const w=P=>{var te;const O=(((te=P.detail)==null?void 0:te.name)||"").trim().toLowerCase();if(!O)return;const W=c.dossiers.find(Ee=>(Ee.name||"").trim().toLowerCase()===O);W&&d(a==="ops"?{type:"focus",id:W.id}:{type:"popup",id:W.id})};return window.addEventListener("ppmap:similar",w),()=>window.removeEventListener("ppmap:similar",w)});const wt=(w,P)=>{const O=((w==null?void 0:w.name)||P||"").trim();if(!se){k({kicker:O});return}!O||E||(q(!0),(async()=>{try{let W=O;const te=((w==null?void 0:w.website)||(w==null?void 0:w.domain)||"").trim();if(te)W=te;else try{const ke=await _r(O);if(ke!=null&&ke.website)W=ke.website;else if(((ke==null?void 0:ke.candidates)||[]).length===1)W=ke.candidates[0].url;else if(((ke==null?void 0:ke.candidates)||[]).length>1){K.current=[{name:O,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(ke.candidates||[]).slice(0,5)},...K.current].slice(0,8),M();return}}catch{}const Ee=await $r(ne,W,"atelier2"),we={name:Ee.company||O,verdict:Ee.verdict,reason:Ee.reason||"",remaining:Ee.remaining??null};K.current=[we,...K.current].slice(0,8),Ee.verdict==="kept"&&A(ke=>({...ke,kept:ke.kept+1})),Ee.verdict==="ruled_out"&&A(ke=>({...ke,dropped:ke.dropped+1}));const et=w||c.dossiers.find(ke=>(ke.name||"").toLowerCase()===O.toLowerCase());et&&(Ee.verdict==="kept"?et.verdict=et.verdict||"MATCH":Ee.verdict==="ruled_out"&&(et.verdict="NO MATCH"),Ee.reason&&(et.reasoning=Ee.reason)),M()}finally{q(!1)}})())},S=w=>{if(!se){k({kicker:w.name});return}oe(w,"instant"),Ht(ne,"fast_request",w.name||"",""),pe(l.memoInstantSent(w.name))},G=w=>ae.current.get(w.id)??c.thumbs.get((w.name||"").trim().toLowerCase()),V=(w,P)=>d({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:P}}),re=async(w,P,O)=>{const W=w.ceoStatus||"";w.ceoStatus=P,M();const te=await Pa(ne,{status:P,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(O==null?void 0:O.note)!==void 0?{note:O.note}:{},...O!=null&&O.via?{via:O.via}:{}});return te.ok?te.skipped?(w.ceoStatus=W,M(),Pe(l.actNotPersisted),!1):((O==null?void 0:O.undo)!==!1&&V(w,W),O!=null&&O.msg&&pe(O.msg),(P==="Validé"||P==="Écarté")&&!w.ceoNote&&(O==null?void 0:O.note)===void 0&&F({o:w,yes:P==="Validé"}),!0):(w.ceoStatus=W,M(),Pe(l.actErr),!1)},be=async(w,P)=>{const O=await Pa(ne,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:P,via:"note"});return!O.ok||O.skipped?(Pe(O.skipped?l.actNotPersisted:l.actErr),!1):(w.ceoNote=P,M(),!0)},de=u.useRef(new Map),je=w=>de.current.has(w.id)?de.current.get(w.id):c.stages.get((w.name||"").trim().toLowerCase()),Xe=(w,P)=>{de.current.set(w.id,P),M()},kt=(w,P)=>{se&&re(w,P?"Validé":"Écarté",{msg:P?l.decidedYes(w.name):l.decidedNo(w.name)})},ft=w=>{se&&re(w,"À trancher",{msg:l.promoted(w.name)})},_t=w=>{se&&(async()=>{const P=w.ceoStatus||"";w.ceoStatus="Retenu",M();const O=await Pa(ne,{status:"Retenu",check_id:w.checkId,company:w.name});if(!O.ok||O.skipped){w.ceoStatus=P,M(),Pe(O.skipped?l.actNotPersisted:l.actErr);return}V(w,P),pe(l.repeched(w.name))})()},Tt=()=>{const w=g.undo[g.undo.length-1];if(!w){pe(l.undoNone);return}const P=Oe.get(w.id);if(!P){d({type:"undoPop"}),pe(l.undoNone);return}let O=w.prevCeoStatus;if(!O)if((P.verdict||"").toUpperCase().includes("CALL"))O="À trancher";else{pe(l.undoLockedTitle);return}(async()=>await re(P,O,{undo:!1})&&(d({type:"undoPop"}),P.ceoStatus=w.prevCeoStatus,M(),pe(l.undoDone(P.name))))()},Me=w=>{se&&(J.current.add(w.id),M(),(async()=>{const P=await Hi(ne,w.name,"email");if(!P||P.ok===!1){J.current.delete(w.id),M(),Pe(l.actErr);return}Ht(ne,"approach",w.name||"",""),pe(l.actApproachSent)})())},De=(w,P)=>{se&&(async()=>{if(!(await Ht(ne,P?"yes":"no",w.name||"","")).ok){Pe(l.actErr);return}ae.current.set(w.id,P?"yes":"no"),M(),pe(P?l.thumbUpDone:l.thumbDnDone)})()},Ze=w=>{!se||!Ft(w)||(oe(w,"detailed"),Ht(ne,"detailed_request",w.name||"",""),pe(l.memoDeepSent(w.name)))},$t=w=>{const P=new Set(c.favIds),O=P.has(w.id);O?P.delete(w.id):P.add(w.id),c.setFavIds(P),se&&Vi(ne,{id:w.id,co:w.name},O)},Ut=()=>{!se||$||window.confirm(l.identSyncConfirm)&&(Q(!0),(async()=>{const w=await Wi(ne);Q(!1),w?pe(l.identSyncDone):Pe(l.actErr)})())},oa=/proplace/i.test(c.fund||""),Ma=w=>{!se||!oa||(Ht(ne,"onboard_request",w.name||"",""),pe(l.onboardSent(w.name)))},I={st:g,dispatch:d,t:l,lang:s,mode:xe,caps:ce,pipe:Z,token:ne,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:_t,thumbOf:G,canWrite:se,commitStatus:re,saveNote:be,stageOf:je,setStage:Xe,flashErr:Pe,startTour:()=>T(!0),dossiers:c.dossiers,scopedAll:Ce,scoped:ye,counts:Ue,byId:Oe,contName:mt,favIds:c.favIds,toggleFav:$t,askEvaluate:wt,doAnalyse:S,doDecide:kt,doPromote:ft,doApproach:Me,doThumb:De,doDeep:Ze,doUndo:Tt,doSync:Ut,doOnboard:Ma,outbound:oa,memoQueued:_.current,liveMemos:{items:ge,serverOff:fe,liveOf:Se},approachDone:J.current,sessTally:j,evalCards:K.current,evalBusy:E,markRow:y,markedId:v,flash:pe,focusExtra:f};u.useEffect(()=>{const w=P=>{P.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]);const ee=w=>ne?t.jsx(Es,{token:ne,children:w}):t.jsx(t.Fragment,{children:w});return t.jsx(zo.Provider,{value:I,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ne?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:cs}),ee(t.jsxs("div",{className:"app"+(Z?" pipe":"")+(ne?" has-thesis":""),children:[ce.showTicker&&t.jsx(tt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ne?" live-stack--cibles":""),children:[t.jsx(Ls,{}),!!ne&&t.jsx(Ss,{})]})}),ce.showIdent&&t.jsx(tt,{name:"identite",children:t.jsx(Us,{})}),!1,ec,ce.showFunnel&&t.jsx(tt,{name:"entonnoir",children:t.jsx(rc,{})}),!g.mapFolded&&t.jsx(tt,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(yo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Xd,{}),a!=="ops"&&ce.showFunnel&&t.jsx(Zd,{}),t.jsx(_l,{}),t.jsx(vo,{})]})]})}),ce.showDemand&&Z&&t.jsx(tt,{name:"direct",children:t.jsx(Ji,{items:ge,serverOff:fe,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>d({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([w,P])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===w,onClick:()=>{m(w);try{localStorage.setItem("atl2:chrome-mode",w)}catch{}},children:P},w))}),ce.showDemand&&t.jsx(tt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Yl,{})})}),ce.showDemand&&g.memoConsole&&t.jsx(tt,{name:"console",children:t.jsx(Ql,{})}),ce.pipe&&!!ne&&t.jsx(tt,{name:"moteurs",children:t.jsx(ns,{})}),t.jsx(tt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(wd,{})}),c.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:l.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(tt,{name:"fiche",children:t.jsx(rd,{})}),t.jsx(tt,{name:"modales",children:t.jsx(Ad,{})}),t.jsx(Ms,{}),L&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:L.o.name}),t.jsx(Ps,{placeholder:L.yes?l.whyYesPh:l.whyNoPh,onDone:w=>{const P=L.o;F(null),w&&be(P,w).then(O=>{O&&pe(l.csNoteSaved)})}})]}),x&&bt&&t.jsx(_s,{steps:nc(l,st,ut,yt,vt,Ue[3]||0),onClose:()=>{T(!1),Mr(ne)}}),t.jsx(tc,{}),ce.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:Qr,children:jn}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${Na}`,children:Na})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),z&&t.jsx("div",{className:"flash on"+(D?" err":""),children:z}),C&&t.jsx(Pi,{variant:"acquirer",initialCompany:Or().co,initialWebsite:Or().site,onClose:()=>k(null)})]})})}function rc(){const{t:e}=Y(),[a,r]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Or(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function oc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Ao as FlagCell,xt as SigBadge,Fa as SigWin,lc as default,oc as fmtShort,Y as useV2};
;/* deploy-1788030565 */
