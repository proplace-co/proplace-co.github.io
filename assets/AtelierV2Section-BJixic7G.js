...
`,sn=rn+on;function ln(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function dn(t,a){return t||a.mode!=="client"||!a.token?"visiteur":ln("teaser")==="1"?"apercu":"client"}const cn={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},pn=t=>cn[t],xe=t=>Object.assign(t,{continent:ba(t.cc)});function Ye(t){const a=new Set,r=[];for(const n of t){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const un=60*60*1e3;function mn(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>un?null:a}catch{return null}}function De(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const fn=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function xn(t,a,r="default"){const n=r!=="default",i=p.useMemo(()=>t||n?{mode:"anon"}:pa(),[t,n]),o=p.useMemo(()=>n?"visiteur":dn(t,i),[t,i,n]),d=p.useMemo(()=>pn(o),[o]),s=o!=="visiteur",c=fn(r),[u,h]=p.useState([]),[l,b]=p.useState(""),[v,g]=p.useState(null),[f,x]=p.useState(null),[m,y]=p.useState(null),[S,w]=p.useState(()=>new Map),[C,k]=p.useState(()=>new Map),[z,N]=p.useState(""),[A,D]=p.useState(new Set),[M,E]=p.useState(null),[P,q]=p.useState(!0),[B,R]=p.useState(!1),[_,se]=p.useState(0),[pe,Oe]=p.useState(0),he=p.useRef(0),ue=p.useMemo(()=>{var V;if(o!=="client")return"";try{return((V=ua())==null?void 0:V.email)||""}catch{return""}},[o]);p.useEffect(()=>{const V=++he.current;let U=!0;const F=()=>U&&V===he.current,I=(s&&i.token?i.token:"pub:"+a)+(c?":"+c:""),H=mn(I);return H?(h(H.objs.map(xe)),H.fund&&b(H.fund),g(H.marketEstimate??null),x(H.criteria??null),y(H.stats??null),N(H.generatedAt||""),q(!1)):q(!0),(async()=>{try{if(r==="ops"){const re=await Ue(),te=((re==null?void 0:re.recent_ops)||[]).map(J=>He(J,a)).filter(J=>!!J);if(!F())return;h(te.map(xe)),De(I,{objs:te})}else if(typeof r=="object"){const te=(await dt()||[]).filter(Z=>(Z.slug||"")===r.research).map(Z=>ct(Z,a)).filter(Z=>!!Z),J=Ye(await pt(te,a));if(!F())return;h(J.map(xe)),De(I,{objs:J})}else if(s&&i.token){const re=ma(i.token),te=Ue(),J=fa(i.token),Z=xa(i.token),Ce=ga(i.token),$=await re;let le=$?$.targets:[];F()&&$&&(b($.fund||""),g($.marketEstimate??null),x($.criteria??null),y($.stats??null),N($.generatedAt||""),h(le.map(xe)),q(!1),R(!1));const[me,ze,be,ae]=await Promise.all([te,J,Z,Ce]),ve=((me==null?void 0:me.recent_ops)||[]).map(oe=>He(oe,a)).filter(oe=>!!oe);if(le=[...le,...ve],!F())return;h(le.map(xe));const Ee=new Set;for(const oe of ze){const ye=(oe.id||oe.co||"").toString().trim().toLowerCase();ye&&Ee.add(ye.startsWith("t:")?ye:"t:"+ye)}D(Ee),w(be),k(ae),$&&De(I,{fund:$.fund,marketEstimate:$.marketEstimate,criteria:$.criteria,stats:$.stats,generatedAt:$.generatedAt,objs:le})}else{const re=ha(),te=dt(),J=Ue(),Z=await re;F()&&Z.length&&(h(Ye(Z).map(xe)),q(!1),R(!1));const[Ce,$]=await Promise.all([te,J]),le=(Ce||[]).map(ae=>ct(ae,a)).filter(ae=>!!ae),me=await pt(le,a),ze=(($==null?void 0:$.recent_ops)||[]).map(ae=>He(ae,a)).filter(ae=>!!ae),be=Ye([...Z,...me,...ze]);if(!F())return;h(be.map(xe)),De(I,{objs:be})}F()&&R(!1)}catch{F()&&!H&&R(!0)}finally{F()&&q(!1)}})(),()=>{U=!1}},[s,i.token,a,_,c]),p.useEffect(()=>{if(!d.showCredits||!ue){E(null);return}let V=!0;return(async()=>{try{const U=await fetch(`${Qe}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ue})});if(!U.ok)return;const F=await U.json();V&&F&&F.ok!==!1&&E(F)}catch{}})(),()=>{V=!1}},[d.showCredits,ue,pe]);const Y=p.useCallback(V=>D(new Set(V)),[]);return{session:i,mode:o,caps:d,fund:l,email:ue,marketEstimate:v,generatedAt:z,criteria:f,stats:m,thumbs:S,stages:C,dossiers:u,favIds:A,setFavIds:Y,credits:M,reloadCredits:()=>Oe(V=>V+1),loading:P,error:B,refresh:()=>se(V=>V+1)}}const Pt=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),gn=(t="europe",a=!1,r)=>({continent:t,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Pt(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function hn(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const r=t.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...t,filters:{...t.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=t.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...t,filters:{...t.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Pt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Ie)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Ie=60;function at(t,a,r,n){if(n!=="signal"&&a.signalOnly&&(!Q(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(t.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Je(t)))return!1;if(n!=="win"){if(a.day){if((t.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ke(t.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&ce(t)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Bt(t,a,r){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:at(t,a.filters,r)}function bn(t,a,r,n){return!(!Bt(t,a,r)||r&&!va(t,a.ptab,n))}function nt(t,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ke(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=Q(i);return o?100-(o.left??0):-1}}};return[...t].sort((i,o)=>{const d=n(i),s=n(o);return d<s?-a.dir:d>s?a.dir:(i.name||"").localeCompare(o.name||"")})}function vn(){const{dossiers:t,st:a,t:r,dispatch:n,contName:i,pipe:o}=T(),d=p.useMemo(()=>{const c=l=>o?!0:l.continent===a.continent,u=t.filter(l=>c(l)&&Q(l)),h=t.filter(l=>c(l)&&l.kind==="op"&&!Q(l)&&(l.dealKind==="ma"||l.dealKind==="levee")&&ke(l.date)<=2);return h.sort((l,b)=>(b.amountEur||0)-(l.amountEur||0)),[...nt(u,{key:"signal",dir:-1}),...h].slice(0,40)},[t,a.continent,o]),s=c=>d.map(u=>e.jsxs("button",{type:"button",className:"tk"+(ne(u)?" spent":""),onClick:h=>{const l=h.currentTarget.getBoundingClientRect();n({type:"popup",id:u.id,anchor:{x:l.left+l.width/2,y:l.bottom}})},title:u.name+(u.tagline?" — "+u.tagline:""),children:[e.jsx(Se,{o:u}),e.jsxs("span",{className:"who",children:[e.jsx(_t,{o:u}),e.jsx("span",{className:"co",children:u.name})]}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{className:"am",children:Ur(u.amountEur)}),u.sector&&e.jsx("span",{className:"mt",children:u.sector}),e.jsx(Ve,{o:u}),e.jsx("span",{className:"tkgo",children:"→"})]},c+(u.id||u.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),r.live,e.jsx("span",{className:"cnt",children:d.length})]}),e.jsx("div",{className:"win",children:d.length?e.jsxs("div",{className:"run",children:[s(0),s(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const yn="aDx8z7Hzksus",It="+33 6 83 10 72 86",yt="alexandre@proplace.co",wn=`tel:${It.replace(/[^\d+]/g,"")}`,wt="pp-rdv-slot";function kn(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function jn(){const{t,caps:a,fund:r}=T(),n=a.showOnb,i=r||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${n?" is-teaser":""}`,children:[e.jsx("style",{children:Sn}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:wn,children:It}),t.rdvSubMid,e.jsx("a",{href:`mailto:${yt}`,children:yt})]}),n&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(i).map(([o,d],s)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(s+1)}),e.jsx("b",{children:o}),e.jsx("span",{children:d})]},o))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(en,{filloutId:yn,parameters:r?{company_name:r}:void 0})})]})}function Nn(){const[t,a]=p.useState(()=>typeof document>"u"?null:document.getElementById(wt));return p.useEffect(()=>{t||a(document.getElementById(wt))},[t]),t?Le.createPortal(e.jsx(jn,{}),t):null}const Sn=`
...
`;class G extends p.Component{constructor(){super(...arguments);st(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Cn=8;function zn(){const{t,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:d}=T(),[s,c]=p.useState(!1),[u,h]=p.useState(!1),[l,b]=p.useState(!1),v=r||"home",{names:g,verdicts:f}=p.useMemo(()=>{const w=[],C={};return n.forEach(k=>{k.kind!=="target"||!k.name||(w.push(k.name),C[k.name]=ya(k)||"")}),{names:w,verdicts:C}},[n]),x=p.useMemo(()=>g.length?wa(v,g,f,a):null,[v,g.length]);if(!i.pipe||s||!x||x.firstVisit||!x.added.length&&!x.gone.length)return null;const m=u?x.added:x.added.slice(0,Cn),y=x.added.length-m.length,S=w=>{const C=n.find(k=>k.name===w);C&&(o(C.id),d({type:"popup",id:C.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(x.added.length,x.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{c(!0),ka(v,g,f,x.fp,a)},children:"×"})]}),!!x.added.length&&e.jsxs("div",{className:"since-c",children:[m.map(w=>e.jsx("button",{type:"button",onClick:()=>S(w),children:w},w)),y>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>h(!0),children:t.sinceMore(y)})]}),!!x.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>b(w=>!w),children:t.sinceOut(x.gone.length)}),l&&x.gone.slice(0,20).map(w=>e.jsx("span",{className:"gone",children:w},w))]})]})}const We=600,ge=62,kt="atl2:fstats";function En(){const{t,lang:a,data:r,caps:n,st:i,dispatch:o}=T(),[d,s]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(kt)==="on"}catch{return!1}}),c=r.stats,u=p.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),h=p.useMemo(()=>{if(c!=null&&c.since)return c.since;const y=new Date;return y.setDate(y.getDate()-((c==null?void 0:c.window_days)||30)),y.toISOString().slice(0,10)},[c==null?void 0:c.since,c==null?void 0:c.window_days]);if(!n.showFunnel||!c||typeof c.screened!="number")return null;const l=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,b=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),v=u.reduce((y,S)=>Math.max(y,S.s||0),0),g=u.length?We/u.length:0,f=Math.max(4,g-4),x=u.length>=5&&v>0,m=[[c.screened,t.funScreened(l(h)),c.screened_today],...typeof c.kept=="number"?[[c.kept,t.funKept,c.kept_today]]:[],...typeof c.analyzed=="number"?[[c.analyzed,t.funAnalyzed,c.analyzed_today]]:[],...typeof c.shown=="number"?[[c.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(d?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[m.map(([y,S,w],C)=>e.jsxs("span",{className:"fst-t",children:[C>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:b(y)}),e.jsx("i",{children:S}),d&&typeof w=="number"&&w>0&&e.jsx("em",{children:t.funToday(w)})]},S)),x&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?t.fstatsHide:t.fstatsShow,onClick:()=>{const y=!d;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(kt,y?"on":"off")}catch{}},children:d?"⌃":"⌄"})]}),d&&x&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${We} ${ge}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[u.map((y,S)=>{const w=(y.s||0)/v*(ge-4),C=(y.m||0)/v*(ge-4),k=S*g+(g-f)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${l(y.d)} — ${y.s} ${t.actScreened} · ${y.m} ${t.actKept}`}),e.jsx("rect",{x:k,y:ge-2-w,width:f,height:w,fill:"#cfe0d6"}),e.jsx("rect",{x:k,y:ge-2-C,width:f,height:C,fill:"#185c38"})]},y.d)}),e.jsx("line",{x1:0,y1:ge-1.5,x2:We,y2:ge-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:l(u[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const Tn=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function An({o:t}){const{t:a,caps:r,canWrite:n,commitStatus:i}=T(),[o,d]=p.useState(""),[s,c]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const u=(t.ceoStatus||"").trim(),h=(je(t)||"").startsWith("CALL")&&ee(t)===3,l=ee(t)>=2,b=async g=>{if(o||g==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(g);const f=await i(t,g);d(""),f&&(c(!0),setTimeout(()=>c(!1),2200))},v=h?[["Validé",a.csYes],["Écarté",a.csNo]]:Tn.filter(([g])=>!(l&&g==="Retenu")).map(([g,f])=>[g,a[f]]);return e.jsxs("div",{className:"csp",onClick:g=>g.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([g,f])=>e.jsx("button",{type:"button",className:"csb"+(u===g?" on":"")+(o===g?" busy":""),disabled:!!o,onClick:()=>{b(g)},children:f},g)),s&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(qn,{o:t})]})}function qn({o:t}){const{t:a,saveNote:r,flash:n}=T(),[i,o]=p.useState(t.ceoNote||""),[d,s]=p.useState(!1),[c,u]=p.useState(!1),h=i.trim()!==(t.ceoNote||"").trim(),l=async()=>{if(d||!h)return;s(!0);const b=await r(t,i.trim());s(!1),b&&(u(!0),setTimeout(()=>u(!1),2200),n(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:d,onChange:b=>o(b.target.value),onKeyDown:b=>{b.key==="Enter"&&l()}}),e.jsx("button",{type:"button",disabled:d||!h,onClick:()=>{l()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Ln({placeholder:t,onDone:a}){const{t:r}=T(),[n,i]=p.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function On({o:t}){var x;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:d,flashErr:s}=T(),[c,u]=p.useState(!1);if(!n.pipe||!i||n.lockActions||ee(t)!==4)return null;const h=o(t),l=(h==null?void 0:h.stage)||"todo",b=async m=>{if(c||m===l)return;u(!0);const y=h;d(t,{stage:m,stamps:(h==null?void 0:h.stamps)||{}});const S=Math.max(Date.now(),jt+=1);jt=S;const w=await ja(r,{company:t.name||"",stage:m,cts:S,deal_id:t.airtableId,check_id:t.checkId});u(!1),!w.stale&&(w.ok||(d(t,y),s(a.actErr)))},v=(x=h==null?void 0:h.stamps)==null?void 0:x.sent,g=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,f=l==="sent"&&v&&g>=4;return e.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>e.jsx("button",{type:"button",className:"stgb"+(l===m?" on":""),disabled:c,onClick:()=>{b(m)},children:y},m)),f&&e.jsx("span",{className:"stgj4",children:a.j4Badge(g)})]})}let jt=0;const Fe=8,Pe=340;function Nt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((r,n)=>n%2?e.jsx("b",{children:r},n):e.jsx("span",{children:r},n))})}function Rn({steps:t,onClose:a}){const{t:r,dispatch:n,counts:i,scoped:o,byId:d,st:s}=T(),[c,u]=p.useState(0),[h,l]=p.useState(null),[b,v]=p.useState([]),g=p.useRef(!1);p.useEffect(()=>{g.current||(g.current=!0,v(t.filter(C=>!!document.querySelector(C.need||C.sel))))},[t]);const f=b[c],x=c>=b.length;p.useEffect(()=>{f&&(f.ptab!==void 0&&s.ptab!==f.ptab&&n({type:"ptab",tab:f.ptab}),f.dens&&s.dens!==f.dens&&n({type:"dens",dens:f.dens}))},[c,f]);const m=p.useCallback(()=>{if(!f){l(null);return}const C=document.querySelector(f.sel);if(!C){l(null);return}C.scrollIntoView({block:"nearest",behavior:"smooth"}),l(C.getBoundingClientRect())},[f]);p.useLayoutEffect(()=>{m();const C=window.setTimeout(m,260),k=()=>m();return window.addEventListener("scroll",k,!0),window.addEventListener("resize",k),()=>{window.clearTimeout(C),window.removeEventListener("scroll",k,!0),window.removeEventListener("resize",k)}},[m]);const y=p.useRef(a);if(y.current=a,p.useEffect(()=>{const C=k=>{k.key==="Escape"?(k.preventDefault(),k.stopPropagation(),y.current()):k.key==="ArrowRight"?u(z=>z+1):k.key==="ArrowLeft"&&u(z=>Math.max(0,z-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!b.length)return null;let S=null;if(x){const C=i[3]||0,k=o.find(z=>z.memoUrl)||[...d.values()].find(z=>z.memoUrl);C>0?S={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:k?S={title:r.ahaBTitle,body:r.ahaBBody(k.name),btn:r.ahaBBtn,go:()=>{n({type:"memoConsole",id:k.id}),a()}}:S={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Pe};if(!x&&h){const C=h.bottom+14,z=window.innerHeight-C>190?C:Math.max(12,h.top-200);w={left:Math.min(Math.max(12,h.left+h.width/2-Pe/2),window.innerWidth-Pe-12),top:z,width:Pe}}return Le.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!x&&h&&e.jsx("div",{className:"tour-hole",style:{left:h.left-Fe,top:h.top-Fe,width:h.width+Fe*2,height:h.height+Fe*2}}),(x||!h)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(x?" fin":""),style:w,children:[x&&S?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:S.title}),e.jsx("p",{children:e.jsx(Nt,{text:S.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>u(b.length-1),children:r.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:S.go,children:S.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:r.tourStep(c+1,b.length)}),e.jsx("h3",{children:f==null?void 0:f.title}),e.jsx("p",{children:e.jsx(Nt,{text:(f==null?void 0:f.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:c===0,onClick:()=>u(C=>Math.max(0,C-1)),children:r.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>u(C=>C+1),children:c===b.length-1?r.tourDone:r.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Mn(){const{dossiers:t,pipe:a,t:r,st:n,dispatch:i}=T(),o=p.useMemo(()=>t.filter(l=>ke(l.date)===0&&l.kind==="target"),[t]),d=p.useMemo(()=>o.filter(l=>a?ee(l)===0:!ne(l)),[o,a]),s=o.length-d.length,c=o.length?Math.min(100,s/o.length*100):100;let u;a?u=r.morningThesis(o.length,s,d.length):o.length?s===0?u=r.goalSourced(o.length):s>=o.length?u=r.goalCleared:u=r.goalDone(s,o.length):u=r.goalSourced(0);const h=()=>{a?(i({type:"ptab",tab:0}),i({type:"filters",patch:{win:"1"}})):i({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:u}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:c+"%"}})}),d.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:a?r.morningEval(d.length):n.pileMode?r.goalContinue(d.length):r.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Dn(){var D,M;const{t,lang:a,st:r,dispatch:n,token:i,fund:o,data:d,dossiers:s,mode:c,doSync:u,startTour:h}=T(),[l,b]=p.useState(null),[v,g]=p.useState([]),f=c==="client";p.useEffect(()=>{if(!i||!o)return;let E=!0;return(async()=>{const[P,q]=await Promise.all([Xe(o),Rt(i)]);E&&(P&&b(P),g(q))})(),()=>{E=!1}},[i,o]);const x=(l==null?void 0:l.per_day)??null,m=((D=l==null?void 0:l.pool_order)==null?void 0:D.length)??0,y=v.filter(E=>E.status==="running").length,S=p.useMemo(()=>s.filter(E=>E.kind==="target"&&ne(E)).length,[s]),w=d.marketEstimate,C=typeof((M=d.stats)==null?void 0:M.screened)=="number"?d.stats.screened:S,k=w&&w>0?Math.min(100,Math.round(C/w*100)):null,z=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),N=(o||"P").split(/\s+/).map(E=>E[0]).join("").slice(0,2).toUpperCase(),A=(()=>{const E=Date.parse(d.generatedAt||"");if(Number.isNaN(E))return"";const P=new Date(E),q=B=>String(B).padStart(2,"0");return`${q(P.getDate())}/${q(P.getMonth()+1)} à ${q(P.getHours())}:${q(P.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),A&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(A)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:h,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[k===null&&C>0&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsx("span",{className:"ev",children:e.jsx("b",{children:z(C)})})]}),k!==null&&w&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:k+"%"}})}),e.jsxs("b",{children:[k," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(C,w)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),x!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"q",children:x})," ",t.identPerDay]}),e.jsx("span",{className:"edv"})]}),x===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),y>0&&e.jsxs("span",{className:"ev",children:["⏳ ",y]}),e.jsx("span",{className:"ego",children:t.identPending(m)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:E=>{E.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!f,onClick:u,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:r.filters.search,onChange:E=>n({type:"filters",patch:{search:E.target.value}})})]})]})]})}function Fn(){const{t,counts:a,dispatch:r}=T();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([n,i],o)=>{const d=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(d?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:n}),e.jsx("div",{className:"s4d",children:i}),d&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Pn=["--p0","--p1","--p2","--p3","--p4"];function Bn(){const{st:t,dispatch:a,counts:r,t:n,doUndo:i}=T(),o=p.useRef({});p.useEffect(()=>{o.current={...r}},[r]);const d=u=>{const h=o.current[u],l=h!==void 0?r[u]-h:0;return e.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Pn[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[e.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(l>0?" up":l<0?" down":""),children:[r[u],l!==0&&e.jsxs("em",{className:"delta",children:[l>0?"+":"−",Math.abs(l)]})]})]},u)},s=(u,h,l)=>e.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[e.jsx("span",{className:"l",children:l.toUpperCase()}),e.jsx("span",{className:"n",children:r[u]})]},u),c=(u,h,l,b=!1)=>e.jsx("button",{type:"button",className:"tool",title:h,disabled:b,onClick:l,children:u},h);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(d)}),e.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[c("↩",n.toolUndo,i,t.undo.length===0),c("↺",n.toolReset,()=>{a({type:"reset"})}),c("⇅",n.toolSort,()=>a({type:"sort",key:t.sort.key})),c("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),c("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const In=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function $n(){const{st:t,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:d}=T(),s=p.useRef(null),[c,u]=p.useState(60);p.useEffect(()=>{let v=0;const g=()=>{var S;const f=s.current;if(!f)return;const x=(S=f.parentElement)==null?void 0:S.querySelector('.funnel [aria-selected="true"]');if(!x)return;const m=x.getBoundingClientRect(),y=f.getBoundingClientRect();u(Math.max(20,Math.min(m.left+m.width/2-y.left,y.width-30)))};return v=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",g)}},[t.ptab]);const h=t.ptab;let l=r.tuto[h].p;if(h===3){const v=n.filter(x=>x.kind==="target"&&ee(x)===3),g=v.filter(x=>Ge(x)==="auto").length,f=v.filter(x=>Ge(x)==="cd").length;l=r.tutoPending(g,f,v.length)}const b=(()=>{if(d!=="client")return null;if(h===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(v=>v.id)})};if(h===1){const v=n.filter(g=>g.kind==="target"&&ee(g)===1&&!i.has(g.id)).slice(0,10);if(v.length)return{label:r.tuto[1].a,run:()=>v.forEach(g=>o(g))}}return null})();return e.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":In[h],"--ax":c+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:r.plabels[h].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:l}})]})}),b&&e.jsx("button",{type:"button",className:"tprim",onClick:b.run,children:b.label})]})}const St=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Ct(t){let a=2166136261;for(let r=0;r<t.length;r++)a^=t.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Vn(t,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let i=!0,o=0;const d=()=>{var u;if(!i)return;const c=(u=t.current)==null?void 0:u.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(d)};d();const s=new ResizeObserver(()=>d());return t.current&&s.observe(t.current),window.addEventListener("resize",d),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",d)}},[t,a]),r}function Un(){const{st:t,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:d,lang:s,t:c}=T(),u=p.useRef(null),h=p.useRef(null),l=Ze.find(N=>N.key===t.continent),b=Vn(u,t.continent+":"+t.mapFolded),[v,g]=p.useState(new Map),[f,x]=p.useState(null);p.useEffect(()=>{const N=u.current;if(!N)return;const A=new Map;N.querySelectorAll("path[data-i2]").forEach(D=>{const M=D.dataset.i2;if(M)try{const E=D.getBBox();E.width>0&&A.set(M,{x:E.x,y:E.y,w:E.width,h:E.height})}catch{}}),g(A)},[t.continent,b]);const m=p.useMemo(()=>r.filter(N=>N.cc),[r]),y=p.useMemo(()=>{const N=new Map;return m.forEach(A=>N.set(A.cc,(N.get(A.cc)||0)+1)),N},[m]),S=p.useMemo(()=>m.map(N=>{const A=N.cc?v.get(N.cc):void 0;if(!A)return null;const D=Ct(N.name||N.id||""),M=Ct((N.id||N.name||"")+"·y"),E=(D-.5)*Math.min(A.w*.55,60),P=(M-.5)*Math.min(A.h*.55,60);return{d:N,x:A.x+A.w/2+E,y:A.y+A.h/2+P}}).filter(N=>!!N),[m,v]),w=N=>b>0?N/b:N,C=p.useMemo(()=>n?[0,1,2,3,4,5].map(N=>({c:St[N],fr:c.plabels[N].toUpperCase(),en:c.plabels[N].toUpperCase(),n:r.filter(A=>A.kind==="target"&&ee(A)===N).length})).filter(N=>N.n>0):ut.map((N,A)=>({...N,n:r.filter(D=>mt(D)===A).length})),[r,n,c.plabels]),k=o?d.get(o):null,z=k?S.find(N=>N.d.id===k.id):null;return e.jsxs("div",{className:"mapzone",ref:h,children:[e.jsxs("svg",{ref:u,viewBox:l.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?l.fr:l.en,onMouseLeave:()=>{x(null),i(null)},children:[e.jsx("g",{children:l.countries.map((N,A)=>e.jsx("g",{className:"ct"+(N.i2&&y.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},A))}),e.jsx("g",{children:S.map(N=>{const A=ut[mt(N.d)],D=!!Q(N.d),M=N.d.kind==="target",E=n&&M?St[ee(N.d)]:A.c,P=!n&&ne(N.d);return e.jsxs("g",{className:"co"+(P?" done":""),onMouseEnter:()=>{var R,_;const q=(R=h.current)==null?void 0:R.getBoundingClientRect(),B=(_=u.current)==null?void 0:_.createSVGPoint();if(B&&u.current&&q){B.x=N.x,B.y=N.y;const se=B.matrixTransform(u.current.getScreenCTM());x({x:se.x-q.left,y:se.y-q.top,label:N.d.name+" · "+(Ne(N.d.cc,s)||N.d.countryLabel||"")})}i(N.d.id)},onMouseLeave:()=>{x(null),i(null)},onClick:()=>{var R;const q=(R=u.current)==null?void 0:R.createSVGPoint();let B=null;if(q&&u.current){q.x=N.x,q.y=N.y;const _=q.matrixTransform(u.current.getScreenCTM());B={x:_.x,y:_.y}}a({type:"popup",id:N.d.id,anchor:B})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:w(Math.max(11,A.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:w(A.px),fill:E,stroke:D?"#DC2626":"#ffffff",strokeWidth:w(D?2.2:1.3)})]},N.d.id||N.d.name)})}),z&&e.jsx("circle",{className:"ring on",cx:z.x,cy:z.y,r:w(13),fill:"none",stroke:"#0F172A",strokeWidth:w(2)})]}),e.jsx("div",{className:"hov"+(f?" on":""),style:f?{left:f.x,top:f.y}:void 0,children:f==null?void 0:f.label}),e.jsx("div",{className:"legend",children:C.map((N,A)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),s==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},A))}),r.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",c.notLocated," ",e.jsx("b",{children:r.filter(N=>!N.cc).length})]})})]})}function Hn(t,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t);if(!r)return t;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function _n(){const{st:t,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:d}=T(),s=t.filters,c=p.useMemo(()=>r.filter(f=>f.continent===t.continent),[r,t.continent]),u=f=>c.filter(x=>f!=="country"&&s.country.length&&!s.country.includes(x.cc||"")?!1:at(x,s,i,f==="country"?void 0:f)),h=p.useMemo(()=>{const f=u("win"),x=m=>f.filter(y=>(y.date?Math.max(0,Math.floor((Date.now()-Date.parse(y.date))/864e5)):9999)<=m).length;return[x(0),x(7),x(30),f.length]},[c,s,i]),l=p.useMemo(()=>s.day?u("win").filter(f=>(f.date||"").slice(0,10)===s.day).length:0,[c,s,i]),b=p.useMemo(()=>{if(i)return null;const f=u("status"),x={all:f.length,todo:0,retenu:0,pending:0,ecarte:0};return f.forEach(m=>{x[ce(m)]+=1}),x},[c,s,i]),v=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(!i&&s.status!=="all"?1:0)+(s.search.trim()?1:0),g=(f,x,m,y="fbtn")=>e.jsxs("button",{type:"button",className:y,"aria-expanded":t.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[e.jsx("span",{className:"fl",children:x}),m>0&&e.jsx("span",{className:"n",children:m}),e.jsx("span",{className:"cv",children:"▾"})]},f);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[s.day?e.jsxs("div",{className:"seg",children:[e.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(Hn(s.day,d)),e.jsx("b",{children:l})]}),e.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):e.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,x)=>e.jsxs("button",{type:"button","aria-pressed":s.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[n.dates[x],e.jsx("b",{children:h[x]})]},f))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),!i&&b&&e.jsx("div",{className:"statusf",children:[["all",n.statusAll],["todo",n.statusTodo],["retenu",n.statusKeep],["pending",n.statusPending],["ecarte",n.statusDrop]].map(([f,x])=>e.jsxs("button",{type:"button","aria-pressed":s.status===f,onClick:()=>a({type:"filters",patch:{status:f}}),children:[x,e.jsx("b",{children:b[f]??0})]},f))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&e.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),g("sec",n.fSector,s.sector.length),g("pay",n.fCountry,s.country.length),g("det",n.fEngine,s.engine.length),g("sta",n.fStage,s.stage.length),i&&g("ang","Angle",s.angle.length),i&&g("mem","Mémo",s.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),v>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(c.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:n.clear(v)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),t.openFacet&&e.jsx(Yn,{poolFor:u})]})}function Yn({poolFor:t}){const{st:a,dispatch:r,t:n,lang:i}=T(),o=a.filters,d=a.openFacet,{title:s,cols:c,options:u}=p.useMemo(()=>{if(d==="sig"){const g=t("signal").filter(m=>Q(m)),f=new Map;g.forEach(m=>{const y=m.engine||"";f.set(y,(f.get(y)||0)+1)});const x=[{v:"*",label:n.fpSigAll,n:g.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ft([...f.keys()],i).map(m=>({v:m,label:we(m)+" "+de(m,i),n:f.get(m)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(m)}))];return{title:n.fpSigTitle,cols:2,options:x}}if(d==="sec"){const g=t("sector"),f=new Map;return g.forEach(x=>{x.sector&&f.set(x.sector,(f.get(x.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...f.entries()].sort((x,m)=>m[1]-x[1]).map(([x,m])=>({v:x,label:x,n:m,html:!1,on:o.sector.includes(x)}))}}if(d==="pay"){const g=t("country"),f=new Map;return g.forEach(x=>{x.cc&&f.set(x.cc,(f.get(x.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...f.entries()].sort((x,m)=>m[1]-x[1]).map(([x,m])=>({v:x,label:Ne(x,i)||x,n:m,html:!1,on:o.country.includes(x)}))}}if(d==="det"){const g=t("engine"),f=new Map;return g.forEach(x=>{x.engine&&f.set(x.engine,(f.get(x.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ft([...f.keys()],i).map(x=>({v:x,label:we(x)+" "+de(x,i)+' <span style="color:var(--dim);font-size:10px">· '+Na(Sa(x),i)+"</span>",n:f.get(x)||0,html:!0,on:o.engine.includes(x)}))}}if(d==="ang"){const g=t("angle"),f=new Map;return g.forEach(x=>{x.angle&&f.set(x.angle,(f.get(x.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((x,m)=>m[1]-x[1]).map(([x,m])=>({v:x,label:x.replace(/[_-]+/g," "),n:m,html:!1,on:o.angle.includes(x)}))}}if(d==="mem"){const g=t("memoLevel"),f=new Map;g.forEach(m=>{if(m.kind==="target"){const y=Je(m);f.set(y,(f.get(y)||0)+1)}});const x=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(m=>({v:String(m),label:x[m],n:f.get(m)||0,html:!1,on:o.memoLevel.includes(m)}))}}const b=t("stage"),v=new Map;return b.forEach(g=>{g.stage&&v.set(g.stage,(v.get(g.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((g,f)=>f[1]-g[1]).map(([g,f])=>({v:g,label:g,n:f,html:!1,on:o.stage.includes(g)}))}},[d,a,i]),h=b=>{if(d==="sig"){if(b==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const g=o.signalEngines.includes(b)?o.signalEngines.filter(f=>f!==b):[...o.signalEngines,b];r({type:"filters",patch:{signalOnly:!0,signalEngines:g}})}return}if(d==="mem"){r({type:"toggleMemoLevel",value:Number(b)});return}r({type:"toggleFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage",value:b})},l=()=>{r(d==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:d==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:s}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:l,children:n.fpNone}),e.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),e.jsx("div",{className:"fcols"+(c===2?" two":""),children:u.map(b=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":b.on,onClick:()=>h(b.v),children:[e.jsx("span",{className:"bx"}),b.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:b.label}}):e.jsx("span",{className:"l",children:b.label}),e.jsx("span",{className:"n",children:b.n})]},b.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:n.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}const zt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Wn(){const{t,mode:a,token:r,askEvaluate:n,sessTally:i,dispatch:o,evalBusy:d,evalCards:s,caps:c,data:u}=T(),h=a==="client",[l,b]=p.useState(""),[v,g]=p.useState(!1),[f,x]=p.useState(""),[m,y]=p.useState(!1),[S,w]=p.useState(""),[C,k]=p.useState([]),z=p.useRef(!1),N=l.trim()?zt.test(l.trim())?t.evalUrl:t.evalName:t.evalWaiting,A=p.useMemo(()=>f.split(`
`).map(q=>q.trim()).filter(Boolean).slice(0,15),[f]),D=C.length?C:s,M=u.credits,E=()=>{const q=l.trim();q&&(n(null,q),b(""))},P=async()=>{if(!h){n(null,A[0]||"");return}if(!A.length||m)return;y(!0),z.current=!1;const q=[];for(let B=0;B<A.length&&!z.current;B++){w(t.evaluating(B+1,A.length,A[B]));const R=await Mt(r,A[B],"atelier2");if(q.unshift({name:R.company||A[B],verdict:R.verdict,reason:R.reason||"",remaining:R.remaining??null}),k([...q]),R.verdict==="quota"){q.unshift({name:"",verdict:"quota",reason:t.quota(A.length-B-1),remaining:0}),k([...q]);break}}w(""),x(""),y(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:l,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:q=>b(q.target.value),onKeyDown:q=>{q.key==="Enter"&&E()}}),e.jsx("span",{className:"detect"+(zt.test(l.trim())?" url":""),children:N})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),disabled:d,onClick:E,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),c.showCredits&&M&&e.jsxs("button",{type:"button",className:"credits"+(M.total_available<=0&&!M.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:M.unlimited?"∞":M.total_available}),!M.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",M.daily_grant+M.purchased]}),M.total_available<=0&&!M.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>g(!v),children:t.evalMulti})}),v&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:f,placeholder:t.bulkPh,onChange:q=>x(q.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{justifyContent:"center"},disabled:m||!A.length,onClick:()=>{P()},children:[e.jsx("span",{className:"fill"}),m&&S?S:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(A.length)})]})]}),D.slice(0,1).map((q,B)=>{const R=q.verdict==="kept",_=q.verdict==="quota",se=R?"var(--brand)":_?"var(--bolt)":"var(--red)",pe=R?"var(--brand-l)":_?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":se,"--bgc":pe},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:R?"✓ "+t.kept:_?"⏳":"✗ "+t.dropped})}),q.name&&e.jsx("span",{className:"rn",children:q.name}),e.jsx("span",{className:"rr",children:q.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",q.reason]}):null}),!_&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(R?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},B)}),h&&(i.kept+i.dropped>0||D.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(i.kept,i.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Gn(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Kn(){const{st:t,dispatch:a,byId:r,t:n,doDeep:i}=T(),o=t.memoConsole?r.get(t.memoConsole):null,d=p.useMemo(()=>o?[o.reasoning||"",Gn(o.summary||"")].filter(Boolean).join(`
...
`).map((u,h)=>e.jsx("p",{style:{margin:"0 0 10px"},children:u},h)):e.jsx("p",{children:n.memoNone})}),e.jsxs("div",{className:"mf",children:[et(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:n.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):e.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const Qn=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Be=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Jn(t){const a=String(t||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Be(a.slice(n));break}r+=Be(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Be(a.slice(i));break}const d=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(d),c=s?s[2].toLowerCase():"";s&&Qn.has(c)?r+=`<${s[1]}${c}>`:r+=Be(a.slice(i,o+1)),n=o+1}return r}const Et=(t,a)=>{const r=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function K({k:t,v:a,href:r}){return a==null||a===""?null:e.jsxs("div",{className:"cdl",children:[e.jsx("span",{className:"cdk",children:t}),r?e.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):e.jsx("span",{className:"cdv",children:String(a)})]})}function Xn({o:t}){const{t:a,lang:r,dispatch:n,caps:i}=T(),o=$e(t),d=je(t),s=(t.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[t.sector,t.stage,t.countryLabel,t.city,t.website,t.domain,t.linkedinCompany,t.angle,t.date].filter(Boolean).length,u=[t.contactName,t.contactEmail,t.contactLinkedin].filter(Boolean).length,h=[t.ceoStatus,t.ceoNote,i.pipe?t.memoUrl:"",i.pipe?t.memoPdfUrl:""].filter(Boolean).length+(typeof t.engagement=="number"&&t.engagement>0?1:0),l=p.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(t.reasoning?1:0)+(d?1:0)},{k:"ana",lib:a.cdAnalyse,n:(t.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:u},{k:"suivi",lib:a.cdSuivi,n:h}].filter(f=>f.n>0),[t,a,s,d,c,u,h]),[b,v]=p.useState("");if(!l.length)return null;const g=l.some(f=>f.k===b)?b:l[0].k;return e.jsxs("div",{className:"cdtabs",children:[e.jsx("div",{className:"cdnav",role:"tablist",children:l.map(f=>e.jsx("button",{type:"button",role:"tab","aria-selected":g===f.k,className:g===f.k?"on":"",onClick:x=>{x.stopPropagation(),v(f.k)},children:f.lib},f.k))}),e.jsxs("div",{className:"cdbody",onClick:f=>f.stopPropagation(),children:[g==="conv"&&e.jsxs(e.Fragment,{children:[s&&e.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[e.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),e.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.reasoning&&e.jsx("p",{className:"cdtxt",children:t.reasoning}),d&&e.jsxs("div",{className:"cdv1 memo",children:[e.jsx("b",{children:d}),e.jsx("span",{className:"cdw",children:a.cdMemo(t.memoType||"")})]}),e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(K,{k:a.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(K,{k:a.cdVerdictDate,v:Et(t.verdictDate,r)})]})]}),g==="ana"&&e.jsxs(e.Fragment,{children:[t.summary&&e.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Jn(t.summary)}}),i.pipe&&!i.lockActions&&e.jsx(Zn,{o:t})]}),g==="soc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdSector,v:t.sector}),e.jsx(K,{k:a.cdStage,v:t.stage}),e.jsx(K,{k:a.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(K,{k:a.cdSite,v:t.domain||t.website,href:t.website||void 0}),e.jsx(K,{k:a.cdLinkedin,v:t.linkedinCompany?"LinkedIn":"",href:t.linkedinCompany}),e.jsx(K,{k:a.cdAngle,v:t.angle}),e.jsx(K,{k:a.cdDetected,v:Et(t.date,r)})]}),g==="ctc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdName,v:t.contactName}),e.jsx(K,{k:a.cdEmail,v:t.contactEmail,href:t.contactEmail?`mailto:${t.contactEmail}`:void 0}),e.jsx(K,{k:a.cdLinkedin,v:t.contactLinkedin?"LinkedIn":"",href:t.contactLinkedin})]}),g==="suivi"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdCeoStatus,v:t.ceoStatus}),e.jsx(K,{k:a.cdEngagement,v:typeof t.engagement=="number"&&t.engagement>0?t.engagement:""})]}),t.ceoNote&&e.jsxs("p",{className:"cdtxt",children:["💬 ",t.ceoNote]}),i.pipe&&(t.memoUrl||t.memoPdfUrl)&&e.jsxs("div",{className:"cdacts",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),t.memoPdfUrl&&e.jsx("a",{className:"abtn",href:t.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Zn({o:t}){const{t:a,token:r}=T(),[n,i]=p.useState(!1),[o,d]=p.useState(null),s=async()=>{n||(i(!0),d(await Ca(r,t.name,t.website||t.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},u=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],h=u.some(([,l])=>l);return e.jsxs("div",{className:"qab",children:[!o&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mnote dim",children:a.qaHint}),e.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&h&&e.jsxs(e.Fragment,{children:[u.filter(([,l])=>l).map(([l,b])=>e.jsxs("div",{className:"qal",children:[e.jsx("span",{className:"qak",children:l}),e.jsx("p",{children:b})]},l)),!!(o.pages||[]).length&&e.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!h&&e.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function $t({name:t}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=T(),[d,s]=p.useState(!1),[c,u]=p.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const h=async()=>{if(d)return;s(!0);const l=await za(r,t);if(s(!1),!l){o(a.actErr);return}u(l.results||[])};return e.jsxs("div",{className:"simb",onClick:l=>l.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{h()},children:d?a.similarBusy:a.similar}),c&&(c.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:c.map(l=>e.jsxs("li",{children:[e.jsx("b",{className:l.verdict==="kept"?"ok":"ko",children:l.company}),l.reason&&e.jsx("span",{children:l.reason})]},l.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Vt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function rt({o:t}){const{t:a}=T(),r=$e(t),n=je(t),i=ee(t),o=Ge(t),d=Ea(t);return e.jsxs("span",{className:"c-vd",children:[r?e.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):e.jsx("span",{className:"vd wait",children:a.actToEval}),n?e.jsx("span",{className:"vd "+(Vt[n]||"v-cons"),title:a.vt[n],children:n}):i===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&d!==null&&e.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:a.waitTitle(d),children:a.waitChip(d)})]})}function Tt({o:t}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=T(),[o,d]=p.useState(!1);if(p.useEffect(()=>{n||d(!1)},[n]),ne(t)){const u=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":u?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[u?"✓":"✗"," ",e.jsx("b",{children:u?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const c=o&&n;return e.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,onClick:u=>{u.stopPropagation(),d(!0),r(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function er({o:t}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:d,doPromote:s,doRepeche:c,doApproach:u,dispatch:h}=T();if(r.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:v=>{v.stopPropagation(),h({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return e.jsx("span",{className:"cell",children:e.jsx(Tt,{o:t})});const l=ee(t),b=v=>g=>{g.stopPropagation(),v()};if(l===0)return e.jsx("span",{className:"cell",children:e.jsx(Tt,{o:t})});if(l===1){const v=n.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:b(()=>o(t)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(l===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>d(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>d(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})});if(l===4){const v=i.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:v,onClick:b(()=>u(t)),children:v?a.actApproachSent:a.actApproach})})}return l===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:b(()=>s(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):l===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:b(()=>c(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>h({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function tr({o:t}){const{t:a,doThumb:r,thumbOf:n}=T(),i=n(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(t,!1)},children:"👎"})]})}function ar({o:t}){const{lang:a}=T();return Q(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(Se,{o:t}),e.jsx(Ve,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[we(t.engine||"")," ",de(t.engine||"",a)]})})}function nr({o:t,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:d,markRow:s,markedId:c,favIds:u,toggleFav:h}=T(),l=ee(t),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],v=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,g=v<=0?0:v<=7?1:v<=30?2:3,f=d.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][l]:b[g],x=u.has(t.id),m=y=>{if(a)return;if(d.pipe){n();return}const S=y.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"row"+(c===t.id||r?" on":"")+(a?" locked":""),onMouseEnter:()=>s(t.id),onMouseLeave:()=>s(null),onClick:m,children:[e.jsx("span",{className:"pt",style:{"--c":f}}),e.jsx(_t,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[d.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:x?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),h(t)},children:x?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(y=>y&&y!==t.name)||""})]}),e.jsx(rr,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(ar,{o:t}),d.pipe&&e.jsx(rt,{o:t}),d.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(er,{o:t}),d.showThumbs&&e.jsx(tr,{o:t})]}),(r||i.dens==="deplie")&&!a&&e.jsx(or,{o:t})]})}function rr({o:t}){const{lang:a,caps:r}=T();if(r.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const n=tt(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function or({o:t}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:d}=T();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),e.jsx(Xn,{o:t}),e.jsx(An,{o:t}),e.jsx(On,{o:t}),e.jsx($t,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(rt,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[we(t.engine||"")," ",de(t.engine||"",r)]}),Q(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(Se,{o:t})})]}),i.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>n({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(t),children:a.actOnboard})]})]})]})}function ir({o:t,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o}=T(),d=ee(t),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][d];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":s},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(rt,{o:t}),Q(t)&&e.jsx(Se,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&i.pipe&&d===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:r.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:r.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:t.id}),children:[r.actMemo," →"]})]})}function sr(){const t=T(),{st:a,dispatch:r,t:n,caps:i,scoped:o,lang:d,sessTally:s,data:c,dossiers:u}=t,[h,l]=p.useState(new Set);p.useEffect(()=>{l(new Set)},[a.ptab,a.continent]);const b=k=>l(z=>{const N=new Set(z);return N.has(k)?N.delete(k):N.add(k),N}),v=p.useMemo(()=>nt(o,a.sort),[o,a.sort]),g=p.useMemo(()=>v.filter(k=>Q(k)&&!ne(k)).length,[v]),f=p.useMemo(()=>i.pipe?v:v.filter(k=>!ne(k)),[v,i.pipe]),x=i.pipe?n.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,m=(k,z,N="",A=!1)=>e.jsxs("button",{type:"button","data-s":k,className:N,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:A?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:k}),children:[z,e.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),y=p.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const k=new Map;return v.forEach(z=>{const N=z.engine||"?";k.has(N)||k.set(N,[]),k.get(N).push(z)}),[...k.entries()]},[v,i.pipe,a.groupBy]),S=i.lockRowsAfter;let w=0;const C=(k,z)=>{const N=a.shown[z]||Ie,D=k.slice(0,N).map(M=>{const E=S!==null&&w>=S;return w++,a.dens==="maxi"?e.jsx(ir,{o:M,locked:E},M.id):e.jsx(nr,{o:M,locked:E,open:h.has(M.id),onToggle:()=>b(M.id)},M.id)});return k.length>N&&D.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>r({type:"more",group:z,by:Ie}),children:n.more(Math.min(Ie,k.length-N),k.length-N)},z+":more")),D};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:v.length})," ",x]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,i.pipe&&t.fund?" · "+t.fund:""]}),i.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:n.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),i.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",n.densList],["deplie",n.densOpen],["maxi",n.densMaxi]].map(([k,z])=>e.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k,onClick:()=>r({type:"dens",dens:k}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:z})]},k))}),i.showChain&&f.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:f.map(k=>k.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(f.length):n.chainAll(f.length)]})]}),g>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(g)}}),e.jsx("span",{className:"s",children:n.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),m("country",n.colCountry),m("name",n.colCompany),m("amount",n.colAmount,"h-amt",!0),m("stage",n.colStage,"h-stade"),m("signal",n.colSignal,"h-sig"),i.pipe&&e.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&m("score",n.colScore,"h-sc",!0),e.jsx("span",{}),i.showThumbs&&e.jsx("span",{className:"h-thu",children:n.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[y?y.map(([k,z])=>e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:we(k)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:de(k,d)}),e.jsx("div",{className:"s",children:n.grpCount(z.filter(N=>!ne(N)).length,z.length)})]})]}),C(z,k)]},k)):C(v,"pt"+a.ptab),!v.length&&!(c.loading&&!u.length)&&e.jsx("div",{className:"void",children:i.pipe?n.emptyTab:n.emptyScope})]}),i.showThumbs&&e.jsxs("p",{className:"learn",children:[n.learnLine,e.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}})]})}const lr=`
...
`;function dr(t){if(!t||typeof window>"u")return;const a=352,r=430,n=window.innerWidth,i=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,n-a-8));let d=t.y+10;return d+r>i-8&&(d=Math.max(8,t.y-r-14)),d<8&&(d=8),{left:o,top:d}}function cr(){const{st:t,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:d,askEvaluate:s,doAnalyse:c,doDecide:u,doPromote:h,doRepeche:l,doApproach:b,doDeep:v,doOnboard:g,outbound:f,evalBusy:x}=T(),m=t.popupId?r.get(t.popupId):null;if(!m)return null;const y=Q(m),S=ee(m),w=je(m),C=m.kind==="target",k=z=>{a({type:"filters",patch:z}),a({type:"popup",id:null})};return Le.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:lr}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:dr(t.popupAnchor),onClick:z=>z.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:m.name}),e.jsx("span",{className:"id",children:n.detected(n.daysAgo(ke(m.date)),de(m.engine,i))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[m.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>k({country:[m.cc]}),children:(Ne(m.cc,i)||m.countryLabel||"").toUpperCase()}),m.sector&&e.jsx("button",{type:"button",onClick:()=>k({sector:[m.sector]}),children:m.sector.toUpperCase()}),m.stage&&e.jsx("button",{type:"button",onClick:()=>k({stage:[m.stage]}),children:m.stage.toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&e.jsx("span",{className:"am2",children:tt(m.amountEur,i)})]}),(m.tagline||m.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.desc}),e.jsx("p",{children:m.tagline||m.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.how}),e.jsxs("p",{children:[we(m.engine)," ",e.jsx("b",{children:de(m.engine,i)})," — ",Ta(m.engine,i),m.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",m.noteTitle]})]}),y?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(Se,{o:m,lg:!0})," ",e.jsx(Ve,{o:m,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Dt(y,i))," · ",n.win7(Ft(y,i))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),m.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&S>=1?n.verdictCap:n.memo}),e.jsx("p",{className:"memo",children:m.reasoning})]}),o.pipe&&C&&w&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[w,typeof m.score=="number"&&m.score>0?" · "+n.score(m.score):""]})})]}),e.jsx($t,{name:m.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||d!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[S===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>s(m),children:[e.jsx("span",{className:"fill"}),n.evalGo]}),S===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(m),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actAnalyse]}),S===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(m),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actPromote]}),S===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(m,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{u(m,!1),a({type:"popup",id:null})},children:n.actNo}),et(m)&&e.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(m),a({type:"popup",id:null})},children:n.memoDeep})]}),S===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{b(m),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actApproach]}),S===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{l(m),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actRepeche]}),m.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:m.id}),a({type:"popup",id:null})},children:"📄"}),f&&e.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{g(m),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>s(m),children:[e.jsx("span",{className:"fill"}),n.evalGo," →"]}),m.website&&e.jsx("a",{className:"psite",href:m.website.startsWith("http")?m.website:"https://"+m.website,target:"_blank",rel:"noopener noreferrer",title:m.website,children:"🌐"})]})]})]}),document.body)}function At(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function pr(t,a){const r=Aa(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function ur(t,a){const n=[a.head.split("|").map(At).join(";")];for(const i of t){const o=a.stageOf(i);n.push([i.name||"",pr(i,a.plabels),$e(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(At).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function mr(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const fr=(t,a)=>{const r=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ie({k:t,v:a}){return a==null||a===""?null:e.jsxs("div",{className:"dsl",children:[e.jsx("span",{children:t}),e.jsx("b",{children:String(a)})]})}function xr({o:t,qa:a}){const{t:r,lang:n,fund:i}=T(),o=(t.cribleStatus||"").trim().toUpperCase()||($e(t)==="NO MATCH"?"NO MATCH":"MATCH"),d=je(t),s=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return e.jsxs("article",{className:"dspage",children:[e.jsxs("header",{className:"dsh",children:[e.jsxs("div",{children:[e.jsx("b",{children:t.name}),t.tagline&&e.jsx("p",{children:t.tagline})]}),e.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,d&&e.jsx("em",{children:d})]})]}),t.reasoning&&e.jsxs("section",{children:[e.jsx("h3",{children:r.dsWhy}),e.jsx("p",{className:"dstxt",children:t.reasoning})]}),e.jsxs("section",{className:"dsgrid",children:[e.jsx(ie,{k:r.cdSector,v:t.sector}),e.jsx(ie,{k:r.cdStage,v:t.stage}),e.jsx(ie,{k:r.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(ie,{k:r.cdSite,v:t.domain||t.website}),e.jsx(ie,{k:r.cdName,v:t.contactName}),e.jsx(ie,{k:r.cdEmail,v:t.contactEmail}),e.jsx(ie,{k:r.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(ie,{k:r.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(ie,{k:r.cdAngle,v:t.angle}),e.jsx(ie,{k:r.cdDetected,v:fr(t.date,n)})]}),c.some(([,u])=>u)&&e.jsxs("section",{children:[e.jsx("h3",{children:r.dsAnalysis}),c.filter(([,u])=>u).map(([u,h])=>e.jsxs("div",{className:"dsb",children:[e.jsx("span",{children:u}),e.jsx("p",{children:h})]},u))]}),(t.ceoStatus||t.ceoNote)&&e.jsxs("section",{children:[e.jsx("h3",{children:r.dsDecision}),t.ceoStatus&&e.jsx("p",{className:"dstxt",children:e.jsx("b",{children:t.ceoStatus})}),t.ceoNote&&e.jsxs("p",{className:"dstxt",children:["« ",t.ceoNote," »"]})]}),e.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function gr(){const{t,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:d}=T(),[s,c]=p.useState({}),u=25,h=p.useMemo(()=>n.slice(0,u),[n]);p.useEffect(()=>{h.length&&qa(r,h.map(v=>v.name)).then(c)},[r,h]);const l=o.stats,b=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return e.jsxs("div",{className:"dossier",children:[e.jsxs("div",{className:"dsbar",children:[e.jsx("b",{children:t.dsTitle(h.length)}),n.length>u&&e.jsx("span",{className:"mnote dim",children:t.dsCap(u,n.length)}),e.jsx("span",{className:"dssp"}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:t.printBtn})]}),e.jsxs("div",{className:"dscover",children:[e.jsx("b",{children:i}),l&&typeof l.screened=="number"&&e.jsxs("p",{children:[b(l.screened)," ",t.funScreened(""),typeof l.kept=="number"&&e.jsxs(e.Fragment,{children:[" · ",b(l.kept)," ",t.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&e.jsxs(e.Fragment,{children:[" · ",t.covOf(b(o.marketEstimate)),", ",Math.round(l.screened/o.marketEstimate*100)," %"]})]})]}),h.map(v=>e.jsx(xr,{o:v,qa:s[v.name]},v.id)),!h.length&&e.jsx("p",{className:"mnote",children:t.dsEmpty})]})}const hr=50;function ot({label:t,onPreview:a,onTest:r,readOnly:n}){const{t:i}=T(),[o,d]=p.useState(null),[s,c]=p.useState(!1),[u,h]=p.useState(""),[l,b]=p.useState(0),[v,g]=p.useState(""),[f,x]=p.useState(!1),m=p.useRef(null);p.useEffect(()=>()=>{m.current&&window.clearInterval(m.current)},[]);const y=async w=>{c(!0),h("");const C=await a();if(c(!1),C.ok){d(C);return}if(C.busy){h(i.alertPreviewBusy);return}if(!w){h(i.alertPreviewFail);return}b(hr),m.current=window.setInterval(()=>{b(k=>k>1?k-1:(m.current&&window.clearInterval(m.current),y(!1),0))},1e3)},S=async()=>{if(n||f)return;x(!0),g("");const w=await r();x(!1),g(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:s||l>0,onClick:()=>{y(!0)},children:s?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:n||f,onClick:()=>{S()},children:f?"…":i.alertTest})]}),l>0&&e.jsx("p",{className:"mnote",children:i.alertPreviewRetry(l)}),u&&e.jsx("p",{className:"mnote warn",children:u}),v&&e.jsx("p",{className:"mnote",children:v}),!v&&e.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const qe="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function X({title:t,icon:a,children:r,wide:n}){const{dispatch:i}=T();return Le.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:r})]})})}),document.body)}function br(){const{st:t}=T();switch(t.modal){case"chain":return e.jsx(yr,{});case"space":return e.jsx(wr,{});case"alert":return e.jsx(kr,{});case"queue":return e.jsx(zr,{});case"export":return e.jsx(Er,{});case"plug":return e.jsx(qr,{});case"recharge":return e.jsx(Or,{});case"cover":return e.jsx(Mr,{});case"dossier":return e.jsx(Rr,{});case"crit":return e.jsx(Dr,{});case"tuto":return e.jsx(Fr,{});case"rdv":return e.jsx(vr,{});case"memoalert":return e.jsx(Tr,{});default:return null}}function vr(){const{dispatch:t,fund:a}=T(),r=typeof document<"u"&&!!document.getElementById("rdv");return p.useEffect(()=>{r&&(t({type:"modal",modal:null}),kn())},[r,t]),r?null:e.jsx(Ra,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function yr(){const{st:t,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:d,evalBusy:s}=T(),c=o==="client",u=t.chain.queue.map(v=>r.get(v)).filter(v=>!!v),h=t.chain.idx,l=u[h],b=h>=u.length;return Le.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:b?n.finished:`${h+1} / ${u.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(b?100:h/Math.max(1,u.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:b||!l?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:n.chainDone}),e.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:l.name}),e.jsx("div",{className:"sub",children:[Ne(l.cc,i)||l.countryLabel,l.sector,l.stage,n.daysAgo(ke(l.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:de(l.engine,i).toUpperCase()}),typeof l.amountEur=="number"&&l.amountEur>0&&e.jsx("span",{children:tt(l.amountEur,i)})]}),Q(l)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(Se,{o:l,lg:!0})," ",e.jsx(Ve,{o:l,src:!0})]}),(l.tagline||l.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.desc}),e.jsx("p",{children:l.tagline||l.headline})]}),l.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.memo}),e.jsx("p",{className:"memo",children:l.reasoning})]}),c&&ne(l)&&e.jsxs("div",{className:"vbox",style:{"--c":ce(l)==="retenu"?"var(--brand)":ce(l)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:ce(l)==="retenu"?"✓ "+n.kept:ce(l)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),e.jsx("span",{className:"vd",children:l.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!b&&l&&!(c&&ne(l))&&e.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{d(l)},children:[e.jsx("span",{className:"fill"}),n.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function wr(){const{st:t,dispatch:a,dossiers:r,t:n,mode:i}=T(),o=i==="client",d=p.useMemo(()=>o?r.filter(l=>ne(l)):[],[r,o]),s=p.useMemo(()=>nt(d.filter(l=>ce(l)==="retenu"),{key:"signal",dir:-1}),[d]),c=p.useMemo(()=>d.filter(l=>ce(l)==="ecarte"),[d]),u=t.spaceTab==="retenu"?s:c,h=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(X,{title:n.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:s.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:c.length})]})]}),u.length===0&&e.jsx("div",{className:"sp-empty",children:n.spEmpty}),u.slice(0,40).map(l=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":h},children:typeof l.score=="number"&&l.score>0?l.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:l.name}),e.jsx("div",{className:"rr",children:l.reasoning||l.tagline||""})]})]},l.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function kr(){const{mode:t}=T();return t==="client"||t==="apercu"?e.jsx(jr,{}):e.jsx(Cr,{})}function jr(){const{t,token:a,flash:r,flashErr:n,mode:i}=T(),[o,d]=p.useState("d"),s=i!=="client";return e.jsxs(X,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>d("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>d("w"),children:t.alertTabWeekly})]}),o==="d"?e.jsx(Nr,{t,token:a,readOnly:s,flash:r,flashErr:n}):e.jsx(Sr,{t,token:a,readOnly:s,flash:r,flashErr:n})]})}function Nr({t,token:a,readOnly:r,flash:n,flashErr:i}){const[o,d]=p.useState(null),[s,c]=p.useState(!1),[u,h]=p.useState(0);p.useEffect(()=>{let g=!0;return c(!1),ht(a).then(f=>{g&&(f?d(f):c(!0))}),()=>{g=!1}},[a,u]);const l=g=>{r||ht(a,g).then(f=>{if(!f){i(t.actErr);return}d(f),f.throttled?i(t.alertThrottled):n(t.alertSaved)})};if(s)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(g=>g+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const b=g=>!o.sections||o.sections.includes(g),v=g=>{const f=o.sections||t.alertSec.map(([x])=>x);l({sections:b(g)?f.filter(x=>x!==g):[...f,g]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>l({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>l({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>l({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>l({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>l({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([g,f])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:b(g),disabled:r,onChange:()=>v(g)}),e.jsxs("span",{children:[f,g==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},g))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(ot,{label:t.alertPreview,readOnly:r,onPreview:()=>$a(a),onTest:()=>Ia(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Sr({t,token:a,readOnly:r,flash:n,flashErr:i}){const[o,d]=p.useState(null),[s,c]=p.useState(!1),[u,h]=p.useState(0);p.useEffect(()=>{let g=!0;return c(!1),bt(a).then(f=>{g&&(f?d(f):c(!0))}),()=>{g=!1}},[a,u]);const l=g=>{r||bt(a,g).then(f=>{if(!f){i(t.actErr);return}d(f),n(t.alertSaved)})};if(s)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(g=>g+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const b=o.dow??0,v=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>l({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:b,disabled:r,onChange:g=>l({dow:Number(g.target.value)}),children:t.alertDow.map((g,f)=>e.jsx("option",{value:f,children:g},g))}),e.jsx("button",{type:"button",onClick:()=>l({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),e.jsxs("b",{children:[v," h"]}),e.jsx("button",{type:"button",onClick:()=>l({hour:Math.min(21,v+1)}),disabled:r,children:"＋"})]})]}),e.jsx(ot,{label:t.alertPreviewWeekly,readOnly:r,onPreview:()=>Ua(a),onTest:()=>Va(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Cr(){const{st:t,t:a,lang:r,scoped:n,contName:i}=T(),[o,d]=p.useState(""),[s,c]=p.useState(!1),[u,h]=p.useState(!1),l=t.filters,b=p.useMemo(()=>n.filter(x=>Q(x)).length,[n]),v=l.win==="1"?0:l.win==="7"?1:l.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(o)||u)){h(!0);try{await fetch(`${Qe}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o.trim(),sectors:l.sector,countries:l.country,source:"atelier2",website:""})}),c(!0)}finally{h(!1)}}},f=[[a.amRows.continent,i],[a.amRows.since,a.amSince[v]],[a.amRows.signal,l.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,l.engine.length?l.engine.map(x=>de(x,r)).join(", "):a.amAllEngines],[a.amRows.sectors,l.sector.length?l.sector.join(", "):a.amAllSectors],[a.amRows.countries,l.country.length?l.country.map(x=>Ne(x,r)||x).join(", "):a.amAllCountries],[a.amRows.stages,l.stage.length?l.stage.join(", "):a.amAllStages]];return e.jsx(X,{title:a.alertTitle,icon:"🔔",children:s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(o)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:f.map(([x,m])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:x}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:m}})]},x))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:o,onChange:x=>d(x.target.value),onKeyDown:x=>{x.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function zr(){var f,x,m;const{t,token:a,fund:r,mode:n,flash:i}=T(),[o,d]=p.useState(null),[s,c]=p.useState([]),[u,h]=p.useState(0),l=n==="client";p.useEffect(()=>{let y=!0;return(async()=>{const[S,w]=await Promise.all([Xe(r),Rt(a)]);y&&(S&&d(S),c(w))})(),()=>{y=!1}},[a,r,u]);const b=(o==null?void 0:o.per_day)??2,v=((f=o==null?void 0:o.analyzed_today)==null?void 0:f.length)??0,g=(x=o==null?void 0:o.tomorrow)!=null&&x.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(X,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(v,v+(((m=o==null?void 0:o.pool_order)==null?void 0:m.length)??0))}})}),e.jsxs("div",{className:"qrate",children:[t.covRate," — ",e.jsx("b",{children:t.covRateNow(b)})]})]}),s.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:s.map(y=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:y.company}),e.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),e.jsx("span",{className:"qt",children:y.status}),y.url&&e.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),l&&y.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{gt(a,y.company,"retry").then(()=>h(S=>S+1))},children:t.queueRetry}),l&&y.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{gt(a,y.company,"delete").then(()=>h(S=>S+1))},children:t.queueDelete})]},y.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[g.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),g.slice(0,10).map((y,S)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",S+1]}),e.jsx("b",{children:y.name}),typeof y.score=="number"&&e.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Er(){const{t,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:d}=T(),s=`${qe}/cibles/list.csv?token=${a}`,c=`${qe}/cibles/list.json?token=${a}`,u=`${qe}/cibles/export.xlsx?token=${a}&scope=full`,h=`=IMPORTDATA("${s}")`,l=x=>{var m;(m=navigator.clipboard)==null||m.writeText(x).then(()=>r(t.exportCopied))},b=[{def:t.exportCsv,value:s,href:s},{def:t.exportSheet,value:h},{def:t.exportLive,value:c,href:c},{def:t.exportXlsx,value:u,href:u}],v=!i.lockActions&&n.length>0,g=()=>{mr(ur(n,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:x=>(t.stg.find(([m])=>m===x)||["",""])[1]})),r(t.exportViewDone(n.length))},f=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return e.jsxs(X,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🖨️"}),e.jsxs("div",{children:[e.jsx("b",{children:t.printTitle}),e.jsx("p",{children:t.printDesc(n.length)})]}),e.jsx("button",{type:"button",className:"exb",onClick:f,children:t.printBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🗂"}),e.jsxs("div",{children:[e.jsx("b",{children:t.dsBtn}),e.jsx("p",{children:t.dsHint})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:t.exportViewBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(n.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:g,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:b.map(({def:x,value:m,href:y})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:x[0]}),e.jsxs("div",{children:[e.jsx("b",{children:x[1]}),e.jsx("p",{children:x[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>l(m),children:t.exportCopy}),y&&e.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},x[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function Tr(){const{t,token:a,flash:r,flashErr:n,mode:i}=T(),o=i!=="client",[d,s]=p.useState(null),[c,u]=p.useState(!1),[h,l]=p.useState(0),[b,v]=p.useState(!1);p.useEffect(()=>{let m=!0;return u(!1),xt(a).then(y=>{m&&(y?s(y):u(!0))}),()=>{m=!1}},[a,h]);const g=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},f=m=>{if(o||!d)return;const y={enabled:m.enabled??!!d.enabled,email:m.email??(d.email||""),sections:m.sections??g()};v(!0),xt(a,y).then(S=>{if(v(!1),!S){n(t.memoAlertErr);return}s(S),r(t.memoAlertSaved)})};if(c)return e.jsx(X,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>l(m=>m+1),children:t.retry})]})});if(!d)return e.jsx(X,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const x=g();return e.jsxs(X,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:o||b,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),e.jsx(Ar,{value:d.email||"",readOnly:o||b,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:m=>f({email:m})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([m,y])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!x[m],disabled:o||b,onChange:()=>f({sections:{...x,[m]:!x[m]}})}),e.jsx("span",{children:y})]},m))}),e.jsx(ot,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>Oa(a,x),onTest:()=>La(a,x)})]})}function Ar({value:t,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,d]=p.useState(t);p.useEffect(()=>{d(t)},[t]);const s=o.trim()!==t.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:r}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:u=>d(u.target.value),onKeyDown:u=>{u.key==="Enter"&&s&&c&&i(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!c,onClick:()=>i(o.trim()),children:n})]})]})}function qr(){const{t,token:a,flash:r,flashErr:n,canWrite:i}=T(),[o,d]=p.useState(null),[s,c]=p.useState(!1),[u,h]=p.useState(null),[l,b]=p.useState(""),[v,g]=p.useState(0);p.useEffect(()=>{let m=!0;return c(!1),Ke(a).then(y=>{m&&(y?d({configured:y.configured,url_hint:y.url_hint}):c(!0))}),Da(a).then(y=>{m&&h(y)}),()=>{m=!1}},[a,v]);const f=(m,y)=>{i&&Ke(a,m).then(S=>{if(!S||S.ok===!1){n(t.actErr);return}m.test&&S.sent===!1?n(t.plugTestThrottled):r(y),g(w=>w+1)})},x='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(X,{title:t.plugTitle,icon:"🔌",wide:!0,children:[u&&e.jsx("p",{className:"mnote"+(u.enabled?" warn":""),children:u.enabled?t.plugAutoOn(u.destination||"webhook"):t.plugAutoOff}),s?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>g(m=>m+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:l,disabled:!i,onChange:m=>b(m.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!i||!l.trim(),onClick:()=>f({url:l.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>f({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>f({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(Lr,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:x}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var m;(m=navigator.clipboard)==null||m.writeText(x).then(()=>r(t.exportCopied))},children:t.exportCopy})]})]})]})}function Lr(){const{t,token:a,lang:r}=T(),[n,i]=p.useState("valides"),[o,d]=p.useState(!1),[s,c]=p.useState(null),[u,h]=p.useState(null),[l,b]=p.useState(!1),[v,g]=p.useState(!1),[f,x]=p.useState(null),[m,y]=p.useState(null),[S,w]=p.useState(null),C=`atl2:bulk:${a}:${n}`;p.useEffect(()=>{Ke(a).then(E=>{y(E&&E.configured?E.url_hint||"webhook":null)})},[a]),p.useEffect(()=>{c(null),h(null),b(!1),x(null);try{const E=JSON.parse(localStorage.getItem(C)||"null");w(E&&Date.now()-Date.parse(E.t)<24*3600*1e3?E:null)}catch{w(null)}},[C]);const k=async()=>{d(!0),b(!1),x(null);const E=await Pa(a,n);c(E),h(E.ok?n:null),d(!1)},z=p.useRef(!1),N=async()=>{if(z.current)return;z.current=!0,g(!0);const E=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let P;try{P=await Ba(a,n,"webhook",void 0,E)}finally{z.current=!1}if(g(!1),b(!1),x(P),P.ok&&(P.pushed||0)>0){const q={t:new Date().toISOString(),n:P.pushed||0};w(q);try{localStorage.setItem(C,JSON.stringify(q))}catch{}}},A=s!=null&&s.ok&&s.ready||0,D=!!(s!=null&&s.ok)&&u===n&&A>0&&!!m&&!S,M=S?new Date(S.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:n,onChange:E=>i(E.target.value),children:t.plugBulkTabs.map(([E,P])=>e.jsx("option",{value:E,children:P},E))}),e.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{k()},children:o?"…":t.plugBulkPreview})]}),s&&(s.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr})),!!(s!=null&&s.ok)&&e.jsx("p",{className:"mnote dim",children:t.bulkScope}),S&&e.jsx("p",{className:"mnote",children:t.bulkLocked(M,S.n)}),!S&&!!(s!=null&&s.ok)&&!m&&e.jsx("p",{className:"mnote warn",children:t.bulkNoDest}),!S&&!s&&e.jsx("p",{className:"mnote dim",children:t.bulkPreviewFirst}),D&&!l&&e.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>b(!0),children:t.bulkArm}),D&&l&&e.jsxs("div",{className:"bulkc",children:[e.jsx("p",{className:"mnote warn",children:t.bulkWarn(A,m||"")}),e.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{N()},children:v?t.bulkSending:t.bulkConfirm(m||"")}),e.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>b(!1),children:t.bulkCancel})]}),f&&(f.ok?f.replayed?e.jsx("p",{className:"mnote",children:f.pending?t.bulkPending:t.bulkReplayed}):(f.pushed||0)>0?e.jsx("p",{className:"mnote",children:t.bulkDone(f.pushed||0,f.linkedinReady||0,f.skippedNoEmail||0)}):e.jsx("p",{className:"mnote warn",children:t.bulkNone}):e.jsx("p",{className:"mnote warn",children:f.error||t.actErr}))]})}function Or(){const{t,data:a,lang:r}=T(),n=a.credits,i=a.email,o=async d=>{if(!i)return;const s=window.location.href.split("?")[0];try{const u=await(await fetch(`${Qe}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:d,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();u.url&&(window.location.href=u.url)}catch{}};return e.jsxs(X,{title:t.rechargeTitle,icon:"⚡",children:[n&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(n.daily_grant)}}),n.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(n.costs.instant)," · ② ",t.creditsCost(n.costs.detailed)]}),e.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(d.credits,d.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(d.lookup_key)},children:t.rechargeBuy})]},d.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!n&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function Rr(){const{t}=T();return e.jsx(X,{title:t.dsBtn,icon:"🗂",wide:!0,children:e.jsx(gr,{})})}function Mr(){const{t,lang:a,data:r,dossiers:n,token:i,canWrite:o,flash:d}=T(),[s,c]=p.useState(null),[u,h]=p.useState(!1);p.useEffect(()=>{let k=!0;return Xe(i).then(z=>{k&&z&&typeof z.per_day=="number"&&c(z.per_day)}),()=>{k=!1}},[i]);const l=r.stats,b=typeof(l==null?void 0:l.screened)=="number"?l.screened:n.filter(k=>k.kind==="target"&&ne(k)).length,v=r.marketEstimate||0,g=v>0?Math.min(100,Math.round(b/v*100)):null,f=(l==null?void 0:l.window_days)||30,x=b>0?b/f:0,m=v>0?Math.max(0,v-b):0,S=v>0&&x>0&&b>=100?Math.round(m/x):null,w=k=>Math.round(k).toLocaleString(a==="en"?"en-US":"fr-FR"),C=k=>{u||!o||(h(!0),Fa(i,k).then(z=>{if(h(!1),z===null){d(t.actErr);return}c(z),d(t.alertSaved)}))};return e.jsxs(X,{title:t.coverTitle,icon:"🌍",children:[e.jsxs("div",{className:"covg",children:[e.jsx("b",{children:t.covScreened(w(b))}),v>0&&e.jsx("span",{children:t.covOf(w(v))})]}),g!==null?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"covbar",children:[e.jsx("i",{style:{width:g+"%"}}),e.jsxs("em",{children:[g," %"]})]}),S!==null&&e.jsx("p",{className:"mnote",children:t.covEta(S)})]}):e.jsx("p",{className:"mnote dim",children:t.covNoEst}),x>=1&&e.jsx("p",{className:"mnote",children:t.covPace(w(x))}),l&&e.jsxs("div",{className:"covf",children:[typeof l.kept=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(l.kept)})," ",t.covKept]}),typeof l.analyzed=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(l.analyzed)})," ",t.covAna]}),typeof l.shown=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(l.shown)})," ",t.covShown]})]}),o&&s!==null&&e.jsxs("div",{className:"covr",children:[e.jsxs("div",{className:"covrh",children:[e.jsx("span",{children:t.covRate}),e.jsx("b",{children:t.covRateNow(s)})]}),e.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(k=>e.jsx("button",{type:"button",className:s===k?"on":"",disabled:u,onClick:()=>C(k),children:k===0?"⏸":k},k))}),e.jsx("p",{className:"mnote dim",children:t.covRateHint})]})]})}function Dr(){var m,y,S;const{t,dossiers:a,token:r,mode:n,flash:i,criteria:o}=T(),d=n==="client",s=p.useMemo(()=>{const w=new Set;return a.forEach(C=>{C.angle&&w.add(C.angle)}),[...w]},[a]),[c,u]=p.useState(null);p.useEffect(()=>{let w=!0;return Ma(r).then(C=>{w&&u(C.thumbs)}),()=>{w=!1}},[r]);const[h,l]=p.useState(""),[b,v]=p.useState(""),[g,f]=p.useState(!1),x=async()=>{const w=h.trim();if(!(!w||g||!d)){f(!0),v("");try{const k=await(await fetch(`${qe}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(k.reply&&v(String(k.reply)),k.job_id){v(t.critChatRunning);const z=async()=>{const N=await fetch(`${qe}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:k.job_id})}).then(A=>A.json()).catch(()=>null);if(N&&N.done){v(String(N.reply||N.clarification||N.summary||"✓")),f(!1),N.applied&&i(t.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),l("");return}l("")}finally{b.startsWith("⏳")||f(!1)}}};return e.jsxs(X,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((m=o.points)!=null&&m.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(w=>e.jsx("li",{children:w},w))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(w=>{var C,k;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:w.title}),w.why&&e.jsx("p",{className:"why",children:w.why}),e.jsxs("div",{className:"lo",children:[!!((C=w.look)!=null&&C.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:w.look.map(z=>e.jsx("li",{children:z},z))})]}),!!((k=w.out)!=null&&k.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:w.out.map(z=>e.jsx("li",{children:z},z))})]})]})]},w.title)})]}),!!((S=o==null?void 0:o.gate)!=null&&S.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>e.jsxs("li",{children:[w.k&&e.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>e.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:h,disabled:!d||g,onChange:w=>l(w.target.value),onKeyDown:w=>{w.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(g?" loading":""),style:{padding:"12px 18px"},disabled:!d||g||!h.trim(),onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),b&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:b})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),c===null?e.jsx("div",{className:"sp-empty",children:"…"}):c.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:c.slice(0,12).map((w,C)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:w.company}),e.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},C))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Vt[w]||"v-cons"),children:w}),e.jsx("span",{children:C})]},w))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:w}),e.jsxs("span",{children:["← ",C]})]},w))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function Fr(){const{t,dispatch:a,startTour:r}=T(),n=i=>{var o,d;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return e.jsxs(X,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([i,o],d)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[e.jsx("span",{className:"n",children:d+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+d))})]})}const Ut="atl2:mapfold",Pr=()=>{if(typeof window>"u")return!1;try{const t=localStorage.getItem(Ut);if(t==="on")return!0;if(t==="off")return!1}catch{}return window.innerHeight<1e3},Ht=p.createContext(null),T=()=>{const t=p.useContext(Ht);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function Se({o:t,lg:a}){const{lang:r}=T(),n=Q(t);return n?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:vt(n,r),children:[n.emoji," ",vt(n,r)]}):null}function Ve({o:t,src:a}){const{lang:r,t:n}=T(),i=Q(t);if(!i)return null;const o=Ga(i),d=Ka(i);return e.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(Dt(i,r))+" · "+n.win7(Ft(i,r)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(s,c)=>e.jsx("i",{className:c<o?"on":""},c))}),e.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&e.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function _t({o:t}){const{lang:a}=T(),r=Wa(t.cc),n=t.cc?Ne(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:n||void 0,children:r?e.jsx("img",{src:r,width:24,height:18,alt:n||""}):e.jsx("span",{className:"em",children:"🌐"})})}const qt="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Yt=t=>`atl2:tour:${t||"anon"}`;function Br(t){try{return localStorage.getItem(Yt(t))==="1"}catch{return!0}}function Lt(t){try{localStorage.setItem(Yt(t),"1")}catch{}}function Ir(t){const a=t.tourT,r=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function Yr({demo:t=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){const{lang:d}=Ha(),s=nn[d],c=xn(t,d,a),[u,h]=p.useReducer(hn,void 0,()=>gn((n==null?void 0:n.continent)??"europe",t||Pr(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),l=p.useRef(!0);p.useEffect(()=>{if(l.current){l.current=!1;return}if(!t)try{localStorage.setItem(Ut,u.mapFolded?"on":"off")}catch{}},[u.mapFolded,t]);const b=p.useRef(o);b.current=o,p.useEffect(()=>{var j;(j=b.current)==null||j.call(b,u.filters)},[u.filters]);const[v,g]=p.useState(null),[f,x]=p.useState(null),[m,y]=p.useState({kept:0,dropped:0}),[S,w]=p.useState(!1),[C,k]=p.useState(""),[z,N]=p.useState(!1),[A,D]=p.useState(null),[M,E]=p.useState(!1),[P,q]=p.useState(!1),[,B]=p.useState(0),R=()=>B(j=>j+1),_=p.useRef([]),se=p.useRef(new Set),pe=p.useRef(new Set),Oe=p.useRef(new Map),he=p.useRef(null),{mode:ue}=c,Y=p.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),V=Y.pipe,U=c.session.token||"",F=ue==="client"&&!t;p.useEffect(()=>{if(document.querySelector(`link[href="${qt}"]`))return;const j=document.createElement("link");j.rel="stylesheet",j.href=qt,document.head.appendChild(j)},[]);const I=(j,L=!1)=>{k(j),N(L),he.current&&clearTimeout(he.current),he.current=setTimeout(()=>k(""),L?4200:2400)},H=j=>I(j,!0),re=p.useMemo(()=>{const j=new Map;return c.dossiers.forEach(L=>{L.id&&j.set(L.id,L)}),j},[c.dossiers]),te=p.useMemo(()=>c.dossiers.filter(j=>Bt(j,u,V)),[c.dossiers,u,V]),J=p.useRef(!1);p.useEffect(()=>{if(J.current||t||c.loading||!c.dossiers.length)return;if(!Y.showFunnel||Br(c.session.token||"")){J.current=!0;return}J.current=!0;const j=window.setTimeout(()=>{Lt(c.session.token||""),E(!0)},700);return()=>window.clearTimeout(j)},[t,c.loading,c.dossiers.length,Y.showFunnel,c.session.token]);const Z=p.useMemo(()=>c.dossiers.filter(j=>bn(j,u,V,c.favIds)),[c.dossiers,u,V,c.favIds]),Ce=p.useMemo(()=>_a(te,c.favIds),[te,c.favIds]),$=Ze.find(j=>j.key===u.continent),le=d==="fr"?$.fr:$.en,me=(j,L)=>{const O=((j==null?void 0:j.name)||L||"").trim();if(!F){x({kicker:O});return}!O||S||(w(!0),(async()=>{try{const W=await Mt(U,O,"atelier2"),Re={name:W.company||O,verdict:W.verdict,reason:W.reason||"",remaining:W.remaining??null};_.current=[Re,..._.current].slice(0,8),W.verdict==="kept"&&y(fe=>({...fe,kept:fe.kept+1})),W.verdict==="ruled_out"&&y(fe=>({...fe,dropped:fe.dropped+1}));const Te=j||c.dossiers.find(fe=>(fe.name||"").toLowerCase()===O.toLowerCase());Te&&(W.verdict==="kept"?Te.verdict=Te.verdict||"MATCH":W.verdict==="ruled_out"&&(Te.verdict="NO MATCH"),W.reason&&(Te.reasoning=W.reason)),R()}finally{w(!1)}})())},ze=j=>{if(!F){x({kicker:j.name});return}se.current.add(j.id),Ae(U,"fast_request",j.name||"",""),I(s.memoInstantSent(j.name)),R()},be=j=>Oe.current.get(j.id)??c.thumbs.get((j.name||"").trim().toLowerCase()),ae=(j,L)=>h({type:"undoPush",entry:{id:j.id,name:j.name,prevCeoStatus:L}}),ve=async(j,L,O)=>{const W=j.ceoStatus||"";j.ceoStatus=L,R();const Re=await _e(U,{status:L,airtable_id:j.airtableId,check_id:j.checkId,company:j.name,...(O==null?void 0:O.note)!==void 0?{note:O.note}:{},...O!=null&&O.via?{via:O.via}:{}});return Re.ok?Re.skipped?(j.ceoStatus=W,R(),H(s.actNotPersisted),!1):((O==null?void 0:O.undo)!==!1&&ae(j,W),O!=null&&O.msg&&I(O.msg),(L==="Validé"||L==="Écarté")&&!j.ceoNote&&(O==null?void 0:O.note)===void 0&&D({o:j,yes:L==="Validé"}),!0):(j.ceoStatus=W,R(),H(s.actErr),!1)},Ee=async(j,L)=>{const O=await _e(U,{status:j.ceoStatus||"Retenu",airtable_id:j.airtableId,check_id:j.checkId,company:j.name,note:L,via:"note"});return!O.ok||O.skipped?(H(O.skipped?s.actNotPersisted:s.actErr),!1):(j.ceoNote=L,R(),!0)},oe=p.useRef(new Map),ye=j=>oe.current.has(j.id)?oe.current.get(j.id):c.stages.get((j.name||"").trim().toLowerCase()),Wt=(j,L)=>{oe.current.set(j.id,L),R()},Gt=(j,L)=>{F&&ve(j,L?"Validé":"Écarté",{msg:L?s.decidedYes(j.name):s.decidedNo(j.name)})},Kt=j=>{F&&ve(j,"À trancher",{msg:s.promoted(j.name)})},Qt=j=>{F&&(async()=>{const L=j.ceoStatus||"";j.ceoStatus="Retenu",R();const O=await _e(U,{status:"Retenu",check_id:j.checkId,company:j.name});if(!O.ok||O.skipped){j.ceoStatus=L,R(),H(O.skipped?s.actNotPersisted:s.actErr);return}ae(j,L),I(s.repeched(j.name))})()},Jt=()=>{const j=u.undo[u.undo.length-1];if(!j){I(s.undoNone);return}const L=re.get(j.id);if(!L){h({type:"undoPop"}),I(s.undoNone);return}let O=j.prevCeoStatus;if(!O)if((L.verdict||"").toUpperCase().includes("CALL"))O="À trancher";else{I(s.undoLockedTitle);return}(async()=>await ve(L,O,{undo:!1})&&(h({type:"undoPop"}),L.ceoStatus=j.prevCeoStatus,R(),I(s.undoDone(L.name))))()},Xt=j=>{F&&(pe.current.add(j.id),R(),(async()=>{const L=await Qa(U,j.name,"email");if(!L||L.ok===!1){pe.current.delete(j.id),R(),H(s.actErr);return}Ae(U,"approach",j.name||"",""),I(s.actApproachSent)})())},Zt=(j,L)=>{F&&(async()=>{if(!(await Ae(U,L?"yes":"no",j.name||"","")).ok){H(s.actErr);return}Oe.current.set(j.id,L?"yes":"no"),R(),I(L?s.thumbUpDone:s.thumbDnDone)})()},ea=j=>{!F||!et(j)||(Ae(U,"detailed_request",j.name||"",""),I(s.memoDeepSent(j.name)))},ta=j=>{const L=new Set(c.favIds),O=L.has(j.id);O?L.delete(j.id):L.add(j.id),c.setFavIds(L),F&&Ja(U,{id:j.id,co:j.name},O)},aa=()=>{!F||P||window.confirm(s.identSyncConfirm)&&(q(!0),(async()=>{const j=await Xa(U);q(!1),j?I(s.identSyncDone):H(s.actErr)})())},it=/proplace/i.test(c.fund||""),na=j=>{!F||!it||(Ae(U,"onboard_request",j.name||"",""),I(s.onboardSent(j.name)))},ra={st:u,dispatch:h,t:s,lang:d,mode:ue,caps:Y,pipe:V,token:U,fund:c.fund,email:c.email,criteria:c.criteria,data:c,doRepeche:Qt,thumbOf:be,canWrite:F,commitStatus:ve,saveNote:Ee,stageOf:ye,setStage:Wt,flashErr:H,startTour:()=>E(!0),dossiers:c.dossiers,scopedAll:te,scoped:Z,counts:Ce,byId:re,contName:le,favIds:c.favIds,toggleFav:ta,askEvaluate:me,doAnalyse:ze,doDecide:Gt,doPromote:Kt,doApproach:Xt,doThumb:Zt,doDeep:ea,doUndo:Jt,doSync:aa,doOnboard:na,outbound:it,memoQueued:se.current,approachDone:pe.current,sessTally:m,evalCards:_.current,evalBusy:S,markRow:g,markedId:v,flash:I};return p.useEffect(()=>{const j=L=>{L.key==="Escape"&&(h({type:"popup",id:null}),h({type:"modal",modal:null}),h({type:"openFacet",facet:null}))};return window.addEventListener("keydown",j),()=>window.removeEventListener("keydown",j)},[]),e.jsx(Ht.Provider,{value:ra,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:sn}),e.jsxs("div",{className:"app"+(V?" pipe":""),children:[Y.showTicker&&e.jsx(G,{name:"live",children:e.jsx(vn,{})}),Y.showIdent&&e.jsx(G,{name:"identite",children:e.jsx(Dn,{})}),Y.showOnb&&e.jsx(G,{name:"onboarding",children:e.jsx(Fn,{})}),Y.showMorning&&e.jsx(G,{name:"matin",children:e.jsx(Mn,{})}),e.jsx(G,{name:"fraicheur",children:e.jsx(zn,{})}),e.jsx(G,{name:"mesure",children:e.jsx(En,{})}),Y.showFunnel&&e.jsx(G,{name:"entonnoir",children:e.jsx($r,{})}),Y.showFunnel&&e.jsx(G,{name:"tunnel",children:e.jsx(Bn,{})}),Y.showFunnel&&e.jsx(G,{name:"tuto",children:e.jsx($n,{})}),e.jsx(G,{name:"carte",fallback:e.jsx("div",{className:"void",children:s.loadError}),children:e.jsxs("div",{className:"fzone",children:[e.jsx(Vr,{}),e.jsxs("div",{className:"stage"+(u.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(Un,{}),e.jsx(_n,{})]})]})}),Y.showDemand&&e.jsx(G,{name:"evaluation",children:e.jsx(Wn,{})}),Y.showDemand&&u.memoConsole&&e.jsx(G,{name:"console",children:e.jsx(Kn,{})}),e.jsx(G,{name:"liste",fallback:e.jsxs("div",{className:"void",children:[s.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:e.jsx(sr,{})}),c.loading&&e.jsx("div",{className:"void",children:s.loadingV2}),c.error&&!c.loading&&e.jsxs("div",{className:"void",children:[s.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:s.retry})]})]}),Y.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:s.lockbarText}),e.jsx("button",{type:"button",onClick:()=>h({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),u.popupId&&e.jsx(G,{name:"fiche",children:e.jsx(cr,{})}),e.jsx(G,{name:"modales",children:e.jsx(br,{})}),e.jsx(Nn,{}),A&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:A.o.name}),e.jsx(Ln,{placeholder:A.yes?s.whyYesPh:s.whyNoPh,onDone:j=>{const L=A.o;D(null),j&&Ee(L,j).then(O=>{O&&I(s.csNoteSaved)})}})]}),M&&e.jsx(Rn,{steps:Ir(s),onClose:()=>{E(!1),Lt(U)}}),C&&e.jsx("div",{className:"flash on"+(z?" err":""),children:C}),f&&e.jsx(Ya,{variant:"acquirer",initialCompany:Ot().co,initialWebsite:Ot().site,onClose:()=>x(null)})]})})}function $r(){const{t}=T(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Vr(){const{dossiers:t,st:a,dispatch:r,pipe:n,lang:i,t:o}=T(),d=p.useMemo(()=>{const s={};return t.forEach(c=>{c.continent&&at(c,a.filters,n)&&(s[c.continent]=(s[c.continent]||0)+1)}),s},[t,a.filters,n]);return e.jsxs("div",{className:"conts",children:[Za.map(s=>{const c=Ze.find(u=>u.key===s);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[i==="fr"?c.fr:c.en,e.jsx("span",{className:"n",children:d[s]||0})]},s)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Ot(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ur(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{_t as FlagCell,Se as SigBadge,Ve as SigWin,Yr as default,Ur as fmtShort,T as useV2};
