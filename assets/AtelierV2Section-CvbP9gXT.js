...
`,Eo=So+Co,zo=`
/* « Faut écrire ⚡ Évaluer X sinon on comprend plus rien » : sur les lignes
   ACTUALITÉ, les DEUX gestes en toutes lettres, empilés dans la cellule
   d'action — plus jamais d'icône nue. */
.atl2 .cell.cell-duo{flex-direction:column;align-items:stretch;gap:5px}
.atl2 .cell.cell-duo .rev{flex:none;width:100%}
.atl2 .cell.cell-duo .rev:first-child{flex:none}
`;function na(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ao(){const e=na("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function To(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ao();return r==="0"?"client":r==="1"||na("embed")==="1"&&na("chrome")==="1"?"apercu":"client"}const Lo={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ro=e=>Lo[e],Ue=e=>Object.assign(e,{continent:Lr(e.cc)});function Yt(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Mo=60*60*1e3;function Oo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Mo?null:a}catch{return null}}function vt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const qo=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Fo(e,a,r="default"){const n=r!=="default",o=g.useMemo(()=>e||n?{mode:"anon"}:wr(),[e,n]),i=g.useMemo(()=>n?"visiteur":To(e,o),[e,o,n]),l=g.useMemo(()=>Ro(i),[i]),s=i!=="visiteur",p=qo(r),[u,c]=g.useState([]),[d,m]=g.useState(""),[b,f]=g.useState(null),[v,h]=g.useState(null),[x,y]=g.useState(null),[j,w]=g.useState(()=>new Map),[N,S]=g.useState(()=>new Map),[L,P]=g.useState(""),[z,k]=g.useState(new Set),[A,T]=g.useState(null),[q,R]=g.useState(!0),[E,M]=g.useState(!1),[$,K]=g.useState(0),[Q,pe]=g.useState(0),le=g.useRef(0),U=g.useMemo(()=>{var H;if(i!=="client")return"";try{return((H=kr())==null?void 0:H.email)||""}catch{return""}},[i]);g.useEffect(()=>{const H=++le.current;let _=!0;const G=()=>_&&H===le.current,ee=(s&&o.token?o.token:"pub:"+a)+(p?":"+p:""),ne=Oo(ee);return ne?(c(ne.objs.map(Ue)),ne.fund&&m(ne.fund),f(ne.marketEstimate??null),h(ne.criteria??null),y(ne.stats??null),P(ne.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const ge=await Ut(),ue=((ge==null?void 0:ge.recent_ops)||[]).map(Y=>{const Z=Vt(Y.company_name||Y.title?Y:{...Y,title:(Y.headline_fr||Y.headline||"").slice(0,120)},a),be=String(Y.rubrique||"").toLowerCase();return Z&&(be==="nominations"||be==="recrutements")&&(Z.engine=be),Z}).filter(Y=>!!Y).map(Y=>(jr((Y.name||"").trim())||(Y.noCo=!0),Y));try{const Y=await Nr(),Z=Sr(Y),be=((Y==null?void 0:Y.date)||"").slice(0,10);if(Z.length&&be){const B=new Set;for(const de of ue){if(de.noCo||(de.date||"").slice(0,10)!==be)continue;const re=(de.name||"").trim().toLowerCase();if(!(re.length<3)){for(let fe=0;fe<Z.length;fe++)if(!B.has(fe)&&Z[fe].t.includes(re)){B.add(fe),de.decryptHtml=Z[fe].html;break}}}}}catch{}if(!G())return;c(ue.map(Ue)),vt(ee,{objs:ue})}else if(typeof r=="object"){const ue=(await qa()||[]).filter(Z=>(Z.slug||"")===r.research).map(Z=>Fa(Z,a)).filter(Z=>!!Z),Y=Yt(await Pa(ue,a));if(!G())return;c(Y.map(Ue)),vt(ee,{objs:Y})}else if(s&&o.token){const ge=Cr(o.token),ue=Ut(),Y=Er(o.token),Z=zr(o.token),be=Ar(o.token),B=await ge;let de=B?B.targets:[];G()&&B&&(m(B.fund||""),f(B.marketEstimate??null),h(B.criteria??null),y(B.stats??null),P(B.generatedAt||""),c(de.map(Ue)),R(!1),M(!1));const[re,fe,Me,ve]=await Promise.all([ue,Y,Z,be]),Oe=((re==null?void 0:re.recent_ops)||[]).map(ye=>Vt(ye,a)).filter(ye=>!!ye);if(de=[...de,...Oe],!G())return;c(de.map(Ue));const Ie=new Set;for(const ye of fe){const Be=(ye.id||ye.co||"").toString().trim().toLowerCase();Be&&Ie.add(Be.startsWith("t:")?Be:"t:"+Be)}k(Ie),w(Me),S(ve),B&&vt(ee,{fund:B.fund,marketEstimate:B.marketEstimate,criteria:B.criteria,stats:B.stats,generatedAt:B.generatedAt,objs:de})}else{const ge=Tr(),ue=qa(),Y=Ut(),Z=await ge;G()&&Z.length&&(c(Yt(Z).map(Ue)),R(!1),M(!1));const[be,B]=await Promise.all([ue,Y]),de=(be||[]).map(ve=>Fa(ve,a)).filter(ve=>!!ve),re=await Pa(de,a),fe=((B==null?void 0:B.recent_ops)||[]).map(ve=>Vt(ve,a)).filter(ve=>!!ve),Me=Yt([...Z,...re,...fe]);if(!G())return;c(Me.map(Ue)),vt(ee,{objs:Me})}G()&&M(!1)}catch{G()&&!ne&&M(!0)}finally{G()&&R(!1)}})(),()=>{_=!1}},[s,o.token,a,$,p]),g.useEffect(()=>{if(!l.showCredits||!U){T(null);return}let H=!0;return(async()=>{try{const _=await fetch(`${ya}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:U})});if(!_.ok)return;const G=await _.json();H&&G&&G.ok!==!1&&T(G)}catch{}})(),()=>{H=!1}},[l.showCredits,U,Q]);const W=g.useCallback(H=>k(new Set(H)),[]);return{session:o,mode:i,caps:l,fund:d,email:U,marketEstimate:b,generatedAt:L,criteria:v,stats:x,thumbs:j,stages:N,dossiers:u,favIds:z,setFavIds:W,credits:A,reloadCredits:()=>pe(H=>H+1),loading:q,error:E,refresh:()=>K(H=>H+1)}}const Rn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Po=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Rn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Do(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Rn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Mn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Mn=40;function Sa(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!he(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(wa(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(et(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&He(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(o))return!1}return!0}function On(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Sa(e,a.filters,r)}function Io(e,a,r,n){return!(!On(e,a,r)||r&&!Rr(e,a.ptab,n))}function Ca(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-et(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"signal":{const i=he(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),s=n(i);return l<s?-a.dir:l>s?a.dir:(o.name||"").localeCompare(i.name||"")})}function Bo(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i}=O(),l=g.useMemo(()=>{const p=(a.filters.day||"").slice(0,10),u=b=>!(!i&&a.continent!=="monde"&&b.continent!==a.continent||p&&(b.date||"").slice(0,10)!==p),c=e.filter(b=>u(b)&&he(b)),d=e.filter(b=>u(b)&&b.kind==="op"&&!he(b)&&(p?!0:et(b.date)<=7)),m=p||new Date().toISOString().slice(0,10);return d.sort((b,f)=>{const v=(b.date||"").slice(0,10)===m?0:1,h=(f.date||"").slice(0,10)===m?0:1;return v!==h?v-h:(f.amountEur||0)-(b.amountEur||0)}),[...Ca(c,{key:"signal",dir:-1}),...d].slice(0,48)},[e,a.continent,a.filters.day,i]),s=p=>l.map(u=>t.jsxs("button",{type:"button",className:"tk"+(Ne(u)?" spent":""),onClick:c=>{const d=c.currentTarget.getBoundingClientRect();n({type:"popup",id:u.id,anchor:{x:d.left+d.width/2,y:d.bottom}})},title:u.name+(u.tagline?" — "+u.tagline:""),children:[t.jsx(rt,{o:u}),t.jsxs("span",{className:"who",children:[t.jsx(lr,{o:u}),t.jsx("span",{className:"co",children:u.name})]}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{className:"am",children:dl(u.amountEur)}),u.sector&&t.jsx("span",{className:"mt",children:u.sector}),t.jsx($t,{o:u}),t.jsx("span",{className:"tkgo",children:"→"})]},p+(u.id||u.name)));return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live,t.jsx("span",{className:"cnt",children:l.length})]}),t.jsx("div",{className:"win",children:l.length?t.jsxs("div",{className:"run",children:[s(0),s(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})})]})}const $o="aDx8z7Hzksus",qn="+33 6 83 10 72 86",Ya="alexandre@proplace.co",_o=`tel:${qn.replace(/[^\d+]/g,"")}`,Wa="pp-rdv-slot";function Uo(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Vo(){const{t:e,caps:a,fund:r}=O();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:Yo}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:_o,children:qn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Ya}`,children:Ya})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([o,i],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(wo,{filloutId:$o,parameters:r?{company_name:r}:void 0})})]})}function Ho(){const[e,a]=g.useState(()=>typeof document>"u"?null:document.getElementById(Wa));return g.useEffect(()=>{e||a(document.getElementById(Wa))},[e]),e?tt.createPortal(t.jsx(Vo,{}),e):null}const Yo=`
...
`;class me extends g.Component{constructor(){super(...arguments);Ma(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Wo=8;function Go(){const{t:e,lang:a,token:r,dossiers:n,caps:o,markRow:i,dispatch:l}=O(),[s,p]=g.useState(!1),[u,c]=g.useState(!1),[d,m]=g.useState(!1),b=r||"home",{names:f,verdicts:v}=g.useMemo(()=>{const w=[],N={};return n.forEach(S=>{S.kind!=="target"||!S.name||(w.push(S.name),N[S.name]=Mr(S)||"")}),{names:w,verdicts:N}},[n]),h=g.useMemo(()=>f.length?Or(b,f,v,a):null,[b,f.length]);if(!o.pipe||s||!h||h.firstVisit||!h.added.length&&!h.gone.length)return null;const x=u?h.added:h.added.slice(0,Wo),y=h.added.length-x.length,j=w=>{const N=n.find(S=>S.name===w);N&&(i(N.id),l({type:"popup",id:N.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(h.added.length,h.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),qr(b,f,v,h.fp,a)},children:"×"})]}),!!h.added.length&&t.jsxs("div",{className:"since-c",children:[x.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>c(!0),children:e.sinceMore(y)})]}),!!h.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>m(w=>!w),children:e.sinceOut(h.gone.length)}),d&&h.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Wt=600,Ve=62,Ga="atl2:fstats";function Ko(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=O(),[l,s]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Ga)==="on"}catch{return!1}}),p=r.stats,u=g.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),c=g.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const d=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,m=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),b=u.reduce((y,j)=>Math.max(y,j.s||0),0),f=u.length?Wt/u.length:0,v=Math.max(4,f-4),h=u.length>=5&&b>0,x=[[p.screened,e.funScreened(d(c)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[x.map(([y,j,w],N)=>t.jsxs("span",{className:"fst-t",children:[N>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:m(y)}),t.jsx("i",{children:j}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),h&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Ga,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&h&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Wt} ${Ve}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[u.map((y,j)=>{const w=(y.s||0)/b*(Ve-4),N=(y.m||0)/b*(Ve-4),S=j*f+(f-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${d(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:S,y:Ve-2-w,width:v,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:S,y:Ve-2-N,width:v,height:N,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Ve-1.5,x2:Wt,y2:Ve-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:d(u[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Qo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Xo({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=O(),[i,l]=g.useState(""),[s,p]=g.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const u=(e.ceoStatus||"").trim(),c=(at(e)||"").startsWith("CALL")&&ke(e)===3,d=ke(e)>=2,m=async f=>{if(i||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(f);const v=await o(e,f);l(""),v&&(p(!0),setTimeout(()=>p(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:Qo.filter(([f])=>!(d&&f==="Retenu")).map(([f,v])=>[f,a[v]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([f,v])=>t.jsx("button",{type:"button",className:"csb"+(u===f?" on":"")+(i===f?" busy":""),disabled:!!i,onClick:()=>{m(f)},children:v},f)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Jo,{o:e})]})}function Jo({o:e}){const{t:a,saveNote:r,flash:n}=O(),[o,i]=g.useState(e.ceoNote||""),[l,s]=g.useState(!1),[p,u]=g.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),d=async()=>{if(l||!c)return;s(!0);const m=await r(e,o.trim());s(!1),m&&(u(!0),setTimeout(()=>u(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:l,onChange:m=>i(m.target.value),onKeyDown:m=>{m.key==="Enter"&&d()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{d()},children:p?a.csNoteSaved:a.csNoteOk})]})}function Zo({placeholder:e,onDone:a}){const{t:r}=O(),[n,o]=g.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ei({o:e}){var h;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:l,flashErr:s}=O(),[p,u]=g.useState(!1);if(!n.pipe||!o||n.lockActions||ke(e)!==4)return null;const c=i(e),d=(c==null?void 0:c.stage)||"todo",m=async x=>{if(p||x===d)return;u(!0);const y=c;l(e,{stage:x,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),Ka+=1);Ka=j;const w=await Fr(r,{company:e.name||"",stage:x,cts:j,deal_id:e.airtableId,check_id:e.checkId});u(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},b=(h=c==null?void 0:c.stamps)==null?void 0:h.sent,f=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=d==="sent"&&b&&f>=4;return t.jsxs("div",{className:"stg",onClick:x=>x.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([x,y])=>t.jsx("button",{type:"button",className:"stgb"+(d===x?" on":""),disabled:p,onClick:()=>{m(x)},children:y},x)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let Ka=0;const yt=8,wt=340;function Qa({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function ti({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,scoped:i,byId:l,st:s}=O(),[p,u]=g.useState(0),[c,d]=g.useState(null),[m,b]=g.useState([]),f=g.useRef(!1);g.useEffect(()=>{f.current||(f.current=!0,b(e.filter(N=>!!document.querySelector(N.need||N.sel))))},[e]);const v=m[p],h=p>=m.length;g.useEffect(()=>{v&&(v.ptab!==void 0&&s.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&s.dens!==v.dens&&n({type:"dens",dens:v.dens}))},[p,v]);const x=g.useCallback(()=>{if(!v){d(null);return}const N=document.querySelector(v.sel);if(!N){d(null);return}N.scrollIntoView({block:"nearest",behavior:"smooth"}),d(N.getBoundingClientRect())},[v]);g.useLayoutEffect(()=>{x();const N=window.setTimeout(x,260),S=()=>x();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{window.clearTimeout(N),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[x]);const y=g.useRef(a);if(y.current=a,g.useEffect(()=>{const N=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),y.current()):S.key==="ArrowRight"?u(L=>L+1):S.key==="ArrowLeft"&&u(L=>Math.max(0,L-1))};return document.addEventListener("keydown",N,!0),()=>document.removeEventListener("keydown",N,!0)},[]),!m.length)return null;let j=null;if(h){const N=o[3]||0,S=i.find(L=>L.memoUrl)||[...l.values()].find(L=>L.memoUrl);N>0?j={title:N===1?r.ahaATitle1:r.ahaATitleN(N),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:S?j={title:r.ahaBTitle,body:r.ahaBBody(S.name),btn:r.ahaBBtn,go:()=>{n({type:"memoConsole",id:S.id}),a()}}:j={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:wt};if(!h&&c){const N=c.bottom+14,L=window.innerHeight-N>190?N:Math.max(12,c.top-200);w={left:Math.min(Math.max(12,c.left+c.width/2-wt/2),window.innerWidth-wt-12),top:L,width:wt}}return tt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!h&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-yt,top:c.top-yt,width:c.width+yt*2,height:c.height+yt*2}}),(h||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(h?" fin":""),style:w,children:[h&&j?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:j.title}),t.jsx("p",{children:t.jsx(Qa,{text:j.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>u(m.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:j.go,children:j.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(p+1,m.length)}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx("p",{children:t.jsx(Qa,{text:(v==null?void 0:v.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:p===0,onClick:()=>u(N=>Math.max(0,N-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>u(N=>N+1),children:p===m.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function ai(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,dispatch:l}=O(),s=r?a:e,p=g.useMemo(()=>s.filter(x=>et(x.date)===0&&x.kind==="target"),[s]),u=g.useMemo(()=>r?a.filter(x=>ke(x)===0).slice().sort((x,y)=>(y.date||"").localeCompare(x.date||"")):[],[a,r]),c=g.useMemo(()=>p.filter(x=>r?ke(x)===0:!Ne(x)),[p,r]),d=r?u:c,m=r?a.length-u.length:p.length-c.length,b=r?a.length:p.length,f=b?Math.min(100,m/b*100):100;let v;r?v=o.morningThesis(p.length,u.length):p.length?m===0?v=o.goalSourced(p.length):m>=p.length?v=o.goalCleared:v=o.goalDone(m,p.length):v=o.goalSourced(0);const h=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&u.length&&l({type:"chainStart",queue:u.map(x=>x.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:v}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:f+"%"}})}),d.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:r?o.morningEval(d.length):i.pileMode?o.goalContinue(d.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ni(){var k,A;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:l,dossiers:s,mode:p,doSync:u,startTour:c}=O(),[d,m]=g.useState(null),[b,f]=g.useState([]),v=p==="client";g.useEffect(()=>{if(!o||!i)return;let T=!0;return(async()=>{const[q,R]=await Promise.all([ka(i),En(o)]);T&&(q&&m(q),f(R))})(),()=>{T=!1}},[o,i]);const h=(d==null?void 0:d.per_day)??null,x=((k=d==null?void 0:d.pool_order)==null?void 0:k.length)??0,y=b.filter(T=>T.status==="running").length,j=g.useMemo(()=>s.filter(T=>T.kind==="target"&&Ne(T)).length,[s]),w=l.marketEstimate,N=typeof((A=l.stats)==null?void 0:A.screened)=="number"?l.stats.screened:j,S=w&&w>0?Math.min(100,Math.round(N/w*100)):null,L=T=>T.toLocaleString(a==="en"?"en-US":"fr-FR"),P=(i||"P").split(/\s+/).map(T=>T[0]).join("").slice(0,2).toUpperCase(),z=(()=>{const T=Date.parse(l.generatedAt||"");if(Number.isNaN(T))return"";const q=new Date(T),R=E=>String(E).padStart(2,"0");return`${R(q.getDate())}/${R(q.getMonth()+1)} à ${R(q.getHours())}:${R(q.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:P}),t.jsx("i",{children:i})]}),t.jsx("h1",{children:e.identTitle(i||"…")}),t.jsx("span",{className:"idsp"}),z&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(z)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[S===null&&N>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:L(N)})})]}),S!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:S+"%"}})}),t.jsxs("b",{children:[S," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(N,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),h!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:h})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),h===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(x)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:T=>{T.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!v,onClick:u,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:T=>n({type:"filters",patch:{search:T.target.value}})})]})]})]})}function ri(){const{t:e,counts:a,dispatch:r}=O();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,o],i)=>{const l=i===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:i+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:o}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},i)})})]})}const oi=["--p0","--p1","--p2","--p3","--p4"];function ii(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o}=O(),i=g.useRef({});g.useEffect(()=>{i.current={...r}},[r]);const l=u=>{const c=i.current[u],d=c!==void 0?r[u]-c:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${oi[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(d>0?" up":d<0?" down":""),children:[r[u],d!==0&&t.jsxs("em",{className:"delta",children:[d>0?"+":"−",Math.abs(d)]})]})]},u)},s=(u,c,d)=>t.jsxs("button",{type:"button",className:"off"+(c?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:d.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),p=(u,c,d,m=!1)=>t.jsx("button",{type:"button",className:"tool",title:c,disabled:m,onClick:d,children:u},c);return t.jsxs("div",{className:"funnel",children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[p("↩",n.toolUndo,o,e.undo.length===0),p("↺",n.toolReset,()=>{a({type:"reset"})}),p("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),p("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const si=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function li(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:l}=O(),s=g.useRef(null),[p,u]=g.useState(60);g.useEffect(()=>{let b=0;const f=()=>{var j;const v=s.current;if(!v)return;const h=(j=v.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!h)return;const x=h.getBoundingClientRect(),y=v.getBoundingClientRect();u(Math.max(20,Math.min(x.left+x.width/2-y.left,y.width-30)))};return b=requestAnimationFrame(f),window.addEventListener("resize",f),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",f)}},[e.ptab]);const c=e.ptab;let d=r.tuto[c].p;if(c===3){const b=n.filter(h=>h.kind==="target"&&ke(h)===3),f=b.filter(h=>ea(h)==="auto").length,v=b.filter(h=>ea(h)==="cd").length;d=r.tutoPending(f,v,b.length)}const m=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(b=>b.id)})};if(c===1){const b=n.filter(f=>f.kind==="target"&&ke(f)===1&&!o.has(f.id)).slice(0,10);if(b.length)return{label:r.tuto[1].a,run:()=>b.forEach(f=>i(f))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":si[c],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:d}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label})]})}class Ye{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],l=a+i,s=Math.abs(a)<Math.abs(i)?a-(l-i):i-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,o=a[--r],l=n+o,i=o-(l-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=l+o,o==n-l&&(l=n))}return l}}function*ci(e){for(const a of e)yield*a}function Fn(e){return Array.from(ci(e))}var J=1e-6,V=Math.PI,Ce=V/2,Xa=V/4,ze=V*2,Fe=180/V,je=V/180,te=Math.abs,di=Math.atan,ft=Math.atan2,ie=Math.cos,se=Math.sin,pi=Math.sign||function(e){return e>0?1:e<0?-1:0},Ge=Math.sqrt;function ui(e){return e>1?0:e<-1?V:Math.acos(e)}function mt(e){return e>1?Ce:e<-1?-Ce:Math.asin(e)}function Ee(){}function Tt(e,a){e&&Za.hasOwnProperty(e.type)&&Za[e.type](e,a)}var Ja={Feature:function(e,a){Tt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Tt(r[n].geometry,a)}},Za={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ra(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ra(r[n],a,0)},Polygon:function(e,a){en(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)en(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Tt(r[n],a)}};function ra(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function en(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ra(e[r],a,1);a.polygonEnd()}function Ke(e,a){e&&Ja.hasOwnProperty(e.type)?Ja[e.type](e,a):Tt(e,a)}function oa(e){return[ft(e[1],e[0]),mt(e[2])]}function Je(e){var a=e[0],r=e[1],n=ie(r);return[n*ie(a),n*se(a),se(r)]}function kt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Lt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Gt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function jt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ia(e){var a=Ge(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function sa(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function la(e,a){return te(e)>V&&(e-=Math.round(e/ze)*ze),[e,a]}la.invert=la;function fi(e,a,r){return(e%=ze)?a||r?sa(an(e),nn(a,r)):an(e):a||r?nn(a,r):la}function tn(e){return function(a,r){return a+=e,te(a)>V&&(a-=Math.round(a/ze)*ze),[a,r]}}function an(e){var a=tn(e);return a.invert=tn(-e),a}function nn(e,a){var r=ie(e),n=se(e),o=ie(a),i=se(a);function l(s,p){var u=ie(p),c=ie(s)*u,d=se(s)*u,m=se(p),b=m*r+c*n;return[ft(d*o-b*i,c*r-m*n),mt(b*o+d*i)]}return l.invert=function(s,p){var u=ie(p),c=ie(s)*u,d=se(s)*u,m=se(p),b=m*o-d*i;return[ft(d*o+m*i,c*r+b*n),mt(b*r-c*n)]},l}function mi(e,a,r,n,o,i){if(r){var l=ie(a),s=se(a),p=n*r;o==null?(o=a+n*ze,i=a-p/2):(o=rn(l,o),i=rn(l,i),(n>0?o<i:o>i)&&(o+=n*ze));for(var u,c=o;n>0?c>i:c<i;c-=p)u=oa([l,-s*ie(c),-s*se(c)]),e.point(u[0],u[1])}}function rn(e,a){a=Je(a),a[0]-=e,ia(a);var r=ui(-a[1]);return((-a[2]<0?-r:r)+ze-J)%ze}function Pn(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Ee,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function At(e,a){return te(e[0]-a[0])<J&&te(e[1]-a[1])<J}function Nt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Dn(e,a,r,n,o){var i=[],l=[],s,p;if(e.forEach(function(f){if(!((v=f.length-1)<=0)){var v,h=f[0],x=f[v],y;if(At(h,x)){if(!h[2]&&!x[2]){for(o.lineStart(),s=0;s<v;++s)o.point((h=f[s])[0],h[1]);o.lineEnd();return}x[0]+=2*J}i.push(y=new Nt(h,f,null,!0)),l.push(y.o=new Nt(h,null,y,!1)),i.push(y=new Nt(x,f,null,!1)),l.push(y.o=new Nt(x,null,y,!0))}}),!!i.length){for(l.sort(a),on(i),on(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var u=i[0],c,d;;){for(var m=u,b=!0;m.v;)if((m=m.n)===u)return;c=m.z,o.lineStart();do{if(m.v=m.o.v=!0,m.e){if(b)for(s=0,p=c.length;s<p;++s)o.point((d=c[s])[0],d[1]);else n(m.x,m.n.x,1,o);m=m.n}else{if(b)for(c=m.p.z,s=c.length-1;s>=0;--s)o.point((d=c[s])[0],d[1]);else n(m.x,m.p.x,-1,o);m=m.p}m=m.o,c=m.z,b=!b}while(!m.v);o.lineEnd()}}}function on(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Kt(e){return te(e[0])<=V?e[0]:pi(e[0])*((te(e[0])+V)%ze-V)}function xi(e,a){var r=Kt(a),n=a[1],o=se(n),i=[se(r),-ie(r),0],l=0,s=0,p=new Ye;o===1?n=Ce+J:o===-1&&(n=-Ce-J);for(var u=0,c=e.length;u<c;++u)if(m=(d=e[u]).length)for(var d,m,b=d[m-1],f=Kt(b),v=b[1]/2+Xa,h=se(v),x=ie(v),y=0;y<m;++y,f=w,h=S,x=L,b=j){var j=d[y],w=Kt(j),N=j[1]/2+Xa,S=se(N),L=ie(N),P=w-f,z=P>=0?1:-1,k=z*P,A=k>V,T=h*S;if(p.add(ft(T*z*se(k),x*L+T*ie(k))),l+=A?P+z*ze:P,A^f>=r^w>=r){var q=Lt(Je(b),Je(j));ia(q);var R=Lt(i,q);ia(R);var E=(A^P>=0?-1:1)*mt(R[2]);(n>E||n===E&&(q[0]||q[1]))&&(s+=A^P>=0?1:-1)}}return(l<-J||l<J&&p<-1e-12)^s&1}function In(e,a,r,n){return function(o){var i=a(o),l=Pn(),s=a(l),p=!1,u,c,d,m={point:b,lineStart:v,lineEnd:h,polygonStart:function(){m.point=x,m.lineStart=y,m.lineEnd=j,c=[],u=[]},polygonEnd:function(){m.point=b,m.lineStart=v,m.lineEnd=h,c=Fn(c);var w=xi(u,n);c.length?(p||(o.polygonStart(),p=!0),Dn(c,gi,w,r,o)):w&&(p||(o.polygonStart(),p=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),p&&(o.polygonEnd(),p=!1),c=u=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(w,N){e(w,N)&&o.point(w,N)}function f(w,N){i.point(w,N)}function v(){m.point=f,i.lineStart()}function h(){m.point=b,i.lineEnd()}function x(w,N){d.push([w,N]),s.point(w,N)}function y(){s.lineStart(),d=[]}function j(){x(d[0][0],d[0][1]),s.lineEnd();var w=s.clean(),N=l.result(),S,L=N.length,P,z,k;if(d.pop(),u.push(d),d=null,!!L){if(w&1){if(z=N[0],(P=z.length-1)>0){for(p||(o.polygonStart(),p=!0),o.lineStart(),S=0;S<P;++S)o.point((k=z[S])[0],k[1]);o.lineEnd()}return}L>1&&w&2&&N.push(N.pop().concat(N.shift())),c.push(N.filter(hi))}}return m}}function hi(e){return e.length>1}function gi(e,a){return((e=e.x)[0]<0?e[1]-Ce-J:Ce-e[1])-((a=a.x)[0]<0?a[1]-Ce-J:Ce-a[1])}const sn=In(function(){return!0},bi,yi,[-V,-Ce]);function bi(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,l){var s=i>0?V:-V,p=te(i-a);te(p-V)<J?(e.point(a,r=(r+l)/2>0?Ce:-Ce),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&p>=V&&(te(a-n)<J&&(a-=n*J),te(i-s)<J&&(i-=s*J),r=vi(a,r,i,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function vi(e,a,r,n){var o,i,l=se(e-r);return te(l)>J?di((se(a)*(i=ie(n))*se(r)-se(n)*(o=ie(a))*se(e))/(o*i*l)):(a+n)/2}function yi(e,a,r,n){var o;if(e==null)o=r*Ce,n.point(-V,o),n.point(0,o),n.point(V,o),n.point(V,0),n.point(V,-o),n.point(0,-o),n.point(-V,-o),n.point(-V,0),n.point(-V,o);else if(te(e[0]-a[0])>J){var i=e[0]<a[0]?V:-V;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function wi(e){var a=ie(e),r=2*je,n=a>0,o=te(a)>J;function i(c,d,m,b){mi(b,e,r,m,c,d)}function l(c,d){return ie(c)*ie(d)>a}function s(c){var d,m,b,f,v;return{lineStart:function(){f=b=!1,v=1},point:function(h,x){var y=[h,x],j,w=l(h,x),N=n?w?0:u(h,x):w?u(h+(h<0?V:-V),x):0;if(!d&&(f=b=w)&&c.lineStart(),w!==b&&(j=p(d,y),(!j||At(d,j)||At(y,j))&&(y[2]=1)),w!==b)v=0,w?(c.lineStart(),j=p(y,d),c.point(j[0],j[1])):(j=p(d,y),c.point(j[0],j[1],2),c.lineEnd()),d=j;else if(o&&d&&n^w){var S;!(N&m)&&(S=p(y,d,!0))&&(v=0,n?(c.lineStart(),c.point(S[0][0],S[0][1]),c.point(S[1][0],S[1][1]),c.lineEnd()):(c.point(S[1][0],S[1][1]),c.lineEnd(),c.lineStart(),c.point(S[0][0],S[0][1],3)))}w&&(!d||!At(d,y))&&c.point(y[0],y[1]),d=y,b=w,m=N},lineEnd:function(){b&&c.lineEnd(),d=null},clean:function(){return v|(f&&b)<<1}}}function p(c,d,m){var b=Je(c),f=Je(d),v=[1,0,0],h=Lt(b,f),x=kt(h,h),y=h[0],j=x-y*y;if(!j)return!m&&c;var w=a*x/j,N=-a*y/j,S=Lt(v,h),L=jt(v,w),P=jt(h,N);Gt(L,P);var z=S,k=kt(L,z),A=kt(z,z),T=k*k-A*(kt(L,L)-1);if(!(T<0)){var q=Ge(T),R=jt(z,(-k-q)/A);if(Gt(R,L),R=oa(R),!m)return R;var E=c[0],M=d[0],$=c[1],K=d[1],Q;M<E&&(Q=E,E=M,M=Q);var pe=M-E,le=te(pe-V)<J,U=le||pe<J;if(!le&&K<$&&(Q=$,$=K,K=Q),U?le?$+K>0^R[1]<(te(R[0]-E)<J?$:K):$<=R[1]&&R[1]<=K:pe>V^(E<=R[0]&&R[0]<=M)){var W=jt(z,(-k+q)/A);return Gt(W,L),[R,oa(W)]}}}function u(c,d){var m=n?e:V-e,b=0;return c<-m?b|=1:c>m&&(b|=2),d<-m?b|=4:d>m&&(b|=8),b}return In(l,s,i,n?[0,-e]:[-V,e-V])}function ki(e,a,r,n,o,i){var l=e[0],s=e[1],p=a[0],u=a[1],c=0,d=1,m=p-l,b=u-s,f;if(f=r-l,!(!m&&f>0)){if(f/=m,m<0){if(f<c)return;f<d&&(d=f)}else if(m>0){if(f>d)return;f>c&&(c=f)}if(f=o-l,!(!m&&f<0)){if(f/=m,m<0){if(f>d)return;f>c&&(c=f)}else if(m>0){if(f<c)return;f<d&&(d=f)}if(f=n-s,!(!b&&f>0)){if(f/=b,b<0){if(f<c)return;f<d&&(d=f)}else if(b>0){if(f>d)return;f>c&&(c=f)}if(f=i-s,!(!b&&f<0)){if(f/=b,b<0){if(f>d)return;f>c&&(c=f)}else if(b>0){if(f<c)return;f<d&&(d=f)}return c>0&&(e[0]=l+c*m,e[1]=s+c*b),d<1&&(a[0]=l+d*m,a[1]=s+d*b),!0}}}}}var st=1e9,St=-st;function ji(e,a,r,n){function o(u,c){return e<=u&&u<=r&&a<=c&&c<=n}function i(u,c,d,m){var b=0,f=0;if(u==null||(b=l(u,d))!==(f=l(c,d))||p(u,c)<0^d>0)do m.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+d+4)%4)!==f);else m.point(c[0],c[1])}function l(u,c){return te(u[0]-e)<J?c>0?0:3:te(u[0]-r)<J?c>0?2:1:te(u[1]-a)<J?c>0?1:0:c>0?3:2}function s(u,c){return p(u.x,c.x)}function p(u,c){var d=l(u,1),m=l(c,1);return d!==m?d-m:d===0?c[1]-u[1]:d===1?u[0]-c[0]:d===2?u[1]-c[1]:c[0]-u[0]}return function(u){var c=u,d=Pn(),m,b,f,v,h,x,y,j,w,N,S,L={point:P,lineStart:T,lineEnd:q,polygonStart:k,polygonEnd:A};function P(E,M){o(E,M)&&c.point(E,M)}function z(){for(var E=0,M=0,$=b.length;M<$;++M)for(var K=b[M],Q=1,pe=K.length,le=K[0],U,W,H=le[0],_=le[1];Q<pe;++Q)U=H,W=_,le=K[Q],H=le[0],_=le[1],W<=n?_>n&&(H-U)*(n-W)>(_-W)*(e-U)&&++E:_<=n&&(H-U)*(n-W)<(_-W)*(e-U)&&--E;return E}function k(){c=d,m=[],b=[],S=!0}function A(){var E=z(),M=S&&E,$=(m=Fn(m)).length;(M||$)&&(u.polygonStart(),M&&(u.lineStart(),i(null,null,1,u),u.lineEnd()),$&&Dn(m,s,E,i,u),u.polygonEnd()),c=u,m=b=f=null}function T(){L.point=R,b&&b.push(f=[]),N=!0,w=!1,y=j=NaN}function q(){m&&(R(v,h),x&&w&&d.rejoin(),m.push(d.result())),L.point=P,w&&c.lineEnd()}function R(E,M){var $=o(E,M);if(b&&f.push([E,M]),N)v=E,h=M,x=$,N=!1,$&&(c.lineStart(),c.point(E,M));else if($&&w)c.point(E,M);else{var K=[y=Math.max(St,Math.min(st,y)),j=Math.max(St,Math.min(st,j))],Q=[E=Math.max(St,Math.min(st,E)),M=Math.max(St,Math.min(st,M))];ki(K,Q,e,a,r,n)?(w||(c.lineStart(),c.point(K[0],K[1])),c.point(Q[0],Q[1]),$||c.lineEnd(),S=!1):$&&(c.lineStart(),c.point(E,M),S=!1)}y=E,j=M,w=$}return L}}const ca=e=>e;var Qt=new Ye,da=new Ye,Bn,$n,pa,ua,Pe={point:Ee,lineStart:Ee,lineEnd:Ee,polygonStart:function(){Pe.lineStart=Ni,Pe.lineEnd=Ci},polygonEnd:function(){Pe.lineStart=Pe.lineEnd=Pe.point=Ee,Qt.add(te(da)),da=new Ye},result:function(){var e=Qt/2;return Qt=new Ye,e}};function Ni(){Pe.point=Si}function Si(e,a){Pe.point=_n,Bn=pa=e,$n=ua=a}function _n(e,a){da.add(ua*e-pa*a),pa=e,ua=a}function Ci(){_n(Bn,$n)}var Ze=1/0,Rt=Ze,xt=-Ze,Mt=xt,Ot={point:Ei,lineStart:Ee,lineEnd:Ee,polygonStart:Ee,polygonEnd:Ee,result:function(){var e=[[Ze,Rt],[xt,Mt]];return xt=Mt=-(Rt=Ze=1/0),e}};function Ei(e,a){e<Ze&&(Ze=e),e>xt&&(xt=e),a<Rt&&(Rt=a),a>Mt&&(Mt=a)}var fa=0,ma=0,lt=0,qt=0,Ft=0,Qe=0,xa=0,ha=0,ct=0,Un,Vn,Le,Re,Se={point:We,lineStart:ln,lineEnd:cn,polygonStart:function(){Se.lineStart=Ti,Se.lineEnd=Li},polygonEnd:function(){Se.point=We,Se.lineStart=ln,Se.lineEnd=cn},result:function(){var e=ct?[xa/ct,ha/ct]:Qe?[qt/Qe,Ft/Qe]:lt?[fa/lt,ma/lt]:[NaN,NaN];return fa=ma=lt=qt=Ft=Qe=xa=ha=ct=0,e}};function We(e,a){fa+=e,ma+=a,++lt}function ln(){Se.point=zi}function zi(e,a){Se.point=Ai,We(Le=e,Re=a)}function Ai(e,a){var r=e-Le,n=a-Re,o=Ge(r*r+n*n);qt+=o*(Le+e)/2,Ft+=o*(Re+a)/2,Qe+=o,We(Le=e,Re=a)}function cn(){Se.point=We}function Ti(){Se.point=Ri}function Li(){Hn(Un,Vn)}function Ri(e,a){Se.point=Hn,We(Un=Le=e,Vn=Re=a)}function Hn(e,a){var r=e-Le,n=a-Re,o=Ge(r*r+n*n);qt+=o*(Le+e)/2,Ft+=o*(Re+a)/2,Qe+=o,o=Re*e-Le*a,xa+=o*(Le+e),ha+=o*(Re+a),ct+=o*3,We(Le=e,Re=a)}function Yn(e){this._context=e}Yn.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,ze);break}}},result:Ee};var ga=new Ye,Xt,Wn,Gn,dt,pt,ht={point:Ee,lineStart:function(){ht.point=Mi},lineEnd:function(){Xt&&Kn(Wn,Gn),ht.point=Ee},polygonStart:function(){Xt=!0},polygonEnd:function(){Xt=null},result:function(){var e=+ga;return ga=new Ye,e}};function Mi(e,a){ht.point=Kn,Wn=dt=e,Gn=pt=a}function Kn(e,a){dt-=e,pt-=a,ga.add(Ge(dt*dt+pt*pt)),dt=e,pt=a}let dn,Pt,pn,un;class fn{constructor(a){this._append=a==null?Qn:Oi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==pn||this._append!==Pt){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,pn=n,Pt=this._append,un=this._,this._=o}this._+=un;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Qn(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Oi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Qn;if(a!==dn){const r=10**a;dn=a,Pt=function(o){let i=1;this._+=o[0];for(const l=o.length;i<l;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Pt}function qi(e,a){let r=3,n=4.5,o,i;function l(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Ke(s,o(i))),i.result()}return l.area=function(s){return Ke(s,o(Pe)),Pe.result()},l.measure=function(s){return Ke(s,o(ht)),ht.result()},l.bounds=function(s){return Ke(s,o(Ot)),Ot.result()},l.centroid=function(s){return Ke(s,o(Se)),Se.result()},l.projection=function(s){return arguments.length?(o=s==null?(e=null,ca):(e=s).stream,l):e},l.context=function(s){return arguments.length?(i=s==null?(a=null,new fn(r)):new Yn(a=s),typeof n!="function"&&i.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(i=new fn(r)),l},l.projection(e).digits(r).context(a)}function Ea(e){return function(a){var r=new ba;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ba(){}ba.prototype={constructor:ba,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function za(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ke(r,e.stream(Ot)),a(Ot.result()),n!=null&&e.clipExtent(n),e}function Xn(e,a,r){return za(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],l=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(i-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function Fi(e,a,r){return Xn(e,[[0,0],a],r)}function Pi(e,a,r){return za(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),l=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([l,s])},r)}function Di(e,a,r){return za(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),l=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,s])},r)}var mn=16,Ii=ie(30*je);function xn(e,a){return+a?$i(e,a):Bi(e)}function Bi(e){return Ea({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function $i(e,a){function r(n,o,i,l,s,p,u,c,d,m,b,f,v,h){var x=u-n,y=c-o,j=x*x+y*y;if(j>4*a&&v--){var w=l+m,N=s+b,S=p+f,L=Ge(w*w+N*N+S*S),P=mt(S/=L),z=te(te(S)-1)<J||te(i-d)<J?(i+d)/2:ft(N,w),k=e(z,P),A=k[0],T=k[1],q=A-n,R=T-o,E=y*q-x*R;(E*E/j>a||te((x*q+y*R)/j-.5)>.3||l*m+s*b+p*f<Ii)&&(r(n,o,i,l,s,p,A,T,z,w/=L,N/=L,S,v,h),h.point(A,T),r(A,T,z,w,N,S,u,c,d,m,b,f,v,h))}}return function(n){var o,i,l,s,p,u,c,d,m,b,f,v,h={point:x,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),h.lineStart=N},polygonEnd:function(){n.polygonEnd(),h.lineStart=y}};function x(P,z){P=e(P,z),n.point(P[0],P[1])}function y(){d=NaN,h.point=j,n.lineStart()}function j(P,z){var k=Je([P,z]),A=e(P,z);r(d,m,c,b,f,v,d=A[0],m=A[1],c=P,b=k[0],f=k[1],v=k[2],mn,n),n.point(d,m)}function w(){h.point=x,n.lineEnd()}function N(){y(),h.point=S,h.lineEnd=L}function S(P,z){j(o=P,z),i=d,l=m,s=b,p=f,u=v,h.point=j}function L(){r(d,m,c,b,f,v,i,l,o,s,p,u,mn,n),h.lineEnd=w,w()}return h}}var _i=Ea({point:function(e,a){this.stream.point(e*je,a*je)}});function Ui(e){return Ea({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Vi(e,a,r,n,o){function i(l,s){return l*=n,s*=o,[a+e*l,r-e*s]}return i.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*o]},i}function hn(e,a,r,n,o,i){if(!i)return Vi(e,a,r,n,o);var l=ie(i),s=se(i),p=l*e,u=s*e,c=l/e,d=s/e,m=(s*r-l*a)/e,b=(s*a+l*r)/e;function f(v,h){return v*=n,h*=o,[p*v-u*h+a,r-u*v-p*h]}return f.invert=function(v,h){return[n*(c*v-d*h+m),o*(b-d*v-c*h)]},f}function Hi(e){return Yi(function(){return e})()}function Yi(e){var a,r=150,n=480,o=250,i=0,l=0,s=0,p=0,u=0,c,d=0,m=1,b=1,f=null,v=sn,h=null,x,y,j,w=ca,N=.5,S,L,P,z,k;function A(E){return P(E[0]*je,E[1]*je)}function T(E){return E=P.invert(E[0],E[1]),E&&[E[0]*Fe,E[1]*Fe]}A.stream=function(E){return z&&k===E?z:z=_i(Ui(c)(v(S(w(k=E)))))},A.preclip=function(E){return arguments.length?(v=E,f=void 0,R()):v},A.postclip=function(E){return arguments.length?(w=E,h=x=y=j=null,R()):w},A.clipAngle=function(E){return arguments.length?(v=+E?wi(f=E*je):(f=null,sn),R()):f*Fe},A.clipExtent=function(E){return arguments.length?(w=E==null?(h=x=y=j=null,ca):ji(h=+E[0][0],x=+E[0][1],y=+E[1][0],j=+E[1][1]),R()):h==null?null:[[h,x],[y,j]]},A.scale=function(E){return arguments.length?(r=+E,q()):r},A.translate=function(E){return arguments.length?(n=+E[0],o=+E[1],q()):[n,o]},A.center=function(E){return arguments.length?(i=E[0]%360*je,l=E[1]%360*je,q()):[i*Fe,l*Fe]},A.rotate=function(E){return arguments.length?(s=E[0]%360*je,p=E[1]%360*je,u=E.length>2?E[2]%360*je:0,q()):[s*Fe,p*Fe,u*Fe]},A.angle=function(E){return arguments.length?(d=E%360*je,q()):d*Fe},A.reflectX=function(E){return arguments.length?(m=E?-1:1,q()):m<0},A.reflectY=function(E){return arguments.length?(b=E?-1:1,q()):b<0},A.precision=function(E){return arguments.length?(S=xn(L,N=E*E),R()):Ge(N)},A.fitExtent=function(E,M){return Xn(A,E,M)},A.fitSize=function(E,M){return Fi(A,E,M)},A.fitWidth=function(E,M){return Pi(A,E,M)},A.fitHeight=function(E,M){return Di(A,E,M)};function q(){var E=hn(r,0,0,m,b,d).apply(null,a(i,l)),M=hn(r,n-E[0],o-E[1],m,b,d);return c=fi(s,p,u),L=sa(a,M),P=sa(c,L),S=xn(L,N),R()}function R(){return z=k=null,A}return function(){return a=e.apply(this,arguments),A.invert=a.invert&&T,q()}}function Jn(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Jn.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,l=i*i;r-=o=(r*(1.007226+i*(.015085+l*(-.044475+.028874*i-.005916*l)))-a)/(1.007226+i*(.015085*3+l*(-.044475*7+.028874*9*i-.005916*11*l)))}while(te(o)>J&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Wi(){return Hi(Jn).scale(175.295)}function Gi(e){return e}function Ki(e){if(e==null)return Gi;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var u=2,c=s.length,d=new Array(c);for(d[0]=(a+=s[0])*n+i,d[1]=(r+=s[1])*o+l;u<c;)d[u]=s[u],++u;return d}}function Qi(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Xi(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return gn(e,r)})}:gn(e,a)}function gn(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Ji(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Ji(e,a){var r=Ki(e.transform),n=e.arcs;function o(c,d){d.length&&d.pop();for(var m=n[c<0?~c:c],b=0,f=m.length;b<f;++b)d.push(r(m[b],b));c<0&&Qi(d,f)}function i(c){return r(c)}function l(c){for(var d=[],m=0,b=c.length;m<b;++m)o(c[m],d);return d.length<2&&d.push(d[0]),d}function s(c){for(var d=l(c);d.length<4;)d.push(d[0]);return d}function p(c){return c.map(s)}function u(c){var d=c.type,m;switch(d){case"GeometryCollection":return{type:d,geometries:c.geometries.map(u)};case"Point":m=i(c.coordinates);break;case"MultiPoint":m=c.coordinates.map(i);break;case"LineString":m=l(c.arcs);break;case"MultiLineString":m=c.arcs.map(l);break;case"Polygon":m=p(c.arcs);break;case"MultiPolygon":m=c.arcs.map(p);break;default:return null}return{type:d,coordinates:m}}return u(a)}let Ct=null;function Zi(){return Ct||(Ct=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Xi(r,n),i=Wi().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=qi(i),s=(o.features||[]).filter(u=>{var c;return(((c=u.properties)==null?void 0:c.name)||"")!=="Antarctica"}).map(u=>{var m;const c=((m=u.properties)==null?void 0:m.name)||"",d=l(u)||"";return d?{i2:Pr(c)||null,n:c,d}:null}).filter(u=>!!u);if(!s.length)return null;const p={};for(const[u,c]of Object.entries(Dr)){const d=i(c);d&&(p[u]={x:d[0],y:d[1]})}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p}}catch{return null}})(),Ct)}function es(e){const[a,r]=g.useState(null);return g.useEffect(()=>{if(!e||a)return;let n=!1;return Zi().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const bn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Et(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ts(e,a){const[r,n]=g.useState(1);return g.useEffect(()=>{let o=!0,i=0;const l=()=>{var u;if(!o)return;const p=(u=e.current)==null?void 0:u.getScreenCTM();p&&p.a>0?n(p.a):i=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function as(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:l,lang:s,t:p}=O(),u=g.useRef(null),c=g.useRef(null),d=es(e.continent==="monde"),m=e.continent==="monde"?d:ja.find(k=>k.key===e.continent)||null,b=ts(u,e.continent+":"+e.mapFolded+":"+!!m),[f,v]=g.useState(new Map),[h,x]=g.useState(null);g.useEffect(()=>{const k=u.current;if(!k)return;const A=new Map;k.querySelectorAll("path[data-i2]").forEach(T=>{const q=T.dataset.i2;if(q)try{const R=T.getBBox();R.width>0&&A.set(q,{x:R.x,y:R.y,w:R.width,h:R.height})}catch{}}),v(A)},[e.continent,b,m]);const y=g.useMemo(()=>r.filter(k=>k.cc),[r]),j=g.useMemo(()=>{const k=new Map;return y.forEach(A=>k.set(A.cc,(k.get(A.cc)||0)+1)),k},[y]),w=e.continent==="monde"&&d?d.anchors:null,N=g.useMemo(()=>y.map(k=>{const A=w&&k.cc?w[k.cc]:void 0;if(A){const $=Et(k.name||k.id||""),K=Et((k.id||k.name||"")+"·y");return{d:k,x:A.x+($-.5)*10,y:A.y+(K-.5)*10}}const T=k.cc?f.get(k.cc):void 0;if(!T)return null;const q=Et(k.name||k.id||""),R=Et((k.id||k.name||"")+"·y"),E=(q-.5)*Math.min(T.w*.55,60),M=(R-.5)*Math.min(T.h*.55,60);return{d:k,x:T.x+T.w/2+E,y:T.y+T.h/2+M}}).filter(k=>!!k),[y,f,w]),S=k=>b>0?k/b:k,L=g.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:bn[k],fr:p.plabels[k].toUpperCase(),en:p.plabels[k].toUpperCase(),n:r.filter(A=>A.kind==="target"&&ke(A)===k).length})).filter(k=>k.n>0):Da.map((k,A)=>({...k,n:r.filter(T=>Ia(T)===A).length})),[r,n,p.plabels]),P=i?l.get(i):null,z=P?N.find(k=>k.d.id===P.id):null;return m?t.jsxs("div",{className:"mapzone",ref:c,children:[t.jsxs("svg",{ref:u,viewBox:m.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?m.fr:m.en,onMouseLeave:()=>{x(null),o(null)},children:[t.jsx("g",{children:m.countries.map((k,A)=>t.jsx("g",{className:"ct"+(k.i2&&j.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},A))}),t.jsx("g",{children:N.map(k=>{const A=Da[Ia(k.d)],T=!!he(k.d),q=k.d.kind==="target",R=n&&q?bn[ke(k.d)]:A.c,E=!n&&Ne(k.d);return t.jsxs("g",{className:"co"+(E?" done":""),onMouseEnter:()=>{var K,Q;const M=(K=c.current)==null?void 0:K.getBoundingClientRect(),$=(Q=u.current)==null?void 0:Q.createSVGPoint();if($&&u.current&&M){$.x=k.x,$.y=k.y;const pe=$.matrixTransform(u.current.getScreenCTM());x({x:pe.x-M.left,y:pe.y-M.top,label:k.d.name+" · "+(nt(k.d.cc,s)||k.d.countryLabel||"")})}o(k.d.id)},onMouseLeave:()=>{x(null),o(null)},onClick:()=>{var K;const M=(K=u.current)==null?void 0:K.createSVGPoint();let $=null;if(M&&u.current){M.x=k.x,M.y=k.y;const Q=M.matrixTransform(u.current.getScreenCTM());$={x:Q.x,y:Q.y}}a({type:"popup",id:k.d.id,anchor:$})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:S(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:S(A.px),fill:R,stroke:T?"#DC2626":"#ffffff",strokeWidth:S(T?2.2:1.3)})]},k.d.id||k.d.name)})}),z&&t.jsx("circle",{className:"ring on",cx:z.x,cy:z.y,r:S(13),fill:"none",stroke:"#0F172A",strokeWidth:S(2)})]}),t.jsx("div",{className:"hov"+(h?" on":""),style:h?{left:h.x,top:h.y}:void 0,children:h==null?void 0:h.label}),t.jsx("div",{className:"legend",children:L.map((k,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},A))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:c})}function ns(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function rs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:o,contName:i,lang:l}=O(),s=e.filters,p=g.useMemo(()=>e.continent==="monde"?r:r.filter(f=>f.continent===e.continent),[r,e.continent]),u=f=>p.filter(v=>f!=="country"&&s.country.length&&!s.country.includes(v.cc||"")?!1:Sa(v,s,o,f==="country"?void 0:f)),c=g.useMemo(()=>{const f=u("win"),v=h=>f.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=h).length;return[v(0),v(7),v(30),f.length]},[p,s,o]),d=g.useMemo(()=>s.day?u("win").filter(f=>(f.date||"").slice(0,10)===s.day).length:0,[p,s,o]),m=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),b=(f,v,h,x="fbtn")=>t.jsxs("button",{type:"button",className:x,"aria-expanded":e.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[t.jsx("span",{className:"fl",children:v}),h>0&&t.jsx("span",{className:"n",children:h}),t.jsx("span",{className:"cv",children:"▾"})]},f);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(ns(s.day,l)),t.jsx("b",{children:d})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,v)=>t.jsxs("button",{type:"button","aria-pressed":s.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[n.dates[v],t.jsx("b",{children:c[v]})]},f))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):b("sec",n.fSector,s.sector.length),b("pay",n.fCountry,s.country.length),b("det",n.fEngine,s.engine.length),b("sta",n.fStage,s.stage.length),o&&b("ang","Angle",s.angle.length),o&&b("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),m>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,i),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(m)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(os,{poolFor:u})]})}function os({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=O(),i=a.filters,l=a.openFacet,{title:s,cols:p,options:u}=g.useMemo(()=>{if(l==="sig"){const f=e("signal").filter(x=>he(x)),v=new Map;f.forEach(x=>{const y=x.engine||"";v.set(y,(v.get(y)||0)+1)});const h=[{v:"*",label:n.fpSigAll,n:f.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...ta([...v.keys()],o).map(x=>({v:x,label:Xe(x)+" "+De(x,o),n:v.get(x)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(x)}))];return{title:n.fpSigTitle,cols:2,options:h}}if(l==="sec"){const f=e("sector"),v=new Map;return f.forEach(h=>{h.sector&&v.set(h.sector,(v.get(h.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((h,x)=>x[1]-h[1]).map(([h,x])=>({v:h,label:h,n:x,html:!1,on:i.sector.includes(h)}))}}if(l==="pay"){const f=e("country"),v=new Map;return f.forEach(h=>{h.cc&&v.set(h.cc,(v.get(h.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((h,x)=>x[1]-h[1]).map(([h,x])=>({v:h,label:nt(h,o)||h,n:x,html:!1,on:i.country.includes(h)}))}}if(l==="det"){const f=e("engine"),v=new Map;return f.forEach(h=>{h.engine&&v.set(h.engine,(v.get(h.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ta([...v.keys()],o).map(h=>({v:h,label:Xe(h)+" "+De(h,o)+' <span style="color:var(--dim);font-size:10px">· '+Ir(Br(h),o)+"</span>",n:v.get(h)||0,html:!0,on:i.engine.includes(h)}))}}if(l==="ang"){const f=e("angle"),v=new Map;return f.forEach(h=>{h.angle&&v.set(h.angle,(v.get(h.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((h,x)=>x[1]-h[1]).map(([h,x])=>({v:h,label:h.replace(/[_-]+/g," "),n:x,html:!1,on:i.angle.includes(h)}))}}if(l==="mem"){const f=e("memoLevel"),v=new Map;f.forEach(x=>{if(x.kind==="target"){const y=wa(x);v.set(y,(v.get(y)||0)+1)}});const h=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(x=>({v:String(x),label:h[x],n:v.get(x)||0,html:!1,on:i.memoLevel.includes(x)}))}}const m=e("stage"),b=new Map;return m.forEach(f=>{f.stage&&b.set(f.stage,(b.get(f.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((f,v)=>v[1]-f[1]).map(([f,v])=>({v:f,label:f,n:v,html:!1,on:i.stage.includes(f)}))}},[l,a,o]),c=m=>{if(l==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const f=i.signalEngines.includes(m)?i.signalEngines.filter(v=>v!==m):[...i.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:m})},d=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:d,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:u.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>c(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Zn(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function is(e){var o;const a=[],r=new Set,n=i=>{const l=(i||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function vn({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:l}){const{t:s}=O();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(u=>t.jsx("span",{className:"ch",children:u},u))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function er({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=O(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(vn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(vn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function ss({card:e,onEvaluate:a,onAddAll:r}){var s,p,u;const{t:n}=O(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Zn(e.summary_md||"").map((c,d)=>t.jsx("p",{children:c},d))})]}),t.jsx(er,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((u=e.prospective)==null?void 0:u.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function ls(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function cs({onClose:e,onEvaluate:a,onAddAll:r,bump:n}){const{t:o,token:i,email:l}=O(),[s,p]=g.useState(null),[u,c]=g.useState(null),[d,m]=g.useState(null),[b,f]=g.useState(!1);g.useEffect(()=>{let h=!0;return(async()=>{const x=await zn({email:l,cbToken:i});h&&p(x)})(),()=>{h=!1}},[l,i,n]);const v=h=>{c(h),m(null),f(!0),(async()=>{const x=await $r(h.id);m(x),f(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[u?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{c(null),m(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),u&&t.jsx("span",{className:"ti",children:u.title}),!u&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!u&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(s||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[ls(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),u&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[u.source_url&&t.jsx("a",{href:u.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),u.published&&u.page_url&&t.jsx("a",{href:u.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(u.published?" on":""),children:u.published?o.rsPub:o.rsPriv})]}),b&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!b&&!d&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!b&&d&&t.jsx(ss,{card:d,onEvaluate:a,onAddAll:r})]})]})}const yn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ds(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:l,evalBusy:s,evalCards:p,caps:u,data:c,canWrite:d}=O(),m=a==="client",[b,f]=g.useState(""),[v,h]=g.useState(!1),[x,y]=g.useState(""),[j,w]=g.useState(!1),[N,S]=g.useState(""),[L,P]=g.useState([]),z=g.useRef(!1),[k,A]=g.useState(!1),[T,q]=g.useState(""),[R,E]=g.useState(""),[M,$]=g.useState(!1),[K,Q]=g.useState(0),[pe,le]=g.useState(""),[U,W]=g.useState(null),[H,_]=g.useState(null),[G,ee]=g.useState(!1),[ne,ge]=g.useState(null),[ue,Y]=g.useState(0),Z=g.useRef(!1),be=b.trim()?yn.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,B=g.useMemo(()=>x.split(`
`).map(F=>F.trim()).filter(Boolean).slice(0,15),[x]);g.useEffect(()=>{if(typeof window>"u")return;const F=(new URLSearchParams(window.location.search).get("rs")||"").trim();!F||!/^https?:\/\//i.test(F)||(q(F),A(!0))},[]),g.useEffect(()=>{const F=X=>{var oe;const ae=String(((oe=X.detail)==null?void 0:oe.url)||"").trim();!ae||!/^https?:\/\//i.test(ae)||(q(ae),A(!0))};return window.addEventListener("ppmap:research",F),()=>window.removeEventListener("ppmap:research",F)},[]),g.useEffect(()=>{if(!d){ge(null);return}let F=!0;return(async()=>{const X=await zn({email:n,cbToken:r});F&&ge(X.length)})(),()=>{F=!1}},[d,n,r,ue]);const de=L.length?L:p,re=c.credits,fe=g.useCallback(F=>{const X=F.map(ae=>(ae||"").trim()).filter(Boolean);X.length&&(y(ae=>{const oe=ae.split(`
`).map($e=>$e.trim()).filter(Boolean),qe=new Set(oe.map($e=>$e.toLowerCase())),Ae=X.filter($e=>!qe.has($e.toLowerCase()));return[...oe,...Ae].slice(0,15).join(`
`)}),h(!0))},[]);g.useEffect(()=>{if(!M)return;Q(0);const F=window.setInterval(()=>Q(X=>X+1),1e3);return()=>window.clearInterval(F)},[M]);const Me=()=>{const F=b.trim();F&&(o(null,F),f(""))},ve=async()=>{if(!m){o(null,B[0]||"");return}if(!B.length||j)return;w(!0),z.current=!1;const F=[];for(let X=0;X<B.length&&!z.current;X++){S(e.evaluating(X+1,B.length,B[X]));const ae=await An(r,B[X],"atelier2");if(F.unshift({name:ae.company||B[X],verdict:ae.verdict,reason:ae.reason||"",remaining:ae.remaining??null}),P([...F]),ae.verdict==="quota"){F.unshift({name:"",verdict:"quota",reason:e.quota(B.length-X-1),remaining:0}),P([...F]),y(B.slice(X+1).join(`
`)),S(""),w(!1);return}}S(""),y(z.current?B.slice(F.length).join(`
`):""),w(!1)},Oe=async()=>{var ae;if(Z.current)return;const F=T.trim().replace(/\s+/g,""),X=R.trim();if(!F&&!X){le(e.rsNeed);return}if(!m){o(null,F||X.slice(0,80));return}Z.current=!0,le(""),W(null),_(null),$(!0);try{const oe=await Ur({url:F,text:X,email:n,cbToken:r});if($(!1),!oe||oe.status!=="success"){le((oe==null?void 0:oe.message)||"Erreur");return}W(oe),A(!1),fe((((ae=oe.prospective)==null?void 0:ae.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),_({state:"pending"});const qe=await Vr(oe,{email:n,cbToken:r});_(qe.ok?{state:"ok"}:{state:"fail",msg:qe.error||""}),qe.ok&&Y(Ae=>Ae+1)}finally{Z.current=!1,$(!1)}},Ie=[U==null?void 0:U.industry,...(U==null?void 0:U.market_tags)||[],U==null?void 0:U.author].map(F=>(F||"").trim()).filter(Boolean),ye=(H==null?void 0:H.state)==="pending",Be=H&&(ye?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):H.state==="ok"?t.jsx("span",{className:"rslink ok",children:e.rsSaved}):t.jsx("span",{className:"rslink fail",title:H.msg,children:e.rsSaveFail})),_t=is(U).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:b,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:F=>f(F.target.value),onKeyDown:F=>{F.key==="Enter"&&Me()}}),t.jsx("span",{className:"detect"+(yn.test(b.trim())?" url":""),children:be})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:Me,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),u.showCredits&&re&&t.jsxs("button",{type:"button",className:"credits"+(re.total_available<=0&&!re.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:re.unlimited?"∞":re.total_available}),!re.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",re.daily_grant+re.purchased]}),re.total_available<=0&&!re.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>h(!v),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(k?" on":""),onClick:()=>A(!k),children:e.rsOpen}),ne!==null&&ne>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(G?" on":""),onClick:()=>ee(!G),children:e.rsArchOpen(ne)})]}),G&&t.jsx(cs,{bump:ue,onClose:()=>ee(!1),onEvaluate:F=>o(null,F),onAddAll:fe}),k&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:T,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:F=>q(F.target.value),onKeyDown:F=>{F.key==="Enter"&&Oe()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:R,placeholder:e.rsTextPh,onChange:F=>E(F.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(M?" loading":""),style:{justifyContent:"center"},disabled:M||ye||!T.trim()&&!R.trim(),onClick:()=>{Oe()},children:[t.jsx("span",{className:"fill"}),M?`${_r(T.trim())==="youtube"&&T.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(K)}`:ye?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),pe&&t.jsx("div",{className:"rserr",children:pe}),U&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:U.title}),U.source_url&&t.jsx("a",{href:U.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{W(null),_(null)},children:"×"})]}),U.market&&t.jsx("p",{className:"rsmk",children:U.market}),Ie.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Ie.map(F=>t.jsx("span",{children:F},F))]}),t.jsxs("div",{className:"rsbody",children:[U.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${U.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Zn(U.summary_md||"").map((F,X)=>t.jsx("p",{children:F},X))})]}),t.jsx(er,{card:U,onEvaluate:F=>o(null,F),onAddAll:fe}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(_t)}),Be]})]}),v&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:x,placeholder:e.bulkPh,onChange:F=>y(F.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(j?" loading":""),style:{justifyContent:"center"},disabled:j||!B.length,onClick:()=>{ve()},children:[t.jsx("span",{className:"fill"}),j&&N?N:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(B.length)})]})]}),de.slice(0,1).map((F,X)=>{const ae=F.verdict==="kept",oe=F.verdict==="quota",qe=ae?"var(--brand)":oe?"var(--bolt)":"var(--red)",Ae=ae?"var(--brand-l)":oe?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":qe,"--bgc":Ae},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ae?"✓ "+e.kept:oe?"⏳":"✗ "+e.dropped})}),F.name&&t.jsx("span",{className:"rn",children:F.name}),t.jsx("span",{className:"rr",children:F.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",F.reason]}):null}),!oe&&t.jsx("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"space"}),children:e.seeSpace(ae?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},X)}),m&&(i.kept+i.dropped>0||de.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function ps(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function us(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=O(),i=e.memoConsole?r.get(e.memoConsole):null,l=g.useMemo(()=>i?[i.reasoning||"",ps(i.summary||"")].filter(Boolean).join(`
...
`)}`}function Ls(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Rs=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Te({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Ms({o:e,qa:a}){const{t:r,lang:n,fund:o}=O(),i=(e.cribleStatus||"").trim().toUpperCase()||(Bt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=at(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Te,{k:r.cdSector,v:e.sector}),t.jsx(Te,{k:r.cdStage,v:e.stage}),t.jsx(Te,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Te,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Te,{k:r.cdName,v:e.contactName}),t.jsx(Te,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Te,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Te,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Te,{k:r.cdAngle,v:e.angle}),t.jsx(Te,{k:r.cdDetected,v:Rs(e.date,n)})]}),p.some(([,u])=>u)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,u])=>u).map(([u,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:u}),t.jsx("p",{children:c})]},u))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Os(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:l}=O(),[s,p]=g.useState({}),u=25,c=g.useMemo(()=>n.slice(0,u),[n]);g.useEffect(()=>{c.length&&Qr(r,c.map(b=>b.name)).then(p)},[r,c]);const d=i.stats,m=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),d&&typeof d.screened=="number"&&t.jsxs("p",{children:[m(d.screened)," ",e.funScreened(""),typeof d.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",m(d.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(m(i.marketEstimate)),", ",Math.round(d.screened/i.marketEstimate*100)," %"]})]})]}),c.map(b=>t.jsx(Ms,{o:b,qa:s[b.name]},b.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const qs=50;function La({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=O(),[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,c]=g.useState(""),[d,m]=g.useState(0),[b,f]=g.useState(""),[v,h]=g.useState(!1),x=g.useRef(null);g.useEffect(()=>()=>{x.current&&window.clearInterval(x.current)},[]);const y=async w=>{p(!0),c("");const N=await a();if(p(!1),N.ok){l(N);return}if(N.busy){c(o.alertPreviewBusy);return}if(!w){c(o.alertPreviewFail);return}m(qs),x.current=window.setInterval(()=>{m(S=>S>1?S-1:(x.current&&window.clearInterval(x.current),y(!1),0))},1e3)},j=async()=>{if(n||v)return;h(!0),f("");const w=await r();h(!1),f(w.ok?o.alertTestOk(w.sentTo||""):w.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||d>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v,onClick:()=>{j()},children:v?"…":o.alertTest})]}),d>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(d)}),u&&t.jsx("p",{className:"mnote warn",children:u}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const ut="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function we({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=O();return tt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Fs(){const{st:e}=O();switch(e.modal){case"chain":return t.jsx(Ds,{});case"space":return t.jsx(Is,{});case"alert":return t.jsx(Bs,{});case"queue":return t.jsx(Hs,{});case"export":return t.jsx(Ys,{});case"plug":return t.jsx(Ks,{});case"recharge":return t.jsx(Xs,{});case"cover":return t.jsx(Zs,{});case"dossier":return t.jsx(Js,{});case"crit":return t.jsx(el,{});case"tuto":return t.jsx(tl,{});case"rdv":return t.jsx(Ps,{});case"memoalert":return t.jsx(Ws,{});default:return null}}function Ps(){const{dispatch:e,fund:a}=O(),r=typeof document<"u"&&!!document.getElementById("rdv");return g.useEffect(()=>{r&&(e({type:"modal",modal:null}),Uo())},[r,e]),r?null:t.jsx(Zr,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Ds(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:l,evalBusy:s}=O(),p=i==="client",u=e.chain.queue.map(b=>r.get(b)).filter(b=>!!b),c=e.chain.idx,d=u[c],m=c>=u.length;return tt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:m?n.finished:`${c+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(m?100:c/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:m||!d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:d.name}),t.jsx("div",{className:"sub",children:[nt(d.cc,o)||d.countryLabel,d.sector,d.stage,n.daysAgo(et(d.date))].filter(Boolean).map(b=>String(b).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:De(d.engine,o).toUpperCase()}),typeof d.amountEur=="number"&&d.amountEur>0&&t.jsx("span",{children:It(d.amountEur,o)})]}),he(d)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(rt,{o:d,lg:!0})," ",t.jsx($t,{o:d,src:!0})]}),(d.tagline||d.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:d.tagline||d.headline})]}),d.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:d.reasoning})]}),p&&Ne(d)&&t.jsxs("div",{className:"vbox",style:{"--c":He(d)==="retenu"?"var(--brand)":He(d)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:He(d)==="retenu"?"✓ "+n.kept:He(d)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:d.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!m&&d&&!(p&&Ne(d))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(d)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(m?{type:"modal",modal:null}:{type:"chainNext"}),children:m?n.closeBtn:n.skip})]})]})})}),document.body)}function Is(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=O(),i=o==="client",l=g.useMemo(()=>i?r.filter(d=>Ne(d)):[],[r,i]),s=g.useMemo(()=>Ca(l.filter(d=>He(d)==="retenu"),{key:"signal",dir:-1}),[l]),p=g.useMemo(()=>l.filter(d=>He(d)==="ecarte"),[l]),u=e.spaceTab==="retenu"?s:p,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(we,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),u.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),u.slice(0,40).map(d=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof d.score=="number"&&d.score>0?d.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:d.name}),t.jsx("div",{className:"rr",children:d.reasoning||d.tagline||""})]})]},d.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Bs(){const{mode:e}=O();return e==="client"||e==="apercu"?t.jsx($s,{}):t.jsx(Vs,{})}function $s(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=O(),[i,l]=g.useState("d"),s=o!=="client";return t.jsxs(we,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(_s,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(Us,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(nr,{})]})}function _s({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,c]=g.useState(0);g.useEffect(()=>{let f=!0;return p(!1),Ua(a).then(v=>{f&&(v?l(v):p(!0))}),()=>{f=!1}},[a,u]);const d=f=>{r||Ua(a,f).then(v=>{if(!v){o(e.actErr);return}l(v),v.throttled?o(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=f=>!i.sections||i.sections.includes(f),b=f=>{const v=i.sections||e.alertSec.map(([h])=>h);d({sections:m(f)?v.filter(h=>h!==f):[...v,f]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>d({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>d({hour:Math.max(6,(i.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[i.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.min(21,(i.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>d({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>d({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([f,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:m(f),disabled:r,onChange:()=>b(f)}),t.jsxs("span",{children:[v,f==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},f))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(La,{label:e.alertPreview,readOnly:r,onPreview:()=>io(a),onTest:()=>oo(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Us({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,c]=g.useState(0);g.useEffect(()=>{let f=!0;return p(!1),Va(a).then(v=>{f&&(v?l(v):p(!0))}),()=>{f=!1}},[a,u]);const d=f=>{r||Va(a,f).then(v=>{if(!v){o(e.actErr);return}l(v),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>d({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:m,disabled:r,onChange:f=>d({dow:Number(f.target.value)}),children:e.alertDow.map((f,v)=>t.jsx("option",{value:v,children:f},f))}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx(La,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>lo(a),onTest:()=>so(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function nr(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=O(),[l,s]=g.useState(i||""),[p,u]=g.useState(!1),[c,d]=g.useState(!1);g.useEffect(()=>{i&&s(i)},[i]);const m=e.filters,b=g.useMemo(()=>n.filter(x=>he(x)).length,[n]),f=m.win==="1"?0:m.win==="7"?1:m.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(l)||c)){d(!0);try{await fetch(`${ya}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:m.sector,countries:m.country,source:i?"atelier2-client":"atelier2",website:""})}),u(!0)}finally{d(!1)}}},h=[[a.amRows.continent,o],[a.amRows.since,a.amSince[f]],[a.amRows.signal,m.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,m.engine.length?m.engine.map(x=>De(x,r)).join(", "):a.amAllEngines],[a.amRows.sectors,m.sector.length?m.sector.join(", "):a.amAllSectors],[a.amRows.countries,m.country.length?m.country.map(x=>nt(x,r)||x).join(", "):a.amAllCountries],[a.amRows.stages,m.stage.length?m.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:h.map(([x,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:x}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},x))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!i,onChange:x=>s(x.target.value),onKeyDown:x=>{x.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Vs(){const{t:e}=O();return t.jsx(we,{title:e.alertTitle,icon:"🔔",children:t.jsx(nr,{})})}function Hs(){var v,h,x;const{t:e,token:a,fund:r,mode:n,flash:o}=O(),[i,l]=g.useState(null),[s,p]=g.useState([]),[u,c]=g.useState(0),d=n==="client";g.useEffect(()=>{let y=!0;return(async()=>{const[j,w]=await Promise.all([ka(r),En(a)]);y&&(j&&l(j),p(w))})(),()=>{y=!1}},[a,r,u]);const m=(i==null?void 0:i.per_day)??2,b=((v=i==null?void 0:i.analyzed_today)==null?void 0:v.length)??0,f=(h=i==null?void 0:i.tomorrow)!=null&&h.length?i.tomorrow:((i==null?void 0:i.pool_meta)||[]).slice(0,10);return t.jsxs(we,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(b,b+(((x=i==null?void 0:i.pool_order)==null?void 0:x.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(m)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),d&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{_a(a,y.company,"retry").then(()=>c(j=>j+1))},children:e.queueRetry}),d&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{_a(a,y.company,"delete").then(()=>c(j=>j+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[f.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),f.slice(0,10).map((y,j)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",j+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Ys(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:l}=O(),s=`${ut}/cibles/list.csv?token=${a}`,p=`${ut}/cibles/list.json?token=${a}`,u=`${ut}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,d=h=>{var x;(x=navigator.clipboard)==null||x.writeText(h).then(()=>r(e.exportCopied))},m=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:u,href:u}],b=!o.lockActions&&n.length>0,f=()=>{Ls(Ts(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:h=>(e.stg.find(([x])=>x===h)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(we,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:f,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:m.map(({def:h,value:x,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:h[0]}),t.jsxs("div",{children:[t.jsx("b",{children:h[1]}),t.jsx("p",{children:h[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d(x),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},h[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Ws(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=O(),i=o!=="client",[l,s]=g.useState(null),[p,u]=g.useState(!1),[c,d]=g.useState(0),[m,b]=g.useState(!1);g.useEffect(()=>{let x=!0;return u(!1),$a(a).then(y=>{x&&(y?s(y):u(!0))}),()=>{x=!1}},[a,c]);const f=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=x=>{if(i||!l)return;const y={enabled:x.enabled??!!l.enabled,email:x.email??(l.email||""),sections:x.sections??f()};b(!0),$a(a,y).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(p)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(x=>x+1),children:e.retry})]})});if(!l)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const h=f();return t.jsxs(we,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:i||m,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Gs,{value:l.email||"",readOnly:i||m,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:x=>v({email:x})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([x,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!h[x],disabled:i||m,onChange:()=>v({sections:{...h,[x]:!h[x]}})}),t.jsx("span",{children:y})]},x))}),t.jsx(La,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Jr(a,h),onTest:()=>Xr(a,h)})]})}function Gs({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,l]=g.useState(e);g.useEffect(()=>{l(e)},[e]);const s=i.trim()!==e.trim(),p=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:u=>l(u.target.value),onKeyDown:u=>{u.key==="Enter"&&s&&p&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>o(i.trim()),children:n})]})]})}function Ks(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=O(),[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,c]=g.useState(null),[d,m]=g.useState(""),[b,f]=g.useState(0);g.useEffect(()=>{let x=!0;return p(!1),aa(a).then(y=>{x&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),to(a).then(y=>{x&&c(y)}),()=>{x=!1}},[a,b]);const v=(x,y)=>{o&&aa(a,x).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}x.test&&j.sent===!1?n(e.plugTestThrottled):r(y),f(w=>w+1)})},h='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(we,{title:e.plugTitle,icon:"🔌",wide:!0,children:[u&&t.jsx("p",{className:"mnote"+(u.enabled?" warn":""),children:u.enabled?e.plugAutoOn(u.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(x=>x+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:d,disabled:!o,onChange:x=>m(x.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!d.trim(),onClick:()=>v({url:d.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(Qs,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var x;(x=navigator.clipboard)==null||x.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function Qs(){const{t:e,token:a,lang:r}=O(),[n,o]=g.useState("valides"),[i,l]=g.useState(!1),[s,p]=g.useState(null),[u,c]=g.useState(null),[d,m]=g.useState(!1),[b,f]=g.useState(!1),[v,h]=g.useState(null),[x,y]=g.useState(null),[j,w]=g.useState(null),N=`atl2:bulk:${a}:${n}`;g.useEffect(()=>{aa(a).then(T=>{y(T&&T.configured?T.url_hint||"webhook":null)})},[a]),g.useEffect(()=>{p(null),c(null),m(!1),h(null);try{const T=JSON.parse(localStorage.getItem(N)||"null");w(T&&Date.now()-Date.parse(T.t)<24*3600*1e3?T:null)}catch{w(null)}},[N]);const S=async()=>{l(!0),m(!1),h(null);const T=await no(a,n);p(T),c(T.ok?n:null),l(!1)},L=g.useRef(!1),P=async()=>{if(L.current)return;L.current=!0,f(!0);const T=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let q;try{q=await ro(a,n,"webhook",void 0,T)}finally{L.current=!1}if(f(!1),m(!1),h(q),q.ok&&(q.pushed||0)>0){const R={t:new Date().toISOString(),n:q.pushed||0};w(R);try{localStorage.setItem(N,JSON.stringify(R))}catch{}}},z=s!=null&&s.ok&&s.ready||0,k=!!(s!=null&&s.ok)&&u===n&&z>0&&!!x&&!j,A=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:T=>o(T.target.value),children:e.plugBulkTabs.map(([T,q])=>t.jsx("option",{value:T,children:q},T))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{S()},children:i?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(A,j.n)}),!j&&!!(s!=null&&s.ok)&&!x&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),k&&!d&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>m(!0),children:e.bulkArm}),k&&d&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(z,x||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{P()},children:b?e.bulkSending:e.bulkConfirm(x||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>m(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function Xs(){const{t:e,data:a,lang:r}=O(),n=a.credits,o=a.email,i=async l=>{if(!o)return;const s=window.location.href.split("?")[0];try{const u=await(await fetch(`${ya}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();u.url&&(window.location.href=u.url)}catch{}};return t.jsxs(we,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Js(){const{t:e}=O();return t.jsx(we,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Os,{})})}function Zs(){const{t:e,lang:a,data:r,dossiers:n,token:o,canWrite:i,flash:l}=O(),[s,p]=g.useState(null),[u,c]=g.useState(!1);g.useEffect(()=>{let S=!0;return ka(o).then(L=>{S&&L&&typeof L.per_day=="number"&&p(L.per_day)}),()=>{S=!1}},[o]);const d=r.stats,m=typeof(d==null?void 0:d.screened)=="number"?d.screened:n.filter(S=>S.kind==="target"&&Ne(S)).length,b=r.marketEstimate||0,f=b>0?Math.min(100,Math.round(m/b*100)):null,v=(d==null?void 0:d.window_days)||30,h=m>0?m/v:0,x=b>0?Math.max(0,b-m):0,j=b>0&&h>0&&m>=100?Math.round(x/h):null,w=S=>Math.round(S).toLocaleString(a==="en"?"en-US":"fr-FR"),N=S=>{u||!i||(c(!0),ao(o,S).then(L=>{if(c(!1),L===null){l(e.actErr);return}p(L),l(e.alertSaved)}))};return t.jsxs(we,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(m))}),b>0&&t.jsx("span",{children:e.covOf(w(b))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),j!==null&&t.jsx("p",{className:"mnote",children:e.covEta(j)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),h>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(h))}),d&&t.jsxs("div",{className:"covf",children:[typeof d.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.kept)})," ",e.covKept]}),typeof d.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.analyzed)})," ",e.covAna]}),typeof d.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.shown)})," ",e.covShown]})]}),i&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(S=>t.jsx("button",{type:"button",className:s===S?"on":"",disabled:u,onClick:()=>N(S),children:S===0?"⏸":S},S))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function el(){var x,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i}=O(),l=n==="client",s=g.useMemo(()=>{const w=new Set;return a.forEach(N=>{N.angle&&w.add(N.angle)}),[...w]},[a]),[p,u]=g.useState(null);g.useEffect(()=>{let w=!0;return eo(r).then(N=>{w&&u(N.thumbs)}),()=>{w=!1}},[r]);const[c,d]=g.useState(""),[m,b]=g.useState(""),[f,v]=g.useState(!1),h=async()=>{const w=c.trim();if(!(!w||f||!l)){v(!0),b("");try{const S=await(await fetch(`${ut}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(S.reply&&b(String(S.reply)),S.job_id){b(e.critChatRunning);const L=async()=>{const P=await fetch(`${ut}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:S.job_id})}).then(z=>z.json()).catch(()=>null);if(P&&P.done){b(String(P.reply||P.clarification||P.summary||"✓")),v(!1),P.applied&&o(e.alertSaved);return}setTimeout(()=>{L()},8e3)};setTimeout(()=>{L()},8e3),d("");return}d("")}finally{m.startsWith("⏳")||v(!1)}}};return t.jsxs(we,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((x=i.points)!=null&&x.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var N,S;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((N=w.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(L=>t.jsx("li",{children:L},L))})]}),!!((S=w.out)!=null&&S.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(L=>t.jsx("li",{children:L},L))})]})]})]},w.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!l||f,onChange:w=>d(w.target.value),onKeyDown:w=>{w.key==="Enter"&&h()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!l||f||!c.trim(),onClick:()=>void h(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),m&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:m})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,N)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},N))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(ar[w]||"v-cons"),children:w}),t.jsx("span",{children:N})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",N]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function tl(){const{t:e,dispatch:a,startTour:r}=O(),n=o=>{var i,l;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(we,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+l))})]})}const Zt={},jn=(Zt==null?void 0:Zt.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Dt(){return new Date().toISOString().slice(0,10)}const rr=g.createContext(null);function or(){const e=g.useContext(rr);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function al({token:e,children:a}){const{dispatch:r,st:n,lang:o}=O(),[i,l]=g.useState(()=>n.filters.day||Dt()),[s,p]=g.useState(null),[u,c]=g.useState(!1),d=g.useCallback(f=>{if(/^\d{4}-\d{2}-\d{2}$/.test(f)){l(f);try{r({type:"filters",patch:{day:f,win:"all"}})}catch{}}},[r]);g.useEffect(()=>{n.filters.day||d(Dt())},[]),g.useEffect(()=>{const f=v=>{var x;const h=(x=v.detail)==null?void 0:x.day;typeof h=="string"&&d(h)};return window.addEventListener("pp-edition-day",f),()=>window.removeEventListener("pp-edition-day",f)},[d]),g.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),g.useEffect(()=>{if(!e||!i)return;let f=!1;c(!0);const v=new URLSearchParams({token:e,date:i});return fetch(`${jn}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{f||p(h)}).catch(()=>{f||p({ok:!1,error:"network"})}).finally(()=>{f||c(!1)}),()=>{f=!0}},[e,i]);const m=g.useMemo(()=>`${jn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),b=g.useMemo(()=>({token:e,day:i,ed:s,loading:u,pickDay:d,daysUrl:m,isEn:o==="en"}),[e,i,s,u,d,m,o]);return t.jsx(rr.Provider,{value:b,children:a})}function nl(){const{day:e,daysUrl:a,pickDay:r,isEn:n}=or();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsx("p",{className:"thesis-days__h",children:n?"Thesis brief · pick a day":"Brief thèse · choisir un jour"}),t.jsx(co,{mode:"local",theme:"light",month:e.slice(0,7),current:e,daysUrl:a,onPick:r})]})}function rl(){const{day:e,ed:a,loading:r,pickDay:n,isEn:o}=or(),i=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!i,s=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!i&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),s&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),l&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["No thesis brief for ",t.jsx("b",{children:e})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):t.jsxs(t.Fragment,{children:["Pas encore de brief de thèse pour le ",t.jsx("b",{children:e}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),i&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,i&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,e&&e!==Dt()&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:()=>n(Dt()),children:o?"← Back to today":"← Revenir à aujourd’hui"})]})}const ir="atl2:mapfold",ol=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(ir);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},sr=g.createContext(null),O=()=>{const e=g.useContext(sr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function rt({o:e,lg:a}){const{lang:r}=O(),n=he(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ha(n,r),children:[n.emoji," ",Ha(n,r)]}):null}function $t({o:e,src:a}){const{lang:r,t:n}=O(),o=he(e);if(!o)return null;const i=xo(o),l=ho(o);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Tn(o,r))+" · "+n.win7(Ln(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<i?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function lr({o:e}){const{lang:a}=O(),r=mo(e.cc),n=e.cc?nt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Nn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",cr=e=>`atl2:tour:${e||"anon"}`;function il(e){try{return localStorage.getItem(cr(e))==="1"}catch{return!0}}function Sn(e){try{localStorage.setItem(cr(e),"1")}catch{}}function sl(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function fl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){const{lang:l}=po(),s=No[l],p=Fo(e,l,a),[u,c]=g.useReducer(Do,void 0,()=>Po((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||ol(),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??(a==="ops"?"deplie":void 0),filters:r,modal:n==null?void 0:n.modal})),d=g.useRef(!0);g.useEffect(()=>{if(d.current){d.current=!1;return}if(!e)try{localStorage.setItem(ir,u.mapFolded?"on":"off")}catch{}},[u.mapFolded,e]);const m=g.useRef(i);m.current=i,g.useEffect(()=>{var C;(C=m.current)==null||C.call(m,u.filters)},[u.filters]);const[b,f]=g.useState(null),[v,h]=g.useState(null),[x,y]=g.useState({kept:0,dropped:0}),[j,w]=g.useState(!1),[N,S]=g.useState(""),[L,P]=g.useState(!1),[z,k]=g.useState(null),[A,T]=g.useState(!1),[q,R]=g.useState(!1),[,E]=g.useState(0),M=()=>E(C=>C+1),$=g.useRef([]),K=g.useRef(new Set),Q=g.useRef(new Set),pe=g.useRef(new Map),le=g.useRef(null),{mode:U}=p,W=g.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[p.caps,o,a]),H=W.pipe,_=p.session.token||"",G=U==="client"&&!e;g.useEffect(()=>{if(document.querySelector(`link[href="${Nn}"]`))return;const C=document.createElement("link");C.rel="stylesheet",C.href=Nn,document.head.appendChild(C)},[]);const ee=(C,D=!1)=>{S(C),P(D),le.current&&clearTimeout(le.current),le.current=setTimeout(()=>S(""),D?4200:2400)},ne=C=>ee(C,!0),ge=g.useMemo(()=>{const C=new Map;return p.dossiers.forEach(D=>{D.id&&C.set(D.id,D)}),C},[p.dossiers]),ue=g.useMemo(()=>p.dossiers.filter(C=>On(C,u,H)),[p.dossiers,u,H]),Y=g.useRef(!1);g.useEffect(()=>{if(Y.current||e||p.loading||!p.dossiers.length)return;if(!W.showFunnel||il(p.session.token||"")){Y.current=!0;return}Y.current=!0;const C=window.setTimeout(()=>{Sn(p.session.token||""),T(!0)},700);return()=>window.clearTimeout(C)},[e,p.loading,p.dossiers.length,W.showFunnel,p.session.token]);const Z=g.useMemo(()=>p.dossiers.filter(C=>Io(C,u,H,p.favIds)),[p.dossiers,u,H,p.favIds]),be=g.useMemo(()=>uo(ue,p.favIds),[ue,p.favIds]),B=ja.find(C=>C.key===u.continent),de=u.continent==="monde"?s.contWorld:(l==="fr"?B==null?void 0:B.fr:B==null?void 0:B.en)||"";g.useEffect(()=>{const C=D=>{var ce;const I=(((ce=D.detail)==null?void 0:ce.name)||"").trim();I&&re(null,I)};return window.addEventListener("ppmap:evaluate",C),()=>window.removeEventListener("ppmap:evaluate",C)});const re=(C,D)=>{const I=((C==null?void 0:C.name)||D||"").trim();if(!G){h({kicker:I});return}!I||j||(w(!0),(async()=>{try{const ce=await An(_,I,"atelier2"),gt={name:ce.company||I,verdict:ce.verdict,reason:ce.reason||"",remaining:ce.remaining??null};$.current=[gt,...$.current].slice(0,8),ce.verdict==="kept"&&y(_e=>({..._e,kept:_e.kept+1})),ce.verdict==="ruled_out"&&y(_e=>({..._e,dropped:_e.dropped+1}));const ot=C||p.dossiers.find(_e=>(_e.name||"").toLowerCase()===I.toLowerCase());ot&&(ce.verdict==="kept"?ot.verdict=ot.verdict||"MATCH":ce.verdict==="ruled_out"&&(ot.verdict="NO MATCH"),ce.reason&&(ot.reasoning=ce.reason)),M()}finally{w(!1)}})())},fe=C=>{if(!G){h({kicker:C.name});return}K.current.add(C.id),it(_,"fast_request",C.name||"",""),ee(s.memoInstantSent(C.name)),M()},Me=C=>pe.current.get(C.id)??p.thumbs.get((C.name||"").trim().toLowerCase()),ve=(C,D)=>c({type:"undoPush",entry:{id:C.id,name:C.name,prevCeoStatus:D}}),Oe=async(C,D,I)=>{const ce=C.ceoStatus||"";C.ceoStatus=D,M();const gt=await Ht(_,{status:D,airtable_id:C.airtableId,check_id:C.checkId,company:C.name,...(I==null?void 0:I.note)!==void 0?{note:I.note}:{},...I!=null&&I.via?{via:I.via}:{}});return gt.ok?gt.skipped?(C.ceoStatus=ce,M(),ne(s.actNotPersisted),!1):((I==null?void 0:I.undo)!==!1&&ve(C,ce),I!=null&&I.msg&&ee(I.msg),(D==="Validé"||D==="Écarté")&&!C.ceoNote&&(I==null?void 0:I.note)===void 0&&k({o:C,yes:D==="Validé"}),!0):(C.ceoStatus=ce,M(),ne(s.actErr),!1)},Ie=async(C,D)=>{const I=await Ht(_,{status:C.ceoStatus||"Retenu",airtable_id:C.airtableId,check_id:C.checkId,company:C.name,note:D,via:"note"});return!I.ok||I.skipped?(ne(I.skipped?s.actNotPersisted:s.actErr),!1):(C.ceoNote=D,M(),!0)},ye=g.useRef(new Map),Be=C=>ye.current.has(C.id)?ye.current.get(C.id):p.stages.get((C.name||"").trim().toLowerCase()),_t=(C,D)=>{ye.current.set(C.id,D),M()},F=(C,D)=>{G&&Oe(C,D?"Validé":"Écarté",{msg:D?s.decidedYes(C.name):s.decidedNo(C.name)})},X=C=>{G&&Oe(C,"À trancher",{msg:s.promoted(C.name)})},ae=C=>{G&&(async()=>{const D=C.ceoStatus||"";C.ceoStatus="Retenu",M();const I=await Ht(_,{status:"Retenu",check_id:C.checkId,company:C.name});if(!I.ok||I.skipped){C.ceoStatus=D,M(),ne(I.skipped?s.actNotPersisted:s.actErr);return}ve(C,D),ee(s.repeched(C.name))})()},oe=()=>{const C=u.undo[u.undo.length-1];if(!C){ee(s.undoNone);return}const D=ge.get(C.id);if(!D){c({type:"undoPop"}),ee(s.undoNone);return}let I=C.prevCeoStatus;if(!I)if((D.verdict||"").toUpperCase().includes("CALL"))I="À trancher";else{ee(s.undoLockedTitle);return}(async()=>await Oe(D,I,{undo:!1})&&(c({type:"undoPop"}),D.ceoStatus=C.prevCeoStatus,M(),ee(s.undoDone(D.name))))()},qe=C=>{G&&(Q.current.add(C.id),M(),(async()=>{const D=await go(_,C.name,"email");if(!D||D.ok===!1){Q.current.delete(C.id),M(),ne(s.actErr);return}it(_,"approach",C.name||"",""),ee(s.actApproachSent)})())},Ae=(C,D)=>{G&&(async()=>{if(!(await it(_,D?"yes":"no",C.name||"","")).ok){ne(s.actErr);return}pe.current.set(C.id,D?"yes":"no"),M(),ee(D?s.thumbUpDone:s.thumbDnDone)})()},$e=C=>{!G||!Na(C)||(it(_,"detailed_request",C.name||"",""),ee(s.memoDeepSent(C.name)))},dr=C=>{const D=new Set(p.favIds),I=D.has(C.id);I?D.delete(C.id):D.add(C.id),p.setFavIds(D),G&&bo(_,{id:C.id,co:C.name},I)},pr=()=>{!G||q||window.confirm(s.identSyncConfirm)&&(R(!0),(async()=>{const C=await vo(_);R(!1),C?ee(s.identSyncDone):ne(s.actErr)})())},Ra=/proplace/i.test(p.fund||""),ur=C=>{!G||!Ra||(it(_,"onboard_request",C.name||"",""),ee(s.onboardSent(C.name)))},fr={st:u,dispatch:c,t:s,lang:l,mode:U,caps:W,pipe:H,token:_,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:ae,thumbOf:Me,canWrite:G,commitStatus:Oe,saveNote:Ie,stageOf:Be,setStage:_t,flashErr:ne,startTour:()=>T(!0),dossiers:p.dossiers,scopedAll:ue,scoped:Z,counts:be,byId:ge,contName:de,favIds:p.favIds,toggleFav:dr,askEvaluate:re,doAnalyse:fe,doDecide:F,doPromote:X,doApproach:qe,doThumb:Ae,doDeep:$e,doUndo:oe,doSync:pr,doOnboard:ur,outbound:Ra,memoQueued:K.current,approachDone:Q.current,sessTally:x,evalCards:$.current,evalBusy:j,markRow:f,markedId:b,flash:ee};g.useEffect(()=>{const C=D=>{D.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[]);const mr=C=>_?t.jsx(al,{token:_,children:C}):t.jsx(t.Fragment,{children:C});return t.jsx(sr.Provider,{value:fr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Eo}),t.jsx("style",{children:zo}),mr(t.jsxs("div",{className:"app"+(H?" pipe":"")+(_?" has-thesis":""),children:[W.showTicker&&t.jsx(me,{name:"live",children:t.jsxs("div",{className:"live-stack"+(_?" live-stack--cibles":""),children:[t.jsx(Bo,{}),!!_&&t.jsx(nl,{})]})}),W.showIdent&&t.jsx(me,{name:"identite",children:t.jsx(ni,{})}),W.showOnb&&t.jsx(me,{name:"onboarding",children:t.jsx(ri,{})}),W.showMorning&&t.jsx(me,{name:"matin",children:t.jsx(ai,{})}),t.jsx(me,{name:"fraicheur",children:t.jsx(Go,{})}),t.jsx(me,{name:"mesure",children:t.jsx(Ko,{})}),W.showFunnel&&t.jsx(me,{name:"entonnoir",children:t.jsx(ll,{})}),W.showFunnel&&t.jsx(me,{name:"tunnel",children:t.jsx(ii,{})}),W.showFunnel&&t.jsx(me,{name:"tuto",children:t.jsx(li,{})}),t.jsx(me,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(cl,{}),t.jsxs("div",{className:"stage"+(u.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(as,{}),t.jsx(rs,{})]})]})}),W.showDemand&&t.jsx(me,{name:"evaluation",children:t.jsx(ds,{})}),W.showDemand&&u.memoConsole&&t.jsx(me,{name:"console",children:t.jsx(us,{})}),t.jsx(me,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(zs,{})}),!!_&&t.jsx(me,{name:"edition",children:t.jsx(rl,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),W.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),u.popupId&&t.jsx(me,{name:"fiche",children:t.jsx(xs,{})}),t.jsx(me,{name:"modales",children:t.jsx(Fs,{})}),t.jsx(Ho,{}),z&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:z.o.name}),t.jsx(Zo,{placeholder:z.yes?s.whyYesPh:s.whyNoPh,onDone:C=>{const D=z.o;k(null),C&&Ie(D,C).then(I=>{I&&ee(s.csNoteSaved)})}})]}),A&&t.jsx(ti,{steps:sl(s),onClose:()=>{T(!1),Sn(_)}}),N&&t.jsx("div",{className:"flash on"+(L?" err":""),children:N}),v&&t.jsx(fo,{variant:"acquirer",initialCompany:Cn().co,initialWebsite:Cn().site,onClose:()=>h(null)})]})})}function ll(){const{t:e}=O(),[a,r]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function cl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:o,t:i}=O(),l=g.useMemo(()=>{const s={};return e.forEach(p=>{Sa(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[yo.map(s=>{const p=ja.find(c=>c.key===s),u=s==="monde"?i.contWorld:o==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[u,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?i.showMap:i.hideMap})})]})}function Cn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function dl(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{lr as FlagCell,rt as SigBadge,$t as SigWin,fl as default,dl as fmtShort,O as useV2};
