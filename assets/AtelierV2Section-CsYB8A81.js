...
/* ⚠️ LE FIL N'EST PAS ENFANT DE .app — mesuré : il vit dans .live-stack
   ...
   ils sont dessinés. */
.atl2 .app > .live-stack,.atl2 .app > .ticker{position:sticky;top:var(--pp-gap,68px);z-index:32}
.atl2:has(> .lockbar.on) .app > .live-stack,
.atl2:has(> .lockbar.on) .app > .ticker{top:calc(var(--pp-gap,68px) + 46px)}
body.pp-navfold .atl2 .app > .live-stack{top:26px}
