...
`,ur=8;function fr(){const{t,lang:a,token:n,dossiers:r,caps:i,markRow:o,dispatch:l}=z(),[f,d]=p.useState(!1),[u,h]=p.useState(!1),[s,y]=p.useState(!1),b=n||"home",{names:m,verdicts:x}=p.useMemo(()=>{const v=[],S={};return r.forEach(C=>{C.kind!=="target"||!C.name||(v.push(C.name),S[C.name]=pa(C)||"")}),{names:v,verdicts:S}},[r]),g=p.useMemo(()=>m.length?ua(b,m,x,a):null,[b,m.length]);if(!i.pipe||f||!g||g.firstVisit||!g.added.length&&!g.gone.length)return null;const c=u?g.added:g.added.slice(0,ur),w=g.added.length-c.length,k=v=>{const S=r.find(C=>C.name===v);S&&(o(S.id),l({type:"popup",id:S.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(g.added.length,g.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{d(!0),fa(b,m,x,g.fp,a)},children:"×"})]}),!!g.added.length&&e.jsxs("div",{className:"since-c",children:[c.map(v=>e.jsx("button",{type:"button",onClick:()=>k(v),children:v},v)),w>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>h(!0),children:t.sinceMore(w)})]}),!!g.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>y(v=>!v),children:t.sinceOut(g.gone.length)}),s&&g.gone.slice(0,20).map(v=>e.jsx("span",{className:"gone",children:v},v))]})]})}const Ue=600,fe=62,gt="atl2:fstats";function mr(){const{t,lang:a,data:n,caps:r,st:i,dispatch:o}=z(),[l,f]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(gt)==="on"}catch{return!1}}),d=n.stats,u=p.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]);if(!r.showFunnel||!d||typeof d.screened!="number")return null;const h=w=>a==="en"?w.slice(5,10):`${w.slice(8,10)}/${w.slice(5,7)}`,s=p.useMemo(()=>{if(d!=null&&d.since)return d.since;const w=new Date;return w.setDate(w.getDate()-((d==null?void 0:d.window_days)||30)),w.toISOString().slice(0,10)},[d==null?void 0:d.since,d==null?void 0:d.window_days]),y=w=>w.toLocaleString(a==="en"?"en-US":"fr-FR"),b=u.reduce((w,k)=>Math.max(w,k.s||0),0),m=u.length?Ue/u.length:0,x=Math.max(4,m-4),g=u.length>=5&&b>0,c=[[d.screened,t.funScreened(h(s)),d.screened_today],...typeof d.kept=="number"?[[d.kept,t.funKept,d.kept_today]]:[],...typeof d.analyzed=="number"?[[d.analyzed,t.funAnalyzed,d.analyzed_today]]:[],...typeof d.shown=="number"?[[d.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(l?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[c.map(([w,k,v],S)=>e.jsxs("span",{className:"fst-t",children:[S>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:y(w)}),e.jsx("i",{children:k}),l&&typeof v=="number"&&v>0&&e.jsx("em",{children:t.funToday(v)})]},k)),g&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?t.fstatsHide:t.fstatsShow,onClick:()=>{const w=!l;f(w),w&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(gt,w?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&g&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${Ue} ${fe}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[u.map((w,k)=>{const v=(w.s||0)/b*(fe-4),S=(w.m||0)/b*(fe-4),C=k*m+(m-x)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${h(w.d)} — ${w.s} ${t.actScreened} · ${w.m} ${t.actKept}`}),e.jsx("rect",{x:C,y:fe-2-v,width:x,height:v,fill:"#cfe0d6"}),e.jsx("rect",{x:C,y:fe-2-S,width:x,height:S,fill:"#185c38"})]},w.d)}),e.jsx("line",{x1:0,y1:fe-1.5,x2:Ue,y2:fe-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:h(u[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const xr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function gr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:i}=z(),[o,l]=p.useState(""),[f,d]=p.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const u=(t.ceoStatus||"").trim(),h=(qe(t)||"").startsWith("CALL")&&X(t)===3,s=X(t)>=2,y=async m=>{if(o||m==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(m);const x=await i(t,m);l(""),x&&(d(!0),setTimeout(()=>d(!1),2200))},b=h?[["Validé",a.csYes],["Écarté",a.csNo]]:xr.filter(([m])=>!(s&&m==="Retenu")).map(([m,x])=>[m,a[x]]);return e.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,x])=>e.jsx("button",{type:"button",className:"csb"+(u===m?" on":"")+(o===m?" busy":""),disabled:!!o,onClick:()=>{y(m)},children:x},m)),f&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(hr,{o:t})]})}function hr({o:t}){const{t:a,saveNote:n,flash:r}=z(),[i,o]=p.useState(t.ceoNote||""),[l,f]=p.useState(!1),[d,u]=p.useState(!1),h=i.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(l||!h)return;f(!0);const y=await n(t,i.trim());f(!1),y&&(u(!0),setTimeout(()=>u(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:y=>o(y.target.value),onKeyDown:y=>{y.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:l||!h,onClick:()=>{s()},children:d?a.csNoteSaved:a.csNoteOk})]})}function br({placeholder:t,onDone:a}){const{t:n}=z(),[r,i]=p.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function vr({o:t}){var g;const{t:a,token:n,caps:r,canWrite:i,stageOf:o,setStage:l,flashErr:f}=z(),[d,u]=p.useState(!1);if(!r.pipe||!i||r.lockActions||X(t)!==4)return null;const h=o(t),s=(h==null?void 0:h.stage)||"todo",y=async c=>{if(d||c===s)return;u(!0);const w=h;l(t,{stage:c,stamps:(h==null?void 0:h.stamps)||{}});const k=Math.max(Date.now(),ht+=1);ht=k;const v=await ma(n,{company:t.name||"",stage:c,cts:k,deal_id:t.airtableId,check_id:t.checkId});u(!1),!v.stale&&(v.ok||(l(t,w),f(a.actErr)))},b=(g=h==null?void 0:h.stamps)==null?void 0:g.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,x=s==="sent"&&b&&m>=4;return e.jsxs("div",{className:"stg",onClick:c=>c.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([c,w])=>e.jsx("button",{type:"button",className:"stgb"+(s===c?" on":""),disabled:d,onClick:()=>{y(c)},children:w},c)),x&&e.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let ht=0;const Fe=8,Re=340;function bt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function yr({steps:t,onClose:a}){const{t:n,dispatch:r,counts:i,scoped:o,byId:l,st:f}=z(),[d,u]=p.useState(0),[h,s]=p.useState(null),[y,b]=p.useState([]),m=p.useRef(!1);p.useEffect(()=>{m.current||(m.current=!0,b(t.filter(S=>!!document.querySelector(S.need||S.sel))))},[t]);const x=y[d],g=d>=y.length;p.useEffect(()=>{x&&(x.ptab!==void 0&&f.ptab!==x.ptab&&r({type:"ptab",tab:x.ptab}),x.dens&&f.dens!==x.dens&&r({type:"dens",dens:x.dens}))},[d,x]);const c=p.useCallback(()=>{if(!x){s(null);return}const S=document.querySelector(x.sel);if(!S){s(null);return}S.scrollIntoView({block:"nearest",behavior:"smooth"}),s(S.getBoundingClientRect())},[x]);p.useLayoutEffect(()=>{c();const S=window.setTimeout(c,260),C=()=>c();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{window.clearTimeout(S),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[c]);const w=p.useRef(a);if(w.current=a,p.useEffect(()=>{const S=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),w.current()):C.key==="ArrowRight"?u(F=>F+1):C.key==="ArrowLeft"&&u(F=>Math.max(0,F-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!y.length)return null;let k=null;if(g){const S=i[3]||0,C=o.find(F=>F.memoUrl)||[...l.values()].find(F=>F.memoUrl);S>0?k={title:S===1?n.ahaATitle1:n.ahaATitleN(S),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:C?k={title:n.ahaBTitle,body:n.ahaBBody(C.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:C.id}),a()}}:k={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let v={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Re};if(!g&&h){const S=h.bottom+14,F=window.innerHeight-S>190?S:Math.max(12,h.top-200);v={left:Math.min(Math.max(12,h.left+h.width/2-Re/2),window.innerWidth-Re-12),top:F,width:Re}}return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!g&&h&&e.jsx("div",{className:"tour-hole",style:{left:h.left-Fe,top:h.top-Fe,width:h.width+Fe*2,height:h.height+Fe*2}}),(g||!h)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(g?" fin":""),style:v,children:[g&&k?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:k.title}),e.jsx("p",{children:e.jsx(bt,{text:k.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>u(y.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(d+1,y.length)}),e.jsx("h3",{children:x==null?void 0:x.title}),e.jsx("p",{children:e.jsx(bt,{text:(x==null?void 0:x.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>u(S=>Math.max(0,S-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>u(S=>S+1),children:d===y.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function wr(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:i}=z(),o=p.useMemo(()=>t.filter(s=>ve(s.date)===0&&s.kind==="target"),[t]),l=p.useMemo(()=>o.filter(s=>a?X(s)===0:!Q(s)),[o,a]),f=o.length-l.length,d=o.length?Math.min(100,f/o.length*100):100;let u;a?u=n.morningThesis(o.length,f,l.length):o.length?f===0?u=n.goalSourced(o.length):f>=o.length?u=n.goalCleared:u=n.goalDone(f,o.length):u=n.goalSourced(0);const h=()=>{a?(i({type:"ptab",tab:0}),i({type:"filters",patch:{win:"1"}})):i({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:u}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:d+"%"}})}),l.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:a?n.morningEval(l.length):r.pileMode?n.goalContinue(l.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function kr(){var I;const{t,st:a,dispatch:n,token:r,fund:i,data:o,dossiers:l,mode:f,doSync:d,startTour:u}=z(),[h,s]=p.useState(null),[y,b]=p.useState([]),[m,x]=p.useState(!1),g=f==="client";p.useEffect(()=>{if(!r||!i)return;let O=!0;return(async()=>{const[M,B]=await Promise.all([zt(i),Tt(r)]);O&&(M&&s(M),b(B))})(),()=>{O=!1}},[r,i]);const c=(h==null?void 0:h.per_day)??null,w=((I=h==null?void 0:h.pool_order)==null?void 0:I.length)??0,k=y.filter(O=>O.status==="running").length,v=O=>{if(!g||c===null||m)return;const M=Math.max(0,Math.min(10,c+O));M!==c&&(x(!0),s(B=>B&&{...B,per_day:M}),Et(r,M).then(B=>{x(!1),s(B===null?E=>E&&{...E,per_day:c}:E=>E&&{...E,per_day:B})}))},S=p.useMemo(()=>l.filter(O=>O.kind==="target"&&Q(O)).length,[l]),C=o.marketEstimate,F=C&&C>0?Math.min(100,Math.round(S/C*100)):null,N=(i||"P").split(/\s+/).map(O=>O[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const O=Date.parse(o.generatedAt||"");if(Number.isNaN(O))return"";const M=new Date(O),B=E=>String(E).padStart(2,"0");return`${B(M.getDate())}/${B(M.getMonth()+1)} à ${B(M.getHours())}:${B(M.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:i})]}),e.jsx("h1",{children:t.identTitle(i||"…")}),e.jsx("span",{className:"idsp"}),T&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(T)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:u,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[F!==null&&C&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:F+"%"}})}),e.jsxs("b",{children:[F," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(S,C)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),c!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),v(-1)},children:"−"}),e.jsx("b",{className:"q",children:c})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),v(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),c===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),k>0&&e.jsxs("span",{className:"ev",children:["⏳ ",k]}),e.jsx("span",{className:"ego",children:t.identPending(w)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:O=>{O.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!g,onClick:d,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:O=>n({type:"filters",patch:{search:O.target.value}})})]})]})]})}function jr(){const{t,counts:a,dispatch:n}=z();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,i],o)=>{const l=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(l?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:i}),l&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Nr=["--p0","--p1","--p2","--p3","--p4"];function Sr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:i}=z(),o=p.useRef({});p.useEffect(()=>{o.current={...n}},[n]);const l=u=>{const h=o.current[u],s=h!==void 0?n[u]-h:0;return e.jsxs("button",{type:"button",className:"step"+(u===3&&n[3]>0?" wait":""),style:{"--c":`var(${Nr[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===u,title:r.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[e.jsxs("span",{className:"l",children:[r.plabels[u].toUpperCase(),u===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[u],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},u)},f=(u,h,s)=>e.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===u,title:r.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[u]})]},u),d=(u,h,s,y=!1)=>e.jsx("button",{type:"button",className:"tool",title:h,disabled:y,onClick:s,children:u},h);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),e.jsxs("div",{className:"offtrack",children:[f(5,!1,r.plabels[5]),f(7,!0,r.plabels[7]),f(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[d("↩",r.toolUndo,i,t.undo.length===0),d("↺",r.toolReset,()=>{a({type:"reset"})}),d("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),d("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),d("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Cr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function zr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:i,doAnalyse:o,mode:l}=z(),f=p.useRef(null),[d,u]=p.useState(60);p.useEffect(()=>{let b=0;const m=()=>{var k;const x=f.current;if(!x)return;const g=(k=x.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!g)return;const c=g.getBoundingClientRect(),w=x.getBoundingClientRect();u(Math.max(20,Math.min(c.left+c.width/2-w.left,w.width-30)))};return b=requestAnimationFrame(m),window.addEventListener("resize",m),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",m)}},[t.ptab]);const h=t.ptab;let s=n.tuto[h].p;if(h===3){const b=r.filter(g=>g.kind==="target"&&X(g)===3),m=b.filter(g=>_e(g)==="auto").length,x=b.filter(g=>_e(g)==="cd").length;s=n.tutoPending(m,x,b.length)}const y=(()=>{if(l!=="client")return null;if(h===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(h===1){const b=r.filter(m=>m.kind==="target"&&X(m)===1&&!i.has(m.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(m=>o(m))}}return null})();return e.jsxs("div",{ref:f,className:"tuto mini",style:{"--bg":Cr[h],"--ax":d+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[h].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),y&&e.jsx("button",{type:"button",className:"tprim",onClick:y.run,children:y.label})]})}const vt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function yt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Tr(t,a){const[n,r]=p.useState(1);return p.useEffect(()=>{let i=!0,o=0;const l=()=>{var u;if(!i)return;const d=(u=t.current)==null?void 0:u.getScreenCTM();d&&d.a>0?r(d.a):o=requestAnimationFrame(l)};l();const f=new ResizeObserver(()=>l());return t.current&&f.observe(t.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),f.disconnect(),window.removeEventListener("resize",l)}},[t,a]),n}function Er(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:i,markedId:o,byId:l,lang:f,t:d}=z(),u=p.useRef(null),h=p.useRef(null),s=We.find(N=>N.key===t.continent),y=Tr(u,t.continent+":"+t.mapFolded),[b,m]=p.useState(new Map),[x,g]=p.useState(null);p.useEffect(()=>{const N=u.current;if(!N)return;const T=new Map;N.querySelectorAll("path[data-i2]").forEach(I=>{const O=I.dataset.i2;if(O)try{const M=I.getBBox();M.width>0&&T.set(O,{x:M.x,y:M.y,w:M.width,h:M.height})}catch{}}),m(T)},[t.continent,y]);const c=p.useMemo(()=>n.filter(N=>N.cc),[n]),w=p.useMemo(()=>{const N=new Map;return c.forEach(T=>N.set(T.cc,(N.get(T.cc)||0)+1)),N},[c]),k=p.useMemo(()=>c.map(N=>{const T=N.cc?b.get(N.cc):void 0;if(!T)return null;const I=yt(N.name||N.id||""),O=yt((N.id||N.name||"")+"·y"),M=(I-.5)*Math.min(T.w*.55,60),B=(O-.5)*Math.min(T.h*.55,60);return{d:N,x:T.x+T.w/2+M,y:T.y+T.h/2+B}}).filter(N=>!!N),[c,b]),v=N=>y>0?N/y:N,S=p.useMemo(()=>r?[0,1,2,3,4,5].map(N=>({c:vt[N],fr:d.plabels[N].toUpperCase(),en:d.plabels[N].toUpperCase(),n:n.filter(T=>T.kind==="target"&&X(T)===N).length})).filter(N=>N.n>0):ot.map((N,T)=>({...N,n:n.filter(I=>it(I)===T).length})),[n,r,d.plabels]),C=o?l.get(o):null,F=C?k.find(N=>N.d.id===C.id):null;return e.jsxs("div",{className:"mapzone",ref:h,children:[e.jsxs("svg",{ref:u,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":f==="fr"?s.fr:s.en,onMouseLeave:()=>{g(null),i(null)},children:[e.jsx("g",{children:s.countries.map((N,T)=>e.jsx("g",{className:"ct"+(N.i2&&w.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},T))}),e.jsx("g",{children:k.map(N=>{const T=ot[it(N.d)],I=!!Y(N.d),O=N.d.kind==="target",M=r&&O?vt[X(N.d)]:T.c,B=!r&&Q(N.d);return e.jsxs("g",{className:"co"+(B?" done":""),onMouseEnter:()=>{var P,_;const E=(P=h.current)==null?void 0:P.getBoundingClientRect(),R=(_=u.current)==null?void 0:_.createSVGPoint();if(R&&u.current&&E){R.x=N.x,R.y=N.y;const re=R.matrixTransform(u.current.getScreenCTM());g({x:re.x-E.left,y:re.y-E.top,label:N.d.name+" · "+(ye(N.d.cc,f)||N.d.countryLabel||"")})}i(N.d.id)},onMouseLeave:()=>{g(null),i(null)},onClick:()=>{var P;const E=(P=u.current)==null?void 0:P.createSVGPoint();let R=null;if(E&&u.current){E.x=N.x,E.y=N.y;const _=E.matrixTransform(u.current.getScreenCTM());R={x:_.x,y:_.y}}a({type:"popup",id:N.d.id,anchor:R})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:v(Math.max(11,T.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:v(T.px),fill:M,stroke:I?"#DC2626":"#ffffff",strokeWidth:v(I?2.2:1.3)})]},N.d.id||N.d.name)})}),F&&e.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:v(13),fill:"none",stroke:"#0F172A",strokeWidth:v(2)})]}),e.jsx("div",{className:"hov"+(x?" on":""),style:x?{left:x.x,top:x.y}:void 0,children:x==null?void 0:x.label}),e.jsx("div",{className:"legend",children:S.map((N,T)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),f==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},T))}),n.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",d.notLocated," ",e.jsx("b",{children:n.filter(N=>!N.cc).length})]})})]})}function Ar(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:i,contName:o}=z(),l=t.filters,f=p.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),d=b=>f.filter(m=>b!=="country"&&l.country.length&&!l.country.includes(m.cc||"")?!1:Qe(m,l,i,b==="country"?void 0:b)),u=p.useMemo(()=>{const b=d("win"),m=x=>b.filter(g=>(g.date?Math.max(0,Math.floor((Date.now()-Date.parse(g.date))/864e5)):9999)<=x).length;return[m(0),m(7),m(30),b.length]},[f,l,i]),h=p.useMemo(()=>{if(i)return null;const b=d("status"),m={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(x=>{m[se(x)]+=1}),m},[f,l,i]),s=l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+(l.signalOnly?1:0)+(l.win!=="all"?1:0)+(!i&&l.status!=="all"?1:0)+(l.search.trim()?1:0),y=(b,m,x,g="fbtn")=>e.jsxs("button",{type:"button",className:g,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:m}),x>0&&e.jsx("span",{className:"n",children:x}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,m)=>e.jsxs("button",{type:"button","aria-pressed":l.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[m],e.jsx("b",{children:u[m]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:l.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!i&&h&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,m])=>e.jsxs("button",{type:"button","aria-pressed":l.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[m,e.jsx("b",{children:h[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),l.signalOnly&&e.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),y("sec",r.fSector,l.sector.length),y("pay",r.fCountry,l.country.length),y("det",r.fEngine,l.engine.length),y("sta",r.fStage,l.stage.length),i&&y("ang","Angle",l.angle.length),i&&y("mem","Mémo",l.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(f.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(Or,{poolFor:d})]})}function Or({poolFor:t}){const{st:a,dispatch:n,t:r,lang:i}=z(),o=a.filters,l=a.openFacet,{title:f,cols:d,options:u}=p.useMemo(()=>{if(l==="sig"){const m=t("signal").filter(c=>Y(c)),x=new Map;m.forEach(c=>{const w=c.engine||"";x.set(w,(x.get(w)||0)+1)});const g=[{v:"*",label:r.fpSigAll,n:m.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...lt([...x.keys()],i).map(c=>({v:c,label:be(c)+" "+oe(c,i),n:x.get(c)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(c)}))];return{title:r.fpSigTitle,cols:2,options:g}}if(l==="sec"){const m=t("sector"),x=new Map;return m.forEach(g=>{g.sector&&x.set(g.sector,(x.get(g.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...x.entries()].sort((g,c)=>c[1]-g[1]).map(([g,c])=>({v:g,label:g,n:c,html:!1,on:o.sector.includes(g)}))}}if(l==="pay"){const m=t("country"),x=new Map;return m.forEach(g=>{g.cc&&x.set(g.cc,(x.get(g.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...x.entries()].sort((g,c)=>c[1]-g[1]).map(([g,c])=>({v:g,label:ye(g,i)||g,n:c,html:!1,on:o.country.includes(g)}))}}if(l==="det"){const m=t("engine"),x=new Map;return m.forEach(g=>{g.engine&&x.set(g.engine,(x.get(g.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:lt([...x.keys()],i).map(g=>({v:g,label:be(g)+" "+oe(g,i)+' <span style="color:var(--dim);font-size:10px">· '+xa(ga(g),i)+"</span>",n:x.get(g)||0,html:!0,on:o.engine.includes(g)}))}}if(l==="ang"){const m=t("angle"),x=new Map;return m.forEach(g=>{g.angle&&x.set(g.angle,(x.get(g.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...x.entries()].sort((g,c)=>c[1]-g[1]).map(([g,c])=>({v:g,label:g.replace(/[_-]+/g," "),n:c,html:!1,on:o.angle.includes(g)}))}}if(l==="mem"){const m=t("memoLevel"),x=new Map;m.forEach(c=>{if(c.kind==="target"){const w=Ye(c);x.set(w,(x.get(w)||0)+1)}});const g=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(c=>({v:String(c),label:g[c],n:x.get(c)||0,html:!1,on:o.memoLevel.includes(c)}))}}const y=t("stage"),b=new Map;return y.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,x)=>x[1]-m[1]).map(([m,x])=>({v:m,label:m,n:x,html:!1,on:o.stage.includes(m)}))}},[l,a,i]),h=y=>{if(l==="sig"){if(y==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const m=o.signalEngines.includes(y)?o.signalEngines.filter(x=>x!==y):[...o.signalEngines,y];n({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(l==="mem"){n({type:"toggleMemoLevel",value:Number(y)});return}n({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:y})},s=()=>{n(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:f}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(d===2?" two":""),children:u.map(y=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":y.on,onClick:()=>h(y.v),children:[e.jsx("span",{className:"bx"}),y.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:y.label}}):e.jsx("span",{className:"l",children:y.label}),e.jsx("span",{className:"n",children:y.n})]},y.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const wt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Lr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:i,dispatch:o,evalBusy:l,evalCards:f,caps:d,data:u}=z(),h=a==="client",[s,y]=p.useState(""),[b,m]=p.useState(!1),[x,g]=p.useState(""),[c,w]=p.useState(!1),[k,v]=p.useState(""),[S,C]=p.useState([]),F=p.useRef(!1),N=s.trim()?wt.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,T=p.useMemo(()=>x.split(`
`).map(E=>E.trim()).filter(Boolean).slice(0,15),[x]),I=S.length?S:f,O=u.credits,M=()=>{const E=s.trim();E&&(r(null,E),y(""))},B=async()=>{if(!h){r(null,T[0]||"");return}if(!T.length||c)return;w(!0),F.current=!1;const E=[];for(let R=0;R<T.length&&!F.current;R++){v(t.evaluating(R+1,T.length,T[R]));const P=await At(n,T[R],"atelier2");if(E.unshift({name:P.company||T[R],verdict:P.verdict,reason:P.reason||"",remaining:P.remaining??null}),C([...E]),P.verdict==="quota"){E.unshift({name:"",verdict:"quota",reason:t.quota(T.length-R-1),remaining:0}),C([...E]);break}}v(""),g(""),w(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:E=>y(E.target.value),onKeyDown:E=>{E.key==="Enter"&&M()}}),e.jsx("span",{className:"detect"+(wt.test(s.trim())?" url":""),children:N})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),disabled:l,onClick:M,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),d.showCredits&&O&&e.jsxs("button",{type:"button",className:"credits"+(O.total_available<=0&&!O.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:O.unlimited?"∞":O.total_available}),!O.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",O.daily_grant+O.purchased]}),O.total_available<=0&&!O.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>m(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:x,placeholder:t.bulkPh,onChange:E=>g(E.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{justifyContent:"center"},disabled:c||!T.length,onClick:()=>{B()},children:[e.jsx("span",{className:"fill"}),c&&k?k:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(T.length)})]})]}),I.slice(0,1).map((E,R)=>{const P=E.verdict==="kept",_=E.verdict==="quota",re=P?"var(--brand)":_?"var(--bolt)":"var(--red)",me=P?"var(--brand-l)":_?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":re,"--bgc":me},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:P?"✓ "+t.kept:_?"⏳":"✗ "+t.dropped})}),E.name&&e.jsx("span",{className:"rn",children:E.name}),e.jsx("span",{className:"rr",children:E.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",E.reason]}):null}),!_&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(P?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},R)}),h&&(i.kept+i.dropped>0||I.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(i.kept,i.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Fr(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Rr(){const{st:t,dispatch:a,byId:n,t:r,doDeep:i}=z(),o=t.memoConsole?n.get(t.memoConsole):null,l=p.useMemo(()=>o?[o.reasoning||"",Fr(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const f=qe(o),d=Ye(o);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:o.name}),f&&e.jsx("span",{className:"vv",children:f}),typeof o.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:r.memoSynth})}),e.jsx("div",{className:"mb2",children:l?l.split(`

`).map((u,h)=>e.jsx("p",{style:{margin:"0 0 10px"},children:u},h)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[Ge(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:d===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}function Dt({name:t}){const{t:a,token:n,caps:r,mode:i,flashErr:o}=z(),[l,f]=p.useState(!1),[d,u]=p.useState(null);if(!r.pipe||i!=="client"||r.lockActions)return null;const h=async()=>{if(l)return;f(!0);const s=await ha(n,t);if(f(!1),!s){o(a.actErr);return}u(s.results||[])};return e.jsxs("div",{className:"simb",onClick:s=>s.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{h()},children:l?a.similarBusy:a.similar}),d&&(d.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:d.map(s=>e.jsxs("li",{children:[e.jsx("b",{className:s.verdict==="kept"?"ok":"ko",children:s.company}),s.reason&&e.jsx("span",{children:s.reason})]},s.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const qt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Xe({o:t}){const{t:a}=z(),n=De(t),r=qe(t),i=X(t),o=_e(t),l=ba(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(qt[r]||"v-cons"),title:a.vt[r],children:r}):i===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&e.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}function kt({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:i}=z(),[o,l]=p.useState(!1);if(p.useEffect(()=>{r||l(!1)},[r]),Q(t)){const u=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":u?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[u?"✓":"✗"," ",e.jsx("b",{children:u?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const d=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:r,onClick:u=>{u.stopPropagation(),l(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function Mr({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:i,doAnalyse:o,doDecide:l,doPromote:f,doRepeche:d,doApproach:u,dispatch:h}=z();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),h({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(kt,{o:t})});const s=X(t),y=b=>m=>{m.stopPropagation(),b()};if(s===0)return e.jsx("span",{className:"cell",children:e.jsx(kt,{o:t})});if(s===1){const b=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:y(()=>o(t)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(s===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:y(()=>l(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:y(()=>l(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:y(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})});if(s===4){const b=i.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:b,onClick:y(()=>u(t)),children:b?a.actApproachSent:a.actApproach})})}return s===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:y(()=>f(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:y(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):s===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:y(()=>d(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:y(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:y(()=>h({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function Dr({o:t}){const{t:a,doThumb:n,thumbOf:r}=z(),i=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function qr({o:t}){const{lang:a}=z();return Y(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(we,{o:t}),e.jsx(Pe,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[be(t.engine||"")," ",oe(t.engine||"",a)]})})}function Pr({o:t,locked:a,open:n,onToggle:r}){const{st:i,dispatch:o,caps:l,markRow:f,markedId:d,favIds:u,toggleFav:h}=z(),s=X(t),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,m=b<=0?0:b<=7?1:b<=30?2:3,x=l.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][s]:y[m],g=u.has(t.id),c=w=>{if(a)return;if(l.pipe){r();return}const k=w.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:k.left+Math.min(280,k.width/3),y:k.bottom}})};return e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"row"+(d===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>f(t.id),onMouseLeave:()=>f(null),onClick:c,children:[e.jsx("span",{className:"pt",style:{"--c":x}}),e.jsx(Bt,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[l.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:g?1:.35,padding:0,marginRight:4},onClick:w=>{w.stopPropagation(),h(t)},children:g?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(w=>w&&w!==t.name)||""})]}),e.jsx(Br,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(qr,{o:t}),l.pipe&&e.jsx(Xe,{o:t}),l.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(Mr,{o:t}),l.showThumbs&&e.jsx(Dr,{o:t})]}),(n||i.dens==="deplie")&&!a&&e.jsx(Ir,{o:t})]})}function Br({o:t}){const{lang:a,caps:n}=z();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=Ke(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function Ir({o:t}){const{t:a,lang:n,dispatch:r,caps:i,outbound:o,doOnboard:l}=z();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),t.reasoning&&e.jsxs("div",{className:"dec"+(De(t)==="NO MATCH"?" out":""),title:t.reasoning,children:[e.jsx("em",{children:De(t)==="NO MATCH"?a.vOut:a.vKept}),t.reasoning.length>340?`${t.reasoning.slice(0,340)}…`:t.reasoning]}),t.ceoNote&&e.jsxs("div",{className:"ceonote",children:["💬 ",e.jsx("i",{children:t.ceoNote})]}),e.jsx(gr,{o:t}),e.jsx(vr,{o:t}),e.jsx(Dt,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(Xe,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[be(t.engine||"")," ",oe(t.engine||"",n)]}),Y(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(we,{o:t})})]}),i.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(t),children:a.actOnboard})]})]})]})}function $r({o:t,locked:a}){const{t:n,dispatch:r,caps:i,doDecide:o}=z(),l=X(t),f=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":f},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(Xe,{o:t}),Y(t)&&e.jsx(we,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&i.pipe&&l===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function Vr(){const t=z(),{st:a,dispatch:n,t:r,caps:i,scoped:o,lang:l,sessTally:f}=t,[d,u]=p.useState(new Set);p.useEffect(()=>{u(new Set)},[a.ptab,a.continent]);const h=k=>u(v=>{const S=new Set(v);return S.has(k)?S.delete(k):S.add(k),S}),s=p.useMemo(()=>Je(o,a.sort),[o,a.sort]),y=p.useMemo(()=>s.filter(k=>Y(k)&&!Q(k)).length,[s]),b=i.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,m=(k,v,S="",C=!1)=>e.jsxs("button",{type:"button","data-s":k,className:S,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:C?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:k}),children:[v,e.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),x=p.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const k=new Map;return s.forEach(v=>{const S=v.engine||"?";k.has(S)||k.set(S,[]),k.get(S).push(v)}),[...k.entries()]},[s,i.pipe,a.groupBy]),g=i.lockRowsAfter;let c=0;const w=(k,v)=>{const S=a.shown[v]||Me,F=k.slice(0,S).map(N=>{const T=g!==null&&c>=g;return c++,a.dens==="maxi"?e.jsx($r,{o:N,locked:T},N.id):e.jsx(Pr,{o:N,locked:T,open:d.has(N.id),onToggle:()=>h(N.id)},N.id)});return k.length>S&&F.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:v,by:Me}),children:r.more(Math.min(Me,k.length-S),k.length-S)},v+":more")),F};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:s.length})," ",b]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,i.pipe&&t.fund?" · "+t.fund:""]}),i.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),i.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([k,v])=>e.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k,onClick:()=>n({type:"dens",dens:k}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:v})]},k))}),i.showChain&&s.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:s.filter(k=>i.pipe?!0:!Q(k)).map(k=>k.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",i.pipe?r.browse(s.length):r.chainAll(s.filter(k=>!Q(k)).length)]})]}),y>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(y)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),m("country",r.colCountry),m("name",r.colCompany),m("amount",r.colAmount,"h-amt",!0),m("stage",r.colStage,"h-stade"),m("signal",r.colSignal,"h-sig"),i.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),i.pipe&&m("score",r.colScore,"h-sc",!0),e.jsx("span",{}),i.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[x?x.map(([k,v])=>e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:be(k)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:oe(k,l)}),e.jsx("div",{className:"s",children:r.grpCount(v.filter(S=>!Q(S)).length,v.length)})]})]}),w(v,k)]},k)):w(s,"pt"+a.ptab),!s.length&&e.jsx("div",{className:"void",children:i.pipe?r.emptyTab:r.emptyScope})]}),i.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(f.kept>0||f.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(f.kept,f.dropped)}})]})}const Ur=`
...
`;function _r(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,i=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let l=t.y+10;return l+n>i-8&&(l=Math.max(8,t.y-n-14)),l<8&&(l=8),{left:o,top:l}}function Hr(){const{st:t,dispatch:a,byId:n,t:r,lang:i,caps:o,mode:l,askEvaluate:f,doAnalyse:d,doDecide:u,doPromote:h,doRepeche:s,doApproach:y,doDeep:b,doOnboard:m,outbound:x,evalBusy:g}=z(),c=t.popupId?n.get(t.popupId):null;if(!c)return null;const w=Y(c),k=X(c),v=qe(c),S=c.kind==="target",C=F=>{a({type:"filters",patch:F}),a({type:"popup",id:null})};return Te.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Ur}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:_r(t.popupAnchor),onClick:F=>F.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:c.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(ve(c.date)),oe(c.engine,i))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[c.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[c.cc]}),children:(ye(c.cc,i)||c.countryLabel||"").toUpperCase()}),c.sector&&e.jsx("button",{type:"button",onClick:()=>C({sector:[c.sector]}),children:c.sector.toUpperCase()}),c.stage&&e.jsx("button",{type:"button",onClick:()=>C({stage:[c.stage]}),children:c.stage.toUpperCase()}),typeof c.amountEur=="number"&&c.amountEur>0&&e.jsx("span",{className:"am2",children:Ke(c.amountEur,i)})]}),(c.tagline||c.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:c.tagline||c.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[be(c.engine)," ",e.jsx("b",{children:oe(c.engine,i)})," — ",va(c.engine,i),c.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",c.noteTitle]})]}),w?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(we,{o:c,lg:!0})," ",e.jsx(Pe,{o:c,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(Ot(w,i))," · ",r.win7(Lt(w,i))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),c.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&k>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:c.reasoning})]}),o.pipe&&S&&v&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[v,typeof c.score=="number"&&c.score>0?" · "+r.score(c.score):""]})})]}),e.jsx(Dt,{name:c.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[k===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>f(c),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),k===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(c),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),k===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(c),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),k===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(c,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{u(c,!1),a({type:"popup",id:null})},children:r.actNo}),Ge(c)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{b(c),a({type:"popup",id:null})},children:r.memoDeep})]}),k===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{y(c),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),k===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(c),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),c.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:c.id}),a({type:"popup",id:null})},children:"📄"}),x&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{m(c),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>f(c),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),c.website&&e.jsx("a",{className:"psite",href:c.website.startsWith("http")?c.website:"https://"+c.website,target:"_blank",rel:"noopener noreferrer",title:c.website,children:"🌐"})]})]})]}),document.body)}function jt(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Yr(t,a){const n=ya(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function Wr(t,a){const r=[a.head.split("|").map(jt).join(";")];for(const i of t){const o=a.stageOf(i);r.push([i.name||"",Yr(i,a.plabels),De(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(jt).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function Gr(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const Kr=50;function Ze({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:i}=z(),[o,l]=p.useState(null),[f,d]=p.useState(!1),[u,h]=p.useState(""),[s,y]=p.useState(0),[b,m]=p.useState(""),[x,g]=p.useState(!1),c=p.useRef(null);p.useEffect(()=>()=>{c.current&&window.clearInterval(c.current)},[]);const w=async v=>{d(!0),h("");const S=await a();if(d(!1),S.ok){l(S);return}if(S.busy){h(i.alertPreviewBusy);return}if(!v){h(i.alertPreviewFail);return}y(Kr),c.current=window.setInterval(()=>{y(C=>C>1?C-1:(c.current&&window.clearInterval(c.current),w(!1),0))},1e3)},k=async()=>{if(r||x)return;g(!0),m("");const v=await n();g(!1),m(v.ok?i.alertTestOk(v.sentTo||""):v.error||i.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:f||s>0,onClick:()=>{w(!0)},children:f?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||x,onClick:()=>{k()},children:x?"…":i.alertTest})]}),s>0&&e.jsx("p",{className:"mnote",children:i.alertPreviewRetry(s)}),u&&e.jsx("p",{className:"mnote warn",children:u}),b&&e.jsx("p",{className:"mnote",children:b}),!b&&e.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const ze="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function J({title:t,icon:a,children:n,wide:r}){const{dispatch:i}=z();return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function Qr(){const{st:t}=z();switch(t.modal){case"chain":return e.jsx(Xr,{});case"space":return e.jsx(Zr,{});case"alert":return e.jsx(en,{});case"queue":return e.jsx(on,{});case"export":return e.jsx(ln,{});case"plug":return e.jsx(cn,{});case"recharge":return e.jsx(un,{});case"cover":return e.jsx(fn,{});case"crit":return e.jsx(mn,{});case"tuto":return e.jsx(xn,{});case"rdv":return e.jsx(Jr,{});case"memoalert":return e.jsx(sn,{});default:return null}}function Jr(){const{dispatch:t,fund:a}=z(),n=typeof document<"u"&&!!document.getElementById("rdv");return p.useEffect(()=>{n&&(t({type:"modal",modal:null}),sr())},[n,t]),n?null:e.jsx(ja,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function Xr(){const{st:t,dispatch:a,byId:n,t:r,lang:i,mode:o,askEvaluate:l,evalBusy:f}=z(),d=o==="client",u=t.chain.queue.map(b=>n.get(b)).filter(b=>!!b),h=t.chain.idx,s=u[h],y=h>=u.length;return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:y?r.finished:`${h+1} / ${u.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(y?100:h/Math.max(1,u.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:y||!s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(u.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:s.name}),e.jsx("div",{className:"sub",children:[ye(s.cc,i)||s.countryLabel,s.sector,s.stage,r.daysAgo(ve(s.date))].filter(Boolean).map(b=>String(b).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:oe(s.engine,i).toUpperCase()}),typeof s.amountEur=="number"&&s.amountEur>0&&e.jsx("span",{children:Ke(s.amountEur,i)})]}),Y(s)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(we,{o:s,lg:!0})," ",e.jsx(Pe,{o:s,src:!0})]}),(s.tagline||s.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:s.tagline||s.headline})]}),s.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:s.reasoning})]}),d&&Q(s)&&e.jsxs("div",{className:"vbox",style:{"--c":se(s)==="retenu"?"var(--brand)":se(s)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:se(s)==="retenu"?"✓ "+r.kept:se(s)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:s.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!y&&s&&!(d&&Q(s))&&e.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:f,onClick:()=>{l(s)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(y?{type:"modal",modal:null}:{type:"chainNext"}),children:y?r.closeBtn:r.skip})]})]})})}),document.body)}function Zr(){const{st:t,dispatch:a,dossiers:n,t:r,mode:i}=z(),o=i==="client",l=p.useMemo(()=>o?n.filter(s=>Q(s)):[],[n,o]),f=p.useMemo(()=>Je(l.filter(s=>se(s)==="retenu"),{key:"signal",dir:-1}),[l]),d=p.useMemo(()=>l.filter(s=>se(s)==="ecarte"),[l]),u=t.spaceTab==="retenu"?f:d,h=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(J,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:f.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:d.length})]})]}),u.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),u.slice(0,40).map(s=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":h},children:typeof s.score=="number"&&s.score>0?s.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:s.name}),e.jsx("div",{className:"rr",children:s.reasoning||s.tagline||""})]})]},s.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function en(){const{mode:t}=z();return t==="client"||t==="apercu"?e.jsx(tn,{}):e.jsx(nn,{})}function tn(){const{t,token:a,flash:n,flashErr:r,mode:i}=z(),[o,l]=p.useState("d"),f=i!=="client";return e.jsxs(J,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:t.alertTabWeekly})]}),o==="d"?e.jsx(an,{t,token:a,readOnly:f,flash:n,flashErr:r}):e.jsx(rn,{t,token:a,readOnly:f,flash:n,flashErr:r})]})}function an({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,l]=p.useState(null),[f,d]=p.useState(!1),[u,h]=p.useState(0);p.useEffect(()=>{let m=!0;return d(!1),pt(a).then(x=>{m&&(x?l(x):d(!0))}),()=>{m=!1}},[a,u]);const s=m=>{n||pt(a,m).then(x=>{if(!x){i(t.actErr);return}l(x),x.throttled?i(t.alertThrottled):r(t.alertSaved)})};if(f)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const y=m=>!o.sections||o.sections.includes(m),b=m=>{const x=o.sections||t.alertSec.map(([g])=>g);s({sections:y(m)?x.filter(g=>g!==m):[...x,m]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([m,x])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:y(m),disabled:n,onChange:()=>b(m)}),e.jsxs("span",{children:[x,m==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},m))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(Ze,{label:t.alertPreview,readOnly:n,onPreview:()=>Ta(a),onTest:()=>za(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function rn({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,l]=p.useState(null),[f,d]=p.useState(!1),[u,h]=p.useState(0);p.useEffect(()=>{let m=!0;return d(!1),ut(a).then(x=>{m&&(x?l(x):d(!0))}),()=>{m=!1}},[a,u]);const s=m=>{n||ut(a,m).then(x=>{if(!x){i(t.actErr);return}l(x),r(t.alertSaved)})};if(f)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const y=o.dow??0,b=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:y,disabled:n,onChange:m=>s({dow:Number(m.target.value)}),children:t.alertDow.map((m,x)=>e.jsx("option",{value:x,children:m},m))}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,b-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[b," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,b+1)}),disabled:n,children:"＋"})]})]}),e.jsx(Ze,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>Aa(a),onTest:()=>Ea(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function nn(){const{st:t,t:a,lang:n,scoped:r,contName:i}=z(),[o,l]=p.useState(""),[f,d]=p.useState(!1),[u,h]=p.useState(!1),s=t.filters,y=p.useMemo(()=>r.filter(g=>Y(g)).length,[r]),b=s.win==="1"?0:s.win==="7"?1:s.win==="30"?2:3,m=async()=>{if(!(!/.+@.+\..+/.test(o)||u)){h(!0);try{await fetch(`${He}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o.trim(),sectors:s.sector,countries:s.country,source:"atelier2",website:""})}),d(!0)}finally{h(!1)}}},x=[[a.amRows.continent,i],[a.amRows.since,a.amSince[b]],[a.amRows.signal,s.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,s.engine.length?s.engine.map(g=>oe(g,n)).join(", "):a.amAllEngines],[a.amRows.sectors,s.sector.length?s.sector.join(", "):a.amAllSectors],[a.amRows.countries,s.country.length?s.country.map(g=>ye(g,n)||g).join(", "):a.amAllCountries],[a.amRows.stages,s.stage.length?s.stage.join(", "):a.amAllStages]];return e.jsx(J,{title:a.alertTitle,icon:"🔔",children:f?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(o)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:x.map(([g,c])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:g}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:c}})]},g))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:o,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&m()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},onClick:()=>void m(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,y)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function on(){var x,g,c;const{t,token:a,fund:n,mode:r,flash:i}=z(),[o,l]=p.useState(null),[f,d]=p.useState([]),[u,h]=p.useState(0),s=r==="client";p.useEffect(()=>{let w=!0;return(async()=>{const[k,v]=await Promise.all([zt(n),Tt(a)]);w&&(k&&l(k),d(v))})(),()=>{w=!1}},[a,n,u]);const y=(o==null?void 0:o.per_day)??2,b=((x=o==null?void 0:o.analyzed_today)==null?void 0:x.length)??0,m=(g=o==null?void 0:o.tomorrow)!=null&&g.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(J,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(b,b+(((c=o==null?void 0:o.pool_order)==null?void 0:c.length)??0))}})}),e.jsx("div",{className:"qrate",children:t.queueRate}),e.jsx("div",{className:"qrates",children:[1,2,3,5,10].map(w=>e.jsx("button",{type:"button",className:"qr"+(y===w?" on":""),disabled:!s,onClick:()=>{Et(a,w).then(k=>{k!==null&&(h(v=>v+1),i(t.alertSaved))})},children:e.jsxs("b",{children:[w,"/j"]})},w))})]}),f.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:f.map(w=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:w.company}),e.jsxs("span",{className:"qd",children:[w.memo_type,typeof w.est_min=="number"?` · ~${w.est_min} min`:""]}),e.jsx("span",{className:"qt",children:w.status}),w.url&&e.jsx("a",{className:"qgo",href:w.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),s&&w.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{ct(a,w.company,"retry").then(()=>h(k=>k+1))},children:t.queueRetry}),s&&w.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{ct(a,w.company,"delete").then(()=>h(k=>k+1))},children:t.queueDelete})]},w.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[m.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),m.slice(0,10).map((w,k)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",k+1]}),e.jsx("b",{children:w.name}),typeof w.score=="number"&&e.jsx("span",{className:"qs2",children:w.score})]},w.name))]})]})}function ln(){const{t,token:a,flash:n,scoped:r,caps:i,stageOf:o}=z(),l=`${ze}/cibles/list.csv?token=${a}`,f=`${ze}/cibles/list.json?token=${a}`,d=`${ze}/cibles/export.xlsx?token=${a}&scope=full`,u=`=IMPORTDATA("${l}")`,h=m=>{var x;(x=navigator.clipboard)==null||x.writeText(m).then(()=>n(t.exportCopied))},s=[{def:t.exportCsv,value:l,href:l},{def:t.exportSheet,value:u},{def:t.exportLive,value:f,href:f},{def:t.exportXlsx,value:d,href:d}],y=!i.lockActions&&r.length>0,b=()=>{Gr(Wr(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:m=>(t.stg.find(([x])=>x===m)||["",""])[1]})),n(t.exportViewDone(r.length))};return e.jsxs(J,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),y&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:b,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:s.map(({def:m,value:x,href:g})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:m[0]}),e.jsxs("div",{children:[e.jsx("b",{children:m[1]}),e.jsx("p",{children:m[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>h(x),children:t.exportCopy}),g&&e.jsx("a",{className:"exb",href:g,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},m[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function sn(){const{t,token:a,flash:n,flashErr:r,mode:i}=z(),o=i!=="client",[l,f]=p.useState(null),[d,u]=p.useState(!1),[h,s]=p.useState(0),[y,b]=p.useState(!1);p.useEffect(()=>{let c=!0;return u(!1),st(a).then(w=>{c&&(w?f(w):u(!0))}),()=>{c=!1}},[a,h]);const m=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},x=c=>{if(o||!l)return;const w={enabled:c.enabled??!!l.enabled,email:c.email??(l.email||""),sections:c.sections??m()};b(!0),st(a,w).then(k=>{if(b(!1),!k){r(t.memoAlertErr);return}f(k),n(t.memoAlertSaved)})};if(d)return e.jsx(J,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>s(c=>c+1),children:t.retry})]})});if(!l)return e.jsx(J,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const g=m();return e.jsxs(J,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||y,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),e.jsx(dn,{value:l.email||"",readOnly:o||y,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:c=>x({email:c})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([c,w])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!g[c],disabled:o||y,onChange:()=>x({sections:{...g,[c]:!g[c]}})}),e.jsx("span",{children:w})]},c))}),e.jsx(Ze,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>ka(a,g),onTest:()=>wa(a,g)})]})}function dn({value:t,readOnly:a,label:n,okLabel:r,onSave:i}){const[o,l]=p.useState(t);p.useEffect(()=>{l(t)},[t]);const f=o.trim()!==t.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:u=>l(u.target.value),onKeyDown:u=>{u.key==="Enter"&&f&&d&&i(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!f||!d,onClick:()=>i(o.trim()),children:r})]})]})}function cn(){const{t,token:a,flash:n,flashErr:r,canWrite:i}=z(),[o,l]=p.useState(null),[f,d]=p.useState(!1),[u,h]=p.useState(null),[s,y]=p.useState(""),[b,m]=p.useState(0);p.useEffect(()=>{let c=!0;return d(!1),dt(a).then(w=>{c&&(w?l({configured:w.configured,url_hint:w.url_hint}):d(!0))}),Sa(a).then(w=>{c&&h(w)}),()=>{c=!1}},[a,b]);const x=(c,w)=>{i&&dt(a,c).then(k=>{if(!k||k.ok===!1){r(t.actErr);return}c.test&&k.sent===!1?r(t.plugTestThrottled):n(w),m(v=>v+1)})},g='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(J,{title:t.plugTitle,icon:"🔌",wide:!0,children:[u&&e.jsx("p",{className:"mnote"+(u.enabled?" warn":""),children:u.enabled?t.plugAutoOn(u.destination||"webhook"):t.plugAutoOff}),f?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>m(c=>c+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:s,disabled:!i,onChange:c=>y(c.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!i||!s.trim(),onClick:()=>x({url:s.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>x({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>x({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(pn,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:g}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var c;(c=navigator.clipboard)==null||c.writeText(g).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function pn(){const{t,token:a}=z(),[n,r]=p.useState("valides"),[i,o]=p.useState(!1),[l,f]=p.useState(null),d=async()=>{o(!0),f(await Ca(a,n)),o(!1)};return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:n,onChange:u=>r(u.target.value),children:t.plugBulkTabs.map(([u,h])=>e.jsx("option",{value:u,children:h},u))}),e.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{d()},children:i?"…":t.plugBulkPreview})]}),l&&(l.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(l.ready||0,l.linkedinReady||0,(l.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr}))]})}function un(){const{t,data:a,lang:n}=z(),r=a.credits,i=a.email,o=async l=>{if(!i)return;const f=window.location.href.split("?")[0];try{const u=await(await fetch(`${He}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:f+"?credits=ok",cancel_url:f+"?credits=cancel"})})).json();u.url&&(window.location.href=u.url)}catch{}};return e.jsxs(J,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(l=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(l.credits,l.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:t.rechargeBuy})]},l.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function fn(){const{t,data:a,dossiers:n}=z(),r=n.filter(o=>o.kind==="target"&&Q(o)).length,i=a.marketEstimate||0;return e.jsx(J,{title:t.coverTitle,icon:"🌍",children:i>0?e.jsx("p",{dangerouslySetInnerHTML:{__html:t.coverBody(r,i)}}):e.jsx("p",{children:t.coverScreened(r)})})}function mn(){var c,w,k;const{t,dossiers:a,token:n,mode:r,flash:i,criteria:o}=z(),l=r==="client",f=p.useMemo(()=>{const v=new Set;return a.forEach(S=>{S.angle&&v.add(S.angle)}),[...v]},[a]),[d,u]=p.useState(null);p.useEffect(()=>{let v=!0;return Na(n).then(S=>{v&&u(S.thumbs)}),()=>{v=!1}},[n]);const[h,s]=p.useState(""),[y,b]=p.useState(""),[m,x]=p.useState(!1),g=async()=>{const v=h.trim();if(!(!v||m||!l)){x(!0),b("");try{const C=await(await fetch(`${ze}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:v,who:"atelier2"})})).json().catch(()=>({}));if(C.reply&&b(String(C.reply)),C.job_id){b(t.critChatRunning);const F=async()=>{const N=await fetch(`${ze}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:C.job_id})}).then(T=>T.json()).catch(()=>null);if(N&&N.done){b(String(N.reply||N.clarification||N.summary||"✓")),x(!1),N.applied&&i(t.alertSaved);return}setTimeout(()=>{F()},8e3)};setTimeout(()=>{F()},8e3),s("");return}s("")}finally{y.startsWith("⏳")||x(!1)}}};return e.jsxs(J,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((c=o.points)!=null&&c.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(v=>e.jsx("li",{children:v},v))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((w=o==null?void 0:o.angles)!=null&&w.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(v=>{var S,C;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:v.title}),v.why&&e.jsx("p",{className:"why",children:v.why}),e.jsxs("div",{className:"lo",children:[!!((S=v.look)!=null&&S.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:v.look.map(F=>e.jsx("li",{children:F},F))})]}),!!((C=v.out)!=null&&C.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:v.out.map(F=>e.jsx("li",{children:F},F))})]})]})]},v.title)})]}),!!((k=o==null?void 0:o.gate)!=null&&k.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(v=>e.jsxs("li",{children:[v.k&&e.jsx("b",{children:v.k}),v.t]},v.t))})]}),f.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(v=>e.jsx("li",{style:{marginBottom:5},children:v.replace(/[_-]+/g," ")},v))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:h,disabled:!l||m,onChange:v=>s(v.target.value),onKeyDown:v=>{v.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!l||m||!h.trim(),onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),y&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:y})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),d===null?e.jsx("div",{className:"sp-empty",children:"…"}):d.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:d.slice(0,12).map((v,S)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:v.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:v.company}),e.jsx("span",{className:"qd",children:(v.ts||"").slice(0,10)})]},S))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([v,S])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(qt[v]||"v-cons"),children:v}),e.jsx("span",{children:S})]},v))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([v,S])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:v}),e.jsxs("span",{children:["← ",S]})]},v))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function xn(){const{t,dispatch:a,startTour:n}=z(),r=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return e.jsxs(J,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([i,o],l)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:f=>{(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:l+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const Pt=p.createContext(null),z=()=>{const t=p.useContext(Pt);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function we({o:t,lg:a}){const{lang:n}=z(),r=Y(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:ft(r,n),children:[r.emoji," ",ft(r,n)]}):null}function Pe({o:t,src:a}){const{lang:n,t:r}=z(),i=Y(t);if(!i)return null;const o=Ma(i),l=Da(i);return e.jsxs("em",{className:"sigwin"+(l?" hot":""),title:r.signaledOn(Ot(i,n))+" · "+r.win7(Lt(i,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(f,d)=>e.jsx("i",{className:d<o?"on":""},d))}),e.jsx("span",{className:"lb",children:l?r.lastDay:r.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&e.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:f=>f.stopPropagation(),children:"↗"})]})}function Bt({o:t}){const{lang:a}=z(),n=Ra(t.cc),r=t.cc?ye(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const Nt="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",It=t=>`atl2:tour:${t||"anon"}`;function gn(t){try{return localStorage.getItem(It(t))==="1"}catch{return!0}}function St(t){try{localStorage.setItem(It(t),"1")}catch{}}function hn(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function kn({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:i,onFiltersChange:o}){const{lang:l}=Oa(),f=_a[l],d=tr(t,l,a),[u,h]=p.useReducer(rr,void 0,()=>ar((r==null?void 0:r.continent)??"europe",t,{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),s=p.useRef(o);s.current=o,p.useEffect(()=>{var j;(j=s.current)==null||j.call(s,u.filters)},[u.filters]);const[y,b]=p.useState(null),[m,x]=p.useState(null),[g,c]=p.useState({kept:0,dropped:0}),[w,k]=p.useState(!1),[v,S]=p.useState(""),[C,F]=p.useState(!1),[N,T]=p.useState(null),[I,O]=p.useState(!1),[M,B]=p.useState(!1),[,E]=p.useState(0),R=()=>E(j=>j+1),P=p.useRef([]),_=p.useRef(new Set),re=p.useRef(new Set),me=p.useRef(new Map),ke=p.useRef(null),{mode:je}=d,V=p.useMemo(()=>i?{...d.caps,...i}:d.caps,[d.caps,i]),ie=V.pipe,q=d.session.token||"",U=je==="client"&&!t;p.useEffect(()=>{if(document.querySelector(`link[href="${Nt}"]`))return;const j=document.createElement("link");j.rel="stylesheet",j.href=Nt,document.head.appendChild(j)},[]);const D=(j,A=!1)=>{S(j),F(A),ke.current&&clearTimeout(ke.current),ke.current=setTimeout(()=>S(""),A?4200:2400)},W=j=>D(j,!0),Z=p.useMemo(()=>{const j=new Map;return d.dossiers.forEach(A=>{A.id&&j.set(A.id,A)}),j},[d.dossiers]),ee=p.useMemo(()=>d.dossiers.filter(j=>Rt(j,u,ie)),[d.dossiers,u,ie]),te=p.useRef(!1);p.useEffect(()=>{if(te.current||t||d.loading||!d.dossiers.length)return;if(!V.showFunnel||gn(d.session.token||"")){te.current=!0;return}te.current=!0;const j=window.setTimeout(()=>{St(d.session.token||""),O(!0)},700);return()=>window.clearTimeout(j)},[t,d.loading,d.dossiers.length,V.showFunnel,d.session.token]);const ae=p.useMemo(()=>d.dossiers.filter(j=>nr(j,u,ie,d.favIds)),[d.dossiers,u,ie,d.favIds]),K=p.useMemo(()=>La(ee,d.favIds),[ee,d.favIds]),xe=We.find(j=>j.key===u.continent),$=l==="fr"?xe.fr:xe.en,ne=(j,A)=>{const L=((j==null?void 0:j.name)||A||"").trim();if(!U){x({kicker:L});return}!L||w||(k(!0),(async()=>{try{const H=await At(q,L,"atelier2"),Ae={name:H.company||L,verdict:H.verdict,reason:H.reason||"",remaining:H.remaining??null};P.current=[Ae,...P.current].slice(0,8),H.verdict==="kept"&&c(pe=>({...pe,kept:pe.kept+1})),H.verdict==="ruled_out"&&c(pe=>({...pe,dropped:pe.dropped+1}));const Se=j||d.dossiers.find(pe=>(pe.name||"").toLowerCase()===L.toLowerCase());Se&&(H.verdict==="kept"?Se.verdict=Se.verdict||"MATCH":H.verdict==="ruled_out"&&(Se.verdict="NO MATCH"),H.reason&&(Se.reasoning=H.reason)),R()}finally{k(!1)}})())},de=j=>{if(!U){x({kicker:j.name});return}_.current.add(j.id),Ce(q,"fast_request",j.name||"",""),D(f.memoInstantSent(j.name)),R()},Ne=j=>me.current.get(j.id)??d.thumbs.get((j.name||"").trim().toLowerCase()),ce=(j,A)=>h({type:"undoPush",entry:{id:j.id,name:j.name,prevCeoStatus:A}}),G=async(j,A,L)=>{const H=j.ceoStatus||"";j.ceoStatus=A,R();const Ae=await $e(q,{status:A,airtable_id:j.airtableId,check_id:j.checkId,company:j.name,...(L==null?void 0:L.note)!==void 0?{note:L.note}:{},...L!=null&&L.via?{via:L.via}:{}});return Ae.ok?Ae.skipped?(j.ceoStatus=H,R(),W(f.actNotPersisted),!1):((L==null?void 0:L.undo)!==!1&&ce(j,H),L!=null&&L.msg&&D(L.msg),(A==="Validé"||A==="Écarté")&&!j.ceoNote&&(L==null?void 0:L.note)===void 0&&T({o:j,yes:A==="Validé"}),!0):(j.ceoStatus=H,R(),W(f.actErr),!1)},Ee=async(j,A)=>{const L=await $e(q,{status:j.ceoStatus||"Retenu",airtable_id:j.airtableId,check_id:j.checkId,company:j.name,note:A,via:"note"});return!L.ok||L.skipped?(W(L.skipped?f.actNotPersisted:f.actErr),!1):(j.ceoNote=A,R(),!0)},ge=p.useRef(new Map),le=j=>ge.current.has(j.id)?ge.current.get(j.id):d.stages.get((j.name||"").trim().toLowerCase()),he=(j,A)=>{ge.current.set(j.id,A),R()},$t=(j,A)=>{U&&G(j,A?"Validé":"Écarté",{msg:A?f.decidedYes(j.name):f.decidedNo(j.name)})},Vt=j=>{U&&G(j,"À trancher",{msg:f.promoted(j.name)})},Ut=j=>{U&&(async()=>{const A=j.ceoStatus||"";j.ceoStatus="Retenu",R();const L=await $e(q,{status:"Retenu",check_id:j.checkId,company:j.name});if(!L.ok||L.skipped){j.ceoStatus=A,R(),W(L.skipped?f.actNotPersisted:f.actErr);return}ce(j,A),D(f.repeched(j.name))})()},_t=()=>{const j=u.undo[u.undo.length-1];if(!j){D(f.undoNone);return}const A=Z.get(j.id);if(!A){h({type:"undoPop"}),D(f.undoNone);return}let L=j.prevCeoStatus;if(!L)if((A.verdict||"").toUpperCase().includes("CALL"))L="À trancher";else{D(f.undoLockedTitle);return}(async()=>await G(A,L,{undo:!1})&&(h({type:"undoPop"}),A.ceoStatus=j.prevCeoStatus,R(),D(f.undoDone(A.name))))()},Ht=j=>{U&&(re.current.add(j.id),R(),(async()=>{const A=await qa(q,j.name,"email");if(!A||A.ok===!1){re.current.delete(j.id),R(),W(f.actErr);return}Ce(q,"approach",j.name||"",""),D(f.actApproachSent)})())},Yt=(j,A)=>{U&&(async()=>{if(!(await Ce(q,A?"yes":"no",j.name||"","")).ok){W(f.actErr);return}me.current.set(j.id,A?"yes":"no"),R(),D(A?f.thumbUpDone:f.thumbDnDone)})()},Wt=j=>{!U||!Ge(j)||(Ce(q,"detailed_request",j.name||"",""),D(f.memoDeepSent(j.name)))},Gt=j=>{const A=new Set(d.favIds),L=A.has(j.id);L?A.delete(j.id):A.add(j.id),d.setFavIds(A),U&&Pa(q,{id:j.id,co:j.name},L)},Kt=()=>{!U||M||window.confirm(f.identSyncConfirm)&&(B(!0),(async()=>{const j=await Ba(q);B(!1),j?D(f.identSyncDone):W(f.actErr)})())},et=/proplace/i.test(d.fund||""),Qt=j=>{!U||!et||(Ce(q,"onboard_request",j.name||"",""),D(f.onboardSent(j.name)))},Jt={st:u,dispatch:h,t:f,lang:l,mode:je,caps:V,pipe:ie,token:q,fund:d.fund,email:d.email,criteria:d.criteria,data:d,doRepeche:Ut,thumbOf:Ne,canWrite:U,commitStatus:G,saveNote:Ee,stageOf:le,setStage:he,flashErr:W,startTour:()=>O(!0),dossiers:d.dossiers,scopedAll:ee,scoped:ae,counts:K,byId:Z,contName:$,favIds:d.favIds,toggleFav:Gt,askEvaluate:ne,doAnalyse:de,doDecide:$t,doPromote:Vt,doApproach:Ht,doThumb:Yt,doDeep:Wt,doUndo:_t,doSync:Kt,doOnboard:Qt,outbound:et,memoQueued:_.current,approachDone:re.current,sessTally:g,evalCards:P.current,evalBusy:w,markRow:b,markedId:y,flash:D};return p.useEffect(()=>{const j=A=>{A.key==="Escape"&&(h({type:"popup",id:null}),h({type:"modal",modal:null}),h({type:"openFacet",facet:null}))};return window.addEventListener("keydown",j),()=>window.removeEventListener("keydown",j)},[]),e.jsx(Pt.Provider,{value:Jt,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Wa}),e.jsxs("div",{className:"app"+(ie?" pipe":""),children:[V.showTicker&&e.jsx(or,{}),V.showIdent&&e.jsx(kr,{}),V.showOnb&&e.jsx(jr,{}),e.jsx(wr,{}),e.jsx(fr,{}),e.jsx(mr,{}),V.showFunnel&&e.jsx(bn,{}),V.showFunnel&&e.jsx(Sr,{}),V.showFunnel&&e.jsx(zr,{}),e.jsxs("div",{className:"fzone",children:[e.jsx(vn,{}),e.jsxs("div",{className:"stage"+(u.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(Er,{}),e.jsx(Ar,{})]})]}),V.showDemand&&e.jsx(Lr,{}),V.showDemand&&u.memoConsole&&e.jsx(Rr,{}),e.jsx(Vr,{}),d.loading&&e.jsx("div",{className:"void",children:f.loadingV2}),d.error&&!d.loading&&e.jsxs("div",{className:"void",children:[f.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:f.retry})]})]}),V.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:f.lockbarText}),e.jsx("button",{type:"button",onClick:()=>h({type:"modal",modal:"rdv"}),children:f.lockbarCta})]}),u.popupId&&e.jsx(Hr,{}),e.jsx(Qr,{}),e.jsx(cr,{}),N&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:N.o.name}),e.jsx(br,{placeholder:N.yes?f.whyYesPh:f.whyNoPh,onDone:j=>{const A=N.o;T(null),j&&Ee(A,j).then(L=>{L&&D(f.csNoteSaved)})}})]}),I&&e.jsx(yr,{steps:hn(f),onClose:()=>{O(!1),St(q)}}),v&&e.jsx("div",{className:"flash on"+(C?" err":""),children:v}),m&&e.jsx(Fa,{variant:"acquirer",initialCompany:Ct().co,initialWebsite:Ct().site,onClose:()=>x(null)})]})})}function bn(){const{t}=z(),[a,n]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function vn(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:i,t:o}=z(),l=p.useMemo(()=>{const f={};return t.forEach(d=>{d.continent&&Qe(d,a.filters,r)&&(f[d.continent]=(f[d.continent]||0)+1)}),f},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[Ia.map(f=>{const d=We.find(u=>u.key===f);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===f,onClick:()=>n({type:"continent",key:f}),children:[i==="fr"?d.fr:d.en,e.jsx("span",{className:"n",children:l[f]||0})]},f)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Ct(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function yn(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{Bt as FlagCell,we as SigBadge,Pe as SigWin,kn as default,yn as fmtShort,z as useV2};
