...
.atl2 .bulk .side .hint{white-space:nowrap}`,Uo=`
...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,_o=Bo+Uo;function da(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Vo(){const e=da("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ho(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Vo();return r==="0"?"client":r==="1"||da("embed")==="1"&&da("chrome")==="1"?"apercu":"client"}const Yo={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Wo=e=>Yo[e];function Go(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const He=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Dn(a)||Go(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Hr(e.cc)})};function Xt(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ko=60*60*1e3;function Qo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ko?null:a}catch{return null}}function Ct(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Jo=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Xo(e,a,r="default"){const n=r!=="default",o=h.useMemo(()=>e||n?{mode:"anon"}:Fr(),[e,n]),i=h.useMemo(()=>n?"visiteur":Ho(e,o),[e,o,n]),l=h.useMemo(()=>Wo(i),[i]),s=i!=="visiteur",p=Jo(r),[g,d]=h.useState([]),[m,u]=h.useState(""),[x,c]=h.useState(null),[b,v]=h.useState(null),[f,y]=h.useState(null),[k,w]=h.useState(()=>new Map),[S,A]=h.useState(()=>new Map),[T,D]=h.useState(""),[E,M]=h.useState(new Set),[q,R]=h.useState(null),[U,j]=h.useState(!0),[C,L]=h.useState(!1),[H,G]=h.useState(0),[X,z]=h.useState(0),O=h.useRef(0),B=h.useMemo(()=>{var I;if(i!=="client")return"";try{return((I=Pr())==null?void 0:I.email)||""}catch{return""}},[i]);h.useEffect(()=>{const I=++O.current;let _=!0;const W=()=>_&&I===O.current,J=(s&&o.token?o.token:"pub:"+a)+(p?":"+p:""),re=Qo(J);return re?(d(re.objs.map(He)),re.fund&&u(re.fund),c(re.marketEstimate??null),v(re.criteria??null),y(re.stats??null),D(re.generatedAt||""),j(!1)):j(!0),(async()=>{try{if(r==="ops"){const fe=await Kt(),pe=((fe==null?void 0:fe.recent_ops)||[]).map(K=>{const ee=Qt(K.company_name||K.title?K:{...K,title:(K.headline_fr||K.headline||"").slice(0,120)},a),xe=String(K.rubrique||"").toLowerCase();return ee&&(xe==="nominations"||xe==="recrutements")&&(ee.engine=xe),ee&&!String(K.company_name||"").trim()&&(ee.noCo=!0),ee}).filter(K=>!!K).map(K=>(Dn((K.name||"").trim())||(K.noCo=!0),K));try{const K=await Dr(),ee=Ir(K),xe=((K==null?void 0:K.date)||"").slice(0,10);if(ee.length&&xe){const Z=new Set;for(const se of pe){if(se.noCo||(se.date||"").slice(0,10)!==xe)continue;const te=$a(ee,Z,se.name,"");te>=0&&(Z.add(te),se.decryptHtml=ee[te].html)}for(const se of pe){if(se.decryptHtml||(se.date||"").slice(0,10)!==xe)continue;const te=$a(ee,Z,"",se.headline||se.tagline||se.name);te>=0&&(Z.add(te),se.decryptHtml=ee[te].html)}}}catch{}if(!W())return;d(pe.map(He)),Ct(J,{objs:pe})}else if(typeof r=="object"){const pe=(await Ba()||[]).filter(ee=>(ee.slug||"")===r.research).map(ee=>Ua(ee,a)).filter(ee=>!!ee),K=Xt(await _a(pe,a));if(!W())return;d(K.map(He)),Ct(J,{objs:K})}else if(s&&o.token){const fe=$r(o.token),pe=Kt(),K=Br(o.token),ee=Ur(o.token),xe=_r(o.token),Z=await fe;let se=Z?Z.targets:[];W()&&Z&&(u(Z.fund||""),c(Z.marketEstimate??null),v(Z.criteria??null),y(Z.stats??null),D(Z.generatedAt||""),d(se.map(He)),j(!1),L(!1));const[te,Se,he,be]=await Promise.all([pe,K,ee,xe]),et=((te==null?void 0:te.recent_ops)||[]).map(Ae=>Qt(Ae,a)).filter(Ae=>!!Ae);if(se=[...se,...et],!W())return;d(se.map(He));const tt=new Set;for(const Ae of Se){const ze=(Ae.id||Ae.co||"").toString().trim().toLowerCase();ze&&tt.add(ze.startsWith("t:")?ze:"t:"+ze)}M(tt),w(he),A(be),Z&&Ct(J,{fund:Z.fund,marketEstimate:Z.marketEstimate,criteria:Z.criteria,stats:Z.stats,generatedAt:Z.generatedAt,objs:se})}else{const fe=Vr(),pe=Ba(),K=Kt(),ee=await fe;W()&&ee.length&&(d(Xt(ee).map(He)),j(!1),L(!1));const[xe,Z]=await Promise.all([pe,K]),se=(xe||[]).map(be=>Ua(be,a)).filter(be=>!!be),te=await _a(se,a),Se=((Z==null?void 0:Z.recent_ops)||[]).map(be=>Qt(be,a)).filter(be=>!!be),he=Xt([...ee,...te,...Se]);if(!W())return;d(he.map(He)),Ct(J,{objs:he})}W()&&L(!1)}catch{W()&&!re&&L(!0)}finally{W()&&j(!1)}})(),()=>{_=!1}},[s,o.token,a,H,p]),h.useEffect(()=>{if(!l.showCredits||!B){R(null);return}let I=!0;return(async()=>{try{const _=await fetch(`${Ca}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:B})});if(!_.ok)return;const W=await _.json();I&&W&&W.ok!==!1&&R(W)}catch{}})(),()=>{I=!1}},[l.showCredits,B,X]);const P=h.useCallback(I=>M(new Set(I)),[]);return{session:o,mode:i,caps:l,fund:m,email:B,marketEstimate:x,generatedAt:T,criteria:b,stats:f,thumbs:k,stages:S,dossiers:g,favIds:E,setFavIds:P,credits:q,reloadCredits:()=>z(I=>I+1),loading:U,error:C,refresh:()=>G(I=>I+1)}}const Vn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Zo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Vn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function ei(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Vn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Hn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Hn=40;function Ta(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ge(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ea(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(Ve(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&We(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(o))return!1}return!0}function Yn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ta(e,a.filters,r)}function ti(e,a,r,n){return!(!Yn(e,a,r)||r&&!Yr(e,a.ptab,n))}function La(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-Ve(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"signal":{const i=ge(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),s=n(i);return l<s?-a.dir:l>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const ai=["ma","levees","nominations","recrutements","actualites"],ni=300,Zt=7,ri={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Wn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},oi=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Xa(e){const a=ge(e);if(a)return"sig:"+(a.theme&&Wn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function ii(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:l}=F(),s=l==="en",[p,g]=h.useState("all"),[d,m]=h.useState(!1),u=h.useMemo(()=>{const E=(a.filters.day||"").slice(0,10),M=j=>!(!i&&a.continent!=="monde"&&j.continent!==a.continent||E&&(j.date||"").slice(0,10)!==E),q=e.filter(j=>M(j)&&ge(j)),R=e.filter(j=>M(j)&&j.kind==="op"&&!ge(j)&&(E?!0:Ve(j.date)<=Zt)),U=E||new Date().toISOString().slice(0,10);return R.sort((j,C)=>{const L=(j.date||"").slice(0,10)===U?0:1,H=(C.date||"").slice(0,10)===U?0:1;return L!==H?L-H:(C.amountEur||0)-(j.amountEur||0)}),[...La(q,{key:"signal",dir:-1}),...R]},[e,a.continent,a.filters.day,i]),x=h.useMemo(()=>{const E={};for(const M of u){const q=Xa(M);E[q]=(E[q]||0)+1}return E},[u]),c=h.useMemo(()=>p==="all"?u:u.filter(E=>Xa(E)===p),[u,p]),b=h.useMemo(()=>c.slice(0,ni),[c]),v=c.length-b.length,f=E=>E==="all"?u.length:x[E]||0,y=E=>E==="all"?s?"All":"Tout":E.startsWith("sig:")?Wn[s?"en":"fr"][E.slice(4)]||"🔔":ri[s?"en":"fr"][E],k=[{k:"all"}],w=ai.filter(E=>f(E)>0||E===p);if(w.length){k.push({g:s?"DEALS":"OPÉRATIONS"});for(const E of w)k.push({k:E})}const S=oi.map(E=>"sig:"+E).filter(E=>f(E)>0||E===p);if(S.length){k.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const E of S)k.push({k:E})}const A=E=>{try{return new Date(E+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return E}},T=(()=>{const E=(a.filters.day||"").slice(0,10),M=!i&&a.continent!=="monde"&&o?s?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return E?(s?`LIVE covers the events of ${A(E)}.`:`Le LIVE regroupe les événements du ${A(E)}.`)+M:(s?`LIVE covers the still-open signals and the deals of the last ${Zt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Zt} derniers jours.`)+M})(),D=E=>b.map(M=>t.jsxs("button",{type:"button",className:"tk"+(Ee(M)?" spent":""),onClick:q=>{const R=q.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:R.left+R.width/2,y:R.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(Je,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(Nr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:$l(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(Yt,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},E+(M.id||M.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},E+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:E=>{E.currentTarget.contains(E.relatedTarget)||m(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":d,onClick:()=>m(E=>!E),children:[y(p),t.jsx("b",{children:f(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!d,children:[t.jsx("span",{className:"tkfilscope",children:T}),k.map(E=>"g"in E?t.jsx("span",{className:"tkfilg",children:E.g},E.g):t.jsxs("button",{type:"button","aria-pressed":E.k===p,onClick:()=>{g(E.k),m(!1)},children:[y(E.k),t.jsx("b",{children:f(E.k)})]},E.k))]})]}),t.jsx("div",{className:"win",children:b.length?t.jsxs("div",{className:"run",children:[D(0),D(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})})]})}const si="aDx8z7Hzksus",Gn="+33 6 83 10 72 86",Za="alexandre@proplace.co",li=`tel:${Gn.replace(/[^\d+]/g,"")}`,en="pp-rdv-slot";function di(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ci(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:ui}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:li,children:Gn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Za}`,children:Za})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([o,i],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Po,{filloutId:si,parameters:r?{company_name:r}:void 0})})]})}function pi(){const[e,a]=h.useState(()=>typeof document>"u"?null:document.getElementById(en));return h.useEffect(()=>{e||a(document.getElementById(en))},[e]),e?lt.createPortal(t.jsx(ci,{}),e):null}const ui=`
...
`;class ve extends h.Component{constructor(){super(...arguments);Da(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const mi=8;function fi(){const{t:e,lang:a,token:r,dossiers:n,caps:o,markRow:i,dispatch:l}=F(),[s,p]=h.useState(!1),[g,d]=h.useState(!1),[m,u]=h.useState(!1),x=r||"home",{names:c,verdicts:b}=h.useMemo(()=>{const w=[],S={};return n.forEach(A=>{A.kind!=="target"||!A.name||(w.push(A.name),S[A.name]=Wr(A)||"")}),{names:w,verdicts:S}},[n]),v=h.useMemo(()=>c.length?Gr(x,c,b,a):null,[x,c.length]);if(!o.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const f=g?v.added:v.added.slice(0,mi),y=v.added.length-f.length,k=w=>{const S=n.find(A=>A.name===w);S&&(i(S.id),l({type:"popup",id:S.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Kr(x,c,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[f.map(w=>t.jsx("button",{type:"button",onClick:()=>k(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),m&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const ea=600,Ye=62,tn="atl2:fstats";function xi(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=F(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(tn)==="on"}catch{return!1}}),p=r.stats,g=h.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=h.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const m=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),x=g.reduce((y,k)=>Math.max(y,k.s||0),0),c=g.length?ea/g.length:0,b=Math.max(4,c-4),v=g.length>=5&&x>0,f=[[p.screened,e.funScreened(m(d)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[f.map(([y,k,w],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:k}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},k)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(tn,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ea} ${Ye}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((y,k)=>{const w=(y.s||0)/x*(Ye-4),S=(y.m||0)/x*(Ye-4),A=k*c+(c-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:Ye-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:Ye-2-S,width:b,height:S,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Ye-1.5,x2:ea,y2:Ye-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const hi=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function gi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=F(),[i,l]=h.useState(""),[s,p]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(Xe(e)||"").startsWith("CALL")&&ke(e)===3,m=ke(e)>=2,u=async c=>{if(i||c==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(c);const b=await o(e,c);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},x=d?[["Validé",a.csYes],["Écarté",a.csNo]]:hi.filter(([c])=>!(m&&c==="Retenu")).map(([c,b])=>[c,a[b]]);return t.jsxs("div",{className:"csp",onClick:c=>c.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),x.map(([c,b])=>t.jsx("button",{type:"button",className:"csb"+(g===c?" on":"")+(i===c?" busy":""),disabled:!!i,onClick:()=>{u(c)},children:b},c)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(bi,{o:e})]})}function bi({o:e}){const{t:a,saveNote:r,flash:n}=F(),[o,i]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[p,g]=h.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!d)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:l,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{m()},children:p?a.csNoteSaved:a.csNoteOk})]})}function vi({placeholder:e,onDone:a}){const{t:r}=F(),[n,o]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function yi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:l,flashErr:s}=F(),[p,g]=h.useState(!1);if(!n.pipe||!o||n.lockActions||ke(e)!==4)return null;const d=i(e),m=(d==null?void 0:d.stage)||"todo",u=async f=>{if(p||f===m)return;g(!0);const y=d;l(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const k=Math.max(Date.now(),an+=1);an=k;const w=await Qr(r,{company:e.name||"",stage:f,cts:k,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},x=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,c=x?Math.floor((Date.now()-Date.parse(x))/864e5):0,b=m==="sent"&&x&&c>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(m===f?" on":""),disabled:p,onClick:()=>{u(f)},children:y},f)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(c)})]})}let an=0;const Et=8,At=360;function nn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function rn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(nn,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(nn,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function wi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=F(),[l,s]=h.useState(0),[p,g]=h.useState(null),[d,m]=h.useState([]),u=h.useRef(!1);h.useEffect(()=>{u.current||(u.current=!0,m(e.filter(k=>!!document.querySelector(k.need||k.sel))))},[e]);const x=d[l],c=l>=d.length;h.useEffect(()=>{if(x&&(x.ptab!==void 0&&i.ptab!==x.ptab&&n({type:"ptab",tab:x.ptab}),x.dens&&i.dens!==x.dens&&n({type:"dens",dens:x.dens}),i.modal!==(x.modal??null)&&n({type:"modal",modal:x.modal??null}),x.click)){const k=x.click,w=window.setTimeout(()=>{const S=document.querySelector(k);S&&S.getAttribute("aria-selected")!=="true"&&S.click()},60);return()=>window.clearTimeout(w)}},[l,x]);const b=h.useCallback(()=>{if(!x){g(null);return}const k=document.querySelector(x.sel);if(!k){g(null);return}k.scrollIntoView({block:"nearest",behavior:"smooth"}),g(k.getBoundingClientRect())},[x]);h.useLayoutEffect(()=>{b();const k=[90,300,700,1300].map(S=>window.setTimeout(b,S)),w=()=>b();return window.addEventListener("scroll",w,!0),window.addEventListener("resize",w),()=>{k.forEach(S=>window.clearTimeout(S)),window.removeEventListener("scroll",w,!0),window.removeEventListener("resize",w)}},[b]);const v=h.useRef(a);if(v.current=a,h.useEffect(()=>{const k=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),v.current()):w.key==="ArrowRight"?s(S=>S+1):w.key==="ArrowLeft"&&s(S=>Math.max(0,S-1))};return document.addEventListener("keydown",k,!0),()=>document.removeEventListener("keydown",k,!0)},[]),!d.length)return null;let f=null;if(c){const k=o[3]||0;k>0?f={title:k===1?r.ahaATitle1:r.ahaATitleN(k),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:(o[1]||0)>0?f={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:()=>{n({type:"ptab",tab:1}),a()}}:(o[0]||0)>0?f={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:()=>{n({type:"ptab",tab:0}),a()}}:f={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:At};if(!c&&p){const k=p.bottom+14,S=window.innerHeight-k>190?k:Math.max(12,p.top-200);y={left:Math.min(Math.max(12,p.left+p.width/2-At/2),window.innerWidth-At-12),top:S,width:At}}return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!c&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-Et,top:p.top-Et,width:p.width+Et*2,height:p.height+Et*2}}),(c||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(c?" fin":""),style:y,children:[c&&f?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:f.title}),t.jsx(rn,{text:f.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:f.go,children:f.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:x==null?void 0:x.title}),t.jsx(rn,{text:(x==null?void 0:x.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(k=>Math.max(0,k-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(k=>k+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Kn(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Qn(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ki(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:l,dispatch:s}=F(),p=r?a:e,g=h.useMemo(()=>p.filter(S=>Ve(S.date)===0&&S.kind==="target"),[p]),d=h.useMemo(()=>r?a.filter(S=>ke(S)===0).slice().sort((S,A)=>(A.date||"").localeCompare(S.date||"")):[],[a,r]),m=h.useMemo(()=>g.filter(S=>r?ke(S)===0:!Ee(S)),[g,r]),u=r?d:m,x=r?a.length-d.length:g.length-m.length,c=r?a.length:g.length,b=c?Math.min(100,x/c*100):100,v=h.useMemo(()=>Kn(p),[p]),f=!!v&&Ve(v)>0,y=h.useMemo(()=>f?p.filter(S=>(S.date||"").slice(0,10)===v):[],[p,v,f]);let k;f?k=o.morningLast(y.length,d.length,Qn(v,l)):r?k=o.morningThesis(g.length,d.length):g.length?x===0?k=o.goalSourced(g.length):x>=g.length?k=o.goalCleared:k=o.goalDone(x,g.length):k=o.goalSourced(0);const w=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&d.length&&s({type:"chainStart",queue:d.map(S=>S.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:k}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:b+"%"}})}),u.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:w,children:r?o.morningEval(u.length):i.pileMode?o.goalContinue(u.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ji(){var M,q;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:l,dossiers:s,mode:p,doSync:g,startTour:d}=F(),[m,u]=h.useState(null),[x,c]=h.useState([]),b=p==="client";h.useEffect(()=>{if(!o||!i)return;let R=!0;return(async()=>{const[U,j]=await Promise.all([Aa(i),In(o)]);R&&(U&&u(U),c(j))})(),()=>{R=!1}},[o,i]);const v=(m==null?void 0:m.per_day)??null,f=((M=m==null?void 0:m.pool_order)==null?void 0:M.length)??0,y=x.filter(R=>R.status==="running").length,k=h.useMemo(()=>s.filter(R=>R.kind==="target"&&Ee(R)).length,[s]),w=l.marketEstimate,S=typeof((q=l.stats)==null?void 0:q.screened)=="number"?l.stats.screened:k,A=w&&w>0?Math.min(100,Math.round(S/w*100)):null,T=R=>R.toLocaleString(a==="en"?"en-US":"fr-FR"),D=(i||"P").split(/\s+/).map(R=>R[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const R=Date.parse(l.generatedAt||"");if(Number.isNaN(R))return"";const U=new Date(R),j=C=>String(C).padStart(2,"0");return`${j(U.getDate())}/${j(U.getMonth()+1)} à ${j(U.getHours())}:${j(U.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:D}),t.jsx("i",{children:i})]}),t.jsx("h1",{children:e.identTitle(i||"…")}),t.jsx("span",{className:"idsp"}),E&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(E)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[A===null&&S>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:T(S)})})]}),A!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:A+"%"}})}),t.jsxs("b",{children:[A," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(S,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(f)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:R=>{R.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:R=>n({type:"filters",patch:{search:R.target.value}})})]})]})]})}function Ni(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,o],i)=>{const l=i===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:i+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:o}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},i)})})]})}const Si=["--p0","--p1","--p2","--p3","--p4"];function Ci(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:l}=F(),s=i.loading&&!l.length,p=h.useRef({});h.useEffect(()=>{p.current={...r}},[r]);const g=u=>{const x=p.current[u],c=x!==void 0?r[u]-x:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Si[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(c>0?" up":c<0?" down":""),children:[r[u],c!==0&&t.jsxs("em",{className:"delta",children:[c>0?"+":"−",Math.abs(c)]})]})]},u)},d=(u,x,c)=>t.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:c.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,x,c,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:x,disabled:b,onClick:c,children:u},x);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,o,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Ei=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Ai(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:l}=F(),s=h.useRef(null),[p,g]=h.useState(60);h.useEffect(()=>{let x=0;const c=()=>{var k;const b=s.current;if(!b)return;const v=(k=b.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!v)return;const f=v.getBoundingClientRect(),y=b.getBoundingClientRect();g(Math.max(20,Math.min(f.left+f.width/2-y.left,y.width-30)))};return x=requestAnimationFrame(c),window.addEventListener("resize",c),()=>{cancelAnimationFrame(x),window.removeEventListener("resize",c)}},[e.ptab]);const d=e.ptab;let m=r.tuto[d].p;if(d===3){const x=n.filter(v=>v.kind==="target"&&ke(v)===3),c=x.filter(v=>ia(v)==="auto").length,b=x.filter(v=>ia(v)==="cd").length;m=r.tutoPending(c,b,x.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(x=>x.id)})};if(d===1){const x=n.filter(c=>c.kind==="target"&&ke(c)===1&&!o.has(c.id)).slice(0,10);if(x.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:x.map(c=>c.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Ei[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Ke{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],l=a+i,s=Math.abs(a)<Math.abs(i)?a-(l-i):i-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,o=a[--r],l=n+o,i=o-(l-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=l+o,o==n-l&&(l=n))}return l}}function*zi(e){for(const a of e)yield*a}function Jn(e){return Array.from(zi(e))}var ne=1e-6,Q=Math.PI,Re=Q/2,on=Q/4,qe=Q*2,Be=180/Q,Ce=Q/180,ie=Math.abs,Ti=Math.atan,vt=Math.atan2,de=Math.cos,ce=Math.sin,Li=Math.sign||function(e){return e>0?1:e<0?-1:0},Ze=Math.sqrt;function Ri(e){return e>1?0:e<-1?Q:Math.acos(e)}function yt(e){return e>1?Re:e<-1?-Re:Math.asin(e)}function Me(){}function Ft(e,a){e&&ln.hasOwnProperty(e.type)&&ln[e.type](e,a)}var sn={Feature:function(e,a){Ft(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ft(r[n].geometry,a)}},ln={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ca(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ca(r[n],a,0)},Polygon:function(e,a){dn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)dn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ft(r[n],a)}};function ca(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function dn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ca(e[r],a,1);a.polygonEnd()}function nt(e,a){e&&sn.hasOwnProperty(e.type)?sn[e.type](e,a):Ft(e,a)}function pa(e){return[vt(e[1],e[0]),yt(e[2])]}function it(e){var a=e[0],r=e[1],n=de(r);return[n*de(a),n*ce(a),ce(r)]}function zt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Pt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ta(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Tt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ua(e){var a=Ze(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ma(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function fa(e,a){return ie(e)>Q&&(e-=Math.round(e/qe)*qe),[e,a]}fa.invert=fa;function Mi(e,a,r){return(e%=qe)?a||r?ma(pn(e),un(a,r)):pn(e):a||r?un(a,r):fa}function cn(e){return function(a,r){return a+=e,ie(a)>Q&&(a-=Math.round(a/qe)*qe),[a,r]}}function pn(e){var a=cn(e);return a.invert=cn(-e),a}function un(e,a){var r=de(e),n=ce(e),o=de(a),i=ce(a);function l(s,p){var g=de(p),d=de(s)*g,m=ce(s)*g,u=ce(p),x=u*r+d*n;return[vt(m*o-x*i,d*r-u*n),yt(x*o+m*i)]}return l.invert=function(s,p){var g=de(p),d=de(s)*g,m=ce(s)*g,u=ce(p),x=u*o-m*i;return[vt(m*o+u*i,d*r+x*n),yt(x*r-d*n)]},l}function qi(e,a,r,n,o,i){if(r){var l=de(a),s=ce(a),p=n*r;o==null?(o=a+n*qe,i=a-p/2):(o=mn(l,o),i=mn(l,i),(n>0?o<i:o>i)&&(o+=n*qe));for(var g,d=o;n>0?d>i:d<i;d-=p)g=pa([l,-s*de(d),-s*ce(d)]),e.point(g[0],g[1])}}function mn(e,a){a=it(a),a[0]-=e,ua(a);var r=Ri(-a[1]);return((-a[2]<0?-r:r)+qe-ne)%qe}function Xn(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Me,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ot(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Lt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Zn(e,a,r,n,o){var i=[],l=[],s,p;if(e.forEach(function(c){if(!((b=c.length-1)<=0)){var b,v=c[0],f=c[b],y;if(Ot(v,f)){if(!v[2]&&!f[2]){for(o.lineStart(),s=0;s<b;++s)o.point((v=c[s])[0],v[1]);o.lineEnd();return}f[0]+=2*ne}i.push(y=new Lt(v,c,null,!0)),l.push(y.o=new Lt(v,null,y,!1)),i.push(y=new Lt(f,c,null,!1)),l.push(y.o=new Lt(f,null,y,!0))}}),!!i.length){for(l.sort(a),fn(i),fn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var g=i[0],d,m;;){for(var u=g,x=!0;u.v;)if((u=u.n)===g)return;d=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(x)for(s=0,p=d.length;s<p;++s)o.point((m=d[s])[0],m[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(x)for(d=u.p.z,s=d.length-1;s>=0;--s)o.point((m=d[s])[0],m[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,d=u.z,x=!x}while(!u.v);o.lineEnd()}}}function fn(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function aa(e){return ie(e[0])<=Q?e[0]:Li(e[0])*((ie(e[0])+Q)%qe-Q)}function Oi(e,a){var r=aa(a),n=a[1],o=ce(n),i=[ce(r),-de(r),0],l=0,s=0,p=new Ke;o===1?n=Re+ne:o===-1&&(n=-Re-ne);for(var g=0,d=e.length;g<d;++g)if(u=(m=e[g]).length)for(var m,u,x=m[u-1],c=aa(x),b=x[1]/2+on,v=ce(b),f=de(b),y=0;y<u;++y,c=w,v=A,f=T,x=k){var k=m[y],w=aa(k),S=k[1]/2+on,A=ce(S),T=de(S),D=w-c,E=D>=0?1:-1,M=E*D,q=M>Q,R=v*A;if(p.add(vt(R*E*ce(M),f*T+R*de(M))),l+=q?D+E*qe:D,q^c>=r^w>=r){var U=Pt(it(x),it(k));ua(U);var j=Pt(i,U);ua(j);var C=(q^D>=0?-1:1)*yt(j[2]);(n>C||n===C&&(U[0]||U[1]))&&(s+=q^D>=0?1:-1)}}return(l<-ne||l<ne&&p<-1e-12)^s&1}function er(e,a,r,n){return function(o){var i=a(o),l=Xn(),s=a(l),p=!1,g,d,m,u={point:x,lineStart:b,lineEnd:v,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=k,d=[],g=[]},polygonEnd:function(){u.point=x,u.lineStart=b,u.lineEnd=v,d=Jn(d);var w=Oi(g,n);d.length?(p||(o.polygonStart(),p=!0),Zn(d,Pi,w,r,o)):w&&(p||(o.polygonStart(),p=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),p&&(o.polygonEnd(),p=!1),d=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function x(w,S){e(w,S)&&o.point(w,S)}function c(w,S){i.point(w,S)}function b(){u.point=c,i.lineStart()}function v(){u.point=x,i.lineEnd()}function f(w,S){m.push([w,S]),s.point(w,S)}function y(){s.lineStart(),m=[]}function k(){f(m[0][0],m[0][1]),s.lineEnd();var w=s.clean(),S=l.result(),A,T=S.length,D,E,M;if(m.pop(),g.push(m),m=null,!!T){if(w&1){if(E=S[0],(D=E.length-1)>0){for(p||(o.polygonStart(),p=!0),o.lineStart(),A=0;A<D;++A)o.point((M=E[A])[0],M[1]);o.lineEnd()}return}T>1&&w&2&&S.push(S.pop().concat(S.shift())),d.push(S.filter(Fi))}}return u}}function Fi(e){return e.length>1}function Pi(e,a){return((e=e.x)[0]<0?e[1]-Re-ne:Re-e[1])-((a=a.x)[0]<0?a[1]-Re-ne:Re-a[1])}const xn=er(function(){return!0},Di,$i,[-Q,-Re]);function Di(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,l){var s=i>0?Q:-Q,p=ie(i-a);ie(p-Q)<ne?(e.point(a,r=(r+l)/2>0?Re:-Re),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&p>=Q&&(ie(a-n)<ne&&(a-=n*ne),ie(i-s)<ne&&(i-=s*ne),r=Ii(a,r,i,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Ii(e,a,r,n){var o,i,l=ce(e-r);return ie(l)>ne?Ti((ce(a)*(i=de(n))*ce(r)-ce(n)*(o=de(a))*ce(e))/(o*i*l)):(a+n)/2}function $i(e,a,r,n){var o;if(e==null)o=r*Re,n.point(-Q,o),n.point(0,o),n.point(Q,o),n.point(Q,0),n.point(Q,-o),n.point(0,-o),n.point(-Q,-o),n.point(-Q,0),n.point(-Q,o);else if(ie(e[0]-a[0])>ne){var i=e[0]<a[0]?Q:-Q;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Bi(e){var a=de(e),r=2*Ce,n=a>0,o=ie(a)>ne;function i(d,m,u,x){qi(x,e,r,u,d,m)}function l(d,m){return de(d)*de(m)>a}function s(d){var m,u,x,c,b;return{lineStart:function(){c=x=!1,b=1},point:function(v,f){var y=[v,f],k,w=l(v,f),S=n?w?0:g(v,f):w?g(v+(v<0?Q:-Q),f):0;if(!m&&(c=x=w)&&d.lineStart(),w!==x&&(k=p(m,y),(!k||Ot(m,k)||Ot(y,k))&&(y[2]=1)),w!==x)b=0,w?(d.lineStart(),k=p(y,m),d.point(k[0],k[1])):(k=p(m,y),d.point(k[0],k[1],2),d.lineEnd()),m=k;else if(o&&m&&n^w){var A;!(S&u)&&(A=p(y,m,!0))&&(b=0,n?(d.lineStart(),d.point(A[0][0],A[0][1]),d.point(A[1][0],A[1][1]),d.lineEnd()):(d.point(A[1][0],A[1][1]),d.lineEnd(),d.lineStart(),d.point(A[0][0],A[0][1],3)))}w&&(!m||!Ot(m,y))&&d.point(y[0],y[1]),m=y,x=w,u=S},lineEnd:function(){x&&d.lineEnd(),m=null},clean:function(){return b|(c&&x)<<1}}}function p(d,m,u){var x=it(d),c=it(m),b=[1,0,0],v=Pt(x,c),f=zt(v,v),y=v[0],k=f-y*y;if(!k)return!u&&d;var w=a*f/k,S=-a*y/k,A=Pt(b,v),T=Tt(b,w),D=Tt(v,S);ta(T,D);var E=A,M=zt(T,E),q=zt(E,E),R=M*M-q*(zt(T,T)-1);if(!(R<0)){var U=Ze(R),j=Tt(E,(-M-U)/q);if(ta(j,T),j=pa(j),!u)return j;var C=d[0],L=m[0],H=d[1],G=m[1],X;L<C&&(X=C,C=L,L=X);var z=L-C,O=ie(z-Q)<ne,B=O||z<ne;if(!O&&G<H&&(X=H,H=G,G=X),B?O?H+G>0^j[1]<(ie(j[0]-C)<ne?H:G):H<=j[1]&&j[1]<=G:z>Q^(C<=j[0]&&j[0]<=L)){var P=Tt(E,(-M+U)/q);return ta(P,T),[j,pa(P)]}}}function g(d,m){var u=n?e:Q-e,x=0;return d<-u?x|=1:d>u&&(x|=2),m<-u?x|=4:m>u&&(x|=8),x}return er(l,s,i,n?[0,-e]:[-Q,e-Q])}function Ui(e,a,r,n,o,i){var l=e[0],s=e[1],p=a[0],g=a[1],d=0,m=1,u=p-l,x=g-s,c;if(c=r-l,!(!u&&c>0)){if(c/=u,u<0){if(c<d)return;c<m&&(m=c)}else if(u>0){if(c>m)return;c>d&&(d=c)}if(c=o-l,!(!u&&c<0)){if(c/=u,u<0){if(c>m)return;c>d&&(d=c)}else if(u>0){if(c<d)return;c<m&&(m=c)}if(c=n-s,!(!x&&c>0)){if(c/=x,x<0){if(c<d)return;c<m&&(m=c)}else if(x>0){if(c>m)return;c>d&&(d=c)}if(c=i-s,!(!x&&c<0)){if(c/=x,x<0){if(c>m)return;c>d&&(d=c)}else if(x>0){if(c<d)return;c<m&&(m=c)}return d>0&&(e[0]=l+d*u,e[1]=s+d*x),m<1&&(a[0]=l+m*u,a[1]=s+m*x),!0}}}}}var mt=1e9,Rt=-mt;function _i(e,a,r,n){function o(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function i(g,d,m,u){var x=0,c=0;if(g==null||(x=l(g,m))!==(c=l(d,m))||p(g,d)<0^m>0)do u.point(x===0||x===3?e:r,x>1?n:a);while((x=(x+m+4)%4)!==c);else u.point(d[0],d[1])}function l(g,d){return ie(g[0]-e)<ne?d>0?0:3:ie(g[0]-r)<ne?d>0?2:1:ie(g[1]-a)<ne?d>0?1:0:d>0?3:2}function s(g,d){return p(g.x,d.x)}function p(g,d){var m=l(g,1),u=l(d,1);return m!==u?m-u:m===0?d[1]-g[1]:m===1?g[0]-d[0]:m===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,m=Xn(),u,x,c,b,v,f,y,k,w,S,A,T={point:D,lineStart:R,lineEnd:U,polygonStart:M,polygonEnd:q};function D(C,L){o(C,L)&&d.point(C,L)}function E(){for(var C=0,L=0,H=x.length;L<H;++L)for(var G=x[L],X=1,z=G.length,O=G[0],B,P,I=O[0],_=O[1];X<z;++X)B=I,P=_,O=G[X],I=O[0],_=O[1],P<=n?_>n&&(I-B)*(n-P)>(_-P)*(e-B)&&++C:_<=n&&(I-B)*(n-P)<(_-P)*(e-B)&&--C;return C}function M(){d=m,u=[],x=[],A=!0}function q(){var C=E(),L=A&&C,H=(u=Jn(u)).length;(L||H)&&(g.polygonStart(),L&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),H&&Zn(u,s,C,i,g),g.polygonEnd()),d=g,u=x=c=null}function R(){T.point=j,x&&x.push(c=[]),S=!0,w=!1,y=k=NaN}function U(){u&&(j(b,v),f&&w&&m.rejoin(),u.push(m.result())),T.point=D,w&&d.lineEnd()}function j(C,L){var H=o(C,L);if(x&&c.push([C,L]),S)b=C,v=L,f=H,S=!1,H&&(d.lineStart(),d.point(C,L));else if(H&&w)d.point(C,L);else{var G=[y=Math.max(Rt,Math.min(mt,y)),k=Math.max(Rt,Math.min(mt,k))],X=[C=Math.max(Rt,Math.min(mt,C)),L=Math.max(Rt,Math.min(mt,L))];Ui(G,X,e,a,r,n)?(w||(d.lineStart(),d.point(G[0],G[1])),d.point(X[0],X[1]),H||d.lineEnd(),A=!1):H&&(d.lineStart(),d.point(C,L),A=!1)}y=C,k=L,w=H}return T}}const xa=e=>e;var na=new Ke,ha=new Ke,tr,ar,ga,ba,Ue={point:Me,lineStart:Me,lineEnd:Me,polygonStart:function(){Ue.lineStart=Vi,Ue.lineEnd=Yi},polygonEnd:function(){Ue.lineStart=Ue.lineEnd=Ue.point=Me,na.add(ie(ha)),ha=new Ke},result:function(){var e=na/2;return na=new Ke,e}};function Vi(){Ue.point=Hi}function Hi(e,a){Ue.point=nr,tr=ga=e,ar=ba=a}function nr(e,a){ha.add(ba*e-ga*a),ga=e,ba=a}function Yi(){nr(tr,ar)}var st=1/0,Dt=st,wt=-st,It=wt,$t={point:Wi,lineStart:Me,lineEnd:Me,polygonStart:Me,polygonEnd:Me,result:function(){var e=[[st,Dt],[wt,It]];return wt=It=-(Dt=st=1/0),e}};function Wi(e,a){e<st&&(st=e),e>wt&&(wt=e),a<Dt&&(Dt=a),a>It&&(It=a)}var va=0,ya=0,ft=0,Bt=0,Ut=0,rt=0,wa=0,ka=0,xt=0,rr,or,De,Ie,Le={point:Qe,lineStart:hn,lineEnd:gn,polygonStart:function(){Le.lineStart=Qi,Le.lineEnd=Ji},polygonEnd:function(){Le.point=Qe,Le.lineStart=hn,Le.lineEnd=gn},result:function(){var e=xt?[wa/xt,ka/xt]:rt?[Bt/rt,Ut/rt]:ft?[va/ft,ya/ft]:[NaN,NaN];return va=ya=ft=Bt=Ut=rt=wa=ka=xt=0,e}};function Qe(e,a){va+=e,ya+=a,++ft}function hn(){Le.point=Gi}function Gi(e,a){Le.point=Ki,Qe(De=e,Ie=a)}function Ki(e,a){var r=e-De,n=a-Ie,o=Ze(r*r+n*n);Bt+=o*(De+e)/2,Ut+=o*(Ie+a)/2,rt+=o,Qe(De=e,Ie=a)}function gn(){Le.point=Qe}function Qi(){Le.point=Xi}function Ji(){ir(rr,or)}function Xi(e,a){Le.point=ir,Qe(rr=De=e,or=Ie=a)}function ir(e,a){var r=e-De,n=a-Ie,o=Ze(r*r+n*n);Bt+=o*(De+e)/2,Ut+=o*(Ie+a)/2,rt+=o,o=Ie*e-De*a,wa+=o*(De+e),ka+=o*(Ie+a),xt+=o*3,Qe(De=e,Ie=a)}function sr(e){this._context=e}sr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,qe);break}}},result:Me};var ja=new Ke,ra,lr,dr,ht,gt,kt={point:Me,lineStart:function(){kt.point=Zi},lineEnd:function(){ra&&cr(lr,dr),kt.point=Me},polygonStart:function(){ra=!0},polygonEnd:function(){ra=null},result:function(){var e=+ja;return ja=new Ke,e}};function Zi(e,a){kt.point=cr,lr=ht=e,dr=gt=a}function cr(e,a){ht-=e,gt-=a,ja.add(Ze(ht*ht+gt*gt)),ht=e,gt=a}let bn,_t,vn,yn;class wn{constructor(a){this._append=a==null?pr:es(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==vn||this._append!==_t){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,vn=n,_t=this._append,yn=this._,this._=o}this._+=yn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function pr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function es(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return pr;if(a!==bn){const r=10**a;bn=a,_t=function(o){let i=1;this._+=o[0];for(const l=o.length;i<l;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return _t}function ts(e,a){let r=3,n=4.5,o,i;function l(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),nt(s,o(i))),i.result()}return l.area=function(s){return nt(s,o(Ue)),Ue.result()},l.measure=function(s){return nt(s,o(kt)),kt.result()},l.bounds=function(s){return nt(s,o($t)),$t.result()},l.centroid=function(s){return nt(s,o(Le)),Le.result()},l.projection=function(s){return arguments.length?(o=s==null?(e=null,xa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(i=s==null?(a=null,new wn(r)):new sr(a=s),typeof n!="function"&&i.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(i=new wn(r)),l},l.projection(e).digits(r).context(a)}function Ra(e){return function(a){var r=new Na;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Na(){}Na.prototype={constructor:Na,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ma(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),nt(r,e.stream($t)),a($t.result()),n!=null&&e.clipExtent(n),e}function ur(e,a,r){return Ma(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],l=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(i-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function as(e,a,r){return ur(e,[[0,0],a],r)}function ns(e,a,r){return Ma(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),l=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([l,s])},r)}function rs(e,a,r){return Ma(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),l=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,s])},r)}var kn=16,os=de(30*Ce);function jn(e,a){return+a?ss(e,a):is(e)}function is(e){return Ra({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ss(e,a){function r(n,o,i,l,s,p,g,d,m,u,x,c,b,v){var f=g-n,y=d-o,k=f*f+y*y;if(k>4*a&&b--){var w=l+u,S=s+x,A=p+c,T=Ze(w*w+S*S+A*A),D=yt(A/=T),E=ie(ie(A)-1)<ne||ie(i-m)<ne?(i+m)/2:vt(S,w),M=e(E,D),q=M[0],R=M[1],U=q-n,j=R-o,C=y*U-f*j;(C*C/k>a||ie((f*U+y*j)/k-.5)>.3||l*u+s*x+p*c<os)&&(r(n,o,i,l,s,p,q,R,E,w/=T,S/=T,A,b,v),v.point(q,R),r(q,R,E,w,S,A,g,d,m,u,x,c,b,v))}}return function(n){var o,i,l,s,p,g,d,m,u,x,c,b,v={point:f,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=S},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function f(D,E){D=e(D,E),n.point(D[0],D[1])}function y(){m=NaN,v.point=k,n.lineStart()}function k(D,E){var M=it([D,E]),q=e(D,E);r(m,u,d,x,c,b,m=q[0],u=q[1],d=D,x=M[0],c=M[1],b=M[2],kn,n),n.point(m,u)}function w(){v.point=f,n.lineEnd()}function S(){y(),v.point=A,v.lineEnd=T}function A(D,E){k(o=D,E),i=m,l=u,s=x,p=c,g=b,v.point=k}function T(){r(m,u,d,x,c,b,i,l,o,s,p,g,kn,n),v.lineEnd=w,w()}return v}}var ls=Ra({point:function(e,a){this.stream.point(e*Ce,a*Ce)}});function ds(e){return Ra({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function cs(e,a,r,n,o){function i(l,s){return l*=n,s*=o,[a+e*l,r-e*s]}return i.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*o]},i}function Nn(e,a,r,n,o,i){if(!i)return cs(e,a,r,n,o);var l=de(i),s=ce(i),p=l*e,g=s*e,d=l/e,m=s/e,u=(s*r-l*a)/e,x=(s*a+l*r)/e;function c(b,v){return b*=n,v*=o,[p*b-g*v+a,r-g*b-p*v]}return c.invert=function(b,v){return[n*(d*b-m*v+u),o*(x-m*b-d*v)]},c}function ps(e){return us(function(){return e})()}function us(e){var a,r=150,n=480,o=250,i=0,l=0,s=0,p=0,g=0,d,m=0,u=1,x=1,c=null,b=xn,v=null,f,y,k,w=xa,S=.5,A,T,D,E,M;function q(C){return D(C[0]*Ce,C[1]*Ce)}function R(C){return C=D.invert(C[0],C[1]),C&&[C[0]*Be,C[1]*Be]}q.stream=function(C){return E&&M===C?E:E=ls(ds(d)(b(A(w(M=C)))))},q.preclip=function(C){return arguments.length?(b=C,c=void 0,j()):b},q.postclip=function(C){return arguments.length?(w=C,v=f=y=k=null,j()):w},q.clipAngle=function(C){return arguments.length?(b=+C?Bi(c=C*Ce):(c=null,xn),j()):c*Be},q.clipExtent=function(C){return arguments.length?(w=C==null?(v=f=y=k=null,xa):_i(v=+C[0][0],f=+C[0][1],y=+C[1][0],k=+C[1][1]),j()):v==null?null:[[v,f],[y,k]]},q.scale=function(C){return arguments.length?(r=+C,U()):r},q.translate=function(C){return arguments.length?(n=+C[0],o=+C[1],U()):[n,o]},q.center=function(C){return arguments.length?(i=C[0]%360*Ce,l=C[1]%360*Ce,U()):[i*Be,l*Be]},q.rotate=function(C){return arguments.length?(s=C[0]%360*Ce,p=C[1]%360*Ce,g=C.length>2?C[2]%360*Ce:0,U()):[s*Be,p*Be,g*Be]},q.angle=function(C){return arguments.length?(m=C%360*Ce,U()):m*Be},q.reflectX=function(C){return arguments.length?(u=C?-1:1,U()):u<0},q.reflectY=function(C){return arguments.length?(x=C?-1:1,U()):x<0},q.precision=function(C){return arguments.length?(A=jn(T,S=C*C),j()):Ze(S)},q.fitExtent=function(C,L){return ur(q,C,L)},q.fitSize=function(C,L){return as(q,C,L)},q.fitWidth=function(C,L){return ns(q,C,L)},q.fitHeight=function(C,L){return rs(q,C,L)};function U(){var C=Nn(r,0,0,u,x,m).apply(null,a(i,l)),L=Nn(r,n-C[0],o-C[1],u,x,m);return d=Mi(s,p,g),T=ma(a,L),D=ma(d,T),A=jn(T,S),j()}function j(){return E=M=null,q}return function(){return a=e.apply(this,arguments),q.invert=a.invert&&R,U()}}function mr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}mr.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,l=i*i;r-=o=(r*(1.007226+i*(.015085+l*(-.044475+.028874*i-.005916*l)))-a)/(1.007226+i*(.015085*3+l*(-.044475*7+.028874*9*i-.005916*11*l)))}while(ie(o)>ne&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function ms(){return ps(mr).scale(175.295)}function fs(e){return e}function xs(e){if(e==null)return fs;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var g=2,d=s.length,m=new Array(d);for(m[0]=(a+=s[0])*n+i,m[1]=(r+=s[1])*o+l;g<d;)m[g]=s[g],++g;return m}}function hs(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function gs(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Sn(e,r)})}:Sn(e,a)}function Sn(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=bs(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function bs(e,a){var r=xs(e.transform),n=e.arcs;function o(d,m){m.length&&m.pop();for(var u=n[d<0?~d:d],x=0,c=u.length;x<c;++x)m.push(r(u[x],x));d<0&&hs(m,c)}function i(d){return r(d)}function l(d){for(var m=[],u=0,x=d.length;u<x;++u)o(d[u],m);return m.length<2&&m.push(m[0]),m}function s(d){for(var m=l(d);m.length<4;)m.push(m[0]);return m}function p(d){return d.map(s)}function g(d){var m=d.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:d.geometries.map(g)};case"Point":u=i(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(i);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=p(d.arcs);break;case"MultiPolygon":u=d.arcs.map(p);break;default:return null}return{type:m,coordinates:u}}return g(a)}const fr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},vs=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ys(e,a,r){const n=fr[e];if(!n||!n.length)return-1;const o=vs(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(l=>o.includes(l)))return i}return Math.floor(r*n.length)%n.length}let Mt=null;function ws(){return Mt||(Mt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=gs(r,n),i=ms().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=ts(i),s=(o.features||[]).filter(d=>{var m;return(((m=d.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(d=>{var x;const m=((x=d.properties)==null?void 0:x.name)||"",u=l(d)||"";return u?{i2:Jr(m)||null,n:m,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const p={};for(const[d,m]of Object.entries(Xr)){const u=i(m);u&&(p[d]={x:u[0],y:u[1]})}const g={};for(const[d,m]of Object.entries(fr)){const u=m.map(x=>i(x.ll)).filter(x=>!!x).map(([x,c])=>({x,y:c}));u.length&&(g[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:g}}catch{return null}})(),Mt)}function ks(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return ws().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const js={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Cn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function En(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Ns(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let o=!0,i=0;const l=()=>{var g;if(!o)return;const p=(g=e.current)==null?void 0:g.getScreenCTM();p&&p.a>0?n(p.a):i=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Ss(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:l,lang:s,t:p,data:g,dossiers:d}=F(),m=g.loading&&!d.length,u=h.useRef(null),x=h.useRef(null),c=ks(e.continent==="monde"),b=e.continent==="monde"?c:za.find(j=>j.key===e.continent)||null,v=Ns(u,e.continent+":"+e.mapFolded+":"+!!b),[f,y]=h.useState(new Map),[k,w]=h.useState(null);h.useEffect(()=>{const j=u.current;if(!j)return;const C=new Map;j.querySelectorAll("path[data-i2]").forEach(L=>{const H=L.dataset.i2;if(H)try{const G=L.getBBox();G.width>0&&C.set(H,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(C)},[e.continent,v,b]);const S=h.useMemo(()=>r.filter(j=>j.cc),[r]),A=h.useMemo(()=>{const j=new Map;return S.forEach(C=>j.set(C.cc,(j.get(C.cc)||0)+1)),j},[S]),T=e.continent==="monde"&&c?c.anchors:null,D=e.continent==="monde"&&c?c.metros:null,E=h.useMemo(()=>S.map(j=>{const C=En(j.name||j.id||""),L=En((j.id||j.name||"")+"·y");if(T&&j.cc){const O=D?D[j.cc]:void 0;if(O&&O.length){const P=ys(j.cc,j.city,C);if(P>=0&&O[P])return{d:j,x:O[P].x+(C-.5)*5,y:O[P].y+(L-.5)*5}}const B=T[j.cc];if(B)return{d:j,x:B.x+(C-.5)*10,y:B.y+(L-.5)*10}}const H=j.cc?f.get(j.cc):void 0;if(!H)return null;const G=js[`${e.continent}:${j.cc||""}`];if(G)return{d:j,x:H.x+H.w*(G.fx+(C-.5)*G.sx),y:H.y+H.h*(G.fy+(L-.5)*G.sy)};const X=(C-.5)*Math.min(H.w*.55,60),z=(L-.5)*Math.min(H.h*.55,60);return{d:j,x:H.x+H.w/2+X,y:H.y+H.h/2+z}}).filter(j=>!!j),[S,f,T,D,e.continent]),M=j=>v>0?j/v:j,q=h.useMemo(()=>n?[0,1,2,3,4,5].map(j=>({c:Cn[j],fr:p.plabels[j].toUpperCase(),en:p.plabels[j].toUpperCase(),n:r.filter(C=>C.kind==="target"&&ke(C)===j).length})).filter(j=>j.n>0):Va.map((j,C)=>({...j,n:r.filter(L=>Ha(L)===C).length})),[r,n,p.plabels]),R=i?l.get(i):null,U=R?E.find(j=>j.d.id===R.id):null;return b?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:x,children:[t.jsxs("svg",{ref:u,viewBox:b.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?b.fr:b.en,onMouseLeave:()=>{w(null),o(null)},children:[t.jsx("g",{children:b.countries.map((j,C)=>t.jsx("g",{className:"ct"+(j.i2&&A.get(j.i2)?"":" empty"),children:t.jsx("path",{d:j.d,"data-i2":j.i2||void 0})},C))}),t.jsx("g",{children:E.map(j=>{const C=Va[Ha(j.d)],L=!!ge(j.d),H=j.d.kind==="target",G=n&&H?Cn[ke(j.d)]:C.c,X=!n&&Ee(j.d);return t.jsxs("g",{className:"co"+(X?" done":""),onMouseEnter:()=>{var B,P;const z=(B=x.current)==null?void 0:B.getBoundingClientRect(),O=(P=u.current)==null?void 0:P.createSVGPoint();if(O&&u.current&&z){O.x=j.x,O.y=j.y;const I=O.matrixTransform(u.current.getScreenCTM());w({x:I.x-z.left,y:I.y-z.top,label:j.d.name+" · "+(dt(j.d.cc,s)||j.d.countryLabel||"")})}o(j.d.id)},onMouseLeave:()=>{w(null),o(null)},onClick:()=>{var B;const z=(B=u.current)==null?void 0:B.createSVGPoint();let O=null;if(z&&u.current){z.x=j.x,z.y=j.y;const P=z.matrixTransform(u.current.getScreenCTM());O={x:P.x,y:P.y}}a({type:"popup",id:j.d.id,anchor:O})},children:[t.jsx("circle",{className:"h",cx:j.x,cy:j.y,r:M(Math.max(11,C.px+7))}),t.jsx("circle",{className:"v",cx:j.x,cy:j.y,r:M(C.px),fill:G,stroke:L?"#DC2626":"#ffffff",strokeWidth:M(L?2.2:1.3)})]},j.d.id||j.d.name)})}),U&&t.jsx("circle",{className:"ring on",cx:U.x,cy:U.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:q.map((j,C)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":j.c}}),s==="fr"?j.fr:j.en," ",t.jsx("b",{children:j.n})]},C))}),r.some(j=>!j.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(j=>!j.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:x})}function Cs(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Es(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:o,contName:i,lang:l}=F(),s=e.filters,p=h.useMemo(()=>e.continent==="monde"?r:r.filter(c=>c.continent===e.continent),[r,e.continent]),g=c=>p.filter(b=>c!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:Ta(b,s,o,c==="country"?void 0:c)),d=h.useMemo(()=>{const c=g("win"),b=v=>c.filter(f=>(f.date?Math.max(0,Math.floor((Date.now()-Date.parse(f.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),c.length]},[p,s,o]),m=h.useMemo(()=>s.day?g("win").filter(c=>(c.date||"").slice(0,10)===s.day).length:0,[p,s,o]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),x=(c,b,v,f="fbtn")=>t.jsxs("button",{type:"button",className:f,"aria-expanded":e.openFacet===c,onClick:()=>a({type:"openFacet",facet:c}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},c);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(Cs(s.day,l)),t.jsx("b",{children:m})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((c,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===c,onClick:()=>a({type:"filters",patch:{win:c}}),children:[n.dates[b],t.jsx("b",{children:d[b]})]},c))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:c=>a({type:"filters",patch:{search:c.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):x("sec",n.fSector,s.sector.length),x("pay",n.fCountry,s.country.length),x("det",n.fEngine,s.engine.length),x("sta",n.fStage,s.stage.length),o&&x("ang","Angle",s.angle.length),o&&x("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,i),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(As,{poolFor:g})]})}function As({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=F(),i=a.filters,l=a.openFacet,{title:s,cols:p,options:g}=h.useMemo(()=>{if(l==="sig"){const c=e("signal").filter(f=>ge(f)),b=new Map;c.forEach(f=>{const y=f.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:c.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...sa([...b.keys()],o).map(f=>({v:f,label:Ge(f)+" "+$e(f,o),n:b.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const c=e("sector"),b=new Map;return c.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v,n:f,html:!1,on:i.sector.includes(v)}))}}if(l==="pay"){const c=e("country"),b=new Map;return c.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:dt(v,o)||v,n:f,html:!1,on:i.country.includes(v)}))}}if(l==="det"){const c=e("engine"),b=new Map;return c.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:sa([...b.keys()],o).map(v=>({v,label:Ge(v)+" "+$e(v,o)+' <span style="color:var(--dim);font-size:10px">· '+Zr(eo(v),o)+"</span>",n:b.get(v)||0,html:!0,on:i.engine.includes(v)}))}}if(l==="ang"){const c=e("angle"),b=new Map;return c.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(v)}))}}if(l==="mem"){const c=e("memoLevel"),b=new Map;c.forEach(f=>{if(f.kind==="target"){const y=Ea(f);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:v[f],n:b.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const u=e("stage"),x=new Map;return u.forEach(c=>{c.stage&&x.set(c.stage,(x.get(c.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...x.entries()].sort((c,b)=>b[1]-c[1]).map(([c,b])=>({v:c,label:c,n:b,html:!1,on:i.stage.includes(c)}))}},[l,a,o]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const c=i.signalEngines.includes(u)?i.signalEngines.filter(b=>b!==u):[...i.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:c}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function xr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function zs(e){var o;const a=[],r=new Set,n=i=>{const l=(i||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function An({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:l}){const{t:s}=F();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function hr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=F(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(An,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(An,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Ts({card:e,onEvaluate:a,onAddAll:r}){var s,p,g;const{t:n}=F(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:xr(e.summary_md||"").map((d,m)=>t.jsx("p",{children:d},m))})]}),t.jsx(hr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Ls(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Rs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:l}=F(),s=o,[p,g]=h.useState(null),[d,m]=h.useState(null),[u,x]=h.useState(null),[c,b]=h.useState(!1);h.useEffect(()=>{let f=!0;return(async()=>{const y=await $n({email:l,cbToken:s});f&&g(y)})(),()=>{f=!1}},[l,s,n]);const v=f=>{m(f),x(null),b(!0),(async()=>{const y=await to(f.id);x(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),x(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(p||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Ls(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),c&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!c&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!c&&u&&t.jsx(Ts,{card:u,onEvaluate:a,onAddAll:r})]})]})}const zn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Ms(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:l,evalBusy:s,evalCards:p,caps:g,data:d,canWrite:m,source:u}=F(),x=a==="client",c=h.useMemo(()=>r||(u!=="default"?ao():""),[r,u]),[b,v]=h.useState(""),[f,y]=h.useState(!1),[k,w]=h.useState(""),[S,A]=h.useState(!1),[T,D]=h.useState(""),[E,M]=h.useState([]),q=h.useRef(!1),[R,U]=h.useState(!1),[j,C]=h.useState(""),[L,H]=h.useState(""),[G,X]=h.useState(!1),[z,O]=h.useState(0),[B,P]=h.useState(""),[I,_]=h.useState(null),[W,J]=h.useState(null),[re,fe]=h.useState(!1),[pe,K]=h.useState(null),[ee,xe]=h.useState(0),Z=h.useRef(!1),se=b.trim()?zn.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,te=h.useMemo(()=>k.split(`
`).map($=>$.trim()).filter(Boolean).slice(0,15),[k]);h.useEffect(()=>{if(typeof window>"u")return;const $=(new URLSearchParams(window.location.search).get("rs")||"").trim();!$||!/^https?:\/\//i.test($)||(C($),U(!0))},[]),h.useEffect(()=>{const $=ae=>{var ye;const oe=String(((ye=ae.detail)==null?void 0:ye.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(C(oe),U(!0))};return window.addEventListener("ppmap:research",$),()=>window.removeEventListener("ppmap:research",$)},[]),h.useEffect(()=>{if(!m&&!c){K(null);return}let $=!0;return(async()=>{const ae=await $n({email:n,cbToken:c});$&&K(ae.length)})(),()=>{$=!1}},[m,c,n,ee]);const Se=E.length?E:p,he=d.credits,be=h.useCallback($=>{const ae=$.map(oe=>(oe||"").trim()).filter(Boolean);ae.length&&(w(oe=>{const ye=oe.split(`
`).map(le=>le.trim()).filter(Boolean),_e=new Set(ye.map(le=>le.toLowerCase())),je=ae.filter(le=>!_e.has(le.toLowerCase()));return[...ye,...je].slice(0,15).join(`
`)}),y(!0))},[]);h.useEffect(()=>{if(!G)return;O(0);const $=window.setInterval(()=>O(ae=>ae+1),1e3);return()=>window.clearInterval($)},[G]);const et=()=>{const $=b.trim();$&&(o(null,$),v(""))},tt=async()=>{if(!x){o(null,te[0]||"");return}if(!te.length||S)return;A(!0),q.current=!1;const $=[];for(let ae=0;ae<te.length&&!q.current;ae++){D(e.evaluating(ae+1,te.length,te[ae]));const oe=await Bn(r,te[ae],"atelier2");if($.unshift({name:oe.company||te[ae],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),M([...$]),oe.verdict==="quota"){$.unshift({name:"",verdict:"quota",reason:e.quota(te.length-ae-1),remaining:0}),M([...$]),w(te.slice(ae+1).join(`
`)),D(""),A(!1);return}}D(""),w(q.current?te.slice($.length).join(`
`):""),A(!1)},Ae=async()=>{var oe,ye,_e;if(Z.current)return;const $=j.trim().replace(/\s+/g,""),ae=L.trim();if(!$&&!ae){P(e.rsNeed);return}if(!x&&!c){o(null,$||ae.slice(0,80));return}Z.current=!0,P(""),_(null),J(null),X(!0);try{const je=await ro({url:$,text:ae,email:n,cbToken:c});if(X(!1),!je||je.status!=="success"){P((je==null?void 0:je.message)||"Erreur");return}_(je),U(!1),be((((oe=je.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(Te=>(Te==null?void 0:Te.name)||"")),J({state:"pending"});const le=await oo(je,{email:n,cbToken:c});J(le.ok?{state:"ok",scopeLabel:((ye=le.summary)==null?void 0:ye.scope_label)||"",scope:((_e=le.summary)==null?void 0:_e.scope)||""}:{state:"fail",msg:le.error||""}),le.ok&&xe(Te=>Te+1)}finally{Z.current=!1,X(!1)}},ze=[I==null?void 0:I.industry,...(I==null?void 0:I.market_tags)||[],I==null?void 0:I.author].map($=>($||"").trim()).filter(Boolean),at=(W==null?void 0:W.state)==="pending",ct=W&&(at?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):W.state==="ok"?t.jsx("span",{className:"rslink ok",children:W.scope&&W.scope!=="public"?e.rsSavedIn(W.scopeLabel||W.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:W.msg,children:e.rsSaveFail})),Wt=zs(I).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:b,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:$=>v($.target.value),onKeyDown:$=>{$.key==="Enter"&&et()}}),t.jsx("span",{className:"detect"+(zn.test(b.trim())?" url":""),children:se})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:et,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),g.showCredits&&he&&t.jsxs("button",{type:"button",className:"credits"+(he.total_available<=0&&!he.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:he.unlimited?"∞":he.total_available}),!he.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",he.daily_grant+he.purchased]}),he.total_available<=0&&!he.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(R?" on":""),onClick:()=>U(!R),children:e.rsOpen}),pe!==null&&pe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>fe(!re),children:e.rsArchOpen(pe)})]}),re&&t.jsx(Rs,{bump:ee,cbToken:c,onClose:()=>fe(!1),onEvaluate:$=>o(null,$),onAddAll:be}),R&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:j,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:$=>C($.target.value),onKeyDown:$=>{$.key==="Enter"&&Ae()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:L,placeholder:e.rsTextPh,onChange:$=>H($.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(G?" loading":""),style:{justifyContent:"center"},disabled:G||at||!j.trim()&&!L.trim(),onClick:()=>{Ae()},children:[t.jsx("span",{className:"fill"}),G?`${no(j.trim())==="youtube"&&j.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(z)}`:at?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),B&&t.jsx("div",{className:"rserr",children:B}),I&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:I.title}),I.source_url&&t.jsx("a",{href:I.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{_(null),J(null)},children:"×"})]}),I.market&&t.jsx("p",{className:"rsmk",children:I.market}),ze.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),ze.map($=>t.jsx("span",{children:$},$))]}),t.jsxs("div",{className:"rsbody",children:[I.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${I.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:xr(I.summary_md||"").map(($,ae)=>t.jsx("p",{children:$},ae))})]}),t.jsx(hr,{card:I,onEvaluate:$=>o(null,$),onAddAll:be}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Wt)}),ct]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:k,placeholder:e.bulkPh,onChange:$=>w($.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(S?" loading":""),style:{justifyContent:"center"},disabled:S||!te.length,onClick:()=>{tt()},children:[t.jsx("span",{className:"fill"}),S&&T?T:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(te.length)})]})]}),Se.slice(0,1).map(($,ae)=>{const oe=$.verdict==="kept",ye=$.verdict==="quota",_e=oe?"var(--brand)":ye?"var(--bolt)":"var(--red)",je=oe?"var(--brand-l)":ye?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":_e,"--bgc":je},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:ye?"⏳":"✗ "+e.dropped})}),$.name&&t.jsx("span",{className:"rn",children:$.name}),t.jsx("span",{className:"rr",children:$.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",$.reason]}):null}),!!($.candidates&&$.candidates.length)&&t.jsx("span",{className:"sitepick",children:$.candidates.map(le=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:le.url.startsWith("http")?le.url:`https://${le.url}`,target:"_blank",rel:"nofollow noopener",children:[(le.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,le.url),children:e.evalPickGo})]},le.url))}),!ye&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:oe?1:5});const le=($.name||"").trim().toLowerCase();window.setTimeout(()=>{const Te=[...document.querySelectorAll(".atl2 .list .row")].find(Gt=>{var Nt;return(((Nt=Gt.querySelector(".rnm"))==null?void 0:Nt.textContent)||"").trim().toLowerCase().includes(le)});Te&&(Te.scrollIntoView({behavior:"smooth",block:"center"}),Te.classList.add("flashrow"),window.setTimeout(()=>Te.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),x&&(i.kept+i.dropped>0||Se.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function qs(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Os(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=F(),i=e.memoConsole?r.get(e.memoConsole):null,l=h.useMemo(()=>i?[i.reasoning||"",qs(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const s=Xe(i),p=Ea(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[ot(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const oa={},Tn=(oa==null?void 0:oa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ln(){return new Date().toISOString().slice(0,10)}const qa=h.createContext(null);function Fs(){return h.useContext(qa)}function Ps(e){if(!e||typeof DOMParser>"u")return[];try{const r=[...new DOMParser().parseFromString(e,"text/html").querySelectorAll("div,section")].find(o=>/en bref/i.test(o.textContent||"")&&o.querySelector("li"));return(r?[...r.querySelectorAll("li")]:[]).map(o=>(o.textContent||"").replace(/\s+/g," ").trim()).filter(o=>o.length>3).slice(0,4)}catch{return[]}}function Ds(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),l=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(p=>p.remove()),s.querySelectorAll("*").forEach(p=>{const g=p.tagName==="A"?p.getAttribute("href"):null;[...p.attributes].forEach(d=>p.removeAttribute(d.name)),g&&/^https?:\/\//i.test(g)&&(p.setAttribute("href",g),p.setAttribute("target","_blank"),p.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Is(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${i} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${i} ${r[1]}`}function $s(){const{ed:e,isEn:a,day:r,loading:n}=gr(),o=h.useMemo(()=>Ps((e==null?void 0:e.html)||""),[e==null?void 0:e.html]);if(n&&!e)return null;const i=Is(r,a);return o.length?t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:(a?"Daily brief · ":"Brief du jour · ")+i}),t.jsx("ul",{children:o.map((l,s)=>t.jsx("li",{children:l},s))})]}):t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:a?"Daily brief":"Brief du jour"}),t.jsx("p",{className:"tlp",children:a?`Edition of ${i}.`:`Édition du ${i}.`})]})}function gr(){const e=h.useContext(qa);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Bs({token:e,children:a}){const{dispatch:r,st:n,lang:o}=F(),[i,l]=h.useState(()=>n.filters.day||Ln()),[s,p]=h.useState(null),[g,d]=h.useState(!1),m=h.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=h.useCallback(()=>{l(Ln());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);h.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),h.useEffect(()=>{const b=v=>{var y;const f=(y=v.detail)==null?void 0:y.day;typeof f=="string"&&m(f)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[m]),h.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),h.useEffect(()=>{if(!e||!i)return;let b=!1;d(!0);const v=new URLSearchParams({token:e,date:i});return fetch(`${Tn}/cibles/edition.json?${v}`).then(f=>f.json()).then(f=>{b||p(f)}).catch(()=>{b||p({ok:!1,error:"network"})}).finally(()=>{b||d(!1)}),()=>{b=!0}},[e,i]);const x=h.useMemo(()=>`${Tn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),c=h.useMemo(()=>({token:e,day:i,ed:s,loading:g,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:x,isEn:o==="en"}),[e,i,s,g,m,u,n.filters.day,x,o]);return t.jsx(qa.Provider,{value:c,children:a})}function Us(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=gr();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(io,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function br({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=F(),[l,s]=h.useState(!1),[p,g]=h.useState(null);if(!n.pipe||o!=="client"||n.lockActions)return null;const d=async()=>{if(l)return;s(!0);const m=await so(r,e);if(s(!1),!m){i(a.actErr);return}g(m.results||[])};return t.jsxs("div",{className:"simb",onClick:m=>m.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{d()},children:l?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(m=>t.jsxs("li",{children:[t.jsx("b",{className:m.verdict==="kept"?"ok":"ko",children:m.company}),m.reason&&t.jsx("span",{children:m.reason})]},m.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}function Ht({spec:e}){const a=h.useRef(null),r=h.useRef(null),[n,o]=h.useState(!1);return h.useEffect(()=>{const i=a.current;if(!i)return;let l=!1;return Ya({kind:"op",card:e},Math.max(240,i.clientWidth||320)).then(s=>{!l&&s&&i.isConnected&&i.replaceChildren(s)}),()=>{l=!0,i.replaceChildren()}},[e]),h.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let l=!1;Ya({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(p=>{!l&&p&&i.isConnected&&i.replaceChildren(p)});const s=p=>{p.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>o(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const _s=`
...
`;function Vs(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function Hs(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:l,askEvaluate:s,doAnalyse:p,doDecide:g,doPromote:d,doRepeche:m,doApproach:u,doDeep:x,doOnboard:c,outbound:b,evalBusy:v}=F(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const y=ge(f),k=ke(f),w=Xe(f),S=f.kind==="target",A=T=>{a({type:"filters",patch:T}),a({type:"popup",id:null})};return lt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:_s}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Vs(e.popupAnchor,!!f.card),onClick:T=>T.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(Ve(f.date)),$e(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[f.cc]}),children:(dt(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:jt(f.amountEur,o)})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ge(f.engine)," ",t.jsx("b",{children:$e(f.engine,o)})," — ",lo(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Je,{o:f,lg:!0})," ",t.jsx(Yt,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Un(y,o))," · ",n.win7(_n(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(Ht,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&k>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&S&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})})]}),t.jsx(br,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||l!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[k===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),k===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),k===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),k===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),ot(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{x(f),a({type:"popup",id:null})},children:n.memoDeep})]}),k===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),k===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{c(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var T;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(T=document.querySelector(".atl2 .demand"))==null||T.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}const Ys=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),qt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Ws(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=qt(a.slice(n));break}r+=qt(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=qt(a.slice(o));break}const l=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&Ys.has(p)?r+=`<${s[1]}${p}>`:r+=qt(a.slice(o,i+1)),n=i+1}return r}const Rn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function we({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Gs(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ks({o:e}){const{t:a,doDeep:r}=F(),n=Xe(e),o=[e.reasoning||"",Gs(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[n&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:n}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),o.length?o.join(`

`).split(`

`).map((i,l)=>t.jsx("p",{className:"cdtxt",children:i},l)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[ot(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:i=>{i.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:i=>i.stopPropagation(),children:a.memoOpenFull})]})]})}function Qs({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=F(),i=Vt(e),l=Xe(e),s=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),m=h.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||ot(e)?1:0}].filter(b=>b.n>0),[e,a,s,l,p,g,d]),[u,x]=h.useState("");if(!m.length)return null;const c=m.some(b=>b.k===u)?u:m[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:m.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":c===b.k,"data-tour":"tab-"+b.k,className:c===b.k?"on":"",onClick:v=>{v.stopPropagation(),x(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[c==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(we,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(we,{k:a.cdVerdictDate,v:Rn(e.verdictDate,r)})]})]}),c==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Ws(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(Js,{o:e})]}),c==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdSector,v:e.sector}),t.jsx(we,{k:a.cdStage,v:e.stage}),t.jsx(we,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(we,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(we,{k:a.cdAngle,v:e.angle}),t.jsx(we,{k:a.cdDetected,v:Rn(e.date,r)})]}),c==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdName,v:e.contactName}),t.jsx(we,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),c==="memo"&&t.jsx(Ks,{o:e}),c==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(we,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Js({o:e}){const{t:a,token:r}=F(),[n,o]=h.useState(!1),[i,l]=h.useState(null),s=async()=>{n||(o(!0),l(await co(r,e.name,e.website||e.domain||"")),o(!1))},p=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=g.some(([,m])=>m);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[g.filter(([,m])=>m).map(([m,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:m}),t.jsx("p",{children:u})]},m)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}const vr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Oa({o:e}){const{t:a}=F(),r=Vt(e),n=Xe(e),o=ke(e),i=ia(e),l=po(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(vr[n]||"v-cons"),title:a.vt[n],children:n}):o===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,o===3&&i==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),o===3&&i==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),o===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const Sa=e=>e.length>22?e.slice(0,21)+"…":e;function Mn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=F(),[i,l]=h.useState(!1);if(h.useEffect(()=>{n||l(!1)},[n]),Ee(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Sa(e.name))})]})}function yr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:l,doPromote:s,doRepeche:p,doApproach:g,dispatch:d}=F();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:x=>{x.stopPropagation(),d({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:x=>{var c;x.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(c=document.querySelector(".atl2 .demand"))==null||c.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:x=>{var c;x.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(c=document.querySelector(".atl2 .demand"))==null||c.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Mn,{o:e})});const m=ke(e),u=x=>c=>{c.stopPropagation(),x()};if(m===0)return t.jsx("span",{className:"cell",children:t.jsx(Mn,{o:e})});if(m===1){const x=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:x,onClick:u(()=>i(e)),children:x?a.actAnalyseQueued:a.actAnalyse})})}if(m===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(m===4){const x=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:x,onClick:u(()=>g(e)),children:x?a.actApproachSent:a.actApproach})})}return m===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):m===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Xs({o:e}){const{t:a,doThumb:r,thumbOf:n}=F(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Zs({o:e}){const{lang:a}=F();return ge(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Je,{o:e}),t.jsx(Yt,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ge(e.engine||"")," ",$e(e.engine||"",a)]})})}function el({o:e,locked:a,open:r,onToggle:n}){const{st:o,dispatch:i,caps:l,markRow:s,markedId:p,favIds:g,toggleFav:d}=F(),m=ke(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],x=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,c=x<=0?0:x<=7?1:x<=30?2:3,b=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][m]:u[c],v=g.has(e.id),f=y=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const k=y.currentTarget.getBoundingClientRect();i({type:"popup",id:e.id,anchor:{x:k.left+Math.min(280,k.width/3),y:k.bottom}})};return t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:f,children:[t.jsx("span",{className:"pt",style:{"--c":b}}),t.jsx(Nr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:v?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),d(e)},children:v?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(tl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Zs,{o:e}),l.pipe&&t.jsx(Oa,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(yr,{o:e}),l.showThumbs&&t.jsx(Xs,{o:e})]}),r&&!a&&t.jsx(nl,{o:e})]})}function tl({o:e}){const{lang:a,caps:r}=F();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=jt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function al({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=F(),l=(u,x=!1)=>c=>{c.stopPropagation(),x&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),p=jt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ee(e),m=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),p&&t.jsx("span",{className:"oc-amt",children:p}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},children:[m?"✓":"✗"," ",t.jsx("b",{children:m?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var x;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(x=document.querySelector(".atl2 .demand"))==null||x.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Sa(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Sa(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Ht,{spec:e.card})})]})}function nl({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:l}=F();return!o.pipe&&e.kind==="op"?t.jsx(al,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Qs,{o:e}),t.jsx(gi,{o:e}),t.jsx(yi,{o:e}),t.jsx(br,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Oa,{o:e})})]}),e.card&&t.jsx(Ht,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ge(e.engine||"")," ",$e(e.engine||"",r)]}),ge(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Je,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function rl({o:e,locked:a}){const{t:r,dispatch:n,caps:o,doDecide:i,lang:l}=F();if(!o.pipe&&e.kind==="op"){const g=jt(e.amountEur,l),d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),m=(u,x=!1)=>c=>{c.stopPropagation(),x&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" locked":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Ht,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:m({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:m({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:m({stage:[e.stage]}),children:e.stage}),g&&t.jsx("span",{className:"damt",children:g})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Ge(e.engine||"")," ",$e(e.engine||"",l)]}),ge(e)&&t.jsx(Je,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(yr,{o:e})})]})}const s=ke(e),p=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":p},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Oa,{o:e}),ge(e)&&t.jsx(Je,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&o.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>i(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>i(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function ol(){const{t:e}=F(),[a,r]=h.useState(0);return h.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function il({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=F(),i=o==="en",l=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),p=s.includes(0)?0:s.sort((d,m)=>(e[m]||0)-(e[d]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${l(p)}”`:`${g} dossier${g>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(i?"Open ":"Ouvrir ")+l(p)," →"]})]})}function sl(){var X;const e=F(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:l,lang:s,sessTally:p,data:g,dossiers:d,source:m}=e,u=m==="ops"?8:Hn,[x,c]=h.useState(new Set);h.useEffect(()=>{c(new Set)},[a.ptab,a.continent]);const[b,v]=h.useState(null);h.useEffect(()=>{v(null)},[a.ptab,a.continent]);const f=z=>c(O=>{const B=new Set(O);return B.has(z)?B.delete(z):B.add(z),B}),[y,k]=h.useState("all"),[w,S]=h.useState(!1);h.useEffect(()=>{k("all"),S(!1)},[a.ptab,a.continent]),h.useEffect(()=>{if(!w)return;const z=O=>{var B,P;(P=(B=O.target)==null?void 0:B.closest)!=null&&P.call(B,".atl2 .doable")||S(!1)};return document.addEventListener("click",z),()=>document.removeEventListener("click",z)},[w]);const A=Fs(),T=h.useMemo(()=>{var O;const z=new Map;for(const B of Ds(((O=A==null?void 0:A.ed)==null?void 0:O.html)||""))z.has(B.t)||z.set(B.t,B.html);return z},[(X=A==null?void 0:A.ed)==null?void 0:X.html]),D=h.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!T.size)return;const O=(z.name||"").trim().toLowerCase();if(O.length<3)return;const B=T.get(O);if(B)return B;for(const[P,I]of T)if(P.includes(O)||O.includes(P))return I},[T]),E=h.useMemo(()=>{const z=La(l,a.sort);return y==="all"?z:z.filter(O=>y==="explore"?!!O.noCo:!O.noCo)},[l,a.sort,m,y]),M=h.useMemo(()=>E.filter(z=>ge(z)&&!Ee(z)).length,[E]),q=h.useMemo(()=>o.pipe?E:E.filter(z=>!Ee(z)&&!z.noCo),[E,o.pipe]),R=m==="ops"?E.filter(z=>z.noCo).length:0,U=o.pipe?n.plabels[a.ptab].toLowerCase():m==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,j=(z,O,B="",P=!1)=>t.jsxs("button",{type:"button","data-s":z,className:B,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:P?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[O,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),C=h.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const z=new Map;E.forEach(P=>{const I=P.engine||"?";z.has(I)||z.set(I,[]),z.get(I).push(P)});const O={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},B=sa([...z.keys()],s);return[...z.entries()].sort((P,I)=>{const _=O[P[0]]??10+B.indexOf(P[0]),W=O[I[0]]??10+B.indexOf(I[0]);return _-W})},[E,o.pipe,a.groupBy,s]),L=o.lockRowsAfter;let H=0;const G=(z,O)=>{let B=a.shown[O]||u;return z.length-B<=4&&(B=z.length),z.slice(0,B).map(_=>{const W=L!==null&&H>=L;H++;const J=D(_),re=J&&J!==_.decryptHtml?{..._,decryptHtml:J}:_,fe=a.dens!=="maxi"&&(a.dens==="deplie"||(b?b==="open":!!J)),pe=x.has(_.id)?!fe:fe;return a.dens==="maxi"?t.jsx(rl,{o:re,locked:W},_.id):t.jsx(el,{o:re,locked:W,open:pe,onToggle:()=>f(_.id)},_.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:E.length})," ",U]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,o.pipe&&e.fund?" · "+e.fund:"",m==="ops"&&E.length>0&&" — "+n.edSplit(E.length-R,R)]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(o.showFunnel||m==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,O])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:O})]},z))}),(o.showFunnel||m==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":b==="open",onClick:()=>{v("open"),c(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":b==="closed",onClick:()=>{v("closed"),c(new Set)},children:n.foldAllLbl}),m==="ops"&&t.jsxs("button",{type:"button","aria-pressed":b===null,onClick:()=>{v(null),c(new Set)},children:["📖 ",n.foldArts]})]}),(o.showFunnel||m==="ops")&&(()=>{var B;const z=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],O=((B=z.find(([P])=>P===y))==null?void 0:B[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":w,onClick:()=>S(P=>!P),children:[O,t.jsx("i",{children:"▾"})]}),w&&t.jsx("div",{className:"dolist",children:z.map(([P,I])=>t.jsx("button",{type:"button","aria-pressed":y===P,onClick:()=>{k(P),S(!1)},children:I},P))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([z,O])=>t.jsx("option",{value:z,children:O},z))})]}),o.showChain&&q.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:q.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(q.length):n.chainAll(q.length)]})]}),M>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(M)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),j("country",n.colCountry),j("name",n.colCompany),j("amount",n.colAmount,"h-amt",!0),j("stage",n.colStage,"h-stade"),j("signal",n.colSignal,"h-sig"),o.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),o.pipe&&j("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(m==="ops"?" opsl":"")+(E.length?"":" list-empty"),children:[C?C.map(([z,O])=>t.jsxs(h.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ge(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:$e(z,s)}),t.jsx("div",{className:"s",children:n.grpCount(O.filter(B=>!Ee(B)).length,O.length)})]})]}),G(O,z)]},z)):G(E,"pt"+a.ptab),g.loading&&!d.length&&t.jsx(ol,{}),!E.length&&!(g.loading&&!d.length)&&(o.pipe?t.jsx(il,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const z=C||[["pt"+a.ptab,E]];let O=0,B=0;for(const[I,_]of z){B+=_.length;let W=a.shown[I]||u;_.length-W<=4&&(W=_.length),O+=Math.min(_.length,W)}const P=B-O;return P<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([I,_])=>r({type:"more",group:I,by:_.length,base:u})),children:[t.jsx("span",{className:"more-label",children:n.more(P,P)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(O,B)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}})]})}function qn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ll(e,a){const r=uo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function dl(e,a){const n=[a.head.split("|").map(qn).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",ll(o,a.plabels),Vt(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(qn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function cl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const pl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Pe({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function ul({o:e,qa:a}){const{t:r,lang:n,fund:o}=F(),i=(e.cribleStatus||"").trim().toUpperCase()||(Vt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Xe(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Pe,{k:r.cdSector,v:e.sector}),t.jsx(Pe,{k:r.cdStage,v:e.stage}),t.jsx(Pe,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Pe,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Pe,{k:r.cdName,v:e.contactName}),t.jsx(Pe,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Pe,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Pe,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Pe,{k:r.cdAngle,v:e.angle}),t.jsx(Pe,{k:r.cdDetected,v:pl(e.date,n)})]}),p.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,g])=>g).map(([g,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:d})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function ml(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:l}=F(),[s,p]=h.useState({}),g=25,d=h.useMemo(()=>n.slice(0,g),[n]);h.useEffect(()=>{d.length&&mo(r,d.map(x=>x.name)).then(p)},[r,d]);const m=i.stats,u=x=>x.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),m&&typeof m.screened=="number"&&t.jsxs("p",{children:[u(m.screened)," ",e.funScreened(""),typeof m.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(m.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(m.screened/i.marketEstimate*100)," %"]})]})]}),d.map(x=>t.jsx(ul,{o:x,qa:s[x.name]},x.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const fl=50;function Fa({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=F(),[i,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(""),[m,u]=h.useState(0),[x,c]=h.useState(""),[b,v]=h.useState(!1),f=h.useRef(null);h.useEffect(()=>()=>{f.current&&window.clearInterval(f.current)},[]);const y=async w=>{p(!0),d("");const S=await a();if(p(!1),S.ok){l(S);return}if(S.busy){d(o.alertPreviewBusy);return}if(!w){d(o.alertPreviewFail);return}u(fl),f.current=window.setInterval(()=>{u(A=>A>1?A-1:(f.current&&window.clearInterval(f.current),y(!1),0))},1e3)},k=async()=>{if(n||b)return;v(!0),c("");const w=await r();v(!1),c(w.ok?o.alertTestOk(w.sentTo||""):w.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||m>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{k()},children:b?"…":o.alertTest})]}),m>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(m)}),g&&t.jsx("p",{className:"mnote warn",children:g}),x&&t.jsx("p",{className:"mnote",children:x}),!x&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const bt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ne({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=F();return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function xl(){const{st:e}=F();switch(e.modal){case"chain":return t.jsx(gl,{});case"space":return t.jsx(bl,{});case"alert":return t.jsx(vl,{});case"queue":return t.jsx(Nl,{});case"export":return t.jsx(Sl,{});case"plug":return t.jsx(Al,{});case"recharge":return t.jsx(Tl,{});case"cover":return t.jsx(Rl,{});case"dossier":return t.jsx(Ll,{});case"crit":return t.jsx(Ml,{});case"tuto":return t.jsx(ql,{});case"rdv":return t.jsx(hl,{});case"memoalert":return t.jsx(Cl,{});default:return null}}function hl(){const{dispatch:e,fund:a}=F(),r=typeof document<"u"&&!!document.getElementById("rdv");return h.useEffect(()=>{r&&(e({type:"modal",modal:null}),di())},[r,e]),r?null:t.jsx(ho,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function gl(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:l,evalBusy:s,caps:p,memoQueued:g,doAnalyse:d}=F(),m=i==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),x=e.chain.idx,c=u[x],b=x>=u.length;return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${x+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:x/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:c.name}),t.jsx("div",{className:"sub",children:[dt(c.cc,o)||c.countryLabel,c.sector,c.stage,n.daysAgo(Ve(c.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:$e(c.engine,o).toUpperCase()}),typeof c.amountEur=="number"&&c.amountEur>0&&t.jsx("span",{children:jt(c.amountEur,o)})]}),ge(c)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Je,{o:c,lg:!0})," ",t.jsx(Yt,{o:c,src:!0})]}),(c.tagline||c.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:c.tagline||c.headline})]}),c.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:c.reasoning})]}),m&&Ee(c)&&t.jsxs("div",{className:"vbox",style:{"--c":We(c)==="retenu"?"var(--brand)":We(c)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:We(c)==="retenu"?"✓ "+n.kept:We(c)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:c.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&c&&p.pipe&&ke(c)===1&&!g.has(c.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(c),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&c&&!(m&&Ee(c))&&(c.noCo&&c.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:c.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(c)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function bl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=F(),i=o==="client",l=h.useMemo(()=>i?r.filter(m=>Ee(m)):[],[r,i]),s=h.useMemo(()=>La(l.filter(m=>We(m)==="retenu"),{key:"signal",dir:-1}),[l]),p=h.useMemo(()=>l.filter(m=>We(m)==="ecarte"),[l]),g=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ne,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(m=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof m.score=="number"&&m.score>0?m.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:m.name}),t.jsx("div",{className:"rr",children:m.reasoning||m.tagline||""})]})]},m.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function vl(){const{mode:e}=F();return e==="client"||e==="apercu"?t.jsx(yl,{}):t.jsx(jl,{})}function yl(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=F(),[i,l]=h.useState("d"),s=o!=="client";return t.jsxs(Ne,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(wl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(kl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(wr,{})]})}function wl({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(0);h.useEffect(()=>{let c=!0;return p(!1),Ka(a).then(b=>{c&&(b?l(b):p(!0))}),()=>{c=!1}},[a,g]);const m=c=>{r||Ka(a,c).then(b=>{if(!b){o(e.actErr);return}l(b),b.throttled?o(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(c=>c+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=c=>!i.sections||i.sections.includes(c),x=c=>{const b=i.sections||e.alertSec.map(([v])=>v);m({sections:u(c)?b.filter(v=>v!==c):[...b,c]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,(i.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[i.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,(i.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([c,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(c),disabled:r,onChange:()=>x(c)}),t.jsxs("span",{children:[b,c==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},c))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Fa,{label:e.alertPreview,readOnly:r,onPreview:()=>jo(a),onTest:()=>ko(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function kl({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(0);h.useEffect(()=>{let c=!0;return p(!1),Qa(a).then(b=>{c&&(b?l(b):p(!0))}),()=>{c=!1}},[a,g]);const m=c=>{r||Qa(a,c).then(b=>{if(!b){o(e.actErr);return}l(b),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(c=>c+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,x=i.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:c=>m({dow:Number(c.target.value)}),children:e.alertDow.map((c,b)=>t.jsx("option",{value:b,children:c},c))}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,x-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[x," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,x+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Fa,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>So(a),onTest:()=>No(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function wr(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=F(),[l,s]=h.useState(i||""),[p,g]=h.useState(!1),[d,m]=h.useState(!1);h.useEffect(()=>{i&&s(i)},[i]);const u=e.filters,x=h.useMemo(()=>n.filter(f=>ge(f)).length,[n]),c=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){m(!0);try{await fetch(`${Ca}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{m(!1)}}},v=[[a.amRows.continent,o],[a.amRows.since,a.amSince[c]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>$e(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>dt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([f,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!i,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,x)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function jl(){const{t:e}=F();return t.jsx(Ne,{title:e.alertTitle,icon:"🔔",children:t.jsx(wr,{})})}function Nl(){var b,v,f;const{t:e,token:a,fund:r,mode:n,flash:o}=F(),[i,l]=h.useState(null),[s,p]=h.useState([]),[g,d]=h.useState(0),m=n==="client";h.useEffect(()=>{let y=!0;return(async()=>{const[k,w]=await Promise.all([Aa(r),In(a)]);y&&(k&&l(k),p(w))})(),()=>{y=!1}},[a,r,g]);const u=(i==null?void 0:i.per_day)??2,x=((b=i==null?void 0:i.analyzed_today)==null?void 0:b.length)??0,c=(v=i==null?void 0:i.tomorrow)!=null&&v.length?i.tomorrow:((i==null?void 0:i.pool_meta)||[]).slice(0,10);return t.jsxs(Ne,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(x,x+(((f=i==null?void 0:i.pool_order)==null?void 0:f.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),m&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Ga(a,y.company,"retry").then(()=>d(k=>k+1))},children:e.queueRetry}),m&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Ga(a,y.company,"delete").then(()=>d(k=>k+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[c.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),c.slice(0,10).map((y,k)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",k+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Sl(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:l}=F(),s=`${bt}/cibles/list.csv?token=${a}`,p=`${bt}/cibles/list.json?token=${a}`,g=`${bt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,m=v=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:g,href:g}],x=!o.lockActions&&n.length>0,c=()=>{cl(dl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:v=>(e.stg.find(([f])=>f===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ne,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:c,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:f,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>m(f),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Cl(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=F(),i=o!=="client",[l,s]=h.useState(null),[p,g]=h.useState(!1),[d,m]=h.useState(0),[u,x]=h.useState(!1);h.useEffect(()=>{let f=!0;return g(!1),Wa(a).then(y=>{f&&(y?s(y):g(!0))}),()=>{f=!1}},[a,d]);const c=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=f=>{if(i||!l)return;const y={enabled:f.enabled??!!l.enabled,email:f.email??(l.email||""),sections:f.sections??c()};x(!0),Wa(a,y).then(k=>{if(x(!1),!k){n(e.memoAlertErr);return}s(k),r(e.memoAlertSaved)})};if(p)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(f=>f+1),children:e.retry})]})});if(!l)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=c();return t.jsxs(Ne,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:i||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(El,{value:l.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>b({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[f],disabled:i||u,onChange:()=>b({sections:{...v,[f]:!v[f]}})}),t.jsx("span",{children:y})]},f))}),t.jsx(Fa,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>xo(a,v),onTest:()=>fo(a,v)})]})}function El({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,l]=h.useState(e);h.useEffect(()=>{l(e)},[e]);const s=i.trim()!==e.trim(),p=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&s&&p&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>o(i.trim()),children:n})]})]})}function Al(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=F(),[i,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(null),[m,u]=h.useState(""),[x,c]=h.useState(0);h.useEffect(()=>{let f=!0;return p(!1),la(a).then(y=>{f&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),bo(a).then(y=>{f&&d(y)}),()=>{f=!1}},[a,x]);const b=(f,y)=>{o&&la(a,f).then(k=>{if(!k||k.ok===!1){n(e.actErr);return}f.test&&k.sent===!1?n(e.plugTestThrottled):r(y),c(w=>w+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(Ne,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(f=>f+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:m,disabled:!o,onChange:f=>u(f.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!m.trim(),onClick:()=>b({url:m.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(zl,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function zl(){const{t:e,token:a,lang:r}=F(),[n,o]=h.useState("valides"),[i,l]=h.useState(!1),[s,p]=h.useState(null),[g,d]=h.useState(null),[m,u]=h.useState(!1),[x,c]=h.useState(!1),[b,v]=h.useState(null),[f,y]=h.useState(null),[k,w]=h.useState(null),S=`atl2:bulk:${a}:${n}`;h.useEffect(()=>{la(a).then(R=>{y(R&&R.configured?R.url_hint||"webhook":null)})},[a]),h.useEffect(()=>{p(null),d(null),u(!1),v(null);try{const R=JSON.parse(localStorage.getItem(S)||"null");w(R&&Date.now()-Date.parse(R.t)<24*3600*1e3?R:null)}catch{w(null)}},[S]);const A=async()=>{l(!0),u(!1),v(null);const R=await yo(a,n);p(R),d(R.ok?n:null),l(!1)},T=h.useRef(!1),D=async()=>{if(T.current)return;T.current=!0,c(!0);const R=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let U;try{U=await wo(a,n,"webhook",void 0,R)}finally{T.current=!1}if(c(!1),u(!1),v(U),U.ok&&(U.pushed||0)>0){const j={t:new Date().toISOString(),n:U.pushed||0};w(j);try{localStorage.setItem(S,JSON.stringify(j))}catch{}}},E=s!=null&&s.ok&&s.ready||0,M=!!(s!=null&&s.ok)&&g===n&&E>0&&!!f&&!k,q=k?new Date(k.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:R=>o(R.target.value),children:e.plugBulkTabs.map(([R,U])=>t.jsx("option",{value:R,children:U},R))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{A()},children:i?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),k&&t.jsx("p",{className:"mnote",children:e.bulkLocked(q,k.n)}),!k&&!!(s!=null&&s.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!k&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),M&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),M&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(E,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:x,onClick:()=>{D()},children:x?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:x,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function Tl(){const{t:e,data:a,lang:r}=F(),n=a.credits,o=a.email,i=async l=>{if(!o)return;const s=window.location.href.split("?")[0];try{const g=await(await fetch(`${Ca}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ne,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Ll(){const{t:e}=F();return t.jsx(Ne,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(ml,{})})}function Rl(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:l,flash:s}=F(),[p,g]=h.useState(null),[d,m]=h.useState(!1);h.useEffect(()=>{let T=!0;if(i)return Aa(i).then(D=>{T&&D&&typeof D.per_day=="number"&&g(D.per_day)}),()=>{T=!1}},[i]);const u=r.stats,x=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(T=>T.kind==="target"&&Ee(T)).length,c=r.marketEstimate||0,b=c>0?Math.min(100,Math.round(x/c*100)):null,v=(u==null?void 0:u.window_days)||30,f=x>0?x/v:0,y=c>0?Math.max(0,c-x):0,w=c>0&&f>0&&x>=100?Math.round(y/f):null,S=T=>Math.round(T).toLocaleString(a==="en"?"en-US":"fr-FR"),A=T=>{d||!l||(m(!0),vo(o,T).then(D=>{if(m(!1),D===null){s(e.actErr);return}g(D),s(e.alertSaved)}))};return t.jsxs(Ne,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(S(x))}),c>0&&t.jsx("span",{children:e.covOf(S(c))})]}),b!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:b+"%"}}),t.jsxs("em",{children:[b," %"]})]}),w!==null&&t.jsx("p",{className:"mnote",children:e.covEta(w)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),f>=1&&t.jsx("p",{className:"mnote",children:e.covPace(S(f))}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(u.shown)})," ",e.covShown]})]}),l&&p!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(p)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(T=>t.jsx("button",{type:"button",className:p===T?"on":"",disabled:d,onClick:()=>A(T),children:T===0?"⏸":T},T))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Ml(){var f,y,k;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:l,lang:s}=F(),p=n==="client",g=h.useMemo(()=>{const w=new Set;return a.forEach(S=>{S.angle&&w.add(S.angle)}),[...w]},[a]),[d,m]=h.useState(""),[u,x]=h.useState(""),[c,b]=h.useState(!1),v=async()=>{const w=d.trim();if(!(!w||c||!p)){b(!0),x("");try{const A=await(await fetch(`${bt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&x(String(A.reply)),A.job_id){x(e.critChatRunning);const T=async()=>{const D=await fetch(`${bt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(E=>E.json()).catch(()=>null);if(D&&D.done){x(String(D.reply||D.clarification||D.summary||"✓")),b(!1),D.applied&&o(e.alertSaved);return}setTimeout(()=>{T()},8e3)};setTimeout(()=>{T()},8e3),m("");return}m("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(Ne,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var S,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((S=w.look)!=null&&S.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(T=>t.jsx("li",{children:T},T))})]}),!!((A=w.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(T=>t.jsx("li",{children:T},T))})]})]})]},w.title)})]}),!!((k=i==null?void 0:i.gate)!=null&&k.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!p||c,onChange:w=>m(w.target.value),onKeyDown:w=>{w.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},disabled:!p||c||!d.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(go,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,S])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(vr[w]||"v-cons"),children:w}),t.jsx("span",{children:S})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,S])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",S]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function ql(){const{t:e,dispatch:a,startTour:r}=F(),n=o=>{var i,l;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ne,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+l))})]})}const kr="atl2:mapfold",Ol=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(kr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},jr=h.createContext(null),F=()=>{const e=h.useContext(jr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Je({o:e,lg:a}){const{lang:r}=F(),n=ge(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ja(n,r),children:[n.emoji," ",Ja(n,r)]}):null}function Yt({o:e,src:a}){const{lang:r,t:n}=F(),o=ge(e);if(!o)return null;const i=To(o),l=Lo(o);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Un(o,r))+" · "+n.win7(_n(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<i?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Nr({o:e}){const{lang:a}=F(),r=zo(e.cc),n=e.cc?dt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const On="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Sr=e=>`atl2:tour:${e||"anon"}`;function Fl(e){try{return localStorage.getItem(Sr(e))==="1"}catch{return!0}}function Fn(e){try{localStorage.setItem(Sr(e),"1")}catch{}}function Pl(e,a,r,n){const o=e.tourT,i=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},{sel:".atl2 .cover",title:o.cover,body:e.fhintCover},{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:i[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:i[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:i[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:i[0][0],modal:"crit"}].filter(Boolean)}function _l({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){const{lang:l}=Co(),s=$o[l],p=Xo(e,l,a),[g,d]=h.useReducer(ei,void 0,()=>Zo((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Ol(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),m=h.useRef(!0);h.useEffect(()=>{if(m.current){m.current=!1;return}if(!e)try{localStorage.setItem(kr,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e]);const u=h.useRef(i);u.current=i,h.useEffect(()=>{var N;(N=u.current)==null||N.call(u,g.filters)},[g.filters]);const[x,c]=h.useState(null),[b,v]=h.useState(null),[f,y]=h.useState({kept:0,dropped:0}),[k,w]=h.useState(!1),[S,A]=h.useState(""),[T,D]=h.useState(!1),[E,M]=h.useState(null),[q,R]=h.useState(!1),[U,j]=h.useState(!1),[,C]=h.useState(0),L=()=>C(N=>N+1),H=h.useRef([]),G=h.useRef(new Set),X=h.useRef(new Set),z=h.useRef(new Map),O=h.useRef(null),{mode:B}=p,P=h.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[p.caps,o,a]),I=P.pipe,_=p.session.token||"",W=B==="client"&&!e;h.useEffect(()=>{if(document.querySelector(`link[href="${On}"]`))return;const N=document.createElement("link");N.rel="stylesheet",N.href=On,document.head.appendChild(N)},[]);const J=(N,V=!1)=>{A(N),D(V),O.current&&clearTimeout(O.current),O.current=setTimeout(()=>A(""),V?4200:2400)},re=N=>J(N,!0),fe=h.useMemo(()=>{const N=new Map;return p.dossiers.forEach(V=>{V.id&&N.set(V.id,V)}),N},[p.dossiers]),pe=h.useMemo(()=>p.dossiers.filter(N=>Yn(N,g,I)),[p.dossiers,g,I]),K=h.useRef(!1);h.useEffect(()=>{if(K.current||e||p.loading||!p.dossiers.length)return;if(!P.showFunnel||Fl(p.session.token||"")){K.current=!0;return}K.current=!0;const N=window.setTimeout(()=>{Fn(p.session.token||""),R(!0)},700);return()=>window.clearTimeout(N)},[e,p.loading,p.dossiers.length,P.showFunnel,p.session.token]);const ee=h.useMemo(()=>p.dossiers.filter(N=>ti(N,g,I,p.favIds)),[p.dossiers,g,I,p.favIds]),xe=h.useMemo(()=>Eo(pe,p.favIds),[pe,p.favIds]),Z=h.useMemo(()=>{const N=Kn(p.dossiers);return N?Ve(N)===0?s.tourToday:Qn(N,l):s.tourNoRun},[p.dossiers,s,l]),se=h.useMemo(()=>p.dossiers.some(N=>!!N.memoUrl||!!N.summary||ot(N)),[p.dossiers]),te=h.useMemo(()=>[1,0,2,4,5,3].find(N=>(xe[N]||0)>0)??0,[xe]),Se=za.find(N=>N.key===g.continent),he=g.continent==="monde"?s.contWorld:(l==="fr"?Se==null?void 0:Se.fr:Se==null?void 0:Se.en)||"";h.useEffect(()=>{const N=V=>{var ue;const Y=(((ue=V.detail)==null?void 0:ue.name)||"").trim();Y&&be(null,Y)};return window.addEventListener("ppmap:evaluate",N),()=>window.removeEventListener("ppmap:evaluate",N)}),h.useEffect(()=>{const N=ue=>{const Oe=String(ue||"").trim();Oe&&d({type:"filters",patch:{sector:[Oe]}})},V=ue=>{var Oe;return N((Oe=ue.detail)==null?void 0:Oe.sector)},Y=ue=>{ue.data&&ue.data.type==="pp-filter"&&N(ue.data.sector)};return window.addEventListener("ppmap:filter",V),window.addEventListener("message",Y),()=>{window.removeEventListener("ppmap:filter",V),window.removeEventListener("message",Y)}},[]);const be=(N,V)=>{const Y=((N==null?void 0:N.name)||V||"").trim();if(!W){v({kicker:Y});return}!Y||k||(w(!0),(async()=>{try{let ue=Y;const Oe=((N==null?void 0:N.website)||(N==null?void 0:N.domain)||"").trim();if(Oe)ue=Oe;else try{const me=await Ro(Y);if(me!=null&&me.website)ue=me.website;else if(((me==null?void 0:me.candidates)||[]).length===1)ue=me.candidates[0].url;else if(((me==null?void 0:me.candidates)||[]).length>1){H.current=[{name:Y,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(me.candidates||[]).slice(0,5)},...H.current].slice(0,8),L();return}}catch{}const Fe=await Bn(_,ue,"atelier2"),zr={name:Fe.company||Y,verdict:Fe.verdict,reason:Fe.reason||"",remaining:Fe.remaining??null};H.current=[zr,...H.current].slice(0,8),Fe.verdict==="kept"&&y(me=>({...me,kept:me.kept+1})),Fe.verdict==="ruled_out"&&y(me=>({...me,dropped:me.dropped+1}));const pt=N||p.dossiers.find(me=>(me.name||"").toLowerCase()===Y.toLowerCase());pt&&(Fe.verdict==="kept"?pt.verdict=pt.verdict||"MATCH":Fe.verdict==="ruled_out"&&(pt.verdict="NO MATCH"),Fe.reason&&(pt.reasoning=Fe.reason)),L()}finally{w(!1)}})())},et=N=>{if(!W){v({kicker:N.name});return}G.current.add(N.id),ut(_,"fast_request",N.name||"",""),J(s.memoInstantSent(N.name)),L()},tt=N=>z.current.get(N.id)??p.thumbs.get((N.name||"").trim().toLowerCase()),Ae=(N,V)=>d({type:"undoPush",entry:{id:N.id,name:N.name,prevCeoStatus:V}}),ze=async(N,V,Y)=>{const ue=N.ceoStatus||"";N.ceoStatus=V,L();const Oe=await Jt(_,{status:V,airtable_id:N.airtableId,check_id:N.checkId,company:N.name,...(Y==null?void 0:Y.note)!==void 0?{note:Y.note}:{},...Y!=null&&Y.via?{via:Y.via}:{}});return Oe.ok?Oe.skipped?(N.ceoStatus=ue,L(),re(s.actNotPersisted),!1):((Y==null?void 0:Y.undo)!==!1&&Ae(N,ue),Y!=null&&Y.msg&&J(Y.msg),(V==="Validé"||V==="Écarté")&&!N.ceoNote&&(Y==null?void 0:Y.note)===void 0&&M({o:N,yes:V==="Validé"}),!0):(N.ceoStatus=ue,L(),re(s.actErr),!1)},at=async(N,V)=>{const Y=await Jt(_,{status:N.ceoStatus||"Retenu",airtable_id:N.airtableId,check_id:N.checkId,company:N.name,note:V,via:"note"});return!Y.ok||Y.skipped?(re(Y.skipped?s.actNotPersisted:s.actErr),!1):(N.ceoNote=V,L(),!0)},ct=h.useRef(new Map),Wt=N=>ct.current.has(N.id)?ct.current.get(N.id):p.stages.get((N.name||"").trim().toLowerCase()),$=(N,V)=>{ct.current.set(N.id,V),L()},ae=(N,V)=>{W&&ze(N,V?"Validé":"Écarté",{msg:V?s.decidedYes(N.name):s.decidedNo(N.name)})},oe=N=>{W&&ze(N,"À trancher",{msg:s.promoted(N.name)})},ye=N=>{W&&(async()=>{const V=N.ceoStatus||"";N.ceoStatus="Retenu",L();const Y=await Jt(_,{status:"Retenu",check_id:N.checkId,company:N.name});if(!Y.ok||Y.skipped){N.ceoStatus=V,L(),re(Y.skipped?s.actNotPersisted:s.actErr);return}Ae(N,V),J(s.repeched(N.name))})()},_e=()=>{const N=g.undo[g.undo.length-1];if(!N){J(s.undoNone);return}const V=fe.get(N.id);if(!V){d({type:"undoPop"}),J(s.undoNone);return}let Y=N.prevCeoStatus;if(!Y)if((V.verdict||"").toUpperCase().includes("CALL"))Y="À trancher";else{J(s.undoLockedTitle);return}(async()=>await ze(V,Y,{undo:!1})&&(d({type:"undoPop"}),V.ceoStatus=N.prevCeoStatus,L(),J(s.undoDone(V.name))))()},je=N=>{W&&(X.current.add(N.id),L(),(async()=>{const V=await Mo(_,N.name,"email");if(!V||V.ok===!1){X.current.delete(N.id),L(),re(s.actErr);return}ut(_,"approach",N.name||"",""),J(s.actApproachSent)})())},le=(N,V)=>{W&&(async()=>{if(!(await ut(_,V?"yes":"no",N.name||"","")).ok){re(s.actErr);return}z.current.set(N.id,V?"yes":"no"),L(),J(V?s.thumbUpDone:s.thumbDnDone)})()},Te=N=>{!W||!ot(N)||(ut(_,"detailed_request",N.name||"",""),J(s.memoDeepSent(N.name)))},Gt=N=>{const V=new Set(p.favIds),Y=V.has(N.id);Y?V.delete(N.id):V.add(N.id),p.setFavIds(V),W&&qo(_,{id:N.id,co:N.name},Y)},Nt=()=>{!W||U||window.confirm(s.identSyncConfirm)&&(j(!0),(async()=>{const N=await Oo(_);j(!1),N?J(s.identSyncDone):re(s.actErr)})())},Pa=/proplace/i.test(p.fund||""),Cr=N=>{!W||!Pa||(ut(_,"onboard_request",N.name||"",""),J(s.onboardSent(N.name)))},Er={st:g,dispatch:d,t:s,lang:l,mode:B,caps:P,pipe:I,token:_,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:ye,thumbOf:tt,canWrite:W,commitStatus:ze,saveNote:at,stageOf:Wt,setStage:$,flashErr:re,startTour:()=>R(!0),dossiers:p.dossiers,scopedAll:pe,scoped:ee,counts:xe,byId:fe,contName:he,favIds:p.favIds,toggleFav:Gt,askEvaluate:be,doAnalyse:et,doDecide:ae,doPromote:oe,doApproach:je,doThumb:le,doDeep:Te,doUndo:_e,doSync:Nt,doOnboard:Cr,outbound:Pa,memoQueued:G.current,approachDone:X.current,sessTally:f,evalCards:H.current,evalBusy:k,markRow:c,markedId:x,flash:J};h.useEffect(()=>{const N=V=>{V.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",N),()=>window.removeEventListener("keydown",N)},[]);const Ar=N=>_?t.jsx(Bs,{token:_,children:N}):t.jsx(t.Fragment,{children:N});return t.jsx(jr.Provider,{value:Er,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:_o}),Ar(t.jsxs("div",{className:"app"+(I?" pipe":"")+(_?" has-thesis":""),children:[P.showTicker&&t.jsx(ve,{name:"live",children:t.jsxs("div",{className:"live-stack"+(_?" live-stack--cibles":""),children:[t.jsx(ii,{}),!!_&&t.jsx(Us,{})]})}),P.showIdent&&t.jsx(ve,{name:"identite",children:t.jsx(ji,{})}),!!_&&t.jsx(ve,{name:"lead",children:t.jsx($s,{})}),P.showOnb&&t.jsx(ve,{name:"onboarding",children:t.jsx(Ni,{})}),P.showMorning&&t.jsx(ve,{name:"matin",children:t.jsx(ki,{})}),t.jsx(ve,{name:"fraicheur",children:t.jsx(fi,{})}),t.jsx(ve,{name:"mesure",children:t.jsx(xi,{})}),P.showFunnel&&t.jsx(ve,{name:"entonnoir",children:t.jsx(Dl,{})}),P.showFunnel&&t.jsx(ve,{name:"tunnel",children:t.jsx(Ci,{})}),P.showFunnel&&t.jsx(ve,{name:"tuto",children:t.jsx(Ai,{})}),t.jsx(ve,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Il,{}),t.jsxs("div",{className:"stage"+(g.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(Ss,{}),t.jsx(Es,{})]})]})}),P.showDemand&&t.jsx(ve,{name:"evaluation",children:t.jsx(Ms,{})}),P.showDemand&&g.memoConsole&&t.jsx(ve,{name:"console",children:t.jsx(Os,{})}),t.jsx(ve,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(sl,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),P.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),g.popupId&&t.jsx(ve,{name:"fiche",children:t.jsx(Hs,{})}),t.jsx(ve,{name:"modales",children:t.jsx(xl,{})}),t.jsx(pi,{}),E&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:E.o.name}),t.jsx(vi,{placeholder:E.yes?s.whyYesPh:s.whyNoPh,onDone:N=>{const V=E.o;M(null),N&&at(V,N).then(Y=>{Y&&J(s.csNoteSaved)})}})]}),q&&t.jsx(wi,{steps:Pl(s,Z,se,te),onClose:()=>{R(!1),Fn(_)}}),S&&t.jsx("div",{className:"flash on"+(T?" err":""),children:S}),b&&t.jsx(Ao,{variant:"acquirer",initialCompany:Pn().co,initialWebsite:Pn().site,onClose:()=>v(null)})]})})}function Dl(){const{t:e}=F(),[a,r]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Il(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:o,t:i}=F(),l=h.useMemo(()=>{const s={};return e.forEach(p=>{Ta(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[Fo.map(s=>{const p=za.find(d=>d.key===s),g=s==="monde"?i.contWorld:o==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[g,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?i.showMap:i.hideMap})})]})}function Pn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function $l(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Nr as FlagCell,Je as SigBadge,Yt as SigWin,_l as default,$l as fmtShort,F as useV2};
