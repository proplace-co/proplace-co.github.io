...
.atl2.ops .desk{margin:var(--v3-stack) var(--v3-pad) 0;border-top:0;background:transparent;
  grid-template-columns:minmax(0,63fr) minmax(0,37fr);gap:24px;align-items:start}
.atl2.ops .desk-list{border:1px solid var(--pp-line,#E3E8F0);border-radius:12px;
  background:#fff;overflow:visible;min-width:0}
.atl2.ops .readpane,.atl2.ops .readpane.is-edito,
body.pp-desk .atl2.ops .readpane,body.pp-desk .atl2.ops .readpane.is-edito{
  background:transparent;border-left:0;border-top:0;padding:0;
  display:flex;flex-direction:column;gap:14px;overflow:visible;
  box-shadow:none;position:sticky;align-self:start;z-index:21;
...
.atl2.ops .readpane .zoom,.atl2.ops .readpane.is-edito .zoom{
  border:1px solid var(--pp-line,#E3E8F0);border-radius:14px;background:#fff;
  overflow:visible;padding:0;margin:0;max-width:none;min-width:0;box-sizing:border-box}
