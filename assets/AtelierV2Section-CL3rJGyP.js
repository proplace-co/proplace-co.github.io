...
`;class me extends h.Component{constructor(){super(...arguments);Ma(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ai=8;function ni(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=q(),[s,p]=h.useState(!1),[f,d]=h.useState(!1),[c,m]=h.useState(!1),v=r||"home",{names:x,verdicts:g}=h.useMemo(()=>{const w=[],S={};return n.forEach(C=>{C.kind!=="target"||!C.name||(w.push(C.name),S[C.name]=Dr(C)||"")}),{names:w,verdicts:S}},[n]),b=h.useMemo(()=>x.length?Ir(v,x,g,a):null,[v,x.length]);if(!i.pipe||s||!b||b.firstVisit||!b.added.length&&!b.gone.length)return null;const u=f?b.added:b.added.slice(0,ai),y=b.added.length-u.length,N=w=>{const S=n.find(C=>C.name===w);S&&(o(S.id),l({type:"popup",id:S.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(b.added.length,b.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Br(v,x,g,b.fp,a)},children:"×"})]}),!!b.added.length&&t.jsxs("div",{className:"since-c",children:[u.map(w=>t.jsx("button",{type:"button",onClick:()=>N(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!b.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>m(w=>!w),children:e.sinceOut(b.gone.length)}),c&&b.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Xt=600,He=62,Xa="atl2:fstats";function ri(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=q(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Xa)==="on"}catch{return!1}}),p=r.stats,f=h.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=h.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const c=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,m=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),v=f.reduce((y,N)=>Math.max(y,N.s||0),0),x=f.length?Xt/f.length:0,g=Math.max(4,x-4),b=f.length>=5&&v>0,u=[[p.screened,e.funScreened(c(d)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[u.map(([y,N,w],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:m(y)}),t.jsx("i",{children:N}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},N)),b&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Xa,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&b&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Xt} ${He}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((y,N)=>{const w=(y.s||0)/v*(He-4),S=(y.m||0)/v*(He-4),C=N*x+(x-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${c(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:C,y:He-2-w,width:g,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:C,y:He-2-S,width:g,height:S,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:He-1.5,x2:Xt,y2:He-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:c(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const oi=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ii({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=q(),[o,l]=h.useState(""),[s,p]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),d=(nt(e)||"").startsWith("CALL")&&ke(e)===3,c=ke(e)>=2,m=async x=>{if(o||x==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(x);const g=await i(e,x);l(""),g&&(p(!0),setTimeout(()=>p(!1),2200))},v=d?[["Validé",a.csYes],["Écarté",a.csNo]]:oi.filter(([x])=>!(c&&x==="Retenu")).map(([x,g])=>[x,a[g]]);return t.jsxs("div",{className:"csp",onClick:x=>x.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([x,g])=>t.jsx("button",{type:"button",className:"csb"+(f===x?" on":"")+(o===x?" busy":""),disabled:!!o,onClick:()=>{m(x)},children:g},x)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(si,{o:e})]})}function si({o:e}){const{t:a,saveNote:r,flash:n}=q(),[i,o]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[p,f]=h.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),c=async()=>{if(l||!d)return;s(!0);const m=await r(e,i.trim());s(!1),m&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:m=>o(m.target.value),onKeyDown:m=>{m.key==="Enter"&&c()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{c()},children:p?a.csNoteSaved:a.csNoteOk})]})}function li({placeholder:e,onDone:a}){const{t:r}=q(),[n,i]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function di({o:e}){var b;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=q(),[p,f]=h.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const d=o(e),c=(d==null?void 0:d.stage)||"todo",m=async u=>{if(p||u===c)return;f(!0);const y=d;l(e,{stage:u,stamps:(d==null?void 0:d.stamps)||{}});const N=Math.max(Date.now(),Ja+=1);Ja=N;const w=await $r(r,{company:e.name||"",stage:u,cts:N,deal_id:e.airtableId,check_id:e.checkId});f(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},v=(b=d==null?void 0:d.stamps)==null?void 0:b.sent,x=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,g=c==="sent"&&v&&x>=4;return t.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,y])=>t.jsx("button",{type:"button",className:"stgb"+(c===u?" on":""),disabled:p,onClick:()=>{m(u)},children:y},u)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(x)})]})}let Ja=0;const kt=8,jt=340;function Za({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function ci({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,scoped:o,byId:l,st:s}=q(),[p,f]=h.useState(0),[d,c]=h.useState(null),[m,v]=h.useState([]),x=h.useRef(!1);h.useEffect(()=>{x.current||(x.current=!0,v(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const g=m[p],b=p>=m.length;h.useEffect(()=>{g&&(g.ptab!==void 0&&s.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&s.dens!==g.dens&&n({type:"dens",dens:g.dens}))},[p,g]);const u=h.useCallback(()=>{if(!g){c(null);return}const S=document.querySelector(g.sel);if(!S){c(null);return}S.scrollIntoView({block:"nearest",behavior:"smooth"}),c(S.getBoundingClientRect())},[g]);h.useLayoutEffect(()=>{u();const S=window.setTimeout(u,260),C=()=>u();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{window.clearTimeout(S),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[u]);const y=h.useRef(a);if(y.current=a,h.useEffect(()=>{const S=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),y.current()):C.key==="ArrowRight"?f(O=>O+1):C.key==="ArrowLeft"&&f(O=>Math.max(0,O-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!m.length)return null;let N=null;if(b){const S=i[3]||0,C=o.find(O=>O.memoUrl)||[...l.values()].find(O=>O.memoUrl);S>0?N={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:C?N={title:r.ahaBTitle,body:r.ahaBBody(C.name),btn:r.ahaBBtn,go:()=>{n({type:"memoConsole",id:C.id}),a()}}:N={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:jt};if(!b&&d){const S=d.bottom+14,O=window.innerHeight-S>190?S:Math.max(12,d.top-200);w={left:Math.min(Math.max(12,d.left+d.width/2-jt/2),window.innerWidth-jt-12),top:O,width:jt}}return at.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!b&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-kt,top:d.top-kt,width:d.width+kt*2,height:d.height+kt*2}}),(b||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(b?" fin":""),style:w,children:[b&&N?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:N.title}),t.jsx("p",{children:t.jsx(Za,{text:N.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>f(m.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:N.go,children:N.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(p+1,m.length)}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx("p",{children:t.jsx(Za,{text:(g==null?void 0:g.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:p===0,onClick:()=>f(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>f(S=>S+1),children:p===m.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function pi(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,dispatch:l}=q(),s=r?a:e,p=h.useMemo(()=>s.filter(u=>tt(u.date)===0&&u.kind==="target"),[s]),f=h.useMemo(()=>r?a.filter(u=>ke(u)===0).slice().sort((u,y)=>(y.date||"").localeCompare(u.date||"")):[],[a,r]),d=h.useMemo(()=>p.filter(u=>r?ke(u)===0:!Ce(u)),[p,r]),c=r?f:d,m=r?a.length-f.length:p.length-d.length,v=r?a.length:p.length,x=v?Math.min(100,m/v*100):100;let g;r?g=i.morningThesis(p.length,f.length):p.length?m===0?g=i.goalSourced(p.length):m>=p.length?g=i.goalCleared:g=i.goalDone(m,p.length):g=i.goalSourced(0);const b=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&f.length&&l({type:"chainStart",queue:f.map(u=>u.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:g}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:x+"%"}})}),c.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:b,children:r?i.morningEval(c.length):o.pileMode?i.goalContinue(c.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ui(){var k,L;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:f,startTour:d}=q(),[c,m]=h.useState(null),[v,x]=h.useState([]),g=p==="client";h.useEffect(()=>{if(!i||!o)return;let j=!0;return(async()=>{const[M,T]=await Promise.all([Sa(o),Rn(i)]);j&&(M&&m(M),x(T))})(),()=>{j=!1}},[i,o]);const b=(c==null?void 0:c.per_day)??null,u=((k=c==null?void 0:c.pool_order)==null?void 0:k.length)??0,y=v.filter(j=>j.status==="running").length,N=h.useMemo(()=>s.filter(j=>j.kind==="target"&&Ce(j)).length,[s]),w=l.marketEstimate,S=typeof((L=l.stats)==null?void 0:L.screened)=="number"?l.stats.screened:N,C=w&&w>0?Math.min(100,Math.round(S/w*100)):null,O=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),F=(o||"P").split(/\s+/).map(j=>j[0]).join("").slice(0,2).toUpperCase(),A=(()=>{const j=Date.parse(l.generatedAt||"");if(Number.isNaN(j))return"";const M=new Date(j),T=E=>String(E).padStart(2,"0");return`${T(M.getDate())}/${T(M.getMonth()+1)} à ${T(M.getHours())}:${T(M.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:F}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),A&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(A)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[C===null&&S>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:O(S)})})]}),C!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:C+"%"}})}),t.jsxs("b",{children:[C," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(S,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),b!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:b})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),b===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(u)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:j=>{j.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!g,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:j=>n({type:"filters",patch:{search:j.target.value}})})]})]})]})}function fi(){const{t:e,counts:a,dispatch:r}=q();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const mi=["--p0","--p1","--p2","--p3","--p4"];function xi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i}=q(),o=h.useRef({});h.useEffect(()=>{o.current={...r}},[r]);const l=f=>{const d=o.current[f],c=d!==void 0?r[f]-d:0;return t.jsxs("button",{type:"button",className:"step"+(f===3&&r[3]>0?" wait":""),style:{"--c":`var(${mi[f]})`,"--tc":f<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===f,title:n.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[t.jsxs("span",{className:"l",children:[n.plabels[f].toUpperCase(),f===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(c>0?" up":c<0?" down":""),children:[r[f],c!==0&&t.jsxs("em",{className:"delta",children:[c>0?"+":"−",Math.abs(c)]})]})]},f)},s=(f,d,c)=>t.jsxs("button",{type:"button",className:"off"+(d?" view":""),style:{"--c":f===5?"var(--p5)":f===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===f,title:n.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[t.jsx("span",{className:"l",children:c.toUpperCase()}),t.jsx("span",{className:"n",children:r[f]})]},f),p=(f,d,c,m=!1)=>t.jsx("button",{type:"button",className:"tool",title:d,disabled:m,onClick:c,children:f},d);return t.jsxs("div",{className:"funnel",children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[p("↩",n.toolUndo,i,e.undo.length===0),p("↺",n.toolReset,()=>{a({type:"reset"})}),p("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),p("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const hi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function gi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=q(),s=h.useRef(null),[p,f]=h.useState(60);h.useEffect(()=>{let v=0;const x=()=>{var N;const g=s.current;if(!g)return;const b=(N=g.parentElement)==null?void 0:N.querySelector('.funnel [aria-selected="true"]');if(!b)return;const u=b.getBoundingClientRect(),y=g.getBoundingClientRect();f(Math.max(20,Math.min(u.left+u.width/2-y.left,y.width-30)))};return v=requestAnimationFrame(x),window.addEventListener("resize",x),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",x)}},[e.ptab]);const d=e.ptab;let c=r.tuto[d].p;if(d===3){const v=n.filter(b=>b.kind==="target"&&ke(b)===3),x=v.filter(b=>na(b)==="auto").length,g=v.filter(b=>na(b)==="cd").length;c=r.tutoPending(x,g,v.length)}const m=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(v=>v.id)})};if(d===1){const v=n.filter(x=>x.kind==="target"&&ke(x)===1&&!i.has(x.id)).slice(0,10);if(v.length)return{label:r.tuto[1].a,run:()=>v.forEach(x=>o(x))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":hi[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:c}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label})]})}class We{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*bi(e){for(const a of e)yield*a}function _n(e){return Array.from(bi(e))}var Z=1e-6,W=Math.PI,ze=W/2,en=W/4,Te=W*2,Fe=180/W,Se=W/180,te=Math.abs,vi=Math.atan,xt=Math.atan2,oe=Math.cos,ie=Math.sin,yi=Math.sign||function(e){return e>0?1:e<0?-1:0},Ke=Math.sqrt;function wi(e){return e>1?0:e<-1?W:Math.acos(e)}function ht(e){return e>1?ze:e<-1?-ze:Math.asin(e)}function Ae(){}function Rt(e,a){e&&an.hasOwnProperty(e.type)&&an[e.type](e,a)}var tn={Feature:function(e,a){Rt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Rt(r[n].geometry,a)}},an={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){sa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)sa(r[n],a,0)},Polygon:function(e,a){nn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)nn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Rt(r[n],a)}};function sa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function nn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)sa(e[r],a,1);a.polygonEnd()}function Qe(e,a){e&&tn.hasOwnProperty(e.type)?tn[e.type](e,a):Rt(e,a)}function la(e){return[xt(e[1],e[0]),ht(e[2])]}function Ze(e){var a=e[0],r=e[1],n=oe(r);return[n*oe(a),n*ie(a),ie(r)]}function Nt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ot(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Jt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function St(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function da(e){var a=Ke(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ca(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function pa(e,a){return te(e)>W&&(e-=Math.round(e/Te)*Te),[e,a]}pa.invert=pa;function ki(e,a,r){return(e%=Te)?a||r?ca(on(e),sn(a,r)):on(e):a||r?sn(a,r):pa}function rn(e){return function(a,r){return a+=e,te(a)>W&&(a-=Math.round(a/Te)*Te),[a,r]}}function on(e){var a=rn(e);return a.invert=rn(-e),a}function sn(e,a){var r=oe(e),n=ie(e),i=oe(a),o=ie(a);function l(s,p){var f=oe(p),d=oe(s)*f,c=ie(s)*f,m=ie(p),v=m*r+d*n;return[xt(c*i-v*o,d*r-m*n),ht(v*i+c*o)]}return l.invert=function(s,p){var f=oe(p),d=oe(s)*f,c=ie(s)*f,m=ie(p),v=m*i-c*o;return[xt(c*i+m*o,d*r+v*n),ht(v*r-d*n)]},l}function ji(e,a,r,n,i,o){if(r){var l=oe(a),s=ie(a),p=n*r;i==null?(i=a+n*Te,o=a-p/2):(i=ln(l,i),o=ln(l,o),(n>0?i<o:i>o)&&(i+=n*Te));for(var f,d=i;n>0?d>o:d<o;d-=p)f=la([l,-s*oe(d),-s*ie(d)]),e.point(f[0],f[1])}}function ln(e,a){a=Ze(a),a[0]-=e,da(a);var r=wi(-a[1]);return((-a[2]<0?-r:r)+Te-Z)%Te}function Un(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ae,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Lt(e,a){return te(e[0]-a[0])<Z&&te(e[1]-a[1])<Z}function Ct(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Vn(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(x){if(!((g=x.length-1)<=0)){var g,b=x[0],u=x[g],y;if(Lt(b,u)){if(!b[2]&&!u[2]){for(i.lineStart(),s=0;s<g;++s)i.point((b=x[s])[0],b[1]);i.lineEnd();return}u[0]+=2*Z}o.push(y=new Ct(b,x,null,!0)),l.push(y.o=new Ct(b,null,y,!1)),o.push(y=new Ct(u,x,null,!1)),l.push(y.o=new Ct(u,null,y,!0))}}),!!o.length){for(l.sort(a),dn(o),dn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var f=o[0],d,c;;){for(var m=f,v=!0;m.v;)if((m=m.n)===f)return;d=m.z,i.lineStart();do{if(m.v=m.o.v=!0,m.e){if(v)for(s=0,p=d.length;s<p;++s)i.point((c=d[s])[0],c[1]);else n(m.x,m.n.x,1,i);m=m.n}else{if(v)for(d=m.p.z,s=d.length-1;s>=0;--s)i.point((c=d[s])[0],c[1]);else n(m.x,m.p.x,-1,i);m=m.p}m=m.o,d=m.z,v=!v}while(!m.v);i.lineEnd()}}}function dn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function Zt(e){return te(e[0])<=W?e[0]:yi(e[0])*((te(e[0])+W)%Te-W)}function Ni(e,a){var r=Zt(a),n=a[1],i=ie(n),o=[ie(r),-oe(r),0],l=0,s=0,p=new We;i===1?n=ze+Z:i===-1&&(n=-ze-Z);for(var f=0,d=e.length;f<d;++f)if(m=(c=e[f]).length)for(var c,m,v=c[m-1],x=Zt(v),g=v[1]/2+en,b=ie(g),u=oe(g),y=0;y<m;++y,x=w,b=C,u=O,v=N){var N=c[y],w=Zt(N),S=N[1]/2+en,C=ie(S),O=oe(S),F=w-x,A=F>=0?1:-1,k=A*F,L=k>W,j=b*C;if(p.add(xt(j*A*ie(k),u*O+j*oe(k))),l+=L?F+A*Te:F,L^x>=r^w>=r){var M=Ot(Ze(v),Ze(N));da(M);var T=Ot(o,M);da(T);var E=(L^F>=0?-1:1)*ht(T[2]);(n>E||n===E&&(M[0]||M[1]))&&(s+=L^F>=0?1:-1)}}return(l<-Z||l<Z&&p<-1e-12)^s&1}function Hn(e,a,r,n){return function(i){var o=a(i),l=Un(),s=a(l),p=!1,f,d,c,m={point:v,lineStart:g,lineEnd:b,polygonStart:function(){m.point=u,m.lineStart=y,m.lineEnd=N,d=[],f=[]},polygonEnd:function(){m.point=v,m.lineStart=g,m.lineEnd=b,d=_n(d);var w=Ni(f,n);d.length?(p||(i.polygonStart(),p=!0),Vn(d,Ci,w,r,i)):w&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),d=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function v(w,S){e(w,S)&&i.point(w,S)}function x(w,S){o.point(w,S)}function g(){m.point=x,o.lineStart()}function b(){m.point=v,o.lineEnd()}function u(w,S){c.push([w,S]),s.point(w,S)}function y(){s.lineStart(),c=[]}function N(){u(c[0][0],c[0][1]),s.lineEnd();var w=s.clean(),S=l.result(),C,O=S.length,F,A,k;if(c.pop(),f.push(c),c=null,!!O){if(w&1){if(A=S[0],(F=A.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),C=0;C<F;++C)i.point((k=A[C])[0],k[1]);i.lineEnd()}return}O>1&&w&2&&S.push(S.pop().concat(S.shift())),d.push(S.filter(Si))}}return m}}function Si(e){return e.length>1}function Ci(e,a){return((e=e.x)[0]<0?e[1]-ze-Z:ze-e[1])-((a=a.x)[0]<0?a[1]-ze-Z:ze-a[1])}const cn=Hn(function(){return!0},Ei,Ai,[-W,-ze]);function Ei(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?W:-W,p=te(o-a);te(p-W)<Z?(e.point(a,r=(r+l)/2>0?ze:-ze),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=W&&(te(a-n)<Z&&(a-=n*Z),te(o-s)<Z&&(o-=s*Z),r=zi(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function zi(e,a,r,n){var i,o,l=ie(e-r);return te(l)>Z?vi((ie(a)*(o=oe(n))*ie(r)-ie(n)*(i=oe(a))*ie(e))/(i*o*l)):(a+n)/2}function Ai(e,a,r,n){var i;if(e==null)i=r*ze,n.point(-W,i),n.point(0,i),n.point(W,i),n.point(W,0),n.point(W,-i),n.point(0,-i),n.point(-W,-i),n.point(-W,0),n.point(-W,i);else if(te(e[0]-a[0])>Z){var o=e[0]<a[0]?W:-W;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ti(e){var a=oe(e),r=2*Se,n=a>0,i=te(a)>Z;function o(d,c,m,v){ji(v,e,r,m,d,c)}function l(d,c){return oe(d)*oe(c)>a}function s(d){var c,m,v,x,g;return{lineStart:function(){x=v=!1,g=1},point:function(b,u){var y=[b,u],N,w=l(b,u),S=n?w?0:f(b,u):w?f(b+(b<0?W:-W),u):0;if(!c&&(x=v=w)&&d.lineStart(),w!==v&&(N=p(c,y),(!N||Lt(c,N)||Lt(y,N))&&(y[2]=1)),w!==v)g=0,w?(d.lineStart(),N=p(y,c),d.point(N[0],N[1])):(N=p(c,y),d.point(N[0],N[1],2),d.lineEnd()),c=N;else if(i&&c&&n^w){var C;!(S&m)&&(C=p(y,c,!0))&&(g=0,n?(d.lineStart(),d.point(C[0][0],C[0][1]),d.point(C[1][0],C[1][1]),d.lineEnd()):(d.point(C[1][0],C[1][1]),d.lineEnd(),d.lineStart(),d.point(C[0][0],C[0][1],3)))}w&&(!c||!Lt(c,y))&&d.point(y[0],y[1]),c=y,v=w,m=S},lineEnd:function(){v&&d.lineEnd(),c=null},clean:function(){return g|(x&&v)<<1}}}function p(d,c,m){var v=Ze(d),x=Ze(c),g=[1,0,0],b=Ot(v,x),u=Nt(b,b),y=b[0],N=u-y*y;if(!N)return!m&&d;var w=a*u/N,S=-a*y/N,C=Ot(g,b),O=St(g,w),F=St(b,S);Jt(O,F);var A=C,k=Nt(O,A),L=Nt(A,A),j=k*k-L*(Nt(O,O)-1);if(!(j<0)){var M=Ke(j),T=St(A,(-k-M)/L);if(Jt(T,O),T=la(T),!m)return T;var E=d[0],R=c[0],D=d[1],_=c[1],G;R<E&&(G=E,E=R,R=G);var pe=R-E,se=te(pe-W)<Z,le=se||pe<Z;if(!se&&_<D&&(G=D,D=_,_=G),le?se?D+_>0^T[1]<(te(T[0]-E)<Z?D:_):D<=T[1]&&T[1]<=_:pe>W^(E<=T[0]&&T[0]<=R)){var K=St(A,(-k+M)/L);return Jt(K,O),[T,la(K)]}}}function f(d,c){var m=n?e:W-e,v=0;return d<-m?v|=1:d>m&&(v|=2),c<-m?v|=4:c>m&&(v|=8),v}return Hn(l,s,o,n?[0,-e]:[-W,e-W])}function Li(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],f=a[1],d=0,c=1,m=p-l,v=f-s,x;if(x=r-l,!(!m&&x>0)){if(x/=m,m<0){if(x<d)return;x<c&&(c=x)}else if(m>0){if(x>c)return;x>d&&(d=x)}if(x=i-l,!(!m&&x<0)){if(x/=m,m<0){if(x>c)return;x>d&&(d=x)}else if(m>0){if(x<d)return;x<c&&(c=x)}if(x=n-s,!(!v&&x>0)){if(x/=v,v<0){if(x<d)return;x<c&&(c=x)}else if(v>0){if(x>c)return;x>d&&(d=x)}if(x=o-s,!(!v&&x<0)){if(x/=v,v<0){if(x>c)return;x>d&&(d=x)}else if(v>0){if(x<d)return;x<c&&(c=x)}return d>0&&(e[0]=l+d*m,e[1]=s+d*v),c<1&&(a[0]=l+c*m,a[1]=s+c*v),!0}}}}}var dt=1e9,Et=-dt;function Ri(e,a,r,n){function i(f,d){return e<=f&&f<=r&&a<=d&&d<=n}function o(f,d,c,m){var v=0,x=0;if(f==null||(v=l(f,c))!==(x=l(d,c))||p(f,d)<0^c>0)do m.point(v===0||v===3?e:r,v>1?n:a);while((v=(v+c+4)%4)!==x);else m.point(d[0],d[1])}function l(f,d){return te(f[0]-e)<Z?d>0?0:3:te(f[0]-r)<Z?d>0?2:1:te(f[1]-a)<Z?d>0?1:0:d>0?3:2}function s(f,d){return p(f.x,d.x)}function p(f,d){var c=l(f,1),m=l(d,1);return c!==m?c-m:c===0?d[1]-f[1]:c===1?f[0]-d[0]:c===2?f[1]-d[1]:d[0]-f[0]}return function(f){var d=f,c=Un(),m,v,x,g,b,u,y,N,w,S,C,O={point:F,lineStart:j,lineEnd:M,polygonStart:k,polygonEnd:L};function F(E,R){i(E,R)&&d.point(E,R)}function A(){for(var E=0,R=0,D=v.length;R<D;++R)for(var _=v[R],G=1,pe=_.length,se=_[0],le,K,B=se[0],U=se[1];G<pe;++G)le=B,K=U,se=_[G],B=se[0],U=se[1],K<=n?U>n&&(B-le)*(n-K)>(U-K)*(e-le)&&++E:U<=n&&(B-le)*(n-K)<(U-K)*(e-le)&&--E;return E}function k(){d=c,m=[],v=[],C=!0}function L(){var E=A(),R=C&&E,D=(m=_n(m)).length;(R||D)&&(f.polygonStart(),R&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),D&&Vn(m,s,E,o,f),f.polygonEnd()),d=f,m=v=x=null}function j(){O.point=T,v&&v.push(x=[]),S=!0,w=!1,y=N=NaN}function M(){m&&(T(g,b),u&&w&&c.rejoin(),m.push(c.result())),O.point=F,w&&d.lineEnd()}function T(E,R){var D=i(E,R);if(v&&x.push([E,R]),S)g=E,b=R,u=D,S=!1,D&&(d.lineStart(),d.point(E,R));else if(D&&w)d.point(E,R);else{var _=[y=Math.max(Et,Math.min(dt,y)),N=Math.max(Et,Math.min(dt,N))],G=[E=Math.max(Et,Math.min(dt,E)),R=Math.max(Et,Math.min(dt,R))];Li(_,G,e,a,r,n)?(w||(d.lineStart(),d.point(_[0],_[1])),d.point(G[0],G[1]),D||d.lineEnd(),C=!1):D&&(d.lineStart(),d.point(E,R),C=!1)}y=E,N=R,w=D}return O}}const ua=e=>e;var ea=new We,fa=new We,Yn,Wn,ma,xa,Pe={point:Ae,lineStart:Ae,lineEnd:Ae,polygonStart:function(){Pe.lineStart=Oi,Pe.lineEnd=qi},polygonEnd:function(){Pe.lineStart=Pe.lineEnd=Pe.point=Ae,ea.add(te(fa)),fa=new We},result:function(){var e=ea/2;return ea=new We,e}};function Oi(){Pe.point=Mi}function Mi(e,a){Pe.point=Gn,Yn=ma=e,Wn=xa=a}function Gn(e,a){fa.add(xa*e-ma*a),ma=e,xa=a}function qi(){Gn(Yn,Wn)}var et=1/0,Mt=et,gt=-et,qt=gt,Ft={point:Fi,lineStart:Ae,lineEnd:Ae,polygonStart:Ae,polygonEnd:Ae,result:function(){var e=[[et,Mt],[gt,qt]];return gt=qt=-(Mt=et=1/0),e}};function Fi(e,a){e<et&&(et=e),e>gt&&(gt=e),a<Mt&&(Mt=a),a>qt&&(qt=a)}var ha=0,ga=0,ct=0,Pt=0,Dt=0,Xe=0,ba=0,va=0,pt=0,Kn,Qn,Re,Oe,Ee={point:Ge,lineStart:pn,lineEnd:un,polygonStart:function(){Ee.lineStart=Ii,Ee.lineEnd=Bi},polygonEnd:function(){Ee.point=Ge,Ee.lineStart=pn,Ee.lineEnd=un},result:function(){var e=pt?[ba/pt,va/pt]:Xe?[Pt/Xe,Dt/Xe]:ct?[ha/ct,ga/ct]:[NaN,NaN];return ha=ga=ct=Pt=Dt=Xe=ba=va=pt=0,e}};function Ge(e,a){ha+=e,ga+=a,++ct}function pn(){Ee.point=Pi}function Pi(e,a){Ee.point=Di,Ge(Re=e,Oe=a)}function Di(e,a){var r=e-Re,n=a-Oe,i=Ke(r*r+n*n);Pt+=i*(Re+e)/2,Dt+=i*(Oe+a)/2,Xe+=i,Ge(Re=e,Oe=a)}function un(){Ee.point=Ge}function Ii(){Ee.point=$i}function Bi(){Xn(Kn,Qn)}function $i(e,a){Ee.point=Xn,Ge(Kn=Re=e,Qn=Oe=a)}function Xn(e,a){var r=e-Re,n=a-Oe,i=Ke(r*r+n*n);Pt+=i*(Re+e)/2,Dt+=i*(Oe+a)/2,Xe+=i,i=Oe*e-Re*a,ba+=i*(Re+e),va+=i*(Oe+a),pt+=i*3,Ge(Re=e,Oe=a)}function Jn(e){this._context=e}Jn.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Te);break}}},result:Ae};var ya=new We,ta,Zn,er,ut,ft,bt={point:Ae,lineStart:function(){bt.point=_i},lineEnd:function(){ta&&tr(Zn,er),bt.point=Ae},polygonStart:function(){ta=!0},polygonEnd:function(){ta=null},result:function(){var e=+ya;return ya=new We,e}};function _i(e,a){bt.point=tr,Zn=ut=e,er=ft=a}function tr(e,a){ut-=e,ft-=a,ya.add(Ke(ut*ut+ft*ft)),ut=e,ft=a}let fn,It,mn,xn;class hn{constructor(a){this._append=a==null?ar:Ui(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==mn||this._append!==It){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,mn=n,It=this._append,xn=this._,this._=i}this._+=xn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ar(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Ui(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ar;if(a!==fn){const r=10**a;fn=a,It=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return It}function Vi(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Qe(s,i(o))),o.result()}return l.area=function(s){return Qe(s,i(Pe)),Pe.result()},l.measure=function(s){return Qe(s,i(bt)),bt.result()},l.bounds=function(s){return Qe(s,i(Ft)),Ft.result()},l.centroid=function(s){return Qe(s,i(Ee)),Ee.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,ua):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new hn(r)):new Jn(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new hn(r)),l},l.projection(e).digits(r).context(a)}function Ta(e){return function(a){var r=new wa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function wa(){}wa.prototype={constructor:wa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function La(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Qe(r,e.stream(Ft)),a(Ft.result()),n!=null&&e.clipExtent(n),e}function nr(e,a,r){return La(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function Hi(e,a,r){return nr(e,[[0,0],a],r)}function Yi(e,a,r){return La(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Wi(e,a,r){return La(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var gn=16,Gi=oe(30*Se);function bn(e,a){return+a?Qi(e,a):Ki(e)}function Ki(e){return Ta({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Qi(e,a){function r(n,i,o,l,s,p,f,d,c,m,v,x,g,b){var u=f-n,y=d-i,N=u*u+y*y;if(N>4*a&&g--){var w=l+m,S=s+v,C=p+x,O=Ke(w*w+S*S+C*C),F=ht(C/=O),A=te(te(C)-1)<Z||te(o-c)<Z?(o+c)/2:xt(S,w),k=e(A,F),L=k[0],j=k[1],M=L-n,T=j-i,E=y*M-u*T;(E*E/N>a||te((u*M+y*T)/N-.5)>.3||l*m+s*v+p*x<Gi)&&(r(n,i,o,l,s,p,L,j,A,w/=O,S/=O,C,g,b),b.point(L,j),r(L,j,A,w,S,C,f,d,c,m,v,x,g,b))}}return function(n){var i,o,l,s,p,f,d,c,m,v,x,g,b={point:u,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),b.lineStart=S},polygonEnd:function(){n.polygonEnd(),b.lineStart=y}};function u(F,A){F=e(F,A),n.point(F[0],F[1])}function y(){c=NaN,b.point=N,n.lineStart()}function N(F,A){var k=Ze([F,A]),L=e(F,A);r(c,m,d,v,x,g,c=L[0],m=L[1],d=F,v=k[0],x=k[1],g=k[2],gn,n),n.point(c,m)}function w(){b.point=u,n.lineEnd()}function S(){y(),b.point=C,b.lineEnd=O}function C(F,A){N(i=F,A),o=c,l=m,s=v,p=x,f=g,b.point=N}function O(){r(c,m,d,v,x,g,o,l,i,s,p,f,gn,n),b.lineEnd=w,w()}return b}}var Xi=Ta({point:function(e,a){this.stream.point(e*Se,a*Se)}});function Ji(e){return Ta({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Zi(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function vn(e,a,r,n,i,o){if(!o)return Zi(e,a,r,n,i);var l=oe(o),s=ie(o),p=l*e,f=s*e,d=l/e,c=s/e,m=(s*r-l*a)/e,v=(s*a+l*r)/e;function x(g,b){return g*=n,b*=i,[p*g-f*b+a,r-f*g-p*b]}return x.invert=function(g,b){return[n*(d*g-c*b+m),i*(v-c*g-d*b)]},x}function es(e){return ts(function(){return e})()}function ts(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,f=0,d,c=0,m=1,v=1,x=null,g=cn,b=null,u,y,N,w=ua,S=.5,C,O,F,A,k;function L(E){return F(E[0]*Se,E[1]*Se)}function j(E){return E=F.invert(E[0],E[1]),E&&[E[0]*Fe,E[1]*Fe]}L.stream=function(E){return A&&k===E?A:A=Xi(Ji(d)(g(C(w(k=E)))))},L.preclip=function(E){return arguments.length?(g=E,x=void 0,T()):g},L.postclip=function(E){return arguments.length?(w=E,b=u=y=N=null,T()):w},L.clipAngle=function(E){return arguments.length?(g=+E?Ti(x=E*Se):(x=null,cn),T()):x*Fe},L.clipExtent=function(E){return arguments.length?(w=E==null?(b=u=y=N=null,ua):Ri(b=+E[0][0],u=+E[0][1],y=+E[1][0],N=+E[1][1]),T()):b==null?null:[[b,u],[y,N]]},L.scale=function(E){return arguments.length?(r=+E,M()):r},L.translate=function(E){return arguments.length?(n=+E[0],i=+E[1],M()):[n,i]},L.center=function(E){return arguments.length?(o=E[0]%360*Se,l=E[1]%360*Se,M()):[o*Fe,l*Fe]},L.rotate=function(E){return arguments.length?(s=E[0]%360*Se,p=E[1]%360*Se,f=E.length>2?E[2]%360*Se:0,M()):[s*Fe,p*Fe,f*Fe]},L.angle=function(E){return arguments.length?(c=E%360*Se,M()):c*Fe},L.reflectX=function(E){return arguments.length?(m=E?-1:1,M()):m<0},L.reflectY=function(E){return arguments.length?(v=E?-1:1,M()):v<0},L.precision=function(E){return arguments.length?(C=bn(O,S=E*E),T()):Ke(S)},L.fitExtent=function(E,R){return nr(L,E,R)},L.fitSize=function(E,R){return Hi(L,E,R)},L.fitWidth=function(E,R){return Yi(L,E,R)},L.fitHeight=function(E,R){return Wi(L,E,R)};function M(){var E=vn(r,0,0,m,v,c).apply(null,a(o,l)),R=vn(r,n-E[0],i-E[1],m,v,c);return d=ki(s,p,f),O=ca(a,R),F=ca(d,O),C=bn(O,S),T()}function T(){return A=k=null,L}return function(){return a=e.apply(this,arguments),L.invert=a.invert&&j,M()}}function rr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}rr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(te(i)>Z&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function as(){return es(rr).scale(175.295)}function ns(e){return e}function rs(e){if(e==null)return ns;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var f=2,d=s.length,c=new Array(d);for(c[0]=(a+=s[0])*n+o,c[1]=(r+=s[1])*i+l;f<d;)c[f]=s[f],++f;return c}}function os(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function is(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return yn(e,r)})}:yn(e,a)}function yn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=ss(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function ss(e,a){var r=rs(e.transform),n=e.arcs;function i(d,c){c.length&&c.pop();for(var m=n[d<0?~d:d],v=0,x=m.length;v<x;++v)c.push(r(m[v],v));d<0&&os(c,x)}function o(d){return r(d)}function l(d){for(var c=[],m=0,v=d.length;m<v;++m)i(d[m],c);return c.length<2&&c.push(c[0]),c}function s(d){for(var c=l(d);c.length<4;)c.push(c[0]);return c}function p(d){return d.map(s)}function f(d){var c=d.type,m;switch(c){case"GeometryCollection":return{type:c,geometries:d.geometries.map(f)};case"Point":m=o(d.coordinates);break;case"MultiPoint":m=d.coordinates.map(o);break;case"LineString":m=l(d.arcs);break;case"MultiLineString":m=d.arcs.map(l);break;case"Polygon":m=p(d.arcs);break;case"MultiPolygon":m=d.arcs.map(p);break;default:return null}return{type:c,coordinates:m}}return f(a)}let zt=null;function ls(){return zt||(zt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=is(r,n),o=as().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Vi(o),s=(i.features||[]).filter(f=>{var d;return(((d=f.properties)==null?void 0:d.name)||"")!=="Antarctica"}).map(f=>{var m;const d=((m=f.properties)==null?void 0:m.name)||"",c=l(f)||"";return c?{i2:_r(d)||null,n:d,d:c}:null}).filter(f=>!!f);if(!s.length)return null;const p={};for(const[f,d]of Object.entries(Ur)){const c=o(d);c&&(p[f]={x:c[0],y:c[1]})}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p}}catch{return null}})(),zt)}function ds(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return ls().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const wn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function At(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function cs(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const p=(f=e.current)==null?void 0:f.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function ps(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p}=q(),f=h.useRef(null),d=h.useRef(null),c=ds(e.continent==="monde"),m=e.continent==="monde"?c:Ca.find(k=>k.key===e.continent)||null,v=cs(f,e.continent+":"+e.mapFolded+":"+!!m),[x,g]=h.useState(new Map),[b,u]=h.useState(null);h.useEffect(()=>{const k=f.current;if(!k)return;const L=new Map;k.querySelectorAll("path[data-i2]").forEach(j=>{const M=j.dataset.i2;if(M)try{const T=j.getBBox();T.width>0&&L.set(M,{x:T.x,y:T.y,w:T.width,h:T.height})}catch{}}),g(L)},[e.continent,v,m]);const y=h.useMemo(()=>r.filter(k=>k.cc),[r]),N=h.useMemo(()=>{const k=new Map;return y.forEach(L=>k.set(L.cc,(k.get(L.cc)||0)+1)),k},[y]),w=e.continent==="monde"&&c?c.anchors:null,S=h.useMemo(()=>y.map(k=>{const L=w&&k.cc?w[k.cc]:void 0;if(L){const D=At(k.name||k.id||""),_=At((k.id||k.name||"")+"·y");return{d:k,x:L.x+(D-.5)*10,y:L.y+(_-.5)*10}}const j=k.cc?x.get(k.cc):void 0;if(!j)return null;const M=At(k.name||k.id||""),T=At((k.id||k.name||"")+"·y"),E=(M-.5)*Math.min(j.w*.55,60),R=(T-.5)*Math.min(j.h*.55,60);return{d:k,x:j.x+j.w/2+E,y:j.y+j.h/2+R}}).filter(k=>!!k),[y,x,w]),C=k=>v>0?k/v:k,O=h.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:wn[k],fr:p.plabels[k].toUpperCase(),en:p.plabels[k].toUpperCase(),n:r.filter(L=>L.kind==="target"&&ke(L)===k).length})).filter(k=>k.n>0):Ba.map((k,L)=>({...k,n:r.filter(j=>$a(j)===L).length})),[r,n,p.plabels]),F=o?l.get(o):null,A=F?S.find(k=>k.d.id===F.id):null;return m?t.jsxs("div",{className:"mapzone",ref:d,children:[t.jsxs("svg",{ref:f,viewBox:m.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?m.fr:m.en,onMouseLeave:()=>{u(null),i(null)},children:[t.jsx("g",{children:m.countries.map((k,L)=>t.jsx("g",{className:"ct"+(k.i2&&N.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},L))}),t.jsx("g",{children:S.map(k=>{const L=Ba[$a(k.d)],j=!!xe(k.d),M=k.d.kind==="target",T=n&&M?wn[ke(k.d)]:L.c,E=!n&&Ce(k.d);return t.jsxs("g",{className:"co"+(E?" done":""),onMouseEnter:()=>{var _,G;const R=(_=d.current)==null?void 0:_.getBoundingClientRect(),D=(G=f.current)==null?void 0:G.createSVGPoint();if(D&&f.current&&R){D.x=k.x,D.y=k.y;const pe=D.matrixTransform(f.current.getScreenCTM());u({x:pe.x-R.left,y:pe.y-R.top,label:k.d.name+" · "+(rt(k.d.cc,s)||k.d.countryLabel||"")})}i(k.d.id)},onMouseLeave:()=>{u(null),i(null)},onClick:()=>{var _;const R=(_=f.current)==null?void 0:_.createSVGPoint();let D=null;if(R&&f.current){R.x=k.x,R.y=k.y;const G=R.matrixTransform(f.current.getScreenCTM());D={x:G.x,y:G.y}}a({type:"popup",id:k.d.id,anchor:D})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:C(Math.max(11,L.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:C(L.px),fill:T,stroke:j?"#DC2626":"#ffffff",strokeWidth:C(j?2.2:1.3)})]},k.d.id||k.d.name)})}),A&&t.jsx("circle",{className:"ring on",cx:A.x,cy:A.y,r:C(13),fill:"none",stroke:"#0F172A",strokeWidth:C(2)})]}),t.jsx("div",{className:"hov"+(b?" on":""),style:b?{left:b.x,top:b.y}:void 0,children:b==null?void 0:b.label}),t.jsx("div",{className:"legend",children:O.map((k,L)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},L))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:d})}function us(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function fs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=q(),s=e.filters,p=h.useMemo(()=>e.continent==="monde"?r:r.filter(x=>x.continent===e.continent),[r,e.continent]),f=x=>p.filter(g=>x!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:za(g,s,i,x==="country"?void 0:x)),d=h.useMemo(()=>{const x=f("win"),g=b=>x.filter(u=>(u.date?Math.max(0,Math.floor((Date.now()-Date.parse(u.date))/864e5)):9999)<=b).length;return[g(0),g(7),g(30),x.length]},[p,s,i]),c=h.useMemo(()=>s.day?f("win").filter(x=>(x.date||"").slice(0,10)===s.day).length:0,[p,s,i]),m=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),v=(x,g,b,u="fbtn")=>t.jsxs("button",{type:"button",className:u,"aria-expanded":e.openFacet===x,onClick:()=>a({type:"openFacet",facet:x}),children:[t.jsx("span",{className:"fl",children:g}),b>0&&t.jsx("span",{className:"n",children:b}),t.jsx("span",{className:"cv",children:"▾"})]},x);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(us(s.day,l)),t.jsx("b",{children:c})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((x,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===x,onClick:()=>a({type:"filters",patch:{win:x}}),children:[n.dates[g],t.jsx("b",{children:d[g]})]},x))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:x=>a({type:"filters",patch:{search:x.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):v("sec",n.fSector,s.sector.length),v("pay",n.fCountry,s.country.length),v("det",n.fEngine,s.engine.length),v("sta",n.fStage,s.stage.length),i&&v("ang","Angle",s.angle.length),i&&v("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),m>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(m)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(ms,{poolFor:f})]})}function ms({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=q(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:f}=h.useMemo(()=>{if(l==="sig"){const x=e("signal").filter(u=>xe(u)),g=new Map;x.forEach(u=>{const y=u.engine||"";g.set(y,(g.get(y)||0)+1)});const b=[{v:"*",label:n.fpSigAll,n:x.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ra([...g.keys()],i).map(u=>({v:u,label:Je(u)+" "+De(u,i),n:g.get(u)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(u)}))];return{title:n.fpSigTitle,cols:2,options:b}}if(l==="sec"){const x=e("sector"),g=new Map;return x.forEach(b=>{b.sector&&g.set(b.sector,(g.get(b.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((b,u)=>u[1]-b[1]).map(([b,u])=>({v:b,label:b,n:u,html:!1,on:o.sector.includes(b)}))}}if(l==="pay"){const x=e("country"),g=new Map;return x.forEach(b=>{b.cc&&g.set(b.cc,(g.get(b.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((b,u)=>u[1]-b[1]).map(([b,u])=>({v:b,label:rt(b,i)||b,n:u,html:!1,on:o.country.includes(b)}))}}if(l==="det"){const x=e("engine"),g=new Map;return x.forEach(b=>{b.engine&&g.set(b.engine,(g.get(b.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ra([...g.keys()],i).map(b=>({v:b,label:Je(b)+" "+De(b,i)+' <span style="color:var(--dim);font-size:10px">· '+Vr(Hr(b),i)+"</span>",n:g.get(b)||0,html:!0,on:o.engine.includes(b)}))}}if(l==="ang"){const x=e("angle"),g=new Map;return x.forEach(b=>{b.angle&&g.set(b.angle,(g.get(b.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((b,u)=>u[1]-b[1]).map(([b,u])=>({v:b,label:b.replace(/[_-]+/g," "),n:u,html:!1,on:o.angle.includes(b)}))}}if(l==="mem"){const x=e("memoLevel"),g=new Map;x.forEach(u=>{if(u.kind==="target"){const y=Na(u);g.set(y,(g.get(y)||0)+1)}});const b=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(u=>({v:String(u),label:b[u],n:g.get(u)||0,html:!1,on:o.memoLevel.includes(u)}))}}const m=e("stage"),v=new Map;return m.forEach(x=>{x.stage&&v.set(x.stage,(v.get(x.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((x,g)=>g[1]-x[1]).map(([x,g])=>({v:x,label:x,n:g,html:!1,on:o.stage.includes(x)}))}},[l,a,i]),d=m=>{if(l==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const x=o.signalEngines.includes(m)?o.signalEngines.filter(g=>g!==m):[...o.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:x}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:m})},c=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:c,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:f.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>d(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function or(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function xs(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function kn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=q();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function ir({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=q(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(kn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(kn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function hs({card:e,onEvaluate:a,onAddAll:r}){var s,p,f;const{t:n}=q(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:or(e.summary_md||"").map((d,c)=>t.jsx("p",{children:d},c))})]}),t.jsx(ir,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function gs(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function bs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=q(),s=i,[p,f]=h.useState(null),[d,c]=h.useState(null),[m,v]=h.useState(null),[x,g]=h.useState(!1);h.useEffect(()=>{let u=!0;return(async()=>{const y=await On({email:l,cbToken:s});u&&f(y)})(),()=>{u=!1}},[l,s,n]);const b=u=>{c(u),v(null),g(!0),(async()=>{const y=await Yr(u.id);v(y),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{c(null),v(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(u=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>b(u),children:[t.jsx("span",{className:"ti",children:u.title}),t.jsxs("span",{className:"me",children:[gs(u.created_at),u.industry?` · ${u.industry}`:"",u.author?` · ${u.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(u.cited_n||0,u.evaluate_n||0)}),t.jsx("span",{className:"st"+(u.published?" on":""),children:u.published?o.rsPub:o.rsPriv})]},u.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),x&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!x&&!m&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!x&&m&&t.jsx(hs,{card:m,onEvaluate:a,onAddAll:r})]})]})}const jn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function vs(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:f,data:d,canWrite:c,source:m}=q(),v=a==="client",x=h.useMemo(()=>r||(m!=="default"?Wr():""),[r,m]),[g,b]=h.useState(""),[u,y]=h.useState(!1),[N,w]=h.useState(""),[S,C]=h.useState(!1),[O,F]=h.useState(""),[A,k]=h.useState([]),L=h.useRef(!1),[j,M]=h.useState(!1),[T,E]=h.useState(""),[R,D]=h.useState(""),[_,G]=h.useState(!1),[pe,se]=h.useState(0),[le,K]=h.useState(""),[B,U]=h.useState(null),[V,ee]=h.useState(null),[re,ve]=h.useState(!1),[de,Y]=h.useState(null),[X,he]=h.useState(0),H=h.useRef(!1),ae=g.trim()?jn.test(g.trim())?e.evalUrl:e.evalName:e.evalWaiting,Q=h.useMemo(()=>N.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[N]);h.useEffect(()=>{if(typeof window>"u")return;const P=(new URLSearchParams(window.location.search).get("rs")||"").trim();!P||!/^https?:\/\//i.test(P)||(E(P),M(!0))},[]),h.useEffect(()=>{const P=J=>{var ge;const ne=String(((ge=J.detail)==null?void 0:ge.url)||"").trim();!ne||!/^https?:\/\//i.test(ne)||(E(ne),M(!0))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),h.useEffect(()=>{if(!c&&!x){Y(null);return}let P=!0;return(async()=>{const J=await On({email:n,cbToken:x});P&&Y(J.length)})(),()=>{P=!1}},[c,x,n,X]);const Ie=A.length?A:p,ue=d.credits,fe=h.useCallback(P=>{const J=P.map(ne=>(ne||"").trim()).filter(Boolean);J.length&&(w(ne=>{const ge=ne.split(`
...
`;function js(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function Ns(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:p,doDecide:f,doPromote:d,doRepeche:c,doApproach:m,doDeep:v,doOnboard:x,outbound:g,evalBusy:b}=q(),u=e.popupId?r.get(e.popupId):null;if(!u)return null;const y=xe(u),N=ke(u),w=nt(u),S=u.kind==="target",C=O=>{a({type:"filters",patch:O}),a({type:"popup",id:null})};return at.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:ks}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:js(e.popupAnchor,!!u.card),onClick:O=>O.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:u.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(tt(u.date)),De(u.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[u.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[u.cc]}),children:(rt(u.cc,i)||u.countryLabel||"").toUpperCase()}),u.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[u.sector]}),children:u.sector.toUpperCase()}),u.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[u.stage]}),children:u.stage.toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{className:"am2",children:Bt(u.amountEur,i)})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Je(u.engine)," ",t.jsx("b",{children:De(u.engine,i)})," — ",Jr(u.engine,i),u.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",u.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(ot,{o:u,lg:!0})," ",t.jsx(Ut,{o:u,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(qn(y,i))," · ",n.win7(Fn(y,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),u.card?t.jsx(_t,{spec:u.card}):null,u.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&N>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),o.pipe&&S&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof u.score=="number"&&u.score>0?" · "+n.score(u.score):""]})})]}),t.jsx(sr,{name:u.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[N===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:b,onClick:()=>s(u),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(u.name.length>22?u.name.slice(0,21)+"…":u.name)]}),N===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),N===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),N===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(u,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(u,!1),a({type:"popup",id:null})},children:n.actNo}),Ea(u)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(u),a({type:"popup",id:null})},children:n.memoDeep})]}),N===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),N===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),u.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:u.id}),a({type:"popup",id:null})},children:"📄"}),g&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{x(u),a({type:"popup",id:null})},children:"🚀"})]}):u.engine==="media"&&u.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var O;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"popup",id:null}),(O=document.querySelector(".atl2 .demand"))==null||O.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:b,title:n.evalGoOn(u.name),onClick:()=>s(u),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:b,onClick:()=>s(u),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(u.name.length>22?u.name.slice(0,21)+"…":u.name)," →"]}),u.website&&t.jsx("a",{className:"psite",href:u.website.startsWith("http")?u.website:"https://"+u.website,target:"_blank",rel:"noopener noreferrer",title:u.website,children:"🌐"})]})]})]}),document.body)}const Ss=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Tt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Cs(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Tt(a.slice(n));break}r+=Tt(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Tt(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&Ss.has(p)?r+=`<${s[1]}${p}>`:r+=Tt(a.slice(i,o+1)),n=o+1}return r}const Nn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function be({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Es({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=q(),o=$t(e),l=nt(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),c=h.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:d}].filter(g=>g.n>0),[e,a,s,l,p,f,d]),[m,v]=h.useState("");if(!c.length)return null;const x=c.some(g=>g.k===m)?m:c[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:c.map(g=>t.jsx("button",{type:"button",role:"tab","aria-selected":x===g.k,className:x===g.k?"on":"",onClick:b=>{b.stopPropagation(),v(g.k)},children:g.lib},g.k))}),t.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[x==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(be,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(be,{k:a.cdVerdictDate,v:Nn(e.verdictDate,r)})]})]}),x==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Cs(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(zs,{o:e})]}),x==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdSector,v:e.sector}),t.jsx(be,{k:a.cdStage,v:e.stage}),t.jsx(be,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(be,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(be,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(be,{k:a.cdAngle,v:e.angle}),t.jsx(be,{k:a.cdDetected,v:Nn(e.date,r)})]}),x==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdName,v:e.contactName}),t.jsx(be,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(be,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),x==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(be,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function zs({o:e}){const{t:a,token:r}=q(),[n,i]=h.useState(!1),[o,l]=h.useState(null),s=async()=>{n||(i(!0),l(await Zr(r,e.name,e.website||e.domain||"")),i(!1))},p=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=f.some(([,c])=>c);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&d&&t.jsxs(t.Fragment,{children:[f.filter(([,c])=>c).map(([c,m])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:c}),t.jsx("p",{children:m})]},c)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!d&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const lr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ra({o:e}){const{t:a}=q(),r=$t(e),n=nt(e),i=ke(e),o=na(e),l=eo(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(lr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const ka=e=>e.length>22?e.slice(0,21)+"…":e;function Sn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=q(),[o,l]=h.useState(!1);if(h.useEffect(()=>{n||l(!1)},[n]),Ce(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(ka(e.name))})]})}function dr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:p,doApproach:f,dispatch:d}=q();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:v=>{v.stopPropagation(),d({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:v=>{var x;v.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(x=document.querySelector(".atl2 .demand"))==null||x.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Sn,{o:e})});const c=ke(e),m=v=>x=>{x.stopPropagation(),v()};if(c===0)return t.jsx("span",{className:"cell",children:t.jsx(Sn,{o:e})});if(c===1){const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:m(()=>o(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(c===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:m(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:m(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(c===4){const v=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:v,onClick:m(()=>f(e)),children:v?a.actApproachSent:a.actApproach})})}return c===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):c===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:m(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function As({o:e}){const{t:a,doThumb:r,thumbOf:n}=q(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Ts({o:e}){const{lang:a}=q();return xe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(ot,{o:e}),t.jsx(Ut,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Je(e.engine||"")," ",De(e.engine||"",a)]})})}function Ls({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:p,favIds:f,toggleFav:d}=q(),c=ke(e),m=["#0F172A","#475C6E","#8798A8","#B9C6D2"],v=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,x=v<=0?0:v<=7?1:v<=30?2:3,g=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][c]:m[x],b=f.has(e.id),u=y=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const N=y.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:N.left+Math.min(280,N.width/3),y:N.bottom}})};return t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:u,children:[t.jsx("span",{className:"pt",style:{"--c":g}}),t.jsx(xr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:b?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),d(e)},children:b?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(Rs,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Ts,{o:e}),l.pipe&&t.jsx(Ra,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(dr,{o:e}),l.showThumbs&&t.jsx(As,{o:e})]}),r&&!a&&t.jsx(Ms,{o:e})]})}function Rs({o:e}){const{lang:a,caps:r}=q();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Bt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Os({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i}=q(),o=(()=>{const d=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return d?d[1].slice(0,40):""})(),l=Bt(e.amountEur,r),s=(e.date||"").slice(0,10).split("-").reverse().join("/"),p=Ce(e),f=p&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("span",{children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&t.jsx("span",{children:e.countryLabel}),e.stage&&t.jsx("span",{children:e.stage}),l&&t.jsx("span",{className:"oc-amt",children:l}),s&&t.jsx("span",{children:s})]}),t.jsxs("div",{className:"oc-acts",children:[p?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:d=>{var c;d.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(c=document.querySelector(".atl2 .demand"))==null||c.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:d=>{d.stopPropagation(),n(e)},children:a.evalGoOn(ka(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:d=>{d.stopPropagation(),n(e)},children:a.evalGoOn(ka(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:d=>d.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(o?` · ${o}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(_t,{spec:e.card})})]})}function Ms({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=q();return!i.pipe&&e.kind==="op"?t.jsx(Os,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Es,{o:e}),t.jsx(ii,{o:e}),t.jsx(di,{o:e}),t.jsx(sr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("span",{children:e.sector}),e.stage&&t.jsx("span",{children:e.stage}),e.countryLabel&&t.jsx("span",{children:e.countryLabel}),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Ra,{o:e})})]}),e.card&&t.jsx(_t,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Je(e.engine||"")," ",De(e.engine||"",r)]}),xe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(ot,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsxs("div",{className:"sec2 acts2",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"btn p",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})]})]})]})}function qs({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o}=q();if(!i.pipe&&e.kind==="op")return t.jsxs("div",{className:"dcard dops"+(a?" locked":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(_t,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),!a&&t.jsx("div",{className:"dact",children:t.jsx(dr,{o:e})})]});const l=ke(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":s},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Ra,{o:e}),xe(e)&&t.jsx(ot,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&l===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Fs({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=q(),o=i==="en",l=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),p=s.includes(0)?0:s.sort((d,c)=>(e[c]||0)-(e[d]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${l(p)}”`:`${f} dossier${f>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(o?"Open ":"Ouvrir ")+l(p)," →"]})]})}function Ps(){const e=q(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,lang:s,sessTally:p,data:f,dossiers:d,source:c}=e,m=c==="ops"?8:Dn,[v,x]=h.useState(new Set);h.useEffect(()=>{x(new Set)},[a.ptab,a.continent]);const[g,b]=h.useState(null);h.useEffect(()=>{b(null)},[a.ptab,a.continent]);const u=j=>x(M=>{const T=new Set(M);return T.has(j)?T.delete(j):T.add(j),T}),y=h.useMemo(()=>Aa(l,a.sort),[l,a.sort]),N=h.useMemo(()=>y.filter(j=>xe(j)&&!Ce(j)).length,[y]),w=h.useMemo(()=>i.pipe?y:y.filter(j=>!Ce(j)&&!j.noCo),[y,i.pipe]),S=c==="ops"?y.filter(j=>j.noCo).length:0,C=i.pipe?n.plabels[a.ptab].toLowerCase():c==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,O=(j,M,T="",E=!1)=>t.jsxs("button",{type:"button","data-s":j,className:T,"aria-sort":a.sort.key===j?a.sort.dir===1?"ascending":"descending":"none",style:E?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:j}),children:[M,t.jsx("span",{className:"ar",children:a.sort.key===j&&a.sort.dir===1?"▴":"▾"})]},j),F=h.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const j=new Map;y.forEach(E=>{const R=E.engine||"?";j.has(R)||j.set(R,[]),j.get(R).push(E)});const M={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},T=ra([...j.keys()],s);return[...j.entries()].sort((E,R)=>{const D=M[E[0]]??10+T.indexOf(E[0]),_=M[R[0]]??10+T.indexOf(R[0]);return D-_})},[y,i.pipe,a.groupBy,s]),A=i.lockRowsAfter;let k=0;const L=(j,M)=>{const T=a.shown[M]||m,R=j.slice(0,T).map(D=>{const _=A!==null&&k>=A;k++;const G=c==="ops"&&a.dens!=="maxi"&&(g?g==="open":!!D.decryptHtml),pe=v.has(D.id)?!G:G;return a.dens==="maxi"?t.jsx(qs,{o:D,locked:_},D.id):t.jsx(Ls,{o:D,locked:_,open:pe,onToggle:()=>u(D.id)},D.id)});if(j.length>T&&c!=="ops"){const D=Math.min(m,j.length-T),_=j.length-T;R.push(t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>r({type:"more",group:M,by:m,base:m}),children:[t.jsx("span",{className:"more-label",children:n.more(D,_)}),t.jsxs("span",{className:"more-meta",children:[n.moreMeta(T,j.length)," · ",_," ",s==="en"?"remaining":_>1?"restantes":"restante"]})]},M+":more"))}return R};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:y.length})," ",C]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",c==="ops"&&y.length>0&&" — "+n.edSplit(y.length-S,S)]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||c==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["maxi",n.densMaxi]].map(([j,M])=>t.jsxs("button",{type:"button","data-d":j,"aria-pressed":a.dens===j||j==="liste"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:j}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:M})]},j))}),c==="ops"&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":g==="open",onClick:()=>{b("open"),x(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":g==="closed",onClick:()=>{b("closed"),x(new Set)},children:n.foldAllLbl})]}),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:j=>r({type:"sort",key:j.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([j,M])=>t.jsx("option",{value:j,children:M},j))})]}),i.showChain&&w.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:w.map(j=>j.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(w.length):n.chainAll(w.length)]})]}),N>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(N)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),O("country",n.colCountry),O("name",n.colCompany),O("amount",n.colAmount,"h-amt",!0),O("stage",n.colStage,"h-stade"),O("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&O("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":"")+(c==="ops"?" opsl":"")+(y.length?"":" list-empty"),children:[F?F.map(([j,M])=>t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Je(j)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:De(j,s)}),t.jsx("div",{className:"s",children:n.grpCount(M.filter(T=>!Ce(T)).length,M.length)})]})]}),L(M,j)]},j)):L(y,"pt"+a.ptab),!y.length&&!(f.loading&&!d.length)&&(i.pipe?t.jsx(Fs,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),c==="ops"&&F&&(()=>{let j=0,M=0;for(const[E,R]of F)M+=R.length,j+=Math.min(R.length,a.shown[E]||m);const T=M-j;return T<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>F.forEach(([E,R])=>r({type:"more",group:E,by:R.length,base:m})),children:[t.jsx("span",{className:"more-label",children:n.more(T,T)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(j,M)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}})]})}function Cn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Ds(e,a){const r=to(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Is(e,a){const n=[a.head.split("|").map(Cn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",Ds(i,a.plabels),$t(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Cn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Bs(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const $s=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Le({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function _s({o:e,qa:a}){const{t:r,lang:n,fund:i}=q(),o=(e.cribleStatus||"").trim().toUpperCase()||($t(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=nt(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Le,{k:r.cdSector,v:e.sector}),t.jsx(Le,{k:r.cdStage,v:e.stage}),t.jsx(Le,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Le,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Le,{k:r.cdName,v:e.contactName}),t.jsx(Le,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Le,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Le,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Le,{k:r.cdAngle,v:e.angle}),t.jsx(Le,{k:r.cdDetected,v:$s(e.date,n)})]}),p.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,f])=>f).map(([f,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:d})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Us(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=q(),[s,p]=h.useState({}),f=25,d=h.useMemo(()=>n.slice(0,f),[n]);h.useEffect(()=>{d.length&&ao(r,d.map(v=>v.name)).then(p)},[r,d]);const c=o.stats,m=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),c&&typeof c.screened=="number"&&t.jsxs("p",{children:[m(c.screened)," ",e.funScreened(""),typeof c.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",m(c.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(m(o.marketEstimate)),", ",Math.round(c.screened/o.marketEstimate*100)," %"]})]})]}),d.map(v=>t.jsx(_s,{o:v,qa:s[v.name]},v.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Vs=50;function Oa({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=q(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[f,d]=h.useState(""),[c,m]=h.useState(0),[v,x]=h.useState(""),[g,b]=h.useState(!1),u=h.useRef(null);h.useEffect(()=>()=>{u.current&&window.clearInterval(u.current)},[]);const y=async w=>{p(!0),d("");const S=await a();if(p(!1),S.ok){l(S);return}if(S.busy){d(i.alertPreviewBusy);return}if(!w){d(i.alertPreviewFail);return}m(Vs),u.current=window.setInterval(()=>{m(C=>C>1?C-1:(u.current&&window.clearInterval(u.current),y(!1),0))},1e3)},N=async()=>{if(n||g)return;b(!0),x("");const w=await r();b(!1),x(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||c>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||g,onClick:()=>{N()},children:g?"…":i.alertTest})]}),c>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(c)}),f&&t.jsx("p",{className:"mnote warn",children:f}),v&&t.jsx("p",{className:"mnote",children:v}),!v&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const mt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function we({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=q();return at.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Hs(){const{st:e}=q();switch(e.modal){case"chain":return t.jsx(Ws,{});case"space":return t.jsx(Gs,{});case"alert":return t.jsx(Ks,{});case"queue":return t.jsx(el,{});case"export":return t.jsx(tl,{});case"plug":return t.jsx(rl,{});case"recharge":return t.jsx(il,{});case"cover":return t.jsx(ll,{});case"dossier":return t.jsx(sl,{});case"crit":return t.jsx(dl,{});case"tuto":return t.jsx(cl,{});case"rdv":return t.jsx(Ys,{});case"memoalert":return t.jsx(al,{});default:return null}}function Ys(){const{dispatch:e,fund:a}=q(),r=typeof document<"u"&&!!document.getElementById("rdv");return h.useEffect(()=>{r&&(e({type:"modal",modal:null}),Jo())},[r,e]),r?null:t.jsx(oo,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Ws(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s}=q(),p=o==="client",f=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),d=e.chain.idx,c=f[d],m=d>=f.length;return at.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:m?n.finished:`${d+1} / ${f.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(m?100:d/Math.max(1,f.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:m||!c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(f.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:c.name}),t.jsx("div",{className:"sub",children:[rt(c.cc,i)||c.countryLabel,c.sector,c.stage,n.daysAgo(tt(c.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:De(c.engine,i).toUpperCase()}),typeof c.amountEur=="number"&&c.amountEur>0&&t.jsx("span",{children:Bt(c.amountEur,i)})]}),xe(c)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(ot,{o:c,lg:!0})," ",t.jsx(Ut,{o:c,src:!0})]}),(c.tagline||c.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:c.tagline||c.headline})]}),c.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:c.reasoning})]}),p&&Ce(c)&&t.jsxs("div",{className:"vbox",style:{"--c":Ye(c)==="retenu"?"var(--brand)":Ye(c)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ye(c)==="retenu"?"✓ "+n.kept:Ye(c)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:c.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!m&&c&&!(p&&Ce(c))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(c)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(m?{type:"modal",modal:null}:{type:"chainNext"}),children:m?n.closeBtn:n.skip})]})]})})}),document.body)}function Gs(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=q(),o=i==="client",l=h.useMemo(()=>o?r.filter(c=>Ce(c)):[],[r,o]),s=h.useMemo(()=>Aa(l.filter(c=>Ye(c)==="retenu"),{key:"signal",dir:-1}),[l]),p=h.useMemo(()=>l.filter(c=>Ye(c)==="ecarte"),[l]),f=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(we,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(c=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof c.score=="number"&&c.score>0?c.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:c.name}),t.jsx("div",{className:"rr",children:c.reasoning||c.tagline||""})]})]},c.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Ks(){const{mode:e}=q();return e==="client"||e==="apercu"?t.jsx(Qs,{}):t.jsx(Zs,{})}function Qs(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=q(),[o,l]=h.useState("d"),s=i!=="client";return t.jsxs(we,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(Xs,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(Js,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(cr,{})]})}function Xs({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[f,d]=h.useState(0);h.useEffect(()=>{let x=!0;return p(!1),Ha(a).then(g=>{x&&(g?l(g):p(!0))}),()=>{x=!1}},[a,f]);const c=x=>{r||Ha(a,x).then(g=>{if(!g){i(e.actErr);return}l(g),g.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(x=>x+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const m=x=>!o.sections||o.sections.includes(x),v=x=>{const g=o.sections||e.alertSec.map(([b])=>b);c({sections:m(x)?g.filter(b=>b!==x):[...g,x]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>c({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>c({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>c({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>c({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([x,g])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:m(x),disabled:r,onChange:()=>v(x)}),t.jsxs("span",{children:[g,x==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},x))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Oa,{label:e.alertPreview,readOnly:r,onPreview:()=>fo(a),onTest:()=>uo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Js({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[f,d]=h.useState(0);h.useEffect(()=>{let x=!0;return p(!1),Ya(a).then(g=>{x&&(g?l(g):p(!0))}),()=>{x=!1}},[a,f]);const c=x=>{r||Ya(a,x).then(g=>{if(!g){i(e.actErr);return}l(g),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(x=>x+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const m=o.dow??0,v=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>c({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:m,disabled:r,onChange:x=>c({dow:Number(x.target.value)}),children:e.alertDow.map((x,g)=>t.jsx("option",{value:g,children:x},x))}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[v," h"]}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.min(21,v+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Oa,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>xo(a),onTest:()=>mo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function cr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=q(),[l,s]=h.useState(o||""),[p,f]=h.useState(!1),[d,c]=h.useState(!1);h.useEffect(()=>{o&&s(o)},[o]);const m=e.filters,v=h.useMemo(()=>n.filter(u=>xe(u)).length,[n]),x=m.win==="1"?0:m.win==="7"?1:m.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){c(!0);try{await fetch(`${ja}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:m.sector,countries:m.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{c(!1)}}},b=[[a.amRows.continent,i],[a.amRows.since,a.amSince[x]],[a.amRows.signal,m.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,m.engine.length?m.engine.map(u=>De(u,r)).join(", "):a.amAllEngines],[a.amRows.sectors,m.sector.length?m.sector.join(", "):a.amAllSectors],[a.amRows.countries,m.country.length?m.country.map(u=>rt(u,r)||u).join(", "):a.amAllCountries],[a.amRows.stages,m.stage.length?m.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:b.map(([u,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:u}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},u))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:u=>s(u.target.value),onKeyDown:u=>{u.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Zs(){const{t:e}=q();return t.jsx(we,{title:e.alertTitle,icon:"🔔",children:t.jsx(cr,{})})}function el(){var g,b,u;const{t:e,token:a,fund:r,mode:n,flash:i}=q(),[o,l]=h.useState(null),[s,p]=h.useState([]),[f,d]=h.useState(0),c=n==="client";h.useEffect(()=>{let y=!0;return(async()=>{const[N,w]=await Promise.all([Sa(r),Rn(a)]);y&&(N&&l(N),p(w))})(),()=>{y=!1}},[a,r,f]);const m=(o==null?void 0:o.per_day)??2,v=((g=o==null?void 0:o.analyzed_today)==null?void 0:g.length)??0,x=(b=o==null?void 0:o.tomorrow)!=null&&b.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return t.jsxs(we,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(v,v+(((u=o==null?void 0:o.pool_order)==null?void 0:u.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(m)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),c&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Va(a,y.company,"retry").then(()=>d(N=>N+1))},children:e.queueRetry}),c&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Va(a,y.company,"delete").then(()=>d(N=>N+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[x.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),x.slice(0,10).map((y,N)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",N+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function tl(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=q(),s=`${mt}/cibles/list.csv?token=${a}`,p=`${mt}/cibles/list.json?token=${a}`,f=`${mt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,c=b=>{var u;(u=navigator.clipboard)==null||u.writeText(b).then(()=>r(e.exportCopied))},m=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:f,href:f}],v=!i.lockActions&&n.length>0,x=()=>{Bs(Is(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:b=>(e.stg.find(([u])=>u===b)||["",""])[1]})),r(e.exportViewDone(n.length))},g=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(we,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:g,children:e.printBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:x,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:m.map(({def:b,value:u,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:b[0]}),t.jsxs("div",{children:[t.jsx("b",{children:b[1]}),t.jsx("p",{children:b[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>c(u),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},b[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function al(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=q(),o=i!=="client",[l,s]=h.useState(null),[p,f]=h.useState(!1),[d,c]=h.useState(0),[m,v]=h.useState(!1);h.useEffect(()=>{let u=!0;return f(!1),Ua(a).then(y=>{u&&(y?s(y):f(!0))}),()=>{u=!1}},[a,d]);const x=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=u=>{if(o||!l)return;const y={enabled:u.enabled??!!l.enabled,email:u.email??(l.email||""),sections:u.sections??x()};v(!0),Ua(a,y).then(N=>{if(v(!1),!N){n(e.memoAlertErr);return}s(N),r(e.memoAlertSaved)})};if(p)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(u=>u+1),children:e.retry})]})});if(!l)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const b=x();return t.jsxs(we,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||m,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(nl,{value:l.email||"",readOnly:o||m,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:u=>g({email:u})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([u,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!b[u],disabled:o||m,onChange:()=>g({sections:{...b,[u]:!b[u]}})}),t.jsx("span",{children:y})]},u))}),t.jsx(Oa,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>ro(a,b),onTest:()=>no(a,b)})]})}function nl({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=h.useState(e);h.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),p=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&s&&p&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>i(o.trim()),children:n})]})]})}function rl(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=q(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[f,d]=h.useState(null),[c,m]=h.useState(""),[v,x]=h.useState(0);h.useEffect(()=>{let u=!0;return p(!1),oa(a).then(y=>{u&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),so(a).then(y=>{u&&d(y)}),()=>{u=!1}},[a,v]);const g=(u,y)=>{i&&oa(a,u).then(N=>{if(!N||N.ok===!1){n(e.actErr);return}u.test&&N.sent===!1?n(e.plugTestThrottled):r(y),x(w=>w+1)})},b='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(we,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(u=>u+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:c,disabled:!i,onChange:u=>m(u.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!c.trim(),onClick:()=>g({url:c.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(ol,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:b}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var u;(u=navigator.clipboard)==null||u.writeText(b).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function ol(){const{t:e,token:a,lang:r}=q(),[n,i]=h.useState("valides"),[o,l]=h.useState(!1),[s,p]=h.useState(null),[f,d]=h.useState(null),[c,m]=h.useState(!1),[v,x]=h.useState(!1),[g,b]=h.useState(null),[u,y]=h.useState(null),[N,w]=h.useState(null),S=`atl2:bulk:${a}:${n}`;h.useEffect(()=>{oa(a).then(j=>{y(j&&j.configured?j.url_hint||"webhook":null)})},[a]),h.useEffect(()=>{p(null),d(null),m(!1),b(null);try{const j=JSON.parse(localStorage.getItem(S)||"null");w(j&&Date.now()-Date.parse(j.t)<24*3600*1e3?j:null)}catch{w(null)}},[S]);const C=async()=>{l(!0),m(!1),b(null);const j=await co(a,n);p(j),d(j.ok?n:null),l(!1)},O=h.useRef(!1),F=async()=>{if(O.current)return;O.current=!0,x(!0);const j=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await po(a,n,"webhook",void 0,j)}finally{O.current=!1}if(x(!1),m(!1),b(M),M.ok&&(M.pushed||0)>0){const T={t:new Date().toISOString(),n:M.pushed||0};w(T);try{localStorage.setItem(S,JSON.stringify(T))}catch{}}},A=s!=null&&s.ok&&s.ready||0,k=!!(s!=null&&s.ok)&&f===n&&A>0&&!!u&&!N,L=N?new Date(N.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:j=>i(j.target.value),children:e.plugBulkTabs.map(([j,M])=>t.jsx("option",{value:j,children:M},j))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{C()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),N&&t.jsx("p",{className:"mnote",children:e.bulkLocked(L,N.n)}),!N&&!!(s!=null&&s.ok)&&!u&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!N&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),k&&!c&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>m(!0),children:e.bulkArm}),k&&c&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(A,u||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{F()},children:v?e.bulkSending:e.bulkConfirm(u||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>m(!1),children:e.bulkCancel})]}),g&&(g.ok?g.replayed?t.jsx("p",{className:"mnote",children:g.pending?e.bulkPending:e.bulkReplayed}):(g.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:g.error||e.actErr}))]})}function il(){const{t:e,data:a,lang:r}=q(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const f=await(await fetch(`${ja}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(we,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function sl(){const{t:e}=q();return t.jsx(we,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Us,{})})}function ll(){const{t:e,lang:a,data:r,dossiers:n,token:i,canWrite:o,flash:l}=q(),[s,p]=h.useState(null),[f,d]=h.useState(!1);h.useEffect(()=>{let C=!0;return Sa(i).then(O=>{C&&O&&typeof O.per_day=="number"&&p(O.per_day)}),()=>{C=!1}},[i]);const c=r.stats,m=typeof(c==null?void 0:c.screened)=="number"?c.screened:n.filter(C=>C.kind==="target"&&Ce(C)).length,v=r.marketEstimate||0,x=v>0?Math.min(100,Math.round(m/v*100)):null,g=(c==null?void 0:c.window_days)||30,b=m>0?m/g:0,u=v>0?Math.max(0,v-m):0,N=v>0&&b>0&&m>=100?Math.round(u/b):null,w=C=>Math.round(C).toLocaleString(a==="en"?"en-US":"fr-FR"),S=C=>{f||!o||(d(!0),lo(i,C).then(O=>{if(d(!1),O===null){l(e.actErr);return}p(O),l(e.alertSaved)}))};return t.jsxs(we,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(m))}),v>0&&t.jsx("span",{children:e.covOf(w(v))})]}),x!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:x+"%"}}),t.jsxs("em",{children:[x," %"]})]}),N!==null&&t.jsx("p",{className:"mnote",children:e.covEta(N)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),b>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(b))}),c&&t.jsxs("div",{className:"covf",children:[typeof c.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.kept)})," ",e.covKept]}),typeof c.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.analyzed)})," ",e.covAna]}),typeof c.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.shown)})," ",e.covShown]})]}),o&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:s===C?"on":"",disabled:f,onClick:()=>S(C),children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function dl(){var u,y,N;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o}=q(),l=n==="client",s=h.useMemo(()=>{const w=new Set;return a.forEach(S=>{S.angle&&w.add(S.angle)}),[...w]},[a]),[p,f]=h.useState(null);h.useEffect(()=>{let w=!0;return io(r).then(S=>{w&&f(S.thumbs)}),()=>{w=!1}},[r]);const[d,c]=h.useState(""),[m,v]=h.useState(""),[x,g]=h.useState(!1),b=async()=>{const w=d.trim();if(!(!w||x||!l)){g(!0),v("");try{const C=await(await fetch(`${mt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(C.reply&&v(String(C.reply)),C.job_id){v(e.critChatRunning);const O=async()=>{const F=await fetch(`${mt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:C.job_id})}).then(A=>A.json()).catch(()=>null);if(F&&F.done){v(String(F.reply||F.clarification||F.summary||"✓")),g(!1),F.applied&&i(e.alertSaved);return}setTimeout(()=>{O()},8e3)};setTimeout(()=>{O()},8e3),c("");return}c("")}finally{m.startsWith("⏳")||g(!1)}}};return t.jsxs(we,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((u=o.points)!=null&&u.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var S,C;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((S=w.look)!=null&&S.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(O=>t.jsx("li",{children:O},O))})]}),!!((C=w.out)!=null&&C.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(O=>t.jsx("li",{children:O},O))})]})]})]},w.title)})]}),!!((N=o==null?void 0:o.gate)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!l||x,onChange:w=>c(w.target.value),onKeyDown:w=>{w.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(x?" loading":""),style:{padding:"12px 18px"},disabled:!l||x||!d.trim(),onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),m&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:m})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,S)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},S))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,S])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(lr[w]||"v-cons"),children:w}),t.jsx("span",{children:S})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,S])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",S]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function cl(){const{t:e,dispatch:a,startTour:r}=q(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(we,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const aa={},En=(aa==null?void 0:aa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function zn(){return new Date().toISOString().slice(0,10)}const pr=h.createContext(null);function ur(){const e=h.useContext(pr);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function pl({token:e,children:a}){const{dispatch:r,st:n,lang:i}=q(),[o,l]=h.useState(()=>n.filters.day||zn()),[s,p]=h.useState(null),[f,d]=h.useState(!1),c=h.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){l(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),m=h.useCallback(()=>{l(zn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);h.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),h.useEffect(()=>{const g=b=>{var y;const u=(y=b.detail)==null?void 0:y.day;typeof u=="string"&&c(u)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[c]),h.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),h.useEffect(()=>{if(!e||!o)return;let g=!1;d(!0);const b=new URLSearchParams({token:e,date:o});return fetch(`${En}/cibles/edition.json?${b}`).then(u=>u.json()).then(u=>{g||p(u)}).catch(()=>{g||p({ok:!1,error:"network"})}).finally(()=>{g||d(!1)}),()=>{g=!0}},[e,o]);const v=h.useMemo(()=>`${En}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),x=h.useMemo(()=>({token:e,day:o,ed:s,loading:f,pickDay:c,pickWindow:m,dayPicked:!!n.filters.day,daysUrl:v,isEn:i==="en"}),[e,o,s,f,c,m,n.filters.day,v,i]);return t.jsx(pr.Provider,{value:x,children:a})}function ul(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=ur();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
