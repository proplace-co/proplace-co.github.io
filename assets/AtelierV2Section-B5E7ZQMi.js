...
`)}),R(!0))},[]);f.useEffect(()=>{if(!K)return;me(0);const D=window.setInterval(()=>me(ie=>ie+1),1e3);return()=>window.clearInterval(D)},[K]);const Ge=f.useMemo(()=>{const D=j.trim().toLowerCase();return!D||!v?null:b.find(ie=>We(ie.name)===D&&ke(ie)===1)||null},[j,b,v]),At=()=>{const D=j.trim();if(D){if(Ge){p(Ge);return}i(null,D),y("")}},ft=async()=>{if(!h){i(null,le[0]||"");return}if(!le.length||E)return;k(!0),A.current=!1;const D=[];for(let ie=0;ie<le.length&&!A.current;ie++){T(e.evaluating(ie+1,le.length,le[ie]));const de=await nr(r,le[ie],"atelier2");if(D.unshift({name:de.company||le[ie],verdict:de.verdict,reason:de.reason||"",remaining:de.remaining??null}),C([...D]),de.verdict==="quota"){D.unshift({name:"",verdict:"quota",reason:e.quota(le.length-ie-1),remaining:0}),C([...D]),S(le.slice(ie+1).join(`
`)),T(""),k(!1);return}}T(""),S(A.current?le.slice(D.length).join(`
`):""),k(!1)},Tt=async()=>{var de,Ne,Ve;if(se.current)return;const D=Y.trim().replace(/\s+/g,""),ie=V.trim();if(!D&&!ie){fe(e.rsNeed);return}if(!h&&!N){i(null,D||ie.slice(0,80));return}se.current=!0,fe(""),oe(null),W(null),ee(!0);try{const Se=await Ro({url:D,text:ie,email:n,cbToken:N});if(ee(!1),!Se||Se.status!=="success"){fe((Se==null?void 0:Se.message)||"Erreur");return}oe(Se),U(!1),Te((((de=Se.prospective)==null?void 0:de.companies_to_evaluate)||[]).map(Re=>(Re==null?void 0:Re.name)||"")),W({state:"pending"});const xe=await Mo(Se,{email:n,cbToken:N});W(xe.ok?{state:"ok",scopeLabel:((Ne=xe.summary)==null?void 0:Ne.scope_label)||"",scope:((Ve=xe.summary)==null?void 0:Ve.scope)||""}:{state:"fail",msg:xe.error||""}),xe.ok&&J(Re=>Re+1)}finally{se.current=!1,ee(!1)}},zt=[X==null?void 0:X.industry,...(X==null?void 0:X.market_tags)||[],X==null?void 0:X.author].map(D=>(D||"").trim()).filter(Boolean),Ie=(te==null?void 0:te.state)==="pending",ra=te&&(Ie?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):te.state==="ok"?t.jsx("span",{className:"rslink ok",children:te.scope&&te.scope!=="public"?e.rsSavedIn(te.scopeLabel||te.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:te.msg,children:e.rsSaveFail})),qt=cl(X).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:j,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:D=>y(D.target.value),onKeyDown:D=>{D.key==="Enter"&&At()}}),t.jsx("span",{className:"detect"+(Yn.test(j.trim())?" url":""),children:ae})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(Ge?" analyse":"")+(s?" loading":""),disabled:s,onClick:At,children:[t.jsx("span",{className:"fill"}),Ge?e.actAnalyse:e.evalGo]}),x.showCredits&&pe&&t.jsxs("button",{type:"button",className:"credits"+(pe.total_available<=0&&!pe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:pe.unlimited?"∞":pe.total_available}),!pe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",pe.daily_grant+pe.purchased]}),pe.total_available<=0&&!pe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),g.items.filter(D=>D.status==="boot"||D.status==="running").map(D=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:D.name}),t.jsx(wt,{item:D,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+D.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>R(!z),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(F?" on":""),onClick:()=>U(!F),children:e.rsOpen}),L!==null&&L>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Q?" on":""),onClick:()=>ge(!Q),children:e.rsArchOpen(L)})]}),Q&&t.jsx(ul,{bump:B,cbToken:N,onClose:()=>ge(!1),onEvaluate:D=>i(null,D),onAddAll:Te}),F&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:Y,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:D=>H(D.target.value),onKeyDown:D=>{D.key==="Enter"&&Tt()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:V,placeholder:e.rsTextPh,onChange:D=>G(D.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(K?" loading":""),style:{justifyContent:"center"},disabled:K||Ie||!Y.trim()&&!V.trim(),onClick:()=>{Tt()},children:[t.jsx("span",{className:"fill"}),K?`${Lo(Y.trim())==="youtube"&&Y.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Z)}`:Ie?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),he&&t.jsx("div",{className:"rserr",children:he}),X&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:X.title}),X.source_url&&t.jsx("a",{href:X.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{oe(null),W(null)},children:"×"})]}),X.market&&t.jsx("p",{className:"rsmk",children:X.market}),zt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),zt.map(D=>t.jsx("span",{children:D},D))]}),t.jsxs("div",{className:"rsbody",children:[X.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${X.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Mr(X.summary_md||"").map((D,ie)=>t.jsx("p",{children:D},ie))})]}),t.jsx(Or,{card:X,onEvaluate:D=>i(null,D),onAddAll:Te}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(qt)}),ra]})]}),z&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:q,placeholder:e.bulkPh,onChange:D=>S(D.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(E?" loading":""),style:{justifyContent:"center"},disabled:E||!le.length,onClick:()=>{ft()},children:[t.jsx("span",{className:"fill"}),E&&M?M:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(le.length)})]})]}),Le.slice(0,1).map((D,ie)=>{const de=D.verdict==="kept",Ne=D.verdict==="quota",Ve=de?"var(--brand)":Ne?"var(--bolt)":"var(--red)",Se=de?"var(--brand-l)":Ne?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ve,"--bgc":Se},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:de?"✓ "+e.kept:Ne?"⏳":"✗ "+e.dropped})}),D.name&&t.jsx("span",{className:"rn",children:D.name}),t.jsx("span",{className:"rr",children:D.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",D.reason]}):null}),!!(D.candidates&&D.candidates.length)&&t.jsx("span",{className:"sitepick",children:D.candidates.map(xe=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:xe.url.startsWith("http")?xe.url:`https://${xe.url}`,target:"_blank",rel:"nofollow noopener",children:[(xe.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,xe.url),children:e.evalPickGo})]},xe.url))}),!Ne&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:de?1:5});const xe=(D.name||"").trim().toLowerCase();window.setTimeout(()=>{const Re=[...document.querySelectorAll(".atl2 .list .row")].find(oa=>{var Lt;return(((Lt=oa.querySelector(".rnm"))==null?void 0:Lt.textContent)||"").trim().toLowerCase().includes(xe)});Re&&(Re.scrollIntoView({behavior:"smooth",block:"center"}),Re.classList.add("flashrow"),window.setTimeout(()=>Re.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(de?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ie)}),h&&(o.kept+o.dropped>0||Le.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function fl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function xl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=$(),o=e.memoConsole?r.get(e.memoConsole):null,l=f.useMemo(()=>o?[o.reasoning||"",fl(o.summary||"")].filter(Boolean).join(`
