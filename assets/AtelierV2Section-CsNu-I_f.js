...
.atl2 .bulk .side .hint{white-space:nowrap}`,Fi=`
...
.atl2 .props{display:inline-block;font-family:var(--mono);font-size:9.5px;
  letter-spacing:.08em;text-transform:uppercase;color:var(--brand-d,#0A6B3D);
  background:#EFF8F2;border-radius:999px;padding:3px 9px;margin-bottom:6px}
...
`,Mi=Ri+Fi+Oi;function sn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Di(){const e=sn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ii(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Di();return r==="0"?"client":r==="1"||sn("embed")==="1"&&sn("chrome")==="1"?"apercu":"client"}const Pi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Bi=e=>Pi[e];function Ea(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const St=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!eo(a)||Ea(a))&&(e.noCo=!0)}return Object.assign(e,{continent:vs(e.cc)})};function Va(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const _i=60*60*1e3;function $i(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>_i?null:a}catch{return null}}function ca(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ui=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Hi(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:ls(),[e,n]),s=p.useMemo(()=>n?"visiteur":Ii(e,o),[e,o,n]),i=p.useMemo(()=>Bi(s),[s]),l=s!=="visiteur",d=Ui(r),[g,c]=p.useState([]),[x,u]=p.useState(""),[b,m]=p.useState(null),[v,w]=p.useState(null),[f,y]=p.useState(null),[j,k]=p.useState(()=>new Map),[N,S]=p.useState(()=>new Map),[C,R]=p.useState(""),[T,D]=p.useState(new Set),[F,$]=p.useState(null),[O,I]=p.useState(!0),[h,q]=p.useState(!1),[U,X]=p.useState(0),[E,z]=p.useState(0),M=p.useRef(0),B=p.useMemo(()=>{var G;if(s!=="client")return"";try{return((G=ds())==null?void 0:G.email)||""}catch{return""}},[s]);p.useEffect(()=>{const G=++M.current;let ue=!0;const K=()=>ue&&G===M.current,ce=(l&&o.token?o.token:"pub:"+a)+(d?":"+d:""),le=$i(ce);return le?(c(le.objs.map(St)),le.fund&&u(le.fund),m(le.marketEstimate??null),w(le.criteria??null),y(le.stats??null),R(le.generatedAt||""),I(!1)):I(!0),(async()=>{try{if(r==="ops"){const be=await _a(),fe=((be==null?void 0:be.recent_ops)||[]).map(de=>{const pe=va(de.company_name||de.title?de:{...de,title:(de.headline_fr||de.headline||"").slice(0,120)},a),xe=String(de.rubrique||"").toLowerCase();return pe&&(xe==="nominations"||xe==="recrutements")&&(pe.engine=xe),pe&&!String(de.company_name||"").trim()&&(pe.noCo=!0),pe}).filter(de=>!!de).map(de=>(eo((de.name||"").trim())||(de.noCo=!0),de));try{const de=cs(),pe=await ps(),xe=((pe==null?void 0:pe.date)||"").slice(0,10),Q=de?de.doc:pe,re=us(Q),he=((de==null?void 0:de.day)||(Q==null?void 0:Q.date)||xe||"").slice(0,10);if(he&&re.length){const ke=new Set;for(const ne of fe){if((ne.date||"").slice(0,10)!==he)continue;const ve=_n(re,ke,ne.name,"");ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}for(const ne of fe){if(ne.decryptHtml||(ne.date||"").slice(0,10)!==he)continue;const ve=_n(re,ke,"",ne.headline||ne.tagline||ne.name);ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}}if(he){const ke=((Q==null?void 0:Q.title_fr)||"").trim(),ne=((Q==null?void 0:Q.lead_fr)||"").trim(),ve=ms(Q),oe=((Q==null?void 0:Q.url)||"").trim();ke&&(ve||oe)&&fe.unshift({id:`edito:${he}`,kind:"op",name:ke,cc:null,date:he,engine:"edito",dealKind:"other",headline:ke,tagline:ne||ke,decryptHtml:ve||void 0,url:oe,noCo:!0})}}catch{}if(!K())return;c(fe.map(St)),ca(ce,{objs:fe})}else if(typeof r=="object"){const fe=(await $n()||[]).filter(pe=>(pe.slug||"")===r.research).map(pe=>Un(pe,a)).filter(pe=>!!pe),de=Va(await Hn(fe,a));if(!K())return;c(de.map(St)),ca(ce,{objs:de})}else if(l&&o.token){const be=fs(o.token),fe=_a(),de=hs(o.token),pe=gs(o.token),xe=xs(o.token),Q=await be;let re=Q?Q.targets:[];K()&&Q&&(u(Q.fund||""),m(Q.marketEstimate??null),w(Q.criteria??null),y(Q.stats??null),R(Q.generatedAt||""),c(re.map(St)),I(!1),q(!1));const[he,ke,ne,ve]=await Promise.all([fe,de,pe,xe]),oe=((he==null?void 0:he.recent_ops)||[]).map(ge=>va(ge,a)).filter(ge=>!!ge),ze=new Set(re.map(ge=>ge.id));if(re=[...re,...oe.filter(ge=>!ze.has(ge.id)&&(ze.add(ge.id),!0))],!K())return;c(re.map(St));const Ke=new Set;for(const ge of ke){const Se=(ge.id||ge.co||"").toString().trim().toLowerCase();Se&&Ke.add(Se.startsWith("t:")?Se:"t:"+Se)}D(Ke),k(ne),S(ve),Q&&ca(ce,{fund:Q.fund,marketEstimate:Q.marketEstimate,criteria:Q.criteria,stats:Q.stats,generatedAt:Q.generatedAt,objs:re})}else{const be=bs(),fe=$n(),de=_a(),pe=await be;K()&&pe.length&&(c(Va(pe).map(St)),I(!1),q(!1));const[xe,Q]=await Promise.all([fe,de]),re=(xe||[]).map(ve=>Un(ve,a)).filter(ve=>!!ve),he=await Hn(re,a),ke=((Q==null?void 0:Q.recent_ops)||[]).map(ve=>va(ve,a)).filter(ve=>!!ve),ne=Va([...pe,...he,...ke]);if(!K())return;c(ne.map(St)),ca(ce,{objs:ne})}K()&&q(!1)}catch{K()&&!le&&q(!0)}finally{K()&&I(!1)}})(),()=>{ue=!1}},[l,o.token,a,U,d]),p.useEffect(()=>{if(!i.showCredits||!B){$(null);return}let G=!0;return(async()=>{try{const ue=await fetch(`${Da}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:B})});if(!ue.ok)return;const K=await ue.json();G&&K&&K.ok!==!1&&$(K)}catch{}})(),()=>{G=!1}},[i.showCredits,B,E]);const _=p.useCallback(G=>D(new Set(G)),[]);return{session:o,mode:s,caps:i,fund:x,email:B,marketEstimate:b,generatedAt:C,criteria:v,stats:f,thumbs:j,stages:N,dossiers:g,favIds:T,setFavIds:_,credits:F,reloadCredits:()=>z(G=>G+1),loading:O,error:h,refresh:()=>X(G=>G+1)}}function Ge(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ya=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Sa(e){return ya.has(e.engine||"")}function We(e){return!!e.noCo||Sa(e)&&!!e.url}const mo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Vi=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...mo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,memoTab:0,undo:[],mapFolded:a}),Wi=new Set(["signal","amount","score","crible","memo"]);function Gi(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:mo(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Wi.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??fo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const fo=80;function Ca(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Oe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Nn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const s=a.win==="1"?0:a.win==="7"?7:30;if(gt(e.date)>s)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&zt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(ao(e)))return!1;if(n!=="search"&&a.search.trim()){const s=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(s))return!1}return!0}function ea(e,a,r){return Ge(e)?Ca(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ca(e,a.filters,r)}function Yi(e,a,r,n){return!(!ea(e,a,r)||r&&!to(e,a.ptab,n))}function zn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-gt(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return ws(o);case"memo":return ys(o);case"signal":{const s=Oe(o);return s?100-(s.left??0):-1}}};return[...e].sort((o,s)=>{const i=n(o),l=n(s);return i<l?-a.dir:i>l?a.dir:(o.name||"").localeCompare(s.name||"")})}const Wa={},ir=(Wa==null?void 0:Wa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function lr(){return new Date().toISOString().slice(0,10)}const An=p.createContext(null);function ho(){return p.useContext(An)}function Qi(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const s=n.querySelector("strong,b"),i=((s==null?void 0:s.textContent)||"").replace(/\s+/g," ").trim();if(!i||i.length<2||i.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),l.querySelectorAll("*").forEach(d=>{const g=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(c=>d.removeAttribute(c.name)),g&&/^https?:\/\//i.test(g)&&(d.setAttribute("href",g),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:i.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Ki(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const s=o.name.toLowerCase(),i=o.value,l=s==="class"||s==="alt"||s==="width"||s==="height"||s.startsWith("data-"),d=(s==="href"||s==="src")&&/^https?:\/\//i.test(i);!l&&!d&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function dr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,s=n.getAttribute("class"),i=s==="tb-geo"||s==="tb-these"||s==="tb-sec"?s:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),i&&n.setAttribute("class",i),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function cr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const s=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",i=String(Number(r[3]));return a?`${s} ${i}, ${r[1]}`:`${i==="1"?"1ᵉʳ":i} ${s} ${r[1]}`}function go(){const e=p.useContext(An);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ji({token:e,children:a}){const{dispatch:r,st:n,lang:o}=V(),[s,i]=p.useState(()=>n.filters.day||lr()),[l,d]=p.useState(null),[g,c]=p.useState(!1),x=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){i(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{i(lr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=w=>{var y;const f=(y=w.detail)==null?void 0:y.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[x]),p.useEffect(()=>{n.filters.day&&n.filters.day!==s&&i(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!s)return;let v=!1;c(!0);const w=new URLSearchParams({token:e,date:s});return fetch(`${ir}/cibles/edition.json?${w}`).then(f=>f.json()).then(f=>{v||d(f)}).catch(()=>{v||d({ok:!1,error:"network"})}).finally(()=>{v||c(!1)}),()=>{v=!0}},[e,s]);const b=p.useMemo(()=>`${ir}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=p.useMemo(()=>({token:e,day:s,ed:l,loading:g,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,s,l,g,x,u,n.filters.day,b,o]);return t.jsx(An.Provider,{value:m,children:a})}function Xi(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=go(),[o,s]=p.useState(()=>n||no());return p.useEffect(()=>{n&&s(!0)},[n]),p.useEffect(()=>{const i=l=>{var d;return s(!!((d=l.detail)!=null&&d.open))};return window.addEventListener(ja,i),()=>window.removeEventListener(ja,i)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(ks,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Zi(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function pr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function ur(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function el(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:s}=go(),i=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!i,d=a&&!a.ok,g=p.useRef(null),[c,x]=p.useState("fonds"),[u,b]=p.useState(null),[m,v]=p.useState("idle"),w=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),w.current=!1,x("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||w.current)return;w.current=!0;let N=!0;return v("load"),Zi(e).then(S=>{N&&(b(S),v("fait"))}),()=>{N=!1}},[c,e]);const f=p.useMemo(()=>Ki((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),y=p.useRef(null);p.useEffect(()=>{const N=y.current;if(!N||!f)return;let S=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(S||!N.isConnected)&&(C.beautifyEditoRows(N),C.mountCardFits(N))}),()=>{S=!0}},[f]);const j=p.useMemo(()=>dr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>dr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const N=g.current;if(!N||!j)return;let S=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(S||!N.isConnected)&&(C.beautifyEditoRows(N),C.mountCardFits(N))}),()=>{S=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:s?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[s?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>x("fonds"),children:(s?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(s?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>x("jour"),children:s?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:s?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!i&&t.jsx("p",{className:"thesis-brief__loading",children:s?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&d&&t.jsxs("p",{className:"thesis-brief__err",children:[s?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:s?pr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:cr(e,!0)}),"."]}):pr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:cr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:s?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&i&&j?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,c==="fonds"&&i&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:y,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?s?"Loading the daily editorial…":"Chargement de l’édito du jour…":s?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:ur(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:ur(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:s?"← See all":"← Voir tout"})]})}const tl=300,pa=7,al={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},xo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},nl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ga(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Ss(r)&&r!=="media")return"news:"+r;const n=Oe(e);return n?"sig:"+(n.theme&&xo.fr[n.theme]?n.theme:"other"):"actualites"}function rl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:s,lang:i,fund:l}=V(),d=ho(),g=i==="en",[c,x]=p.useState("all"),[u,b]=p.useState(!1),m=p.useMemo(()=>{var ue;const h=(a.filters.day||"").slice(0,10),q=K=>!(!s&&a.continent!=="monde"&&K.continent!==a.continent||h&&(K.date||"").slice(0,10)!==h),U=e.filter(K=>q(K)&&Oe(K)&&(!s||K.kind!=="target"||Ne(K)!==5)),X=s&&(((ue=d==null?void 0:d.ed)==null?void 0:ue.ops)||[]).length?d.ed.ops.map(K=>va(K,i)).filter(K=>!!K).map(K=>(K.briefOnly=!0,K)).filter(K=>!h||(K.date||"").slice(0,10)===h):[],E=e.filter(K=>q(K)&&K.kind==="op"&&(h?!0:gt(K.date)<=pa)),z=s?X.length?X:E.filter(K=>{const ce=(l||"").trim().toLowerCase();if(!ce)return!1;const le=K.match||null;return le?Object.keys(le).map(be=>be.trim().toLowerCase()).includes(ce):!1}):E,M=h||new Date().toISOString().slice(0,10),B=K=>{const ce=Ga(K);return ce==="ma"?0:ce==="levees"?1:2};z.sort((K,ce)=>{const le=B(K)-B(ce);if(le)return le;const be=(K.date||"").slice(0,10)===M?0:1,fe=(ce.date||"").slice(0,10)===M?0:1;return be!==fe?be-fe:(ce.amountEur||0)-(K.amountEur||0)});const _=new Set,G=[];for(const K of[...z,...zn(U,{key:"signal",dir:-1})]){const ce=K.id||K.name;!ce||_.has(ce)||(_.add(ce),G.push(K))}return s&&G.length===0?e.filter(ce=>q(ce)&&gt(ce.date)<=pa).sort((ce,le)=>(le.date||"").localeCompare(ce.date||"")).slice(0,80):G},[e,a.continent,a.filters.day,s,l,i,d]),v=p.useMemo(()=>{const h={};for(const q of m){const U=Ga(q);h[U]=(h[U]||0)+1}return h},[m]),w=p.useMemo(()=>c==="all"?m:m.filter(h=>Ga(h)===c),[m,c]),f=p.useMemo(()=>w.slice(0,tl),[w]),y=w.length-f.length,j=p.useRef(null);p.useEffect(()=>{var z,M;const h=j.current;if(!h)return;const q=()=>{const B=h.scrollWidth;B<200||(h.style.animationDuration=Math.max(18,Math.round(B/130))+"s")};q();const U=requestAnimationFrame(q),X=window.setTimeout(q,1200);let E=!0;return(M=(z=document.fonts)==null?void 0:z.ready)==null||M.then(()=>{E&&q()}),()=>{E=!1,cancelAnimationFrame(U),window.clearTimeout(X)}},[f.length,c]);const k=h=>h==="all"?m.length:v[h]||0,N=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return xo[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const q=h.slice(5);return Ns[q]?Es(q,g?"en":"fr"):h}return al[g?"en":"fr"][h]},S=[{k:"all"}],C=["ma","levees"].filter(h=>k(h)>0||h===c);if(C.length){S.push({g:g?"Deals":"Opérations"});for(const h of C)S.push({k:h})}const R=["nominations","recrutements"].filter(h=>k(h)>0||h===c),T=js.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>k(h)>0||h===c),D=k("actualites")>0||c==="actualites"?["actualites"]:[];if(R.length||T.length||D.length){S.push({g:g?"News":"Actualités"});for(const h of R)S.push({k:h});for(const h of T)S.push({k:h});for(const h of D)S.push({k:h})}const F=nl.map(h=>"sig:"+h).filter(h=>k(h)>0||h===c);if(F.length){S.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of F)S.push({k:h})}const $=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},O=(()=>{const h=(a.filters.day||"").slice(0,10),q=!s&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(g?`LIVE covers the events of ${$(h)}.`:`Le LIVE regroupe les événements du ${$(h)}.`)+q:(g?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+q})(),I=h=>f.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ie(q)?" spent":""),onClick:U=>{const X=q.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:X?"":q.id,name:q.name,url:q.url||"",text:q.tagline||q.headline||"",card:q.card}}))}catch{}if(X||n({type:"focus",id:q.id}),a.dens!=="liste"){const E=U.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:E.left+E.width/2,y:E.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(wt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(es,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Uc(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Ia,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(q.id||q.name))).concat(y>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${y} more — filter by section to see them`:`+ ${y} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(h=>!h),children:[N(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:O}),S.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===c,onClick:()=>{x(h.k),b(!1)},children:[N(h.k),t.jsx("b",{children:k(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:j,children:[I(0),I(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!d&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!d&&t.jsx(sl,{isEn:g})]})}const ol=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function sl({isEn:e}){const[a,r]=p.useState(()=>no());p.useEffect(()=>{const o=s=>{var i;return r(!!((i=s.detail)!=null&&i.open))};return window.addEventListener(ja,o),()=>window.removeEventListener(ja,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Cs(!a),children:ol})}const qn="+33 6 83 10 72 86",za="alexandre@proplace.co",bo=`tel:${qn.replace(/[^\d+]/g,"")}`;function il(){return null}class rt extends p.Component{constructor(){super(...arguments);Pn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const vo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function mr(e,a){if((kt(e)||"").startsWith("CALL")&&Ne(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ne(e)>=2;return vo.filter(([o])=>!(n&&o==="Retenu")).map(([o,s])=>[o,a[s]])}const fr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",ll={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function dl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:s,memoQueued:i}=V(),[l,d]=p.useState(""),[g,c]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!x)return;const y=j=>{b.current&&!b.current.contains(j.target)&&(u(!1),c(!1))};return document.addEventListener("click",y,!0),()=>document.removeEventListener("click",y,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),v=async y=>{if(l)return;if(y==="Analysé"&&!e.memoUrl){c(!0);return}d(y);const j=(mr(e,a).find(([N])=>N===y)||[y,y])[1],k=await o(e,y,{msg:a.csMoved(e.name,j)});d(""),k&&(c(!1),u(!1))},w=mr(e,a),f=y=>(w.find(([j])=>j===y)||[])[1]||y;return w.length===2?t.jsx("span",{className:"rstat rst2",onClick:y=>y.stopPropagation(),children:w.map(([y,j])=>t.jsx("button",{type:"button",className:"rsd "+(y==="Validé"?"yes":"no")+(l===y?" busy":""),disabled:!!l,onClick:()=>{v(y)},children:j},y))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:y=>y.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+fr(m),onClick:()=>{u(y=>!y),c(!1)},children:l?f(l)+"…":m?f(m):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:w.map(([y,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===y,className:"rsopt"+(m===y?" on":"")+(l===y?" busy":""),disabled:!!l,onClick:()=>{if(y===m){u(!1);return}v(y)},children:[t.jsx("i",{className:"pt2",style:{background:ll[fr(y)]}}),j]},y))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:i.has(e.id),onClick:()=>{s(e),c(!1),u(!1)},children:i.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{d("Analysé");const y=await o(e,"Analysé");d(""),y&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function cl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=V(),[s,i]=p.useState(""),[l,d]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),c=(kt(e)||"").startsWith("CALL")&&Ne(e)===3,x=Ne(e)>=2,u=async m=>{if(s||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;i(m);const v=await o(e,m);i(""),v&&(d(!0),setTimeout(()=>d(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:vo.filter(([m])=>!(x&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(s===m?" busy":""),disabled:!!s,onClick:()=>{u(m)},children:v},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(pl,{o:e})]})}function pl({o:e}){const{t:a,saveNote:r,flash:n}=V(),[o,s]=p.useState(e.ceoNote||""),[i,l]=p.useState(!1),[d,g]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(i||!c)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:i,onChange:u=>s(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:i||!c,onClick:()=>{x()},children:d?a.csNoteSaved:a.csNoteOk})]})}function ul({placeholder:e,onDone:a}){const{t:r}=V(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:s=>o(s.target.value),onKeyDown:s=>{s.key==="Enter"&&a(n.trim()),s.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ml({o:e}){var w;const{t:a,token:r,caps:n,canWrite:o,stageOf:s,setStage:i,flashErr:l}=V(),[d,g]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Ne(e)!==4)return null;const c=s(e),x=(c==null?void 0:c.stage)||"todo",u=async f=>{if(d||f===x)return;g(!0);const y=c;i(e,{stage:f,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),hr+=1);hr=j;const k=await zs(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!k.stale&&(k.ok||(i(e,y),l(a.actErr)))},b=(w=c==null?void 0:c.stamps)==null?void 0:w.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:d,onClick:()=>{u(f)},children:y},f)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let hr=0;const Wt=8,yt=360;function gr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function xr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(gr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(gr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function fl({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:s}=V(),[i,l]=p.useState(0),[d,g]=p.useState(null),[c,x]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:s.ptab,dens:s.dens,modal:s.modal}),m=p.useRef(!1);p.useEffect(()=>{const C=b.current;return()=>{m.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const v=c[i],w=i>=c.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&s.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&s.dens!==v.dens&&n({type:"dens",dens:v.dens}),s.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const C=v.click,R=window.setTimeout(()=>{const T=document.querySelector(C);T&&T.getAttribute("aria-selected")!=="true"&&T.click()},60);return()=>window.clearTimeout(R)}},[i,v]);const f=p.useRef(-1),y=p.useCallback(()=>{if(!v){g(null);return}const C=D=>{if(!D)return null;for(const F of document.querySelectorAll(D)){const $=F.getBoundingClientRect();if($.width>1&&$.height>1)return F}return null},R=C(v.sel)||C(v.need);if(!R){g(null);return}f.current!==i&&(f.current=i,R.scrollIntoView({block:"nearest",behavior:"smooth"}));const T=R.getBoundingClientRect();g(D=>D&&Math.abs(D.top-T.top)<1&&Math.abs(D.left-T.left)<1&&Math.abs(D.width-T.width)<1&&Math.abs(D.height-T.height)<1?D:T)},[v,i]);p.useLayoutEffect(()=>{y();const C=[90,300,700,1300].map(D=>window.setTimeout(y,D)),R=window.setInterval(y,400),T=()=>y();return window.addEventListener("scroll",T,!0),window.addEventListener("resize",T),()=>{C.forEach(D=>window.clearTimeout(D)),window.clearInterval(R),window.removeEventListener("scroll",T,!0),window.removeEventListener("resize",T)}},[y]);const j=p.useRef(a);if(j.current=a,p.useEffect(()=>{const C=R=>{R.key==="Escape"?(R.preventDefault(),R.stopPropagation(),j.current()):R.key==="ArrowRight"?l(T=>T+1):R.key==="ArrowLeft"&&l(T=>Math.max(0,T-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!c.length)return null;let k=null;const N=C=>()=>{m.current=!0,n({type:"modal",modal:null}),C()};if(w){const C=o[3]||0;C>0?k={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let S={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:yt};if(!w&&d){const C=d.bottom+14,R=window.innerHeight-C;let T=R>190?C:Math.max(12,d.top-200),D=Math.min(Math.max(12,d.left+d.width/2-yt/2),window.innerWidth-yt-12);R<=190&&d.top<212&&(window.innerWidth-d.right>=yt+40?D=Math.min(d.right+26,window.innerWidth-yt-12):d.left>=yt+40&&(D=Math.max(12,d.left-yt-26)),T=Math.max(12,d.top-Wt)),S={left:D,top:T,width:yt}}return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!w&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Wt,top:d.top-Wt,width:d.width+Wt*2,height:d.height+Wt*2}}),(w||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(w?" fin":""),style:S,children:[w&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(xr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(i+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(i+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(xr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:i===0,onClick:()=>l(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(C=>C+1),children:i===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function yo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function wo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function hl(){var R,T;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:s,lang:i,data:l,dispatch:d}=V(),g=r?a:e,c=p.useMemo(()=>g.filter(D=>gt(D.date)===0&&D.kind==="target"),[g]),x=p.useMemo(()=>r?a.filter(D=>D.kind==="target"&&Ne(D)===0).slice().sort((D,F)=>(F.date||"").localeCompare(D.date||"")):[],[a,r]),u=p.useMemo(()=>c.filter(D=>r?Ne(D)===0:!Ie(D)),[c,r]),b=r?x:u,m=r?a.length-x.length:c.length-u.length,v=r?a.length:c.length,w=v?Math.min(100,m/v*100):100,f=p.useMemo(()=>yo(g),[g]),y=!!f&&gt(f)>0,j=p.useMemo(()=>y?g.filter(D=>(D.date||"").slice(0,10)===f):[],[g,f,y]),k=typeof((R=l.stats)==null?void 0:R.kept_today)=="number"?l.stats.kept_today:null,N=typeof((T=l.stats)==null?void 0:T.screened_today)=="number"?l.stats.screened_today:c.length;let S;y?S=o.morningLast(j.length,x.length,wo(f,i)):r?S=o.morningThesis(N,x.length,k):c.length?m===0?S=o.goalSourced(c.length):m>=c.length?S=o.goalCleared:S=o.goalDone(m,c.length):S=o.goalSourced(0);const C=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&x.length&&d({type:"chainStart",queue:x.map(D=>D.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:S}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:w+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):s.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function gl(){var U,X;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:s,data:i,dossiers:l,mode:d,doSync:g,startTour:c,flash:x,flashErr:u}=V(),[b,m]=p.useState(null),[v,w]=p.useState(!0),[f,y]=p.useState([]),j=d==="client";p.useEffect(()=>{if(!o||!s)return;let E=!0;return w(!0),(async()=>{const[z,M]=await Promise.all([En(s),ro(o)]);E&&(z&&m(z),w(!1),y(M))})(),()=>{E=!1}},[o,s]);const[k,N]=p.useState(!1),S=()=>{!j||k||!s||(N(!0),As(s).then(E=>{N(!1),E?x(e.identRepubDone):u(e.actErr)}))},C=(b==null?void 0:b.per_day)??null,R=((U=b==null?void 0:b.pool_order)==null?void 0:U.length)??0,T=f.filter(E=>E.status==="running").length,D=p.useMemo(()=>l.filter(E=>E.kind==="target"&&Ie(E)).length,[l]),F=i.marketEstimate,$=typeof((X=i.stats)==null?void 0:X.screened)=="number"?i.stats.screened:D,O=F&&F>0?Math.min(100,Math.round($/F*100)):null,I=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),h=(s||"P").split(/\s+/).map(E=>E[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const E=Date.parse(i.generatedAt||"");if(Number.isNaN(E))return"";const z=new Date(E),M=B=>String(B).padStart(2,"0");return`${M(z.getDate())}/${M(z.getMonth()+1)} à ${M(z.getHours())}:${M(z.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:s?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:s||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:s?e.identTitle(s):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),q?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[O===null&&$>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:I($)})})]}),O!==null&&F&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:O+"%"}})}),t.jsxs("b",{children:[O," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf($,F)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),C===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),T>0&&t.jsxs("span",{className:"ev",children:["⏳ ",T]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(R)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:E=>{E.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||k,onClick:S,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:E=>n({type:"filters",patch:{search:E.target.value}})})]})]})]})}class qt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const s=r[o],i=a+s,l=Math.abs(a)<Math.abs(s)?a-(i-s):s-(i-a);l&&(r[n++]=l),a=i}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,s,i=0;if(r>0){for(i=a[--r];r>0&&(n=i,o=a[--r],i=n+o,s=o-(i-n),!s););r>0&&(s<0&&a[r-1]<0||s>0&&a[r-1]>0)&&(o=s*2,n=i+o,o==n-i&&(i=n))}return i}}function*xl(e){for(const a of e)yield*a}function ko(e){return Array.from(xl(e))}var we=1e-6,me=Math.PI,et=me/2,br=me/4,at=me*2,mt=180/me,Ye=me/180,Ce=Math.abs,bl=Math.atan,ta=Math.atan2,Te=Math.cos,Le=Math.sin,vl=Math.sign||function(e){return e>0?1:e<0?-1:0},Lt=Math.sqrt;function yl(e){return e>1?0:e<-1?me:Math.acos(e)}function aa(e){return e>1?et:e<-1?-et:Math.asin(e)}function tt(){}function Aa(e,a){e&&yr.hasOwnProperty(e.type)&&yr[e.type](e,a)}var vr={Feature:function(e,a){Aa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Aa(r[n].geometry,a)}},yr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ln(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ln(r[n],a,0)},Polygon:function(e,a){wr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)wr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Aa(r[n],a)}};function ln(e,a,r){var n=-1,o=e.length-r,s;for(a.lineStart();++n<o;)s=e[n],a.point(s[0],s[1],s[2]);a.lineEnd()}function wr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ln(e[r],a,1);a.polygonEnd()}function Ot(e,a){e&&vr.hasOwnProperty(e.type)?vr[e.type](e,a):Aa(e,a)}function dn(e){return[ta(e[1],e[0]),aa(e[2])]}function It(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*Le(a),Le(r)]}function ua(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function qa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ya(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ma(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function cn(e){var a=Lt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function pn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function un(e,a){return Ce(e)>me&&(e-=Math.round(e/at)*at),[e,a]}un.invert=un;function wl(e,a,r){return(e%=at)?a||r?pn(jr(e),Nr(a,r)):jr(e):a||r?Nr(a,r):un}function kr(e){return function(a,r){return a+=e,Ce(a)>me&&(a-=Math.round(a/at)*at),[a,r]}}function jr(e){var a=kr(e);return a.invert=kr(-e),a}function Nr(e,a){var r=Te(e),n=Le(e),o=Te(a),s=Le(a);function i(l,d){var g=Te(d),c=Te(l)*g,x=Le(l)*g,u=Le(d),b=u*r+c*n;return[ta(x*o-b*s,c*r-u*n),aa(b*o+x*s)]}return i.invert=function(l,d){var g=Te(d),c=Te(l)*g,x=Le(l)*g,u=Le(d),b=u*o-x*s;return[ta(x*o+u*s,c*r+b*n),aa(b*r-c*n)]},i}function kl(e,a,r,n,o,s){if(r){var i=Te(a),l=Le(a),d=n*r;o==null?(o=a+n*at,s=a-d/2):(o=Er(i,o),s=Er(i,s),(n>0?o<s:o>s)&&(o+=n*at));for(var g,c=o;n>0?c>s:c<s;c-=d)g=dn([i,-l*Te(c),-l*Le(c)]),e.point(g[0],g[1])}}function Er(e,a){a=It(a),a[0]-=e,cn(a);var r=yl(-a[1]);return((-a[2]<0?-r:r)+at-we)%at}function jo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:tt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function wa(e,a){return Ce(e[0]-a[0])<we&&Ce(e[1]-a[1])<we}function fa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function No(e,a,r,n,o){var s=[],i=[],l,d;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,w=m[0],f=m[v],y;if(wa(w,f)){if(!w[2]&&!f[2]){for(o.lineStart(),l=0;l<v;++l)o.point((w=m[l])[0],w[1]);o.lineEnd();return}f[0]+=2*we}s.push(y=new fa(w,m,null,!0)),i.push(y.o=new fa(w,null,y,!1)),s.push(y=new fa(f,m,null,!1)),i.push(y.o=new fa(f,null,y,!0))}}),!!s.length){for(i.sort(a),Sr(s),Sr(i),l=0,d=i.length;l<d;++l)i[l].e=r=!r;for(var g=s[0],c,x;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;c=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,d=c.length;l<d;++l)o.point((x=c[l])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(c=u.p.z,l=c.length-1;l>=0;--l)o.point((x=c[l])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Sr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Qa(e){return Ce(e[0])<=me?e[0]:vl(e[0])*((Ce(e[0])+me)%at-me)}function jl(e,a){var r=Qa(a),n=a[1],o=Le(n),s=[Le(r),-Te(r),0],i=0,l=0,d=new qt;o===1?n=et+we:o===-1&&(n=-et-we);for(var g=0,c=e.length;g<c;++g)if(u=(x=e[g]).length)for(var x,u,b=x[u-1],m=Qa(b),v=b[1]/2+br,w=Le(v),f=Te(v),y=0;y<u;++y,m=k,w=S,f=C,b=j){var j=x[y],k=Qa(j),N=j[1]/2+br,S=Le(N),C=Te(N),R=k-m,T=R>=0?1:-1,D=T*R,F=D>me,$=w*S;if(d.add(ta($*T*Le(D),f*C+$*Te(D))),i+=F?R+T*at:R,F^m>=r^k>=r){var O=qa(It(b),It(j));cn(O);var I=qa(s,O);cn(I);var h=(F^R>=0?-1:1)*aa(I[2]);(n>h||n===h&&(O[0]||O[1]))&&(l+=F^R>=0?1:-1)}}return(i<-we||i<we&&d<-1e-12)^l&1}function Eo(e,a,r,n){return function(o){var s=a(o),i=jo(),l=a(i),d=!1,g,c,x,u={point:b,lineStart:v,lineEnd:w,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=j,c=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=w,c=ko(c);var k=jl(g,n);c.length?(d||(o.polygonStart(),d=!0),No(c,El,k,r,o)):k&&(d||(o.polygonStart(),d=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),d&&(o.polygonEnd(),d=!1),c=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,N){e(k,N)&&o.point(k,N)}function m(k,N){s.point(k,N)}function v(){u.point=m,s.lineStart()}function w(){u.point=b,s.lineEnd()}function f(k,N){x.push([k,N]),l.point(k,N)}function y(){l.lineStart(),x=[]}function j(){f(x[0][0],x[0][1]),l.lineEnd();var k=l.clean(),N=i.result(),S,C=N.length,R,T,D;if(x.pop(),g.push(x),x=null,!!C){if(k&1){if(T=N[0],(R=T.length-1)>0){for(d||(o.polygonStart(),d=!0),o.lineStart(),S=0;S<R;++S)o.point((D=T[S])[0],D[1]);o.lineEnd()}return}C>1&&k&2&&N.push(N.pop().concat(N.shift())),c.push(N.filter(Nl))}}return u}}function Nl(e){return e.length>1}function El(e,a){return((e=e.x)[0]<0?e[1]-et-we:et-e[1])-((a=a.x)[0]<0?a[1]-et-we:et-a[1])}const Cr=Eo(function(){return!0},Sl,zl,[-me,-et]);function Sl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(s,i){var l=s>0?me:-me,d=Ce(s-a);Ce(d-me)<we?(e.point(a,r=(r+i)/2>0?et:-et),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(s,r),o=0):n!==l&&d>=me&&(Ce(a-n)<we&&(a-=n*we),Ce(s-l)<we&&(s-=l*we),r=Cl(a,r,s,i),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=s,r=i),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Cl(e,a,r,n){var o,s,i=Le(e-r);return Ce(i)>we?bl((Le(a)*(s=Te(n))*Le(r)-Le(n)*(o=Te(a))*Le(e))/(o*s*i)):(a+n)/2}function zl(e,a,r,n){var o;if(e==null)o=r*et,n.point(-me,o),n.point(0,o),n.point(me,o),n.point(me,0),n.point(me,-o),n.point(0,-o),n.point(-me,-o),n.point(-me,0),n.point(-me,o);else if(Ce(e[0]-a[0])>we){var s=e[0]<a[0]?me:-me;o=r*s/2,n.point(-s,o),n.point(0,o),n.point(s,o)}else n.point(a[0],a[1])}function Al(e){var a=Te(e),r=2*Ye,n=a>0,o=Ce(a)>we;function s(c,x,u,b){kl(b,e,r,u,c,x)}function i(c,x){return Te(c)*Te(x)>a}function l(c){var x,u,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(w,f){var y=[w,f],j,k=i(w,f),N=n?k?0:g(w,f):k?g(w+(w<0?me:-me),f):0;if(!x&&(m=b=k)&&c.lineStart(),k!==b&&(j=d(x,y),(!j||wa(x,j)||wa(y,j))&&(y[2]=1)),k!==b)v=0,k?(c.lineStart(),j=d(y,x),c.point(j[0],j[1])):(j=d(x,y),c.point(j[0],j[1],2),c.lineEnd()),x=j;else if(o&&x&&n^k){var S;!(N&u)&&(S=d(y,x,!0))&&(v=0,n?(c.lineStart(),c.point(S[0][0],S[0][1]),c.point(S[1][0],S[1][1]),c.lineEnd()):(c.point(S[1][0],S[1][1]),c.lineEnd(),c.lineStart(),c.point(S[0][0],S[0][1],3)))}k&&(!x||!wa(x,y))&&c.point(y[0],y[1]),x=y,b=k,u=N},lineEnd:function(){b&&c.lineEnd(),x=null},clean:function(){return v|(m&&b)<<1}}}function d(c,x,u){var b=It(c),m=It(x),v=[1,0,0],w=qa(b,m),f=ua(w,w),y=w[0],j=f-y*y;if(!j)return!u&&c;var k=a*f/j,N=-a*y/j,S=qa(v,w),C=ma(v,k),R=ma(w,N);Ya(C,R);var T=S,D=ua(C,T),F=ua(T,T),$=D*D-F*(ua(C,C)-1);if(!($<0)){var O=Lt($),I=ma(T,(-D-O)/F);if(Ya(I,C),I=dn(I),!u)return I;var h=c[0],q=x[0],U=c[1],X=x[1],E;q<h&&(E=h,h=q,q=E);var z=q-h,M=Ce(z-me)<we,B=M||z<we;if(!M&&X<U&&(E=U,U=X,X=E),B?M?U+X>0^I[1]<(Ce(I[0]-h)<we?U:X):U<=I[1]&&I[1]<=X:z>me^(h<=I[0]&&I[0]<=q)){var _=ma(T,(-D+O)/F);return Ya(_,C),[I,dn(_)]}}}function g(c,x){var u=n?e:me-e,b=0;return c<-u?b|=1:c>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return Eo(i,l,s,n?[0,-e]:[-me,e-me])}function ql(e,a,r,n,o,s){var i=e[0],l=e[1],d=a[0],g=a[1],c=0,x=1,u=d-i,b=g-l,m;if(m=r-i,!(!u&&m>0)){if(m/=u,u<0){if(m<c)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>c&&(c=m)}if(m=o-i,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>c&&(c=m)}else if(u>0){if(m<c)return;m<x&&(x=m)}if(m=n-l,!(!b&&m>0)){if(m/=b,b<0){if(m<c)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>c&&(c=m)}if(m=s-l,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>c&&(c=m)}else if(b>0){if(m<c)return;m<x&&(x=m)}return c>0&&(e[0]=i+c*u,e[1]=l+c*b),x<1&&(a[0]=i+x*u,a[1]=l+x*b),!0}}}}}var Gt=1e9,ha=-Gt;function Tl(e,a,r,n){function o(g,c){return e<=g&&g<=r&&a<=c&&c<=n}function s(g,c,x,u){var b=0,m=0;if(g==null||(b=i(g,x))!==(m=i(c,x))||d(g,c)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(c[0],c[1])}function i(g,c){return Ce(g[0]-e)<we?c>0?0:3:Ce(g[0]-r)<we?c>0?2:1:Ce(g[1]-a)<we?c>0?1:0:c>0?3:2}function l(g,c){return d(g.x,c.x)}function d(g,c){var x=i(g,1),u=i(c,1);return x!==u?x-u:x===0?c[1]-g[1]:x===1?g[0]-c[0]:x===2?g[1]-c[1]:c[0]-g[0]}return function(g){var c=g,x=jo(),u,b,m,v,w,f,y,j,k,N,S,C={point:R,lineStart:$,lineEnd:O,polygonStart:D,polygonEnd:F};function R(h,q){o(h,q)&&c.point(h,q)}function T(){for(var h=0,q=0,U=b.length;q<U;++q)for(var X=b[q],E=1,z=X.length,M=X[0],B,_,G=M[0],ue=M[1];E<z;++E)B=G,_=ue,M=X[E],G=M[0],ue=M[1],_<=n?ue>n&&(G-B)*(n-_)>(ue-_)*(e-B)&&++h:ue<=n&&(G-B)*(n-_)<(ue-_)*(e-B)&&--h;return h}function D(){c=x,u=[],b=[],S=!0}function F(){var h=T(),q=S&&h,U=(u=ko(u)).length;(q||U)&&(g.polygonStart(),q&&(g.lineStart(),s(null,null,1,g),g.lineEnd()),U&&No(u,l,h,s,g),g.polygonEnd()),c=g,u=b=m=null}function $(){C.point=I,b&&b.push(m=[]),N=!0,k=!1,y=j=NaN}function O(){u&&(I(v,w),f&&k&&x.rejoin(),u.push(x.result())),C.point=R,k&&c.lineEnd()}function I(h,q){var U=o(h,q);if(b&&m.push([h,q]),N)v=h,w=q,f=U,N=!1,U&&(c.lineStart(),c.point(h,q));else if(U&&k)c.point(h,q);else{var X=[y=Math.max(ha,Math.min(Gt,y)),j=Math.max(ha,Math.min(Gt,j))],E=[h=Math.max(ha,Math.min(Gt,h)),q=Math.max(ha,Math.min(Gt,q))];ql(X,E,e,a,r,n)?(k||(c.lineStart(),c.point(X[0],X[1])),c.point(E[0],E[1]),U||c.lineEnd(),S=!1):U&&(c.lineStart(),c.point(h,q),S=!1)}y=h,j=q,k=U}return C}}const mn=e=>e;var Ka=new qt,fn=new qt,So,Co,hn,gn,ft={point:tt,lineStart:tt,lineEnd:tt,polygonStart:function(){ft.lineStart=Ll,ft.lineEnd=Fl},polygonEnd:function(){ft.lineStart=ft.lineEnd=ft.point=tt,Ka.add(Ce(fn)),fn=new qt},result:function(){var e=Ka/2;return Ka=new qt,e}};function Ll(){ft.point=Rl}function Rl(e,a){ft.point=zo,So=hn=e,Co=gn=a}function zo(e,a){fn.add(gn*e-hn*a),hn=e,gn=a}function Fl(){zo(So,Co)}var Pt=1/0,Ta=Pt,na=-Pt,La=na,Ra={point:Ol,lineStart:tt,lineEnd:tt,polygonStart:tt,polygonEnd:tt,result:function(){var e=[[Pt,Ta],[na,La]];return na=La=-(Ta=Pt=1/0),e}};function Ol(e,a){e<Pt&&(Pt=e),e>na&&(na=e),a<Ta&&(Ta=a),a>La&&(La=a)}var xn=0,bn=0,Yt=0,Fa=0,Oa=0,Mt=0,vn=0,yn=0,Qt=0,Ao,qo,ct,pt,Ze={point:Tt,lineStart:zr,lineEnd:Ar,polygonStart:function(){Ze.lineStart=Il,Ze.lineEnd=Pl},polygonEnd:function(){Ze.point=Tt,Ze.lineStart=zr,Ze.lineEnd=Ar},result:function(){var e=Qt?[vn/Qt,yn/Qt]:Mt?[Fa/Mt,Oa/Mt]:Yt?[xn/Yt,bn/Yt]:[NaN,NaN];return xn=bn=Yt=Fa=Oa=Mt=vn=yn=Qt=0,e}};function Tt(e,a){xn+=e,bn+=a,++Yt}function zr(){Ze.point=Ml}function Ml(e,a){Ze.point=Dl,Tt(ct=e,pt=a)}function Dl(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Fa+=o*(ct+e)/2,Oa+=o*(pt+a)/2,Mt+=o,Tt(ct=e,pt=a)}function Ar(){Ze.point=Tt}function Il(){Ze.point=Bl}function Pl(){To(Ao,qo)}function Bl(e,a){Ze.point=To,Tt(Ao=ct=e,qo=pt=a)}function To(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Fa+=o*(ct+e)/2,Oa+=o*(pt+a)/2,Mt+=o,o=pt*e-ct*a,vn+=o*(ct+e),yn+=o*(pt+a),Qt+=o*3,Tt(ct=e,pt=a)}function Lo(e){this._context=e}Lo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,at);break}}},result:tt};var wn=new qt,Ja,Ro,Fo,Kt,Jt,ra={point:tt,lineStart:function(){ra.point=_l},lineEnd:function(){Ja&&Oo(Ro,Fo),ra.point=tt},polygonStart:function(){Ja=!0},polygonEnd:function(){Ja=null},result:function(){var e=+wn;return wn=new qt,e}};function _l(e,a){ra.point=Oo,Ro=Kt=e,Fo=Jt=a}function Oo(e,a){Kt-=e,Jt-=a,wn.add(Lt(Kt*Kt+Jt*Jt)),Kt=e,Jt=a}let qr,Ma,Tr,Lr;class Rr{constructor(a){this._append=a==null?Mo:$l(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Tr||this._append!==Ma){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Tr=n,Ma=this._append,Lr=this._,this._=o}this._+=Lr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Mo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function $l(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Mo;if(a!==qr){const r=10**a;qr=a,Ma=function(o){let s=1;this._+=o[0];for(const i=o.length;s<i;++s)this._+=Math.round(arguments[s]*r)/r+o[s]}}return Ma}function Ul(e,a){let r=3,n=4.5,o,s;function i(l){return l&&(typeof n=="function"&&s.pointRadius(+n.apply(this,arguments)),Ot(l,o(s))),s.result()}return i.area=function(l){return Ot(l,o(ft)),ft.result()},i.measure=function(l){return Ot(l,o(ra)),ra.result()},i.bounds=function(l){return Ot(l,o(Ra)),Ra.result()},i.centroid=function(l){return Ot(l,o(Ze)),Ze.result()},i.projection=function(l){return arguments.length?(o=l==null?(e=null,mn):(e=l).stream,i):e},i.context=function(l){return arguments.length?(s=l==null?(a=null,new Rr(r)):new Lo(a=l),typeof n!="function"&&s.pointRadius(n),i):a},i.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(s.pointRadius(+l),+l),i):n},i.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const d=Math.floor(l);if(!(d>=0))throw new RangeError(`invalid digits: ${l}`);r=d}return a===null&&(s=new Rr(r)),i},i.projection(e).digits(r).context(a)}function Tn(e){return function(a){var r=new kn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function kn(){}kn.prototype={constructor:kn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ln(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ot(r,e.stream(Ra)),a(Ra.result()),n!=null&&e.clipExtent(n),e}function Do(e,a,r){return Ln(e,function(n){var o=a[1][0]-a[0][0],s=a[1][1]-a[0][1],i=Math.min(o/(n[1][0]-n[0][0]),s/(n[1][1]-n[0][1])),l=+a[0][0]+(o-i*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(s-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,d])},r)}function Hl(e,a,r){return Do(e,[[0,0],a],r)}function Vl(e,a,r){return Ln(e,function(n){var o=+a,s=o/(n[1][0]-n[0][0]),i=(o-s*(n[1][0]+n[0][0]))/2,l=-s*n[0][1];e.scale(150*s).translate([i,l])},r)}function Wl(e,a,r){return Ln(e,function(n){var o=+a,s=o/(n[1][1]-n[0][1]),i=-s*n[0][0],l=(o-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([i,l])},r)}var Fr=16,Gl=Te(30*Ye);function Or(e,a){return+a?Ql(e,a):Yl(e)}function Yl(e){return Tn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Ql(e,a){function r(n,o,s,i,l,d,g,c,x,u,b,m,v,w){var f=g-n,y=c-o,j=f*f+y*y;if(j>4*a&&v--){var k=i+u,N=l+b,S=d+m,C=Lt(k*k+N*N+S*S),R=aa(S/=C),T=Ce(Ce(S)-1)<we||Ce(s-x)<we?(s+x)/2:ta(N,k),D=e(T,R),F=D[0],$=D[1],O=F-n,I=$-o,h=y*O-f*I;(h*h/j>a||Ce((f*O+y*I)/j-.5)>.3||i*u+l*b+d*m<Gl)&&(r(n,o,s,i,l,d,F,$,T,k/=C,N/=C,S,v,w),w.point(F,$),r(F,$,T,k,N,S,g,c,x,u,b,m,v,w))}}return function(n){var o,s,i,l,d,g,c,x,u,b,m,v,w={point:f,lineStart:y,lineEnd:k,polygonStart:function(){n.polygonStart(),w.lineStart=N},polygonEnd:function(){n.polygonEnd(),w.lineStart=y}};function f(R,T){R=e(R,T),n.point(R[0],R[1])}function y(){x=NaN,w.point=j,n.lineStart()}function j(R,T){var D=It([R,T]),F=e(R,T);r(x,u,c,b,m,v,x=F[0],u=F[1],c=R,b=D[0],m=D[1],v=D[2],Fr,n),n.point(x,u)}function k(){w.point=f,n.lineEnd()}function N(){y(),w.point=S,w.lineEnd=C}function S(R,T){j(o=R,T),s=x,i=u,l=b,d=m,g=v,w.point=j}function C(){r(x,u,c,b,m,v,s,i,o,l,d,g,Fr,n),w.lineEnd=k,k()}return w}}var Kl=Tn({point:function(e,a){this.stream.point(e*Ye,a*Ye)}});function Jl(e){return Tn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Xl(e,a,r,n,o){function s(i,l){return i*=n,l*=o,[a+e*i,r-e*l]}return s.invert=function(i,l){return[(i-a)/e*n,(r-l)/e*o]},s}function Mr(e,a,r,n,o,s){if(!s)return Xl(e,a,r,n,o);var i=Te(s),l=Le(s),d=i*e,g=l*e,c=i/e,x=l/e,u=(l*r-i*a)/e,b=(l*a+i*r)/e;function m(v,w){return v*=n,w*=o,[d*v-g*w+a,r-g*v-d*w]}return m.invert=function(v,w){return[n*(c*v-x*w+u),o*(b-x*v-c*w)]},m}function Zl(e){return ed(function(){return e})()}function ed(e){var a,r=150,n=480,o=250,s=0,i=0,l=0,d=0,g=0,c,x=0,u=1,b=1,m=null,v=Cr,w=null,f,y,j,k=mn,N=.5,S,C,R,T,D;function F(h){return R(h[0]*Ye,h[1]*Ye)}function $(h){return h=R.invert(h[0],h[1]),h&&[h[0]*mt,h[1]*mt]}F.stream=function(h){return T&&D===h?T:T=Kl(Jl(c)(v(S(k(D=h)))))},F.preclip=function(h){return arguments.length?(v=h,m=void 0,I()):v},F.postclip=function(h){return arguments.length?(k=h,w=f=y=j=null,I()):k},F.clipAngle=function(h){return arguments.length?(v=+h?Al(m=h*Ye):(m=null,Cr),I()):m*mt},F.clipExtent=function(h){return arguments.length?(k=h==null?(w=f=y=j=null,mn):Tl(w=+h[0][0],f=+h[0][1],y=+h[1][0],j=+h[1][1]),I()):w==null?null:[[w,f],[y,j]]},F.scale=function(h){return arguments.length?(r=+h,O()):r},F.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],O()):[n,o]},F.center=function(h){return arguments.length?(s=h[0]%360*Ye,i=h[1]%360*Ye,O()):[s*mt,i*mt]},F.rotate=function(h){return arguments.length?(l=h[0]%360*Ye,d=h[1]%360*Ye,g=h.length>2?h[2]%360*Ye:0,O()):[l*mt,d*mt,g*mt]},F.angle=function(h){return arguments.length?(x=h%360*Ye,O()):x*mt},F.reflectX=function(h){return arguments.length?(u=h?-1:1,O()):u<0},F.reflectY=function(h){return arguments.length?(b=h?-1:1,O()):b<0},F.precision=function(h){return arguments.length?(S=Or(C,N=h*h),I()):Lt(N)},F.fitExtent=function(h,q){return Do(F,h,q)},F.fitSize=function(h,q){return Hl(F,h,q)},F.fitWidth=function(h,q){return Vl(F,h,q)},F.fitHeight=function(h,q){return Wl(F,h,q)};function O(){var h=Mr(r,0,0,u,b,x).apply(null,a(s,i)),q=Mr(r,n-h[0],o-h[1],u,b,x);return c=wl(l,d,g),C=pn(a,q),R=pn(c,C),S=Or(C,N),I()}function I(){return T=D=null,F}return function(){return a=e.apply(this,arguments),F.invert=a.invert&&$,O()}}function Io(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Io.invert=function(e,a){var r=a,n=25,o;do{var s=r*r,i=s*s;r-=o=(r*(1.007226+s*(.015085+i*(-.044475+.028874*s-.005916*i)))-a)/(1.007226+s*(.015085*3+i*(-.044475*7+.028874*9*s-.005916*11*i)))}while(Ce(o)>we&&--n>0);return[e/(.8707+(s=r*r)*(-.131979+s*(-.013791+s*s*s*(.003971-.001529*s)))),r]};function td(){return Zl(Io).scale(175.295)}function ad(e){return e}function nd(e){if(e==null)return ad;var a,r,n=e.scale[0],o=e.scale[1],s=e.translate[0],i=e.translate[1];return function(l,d){d||(a=r=0);var g=2,c=l.length,x=new Array(c);for(x[0]=(a+=l[0])*n+s,x[1]=(r+=l[1])*o+i;g<c;)x[g]=l[g],++g;return x}}function rd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function od(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Dr(e,r)})}:Dr(e,a)}function Dr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,s=sd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:s}:n==null?{type:"Feature",id:r,properties:o,geometry:s}:{type:"Feature",id:r,bbox:n,properties:o,geometry:s}}function sd(e,a){var r=nd(e.transform),n=e.arcs;function o(c,x){x.length&&x.pop();for(var u=n[c<0?~c:c],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));c<0&&rd(x,m)}function s(c){return r(c)}function i(c){for(var x=[],u=0,b=c.length;u<b;++u)o(c[u],x);return x.length<2&&x.push(x[0]),x}function l(c){for(var x=i(c);x.length<4;)x.push(x[0]);return x}function d(c){return c.map(l)}function g(c){var x=c.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:c.geometries.map(g)};case"Point":u=s(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(s);break;case"LineString":u=i(c.arcs);break;case"MultiLineString":u=c.arcs.map(i);break;case"Polygon":u=d(c.arcs);break;case"MultiPolygon":u=c.arcs.map(d);break;default:return null}return{type:x,coordinates:u}}return g(a)}const Po={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},id=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ld(e,a,r){const n=Po[e];if(!n||!n.length)return-1;const o=id(a||"");if(o){for(let s=0;s<n.length;s++)if(n[s].k.some(i=>o.includes(i)))return s}return Math.floor(r*n.length)%n.length}let ga=null;function dd(){return ga||(ga=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=od(r,n),s=td().fitExtent([[8,8],[992,492]],{type:"Sphere"}),i=Ul(s),l=(o.features||[]).filter(c=>{var x;return(((x=c.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(c=>{var b;const x=((b=c.properties)==null?void 0:b.name)||"",u=i(c)||"";return u?{i2:qs(x)||null,n:x,d:u}:null}).filter(c=>!!c);if(!l.length)return null;const d={};for(const[c,x]of Object.entries(Ts)){const u=s(x);u&&(d[c]={x:u[0],y:u[1]})}const g={};for(const[c,x]of Object.entries(Po)){const u=x.map(b=>s(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(g[c]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:d,metros:g}}catch{return null}})(),ga)}function cd(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return dd().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const pd="8 40 984 210",ud={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Ir=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Pr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function md(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,s=0;const i=()=>{var g;if(!o)return;const d=(g=e.current)==null?void 0:g.getScreenCTM();d&&d.a>0?n(d.a):s=requestAnimationFrame(i)};i();const l=new ResizeObserver(()=>i());return e.current&&l.observe(e.current),window.addEventListener("resize",i),()=>{o=!1,cancelAnimationFrame(s),l.disconnect(),window.removeEventListener("resize",i)}},[e,a]),r}function Br({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(s=>s+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,s],i)=>t.jsx("i",{style:{left:o+"%",top:s+"%","--d":i*.18+"s"}},i)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function fd(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:s,byId:i,lang:l,t:d,data:g,dossiers:c,source:x}=V(),u=g.loading&&!c.length,b=p.useRef(null),m=p.useRef(null),v=cd(e.continent==="monde"),w=e.continent==="monde"?v:Sn.find(h=>h.key===e.continent)||null,f=md(b,e.continent+":"+e.mapFolded+":"+!!w),[y,j]=p.useState(new Map),[k,N]=p.useState(null);p.useEffect(()=>{const h=b.current;if(!h)return;const q=new Map;h.querySelectorAll("path[data-i2]").forEach(U=>{const X=U.dataset.i2;if(X)try{const E=U.getBBox();E.width>0&&q.set(X,{x:E.x,y:E.y,w:E.width,h:E.height})}catch{}}),j(q)},[e.continent,f,w]);const S=p.useMemo(()=>r.filter(h=>h.cc),[r]),C=p.useMemo(()=>{const h=new Map;return S.forEach(q=>h.set(q.cc,(h.get(q.cc)||0)+1)),h},[S]),R=e.continent==="monde"&&v?v.anchors:null,T=e.continent==="monde"&&v?v.metros:null,D=p.useMemo(()=>S.map(h=>{const q=Pr(h.name||h.id||""),U=Pr((h.id||h.name||"")+"·y");if(R&&h.cc){const B=T?T[h.cc]:void 0;if(B&&B.length){const G=ld(h.cc,h.city,q);if(G>=0&&B[G])return{d:h,x:B[G].x+(q-.5)*5,y:B[G].y+(U-.5)*5}}const _=R[h.cc];if(_)return{d:h,x:_.x+(q-.5)*10,y:_.y+(U-.5)*10}}const X=h.cc?y.get(h.cc):void 0;if(!X)return null;const E=ud[`${e.continent}:${h.cc||""}`];if(E)return{d:h,x:X.x+X.w*(E.fx+(q-.5)*E.sx),y:X.y+X.h*(E.fy+(U-.5)*E.sy)};const z=(q-.5)*Math.min(X.w*.55,60),M=(U-.5)*Math.min(X.h*.55,60);return{d:h,x:X.x+X.w/2+z,y:X.y+X.h/2+M}}).filter(h=>!!h),[S,y,R,T,e.continent]),F=h=>f>0?h/f:h,$=p.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:Ir[h],fr:d.plabels[h].toUpperCase(),en:d.plabels[h].toUpperCase(),n:r.filter(q=>q.kind==="target"&&Ne(q)===h).length})).filter(h=>h.n>0):Vn.map((h,q)=>({...h,n:r.filter(U=>Wn(U)===q).length})),[r,n,d.plabels]),O=s?i.get(s):null,I=O?D.find(h=>h.d.id===O.id):null;return w?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Br,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?pd:w.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?w.fr:w.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:w.countries.map((h,q)=>t.jsx("g",{className:"ct"+(h.i2&&C.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},q))}),t.jsx("g",{children:D.map(h=>{const q=Vn[Wn(h.d)],U=!!Oe(h.d),X=h.d.kind==="target",E=n&&X?Ir[Ne(h.d)]:q.c,z=!n&&Ie(h.d);return t.jsxs("g",{className:"co"+(z?" done":""),onMouseEnter:()=>{var _,G;const M=(_=m.current)==null?void 0:_.getBoundingClientRect(),B=(G=b.current)==null?void 0:G.createSVGPoint();if(B&&b.current&&M){B.x=h.x,B.y=h.y;const ue=B.matrixTransform(b.current.getScreenCTM());N({x:ue.x-M.left,y:ue.y-M.top,label:h.d.name+" · "+($t(h.d.cc,l)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var _;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const M=(_=b.current)==null?void 0:_.createSVGPoint();let B=null;if(M&&b.current){M.x=h.x,M.y=h.y;const G=M.matrixTransform(b.current.getScreenCTM());B={x:G.x,y:G.y}}a({type:"popup",id:h.d.id,anchor:B})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:F(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:F(q.px),fill:E,stroke:U?"#DC2626":"#ffffff",strokeWidth:F(U?2.2:1.3)})]},h.d.id||h.d.name)})}),I&&t.jsx("circle",{className:"ring on",cx:I.x,cy:I.y,r:F(13),fill:"none",stroke:"#0F172A",strokeWidth:F(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:$.map((h,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),l==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},q))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Br,{msgs:d.loadMsgs})})}function hd(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],s=Number(r[3]);return a==="en"?`${o} ${s}, ${r[1]}`:`${s} ${o} ${r[1]}`}function Bo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:s,contName:i,lang:l}=V(),d=a.filters,[g,c]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null),m=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(I=>I.continent===a.continent),[n,a.continent]),w=I=>v.filter(h=>I!=="country"&&d.country.length&&!d.country.includes(h.cc||"")?!1:Ca(h,d,s,I==="country"?void 0:I)),f=I=>!s||I.kind!=="op",y=p.useMemo(()=>{const I=w("win").filter(f),h=q=>I.filter(U=>(U.date?Math.max(0,Math.floor((Date.now()-Date.parse(U.date))/864e5)):9999)<=q).length;return[h(0),h(7),h(30),I.length]},[v,d,s]),j=p.useMemo(()=>d.day?w("win").filter(f).filter(I=>(I.date||"").slice(0,10)===d.day).length:0,[v,d,s]),k=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length+d.crible.length,N=k+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!g&&!x)return;const I=q=>{var X,E;const U=q.target;g&&!((X=b.current)!=null&&X.contains(U))&&c(!1),x&&!((E=m.current)!=null&&E.contains(U))&&u(!1)},h=q=>{q.key==="Escape"&&(c(!1),u(!1))};return document.addEventListener("mousedown",I),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",I),document.removeEventListener("keydown",h)}},[g,x]);const S=(I,h,q,U="fbtn")=>t.jsxs("button",{type:"button",className:U,"aria-expanded":a.openFacet===I,onClick:()=>r({type:"openFacet",facet:I}),children:[t.jsx("span",{className:"fl",children:h}),q>0&&t.jsx("span",{className:"n",children:q}),t.jsx("span",{className:"cv",children:"▾"})]},I),C=["1","7","30","all"],R=Math.max(0,C.indexOf(d.win||"all")),T=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(hd(d.day,l))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(I=>!I),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[R]}),t.jsx("b",{children:y[R]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((I,h)=>t.jsxs("button",{type:"button",role:"option","aria-selected":d.win===I,onClick:()=>{r({type:"filters",patch:{win:I}}),u(!1)},children:[o.datesShort[h],t.jsx("span",{className:"n",children:y[h]})]},I))})]}):t.jsx("div",{className:"seg",children:C.map((I,h)=>t.jsxs("button",{type:"button","aria-pressed":d.win===I,onClick:()=>r({type:"filters",patch:{win:I}}),children:[t.jsx("span",{className:"sl",children:o.dates[h]}),t.jsx("b",{children:y[h]})]},I))}),D=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:d.search,onChange:I=>r({type:"filters",patch:{search:I.target.value}})})]}),F=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):S("sec",o.fSector,d.sector.length),S("pay",o.fCountry,d.country.length),S("det",o.fEngine,d.engine.length),S("sta",o.fStage,d.stage.length),s&&S("crib",o.fVerdict,d.crible.length),s&&S("ang","Angle",d.angle.length),s&&S("mem","Mémo",d.memoLevel.length)]}),$=(I=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,i),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),I&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),O=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{c(I=>!I),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:F})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(d.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:T}),t.jsxs("div",{className:"fstrip-b",children:[D,O,$(!1)]})]}),a.openFacet&&t.jsx(_r,{poolFor:w})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[T,D,F,t.jsx("span",{className:"fgrow"}),$()]}),a.openFacet&&t.jsx(_r,{poolFor:w})]})}function _r({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:s,data:i}=V(),l=a.filters,d=a.openFacet,{title:g,cols:c,options:x}=p.useMemo(()=>{if(d==="sig"){const w=e("signal").filter(j=>Oe(j)),f=new Map;w.forEach(j=>{const k=j.engine||"";f.set(k,(f.get(k)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:w.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...rn([...f.keys()],o).map(j=>({v:j,label:At(j)+" "+Qe(j,o),n:f.get(j)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(d==="crib"){const w=e("crible").filter(y=>!s||to(y,a.ptab,i.favIds)),f=new Map;return w.forEach(y=>{const j=ao(y);j&&j!=="NEW"&&f.set(j,(f.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((y,j)=>(Gn[y[0]]??9)-(Gn[j[0]]??9)||j[1]-y[1]).map(([y,j])=>({v:y,label:'<span class="fdot" style="background:'+(Ls[y]||"#94A3B8")+'"></span>'+y,n:j,html:!0,on:l.crible.includes(y)}))}}if(d==="sec"){const w=e("sector"),f=new Map;return w.forEach(y=>{y.sector&&f.set(y.sector,(f.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...f.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:y,n:j,html:!1,on:l.sector.includes(y)}))}}if(d==="pay"){const w=e("country"),f=new Map;return w.forEach(y=>{y.cc&&f.set(y.cc,(f.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...f.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:$t(y,o)||y,n:j,html:!1,on:l.country.includes(y)}))}}if(d==="det"){const w=e("engine"),f=new Map;return w.forEach(y=>{y.engine&&f.set(y.engine,(f.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:rn([...f.keys()],o).map(y=>({v:y,label:At(y)+" "+Qe(y,o)+' <span style="color:var(--dim);font-size:10px">· '+Rs(Fs(y),o)+"</span>",n:f.get(y)||0,html:!0,on:l.engine.includes(y)}))}}if(d==="ang"){const w=e("angle"),f=new Map;return w.forEach(y=>{y.angle&&f.set(y.angle,(f.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:y.replace(/[_-]+/g," "),n:j,html:!1,on:l.angle.includes(y)}))}}if(d==="mem"){const w=e("memoLevel"),f=new Map;w.forEach(j=>{if(j.kind==="target"){const k=Nn(j);f.set(k,(f.get(k)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:y[j],n:f.get(j)||0,html:!1,on:l.memoLevel.includes(j)}))}}const m=e("stage"),v=new Map;return m.forEach(w=>{w.stage&&v.set(w.stage,(v.get(w.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((w,f)=>f[1]-w[1]).map(([w,f])=>({v:w,label:w,n:f,html:!1,on:l.stage.includes(w)}))}},[d,a,o]),u=m=>{if(d==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const w=l.signalEngines.includes(m)?l.signalEngines.filter(f=>f!==m):[...l.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:w}})}return}if(d==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":d==="crib"?"crible":"stage",value:m})},b=()=>{r(d==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:d==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":d==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:g}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:x.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>u(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function _o({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:s,lang:i,t:l}=V(),d=p.useMemo(()=>{const b={};return r.forEach(m=>{Ca(m,n.filters,s)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,s]),[g,c]=p.useState(!1),x=p.useRef(null);p.useEffect(()=>{if(!g)return;const b=v=>{var w;(w=x.current)!=null&&w.contains(v.target)||c(!1)},m=v=>{v.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const u=b=>{const m=Sn.find(v=>v.key===b);return b==="monde"?l.contWorld:i==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:d[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Yn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:d[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[Yn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:d[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function jn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function $o(e){return"atl2:evalq:"+(e||"anon")}function gd(e,a){const r=$o(e),n=jn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),s=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!s.length)return 0;const i=[...n,...s].slice(0,30);try{localStorage.setItem(r,JSON.stringify(i)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return s.length}function Uo(){const{t:e,data:a,dossiers:r}=V(),n=a.session.token||"",o=$o(n),[s,i]=p.useState(()=>jn(o)),l=p.useRef(!1),[d,g]=p.useState(!1);p.useEffect(()=>{try{const E=s.slice(0,30).map(({descBusy:z,evalBusy:M,...B})=>B);localStorage.setItem(o,JSON.stringify(E)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[s,o]),p.useEffect(()=>{const E=()=>{if(l.current)return;const z=jn(o);i(M=>JSON.stringify(M.map(({descBusy:B,evalBusy:_,...G})=>G))===JSON.stringify(z)?M:z)};return window.addEventListener("atl2:evalq",E),window.addEventListener("storage",E),()=>{window.removeEventListener("atl2:evalq",E),window.removeEventListener("storage",E)}},[o]);const[c,x]=p.useState([]),[u,b]=p.useState(""),[m,v]=p.useState(!1),[w,f]=p.useState(!1),[y,j]=p.useState(""),k=p.useCallback((E,z)=>i(M=>M.map((B,_)=>_===E?{...B,...z}:B)),[]),N=p.useCallback((E,z)=>{const M=z.trim();M&&(k(E,{name:M,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Cn(M).then(B=>{const _=B.candidates||[];B.website?k(E,{site:B.website,status:"ready"}):_.length===1?k(E,{site:_[0].url,status:"ready"}):_.length>1?k(E,{status:"pick",candidates:_.slice(0,4)}):k(E,{status:"ready"})}).catch(()=>k(E,{status:"ready"})))},[k]),S=p.useCallback((E,z,M)=>{k(E,{descBusy:!0}),oo(n,z,M).then(B=>{if(B.quota){g(!0),k(E,{descBusy:!1,descDone:!0});return}const _=B.blocs||{},G=(_.synthese||_.value_prop||_.produit||_.modele||"").trim();k(E,{descBusy:!1,descDone:!0,desc:G})}).catch(()=>k(E,{descBusy:!1,descDone:!0}))},[k,n]);p.useEffect(()=>{const E=s.findIndex(M=>M.auto&&M.name.trim()&&M.status==="");if(E>=0){N(E,s[E].name);return}if(d)return;const z=s.findIndex(M=>M.status==="ready"&&M.site&&!M.descDone&&!M.descBusy);z>=0&&S(z,s[z].name,s[z].site)},[s,N,S,d]);const[C,R]=p.useState(!1),T=p.useCallback(async(E,z)=>{k(E,{evalBusy:!0});const M=await so(n,(z.site||z.name).trim(),"atelier2");return M.verdict==="quota"?(k(E,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:M.reason||"",remaining:0}})),!1):(k(E,{evalBusy:!1,status:M.verdict==="kept"?"kept":"out",reason:M.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:M.company||z.name,verdict:M.verdict,reason:M.reason||"",remaining:M.remaining??null}})),!0)},[k,n]),D=async()=>{if(C)return;const E=s.map((z,M)=>({r:z,i:M})).filter(({r:z})=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving");if(E.length){R(!0);for(const{r:z,i:M}of E)if(!await T(M,z))break;R(!1)}},F=p.useMemo(()=>{const E=new Set,z=[];return s.filter(M=>M.status==="kept").forEach(M=>{const B=M.name.trim().toLowerCase();B&&!E.has(B)&&(E.add(B),z.push(M.name.trim()))}),r.filter(M=>Ne(M)>=1&&Ne(M)<=4&&(M.website||M.domain)).forEach(M=>{const B=(M.name||"").trim().toLowerCase();B&&!E.has(B)&&(E.add(B),z.push((M.name||"").trim()))}),z},[s,r]),$=p.useMemo(()=>{const E=new Set;return r.forEach(z=>{const M=(z.name||"").trim().toLowerCase();M&&E.add(M)}),s.forEach(z=>{const M=z.name.trim().toLowerCase();M&&E.add(M)}),E},[r,s]),O=async()=>{if(u||!F.length)return;f(!1);const E=[];for(const z of F.slice(0,2)){b(z);const M=await io(n,z);if(M){if(M.verdict==="quota"){v(!0);break}(M.results||[]).forEach(B=>{const _=(B.company||"").trim().toLowerCase();!_||$.has(_)||E.some(G=>G.name.toLowerCase()===_)||E.push({name:(B.company||"").trim(),verdict:B.verdict||"",reason:B.reason,from:z})})}}b(""),f(!0),x(z=>[...E,...z].slice(0,24))},I=async(E,z)=>{if(u)return;f(!1),b(E==="thesis"?e.pxThesis:z);const M=await Os(n,E,z,6);if(b(""),f(!0),!M)return;if(M.verdict==="quota"){v(!0);return}const B=[];(M.results||[]).forEach(_=>{const G=(_.company||"").trim().toLowerCase();!G||$.has(G)||B.some(ue=>ue.name.toLowerCase()===G)||B.push({name:(_.company||"").trim(),verdict:_.verdict||"",reason:_.reason,from:E==="thesis"?e.pxThesis:z})}),x(_=>[...B,..._].slice(0,24))},h=()=>{const E=y.trim();E.length<3||I(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(E)?"registry":"keyword",E)},q=E=>{i(z=>[...z,{name:E.name,site:"",status:"",auto:!0}].slice(0,30)),x(z=>z.filter(M=>M.name!==E.name))},U=s.filter(E=>E.name.trim()&&E.status!=="kept"&&E.status!=="out").length,X=E=>E.name.trim()&&E.status!=="kept"&&E.status!=="out"&&E.status!=="resolving"&&!E.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),s.map((E,z)=>t.jsxs("div",{className:"eq-row"+(E.status==="kept"?" r-kept":E.status==="out"?" r-out":""),children:[t.jsx("input",{value:E.name,placeholder:e.eqNamePh,onChange:M=>{const B=M.target.value.split(`
`).map(_=>_.trim()).filter(Boolean);B.length>1?i(_=>{const G=[..._];return G.splice(z,1,...B.map(ue=>({name:ue,site:"",status:"",auto:!0}))),G.slice(0,30)}):k(z,{name:M.target.value})},onBlur:()=>{E.name.trim()&&!E.site&&E.status!=="resolving"&&E.status!=="pick"&&N(z,E.name)},onKeyDown:M=>{M.key==="Enter"&&N(z,E.name)}}),t.jsxs("span",{className:"eq-site",children:[E.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),E.status==="pick"&&(E.candidates||[]).map(M=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>k(z,{site:M.url,status:"ready",candidates:void 0}),children:(M.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},M.url)),E.status!=="resolving"&&E.status!=="pick"&&(E.site?t.jsxs("a",{href:E.site.startsWith("http")?E.site:"https://"+E.site,target:"_blank",rel:"nofollow noopener",children:[E.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:E.name.trim()&&E.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:E.desc||"",children:E.descBusy?t.jsx("i",{children:e.eqDescBusy}):E.desc?E.desc:t.jsx("em",{children:E.descDone?d?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(E.status||"vide"),title:E.reason||"",children:E.status==="kept"?"✓ "+e.kept:E.status==="out"?"✗ "+e.dropped:E.status==="ready"?e.eqReady:E.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!X(E)||C,onClick:()=>{T(z,E)},children:E.evalBusy?"⏳":"⚡"}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>i(M=>M.filter((B,_)=>_!==z)),children:"×"})]},z)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>i(E=>[...E,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]}),t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!u,onClick:()=>{I("thesis","")},children:u===e.pxThesis?e.sgBusy(u):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:y,placeholder:e.pxPlace,onChange:E=>j(E.target.value),onKeyDown:E=>{E.key==="Enter"&&h()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u||y.trim().length<3,onClick:h,children:e.pxGoFree}),!!F.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u,onClick:()=>{O()},children:u&&u!==e.pxThesis&&u!==y?e.sgBusy(u):e.sgGo}),!!F.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(F[0],F.length)}),m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),w&&!c.length&&!m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),c.map(E=>t.jsxs("span",{className:"eq-sc"+(E.verdict==="kept"?" ok":""),title:(E.reason||"")+" — "+e.sgVia(E.from),children:[t.jsx("b",{children:E.name}),E.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>q(E),children:"+"})]},E.name))]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(C?" loading":""),style:{justifyContent:"center"},disabled:C||!U,onClick:()=>{D()},children:[t.jsx("span",{className:"fill"}),C?e.eqRunning:e.eqGo(U)]}),t.jsx("span",{className:"hint",children:e.eqHint}),s.some(E=>E.status==="kept"||E.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>i(E=>E.filter(z=>z.status!=="kept"&&z.status!=="out")),children:e.eqClearDone})]})]})}function Ho(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function xd(e){var o;const a=[],r=new Set,n=s=>{const i=(s||"").trim();!i||r.has(i.toLowerCase())||(r.add(i.toLowerCase()),a.push(i))};return((e==null?void 0:e.companies_cited)||[]).forEach(s=>n(s==null?void 0:s.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(s=>n(s==null?void 0:s.name)),a}function $r({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:s,onAddAll:i}){const{t:l}=V();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),i&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>i(n.map(d=>d.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>s(d.name),children:l.rsEvalOne})]},d.name))})]}):null}function Vo({card:e,onEvaluate:a,onAddAll:r}){var i;const{t:n}=V(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),s=(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!s.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx($r,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx($r,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:s,addLabel:n.rsAddAll(s.length),onEvaluate:a,onAddAll:r})]})}function bd({card:e,onEvaluate:a,onAddAll:r}){var l,d,g;const{t:n}=V(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),s=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),i=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ho(e.summary_md||"").map((c,x)=>t.jsx("p",{children:c},x))})]}),t.jsx(Vo,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||s.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:s.map(c=>t.jsx("li",{children:c},c))})]})]}),i.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:i.length})]}),t.jsx("div",{className:"rssrc",children:i.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function vd(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function yd({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:s,email:i}=V(),l=o,[d,g]=p.useState(null),[c,x]=p.useState(null),[u,b]=p.useState(null),[m,v]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const y=await lo({email:i,cbToken:l});f&&g(y)})(),()=>{f=!1}},[i,l,n]);const w=f=>{x(f),b(null),v(!0),(async()=>{const y=await Ms(f.id);b(y),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:s.rsArchBack}):t.jsxs("b",{children:["🗂 ",s.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:s.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:s.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:s.rsArchEmpty}),(d||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>w(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[vd(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:s.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?s.rsPub:s.rsPriv})]},f.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:s.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:s.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?s.rsPub:s.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:s.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:s.rsArchGone}),!m&&u&&t.jsx(bd,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ka=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Xt(e){return/^https?:\/\//i.test((e||"").trim())}function lt(e){const a=(e||"").trim();return a?Xt(a)?a:ka.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function wd(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function kd(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:s,dispatch:i,evalBusy:l,evalCards:d,caps:g,data:c,canWrite:x,source:u,dossiers:b,doAnalyse:m,liveMemos:v,pipe:w}=V(),f=a==="client",y=p.useMemo(()=>r||(u!=="default"?Ds():""),[r,u]),[j,k]=p.useState(""),[N,S]=p.useState(!1),[C,R]=p.useState(""),[T,D]=p.useState(""),[F,$]=p.useState(""),[O,I]=p.useState(!1),[h,q]=p.useState(!1),[U,X]=p.useState([]);p.useEffect(()=>{const P=ee=>{const se=ee.detail;se&&X(Z=>[se,...Z].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[E,z]=p.useState(!1),[M,B]=p.useState(!1),[_,G]=p.useState(!1),ue=p.useRef(!1),[K,ce]=p.useState(""),[le,be]=p.useState(""),[fe,de]=p.useState(!1),[pe,xe]=p.useState(!1),[Q,re]=p.useState(0),[he,ke]=p.useState(""),[ne,ve]=p.useState(null),[oe,ze]=p.useState(null),[Ke,ge]=p.useState(!1),[Se,Rt]=p.useState(null),[Pe,Je]=p.useState(0),qe=p.useRef(!1),st=j.trim()?ka.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),ee=(P.get("rs")||"").trim(),se=(P.get("rstext")||"").trim();ee&&/^https?:\/\//i.test(ee)&&ce(ee),se&&be(se),(ee&&/^https?:\/\//i.test(ee)||se)&&z(!0)},[]),p.useEffect(()=>{const P=ee=>{const se=ee.detail||{},Z=String(se.url||"").trim(),je=String(se.text||"").trim();Z&&/^https?:\/\//i.test(Z)&&ce(Z),je&&be(je),(Z&&/^https?:\/\//i.test(Z)||je)&&(z(!0),k(""),R(""),de(!0),window.setTimeout(()=>de(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),p.useEffect(()=>{const P=ee=>{const se=ee.detail||{},Z=String(se.name||"").trim();if(!Z)return;z(!1),k(Z),R(Z);const je=lt(String(se.website||se.domain||""));D(je),$(lt(String(se.url||""))),I(!je),S(!0),window.setTimeout(()=>S(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),p.useEffect(()=>{const P=(C||"").trim();if(!P||E||T){(T||!P||E)&&I(!1);return}const ee=b.find(je=>_e(je.name)===_e(P)),se=lt((ee==null?void 0:ee.website)||"")||lt((ee==null?void 0:ee.domain)||"");if(se){D(se),I(!1);return}let Z=!0;return I(!0),Cn(P).then(je=>{var $e,Ae;if(!Z)return;const De=lt(je.website||"")||lt(((Ae=($e=je.candidates)==null?void 0:$e[0])==null?void 0:Ae.url)||"");De&&D(De)}).catch(()=>{}).finally(()=>{Z&&I(!1)}),()=>{Z=!1}},[C,E,T,b]),p.useEffect(()=>{const P=ee=>{var Z;const se=String(((Z=ee.detail)==null?void 0:Z.url)||"").trim();Xt(se)&&window.open(se,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),p.useEffect(()=>{if(ue.current===E)return;ue.current=E,G(!0);const P=window.setTimeout(()=>G(!1),560);return()=>window.clearTimeout(P)},[E]),p.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ee=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!ee)return;const se=()=>ee.style.setProperty("--demand-h",`${P.offsetHeight}px`);se();const Z=new ResizeObserver(se);return Z.observe(P),()=>Z.disconnect()},[u,N,fe,h,E,_,O]),p.useEffect(()=>{if(!x&&!y){Rt(null);return}let P=!0;return(async()=>{const ee=await lo({email:n,cbToken:y});P&&Rt(ee.length)})(),()=>{P=!1}},[x,y,n,Pe]);const jt=U.length?U:d,Me=c.credits,xt=p.useCallback(P=>{gd(r,P)&&q(!0)},[r]);p.useEffect(()=>{if(!pe)return;re(0);const P=window.setInterval(()=>re(ee=>ee+1),1e3);return()=>window.clearInterval(P)},[pe]);const ut=p.useMemo(()=>{const P=j.trim().toLowerCase();return!P||!w?null:b.find(ee=>_e(ee.name)===P&&Ne(ee)===1)||null},[j,b,w]),Xe=()=>{const P=j.trim();if(P){if(ut){m(ut);return}o(null,P),f&&k("")}},Nt=async()=>{var se,Z,je;if(qe.current)return;const P=K.trim().replace(/\s+/g,""),ee=le.trim();if(!P&&!ee){ke(e.rsNeed);return}if(!f&&!y){o(null,P||ee.slice(0,80));return}qe.current=!0,ke(""),ve(null),ze(null),xe(!0);try{const De=await Ps({url:P,text:ee,email:n,cbToken:y});if(xe(!1),!De||De.status!=="success"){ke((De==null?void 0:De.message)||"Erreur");return}ve(De),z(!1),xt((((se=De.prospective)==null?void 0:se.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),ze({state:"pending"});const $e=await Bs(De,{email:n,cbToken:y});ze($e.ok?{state:"ok",scopeLabel:((Z=$e.summary)==null?void 0:Z.scope_label)||"",scope:((je=$e.summary)==null?void 0:je.scope)||""}:{state:"fail",msg:$e.error||""}),$e.ok&&Je(Ae=>Ae+1)}finally{qe.current=!1,xe(!1)}},bt=[ne==null?void 0:ne.industry,...(ne==null?void 0:ne.market_tags)||[],ne==null?void 0:ne.author].map(P=>(P||"").trim()).filter(Boolean),vt=(oe==null?void 0:oe.state)==="pending",Ft=oe&&(vt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):oe.state==="ok"?t.jsx("span",{className:"rslink ok",children:oe.scope&&oe.scope!=="public"?e.rsSavedIn(oe.scopeLabel||oe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:oe.msg,children:e.rsSaveFail})),Et=xd(ne).length,Re=E,nt=(C||j).trim(),L=b.find(P=>_e(P.name)===_e(nt)),H=lt(j)||T||lt((L==null?void 0:L.website)||"")||lt((L==null?void 0:L.domain)||""),Y=F||lt((L==null?void 0:L.url)||""),ae=ut?e.actAnalyse:nt?e.evalGoOn(nt.length>22?nt.slice(0,21)+"…":nt):e.evalGo,ye=pe?`${Is(K.trim())==="youtube"&&K.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Q)}`:vt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Re?" rs-mode":"")+(C&&j.trim()===C||N||fe?" pair":"")+(N||fe||_?" echo":"")+(_?" swap":""),children:[t.jsxs("div",{className:"drow"+((Re?fe:N)||_?" flash":"")+((Re?K.trim():ka.test(j.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Re?K:j,placeholder:Re?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Re?600:200,spellCheck:Re?!1:void 0,inputMode:Re?"url":void 0,onChange:P=>{if(Re){ce(P.target.value);return}k(P.target.value),C&&P.target.value.trim()!==C&&(R(""),D(""),$(""),I(!1))},onKeyDown:P=>{P.key==="Enter"&&(Re?Nt():Xe())}}),t.jsx("span",{className:"detect"+(Re?" off":"")+(ka.test(j.trim())?" url":""),children:st})]}),t.jsx("span",{className:"dacts",children:Re?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(pe?" loading":""),disabled:pe||vt||!K.trim()&&!le.trim(),onClick:()=>{Nt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ye})]}),t.jsxs("a",{className:"viewbtn"+(Xt(K)?"":" off"),href:Xt(K)?K.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{Xt(K)||P.preventDefault()},children:[t.jsx(wd,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ut?" analyse":"")+(l?" loading":""),disabled:l,onClick:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ae})]}),t.jsxs("a",{className:"viewbtn sm"+(O?" searching":H?"":" off"),href:H||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":O||void 0,title:O?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{H||P.preventDefault()},children:[O&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),O?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(Y?"":" off"),href:Y||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{Y||P.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&Me&&t.jsxs("button",{type:"button",className:"credits"+(Me.total_available<=0&&!Me.unlimited?" empty":""),onClick:()=>i({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Me.unlimited?"∞":Me.total_available}),!Me.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Me.daily_grant+Me.purchased]}),Me.total_available<=0&&!Me.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>q(!h),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(E?" on":""),onClick:()=>z(!E),children:e.rsOpen}),Se!==null&&Se>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Ke?" on":""),onClick:()=>ge(!Ke),children:e.rsArchOpen(Se)})]}),Ke&&t.jsx(yd,{bump:Pe,cbToken:y,onClose:()=>ge(!1),onEvaluate:P=>o(null,P),onAddAll:xt}),t.jsx("div",{className:"rsp slim"+(E?" on":" off"),"aria-hidden":!E,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:E?void 0:-1,onClick:()=>B(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:M?"▴":"▾"})]}),M&&t.jsx("textarea",{className:"rstext",value:le,placeholder:e.rsTextPh,tabIndex:E?void 0:-1,onChange:P=>be(P.target.value)})]})}),he&&t.jsx("div",{className:"rserr",children:he}),ne&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ne.title}),ne.source_url&&t.jsx("a",{href:ne.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ve(null),ze(null)},children:"×"})]}),ne.market&&t.jsx("p",{className:"rsmk",children:ne.market}),bt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),bt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[ne.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ne.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ho(ne.summary_md||"").map((P,ee)=>t.jsx("p",{children:P},ee))})]}),t.jsx(Vo,{card:ne,onEvaluate:P=>o(null,P),onAddAll:xt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Et)}),Ft]})]}),h&&t.jsx(Uo,{}),jt.slice(0,1).map((P,ee)=>{const se=P.verdict==="kept",Z=P.verdict==="quota",je=P.verdict==="unresolved",De=se?"var(--brand)":Z?"var(--bolt)":je?"var(--blue)":"var(--red)",$e=se?"var(--brand-l)":Z?"#FEF3C7":je?"#EEF4FF":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":De,"--bgc":$e},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:se?"✓ "+e.kept:Z?"⏳":je?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(Ae=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ae.url.startsWith("http")?Ae.url:`https://${Ae.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ae.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,Ae.url,P.name),children:e.evalPickGo})]},Ae.url))}),!Z&&!je&&t.jsx("button",{type:"button",className:"go",onClick:()=>{i({type:"ptab",tab:se?1:5});const Ae=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ue=[...document.querySelectorAll(".atl2 .list .row")].find(Pa=>{var la;return(((la=Pa.querySelector(".rnm"))==null?void 0:la.textContent)||"").trim().toLowerCase().includes(Ae)});Ue&&(Ue.scrollIntoView({behavior:"smooth",block:"center"}),Ue.classList.add("flashrow"),window.setTimeout(()=>Ue.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(se?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ee)}),f&&(s.kept+s.dropped>0||jt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(s.kept,s.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>i({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function jd(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Nd(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=V(),s=e.memoConsole?r.get(e.memoConsole):null,i=p.useMemo(()=>s?[s.reasoning||"",jd(s.summary||"")].filter(Boolean).join(`

`):"",[s]);if(!s)return null;const l=kt(s),d=Nn(s);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:s.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof s.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[s.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:i?i.split(`

`).map((g,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Dt(s)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(s),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),s.memoUrl&&t.jsx("a",{className:"go",href:s.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Rn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:s}=V(),[i,l]=p.useState(!1),[d,g]=p.useState(null),c=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!c||i)return;l(!0);const u=await io(r,e);if(l(!1),!u){s(a.actErr);return}g(u.results||[])};return p.useEffect(()=>{if(!c)return;const u=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,c]),p.useEffect(()=>{if(c)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,c]),c?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{x()},children:i?a.similarBusy:a.similar}),d&&(d.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:d.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Ed=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),xa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Sd(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=xa(a.slice(n));break}r+=xa(a.slice(n,o));const s=a.indexOf(">",o);if(s<0){r+=xa(a.slice(o));break}const i=a.slice(o+1,s).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(i),d=l?l[2].toLowerCase():"";l&&Ed.has(d)?r+=`<${l[1]}${d}>`:r+=xa(a.slice(o,s+1)),n=s+1}return r}const Cd=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),Ur={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function Wo(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(Cd.has(o)){n.remove();continue}for(const i of Array.from(n.attributes)){const l=i.name.toLowerCase();(!(Ur["*"].has(l)||((r=Ur[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(i.name)}const s=n.getAttribute("style")||"";if(s&&/position\s*:\s*(fixed|sticky)/i.test(s))n.removeAttribute("style");else if(s){const i=s.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");i!==s&&(i?n.setAttribute("style",i):n.removeAttribute("style"))}if(o==="a"){const i=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(i)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const i=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(i)){n.remove();continue}n.setAttribute("loading","lazy")}Wo(n)}}function Xa(e){const a=e.cloneNode(!0);return Wo(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Za=new Map;function zd(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=Za.get(a);return r||(r=Ad(a).catch(()=>null),r.then(n=>{n||Za.delete(a)}),Za.set(a,r)),r}async function Ad(e){var x,u;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=new DOMParser().parseFromString(await a.text(),"text/html"),n=b=>{var m;return(((m=r.querySelector(b))==null?void 0:m.textContent)||"").trim()},o=r.querySelector(".sb-score"),s=((x=Array.from((o==null?void 0:o.classList)||[]).find(b=>b.startsWith("sb-score-")))==null?void 0:x.slice(9))||"",i=[];let l=null;const d=Array.from(r.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const b of d){if(b.classList.contains("sb-nav-heading")){l={label:(b.textContent||"").trim(),items:[]},i.push(l);continue}const m=b.getAttribute("href")||"";if(!m.startsWith("#"))continue;const v=m.slice(1),w=qd(r,v);w&&(l||(l={label:"",items:[]},i.push(l)),l.items.push({id:v,title:(b.textContent||"").trim(),html:w,poids:w.length}))}const g=((u=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:u[1])||"",c={score:n(".sb-score"),scoreTone:s,tags:Array.from(r.querySelectorAll(".sb-tag")).map(b=>(b.textContent||"").trim()).filter(Boolean),name:n(".sidebar-company-name"),tagline:n(".sidebar-tagline"),desc:n(".meta-desc"),groups:i.filter(b=>b.items.length),mindmapSlug:r.querySelector(".cm-mindmap-png")?g:""};return c.groups.length?c:null}const Hr={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function qd(e,a){const r=e.getElementById(a),n=r?Vr(e,r):"";if(n)return n;const o=Hr[a]?e.querySelector(Hr[a]):null;return o&&o!==r?Vr(e,o):""}function Vr(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Xa(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),s=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(s.filter(d=>/^h3$/i.test(d.tagName))[0]===a)for(const d of s){if(d===a)break;/^h2$/i.test(d.tagName)||o.appendChild(d.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?Xa(o):""}return Xa(a)}const en=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ot({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Wr(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Gr({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const tn=new Map;function Td(e,a){const{token:r}=V(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const s=`${r}:${e.id}:${e.checkId||""}`;let i=tn.get(s);i||(i=_s(r,e.name,e.checkId),tn.set(s,i),i.then(d=>{(!d||!d.reasoning&&!d.summaryHtml)&&tn.delete(s)}));let l=!0;return i.then(d=>{l&&d&&o({id:e.id,d})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Ld=6e4;function Rd({o:e}){const{t:a,doDeep:r}=V(),[n,o]=p.useState(null),[s,i]=p.useState(e.memoUrl?"load":"off"),[l,d]=p.useState(()=>new Set),[g,c]=p.useState(!1),x=p.useRef(new Map);p.useEffect(()=>{let v=!0;if(d(new Set),c(!1),x.current=new Map,!e.memoUrl){i("off"),o(null);return}return i("load"),o(null),zd(e.memoUrl).then(w=>{v&&(o(w),i(w?"ok":"err"))}),()=>{v=!1}},[e.memoUrl]);const u=kt(e),b=v=>{var w;return(w=x.current.get(v))==null?void 0:w.scrollIntoView({behavior:"smooth",block:"start"})},m=t.jsxs("div",{className:"cdacts",children:[Dt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:v=>{v.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:"PDF ↗"})]});if(s==="off"){const v=[e.reasoning||"",Wr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[v.length?v.join(`

`).split(`

`).map((w,f)=>t.jsx("p",{className:"cdtxt",children:w},f)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),m]})}if(s!=="ok"){const v=[e.reasoning||"",Wr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:s==="load"?a.memoLoading:a.memoLoadErr}),v.length>0&&v.join(`

`).split(`

`).map((w,f)=>t.jsx("p",{className:"cdtxt",children:w},f)),s==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:w=>{w.stopPropagation(),c(f=>!f)},children:g?a.memoHideHere:a.memoReadHere})}),g&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:w=>w.stopPropagation()}),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(v=>t.jsx("span",{className:"md-tag",children:v},v)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(v=>v.items.map(w=>t.jsx("button",{type:"button",className:"md-jump",onClick:f=>{f.stopPropagation(),b(w.id)},children:w.title},w.id)))}),n.groups.map((v,w)=>t.jsxs("div",{className:"md-grp",children:[v.label&&t.jsx("div",{className:"md-grp-h",children:v.label}),v.items.map(f=>{const y=f.poids>Ld&&!l.has(f.id),j=f.id==="fiche-contact"||f.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:k=>{k&&x.current.set(f.id,k)},children:[t.jsx("h4",{className:"md-h",children:f.title}),j&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:k=>k.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:"LinkedIn"})]}),y?t.jsx("button",{type:"button",className:"abtn md-more",onClick:k=>{k.stopPropagation(),d(N=>new Set(N).add(f.id))},children:a.memoUnfold(Math.round(f.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:f.html}}),!y&&n.mindmapSlug&&f.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Da}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:k=>k.stopPropagation()})]})]},f.id)})]},v.label||w)),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:a.memoOpenFull})]})}function Fd({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:s,flashErr:i,lang:l}=V(),[d,g]=p.useState(!1),[c,x]=p.useState(!1),[u,b]=p.useState(!1),[m,v]=p.useState(null),[w,f]=p.useState(""),[y,j]=p.useState(null),[k,N]=p.useState(""),S={airtableId:e.airtableId,checkId:e.checkId},C=!!(e.airtableId||e.checkId),R=m&&m.id===e.id?m.entries:[],T=!!m&&m.id===e.id;if(p.useEffect(()=>{f(""),j(null),b(!1)},[e.id]),p.useEffect(()=>{if(!d||T||!C||!o)return;let F=!0;x(!0),b(!1);const $=e.id;return Qn(r,"list",S).then(O=>{if(!(!F||$!==e.id)){if(x(!1),!O.ok){b(!0);return}v({id:$,entries:O.entries})}}),()=>{F=!1}},[d,T,C,r,e.id,o]),!n.pipe||!o||!C)return null;const D=(F,$)=>{x(!0);const O=e.id;Qn(r,F,S,$).then(I=>{if(O===e.id){if(x(!1),!I.ok){i(a.notesErr);return}v({id:O,entries:I.entries}),b(!1),F==="add"&&(f(""),s(a.notesAdded)),F==="edit"&&j(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":d,onClick:F=>{F.stopPropagation(),g($=>!$)},children:[t.jsx("b",{children:a.notesT}),R.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(R.length)}),t.jsx("i",{children:d?"▾":"▸"})]}),d&&t.jsxs("div",{className:"dn-b",onClick:F=>F.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),c&&!R.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!c&&!u&&T&&!R.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),R.map(F=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:l==="fr"?F.date.split("-").reverse().join("/"):F.date}),y===F.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:k,rows:3,onChange:$=>N($.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||!k.trim(),onClick:()=>D("edit",{entryId:F.id,text:k.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>j(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:F.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{j(F.id),N(F.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:c,onClick:()=>{window.confirm(a.notesDelAsk)&&D("delete",{entryId:F.id})},children:a.notesDel})]})]})]},F.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:w,onChange:F=>f(F.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:c||!w.trim(),onClick:()=>D("add",{text:w.trim()}),children:a.notesAdd})]})]})]})}function Fn({o:e}){var k;const{t:a,lang:r,dispatch:n,caps:o,canWrite:s}=V(),i=sa(e),l=kt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),g=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,c=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,x=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(s&&o.pipe&&(e.airtableId||e.checkId)?1:0),u=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(d?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Dt(e)?1:0},{k:"soc",lib:a.cdSociete,n:g},{k:"ctc",lib:a.cdContact,n:c},{k:"suivi",lib:a.cdSuivi,n:x}].filter(N=>N.n>0),[e,a,o,d,l,g,c,x]),[b,m]=p.useState(""),v=u.some(N=>N.k===b)?b:((k=u[0])==null?void 0:k.k)||"",w=Td(e,v==="eval"||v==="conv");if(!u.length)return null;const f=((w==null?void 0:w.reasoning)||"").length>(e.reasoning||"").length?w.reasoning:e.reasoning||"",y=((w==null?void 0:w.summaryHtml)||"").length>(e.summary||"").length?w.summaryHtml:e.summary||"",j=(w==null?void 0:w.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:u.map(N=>t.jsx("button",{type:"button",role:"tab","aria-selected":v===N.k,"data-tour":"tab-"+N.k,className:v===N.k?"on":"",onClick:S=>{S.stopPropagation(),m(N.k)},children:N.lib},N.k))}),t.jsxs("div",{className:"cdbody",onClick:N=>N.stopPropagation(),children:[v==="eval"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(Gr,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),f&&f.split(`

`).map((N,S)=>t.jsx("p",{className:"cdtxt",children:N},S)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Od,{o:e})]}),v==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof j=="number"&&t.jsx(Gr,{v:j,sur:100,k:a.cdConvScore}),en(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",en(e.verdictDate,r)]})]}),y&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:Sd(y)}})]}),v==="memo"&&t.jsx(Rd,{o:e}),v==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdSector,v:e.sector}),t.jsx(ot,{k:a.cdStage,v:e.stage}),t.jsx(ot,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ot,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(ot,{k:a.cdAngle,v:e.angle}),t.jsx(ot,{k:a.cdDetected,v:en(e.date,r)})]}),v==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdName,v:e.contactName}),t.jsx(ot,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),v==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(ot,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(Fd,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}const ba=new Map;function Od({o:e}){const{t:a,token:r}=V(),[n,o]=p.useState(!1),[s,i]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const x=`${r}:${e.name.toLowerCase()}`;let u=ba.get(x);u||(u=co(r,[e.name]).then(m=>m[e.name]||Object.values(m)[0]||null).catch(()=>null),ba.set(x,u),u.then(m=>{(!m||!m.ok)&&ba.delete(x)}));let b=!0;return u.then(m=>{b&&m&&m.ok&&i(m)}),()=>{b=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const x=await oo(r,e.name,e.website||e.domain||"");i(x),x.ok&&ba.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(x)),o(!1)},d=(s==null?void 0:s.blocs)||{},g=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],c=g.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!s&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),s&&c&&t.jsxs(t.Fragment,{children:[g.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(s.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((s.pages||[]).length)})]}),s&&!c&&t.jsx("p",{className:"mnote warn",children:s.quota?a.qaQuota:a.qaEmpty})]})}function ia({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const s=a.current;if(!s)return;let i=!1;const l=()=>{const g=Math.max(280,Math.min(560,s.clientWidth||320));Kn({kind:"op",card:e},g).then(c=>{!i&&c&&s.isConnected&&s.replaceChildren(c)})},d=window.requestAnimationFrame(l);return()=>{i=!0,window.cancelAnimationFrame(d),s.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const s=r.current;if(!s)return;let i=!1;Kn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(d=>{!i&&d&&s.isConnected&&s.replaceChildren(d)});const l=d=>{d.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{i=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&_t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Md=`
...
`;function Dd(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,s=window.innerHeight,i=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>s-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:i,top:l}}function Id(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:s,mode:i,askEvaluate:l,doAnalyse:d,doDecide:g,doPromote:c,doRepeche:x,doApproach:u,doDeep:b,doOnboard:m,outbound:v,evalBusy:w}=V(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const y=Oe(f),j=Ne(f),k=kt(f),N=sa(f),S=f.kind==="target",C=R=>{a({type:"filters",patch:R}),a({type:"popup",id:null})};return _t.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Md}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Dd(e.popupAnchor,!!f.card),onClick:R=>R.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(gt(f.date)),Qe(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[f.cc]}),children:($t(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Ut(f.amountEur,o)})]}),s.pipe&&S&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[At(f.engine)," ",t.jsx("b",{children:Qe(f.engine,o)})," — ",$s(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(wt,{o:f,lg:!0})," ",t.jsx(Ia,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(po(y,o))," · ",n.win7(uo(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(ia,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:s.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),s.pipe&&S&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),s.pipe&&S&&t.jsx(Fn,{o:f})]}),t.jsx(Rn,{name:f.name}),t.jsxs("div",{className:"pf",children:[s.lockActions||i!=="client"&&s.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):s.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),Dt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&s.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var R;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(R=document.querySelector(".atl2 .demand"))==null||R.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:w,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Pd(){const{lang:e,token:a,dossiers:r,caps:n}=V(),o=a||"home",{names:s,verdicts:i}=p.useMemo(()=>{const d=[],g={};return r.forEach(c=>{c.kind!=="target"||!c.name||(d.push(c.name),g[c.name]=Us(c)||"")}),{names:d,verdicts:g}},[r]);return{diff:p.useMemo(()=>s.length?Hs(o,s,i,e):null,[o,s.length]),names:s,verdicts:i,scope:o,caps:n}}function Bd(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:s,dossiers:i,caps:l}=V(),[d,g]=p.useState(!1),[c,x]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!d)return;const j=k=>{u.current&&!u.current.contains(k.target)&&g(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[d]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=s.loading&&!i.length,v=p.useRef({});p.useEffect(()=>{v.current={...r}},[r]);const w=j=>{const k=v.current[j],N=k!==void 0?r[j]-k:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${Zt[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j].toUpperCase(),j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[j],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},j)},f=(j,k,N)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),style:{"--c":`var(${Zt[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:N.toUpperCase()}),t.jsx("span",{className:"n",children:r[j]})]},j),y=(j,k,N,S=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:S,onClick:N,children:j},k);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(w)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[y("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(c?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":d,title:n.toolSort,onClick:()=>g(j=>!j),children:"⇅"}),d&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([j,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[k,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),y("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),y("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function _d(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:s,mode:i}=V(),l=p.useRef(null),[d,g]=p.useState(60);p.useEffect(()=>{let m=0;const v=()=>{var k;const w=l.current;if(!w)return;const f=(k=w.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!f)return;const y=f.getBoundingClientRect(),j=w.getBoundingClientRect();g(Math.max(20,Math.min(y.left+y.width/2-j.left,j.width-30)))};return m=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",v)}},[e.ptab]);const c=e.ptab;let x=r.tuto[c].p;if(c===3){const m=n.filter(f=>f.kind==="target"&&Ne(f)===3),v=m.filter(f=>on(f)==="auto").length,w=m.filter(f=>on(f)==="cd").length;x=r.tutoPending(v,w,m.length)}const u=(()=>{if(i!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(c===1){const m=n.filter(v=>v.kind==="target"&&Ne(v)===1&&!o.has(v.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(v=>v.id)})}}return null})(),b=Vs(c);return t.jsxs("div",{ref:l,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Zt[c]})`,"--ax":d+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const an=600,Ct=62,Yr="atl2:fstats";function $d(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:s}=V(),[i,l]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Yr)==="on"}catch{return!1}}),d=r.stats,g=p.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),c=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const x=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,u=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((N,S)=>Math.max(N,S.s||0),0),m=g.length?an/g.length:0,v=Math.max(4,m-4),w=g.length>=5&&b>0,f=r.marketEstimate||0,y=x(new Date().toISOString().slice(0,10)),j=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],k=[];return typeof d.screened_window=="number"&&c&&k.push({cle:"fenetre",periode:e.funPerWindow(x(c),y),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:j(d.screened)}),t.jsxs("div",{className:"fstats"+(i?" on":""),children:[k.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([S,C],R)=>t.jsxs("span",{className:"fst-t",children:[R>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(S)}),t.jsx("i",{children:C})]},N.cle+C)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((d.screened||0)/f*100)))})]}),N.cle===k[k.length-1].cle&&w&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":i,title:i?e.fstatsHide:e.fstatsShow,onClick:()=>{const S=!i;l(S),S&&!o.mapFolded&&s({type:"mapFold",folded:!0});try{localStorage.setItem(Yr,S?"on":"off")}catch{}},children:i?"⌃":"⌄"})]},N.cle)),i&&w&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${an} ${Ct}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((N,S)=>{const C=(N.s||0)/b*(Ct-4),R=(N.m||0)/b*(Ct-4),T=S*m+(m-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:T,y:Ct-2-C,width:v,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:T,y:Ct-2-R,width:v,height:R,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:Ct-1.5,x2:an,y2:Ct-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Go={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function On({o:e,locked:a=!1}){const{t:r}=V(),n=sa(e),o=kt(e),s=Ne(e),i=on(e),l=Ws(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Go[o]||"v-cons"),title:r.vt[o],children:o}):s===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,s===3&&i==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),s===3&&i==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),s===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(dl,{o:e})]})}const Bt=e=>e.length>22?e.slice(0,21)+"…":e;function oa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Yo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Ud({on:e,rev:a}){const[r,n]=p.useState(null),[o,s]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const i=()=>{var m,v,w;const l=document.querySelector(".atl2.ops .desk-list"),d=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const g=l.getBoundingClientRect(),c=d?d.getBoundingClientRect().bottom:g.top;s({top:Math.round(c),left:Math.round(g.left),width:Math.round(g.width)});const x=[...l.querySelectorAll(":scope .grp")];let u=null;for(const f of x){const y=f.querySelector(".grp-h");y&&y.getBoundingClientRect().bottom<=c+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((w=b.querySelector(".s"))==null?void 0:w.textContent)||"").trim()})};return i(),window.addEventListener("scroll",i,{passive:!0}),window.addEventListener("resize",i),()=>{window.removeEventListener("scroll",i),window.removeEventListener("resize",i)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Hd(e){const r=()=>{const n=Yo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Qr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=V(),[s,i]=p.useState(!1);if(p.useEffect(()=>{n||i(!1)},[n]),Ie(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=s&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),i(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}function Mn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:s,doDecide:i,doPromote:l,doRepeche:d,doApproach:g,dispatch:c,liveMemos:x}=V(),u=m=>v=>{v.stopPropagation(),m()};if(r.lockActions){const m=u(()=>c({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Ne(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Sa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Qr,{o:e})});const b=Ne(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Qr,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Na,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:u(()=>s(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>i(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>i(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>c({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>c({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>c({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>c({type:"memoConsole",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Vd({o:e}){const{t:a,doThumb:r,thumbOf:n}=V(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:s=>{s.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:s=>{s.stopPropagation(),r(e,!1)},children:"👎"})]})}function Wd({o:e}){const{lang:a}=V();return Oe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(wt,{o:e}),t.jsx(Ia,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[At(e.engine||"")," ",Qe(e.engine||"",a)]})})}function Gd({o:e,locked:a,open:r,onToggle:n,selected:o,echo:s,onSelect:i,fresh:l}){const{dispatch:d,caps:g,markRow:c,markedId:x,favIds:u,toggleFav:b,t:m}=V(),v=Ne(e),w=["#0F172A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,y=f<=0?0:f<=7?1:f<=30?2:3,j=g.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][v]:w[y],k=u.has(e.id),N=S=>{if(a)return;if(i){i(e.id);return}if(g.pipe||e.kind==="op"){n();return}const C=S.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(s?" echo":"")+(g.pipe&&e.kind==="target"?" p"+v:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>c(e.id),onMouseLeave:()=>c(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(es,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${m.cdEngagement} ${Math.round(e.engagement*10)/10} · ${m.cdEngagementHint}`,children:"🔥"}),Oe(e)&&t.jsx(wt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:S=>{S.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[We(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(S=>S&&S!==e.name)||""]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:S=>{S.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",Bt(e.acquirer)]}),Ge(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(Yd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Wd,{o:e}),g.pipe&&t.jsx(On,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Mn,{o:e}),g.showThumbs&&t.jsx(Vd,{o:e})]}),r&&!a&&!i&&t.jsx(Jd,{o:e})]})}function Yd({o:e}){const{lang:a,caps:r}=V();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ut(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Qd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:s}=V(),i=(u,b=!1)=>m=>{m.stopPropagation(),b&&s({type:"continent",key:"monde"}),s({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),d=Ut(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=Ie(e),x=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:i({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:i({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:i({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):We(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),oa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Bt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ia,{spec:e.card})})]})}function Kd({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=V();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const s=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Qe(e.engine||"",r),s?` · ${s}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Mn,{o:e})}),t.jsx(Fn,{o:e})]})}function Qo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:s,dispatch:i,caps:l,dossiers:d}=V(),g=p.useRef(null),c=Ge(e);if(p.useEffect(()=>{if(!c||!(e!=null&&e.decryptHtml))return;const h=g.current;if(!h)return;let q=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async U=>{await U.ensureEditoCss(),!(q||!h.isConnected)&&(U.beautifyEditoRows(h),U.mountCardFits(h))}),()=>{q=!0}},[c,e==null?void 0:e.decryptHtml]),!e&&!a){const h=d.find(Ge);if(h)return t.jsx(Qo,{o:h})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!x||Ea(x),w=(e==null?void 0:e.engine)||"",f=Ge(e),y=e?Ut(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),N=d.find(Ge),S=((N==null?void 0:N.url)||"").trim(),C=!!u&&!!S&&(u===S||u.endsWith(S)||S.endsWith(u)),R=(h,q=!1)=>U=>{U.stopPropagation(),q&&i({type:"continent",key:"monde"}),i({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const T=()=>{x&&(i({type:"continent",key:"monde"}),i({type:"filters",patch:{search:x}}))},D=()=>{e!=null&&e.sector&&i({type:"filters",patch:{sector:[e.sector]}})},F=()=>{oa({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},$=e?Ie(e):!1,O=$&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",I=f?r.doEdito.replace(/^📖\s*/,""):w?Qe(w,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[I,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(v||Sa({engine:w}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:R({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:R({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:R({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(ia,{spec:m})}),(u&&!C&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!C&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),i({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[$?t.jsxs("span",{className:"verdict",style:{"--c":O?"var(--brand)":"var(--red)"},children:[O?"✓":"✗"," ",t.jsx("b",{children:O?r.kept:r.dropped})]}):!v&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:s,onClick:h=>{h.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Bt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(v||Sa({engine:w}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&x?" ghost":""),onClick:h=>{h.stopPropagation(),F()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Bt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&x&&l.pipe&&t.jsx(Rn,{name:x})]})]})}function Jd({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:s,doOnboard:i}=V();return!o.pipe&&e.kind==="op"?t.jsx(Qd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Fn,{o:e}),t.jsx(cl,{o:e}),t.jsx(ml,{o:e}),t.jsx(Rn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(On,{o:e})})]}),e.card&&t.jsx(ia,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[At(e.engine||"")," ",Qe(e.engine||"",r)]}),Oe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(wt,{o:e})})]}),o.pipe&&(e.memoUrl||s)&&t.jsx("div",{className:"sec2 acts2",children:s&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>i(e),children:a.actOnboard})})]})]})}function Xd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:s,caps:i,doDecide:l,lang:d}=V();if(!i.pipe&&e.kind==="op"){const x=Ut(e.amountEur,d),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>w=>{w.stopPropagation(),v&&s({type:"continent",key:"monde"}),s({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ia,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[At(e.engine||"")," ",Qe(e.engine||"",d)]}),Oe(e)&&t.jsx(wt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(d==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Mn,{o:e})})]})}const g=Ne(e),c=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":c},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(On,{o:e}),Oe(e)&&t.jsx(wt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>s({type:"memoConsole",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function Zd(){const{t:e}=V(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function ec({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=V(),s=o==="en",i=c=>n.plabels[c]||"",l=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),d=l.includes(0)?0:l.sort((c,x)=>(e[x]||0)-(e[c]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:s?`No “${i(a.ptab)}” for now.`:`0 ${i(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?s?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:s?`${g} ${g>1?"files":"file"} in “${i(d)}”`:`${g} dossier${g>1?"s":""} dans « ${i(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(s?"Open ":"Ouvrir ")+i(d)," →"]})]})}function tc(){var vt,Ft,Et,Re,nt;const e=V(),{st:a,dispatch:r,t:n,caps:o,counts:s,scoped:i,scopedAll:l,markRow:d,lang:g,sessTally:c,data:x,dossiers:u,source:b,focusExtra:m,byId:v,token:w}=e,f=ho(),y=p.useMemo(()=>{var Y,ae,ye,P;if(!w||b==="ops")return null;const L=(((Y=f==null?void 0:f.ed)==null?void 0:Y.date)||(f==null?void 0:f.day)||"").slice(0,10),H=[(ae=f==null?void 0:f.ed)==null?void 0:ae.html,(ye=f==null?void 0:f.ed)==null?void 0:ye.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((P=f==null?void 0:f.ed)==null?void 0:P.date)||L,decryptHtml:H||void 0,date:L,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[w,b,g,(vt=f==null?void 0:f.ed)==null?void 0:vt.html,(Ft=f==null?void 0:f.ed)==null?void 0:Ft.acquirers_html,(Et=f==null?void 0:f.ed)==null?void 0:Et.date,f==null?void 0:f.day]),j=L=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:fo,[k,N]=p.useState(new Set);p.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[S,C]=p.useState(null);p.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[R,T]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){T(!1);return}const L=document.getElementById("atl2-stage");if(!L){T(!1);return}const H=new IntersectionObserver(([Y])=>T(!!Y&&Y.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return H.observe(L),()=>H.disconnect()},[a.mapFolded]);const D=a.mapFolded||!R,F=L=>N(H=>{const Y=new Set(H);return Y.has(L)?Y.delete(L):Y.add(L),Y}),$=b==="ops"||o.pipe,[O,I]=p.useState("all"),[h,q]=p.useState(!1),[U,X]=p.useState(null),[E,z]=p.useState(!1),M=p.useRef(!0);p.useEffect(()=>{if(M.current){M.current=!1;return}I("all"),z(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!E)return;const L=H=>{var Y,ae;(ae=(Y=H.target)==null?void 0:Y.closest)!=null&&ae.call(Y,".atl2 .doable")||z(!1)};return document.addEventListener("click",L,!0),()=>document.removeEventListener("click",L,!0)},[E]);const B=p.useMemo(()=>{var H;const L=new Map;for(const Y of Qi(((H=f==null?void 0:f.ed)==null?void 0:H.html)||""))L.has(Y.t)||L.set(Y.t,Y.html);return L},[(Re=f==null?void 0:f.ed)==null?void 0:Re.html]),_=p.useCallback(L=>{if(L.decryptHtml)return L.decryptHtml;if(!B.size)return;const H=(L.name||"").trim().toLowerCase();if(H.length<3)return;const Y=B.get(H);if(Y)return Y;for(const[ae,ye]of B)if(ae.includes(H)||H.includes(ae))return ye},[B]),{diff:G}=Pd(),[ue,K]=p.useState(!1),ce=a.filters.win==="1"&&!a.filters.day,[le,be]=p.useState(!1),fe=p.useMemo(()=>new Set(((G==null?void 0:G.added)||[]).map(L=>L.trim().toLowerCase()).filter(Boolean)),[G]),de=p.useMemo(()=>{if(!fe.size)return 0;const L={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(H=>!Ge(H)&&fe.has((H.name||"").trim().toLowerCase())&&ea(H,L,o.pipe)).length},[u,fe,a,o.pipe]);p.useEffect(()=>{const L=()=>{be(!1),q(!1),I("all"),z(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",L),()=>window.removeEventListener("ppmap:tunnel",L)},[]),p.useEffect(()=>{be(!1),q(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const pe=p.useMemo(()=>{const L=l.filter(Y=>!Ge(Y)&&We(Y));let H="";for(const Y of L){const ae=(Y.date||"").slice(0,10);ae&&(!H||ae<H)&&(H=ae)}return{n:L.length,since:H?H.split("-").reverse().slice(0,2).join("/"):""}},[l]),xe=pe.n,Q=p.useMemo(()=>{const H=le&&fe.size>0||a.filters.signalOnly||O!=="all"||h?l:i;let Y=zn(H,a.sort);return Y=Y.filter(ae=>!Ge(ae)),le&&fe.size&&(Y=Y.filter(ae=>fe.has((ae.name||"").trim().toLowerCase()))),h||O==="explore"?Y=Y.filter(We):O==="eval"?Y=Y.filter(ae=>!We(ae)&&!ae.noCo&&(ae.kind==="op"||!Ie(ae))):o.pipe&&(Y=Y.filter(ae=>!We(ae))),Y},[i,l,a.sort,O,le,fe,h,o.pipe]),he=p.useMemo(()=>o.pipe?u.filter(L=>L.kind==="target"&&!Ge(L)&&Oe(L)&&(a.continent==="monde"||L.continent===a.continent)):Q.filter(L=>Oe(L)&&!Ie(L)),[o.pipe,u,Q,a.continent]).length,ke=p.useMemo(()=>o.pipe?Q:Q.filter(L=>!Ie(L)&&!L.noCo&&!We(L)),[Q,o.pipe]),ne=b==="ops"?Q.filter(We).length:0,ve=le?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,oe=a.filters,ze=[];if(oe.day)ze.push({k:"day",lib:n.fDay(oe.day.slice(8,10)+"/"+oe.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(oe.win&&oe.win!=="all"){const L=["1","7","30"].indexOf(oe.win);L>=0&&ze.push({k:"win",lib:n.dates[L],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ke=L=>L.length<=2?L.join(", "):`${L.length} ${n.fSelected}`;for(const L of["sector","country","engine","crible"]){const H=oe[L];H&&H.length&&ze.push({k:L,lib:Ke(H),off:()=>r({type:"clearFacet",facet:L})})}oe.search&&ze.push({k:"search",lib:"🔍 "+oe.search,off:()=>r({type:"filters",patch:{search:""}})}),le&&fe.size&&ze.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>be(!1)}),oe.signalOnly&&ze.push({k:"sig",lib:"🔴 "+n.sigDock(he||oe.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const ge=(L,H,Y="",ae=!1)=>t.jsxs("button",{type:"button","data-s":L,className:Y,"aria-sort":a.sort.key===L?a.sort.dir===1?"ascending":"descending":"none",style:ae?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:L}),children:[H,t.jsx("span",{className:"ar",children:a.sort.key===L&&a.sort.dir===1?"▴":"▾"})]},L),Se=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const L=new Map;Q.forEach(ae=>{const ye=ae.engine||"?";L.has(ye)||L.set(ye,[]),L.get(ye).push(ae)});const H={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},Y=rn([...L.keys()],g);return[...L.entries()].sort((ae,ye)=>{const P=H[ae[0]]??10+Y.indexOf(ae[0]),ee=H[ye[0]]??10+Y.indexOf(ye[0]);return P-ee})},[Q,o.pipe,a.groupBy,g]),Rt=Se?Se.filter(([L])=>ya.has(L)).length:0,Pe=(()=>{var H;return((H=(Se?Se.flatMap(([,Y])=>Y):Q)[0])==null?void 0:H.id)??null})(),Je=p.useRef(!1),qe=p.useMemo(()=>u.find(Ge)||y,[u,y]);p.useEffect(()=>{const L=()=>{Je.current=!0,be(!1)};return window.addEventListener("ppmap:reveal",L),window.addEventListener("ppmap:focus",L),()=>{window.removeEventListener("ppmap:reveal",L),window.removeEventListener("ppmap:focus",L)}},[]),p.useEffect(()=>{const L=()=>{qe&&r({type:"focus",id:qe.id})};return window.addEventListener("ppmap:edito",L),()=>window.removeEventListener("ppmap:edito",L)},[qe,r]),p.useEffect(()=>{if(!a.focusId)return;X(a.focusId);const L=window.setTimeout(()=>X(null),900);return()=>window.clearTimeout(L)},[a.focusId]),p.useEffect(()=>{if($&&!(a.focusId&&(Q.some(L=>L.id===a.focusId)||u.some(L=>L.id===a.focusId)||a.focusId===(qe==null?void 0:qe.id)))&&!m){if(qe){r({type:"focus",id:qe.id});return}Pe&&r({type:"focus",id:Pe})}},[$,a.focusId,Q,Pe,m,r,u,b,qe]),p.useEffect(()=>{if(!$||!a.focusId||qe&&a.focusId===qe.id||Q.some(H=>H.id===a.focusId))return;const L=u.find(H=>H.id===a.focusId);if(L){if(Je.current){L.kind==="op"?I(We(L)?"explore":"eval"):O!=="all"&&I("all");return}O!=="all"&&Pe&&r({type:"focus",id:Pe})}},[$,a.focusId,O,Q,u,Pe,r,qe]),p.useEffect(()=>{if(!$||!a.focusId||!Je.current)return;const L=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!L){const ye=Q.findIndex(P=>P.id===a.focusId);if(ye>=0){const P=Se?"":"pt"+a.ptab;if(P){const ee=a.shown[P]||j();ye>=ee&&r({type:"more",group:P,by:ye-ee+8})}}return}Je.current=!1;const H=Yo(),Y=L.getBoundingClientRect();Y.top>=H-2&&Y.bottom<=window.innerHeight-4||Hd(L)},[$,a.focusId,a.ptab,Q,a.shown,Se,r]),p.useEffect(()=>{if(typeof window>"u")return;const L=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),H=document.querySelector(".atl2.ops, .atl2.cibles");if(!L||!H)return;const Y=()=>H.style.setProperty("--listhead-h",`${L.offsetHeight}px`);Y();const ae=new ResizeObserver(Y);return ae.observe(L),()=>ae.disconnect()},[D,a.dens,a.mapFolded]);const st=p.useMemo(()=>{if(!$||!a.focusId)return null;if(y&&a.focusId===y.id)return y;const L=Q.find(Y=>Y.id===a.focusId)||u.find(Y=>Y.id===a.focusId)||null;if(!L)return null;const H=_(L);return H&&H!==L.decryptHtml?{...L,decryptHtml:H}:L},[$,a.focusId,Q,u,_,y]),jt=o.lockRowsAfter;let Me=0;const xt=(L,H)=>{let Y=a.shown[H]||j();return L.length-Y<=4&&(Y=L.length),L.slice(0,Y).map(P=>{const ee=jt!==null&&Me>=jt;Me++;const se=_(P),Z=se&&se!==P.decryptHtml?{...P,decryptHtml:se}:P,je=!$&&a.dens!=="maxi"&&(a.dens==="deplie"||(S?S==="open":!!se)),De=k.has(P.id)?!je:je,$e=$?Ae=>{Je.current=!0,r({type:"focus",id:Ae});const Ue=v.get(Ae);Ue&&(We(Ue)?oa(Ue):Ue.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ue.name,url:Ue.url||"",website:Ue.website||"",domain:Ue.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Xd,{o:Z,locked:ee,selected:$&&a.focusId===P.id,onSelect:$e},P.id):t.jsx(Gd,{o:Z,locked:ee,open:De,onToggle:()=>F(P.id),selected:$&&a.focusId===P.id,echo:U===P.id,fresh:fe.has((P.name||"").trim().toLowerCase()),onSelect:$e},P.id)})},ut="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(Q.length?"":" list-empty"),Xe=t.jsxs(t.Fragment,{children:[Se?Se.map(([L,H])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:At(L)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:L==="ma"?n.grpMa:L==="fundraising"?n.grpLev:ya.has(L)&&Rt<=1?n.grpNews:L==="nominations"?n.grpNom:L==="media"?n.grpNewsOther:L==="recrutements"?n.grpHire:ya.has(L)?n.grpNews+" · "+Qe(L,g):Qe(L,g)}),t.jsx("div",{className:"s",children:n.grpCount(H.filter(Y=>!Ie(Y)).length,H.length)})]})]}),xt(H,L)]},L)):xt(Q,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(Zd,{}),o.pipe&&a.ptab===0&&!h&&!le&&O==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(Uo,{}),!Q.length&&!(x.loading&&!u.length)&&(o.pipe&&O==="all"?t.jsx(ec,{counts:s}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),Nt=t.jsxs(t.Fragment,{children:[!le&&!h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:Q.length})," ",ve]}),h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:Q.length})," ",n.newsWord]}),(!le||h)&&t.jsx("span",{className:"dot",children:"·"}),D&&t.jsx(_o,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[D?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ze.map(L=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:H=>{H.stopPropagation(),L.off()},children:[L.lib,t.jsx("i",{children:"×"})]},L.k)),b==="ops"&&Q.length>0&&!D&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",Q.length-ne," ",n.zoomPulseEval,ne>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",ne," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),bt=t.jsxs("div",{className:"listhead"+(D?" mapoff":""),children:[D&&t.jsx("div",{className:"lh-tools",children:t.jsx(Bo,{compact:!0})}),o.showFunnel&&ue&&ce&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(hl,{}),t.jsx($d,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:Nt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Bd,{}),t.jsx(_d,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ce?" on":""),"aria-pressed":ce,title:n.morningDockTitle,onClick:()=>{if(ce){r({type:"filters",patch:{win:"all",day:""}}),K(!1);return}be(!1),q(!1),I("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),K(!0)},children:["📊 ",n.morningDock(typeof((nt=x.stats)==null?void 0:nt.screened_today)=="number"?x.stats.screened_today:0)]}),G&&!G.firstVisit&&(G.added.length>0||G.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(le?" on":""),"aria-pressed":le,title:n.sinceSub,onClick:()=>{const L=!le;be(L),q(!1),K(!1),I("all"),L&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(de),G!=null&&G.lastDate?` · ${n.sinceSince(G.lastDate)}`:""]}),he>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{be(!1),q(!1),K(!1),I("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(he)]}),o.pipe&&xe>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(h?" on":""),"aria-pressed":h,title:n.newsDockHint,onClick:()=>{const L=!h;q(L),be(!1),K(!1),I("all"),L&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(xe),pe.since?` · ${n.newsSince(pe.since)}`:""]})]}),!o.showFunnel&&Nt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([L,H])=>t.jsxs("button",{type:"button","data-d":L,"aria-pressed":a.dens===L||L==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:L}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:H})]},L))}),!$&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":S==="open",onClick:()=>{C("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":S==="closed",onClick:()=>{C("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var se;const L={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},H=u.filter(Z=>ea(Z,L,o.pipe)&&!Ge(Z)),Y=H.filter(Z=>!We(Z)&&!Z.noCo&&(Z.kind==="op"||!Ie(Z))).length,ae=H.filter(We).length,ye=o.pipe?H.filter(Z=>Z.kind!=="op"&&Ne(Z)===1).length:0,P=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ye?` ${ye}`:""}`]]:[],["eval",`${n.doEval}${Y?` ${Y}`:""}`],["explore",`${n.doExplore}${ae?` ${ae}`:""}`]],ee=((se=P.find(([Z])=>Z===O))==null?void 0:se[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":E,onClick:()=>z(Z=>!Z),children:[ee,t.jsx("i",{children:"▾"})]}),E&&t.jsx("div",{className:"dolist",children:P.map(([Z,je])=>t.jsx("button",{type:"button","aria-pressed":O===Z,onClick:()=>{if(z(!1),Z==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}I(Z),Z!=="all"&&(be(!1),q(!1),K(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:je},Z))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:L=>r({type:"sort",key:L.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([L,H])=>t.jsx("option",{value:L,children:H},L))})]}),o.showChain&&ke.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ke.map(L=>L.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ke.length):n.chainAll(ke.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!$&&bt,a.dens!=="maxi"&&!$&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ge("country",n.colCountry),ge("name",n.colCompany),ge("amount",n.colAmount,"h-amt",!0),ge("stage",n.colStage,"h-stade"),ge("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ge("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ge("memo",n.colMemo)]}),o.pipe&&ge("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),$?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[bt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ge("country",n.colCountry),ge("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ge("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ge("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ut,children:Xe})]}),t.jsxs("aside",{className:"readpane"+((st?Ge(st):!m&&qe)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[qe&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===qe.id,onClick:()=>r({type:"focus",id:qe.id}),children:n.doEdito}),y&&a.focusId===y.id?t.jsx("div",{className:"zoom",children:t.jsx(el,{})}):st&&o.pipe?t.jsx(Kd,{o:st}):t.jsx(Qo,{o:st,extra:st?null:m})]})]}):t.jsx("div",{className:ut,children:Xe}),(()=>{const L=Se||[["pt"+a.ptab,Q]];let H=0,Y=0;for(const[ye,P]of L){Y+=P.length;let ee=a.shown[ye]||j();P.length-ee<=4&&(ee=P.length),H+=Math.min(P.length,ee)}const ae=Y-H;return ae<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>L.forEach(([ye,P])=>r({type:"more",group:ye,by:P.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(ae,ae)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(H,Y)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}}),$&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Ud,{on:!!Se,rev:(Se||[]).map(([L,H])=>L+H.length).join("|")})]})}function Kr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ac(e,a){const r=Gs(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function nc(e,a){const n=[a.head.split("|").map(Kr).join(";")];for(const o of e){const s=a.stageOf(o);n.push([o.name||"",ac(o,a.plabels),sa(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",s?a.stageLabel(s.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Kr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function rc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const oc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function dt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function sc({o:e,qa:a}){const{t:r,lang:n,fund:o}=V(),s=(e.cribleStatus||"").trim().toUpperCase()||(sa(e)==="NO MATCH"?"NO MATCH":"MATCH"),i=kt(e),l=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(s==="NO MATCH"?" out":""),children:[s==="NO MATCH"?r.vOut:r.vKept,i&&t.jsx("em",{children:i})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(dt,{k:r.cdSector,v:e.sector}),t.jsx(dt,{k:r.cdStage,v:e.stage}),t.jsx(dt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(dt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(dt,{k:r.cdName,v:e.contactName}),t.jsx(dt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(dt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(dt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(dt,{k:r.cdAngle,v:e.angle}),t.jsx(dt,{k:r.cdDetected,v:oc(e.date,n)})]}),d.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,g])=>g).map(([g,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:c})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function ic(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:s,dispatch:i}=V(),[l,d]=p.useState({}),g=25,c=p.useMemo(()=>n.slice(0,g),[n]);p.useEffect(()=>{c.length&&co(r,c.map(b=>b.name)).then(d)},[r,c]);const x=s.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{i({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof s.marketEstimate=="number"&&s.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(s.marketEstimate)),", ",Math.round(x.screened/s.marketEstimate*100)," %"]})]})]}),c.map(b=>t.jsx(sc,{o:b,qa:l[b.name]},b.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const lc=50;function Dn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=V(),[s,i]=p.useState(null),[l,d]=p.useState(!1),[g,c]=p.useState(""),[x,u]=p.useState(0),[b,m]=p.useState(""),[v,w]=p.useState(!1),[f,y]=p.useState(0),j=p.useRef(null),k=p.useRef(null),N=()=>{y(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>y(T=>T+1),1e3)},S=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};p.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),k.current&&window.clearInterval(k.current)},[]);const C=async T=>{d(!0),c(""),N();const D=await a();if(d(!1),S(),D.ok){i(D);return}if(D.busy){c(o.alertPreviewBusy);return}if(!T){c(o.alertPreviewFail);return}u(lc),S(),j.current=window.setInterval(()=>{u(F=>F>1?F-1:(j.current&&window.clearInterval(j.current),C(!1),0))},1e3)},R=async()=>{if(n||v||l)return;w(!0),m(""),N();const T=await r();w(!1),S(),m(T.ok?o.alertTestOk(T.sentTo||""):T.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||v||x>0,onClick:()=>{C(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||l,onClick:()=>{R()},children:v?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(s==null?void 0:s.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",s.subject]}),s.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:s.html,title:e})]})]})}const ht="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ve({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=V();return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:s=>{s.target===s.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function dc(){const{st:e}=V();switch(e.modal){case"chain":return t.jsx(pc,{});case"space":return t.jsx(uc,{});case"alert":return t.jsx(mc,{});case"queue":return t.jsx(bc,{});case"export":return t.jsx(vc,{});case"plug":return t.jsx(kc,{});case"approach":return t.jsx(jc,{});case"recharge":return t.jsx(Sc,{});case"cover":return t.jsx(zc,{});case"dossier":return t.jsx(Cc,{});case"crit":return t.jsx(Tc,{});case"tuto":return t.jsx(Lc,{});case"rdv":return t.jsx(cc,{});case"memoalert":return t.jsx(yc,{});default:return null}}function cc(){const{dispatch:e,fund:a,t:r}=V(),n=a||r.rdvCoFallback;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:bo,children:qn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,s],i)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(i+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:s})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(vi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function pc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:s,askEvaluate:i,evalBusy:l,caps:d,memoQueued:g,doAnalyse:c}=V(),x=s==="client",u=e.chain.queue.map(w=>r.get(w)).filter(w=>!!w),b=e.chain.idx,m=u[b],v=b>=u.length;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[$t(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(gt(m.date))].filter(Boolean).map(w=>String(w).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Qe(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Ut(m.amountEur,o)})]}),Oe(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(wt,{o:m,lg:!0})," ",t.jsx(Ia,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&Ie(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&Ie(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":zt(m)==="retenu"?"var(--brand)":zt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:zt(m)==="retenu"?"✓ "+n.kept:zt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&d.pipe&&Ne(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(x&&Ie(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var w;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(w=document.querySelector(".atl2 .demand"))==null||w.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{i(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function uc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=V(),s=o==="client",i=p.useMemo(()=>s?r.filter(x=>Ie(x)):[],[r,s]),l=p.useMemo(()=>zn(i.filter(x=>zt(x)==="retenu"),{key:"signal",dir:-1}),[i]),d=p.useMemo(()=>i.filter(x=>zt(x)==="ecarte"),[i]),g=e.spaceTab==="retenu"?l:d,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ve,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function mc(){const{mode:e}=V();return e==="client"||e==="apercu"?t.jsx(fc,{}):t.jsx(xc,{})}function fc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=V(),[s,i]=p.useState("d"),l=o!=="client";return t.jsxs(Ve,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":s==="d",className:s==="d"?"on":"",onClick:()=>i("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":s==="w",className:s==="w"?"on":"",onClick:()=>i("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":s==="m",className:s==="m"?"on":"",onClick:()=>i("m"),children:e.alertTabMarket})]}),s==="d"&&t.jsx(hc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),s==="w"&&t.jsx(gc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),s==="m"&&t.jsx(Ko,{})]})}function hc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[s,i]=p.useState(null),[l,d]=p.useState(!1),[g,c]=p.useState(0);p.useEffect(()=>{let R=!0;return d(!1),tr(a).then(T=>{R&&(T?i(T):d(!0))}),()=>{R=!1}},[a,g]);const x=p.useRef({}),[u,b]=p.useState({}),[m,v]=p.useState(!1),[w,f]=p.useState(!1),y=p.useRef(null);p.useEffect(()=>()=>{y.current&&window.clearTimeout(y.current)},[]);const j=R=>{const T=x.current;Object.keys(T).length&&(v(!0),tr(a,T).then(D=>{if(!D){v(!1),o(e.actErr);return}if(D.throttled&&R<3){y.current=window.setTimeout(()=>j(R+1),5400);return}if(x.current={},b({}),i(D),v(!1),D.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},k=R=>{r||(x.current={...x.current,...R},b(T=>({...T,...R})),y.current&&window.clearTimeout(y.current),y.current=window.setTimeout(()=>j(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(R=>R+1),children:e.retry})]});if(!s)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...s,...u},S=R=>!N.sections||N.sections.includes(R),C=R=>{const T=N.sections||e.alertSec.map(([D])=>D);k({sections:S(R)?T.filter(D=>D!==R):[...T,R]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&w&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([R,T])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:S(R),disabled:r,onChange:()=>C(R)}),t.jsxs("span",{children:[T,R==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},R))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Dn,{label:e.alertPreview,readOnly:r,onPreview:()=>si(a),onTest:()=>oi(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function gc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[s,i]=p.useState(null),[l,d]=p.useState(!1),[g,c]=p.useState(0);p.useEffect(()=>{let m=!0;return d(!1),ar(a).then(v=>{m&&(v?i(v):d(!0))}),()=>{m=!1}},[a,g]);const x=m=>{r||ar(a,m).then(v=>{if(!v){o(e.actErr);return}i(v),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(m=>m+1),children:e.retry})]});if(!s)return t.jsx("div",{className:"sp-empty",children:"…"});const u=s.dow??0,b=s.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":s.enabled===!0,disabled:r,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Dn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>li(a),onTest:()=>ii(a)}),s.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),s.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",s.email_lead,s.last_sent?` · ${e.updatedAt(s.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ko(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:s}=V(),[i,l]=p.useState(s||""),[d,g]=p.useState(!1),[c,x]=p.useState(!1);p.useEffect(()=>{s&&l(s)},[s]);const u=e.filters,b=p.useMemo(()=>n.filter(f=>Oe(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(i)||c)){x(!0);try{await fetch(`${Da}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i.trim(),sectors:u.sector,countries:u.country,source:s?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},w=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Qe(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>$t(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(i)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:w.map(([f,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:i,readOnly:!!s,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function xc(){const{t:e}=V();return t.jsx(Ve,{title:e.alertTitle,icon:"🔔",children:t.jsx(Ko,{})})}function bc(){var F,$;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:s,memoQueued:i,caps:l,dispatch:d,liveMemos:g}=V(),[c,x]=p.useState(()=>$a(r)),[u,b]=p.useState(()=>!$a(r)),[m,v]=p.useState([]),[w,f]=p.useState(0),y=n==="client",j=p.useMemo(()=>{const O=new Map;return o.forEach(I=>{const h=(I.name||"").trim().toLowerCase();h&&!O.has(h)&&O.set(h,I)}),O},[o]);p.useEffect(()=>{let O=!0;return(!$a(r)||w>0)&&b(!0),(async()=>{const[I,h]=await Promise.all([En(r,w>0),ro(a)]);O&&(I&&x(I),b(!1),v(h))})(),()=>{O=!1}},[a,r,w]);const k=u&&!c,N=(c==null?void 0:c.per_day)??0,S=((F=c==null?void 0:c.analyzed_today)==null?void 0:F.length)??0,C=c==null?void 0:c.offre,R=(c==null?void 0:c.pool_meta)||[],T=p.useMemo(()=>{const O=new Map;for(const I of(c==null?void 0:c.scheduled)||[])for(const h of I.names||[])O.has(h)||O.set(h,{label:I.day_label,date:I.date});return O},[c==null?void 0:c.scheduled]),D=(c==null?void 0:c.in_progress)||[];return t.jsxs(Ve,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(S,S+((($=c==null?void 0:c.pool_order)==null?void 0:$.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(D.length>0||g.items.some(O=>O.status==="boot"||O.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(O=>O.status==="boot"||O.status==="running"||O.status==="error").map(O=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:O.name}),t.jsx("span",{className:"qd",children:O.memoType||""}),t.jsx(Na,{item:O,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+O.name)),D.filter(O=>!g.liveOf(O.name)).map(O=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:O.name}),t.jsxs("span",{className:"qd",children:[O.memo_type||"",O.age_min?` · ${Math.round(O.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:O.state||""})]},"ip-"+O.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(O=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:O.company}),t.jsxs("span",{className:"qd",children:[O.memo_type,typeof O.est_min=="number"?` · ~${O.est_min} min`:""]}),t.jsx("span",{className:"qt",children:O.status}),O.url&&t.jsx("a",{className:"qgo",href:O.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(O.memo_type)}),y&&O.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Zn(a,O.company,"retry").then(()=>f(I=>I+1))},children:e.queueRetry}),y&&O.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Zn(a,O.company,"delete").then(()=>f(I=>I+1))},children:e.queueDelete})]},O.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(R.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&R.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),R.map((O,I)=>{const h=T.get(O.name),q=j.get((O.name||"").trim().toLowerCase()),U=g.liveOf(O.name),X=!!(q&&i.has(q.id))||!!(U&&(U.status==="boot"||U.status==="running")),E=!!(q&&Ne(q)===1&&!q.memoUrl)&&!U;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",I+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:O.name}),O.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof O.score=="number"&&t.jsx("span",{className:"qs2",children:O.score}),U&&(U.status==="boot"||U.status==="running")&&t.jsx(Na,{item:U,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),E&&(l.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>d({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:X,onClick:()=>{s(q),f(z=>z+1)},children:X?e.actAnalyseQueued:e.actAnalyse})),O.excerpt&&t.jsx("span",{className:"qex",children:O.excerpt})]},O.name+":"+I)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([O,I])=>t.jsxs("li",{children:[t.jsx("b",{children:O})," — ",I]},O))})]})}function vc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:s,dispatch:i}=V(),l=`${ht}/cibles/list.csv?token=${a}`,d=`${ht}/cibles/list.json?token=${a}`,g=`${ht}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${l}")`,x=w=>{var f;(f=navigator.clipboard)==null||f.writeText(w).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:c},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{rc(nc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:s,stageLabel:w=>(e.stg.find(([f])=>f===w)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{i({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ve,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>i({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:w,value:f,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:w[0]}),t.jsxs("div",{children:[t.jsx("b",{children:w[1]}),t.jsx("p",{children:w[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},w[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function yc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=V(),s=o!=="client",[i,l]=p.useState(null),[d,g]=p.useState(!1),[c,x]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let f=!0;return g(!1),Jn(a).then(y=>{f&&(y?l(y):g(!0))}),()=>{f=!1}},[a,c]);const m=()=>(i==null?void 0:i.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=f=>{if(s||!i)return;const y={enabled:f.enabled??!!i.enabled,email:f.email??(i.email||""),sections:f.sections??m()};b(!0),Jn(a,y).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}l(j),r(e.memoAlertSaved)})};if(d)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!i)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const w=m();return t.jsxs(Ve,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:s||u,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsx(wc,{value:i.email||"",readOnly:s||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>v({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!w[f],disabled:s||u,onChange:()=>v({sections:{...w,[f]:!w[f]}})}),t.jsx("span",{children:y})]},f))}),t.jsx(Dn,{label:e.memoAlertPreview,readOnly:s,onPreview:()=>Qs(a,w),onTest:()=>Ys(a,w)})]})}function wc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[s,i]=p.useState(e);p.useEffect(()=>{i(e)},[e]);const l=s.trim()!==e.trim(),d=!s.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(s.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:s,disabled:a,onChange:g=>i(g.target.value),onKeyDown:g=>{g.key==="Enter"&&l&&d&&o(s.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!d,onClick:()=>o(s.trim()),children:n})]})]})}function kc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=V(),[s,i]=p.useState(null),[l,d]=p.useState(!1),[g,c]=p.useState(null),[x,u]=p.useState(!1),[b,m]=p.useState(""),[v,w]=p.useState(0),[f,y]=p.useState("webhook"),[j,k]=p.useState(""),N=p.useRef(!1);p.useEffect(()=>{let F=!0;return d(!1),Xn(a).then($=>{F&&($?i({configured:$.configured,url_hint:$.url_hint}):d(!0))}),Zs(a).then($=>{if(F){if(!$){u(!0);return}u(!1),c($),N.current||(N.current=!0,$.destination==="instantly"&&y(O=>O==="webhook"?"instantly":O),$.campaign_id&&k(O=>O||$.campaign_id||""))}}),()=>{F=!1}},[a,v]);const S=(F,$)=>{o&&Xn(a,F).then(O=>{if(!O||O.ok===!1){n(e.actErr);return}F.test&&O.sent===!1?n(e.plugTestThrottled):r($),w(I=>I+1)})},C='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',R=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),T=`curl -X POST ${ht}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,D=`curl -X POST ${ht}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`;return t.jsxs(Ve,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>w(F=>F+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:F=>m(F.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>S({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(s==null?void 0:s.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",s.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>S({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>S({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:R}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(R).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Ec,{destKind:f,setDestKind:y,camp:j,setCamp:k,whHint:s!=null&&s.configured?s.url_hint||"webhook":null}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugVarsT}),t.jsx("p",{className:"mnote",children:e.plugVars})]}),t.jsx(Nc,{auto:g,autoKo:x,destKind:f,camp:j,onRetry:()=>w(F=>F+1),onDone:F=>{c(F),u(!1)}}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:T}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(T).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:C}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(C).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:D}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(D).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function jc(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:s,flashErr:i,lang:l}=V(),d=p.useMemo(()=>r.find(h=>h.id===n.approachId)||null,[r,n.approachId]),[g,c]=p.useState("email"),[x,u]=p.useState(0),[b,m]=p.useState({}),[v,w]=p.useState(!1),[f,y]=p.useState(""),[j,k]=p.useState({});if(p.useEffect(()=>{!d||b[g]||v||(w(!0),y(""),Xs(a,d.name,g).then(h=>{if(w(!1),!h||h.ok===!1){y((h==null?void 0:h.error)||e.apprFail);return}m(q=>({...q,[g]:h}))}))},[d,g,a]),!d)return null;const N=b[g],S=(N==null?void 0:N.sequence)||[],C=S[x],R=h=>`${g}|${x}|${h}`,T=h=>{const q=R(h);return q in j?j[q]:String(((C==null?void 0:C[h])??"")||"")},D=(h,q)=>k(U=>({...U,[R(h)]:q})),F=R("subject")in j||R("body")in j||R("message")in j,$=T(g==="email"?"body":"message"),O=T("subject"),I=g==="email"&&O?`${O}

${$}`:$;return t.jsxs(Ve,{title:e.apprT(d.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(h=>t.jsx("button",{type:"button",className:"apch"+(g===h?" on":""),"aria-pressed":g===h,onClick:()=>{c(h),u(0)},children:h==="email"?e.apprChEmail:e.apprChLi},h)),t.jsx("span",{className:"sp"}),S.map((h,q)=>t.jsxs("button",{type:"button",className:"apday"+(x===q?" on":""),"aria-pressed":x===q,onClick:()=>u(q),children:[h.day||`J${q}`,[`${g}|${q}|subject`,`${g}|${q}|body`,`${g}|${q}|message`].some(U=>U in j)&&t.jsx("i",{children:"✎"})]},h.day||q))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,N!=null&&N.sender?" · "+e.apprSender(N.sender):""]}),v&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!f&&!v&&t.jsxs("p",{className:"mnote warn",children:[f," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{m(h=>{const q={...h};return delete q[g],q}),y("")},children:e.retry})]}),!v&&!f&&!C&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),C&&t.jsxs(t.Fragment,{children:[g==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:O,onChange:h=>D("subject",h.target.value)})]}),g==="linkedin"&&x===0&&(N==null?void 0:N.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:$,onChange:h=>D(g==="email"?"body":"message",h.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var h;(h=navigator.clipboard)==null||h.writeText(I).then(()=>s(e.exportCopied)).catch(()=>i(e.actErr))},children:e.apprCopy}),g==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(d.contactEmail||"")}?subject=${encodeURIComponent(O)}&body=${encodeURIComponent($)}`,children:e.apprMailto}),F&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Nc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:s}){const{t:i,token:l,flash:d,flashErr:g,canWrite:c}=V(),[x,u]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:i.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[i.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:s,children:i.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?i.plugAutoNeed:"":n.trim()?"":i.plugCampNeed),v=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,w=()=>{if(x||!c||m)return;u(!0),(b?er(l,!1):er(l,!0,r,n.trim()||void 0)).then(y=>{if(u(!1),!y){g(i.actErr);return}o(y),d(y.enabled?i.plugAutoSavedOn:i.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:i.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:i.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!c||!!m,title:m||void 0,onClick:w,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:i.plugAutoOnLbl})]}),m===i.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:m}),v&&t.jsx("p",{className:"mnote warn",children:i.plugAutoBroken})]})}function Ec({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:s,token:i,lang:l,canWrite:d}=V(),[g,c]=p.useState("valides"),[x,u]=p.useState(!1),[b,m]=p.useState(null),[v,w]=p.useState(null),[f,y]=p.useState(!1),[j,k]=p.useState(!1),[N,S]=p.useState(null),[C,R]=p.useState(null),T=`atl2:bulk:${i}:${g}:${e}`;p.useEffect(()=>{m(null),w(null),y(!1),S(null);try{const z=localStorage.getItem(T)||localStorage.getItem(`atl2:bulk:${i}:${g}`),M=JSON.parse(z||"null");R(M&&Date.now()-Date.parse(M.t)<24*3600*1e3?M:null)}catch{R(null)}},[T,g,i]);const D=e==="instantly"&&!r.trim(),F=`${g}|${e}|${r.trim()}`,$=async()=>{if(D||!d)return;u(!0),y(!1),S(null);const z=await ni(i,g,e,r.trim()||void 0);m(z),w(z.ok?F:null),u(!1)},O=p.useRef(!1);if(!d)return null;const I=async()=>{if(O.current||!d)return;O.current=!0,k(!0);const z=`${i}:${g}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await ri(i,g,e,r.trim()||void 0,z)}finally{O.current=!1}if(k(!1),y(!1),S(M),M.ok&&(M.pushed||0)>0){const B={t:new Date().toISOString(),n:M.pushed||0};R(B);try{localStorage.setItem(T,JSON.stringify(B))}catch{}}};f&&v!==null&&v!==F&&y(!1);const h=o,q=b!=null&&b.ok&&b.ready||0,U=e==="instantly"?r.trim()?s.plugDestInstOn(r.trim()):"":h||"",X=!!(b!=null&&b.ok)&&v===F&&q>0&&!!U&&!C,E=C?new Date(C.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:s.plugBulk}),t.jsx("p",{className:"mnote",children:s.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:g,onChange:z=>c(z.target.value),children:s.plugBulkTabs.map(([z,M])=>t.jsx("option",{value:z,children:M},z))}),t.jsxs("select",{value:e,"aria-label":s.plugDestLbl,onChange:z=>a(z.target.value),children:[t.jsx("option",{value:"webhook",children:s.plugDestWh}),t.jsx("option",{value:"instantly",children:s.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:s.plugCampPh,value:r,onChange:z=>n(z.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||D,onClick:()=>{$()},children:x?"…":s.plugBulkPreview})]}),D&&t.jsx("p",{className:"mnote warn",children:s.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:s.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:s.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:s.bulkScope}),C&&t.jsx("p",{className:"mnote",children:s.bulkLocked(E,C.n)}),!C&&!!(b!=null&&b.ok)&&!U&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:s.bulkNoDest}),!C&&!b&&t.jsx("p",{className:"mnote dim",children:s.bulkPreviewFirst}),X&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>y(!0),children:s.bulkArm}),X&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:s.bulkWarn(q,U)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:j,onClick:()=>{I()},children:j?s.bulkSending:s.bulkConfirm(U)}),t.jsx("button",{type:"button",className:"abtn",disabled:j,onClick:()=>y(!1),children:s.bulkCancel})]}),N&&(N.ok?N.replayed?t.jsx("p",{className:"mnote",children:N.pending?s.bulkPending:s.bulkReplayed}):(N.pushed||0)>0?t.jsx("p",{className:"mnote",children:s.bulkDone(N.pushed||0,N.linkedinReady||0,N.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:s.bulkNone}):t.jsx("p",{className:"mnote warn",children:N.error||s.actErr}))]})}function Sc(){const{t:e,data:a,lang:r}=V(),n=a.credits,o=a.email,s=async i=>{if(!o)return;const l=window.location.href.split("?")[0];try{const g=await(await fetch(`${Da}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:i,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ve,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(i=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(i.credits,i.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{s(i.lookup_key)},children:e.rechargeBuy})]},i.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Cc(){const{t:e}=V();return t.jsx(Ve,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(ic,{})})}function zc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:s,canWrite:i,flash:l}=V(),[d,g]=p.useState(null),[c,x]=p.useState(!1);p.useEffect(()=>{let T=!0;if(s)return En(s).then(D=>{T&&D&&typeof D.per_day=="number"&&g(D.per_day)}),()=>{T=!1}},[s]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let T=!0;return Js(o).then(D=>{T&&b(D)}),()=>{T=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(T=>T.kind==="target"&&Ie(T)).length,w=r.marketEstimate||0,f=w>0?Math.min(100,Math.round(v/w*100)):null,y=(m==null?void 0:m.window_days)||30,j=v>0?v/y:0,k=w>0?Math.max(0,w-v):0,S=w>0&&j>0&&v>=100?Math.round(k/j):null,C=T=>Math.round(T).toLocaleString(a==="en"?"en-US":"fr-FR"),R=T=>{c||!i||(x(!0),ti(o,T).then(D=>{if(x(!1),D===null){l(e.actErr);return}g(D),l(e.alertSaved)}))};return t.jsxs(Ve,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(v))}),w>0&&t.jsx("span",{children:e.covOf(C(w))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),S!==null&&t.jsx("p",{className:"mnote",children:e.covEta(S)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(j))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((T,D)=>t.jsxs("tr",{className:T.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[T.code,T.geo?` · ${T.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof T.n=="number"?C(T.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:T.source}),T.elargi&&t.jsx("em",{children:e.covWide(String(T.demande||""))}),T.erreur&&t.jsx("em",{children:e.covMissing})]})]},D)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(u.total||w)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),i&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(T=>t.jsx("button",{type:"button",className:d===T?"on":"",disabled:c,onClick:()=>R(T),children:T===0?"⏸":T},T))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function Jo(e,a,r){const n=await fetch(`${ht}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(i=>window.setTimeout(i,5e3));const s=await fetch(`${ht}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(i=>i.json().catch(()=>({}))).catch(()=>null);if(s){if(s.applied===!0)return{applied:!0,reply:String(s.reply||"")};if(s.done===!0||s.status==="done"||s.status==="error"||s.clarification||s.error)return{applied:!1,reply:String(s.reply||s.clarification||s.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Ac(){const{t:e,token:a,canWrite:r}=V(),[n,o]=p.useState(null),[s,i]=p.useState(""),[l,d]=p.useState(""),[g,c]=p.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=p.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const m=JSON.parse(localStorage.getItem(x)||"null");return!!m&&Date.now()-(m.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(p.useEffect(()=>{if(!r)return;let m=!0;return ei(a).then(v=>{m&&o(v)}),()=>{m=!1}},[a,r]),!r||g||u||!n||!n.pattern||!n.instruction)return null;if(s==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{i("run"),Jo(a,n.instruction||"","atelier2-avis").then(m=>{if(i(m.applied?"ok":"ko"),m.applied||d(m.encours?e.propSlow:m.reply),m.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),s==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),s==="ko"&&t.jsx("p",{className:"mnote warn",children:l||e.avisFail}),s!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{c(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function qc(){var N;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=V(),[s,i]=p.useState(!1),[l,d]=p.useState(null),[g,c]=p.useState(!1),[x,u]=p.useState([]),[b,m]=p.useState(null),[v,w]=p.useState([]);if(!r)return null;const f=()=>{i(!0),c(!1),u([]),w([]),ai(a).then(S=>{if(i(!1),!S){c(!0),d(null);return}d(S)})},y=S=>{b||(m(S.title),Jo(a,S.instruction,"atelier2-prop").then(C=>{m(null),C.applied?(w(R=>[...R,S.title]),n(e.propApplied)):C.encours?n(e.propSlow):o(C.reply||e.propApplyFail)}))},j=((l==null?void 0:l.proposals)||[]).filter(S=>!x.includes(S.title)&&!v.includes(S.title)),k=((N=l==null?void 0:l.counts)==null?void 0:N.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(s?" loading":""),disabled:s,style:{marginTop:8},onClick:f,children:s?e.propWait:e.propBtn}),!s&&g&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!s&&!g&&l&&!(l.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:l.reason==="not_enough_signals"?e.propFew(k):e.propNone}),j.map(S=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[S.section]||S.section}),t.jsx("p",{className:"propt",children:S.title}),S.why&&t.jsx("p",{className:"mnote dim",children:S.why}),S.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",S.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>y(S),children:b===S.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(C=>[...C,S.title]),children:e.propSkip})]})]},S.title))]})}function Tc(){var f,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:s,fund:i,lang:l}=V(),d=n==="client",g=p.useMemo(()=>{const k=new Set;return a.forEach(N=>{N.angle&&k.add(N.angle)}),[...k]},[a]),[c,x]=p.useState(""),[u,b]=p.useState(""),[m,v]=p.useState(!1),w=async()=>{const k=c.trim();if(!(!k||m||!d)){v(!0),b("");try{const S=await(await fetch(`${ht}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(S.reply&&b(String(S.reply)),S.job_id){b(e.critChatRunning);const C=async()=>{const R=await fetch(`${ht}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:S.job_id})}).then(T=>T.json()).catch(()=>null);if(R&&R.done){b(String(R.reply||R.clarification||R.summary||"✓")),v(!1),R.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||v(!1)}}};return t.jsxs(Ve,{title:e.critTitle,icon:"⚙",wide:!0,children:[(s==null?void 0:s.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:s.lead}),!!((f=s.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:s.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=s==null?void 0:s.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:s.method||e.critProfilsSub}),s.angles.map(k=>{var N,S;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((N=k.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((S=k.out)!=null&&S.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},k.title)})]}),!!((j=s==null?void 0:s.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),s.gate.length===1&&!s.gate[0].k?t.jsx("p",{className:"gate1",children:s.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:s.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsx(Ac,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!d||m,onChange:k=>x(k.target.value),onKeyDown:k=>{k.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!d||m||!c.trim(),onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(qc,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Ks,{fund:i,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Go[k]||"v-cons"),children:k}),t.jsx("span",{children:N})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",N]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Lc(){const{t:e,dispatch:a,startTour:r}=V(),n=o=>{var s,i;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((s=document.querySelector(".atl2 .demand input"))==null||s.scrollIntoView({block:"center",behavior:"smooth"}),(i=document.querySelector(".atl2 .demand input"))==null||i.focus())};return t.jsxs(Ve,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,s],i)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(s),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(s))},children:[t.jsx("span",{className:"n",children:i+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},s+i))})]})}const Xo="atl2:mapfold",Rc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Xo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Fc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Zo=p.createContext(null),V=()=>{const e=p.useContext(Zo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function wt({o:e,lg:a}){const{lang:r}=V(),n=Oe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:nr(n,r),children:[n.emoji," ",nr(n,r)]}):null}function Ia({o:e,src:a}){const{lang:r,t:n}=V(),o=Oe(e);if(!o)return null;const s=fi(o),i=hi(o);return t.jsxs("em",{className:"sigwin"+(i?" hot":""),title:n.signaledOn(po(o,r))+" · "+n.win7(uo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,d)=>t.jsx("i",{className:d<s?"on":""},d))}),t.jsx("span",{className:"lb",children:i?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Oc(e,a,r){const n=(r||"").trim();if(n){const s=e.find(i=>(i.url||"")===n);if(s)return s}const o=_e(a);if(o)return e.find(s=>_e(s.name)===o)||e.find(s=>{const i=_e(s.name);return i.length>=3&&(o.includes(i)||i.includes(o))})}function Mc(){const{scoped:e,t:a,st:r,dispatch:n}=V(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const s=!!r.filters.day,i=e.filter(x=>!Ge(x)),l=i.length,d=i.filter(x=>!x.noCo).length,g=i.filter(x=>!!x.noCo).length,c=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(s?" on":""),"aria-pressed":s,title:s?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(s)n({type:"filters",patch:{day:"",win:c?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:s?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:s?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",d," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function Dc(){const{t:e,lang:a,data:r,dispatch:n}=V(),o=r.stats,s=l=>l.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const i=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:s(o.screened)}),t.jsx("span",{children:i>0?e.covOf(s(i)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",s(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",s(o.analyzed)," ",e.covAna]})]})]})}function es({o:e}){const{lang:a}=V(),r=mi(e.cc),n=e.cc?$t(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Jr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Ic=!1;function Pc(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const ts=e=>`atl2:tour:${e||"anon"}`;function Bc(e){try{return localStorage.getItem(ts(e))==="1"}catch{return!0}}function Xr(e){try{localStorage.setItem(ts(e),"1")}catch{}}function _c(e,a,r,n,o,s){const i=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:i.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:i.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:i.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:i.live,body:e.fhintLive},{sel:".atl2 .goal",title:i.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:i.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:i.funnel,body:e.fhintFunnel,ptab:n},s>0?{sel:".atl2 .tuto",title:i.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:i.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:i.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:i.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:i.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:i.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:i.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:i.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:i.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:i.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:i.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Wc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:s}){var In;const{lang:i}=di(),l=Li[i],d=Hi(e,i,a),[g,c]=p.useReducer(Gi,void 0,()=>Vi((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Fc():Rc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=p.useRef(!0);p.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Xo,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const A=()=>{window.innerWidth<=760&&c({type:"mapFold",folded:!0})};return A(),window.addEventListener("resize",A),()=>window.removeEventListener("resize",A)},[a]);const u=p.useRef(s);u.current=s,p.useEffect(()=>{var A;(A=u.current)==null||A.call(u,g.filters)},[g.filters]);const[b,m]=p.useState(()=>{if(typeof window>"u")return"both";try{const A=localStorage.getItem("atl2:chrome-mode");if(A==="eval"||A==="filt"||A==="both")return A;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,w]=p.useState(null),[f,y]=p.useState(null),[j,k]=p.useState(null),[N,S]=p.useState({kept:0,dropped:0}),[C,R]=p.useState(!1),[T,D]=p.useState(""),[F,$]=p.useState(!1),[O,I]=p.useState(null),[h,q]=p.useState(!1),[U,X]=p.useState(!1),[,E]=p.useState(0),z=()=>E(A=>A+1),M=p.useRef([]),B=p.useRef(new Set),_=p.useRef(new Set),[G,ue]=p.useState([]),[K,ce]=p.useState([]),[le,be]=p.useState(0),fe=p.useRef(new Map),de=p.useRef(null),{mode:pe}=d,xe=p.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[d.caps,o,a]),Q=xe.pipe,re=d.session.token||"",he=pe==="client"&&!e;p.useEffect(()=>{if(!re||!Q)return;let A=!0;const J=async()=>{const ie=await gi(re);!A||!ie||(ce(ie.runs),be(Date.now()/1e3-ie.now),ue(He=>He.filter(Ee=>!ie.runs.some(Be=>_e(Be.company)===_e(Ee.name)))))};J();const W=G.length>0||K.some(ie=>ie.status==="running"),te=window.setInterval(()=>{J()},W?8e3:25e3);return()=>{A=!1,window.clearInterval(te)}},[re,Q,G.length,K.some(A=>A.status==="running")]);const ke=p.useMemo(()=>{const A=[],J=new Set;for(const W of G){const te=_e(W.name);!te||J.has(te)||(J.add(te),A.push({name:W.name,id:W.id,status:"boot",started:W.started,estMin:W.estMin,memoType:"instant"}))}for(const W of K){const te=_e(W.company);if(!te||J.has(te))continue;J.add(te);const ie=W.status==="error"?"error":W.status==="done"?"done":"running";A.push({name:W.company,status:ie,started:W.started||0,estMin:W.est_min||(W.memo_type==="detailed"?40:15),url:W.url,error:W.error,memoType:W.memo_type,note:W.note})}return A},[G,K]),ne=A=>ke.find(J=>_e(J.name)===_e(A))||null,ve=(A,J)=>{ue(W=>W.some(te=>_e(te.name)===_e(A.name))?W:[...W,{name:A.name,id:A.id,started:Date.now()/1e3,estMin:J==="detailed"?40:15}]),B.current.add(A.id),z()};p.useEffect(()=>{if(document.querySelector(`link[href="${Jr}"]`))return;const A=document.createElement("link");A.rel="stylesheet",A.href=Jr,document.head.appendChild(A)},[]);const oe=(A,J=!1)=>{D(A),$(J),de.current&&clearTimeout(de.current),de.current=setTimeout(()=>D(""),J?4200:2400)},ze=A=>oe(A,!0),Ke=p.useMemo(()=>{const A=new Map;return d.dossiers.forEach(J=>{J.id&&A.set(J.id,J)}),A},[d.dossiers]),ge=p.useMemo(()=>d.dossiers.filter(A=>ea(A,g,Q)),[d.dossiers,g,Q]),Se=p.useRef(!1);p.useEffect(()=>{if(Se.current||e||d.loading||!d.dossiers.length)return;if(!xe.showFunnel||Bc(d.session.token||"")){Se.current=!0;return}Se.current=!0;const A=window.setTimeout(()=>{Xr(d.session.token||""),q(!0)},700);return()=>window.clearTimeout(A)},[e,d.loading,d.dossiers.length,xe.showFunnel,d.session.token]);const Rt=p.useMemo(()=>d.dossiers.filter(A=>Yi(A,g,Q,d.favIds)),[d.dossiers,g,Q,d.favIds]),Pe=p.useMemo(()=>ci(ge.filter(A=>!We(A)),d.favIds),[ge,d.favIds]),Je=p.useRef(!1);p.useEffect(()=>{if(Je.current)return;if(!Q||a==="ops"){Je.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Je.current=!0;return}if(d.loading)return;Je.current=!0;const A=pi(Pe);A!==g.ptab&&c({type:"ptab",tab:A})},[Q,a,n==null?void 0:n.ptab,d.loading,Pe,g.ptab]);const qe=p.useMemo(()=>{const A=yo(d.dossiers);return A?gt(A)===0?l.tourToday:wo(A,i):l.tourNoRun},[d.dossiers,l,i]),st=p.useMemo(()=>d.dossiers.some(A=>!!A.memoUrl||!!A.summary||Dt(A)),[d.dossiers]),[jt,Me]=p.useState(!1);p.useEffect(()=>{if(d.loading){Me(!1);return}if(d.dossiers.length>0||d.error){Me(!0);return}const A=window.setTimeout(()=>Me(!0),6e3);return()=>window.clearTimeout(A)},[d.loading,d.dossiers.length,d.error]);const xt=(d.marketEstimate||0)>0||typeof((In=d.stats)==null?void 0:In.screened)=="number"&&d.stats.screened>0,ut=p.useMemo(()=>[1,0,2,4,5,3].find(A=>(Pe[A]||0)>0)??0,[Pe]),Xe=Sn.find(A=>A.key===g.continent),Nt=g.continent==="monde"?l.contWorld:(i==="fr"?Xe==null?void 0:Xe.fr:Xe==null?void 0:Xe.en)||"";p.useEffect(()=>{const A=J=>{var te;const W=(((te=J.detail)==null?void 0:te.name)||"").trim();W&&bt(null,W)};return window.addEventListener("ppmap:evaluate",A),()=>window.removeEventListener("ppmap:evaluate",A)}),p.useEffect(()=>{const A=J=>{const W=J.detail||{},te=String(W.id||"").trim(),ie=String(W.name||"").trim(),He=String(W.url||"").trim(),Ee=te&&Ke.get(te)||Oc(d.dossiers,ie,He);if(Ee){if(y(null),ea(Ee,g,Q)||(g.continent!=="monde"&&Ee.continent!==g.continent&&c({type:"continent",key:Ee.continent||"monde"}),c({type:"reset"})),Q&&Ee.kind!=="op"){const it=Ne(Ee);typeof it=="number"&&it!==g.ptab&&c({type:"ptab",tab:it})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),c({type:"focus",id:Ee.id}),(Ee.noCo||["media","nominations","recrutements"].includes(Ee.engine||""))&&(Ee.url||Ee.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee.url||"",text:[Ee.headline,Ee.tagline].filter(Boolean).join(`
`)}})):Ee.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ee.name,url:Ee.url||"",website:Ee.website||"",domain:Ee.domain||""}}));return}!ie&&!He||(c({type:"focus",id:te||null}),y({name:ie,headline:String(W.text||"").trim()||ie,url:He,card:W.card}),He&&(Ea(ie)||!ie)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:He,text:String(W.text||"").trim()}})):ie&&!Ea(ie)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ie}})))};return window.addEventListener("ppmap:focus",A),()=>window.removeEventListener("ppmap:focus",A)}),p.useEffect(()=>{const A=te=>{const ie={},He=String((te==null?void 0:te.sector)||"").trim();He&&(ie.sector=[He]);const Ee=String((te==null?void 0:te.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ee)&&(ie.day=Ee);const Be=String((te==null?void 0:te.search)||"").trim();Be&&(ie.search=Be);const it=String((te==null?void 0:te.dealKind)||"").trim();(it==="ma"||it==="levee"||it==="other")&&(ie.dealKind=[it]),Object.keys(ie).length&&c({type:"filters",patch:ie})},J=te=>A(te.detail),W=te=>{te.data&&te.data.type==="pp-filter"&&A(te.data)};return window.addEventListener("ppmap:filter",J),window.addEventListener("message",W),()=>{window.removeEventListener("ppmap:filter",J),window.removeEventListener("message",W)}},[]),p.useEffect(()=>{const A=J=>{var ie;const W=(((ie=J.detail)==null?void 0:ie.name)||"").trim().toLowerCase();if(!W)return;const te=d.dossiers.find(He=>(He.name||"").trim().toLowerCase()===W);te&&c(a==="ops"?{type:"focus",id:te.id}:{type:"popup",id:te.id})};return window.addEventListener("ppmap:similar",A),()=>window.removeEventListener("ppmap:similar",A)});const bt=(A,J,W)=>{const te=(W||(A==null?void 0:A.name)||J||"").trim();if(!he){k({kicker:te});return}!te||C||(R(!0),(async()=>{try{let ie=(J||te).trim();const He=((A==null?void 0:A.website)||(A==null?void 0:A.domain)||"").trim();if(!(/^https?:\/\//i.test(ie)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(ie)&&!/\s/.test(ie)))if(He)ie=He;else try{const Fe=await Cn(te);if(Fe!=null&&Fe.website)ie=Fe.website;else if(((Fe==null?void 0:Fe.candidates)||[]).length===1)ie=Fe.candidates[0].url;else if(((Fe==null?void 0:Fe.candidates)||[]).length>1){M.current=[{name:te,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(Fe.candidates||[]).slice(0,5)},...M.current].slice(0,8),z();return}}catch{}const Be=await so(re,ie,"atelier2"),it={name:Be.company||te,verdict:Be.verdict,reason:Be.reason||"",remaining:Be.remaining??null};M.current=[it,...M.current].slice(0,8),Be.verdict==="kept"&&S(Fe=>({...Fe,kept:Fe.kept+1})),Be.verdict==="ruled_out"&&S(Fe=>({...Fe,dropped:Fe.dropped+1}));const Ht=A||d.dossiers.find(Fe=>(Fe.name||"").toLowerCase()===te.toLowerCase());Ht&&(Be.verdict==="kept"?Ht.verdict=Ht.verdict||"MATCH":Be.verdict==="ruled_out"&&(Ht.verdict="NO MATCH"),Be.reason&&(Ht.reasoning=Be.reason)),z()}finally{R(!1)}})())},vt=A=>{if(!he){k({kicker:A.name});return}ve(A,"instant"),Vt(re,"fast_request",A.name||"",""),oe(l.memoInstantSent(A.name))},Ft=A=>fe.current.get(A.id)??d.thumbs.get((A.name||"").trim().toLowerCase()),Et=(A,J)=>c({type:"undoPush",entry:{id:A.id,name:A.name,prevCeoStatus:J}}),Re=async(A,J,W)=>{const te=A.ceoStatus||"";A.ceoStatus=J,z();const ie=await Ua(re,{status:J,airtable_id:A.airtableId,check_id:A.checkId,company:A.name,...(W==null?void 0:W.note)!==void 0?{note:W.note}:{},...W!=null&&W.via?{via:W.via}:{}});return ie.ok?ie.skipped?(A.ceoStatus=te,z(),ze(l.actNotPersisted),!1):((W==null?void 0:W.undo)!==!1&&Et(A,te),W!=null&&W.msg&&oe(W.msg),(J==="Validé"||J==="Écarté")&&!A.ceoNote&&(W==null?void 0:W.note)===void 0&&I({o:A,yes:J==="Validé"}),!0):(A.ceoStatus=te,z(),ze(l.actErr),!1)},nt=async(A,J)=>{const W=await Ua(re,{status:A.ceoStatus||"Retenu",airtable_id:A.airtableId,check_id:A.checkId,company:A.name,note:J,via:"note"});return!W.ok||W.skipped?(ze(W.skipped?l.actNotPersisted:l.actErr),!1):(A.ceoNote=J,z(),!0)},L=p.useRef(new Map),H=A=>L.current.has(A.id)?L.current.get(A.id):d.stages.get((A.name||"").trim().toLowerCase()),Y=(A,J)=>{L.current.set(A.id,J),z()},ae=(A,J)=>{he&&Re(A,J?"Validé":"Écarté",{msg:J?l.decidedYes(A.name):l.decidedNo(A.name)})},ye=A=>{he&&Re(A,"À trancher",{msg:l.promoted(A.name)})},P=A=>{he&&(async()=>{const J=A.ceoStatus||"";A.ceoStatus="Retenu",z();const W=await Ua(re,{status:"Retenu",check_id:A.checkId,company:A.name});if(!W.ok||W.skipped){A.ceoStatus=J,z(),ze(W.skipped?l.actNotPersisted:l.actErr);return}Et(A,J),oe(l.repeched(A.name))})()},ee=()=>{const A=g.undo[g.undo.length-1];if(!A){oe(l.undoNone);return}const J=Ke.get(A.id);if(!J){c({type:"undoPop"}),oe(l.undoNone);return}let W=A.prevCeoStatus;if(!W)if((J.verdict||"").toUpperCase().includes("CALL"))W="À trancher";else{oe(l.undoLockedTitle);return}(async()=>await Re(J,W,{undo:!1})&&(c({type:"undoPop"}),J.ceoStatus=A.prevCeoStatus,z(),oe(l.undoDone(J.name))))()},se=A=>{he&&(_.current.add(A.id),z(),c({type:"approachOpen",id:A.id}),Vt(re,"approach",A.name||"",""))},Z=(A,J)=>{he&&(async()=>{if(!(await Vt(re,J?"yes":"no",A.name||"",(A.ceoNote||"").slice(0,400),A.sector||"")).ok){ze(l.actErr);return}fe.current.set(A.id,J?"yes":"no"),z(),oe(J?l.thumbUpDone:l.thumbDnDone)})()},je=A=>{!he||!Dt(A)||(ve(A,"detailed"),Vt(re,"detailed_request",A.name||"",""),oe(l.memoDeepSent(A.name)))},De=A=>{const J=new Set(d.favIds),W=J.has(A.id);W?J.delete(A.id):J.add(A.id),d.setFavIds(J),he&&xi(re,{id:A.id,co:A.name},W)},$e=()=>{!he||U||window.confirm(l.identSyncConfirm)&&(X(!0),(async()=>{const A=await bi(re);X(!1),A?oe(l.identSyncDone):ze(l.actErr)})())},Ae=/proplace/i.test(d.fund||""),Ue=A=>{!he||!Ae||(Vt(re,"onboard_request",A.name||"",""),oe(l.onboardSent(A.name)))},Pa={st:g,dispatch:c,t:l,lang:i,mode:pe,caps:xe,pipe:Q,token:re,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:P,thumbOf:Ft,canWrite:he,commitStatus:Re,saveNote:nt,stageOf:H,setStage:Y,flashErr:ze,startTour:()=>q(!0),dossiers:d.dossiers,scopedAll:ge,scoped:Rt,counts:Pe,byId:Ke,contName:Nt,favIds:d.favIds,toggleFav:De,askEvaluate:bt,doAnalyse:vt,doDecide:ae,doPromote:ye,doApproach:se,doThumb:Z,doDeep:je,doUndo:ee,doSync:$e,doOnboard:Ue,outbound:Ae,memoQueued:B.current,liveMemos:{items:ke,serverOff:le,liveOf:ne},approachDone:_.current,sessTally:N,evalCards:M.current,evalBusy:C,markRow:w,markedId:v,flash:oe,focusExtra:f};p.useEffect(()=>{const A=J=>{J.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[]);const la=A=>re?t.jsx(Ji,{token:re,children:A}):t.jsx(t.Fragment,{children:A});return t.jsx(Zo.Provider,{value:Pa,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(re?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Mi}),la(t.jsxs("div",{className:"app"+(Q?" pipe":"")+(re?" has-thesis":""),children:[xe.showTicker&&t.jsx(rt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(re?" live-stack--cibles":""),children:[t.jsx(rl,{}),!!re&&t.jsx(Xi,{})]})}),xe.showIdent&&t.jsx(rt,{name:"identite",children:t.jsx(gl,{})}),!1,Ic,xe.showFunnel&&t.jsx(rt,{name:"entonnoir",children:t.jsx($c,{})}),!g.mapFolded&&t.jsx(rt,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(_o,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Mc,{}),a!=="ops"&&xe.showFunnel&&t.jsx(Dc,{}),t.jsx(fd,{}),t.jsx(Bo,{})]})]})}),xe.showDemand&&Q&&t.jsx(rt,{name:"direct",children:t.jsx(ji,{items:ke,serverOff:le,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([A,J])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===A,onClick:()=>{m(A);try{localStorage.setItem("atl2:chrome-mode",A)}catch{}},children:J},A))}),xe.showDemand&&t.jsx(rt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(kd,{})})}),xe.showDemand&&g.memoConsole&&t.jsx(rt,{name:"console",children:t.jsx(Nd,{})}),xe.pipe&&!!re&&t.jsx(rt,{name:"moteurs",children:t.jsx(Ai,{})}),t.jsx(rt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(tc,{})}),d.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:l.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(rt,{name:"fiche",children:t.jsx(Id,{})}),t.jsx(rt,{name:"modales",children:t.jsx(dc,{})}),t.jsx(il,{}),O&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:O.o.name}),t.jsx(ul,{placeholder:O.yes?l.whyYesPh:l.whyNoPh,onDone:A=>{const J=O.o;I(null),A&&nt(J,A).then(W=>{W&&oe(l.csNoteSaved)})}})]}),h&&jt&&t.jsx(fl,{steps:_c(l,qe,st,ut,xt,Pe[3]||0),onClose:()=>{q(!1),Xr(re)}}),t.jsx(Pc,{}),xe.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:bo,children:qn}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),T&&t.jsx("div",{className:"flash on"+(F?" err":""),children:T}),j&&t.jsx(ui,{variant:"acquirer",initialCompany:Zr().co,initialWebsite:Zr().site,onClose:()=>k(null)})]})})}function $c(){const{t:e}=V(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Zr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Uc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{es as FlagCell,wt as SigBadge,Ia as SigWin,Wc as default,Uc as fmtShort,V as useV2};
