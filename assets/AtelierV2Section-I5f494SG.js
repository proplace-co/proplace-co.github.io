...
`,Yi=Vi+Wi;function Ga(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Gi(){const e=Ga("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ki(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Gi();return r==="0"?"client":r==="1"||Ga("embed")==="1"&&Ga("chrome")==="1"?"apercu":"client"}const Qi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ji=e=>Qi[e];function ga(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const vt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Er(a)||ga(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ro(e.cc)})};function Fa(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Xi=60*60*1e3;function Zi(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Xi?null:a}catch{return null}}function aa(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const es=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function ts(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:jo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Ki(e,i),[e,i,n]),l=m.useMemo(()=>Ji(o),[o]),d=o!=="visiteur",c=es(r),[f,s]=m.useState([]),[x,u]=m.useState(""),[h,p]=m.useState(null),[b,y]=m.useState(null),[g,j]=m.useState(null),[N,w]=m.useState(()=>new Map),[C,T]=m.useState(()=>new Map),[A,L]=m.useState(""),[z,S]=m.useState(new Set),[R,_]=m.useState(null),[M,O]=m.useState(!0),[v,q]=m.useState(!1),[H,B]=m.useState(0),[U,W]=m.useState(0),X=m.useRef(0),Y=m.useMemo(()=>{var te;if(o!=="client")return"";try{return((te=No())==null?void 0:te.email)||""}catch{return""}},[o]);m.useEffect(()=>{const te=++X.current;let we=!0;const G=()=>we&&te===X.current,pe=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),xe=Zi(pe);return xe?(s(xe.objs.map(vt)),xe.fund&&u(xe.fund),p(xe.marketEstimate??null),y(xe.criteria??null),j(xe.stats??null),L(xe.generatedAt||""),O(!1)):O(!0),(async()=>{try{if(r==="ops"){const ue=await Ma(),ke=((ue==null?void 0:ue.recent_ops)||[]).map(J=>{const Z=ua(J.company_name||J.title?J:{...J,title:(J.headline_fr||J.headline||"").slice(0,120)},a),K=String(J.rubrique||"").toLowerCase();return Z&&(K==="nominations"||K==="recrutements")&&(Z.engine=K),Z&&!String(J.company_name||"").trim()&&(Z.noCo=!0),Z}).filter(J=>!!J).map(J=>(Er((J.name||"").trim())||(J.noCo=!0),J));try{const J=So(),Z=J&&J.doc||await Eo(),K=Co(Z),ee=((J==null?void 0:J.day)||(Z==null?void 0:Z.date)||"").slice(0,10);if(ee&&K.length){const me=new Set;for(const re of ke){if((re.date||"").slice(0,10)!==ee)continue;const fe=zn(K,me,re.name,"");fe>=0&&(me.add(fe),re.decryptHtml=K[fe].html)}for(const re of ke){if(re.decryptHtml||(re.date||"").slice(0,10)!==ee)continue;const fe=zn(K,me,"",re.headline||re.tagline||re.name);fe>=0&&(me.add(fe),re.decryptHtml=K[fe].html)}}if(ee){const me=((Z==null?void 0:Z.title_fr)||"").trim(),re=((Z==null?void 0:Z.lead_fr)||"").trim(),fe=zo(Z),he=((Z==null?void 0:Z.url)||"").trim();me&&(fe||he)&&ke.unshift({id:`edito:${ee}`,kind:"op",name:me,cc:null,date:ee,engine:"edito",dealKind:"other",headline:re||me,tagline:re||me,decryptHtml:fe||void 0,url:he,noCo:!0})}}catch{}if(!G())return;s(ke.map(vt)),aa(pe,{objs:ke})}else if(typeof r=="object"){const ke=(await An()||[]).filter(Z=>(Z.slug||"")===r.research).map(Z=>Tn(Z,a)).filter(Z=>!!Z),J=Fa(await Ln(ke,a));if(!G())return;s(J.map(vt)),aa(pe,{objs:J})}else if(d&&i.token){const ue=Ao(i.token),ke=Ma(),J=To(i.token),Z=Lo(i.token),K=qo(i.token),ee=await ue;let me=ee?ee.targets:[];G()&&ee&&(u(ee.fund||""),p(ee.marketEstimate??null),y(ee.criteria??null),j(ee.stats??null),L(ee.generatedAt||""),s(me.map(vt)),O(!1),q(!1));const[re,fe,he,ge]=await Promise.all([ke,J,Z,K]),Re=((re==null?void 0:re.recent_ops)||[]).map(Ae=>ua(Ae,a)).filter(Ae=>!!Ae);if(me=[...me,...Re],!G())return;s(me.map(vt));const le=new Set;for(const Ae of fe){const Te=(Ae.id||Ae.co||"").toString().trim().toLowerCase();Te&&le.add(Te.startsWith("t:")?Te:"t:"+Te)}S(le),w(he),T(ge),ee&&aa(pe,{fund:ee.fund,marketEstimate:ee.marketEstimate,criteria:ee.criteria,stats:ee.stats,generatedAt:ee.generatedAt,objs:me})}else{const ue=Mo(),ke=An(),J=Ma(),Z=await ue;G()&&Z.length&&(s(Fa(Z).map(vt)),O(!1),q(!1));const[K,ee]=await Promise.all([ke,J]),me=(K||[]).map(ge=>Tn(ge,a)).filter(ge=>!!ge),re=await Ln(me,a),fe=((ee==null?void 0:ee.recent_ops)||[]).map(ge=>ua(ge,a)).filter(ge=>!!ge),he=Fa([...Z,...re,...fe]);if(!G())return;s(he.map(vt)),aa(pe,{objs:he})}G()&&q(!1)}catch{G()&&!xe&&q(!0)}finally{G()&&O(!1)}})(),()=>{we=!1}},[d,i.token,a,H,c]),m.useEffect(()=>{if(!l.showCredits||!Y){_(null);return}let te=!0;return(async()=>{try{const we=await fetch(`${pn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Y})});if(!we.ok)return;const G=await we.json();te&&G&&G.ok!==!1&&_(G)}catch{}})(),()=>{te=!1}},[l.showCredits,Y,U]);const oe=m.useCallback(te=>S(new Set(te)),[]);return{session:i,mode:o,caps:l,fund:x,email:Y,marketEstimate:h,generatedAt:A,criteria:b,stats:g,thumbs:N,stages:C,dossiers:f,favIds:z,setFavIds:oe,credits:R,reloadCredits:()=>W(te=>te+1),loading:M,error:v,refresh:()=>B(te=>te+1)}}function ot(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Tr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),as=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Tr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ns=new Set(["signal","amount","score","crible","memo"]);function rs(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Tr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ns.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Lr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Lr=80;function ba(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(un(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(dt(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&kt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function qr(e,a,r){return ot(e)?ba(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ba(e,a.filters,r)}function os(e,a,r,n){return!(!qr(e,a,r)||r&&!Fo(e,a.ptab,n))}function hn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-dt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Po(i);case"memo":return Oo(i);case"signal":{const o=Me(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const Oa={},$n=(Oa==null?void 0:Oa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function _n(){return new Date().toISOString().slice(0,10)}const gn=m.createContext(null);function Mr(){return m.useContext(gn)}function is(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const f=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(c.setAttribute("href",f),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function Un(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Rr(){const e=m.useContext(gn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ss({token:e,children:a}){const{dispatch:r,st:n,lang:i}=$(),[o,l]=m.useState(()=>n.filters.day||_n()),[d,c]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l(_n());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=y=>{var j;const g=(j=y.detail)==null?void 0:j.day;typeof g=="string"&&x(g)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${$n}/cibles/edition.json?${y}`).then(g=>g.json()).then(g=>{b||c(g)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const h=m.useMemo(()=>`${$n}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:d,loading:f,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:h,isEn:i==="en"}),[e,o,d,f,x,u,n.filters.day,h,i]);return t.jsx(gn.Provider,{value:p,children:a})}function ls(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Rr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Do,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})]})}function ds(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Rr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
