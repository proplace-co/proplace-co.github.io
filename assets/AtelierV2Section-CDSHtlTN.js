...
`,Xi=Qi+Ji;function Ja(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Zi(){const e=Ja("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function es(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Zi();return r==="0"?"client":r==="1"||Ja("embed")==="1"&&Ja("chrome")==="1"?"apercu":"client"}const ts={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},as=e=>ts[e];function wa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const wt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Tr(a)||wa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:_o(e.cc)})};function Pa(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const ns=60*60*1e3;function rs(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>ns?null:a}catch{return null}}function ia(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const os=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function is(e,a,r="default"){const n=r!=="default",o=u.useMemo(()=>e||n?{mode:"anon"}:qo(),[e,n]),i=u.useMemo(()=>n?"visiteur":es(e,o),[e,o,n]),l=u.useMemo(()=>as(i),[i]),d=i!=="visiteur",c=os(r),[g,s]=u.useState([]),[h,p]=u.useState(""),[b,m]=u.useState(null),[v,y]=u.useState(null),[f,N]=u.useState(null),[S,k]=u.useState(()=>new Map),[j,z]=u.useState(()=>new Map),[E,q]=u.useState(""),[C,R]=u.useState(new Set),[I,$]=u.useState(null),[L,F]=u.useState(!0),[x,T]=u.useState(!1),[B,W]=u.useState(0),[V,Q]=u.useState(0),Z=u.useRef(0),J=u.useMemo(()=>{var te;if(i!=="client")return"";try{return((te=Lo())==null?void 0:te.email)||""}catch{return""}},[i]);u.useEffect(()=>{const te=++Z.current;let xe=!0;const U=()=>xe&&te===Z.current,de=(d&&o.token?o.token:"pub:"+a)+(c?":"+c:""),he=rs(de);return he?(s(he.objs.map(wt)),he.fund&&p(he.fund),m(he.marketEstimate??null),y(he.criteria??null),N(he.stats??null),q(he.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const ae=await Ma(),ze=((ae==null?void 0:ae.recent_ops)||[]).map(ie=>{const me=xa(ie.company_name||ie.title?ie:{...ie,title:(ie.headline_fr||ie.headline||"").slice(0,120)},a),se=String(ie.rubrique||"").toLowerCase();return me&&(se==="nominations"||se==="recrutements")&&(me.engine=se),me&&!String(ie.company_name||"").trim()&&(me.noCo=!0),me}).filter(ie=>!!ie).map(ie=>(Tr((ie.name||"").trim())||(ie.noCo=!0),ie));try{const ie=Fo(),me=await Ro(),se=((me==null?void 0:me.date)||"").slice(0,10),K=ie?ie.doc:me,G=Mo(K),le=((ie==null?void 0:ie.day)||(K==null?void 0:K.date)||se||"").slice(0,10);if(le&&G.length){const Se=new Set;for(const ce of ze){if((ce.date||"").slice(0,10)!==le)continue;const oe=Tn(G,Se,ce.name,"");oe>=0&&(Se.add(oe),ce.decryptHtml=G[oe].html)}for(const ce of ze){if(ce.decryptHtml||(ce.date||"").slice(0,10)!==le)continue;const oe=Tn(G,Se,"",ce.headline||ce.tagline||ce.name);oe>=0&&(Se.add(oe),ce.decryptHtml=G[oe].html)}}if(le){const Se=((K==null?void 0:K.title_fr)||"").trim(),ce=((K==null?void 0:K.lead_fr)||"").trim(),oe=Oo(K),ke=((K==null?void 0:K.url)||"").trim();Se&&(oe||ke)&&ze.unshift({id:`edito:${le}`,kind:"op",name:Se,cc:null,date:le,engine:"edito",dealKind:"other",headline:Se,tagline:ce||Se,decryptHtml:oe||void 0,url:ke,noCo:!0})}}catch{}if(!U())return;s(ze.map(wt)),ia(de,{objs:ze})}else if(typeof r=="object"){const ze=(await qn()||[]).filter(me=>(me.slug||"")===r.research).map(me=>Ln(me,a)).filter(me=>!!me),ie=Pa(await Fn(ze,a));if(!U())return;s(ie.map(wt)),ia(de,{objs:ie})}else if(d&&o.token){const ae=Do(o.token),ze=Ma(),ie=Po(o.token),me=Io(o.token),se=Bo(o.token),K=await ae;let G=K?K.targets:[];U()&&K&&(p(K.fund||""),m(K.marketEstimate??null),y(K.criteria??null),N(K.stats??null),q(K.generatedAt||""),s(G.map(wt)),F(!1),T(!1));const[le,Se,ce,oe]=await Promise.all([ze,ie,me,se]),ke=((le==null?void 0:le.recent_ops)||[]).map(Re=>xa(Re,a)).filter(Re=>!!Re);if(G=[...G,...ke],!U())return;s(G.map(wt));const Fe=new Set;for(const Re of Se){const ve=(Re.id||Re.co||"").toString().trim().toLowerCase();ve&&Fe.add(ve.startsWith("t:")?ve:"t:"+ve)}R(Fe),k(ce),z(oe),K&&ia(de,{fund:K.fund,marketEstimate:K.marketEstimate,criteria:K.criteria,stats:K.stats,generatedAt:K.generatedAt,objs:G})}else{const ae=$o(),ze=qn(),ie=Ma(),me=await ae;U()&&me.length&&(s(Pa(me).map(wt)),F(!1),T(!1));const[se,K]=await Promise.all([ze,ie]),G=(se||[]).map(oe=>Ln(oe,a)).filter(oe=>!!oe),le=await Fn(G,a),Se=((K==null?void 0:K.recent_ops)||[]).map(oe=>xa(oe,a)).filter(oe=>!!oe),ce=Pa([...me,...le,...Se]);if(!U())return;s(ce.map(wt)),ia(de,{objs:ce})}U()&&T(!1)}catch{U()&&!he&&T(!0)}finally{U()&&F(!1)}})(),()=>{xe=!1}},[d,o.token,a,B,c]),u.useEffect(()=>{if(!l.showCredits||!J){$(null);return}let te=!0;return(async()=>{try{const xe=await fetch(`${fn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:J})});if(!xe.ok)return;const U=await xe.json();te&&U&&U.ok!==!1&&$(U)}catch{}})(),()=>{te=!1}},[l.showCredits,J,V]);const ue=u.useCallback(te=>R(new Set(te)),[]);return{session:o,mode:i,caps:l,fund:h,email:J,marketEstimate:b,generatedAt:E,criteria:v,stats:f,thumbs:S,stages:j,dossiers:g,favIds:C,setFavIds:ue,credits:I,reloadCredits:()=>Q(te=>te+1),loading:L,error:x,refresh:()=>W(te=>te+1)}}function Xe(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Pr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),ss=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Pr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ls=new Set(["signal","amount","score","crible","memo"]);function ds(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Pr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ls.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Ir)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Ir=80;function ka(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Oe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(hn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(dt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Nt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function Br(e,a,r){return Xe(e)?ka(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ka(e,a.filters,r)}function cs(e,a,r,n){return!(!Br(e,a,r)||r&&!Uo(e,a.ptab,n))}function bn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-dt(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Vo(o);case"memo":return Ho(o);case"signal":{const i=Oe(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),d=n(i);return l<d?-a.dir:l>d?a.dir:(o.name||"").localeCompare(i.name||"")})}const Ia={},Un=(Ia==null?void 0:Ia.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Hn(){return new Date().toISOString().slice(0,10)}const vn=u.createContext(null);function $r(){return u.useContext(vn)}function ps(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),l=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function us(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),l=o.value,d=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(l);!d&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function Vn(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),l=i==="tb-geo"||i==="tb-these"?i:"";[...n.attributes].forEach(d=>n.removeAttribute(d.name)),l&&n.setAttribute("class",l),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Wn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${i} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${i} ${r[1]}`}function _r(){const e=u.useContext(vn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ms({token:e,children:a}){const{dispatch:r,st:n,lang:o}=H(),[i,l]=u.useState(()=>n.filters.day||Hn()),[d,c]=u.useState(null),[g,s]=u.useState(!1),h=u.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){l(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),p=u.useCallback(()=>{l(Hn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);u.useEffect(()=>{const v=y=>{var N;const f=(N=y.detail)==null?void 0:N.day;typeof f=="string"&&h(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[h]),u.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),u.useEffect(()=>{if(!e||!i)return;let v=!1;s(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Un}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{v||c(f)}).catch(()=>{v||c({ok:!1,error:"network"})}).finally(()=>{v||s(!1)}),()=>{v=!0}},[e,i]);const b=u.useMemo(()=>`${Un}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=u.useMemo(()=>({token:e,day:i,ed:d,loading:g,pickDay:h,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,d,g,h,p,n.filters.day,b,o]);return t.jsx(vn.Provider,{value:m,children:a})}function fs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=_r(),[o,i]=u.useState(()=>n||qr());return u.useEffect(()=>{n&&i(!0)},[n]),u.useEffect(()=>{const l=d=>{var c;return i(!!((c=d.detail)!=null&&c.open))};return window.addEventListener(ya,l),()=>window.removeEventListener(ya,l)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Wo,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function hs(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Yn(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Gn(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function xs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=_r(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok,g=u.useRef(null),[s,h]=u.useState("fonds"),[p,b]=u.useState(null),[m,v]=u.useState("idle"),y=u.useRef(!1);u.useEffect(()=>{b(null),v("idle"),y.current=!1,h("fonds")},[e]),u.useEffect(()=>{if(s!=="jour"||y.current)return;y.current=!0;let j=!0;return v("load"),hs(e).then(z=>{j&&(b(z),v("fait"))}),()=>{j=!1}},[s,e]);const f=u.useMemo(()=>us((p==null?void 0:p.html)||""),[p==null?void 0:p.html]),N=u.useRef(null);u.useEffect(()=>{const j=N.current;if(!j||!f)return;let z=!1;return Wa(()=>import("./fit-BnaWm7z_.js"),[]).then(async E=>{await E.ensureEditoCss(),!(z||!j.isConnected)&&(E.beautifyEditoRows(j),E.mountCardFits(j))}),()=>{z=!0}},[f]);const S=u.useMemo(()=>Vn((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=u.useMemo(()=>Vn((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return u.useEffect(()=>{const j=g.current;if(!j||!S)return;let z=!1;return Wa(()=>import("./fit-BnaWm7z_.js"),[]).then(async E=>{await E.ensureEditoCss(),!(z||!j.isConnected)&&(E.beautifyEditoRows(j),E.mountCardFits(j))}),()=>{z=!0}},[S]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
        ...
        .thesis-brief__body,.thesis-brief__acq{font-size:13px;line-height:1.62;color:#1e293b}
        ...
        /* « EN BREF » : un encadré SOBRE, aligné à gauche (29/08 : « en bref est
           mal mis en valeur, c'est centré et moche »). La feuille de /actualites
           le centre — ce qui marche sur une pleine page, pas dans une colonne
           de 600 px. Filet vert à gauche, fond très clair, texte au fer. */
        .thesis-brief__body .ed-lead{text-align:left!important;margin:0 0 20px;
          padding:12px 14px;background:#F6FAF7;border:0;border-left:3px solid #0E8A4F;
          border-radius:0 8px 8px 0}
        .thesis-brief__body .ed-lead *{text-align:left!important}
        .thesis-brief__body .ed-lead p,.thesis-brief__body .ed-lead li{font-size:12.5px;
          line-height:1.65;margin:0 0 8px;color:#334155}
        .thesis-brief__body .ed-lead :last-child{margin-bottom:0}
        .thesis-brief__body .ed-lead h2,.thesis-brief__body .ed-lead h3,
        .thesis-brief__body .ed-lead b,.thesis-brief__body .ed-lead strong{
          display:block;font-size:9.5px;font-weight:700;letter-spacing:.14em;
          text-transform:uppercase;color:#0A6B3D;margin:0 0 7px}
