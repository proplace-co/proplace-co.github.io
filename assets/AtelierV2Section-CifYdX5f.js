...
.atl2 .dfh{margin:0 0 4px;font-size:12px;color:var(--sub);line-height:1.4}
.atl2 .dfh2{margin:0 0 10px;font-size:12px;color:var(--ink);line-height:1.45;font-weight:600}
...
`,Tl=Cl+zl+Al+ql;function bn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ll(){const e=bn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Fl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ll();return r==="0"?"client":r==="1"||bn("embed")==="1"&&bn("chrome")==="1"?"apercu":"client"}const Rl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ol=e=>Rl[e];function Ia(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Lt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!vo(a)||Ia(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ji(e.cc)})};function an(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ml=60*60*1e3;function Dl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ml?null:a}catch{return null}}function va(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Il=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Pl(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:_i(),[e,n]),i=p.useMemo(()=>n?"visiteur":Fl(e,o),[e,o,n]),d=p.useMemo(()=>Ol(i),[i]),s=i!=="visiteur",l=Il(r),[f,c]=p.useState([]),[g,u]=p.useState(""),[b,h]=p.useState(null),[v,w]=p.useState(null),[m,y]=p.useState(null),[E,k]=p.useState(()=>new Map),[j,N]=p.useState(()=>new Map),[q,T]=p.useState(""),[L,z]=p.useState(new Set),[O,U]=p.useState(null),[V,B]=p.useState(!0),[x,F]=p.useState(!1),[C,$]=p.useState(0),[G,S]=p.useState(0),I=p.useRef(0),D=p.useMemo(()=>{var H;if(i!=="client")return"";try{return((H=Bi())==null?void 0:H.email)||""}catch{return""}},[i]);p.useEffect(()=>{const H=++I.current;let ce=!0;const te=()=>ce&&H===I.current,le=(s&&o.token?o.token:"pub:"+a)+(l?":"+l:""),xe=Dl(le);return xe?(c(xe.objs.map(Lt)),xe.fund&&u(xe.fund),h(xe.marketEstimate??null),w(xe.criteria??null),y(xe.stats??null),T(xe.generatedAt||""),B(!1)):B(!0),(async()=>{try{if(r==="ops"){const he=await Xa(),we=((he==null?void 0:he.recent_ops)||[]).map(pe=>{const Ne=Aa(pe.company_name||pe.title?pe:{...pe,title:(pe.headline_fr||pe.headline||"").slice(0,120)},a),ze=String(pe.rubrique||"").toLowerCase();return Ne&&(ze==="nominations"||ze==="recrutements")&&(Ne.engine=ze),Ne&&!String(pe.company_name||"").trim()&&(Ne.noCo=!0),Ne}).filter(pe=>!!pe).map(pe=>(vo((pe.name||"").trim())||(pe.noCo=!0),pe));try{const pe=$i(),Ne=await Ui(),ze=((Ne==null?void 0:Ne.date)||"").slice(0,10),ue=pe?pe.doc:Ne,be=Hi(ue),ye=((pe==null?void 0:pe.day)||(ue==null?void 0:ue.date)||ze||"").slice(0,10);if(ye&&be.length){const ee=new Set;for(const P of we){if((P.date||"").slice(0,10)!==ye)continue;const J=tr(be,ee,P.name,"");J>=0&&(ee.add(J),P.decryptHtml=be[J].html)}for(const P of we){if(P.decryptHtml||(P.date||"").slice(0,10)!==ye)continue;const J=tr(be,ee,"",P.headline||P.tagline||P.name);J>=0&&(ee.add(J),P.decryptHtml=be[J].html)}}if(ye){const ee=((ue==null?void 0:ue.title_fr)||"").trim(),P=((ue==null?void 0:ue.lead_fr)||"").trim(),J=Vi(ue),ie=((ue==null?void 0:ue.url)||"").trim();ee&&(J||ie)&&we.unshift({id:`edito:${ye}`,kind:"op",name:ee,cc:null,date:ye,engine:"edito",dealKind:"other",headline:ee,tagline:P||ee,decryptHtml:J||void 0,url:ie,noCo:!0})}}catch{}if(!te())return;c(we.map(Lt)),va(le,{objs:we})}else if(typeof r=="object"){const we=(await ar()||[]).filter(Ne=>(Ne.slug||"")===r.research).map(Ne=>nr(Ne,a)).filter(Ne=>!!Ne),pe=an(await rr(we,a));if(!te())return;c(pe.map(Lt)),va(le,{objs:pe})}else if(s&&o.token){const he=Wi(o.token),we=Xa(),pe=Gi(o.token),Ne=Yi(o.token),ze=Qi(o.token),ue=await he;let be=ue?ue.targets:[];te()&&ue&&(u(ue.fund||""),h(ue.marketEstimate??null),w(ue.criteria??null),y(ue.stats??null),T(ue.generatedAt||""),c(be.map(Lt)),B(!1),F(!1));const[ye,ee,P,J]=await Promise.all([we,pe,Ne,ze]),ie=((ye==null?void 0:ye.recent_ops)||[]).map(W=>Aa(W,a)).filter(W=>!!W),oe=new Set(be.map(W=>W.id));if(be=[...be,...ie.filter(W=>!oe.has(W.id)&&(oe.add(W.id),!0))],!te())return;c(be.map(Lt));const me=new Set;for(const W of ee){const se=(W.id||W.co||"").toString().trim().toLowerCase();se&&me.add(se.startsWith("t:")?se:"t:"+se)}z(me),k(P),N(J),ue&&va(le,{fund:ue.fund,marketEstimate:ue.marketEstimate,criteria:ue.criteria,stats:ue.stats,generatedAt:ue.generatedAt,objs:be})}else{const he=Ki(),we=ar(),pe=Xa(),Ne=await he;te()&&Ne.length&&(c(an(Ne).map(Lt)),B(!1),F(!1));const[ze,ue]=await Promise.all([we,pe]),be=(ze||[]).map(J=>nr(J,a)).filter(J=>!!J),ye=await rr(be,a),ee=((ue==null?void 0:ue.recent_ops)||[]).map(J=>Aa(J,a)).filter(J=>!!J),P=an([...Ne,...ye,...ee]);if(!te())return;c(P.map(Lt)),va(le,{objs:P})}te()&&F(!1)}catch{te()&&!xe&&F(!0)}finally{te()&&B(!1)}})(),()=>{ce=!1}},[s,o.token,a,C,l]),p.useEffect(()=>{if(!d.showCredits||!D){U(null);return}let H=!0;return(async()=>{try{const ce=await fetch(`${ha}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:D})});if(!ce.ok)return;const te=await ce.json();H&&te&&te.ok!==!1&&U(te)}catch{}})(),()=>{H=!1}},[d.showCredits,D,G]);const Q=p.useCallback(H=>z(new Set(H)),[]);return{session:o,mode:i,caps:d,fund:g,email:D,marketEstimate:b,generatedAt:q,criteria:v,thesisMode:String((v==null?void 0:v.mode)||""),stats:m,thumbs:E,stages:j,dossiers:f,patchStatuses:(H,ce)=>{c(te=>{let le=!1;const xe=te.map(he=>{if(!he.checkId)return he;const we=H.get(he.checkId);return!we||we===(he.ceoStatus||"")||!ce(he.id)?he:(le=!0,{...he,ceoStatus:we})});return le?xe:te})},favIds:L,setFavIds:Q,credits:O,reloadCredits:()=>S(H=>H+1),loading:V,error:x,refresh:()=>$(H=>H+1)}}function Be(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const qa=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Pa(e){return qa.has(e.engine||"")}function Ke(e){return!!e.noCo||Pa(e)&&!!e.url}const Po=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),_l=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Po(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Bl=new Set(["signal","amount","score","crible","memo"]);function $l(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Po(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Bl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??_o)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const _o=80;function _a(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!_e(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Mn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ut(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ft(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(yo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function Rt(e,a,r){return Be(e)?_a(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:_a(e,a.filters,r)}function Ul(e,a,r,n){return!(!Rt(e,a,r)||r&&!wo(e,a.ptab,n))}function Bn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-ut(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Zi(o)||null;case"memo":return Xi(o)||null;case"signal":{const i=_e(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),s=n(i);return d===null||s===null?d===s?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<s?-a.dir:d>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const nn={},Er=(nn==null?void 0:nn.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function jr(){return new Date().toISOString().slice(0,10)}const $n=p.createContext(null);function Bo(){return p.useContext($n)}function Hl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(l=>l.remove()),s.querySelectorAll("*").forEach(l=>{const f=l.tagName==="A"?l.getAttribute("href"):null;[...l.attributes].forEach(c=>l.removeAttribute(c.name)),f&&/^https?:\/\//i.test(f)&&(l.setAttribute("href",f),l.setAttribute("target","_blank"),l.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:s.outerHTML})}}catch{}return a}function $o(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Vl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),l=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!s&&!l&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),$o(r),r.innerHTML):e}catch{return e}}function Nr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),$o(r),r.innerHTML):e}catch{return e}}function Sr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Uo(){const e=p.useContext($n);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Wl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Z(),[i,d]=p.useState(()=>n.filters.day||jr()),[s,l]=p.useState(null),[f,c]=p.useState(!1),g=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){d(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{d(jr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=w=>{var y;const m=(y=w.detail)==null?void 0:y.day;typeof m=="string"&&g(m)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[g]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let v=!1;c(!0);const w=new URLSearchParams({token:e,date:i});return fetch(`${Er}/cibles/edition.json?${w}`).then(m=>m.json()).then(m=>{v||l(m)}).catch(()=>{v||l({ok:!1,error:"network"})}).finally(()=>{v||c(!1)}),()=>{v=!0}},[e,i]);const b=p.useMemo(()=>`${Er}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),h=p.useMemo(()=>({token:e,day:i,ed:s,loading:f,pickDay:g,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,f,g,u,n.filters.day,b,o]);return t.jsx($n.Provider,{value:h,children:a})}function Gl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Uo(),[o,i]=p.useState(()=>n||ko());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const d=s=>{var l;return i(!!((l=s.detail)!=null&&l.open))};return window.addEventListener(Ra,d),()=>window.removeEventListener(Ra,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(es,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Yl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Cr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function zr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Ql(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Uo(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!d,l=a&&!a.ok,f=p.useRef(null),[c,g]=p.useState("fonds"),[u,b]=p.useState(null),[h,v]=p.useState("idle"),w=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),w.current=!1,g("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||w.current)return;w.current=!0;let j=!0;return v("load"),Yl(e).then(N=>{j&&(b(N),v("fait"))}),()=>{j=!1}},[c,e]);const m=p.useMemo(()=>Vl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),y=p.useRef(null);p.useEffect(()=>{const j=y.current;if(!j||!m)return;let N=!1;return hn(()=>import("./fit-DX-mzLKR.js"),[]).then(async q=>{await q.ensureEditoCss(),!(N||!j.isConnected)&&(q.beautifyEditoRows(j),q.mountCardFits(j))}),()=>{N=!0}},[m]);const E=p.useMemo(()=>Nr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>Nr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const j=f.current;if(!j||!E)return;let N=!1;return hn(()=>import("./fit-DX-mzLKR.js"),[]).then(async q=>{await q.ensureEditoCss(),!(N||!j.isConnected)&&(q.beautifyEditoRows(j),q.mountCardFits(j))}),()=>{N=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const j=(a==null?void 0:a.date)||e,N=/^(\d{4})-(\d{2})-(\d{2})/.exec(j);return N?i?`${N[2]}/${N[3]}/${N[1]}`:`${N[3]}/${N[2]}/${N[1]}`:j})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>g("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>g("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&l&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Cr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Sr(e,!0)}),"."]}):Cr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Sr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>g("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&d&&E?t.jsx("div",{ref:f,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,c==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(m?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title thesis-brief__jour-h",children:u.title}),t.jsx("div",{ref:y,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:m}})]}):t.jsx("p",{className:h==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:h!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:zr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:zr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Kl=300,wa=7,Jl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Ho={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Xl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function ya(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(rs(r)&&r!=="media")return"news:"+r;const n=_e(e);return n?"sig:"+(n.theme&&Ho.fr[n.theme]?n.theme:"other"):"actualites"}function Zl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:s}=Z(),l=Bo(),f=d==="en",[c,g]=p.useState("all"),[u,b]=p.useState(!1),h=p.useMemo(()=>{var ce;const x=(a.filters.day||"").slice(0,10),F=te=>!(!i&&a.continent!=="monde"&&te.continent!==a.continent||x&&(te.date||"").slice(0,10)!==x),C=e.filter(te=>F(te)&&_e(te)&&(!i||te.kind!=="target"||Te(te)!==5)),$=i&&(((ce=l==null?void 0:l.ed)==null?void 0:ce.ops)||[]).length?l.ed.ops.map(te=>Aa(te,d)).filter(te=>!!te).map(te=>(te.briefOnly=!0,te)).filter(te=>!x||(te.date||"").slice(0,10)===x):[],G=e.filter(te=>F(te)&&te.kind==="op"&&(x?!0:ut(te.date)<=wa)),S=i?$.length?$:G.filter(te=>{const le=(s||"").trim().toLowerCase();if(!le)return!1;const xe=te.match||null;return xe?Object.keys(xe).map(he=>he.trim().toLowerCase()).includes(le):!1}):G,I=x||new Date().toISOString().slice(0,10),D=te=>{const le=ya(te);return le==="ma"?0:le==="levees"?1:2};S.sort((te,le)=>{const xe=D(te)-D(le);if(xe)return xe;const he=(te.date||"").slice(0,10)===I?0:1,we=(le.date||"").slice(0,10)===I?0:1;return he!==we?he-we:(le.amountEur||0)-(te.amountEur||0)});const Q=new Set,H=[];for(const te of[...S,...Bn(C,{key:"signal",dir:-1})]){const le=te.id||te.name;!le||Q.has(le)||(Q.add(le),H.push(te))}return i&&H.length===0?e.filter(le=>F(le)&&ut(le.date)<=wa).sort((le,xe)=>(xe.date||"").localeCompare(le.date||"")).slice(0,80):H},[e,a.continent,a.filters.day,i,s,d,l]),v=p.useMemo(()=>{const x={};for(const F of h){const C=ya(F);x[C]=(x[C]||0)+1}return x},[h]),w=p.useMemo(()=>c==="all"?h:h.filter(x=>ya(x)===c),[h,c]),m=p.useMemo(()=>w.slice(0,Kl),[w]),y=w.length-m.length,E=p.useRef(null);p.useEffect(()=>{var S,I;const x=E.current;if(!x)return;const F=()=>{const D=x.scrollWidth;D<200||(x.style.animationDuration=Math.max(18,Math.round(D/130))+"s")};F();const C=requestAnimationFrame(F),$=window.setTimeout(F,1200);let G=!0;return(I=(S=document.fonts)==null?void 0:S.ready)==null||I.then(()=>{G&&F()}),()=>{G=!1,cancelAnimationFrame(C),window.clearTimeout($)}},[m.length,c]);const k=x=>x==="all"?h.length:v[x]||0,j=x=>{if(x==="all")return f?"All":"Tout";if(x.startsWith("sig:"))return Ho[f?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const F=x.slice(5);return as[F]?ns(F,f?"en":"fr"):x}return Jl[f?"en":"fr"][x]},N=[{k:"all"}],q=["ma","levees"].filter(x=>k(x)>0||x===c);if(q.length){N.push({g:f?"Deals":"Opérations"});for(const x of q)N.push({k:x})}const T=["nominations","recrutements"].filter(x=>k(x)>0||x===c),L=ts.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===c),z=k("actualites")>0||c==="actualites"?["actualites"]:[];if(T.length||L.length||z.length){N.push({g:f?"News":"Actualités"});for(const x of T)N.push({k:x});for(const x of L)N.push({k:x});for(const x of z)N.push({k:x})}const O=Xl.map(x=>"sig:"+x).filter(x=>k(x)>0||x===c);if(O.length){N.push({g:f?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of O)N.push({k:x})}const U=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},V=(()=>{const x=(a.filters.day||"").slice(0,10),F=!i&&a.continent!=="monde"&&o?f?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(f?`LIVE covers the events of ${U(x)}.`:`Le LIVE regroupe les événements du ${U(x)}.`)+F:(f?`LIVE covers the still-open signals and the deals of the last ${wa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${wa} derniers jours.`)+F})(),B=x=>m.map(F=>t.jsxs("button",{type:"button",className:"tk"+(Ue(F)?" spent":""),onClick:C=>{const $=F.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:$?"":F.id,name:F.name,url:F.url||"",text:F.tagline||F.headline||"",card:F.card}}))}catch{}if($||n({type:"focus",id:F.id}),a.dens!=="liste"){const G=C.currentTarget.getBoundingClientRect();n({type:"popup",id:F.id,anchor:{x:G.left+G.width/2,y:G.bottom}})}},title:Ue(F)?f?`${F.name} — already screened (dimmed)`:`${F.name} — déjà évaluée (grisée)`:F.name+(F.tagline?" — "+F.tagline:""),children:[t.jsx(Ct,{o:F}),t.jsxs("span",{className:"who",children:[t.jsx(Ci,{o:F}),t.jsx("span",{className:"co",children:F.name})]}),(()=>{const C=(F.tagline||F.headline||"").trim();if(C&&C!==F.name)return t.jsx("span",{className:"what",children:C});const $=ya(F),G=$==="ma"?f?"M&A deal":"opération M&A":$==="levees"?f?"fundraising":"levée de fonds":$==="nominations"?f?"appointment":"nomination":$==="recrutements"?f?"hiring":"recrutement":$.startsWith("sig:")?f?"engine signal":"signal moteur":$.startsWith("news:")?f?"news":"actualité":F.kind==="target"?f?"sourced target":"cible sourcée":f?"news item":"actualité";return t.jsx("span",{className:"what dim",children:G})})(),typeof F.amountEur=="number"&&F.amountEur>0&&t.jsx("span",{className:"am",children:Zc(F.amountEur)}),F.sector&&t.jsx("span",{className:"mt",children:F.sector}),t.jsx(Ka,{o:F}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(F.id||F.name))).concat(y>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${y} more — filter by section to see them`:`+ ${y} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(x=>!x),children:[j(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:V}),N.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===c,onClick:()=>{g(x.k),b(!1)},children:[j(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:m.length?t.jsxs("div",{className:"run",ref:E,children:[B(0),B(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!l&&t.jsxs("button",{type:"button",className:"tk-edito",title:f?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",f?"Today's editorial":"Edito du jour"]}),!!l&&t.jsx(td,{isEn:f})]})}const ed=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function td({isEn:e}){const[a,r]=p.useState(()=>ko());p.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Ra,o),()=>window.removeEventListener(Ra,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>os(!a),children:ed})}class pt extends p.Component{constructor(){super(...arguments);Xn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Vo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Ar(e,a){if((zt(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return Vo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const qr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",ad={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function nd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=Z(),[s,l]=p.useState(""),[f,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!g)return;const y=E=>{b.current&&!b.current.contains(E.target)&&(u(!1),c(!1))};return document.addEventListener("click",y,!0),()=>document.removeEventListener("click",y,!0)},[g]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const h=(e.ceoStatus||"").trim(),v=async y=>{if(s)return;if(y==="Analysé"&&!e.memoUrl){c(!0);return}l(y);const E=(Ar(e,a).find(([j])=>j===y)||[y,y])[1],k=await o(e,y,{msg:a.csMoved(e.name,E)});l(""),k&&(c(!1),u(!1))},w=Ar(e,a),m=y=>(w.find(([E])=>E===y)||[])[1]||y;return w.length===2?t.jsx("span",{className:"rstat rst2",onClick:y=>y.stopPropagation(),children:w.map(([y,E])=>t.jsx("button",{type:"button",className:"rsd "+(y==="Validé"?"yes":"no")+(s===y?" busy":""),disabled:!!s,onClick:()=>{v(y)},children:E},y))}):t.jsxs("span",{className:"rstat"+(g||f?" rs-open":""),ref:b,onClick:y=>y.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":g,disabled:!!s,title:a.csLabel,className:"rsel rs-"+qr(h),onClick:()=>{u(y=>!y),c(!1)},children:s?m(s)+"…":h?m(h):a.csNone}),g&&!f&&t.jsx("span",{className:"rsmenu",role:"listbox",children:w.map(([y,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":h===y,className:"rsopt"+(h===y?" on":"")+(s===y?" busy":""),disabled:!!s,onClick:()=>{if(y===h){u(!1);return}v(y)},children:[t.jsx("i",{className:"pt2",style:{background:ad[qr(y)]}}),E]},y))}),f&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),c(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const y=await o(e,"Analysé");l(""),y&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function rd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Z(),[i,d]=p.useState(""),[s,l]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),c=(zt(e)||"").startsWith("CALL")&&Te(e)===3,g=Te(e)>=2,u=async h=>{if(i||h==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(h);const v=await o(e,h);d(""),v&&(l(!0),setTimeout(()=>l(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:Vo.filter(([h])=>!(g&&h==="Retenu")).map(([h,v])=>[h,a[v]]);return t.jsxs("div",{className:"csp",onClick:h=>h.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([h,v])=>t.jsx("button",{type:"button",className:"csb"+(f===h?" on":"")+(i===h?" busy":""),disabled:!!i,onClick:()=>{u(h)},children:v},h)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(od,{o:e})]})}function od({o:e}){const{t:a,saveNote:r,flash:n}=Z(),[o,i]=p.useState(e.ceoNote||""),[d,s]=p.useState(!1),[l,f]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),g=async()=>{if(d||!c)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&g()}}),t.jsx("button",{type:"button",disabled:d||!c,onClick:()=>{g()},children:l?a.csNoteSaved:a.csNoteOk})]})}function Tr({placeholder:e,onDone:a}){const{t:r}=Z(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function id({o:e}){var w;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:s}=Z(),[l,f]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Te(e)!==4)return null;const c=i(e),g=(c==null?void 0:c.stage)||"todo",u=async m=>{if(l||m===g)return;f(!0);const y=c;d(e,{stage:m,stamps:(c==null?void 0:c.stamps)||{}});const E=Math.max(Date.now(),Lr+=1);Lr=E;const k=await is(r,{company:e.name||"",stage:m,cts:E,deal_id:e.airtableId,check_id:e.checkId});f(!1),!k.stale&&(k.ok||(d(e,y),s(a.actErr)))},b=(w=c==null?void 0:c.stamps)==null?void 0:w.sent,h=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=g==="sent"&&b&&h>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(g===m?" on":""),disabled:l,onClick:()=>{u(m)},children:y},m)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(h)})]})}let Lr=0;const Zt=8,Nt=360;function Fr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Rr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Fr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Fr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function sd({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Z(),[d,s]=p.useState(0),[l,f]=p.useState(null),[c,g]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),h=p.useRef(!1);p.useEffect(()=>{const q=b.current;return()=>{h.current||(n({type:"ptab",tab:q.ptab}),n({type:"dens",dens:q.dens}),n({type:"modal",modal:q.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,g(e.filter(q=>!!document.querySelector(q.need||q.sel))))},[e]);const v=c[d],w=d>=c.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const q=v.click,T=window.setTimeout(()=>{const L=document.querySelector(q);L&&L.getAttribute("aria-selected")!=="true"&&L.click()},60);return()=>window.clearTimeout(T)}},[d,v]);const m=p.useRef(-1),y=p.useCallback(()=>{if(!v){f(null);return}const q=z=>{if(!z)return null;for(const O of document.querySelectorAll(z)){const U=O.getBoundingClientRect();if(U.width>1&&U.height>1)return O}return null},T=q(v.sel)||q(v.need);if(!T){f(null);return}m.current!==d&&(m.current=d,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=T.getBoundingClientRect();f(z=>z&&Math.abs(z.top-L.top)<1&&Math.abs(z.left-L.left)<1&&Math.abs(z.width-L.width)<1&&Math.abs(z.height-L.height)<1?z:L)},[v,d]);p.useLayoutEffect(()=>{y();const q=[90,300,700,1300].map(z=>window.setTimeout(y,z)),T=window.setInterval(y,400),L=()=>y();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{q.forEach(z=>window.clearTimeout(z)),window.clearInterval(T),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[y]);const E=p.useRef(a);if(E.current=a,p.useEffect(()=>{const q=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),E.current()):T.key==="ArrowRight"?s(L=>L+1):T.key==="ArrowLeft"&&s(L=>Math.max(0,L-1))};return document.addEventListener("keydown",q,!0),()=>document.removeEventListener("keydown",q,!0)},[]),!c.length)return null;let k=null;const j=q=>()=>{h.current=!0,n({type:"modal",modal:null}),q()};if(w){const q=o[3]||0;q>0?k={title:q===1?r.ahaATitle1:r.ahaATitleN(q),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let N={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Nt};if(!w&&l){const q=l.bottom+14,T=window.innerHeight-q;let L=T>190?q:Math.max(12,l.top-200),z=Math.min(Math.max(12,l.left+l.width/2-Nt/2),window.innerWidth-Nt-12);T<=190&&l.top<212&&(window.innerWidth-l.right>=Nt+40?z=Math.min(l.right+26,window.innerWidth-Nt-12):l.left>=Nt+40&&(z=Math.max(12,l.left-Nt-26)),L=Math.max(12,l.top-Zt)),N={left:z,top:L,width:Nt}}return Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!w&&l&&t.jsx("div",{className:"tour-hole",style:{left:l.left-Zt,top:l.top-Zt,width:l.width+Zt*2,height:l.height+Zt*2}}),(w||!l)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(w?" fin":""),style:N,children:[w&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Rr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(Rr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>s(q=>Math.max(0,q-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(q=>q+1),children:d===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Wo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Go(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ld(){var T,L;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:s,dispatch:l}=Z(),f=r?a:e,c=p.useMemo(()=>f.filter(z=>ut(z.date)===0&&z.kind==="target"),[f]),g=p.useMemo(()=>r?a.filter(z=>z.kind==="target"&&Te(z)===0).slice().sort((z,O)=>(O.date||"").localeCompare(z.date||"")):[],[a,r]),u=p.useMemo(()=>c.filter(z=>r?Te(z)===0:!Ue(z)),[c,r]),b=r?g:u,h=r?a.length-g.length:c.length-u.length,v=r?a.length:c.length,w=v?Math.min(100,h/v*100):100,m=p.useMemo(()=>Wo(f),[f]),y=!!m&&ut(m)>0,E=p.useMemo(()=>y?f.filter(z=>(z.date||"").slice(0,10)===m):[],[f,m,y]),k=typeof((T=s.stats)==null?void 0:T.kept_today)=="number"?s.stats.kept_today:null,j=typeof((L=s.stats)==null?void 0:L.screened_today)=="number"?s.stats.screened_today:c.length;let N;y?N=o.morningLast(E.length,g.length,Go(m,d)):r?N=o.morningThesis(j,g.length,k):c.length?h===0?N=o.goalSourced(c.length):h>=c.length?N=o.goalCleared:N=o.goalDone(h,c.length):N=o.goalSourced(0);const q=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&g.length&&l({type:"chainStart",queue:g.map(z=>z.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:w+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:q,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function dd(){const{t:e,st:a,dispatch:r,fund:n,data:o,mode:i,doSync:d,startTour:s}=Z(),l=i==="client",[f,c]=p.useState(!1),[g,u]=p.useState(""),b=()=>{!l||f||!n||(c(!0),u(""),ss(n).then(w=>{if(c(!1),w.pending){u(e.refreshSlow);return}if(!w.ok){w.error&&console.warn("[republish]",w.error),u(e.refreshKo);return}const m=w.entered??0,y=w.left??0;u(w.unchanged||!m&&!y?e.refreshSame:e.refreshDone(m,y)),o.refresh()}))},h=(n||"P").split(/\s+/).map(w=>w[0]).join("").slice(0,2).toUpperCase(),v=(()=>{const w=Date.parse(o.generatedAt||"");if(Number.isNaN(w))return"";const m=new Date(w),y=E=>String(E).padStart(2,"0");return`${y(m.getDate())}/${y(m.getMonth()+1)} à ${y(m.getHours())}:${y(m.getMinutes())}`})();return t.jsx("div",{className:"ident",children:t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:n?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:n||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:n?e.identTitle(n):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),v?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(v)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!l||f,onClick:b,children:f?"⏳":"📰"}),(f||!!g)&&t.jsxs("span",{className:"repubst",children:[f?e.refreshRun:g,!f&&t.jsx("button",{type:"button",onClick:()=>u(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!l,onClick:d,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:a.filters.search,onChange:w=>r({type:"filters",patch:{search:w.target.value}})})]})]})})}class Mt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,s=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);s&&(r[n++]=s),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*pd(e){for(const a of e)yield*a}function Yo(e){return Array.from(pd(e))}var Le=1e-6,Se=Math.PI,it=Se/2,Or=Se/4,lt=Se*2,vt=180/Se,et=Se/180,Fe=Math.abs,cd=Math.atan,da=Math.atan2,Oe=Math.cos,Me=Math.sin,ud=Math.sign||function(e){return e>0?1:e<0?-1:0},_t=Math.sqrt;function md(e){return e>1?0:e<-1?Se:Math.acos(e)}function pa(e){return e>1?it:e<-1?-it:Math.asin(e)}function st(){}function Ba(e,a){e&&Dr.hasOwnProperty(e.type)&&Dr[e.type](e,a)}var Mr={Feature:function(e,a){Ba(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ba(r[n].geometry,a)}},Dr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){vn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)vn(r[n],a,0)},Polygon:function(e,a){Ir(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Ir(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ba(r[n],a)}};function vn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Ir(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)vn(e[r],a,1);a.polygonEnd()}function Ut(e,a){e&&Mr.hasOwnProperty(e.type)?Mr[e.type](e,a):Ba(e,a)}function wn(e){return[da(e[1],e[0]),pa(e[2])]}function Wt(e){var a=e[0],r=e[1],n=Oe(r);return[n*Oe(a),n*Me(a),Me(r)]}function ka(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function $a(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function rn(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Ea(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function yn(e){var a=_t(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function kn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function En(e,a){return Fe(e)>Se&&(e-=Math.round(e/lt)*lt),[e,a]}En.invert=En;function fd(e,a,r){return(e%=lt)?a||r?kn(_r(e),Br(a,r)):_r(e):a||r?Br(a,r):En}function Pr(e){return function(a,r){return a+=e,Fe(a)>Se&&(a-=Math.round(a/lt)*lt),[a,r]}}function _r(e){var a=Pr(e);return a.invert=Pr(-e),a}function Br(e,a){var r=Oe(e),n=Me(e),o=Oe(a),i=Me(a);function d(s,l){var f=Oe(l),c=Oe(s)*f,g=Me(s)*f,u=Me(l),b=u*r+c*n;return[da(g*o-b*i,c*r-u*n),pa(b*o+g*i)]}return d.invert=function(s,l){var f=Oe(l),c=Oe(s)*f,g=Me(s)*f,u=Me(l),b=u*o-g*i;return[da(g*o+u*i,c*r+b*n),pa(b*r-c*n)]},d}function hd(e,a,r,n,o,i){if(r){var d=Oe(a),s=Me(a),l=n*r;o==null?(o=a+n*lt,i=a-l/2):(o=$r(d,o),i=$r(d,i),(n>0?o<i:o>i)&&(o+=n*lt));for(var f,c=o;n>0?c>i:c<i;c-=l)f=wn([d,-s*Oe(c),-s*Me(c)]),e.point(f[0],f[1])}}function $r(e,a){a=Wt(a),a[0]-=e,yn(a);var r=md(-a[1]);return((-a[2]<0?-r:r)+lt-Le)%lt}function Qo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:st,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ta(e,a){return Fe(e[0]-a[0])<Le&&Fe(e[1]-a[1])<Le}function ja(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Ko(e,a,r,n,o){var i=[],d=[],s,l;if(e.forEach(function(h){if(!((v=h.length-1)<=0)){var v,w=h[0],m=h[v],y;if(Ta(w,m)){if(!w[2]&&!m[2]){for(o.lineStart(),s=0;s<v;++s)o.point((w=h[s])[0],w[1]);o.lineEnd();return}m[0]+=2*Le}i.push(y=new ja(w,h,null,!0)),d.push(y.o=new ja(w,null,y,!1)),i.push(y=new ja(m,h,null,!1)),d.push(y.o=new ja(m,null,y,!0))}}),!!i.length){for(d.sort(a),Ur(i),Ur(d),s=0,l=d.length;s<l;++s)d[s].e=r=!r;for(var f=i[0],c,g;;){for(var u=f,b=!0;u.v;)if((u=u.n)===f)return;c=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,l=c.length;s<l;++s)o.point((g=c[s])[0],g[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(c=u.p.z,s=c.length-1;s>=0;--s)o.point((g=c[s])[0],g[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Ur(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function on(e){return Fe(e[0])<=Se?e[0]:ud(e[0])*((Fe(e[0])+Se)%lt-Se)}function gd(e,a){var r=on(a),n=a[1],o=Me(n),i=[Me(r),-Oe(r),0],d=0,s=0,l=new Mt;o===1?n=it+Le:o===-1&&(n=-it-Le);for(var f=0,c=e.length;f<c;++f)if(u=(g=e[f]).length)for(var g,u,b=g[u-1],h=on(b),v=b[1]/2+Or,w=Me(v),m=Oe(v),y=0;y<u;++y,h=k,w=N,m=q,b=E){var E=g[y],k=on(E),j=E[1]/2+Or,N=Me(j),q=Oe(j),T=k-h,L=T>=0?1:-1,z=L*T,O=z>Se,U=w*N;if(l.add(da(U*L*Me(z),m*q+U*Oe(z))),d+=O?T+L*lt:T,O^h>=r^k>=r){var V=$a(Wt(b),Wt(E));yn(V);var B=$a(i,V);yn(B);var x=(O^T>=0?-1:1)*pa(B[2]);(n>x||n===x&&(V[0]||V[1]))&&(s+=O^T>=0?1:-1)}}return(d<-Le||d<Le&&l<-1e-12)^s&1}function Jo(e,a,r,n){return function(o){var i=a(o),d=Qo(),s=a(d),l=!1,f,c,g,u={point:b,lineStart:v,lineEnd:w,polygonStart:function(){u.point=m,u.lineStart=y,u.lineEnd=E,c=[],f=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=w,c=Yo(c);var k=gd(f,n);c.length?(l||(o.polygonStart(),l=!0),Ko(c,bd,k,r,o)):k&&(l||(o.polygonStart(),l=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),l&&(o.polygonEnd(),l=!1),c=f=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function h(k,j){i.point(k,j)}function v(){u.point=h,i.lineStart()}function w(){u.point=b,i.lineEnd()}function m(k,j){g.push([k,j]),s.point(k,j)}function y(){s.lineStart(),g=[]}function E(){m(g[0][0],g[0][1]),s.lineEnd();var k=s.clean(),j=d.result(),N,q=j.length,T,L,z;if(g.pop(),f.push(g),g=null,!!q){if(k&1){if(L=j[0],(T=L.length-1)>0){for(l||(o.polygonStart(),l=!0),o.lineStart(),N=0;N<T;++N)o.point((z=L[N])[0],z[1]);o.lineEnd()}return}q>1&&k&2&&j.push(j.pop().concat(j.shift())),c.push(j.filter(xd))}}return u}}function xd(e){return e.length>1}function bd(e,a){return((e=e.x)[0]<0?e[1]-it-Le:it-e[1])-((a=a.x)[0]<0?a[1]-it-Le:it-a[1])}const Hr=Jo(function(){return!0},vd,yd,[-Se,-it]);function vd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var s=i>0?Se:-Se,l=Fe(i-a);Fe(l-Se)<Le?(e.point(a,r=(r+d)/2>0?it:-it),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&l>=Se&&(Fe(a-n)<Le&&(a-=n*Le),Fe(i-s)<Le&&(i-=s*Le),r=wd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=d),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function wd(e,a,r,n){var o,i,d=Me(e-r);return Fe(d)>Le?cd((Me(a)*(i=Oe(n))*Me(r)-Me(n)*(o=Oe(a))*Me(e))/(o*i*d)):(a+n)/2}function yd(e,a,r,n){var o;if(e==null)o=r*it,n.point(-Se,o),n.point(0,o),n.point(Se,o),n.point(Se,0),n.point(Se,-o),n.point(0,-o),n.point(-Se,-o),n.point(-Se,0),n.point(-Se,o);else if(Fe(e[0]-a[0])>Le){var i=e[0]<a[0]?Se:-Se;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function kd(e){var a=Oe(e),r=2*et,n=a>0,o=Fe(a)>Le;function i(c,g,u,b){hd(b,e,r,u,c,g)}function d(c,g){return Oe(c)*Oe(g)>a}function s(c){var g,u,b,h,v;return{lineStart:function(){h=b=!1,v=1},point:function(w,m){var y=[w,m],E,k=d(w,m),j=n?k?0:f(w,m):k?f(w+(w<0?Se:-Se),m):0;if(!g&&(h=b=k)&&c.lineStart(),k!==b&&(E=l(g,y),(!E||Ta(g,E)||Ta(y,E))&&(y[2]=1)),k!==b)v=0,k?(c.lineStart(),E=l(y,g),c.point(E[0],E[1])):(E=l(g,y),c.point(E[0],E[1],2),c.lineEnd()),g=E;else if(o&&g&&n^k){var N;!(j&u)&&(N=l(y,g,!0))&&(v=0,n?(c.lineStart(),c.point(N[0][0],N[0][1]),c.point(N[1][0],N[1][1]),c.lineEnd()):(c.point(N[1][0],N[1][1]),c.lineEnd(),c.lineStart(),c.point(N[0][0],N[0][1],3)))}k&&(!g||!Ta(g,y))&&c.point(y[0],y[1]),g=y,b=k,u=j},lineEnd:function(){b&&c.lineEnd(),g=null},clean:function(){return v|(h&&b)<<1}}}function l(c,g,u){var b=Wt(c),h=Wt(g),v=[1,0,0],w=$a(b,h),m=ka(w,w),y=w[0],E=m-y*y;if(!E)return!u&&c;var k=a*m/E,j=-a*y/E,N=$a(v,w),q=Ea(v,k),T=Ea(w,j);rn(q,T);var L=N,z=ka(q,L),O=ka(L,L),U=z*z-O*(ka(q,q)-1);if(!(U<0)){var V=_t(U),B=Ea(L,(-z-V)/O);if(rn(B,q),B=wn(B),!u)return B;var x=c[0],F=g[0],C=c[1],$=g[1],G;F<x&&(G=x,x=F,F=G);var S=F-x,I=Fe(S-Se)<Le,D=I||S<Le;if(!I&&$<C&&(G=C,C=$,$=G),D?I?C+$>0^B[1]<(Fe(B[0]-x)<Le?C:$):C<=B[1]&&B[1]<=$:S>Se^(x<=B[0]&&B[0]<=F)){var Q=Ea(L,(-z+V)/O);return rn(Q,q),[B,wn(Q)]}}}function f(c,g){var u=n?e:Se-e,b=0;return c<-u?b|=1:c>u&&(b|=2),g<-u?b|=4:g>u&&(b|=8),b}return Jo(d,s,i,n?[0,-e]:[-Se,e-Se])}function Ed(e,a,r,n,o,i){var d=e[0],s=e[1],l=a[0],f=a[1],c=0,g=1,u=l-d,b=f-s,h;if(h=r-d,!(!u&&h>0)){if(h/=u,u<0){if(h<c)return;h<g&&(g=h)}else if(u>0){if(h>g)return;h>c&&(c=h)}if(h=o-d,!(!u&&h<0)){if(h/=u,u<0){if(h>g)return;h>c&&(c=h)}else if(u>0){if(h<c)return;h<g&&(g=h)}if(h=n-s,!(!b&&h>0)){if(h/=b,b<0){if(h<c)return;h<g&&(g=h)}else if(b>0){if(h>g)return;h>c&&(c=h)}if(h=i-s,!(!b&&h<0)){if(h/=b,b<0){if(h>g)return;h>c&&(c=h)}else if(b>0){if(h<c)return;h<g&&(g=h)}return c>0&&(e[0]=d+c*u,e[1]=s+c*b),g<1&&(a[0]=d+g*u,a[1]=s+g*b),!0}}}}}var ta=1e9,Na=-ta;function jd(e,a,r,n){function o(f,c){return e<=f&&f<=r&&a<=c&&c<=n}function i(f,c,g,u){var b=0,h=0;if(f==null||(b=d(f,g))!==(h=d(c,g))||l(f,c)<0^g>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+g+4)%4)!==h);else u.point(c[0],c[1])}function d(f,c){return Fe(f[0]-e)<Le?c>0?0:3:Fe(f[0]-r)<Le?c>0?2:1:Fe(f[1]-a)<Le?c>0?1:0:c>0?3:2}function s(f,c){return l(f.x,c.x)}function l(f,c){var g=d(f,1),u=d(c,1);return g!==u?g-u:g===0?c[1]-f[1]:g===1?f[0]-c[0]:g===2?f[1]-c[1]:c[0]-f[0]}return function(f){var c=f,g=Qo(),u,b,h,v,w,m,y,E,k,j,N,q={point:T,lineStart:U,lineEnd:V,polygonStart:z,polygonEnd:O};function T(x,F){o(x,F)&&c.point(x,F)}function L(){for(var x=0,F=0,C=b.length;F<C;++F)for(var $=b[F],G=1,S=$.length,I=$[0],D,Q,H=I[0],ce=I[1];G<S;++G)D=H,Q=ce,I=$[G],H=I[0],ce=I[1],Q<=n?ce>n&&(H-D)*(n-Q)>(ce-Q)*(e-D)&&++x:ce<=n&&(H-D)*(n-Q)<(ce-Q)*(e-D)&&--x;return x}function z(){c=g,u=[],b=[],N=!0}function O(){var x=L(),F=N&&x,C=(u=Yo(u)).length;(F||C)&&(f.polygonStart(),F&&(f.lineStart(),i(null,null,1,f),f.lineEnd()),C&&Ko(u,s,x,i,f),f.polygonEnd()),c=f,u=b=h=null}function U(){q.point=B,b&&b.push(h=[]),j=!0,k=!1,y=E=NaN}function V(){u&&(B(v,w),m&&k&&g.rejoin(),u.push(g.result())),q.point=T,k&&c.lineEnd()}function B(x,F){var C=o(x,F);if(b&&h.push([x,F]),j)v=x,w=F,m=C,j=!1,C&&(c.lineStart(),c.point(x,F));else if(C&&k)c.point(x,F);else{var $=[y=Math.max(Na,Math.min(ta,y)),E=Math.max(Na,Math.min(ta,E))],G=[x=Math.max(Na,Math.min(ta,x)),F=Math.max(Na,Math.min(ta,F))];Ed($,G,e,a,r,n)?(k||(c.lineStart(),c.point($[0],$[1])),c.point(G[0],G[1]),C||c.lineEnd(),N=!1):C&&(c.lineStart(),c.point(x,F),N=!1)}y=x,E=F,k=C}return q}}const jn=e=>e;var sn=new Mt,Nn=new Mt,Xo,Zo,Sn,Cn,yt={point:st,lineStart:st,lineEnd:st,polygonStart:function(){yt.lineStart=Nd,yt.lineEnd=Cd},polygonEnd:function(){yt.lineStart=yt.lineEnd=yt.point=st,sn.add(Fe(Nn)),Nn=new Mt},result:function(){var e=sn/2;return sn=new Mt,e}};function Nd(){yt.point=Sd}function Sd(e,a){yt.point=ei,Xo=Sn=e,Zo=Cn=a}function ei(e,a){Nn.add(Cn*e-Sn*a),Sn=e,Cn=a}function Cd(){ei(Xo,Zo)}var Gt=1/0,Ua=Gt,ca=-Gt,Ha=ca,Va={point:zd,lineStart:st,lineEnd:st,polygonStart:st,polygonEnd:st,result:function(){var e=[[Gt,Ua],[ca,Ha]];return ca=Ha=-(Ua=Gt=1/0),e}};function zd(e,a){e<Gt&&(Gt=e),e>ca&&(ca=e),a<Ua&&(Ua=a),a>Ha&&(Ha=a)}var zn=0,An=0,aa=0,Wa=0,Ga=0,Ht=0,qn=0,Tn=0,na=0,ti,ai,gt,xt,ot={point:Dt,lineStart:Vr,lineEnd:Wr,polygonStart:function(){ot.lineStart=Td,ot.lineEnd=Ld},polygonEnd:function(){ot.point=Dt,ot.lineStart=Vr,ot.lineEnd=Wr},result:function(){var e=na?[qn/na,Tn/na]:Ht?[Wa/Ht,Ga/Ht]:aa?[zn/aa,An/aa]:[NaN,NaN];return zn=An=aa=Wa=Ga=Ht=qn=Tn=na=0,e}};function Dt(e,a){zn+=e,An+=a,++aa}function Vr(){ot.point=Ad}function Ad(e,a){ot.point=qd,Dt(gt=e,xt=a)}function qd(e,a){var r=e-gt,n=a-xt,o=_t(r*r+n*n);Wa+=o*(gt+e)/2,Ga+=o*(xt+a)/2,Ht+=o,Dt(gt=e,xt=a)}function Wr(){ot.point=Dt}function Td(){ot.point=Fd}function Ld(){ni(ti,ai)}function Fd(e,a){ot.point=ni,Dt(ti=gt=e,ai=xt=a)}function ni(e,a){var r=e-gt,n=a-xt,o=_t(r*r+n*n);Wa+=o*(gt+e)/2,Ga+=o*(xt+a)/2,Ht+=o,o=xt*e-gt*a,qn+=o*(gt+e),Tn+=o*(xt+a),na+=o*3,Dt(gt=e,xt=a)}function ri(e){this._context=e}ri.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,lt);break}}},result:st};var Ln=new Mt,ln,oi,ii,ra,oa,ua={point:st,lineStart:function(){ua.point=Rd},lineEnd:function(){ln&&si(oi,ii),ua.point=st},polygonStart:function(){ln=!0},polygonEnd:function(){ln=null},result:function(){var e=+Ln;return Ln=new Mt,e}};function Rd(e,a){ua.point=si,oi=ra=e,ii=oa=a}function si(e,a){ra-=e,oa-=a,Ln.add(_t(ra*ra+oa*oa)),ra=e,oa=a}let Gr,Ya,Yr,Qr;class Kr{constructor(a){this._append=a==null?li:Od(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Yr||this._append!==Ya){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Yr=n,Ya=this._append,Qr=this._,this._=o}this._+=Qr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function li(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Od(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return li;if(a!==Gr){const r=10**a;Gr=a,Ya=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ya}function Md(e,a){let r=3,n=4.5,o,i;function d(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Ut(s,o(i))),i.result()}return d.area=function(s){return Ut(s,o(yt)),yt.result()},d.measure=function(s){return Ut(s,o(ua)),ua.result()},d.bounds=function(s){return Ut(s,o(Va)),Va.result()},d.centroid=function(s){return Ut(s,o(ot)),ot.result()},d.projection=function(s){return arguments.length?(o=s==null?(e=null,jn):(e=s).stream,d):e},d.context=function(s){return arguments.length?(i=s==null?(a=null,new Kr(r)):new ri(a=s),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),d):n},d.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const l=Math.floor(s);if(!(l>=0))throw new RangeError(`invalid digits: ${s}`);r=l}return a===null&&(i=new Kr(r)),d},d.projection(e).digits(r).context(a)}function Un(e){return function(a){var r=new Fn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Fn(){}Fn.prototype={constructor:Fn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Hn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ut(r,e.stream(Va)),a(Va.result()),n!=null&&e.clipExtent(n),e}function di(e,a,r){return Hn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,l=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([s,l])},r)}function Dd(e,a,r){return di(e,[[0,0],a],r)}function Id(e,a,r){return Hn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([d,s])},r)}function Pd(e,a,r){return Hn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,s])},r)}var Jr=16,_d=Oe(30*et);function Xr(e,a){return+a?$d(e,a):Bd(e)}function Bd(e){return Un({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function $d(e,a){function r(n,o,i,d,s,l,f,c,g,u,b,h,v,w){var m=f-n,y=c-o,E=m*m+y*y;if(E>4*a&&v--){var k=d+u,j=s+b,N=l+h,q=_t(k*k+j*j+N*N),T=pa(N/=q),L=Fe(Fe(N)-1)<Le||Fe(i-g)<Le?(i+g)/2:da(j,k),z=e(L,T),O=z[0],U=z[1],V=O-n,B=U-o,x=y*V-m*B;(x*x/E>a||Fe((m*V+y*B)/E-.5)>.3||d*u+s*b+l*h<_d)&&(r(n,o,i,d,s,l,O,U,L,k/=q,j/=q,N,v,w),w.point(O,U),r(O,U,L,k,j,N,f,c,g,u,b,h,v,w))}}return function(n){var o,i,d,s,l,f,c,g,u,b,h,v,w={point:m,lineStart:y,lineEnd:k,polygonStart:function(){n.polygonStart(),w.lineStart=j},polygonEnd:function(){n.polygonEnd(),w.lineStart=y}};function m(T,L){T=e(T,L),n.point(T[0],T[1])}function y(){g=NaN,w.point=E,n.lineStart()}function E(T,L){var z=Wt([T,L]),O=e(T,L);r(g,u,c,b,h,v,g=O[0],u=O[1],c=T,b=z[0],h=z[1],v=z[2],Jr,n),n.point(g,u)}function k(){w.point=m,n.lineEnd()}function j(){y(),w.point=N,w.lineEnd=q}function N(T,L){E(o=T,L),i=g,d=u,s=b,l=h,f=v,w.point=E}function q(){r(g,u,c,b,h,v,i,d,o,s,l,f,Jr,n),w.lineEnd=k,k()}return w}}var Ud=Un({point:function(e,a){this.stream.point(e*et,a*et)}});function Hd(e){return Un({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Vd(e,a,r,n,o){function i(d,s){return d*=n,s*=o,[a+e*d,r-e*s]}return i.invert=function(d,s){return[(d-a)/e*n,(r-s)/e*o]},i}function Zr(e,a,r,n,o,i){if(!i)return Vd(e,a,r,n,o);var d=Oe(i),s=Me(i),l=d*e,f=s*e,c=d/e,g=s/e,u=(s*r-d*a)/e,b=(s*a+d*r)/e;function h(v,w){return v*=n,w*=o,[l*v-f*w+a,r-f*v-l*w]}return h.invert=function(v,w){return[n*(c*v-g*w+u),o*(b-g*v-c*w)]},h}function Wd(e){return Gd(function(){return e})()}function Gd(e){var a,r=150,n=480,o=250,i=0,d=0,s=0,l=0,f=0,c,g=0,u=1,b=1,h=null,v=Hr,w=null,m,y,E,k=jn,j=.5,N,q,T,L,z;function O(x){return T(x[0]*et,x[1]*et)}function U(x){return x=T.invert(x[0],x[1]),x&&[x[0]*vt,x[1]*vt]}O.stream=function(x){return L&&z===x?L:L=Ud(Hd(c)(v(N(k(z=x)))))},O.preclip=function(x){return arguments.length?(v=x,h=void 0,B()):v},O.postclip=function(x){return arguments.length?(k=x,w=m=y=E=null,B()):k},O.clipAngle=function(x){return arguments.length?(v=+x?kd(h=x*et):(h=null,Hr),B()):h*vt},O.clipExtent=function(x){return arguments.length?(k=x==null?(w=m=y=E=null,jn):jd(w=+x[0][0],m=+x[0][1],y=+x[1][0],E=+x[1][1]),B()):w==null?null:[[w,m],[y,E]]},O.scale=function(x){return arguments.length?(r=+x,V()):r},O.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],V()):[n,o]},O.center=function(x){return arguments.length?(i=x[0]%360*et,d=x[1]%360*et,V()):[i*vt,d*vt]},O.rotate=function(x){return arguments.length?(s=x[0]%360*et,l=x[1]%360*et,f=x.length>2?x[2]%360*et:0,V()):[s*vt,l*vt,f*vt]},O.angle=function(x){return arguments.length?(g=x%360*et,V()):g*vt},O.reflectX=function(x){return arguments.length?(u=x?-1:1,V()):u<0},O.reflectY=function(x){return arguments.length?(b=x?-1:1,V()):b<0},O.precision=function(x){return arguments.length?(N=Xr(q,j=x*x),B()):_t(j)},O.fitExtent=function(x,F){return di(O,x,F)},O.fitSize=function(x,F){return Dd(O,x,F)},O.fitWidth=function(x,F){return Id(O,x,F)},O.fitHeight=function(x,F){return Pd(O,x,F)};function V(){var x=Zr(r,0,0,u,b,g).apply(null,a(i,d)),F=Zr(r,n-x[0],o-x[1],u,b,g);return c=fd(s,l,f),q=kn(a,F),T=kn(c,q),N=Xr(q,j),B()}function B(){return L=z=null,O}return function(){return a=e.apply(this,arguments),O.invert=a.invert&&U,V()}}function pi(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}pi.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Fe(o)>Le&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Yd(){return Wd(pi).scale(175.295)}function Qd(e){return e}function Kd(e){if(e==null)return Qd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(s,l){l||(a=r=0);var f=2,c=s.length,g=new Array(c);for(g[0]=(a+=s[0])*n+i,g[1]=(r+=s[1])*o+d;f<c;)g[f]=s[f],++f;return g}}function Jd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Xd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return eo(e,r)})}:eo(e,a)}function eo(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Zd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Zd(e,a){var r=Kd(e.transform),n=e.arcs;function o(c,g){g.length&&g.pop();for(var u=n[c<0?~c:c],b=0,h=u.length;b<h;++b)g.push(r(u[b],b));c<0&&Jd(g,h)}function i(c){return r(c)}function d(c){for(var g=[],u=0,b=c.length;u<b;++u)o(c[u],g);return g.length<2&&g.push(g[0]),g}function s(c){for(var g=d(c);g.length<4;)g.push(g[0]);return g}function l(c){return c.map(s)}function f(c){var g=c.type,u;switch(g){case"GeometryCollection":return{type:g,geometries:c.geometries.map(f)};case"Point":u=i(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(i);break;case"LineString":u=d(c.arcs);break;case"MultiLineString":u=c.arcs.map(d);break;case"Polygon":u=l(c.arcs);break;case"MultiPolygon":u=c.arcs.map(l);break;default:return null}return{type:g,coordinates:u}}return f(a)}const ci={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ep=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function tp(e,a,r){const n=ci[e];if(!n||!n.length)return-1;const o=ep(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let Sa=null;function ap(){return Sa||(Sa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Xd(r,n),i=Yd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Md(i),s=(o.features||[]).filter(c=>{var g;return(((g=c.properties)==null?void 0:g.name)||"")!=="Antarctica"}).map(c=>{var b;const g=((b=c.properties)==null?void 0:b.name)||"",u=d(c)||"";return u?{i2:ls(g)||null,n:g,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const l={};for(const[c,g]of Object.entries(ds)){const u=i(g);u&&(l[c]={x:u[0],y:u[1]})}const f={};for(const[c,g]of Object.entries(ci)){const u=g.map(b=>i(b.ll)).filter(b=>!!b).map(([b,h])=>({x:b,y:h}));u.length&&(f[c]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:l,metros:f}}catch{return null}})(),Sa)}function np(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return ap().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const rp="8 40 984 210",op={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},to=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function ao(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ip(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const d=()=>{var f;if(!o)return;const l=(f=e.current)==null?void 0:f.getScreenCTM();l&&l.a>0?n(l.a):i=requestAnimationFrame(d)};d();const s=new ResizeObserver(()=>d());return e.current&&s.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function no({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function sp(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:s,t:l,data:f,dossiers:c,source:g}=Z(),u=f.loading&&!c.length,b=p.useRef(null),h=p.useRef(null),v=np(e.continent==="monde"),w=e.continent==="monde"?v:Dn.find(x=>x.key===e.continent)||null,m=ip(b,e.continent+":"+e.mapFolded+":"+!!w),[y,E]=p.useState(new Map),[k,j]=p.useState(null);p.useEffect(()=>{const x=b.current;if(!x)return;const F=new Map;x.querySelectorAll("path[data-i2]").forEach(C=>{const $=C.dataset.i2;if($)try{const G=C.getBBox();G.width>0&&F.set($,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),E(F)},[e.continent,m,w]);const N=p.useMemo(()=>r.filter(x=>x.cc),[r]),q=p.useMemo(()=>{const x=new Map;return N.forEach(F=>x.set(F.cc,(x.get(F.cc)||0)+1)),x},[N]),T=e.continent==="monde"&&v?v.anchors:null,L=e.continent==="monde"&&v?v.metros:null,z=p.useMemo(()=>N.map(x=>{const F=ao(x.name||x.id||""),C=ao((x.id||x.name||"")+"·y");if(T&&x.cc){const D=L?L[x.cc]:void 0;if(D&&D.length){const H=tp(x.cc,x.city,F);if(H>=0&&D[H])return{d:x,x:D[H].x+(F-.5)*5,y:D[H].y+(C-.5)*5}}const Q=T[x.cc];if(Q)return{d:x,x:Q.x+(F-.5)*10,y:Q.y+(C-.5)*10}}const $=x.cc?y.get(x.cc):void 0;if(!$)return null;const G=op[`${e.continent}:${x.cc||""}`];if(G)return{d:x,x:$.x+$.w*(G.fx+(F-.5)*G.sx),y:$.y+$.h*(G.fy+(C-.5)*G.sy)};const S=(F-.5)*Math.min($.w*.55,60),I=(C-.5)*Math.min($.h*.55,60);return{d:x,x:$.x+$.w/2+S,y:$.y+$.h/2+I}}).filter(x=>!!x),[N,y,T,L,e.continent]),O=x=>m>0?x/m:x,U=p.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:to[x],fr:l.plabels[x],en:l.plabels[x],n:r.filter(F=>F.kind==="target"&&Te(F)===x).length})).filter(x=>x.n>0):or.map((x,F)=>({...x,n:r.filter(C=>ir(C)===F).length})),[r,n,l.plabels]),V=i?d.get(i):null,B=V?z.find(x=>x.d.id===V.id):null;return w?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:h,children:[u&&t.jsx(no,{msgs:l.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?rp:w.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?w.fr:w.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:w.countries.map((x,F)=>t.jsx("g",{className:"ct"+(x.i2&&q.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},F))}),t.jsx("g",{children:z.map(x=>{const F=or[ir(x.d)],C=!!_e(x.d),$=x.d.kind==="target",G=n&&$?to[Te(x.d)]:F.c,S=!n&&Ue(x.d);return t.jsxs("g",{className:"co"+(S?" done":""),onMouseEnter:()=>{var Q,H;const I=(Q=h.current)==null?void 0:Q.getBoundingClientRect(),D=(H=b.current)==null?void 0:H.createSVGPoint();if(D&&b.current&&I){D.x=x.x,D.y=x.y;const ce=D.matrixTransform(b.current.getScreenCTM());j({x:ce.x-I.left,y:ce.y-I.top,label:x.d.name+" · "+(Kt(x.d.cc,s)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var Q;if(g==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const I=(Q=b.current)==null?void 0:Q.createSVGPoint();let D=null;if(I&&b.current){I.x=x.x,I.y=x.y;const H=I.matrixTransform(b.current.getScreenCTM());D={x:H.x,y:H.y}}a({type:"popup",id:x.d.id,anchor:D})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:O(Math.max(11,F.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:O(F.px),fill:G,stroke:C?"#E5484D":"#ffffff",strokeWidth:O(C?2.2:1.3)})]},x.d.id||x.d.name)})}),B&&t.jsx("circle",{className:"ring on",cx:B.x,cy:B.y,r:O(13),fill:"none",stroke:"#16233A",strokeWidth:O(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:U.map((x,F)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),s==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},F))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",l.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:h,children:t.jsx(no,{msgs:l.loadMsgs})})}function lp(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function ui({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:s}=Z(),l=a.filters,[f,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null),h=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(B=>B.continent===a.continent),[n,a.continent]),w=B=>v.filter(x=>B!=="country"&&l.country.length&&!l.country.includes(x.cc||"")?!1:_a(x,l,i,B==="country"?void 0:B)),m=B=>!i||B.kind!=="op",y=p.useMemo(()=>{const B=w("win").filter(m),x=F=>B.filter(C=>(C.date?Math.max(0,Math.floor((Date.now()-Date.parse(C.date))/864e5)):9999)<=F).length;return[x(0),x(7),x(30),B.length]},[v,l,i]),E=p.useMemo(()=>l.day?w("win").filter(m).filter(B=>(B.date||"").slice(0,10)===l.day).length:0,[v,l,i]),k=(l.signalOnly?1:0)+l.sector.length+l.market.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+l.crible.length,j=k+(l.acquirer.trim()?1:0)+(l.day||l.win!=="all"?1:0)+(l.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!f&&!g)return;const B=F=>{var $,G;const C=F.target;f&&!(($=b.current)!=null&&$.contains(C))&&c(!1),g&&!((G=h.current)!=null&&G.contains(C))&&u(!1)},x=F=>{F.key==="Escape"&&(c(!1),u(!1))};return document.addEventListener("mousedown",B),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",B),document.removeEventListener("keydown",x)}},[f,g]);const N=(B,x,F,C="fbtn")=>t.jsxs("button",{type:"button",className:C,"aria-expanded":a.openFacet===B,onClick:()=>r({type:"openFacet",facet:B}),children:[t.jsx("span",{className:"fl",children:x}),F>0&&t.jsx("span",{className:"n",children:F}),t.jsx("span",{className:"cv",children:"▾"})]},B),q=["1","7","30","all"],T=Math.max(0,q.indexOf(l.win||"all")),L=l.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(lp(l.day,s))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:h,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>u(B=>!B),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:y[T]}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:q.map((B,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":l.win===B,onClick:()=>{r({type:"filters",patch:{win:B}}),u(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:y[x]})]},B))})]}):t.jsx("div",{className:"seg",children:q.map((B,x)=>t.jsxs("button",{type:"button","aria-pressed":l.win===B,onClick:()=>r({type:"filters",patch:{win:B}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:y[x]})]},B))}),z=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:l.search,onChange:B=>r({type:"filters",patch:{search:B.target.value}})})]}),O=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),l.signalOnly&&t.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),l.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:l.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",o.fSector,l.sector.length),(n.some(B=>!!B.market)||l.market.length>0)&&N("mar",o.fMarket,l.market.length),N("pay",o.fCountry,l.country.length),N("det",o.fEngine,l.engine.length),N("sta",o.fStage,l.stage.length),i&&N("crib",o.fVerdict,l.crible.length),i&&N("ang","Angle",l.angle.length),i&&N("mem","Mémo",l.memoLevel.length)]}),U=(B=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),B&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),V=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{c(B=>!B),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:O})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(l.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:L}),t.jsxs("div",{className:"fstrip-b",children:[z,V,U(!1)]})]}),a.openFacet&&t.jsx(ro,{poolFor:w})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[L,z,O,t.jsx("span",{className:"fgrow"}),U()]}),a.openFacet&&t.jsx(ro,{poolFor:w})]})}function ro({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=Z(),s=a.filters,l=a.openFacet,{title:f,cols:c,options:g}=p.useMemo(()=>{if(l==="sig"){const w=e("signal").filter(E=>_e(E)),m=new Map;w.forEach(E=>{const k=E.engine||"";m.set(k,(m.get(k)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:w.length,html:!0,on:s.signalOnly&&!s.signalEngines.length},...gn([...m.keys()],o).map(E=>({v:E,label:Ot(E)+" "+tt(E,o),n:m.get(E)||0,html:!1,on:s.signalOnly&&s.signalEngines.includes(E)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="crib"){const w=e("crible").filter(y=>!i||wo(y,a.ptab,d.favIds)),m=new Map;return w.forEach(y=>{const E=yo(y);E&&E!=="NEW"&&m.set(E,(m.get(E)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...m.entries()].sort((y,E)=>(sr[y[0]]??9)-(sr[E[0]]??9)||E[1]-y[1]).map(([y,E])=>({v:y,label:'<span class="fdot" style="background:'+(ps[y]||"#94A3B8")+'"></span>'+y,n:E,html:!0,on:s.crible.includes(y)}))}}if(l==="sec"){const w=e("sector"),m=new Map;return w.forEach(y=>{y.sector&&m.set(y.sector,(m.get(y.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y,n:E,html:!1,on:s.sector.includes(y)}))}}if(l==="mar"){const w=e("market"),m=new Map;return w.forEach(y=>{y.market&&m.set(y.market,(m.get(y.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y,n:E,html:!1,on:s.market.includes(y)}))}}if(l==="pay"){const w=e("country"),m=new Map;return w.forEach(y=>{y.cc&&m.set(y.cc,(m.get(y.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:Kt(y,o)||y,n:E,html:!1,on:s.country.includes(y)}))}}if(l==="det"){const w=e("engine"),m=new Map;return w.forEach(y=>{y.engine&&m.set(y.engine,(m.get(y.engine)||0)+1)}),{title:n.fEngine,cols:2,options:gn([...m.keys()],o).map(y=>({v:y,label:Ot(y)+" "+tt(y,o)+' <span style="color:var(--dim);font-size:10px">· '+cs(us(y),o)+"</span>",n:m.get(y)||0,html:!0,on:s.engine.includes(y)}))}}if(l==="ang"){const w=e("angle"),m=new Map;return w.forEach(y=>{y.angle&&m.set(y.angle,(m.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y.replace(/[_-]+/g," "),n:E,html:!1,on:s.angle.includes(y)}))}}if(l==="mem"){const w=e("memoLevel"),m=new Map;w.forEach(E=>{if(E.kind==="target"){const k=Mn(E);m.set(k,(m.get(k)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(E=>({v:String(E),label:y[E],n:m.get(E)||0,html:!1,on:s.memoLevel.includes(E)}))}}const h=e("stage"),v=new Map;return h.forEach(w=>{w.stage&&v.set(w.stage,(v.get(w.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...v.entries()].sort((w,m)=>m[1]-w[1]).map(([w,m])=>({v:w,label:w,n:m,html:!1,on:s.stage.includes(w)}))}},[l,a,o]),u=h=>{if(l==="sig"){if(h==="*")r({type:"filters",patch:{signalOnly:!(s.signalOnly&&!s.signalEngines.length),signalEngines:[]}});else{const w=s.signalEngines.includes(h)?s.signalEngines.filter(m=>m!==h):[...s.signalEngines,h];r({type:"filters",patch:{signalOnly:!0,signalEngines:w}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(h)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage",value:h})},b=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:f}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(h=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":h.on,onClick:()=>u(h.v),children:[t.jsx("span",{className:"bx"}),h.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:h.label}}):t.jsx("span",{className:"l",children:h.label}),t.jsx("span",{className:"n",children:h.n})]},h.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function mi({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:s}=Z(),l=p.useMemo(()=>{const b={};return r.forEach(h=>{_a(h,n.filters,i)&&(b.monde=(b.monde||0)+1,h.continent&&(b[h.continent]=(b[h.continent]||0)+1))}),b},[r,n.filters,i]),[f,c]=p.useState(!1),g=p.useRef(null);p.useEffect(()=>{if(!f)return;const b=v=>{var w;(w=g.current)!=null&&w.contains(v.target)||c(!1)},h=v=>{v.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",h)}},[f]);const u=b=>{const h=Dn.find(v=>v.key===b);return b==="monde"?s.contWorld:d==="fr"?h.fr:h.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:g,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:l[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:lr.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:s.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:s.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[lr.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:s.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:s.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]})]})}function Rn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function fi(e){return"atl2:evalq:"+(e||"anon")}function dp(e,a){const r=fi(e),n=Rn(r),o=new Set(n.map(s=>(s.name||"").trim().toLowerCase())),i=a.map(s=>(s||"").trim()).filter(s=>s&&!o.has(s.toLowerCase())).map(s=>({name:s,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function pp(){const{t:e,lang:a,data:r,dossiers:n}=Z(),o=r.session.token||"",i=fi(o),[d,s]=p.useState(()=>Rn(i)),l=p.useRef(!1),[f,c]=p.useState(!1);p.useEffect(()=>{try{const S=d.slice(0,30).map(({descBusy:I,evalBusy:D,...Q})=>Q);localStorage.setItem(i,JSON.stringify(S)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[d,i]),p.useEffect(()=>{const S=()=>{if(l.current)return;const I=Rn(i);s(D=>JSON.stringify(D.map(({descBusy:Q,evalBusy:H,...ce})=>ce))===JSON.stringify(I)?D:I)};return window.addEventListener("atl2:evalq",S),window.addEventListener("storage",S),()=>{window.removeEventListener("atl2:evalq",S),window.removeEventListener("storage",S)}},[i]);const[g,u]=p.useState([]),[b,h]=p.useState(""),[v,w]=p.useState(!1),[m,y]=p.useState(!1),[E,k]=p.useState(""),j=p.useCallback((S,I)=>s(D=>D.map((Q,H)=>H===S?{...Q,...I}:Q)),[]),N=p.useCallback((S,I)=>{const D=I.trim();D&&(j(S,{name:D,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),In(D).then(Q=>{const H=Q.candidates||[];Q.website?j(S,{site:Q.website,status:"ready"}):H.length===1?j(S,{site:H[0].url,status:"ready"}):H.length>1?j(S,{status:"pick",candidates:H.slice(0,6)}):j(S,{status:"ready"})}).catch(()=>j(S,{status:"ready"})))},[j]),q=p.useCallback((S,I,D)=>{j(S,{descBusy:!0}),Eo(o,I,D).then(Q=>{if(Q.quota){c(!0),j(S,{descBusy:!1,descDone:!0});return}const H=Q.blocs||{},ce=(H.synthese||H.value_prop||H.produit||H.modele||"").trim();j(S,{descBusy:!1,descDone:!0,desc:ce})}).catch(()=>j(S,{descBusy:!1,descDone:!0}))},[j,o]);p.useEffect(()=>{const S=d.findIndex(D=>D.auto&&D.name.trim()&&D.status==="");if(S>=0){N(S,d[S].name);return}if(f)return;const I=d.findIndex(D=>D.status==="ready"&&D.site&&!D.descDone&&!D.descBusy);I>=0&&q(I,d[I].name,d[I].site)},[d,N,q,f]);const[T,L]=p.useState(!1),z=p.useCallback(async(S,I)=>{j(S,{evalBusy:!0});const D=(I.site||I.name).trim(),Q=await jo(o,D,"atelier2");return Q.verdict==="quota"?(j(S,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:Q.reason||"",remaining:0}})),!1):(j(S,{evalBusy:!1,status:Q.verdict==="kept"?"kept":"out",reason:Q.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:Q.company||I.name,verdict:Q.verdict,reason:Q.reason||"",remaining:Q.remaining??null}})),!0)},[j,o]),O=async()=>{if(T)return;const S=d.map((I,D)=>({r:I,i:D})).filter(({r:I})=>I.name.trim()&&I.status!=="kept"&&I.status!=="out"&&I.status!=="resolving");if(S.length){L(!0);for(const{r:I,i:D}of S)if(!await z(D,I))break;L(!1)}},U=p.useMemo(()=>{const S=new Set,I=[];return d.filter(D=>D.status==="kept").forEach(D=>{const Q=D.name.trim().toLowerCase();Q&&!S.has(Q)&&(S.add(Q),I.push(D.name.trim()))}),n.filter(D=>Te(D)>=1&&Te(D)<=4&&(D.website||D.domain)).forEach(D=>{const Q=(D.name||"").trim().toLowerCase();Q&&!S.has(Q)&&(S.add(Q),I.push((D.name||"").trim()))}),I},[d,n]),V=p.useMemo(()=>{const S=new Set;return n.forEach(I=>{const D=(I.name||"").trim().toLowerCase();D&&S.add(D)}),d.forEach(I=>{const D=I.name.trim().toLowerCase();D&&S.add(D)}),S},[n,d]),B=async()=>{if(b||!U.length)return;y(!1);const S=[];for(const I of U.slice(0,2)){h(I);const D=await No(o,I);if(D){if(D.verdict==="quota"){w(!0);break}(D.results||[]).forEach(Q=>{const H=(Q.company||"").trim().toLowerCase();!H||V.has(H)||S.some(ce=>ce.name.toLowerCase()===H)||S.push({name:(Q.company||"").trim(),verdict:Q.verdict||"",reason:Q.reason,from:I})})}}h(""),y(!0),u(I=>[...S,...I].slice(0,24))},x=async(S,I)=>{if(b)return;y(!1),h(S==="thesis"?e.pxThesis:I);const D=await fs(o,S,I,6);if(h(""),y(!0),!D)return;if(D.verdict==="quota"){w(!0);return}const Q=[];(D.results||[]).forEach(H=>{const ce=(H.company||"").trim().toLowerCase();!ce||V.has(ce)||Q.some(te=>te.name.toLowerCase()===ce)||Q.push({name:(H.company||"").trim(),verdict:H.verdict||"",reason:H.reason,from:S==="thesis"?e.pxThesis:I})}),u(H=>[...Q,...H].slice(0,24))},F=()=>{const S=E.trim();S.length<3||x(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(S)?"registry":"keyword",S)},C=S=>{s(I=>[...I,{name:S.name,site:"",status:"",auto:!0}].slice(0,30)),u(I=>I.filter(D=>D.name!==S.name))},$=d.filter(S=>S.name.trim()&&S.status!=="kept"&&S.status!=="out").length,G=S=>S.name.trim()&&S.status!=="kept"&&S.status!=="out"&&S.status!=="resolving"&&!S.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{className:"eq-h-go",children:e.eqRunOneShort})]}),d.map((S,I)=>t.jsxs("div",{className:"eq-item"+(S.status==="kept"?" r-kept":S.status==="out"?" r-out":""),children:[t.jsxs("div",{className:"eq-row"+(S.status==="kept"?" r-kept":S.status==="out"?" r-out":""),children:[t.jsx("input",{value:S.name,placeholder:e.eqNamePh,onChange:D=>{const Q=D.target.value.split(`
`).map(H=>H.trim()).filter(Boolean);Q.length>1?s(H=>{const ce=[...H];return ce.splice(I,1,...Q.map(te=>({name:te,site:"",status:"",auto:!0}))),ce.slice(0,30)}):j(I,{name:D.target.value})},onBlur:()=>{S.name.trim()&&!S.site&&S.status!=="resolving"&&S.status!=="pick"&&N(I,S.name)},onKeyDown:D=>{D.key==="Enter"&&N(I,S.name)}}),t.jsxs("span",{className:"eq-site",children:[S.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),S.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:D=>{const Q=D.target.value;Q&&j(I,{site:Q,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(S.candidates||[]).map(D=>t.jsx("option",{value:D.url,children:(D.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},D.url))]}),S.status!=="resolving"&&S.status!=="pick"&&(S.site?t.jsxs("a",{href:S.site.startsWith("http")?S.site:"https://"+S.site,target:"_blank",rel:"nofollow noopener",children:[S.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:S.name.trim()&&S.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:S.desc||"",children:S.descBusy?t.jsx("i",{children:e.eqDescBusy}):S.desc?S.desc:t.jsx("em",{children:S.descDone?f?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(S.status||"vide"),title:S.reason||"",children:S.status==="kept"?"✓ "+e.kept:S.status==="out"?"✗ "+e.dropped:S.status==="ready"?e.eqReady:S.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>s(D=>D.filter((Q,H)=>H!==I)),children:"×"}),(S.name.trim()||S.site)&&S.status!=="kept"&&S.status!=="out"?t.jsxs(Qa,{lang:a,storeKey:(S.site||S.name).trim(),className:"eq-go",title:e.eqRunOne,disabled:!G(S)||T,confirmLabel:"⚡ "+e.eqRunOneShort,onConfirm:()=>{z(I,S)},children:[S.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}):t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!G(S)||T,onClick:()=>{z(I,S)},children:[S.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]})]}),(S.name.trim()||S.site)&&S.status!=="kept"&&S.status!=="out"&&t.jsx(ms,{lang:a,variant:"row",storeKey:(S.site||S.name).trim()})]},I)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>s(S=>[...S,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!b,onClick:()=>{x("thesis","")},children:b===e.pxThesis?e.sgBusy(b):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:E,placeholder:e.pxPlace,onChange:S=>k(S.target.value),onKeyDown:S=>{S.key==="Enter"&&F()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b||E.trim().length<3,onClick:F,children:e.pxGoFree}),!!U.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b,onClick:()=>{B()},children:b&&b!==e.pxThesis&&b!==E?e.sgBusy(b):e.sgGo}),!!U.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(U[0],U.length)}),v&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),m&&!g.length&&!v&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),g.map(S=>t.jsxs("span",{className:"eq-sc"+(S.verdict==="kept"?" ok":""),title:(S.reason||"")+" — "+e.sgVia(S.from),children:[t.jsx("b",{children:S.name}),S.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>C(S),children:"+"})]},S.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),d.some(S=>S.status==="kept"||S.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>s(S=>S.filter(I=>I.status!=="kept"&&I.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(T?" loading":""),style:{justifyContent:"center"},disabled:T||!$,onClick:()=>{O()},children:[t.jsx("span",{className:"fill"}),T?e.eqRunning:e.eqGo($)]})]})]})]})}const cp={deals:"ma-deals",news:"veille"};function oo(e){return(e.url||e.title||"").trim()}function up(e){const a=(e.title||"").replace(/\s+/g," ").trim();if(!a)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const r=/^(.{2,72}?)[:–—|]/.exec(a);return r?r[1].trim():(a.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||a).slice(0,72).trim()}function mp({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,canWrite:i,flash:d}=Z(),[s,l]=p.useState(null),[f,c]=p.useState({deals:[],news:[]}),[g,u]=p.useState({deals:!1,news:!1}),[b,h]=p.useState(null),[v,w]=p.useState(""),m=p.useRef(!1),y=p.useCallback(async z=>{if(!o)return[];if(g[z])return f[z];h(z),w("");const O=await hs(cp[z],o,n);return h(null),!O.ok&&O.error?(w(O.error),[]):(c(U=>({...U,[z]:O.items})),u(U=>({...U,[z]:!0})),O.items)},[o,n,g,f]);p.useEffect(()=>{s&&y(s)},[s,y]);const E=p.useCallback(z=>f[z].map(oo).filter(Boolean),[f]),k=p.useMemo(()=>{var U,V;if(!o)return{deals:[],news:[]};const z={deals:E("deals"),news:E("news")},O=Do("feed:"+o,z);return{deals:((U=O.deals)==null?void 0:U.noms)||[],news:((V=O.news)==null?void 0:V.noms)||[]}},[o,E]),j=p.useRef(null);p.useEffect(()=>{j.current&&!s&&o&&Io("feed:"+o,{deals:E("deals"),news:E("news")}),j.current=s},[s,o,E]);const N=z=>{const O=z.map(up).filter(Boolean);O.length&&(a(O),l(null),d(r.feedSent(O.length)))},q=(z,O)=>{const U=(z.url||"").trim();if(O==="news"&&U&&/^https?:\/\//i.test(U)){window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:U}})),l(null);return}N([z])},T=async z=>{if(s===z){l(null);return}m.current||(m.current=!0,await y(z),m.current=!1,l(z))},L=z=>{const O=f[z],U=new Set(k[z].map(V=>V.toLowerCase()));return t.jsxs("div",{className:"dfpane"+(s===z?" on":""),hidden:s!==z,children:[t.jsx("p",{className:"dfh",children:z==="deals"?r.feedDealsH:r.feedNewsH}),t.jsx("p",{className:"dfh2",children:z==="deals"?r.feedDealsHow:r.feedNewsHow}),b===z&&t.jsx("p",{className:"dfload",children:n==="en"?"Loading…":"Chargement…"}),s===z&&!!v&&t.jsx("p",{className:"dferr",children:v}),g[z]&&!O.length&&!b&&t.jsx("p",{className:"dfempty",children:z==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!O.length&&t.jsx("ul",{className:"dflist",children:O.map((V,B)=>{const x=oo(V),F=U.has(x.toLowerCase()),C=(V.url||"").trim();return t.jsxs("li",{className:F?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:V.title||C}),t.jsx("span",{children:[V.source,V.sector_fr,(V.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[C&&t.jsx("a",{href:C,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),i&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>q(V,z),children:z==="deals"?r.feedToEval:r.rowExtract})]})]},x||B)})})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(z=>{const O=k[z].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(z==="deals"?"ddeals":"dnews")+(s===z?" on":"")+(b===z?" busy":""),title:z==="deals"?r.feedDealsH:r.feedNewsH,"aria-busy":b===z||void 0,onClick:()=>{T(z)},children:[b===z?n==="en"?"Loading…":"Chargement…":z==="deals"?r.feedDeals:r.feedNews,O>0&&b!==z&&t.jsx("em",{title:r.feedHint,children:r.feedNew(O)})]},z)}),s&&L(s)]})}function hi(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function fp(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function io({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:s}=Z();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(l=>l.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(l=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:l.name}),l.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),l.line1&&t.jsx("p",{className:"w",children:l.line1}),l.line2&&t.jsx("p",{className:"r",children:l.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(l.name),children:s.rsEvalOne})]},l.name))})]}):null}function gi({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=Z(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(io,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(io,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function hp({card:e,onEvaluate:a,onAddAll:r}){var s,l,f;const{t:n}=Z(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:hi(e.summary_md||"").map((c,g)=>t.jsx("p",{children:c},g))})]}),t.jsx(gi,{card:e,onEvaluate:a,onAddAll:r}),(((l=e.prospective)==null?void 0:l.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(c=>t.jsx("li",{children:c},c))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function gp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function xp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=Z(),s=o,[l,f]=p.useState(null),[c,g]=p.useState(null),[u,b]=p.useState(null),[h,v]=p.useState(!1);p.useEffect(()=>{let m=!0;return(async()=>{const y=await So({email:d,cbToken:s});m&&f(y)})(),()=>{m=!1}},[d,s,n]);const w=m=>{g(m),b(null),v(!0),(async()=>{const y=await gs(m.id);b(y),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{g(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&l&&t.jsx("span",{className:"n",children:l.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[l===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),l!==null&&l.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(l||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>w(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[gp(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?i.rsPub:i.rsPriv})]},m.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?i.rsPub:i.rsPriv})]}),h&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!h&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!h&&u&&t.jsx(hp,{card:u,onEvaluate:a,onAddAll:r})]})]})}const La=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ia(e){return/^https?:\/\//i.test((e||"").trim())}function ct(e){const a=(e||"").trim();return a?ia(a)?a:La.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function bp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function vp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:s,evalBusy:l,evalCards:f,caps:c,data:g,canWrite:u,source:b,dossiers:h,doAnalyse:v,liveMemos:w,pipe:m}=Z(),y=r==="client",E=p.useMemo(()=>n||(b!=="default"?xs():""),[n,b]),[k,j]=p.useState(""),[N,q]=p.useState(!1),[T,L]=p.useState(""),[z,O]=p.useState(""),[U,V]=p.useState(""),[B,x]=p.useState(!1),[F,C]=p.useState(!1),[$,G]=p.useState([]);p.useEffect(()=>{const R=_=>{const Y=_.detail;Y&&G(ae=>[Y,...ae].slice(0,8))};return window.addEventListener("ppmap:evalcard",R),()=>window.removeEventListener("ppmap:evalcard",R)},[]);const[S,I]=p.useState(!1),[D,Q]=p.useState(!1),[H,ce]=p.useState(!1),te=p.useRef(!1),[le,xe]=p.useState(""),[he,we]=p.useState(""),[pe,Ne]=p.useState(!1),[ze,ue]=p.useState(!1),[be,ye]=p.useState(0),[ee,P]=p.useState(""),[J,ie]=p.useState(null),[oe,me]=p.useState(null),[W,se]=p.useState(!1),[ve,ke]=p.useState(null),[Ee,ge]=p.useState(0),Pe=p.useRef(!1),Je=k.trim()?La.test(k.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const R=new URLSearchParams(window.location.search),_=(R.get("rs")||"").trim(),Y=(R.get("rstext")||"").trim();_&&/^https?:\/\//i.test(_)&&xe(_),Y&&we(Y),(_&&/^https?:\/\//i.test(_)||Y)&&I(!0)},[]),p.useEffect(()=>{const R=_=>{const Y=_.detail||{},ae=String(Y.url||"").trim(),re=String(Y.text||"").trim();ae&&/^https?:\/\//i.test(ae)&&xe(ae),re&&we(re),(ae&&/^https?:\/\//i.test(ae)||re)&&(I(!0),j(""),L(""),Ne(!0),window.setTimeout(()=>Ne(!1),900))};return window.addEventListener("ppmap:research",R),()=>window.removeEventListener("ppmap:research",R)},[]),p.useEffect(()=>{const R=_=>{const Y=_.detail||{},ae=String(Y.name||"").trim();if(!ae)return;I(!1),j(ae),L(ae);const re=ct(String(Y.website||Y.domain||""));O(re),V(ct(String(Y.url||""))),x(!re),q(!0),window.setTimeout(()=>q(!1),900)};return window.addEventListener("ppmap:prefill",R),()=>window.removeEventListener("ppmap:prefill",R)},[]),p.useEffect(()=>{const R=(T||"").trim();if(!R||S||z){(z||!R||S)&&x(!1);return}const _=$e(R),Y=h.find(Ae=>$e(Ae.name)===_)||h.find(Ae=>{const de=$e(Ae.name);return de.length>=3&&(_.includes(de)||de.includes(_))}),ae=ct((Y==null?void 0:Y.website)||"")||ct((Y==null?void 0:Y.domain)||""),re=ct((Y==null?void 0:Y.url)||"");if(re&&V(Ae=>Ae||re),ae){O(ae),x(!1);return}let je=!0;return x(!0),In(R).then(Ae=>{var He,jt;if(!je)return;const de=ct(Ae.website||"")||ct(((jt=(He=Ae.candidates)==null?void 0:He[0])==null?void 0:jt.url)||"");de&&O(de)}).catch(()=>{}).finally(()=>{je&&x(!1)}),()=>{je=!1}},[T,S,z,h]),p.useEffect(()=>{const R=_=>{var ae;const Y=String(((ae=_.detail)==null?void 0:ae.url)||"").trim();ia(Y)&&window.open(Y,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",R),()=>window.removeEventListener("ppmap:view",R)},[]),p.useEffect(()=>{if(te.current===S)return;te.current=S,ce(!0);const R=window.setTimeout(()=>ce(!1),560);return()=>window.clearTimeout(R)},[S]),p.useEffect(()=>{if(typeof window>"u")return;const R=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),_=document.querySelector(".atl2.ops, .atl2.cibles");if(!R||!_)return;const Y=_.classList.contains("cibles")?document.querySelector(".atl2.cibles .live-stack"):null,ae=()=>{const je=parseFloat(window.getComputedStyle(R).top)||0,Ae=R.getBoundingClientRect().top<=je+1;R.classList.toggle("is-stuck",Ae),_.classList.toggle("url-stuck",Ae);const de=Math.round(R.getBoundingClientRect().height);_.style.setProperty("--demand-h",`${de}px`);const He=window.matchMedia("(min-width: 861px)").matches;Y&&He?_.style.setProperty("--pp-live-h",`${Math.round(Y.getBoundingClientRect().height)}px`):_.classList.contains("cibles")&&_.style.setProperty("--pp-live-h","0px")};ae();const re=new ResizeObserver(ae);return re.observe(R),Y&&re.observe(Y),window.addEventListener("scroll",ae,!0),window.addEventListener("resize",ae),()=>{re.disconnect(),R.classList.remove("is-stuck"),_.classList.remove("url-stuck"),window.removeEventListener("scroll",ae,!0),window.removeEventListener("resize",ae)}},[b,N,pe,F,S,H,B]),p.useEffect(()=>{if(!u&&!E){ke(null);return}let R=!0;return(async()=>{const _=await So({email:o,cbToken:E});R&&ke(_.length)})(),()=>{R=!1}},[u,E,o,Ee]);const at=$.length?$:f,Ce=g.credits,dt=p.useCallback(R=>{dp(n,R)&&(C(!1),s({type:"ptab",tab:0}),requestAnimationFrame(()=>{const _=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!_)return;const Y=window.scrollY+_.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,Y),behavior:"smooth"})}))},[n,s]);p.useEffect(()=>{if(!ze)return;ye(0);const R=window.setInterval(()=>ye(_=>_+1),1e3);return()=>window.clearInterval(R)},[ze]);const nt=p.useMemo(()=>{const R=k.trim().toLowerCase();return!R||!m?null:h.find(_=>$e(_.name)===R&&Te(_)===1)||null},[k,h,m]),Xe=()=>{const R=k.trim();if(R){if(nt){v(nt);return}i(null,R),y&&j("")}},rt=async()=>{var Y,ae,re;if(Pe.current)return;const R=le.trim().replace(/\s+/g,""),_=he.trim();if(!R&&!_){P(e.rsNeed);return}if(!y&&!E){i(null,R||_.slice(0,80));return}Pe.current=!0,P(""),ie(null),me(null),ue(!0);try{const je=await vs({url:R,text:_,email:o,cbToken:E});if(ue(!1),!je||je.status!=="success"){P((je==null?void 0:je.message)||"Erreur");return}ie(je),I(!1),dt((((Y=je.prospective)==null?void 0:Y.companies_to_evaluate)||[]).map(de=>(de==null?void 0:de.name)||"")),me({state:"pending"});const Ae=await ws(je,{email:o,cbToken:E});me(Ae.ok?{state:"ok",scopeLabel:((ae=Ae.summary)==null?void 0:ae.scope_label)||"",scope:((re=Ae.summary)==null?void 0:re.scope)||""}:{state:"fail",msg:Ae.error||""}),Ae.ok&&ge(de=>de+1)}finally{Pe.current=!1,ue(!1)}},At=[J==null?void 0:J.industry,...(J==null?void 0:J.market_tags)||[],J==null?void 0:J.author].map(R=>(R||"").trim()).filter(Boolean),bt=(oe==null?void 0:oe.state)==="pending",Bt=oe&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):oe.state==="ok"?t.jsx("span",{className:"rslink ok",children:oe.scope&&oe.scope!=="public"?e.rsSavedIn(oe.scopeLabel||oe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:oe.msg,children:e.rsSaveFail})),$t=fp(J).length,De=S,Ze=(T||k).trim(),Ge=h.find(R=>$e(R.name)===$e(Ze)),mt=ct(k)||z||ct((Ge==null?void 0:Ge.website)||"")||ct((Ge==null?void 0:Ge.domain)||""),Et=U||ct((Ge==null?void 0:Ge.url)||""),qt=nt?e.actAnalyse:Ze?e.evalGoOn(Ze.length>22?Ze.slice(0,21)+"…":Ze):e.evalGo,M=ze?`${bs(le.trim())==="youtube"&&le.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(be)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(De?" rs-mode":"")+(T&&k.trim()===T||N||pe?" pair":"")+(N||pe||H?" echo":"")+(H?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:De?a==="en"?"Extract companies from an article":"Extraire les sociétés d’un article":a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:De?a==="en"?"Paste an article or video URL — Stan lists the companies, then you pick which ones to screen.":"Collez l’URL d’un article ou d’une vidéo — Stan en sort les sociétés, vous choisissez lesquelles évaluer.":a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((De?pe:N)||H?" flash":"")+((De?le.trim():La.test(k.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:De?le:k,placeholder:De?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:De?600:200,spellCheck:De?!1:void 0,inputMode:De?"url":void 0,onChange:R=>{if(De){xe(R.target.value);return}j(R.target.value),T&&R.target.value.trim()!==T&&(L(""),O(""),V(""),x(!1))},onKeyDown:R=>{R.key==="Enter"&&(De?rt():Xe())}}),t.jsx("span",{className:"detect"+(De?" off":"")+(La.test(k.trim())?" url":""),children:Je})]}),t.jsx("span",{className:"dacts",children:De?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ze?" loading":""),disabled:ze||bt||!le.trim()&&!he.trim(),onClick:()=>{rt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:M})]}),t.jsxs("a",{className:"viewbtn"+(ia(le)?"":" off"),href:ia(le)?le.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:R=>{ia(le)||R.preventDefault()},children:[t.jsx(bp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs(Qa,{lang:a,storeKey:((nt==null?void 0:nt.name)||k).trim(),className:"evalbtn"+(nt?" analyse":"")+(l?" loading":""),disabled:l,confirmLabel:qt,onConfirm:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:qt})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(B?" searching":mt?"":" off"),href:mt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":B||void 0,title:B?e.viewSiteBusyHint:e.viewSiteHint,onClick:R=>{mt||R.preventDefault()},children:[B&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),B?e.viewSiteBusy:e.viewSite,!B&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(Et?"":" off"),href:Et||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:R=>{Et||R.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),c.showCredits&&Ce&&b==="ops"&&t.jsxs("button",{type:"button",className:"credits"+(Ce.total_available<=0&&!Ce.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Ce.unlimited?"∞":Ce.total_available}),!Ce.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Ce.daily_grant+Ce.purchased]}),Ce.total_available<=0&&!Ce.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{s({type:"ptab",tab:0}),C(!1),requestAnimationFrame(()=>{const R=document.querySelector(".atl2.cibles .desk-list");if(!R)return;const _=window.scrollY+R.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,_),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(S?" on":""),title:e.rsOpenHint,onClick:()=>I(!S),children:e.rsOpen}),ve!==null&&ve>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(W?" on":""),onClick:()=>se(!W),children:e.rsArchOpen(ve)}),c.pipe&&!!n&&t.jsx(mp,{pageToken:E,onAddNames:dt})]}),W&&t.jsx(xp,{bump:Ee,cbToken:E,onClose:()=>se(!1),onEvaluate:R=>i(null,R),onAddAll:dt}),t.jsx("div",{className:"rsp slim"+(S?" on":" off"),"aria-hidden":!S,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:S?void 0:-1,onClick:()=>Q(R=>!R),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:D?"▴":"▾"})]}),D&&t.jsx("textarea",{className:"rstext",value:he,placeholder:e.rsTextPh,tabIndex:S?void 0:-1,onChange:R=>we(R.target.value)})]})}),ee&&t.jsx("div",{className:"rserr",children:ee}),J&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:J.title}),J.source_url&&t.jsx("a",{href:J.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ie(null),me(null)},children:"×"})]}),J.market&&t.jsx("p",{className:"rsmk",children:J.market}),At.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),At.map(R=>t.jsx("span",{children:R},R))]}),t.jsxs("div",{className:"rsbody",children:[J.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${J.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:hi(J.summary_md||"").map((R,_)=>t.jsx("p",{children:R},_))})]}),t.jsx(gi,{card:J,onEvaluate:R=>i(null,R),onAddAll:dt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound($t)}),Bt]})]}),at.slice(0,1).map((R,_)=>{const Y=R.verdict==="kept",ae=R.verdict==="quota",re=R.verdict==="unresolved",je=Y?"var(--brand)":ae?"var(--bolt)":re?"var(--blue)":"var(--red)",Ae=Y?"var(--brand-l)":ae?"#FFF3D6":re?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":je,"--bgc":Ae},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:Y?"✓ "+e.kept:ae?"⏳":re?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),R.name&&t.jsx("span",{className:"rn",children:R.name}),t.jsx("span",{className:"rr",children:R.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",R.reason]}):null}),!!(R.candidates&&R.candidates.length)&&t.jsx("span",{className:"sitepick",children:R.candidates.map(de=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:de.url.startsWith("http")?de.url:`https://${de.url}`,target:"_blank",rel:"nofollow noopener",children:[(de.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,de.url,R.name),children:e.evalPickGo})]},de.url))}),!ae&&!re&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:Y?1:5});const de=(R.name||"").trim().toLowerCase();window.setTimeout(()=>{const He=[...document.querySelectorAll(".atl2 .list .row")].find(jt=>{var Tt;return(((Tt=jt.querySelector(".rnm"))==null?void 0:Tt.textContent)||"").trim().toLowerCase().includes(de)});He&&(He.scrollIntoView({behavior:"smooth",block:"center"}),He.classList.add("flashrow"),window.setTimeout(()=>He.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(Y?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},_)}),y&&(d.kept+d.dropped>0||at.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function wp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function yp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Z(),i=e.memoConsole?r.get(e.memoConsole):null,d=p.useMemo(()=>i?[i.reasoning||"",wp(i.summary||"")].filter(Boolean).join(`
