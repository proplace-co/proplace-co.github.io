...
`,ur=8;function fr(){const{t,lang:a,token:n,dossiers:r,caps:i,markRow:o,dispatch:l}=z(),[p,x]=c.useState(!1),[u,h]=c.useState(!1),[s,v]=c.useState(!1),b=n||"home",{names:m,verdicts:f}=c.useMemo(()=>{const y=[],S={};return r.forEach(C=>{C.kind!=="target"||!C.name||(y.push(C.name),S[C.name]=pa(C)||"")}),{names:y,verdicts:S}},[r]),g=c.useMemo(()=>m.length?ua(b,m,f,a):null,[b,m.length]);if(!i.pipe||p||!g||g.firstVisit||!g.added.length&&!g.gone.length)return null;const d=u?g.added:g.added.slice(0,ur),j=g.added.length-d.length,k=y=>{const S=r.find(C=>C.name===y);S&&(o(S.id),l({type:"popup",id:S.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(g.added.length,g.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{x(!0),fa(b,m,f,g.fp,a)},children:"×"})]}),!!g.added.length&&e.jsxs("div",{className:"since-c",children:[d.map(y=>e.jsx("button",{type:"button",onClick:()=>k(y),children:y},y)),j>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>h(!0),children:t.sinceMore(j)})]}),!!g.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>v(y=>!y),children:t.sinceOut(g.gone.length)}),s&&g.gone.slice(0,20).map(y=>e.jsx("span",{className:"gone",children:y},y))]})]})}const Ue=600,fe=62,gt="atl2:fstats";function mr(){const{t,lang:a,data:n,caps:r}=z(),[i,o]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(gt)==="on"}catch{return!1}}),l=n.stats,p=c.useMemo(()=>((l==null?void 0:l.by_day)||[]).slice(-30),[l]);if(!r.showFunnel||!l||typeof l.screened!="number")return null;const x=f=>a==="en"?f.slice(5,10):`${f.slice(8,10)}/${f.slice(5,7)}`,u=f=>f.toLocaleString(a==="en"?"en-US":"fr-FR"),h=p.reduce((f,g)=>Math.max(f,g.s||0),0),s=p.length?Ue/p.length:0,v=Math.max(4,s-4),b=p.length>=5&&h>0,m=[[l.screened,t.funScreened(l.since?x(l.since):""),l.screened_today],...typeof l.kept=="number"?[[l.kept,t.funKept,l.kept_today]]:[],...typeof l.analyzed=="number"?[[l.analyzed,t.funAnalyzed,l.analyzed_today]]:[],...typeof l.shown=="number"?[[l.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(i?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[m.map(([f,g,d],j)=>e.jsxs("span",{className:"fst-t",children:[j>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:u(f)}),e.jsx("i",{children:g}),i&&typeof d=="number"&&d>0&&e.jsx("em",{children:t.funToday(d)})]},g)),b&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":i,title:i?t.fstatsHide:t.fstatsShow,onClick:()=>{const f=!i;o(f);try{localStorage.setItem(gt,f?"on":"off")}catch{}},children:i?"⌃":"⌄"})]}),i&&b&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${Ue} ${fe}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[p.map((f,g)=>{const d=(f.s||0)/h*(fe-4),j=(f.m||0)/h*(fe-4),k=g*s+(s-v)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${x(f.d)} — ${f.s} ${t.actScreened} · ${f.m} ${t.actKept}`}),e.jsx("rect",{x:k,y:fe-2-d,width:v,height:d,fill:"#cfe0d6"}),e.jsx("rect",{x:k,y:fe-2-j,width:v,height:j,fill:"#185c38"})]},f.d)}),e.jsx("line",{x1:0,y1:fe-1.5,x2:Ue,y2:fe-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:x(p[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const xr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function gr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:i}=z(),[o,l]=c.useState(""),[p,x]=c.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const u=(t.ceoStatus||"").trim(),h=(qe(t)||"").startsWith("CALL")&&X(t)===3,s=X(t)>=2,v=async m=>{if(o||m==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(m);const f=await i(t,m);l(""),f&&(x(!0),setTimeout(()=>x(!1),2200))},b=h?[["Validé",a.csYes],["Écarté",a.csNo]]:xr.filter(([m])=>!(s&&m==="Retenu")).map(([m,f])=>[m,a[f]]);return e.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,f])=>e.jsx("button",{type:"button",className:"csb"+(u===m?" on":"")+(o===m?" busy":""),disabled:!!o,onClick:()=>{v(m)},children:f},m)),p&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(hr,{o:t})]})}function hr({o:t}){const{t:a,saveNote:n,flash:r}=z(),[i,o]=c.useState(t.ceoNote||""),[l,p]=c.useState(!1),[x,u]=c.useState(!1),h=i.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(l||!h)return;p(!0);const v=await n(t,i.trim());p(!1),v&&(u(!0),setTimeout(()=>u(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:v=>o(v.target.value),onKeyDown:v=>{v.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:l||!h,onClick:()=>{s()},children:x?a.csNoteSaved:a.csNoteOk})]})}function br({placeholder:t,onDone:a}){const{t:n}=z(),[r,i]=c.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function vr({o:t}){var g;const{t:a,token:n,caps:r,canWrite:i,stageOf:o,setStage:l,flashErr:p}=z(),[x,u]=c.useState(!1);if(!r.pipe||!i||r.lockActions||X(t)!==4)return null;const h=o(t),s=(h==null?void 0:h.stage)||"todo",v=async d=>{if(x||d===s)return;u(!0);const j=h;l(t,{stage:d,stamps:(h==null?void 0:h.stamps)||{}});const k=Math.max(Date.now(),ht+=1);ht=k;const y=await ma(n,{company:t.name||"",stage:d,cts:k,deal_id:t.airtableId,check_id:t.checkId});u(!1),!y.stale&&(y.ok||(l(t,j),p(a.actErr)))},b=(g=h==null?void 0:h.stamps)==null?void 0:g.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,f=s==="sent"&&b&&m>=4;return e.jsxs("div",{className:"stg",onClick:d=>d.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([d,j])=>e.jsx("button",{type:"button",className:"stgb"+(s===d?" on":""),disabled:x,onClick:()=>{v(d)},children:j},d)),f&&e.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let ht=0;const Fe=8,Re=340;function bt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function yr({steps:t,onClose:a}){const{t:n,dispatch:r,counts:i,scoped:o,byId:l,st:p}=z(),[x,u]=c.useState(0),[h,s]=c.useState(null),[v,b]=c.useState([]),m=c.useRef(!1);c.useEffect(()=>{m.current||(m.current=!0,b(t.filter(S=>!!document.querySelector(S.need||S.sel))))},[t]);const f=v[x],g=x>=v.length;c.useEffect(()=>{f&&(f.ptab!==void 0&&p.ptab!==f.ptab&&r({type:"ptab",tab:f.ptab}),f.dens&&p.dens!==f.dens&&r({type:"dens",dens:f.dens}))},[x,f]);const d=c.useCallback(()=>{if(!f){s(null);return}const S=document.querySelector(f.sel);if(!S){s(null);return}S.scrollIntoView({block:"nearest",behavior:"smooth"}),s(S.getBoundingClientRect())},[f]);c.useLayoutEffect(()=>{d();const S=window.setTimeout(d,260),C=()=>d();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{window.clearTimeout(S),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[d]);const j=c.useRef(a);if(j.current=a,c.useEffect(()=>{const S=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),j.current()):C.key==="ArrowRight"?u(F=>F+1):C.key==="ArrowLeft"&&u(F=>Math.max(0,F-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!v.length)return null;let k=null;if(g){const S=i[3]||0,C=o.find(F=>F.memoUrl)||[...l.values()].find(F=>F.memoUrl);S>0?k={title:S===1?n.ahaATitle1:n.ahaATitleN(S),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:C?k={title:n.ahaBTitle,body:n.ahaBBody(C.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:C.id}),a()}}:k={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Re};if(!g&&h){const S=h.bottom+14,F=window.innerHeight-S>190?S:Math.max(12,h.top-200);y={left:Math.min(Math.max(12,h.left+h.width/2-Re/2),window.innerWidth-Re-12),top:F,width:Re}}return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!g&&h&&e.jsx("div",{className:"tour-hole",style:{left:h.left-Fe,top:h.top-Fe,width:h.width+Fe*2,height:h.height+Fe*2}}),(g||!h)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(g?" fin":""),style:y,children:[g&&k?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:k.title}),e.jsx("p",{children:e.jsx(bt,{text:k.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>u(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(x+1,v.length)}),e.jsx("h3",{children:f==null?void 0:f.title}),e.jsx("p",{children:e.jsx(bt,{text:(f==null?void 0:f.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:x===0,onClick:()=>u(S=>Math.max(0,S-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>u(S=>S+1),children:x===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function wr(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:i}=z(),o=c.useMemo(()=>t.filter(s=>ve(s.date)===0&&s.kind==="target"),[t]),l=c.useMemo(()=>o.filter(s=>a?X(s)===0:!Q(s)),[o,a]),p=o.length-l.length,x=o.length?Math.min(100,p/o.length*100):100;let u;a?u=n.morningThesis(o.length,p,l.length):o.length?p===0?u=n.goalSourced(o.length):p>=o.length?u=n.goalCleared:u=n.goalDone(p,o.length):u=n.goalSourced(0);const h=()=>{a?(i({type:"ptab",tab:0}),i({type:"filters",patch:{win:"1"}})):i({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:u}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:x+"%"}})}),l.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:a?n.morningEval(l.length):r.pileMode?n.goalContinue(l.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function kr(){var I;const{t,st:a,dispatch:n,token:r,fund:i,data:o,dossiers:l,mode:p,doSync:x,startTour:u}=z(),[h,s]=c.useState(null),[v,b]=c.useState([]),[m,f]=c.useState(!1),g=p==="client";c.useEffect(()=>{if(!r||!i)return;let O=!0;return(async()=>{const[M,B]=await Promise.all([zt(i),Tt(r)]);O&&(M&&s(M),b(B))})(),()=>{O=!1}},[r,i]);const d=(h==null?void 0:h.per_day)??null,j=((I=h==null?void 0:h.pool_order)==null?void 0:I.length)??0,k=v.filter(O=>O.status==="running").length,y=O=>{if(!g||d===null||m)return;const M=Math.max(0,Math.min(10,d+O));M!==d&&(f(!0),s(B=>B&&{...B,per_day:M}),Et(r,M).then(B=>{f(!1),s(B===null?E=>E&&{...E,per_day:d}:E=>E&&{...E,per_day:B})}))},S=c.useMemo(()=>l.filter(O=>O.kind==="target"&&Q(O)).length,[l]),C=o.marketEstimate,F=C&&C>0?Math.min(100,Math.round(S/C*100)):null,N=(i||"P").split(/\s+/).map(O=>O[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const O=Date.parse(o.generatedAt||"");if(Number.isNaN(O))return"";const M=new Date(O),B=E=>String(E).padStart(2,"0");return`${B(M.getDate())}/${B(M.getMonth()+1)} à ${B(M.getHours())}:${B(M.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:i})]}),e.jsx("h1",{children:t.identTitle(i||"…")}),e.jsx("span",{className:"idsp"}),T&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(T)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:u,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[F!==null&&C&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:F+"%"}})}),e.jsxs("b",{children:[F," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(S,C)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),d!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),y(-1)},children:"−"}),e.jsx("b",{className:"q",children:d})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),y(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),d===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),k>0&&e.jsxs("span",{className:"ev",children:["⏳ ",k]}),e.jsx("span",{className:"ego",children:t.identPending(j)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:O=>{O.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!g,onClick:x,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:O=>n({type:"filters",patch:{search:O.target.value}})})]})]})]})}function jr(){const{t,counts:a,dispatch:n}=z();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,i],o)=>{const l=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(l?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:i}),l&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Nr=["--p0","--p1","--p2","--p3","--p4"];function Sr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:i}=z(),o=c.useRef({});c.useEffect(()=>{o.current={...n}},[n]);const l=u=>{const h=o.current[u],s=h!==void 0?n[u]-h:0;return e.jsxs("button",{type:"button",className:"step"+(u===3&&n[3]>0?" wait":""),style:{"--c":`var(${Nr[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===u,title:r.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[e.jsxs("span",{className:"l",children:[r.plabels[u].toUpperCase(),u===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[u],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},u)},p=(u,h,s)=>e.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===u,title:r.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[u]})]},u),x=(u,h,s,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:h,disabled:v,onClick:s,children:u},h);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),e.jsxs("div",{className:"offtrack",children:[p(5,!1,r.plabels[5]),p(7,!0,r.plabels[7]),p(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[x("↩",r.toolUndo,i,t.undo.length===0),x("↺",r.toolReset,()=>{a({type:"reset"})}),x("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),x("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Cr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function zr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:i,doAnalyse:o,mode:l}=z(),p=c.useRef(null),[x,u]=c.useState(60);c.useEffect(()=>{let b=0;const m=()=>{var k;const f=p.current;if(!f)return;const g=(k=f.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!g)return;const d=g.getBoundingClientRect(),j=f.getBoundingClientRect();u(Math.max(20,Math.min(d.left+d.width/2-j.left,j.width-30)))};return b=requestAnimationFrame(m),window.addEventListener("resize",m),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",m)}},[t.ptab]);const h=t.ptab;let s=n.tuto[h].p;if(h===3){const b=r.filter(g=>g.kind==="target"&&X(g)===3),m=b.filter(g=>_e(g)==="auto").length,f=b.filter(g=>_e(g)==="cd").length;s=n.tutoPending(m,f,b.length)}const v=(()=>{if(l!=="client")return null;if(h===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(h===1){const b=r.filter(m=>m.kind==="target"&&X(m)===1&&!i.has(m.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(m=>o(m))}}return null})();return e.jsxs("div",{ref:p,className:"tuto mini",style:{"--bg":Cr[h],"--ax":x+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[h].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const vt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function yt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Tr(t,a){const[n,r]=c.useState(1);return c.useEffect(()=>{let i=!0,o=0;const l=()=>{var u;if(!i)return;const x=(u=t.current)==null?void 0:u.getScreenCTM();x&&x.a>0?r(x.a):o=requestAnimationFrame(l)};l();const p=new ResizeObserver(()=>l());return t.current&&p.observe(t.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),p.disconnect(),window.removeEventListener("resize",l)}},[t,a]),n}function Er(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:i,markedId:o,byId:l,lang:p,t:x}=z(),u=c.useRef(null),h=c.useRef(null),s=We.find(N=>N.key===t.continent),v=Tr(u,t.continent+":"+t.mapFolded),[b,m]=c.useState(new Map),[f,g]=c.useState(null);c.useEffect(()=>{const N=u.current;if(!N)return;const T=new Map;N.querySelectorAll("path[data-i2]").forEach(I=>{const O=I.dataset.i2;if(O)try{const M=I.getBBox();M.width>0&&T.set(O,{x:M.x,y:M.y,w:M.width,h:M.height})}catch{}}),m(T)},[t.continent,v]);const d=c.useMemo(()=>n.filter(N=>N.cc),[n]),j=c.useMemo(()=>{const N=new Map;return d.forEach(T=>N.set(T.cc,(N.get(T.cc)||0)+1)),N},[d]),k=c.useMemo(()=>d.map(N=>{const T=N.cc?b.get(N.cc):void 0;if(!T)return null;const I=yt(N.name||N.id||""),O=yt((N.id||N.name||"")+"·y"),M=(I-.5)*Math.min(T.w*.55,60),B=(O-.5)*Math.min(T.h*.55,60);return{d:N,x:T.x+T.w/2+M,y:T.y+T.h/2+B}}).filter(N=>!!N),[d,b]),y=N=>v>0?N/v:N,S=c.useMemo(()=>r?[0,1,2,3,4,5].map(N=>({c:vt[N],fr:x.plabels[N].toUpperCase(),en:x.plabels[N].toUpperCase(),n:n.filter(T=>T.kind==="target"&&X(T)===N).length})).filter(N=>N.n>0):ot.map((N,T)=>({...N,n:n.filter(I=>it(I)===T).length})),[n,r,x.plabels]),C=o?l.get(o):null,F=C?k.find(N=>N.d.id===C.id):null;return e.jsxs("div",{className:"mapzone",ref:h,children:[e.jsxs("svg",{ref:u,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":p==="fr"?s.fr:s.en,onMouseLeave:()=>{g(null),i(null)},children:[e.jsx("g",{children:s.countries.map((N,T)=>e.jsx("g",{className:"ct"+(N.i2&&j.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},T))}),e.jsx("g",{children:k.map(N=>{const T=ot[it(N.d)],I=!!Y(N.d),O=N.d.kind==="target",M=r&&O?vt[X(N.d)]:T.c,B=!r&&Q(N.d);return e.jsxs("g",{className:"co"+(B?" done":""),onMouseEnter:()=>{var P,_;const E=(P=h.current)==null?void 0:P.getBoundingClientRect(),R=(_=u.current)==null?void 0:_.createSVGPoint();if(R&&u.current&&E){R.x=N.x,R.y=N.y;const re=R.matrixTransform(u.current.getScreenCTM());g({x:re.x-E.left,y:re.y-E.top,label:N.d.name+" · "+(ye(N.d.cc,p)||N.d.countryLabel||"")})}i(N.d.id)},onMouseLeave:()=>{g(null),i(null)},onClick:()=>{var P;const E=(P=u.current)==null?void 0:P.createSVGPoint();let R=null;if(E&&u.current){E.x=N.x,E.y=N.y;const _=E.matrixTransform(u.current.getScreenCTM());R={x:_.x,y:_.y}}a({type:"popup",id:N.d.id,anchor:R})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:y(Math.max(11,T.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:y(T.px),fill:M,stroke:I?"#DC2626":"#ffffff",strokeWidth:y(I?2.2:1.3)})]},N.d.id||N.d.name)})}),F&&e.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:y(13),fill:"none",stroke:"#0F172A",strokeWidth:y(2)})]}),e.jsx("div",{className:"hov"+(f?" on":""),style:f?{left:f.x,top:f.y}:void 0,children:f==null?void 0:f.label}),e.jsx("div",{className:"legend",children:S.map((N,T)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),p==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},T))}),n.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",x.notLocated," ",e.jsx("b",{children:n.filter(N=>!N.cc).length})]})})]})}function Ar(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:i,contName:o}=z(),l=t.filters,p=c.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),x=b=>p.filter(m=>b!=="country"&&l.country.length&&!l.country.includes(m.cc||"")?!1:Qe(m,l,i,b==="country"?void 0:b)),u=c.useMemo(()=>{const b=x("win"),m=f=>b.filter(g=>(g.date?Math.max(0,Math.floor((Date.now()-Date.parse(g.date))/864e5)):9999)<=f).length;return[m(0),m(7),m(30),b.length]},[p,l,i]),h=c.useMemo(()=>{if(i)return null;const b=x("status"),m={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(f=>{m[se(f)]+=1}),m},[p,l,i]),s=l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+(l.signalOnly?1:0)+(l.win!=="all"?1:0)+(!i&&l.status!=="all"?1:0)+(l.search.trim()?1:0),v=(b,m,f,g="fbtn")=>e.jsxs("button",{type:"button",className:g,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:m}),f>0&&e.jsx("span",{className:"n",children:f}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,m)=>e.jsxs("button",{type:"button","aria-pressed":l.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[m],e.jsx("b",{children:u[m]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:l.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!i&&h&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,m])=>e.jsxs("button",{type:"button","aria-pressed":l.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[m,e.jsx("b",{children:h[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),l.signalOnly&&e.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,l.sector.length),v("pay",r.fCountry,l.country.length),v("det",r.fEngine,l.engine.length),v("sta",r.fStage,l.stage.length),i&&v("ang","Angle",l.angle.length),i&&v("mem","Mémo",l.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(Or,{poolFor:x})]})}function Or({poolFor:t}){const{st:a,dispatch:n,t:r,lang:i}=z(),o=a.filters,l=a.openFacet,{title:p,cols:x,options:u}=c.useMemo(()=>{if(l==="sig"){const m=t("signal").filter(d=>Y(d)),f=new Map;m.forEach(d=>{const j=d.engine||"";f.set(j,(f.get(j)||0)+1)});const g=[{v:"*",label:r.fpSigAll,n:m.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...lt([...f.keys()],i).map(d=>({v:d,label:be(d)+" "+oe(d,i),n:f.get(d)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(d)}))];return{title:r.fpSigTitle,cols:2,options:g}}if(l==="sec"){const m=t("sector"),f=new Map;return m.forEach(g=>{g.sector&&f.set(g.sector,(f.get(g.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...f.entries()].sort((g,d)=>d[1]-g[1]).map(([g,d])=>({v:g,label:g,n:d,html:!1,on:o.sector.includes(g)}))}}if(l==="pay"){const m=t("country"),f=new Map;return m.forEach(g=>{g.cc&&f.set(g.cc,(f.get(g.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...f.entries()].sort((g,d)=>d[1]-g[1]).map(([g,d])=>({v:g,label:ye(g,i)||g,n:d,html:!1,on:o.country.includes(g)}))}}if(l==="det"){const m=t("engine"),f=new Map;return m.forEach(g=>{g.engine&&f.set(g.engine,(f.get(g.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:lt([...f.keys()],i).map(g=>({v:g,label:be(g)+" "+oe(g,i)+' <span style="color:var(--dim);font-size:10px">· '+xa(ga(g),i)+"</span>",n:f.get(g)||0,html:!0,on:o.engine.includes(g)}))}}if(l==="ang"){const m=t("angle"),f=new Map;return m.forEach(g=>{g.angle&&f.set(g.angle,(f.get(g.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((g,d)=>d[1]-g[1]).map(([g,d])=>({v:g,label:g.replace(/[_-]+/g," "),n:d,html:!1,on:o.angle.includes(g)}))}}if(l==="mem"){const m=t("memoLevel"),f=new Map;m.forEach(d=>{if(d.kind==="target"){const j=Ye(d);f.set(j,(f.get(j)||0)+1)}});const g=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(d=>({v:String(d),label:g[d],n:f.get(d)||0,html:!1,on:o.memoLevel.includes(d)}))}}const v=t("stage"),b=new Map;return v.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,f)=>f[1]-m[1]).map(([m,f])=>({v:m,label:m,n:f,html:!1,on:o.stage.includes(m)}))}},[l,a,i]),h=v=>{if(l==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const m=o.signalEngines.includes(v)?o.signalEngines.filter(f=>f!==v):[...o.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(l==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:v})},s=()=>{n(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:p}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(x===2?" two":""),children:u.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>h(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const wt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Lr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:i,dispatch:o,evalBusy:l,evalCards:p,caps:x,data:u}=z(),h=a==="client",[s,v]=c.useState(""),[b,m]=c.useState(!1),[f,g]=c.useState(""),[d,j]=c.useState(!1),[k,y]=c.useState(""),[S,C]=c.useState([]),F=c.useRef(!1),N=s.trim()?wt.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,T=c.useMemo(()=>f.split(`
`).map(E=>E.trim()).filter(Boolean).slice(0,15),[f]),I=S.length?S:p,O=u.credits,M=()=>{const E=s.trim();E&&(r(null,E),v(""))},B=async()=>{if(!h){r(null,T[0]||"");return}if(!T.length||d)return;j(!0),F.current=!1;const E=[];for(let R=0;R<T.length&&!F.current;R++){y(t.evaluating(R+1,T.length,T[R]));const P=await At(n,T[R],"atelier2");if(E.unshift({name:P.company||T[R],verdict:P.verdict,reason:P.reason||"",remaining:P.remaining??null}),C([...E]),P.verdict==="quota"){E.unshift({name:"",verdict:"quota",reason:t.quota(T.length-R-1),remaining:0}),C([...E]);break}}y(""),g(""),j(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:E=>v(E.target.value),onKeyDown:E=>{E.key==="Enter"&&M()}}),e.jsx("span",{className:"detect"+(wt.test(s.trim())?" url":""),children:N})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),disabled:l,onClick:M,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),x.showCredits&&O&&e.jsxs("button",{type:"button",className:"credits"+(O.total_available<=0&&!O.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:O.unlimited?"∞":O.total_available}),!O.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",O.daily_grant+O.purchased]}),O.total_available<=0&&!O.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>m(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:f,placeholder:t.bulkPh,onChange:E=>g(E.target.value.split(`
`).slice(0,15).join(`
