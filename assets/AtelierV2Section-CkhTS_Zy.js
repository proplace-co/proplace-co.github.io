...
/* Crédits essai + packs d'achat dans la carte Moteur de mémos. */
.atl2.cibles .map-engine-credits,
.atl2.cibles .stage:not(.folded) .map-engine-credits{margin-top:10px;padding-top:10px;
  border-top:1px solid #EAF0F6}
.atl2.cibles .stage:not(.folded) .map-engine-credits em{display:block;font-style:normal;
  font-size:11px;font-weight:700;color:var(--pp-green-tx,#0E8A44);letter-spacing:0;
  margin:0;text-transform:none}
.atl2.cibles .stage:not(.folded) .map-engine-credits>b{display:block;margin:4px 0 0;
  font-size:22px!important;font-weight:800;letter-spacing:-.03em;line-height:1;
  color:var(--pp-ink,#0F1D33)}
.atl2.cibles .stage:not(.folded) .map-engine-credits>b span{font-size:13px;font-weight:600;
  color:#8FA0B8;letter-spacing:0}
.atl2.cibles .stage:not(.folded) .map-engine-credits>span{display:block;margin:3px 0 0;
  font-size:11px;font-weight:600;color:#8FA0B8}
.atl2.cibles .map-engine-credits p{margin:8px 0 0;font-size:11.5px;line-height:1.4;
  color:#4A5C73;font-weight:500}
.atl2.cibles .map-engine-packs{display:grid;grid-template-columns:1fr 1fr;gap:6px;
  margin-top:10px}
.atl2.cibles .map-engine-packs button{display:flex;flex-direction:column;align-items:flex-start;
  gap:1px;min-width:0;height:auto;padding:7px 8px;border:1px solid #E3E8F0;
  border-radius:8px;background:#fff;cursor:pointer;text-align:left;font:inherit}
.atl2.cibles .map-engine-packs button:hover:not(:disabled){border-color:#12A150;
  background:#F4FBF6}
.atl2.cibles .map-engine-packs button:disabled{opacity:.55;cursor:wait}
.atl2.cibles .map-engine-packs button strong{font-size:13px;font-weight:800;
  color:#0F1D33;line-height:1.1}
.atl2.cibles .map-engine-packs button i{font-style:normal;font-size:11px;font-weight:600;
  color:#8FA0B8}
`,ql=Sl+Cl+zl+Al;function gn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Tl(){const e=gn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ll(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Tl();return r==="0"?"client":r==="1"||gn("embed")==="1"&&gn("chrome")==="1"?"apercu":"client"}const Fl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Rl=e=>Fl[e];function Oa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Tt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!xo(a)||Oa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ji(e.cc)})};function Za(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ol=60*60*1e3;function Ml(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ol?null:a}catch{return null}}function xa(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Dl=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Il(e,a,r="default"){const n=r!=="default",o=c.useMemo(()=>e||n?{mode:"anon"}:_i(),[e,n]),i=c.useMemo(()=>n?"visiteur":Ll(e,o),[e,o,n]),d=c.useMemo(()=>Rl(i),[i]),l=i!=="visiteur",s=Dl(r),[h,p]=c.useState([]),[x,m]=c.useState(""),[b,f]=c.useState(null),[w,y]=c.useState(null),[u,v]=c.useState(null),[E,k]=c.useState(()=>new Map),[j,N]=c.useState(()=>new Map),[C,q]=c.useState(""),[S,T]=c.useState(new Set),[D,B]=c.useState(null),[R,O]=c.useState(!0),[g,L]=c.useState(!1),[M,J]=c.useState(0),[te,z]=c.useState(0),$=c.useRef(0),I=c.useMemo(()=>{var U;if(i!=="client")return"";try{return((U=Bi())==null?void 0:U.email)||""}catch{return""}},[i]);c.useEffect(()=>{const U=++$.current;let ue=!0;const ae=()=>ue&&U===$.current,de=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),xe=Ml(de);return xe?(p(xe.objs.map(Tt)),xe.fund&&m(xe.fund),f(xe.marketEstimate??null),y(xe.criteria??null),v(xe.stats??null),q(xe.generatedAt||""),O(!1)):O(!0),(async()=>{try{if(r==="ops"){const me=await Qa(),we=((me==null?void 0:me.recent_ops)||[]).map(be=>{const Ne=Sa(be.company_name||be.title?be:{...be,title:(be.headline_fr||be.headline||"").slice(0,120)},a),Re=String(be.rubrique||"").toLowerCase();return Ne&&(Re==="nominations"||Re==="recrutements")&&(Ne.engine=Re),Ne&&!String(be.company_name||"").trim()&&(Ne.noCo=!0),Ne}).filter(be=>!!be).map(be=>(xo((be.name||"").trim())||(be.noCo=!0),be));try{const be=$i(),Ne=await Ui(),Re=((Ne==null?void 0:Ne.date)||"").slice(0,10),ne=be?be.doc:Ne,ke=Hi(ne),ve=((be==null?void 0:be.day)||(ne==null?void 0:ne.date)||Re||"").slice(0,10);if(ve&&ke.length){const oe=new Set;for(const _ of we){if((_.date||"").slice(0,10)!==ve)continue;const W=Zn(ke,oe,_.name,"");W>=0&&(oe.add(W),_.decryptHtml=ke[W].html)}for(const _ of we){if(_.decryptHtml||(_.date||"").slice(0,10)!==ve)continue;const W=Zn(ke,oe,"",_.headline||_.tagline||_.name);W>=0&&(oe.add(W),_.decryptHtml=ke[W].html)}}if(ve){const oe=((ne==null?void 0:ne.title_fr)||"").trim(),_=((ne==null?void 0:ne.lead_fr)||"").trim(),W=Vi(ne),ee=((ne==null?void 0:ne.url)||"").trim();oe&&(W||ee)&&we.unshift({id:`edito:${ve}`,kind:"op",name:oe,cc:null,date:ve,engine:"edito",dealKind:"other",headline:oe,tagline:_||oe,decryptHtml:W||void 0,url:ee,noCo:!0})}}catch{}if(!ae())return;p(we.map(Tt)),xa(de,{objs:we})}else if(typeof r=="object"){const we=(await er()||[]).filter(Ne=>(Ne.slug||"")===r.research).map(Ne=>tr(Ne,a)).filter(Ne=>!!Ne),be=Za(await ar(we,a));if(!ae())return;p(be.map(Tt)),xa(de,{objs:be})}else if(l&&o.token){const me=Wi(o.token),we=Qa(),be=Gi(o.token),Ne=Yi(o.token),Re=Qi(o.token),ne=await me;let ke=ne?ne.targets:[];ae()&&ne&&(m(ne.fund||""),f(ne.marketEstimate??null),y(ne.criteria??null),v(ne.stats??null),q(ne.generatedAt||""),p(ke.map(Tt)),O(!1),L(!1));const[ve,oe,_,W]=await Promise.all([we,be,Ne,Re]),ee=((ve==null?void 0:ve.recent_ops)||[]).map(re=>Sa(re,a)).filter(re=>!!re),le=new Set(ke.map(re=>re.id));if(ke=[...ke,...ee.filter(re=>!le.has(re.id)&&(le.add(re.id),!0))],!ae())return;p(ke.map(Tt));const pe=new Set;for(const re of oe){const ie=(re.id||re.co||"").toString().trim().toLowerCase();ie&&pe.add(ie.startsWith("t:")?ie:"t:"+ie)}T(pe),k(_),N(W),ne&&xa(de,{fund:ne.fund,marketEstimate:ne.marketEstimate,criteria:ne.criteria,stats:ne.stats,generatedAt:ne.generatedAt,objs:ke})}else{const me=Ki(),we=er(),be=Qa(),Ne=await me;ae()&&Ne.length&&(p(Za(Ne).map(Tt)),O(!1),L(!1));const[Re,ne]=await Promise.all([we,be]),ke=(Re||[]).map(W=>tr(W,a)).filter(W=>!!W),ve=await ar(ke,a),oe=((ne==null?void 0:ne.recent_ops)||[]).map(W=>Sa(W,a)).filter(W=>!!W),_=Za([...Ne,...ve,...oe]);if(!ae())return;p(_.map(Tt)),xa(de,{objs:_})}ae()&&L(!1)}catch{ae()&&!xe&&L(!0)}finally{ae()&&O(!1)}})(),()=>{ue=!1}},[l,o.token,a,M,s]),c.useEffect(()=>{if(!d.showCredits||!I){B(null);return}let U=!0;return(async()=>{try{const ue=await fetch(`${fa}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:I})});if(!ue.ok)return;const ae=await ue.json();U&&ae&&ae.ok!==!1&&B(ae)}catch{}})(),()=>{U=!1}},[d.showCredits,I,te]);const V=c.useCallback(U=>T(new Set(U)),[]);return{session:o,mode:i,caps:d,fund:x,email:I,marketEstimate:b,generatedAt:C,criteria:w,thesisMode:String((w==null?void 0:w.mode)||""),stats:u,thumbs:E,stages:j,dossiers:h,patchStatuses:(U,ue)=>{p(ae=>{let de=!1;const xe=ae.map(me=>{if(!me.checkId)return me;const we=U.get(me.checkId);return!we||we===(me.ceoStatus||"")||!ue(me.id)?me:(de=!0,{...me,ceoStatus:we})});return de?xe:ae})},favIds:S,setFavIds:V,credits:D,reloadCredits:()=>z(U=>U+1),loading:R,error:g,refresh:()=>J(U=>U+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Ca=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ma(e){return Ca.has(e.engine||"")}function Xe(e){return!!e.noCo||Ma(e)&&!!e.url}const Do=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Pl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Do(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),_l=new Set(["signal","amount","score","crible","memo"]);function Bl(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Do(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:_l.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Io)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Io=80;function Da(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!$e(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Rn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(jt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Lt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(vo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function sa(e,a,r){return We(e)?Da(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Da(e,a.filters,r)}function $l(e,a,r,n){return!(!sa(e,a,r)||r&&!bo(e,a.ptab,n))}function Pn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-jt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Zi(o)||null;case"memo":return Xi(o)||null;case"signal":{const i=$e(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const en={},yr=(en==null?void 0:en.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function kr(){return new Date().toISOString().slice(0,10)}const _n=c.createContext(null);function Po(){return c.useContext(_n)}function Ul(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const h=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(p=>s.removeAttribute(p.name)),h&&/^https?:\/\//i.test(h)&&(s.setAttribute("href",h),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function _o(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Hl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),_o(r),r.innerHTML):e}catch{return e}}function Er(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),_o(r),r.innerHTML):e}catch{return e}}function jr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Bo(){const e=c.useContext(_n);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Vl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Q(),[i,d]=c.useState(()=>n.filters.day||kr()),[l,s]=c.useState(null),[h,p]=c.useState(!1),x=c.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),m=c.useCallback(()=>{d(kr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);c.useEffect(()=>{const w=y=>{var v;const u=(v=y.detail)==null?void 0:v.day;typeof u=="string"&&x(u)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),c.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),c.useEffect(()=>{if(!e||!i)return;let w=!1;p(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${yr}/cibles/edition.json?${y}`).then(u=>u.json()).then(u=>{w||s(u)}).catch(()=>{w||s({ok:!1,error:"network"})}).finally(()=>{w||p(!1)}),()=>{w=!0}},[e,i]);const b=c.useMemo(()=>`${yr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),f=c.useMemo(()=>({token:e,day:i,ed:l,loading:h,pickDay:x,pickWindow:m,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,h,x,m,n.filters.day,b,o]);return t.jsx(_n.Provider,{value:f,children:a})}function Wl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Bo(),[o,i]=c.useState(()=>n||wo());return c.useEffect(()=>{n&&i(!0)},[n]),c.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(Ta,d),()=>window.removeEventListener(Ta,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(es,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Gl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Nr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Sr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Yl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Bo(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,h=c.useRef(null),[p,x]=c.useState("fonds"),[m,b]=c.useState(null),[f,w]=c.useState("idle"),y=c.useRef(!1);c.useEffect(()=>{b(null),w("idle"),y.current=!1,x("fonds")},[e]),c.useEffect(()=>{if(p!=="jour"||y.current)return;y.current=!0;let j=!0;return w("load"),Gl(e).then(N=>{j&&(b(N),w("fait"))}),()=>{j=!1}},[p,e]);const u=c.useMemo(()=>Hl((m==null?void 0:m.html)||""),[m==null?void 0:m.html]),v=c.useRef(null);c.useEffect(()=>{const j=v.current;if(!j||!u)return;let N=!1;return mn(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!j.isConnected)&&(C.beautifyEditoRows(j),C.mountCardFits(j))}),()=>{N=!0}},[u]);const E=c.useMemo(()=>Er((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=c.useMemo(()=>Er((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return c.useEffect(()=>{const j=h.current;if(!j||!E)return;let N=!1;return mn(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!j.isConnected)&&(C.beautifyEditoRows(j),C.mountCardFits(j))}),()=>{N=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const j=(a==null?void 0:a.date)||e,N=/^(\d{4})-(\d{2})-(\d{2})/.exec(j);return N?i?`${N[2]}/${N[3]}/${N[1]}`:`${N[3]}/${N[2]}/${N[1]}`:j})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":p==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":p==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),p==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),p==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p==="fonds"&&s&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),p==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Nr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:jr(e,!0)}),"."]}):Nr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:jr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),p==="fonds"&&d&&E?t.jsx("div",{ref:h,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,p==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,p==="jour"&&(u?t.jsxs(t.Fragment,{children:[(m==null?void 0:m.title)&&t.jsx("h3",{className:"thesis-brief__title thesis-brief__jour-h",children:m.title}),t.jsx("div",{ref:v,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:u}})]}):t.jsx("p",{className:f==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:f!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Sr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Sr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Ql=300,ba=7,Kl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},$o={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Jl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function tn(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(rs(r)&&r!=="media")return"news:"+r;const n=$e(e);return n?"sig:"+(n.theme&&$o.fr[n.theme]?n.theme:"other"):"actualites"}function Xl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=Q(),s=Po(),h=d==="en",[p,x]=c.useState("all"),[m,b]=c.useState(!1),f=c.useMemo(()=>{var ue;const g=(a.filters.day||"").slice(0,10),L=ae=>!(!i&&a.continent!=="monde"&&ae.continent!==a.continent||g&&(ae.date||"").slice(0,10)!==g),M=e.filter(ae=>L(ae)&&$e(ae)&&(!i||ae.kind!=="target"||Fe(ae)!==5)),J=i&&(((ue=s==null?void 0:s.ed)==null?void 0:ue.ops)||[]).length?s.ed.ops.map(ae=>Sa(ae,d)).filter(ae=>!!ae).map(ae=>(ae.briefOnly=!0,ae)).filter(ae=>!g||(ae.date||"").slice(0,10)===g):[],te=e.filter(ae=>L(ae)&&ae.kind==="op"&&(g?!0:jt(ae.date)<=ba)),z=i?J.length?J:te.filter(ae=>{const de=(l||"").trim().toLowerCase();if(!de)return!1;const xe=ae.match||null;return xe?Object.keys(xe).map(me=>me.trim().toLowerCase()).includes(de):!1}):te,$=g||new Date().toISOString().slice(0,10),I=ae=>{const de=tn(ae);return de==="ma"?0:de==="levees"?1:2};z.sort((ae,de)=>{const xe=I(ae)-I(de);if(xe)return xe;const me=(ae.date||"").slice(0,10)===$?0:1,we=(de.date||"").slice(0,10)===$?0:1;return me!==we?me-we:(de.amountEur||0)-(ae.amountEur||0)});const V=new Set,U=[];for(const ae of[...z,...Pn(M,{key:"signal",dir:-1})]){const de=ae.id||ae.name;!de||V.has(de)||(V.add(de),U.push(ae))}return i&&U.length===0?e.filter(de=>L(de)&&jt(de.date)<=ba).sort((de,xe)=>(xe.date||"").localeCompare(de.date||"")).slice(0,80):U},[e,a.continent,a.filters.day,i,l,d,s]),w=c.useMemo(()=>{const g={};for(const L of f){const M=tn(L);g[M]=(g[M]||0)+1}return g},[f]),y=c.useMemo(()=>p==="all"?f:f.filter(g=>tn(g)===p),[f,p]),u=c.useMemo(()=>y.slice(0,Ql),[y]),v=y.length-u.length,E=c.useRef(null);c.useEffect(()=>{var z,$;const g=E.current;if(!g)return;const L=()=>{const I=g.scrollWidth;I<200||(g.style.animationDuration=Math.max(18,Math.round(I/130))+"s")};L();const M=requestAnimationFrame(L),J=window.setTimeout(L,1200);let te=!0;return($=(z=document.fonts)==null?void 0:z.ready)==null||$.then(()=>{te&&L()}),()=>{te=!1,cancelAnimationFrame(M),window.clearTimeout(J)}},[u.length,p]);const k=g=>g==="all"?f.length:w[g]||0,j=g=>{if(g==="all")return h?"All":"Tout";if(g.startsWith("sig:"))return $o[h?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const L=g.slice(5);return as[L]?ns(L,h?"en":"fr"):g}return Kl[h?"en":"fr"][g]},N=[{k:"all"}],C=["ma","levees"].filter(g=>k(g)>0||g===p);if(C.length){N.push({g:h?"Deals":"Opérations"});for(const g of C)N.push({k:g})}const q=["nominations","recrutements"].filter(g=>k(g)>0||g===p),S=ts.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>k(g)>0||g===p),T=k("actualites")>0||p==="actualites"?["actualites"]:[];if(q.length||S.length||T.length){N.push({g:h?"News":"Actualités"});for(const g of q)N.push({k:g});for(const g of S)N.push({k:g});for(const g of T)N.push({k:g})}const D=Jl.map(g=>"sig:"+g).filter(g=>k(g)>0||g===p);if(D.length){N.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of D)N.push({k:g})}const B=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},R=(()=>{const g=(a.filters.day||"").slice(0,10),L=!i&&a.continent!=="monde"&&o?h?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return g?(h?`LIVE covers the events of ${B(g)}.`:`Le LIVE regroupe les événements du ${B(g)}.`)+L:(h?`LIVE covers the still-open signals and the deals of the last ${ba} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ba} derniers jours.`)+L})(),O=g=>u.map(L=>t.jsxs("button",{type:"button",className:"tk"+(Ge(L)?" spent":""),onClick:M=>{const J=L.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:J?"":L.id,name:L.name,url:L.url||"",text:L.tagline||L.headline||"",card:L.card}}))}catch{}if(J||n({type:"focus",id:L.id}),a.dens!=="liste"){const te=M.currentTarget.getBoundingClientRect();n({type:"popup",id:L.id,anchor:{x:te.left+te.width/2,y:te.bottom}})}},title:L.name+(L.tagline?" — "+L.tagline:""),children:[t.jsx(Ct,{o:L}),t.jsxs("span",{className:"who",children:[t.jsx(Ni,{o:L}),t.jsx("span",{className:"co",children:L.name})]}),(()=>{const M=(L.tagline||L.headline||"").trim();return M&&M!==L.name?t.jsx("span",{className:"what",children:M}):null})(),typeof L.amountEur=="number"&&L.amountEur>0&&t.jsx("span",{className:"am",children:eu(L.amountEur)}),L.sector&&t.jsx("span",{className:"mt",children:L.sector}),t.jsx(Ga,{o:L}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(L.id||L.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":m,onClick:()=>b(g=>!g),children:[j(p),t.jsx("b",{children:k(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!m,children:[t.jsx("span",{className:"tkfilscope",children:R}),N.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===p,onClick:()=>{x(g.k),b(!1)},children:[j(g.k),t.jsx("b",{children:k(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:u.length?t.jsxs("div",{className:"run",ref:E,children:[O(0),O(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!s&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!s&&t.jsx(ed,{isEn:h})]})}const Zl=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function ed({isEn:e}){const[a,r]=c.useState(()=>wo());c.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Ta,o),()=>window.removeEventListener(Ta,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>os(!a),children:Zl})}class pt extends c.Component{constructor(){super(...arguments);Kn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Uo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Cr(e,a){if((zt(e)||"").startsWith("CALL")&&Fe(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Fe(e)>=2;return Uo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const zr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",td={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function ad({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=Q(),[l,s]=c.useState(""),[h,p]=c.useState(!1),[x,m]=c.useState(!1),b=c.useRef(null);if(c.useEffect(()=>{if(!x)return;const v=E=>{b.current&&!b.current.contains(E.target)&&(m(!1),p(!1))};return document.addEventListener("click",v,!0),()=>document.removeEventListener("click",v,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const f=(e.ceoStatus||"").trim(),w=async v=>{if(l)return;if(v==="Analysé"&&!e.memoUrl){p(!0);return}s(v);const E=(Cr(e,a).find(([j])=>j===v)||[v,v])[1],k=await o(e,v,{msg:a.csMoved(e.name,E)});s(""),k&&(p(!1),m(!1))},y=Cr(e,a),u=v=>(y.find(([E])=>E===v)||[])[1]||v;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:v=>v.stopPropagation(),children:y.map(([v,E])=>t.jsx("button",{type:"button",className:"rsd "+(v==="Validé"?"yes":"no")+(l===v?" busy":""),disabled:!!l,onClick:()=>{w(v)},children:E},v))}):t.jsxs("span",{className:"rstat"+(x||h?" rs-open":""),ref:b,onClick:v=>v.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+zr(f),onClick:()=>{m(v=>!v),p(!1)},children:l?u(l)+"…":f?u(f):a.csNone}),x&&!h&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([v,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":f===v,className:"rsopt"+(f===v?" on":"")+(l===v?" busy":""),disabled:!!l,onClick:()=>{if(v===f){m(!1);return}w(v)},children:[t.jsx("i",{className:"pt2",style:{background:td[zr(v)]}}),E]},v))}),h&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),p(!1),m(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const v=await o(e,"Analysé");s(""),v&&(p(!1),m(!1))})()},children:a.csAnaAnyway})]})})]})}function nd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Q(),[i,d]=c.useState(""),[l,s]=c.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),p=(zt(e)||"").startsWith("CALL")&&Fe(e)===3,x=Fe(e)>=2,m=async f=>{if(i||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(f);const w=await o(e,f);d(""),w&&(s(!0),setTimeout(()=>s(!1),2200))},b=p?[["Validé",a.csYes],["Écarté",a.csNo]]:Uo.filter(([f])=>!(x&&f==="Retenu")).map(([f,w])=>[f,a[w]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([f,w])=>t.jsx("button",{type:"button",className:"csb"+(h===f?" on":"")+(i===f?" busy":""),disabled:!!i,onClick:()=>{m(f)},children:w},f)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(rd,{o:e})]})}function rd({o:e}){const{t:a,saveNote:r,flash:n}=Q(),[o,i]=c.useState(e.ceoNote||""),[d,l]=c.useState(!1),[s,h]=c.useState(!1),p=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!p)return;l(!0);const m=await r(e,o.trim());l(!1),m&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:m=>i(m.target.value),onKeyDown:m=>{m.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!p,onClick:()=>{x()},children:s?a.csNoteSaved:a.csNoteOk})]})}function Ar({placeholder:e,onDone:a}){const{t:r}=Q(),[n,o]=c.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function od({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=Q(),[s,h]=c.useState(!1);if(!n.pipe||!o||n.lockActions||Fe(e)!==4)return null;const p=i(e),x=(p==null?void 0:p.stage)||"todo",m=async u=>{if(s||u===x)return;h(!0);const v=p;d(e,{stage:u,stamps:(p==null?void 0:p.stamps)||{}});const E=Math.max(Date.now(),qr+=1);qr=E;const k=await is(r,{company:e.name||"",stage:u,cts:E,deal_id:e.airtableId,check_id:e.checkId});h(!1),!k.stale&&(k.ok||(d(e,v),l(a.actErr)))},b=(y=p==null?void 0:p.stamps)==null?void 0:y.sent,f=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=x==="sent"&&b&&f>=4;return t.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,v])=>t.jsx("button",{type:"button",className:"stgb"+(x===u?" on":""),disabled:s,onClick:()=>{m(u)},children:v},u)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let qr=0;const Jt=8,Nt=360;function Tr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Lr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Tr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Tr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function id({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Q(),[d,l]=c.useState(0),[s,h]=c.useState(null),[p,x]=c.useState([]),m=c.useRef(!1),b=c.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),f=c.useRef(!1);c.useEffect(()=>{const C=b.current;return()=>{f.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),c.useEffect(()=>{m.current||(m.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const w=p[d],y=d>=p.length;c.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const C=w.click,q=window.setTimeout(()=>{const S=document.querySelector(C);S&&S.getAttribute("aria-selected")!=="true"&&S.click()},60);return()=>window.clearTimeout(q)}},[d,w]);const u=c.useRef(-1),v=c.useCallback(()=>{if(!w){h(null);return}const C=T=>{if(!T)return null;for(const D of document.querySelectorAll(T)){const B=D.getBoundingClientRect();if(B.width>1&&B.height>1)return D}return null},q=C(w.sel)||C(w.need);if(!q){h(null);return}u.current!==d&&(u.current=d,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=q.getBoundingClientRect();h(T=>T&&Math.abs(T.top-S.top)<1&&Math.abs(T.left-S.left)<1&&Math.abs(T.width-S.width)<1&&Math.abs(T.height-S.height)<1?T:S)},[w,d]);c.useLayoutEffect(()=>{v();const C=[90,300,700,1300].map(T=>window.setTimeout(v,T)),q=window.setInterval(v,400),S=()=>v();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{C.forEach(T=>window.clearTimeout(T)),window.clearInterval(q),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[v]);const E=c.useRef(a);if(E.current=a,c.useEffect(()=>{const C=q=>{q.key==="Escape"?(q.preventDefault(),q.stopPropagation(),E.current()):q.key==="ArrowRight"?l(S=>S+1):q.key==="ArrowLeft"&&l(S=>Math.max(0,S-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!p.length)return null;let k=null;const j=C=>()=>{f.current=!0,n({type:"modal",modal:null}),C()};if(y){const C=o[3]||0;C>0?k={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let N={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Nt};if(!y&&s){const C=s.bottom+14,q=window.innerHeight-C;let S=q>190?C:Math.max(12,s.top-200),T=Math.min(Math.max(12,s.left+s.width/2-Nt/2),window.innerWidth-Nt-12);q<=190&&s.top<212&&(window.innerWidth-s.right>=Nt+40?T=Math.min(s.right+26,window.innerWidth-Nt-12):s.left>=Nt+40&&(T=Math.max(12,s.left-Nt-26)),S=Math.max(12,s.top-Jt)),N={left:T,top:S,width:Nt}}return Gt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&s&&t.jsx("div",{className:"tour-hole",style:{left:s.left-Jt,top:s.top-Jt,width:s.width+Jt*2,height:s.height+Jt*2}}),(y||!s)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:N,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Lr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(p.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,p.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/p.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(Lr,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(C=>C+1),children:d===p.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Ho(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Vo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function sd(){var q,S;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:s}=Q(),h=r?a:e,p=c.useMemo(()=>h.filter(T=>jt(T.date)===0&&T.kind==="target"),[h]),x=c.useMemo(()=>r?a.filter(T=>T.kind==="target"&&Fe(T)===0).slice().sort((T,D)=>(D.date||"").localeCompare(T.date||"")):[],[a,r]),m=c.useMemo(()=>p.filter(T=>r?Fe(T)===0:!Ge(T)),[p,r]),b=r?x:m,f=r?a.length-x.length:p.length-m.length,w=r?a.length:p.length,y=w?Math.min(100,f/w*100):100,u=c.useMemo(()=>Ho(h),[h]),v=!!u&&jt(u)>0,E=c.useMemo(()=>v?h.filter(T=>(T.date||"").slice(0,10)===u):[],[h,u,v]),k=typeof((q=l.stats)==null?void 0:q.kept_today)=="number"?l.stats.kept_today:null,j=typeof((S=l.stats)==null?void 0:S.screened_today)=="number"?l.stats.screened_today:p.length;let N;v?N=o.morningLast(E.length,x.length,Vo(u,d)):r?N=o.morningThesis(j,x.length,k):p.length?f===0?N=o.goalSourced(p.length):f>=p.length?N=o.goalCleared:N=o.goalDone(f,p.length):N=o.goalSourced(0);const C=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&x.length&&s({type:"chainStart",queue:x.map(T=>T.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ld(){const{t:e,st:a,dispatch:r,fund:n,data:o,mode:i,doSync:d,startTour:l}=Q(),s=i==="client",[h,p]=c.useState(!1),[x,m]=c.useState(""),b=()=>{!s||h||!n||(p(!0),m(""),ss(n).then(y=>{if(p(!1),y.pending){m(e.refreshSlow);return}if(!y.ok){y.error&&console.warn("[republish]",y.error),m(e.refreshKo);return}const u=y.entered??0,v=y.left??0;m(y.unchanged||!u&&!v?e.refreshSame:e.refreshDone(u,v)),o.refresh()}))},f=(n||"P").split(/\s+/).map(y=>y[0]).join("").slice(0,2).toUpperCase(),w=(()=>{const y=Date.parse(o.generatedAt||"");if(Number.isNaN(y))return"";const u=new Date(y),v=E=>String(E).padStart(2,"0");return`${v(u.getDate())}/${v(u.getMonth()+1)} à ${v(u.getHours())}:${v(u.getMinutes())}`})();return t.jsx("div",{className:"ident",children:t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:n?f:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:n||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:n?e.identTitle(n):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),w?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(w)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!s||h,onClick:b,children:h?"⏳":"📰"}),(h||!!x)&&t.jsxs("span",{className:"repubst",children:[h?e.refreshRun:x,!h&&t.jsx("button",{type:"button",onClick:()=>m(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!s,onClick:d,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:l,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:a.filters.search,onChange:y=>r({type:"filters",patch:{search:y.target.value}})})]})]})})}class Rt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*dd(e){for(const a of e)yield*a}function Wo(e){return Array.from(dd(e))}var Te=1e-6,Se=Math.PI,it=Se/2,Fr=Se/4,lt=Se*2,wt=180/Se,tt=Se/180,Oe=Math.abs,pd=Math.atan,la=Math.atan2,Ie=Math.cos,Pe=Math.sin,cd=Math.sign||function(e){return e>0?1:e<0?-1:0},It=Math.sqrt;function ud(e){return e>1?0:e<-1?Se:Math.acos(e)}function da(e){return e>1?it:e<-1?-it:Math.asin(e)}function st(){}function Ia(e,a){e&&Or.hasOwnProperty(e.type)&&Or[e.type](e,a)}var Rr={Feature:function(e,a){Ia(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ia(r[n].geometry,a)}},Or={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){xn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)xn(r[n],a,0)},Polygon:function(e,a){Mr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Mr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ia(r[n],a)}};function xn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Mr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)xn(e[r],a,1);a.polygonEnd()}function Bt(e,a){e&&Rr.hasOwnProperty(e.type)?Rr[e.type](e,a):Ia(e,a)}function bn(e){return[la(e[1],e[0]),da(e[2])]}function Ht(e){var a=e[0],r=e[1],n=Ie(r);return[n*Ie(a),n*Pe(a),Pe(r)]}function va(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Pa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function an(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function wa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function vn(e){var a=It(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function wn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function yn(e,a){return Oe(e)>Se&&(e-=Math.round(e/lt)*lt),[e,a]}yn.invert=yn;function md(e,a,r){return(e%=lt)?a||r?wn(Ir(e),Pr(a,r)):Ir(e):a||r?Pr(a,r):yn}function Dr(e){return function(a,r){return a+=e,Oe(a)>Se&&(a-=Math.round(a/lt)*lt),[a,r]}}function Ir(e){var a=Dr(e);return a.invert=Dr(-e),a}function Pr(e,a){var r=Ie(e),n=Pe(e),o=Ie(a),i=Pe(a);function d(l,s){var h=Ie(s),p=Ie(l)*h,x=Pe(l)*h,m=Pe(s),b=m*r+p*n;return[la(x*o-b*i,p*r-m*n),da(b*o+x*i)]}return d.invert=function(l,s){var h=Ie(s),p=Ie(l)*h,x=Pe(l)*h,m=Pe(s),b=m*o-x*i;return[la(x*o+m*i,p*r+b*n),da(b*r-p*n)]},d}function fd(e,a,r,n,o,i){if(r){var d=Ie(a),l=Pe(a),s=n*r;o==null?(o=a+n*lt,i=a-s/2):(o=_r(d,o),i=_r(d,i),(n>0?o<i:o>i)&&(o+=n*lt));for(var h,p=o;n>0?p>i:p<i;p-=s)h=bn([d,-l*Ie(p),-l*Pe(p)]),e.point(h[0],h[1])}}function _r(e,a){a=Ht(a),a[0]-=e,vn(a);var r=ud(-a[1]);return((-a[2]<0?-r:r)+lt-Te)%lt}function Go(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:st,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function za(e,a){return Oe(e[0]-a[0])<Te&&Oe(e[1]-a[1])<Te}function ya(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Yo(e,a,r,n,o){var i=[],d=[],l,s;if(e.forEach(function(f){if(!((w=f.length-1)<=0)){var w,y=f[0],u=f[w],v;if(za(y,u)){if(!y[2]&&!u[2]){for(o.lineStart(),l=0;l<w;++l)o.point((y=f[l])[0],y[1]);o.lineEnd();return}u[0]+=2*Te}i.push(v=new ya(y,f,null,!0)),d.push(v.o=new ya(y,null,v,!1)),i.push(v=new ya(u,f,null,!1)),d.push(v.o=new ya(u,null,v,!0))}}),!!i.length){for(d.sort(a),Br(i),Br(d),l=0,s=d.length;l<s;++l)d[l].e=r=!r;for(var h=i[0],p,x;;){for(var m=h,b=!0;m.v;)if((m=m.n)===h)return;p=m.z,o.lineStart();do{if(m.v=m.o.v=!0,m.e){if(b)for(l=0,s=p.length;l<s;++l)o.point((x=p[l])[0],x[1]);else n(m.x,m.n.x,1,o);m=m.n}else{if(b)for(p=m.p.z,l=p.length-1;l>=0;--l)o.point((x=p[l])[0],x[1]);else n(m.x,m.p.x,-1,o);m=m.p}m=m.o,p=m.z,b=!b}while(!m.v);o.lineEnd()}}}function Br(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function nn(e){return Oe(e[0])<=Se?e[0]:cd(e[0])*((Oe(e[0])+Se)%lt-Se)}function hd(e,a){var r=nn(a),n=a[1],o=Pe(n),i=[Pe(r),-Ie(r),0],d=0,l=0,s=new Rt;o===1?n=it+Te:o===-1&&(n=-it-Te);for(var h=0,p=e.length;h<p;++h)if(m=(x=e[h]).length)for(var x,m,b=x[m-1],f=nn(b),w=b[1]/2+Fr,y=Pe(w),u=Ie(w),v=0;v<m;++v,f=k,y=N,u=C,b=E){var E=x[v],k=nn(E),j=E[1]/2+Fr,N=Pe(j),C=Ie(j),q=k-f,S=q>=0?1:-1,T=S*q,D=T>Se,B=y*N;if(s.add(la(B*S*Pe(T),u*C+B*Ie(T))),d+=D?q+S*lt:q,D^f>=r^k>=r){var R=Pa(Ht(b),Ht(E));vn(R);var O=Pa(i,R);vn(O);var g=(D^q>=0?-1:1)*da(O[2]);(n>g||n===g&&(R[0]||R[1]))&&(l+=D^q>=0?1:-1)}}return(d<-Te||d<Te&&s<-1e-12)^l&1}function Qo(e,a,r,n){return function(o){var i=a(o),d=Go(),l=a(d),s=!1,h,p,x,m={point:b,lineStart:w,lineEnd:y,polygonStart:function(){m.point=u,m.lineStart=v,m.lineEnd=E,p=[],h=[]},polygonEnd:function(){m.point=b,m.lineStart=w,m.lineEnd=y,p=Wo(p);var k=hd(h,n);p.length?(s||(o.polygonStart(),s=!0),Yo(p,xd,k,r,o)):k&&(s||(o.polygonStart(),s=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),s&&(o.polygonEnd(),s=!1),p=h=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function f(k,j){i.point(k,j)}function w(){m.point=f,i.lineStart()}function y(){m.point=b,i.lineEnd()}function u(k,j){x.push([k,j]),l.point(k,j)}function v(){l.lineStart(),x=[]}function E(){u(x[0][0],x[0][1]),l.lineEnd();var k=l.clean(),j=d.result(),N,C=j.length,q,S,T;if(x.pop(),h.push(x),x=null,!!C){if(k&1){if(S=j[0],(q=S.length-1)>0){for(s||(o.polygonStart(),s=!0),o.lineStart(),N=0;N<q;++N)o.point((T=S[N])[0],T[1]);o.lineEnd()}return}C>1&&k&2&&j.push(j.pop().concat(j.shift())),p.push(j.filter(gd))}}return m}}function gd(e){return e.length>1}function xd(e,a){return((e=e.x)[0]<0?e[1]-it-Te:it-e[1])-((a=a.x)[0]<0?a[1]-it-Te:it-a[1])}const $r=Qo(function(){return!0},bd,wd,[-Se,-it]);function bd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?Se:-Se,s=Oe(i-a);Oe(s-Se)<Te?(e.point(a,r=(r+d)/2>0?it:-it),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&s>=Se&&(Oe(a-n)<Te&&(a-=n*Te),Oe(i-l)<Te&&(i-=l*Te),r=vd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function vd(e,a,r,n){var o,i,d=Pe(e-r);return Oe(d)>Te?pd((Pe(a)*(i=Ie(n))*Pe(r)-Pe(n)*(o=Ie(a))*Pe(e))/(o*i*d)):(a+n)/2}function wd(e,a,r,n){var o;if(e==null)o=r*it,n.point(-Se,o),n.point(0,o),n.point(Se,o),n.point(Se,0),n.point(Se,-o),n.point(0,-o),n.point(-Se,-o),n.point(-Se,0),n.point(-Se,o);else if(Oe(e[0]-a[0])>Te){var i=e[0]<a[0]?Se:-Se;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function yd(e){var a=Ie(e),r=2*tt,n=a>0,o=Oe(a)>Te;function i(p,x,m,b){fd(b,e,r,m,p,x)}function d(p,x){return Ie(p)*Ie(x)>a}function l(p){var x,m,b,f,w;return{lineStart:function(){f=b=!1,w=1},point:function(y,u){var v=[y,u],E,k=d(y,u),j=n?k?0:h(y,u):k?h(y+(y<0?Se:-Se),u):0;if(!x&&(f=b=k)&&p.lineStart(),k!==b&&(E=s(x,v),(!E||za(x,E)||za(v,E))&&(v[2]=1)),k!==b)w=0,k?(p.lineStart(),E=s(v,x),p.point(E[0],E[1])):(E=s(x,v),p.point(E[0],E[1],2),p.lineEnd()),x=E;else if(o&&x&&n^k){var N;!(j&m)&&(N=s(v,x,!0))&&(w=0,n?(p.lineStart(),p.point(N[0][0],N[0][1]),p.point(N[1][0],N[1][1]),p.lineEnd()):(p.point(N[1][0],N[1][1]),p.lineEnd(),p.lineStart(),p.point(N[0][0],N[0][1],3)))}k&&(!x||!za(x,v))&&p.point(v[0],v[1]),x=v,b=k,m=j},lineEnd:function(){b&&p.lineEnd(),x=null},clean:function(){return w|(f&&b)<<1}}}function s(p,x,m){var b=Ht(p),f=Ht(x),w=[1,0,0],y=Pa(b,f),u=va(y,y),v=y[0],E=u-v*v;if(!E)return!m&&p;var k=a*u/E,j=-a*v/E,N=Pa(w,y),C=wa(w,k),q=wa(y,j);an(C,q);var S=N,T=va(C,S),D=va(S,S),B=T*T-D*(va(C,C)-1);if(!(B<0)){var R=It(B),O=wa(S,(-T-R)/D);if(an(O,C),O=bn(O),!m)return O;var g=p[0],L=x[0],M=p[1],J=x[1],te;L<g&&(te=g,g=L,L=te);var z=L-g,$=Oe(z-Se)<Te,I=$||z<Te;if(!$&&J<M&&(te=M,M=J,J=te),I?$?M+J>0^O[1]<(Oe(O[0]-g)<Te?M:J):M<=O[1]&&O[1]<=J:z>Se^(g<=O[0]&&O[0]<=L)){var V=wa(S,(-T+R)/D);return an(V,C),[O,bn(V)]}}}function h(p,x){var m=n?e:Se-e,b=0;return p<-m?b|=1:p>m&&(b|=2),x<-m?b|=4:x>m&&(b|=8),b}return Qo(d,l,i,n?[0,-e]:[-Se,e-Se])}function kd(e,a,r,n,o,i){var d=e[0],l=e[1],s=a[0],h=a[1],p=0,x=1,m=s-d,b=h-l,f;if(f=r-d,!(!m&&f>0)){if(f/=m,m<0){if(f<p)return;f<x&&(x=f)}else if(m>0){if(f>x)return;f>p&&(p=f)}if(f=o-d,!(!m&&f<0)){if(f/=m,m<0){if(f>x)return;f>p&&(p=f)}else if(m>0){if(f<p)return;f<x&&(x=f)}if(f=n-l,!(!b&&f>0)){if(f/=b,b<0){if(f<p)return;f<x&&(x=f)}else if(b>0){if(f>x)return;f>p&&(p=f)}if(f=i-l,!(!b&&f<0)){if(f/=b,b<0){if(f>x)return;f>p&&(p=f)}else if(b>0){if(f<p)return;f<x&&(x=f)}return p>0&&(e[0]=d+p*m,e[1]=l+p*b),x<1&&(a[0]=d+x*m,a[1]=l+x*b),!0}}}}}var Zt=1e9,ka=-Zt;function Ed(e,a,r,n){function o(h,p){return e<=h&&h<=r&&a<=p&&p<=n}function i(h,p,x,m){var b=0,f=0;if(h==null||(b=d(h,x))!==(f=d(p,x))||s(h,p)<0^x>0)do m.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==f);else m.point(p[0],p[1])}function d(h,p){return Oe(h[0]-e)<Te?p>0?0:3:Oe(h[0]-r)<Te?p>0?2:1:Oe(h[1]-a)<Te?p>0?1:0:p>0?3:2}function l(h,p){return s(h.x,p.x)}function s(h,p){var x=d(h,1),m=d(p,1);return x!==m?x-m:x===0?p[1]-h[1]:x===1?h[0]-p[0]:x===2?h[1]-p[1]:p[0]-h[0]}return function(h){var p=h,x=Go(),m,b,f,w,y,u,v,E,k,j,N,C={point:q,lineStart:B,lineEnd:R,polygonStart:T,polygonEnd:D};function q(g,L){o(g,L)&&p.point(g,L)}function S(){for(var g=0,L=0,M=b.length;L<M;++L)for(var J=b[L],te=1,z=J.length,$=J[0],I,V,U=$[0],ue=$[1];te<z;++te)I=U,V=ue,$=J[te],U=$[0],ue=$[1],V<=n?ue>n&&(U-I)*(n-V)>(ue-V)*(e-I)&&++g:ue<=n&&(U-I)*(n-V)<(ue-V)*(e-I)&&--g;return g}function T(){p=x,m=[],b=[],N=!0}function D(){var g=S(),L=N&&g,M=(m=Wo(m)).length;(L||M)&&(h.polygonStart(),L&&(h.lineStart(),i(null,null,1,h),h.lineEnd()),M&&Yo(m,l,g,i,h),h.polygonEnd()),p=h,m=b=f=null}function B(){C.point=O,b&&b.push(f=[]),j=!0,k=!1,v=E=NaN}function R(){m&&(O(w,y),u&&k&&x.rejoin(),m.push(x.result())),C.point=q,k&&p.lineEnd()}function O(g,L){var M=o(g,L);if(b&&f.push([g,L]),j)w=g,y=L,u=M,j=!1,M&&(p.lineStart(),p.point(g,L));else if(M&&k)p.point(g,L);else{var J=[v=Math.max(ka,Math.min(Zt,v)),E=Math.max(ka,Math.min(Zt,E))],te=[g=Math.max(ka,Math.min(Zt,g)),L=Math.max(ka,Math.min(Zt,L))];kd(J,te,e,a,r,n)?(k||(p.lineStart(),p.point(J[0],J[1])),p.point(te[0],te[1]),M||p.lineEnd(),N=!1):M&&(p.lineStart(),p.point(g,L),N=!1)}v=g,E=L,k=M}return C}}const kn=e=>e;var rn=new Rt,En=new Rt,Ko,Jo,jn,Nn,kt={point:st,lineStart:st,lineEnd:st,polygonStart:function(){kt.lineStart=jd,kt.lineEnd=Sd},polygonEnd:function(){kt.lineStart=kt.lineEnd=kt.point=st,rn.add(Oe(En)),En=new Rt},result:function(){var e=rn/2;return rn=new Rt,e}};function jd(){kt.point=Nd}function Nd(e,a){kt.point=Xo,Ko=jn=e,Jo=Nn=a}function Xo(e,a){En.add(Nn*e-jn*a),jn=e,Nn=a}function Sd(){Xo(Ko,Jo)}var Vt=1/0,_a=Vt,pa=-Vt,Ba=pa,$a={point:Cd,lineStart:st,lineEnd:st,polygonStart:st,polygonEnd:st,result:function(){var e=[[Vt,_a],[pa,Ba]];return pa=Ba=-(_a=Vt=1/0),e}};function Cd(e,a){e<Vt&&(Vt=e),e>pa&&(pa=e),a<_a&&(_a=a),a>Ba&&(Ba=a)}var Sn=0,Cn=0,ea=0,Ua=0,Ha=0,$t=0,zn=0,An=0,ta=0,Zo,ei,ft,ht,ot={point:Ot,lineStart:Ur,lineEnd:Hr,polygonStart:function(){ot.lineStart=qd,ot.lineEnd=Td},polygonEnd:function(){ot.point=Ot,ot.lineStart=Ur,ot.lineEnd=Hr},result:function(){var e=ta?[zn/ta,An/ta]:$t?[Ua/$t,Ha/$t]:ea?[Sn/ea,Cn/ea]:[NaN,NaN];return Sn=Cn=ea=Ua=Ha=$t=zn=An=ta=0,e}};function Ot(e,a){Sn+=e,Cn+=a,++ea}function Ur(){ot.point=zd}function zd(e,a){ot.point=Ad,Ot(ft=e,ht=a)}function Ad(e,a){var r=e-ft,n=a-ht,o=It(r*r+n*n);Ua+=o*(ft+e)/2,Ha+=o*(ht+a)/2,$t+=o,Ot(ft=e,ht=a)}function Hr(){ot.point=Ot}function qd(){ot.point=Ld}function Td(){ti(Zo,ei)}function Ld(e,a){ot.point=ti,Ot(Zo=ft=e,ei=ht=a)}function ti(e,a){var r=e-ft,n=a-ht,o=It(r*r+n*n);Ua+=o*(ft+e)/2,Ha+=o*(ht+a)/2,$t+=o,o=ht*e-ft*a,zn+=o*(ft+e),An+=o*(ht+a),ta+=o*3,Ot(ft=e,ht=a)}function ai(e){this._context=e}ai.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,lt);break}}},result:st};var qn=new Rt,on,ni,ri,aa,na,ca={point:st,lineStart:function(){ca.point=Fd},lineEnd:function(){on&&oi(ni,ri),ca.point=st},polygonStart:function(){on=!0},polygonEnd:function(){on=null},result:function(){var e=+qn;return qn=new Rt,e}};function Fd(e,a){ca.point=oi,ni=aa=e,ri=na=a}function oi(e,a){aa-=e,na-=a,qn.add(It(aa*aa+na*na)),aa=e,na=a}let Vr,Va,Wr,Gr;class Yr{constructor(a){this._append=a==null?ii:Rd(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Wr||this._append!==Va){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Wr=n,Va=this._append,Gr=this._,this._=o}this._+=Gr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ii(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Rd(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ii;if(a!==Vr){const r=10**a;Vr=a,Va=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Va}function Od(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Bt(l,o(i))),i.result()}return d.area=function(l){return Bt(l,o(kt)),kt.result()},d.measure=function(l){return Bt(l,o(ca)),ca.result()},d.bounds=function(l){return Bt(l,o($a)),$a.result()},d.centroid=function(l){return Bt(l,o(ot)),ot.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,kn):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new Yr(r)):new ai(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const s=Math.floor(l);if(!(s>=0))throw new RangeError(`invalid digits: ${l}`);r=s}return a===null&&(i=new Yr(r)),d},d.projection(e).digits(r).context(a)}function Bn(e){return function(a){var r=new Tn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Tn(){}Tn.prototype={constructor:Tn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function $n(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Bt(r,e.stream($a)),a($a.result()),n!=null&&e.clipExtent(n),e}function si(e,a,r){return $n(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,s=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,s])},r)}function Md(e,a,r){return si(e,[[0,0],a],r)}function Dd(e,a,r){return $n(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function Id(e,a,r){return $n(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var Qr=16,Pd=Ie(30*tt);function Kr(e,a){return+a?Bd(e,a):_d(e)}function _d(e){return Bn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Bd(e,a){function r(n,o,i,d,l,s,h,p,x,m,b,f,w,y){var u=h-n,v=p-o,E=u*u+v*v;if(E>4*a&&w--){var k=d+m,j=l+b,N=s+f,C=It(k*k+j*j+N*N),q=da(N/=C),S=Oe(Oe(N)-1)<Te||Oe(i-x)<Te?(i+x)/2:la(j,k),T=e(S,q),D=T[0],B=T[1],R=D-n,O=B-o,g=v*R-u*O;(g*g/E>a||Oe((u*R+v*O)/E-.5)>.3||d*m+l*b+s*f<Pd)&&(r(n,o,i,d,l,s,D,B,S,k/=C,j/=C,N,w,y),y.point(D,B),r(D,B,S,k,j,N,h,p,x,m,b,f,w,y))}}return function(n){var o,i,d,l,s,h,p,x,m,b,f,w,y={point:u,lineStart:v,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=j},polygonEnd:function(){n.polygonEnd(),y.lineStart=v}};function u(q,S){q=e(q,S),n.point(q[0],q[1])}function v(){x=NaN,y.point=E,n.lineStart()}function E(q,S){var T=Ht([q,S]),D=e(q,S);r(x,m,p,b,f,w,x=D[0],m=D[1],p=q,b=T[0],f=T[1],w=T[2],Qr,n),n.point(x,m)}function k(){y.point=u,n.lineEnd()}function j(){v(),y.point=N,y.lineEnd=C}function N(q,S){E(o=q,S),i=x,d=m,l=b,s=f,h=w,y.point=E}function C(){r(x,m,p,b,f,w,i,d,o,l,s,h,Qr,n),y.lineEnd=k,k()}return y}}var $d=Bn({point:function(e,a){this.stream.point(e*tt,a*tt)}});function Ud(e){return Bn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Hd(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function Jr(e,a,r,n,o,i){if(!i)return Hd(e,a,r,n,o);var d=Ie(i),l=Pe(i),s=d*e,h=l*e,p=d/e,x=l/e,m=(l*r-d*a)/e,b=(l*a+d*r)/e;function f(w,y){return w*=n,y*=o,[s*w-h*y+a,r-h*w-s*y]}return f.invert=function(w,y){return[n*(p*w-x*y+m),o*(b-x*w-p*y)]},f}function Vd(e){return Wd(function(){return e})()}function Wd(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,s=0,h=0,p,x=0,m=1,b=1,f=null,w=$r,y=null,u,v,E,k=kn,j=.5,N,C,q,S,T;function D(g){return q(g[0]*tt,g[1]*tt)}function B(g){return g=q.invert(g[0],g[1]),g&&[g[0]*wt,g[1]*wt]}D.stream=function(g){return S&&T===g?S:S=$d(Ud(p)(w(N(k(T=g)))))},D.preclip=function(g){return arguments.length?(w=g,f=void 0,O()):w},D.postclip=function(g){return arguments.length?(k=g,y=u=v=E=null,O()):k},D.clipAngle=function(g){return arguments.length?(w=+g?yd(f=g*tt):(f=null,$r),O()):f*wt},D.clipExtent=function(g){return arguments.length?(k=g==null?(y=u=v=E=null,kn):Ed(y=+g[0][0],u=+g[0][1],v=+g[1][0],E=+g[1][1]),O()):y==null?null:[[y,u],[v,E]]},D.scale=function(g){return arguments.length?(r=+g,R()):r},D.translate=function(g){return arguments.length?(n=+g[0],o=+g[1],R()):[n,o]},D.center=function(g){return arguments.length?(i=g[0]%360*tt,d=g[1]%360*tt,R()):[i*wt,d*wt]},D.rotate=function(g){return arguments.length?(l=g[0]%360*tt,s=g[1]%360*tt,h=g.length>2?g[2]%360*tt:0,R()):[l*wt,s*wt,h*wt]},D.angle=function(g){return arguments.length?(x=g%360*tt,R()):x*wt},D.reflectX=function(g){return arguments.length?(m=g?-1:1,R()):m<0},D.reflectY=function(g){return arguments.length?(b=g?-1:1,R()):b<0},D.precision=function(g){return arguments.length?(N=Kr(C,j=g*g),O()):It(j)},D.fitExtent=function(g,L){return si(D,g,L)},D.fitSize=function(g,L){return Md(D,g,L)},D.fitWidth=function(g,L){return Dd(D,g,L)},D.fitHeight=function(g,L){return Id(D,g,L)};function R(){var g=Jr(r,0,0,m,b,x).apply(null,a(i,d)),L=Jr(r,n-g[0],o-g[1],m,b,x);return p=md(l,s,h),C=wn(a,L),q=wn(p,C),N=Kr(C,j),O()}function O(){return S=T=null,D}return function(){return a=e.apply(this,arguments),D.invert=a.invert&&B,R()}}function li(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}li.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Oe(o)>Te&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Gd(){return Vd(li).scale(175.295)}function Yd(e){return e}function Qd(e){if(e==null)return Yd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,s){s||(a=r=0);var h=2,p=l.length,x=new Array(p);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+d;h<p;)x[h]=l[h],++h;return x}}function Kd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Jd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Xr(e,r)})}:Xr(e,a)}function Xr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Xd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Xd(e,a){var r=Qd(e.transform),n=e.arcs;function o(p,x){x.length&&x.pop();for(var m=n[p<0?~p:p],b=0,f=m.length;b<f;++b)x.push(r(m[b],b));p<0&&Kd(x,f)}function i(p){return r(p)}function d(p){for(var x=[],m=0,b=p.length;m<b;++m)o(p[m],x);return x.length<2&&x.push(x[0]),x}function l(p){for(var x=d(p);x.length<4;)x.push(x[0]);return x}function s(p){return p.map(l)}function h(p){var x=p.type,m;switch(x){case"GeometryCollection":return{type:x,geometries:p.geometries.map(h)};case"Point":m=i(p.coordinates);break;case"MultiPoint":m=p.coordinates.map(i);break;case"LineString":m=d(p.arcs);break;case"MultiLineString":m=p.arcs.map(d);break;case"Polygon":m=s(p.arcs);break;case"MultiPolygon":m=p.arcs.map(s);break;default:return null}return{type:x,coordinates:m}}return h(a)}const di={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Zd=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ep(e,a,r){const n=di[e];if(!n||!n.length)return-1;const o=Zd(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let Ea=null;function tp(){return Ea||(Ea=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Jd(r,n),i=Gd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Od(i),l=(o.features||[]).filter(p=>{var x;return(((x=p.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(p=>{var b;const x=((b=p.properties)==null?void 0:b.name)||"",m=d(p)||"";return m?{i2:ls(x)||null,n:x,d:m}:null}).filter(p=>!!p);if(!l.length)return null;const s={};for(const[p,x]of Object.entries(ds)){const m=i(x);m&&(s[p]={x:m[0],y:m[1]})}const h={};for(const[p,x]of Object.entries(di)){const m=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,f])=>({x:b,y:f}));m.length&&(h[p]=m)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:s,metros:h}}catch{return null}})(),Ea)}function ap(e){const[a,r]=c.useState(null);return c.useEffect(()=>{if(!e||a)return;let n=!1;return tp().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const np="8 40 984 210",rp={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Zr=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function eo(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function op(e,a){const[r,n]=c.useState(1);return c.useEffect(()=>{let o=!0,i=0;const d=()=>{var h;if(!o)return;const s=(h=e.current)==null?void 0:h.getScreenCTM();s&&s.a>0?n(s.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function to({msgs:e}){const[a,r]=c.useState(0);c.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function ip(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:s,data:h,dossiers:p,source:x}=Q(),m=h.loading&&!p.length,b=c.useRef(null),f=c.useRef(null),w=ap(e.continent==="monde"),y=e.continent==="monde"?w:On.find(g=>g.key===e.continent)||null,u=op(b,e.continent+":"+e.mapFolded+":"+!!y),[v,E]=c.useState(new Map),[k,j]=c.useState(null);c.useEffect(()=>{const g=b.current;if(!g)return;const L=new Map;g.querySelectorAll("path[data-i2]").forEach(M=>{const J=M.dataset.i2;if(J)try{const te=M.getBBox();te.width>0&&L.set(J,{x:te.x,y:te.y,w:te.width,h:te.height})}catch{}}),E(L)},[e.continent,u,y]);const N=c.useMemo(()=>r.filter(g=>g.cc),[r]),C=c.useMemo(()=>{const g=new Map;return N.forEach(L=>g.set(L.cc,(g.get(L.cc)||0)+1)),g},[N]),q=e.continent==="monde"&&w?w.anchors:null,S=e.continent==="monde"&&w?w.metros:null,T=c.useMemo(()=>N.map(g=>{const L=eo(g.name||g.id||""),M=eo((g.id||g.name||"")+"·y");if(q&&g.cc){const I=S?S[g.cc]:void 0;if(I&&I.length){const U=ep(g.cc,g.city,L);if(U>=0&&I[U])return{d:g,x:I[U].x+(L-.5)*5,y:I[U].y+(M-.5)*5}}const V=q[g.cc];if(V)return{d:g,x:V.x+(L-.5)*10,y:V.y+(M-.5)*10}}const J=g.cc?v.get(g.cc):void 0;if(!J)return null;const te=rp[`${e.continent}:${g.cc||""}`];if(te)return{d:g,x:J.x+J.w*(te.fx+(L-.5)*te.sx),y:J.y+J.h*(te.fy+(M-.5)*te.sy)};const z=(L-.5)*Math.min(J.w*.55,60),$=(M-.5)*Math.min(J.h*.55,60);return{d:g,x:J.x+J.w/2+z,y:J.y+J.h/2+$}}).filter(g=>!!g),[N,v,q,S,e.continent]),D=g=>u>0?g/u:g,B=c.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:Zr[g],fr:s.plabels[g],en:s.plabels[g],n:r.filter(L=>L.kind==="target"&&Fe(L)===g).length})).filter(g=>g.n>0):nr.map((g,L)=>({...g,n:r.filter(M=>rr(M)===L).length})),[r,n,s.plabels]),R=i?d.get(i):null,O=R?T.find(g=>g.d.id===R.id):null;return y?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),"data-cont":e.continent,ref:f,children:[m&&t.jsx(to,{msgs:s.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?np:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?y.fr:y.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:y.countries.map((g,L)=>t.jsx("g",{className:"ct"+(g.i2&&C.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},L))}),t.jsx("g",{children:T.map(g=>{const L=nr[rr(g.d)],M=!!$e(g.d),J=g.d.kind==="target",te=n&&J?Zr[Fe(g.d)]:L.c,z=!n&&Ge(g.d);return t.jsxs("g",{className:"co"+(z?" done":""),onMouseEnter:()=>{var V,U;const $=(V=f.current)==null?void 0:V.getBoundingClientRect(),I=(U=b.current)==null?void 0:U.createSVGPoint();if(I&&b.current&&$){I.x=g.x,I.y=g.y;const ue=I.matrixTransform(b.current.getScreenCTM());j({x:ue.x-$.left,y:ue.y-$.top,label:g.d.name+" · "+(Yt(g.d.cc,l)||g.d.countryLabel||"")})}o(g.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var V;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const $=(V=b.current)==null?void 0:V.createSVGPoint();let I=null;if($&&b.current){$.x=g.x,$.y=g.y;const U=$.matrixTransform(b.current.getScreenCTM());I={x:U.x,y:U.y}}a({type:"popup",id:g.d.id,anchor:I})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:D(Math.max(11,L.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:D(L.px),fill:te,stroke:M?"#E5484D":"#ffffff",strokeWidth:D(M?2.2:1.3)})]},g.d.id||g.d.name)})}),O&&t.jsx("circle",{className:"ring on",cx:O.x,cy:O.y,r:D(13),fill:"none",stroke:"#16233A",strokeWidth:D(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:B.map((g,L)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),l==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},L))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",s.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),"data-cont":e.continent,ref:f,children:t.jsx(to,{msgs:s.loadMsgs})})}function sp(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function pi({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=Q(),s=a.filters,[h,p]=c.useState(!1),[x,m]=c.useState(!1),b=c.useRef(null),f=c.useRef(null),w=c.useMemo(()=>a.continent==="monde"?n:n.filter(O=>O.continent===a.continent),[n,a.continent]),y=O=>w.filter(g=>O!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:Da(g,s,i,O==="country"?void 0:O)),u=O=>!i||O.kind!=="op",v=c.useMemo(()=>{const O=y("win").filter(u),g=L=>O.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=L).length;return[g(0),g(7),g(30),O.length]},[w,s,i]),E=c.useMemo(()=>s.day?y("win").filter(u).filter(O=>(O.date||"").slice(0,10)===s.day).length:0,[w,s,i]),k=(s.signalOnly?1:0)+s.sector.length+s.market.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+s.crible.length,j=k+(s.acquirer.trim()?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0);c.useEffect(()=>{a.openFacet&&p(!1)},[a.openFacet]),c.useEffect(()=>{if(!h&&!x)return;const O=L=>{var J,te;const M=L.target;h&&!((J=b.current)!=null&&J.contains(M))&&p(!1),x&&!((te=f.current)!=null&&te.contains(M))&&m(!1)},g=L=>{L.key==="Escape"&&(p(!1),m(!1))};return document.addEventListener("mousedown",O),document.addEventListener("keydown",g),()=>{document.removeEventListener("mousedown",O),document.removeEventListener("keydown",g)}},[h,x]);const N=(O,g,L,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===O,onClick:()=>r({type:"openFacet",facet:O}),children:[t.jsx("span",{className:"fl",children:g}),L>0&&t.jsx("span",{className:"n",children:L}),t.jsx("span",{className:"cv",children:"▾"})]},O),C=["1","7","30","all"],q=Math.max(0,C.indexOf(s.win||"all")),S=s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(sp(s.day,l))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:f,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>m(O=>!O),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[q]}),t.jsx("b",{children:v[q]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((O,g)=>t.jsxs("button",{type:"button",role:"option","aria-selected":s.win===O,onClick:()=>{r({type:"filters",patch:{win:O}}),m(!1)},children:[o.datesShort[g],t.jsx("span",{className:"n",children:v[g]})]},O))})]}):t.jsx("div",{className:"seg",children:C.map((O,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===O,onClick:()=>r({type:"filters",patch:{win:O}}),children:[t.jsx("span",{className:"sl",children:o.dates[g]}),t.jsx("b",{children:v[g]})]},O))}),T=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:s.search,onChange:O=>r({type:"filters",patch:{search:O.target.value}})})]}),D=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",o.fSector,s.sector.length),(n.some(O=>!!O.market)||s.market.length>0)&&N("mar",o.fMarket,s.market.length),N("pay",o.fCountry,s.country.length),N("det",o.fEngine,s.engine.length),N("sta",o.fStage,s.stage.length),i&&N("crib",o.fVerdict,s.crible.length),i&&N("ang","Angle",s.angle.length),i&&N("mem","Mémo",s.memoLevel.length)]}),B=(O=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),O&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),R=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{p(O=>!O),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:D})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(s.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:S}),t.jsxs("div",{className:"fstrip-b",children:[T,R,B(!1)]})]}),a.openFacet&&t.jsx(ao,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[S,T,D,t.jsx("span",{className:"fgrow"}),B()]}),a.openFacet&&t.jsx(ao,{poolFor:y})]})}function ao({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=Q(),l=a.filters,s=a.openFacet,{title:h,cols:p,options:x}=c.useMemo(()=>{if(s==="sig"){const y=e("signal").filter(E=>$e(E)),u=new Map;y.forEach(E=>{const k=E.engine||"";u.set(k,(u.get(k)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:y.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...fn([...u.keys()],o).map(E=>({v:E,label:Ft(E)+" "+at(E,o),n:u.get(E)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(E)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(s==="crib"){const y=e("crible").filter(v=>!i||bo(v,a.ptab,d.favIds)),u=new Map;return y.forEach(v=>{const E=vo(v);E&&E!=="NEW"&&u.set(E,(u.get(E)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...u.entries()].sort((v,E)=>(or[v[0]]??9)-(or[E[0]]??9)||E[1]-v[1]).map(([v,E])=>({v,label:'<span class="fdot" style="background:'+(ps[v]||"#94A3B8")+'"></span>'+v,n:E,html:!0,on:l.crible.includes(v)}))}}if(s==="sec"){const y=e("sector"),u=new Map;return y.forEach(v=>{v.sector&&u.set(v.sector,(u.get(v.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...u.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:v,n:E,html:!1,on:l.sector.includes(v)}))}}if(s==="mar"){const y=e("market"),u=new Map;return y.forEach(v=>{v.market&&u.set(v.market,(u.get(v.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...u.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:v,n:E,html:!1,on:l.market.includes(v)}))}}if(s==="pay"){const y=e("country"),u=new Map;return y.forEach(v=>{v.cc&&u.set(v.cc,(u.get(v.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...u.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:Yt(v,o)||v,n:E,html:!1,on:l.country.includes(v)}))}}if(s==="det"){const y=e("engine"),u=new Map;return y.forEach(v=>{v.engine&&u.set(v.engine,(u.get(v.engine)||0)+1)}),{title:n.fEngine,cols:2,options:fn([...u.keys()],o).map(v=>({v,label:Ft(v)+" "+at(v,o)+' <span style="color:var(--dim);font-size:10px">· '+cs(us(v),o)+"</span>",n:u.get(v)||0,html:!0,on:l.engine.includes(v)}))}}if(s==="ang"){const y=e("angle"),u=new Map;return y.forEach(v=>{v.angle&&u.set(v.angle,(u.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...u.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:v.replace(/[_-]+/g," "),n:E,html:!1,on:l.angle.includes(v)}))}}if(s==="mem"){const y=e("memoLevel"),u=new Map;y.forEach(E=>{if(E.kind==="target"){const k=Rn(E);u.set(k,(u.get(k)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(E=>({v:String(E),label:v[E],n:u.get(E)||0,html:!1,on:l.memoLevel.includes(E)}))}}const f=e("stage"),w=new Map;return f.forEach(y=>{y.stage&&w.set(y.stage,(w.get(y.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((y,u)=>u[1]-y[1]).map(([y,u])=>({v:y,label:y,n:u,html:!1,on:l.stage.includes(y)}))}},[s,a,o]),m=f=>{if(s==="sig"){if(f==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const y=l.signalEngines.includes(f)?l.signalEngines.filter(u=>u!==f):[...l.signalEngines,f];r({type:"filters",patch:{signalOnly:!0,signalEngines:y}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(f)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage",value:f})},b=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:h}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(f=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":f.on,onClick:()=>m(f.v),children:[t.jsx("span",{className:"bx"}),f.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:f.label}}):t.jsx("span",{className:"l",children:f.label}),t.jsx("span",{className:"n",children:f.n})]},f.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function ci({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=Q(),s=c.useMemo(()=>{const b={};return r.forEach(f=>{Da(f,n.filters,i)&&(b.monde=(b.monde||0)+1,f.continent&&(b[f.continent]=(b[f.continent]||0)+1))}),b},[r,n.filters,i]),[h,p]=c.useState(!1),x=c.useRef(null);c.useEffect(()=>{if(!h)return;const b=w=>{var y;(y=x.current)!=null&&y.contains(w.target)||p(!1)},f=w=>{w.key==="Escape"&&p(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",f),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",f)}},[h]);const m=b=>{const f=On.find(w=>w.key===b);return b==="monde"?l.contWorld:d==="fr"?f.fr:f.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>p(b=>!b),children:[m(n.continent),t.jsx("span",{className:"n",children:s[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:ir.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),p(!1)},children:[m(b),t.jsx("span",{className:"n",children:s[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[ir.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[m(b),t.jsx("span",{className:"n",children:s[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]})]})}function Ln(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function ui(e){return"atl2:evalq:"+(e||"anon")}function lp(e,a){const r=ui(e),n=Ln(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function dp(){const{t:e,lang:a,data:r,dossiers:n}=Q(),o=r.session.token||"",i=ui(o),[d,l]=c.useState(()=>Ln(i)),s=c.useRef(!1),[h,p]=c.useState(!1);c.useEffect(()=>{try{const z=d.slice(0,30).map(({descBusy:$,evalBusy:I,...V})=>V);localStorage.setItem(i,JSON.stringify(z)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[d,i]),c.useEffect(()=>{const z=()=>{if(s.current)return;const $=Ln(i);l(I=>JSON.stringify(I.map(({descBusy:V,evalBusy:U,...ue})=>ue))===JSON.stringify($)?I:$)};return window.addEventListener("atl2:evalq",z),window.addEventListener("storage",z),()=>{window.removeEventListener("atl2:evalq",z),window.removeEventListener("storage",z)}},[i]);const[x,m]=c.useState([]),[b,f]=c.useState(""),[w,y]=c.useState(!1),[u,v]=c.useState(!1),[E,k]=c.useState(""),j=c.useCallback((z,$)=>l(I=>I.map((V,U)=>U===z?{...V,...$}:V)),[]),N=c.useCallback((z,$)=>{const I=$.trim();I&&(j(z,{name:I,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Mn(I).then(V=>{const U=V.candidates||[];V.website?j(z,{site:V.website,status:"ready"}):U.length===1?j(z,{site:U[0].url,status:"ready"}):U.length>1?j(z,{status:"pick",candidates:U.slice(0,6)}):j(z,{status:"ready"})}).catch(()=>j(z,{status:"ready"})))},[j]),C=c.useCallback((z,$,I)=>{j(z,{descBusy:!0}),yo(o,$,I).then(V=>{if(V.quota){p(!0),j(z,{descBusy:!1,descDone:!0});return}const U=V.blocs||{},ue=(U.synthese||U.value_prop||U.produit||U.modele||"").trim();j(z,{descBusy:!1,descDone:!0,desc:ue})}).catch(()=>j(z,{descBusy:!1,descDone:!0}))},[j,o]);c.useEffect(()=>{const z=d.findIndex(I=>I.auto&&I.name.trim()&&I.status==="");if(z>=0){N(z,d[z].name);return}if(h)return;const $=d.findIndex(I=>I.status==="ready"&&I.site&&!I.descDone&&!I.descBusy);$>=0&&C($,d[$].name,d[$].site)},[d,N,C,h]);const[q,S]=c.useState(!1),T=c.useCallback(async(z,$)=>{j(z,{evalBusy:!0});const I=($.site||$.name).trim(),V=await ko(o,I,"atelier2");return V.verdict==="quota"?(j(z,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:V.reason||"",remaining:0}})),!1):(j(z,{evalBusy:!1,status:V.verdict==="kept"?"kept":"out",reason:V.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:V.company||$.name,verdict:V.verdict,reason:V.reason||"",remaining:V.remaining??null}})),!0)},[j,o]),D=async()=>{if(q)return;const z=d.map(($,I)=>({r:$,i:I})).filter(({r:$})=>$.name.trim()&&$.status!=="kept"&&$.status!=="out"&&$.status!=="resolving");if(z.length){S(!0);for(const{r:$,i:I}of z)if(!await T(I,$))break;S(!1)}},B=c.useMemo(()=>{const z=new Set,$=[];return d.filter(I=>I.status==="kept").forEach(I=>{const V=I.name.trim().toLowerCase();V&&!z.has(V)&&(z.add(V),$.push(I.name.trim()))}),n.filter(I=>Fe(I)>=1&&Fe(I)<=4&&(I.website||I.domain)).forEach(I=>{const V=(I.name||"").trim().toLowerCase();V&&!z.has(V)&&(z.add(V),$.push((I.name||"").trim()))}),$},[d,n]),R=c.useMemo(()=>{const z=new Set;return n.forEach($=>{const I=($.name||"").trim().toLowerCase();I&&z.add(I)}),d.forEach($=>{const I=$.name.trim().toLowerCase();I&&z.add(I)}),z},[n,d]),O=async()=>{if(b||!B.length)return;v(!1);const z=[];for(const $ of B.slice(0,2)){f($);const I=await Eo(o,$);if(I){if(I.verdict==="quota"){y(!0);break}(I.results||[]).forEach(V=>{const U=(V.company||"").trim().toLowerCase();!U||R.has(U)||z.some(ue=>ue.name.toLowerCase()===U)||z.push({name:(V.company||"").trim(),verdict:V.verdict||"",reason:V.reason,from:$})})}}f(""),v(!0),m($=>[...z,...$].slice(0,24))},g=async(z,$)=>{if(b)return;v(!1),f(z==="thesis"?e.pxThesis:$);const I=await ms(o,z,$,6);if(f(""),v(!0),!I)return;if(I.verdict==="quota"){y(!0);return}const V=[];(I.results||[]).forEach(U=>{const ue=(U.company||"").trim().toLowerCase();!ue||R.has(ue)||V.some(ae=>ae.name.toLowerCase()===ue)||V.push({name:(U.company||"").trim(),verdict:U.verdict||"",reason:U.reason,from:z==="thesis"?e.pxThesis:$})}),m(U=>[...V,...U].slice(0,24))},L=()=>{const z=E.trim();z.length<3||g(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(z)?"registry":"keyword",z)},M=z=>{l($=>[...$,{name:z.name,site:"",status:"",auto:!0}].slice(0,30)),m($=>$.filter(I=>I.name!==z.name))},J=d.filter(z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out").length,te=z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving"&&!z.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),d.map((z,$)=>t.jsx("div",{className:"eq-item"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:t.jsxs("div",{className:"eq-row"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsx("input",{value:z.name,placeholder:e.eqNamePh,onChange:I=>{const V=I.target.value.split(`
`).map(U=>U.trim()).filter(Boolean);V.length>1?l(U=>{const ue=[...U];return ue.splice($,1,...V.map(ae=>({name:ae,site:"",status:"",auto:!0}))),ue.slice(0,30)}):j($,{name:I.target.value})},onBlur:()=>{z.name.trim()&&!z.site&&z.status!=="resolving"&&z.status!=="pick"&&N($,z.name)},onKeyDown:I=>{I.key==="Enter"&&N($,z.name)}}),t.jsxs("span",{className:"eq-site",children:[z.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),z.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:I=>{const V=I.target.value;V&&j($,{site:V,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(z.candidates||[]).map(I=>t.jsx("option",{value:I.url,children:(I.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},I.url))]}),z.status!=="resolving"&&z.status!=="pick"&&(z.site?t.jsxs("a",{href:z.site.startsWith("http")?z.site:"https://"+z.site,target:"_blank",rel:"nofollow noopener",children:[z.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:z.name.trim()&&z.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:z.desc||"",children:z.descBusy?t.jsx("i",{children:e.eqDescBusy}):z.desc?z.desc:t.jsx("em",{children:z.descDone?h?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(z.status||"vide"),title:z.reason||"",children:z.status==="kept"?"✓ "+e.kept:z.status==="out"?"✗ "+e.dropped:z.status==="ready"?e.eqReady:z.status==="pick"?e.eqPick:""}),(z.name.trim()||z.site)&&z.status!=="kept"&&z.status!=="out"?t.jsxs(Wa,{lang:a,storeKey:(z.site||z.name).trim(),className:"eq-go",title:e.eqRunOne,disabled:!te(z)||q,confirmLabel:"⚡ "+e.eqRunOneShort,onConfirm:()=>{T($,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}):t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!te(z)||q,onClick:()=>{T($,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>l(I=>I.filter((V,U)=>U!==$)),children:"×"})]})},$)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>l(z=>[...z,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!b,onClick:()=>{g("thesis","")},children:b===e.pxThesis?e.sgBusy(b):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:E,placeholder:e.pxPlace,onChange:z=>k(z.target.value),onKeyDown:z=>{z.key==="Enter"&&L()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b||E.trim().length<3,onClick:L,children:e.pxGoFree}),!!B.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b,onClick:()=>{O()},children:b&&b!==e.pxThesis&&b!==E?e.sgBusy(b):e.sgGo}),!!B.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(B[0],B.length)}),w&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),u&&!x.length&&!w&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),x.map(z=>t.jsxs("span",{className:"eq-sc"+(z.verdict==="kept"?" ok":""),title:(z.reason||"")+" — "+e.sgVia(z.from),children:[t.jsx("b",{children:z.name}),z.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>M(z),children:"+"})]},z.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),d.some(z=>z.status==="kept"||z.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>l(z=>z.filter($=>$.status!=="kept"&&$.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(q?" loading":""),style:{justifyContent:"center"},disabled:q||!J,onClick:()=>{D()},children:[t.jsx("span",{className:"fill"}),q?e.eqRunning:e.eqGo(J)]})]})]})]})}const pp={deals:"ma-deals",news:"veille"};function no(e){return(e.url||e.title||"").trim()}function cp(e){const a=(e.title||"").replace(/\s+/g," ").trim();if(!a)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const r=/^(.{2,72}?)[:–—|]/.exec(a);return r?r[1].trim():(a.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||a).slice(0,72).trim()}function up({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,canWrite:i}=Q(),[d,l]=c.useState(null),[s,h]=c.useState({deals:[],news:[]}),[p,x]=c.useState({deals:!1,news:!1}),[m,b]=c.useState(null),[f,w]=c.useState(""),y=c.useRef(!1),u=c.useCallback(async S=>{if(!o)return[];if(p[S])return s[S];b(S),w("");const T=await fs(pp[S],o,n);return b(null),!T.ok&&T.error?(w(T.error),[]):(h(D=>({...D,[S]:T.items})),x(D=>({...D,[S]:!0})),T.items)},[o,n,p,s]);c.useEffect(()=>{d&&u(d)},[d,u]);const v=c.useCallback(S=>s[S].map(no).filter(Boolean),[s]),E=c.useMemo(()=>{var D,B;if(!o)return{deals:[],news:[]};const S={deals:v("deals"),news:v("news")},T=Oo("feed:"+o,S);return{deals:((D=T.deals)==null?void 0:D.noms)||[],news:((B=T.news)==null?void 0:B.noms)||[]}},[o,v]),k=c.useRef(null);c.useEffect(()=>{k.current&&!d&&o&&Mo("feed:"+o,{deals:v("deals"),news:v("news")}),k.current=d},[d,o,v]);const j=S=>{const T=S.map(cp).filter(Boolean);T.length&&(a(T),l(null))},N=(S,T)=>{const D=(S.url||"").trim();if(T==="news"&&D&&/^https?:\/\//i.test(D)){window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:D}})),l(null);return}j([S])},C=async S=>{if(d===S){l(null);return}if(y.current)return;y.current=!0;const T=await u(S);if(y.current=!1,S==="deals"&&T.length){j(T);return}l(S)},q=S=>{const T=s[S],D=new Set(E[S].map(B=>B.toLowerCase()));return t.jsxs("div",{className:"dfpane"+(d===S?" on":""),hidden:d!==S,children:[t.jsx("p",{className:"dfh",children:S==="deals"?r.feedDealsH:r.feedNewsH}),m===S&&t.jsx("p",{className:"dfload",children:n==="en"?"Loading…":"Chargement…"}),d===S&&!!f&&t.jsx("p",{className:"dferr",children:f}),p[S]&&!T.length&&!m&&t.jsx("p",{className:"dfempty",children:S==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!T.length&&t.jsx("ul",{className:"dflist",children:T.map((B,R)=>{const O=no(B),g=D.has(O.toLowerCase()),L=(B.url||"").trim();return t.jsxs("li",{className:g?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:B.title||L}),t.jsx("span",{children:[B.source,B.sector_fr,(B.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[L&&t.jsx("a",{href:L,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),i&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>N(B,S),children:S==="deals"?r.feedToEval:r.feedToExtract})]})]},O||R)})})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(S=>{const T=E[S].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(S==="deals"?"ddeals":"dnews")+(d===S?" on":""),onClick:()=>{C(S)},children:[S==="deals"?r.feedDeals:r.feedNews,T>0&&t.jsx("em",{title:r.feedHint,children:r.feedNew(T)})]},S)}),d&&q(d)]})}function mi(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function mp(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function ro({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=Q();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(s=>s.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(s=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:s.name}),s.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),s.line1&&t.jsx("p",{className:"w",children:s.line1}),s.line2&&t.jsx("p",{className:"r",children:s.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(s.name),children:l.rsEvalOne})]},s.name))})]}):null}function fi({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=Q(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(ro,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(ro,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function fp({card:e,onEvaluate:a,onAddAll:r}){var l,s,h;const{t:n}=Q(),o=[e.industry,...e.market_tags||[],e.author].map(p=>(p||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(p=>p&&p.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(p=>t.jsx("span",{children:p},p))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:mi(e.summary_md||"").map((p,x)=>t.jsx("p",{children:p},x))})]}),t.jsx(fi,{card:e,onEvaluate:a,onAddAll:r}),(((s=e.prospective)==null?void 0:s.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(p=>t.jsx("li",{children:p},p))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(p=>t.jsx("a",{href:p.url,target:"_blank",rel:"noopener noreferrer",children:p.label||p.url},p.url))})]})]})}function hp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function gp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=Q(),l=o,[s,h]=c.useState(null),[p,x]=c.useState(null),[m,b]=c.useState(null),[f,w]=c.useState(!1);c.useEffect(()=>{let u=!0;return(async()=>{const v=await jo({email:d,cbToken:l});u&&h(v)})(),()=>{u=!1}},[d,l,n]);const y=u=>{x(u),b(null),w(!0),(async()=>{const v=await hs(u.id);b(v),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[p?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),p&&t.jsx("span",{className:"ti",children:p.title}),!p&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!p&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(s||[]).map(u=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(u),children:[t.jsx("span",{className:"ti",children:u.title}),t.jsxs("span",{className:"me",children:[hp(u.created_at),u.industry?` · ${u.industry}`:"",u.author?` · ${u.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(u.cited_n||0,u.evaluate_n||0)}),t.jsx("span",{className:"st"+(u.published?" on":""),children:u.published?i.rsPub:i.rsPriv})]},u.id))]}),p&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[p.source_url&&t.jsx("a",{href:p.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),p.published&&p.page_url&&t.jsx("a",{href:p.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(p.published?" on":""),children:p.published?i.rsPub:i.rsPriv})]}),f&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!f&&!m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!f&&m&&t.jsx(fp,{card:m,onEvaluate:a,onAddAll:r})]})]})}const Aa=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ra(e){return/^https?:\/\//i.test((e||"").trim())}function ct(e){const a=(e||"").trim();return a?ra(a)?a:Aa.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function xp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function bp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:l,evalBusy:s,evalCards:h,caps:p,data:x,canWrite:m,source:b,dossiers:f,doAnalyse:w,liveMemos:y,pipe:u}=Q(),v=r==="client",E=c.useMemo(()=>n||(b!=="default"?gs():""),[n,b]),[k,j]=c.useState(""),[N,C]=c.useState(!1),[q,S]=c.useState(""),[T,D]=c.useState(""),[B,R]=c.useState(""),[O,g]=c.useState(!1),[L,M]=c.useState(!1),[J,te]=c.useState([]);c.useEffect(()=>{const P=Z=>{const K=Z.detail;K&&te(ce=>[K,...ce].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[z,$]=c.useState(!1),[I,V]=c.useState(!1),[U,ue]=c.useState(!1),ae=c.useRef(!1),[de,xe]=c.useState(""),[me,we]=c.useState(""),[be,Ne]=c.useState(!1),[Re,ne]=c.useState(!1),[ke,ve]=c.useState(0),[oe,_]=c.useState(""),[W,ee]=c.useState(null),[le,pe]=c.useState(null),[re,ie]=c.useState(!1),[fe,ye]=c.useState(null),[Ce,je]=c.useState(0),Ee=c.useRef(!1),gt=k.trim()?Aa.test(k.trim())?e.evalUrl:e.evalName:e.evalWaiting;c.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),Z=(P.get("rs")||"").trim(),K=(P.get("rstext")||"").trim();Z&&/^https?:\/\//i.test(Z)&&xe(Z),K&&we(K),(Z&&/^https?:\/\//i.test(Z)||K)&&$(!0)},[]),c.useEffect(()=>{const P=Z=>{const K=Z.detail||{},ce=String(K.url||"").trim(),ze=String(K.text||"").trim();ce&&/^https?:\/\//i.test(ce)&&xe(ce),ze&&we(ze),(ce&&/^https?:\/\//i.test(ce)||ze)&&($(!0),j(""),S(""),Ne(!0),window.setTimeout(()=>Ne(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),c.useEffect(()=>{const P=Z=>{const K=Z.detail||{},ce=String(K.name||"").trim();if(!ce)return;$(!1),j(ce),S(ce);const ze=ct(String(K.website||K.domain||""));D(ze),R(ct(String(K.url||""))),g(!ze),C(!0),window.setTimeout(()=>C(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),c.useEffect(()=>{const P=(q||"").trim();if(!P||z||T){(T||!P||z)&&g(!1);return}const Z=Ue(P),K=f.find(Le=>Ue(Le.name)===Z)||f.find(Le=>{const Ae=Ue(Le.name);return Ae.length>=3&&(Z.includes(Ae)||Ae.includes(Z))}),ce=ct((K==null?void 0:K.website)||"")||ct((K==null?void 0:K.domain)||""),ze=ct((K==null?void 0:K.url)||"");if(ze&&R(Le=>Le||ze),ce){D(ce),g(!1);return}let he=!0;return g(!0),Mn(P).then(Le=>{var Je,vt;if(!he)return;const Ae=ct(Le.website||"")||ct(((vt=(Je=Le.candidates)==null?void 0:Je[0])==null?void 0:vt.url)||"");Ae&&D(Ae)}).catch(()=>{}).finally(()=>{he&&g(!1)}),()=>{he=!1}},[q,z,T,f]),c.useEffect(()=>{const P=Z=>{var ce;const K=String(((ce=Z.detail)==null?void 0:ce.url)||"").trim();ra(K)&&window.open(K,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),c.useEffect(()=>{if(ae.current===z)return;ae.current=z,ue(!0);const P=window.setTimeout(()=>ue(!1),560);return()=>window.clearTimeout(P)},[z]),c.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),Z=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!Z)return;const K=Z.classList.contains("cibles")?document.querySelector(".atl2.cibles .live-stack"):null,ce=()=>{const he=parseFloat(window.getComputedStyle(P).top)||0,Le=P.getBoundingClientRect().top<=he+1;P.classList.toggle("is-stuck",Le),Z.classList.toggle("url-stuck",Le);const Ae=Math.round(P.getBoundingClientRect().height);Z.style.setProperty("--demand-h",`${Ae}px`);const Je=window.matchMedia("(min-width: 861px)").matches;K&&Je?Z.style.setProperty("--pp-live-h",`${Math.round(K.getBoundingClientRect().height)}px`):Z.classList.contains("cibles")&&Z.style.setProperty("--pp-live-h","0px")};ce();const ze=new ResizeObserver(ce);return ze.observe(P),K&&ze.observe(K),window.addEventListener("scroll",ce,!0),window.addEventListener("resize",ce),()=>{ze.disconnect(),P.classList.remove("is-stuck"),Z.classList.remove("url-stuck"),window.removeEventListener("scroll",ce,!0),window.removeEventListener("resize",ce)}},[b,N,be,L,z,U,O]),c.useEffect(()=>{if(!m&&!E){ye(null);return}let P=!0;return(async()=>{const Z=await jo({email:o,cbToken:E});P&&ye(Z.length)})(),()=>{P=!1}},[m,E,o,Ce]);const xt=J.length?J:h,Me=x.credits,dt=c.useCallback(P=>{lp(n,P)&&(M(!1),l({type:"ptab",tab:0}),requestAnimationFrame(()=>{const Z=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!Z)return;const K=window.scrollY+Z.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,K),behavior:"smooth"})}))},[n,l]);c.useEffect(()=>{if(!Re)return;ve(0);const P=window.setInterval(()=>ve(Z=>Z+1),1e3);return()=>window.clearInterval(P)},[Re]);const nt=c.useMemo(()=>{const P=k.trim().toLowerCase();return!P||!u?null:f.find(Z=>Ue(Z.name)===P&&Fe(Z)===1)||null},[k,f,u]),At=()=>{const P=k.trim();if(P){if(nt){w(nt);return}i(null,P),v&&j("")}},rt=async()=>{var K,ce,ze;if(Ee.current)return;const P=de.trim().replace(/\s+/g,""),Z=me.trim();if(!P&&!Z){_(e.rsNeed);return}if(!v&&!E){i(null,P||Z.slice(0,80));return}Ee.current=!0,_(""),ee(null),pe(null),ne(!0);try{const he=await bs({url:P,text:Z,email:o,cbToken:E});if(ne(!1),!he||he.status!=="success"){_((he==null?void 0:he.message)||"Erreur");return}ee(he),$(!1),dt((((K=he.prospective)==null?void 0:K.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),pe({state:"pending"});const Le=await vs(he,{email:o,cbToken:E});pe(Le.ok?{state:"ok",scopeLabel:((ce=Le.summary)==null?void 0:ce.scope_label)||"",scope:((ze=Le.summary)==null?void 0:ze.scope)||""}:{state:"fail",msg:Le.error||""}),Le.ok&&je(Ae=>Ae+1)}finally{Ee.current=!1,ne(!1)}},qt=[W==null?void 0:W.industry,...(W==null?void 0:W.market_tags)||[],W==null?void 0:W.author].map(P=>(P||"").trim()).filter(Boolean),bt=(le==null?void 0:le.state)==="pending",Pt=le&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):le.state==="ok"?t.jsx("span",{className:"rslink ok",children:le.scope&&le.scope!=="public"?e.rsSavedIn(le.scopeLabel||le.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:le.msg,children:e.rsSaveFail})),_t=mp(W).length,Be=z,Ze=(q||k).trim(),Ye=f.find(P=>Ue(P.name)===Ue(Ze)),ut=ct(k)||T||ct((Ye==null?void 0:Ye.website)||"")||ct((Ye==null?void 0:Ye.domain)||""),F=B||ct((Ye==null?void 0:Ye.url)||""),G=nt?e.actAnalyse:Ze?e.evalGoOn(Ze.length>22?Ze.slice(0,21)+"…":Ze):e.evalGo,X=Re?`${xs(de.trim())==="youtube"&&de.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ke)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Be?" rs-mode":"")+(q&&k.trim()===q||N||be?" pair":"")+(N||be||U?" echo":"")+(U?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((Be?be:N)||U?" flash":"")+((Be?de.trim():Aa.test(k.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Be?de:k,placeholder:Be?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Be?600:200,spellCheck:Be?!1:void 0,inputMode:Be?"url":void 0,onChange:P=>{if(Be){xe(P.target.value);return}j(P.target.value),q&&P.target.value.trim()!==q&&(S(""),D(""),R(""),g(!1))},onKeyDown:P=>{P.key==="Enter"&&(Be?rt():At())}}),t.jsx("span",{className:"detect"+(Be?" off":"")+(Aa.test(k.trim())?" url":""),children:gt})]}),t.jsx("span",{className:"dacts",children:Be?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Re?" loading":""),disabled:Re||bt||!de.trim()&&!me.trim(),onClick:()=>{rt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:X})]}),t.jsxs("a",{className:"viewbtn"+(ra(de)?"":" off"),href:ra(de)?de.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{ra(de)||P.preventDefault()},children:[t.jsx(xp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs(Wa,{lang:a,storeKey:((nt==null?void 0:nt.name)||k).trim(),className:"evalbtn"+(nt?" analyse":"")+(s?" loading":""),disabled:s,confirmLabel:G,onConfirm:At,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:G})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(O?" searching":ut?"":" off"),href:ut||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":O||void 0,title:O?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{ut||P.preventDefault()},children:[O&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),O?e.viewSiteBusy:e.viewSite,!O&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(F?"":" off"),href:F||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{F||P.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),p.showCredits&&Me&&b==="ops"&&t.jsxs("button",{type:"button",className:"credits"+(Me.total_available<=0&&!Me.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Me.unlimited?"∞":Me.total_available}),!Me.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Me.daily_grant+Me.purchased]}),Me.total_available<=0&&!Me.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{l({type:"ptab",tab:0}),M(!1),requestAnimationFrame(()=>{const P=document.querySelector(".atl2.cibles .desk-list");if(!P)return;const Z=window.scrollY+P.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,Z),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(z?" on":""),onClick:()=>$(!z),children:e.rsOpen}),fe!==null&&fe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>ie(!re),children:e.rsArchOpen(fe)}),p.pipe&&!!n&&t.jsx(up,{pageToken:E,onAddNames:dt})]}),re&&t.jsx(gp,{bump:Ce,cbToken:E,onClose:()=>ie(!1),onEvaluate:P=>i(null,P),onAddAll:dt}),t.jsx("div",{className:"rsp slim"+(z?" on":" off"),"aria-hidden":!z,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:z?void 0:-1,onClick:()=>V(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:I?"▴":"▾"})]}),I&&t.jsx("textarea",{className:"rstext",value:me,placeholder:e.rsTextPh,tabIndex:z?void 0:-1,onChange:P=>we(P.target.value)})]})}),oe&&t.jsx("div",{className:"rserr",children:oe}),W&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:W.title}),W.source_url&&t.jsx("a",{href:W.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ee(null),pe(null)},children:"×"})]}),W.market&&t.jsx("p",{className:"rsmk",children:W.market}),qt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),qt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[W.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${W.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:mi(W.summary_md||"").map((P,Z)=>t.jsx("p",{children:P},Z))})]}),t.jsx(fi,{card:W,onEvaluate:P=>i(null,P),onAddAll:dt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(_t)}),Pt]})]}),xt.slice(0,1).map((P,Z)=>{const K=P.verdict==="kept",ce=P.verdict==="quota",ze=P.verdict==="unresolved",he=K?"var(--brand)":ce?"var(--bolt)":ze?"var(--blue)":"var(--red)",Le=K?"var(--brand-l)":ce?"#FFF3D6":ze?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":he,"--bgc":Le},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:K?"✓ "+e.kept:ce?"⏳":ze?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(Ae=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ae.url.startsWith("http")?Ae.url:`https://${Ae.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ae.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Ae.url,P.name),children:e.evalPickGo})]},Ae.url))}),!ce&&!ze&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:K?1:5});const Ae=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const Je=[...document.querySelectorAll(".atl2 .list .row")].find(vt=>{var et;return(((et=vt.querySelector(".rnm"))==null?void 0:et.textContent)||"").trim().toLowerCase().includes(Ae)});Je&&(Je.scrollIntoView({behavior:"smooth",block:"center"}),Je.classList.add("flashrow"),window.setTimeout(()=>Je.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(K?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},Z)}),v&&(d.kept+d.dropped>0||xt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function vp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function wp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Q(),i=e.memoConsole?r.get(e.memoConsole):null,d=c.useMemo(()=>i?[i.reasoning||"",vp(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=zt(i),s=Rn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:d?d.split(`

`).map((h,p)=>t.jsx("p",{style:{margin:"0 0 10px"},children:h},p)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Ut(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:s===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Un({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Q(),[d,l]=c.useState(!1),[s,h]=c.useState(null),p=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!p||d)return;l(!0);const m=await Eo(r,e);if(l(!1),!m){i(a.actErr);return}h(m.results||[])};return c.useEffect(()=>{if(!p)return;const m=b=>{var w;const f=String(((w=b.detail)==null?void 0:w.name)||"").trim();f&&f.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",m),()=>window.removeEventListener("ppmap:similar",m)},[e,p]),c.useEffect(()=>{if(p)try{const m=(sessionStorage.getItem("pp:similar")||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,p]),p?t.jsxs("div",{className:"simb",onClick:m=>m.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{x()},children:d?a.similarBusy:a.similar}),s&&(s.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:s.map(m=>t.jsxs("li",{children:[t.jsx("b",{className:m.verdict==="kept"?"ok":"ko",children:m.company}),m.reason&&t.jsx("span",{children:m.reason})]},m.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const yp=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ja=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ua(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}function Fn(e){const a=ua(e);if(!a)return"";try{return new URL(a).hostname.replace(/^www\./,"")}catch{return""}}function kp(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ja(a.slice(n));break}r+=ja(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ja(a.slice(o));break}const d=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(d),s=l?l[2].toLowerCase():"";l&&yp.has(s)?r+=`<${l[1]}${s}>`:r+=ja(a.slice(o,i+1)),n=i+1}return r}const Ep=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),oo={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function hi(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(Ep.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const l=d.name.toLowerCase();(!(oo["*"].has(l)||((r=oo[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}hi(n)}}function qa(e){const a=e.cloneNode(!0);return hi(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const jp={swot:null,summary:"",syn:"",pnl:"",cf:"",roi:"",reco:"",plan:"",pruned:[]},Np=/chiffre|revenu|revenue|\barr\b|ebitda|marge|gross|fcf|free cash|net|total|r[ée]sultat|cash|capex|nopat|moic|irr|\btri\b|roi|entry|\bev\b|invested|synerg/i,Sp=[["syn",/synerg/i],["pnl",/compte de r[ée]sultat|p\s*&\s*l|profit\s*(?:and|&)\s*loss|income statement/i],["cf",/flux de tr[ée]sorerie|cash\s*-?\s*flow/i],["roi",/\broi\b|return on investment|retour sur investissement/i],["reco",/verdict post|post[- ]model verdict|conviction quantitative/i]];function Mt(e){return String(e||"").replace(/<script[\s\S]*?<\/script>/gi," ").replace(/<style[\s\S]*?<\/style>/gi," ").replace(/<[^>]+>/g," ").replace(/&nbsp;/gi," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#39;|&apos;/g,"'").replace(/&quot;/g,'"').replace(/\s+/g," ").trim()}function gi(e,a){const r=e.slice(a),n=/<div\b|<\/div\s*>/gi;let o=0,i;for(;i=n.exec(r);)if(i[0][1]!=="/")o+=1;else if(o-=1,o===0)return e.slice(a,a+i.index+i[0].length);return""}function sn(e,a){const n=new RegExp(`<div\\b[^>]*\\bid="${a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}"`,"i").exec(e);return n?gi(e,n.index):""}function Cp(e,a=14){const r=e.match(/<tr\b[\s\S]*?<\/tr\s*>/gi)||[];if(r.length<=a)return{html:e,pruned:!1};const n=[];for(let d=0;d<r.length-1;d+=1){const l=r[d],s=/<t[dh]\b[^>]*>([\s\S]*?)<\/t[dh]\s*>/i.exec(l),h=s?Mt(s[1]):"";if((d<2||/<th/i.test(l)||Np.test(h))&&n.push(l),n.length>=a-1)break}n.push(r[r.length-1]);const o=n.length<3?r.slice(0,a):n;return{html:(/^\s*<table\b[^>]*>/i.exec(e)||["<table>"])[0]+o.join("")+"</table>",pruned:!0}}function zp(e,a=14){let r=!1;return{html:e.replace(/<table\b[\s\S]*?<\/table\s*>/gi,o=>{const i=Cp(o,a);return r=r||i.pruned,i.html}),pruned:r}}function Ap(e){const a={s:[],w:[],o:[],t:[]},r=[["s","s-green"],["w","s-red"],["o","s-blue"],["t","s-orange"]];for(const[n,o]of r){const i=new RegExp(`<div\\b[^>]*class="[^"]*swot-item[^"]*\\b${o}\\b[^"]*"`,"i").exec(e);if(!i)return null;const d=gi(e,i.index);let l=(d.match(/<li\b[^>]*>([\s\S]*?)<\/li\s*>/gi)||[]).map(s=>Mt(s));if(!l.length){const s=/<p\b[^>]*>([\s\S]*?)<\/p\s*>/i.exec(d);s&&(l=[Mt(s[1])])}if(l=l.filter(s=>s&&!/not available/i.test(s)&&!/non disponible/i.test(s)).map(s=>s.slice(0,260)).slice(0,4),!l.length)return null;a[n]=l}return a}function qp(e){const a=e.search(/id=["']company-summary["']/i);if(a<0)return"";const r=e.slice(a,a+9e3),n=/(?:EN R[ÉE]SUM[ÉE]|EN QUELQUES MOTS|IN SUMMARY|IN A FEW WORDS|IN A NUTSHELL|TL;DR)[\s:]*(?:<\/?span[^>]*>[\s:]*)*([\s\S]+?)(?=<br|<hr|<\/div|<h[23]|⚠|✅|🚀|❓|$)/i.exec(r);return n?Mt(n[1]).slice(0,600):""}function Tp(e,a,r){if(r<0)return"";const n=/<h3\b[^>]*>([\s\S]*?)<\/h3\s*>/gi;n.lastIndex=r;let o;for(;o=n.exec(e);){if(!a.test(Mt(o[1])))continue;const i=/<h3\b[^>]*>/i.exec(e.slice(o.index+o[0].length));return i?e.slice(o.index,o.index+o[0].length+i.index):e.slice(o.index,Math.min(e.length,o.index+o[0].length+6e4))}return""}function io(e){let a=e.replace(/^\s*<div\b[^>]*>/i,"").replace(/<\/div\s*>\s*$/i,"");return a=a.replace(/<h2\b[^>]*class="[^"]*section-title[^"]*"[^>]*>[\s\S]*?<\/h2\s*>/gi,""),a=a.replace(/<details\b[\s\S]*?<\/details\s*>/gi,""),a.trim()}function ln(e,a){if(e.length<=a)return e;const r=e.slice(0,a),n=r.lastIndexOf(">");return n>=0?r.slice(0,n+1):r}function Lp(e){const a={...jp,pruned:[]};if(!e)return a;try{const n=sn(e,"swot");n&&(a.swot=Ap(n))}catch{}try{a.summary=qp(e)}catch{}try{const n=sn(e,"action-plan");if(n){const o=io(n);a.plan=ln(o,12e3)}}catch{}const r=e.search(/id=["']financial-forecast["']/i);for(const[n,o]of Sp)try{let i=Tp(e,o,r);if(!i)continue;const d=zp(i);i=ln(d.html,45e3),Mt(i)&&(a[n]=i,d.pruned&&a.pruned.push(n))}catch{}if(!a.reco)try{const n=sn(e,"conviction");if(n){const o=ln(io(n),8e3);Mt(o)&&(a.reco=o)}}catch{}return a}function Fp(e){return e?!!(e.swot||e.summary||e.syn||e.pnl||e.cf||e.roi||e.reco||e.plan):!1}const dn=new Map;function xi(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=dn.get(a);return r||(r=Rp(a).catch(()=>null),r.then(n=>{n||dn.delete(a)}),dn.set(a,r)),r}async function Rp(e){var m,b;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=await a.text(),n=new DOMParser().parseFromString(r,"text/html"),o=f=>{var w;return(((w=n.querySelector(f))==null?void 0:w.textContent)||"").trim()},i=n.querySelector(".sb-score"),d=((m=Array.from((i==null?void 0:i.classList)||[]).find(f=>f.startsWith("sb-score-")))==null?void 0:m.slice(9))||"",l=[];let s=null;const h=Array.from(n.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const f of h){if(f.classList.contains("sb-nav-heading")){s={label:(f.textContent||"").trim(),items:[]},l.push(s);continue}const w=f.getAttribute("href")||"";if(!w.startsWith("#"))continue;const y=w.slice(1),u=Mp(n,y);u&&(s||(s={label:"",items:[]},l.push(s)),s.items.push({id:y,title:(f.textContent||"").trim(),html:u,poids:u.length}))}const p=((b=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:b[1])||"",x={score:o(".sb-score"),scoreTone:d,tags:Array.from(n.querySelectorAll(".sb-tag")).map(f=>(f.textContent||"").trim()).filter(Boolean),name:o(".sidebar-company-name"),tagline:o(".sidebar-tagline"),desc:o(".meta-desc"),groups:l.filter(f=>f.items.length),mindmapSlug:n.querySelector(".cm-mindmap-png")?p:"",comite:Op(n,Lp(r))};return x.groups.length?x:null}function Op(e,a){const r=n=>{if(!n)return"";const o=e.createElement("div");return o.innerHTML=n,qa(o)};return{...a,syn:r(a.syn),pnl:r(a.pnl),cf:r(a.cf),roi:r(a.roi),reco:r(a.reco),plan:r(a.plan)}}const so={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Mp(e,a){const r=e.getElementById(a),n=r?lo(e,r):"";if(n)return n;const o=so[a]?e.querySelector(so[a]):null;return o&&o!==r?lo(e,o):""}function lo(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),qa(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(s=>/^h3$/i.test(s.tagName))[0]===a)for(const s of i){if(s===a)break;/^h2$/i.test(s.tagName)||o.appendChild(s.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?qa(o):""}return qa(a)}const pn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ve({k:e,v:a,href:r,wide:n}){return a==null||a===""?null:t.jsxs("div",{className:"cdl"+(n?" cdw":""),children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Dp({k:e,vals:a}){const r=(a||[]).filter(Boolean);return r.length?t.jsxs("div",{className:"cdl cdw",children:[t.jsx("span",{className:"cdk",children:e}),t.jsx("span",{className:"cdtags",children:r.map(n=>t.jsx("span",{className:"cdtag",children:n},n))})]}):null}function po(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function co({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const cn=new Map;function Ip(e,a){const{token:r}=Q(),[n,o]=c.useState(null);return c.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=cn.get(i);d||(d=ws(r,e.name,e.checkId),cn.set(i,d),d.then(s=>{(!s||!s.reasoning&&!s.summaryHtml)&&cn.delete(i)}));let l=!0;return d.then(s=>{l&&s&&o({id:e.id,d:s})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Pp=6e4;function _p({o:e}){const{t:a,doDeep:r}=Q(),[n,o]=c.useState(null),[i,d]=c.useState(e.memoUrl?"load":"off"),[l,s]=c.useState(()=>new Set),[h,p]=c.useState(!1),x=c.useRef(new Map);c.useEffect(()=>{let w=!0;if(s(new Set),p(!1),x.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),xi(e.memoUrl).then(y=>{w&&(o(y),d(y?"ok":"err"))}),()=>{w=!1}},[e.memoUrl]);const m=zt(e),b=w=>{var y;return(y=x.current.get(w))==null?void 0:y.scrollIntoView({behavior:"smooth",block:"start"})},f=t.jsxs("div",{className:"cdacts",children:[Ut(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:w=>{w.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const w=[e.reasoning||"",po(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[w.length?w.join(`

`).split(`

`).map((y,u)=>t.jsx("p",{className:"cdtxt",children:y},u)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),f]})}if(i!=="ok"){const w=[e.reasoning||"",po(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[m&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:m}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),w.length>0&&w.join(`

`).split(`

`).map((y,u)=>t.jsx("p",{className:"cdtxt",children:y},u)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:y=>{y.stopPropagation(),p(u=>!u)},children:h?a.memoHideHere:a.memoReadHere})}),h&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:y=>y.stopPropagation()}),f,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[m&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:m}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(w=>t.jsx("span",{className:"md-tag",children:w},w)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(w=>w.items.map(y=>t.jsx("button",{type:"button",className:"md-jump",onClick:u=>{u.stopPropagation(),b(y.id)},children:y.title},y.id)))}),n.groups.map((w,y)=>t.jsxs("div",{className:"md-grp",children:[w.label&&t.jsx("div",{className:"md-grp-h",children:w.label}),w.items.map(u=>{const v=u.poids>Pp&&!l.has(u.id),E=u.id==="fiche-contact"||u.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:k=>{k&&x.current.set(u.id,k)},children:[t.jsx("h4",{className:"md-h",children:u.title}),E&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:k=>k.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:"LinkedIn"})]}),v?t.jsx("button",{type:"button",className:"abtn md-more",onClick:k=>{k.stopPropagation(),s(j=>new Set(j).add(u.id))},children:a.memoUnfold(Math.round(u.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:E?u.html.replace(/>\s*unavailable(\s+unavailable)*\s*</gi,"><"):u.html}}),!v&&n.mindmapSlug&&u.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${fa}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:k=>k.stopPropagation()})]})]},u.id)})]},w.label||y)),f,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull})]})}function Bp({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:l}=Q(),[s,h]=c.useState(!1),[p,x]=c.useState(!1),[m,b]=c.useState(!1),[f,w]=c.useState(null),[y,u]=c.useState(""),[v,E]=c.useState(null),[k,j]=c.useState(""),N={airtableId:e.airtableId,checkId:e.checkId},C=!!(e.airtableId||e.checkId),q=f&&f.id===e.id?f.entries:[],S=!!f&&f.id===e.id;if(c.useEffect(()=>{u(""),E(null),b(!1)},[e.id]),c.useEffect(()=>{if(!s||S||!C||!o)return;let D=!0;x(!0),b(!1);const B=e.id;return sr(r,"list",N).then(R=>{if(!(!D||B!==e.id)){if(x(!1),!R.ok){b(!0);return}w({id:B,entries:R.entries})}}),()=>{D=!1}},[s,S,C,r,e.id,o]),!n.pipe||!o||!C)return null;const T=(D,B)=>{x(!0);const R=e.id;sr(r,D,N,B).then(O=>{if(R===e.id){if(x(!1),!O.ok){d(a.notesErr);return}w({id:R,entries:O.entries}),b(!1),D==="add"&&(u(""),i(a.notesAdded)),D==="edit"&&E(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":s,onClick:D=>{D.stopPropagation(),h(B=>!B)},children:[t.jsx("b",{children:a.notesT}),q.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(q.length)}),t.jsx("i",{children:s?"▾":"▸"})]}),s&&t.jsxs("div",{className:"dn-b",onClick:D=>D.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),p&&!q.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),m&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!p&&!m&&S&&!q.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),q.map(D=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:l==="fr"?D.date.split("-").reverse().join("/"):D.date}),v===D.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:k,rows:3,onChange:B=>j(B.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:p||!k.trim(),onClick:()=>T("edit",{entryId:D.id,text:k.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>E(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:D.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{E(D.id),j(D.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:p,onClick:()=>{window.confirm(a.notesDelAsk)&&T("delete",{entryId:D.id})},children:a.notesDel})]})]})]},D.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:y,onChange:D=>u(D.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:p||!y.trim(),onClick:()=>T("add",{text:y.trim()}),children:a.notesAdd})]})]})]})}function Hn({o:e}){var j;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:d}=Q(),l=ha(e),s=zt(e),h=(e.cribleStatus||"").trim().toUpperCase()||(l==="NO MATCH"?"NO MATCH":l==="MATCH"?"MATCH":""),p=[e.sector,e.market,(e.tags||[]).filter(Boolean).length?"1":"",e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.provQuery,Fn(e.provUrl||""),La(e),e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,m=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=c.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(h?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Ut(e)?1:0},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:m}].filter(N=>N.n>0),[e,a,o,h,s,p,x,m]),[f,w]=c.useState(""),y=b.some(N=>N.k===f)?f:((j=b[0])==null?void 0:j.k)||"";c.useEffect(()=>{const N=C=>{var S;const q=String(((S=C.detail)==null?void 0:S.tab)||"");q&&b.some(T=>T.k===q)&&w(q)};return window.addEventListener("ppmap:card-tab",N),()=>window.removeEventListener("ppmap:card-tab",N)},[b]);const u=Ip(e,y==="eval"||y==="conv");if(!b.length)return null;const v=((u==null?void 0:u.reasoning)||"").length>(e.reasoning||"").length?u.reasoning:e.reasoning||"",E=((u==null?void 0:u.summaryHtml)||"").length>(e.summary||"").length?u.summaryHtml:e.summary||"",k=(u==null?void 0:u.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(N=>t.jsx("button",{type:"button",role:"tab","aria-selected":y===N.k,"data-tour":"tab-"+N.k,className:y===N.k?"on":"",onClick:C=>{C.stopPropagation(),w(N.k)},children:N.lib},N.k))}),t.jsxs("div",{className:"cdbody",onClick:N=>N.stopPropagation(),children:[y==="eval"&&t.jsxs(t.Fragment,{children:[h&&t.jsxs("div",{className:"cdv1"+(h==="NO MATCH"?" out":""),children:[t.jsx("b",{children:h==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(co,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),v&&v.split(`

`).map((N,C)=>t.jsx("p",{className:"cdtxt",children:N},C)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx($p,{o:e})]}),y==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof k=="number"&&t.jsx(co,{v:k,sur:100,k:a.cdConvScore}),pn(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",pn(e.verdictDate,r)]})]}),E&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:kp(E)}})]}),y==="memo"&&t.jsx(_p,{o:e}),y==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ve,{k:a.cdSector,v:e.sector}),t.jsx(Ve,{k:a.cdMarket,v:e.market,wide:!0}),t.jsx(Dp,{k:a.cdTags,vals:e.tags}),t.jsx(Ve,{k:a.cdStage,v:e.stage}),t.jsx(Ve,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ve,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Ve,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Ve,{k:a.cdAngle,v:e.angle}),t.jsx(Ve,{k:a.cdDetected,v:pn(e.date,r)}),t.jsx(Ve,{k:a.cdQuery,v:e.provQuery,wide:!0}),t.jsx(Ve,{k:a.cdSrc,v:Fn(e.provUrl||""),href:ua(e.provUrl||"")}),t.jsx(Ve,{k:a.cdAngleSrc,v:La(e)})]}),y==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ve,{k:a.cdName,v:e.contactName}),t.jsx(Ve,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Ve,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(Ve,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),y==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(Ve,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(Bp,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(e),children:a.actRegen})]})]})]})]})}const Na=new Map;function $p({o:e}){const{t:a,token:r}=Q(),[n,o]=c.useState(!1),[i,d]=c.useState(null);c.useEffect(()=>{if(!r||!e.name)return;const x=`${r}:${e.name.toLowerCase()}`;let m=Na.get(x);m||(m=No(r,[e.name]).then(f=>f[e.name]||Object.values(f)[0]||null).catch(()=>null),Na.set(x,m),m.then(f=>{(!f||!f.ok)&&Na.delete(x)}));let b=!0;return m.then(f=>{b&&f&&f.ok&&d(f)}),()=>{b=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const x=await yo(r,e.name,e.website||e.domain||"");d(x),x.ok&&Na.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(x)),o(!1)},s=(i==null?void 0:i.blocs)||{},h=[[a.qaVP,s.value_prop],[a.qaProduct,s.produit],[a.qaModel,s.modele],[a.qaSummary,s.synthese]],p=h.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&p&&t.jsxs(t.Fragment,{children:[h.filter(([,x])=>x).map(([x,m])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:m})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!p&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function Qt({spec:e}){const a=c.useRef(null),r=c.useRef(null),[n,o]=c.useState(!1);return c.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const l=()=>{const h=Math.max(280,Math.min(560,i.clientWidth||320));lr({kind:"op",card:e},h).then(p=>{!d&&p&&i.isConnected&&i.replaceChildren(p)})},s=window.requestAnimationFrame(l);return()=>{d=!0,window.cancelAnimationFrame(s),i.replaceChildren()}},[e]),c.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;lr({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(s=>{!d&&s&&i.isConnected&&i.replaceChildren(s)});const l=s=>{s.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{d=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Gt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Up=`
...
`;function Hp(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:d,top:l}}function Vp(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:l,doAnalyse:s,doDecide:h,doPromote:p,doRepeche:x,doApproach:m,doDeep:b,doOnboard:f,outbound:w,evalBusy:y}=Q(),u=e.popupId?r.get(e.popupId):null;if(!u)return null;const v=$e(u),E=Fe(u),k=zt(u),j=ha(u),N=u.kind==="target",C=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return Gt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Up}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Hp(e.popupAnchor,!!u.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:u.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(jt(u.date)),at(u.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[u.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[u.cc]}),children:(Yt(u.cc,o)||u.countryLabel||"").toUpperCase()}),u.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[u.sector]}),children:u.sector.toUpperCase()}),u.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[u.stage]}),children:u.stage.toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{className:"am2",children:Dt(u.amountEur,o)})]}),i.pipe&&N&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),u.ceoStatus&&t.jsx("span",{className:"pstep own",children:u.ceoStatus})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ft(u.engine)," ",t.jsx("b",{children:at(u.engine,o)})," — ",ys(u.engine,o),u.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",u.noteTitle]})]}),v?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ct,{o:u,lg:!0})," ",t.jsx(Ga,{o:u,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(So(v,o))," · ",n.win7(Co(v,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),u.card?t.jsx(Qt,{spec:u.card}):null,u.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),i.pipe&&N&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof u.score=="number"&&u.score>0?" · "+n.score(u.score):""]})}),i.pipe&&N&&t.jsx(Hn,{o:u})]}),t.jsx(Un,{name:u.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(u),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(u.name.length>22?u.name.slice(0,21)+"…":u.name)]}),E===1&&t.jsxs(Wa,{lang:o,storeKey:u.name,className:"evalbtn memo",style:{flex:1,justifyContent:"center"},confirmLabel:n.actAnalyse,onConfirm:()=>{s(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(u,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(u,!1),a({type:"popup",id:null})},children:n.actNo}),Ut(u)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(u),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),u.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:u.id}),a({type:"popup",id:null})},children:"📄"}),w&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{f(u),a({type:"popup",id:null})},children:"🚀"})]}):u.engine==="media"&&u.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(u.name),onClick:()=>l(u),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(u),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(u.name.length>22?u.name.slice(0,21)+"…":u.name)," →"]}),u.website&&t.jsx("a",{className:"psite",href:u.website.startsWith("http")?u.website:"https://"+u.website,target:"_blank",rel:"noopener noreferrer",title:u.website,children:"🌐"})]})]})]}),document.body)}function Wp(){const{lang:e,token:a,dossiers:r,caps:n}=Q(),o=a||"home",{names:i,verdicts:d}=c.useMemo(()=>{const s=[],h={};return r.forEach(p=>{p.kind!=="target"||!p.name||(s.push(p.name),h[p.name]=ks(p)||"")}),{names:s,verdicts:h}},[r]);return{diff:c.useMemo(()=>i.length?Es(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function Gp(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:l}=Q(),[s,h]=c.useState(!1),[p,x]=c.useState(!1),m=c.useRef(null);c.useEffect(()=>{if(!s)return;const E=k=>{m.current&&!m.current.contains(k.target)&&h(!1)};return document.addEventListener("click",E,!0),()=>document.removeEventListener("click",E,!0)},[s]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],f=i.loading&&!d.length,w=c.useRef({});c.useEffect(()=>{w.current={...r}},[r]);const y=E=>{const k=w.current[E],j=k!==void 0?r[E]-k:0;return t.jsxs("button",{type:"button",className:"step"+(E===3&&r[3]>0?" wait":""),style:{"--c":`var(${ia[E]})`,"--tc":E<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsxs("span",{className:"l",children:[n.plabels[E],E===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(j>0?" up":j<0?" down":""),children:[r[E],j!==0&&t.jsxs("em",{className:"delta",children:[j>0?"+":"−",Math.abs(j)]})]})]},E)},u=(E,k,j)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),"data-off":E,style:{"--c":`var(${ia[E]})`},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsx("span",{className:"l",children:j}),t.jsx("span",{className:"n",children:r[E]})]},E),v=(E,k,j,N=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:N,onClick:j,children:E},k);return t.jsxs("div",{className:"funnel"+(f?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(y)}),t.jsxs("div",{className:"offtrack",children:[u(5,!1,n.plabels[5]),u(7,!0,n.plabels[7]),u(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[v("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(p?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"}),a({type:"ptab",tab:1}),a({type:"continent",key:l.pipe?"europe":"monde"}),a({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:m,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":s,title:n.toolSort,onClick:()=>h(E=>!E),children:"⇅"}),s&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([E,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===E,className:"sortopt"+(e.sort.key===E?" on":""),onClick:()=>a({type:"sort",key:E}),children:[k,t.jsx("i",{children:e.sort.key===E?e.sort.dir===1?"↑":"↓":""})]},E))})]}),v("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),v("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Yp(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,mode:l,data:s}=Q(),h=c.useRef(null),[p,x]=c.useState(60);c.useEffect(()=>{let C=0;const q=()=>{var R;const S=h.current;if(!S)return;const T=(R=S.parentElement)==null?void 0:R.querySelector('.funnel [aria-selected="true"]');if(!T)return;const D=T.getBoundingClientRect(),B=S.getBoundingClientRect();x(Math.max(20,Math.min(D.left+D.width/2-B.left,B.width-30)))};return C=requestAnimationFrame(q),window.addEventListener("resize",q),()=>{cancelAnimationFrame(C),window.removeEventListener("resize",q)}},[e.ptab]);const m=e.ptab;let b=r.tuto[m].p;if(m===3){const C=i.filter(T=>T.kind==="target"&&Fe(T)===3),q=C.filter(T=>hn(T)==="auto").length,S=C.filter(T=>hn(T)==="cd").length;b=r.tutoPending(q,S,C.length)}const f=(()=>{var C;if(l!=="client")return null;if(m===0&&i.length)return{label:r.tuto[0].a,locked:!1,run:()=>a({type:"chainStart",queue:i.map(q=>q.id)})};if(m===1){const q=i.filter(S=>S.kind==="target"&&Fe(S)===1&&!d.has(S.id)).slice(0,10);if(q.length){const S=String(((C=s.credits)==null?void 0:C.plan)||"").toLowerCase(),T=S==="enterprise"||S==="entreprise";return{label:r.tuto[1].a,locked:!T,run:()=>{T&&a({type:"chainStart",queue:q.map(D=>D.id)})}}}}return null})(),w=js(m),y=m===1||m===2,u=m===5,v=m===7,E=m===6,k=w||u||v,j=r.plabels[m]+" · "+(o[m]??0),N=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:h,className:"tuto mini"+(k?"":" on-dark")+(y?" etape-on":"")+(u?" etape-out":"")+(v?" etape-view":"")+(E?" etape-fav":""),style:{"--bg":`var(${ia[m]})`,"--ax":p+"px","--stc":k?"var(--ink)":"#fff","--stt":k?"#fff":"var(--ink)","--tc":k?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:j}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),f&&t.jsx("button",{type:"button",className:"tprim"+(f.locked?" lock":""),disabled:!!f.locked,title:f.locked?r.analyseLockHint:void 0,onClick:f.run,children:f.locked?"🔒 "+r.analyseLock:f.label}),m!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:N})]})}const un=600,St=62,uo="atl2:fstats";function Qp(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Q(),[d,l]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(uo)==="on"}catch{return!1}}),s=r.stats,h=c.useMemo(()=>((s==null?void 0:s.by_day)||[]).slice(-30),[s]),p=(s==null?void 0:s.since)||"";if(!n.showFunnel||!s||typeof s.screened!="number")return null;const x=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,m=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),b=h.reduce((j,N)=>Math.max(j,N.s||0),0),f=h.length?un/h.length:0,w=Math.max(4,f-4),y=h.length>=5&&b>0,u=r.marketEstimate||0,v=x(new Date().toISOString().slice(0,10)),E=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof s.kept=="number"?[[s.kept,e.funKept]]:[],...typeof s.analyzed=="number"?[[s.analyzed,e.funAnalyzed]]:[],...typeof s.shown=="number"?[[s.shown,e.funShown]]:[]],k=[];return typeof s.screened_window=="number"&&p&&k.push({cle:"fenetre",periode:e.funPerWindow(x(p),v),etapes:[[s.screened_window,e.funScreened("","")]]}),typeof s.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:E(s.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([N,C],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:m(N)}),t.jsx("i",{children:C})]},j.cle+C)),j.cle==="total"&&u>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(m(u),Math.min(100,Math.round((s.screened||0)/u*100)))})]}),j.cle==="total"&&(s.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),j.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const N=!d;l(N),N&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(uo,N?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},j.cle)),d&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${un} ${St}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((j,N)=>{const C=(j.s||0)/b*(St-4),q=(j.m||0)/b*(St-4),S=N*f+(f-w)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===j.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}),onKeyDown:T=>{T.key!=="Enter"&&T.key!==" "||(T.preventDefault(),i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}))},children:[t.jsx("title",{children:`${x(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:S-1,y:0,width:w+2,height:St,fill:"transparent"}),t.jsx("rect",{x:S,y:St-2-C,width:w,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:S,y:St-2-q,width:w,height:q,fill:"#0E7F3F"})]},j.d)}),t.jsx("line",{x1:0,y1:St-1.5,x2:un,y2:St-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const bi={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Vn({o:e,locked:a=!1}){const{t:r}=Q(),n=ha(e),o=zt(e),i=Fe(e),d=hn(e),l=Ns(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(bi[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(ad,{o:e})]})}const Wt=e=>e.length>22?e.slice(0,21)+"…":e;function ma(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function vi(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .fzone:has(.stage.folded), .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .fzone:has(.stage.folded), .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Kp({on:e,rev:a}){const[r,n]=c.useState(null),[o,i]=c.useState({top:0,left:0,width:0});return c.useEffect(()=>{if(!e){n(null);return}const d=()=>{var f,w,y;const l=document.querySelector(".atl2.ops .desk-list"),s=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const h=l.getBoundingClientRect(),p=s?s.getBoundingClientRect().bottom:h.top;i({top:Math.round(p),left:Math.round(h.left),width:Math.round(h.width)});const x=[...l.querySelectorAll(":scope .grp")];let m=null;for(const u of x){const v=u.querySelector(".grp-h");v&&v.getBoundingClientRect().bottom<=p+2&&(m=u)}if(!m){n(null);return}const b=m.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((f=b.querySelector(".ic"))==null?void 0:f.textContent)||"").trim(),t:(((w=b.querySelector(".t"))==null?void 0:w.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Jp(e){const r=()=>{const n=vi(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function mo({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Q(),[i,d]=c.useState(!1);if(c.useEffect(()=>{n||d(!1)},[n]),Ge(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const s=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(s?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Wt(e.name))})]})}function oa(e,a){e({type:"focus",id:a.id}),window.setTimeout(()=>{var r;window.dispatchEvent(new CustomEvent("ppmap:card-tab",{detail:{tab:"memo"}})),(r=document.querySelector(".atl2 .readpane"))==null||r.scrollIntoView({block:"nearest"})},40)}function Wn({o:e}){const{t:a,lang:r,caps:n,memoQueued:o,approachDone:i,doAnalyse:d,doDecide:l,doPromote:s,doRepeche:h,doApproach:p,dispatch:x,liveMemos:m}=Q(),b=w=>y=>{y.stopPropagation(),w()};if(n.lockActions){const w=b(()=>x({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:w,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const y=Fe(e);return y===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:w,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Wt(e.name))})]})}):y===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:w,children:a.actAnalyse})}):y===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:w,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:w,children:a.actNo})]})}):y===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:w,children:a.actPromote})}):y===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:w,children:a.actApproach})}):y===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:w,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:w,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:w=>{w.stopPropagation(),ma(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Ma(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:w=>{w.stopPropagation(),ma(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!n.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(mo,{o:e})});const f=Fe(e);if(f===0)return t.jsx("span",{className:"cell",children:t.jsx(mo,{o:e})});if(f===1){const w=m.liveOf(e.name);if(w&&(w.status==="boot"||w.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ra,{item:w,serverOff:m.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const y=o.has(e.id);return t.jsx("span",{className:"cell cell-an",children:t.jsx(Wa,{lang:r,storeKey:e.name,className:"memobtn",disabled:y,confirmLabel:a.actAnalyse,onConfirm:()=>d(e),children:y?a.actAnalyseQueued:a.actAnalyse})})}if(f===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>oa(x,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(f===4){const w=i.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:w,onClick:b(()=>p(e)),children:w?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:b(()=>x({type:"modal",modal:"plug"})),children:a.actConn}),t.jsx("button",{type:"button",className:"lk sm dsrow",title:a.dsBtn,onClick:b(()=>x({type:"dossierOpen",id:e.id})),children:a.dsBtn})]})}return f===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>oa(x,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):f===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>h(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>oa(x,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>oa(x,e)),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Xp({o:e}){const{t:a,doThumb:r,thumbOf:n}=Q(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Zp({o:e}){const{lang:a}=Q();return $e(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ct,{o:e}),t.jsx(Ga,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ft(e.engine||"")," ",at(e.engine||"",a)]})})}function ec({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:l}){const{dispatch:s,caps:h,markRow:p,markedId:x,favIds:m,toggleFav:b,t:f}=Q(),w=Fe(e),y=["#16233A","#475C6E","#8798A8","#B9C6D2"],u=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=u<=0?0:u<=7?1:u<=30?2:3,E=h.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][w]:y[v],k=m.has(e.id),j=N=>{if(a)return;if(d){d(e.id);return}if(h.pipe||e.kind==="op"){n();return}const C=N.currentTarget.getBoundingClientRect();s({type:"popup",id:e.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return t.jsxs(c.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(h.pipe&&e.kind==="target"?" p"+w:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>p(e.id),onMouseLeave:()=>p(null),onClick:j,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx(Ni,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${f.cdEngagement} ${Math.round(e.engagement*10)/10} · ${f.cdEngagementHint}`,children:"🔥"}),$e(e)&&t.jsx(Ct,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[h.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Xe(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(N=>N&&N!==e.name)||""]}),h.pipe&&!h.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:N=>N.stopPropagation(),children:[e.website&&t.jsx("a",{href:ua(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":f.rowSite,title:f.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:ua(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":f.rowLi,title:f.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":f.rowMail,title:f.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":f.rowTel,title:f.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:f.acqSee(e.acquirer),onClick:N=>{N.stopPropagation(),s({type:"acquirer",value:e.acquirer||""})},children:["← ",Wt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:f.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:f.zoomNewsMark,children:"📰"}):null]}),t.jsx(tc,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Zp,{o:e}),h.pipe&&t.jsx(Vn,{o:e,locked:a}),h.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Wn,{o:e}),h.showThumbs&&t.jsx(Xp,{o:e})]}),r&&!a&&!d&&t.jsx(rc,{o:e})]})}function tc({o:e}){const{lang:a,caps:r}=Q();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Dt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function ac({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Q(),d=(m,b=!1)=>f=>{f.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})},l=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,40):""})(),s=Dt(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),p=Ge(e),x=p&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),s&&t.jsx("span",{className:"oc-amt",children:s}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[p?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Xe(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:m=>{m.stopPropagation(),ma(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:m=>{m.stopPropagation(),n(e)},children:a.evalGoOn(Wt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Qt,{spec:e.card})})]})}function nc({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Q();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=[e.tagline,e.headline,e.reasoning].find(h=>h&&h!==e.name)||"",l=Dt(e.amountEur,r),s=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return h?h[1].replace(/^www\./,"").slice(0,40):""})();return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[at(e.engine||"",r),i?` · ${i}`:"",l?` · ${l}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Wn,{o:e})})]}),(e.sector||e.countryLabel||e.stage||e.acquirer)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null,e.acquirer?t.jsxs("span",{children:["← ",e.acquirer]}):null]}),(d||e.decryptHtml||e.url||e.card)&&t.jsxs("div",{className:"zoom-news",children:[d?t.jsx("p",{className:"zoom-lead",children:d}):null,e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):null,e.card?t.jsx("div",{className:"zoom-card",children:t.jsx(Qt,{spec:e.card})}):null,e.url?t.jsxs("a",{className:"zoom-src",href:e.url,target:"_blank",rel:"nofollow noopener",children:[a.zoomSrc,s?` · ${s}`:""," ↗"]}):null]}),t.jsx(Hn,{o:e})]})}function wi({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:l,dossiers:s}=Q(),h=c.useRef(null),p=We(e);if(c.useEffect(()=>{if(!p||!(e!=null&&e.decryptHtml))return;const g=h.current;if(!g)return;let L=!1;return mn(()=>import("./fit-DX-mzLKR.js"),[]).then(async M=>{await M.ensureEditoCss(),!(L||!g.isConnected)&&(M.beautifyEditoRows(g),M.mountCardFits(g))}),()=>{L=!0}},[p,e==null?void 0:e.decryptHtml]),!e&&!a){const g=s.find(We);if(g)return t.jsx(wi,{o:g})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),m=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,f=(e==null?void 0:e.card)||(a==null?void 0:a.card),w=e?!!e.noCo:!x||Oa(x),y=(e==null?void 0:e.engine)||"",u=We(e),v=e?Dt(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const g=/https?:\/\/(?:www\.)?([^/]+)/.exec(m);return g?g[1].replace(/^www\./,"").slice(0,40):""})(),j=s.find(We),N=((j==null?void 0:j.url)||"").trim(),C=!!m&&!!N&&(m===N||m.endsWith(N)||N.endsWith(m)),q=(g,L=!1)=>M=>{M.stopPropagation(),L&&d({type:"continent",key:"monde"}),d({type:"filters",patch:g})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const S=()=>{x&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:x}}))},T=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},D=()=>{ma({url:m,headline:b,tagline:e==null?void 0:e.tagline,name:x})},B=e?Ge(e):!1,R=B&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",O=u?r.doEdito.replace(/^📖\s*/,""):y?at(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[O,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),m&&!u&&(w||Ma({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:m,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:g=>g.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:h,className:"ed-decrypt-b zoom-body"+(u?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),v&&t.jsx("span",{className:"oc-amt",children:v})]}),f&&t.jsx("div",{className:"zoom-card",children:t.jsx(Qt,{spec:f})}),(m&&!C&&!u||j&&!u)&&t.jsxs("div",{className:"zoom-srcbox",children:[m&&!C&&!u&&t.jsxs("a",{className:"zoom-src",href:m,target:"_blank",rel:"nofollow noopener",onClick:g=>g.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!u&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:g=>{g.stopPropagation(),d({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[B?t.jsxs("span",{className:"verdict",style:{"--c":R?"var(--brand)":"var(--red)"},children:[R?"✓":"✗"," ",t.jsx("b",{children:R?r.kept:r.dropped})]}):!w&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:g=>{g.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Wt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,m&&!u&&(w||Ma({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!w&&x?" ghost":""),onClick:g=>{g.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!w&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),S()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Wt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!w&&x&&l.pipe&&t.jsx(Un,{name:x})]})]})}function rc({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=Q();return!o.pipe&&e.kind==="op"?t.jsx(ac,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Hn,{o:e}),t.jsx(nd,{o:e}),t.jsx(od,{o:e}),t.jsx(Un,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Vn,{o:e})})]}),e.card&&t.jsx(Qt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ft(e.engine||"")," ",at(e.engine||"",r)]}),$e(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ct,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function oc({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:l,lang:s}=Q();if(!d.pipe&&e.kind==="op"){const x=Dt(e.amountEur,s),m=(()=>{const f=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return f?f[1].slice(0,32):""})(),b=(f,w=!1)=>y=>{y.stopPropagation(),w&&i({type:"continent",key:"monde"}),i({type:"filters",patch:f})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Qt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Ft(e.engine||"")," ",at(e.engine||"",s)]}),$e(e)&&t.jsx(Ct,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:f=>f.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(m?` · ${m}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Wn,{o:e})})]})}const h=Fe(e),p=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][h];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":p},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Vn,{o:e}),$e(e)&&t.jsx(Ct,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&h===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>oa(i,e),children:[o.actMemoOf(e.memoType)," →"]})]})}function ic(){const{t:e}=Q(),[a,r]=c.useState(0);return c.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function sc({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Q(),i=o==="en",d=p=>n.plabels[p]||"",l=[0,1,2,3,4,5,6,7].filter(p=>p!==a.ptab&&(e[p]||0)>0),s=l.includes(0)?0:l.sort((p,x)=>(e[x]||0)-(e[p]||0))[0];if(s===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[s]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:s===0?i?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:i?`${h} ${h>1?"files":"file"} in “${d(s)}”`:`${h} dossier${h>1?"s":""} dans « ${d(s)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:s}),children:[(i?"Open ":"Ouvrir ")+d(s)," →"]})]})}function lc(){var _t,Be,Ze,Ye,ut;const e=Q(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:l,markRow:s,lang:h,sessTally:p,data:x,dossiers:m,source:b,focusExtra:f,byId:w,token:y}=e,u=Po(),v=c.useMemo(()=>{var X,P,Z,K;if(!y||b==="ops")return null;const F=(((X=u==null?void 0:u.ed)==null?void 0:X.date)||(u==null?void 0:u.day)||"").slice(0,10),G=[(P=u==null?void 0:u.ed)==null?void 0:P.html,(Z=u==null?void 0:u.ed)==null?void 0:Z.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:h==="en"?"Today's brief":"Brief du jour",headline:h==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((K=u==null?void 0:u.ed)==null?void 0:K.date)||F,decryptHtml:G||void 0,date:F,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,h,(_t=u==null?void 0:u.ed)==null?void 0:_t.html,(Be=u==null?void 0:u.ed)==null?void 0:Be.acquirers_html,(Ze=u==null?void 0:u.ed)==null?void 0:Ze.date,u==null?void 0:u.day]),E=F=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Io,[k,j]=c.useState(new Set);c.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[N,C]=c.useState(null);c.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[q,S]=c.useState(!a.mapFolded);c.useEffect(()=>{if(a.mapFolded){S(!1);return}const F=document.getElementById("atl2-stage");if(!F){S(!1);return}const G=new IntersectionObserver(([X])=>S(!!X&&X.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return G.observe(F),()=>G.disconnect()},[a.mapFolded]);const T=!a.mapFolded&&!q,D=F=>j(G=>{const X=new Set(G);return X.has(F)?X.delete(F):X.add(F),X}),B=b==="ops"||o.pipe,[R,O]=c.useState("all"),[g,L]=c.useState(!1),[M,J]=c.useState(null),[te,z]=c.useState(!1),$=c.useRef(!0);c.useEffect(()=>{if($.current){$.current=!1;return}O("all"),z(!1)},[a.ptab,a.continent]),c.useEffect(()=>{if(!te)return;const F=G=>{var X,P;(P=(X=G.target)==null?void 0:X.closest)!=null&&P.call(X,".atl2 .doable")||z(!1)};return document.addEventListener("click",F,!0),()=>document.removeEventListener("click",F,!0)},[te]);const I=c.useMemo(()=>{var G;const F=new Map;for(const X of Ul(((G=u==null?void 0:u.ed)==null?void 0:G.html)||""))F.has(X.t)||F.set(X.t,X.html);return F},[(Ye=u==null?void 0:u.ed)==null?void 0:Ye.html]),V=c.useCallback(F=>{if(F.decryptHtml)return F.decryptHtml;if(!I.size)return;const G=(F.name||"").trim().toLowerCase();if(G.length<3)return;const X=I.get(G);if(X)return X;for(const[P,Z]of I)if(P.includes(G)||G.includes(P))return Z},[I]),{diff:U}=Wp(),[ue,ae]=c.useState(!1),de=a.filters.win==="1"&&!a.filters.day,[xe,me]=c.useState(!1),we=c.useMemo(()=>new Set(((U==null?void 0:U.added)||[]).map(F=>F.trim().toLowerCase()).filter(Boolean)),[U]),be=c.useMemo(()=>{if(!we.size)return 0;const F={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return m.filter(G=>!We(G)&&we.has((G.name||"").trim().toLowerCase())&&sa(G,F,o.pipe)).length},[m,we,a,o.pipe]);c.useEffect(()=>{const F=()=>{me(!1),L(!1),O("all"),z(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",F),()=>window.removeEventListener("ppmap:tunnel",F)},[]),c.useEffect(()=>{me(!1),L(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const Ne=c.useMemo(()=>{const F=l.filter(X=>!We(X)&&Xe(X));let G="";for(const X of F){const P=(X.date||"").slice(0,10);P&&(!G||P<G)&&(G=P)}return{n:F.length,since:G?G.split("-").reverse().slice(0,2).join("/"):""}},[l]),Re=Ne.n,ne=c.useMemo(()=>{const G=xe&&we.size>0||a.filters.signalOnly||R!=="all"||g?l:d;let X=Pn(G,a.sort);return X=X.filter(P=>!We(P)),xe&&we.size&&(X=X.filter(P=>we.has((P.name||"").trim().toLowerCase()))),g||R==="explore"?X=X.filter(Xe):R==="eval"?X=X.filter(P=>!Xe(P)&&!P.noCo&&(P.kind==="op"||!Ge(P))):o.pipe&&(X=X.filter(P=>!Xe(P))),X},[d,l,a.sort,R,xe,we,g,o.pipe]),ve=c.useMemo(()=>o.pipe?m.filter(F=>F.kind==="target"&&!We(F)&&$e(F)&&(a.continent==="monde"||F.continent===a.continent)):ne.filter(F=>$e(F)&&!Ge(F)),[o.pipe,m,ne,a.continent]).length,oe=c.useMemo(()=>o.pipe?ne:ne.filter(F=>!Ge(F)&&!F.noCo&&!Xe(F)),[ne,o.pipe]),_=b==="ops"?ne.filter(Xe).length:0,W=xe?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,ee=a.filters,le=ee.sector.length+ee.market.length+ee.country.length+ee.engine.length+ee.stage.length+ee.crible.length+ee.angle.length+ee.memoLevel.length+ee.dealKind.length+(ee.signalOnly?1:0)+(ee.acquirer.trim()?1:0)+(ee.search.trim()?1:0),pe=[];if(ee.day)pe.push({k:"day",lib:n.fDay(ee.day.slice(8,10)+"/"+ee.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(ee.win&&ee.win!=="all"){const F=["1","7","30"].indexOf(ee.win);F>=0&&pe.push({k:"win",lib:n.dates[F],off:()=>r({type:"filters",patch:{win:"all"}})})}const re=F=>F.length<=2?F.join(", "):`${F.length} ${n.fSelected}`;for(const F of["sector","market","country","engine","crible"]){const G=ee[F];G&&G.length&&pe.push({k:F,lib:re(G),off:()=>r({type:"clearFacet",facet:F})})}ee.search&&pe.push({k:"search",lib:"🔍 "+ee.search,off:()=>r({type:"filters",patch:{search:""}})}),xe&&we.size&&pe.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>me(!1)}),ee.signalOnly&&pe.push({k:"sig",lib:"🔴 "+n.sigDock(ve||ee.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const ie=(F,G,X="",P=!1)=>t.jsxs("button",{type:"button","data-s":F,className:X,"aria-sort":a.sort.key===F?a.sort.dir===1?"ascending":"descending":"none",style:P?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:F}),children:[G,t.jsx("span",{className:"ar",children:a.sort.key===F&&a.sort.dir===1?"▴":"▾"})]},F),fe=c.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const F=new Map;ne.forEach(P=>{const Z=P.engine||"?";F.has(Z)||F.set(Z,[]),F.get(Z).push(P)});const G={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},X=fn([...F.keys()],h);return[...F.entries()].sort((P,Z)=>{const K=G[P[0]]??10+X.indexOf(P[0]),ce=G[Z[0]]??10+X.indexOf(Z[0]);return K-ce})},[ne,o.pipe,a.groupBy,h]),ye=fe?fe.filter(([F])=>Ca.has(F)).length:0,Ce=(()=>{var G;return((G=(fe?fe.flatMap(([,X])=>X):ne)[0])==null?void 0:G.id)??null})(),je=c.useRef(!1),Ee=c.useMemo(()=>m.find(We)||v,[m,v]),[gt,xt]=c.useState(!1);c.useEffect(()=>{const F=()=>{je.current=!0,me(!1)};return window.addEventListener("ppmap:reveal",F),window.addEventListener("ppmap:focus",F),()=>{window.removeEventListener("ppmap:reveal",F),window.removeEventListener("ppmap:focus",F)}},[]),c.useEffect(()=>{const F=()=>{Ee&&r({type:"focus",id:Ee.id})};return window.addEventListener("ppmap:edito",F),()=>window.removeEventListener("ppmap:edito",F)},[Ee,r]),c.useEffect(()=>{if(!a.focusId)return;J(a.focusId);const F=window.setTimeout(()=>J(null),900);return()=>window.clearTimeout(F)},[a.focusId]),c.useEffect(()=>{if(B&&!(a.focusId&&(ne.some(F=>F.id===a.focusId)||m.some(F=>F.id===a.focusId)||a.focusId===(Ee==null?void 0:Ee.id)))&&!f){if(Ee){r({type:"focus",id:Ee.id});return}Ce&&r({type:"focus",id:Ce})}},[B,a.focusId,ne,Ce,f,r,m,b,Ee]),c.useEffect(()=>{if(!B||!a.focusId||Ee&&a.focusId===Ee.id||ne.some(G=>G.id===a.focusId))return;const F=m.find(G=>G.id===a.focusId);if(F){if(je.current){F.kind==="op"?O(Xe(F)?"explore":"eval"):R!=="all"&&O("all");return}R!=="all"&&Ce&&r({type:"focus",id:Ce})}},[B,a.focusId,R,ne,m,Ce,r,Ee]),c.useEffect(()=>{if(!B||!a.focusId||!je.current)return;const F=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!F){const Z=ne.findIndex(K=>K.id===a.focusId);if(Z>=0){const K=fe?"":"pt"+a.ptab;if(K){const ce=a.shown[K]||E();Z>=ce&&r({type:"more",group:K,by:Z-ce+8})}}return}je.current=!1;const G=vi(),X=F.getBoundingClientRect();X.top>=G-2&&X.bottom<=window.innerHeight-4||Jp(F)},[B,a.focusId,a.ptab,ne,a.shown,fe,r]),c.useEffect(()=>{if(typeof window>"u")return;const F=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),G=document.querySelector(".atl2.ops, .atl2.cibles");if(!F||!G)return;const X=document.querySelector(".atl2 .fzone"),P=()=>{G.style.setProperty("--listhead-h",`${F.offsetHeight}px`);const K=!!(X&&X.querySelector(".stage.folded"));G.style.setProperty("--fold-h",K&&X?`${X.offsetHeight}px`:"0px")};P();const Z=new ResizeObserver(P);return Z.observe(F),X&&Z.observe(X),()=>Z.disconnect()},[T,a.dens,a.mapFolded]);const Me=c.useMemo(()=>{if(!B||!a.focusId)return null;if(v&&a.focusId===v.id)return v;const F=ne.find(X=>X.id===a.focusId)||m.find(X=>X.id===a.focusId)||null;if(!F)return null;const G=V(F);return G&&G!==F.decryptHtml?{...F,decryptHtml:G}:F},[B,a.focusId,ne,m,V,v]),dt=o.lockRowsAfter;let nt=0;const At=(F,G)=>{let X=a.shown[G]||E();return F.length-X<=4&&(X=F.length),F.slice(0,X).map(K=>{const ce=dt!==null&&nt>=dt;nt++;const ze=V(K),he=ze&&ze!==K.decryptHtml?{...K,decryptHtml:ze}:K,Le=!B&&a.dens!=="maxi"&&(a.dens==="deplie"||(N?N==="open":!!ze)),Ae=k.has(K.id)?!Le:Le,Je=B?vt=>{je.current=!0,r({type:"focus",id:vt});const et=w.get(vt);et&&(Xe(et)?ma(et):et.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:et.name,url:et.url||"",website:et.website||"",domain:et.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(oc,{o:he,locked:ce,selected:B&&a.focusId===K.id,onSelect:Je},K.id):t.jsx(ec,{o:he,locked:ce,open:Ae,onToggle:()=>D(K.id),selected:B&&a.focusId===K.id,echo:M===K.id,fresh:we.has((K.name||"").trim().toLowerCase()),onSelect:Je},K.id)})},rt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ne.length?"":" list-empty"),qt=t.jsxs(t.Fragment,{children:[fe?fe.map(([F,G])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ft(F)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:F==="ma"?n.grpMa:F==="fundraising"?n.grpLev:Ca.has(F)&&ye<=1?n.grpNews:F==="nominations"?n.grpNom:F==="media"?n.grpNewsOther:F==="recrutements"?n.grpHire:Ca.has(F)?n.grpNews+" · "+at(F,h):at(F,h)}),t.jsx("div",{className:"s",children:n.grpCount(G.filter(X=>!Ge(X)).length,G.length)})]})]}),At(G,F)]},F)):At(ne,"pt"+a.ptab),x.loading&&!m.length&&t.jsx(ic,{}),o.pipe&&a.ptab===0&&!g&&!xe&&R==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(dp,{}),!ne.length&&!(x.loading&&!m.length)&&(o.pipe&&R==="all"?t.jsx(sc,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(ee.win!=="all"||!!ee.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),le>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(le)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),bt=t.jsxs(t.Fragment,{children:[!xe&&!g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ia[a.ptab]+")"},children:ne.length})," ",W]}),g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ia[a.ptab]+")"},children:ne.length})," ",n.newsWord]}),(!xe||g)&&t.jsx("span",{className:"dot",children:"·"}),T&&t.jsx(ci,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[T?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),pe.map(F=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:G=>{G.stopPropagation(),F.off()},children:[F.lib,t.jsx("i",{children:"×"})]},F.k)),b==="ops"&&ne.length>0&&!T&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ne.length-_," ",n.zoomPulseEval,_>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",_," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),Pt=t.jsxs("div",{className:"listhead"+(T?" mapoff":""),children:[T&&t.jsx("div",{className:"lh-tools",children:t.jsx(pi,{compact:!0})}),o.showFunnel&&ue&&de&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(sd,{}),t.jsx(Qp,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:bt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Gp,{}),t.jsx(Yp,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(de?" on":""),"aria-pressed":de,title:n.morningDockTitle,onClick:()=>{if(de){r({type:"filters",patch:{win:"all",day:""}}),ae(!1);return}me(!1),L(!1),O("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),ae(!0)},children:["📊 ",n.morningDock(typeof((ut=x.stats)==null?void 0:ut.screened_today)=="number"?x.stats.screened_today:0)]}),U&&!U.firstVisit&&(U.added.length>0||U.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(xe?" on":""),"aria-pressed":xe,title:n.sinceSub,onClick:()=>{const F=!xe;me(F),L(!1),ae(!1),O("all"),F&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(be),U!=null&&U.lastDate?` · ${n.sinceSince(U.lastDate)}`:""]}),ve>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{me(!1),L(!1),ae(!1),O("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(ve)]}),o.pipe&&Re>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(g?" on":""),"aria-pressed":g,title:n.newsDockHint,onClick:()=>{const F=!g;L(F),me(!1),ae(!1),O("all"),F&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(Re),Ne.since?` · ${n.newsSince(Ne.since)}`:""]})]}),!o.showFunnel&&bt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([F,G])=>t.jsxs("button",{type:"button","data-d":F,"aria-pressed":a.dens===F||F==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:F}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:G})]},F))}),!B&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":N==="open",onClick:()=>{C("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":N==="closed",onClick:()=>{C("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var ze;const F={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},G=m.filter(he=>sa(he,F,o.pipe)&&!We(he)),X=G.filter(he=>!Xe(he)&&!he.noCo&&(he.kind==="op"||!Ge(he))).length,P=G.filter(Xe).length,Z=o.pipe?G.filter(he=>he.kind!=="op"&&Fe(he)===1).length:0,K=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${Z?` ${Z}`:""}`]]:[],["eval",`${n.doEval}${X?` ${X}`:""}`],["explore",`${n.doExplore}${P?` ${P}`:""}`]],ce=((ze=K.find(([he])=>he===R))==null?void 0:ze[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":te,onClick:()=>z(he=>!he),children:[ce,t.jsx("i",{children:"▾"})]}),te&&t.jsx("div",{className:"dolist",children:K.map(([he,Le])=>t.jsx("button",{type:"button","aria-pressed":R===he,onClick:()=>{if(z(!1),he==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}O(he),he!=="all"&&(me(!1),L(!1),ae(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:Le},he))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:F=>r({type:"sort",key:F.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([F,G])=>t.jsx("option",{value:F,children:G},F))})]}),o.showChain&&t.jsxs("span",{className:"chainwrap"+(oe.length===0?" empty":""),children:[t.jsxs("button",{type:"button",className:"chain",disabled:oe.length===0,title:n.chainHint,onClick:()=>{oe.length&&r({type:"chainStart",queue:oe.map(F=>F.id)})},children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(oe.length):n.chainAll(oe.length)]}),!o.pipe&&t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!B&&Pt,a.dens!=="maxi"&&!B&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ie("country",n.colCountry),ie("name",n.colCompany),ie("amount",n.colAmount,"h-amt",!0),ie("stage",n.colStage,"h-stade"),ie("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ie("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ie("memo",n.colMemo)]}),o.pipe&&ie("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),B?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[Pt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ie("country",n.colCountry),ie("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ie("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ie("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:rt,children:qt})]}),t.jsxs("aside",{className:"readpane"+((Me?We(Me):!f&&Ee)?" is-edito":""),"aria-label":h==="fr"?"Dossier":"File",children:[Ee&&(()=>{const F=a.focusId===Ee.id&&!gt,G=(Ee.headline||Ee.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":F,onClick:()=>{if(F){xt(!0);return}xt(!1),r({type:"focus",id:Ee.id})},children:[t.jsx("span",{className:"eg-t",children:h==="en"?"Today’s editorial":"Édito du jour"}),G&&t.jsx("span",{className:"eg-sub",children:G}),t.jsx("span",{className:"eg-chev",children:F?h==="en"?"Collapse ▴":"Replier ▴":h==="en"?"Read ▾":"Lire ▾"})]})})(),!!(Ee&&(Me?We(Me):!f))&&gt?null:v&&a.focusId===v.id?t.jsx("div",{className:"zoom",children:t.jsx(Yl,{})}):Me&&o.pipe?t.jsx(nc,{o:Me}):t.jsx(wi,{o:Me,extra:Me?null:f})]})]}):t.jsx("div",{className:rt,children:qt}),(()=>{const F=fe||[["pt"+a.ptab,ne]];let G=0,X=0;for(const[Z,K]of F){X+=K.length;let ce=a.shown[Z]||E();K.length-ce<=4&&(ce=K.length),G+=Math.min(K.length,ce)}const P=X-G;return P<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>F.forEach(([Z,K])=>r({type:"more",group:Z,by:K.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(P,P)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(G,X)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}}),B&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Kp,{on:!!fe,rev:(fe||[]).map(([F,G])=>F+G.length).join("|")})]})}function fo(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function dc(e,a){const r=Ss(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function pc(e,a){const n=[a.head.split("|").map(fo).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",dc(o,a.plabels),ha(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(fo).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function cc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const uc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Qe({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function Xt({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function mc({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=Q(),d=(e.cribleStatus||"").trim().toUpperCase()||(ha(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=zt(e),s=(a==null?void 0:a.blocs)||{},h=[[n.qaVP,s.value_prop],[n.qaProduct,s.produit],[n.qaModel,s.modele],[n.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Qe,{k:n.cdSector,v:e.sector}),t.jsx(Qe,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(Qe,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(Qe,{k:n.cdStage,v:e.stage}),t.jsx(Qe,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Qe,{k:n.cdSite,v:e.domain||e.website}),t.jsx(Qe,{k:n.cdName,v:e.contactName}),t.jsx(Qe,{k:n.cdEmail,v:e.contactEmail}),t.jsx(Qe,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Qe,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Qe,{k:n.cdAngle,v:e.angle}),t.jsx(Qe,{k:n.cdDetected,v:uc(e.date,o)})]}),!!(e.provQuery||e.provUrl||La(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(Qe,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(Qe,{k:n.cdSrc,v:Fn(e.provUrl||""),href:ua(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(Qe,{k:n.cdAngleSrc,v:La(e)})]})]}),h.some(([,p])=>p)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),h.filter(([,p])=>p).map(([p,x])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:p}),t.jsx("p",{children:x})]},p))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([p,x,m])=>t.jsxs("div",{className:"dssq "+p,children:[t.jsx("b",{children:x}),t.jsx("ul",{children:m.map(b=>t.jsx("li",{children:b},b))})]},p))})]}),t.jsx(Xt,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(Xt,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(Xt,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(Xt,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(Xt,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function fc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d,st:l}=Q(),[s,h]=c.useState({}),[p,x]=c.useState({}),m=25,b=12,f=c.useMemo(()=>{if(l.dossierId){const u=n.find(v=>v.id===l.dossierId)||i.dossiers.find(v=>v.id===l.dossierId);return u?[u]:n.slice(0,m)}return n.slice(0,m)},[n,l.dossierId,i.dossiers]);c.useEffect(()=>{f.length&&No(r,f.map(u=>u.name)).then(h)},[r,f]),c.useEffect(()=>{const u=f.filter(k=>!!k.memoUrl).slice(0,b);if(!u.length){x({});return}let v=!1;const E={};return(async()=>{for(const k of u){if(v)return;try{const j=await xi(k.memoUrl||"");if(v)return;j&&Fp(j.comite)&&(E[k.id]=j.comite,x({...E}))}catch{}}})(),()=>{v=!0}},[f]);const w=i.stats,y=u=>u.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(f.length)}),!l.dossierId&&n.length>m&&t.jsx("span",{className:"mnote dim",children:e.dsCap(m,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),w&&typeof w.screened=="number"&&t.jsxs("p",{children:[y(w.screened)," ",e.funScreened(""),typeof w.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",y(w.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(y(i.marketEstimate)),", ",Math.round(w.screened/i.marketEstimate*100)," %"]})]})]}),f.map(u=>t.jsx(mc,{o:u,qa:s[u.name],comite:p[u.id]},u.id)),!f.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const hc=50;function Gn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Q(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[h,p]=c.useState(""),[x,m]=c.useState(0),[b,f]=c.useState(""),[w,y]=c.useState(!1),[u,v]=c.useState(0),E=c.useRef(null),k=c.useRef(null),j=()=>{v(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>v(S=>S+1),1e3)},N=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};c.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),k.current&&window.clearInterval(k.current)},[]);const C=async S=>{s(!0),p(""),j();const T=await a();if(s(!1),N(),T.ok){d(T);return}if(T.busy){p(o.alertPreviewBusy);return}if(!S){p(o.alertPreviewFail);return}m(hc),N(),E.current=window.setInterval(()=>{m(D=>D>1?D-1:(E.current&&window.clearInterval(E.current),C(!1),0))},1e3)},q=async()=>{if(n||w||l)return;y(!0),f(""),j();const S=await r();y(!1),N(),f(S.ok?o.alertTestOk(S.sentTo||""):S.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||w||x>0,onClick:()=>{C(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||w||l,onClick:()=>{q()},children:w?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(u)]}),w&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(u)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),h&&t.jsx("p",{className:"mnote warn",children:h}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Et="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ke({title:e,icon:a,children:r,wide:n,kind:o,lead:i}){const{dispatch:d}=Q(),l=o==="plug"?"min(720px,100%)":"min(760px,100%)";return Gt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:s=>{s.target===s.currentTarget&&d({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard"+(o?" m-"+o:""),style:n?{width:l}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsxs("div",{className:"mh-txt",children:[t.jsx("h2",{children:e}),i&&t.jsx("p",{className:"mh-lead",children:i})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>d({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function gc(){const{st:e}=Q();switch(e.modal){case"chain":return t.jsx(bc,{});case"space":return t.jsx(vc,{});case"alert":return t.jsx(wc,{});case"queue":return t.jsx(Nc,{});case"export":return t.jsx(Sc,{});case"plug":return t.jsx(Ac,{});case"approach":return t.jsx(qc,{});case"recharge":return t.jsx(Fc,{});case"cover":return t.jsx(Oc,{});case"dossier":return t.jsx(Rc,{});case"crit":return t.jsx(Pc,{});case"tuto":return t.jsx(_c,{});case"rdv":return t.jsx(xc,{});case"memoalert":return t.jsx(Cc,{});default:return null}}function xc(){const{dispatch:e,fund:a,t:r}=Q(),n=a||r.rdvCoFallback;return Gt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Ao,children:zo}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Fa}`,children:Fa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(tl,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function bc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:l,caps:s,memoQueued:h,doAnalyse:p}=Q(),x=i==="client",m=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,f=m[b],w=b>=m.length;return Gt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:w?n.finished:`${b+1} / ${m.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(w?100:b/Math.max(1,m.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:w||!f?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(m.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:f.name}),t.jsx("div",{className:"sub",children:[Yt(f.cc,o)||f.countryLabel,f.sector,f.stage,n.daysAgo(jt(f.date))].filter(Boolean).map(y=>String(y)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:at(f.engine,o)}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{children:Dt(f.amountEur,o)})]}),$e(f)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ct,{o:f,lg:!0})," ",t.jsx(Ga,{o:f,src:!0})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),f.reasoning&&!(x&&Ge(f))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),x&&Ge(f)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Lt(f)==="retenu"?"var(--brand)":Lt(f)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Lt(f)==="retenu"?"✓ "+n.kept:Lt(f)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:f.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!w&&f&&s.pipe&&Fe(f)===1&&!h.has(f.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{p(f),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!w&&f&&!(x&&Ge(f))&&(f.noCo&&f.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{d(f)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(w?{type:"modal",modal:null}:{type:"chainNext"}),children:w?n.closeBtn:n.skip})]})]})})}),document.body)}function vc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Q(),i=o==="client",d=c.useMemo(()=>i?r.filter(x=>Ge(x)):[],[r,i]),l=c.useMemo(()=>Pn(d.filter(x=>Lt(x)==="retenu"),{key:"signal",dir:-1}),[d]),s=c.useMemo(()=>d.filter(x=>Lt(x)==="ecarte"),[d]),h=e.spaceTab==="retenu"?l:s,p=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ke,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:s.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":p},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function wc(){const{mode:e}=Q();return e==="client"||e==="apercu"?t.jsx(yc,{}):t.jsx(jc,{})}function yc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Q(),[i,d]=c.useState("d"),l=o!=="client";return t.jsxs(Ke,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(kc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(Ec,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(yi,{})]})}function kc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[h,p]=c.useState(0);c.useEffect(()=>{let q=!0;return s(!1),mr(a).then(S=>{q&&(S?d(S):s(!0))}),()=>{q=!1}},[a,h]);const x=c.useRef({}),[m,b]=c.useState({}),[f,w]=c.useState(!1),[y,u]=c.useState(!1),v=c.useRef(null);c.useEffect(()=>()=>{v.current&&window.clearTimeout(v.current)},[]);const E=q=>{const S=x.current;Object.keys(S).length&&(w(!0),mr(a,S).then(T=>{if(!T){w(!1),o(e.actErr);return}if(T.throttled&&q<3){v.current=window.setTimeout(()=>E(q+1),5400);return}if(x.current={},b({}),d(T),w(!1),T.throttled){o(e.alertThrottled);return}u(!0),window.setTimeout(()=>u(!1),2e3),n(e.alertSaved)}))},k=q=>{r||(x.current={...x.current,...q},b(S=>({...S,...q})),v.current&&window.clearTimeout(v.current),v.current=window.setTimeout(()=>E(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(q=>q+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...m},N=q=>!j.sections||j.sections.includes(q),C=q=>{const S=j.sections||e.alertSec.map(([T])=>T);k({sections:N(q)?S.filter(T=>T!==q):[...S,q]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,f&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!f&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([q,S])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:N(q),disabled:r,onChange:()=>C(q)}),t.jsxs("span",{children:[S,q==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},q))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Gn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ps(a),onTest:()=>Is(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ec({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[h,p]=c.useState(0);c.useEffect(()=>{let f=!0;return s(!1),fr(a).then(w=>{f&&(w?d(w):s(!0))}),()=>{f=!1}},[a,h]);const x=f=>{r||fr(a,f).then(w=>{if(!w){o(e.actErr);return}d(w),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:m,disabled:r,onChange:f=>x({dow:Number(f.target.value)}),children:e.alertDow.map((f,w)=>t.jsx("option",{value:w,children:f},f))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Gn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Bs(a),onTest:()=>_s(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function yi(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Q(),[d,l]=c.useState(i||""),[s,h]=c.useState(!1),[p,x]=c.useState(!1);c.useEffect(()=>{i&&l(i)},[i]);const m=e.filters,b=c.useMemo(()=>n.filter(u=>$e(u)).length,[n]),f=m.win==="1"?0:m.win==="7"?1:m.win==="30"?2:3,w=async()=>{if(!(!/.+@.+\..+/.test(d)||p)){x(!0);try{await fetch(`${fa}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:m.sector,countries:m.country,source:i?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{x(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[f]],[a.amRows.signal,m.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,m.engine.length?m.engine.map(u=>at(u,r)).join(", "):a.amAllEngines],[a.amRows.sectors,m.sector.length?m.sector.join(", "):a.amAllSectors],[a.amRows.countries,m.country.length?m.country.map(u=>Yt(u,r)||u).join(", "):a.amAllCountries],[a.amRows.stages,m.stage.length?m.stage.join(", "):a.amAllStages]];return s?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([u,v])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:u}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:v}})]},u))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:u=>l(u.target.value),onKeyDown:u=>{u.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function jc(){const{t:e}=Q();return t.jsx(Ke,{title:e.alertTitle,icon:"🔔",children:t.jsx(yi,{})})}function Nc(){var D,B;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:l,dispatch:s,liveMemos:h}=Q(),[p,x]=c.useState(()=>Ka(r)),[m,b]=c.useState(()=>!Ka(r)),[f,w]=c.useState([]),[y,u]=c.useState(0),v=n==="client",E=c.useMemo(()=>{const R=new Map;return o.forEach(O=>{const g=(O.name||"").trim().toLowerCase();g&&!R.has(g)&&R.set(g,O)}),R},[o]);c.useEffect(()=>{let R=!0;return(!Ka(r)||y>0)&&b(!0),(async()=>{const[O,g]=await Promise.all([Dn(r,y>0),qo(a)]);R&&(O&&x(O),b(!1),w(g))})(),()=>{R=!1}},[a,r,y]);const k=m&&!p,j=(p==null?void 0:p.per_day)??0,N=((D=p==null?void 0:p.analyzed_today)==null?void 0:D.length)??0,C=p==null?void 0:p.offre,q=(p==null?void 0:p.pool_meta)||[],S=c.useMemo(()=>{const R=new Map;for(const O of(p==null?void 0:p.scheduled)||[])for(const g of O.names||[])R.has(g)||R.set(g,{label:O.day_label,date:O.date});return R},[p==null?void 0:p.scheduled]),T=(p==null?void 0:p.in_progress)||[];return t.jsxs(Ke,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(N,N+(((B=p==null?void 0:p.pool_order)==null?void 0:B.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(T.length>0||h.items.some(R=>R.status==="boot"||R.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[h.items.filter(R=>R.status==="boot"||R.status==="running"||R.status==="error").map(R=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:R.name}),t.jsx("span",{className:"qd",children:R.memoType||""}),t.jsx(Ra,{item:R,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+R.name)),T.filter(R=>!h.liveOf(R.name)).map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.name}),t.jsxs("span",{className:"qd",children:[R.memo_type||"",R.age_min?` · ${Math.round(R.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:R.state||""})]},"ip-"+R.name))]})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:f.map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.company}),t.jsxs("span",{className:"qd",children:[R.memo_type,typeof R.est_min=="number"?` · ~${R.est_min} min`:""]}),t.jsx("span",{className:"qt",children:R.status}),R.url&&t.jsx("a",{className:"qgo",href:R.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(R.memo_type)}),v&&R.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{cr(a,R.company,"retry").then(()=>u(O=>O+1))},children:e.queueRetry}),v&&R.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{cr(a,R.company,"delete").then(()=>u(O=>O+1))},children:e.queueDelete})]},R.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(q.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&q.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),q.map((R,O)=>{const g=S.get(R.name),L=E.get((R.name||"").trim().toLowerCase()),M=h.liveOf(R.name),J=!!(L&&d.has(L.id))||!!(M&&(M.status==="boot"||M.status==="running")),te=!!(L&&Fe(L)===1&&!L.memoUrl)&&!M;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",O+1]}),g?t.jsx("span",{className:"qwhen"+(g.label==="demain"?" soon":""),children:g.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:R.name}),R.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof R.score=="number"&&t.jsx("span",{className:"qs2",children:R.score}),M&&(M.status==="boot"||M.status==="running")&&t.jsx(Ra,{item:M,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),te&&(l.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>s({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:J,onClick:()=>{i(L),u(z=>z+1)},children:J?e.actAnalyseQueued:e.actAnalyse})),R.excerpt&&t.jsx("span",{className:"qex",children:R.excerpt})]},R.name+":"+O)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([R,O])=>t.jsxs("li",{children:[t.jsx("b",{children:R})," — ",O]},R))})]})}function Sc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=Q(),l=`${Et}/cibles/list.csv?token=${a}`,s=`${Et}/cibles/list.json?token=${a}`,h=`${Et}/cibles/export.xlsx?token=${a}&scope=full`,p=`=IMPORTDATA("${l}")`,x=y=>{var u;(u=navigator.clipboard)==null||u.writeText(y).then(()=>r(e.exportCopied))},m=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:p},{def:e.exportLive,value:s,href:s},{def:e.exportXlsx,value:h,href:h}],b=!o.lockActions&&n.length>0,f=()=>{cc(pc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([u])=>u===y)||["",""])[1]})),r(e.exportViewDone(n.length))},w=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ke,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:w,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:f,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:m.map(({def:y,value:u,href:v})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(u),children:e.exportCopy}),v&&t.jsx("a",{className:"exb",href:v,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Cc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Q(),i=o!=="client",[d,l]=c.useState(null),[s,h]=c.useState(!1),[p,x]=c.useState(0),[m,b]=c.useState(!1);c.useEffect(()=>{let u=!0;return h(!1),dr(a).then(v=>{u&&(v?l(v):h(!0))}),()=>{u=!1}},[a,p]);const f=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},w=u=>{if(i||!d)return;const v={enabled:u.enabled??!!d.enabled,email:u.email??(d.email||""),sections:u.sections??f()};b(!0),dr(a,v).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}l(E),r(e.memoAlertSaved)})};if(s)return t.jsx(Ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(u=>u+1),children:e.retry})]})});if(!d)return t.jsx(Ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=f();return t.jsxs(Ke,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||m,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(zc,{value:d.email||"",readOnly:i||m,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:u=>w({email:u})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([u,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[u],disabled:i||m,onChange:()=>w({sections:{...y,[u]:!y[u]}})}),t.jsx("span",{children:v})]},u))}),t.jsx(Gn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>zs(a,y),onTest:()=>Cs(a,y)})]})}function zc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=c.useState(e);c.useEffect(()=>{d(e)},[e]);const l=i.trim()!==e.trim(),s=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:h=>d(h.target.value),onKeyDown:h=>{h.key==="Enter"&&l&&s&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!s,onClick:()=>o(i.trim()),children:n})]})]})}function Ac(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Q(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[h,p]=c.useState(null),[x,m]=c.useState(!1),[b,f]=c.useState(""),[w,y]=c.useState(0),[u,v]=c.useState("webhook"),[E,k]=c.useState("webhook"),[j,N]=c.useState(""),C=c.useRef(!1);c.useEffect(()=>{let M=!0;return s(!1),pr(a).then(J=>{M&&(J?d({configured:J.configured,url_hint:J.url_hint}):s(!0))}),Ls(a).then(J=>{if(M){if(!J){m(!0);return}m(!1),p(J),C.current||(C.current=!0,J.destination==="instantly"&&(v(te=>te==="webhook"?"instantly":te),k(te=>te==="webhook"?"instantly":te)),J.campaign_id&&N(te=>te||J.campaign_id||""))}}),()=>{M=!1}},[a,w]);const q=(M,J)=>{o&&pr(a,M).then(te=>{if(!te||te.ok===!1){n(e.actErr);return}M.test&&te.sent===!1?n(e.plugTestThrottled):r(J),y(z=>z+1)})},S='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',T=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),D=`curl -X POST ${Et}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,B=`curl -X POST ${Et}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`,R=[{k:"webhook",t:e.plugDestCrm,s:e.plugDestCrmS},{k:"instantly",t:e.plugDestInst,s:e.plugAideInst},{k:"script",t:e.plugDestScript,s:e.plugDestScriptS}],O=E==="instantly"?e.plugStep2Inst:E==="script"?e.plugStep2Script:e.plugStep2Wh,g=E==="instantly"?e.plugAideInst:E==="script"?e.plugAideScript:e.plugAideWh,L=M=>{k(M),M!=="script"&&v(M)};return t.jsxs(Ke,{title:e.plugTitle,icon:"🔌",wide:!0,kind:"plug",lead:e.plugLead,children:[h&&t.jsxs("div",{className:"plugetat"+(h.enabled?" on":""),children:[t.jsx("i",{}),t.jsx("b",{children:h.enabled?e.plugEtatOn:e.plugEtatOff})]}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>y(M=>M+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"1"}),t.jsx("h4",{children:e.plugStep1})]}),t.jsx("div",{className:"plugdests",children:R.map(M=>{const J=E===M.k;return t.jsxs("button",{type:"button",className:"plugdest"+(J?" on":""),onClick:()=>L(M.k),children:[t.jsx("span",{className:"pradio","aria-hidden":"true"}),t.jsx("b",{children:M.t}),t.jsx("em",{children:M.s})]},M.k)})}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"2"}),t.jsx("h4",{children:O})]}),E==="script"?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:D}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(D).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}):E==="instantly"?t.jsx("div",{className:"mfield pill",children:t.jsx("input",{type:"text",maxLength:80,placeholder:e.plugCampPh,value:j,disabled:!o,onChange:M=>N(M.target.value)})}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"mfield pill",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:M=>f(M.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>q({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>q({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>q({remove:!0},e.plugRemoved),children:e.plugRemove})]})]}),t.jsx("p",{className:"mnote dim",children:g}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"3"}),t.jsx("h4",{children:e.plugStep3})]}),t.jsx(Tc,{auto:h,autoKo:x,destKind:u,camp:j,onRetry:()=>y(M=>M+1),onDone:M=>{p(M),m(!1)}}),t.jsx("p",{className:"mnote dim",children:e.plugHow3}),t.jsxs("details",{className:"plugex plugpay",children:[t.jsxs("summary",{children:[t.jsx("b",{children:e.plugExT}),t.jsx("span",{children:e.plugPayloadSub})]}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:T}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(T).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult}),t.jsx("p",{className:"mnote dim",children:e.plugVars})]}),t.jsx("div",{"data-tour":"plug-bulk",children:t.jsx(Lc,{destKind:u,setDestKind:M=>{v(M),k(M)},camp:j,setCamp:N,whHint:i!=null&&i.configured?i.url_hint||"webhook":null})}),E!=="script"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:D}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(D).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:S}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(S).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm","data-tour":"plug-crm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:B}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(B).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function qc(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:l}=Q(),s=c.useMemo(()=>r.find(g=>g.id===n.approachId)||null,[r,n.approachId]),[h,p]=c.useState("email"),[x,m]=c.useState(0),[b,f]=c.useState({}),[w,y]=c.useState(!1),[u,v]=c.useState(""),[E,k]=c.useState({});if(c.useEffect(()=>{!s||b[h]||w||(y(!0),v(""),Ts(a,s.name,h).then(g=>{if(y(!1),!g||g.ok===!1){v((g==null?void 0:g.error)||e.apprFail);return}f(L=>({...L,[h]:g}))}))},[s,h,a]),!s)return null;const j=b[h],N=(j==null?void 0:j.sequence)||[],C=N[x],q=g=>`${h}|${x}|${g}`,S=g=>{const L=q(g);return L in E?E[L]:String(((C==null?void 0:C[g])??"")||"")},T=(g,L)=>k(M=>({...M,[q(g)]:L})),D=q("subject")in E||q("body")in E||q("message")in E,B=S(h==="email"?"body":"message"),R=S("subject"),O=h==="email"&&R?`${R}

${B}`:B;return t.jsxs(Ke,{title:e.apprT(s.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(g=>t.jsx("button",{type:"button",className:"apch"+(h===g?" on":""),"aria-pressed":h===g,onClick:()=>{p(g),m(0)},children:g==="email"?e.apprChEmail:e.apprChLi},g)),t.jsx("span",{className:"sp"}),N.map((g,L)=>t.jsxs("button",{type:"button",className:"apday"+(x===L?" on":""),"aria-pressed":x===L,onClick:()=>m(L),children:[g.day||`J${L}`,[`${h}|${L}|subject`,`${h}|${L}|body`,`${h}|${L}|message`].some(M=>M in E)&&t.jsx("i",{children:"✎"})]},g.day||L))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,j!=null&&j.sender?" · "+e.apprSender(j.sender):""]}),w&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!u&&!w&&t.jsxs("p",{className:"mnote warn",children:[u," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{f(g=>{const L={...g};return delete L[h],L}),v("")},children:e.retry})]}),!w&&!u&&!C&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),C&&t.jsxs(t.Fragment,{children:[h==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:R,onChange:g=>T("subject",g.target.value)})]}),h==="linkedin"&&x===0&&(j==null?void 0:j.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:B,onChange:g=>T(h==="email"?"body":"message",g.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var g;(g=navigator.clipboard)==null||g.writeText(O).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),h==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(s.contactEmail||"")}?subject=${encodeURIComponent(R)}&body=${encodeURIComponent(B)}`,children:e.apprMailto}),D&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Tc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:l,flash:s,flashErr:h,canWrite:p}=Q(),[x,m]=c.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,f=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),w=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,y=()=>{if(x||!p||f)return;m(!0),(b?ur(l,!1):ur(l,!0,r,n.trim()||void 0)).then(v=>{if(m(!1),!v){h(d.actErr);return}o(v),s(v.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!p||!!f,title:f||void 0,onClick:y,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),f===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:f}),w&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function Lc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:l,canWrite:s}=Q(),[h,p]=c.useState("valides"),[x,m]=c.useState(!1),[b,f]=c.useState(null),[w,y]=c.useState(null),[u,v]=c.useState(!1),[E,k]=c.useState(!1),[j,N]=c.useState(null),[C,q]=c.useState(null),S=`atl2:bulk:${d}:${h}:${e}`;c.useEffect(()=>{f(null),y(null),v(!1),N(null);try{const z=localStorage.getItem(S)||localStorage.getItem(`atl2:bulk:${d}:${h}`),$=JSON.parse(z||"null");q($&&Date.now()-Date.parse($.t)<24*3600*1e3?$:null)}catch{q(null)}},[S,h,d]);const T=e==="instantly"&&!r.trim(),D=`${h}|${e}|${r.trim()}`,B=async()=>{if(T||!s)return;m(!0),v(!1),N(null);const z=await Ms(d,h,e,r.trim()||void 0);f(z),y(z.ok?D:null),m(!1)},R=c.useRef(!1);if(!s)return null;const O=async()=>{if(R.current||!s)return;R.current=!0,k(!0);const z=`${d}:${h}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let $;try{$=await Ds(d,h,e,r.trim()||void 0,z)}finally{R.current=!1}if(k(!1),v(!1),N($),$.ok&&($.pushed||0)>0){const I={t:new Date().toISOString(),n:$.pushed||0};q(I);try{localStorage.setItem(S,JSON.stringify(I))}catch{}}};u&&w!==null&&w!==D&&v(!1);const g=o,L=b!=null&&b.ok&&b.ready||0,M=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":g||"",J=!!(b!=null&&b.ok)&&w===D&&L>0&&!!M&&!C,te=C?new Date(C.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:h,onChange:z=>p(z.target.value),children:i.plugBulkTabs.map(([z,$])=>t.jsx("option",{value:z,children:$},z))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:z=>a(z.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:z=>n(z.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||T,onClick:()=>{B()},children:x?"…":i.plugBulkPreview})]}),T&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),C&&t.jsx("p",{className:"mnote",children:i.bulkLocked(te,C.n)}),!C&&!!(b!=null&&b.ok)&&!M&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!C&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),J&&!u&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>v(!0),children:i.bulkArm}),J&&u&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(L,M)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:E,onClick:()=>{O()},children:E?i.bulkSending:i.bulkConfirm(M)}),t.jsx("button",{type:"button",className:"abtn",disabled:E,onClick:()=>v(!1),children:i.bulkCancel})]}),j&&(j.ok?j.replayed?t.jsx("p",{className:"mnote",children:j.pending?i.bulkPending:i.bulkReplayed}):(j.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(j.pushed||0,j.linkedinReady||0,j.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:j.error||i.actErr}))]})}function Fc(){const{t:e,data:a,lang:r}=Q(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const l=window.location.href.split("?")[0];try{const h=await(await fetch(`${fa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(Ke,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("b",{className:"pk-n",children:d.credits}),t.jsx("span",{className:"pk-u",children:e.creditsUnit}),t.jsxs("span",{className:"pk-p",children:[d.price_eur," €"]}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Rc(){const{t:e}=Q();return t.jsx(Ke,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(fc,{})})}function Oc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:l}=Q(),[s,h]=c.useState(null),[p,x]=c.useState(!1);c.useEffect(()=>{let S=!0;if(i)return Dn(i).then(T=>{S&&T&&typeof T.per_day=="number"&&h(T.per_day)}),()=>{S=!1}},[i]);const[m,b]=c.useState(null);c.useEffect(()=>{if(!o)return;let S=!0;return qs(o).then(T=>{S&&b(T)}),()=>{S=!1}},[o]);const f=r.stats,w=typeof(f==null?void 0:f.screened)=="number"?f.screened:n.filter(S=>S.kind==="target"&&Ge(S)).length,y=r.marketEstimate||0,u=y>0?Math.min(100,Math.round(w/y*100)):null,v=(f==null?void 0:f.window_days)||30,E=w>0?w/v:0,k=y>0?Math.max(0,y-w):0,N=y>0&&E>0&&w>=100?Math.round(k/E):null,C=S=>Math.round(S).toLocaleString(a==="en"?"en-US":"fr-FR"),q=S=>{p||!d||(x(!0),To(o,S).then(T=>{if(x(!1),T===null){l(e.actErr);return}h(T),l(e.alertSaved)}))};return t.jsxs(Ke,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(w))}),y>0&&t.jsx("span",{children:e.covOf(C(y))})]}),u!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:u+"%"}}),t.jsxs("em",{children:[u," %"]})]}),N!==null&&t.jsx("p",{className:"mnote",children:e.covEta(N)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(E))}),f&&t.jsxs("div",{className:"covf",children:[typeof f.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(f.kept)})," ",e.covKept]}),typeof f.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(f.analyzed)})," ",e.covAna]}),typeof f.shown=="number"&&f.shown!==f.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(f.shown)})," ",e.funShown]})]}),(m==null?void 0:m.ok)&&(m.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),m.perimetre&&t.jsx("p",{className:"mnote",children:m.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(m.detail||[]).map((S,T)=>t.jsxs("tr",{className:S.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[S.code,S.geo?` · ${S.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof S.n=="number"?C(S.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:S.source}),S.elargi&&t.jsx("em",{children:e.covWide(String(S.demande||""))}),S.erreur&&t.jsx("em",{children:e.covMissing})]})]},T)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(m.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(m.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((m.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(m.sources||[]).join(" · "),m.calcule_le?` — ${e.covComputedAt(m.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(S=>t.jsx("button",{type:"button",className:s===S?"on":"",disabled:p,onClick:()=>q(S),children:S===0?"⏸":S},S))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function ki(e,a,r){const n=await fetch(`${Et}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${Et}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Mc(){const{t:e,token:a,canWrite:r}=Q(),[n,o]=c.useState(null),[i,d]=c.useState(""),[l,s]=c.useState(""),[h,p]=c.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,m=c.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const f=JSON.parse(localStorage.getItem(x)||"null");return!!f&&Date.now()-(f.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(c.useEffect(()=>{if(!r)return;let f=!0;return Rs(a).then(w=>{f&&o(w)}),()=>{f=!1}},[a,r]),!r||h||m||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),ki(a,n.instruction||"","atelier2-avis").then(f=>{if(d(f.applied?"ok":"ko"),f.applied||s(f.encours?e.propSlow:f.reply),f.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:l||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{p(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Dc(){var j;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=Q(),[i,d]=c.useState(!1),[l,s]=c.useState(null),[h,p]=c.useState(!1),[x,m]=c.useState([]),[b,f]=c.useState(null),[w,y]=c.useState([]);if(!r)return null;const u=()=>{d(!0),p(!1),m([]),y([]),Os(a).then(N=>{if(d(!1),!N){p(!0),s(null);return}s(N)})},v=N=>{b||(f(N.title),ki(a,N.instruction,"atelier2-prop").then(C=>{f(null),C.applied?(y(q=>[...q,N.title]),n(e.propApplied)):C.encours?n(e.propSlow):o(C.reply||e.propApplyFail)}))},E=((l==null?void 0:l.proposals)||[]).filter(N=>!x.includes(N.title)&&!w.includes(N.title)),k=((j=l==null?void 0:l.counts)==null?void 0:j.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:u,children:i?e.propWait:e.propBtn}),!i&&h&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!h&&l&&!(l.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:l.reason==="not_enough_signals"?e.propFew(k):e.propNone}),E.map(N=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[N.section]||N.section}),t.jsx("p",{className:"propt",children:N.title}),N.why&&t.jsx("p",{className:"mnote dim",children:N.why}),N.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",N.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>v(N),children:b===N.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>m(C=>[...C,N.title]),children:e.propSkip})]})]},N.title))]})}function Ic(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=Q(),[l,s]=c.useState(null),[h,p]=c.useState(!1),[x,m]=c.useState(!1),[b,f]=c.useState(""),[w,y]=c.useState(""),[u,v]=c.useState(!1),E=c.useRef(!1);if(c.useEffect(()=>{if(!a||!r)return;let N=!0;return Fs(a).then(C=>{N&&(p(!0),!(!C||E.current)&&(s(C),f(C.fit),y(C.note)))}),()=>{N=!1}},[a,r]),!r)return null;const k=()=>{if(!(!b||u)){if(l&&l.fit===b&&l.note===w.trim()){m(!1);return}v(!0),yt(a,"thesis_fit",b,w.trim(),"",d.email||"").then(N=>{if(v(!1),!N.ok){o(e.fitKo);return}s({fit:b,note:w.trim(),ts:new Date().toISOString()}),m(!1),n(e.fitSaved)})}},j=N=>N==="yes"?e.fitYes:N==="partial"?e.fitPartial:e.fitNo;if(l&&!x){const N=new Date(String(l.ts||"")),C=Number.isNaN(N.getTime())?"":N.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:j(l.fit)}),l.note?` — ${l.note}`:""]}),!!C&&t.jsx("p",{className:"mnote dim",children:C}),t.jsx("button",{type:"button",className:"lk",onClick:()=>m(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(N=>t.jsx("button",{type:"button","aria-pressed":b===N,className:"fitopt"+(b===N?" on":""),onClick:()=>{E.current=!0,f(N)},children:j(N)},N))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:w,onChange:N=>{E.current=!0,y(N.target.value)},onKeyDown:N=>{N.key==="Enter"&&k()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||u,onClick:k,children:u?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!h&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function Pc(){var u,v,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:l}=Q(),s=n==="client",h=c.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[p,x]=c.useState(""),[m,b]=c.useState(""),[f,w]=c.useState(!1),y=async()=>{const k=p.trim();if(!(!k||f||!s)){w(!0),b("");try{const N=await(await fetch(`${Et}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(N.reply&&b(String(N.reply)),N.job_id){b(e.critChatRunning);const C=async()=>{const q=await fetch(`${Et}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:N.job_id})}).then(S=>S.json()).catch(()=>null);if(q&&q.done){b(String(q.reply||q.clarification||q.summary||"✓")),w(!1),q.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),x("");return}x("")}finally{m.startsWith("⏳")||w(!1)}}};return t.jsxs(Ke,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((u=i.points)!=null&&u.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((v=i==null?void 0:i.angles)!=null&&v.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,N;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((N=k.out)!=null&&N.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},k.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsx(Ic,{}),t.jsx(Mc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:p,disabled:!s||f,onChange:k=>x(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!s||f||!p.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),m&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:m})]}),t.jsx(Dc,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(As,{fund:d,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(bi[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function _c(){const{t:e,dispatch:a,startTour:r}=Q(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Ke,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const Ei="atl2:mapfold",Bc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Ei);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},$c=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},ji=c.createContext(null),Q=()=>{const e=c.useContext(ji);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ct({o:e,lg:a}){const{lang:r}=Q(),n=$e(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:hr(n,r),children:[n.emoji," ",hr(n,r)]}):null}function Ga({o:e,src:a}){const{lang:r,t:n}=Q(),o=$e(e);if(!o)return null;const i=Ys(o),d=Qs(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(So(o,r))+" · "+n.win7(Co(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,s)=>t.jsx("i",{className:s<i?"on":""},s))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Uc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Ue(a);if(o)return e.find(i=>Ue(i.name)===o)||e.find(i=>{const d=Ue(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Hc(){const{scoped:e,t:a,st:r,dispatch:n}=Q(),o=c.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(x=>!We(x)),l=d.length,s=d.filter(x=>!x.noCo).length,h=d.filter(x=>!!x.noCo).length,p=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:p?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",s," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",h," ",a.zoomPulseExplore]})]})]})}function Vc(){var x;const{t:e,lang:a,data:r,dispatch:n,scopedAll:o,counts:i}=Q(),d=m=>m.toLocaleString(a==="en"?"en-US":"fr-FR"),s=o.filter(m=>!We(m)).length,h=typeof((x=r.stats)==null?void 0:x.screened)=="number"?r.stats.screened:0;if(s<=0&&h<=0)return null;const p=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:d(s)}),t.jsx("span",{children:p>0?e.covOf(d(p)):e.covScreened("").trim()}),t.jsxs("ul",{children:[t.jsxs("li",{children:["✅ ",d(i[1]||0)," ",e.covKept]}),t.jsxs("li",{children:["⚡ ",d(i[2]||0)," ",e.covAna]})]})]})}const Wc=[0,1,2,3,5,10];async function Gc(e,a){const r=window.location.href.split("?")[0],o=await(await fetch(`${fa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,lookup_key:a,success_url:r+"?credits=ok",cancel_url:r+"?credits=cancel"})})).json();o.url&&(window.location.href=o.url)}function Yc(){var T,D;const{t:e,token:a,fund:r,mode:n,dispatch:o,flash:i,flashErr:d,data:l}=Q(),[s,h]=c.useState(null),[p,x]=c.useState(!0),[m,b]=c.useState([]),[f,w]=c.useState(!1),[y,u]=c.useState(null),v=n==="client",E=l.credits,k=!!E&&!E.unlimited;c.useEffect(()=>{if(!a||!r)return;let B=!0;return x(!0),(async()=>{const[R,O]=await Promise.all([Dn(r),qo(a)]);B&&(R&&h(R),x(!1),b(O))})(),()=>{B=!1}},[a,r]);const j=(s==null?void 0:s.per_day)??null,N=((T=s==null?void 0:s.pool_order)==null?void 0:T.length)??0,C=m.filter(B=>B.status==="running").length,q=B=>{!v||f||!a||(w(!0),To(a,B).then(R=>{if(w(!1),R===null){d(e.actErr);return}h(O=>O&&{...O,per_day:R}),i(e.alertSaved)}))},S=B=>{!l.email||y||(u(B),Gc(l.email,B).catch(()=>d(e.actErr)).finally(()=>u(null)))};return t.jsxs("div",{className:"map-pulse map-engine",children:[t.jsxs("button",{type:"button",className:"map-engine-hit",title:e.queueTitle,onClick:()=>o({type:"modal",modal:"queue"}),children:[t.jsx("em",{children:e.identEngine}),t.jsx("b",{children:j===null?"—":j}),t.jsx("span",{children:e.identPerDay}),t.jsxs("ul",{children:[j===0&&t.jsx("li",{children:t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause})}),C>0&&t.jsxs("li",{children:["⏳ ",C]}),t.jsx("li",{children:p?e.identPendingWait:e.identPending(N)})]})]}),j!==null&&t.jsxs("div",{className:"map-engine-rate covrb",role:"group","aria-label":e.covRate,children:[Wc.map(B=>t.jsx("button",{type:"button",className:j===B?"on":"",disabled:!v||f,title:B===0?e.identPauseTitle:e.covRateNow(B),onClick:()=>q(B),children:B===0?"⏸":B},B)),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:()=>o({type:"modal",modal:"memoalert"}),children:"🔔"})]}),k&&E&&t.jsxs("div",{className:"map-engine-credits",children:[t.jsx("em",{children:e.creditsCap}),t.jsxs("b",{children:[E.total_available,t.jsxs("span",{children:[" / ",E.daily_grant+E.purchased]})]}),t.jsx("span",{children:e.creditsToday}),t.jsx("p",{children:e.creditsTrialHint(E.daily_grant)}),!!((D=E.packs)!=null&&D.length)&&t.jsx("div",{className:"map-engine-packs",role:"group","aria-label":e.creditsPacksLbl,children:E.packs.map(B=>t.jsxs("button",{type:"button",disabled:!!y||!l.email,title:`${B.credits} ${e.creditsUnit} — ${B.price_eur} €`,onClick:()=>S(B.lookup_key),children:[t.jsx("strong",{children:B.credits}),t.jsxs("i",{children:[B.price_eur," €"]})]},B.lookup_key))})]})]})}function Ni({o:e}){const{lang:a}=Q(),r=Gs(e.cc),n=e.cc?Yt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:16,height:16,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Qc=!1;function Kc(){const[e,a]=c.useState(!1);return c.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Si=e=>`atl2:tour:${e||"anon"}`;function Jc(e){try{return localStorage.getItem(Si(e))==="1"}catch{return!0}}function ho(e){try{localStorage.setItem(Si(e),"1")}catch{}}function Xc(e,a,r,n,o,i,d,l){const s=e.tourT,h=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .map-pulse",title:s.cover,body:e.fhintCover,need:".atl2 .map-hud"}:null,{sel:".atl2 .map-engine",title:s.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:h[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:h[1][0]},{sel:".atl2 .dmulti.ddeals",title:s.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:s.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:s.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:s.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:s.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:s.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-bulk"]',need:".atl2 .ic[data-tour=plug]",title:s.campout,body:e.fhintCampout,modal:"plug"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-crm"]',need:".atl2 .ic[data-tour=plug]",title:s.addcrm,body:e.fhintAddcrm,modal:"plug"}:null,...[2,4,5].filter(p=>(l[p]||0)>0).map(p=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:p===2?s.tabAna:p===4?s.tabValid:s.tabRej,body:p===2?e.fhintTabAna:p===4?e.fhintTabValid:e.fhintTabRej,ptab:p})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:s.rank,body:e.fhintRank},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:s.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:h[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:h[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:s.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:s.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:s.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function nu({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Qn;const{lang:d}=$s(),l=Il(e,d,a),s=c.useMemo(()=>({...Nl[d],...jl(d,l.thesisMode)}),[d,l.thesisMode]),[h,p]=c.useReducer(Bl,void 0,()=>Pl((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?$c():Bc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=c.useRef(!0);c.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Ei,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e,a]),c.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const A=()=>{window.innerWidth<=760&&p({type:"mapFold",folded:!0})};return A(),window.addEventListener("resize",A),()=>window.removeEventListener("resize",A)},[a]);const m=c.useRef(i);m.current=i,c.useEffect(()=>{var A;(A=m.current)==null||A.call(m,h.filters)},[h.filters]);const[b,f]=c.useState(()=>{if(typeof window>"u")return"both";try{const A=localStorage.getItem("atl2:chrome-mode");if(A==="eval"||A==="filt"||A==="both")return A;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[w,y]=c.useState(null),[u,v]=c.useState(null),[E,k]=c.useState(null),[j,N]=c.useState({kept:0,dropped:0}),[C,q]=c.useState(!1),[S,T]=c.useState(""),[D,B]=c.useState(!1),[R,O]=c.useState(null),[g,L]=c.useState(null),[M,J]=c.useState(!1),[te,z]=c.useState(!1),[,$]=c.useState(0),I=()=>$(A=>A+1),V=c.useRef([]),U=c.useRef(new Set),ue=c.useRef(new Set),[ae,de]=c.useState([]),[xe,me]=c.useState([]),[we,be]=c.useState(0),Ne=c.useRef(new Map),Re=c.useRef(null),{mode:ne}=l,ke=c.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),ve=ke.pipe,oe=l.session.token||"",_=ne==="client"&&!e;c.useEffect(()=>{if(!oe||!ve)return;let A=!0;const Y=async()=>{const ge=await Ks(oe);!A||!ge||(me(ge.runs),be(Date.now()/1e3-ge.now),de(De=>De.filter(qe=>!ge.runs.some(He=>Ue(He.company)===Ue(qe.name)))))};Y();const H=ae.length>0||xe.some(ge=>ge.status==="running"),se=window.setInterval(()=>{Y()},H?8e3:25e3);return()=>{A=!1,window.clearInterval(se)}},[oe,ve,ae.length,xe.some(A=>A.status==="running")]),c.useEffect(()=>{if(!oe||!ve||!_)return;let A=!0;const Y=async()=>{const se=await Js(oe);if(!A||!se.length)return;const ge=new Map;se.forEach(De=>{const qe=String(De.ceo_status||"").trim();qe&&De.check_id&&ge.set(String(De.check_id),qe)}),l.patchStatuses(ge,De=>Date.now()-(ze.current.get(De)||0)>9e4)};Y();const H=window.setInterval(()=>{Y()},6e4);return()=>{A=!1,window.clearInterval(H)}},[oe,ve,_]);const W=c.useMemo(()=>{const A=[],Y=new Set;for(const H of ae){const se=Ue(H.name);!se||Y.has(se)||(Y.add(se),A.push({name:H.name,id:H.id,status:"boot",started:H.started,estMin:H.estMin,memoType:"instant"}))}for(const H of xe){const se=Ue(H.company);if(!se||Y.has(se))continue;Y.add(se);const ge=H.status==="error"?"error":H.status==="done"?"done":"running";A.push({name:H.company,status:ge,started:H.started||0,estMin:H.est_min||(H.memo_type==="detailed"?40:15),url:H.url,error:H.error,memoType:H.memo_type,note:H.note})}return A},[ae,xe]),ee=A=>W.find(Y=>Ue(Y.name)===Ue(A))||null,le=(A,Y)=>{de(H=>H.some(se=>Ue(se.name)===Ue(A.name))?H:[...H,{name:A.name,id:A.id,started:Date.now()/1e3,estMin:Y==="detailed"?40:15}]),U.current.add(A.id),I()},pe=(A,Y=!1)=>{T(A),B(Y),Re.current&&clearTimeout(Re.current),Re.current=setTimeout(()=>T(""),Y?4200:2400)},re=A=>pe(A,!0),ie=c.useMemo(()=>{const A=new Map;return l.dossiers.forEach(Y=>{Y.id&&A.set(Y.id,Y)}),A},[l.dossiers]),fe=c.useMemo(()=>l.dossiers.filter(A=>sa(A,h,ve)),[l.dossiers,h,ve]),ye=c.useRef(!1);c.useEffect(()=>{if(ye.current||l.loading||!l.dossiers.length)return;if(e&&!l.session.token){ye.current=!0;return}if(!ke.showFunnel||Jc(l.session.token||"")){ye.current=!0;return}ye.current=!0;const A=window.setTimeout(()=>{ho(l.session.token||""),J(!0)},700);return()=>window.clearTimeout(A)},[e,l.loading,l.dossiers.length,ke.showFunnel,l.session.token]);const Ce=c.useMemo(()=>l.dossiers.filter(A=>$l(A,h,ve,l.favIds)),[l.dossiers,h,ve,l.favIds]),je=c.useMemo(()=>Us(fe.filter(A=>!Xe(A)),l.favIds),[fe,l.favIds]),Ee=c.useRef(!1);c.useEffect(()=>{if(Ee.current)return;if(!ve||a==="ops"){Ee.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Ee.current=!0;return}if(l.loading)return;Ee.current=!0;const A=Hs(je);A!==h.ptab&&p({type:"ptab",tab:A})},[ve,a,n==null?void 0:n.ptab,l.loading,je,h.ptab]);const gt=c.useMemo(()=>{const A=Ho(l.dossiers);return A?jt(A)===0?s.tourToday:Vo(A,d):s.tourNoRun},[l.dossiers,s,d]),xt=c.useMemo(()=>l.dossiers.some(A=>!!A.memoUrl||!!A.summary||Ut(A)),[l.dossiers]),[Me,dt]=c.useState(!1);c.useEffect(()=>{if(l.loading){dt(!1);return}if(l.dossiers.length>0||l.error){dt(!0);return}const A=window.setTimeout(()=>dt(!0),6e3);return()=>window.clearTimeout(A)},[l.loading,l.dossiers.length,l.error]);const nt=(l.marketEstimate||0)>0||typeof((Qn=l.stats)==null?void 0:Qn.screened)=="number"&&l.stats.screened>0,At=c.useMemo(()=>[1,0,2,4,5,3].find(A=>(je[A]||0)>0)??0,[je]),rt=On.find(A=>A.key===h.continent),qt=h.continent==="monde"?s.contWorld:(d==="fr"?rt==null?void 0:rt.fr:rt==null?void 0:rt.en)||"";c.useEffect(()=>{const A=Y=>{var se;const H=(((se=Y.detail)==null?void 0:se.name)||"").trim();H&&bt(null,H)};return window.addEventListener("ppmap:evaluate",A),()=>window.removeEventListener("ppmap:evaluate",A)}),c.useEffect(()=>{const A=Y=>{const H=Y.detail||{},se=String(H.id||"").trim(),ge=String(H.name||"").trim(),De=String(H.url||"").trim(),qe=se&&ie.get(se)||Uc(l.dossiers,ge,De);if(qe){if(v(null),sa(qe,h,ve)||(h.continent!=="monde"&&qe.continent!==h.continent&&p({type:"continent",key:qe.continent||"monde"}),p({type:"reset"})),ve&&qe.kind!=="op"){const mt=Fe(qe);typeof mt=="number"&&mt!==h.ptab&&p({type:"ptab",tab:mt})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),p({type:"focus",id:qe.id}),(qe.noCo||["media","nominations","recrutements"].includes(qe.engine||""))&&(qe.url||qe.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:qe.url||"",text:[qe.headline,qe.tagline].filter(Boolean).join(`
`)}})):qe.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:qe.name,url:qe.url||"",website:qe.website||"",domain:qe.domain||""}}));return}!ge&&!De||(p({type:"focus",id:se||null}),v({name:ge,headline:String(H.text||"").trim()||ge,url:De,card:H.card}),De&&(Oa(ge)||!ge)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:De,text:String(H.text||"").trim()}})):ge&&!Oa(ge)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ge}})))};return window.addEventListener("ppmap:focus",A),()=>window.removeEventListener("ppmap:focus",A)}),c.useEffect(()=>{const A=se=>{const ge={},De=String((se==null?void 0:se.sector)||"").trim();De&&(ge.sector=[De]);const qe=String((se==null?void 0:se.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(qe)&&(ge.day=qe);const He=String((se==null?void 0:se.search)||"").trim();He&&(ge.search=He);const mt=String((se==null?void 0:se.dealKind)||"").trim();(mt==="ma"||mt==="levee"||mt==="other")&&(ge.dealKind=[mt]),Object.keys(ge).length&&p({type:"filters",patch:ge})},Y=se=>A(se.detail),H=se=>{se.data&&se.data.type==="pp-filter"&&A(se.data)};return window.addEventListener("ppmap:filter",Y),window.addEventListener("message",H),()=>{window.removeEventListener("ppmap:filter",Y),window.removeEventListener("message",H)}},[]),c.useEffect(()=>{const A=Y=>{var ge;const H=(((ge=Y.detail)==null?void 0:ge.name)||"").trim().toLowerCase();if(!H)return;const se=l.dossiers.find(De=>(De.name||"").trim().toLowerCase()===H);se&&p(a==="ops"?{type:"focus",id:se.id}:{type:"popup",id:se.id})};return window.addEventListener("ppmap:similar",A),()=>window.removeEventListener("ppmap:similar",A)});const bt=(A,Y,H)=>{const se=(H||(A==null?void 0:A.name)||Y||"").trim();if(!_){k({kicker:se});return}!se||C||(q(!0),(async()=>{try{let ge=(Y||se).trim();const De=((A==null?void 0:A.website)||(A==null?void 0:A.domain)||"").trim();if(!(/^https?:\/\//i.test(ge)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(ge)&&!/\s/.test(ge)))if(De)ge=De;else try{const _e=await Mn(se);if(_e!=null&&_e.website)ge=_e.website;else if(((_e==null?void 0:_e.candidates)||[]).length===1)ge=_e.candidates[0].url;else if(((_e==null?void 0:_e.candidates)||[]).length>1){V.current=[{name:se,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(_e.candidates||[]).slice(0,5)},...V.current].slice(0,8),I();return}}catch{}const He=await ko(oe,ge,"atelier2"),mt={name:He.company||se,verdict:He.verdict,reason:He.reason||"",remaining:He.remaining??null};V.current=[mt,...V.current].slice(0,8),He.verdict==="kept"&&N(_e=>({..._e,kept:_e.kept+1})),He.verdict==="ruled_out"&&N(_e=>({..._e,dropped:_e.dropped+1}));const Kt=A||l.dossiers.find(_e=>(_e.name||"").toLowerCase()===se.toLowerCase());Kt&&(He.verdict==="kept"?Kt.verdict=Kt.verdict||"MATCH":He.verdict==="ruled_out"&&(Kt.verdict="NO MATCH"),He.reason&&(Kt.reasoning=He.reason)),I()}finally{q(!1)}})())},Pt=A=>{if(!_){k({kicker:A.name});return}le(A,"instant"),yt(oe,"fast_request",A.name||"",""),pe(s.memoInstantSent(A.name))},_t=A=>Ne.current.get(A.id)??l.thumbs.get((A.name||"").trim().toLowerCase()),Be=(A,Y)=>p({type:"undoPush",entry:{id:A.id,name:A.name,prevCeoStatus:Y}}),Ze=async(A,Y,H)=>{const se=A.ceoStatus||"";ze.current.set(A.id,Date.now()),A.ceoStatus=Y,I();const ge=await Ja(oe,{status:Y,airtable_id:A.airtableId,check_id:A.checkId,company:A.name,...(H==null?void 0:H.note)!==void 0?{note:H.note}:{},...H!=null&&H.via?{via:H.via}:{}});return ge.ok?ge.skipped?(A.ceoStatus=se,I(),re(s.actNotPersisted),!1):((H==null?void 0:H.undo)!==!1&&Be(A,se),H!=null&&H.msg&&pe(H.msg),(Y==="Validé"||Y==="Écarté")&&!A.ceoNote&&(H==null?void 0:H.note)===void 0&&O({o:A,yes:Y==="Validé"}),!0):(A.ceoStatus=se,I(),re(s.actErr),!1)},Ye=async(A,Y)=>{const H=await Ja(oe,{status:A.ceoStatus||"Retenu",airtable_id:A.airtableId,check_id:A.checkId,company:A.name,note:Y,via:"note"});return!H.ok||H.skipped?(re(H.skipped?s.actNotPersisted:s.actErr),!1):(A.ceoNote=Y,I(),!0)},ut=c.useRef(new Map),F=A=>ut.current.has(A.id)?ut.current.get(A.id):l.stages.get((A.name||"").trim().toLowerCase()),G=(A,Y)=>{ut.current.set(A.id,Y),I()},X=(A,Y)=>{_&&Ze(A,Y?"Validé":"Écarté",{msg:Y?s.decidedYes(A.name):s.decidedNo(A.name)})},P=A=>{_&&Ze(A,"À trancher",{msg:s.promoted(A.name)})},Z=A=>{_&&(async()=>{const Y=A.ceoStatus||"";A.ceoStatus="Retenu",I();const H=await Ja(oe,{status:"Retenu",check_id:A.checkId,company:A.name});if(!H.ok||H.skipped){A.ceoStatus=Y,I(),re(H.skipped?s.actNotPersisted:s.actErr);return}Be(A,Y),pe(s.repeched(A.name))})()},K=()=>{const A=h.undo[h.undo.length-1];if(!A){pe(s.undoNone);return}const Y=ie.get(A.id);if(!Y){p({type:"undoPop"}),pe(s.undoNone);return}let H=A.prevCeoStatus;if(!H)if((Y.verdict||"").toUpperCase().includes("CALL"))H="À trancher";else{pe(s.undoLockedTitle);return}(async()=>await Ze(Y,H,{undo:!1})&&(p({type:"undoPop"}),Y.ceoStatus=A.prevCeoStatus,I(),pe(s.undoDone(Y.name))))()},ce=A=>{_&&(ue.current.add(A.id),I(),p({type:"approachOpen",id:A.id}),yt(oe,"approach",A.name||"","","",l.email||""))},ze=c.useRef(new Map),he=c.useRef(!1),[Le,Ae]=c.useState(0);c.useEffect(()=>{if(!oe||e||!_||he.current)return;he.current=!0;const A=new Date().toISOString().slice(0,10),Y=l.email||"",H=`cbv_${oe}_${Y}_${A}`,se=`atl2:vue:${oe}:${A}`;try{if(localStorage.getItem(H)||localStorage.getItem(se))return}catch{}yt(oe,"view","","","",Y).then(ge=>{if(!ge.ok){he.current=!1;return}try{localStorage.setItem(H,"1")}catch{}})},[oe,e,_,l.email]),c.useEffect(()=>{if(!oe||!ve||e||!_||!l.generatedAt)return;let A=!0;const Y=()=>{document.hidden||Xs(oe,l.generatedAt||"").then(se=>{A&&Ae(se)})};Y();const H=window.setInterval(Y,6e4);return()=>{A=!1,window.clearInterval(H)}},[oe,ve,e,l.generatedAt]);const Je=(A,Y)=>{_&&(async()=>{if(!(await yt(oe,Y?"yes":"no",A.name||"",(A.ceoNote||"").slice(0,400),A.sector||"",l.email||"")).ok){re(s.actErr);return}Ne.current.set(A.id,Y?"yes":"no"),I(),pe(Y?s.thumbUpDone:s.thumbDnDone),L({o:A,up:Y})})()},vt=A=>{!_||!Ut(A)||(le(A,"detailed"),yt(oe,"detailed_request",A.name||"","","",l.email||""),pe(s.memoDeepSent(A.name)))},et=A=>{!_||!A.memoUrl||window.confirm(s.memoRegenAsk(A.name))&&(le(A,"detailed"),yt(oe,"detailed_regen",A.name||"","","",l.email||""),pe(s.memoDeepSent(A.name)))},Ci=A=>{const Y=new Set(l.favIds),H=Y.has(A.id);H?Y.delete(A.id):Y.add(A.id),l.setFavIds(Y),_&&Zs(oe,{id:A.id,co:A.name},H)},zi=()=>{!_||te||window.confirm(s.identSyncConfirm)&&(z(!0),(async()=>{const A=await el(oe);z(!1),A?pe(s.identSyncDone):re(s.actErr)})())},Yn=/proplace/i.test(l.fund||""),Ai=A=>{!_||!Yn||(yt(oe,"onboard_request",A.name||"",""),pe(s.onboardSent(A.name)))},qi={st:h,dispatch:p,t:s,lang:d,mode:ne,caps:ke,pipe:ve,token:oe,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:Z,thumbOf:_t,canWrite:_,commitStatus:Ze,saveNote:Ye,stageOf:F,setStage:G,flashErr:re,startTour:()=>J(!0),dossiers:l.dossiers,scopedAll:fe,scoped:Ce,counts:je,byId:ie,contName:qt,favIds:l.favIds,toggleFav:Ci,askEvaluate:bt,doAnalyse:Pt,doDecide:X,doPromote:P,doApproach:ce,doThumb:Je,doDeep:vt,doRegen:et,doUndo:K,doSync:zi,doOnboard:Ai,outbound:Yn,memoQueued:U.current,liveMemos:{items:W,serverOff:we,liveOf:ee},approachDone:ue.current,sessTally:j,evalCards:V.current,evalBusy:C,markRow:y,markedId:w,flash:pe,focusExtra:u};c.useEffect(()=>{const A=Y=>{Y.key==="Escape"&&(p({type:"popup",id:null}),p({type:"modal",modal:null}),p({type:"openFacet",facet:null}))};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[]);const Ti=A=>oe?t.jsx(Vl,{token:oe,children:A}):t.jsx(t.Fragment,{children:A});return t.jsx(ji.Provider,{value:qi,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(oe?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:ql}),Ti(t.jsxs("div",{className:"app"+(ve?" pipe":"")+(oe?" has-thesis":""),children:[ke.showTicker&&t.jsx(pt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(oe?" live-stack--cibles":""),children:[t.jsx(Xl,{}),!!oe&&t.jsx(Wl,{})]})}),ke.showIdent&&t.jsx(pt,{name:"identite",children:t.jsx(ld,{})}),!1,Qc,ke.showFunnel&&t.jsx(pt,{name:"entonnoir",children:t.jsx(Zc,{})}),t.jsx(pt,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(ci,{variant:h.mapFolded?"compact":"tabs"}),t.jsxs("div",{className:"stage"+(h.mapFolded?" folded":""),id:"atl2-stage",children:[!h.mapFolded&&a==="ops"&&t.jsx(Hc,{}),!h.mapFolded&&a!=="ops"&&(ke.showFunnel||ke.showIdent)&&t.jsxs("div",{className:"map-hud",children:[ke.showFunnel&&t.jsx(Vc,{}),ke.showIdent&&t.jsx(Yc,{})]}),!h.mapFolded&&t.jsx(ip,{}),t.jsx(pi,{compact:!!h.mapFolded})]})]})}),ke.showDemand&&ve&&t.jsx(pt,{name:"direct",children:t.jsx(ol,{items:W,serverOff:we,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>p({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([A,Y])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===A,onClick:()=>{f(A);try{localStorage.setItem("atl2:chrome-mode",A)}catch{}},children:Y},A))}),ke.showDemand&&t.jsx(pt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(bp,{})})}),ke.showDemand&&h.memoConsole&&t.jsx(pt,{name:"console",children:t.jsx(wp,{})}),ke.pipe&&!!oe&&t.jsx(pt,{name:"moteurs",children:t.jsx(bl,{})}),Le>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:s.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Ae(0),l.refresh()},children:s.freshGo})]}),t.jsx(pt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(lc,{})}),ke.pipe&&!!oe&&t.jsx("p",{className:"privnote",children:s.privLink}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),h.popupId&&h.dens!=="liste"&&a!=="ops"&&t.jsx(pt,{name:"fiche",children:t.jsx(Vp,{})}),t.jsx(pt,{name:"modales",children:t.jsx(gc,{})}),t.jsx(Vs,{}),g&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:g.o.name}),t.jsx(Ar,{placeholder:g.up?s.thumbWhyUpPh:s.thumbWhyDnPh,onDone:A=>{const Y=g.o;L(null),A&&yt(oe,"note",Y.name||"",A,Y.sector||"",l.email||"").then(H=>{H.ok&&pe(s.csNoteSaved)})}})]}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(Ar,{placeholder:R.yes?s.whyYesPh:s.whyNoPh,onDone:A=>{const Y=R.o;O(null),A&&Ye(Y,A).then(H=>{H&&pe(s.csNoteSaved)})}})]}),M&&Me&&t.jsx(id,{steps:Xc(s,gt,xt,At,nt,je[3]||0,je[4]||0,je),onClose:()=>{J(!1),ho(oe)}}),t.jsx(Kc,{}),ke.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:Ao,children:zo}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Fa}`,children:Fa})]}),t.jsx("button",{type:"button",onClick:()=>p({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),S&&t.jsx("div",{className:"flash on"+(D?" err":""),children:S}),E&&t.jsx(Ws,{variant:"acquirer",initialCompany:go().co,initialWebsite:go().site,onClose:()=>k(null)})]})})}function Zc(){const{t:e}=Q(),[a,r]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function go(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function eu(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Ni as FlagCell,Ct as SigBadge,Ga as SigWin,nu as default,eu as fmtShort,Q as useV2};
