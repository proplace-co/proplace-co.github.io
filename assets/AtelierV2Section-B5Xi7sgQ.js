...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,_o=Bo+Uo;function da(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Vo(){const e=da("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ho(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Vo();return r==="0"?"client":r==="1"||da("embed")==="1"&&da("chrome")==="1"?"apercu":"client"}const Wo={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Yo=e=>Wo[e];function Go(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const He=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Dn(a)||Go(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Hr(e.cc)})};function Xt(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ko=60*60*1e3;function Qo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ko?null:a}catch{return null}}function Ct(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Jo=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Xo(e,a,r="default"){const n=r!=="default",o=x.useMemo(()=>e||n?{mode:"anon"}:Fr(),[e,n]),i=x.useMemo(()=>n?"visiteur":Ho(e,o),[e,o,n]),l=x.useMemo(()=>Yo(i),[i]),s=i!=="visiteur",p=Jo(r),[h,d]=x.useState([]),[m,u]=x.useState(""),[b,c]=x.useState(null),[g,v]=x.useState(null),[f,y]=x.useState(null),[j,w]=x.useState(()=>new Map),[A,C]=x.useState(()=>new Map),[z,R]=x.useState(""),[E,q]=x.useState(new Set),[M,B]=x.useState(null),[H,k]=x.useState(!0),[N,L]=x.useState(!1),[V,G]=x.useState(0),[X,T]=x.useState(0),O=x.useRef(0),$=x.useMemo(()=>{var D;if(i!=="client")return"";try{return((D=Pr())==null?void 0:D.email)||""}catch{return""}},[i]);x.useEffect(()=>{const D=++O.current;let U=!0;const Y=()=>U&&D===O.current,J=(s&&o.token?o.token:"pub:"+a)+(p?":"+p:""),re=Qo(J);return re?(d(re.objs.map(He)),re.fund&&u(re.fund),c(re.marketEstimate??null),v(re.criteria??null),y(re.stats??null),R(re.generatedAt||""),k(!1)):k(!0),(async()=>{try{if(r==="ops"){const fe=await Kt(),pe=((fe==null?void 0:fe.recent_ops)||[]).map(K=>{const ee=Qt(K.company_name||K.title?K:{...K,title:(K.headline_fr||K.headline||"").slice(0,120)},a),xe=String(K.rubrique||"").toLowerCase();return ee&&(xe==="nominations"||xe==="recrutements")&&(ee.engine=xe),ee&&!String(K.company_name||"").trim()&&(ee.noCo=!0),ee}).filter(K=>!!K).map(K=>(Dn((K.name||"").trim())||(K.noCo=!0),K));try{const K=await Dr(),ee=Ir(K),xe=((K==null?void 0:K.date)||"").slice(0,10);if(ee.length&&xe){const Z=new Set;for(const se of pe){if(se.noCo||(se.date||"").slice(0,10)!==xe)continue;const te=$a(ee,Z,se.name,"");te>=0&&(Z.add(te),se.decryptHtml=ee[te].html)}for(const se of pe){if(se.decryptHtml||(se.date||"").slice(0,10)!==xe)continue;const te=$a(ee,Z,"",se.headline||se.tagline||se.name);te>=0&&(Z.add(te),se.decryptHtml=ee[te].html)}}}catch{}if(!Y())return;d(pe.map(He)),Ct(J,{objs:pe})}else if(typeof r=="object"){const pe=(await Ba()||[]).filter(ee=>(ee.slug||"")===r.research).map(ee=>Ua(ee,a)).filter(ee=>!!ee),K=Xt(await _a(pe,a));if(!Y())return;d(K.map(He)),Ct(J,{objs:K})}else if(s&&o.token){const fe=$r(o.token),pe=Kt(),K=Br(o.token),ee=Ur(o.token),xe=_r(o.token),Z=await fe;let se=Z?Z.targets:[];Y()&&Z&&(u(Z.fund||""),c(Z.marketEstimate??null),v(Z.criteria??null),y(Z.stats??null),R(Z.generatedAt||""),d(se.map(He)),k(!1),L(!1));const[te,Se,he,be]=await Promise.all([pe,K,ee,xe]),et=((te==null?void 0:te.recent_ops)||[]).map(Ae=>Qt(Ae,a)).filter(Ae=>!!Ae);if(se=[...se,...et],!Y())return;d(se.map(He));const tt=new Set;for(const Ae of Se){const ze=(Ae.id||Ae.co||"").toString().trim().toLowerCase();ze&&tt.add(ze.startsWith("t:")?ze:"t:"+ze)}q(tt),w(he),C(be),Z&&Ct(J,{fund:Z.fund,marketEstimate:Z.marketEstimate,criteria:Z.criteria,stats:Z.stats,generatedAt:Z.generatedAt,objs:se})}else{const fe=Vr(),pe=Ba(),K=Kt(),ee=await fe;Y()&&ee.length&&(d(Xt(ee).map(He)),k(!1),L(!1));const[xe,Z]=await Promise.all([pe,K]),se=(xe||[]).map(be=>Ua(be,a)).filter(be=>!!be),te=await _a(se,a),Se=((Z==null?void 0:Z.recent_ops)||[]).map(be=>Qt(be,a)).filter(be=>!!be),he=Xt([...ee,...te,...Se]);if(!Y())return;d(he.map(He)),Ct(J,{objs:he})}Y()&&L(!1)}catch{Y()&&!re&&L(!0)}finally{Y()&&k(!1)}})(),()=>{U=!1}},[s,o.token,a,V,p]),x.useEffect(()=>{if(!l.showCredits||!$){B(null);return}let D=!0;return(async()=>{try{const U=await fetch(`${Ca}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:$})});if(!U.ok)return;const Y=await U.json();D&&Y&&Y.ok!==!1&&B(Y)}catch{}})(),()=>{D=!1}},[l.showCredits,$,X]);const P=x.useCallback(D=>q(new Set(D)),[]);return{session:o,mode:i,caps:l,fund:m,email:$,marketEstimate:b,generatedAt:z,criteria:g,stats:f,thumbs:j,stages:A,dossiers:h,favIds:E,setFavIds:P,credits:M,reloadCredits:()=>T(D=>D+1),loading:H,error:N,refresh:()=>G(D=>D+1)}}const Vn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Zo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Vn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function ei(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Vn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Hn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Hn=40;function Ta(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ge(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ea(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(Ve(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ye(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(o))return!1}return!0}function Wn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ta(e,a.filters,r)}function ti(e,a,r,n){return!(!Wn(e,a,r)||r&&!Wr(e,a.ptab,n))}function La(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-Ve(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"signal":{const i=ge(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),s=n(i);return l<s?-a.dir:l>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const ai=["ma","levees","nominations","recrutements","actualites"],ni=300,Zt=7,ri={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Yn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},oi=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Xa(e){const a=ge(e);if(a)return"sig:"+(a.theme&&Yn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function ii(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:l}=F(),s=l==="en",[p,h]=x.useState("all"),[d,m]=x.useState(!1),u=x.useMemo(()=>{const E=(a.filters.day||"").slice(0,10),q=k=>!(!i&&a.continent!=="monde"&&k.continent!==a.continent||E&&(k.date||"").slice(0,10)!==E),M=e.filter(k=>q(k)&&ge(k)),B=e.filter(k=>q(k)&&k.kind==="op"&&!ge(k)&&(E?!0:Ve(k.date)<=Zt)),H=E||new Date().toISOString().slice(0,10);return B.sort((k,N)=>{const L=(k.date||"").slice(0,10)===H?0:1,V=(N.date||"").slice(0,10)===H?0:1;return L!==V?L-V:(N.amountEur||0)-(k.amountEur||0)}),[...La(M,{key:"signal",dir:-1}),...B]},[e,a.continent,a.filters.day,i]),b=x.useMemo(()=>{const E={};for(const q of u){const M=Xa(q);E[M]=(E[M]||0)+1}return E},[u]),c=x.useMemo(()=>p==="all"?u:u.filter(E=>Xa(E)===p),[u,p]),g=x.useMemo(()=>c.slice(0,ni),[c]),v=c.length-g.length,f=E=>E==="all"?u.length:b[E]||0,y=E=>E==="all"?s?"All":"Tout":E.startsWith("sig:")?Yn[s?"en":"fr"][E.slice(4)]||"🔔":ri[s?"en":"fr"][E],j=[{k:"all"}],w=ai.filter(E=>f(E)>0||E===p);if(w.length){j.push({g:s?"DEALS":"OPÉRATIONS"});for(const E of w)j.push({k:E})}const A=oi.map(E=>"sig:"+E).filter(E=>f(E)>0||E===p);if(A.length){j.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const E of A)j.push({k:E})}const C=E=>{try{return new Date(E+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return E}},z=(()=>{const E=(a.filters.day||"").slice(0,10),q=!i&&a.continent!=="monde"&&o?s?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return E?(s?`LIVE covers the events of ${C(E)}.`:`Le LIVE regroupe les événements du ${C(E)}.`)+q:(s?`LIVE covers the still-open signals and the deals of the last ${Zt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Zt} derniers jours.`)+q})(),R=E=>g.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ee(q)?" spent":""),onClick:M=>{const B=M.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:B.left+B.width/2,y:B.bottom}})},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(Je,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(Nr,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:$l(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Wt,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},E+(q.id||q.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},E+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:E=>{E.currentTarget.contains(E.relatedTarget)||m(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":d,onClick:()=>m(E=>!E),children:[y(p),t.jsx("b",{children:f(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!d,children:[t.jsx("span",{className:"tkfilscope",children:z}),j.map(E=>"g"in E?t.jsx("span",{className:"tkfilg",children:E.g},E.g):t.jsxs("button",{type:"button","aria-pressed":E.k===p,onClick:()=>{h(E.k),m(!1)},children:[y(E.k),t.jsx("b",{children:f(E.k)})]},E.k))]})]}),t.jsx("div",{className:"win",children:g.length?t.jsxs("div",{className:"run",children:[R(0),R(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})})]})}const si="aDx8z7Hzksus",Gn="+33 6 83 10 72 86",Za="alexandre@proplace.co",li=`tel:${Gn.replace(/[^\d+]/g,"")}`,en="pp-rdv-slot";function di(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ci(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:ui}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:li,children:Gn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Za}`,children:Za})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([o,i],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Po,{filloutId:si,parameters:r?{company_name:r}:void 0})})]})}function pi(){const[e,a]=x.useState(()=>typeof document>"u"?null:document.getElementById(en));return x.useEffect(()=>{e||a(document.getElementById(en))},[e]),e?lt.createPortal(t.jsx(ci,{}),e):null}const ui=`
...
`)}),y(!0))},[]);x.useEffect(()=>{if(!G)return;O(0);const I=window.setInterval(()=>O(ae=>ae+1),1e3);return()=>window.clearInterval(I)},[G]);const et=()=>{const I=g.trim();I&&(o(null,I),v(""))},tt=async()=>{if(!b){o(null,te[0]||"");return}if(!te.length||A)return;C(!0),M.current=!1;const I=[];for(let ae=0;ae<te.length&&!M.current;ae++){R(e.evaluating(ae+1,te.length,te[ae]));const oe=await Bn(r,te[ae],"atelier2");if(I.unshift({name:oe.company||te[ae],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),q([...I]),oe.verdict==="quota"){I.unshift({name:"",verdict:"quota",reason:e.quota(te.length-ae-1),remaining:0}),q([...I]),w(te.slice(ae+1).join(`
`)),R(""),C(!1);return}}R(""),w(M.current?te.slice(I.length).join(`
`):""),C(!1)},Ae=async()=>{var oe,ye,_e;if(Z.current)return;const I=k.trim().replace(/\s+/g,""),ae=L.trim();if(!I&&!ae){P(e.rsNeed);return}if(!b&&!c){o(null,I||ae.slice(0,80));return}Z.current=!0,P(""),U(null),J(null),X(!0);try{const je=await ro({url:I,text:ae,email:n,cbToken:c});if(X(!1),!je||je.status!=="success"){P((je==null?void 0:je.message)||"Erreur");return}U(je),H(!1),be((((oe=je.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(Te=>(Te==null?void 0:Te.name)||"")),J({state:"pending"});const le=await oo(je,{email:n,cbToken:c});J(le.ok?{state:"ok",scopeLabel:((ye=le.summary)==null?void 0:ye.scope_label)||"",scope:((_e=le.summary)==null?void 0:_e.scope)||""}:{state:"fail",msg:le.error||""}),le.ok&&xe(Te=>Te+1)}finally{Z.current=!1,X(!1)}},ze=[D==null?void 0:D.industry,...(D==null?void 0:D.market_tags)||[],D==null?void 0:D.author].map(I=>(I||"").trim()).filter(Boolean),at=(Y==null?void 0:Y.state)==="pending",ct=Y&&(at?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Y.state==="ok"?t.jsx("span",{className:"rslink ok",children:Y.scope&&Y.scope!=="public"?e.rsSavedIn(Y.scopeLabel||Y.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Y.msg,children:e.rsSaveFail})),Yt=zs(D).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:g,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:I=>v(I.target.value),onKeyDown:I=>{I.key==="Enter"&&et()}}),t.jsx("span",{className:"detect"+(zn.test(g.trim())?" url":""),children:se})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:et,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),h.showCredits&&he&&t.jsxs("button",{type:"button",className:"credits"+(he.total_available<=0&&!he.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:he.unlimited?"∞":he.total_available}),!he.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",he.daily_grant+he.purchased]}),he.total_available<=0&&!he.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(B?" on":""),onClick:()=>H(!B),children:e.rsOpen}),pe!==null&&pe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>fe(!re),children:e.rsArchOpen(pe)})]}),re&&t.jsx(Rs,{bump:ee,cbToken:c,onClose:()=>fe(!1),onEvaluate:I=>o(null,I),onAddAll:be}),B&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:k,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:I=>N(I.target.value),onKeyDown:I=>{I.key==="Enter"&&Ae()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:L,placeholder:e.rsTextPh,onChange:I=>V(I.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(G?" loading":""),style:{justifyContent:"center"},disabled:G||at||!k.trim()&&!L.trim(),onClick:()=>{Ae()},children:[t.jsx("span",{className:"fill"}),G?`${no(k.trim())==="youtube"&&k.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(T)}`:at?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),$&&t.jsx("div",{className:"rserr",children:$}),D&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:D.title}),D.source_url&&t.jsx("a",{href:D.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{U(null),J(null)},children:"×"})]}),D.market&&t.jsx("p",{className:"rsmk",children:D.market}),ze.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),ze.map(I=>t.jsx("span",{children:I},I))]}),t.jsxs("div",{className:"rsbody",children:[D.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${D.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:xr(D.summary_md||"").map((I,ae)=>t.jsx("p",{children:I},ae))})]}),t.jsx(hr,{card:D,onEvaluate:I=>o(null,I),onAddAll:be}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Yt)}),ct]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:j,placeholder:e.bulkPh,onChange:I=>w(I.target.value.split(`
`).slice(0,15).join(`
