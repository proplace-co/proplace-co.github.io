...
`,ol=tl+al+nl+rl;function pn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function il(){const e=pn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function sl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=il();return r==="0"?"client":r==="1"||pn("embed")==="1"&&pn("chrome")==="1"?"apercu":"client"}const ll={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},dl=e=>ll[e];function Aa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const At=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!io(a)||Aa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Li(e.cc)})};function Ya(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const pl=60*60*1e3;function cl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>pl?null:a}catch{return null}}function ma(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ul=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function ml(e,a,r="default"){const n=r!=="default",o=c.useMemo(()=>e||n?{mode:"anon"}:wi(),[e,n]),i=c.useMemo(()=>n?"visiteur":sl(e,o),[e,o,n]),d=c.useMemo(()=>dl(i),[i]),s=i!=="visiteur",l=ul(r),[g,p]=c.useState([]),[x,u]=c.useState(""),[b,m]=c.useState(null),[y,k]=c.useState(null),[f,v]=c.useState(null),[j,w]=c.useState(()=>new Map),[N,E]=c.useState(()=>new Map),[S,T]=c.useState(""),[q,D]=c.useState(new Set),[O,H]=c.useState(null),[F,M]=c.useState(!0),[h,A]=c.useState(!1),[U,ee]=c.useState(0),[z,I]=c.useState(0),R=c.useRef(0),_=c.useMemo(()=>{var X;if(i!=="client")return"";try{return((X=ki())==null?void 0:X.email)||""}catch{return""}},[i]);c.useEffect(()=>{const X=++R.current;let be=!0;const te=()=>be&&X===R.current,pe=(s&&o.token?o.token:"pub:"+a)+(l?":"+l:""),me=cl(pe);return me?(p(me.objs.map(At)),me.fund&&u(me.fund),m(me.marketEstimate??null),k(me.criteria??null),v(me.stats??null),T(me.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(r==="ops"){const ge=await Ha(),B=((ge==null?void 0:ge.recent_ops)||[]).map(Q=>{const W=ka(Q.company_name||Q.title?Q:{...Q,title:(Q.headline_fr||Q.headline||"").slice(0,120)},a),re=String(Q.rubrique||"").toLowerCase();return W&&(re==="nominations"||re==="recrutements")&&(W.engine=re),W&&!String(Q.company_name||"").trim()&&(W.noCo=!0),W}).filter(Q=>!!Q).map(Q=>(io((Q.name||"").trim())||(Q.noCo=!0),Q));try{const Q=ji(),W=await Ei(),re=((W==null?void 0:W.date)||"").slice(0,10),$=Q?Q.doc:W,se=Ni($),le=((Q==null?void 0:Q.day)||($==null?void 0:$.date)||re||"").slice(0,10);if(le&&se.length){const oe=new Set;for(const ce of B){if((ce.date||"").slice(0,10)!==le)continue;const de=Gn(se,oe,ce.name,"");de>=0&&(oe.add(de),ce.decryptHtml=se[de].html)}for(const ce of B){if(ce.decryptHtml||(ce.date||"").slice(0,10)!==le)continue;const de=Gn(se,oe,"",ce.headline||ce.tagline||ce.name);de>=0&&(oe.add(de),ce.decryptHtml=se[de].html)}}if(le){const oe=(($==null?void 0:$.title_fr)||"").trim(),ce=(($==null?void 0:$.lead_fr)||"").trim(),de=Si($),xe=(($==null?void 0:$.url)||"").trim();oe&&(de||xe)&&B.unshift({id:`edito:${le}`,kind:"op",name:oe,cc:null,date:le,engine:"edito",dealKind:"other",headline:oe,tagline:ce||oe,decryptHtml:de||void 0,url:xe,noCo:!0})}}catch{}if(!te())return;p(B.map(At)),ma(pe,{objs:B})}else if(typeof r=="object"){const B=(await Yn()||[]).filter(W=>(W.slug||"")===r.research).map(W=>Qn(W,a)).filter(W=>!!W),Q=Ya(await Kn(B,a));if(!te())return;p(Q.map(At)),ma(pe,{objs:Q})}else if(s&&o.token){const ge=Ci(o.token),B=Ha(),Q=zi(o.token),W=Ai(o.token),re=qi(o.token),$=await ge;let se=$?$.targets:[];te()&&$&&(u($.fund||""),m($.marketEstimate??null),k($.criteria??null),v($.stats??null),T($.generatedAt||""),p(se.map(At)),M(!1),A(!1));const[le,oe,ce,de]=await Promise.all([B,Q,W,re]),xe=((le==null?void 0:le.recent_ops)||[]).map(Se=>ka(Se,a)).filter(Se=>!!Se),Re=new Set(se.map(Se=>Se.id));if(se=[...se,...xe.filter(Se=>!Re.has(Se.id)&&(Re.add(Se.id),!0))],!te())return;p(se.map(At));const ye=new Set;for(const Se of oe){const Ce=(Se.id||Se.co||"").toString().trim().toLowerCase();Ce&&ye.add(Ce.startsWith("t:")?Ce:"t:"+Ce)}D(ye),w(ce),E(de),$&&ma(pe,{fund:$.fund,marketEstimate:$.marketEstimate,criteria:$.criteria,stats:$.stats,generatedAt:$.generatedAt,objs:se})}else{const ge=Ti(),B=Yn(),Q=Ha(),W=await ge;te()&&W.length&&(p(Ya(W).map(At)),M(!1),A(!1));const[re,$]=await Promise.all([B,Q]),se=(re||[]).map(de=>Qn(de,a)).filter(de=>!!de),le=await Kn(se,a),oe=(($==null?void 0:$.recent_ops)||[]).map(de=>ka(de,a)).filter(de=>!!de),ce=Ya([...W,...le,...oe]);if(!te())return;p(ce.map(At)),ma(pe,{objs:ce})}te()&&A(!1)}catch{te()&&!me&&A(!0)}finally{te()&&M(!1)}})(),()=>{be=!1}},[s,o.token,a,U,l]),c.useEffect(()=>{if(!d.showCredits||!_){H(null);return}let X=!0;return(async()=>{try{const be=await fetch(`${Ba}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:_})});if(!be.ok)return;const te=await be.json();X&&te&&te.ok!==!1&&H(te)}catch{}})(),()=>{X=!1}},[d.showCredits,_,z]);const J=c.useCallback(X=>D(new Set(X)),[]);return{session:o,mode:i,caps:d,fund:x,email:_,marketEstimate:b,generatedAt:S,criteria:y,thesisMode:String((y==null?void 0:y.mode)||""),stats:f,thumbs:j,stages:N,dossiers:g,patchStatuses:(X,be)=>{p(te=>{let pe=!1;const me=te.map(ge=>{if(!ge.checkId)return ge;const B=X.get(ge.checkId);return!B||B===(ge.ceoStatus||"")||!be(ge.id)?ge:(pe=!0,{...ge,ceoStatus:B})});return pe?me:te})},favIds:q,setFavIds:J,credits:O,reloadCredits:()=>I(X=>X+1),loading:F,error:h,refresh:()=>ee(X=>X+1)}}function Qe(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ja=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function qa(e){return ja.has(e.engine||"")}function Ye(e){return!!e.noCo||qa(e)&&!!e.url}const vo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),fl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...vo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,memoTab:0,undo:[],mapFolded:a}),hl=new Set(["signal","amount","score","crible","memo"]);function gl(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:vo(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:hl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??yo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const yo=80;function Ta(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Ie(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(zn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(wt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&qt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(lo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function na(e,a,r){return Qe(e)?Ta(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ta(e,a.filters,r)}function xl(e,a,r,n){return!(!na(e,a,r)||r&&!so(e,a.ptab,n))}function Ln(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-wt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Fi(o)||null;case"memo":return Ri(o)||null;case"signal":{const i=Ie(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),s=n(i);return d===null||s===null?d===s?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<s?-a.dir:d>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const Qa={},mr=(Qa==null?void 0:Qa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function fr(){return new Date().toISOString().slice(0,10)}const Rn=c.createContext(null);function wo(){return c.useContext(Rn)}function bl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(l=>l.remove()),s.querySelectorAll("*").forEach(l=>{const g=l.tagName==="A"?l.getAttribute("href"):null;[...l.attributes].forEach(p=>l.removeAttribute(p.name)),g&&/^https?:\/\//i.test(g)&&(l.setAttribute("href",g),l.setAttribute("target","_blank"),l.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:s.outerHTML})}}catch{}return a}function vl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),l=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!s&&!l&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function hr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function gr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function ko(){const e=c.useContext(Rn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function yl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=K(),[i,d]=c.useState(()=>n.filters.day||fr()),[s,l]=c.useState(null),[g,p]=c.useState(!1),x=c.useCallback(y=>{if(/^\d{4}-\d{2}-\d{2}$/.test(y)){d(y);try{r({type:"filters",patch:{day:y,win:"all"}})}catch{}}},[r]),u=c.useCallback(()=>{d(fr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);c.useEffect(()=>{const y=k=>{var v;const f=(v=k.detail)==null?void 0:v.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",y),()=>window.removeEventListener("pp-edition-day",y)},[x]),c.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),c.useEffect(()=>{if(!e||!i)return;let y=!1;p(!0);const k=new URLSearchParams({token:e,date:i});return fetch(`${mr}/cibles/edition.json?${k}`).then(f=>f.json()).then(f=>{y||l(f)}).catch(()=>{y||l({ok:!1,error:"network"})}).finally(()=>{y||p(!1)}),()=>{y=!0}},[e,i]);const b=c.useMemo(()=>`${mr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=c.useMemo(()=>({token:e,day:i,ed:s,loading:g,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,g,x,u,n.filters.day,b,o]);return t.jsx(Rn.Provider,{value:m,children:a})}function wl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=ko(),[o,i]=c.useState(()=>n||po());return c.useEffect(()=>{n&&i(!0)},[n]),c.useEffect(()=>{const d=s=>{var l;return i(!!((l=s.detail)!=null&&l.open))};return window.addEventListener(Sa,d),()=>window.removeEventListener(Sa,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Oi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function kl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function xr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function br(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function jl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=ko(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!d,l=a&&!a.ok,g=c.useRef(null),[p,x]=c.useState("fonds"),[u,b]=c.useState(null),[m,y]=c.useState("idle"),k=c.useRef(!1);c.useEffect(()=>{b(null),y("idle"),k.current=!1,x("fonds")},[e]),c.useEffect(()=>{if(p!=="jour"||k.current)return;k.current=!0;let N=!0;return y("load"),kl(e).then(E=>{N&&(b(E),y("fait"))}),()=>{N=!1}},[p,e]);const f=c.useMemo(()=>vl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),v=c.useRef(null);c.useEffect(()=>{const N=v.current;if(!N||!f)return;let E=!1;return sn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(E||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{E=!0}},[f]);const j=c.useMemo(()=>hr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),w=c.useMemo(()=>hr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return c.useEffect(()=>{const N=g.current;if(!N||!j)return;let E=!1;return sn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(E||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{E=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const N=(a==null?void 0:a.date)||e,E=/^(\d{4})-(\d{2})-(\d{2})/.exec(N);return E?i?`${E[2]}/${E[3]}/${E[1]}`:`${E[3]}/${E[2]}/${E[1]}`:N})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":p==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":p==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),p==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),p==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p==="fonds"&&l&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),p==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?xr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:gr(e,!0)}),"."]}):xr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:gr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),p==="fonds"&&d&&j?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,p==="fonds"&&d&&w?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:w}}):null,p==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:v,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:br(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:br(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const El=300,fa=7,Nl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},jo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Sl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ka(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Pi(r)&&r!=="media")return"news:"+r;const n=Ie(e);return n?"sig:"+(n.theme&&jo.fr[n.theme]?n.theme:"other"):"actualites"}function Cl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:s}=K(),l=wo(),g=d==="en",[p,x]=c.useState("all"),[u,b]=c.useState(!1),m=c.useMemo(()=>{var be;const h=(a.filters.day||"").slice(0,10),A=te=>!(!i&&a.continent!=="monde"&&te.continent!==a.continent||h&&(te.date||"").slice(0,10)!==h),U=e.filter(te=>A(te)&&Ie(te)&&(!i||te.kind!=="target"||Ne(te)!==5)),ee=i&&(((be=l==null?void 0:l.ed)==null?void 0:be.ops)||[]).length?l.ed.ops.map(te=>ka(te,d)).filter(te=>!!te).map(te=>(te.briefOnly=!0,te)).filter(te=>!h||(te.date||"").slice(0,10)===h):[],z=e.filter(te=>A(te)&&te.kind==="op"&&(h?!0:wt(te.date)<=fa)),I=i?ee.length?ee:z.filter(te=>{const pe=(s||"").trim().toLowerCase();if(!pe)return!1;const me=te.match||null;return me?Object.keys(me).map(ge=>ge.trim().toLowerCase()).includes(pe):!1}):z,R=h||new Date().toISOString().slice(0,10),_=te=>{const pe=Ka(te);return pe==="ma"?0:pe==="levees"?1:2};I.sort((te,pe)=>{const me=_(te)-_(pe);if(me)return me;const ge=(te.date||"").slice(0,10)===R?0:1,B=(pe.date||"").slice(0,10)===R?0:1;return ge!==B?ge-B:(pe.amountEur||0)-(te.amountEur||0)});const J=new Set,X=[];for(const te of[...I,...Ln(U,{key:"signal",dir:-1})]){const pe=te.id||te.name;!pe||J.has(pe)||(J.add(pe),X.push(te))}return i&&X.length===0?e.filter(pe=>A(pe)&&wt(pe.date)<=fa).sort((pe,me)=>(me.date||"").localeCompare(pe.date||"")).slice(0,80):X},[e,a.continent,a.filters.day,i,s,d,l]),y=c.useMemo(()=>{const h={};for(const A of m){const U=Ka(A);h[U]=(h[U]||0)+1}return h},[m]),k=c.useMemo(()=>p==="all"?m:m.filter(h=>Ka(h)===p),[m,p]),f=c.useMemo(()=>k.slice(0,El),[k]),v=k.length-f.length,j=c.useRef(null);c.useEffect(()=>{var I,R;const h=j.current;if(!h)return;const A=()=>{const _=h.scrollWidth;_<200||(h.style.animationDuration=Math.max(18,Math.round(_/130))+"s")};A();const U=requestAnimationFrame(A),ee=window.setTimeout(A,1200);let z=!0;return(R=(I=document.fonts)==null?void 0:I.ready)==null||R.then(()=>{z&&A()}),()=>{z=!1,cancelAnimationFrame(U),window.clearTimeout(ee)}},[f.length,p]);const w=h=>h==="all"?m.length:y[h]||0,N=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return jo[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const A=h.slice(5);return Di[A]?Ii(A,g?"en":"fr"):h}return Nl[g?"en":"fr"][h]},E=[{k:"all"}],S=["ma","levees"].filter(h=>w(h)>0||h===p);if(S.length){E.push({g:g?"Deals":"Opérations"});for(const h of S)E.push({k:h})}const T=["nominations","recrutements"].filter(h=>w(h)>0||h===p),q=Mi.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>w(h)>0||h===p),D=w("actualites")>0||p==="actualites"?["actualites"]:[];if(T.length||q.length||D.length){E.push({g:g?"News":"Actualités"});for(const h of T)E.push({k:h});for(const h of q)E.push({k:h});for(const h of D)E.push({k:h})}const O=Sl.map(h=>"sig:"+h).filter(h=>w(h)>0||h===p);if(O.length){E.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of O)E.push({k:h})}const H=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},F=(()=>{const h=(a.filters.day||"").slice(0,10),A=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(g?`LIVE covers the events of ${H(h)}.`:`Le LIVE regroupe les événements du ${H(h)}.`)+A:(g?`LIVE covers the still-open signals and the deals of the last ${fa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${fa} derniers jours.`)+A})(),M=h=>f.map(A=>t.jsxs("button",{type:"button",className:"tk"+(_e(A)?" spent":""),onClick:U=>{const ee=A.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:ee?"":A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(ee||n({type:"focus",id:A.id}),a.dens!=="liste"){const z=U.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:z.left+z.width/2,y:z.bottom}})}},title:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(Et,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(ii,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:mc(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx($a,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(A.id||A.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(h=>!h),children:[N(p),t.jsx("b",{children:w(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:F}),E.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===p,onClick:()=>{x(h.k),b(!1)},children:[N(h.k),t.jsx("b",{children:w(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:j,children:[M(0),M(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!l&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!l&&t.jsx(Al,{isEn:g})]})}const zl=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Al({isEn:e}){const[a,r]=c.useState(()=>po());c.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Sa,o),()=>window.removeEventListener(Sa,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>_i(!a),children:zl})}const Fn="+33 6 83 10 72 86",La="alexandre@proplace.co",Eo=`tel:${Fn.replace(/[^\d+]/g,"")}`;function ql(){return null}class it extends c.Component{constructor(){super(...arguments);Hn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const No=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function vr(e,a){if((Nt(e)||"").startsWith("CALL")&&Ne(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ne(e)>=2;return No.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const yr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",Tl={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function Ll({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=K(),[s,l]=c.useState(""),[g,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null);if(c.useEffect(()=>{if(!x)return;const v=j=>{b.current&&!b.current.contains(j.target)&&(u(!1),p(!1))};return document.addEventListener("click",v,!0),()=>document.removeEventListener("click",v,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),y=async v=>{if(s)return;if(v==="Analysé"&&!e.memoUrl){p(!0);return}l(v);const j=(vr(e,a).find(([N])=>N===v)||[v,v])[1],w=await o(e,v,{msg:a.csMoved(e.name,j)});l(""),w&&(p(!1),u(!1))},k=vr(e,a),f=v=>(k.find(([j])=>j===v)||[])[1]||v;return k.length===2?t.jsx("span",{className:"rstat rst2",onClick:v=>v.stopPropagation(),children:k.map(([v,j])=>t.jsx("button",{type:"button",className:"rsd "+(v==="Validé"?"yes":"no")+(s===v?" busy":""),disabled:!!s,onClick:()=>{y(v)},children:j},v))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:v=>v.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!s,title:a.csLabel,className:"rsel rs-"+yr(m),onClick:()=>{u(v=>!v),p(!1)},children:s?f(s)+"…":m?f(m):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:k.map(([v,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===v,className:"rsopt"+(m===v?" on":"")+(s===v?" busy":""),disabled:!!s,onClick:()=>{if(v===m){u(!1);return}y(v)},children:[t.jsx("i",{className:"pt2",style:{background:Tl[yr(v)]}}),j]},v))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),p(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const v=await o(e,"Analysé");l(""),v&&(p(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function Rl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=K(),[i,d]=c.useState(""),[s,l]=c.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),p=(Nt(e)||"").startsWith("CALL")&&Ne(e)===3,x=Ne(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(m);const y=await o(e,m);d(""),y&&(l(!0),setTimeout(()=>l(!1),2200))},b=p?[["Validé",a.csYes],["Écarté",a.csNo]]:No.filter(([m])=>!(x&&m==="Retenu")).map(([m,y])=>[m,a[y]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,y])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:y},m)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Fl,{o:e})]})}function Fl({o:e}){const{t:a,saveNote:r,flash:n}=K(),[o,i]=c.useState(e.ceoNote||""),[d,s]=c.useState(!1),[l,g]=c.useState(!1),p=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!p)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!p,onClick:()=>{x()},children:l?a.csNoteSaved:a.csNoteOk})]})}function wr({placeholder:e,onDone:a}){const{t:r}=K(),[n,o]=c.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Ol({o:e}){var k;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:s}=K(),[l,g]=c.useState(!1);if(!n.pipe||!o||n.lockActions||Ne(e)!==4)return null;const p=i(e),x=(p==null?void 0:p.stage)||"todo",u=async f=>{if(l||f===x)return;g(!0);const v=p;d(e,{stage:f,stamps:(p==null?void 0:p.stamps)||{}});const j=Math.max(Date.now(),kr+=1);kr=j;const w=await Bi(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(d(e,v),s(a.actErr)))},b=(k=p==null?void 0:p.stamps)==null?void 0:k.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,y=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,v])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:l,onClick:()=>{u(f)},children:v},f)),y&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let kr=0;const Qt=8,kt=360;function jr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Er({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(jr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(jr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function Ml({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=K(),[d,s]=c.useState(0),[l,g]=c.useState(null),[p,x]=c.useState([]),u=c.useRef(!1),b=c.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=c.useRef(!1);c.useEffect(()=>{const S=b.current;return()=>{m.current||(n({type:"ptab",tab:S.ptab}),n({type:"dens",dens:S.dens}),n({type:"modal",modal:S.modal}))}},[]),c.useEffect(()=>{u.current||(u.current=!0,x(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const y=p[d],k=d>=p.length;c.useEffect(()=>{if(y&&(y.ptab!==void 0&&i.ptab!==y.ptab&&n({type:"ptab",tab:y.ptab}),y.dens&&i.dens!==y.dens&&n({type:"dens",dens:y.dens}),i.modal!==(y.modal??null)&&n({type:"modal",modal:y.modal??null}),y.click)){const S=y.click,T=window.setTimeout(()=>{const q=document.querySelector(S);q&&q.getAttribute("aria-selected")!=="true"&&q.click()},60);return()=>window.clearTimeout(T)}},[d,y]);const f=c.useRef(-1),v=c.useCallback(()=>{if(!y){g(null);return}const S=D=>{if(!D)return null;for(const O of document.querySelectorAll(D)){const H=O.getBoundingClientRect();if(H.width>1&&H.height>1)return O}return null},T=S(y.sel)||S(y.need);if(!T){g(null);return}f.current!==d&&(f.current=d,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const q=T.getBoundingClientRect();g(D=>D&&Math.abs(D.top-q.top)<1&&Math.abs(D.left-q.left)<1&&Math.abs(D.width-q.width)<1&&Math.abs(D.height-q.height)<1?D:q)},[y,d]);c.useLayoutEffect(()=>{v();const S=[90,300,700,1300].map(D=>window.setTimeout(v,D)),T=window.setInterval(v,400),q=()=>v();return window.addEventListener("scroll",q,!0),window.addEventListener("resize",q),()=>{S.forEach(D=>window.clearTimeout(D)),window.clearInterval(T),window.removeEventListener("scroll",q,!0),window.removeEventListener("resize",q)}},[v]);const j=c.useRef(a);if(j.current=a,c.useEffect(()=>{const S=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),j.current()):T.key==="ArrowRight"?s(q=>q+1):T.key==="ArrowLeft"&&s(q=>Math.max(0,q-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!p.length)return null;let w=null;const N=S=>()=>{m.current=!0,n({type:"modal",modal:null}),S()};if(k){const S=o[3]||0;S>0?w={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?w={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?w={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let E={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:kt};if(!k&&l){const S=l.bottom+14,T=window.innerHeight-S;let q=T>190?S:Math.max(12,l.top-200),D=Math.min(Math.max(12,l.left+l.width/2-kt/2),window.innerWidth-kt-12);T<=190&&l.top<212&&(window.innerWidth-l.right>=kt+40?D=Math.min(l.right+26,window.innerWidth-kt-12):l.left>=kt+40&&(D=Math.max(12,l.left-kt-26)),q=Math.max(12,l.top-Qt)),E={left:D,top:q,width:kt}}return Vt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!k&&l&&t.jsx("div",{className:"tour-hole",style:{left:l.left-Qt,top:l.top-Qt,width:l.width+Qt*2,height:l.height+Qt*2}}),(k||!l)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(k?" fin":""),style:E,children:[k&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(Er,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(p.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,p.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/p.length*100+"%"}})})]}),t.jsx("h3",{children:y==null?void 0:y.title}),t.jsx(Er,{text:(y==null?void 0:y.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>s(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(S=>S+1),children:d===p.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function So(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Co(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Dl(){var T,q;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:s,dispatch:l}=K(),g=r?a:e,p=c.useMemo(()=>g.filter(D=>wt(D.date)===0&&D.kind==="target"),[g]),x=c.useMemo(()=>r?a.filter(D=>D.kind==="target"&&Ne(D)===0).slice().sort((D,O)=>(O.date||"").localeCompare(D.date||"")):[],[a,r]),u=c.useMemo(()=>p.filter(D=>r?Ne(D)===0:!_e(D)),[p,r]),b=r?x:u,m=r?a.length-x.length:p.length-u.length,y=r?a.length:p.length,k=y?Math.min(100,m/y*100):100,f=c.useMemo(()=>So(g),[g]),v=!!f&&wt(f)>0,j=c.useMemo(()=>v?g.filter(D=>(D.date||"").slice(0,10)===f):[],[g,f,v]),w=typeof((T=s.stats)==null?void 0:T.kept_today)=="number"?s.stats.kept_today:null,N=typeof((q=s.stats)==null?void 0:q.screened_today)=="number"?s.stats.screened_today:p.length;let E;v?E=o.morningLast(j.length,x.length,Co(f,d)):r?E=o.morningThesis(N,x.length,w):p.length?m===0?E=o.goalSourced(p.length):m>=p.length?E=o.goalCleared:E=o.goalDone(m,p.length):E=o.goalSourced(0);const S=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&x.length&&l({type:"chainStart",queue:x.map(D=>D.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:E}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:k+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:S,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Il(){var z,I;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:d,dossiers:s,mode:l,doSync:g,startTour:p,flash:x,flashErr:u}=K(),[b,m]=c.useState(null),[y,k]=c.useState(!0),[f,v]=c.useState([]),j=l==="client";c.useEffect(()=>{if(!o||!i)return;let R=!0;return k(!0),(async()=>{const[_,J]=await Promise.all([An(i),co(o)]);R&&(_&&m(_),k(!1),v(J))})(),()=>{R=!1}},[o,i]);const[w,N]=c.useState(!1),[E,S]=c.useState(""),T=()=>{!j||w||!i||(N(!0),S(""),$i(i).then(R=>{if(N(!1),R.pending){S(e.refreshSlow);return}if(!R.ok){R.error&&console.warn("[republish]",R.error),S(e.refreshKo);return}const _=R.entered??0,J=R.left??0;S(R.unchanged||!_&&!J?e.refreshSame:e.refreshDone(_,J)),d.refresh()}))},q=(b==null?void 0:b.per_day)??null,D=((z=b==null?void 0:b.pool_order)==null?void 0:z.length)??0,O=f.filter(R=>R.status==="running").length,H=c.useMemo(()=>s.filter(R=>R.kind==="target"&&_e(R)).length,[s]),F=d.marketEstimate,M=typeof((I=d.stats)==null?void 0:I.screened)=="number"?d.stats.screened:H,h=F&&F>0?Math.min(100,Math.round(M/F*100)):null,A=R=>R.toLocaleString(a==="en"?"en-US":"fr-FR"),U=(i||"P").split(/\s+/).map(R=>R[0]).join("").slice(0,2).toUpperCase(),ee=(()=>{const R=Date.parse(d.generatedAt||"");if(Number.isNaN(R))return"";const _=new Date(R),J=X=>String(X).padStart(2,"0");return`${J(_.getDate())}/${J(_.getMonth()+1)} à ${J(_.getHours())}:${J(_.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?U:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),ee?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(ee)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||w,onClick:T,children:w?"⏳":"📰"}),(w||!!E)&&t.jsxs("span",{className:"repubst",children:[w?e.refreshRun:E,!w&&t.jsx("button",{type:"button",onClick:()=>S(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:g,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:p,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:R=>n({type:"filters",patch:{search:R.target.value}})})]})]}),t.jsxs("div",{className:"idmain",children:[h===null&&M>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:A(M)})})]}),h!==null&&F&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:h+"%"}})}),t.jsxs("b",{children:[h," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(M,F)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),q!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:q})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),q===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),O>0&&t.jsxs("span",{className:"ev",children:["⏳ ",O]})]}),t.jsxs("span",{className:"filec",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:a==="en"?"Queue":"File"}),t.jsx("span",{className:"ego",children:y?e.identPendingWait:e.identPending(D)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:R=>{R.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]})]})]})}class Lt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,s=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);s&&(r[n++]=s),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*Pl(e){for(const a of e)yield*a}function zo(e){return Array.from(Pl(e))}var Ee=1e-6,ve=Math.PI,at=ve/2,Nr=ve/4,rt=ve*2,xt=180/ve,Xe=ve/180,ze=Math.abs,_l=Math.atan,ra=Math.atan2,Te=Math.cos,Le=Math.sin,Bl=Math.sign||function(e){return e>0?1:e<0?-1:0},Ft=Math.sqrt;function $l(e){return e>1?0:e<-1?ve:Math.acos(e)}function oa(e){return e>1?at:e<-1?-at:Math.asin(e)}function nt(){}function Ra(e,a){e&&Cr.hasOwnProperty(e.type)&&Cr[e.type](e,a)}var Sr={Feature:function(e,a){Ra(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ra(r[n].geometry,a)}},Cr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){cn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)cn(r[n],a,0)},Polygon:function(e,a){zr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)zr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ra(r[n],a)}};function cn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function zr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)cn(e[r],a,1);a.polygonEnd()}function Pt(e,a){e&&Sr.hasOwnProperty(e.type)?Sr[e.type](e,a):Ra(e,a)}function un(e){return[ra(e[1],e[0]),oa(e[2])]}function $t(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*Le(a),Le(r)]}function ha(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Fa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ja(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ga(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function mn(e){var a=Ft(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function fn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function hn(e,a){return ze(e)>ve&&(e-=Math.round(e/rt)*rt),[e,a]}hn.invert=hn;function Ul(e,a,r){return(e%=rt)?a||r?fn(qr(e),Tr(a,r)):qr(e):a||r?Tr(a,r):hn}function Ar(e){return function(a,r){return a+=e,ze(a)>ve&&(a-=Math.round(a/rt)*rt),[a,r]}}function qr(e){var a=Ar(e);return a.invert=Ar(-e),a}function Tr(e,a){var r=Te(e),n=Le(e),o=Te(a),i=Le(a);function d(s,l){var g=Te(l),p=Te(s)*g,x=Le(s)*g,u=Le(l),b=u*r+p*n;return[ra(x*o-b*i,p*r-u*n),oa(b*o+x*i)]}return d.invert=function(s,l){var g=Te(l),p=Te(s)*g,x=Le(s)*g,u=Le(l),b=u*o-x*i;return[ra(x*o+u*i,p*r+b*n),oa(b*r-p*n)]},d}function Hl(e,a,r,n,o,i){if(r){var d=Te(a),s=Le(a),l=n*r;o==null?(o=a+n*rt,i=a-l/2):(o=Lr(d,o),i=Lr(d,i),(n>0?o<i:o>i)&&(o+=n*rt));for(var g,p=o;n>0?p>i:p<i;p-=l)g=un([d,-s*Te(p),-s*Le(p)]),e.point(g[0],g[1])}}function Lr(e,a){a=$t(a),a[0]-=e,mn(a);var r=$l(-a[1]);return((-a[2]<0?-r:r)+rt-Ee)%rt}function Ao(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:nt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ea(e,a){return ze(e[0]-a[0])<Ee&&ze(e[1]-a[1])<Ee}function xa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function qo(e,a,r,n,o){var i=[],d=[],s,l;if(e.forEach(function(m){if(!((y=m.length-1)<=0)){var y,k=m[0],f=m[y],v;if(Ea(k,f)){if(!k[2]&&!f[2]){for(o.lineStart(),s=0;s<y;++s)o.point((k=m[s])[0],k[1]);o.lineEnd();return}f[0]+=2*Ee}i.push(v=new xa(k,m,null,!0)),d.push(v.o=new xa(k,null,v,!1)),i.push(v=new xa(f,m,null,!1)),d.push(v.o=new xa(f,null,v,!0))}}),!!i.length){for(d.sort(a),Rr(i),Rr(d),s=0,l=d.length;s<l;++s)d[s].e=r=!r;for(var g=i[0],p,x;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;p=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,l=p.length;s<l;++s)o.point((x=p[s])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(p=u.p.z,s=p.length-1;s>=0;--s)o.point((x=p[s])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,p=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Rr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Xa(e){return ze(e[0])<=ve?e[0]:Bl(e[0])*((ze(e[0])+ve)%rt-ve)}function Vl(e,a){var r=Xa(a),n=a[1],o=Le(n),i=[Le(r),-Te(r),0],d=0,s=0,l=new Lt;o===1?n=at+Ee:o===-1&&(n=-at-Ee);for(var g=0,p=e.length;g<p;++g)if(u=(x=e[g]).length)for(var x,u,b=x[u-1],m=Xa(b),y=b[1]/2+Nr,k=Le(y),f=Te(y),v=0;v<u;++v,m=w,k=E,f=S,b=j){var j=x[v],w=Xa(j),N=j[1]/2+Nr,E=Le(N),S=Te(N),T=w-m,q=T>=0?1:-1,D=q*T,O=D>ve,H=k*E;if(l.add(ra(H*q*Le(D),f*S+H*Te(D))),d+=O?T+q*rt:T,O^m>=r^w>=r){var F=Fa($t(b),$t(j));mn(F);var M=Fa(i,F);mn(M);var h=(O^T>=0?-1:1)*oa(M[2]);(n>h||n===h&&(F[0]||F[1]))&&(s+=O^T>=0?1:-1)}}return(d<-Ee||d<Ee&&l<-1e-12)^s&1}function To(e,a,r,n){return function(o){var i=a(o),d=Ao(),s=a(d),l=!1,g,p,x,u={point:b,lineStart:y,lineEnd:k,polygonStart:function(){u.point=f,u.lineStart=v,u.lineEnd=j,p=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=y,u.lineEnd=k,p=zo(p);var w=Vl(g,n);p.length?(l||(o.polygonStart(),l=!0),qo(p,Gl,w,r,o)):w&&(l||(o.polygonStart(),l=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),l&&(o.polygonEnd(),l=!1),p=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(w,N){e(w,N)&&o.point(w,N)}function m(w,N){i.point(w,N)}function y(){u.point=m,i.lineStart()}function k(){u.point=b,i.lineEnd()}function f(w,N){x.push([w,N]),s.point(w,N)}function v(){s.lineStart(),x=[]}function j(){f(x[0][0],x[0][1]),s.lineEnd();var w=s.clean(),N=d.result(),E,S=N.length,T,q,D;if(x.pop(),g.push(x),x=null,!!S){if(w&1){if(q=N[0],(T=q.length-1)>0){for(l||(o.polygonStart(),l=!0),o.lineStart(),E=0;E<T;++E)o.point((D=q[E])[0],D[1]);o.lineEnd()}return}S>1&&w&2&&N.push(N.pop().concat(N.shift())),p.push(N.filter(Wl))}}return u}}function Wl(e){return e.length>1}function Gl(e,a){return((e=e.x)[0]<0?e[1]-at-Ee:at-e[1])-((a=a.x)[0]<0?a[1]-at-Ee:at-a[1])}const Fr=To(function(){return!0},Yl,Kl,[-ve,-at]);function Yl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var s=i>0?ve:-ve,l=ze(i-a);ze(l-ve)<Ee?(e.point(a,r=(r+d)/2>0?at:-at),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&l>=ve&&(ze(a-n)<Ee&&(a-=n*Ee),ze(i-s)<Ee&&(i-=s*Ee),r=Ql(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=d),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Ql(e,a,r,n){var o,i,d=Le(e-r);return ze(d)>Ee?_l((Le(a)*(i=Te(n))*Le(r)-Le(n)*(o=Te(a))*Le(e))/(o*i*d)):(a+n)/2}function Kl(e,a,r,n){var o;if(e==null)o=r*at,n.point(-ve,o),n.point(0,o),n.point(ve,o),n.point(ve,0),n.point(ve,-o),n.point(0,-o),n.point(-ve,-o),n.point(-ve,0),n.point(-ve,o);else if(ze(e[0]-a[0])>Ee){var i=e[0]<a[0]?ve:-ve;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Jl(e){var a=Te(e),r=2*Xe,n=a>0,o=ze(a)>Ee;function i(p,x,u,b){Hl(b,e,r,u,p,x)}function d(p,x){return Te(p)*Te(x)>a}function s(p){var x,u,b,m,y;return{lineStart:function(){m=b=!1,y=1},point:function(k,f){var v=[k,f],j,w=d(k,f),N=n?w?0:g(k,f):w?g(k+(k<0?ve:-ve),f):0;if(!x&&(m=b=w)&&p.lineStart(),w!==b&&(j=l(x,v),(!j||Ea(x,j)||Ea(v,j))&&(v[2]=1)),w!==b)y=0,w?(p.lineStart(),j=l(v,x),p.point(j[0],j[1])):(j=l(x,v),p.point(j[0],j[1],2),p.lineEnd()),x=j;else if(o&&x&&n^w){var E;!(N&u)&&(E=l(v,x,!0))&&(y=0,n?(p.lineStart(),p.point(E[0][0],E[0][1]),p.point(E[1][0],E[1][1]),p.lineEnd()):(p.point(E[1][0],E[1][1]),p.lineEnd(),p.lineStart(),p.point(E[0][0],E[0][1],3)))}w&&(!x||!Ea(x,v))&&p.point(v[0],v[1]),x=v,b=w,u=N},lineEnd:function(){b&&p.lineEnd(),x=null},clean:function(){return y|(m&&b)<<1}}}function l(p,x,u){var b=$t(p),m=$t(x),y=[1,0,0],k=Fa(b,m),f=ha(k,k),v=k[0],j=f-v*v;if(!j)return!u&&p;var w=a*f/j,N=-a*v/j,E=Fa(y,k),S=ga(y,w),T=ga(k,N);Ja(S,T);var q=E,D=ha(S,q),O=ha(q,q),H=D*D-O*(ha(S,S)-1);if(!(H<0)){var F=Ft(H),M=ga(q,(-D-F)/O);if(Ja(M,S),M=un(M),!u)return M;var h=p[0],A=x[0],U=p[1],ee=x[1],z;A<h&&(z=h,h=A,A=z);var I=A-h,R=ze(I-ve)<Ee,_=R||I<Ee;if(!R&&ee<U&&(z=U,U=ee,ee=z),_?R?U+ee>0^M[1]<(ze(M[0]-h)<Ee?U:ee):U<=M[1]&&M[1]<=ee:I>ve^(h<=M[0]&&M[0]<=A)){var J=ga(q,(-D+F)/O);return Ja(J,S),[M,un(J)]}}}function g(p,x){var u=n?e:ve-e,b=0;return p<-u?b|=1:p>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return To(d,s,i,n?[0,-e]:[-ve,e-ve])}function Xl(e,a,r,n,o,i){var d=e[0],s=e[1],l=a[0],g=a[1],p=0,x=1,u=l-d,b=g-s,m;if(m=r-d,!(!u&&m>0)){if(m/=u,u<0){if(m<p)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>p&&(p=m)}if(m=o-d,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>p&&(p=m)}else if(u>0){if(m<p)return;m<x&&(x=m)}if(m=n-s,!(!b&&m>0)){if(m/=b,b<0){if(m<p)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>p&&(p=m)}if(m=i-s,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>p&&(p=m)}else if(b>0){if(m<p)return;m<x&&(x=m)}return p>0&&(e[0]=d+p*u,e[1]=s+p*b),x<1&&(a[0]=d+x*u,a[1]=s+x*b),!0}}}}}var Kt=1e9,ba=-Kt;function Zl(e,a,r,n){function o(g,p){return e<=g&&g<=r&&a<=p&&p<=n}function i(g,p,x,u){var b=0,m=0;if(g==null||(b=d(g,x))!==(m=d(p,x))||l(g,p)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(p[0],p[1])}function d(g,p){return ze(g[0]-e)<Ee?p>0?0:3:ze(g[0]-r)<Ee?p>0?2:1:ze(g[1]-a)<Ee?p>0?1:0:p>0?3:2}function s(g,p){return l(g.x,p.x)}function l(g,p){var x=d(g,1),u=d(p,1);return x!==u?x-u:x===0?p[1]-g[1]:x===1?g[0]-p[0]:x===2?g[1]-p[1]:p[0]-g[0]}return function(g){var p=g,x=Ao(),u,b,m,y,k,f,v,j,w,N,E,S={point:T,lineStart:H,lineEnd:F,polygonStart:D,polygonEnd:O};function T(h,A){o(h,A)&&p.point(h,A)}function q(){for(var h=0,A=0,U=b.length;A<U;++A)for(var ee=b[A],z=1,I=ee.length,R=ee[0],_,J,X=R[0],be=R[1];z<I;++z)_=X,J=be,R=ee[z],X=R[0],be=R[1],J<=n?be>n&&(X-_)*(n-J)>(be-J)*(e-_)&&++h:be<=n&&(X-_)*(n-J)<(be-J)*(e-_)&&--h;return h}function D(){p=x,u=[],b=[],E=!0}function O(){var h=q(),A=E&&h,U=(u=zo(u)).length;(A||U)&&(g.polygonStart(),A&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),U&&qo(u,s,h,i,g),g.polygonEnd()),p=g,u=b=m=null}function H(){S.point=M,b&&b.push(m=[]),N=!0,w=!1,v=j=NaN}function F(){u&&(M(y,k),f&&w&&x.rejoin(),u.push(x.result())),S.point=T,w&&p.lineEnd()}function M(h,A){var U=o(h,A);if(b&&m.push([h,A]),N)y=h,k=A,f=U,N=!1,U&&(p.lineStart(),p.point(h,A));else if(U&&w)p.point(h,A);else{var ee=[v=Math.max(ba,Math.min(Kt,v)),j=Math.max(ba,Math.min(Kt,j))],z=[h=Math.max(ba,Math.min(Kt,h)),A=Math.max(ba,Math.min(Kt,A))];Xl(ee,z,e,a,r,n)?(w||(p.lineStart(),p.point(ee[0],ee[1])),p.point(z[0],z[1]),U||p.lineEnd(),E=!1):U&&(p.lineStart(),p.point(h,A),E=!1)}v=h,j=A,w=U}return S}}const gn=e=>e;var Za=new Lt,xn=new Lt,Lo,Ro,bn,vn,vt={point:nt,lineStart:nt,lineEnd:nt,polygonStart:function(){vt.lineStart=ed,vt.lineEnd=ad},polygonEnd:function(){vt.lineStart=vt.lineEnd=vt.point=nt,Za.add(ze(xn)),xn=new Lt},result:function(){var e=Za/2;return Za=new Lt,e}};function ed(){vt.point=td}function td(e,a){vt.point=Fo,Lo=bn=e,Ro=vn=a}function Fo(e,a){xn.add(vn*e-bn*a),bn=e,vn=a}function ad(){Fo(Lo,Ro)}var Ut=1/0,Oa=Ut,ia=-Ut,Ma=ia,Da={point:nd,lineStart:nt,lineEnd:nt,polygonStart:nt,polygonEnd:nt,result:function(){var e=[[Ut,Oa],[ia,Ma]];return ia=Ma=-(Oa=Ut=1/0),e}};function nd(e,a){e<Ut&&(Ut=e),e>ia&&(ia=e),a<Oa&&(Oa=a),a>Ma&&(Ma=a)}var yn=0,wn=0,Jt=0,Ia=0,Pa=0,_t=0,kn=0,jn=0,Xt=0,Oo,Mo,ct,ut,tt={point:Rt,lineStart:Or,lineEnd:Mr,polygonStart:function(){tt.lineStart=id,tt.lineEnd=sd},polygonEnd:function(){tt.point=Rt,tt.lineStart=Or,tt.lineEnd=Mr},result:function(){var e=Xt?[kn/Xt,jn/Xt]:_t?[Ia/_t,Pa/_t]:Jt?[yn/Jt,wn/Jt]:[NaN,NaN];return yn=wn=Jt=Ia=Pa=_t=kn=jn=Xt=0,e}};function Rt(e,a){yn+=e,wn+=a,++Jt}function Or(){tt.point=rd}function rd(e,a){tt.point=od,Rt(ct=e,ut=a)}function od(e,a){var r=e-ct,n=a-ut,o=Ft(r*r+n*n);Ia+=o*(ct+e)/2,Pa+=o*(ut+a)/2,_t+=o,Rt(ct=e,ut=a)}function Mr(){tt.point=Rt}function id(){tt.point=ld}function sd(){Do(Oo,Mo)}function ld(e,a){tt.point=Do,Rt(Oo=ct=e,Mo=ut=a)}function Do(e,a){var r=e-ct,n=a-ut,o=Ft(r*r+n*n);Ia+=o*(ct+e)/2,Pa+=o*(ut+a)/2,_t+=o,o=ut*e-ct*a,kn+=o*(ct+e),jn+=o*(ut+a),Xt+=o*3,Rt(ct=e,ut=a)}function Io(e){this._context=e}Io.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,rt);break}}},result:nt};var En=new Lt,en,Po,_o,Zt,ea,sa={point:nt,lineStart:function(){sa.point=dd},lineEnd:function(){en&&Bo(Po,_o),sa.point=nt},polygonStart:function(){en=!0},polygonEnd:function(){en=null},result:function(){var e=+En;return En=new Lt,e}};function dd(e,a){sa.point=Bo,Po=Zt=e,_o=ea=a}function Bo(e,a){Zt-=e,ea-=a,En.add(Ft(Zt*Zt+ea*ea)),Zt=e,ea=a}let Dr,_a,Ir,Pr;class _r{constructor(a){this._append=a==null?$o:pd(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Ir||this._append!==_a){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Ir=n,_a=this._append,Pr=this._,this._=o}this._+=Pr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function $o(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function pd(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return $o;if(a!==Dr){const r=10**a;Dr=a,_a=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return _a}function cd(e,a){let r=3,n=4.5,o,i;function d(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Pt(s,o(i))),i.result()}return d.area=function(s){return Pt(s,o(vt)),vt.result()},d.measure=function(s){return Pt(s,o(sa)),sa.result()},d.bounds=function(s){return Pt(s,o(Da)),Da.result()},d.centroid=function(s){return Pt(s,o(tt)),tt.result()},d.projection=function(s){return arguments.length?(o=s==null?(e=null,gn):(e=s).stream,d):e},d.context=function(s){return arguments.length?(i=s==null?(a=null,new _r(r)):new Io(a=s),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),d):n},d.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const l=Math.floor(s);if(!(l>=0))throw new RangeError(`invalid digits: ${s}`);r=l}return a===null&&(i=new _r(r)),d},d.projection(e).digits(r).context(a)}function On(e){return function(a){var r=new Nn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Nn(){}Nn.prototype={constructor:Nn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Mn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Pt(r,e.stream(Da)),a(Da.result()),n!=null&&e.clipExtent(n),e}function Uo(e,a,r){return Mn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,l=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([s,l])},r)}function ud(e,a,r){return Uo(e,[[0,0],a],r)}function md(e,a,r){return Mn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([d,s])},r)}function fd(e,a,r){return Mn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,s])},r)}var Br=16,hd=Te(30*Xe);function $r(e,a){return+a?xd(e,a):gd(e)}function gd(e){return On({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function xd(e,a){function r(n,o,i,d,s,l,g,p,x,u,b,m,y,k){var f=g-n,v=p-o,j=f*f+v*v;if(j>4*a&&y--){var w=d+u,N=s+b,E=l+m,S=Ft(w*w+N*N+E*E),T=oa(E/=S),q=ze(ze(E)-1)<Ee||ze(i-x)<Ee?(i+x)/2:ra(N,w),D=e(q,T),O=D[0],H=D[1],F=O-n,M=H-o,h=v*F-f*M;(h*h/j>a||ze((f*F+v*M)/j-.5)>.3||d*u+s*b+l*m<hd)&&(r(n,o,i,d,s,l,O,H,q,w/=S,N/=S,E,y,k),k.point(O,H),r(O,H,q,w,N,E,g,p,x,u,b,m,y,k))}}return function(n){var o,i,d,s,l,g,p,x,u,b,m,y,k={point:f,lineStart:v,lineEnd:w,polygonStart:function(){n.polygonStart(),k.lineStart=N},polygonEnd:function(){n.polygonEnd(),k.lineStart=v}};function f(T,q){T=e(T,q),n.point(T[0],T[1])}function v(){x=NaN,k.point=j,n.lineStart()}function j(T,q){var D=$t([T,q]),O=e(T,q);r(x,u,p,b,m,y,x=O[0],u=O[1],p=T,b=D[0],m=D[1],y=D[2],Br,n),n.point(x,u)}function w(){k.point=f,n.lineEnd()}function N(){v(),k.point=E,k.lineEnd=S}function E(T,q){j(o=T,q),i=x,d=u,s=b,l=m,g=y,k.point=j}function S(){r(x,u,p,b,m,y,i,d,o,s,l,g,Br,n),k.lineEnd=w,w()}return k}}var bd=On({point:function(e,a){this.stream.point(e*Xe,a*Xe)}});function vd(e){return On({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function yd(e,a,r,n,o){function i(d,s){return d*=n,s*=o,[a+e*d,r-e*s]}return i.invert=function(d,s){return[(d-a)/e*n,(r-s)/e*o]},i}function Ur(e,a,r,n,o,i){if(!i)return yd(e,a,r,n,o);var d=Te(i),s=Le(i),l=d*e,g=s*e,p=d/e,x=s/e,u=(s*r-d*a)/e,b=(s*a+d*r)/e;function m(y,k){return y*=n,k*=o,[l*y-g*k+a,r-g*y-l*k]}return m.invert=function(y,k){return[n*(p*y-x*k+u),o*(b-x*y-p*k)]},m}function wd(e){return kd(function(){return e})()}function kd(e){var a,r=150,n=480,o=250,i=0,d=0,s=0,l=0,g=0,p,x=0,u=1,b=1,m=null,y=Fr,k=null,f,v,j,w=gn,N=.5,E,S,T,q,D;function O(h){return T(h[0]*Xe,h[1]*Xe)}function H(h){return h=T.invert(h[0],h[1]),h&&[h[0]*xt,h[1]*xt]}O.stream=function(h){return q&&D===h?q:q=bd(vd(p)(y(E(w(D=h)))))},O.preclip=function(h){return arguments.length?(y=h,m=void 0,M()):y},O.postclip=function(h){return arguments.length?(w=h,k=f=v=j=null,M()):w},O.clipAngle=function(h){return arguments.length?(y=+h?Jl(m=h*Xe):(m=null,Fr),M()):m*xt},O.clipExtent=function(h){return arguments.length?(w=h==null?(k=f=v=j=null,gn):Zl(k=+h[0][0],f=+h[0][1],v=+h[1][0],j=+h[1][1]),M()):k==null?null:[[k,f],[v,j]]},O.scale=function(h){return arguments.length?(r=+h,F()):r},O.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],F()):[n,o]},O.center=function(h){return arguments.length?(i=h[0]%360*Xe,d=h[1]%360*Xe,F()):[i*xt,d*xt]},O.rotate=function(h){return arguments.length?(s=h[0]%360*Xe,l=h[1]%360*Xe,g=h.length>2?h[2]%360*Xe:0,F()):[s*xt,l*xt,g*xt]},O.angle=function(h){return arguments.length?(x=h%360*Xe,F()):x*xt},O.reflectX=function(h){return arguments.length?(u=h?-1:1,F()):u<0},O.reflectY=function(h){return arguments.length?(b=h?-1:1,F()):b<0},O.precision=function(h){return arguments.length?(E=$r(S,N=h*h),M()):Ft(N)},O.fitExtent=function(h,A){return Uo(O,h,A)},O.fitSize=function(h,A){return ud(O,h,A)},O.fitWidth=function(h,A){return md(O,h,A)},O.fitHeight=function(h,A){return fd(O,h,A)};function F(){var h=Ur(r,0,0,u,b,x).apply(null,a(i,d)),A=Ur(r,n-h[0],o-h[1],u,b,x);return p=Ul(s,l,g),S=fn(a,A),T=fn(p,S),E=$r(S,N),M()}function M(){return q=D=null,O}return function(){return a=e.apply(this,arguments),O.invert=a.invert&&H,F()}}function Ho(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Ho.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(ze(o)>Ee&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function jd(){return wd(Ho).scale(175.295)}function Ed(e){return e}function Nd(e){if(e==null)return Ed;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(s,l){l||(a=r=0);var g=2,p=s.length,x=new Array(p);for(x[0]=(a+=s[0])*n+i,x[1]=(r+=s[1])*o+d;g<p;)x[g]=s[g],++g;return x}}function Sd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Cd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Hr(e,r)})}:Hr(e,a)}function Hr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=zd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function zd(e,a){var r=Nd(e.transform),n=e.arcs;function o(p,x){x.length&&x.pop();for(var u=n[p<0?~p:p],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));p<0&&Sd(x,m)}function i(p){return r(p)}function d(p){for(var x=[],u=0,b=p.length;u<b;++u)o(p[u],x);return x.length<2&&x.push(x[0]),x}function s(p){for(var x=d(p);x.length<4;)x.push(x[0]);return x}function l(p){return p.map(s)}function g(p){var x=p.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:p.geometries.map(g)};case"Point":u=i(p.coordinates);break;case"MultiPoint":u=p.coordinates.map(i);break;case"LineString":u=d(p.arcs);break;case"MultiLineString":u=p.arcs.map(d);break;case"Polygon":u=l(p.arcs);break;case"MultiPolygon":u=p.arcs.map(l);break;default:return null}return{type:x,coordinates:u}}return g(a)}const Vo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Ad=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function qd(e,a,r){const n=Vo[e];if(!n||!n.length)return-1;const o=Ad(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let va=null;function Td(){return va||(va=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Cd(r,n),i=jd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=cd(i),s=(o.features||[]).filter(p=>{var x;return(((x=p.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(p=>{var b;const x=((b=p.properties)==null?void 0:b.name)||"",u=d(p)||"";return u?{i2:Ui(x)||null,n:x,d:u}:null}).filter(p=>!!p);if(!s.length)return null;const l={};for(const[p,x]of Object.entries(Hi)){const u=i(x);u&&(l[p]={x:u[0],y:u[1]})}const g={};for(const[p,x]of Object.entries(Vo)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(g[p]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:l,metros:g}}catch{return null}})(),va)}function Ld(e){const[a,r]=c.useState(null);return c.useEffect(()=>{if(!e||a)return;let n=!1;return Td().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Rd="8 40 984 210",Fd={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Vr=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function Wr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Od(e,a){const[r,n]=c.useState(1);return c.useEffect(()=>{let o=!0,i=0;const d=()=>{var g;if(!o)return;const l=(g=e.current)==null?void 0:g.getScreenCTM();l&&l.a>0?n(l.a):i=requestAnimationFrame(d)};d();const s=new ResizeObserver(()=>d());return e.current&&s.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function Gr({msgs:e}){const[a,r]=c.useState(0);c.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Md(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:s,t:l,data:g,dossiers:p,source:x}=K(),u=g.loading&&!p.length,b=c.useRef(null),m=c.useRef(null),y=Ld(e.continent==="monde"),k=e.continent==="monde"?y:qn.find(h=>h.key===e.continent)||null,f=Od(b,e.continent+":"+e.mapFolded+":"+!!k),[v,j]=c.useState(new Map),[w,N]=c.useState(null);c.useEffect(()=>{const h=b.current;if(!h)return;const A=new Map;h.querySelectorAll("path[data-i2]").forEach(U=>{const ee=U.dataset.i2;if(ee)try{const z=U.getBBox();z.width>0&&A.set(ee,{x:z.x,y:z.y,w:z.width,h:z.height})}catch{}}),j(A)},[e.continent,f,k]);const E=c.useMemo(()=>r.filter(h=>h.cc),[r]),S=c.useMemo(()=>{const h=new Map;return E.forEach(A=>h.set(A.cc,(h.get(A.cc)||0)+1)),h},[E]),T=e.continent==="monde"&&y?y.anchors:null,q=e.continent==="monde"&&y?y.metros:null,D=c.useMemo(()=>E.map(h=>{const A=Wr(h.name||h.id||""),U=Wr((h.id||h.name||"")+"·y");if(T&&h.cc){const _=q?q[h.cc]:void 0;if(_&&_.length){const X=qd(h.cc,h.city,A);if(X>=0&&_[X])return{d:h,x:_[X].x+(A-.5)*5,y:_[X].y+(U-.5)*5}}const J=T[h.cc];if(J)return{d:h,x:J.x+(A-.5)*10,y:J.y+(U-.5)*10}}const ee=h.cc?v.get(h.cc):void 0;if(!ee)return null;const z=Fd[`${e.continent}:${h.cc||""}`];if(z)return{d:h,x:ee.x+ee.w*(z.fx+(A-.5)*z.sx),y:ee.y+ee.h*(z.fy+(U-.5)*z.sy)};const I=(A-.5)*Math.min(ee.w*.55,60),R=(U-.5)*Math.min(ee.h*.55,60);return{d:h,x:ee.x+ee.w/2+I,y:ee.y+ee.h/2+R}}).filter(h=>!!h),[E,v,T,q,e.continent]),O=h=>f>0?h/f:h,H=c.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:Vr[h],fr:l.plabels[h],en:l.plabels[h],n:r.filter(A=>A.kind==="target"&&Ne(A)===h).length})).filter(h=>h.n>0):Jn.map((h,A)=>({...h,n:r.filter(U=>Xn(U)===A).length})),[r,n,l.plabels]),F=i?d.get(i):null,M=F?D.find(h=>h.d.id===F.id):null;return k?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Gr,{msgs:l.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?Rd:k.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?k.fr:k.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:k.countries.map((h,A)=>t.jsx("g",{className:"ct"+(h.i2&&S.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},A))}),t.jsx("g",{children:D.map(h=>{const A=Jn[Xn(h.d)],U=!!Ie(h.d),ee=h.d.kind==="target",z=n&&ee?Vr[Ne(h.d)]:A.c,I=!n&&_e(h.d);return t.jsxs("g",{className:"co"+(I?" done":""),onMouseEnter:()=>{var J,X;const R=(J=m.current)==null?void 0:J.getBoundingClientRect(),_=(X=b.current)==null?void 0:X.createSVGPoint();if(_&&b.current&&R){_.x=h.x,_.y=h.y;const be=_.matrixTransform(b.current.getScreenCTM());N({x:be.x-R.left,y:be.y-R.top,label:h.d.name+" · "+(Wt(h.d.cc,s)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var J;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const R=(J=b.current)==null?void 0:J.createSVGPoint();let _=null;if(R&&b.current){R.x=h.x,R.y=h.y;const X=R.matrixTransform(b.current.getScreenCTM());_={x:X.x,y:X.y}}a({type:"popup",id:h.d.id,anchor:_})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:O(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:O(A.px),fill:z,stroke:U?"#E5484D":"#ffffff",strokeWidth:O(U?2.2:1.3)})]},h.d.id||h.d.name)})}),M&&t.jsx("circle",{className:"ring on",cx:M.x,cy:M.y,r:O(13),fill:"none",stroke:"#16233A",strokeWidth:O(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:H.map((h,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),s==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},A))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",l.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Gr,{msgs:l.loadMsgs})})}function Dd(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Wo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:s}=K(),l=a.filters,[g,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null),m=c.useRef(null),y=c.useMemo(()=>a.continent==="monde"?n:n.filter(M=>M.continent===a.continent),[n,a.continent]),k=M=>y.filter(h=>M!=="country"&&l.country.length&&!l.country.includes(h.cc||"")?!1:Ta(h,l,i,M==="country"?void 0:M)),f=M=>!i||M.kind!=="op",v=c.useMemo(()=>{const M=k("win").filter(f),h=A=>M.filter(U=>(U.date?Math.max(0,Math.floor((Date.now()-Date.parse(U.date))/864e5)):9999)<=A).length;return[h(0),h(7),h(30),M.length]},[y,l,i]),j=c.useMemo(()=>l.day?k("win").filter(f).filter(M=>(M.date||"").slice(0,10)===l.day).length:0,[y,l,i]),w=(l.signalOnly?1:0)+l.sector.length+l.market.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+l.crible.length,N=w+(l.acquirer.trim()?1:0)+(l.day||l.win!=="all"?1:0)+(l.search.trim()?1:0);c.useEffect(()=>{a.openFacet&&p(!1)},[a.openFacet]),c.useEffect(()=>{if(!g&&!x)return;const M=A=>{var ee,z;const U=A.target;g&&!((ee=b.current)!=null&&ee.contains(U))&&p(!1),x&&!((z=m.current)!=null&&z.contains(U))&&u(!1)},h=A=>{A.key==="Escape"&&(p(!1),u(!1))};return document.addEventListener("mousedown",M),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",M),document.removeEventListener("keydown",h)}},[g,x]);const E=(M,h,A,U="fbtn")=>t.jsxs("button",{type:"button",className:U,"aria-expanded":a.openFacet===M,onClick:()=>r({type:"openFacet",facet:M}),children:[t.jsx("span",{className:"fl",children:h}),A>0&&t.jsx("span",{className:"n",children:A}),t.jsx("span",{className:"cv",children:"▾"})]},M),S=["1","7","30","all"],T=Math.max(0,S.indexOf(l.win||"all")),q=l.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(Dd(l.day,s))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(M=>!M),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:v[T]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:S.map((M,h)=>t.jsxs("button",{type:"button",role:"option","aria-selected":l.win===M,onClick:()=>{r({type:"filters",patch:{win:M}}),u(!1)},children:[o.datesShort[h],t.jsx("span",{className:"n",children:v[h]})]},M))})]}):t.jsx("div",{className:"seg",children:S.map((M,h)=>t.jsxs("button",{type:"button","aria-pressed":l.win===M,onClick:()=>r({type:"filters",patch:{win:M}}),children:[t.jsx("span",{className:"sl",children:o.dates[h]}),t.jsx("b",{children:v[h]})]},M))}),D=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:l.search,onChange:M=>r({type:"filters",patch:{search:M.target.value}})})]}),O=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),l.signalOnly&&t.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),l.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:l.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):E("sec",o.fSector,l.sector.length),(n.some(M=>!!M.market)||l.market.length>0)&&E("mar",o.fMarket,l.market.length),E("pay",o.fCountry,l.country.length),E("det",o.fEngine,l.engine.length),E("sta",o.fStage,l.stage.length),i&&E("crib",o.fVerdict,l.crible.length),i&&E("ang","Angle",l.angle.length),i&&E("mem","Mémo",l.memoLevel.length)]}),H=(M=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(y.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),M&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),F=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(w?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{p(M=>!M),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),w>0&&t.jsx("span",{className:"n",children:w}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:O})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(l.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:q}),t.jsxs("div",{className:"fstrip-b",children:[D,F,H(!1)]})]}),a.openFacet&&t.jsx(Yr,{poolFor:k})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[q,D,O,t.jsx("span",{className:"fgrow"}),H()]}),a.openFacet&&t.jsx(Yr,{poolFor:k})]})}function Yr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=K(),s=a.filters,l=a.openFacet,{title:g,cols:p,options:x}=c.useMemo(()=>{if(l==="sig"){const k=e("signal").filter(j=>Ie(j)),f=new Map;k.forEach(j=>{const w=j.engine||"";f.set(w,(f.get(w)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:k.length,html:!0,on:s.signalOnly&&!s.signalEngines.length},...ln([...f.keys()],o).map(j=>({v:j,label:Tt(j)+" "+Ze(j,o),n:f.get(j)||0,html:!1,on:s.signalOnly&&s.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="crib"){const k=e("crible").filter(v=>!i||so(v,a.ptab,d.favIds)),f=new Map;return k.forEach(v=>{const j=lo(v);j&&j!=="NEW"&&f.set(j,(f.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((v,j)=>(Zn[v[0]]??9)-(Zn[j[0]]??9)||j[1]-v[1]).map(([v,j])=>({v,label:'<span class="fdot" style="background:'+(Vi[v]||"#94A3B8")+'"></span>'+v,n:j,html:!0,on:s.crible.includes(v)}))}}if(l==="sec"){const k=e("sector"),f=new Map;return k.forEach(v=>{v.sector&&f.set(v.sector,(f.get(v.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:s.sector.includes(v)}))}}if(l==="mar"){const k=e("market"),f=new Map;return k.forEach(v=>{v.market&&f.set(v.market,(f.get(v.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:s.market.includes(v)}))}}if(l==="pay"){const k=e("country"),f=new Map;return k.forEach(v=>{v.cc&&f.set(v.cc,(f.get(v.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:Wt(v,o)||v,n:j,html:!1,on:s.country.includes(v)}))}}if(l==="det"){const k=e("engine"),f=new Map;return k.forEach(v=>{v.engine&&f.set(v.engine,(f.get(v.engine)||0)+1)}),{title:n.fEngine,cols:2,options:ln([...f.keys()],o).map(v=>({v,label:Tt(v)+" "+Ze(v,o)+' <span style="color:var(--dim);font-size:10px">· '+Wi(Gi(v),o)+"</span>",n:f.get(v)||0,html:!0,on:s.engine.includes(v)}))}}if(l==="ang"){const k=e("angle"),f=new Map;return k.forEach(v=>{v.angle&&f.set(v.angle,(f.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v.replace(/[_-]+/g," "),n:j,html:!1,on:s.angle.includes(v)}))}}if(l==="mem"){const k=e("memoLevel"),f=new Map;k.forEach(j=>{if(j.kind==="target"){const w=zn(j);f.set(w,(f.get(w)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:v[j],n:f.get(j)||0,html:!1,on:s.memoLevel.includes(j)}))}}const m=e("stage"),y=new Map;return m.forEach(k=>{k.stage&&y.set(k.stage,(y.get(k.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...y.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:k,n:f,html:!1,on:s.stage.includes(k)}))}},[l,a,o]),u=m=>{if(l==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(s.signalOnly&&!s.signalEngines.length),signalEngines:[]}});else{const k=s.signalEngines.includes(m)?s.signalEngines.filter(f=>f!==m):[...s.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:k}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage",value:m})},b=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:g}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>u(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Go({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:s}=K(),l=c.useMemo(()=>{const b={};return r.forEach(m=>{Ta(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,p]=c.useState(!1),x=c.useRef(null);c.useEffect(()=>{if(!g)return;const b=y=>{var k;(k=x.current)!=null&&k.contains(y.target)||p(!1)},m=y=>{y.key==="Escape"&&p(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const u=b=>{const m=qn.find(y=>y.key===b);return b==="monde"?s.contWorld:d==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>p(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:l[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:er.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),p(!1)},children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[er.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})})]})}function Sn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function Yo(e){return"atl2:evalq:"+(e||"anon")}function Id(e,a){const r=Yo(e),n=Sn(r),o=new Set(n.map(s=>(s.name||"").trim().toLowerCase())),i=a.map(s=>(s||"").trim()).filter(s=>s&&!o.has(s.toLowerCase())).map(s=>({name:s,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function Qo(){const{t:e,data:a,dossiers:r}=K(),n=a.session.token||"",o=Yo(n),[i,d]=c.useState(()=>Sn(o)),s=c.useRef(!1),[l,g]=c.useState(!1);c.useEffect(()=>{try{const z=i.slice(0,30).map(({descBusy:I,evalBusy:R,..._})=>_);localStorage.setItem(o,JSON.stringify(z)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[i,o]),c.useEffect(()=>{const z=()=>{if(s.current)return;const I=Sn(o);d(R=>JSON.stringify(R.map(({descBusy:_,evalBusy:J,...X})=>X))===JSON.stringify(I)?R:I)};return window.addEventListener("atl2:evalq",z),window.addEventListener("storage",z),()=>{window.removeEventListener("atl2:evalq",z),window.removeEventListener("storage",z)}},[o]);const[p,x]=c.useState([]),[u,b]=c.useState(""),[m,y]=c.useState(!1),[k,f]=c.useState(!1),[v,j]=c.useState(""),w=c.useCallback((z,I)=>d(R=>R.map((_,J)=>J===z?{..._,...I}:_)),[]),N=c.useCallback((z,I)=>{const R=I.trim();R&&(w(z,{name:R,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Tn(R).then(_=>{const J=_.candidates||[];_.website?w(z,{site:_.website,status:"ready"}):J.length===1?w(z,{site:J[0].url,status:"ready"}):J.length>1?w(z,{status:"pick",candidates:J.slice(0,4)}):w(z,{status:"ready"})}).catch(()=>w(z,{status:"ready"})))},[w]),E=c.useCallback((z,I,R)=>{w(z,{descBusy:!0}),uo(n,I,R).then(_=>{if(_.quota){g(!0),w(z,{descBusy:!1,descDone:!0});return}const J=_.blocs||{},X=(J.synthese||J.value_prop||J.produit||J.modele||"").trim();w(z,{descBusy:!1,descDone:!0,desc:X})}).catch(()=>w(z,{descBusy:!1,descDone:!0}))},[w,n]);c.useEffect(()=>{const z=i.findIndex(R=>R.auto&&R.name.trim()&&R.status==="");if(z>=0){N(z,i[z].name);return}if(l)return;const I=i.findIndex(R=>R.status==="ready"&&R.site&&!R.descDone&&!R.descBusy);I>=0&&E(I,i[I].name,i[I].site)},[i,N,E,l]);const[S,T]=c.useState(!1),q=c.useCallback(async(z,I)=>{w(z,{evalBusy:!0});const R=await mo(n,(I.site||I.name).trim(),"atelier2");return R.verdict==="quota"?(w(z,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:R.reason||"",remaining:0}})),!1):(w(z,{evalBusy:!1,status:R.verdict==="kept"?"kept":"out",reason:R.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:R.company||I.name,verdict:R.verdict,reason:R.reason||"",remaining:R.remaining??null}})),!0)},[w,n]),D=async()=>{if(S)return;const z=i.map((I,R)=>({r:I,i:R})).filter(({r:I})=>I.name.trim()&&I.status!=="kept"&&I.status!=="out"&&I.status!=="resolving");if(z.length){T(!0);for(const{r:I,i:R}of z)if(!await q(R,I))break;T(!1)}},O=c.useMemo(()=>{const z=new Set,I=[];return i.filter(R=>R.status==="kept").forEach(R=>{const _=R.name.trim().toLowerCase();_&&!z.has(_)&&(z.add(_),I.push(R.name.trim()))}),r.filter(R=>Ne(R)>=1&&Ne(R)<=4&&(R.website||R.domain)).forEach(R=>{const _=(R.name||"").trim().toLowerCase();_&&!z.has(_)&&(z.add(_),I.push((R.name||"").trim()))}),I},[i,r]),H=c.useMemo(()=>{const z=new Set;return r.forEach(I=>{const R=(I.name||"").trim().toLowerCase();R&&z.add(R)}),i.forEach(I=>{const R=I.name.trim().toLowerCase();R&&z.add(R)}),z},[r,i]),F=async()=>{if(u||!O.length)return;f(!1);const z=[];for(const I of O.slice(0,2)){b(I);const R=await fo(n,I);if(R){if(R.verdict==="quota"){y(!0);break}(R.results||[]).forEach(_=>{const J=(_.company||"").trim().toLowerCase();!J||H.has(J)||z.some(X=>X.name.toLowerCase()===J)||z.push({name:(_.company||"").trim(),verdict:_.verdict||"",reason:_.reason,from:I})})}}b(""),f(!0),x(I=>[...z,...I].slice(0,24))},M=async(z,I)=>{if(u)return;f(!1),b(z==="thesis"?e.pxThesis:I);const R=await Yi(n,z,I,6);if(b(""),f(!0),!R)return;if(R.verdict==="quota"){y(!0);return}const _=[];(R.results||[]).forEach(J=>{const X=(J.company||"").trim().toLowerCase();!X||H.has(X)||_.some(be=>be.name.toLowerCase()===X)||_.push({name:(J.company||"").trim(),verdict:J.verdict||"",reason:J.reason,from:z==="thesis"?e.pxThesis:I})}),x(J=>[..._,...J].slice(0,24))},h=()=>{const z=v.trim();z.length<3||M(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(z)?"registry":"keyword",z)},A=z=>{d(I=>[...I,{name:z.name,site:"",status:"",auto:!0}].slice(0,30)),x(I=>I.filter(R=>R.name!==z.name))},U=i.filter(z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out").length,ee=z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving"&&!z.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((z,I)=>t.jsxs("div",{className:"eq-row"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsx("input",{value:z.name,placeholder:e.eqNamePh,onChange:R=>{const _=R.target.value.split(`
`).map(J=>J.trim()).filter(Boolean);_.length>1?d(J=>{const X=[...J];return X.splice(I,1,..._.map(be=>({name:be,site:"",status:"",auto:!0}))),X.slice(0,30)}):w(I,{name:R.target.value})},onBlur:()=>{z.name.trim()&&!z.site&&z.status!=="resolving"&&z.status!=="pick"&&N(I,z.name)},onKeyDown:R=>{R.key==="Enter"&&N(I,z.name)}}),t.jsxs("span",{className:"eq-site",children:[z.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),z.status==="pick"&&(z.candidates||[]).map(R=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>w(I,{site:R.url,status:"ready",candidates:void 0}),children:(R.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},R.url)),z.status!=="resolving"&&z.status!=="pick"&&(z.site?t.jsxs("a",{href:z.site.startsWith("http")?z.site:"https://"+z.site,target:"_blank",rel:"nofollow noopener",children:[z.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:z.name.trim()&&z.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:z.desc||"",children:z.descBusy?t.jsx("i",{children:e.eqDescBusy}):z.desc?z.desc:t.jsx("em",{children:z.descDone?l?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(z.status||"vide"),title:z.reason||"",children:z.status==="kept"?"✓ "+e.kept:z.status==="out"?"✗ "+e.dropped:z.status==="ready"?e.eqReady:z.status==="pick"?e.eqPick:""}),t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!ee(z)||S,onClick:()=>{q(I,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>d(R=>R.filter((_,J)=>J!==I)),children:"×"})]},I)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>d(z=>[...z,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!u,onClick:()=>{M("thesis","")},children:u===e.pxThesis?e.sgBusy(u):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:v,placeholder:e.pxPlace,onChange:z=>j(z.target.value),onKeyDown:z=>{z.key==="Enter"&&h()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u||v.trim().length<3,onClick:h,children:e.pxGoFree}),!!O.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u,onClick:()=>{F()},children:u&&u!==e.pxThesis&&u!==v?e.sgBusy(u):e.sgGo}),!!O.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(O[0],O.length)}),m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),k&&!p.length&&!m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),p.map(z=>t.jsxs("span",{className:"eq-sc"+(z.verdict==="kept"?" ok":""),title:(z.reason||"")+" — "+e.sgVia(z.from),children:[t.jsx("b",{children:z.name}),z.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>A(z),children:"+"})]},z.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),i.some(z=>z.status==="kept"||z.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>d(z=>z.filter(I=>I.status!=="kept"&&I.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(S?" loading":""),style:{justifyContent:"center"},disabled:S||!U,onClick:()=>{D()},children:[t.jsx("span",{className:"fill"}),S?e.eqRunning:e.eqGo(U)]})]})]})]})}function Ko(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Pd(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Qr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:s}=K();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(l=>l.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(l=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:l.name}),l.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),l.line1&&t.jsx("p",{className:"w",children:l.line1}),l.line2&&t.jsx("p",{className:"r",children:l.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(l.name),children:s.rsEvalOne})]},l.name))})]}):null}function Jo({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=K(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Qr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Qr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function _d({card:e,onEvaluate:a,onAddAll:r}){var s,l,g;const{t:n}=K(),o=[e.industry,...e.market_tags||[],e.author].map(p=>(p||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(p=>p&&p.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(p=>t.jsx("span",{children:p},p))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ko(e.summary_md||"").map((p,x)=>t.jsx("p",{children:p},x))})]}),t.jsx(Jo,{card:e,onEvaluate:a,onAddAll:r}),(((l=e.prospective)==null?void 0:l.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(p=>t.jsx("li",{children:p},p))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(p=>t.jsx("a",{href:p.url,target:"_blank",rel:"noopener noreferrer",children:p.label||p.url},p.url))})]})]})}function Bd(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function $d({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=K(),s=o,[l,g]=c.useState(null),[p,x]=c.useState(null),[u,b]=c.useState(null),[m,y]=c.useState(!1);c.useEffect(()=>{let f=!0;return(async()=>{const v=await ho({email:d,cbToken:s});f&&g(v)})(),()=>{f=!1}},[d,s,n]);const k=f=>{x(f),b(null),y(!0),(async()=>{const v=await Qi(f.id);b(v),y(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[p?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),p&&t.jsx("span",{className:"ti",children:p.title}),!p&&l&&t.jsx("span",{className:"n",children:l.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!p&&t.jsxs("div",{className:"rsarch-list",children:[l===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),l!==null&&l.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(l||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>k(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Bd(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),p&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[p.source_url&&t.jsx("a",{href:p.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),p.published&&p.page_url&&t.jsx("a",{href:p.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(p.published?" on":""),children:p.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(_d,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Na=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ta(e){return/^https?:\/\//i.test((e||"").trim())}function pt(e){const a=(e||"").trim();return a?ta(a)?a:Na.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Ud(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Hd(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:s,evalBusy:l,evalCards:g,caps:p,data:x,canWrite:u,source:b,dossiers:m,doAnalyse:y,liveMemos:k,pipe:f}=K(),v=r==="client",j=c.useMemo(()=>n||(b!=="default"?Ki():""),[n,b]),[w,N]=c.useState(""),[E,S]=c.useState(!1),[T,q]=c.useState(""),[D,O]=c.useState(""),[H,F]=c.useState(""),[M,h]=c.useState(!1),[A,U]=c.useState(!1),[ee,z]=c.useState([]);c.useEffect(()=>{const P=ne=>{const ae=ne.detail;ae&&z(ue=>[ae,...ue].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[I,R]=c.useState(!1),[_,J]=c.useState(!1),[X,be]=c.useState(!1),te=c.useRef(!1),[pe,me]=c.useState(""),[ge,B]=c.useState(""),[Q,W]=c.useState(!1),[re,$]=c.useState(!1),[se,le]=c.useState(0),[oe,ce]=c.useState(""),[de,xe]=c.useState(null),[Re,ye]=c.useState(null),[Se,Ce]=c.useState(!1),[Oe,mt]=c.useState(null),[ot,Be]=c.useState(0),je=c.useRef(!1),Ot=w.trim()?Na.test(w.trim())?e.evalUrl:e.evalName:e.evalWaiting;c.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),ne=(P.get("rs")||"").trim(),ae=(P.get("rstext")||"").trim();ne&&/^https?:\/\//i.test(ne)&&me(ne),ae&&B(ae),(ne&&/^https?:\/\//i.test(ne)||ae)&&R(!0)},[]),c.useEffect(()=>{const P=ne=>{const ae=ne.detail||{},ue=String(ae.url||"").trim(),we=String(ae.text||"").trim();ue&&/^https?:\/\//i.test(ue)&&me(ue),we&&B(we),(ue&&/^https?:\/\//i.test(ue)||we)&&(R(!0),N(""),q(""),W(!0),window.setTimeout(()=>W(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),c.useEffect(()=>{const P=ne=>{const ae=ne.detail||{},ue=String(ae.name||"").trim();if(!ue)return;R(!1),N(ue),q(ue);const we=pt(String(ae.website||ae.domain||""));O(we),F(pt(String(ae.url||""))),h(!we),S(!0),window.setTimeout(()=>S(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),c.useEffect(()=>{const P=(T||"").trim();if(!P||I||D){(D||!P||I)&&h(!1);return}const ne=m.find(we=>He(we.name)===He(P)),ae=pt((ne==null?void 0:ne.website)||"")||pt((ne==null?void 0:ne.domain)||"");if(ae){O(ae),h(!1);return}let ue=!0;return h(!0),Tn(P).then(we=>{var Pe,Ae;if(!ue)return;const he=pt(we.website||"")||pt(((Ae=(Pe=we.candidates)==null?void 0:Pe[0])==null?void 0:Ae.url)||"");he&&O(he)}).catch(()=>{}).finally(()=>{ue&&h(!1)}),()=>{ue=!1}},[T,I,D,m]),c.useEffect(()=>{const P=ne=>{var ue;const ae=String(((ue=ne.detail)==null?void 0:ue.url)||"").trim();ta(ae)&&window.open(ae,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),c.useEffect(()=>{if(te.current===I)return;te.current=I,be(!0);const P=window.setTimeout(()=>be(!1),560);return()=>window.clearTimeout(P)},[I]),c.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ne=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!ne)return;const ae=()=>ne.style.setProperty("--demand-h",`${P.offsetHeight}px`);ae();const ue=new ResizeObserver(ae);return ue.observe(P),()=>ue.disconnect()},[b,E,Q,A,I,X,M]),c.useEffect(()=>{if(!u&&!j){mt(null);return}let P=!0;return(async()=>{const ne=await ho({email:o,cbToken:j});P&&mt(ne.length)})(),()=>{P=!1}},[u,j,o,ot]);const St=ee.length?ee:g,Me=x.credits,st=c.useCallback(P=>{Id(n,P)&&U(!0)},[n]);c.useEffect(()=>{if(!re)return;le(0);const P=window.setInterval(()=>le(ne=>ne+1),1e3);return()=>window.clearInterval(P)},[re]);const ft=c.useMemo(()=>{const P=w.trim().toLowerCase();return!P||!f?null:m.find(ne=>He(ne.name)===P&&Ne(ne)===1)||null},[w,m,f]),Ct=()=>{const P=w.trim();if(P){if(ft){y(ft);return}i(null,P),v&&N("")}},et=async()=>{var ae,ue,we;if(je.current)return;const P=pe.trim().replace(/\s+/g,""),ne=ge.trim();if(!P&&!ne){ce(e.rsNeed);return}if(!v&&!j){i(null,P||ne.slice(0,80));return}je.current=!0,ce(""),xe(null),ye(null),$(!0);try{const he=await Xi({url:P,text:ne,email:o,cbToken:j});if($(!1),!he||he.status!=="success"){ce((he==null?void 0:he.message)||"Erreur");return}xe(he),R(!1),st((((ae=he.prospective)==null?void 0:ae.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),ye({state:"pending"});const Pe=await Zi(he,{email:o,cbToken:j});ye(Pe.ok?{state:"ok",scopeLabel:((ue=Pe.summary)==null?void 0:ue.scope_label)||"",scope:((we=Pe.summary)==null?void 0:we.scope)||""}:{state:"fail",msg:Pe.error||""}),Pe.ok&&Be(Ae=>Ae+1)}finally{je.current=!1,$(!1)}},zt=[de==null?void 0:de.industry,...(de==null?void 0:de.market_tags)||[],de==null?void 0:de.author].map(P=>(P||"").trim()).filter(Boolean),ht=(Re==null?void 0:Re.state)==="pending",Mt=Re&&(ht?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Re.state==="ok"?t.jsx("span",{className:"rslink ok",children:Re.scope&&Re.scope!=="public"?e.rsSavedIn(Re.scopeLabel||Re.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Re.msg,children:e.rsSaveFail})),Dt=Pd(de).length,De=I,Ke=(T||w).trim(),Ve=m.find(P=>He(P.name)===He(Ke)),lt=pt(w)||D||pt((Ve==null?void 0:Ve.website)||"")||pt((Ve==null?void 0:Ve.domain)||""),L=H||pt((Ve==null?void 0:Ve.url)||""),Y=ft?e.actAnalyse:Ke?e.evalGoOn(Ke.length>22?Ke.slice(0,21)+"…":Ke):e.evalGo,Z=re?`${Ji(pe.trim())==="youtube"&&pe.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(se)}`:ht?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(De?" rs-mode":"")+(T&&w.trim()===T||E||Q?" pair":"")+(E||Q||X?" echo":"")+(X?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((De?Q:E)||X?" flash":"")+((De?pe.trim():Na.test(w.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:De?pe:w,placeholder:De?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:De?600:200,spellCheck:De?!1:void 0,inputMode:De?"url":void 0,onChange:P=>{if(De){me(P.target.value);return}N(P.target.value),T&&P.target.value.trim()!==T&&(q(""),O(""),F(""),h(!1))},onKeyDown:P=>{P.key==="Enter"&&(De?et():Ct())}}),t.jsx("span",{className:"detect"+(De?" off":"")+(Na.test(w.trim())?" url":""),children:Ot})]}),t.jsx("span",{className:"dacts",children:De?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(re?" loading":""),disabled:re||ht||!pe.trim()&&!ge.trim(),onClick:()=>{et()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Z})]}),t.jsxs("a",{className:"viewbtn"+(ta(pe)?"":" off"),href:ta(pe)?pe.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{ta(pe)||P.preventDefault()},children:[t.jsx(Ud,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ft?" analyse":"")+(l?" loading":""),disabled:l,onClick:Ct,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Y})]}),t.jsxs("a",{className:"viewbtn sm"+(M?" searching":lt?"":" off"),href:lt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":M||void 0,title:M?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{lt||P.preventDefault()},children:[M&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),M?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(L?"":" off"),href:L||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{L||P.preventDefault()},children:e.viewSrc})]})}),p.showCredits&&Me&&t.jsxs("button",{type:"button",className:"credits"+(Me.total_available<=0&&!Me.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Me.unlimited?"∞":Me.total_available}),!Me.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Me.daily_grant+Me.purchased]}),Me.total_available<=0&&!Me.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{s({type:"ptab",tab:0}),U(!1),requestAnimationFrame(()=>{const P=document.querySelector(".atl2.cibles .desk-list");if(!P)return;const ne=window.scrollY+P.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,ne),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(I?" on":""),onClick:()=>R(!I),children:e.rsOpen}),Oe!==null&&Oe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Se?" on":""),onClick:()=>Ce(!Se),children:e.rsArchOpen(Oe)})]}),Se&&t.jsx($d,{bump:ot,cbToken:j,onClose:()=>Ce(!1),onEvaluate:P=>i(null,P),onAddAll:st}),t.jsx("div",{className:"rsp slim"+(I?" on":" off"),"aria-hidden":!I,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:I?void 0:-1,onClick:()=>J(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:_?"▴":"▾"})]}),_&&t.jsx("textarea",{className:"rstext",value:ge,placeholder:e.rsTextPh,tabIndex:I?void 0:-1,onChange:P=>B(P.target.value)})]})}),oe&&t.jsx("div",{className:"rserr",children:oe}),de&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:de.title}),de.source_url&&t.jsx("a",{href:de.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{xe(null),ye(null)},children:"×"})]}),de.market&&t.jsx("p",{className:"rsmk",children:de.market}),zt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),zt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[de.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${de.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ko(de.summary_md||"").map((P,ne)=>t.jsx("p",{children:P},ne))})]}),t.jsx(Jo,{card:de,onEvaluate:P=>i(null,P),onAddAll:st}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Dt)}),Mt]})]}),A&&t.jsx(Qo,{}),St.slice(0,1).map((P,ne)=>{const ae=P.verdict==="kept",ue=P.verdict==="quota",we=P.verdict==="unresolved",he=ae?"var(--brand)":ue?"var(--bolt)":we?"var(--blue)":"var(--red)",Pe=ae?"var(--brand-l)":ue?"#FFF3D6":we?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":he,"--bgc":Pe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ae?"✓ "+e.kept:ue?"⏳":we?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(Ae=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ae.url.startsWith("http")?Ae.url:`https://${Ae.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ae.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Ae.url,P.name),children:e.evalPickGo})]},Ae.url))}),!ue&&!we&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:ae?1:5});const Ae=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const gt=[...document.querySelectorAll(".atl2 .list .row")].find(It=>{var Je;return(((Je=It.querySelector(".rnm"))==null?void 0:Je.textContent)||"").trim().toLowerCase().includes(Ae)});gt&&(gt.scrollIntoView({behavior:"smooth",block:"center"}),gt.classList.add("flashrow"),window.setTimeout(()=>gt.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ae?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ne)}),v&&(d.kept+d.dropped>0||St.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Vd(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Wd(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=K(),i=e.memoConsole?r.get(e.memoConsole):null,d=c.useMemo(()=>i?[i.reasoning||"",Vd(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const s=Nt(i),l=zn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:d?d.split(`

`).map((g,p)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},p)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Bt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:l===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Dn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=K(),[d,s]=c.useState(!1),[l,g]=c.useState(null),p=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!p||d)return;s(!0);const u=await fo(r,e);if(s(!1),!u){i(a.actErr);return}g(u.results||[])};return c.useEffect(()=>{if(!p)return;const u=b=>{var y;const m=String(((y=b.detail)==null?void 0:y.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,p]),c.useEffect(()=>{if(p)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,p]),p?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{x()},children:d?a.similarBusy:a.similar}),l&&(l.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:l.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Gd=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ya=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function la(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}function Cn(e){const a=la(e);if(!a)return"";try{return new URL(a).hostname.replace(/^www\./,"")}catch{return""}}function Yd(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ya(a.slice(n));break}r+=ya(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ya(a.slice(o));break}const d=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(d),l=s?s[2].toLowerCase():"";s&&Gd.has(l)?r+=`<${s[1]}${l}>`:r+=ya(a.slice(o,i+1)),n=i+1}return r}const Qd=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),Kr={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function Xo(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(Qd.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const s=d.name.toLowerCase();(!(Kr["*"].has(s)||((r=Kr[o])==null?void 0:r.has(s)))||s.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(s=>s.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(s)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}Xo(n)}}function tn(e){const a=e.cloneNode(!0);return Xo(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const an=new Map;function Kd(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=an.get(a);return r||(r=Jd(a).catch(()=>null),r.then(n=>{n||an.delete(a)}),an.set(a,r)),r}async function Jd(e){var x,u;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=new DOMParser().parseFromString(await a.text(),"text/html"),n=b=>{var m;return(((m=r.querySelector(b))==null?void 0:m.textContent)||"").trim()},o=r.querySelector(".sb-score"),i=((x=Array.from((o==null?void 0:o.classList)||[]).find(b=>b.startsWith("sb-score-")))==null?void 0:x.slice(9))||"",d=[];let s=null;const l=Array.from(r.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const b of l){if(b.classList.contains("sb-nav-heading")){s={label:(b.textContent||"").trim(),items:[]},d.push(s);continue}const m=b.getAttribute("href")||"";if(!m.startsWith("#"))continue;const y=m.slice(1),k=Xd(r,y);k&&(s||(s={label:"",items:[]},d.push(s)),s.items.push({id:y,title:(b.textContent||"").trim(),html:k,poids:k.length}))}const g=((u=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:u[1])||"",p={score:n(".sb-score"),scoreTone:i,tags:Array.from(r.querySelectorAll(".sb-tag")).map(b=>(b.textContent||"").trim()).filter(Boolean),name:n(".sidebar-company-name"),tagline:n(".sidebar-tagline"),desc:n(".meta-desc"),groups:d.filter(b=>b.items.length),mindmapSlug:r.querySelector(".cm-mindmap-png")?g:""};return p.groups.length?p:null}const Jr={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Xd(e,a){const r=e.getElementById(a),n=r?Xr(e,r):"";if(n)return n;const o=Jr[a]?e.querySelector(Jr[a]):null;return o&&o!==r?Xr(e,o):""}function Xr(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),tn(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(l=>/^h3$/i.test(l.tagName))[0]===a)for(const l of i){if(l===a)break;/^h2$/i.test(l.tagName)||o.appendChild(l.cloneNode(!0))}let s=a.nextElementSibling;for(;s&&!/^h3$/i.test(s.tagName);)o.appendChild(s.cloneNode(!0)),s=s.nextElementSibling;return o.children.length?tn(o):""}return tn(a)}const nn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ue({k:e,v:a,href:r,wide:n}){return a==null||a===""?null:t.jsxs("div",{className:"cdl"+(n?" cdw":""),children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Zd({k:e,vals:a}){const r=(a||[]).filter(Boolean);return r.length?t.jsxs("div",{className:"cdl cdw",children:[t.jsx("span",{className:"cdk",children:e}),t.jsx("span",{className:"cdtags",children:r.map(n=>t.jsx("span",{className:"cdtag",children:n},n))})]}):null}function Zr(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function eo({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const rn=new Map;function ep(e,a){const{token:r}=K(),[n,o]=c.useState(null);return c.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=rn.get(i);d||(d=es(r,e.name,e.checkId),rn.set(i,d),d.then(l=>{(!l||!l.reasoning&&!l.summaryHtml)&&rn.delete(i)}));let s=!0;return d.then(l=>{s&&l&&o({id:e.id,d:l})}),()=>{s=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const tp=6e4;function ap({o:e}){const{t:a,doDeep:r}=K(),[n,o]=c.useState(null),[i,d]=c.useState(e.memoUrl?"load":"off"),[s,l]=c.useState(()=>new Set),[g,p]=c.useState(!1),x=c.useRef(new Map);c.useEffect(()=>{let y=!0;if(l(new Set),p(!1),x.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),Kd(e.memoUrl).then(k=>{y&&(o(k),d(k?"ok":"err"))}),()=>{y=!1}},[e.memoUrl]);const u=Nt(e),b=y=>{var k;return(k=x.current.get(y))==null?void 0:k.scrollIntoView({behavior:"smooth",block:"start"})},m=t.jsxs("div",{className:"cdacts",children:[Bt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:y=>{y.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const y=[e.reasoning||"",Zr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[y.length?y.join(`

`).split(`

`).map((k,f)=>t.jsx("p",{className:"cdtxt",children:k},f)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),m]})}if(i!=="ok"){const y=[e.reasoning||"",Zr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),y.length>0&&y.join(`

`).split(`

`).map((k,f)=>t.jsx("p",{className:"cdtxt",children:k},f)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:k=>{k.stopPropagation(),p(f=>!f)},children:g?a.memoHideHere:a.memoReadHere})}),g&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:k=>k.stopPropagation()}),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(y=>t.jsx("span",{className:"md-tag",children:y},y)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(y=>y.items.map(k=>t.jsx("button",{type:"button",className:"md-jump",onClick:f=>{f.stopPropagation(),b(k.id)},children:k.title},k.id)))}),n.groups.map((y,k)=>t.jsxs("div",{className:"md-grp",children:[y.label&&t.jsx("div",{className:"md-grp-h",children:y.label}),y.items.map(f=>{const v=f.poids>tp&&!s.has(f.id),j=f.id==="fiche-contact"||f.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:w=>{w&&x.current.set(f.id,w)},children:[t.jsx("h4",{className:"md-h",children:f.title}),j&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:w=>w.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"LinkedIn"})]}),v?t.jsx("button",{type:"button",className:"abtn md-more",onClick:w=>{w.stopPropagation(),l(N=>new Set(N).add(f.id))},children:a.memoUnfold(Math.round(f.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:f.html}}),!v&&n.mindmapSlug&&f.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Ba}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:w=>w.stopPropagation()})]})]},f.id)})]},y.label||k)),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:a.memoOpenFull})]})}function np({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:s}=K(),[l,g]=c.useState(!1),[p,x]=c.useState(!1),[u,b]=c.useState(!1),[m,y]=c.useState(null),[k,f]=c.useState(""),[v,j]=c.useState(null),[w,N]=c.useState(""),E={airtableId:e.airtableId,checkId:e.checkId},S=!!(e.airtableId||e.checkId),T=m&&m.id===e.id?m.entries:[],q=!!m&&m.id===e.id;if(c.useEffect(()=>{f(""),j(null),b(!1)},[e.id]),c.useEffect(()=>{if(!l||q||!S||!o)return;let O=!0;x(!0),b(!1);const H=e.id;return tr(r,"list",E).then(F=>{if(!(!O||H!==e.id)){if(x(!1),!F.ok){b(!0);return}y({id:H,entries:F.entries})}}),()=>{O=!1}},[l,q,S,r,e.id,o]),!n.pipe||!o||!S)return null;const D=(O,H)=>{x(!0);const F=e.id;tr(r,O,E,H).then(M=>{if(F===e.id){if(x(!1),!M.ok){d(a.notesErr);return}y({id:F,entries:M.entries}),b(!1),O==="add"&&(f(""),i(a.notesAdded)),O==="edit"&&j(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":l,onClick:O=>{O.stopPropagation(),g(H=>!H)},children:[t.jsx("b",{children:a.notesT}),T.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(T.length)}),t.jsx("i",{children:l?"▾":"▸"})]}),l&&t.jsxs("div",{className:"dn-b",onClick:O=>O.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),p&&!T.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!p&&!u&&q&&!T.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),T.map(O=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:s==="fr"?O.date.split("-").reverse().join("/"):O.date}),v===O.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:w,rows:3,onChange:H=>N(H.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:p||!w.trim(),onClick:()=>D("edit",{entryId:O.id,text:w.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>j(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:O.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{j(O.id),N(O.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:p,onClick:()=>{window.confirm(a.notesDelAsk)&&D("delete",{entryId:O.id})},children:a.notesDel})]})]})]},O.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:k,onChange:O=>f(O.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:p||!k.trim(),onClick:()=>D("add",{text:k.trim()}),children:a.notesAdd})]})]})]})}function In({o:e}){var N;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:d}=K(),s=pa(e),l=Nt(e),g=(e.cribleStatus||"").trim().toUpperCase()||(s==="NO MATCH"?"NO MATCH":s==="MATCH"?"MATCH":""),p=[e.sector,e.market,(e.tags||[]).filter(Boolean).length?"1":"",e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.provQuery,Cn(e.provUrl||""),Ca(e),e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,u=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=c.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(g?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Bt(e)?1:0},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:u}].filter(E=>E.n>0),[e,a,o,g,l,p,x,u]),[m,y]=c.useState(""),k=b.some(E=>E.k===m)?m:((N=b[0])==null?void 0:N.k)||"",f=ep(e,k==="eval"||k==="conv");if(!b.length)return null;const v=((f==null?void 0:f.reasoning)||"").length>(e.reasoning||"").length?f.reasoning:e.reasoning||"",j=((f==null?void 0:f.summaryHtml)||"").length>(e.summary||"").length?f.summaryHtml:e.summary||"",w=(f==null?void 0:f.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(E=>t.jsx("button",{type:"button",role:"tab","aria-selected":k===E.k,"data-tour":"tab-"+E.k,className:k===E.k?"on":"",onClick:S=>{S.stopPropagation(),y(E.k)},children:E.lib},E.k))}),t.jsxs("div",{className:"cdbody",onClick:E=>E.stopPropagation(),children:[k==="eval"&&t.jsxs(t.Fragment,{children:[g&&t.jsxs("div",{className:"cdv1"+(g==="NO MATCH"?" out":""),children:[t.jsx("b",{children:g==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(eo,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),v&&v.split(`

`).map((E,S)=>t.jsx("p",{className:"cdtxt",children:E},S)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(rp,{o:e})]}),k==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof w=="number"&&t.jsx(eo,{v:w,sur:100,k:a.cdConvScore}),nn(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",nn(e.verdictDate,r)]})]}),j&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:Yd(j)}})]}),k==="memo"&&t.jsx(ap,{o:e}),k==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ue,{k:a.cdSector,v:e.sector}),t.jsx(Ue,{k:a.cdMarket,v:e.market,wide:!0}),t.jsx(Zd,{k:a.cdTags,vals:e.tags}),t.jsx(Ue,{k:a.cdStage,v:e.stage}),t.jsx(Ue,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ue,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Ue,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Ue,{k:a.cdAngle,v:e.angle}),t.jsx(Ue,{k:a.cdDetected,v:nn(e.date,r)}),t.jsx(Ue,{k:a.cdQuery,v:e.provQuery,wide:!0}),t.jsx(Ue,{k:a.cdSrc,v:Cn(e.provUrl||""),href:la(e.provUrl||"")}),t.jsx(Ue,{k:a.cdAngleSrc,v:Ca(e)})]}),k==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ue,{k:a.cdName,v:e.contactName}),t.jsx(Ue,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Ue,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(Ue,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),k==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(Ue,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(np,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(e),children:a.actRegen})]})]})]})]})}const wa=new Map;function rp({o:e}){const{t:a,token:r}=K(),[n,o]=c.useState(!1),[i,d]=c.useState(null);c.useEffect(()=>{if(!r||!e.name)return;const x=`${r}:${e.name.toLowerCase()}`;let u=wa.get(x);u||(u=go(r,[e.name]).then(m=>m[e.name]||Object.values(m)[0]||null).catch(()=>null),wa.set(x,u),u.then(m=>{(!m||!m.ok)&&wa.delete(x)}));let b=!0;return u.then(m=>{b&&m&&m.ok&&d(m)}),()=>{b=!1}},[r,e.id,e.name]);const s=async()=>{if(n)return;o(!0);const x=await uo(r,e.name,e.website||e.domain||"");d(x),x.ok&&wa.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(x)),o(!1)},l=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,l.value_prop],[a.qaProduct,l.produit],[a.qaModel,l.modele],[a.qaSummary,l.synthese]],p=g.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&p&&t.jsxs(t.Fragment,{children:[g.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!p&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function ca({spec:e}){const a=c.useRef(null),r=c.useRef(null),[n,o]=c.useState(!1);return c.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const s=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));ar({kind:"op",card:e},g).then(p=>{!d&&p&&i.isConnected&&i.replaceChildren(p)})},l=window.requestAnimationFrame(s);return()=>{d=!0,window.cancelAnimationFrame(l),i.replaceChildren()}},[e]),c.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;ar({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(l=>{!d&&l&&i.isConnected&&i.replaceChildren(l)});const s=l=>{l.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{d=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Vt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const op=`
