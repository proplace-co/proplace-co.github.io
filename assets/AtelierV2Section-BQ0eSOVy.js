...
/* Afficher plus — CTA sticky bas de liste (tous contextes) */
.atl2 .moregrp{width:100%;padding:14px 16px 16px;background:linear-gradient(180deg,rgba(248,250,252,.9),#F8FAFC 45%);
  border:0;border-top:1px solid var(--line);font-size:13.5px;font-weight:700;color:var(--brand-d,#0A6B3D);
  cursor:pointer;letter-spacing:-.01em;text-align:center}
.atl2 .moregrp:hover{color:var(--brand,#0E8A4F);background:#F0FDF4}
.atl2 .moregrp .more-meta{display:block;margin-top:3px;font-family:var(--mono);font-size:10.5px;
  font-weight:600;letter-spacing:.04em;color:var(--muted,#64748b)}
