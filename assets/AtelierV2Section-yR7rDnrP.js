...
.atl2 .bulk .side .hint{white-space:nowrap}`,Zi=`
...
`,es=Xi+Zi;function Xa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function ts(){const e=Xa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function as(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=ts();return r==="0"?"client":r==="1"||Xa("embed")==="1"&&Xa("chrome")==="1"?"apercu":"client"}const ns={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},rs=e=>ns[e];function ka(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const jt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Rr(a)||ka(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Vo(e.cc)})};function Ia(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const os=60*60*1e3;function is(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>os?null:a}catch{return null}}function la(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ss=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function ls(e,a,r="default"){const n=r!=="default",o=u.useMemo(()=>e||n?{mode:"anon"}:Ro(),[e,n]),i=u.useMemo(()=>n?"visiteur":as(e,o),[e,o,n]),l=u.useMemo(()=>rs(i),[i]),d=i!=="visiteur",c=ss(r),[g,s]=u.useState([]),[h,p]=u.useState(""),[b,m]=u.useState(null),[v,y]=u.useState(null),[f,j]=u.useState(null),[E,k]=u.useState(()=>new Map),[N,z]=u.useState(()=>new Map),[S,q]=u.useState(""),[A,R]=u.useState(new Set),[P,I]=u.useState(null),[L,F]=u.useState(!0),[x,T]=u.useState(!1),[B,G]=u.useState(0),[H,Q]=u.useState(0),X=u.useRef(0),K=u.useMemo(()=>{var Z;if(i!=="client")return"";try{return((Z=Mo())==null?void 0:Z.email)||""}catch{return""}},[i]);u.useEffect(()=>{const Z=++X.current;let ge=!0;const _=()=>ge&&Z===X.current,ie=(d&&o.token?o.token:"pub:"+a)+(c?":"+c:""),me=is(ie);return me?(s(me.objs.map(jt)),me.fund&&p(me.fund),m(me.marketEstimate??null),y(me.criteria??null),j(me.stats??null),q(me.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const Le=await Oa(),te=((Le==null?void 0:Le.recent_ops)||[]).map(pe=>{const he=xa(pe.company_name||pe.title?pe:{...pe,title:(pe.headline_fr||pe.headline||"").slice(0,120)},a),de=String(pe.rubrique||"").toLowerCase();return he&&(de==="nominations"||de==="recrutements")&&(he.engine=de),he&&!String(pe.company_name||"").trim()&&(he.noCo=!0),he}).filter(pe=>!!pe).map(pe=>(Rr((pe.name||"").trim())||(pe.noCo=!0),pe));try{const pe=Oo(),he=await Do(),de=((he==null?void 0:he.date)||"").slice(0,10),Y=pe?pe.doc:he,ne=Po(Y),se=((pe==null?void 0:pe.day)||(Y==null?void 0:Y.date)||de||"").slice(0,10);if(se&&ne.length){const be=new Set;for(const Se of te){if((Se.date||"").slice(0,10)!==se)continue;const re=qn(ne,be,Se.name,"");re>=0&&(be.add(re),Se.decryptHtml=ne[re].html)}for(const Se of te){if(Se.decryptHtml||(Se.date||"").slice(0,10)!==se)continue;const re=qn(ne,be,"",Se.headline||Se.tagline||Se.name);re>=0&&(be.add(re),Se.decryptHtml=ne[re].html)}}if(se){const be=((Y==null?void 0:Y.title_fr)||"").trim(),Se=((Y==null?void 0:Y.lead_fr)||"").trim(),re=Io(Y),ce=((Y==null?void 0:Y.url)||"").trim();be&&(re||ce)&&te.unshift({id:`edito:${se}`,kind:"op",name:be,cc:null,date:se,engine:"edito",dealKind:"other",headline:be,tagline:Se||be,decryptHtml:re||void 0,url:ce,noCo:!0})}}catch{}if(!_())return;s(te.map(jt)),la(ie,{objs:te})}else if(typeof r=="object"){const te=(await Ln()||[]).filter(he=>(he.slug||"")===r.research).map(he=>Fn(he,a)).filter(he=>!!he),pe=Ia(await Rn(te,a));if(!_())return;s(pe.map(jt)),la(ie,{objs:pe})}else if(d&&o.token){const Le=Bo(o.token),te=Oa(),pe=_o(o.token),he=$o(o.token),de=Uo(o.token),Y=await Le;let ne=Y?Y.targets:[];_()&&Y&&(p(Y.fund||""),m(Y.marketEstimate??null),y(Y.criteria??null),j(Y.stats??null),q(Y.generatedAt||""),s(ne.map(jt)),F(!1),T(!1));const[se,be,Se,re]=await Promise.all([te,pe,he,de]),ce=((se==null?void 0:se.recent_ops)||[]).map(Ce=>xa(Ce,a)).filter(Ce=>!!Ce),_e=new Set(ne.map(Ce=>Ce.id));if(ne=[...ne,...ce.filter(Ce=>!_e.has(Ce.id)&&(_e.add(Ce.id),!0))],!_())return;s(ne.map(jt));const Pe=new Set;for(const Ce of be){const ve=(Ce.id||Ce.co||"").toString().trim().toLowerCase();ve&&Pe.add(ve.startsWith("t:")?ve:"t:"+ve)}R(Pe),k(Se),z(re),Y&&la(ie,{fund:Y.fund,marketEstimate:Y.marketEstimate,criteria:Y.criteria,stats:Y.stats,generatedAt:Y.generatedAt,objs:ne})}else{const Le=Ho(),te=Ln(),pe=Oa(),he=await Le;_()&&he.length&&(s(Ia(he).map(jt)),F(!1),T(!1));const[de,Y]=await Promise.all([te,pe]),ne=(de||[]).map(re=>Fn(re,a)).filter(re=>!!re),se=await Rn(ne,a),be=((Y==null?void 0:Y.recent_ops)||[]).map(re=>xa(re,a)).filter(re=>!!re),Se=Ia([...he,...se,...be]);if(!_())return;s(Se.map(jt)),la(ie,{objs:Se})}_()&&T(!1)}catch{_()&&!me&&T(!0)}finally{_()&&F(!1)}})(),()=>{ge=!1}},[d,o.token,a,B,c]),u.useEffect(()=>{if(!l.showCredits||!K){I(null);return}let Z=!0;return(async()=>{try{const ge=await fetch(`${hn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:K})});if(!ge.ok)return;const _=await ge.json();Z&&_&&_.ok!==!1&&I(_)}catch{}})(),()=>{Z=!1}},[l.showCredits,K,H]);const ue=u.useCallback(Z=>R(new Set(Z)),[]);return{session:o,mode:i,caps:l,fund:h,email:K,marketEstimate:b,generatedAt:S,criteria:v,stats:f,thumbs:E,stages:N,dossiers:g,favIds:A,setFavIds:ue,credits:P,reloadCredits:()=>Q(Z=>Z+1),loading:L,error:x,refresh:()=>G(Z=>Z+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const $r=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),ds=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...$r(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),cs=new Set(["signal","amount","score","crible","memo"]);function ps(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:$r(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:cs.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Ur)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Ur=80;function ja(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Re(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(xn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(mt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Et(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function Xt(e,a,r){return We(e)?ja(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ja(e,a.filters,r)}function us(e,a,r,n){return!(!Xt(e,a,r)||r&&!Wo(e,a.ptab,n))}function vn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-mt(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Yo(o);case"memo":return Go(o);case"signal":{const i=Re(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),d=n(i);return l<d?-a.dir:l>d?a.dir:(o.name||"").localeCompare(i.name||"")})}const Ba={},Vn=(Ba==null?void 0:Ba.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Wn(){return new Date().toISOString().slice(0,10)}const yn=u.createContext(null);function Hr(){return u.useContext(yn)}function ms(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),l=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function fs(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),l=o.value,d=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(l);!d&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function Gn(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),l=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(d=>n.removeAttribute(d.name)),l&&n.setAttribute("class",l),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Yn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${i} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${i} ${r[1]}`}function Vr(){const e=u.useContext(yn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function hs({token:e,children:a}){const{dispatch:r,st:n,lang:o}=W(),[i,l]=u.useState(()=>n.filters.day||Wn()),[d,c]=u.useState(null),[g,s]=u.useState(!1),h=u.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){l(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),p=u.useCallback(()=>{l(Wn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);u.useEffect(()=>{const v=y=>{var j;const f=(j=y.detail)==null?void 0:j.day;typeof f=="string"&&h(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[h]),u.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),u.useEffect(()=>{if(!e||!i)return;let v=!1;s(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Vn}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{v||c(f)}).catch(()=>{v||c({ok:!1,error:"network"})}).finally(()=>{v||s(!1)}),()=>{v=!0}},[e,i]);const b=u.useMemo(()=>`${Vn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=u.useMemo(()=>({token:e,day:i,ed:d,loading:g,pickDay:h,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,d,g,h,p,n.filters.day,b,o]);return t.jsx(yn.Provider,{value:m,children:a})}function xs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Vr(),[o,i]=u.useState(()=>n||Mr());return u.useEffect(()=>{n&&i(!0)},[n]),u.useEffect(()=>{const l=d=>{var c;return i(!!((c=d.detail)!=null&&c.open))};return window.addEventListener(ya,l),()=>window.removeEventListener(ya,l)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Ko,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function gs(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Kn(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Qn(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function bs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Vr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok,g=u.useRef(null),[s,h]=u.useState("fonds"),[p,b]=u.useState(null),[m,v]=u.useState("idle"),y=u.useRef(!1);u.useEffect(()=>{b(null),v("idle"),y.current=!1,h("fonds")},[e]),u.useEffect(()=>{if(s!=="jour"||y.current)return;y.current=!0;let N=!0;return v("load"),gs(e).then(z=>{N&&(b(z),v("fait"))}),()=>{N=!1}},[s,e]);const f=u.useMemo(()=>fs((p==null?void 0:p.html)||""),[p==null?void 0:p.html]),j=u.useRef(null);u.useEffect(()=>{const N=j.current;if(!N||!f)return;let z=!1;return Ga(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(z||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{z=!0}},[f]);const E=u.useMemo(()=>Gn((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=u.useMemo(()=>Gn((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return u.useEffect(()=>{const N=g.current;if(!N||!E)return;let z=!1;return Ga(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(z||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{z=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":s==="fonds",onClick:()=>h("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":s==="jour",onClick:()=>h("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),s==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),s==="fonds"&&r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),s==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s==="fonds"&&d&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Kn(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Yn(e,!0)}),"."]}):Kn(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Yn(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>h("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),s==="fonds"&&l&&E?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,s==="fonds"&&l&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,s==="jour"&&(f?t.jsxs(t.Fragment,{children:[(p==null?void 0:p.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:p.title}),t.jsx("div",{ref:j,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Qn(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Qn(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const vs=300,da=7,ys={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Wr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},ws=["hiring","raised","news","posting","building","community","registry","exodus","other"];function _a(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Zo(r)&&r!=="media")return"news:"+r;const n=Re(e);return n?"sig:"+(n.theme&&Wr.fr[n.theme]?n.theme:"other"):"actualites"}function ks(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:l,fund:d}=W(),c=Hr(),g=l==="en",[s,h]=u.useState("all"),[p,b]=u.useState(!1),m=u.useMemo(()=>{var ge;const x=(a.filters.day||"").slice(0,10),T=_=>!(!i&&a.continent!=="monde"&&_.continent!==a.continent||x&&(_.date||"").slice(0,10)!==x),B=e.filter(_=>T(_)&&Re(_)&&(!i||_.kind!=="target"||Ae(_)!==5)),G=i&&(((ge=c==null?void 0:c.ed)==null?void 0:ge.ops)||[]).length?c.ed.ops.map(_=>xa(_,l)).filter(_=>!!_).map(_=>(_.briefOnly=!0,_)).filter(_=>!x||(_.date||"").slice(0,10)===x):[],H=e.filter(_=>T(_)&&_.kind==="op"&&(x?!0:mt(_.date)<=da)),Q=i?G.length?G:H.filter(_=>{const ie=(d||"").trim().toLowerCase();if(!ie)return!1;const me=_.match||null;return me?Object.keys(me).map(Le=>Le.trim().toLowerCase()).includes(ie):!1}):H,X=x||new Date().toISOString().slice(0,10),K=_=>{const ie=_a(_);return ie==="ma"?0:ie==="levees"?1:2};Q.sort((_,ie)=>{const me=K(_)-K(ie);if(me)return me;const Le=(_.date||"").slice(0,10)===X?0:1,te=(ie.date||"").slice(0,10)===X?0:1;return Le!==te?Le-te:(ie.amountEur||0)-(_.amountEur||0)});const ue=new Set,Z=[];for(const _ of[...Q,...vn(B,{key:"signal",dir:-1})]){const ie=_.id||_.name;!ie||ue.has(ie)||(ue.add(ie),Z.push(_))}return i&&Z.length===0?e.filter(ie=>T(ie)&&mt(ie.date)<=da).sort((ie,me)=>(me.date||"").localeCompare(ie.date||"")).slice(0,80):Z},[e,a.continent,a.filters.day,i,d,l,c]),v=u.useMemo(()=>{const x={};for(const T of m){const B=_a(T);x[B]=(x[B]||0)+1}return x},[m]),y=u.useMemo(()=>s==="all"?m:m.filter(x=>_a(x)===s),[m,s]),f=u.useMemo(()=>y.slice(0,vs),[y]),j=y.length-f.length,E=u.useRef(null);u.useEffect(()=>{var Q,X;const x=E.current;if(!x)return;const T=()=>{const K=x.scrollWidth;K<200||(x.style.animationDuration=Math.max(18,Math.round(K/130))+"s")};T();const B=requestAnimationFrame(T),G=window.setTimeout(T,1200);let H=!0;return(X=(Q=document.fonts)==null?void 0:Q.ready)==null||X.then(()=>{H&&T()}),()=>{H=!1,cancelAnimationFrame(B),window.clearTimeout(G)}},[f.length,s]);const k=x=>x==="all"?m.length:v[x]||0,N=x=>{if(x==="all")return g?"All":"Tout";if(x.startsWith("sig:"))return Wr[g?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const T=x.slice(5);return Jo[T]?Xo(T,g?"en":"fr"):x}return ys[g?"en":"fr"][x]},z=[{k:"all"}],S=["ma","levees"].filter(x=>k(x)>0||x===s);if(S.length){z.push({g:g?"Deals":"Opérations"});for(const x of S)z.push({k:x})}const q=["nominations","recrutements"].filter(x=>k(x)>0||x===s),A=Qo.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===s),R=k("actualites")>0||s==="actualites"?["actualites"]:[];if(q.length||A.length||R.length){z.push({g:g?"News":"Actualités"});for(const x of q)z.push({k:x});for(const x of A)z.push({k:x});for(const x of R)z.push({k:x})}const P=ws.map(x=>"sig:"+x).filter(x=>k(x)>0||x===s);if(P.length){z.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of P)z.push({k:x})}const I=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},L=(()=>{const x=(a.filters.day||"").slice(0,10),T=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(g?`LIVE covers the events of ${I(x)}.`:`Le LIVE regroupe les événements du ${I(x)}.`)+T:(g?`LIVE covers the still-open signals and the deals of the last ${da} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${da} derniers jours.`)+T})(),F=x=>f.map(T=>t.jsxs("button",{type:"button",className:"tk"+(De(T)?" spent":""),onClick:B=>{const G=T.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:G?"":T.id,name:T.name,url:T.url||"",text:T.tagline||T.headline||"",card:T.card}}))}catch{}if(G||n({type:"focus",id:T.id}),a.dens!=="liste"){const H=B.currentTarget.getBoundingClientRect();n({type:"popup",id:T.id,anchor:{x:H.left+H.width/2,y:H.bottom}})}},title:T.name+(T.tagline?" — "+T.tagline:""),children:[t.jsx(gt,{o:T}),t.jsxs("span",{className:"who",children:[t.jsx(So,{o:T}),t.jsx("span",{className:"co",children:T.name})]}),typeof T.amountEur=="number"&&T.amountEur>0&&t.jsx("span",{className:"am",children:Qd(T.amountEur)}),T.sector&&t.jsx("span",{className:"mt",children:T.sector}),t.jsx(Ra,{o:T}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(T.id||T.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>b(x=>!x),children:[N(s),t.jsx("b",{children:k(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:L}),z.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===s,onClick:()=>{h(x.k),b(!1)},children:[N(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:E,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(Ns,{isEn:g})]})}const js=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Ns({isEn:e}){const[a,r]=u.useState(()=>Mr());u.useEffect(()=>{const o=i=>{var l;return r(!!((l=i.detail)!=null&&l.open))};return window.addEventListener(ya,o),()=>window.removeEventListener(ya,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>ei(!a),children:js})}const wn="+33 6 83 10 72 86",Na="alexandre@proplace.co",Gr=`tel:${wn.replace(/[^\d+]/g,"")}`;function Es(){return null}class rt extends u.Component{constructor(){super(...arguments);An(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Yr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Jn(e,a){if((bt(e)||"").startsWith("CALL")&&Ae(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ae(e)>=2;return Yr.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const Xn=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",Ss={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function Cs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:l}=W(),[d,c]=u.useState(""),[g,s]=u.useState(!1),[h,p]=u.useState(!1),b=u.useRef(null);if(u.useEffect(()=>{if(!h)return;const j=E=>{b.current&&!b.current.contains(E.target)&&(p(!1),s(!1))};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[h]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),v=async j=>{if(d)return;if(j==="Analysé"&&!e.memoUrl){s(!0);return}c(j);const E=(Jn(e,a).find(([N])=>N===j)||[j,j])[1],k=await o(e,j,{msg:a.csMoved(e.name,E)});c(""),k&&(s(!1),p(!1))},y=Jn(e,a),f=j=>(y.find(([E])=>E===j)||[])[1]||j;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:j=>j.stopPropagation(),children:y.map(([j,E])=>t.jsx("button",{type:"button",className:"rsd "+(j==="Validé"?"yes":"no")+(d===j?" busy":""),disabled:!!d,onClick:()=>{v(j)},children:E},j))}):t.jsxs("span",{className:"rstat"+(h||g?" rs-open":""),ref:b,onClick:j=>j.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":h,disabled:!!d,title:a.csLabel,className:"rsel rs-"+Xn(m),onClick:()=>{p(j=>!j),s(!1)},children:d?f(d)+"…":m?f(m):a.csNone}),h&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([j,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===j,className:"rsopt"+(m===j?" on":"")+(d===j?" busy":""),disabled:!!d,onClick:()=>{if(j===m){p(!1);return}v(j)},children:[t.jsx("i",{className:"pt2",style:{background:Ss[Xn(j)]}}),E]},j))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{i(e),s(!1),p(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const j=await o(e,"Analysé");c(""),j&&(s(!1),p(!1))})()},children:a.csAnaAnyway})]})})]})}function zs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=W(),[i,l]=u.useState(""),[d,c]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),s=(bt(e)||"").startsWith("CALL")&&Ae(e)===3,h=Ae(e)>=2,p=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(m);const v=await o(e,m);l(""),v&&(c(!0),setTimeout(()=>c(!1),2200))},b=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Yr.filter(([m])=>!(h&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{p(m)},children:v},m)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(As,{o:e})]})}function As({o:e}){const{t:a,saveNote:r,flash:n}=W(),[o,i]=u.useState(e.ceoNote||""),[l,d]=u.useState(!1),[c,g]=u.useState(!1),s=o.trim()!==(e.ceoNote||"").trim(),h=async()=>{if(l||!s)return;d(!0);const p=await r(e,o.trim());d(!1),p&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:l,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&h()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{h()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Ts({placeholder:e,onDone:a}){const{t:r}=W(),[n,o]=u.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function qs({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:l,flashErr:d}=W(),[c,g]=u.useState(!1);if(!n.pipe||!o||n.lockActions||Ae(e)!==4)return null;const s=i(e),h=(s==null?void 0:s.stage)||"todo",p=async f=>{if(c||f===h)return;g(!0);const j=s;l(e,{stage:f,stamps:(s==null?void 0:s.stamps)||{}});const E=Math.max(Date.now(),Zn+=1);Zn=E;const k=await ti(r,{company:e.name||"",stage:f,cts:E,deal_id:e.airtableId,check_id:e.checkId});g(!1),!k.stale&&(k.ok||(l(e,j),d(a.actErr)))},b=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=h==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,j])=>t.jsx("button",{type:"button",className:"stgb"+(h===f?" on":""),disabled:c,onClick:()=>{p(f)},children:j},f)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let Zn=0;const Vt=8,xt=360;function er({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function tr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(er,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(er,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function Ls({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=W(),[l,d]=u.useState(0),[c,g]=u.useState(null),[s,h]=u.useState([]),p=u.useRef(!1),b=u.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=u.useRef(!1);u.useEffect(()=>{const S=b.current;return()=>{m.current||(n({type:"ptab",tab:S.ptab}),n({type:"dens",dens:S.dens}),n({type:"modal",modal:S.modal}))}},[]),u.useEffect(()=>{p.current||(p.current=!0,h(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const v=s[l],y=l>=s.length;u.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const S=v.click,q=window.setTimeout(()=>{const A=document.querySelector(S);A&&A.getAttribute("aria-selected")!=="true"&&A.click()},60);return()=>window.clearTimeout(q)}},[l,v]);const f=u.useRef(-1),j=u.useCallback(()=>{if(!v){g(null);return}const S=R=>{if(!R)return null;for(const P of document.querySelectorAll(R)){const I=P.getBoundingClientRect();if(I.width>1&&I.height>1)return P}return null},q=S(v.sel)||S(v.need);if(!q){g(null);return}f.current!==l&&(f.current=l,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const A=q.getBoundingClientRect();g(R=>R&&Math.abs(R.top-A.top)<1&&Math.abs(R.left-A.left)<1&&Math.abs(R.width-A.width)<1&&Math.abs(R.height-A.height)<1?R:A)},[v,l]);u.useLayoutEffect(()=>{j();const S=[90,300,700,1300].map(R=>window.setTimeout(j,R)),q=window.setInterval(j,400),A=()=>j();return window.addEventListener("scroll",A,!0),window.addEventListener("resize",A),()=>{S.forEach(R=>window.clearTimeout(R)),window.clearInterval(q),window.removeEventListener("scroll",A,!0),window.removeEventListener("resize",A)}},[j]);const E=u.useRef(a);if(E.current=a,u.useEffect(()=>{const S=q=>{q.key==="Escape"?(q.preventDefault(),q.stopPropagation(),E.current()):q.key==="ArrowRight"?d(A=>A+1):q.key==="ArrowLeft"&&d(A=>Math.max(0,A-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!s.length)return null;let k=null;const N=S=>()=>{m.current=!0,n({type:"modal",modal:null}),S()};if(y){const S=o[3]||0;S>0?k={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let z={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:xt};if(!y&&c){const S=c.bottom+14,q=window.innerHeight-S;let A=q>190?S:Math.max(12,c.top-200),R=Math.min(Math.max(12,c.left+c.width/2-xt/2),window.innerWidth-xt-12);q<=190&&c.top<212&&(window.innerWidth-c.right>=xt+40?R=Math.min(c.right+26,window.innerWidth-xt-12):c.left>=xt+40&&(R=Math.max(12,c.left-xt-26)),A=Math.max(12,c.top-Vt)),z={left:R,top:A,width:xt}}return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Vt,top:c.top-Vt,width:c.width+Vt*2,height:c.height+Vt*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:z,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(tr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(tr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(S=>S+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Kr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Qr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Fs(){var q,A;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:l,data:d,dispatch:c}=W(),g=r?a:e,s=u.useMemo(()=>g.filter(R=>mt(R.date)===0&&R.kind==="target"),[g]),h=u.useMemo(()=>r?a.filter(R=>R.kind==="target"&&Ae(R)===0).slice().sort((R,P)=>(P.date||"").localeCompare(R.date||"")):[],[a,r]),p=u.useMemo(()=>s.filter(R=>r?Ae(R)===0:!De(R)),[s,r]),b=r?h:p,m=r?a.length-h.length:s.length-p.length,v=r?a.length:s.length,y=v?Math.min(100,m/v*100):100,f=u.useMemo(()=>Kr(g),[g]),j=!!f&&mt(f)>0,E=u.useMemo(()=>j?g.filter(R=>(R.date||"").slice(0,10)===f):[],[g,f,j]),k=typeof((q=d.stats)==null?void 0:q.kept_today)=="number"?d.stats.kept_today:null,N=typeof((A=d.stats)==null?void 0:A.screened_today)=="number"?d.stats.screened_today:s.length;let z;j?z=o.morningLast(E.length,h.length,Qr(f,l)):r?z=o.morningThesis(N,h.length,k):s.length?m===0?z=o.goalSourced(s.length):m>=s.length?z=o.goalCleared:z=o.goalDone(m,s.length):z=o.goalSourced(0);const S=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&h.length&&c({type:"chainStart",queue:h.map(R=>R.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:z}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:S,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Rs(){var B,G;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:l,dossiers:d,mode:c,doSync:g,startTour:s,flash:h,flashErr:p}=W(),[b,m]=u.useState(null),[v,y]=u.useState(!0),[f,j]=u.useState([]),E=c==="client";u.useEffect(()=>{if(!o||!i)return;let H=!0;return y(!0),(async()=>{const[Q,X]=await Promise.all([gn(i),Or(o)]);H&&(Q&&m(Q),y(!1),j(X))})(),()=>{H=!1}},[o,i]);const[k,N]=u.useState(!1),z=()=>{!E||k||!i||(N(!0),ai(i).then(H=>{N(!1),H?h(e.identRepubDone):p(e.actErr)}))},S=(b==null?void 0:b.per_day)??null,q=((B=b==null?void 0:b.pool_order)==null?void 0:B.length)??0,A=f.filter(H=>H.status==="running").length,R=u.useMemo(()=>d.filter(H=>H.kind==="target"&&De(H)).length,[d]),P=l.marketEstimate,I=typeof((G=l.stats)==null?void 0:G.screened)=="number"?l.stats.screened:R,L=P&&P>0?Math.min(100,Math.round(I/P*100)):null,F=H=>H.toLocaleString(a==="en"?"en-US":"fr-FR"),x=(i||"P").split(/\s+/).map(H=>H[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const H=Date.parse(l.generatedAt||"");if(Number.isNaN(H))return"";const Q=new Date(H),X=K=>String(K).padStart(2,"0");return`${X(Q.getDate())}/${X(Q.getMonth()+1)} à ${X(Q.getHours())}:${X(Q.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?x:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),T?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(T)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&I>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:F(I)})})]}),L!==null&&P&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(I,P)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),S!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:S})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),S===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),A>0&&t.jsxs("span",{className:"ev",children:["⏳ ",A]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(q)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:H=>{H.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||k,onClick:z,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:H=>n({type:"filters",patch:{search:H.target.value}})})]})]})]})}class Ct{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],l=a+i,d=Math.abs(a)<Math.abs(i)?a-(l-i):i-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,o=a[--r],l=n+o,i=o-(l-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=l+o,o==n-l&&(l=n))}return l}}function*Ms(e){for(const a of e)yield*a}function Jr(e){return Array.from(Ms(e))}var Ne=1e-6,fe=Math.PI,Qe=fe/2,ar=fe/4,Xe=fe*2,ct=180/fe,Ve=fe/180,ze=Math.abs,Os=Math.atan,Zt=Math.atan2,Te=Math.cos,qe=Math.sin,Ds=Math.sign||function(e){return e>0?1:e<0?-1:0},At=Math.sqrt;function Ps(e){return e>1?0:e<-1?fe:Math.acos(e)}function ea(e){return e>1?Qe:e<-1?-Qe:Math.asin(e)}function Je(){}function Ea(e,a){e&&rr.hasOwnProperty(e.type)&&rr[e.type](e,a)}var nr={Feature:function(e,a){Ea(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ea(r[n].geometry,a)}},rr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Za(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Za(r[n],a,0)},Polygon:function(e,a){or(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)or(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ea(r[n],a)}};function Za(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function or(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Za(e[r],a,1);a.polygonEnd()}function qt(e,a){e&&nr.hasOwnProperty(e.type)?nr[e.type](e,a):Ea(e,a)}function en(e){return[Zt(e[1],e[0]),ea(e[2])]}function Mt(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*qe(a),qe(r)]}function ca(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Sa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function $a(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function pa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function tn(e){var a=At(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function an(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function nn(e,a){return ze(e)>fe&&(e-=Math.round(e/Xe)*Xe),[e,a]}nn.invert=nn;function Is(e,a,r){return(e%=Xe)?a||r?an(sr(e),lr(a,r)):sr(e):a||r?lr(a,r):nn}function ir(e){return function(a,r){return a+=e,ze(a)>fe&&(a-=Math.round(a/Xe)*Xe),[a,r]}}function sr(e){var a=ir(e);return a.invert=ir(-e),a}function lr(e,a){var r=Te(e),n=qe(e),o=Te(a),i=qe(a);function l(d,c){var g=Te(c),s=Te(d)*g,h=qe(d)*g,p=qe(c),b=p*r+s*n;return[Zt(h*o-b*i,s*r-p*n),ea(b*o+h*i)]}return l.invert=function(d,c){var g=Te(c),s=Te(d)*g,h=qe(d)*g,p=qe(c),b=p*o-h*i;return[Zt(h*o+p*i,s*r+b*n),ea(b*r-s*n)]},l}function Bs(e,a,r,n,o,i){if(r){var l=Te(a),d=qe(a),c=n*r;o==null?(o=a+n*Xe,i=a-c/2):(o=dr(l,o),i=dr(l,i),(n>0?o<i:o>i)&&(o+=n*Xe));for(var g,s=o;n>0?s>i:s<i;s-=c)g=en([l,-d*Te(s),-d*qe(s)]),e.point(g[0],g[1])}}function dr(e,a){a=Mt(a),a[0]-=e,tn(a);var r=Ps(-a[1]);return((-a[2]<0?-r:r)+Xe-Ne)%Xe}function Xr(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Je,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ga(e,a){return ze(e[0]-a[0])<Ne&&ze(e[1]-a[1])<Ne}function ua(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Zr(e,a,r,n,o){var i=[],l=[],d,c;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,y=m[0],f=m[v],j;if(ga(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),d=0;d<v;++d)o.point((y=m[d])[0],y[1]);o.lineEnd();return}f[0]+=2*Ne}i.push(j=new ua(y,m,null,!0)),l.push(j.o=new ua(y,null,j,!1)),i.push(j=new ua(f,m,null,!1)),l.push(j.o=new ua(f,null,j,!0))}}),!!i.length){for(l.sort(a),cr(i),cr(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var g=i[0],s,h;;){for(var p=g,b=!0;p.v;)if((p=p.n)===g)return;s=p.z,o.lineStart();do{if(p.v=p.o.v=!0,p.e){if(b)for(d=0,c=s.length;d<c;++d)o.point((h=s[d])[0],h[1]);else n(p.x,p.n.x,1,o);p=p.n}else{if(b)for(s=p.p.z,d=s.length-1;d>=0;--d)o.point((h=s[d])[0],h[1]);else n(p.x,p.p.x,-1,o);p=p.p}p=p.o,s=p.z,b=!b}while(!p.v);o.lineEnd()}}}function cr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Ua(e){return ze(e[0])<=fe?e[0]:Ds(e[0])*((ze(e[0])+fe)%Xe-fe)}function _s(e,a){var r=Ua(a),n=a[1],o=qe(n),i=[qe(r),-Te(r),0],l=0,d=0,c=new Ct;o===1?n=Qe+Ne:o===-1&&(n=-Qe-Ne);for(var g=0,s=e.length;g<s;++g)if(p=(h=e[g]).length)for(var h,p,b=h[p-1],m=Ua(b),v=b[1]/2+ar,y=qe(v),f=Te(v),j=0;j<p;++j,m=k,y=z,f=S,b=E){var E=h[j],k=Ua(E),N=E[1]/2+ar,z=qe(N),S=Te(N),q=k-m,A=q>=0?1:-1,R=A*q,P=R>fe,I=y*z;if(c.add(Zt(I*A*qe(R),f*S+I*Te(R))),l+=P?q+A*Xe:q,P^m>=r^k>=r){var L=Sa(Mt(b),Mt(E));tn(L);var F=Sa(i,L);tn(F);var x=(P^q>=0?-1:1)*ea(F[2]);(n>x||n===x&&(L[0]||L[1]))&&(d+=P^q>=0?1:-1)}}return(l<-Ne||l<Ne&&c<-1e-12)^d&1}function eo(e,a,r,n){return function(o){var i=a(o),l=Xr(),d=a(l),c=!1,g,s,h,p={point:b,lineStart:v,lineEnd:y,polygonStart:function(){p.point=f,p.lineStart=j,p.lineEnd=E,s=[],g=[]},polygonEnd:function(){p.point=b,p.lineStart=v,p.lineEnd=y,s=Jr(s);var k=_s(g,n);s.length?(c||(o.polygonStart(),c=!0),Zr(s,Us,k,r,o)):k&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),s=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,N){e(k,N)&&o.point(k,N)}function m(k,N){i.point(k,N)}function v(){p.point=m,i.lineStart()}function y(){p.point=b,i.lineEnd()}function f(k,N){h.push([k,N]),d.point(k,N)}function j(){d.lineStart(),h=[]}function E(){f(h[0][0],h[0][1]),d.lineEnd();var k=d.clean(),N=l.result(),z,S=N.length,q,A,R;if(h.pop(),g.push(h),h=null,!!S){if(k&1){if(A=N[0],(q=A.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),z=0;z<q;++z)o.point((R=A[z])[0],R[1]);o.lineEnd()}return}S>1&&k&2&&N.push(N.pop().concat(N.shift())),s.push(N.filter($s))}}return p}}function $s(e){return e.length>1}function Us(e,a){return((e=e.x)[0]<0?e[1]-Qe-Ne:Qe-e[1])-((a=a.x)[0]<0?a[1]-Qe-Ne:Qe-a[1])}const pr=eo(function(){return!0},Hs,Ws,[-fe,-Qe]);function Hs(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,l){var d=i>0?fe:-fe,c=ze(i-a);ze(c-fe)<Ne?(e.point(a,r=(r+l)/2>0?Qe:-Qe),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(i,r),o=0):n!==d&&c>=fe&&(ze(a-n)<Ne&&(a-=n*Ne),ze(i-d)<Ne&&(i-=d*Ne),r=Vs(a,r,i,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),o=0),e.point(a=i,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Vs(e,a,r,n){var o,i,l=qe(e-r);return ze(l)>Ne?Os((qe(a)*(i=Te(n))*qe(r)-qe(n)*(o=Te(a))*qe(e))/(o*i*l)):(a+n)/2}function Ws(e,a,r,n){var o;if(e==null)o=r*Qe,n.point(-fe,o),n.point(0,o),n.point(fe,o),n.point(fe,0),n.point(fe,-o),n.point(0,-o),n.point(-fe,-o),n.point(-fe,0),n.point(-fe,o);else if(ze(e[0]-a[0])>Ne){var i=e[0]<a[0]?fe:-fe;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Gs(e){var a=Te(e),r=2*Ve,n=a>0,o=ze(a)>Ne;function i(s,h,p,b){Bs(b,e,r,p,s,h)}function l(s,h){return Te(s)*Te(h)>a}function d(s){var h,p,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(y,f){var j=[y,f],E,k=l(y,f),N=n?k?0:g(y,f):k?g(y+(y<0?fe:-fe),f):0;if(!h&&(m=b=k)&&s.lineStart(),k!==b&&(E=c(h,j),(!E||ga(h,E)||ga(j,E))&&(j[2]=1)),k!==b)v=0,k?(s.lineStart(),E=c(j,h),s.point(E[0],E[1])):(E=c(h,j),s.point(E[0],E[1],2),s.lineEnd()),h=E;else if(o&&h&&n^k){var z;!(N&p)&&(z=c(j,h,!0))&&(v=0,n?(s.lineStart(),s.point(z[0][0],z[0][1]),s.point(z[1][0],z[1][1]),s.lineEnd()):(s.point(z[1][0],z[1][1]),s.lineEnd(),s.lineStart(),s.point(z[0][0],z[0][1],3)))}k&&(!h||!ga(h,j))&&s.point(j[0],j[1]),h=j,b=k,p=N},lineEnd:function(){b&&s.lineEnd(),h=null},clean:function(){return v|(m&&b)<<1}}}function c(s,h,p){var b=Mt(s),m=Mt(h),v=[1,0,0],y=Sa(b,m),f=ca(y,y),j=y[0],E=f-j*j;if(!E)return!p&&s;var k=a*f/E,N=-a*j/E,z=Sa(v,y),S=pa(v,k),q=pa(y,N);$a(S,q);var A=z,R=ca(S,A),P=ca(A,A),I=R*R-P*(ca(S,S)-1);if(!(I<0)){var L=At(I),F=pa(A,(-R-L)/P);if($a(F,S),F=en(F),!p)return F;var x=s[0],T=h[0],B=s[1],G=h[1],H;T<x&&(H=x,x=T,T=H);var Q=T-x,X=ze(Q-fe)<Ne,K=X||Q<Ne;if(!X&&G<B&&(H=B,B=G,G=H),K?X?B+G>0^F[1]<(ze(F[0]-x)<Ne?B:G):B<=F[1]&&F[1]<=G:Q>fe^(x<=F[0]&&F[0]<=T)){var ue=pa(A,(-R+L)/P);return $a(ue,S),[F,en(ue)]}}}function g(s,h){var p=n?e:fe-e,b=0;return s<-p?b|=1:s>p&&(b|=2),h<-p?b|=4:h>p&&(b|=8),b}return eo(l,d,i,n?[0,-e]:[-fe,e-fe])}function Ys(e,a,r,n,o,i){var l=e[0],d=e[1],c=a[0],g=a[1],s=0,h=1,p=c-l,b=g-d,m;if(m=r-l,!(!p&&m>0)){if(m/=p,p<0){if(m<s)return;m<h&&(h=m)}else if(p>0){if(m>h)return;m>s&&(s=m)}if(m=o-l,!(!p&&m<0)){if(m/=p,p<0){if(m>h)return;m>s&&(s=m)}else if(p>0){if(m<s)return;m<h&&(h=m)}if(m=n-d,!(!b&&m>0)){if(m/=b,b<0){if(m<s)return;m<h&&(h=m)}else if(b>0){if(m>h)return;m>s&&(s=m)}if(m=i-d,!(!b&&m<0)){if(m/=b,b<0){if(m>h)return;m>s&&(s=m)}else if(b>0){if(m<s)return;m<h&&(h=m)}return s>0&&(e[0]=l+s*p,e[1]=d+s*b),h<1&&(a[0]=l+h*p,a[1]=d+h*b),!0}}}}}var Wt=1e9,ma=-Wt;function Ks(e,a,r,n){function o(g,s){return e<=g&&g<=r&&a<=s&&s<=n}function i(g,s,h,p){var b=0,m=0;if(g==null||(b=l(g,h))!==(m=l(s,h))||c(g,s)<0^h>0)do p.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+h+4)%4)!==m);else p.point(s[0],s[1])}function l(g,s){return ze(g[0]-e)<Ne?s>0?0:3:ze(g[0]-r)<Ne?s>0?2:1:ze(g[1]-a)<Ne?s>0?1:0:s>0?3:2}function d(g,s){return c(g.x,s.x)}function c(g,s){var h=l(g,1),p=l(s,1);return h!==p?h-p:h===0?s[1]-g[1]:h===1?g[0]-s[0]:h===2?g[1]-s[1]:s[0]-g[0]}return function(g){var s=g,h=Xr(),p,b,m,v,y,f,j,E,k,N,z,S={point:q,lineStart:I,lineEnd:L,polygonStart:R,polygonEnd:P};function q(x,T){o(x,T)&&s.point(x,T)}function A(){for(var x=0,T=0,B=b.length;T<B;++T)for(var G=b[T],H=1,Q=G.length,X=G[0],K,ue,Z=X[0],ge=X[1];H<Q;++H)K=Z,ue=ge,X=G[H],Z=X[0],ge=X[1],ue<=n?ge>n&&(Z-K)*(n-ue)>(ge-ue)*(e-K)&&++x:ge<=n&&(Z-K)*(n-ue)<(ge-ue)*(e-K)&&--x;return x}function R(){s=h,p=[],b=[],z=!0}function P(){var x=A(),T=z&&x,B=(p=Jr(p)).length;(T||B)&&(g.polygonStart(),T&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),B&&Zr(p,d,x,i,g),g.polygonEnd()),s=g,p=b=m=null}function I(){S.point=F,b&&b.push(m=[]),N=!0,k=!1,j=E=NaN}function L(){p&&(F(v,y),f&&k&&h.rejoin(),p.push(h.result())),S.point=q,k&&s.lineEnd()}function F(x,T){var B=o(x,T);if(b&&m.push([x,T]),N)v=x,y=T,f=B,N=!1,B&&(s.lineStart(),s.point(x,T));else if(B&&k)s.point(x,T);else{var G=[j=Math.max(ma,Math.min(Wt,j)),E=Math.max(ma,Math.min(Wt,E))],H=[x=Math.max(ma,Math.min(Wt,x)),T=Math.max(ma,Math.min(Wt,T))];Ys(G,H,e,a,r,n)?(k||(s.lineStart(),s.point(G[0],G[1])),s.point(H[0],H[1]),B||s.lineEnd(),z=!1):B&&(s.lineStart(),s.point(x,T),z=!1)}j=x,E=T,k=B}return S}}const rn=e=>e;var Ha=new Ct,on=new Ct,to,ao,sn,ln,ut={point:Je,lineStart:Je,lineEnd:Je,polygonStart:function(){ut.lineStart=Qs,ut.lineEnd=Xs},polygonEnd:function(){ut.lineStart=ut.lineEnd=ut.point=Je,Ha.add(ze(on)),on=new Ct},result:function(){var e=Ha/2;return Ha=new Ct,e}};function Qs(){ut.point=Js}function Js(e,a){ut.point=no,to=sn=e,ao=ln=a}function no(e,a){on.add(ln*e-sn*a),sn=e,ln=a}function Xs(){no(to,ao)}var Ot=1/0,Ca=Ot,ta=-Ot,za=ta,Aa={point:Zs,lineStart:Je,lineEnd:Je,polygonStart:Je,polygonEnd:Je,result:function(){var e=[[Ot,Ca],[ta,za]];return ta=za=-(Ca=Ot=1/0),e}};function Zs(e,a){e<Ot&&(Ot=e),e>ta&&(ta=e),a<Ca&&(Ca=a),a>za&&(za=a)}var dn=0,cn=0,Gt=0,Ta=0,qa=0,Lt=0,pn=0,un=0,Yt=0,ro,oo,st,lt,Ke={point:zt,lineStart:ur,lineEnd:mr,polygonStart:function(){Ke.lineStart=al,Ke.lineEnd=nl},polygonEnd:function(){Ke.point=zt,Ke.lineStart=ur,Ke.lineEnd=mr},result:function(){var e=Yt?[pn/Yt,un/Yt]:Lt?[Ta/Lt,qa/Lt]:Gt?[dn/Gt,cn/Gt]:[NaN,NaN];return dn=cn=Gt=Ta=qa=Lt=pn=un=Yt=0,e}};function zt(e,a){dn+=e,cn+=a,++Gt}function ur(){Ke.point=el}function el(e,a){Ke.point=tl,zt(st=e,lt=a)}function tl(e,a){var r=e-st,n=a-lt,o=At(r*r+n*n);Ta+=o*(st+e)/2,qa+=o*(lt+a)/2,Lt+=o,zt(st=e,lt=a)}function mr(){Ke.point=zt}function al(){Ke.point=rl}function nl(){io(ro,oo)}function rl(e,a){Ke.point=io,zt(ro=st=e,oo=lt=a)}function io(e,a){var r=e-st,n=a-lt,o=At(r*r+n*n);Ta+=o*(st+e)/2,qa+=o*(lt+a)/2,Lt+=o,o=lt*e-st*a,pn+=o*(st+e),un+=o*(lt+a),Yt+=o*3,zt(st=e,lt=a)}function so(e){this._context=e}so.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Xe);break}}},result:Je};var mn=new Ct,Va,lo,co,Kt,Qt,aa={point:Je,lineStart:function(){aa.point=ol},lineEnd:function(){Va&&po(lo,co),aa.point=Je},polygonStart:function(){Va=!0},polygonEnd:function(){Va=null},result:function(){var e=+mn;return mn=new Ct,e}};function ol(e,a){aa.point=po,lo=Kt=e,co=Qt=a}function po(e,a){Kt-=e,Qt-=a,mn.add(At(Kt*Kt+Qt*Qt)),Kt=e,Qt=a}let fr,La,hr,xr;class gr{constructor(a){this._append=a==null?uo:il(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==hr||this._append!==La){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,hr=n,La=this._append,xr=this._,this._=o}this._+=xr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function uo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function il(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return uo;if(a!==fr){const r=10**a;fr=a,La=function(o){let i=1;this._+=o[0];for(const l=o.length;i<l;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return La}function sl(e,a){let r=3,n=4.5,o,i;function l(d){return d&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),qt(d,o(i))),i.result()}return l.area=function(d){return qt(d,o(ut)),ut.result()},l.measure=function(d){return qt(d,o(aa)),aa.result()},l.bounds=function(d){return qt(d,o(Aa)),Aa.result()},l.centroid=function(d){return qt(d,o(Ke)),Ke.result()},l.projection=function(d){return arguments.length?(o=d==null?(e=null,rn):(e=d).stream,l):e},l.context=function(d){return arguments.length?(i=d==null?(a=null,new gr(r)):new so(a=d),typeof n!="function"&&i.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(i.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(i=new gr(r)),l},l.projection(e).digits(r).context(a)}function kn(e){return function(a){var r=new fn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function fn(){}fn.prototype={constructor:fn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function jn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),qt(r,e.stream(Aa)),a(Aa.result()),n!=null&&e.clipExtent(n),e}function mo(e,a,r){return jn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],l=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),d=+a[0][0]+(o-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function ll(e,a,r){return mo(e,[[0,0],a],r)}function dl(e,a,r){return jn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),l=(o-i*(n[1][0]+n[0][0]))/2,d=-i*n[0][1];e.scale(150*i).translate([l,d])},r)}function cl(e,a,r){return jn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),l=-i*n[0][0],d=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,d])},r)}var br=16,pl=Te(30*Ve);function vr(e,a){return+a?ml(e,a):ul(e)}function ul(e){return kn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ml(e,a){function r(n,o,i,l,d,c,g,s,h,p,b,m,v,y){var f=g-n,j=s-o,E=f*f+j*j;if(E>4*a&&v--){var k=l+p,N=d+b,z=c+m,S=At(k*k+N*N+z*z),q=ea(z/=S),A=ze(ze(z)-1)<Ne||ze(i-h)<Ne?(i+h)/2:Zt(N,k),R=e(A,q),P=R[0],I=R[1],L=P-n,F=I-o,x=j*L-f*F;(x*x/E>a||ze((f*L+j*F)/E-.5)>.3||l*p+d*b+c*m<pl)&&(r(n,o,i,l,d,c,P,I,A,k/=S,N/=S,z,v,y),y.point(P,I),r(P,I,A,k,N,z,g,s,h,p,b,m,v,y))}}return function(n){var o,i,l,d,c,g,s,h,p,b,m,v,y={point:f,lineStart:j,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=N},polygonEnd:function(){n.polygonEnd(),y.lineStart=j}};function f(q,A){q=e(q,A),n.point(q[0],q[1])}function j(){h=NaN,y.point=E,n.lineStart()}function E(q,A){var R=Mt([q,A]),P=e(q,A);r(h,p,s,b,m,v,h=P[0],p=P[1],s=q,b=R[0],m=R[1],v=R[2],br,n),n.point(h,p)}function k(){y.point=f,n.lineEnd()}function N(){j(),y.point=z,y.lineEnd=S}function z(q,A){E(o=q,A),i=h,l=p,d=b,c=m,g=v,y.point=E}function S(){r(h,p,s,b,m,v,i,l,o,d,c,g,br,n),y.lineEnd=k,k()}return y}}var fl=kn({point:function(e,a){this.stream.point(e*Ve,a*Ve)}});function hl(e){return kn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function xl(e,a,r,n,o){function i(l,d){return l*=n,d*=o,[a+e*l,r-e*d]}return i.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*o]},i}function yr(e,a,r,n,o,i){if(!i)return xl(e,a,r,n,o);var l=Te(i),d=qe(i),c=l*e,g=d*e,s=l/e,h=d/e,p=(d*r-l*a)/e,b=(d*a+l*r)/e;function m(v,y){return v*=n,y*=o,[c*v-g*y+a,r-g*v-c*y]}return m.invert=function(v,y){return[n*(s*v-h*y+p),o*(b-h*v-s*y)]},m}function gl(e){return bl(function(){return e})()}function bl(e){var a,r=150,n=480,o=250,i=0,l=0,d=0,c=0,g=0,s,h=0,p=1,b=1,m=null,v=pr,y=null,f,j,E,k=rn,N=.5,z,S,q,A,R;function P(x){return q(x[0]*Ve,x[1]*Ve)}function I(x){return x=q.invert(x[0],x[1]),x&&[x[0]*ct,x[1]*ct]}P.stream=function(x){return A&&R===x?A:A=fl(hl(s)(v(z(k(R=x)))))},P.preclip=function(x){return arguments.length?(v=x,m=void 0,F()):v},P.postclip=function(x){return arguments.length?(k=x,y=f=j=E=null,F()):k},P.clipAngle=function(x){return arguments.length?(v=+x?Gs(m=x*Ve):(m=null,pr),F()):m*ct},P.clipExtent=function(x){return arguments.length?(k=x==null?(y=f=j=E=null,rn):Ks(y=+x[0][0],f=+x[0][1],j=+x[1][0],E=+x[1][1]),F()):y==null?null:[[y,f],[j,E]]},P.scale=function(x){return arguments.length?(r=+x,L()):r},P.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],L()):[n,o]},P.center=function(x){return arguments.length?(i=x[0]%360*Ve,l=x[1]%360*Ve,L()):[i*ct,l*ct]},P.rotate=function(x){return arguments.length?(d=x[0]%360*Ve,c=x[1]%360*Ve,g=x.length>2?x[2]%360*Ve:0,L()):[d*ct,c*ct,g*ct]},P.angle=function(x){return arguments.length?(h=x%360*Ve,L()):h*ct},P.reflectX=function(x){return arguments.length?(p=x?-1:1,L()):p<0},P.reflectY=function(x){return arguments.length?(b=x?-1:1,L()):b<0},P.precision=function(x){return arguments.length?(z=vr(S,N=x*x),F()):At(N)},P.fitExtent=function(x,T){return mo(P,x,T)},P.fitSize=function(x,T){return ll(P,x,T)},P.fitWidth=function(x,T){return dl(P,x,T)},P.fitHeight=function(x,T){return cl(P,x,T)};function L(){var x=yr(r,0,0,p,b,h).apply(null,a(i,l)),T=yr(r,n-x[0],o-x[1],p,b,h);return s=Is(d,c,g),S=an(a,T),q=an(s,S),z=vr(S,N),F()}function F(){return A=R=null,P}return function(){return a=e.apply(this,arguments),P.invert=a.invert&&I,L()}}function fo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}fo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,l=i*i;r-=o=(r*(1.007226+i*(.015085+l*(-.044475+.028874*i-.005916*l)))-a)/(1.007226+i*(.015085*3+l*(-.044475*7+.028874*9*i-.005916*11*l)))}while(ze(o)>Ne&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function vl(){return gl(fo).scale(175.295)}function yl(e){return e}function wl(e){if(e==null)return yl;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var g=2,s=d.length,h=new Array(s);for(h[0]=(a+=d[0])*n+i,h[1]=(r+=d[1])*o+l;g<s;)h[g]=d[g],++g;return h}}function kl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function jl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return wr(e,r)})}:wr(e,a)}function wr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Nl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Nl(e,a){var r=wl(e.transform),n=e.arcs;function o(s,h){h.length&&h.pop();for(var p=n[s<0?~s:s],b=0,m=p.length;b<m;++b)h.push(r(p[b],b));s<0&&kl(h,m)}function i(s){return r(s)}function l(s){for(var h=[],p=0,b=s.length;p<b;++p)o(s[p],h);return h.length<2&&h.push(h[0]),h}function d(s){for(var h=l(s);h.length<4;)h.push(h[0]);return h}function c(s){return s.map(d)}function g(s){var h=s.type,p;switch(h){case"GeometryCollection":return{type:h,geometries:s.geometries.map(g)};case"Point":p=i(s.coordinates);break;case"MultiPoint":p=s.coordinates.map(i);break;case"LineString":p=l(s.arcs);break;case"MultiLineString":p=s.arcs.map(l);break;case"Polygon":p=c(s.arcs);break;case"MultiPolygon":p=s.arcs.map(c);break;default:return null}return{type:h,coordinates:p}}return g(a)}const ho={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},El=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Sl(e,a,r){const n=ho[e];if(!n||!n.length)return-1;const o=El(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(l=>o.includes(l)))return i}return Math.floor(r*n.length)%n.length}let fa=null;function Cl(){return fa||(fa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=jl(r,n),i=vl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=sl(i),d=(o.features||[]).filter(s=>{var h;return(((h=s.properties)==null?void 0:h.name)||"")!=="Antarctica"}).map(s=>{var b;const h=((b=s.properties)==null?void 0:b.name)||"",p=l(s)||"";return p?{i2:ni(h)||null,n:h,d:p}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,h]of Object.entries(ri)){const p=i(h);p&&(c[s]={x:p[0],y:p[1]})}const g={};for(const[s,h]of Object.entries(ho)){const p=h.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));p.length&&(g[s]=p)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:d,anchors:c,metros:g}}catch{return null}})(),fa)}function zl(e){const[a,r]=u.useState(null);return u.useEffect(()=>{if(!e||a)return;let n=!1;return Cl().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Al="8 40 984 210",Tl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},kr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function jr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ql(e,a){const[r,n]=u.useState(1);return u.useEffect(()=>{let o=!0,i=0;const l=()=>{var g;if(!o)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{o=!1,cancelAnimationFrame(i),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Nr({msgs:e}){const[a,r]=u.useState(0);u.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],l)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Ll(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:l,lang:d,t:c,data:g,dossiers:s,source:h}=W(),p=g.loading&&!s.length,b=u.useRef(null),m=u.useRef(null),v=zl(e.continent==="monde"),y=e.continent==="monde"?v:bn.find(x=>x.key===e.continent)||null,f=ql(b,e.continent+":"+e.mapFolded+":"+!!y),[j,E]=u.useState(new Map),[k,N]=u.useState(null);u.useEffect(()=>{const x=b.current;if(!x)return;const T=new Map;x.querySelectorAll("path[data-i2]").forEach(B=>{const G=B.dataset.i2;if(G)try{const H=B.getBBox();H.width>0&&T.set(G,{x:H.x,y:H.y,w:H.width,h:H.height})}catch{}}),E(T)},[e.continent,f,y]);const z=u.useMemo(()=>r.filter(x=>x.cc),[r]),S=u.useMemo(()=>{const x=new Map;return z.forEach(T=>x.set(T.cc,(x.get(T.cc)||0)+1)),x},[z]),q=e.continent==="monde"&&v?v.anchors:null,A=e.continent==="monde"&&v?v.metros:null,R=u.useMemo(()=>z.map(x=>{const T=jr(x.name||x.id||""),B=jr((x.id||x.name||"")+"·y");if(q&&x.cc){const K=A?A[x.cc]:void 0;if(K&&K.length){const Z=Sl(x.cc,x.city,T);if(Z>=0&&K[Z])return{d:x,x:K[Z].x+(T-.5)*5,y:K[Z].y+(B-.5)*5}}const ue=q[x.cc];if(ue)return{d:x,x:ue.x+(T-.5)*10,y:ue.y+(B-.5)*10}}const G=x.cc?j.get(x.cc):void 0;if(!G)return null;const H=Tl[`${e.continent}:${x.cc||""}`];if(H)return{d:x,x:G.x+G.w*(H.fx+(T-.5)*H.sx),y:G.y+G.h*(H.fy+(B-.5)*H.sy)};const Q=(T-.5)*Math.min(G.w*.55,60),X=(B-.5)*Math.min(G.h*.55,60);return{d:x,x:G.x+G.w/2+Q,y:G.y+G.h/2+X}}).filter(x=>!!x),[z,j,q,A,e.continent]),P=x=>f>0?x/f:x,I=u.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:kr[x],fr:c.plabels[x].toUpperCase(),en:c.plabels[x].toUpperCase(),n:r.filter(T=>T.kind==="target"&&Ae(T)===x).length})).filter(x=>x.n>0):Mn.map((x,T)=>({...x,n:r.filter(B=>On(B)===T).length})),[r,n,c.plabels]),L=i?l.get(i):null,F=L?R.find(x=>x.d.id===L.id):null;return y?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:[p&&t.jsx(Nr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?Al:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:y.countries.map((x,T)=>t.jsx("g",{className:"ct"+(x.i2&&S.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},T))}),t.jsx("g",{children:R.map(x=>{const T=Mn[On(x.d)],B=!!Re(x.d),G=x.d.kind==="target",H=n&&G?kr[Ae(x.d)]:T.c,Q=!n&&De(x.d);return t.jsxs("g",{className:"co"+(Q?" done":""),onMouseEnter:()=>{var ue,Z;const X=(ue=m.current)==null?void 0:ue.getBoundingClientRect(),K=(Z=b.current)==null?void 0:Z.createSVGPoint();if(K&&b.current&&X){K.x=x.x,K.y=x.y;const ge=K.matrixTransform(b.current.getScreenCTM());N({x:ge.x-X.left,y:ge.y-X.top,label:x.d.name+" · "+(It(x.d.cc,d)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var ue;if(h==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const X=(ue=b.current)==null?void 0:ue.createSVGPoint();let K=null;if(X&&b.current){X.x=x.x,X.y=x.y;const Z=X.matrixTransform(b.current.getScreenCTM());K={x:Z.x,y:Z.y}}a({type:"popup",id:x.d.id,anchor:K})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:P(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:P(T.px),fill:H,stroke:B?"#DC2626":"#ffffff",strokeWidth:P(B?2.2:1.3)})]},x.d.id||x.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:P(13),fill:"none",stroke:"#0F172A",strokeWidth:P(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:I.map((x,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),d==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},T))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:t.jsx(Nr,{msgs:c.loadMsgs})})}function Fl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function xo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:l,lang:d}=W(),c=a.filters,[g,s]=u.useState(!1),[h,p]=u.useState(!1),b=u.useRef(null),m=u.useRef(null),v=u.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),y=F=>v.filter(x=>F!=="country"&&c.country.length&&!c.country.includes(x.cc||"")?!1:ja(x,c,i,F==="country"?void 0:F)),f=F=>!i||F.kind!=="op",j=u.useMemo(()=>{const F=y("win").filter(f),x=T=>F.filter(B=>(B.date?Math.max(0,Math.floor((Date.now()-Date.parse(B.date))/864e5)):9999)<=T).length;return[x(0),x(7),x(30),F.length]},[v,c,i]),E=u.useMemo(()=>c.day?y("win").filter(f).filter(F=>(F.date||"").slice(0,10)===c.day).length:0,[v,c,i]),k=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,N=k+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);u.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),u.useEffect(()=>{if(!g&&!h)return;const F=T=>{var G,H;const B=T.target;g&&!((G=b.current)!=null&&G.contains(B))&&s(!1),h&&!((H=m.current)!=null&&H.contains(B))&&p(!1)},x=T=>{T.key==="Escape"&&(s(!1),p(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",x)}},[g,h]);const z=(F,x,T,B="fbtn")=>t.jsxs("button",{type:"button",className:B,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:x}),T>0&&t.jsx("span",{className:"n",children:T}),t.jsx("span",{className:"cv",children:"▾"})]},F),S=["1","7","30","all"],q=Math.max(0,S.indexOf(c.win||"all")),A=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(Fl(c.day,d))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>p(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[q]}),t.jsx("b",{children:j[q]}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:S.map((F,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),p(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:j[x]})]},F))})]}):t.jsx("div",{className:"seg",children:S.map((F,x)=>t.jsxs("button",{type:"button","aria-pressed":c.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:j[x]})]},F))}),R=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),P=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):z("sec",o.fSector,c.sector.length),z("pay",o.fCountry,c.country.length),z("det",o.fEngine,c.engine.length),z("sta",o.fStage,c.stage.length),i&&z("ang","Angle",c.angle.length),i&&z("mem","Mémo",c.memoLevel.length)]}),I=(F=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{s(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:P})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:A}),t.jsxs("div",{className:"fstrip-b",children:[R,L,I(!1)]})]}),a.openFacet&&t.jsx(Er,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[A,R,P,t.jsx("span",{className:"fgrow"}),I()]}),a.openFacet&&t.jsx(Er,{poolFor:y})]})}function Er({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=W(),i=a.filters,l=a.openFacet,{title:d,cols:c,options:g}=u.useMemo(()=>{if(l==="sig"){const m=e("signal").filter(f=>Re(f)),v=new Map;m.forEach(f=>{const j=f.engine||"";v.set(j,(v.get(j)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Ya([...v.keys()],o).map(f=>({v:f,label:St(f)+" "+Ge(f,o),n:v.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const m=e("sector"),v=new Map;return m.forEach(y=>{y.sector&&v.set(y.sector,(v.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:i.sector.includes(y)}))}}if(l==="pay"){const m=e("country"),v=new Map;return m.forEach(y=>{y.cc&&v.set(y.cc,(v.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:It(y,o)||y,n:f,html:!1,on:i.country.includes(y)}))}}if(l==="det"){const m=e("engine"),v=new Map;return m.forEach(y=>{y.engine&&v.set(y.engine,(v.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Ya([...v.keys()],o).map(y=>({v:y,label:St(y)+" "+Ge(y,o)+' <span style="color:var(--dim);font-size:10px">· '+oi(ii(y),o)+"</span>",n:v.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(l==="ang"){const m=e("angle"),v=new Map;return m.forEach(y=>{y.angle&&v.set(y.angle,(v.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(y)}))}}if(l==="mem"){const m=e("memoLevel"),v=new Map;m.forEach(f=>{if(f.kind==="target"){const j=xn(f);v.set(j,(v.get(j)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:y[f],n:v.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const p=e("stage"),b=new Map;return p.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,v)=>v[1]-m[1]).map(([m,v])=>({v:m,label:m,n:v,html:!1,on:i.stage.includes(m)}))}},[l,a,o]),s=p=>{if(l==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(p)?i.signalEngines.filter(v=>v!==p):[...i.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:p})},h=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:h,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>s(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function go({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:l,t:d}=W(),c=u.useMemo(()=>{const b={};return r.forEach(m=>{ja(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,s]=u.useState(!1),h=u.useRef(null);u.useEffect(()=>{if(!g)return;const b=v=>{var y;(y=h.current)!=null&&y.contains(v.target)||s(!1)},m=v=>{v.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const p=b=>{const m=bn.find(v=>v.key===b);return b==="monde"?d.contWorld:l==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:h,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>s(b=>!b),children:[p(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Dn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),s(!1)},children:[p(b),t.jsx("span",{className:"n",children:c[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Dn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[p(b),t.jsx("span",{className:"n",children:c[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function bo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Rl(e){var o;const a=[],r=new Set,n=i=>{const l=(i||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Sr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:l}){const{t:d}=W();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function vo({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=W(),o=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),i=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Sr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Sr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Ml({card:e,onEvaluate:a,onAddAll:r}){var d,c,g;const{t:n}=W(),o=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),i=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:bo(e.summary_md||"").map((s,h)=>t.jsx("p",{children:s},h))})]}),t.jsx(vo,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Ol(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Dl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:l}=W(),d=o,[c,g]=u.useState(null),[s,h]=u.useState(null),[p,b]=u.useState(null),[m,v]=u.useState(!1);u.useEffect(()=>{let f=!0;return(async()=>{const j=await Dr({email:l,cbToken:d});f&&g(j)})(),()=>{f=!1}},[l,d,n]);const y=f=>{h(f),b(null),v(!0),(async()=>{const j=await si(f.id);b(j),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{h(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Ol(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!p&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&p&&t.jsx(Ml,{card:p,onEvaluate:a,onAddAll:r})]})]})}const ba=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Jt(e){return/^https?:\/\//i.test((e||"").trim())}function ot(e){const a=(e||"").trim();return a?Jt(a)?a:ba.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Pl(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Il(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:l,evalBusy:d,evalCards:c,caps:g,data:s,canWrite:h,source:p,dossiers:b,doAnalyse:m,liveMemos:v,pipe:y}=W(),f=a==="client",j=u.useMemo(()=>r||(p!=="default"?li():""),[r,p]),[E,k]=u.useState(""),[N,z]=u.useState(!1),[S,q]=u.useState(""),[A,R]=u.useState(""),[P,I]=u.useState(""),[L,F]=u.useState(!1),[x,T]=u.useState(!1),[B,G]=u.useState(""),[H,Q]=u.useState(!1),[X,K]=u.useState(""),[ue,Z]=u.useState([]),ge=u.useRef(!1),[_,ie]=u.useState(!1),[me,Le]=u.useState(!1),[te,pe]=u.useState(!1),he=u.useRef(!1),[de,Y]=u.useState(""),[ne,se]=u.useState(""),[be,Se]=u.useState(!1),[re,ce]=u.useState(!1),[_e,Pe]=u.useState(0),[Ce,ve]=u.useState(""),[ye,He]=u.useState(null),[Fe,dt]=u.useState(null),[ft,vt]=u.useState(!1),[at,yt]=u.useState(null),[wt,Ze]=u.useState(0),ht=u.useRef(!1),kt=E.trim()?ba.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting,C=u.useMemo(()=>B.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[B]);u.useEffect(()=>{if(typeof window>"u")return;const O=new URLSearchParams(window.location.search),J=(O.get("rs")||"").trim(),oe=(O.get("rstext")||"").trim();J&&/^https?:\/\//i.test(J)&&Y(J),oe&&se(oe),(J&&/^https?:\/\//i.test(J)||oe)&&ie(!0)},[]),u.useEffect(()=>{const O=J=>{const oe=J.detail||{},w=String(oe.url||"").trim(),D=String(oe.text||"").trim();w&&/^https?:\/\//i.test(w)&&Y(w),D&&se(D),(w&&/^https?:\/\//i.test(w)||D)&&(ie(!0),k(""),q(""),Se(!0),window.setTimeout(()=>Se(!1),900))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]),u.useEffect(()=>{const O=J=>{const oe=J.detail||{},w=String(oe.name||"").trim();if(!w)return;ie(!1),k(w),q(w);const D=ot(String(oe.website||oe.domain||""));R(D),I(ot(String(oe.url||""))),F(!D),z(!0),window.setTimeout(()=>z(!1),900)};return window.addEventListener("ppmap:prefill",O),()=>window.removeEventListener("ppmap:prefill",O)},[]),u.useEffect(()=>{const O=(S||"").trim();if(!O||_||A){(A||!O||_)&&F(!1);return}const J=b.find(D=>Be(D.name)===Be(O)),oe=ot((J==null?void 0:J.website)||"")||ot((J==null?void 0:J.domain)||"");if(oe){R(oe),F(!1);return}let w=!0;return F(!0),Pr(O).then(D=>{var U,ee;if(!w)return;const M=ot(D.website||"")||ot(((ee=(U=D.candidates)==null?void 0:U[0])==null?void 0:ee.url)||"");M&&R(M)}).catch(()=>{}).finally(()=>{w&&F(!1)}),()=>{w=!1}},[S,_,A,b]),u.useEffect(()=>{const O=J=>{var w;const oe=String(((w=J.detail)==null?void 0:w.url)||"").trim();Jt(oe)&&window.open(oe,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",O),()=>window.removeEventListener("ppmap:view",O)},[]),u.useEffect(()=>{if(he.current===_)return;he.current=_,pe(!0);const O=window.setTimeout(()=>pe(!1),560);return()=>window.clearTimeout(O)},[_]),u.useEffect(()=>{if(typeof window>"u")return;const O=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),J=document.querySelector(".atl2.ops, .atl2.cibles");if(!O||!J)return;const oe=()=>J.style.setProperty("--demand-h",`${O.offsetHeight}px`);oe();const w=new ResizeObserver(oe);return w.observe(O),()=>w.disconnect()},[p,N,be,x,_,te,L]),u.useEffect(()=>{if(!h&&!j){yt(null);return}let O=!0;return(async()=>{const J=await Dr({email:n,cbToken:j});O&&yt(J.length)})(),()=>{O=!1}},[h,j,n,wt]);const V=ue.length?ue:c,$=s.credits,ae=u.useCallback(O=>{const J=O.map(oe=>(oe||"").trim()).filter(Boolean);J.length&&(G(oe=>{const w=oe.split(`
`).map(U=>U.trim()).filter(Boolean),D=new Set(w.map(U=>U.toLowerCase())),M=J.filter(U=>!D.has(U.toLowerCase()));return[...w,...M].slice(0,15).join(`
`)}),T(!0))},[]);u.useEffect(()=>{if(!re)return;Pe(0);const O=window.setInterval(()=>Pe(J=>J+1),1e3);return()=>window.clearInterval(O)},[re]);const xe=u.useMemo(()=>{const O=E.trim().toLowerCase();return!O||!y?null:b.find(J=>Be(J.name)===O&&Ae(J)===1)||null},[E,b,y]),le=()=>{const O=E.trim();if(O){if(xe){m(xe);return}o(null,O),f&&k("")}},Me=async()=>{if(!f){o(null,C[0]||"");return}if(!C.length||H)return;Q(!0),ge.current=!1;const O=[];for(let J=0;J<C.length&&!ge.current;J++){K(e.evaluating(J+1,C.length,C[J]));const oe=await Ir(r,C[J],"atelier2");if(O.unshift({name:oe.company||C[J],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),Z([...O]),oe.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(C.length-J-1),remaining:0}),Z([...O]),G(C.slice(J+1).join(`
`)),K(""),Q(!1);return}}K(""),G(ge.current?C.slice(O.length).join(`
`):""),Q(!1)},Ye=async()=>{var oe,w,D;if(ht.current)return;const O=de.trim().replace(/\s+/g,""),J=ne.trim();if(!O&&!J){ve(e.rsNeed);return}if(!f&&!j){o(null,O||J.slice(0,80));return}ht.current=!0,ve(""),He(null),dt(null),ce(!0);try{const M=await ci({url:O,text:J,email:n,cbToken:j});if(ce(!1),!M||M.status!=="success"){ve((M==null?void 0:M.message)||"Erreur");return}He(M),ie(!1),ae((((oe=M.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(ee=>(ee==null?void 0:ee.name)||"")),dt({state:"pending"});const U=await pi(M,{email:n,cbToken:j});dt(U.ok?{state:"ok",scopeLabel:((w=U.summary)==null?void 0:w.scope_label)||"",scope:((D=U.summary)==null?void 0:D.scope)||""}:{state:"fail",msg:U.error||""}),U.ok&&Ze(ee=>ee+1)}finally{ht.current=!1,ce(!1)}},je=[ye==null?void 0:ye.industry,...(ye==null?void 0:ye.market_tags)||[],ye==null?void 0:ye.author].map(O=>(O||"").trim()).filter(Boolean),nt=(Fe==null?void 0:Fe.state)==="pending",_t=Fe&&(nt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Fe.state==="ok"?t.jsx("span",{className:"rslink ok",children:Fe.scope&&Fe.scope!=="public"?e.rsSavedIn(Fe.scopeLabel||Fe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Fe.msg,children:e.rsSaveFail})),Tt=Rl(ye).length,Oe=_,Ie=(S||E).trim(),et=b.find(O=>Be(O.name)===Be(Ie)),$t=ot(E)||A||ot((et==null?void 0:et.website)||"")||ot((et==null?void 0:et.domain)||""),Ut=P||ot((et==null?void 0:et.url)||""),ia=xe?e.actAnalyse:Ie?e.evalGoOn(Ie.length>22?Ie.slice(0,21)+"…":Ie):e.evalGo,Ma=re?`${di(de.trim())==="youtube"&&de.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(_e)}`:nt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Oe?" rs-mode":"")+(S&&E.trim()===S||N||be?" pair":"")+(N||be||te?" echo":"")+(te?" swap":""),children:[t.jsxs("div",{className:"drow"+((Oe?be:N)||te?" flash":"")+((Oe?de.trim():ba.test(E.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Oe?de:E,placeholder:Oe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Oe?600:200,spellCheck:Oe?!1:void 0,inputMode:Oe?"url":void 0,onChange:O=>{if(Oe){Y(O.target.value);return}k(O.target.value),S&&O.target.value.trim()!==S&&(q(""),R(""),I(""),F(!1))},onKeyDown:O=>{O.key==="Enter"&&(Oe?Ye():le())}}),t.jsx("span",{className:"detect"+(Oe?" off":"")+(ba.test(E.trim())?" url":""),children:kt})]}),t.jsx("span",{className:"dacts",children:Oe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(re?" loading":""),disabled:re||nt||!de.trim()&&!ne.trim(),onClick:()=>{Ye()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Ma})]}),t.jsxs("a",{className:"viewbtn"+(Jt(de)?"":" off"),href:Jt(de)?de.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:O=>{Jt(de)||O.preventDefault()},children:[t.jsx(Pl,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(xe?" analyse":"")+(d?" loading":""),disabled:d,onClick:le,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ia})]}),t.jsxs("a",{className:"viewbtn sm"+(L?" searching":$t?"":" off"),href:$t||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":L||void 0,title:L?e.viewSiteBusyHint:e.viewSiteHint,onClick:O=>{$t||O.preventDefault()},children:[L&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),L?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(Ut?"":" off"),href:Ut||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:O=>{Ut||O.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&$&&t.jsxs("button",{type:"button",className:"credits"+($.total_available<=0&&!$.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:$.unlimited?"∞":$.total_available}),!$.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",$.daily_grant+$.purchased]}),$.total_available<=0&&!$.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>T(!x),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(_?" on":""),onClick:()=>ie(!_),children:e.rsOpen}),at!==null&&at>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ft?" on":""),onClick:()=>vt(!ft),children:e.rsArchOpen(at)})]}),ft&&t.jsx(Dl,{bump:wt,cbToken:j,onClose:()=>vt(!1),onEvaluate:O=>o(null,O),onAddAll:ae}),t.jsx("div",{className:"rsp slim"+(_?" on":" off"),"aria-hidden":!_,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:_?void 0:-1,onClick:()=>Le(O=>!O),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:me?"▴":"▾"})]}),me&&t.jsx("textarea",{className:"rstext",value:ne,placeholder:e.rsTextPh,tabIndex:_?void 0:-1,onChange:O=>se(O.target.value)})]})}),Ce&&t.jsx("div",{className:"rserr",children:Ce}),ye&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ye.title}),ye.source_url&&t.jsx("a",{href:ye.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{He(null),dt(null)},children:"×"})]}),ye.market&&t.jsx("p",{className:"rsmk",children:ye.market}),je.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),je.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[ye.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ye.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:bo(ye.summary_md||"").map((O,J)=>t.jsx("p",{children:O},J))})]}),t.jsx(vo,{card:ye,onEvaluate:O=>o(null,O),onAddAll:ae}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Tt)}),_t]})]}),x&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:B,placeholder:e.bulkPh,onChange:O=>G(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(H?" loading":""),style:{justifyContent:"center"},disabled:H||!C.length,onClick:()=>{Me()},children:[t.jsx("span",{className:"fill"}),H&&X?X:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(C.length)})]})]}),V.slice(0,1).map((O,J)=>{const oe=O.verdict==="kept",w=O.verdict==="quota",D=oe?"var(--brand)":w?"var(--bolt)":"var(--red)",M=oe?"var(--brand-l)":w?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":D,"--bgc":M},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:w?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!!(O.candidates&&O.candidates.length)&&t.jsx("span",{className:"sitepick",children:O.candidates.map(U=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:U.url.startsWith("http")?U.url:`https://${U.url}`,target:"_blank",rel:"nofollow noopener",children:[(U.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,U.url),children:e.evalPickGo})]},U.url))}),!w&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:oe?1:5});const U=(O.name||"").trim().toLowerCase();window.setTimeout(()=>{const ee=[...document.querySelectorAll(".atl2 .list .row")].find(Ee=>{var we;return(((we=Ee.querySelector(".rnm"))==null?void 0:we.textContent)||"").trim().toLowerCase().includes(U)});ee&&(ee.scrollIntoView({behavior:"smooth",block:"center"}),ee.classList.add("flashrow"),window.setTimeout(()=>ee.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),f&&(i.kept+i.dropped>0||V.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Bl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function _l(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=W(),i=e.memoConsole?r.get(e.memoConsole):null,l=u.useMemo(()=>i?[i.reasoning||"",Bl(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const d=bt(i),c=xn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Rt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Nn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=W(),[l,d]=u.useState(!1),[c,g]=u.useState(null),s=n.pipe&&o==="client"&&!n.lockActions,h=async()=>{if(!s||l)return;d(!0);const p=await ui(r,e);if(d(!1),!p){i(a.actErr);return}g(p.results||[])};return u.useEffect(()=>{if(!s)return;const p=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&h()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,s]),u.useEffect(()=>{if(s)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),h())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{h()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const $l=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ha=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Ul(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ha(a.slice(n));break}r+=ha(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ha(a.slice(o));break}const l=a.slice(o+1,i).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&$l.has(c)?r+=`<${d[1]}${c}>`:r+=ha(a.slice(o,i+1)),n=i+1}return r}const Cr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function $e({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Hl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Vl({o:e}){const{t:a,doDeep:r}=W(),[n,o]=u.useState(!1),i=bt(e),l=[e.reasoning||"",Hl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[i&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:i}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Rt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),o(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function En({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=W(),i=ra(e),l=bt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),h=u.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Rt(e)?1:0}].filter(v=>v.n>0),[e,a,d,l,c,g,s]),[p,b]=u.useState("");if(!h.length)return null;const m=h.some(v=>v.k===p)?p:h[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:h.map(v=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===v.k,"data-tour":"tab-"+v.k,className:m===v.k?"on":"",onClick:y=>{y.stopPropagation(),b(v.k)},children:v.lib},v.k))}),t.jsxs("div",{className:"cdbody",onClick:v=>v.stopPropagation(),children:[m==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx($e,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx($e,{k:a.cdVerdictDate,v:Cr(e.verdictDate,r)})]})]}),m==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Ul(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(Wl,{o:e})]}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdSector,v:e.sector}),t.jsx($e,{k:a.cdStage,v:e.stage}),t.jsx($e,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx($e,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx($e,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx($e,{k:a.cdAngle,v:e.angle}),t.jsx($e,{k:a.cdDetected,v:Cr(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdName,v:e.contactName}),t.jsx($e,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx($e,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="memo"&&t.jsx(Vl,{o:e}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx($e,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Wl({o:e}){const{t:a,token:r}=W(),[n,o]=u.useState(!1),[i,l]=u.useState(null),d=async()=>{n||(o(!0),l(await mi(r,e.name,e.website||e.domain||"")),o(!1))},c=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=g.some(([,h])=>h);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),i&&s&&t.jsxs(t.Fragment,{children:[g.filter(([,h])=>h).map(([h,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:h}),t.jsx("p",{children:p})]},h)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!s&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function oa({spec:e}){const a=u.useRef(null),r=u.useRef(null),[n,o]=u.useState(!1);return u.useEffect(()=>{const i=a.current;if(!i)return;let l=!1;const d=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Pn({kind:"op",card:e},g).then(s=>{!l&&s&&i.isConnected&&i.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),u.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let l=!1;Pn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&i.isConnected&&i.replaceChildren(c)});const d=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Gl=`
...
`;function Yl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let d=e.y+10;return d+n>i-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function Kl(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:l,askEvaluate:d,doAnalyse:c,doDecide:g,doPromote:s,doRepeche:h,doApproach:p,doDeep:b,doOnboard:m,outbound:v,evalBusy:y}=W(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const j=Re(f),E=Ae(f),k=bt(f),N=ra(f),z=f.kind==="target",S=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return Pt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Gl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Yl(e.popupAnchor,!!f.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(mt(f.date)),Ge(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[f.cc]}),children:(It(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>S({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>S({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Bt(f.amountEur,o)})]}),i.pipe&&z&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[St(f.engine)," ",t.jsx("b",{children:Ge(f.engine,o)})," — ",fi(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(gt,{o:f,lg:!0})," ",t.jsx(Ra,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Br(j,o))," · ",n.win7(_r(j,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(oa,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&z&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&z&&t.jsx(En,{o:f})]}),t.jsx(Nn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||l!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),Rt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>d(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Ql(){const{lang:e,token:a,dossiers:r,caps:n}=W(),o=a||"home",{names:i,verdicts:l}=u.useMemo(()=>{const c=[],g={};return r.forEach(s=>{s.kind!=="target"||!s.name||(c.push(s.name),g[s.name]=hi(s)||"")}),{names:c,verdicts:g}},[r]);return{diff:u.useMemo(()=>i.length?xi(o,i,l,e):null,[o,i.length]),names:i,verdicts:l,scope:o,caps:n}}function Jl(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:l}=W(),d=i.loading&&!l.length,c=u.useRef({});u.useEffect(()=>{c.current={...r}},[r]);const g=p=>{const b=c.current[p],m=b!==void 0?r[p]-b:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ka[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:p})},children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(m>0?" up":m<0?" down":""),children:[r[p],m!==0&&t.jsxs("em",{className:"delta",children:[m>0?"+":"−",Math.abs(m)]})]})]},p)},s=(p,b,m)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${Ka[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:p})},children:[t.jsx("span",{className:"l",children:m.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),h=(p,b,m,v=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:v,onClick:m,children:p},b);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[h("↩",n.toolUndo,o,e.undo.length===0),h("↺",n.toolReset,()=>{a({type:"reset"})}),h("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),h("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),h("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Xl(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:l}=W(),d=u.useRef(null),[c,g]=u.useState(60);u.useEffect(()=>{let m=0;const v=()=>{var k;const y=d.current;if(!y)return;const f=(k=y.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!f)return;const j=f.getBoundingClientRect(),E=y.getBoundingClientRect();g(Math.max(20,Math.min(j.left+j.width/2-E.left,E.width-30)))};return m=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",v)}},[e.ptab]);const s=e.ptab;let h=r.tuto[s].p;if(s===3){const m=n.filter(f=>f.kind==="target"&&Ae(f)===3),v=m.filter(f=>Qa(f)==="auto").length,y=m.filter(f=>Qa(f)==="cd").length;h=r.tutoPending(v,y,m.length)}const p=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(s===1){const m=n.filter(v=>v.kind==="target"&&Ae(v)===1&&!o.has(v.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(v=>v.id)})}}return null})(),b=gi(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Ka[s]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:h}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}const Wa=600,Nt=62,zr="atl2:fstats";function Zl(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=W(),[l,d]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(zr)==="on"}catch{return!1}}),c=r.stats,g=u.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const h=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,p=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((N,z)=>Math.max(N,z.s||0),0),m=g.length?Wa/g.length:0,v=Math.max(4,m-4),y=g.length>=5&&b>0,f=r.marketEstimate||0,j=h(new Date().toISOString().slice(0,10)),E=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],k=[];return typeof c.screened_window=="number"&&s&&k.push({cle:"fenetre",periode:e.funPerWindow(h(s),j),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:E(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[k.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([z,S],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(z)}),t.jsx("i",{children:S})]},N.cle+S)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(f),Math.min(100,Math.round((c.screened||0)/f*100)))})]}),N.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const z=!l;d(z),z&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(zr,z?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},N.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Wa} ${Nt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((N,z)=>{const S=(N.s||0)/b*(Nt-4),q=(N.m||0)/b*(Nt-4),A=z*m+(m-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${h(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:Nt-2-S,width:v,height:S,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:Nt-2-q,width:v,height:q,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:Nt-1.5,x2:Wa,y2:Nt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:h(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const yo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Sn({o:e,locked:a=!1}){const{t:r}=W(),n=ra(e),o=bt(e),i=Ae(e),l=Qa(e),d=bi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(yo[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(Cs,{o:e})]})}const Dt=e=>e.length>22?e.slice(0,21)+"…":e,va=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Fa(e){return va.has(e.engine||"")}function pt(e){return!!e.noCo||Fa(e)&&!!e.url}function na(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function wo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function ed({on:e,rev:a}){const[r,n]=u.useState(null),[o,i]=u.useState({top:0,left:0,width:0});return u.useEffect(()=>{if(!e){n(null);return}const l=()=>{var m,v,y;const d=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!d){n(null);return}const g=d.getBoundingClientRect(),s=c?c.getBoundingClientRect().bottom:g.top;i({top:Math.round(s),left:Math.round(g.left),width:Math.round(g.width)});const h=[...d.querySelectorAll(":scope .grp")];let p=null;for(const f of h){const j=f.querySelector(".grp-h");j&&j.getBoundingClientRect().bottom<=s+2&&(p=f)}if(!p){n(null);return}const b=p.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function td(e){const r=()=>{const n=wo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Ar({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=W(),[i,l]=u.useState(!1);if(u.useEffect(()=>{n||l(!1)},[n]),De(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Dt(e.name))})]})}function Cn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:l,doPromote:d,doRepeche:c,doApproach:g,dispatch:s,liveMemos:h}=W(),p=m=>v=>{v.stopPropagation(),m()};if(r.lockActions){const m=p(()=>s({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Ae(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Dt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),na(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Fa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),na(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Ar,{o:e})});const b=Ae(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Ar,{o:e})});if(b===1){const m=h.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(wa,{item:m,serverOff:h.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:p(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:p(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:p(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:p(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:p(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function ad({o:e}){const{t:a,doThumb:r,thumbOf:n}=W(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function nd({o:e}){const{lang:a}=W();return Re(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(gt,{o:e}),t.jsx(Ra,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[St(e.engine||"")," ",Ge(e.engine||"",a)]})})}function rd({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:l,fresh:d}){const{dispatch:c,caps:g,markRow:s,markedId:h,favIds:p,toggleFav:b,t:m}=W(),v=Ae(e),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,j=f<=0?0:f<=7?1:f<=30?2:3,E=g.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][v]:y[j],k=p.has(e.id),N=z=>{if(a)return;if(l){l(e.id);return}if(g.pipe||e.kind==="op"){n();return}const S=z.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return t.jsxs(u.Fragment,{children:[t.jsxs("div",{className:"row"+(h===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+v:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx(So,{o:e}),t.jsxs("span",{className:"nd",children:[d&&t.jsx("span",{className:"rfresh",children:"✨"}),Re(e)&&t.jsx(gt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:z=>{z.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(z=>z&&z!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:z=>{z.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",Dt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(od,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(nd,{o:e}),g.pipe&&t.jsx(Sn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Cn,{o:e}),g.showThumbs&&t.jsx(ad,{o:e})]}),r&&!a&&!l&&t.jsx(ld,{o:e})]})}function od({o:e}){const{lang:a,caps:r}=W();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Bt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function id({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=W(),l=(p,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:p})},d=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),c=Bt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=De(e),h=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped})]}):pt(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{p.stopPropagation(),na(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Dt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(oa,{spec:e.card})})]})}function sd({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=W();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ge(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Cn,{o:e})}),t.jsx(En,{o:e})]})}function ko({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:l,caps:d,dossiers:c}=W(),g=u.useRef(null),s=We(e);if(u.useEffect(()=>{if(!s||!(e!=null&&e.decryptHtml))return;const x=g.current;if(!x)return;let T=!1;return Ga(()=>import("./fit-BnaWm7z_.js"),[]).then(async B=>{await B.ensureEditoCss(),!(T||!x.isConnected)&&(B.beautifyEditoRows(x),B.mountCardFits(x))}),()=>{T=!0}},[s,e==null?void 0:e.decryptHtml]),!e&&!a){const x=c.find(We);if(x)return t.jsx(ko,{o:x})}const h=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),p=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||h,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!h||ka(h),y=(e==null?void 0:e.engine)||"",f=We(e),j=e?Bt(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const x=/https?:\/\/(?:www\.)?([^/]+)/.exec(p);return x?x[1].replace(/^www\./,"").slice(0,40):""})(),N=c.find(We),z=((N==null?void 0:N.url)||"").trim(),S=!!p&&!!z&&(p===z||p.endsWith(z)||z.endsWith(p)),q=(x,T=!1)=>B=>{B.stopPropagation(),T&&l({type:"continent",key:"monde"}),l({type:"filters",patch:x})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const A=()=>{h&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:h}}))},R=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},P=()=>{na({url:p,headline:b,tagline:e==null?void 0:e.tagline,name:h})},I=e?De(e):!1,L=I&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",F=f?r.doEdito.replace(/^📖\s*/,""):y?Ge(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[F,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),p&&!f&&(v||Fa({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:p,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:x=>x.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),j&&t.jsx("span",{className:"oc-amt",children:j})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(oa,{spec:m})}),(p&&!S&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[p&&!S&&!f&&t.jsxs("a",{className:"zoom-src",href:p,target:"_blank",rel:"nofollow noopener",onClick:x=>x.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:x=>{x.stopPropagation(),l({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[I?t.jsxs("span",{className:"verdict",style:{"--c":L?"var(--brand)":"var(--red)"},children:[L?"✓":"✗"," ",t.jsx("b",{children:L?r.kept:r.dropped})]}):!v&&h?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:x=>{x.stopPropagation(),o(e,h)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Dt(h))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,p&&!f&&(v||Fa({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&h?" ghost":""),onClick:x=>{x.stopPropagation(),P()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&h&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),R()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),A()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Dt(h)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&h&&d.pipe&&t.jsx(Nn,{name:h})]})]})}function ld({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:l}=W();return!o.pipe&&e.kind==="op"?t.jsx(id,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(En,{o:e}),t.jsx(zs,{o:e}),t.jsx(qs,{o:e}),t.jsx(Nn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Sn,{o:e})})]}),e.card&&t.jsx(oa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[St(e.engine||"")," ",Ge(e.engine||"",r)]}),Re(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(gt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function dd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:l,doDecide:d,lang:c}=W();if(!l.pipe&&e.kind==="op"){const h=Bt(e.amountEur,c),p=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(oa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),h&&t.jsx("span",{className:"damt",children:h})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[St(e.engine||"")," ",Ge(e.engine||"",c)]}),Re(e)&&t.jsx(gt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(p?` · ${p}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Cn,{o:e})})]})}const g=Ae(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Sn,{o:e}),Re(e)&&t.jsx(gt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemo," →"]})]})}function cd(){const{t:e}=W(),[a,r]=u.useState(0);return u.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function pd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=W(),i=o==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,h)=>(e[h]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${l(c)}”`:`${g} dossier${g>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+l(c)," →"]})]})}function ud(){var yt,wt,Ze,ht,kt;const e=W(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:l,scopedAll:d,markRow:c,lang:g,sessTally:s,data:h,dossiers:p,source:b,focusExtra:m,byId:v,token:y}=e,f=Hr(),j=u.useMemo(()=>{var $,ae,xe,le;if(!y||b==="ops")return null;const C=((($=f==null?void 0:f.ed)==null?void 0:$.date)||(f==null?void 0:f.day)||"").slice(0,10),V=[(ae=f==null?void 0:f.ed)==null?void 0:ae.html,(xe=f==null?void 0:f.ed)==null?void 0:xe.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((le=f==null?void 0:f.ed)==null?void 0:le.date)||C,decryptHtml:V||void 0,date:C,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,g,(yt=f==null?void 0:f.ed)==null?void 0:yt.html,(wt=f==null?void 0:f.ed)==null?void 0:wt.acquirers_html,(Ze=f==null?void 0:f.ed)==null?void 0:Ze.date,f==null?void 0:f.day]),E=C=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Ur,[k,N]=u.useState(new Set);u.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[z,S]=u.useState(null);u.useEffect(()=>{S(null)},[a.ptab,a.continent]);const[q,A]=u.useState(!a.mapFolded);u.useEffect(()=>{if(a.mapFolded){A(!1);return}const C=document.getElementById("atl2-stage");if(!C){A(!1);return}const V=new IntersectionObserver(([$])=>A(!!$&&$.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return V.observe(C),()=>V.disconnect()},[a.mapFolded]);const R=a.mapFolded||!q,P=C=>N(V=>{const $=new Set(V);return $.has(C)?$.delete(C):$.add(C),$}),I=b==="ops"||o.pipe,[L,F]=u.useState("all"),[x,T]=u.useState(null),[B,G]=u.useState(!1),H=u.useRef(!0);u.useEffect(()=>{if(H.current){H.current=!1;return}F("all"),G(!1)},[a.ptab,a.continent]),u.useEffect(()=>{if(!B)return;const C=V=>{var $,ae;(ae=($=V.target)==null?void 0:$.closest)!=null&&ae.call($,".atl2 .doable")||G(!1)};return document.addEventListener("click",C,!0),()=>document.removeEventListener("click",C,!0)},[B]);const Q=u.useMemo(()=>{var V;const C=new Map;for(const $ of ms(((V=f==null?void 0:f.ed)==null?void 0:V.html)||""))C.has($.t)||C.set($.t,$.html);return C},[(ht=f==null?void 0:f.ed)==null?void 0:ht.html]),X=u.useCallback(C=>{if(C.decryptHtml)return C.decryptHtml;if(!Q.size)return;const V=(C.name||"").trim().toLowerCase();if(V.length<3)return;const $=Q.get(V);if($)return $;for(const[ae,xe]of Q)if(ae.includes(V)||V.includes(ae))return xe},[Q]),{diff:K}=Ql(),[ue,Z]=u.useState(!1),ge=a.filters.win==="1"&&!a.filters.day,[_,ie]=u.useState(!1),me=u.useMemo(()=>new Set(((K==null?void 0:K.added)||[]).map(C=>C.trim().toLowerCase()).filter(Boolean)),[K]),Le=u.useMemo(()=>{if(!me.size)return 0;const C={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return p.filter(V=>!We(V)&&me.has((V.name||"").trim().toLowerCase())&&Xt(V,C,o.pipe)).length},[p,me,a,o.pipe]);u.useEffect(()=>{const C=()=>{ie(!1),F("all"),G(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",C),()=>window.removeEventListener("ppmap:tunnel",C)},[]),u.useEffect(()=>{ie(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const te=u.useMemo(()=>{const V=_&&me.size>0||a.filters.signalOnly||L!=="all"?d:l;let $=vn(V,a.sort);return $=$.filter(ae=>!We(ae)),_&&me.size&&($=$.filter(ae=>me.has((ae.name||"").trim().toLowerCase()))),L==="explore"?$=$.filter(pt):L==="eval"&&($=$.filter(ae=>!pt(ae)&&!ae.noCo&&(ae.kind==="op"||!De(ae)))),$},[l,d,a.sort,L,_,me]),he=u.useMemo(()=>o.pipe?p.filter(C=>C.kind==="target"&&!We(C)&&Re(C)&&(a.continent==="monde"||C.continent===a.continent)):te.filter(C=>Re(C)&&!De(C)),[o.pipe,p,te,a.continent]).length,de=u.useMemo(()=>o.pipe?te:te.filter(C=>!De(C)&&!C.noCo&&!pt(C)),[te,o.pipe]),Y=b==="ops"?te.filter(pt).length:0,ne=_?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,se=a.filters,be=[];if(se.day)be.push({k:"day",lib:n.fDay(se.day.slice(8,10)+"/"+se.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(se.win&&se.win!=="all"){const C=["1","7","30"].indexOf(se.win);C>=0&&be.push({k:"win",lib:n.dates[C],off:()=>r({type:"filters",patch:{win:"all"}})})}const Se=C=>C.length<=2?C.join(", "):`${C.length} ${n.fSelected}`;for(const C of["sector","country","engine"]){const V=se[C];V&&V.length&&be.push({k:C,lib:Se(V),off:()=>r({type:"clearFacet",facet:C})})}se.search&&be.push({k:"search",lib:"🔍 "+se.search,off:()=>r({type:"filters",patch:{search:""}})}),_&&me.size&&be.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>ie(!1)}),se.signalOnly&&be.push({k:"sig",lib:"🔴 "+n.sigDock(he||se.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const re=(C,V,$="",ae=!1)=>t.jsxs("button",{type:"button","data-s":C,className:$,"aria-sort":a.sort.key===C?a.sort.dir===1?"ascending":"descending":"none",style:ae?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:C}),children:[V,t.jsx("span",{className:"ar",children:a.sort.key===C&&a.sort.dir===1?"▴":"▾"})]},C),ce=u.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const C=new Map;te.forEach(ae=>{const xe=ae.engine||"?";C.has(xe)||C.set(xe,[]),C.get(xe).push(ae)});const V={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},$=Ya([...C.keys()],g);return[...C.entries()].sort((ae,xe)=>{const le=V[ae[0]]??10+$.indexOf(ae[0]),Me=V[xe[0]]??10+$.indexOf(xe[0]);return le-Me})},[te,o.pipe,a.groupBy,g]),_e=ce?ce.filter(([C])=>va.has(C)).length:0,Pe=(()=>{var V;return((V=(ce?ce.flatMap(([,$])=>$):te)[0])==null?void 0:V.id)??null})(),Ce=u.useRef(!1),ve=u.useMemo(()=>p.find(We)||j,[p,j]);u.useEffect(()=>{const C=()=>{Ce.current=!0,ie(!1)};return window.addEventListener("ppmap:reveal",C),window.addEventListener("ppmap:focus",C),()=>{window.removeEventListener("ppmap:reveal",C),window.removeEventListener("ppmap:focus",C)}},[]),u.useEffect(()=>{const C=()=>{ve&&r({type:"focus",id:ve.id})};return window.addEventListener("ppmap:edito",C),()=>window.removeEventListener("ppmap:edito",C)},[ve,r]),u.useEffect(()=>{if(!a.focusId)return;T(a.focusId);const C=window.setTimeout(()=>T(null),900);return()=>window.clearTimeout(C)},[a.focusId]),u.useEffect(()=>{if(I&&!(a.focusId&&(te.some(C=>C.id===a.focusId)||p.some(C=>C.id===a.focusId)||a.focusId===(ve==null?void 0:ve.id)))&&!m){if(ve){r({type:"focus",id:ve.id});return}Pe&&r({type:"focus",id:Pe})}},[I,a.focusId,te,Pe,m,r,p,b,ve]),u.useEffect(()=>{if(!I||!a.focusId||ve&&a.focusId===ve.id||te.some(V=>V.id===a.focusId))return;const C=p.find(V=>V.id===a.focusId);if(C){if(Ce.current){C.kind==="op"?F(pt(C)?"explore":"eval"):L!=="all"&&F("all");return}L!=="all"&&Pe&&r({type:"focus",id:Pe})}},[I,a.focusId,L,te,p,Pe,r,ve]),u.useEffect(()=>{if(!I||!a.focusId||!Ce.current)return;const C=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!C){const xe=te.findIndex(le=>le.id===a.focusId);if(xe>=0){const le=ce?"":"pt"+a.ptab;if(le){const Me=a.shown[le]||E();xe>=Me&&r({type:"more",group:le,by:xe-Me+8})}}return}Ce.current=!1;const V=wo(),$=C.getBoundingClientRect();$.top>=V-2&&$.bottom<=window.innerHeight-4||td(C)},[I,a.focusId,a.ptab,te,a.shown,ce,r]),u.useEffect(()=>{if(typeof window>"u")return;const C=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),V=document.querySelector(".atl2.ops, .atl2.cibles");if(!C||!V)return;const $=()=>V.style.setProperty("--listhead-h",`${C.offsetHeight}px`);$();const ae=new ResizeObserver($);return ae.observe(C),()=>ae.disconnect()},[R,a.dens,a.mapFolded]);const ye=u.useMemo(()=>{if(!I||!a.focusId)return null;if(j&&a.focusId===j.id)return j;const C=te.find($=>$.id===a.focusId)||p.find($=>$.id===a.focusId)||null;if(!C)return null;const V=X(C);return V&&V!==C.decryptHtml?{...C,decryptHtml:V}:C},[I,a.focusId,te,p,X,j]),He=o.lockRowsAfter;let Fe=0;const dt=(C,V)=>{let $=a.shown[V]||E();return C.length-$<=4&&($=C.length),C.slice(0,$).map(le=>{const Me=He!==null&&Fe>=He;Fe++;const Ye=X(le),je=Ye&&Ye!==le.decryptHtml?{...le,decryptHtml:Ye}:le,nt=!I&&a.dens!=="maxi"&&(a.dens==="deplie"||(z?z==="open":!!Ye)),_t=k.has(le.id)?!nt:nt,Tt=I?Oe=>{Ce.current=!0,r({type:"focus",id:Oe});const Ie=v.get(Oe);Ie&&(pt(Ie)?na(Ie):Ie.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ie.name,url:Ie.url||"",website:Ie.website||"",domain:Ie.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(dd,{o:je,locked:Me,selected:I&&a.focusId===le.id,onSelect:Tt},le.id):t.jsx(rd,{o:je,locked:Me,open:_t,onToggle:()=>P(le.id),selected:I&&a.focusId===le.id,echo:x===le.id,fresh:me.has((le.name||"").trim().toLowerCase()),onSelect:Tt},le.id)})},ft="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(te.length?"":" list-empty"),vt=t.jsxs(t.Fragment,{children:[ce?ce.map(([C,V])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:St(C)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:C==="ma"?n.grpMa:C==="fundraising"?n.grpLev:va.has(C)&&_e<=1?n.grpNews:C==="nominations"?n.grpNom:C==="media"?n.grpNewsOther:C==="recrutements"?n.grpHire:va.has(C)?n.grpNews+" · "+Ge(C,g):Ge(C,g)}),t.jsx("div",{className:"s",children:n.grpCount(V.filter($=>!De($)).length,V.length)})]})]}),dt(V,C)]},C)):dt(te,"pt"+a.ptab),h.loading&&!p.length&&t.jsx(cd,{}),!te.length&&!(h.loading&&!p.length)&&(o.pipe&&L==="all"?t.jsx(pd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),at=t.jsxs("div",{className:"listhead"+(R?" mapoff":""),children:[R&&t.jsx("div",{className:"lh-tools",children:t.jsx(xo,{compact:!0})}),o.showFunnel&&ue&&ge&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(Fs,{}),t.jsx(Zl,{})]}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Jl,{}),t.jsx(Xl,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ge?" on":""),"aria-pressed":ge,title:n.morningDockTitle,onClick:()=>{if(ge){r({type:"filters",patch:{win:"all",day:""}}),Z(!1);return}ie(!1),F("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),Z(!0)},children:["📊 ",n.morningDock(typeof((kt=h.stats)==null?void 0:kt.screened_today)=="number"?h.stats.screened_today:0)]}),K&&!K.firstVisit&&(K.added.length>0||K.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(_?" on":""),"aria-pressed":_,title:n.sinceSub,onClick:()=>{const C=!_;ie(C),Z(!1),F("all"),C&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(Le),K!=null&&K.lastDate?` · ${n.sinceSince(K.lastDate)}`:""]}),he>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{ie(!1),Z(!1),F("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(he)]})]}),!_&&t.jsxs("span",{className:"main",children:[t.jsx("b",{children:te.length})," ",ne]}),t.jsx("span",{className:"dot",children:"·"}),R&&t.jsx(go,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[R?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),be.map(C=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:V=>{V.stopPropagation(),C.off()},children:[C.lib,t.jsx("i",{children:"×"})]},C.k)),b==="ops"&&te.length>0&&!R&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",te.length-Y," ",n.zoomPulseEval,Y>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",Y," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([C,V])=>t.jsxs("button",{type:"button","data-d":C,"aria-pressed":a.dens===C||C==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:C}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:V})]},C))}),!I&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":z==="open",onClick:()=>{S("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":z==="closed",onClick:()=>{S("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var Ye;const C={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}},V=p.filter(je=>Xt(je,C,o.pipe)&&!We(je)),$=V.filter(je=>!pt(je)&&!je.noCo&&(je.kind==="op"||!De(je))).length,ae=V.filter(pt).length,xe=o.pipe?V.filter(je=>je.kind!=="op"&&Ae(je)===1).length:0,le=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${xe?` ${xe}`:""}`]]:[],["eval",`${n.doEval}${$?` ${$}`:""}`],["explore",`${n.doExplore}${ae?` ${ae}`:""}`]],Me=((Ye=le.find(([je])=>je===L))==null?void 0:Ye[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":B,onClick:()=>G(je=>!je),children:[Me,t.jsx("i",{children:"▾"})]}),B&&t.jsx("div",{className:"dolist",children:le.map(([je,nt])=>t.jsx("button",{type:"button","aria-pressed":L===je,onClick:()=>{if(G(!1),je==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}F(je),je!=="all"&&(ie(!1),Z(!1),r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}}))},children:nt},je))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:C=>r({type:"sort",key:C.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([C,V])=>t.jsx("option",{value:C,children:V},C))})]}),o.showChain&&de.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:de.map(C=>C.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(de.length):n.chainAll(de.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!I&&at,a.dens!=="maxi"&&!I&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),re("country",n.colCountry),re("name",n.colCompany),re("amount",n.colAmount,"h-amt",!0),re("stage",n.colStage,"h-stade"),re("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[re("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),re("memo",n.colMemo)]}),o.pipe&&re("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),I?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[at,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),re("country",n.colCountry),re("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[re("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),re("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ft,children:vt})]}),t.jsxs("aside",{className:"readpane"+((ye?We(ye):!m&&ve)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[ve&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===ve.id,onClick:()=>r({type:"focus",id:ve.id}),children:n.doEdito}),j&&a.focusId===j.id?t.jsx("div",{className:"zoom",children:t.jsx(bs,{})}):ye&&o.pipe?t.jsx(sd,{o:ye}):t.jsx(ko,{o:ye,extra:ye?null:m})]})]}):t.jsx("div",{className:ft,children:vt}),(()=>{const C=ce||[["pt"+a.ptab,te]];let V=0,$=0;for(const[xe,le]of C){$+=le.length;let Me=a.shown[xe]||E();le.length-Me<=4&&(Me=le.length),V+=Math.min(le.length,Me)}const ae=$-V;return ae<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>C.forEach(([xe,le])=>r({type:"more",group:xe,by:le.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(ae,ae)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(V,$)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}}),I&&b==="ops"&&a.dens!=="maxi"&&t.jsx(ed,{on:!!ce,rev:(ce||[]).map(([C,V])=>C+V.length).join("|")})]})}function Tr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function md(e,a){const r=vi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function fd(e,a){const n=[a.head.split("|").map(Tr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",md(o,a.plabels),ra(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Tr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function hd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const xd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function it({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function gd({o:e,qa:a}){const{t:r,lang:n,fund:o}=W(),i=(e.cribleStatus||"").trim().toUpperCase()||(ra(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=bt(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(it,{k:r.cdSector,v:e.sector}),t.jsx(it,{k:r.cdStage,v:e.stage}),t.jsx(it,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(it,{k:r.cdSite,v:e.domain||e.website}),t.jsx(it,{k:r.cdName,v:e.contactName}),t.jsx(it,{k:r.cdEmail,v:e.contactEmail}),t.jsx(it,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(it,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(it,{k:r.cdAngle,v:e.angle}),t.jsx(it,{k:r.cdDetected,v:xd(e.date,n)})]}),c.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,g])=>g).map(([g,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:s})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function bd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:l}=W(),[d,c]=u.useState({}),g=25,s=u.useMemo(()=>n.slice(0,g),[n]);u.useEffect(()=>{s.length&&yi(r,s.map(b=>b.name)).then(c)},[r,s]);const h=i.stats,p=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),h&&typeof h.screened=="number"&&t.jsxs("p",{children:[p(h.screened)," ",e.funScreened(""),typeof h.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(h.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(i.marketEstimate)),", ",Math.round(h.screened/i.marketEstimate*100)," %"]})]})]}),s.map(b=>t.jsx(gd,{o:b,qa:d[b.name]},b.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const vd=50;function zn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=W(),[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(""),[h,p]=u.useState(0),[b,m]=u.useState(""),[v,y]=u.useState(!1),[f,j]=u.useState(0),E=u.useRef(null),k=u.useRef(null),N=()=>{j(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>j(A=>A+1),1e3)},z=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};u.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),k.current&&window.clearInterval(k.current)},[]);const S=async A=>{c(!0),s(""),N();const R=await a();if(c(!1),z(),R.ok){l(R);return}if(R.busy){s(o.alertPreviewBusy);return}if(!A){s(o.alertPreviewFail);return}p(vd),z(),E.current=window.setInterval(()=>{p(P=>P>1?P-1:(E.current&&window.clearInterval(E.current),S(!1),0))},1e3)},q=async()=>{if(n||v||d)return;y(!0),m(""),N();const A=await r();y(!1),z(),m(A.ok?o.alertTestOk(A.sentTo||""):A.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||v||h>0,onClick:()=>{S(!0)},children:d?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||d,onClick:()=>{q()},children:v?o.alertBtnTestBusy:o.alertTest})]}),d&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),h>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(h)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Ft="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ue({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=W();return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function yd(){const{st:e}=W();switch(e.modal){case"chain":return t.jsx(kd,{});case"space":return t.jsx(jd,{});case"alert":return t.jsx(Nd,{});case"queue":return t.jsx(Ad,{});case"export":return t.jsx(Td,{});case"plug":return t.jsx(Fd,{});case"recharge":return t.jsx(Md,{});case"cover":return t.jsx(Dd,{});case"dossier":return t.jsx(Od,{});case"crit":return t.jsx(Pd,{});case"tuto":return t.jsx(Id,{});case"rdv":return t.jsx(wd,{});case"memoalert":return t.jsx(qd,{});default:return null}}function wd(){const{dispatch:e,fund:a,t:r}=W(),n=a||r.rdvCoFallback;return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Gr,children:wn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Na}`,children:Na})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Hi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function kd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:l,evalBusy:d,caps:c,memoQueued:g,doAnalyse:s}=W(),h=i==="client",p=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,m=p[b],v=b>=p.length;return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[It(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(mt(m.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ge(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Bt(m.amountEur,o)})]}),Re(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(gt,{o:m,lg:!0})," ",t.jsx(Ra,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(h&&De(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),h&&De(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Et(m)==="retenu"?"var(--brand)":Et(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Et(m)==="retenu"?"✓ "+n.kept:Et(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&c.pipe&&Ae(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(h&&De(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function jd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=W(),i=o==="client",l=u.useMemo(()=>i?r.filter(h=>De(h)):[],[r,i]),d=u.useMemo(()=>vn(l.filter(h=>Et(h)==="retenu"),{key:"signal",dir:-1}),[l]),c=u.useMemo(()=>l.filter(h=>Et(h)==="ecarte"),[l]),g=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ue,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(h=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof h.score=="number"&&h.score>0?h.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:h.name}),t.jsx("div",{className:"rr",children:h.reasoning||h.tagline||""})]})]},h.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Nd(){const{mode:e}=W();return e==="client"||e==="apercu"?t.jsx(Ed,{}):t.jsx(zd,{})}function Ed(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=W(),[i,l]=u.useState("d"),d=o!=="client";return t.jsxs(Ue,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Sd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),i==="w"&&t.jsx(Cd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),i==="m"&&t.jsx(jo,{})]})}function Sd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(0);u.useEffect(()=>{let q=!0;return c(!1),_n(a).then(A=>{q&&(A?l(A):c(!0))}),()=>{q=!1}},[a,g]);const h=u.useRef({}),[p,b]=u.useState({}),[m,v]=u.useState(!1),[y,f]=u.useState(!1),j=u.useRef(null);u.useEffect(()=>()=>{j.current&&window.clearTimeout(j.current)},[]);const E=q=>{const A=h.current;Object.keys(A).length&&(v(!0),_n(a,A).then(R=>{if(!R){v(!1),o(e.actErr);return}if(R.throttled&&q<3){j.current=window.setTimeout(()=>E(q+1),5400);return}if(h.current={},b({}),l(R),v(!1),R.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},k=q=>{r||(h.current={...h.current,...q},b(A=>({...A,...q})),j.current&&window.clearTimeout(j.current),j.current=window.setTimeout(()=>E(1),700))};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(q=>q+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...p},z=q=>!N.sections||N.sections.includes(q),S=q=>{const A=N.sections||e.alertSec.map(([R])=>R);k({sections:z(q)?A.filter(R=>R!==q):[...A,q]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([q,A])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:z(q),disabled:r,onChange:()=>S(q)}),t.jsxs("span",{children:[A,q==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},q))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(zn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ti(a),onTest:()=>Ai(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Cd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(0);u.useEffect(()=>{let m=!0;return c(!1),$n(a).then(v=>{m&&(v?l(v):c(!0))}),()=>{m=!1}},[a,g]);const h=m=>{r||$n(a,m).then(v=>{if(!v){o(e.actErr);return}l(v),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const p=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>h({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:m=>h({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(zn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Li(a),onTest:()=>qi(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function jo(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=W(),[l,d]=u.useState(i||""),[c,g]=u.useState(!1),[s,h]=u.useState(!1);u.useEffect(()=>{i&&d(i)},[i]);const p=e.filters,b=u.useMemo(()=>n.filter(f=>Re(f)).length,[n]),m=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){h(!0);try{await fetch(`${hn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:p.sector,countries:p.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{h(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(f=>Ge(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(f=>It(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!i,onChange:f=>d(f.target.value),onKeyDown:f=>{f.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function zd(){const{t:e}=W();return t.jsx(Ue,{title:e.alertTitle,icon:"🔔",children:t.jsx(jo,{})})}function Ad(){var P,I;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:l,caps:d,dispatch:c,liveMemos:g}=W(),[s,h]=u.useState(()=>Da(r)),[p,b]=u.useState(()=>!Da(r)),[m,v]=u.useState([]),[y,f]=u.useState(0),j=n==="client",E=u.useMemo(()=>{const L=new Map;return o.forEach(F=>{const x=(F.name||"").trim().toLowerCase();x&&!L.has(x)&&L.set(x,F)}),L},[o]);u.useEffect(()=>{let L=!0;return(!Da(r)||y>0)&&b(!0),(async()=>{const[F,x]=await Promise.all([gn(r,y>0),Or(a)]);L&&(F&&h(F),b(!1),v(x))})(),()=>{L=!1}},[a,r,y]);const k=p&&!s,N=(s==null?void 0:s.per_day)??0,z=((P=s==null?void 0:s.analyzed_today)==null?void 0:P.length)??0,S=s==null?void 0:s.offre,q=(s==null?void 0:s.pool_meta)||[],A=u.useMemo(()=>{const L=new Map;for(const F of(s==null?void 0:s.scheduled)||[])for(const x of F.names||[])L.has(x)||L.set(x,{label:F.day_label,date:F.date});return L},[s==null?void 0:s.scheduled]),R=(s==null?void 0:s.in_progress)||[];return t.jsxs(Ue,{title:e.queueTitle,wide:!0,children:[S&&t.jsxs("div",{className:"qoffre"+(S.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:S.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:S.delai})]}),t.jsx("span",{className:"osp"}),S.rythme>0?t.jsx("span",{className:"or",children:e.qRate(S.rythme)}):S.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(S.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(z,z+(((I=s==null?void 0:s.pool_order)==null?void 0:I.length)??0))}})}),S&&t.jsxs("div",{className:"qeta",children:[S.file===0?e.qEtaDone:S.rythme<=0?e.qEtaPaused:e.qEta(S.file,S.rythme,S.jours_restants),S.en_retard&&t.jsxs("em",{children:[" ",e.qLate(S.delai,S.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(S==null?void 0:S.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(R.length>0||g.items.some(L=>L.status==="boot"||L.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(L=>L.status==="boot"||L.status==="running"||L.status==="error").map(L=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:L.name}),t.jsx("span",{className:"qd",children:L.memoType||""}),t.jsx(wa,{item:L,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+L.name)),R.filter(L=>!g.liveOf(L.name)).map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.name}),t.jsxs("span",{className:"qd",children:[L.memo_type||"",L.age_min?` · ${Math.round(L.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:L.state||""})]},"ip-"+L.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.company}),t.jsxs("span",{className:"qd",children:[L.memo_type,typeof L.est_min=="number"?` · ~${L.est_min} min`:""]}),t.jsx("span",{className:"qt",children:L.status}),L.url&&t.jsx("a",{className:"qgo",href:L.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),j&&L.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Bn(a,L.company,"retry").then(()=>f(F=>F+1))},children:e.queueRetry}),j&&L.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Bn(a,L.company,"delete").then(()=>f(F=>F+1))},children:e.queueDelete})]},L.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(q.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&q.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),q.map((L,F)=>{const x=A.get(L.name),T=E.get((L.name||"").trim().toLowerCase()),B=g.liveOf(L.name),G=!!(T&&l.has(T.id))||!!(B&&(B.status==="boot"||B.status==="running")),H=!!(T&&Ae(T)===1&&!T.memoUrl)&&!B;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",F+1]}),x?t.jsx("span",{className:"qwhen"+(x.label==="demain"?" soon":""),children:x.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:L.name}),L.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof L.score=="number"&&t.jsx("span",{className:"qs2",children:L.score}),B&&(B.status==="boot"||B.status==="running")&&t.jsx(wa,{item:B,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),H&&(d.lockActions||!j?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:G,onClick:()=>{i(T),f(Q=>Q+1)},children:G?e.actAnalyseQueued:e.actAnalyse})),L.excerpt&&t.jsx("span",{className:"qex",children:L.excerpt})]},L.name+":"+F)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([L,F])=>t.jsxs("li",{children:[t.jsx("b",{children:L})," — ",F]},L))})]})}function Td(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:l}=W(),d=`${Ft}/cibles/list.csv?token=${a}`,c=`${Ft}/cibles/list.json?token=${a}`,g=`${Ft}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,h=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{hd(fd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ue,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:y,value:f,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>h(f),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function qd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=W(),i=o!=="client",[l,d]=u.useState(null),[c,g]=u.useState(!1),[s,h]=u.useState(0),[p,b]=u.useState(!1);u.useEffect(()=>{let f=!0;return g(!1),In(a).then(j=>{f&&(j?d(j):g(!0))}),()=>{f=!1}},[a,s]);const m=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=f=>{if(i||!l)return;const j={enabled:f.enabled??!!l.enabled,email:f.email??(l.email||""),sections:f.sections??m()};b(!0),In(a,j).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}d(E),r(e.memoAlertSaved)})};if(c)return t.jsx(Ue,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>h(f=>f+1),children:e.retry})]})});if(!l)return t.jsx(Ue,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs(Ue,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:i||p,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Ld,{value:l.email||"",readOnly:i||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>v({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:i||p,onChange:()=>v({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:j})]},f))}),t.jsx(zn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>ki(a,y),onTest:()=>wi(a,y)})]})}function Ld({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,l]=u.useState(e);u.useEffect(()=>{l(e)},[e]);const d=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&d&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>o(i.trim()),children:n})]})]})}function Fd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=W(),[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(null),[h,p]=u.useState(""),[b,m]=u.useState(0);u.useEffect(()=>{let E=!0;return c(!1),Ja(a).then(k=>{E&&(k?l({configured:k.configured,url_hint:k.url_hint}):c(!0))}),Ei(a).then(k=>{E&&s(k)}),()=>{E=!1}},[a,b]);const v=(E,k)=>{o&&Ja(a,E).then(N=>{if(!N||N.ok===!1){n(e.actErr);return}E.test&&N.sent===!1?n(e.plugTestThrottled):r(k),m(z=>z+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',f=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${Ft}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ue,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(E=>E+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:h,disabled:!o,onChange:E=>p(E.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!h.trim(),onClick:()=>v({url:h.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:f}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(f).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Rd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Rd(){const{t:e,token:a,lang:r}=W(),[n,o]=u.useState("valides"),[i,l]=u.useState(!1),[d,c]=u.useState(null),[g,s]=u.useState(null),[h,p]=u.useState(!1),[b,m]=u.useState(!1),[v,y]=u.useState(null),[f,j]=u.useState(null),[E,k]=u.useState(null),N=`atl2:bulk:${a}:${n}`;u.useEffect(()=>{Ja(a).then(I=>{j(I&&I.configured?I.url_hint||"webhook":null)})},[a]),u.useEffect(()=>{c(null),s(null),p(!1),y(null);try{const I=JSON.parse(localStorage.getItem(N)||"null");k(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{k(null)}},[N]);const z=async()=>{l(!0),p(!1),y(null);const I=await Ci(a,n);c(I),s(I.ok?n:null),l(!1)},S=u.useRef(!1),q=async()=>{if(S.current)return;S.current=!0,m(!0);const I=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await zi(a,n,"webhook",void 0,I)}finally{S.current=!1}if(m(!1),p(!1),y(L),L.ok&&(L.pushed||0)>0){const F={t:new Date().toISOString(),n:L.pushed||0};k(F);try{localStorage.setItem(N,JSON.stringify(F))}catch{}}},A=d!=null&&d.ok&&d.ready||0,R=!!(d!=null&&d.ok)&&g===n&&A>0&&!!f&&!E,P=E?new Date(E.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:I=>o(I.target.value),children:e.plugBulkTabs.map(([I,L])=>t.jsx("option",{value:I,children:L},I))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{z()},children:i?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),E&&t.jsx("p",{className:"mnote",children:e.bulkLocked(P,E.n)}),!E&&!!(d!=null&&d.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!E&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),R&&!h&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),R&&h&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(A,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{q()},children:b?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>p(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function Md(){const{t:e,data:a,lang:r}=W(),n=a.credits,o=a.email,i=async l=>{if(!o)return;const d=window.location.href.split("?")[0];try{const g=await(await fetch(`${hn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ue,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Od(){const{t:e}=W();return t.jsx(Ue,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(bd,{})})}function Dd(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:l,flash:d}=W(),[c,g]=u.useState(null),[s,h]=u.useState(!1);u.useEffect(()=>{let A=!0;if(i)return gn(i).then(R=>{A&&R&&typeof R.per_day=="number"&&g(R.per_day)}),()=>{A=!1}},[i]);const[p,b]=u.useState(null);u.useEffect(()=>{if(!o)return;let A=!0;return Ni(o).then(R=>{A&&b(R)}),()=>{A=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(A=>A.kind==="target"&&De(A)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(v/y*100)):null,j=(m==null?void 0:m.window_days)||30,E=v>0?v/j:0,k=y>0?Math.max(0,y-v):0,z=y>0&&E>0&&v>=100?Math.round(k/E):null,S=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),q=A=>{s||!l||(h(!0),Si(o,A).then(R=>{if(h(!1),R===null){d(e.actErr);return}g(R),d(e.alertSaved)}))};return t.jsxs(Ue,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(S(v))}),y>0&&t.jsx("span",{children:e.covOf(S(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),z!==null&&t.jsx("p",{className:"mnote",children:e.covEta(z)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(S(E))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.shown)})," ",e.funShown]})]}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((A,R)=>t.jsxs("tr",{className:A.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[A.code,A.geo?` · ${A.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof A.n=="number"?S(A.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:A.source}),A.elargi&&t.jsx("em",{children:e.covWide(String(A.demande||""))}),A.erreur&&t.jsx("em",{children:e.covMissing})]})]},R)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:S(p.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:c===A?"on":"",disabled:s,onClick:()=>q(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Pd(){var f,j,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:l,lang:d}=W(),c=n==="client",g=u.useMemo(()=>{const k=new Set;return a.forEach(N=>{N.angle&&k.add(N.angle)}),[...k]},[a]),[s,h]=u.useState(""),[p,b]=u.useState(""),[m,v]=u.useState(!1),y=async()=>{const k=s.trim();if(!(!k||m||!c)){v(!0),b("");try{const z=await(await fetch(`${Ft}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(z.reply&&b(String(z.reply)),z.job_id){b(e.critChatRunning);const S=async()=>{const q=await fetch(`${Ft}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:z.job_id})}).then(A=>A.json()).catch(()=>null);if(q&&q.done){b(String(q.reply||q.clarification||q.summary||"✓")),v(!1),q.applied&&o(e.alertSaved);return}setTimeout(()=>{S()},8e3)};setTimeout(()=>{S()},8e3),h("");return}h("")}finally{p.startsWith("⏳")||v(!1)}}};return t.jsxs(Ue,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=i==null?void 0:i.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var N,z;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((N=k.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(S=>t.jsx("li",{children:S},S))})]}),!!((z=k.out)!=null&&z.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(S=>t.jsx("li",{children:S},S))})]})]})]},k.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||m,onChange:k=>h(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ji,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(yo[k]||"v-cons"),children:k}),t.jsx("span",{children:N})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",N]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Id(){const{t:e,dispatch:a,startTour:r}=W(),n=o=>{var i,l;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ue,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+l))})]})}const No="atl2:mapfold",Bd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(No);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},_d=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Eo=u.createContext(null),W=()=>{const e=u.useContext(Eo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function gt({o:e,lg:a}){const{lang:r}=W(),n=Re(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Un(n,r),children:[n.emoji," ",Un(n,r)]}):null}function Ra({o:e,src:a}){const{lang:r,t:n}=W(),o=Re(e);if(!o)return null;const i=Pi(o),l=Ii(o);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Br(o,r))+" · "+n.win7(_r(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function $d(e,a,r){const n=(r||"").trim();if(n){const i=e.find(l=>(l.url||"")===n);if(i)return i}const o=Be(a);if(o)return e.find(i=>Be(i.name)===o)||e.find(i=>{const l=Be(i.name);return l.length>=3&&(o.includes(l)||l.includes(o))})}function Ud(){const{scoped:e,t:a,st:r,dispatch:n}=W(),o=u.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,l=e.filter(h=>!We(h)),d=l.length,c=l.filter(h=>!h.noCo).length,g=l.filter(h=>!!h.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const h=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:h,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function Hd(){const{t:e,lang:a,data:r,dispatch:n}=W(),o=r.stats,i=d=>d.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const l=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:l>0?e.covOf(i(l)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function So({o:e}){const{lang:a}=W(),r=Di(e.cc),n=e.cc?It(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const qr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Vd=!1;function Wd(){const[e,a]=u.useState(!1);return u.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Co=e=>`atl2:tour:${e||"anon"}`;function Gd(e){try{return localStorage.getItem(Co(e))==="1"}catch{return!0}}function Lr(e){try{localStorage.setItem(Co(e),"1")}catch{}}function Yd(e,a,r,n,o,i){const l=e.tourT,d=e.howto;return[{sel:".atl2 .ident",title:l.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:l.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:l.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:l.live,body:e.fhintLive},{sel:".atl2 .goal",title:l.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:l.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:l.tuto,body:d[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:l.demand,body:d[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:l.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:l.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:l.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:l.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:l.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:l.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:l.tools,body:d[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:l.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:l.crit,body:d[0][0],modal:"crit"}].filter(Boolean)}function Zd({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var oe;const{lang:l}=Fi(),d=Ji[l],c=ls(e,l,a),[g,s]=u.useReducer(ps,void 0,()=>ds((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?_d():Bd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),h=u.useRef(!0);u.useEffect(()=>{if(h.current){h.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(No,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),u.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const w=()=>{window.innerWidth<=760&&s({type:"mapFold",folded:!0})};return w(),window.addEventListener("resize",w),()=>window.removeEventListener("resize",w)},[a]);const p=u.useRef(i);p.current=i,u.useEffect(()=>{var w;(w=p.current)==null||w.call(p,g.filters)},[g.filters]);const[b,m]=u.useState(()=>{if(typeof window>"u")return"both";try{const w=localStorage.getItem("atl2:chrome-mode");if(w==="eval"||w==="filt"||w==="both")return w;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=u.useState(null),[f,j]=u.useState(null),[E,k]=u.useState(null),[N,z]=u.useState({kept:0,dropped:0}),[S,q]=u.useState(!1),[A,R]=u.useState(""),[P,I]=u.useState(!1),[L,F]=u.useState(null),[x,T]=u.useState(!1),[B,G]=u.useState(!1),[,H]=u.useState(0),Q=()=>H(w=>w+1),X=u.useRef([]),K=u.useRef(new Set),ue=u.useRef(new Set),[Z,ge]=u.useState([]),[_,ie]=u.useState([]),[me,Le]=u.useState(0),te=u.useRef(new Map),pe=u.useRef(null),{mode:he}=c,de=u.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),Y=de.pipe,ne=c.session.token||"",se=he==="client"&&!e;u.useEffect(()=>{if(!ne||!Y)return;let w=!0;const D=async()=>{const ee=await Bi(ne);!w||!ee||(ie(ee.runs),Le(Date.now()/1e3-ee.now),ge(Ee=>Ee.filter(we=>!ee.runs.some(tt=>Be(tt.company)===Be(we.name)))))};D();const M=Z.length>0||_.some(ee=>ee.status==="running"),U=window.setInterval(()=>{D()},M?8e3:25e3);return()=>{w=!1,window.clearInterval(U)}},[ne,Y,Z.length,_.some(w=>w.status==="running")]);const be=u.useMemo(()=>{const w=[],D=new Set;for(const M of Z){const U=Be(M.name);!U||D.has(U)||(D.add(U),w.push({name:M.name,id:M.id,status:"boot",started:M.started,estMin:M.estMin,memoType:"instant"}))}for(const M of _){const U=Be(M.company);if(!U||D.has(U))continue;D.add(U);const ee=M.status==="error"?"error":M.status==="done"?"done":"running";w.push({name:M.company,status:ee,started:M.started||0,estMin:M.est_min||(M.memo_type==="detailed"?40:15),url:M.url,error:M.error,memoType:M.memo_type,note:M.note})}return w},[Z,_]),Se=w=>be.find(D=>Be(D.name)===Be(w))||null,re=(w,D)=>{ge(M=>M.some(U=>Be(U.name)===Be(w.name))?M:[...M,{name:w.name,id:w.id,started:Date.now()/1e3,estMin:D==="detailed"?40:15}]),K.current.add(w.id),Q()};u.useEffect(()=>{if(document.querySelector(`link[href="${qr}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=qr,document.head.appendChild(w)},[]);const ce=(w,D=!1)=>{R(w),I(D),pe.current&&clearTimeout(pe.current),pe.current=setTimeout(()=>R(""),D?4200:2400)},_e=w=>ce(w,!0),Pe=u.useMemo(()=>{const w=new Map;return c.dossiers.forEach(D=>{D.id&&w.set(D.id,D)}),w},[c.dossiers]),Ce=u.useMemo(()=>c.dossiers.filter(w=>Xt(w,g,Y)),[c.dossiers,g,Y]),ve=u.useRef(!1);u.useEffect(()=>{if(ve.current||e||c.loading||!c.dossiers.length)return;if(!de.showFunnel||Gd(c.session.token||"")){ve.current=!0;return}ve.current=!0;const w=window.setTimeout(()=>{Lr(c.session.token||""),T(!0)},700);return()=>window.clearTimeout(w)},[e,c.loading,c.dossiers.length,de.showFunnel,c.session.token]);const ye=u.useMemo(()=>c.dossiers.filter(w=>us(w,g,Y,c.favIds)),[c.dossiers,g,Y,c.favIds]),He=u.useMemo(()=>Ri(Ce,c.favIds),[Ce,c.favIds]),Fe=u.useRef(!1);u.useEffect(()=>{if(Fe.current)return;if(!Y||a==="ops"){Fe.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Fe.current=!0;return}if(c.loading)return;Fe.current=!0;const w=Mi(He);w!==g.ptab&&s({type:"ptab",tab:w})},[Y,a,n==null?void 0:n.ptab,c.loading,He,g.ptab]);const dt=u.useMemo(()=>{const w=Kr(c.dossiers);return w?mt(w)===0?d.tourToday:Qr(w,l):d.tourNoRun},[c.dossiers,d,l]),ft=u.useMemo(()=>c.dossiers.some(w=>!!w.memoUrl||!!w.summary||Rt(w)),[c.dossiers]),[vt,at]=u.useState(!1);u.useEffect(()=>{if(c.loading){at(!1);return}if(c.dossiers.length>0||c.error){at(!0);return}const w=window.setTimeout(()=>at(!0),6e3);return()=>window.clearTimeout(w)},[c.loading,c.dossiers.length,c.error]);const yt=(c.marketEstimate||0)>0||typeof((oe=c.stats)==null?void 0:oe.screened)=="number"&&c.stats.screened>0,wt=u.useMemo(()=>[1,0,2,4,5,3].find(w=>(He[w]||0)>0)??0,[He]),Ze=bn.find(w=>w.key===g.continent),ht=g.continent==="monde"?d.contWorld:(l==="fr"?Ze==null?void 0:Ze.fr:Ze==null?void 0:Ze.en)||"";u.useEffect(()=>{const w=D=>{var U;const M=(((U=D.detail)==null?void 0:U.name)||"").trim();M&&kt(null,M)};return window.addEventListener("ppmap:evaluate",w),()=>window.removeEventListener("ppmap:evaluate",w)}),u.useEffect(()=>{const w=D=>{const M=D.detail||{},U=String(M.id||"").trim(),ee=String(M.name||"").trim(),Ee=String(M.url||"").trim(),we=U&&Pe.get(U)||$d(c.dossiers,ee,Ee);if(we){if(j(null),Xt(we,g,Y)||(g.continent!=="monde"&&we.continent!==g.continent&&s({type:"continent",key:we.continent||"monde"}),s({type:"reset"})),Y&&we.kind!=="op"){const ke=Ae(we);typeof ke=="number"&&ke!==g.ptab&&s({type:"ptab",tab:ke})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:we.id}),(we.noCo||["media","nominations","recrutements"].includes(we.engine||""))&&(we.url||we.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:we.url||"",text:[we.headline,we.tagline].filter(Boolean).join(`
`)}})):we.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:we.name,url:we.url||"",website:we.website||"",domain:we.domain||""}}));return}!ee&&!Ee||(s({type:"focus",id:U||null}),j({name:ee,headline:String(M.text||"").trim()||ee,url:Ee,card:M.card}),Ee&&(ka(ee)||!ee)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee,text:String(M.text||"").trim()}})):ee&&!ka(ee)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ee}})))};return window.addEventListener("ppmap:focus",w),()=>window.removeEventListener("ppmap:focus",w)}),u.useEffect(()=>{const w=U=>{const ee={},Ee=String((U==null?void 0:U.sector)||"").trim();Ee&&(ee.sector=[Ee]);const we=String((U==null?void 0:U.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(we)&&(ee.day=we);const tt=String((U==null?void 0:U.search)||"").trim();tt&&(ee.search=tt);const ke=String((U==null?void 0:U.dealKind)||"").trim();(ke==="ma"||ke==="levee"||ke==="other")&&(ee.dealKind=[ke]),Object.keys(ee).length&&s({type:"filters",patch:ee})},D=U=>w(U.detail),M=U=>{U.data&&U.data.type==="pp-filter"&&w(U.data)};return window.addEventListener("ppmap:filter",D),window.addEventListener("message",M),()=>{window.removeEventListener("ppmap:filter",D),window.removeEventListener("message",M)}},[]),u.useEffect(()=>{const w=D=>{var ee;const M=(((ee=D.detail)==null?void 0:ee.name)||"").trim().toLowerCase();if(!M)return;const U=c.dossiers.find(Ee=>(Ee.name||"").trim().toLowerCase()===M);U&&s(a==="ops"?{type:"focus",id:U.id}:{type:"popup",id:U.id})};return window.addEventListener("ppmap:similar",w),()=>window.removeEventListener("ppmap:similar",w)});const kt=(w,D)=>{const M=((w==null?void 0:w.name)||D||"").trim();if(!se){k({kicker:M});return}!M||S||(q(!0),(async()=>{try{let U=M;const ee=((w==null?void 0:w.website)||(w==null?void 0:w.domain)||"").trim();if(ee)U=ee;else try{const ke=await Pr(M);if(ke!=null&&ke.website)U=ke.website;else if(((ke==null?void 0:ke.candidates)||[]).length===1)U=ke.candidates[0].url;else if(((ke==null?void 0:ke.candidates)||[]).length>1){X.current=[{name:M,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(ke.candidates||[]).slice(0,5)},...X.current].slice(0,8),Q();return}}catch{}const Ee=await Ir(ne,U,"atelier2"),we={name:Ee.company||M,verdict:Ee.verdict,reason:Ee.reason||"",remaining:Ee.remaining??null};X.current=[we,...X.current].slice(0,8),Ee.verdict==="kept"&&z(ke=>({...ke,kept:ke.kept+1})),Ee.verdict==="ruled_out"&&z(ke=>({...ke,dropped:ke.dropped+1}));const tt=w||c.dossiers.find(ke=>(ke.name||"").toLowerCase()===M.toLowerCase());tt&&(Ee.verdict==="kept"?tt.verdict=tt.verdict||"MATCH":Ee.verdict==="ruled_out"&&(tt.verdict="NO MATCH"),Ee.reason&&(tt.reasoning=Ee.reason)),Q()}finally{q(!1)}})())},C=w=>{if(!se){k({kicker:w.name});return}re(w,"instant"),Ht(ne,"fast_request",w.name||"",""),ce(d.memoInstantSent(w.name))},V=w=>te.current.get(w.id)??c.thumbs.get((w.name||"").trim().toLowerCase()),$=(w,D)=>s({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:D}}),ae=async(w,D,M)=>{const U=w.ceoStatus||"";w.ceoStatus=D,Q();const ee=await Pa(ne,{status:D,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(M==null?void 0:M.note)!==void 0?{note:M.note}:{},...M!=null&&M.via?{via:M.via}:{}});return ee.ok?ee.skipped?(w.ceoStatus=U,Q(),_e(d.actNotPersisted),!1):((M==null?void 0:M.undo)!==!1&&$(w,U),M!=null&&M.msg&&ce(M.msg),(D==="Validé"||D==="Écarté")&&!w.ceoNote&&(M==null?void 0:M.note)===void 0&&F({o:w,yes:D==="Validé"}),!0):(w.ceoStatus=U,Q(),_e(d.actErr),!1)},xe=async(w,D)=>{const M=await Pa(ne,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:D,via:"note"});return!M.ok||M.skipped?(_e(M.skipped?d.actNotPersisted:d.actErr),!1):(w.ceoNote=D,Q(),!0)},le=u.useRef(new Map),Me=w=>le.current.has(w.id)?le.current.get(w.id):c.stages.get((w.name||"").trim().toLowerCase()),Ye=(w,D)=>{le.current.set(w.id,D),Q()},je=(w,D)=>{se&&ae(w,D?"Validé":"Écarté",{msg:D?d.decidedYes(w.name):d.decidedNo(w.name)})},nt=w=>{se&&ae(w,"À trancher",{msg:d.promoted(w.name)})},_t=w=>{se&&(async()=>{const D=w.ceoStatus||"";w.ceoStatus="Retenu",Q();const M=await Pa(ne,{status:"Retenu",check_id:w.checkId,company:w.name});if(!M.ok||M.skipped){w.ceoStatus=D,Q(),_e(M.skipped?d.actNotPersisted:d.actErr);return}$(w,D),ce(d.repeched(w.name))})()},Tt=()=>{const w=g.undo[g.undo.length-1];if(!w){ce(d.undoNone);return}const D=Pe.get(w.id);if(!D){s({type:"undoPop"}),ce(d.undoNone);return}let M=w.prevCeoStatus;if(!M)if((D.verdict||"").toUpperCase().includes("CALL"))M="À trancher";else{ce(d.undoLockedTitle);return}(async()=>await ae(D,M,{undo:!1})&&(s({type:"undoPop"}),D.ceoStatus=w.prevCeoStatus,Q(),ce(d.undoDone(D.name))))()},Oe=w=>{se&&(ue.current.add(w.id),Q(),(async()=>{const D=await _i(ne,w.name,"email");if(!D||D.ok===!1){ue.current.delete(w.id),Q(),_e(d.actErr);return}Ht(ne,"approach",w.name||"",""),ce(d.actApproachSent)})())},Ie=(w,D)=>{se&&(async()=>{if(!(await Ht(ne,D?"yes":"no",w.name||"","")).ok){_e(d.actErr);return}te.current.set(w.id,D?"yes":"no"),Q(),ce(D?d.thumbUpDone:d.thumbDnDone)})()},et=w=>{!se||!Rt(w)||(re(w,"detailed"),Ht(ne,"detailed_request",w.name||"",""),ce(d.memoDeepSent(w.name)))},$t=w=>{const D=new Set(c.favIds),M=D.has(w.id);M?D.delete(w.id):D.add(w.id),c.setFavIds(D),se&&$i(ne,{id:w.id,co:w.name},M)},Ut=()=>{!se||B||window.confirm(d.identSyncConfirm)&&(G(!0),(async()=>{const w=await Ui(ne);G(!1),w?ce(d.identSyncDone):_e(d.actErr)})())},ia=/proplace/i.test(c.fund||""),Ma=w=>{!se||!ia||(Ht(ne,"onboard_request",w.name||"",""),ce(d.onboardSent(w.name)))},O={st:g,dispatch:s,t:d,lang:l,mode:he,caps:de,pipe:Y,token:ne,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:_t,thumbOf:V,canWrite:se,commitStatus:ae,saveNote:xe,stageOf:Me,setStage:Ye,flashErr:_e,startTour:()=>T(!0),dossiers:c.dossiers,scopedAll:Ce,scoped:ye,counts:He,byId:Pe,contName:ht,favIds:c.favIds,toggleFav:$t,askEvaluate:kt,doAnalyse:C,doDecide:je,doPromote:nt,doApproach:Oe,doThumb:Ie,doDeep:et,doUndo:Tt,doSync:Ut,doOnboard:Ma,outbound:ia,memoQueued:K.current,liveMemos:{items:be,serverOff:me,liveOf:Se},approachDone:ue.current,sessTally:N,evalCards:X.current,evalBusy:S,markRow:y,markedId:v,flash:ce,focusExtra:f};u.useEffect(()=>{const w=D=>{D.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]);const J=w=>ne?t.jsx(hs,{token:ne,children:w}):t.jsx(t.Fragment,{children:w});return t.jsx(Eo.Provider,{value:O,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ne?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:es}),J(t.jsxs("div",{className:"app"+(Y?" pipe":"")+(ne?" has-thesis":""),children:[de.showTicker&&t.jsx(rt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ne?" live-stack--cibles":""),children:[t.jsx(ks,{}),!!ne&&t.jsx(xs,{})]})}),de.showIdent&&t.jsx(rt,{name:"identite",children:t.jsx(Rs,{})}),!1,Vd,de.showFunnel&&t.jsx(rt,{name:"entonnoir",children:t.jsx(Kd,{})}),!g.mapFolded&&t.jsx(rt,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(go,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Ud,{}),a!=="ops"&&de.showFunnel&&t.jsx(Hd,{}),t.jsx(Ll,{}),t.jsx(xo,{})]})]})}),de.showDemand&&Y&&t.jsx(rt,{name:"direct",children:t.jsx(Yi,{items:be,serverOff:me,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":d.chromeBoth,children:[["eval",d.chromeEval],["filt",d.chromeFilt],["both",d.chromeBoth]].map(([w,D])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===w,onClick:()=>{m(w);try{localStorage.setItem("atl2:chrome-mode",w)}catch{}},children:D},w))}),de.showDemand&&t.jsx(rt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Il,{})})}),de.showDemand&&g.memoConsole&&t.jsx(rt,{name:"console",children:t.jsx(_l,{})}),t.jsx(rt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(ud,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(rt,{name:"fiche",children:t.jsx(Kl,{})}),t.jsx(rt,{name:"modales",children:t.jsx(yd,{})}),t.jsx(Es,{}),L&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:L.o.name}),t.jsx(Ts,{placeholder:L.yes?d.whyYesPh:d.whyNoPh,onDone:w=>{const D=L.o;F(null),w&&xe(D,w).then(M=>{M&&ce(d.csNoteSaved)})}})]}),x&&vt&&t.jsx(Ls,{steps:Yd(d,dt,ft,wt,yt,He[3]||0),onClose:()=>{T(!1),Lr(ne)}}),t.jsx(Wd,{}),de.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:Gr,children:wn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${Na}`,children:Na})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),A&&t.jsx("div",{className:"flash on"+(P?" err":""),children:A}),E&&t.jsx(Oi,{variant:"acquirer",initialCompany:Fr().co,initialWebsite:Fr().site,onClose:()=>k(null)})]})})}function Kd(){const{t:e}=W(),[a,r]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Fr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Qd(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{So as FlagCell,gt as SigBadge,Ra as SigWin,Zd as default,Qd as fmtShort,W as useV2};
;/* deploy-1788031141 */
