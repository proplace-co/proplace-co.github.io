...
.atl2 .bulk .side .hint{white-space:nowrap}`,mr=`
...
`,fr=ur+mr;function nt(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function xr(){const t=nt("teaser");if(t==="0"||t==="1")return t;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function gr(t,a){if(t||a.mode!=="client"||!a.token)return"visiteur";const r=xr();return r==="0"?"client":r==="1"||nt("embed")==="1"&&nt("chrome")==="1"?"apercu":"client"}const hr={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},br=t=>hr[t],Se=t=>Object.assign(t,{continent:ka(t.cc)});function Xe(t){const a=new Set,r=[];for(const n of t){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const vr=60*60*1e3;function yr(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>vr?null:a}catch{return null}}function Be(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const wr=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function kr(t,a,r="default"){const n=r!=="default",i=c.useMemo(()=>t||n?{mode:"anon"}:xa(),[t,n]),o=c.useMemo(()=>n?"visiteur":gr(t,i),[t,i,n]),s=c.useMemo(()=>br(o),[o]),l=o!=="visiteur",d=wr(r),[m,b]=c.useState([]),[u,g]=c.useState(""),[v,x]=c.useState(null),[f,h]=c.useState(null),[p,y]=c.useState(null),[S,w]=c.useState(()=>new Map),[C,j]=c.useState(()=>new Map),[E,N]=c.useState(""),[q,B]=c.useState(new Set),[M,T]=c.useState(null),[$,F]=c.useState(!0),[Q,D]=c.useState(!1),[se,me]=c.useState(0),[he,be]=c.useState(0),P=c.useRef(0),ce=c.useMemo(()=>{var V;if(o!=="client")return"";try{return((V=ga())==null?void 0:V.email)||""}catch{return""}},[o]);c.useEffect(()=>{const V=++P.current;let _=!0;const I=()=>_&&V===P.current,O=(l&&i.token?i.token:"pub:"+a)+(d?":"+d:""),K=yr(O);return K?(b(K.objs.map(Se)),K.fund&&g(K.fund),x(K.marketEstimate??null),h(K.criteria??null),y(K.stats??null),N(K.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const G=await Ke(),ae=((G==null?void 0:G.recent_ops)||[]).map(Z=>Qe(Z,a)).filter(Z=>!!Z);if(!I())return;b(ae.map(Se)),Be(O,{objs:ae})}else if(typeof r=="object"){const ae=(await bt()||[]).filter(ee=>(ee.slug||"")===r.research).map(ee=>vt(ee,a)).filter(ee=>!!ee),Z=Xe(await yt(ae,a));if(!I())return;b(Z.map(Se)),Be(O,{objs:Z})}else if(l&&i.token){const G=ha(i.token),ae=Ke(),Z=ba(i.token),ee=va(i.token),ve=ya(i.token),H=await G;let le=H?H.targets:[];I()&&H&&(g(H.fund||""),x(H.marketEstimate??null),h(H.criteria??null),y(H.stats??null),N(H.generatedAt||""),b(le.map(Se)),F(!1),D(!1));const[pe,ye,xe,A]=await Promise.all([ae,Z,ee,ve]),Y=((pe==null?void 0:pe.recent_ops)||[]).map(W=>Qe(W,a)).filter(W=>!!W);if(le=[...le,...Y],!I())return;b(le.map(Se));const J=new Set;for(const W of ye){const ue=(W.id||W.co||"").toString().trim().toLowerCase();ue&&J.add(ue.startsWith("t:")?ue:"t:"+ue)}B(J),w(xe),j(A),H&&Be(O,{fund:H.fund,marketEstimate:H.marketEstimate,criteria:H.criteria,stats:H.stats,generatedAt:H.generatedAt,objs:le})}else{const G=wa(),ae=bt(),Z=Ke(),ee=await G;I()&&ee.length&&(b(Xe(ee).map(Se)),F(!1),D(!1));const[ve,H]=await Promise.all([ae,Z]),le=(ve||[]).map(A=>vt(A,a)).filter(A=>!!A),pe=await yt(le,a),ye=((H==null?void 0:H.recent_ops)||[]).map(A=>Qe(A,a)).filter(A=>!!A),xe=Xe([...ee,...pe,...ye]);if(!I())return;b(xe.map(Se)),Be(O,{objs:xe})}I()&&D(!1)}catch{I()&&!K&&D(!0)}finally{I()&&F(!1)}})(),()=>{_=!1}},[l,i.token,a,se,d]),c.useEffect(()=>{if(!s.showCredits||!ce){T(null);return}let V=!0;return(async()=>{try{const _=await fetch(`${ot}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ce})});if(!_.ok)return;const I=await _.json();V&&I&&I.ok!==!1&&T(I)}catch{}})(),()=>{V=!1}},[s.showCredits,ce,he]);const U=c.useCallback(V=>B(new Set(V)),[]);return{session:i,mode:o,caps:s,fund:u,email:ce,marketEstimate:v,generatedAt:E,criteria:f,stats:p,thumbs:S,stages:C,dossiers:m,favIds:q,setFavIds:U,credits:M,reloadCredits:()=>be(V=>V+1),loading:$,error:Q,refresh:()=>me(V=>V+1)}}const Wt=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),jr=(t="europe",a=!1,r)=>({continent:t,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Wt(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Nr(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const r=t.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...t,filters:{...t.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=t.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...t,filters:{...t.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Wt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Ve)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Ve=60;function pt(t,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ne(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(t.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(it(t)))return!1;if(n!=="win"){if(a.day){if((t.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(Te(t.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ee(t)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Gt(t,a,r){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:pt(t,a.filters,r)}function Sr(t,a,r,n){return!(!Gt(t,a,r)||r&&!ja(t,a.ptab,n))}function ut(t,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-Te(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=ne(i);return o?100-(o.left??0):-1}}};return[...t].sort((i,o)=>{const s=n(i),l=n(o);return s<l?-a.dir:s>l?a.dir:(i.name||"").localeCompare(o.name||"")})}function Cr(){const{dossiers:t,st:a,t:r,dispatch:n,contName:i,pipe:o}=z(),s=c.useMemo(()=>{const d=(a.filters.day||"").slice(0,10),m=g=>!(!o&&g.continent!==a.continent||d&&(g.date||"").slice(0,10)!==d),b=t.filter(g=>m(g)&&ne(g)),u=t.filter(g=>m(g)&&g.kind==="op"&&!ne(g)&&(g.dealKind==="ma"||g.dealKind==="levee")&&(d?!0:Te(g.date)<=2));return u.sort((g,v)=>(v.amountEur||0)-(g.amountEur||0)),[...ut(b,{key:"signal",dir:-1}),...u].slice(0,40)},[t,a.continent,a.filters.day,o]),l=d=>s.map(m=>e.jsxs("button",{type:"button",className:"tk"+(de(m)?" spent":""),onClick:b=>{const u=b.currentTarget.getBoundingClientRect();n({type:"popup",id:m.id,anchor:{x:u.left+u.width/2,y:u.bottom}})},title:m.name+(m.tagline?" — "+m.tagline:""),children:[e.jsx(qe,{o:m}),e.jsxs("span",{className:"who",children:[e.jsx(ta,{o:m}),e.jsx("span",{className:"co",children:m.name})]}),typeof m.amountEur=="number"&&m.amountEur>0&&e.jsx("span",{className:"am",children:eo(m.amountEur)}),m.sector&&e.jsx("span",{className:"mt",children:m.sector}),e.jsx(Ye,{o:m}),e.jsx("span",{className:"tkgo",children:"→"})]},d+(m.id||m.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),r.live,e.jsx("span",{className:"cnt",children:s.length})]}),e.jsx("div",{className:"win",children:s.length?e.jsxs("div",{className:"run",children:[l(0),l(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const Er="aDx8z7Hzksus",Kt="+33 6 83 10 72 86",Tt="alexandre@proplace.co",zr=`tel:${Kt.replace(/[^\d+]/g,"")}`,At="pp-rdv-slot";function Tr(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Ar(){const{t,caps:a,fund:r}=z();if(!a.showOnb)return null;const n=r||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[e.jsx("style",{children:qr}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:zr,children:Kt}),t.rdvSubMid,e.jsx("a",{href:`mailto:${Tt}`,children:Tt})]}),e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(n).map(([i,o],s)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(s+1)}),e.jsx("b",{children:i}),e.jsx("span",{children:o})]},i))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(lr,{filloutId:Er,parameters:r?{company_name:r}:void 0})})]})}function Lr(){const[t,a]=c.useState(()=>typeof document>"u"?null:document.getElementById(At));return c.useEffect(()=>{t||a(document.getElementById(At))},[t]),t?Me.createPortal(e.jsx(Ar,{}),t):null}const qr=`
...
`;class te extends c.Component{constructor(){super(...arguments);gt(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Rr=8;function Or(){const{t,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:s}=z(),[l,d]=c.useState(!1),[m,b]=c.useState(!1),[u,g]=c.useState(!1),v=r||"home",{names:x,verdicts:f}=c.useMemo(()=>{const w=[],C={};return n.forEach(j=>{j.kind!=="target"||!j.name||(w.push(j.name),C[j.name]=Na(j)||"")}),{names:w,verdicts:C}},[n]),h=c.useMemo(()=>x.length?Sa(v,x,f,a):null,[v,x.length]);if(!i.pipe||l||!h||h.firstVisit||!h.added.length&&!h.gone.length)return null;const p=m?h.added:h.added.slice(0,Rr),y=h.added.length-p.length,S=w=>{const C=n.find(j=>j.name===w);C&&(o(C.id),s({type:"popup",id:C.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(h.added.length,h.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{d(!0),Ca(v,x,f,h.fp,a)},children:"×"})]}),!!h.added.length&&e.jsxs("div",{className:"since-c",children:[p.map(w=>e.jsx("button",{type:"button",onClick:()=>S(w),children:w},w)),y>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>b(!0),children:t.sinceMore(y)})]}),!!h.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>g(w=>!w),children:t.sinceOut(h.gone.length)}),u&&h.gone.slice(0,20).map(w=>e.jsx("span",{className:"gone",children:w},w))]})]})}const Ze=600,Ce=62,Lt="atl2:fstats";function Fr(){const{t,lang:a,data:r,caps:n,st:i,dispatch:o}=z(),[s,l]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Lt)==="on"}catch{return!1}}),d=r.stats,m=c.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),b=c.useMemo(()=>{if(d!=null&&d.since)return d.since;const y=new Date;return y.setDate(y.getDate()-((d==null?void 0:d.window_days)||30)),y.toISOString().slice(0,10)},[d==null?void 0:d.since,d==null?void 0:d.window_days]);if(!n.showFunnel||!d||typeof d.screened!="number")return null;const u=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,g=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),v=m.reduce((y,S)=>Math.max(y,S.s||0),0),x=m.length?Ze/m.length:0,f=Math.max(4,x-4),h=m.length>=5&&v>0,p=[[d.screened,t.funScreened(u(b)),d.screened_today],...typeof d.kept=="number"?[[d.kept,t.funKept,d.kept_today]]:[],...typeof d.analyzed=="number"?[[d.analyzed,t.funAnalyzed,d.analyzed_today]]:[],...typeof d.shown=="number"?[[d.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(s?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[p.map(([y,S,w],C)=>e.jsxs("span",{className:"fst-t",children:[C>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:g(y)}),e.jsx("i",{children:S}),s&&typeof w=="number"&&w>0&&e.jsx("em",{children:t.funToday(w)})]},S)),h&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?t.fstatsHide:t.fstatsShow,onClick:()=>{const y=!s;l(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Lt,y?"on":"off")}catch{}},children:s?"⌃":"⌄"})]}),s&&h&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${Ze} ${Ce}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[m.map((y,S)=>{const w=(y.s||0)/v*(Ce-4),C=(y.m||0)/v*(Ce-4),j=S*x+(x-f)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${u(y.d)} — ${y.s} ${t.actScreened} · ${y.m} ${t.actKept}`}),e.jsx("rect",{x:j,y:Ce-2-w,width:f,height:w,fill:"#cfe0d6"}),e.jsx("rect",{x:j,y:Ce-2-C,width:f,height:C,fill:"#185c38"})]},y.d)}),e.jsx("line",{x1:0,y1:Ce-1.5,x2:Ze,y2:Ce-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:u(m[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const Mr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Dr({o:t}){const{t:a,caps:r,canWrite:n,commitStatus:i}=z(),[o,s]=c.useState(""),[l,d]=c.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const m=(t.ceoStatus||"").trim(),b=(Ae(t)||"").startsWith("CALL")&&ie(t)===3,u=ie(t)>=2,g=async x=>{if(o||x==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(x);const f=await i(t,x);s(""),f&&(d(!0),setTimeout(()=>d(!1),2200))},v=b?[["Validé",a.csYes],["Écarté",a.csNo]]:Mr.filter(([x])=>!(u&&x==="Retenu")).map(([x,f])=>[x,a[f]]);return e.jsxs("div",{className:"csp",onClick:x=>x.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([x,f])=>e.jsx("button",{type:"button",className:"csb"+(m===x?" on":"")+(o===x?" busy":""),disabled:!!o,onClick:()=>{g(x)},children:f},x)),l&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(Pr,{o:t})]})}function Pr({o:t}){const{t:a,saveNote:r,flash:n}=z(),[i,o]=c.useState(t.ceoNote||""),[s,l]=c.useState(!1),[d,m]=c.useState(!1),b=i.trim()!==(t.ceoNote||"").trim(),u=async()=>{if(s||!b)return;l(!0);const g=await r(t,i.trim());l(!1),g&&(m(!0),setTimeout(()=>m(!1),2200),n(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:s,onChange:g=>o(g.target.value),onKeyDown:g=>{g.key==="Enter"&&u()}}),e.jsx("button",{type:"button",disabled:s||!b,onClick:()=>{u()},children:d?a.csNoteSaved:a.csNoteOk})]})}function Ir({placeholder:t,onDone:a}){const{t:r}=z(),[n,i]=c.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Br({o:t}){var h;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:s,flashErr:l}=z(),[d,m]=c.useState(!1);if(!n.pipe||!i||n.lockActions||ie(t)!==4)return null;const b=o(t),u=(b==null?void 0:b.stage)||"todo",g=async p=>{if(d||p===u)return;m(!0);const y=b;s(t,{stage:p,stamps:(b==null?void 0:b.stamps)||{}});const S=Math.max(Date.now(),qt+=1);qt=S;const w=await Ea(r,{company:t.name||"",stage:p,cts:S,deal_id:t.airtableId,check_id:t.checkId});m(!1),!w.stale&&(w.ok||(s(t,y),l(a.actErr)))},v=(h=b==null?void 0:b.stamps)==null?void 0:h.sent,x=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,f=u==="sent"&&v&&x>=4;return e.jsxs("div",{className:"stg",onClick:p=>p.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([p,y])=>e.jsx("button",{type:"button",className:"stgb"+(u===p?" on":""),disabled:d,onClick:()=>{g(p)},children:y},p)),f&&e.jsx("span",{className:"stgj4",children:a.j4Badge(x)})]})}let qt=0;const $e=8,_e=340;function Rt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((r,n)=>n%2?e.jsx("b",{children:r},n):e.jsx("span",{children:r},n))})}function $r({steps:t,onClose:a}){const{t:r,dispatch:n,counts:i,scoped:o,byId:s,st:l}=z(),[d,m]=c.useState(0),[b,u]=c.useState(null),[g,v]=c.useState([]),x=c.useRef(!1);c.useEffect(()=>{x.current||(x.current=!0,v(t.filter(C=>!!document.querySelector(C.need||C.sel))))},[t]);const f=g[d],h=d>=g.length;c.useEffect(()=>{f&&(f.ptab!==void 0&&l.ptab!==f.ptab&&n({type:"ptab",tab:f.ptab}),f.dens&&l.dens!==f.dens&&n({type:"dens",dens:f.dens}))},[d,f]);const p=c.useCallback(()=>{if(!f){u(null);return}const C=document.querySelector(f.sel);if(!C){u(null);return}C.scrollIntoView({block:"nearest",behavior:"smooth"}),u(C.getBoundingClientRect())},[f]);c.useLayoutEffect(()=>{p();const C=window.setTimeout(p,260),j=()=>p();return window.addEventListener("scroll",j,!0),window.addEventListener("resize",j),()=>{window.clearTimeout(C),window.removeEventListener("scroll",j,!0),window.removeEventListener("resize",j)}},[p]);const y=c.useRef(a);if(y.current=a,c.useEffect(()=>{const C=j=>{j.key==="Escape"?(j.preventDefault(),j.stopPropagation(),y.current()):j.key==="ArrowRight"?m(E=>E+1):j.key==="ArrowLeft"&&m(E=>Math.max(0,E-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!g.length)return null;let S=null;if(h){const C=i[3]||0,j=o.find(E=>E.memoUrl)||[...s.values()].find(E=>E.memoUrl);C>0?S={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:j?S={title:r.ahaBTitle,body:r.ahaBBody(j.name),btn:r.ahaBBtn,go:()=>{n({type:"memoConsole",id:j.id}),a()}}:S={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:_e};if(!h&&b){const C=b.bottom+14,E=window.innerHeight-C>190?C:Math.max(12,b.top-200);w={left:Math.min(Math.max(12,b.left+b.width/2-_e/2),window.innerWidth-_e-12),top:E,width:_e}}return Me.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!h&&b&&e.jsx("div",{className:"tour-hole",style:{left:b.left-$e,top:b.top-$e,width:b.width+$e*2,height:b.height+$e*2}}),(h||!b)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(h?" fin":""),style:w,children:[h&&S?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:S.title}),e.jsx("p",{children:e.jsx(Rt,{text:S.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>m(g.length-1),children:r.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:S.go,children:S.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:r.tourStep(d+1,g.length)}),e.jsx("h3",{children:f==null?void 0:f.title}),e.jsx("p",{children:e.jsx(Rt,{text:(f==null?void 0:f.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>m(C=>Math.max(0,C-1)),children:r.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>m(C=>C+1),children:d===g.length-1?r.tourDone:r.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function _r(){const{dossiers:t,scopedAll:a,pipe:r,mode:n,t:i,st:o,dispatch:s}=z(),l=r?a:t,d=c.useMemo(()=>l.filter(p=>Te(p.date)===0&&p.kind==="target"),[l]),m=c.useMemo(()=>r?a.filter(p=>ie(p)===0).slice().sort((p,y)=>(y.date||"").localeCompare(p.date||"")):[],[a,r]),b=c.useMemo(()=>d.filter(p=>r?ie(p)===0:!de(p)),[d,r]),u=r?m:b,g=r?a.length-m.length:d.length-b.length,v=r?a.length:d.length,x=v?Math.min(100,g/v*100):100;let f;r?f=i.morningThesis(d.length,m.length):d.length?g===0?f=i.goalSourced(d.length):g>=d.length?f=i.goalCleared:f=i.goalDone(g,d.length):f=i.goalSourced(0);const h=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&m.length&&s({type:"chainStart",queue:m.map(p=>p.id)})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:f}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:x+"%"}})}),u.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:r?i.morningEval(u.length):o.pileMode?i.goalContinue(u.length):i.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Ur(){var B,M;const{t,lang:a,st:r,dispatch:n,token:i,fund:o,data:s,dossiers:l,mode:d,doSync:m,startTour:b}=z(),[u,g]=c.useState(null),[v,x]=c.useState([]),f=d==="client";c.useEffect(()=>{if(!i||!o)return;let T=!0;return(async()=>{const[$,F]=await Promise.all([st(o),Ut(i)]);T&&($&&g($),x(F))})(),()=>{T=!1}},[i,o]);const h=(u==null?void 0:u.per_day)??null,p=((B=u==null?void 0:u.pool_order)==null?void 0:B.length)??0,y=v.filter(T=>T.status==="running").length,S=c.useMemo(()=>l.filter(T=>T.kind==="target"&&de(T)).length,[l]),w=s.marketEstimate,C=typeof((M=s.stats)==null?void 0:M.screened)=="number"?s.stats.screened:S,j=w&&w>0?Math.min(100,Math.round(C/w*100)):null,E=T=>T.toLocaleString(a==="en"?"en-US":"fr-FR"),N=(o||"P").split(/\s+/).map(T=>T[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const T=Date.parse(s.generatedAt||"");if(Number.isNaN(T))return"";const $=new Date(T),F=Q=>String(Q).padStart(2,"0");return`${F($.getDate())}/${F($.getMonth()+1)} à ${F($.getHours())}:${F($.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),q&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(q)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:b,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[j===null&&C>0&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsx("span",{className:"ev",children:e.jsx("b",{children:E(C)})})]}),j!==null&&w&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:j+"%"}})}),e.jsxs("b",{children:[j," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(C,w)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),h!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"q",children:h})," ",t.identPerDay]}),e.jsx("span",{className:"edv"})]}),h===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),y>0&&e.jsxs("span",{className:"ev",children:["⏳ ",y]}),e.jsx("span",{className:"ego",children:t.identPending(p)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:T=>{T.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!f,onClick:m,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:r.filters.search,onChange:T=>n({type:"filters",patch:{search:T.target.value}})})]})]})]})}function Vr(){const{t,counts:a,dispatch:r}=z();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([n,i],o)=>{const s=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(s?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:n}),e.jsx("div",{className:"s4d",children:i}),s&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Hr=["--p0","--p1","--p2","--p3","--p4"];function Yr(){const{st:t,dispatch:a,counts:r,t:n,doUndo:i}=z(),o=c.useRef({});c.useEffect(()=>{o.current={...r}},[r]);const s=m=>{const b=o.current[m],u=b!==void 0?r[m]-b:0;return e.jsxs("button",{type:"button",className:"step"+(m===3&&r[3]>0?" wait":""),style:{"--c":`var(${Hr[m]})`,"--tc":m<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===m,title:n.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsxs("span",{className:"l",children:[n.plabels[m].toUpperCase(),m===3&&r[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(u>0?" up":u<0?" down":""),children:[r[m],u!==0&&e.jsxs("em",{className:"delta",children:[u>0?"+":"−",Math.abs(u)]})]})]},m)},l=(m,b,u)=>e.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":m===5?"var(--p5)":m===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===m,title:n.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsx("span",{className:"l",children:u.toUpperCase()}),e.jsx("span",{className:"n",children:r[m]})]},m),d=(m,b,u,g=!1)=>e.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:u,children:m},b);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(s)}),e.jsxs("div",{className:"offtrack",children:[l(5,!1,n.plabels[5]),l(7,!0,n.plabels[7]),l(6,!0,"★ "+n.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[d("↩",n.toolUndo,i,t.undo.length===0),d("↺",n.toolReset,()=>{a({type:"reset"})}),d("⇅",n.toolSort,()=>a({type:"sort",key:t.sort.key})),d("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),d("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Wr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Gr(){const{st:t,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:s}=z(),l=c.useRef(null),[d,m]=c.useState(60);c.useEffect(()=>{let v=0;const x=()=>{var S;const f=l.current;if(!f)return;const h=(S=f.parentElement)==null?void 0:S.querySelector('.funnel [aria-selected="true"]');if(!h)return;const p=h.getBoundingClientRect(),y=f.getBoundingClientRect();m(Math.max(20,Math.min(p.left+p.width/2-y.left,y.width-30)))};return v=requestAnimationFrame(x),window.addEventListener("resize",x),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",x)}},[t.ptab]);const b=t.ptab;let u=r.tuto[b].p;if(b===3){const v=n.filter(h=>h.kind==="target"&&ie(h)===3),x=v.filter(h=>at(h)==="auto").length,f=v.filter(h=>at(h)==="cd").length;u=r.tutoPending(x,f,v.length)}const g=(()=>{if(s!=="client")return null;if(b===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(v=>v.id)})};if(b===1){const v=n.filter(x=>x.kind==="target"&&ie(x)===1&&!i.has(x.id)).slice(0,10);if(v.length)return{label:r.tuto[1].a,run:()=>v.forEach(x=>o(x))}}return null})();return e.jsxs("div",{ref:l,className:"tuto mini",style:{"--bg":Wr[b],"--ax":d+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:r.plabels[b].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:u}})]})}),g&&e.jsx("button",{type:"button",className:"tprim",onClick:g.run,children:g.label})]})}const Ot=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Ft(t){let a=2166136261;for(let r=0;r<t.length;r++)a^=t.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Kr(t,a){const[r,n]=c.useState(1);return c.useEffect(()=>{let i=!0,o=0;const s=()=>{var m;if(!i)return;const d=(m=t.current)==null?void 0:m.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(s)};s();const l=new ResizeObserver(()=>s());return t.current&&l.observe(t.current),window.addEventListener("resize",s),()=>{i=!1,cancelAnimationFrame(o),l.disconnect(),window.removeEventListener("resize",s)}},[t,a]),r}function Qr(){const{st:t,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:s,lang:l,t:d}=z(),m=c.useRef(null),b=c.useRef(null),u=lt.find(N=>N.key===t.continent),g=Kr(m,t.continent+":"+t.mapFolded),[v,x]=c.useState(new Map),[f,h]=c.useState(null);c.useEffect(()=>{const N=m.current;if(!N)return;const q=new Map;N.querySelectorAll("path[data-i2]").forEach(B=>{const M=B.dataset.i2;if(M)try{const T=B.getBBox();T.width>0&&q.set(M,{x:T.x,y:T.y,w:T.width,h:T.height})}catch{}}),x(q)},[t.continent,g]);const p=c.useMemo(()=>r.filter(N=>N.cc),[r]),y=c.useMemo(()=>{const N=new Map;return p.forEach(q=>N.set(q.cc,(N.get(q.cc)||0)+1)),N},[p]),S=c.useMemo(()=>p.map(N=>{const q=N.cc?v.get(N.cc):void 0;if(!q)return null;const B=Ft(N.name||N.id||""),M=Ft((N.id||N.name||"")+"·y"),T=(B-.5)*Math.min(q.w*.55,60),$=(M-.5)*Math.min(q.h*.55,60);return{d:N,x:q.x+q.w/2+T,y:q.y+q.h/2+$}}).filter(N=>!!N),[p,v]),w=N=>g>0?N/g:N,C=c.useMemo(()=>n?[0,1,2,3,4,5].map(N=>({c:Ot[N],fr:d.plabels[N].toUpperCase(),en:d.plabels[N].toUpperCase(),n:r.filter(q=>q.kind==="target"&&ie(q)===N).length})).filter(N=>N.n>0):wt.map((N,q)=>({...N,n:r.filter(B=>kt(B)===q).length})),[r,n,d.plabels]),j=o?s.get(o):null,E=j?S.find(N=>N.d.id===j.id):null;return e.jsxs("div",{className:"mapzone",ref:b,children:[e.jsxs("svg",{ref:m,viewBox:u.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":l==="fr"?u.fr:u.en,onMouseLeave:()=>{h(null),i(null)},children:[e.jsx("g",{children:u.countries.map((N,q)=>e.jsx("g",{className:"ct"+(N.i2&&y.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},q))}),e.jsx("g",{children:S.map(N=>{const q=wt[kt(N.d)],B=!!ne(N.d),M=N.d.kind==="target",T=n&&M?Ot[ie(N.d)]:q.c,$=!n&&de(N.d);return e.jsxs("g",{className:"co"+($?" done":""),onMouseEnter:()=>{var D,se;const F=(D=b.current)==null?void 0:D.getBoundingClientRect(),Q=(se=m.current)==null?void 0:se.createSVGPoint();if(Q&&m.current&&F){Q.x=N.x,Q.y=N.y;const me=Q.matrixTransform(m.current.getScreenCTM());h({x:me.x-F.left,y:me.y-F.top,label:N.d.name+" · "+(Le(N.d.cc,l)||N.d.countryLabel||"")})}i(N.d.id)},onMouseLeave:()=>{h(null),i(null)},onClick:()=>{var D;const F=(D=m.current)==null?void 0:D.createSVGPoint();let Q=null;if(F&&m.current){F.x=N.x,F.y=N.y;const se=F.matrixTransform(m.current.getScreenCTM());Q={x:se.x,y:se.y}}a({type:"popup",id:N.d.id,anchor:Q})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:w(Math.max(11,q.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:w(q.px),fill:T,stroke:B?"#DC2626":"#ffffff",strokeWidth:w(B?2.2:1.3)})]},N.d.id||N.d.name)})}),E&&e.jsx("circle",{className:"ring on",cx:E.x,cy:E.y,r:w(13),fill:"none",stroke:"#0F172A",strokeWidth:w(2)})]}),e.jsx("div",{className:"hov"+(f?" on":""),style:f?{left:f.x,top:f.y}:void 0,children:f==null?void 0:f.label}),e.jsx("div",{className:"legend",children:C.map((N,q)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),l==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},q))}),r.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",d.notLocated," ",e.jsx("b",{children:r.filter(N=>!N.cc).length})]})})]})}function Jr(t,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t);if(!r)return t;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Xr(){const{st:t,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:s}=z(),l=t.filters,d=c.useMemo(()=>r.filter(x=>x.continent===t.continent),[r,t.continent]),m=x=>d.filter(f=>x!=="country"&&l.country.length&&!l.country.includes(f.cc||"")?!1:pt(f,l,i,x==="country"?void 0:x)),b=c.useMemo(()=>{const x=m("win"),f=h=>x.filter(p=>(p.date?Math.max(0,Math.floor((Date.now()-Date.parse(p.date))/864e5)):9999)<=h).length;return[f(0),f(7),f(30),x.length]},[d,l,i]),u=c.useMemo(()=>l.day?m("win").filter(x=>(x.date||"").slice(0,10)===l.day).length:0,[d,l,i]),g=l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+(l.signalOnly?1:0)+(l.day||l.win!=="all"?1:0)+(l.search.trim()?1:0),v=(x,f,h,p="fbtn")=>e.jsxs("button",{type:"button",className:p,"aria-expanded":t.openFacet===x,onClick:()=>a({type:"openFacet",facet:x}),children:[e.jsx("span",{className:"fl",children:f}),h>0&&e.jsx("span",{className:"n",children:h}),e.jsx("span",{className:"cv",children:"▾"})]},x);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[l.day?e.jsxs("div",{className:"seg",children:[e.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(Jr(l.day,s)),e.jsx("b",{children:u})]}),e.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):e.jsx("div",{className:"seg",children:["1","7","30","all"].map((x,f)=>e.jsxs("button",{type:"button","aria-pressed":l.win===x,onClick:()=>a({type:"filters",patch:{win:x}}),children:[n.dates[f],e.jsx("b",{children:b[f]})]},x))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:n.identSearch,value:l.search,onChange:x=>a({type:"filters",patch:{search:x.target.value}})})]}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:n.fSignal}),l.signalOnly&&e.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),l.sector.length===1?e.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":t.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:l.sector[0],children:[e.jsx("span",{className:"fl",children:n.fSector}),e.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.sector[0]}),e.jsx("span",{className:"cv",children:"▾"})]}):v("sec",n.fSector,l.sector.length),v("pay",n.fCountry,l.country.length),v("det",n.fEngine,l.engine.length),v("sta",n.fStage,l.stage.length),i&&v("ang","Angle",l.angle.length),i&&v("mem","Mémo",l.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),g>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(d.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:n.clear(g)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),t.openFacet&&e.jsx(Zr,{poolFor:m})]})}function Zr({poolFor:t}){const{st:a,dispatch:r,t:n,lang:i}=z(),o=a.filters,s=a.openFacet,{title:l,cols:d,options:m}=c.useMemo(()=>{if(s==="sig"){const x=t("signal").filter(p=>ne(p)),f=new Map;x.forEach(p=>{const y=p.engine||"";f.set(y,(f.get(y)||0)+1)});const h=[{v:"*",label:n.fpSigAll,n:x.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...jt([...f.keys()],i).map(p=>({v:p,label:ze(p)+" "+ge(p,i),n:f.get(p)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(p)}))];return{title:n.fpSigTitle,cols:2,options:h}}if(s==="sec"){const x=t("sector"),f=new Map;return x.forEach(h=>{h.sector&&f.set(h.sector,(f.get(h.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...f.entries()].sort((h,p)=>p[1]-h[1]).map(([h,p])=>({v:h,label:h,n:p,html:!1,on:o.sector.includes(h)}))}}if(s==="pay"){const x=t("country"),f=new Map;return x.forEach(h=>{h.cc&&f.set(h.cc,(f.get(h.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...f.entries()].sort((h,p)=>p[1]-h[1]).map(([h,p])=>({v:h,label:Le(h,i)||h,n:p,html:!1,on:o.country.includes(h)}))}}if(s==="det"){const x=t("engine"),f=new Map;return x.forEach(h=>{h.engine&&f.set(h.engine,(f.get(h.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:jt([...f.keys()],i).map(h=>({v:h,label:ze(h)+" "+ge(h,i)+' <span style="color:var(--dim);font-size:10px">· '+za(Ta(h),i)+"</span>",n:f.get(h)||0,html:!0,on:o.engine.includes(h)}))}}if(s==="ang"){const x=t("angle"),f=new Map;return x.forEach(h=>{h.angle&&f.set(h.angle,(f.get(h.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((h,p)=>p[1]-h[1]).map(([h,p])=>({v:h,label:h.replace(/[_-]+/g," "),n:p,html:!1,on:o.angle.includes(h)}))}}if(s==="mem"){const x=t("memoLevel"),f=new Map;x.forEach(p=>{if(p.kind==="target"){const y=it(p);f.set(y,(f.get(y)||0)+1)}});const h=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(p=>({v:String(p),label:h[p],n:f.get(p)||0,html:!1,on:o.memoLevel.includes(p)}))}}const g=t("stage"),v=new Map;return g.forEach(x=>{x.stage&&v.set(x.stage,(v.get(x.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((x,f)=>f[1]-x[1]).map(([x,f])=>({v:x,label:x,n:f,html:!1,on:o.stage.includes(x)}))}},[s,a,i]),b=g=>{if(s==="sig"){if(g==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const x=o.signalEngines.includes(g)?o.signalEngines.filter(f=>f!==g):[...o.signalEngines,g];r({type:"filters",patch:{signalOnly:!0,signalEngines:x}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(g)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:g})},u=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:l}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:u,children:n.fpNone}),e.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),e.jsx("div",{className:"fcols"+(d===2?" two":""),children:m.map(g=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":g.on,onClick:()=>b(g.v),children:[e.jsx("span",{className:"bx"}),g.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:g.label}}):e.jsx("span",{className:"l",children:g.label}),e.jsx("span",{className:"n",children:g.n})]},g.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:n.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}const Mt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function en(t){return String(t||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function tn(){var xe;const{t,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:s,evalBusy:l,evalCards:d,caps:m,data:b}=z(),u=a==="client",[g,v]=c.useState(""),[x,f]=c.useState(!1),[h,p]=c.useState(""),[y,S]=c.useState(!1),[w,C]=c.useState(""),[j,E]=c.useState([]),N=c.useRef(!1),[q,B]=c.useState(!1),[M,T]=c.useState(""),[$,F]=c.useState(""),[Q,D]=c.useState(!1),[se,me]=c.useState(0),[he,be]=c.useState(""),[P,ce]=c.useState(null),[U,V]=c.useState(null),_=c.useRef(!1),I=g.trim()?Mt.test(g.trim())?t.evalUrl:t.evalName:t.evalWaiting,O=c.useMemo(()=>h.split(`
`).map(A=>A.trim()).filter(Boolean).slice(0,15),[h]),K=j.length?j:d,G=b.credits;c.useEffect(()=>{if(!Q)return;me(0);const A=window.setInterval(()=>me(Y=>Y+1),1e3);return()=>window.clearInterval(A)},[Q]);const ae=()=>{const A=g.trim();A&&(i(null,A),v(""))},Z=async()=>{if(!u){i(null,O[0]||"");return}if(!O.length||y)return;S(!0),N.current=!1;const A=[];for(let Y=0;Y<O.length&&!N.current;Y++){C(t.evaluating(Y+1,O.length,O[Y]));const J=await Vt(r,O[Y],"atelier2");if(A.unshift({name:J.company||O[Y],verdict:J.verdict,reason:J.reason||"",remaining:J.remaining??null}),E([...A]),J.verdict==="quota"){A.unshift({name:"",verdict:"quota",reason:t.quota(O.length-Y-1),remaining:0}),E([...A]),p(O.slice(Y+1).join(`
`)),C(""),S(!1);return}}C(""),p(N.current?O.slice(A.length).join(`
`):""),S(!1)},ee=async()=>{var J;if(_.current)return;const A=M.trim().replace(/\s+/g,""),Y=$.trim();if(!A&&!Y){be(t.rsNeed);return}_.current=!0,be(""),ce(null),V(null),D(!0);try{const W=await La({url:A,text:Y,email:n,cbToken:r});if(D(!1),!W||W.status!=="success"){be((W==null?void 0:W.message)||"Erreur");return}ce(W),B(!1);const ue=(((J=W.prospective)==null?void 0:J.companies_to_evaluate)||[]).map(ke=>((ke==null?void 0:ke.name)||"").trim()).filter(Boolean);ue.length&&(p(ke=>{const De=ke.split(`
...
`)}),f(!0)),V({state:"pending"});const we=await qa(W,{email:n,cbToken:r});V(we.ok&&we.url?{state:"ok",url:we.url}:{state:"fail",msg:we.error||""})}finally{_.current=!1,D(!1)}},ve=(((xe=P==null?void 0:P.prospective)==null?void 0:xe.companies_to_evaluate)||[]).filter(A=>A&&A.name),H=[P==null?void 0:P.industry,...(P==null?void 0:P.market_tags)||[],P==null?void 0:P.author].map(A=>(A||"").trim()).filter(Boolean),le=(U==null?void 0:U.state)==="pending",pe=U&&(le?e.jsx("span",{className:"rslink pend",children:t.rsPublishing}):U.state==="ok"?e.jsx("a",{className:"rslink",href:U.url,target:"_blank",rel:"noopener noreferrer",children:t.rsLink}):e.jsx("span",{className:"rslink fail",title:U.msg,children:t.rsPublishFail})),ye=x&&ve.length>0;return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:g,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:A=>v(A.target.value),onKeyDown:A=>{A.key==="Enter"&&ae()}}),e.jsx("span",{className:"detect"+(Mt.test(g.trim())?" url":""),children:I})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),disabled:l,onClick:ae,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),m.showCredits&&G&&e.jsxs("button",{type:"button",className:"credits"+(G.total_available<=0&&!G.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:G.unlimited?"∞":G.total_available}),!G.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",G.daily_grant+G.purchased]}),G.total_available<=0&&!G.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsxs("div",{className:"dunder",children:[e.jsx("button",{type:"button",className:"dmulti",onClick:()=>f(!x),children:t.evalMulti}),e.jsx("button",{type:"button",className:"dmulti dsearch"+(q?" on":""),onClick:()=>B(!q),children:t.rsOpen})]}),q&&e.jsxs("div",{className:"rsp on",children:[e.jsxs("div",{className:"rsf",children:[e.jsx("input",{className:"rsurl",value:M,placeholder:t.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:A=>T(A.target.value),onKeyDown:A=>{A.key==="Enter"&&ee()}}),e.jsx("span",{className:"rsor",children:t.rsOr}),e.jsx("textarea",{className:"rstext",value:$,placeholder:t.rsTextPh,onChange:A=>F(A.target.value)})]}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(Q?" loading":""),style:{justifyContent:"center"},disabled:Q||le||!M.trim()&&!$.trim(),onClick:()=>{ee()},children:[e.jsx("span",{className:"fill"}),Q?`${Aa(M.trim())==="youtube"&&M.trim()?t.rsRunningVid:t.rsRunning} ${t.rsElapsed(se)}`:le?t.rsPublishing:t.rsGo]}),e.jsx("span",{className:"hint",children:t.rsHint})]})]}),he&&e.jsx("div",{className:"rserr",children:he}),P&&e.jsxs("div",{className:"rscard",children:[e.jsxs("div",{className:"rsh",children:[e.jsx("b",{children:P.title}),P.source_url&&e.jsx("a",{href:P.source_url,target:"_blank",rel:"noopener noreferrer",children:t.rsSource}),e.jsx("button",{type:"button",className:"rsx",title:t.rsClose,onClick:()=>{ce(null),V(null)},children:"×"})]}),P.market&&e.jsx("p",{className:"rsmk",children:P.market}),H.length>0&&e.jsxs("div",{className:"rstags",children:[e.jsx("em",{children:t.rsTags}),H.map(A=>e.jsx("span",{children:A},A))]}),e.jsxs("div",{className:"rsbody",children:[P.mindmap_png_b64&&e.jsxs("figure",{className:"rsmm",children:[e.jsx("img",{src:`data:image/png;base64,${P.mindmap_png_b64}`,alt:t.rsMindmap}),e.jsx("figcaption",{children:t.rsMindmap})]}),e.jsx("div",{className:"rssum",children:en(P.summary_md||"").map((A,Y)=>e.jsx("p",{children:A},Y))})]}),e.jsxs("div",{className:"rsfoot",children:[e.jsx("span",{children:t.rsFound(ve.length)}),!ye&&pe]})]}),x&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:h,placeholder:t.bulkPh,onChange:A=>p(A.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(y?" loading":""),style:{justifyContent:"center"},disabled:y||!O.length,onClick:()=>{Z()},children:[e.jsx("span",{className:"fill"}),y&&w?w:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(O.length)}),ye&&pe]})]}),K.slice(0,1).map((A,Y)=>{const J=A.verdict==="kept",W=A.verdict==="quota",ue=J?"var(--brand)":W?"var(--bolt)":"var(--red)",we=J?"var(--brand-l)":W?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":ue,"--bgc":we},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:J?"✓ "+t.kept:W?"⏳":"✗ "+t.dropped})}),A.name&&e.jsx("span",{className:"rn",children:A.name}),e.jsx("span",{className:"rr",children:A.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",A.reason]}):null}),!W&&e.jsx("button",{type:"button",className:"go",onClick:()=>s({type:"modal",modal:"space"}),children:t.seeSpace(J?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},Y)}),u&&(o.kept+o.dropped>0||K.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(o.kept,o.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function an(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function rn(){const{st:t,dispatch:a,byId:r,t:n,doDeep:i}=z(),o=t.memoConsole?r.get(t.memoConsole):null,s=c.useMemo(()=>o?[o.reasoning||"",an(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const l=Ae(o),d=it(o);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:o.name}),l&&e.jsx("span",{className:"vv",children:l}),typeof o.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),e.jsx("div",{className:"mb2",children:s?s.split(`

`).map((m,b)=>e.jsx("p",{style:{margin:"0 0 10px"},children:m},b)):e.jsx("p",{children:n.memoNone})}),e.jsxs("div",{className:"mf",children:[dt(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:n.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):e.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const nn=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ue=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function on(t){const a=String(t||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Ue(a.slice(n));break}r+=Ue(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Ue(a.slice(i));break}const s=a.slice(i+1,o).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(s),d=l?l[2].toLowerCase():"";l&&nn.has(d)?r+=`<${l[1]}${d}>`:r+=Ue(a.slice(i,o+1)),n=o+1}return r}const Dt=(t,a)=>{const r=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function re({k:t,v:a,href:r}){return a==null||a===""?null:e.jsxs("div",{className:"cdl",children:[e.jsx("span",{className:"cdk",children:t}),r?e.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):e.jsx("span",{className:"cdv",children:String(a)})]})}function sn({o:t}){const{t:a,lang:r,dispatch:n,caps:i}=z(),o=He(t),s=Ae(t),l=(t.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[t.sector,t.stage,t.countryLabel,t.city,t.website,t.domain,t.linkedinCompany,t.angle,t.date].filter(Boolean).length,m=[t.contactName,t.contactEmail,t.contactLinkedin].filter(Boolean).length,b=[t.ceoStatus,t.ceoNote,i.pipe?t.memoUrl:"",i.pipe?t.memoPdfUrl:""].filter(Boolean).length+(typeof t.engagement=="number"&&t.engagement>0?1:0),u=c.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(l?1:0)+(t.reasoning?1:0)+(s?1:0)},{k:"ana",lib:a.cdAnalyse,n:(t.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:m},{k:"suivi",lib:a.cdSuivi,n:b}].filter(f=>f.n>0),[t,a,l,s,d,m,b]),[g,v]=c.useState("");if(!u.length)return null;const x=u.some(f=>f.k===g)?g:u[0].k;return e.jsxs("div",{className:"cdtabs",children:[e.jsx("div",{className:"cdnav",role:"tablist",children:u.map(f=>e.jsx("button",{type:"button",role:"tab","aria-selected":x===f.k,className:x===f.k?"on":"",onClick:h=>{h.stopPropagation(),v(f.k)},children:f.lib},f.k))}),e.jsxs("div",{className:"cdbody",onClick:f=>f.stopPropagation(),children:[x==="conv"&&e.jsxs(e.Fragment,{children:[l&&e.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[e.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),e.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.reasoning&&e.jsx("p",{className:"cdtxt",children:t.reasoning}),s&&e.jsxs("div",{className:"cdv1 memo",children:[e.jsx("b",{children:s}),e.jsx("span",{className:"cdw",children:a.cdMemo(t.memoType||"")})]}),e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(re,{k:a.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(re,{k:a.cdVerdictDate,v:Dt(t.verdictDate,r)})]})]}),x==="ana"&&e.jsxs(e.Fragment,{children:[t.summary&&e.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:on(t.summary)}}),i.pipe&&!i.lockActions&&e.jsx(ln,{o:t})]}),x==="soc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdSector,v:t.sector}),e.jsx(re,{k:a.cdStage,v:t.stage}),e.jsx(re,{k:a.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(re,{k:a.cdSite,v:t.domain||t.website,href:t.website||void 0}),e.jsx(re,{k:a.cdLinkedin,v:t.linkedinCompany?"LinkedIn":"",href:t.linkedinCompany}),e.jsx(re,{k:a.cdAngle,v:t.angle}),e.jsx(re,{k:a.cdDetected,v:Dt(t.date,r)})]}),x==="ctc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdName,v:t.contactName}),e.jsx(re,{k:a.cdEmail,v:t.contactEmail,href:t.contactEmail?`mailto:${t.contactEmail}`:void 0}),e.jsx(re,{k:a.cdLinkedin,v:t.contactLinkedin?"LinkedIn":"",href:t.contactLinkedin})]}),x==="suivi"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdCeoStatus,v:t.ceoStatus}),e.jsx(re,{k:a.cdEngagement,v:typeof t.engagement=="number"&&t.engagement>0?t.engagement:""})]}),t.ceoNote&&e.jsxs("p",{className:"cdtxt",children:["💬 ",t.ceoNote]}),i.pipe&&(t.memoUrl||t.memoPdfUrl)&&e.jsxs("div",{className:"cdacts",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),t.memoPdfUrl&&e.jsx("a",{className:"abtn",href:t.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function ln({o:t}){const{t:a,token:r}=z(),[n,i]=c.useState(!1),[o,s]=c.useState(null),l=async()=>{n||(i(!0),s(await Ra(r,t.name,t.website||t.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},m=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],b=m.some(([,u])=>u);return e.jsxs("div",{className:"qab",children:[!o&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mnote dim",children:a.qaHint}),e.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),o&&b&&e.jsxs(e.Fragment,{children:[m.filter(([,u])=>u).map(([u,g])=>e.jsxs("div",{className:"qal",children:[e.jsx("span",{className:"qak",children:u}),e.jsx("p",{children:g})]},u)),!!(o.pages||[]).length&&e.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!b&&e.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Qt({name:t}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=z(),[s,l]=c.useState(!1),[d,m]=c.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const b=async()=>{if(s)return;l(!0);const u=await Oa(r,t);if(l(!1),!u){o(a.actErr);return}m(u.results||[])};return e.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{b()},children:s?a.similarBusy:a.similar}),d&&(d.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:d.map(u=>e.jsxs("li",{children:[e.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&e.jsx("span",{children:u.reason})]},u.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Jt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function mt({o:t}){const{t:a}=z(),r=He(t),n=Ae(t),i=ie(t),o=at(t),s=Fa(t);return e.jsxs("span",{className:"c-vd",children:[r?e.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):e.jsx("span",{className:"vd wait",children:a.actToEval}),n?e.jsx("span",{className:"vd "+(Jt[n]||"v-cons"),title:a.vt[n],children:n}):i===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&s!==null&&e.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:a.waitTitle(s),children:a.waitChip(s)})]})}function Pt({o:t}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=z(),[o,s]=c.useState(!1);if(c.useEffect(()=>{n||s(!1)},[n]),de(t)){const m=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[m?"✓":"✗"," ",e.jsx("b",{children:m?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const d=o&&n;return e.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,onClick:m=>{m.stopPropagation(),s(!0),r(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function dn({o:t}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:s,doPromote:l,doRepeche:d,doApproach:m,dispatch:b}=z();if(r.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:v=>{v.stopPropagation(),b({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return e.jsx("span",{className:"cell",children:e.jsx(Pt,{o:t})});const u=ie(t),g=v=>x=>{x.stopPropagation(),v()};if(u===0)return e.jsx("span",{className:"cell",children:e.jsx(Pt,{o:t})});if(u===1){const v=n.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:g(()=>o(t)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:g(()=>s(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:g(()=>s(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})});if(u===4){const v=i.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:v,onClick:g(()=>m(t)),children:v?a.actApproachSent:a.actApproach})})}return u===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:g(()=>l(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})}):u===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:g(()=>d(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:g(()=>b({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function cn({o:t}){const{t:a,doThumb:r,thumbOf:n}=z(),i=n(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(t,!1)},children:"👎"})]})}function pn({o:t}){const{lang:a}=z();return ne(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(qe,{o:t}),e.jsx(Ye,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[ze(t.engine||"")," ",ge(t.engine||"",a)]})})}function un({o:t,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:s,markRow:l,markedId:d,favIds:m,toggleFav:b}=z(),u=ie(t),g=["#0F172A","#475C6E","#8798A8","#B9C6D2"],v=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,x=v<=0?0:v<=7?1:v<=30?2:3,f=s.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:g[x],h=m.has(t.id),p=y=>{if(a)return;if(s.pipe){n();return}const S=y.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return e.jsxs(c.Fragment,{children:[e.jsxs("div",{className:"row"+(d===t.id||r?" on":"")+(a?" locked":""),onMouseEnter:()=>l(t.id),onMouseLeave:()=>l(null),onClick:p,children:[e.jsx("span",{className:"pt",style:{"--c":f}}),e.jsx(ta,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[s.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:h?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),b(t)},children:h?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(y=>y&&y!==t.name)||""})]}),e.jsx(mn,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(pn,{o:t}),s.pipe&&e.jsx(mt,{o:t}),s.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(dn,{o:t}),s.showThumbs&&e.jsx(cn,{o:t})]}),(r||i.dens==="deplie")&&!a&&e.jsx(fn,{o:t})]})}function mn({o:t}){const{lang:a,caps:r}=z();if(r.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const n=ct(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function fn({o:t}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:s}=z();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),e.jsx(sn,{o:t}),e.jsx(Dr,{o:t}),e.jsx(Br,{o:t}),e.jsx(Qt,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(mt,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[ze(t.engine||"")," ",ge(t.engine||"",r)]}),ne(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(qe,{o:t})})]}),i.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>n({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(t),children:a.actOnboard})]})]})]})}function xn({o:t,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o}=z(),s=ie(t),l=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":l},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(mt,{o:t}),ne(t)&&e.jsx(qe,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&i.pipe&&s===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:r.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:r.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:t.id}),children:[r.actMemo," →"]})]})}function gn(){const t=z(),{st:a,dispatch:r,t:n,caps:i,scoped:o,lang:s,sessTally:l,data:d,dossiers:m}=t,[b,u]=c.useState(new Set);c.useEffect(()=>{u(new Set)},[a.ptab,a.continent]);const g=j=>u(E=>{const N=new Set(E);return N.has(j)?N.delete(j):N.add(j),N}),v=c.useMemo(()=>ut(o,a.sort),[o,a.sort]),x=c.useMemo(()=>v.filter(j=>ne(j)&&!de(j)).length,[v]),f=c.useMemo(()=>i.pipe?v:v.filter(j=>!de(j)),[v,i.pipe]),h=i.pipe?n.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,p=(j,E,N="",q=!1)=>e.jsxs("button",{type:"button","data-s":j,className:N,"aria-sort":a.sort.key===j?a.sort.dir===1?"ascending":"descending":"none",style:q?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:j}),children:[E,e.jsx("span",{className:"ar",children:a.sort.key===j&&a.sort.dir===1?"▴":"▾"})]},j),y=c.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const j=new Map;return v.forEach(E=>{const N=E.engine||"?";j.has(N)||j.set(N,[]),j.get(N).push(E)}),[...j.entries()]},[v,i.pipe,a.groupBy]),S=i.lockRowsAfter;let w=0;const C=(j,E)=>{const N=a.shown[E]||Ve,B=j.slice(0,N).map(M=>{const T=S!==null&&w>=S;return w++,a.dens==="maxi"?e.jsx(xn,{o:M,locked:T},M.id):e.jsx(un,{o:M,locked:T,open:b.has(M.id),onToggle:()=>g(M.id)},M.id)});return j.length>N&&B.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>r({type:"more",group:E,by:Ve}),children:n.more(Math.min(Ve,j.length-N),j.length-N)},E+":more")),B};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:v.length})," ",h]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,i.pipe&&t.fund?" · "+t.fund:""]}),i.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:n.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),i.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",n.densList],["deplie",n.densOpen],["maxi",n.densMaxi]].map(([j,E])=>e.jsxs("button",{type:"button","data-d":j,"aria-pressed":a.dens===j,onClick:()=>r({type:"dens",dens:j}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:E})]},j))}),i.showChain&&f.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:f.map(j=>j.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(f.length):n.chainAll(f.length)]})]}),x>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(x)}}),e.jsx("span",{className:"s",children:n.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),p("country",n.colCountry),p("name",n.colCompany),p("amount",n.colAmount,"h-amt",!0),p("stage",n.colStage,"h-stade"),p("signal",n.colSignal,"h-sig"),i.pipe&&e.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&p("score",n.colScore,"h-sc",!0),e.jsx("span",{}),i.showThumbs&&e.jsx("span",{className:"h-thu",children:n.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[y?y.map(([j,E])=>e.jsxs(c.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:ze(j)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:ge(j,s)}),e.jsx("div",{className:"s",children:n.grpCount(E.filter(N=>!de(N)).length,E.length)})]})]}),C(E,j)]},j)):C(v,"pt"+a.ptab),!v.length&&!(d.loading&&!m.length)&&e.jsx("div",{className:"void",children:i.pipe?n.emptyTab:n.emptyScope})]}),i.showThumbs&&e.jsxs("p",{className:"learn",children:[n.learnLine,e.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(l.kept>0||l.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(l.kept,l.dropped)}})]})}const hn=`
...
`;function bn(t){if(!t||typeof window>"u")return;const a=352,r=430,n=window.innerWidth,i=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,n-a-8));let s=t.y+10;return s+r>i-8&&(s=Math.max(8,t.y-r-14)),s<8&&(s=8),{left:o,top:s}}function vn(){const{st:t,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:s,askEvaluate:l,doAnalyse:d,doDecide:m,doPromote:b,doRepeche:u,doApproach:g,doDeep:v,doOnboard:x,outbound:f,evalBusy:h}=z(),p=t.popupId?r.get(t.popupId):null;if(!p)return null;const y=ne(p),S=ie(p),w=Ae(p),C=p.kind==="target",j=E=>{a({type:"filters",patch:E}),a({type:"popup",id:null})};return Me.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:hn}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:bn(t.popupAnchor),onClick:E=>E.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:p.name}),e.jsx("span",{className:"id",children:n.detected(n.daysAgo(Te(p.date)),ge(p.engine,i))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[p.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>j({country:[p.cc]}),children:(Le(p.cc,i)||p.countryLabel||"").toUpperCase()}),p.sector&&e.jsx("button",{type:"button",onClick:()=>j({sector:[p.sector]}),children:p.sector.toUpperCase()}),p.stage&&e.jsx("button",{type:"button",onClick:()=>j({stage:[p.stage]}),children:p.stage.toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&e.jsx("span",{className:"am2",children:ct(p.amountEur,i)})]}),(p.tagline||p.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.desc}),e.jsx("p",{children:p.tagline||p.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.how}),e.jsxs("p",{children:[ze(p.engine)," ",e.jsx("b",{children:ge(p.engine,i)})," — ",Ma(p.engine,i),p.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",p.noteTitle]})]}),y?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(qe,{o:p,lg:!0})," ",e.jsx(Ye,{o:p,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Ht(y,i))," · ",n.win7(Yt(y,i))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),p.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&S>=1?n.verdictCap:n.memo}),e.jsx("p",{className:"memo",children:p.reasoning})]}),o.pipe&&C&&w&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[w,typeof p.score=="number"&&p.score>0?" · "+n.score(p.score):""]})})]}),e.jsx(Qt,{name:p.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||s!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[S===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:h,onClick:()=>l(p),children:[e.jsx("span",{className:"fill"}),n.evalGo]}),S===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actAnalyse]}),S===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{b(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actPromote]}),S===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(p,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{m(p,!1),a({type:"popup",id:null})},children:n.actNo}),dt(p)&&e.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(p),a({type:"popup",id:null})},children:n.memoDeep})]}),S===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actApproach]}),S===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actRepeche]}),p.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:p.id}),a({type:"popup",id:null})},children:"📄"}),f&&e.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{x(p),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:h,onClick:()=>l(p),children:[e.jsx("span",{className:"fill"}),n.evalGo," →"]}),p.website&&e.jsx("a",{className:"psite",href:p.website.startsWith("http")?p.website:"https://"+p.website,target:"_blank",rel:"noopener noreferrer",title:p.website,children:"🌐"})]})]})]}),document.body)}function It(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function yn(t,a){const r=Da(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function wn(t,a){const n=[a.head.split("|").map(It).join(";")];for(const i of t){const o=a.stageOf(i);n.push([i.name||"",yn(i,a.plabels),He(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(It).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function kn(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const jn=(t,a)=>{const r=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function fe({k:t,v:a}){return a==null||a===""?null:e.jsxs("div",{className:"dsl",children:[e.jsx("span",{children:t}),e.jsx("b",{children:String(a)})]})}function Nn({o:t,qa:a}){const{t:r,lang:n,fund:i}=z(),o=(t.cribleStatus||"").trim().toUpperCase()||(He(t)==="NO MATCH"?"NO MATCH":"MATCH"),s=Ae(t),l=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return e.jsxs("article",{className:"dspage",children:[e.jsxs("header",{className:"dsh",children:[e.jsxs("div",{children:[e.jsx("b",{children:t.name}),t.tagline&&e.jsx("p",{children:t.tagline})]}),e.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,s&&e.jsx("em",{children:s})]})]}),t.reasoning&&e.jsxs("section",{children:[e.jsx("h3",{children:r.dsWhy}),e.jsx("p",{className:"dstxt",children:t.reasoning})]}),e.jsxs("section",{className:"dsgrid",children:[e.jsx(fe,{k:r.cdSector,v:t.sector}),e.jsx(fe,{k:r.cdStage,v:t.stage}),e.jsx(fe,{k:r.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(fe,{k:r.cdSite,v:t.domain||t.website}),e.jsx(fe,{k:r.cdName,v:t.contactName}),e.jsx(fe,{k:r.cdEmail,v:t.contactEmail}),e.jsx(fe,{k:r.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(fe,{k:r.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(fe,{k:r.cdAngle,v:t.angle}),e.jsx(fe,{k:r.cdDetected,v:jn(t.date,n)})]}),d.some(([,m])=>m)&&e.jsxs("section",{children:[e.jsx("h3",{children:r.dsAnalysis}),d.filter(([,m])=>m).map(([m,b])=>e.jsxs("div",{className:"dsb",children:[e.jsx("span",{children:m}),e.jsx("p",{children:b})]},m))]}),(t.ceoStatus||t.ceoNote)&&e.jsxs("section",{children:[e.jsx("h3",{children:r.dsDecision}),t.ceoStatus&&e.jsx("p",{className:"dstxt",children:e.jsx("b",{children:t.ceoStatus})}),t.ceoNote&&e.jsxs("p",{className:"dstxt",children:["« ",t.ceoNote," »"]})]}),e.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Sn(){const{t,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:s}=z(),[l,d]=c.useState({}),m=25,b=c.useMemo(()=>n.slice(0,m),[n]);c.useEffect(()=>{b.length&&Pa(r,b.map(v=>v.name)).then(d)},[r,b]);const u=o.stats,g=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return e.jsxs("div",{className:"dossier",children:[e.jsxs("div",{className:"dsbar",children:[e.jsx("b",{children:t.dsTitle(b.length)}),n.length>m&&e.jsx("span",{className:"mnote dim",children:t.dsCap(m,n.length)}),e.jsx("span",{className:"dssp"}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:t.printBtn})]}),e.jsxs("div",{className:"dscover",children:[e.jsx("b",{children:i}),u&&typeof u.screened=="number"&&e.jsxs("p",{children:[g(u.screened)," ",t.funScreened(""),typeof u.kept=="number"&&e.jsxs(e.Fragment,{children:[" · ",g(u.kept)," ",t.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&e.jsxs(e.Fragment,{children:[" · ",t.covOf(g(o.marketEstimate)),", ",Math.round(u.screened/o.marketEstimate*100)," %"]})]})]}),b.map(v=>e.jsx(Nn,{o:v,qa:l[v.name]},v.id)),!b.length&&e.jsx("p",{className:"mnote",children:t.dsEmpty})]})}const Cn=50;function ft({label:t,onPreview:a,onTest:r,readOnly:n}){const{t:i}=z(),[o,s]=c.useState(null),[l,d]=c.useState(!1),[m,b]=c.useState(""),[u,g]=c.useState(0),[v,x]=c.useState(""),[f,h]=c.useState(!1),p=c.useRef(null);c.useEffect(()=>()=>{p.current&&window.clearInterval(p.current)},[]);const y=async w=>{d(!0),b("");const C=await a();if(d(!1),C.ok){s(C);return}if(C.busy){b(i.alertPreviewBusy);return}if(!w){b(i.alertPreviewFail);return}g(Cn),p.current=window.setInterval(()=>{g(j=>j>1?j-1:(p.current&&window.clearInterval(p.current),y(!1),0))},1e3)},S=async()=>{if(n||f)return;h(!0),x("");const w=await r();h(!1),x(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:l||u>0,onClick:()=>{y(!0)},children:l?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:n||f,onClick:()=>{S()},children:f?"…":i.alertTest})]}),u>0&&e.jsx("p",{className:"mnote",children:i.alertPreviewRetry(u)}),m&&e.jsx("p",{className:"mnote warn",children:m}),v&&e.jsx("p",{className:"mnote",children:v}),!v&&e.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Fe="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function oe({title:t,icon:a,children:r,wide:n}){const{dispatch:i}=z();return Me.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:r})]})})}),document.body)}function En(){const{st:t}=z();switch(t.modal){case"chain":return e.jsx(Tn,{});case"space":return e.jsx(An,{});case"alert":return e.jsx(Ln,{});case"queue":return e.jsx(Mn,{});case"export":return e.jsx(Dn,{});case"plug":return e.jsx(Bn,{});case"recharge":return e.jsx(_n,{});case"cover":return e.jsx(Vn,{});case"dossier":return e.jsx(Un,{});case"crit":return e.jsx(Hn,{});case"tuto":return e.jsx(Yn,{});case"rdv":return e.jsx(zn,{});case"memoalert":return e.jsx(Pn,{});default:return null}}function zn(){const{dispatch:t,fund:a}=z(),r=typeof document<"u"&&!!document.getElementById("rdv");return c.useEffect(()=>{r&&(t({type:"modal",modal:null}),Tr())},[r,t]),r?null:e.jsx($a,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function Tn(){const{st:t,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:s,evalBusy:l}=z(),d=o==="client",m=t.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=t.chain.idx,u=m[b],g=b>=m.length;return Me.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:g?n.finished:`${b+1} / ${m.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(g?100:b/Math.max(1,m.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:g||!u?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:n.chainDone}),e.jsx("div",{className:"s",children:n.chainDoneSub(m.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:u.name}),e.jsx("div",{className:"sub",children:[Le(u.cc,i)||u.countryLabel,u.sector,u.stage,n.daysAgo(Te(u.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:ge(u.engine,i).toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{children:ct(u.amountEur,i)})]}),ne(u)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(qe,{o:u,lg:!0})," ",e.jsx(Ye,{o:u,src:!0})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),d&&de(u)&&e.jsxs("div",{className:"vbox",style:{"--c":Ee(u)==="retenu"?"var(--brand)":Ee(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:Ee(u)==="retenu"?"✓ "+n.kept:Ee(u)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),e.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!g&&u&&!(d&&de(u))&&e.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{s(u)},children:[e.jsx("span",{className:"fill"}),n.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(g?{type:"modal",modal:null}:{type:"chainNext"}),children:g?n.closeBtn:n.skip})]})]})})}),document.body)}function An(){const{st:t,dispatch:a,dossiers:r,t:n,mode:i}=z(),o=i==="client",s=c.useMemo(()=>o?r.filter(u=>de(u)):[],[r,o]),l=c.useMemo(()=>ut(s.filter(u=>Ee(u)==="retenu"),{key:"signal",dir:-1}),[s]),d=c.useMemo(()=>s.filter(u=>Ee(u)==="ecarte"),[s]),m=t.spaceTab==="retenu"?l:d,b=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(oe,{title:n.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:l.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:d.length})]})]}),m.length===0&&e.jsx("div",{className:"sp-empty",children:n.spEmpty}),m.slice(0,40).map(u=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":b},children:typeof u.score=="number"&&u.score>0?u.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:u.name}),e.jsx("div",{className:"rr",children:u.reasoning||u.tagline||""})]})]},u.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Ln(){const{mode:t}=z();return t==="client"||t==="apercu"?e.jsx(qn,{}):e.jsx(Fn,{})}function qn(){const{t,token:a,flash:r,flashErr:n,mode:i}=z(),[o,s]=c.useState("d"),l=i!=="client";return e.jsxs(oe,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>s("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>s("w"),children:t.alertTabWeekly}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>s("m"),children:t.alertTabMarket})]}),o==="d"&&e.jsx(Rn,{t,token:a,readOnly:l,flash:r,flashErr:n}),o==="w"&&e.jsx(On,{t,token:a,readOnly:l,flash:r,flashErr:n}),o==="m"&&e.jsx(Xt,{})]})}function Rn({t,token:a,readOnly:r,flash:n,flashErr:i}){const[o,s]=c.useState(null),[l,d]=c.useState(!1),[m,b]=c.useState(0);c.useEffect(()=>{let x=!0;return d(!1),Ct(a).then(f=>{x&&(f?s(f):d(!0))}),()=>{x=!1}},[a,m]);const u=x=>{r||Ct(a,x).then(f=>{if(!f){i(t.actErr);return}s(f),f.throttled?i(t.alertThrottled):n(t.alertSaved)})};if(l)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(x=>x+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const g=x=>!o.sections||o.sections.includes(x),v=x=>{const f=o.sections||t.alertSec.map(([h])=>h);u({sections:g(x)?f.filter(h=>h!==x):[...f,x]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>u({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>u({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>u({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>u({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([x,f])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:g(x),disabled:r,onChange:()=>v(x)}),e.jsxs("span",{children:[f,x==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},x))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(ft,{label:t.alertPreview,readOnly:r,onPreview:()=>Ga(a),onTest:()=>Wa(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function On({t,token:a,readOnly:r,flash:n,flashErr:i}){const[o,s]=c.useState(null),[l,d]=c.useState(!1),[m,b]=c.useState(0);c.useEffect(()=>{let x=!0;return d(!1),Et(a).then(f=>{x&&(f?s(f):d(!0))}),()=>{x=!1}},[a,m]);const u=x=>{r||Et(a,x).then(f=>{if(!f){i(t.actErr);return}s(f),n(t.alertSaved)})};if(l)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(x=>x+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const g=o.dow??0,v=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>u({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:g,disabled:r,onChange:x=>u({dow:Number(x.target.value)}),children:t.alertDow.map((x,f)=>e.jsx("option",{value:f,children:x},x))}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),e.jsxs("b",{children:[v," h"]}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.min(21,v+1)}),disabled:r,children:"＋"})]})]}),e.jsx(ft,{label:t.alertPreviewWeekly,readOnly:r,onPreview:()=>Qa(a),onTest:()=>Ka(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Xt(){const{st:t,t:a,lang:r,scoped:n,contName:i,email:o}=z(),[s,l]=c.useState(o||""),[d,m]=c.useState(!1),[b,u]=c.useState(!1);c.useEffect(()=>{o&&l(o)},[o]);const g=t.filters,v=c.useMemo(()=>n.filter(p=>ne(p)).length,[n]),x=g.win==="1"?0:g.win==="7"?1:g.win==="30"?2:3,f=async()=>{if(!(!/.+@.+\..+/.test(s)||b)){u(!0);try{await fetch(`${ot}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:g.sector,countries:g.country,source:o?"atelier2-client":"atelier2",website:""})}),m(!0)}finally{u(!1)}}},h=[[a.amRows.continent,i],[a.amRows.since,a.amSince[x]],[a.amRows.signal,g.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,g.engine.length?g.engine.map(p=>ge(p,r)).join(", "):a.amAllEngines],[a.amRows.sectors,g.sector.length?g.sector.join(", "):a.amAllSectors],[a.amRows.countries,g.country.length?g.country.map(p=>Le(p,r)||p).join(", "):a.amAllCountries],[a.amRows.stages,g.stage.length?g.stage.join(", "):a.amAllStages]];return d?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:h.map(([p,y])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:p}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},p))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!o,onChange:p=>l(p.target.value),onKeyDown:p=>{p.key==="Enter"&&f()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(b?" loading":""),style:{padding:"12px 18px"},onClick:()=>void f(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})}function Fn(){const{t}=z();return e.jsx(oe,{title:t.alertTitle,icon:"🔔",children:e.jsx(Xt,{})})}function Mn(){var f,h,p;const{t,token:a,fund:r,mode:n,flash:i}=z(),[o,s]=c.useState(null),[l,d]=c.useState([]),[m,b]=c.useState(0),u=n==="client";c.useEffect(()=>{let y=!0;return(async()=>{const[S,w]=await Promise.all([st(r),Ut(a)]);y&&(S&&s(S),d(w))})(),()=>{y=!1}},[a,r,m]);const g=(o==null?void 0:o.per_day)??2,v=((f=o==null?void 0:o.analyzed_today)==null?void 0:f.length)??0,x=(h=o==null?void 0:o.tomorrow)!=null&&h.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(oe,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(v,v+(((p=o==null?void 0:o.pool_order)==null?void 0:p.length)??0))}})}),e.jsxs("div",{className:"qrate",children:[t.covRate," — ",e.jsx("b",{children:t.covRateNow(g)})]})]}),l.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:l.map(y=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:y.company}),e.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),e.jsx("span",{className:"qt",children:y.status}),y.url&&e.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),u&&y.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{St(a,y.company,"retry").then(()=>b(S=>S+1))},children:t.queueRetry}),u&&y.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{St(a,y.company,"delete").then(()=>b(S=>S+1))},children:t.queueDelete})]},y.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[x.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),x.slice(0,10).map((y,S)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",S+1]}),e.jsx("b",{children:y.name}),typeof y.score=="number"&&e.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Dn(){const{t,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:s}=z(),l=`${Fe}/cibles/list.csv?token=${a}`,d=`${Fe}/cibles/list.json?token=${a}`,m=`${Fe}/cibles/export.xlsx?token=${a}&scope=full`,b=`=IMPORTDATA("${l}")`,u=h=>{var p;(p=navigator.clipboard)==null||p.writeText(h).then(()=>r(t.exportCopied))},g=[{def:t.exportCsv,value:l,href:l},{def:t.exportSheet,value:b},{def:t.exportLive,value:d,href:d},{def:t.exportXlsx,value:m,href:m}],v=!i.lockActions&&n.length>0,x=()=>{kn(wn(n,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:h=>(t.stg.find(([p])=>p===h)||["",""])[1]})),r(t.exportViewDone(n.length))},f=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return e.jsxs(oe,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🖨️"}),e.jsxs("div",{children:[e.jsx("b",{children:t.printTitle}),e.jsx("p",{children:t.printDesc(n.length)})]}),e.jsx("button",{type:"button",className:"exb",onClick:f,children:t.printBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🗂"}),e.jsxs("div",{children:[e.jsx("b",{children:t.dsBtn}),e.jsx("p",{children:t.dsHint})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:t.exportViewBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(n.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:x,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:g.map(({def:h,value:p,href:y})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:h[0]}),e.jsxs("div",{children:[e.jsx("b",{children:h[1]}),e.jsx("p",{children:h[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>u(p),children:t.exportCopy}),y&&e.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},h[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function Pn(){const{t,token:a,flash:r,flashErr:n,mode:i}=z(),o=i!=="client",[s,l]=c.useState(null),[d,m]=c.useState(!1),[b,u]=c.useState(0),[g,v]=c.useState(!1);c.useEffect(()=>{let p=!0;return m(!1),Nt(a).then(y=>{p&&(y?l(y):m(!0))}),()=>{p=!1}},[a,b]);const x=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},f=p=>{if(o||!s)return;const y={enabled:p.enabled??!!s.enabled,email:p.email??(s.email||""),sections:p.sections??x()};v(!0),Nt(a,y).then(S=>{if(v(!1),!S){n(t.memoAlertErr);return}l(S),r(t.memoAlertSaved)})};if(d)return e.jsx(oe,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>u(p=>p+1),children:t.retry})]})});if(!s)return e.jsx(oe,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const h=x();return e.jsxs(oe,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:o||g,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),e.jsx(In,{value:s.email||"",readOnly:o||g,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:p=>f({email:p})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([p,y])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!h[p],disabled:o||g,onChange:()=>f({sections:{...h,[p]:!h[p]}})}),e.jsx("span",{children:y})]},p))}),e.jsx(ft,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>Ba(a,h),onTest:()=>Ia(a,h)})]})}function In({value:t,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,s]=c.useState(t);c.useEffect(()=>{s(t)},[t]);const l=o.trim()!==t.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:r}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:m=>s(m.target.value),onKeyDown:m=>{m.key==="Enter"&&l&&d&&i(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!d,onClick:()=>i(o.trim()),children:n})]})]})}function Bn(){const{t,token:a,flash:r,flashErr:n,canWrite:i}=z(),[o,s]=c.useState(null),[l,d]=c.useState(!1),[m,b]=c.useState(null),[u,g]=c.useState(""),[v,x]=c.useState(0);c.useEffect(()=>{let p=!0;return d(!1),rt(a).then(y=>{p&&(y?s({configured:y.configured,url_hint:y.url_hint}):d(!0))}),Ua(a).then(y=>{p&&b(y)}),()=>{p=!1}},[a,v]);const f=(p,y)=>{i&&rt(a,p).then(S=>{if(!S||S.ok===!1){n(t.actErr);return}p.test&&S.sent===!1?n(t.plugTestThrottled):r(y),x(w=>w+1)})},h='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(oe,{title:t.plugTitle,icon:"🔌",wide:!0,children:[m&&e.jsx("p",{className:"mnote"+(m.enabled?" warn":""),children:m.enabled?t.plugAutoOn(m.destination||"webhook"):t.plugAutoOff}),l?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>x(p=>p+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:u,disabled:!i,onChange:p=>g(p.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!i||!u.trim(),onClick:()=>f({url:u.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>f({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>f({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx($n,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:h}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var p;(p=navigator.clipboard)==null||p.writeText(h).then(()=>r(t.exportCopied))},children:t.exportCopy})]})]})]})}function $n(){const{t,token:a,lang:r}=z(),[n,i]=c.useState("valides"),[o,s]=c.useState(!1),[l,d]=c.useState(null),[m,b]=c.useState(null),[u,g]=c.useState(!1),[v,x]=c.useState(!1),[f,h]=c.useState(null),[p,y]=c.useState(null),[S,w]=c.useState(null),C=`atl2:bulk:${a}:${n}`;c.useEffect(()=>{rt(a).then(T=>{y(T&&T.configured?T.url_hint||"webhook":null)})},[a]),c.useEffect(()=>{d(null),b(null),g(!1),h(null);try{const T=JSON.parse(localStorage.getItem(C)||"null");w(T&&Date.now()-Date.parse(T.t)<24*3600*1e3?T:null)}catch{w(null)}},[C]);const j=async()=>{s(!0),g(!1),h(null);const T=await Ha(a,n);d(T),b(T.ok?n:null),s(!1)},E=c.useRef(!1),N=async()=>{if(E.current)return;E.current=!0,x(!0);const T=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let $;try{$=await Ya(a,n,"webhook",void 0,T)}finally{E.current=!1}if(x(!1),g(!1),h($),$.ok&&($.pushed||0)>0){const F={t:new Date().toISOString(),n:$.pushed||0};w(F);try{localStorage.setItem(C,JSON.stringify(F))}catch{}}},q=l!=null&&l.ok&&l.ready||0,B=!!(l!=null&&l.ok)&&m===n&&q>0&&!!p&&!S,M=S?new Date(S.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:n,onChange:T=>i(T.target.value),children:t.plugBulkTabs.map(([T,$])=>e.jsx("option",{value:T,children:$},T))}),e.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{j()},children:o?"…":t.plugBulkPreview})]}),l&&(l.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(l.ready||0,l.linkedinReady||0,(l.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr})),!!(l!=null&&l.ok)&&e.jsx("p",{className:"mnote dim",children:t.bulkScope}),S&&e.jsx("p",{className:"mnote",children:t.bulkLocked(M,S.n)}),!S&&!!(l!=null&&l.ok)&&!p&&e.jsx("p",{className:"mnote warn",children:t.bulkNoDest}),!S&&!l&&e.jsx("p",{className:"mnote dim",children:t.bulkPreviewFirst}),B&&!u&&e.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>g(!0),children:t.bulkArm}),B&&u&&e.jsxs("div",{className:"bulkc",children:[e.jsx("p",{className:"mnote warn",children:t.bulkWarn(q,p||"")}),e.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{N()},children:v?t.bulkSending:t.bulkConfirm(p||"")}),e.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>g(!1),children:t.bulkCancel})]}),f&&(f.ok?f.replayed?e.jsx("p",{className:"mnote",children:f.pending?t.bulkPending:t.bulkReplayed}):(f.pushed||0)>0?e.jsx("p",{className:"mnote",children:t.bulkDone(f.pushed||0,f.linkedinReady||0,f.skippedNoEmail||0)}):e.jsx("p",{className:"mnote warn",children:t.bulkNone}):e.jsx("p",{className:"mnote warn",children:f.error||t.actErr}))]})}function _n(){const{t,data:a,lang:r}=z(),n=a.credits,i=a.email,o=async s=>{if(!i)return;const l=window.location.href.split("?")[0];try{const m=await(await fetch(`${ot}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:s,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();m.url&&(window.location.href=m.url)}catch{}};return e.jsxs(oe,{title:t.rechargeTitle,icon:"⚡",children:[n&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(n.daily_grant)}}),n.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(n.costs.instant)," · ② ",t.creditsCost(n.costs.detailed)]}),e.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(s.credits,s.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(s.lookup_key)},children:t.rechargeBuy})]},s.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!n&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function Un(){const{t}=z();return e.jsx(oe,{title:t.dsBtn,icon:"🗂",wide:!0,children:e.jsx(Sn,{})})}function Vn(){const{t,lang:a,data:r,dossiers:n,token:i,canWrite:o,flash:s}=z(),[l,d]=c.useState(null),[m,b]=c.useState(!1);c.useEffect(()=>{let j=!0;return st(i).then(E=>{j&&E&&typeof E.per_day=="number"&&d(E.per_day)}),()=>{j=!1}},[i]);const u=r.stats,g=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(j=>j.kind==="target"&&de(j)).length,v=r.marketEstimate||0,x=v>0?Math.min(100,Math.round(g/v*100)):null,f=(u==null?void 0:u.window_days)||30,h=g>0?g/f:0,p=v>0?Math.max(0,v-g):0,S=v>0&&h>0&&g>=100?Math.round(p/h):null,w=j=>Math.round(j).toLocaleString(a==="en"?"en-US":"fr-FR"),C=j=>{m||!o||(b(!0),Va(i,j).then(E=>{if(b(!1),E===null){s(t.actErr);return}d(E),s(t.alertSaved)}))};return e.jsxs(oe,{title:t.coverTitle,icon:"🌍",children:[e.jsxs("div",{className:"covg",children:[e.jsx("b",{children:t.covScreened(w(g))}),v>0&&e.jsx("span",{children:t.covOf(w(v))})]}),x!==null?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"covbar",children:[e.jsx("i",{style:{width:x+"%"}}),e.jsxs("em",{children:[x," %"]})]}),S!==null&&e.jsx("p",{className:"mnote",children:t.covEta(S)})]}):e.jsx("p",{className:"mnote dim",children:t.covNoEst}),h>=1&&e.jsx("p",{className:"mnote",children:t.covPace(w(h))}),u&&e.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.kept)})," ",t.covKept]}),typeof u.analyzed=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.analyzed)})," ",t.covAna]}),typeof u.shown=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.shown)})," ",t.covShown]})]}),o&&l!==null&&e.jsxs("div",{className:"covr",children:[e.jsxs("div",{className:"covrh",children:[e.jsx("span",{children:t.covRate}),e.jsx("b",{children:t.covRateNow(l)})]}),e.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(j=>e.jsx("button",{type:"button",className:l===j?"on":"",disabled:m,onClick:()=>C(j),children:j===0?"⏸":j},j))}),e.jsx("p",{className:"mnote dim",children:t.covRateHint})]})]})}function Hn(){var p,y,S;const{t,dossiers:a,token:r,mode:n,flash:i,criteria:o}=z(),s=n==="client",l=c.useMemo(()=>{const w=new Set;return a.forEach(C=>{C.angle&&w.add(C.angle)}),[...w]},[a]),[d,m]=c.useState(null);c.useEffect(()=>{let w=!0;return _a(r).then(C=>{w&&m(C.thumbs)}),()=>{w=!1}},[r]);const[b,u]=c.useState(""),[g,v]=c.useState(""),[x,f]=c.useState(!1),h=async()=>{const w=b.trim();if(!(!w||x||!s)){f(!0),v("");try{const j=await(await fetch(`${Fe}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(j.reply&&v(String(j.reply)),j.job_id){v(t.critChatRunning);const E=async()=>{const N=await fetch(`${Fe}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:j.job_id})}).then(q=>q.json()).catch(()=>null);if(N&&N.done){v(String(N.reply||N.clarification||N.summary||"✓")),f(!1),N.applied&&i(t.alertSaved);return}setTimeout(()=>{E()},8e3)};setTimeout(()=>{E()},8e3),u("");return}u("")}finally{g.startsWith("⏳")||f(!1)}}};return e.jsxs(oe,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((p=o.points)!=null&&p.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(w=>e.jsx("li",{children:w},w))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(w=>{var C,j;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:w.title}),w.why&&e.jsx("p",{className:"why",children:w.why}),e.jsxs("div",{className:"lo",children:[!!((C=w.look)!=null&&C.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:w.look.map(E=>e.jsx("li",{children:E},E))})]}),!!((j=w.out)!=null&&j.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:w.out.map(E=>e.jsx("li",{children:E},E))})]})]})]},w.title)})]}),!!((S=o==null?void 0:o.gate)!=null&&S.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>e.jsxs("li",{children:[w.k&&e.jsx("b",{children:w.k}),w.t]},w.t))})]}),l.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:l.map(w=>e.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:b,disabled:!s||x,onChange:w=>u(w.target.value),onKeyDown:w=>{w.key==="Enter"&&h()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(x?" loading":""),style:{padding:"12px 18px"},disabled:!s||x||!b.trim(),onClick:()=>void h(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),g&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:g})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),d===null?e.jsx("div",{className:"sp-empty",children:"…"}):d.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:d.slice(0,12).map((w,C)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:w.company}),e.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},C))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Jt[w]||"v-cons"),children:w}),e.jsx("span",{children:C})]},w))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:w}),e.jsxs("span",{children:["← ",C]})]},w))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function Yn(){const{t,dispatch:a,startTour:r}=z(),n=i=>{var o,s;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return e.jsxs(oe,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([i,o],s)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(o))},children:[e.jsx("span",{className:"n",children:s+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+s))})]})}const et={},Wn=(et==null?void 0:et.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function tt(){return new Date().toISOString().slice(0,10)}function Gn({token:t}){const{dispatch:a,st:r,lang:n}=z(),[i,o]=c.useState(()=>r.filters.day||tt()),[s,l]=c.useState(null),[d,m]=c.useState(!1);if(c.useEffect(()=>{const v=x=>{var h;const f=(h=x.detail)==null?void 0:h.day;if(typeof f=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(f)){o(f);try{a({type:"filters",patch:{day:f,win:"all"}})}catch{}}};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[a]),c.useEffect(()=>{r.filters.day&&r.filters.day!==i&&o(r.filters.day)},[r.filters.day]),c.useEffect(()=>{if(!t||!i)return;let v=!1;m(!0);const x=new URLSearchParams({token:t,date:i});return fetch(`${Wn}/cibles/edition.json?${x}`).then(f=>f.json()).then(f=>{v||l(f)}).catch(()=>{v||l({ok:!1,error:"network"})}).finally(()=>{v||m(!1)}),()=>{v=!0}},[t,i]),!t)return null;const b=!!(s!=null&&s.ok&&(s.html||s.acquirers_html)),u=(s==null?void 0:s.ok)&&!b,g=s&&!s.ok;return e.jsxs("section",{className:"edition-band","data-day":(s==null?void 0:s.date)||i,children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"edition-band__days",children:[e.jsx("p",{className:"edition-band__days-h",children:n==="en"?"Daily editions · pick a day":"Éditions quotidiennes · choisir un jour"}),e.jsx(Ja,{month:i.slice(0,7),current:i})]}),e.jsxs("div",{className:"edition-band__panel",children:[e.jsxs("header",{className:"edition-band__hd",children:[e.jsx("span",{className:"edition-band__kicker",children:n==="en"?"Edition":"Édition"}),e.jsxs("h2",{className:"edition-band__title",children:[n==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(s==null?void 0:s.count)!=null&&s.count>0?` · ${s.count}`:""]}),((s==null?void 0:s.date)||i)&&e.jsx("time",{className:"edition-band__date",dateTime:(s==null?void 0:s.date)||i,children:(s==null?void 0:s.date)||i})]}),d&&!b&&e.jsx("p",{className:"edition-band__loading",children:n==="en"?"Loading the day’s edition…":"Chargement de l’édition du jour…"}),g&&e.jsxs("p",{className:"edition-band__err",children:[n==="en"?"Could not load this edition.":"Impossible de charger cette édition.",s!=null&&s.error?` (${s.error})`:""]}),u&&!d&&e.jsx("p",{className:"edition-band__empty",children:n==="en"?e.jsxs(e.Fragment,{children:["No editorial for ",e.jsx("b",{children:i})," yet. Pick another day above, or check back after the morning run (the same edition that feeds your daily email)."]}):e.jsxs(e.Fragment,{children:["Pas encore d’éditorial pour le ",e.jsx("b",{children:i}),". Choisissez un autre jour ci-dessus, ou revenez après le run du matin (même édition que l’email quotidien « Opérations pertinentes pour votre thèse »)."]})}),b&&(s!=null&&s.html)?e.jsx("div",{className:"edition-band__body",dangerouslySetInnerHTML:{__html:s.html}}):null,b&&(s!=null&&s.acquirers_html)?e.jsx("div",{className:"edition-band__acq",dangerouslySetInnerHTML:{__html:s.acquirers_html}}):null,i&&i!==tt()&&e.jsx("button",{type:"button",className:"edition-band__clear",onClick:()=>{const v=tt();o(v),a({type:"filters",patch:{day:"",win:"all"}});try{window.dispatchEvent(new CustomEvent("pp-edition-day",{detail:{day:v}}))}catch{}},children:n==="en"?"← Back to today":"← Revenir à aujourd’hui"})]})]})}const Zt="atl2:mapfold",Kn=()=>{if(typeof window>"u")return!1;try{const t=localStorage.getItem(Zt);if(t==="on")return!0;if(t==="off")return!1}catch{}return window.innerHeight<1e3},ea=c.createContext(null),z=()=>{const t=c.useContext(ea);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function qe({o:t,lg:a}){const{lang:r}=z(),n=ne(t);return n?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:zt(n,r),children:[n.emoji," ",zt(n,r)]}):null}function Ye({o:t,src:a}){const{lang:r,t:n}=z(),i=ne(t);if(!i)return null;const o=ar(i),s=rr(i);return e.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(Ht(i,r))+" · "+n.win7(Yt(i,r)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(l,d)=>e.jsx("i",{className:d<o?"on":""},d))}),e.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&e.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function ta({o:t}){const{lang:a}=z(),r=tr(t.cc),n=t.cc?Le(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:n||void 0,children:r?e.jsx("img",{src:r,width:24,height:18,alt:n||""}):e.jsx("span",{className:"em",children:"🌐"})})}const Bt="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",aa=t=>`atl2:tour:${t||"anon"}`;function Qn(t){try{return localStorage.getItem(aa(t))==="1"}catch{return!0}}function $t(t){try{localStorage.setItem(aa(t),"1")}catch{}}function Jn(t){const a=t.tourT,r=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function ro({demo:t=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){const{lang:s}=Xa(),l=pr[s],d=kr(t,s,a),[m,b]=c.useReducer(Nr,void 0,()=>jr((n==null?void 0:n.continent)??"europe",t||Kn(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),u=c.useRef(!0);c.useEffect(()=>{if(u.current){u.current=!1;return}if(!t)try{localStorage.setItem(Zt,m.mapFolded?"on":"off")}catch{}},[m.mapFolded,t]);const g=c.useRef(o);g.current=o,c.useEffect(()=>{var k;(k=g.current)==null||k.call(g,m.filters)},[m.filters]);const[v,x]=c.useState(null),[f,h]=c.useState(null),[p,y]=c.useState({kept:0,dropped:0}),[S,w]=c.useState(!1),[C,j]=c.useState(""),[E,N]=c.useState(!1),[q,B]=c.useState(null),[M,T]=c.useState(!1),[$,F]=c.useState(!1),[,Q]=c.useState(0),D=()=>Q(k=>k+1),se=c.useRef([]),me=c.useRef(new Set),he=c.useRef(new Set),be=c.useRef(new Map),P=c.useRef(null),{mode:ce}=d,U=c.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),V=U.pipe,_=d.session.token||"",I=ce==="client"&&!t;c.useEffect(()=>{if(document.querySelector(`link[href="${Bt}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=Bt,document.head.appendChild(k)},[]);const O=(k,L=!1)=>{j(k),N(L),P.current&&clearTimeout(P.current),P.current=setTimeout(()=>j(""),L?4200:2400)},K=k=>O(k,!0),G=c.useMemo(()=>{const k=new Map;return d.dossiers.forEach(L=>{L.id&&k.set(L.id,L)}),k},[d.dossiers]),ae=c.useMemo(()=>d.dossiers.filter(k=>Gt(k,m,V)),[d.dossiers,m,V]),Z=c.useRef(!1);c.useEffect(()=>{if(Z.current||t||d.loading||!d.dossiers.length)return;if(!U.showFunnel||Qn(d.session.token||"")){Z.current=!0;return}Z.current=!0;const k=window.setTimeout(()=>{$t(d.session.token||""),T(!0)},700);return()=>window.clearTimeout(k)},[t,d.loading,d.dossiers.length,U.showFunnel,d.session.token]);const ee=c.useMemo(()=>d.dossiers.filter(k=>Sr(k,m,V,d.favIds)),[d.dossiers,m,V,d.favIds]),ve=c.useMemo(()=>Za(ae,d.favIds),[ae,d.favIds]),H=lt.find(k=>k.key===m.continent),le=s==="fr"?H.fr:H.en;c.useEffect(()=>{const k=L=>{var X;const R=(((X=L.detail)==null?void 0:X.name)||"").trim();R&&pe(null,R)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)});const pe=(k,L)=>{const R=((k==null?void 0:k.name)||L||"").trim();if(!I){h({kicker:R});return}!R||S||(w(!0),(async()=>{try{const X=await Vt(_,R,"atelier2"),Pe={name:X.company||R,verdict:X.verdict,reason:X.reason||"",remaining:X.remaining??null};se.current=[Pe,...se.current].slice(0,8),X.verdict==="kept"&&y(Ne=>({...Ne,kept:Ne.kept+1})),X.verdict==="ruled_out"&&y(Ne=>({...Ne,dropped:Ne.dropped+1}));const Re=k||d.dossiers.find(Ne=>(Ne.name||"").toLowerCase()===R.toLowerCase());Re&&(X.verdict==="kept"?Re.verdict=Re.verdict||"MATCH":X.verdict==="ruled_out"&&(Re.verdict="NO MATCH"),X.reason&&(Re.reasoning=X.reason)),D()}finally{w(!1)}})())},ye=k=>{if(!I){h({kicker:k.name});return}me.current.add(k.id),Oe(_,"fast_request",k.name||"",""),O(l.memoInstantSent(k.name)),D()},xe=k=>be.current.get(k.id)??d.thumbs.get((k.name||"").trim().toLowerCase()),A=(k,L)=>b({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:L}}),Y=async(k,L,R)=>{const X=k.ceoStatus||"";k.ceoStatus=L,D();const Pe=await Je(_,{status:L,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(R==null?void 0:R.note)!==void 0?{note:R.note}:{},...R!=null&&R.via?{via:R.via}:{}});return Pe.ok?Pe.skipped?(k.ceoStatus=X,D(),K(l.actNotPersisted),!1):((R==null?void 0:R.undo)!==!1&&A(k,X),R!=null&&R.msg&&O(R.msg),(L==="Validé"||L==="Écarté")&&!k.ceoNote&&(R==null?void 0:R.note)===void 0&&B({o:k,yes:L==="Validé"}),!0):(k.ceoStatus=X,D(),K(l.actErr),!1)},J=async(k,L)=>{const R=await Je(_,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:L,via:"note"});return!R.ok||R.skipped?(K(R.skipped?l.actNotPersisted:l.actErr),!1):(k.ceoNote=L,D(),!0)},W=c.useRef(new Map),ue=k=>W.current.has(k.id)?W.current.get(k.id):d.stages.get((k.name||"").trim().toLowerCase()),we=(k,L)=>{W.current.set(k.id,L),D()},ke=(k,L)=>{I&&Y(k,L?"Validé":"Écarté",{msg:L?l.decidedYes(k.name):l.decidedNo(k.name)})},De=k=>{I&&Y(k,"À trancher",{msg:l.promoted(k.name)})},We=k=>{I&&(async()=>{const L=k.ceoStatus||"";k.ceoStatus="Retenu",D();const R=await Je(_,{status:"Retenu",check_id:k.checkId,company:k.name});if(!R.ok||R.skipped){k.ceoStatus=L,D(),K(R.skipped?l.actNotPersisted:l.actErr);return}A(k,L),O(l.repeched(k.name))})()},Ge=()=>{const k=m.undo[m.undo.length-1];if(!k){O(l.undoNone);return}const L=G.get(k.id);if(!L){b({type:"undoPop"}),O(l.undoNone);return}let R=k.prevCeoStatus;if(!R)if((L.verdict||"").toUpperCase().includes("CALL"))R="À trancher";else{O(l.undoLockedTitle);return}(async()=>await Y(L,R,{undo:!1})&&(b({type:"undoPop"}),L.ceoStatus=k.prevCeoStatus,D(),O(l.undoDone(L.name))))()},je=k=>{I&&(he.current.add(k.id),D(),(async()=>{const L=await nr(_,k.name,"email");if(!L||L.ok===!1){he.current.delete(k.id),D(),K(l.actErr);return}Oe(_,"approach",k.name||"",""),O(l.actApproachSent)})())},ra=(k,L)=>{I&&(async()=>{if(!(await Oe(_,L?"yes":"no",k.name||"","")).ok){K(l.actErr);return}be.current.set(k.id,L?"yes":"no"),D(),O(L?l.thumbUpDone:l.thumbDnDone)})()},na=k=>{!I||!dt(k)||(Oe(_,"detailed_request",k.name||"",""),O(l.memoDeepSent(k.name)))},oa=k=>{const L=new Set(d.favIds),R=L.has(k.id);R?L.delete(k.id):L.add(k.id),d.setFavIds(L),I&&or(_,{id:k.id,co:k.name},R)},ia=()=>{!I||$||window.confirm(l.identSyncConfirm)&&(F(!0),(async()=>{const k=await ir(_);F(!1),k?O(l.identSyncDone):K(l.actErr)})())},xt=/proplace/i.test(d.fund||""),sa=k=>{!I||!xt||(Oe(_,"onboard_request",k.name||"",""),O(l.onboardSent(k.name)))},la={st:m,dispatch:b,t:l,lang:s,mode:ce,caps:U,pipe:V,token:_,fund:d.fund,email:d.email,criteria:d.criteria,data:d,doRepeche:We,thumbOf:xe,canWrite:I,commitStatus:Y,saveNote:J,stageOf:ue,setStage:we,flashErr:K,startTour:()=>T(!0),dossiers:d.dossiers,scopedAll:ae,scoped:ee,counts:ve,byId:G,contName:le,favIds:d.favIds,toggleFav:oa,askEvaluate:pe,doAnalyse:ye,doDecide:ke,doPromote:De,doApproach:je,doThumb:ra,doDeep:na,doUndo:Ge,doSync:ia,doOnboard:sa,outbound:xt,memoQueued:me.current,approachDone:he.current,sessTally:p,evalCards:se.current,evalBusy:S,markRow:x,markedId:v,flash:O};return c.useEffect(()=>{const k=L=>{L.key==="Escape"&&(b({type:"popup",id:null}),b({type:"modal",modal:null}),b({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]),e.jsx(ea.Provider,{value:la,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:fr}),e.jsxs("div",{className:"app"+(V?" pipe":""),children:[U.showTicker&&e.jsx(te,{name:"live",children:e.jsx(Cr,{})}),!!_&&U.pipe&&e.jsx(te,{name:"edition",children:e.jsx(Gn,{token:_})}),U.showIdent&&e.jsx(te,{name:"identite",children:e.jsx(Ur,{})}),U.showOnb&&e.jsx(te,{name:"onboarding",children:e.jsx(Vr,{})}),U.showMorning&&e.jsx(te,{name:"matin",children:e.jsx(_r,{})}),e.jsx(te,{name:"fraicheur",children:e.jsx(Or,{})}),e.jsx(te,{name:"mesure",children:e.jsx(Fr,{})}),U.showFunnel&&e.jsx(te,{name:"entonnoir",children:e.jsx(Xn,{})}),U.showFunnel&&e.jsx(te,{name:"tunnel",children:e.jsx(Yr,{})}),U.showFunnel&&e.jsx(te,{name:"tuto",children:e.jsx(Gr,{})}),e.jsx(te,{name:"carte",fallback:e.jsx("div",{className:"void",children:l.loadError}),children:e.jsxs("div",{className:"fzone",children:[e.jsx(Zn,{}),e.jsxs("div",{className:"stage"+(m.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(Qr,{}),e.jsx(Xr,{})]})]})}),U.showDemand&&e.jsx(te,{name:"evaluation",children:e.jsx(tn,{})}),U.showDemand&&m.memoConsole&&e.jsx(te,{name:"console",children:e.jsx(rn,{})}),e.jsx(te,{name:"liste",fallback:e.jsxs("div",{className:"void",children:[l.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:e.jsx(gn,{})}),d.loading&&e.jsx("div",{className:"void",children:l.loadingV2}),d.error&&!d.loading&&e.jsxs("div",{className:"void",children:[l.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:l.retry})]})]}),U.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:l.lockbarText}),e.jsx("button",{type:"button",onClick:()=>b({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),m.popupId&&e.jsx(te,{name:"fiche",children:e.jsx(vn,{})}),e.jsx(te,{name:"modales",children:e.jsx(En,{})}),e.jsx(Lr,{}),q&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:q.o.name}),e.jsx(Ir,{placeholder:q.yes?l.whyYesPh:l.whyNoPh,onDone:k=>{const L=q.o;B(null),k&&J(L,k).then(R=>{R&&O(l.csNoteSaved)})}})]}),M&&e.jsx($r,{steps:Jn(l),onClose:()=>{T(!1),$t(_)}}),C&&e.jsx("div",{className:"flash on"+(E?" err":""),children:C}),f&&e.jsx(er,{variant:"acquirer",initialCompany:_t().co,initialWebsite:_t().site,onClose:()=>h(null)})]})})}function Xn(){const{t}=z(),[a,r]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Zn(){const{dossiers:t,st:a,dispatch:r,pipe:n,lang:i,t:o}=z(),s=c.useMemo(()=>{const l={};return t.forEach(d=>{d.continent&&pt(d,a.filters,n)&&(l[d.continent]=(l[d.continent]||0)+1)}),l},[t,a.filters,n]);return e.jsxs("div",{className:"conts",children:[sr.map(l=>{const d=lt.find(m=>m.key===l);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===l,onClick:()=>r({type:"continent",key:l}),children:[i==="fr"?d.fr:d.en,e.jsx("span",{className:"n",children:s[l]||0})]},l)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function _t(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function eo(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{ta as FlagCell,qe as SigBadge,Ye as SigWin,ro as default,eo as fmtShort,z as useV2};
