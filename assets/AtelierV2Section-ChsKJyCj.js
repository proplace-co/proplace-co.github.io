...
/* 2 rangées au-dessus de la LISTE seulement : identité / Tout / Évaluer,
   puis recherche · filtres · alerte. */
body.pp-desk .atl2.ops .listhead.mapoff{
  display:flex;flex-direction:column;flex-wrap:nowrap;align-items:stretch;
  gap:0;padding:8px 14px 10px}
body.pp-desk .atl2.ops .listhead.mapoff .lh-top{
  display:flex;flex-wrap:nowrap;align-items:center;gap:8px 10px;width:100%;
  min-height:40px}
...
body.pp-desk .atl2.ops .listhead.mapoff .fstrip{
  flex:none;width:100%;display:flex;flex-direction:row;flex-wrap:nowrap;
  align-items:center;gap:8px;padding:8px 0 0;margin:8px 0 0;
  border-top:1px solid var(--line);order:unset}
...
body.pp-desk .atl2.ops .listhead.mapoff .fstrip-b{flex:1;min-width:0}
body.pp-desk .atl2.ops .listhead.mapoff .frow2{margin-left:auto;flex:none}
body.pp-desk .atl2.ops .listhead.mapoff .fstrip .fsrch{
