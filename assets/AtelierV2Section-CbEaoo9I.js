...
.atl2 .bulk .side .hint{white-space:nowrap}`,Xi=`
...
`,Zi=Ji+Xi;function Ja(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function es(){const e=Ja("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function ts(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=es();return r==="0"?"client":r==="1"||Ja("embed")==="1"&&Ja("chrome")==="1"?"apercu":"client"}const as={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},ns=e=>as[e];function wa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const wt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!qr(a)||wa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Uo(e.cc)})};function Pa(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const rs=60*60*1e3;function os(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>rs?null:a}catch{return null}}function ia(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const is=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function ss(e,a,r="default"){const n=r!=="default",o=u.useMemo(()=>e||n?{mode:"anon"}:Lo(),[e,n]),i=u.useMemo(()=>n?"visiteur":ts(e,o),[e,o,n]),d=u.useMemo(()=>ns(i),[i]),l=i!=="visiteur",c=is(r),[g,s]=u.useState([]),[h,p]=u.useState(""),[v,m]=u.useState(null),[b,y]=u.useState(null),[f,N]=u.useState(null),[C,k]=u.useState(()=>new Map),[j,A]=u.useState(()=>new Map),[E,q]=u.useState(""),[z,F]=u.useState(new Set),[P,B]=u.useState(null),[L,R]=u.useState(!0),[x,T]=u.useState(!1),[I,Y]=u.useState(0),[W,K]=u.useState(0),X=u.useRef(0),Q=u.useMemo(()=>{var te;if(i!=="client")return"";try{return((te=Ro())==null?void 0:te.email)||""}catch{return""}},[i]);u.useEffect(()=>{const te=++X.current;let ge=!0;const _=()=>ge&&te===X.current,se=(l&&o.token?o.token:"pub:"+a)+(c?":"+c:""),ue=os(se);return ue?(s(ue.objs.map(wt)),ue.fund&&p(ue.fund),m(ue.marketEstimate??null),y(ue.criteria??null),N(ue.stats??null),q(ue.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const Le=await Ma(),ee=((Le==null?void 0:Le.recent_ops)||[]).map(de=>{const he=xa(de.company_name||de.title?de:{...de,title:(de.headline_fr||de.headline||"").slice(0,120)},a),ie=String(de.rubrique||"").toLowerCase();return he&&(ie==="nominations"||ie==="recrutements")&&(he.engine=ie),he&&!String(de.company_name||"").trim()&&(he.noCo=!0),he}).filter(de=>!!de).map(de=>(qr((de.name||"").trim())||(de.noCo=!0),de));try{const de=Fo(),he=await Mo(),ie=((he==null?void 0:he.date)||"").slice(0,10),G=de?de.doc:he,ae=Oo(G),oe=((de==null?void 0:de.day)||(G==null?void 0:G.date)||ie||"").slice(0,10);if(oe&&ae.length){const xe=new Set;for(const Ee of ee){if((Ee.date||"").slice(0,10)!==oe)continue;const ne=Tn(ae,xe,Ee.name,"");ne>=0&&(xe.add(ne),Ee.decryptHtml=ae[ne].html)}for(const Ee of ee){if(Ee.decryptHtml||(Ee.date||"").slice(0,10)!==oe)continue;const ne=Tn(ae,xe,"",Ee.headline||Ee.tagline||Ee.name);ne>=0&&(xe.add(ne),Ee.decryptHtml=ae[ne].html)}}if(oe){const xe=((G==null?void 0:G.title_fr)||"").trim(),Ee=((G==null?void 0:G.lead_fr)||"").trim(),ne=Do(G),ce=((G==null?void 0:G.url)||"").trim();xe&&(ne||ce)&&ee.unshift({id:`edito:${oe}`,kind:"op",name:xe,cc:null,date:oe,engine:"edito",dealKind:"other",headline:xe,tagline:Ee||xe,decryptHtml:ne||void 0,url:ce,noCo:!0})}}catch{}if(!_())return;s(ee.map(wt)),ia(se,{objs:ee})}else if(typeof r=="object"){const ee=(await qn()||[]).filter(he=>(he.slug||"")===r.research).map(he=>Ln(he,a)).filter(he=>!!he),de=Pa(await Rn(ee,a));if(!_())return;s(de.map(wt)),ia(se,{objs:de})}else if(l&&o.token){const Le=Po(o.token),ee=Ma(),de=Io(o.token),he=Bo(o.token),ie=$o(o.token),G=await Le;let ae=G?G.targets:[];_()&&G&&(p(G.fund||""),m(G.marketEstimate??null),y(G.criteria??null),N(G.stats??null),q(G.generatedAt||""),s(ae.map(wt)),R(!1),T(!1));const[oe,xe,Ee,ne]=await Promise.all([ee,de,he,ie]),ce=((oe==null?void 0:oe.recent_ops)||[]).map(qe=>xa(qe,a)).filter(qe=>!!qe);if(ae=[...ae,...ce],!_())return;s(ae.map(wt));const Ie=new Set;for(const qe of xe){const Me=(qe.id||qe.co||"").toString().trim().toLowerCase();Me&&Ie.add(Me.startsWith("t:")?Me:"t:"+Me)}F(Ie),k(Ee),A(ne),G&&ia(se,{fund:G.fund,marketEstimate:G.marketEstimate,criteria:G.criteria,stats:G.stats,generatedAt:G.generatedAt,objs:ae})}else{const Le=_o(),ee=qn(),de=Ma(),he=await Le;_()&&he.length&&(s(Pa(he).map(wt)),R(!1),T(!1));const[ie,G]=await Promise.all([ee,de]),ae=(ie||[]).map(ne=>Ln(ne,a)).filter(ne=>!!ne),oe=await Rn(ae,a),xe=((G==null?void 0:G.recent_ops)||[]).map(ne=>xa(ne,a)).filter(ne=>!!ne),Ee=Pa([...he,...oe,...xe]);if(!_())return;s(Ee.map(wt)),ia(se,{objs:Ee})}_()&&T(!1)}catch{_()&&!ue&&T(!0)}finally{_()&&R(!1)}})(),()=>{ge=!1}},[l,o.token,a,I,c]),u.useEffect(()=>{if(!d.showCredits||!Q){B(null);return}let te=!0;return(async()=>{try{const ge=await fetch(`${fn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Q})});if(!ge.ok)return;const _=await ge.json();te&&_&&_.ok!==!1&&B(_)}catch{}})(),()=>{te=!1}},[d.showCredits,Q,W]);const pe=u.useCallback(te=>F(new Set(te)),[]);return{session:o,mode:i,caps:d,fund:h,email:Q,marketEstimate:v,generatedAt:E,criteria:b,stats:f,thumbs:C,stages:j,dossiers:g,favIds:z,setFavIds:pe,credits:P,reloadCredits:()=>K(te=>te+1),loading:L,error:x,refresh:()=>Y(te=>te+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Ir=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),ls=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Ir(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ds=new Set(["signal","amount","score","crible","memo"]);function cs(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Ir(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ds.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Br)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Br=80;function ka(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Fe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(hn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ct(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Nt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function $r(e,a,r){return We(e)?ka(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ka(e,a.filters,r)}function ps(e,a,r,n){return!(!$r(e,a,r)||r&&!Ho(e,a.ptab,n))}function bn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-ct(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Wo(o);case"memo":return Vo(o);case"signal":{const i=Fe(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Ia={},Un=(Ia==null?void 0:Ia.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Hn(){return new Date().toISOString().slice(0,10)}const vn=u.createContext(null);function _r(){return u.useContext(vn)}function us(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),l.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function ms(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function Vn(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Wn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Ur(){const e=u.useContext(vn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function fs({token:e,children:a}){const{dispatch:r,st:n,lang:o}=V(),[i,d]=u.useState(()=>n.filters.day||Hn()),[l,c]=u.useState(null),[g,s]=u.useState(!1),h=u.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){d(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),p=u.useCallback(()=>{d(Hn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);u.useEffect(()=>{const b=y=>{var N;const f=(N=y.detail)==null?void 0:N.day;typeof f=="string"&&h(f)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[h]),u.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),u.useEffect(()=>{if(!e||!i)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Un}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{b||c(f)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,i]);const v=u.useMemo(()=>`${Un}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=u.useMemo(()=>({token:e,day:i,ed:l,loading:g,pickDay:h,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:v,isEn:o==="en"}),[e,i,l,g,h,p,n.filters.day,v,o]);return t.jsx(vn.Provider,{value:m,children:a})}function hs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Ur(),[o,i]=u.useState(()=>n||Lr());return u.useEffect(()=>{n&&i(!0)},[n]),u.useEffect(()=>{const d=l=>{var c;return i(!!((c=l.detail)!=null&&c.open))};return window.addEventListener(ya,d),()=>window.removeEventListener(ya,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Yo,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function xs(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Yn(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Gn(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function gs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Ur(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,c=a&&!a.ok,g=u.useRef(null),[s,h]=u.useState("fonds"),[p,v]=u.useState(null),[m,b]=u.useState("idle"),y=u.useRef(!1);u.useEffect(()=>{v(null),b("idle"),y.current=!1,h("fonds")},[e]),u.useEffect(()=>{if(s!=="jour"||y.current)return;y.current=!0;let j=!0;return b("load"),xs(e).then(A=>{j&&(v(A),b("fait"))}),()=>{j=!1}},[s,e]);const f=u.useMemo(()=>ms((p==null?void 0:p.html)||""),[p==null?void 0:p.html]),N=u.useRef(null);u.useEffect(()=>{const j=N.current;if(!j||!f)return;let A=!1;return Wa(()=>import("./fit-BnaWm7z_.js"),[]).then(async E=>{await E.ensureEditoCss(),!(A||!j.isConnected)&&(E.beautifyEditoRows(j),E.mountCardFits(j))}),()=>{A=!0}},[f]);const C=u.useMemo(()=>Vn((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=u.useMemo(()=>Vn((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return u.useEffect(()=>{const j=g.current;if(!j||!C)return;let A=!1;return Wa(()=>import("./fit-BnaWm7z_.js"),[]).then(async E=>{await E.ensureEditoCss(),!(A||!j.isConnected)&&(E.beautifyEditoRows(j),E.mountCardFits(j))}),()=>{A=!0}},[C]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":s==="fonds",onClick:()=>h("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":s==="jour",onClick:()=>h("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),s==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),s==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),s==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Yn(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Wn(e,!0)}),"."]}):Yn(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Wn(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>h("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),s==="fonds"&&d&&C?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:C}}):null,s==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,s==="jour"&&(f?t.jsxs(t.Fragment,{children:[(p==null?void 0:p.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:p.title}),t.jsx("div",{ref:N,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Gn(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Gn(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const bs=300,sa=7,vs={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Hr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},ys=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ba(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Jo(r)&&r!=="media")return"news:"+r;const n=Fe(e);return n?"sig:"+(n.theme&&Hr.fr[n.theme]?n.theme:"other"):"actualites"}function ws(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=V(),c=_r(),g=d==="en",[s,h]=u.useState("all"),[p,v]=u.useState(!1),m=u.useMemo(()=>{var ge;const x=(a.filters.day||"").slice(0,10),T=_=>!(!i&&a.continent!=="monde"&&_.continent!==a.continent||x&&(_.date||"").slice(0,10)!==x),I=e.filter(_=>T(_)&&Fe(_)&&(!i||_.kind!=="target"||ze(_)!==5)),Y=i&&(((ge=c==null?void 0:c.ed)==null?void 0:ge.ops)||[]).length?c.ed.ops.map(_=>xa(_,d)).filter(_=>!!_).filter(_=>!x||(_.date||"").slice(0,10)===x):[],W=e.filter(_=>T(_)&&_.kind==="op"&&(x?!0:ct(_.date)<=sa)),K=i?Y.length?Y:W.filter(_=>{const se=(l||"").trim().toLowerCase();if(!se)return!1;const ue=_.match||null;return ue?Object.keys(ue).map(Le=>Le.trim().toLowerCase()).includes(se):!1}):W,X=x||new Date().toISOString().slice(0,10),Q=_=>{const se=Ba(_);return se==="ma"?0:se==="levees"?1:2};K.sort((_,se)=>{const ue=Q(_)-Q(se);if(ue)return ue;const Le=(_.date||"").slice(0,10)===X?0:1,ee=(se.date||"").slice(0,10)===X?0:1;return Le!==ee?Le-ee:(se.amountEur||0)-(_.amountEur||0)});const pe=new Set,te=[];for(const _ of[...K,...bn(I,{key:"signal",dir:-1})]){const se=_.id||_.name;!se||pe.has(se)||(pe.add(se),te.push(_))}return i&&te.length===0?e.filter(se=>T(se)&&ct(se.date)<=sa).sort((se,ue)=>(ue.date||"").localeCompare(se.date||"")).slice(0,80):te},[e,a.continent,a.filters.day,i,l,d,c]),b=u.useMemo(()=>{const x={};for(const T of m){const I=Ba(T);x[I]=(x[I]||0)+1}return x},[m]),y=u.useMemo(()=>s==="all"?m:m.filter(x=>Ba(x)===s),[m,s]),f=u.useMemo(()=>y.slice(0,bs),[y]),N=y.length-f.length,C=u.useRef(null);u.useEffect(()=>{var K,X;const x=C.current;if(!x)return;const T=()=>{const Q=x.scrollWidth;Q<200||(x.style.animationDuration=Math.max(18,Math.round(Q/130))+"s")};T();const I=requestAnimationFrame(T),Y=window.setTimeout(T,1200);let W=!0;return(X=(K=document.fonts)==null?void 0:K.ready)==null||X.then(()=>{W&&T()}),()=>{W=!1,cancelAnimationFrame(I),window.clearTimeout(Y)}},[f.length,s]);const k=x=>x==="all"?m.length:b[x]||0,j=x=>{if(x==="all")return g?"All":"Tout";if(x.startsWith("sig:"))return Hr[g?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const T=x.slice(5);return Ko[T]?Qo(T,g?"en":"fr"):x}return vs[g?"en":"fr"][x]},A=[{k:"all"}],E=["ma","levees"].filter(x=>k(x)>0||x===s);if(E.length){A.push({g:g?"Deals":"Opérations"});for(const x of E)A.push({k:x})}const q=["nominations","recrutements"].filter(x=>k(x)>0||x===s),z=Go.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===s),F=k("actualites")>0||s==="actualites"?["actualites"]:[];if(q.length||z.length||F.length){A.push({g:g?"News":"Actualités"});for(const x of q)A.push({k:x});for(const x of z)A.push({k:x});for(const x of F)A.push({k:x})}const P=ys.map(x=>"sig:"+x).filter(x=>k(x)>0||x===s);if(P.length){A.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of P)A.push({k:x})}const B=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},L=(()=>{const x=(a.filters.day||"").slice(0,10),T=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(g?`LIVE covers the events of ${B(x)}.`:`Le LIVE regroupe les événements du ${B(x)}.`)+T:(g?`LIVE covers the still-open signals and the deals of the last ${sa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${sa} derniers jours.`)+T})(),R=x=>f.map(T=>t.jsxs("button",{type:"button",className:"tk"+($e(T)?" spent":""),onClick:I=>{try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:T.id,name:T.name,url:T.url||"",text:T.tagline||T.headline||"",card:T.card}}))}catch{}if(n({type:"focus",id:T.id}),a.dens!=="liste"){const Y=I.currentTarget.getBoundingClientRect();n({type:"popup",id:T.id,anchor:{x:Y.left+Y.width/2,y:Y.bottom}})}},title:T.name+(T.tagline?" — "+T.tagline:""),children:[t.jsx(ft,{o:T}),t.jsxs("span",{className:"who",children:[t.jsx(No,{o:T}),t.jsx("span",{className:"co",children:T.name})]}),typeof T.amountEur=="number"&&T.amountEur>0&&t.jsx("span",{className:"am",children:Gd(T.amountEur)}),T.sector&&t.jsx("span",{className:"mt",children:T.sector}),t.jsx(Ra,{o:T}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(T.id||T.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||v(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>v(x=>!x),children:[j(s),t.jsx("b",{children:k(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:L}),A.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===s,onClick:()=>{h(x.k),v(!1)},children:[j(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:C,children:[R(0),R(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(js,{isEn:g})]})}const ks=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function js({isEn:e}){const[a,r]=u.useState(()=>Lr());u.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(ya,o),()=>window.removeEventListener(ya,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Xo(!a),children:ks})}const yn="+33 6 83 10 72 86",ja="alexandre@proplace.co",Vr=`tel:${yn.replace(/[^\d+]/g,"")}`;function Ns(){return null}class at extends u.Component{constructor(){super(...arguments);zn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Wr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Kn(e,a){if((ht(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return Wr.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}function Es({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=V(),[l,c]=u.useState(!1),[g,s]=u.useState(""),[h,p]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const v=(e.ceoStatus||"").trim(),m=async b=>{if(g)return;if(b==="Analysé"&&!e.memoUrl){p(!0);return}s(b);const y=(Kn(e,a).find(([N])=>N===b)||[b,b])[1],f=await o(e,b,{msg:a.csMoved(e.name,y)});s(""),f&&(c(!1),p(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(b=>!b),p(!1)},children:[v||a.csNone,t.jsx("i",{children:"▾"})]}),l&&t.jsx("span",{className:"rstm",children:h?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),p(!1),c(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await o(e,"Analysé");s(""),b&&(c(!1),p(!1))})()},children:a.csAnaAnyway})]}):Kn(e,a).map(([b,y])=>t.jsx("button",{type:"button",className:"rsti"+(v===b?" on":"")+(g===b?" busy":""),disabled:!!g,onClick:()=>{m(b)},children:y},b))})]})}function Ss({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=V(),[i,d]=u.useState(""),[l,c]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),s=(ht(e)||"").startsWith("CALL")&&ze(e)===3,h=ze(e)>=2,p=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(m);const b=await o(e,m);d(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},v=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Wr.filter(([m])=>!(h&&m==="Retenu")).map(([m,b])=>[m,a[b]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([m,b])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{p(m)},children:b},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Cs,{o:e})]})}function Cs({o:e}){const{t:a,saveNote:r,flash:n}=V(),[o,i]=u.useState(e.ceoNote||""),[d,l]=u.useState(!1),[c,g]=u.useState(!1),s=o.trim()!==(e.ceoNote||"").trim(),h=async()=>{if(d||!s)return;l(!0);const p=await r(e,o.trim());l(!1),p&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&h()}}),t.jsx("button",{type:"button",disabled:d||!s,onClick:()=>{h()},children:c?a.csNoteSaved:a.csNoteOk})]})}function zs({placeholder:e,onDone:a}){const{t:r}=V(),[n,o]=u.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function As({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=V(),[c,g]=u.useState(!1);if(!n.pipe||!o||n.lockActions||ze(e)!==4)return null;const s=i(e),h=(s==null?void 0:s.stage)||"todo",p=async f=>{if(c||f===h)return;g(!0);const N=s;d(e,{stage:f,stamps:(s==null?void 0:s.stamps)||{}});const C=Math.max(Date.now(),Qn+=1);Qn=C;const k=await Zo(r,{company:e.name||"",stage:f,cts:C,deal_id:e.airtableId,check_id:e.checkId});g(!1),!k.stale&&(k.ok||(d(e,N),l(a.actErr)))},v=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,m=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,b=h==="sent"&&v&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,N])=>t.jsx("button",{type:"button",className:"stgb"+(h===f?" on":""),disabled:c,onClick:()=>{p(f)},children:N},f)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let Qn=0;const la=8,da=360;function Jn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Xn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Jn,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Jn,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function Ts({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=V(),[d,l]=u.useState(0),[c,g]=u.useState(null),[s,h]=u.useState([]),p=u.useRef(!1),v=u.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=u.useRef(!1);u.useEffect(()=>{const E=v.current;return()=>{m.current||(n({type:"ptab",tab:E.ptab}),n({type:"dens",dens:E.dens}),n({type:"modal",modal:E.modal}))}},[]),u.useEffect(()=>{p.current||(p.current=!0,h(e.filter(E=>!!document.querySelector(E.need||E.sel))))},[e]);const b=s[d],y=d>=s.length;u.useEffect(()=>{if(b&&(b.ptab!==void 0&&i.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&i.dens!==b.dens&&n({type:"dens",dens:b.dens}),i.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const E=b.click,q=window.setTimeout(()=>{const z=document.querySelector(E);z&&z.getAttribute("aria-selected")!=="true"&&z.click()},60);return()=>window.clearTimeout(q)}},[d,b]);const f=u.useRef(-1),N=u.useCallback(()=>{if(!b){g(null);return}const E=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!E){g(null);return}f.current!==d&&(f.current=d,E.scrollIntoView({block:"nearest",behavior:"smooth"}));const q=E.getBoundingClientRect();g(z=>z&&Math.abs(z.top-q.top)<1&&Math.abs(z.left-q.left)<1&&Math.abs(z.width-q.width)<1&&Math.abs(z.height-q.height)<1?z:q)},[b,d]);u.useLayoutEffect(()=>{N();const E=[90,300,700,1300].map(z=>window.setTimeout(N,z)),q=()=>N();return window.addEventListener("scroll",q,!0),window.addEventListener("resize",q),()=>{E.forEach(z=>window.clearTimeout(z)),window.removeEventListener("scroll",q,!0),window.removeEventListener("resize",q)}},[N]);const C=u.useRef(a);if(C.current=a,u.useEffect(()=>{const E=q=>{q.key==="Escape"?(q.preventDefault(),q.stopPropagation(),C.current()):q.key==="ArrowRight"?l(z=>z+1):q.key==="ArrowLeft"&&l(z=>Math.max(0,z-1))};return document.addEventListener("keydown",E,!0),()=>document.removeEventListener("keydown",E,!0)},[]),!s.length)return null;let k=null;const j=E=>()=>{m.current=!0,n({type:"modal",modal:null}),E()};if(y){const E=o[3]||0;E>0?k={title:E===1?r.ahaATitle1:r.ahaATitleN(E),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let A={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:da};if(!y&&c){const E=c.bottom+14,z=window.innerHeight-E>190?E:Math.max(12,c.top-200);A={left:Math.min(Math.max(12,c.left+c.width/2-da/2),window.innerWidth-da-12),top:z,width:da}}return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-la,top:c.top-la,width:c.width+la*2,height:c.height+la*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:A,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Xn,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Xn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(E=>Math.max(0,E-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(E=>E+1),children:d===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Yr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Gr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function qs(){var q,z;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:c}=V(),g=r?a:e,s=u.useMemo(()=>g.filter(F=>ct(F.date)===0&&F.kind==="target"),[g]),h=u.useMemo(()=>r?a.filter(F=>F.kind==="target"&&ze(F)===0).slice().sort((F,P)=>(P.date||"").localeCompare(F.date||"")):[],[a,r]),p=u.useMemo(()=>s.filter(F=>r?ze(F)===0:!$e(F)),[s,r]),v=r?h:p,m=r?a.length-h.length:s.length-p.length,b=r?a.length:s.length,y=b?Math.min(100,m/b*100):100,f=u.useMemo(()=>Yr(g),[g]),N=!!f&&ct(f)>0,C=u.useMemo(()=>N?g.filter(F=>(F.date||"").slice(0,10)===f):[],[g,f,N]),k=typeof((q=l.stats)==null?void 0:q.kept_today)=="number"?l.stats.kept_today:null,j=typeof((z=l.stats)==null?void 0:z.screened_today)=="number"?l.stats.screened_today:s.length;let A;N?A=o.morningLast(C.length,h.length,Gr(f,d)):r?A=o.morningThesis(j,h.length,k):s.length?m===0?A=o.goalSourced(s.length):m>=s.length?A=o.goalCleared:A=o.goalDone(m,s.length):A=o.goalSourced(0);const E=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&h.length&&c({type:"chainStart",queue:h.map(F=>F.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:A}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),v.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:E,children:r?o.morningEval(v.length):i.pileMode?o.goalContinue(v.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ls(){var I,Y;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:d,dossiers:l,mode:c,doSync:g,startTour:s,flash:h,flashErr:p}=V(),[v,m]=u.useState(null),[b,y]=u.useState(!0),[f,N]=u.useState([]),C=c==="client";u.useEffect(()=>{if(!o||!i)return;let W=!0;return y(!0),(async()=>{const[K,X]=await Promise.all([xn(i),Rr(o)]);W&&(K&&m(K),y(!1),N(X))})(),()=>{W=!1}},[o,i]);const[k,j]=u.useState(!1),A=()=>{!C||k||!i||(j(!0),ei(i).then(W=>{j(!1),W?h(e.identRepubDone):p(e.actErr)}))},E=(v==null?void 0:v.per_day)??null,q=((I=v==null?void 0:v.pool_order)==null?void 0:I.length)??0,z=f.filter(W=>W.status==="running").length,F=u.useMemo(()=>l.filter(W=>W.kind==="target"&&$e(W)).length,[l]),P=d.marketEstimate,B=typeof((Y=d.stats)==null?void 0:Y.screened)=="number"?d.stats.screened:F,L=P&&P>0?Math.min(100,Math.round(B/P*100)):null,R=W=>W.toLocaleString(a==="en"?"en-US":"fr-FR"),x=(i||"P").split(/\s+/).map(W=>W[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const W=Date.parse(d.generatedAt||"");if(Number.isNaN(W))return"";const K=new Date(W),X=Q=>String(Q).padStart(2,"0");return`${X(K.getDate())}/${X(K.getMonth()+1)} à ${X(K.getHours())}:${X(K.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?x:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),T?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(T)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&B>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(B)})})]}),L!==null&&P&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(B,P)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),E!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:E})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),E===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),z>0&&t.jsxs("span",{className:"ev",children:["⏳ ",z]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(q)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:W=>{W.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!C||k,onClick:A,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!C,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:W=>n({type:"filters",patch:{search:W.target.value}})})]})]})]})}class St{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*Rs(e){for(const a of e)yield*a}function Kr(e){return Array.from(Rs(e))}var ye=1e-6,fe=Math.PI,Ge=fe/2,Zn=fe/4,Qe=fe*2,lt=180/fe,Ue=fe/180,Se=Math.abs,Fs=Math.atan,Jt=Math.atan2,Ae=Math.cos,Te=Math.sin,Ms=Math.sign||function(e){return e>0?1:e<0?-1:0},At=Math.sqrt;function Os(e){return e>1?0:e<-1?fe:Math.acos(e)}function Xt(e){return e>1?Ge:e<-1?-Ge:Math.asin(e)}function Ke(){}function Na(e,a){e&&tr.hasOwnProperty(e.type)&&tr[e.type](e,a)}var er={Feature:function(e,a){Na(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Na(r[n].geometry,a)}},tr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Xa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Xa(r[n],a,0)},Polygon:function(e,a){ar(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ar(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Na(r[n],a)}};function Xa(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function ar(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Xa(e[r],a,1);a.polygonEnd()}function qt(e,a){e&&er.hasOwnProperty(e.type)?er[e.type](e,a):Na(e,a)}function Za(e){return[Jt(e[1],e[0]),Xt(e[2])]}function Mt(e){var a=e[0],r=e[1],n=Ae(r);return[n*Ae(a),n*Te(a),Te(r)]}function ca(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ea(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function $a(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function pa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function en(e){var a=At(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function tn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function an(e,a){return Se(e)>fe&&(e-=Math.round(e/Qe)*Qe),[e,a]}an.invert=an;function Ds(e,a,r){return(e%=Qe)?a||r?tn(rr(e),or(a,r)):rr(e):a||r?or(a,r):an}function nr(e){return function(a,r){return a+=e,Se(a)>fe&&(a-=Math.round(a/Qe)*Qe),[a,r]}}function rr(e){var a=nr(e);return a.invert=nr(-e),a}function or(e,a){var r=Ae(e),n=Te(e),o=Ae(a),i=Te(a);function d(l,c){var g=Ae(c),s=Ae(l)*g,h=Te(l)*g,p=Te(c),v=p*r+s*n;return[Jt(h*o-v*i,s*r-p*n),Xt(v*o+h*i)]}return d.invert=function(l,c){var g=Ae(c),s=Ae(l)*g,h=Te(l)*g,p=Te(c),v=p*o-h*i;return[Jt(h*o+p*i,s*r+v*n),Xt(v*r-s*n)]},d}function Ps(e,a,r,n,o,i){if(r){var d=Ae(a),l=Te(a),c=n*r;o==null?(o=a+n*Qe,i=a-c/2):(o=ir(d,o),i=ir(d,i),(n>0?o<i:o>i)&&(o+=n*Qe));for(var g,s=o;n>0?s>i:s<i;s-=c)g=Za([d,-l*Ae(s),-l*Te(s)]),e.point(g[0],g[1])}}function ir(e,a){a=Mt(a),a[0]-=e,en(a);var r=Os(-a[1]);return((-a[2]<0?-r:r)+Qe-ye)%Qe}function Qr(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Ke,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ga(e,a){return Se(e[0]-a[0])<ye&&Se(e[1]-a[1])<ye}function ua(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Jr(e,a,r,n,o){var i=[],d=[],l,c;if(e.forEach(function(m){if(!((b=m.length-1)<=0)){var b,y=m[0],f=m[b],N;if(ga(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),l=0;l<b;++l)o.point((y=m[l])[0],y[1]);o.lineEnd();return}f[0]+=2*ye}i.push(N=new ua(y,m,null,!0)),d.push(N.o=new ua(y,null,N,!1)),i.push(N=new ua(f,m,null,!1)),d.push(N.o=new ua(f,null,N,!0))}}),!!i.length){for(d.sort(a),sr(i),sr(d),l=0,c=d.length;l<c;++l)d[l].e=r=!r;for(var g=i[0],s,h;;){for(var p=g,v=!0;p.v;)if((p=p.n)===g)return;s=p.z,o.lineStart();do{if(p.v=p.o.v=!0,p.e){if(v)for(l=0,c=s.length;l<c;++l)o.point((h=s[l])[0],h[1]);else n(p.x,p.n.x,1,o);p=p.n}else{if(v)for(s=p.p.z,l=s.length-1;l>=0;--l)o.point((h=s[l])[0],h[1]);else n(p.x,p.p.x,-1,o);p=p.p}p=p.o,s=p.z,v=!v}while(!p.v);o.lineEnd()}}}function sr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function _a(e){return Se(e[0])<=fe?e[0]:Ms(e[0])*((Se(e[0])+fe)%Qe-fe)}function Is(e,a){var r=_a(a),n=a[1],o=Te(n),i=[Te(r),-Ae(r),0],d=0,l=0,c=new St;o===1?n=Ge+ye:o===-1&&(n=-Ge-ye);for(var g=0,s=e.length;g<s;++g)if(p=(h=e[g]).length)for(var h,p,v=h[p-1],m=_a(v),b=v[1]/2+Zn,y=Te(b),f=Ae(b),N=0;N<p;++N,m=k,y=A,f=E,v=C){var C=h[N],k=_a(C),j=C[1]/2+Zn,A=Te(j),E=Ae(j),q=k-m,z=q>=0?1:-1,F=z*q,P=F>fe,B=y*A;if(c.add(Jt(B*z*Te(F),f*E+B*Ae(F))),d+=P?q+z*Qe:q,P^m>=r^k>=r){var L=Ea(Mt(v),Mt(C));en(L);var R=Ea(i,L);en(R);var x=(P^q>=0?-1:1)*Xt(R[2]);(n>x||n===x&&(L[0]||L[1]))&&(l+=P^q>=0?1:-1)}}return(d<-ye||d<ye&&c<-1e-12)^l&1}function Xr(e,a,r,n){return function(o){var i=a(o),d=Qr(),l=a(d),c=!1,g,s,h,p={point:v,lineStart:b,lineEnd:y,polygonStart:function(){p.point=f,p.lineStart=N,p.lineEnd=C,s=[],g=[]},polygonEnd:function(){p.point=v,p.lineStart=b,p.lineEnd=y,s=Kr(s);var k=Is(g,n);s.length?(c||(o.polygonStart(),c=!0),Jr(s,$s,k,r,o)):k&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),s=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function v(k,j){e(k,j)&&o.point(k,j)}function m(k,j){i.point(k,j)}function b(){p.point=m,i.lineStart()}function y(){p.point=v,i.lineEnd()}function f(k,j){h.push([k,j]),l.point(k,j)}function N(){l.lineStart(),h=[]}function C(){f(h[0][0],h[0][1]),l.lineEnd();var k=l.clean(),j=d.result(),A,E=j.length,q,z,F;if(h.pop(),g.push(h),h=null,!!E){if(k&1){if(z=j[0],(q=z.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),A=0;A<q;++A)o.point((F=z[A])[0],F[1]);o.lineEnd()}return}E>1&&k&2&&j.push(j.pop().concat(j.shift())),s.push(j.filter(Bs))}}return p}}function Bs(e){return e.length>1}function $s(e,a){return((e=e.x)[0]<0?e[1]-Ge-ye:Ge-e[1])-((a=a.x)[0]<0?a[1]-Ge-ye:Ge-a[1])}const lr=Xr(function(){return!0},_s,Hs,[-fe,-Ge]);function _s(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?fe:-fe,c=Se(i-a);Se(c-fe)<ye?(e.point(a,r=(r+d)/2>0?Ge:-Ge),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&c>=fe&&(Se(a-n)<ye&&(a-=n*ye),Se(i-l)<ye&&(i-=l*ye),r=Us(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Us(e,a,r,n){var o,i,d=Te(e-r);return Se(d)>ye?Fs((Te(a)*(i=Ae(n))*Te(r)-Te(n)*(o=Ae(a))*Te(e))/(o*i*d)):(a+n)/2}function Hs(e,a,r,n){var o;if(e==null)o=r*Ge,n.point(-fe,o),n.point(0,o),n.point(fe,o),n.point(fe,0),n.point(fe,-o),n.point(0,-o),n.point(-fe,-o),n.point(-fe,0),n.point(-fe,o);else if(Se(e[0]-a[0])>ye){var i=e[0]<a[0]?fe:-fe;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Vs(e){var a=Ae(e),r=2*Ue,n=a>0,o=Se(a)>ye;function i(s,h,p,v){Ps(v,e,r,p,s,h)}function d(s,h){return Ae(s)*Ae(h)>a}function l(s){var h,p,v,m,b;return{lineStart:function(){m=v=!1,b=1},point:function(y,f){var N=[y,f],C,k=d(y,f),j=n?k?0:g(y,f):k?g(y+(y<0?fe:-fe),f):0;if(!h&&(m=v=k)&&s.lineStart(),k!==v&&(C=c(h,N),(!C||ga(h,C)||ga(N,C))&&(N[2]=1)),k!==v)b=0,k?(s.lineStart(),C=c(N,h),s.point(C[0],C[1])):(C=c(h,N),s.point(C[0],C[1],2),s.lineEnd()),h=C;else if(o&&h&&n^k){var A;!(j&p)&&(A=c(N,h,!0))&&(b=0,n?(s.lineStart(),s.point(A[0][0],A[0][1]),s.point(A[1][0],A[1][1]),s.lineEnd()):(s.point(A[1][0],A[1][1]),s.lineEnd(),s.lineStart(),s.point(A[0][0],A[0][1],3)))}k&&(!h||!ga(h,N))&&s.point(N[0],N[1]),h=N,v=k,p=j},lineEnd:function(){v&&s.lineEnd(),h=null},clean:function(){return b|(m&&v)<<1}}}function c(s,h,p){var v=Mt(s),m=Mt(h),b=[1,0,0],y=Ea(v,m),f=ca(y,y),N=y[0],C=f-N*N;if(!C)return!p&&s;var k=a*f/C,j=-a*N/C,A=Ea(b,y),E=pa(b,k),q=pa(y,j);$a(E,q);var z=A,F=ca(E,z),P=ca(z,z),B=F*F-P*(ca(E,E)-1);if(!(B<0)){var L=At(B),R=pa(z,(-F-L)/P);if($a(R,E),R=Za(R),!p)return R;var x=s[0],T=h[0],I=s[1],Y=h[1],W;T<x&&(W=x,x=T,T=W);var K=T-x,X=Se(K-fe)<ye,Q=X||K<ye;if(!X&&Y<I&&(W=I,I=Y,Y=W),Q?X?I+Y>0^R[1]<(Se(R[0]-x)<ye?I:Y):I<=R[1]&&R[1]<=Y:K>fe^(x<=R[0]&&R[0]<=T)){var pe=pa(z,(-F+L)/P);return $a(pe,E),[R,Za(pe)]}}}function g(s,h){var p=n?e:fe-e,v=0;return s<-p?v|=1:s>p&&(v|=2),h<-p?v|=4:h>p&&(v|=8),v}return Xr(d,l,i,n?[0,-e]:[-fe,e-fe])}function Ws(e,a,r,n,o,i){var d=e[0],l=e[1],c=a[0],g=a[1],s=0,h=1,p=c-d,v=g-l,m;if(m=r-d,!(!p&&m>0)){if(m/=p,p<0){if(m<s)return;m<h&&(h=m)}else if(p>0){if(m>h)return;m>s&&(s=m)}if(m=o-d,!(!p&&m<0)){if(m/=p,p<0){if(m>h)return;m>s&&(s=m)}else if(p>0){if(m<s)return;m<h&&(h=m)}if(m=n-l,!(!v&&m>0)){if(m/=v,v<0){if(m<s)return;m<h&&(h=m)}else if(v>0){if(m>h)return;m>s&&(s=m)}if(m=i-l,!(!v&&m<0)){if(m/=v,v<0){if(m>h)return;m>s&&(s=m)}else if(v>0){if(m<s)return;m<h&&(h=m)}return s>0&&(e[0]=d+s*p,e[1]=l+s*v),h<1&&(a[0]=d+h*p,a[1]=l+h*v),!0}}}}}var Ht=1e9,ma=-Ht;function Ys(e,a,r,n){function o(g,s){return e<=g&&g<=r&&a<=s&&s<=n}function i(g,s,h,p){var v=0,m=0;if(g==null||(v=d(g,h))!==(m=d(s,h))||c(g,s)<0^h>0)do p.point(v===0||v===3?e:r,v>1?n:a);while((v=(v+h+4)%4)!==m);else p.point(s[0],s[1])}function d(g,s){return Se(g[0]-e)<ye?s>0?0:3:Se(g[0]-r)<ye?s>0?2:1:Se(g[1]-a)<ye?s>0?1:0:s>0?3:2}function l(g,s){return c(g.x,s.x)}function c(g,s){var h=d(g,1),p=d(s,1);return h!==p?h-p:h===0?s[1]-g[1]:h===1?g[0]-s[0]:h===2?g[1]-s[1]:s[0]-g[0]}return function(g){var s=g,h=Qr(),p,v,m,b,y,f,N,C,k,j,A,E={point:q,lineStart:B,lineEnd:L,polygonStart:F,polygonEnd:P};function q(x,T){o(x,T)&&s.point(x,T)}function z(){for(var x=0,T=0,I=v.length;T<I;++T)for(var Y=v[T],W=1,K=Y.length,X=Y[0],Q,pe,te=X[0],ge=X[1];W<K;++W)Q=te,pe=ge,X=Y[W],te=X[0],ge=X[1],pe<=n?ge>n&&(te-Q)*(n-pe)>(ge-pe)*(e-Q)&&++x:ge<=n&&(te-Q)*(n-pe)<(ge-pe)*(e-Q)&&--x;return x}function F(){s=h,p=[],v=[],A=!0}function P(){var x=z(),T=A&&x,I=(p=Kr(p)).length;(T||I)&&(g.polygonStart(),T&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),I&&Jr(p,l,x,i,g),g.polygonEnd()),s=g,p=v=m=null}function B(){E.point=R,v&&v.push(m=[]),j=!0,k=!1,N=C=NaN}function L(){p&&(R(b,y),f&&k&&h.rejoin(),p.push(h.result())),E.point=q,k&&s.lineEnd()}function R(x,T){var I=o(x,T);if(v&&m.push([x,T]),j)b=x,y=T,f=I,j=!1,I&&(s.lineStart(),s.point(x,T));else if(I&&k)s.point(x,T);else{var Y=[N=Math.max(ma,Math.min(Ht,N)),C=Math.max(ma,Math.min(Ht,C))],W=[x=Math.max(ma,Math.min(Ht,x)),T=Math.max(ma,Math.min(Ht,T))];Ws(Y,W,e,a,r,n)?(k||(s.lineStart(),s.point(Y[0],Y[1])),s.point(W[0],W[1]),I||s.lineEnd(),A=!1):I&&(s.lineStart(),s.point(x,T),A=!1)}N=x,C=T,k=I}return E}}const nn=e=>e;var Ua=new St,rn=new St,Zr,eo,on,sn,dt={point:Ke,lineStart:Ke,lineEnd:Ke,polygonStart:function(){dt.lineStart=Gs,dt.lineEnd=Qs},polygonEnd:function(){dt.lineStart=dt.lineEnd=dt.point=Ke,Ua.add(Se(rn)),rn=new St},result:function(){var e=Ua/2;return Ua=new St,e}};function Gs(){dt.point=Ks}function Ks(e,a){dt.point=to,Zr=on=e,eo=sn=a}function to(e,a){rn.add(sn*e-on*a),on=e,sn=a}function Qs(){to(Zr,eo)}var Ot=1/0,Sa=Ot,Zt=-Ot,Ca=Zt,za={point:Js,lineStart:Ke,lineEnd:Ke,polygonStart:Ke,polygonEnd:Ke,result:function(){var e=[[Ot,Sa],[Zt,Ca]];return Zt=Ca=-(Sa=Ot=1/0),e}};function Js(e,a){e<Ot&&(Ot=e),e>Zt&&(Zt=e),a<Sa&&(Sa=a),a>Ca&&(Ca=a)}var ln=0,dn=0,Vt=0,Aa=0,Ta=0,Lt=0,cn=0,pn=0,Wt=0,ao,no,ot,it,Ye={point:Ct,lineStart:dr,lineEnd:cr,polygonStart:function(){Ye.lineStart=el,Ye.lineEnd=tl},polygonEnd:function(){Ye.point=Ct,Ye.lineStart=dr,Ye.lineEnd=cr},result:function(){var e=Wt?[cn/Wt,pn/Wt]:Lt?[Aa/Lt,Ta/Lt]:Vt?[ln/Vt,dn/Vt]:[NaN,NaN];return ln=dn=Vt=Aa=Ta=Lt=cn=pn=Wt=0,e}};function Ct(e,a){ln+=e,dn+=a,++Vt}function dr(){Ye.point=Xs}function Xs(e,a){Ye.point=Zs,Ct(ot=e,it=a)}function Zs(e,a){var r=e-ot,n=a-it,o=At(r*r+n*n);Aa+=o*(ot+e)/2,Ta+=o*(it+a)/2,Lt+=o,Ct(ot=e,it=a)}function cr(){Ye.point=Ct}function el(){Ye.point=al}function tl(){ro(ao,no)}function al(e,a){Ye.point=ro,Ct(ao=ot=e,no=it=a)}function ro(e,a){var r=e-ot,n=a-it,o=At(r*r+n*n);Aa+=o*(ot+e)/2,Ta+=o*(it+a)/2,Lt+=o,o=it*e-ot*a,cn+=o*(ot+e),pn+=o*(it+a),Wt+=o*3,Ct(ot=e,it=a)}function oo(e){this._context=e}oo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Qe);break}}},result:Ke};var un=new St,Ha,io,so,Yt,Gt,ea={point:Ke,lineStart:function(){ea.point=nl},lineEnd:function(){Ha&&lo(io,so),ea.point=Ke},polygonStart:function(){Ha=!0},polygonEnd:function(){Ha=null},result:function(){var e=+un;return un=new St,e}};function nl(e,a){ea.point=lo,io=Yt=e,so=Gt=a}function lo(e,a){Yt-=e,Gt-=a,un.add(At(Yt*Yt+Gt*Gt)),Yt=e,Gt=a}let pr,qa,ur,mr;class fr{constructor(a){this._append=a==null?co:rl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==ur||this._append!==qa){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,ur=n,qa=this._append,mr=this._,this._=o}this._+=mr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function co(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function rl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return co;if(a!==pr){const r=10**a;pr=a,qa=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return qa}function ol(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),qt(l,o(i))),i.result()}return d.area=function(l){return qt(l,o(dt)),dt.result()},d.measure=function(l){return qt(l,o(ea)),ea.result()},d.bounds=function(l){return qt(l,o(za)),za.result()},d.centroid=function(l){return qt(l,o(Ye)),Ye.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,nn):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new fr(r)):new oo(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const c=Math.floor(l);if(!(c>=0))throw new RangeError(`invalid digits: ${l}`);r=c}return a===null&&(i=new fr(r)),d},d.projection(e).digits(r).context(a)}function wn(e){return function(a){var r=new mn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function mn(){}mn.prototype={constructor:mn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function kn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),qt(r,e.stream(za)),a(za.result()),n!=null&&e.clipExtent(n),e}function po(e,a,r){return kn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,c])},r)}function il(e,a,r){return po(e,[[0,0],a],r)}function sl(e,a,r){return kn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function ll(e,a,r){return kn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var hr=16,dl=Ae(30*Ue);function xr(e,a){return+a?pl(e,a):cl(e)}function cl(e){return wn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function pl(e,a){function r(n,o,i,d,l,c,g,s,h,p,v,m,b,y){var f=g-n,N=s-o,C=f*f+N*N;if(C>4*a&&b--){var k=d+p,j=l+v,A=c+m,E=At(k*k+j*j+A*A),q=Xt(A/=E),z=Se(Se(A)-1)<ye||Se(i-h)<ye?(i+h)/2:Jt(j,k),F=e(z,q),P=F[0],B=F[1],L=P-n,R=B-o,x=N*L-f*R;(x*x/C>a||Se((f*L+N*R)/C-.5)>.3||d*p+l*v+c*m<dl)&&(r(n,o,i,d,l,c,P,B,z,k/=E,j/=E,A,b,y),y.point(P,B),r(P,B,z,k,j,A,g,s,h,p,v,m,b,y))}}return function(n){var o,i,d,l,c,g,s,h,p,v,m,b,y={point:f,lineStart:N,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=j},polygonEnd:function(){n.polygonEnd(),y.lineStart=N}};function f(q,z){q=e(q,z),n.point(q[0],q[1])}function N(){h=NaN,y.point=C,n.lineStart()}function C(q,z){var F=Mt([q,z]),P=e(q,z);r(h,p,s,v,m,b,h=P[0],p=P[1],s=q,v=F[0],m=F[1],b=F[2],hr,n),n.point(h,p)}function k(){y.point=f,n.lineEnd()}function j(){N(),y.point=A,y.lineEnd=E}function A(q,z){C(o=q,z),i=h,d=p,l=v,c=m,g=b,y.point=C}function E(){r(h,p,s,v,m,b,i,d,o,l,c,g,hr,n),y.lineEnd=k,k()}return y}}var ul=wn({point:function(e,a){this.stream.point(e*Ue,a*Ue)}});function ml(e){return wn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function fl(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function gr(e,a,r,n,o,i){if(!i)return fl(e,a,r,n,o);var d=Ae(i),l=Te(i),c=d*e,g=l*e,s=d/e,h=l/e,p=(l*r-d*a)/e,v=(l*a+d*r)/e;function m(b,y){return b*=n,y*=o,[c*b-g*y+a,r-g*b-c*y]}return m.invert=function(b,y){return[n*(s*b-h*y+p),o*(v-h*b-s*y)]},m}function hl(e){return xl(function(){return e})()}function xl(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,c=0,g=0,s,h=0,p=1,v=1,m=null,b=lr,y=null,f,N,C,k=nn,j=.5,A,E,q,z,F;function P(x){return q(x[0]*Ue,x[1]*Ue)}function B(x){return x=q.invert(x[0],x[1]),x&&[x[0]*lt,x[1]*lt]}P.stream=function(x){return z&&F===x?z:z=ul(ml(s)(b(A(k(F=x)))))},P.preclip=function(x){return arguments.length?(b=x,m=void 0,R()):b},P.postclip=function(x){return arguments.length?(k=x,y=f=N=C=null,R()):k},P.clipAngle=function(x){return arguments.length?(b=+x?Vs(m=x*Ue):(m=null,lr),R()):m*lt},P.clipExtent=function(x){return arguments.length?(k=x==null?(y=f=N=C=null,nn):Ys(y=+x[0][0],f=+x[0][1],N=+x[1][0],C=+x[1][1]),R()):y==null?null:[[y,f],[N,C]]},P.scale=function(x){return arguments.length?(r=+x,L()):r},P.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],L()):[n,o]},P.center=function(x){return arguments.length?(i=x[0]%360*Ue,d=x[1]%360*Ue,L()):[i*lt,d*lt]},P.rotate=function(x){return arguments.length?(l=x[0]%360*Ue,c=x[1]%360*Ue,g=x.length>2?x[2]%360*Ue:0,L()):[l*lt,c*lt,g*lt]},P.angle=function(x){return arguments.length?(h=x%360*Ue,L()):h*lt},P.reflectX=function(x){return arguments.length?(p=x?-1:1,L()):p<0},P.reflectY=function(x){return arguments.length?(v=x?-1:1,L()):v<0},P.precision=function(x){return arguments.length?(A=xr(E,j=x*x),R()):At(j)},P.fitExtent=function(x,T){return po(P,x,T)},P.fitSize=function(x,T){return il(P,x,T)},P.fitWidth=function(x,T){return sl(P,x,T)},P.fitHeight=function(x,T){return ll(P,x,T)};function L(){var x=gr(r,0,0,p,v,h).apply(null,a(i,d)),T=gr(r,n-x[0],o-x[1],p,v,h);return s=Ds(l,c,g),E=tn(a,T),q=tn(s,E),A=xr(E,j),R()}function R(){return z=F=null,P}return function(){return a=e.apply(this,arguments),P.invert=a.invert&&B,L()}}function uo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}uo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Se(o)>ye&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function gl(){return hl(uo).scale(175.295)}function bl(e){return e}function vl(e){if(e==null)return bl;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,c){c||(a=r=0);var g=2,s=l.length,h=new Array(s);for(h[0]=(a+=l[0])*n+i,h[1]=(r+=l[1])*o+d;g<s;)h[g]=l[g],++g;return h}}function yl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function wl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return br(e,r)})}:br(e,a)}function br(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=kl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function kl(e,a){var r=vl(e.transform),n=e.arcs;function o(s,h){h.length&&h.pop();for(var p=n[s<0?~s:s],v=0,m=p.length;v<m;++v)h.push(r(p[v],v));s<0&&yl(h,m)}function i(s){return r(s)}function d(s){for(var h=[],p=0,v=s.length;p<v;++p)o(s[p],h);return h.length<2&&h.push(h[0]),h}function l(s){for(var h=d(s);h.length<4;)h.push(h[0]);return h}function c(s){return s.map(l)}function g(s){var h=s.type,p;switch(h){case"GeometryCollection":return{type:h,geometries:s.geometries.map(g)};case"Point":p=i(s.coordinates);break;case"MultiPoint":p=s.coordinates.map(i);break;case"LineString":p=d(s.arcs);break;case"MultiLineString":p=s.arcs.map(d);break;case"Polygon":p=c(s.arcs);break;case"MultiPolygon":p=s.arcs.map(c);break;default:return null}return{type:h,coordinates:p}}return g(a)}const mo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},jl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Nl(e,a,r){const n=mo[e];if(!n||!n.length)return-1;const o=jl(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let fa=null;function El(){return fa||(fa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=wl(r,n),i=gl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=ol(i),l=(o.features||[]).filter(s=>{var h;return(((h=s.properties)==null?void 0:h.name)||"")!=="Antarctica"}).map(s=>{var v;const h=((v=s.properties)==null?void 0:v.name)||"",p=d(s)||"";return p?{i2:ti(h)||null,n:h,d:p}:null}).filter(s=>!!s);if(!l.length)return null;const c={};for(const[s,h]of Object.entries(ai)){const p=i(h);p&&(c[s]={x:p[0],y:p[1]})}const g={};for(const[s,h]of Object.entries(mo)){const p=h.map(v=>i(v.ll)).filter(v=>!!v).map(([v,m])=>({x:v,y:m}));p.length&&(g[s]=p)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:c,metros:g}}catch{return null}})(),fa)}function Sl(e){const[a,r]=u.useState(null);return u.useEffect(()=>{if(!e||a)return;let n=!1;return El().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Cl="8 40 984 210",zl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},vr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function yr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Al(e,a){const[r,n]=u.useState(1);return u.useEffect(()=>{let o=!0,i=0;const d=()=>{var g;if(!o)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function wr({msgs:e}){const[a,r]=u.useState(0);u.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Tl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:c,data:g,dossiers:s,source:h}=V(),p=g.loading&&!s.length,v=u.useRef(null),m=u.useRef(null),b=Sl(e.continent==="monde"),y=e.continent==="monde"?b:gn.find(x=>x.key===e.continent)||null,f=Al(v,e.continent+":"+e.mapFolded+":"+!!y),[N,C]=u.useState(new Map),[k,j]=u.useState(null);u.useEffect(()=>{const x=v.current;if(!x)return;const T=new Map;x.querySelectorAll("path[data-i2]").forEach(I=>{const Y=I.dataset.i2;if(Y)try{const W=I.getBBox();W.width>0&&T.set(Y,{x:W.x,y:W.y,w:W.width,h:W.height})}catch{}}),C(T)},[e.continent,f,y]);const A=u.useMemo(()=>r.filter(x=>x.cc),[r]),E=u.useMemo(()=>{const x=new Map;return A.forEach(T=>x.set(T.cc,(x.get(T.cc)||0)+1)),x},[A]),q=e.continent==="monde"&&b?b.anchors:null,z=e.continent==="monde"&&b?b.metros:null,F=u.useMemo(()=>A.map(x=>{const T=yr(x.name||x.id||""),I=yr((x.id||x.name||"")+"·y");if(q&&x.cc){const Q=z?z[x.cc]:void 0;if(Q&&Q.length){const te=Nl(x.cc,x.city,T);if(te>=0&&Q[te])return{d:x,x:Q[te].x+(T-.5)*5,y:Q[te].y+(I-.5)*5}}const pe=q[x.cc];if(pe)return{d:x,x:pe.x+(T-.5)*10,y:pe.y+(I-.5)*10}}const Y=x.cc?N.get(x.cc):void 0;if(!Y)return null;const W=zl[`${e.continent}:${x.cc||""}`];if(W)return{d:x,x:Y.x+Y.w*(W.fx+(T-.5)*W.sx),y:Y.y+Y.h*(W.fy+(I-.5)*W.sy)};const K=(T-.5)*Math.min(Y.w*.55,60),X=(I-.5)*Math.min(Y.h*.55,60);return{d:x,x:Y.x+Y.w/2+K,y:Y.y+Y.h/2+X}}).filter(x=>!!x),[A,N,q,z,e.continent]),P=x=>f>0?x/f:x,B=u.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:vr[x],fr:c.plabels[x].toUpperCase(),en:c.plabels[x].toUpperCase(),n:r.filter(T=>T.kind==="target"&&ze(T)===x).length})).filter(x=>x.n>0):Fn.map((x,T)=>({...x,n:r.filter(I=>Mn(I)===T).length})),[r,n,c.plabels]),L=i?d.get(i):null,R=L?F.find(x=>x.d.id===L.id):null;return y?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:[p&&t.jsx(wr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:v,viewBox:e.continent==="monde"?Cl:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?y.fr:y.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:y.countries.map((x,T)=>t.jsx("g",{className:"ct"+(x.i2&&E.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},T))}),t.jsx("g",{children:F.map(x=>{const T=Fn[Mn(x.d)],I=!!Fe(x.d),Y=x.d.kind==="target",W=n&&Y?vr[ze(x.d)]:T.c,K=!n&&$e(x.d);return t.jsxs("g",{className:"co"+(K?" done":""),onMouseEnter:()=>{var pe,te;const X=(pe=m.current)==null?void 0:pe.getBoundingClientRect(),Q=(te=v.current)==null?void 0:te.createSVGPoint();if(Q&&v.current&&X){Q.x=x.x,Q.y=x.y;const ge=Q.matrixTransform(v.current.getScreenCTM());j({x:ge.x-X.left,y:ge.y-X.top,label:x.d.name+" · "+(Pt(x.d.cc,l)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var pe;if(h==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const X=(pe=v.current)==null?void 0:pe.createSVGPoint();let Q=null;if(X&&v.current){X.x=x.x,X.y=x.y;const te=X.matrixTransform(v.current.getScreenCTM());Q={x:te.x,y:te.y}}a({type:"popup",id:x.d.id,anchor:Q})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:P(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:P(T.px),fill:W,stroke:I?"#DC2626":"#ffffff",strokeWidth:P(I?2.2:1.3)})]},x.d.id||x.d.name)})}),R&&t.jsx("circle",{className:"ring on",cx:R.x,cy:R.y,r:P(13),fill:"none",stroke:"#0F172A",strokeWidth:P(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:B.map((x,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),l==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},T))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:t.jsx(wr,{msgs:c.loadMsgs})})}function ql(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function fo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=V(),c=a.filters,[g,s]=u.useState(!1),[h,p]=u.useState(!1),v=u.useRef(null),m=u.useRef(null),b=u.useMemo(()=>a.continent==="monde"?n:n.filter(R=>R.continent===a.continent),[n,a.continent]),y=R=>b.filter(x=>R!=="country"&&c.country.length&&!c.country.includes(x.cc||"")?!1:ka(x,c,i,R==="country"?void 0:R)),f=R=>!i||R.kind!=="op",N=u.useMemo(()=>{const R=y("win").filter(f),x=T=>R.filter(I=>(I.date?Math.max(0,Math.floor((Date.now()-Date.parse(I.date))/864e5)):9999)<=T).length;return[x(0),x(7),x(30),R.length]},[b,c,i]),C=u.useMemo(()=>c.day?y("win").filter(f).filter(R=>(R.date||"").slice(0,10)===c.day).length:0,[b,c,i]),k=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,j=k+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);u.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),u.useEffect(()=>{if(!g&&!h)return;const R=T=>{var Y,W;const I=T.target;g&&!((Y=v.current)!=null&&Y.contains(I))&&s(!1),h&&!((W=m.current)!=null&&W.contains(I))&&p(!1)},x=T=>{T.key==="Escape"&&(s(!1),p(!1))};return document.addEventListener("mousedown",R),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",R),document.removeEventListener("keydown",x)}},[g,h]);const A=(R,x,T,I="fbtn")=>t.jsxs("button",{type:"button",className:I,"aria-expanded":a.openFacet===R,onClick:()=>r({type:"openFacet",facet:R}),children:[t.jsx("span",{className:"fl",children:x}),T>0&&t.jsx("span",{className:"n",children:T}),t.jsx("span",{className:"cv",children:"▾"})]},R),E=["1","7","30","all"],q=Math.max(0,E.indexOf(c.win||"all")),z=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(ql(c.day,l))}),t.jsx("b",{children:C})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>p(R=>!R),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[q]}),t.jsx("b",{children:N[q]}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:E.map((R,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===R,onClick:()=>{r({type:"filters",patch:{win:R}}),p(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:N[x]})]},R))})]}):t.jsx("div",{className:"seg",children:E.map((R,x)=>t.jsxs("button",{type:"button","aria-pressed":c.win===R,onClick:()=>r({type:"filters",patch:{win:R}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:N[x]})]},R))}),F=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:R=>r({type:"filters",patch:{search:R.target.value}})})]}),P=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):A("sec",o.fSector,c.sector.length),A("pay",o.fCountry,c.country.length),A("det",o.fEngine,c.engine.length),A("sta",o.fStage,c.stage.length),i&&A("ang","Angle",c.angle.length),i&&A("mem","Mémo",c.memoLevel.length)]}),B=(R=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(b.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),R&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:v,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{s(R=>!R),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:P})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:z}),t.jsxs("div",{className:"fstrip-b",children:[F,L,B(!1)]})]}),a.openFacet&&t.jsx(kr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[z,F,P,t.jsx("span",{className:"fgrow"}),B()]}),a.openFacet&&t.jsx(kr,{poolFor:y})]})}function kr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=V(),i=a.filters,d=a.openFacet,{title:l,cols:c,options:g}=u.useMemo(()=>{if(d==="sig"){const m=e("signal").filter(f=>Fe(f)),b=new Map;m.forEach(f=>{const N=f.engine||"";b.set(N,(b.get(N)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Ya([...b.keys()],o).map(f=>({v:f,label:Et(f)+" "+He(f,o),n:b.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(d==="sec"){const m=e("sector"),b=new Map;return m.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:i.sector.includes(y)}))}}if(d==="pay"){const m=e("country"),b=new Map;return m.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:Pt(y,o)||y,n:f,html:!1,on:i.country.includes(y)}))}}if(d==="det"){const m=e("engine"),b=new Map;return m.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Ya([...b.keys()],o).map(y=>({v:y,label:Et(y)+" "+He(y,o)+' <span style="color:var(--dim);font-size:10px">· '+ni(ri(y),o)+"</span>",n:b.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(d==="ang"){const m=e("angle"),b=new Map;return m.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(y)}))}}if(d==="mem"){const m=e("memoLevel"),b=new Map;m.forEach(f=>{if(f.kind==="target"){const N=hn(f);b.set(N,(b.get(N)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:y[f],n:b.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const p=e("stage"),v=new Map;return p.forEach(m=>{m.stage&&v.set(m.stage,(v.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((m,b)=>b[1]-m[1]).map(([m,b])=>({v:m,label:m,n:b,html:!1,on:i.stage.includes(m)}))}},[d,a,o]),s=p=>{if(d==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(p)?i.signalEngines.filter(b=>b!==p):[...i.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(d==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage",value:p})},h=()=>{r(d==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:d==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:h,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>s(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function ho({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=V(),c=u.useMemo(()=>{const v={};return r.forEach(m=>{ka(m,n.filters,i)&&(v.monde=(v.monde||0)+1,m.continent&&(v[m.continent]=(v[m.continent]||0)+1))}),v},[r,n.filters,i]),[g,s]=u.useState(!1),h=u.useRef(null);u.useEffect(()=>{if(!g)return;const v=b=>{var y;(y=h.current)!=null&&y.contains(b.target)||s(!1)},m=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",v),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",v),document.removeEventListener("keydown",m)}},[g]);const p=v=>{const m=gn.find(b=>b.key===v);return v==="monde"?l.contWorld:d==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:h,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>s(v=>!v),children:[p(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:On.map(v=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===v,onClick:()=>{o({type:"continent",key:v}),s(!1)},children:[p(v),t.jsx("span",{className:"n",children:c[v]||0})]},v))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[On.map(v=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===v,onClick:()=>o({type:"continent",key:v}),children:[p(v),t.jsx("span",{className:"n",children:c[v]||0})]},v)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function xo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ll(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function jr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=V();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:l.rsEvalOne})]},c.name))})]}):null}function go({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=V(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(jr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(jr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Rl({card:e,onEvaluate:a,onAddAll:r}){var l,c,g;const{t:n}=V(),o=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:xo(e.summary_md||"").map((s,h)=>t.jsx("p",{children:s},h))})]}),t.jsx(go,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(s=>t.jsx("li",{children:s},s))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Fl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Ml({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=V(),l=o,[c,g]=u.useState(null),[s,h]=u.useState(null),[p,v]=u.useState(null),[m,b]=u.useState(!1);u.useEffect(()=>{let f=!0;return(async()=>{const N=await Fr({email:d,cbToken:l});f&&g(N)})(),()=>{f=!1}},[d,l,n]);const y=f=>{h(f),v(null),b(!0),(async()=>{const N=await oi(f.id);v(N),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{h(null),v(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Fl(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!p&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&p&&t.jsx(Rl,{card:p,onEvaluate:a,onAddAll:r})]})]})}const ba=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Kt(e){return/^https?:\/\//i.test((e||"").trim())}function nt(e){const a=(e||"").trim();return a?Kt(a)?a:ba.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Ol(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Dl(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:d,evalBusy:l,evalCards:c,caps:g,data:s,canWrite:h,source:p,dossiers:v,doAnalyse:m,liveMemos:b,pipe:y}=V(),f=a==="client",N=u.useMemo(()=>r||(p!=="default"?ii():""),[r,p]),[C,k]=u.useState(""),[j,A]=u.useState(!1),[E,q]=u.useState(""),[z,F]=u.useState(""),[P,B]=u.useState(""),[L,R]=u.useState(!1),[x,T]=u.useState(!1),[I,Y]=u.useState(""),[W,K]=u.useState(!1),[X,Q]=u.useState(""),[pe,te]=u.useState([]),ge=u.useRef(!1),[_,se]=u.useState(!1),[ue,Le]=u.useState(!1),[ee,de]=u.useState(!1),he=u.useRef(!1),[ie,G]=u.useState(""),[ae,oe]=u.useState(""),[xe,Ee]=u.useState(!1),[ne,ce]=u.useState(!1),[Ie,qe]=u.useState(0),[Me,Ce]=u.useState(""),[be,Ve]=u.useState(null),[Re,st]=u.useState(null),[pt,xt]=u.useState(!1),[tt,gt]=u.useState(null),[bt,Je]=u.useState(0),ut=u.useRef(!1),vt=C.trim()?ba.test(C.trim())?e.evalUrl:e.evalName:e.evalWaiting,S=u.useMemo(()=>I.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[I]);u.useEffect(()=>{if(typeof window>"u")return;const O=new URLSearchParams(window.location.search),J=(O.get("rs")||"").trim(),re=(O.get("rstext")||"").trim();J&&/^https?:\/\//i.test(J)&&G(J),re&&oe(re),(J&&/^https?:\/\//i.test(J)||re)&&se(!0)},[]),u.useEffect(()=>{const O=J=>{const re=J.detail||{},w=String(re.url||"").trim(),D=String(re.text||"").trim();w&&/^https?:\/\//i.test(w)&&G(w),D&&oe(D),(w&&/^https?:\/\//i.test(w)||D)&&(se(!0),k(""),q(""),Ee(!0),window.setTimeout(()=>Ee(!1),900))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]),u.useEffect(()=>{const O=J=>{const re=J.detail||{},w=String(re.name||"").trim();if(!w)return;se(!1),k(w),q(w);const D=nt(String(re.website||re.domain||""));F(D),B(nt(String(re.url||""))),R(!D),A(!0),window.setTimeout(()=>A(!1),900)};return window.addEventListener("ppmap:prefill",O),()=>window.removeEventListener("ppmap:prefill",O)},[]),u.useEffect(()=>{const O=(E||"").trim();if(!O||_||z){(z||!O||_)&&R(!1);return}const J=v.find(D=>Pe(D.name)===Pe(O)),re=nt((J==null?void 0:J.website)||"")||nt((J==null?void 0:J.domain)||"");if(re){F(re),R(!1);return}let w=!0;return R(!0),Mr(O).then(D=>{var $,Z;if(!w)return;const M=nt(D.website||"")||nt(((Z=($=D.candidates)==null?void 0:$[0])==null?void 0:Z.url)||"");M&&F(M)}).catch(()=>{}).finally(()=>{w&&R(!1)}),()=>{w=!1}},[E,_,z,v]),u.useEffect(()=>{const O=J=>{var w;const re=String(((w=J.detail)==null?void 0:w.url)||"").trim();Kt(re)&&window.open(re,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",O),()=>window.removeEventListener("ppmap:view",O)},[]),u.useEffect(()=>{if(he.current===_)return;he.current=_,de(!0);const O=window.setTimeout(()=>de(!1),560);return()=>window.clearTimeout(O)},[_]),u.useEffect(()=>{if(typeof window>"u")return;const O=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),J=document.querySelector(".atl2.ops, .atl2.cibles");if(!O||!J)return;const re=()=>J.style.setProperty("--demand-h",`${O.offsetHeight}px`);re();const w=new ResizeObserver(re);return w.observe(O),()=>w.disconnect()},[p,j,xe,x,_,ee,L]),u.useEffect(()=>{if(!h&&!N){gt(null);return}let O=!0;return(async()=>{const J=await Fr({email:n,cbToken:N});O&&gt(J.length)})(),()=>{O=!1}},[h,N,n,bt]);const U=pe.length?pe:c,H=s.credits,le=u.useCallback(O=>{const J=O.map(re=>(re||"").trim()).filter(Boolean);J.length&&(Y(re=>{const w=re.split(`
`).map($=>$.trim()).filter(Boolean),D=new Set(w.map($=>$.toLowerCase())),M=J.filter($=>!D.has($.toLowerCase()));return[...w,...M].slice(0,15).join(`
`)}),T(!0))},[]);u.useEffect(()=>{if(!ne)return;qe(0);const O=window.setInterval(()=>qe(J=>J+1),1e3);return()=>window.clearInterval(O)},[ne]);const we=u.useMemo(()=>{const O=C.trim().toLowerCase();return!O||!y?null:v.find(J=>Pe(J.name)===O&&ze(J)===1)||null},[C,v,y]),me=()=>{const O=C.trim();if(O){if(we){m(we);return}o(null,O),f&&k("")}},ke=async()=>{if(!f){o(null,S[0]||"");return}if(!S.length||W)return;K(!0),ge.current=!1;const O=[];for(let J=0;J<S.length&&!ge.current;J++){Q(e.evaluating(J+1,S.length,S[J]));const re=await Or(r,S[J],"atelier2");if(O.unshift({name:re.company||S[J],verdict:re.verdict,reason:re.reason||"",remaining:re.remaining??null}),te([...O]),re.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(S.length-J-1),remaining:0}),te([...O]),Y(S.slice(J+1).join(`
`)),Q(""),K(!1);return}}Q(""),Y(ge.current?S.slice(O.length).join(`
`):""),K(!1)},Xe=async()=>{var re,w,D;if(ut.current)return;const O=ie.trim().replace(/\s+/g,""),J=ae.trim();if(!O&&!J){Ce(e.rsNeed);return}if(!f&&!N){o(null,O||J.slice(0,80));return}ut.current=!0,Ce(""),Ve(null),st(null),ce(!0);try{const M=await li({url:O,text:J,email:n,cbToken:N});if(ce(!1),!M||M.status!=="success"){Ce((M==null?void 0:M.message)||"Erreur");return}Ve(M),se(!1),le((((re=M.prospective)==null?void 0:re.companies_to_evaluate)||[]).map(Z=>(Z==null?void 0:Z.name)||"")),st({state:"pending"});const $=await di(M,{email:n,cbToken:N});st($.ok?{state:"ok",scopeLabel:((w=$.summary)==null?void 0:w.scope_label)||"",scope:((D=$.summary)==null?void 0:D.scope)||""}:{state:"fail",msg:$.error||""}),$.ok&&Je(Z=>Z+1)}finally{ut.current=!1,ce(!1)}},yt=[be==null?void 0:be.industry,...(be==null?void 0:be.market_tags)||[],be==null?void 0:be.author].map(O=>(O||"").trim()).filter(Boolean),mt=(Re==null?void 0:Re.state)==="pending",Bt=Re&&(mt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Re.state==="ok"?t.jsx("span",{className:"rslink ok",children:Re.scope&&Re.scope!=="public"?e.rsSavedIn(Re.scopeLabel||Re.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Re.msg,children:e.rsSaveFail})),Tt=Ll(be).length,Oe=_,De=(E||C).trim(),Ze=v.find(O=>Pe(O.name)===Pe(De)),$t=nt(C)||z||nt((Ze==null?void 0:Ze.website)||"")||nt((Ze==null?void 0:Ze.domain)||""),_t=P||nt((Ze==null?void 0:Ze.url)||""),ra=we?e.actAnalyse:De?e.evalGoOn(De.length>22?De.slice(0,21)+"…":De):e.evalGo,Fa=ne?`${si(ie.trim())==="youtube"&&ie.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Ie)}`:mt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Oe?" rs-mode":"")+(E&&C.trim()===E||j||xe?" pair":"")+(j||xe||ee?" echo":"")+(ee?" swap":""),children:[t.jsxs("div",{className:"drow"+((Oe?xe:j)||ee?" flash":"")+((Oe?ie.trim():ba.test(C.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Oe?ie:C,placeholder:Oe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Oe?600:200,spellCheck:Oe?!1:void 0,inputMode:Oe?"url":void 0,onChange:O=>{if(Oe){G(O.target.value);return}k(O.target.value),E&&O.target.value.trim()!==E&&(q(""),F(""),B(""),R(!1))},onKeyDown:O=>{O.key==="Enter"&&(Oe?Xe():me())}}),t.jsx("span",{className:"detect"+(Oe?" off":"")+(ba.test(C.trim())?" url":""),children:vt})]}),t.jsx("span",{className:"dacts",children:Oe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ne?" loading":""),disabled:ne||mt||!ie.trim()&&!ae.trim(),onClick:()=>{Xe()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Fa})]}),t.jsxs("a",{className:"viewbtn"+(Kt(ie)?"":" off"),href:Kt(ie)?ie.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:O=>{Kt(ie)||O.preventDefault()},children:[t.jsx(Ol,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(we?" analyse":"")+(l?" loading":""),disabled:l,onClick:me,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ra})]}),t.jsxs("a",{className:"viewbtn sm"+(L?" searching":$t?"":" off"),href:$t||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":L||void 0,title:L?e.viewSiteBusyHint:e.viewSiteHint,onClick:O=>{$t||O.preventDefault()},children:[L&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),L?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(_t?"":" off"),href:_t||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:O=>{_t||O.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&H&&t.jsxs("button",{type:"button",className:"credits"+(H.total_available<=0&&!H.unlimited?" empty":""),onClick:()=>d({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:H.unlimited?"∞":H.total_available}),!H.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",H.daily_grant+H.purchased]}),H.total_available<=0&&!H.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(O=>O.status==="boot"||O.status==="running").map(O=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:O.name}),t.jsx(Qt,{item:O,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>d({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+O.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>T(!x),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(_?" on":""),onClick:()=>se(!_),children:e.rsOpen}),tt!==null&&tt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(pt?" on":""),onClick:()=>xt(!pt),children:e.rsArchOpen(tt)})]}),pt&&t.jsx(Ml,{bump:bt,cbToken:N,onClose:()=>xt(!1),onEvaluate:O=>o(null,O),onAddAll:le}),t.jsx("div",{className:"rsp slim"+(_?" on":" off"),"aria-hidden":!_,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:_?void 0:-1,onClick:()=>Le(O=>!O),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:ue?"▴":"▾"})]}),ue&&t.jsx("textarea",{className:"rstext",value:ae,placeholder:e.rsTextPh,tabIndex:_?void 0:-1,onChange:O=>oe(O.target.value)})]})}),Me&&t.jsx("div",{className:"rserr",children:Me}),be&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:be.title}),be.source_url&&t.jsx("a",{href:be.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{Ve(null),st(null)},children:"×"})]}),be.market&&t.jsx("p",{className:"rsmk",children:be.market}),yt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),yt.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[be.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${be.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:xo(be.summary_md||"").map((O,J)=>t.jsx("p",{children:O},J))})]}),t.jsx(go,{card:be,onEvaluate:O=>o(null,O),onAddAll:le}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Tt)}),Bt]})]}),x&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:I,placeholder:e.bulkPh,onChange:O=>Y(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(W?" loading":""),style:{justifyContent:"center"},disabled:W||!S.length,onClick:()=>{ke()},children:[t.jsx("span",{className:"fill"}),W&&X?X:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(S.length)})]})]}),U.slice(0,1).map((O,J)=>{const re=O.verdict==="kept",w=O.verdict==="quota",D=re?"var(--brand)":w?"var(--bolt)":"var(--red)",M=re?"var(--brand-l)":w?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":D,"--bgc":M},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:re?"✓ "+e.kept:w?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!!(O.candidates&&O.candidates.length)&&t.jsx("span",{className:"sitepick",children:O.candidates.map($=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:$.url.startsWith("http")?$.url:`https://${$.url}`,target:"_blank",rel:"nofollow noopener",children:[($.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,$.url),children:e.evalPickGo})]},$.url))}),!w&&t.jsx("button",{type:"button",className:"go",onClick:()=>{d({type:"ptab",tab:re?1:5});const $=(O.name||"").trim().toLowerCase();window.setTimeout(()=>{const Z=[...document.querySelectorAll(".atl2 .list .row")].find(je=>{var Ne;return(((Ne=je.querySelector(".rnm"))==null?void 0:Ne.textContent)||"").trim().toLowerCase().includes($)});Z&&(Z.scrollIntoView({behavior:"smooth",block:"center"}),Z.classList.add("flashrow"),window.setTimeout(()=>Z.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(re?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),f&&(i.kept+i.dropped>0||U.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>d({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Pl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Il(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=V(),i=e.memoConsole?r.get(e.memoConsole):null,d=u.useMemo(()=>i?[i.reasoning||"",Pl(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=ht(i),c=hn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:d?d.split(`

`).map((g,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Ft(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function jn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=V(),[d,l]=u.useState(!1),[c,g]=u.useState(null),s=n.pipe&&o==="client"&&!n.lockActions,h=async()=>{if(!s||d)return;l(!0);const p=await ci(r,e);if(l(!1),!p){i(a.actErr);return}g(p.results||[])};return u.useEffect(()=>{if(!s)return;const p=v=>{var b;const m=String(((b=v.detail)==null?void 0:b.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&h()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,s]),u.useEffect(()=>{if(s)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),h())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{h()},children:d?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Bl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ha=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function $l(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ha(a.slice(n));break}r+=ha(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ha(a.slice(o));break}const d=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(d),c=l?l[2].toLowerCase():"";l&&Bl.has(c)?r+=`<${l[1]}${c}>`:r+=ha(a.slice(o,i+1)),n=i+1}return r}const Nr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Be({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function _l(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ul({o:e}){const{t:a,doDeep:r}=V(),[n,o]=u.useState(!1),i=ht(e),d=[e.reasoning||"",_l(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[i&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:i}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),d.length?d.join(`

`).split(`

`).map((l,c)=>t.jsx("p",{className:"cdtxt",children:l},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Ft(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:l=>{l.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:l=>{l.stopPropagation(),o(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:l=>l.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:l=>l.stopPropagation()})]})}function Nn({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=V(),i=aa(e),d=ht(e),l=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),h=u.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.reasoning?1:0)+(d?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Ft(e)?1:0}].filter(b=>b.n>0),[e,a,l,d,c,g,s]),[p,v]=u.useState("");if(!h.length)return null;const m=h.some(b=>b.k===p)?p:h[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:h.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===b.k,"data-tour":"tab-"+b.k,className:m===b.k?"on":"",onClick:y=>{y.stopPropagation(),v(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[m==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[t.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),d&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Be,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Be,{k:a.cdVerdictDate,v:Nr(e.verdictDate,r)})]})]}),m==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:$l(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(Hl,{o:e})]}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdSector,v:e.sector}),t.jsx(Be,{k:a.cdStage,v:e.stage}),t.jsx(Be,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Be,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Be,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Be,{k:a.cdAngle,v:e.angle}),t.jsx(Be,{k:a.cdDetected,v:Nr(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdName,v:e.contactName}),t.jsx(Be,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Be,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="memo"&&t.jsx(Ul,{o:e}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Be,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Hl({o:e}){const{t:a,token:r}=V(),[n,o]=u.useState(!1),[i,d]=u.useState(null),l=async()=>{n||(o(!0),d(await pi(r,e.name,e.website||e.domain||"")),o(!1))},c=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=g.some(([,h])=>h);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&s&&t.jsxs(t.Fragment,{children:[g.filter(([,h])=>h).map(([h,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:h}),t.jsx("p",{children:p})]},h)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!s&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function na({spec:e}){const a=u.useRef(null),r=u.useRef(null),[n,o]=u.useState(!1);return u.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const l=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Dn({kind:"op",card:e},g).then(s=>{!d&&s&&i.isConnected&&i.replaceChildren(s)})},c=window.requestAnimationFrame(l);return()=>{d=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),u.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;Dn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!d&&c&&i.isConnected&&i.replaceChildren(c)});const l=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{d=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Vl=`
...
`;function Wl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:d,top:l}}function Yl(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:l,doAnalyse:c,doDecide:g,doPromote:s,doRepeche:h,doApproach:p,doDeep:v,doOnboard:m,outbound:b,evalBusy:y}=V(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const N=Fe(f),C=ze(f),k=ht(f),j=aa(f),A=f.kind==="target",E=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return Dt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Vl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Wl(e.popupAnchor,!!f.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ct(f.date)),He(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>E({country:[f.cc]}),children:(Pt(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>E({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>E({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:It(f.amountEur,o)})]}),i.pipe&&A&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[C]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Et(f.engine)," ",t.jsx("b",{children:He(f.engine,o)})," — ",ui(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),N?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(ft,{o:f,lg:!0})," ",t.jsx(Ra,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Dr(N,o))," · ",n.win7(Pr(N,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(na,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&C>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&A&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&A&&t.jsx(Nn,{o:f})]}),t.jsx(jn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[C===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),C===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),C===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),C===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),Ft(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(f),a({type:"popup",id:null})},children:n.memoDeep})]}),C===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),C===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Gl(){const{lang:e,token:a,dossiers:r,caps:n}=V(),o=a||"home",{names:i,verdicts:d}=u.useMemo(()=>{const c=[],g={};return r.forEach(s=>{s.kind!=="target"||!s.name||(c.push(s.name),g[s.name]=mi(s)||"")}),{names:c,verdicts:g}},[r]);return{diff:u.useMemo(()=>i.length?fi(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function Kl(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d}=V(),l=i.loading&&!d.length,c=u.useRef({});u.useEffect(()=>{c.current={...r}},[r]);const g=p=>{const v=c.current[p],m=v!==void 0?r[p]-v:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ga[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(m>0?" up":m<0?" down":""),children:[r[p],m!==0&&t.jsxs("em",{className:"delta",children:[m>0?"+":"−",Math.abs(m)]})]})]},p)},s=(p,v,m)=>t.jsxs("button",{type:"button",className:"off"+(v?" view":""),style:{"--c":`var(${Ga[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsx("span",{className:"l",children:m.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),h=(p,v,m,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:v,disabled:b,onClick:m,children:p},v);return t.jsxs("div",{className:"funnel"+(l?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[h("↩",n.toolUndo,o,e.undo.length===0),h("↺",n.toolReset,()=>{a({type:"reset"})}),h("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),h("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),h("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Ql(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:d}=V(),l=u.useRef(null),[c,g]=u.useState(60);u.useEffect(()=>{let m=0;const b=()=>{var k;const y=l.current;if(!y)return;const f=(k=y.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!f)return;const N=f.getBoundingClientRect(),C=y.getBoundingClientRect();g(Math.max(20,Math.min(N.left+N.width/2-C.left,C.width-30)))};return m=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let h=r.tuto[s].p;if(s===3){const m=n.filter(f=>f.kind==="target"&&ze(f)===3),b=m.filter(f=>Ka(f)==="auto").length,y=m.filter(f=>Ka(f)==="cd").length;h=r.tutoPending(b,y,m.length)}const p=(()=>{if(d!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(s===1){const m=n.filter(b=>b.kind==="target"&&ze(b)===1&&!o.has(b.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(b=>b.id)})}}return null})(),v=hi(s);return t.jsxs("div",{ref:l,className:"tuto mini"+(v?"":" on-dark"),style:{"--bg":`var(${Ga[s]})`,"--ax":c+"px","--stc":v?"var(--ink)":"#fff","--stt":v?"#fff":"var(--ink)","--tc":v?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:h}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}const Va=600,kt=62,Er="atl2:fstats";function Jl(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=V(),[d,l]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Er)==="on"}catch{return!1}}),c=r.stats,g=u.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const h=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,p=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),v=g.reduce((j,A)=>Math.max(j,A.s||0),0),m=g.length?Va/g.length:0,b=Math.max(4,m-4),y=g.length>=5&&v>0,f=r.marketEstimate||0,N=h(new Date().toISOString().slice(0,10)),C=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],k=[];return typeof c.screened_window=="number"&&s&&k.push({cle:"fenetre",periode:e.funPerWindow(h(s),N),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:C(c.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([A,E],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(A)}),t.jsx("i",{children:E})]},j.cle+E)),j.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(f),Math.min(100,Math.round((c.screened||0)/f*100)))})]}),j.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const A=!d;l(A),A&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Er,A?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},j.cle)),d&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Va} ${kt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((j,A)=>{const E=(j.s||0)/v*(kt-4),q=(j.m||0)/v*(kt-4),z=A*m+(m-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${h(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:kt-2-E,width:b,height:E,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:kt-2-q,width:b,height:q,fill:"#185c38"})]},j.d)}),t.jsx("line",{x1:0,y1:kt-1.5,x2:Va,y2:kt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:h(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const bo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function En({o:e,locked:a=!1}){const{t:r}=V(),n=aa(e),o=ht(e),i=ze(e),d=Ka(e),l=gi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(bo[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(Es,{o:e})]})}const zt=e=>e.length>22?e.slice(0,21)+"…":e,va=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function La(e){return va.has(e.engine||"")}function jt(e){return!!e.noCo||La(e)&&!!e.url}function ta(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function vo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Xl({on:e,rev:a}){const[r,n]=u.useState(null),[o,i]=u.useState({top:0,left:0,width:0});return u.useEffect(()=>{if(!e){n(null);return}const d=()=>{var m,b,y;const l=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const g=l.getBoundingClientRect(),s=c?c.getBoundingClientRect().bottom:g.top;i({top:Math.round(s),left:Math.round(g.left),width:Math.round(g.width)});const h=[...l.querySelectorAll(":scope .grp")];let p=null;for(const f of h){const N=f.querySelector(".grp-h");N&&N.getBoundingClientRect().bottom<=s+2&&(p=f)}if(!p){n(null);return}const v=p.querySelector(".grp-h");if(!v){n(null);return}n({ic:(((m=v.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((b=v.querySelector(".t"))==null?void 0:b.textContent)||"").trim(),s:(((y=v.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Zl(e){const r=()=>{const n=vo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Sr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=V(),[i,d]=u.useState(!1);if(u.useEffect(()=>{n||d(!1)},[n]),$e(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(zt(e.name))})]})}function Sn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:d,doPromote:l,doRepeche:c,doApproach:g,dispatch:s,liveMemos:h}=V(),p=m=>b=>{b.stopPropagation(),m()};if(r.lockActions){const m=p(()=>s({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const b=ze(e);return b===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(zt(e.name))})]})}):b===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):b===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):b===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):b===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):b===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return La(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Sr,{o:e})});const v=ze(e);if(v===0)return t.jsx("span",{className:"cell",children:t.jsx(Sr,{o:e})});if(v===1){const m=h.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Qt,{item:m,serverOff:h.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:p(()=>i(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(v===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:p(()=>d(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:p(()=>d(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(v===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:p(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return v===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):v===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:p(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function ed({o:e}){const{t:a,doThumb:r,thumbOf:n}=V(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function td({o:e}){const{lang:a}=V();return Fe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(ft,{o:e}),t.jsx(Ra,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Et(e.engine||"")," ",He(e.engine||"",a)]})})}function ad({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d}){const{dispatch:l,caps:c,markRow:g,markedId:s,favIds:h,toggleFav:p,t:v}=V(),m=ze(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,f=y<=0?0:y<=7?1:y<=30?2:3,N=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][m]:b[f],C=h.has(e.id),k=j=>{if(a)return;if(d){d(e.id);return}if(c.pipe||e.kind==="op"){n();return}const A=j.currentTarget.getBoundingClientRect();l({type:"popup",id:e.id,anchor:{x:A.left+Math.min(280,A.width/3),y:A.bottom}})};return t.jsxs(u.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>g(e.id),onMouseLeave:()=>g(null),onClick:k,children:[t.jsx("span",{className:"pt",style:{"--c":N}}),t.jsx(No,{o:e}),t.jsxs("span",{className:"nd",children:[Fe(e)&&t.jsx(ft,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:C?1:.35,padding:0,marginRight:4},onClick:j=>{j.stopPropagation(),p(e)},children:C?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(j=>j&&j!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:v.acqSee(e.acquirer),onClick:j=>{j.stopPropagation(),l({type:"acquirer",value:e.acquirer||""})},children:["← ",zt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:v.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:v.zoomNewsMark,children:"📰"}):null]}),t.jsx(nd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(td,{o:e}),c.pipe&&t.jsx(En,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Sn,{o:e}),c.showThumbs&&t.jsx(ed,{o:e})]}),r&&!a&&!d&&t.jsx(id,{o:e})]})}function nd({o:e}){const{lang:a,caps:r}=V();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=It(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function rd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=V(),d=(p,v=!1)=>m=>{m.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:p})},l=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),c=It(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=$e(e),h=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped})]}):jt(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{p.stopPropagation(),ta(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:o,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(zt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(zt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(na,{spec:e.card})})]})}function od({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=V();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[He(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Sn,{o:e})}),t.jsx(Nn,{o:e})]})}function yo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:l,dossiers:c}=V(),g=u.useRef(null),s=We(e);if(u.useEffect(()=>{if(!s||!(e!=null&&e.decryptHtml))return;const x=g.current;if(!x)return;let T=!1;return Wa(()=>import("./fit-BnaWm7z_.js"),[]).then(async I=>{await I.ensureEditoCss(),!(T||!x.isConnected)&&(I.beautifyEditoRows(x),I.mountCardFits(x))}),()=>{T=!0}},[s,e==null?void 0:e.decryptHtml]),!e&&!a){const x=c.find(We);if(x)return t.jsx(yo,{o:x})}const h=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),p=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),v=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||h,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),b=e?!!e.noCo:!h||wa(h),y=(e==null?void 0:e.engine)||"",f=We(e),N=e?It(e.amountEur,n):"",C=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const x=/https?:\/\/(?:www\.)?([^/]+)/.exec(p);return x?x[1].replace(/^www\./,"").slice(0,40):""})(),j=c.find(We),A=((j==null?void 0:j.url)||"").trim(),E=!!p&&!!A&&(p===A||p.endsWith(A)||A.endsWith(p)),q=(x,T=!1)=>I=>{I.stopPropagation(),T&&d({type:"continent",key:"monde"}),d({type:"filters",patch:x})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const z=()=>{h&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:h}}))},F=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},P=()=>{ta({url:p,headline:v,tagline:e==null?void 0:e.tagline,name:h})},B=e?$e(e):!1,L=B&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",R=f?r.doEdito.replace(/^📖\s*/,""):y?He(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[R,C?` · ${C}`:""]}),t.jsx("h3",{className:"zoom-h",children:v}),p&&!f&&(b||La({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:p,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:x=>x.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),N&&t.jsx("span",{className:"oc-amt",children:N})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(na,{spec:m})}),(p&&!E&&!f||j&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[p&&!E&&!f&&t.jsxs("a",{className:"zoom-src",href:p,target:"_blank",rel:"nofollow noopener",onClick:x=>x.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:x=>{x.stopPropagation(),d({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[B?t.jsxs("span",{className:"verdict",style:{"--c":L?"var(--brand)":"var(--red)"},children:[L?"✓":"✗"," ",t.jsx("b",{children:L?r.kept:r.dropped})]}):!b&&h?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:x=>{x.stopPropagation(),o(e,h)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(zt(h))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,p&&!f&&(b||La({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!b&&h?" ghost":""),onClick:x=>{x.stopPropagation(),P()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!b&&h&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),F()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),z()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:zt(h)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!b&&h&&l.pipe&&t.jsx(jn,{name:h})]})]})}function id({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=V();return!o.pipe&&e.kind==="op"?t.jsx(rd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Nn,{o:e}),t.jsx(Ss,{o:e}),t.jsx(As,{o:e}),t.jsx(jn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(En,{o:e})})]}),e.card&&t.jsx(na,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Et(e.engine||"")," ",He(e.engine||"",r)]}),Fe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(ft,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function sd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:l,lang:c}=V();if(!d.pipe&&e.kind==="op"){const h=It(e.amountEur,c),p=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),v=(m,b=!1)=>y=>{y.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(na,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:v({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:v({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:v({stage:[e.stage]}),children:e.stage}),h&&t.jsx("span",{className:"damt",children:h})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Et(e.engine||"")," ",He(e.engine||"",c)]}),Fe(e)&&t.jsx(ft,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(p?` · ${p}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Sn,{o:e})})]})}const g=ze(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(En,{o:e}),Fe(e)&&t.jsx(ft,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemo," →"]})]})}function ld(){const{t:e}=V(),[a,r]=u.useState(0);return u.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function dd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=V(),i=o==="en",d=s=>n.plabels[s]||"",l=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=l.includes(0)?0:l.sort((s,h)=>(e[h]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${d(c)}”`:`${g} dossier${g>1?"s":""} dans « ${d(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+d(c)," →"]})]})}function cd(){var gt,bt,Je,ut,vt;const e=V(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:l,markRow:c,lang:g,sessTally:s,data:h,dossiers:p,source:v,focusExtra:m,byId:b,token:y}=e,f=_r(),N=u.useMemo(()=>{var H,le,we,me;if(!y||v==="ops")return null;const S=(((H=f==null?void 0:f.ed)==null?void 0:H.date)||(f==null?void 0:f.day)||"").slice(0,10),U=[(le=f==null?void 0:f.ed)==null?void 0:le.html,(we=f==null?void 0:f.ed)==null?void 0:we.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((me=f==null?void 0:f.ed)==null?void 0:me.date)||S,decryptHtml:U||void 0,date:S,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,v,g,(gt=f==null?void 0:f.ed)==null?void 0:gt.html,(bt=f==null?void 0:f.ed)==null?void 0:bt.acquirers_html,(Je=f==null?void 0:f.ed)==null?void 0:Je.date,f==null?void 0:f.day]),C=S=>o.lockRowsAfter!==null||v==="ops"?Number.MAX_SAFE_INTEGER:Br,[k,j]=u.useState(new Set);u.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[A,E]=u.useState(null);u.useEffect(()=>{E(null)},[a.ptab,a.continent]);const[q,z]=u.useState(!a.mapFolded);u.useEffect(()=>{if(a.mapFolded){z(!1);return}const S=document.getElementById("atl2-stage");if(!S){z(!1);return}const U=new IntersectionObserver(([H])=>z(!!H&&H.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return U.observe(S),()=>U.disconnect()},[a.mapFolded]);const F=a.mapFolded||!q,P=S=>j(U=>{const H=new Set(U);return H.has(S)?H.delete(S):H.add(S),H}),B=v==="ops"||o.pipe,[L,R]=u.useState("all"),[x,T]=u.useState(null),[I,Y]=u.useState(!1),W=u.useRef(!0);u.useEffect(()=>{if(W.current){W.current=!1;return}R("all"),Y(!1)},[a.ptab,a.continent]),u.useEffect(()=>{if(!I)return;const S=U=>{var H,le;(le=(H=U.target)==null?void 0:H.closest)!=null&&le.call(H,".atl2 .doable")||Y(!1)};return document.addEventListener("click",S),()=>document.removeEventListener("click",S)},[I]);const K=u.useMemo(()=>{var U;const S=new Map;for(const H of us(((U=f==null?void 0:f.ed)==null?void 0:U.html)||""))S.has(H.t)||S.set(H.t,H.html);return S},[(ut=f==null?void 0:f.ed)==null?void 0:ut.html]),X=u.useCallback(S=>{if(S.decryptHtml)return S.decryptHtml;if(!K.size)return;const U=(S.name||"").trim().toLowerCase();if(U.length<3)return;const H=K.get(U);if(H)return H;for(const[le,we]of K)if(le.includes(U)||U.includes(le))return we},[K]),{diff:Q}=Gl(),[pe,te]=u.useState(!1),ge=a.filters.win==="1"&&!a.filters.day,[_,se]=u.useState(!1),ue=u.useMemo(()=>new Set(((Q==null?void 0:Q.added)||[]).map(S=>S.trim().toLowerCase()).filter(Boolean)),[Q]),Le=u.useMemo(()=>ue.size?l.filter(S=>!We(S)&&ue.has((S.name||"").trim().toLowerCase())).length:0,[l,ue]),ee=u.useMemo(()=>{const S=_&&ue.size?l:d;let U=bn(S,a.sort);return U=U.filter(H=>!We(H)),_&&ue.size&&(U=U.filter(H=>ue.has((H.name||"").trim().toLowerCase()))),L==="explore"?U=U.filter(jt):L==="eval"&&(U=U.filter(H=>!jt(H)&&!H.noCo)),U},[d,l,a.sort,L,_,ue]),he=u.useMemo(()=>o.pipe?l.filter(S=>Fe(S)&&xi(S)):ee.filter(S=>Fe(S)&&!$e(S)),[o.pipe,l,ee]).length,ie=u.useMemo(()=>o.pipe?ee:ee.filter(S=>!$e(S)&&!S.noCo),[ee,o.pipe]),G=v==="ops"?ee.filter(jt).length:0,ae=_?n.sinceDock(ee.length):o.pipe?n.plabels[a.ptab].toLowerCase():v==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,oe=a.filters,xe=[];if(oe.day)xe.push({k:"day",lib:n.fDay(oe.day.slice(8,10)+"/"+oe.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(oe.win&&oe.win!=="all"){const S=["1","7","30"].indexOf(oe.win);S>=0&&xe.push({k:"win",lib:n.dates[S],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ee=S=>S.length<=2?S.join(", "):`${S.length} ${n.fSelected}`;for(const S of["sector","country","engine"]){const U=oe[S];U&&U.length&&xe.push({k:S,lib:Ee(U),off:()=>r({type:"clearFacet",facet:S})})}oe.search&&xe.push({k:"search",lib:"🔍 "+oe.search,off:()=>r({type:"filters",patch:{search:""}})}),_&&ue.size&&xe.push({k:"since",lib:"✨ "+n.sinceDock(ue.size),off:()=>se(!1)}),oe.signalOnly&&xe.push({k:"sig",lib:"🔴 "+n.sigDock(he||oe.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const ne=(S,U,H="",le=!1)=>t.jsxs("button",{type:"button","data-s":S,className:H,"aria-sort":a.sort.key===S?a.sort.dir===1?"ascending":"descending":"none",style:le?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:S}),children:[U,t.jsx("span",{className:"ar",children:a.sort.key===S&&a.sort.dir===1?"▴":"▾"})]},S),ce=u.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const S=new Map;ee.forEach(le=>{const we=le.engine||"?";S.has(we)||S.set(we,[]),S.get(we).push(le)});const U={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},H=Ya([...S.keys()],g);return[...S.entries()].sort((le,we)=>{const me=U[le[0]]??10+H.indexOf(le[0]),ke=U[we[0]]??10+H.indexOf(we[0]);return me-ke})},[ee,o.pipe,a.groupBy,g]),Ie=ce?ce.filter(([S])=>va.has(S)).length:0,qe=(()=>{var U;return((U=(ce?ce.flatMap(([,H])=>H):ee)[0])==null?void 0:U.id)??null})(),Me=u.useRef(!1),Ce=u.useMemo(()=>p.find(We)||N,[p,N]);u.useEffect(()=>{const S=()=>{Me.current=!0};return window.addEventListener("ppmap:reveal",S),window.addEventListener("ppmap:focus",S),()=>{window.removeEventListener("ppmap:reveal",S),window.removeEventListener("ppmap:focus",S)}},[]),u.useEffect(()=>{const S=()=>{Ce&&r({type:"focus",id:Ce.id})};return window.addEventListener("ppmap:edito",S),()=>window.removeEventListener("ppmap:edito",S)},[Ce,r]),u.useEffect(()=>{if(!a.focusId)return;T(a.focusId);const S=window.setTimeout(()=>T(null),900);return()=>window.clearTimeout(S)},[a.focusId]),u.useEffect(()=>{if(B&&!(a.focusId&&(ee.some(S=>S.id===a.focusId)||p.some(S=>S.id===a.focusId)||a.focusId===(Ce==null?void 0:Ce.id)))&&!m){if(Ce){r({type:"focus",id:Ce.id});return}qe&&r({type:"focus",id:qe})}},[B,a.focusId,ee,qe,m,r,p,v,Ce]),u.useEffect(()=>{if(!(!B||!a.focusId)&&L!=="all"&&!(Ce&&a.focusId===Ce.id)&&!ee.some(S=>S.id===a.focusId)&&p.some(S=>S.id===a.focusId)){if(Me.current){R("all");return}qe&&r({type:"focus",id:qe})}},[B,a.focusId,L,ee,p,qe,r]),u.useEffect(()=>{if(!B||!a.focusId||!Me.current)return;const S=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!S)return;Me.current=!1;const U=vo(),H=S.getBoundingClientRect();H.top>=U-2&&H.bottom<=window.innerHeight-4||Zl(S)},[B,a.focusId,a.ptab,ee]),u.useEffect(()=>{if(typeof window>"u")return;const S=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),U=document.querySelector(".atl2.ops, .atl2.cibles");if(!S||!U)return;const H=()=>U.style.setProperty("--listhead-h",`${S.offsetHeight}px`);H();const le=new ResizeObserver(H);return le.observe(S),()=>le.disconnect()},[F,a.dens,a.mapFolded]);const be=u.useMemo(()=>{if(!B||!a.focusId)return null;if(N&&a.focusId===N.id)return N;const S=ee.find(H=>H.id===a.focusId)||p.find(H=>H.id===a.focusId)||null;if(!S)return null;const U=X(S);return U&&U!==S.decryptHtml?{...S,decryptHtml:U}:S},[B,a.focusId,ee,p,X,N]),Ve=o.lockRowsAfter;let Re=0;const st=(S,U)=>{let H=a.shown[U]||C();return S.length-H<=4&&(H=S.length),S.slice(0,H).map(me=>{const ke=Ve!==null&&Re>=Ve;Re++;const Xe=X(me),yt=Xe&&Xe!==me.decryptHtml?{...me,decryptHtml:Xe}:me,mt=!B&&a.dens!=="maxi"&&(a.dens==="deplie"||(A?A==="open":!!Xe)),Bt=k.has(me.id)?!mt:mt,Tt=B?Oe=>{Me.current=!0,r({type:"focus",id:Oe});const De=b.get(Oe);De&&(jt(De)?ta(De):De.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:De.name,url:De.url||"",website:De.website||"",domain:De.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(sd,{o:yt,locked:ke,selected:B&&a.focusId===me.id,onSelect:Tt},me.id):t.jsx(ad,{o:yt,locked:ke,open:Bt,onToggle:()=>P(me.id),selected:B&&a.focusId===me.id,echo:x===me.id,onSelect:Tt},me.id)})},pt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(v==="ops"?" opsl":"")+(ee.length?"":" list-empty"),xt=t.jsxs(t.Fragment,{children:[ce?ce.map(([S,U])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Et(S)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:S==="ma"?n.grpMa:S==="fundraising"?n.grpLev:va.has(S)&&Ie<=1?n.grpNews:S==="nominations"?n.grpNom:S==="media"?n.grpNewsOther:S==="recrutements"?n.grpHire:va.has(S)?n.grpNews+" · "+He(S,g):He(S,g)}),t.jsx("div",{className:"s",children:n.grpCount(U.filter(H=>!$e(H)).length,U.length)})]})]}),st(U,S)]},S)):st(ee,"pt"+a.ptab),h.loading&&!p.length&&t.jsx(ld,{}),!ee.length&&!(h.loading&&!p.length)&&(o.pipe?t.jsx(dd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),tt=t.jsxs("div",{className:"listhead"+(F?" mapoff":""),children:[F&&t.jsx("div",{className:"lh-tools",children:t.jsx(fo,{compact:!0})}),o.showFunnel&&pe&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(qs,{}),t.jsx(Jl,{})]}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Kl,{}),t.jsx(Ql,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ge?" on":""),"aria-pressed":ge,title:n.morningDockTitle,onClick:()=>{if(ge){r({type:"filters",patch:{win:"all",day:""}}),te(!1);return}se(!1),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),te(!0)},children:["📊 ",n.morningDock(typeof((vt=h.stats)==null?void 0:vt.screened_today)=="number"?h.stats.screened_today:0)]}),Q&&!Q.firstVisit&&(Q.added.length>0||Q.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(_?" on":""),"aria-pressed":_,title:n.sinceSub,onClick:()=>{const S=!_;se(S),S&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(Le)]}),he>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{se(!1),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(he)]})]}),t.jsxs("span",{className:"main",children:[t.jsx("b",{children:ee.length})," ",ae]}),t.jsx("span",{className:"dot",children:"·"}),F&&t.jsx(ho,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[F?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),xe.map(S=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:U=>{U.stopPropagation(),S.off()},children:[S.lib,t.jsx("i",{children:"×"})]},S.k)),v==="ops"&&ee.length>0&&!F&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ee.length-G," ",n.zoomPulseEval,G>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",G," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||v==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([S,U])=>t.jsxs("button",{type:"button","data-d":S,"aria-pressed":a.dens===S||S==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:S}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:U})]},S))}),!B&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":A==="open",onClick:()=>{E("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":A==="closed",onClick:()=>{E("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||v==="ops")&&(()=>{var me;const S=d.filter(ke=>!We(ke)),U=S.filter(ke=>!jt(ke)&&!ke.noCo).length,H=S.filter(jt).length,le=[["all",n.doAll],["eval",`${n.doEval}${U?` ${U}`:""}`],["explore",`${n.doExplore}${H?` ${H}`:""}`]],we=((me=le.find(([ke])=>ke===L))==null?void 0:me[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":I,onClick:()=>Y(ke=>!ke),children:[we,t.jsx("i",{children:"▾"})]}),I&&t.jsx("div",{className:"dolist",children:le.map(([ke,Xe])=>t.jsx("button",{type:"button","aria-pressed":L===ke,onClick:()=>{R(ke),Y(!1)},children:Xe},ke))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:S=>r({type:"sort",key:S.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([S,U])=>t.jsx("option",{value:S,children:U},S))})]}),o.showChain&&ie.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ie.map(S=>S.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ie.length):n.chainAll(ie.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!B&&tt,a.dens!=="maxi"&&!B&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ne("country",n.colCountry),ne("name",n.colCompany),ne("amount",n.colAmount,"h-amt",!0),ne("stage",n.colStage,"h-stade"),ne("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ne("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ne("memo",n.colMemo)]}),o.pipe&&ne("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),B?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[tt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ne("country",n.colCountry),ne("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ne("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ne("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:pt,children:xt})]}),t.jsxs("aside",{className:"readpane"+((be?We(be):!m&&Ce)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[Ce&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===Ce.id,onClick:()=>r({type:"focus",id:Ce.id}),children:n.doEdito}),N&&a.focusId===N.id?t.jsx("div",{className:"zoom",children:t.jsx(gs,{})}):be&&o.pipe?t.jsx(od,{o:be}):t.jsx(yo,{o:be,extra:be?null:m})]})]}):t.jsx("div",{className:pt,children:xt}),(()=>{const S=ce||[["pt"+a.ptab,ee]];let U=0,H=0;for(const[we,me]of S){H+=me.length;let ke=a.shown[we]||C();me.length-ke<=4&&(ke=me.length),U+=Math.min(me.length,ke)}const le=H-U;return le<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>S.forEach(([we,me])=>r({type:"more",group:we,by:me.length,base:C()})),children:[t.jsx("span",{className:"more-label",children:n.more(le,le)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(U,H)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}}),B&&v==="ops"&&a.dens!=="maxi"&&t.jsx(Xl,{on:!!ce,rev:(ce||[]).map(([S,U])=>S+U.length).join("|")})]})}function Cr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function pd(e,a){const r=bi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function ud(e,a){const n=[a.head.split("|").map(Cr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",pd(o,a.plabels),aa(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Cr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function md(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const fd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function rt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function hd({o:e,qa:a}){const{t:r,lang:n,fund:o}=V(),i=(e.cribleStatus||"").trim().toUpperCase()||(aa(e)==="NO MATCH"?"NO MATCH":"MATCH"),d=ht(e),l=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,d&&t.jsx("em",{children:d})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(rt,{k:r.cdSector,v:e.sector}),t.jsx(rt,{k:r.cdStage,v:e.stage}),t.jsx(rt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(rt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(rt,{k:r.cdName,v:e.contactName}),t.jsx(rt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(rt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(rt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(rt,{k:r.cdAngle,v:e.angle}),t.jsx(rt,{k:r.cdDetected,v:fd(e.date,n)})]}),c.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,g])=>g).map(([g,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:s})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function xd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d}=V(),[l,c]=u.useState({}),g=25,s=u.useMemo(()=>n.slice(0,g),[n]);u.useEffect(()=>{s.length&&vi(r,s.map(v=>v.name)).then(c)},[r,s]);const h=i.stats,p=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),h&&typeof h.screened=="number"&&t.jsxs("p",{children:[p(h.screened)," ",e.funScreened(""),typeof h.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(h.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(i.marketEstimate)),", ",Math.round(h.screened/i.marketEstimate*100)," %"]})]})]}),s.map(v=>t.jsx(hd,{o:v,qa:l[v.name]},v.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const gd=50;function Cn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=V(),[i,d]=u.useState(null),[l,c]=u.useState(!1),[g,s]=u.useState(""),[h,p]=u.useState(0),[v,m]=u.useState(""),[b,y]=u.useState(!1),[f,N]=u.useState(0),C=u.useRef(null),k=u.useRef(null),j=()=>{N(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>N(z=>z+1),1e3)},A=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};u.useEffect(()=>()=>{C.current&&window.clearInterval(C.current),k.current&&window.clearInterval(k.current)},[]);const E=async z=>{c(!0),s(""),j();const F=await a();if(c(!1),A(),F.ok){d(F);return}if(F.busy){s(o.alertPreviewBusy);return}if(!z){s(o.alertPreviewFail);return}p(gd),A(),C.current=window.setInterval(()=>{p(P=>P>1?P-1:(C.current&&window.clearInterval(C.current),E(!1),0))},1e3)},q=async()=>{if(n||b||l)return;y(!0),m(""),j();const z=await r();y(!1),A(),m(z.ok?o.alertTestOk(z.sentTo||""):z.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||b||h>0,onClick:()=>{E(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b||l,onClick:()=>{q()},children:b?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),b&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),h>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(h)}),g&&t.jsx("p",{className:"mnote warn",children:g}),v&&t.jsx("p",{className:"mnote",children:v}),!v&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Rt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function _e({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=V();return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function bd(){const{st:e}=V();switch(e.modal){case"chain":return t.jsx(yd,{});case"space":return t.jsx(wd,{});case"alert":return t.jsx(kd,{});case"queue":return t.jsx(Cd,{});case"export":return t.jsx(zd,{});case"plug":return t.jsx(qd,{});case"recharge":return t.jsx(Rd,{});case"cover":return t.jsx(Md,{});case"dossier":return t.jsx(Fd,{});case"crit":return t.jsx(Od,{});case"tuto":return t.jsx(Dd,{});case"rdv":return t.jsx(vd,{});case"memoalert":return t.jsx(Ad,{});default:return null}}function vd(){const{dispatch:e,fund:a,t:r}=V(),n=a||r.rdvCoFallback;return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Vr,children:yn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Ui,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function yd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:l,caps:c,memoQueued:g,doAnalyse:s}=V(),h=i==="client",p=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),v=e.chain.idx,m=p[v],b=v>=p.length;return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${v+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:v/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Pt(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(ct(m.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:He(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:It(m.amountEur,o)})]}),Fe(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(ft,{o:m,lg:!0})," ",t.jsx(Ra,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),h&&$e(m)&&t.jsxs("div",{className:"vbox",style:{"--c":Nt(m)==="retenu"?"var(--brand)":Nt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Nt(m)==="retenu"?"✓ "+n.kept:Nt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&m&&c.pipe&&ze(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&m&&!(h&&$e(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{d(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function wd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=V(),i=o==="client",d=u.useMemo(()=>i?r.filter(h=>$e(h)):[],[r,i]),l=u.useMemo(()=>bn(d.filter(h=>Nt(h)==="retenu"),{key:"signal",dir:-1}),[d]),c=u.useMemo(()=>d.filter(h=>Nt(h)==="ecarte"),[d]),g=e.spaceTab==="retenu"?l:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(_e,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(h=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof h.score=="number"&&h.score>0?h.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:h.name}),t.jsx("div",{className:"rr",children:h.reasoning||h.tagline||""})]})]},h.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function kd(){const{mode:e}=V();return e==="client"||e==="apercu"?t.jsx(jd,{}):t.jsx(Sd,{})}function jd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=V(),[i,d]=u.useState("d"),l=o!=="client";return t.jsxs(_e,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Nd,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(Ed,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(wo,{})]})}function Nd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=u.useState(null),[l,c]=u.useState(!1),[g,s]=u.useState(0);u.useEffect(()=>{let q=!0;return c(!1),Bn(a).then(z=>{q&&(z?d(z):c(!0))}),()=>{q=!1}},[a,g]);const h=u.useRef({}),[p,v]=u.useState({}),[m,b]=u.useState(!1),[y,f]=u.useState(!1),N=u.useRef(null);u.useEffect(()=>()=>{N.current&&window.clearTimeout(N.current)},[]);const C=q=>{const z=h.current;Object.keys(z).length&&(b(!0),Bn(a,z).then(F=>{if(!F){b(!1),o(e.actErr);return}if(F.throttled&&q<3){N.current=window.setTimeout(()=>C(q+1),5400);return}if(h.current={},v({}),d(F),b(!1),F.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},k=q=>{r||(h.current={...h.current,...q},v(z=>({...z,...q})),N.current&&window.clearTimeout(N.current),N.current=window.setTimeout(()=>C(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(q=>q+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...p},A=q=>!j.sections||j.sections.includes(q),E=q=>{const z=j.sections||e.alertSec.map(([F])=>F);k({sections:A(q)?z.filter(F=>F!==q):[...z,q]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([q,z])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:A(q),disabled:r,onChange:()=>E(q)}),t.jsxs("span",{children:[z,q==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},q))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Cn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ai(a),onTest:()=>zi(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ed({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=u.useState(null),[l,c]=u.useState(!1),[g,s]=u.useState(0);u.useEffect(()=>{let m=!0;return c(!1),$n(a).then(b=>{m&&(b?d(b):c(!0))}),()=>{m=!1}},[a,g]);const h=m=>{r||$n(a,m).then(b=>{if(!b){o(e.actErr);return}d(b),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const p=i.dow??0,v=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>h({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:m=>h({dow:Number(m.target.value)}),children:e.alertDow.map((m,b)=>t.jsx("option",{value:b,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[v," h"]}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.min(21,v+1)}),disabled:r,children:"+"})]})]}),t.jsx(Cn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>qi(a),onTest:()=>Ti(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function wo(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=V(),[d,l]=u.useState(i||""),[c,g]=u.useState(!1),[s,h]=u.useState(!1);u.useEffect(()=>{i&&l(i)},[i]);const p=e.filters,v=u.useMemo(()=>n.filter(f=>Fe(f)).length,[n]),m=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(d)||s)){h(!0);try{await fetch(`${fn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:p.sector,countries:p.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{h(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(f=>He(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(f=>Pt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,N])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:N}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Sd(){const{t:e}=V();return t.jsx(_e,{title:e.alertTitle,icon:"🔔",children:t.jsx(wo,{})})}function Cd(){var P,B;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:l,dispatch:c,liveMemos:g}=V(),[s,h]=u.useState(()=>Oa(r)),[p,v]=u.useState(()=>!Oa(r)),[m,b]=u.useState([]),[y,f]=u.useState(0),N=n==="client",C=u.useMemo(()=>{const L=new Map;return o.forEach(R=>{const x=(R.name||"").trim().toLowerCase();x&&!L.has(x)&&L.set(x,R)}),L},[o]);u.useEffect(()=>{let L=!0;return(!Oa(r)||y>0)&&v(!0),(async()=>{const[R,x]=await Promise.all([xn(r,y>0),Rr(a)]);L&&(R&&h(R),v(!1),b(x))})(),()=>{L=!1}},[a,r,y]);const k=p&&!s,j=(s==null?void 0:s.per_day)??0,A=((P=s==null?void 0:s.analyzed_today)==null?void 0:P.length)??0,E=s==null?void 0:s.offre,q=(s==null?void 0:s.pool_meta)||[],z=u.useMemo(()=>{const L=new Map;for(const R of(s==null?void 0:s.scheduled)||[])for(const x of R.names||[])L.has(x)||L.set(x,{label:R.day_label,date:R.date});return L},[s==null?void 0:s.scheduled]),F=(s==null?void 0:s.in_progress)||[];return t.jsxs(_e,{title:e.queueTitle,wide:!0,children:[E&&t.jsxs("div",{className:"qoffre"+(E.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:E.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:E.delai})]}),t.jsx("span",{className:"osp"}),E.rythme>0?t.jsx("span",{className:"or",children:e.qRate(E.rythme)}):E.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(E.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(A,A+(((B=s==null?void 0:s.pool_order)==null?void 0:B.length)??0))}})}),E&&t.jsxs("div",{className:"qeta",children:[E.file===0?e.qEtaDone:E.rythme<=0?e.qEtaPaused:e.qEta(E.file,E.rythme,E.jours_restants),E.en_retard&&t.jsxs("em",{children:[" ",e.qLate(E.delai,E.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(E==null?void 0:E.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(F.length>0||g.items.some(L=>L.status==="boot"||L.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(L=>L.status==="boot"||L.status==="running"||L.status==="error").map(L=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:L.name}),t.jsx("span",{className:"qd",children:L.memoType||""}),t.jsx(Qt,{item:L,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+L.name)),F.filter(L=>!g.liveOf(L.name)).map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.name}),t.jsxs("span",{className:"qd",children:[L.memo_type||"",L.age_min?` · ${Math.round(L.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:L.state||""})]},"ip-"+L.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.company}),t.jsxs("span",{className:"qd",children:[L.memo_type,typeof L.est_min=="number"?` · ~${L.est_min} min`:""]}),t.jsx("span",{className:"qt",children:L.status}),L.url&&t.jsx("a",{className:"qgo",href:L.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),N&&L.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{In(a,L.company,"retry").then(()=>f(R=>R+1))},children:e.queueRetry}),N&&L.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{In(a,L.company,"delete").then(()=>f(R=>R+1))},children:e.queueDelete})]},L.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(q.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&q.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),q.map((L,R)=>{const x=z.get(L.name),T=C.get((L.name||"").trim().toLowerCase()),I=g.liveOf(L.name),Y=!!(T&&d.has(T.id))||!!(I&&(I.status==="boot"||I.status==="running")),W=!!(T&&ze(T)===1&&!T.memoUrl)&&!I;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),x?t.jsx("span",{className:"qwhen"+(x.label==="demain"?" soon":""),children:x.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:L.name}),L.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof L.score=="number"&&t.jsx("span",{className:"qs2",children:L.score}),I&&(I.status==="boot"||I.status==="running")&&t.jsx(Qt,{item:I,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),W&&(l.lockActions||!N?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:Y,onClick:()=>{i(T),f(K=>K+1)},children:Y?e.actAnalyseQueued:e.actAnalyse})),L.excerpt&&t.jsx("span",{className:"qex",children:L.excerpt})]},L.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([L,R])=>t.jsxs("li",{children:[t.jsx("b",{children:L})," — ",R]},L))})]})}function zd(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=V(),l=`${Rt}/cibles/list.csv?token=${a}`,c=`${Rt}/cibles/list.json?token=${a}`,g=`${Rt}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${l}")`,h=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:g,href:g}],v=!o.lockActions&&n.length>0,m=()=>{md(ud(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(_e,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:y,value:f,href:N})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>h(f),children:e.exportCopy}),N&&t.jsx("a",{className:"exb",href:N,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Ad(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=V(),i=o!=="client",[d,l]=u.useState(null),[c,g]=u.useState(!1),[s,h]=u.useState(0),[p,v]=u.useState(!1);u.useEffect(()=>{let f=!0;return g(!1),Pn(a).then(N=>{f&&(N?l(N):g(!0))}),()=>{f=!1}},[a,s]);const m=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=f=>{if(i||!d)return;const N={enabled:f.enabled??!!d.enabled,email:f.email??(d.email||""),sections:f.sections??m()};v(!0),Pn(a,N).then(C=>{if(v(!1),!C){n(e.memoAlertErr);return}l(C),r(e.memoAlertSaved)})};if(c)return t.jsx(_e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>h(f=>f+1),children:e.retry})]})});if(!d)return t.jsx(_e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs(_e,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||p,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(Td,{value:d.email||"",readOnly:i||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>b({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,N])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:i||p,onChange:()=>b({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:N})]},f))}),t.jsx(Cn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>wi(a,y),onTest:()=>yi(a,y)})]})}function Td({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=u.useState(e);u.useEffect(()=>{d(e)},[e]);const l=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>d(g.target.value),onKeyDown:g=>{g.key==="Enter"&&l&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!c,onClick:()=>o(i.trim()),children:n})]})]})}function qd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=V(),[i,d]=u.useState(null),[l,c]=u.useState(!1),[g,s]=u.useState(null),[h,p]=u.useState(""),[v,m]=u.useState(0);u.useEffect(()=>{let C=!0;return c(!1),Qa(a).then(k=>{C&&(k?d({configured:k.configured,url_hint:k.url_hint}):c(!0))}),Ni(a).then(k=>{C&&s(k)}),()=>{C=!1}},[a,v]);const b=(C,k)=>{o&&Qa(a,C).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}C.test&&j.sent===!1?n(e.plugTestThrottled):r(k),m(A=>A+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',f=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),N=`curl -X POST ${Rt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(_e,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(C=>C+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:h,disabled:!o,onChange:C=>p(C.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!h.trim(),onClick:()=>b({url:h.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:f}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(f).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Ld,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:N}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(N).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Ld(){const{t:e,token:a,lang:r}=V(),[n,o]=u.useState("valides"),[i,d]=u.useState(!1),[l,c]=u.useState(null),[g,s]=u.useState(null),[h,p]=u.useState(!1),[v,m]=u.useState(!1),[b,y]=u.useState(null),[f,N]=u.useState(null),[C,k]=u.useState(null),j=`atl2:bulk:${a}:${n}`;u.useEffect(()=>{Qa(a).then(B=>{N(B&&B.configured?B.url_hint||"webhook":null)})},[a]),u.useEffect(()=>{c(null),s(null),p(!1),y(null);try{const B=JSON.parse(localStorage.getItem(j)||"null");k(B&&Date.now()-Date.parse(B.t)<24*3600*1e3?B:null)}catch{k(null)}},[j]);const A=async()=>{d(!0),p(!1),y(null);const B=await Si(a,n);c(B),s(B.ok?n:null),d(!1)},E=u.useRef(!1),q=async()=>{if(E.current)return;E.current=!0,m(!0);const B=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await Ci(a,n,"webhook",void 0,B)}finally{E.current=!1}if(m(!1),p(!1),y(L),L.ok&&(L.pushed||0)>0){const R={t:new Date().toISOString(),n:L.pushed||0};k(R);try{localStorage.setItem(j,JSON.stringify(R))}catch{}}},z=l!=null&&l.ok&&l.ready||0,F=!!(l!=null&&l.ok)&&g===n&&z>0&&!!f&&!C,P=C?new Date(C.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:B=>o(B.target.value),children:e.plugBulkTabs.map(([B,L])=>t.jsx("option",{value:B,children:L},B))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{A()},children:i?"…":e.plugBulkPreview})]}),l&&(l.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(l.ready||0,l.linkedinReady||0,(l.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(l!=null&&l.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),C&&t.jsx("p",{className:"mnote",children:e.bulkLocked(P,C.n)}),!C&&!!(l!=null&&l.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!C&&!l&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),F&&!h&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),F&&h&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(z,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{q()},children:v?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>p(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function Rd(){const{t:e,data:a,lang:r}=V(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const l=window.location.href.split("?")[0];try{const g=await(await fetch(`${fn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(_e,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(d.credits,d.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Fd(){const{t:e}=V();return t.jsx(_e,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(xd,{})})}function Md(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:l}=V(),[c,g]=u.useState(null),[s,h]=u.useState(!1);u.useEffect(()=>{let z=!0;if(i)return xn(i).then(F=>{z&&F&&typeof F.per_day=="number"&&g(F.per_day)}),()=>{z=!1}},[i]);const[p,v]=u.useState(null);u.useEffect(()=>{if(!o)return;let z=!0;return ji(o).then(F=>{z&&v(F)}),()=>{z=!1}},[o]);const m=r.stats,b=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(z=>z.kind==="target"&&$e(z)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(b/y*100)):null,N=(m==null?void 0:m.window_days)||30,C=b>0?b/N:0,k=y>0?Math.max(0,y-b):0,A=y>0&&C>0&&b>=100?Math.round(k/C):null,E=z=>Math.round(z).toLocaleString(a==="en"?"en-US":"fr-FR"),q=z=>{s||!d||(h(!0),Ei(o,z).then(F=>{if(h(!1),F===null){l(e.actErr);return}g(F),l(e.alertSaved)}))};return t.jsxs(_e,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(E(b))}),y>0&&t.jsx("span",{children:e.covOf(E(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),A!==null&&t.jsx("p",{className:"mnote",children:e.covEta(A)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),C>=1&&t.jsx("p",{className:"mnote",children:e.covPace(E(C))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.shown)})," ",e.funShown]})]}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((z,F)=>t.jsxs("tr",{className:z.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[z.code,z.geo?` · ${z.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof z.n=="number"?E(z.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:z.source}),z.elargi&&t.jsx("em",{children:e.covWide(String(z.demande||""))}),z.erreur&&t.jsx("em",{children:e.covMissing})]})]},F)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:E(p.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(z=>t.jsx("button",{type:"button",className:c===z?"on":"",disabled:s,onClick:()=>q(z),children:z===0?"⏸":z},z))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Od(){var f,N,C;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:l}=V(),c=n==="client",g=u.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[s,h]=u.useState(""),[p,v]=u.useState(""),[m,b]=u.useState(!1),y=async()=>{const k=s.trim();if(!(!k||m||!c)){b(!0),v("");try{const A=await(await fetch(`${Rt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&v(String(A.reply)),A.job_id){v(e.critChatRunning);const E=async()=>{const q=await fetch(`${Rt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(z=>z.json()).catch(()=>null);if(q&&q.done){v(String(q.reply||q.clarification||q.summary||"✓")),b(!1),q.applied&&o(e.alertSaved);return}setTimeout(()=>{E()},8e3)};setTimeout(()=>{E()},8e3),h("");return}h("")}finally{p.startsWith("⏳")||b(!1)}}};return t.jsxs(_e,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((N=i==null?void 0:i.angles)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(E=>t.jsx("li",{children:E},E))})]}),!!((A=k.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(E=>t.jsx("li",{children:E},E))})]})]})]},k.title)})]}),!!((C=i==null?void 0:i.gate)!=null&&C.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||m,onChange:k=>h(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ki,{fund:d,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(bo[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Dd(){const{t:e,dispatch:a,startTour:r}=V(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(_e,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const ko="atl2:mapfold",Pd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(ko);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Id=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},jo=u.createContext(null),V=()=>{const e=u.useContext(jo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function ft({o:e,lg:a}){const{lang:r}=V(),n=Fe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:_n(n,r),children:[n.emoji," ",_n(n,r)]}):null}function Ra({o:e,src:a}){const{lang:r,t:n}=V(),o=Fe(e);if(!o)return null;const i=Di(o),d=Pi(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(Dr(o,r))+" · "+n.win7(Pr(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Bd(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Pe(a);if(o)return e.find(i=>Pe(i.name)===o)||e.find(i=>{const d=Pe(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function $d(){const{scoped:e,t:a,st:r,dispatch:n}=V(),o=u.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(h=>!We(h)),l=d.length,c=d.filter(h=>!h.noCo).length,g=d.filter(h=>!!h.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const h=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:h,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function _d(){const{t:e,lang:a,data:r,dispatch:n}=V(),o=r.stats,i=l=>l.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const d=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:d>0?e.covOf(i(d)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function No({o:e}){const{lang:a}=V(),r=Oi(e.cc),n=e.cc?Pt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const zr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Ud=!1;function Hd(){const[e,a]=u.useState(!1);return u.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Eo=e=>`atl2:tour:${e||"anon"}`;function Vd(e){try{return localStorage.getItem(Eo(e))==="1"}catch{return!0}}function Ar(e){try{localStorage.setItem(Eo(e),"1")}catch{}}function Wd(e,a,r,n,o){const i=e.tourT,d=e.howto;return[{sel:".atl2 .ident",title:i.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:i.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:i.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:i.live,body:e.fhintLive},{sel:".atl2 .goal",title:i.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:i.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:i.tuto,body:d[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:i.demand,body:d[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:i.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:i.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:i.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:i.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:i.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:i.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:i.tools,body:d[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:i.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:i.crit,body:d[0][0],modal:"crit"}].filter(Boolean)}function Jd({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var re;const{lang:d}=Li(),l=Qi[d],c=ss(e,d,a),[g,s]=u.useReducer(cs,void 0,()=>ls((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Id():Pd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),h=u.useRef(!0);u.useEffect(()=>{if(h.current){h.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(ko,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),u.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const w=()=>{window.innerWidth<=760&&s({type:"mapFold",folded:!0})};return w(),window.addEventListener("resize",w),()=>window.removeEventListener("resize",w)},[a]);const p=u.useRef(i);p.current=i,u.useEffect(()=>{var w;(w=p.current)==null||w.call(p,g.filters)},[g.filters]);const[v,m]=u.useState(()=>{if(typeof window>"u")return"both";try{const w=localStorage.getItem("atl2:chrome-mode");if(w==="eval"||w==="filt"||w==="both")return w;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[b,y]=u.useState(null),[f,N]=u.useState(null),[C,k]=u.useState(null),[j,A]=u.useState({kept:0,dropped:0}),[E,q]=u.useState(!1),[z,F]=u.useState(""),[P,B]=u.useState(!1),[L,R]=u.useState(null),[x,T]=u.useState(!1),[I,Y]=u.useState(!1),[,W]=u.useState(0),K=()=>W(w=>w+1),X=u.useRef([]),Q=u.useRef(new Set),pe=u.useRef(new Set),[te,ge]=u.useState([]),[_,se]=u.useState([]),[ue,Le]=u.useState(0),ee=u.useRef(new Map),de=u.useRef(null),{mode:he}=c,ie=u.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),G=ie.pipe,ae=c.session.token||"",oe=he==="client"&&!e;u.useEffect(()=>{if(!ae||!G)return;let w=!0;const D=async()=>{const Z=await Ii(ae);!w||!Z||(se(Z.runs),Le(Date.now()/1e3-Z.now),ge(je=>je.filter(Ne=>!Z.runs.some(et=>Pe(et.company)===Pe(Ne.name)))))};D();const M=te.length>0||_.some(Z=>Z.status==="running"),$=window.setInterval(()=>{D()},M?8e3:25e3);return()=>{w=!1,window.clearInterval($)}},[ae,G,te.length,_.some(w=>w.status==="running")]);const xe=u.useMemo(()=>{const w=[],D=new Set;for(const M of te){const $=Pe(M.name);!$||D.has($)||(D.add($),w.push({name:M.name,id:M.id,status:"boot",started:M.started,estMin:M.estMin,memoType:"instant"}))}for(const M of _){const $=Pe(M.company);if(!$||D.has($))continue;D.add($);const Z=M.status==="error"?"error":M.status==="done"?"done":"running";w.push({name:M.company,status:Z,started:M.started||0,estMin:M.est_min||(M.memo_type==="detailed"?40:15),url:M.url,error:M.error,memoType:M.memo_type})}return w},[te,_]),Ee=w=>xe.find(D=>Pe(D.name)===Pe(w))||null,ne=(w,D)=>{ge(M=>M.some($=>Pe($.name)===Pe(w.name))?M:[...M,{name:w.name,id:w.id,started:Date.now()/1e3,estMin:D==="detailed"?40:15}]),Q.current.add(w.id),K()};u.useEffect(()=>{if(document.querySelector(`link[href="${zr}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=zr,document.head.appendChild(w)},[]);const ce=(w,D=!1)=>{F(w),B(D),de.current&&clearTimeout(de.current),de.current=setTimeout(()=>F(""),D?4200:2400)},Ie=w=>ce(w,!0),qe=u.useMemo(()=>{const w=new Map;return c.dossiers.forEach(D=>{D.id&&w.set(D.id,D)}),w},[c.dossiers]),Me=u.useMemo(()=>c.dossiers.filter(w=>$r(w,g,G)),[c.dossiers,g,G]),Ce=u.useRef(!1);u.useEffect(()=>{if(Ce.current||e||c.loading||!c.dossiers.length)return;if(!ie.showFunnel||Vd(c.session.token||"")){Ce.current=!0;return}Ce.current=!0;const w=window.setTimeout(()=>{Ar(c.session.token||""),T(!0)},700);return()=>window.clearTimeout(w)},[e,c.loading,c.dossiers.length,ie.showFunnel,c.session.token]);const be=u.useMemo(()=>c.dossiers.filter(w=>ps(w,g,G,c.favIds)),[c.dossiers,g,G,c.favIds]),Ve=u.useMemo(()=>Ri(Me,c.favIds),[Me,c.favIds]),Re=u.useRef(!1);u.useEffect(()=>{if(Re.current)return;if(!G||a==="ops"){Re.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Re.current=!0;return}if(c.loading)return;Re.current=!0;const w=Fi(Ve);w!==g.ptab&&s({type:"ptab",tab:w})},[G,a,n==null?void 0:n.ptab,c.loading,Ve,g.ptab]);const st=u.useMemo(()=>{const w=Yr(c.dossiers);return w?ct(w)===0?l.tourToday:Gr(w,d):l.tourNoRun},[c.dossiers,l,d]),pt=u.useMemo(()=>c.dossiers.some(w=>!!w.memoUrl||!!w.summary||Ft(w)),[c.dossiers]),[xt,tt]=u.useState(!1);u.useEffect(()=>{if(c.loading){tt(!1);return}if(c.dossiers.length>0||c.error){tt(!0);return}const w=window.setTimeout(()=>tt(!0),6e3);return()=>window.clearTimeout(w)},[c.loading,c.dossiers.length,c.error]);const gt=(c.marketEstimate||0)>0||typeof((re=c.stats)==null?void 0:re.screened)=="number"&&c.stats.screened>0,bt=u.useMemo(()=>[1,0,2,4,5,3].find(w=>(Ve[w]||0)>0)??0,[Ve]),Je=gn.find(w=>w.key===g.continent),ut=g.continent==="monde"?l.contWorld:(d==="fr"?Je==null?void 0:Je.fr:Je==null?void 0:Je.en)||"";u.useEffect(()=>{const w=D=>{var $;const M=((($=D.detail)==null?void 0:$.name)||"").trim();M&&vt(null,M)};return window.addEventListener("ppmap:evaluate",w),()=>window.removeEventListener("ppmap:evaluate",w)}),u.useEffect(()=>{const w=D=>{const M=D.detail||{},$=String(M.id||"").trim(),Z=String(M.name||"").trim(),je=String(M.url||"").trim(),Ne=$&&qe.get($)||Bd(c.dossiers,Z,je);if(Ne){if(N(null),G){const ve=ze(Ne);typeof ve=="number"&&ve!==g.ptab&&s({type:"ptab",tab:ve})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Ne.id}),(Ne.noCo||["media","nominations","recrutements"].includes(Ne.engine||""))&&(Ne.url||Ne.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ne.url||"",text:[Ne.headline,Ne.tagline].filter(Boolean).join(`
`)}})):Ne.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ne.name,url:Ne.url||"",website:Ne.website||"",domain:Ne.domain||""}}));return}!Z&&!je||(s({type:"focus",id:$||null}),N({name:Z,headline:String(M.text||"").trim()||Z,url:je,card:M.card}),je&&(wa(Z)||!Z)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:je,text:String(M.text||"").trim()}})):Z&&!wa(Z)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Z}})))};return window.addEventListener("ppmap:focus",w),()=>window.removeEventListener("ppmap:focus",w)}),u.useEffect(()=>{const w=$=>{const Z={},je=String(($==null?void 0:$.sector)||"").trim();je&&(Z.sector=[je]);const Ne=String(($==null?void 0:$.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ne)&&(Z.day=Ne);const et=String(($==null?void 0:$.search)||"").trim();et&&(Z.search=et);const ve=String(($==null?void 0:$.dealKind)||"").trim();(ve==="ma"||ve==="levee"||ve==="other")&&(Z.dealKind=[ve]),Object.keys(Z).length&&s({type:"filters",patch:Z})},D=$=>w($.detail),M=$=>{$.data&&$.data.type==="pp-filter"&&w($.data)};return window.addEventListener("ppmap:filter",D),window.addEventListener("message",M),()=>{window.removeEventListener("ppmap:filter",D),window.removeEventListener("message",M)}},[]),u.useEffect(()=>{const w=D=>{var Z;const M=(((Z=D.detail)==null?void 0:Z.name)||"").trim().toLowerCase();if(!M)return;const $=c.dossiers.find(je=>(je.name||"").trim().toLowerCase()===M);$&&s(a==="ops"?{type:"focus",id:$.id}:{type:"popup",id:$.id})};return window.addEventListener("ppmap:similar",w),()=>window.removeEventListener("ppmap:similar",w)});const vt=(w,D)=>{const M=((w==null?void 0:w.name)||D||"").trim();if(!oe){k({kicker:M});return}!M||E||(q(!0),(async()=>{try{let $=M;const Z=((w==null?void 0:w.website)||(w==null?void 0:w.domain)||"").trim();if(Z)$=Z;else try{const ve=await Mr(M);if(ve!=null&&ve.website)$=ve.website;else if(((ve==null?void 0:ve.candidates)||[]).length===1)$=ve.candidates[0].url;else if(((ve==null?void 0:ve.candidates)||[]).length>1){X.current=[{name:M,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(ve.candidates||[]).slice(0,5)},...X.current].slice(0,8),K();return}}catch{}const je=await Or(ae,$,"atelier2"),Ne={name:je.company||M,verdict:je.verdict,reason:je.reason||"",remaining:je.remaining??null};X.current=[Ne,...X.current].slice(0,8),je.verdict==="kept"&&A(ve=>({...ve,kept:ve.kept+1})),je.verdict==="ruled_out"&&A(ve=>({...ve,dropped:ve.dropped+1}));const et=w||c.dossiers.find(ve=>(ve.name||"").toLowerCase()===M.toLowerCase());et&&(je.verdict==="kept"?et.verdict=et.verdict||"MATCH":je.verdict==="ruled_out"&&(et.verdict="NO MATCH"),je.reason&&(et.reasoning=je.reason)),K()}finally{q(!1)}})())},S=w=>{if(!oe){k({kicker:w.name});return}ne(w,"instant"),Ut(ae,"fast_request",w.name||"",""),ce(l.memoInstantSent(w.name))},U=w=>ee.current.get(w.id)??c.thumbs.get((w.name||"").trim().toLowerCase()),H=(w,D)=>s({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:D}}),le=async(w,D,M)=>{const $=w.ceoStatus||"";w.ceoStatus=D,K();const Z=await Da(ae,{status:D,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(M==null?void 0:M.note)!==void 0?{note:M.note}:{},...M!=null&&M.via?{via:M.via}:{}});return Z.ok?Z.skipped?(w.ceoStatus=$,K(),Ie(l.actNotPersisted),!1):((M==null?void 0:M.undo)!==!1&&H(w,$),M!=null&&M.msg&&ce(M.msg),(D==="Validé"||D==="Écarté")&&!w.ceoNote&&(M==null?void 0:M.note)===void 0&&R({o:w,yes:D==="Validé"}),!0):(w.ceoStatus=$,K(),Ie(l.actErr),!1)},we=async(w,D)=>{const M=await Da(ae,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:D,via:"note"});return!M.ok||M.skipped?(Ie(M.skipped?l.actNotPersisted:l.actErr),!1):(w.ceoNote=D,K(),!0)},me=u.useRef(new Map),ke=w=>me.current.has(w.id)?me.current.get(w.id):c.stages.get((w.name||"").trim().toLowerCase()),Xe=(w,D)=>{me.current.set(w.id,D),K()},yt=(w,D)=>{oe&&le(w,D?"Validé":"Écarté",{msg:D?l.decidedYes(w.name):l.decidedNo(w.name)})},mt=w=>{oe&&le(w,"À trancher",{msg:l.promoted(w.name)})},Bt=w=>{oe&&(async()=>{const D=w.ceoStatus||"";w.ceoStatus="Retenu",K();const M=await Da(ae,{status:"Retenu",check_id:w.checkId,company:w.name});if(!M.ok||M.skipped){w.ceoStatus=D,K(),Ie(M.skipped?l.actNotPersisted:l.actErr);return}H(w,D),ce(l.repeched(w.name))})()},Tt=()=>{const w=g.undo[g.undo.length-1];if(!w){ce(l.undoNone);return}const D=qe.get(w.id);if(!D){s({type:"undoPop"}),ce(l.undoNone);return}let M=w.prevCeoStatus;if(!M)if((D.verdict||"").toUpperCase().includes("CALL"))M="À trancher";else{ce(l.undoLockedTitle);return}(async()=>await le(D,M,{undo:!1})&&(s({type:"undoPop"}),D.ceoStatus=w.prevCeoStatus,K(),ce(l.undoDone(D.name))))()},Oe=w=>{oe&&(pe.current.add(w.id),K(),(async()=>{const D=await Bi(ae,w.name,"email");if(!D||D.ok===!1){pe.current.delete(w.id),K(),Ie(l.actErr);return}Ut(ae,"approach",w.name||"",""),ce(l.actApproachSent)})())},De=(w,D)=>{oe&&(async()=>{if(!(await Ut(ae,D?"yes":"no",w.name||"","")).ok){Ie(l.actErr);return}ee.current.set(w.id,D?"yes":"no"),K(),ce(D?l.thumbUpDone:l.thumbDnDone)})()},Ze=w=>{!oe||!Ft(w)||(ne(w,"detailed"),Ut(ae,"detailed_request",w.name||"",""),ce(l.memoDeepSent(w.name)))},$t=w=>{const D=new Set(c.favIds),M=D.has(w.id);M?D.delete(w.id):D.add(w.id),c.setFavIds(D),oe&&$i(ae,{id:w.id,co:w.name},M)},_t=()=>{!oe||I||window.confirm(l.identSyncConfirm)&&(Y(!0),(async()=>{const w=await _i(ae);Y(!1),w?ce(l.identSyncDone):Ie(l.actErr)})())},ra=/proplace/i.test(c.fund||""),Fa=w=>{!oe||!ra||(Ut(ae,"onboard_request",w.name||"",""),ce(l.onboardSent(w.name)))},O={st:g,dispatch:s,t:l,lang:d,mode:he,caps:ie,pipe:G,token:ae,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:Bt,thumbOf:U,canWrite:oe,commitStatus:le,saveNote:we,stageOf:ke,setStage:Xe,flashErr:Ie,startTour:()=>T(!0),dossiers:c.dossiers,scopedAll:Me,scoped:be,counts:Ve,byId:qe,contName:ut,favIds:c.favIds,toggleFav:$t,askEvaluate:vt,doAnalyse:S,doDecide:yt,doPromote:mt,doApproach:Oe,doThumb:De,doDeep:Ze,doUndo:Tt,doSync:_t,doOnboard:Fa,outbound:ra,memoQueued:Q.current,liveMemos:{items:xe,serverOff:ue,liveOf:Ee},approachDone:pe.current,sessTally:j,evalCards:X.current,evalBusy:E,markRow:y,markedId:b,flash:ce,focusExtra:f};u.useEffect(()=>{const w=D=>{D.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]);const J=w=>ae?t.jsx(fs,{token:ae,children:w}):t.jsx(t.Fragment,{children:w});return t.jsx(jo.Provider,{value:O,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ae?" cibles":"")+" chrome-"+v,children:[t.jsx("style",{children:Zi}),J(t.jsxs("div",{className:"app"+(G?" pipe":"")+(ae?" has-thesis":""),children:[ie.showTicker&&t.jsx(at,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ae?" live-stack--cibles":""),children:[t.jsx(ws,{}),!!ae&&t.jsx(hs,{})]})}),ie.showIdent&&t.jsx(at,{name:"identite",children:t.jsx(Ls,{})}),!1,Ud,ie.showFunnel&&t.jsx(at,{name:"entonnoir",children:t.jsx(Yd,{})}),!g.mapFolded&&t.jsx(at,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(ho,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx($d,{}),a!=="ops"&&ie.showFunnel&&t.jsx(_d,{}),t.jsx(Tl,{}),t.jsx(fo,{})]})]})}),ie.showDemand&&G&&t.jsx(at,{name:"direct",children:t.jsx(Yi,{items:xe,serverOff:ue,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([w,D])=>t.jsx("button",{type:"button",role:"tab","aria-selected":v===w,onClick:()=>{m(w);try{localStorage.setItem("atl2:chrome-mode",w)}catch{}},children:D},w))}),ie.showDemand&&t.jsx(at,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Dl,{})})}),ie.showDemand&&g.memoConsole&&t.jsx(at,{name:"console",children:t.jsx(Il,{})}),t.jsx(at,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(cd,{})}),c.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:l.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(at,{name:"fiche",children:t.jsx(Yl,{})}),t.jsx(at,{name:"modales",children:t.jsx(bd,{})}),t.jsx(Ns,{}),L&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:L.o.name}),t.jsx(zs,{placeholder:L.yes?l.whyYesPh:l.whyNoPh,onDone:w=>{const D=L.o;R(null),w&&we(D,w).then(M=>{M&&ce(l.csNoteSaved)})}})]}),x&&xt&&t.jsx(Ts,{steps:Wd(l,st,pt,bt,gt),onClose:()=>{T(!1),Ar(ae)}}),t.jsx(Hd,{}),ie.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:Vr,children:yn}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),z&&t.jsx("div",{className:"flash on"+(P?" err":""),children:z}),C&&t.jsx(Mi,{variant:"acquirer",initialCompany:Tr().co,initialWebsite:Tr().site,onClose:()=>k(null)})]})})}function Yd(){const{t:e}=V(),[a,r]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Tr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Gd(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{No as FlagCell,ft as SigBadge,Ra as SigWin,Jd as default,Gd as fmtShort,V as useV2};
