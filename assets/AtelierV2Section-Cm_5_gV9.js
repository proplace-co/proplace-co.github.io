...
.atl2:has(> .lockbar.on) .listhead{top:calc(var(--pp-gap,60px) + 90px)}
...
/* ── LES FILTRES ESSENTIELS RESTENT SOUS LA MAIN, CARTE REPLIÉE (17/08 :
   « les filtres essentiels doivent être sticky, oui prends celle qui est quand
   la carte n'est pas affichée »). Carte repliée, la zone se réduit à ce qui
   sert : continents, périodes, facettes, recherche — une bande basse qu'on peut
   coller sans rien manger. Carte DÉPLIÉE on ne colle rien : 300 px de
   planisphère épinglés en haut, ce serait pire que le problème.
   Le rang 33 la met au-dessus de la liste et sous la barre d'aperçu (40). */
/* Carte repliée : les filtres ont déménagé dans .listhead — on ne colle
   plus la zone carte (elle ne porte plus que les continents). */
.atl2 .app > .fzone:has(.stage.folded){position:static;box-shadow:none}
.atl2 .app:has(.stage.folded) .listhead{top:calc(var(--pp-gap,60px) + 44px)}
.atl2:has(> .lockbar.on) .app:has(.stage.folded) .listhead{
  top:calc(var(--pp-gap,60px) + 90px)}
...
.atl2 .fstrip{flex:1 0 100%;display:flex;flex-direction:column;gap:8px;
...
.atl2 .fstrip-a .seg button{flex:0 1 auto;min-width:0;display:inline-flex;
  align-items:center;gap:6px;padding:7px 10px;font-size:11px;
  border:1px solid var(--line);border-radius:var(--r);background:var(--panel);
  cursor:pointer;white-space:nowrap}
.atl2 .fstrip-a .seg button[aria-pressed="true"]{border-color:var(--ink);
  background:var(--ink);color:#fff}
.atl2 .fstrip-a .seg button b{font-family:var(--mono);font-size:11px}
...
.atl2 .fstrip .frow2{margin-left:auto}
...
/* Carte repliée : continents + dates + facettes = UNE bande, dans l'en-tête
   de liste. Plus de fzone fantôme, plus de second « Afficher la carte ». */
.atl2 .fstrip{flex:1 1 100%;width:100%;display:flex;flex-direction:column;
  gap:6px;padding:6px 0 2px;border-top:1px solid var(--line);margin-top:6px}
.atl2 .fstrip-a,.atl2 .fstrip-b{display:flex;align-items:center;gap:8px;
  flex-wrap:wrap;min-width:0}
.atl2 .fstrip .conts{flex:1 1 auto;min-width:0;background:transparent;
  border:0;overflow-x:auto;scrollbar-width:none}
.atl2 .fstrip .conts::-webkit-scrollbar{display:none}
.atl2 .fstrip .conts .cbtn{padding:6px 9px;font-size:12px}
.atl2 .fstrip .conts .side button{border-left:0;padding:0 10px;font-size:11px}
.atl2 .fstrip .seg{display:inline-flex;flex:none;width:auto;gap:0;
  border:1px solid var(--line);border-radius:var(--r);overflow:hidden;
  background:var(--panel)}
.atl2 .fstrip .seg button{border:0;border-right:1px solid var(--line);
  border-radius:0;height:28px;padding:0 9px;background:transparent;
  font-size:11px}
.atl2 .fstrip .seg button:last-child{border-right:0}
.atl2 .fstrip .seg button[aria-pressed="true"]{background:var(--panel3);
  font-weight:700}
.atl2 .fstrip .facets{display:flex;flex-wrap:wrap;gap:5px}
.atl2 .fstrip .fsrch{flex:0 1 160px;min-width:120px}
...
`,ji=wi+ki;function ka(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ni(){const e=ka("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Si(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ni();return r==="0"?"client":r==="1"||ka("embed")==="1"&&ka("chrome")==="1"?"apercu":"client"}const Ei={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ci=e=>Ei[e];function Ai(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Xe=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!tr(a)||Ai(a))&&(e.noCo=!0)}return Object.assign(e,{continent:ho(e.cc)})};function ca(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Ti=60*60*1e3;function zi(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ti?null:a}catch{return null}}function Mt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const qi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Li(e,a,r="default"){const n=r!=="default",i=f.useMemo(()=>e||n?{mode:"anon"}:io(),[e,n]),o=f.useMemo(()=>n?"visiteur":Si(e,i),[e,i,n]),s=f.useMemo(()=>Ci(o),[o]),l=o!=="visiteur",d=qi(r),[x,c]=f.useState([]),[m,u]=f.useState(""),[b,p]=f.useState(null),[g,v]=f.useState(null),[h,E]=f.useState(null),[j,y]=f.useState(()=>new Map),[z,R]=f.useState(()=>new Map),[q,S]=f.useState(""),[A,N]=f.useState(new Set),[w,M]=f.useState(null),[_,C]=f.useState(!0),[T,O]=f.useState(!1),[U,W]=f.useState(0),[H,Q]=f.useState(0),Y=f.useRef(0),J=f.useMemo(()=>{var Z;if(o!=="client")return"";try{return((Z=so())==null?void 0:Z.email)||""}catch{return""}},[o]);f.useEffect(()=>{const Z=++Y.current;let me=!0;const he=()=>me&&Z===Y.current,fe=(l&&i.token?i.token:"pub:"+a)+(d?":"+d:""),X=zi(fe);return X?(c(X.objs.map(Xe)),X.fund&&u(X.fund),p(X.marketEstimate??null),v(X.criteria??null),E(X.stats??null),S(X.generatedAt||""),C(!1)):C(!0),(async()=>{try{if(r==="ops"){const oe=await ia(),ee=((oe==null?void 0:oe.recent_ops)||[]).map(V=>{const G=sa(V.company_name||V.title?V:{...V,title:(V.headline_fr||V.headline||"").slice(0,120)},a),ge=String(V.rubrique||"").toLowerCase();return G&&(ge==="nominations"||ge==="recrutements")&&(G.engine=ge),G&&!String(V.company_name||"").trim()&&(G.noCo=!0),G}).filter(V=>!!V).map(V=>(tr((V.name||"").trim())||(V.noCo=!0),V));try{const V=await lo(),G=co(V),ge=((V==null?void 0:V.date)||"").slice(0,10);if(G.length&&ge){const L=new Set;for(const F of ee){if(F.noCo||(F.date||"").slice(0,10)!==ge)continue;const $=an(G,L,F.name,"");$>=0&&(L.add($),F.decryptHtml=G[$].html)}for(const F of ee){if(F.decryptHtml||(F.date||"").slice(0,10)!==ge)continue;const $=an(G,L,"",F.headline||F.tagline||F.name);$>=0&&(L.add($),F.decryptHtml=G[$].html)}}}catch{}if(!he())return;c(ee.map(Xe)),Mt(fe,{objs:ee})}else if(typeof r=="object"){const ee=(await nn()||[]).filter(G=>(G.slug||"")===r.research).map(G=>rn(G,a)).filter(G=>!!G),V=ca(await on(ee,a));if(!he())return;c(V.map(Xe)),Mt(fe,{objs:V})}else if(l&&i.token){const oe=po(i.token),ee=ia(),V=uo(i.token),G=mo(i.token),ge=fo(i.token),L=await oe;let F=L?L.targets:[];he()&&L&&(u(L.fund||""),p(L.marketEstimate??null),v(L.criteria??null),E(L.stats??null),S(L.generatedAt||""),c(F.map(Xe)),C(!1),O(!1));const[$,K,se,te]=await Promise.all([ee,V,G,ge]),le=(($==null?void 0:$.recent_ops)||[]).map(pe=>sa(pe,a)).filter(pe=>!!pe);if(F=[...F,...le],!he())return;c(F.map(Xe));const Le=new Set;for(const pe of K){const Te=(pe.id||pe.co||"").toString().trim().toLowerCase();Te&&Le.add(Te.startsWith("t:")?Te:"t:"+Te)}N(Le),y(se),R(te),L&&Mt(fe,{fund:L.fund,marketEstimate:L.marketEstimate,criteria:L.criteria,stats:L.stats,generatedAt:L.generatedAt,objs:F})}else{const oe=xo(),ee=nn(),V=ia(),G=await oe;he()&&G.length&&(c(ca(G).map(Xe)),C(!1),O(!1));const[ge,L]=await Promise.all([ee,V]),F=(ge||[]).map(te=>rn(te,a)).filter(te=>!!te),$=await on(F,a),K=((L==null?void 0:L.recent_ops)||[]).map(te=>sa(te,a)).filter(te=>!!te),se=ca([...G,...$,...K]);if(!he())return;c(se.map(Xe)),Mt(fe,{objs:se})}he()&&O(!1)}catch{he()&&!X&&O(!0)}finally{he()&&C(!1)}})(),()=>{me=!1}},[l,i.token,a,U,d]),f.useEffect(()=>{if(!s.showCredits||!J){M(null);return}let Z=!0;return(async()=>{try{const me=await fetch(`${Da}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:J})});if(!me.ok)return;const he=await me.json();Z&&he&&he.ok!==!1&&M(he)}catch{}})(),()=>{Z=!1}},[s.showCredits,J,H]);const re=f.useCallback(Z=>N(new Set(Z)),[]);return{session:i,mode:o,caps:s,fund:m,email:J,marketEstimate:b,generatedAt:q,criteria:g,stats:h,thumbs:j,stages:z,dossiers:x,favIds:A,setFavIds:re,credits:w,reloadCredits:()=>Q(Z=>Z+1),loading:_,error:T,refresh:()=>W(Z=>Z+1)}}const or=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ri=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...or(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Mi=new Set(["signal","amount","score","crible","memo"]);function Oi(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:or(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Mi.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??ir)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const ir=40;function Ua(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!je(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ia(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(Ke(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&et(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function sr(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ua(e,a.filters,r)}function Fi(e,a,r,n){return!(!sr(e,a,r)||r&&!go(e,a.ptab,n))}function Va(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-Ke(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return vo(i);case"memo":return bo(i);case"signal":{const o=je(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const s=n(i),l=n(o);return s<l?-a.dir:s>l?a.dir:(i.name||"").localeCompare(o.name||"")})}const Pi=["ma","levees","nominations","recrutements","actualites"],Di=300,da=7,Ii={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},lr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},$i=["hiring","raised","news","posting","building","community","registry","exodus","other"];function fn(e){const a=je(e);if(a)return"sig:"+(a.theme&&lr.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Bi(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:s,fund:l}=I(),d=s==="en",[x,c]=f.useState("all"),[m,u]=f.useState(!1),b=f.useMemo(()=>{const w=(a.filters.day||"").slice(0,10),M=O=>{if(!o&&a.continent!=="monde"&&O.continent!==a.continent||w&&(O.date||"").slice(0,10)!==w)return!1;if(o&&O.kind==="op"){const U=(l||"").trim().toLowerCase();if(!U)return!1;const W=O.match||null;if(!W||!Object.keys(W).map(Q=>Q.trim().toLowerCase()).includes(U))return!1}return!0},_=e.filter(O=>M(O)&&je(O)&&(!o||O.kind!=="target"||ye(O)!==5)),C=e.filter(O=>M(O)&&O.kind==="op"&&!je(O)&&(w?!0:Ke(O.date)<=da)),T=w||new Date().toISOString().slice(0,10);return C.sort((O,U)=>{const W=(O.date||"").slice(0,10)===T?0:1,H=(U.date||"").slice(0,10)===T?0:1;return W!==H?W-H:(U.amountEur||0)-(O.amountEur||0)}),[...Va(_,{key:"signal",dir:-1}),...C]},[e,a.continent,a.filters.day,o,l]),p=f.useMemo(()=>{const w={};for(const M of b){const _=fn(M);w[_]=(w[_]||0)+1}return w},[b]),g=f.useMemo(()=>x==="all"?b:b.filter(w=>fn(w)===x),[b,x]),v=f.useMemo(()=>g.slice(0,Di),[g]),h=g.length-v.length,E=f.useRef(null);f.useEffect(()=>{var O,U;const w=E.current;if(!w)return;const M=()=>{const W=w.scrollWidth;W<200||(w.style.animationDuration=Math.max(18,Math.round(W/130))+"s")};M();const _=requestAnimationFrame(M),C=window.setTimeout(M,1200);let T=!0;return(U=(O=document.fonts)==null?void 0:O.ready)==null||U.then(()=>{T&&M()}),()=>{T=!1,cancelAnimationFrame(_),window.clearTimeout(C)}},[v.length,x]);const j=w=>w==="all"?b.length:p[w]||0,y=w=>w==="all"?d?"All":"Tout":w.startsWith("sig:")?lr[d?"en":"fr"][w.slice(4)]||"🔔":Ii[d?"en":"fr"][w],z=[{k:"all"}],R=Pi.filter(w=>j(w)>0||w===x);if(R.length){z.push({g:d?"DEALS":"OPÉRATIONS"});for(const w of R)z.push({k:w})}const q=$i.map(w=>"sig:"+w).filter(w=>j(w)>0||w===x);if(q.length){z.push({g:d?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const w of q)z.push({k:w})}const S=w=>{try{return new Date(w+"T12:00:00Z").toLocaleDateString(d?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return w}},A=(()=>{const w=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?d?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return w?(d?`LIVE covers the events of ${S(w)}.`:`Le LIVE regroupe les événements du ${S(w)}.`)+M:(d?`LIVE covers the still-open signals and the deals of the last ${da} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${da} derniers jours.`)+M})(),N=w=>v.map(M=>t.jsxs("button",{type:"button",className:"tk"+(qe(M)?" spent":""),onClick:_=>{const C=_.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:C.left+C.width/2,y:C.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(rt,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(_r,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:fc(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(aa,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},w+(M.id||M.name))).concat(h>0?[t.jsx("span",{className:"tk quiet",children:d?`+ ${h} more — filter by section to see them`:`+ ${h} autres — filtrez par rubrique pour les voir`},w+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:w=>{w.currentTarget.contains(w.relatedTarget)||u(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":m,onClick:()=>u(w=>!w),children:[y(x),t.jsx("b",{children:j(x)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!m,children:[t.jsx("span",{className:"tkfilscope",children:A}),z.map(w=>"g"in w?t.jsx("span",{className:"tkfilg",children:w.g},w.g):t.jsxs("button",{type:"button","aria-pressed":w.k===x,onClick:()=>{c(w.k),u(!1)},children:[y(w.k),t.jsx("b",{children:j(w.k)})]},w.k))]})]}),t.jsx("div",{className:"win",children:v.length?t.jsxs("div",{className:"run",ref:E,children:[N(0),N(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const _i="aDx8z7Hzksus",Ha="+33 6 83 10 72 86",Ht="alexandre@proplace.co",cr=`tel:${Ha.replace(/[^\d+]/g,"")}`,xn="pp-rdv-slot";function Ui(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Vi(){const{t:e,caps:a,fund:r}=I();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:Wi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:cr,children:Ha}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Ht}`,children:Ht})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],s)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(s+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(mi,{filloutId:_i,parameters:r?{company_name:r}:void 0})})]})}function Hi(){const[e,a]=f.useState(()=>typeof document>"u"?null:document.getElementById(xn));return f.useEffect(()=>{e||a(document.getElementById(xn))},[e]),e?ut.createPortal(t.jsx(Vi,{}),e):null}const Wi=`
...
`;class Ee extends f.Component{constructor(){super(...arguments);en(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const pa=600,Ze=62,hn="atl2:fstats";function Yi(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=I(),[s,l]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(hn)==="on"}catch{return!1}}),d=r.stats,x=f.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),c=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const m=z=>a==="en"?z.slice(5,10):`${z.slice(8,10)}/${z.slice(5,7)}`,u=z=>z.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((z,R)=>Math.max(z,R.s||0),0),p=x.length?pa/x.length:0,g=Math.max(4,p-4),v=x.length>=5&&b>0,h=r.marketEstimate||0,E=m(new Date().toISOString().slice(0,10)),j=z=>[...typeof z=="number"?[[z,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],y=[];return typeof d.screened_window=="number"&&c&&y.push({cle:"fenetre",periode:e.funPerWindow(m(c),E),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:j(d.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[y.map(z=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:z.periode}),z.etapes.map(([R,q],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(R)}),t.jsx("i",{children:q})]},z.cle+q)),z.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((d.screened||0)/h*100)))})]}),z.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const R=!s;l(R),R&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(hn,R?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},z.cle)),s&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${pa} ${Ze}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((z,R)=>{const q=(z.s||0)/b*(Ze-4),S=(z.m||0)/b*(Ze-4),A=R*p+(p-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(z.d)} — ${z.s} ${e.actScreened} · ${z.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:Ze-2-q,width:g,height:q,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:Ze-2-S,width:g,height:S,fill:"#185c38"})]},z.d)}),t.jsx("line",{x1:0,y1:Ze-1.5,x2:pa,y2:Ze-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const dr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Gi(e,a){if((Qe(e)||"").startsWith("CALL")&&ye(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ye(e)>=2;return dr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function Ki({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:s}=I(),[l,d]=f.useState(!1),[x,c]=f.useState(""),[m,u]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),p=async g=>{if(x)return;if(g==="Analysé"&&!e.memoUrl){u(!0);return}c(g);const v=await i(e,g);c(""),v&&(d(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:g=>g.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(g=>!g),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),l&&t.jsx("span",{className:"rstm",children:m?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{o(e),u(!1),d(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const g=await i(e,"Analysé");c(""),g&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]}):Gi(e,a).map(([g,v])=>t.jsx("button",{type:"button",className:"rsti"+(b===g?" on":"")+(x===g?" busy":""),disabled:!!x,onClick:()=>{p(g)},children:v},g))})]})}function Qi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=I(),[o,s]=f.useState(""),[l,d]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),c=(Qe(e)||"").startsWith("CALL")&&ye(e)===3,m=ye(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(p);const g=await i(e,p);s(""),g&&(d(!0),setTimeout(()=>d(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:dr.filter(([p])=>!(m&&p==="Retenu")).map(([p,g])=>[p,a[g]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,g])=>t.jsx("button",{type:"button",className:"csb"+(x===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:g},p)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Ji,{o:e})]})}function Ji({o:e}){const{t:a,saveNote:r,flash:n}=I(),[i,o]=f.useState(e.ceoNote||""),[s,l]=f.useState(!1),[d,x]=f.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(s||!c)return;l(!0);const u=await r(e,i.trim());l(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:s,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:s||!c,onClick:()=>{m()},children:d?a.csNoteSaved:a.csNoteOk})]})}function Xi({placeholder:e,onDone:a}){const{t:r}=I(),[n,i]=f.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Zi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:s,flashErr:l}=I(),[d,x]=f.useState(!1);if(!n.pipe||!i||n.lockActions||ye(e)!==4)return null;const c=o(e),m=(c==null?void 0:c.stage)||"todo",u=async h=>{if(d||h===m)return;x(!0);const E=c;s(e,{stage:h,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),gn+=1);gn=j;const y=await yo(r,{company:e.name||"",stage:h,cts:j,deal_id:e.airtableId,check_id:e.checkId});x(!1),!y.stale&&(y.ok||(s(e,E),l(a.actErr)))},b=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=m==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,E])=>t.jsx("button",{type:"button",className:"stgb"+(m===h?" on":""),disabled:d,onClick:()=>{u(h)},children:E},h)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let gn=0;const Ot=8,Ft=360;function bn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function vn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(bn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(bn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function es({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=I(),[s,l]=f.useState(0),[d,x]=f.useState(null),[c,m]=f.useState([]),u=f.useRef(!1),b=f.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=f.useRef(!1);f.useEffect(()=>{const q=b.current;return()=>{p.current||(n({type:"ptab",tab:q.ptab}),n({type:"dens",dens:q.dens}),n({type:"modal",modal:q.modal}))}},[]),f.useEffect(()=>{u.current||(u.current=!0,m(e.filter(q=>!!document.querySelector(q.need||q.sel))))},[e]);const g=c[s],v=s>=c.length;f.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const q=g.click,S=window.setTimeout(()=>{const A=document.querySelector(q);A&&A.getAttribute("aria-selected")!=="true"&&A.click()},60);return()=>window.clearTimeout(S)}},[s,g]);const h=f.useRef(-1),E=f.useCallback(()=>{if(!g){x(null);return}const q=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!q){x(null);return}h.current!==s&&(h.current=s,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=q.getBoundingClientRect();x(A=>A&&Math.abs(A.top-S.top)<1&&Math.abs(A.left-S.left)<1&&Math.abs(A.width-S.width)<1&&Math.abs(A.height-S.height)<1?A:S)},[g,s]);f.useLayoutEffect(()=>{E();const q=[90,300,700,1300].map(A=>window.setTimeout(E,A)),S=()=>E();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{q.forEach(A=>window.clearTimeout(A)),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[E]);const j=f.useRef(a);if(j.current=a,f.useEffect(()=>{const q=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),j.current()):S.key==="ArrowRight"?l(A=>A+1):S.key==="ArrowLeft"&&l(A=>Math.max(0,A-1))};return document.addEventListener("keydown",q,!0),()=>document.removeEventListener("keydown",q,!0)},[]),!c.length)return null;let y=null;const z=q=>()=>{p.current=!0,n({type:"modal",modal:null}),q()};if(v){const q=i[3]||0;q>0?y={title:q===1?r.ahaATitle1:r.ahaATitleN(q),body:r.ahaABody,btn:r.ahaABtn,go:z(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:z(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:z(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:z(()=>{n({type:"modal",modal:"crit"}),a()})}}let R={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Ft};if(!v&&d){const q=d.bottom+14,A=window.innerHeight-q>190?q:Math.max(12,d.top-200);R={left:Math.min(Math.max(12,d.left+d.width/2-Ft/2),window.innerWidth-Ft-12),top:A,width:Ft}}return ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Ot,top:d.top-Ot,width:d.width+Ot*2,height:d.height+Ot*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:R,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(vn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(vn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>l(q=>Math.max(0,q-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(q=>q+1),children:s===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function pr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function ur(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ts(){var S,A;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:s,data:l,dispatch:d}=I(),x=r?a:e,c=f.useMemo(()=>x.filter(N=>Ke(N.date)===0&&N.kind==="target"),[x]),m=f.useMemo(()=>r?a.filter(N=>N.kind==="target"&&ye(N)===0).slice().sort((N,w)=>(w.date||"").localeCompare(N.date||"")):[],[a,r]),u=f.useMemo(()=>c.filter(N=>r?ye(N)===0:!qe(N)),[c,r]),b=r?m:u,p=r?a.length-m.length:c.length-u.length,g=r?a.length:c.length,v=g?Math.min(100,p/g*100):100,h=f.useMemo(()=>pr(x),[x]),E=!!h&&Ke(h)>0,j=f.useMemo(()=>E?x.filter(N=>(N.date||"").slice(0,10)===h):[],[x,h,E]),y=typeof((S=l.stats)==null?void 0:S.kept_today)=="number"?l.stats.kept_today:null,z=typeof((A=l.stats)==null?void 0:A.screened_today)=="number"?l.stats.screened_today:c.length;let R;E?R=i.morningLast(j.length,m.length,ur(h,s)):r?R=i.morningThesis(z,m.length,y):c.length?p===0?R=i.goalSourced(c.length):p>=c.length?R=i.goalCleared:R=i.goalDone(p,c.length):R=i.goalSourced(0);const q=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&m.length&&d({type:"chainStart",queue:m.map(N=>N.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:R}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:q,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function as(){var U,W;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:s,dossiers:l,mode:d,doSync:x,startTour:c,flash:m,flashErr:u}=I(),[b,p]=f.useState(null),[g,v]=f.useState(!0),[h,E]=f.useState([]),j=d==="client";f.useEffect(()=>{if(!i||!o)return;let H=!0;return v(!0),(async()=>{const[Q,Y]=await Promise.all([$a(o),ar(i)]);H&&(Q&&p(Q),v(!1),E(Y))})(),()=>{H=!1}},[i,o]);const[y,z]=f.useState(!1),R=()=>{!j||y||!o||(z(!0),wo(o).then(H=>{z(!1),H?m(e.identRepubDone):u(e.actErr)}))},q=(b==null?void 0:b.per_day)??null,S=((U=b==null?void 0:b.pool_order)==null?void 0:U.length)??0,A=h.filter(H=>H.status==="running").length,N=f.useMemo(()=>l.filter(H=>H.kind==="target"&&qe(H)).length,[l]),w=s.marketEstimate,M=typeof((W=s.stats)==null?void 0:W.screened)=="number"?s.stats.screened:N,_=w&&w>0?Math.min(100,Math.round(M/w*100)):null,C=H=>H.toLocaleString(a==="en"?"en-US":"fr-FR"),T=(o||"P").split(/\s+/).map(H=>H[0]).join("").slice(0,2).toUpperCase(),O=(()=>{const H=Date.parse(s.generatedAt||"");if(Number.isNaN(H))return"";const Q=new Date(H),Y=J=>String(J).padStart(2,"0");return`${Y(Q.getDate())}/${Y(Q.getMonth()+1)} à ${Y(Q.getHours())}:${Y(Q.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?T:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),O?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(O)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[_===null&&M>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:C(M)})})]}),_!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:_+"%"}})}),t.jsxs("b",{children:[_," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(M,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),q!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:q})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),q===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),A>0&&t.jsxs("span",{className:"ev",children:["⏳ ",A]}),t.jsx("span",{className:"ego",children:g?e.identPendingWait:e.identPending(S)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:H=>{H.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||y,onClick:R,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:H=>n({type:"filters",patch:{search:H.target.value}})})]})]})]})}function ns(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:s}=I(),l=o.loading&&!s.length,d=f.useRef({});f.useEffect(()=>{d.current={...r}},[r]);const x=u=>{const b=d.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${ga[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},c=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${ga[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,p,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(l?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[c(5,!1,n.plabels[5]),c(7,!0,n.plabels[7]),c(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function rs(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:s}=I(),l=f.useRef(null),[d,x]=f.useState(60);f.useEffect(()=>{let p=0;const g=()=>{var y;const v=l.current;if(!v)return;const h=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!h)return;const E=h.getBoundingClientRect(),j=v.getBoundingClientRect();x(Math.max(20,Math.min(E.left+E.width/2-j.left,j.width-30)))};return p=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",g)}},[e.ptab]);const c=e.ptab;let m=r.tuto[c].p;if(c===3){const p=n.filter(h=>h.kind==="target"&&ye(h)===3),g=p.filter(h=>ba(h)==="auto").length,v=p.filter(h=>ba(h)==="cd").length;m=r.tutoPending(g,v,p.length)}const u=(()=>{if(s!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(c===1){const p=n.filter(g=>g.kind==="target"&&ye(g)===1&&!i.has(g.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(g=>g.id)})}}return null})(),b=ko(c);return t.jsxs("div",{ref:l,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${ga[c]})`,"--ax":d+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class at{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],s=a+o,l=Math.abs(a)<Math.abs(o)?a-(s-o):o-(s-a);l&&(r[n++]=l),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,i=a[--r],s=n+i,o=i-(s-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=s+i,i==n-s&&(s=n))}return s}}function*os(e){for(const a of e)yield*a}function mr(e){return Array.from(os(e))}var ce=1e-6,ae=Math.PI,Fe=ae/2,yn=ae/4,De=ae*2,He=180/ae,ze=ae/180,ue=Math.abs,is=Math.atan,kt=Math.atan2,be=Math.cos,ve=Math.sin,ss=Math.sign||function(e){return e>0?1:e<0?-1:0},ot=Math.sqrt;function ls(e){return e>1?0:e<-1?ae:Math.acos(e)}function jt(e){return e>1?Fe:e<-1?-Fe:Math.asin(e)}function Pe(){}function Wt(e,a){e&&kn.hasOwnProperty(e.type)&&kn[e.type](e,a)}var wn={Feature:function(e,a){Wt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Wt(r[n].geometry,a)}},kn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ja(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ja(r[n],a,0)},Polygon:function(e,a){jn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)jn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Wt(r[n],a)}};function ja(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function jn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ja(e[r],a,1);a.polygonEnd()}function it(e,a){e&&wn.hasOwnProperty(e.type)?wn[e.type](e,a):Wt(e,a)}function Na(e){return[kt(e[1],e[0]),jt(e[2])]}function dt(e){var a=e[0],r=e[1],n=be(r);return[n*be(a),n*ve(a),ve(r)]}function Pt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Yt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ua(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Dt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Sa(e){var a=ot(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Ea(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Ca(e,a){return ue(e)>ae&&(e-=Math.round(e/De)*De),[e,a]}Ca.invert=Ca;function cs(e,a,r){return(e%=De)?a||r?Ea(Sn(e),En(a,r)):Sn(e):a||r?En(a,r):Ca}function Nn(e){return function(a,r){return a+=e,ue(a)>ae&&(a-=Math.round(a/De)*De),[a,r]}}function Sn(e){var a=Nn(e);return a.invert=Nn(-e),a}function En(e,a){var r=be(e),n=ve(e),i=be(a),o=ve(a);function s(l,d){var x=be(d),c=be(l)*x,m=ve(l)*x,u=ve(d),b=u*r+c*n;return[kt(m*i-b*o,c*r-u*n),jt(b*i+m*o)]}return s.invert=function(l,d){var x=be(d),c=be(l)*x,m=ve(l)*x,u=ve(d),b=u*i-m*o;return[kt(m*i+u*o,c*r+b*n),jt(b*r-c*n)]},s}function ds(e,a,r,n,i,o){if(r){var s=be(a),l=ve(a),d=n*r;i==null?(i=a+n*De,o=a-d/2):(i=Cn(s,i),o=Cn(s,o),(n>0?i<o:i>o)&&(i+=n*De));for(var x,c=i;n>0?c>o:c<o;c-=d)x=Na([s,-l*be(c),-l*ve(c)]),e.point(x[0],x[1])}}function Cn(e,a){a=dt(a),a[0]-=e,Sa(a);var r=ls(-a[1]);return((-a[2]<0?-r:r)+De-ce)%De}function fr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Pe,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ut(e,a){return ue(e[0]-a[0])<ce&&ue(e[1]-a[1])<ce}function It(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function xr(e,a,r,n,i){var o=[],s=[],l,d;if(e.forEach(function(p){if(!((g=p.length-1)<=0)){var g,v=p[0],h=p[g],E;if(Ut(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),l=0;l<g;++l)i.point((v=p[l])[0],v[1]);i.lineEnd();return}h[0]+=2*ce}o.push(E=new It(v,p,null,!0)),s.push(E.o=new It(v,null,E,!1)),o.push(E=new It(h,p,null,!1)),s.push(E.o=new It(h,null,E,!0))}}),!!o.length){for(s.sort(a),An(o),An(s),l=0,d=s.length;l<d;++l)s[l].e=r=!r;for(var x=o[0],c,m;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;c=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,d=c.length;l<d;++l)i.point((m=c[l])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(c=u.p.z,l=c.length-1;l>=0;--l)i.point((m=c[l])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);i.lineEnd()}}}function An(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function ma(e){return ue(e[0])<=ae?e[0]:ss(e[0])*((ue(e[0])+ae)%De-ae)}function ps(e,a){var r=ma(a),n=a[1],i=ve(n),o=[ve(r),-be(r),0],s=0,l=0,d=new at;i===1?n=Fe+ce:i===-1&&(n=-Fe-ce);for(var x=0,c=e.length;x<c;++x)if(u=(m=e[x]).length)for(var m,u,b=m[u-1],p=ma(b),g=b[1]/2+yn,v=ve(g),h=be(g),E=0;E<u;++E,p=y,v=R,h=q,b=j){var j=m[E],y=ma(j),z=j[1]/2+yn,R=ve(z),q=be(z),S=y-p,A=S>=0?1:-1,N=A*S,w=N>ae,M=v*R;if(d.add(kt(M*A*ve(N),h*q+M*be(N))),s+=w?S+A*De:S,w^p>=r^y>=r){var _=Yt(dt(b),dt(j));Sa(_);var C=Yt(o,_);Sa(C);var T=(w^S>=0?-1:1)*jt(C[2]);(n>T||n===T&&(_[0]||_[1]))&&(l+=w^S>=0?1:-1)}}return(s<-ce||s<ce&&d<-1e-12)^l&1}function hr(e,a,r,n){return function(i){var o=a(i),s=fr(),l=a(s),d=!1,x,c,m,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=h,u.lineStart=E,u.lineEnd=j,c=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,c=mr(c);var y=ps(x,n);c.length?(d||(i.polygonStart(),d=!0),xr(c,ms,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),c=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,z){e(y,z)&&i.point(y,z)}function p(y,z){o.point(y,z)}function g(){u.point=p,o.lineStart()}function v(){u.point=b,o.lineEnd()}function h(y,z){m.push([y,z]),l.point(y,z)}function E(){l.lineStart(),m=[]}function j(){h(m[0][0],m[0][1]),l.lineEnd();var y=l.clean(),z=s.result(),R,q=z.length,S,A,N;if(m.pop(),x.push(m),m=null,!!q){if(y&1){if(A=z[0],(S=A.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),R=0;R<S;++R)i.point((N=A[R])[0],N[1]);i.lineEnd()}return}q>1&&y&2&&z.push(z.pop().concat(z.shift())),c.push(z.filter(us))}}return u}}function us(e){return e.length>1}function ms(e,a){return((e=e.x)[0]<0?e[1]-Fe-ce:Fe-e[1])-((a=a.x)[0]<0?a[1]-Fe-ce:Fe-a[1])}const Tn=hr(function(){return!0},fs,hs,[-ae,-Fe]);function fs(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,s){var l=o>0?ae:-ae,d=ue(o-a);ue(d-ae)<ce?(e.point(a,r=(r+s)/2>0?Fe:-Fe),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(o,r),i=0):n!==l&&d>=ae&&(ue(a-n)<ce&&(a-=n*ce),ue(o-l)<ce&&(o-=l*ce),r=xs(a,r,o,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),i=0),e.point(a=o,r=s),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function xs(e,a,r,n){var i,o,s=ve(e-r);return ue(s)>ce?is((ve(a)*(o=be(n))*ve(r)-ve(n)*(i=be(a))*ve(e))/(i*o*s)):(a+n)/2}function hs(e,a,r,n){var i;if(e==null)i=r*Fe,n.point(-ae,i),n.point(0,i),n.point(ae,i),n.point(ae,0),n.point(ae,-i),n.point(0,-i),n.point(-ae,-i),n.point(-ae,0),n.point(-ae,i);else if(ue(e[0]-a[0])>ce){var o=e[0]<a[0]?ae:-ae;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function gs(e){var a=be(e),r=2*ze,n=a>0,i=ue(a)>ce;function o(c,m,u,b){ds(b,e,r,u,c,m)}function s(c,m){return be(c)*be(m)>a}function l(c){var m,u,b,p,g;return{lineStart:function(){p=b=!1,g=1},point:function(v,h){var E=[v,h],j,y=s(v,h),z=n?y?0:x(v,h):y?x(v+(v<0?ae:-ae),h):0;if(!m&&(p=b=y)&&c.lineStart(),y!==b&&(j=d(m,E),(!j||Ut(m,j)||Ut(E,j))&&(E[2]=1)),y!==b)g=0,y?(c.lineStart(),j=d(E,m),c.point(j[0],j[1])):(j=d(m,E),c.point(j[0],j[1],2),c.lineEnd()),m=j;else if(i&&m&&n^y){var R;!(z&u)&&(R=d(E,m,!0))&&(g=0,n?(c.lineStart(),c.point(R[0][0],R[0][1]),c.point(R[1][0],R[1][1]),c.lineEnd()):(c.point(R[1][0],R[1][1]),c.lineEnd(),c.lineStart(),c.point(R[0][0],R[0][1],3)))}y&&(!m||!Ut(m,E))&&c.point(E[0],E[1]),m=E,b=y,u=z},lineEnd:function(){b&&c.lineEnd(),m=null},clean:function(){return g|(p&&b)<<1}}}function d(c,m,u){var b=dt(c),p=dt(m),g=[1,0,0],v=Yt(b,p),h=Pt(v,v),E=v[0],j=h-E*E;if(!j)return!u&&c;var y=a*h/j,z=-a*E/j,R=Yt(g,v),q=Dt(g,y),S=Dt(v,z);ua(q,S);var A=R,N=Pt(q,A),w=Pt(A,A),M=N*N-w*(Pt(q,q)-1);if(!(M<0)){var _=ot(M),C=Dt(A,(-N-_)/w);if(ua(C,q),C=Na(C),!u)return C;var T=c[0],O=m[0],U=c[1],W=m[1],H;O<T&&(H=T,T=O,O=H);var Q=O-T,Y=ue(Q-ae)<ce,J=Y||Q<ce;if(!Y&&W<U&&(H=U,U=W,W=H),J?Y?U+W>0^C[1]<(ue(C[0]-T)<ce?U:W):U<=C[1]&&C[1]<=W:Q>ae^(T<=C[0]&&C[0]<=O)){var re=Dt(A,(-N+_)/w);return ua(re,q),[C,Na(re)]}}}function x(c,m){var u=n?e:ae-e,b=0;return c<-u?b|=1:c>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return hr(s,l,o,n?[0,-e]:[-ae,e-ae])}function bs(e,a,r,n,i,o){var s=e[0],l=e[1],d=a[0],x=a[1],c=0,m=1,u=d-s,b=x-l,p;if(p=r-s,!(!u&&p>0)){if(p/=u,u<0){if(p<c)return;p<m&&(m=p)}else if(u>0){if(p>m)return;p>c&&(c=p)}if(p=i-s,!(!u&&p<0)){if(p/=u,u<0){if(p>m)return;p>c&&(c=p)}else if(u>0){if(p<c)return;p<m&&(m=p)}if(p=n-l,!(!b&&p>0)){if(p/=b,b<0){if(p<c)return;p<m&&(m=p)}else if(b>0){if(p>m)return;p>c&&(c=p)}if(p=o-l,!(!b&&p<0)){if(p/=b,b<0){if(p>m)return;p>c&&(c=p)}else if(b>0){if(p<c)return;p<m&&(m=p)}return c>0&&(e[0]=s+c*u,e[1]=l+c*b),m<1&&(a[0]=s+m*u,a[1]=l+m*b),!0}}}}}var ht=1e9,$t=-ht;function vs(e,a,r,n){function i(x,c){return e<=x&&x<=r&&a<=c&&c<=n}function o(x,c,m,u){var b=0,p=0;if(x==null||(b=s(x,m))!==(p=s(c,m))||d(x,c)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==p);else u.point(c[0],c[1])}function s(x,c){return ue(x[0]-e)<ce?c>0?0:3:ue(x[0]-r)<ce?c>0?2:1:ue(x[1]-a)<ce?c>0?1:0:c>0?3:2}function l(x,c){return d(x.x,c.x)}function d(x,c){var m=s(x,1),u=s(c,1);return m!==u?m-u:m===0?c[1]-x[1]:m===1?x[0]-c[0]:m===2?x[1]-c[1]:c[0]-x[0]}return function(x){var c=x,m=fr(),u,b,p,g,v,h,E,j,y,z,R,q={point:S,lineStart:M,lineEnd:_,polygonStart:N,polygonEnd:w};function S(T,O){i(T,O)&&c.point(T,O)}function A(){for(var T=0,O=0,U=b.length;O<U;++O)for(var W=b[O],H=1,Q=W.length,Y=W[0],J,re,Z=Y[0],me=Y[1];H<Q;++H)J=Z,re=me,Y=W[H],Z=Y[0],me=Y[1],re<=n?me>n&&(Z-J)*(n-re)>(me-re)*(e-J)&&++T:me<=n&&(Z-J)*(n-re)<(me-re)*(e-J)&&--T;return T}function N(){c=m,u=[],b=[],R=!0}function w(){var T=A(),O=R&&T,U=(u=mr(u)).length;(O||U)&&(x.polygonStart(),O&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),U&&xr(u,l,T,o,x),x.polygonEnd()),c=x,u=b=p=null}function M(){q.point=C,b&&b.push(p=[]),z=!0,y=!1,E=j=NaN}function _(){u&&(C(g,v),h&&y&&m.rejoin(),u.push(m.result())),q.point=S,y&&c.lineEnd()}function C(T,O){var U=i(T,O);if(b&&p.push([T,O]),z)g=T,v=O,h=U,z=!1,U&&(c.lineStart(),c.point(T,O));else if(U&&y)c.point(T,O);else{var W=[E=Math.max($t,Math.min(ht,E)),j=Math.max($t,Math.min(ht,j))],H=[T=Math.max($t,Math.min(ht,T)),O=Math.max($t,Math.min(ht,O))];bs(W,H,e,a,r,n)?(y||(c.lineStart(),c.point(W[0],W[1])),c.point(H[0],H[1]),U||c.lineEnd(),R=!1):U&&(c.lineStart(),c.point(T,O),R=!1)}E=T,j=O,y=U}return q}}const Aa=e=>e;var fa=new at,Ta=new at,gr,br,za,qa,Ye={point:Pe,lineStart:Pe,lineEnd:Pe,polygonStart:function(){Ye.lineStart=ys,Ye.lineEnd=ks},polygonEnd:function(){Ye.lineStart=Ye.lineEnd=Ye.point=Pe,fa.add(ue(Ta)),Ta=new at},result:function(){var e=fa/2;return fa=new at,e}};function ys(){Ye.point=ws}function ws(e,a){Ye.point=vr,gr=za=e,br=qa=a}function vr(e,a){Ta.add(qa*e-za*a),za=e,qa=a}function ks(){vr(gr,br)}var pt=1/0,Gt=pt,Nt=-pt,Kt=Nt,Qt={point:js,lineStart:Pe,lineEnd:Pe,polygonStart:Pe,polygonEnd:Pe,result:function(){var e=[[pt,Gt],[Nt,Kt]];return Nt=Kt=-(Gt=pt=1/0),e}};function js(e,a){e<pt&&(pt=e),e>Nt&&(Nt=e),a<Gt&&(Gt=a),a>Kt&&(Kt=a)}var La=0,Ra=0,gt=0,Jt=0,Xt=0,st=0,Ma=0,Oa=0,bt=0,yr,wr,Be,_e,Oe={point:nt,lineStart:zn,lineEnd:qn,polygonStart:function(){Oe.lineStart=Es,Oe.lineEnd=Cs},polygonEnd:function(){Oe.point=nt,Oe.lineStart=zn,Oe.lineEnd=qn},result:function(){var e=bt?[Ma/bt,Oa/bt]:st?[Jt/st,Xt/st]:gt?[La/gt,Ra/gt]:[NaN,NaN];return La=Ra=gt=Jt=Xt=st=Ma=Oa=bt=0,e}};function nt(e,a){La+=e,Ra+=a,++gt}function zn(){Oe.point=Ns}function Ns(e,a){Oe.point=Ss,nt(Be=e,_e=a)}function Ss(e,a){var r=e-Be,n=a-_e,i=ot(r*r+n*n);Jt+=i*(Be+e)/2,Xt+=i*(_e+a)/2,st+=i,nt(Be=e,_e=a)}function qn(){Oe.point=nt}function Es(){Oe.point=As}function Cs(){kr(yr,wr)}function As(e,a){Oe.point=kr,nt(yr=Be=e,wr=_e=a)}function kr(e,a){var r=e-Be,n=a-_e,i=ot(r*r+n*n);Jt+=i*(Be+e)/2,Xt+=i*(_e+a)/2,st+=i,i=_e*e-Be*a,Ma+=i*(Be+e),Oa+=i*(_e+a),bt+=i*3,nt(Be=e,_e=a)}function jr(e){this._context=e}jr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,De);break}}},result:Pe};var Fa=new at,xa,Nr,Sr,vt,yt,St={point:Pe,lineStart:function(){St.point=Ts},lineEnd:function(){xa&&Er(Nr,Sr),St.point=Pe},polygonStart:function(){xa=!0},polygonEnd:function(){xa=null},result:function(){var e=+Fa;return Fa=new at,e}};function Ts(e,a){St.point=Er,Nr=vt=e,Sr=yt=a}function Er(e,a){vt-=e,yt-=a,Fa.add(ot(vt*vt+yt*yt)),vt=e,yt=a}let Ln,Zt,Rn,Mn;class On{constructor(a){this._append=a==null?Cr:zs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Rn||this._append!==Zt){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Rn=n,Zt=this._append,Mn=this._,this._=i}this._+=Mn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Cr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function zs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Cr;if(a!==Ln){const r=10**a;Ln=a,Zt=function(i){let o=1;this._+=i[0];for(const s=i.length;o<s;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Zt}function qs(e,a){let r=3,n=4.5,i,o;function s(l){return l&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),it(l,i(o))),o.result()}return s.area=function(l){return it(l,i(Ye)),Ye.result()},s.measure=function(l){return it(l,i(St)),St.result()},s.bounds=function(l){return it(l,i(Qt)),Qt.result()},s.centroid=function(l){return it(l,i(Oe)),Oe.result()},s.projection=function(l){return arguments.length?(i=l==null?(e=null,Aa):(e=l).stream,s):e},s.context=function(l){return arguments.length?(o=l==null?(a=null,new On(r)):new jr(a=l),typeof n!="function"&&o.pointRadius(n),s):a},s.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(o.pointRadius(+l),+l),s):n},s.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const d=Math.floor(l);if(!(d>=0))throw new RangeError(`invalid digits: ${l}`);r=d}return a===null&&(o=new On(r)),s},s.projection(e).digits(r).context(a)}function Wa(e){return function(a){var r=new Pa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Pa(){}Pa.prototype={constructor:Pa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ya(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),it(r,e.stream(Qt)),a(Qt.result()),n!=null&&e.clipExtent(n),e}function Ar(e,a,r){return Ya(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],s=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),l=+a[0][0]+(i-s*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([l,d])},r)}function Ls(e,a,r){return Ar(e,[[0,0],a],r)}function Rs(e,a,r){return Ya(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),s=(i-o*(n[1][0]+n[0][0]))/2,l=-o*n[0][1];e.scale(150*o).translate([s,l])},r)}function Ms(e,a,r){return Ya(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),s=-o*n[0][0],l=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([s,l])},r)}var Fn=16,Os=be(30*ze);function Pn(e,a){return+a?Ps(e,a):Fs(e)}function Fs(e){return Wa({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Ps(e,a){function r(n,i,o,s,l,d,x,c,m,u,b,p,g,v){var h=x-n,E=c-i,j=h*h+E*E;if(j>4*a&&g--){var y=s+u,z=l+b,R=d+p,q=ot(y*y+z*z+R*R),S=jt(R/=q),A=ue(ue(R)-1)<ce||ue(o-m)<ce?(o+m)/2:kt(z,y),N=e(A,S),w=N[0],M=N[1],_=w-n,C=M-i,T=E*_-h*C;(T*T/j>a||ue((h*_+E*C)/j-.5)>.3||s*u+l*b+d*p<Os)&&(r(n,i,o,s,l,d,w,M,A,y/=q,z/=q,R,g,v),v.point(w,M),r(w,M,A,y,z,R,x,c,m,u,b,p,g,v))}}return function(n){var i,o,s,l,d,x,c,m,u,b,p,g,v={point:h,lineStart:E,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=z},polygonEnd:function(){n.polygonEnd(),v.lineStart=E}};function h(S,A){S=e(S,A),n.point(S[0],S[1])}function E(){m=NaN,v.point=j,n.lineStart()}function j(S,A){var N=dt([S,A]),w=e(S,A);r(m,u,c,b,p,g,m=w[0],u=w[1],c=S,b=N[0],p=N[1],g=N[2],Fn,n),n.point(m,u)}function y(){v.point=h,n.lineEnd()}function z(){E(),v.point=R,v.lineEnd=q}function R(S,A){j(i=S,A),o=m,s=u,l=b,d=p,x=g,v.point=j}function q(){r(m,u,c,b,p,g,o,s,i,l,d,x,Fn,n),v.lineEnd=y,y()}return v}}var Ds=Wa({point:function(e,a){this.stream.point(e*ze,a*ze)}});function Is(e){return Wa({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function $s(e,a,r,n,i){function o(s,l){return s*=n,l*=i,[a+e*s,r-e*l]}return o.invert=function(s,l){return[(s-a)/e*n,(r-l)/e*i]},o}function Dn(e,a,r,n,i,o){if(!o)return $s(e,a,r,n,i);var s=be(o),l=ve(o),d=s*e,x=l*e,c=s/e,m=l/e,u=(l*r-s*a)/e,b=(l*a+s*r)/e;function p(g,v){return g*=n,v*=i,[d*g-x*v+a,r-x*g-d*v]}return p.invert=function(g,v){return[n*(c*g-m*v+u),i*(b-m*g-c*v)]},p}function Bs(e){return _s(function(){return e})()}function _s(e){var a,r=150,n=480,i=250,o=0,s=0,l=0,d=0,x=0,c,m=0,u=1,b=1,p=null,g=Tn,v=null,h,E,j,y=Aa,z=.5,R,q,S,A,N;function w(T){return S(T[0]*ze,T[1]*ze)}function M(T){return T=S.invert(T[0],T[1]),T&&[T[0]*He,T[1]*He]}w.stream=function(T){return A&&N===T?A:A=Ds(Is(c)(g(R(y(N=T)))))},w.preclip=function(T){return arguments.length?(g=T,p=void 0,C()):g},w.postclip=function(T){return arguments.length?(y=T,v=h=E=j=null,C()):y},w.clipAngle=function(T){return arguments.length?(g=+T?gs(p=T*ze):(p=null,Tn),C()):p*He},w.clipExtent=function(T){return arguments.length?(y=T==null?(v=h=E=j=null,Aa):vs(v=+T[0][0],h=+T[0][1],E=+T[1][0],j=+T[1][1]),C()):v==null?null:[[v,h],[E,j]]},w.scale=function(T){return arguments.length?(r=+T,_()):r},w.translate=function(T){return arguments.length?(n=+T[0],i=+T[1],_()):[n,i]},w.center=function(T){return arguments.length?(o=T[0]%360*ze,s=T[1]%360*ze,_()):[o*He,s*He]},w.rotate=function(T){return arguments.length?(l=T[0]%360*ze,d=T[1]%360*ze,x=T.length>2?T[2]%360*ze:0,_()):[l*He,d*He,x*He]},w.angle=function(T){return arguments.length?(m=T%360*ze,_()):m*He},w.reflectX=function(T){return arguments.length?(u=T?-1:1,_()):u<0},w.reflectY=function(T){return arguments.length?(b=T?-1:1,_()):b<0},w.precision=function(T){return arguments.length?(R=Pn(q,z=T*T),C()):ot(z)},w.fitExtent=function(T,O){return Ar(w,T,O)},w.fitSize=function(T,O){return Ls(w,T,O)},w.fitWidth=function(T,O){return Rs(w,T,O)},w.fitHeight=function(T,O){return Ms(w,T,O)};function _(){var T=Dn(r,0,0,u,b,m).apply(null,a(o,s)),O=Dn(r,n-T[0],i-T[1],u,b,m);return c=cs(l,d,x),q=Ea(a,O),S=Ea(c,q),R=Pn(q,z),C()}function C(){return A=N=null,w}return function(){return a=e.apply(this,arguments),w.invert=a.invert&&M,_()}}function Tr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Tr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,s=o*o;r-=i=(r*(1.007226+o*(.015085+s*(-.044475+.028874*o-.005916*s)))-a)/(1.007226+o*(.015085*3+s*(-.044475*7+.028874*9*o-.005916*11*s)))}while(ue(i)>ce&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function Us(){return Bs(Tr).scale(175.295)}function Vs(e){return e}function Hs(e){if(e==null)return Vs;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],s=e.translate[1];return function(l,d){d||(a=r=0);var x=2,c=l.length,m=new Array(c);for(m[0]=(a+=l[0])*n+o,m[1]=(r+=l[1])*i+s;x<c;)m[x]=l[x],++x;return m}}function Ws(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function Ys(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return In(e,r)})}:In(e,a)}function In(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=Gs(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function Gs(e,a){var r=Hs(e.transform),n=e.arcs;function i(c,m){m.length&&m.pop();for(var u=n[c<0?~c:c],b=0,p=u.length;b<p;++b)m.push(r(u[b],b));c<0&&Ws(m,p)}function o(c){return r(c)}function s(c){for(var m=[],u=0,b=c.length;u<b;++u)i(c[u],m);return m.length<2&&m.push(m[0]),m}function l(c){for(var m=s(c);m.length<4;)m.push(m[0]);return m}function d(c){return c.map(l)}function x(c){var m=c.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:c.geometries.map(x)};case"Point":u=o(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(o);break;case"LineString":u=s(c.arcs);break;case"MultiLineString":u=c.arcs.map(s);break;case"Polygon":u=d(c.arcs);break;case"MultiPolygon":u=c.arcs.map(d);break;default:return null}return{type:m,coordinates:u}}return x(a)}const zr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Ks=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Qs(e,a,r){const n=zr[e];if(!n||!n.length)return-1;const i=Ks(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(s=>i.includes(s)))return o}return Math.floor(r*n.length)%n.length}let Bt=null;function Js(){return Bt||(Bt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=Ys(r,n),o=Us().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=qs(o),l=(i.features||[]).filter(c=>{var m;return(((m=c.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(c=>{var b;const m=((b=c.properties)==null?void 0:b.name)||"",u=s(c)||"";return u?{i2:jo(m)||null,n:m,d:u}:null}).filter(c=>!!c);if(!l.length)return null;const d={};for(const[c,m]of Object.entries(No)){const u=o(m);u&&(d[c]={x:u[0],y:u[1]})}const x={};for(const[c,m]of Object.entries(zr)){const u=m.map(b=>o(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(x[c]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:l,anchors:d,metros:x}}catch{return null}})(),Bt)}function Xs(e){const[a,r]=f.useState(null);return f.useEffect(()=>{if(!e||a)return;let n=!1;return Js().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const Zs={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},$n=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Bn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function el(e,a){const[r,n]=f.useState(1);return f.useEffect(()=>{let i=!0,o=0;const s=()=>{var x;if(!i)return;const d=(x=e.current)==null?void 0:x.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(s)};s();const l=new ResizeObserver(()=>s());return e.current&&l.observe(e.current),window.addEventListener("resize",s),()=>{i=!1,cancelAnimationFrame(o),l.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function _n({msgs:e}){const[a,r]=f.useState(0);f.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],s)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function tl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:s,lang:l,t:d,data:x,dossiers:c}=I(),m=x.loading&&!c.length,u=f.useRef(null),b=f.useRef(null),p=Xs(e.continent==="monde"),g=e.continent==="monde"?p:Ba.find(C=>C.key===e.continent)||null,v=el(u,e.continent+":"+e.mapFolded+":"+!!g),[h,E]=f.useState(new Map),[j,y]=f.useState(null);f.useEffect(()=>{const C=u.current;if(!C)return;const T=new Map;C.querySelectorAll("path[data-i2]").forEach(O=>{const U=O.dataset.i2;if(U)try{const W=O.getBBox();W.width>0&&T.set(U,{x:W.x,y:W.y,w:W.width,h:W.height})}catch{}}),E(T)},[e.continent,v,g]);const z=f.useMemo(()=>r.filter(C=>C.cc),[r]),R=f.useMemo(()=>{const C=new Map;return z.forEach(T=>C.set(T.cc,(C.get(T.cc)||0)+1)),C},[z]),q=e.continent==="monde"&&p?p.anchors:null,S=e.continent==="monde"&&p?p.metros:null,A=f.useMemo(()=>z.map(C=>{const T=Bn(C.name||C.id||""),O=Bn((C.id||C.name||"")+"·y");if(q&&C.cc){const Y=S?S[C.cc]:void 0;if(Y&&Y.length){const re=Qs(C.cc,C.city,T);if(re>=0&&Y[re])return{d:C,x:Y[re].x+(T-.5)*5,y:Y[re].y+(O-.5)*5}}const J=q[C.cc];if(J)return{d:C,x:J.x+(T-.5)*10,y:J.y+(O-.5)*10}}const U=C.cc?h.get(C.cc):void 0;if(!U)return null;const W=Zs[`${e.continent}:${C.cc||""}`];if(W)return{d:C,x:U.x+U.w*(W.fx+(T-.5)*W.sx),y:U.y+U.h*(W.fy+(O-.5)*W.sy)};const H=(T-.5)*Math.min(U.w*.55,60),Q=(O-.5)*Math.min(U.h*.55,60);return{d:C,x:U.x+U.w/2+H,y:U.y+U.h/2+Q}}).filter(C=>!!C),[z,h,q,S,e.continent]),N=C=>v>0?C/v:C,w=f.useMemo(()=>n?[0,1,2,3,4,5].map(C=>({c:$n[C],fr:d.plabels[C].toUpperCase(),en:d.plabels[C].toUpperCase(),n:r.filter(T=>T.kind==="target"&&ye(T)===C).length})).filter(C=>C.n>0):sn.map((C,T)=>({...C,n:r.filter(O=>ln(O)===T).length})),[r,n,d.plabels]),M=o?s.get(o):null,_=M?A.find(C=>C.d.id===M.id):null;return g?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[m&&t.jsx(_n,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":l==="fr"?g.fr:g.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:g.countries.map((C,T)=>t.jsx("g",{className:"ct"+(C.i2&&R.get(C.i2)?"":" empty"),children:t.jsx("path",{d:C.d,"data-i2":C.i2||void 0})},T))}),t.jsx("g",{children:A.map(C=>{const T=sn[ln(C.d)],O=!!je(C.d),U=C.d.kind==="target",W=n&&U?$n[ye(C.d)]:T.c,H=!n&&qe(C.d);return t.jsxs("g",{className:"co"+(H?" done":""),onMouseEnter:()=>{var J,re;const Q=(J=b.current)==null?void 0:J.getBoundingClientRect(),Y=(re=u.current)==null?void 0:re.createSVGPoint();if(Y&&u.current&&Q){Y.x=C.x,Y.y=C.y;const Z=Y.matrixTransform(u.current.getScreenCTM());y({x:Z.x-Q.left,y:Z.y-Q.top,label:C.d.name+" · "+(mt(C.d.cc,l)||C.d.countryLabel||"")})}i(C.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var J;const Q=(J=u.current)==null?void 0:J.createSVGPoint();let Y=null;if(Q&&u.current){Q.x=C.x,Q.y=C.y;const re=Q.matrixTransform(u.current.getScreenCTM());Y={x:re.x,y:re.y}}a({type:"popup",id:C.d.id,anchor:Y})},children:[t.jsx("circle",{className:"h",cx:C.x,cy:C.y,r:N(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:C.x,cy:C.y,r:N(T.px),fill:W,stroke:O?"#DC2626":"#ffffff",strokeWidth:N(O?2.2:1.3)})]},C.d.id||C.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:N(13),fill:"none",stroke:"#0F172A",strokeWidth:N(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:w.map((C,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":C.c}}),l==="fr"?C.fr:C.en," ",t.jsx("b",{children:C.n})]},T))}),r.some(C=>!C.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(C=>!C.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:t.jsx(_n,{msgs:d.loadMsgs})})}function Ga({mapToggle:e=!0}){const{dossiers:a,st:r,dispatch:n,pipe:i,lang:o,t:s}=I(),l=f.useMemo(()=>{const d={};return a.forEach(x=>{Ua(x,r.filters,i)&&(d.monde=(d.monde||0)+1,x.continent&&(d[x.continent]=(d[x.continent]||0)+1))}),d},[a,r.filters,i]);return t.jsxs("div",{className:"conts",children:[So.map(d=>{const x=Ba.find(m=>m.key===d),c=d==="monde"?s.contWorld:o==="fr"?x.fr:x.en;return t.jsxs("button",{type:"button",className:"cbtn","aria-selected":r.continent===d,onClick:()=>n({type:"continent",key:d}),children:[c,t.jsx("span",{className:"n",children:l[d]||0})]},d)}),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!r.mapFolded}),children:r.mapFolded?s.showMap:s.hideMap})})]})}function al(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function qr({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:s,lang:l}=I(),d=a.filters,[x,c]=f.useState(!1),m=f.useRef(null),u=f.useMemo(()=>a.continent==="monde"?n:n.filter(S=>S.continent===a.continent),[n,a.continent]),b=S=>u.filter(A=>S!=="country"&&d.country.length&&!d.country.includes(A.cc||"")?!1:Ua(A,d,o,S==="country"?void 0:S)),p=f.useMemo(()=>{const S=b("win"),A=N=>S.filter(w=>(w.date?Math.max(0,Math.floor((Date.now()-Date.parse(w.date))/864e5)):9999)<=N).length;return[A(0),A(7),A(30),S.length]},[u,d,o]),g=f.useMemo(()=>d.day?b("win").filter(S=>(S.date||"").slice(0,10)===d.day).length:0,[u,d,o]),v=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,h=v+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);f.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),f.useEffect(()=>{if(!x)return;const S=N=>{var w;(w=m.current)!=null&&w.contains(N.target)||c(!1)},A=N=>{N.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",S),document.addEventListener("keydown",A),()=>{document.removeEventListener("mousedown",S),document.removeEventListener("keydown",A)}},[x]);const E=(S,A,N,w="fbtn")=>t.jsxs("button",{type:"button",className:w,"aria-expanded":a.openFacet===S,onClick:()=>r({type:"openFacet",facet:S}),children:[t.jsx("span",{className:"fl",children:A}),N>0&&t.jsx("span",{className:"n",children:N}),t.jsx("span",{className:"cv",children:"▾"})]},S),j=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(al(d.day,l))}),t.jsx("b",{children:g})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((S,A)=>t.jsxs("button",{type:"button","aria-pressed":d.win===S,onClick:()=>r({type:"filters",patch:{win:S}}),children:[t.jsx("span",{className:"sl",children:i.dates[A]}),t.jsx("b",{children:p[A]})]},S))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:S=>r({type:"filters",patch:{search:S.target.value}})})]}),z=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):E("sec",i.fSector,d.sector.length),E("pay",i.fCountry,d.country.length),E("det",i.fEngine,d.engine.length),E("sta",i.fStage,d.stage.length),o&&E("ang","Angle",d.angle.length),o&&E("mem","Mémo",d.memoLevel.length)]}),R=t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn})]}),q=t.jsxs("div",{className:"fmenu",ref:m,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":x,"aria-haspopup":"true",onClick:()=>{c(S=>!S),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:z})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip",children:[t.jsxs("div",{className:"fstrip-a",children:[t.jsx(Ga,{}),j]}),t.jsxs("div",{className:"fstrip-b",children:[y,q,R]})]}),a.openFacet&&t.jsx(Un,{poolFor:b})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[j,y,z,t.jsx("span",{className:"fgrow"}),R]}),a.openFacet&&t.jsx(Un,{poolFor:b})]})}function Un({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=I(),o=a.filters,s=a.openFacet,{title:l,cols:d,options:x}=f.useMemo(()=>{if(s==="sig"){const p=e("signal").filter(h=>je(h)),g=new Map;p.forEach(h=>{const E=h.engine||"";g.set(E,(g.get(E)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...va([...g.keys()],i).map(h=>({v:h,label:tt(h)+" "+Ue(h,i),n:g.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(s==="sec"){const p=e("sector"),g=new Map;return p.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(s==="pay"){const p=e("country"),g=new Map;return p.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:mt(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(s==="det"){const p=e("engine"),g=new Map;return p.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:va([...g.keys()],i).map(v=>({v,label:tt(v)+" "+Ue(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Eo(Co(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(s==="ang"){const p=e("angle"),g=new Map;return p.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(s==="mem"){const p=e("memoLevel"),g=new Map;p.forEach(h=>{if(h.kind==="target"){const E=Ia(h);g.set(E,(g.get(E)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:g.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,g)=>g[1]-p[1]).map(([p,g])=>({v:p,label:p,n:g,html:!1,on:o.stage.includes(p)}))}},[s,a,i]),c=u=>{if(s==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:u})},m=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>c(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Lr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function nl(e){var i;const a=[],r=new Set,n=o=>{const s=(o||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Vn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:s}){const{t:l}=I();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:l.rsEvalOne})]},d.name))})]}):null}function Rr({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=I(),i=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),o=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Vn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Vn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function rl({card:e,onEvaluate:a,onAddAll:r}){var l,d,x;const{t:n}=I(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Lr(e.summary_md||"").map((c,m)=>t.jsx("p",{children:c},m))})]}),t.jsx(Rr,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function ol(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function il({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:s}=I(),l=i,[d,x]=f.useState(null),[c,m]=f.useState(null),[u,b]=f.useState(null),[p,g]=f.useState(!1);f.useEffect(()=>{let h=!0;return(async()=>{const E=await nr({email:s,cbToken:l});h&&x(E)})(),()=>{h=!1}},[s,l,n]);const v=h=>{m(h),b(null),g(!0),(async()=>{const E=await Ao(h.id);b(E),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[ol(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(rl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Hn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function sl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:s,evalBusy:l,evalCards:d,caps:x,data:c,canWrite:m,source:u,dossiers:b,doAnalyse:p,liveMemos:g,pipe:v}=I(),h=a==="client",E=f.useMemo(()=>r||(u!=="default"?To():""),[r,u]),[j,y]=f.useState(""),[z,R]=f.useState(!1),[q,S]=f.useState(""),[A,N]=f.useState(!1),[w,M]=f.useState(""),[_,C]=f.useState([]),T=f.useRef(!1),[O,U]=f.useState(!1),[W,H]=f.useState(""),[Q,Y]=f.useState(""),[J,re]=f.useState(!1),[Z,me]=f.useState(0),[he,fe]=f.useState(""),[X,oe]=f.useState(null),[ee,V]=f.useState(null),[G,ge]=f.useState(!1),[L,F]=f.useState(null),[$,K]=f.useState(0),se=f.useRef(!1),te=j.trim()?Hn.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting,le=f.useMemo(()=>q.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[q]);f.useEffect(()=>{if(typeof window>"u")return;const P=(new URLSearchParams(window.location.search).get("rs")||"").trim();!P||!/^https?:\/\//i.test(P)||(H(P),U(!0))},[]),f.useEffect(()=>{const P=ie=>{var Ne;const de=String(((Ne=ie.detail)==null?void 0:Ne.url)||"").trim();!de||!/^https?:\/\//i.test(de)||(H(de),U(!0))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),f.useEffect(()=>{if(!m&&!E){F(null);return}let P=!0;return(async()=>{const ie=await nr({email:n,cbToken:E});P&&F(ie.length)})(),()=>{P=!1}},[m,E,n,$]);const Le=_.length?_:d,pe=c.credits,Te=f.useCallback(P=>{const ie=P.map(de=>(de||"").trim()).filter(Boolean);ie.length&&(S(de=>{const Ne=de.split(`
`).map(xe=>xe.trim()).filter(Boolean),Ve=new Set(Ne.map(xe=>xe.toLowerCase())),Se=ie.filter(xe=>!Ve.has(xe.toLowerCase()));return[...Ne,...Se].slice(0,15).join(`
`)}),R(!0))},[]);f.useEffect(()=>{if(!J)return;me(0);const P=window.setInterval(()=>me(ie=>ie+1),1e3);return()=>window.clearInterval(P)},[J]);const Ge=f.useMemo(()=>{const P=j.trim().toLowerCase();return!P||!v?null:b.find(ie=>We(ie.name)===P&&ye(ie)===1)||null},[j,b,v]),At=()=>{const P=j.trim();if(P){if(Ge){p(Ge);return}i(null,P),y("")}},ft=async()=>{if(!h){i(null,le[0]||"");return}if(!le.length||A)return;N(!0),T.current=!1;const P=[];for(let ie=0;ie<le.length&&!T.current;ie++){M(e.evaluating(ie+1,le.length,le[ie]));const de=await rr(r,le[ie],"atelier2");if(P.unshift({name:de.company||le[ie],verdict:de.verdict,reason:de.reason||"",remaining:de.remaining??null}),C([...P]),de.verdict==="quota"){P.unshift({name:"",verdict:"quota",reason:e.quota(le.length-ie-1),remaining:0}),C([...P]),S(le.slice(ie+1).join(`
`)),M(""),N(!1);return}}M(""),S(T.current?le.slice(P.length).join(`
`):""),N(!1)},Tt=async()=>{var de,Ne,Ve;if(se.current)return;const P=W.trim().replace(/\s+/g,""),ie=Q.trim();if(!P&&!ie){fe(e.rsNeed);return}if(!h&&!E){i(null,P||ie.slice(0,80));return}se.current=!0,fe(""),oe(null),V(null),re(!0);try{const Se=await qo({url:P,text:ie,email:n,cbToken:E});if(re(!1),!Se||Se.status!=="success"){fe((Se==null?void 0:Se.message)||"Erreur");return}oe(Se),U(!1),Te((((de=Se.prospective)==null?void 0:de.companies_to_evaluate)||[]).map(Re=>(Re==null?void 0:Re.name)||"")),V({state:"pending"});const xe=await Lo(Se,{email:n,cbToken:E});V(xe.ok?{state:"ok",scopeLabel:((Ne=xe.summary)==null?void 0:Ne.scope_label)||"",scope:((Ve=xe.summary)==null?void 0:Ve.scope)||""}:{state:"fail",msg:xe.error||""}),xe.ok&&K(Re=>Re+1)}finally{se.current=!1,re(!1)}},zt=[X==null?void 0:X.industry,...(X==null?void 0:X.market_tags)||[],X==null?void 0:X.author].map(P=>(P||"").trim()).filter(Boolean),Ie=(ee==null?void 0:ee.state)==="pending",na=ee&&(Ie?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):ee.state==="ok"?t.jsx("span",{className:"rslink ok",children:ee.scope&&ee.scope!=="public"?e.rsSavedIn(ee.scopeLabel||ee.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:ee.msg,children:e.rsSaveFail})),qt=nl(X).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:j,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:P=>y(P.target.value),onKeyDown:P=>{P.key==="Enter"&&At()}}),t.jsx("span",{className:"detect"+(Hn.test(j.trim())?" url":""),children:te})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(Ge?" analyse":"")+(l?" loading":""),disabled:l,onClick:At,children:[t.jsx("span",{className:"fill"}),Ge?e.actAnalyse:e.evalGo]}),x.showCredits&&pe&&t.jsxs("button",{type:"button",className:"credits"+(pe.total_available<=0&&!pe.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:pe.unlimited?"∞":pe.total_available}),!pe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",pe.daily_grant+pe.purchased]}),pe.total_available<=0&&!pe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),g.items.filter(P=>P.status==="boot"||P.status==="running").map(P=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:P.name}),t.jsx(wt,{item:P,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>s({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+P.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>R(!z),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(O?" on":""),onClick:()=>U(!O),children:e.rsOpen}),L!==null&&L>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(G?" on":""),onClick:()=>ge(!G),children:e.rsArchOpen(L)})]}),G&&t.jsx(il,{bump:$,cbToken:E,onClose:()=>ge(!1),onEvaluate:P=>i(null,P),onAddAll:Te}),O&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:W,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:P=>H(P.target.value),onKeyDown:P=>{P.key==="Enter"&&Tt()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:Q,placeholder:e.rsTextPh,onChange:P=>Y(P.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(J?" loading":""),style:{justifyContent:"center"},disabled:J||Ie||!W.trim()&&!Q.trim(),onClick:()=>{Tt()},children:[t.jsx("span",{className:"fill"}),J?`${zo(W.trim())==="youtube"&&W.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Z)}`:Ie?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),he&&t.jsx("div",{className:"rserr",children:he}),X&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:X.title}),X.source_url&&t.jsx("a",{href:X.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{oe(null),V(null)},children:"×"})]}),X.market&&t.jsx("p",{className:"rsmk",children:X.market}),zt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),zt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[X.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${X.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Lr(X.summary_md||"").map((P,ie)=>t.jsx("p",{children:P},ie))})]}),t.jsx(Rr,{card:X,onEvaluate:P=>i(null,P),onAddAll:Te}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(qt)}),na]})]}),z&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:q,placeholder:e.bulkPh,onChange:P=>S(P.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(A?" loading":""),style:{justifyContent:"center"},disabled:A||!le.length,onClick:()=>{ft()},children:[t.jsx("span",{className:"fill"}),A&&w?w:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(le.length)})]})]}),Le.slice(0,1).map((P,ie)=>{const de=P.verdict==="kept",Ne=P.verdict==="quota",Ve=de?"var(--brand)":Ne?"var(--bolt)":"var(--red)",Se=de?"var(--brand-l)":Ne?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ve,"--bgc":Se},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:de?"✓ "+e.kept:Ne?"⏳":"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(xe=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:xe.url.startsWith("http")?xe.url:`https://${xe.url}`,target:"_blank",rel:"nofollow noopener",children:[(xe.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,xe.url),children:e.evalPickGo})]},xe.url))}),!Ne&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:de?1:5});const xe=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const Re=[...document.querySelectorAll(".atl2 .list .row")].find(ra=>{var Lt;return(((Lt=ra.querySelector(".rnm"))==null?void 0:Lt.textContent)||"").trim().toLowerCase().includes(xe)});Re&&(Re.scrollIntoView({behavior:"smooth",block:"center"}),Re.classList.add("flashrow"),window.setTimeout(()=>Re.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(de?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ie)}),h&&(o.kept+o.dropped>0||Le.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function ll(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function cl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=I(),o=e.memoConsole?r.get(e.memoConsole):null,s=f.useMemo(()=>o?[o.reasoning||"",ll(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const l=Qe(o),d=Ia(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:s?s.split(`

`).map((x,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[ct(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const ha={},Wn=(ha==null?void 0:ha.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Yn(){return new Date().toISOString().slice(0,10)}const Ka=f.createContext(null);function dl(){return f.useContext(Ka)}function pl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),s=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),l.querySelectorAll("*").forEach(d=>{const x=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(c=>d.removeAttribute(c.name)),x&&/^https?:\/\//i.test(x)&&(d.setAttribute("href",x),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Gn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${o} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${o} ${r[1]}`}function Mr(){const e=f.useContext(Ka);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ul({token:e,children:a}){const{dispatch:r,st:n,lang:i}=I(),[o,s]=f.useState(()=>n.filters.day||Yn()),[l,d]=f.useState(null),[x,c]=f.useState(!1),m=f.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){s(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=f.useCallback(()=>{s(Yn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);f.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),f.useEffect(()=>{const g=v=>{var E;const h=(E=v.detail)==null?void 0:E.day;typeof h=="string"&&m(h)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[m]),f.useEffect(()=>{n.filters.day&&n.filters.day!==o&&s(n.filters.day)},[n.filters.day]),f.useEffect(()=>{if(!e||!o)return;let g=!1;c(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${Wn}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{g||d(h)}).catch(()=>{g||d({ok:!1,error:"network"})}).finally(()=>{g||c(!1)}),()=>{g=!0}},[e,o]);const b=f.useMemo(()=>`${Wn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=f.useMemo(()=>({token:e,day:o,ed:l,loading:x,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,l,x,m,u,n.filters.day,b,i]);return t.jsx(Ka.Provider,{value:p,children:a})}function ml(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Mr(),[i,o]=f.useState(n);return f.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(s=>!s),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Ro,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function fl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Mr(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!s,d=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),l&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:Gn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:Gn(e)}),"."]})}),s&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,s&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}function Or({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=I(),[s,l]=f.useState(!1),[d,x]=f.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const c=async()=>{if(s)return;l(!0);const m=await Mo(r,e);if(l(!1),!m){o(a.actErr);return}x(m.results||[])};return t.jsxs("div",{className:"simb",onClick:m=>m.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{c()},children:s?a.similarBusy:a.similar}),d&&(d.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:d.map(m=>t.jsxs("li",{children:[t.jsx("b",{className:m.verdict==="kept"?"ok":"ko",children:m.company}),m.reason&&t.jsx("span",{children:m.reason})]},m.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const xl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),_t=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function hl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=_t(a.slice(n));break}r+=_t(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=_t(a.slice(i));break}const s=a.slice(i+1,o).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(s),d=l?l[2].toLowerCase():"";l&&xl.has(d)?r+=`<${l[1]}${d}>`:r+=_t(a.slice(i,o+1)),n=o+1}return r}const Kn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ce({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function gl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function bl({o:e}){const{t:a,doDeep:r}=I(),[n,i]=f.useState(!1),o=Qe(e),s=[e.reasoning||"",gl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),s.length?s.join(`

`).split(`

`).map((l,d)=>t.jsx("p",{className:"cdtxt",children:l},d)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[ct(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:l=>{l.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:l=>{l.stopPropagation(),i(d=>!d)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:l=>l.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:l=>l.stopPropagation()})]})}function Fr({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=I(),o=Et(e),s=Qe(e),l=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,c=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),m=f.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.reasoning?1:0)+(s?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:c},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||ct(e)?1:0}].filter(g=>g.n>0),[e,a,l,s,d,x,c]),[u,b]=f.useState("");if(!m.length)return null;const p=m.some(g=>g.k===u)?u:m[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:m.map(g=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===g.k,"data-tour":"tab-"+g.k,className:p===g.k?"on":"",onClick:v=>{v.stopPropagation(),b(g.k)},children:g.lib},g.k))}),t.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[t.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ce,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Ce,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Ce,{k:a.cdVerdictDate,v:Kn(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:hl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(vl,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ce,{k:a.cdSector,v:e.sector}),t.jsx(Ce,{k:a.cdStage,v:e.stage}),t.jsx(Ce,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ce,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Ce,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Ce,{k:a.cdAngle,v:e.angle}),t.jsx(Ce,{k:a.cdDetected,v:Kn(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ce,{k:a.cdName,v:e.contactName}),t.jsx(Ce,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Ce,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(bl,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ce,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Ce,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function vl({o:e}){const{t:a,token:r}=I(),[n,i]=f.useState(!1),[o,s]=f.useState(null),l=async()=>{n||(i(!0),s(await Oo(r,e.name,e.website||e.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},x=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],c=x.some(([,m])=>m);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),o&&c&&t.jsxs(t.Fragment,{children:[x.filter(([,m])=>m).map(([m,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:m}),t.jsx("p",{children:u})]},m)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!c&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function ta({spec:e}){const a=f.useRef(null),r=f.useRef(null),[n,i]=f.useState(!1);return f.useEffect(()=>{const o=a.current;if(!o)return;let s=!1;return cn({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(l=>{!s&&l&&o.isConnected&&o.replaceChildren(l)}),()=>{s=!0,o.replaceChildren()}},[e]),f.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let s=!1;cn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(d=>{!s&&d&&o.isConnected&&o.replaceChildren(d)});const l=d=>{d.key==="Escape"&&i(!1)};return document.addEventListener("keydown",l),()=>{s=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const yl=`
...
`;function wl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let l=e.y+10;return l+n>o-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:s,top:l}}function kl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:s,askEvaluate:l,doAnalyse:d,doDecide:x,doPromote:c,doRepeche:m,doApproach:u,doDeep:b,doOnboard:p,outbound:g,evalBusy:v}=I(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const E=je(h),j=ye(h),y=Qe(h),z=Et(h),R=h.kind==="target",q=S=>{a({type:"filters",patch:S}),a({type:"popup",id:null})};return ut.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:yl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:wl(e.popupAnchor,!!h.card),onClick:S=>S.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(Ke(h.date)),Ue(h.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>q({country:[h.cc]}),children:(mt(h.cc,i)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>q({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>q({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:Ct(h.amountEur,i)})]}),o.pipe&&R&&t.jsxs("div",{className:"pstat",children:[z&&t.jsx("span",{className:"vd "+(z==="MATCH"?"v-ok":"v-no"),title:n.vt[z],children:z}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[tt(h.engine)," ",t.jsx("b",{children:Ue(h.engine,i)})," — ",Fo(h.engine,i),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),E?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(rt,{o:h,lg:!0})," ",t.jsx(aa,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(_a(E,i))," · ",n.win7(Vt(E,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(ta,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),o.pipe&&R&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),o.pipe&&R&&t.jsx(Fr,{o:h})]}),t.jsx(Or,{name:h.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||s!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>l(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(h,!1),a({type:"popup",id:null})},children:n.actNo}),ct(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(h),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),g&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var S;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(S=document.querySelector(".atl2 .demand"))==null||S.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(h.name),onClick:()=>l(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>l(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}const jl=8;function Nl(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:s}=I(),[l,d]=f.useState(!1),[x,c]=f.useState(!1),[m,u]=f.useState(!1),b=`atl2:sincemini:${r||"home"}`,[p,g]=f.useState(()=>{try{return localStorage.getItem(b)==="1"}catch{return!1}}),v=()=>{g(S=>{try{localStorage.setItem(b,S?"0":"1")}catch{}return!S})},h=r||"home",{names:E,verdicts:j}=f.useMemo(()=>{const S=[],A={};return n.forEach(N=>{N.kind!=="target"||!N.name||(S.push(N.name),A[N.name]=Po(N)||"")}),{names:S,verdicts:A}},[n]),y=f.useMemo(()=>E.length?Do(h,E,j,a):null,[h,E.length]);if(!i.pipe||l||!y||y.firstVisit||!y.added.length&&!y.gone.length)return null;const z=x?y.added:y.added.slice(0,jl),R=y.added.length-z.length,q=S=>{const A=n.find(N=>N.name===S);A&&(o(A.id),s({type:"popup",id:A.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(y.added.length,y.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:v,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{d(!0),Io(h,E,j,y.fp,a)},children:"×"})]}),!!y.added.length&&t.jsxs("div",{className:"sg-c",children:[z.map(S=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>q(S),children:t.jsx("b",{children:S})},S)),R>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>c(!0),children:e.sinceMore(R)})]}),!!y.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(S=>!S),children:e.sinceOut(y.gone.length)}),m&&y.gone.slice(0,20).map(S=>t.jsx("span",{className:"gone",children:S},S))]})]})}const Pr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Qa({o:e}){const{t:a}=I(),r=Et(e),n=Qe(e),i=ye(e),o=ba(e),s=$o(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(Pr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:a.waitTitle(s),children:a.waitChip(s)})]})}const ea=e=>e.length>22?e.slice(0,21)+"…":e;function Qn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=I(),[o,s]=f.useState(!1);if(f.useEffect(()=>{n||s(!1)},[n]),qe(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(ea(e.name))})]})}function Dr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:s,doPromote:l,doRepeche:d,doApproach:x,dispatch:c,liveMemos:m}=I();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p=>{p.stopPropagation(),c({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{var g;p.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(g=document.querySelector(".atl2 .demand"))==null||g.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{var g;p.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(g=document.querySelector(".atl2 .demand"))==null||g.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Qn,{o:e})});const u=ye(e),b=p=>g=>{g.stopPropagation(),p()};if(u===0)return t.jsx("span",{className:"cell",children:t.jsx(Qn,{o:e})});if(u===1){const p=m.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(wt,{item:p,serverOff:m.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const g=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:g,onClick:b(()=>o(e)),children:g?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})});if(u===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:b(()=>x(e)),children:p?a.actApproachSent:a.actApproach})})}return u===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):u===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>c({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Sl({o:e}){const{t:a,doThumb:r,thumbOf:n}=I(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function El({o:e}){const{lang:a}=I();return je(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(rt,{o:e}),t.jsx(aa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[tt(e.engine||"")," ",Ue(e.engine||"",a)]})})}function Cl({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:s,markRow:l,markedId:d,favIds:x,toggleFav:c,t:m}=I(),u=ye(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],p=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,g=p<=0?0:p<=7?1:p<=30?2:3,v=s.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:b[g],h=x.has(e.id),E=j=>{if(a)return;if(s.pipe||e.kind==="op"){n();return}const y=j.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:y.left+Math.min(280,y.width/3),y:y.bottom}})};return t.jsxs(f.Fragment,{children:[t.jsxs("div",{className:"row"+(d===e.id||r?" on":"")+(r?" open":"")+(a?" tzr":""),onMouseEnter:()=>l(e.id),onMouseLeave:()=>l(null),onClick:E,children:[t.jsx("span",{className:"pt",style:{"--c":v}}),t.jsx(_r,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[s.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:h?1:.35,padding:0,marginRight:4},onClick:j=>{j.stopPropagation(),c(e)},children:h?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(j=>j&&j!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:j=>{j.stopPropagation(),o({type:"acquirer",value:e.acquirer||""})},children:["← ",ea(e.acquirer)]}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(Al,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(El,{o:e}),s.pipe&&t.jsx(Qa,{o:e}),s.pipe&&!a&&t.jsx(Ki,{o:e}),s.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Dr,{o:e}),s.showThumbs&&t.jsx(Sl,{o:e})]}),r&&!a&&t.jsx(zl,{o:e})]})}function Al({o:e}){const{lang:a,caps:r}=I();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ct(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Tl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=I(),s=(u,b=!1)=>p=>{p.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),d=Ct(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=qe(e),m=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},children:[m?"✓":"✗"," ",t.jsx("b",{children:m?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ea(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ea(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ta,{spec:e.card})})]})}function zl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:s}=I();return!i.pipe&&e.kind==="op"?t.jsx(Tl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Fr,{o:e}),t.jsx(Qi,{o:e}),t.jsx(Zi,{o:e}),t.jsx(Or,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Qa,{o:e})})]}),e.card&&t.jsx(ta,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[tt(e.engine||"")," ",Ue(e.engine||"",r)]}),je(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(rt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function ql({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:s}=I();if(!i.pipe&&e.kind==="op"){const x=Ct(e.amountEur,s),c=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),m=(u,b=!1)=>p=>{p.stopPropagation(),b&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ta,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:m({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:m({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:m({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[tt(e.engine||"")," ",Ue(e.engine||"",s)]}),je(e)&&t.jsx(rt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(c?` · ${c}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Dr,{o:e})})]})}const l=ye(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return t.jsxs("div",{className:"dcard"+(a?" tzr":""),style:{"--c":d},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Qa,{o:e}),je(e)&&t.jsx(rt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&l===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Ll(){const{t:e}=I(),[a,r]=f.useState(0);return f.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Rl({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=I(),o=i==="en",s=c=>n.plabels[c]||"",l=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),d=l.includes(0)?0:l.sort((c,m)=>(e[m]||0)-(e[c]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?o?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:o?`${x} ${x>1?"files":"file"} in “${s(d)}”`:`${x} dossier${x>1?"s":""} dans « ${s(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(o?"Open ":"Ouvrir ")+s(d)," →"]})]})}function Ml(){var G,ge;const e=I(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:s,scopedAll:l,markRow:d,lang:x,sessTally:c,data:m,dossiers:u,source:b}=e,p=i.lockRowsAfter!==null?Number.MAX_SAFE_INTEGER:b==="ops"?8:ir,[g,v]=f.useState(new Set);f.useEffect(()=>{v(new Set)},[a.ptab,a.continent]);const[h,E]=f.useState(null);f.useEffect(()=>{E(null)},[a.ptab,a.continent]);const j=L=>v(F=>{const $=new Set(F);return $.has(L)?$.delete(L):$.add(L),$}),[y,z]=f.useState("all"),[R,q]=f.useState(!1);f.useEffect(()=>{z("all"),q(!1)},[a.ptab,a.continent]),f.useEffect(()=>{if(!R)return;const L=F=>{var $,K;(K=($=F.target)==null?void 0:$.closest)!=null&&K.call($,".atl2 .doable")||q(!1)};return document.addEventListener("click",L),()=>document.removeEventListener("click",L)},[R]);const S=dl(),A=f.useMemo(()=>{var F;const L=new Map;for(const $ of pl(((F=S==null?void 0:S.ed)==null?void 0:F.html)||""))L.has($.t)||L.set($.t,$.html);return L},[(G=S==null?void 0:S.ed)==null?void 0:G.html]),N=f.useCallback(L=>{if(L.decryptHtml)return L.decryptHtml;if(!A.size)return;const F=(L.name||"").trim().toLowerCase();if(F.length<3)return;const $=A.get(F);if($)return $;for(const[K,se]of A)if(K.includes(F)||F.includes(K))return se},[A]),w=f.useMemo(()=>{const L=Va(s,a.sort);return y==="all"?L:L.filter(F=>y==="explore"?!!F.noCo:!F.noCo)},[s,a.sort,b,y]),M=f.useMemo(()=>i.pipe?l.filter(L=>je(L)&&ye(L)>=1):w.filter(L=>je(L)&&!qe(L)),[i.pipe,l,w]),_=M.length,[C,T]=f.useState(!1),[O,U]=f.useState(!1),W=`atl2:sigmini:${((ge=m.session)==null?void 0:ge.token)||"home"}`,[H,Q]=f.useState(()=>{try{return localStorage.getItem(W)==="1"}catch{return!1}}),Y=f.useMemo(()=>i.pipe?w:w.filter(L=>!qe(L)&&!L.noCo),[w,i.pipe]),J=b==="ops"?w.filter(L=>L.noCo).length:0,re=i.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,Z=a.filters,me=[];if(Z.day)me.push({k:"day",lib:n.fDay(Z.day.slice(8,10)+"/"+Z.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(Z.win&&Z.win!=="all"){const L=["1","7","30"].indexOf(Z.win);L>=0&&me.push({k:"win",lib:n.dates[L],off:()=>r({type:"filters",patch:{win:"all"}})})}const he=L=>L.length<=2?L.join(", "):`${L.length} ${n.fSelected}`;for(const L of["sector","country","engine"]){const F=Z[L];F&&F.length&&me.push({k:L,lib:he(F),off:()=>r({type:"clearFacet",facet:L})})}Z.search&&me.push({k:"search",lib:"🔍 "+Z.search,off:()=>r({type:"filters",patch:{search:""}})});const fe=(L,F,$="",K=!1)=>t.jsxs("button",{type:"button","data-s":L,className:$,"aria-sort":a.sort.key===L?a.sort.dir===1?"ascending":"descending":"none",style:K?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:L}),children:[F,t.jsx("span",{className:"ar",children:a.sort.key===L&&a.sort.dir===1?"▴":"▾"})]},L),X=f.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const L=new Map;w.forEach(K=>{const se=K.engine||"?";L.has(se)||L.set(se,[]),L.get(se).push(K)});const F={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},$=va([...L.keys()],x);return[...L.entries()].sort((K,se)=>{const te=F[K[0]]??10+$.indexOf(K[0]),le=F[se[0]]??10+$.indexOf(se[0]);return te-le})},[w,i.pipe,a.groupBy,x]),oe=i.lockRowsAfter;let ee=0;const V=(L,F)=>{let $=a.shown[F]||p;return L.length-$<=4&&($=L.length),L.slice(0,$).map(te=>{const le=oe!==null&&ee>=oe;ee++;const Le=N(te),pe=Le&&Le!==te.decryptHtml?{...te,decryptHtml:Le}:te,Te=a.dens!=="maxi"&&(a.dens==="deplie"||(h?h==="open":!!Le)),Ge=g.has(te.id)?!Te:Te;return a.dens==="maxi"?t.jsx(ql,{o:pe,locked:le},te.id):t.jsx(Cl,{o:pe,locked:le,open:Ge,onToggle:()=>j(te.id)},te.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:w.length})," ",re]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",me.map(L=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:F=>{F.stopPropagation(),L.off()},children:[L.lib,t.jsx("i",{children:"×"})]},L.k)),b==="ops"&&w.length>0&&" — "+n.edSplit(w.length-J,J)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([L,F])=>t.jsxs("button",{type:"button","data-d":L,"aria-pressed":a.dens===L||L==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:L}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:F})]},L))}),(i.showFunnel||b==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":h==="open",onClick:()=>{E("open"),v(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":h==="closed",onClick:()=>{E("closed"),v(new Set)},children:n.foldAllLbl}),b==="ops"&&t.jsxs("button",{type:"button","aria-pressed":h===null,onClick:()=>{E(null),v(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||b==="ops")&&(()=>{var $;const L=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],F=(($=L.find(([K])=>K===y))==null?void 0:$[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":R,onClick:()=>q(K=>!K),children:[F,t.jsx("i",{children:"▾"})]}),R&&t.jsx("div",{className:"dolist",children:L.map(([K,se])=>t.jsx("button",{type:"button","aria-pressed":y===K,onClick:()=>{z(K),q(!1)},children:se},K))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:L=>r({type:"sort",key:L.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([L,F])=>t.jsx("option",{value:L,children:F},L))})]}),i.showChain&&Y.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:Y.map(L=>L.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(Y.length):n.chainAll(Y.length)]}),a.mapFolded&&t.jsxs(t.Fragment,{children:[t.jsx(Ga,{}),t.jsx(qr,{compact:!0})]})]}),t.jsx(Nl,{}),_>0&&!a.filters.signalOnly&&!O&&t.jsxs("div",{className:"sigstrip"+(H?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(_)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!H,title:H?n.boxExpand:n.boxCollapse,onClick:()=>Q(L=>{try{localStorage.setItem(W,L?"0":"1")}catch{}return!L}),children:H?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>U(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(C?M:M.slice(0,12)).map(L=>{const F=je(L);return F?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(_a(F,x),Vt(F,x)),onClick:()=>{d(L.id),r({type:"popup",id:L.id})},children:[t.jsx("b",{children:L.name}),t.jsxs("i",{children:[F.emoji," ",ya(F,x)]}),t.jsx("em",{children:Vt(F,x)})]},"sg-"+L.id):null}),!C&&M.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>T(!0),children:n.sigStripMore(M.length-12)})]})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),fe("country",n.colCountry),fe("name",n.colCompany),fe("amount",n.colAmount,"h-amt",!0),fe("stage",n.colStage,"h-stade"),fe("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[fe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),fe("memo",n.colMemo)]}),i.pipe&&fe("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(w.length?"":" list-empty"),children:[X?X.map(([L,F])=>t.jsxs(f.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:tt(L)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Ue(L,x)}),t.jsx("div",{className:"s",children:n.grpCount(F.filter($=>!qe($)).length,F.length)})]})]}),V(F,L)]},L)):V(w,"pt"+a.ptab),m.loading&&!u.length&&t.jsx(Ll,{}),!w.length&&!(m.loading&&!u.length)&&(i.pipe?t.jsx(Rl,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const L=X||[["pt"+a.ptab,w]];let F=0,$=0;for(const[se,te]of L){$+=te.length;let le=a.shown[se]||p;te.length-le<=4&&(le=te.length),F+=Math.min(te.length,le)}const K=$-F;return K<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>L.forEach(([se,te])=>r({type:"more",group:se,by:te.length,base:p})),children:[t.jsx("span",{className:"more-label",children:n.more(K,K)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(F,$)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}})]})}function Jn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Ol(e,a){const r=Bo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Fl(e,a){const n=[a.head.split("|").map(Jn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",Ol(i,a.plabels),Et(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Jn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Pl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Dl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function $e({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Il({o:e,qa:a}){const{t:r,lang:n,fund:i}=I(),o=(e.cribleStatus||"").trim().toUpperCase()||(Et(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=Qe(e),l=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx($e,{k:r.cdSector,v:e.sector}),t.jsx($e,{k:r.cdStage,v:e.stage}),t.jsx($e,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx($e,{k:r.cdSite,v:e.domain||e.website}),t.jsx($e,{k:r.cdName,v:e.contactName}),t.jsx($e,{k:r.cdEmail,v:e.contactEmail}),t.jsx($e,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx($e,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx($e,{k:r.cdAngle,v:e.angle}),t.jsx($e,{k:r.cdDetected,v:Dl(e.date,n)})]}),d.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,x])=>x).map(([x,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:c})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function $l(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:s}=I(),[l,d]=f.useState({}),x=25,c=f.useMemo(()=>n.slice(0,x),[n]);f.useEffect(()=>{c.length&&_o(r,c.map(b=>b.name)).then(d)},[r,c]);const m=o.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),m&&typeof m.screened=="number"&&t.jsxs("p",{children:[u(m.screened)," ",e.funScreened(""),typeof m.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(m.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(m.screened/o.marketEstimate*100)," %"]})]})]}),c.map(b=>t.jsx(Il,{o:b,qa:l[b.name]},b.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Bl=50;function Ja({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=I(),[o,s]=f.useState(null),[l,d]=f.useState(!1),[x,c]=f.useState(""),[m,u]=f.useState(0),[b,p]=f.useState(""),[g,v]=f.useState(!1),h=f.useRef(null);f.useEffect(()=>()=>{h.current&&window.clearInterval(h.current)},[]);const E=async y=>{d(!0),c("");const z=await a();if(d(!1),z.ok){s(z);return}if(z.busy){c(i.alertPreviewBusy);return}if(!y){c(i.alertPreviewFail);return}u(Bl),h.current=window.setInterval(()=>{u(R=>R>1?R-1:(h.current&&window.clearInterval(h.current),E(!1),0))},1e3)},j=async()=>{if(n||g)return;v(!0),p("");const y=await r();v(!1),p(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||m>0,onClick:()=>{E(!0)},children:l?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||g,onClick:()=>{j()},children:g?"…":i.alertTest})]}),m>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(m)}),x&&t.jsx("p",{className:"mnote warn",children:x}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const lt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ae({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=I();return ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function _l(){const{st:e}=I();switch(e.modal){case"chain":return t.jsx(Vl,{});case"space":return t.jsx(Hl,{});case"alert":return t.jsx(Wl,{});case"queue":return t.jsx(Jl,{});case"export":return t.jsx(Xl,{});case"plug":return t.jsx(tc,{});case"recharge":return t.jsx(nc,{});case"cover":return t.jsx(oc,{});case"dossier":return t.jsx(rc,{});case"crit":return t.jsx(ic,{});case"tuto":return t.jsx(sc,{});case"rdv":return t.jsx(Ul,{});case"memoalert":return t.jsx(Zl,{});default:return null}}function Ul(){const{dispatch:e,fund:a}=I(),r=typeof document<"u"&&!!document.getElementById("rdv");return f.useEffect(()=>{r&&(e({type:"modal",modal:null}),Ui())},[r,e]),r?null:t.jsx(Ho,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Vl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:s,evalBusy:l,caps:d,memoQueued:x,doAnalyse:c}=I(),m=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,p=u[b],g=b>=u.length;return ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:g?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(g?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:g||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[mt(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(Ke(p.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ue(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:Ct(p.amountEur,i)})]}),je(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(rt,{o:p,lg:!0})," ",t.jsx(aa,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),m&&qe(p)&&t.jsxs("div",{className:"vbox",style:{"--c":et(p)==="retenu"?"var(--brand)":et(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:et(p)==="retenu"?"✓ "+n.kept:et(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!g&&p&&d.pipe&&ye(p)===1&&!x.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!g&&p&&!(m&&qe(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{s(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(g?{type:"modal",modal:null}:{type:"chainNext"}),children:g?n.closeBtn:n.skip})]})]})})}),document.body)}function Hl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=I(),o=i==="client",s=f.useMemo(()=>o?r.filter(m=>qe(m)):[],[r,o]),l=f.useMemo(()=>Va(s.filter(m=>et(m)==="retenu"),{key:"signal",dir:-1}),[s]),d=f.useMemo(()=>s.filter(m=>et(m)==="ecarte"),[s]),x=e.spaceTab==="retenu"?l:d,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ae,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(m=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof m.score=="number"&&m.score>0?m.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:m.name}),t.jsx("div",{className:"rr",children:m.reasoning||m.tagline||""})]})]},m.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Wl(){const{mode:e}=I();return e==="client"||e==="apercu"?t.jsx(Yl,{}):t.jsx(Ql,{})}function Yl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=I(),[o,s]=f.useState("d"),l=i!=="client";return t.jsxs(Ae,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(Gl,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),o==="w"&&t.jsx(Kl,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),o==="m"&&t.jsx(Ir,{})]})}function Gl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,s]=f.useState(null),[l,d]=f.useState(!1),[x,c]=f.useState(0);f.useEffect(()=>{let p=!0;return d(!1),un(a).then(g=>{p&&(g?s(g):d(!0))}),()=>{p=!1}},[a,x]);const m=p=>{r||un(a,p).then(g=>{if(!g){i(e.actErr);return}s(g),g.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),b=p=>{const g=o.sections||e.alertSec.map(([v])=>v);m({sections:u(p)?g.filter(v=>v!==p):[...g,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,g])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>b(p)}),t.jsxs("span",{children:[g,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ja,{label:e.alertPreview,readOnly:r,onPreview:()=>Zo(a),onTest:()=>Xo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Kl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,s]=f.useState(null),[l,d]=f.useState(!1),[x,c]=f.useState(0);f.useEffect(()=>{let p=!0;return d(!1),mn(a).then(g=>{p&&(g?s(g):d(!0))}),()=>{p=!1}},[a,x]);const m=p=>{r||mn(a,p).then(g=>{if(!g){i(e.actErr);return}s(g),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,b=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>m({dow:Number(p.target.value)}),children:e.alertDow.map((p,g)=>t.jsx("option",{value:g,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ja,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ti(a),onTest:()=>ei(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ir(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=I(),[s,l]=f.useState(o||""),[d,x]=f.useState(!1),[c,m]=f.useState(!1);f.useEffect(()=>{o&&l(o)},[o]);const u=e.filters,b=f.useMemo(()=>n.filter(h=>je(h)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(s)||c)){m(!0);try{await fetch(`${Da}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{m(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>Ue(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>mt(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([h,E])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:E}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!o,onChange:h=>l(h.target.value),onKeyDown:h=>{h.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Ql(){const{t:e}=I();return t.jsx(Ae,{title:e.alertTitle,icon:"🔔",children:t.jsx(Ir,{})})}function Jl(){var S,A;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:s,caps:l,dispatch:d,liveMemos:x}=I(),[c,m]=f.useState(null),[u,b]=f.useState([]),[p,g]=f.useState(0),v=n==="client",h=f.useMemo(()=>{const N=new Map;return i.forEach(w=>{const M=(w.name||"").trim().toLowerCase();M&&!N.has(M)&&N.set(M,w)}),N},[i]);f.useEffect(()=>{let N=!0;return(async()=>{const[w,M]=await Promise.all([$a(r),ar(a)]);N&&(w&&m(w),b(M))})(),()=>{N=!1}},[a,r,p]);const E=(c==null?void 0:c.per_day)??0,j=((S=c==null?void 0:c.analyzed_today)==null?void 0:S.length)??0,y=c==null?void 0:c.offre,z=(c==null?void 0:c.pool_meta)||[],R=f.useMemo(()=>{const N=new Map;for(const w of(c==null?void 0:c.scheduled)||[])for(const M of w.names||[])N.has(M)||N.set(M,{label:w.day_label,date:w.date});return N},[c==null?void 0:c.scheduled]),q=(c==null?void 0:c.in_progress)||[];return t.jsxs(Ae,{title:e.queueTitle,wide:!0,children:[y&&t.jsxs("div",{className:"qoffre"+(y.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:y.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:y.delai})]}),t.jsx("span",{className:"osp"}),y.rythme>0?t.jsx("span",{className:"or",children:e.qRate(y.rythme)}):y.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(y.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(j,j+(((A=c==null?void 0:c.pool_order)==null?void 0:A.length)??0))}})}),y&&t.jsxs("div",{className:"qeta",children:[y.file===0?e.qEtaDone:y.rythme<=0?e.qEtaPaused:e.qEta(y.file,y.rythme,y.jours_restants),y.en_retard&&t.jsxs("em",{children:[" ",e.qLate(y.delai,y.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(E)}),(y==null?void 0:y.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(q.length>0||x.items.some(N=>N.status==="boot"||N.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[x.items.filter(N=>N.status==="boot"||N.status==="running"||N.status==="error").map(N=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:N.name}),t.jsx("span",{className:"qd",children:N.memoType||""}),t.jsx(wt,{item:N,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+N.name)),q.filter(N=>!x.liveOf(N.name)).map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.name}),t.jsxs("span",{className:"qd",children:[N.memo_type||"",N.age_min?` · ${Math.round(N.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:N.state||""})]},"ip-"+N.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.company}),t.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),t.jsx("span",{className:"qt",children:N.status}),N.url&&t.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),v&&N.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{pn(a,N.company,"retry").then(()=>g(w=>w+1))},children:e.queueRetry}),v&&N.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{pn(a,N.company,"delete").then(()=>g(w=>w+1))},children:e.queueDelete})]},N.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(z.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[z.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),z.map((N,w)=>{const M=R.get(N.name),_=h.get((N.name||"").trim().toLowerCase()),C=x.liveOf(N.name),T=!!(_&&s.has(_.id))||!!(C&&(C.status==="boot"||C.status==="running")),O=!!(_&&ye(_)===1&&!_.memoUrl)&&!C;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",w+1]}),M?t.jsx("span",{className:"qwhen"+(M.label==="demain"?" soon":""),children:M.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:N.name}),N.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof N.score=="number"&&t.jsx("span",{className:"qs2",children:N.score}),C&&(C.status==="boot"||C.status==="running")&&t.jsx(wt,{item:C,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),O&&(l.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>d({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:T,onClick:()=>{o(_),g(U=>U+1)},children:T?e.actAnalyseQueued:e.actAnalyse})),N.excerpt&&t.jsx("span",{className:"qex",children:N.excerpt})]},N.name+":"+w)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([N,w])=>t.jsxs("li",{children:[t.jsx("b",{children:N})," — ",w]},N))})]})}function Xl(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:s}=I(),l=`${lt}/cibles/list.csv?token=${a}`,d=`${lt}/cibles/list.json?token=${a}`,x=`${lt}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${l}")`,m=v=>{var h;(h=navigator.clipboard)==null||h.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:c},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:x,href:x}],b=!i.lockActions&&n.length>0,p=()=>{Pl(Fl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([h])=>h===v)||["",""])[1]})),r(e.exportViewDone(n.length))},g=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ae,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:g,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:h,href:E})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>m(h),children:e.exportCopy}),E&&t.jsx("a",{className:"exb",href:E,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Zl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=I(),o=i!=="client",[s,l]=f.useState(null),[d,x]=f.useState(!1),[c,m]=f.useState(0),[u,b]=f.useState(!1);f.useEffect(()=>{let h=!0;return x(!1),dn(a).then(E=>{h&&(E?l(E):x(!0))}),()=>{h=!1}},[a,c]);const p=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=h=>{if(o||!s)return;const E={enabled:h.enabled??!!s.enabled,email:h.email??(s.email||""),sections:h.sections??p()};b(!0),dn(a,E).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}l(j),r(e.memoAlertSaved)})};if(d)return t.jsx(Ae,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(h=>h+1),children:e.retry})]})});if(!s)return t.jsx(Ae,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=p();return t.jsxs(Ae,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:o||u,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(ec,{value:s.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>g({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,E])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[h],disabled:o||u,onChange:()=>g({sections:{...v,[h]:!v[h]}})}),t.jsx("span",{children:E})]},h))}),t.jsx(Ja,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>Vo(a,v),onTest:()=>Uo(a,v)})]})}function ec({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,s]=f.useState(e);f.useEffect(()=>{s(e)},[e]);const l=o.trim()!==e.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:x=>s(x.target.value),onKeyDown:x=>{x.key==="Enter"&&l&&d&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!d,onClick:()=>i(o.trim()),children:n})]})]})}function tc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=I(),[o,s]=f.useState(null),[l,d]=f.useState(!1),[x,c]=f.useState(null),[m,u]=f.useState(""),[b,p]=f.useState(0);f.useEffect(()=>{let j=!0;return d(!1),wa(a).then(y=>{j&&(y?s({configured:y.configured,url_hint:y.url_hint}):d(!0))}),Go(a).then(y=>{j&&c(y)}),()=>{j=!1}},[a,b]);const g=(j,y)=>{i&&wa(a,j).then(z=>{if(!z||z.ok===!1){n(e.actErr);return}j.test&&z.sent===!1?n(e.plugTestThrottled):r(y),p(R=>R+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),E=`curl -X POST ${lt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ae,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(j=>j+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:m,disabled:!i,onChange:j=>u(j.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!m.trim(),onClick:()=>g({url:m.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(ac,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:E}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(E).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function ac(){const{t:e,token:a,lang:r}=I(),[n,i]=f.useState("valides"),[o,s]=f.useState(!1),[l,d]=f.useState(null),[x,c]=f.useState(null),[m,u]=f.useState(!1),[b,p]=f.useState(!1),[g,v]=f.useState(null),[h,E]=f.useState(null),[j,y]=f.useState(null),z=`atl2:bulk:${a}:${n}`;f.useEffect(()=>{wa(a).then(M=>{E(M&&M.configured?M.url_hint||"webhook":null)})},[a]),f.useEffect(()=>{d(null),c(null),u(!1),v(null);try{const M=JSON.parse(localStorage.getItem(z)||"null");y(M&&Date.now()-Date.parse(M.t)<24*3600*1e3?M:null)}catch{y(null)}},[z]);const R=async()=>{s(!0),u(!1),v(null);const M=await Qo(a,n);d(M),c(M.ok?n:null),s(!1)},q=f.useRef(!1),S=async()=>{if(q.current)return;q.current=!0,p(!0);const M=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await Jo(a,n,"webhook",void 0,M)}finally{q.current=!1}if(p(!1),u(!1),v(_),_.ok&&(_.pushed||0)>0){const C={t:new Date().toISOString(),n:_.pushed||0};y(C);try{localStorage.setItem(z,JSON.stringify(C))}catch{}}},A=l!=null&&l.ok&&l.ready||0,N=!!(l!=null&&l.ok)&&x===n&&A>0&&!!h&&!j,w=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:M=>i(M.target.value),children:e.plugBulkTabs.map(([M,_])=>t.jsx("option",{value:M,children:_},M))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{R()},children:o?"…":e.plugBulkPreview})]}),l&&(l.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(l.ready||0,l.linkedinReady||0,(l.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(l!=null&&l.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(w,j.n)}),!j&&!!(l!=null&&l.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!l&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),N&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),N&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(A,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{S()},children:b?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),g&&(g.ok?g.replayed?t.jsx("p",{className:"mnote",children:g.pending?e.bulkPending:e.bulkReplayed}):(g.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:g.error||e.actErr}))]})}function nc(){const{t:e,data:a,lang:r}=I(),n=a.credits,i=a.email,o=async s=>{if(!i)return;const l=window.location.href.split("?")[0];try{const x=await(await fetch(`${Da}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:s,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(Ae,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function rc(){const{t:e}=I();return t.jsx(Ae,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx($l,{})})}function oc(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:s,flash:l}=I(),[d,x]=f.useState(null),[c,m]=f.useState(!1);f.useEffect(()=>{let A=!0;if(o)return $a(o).then(N=>{A&&N&&typeof N.per_day=="number"&&x(N.per_day)}),()=>{A=!1}},[o]);const[u,b]=f.useState(null);f.useEffect(()=>{if(!i)return;let A=!0;return Yo(i).then(N=>{A&&b(N)}),()=>{A=!1}},[i]);const p=r.stats,g=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(A=>A.kind==="target"&&qe(A)).length,v=r.marketEstimate||0,h=v>0?Math.min(100,Math.round(g/v*100)):null,E=(p==null?void 0:p.window_days)||30,j=g>0?g/E:0,y=v>0?Math.max(0,v-g):0,R=v>0&&j>0&&g>=100?Math.round(y/j):null,q=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),S=A=>{c||!s||(m(!0),Ko(i,A).then(N=>{if(m(!1),N===null){l(e.actErr);return}x(N),l(e.alertSaved)}))};return t.jsxs(Ae,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(q(g))}),v>0&&t.jsx("span",{children:e.covOf(q(v))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),R!==null&&t.jsx("p",{className:"mnote",children:e.covEta(R)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(q(j))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((A,N)=>t.jsxs("tr",{className:A.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[A.code,A.geo?` · ${A.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof A.n=="number"?q(A.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:A.source}),A.elargi&&t.jsx("em",{children:e.covWide(String(A.demande||""))}),A.erreur&&t.jsx("em",{children:e.covMissing})]})]},N)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:q(u.total||v)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:q(p.shown)})," ",e.funShown]})]}),s&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:d===A?"on":"",disabled:c,onClick:()=>S(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function ic(){var h,E,j;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:s,lang:l}=I(),d=n==="client",x=f.useMemo(()=>{const y=new Set;return a.forEach(z=>{z.angle&&y.add(z.angle)}),[...y]},[a]),[c,m]=f.useState(""),[u,b]=f.useState(""),[p,g]=f.useState(!1),v=async()=>{const y=c.trim();if(!(!y||p||!d)){g(!0),b("");try{const R=await(await fetch(`${lt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(R.reply&&b(String(R.reply)),R.job_id){b(e.critChatRunning);const q=async()=>{const S=await fetch(`${lt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:R.job_id})}).then(A=>A.json()).catch(()=>null);if(S&&S.done){b(String(S.reply||S.clarification||S.summary||"✓")),g(!1),S.applied&&i(e.alertSaved);return}setTimeout(()=>{q()},8e3)};setTimeout(()=>{q()},8e3),m("");return}m("")}finally{u.startsWith("⏳")||g(!1)}}};return t.jsxs(Ae,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((h=o.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((E=o==null?void 0:o.angles)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var z,R;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((z=y.look)!=null&&z.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(q=>t.jsx("li",{children:q},q))})]}),!!((R=y.out)!=null&&R.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(q=>t.jsx("li",{children:q},q))})]})]})]},y.title)})]}),!!((j=o==null?void 0:o.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:x.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!d||p,onChange:y=>m(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!d||p||!c.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Wo,{fund:s,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Pr[y]||"v-cons"),children:y}),t.jsx("span",{children:z})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",z]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function sc(){const{t:e,dispatch:a,startTour:r}=I(),n=i=>{var o,s;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs(Ae,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+s))})]})}const $r="atl2:mapfold",lc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem($r);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Br=f.createContext(null),I=()=>{const e=f.useContext(Br);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function rt({o:e,lg:a}){const{lang:r}=I(),n=je(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:ya(n,r),children:[n.emoji," ",ya(n,r)]}):null}function aa({o:e,src:a}){const{lang:r,t:n}=I(),i=je(e);if(!i)return null;const o=ii(i),s=si(i);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(_a(i,r))+" · "+n.win7(Vt(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,d)=>t.jsx("i",{className:d<o?"on":""},d))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function _r({o:e}){const{lang:a}=I(),r=oi(e.cc),n=e.cc?mt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Xn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",cc=!1;function dc(){const[e,a]=f.useState(!1);return f.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Ur=e=>`atl2:tour:${e||"anon"}`;function pc(e){try{return localStorage.getItem(Ur(e))==="1"}catch{return!0}}function Zn(e){try{localStorage.setItem(Ur(e),"1")}catch{}}function uc(e,a,r,n,i){const o=e.tourT,s=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:s[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:s[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:s[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:s[0][0],modal:"crit"}].filter(Boolean)}function gc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var Za;const{lang:s}=ai(),l=yi[s],d=Li(e,s,a),[x,c]=f.useReducer(Oi,void 0,()=>Ri((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||lc(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),m=f.useRef(!0);f.useEffect(()=>{if(m.current){m.current=!1;return}if(!e)try{localStorage.setItem($r,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e]);const u=f.useRef(o);u.current=o,f.useEffect(()=>{var k;(k=u.current)==null||k.call(u,x.filters)},[x.filters]);const[b,p]=f.useState(null),[g,v]=f.useState(null),[h,E]=f.useState({kept:0,dropped:0}),[j,y]=f.useState(!1),[z,R]=f.useState(""),[q,S]=f.useState(!1),[A,N]=f.useState(null),[w,M]=f.useState(!1),[_,C]=f.useState(!1),[,T]=f.useState(0),O=()=>T(k=>k+1),U=f.useRef([]),W=f.useRef(new Set),H=f.useRef(new Set),[Q,Y]=f.useState([]),[J,re]=f.useState([]),[Z,me]=f.useState(0),he=f.useRef(new Map),fe=f.useRef(null),{mode:X}=d,oe=f.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),ee=oe.pipe,V=d.session.token||"",G=X==="client"&&!e;f.useEffect(()=>{if(!V||!ee)return;let k=!0;const B=async()=>{const we=await li(V);!k||!we||(re(we.runs),me(Date.now()/1e3-we.now),Y(Me=>Me.filter(oa=>!we.runs.some(Je=>We(Je.company)===We(oa.name)))))};B();const D=Q.length>0||J.some(we=>we.status==="running"),ne=window.setInterval(()=>{B()},D?8e3:25e3);return()=>{k=!1,window.clearInterval(ne)}},[V,ee,Q.length,J.some(k=>k.status==="running")]);const ge=f.useMemo(()=>{const k=[],B=new Set;for(const D of Q){const ne=We(D.name);!ne||B.has(ne)||(B.add(ne),k.push({name:D.name,id:D.id,status:"boot",started:D.started,estMin:D.estMin,memoType:"instant"}))}for(const D of J){const ne=We(D.company);if(!ne||B.has(ne))continue;B.add(ne);const we=D.status==="error"?"error":D.status==="done"?"done":"running";k.push({name:D.company,status:we,started:D.started||0,estMin:D.est_min||(D.memo_type==="detailed"?40:15),url:D.url,error:D.error,memoType:D.memo_type})}return k},[Q,J]),L=k=>ge.find(B=>We(B.name)===We(k))||null,F=(k,B)=>{Y(D=>D.some(ne=>We(ne.name)===We(k.name))?D:[...D,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:B==="detailed"?40:15}]),W.current.add(k.id),O()};f.useEffect(()=>{if(document.querySelector(`link[href="${Xn}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=Xn,document.head.appendChild(k)},[]);const $=(k,B=!1)=>{R(k),S(B),fe.current&&clearTimeout(fe.current),fe.current=setTimeout(()=>R(""),B?4200:2400)},K=k=>$(k,!0),se=f.useMemo(()=>{const k=new Map;return d.dossiers.forEach(B=>{B.id&&k.set(B.id,B)}),k},[d.dossiers]),te=f.useMemo(()=>d.dossiers.filter(k=>sr(k,x,ee)),[d.dossiers,x,ee]),le=f.useRef(!1);f.useEffect(()=>{if(le.current||e||d.loading||!d.dossiers.length)return;if(!oe.showFunnel||pc(d.session.token||"")){le.current=!0;return}le.current=!0;const k=window.setTimeout(()=>{Zn(d.session.token||""),M(!0)},700);return()=>window.clearTimeout(k)},[e,d.loading,d.dossiers.length,oe.showFunnel,d.session.token]);const Le=f.useMemo(()=>d.dossiers.filter(k=>Fi(k,x,ee,d.favIds)),[d.dossiers,x,ee,d.favIds]),pe=f.useMemo(()=>ni(te,d.favIds),[te,d.favIds]),Te=f.useMemo(()=>{const k=pr(d.dossiers);return k?Ke(k)===0?l.tourToday:ur(k,s):l.tourNoRun},[d.dossiers,l,s]),Ge=f.useMemo(()=>d.dossiers.some(k=>!!k.memoUrl||!!k.summary||ct(k)),[d.dossiers]),[At,ft]=f.useState(!1);f.useEffect(()=>{if(d.loading){ft(!1);return}if(d.dossiers.length>0||d.error){ft(!0);return}const k=window.setTimeout(()=>ft(!0),6e3);return()=>window.clearTimeout(k)},[d.loading,d.dossiers.length,d.error]);const Tt=(d.marketEstimate||0)>0||typeof((Za=d.stats)==null?void 0:Za.screened)=="number"&&d.stats.screened>0,zt=f.useMemo(()=>[1,0,2,4,5,3].find(k=>(pe[k]||0)>0)??0,[pe]),Ie=Ba.find(k=>k.key===x.continent),na=x.continent==="monde"?l.contWorld:(s==="fr"?Ie==null?void 0:Ie.fr:Ie==null?void 0:Ie.en)||"";f.useEffect(()=>{const k=B=>{var ne;const D=(((ne=B.detail)==null?void 0:ne.name)||"").trim();D&&qt(null,D)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),f.useEffect(()=>{const k=ne=>{const we=String(ne||"").trim();we&&c({type:"filters",patch:{sector:[we]}})},B=ne=>{var we;return k((we=ne.detail)==null?void 0:we.sector)},D=ne=>{ne.data&&ne.data.type==="pp-filter"&&k(ne.data.sector)};return window.addEventListener("ppmap:filter",B),window.addEventListener("message",D),()=>{window.removeEventListener("ppmap:filter",B),window.removeEventListener("message",D)}},[]);const qt=(k,B)=>{const D=((k==null?void 0:k.name)||B||"").trim();if(!G){v({kicker:D});return}!D||j||(y(!0),(async()=>{try{let ne=D;const we=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(we)ne=we;else try{const ke=await ci(D);if(ke!=null&&ke.website)ne=ke.website;else if(((ke==null?void 0:ke.candidates)||[]).length===1)ne=ke.candidates[0].url;else if(((ke==null?void 0:ke.candidates)||[]).length>1){U.current=[{name:D,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(ke.candidates||[]).slice(0,5)},...U.current].slice(0,8),O();return}}catch{}const Me=await rr(V,ne,"atelier2"),oa={name:Me.company||D,verdict:Me.verdict,reason:Me.reason||"",remaining:Me.remaining??null};U.current=[oa,...U.current].slice(0,8),Me.verdict==="kept"&&E(ke=>({...ke,kept:ke.kept+1})),Me.verdict==="ruled_out"&&E(ke=>({...ke,dropped:ke.dropped+1}));const Je=k||d.dossiers.find(ke=>(ke.name||"").toLowerCase()===D.toLowerCase());Je&&(Me.verdict==="kept"?Je.verdict=Je.verdict||"MATCH":Me.verdict==="ruled_out"&&(Je.verdict="NO MATCH"),Me.reason&&(Je.reasoning=Me.reason)),O()}finally{y(!1)}})())},P=k=>{if(!G){v({kicker:k.name});return}F(k,"instant"),xt(V,"fast_request",k.name||"",""),$(l.memoInstantSent(k.name))},ie=k=>he.current.get(k.id)??d.thumbs.get((k.name||"").trim().toLowerCase()),de=(k,B)=>c({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:B}}),Ne=async(k,B,D)=>{const ne=k.ceoStatus||"";k.ceoStatus=B,O();const we=await la(V,{status:B,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(D==null?void 0:D.note)!==void 0?{note:D.note}:{},...D!=null&&D.via?{via:D.via}:{}});return we.ok?we.skipped?(k.ceoStatus=ne,O(),K(l.actNotPersisted),!1):((D==null?void 0:D.undo)!==!1&&de(k,ne),D!=null&&D.msg&&$(D.msg),(B==="Validé"||B==="Écarté")&&!k.ceoNote&&(D==null?void 0:D.note)===void 0&&N({o:k,yes:B==="Validé"}),!0):(k.ceoStatus=ne,O(),K(l.actErr),!1)},Ve=async(k,B)=>{const D=await la(V,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:B,via:"note"});return!D.ok||D.skipped?(K(D.skipped?l.actNotPersisted:l.actErr),!1):(k.ceoNote=B,O(),!0)},Se=f.useRef(new Map),xe=k=>Se.current.has(k.id)?Se.current.get(k.id):d.stages.get((k.name||"").trim().toLowerCase()),Re=(k,B)=>{Se.current.set(k.id,B),O()},ra=(k,B)=>{G&&Ne(k,B?"Validé":"Écarté",{msg:B?l.decidedYes(k.name):l.decidedNo(k.name)})},Lt=k=>{G&&Ne(k,"À trancher",{msg:l.promoted(k.name)})},Vr=k=>{G&&(async()=>{const B=k.ceoStatus||"";k.ceoStatus="Retenu",O();const D=await la(V,{status:"Retenu",check_id:k.checkId,company:k.name});if(!D.ok||D.skipped){k.ceoStatus=B,O(),K(D.skipped?l.actNotPersisted:l.actErr);return}de(k,B),$(l.repeched(k.name))})()},Hr=()=>{const k=x.undo[x.undo.length-1];if(!k){$(l.undoNone);return}const B=se.get(k.id);if(!B){c({type:"undoPop"}),$(l.undoNone);return}let D=k.prevCeoStatus;if(!D)if((B.verdict||"").toUpperCase().includes("CALL"))D="À trancher";else{$(l.undoLockedTitle);return}(async()=>await Ne(B,D,{undo:!1})&&(c({type:"undoPop"}),B.ceoStatus=k.prevCeoStatus,O(),$(l.undoDone(B.name))))()},Wr=k=>{G&&(H.current.add(k.id),O(),(async()=>{const B=await di(V,k.name,"email");if(!B||B.ok===!1){H.current.delete(k.id),O(),K(l.actErr);return}xt(V,"approach",k.name||"",""),$(l.actApproachSent)})())},Yr=(k,B)=>{G&&(async()=>{if(!(await xt(V,B?"yes":"no",k.name||"","")).ok){K(l.actErr);return}he.current.set(k.id,B?"yes":"no"),O(),$(B?l.thumbUpDone:l.thumbDnDone)})()},Gr=k=>{!G||!ct(k)||(F(k,"detailed"),xt(V,"detailed_request",k.name||"",""),$(l.memoDeepSent(k.name)))},Kr=k=>{const B=new Set(d.favIds),D=B.has(k.id);D?B.delete(k.id):B.add(k.id),d.setFavIds(B),G&&pi(V,{id:k.id,co:k.name},D)},Qr=()=>{!G||_||window.confirm(l.identSyncConfirm)&&(C(!0),(async()=>{const k=await ui(V);C(!1),k?$(l.identSyncDone):K(l.actErr)})())},Xa=/proplace/i.test(d.fund||""),Jr=k=>{!G||!Xa||(xt(V,"onboard_request",k.name||"",""),$(l.onboardSent(k.name)))},Xr={st:x,dispatch:c,t:l,lang:s,mode:X,caps:oe,pipe:ee,token:V,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:Vr,thumbOf:ie,canWrite:G,commitStatus:Ne,saveNote:Ve,stageOf:xe,setStage:Re,flashErr:K,startTour:()=>M(!0),dossiers:d.dossiers,scopedAll:te,scoped:Le,counts:pe,byId:se,contName:na,favIds:d.favIds,toggleFav:Kr,askEvaluate:qt,doAnalyse:P,doDecide:ra,doPromote:Lt,doApproach:Wr,doThumb:Yr,doDeep:Gr,doUndo:Hr,doSync:Qr,doOnboard:Jr,outbound:Xa,memoQueued:W.current,liveMemos:{items:ge,serverOff:Z,liveOf:L},approachDone:H.current,sessTally:h,evalCards:U.current,evalBusy:j,markRow:p,markedId:b,flash:$};f.useEffect(()=>{const k=B=>{B.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const Zr=k=>V?t.jsx(ul,{token:V,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(Br.Provider,{value:Xr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:ji}),oe.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:cr,children:Ha}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${Ht}`,children:Ht})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),Zr(t.jsxs("div",{className:"app"+(ee?" pipe":"")+(V?" has-thesis":""),children:[oe.showTicker&&t.jsx(Ee,{name:"live",children:t.jsxs("div",{className:"live-stack"+(V?" live-stack--cibles":""),children:[t.jsx(Bi,{}),!!V&&t.jsx(ml,{})]})}),oe.showIdent&&t.jsx(Ee,{name:"identite",children:t.jsx(as,{})}),!1,!!V&&t.jsx(Ee,{name:"brief",children:t.jsx(fl,{})}),cc,oe.showMorning&&t.jsx(Ee,{name:"matin",children:t.jsx(ts,{})}),t.jsx(Ee,{name:"mesure",children:t.jsx(Yi,{})}),oe.showFunnel&&t.jsx(Ee,{name:"entonnoir",children:t.jsx(mc,{})}),oe.showFunnel&&t.jsx(Ee,{name:"tunnel",children:t.jsx(ns,{})}),oe.showFunnel&&t.jsx(Ee,{name:"tuto",children:t.jsx(rs,{})}),!x.mapFolded&&t.jsx(Ee,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Ga,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[t.jsx(tl,{}),t.jsx(qr,{})]})]})}),oe.showDemand&&ee&&t.jsx(Ee,{name:"direct",children:t.jsx(gi,{items:ge,serverOff:Z,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),oe.showDemand&&t.jsx(Ee,{name:"evaluation",children:t.jsx(sl,{})}),oe.showDemand&&x.memoConsole&&t.jsx(Ee,{name:"console",children:t.jsx(cl,{})}),t.jsx(Ee,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(Ml,{})}),d.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:l.retry})]})]})),x.popupId&&t.jsx(Ee,{name:"fiche",children:t.jsx(kl,{})}),t.jsx(Ee,{name:"modales",children:t.jsx(_l,{})}),t.jsx(Hi,{}),A&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:A.o.name}),t.jsx(Xi,{placeholder:A.yes?l.whyYesPh:l.whyNoPh,onDone:k=>{const B=A.o;N(null),k&&Ve(B,k).then(D=>{D&&$(l.csNoteSaved)})}})]}),w&&At&&t.jsx(es,{steps:uc(l,Te,Ge,zt,Tt),onClose:()=>{M(!1),Zn(V)}}),t.jsx(dc,{}),z&&t.jsx("div",{className:"flash on"+(q?" err":""),children:z}),g&&t.jsx(ri,{variant:"acquirer",initialCompany:er().co,initialWebsite:er().site,onClose:()=>v(null)})]})})}function mc(){const{t:e}=I(),[a,r]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function er(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function fc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{_r as FlagCell,rt as SigBadge,aa as SigWin,gc as default,fc as fmtShort,I as useV2};
