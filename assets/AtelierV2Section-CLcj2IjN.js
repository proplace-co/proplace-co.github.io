...
`,ps=ls+ds+cs;function en(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function us(){const e=en("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function ms(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=us();return r==="0"?"client":r==="1"||en("embed")==="1"&&en("chrome")==="1"?"apercu":"client"}const fs={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},hs=e=>fs[e];function ka(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const jt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Ir(a)||ka(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ko(e.cc)})};function _a(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const xs=60*60*1e3;function gs(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>xs?null:a}catch{return null}}function la(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const bs=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function vs(e,a,r="default"){const n=r!=="default",o=u.useMemo(()=>e||n?{mode:"anon"}:Io(),[e,n]),i=u.useMemo(()=>n?"visiteur":ms(e,o),[e,o,n]),s=u.useMemo(()=>hs(i),[i]),l=i!=="visiteur",c=bs(r),[x,d]=u.useState([]),[h,p]=u.useState(""),[b,m]=u.useState(null),[v,y]=u.useState(null),[f,j]=u.useState(null),[E,w]=u.useState(()=>new Map),[N,A]=u.useState(()=>new Map),[S,q]=u.useState(""),[z,F]=u.useState(new Set),[D,B]=u.useState(null),[L,R]=u.useState(!0),[g,T]=u.useState(!1),[$,Q]=u.useState(0),[H,M]=u.useState(0),K=u.useRef(0),_=u.useMemo(()=>{var X;if(i!=="client")return"";try{return((X=Po())==null?void 0:X.email)||""}catch{return""}},[i]);u.useEffect(()=>{const X=++K.current;let me=!0;const U=()=>me&&X===K.current,se=(l&&o.token?o.token:"pub:"+a)+(c?":"+c:""),fe=gs(se);return fe?(d(fe.objs.map(jt)),fe.fund&&p(fe.fund),m(fe.marketEstimate??null),y(fe.criteria??null),j(fe.stats??null),q(fe.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const Le=await Da(),ae=((Le==null?void 0:Le.recent_ops)||[]).map(ue=>{const xe=xa(ue.company_name||ue.title?ue:{...ue,title:(ue.headline_fr||ue.headline||"").slice(0,120)},a),ce=String(ue.rubrique||"").toLowerCase();return xe&&(ce==="nominations"||ce==="recrutements")&&(xe.engine=ce),xe&&!String(ue.company_name||"").trim()&&(xe.noCo=!0),xe}).filter(ue=>!!ue).map(ue=>(Ir((ue.name||"").trim())||(ue.noCo=!0),ue));try{const ue=Bo(),xe=await _o(),ce=((xe==null?void 0:xe.date)||"").slice(0,10),Z=ue?ue.doc:xe,re=$o(Z),le=((ue==null?void 0:ue.day)||(Z==null?void 0:Z.date)||ce||"").slice(0,10);if(le&&re.length){const be=new Set;for(const Se of ae){if((Se.date||"").slice(0,10)!==le)continue;const oe=Fn(re,be,Se.name,"");oe>=0&&(be.add(oe),Se.decryptHtml=re[oe].html)}for(const Se of ae){if(Se.decryptHtml||(Se.date||"").slice(0,10)!==le)continue;const oe=Fn(re,be,"",Se.headline||Se.tagline||Se.name);oe>=0&&(be.add(oe),Se.decryptHtml=re[oe].html)}}if(le){const be=((Z==null?void 0:Z.title_fr)||"").trim(),Se=((Z==null?void 0:Z.lead_fr)||"").trim(),oe=Uo(Z),pe=((Z==null?void 0:Z.url)||"").trim();be&&(oe||pe)&&ae.unshift({id:`edito:${le}`,kind:"op",name:be,cc:null,date:le,engine:"edito",dealKind:"other",headline:be,tagline:Se||be,decryptHtml:oe||void 0,url:pe,noCo:!0})}}catch{}if(!U())return;d(ae.map(jt)),la(se,{objs:ae})}else if(typeof r=="object"){const ae=(await Rn()||[]).filter(xe=>(xe.slug||"")===r.research).map(xe=>Mn(xe,a)).filter(xe=>!!xe),ue=_a(await On(ae,a));if(!U())return;d(ue.map(jt)),la(se,{objs:ue})}else if(l&&o.token){const Le=Ho(o.token),ae=Da(),ue=Vo(o.token),xe=Wo(o.token),ce=Go(o.token),Z=await Le;let re=Z?Z.targets:[];U()&&Z&&(p(Z.fund||""),m(Z.marketEstimate??null),y(Z.criteria??null),j(Z.stats??null),q(Z.generatedAt||""),d(re.map(jt)),R(!1),T(!1));const[le,be,Se,oe]=await Promise.all([ae,ue,xe,ce]),pe=((le==null?void 0:le.recent_ops)||[]).map(Ce=>xa(Ce,a)).filter(Ce=>!!Ce),_e=new Set(re.map(Ce=>Ce.id));if(re=[...re,...pe.filter(Ce=>!_e.has(Ce.id)&&(_e.add(Ce.id),!0))],!U())return;d(re.map(jt));const Ie=new Set;for(const Ce of be){const ve=(Ce.id||Ce.co||"").toString().trim().toLowerCase();ve&&Ie.add(ve.startsWith("t:")?ve:"t:"+ve)}F(Ie),w(Se),A(oe),Z&&la(se,{fund:Z.fund,marketEstimate:Z.marketEstimate,criteria:Z.criteria,stats:Z.stats,generatedAt:Z.generatedAt,objs:re})}else{const Le=Yo(),ae=Rn(),ue=Da(),xe=await Le;U()&&xe.length&&(d(_a(xe).map(jt)),R(!1),T(!1));const[ce,Z]=await Promise.all([ae,ue]),re=(ce||[]).map(oe=>Mn(oe,a)).filter(oe=>!!oe),le=await On(re,a),be=((Z==null?void 0:Z.recent_ops)||[]).map(oe=>xa(oe,a)).filter(oe=>!!oe),Se=_a([...xe,...le,...be]);if(!U())return;d(Se.map(jt)),la(se,{objs:Se})}U()&&T(!1)}catch{U()&&!fe&&T(!0)}finally{U()&&R(!1)}})(),()=>{me=!1}},[l,o.token,a,$,c]),u.useEffect(()=>{if(!s.showCredits||!_){B(null);return}let X=!0;return(async()=>{try{const me=await fetch(`${gn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:_})});if(!me.ok)return;const U=await me.json();X&&U&&U.ok!==!1&&B(U)}catch{}})(),()=>{X=!1}},[s.showCredits,_,H]);const J=u.useCallback(X=>F(new Set(X)),[]);return{session:o,mode:i,caps:s,fund:h,email:_,marketEstimate:b,generatedAt:S,criteria:v,stats:f,thumbs:E,stages:N,dossiers:x,favIds:z,setFavIds:J,credits:D,reloadCredits:()=>M(X=>X+1),loading:L,error:g,refresh:()=>Q(X=>X+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Wr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),ys=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Wr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ws=new Set(["signal","amount","score","crible","memo"]);function ks(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Wr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ws.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Gr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Gr=80;function ja(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Re(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(bn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(mt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Et(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function Xt(e,a,r){return We(e)?ja(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ja(e,a.filters,r)}function js(e,a,r,n){return!(!Xt(e,a,r)||r&&!Qo(e,a.ptab,n))}function wn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-mt(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Xo(o);case"memo":return Jo(o);case"signal":{const i=Re(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const s=n(o),l=n(i);return s<l?-a.dir:s>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const $a={},Kn=($a==null?void 0:$a.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Qn(){return new Date().toISOString().slice(0,10)}const kn=u.createContext(null);function Yr(){return u.useContext(kn)}function Ns(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),s=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),l.querySelectorAll("*").forEach(c=>{const x=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(d=>c.removeAttribute(d.name)),x&&/^https?:\/\//i.test(x)&&(c.setAttribute("href",x),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Es(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),s=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(s);!l&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function Jn(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),s=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),s&&n.setAttribute("class",s),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Xn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${i} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${i} ${r[1]}`}function Kr(){const e=u.useContext(kn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ss({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Y(),[i,s]=u.useState(()=>n.filters.day||Qn()),[l,c]=u.useState(null),[x,d]=u.useState(!1),h=u.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){s(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),p=u.useCallback(()=>{s(Qn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);u.useEffect(()=>{const v=y=>{var j;const f=(j=y.detail)==null?void 0:j.day;typeof f=="string"&&h(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[h]),u.useEffect(()=>{n.filters.day&&n.filters.day!==i&&s(n.filters.day)},[n.filters.day]),u.useEffect(()=>{if(!e||!i)return;let v=!1;d(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Kn}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{v||c(f)}).catch(()=>{v||c({ok:!1,error:"network"})}).finally(()=>{v||d(!1)}),()=>{v=!0}},[e,i]);const b=u.useMemo(()=>`${Kn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=u.useMemo(()=>({token:e,day:i,ed:l,loading:x,pickDay:h,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,x,h,p,n.filters.day,b,o]);return t.jsx(kn.Provider,{value:m,children:a})}function Cs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Kr(),[o,i]=u.useState(()=>n||Pr());return u.useEffect(()=>{n&&i(!0)},[n]),u.useEffect(()=>{const s=l=>{var c;return i(!!((c=l.detail)!=null&&c.open))};return window.addEventListener(ya,s),()=>window.removeEventListener(ya,s)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Zo,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function zs(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Zn(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function er(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function As(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Kr(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!s,c=a&&!a.ok,x=u.useRef(null),[d,h]=u.useState("fonds"),[p,b]=u.useState(null),[m,v]=u.useState("idle"),y=u.useRef(!1);u.useEffect(()=>{b(null),v("idle"),y.current=!1,h("fonds")},[e]),u.useEffect(()=>{if(d!=="jour"||y.current)return;y.current=!0;let N=!0;return v("load"),zs(e).then(A=>{N&&(b(A),v("fait"))}),()=>{N=!1}},[d,e]);const f=u.useMemo(()=>Es((p==null?void 0:p.html)||""),[p==null?void 0:p.html]),j=u.useRef(null);u.useEffect(()=>{const N=j.current;if(!N||!f)return;let A=!1;return Ka(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(A||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{A=!0}},[f]);const E=u.useMemo(()=>Jn((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),w=u.useMemo(()=>Jn((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return u.useEffect(()=>{const N=x.current;if(!N||!E)return;let A=!1;return Ka(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(A||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{A=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":d==="fonds",onClick:()=>h("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":d==="jour",onClick:()=>h("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),d==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),d==="fonds"&&r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Zn(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Xn(e,!0)}),"."]}):Zn(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Xn(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>h("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),d==="fonds"&&s&&E?t.jsx("div",{ref:x,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,d==="fonds"&&s&&w?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:w}}):null,d==="jour"&&(f?t.jsxs(t.Fragment,{children:[(p==null?void 0:p.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:p.title}),t.jsx("div",{ref:j,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:er(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:er(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Ts=300,da=7,qs={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Qr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Ls=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ua(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(ni(r)&&r!=="media")return"news:"+r;const n=Re(e);return n?"sig:"+(n.theme&&Qr.fr[n.theme]?n.theme:"other"):"actualites"}function Fs(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:s,fund:l}=Y(),c=Yr(),x=s==="en",[d,h]=u.useState("all"),[p,b]=u.useState(!1),m=u.useMemo(()=>{var me;const g=(a.filters.day||"").slice(0,10),T=U=>!(!i&&a.continent!=="monde"&&U.continent!==a.continent||g&&(U.date||"").slice(0,10)!==g),$=e.filter(U=>T(U)&&Re(U)&&(!i||U.kind!=="target"||Ae(U)!==5)),Q=i&&(((me=c==null?void 0:c.ed)==null?void 0:me.ops)||[]).length?c.ed.ops.map(U=>xa(U,s)).filter(U=>!!U).map(U=>(U.briefOnly=!0,U)).filter(U=>!g||(U.date||"").slice(0,10)===g):[],H=e.filter(U=>T(U)&&U.kind==="op"&&(g?!0:mt(U.date)<=da)),M=i?Q.length?Q:H.filter(U=>{const se=(l||"").trim().toLowerCase();if(!se)return!1;const fe=U.match||null;return fe?Object.keys(fe).map(Le=>Le.trim().toLowerCase()).includes(se):!1}):H,K=g||new Date().toISOString().slice(0,10),_=U=>{const se=Ua(U);return se==="ma"?0:se==="levees"?1:2};M.sort((U,se)=>{const fe=_(U)-_(se);if(fe)return fe;const Le=(U.date||"").slice(0,10)===K?0:1,ae=(se.date||"").slice(0,10)===K?0:1;return Le!==ae?Le-ae:(se.amountEur||0)-(U.amountEur||0)});const J=new Set,X=[];for(const U of[...M,...wn($,{key:"signal",dir:-1})]){const se=U.id||U.name;!se||J.has(se)||(J.add(se),X.push(U))}return i&&X.length===0?e.filter(se=>T(se)&&mt(se.date)<=da).sort((se,fe)=>(fe.date||"").localeCompare(se.date||"")).slice(0,80):X},[e,a.continent,a.filters.day,i,l,s,c]),v=u.useMemo(()=>{const g={};for(const T of m){const $=Ua(T);g[$]=(g[$]||0)+1}return g},[m]),y=u.useMemo(()=>d==="all"?m:m.filter(g=>Ua(g)===d),[m,d]),f=u.useMemo(()=>y.slice(0,Ts),[y]),j=y.length-f.length,E=u.useRef(null);u.useEffect(()=>{var M,K;const g=E.current;if(!g)return;const T=()=>{const _=g.scrollWidth;_<200||(g.style.animationDuration=Math.max(18,Math.round(_/130))+"s")};T();const $=requestAnimationFrame(T),Q=window.setTimeout(T,1200);let H=!0;return(K=(M=document.fonts)==null?void 0:M.ready)==null||K.then(()=>{H&&T()}),()=>{H=!1,cancelAnimationFrame($),window.clearTimeout(Q)}},[f.length,d]);const w=g=>g==="all"?m.length:v[g]||0,N=g=>{if(g==="all")return x?"All":"Tout";if(g.startsWith("sig:"))return Qr[x?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const T=g.slice(5);return ti[T]?ai(T,x?"en":"fr"):g}return qs[x?"en":"fr"][g]},A=[{k:"all"}],S=["ma","levees"].filter(g=>w(g)>0||g===d);if(S.length){A.push({g:x?"Deals":"Opérations"});for(const g of S)A.push({k:g})}const q=["nominations","recrutements"].filter(g=>w(g)>0||g===d),z=ei.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>w(g)>0||g===d),F=w("actualites")>0||d==="actualites"?["actualites"]:[];if(q.length||z.length||F.length){A.push({g:x?"News":"Actualités"});for(const g of q)A.push({k:g});for(const g of z)A.push({k:g});for(const g of F)A.push({k:g})}const D=Ls.map(g=>"sig:"+g).filter(g=>w(g)>0||g===d);if(D.length){A.push({g:x?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of D)A.push({k:g})}const B=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(x?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},L=(()=>{const g=(a.filters.day||"").slice(0,10),T=!i&&a.continent!=="monde"&&o?x?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return g?(x?`LIVE covers the events of ${B(g)}.`:`Le LIVE regroupe les événements du ${B(g)}.`)+T:(x?`LIVE covers the still-open signals and the deals of the last ${da} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${da} derniers jours.`)+T})(),R=g=>f.map(T=>t.jsxs("button",{type:"button",className:"tk"+(De(T)?" spent":""),onClick:$=>{const Q=T.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:Q?"":T.id,name:T.name,url:T.url||"",text:T.tagline||T.headline||"",card:T.card}}))}catch{}if(Q||n({type:"focus",id:T.id}),a.dens!=="liste"){const H=$.currentTarget.getBoundingClientRect();n({type:"popup",id:T.id,anchor:{x:H.left+H.width/2,y:H.bottom}})}},title:T.name+(T.tagline?" — "+T.tagline:""),children:[t.jsx(gt,{o:T}),t.jsxs("span",{className:"who",children:[t.jsx(To,{o:T}),t.jsx("span",{className:"co",children:T.name})]}),typeof T.amountEur=="number"&&T.amountEur>0&&t.jsx("span",{className:"am",children:sc(T.amountEur)}),T.sector&&t.jsx("span",{className:"mt",children:T.sector}),t.jsx(Ra,{o:T}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(T.id||T.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:x?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>b(g=>!g),children:[N(d),t.jsx("b",{children:w(d)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:L}),A.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===d,onClick:()=>{h(g.k),b(!1)},children:[N(g.k),t.jsx("b",{children:w(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:E,children:[R(0),R(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:x?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",x?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(Ms,{isEn:x})]})}const Rs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Ms({isEn:e}){const[a,r]=u.useState(()=>Pr());u.useEffect(()=>{const o=i=>{var s;return r(!!((s=i.detail)!=null&&s.open))};return window.addEventListener(ya,o),()=>window.removeEventListener(ya,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>ri(!a),children:Rs})}const jn="+33 6 83 10 72 86",Na="alexandre@proplace.co",Jr=`tel:${jn.replace(/[^\d+]/g,"")}`;function Os(){return null}class at extends u.Component{constructor(){super(...arguments);qn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Xr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function tr(e,a){if((bt(e)||"").startsWith("CALL")&&Ae(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ae(e)>=2;return Xr.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const ar=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",Ds={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function Is({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:s}=Y(),[l,c]=u.useState(""),[x,d]=u.useState(!1),[h,p]=u.useState(!1),b=u.useRef(null);if(u.useEffect(()=>{if(!h)return;const j=E=>{b.current&&!b.current.contains(E.target)&&(p(!1),d(!1))};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[h]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),v=async j=>{if(l)return;if(j==="Analysé"&&!e.memoUrl){d(!0);return}c(j);const E=(tr(e,a).find(([N])=>N===j)||[j,j])[1],w=await o(e,j,{msg:a.csMoved(e.name,E)});c(""),w&&(d(!1),p(!1))},y=tr(e,a),f=j=>(y.find(([E])=>E===j)||[])[1]||j;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:j=>j.stopPropagation(),children:y.map(([j,E])=>t.jsx("button",{type:"button",className:"rsd "+(j==="Validé"?"yes":"no")+(l===j?" busy":""),disabled:!!l,onClick:()=>{v(j)},children:E},j))}):t.jsxs("span",{className:"rstat"+(h||x?" rs-open":""),ref:b,onClick:j=>j.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":h,disabled:!!l,title:a.csLabel,className:"rsel rs-"+ar(m),onClick:()=>{p(j=>!j),d(!1)},children:l?f(l)+"…":m?f(m):a.csNone}),h&&!x&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([j,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===j,className:"rsopt"+(m===j?" on":"")+(l===j?" busy":""),disabled:!!l,onClick:()=>{if(j===m){p(!1);return}v(j)},children:[t.jsx("i",{className:"pt2",style:{background:Ds[ar(j)]}}),E]},j))}),x&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{i(e),d(!1),p(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const j=await o(e,"Analysé");c(""),j&&(d(!1),p(!1))})()},children:a.csAnaAnyway})]})})]})}function Ps({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Y(),[i,s]=u.useState(""),[l,c]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),d=(bt(e)||"").startsWith("CALL")&&Ae(e)===3,h=Ae(e)>=2,p=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(m);const v=await o(e,m);s(""),v&&(c(!0),setTimeout(()=>c(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:Xr.filter(([m])=>!(h&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(x===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{p(m)},children:v},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Bs,{o:e})]})}function Bs({o:e}){const{t:a,saveNote:r,flash:n}=Y(),[o,i]=u.useState(e.ceoNote||""),[s,l]=u.useState(!1),[c,x]=u.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),h=async()=>{if(s||!d)return;l(!0);const p=await r(e,o.trim());l(!1),p&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:s,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&h()}}),t.jsx("button",{type:"button",disabled:s||!d,onClick:()=>{h()},children:c?a.csNoteSaved:a.csNoteOk})]})}function _s({placeholder:e,onDone:a}){const{t:r}=Y(),[n,o]=u.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function $s({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:s,flashErr:l}=Y(),[c,x]=u.useState(!1);if(!n.pipe||!o||n.lockActions||Ae(e)!==4)return null;const d=i(e),h=(d==null?void 0:d.stage)||"todo",p=async f=>{if(c||f===h)return;x(!0);const j=d;s(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const E=Math.max(Date.now(),nr+=1);nr=E;const w=await oi(r,{company:e.name||"",stage:f,cts:E,deal_id:e.airtableId,check_id:e.checkId});x(!1),!w.stale&&(w.ok||(s(e,j),l(a.actErr)))},b=(y=d==null?void 0:d.stamps)==null?void 0:y.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=h==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,j])=>t.jsx("button",{type:"button",className:"stgb"+(h===f?" on":""),disabled:c,onClick:()=>{p(f)},children:j},f)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let nr=0;const Vt=8,xt=360;function rr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function or({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(rr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(rr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function Us({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Y(),[s,l]=u.useState(0),[c,x]=u.useState(null),[d,h]=u.useState([]),p=u.useRef(!1),b=u.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=u.useRef(!1);u.useEffect(()=>{const S=b.current;return()=>{m.current||(n({type:"ptab",tab:S.ptab}),n({type:"dens",dens:S.dens}),n({type:"modal",modal:S.modal}))}},[]),u.useEffect(()=>{p.current||(p.current=!0,h(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const v=d[s],y=s>=d.length;u.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const S=v.click,q=window.setTimeout(()=>{const z=document.querySelector(S);z&&z.getAttribute("aria-selected")!=="true"&&z.click()},60);return()=>window.clearTimeout(q)}},[s,v]);const f=u.useRef(-1),j=u.useCallback(()=>{if(!v){x(null);return}const S=F=>{if(!F)return null;for(const D of document.querySelectorAll(F)){const B=D.getBoundingClientRect();if(B.width>1&&B.height>1)return D}return null},q=S(v.sel)||S(v.need);if(!q){x(null);return}f.current!==s&&(f.current=s,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const z=q.getBoundingClientRect();x(F=>F&&Math.abs(F.top-z.top)<1&&Math.abs(F.left-z.left)<1&&Math.abs(F.width-z.width)<1&&Math.abs(F.height-z.height)<1?F:z)},[v,s]);u.useLayoutEffect(()=>{j();const S=[90,300,700,1300].map(F=>window.setTimeout(j,F)),q=window.setInterval(j,400),z=()=>j();return window.addEventListener("scroll",z,!0),window.addEventListener("resize",z),()=>{S.forEach(F=>window.clearTimeout(F)),window.clearInterval(q),window.removeEventListener("scroll",z,!0),window.removeEventListener("resize",z)}},[j]);const E=u.useRef(a);if(E.current=a,u.useEffect(()=>{const S=q=>{q.key==="Escape"?(q.preventDefault(),q.stopPropagation(),E.current()):q.key==="ArrowRight"?l(z=>z+1):q.key==="ArrowLeft"&&l(z=>Math.max(0,z-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!d.length)return null;let w=null;const N=S=>()=>{m.current=!0,n({type:"modal",modal:null}),S()};if(y){const S=o[3]||0;S>0?w={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?w={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?w={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let A={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:xt};if(!y&&c){const S=c.bottom+14,q=window.innerHeight-S;let z=q>190?S:Math.max(12,c.top-200),F=Math.min(Math.max(12,c.left+c.width/2-xt/2),window.innerWidth-xt-12);q<=190&&c.top<212&&(window.innerWidth-c.right>=xt+40?F=Math.min(c.right+26,window.innerWidth-xt-12):c.left>=xt+40&&(F=Math.max(12,c.left-xt-26)),z=Math.max(12,c.top-Vt)),A={left:F,top:z,width:xt}}return It.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Vt,top:c.top-Vt,width:c.width+Vt*2,height:c.height+Vt*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:A,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(or,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(or,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>l(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(S=>S+1),children:s===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Zr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function eo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Hs(){var q,z;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:s,data:l,dispatch:c}=Y(),x=r?a:e,d=u.useMemo(()=>x.filter(F=>mt(F.date)===0&&F.kind==="target"),[x]),h=u.useMemo(()=>r?a.filter(F=>F.kind==="target"&&Ae(F)===0).slice().sort((F,D)=>(D.date||"").localeCompare(F.date||"")):[],[a,r]),p=u.useMemo(()=>d.filter(F=>r?Ae(F)===0:!De(F)),[d,r]),b=r?h:p,m=r?a.length-h.length:d.length-p.length,v=r?a.length:d.length,y=v?Math.min(100,m/v*100):100,f=u.useMemo(()=>Zr(x),[x]),j=!!f&&mt(f)>0,E=u.useMemo(()=>j?x.filter(F=>(F.date||"").slice(0,10)===f):[],[x,f,j]),w=typeof((q=l.stats)==null?void 0:q.kept_today)=="number"?l.stats.kept_today:null,N=typeof((z=l.stats)==null?void 0:z.screened_today)=="number"?l.stats.screened_today:d.length;let A;j?A=o.morningLast(E.length,h.length,eo(f,s)):r?A=o.morningThesis(N,h.length,w):d.length?m===0?A=o.goalSourced(d.length):m>=d.length?A=o.goalCleared:A=o.goalDone(m,d.length):A=o.goalSourced(0);const S=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&h.length&&c({type:"chainStart",queue:h.map(F=>F.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:A}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:S,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Vs(){var $,Q;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:s,dossiers:l,mode:c,doSync:x,startTour:d,flash:h,flashErr:p}=Y(),[b,m]=u.useState(null),[v,y]=u.useState(!0),[f,j]=u.useState([]),E=c==="client";u.useEffect(()=>{if(!o||!i)return;let H=!0;return y(!0),(async()=>{const[M,K]=await Promise.all([vn(i),Br(o)]);H&&(M&&m(M),y(!1),j(K))})(),()=>{H=!1}},[o,i]);const[w,N]=u.useState(!1),A=()=>{!E||w||!i||(N(!0),ii(i).then(H=>{N(!1),H?h(e.identRepubDone):p(e.actErr)}))},S=(b==null?void 0:b.per_day)??null,q=(($=b==null?void 0:b.pool_order)==null?void 0:$.length)??0,z=f.filter(H=>H.status==="running").length,F=u.useMemo(()=>l.filter(H=>H.kind==="target"&&De(H)).length,[l]),D=s.marketEstimate,B=typeof((Q=s.stats)==null?void 0:Q.screened)=="number"?s.stats.screened:F,L=D&&D>0?Math.min(100,Math.round(B/D*100)):null,R=H=>H.toLocaleString(a==="en"?"en-US":"fr-FR"),g=(i||"P").split(/\s+/).map(H=>H[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const H=Date.parse(s.generatedAt||"");if(Number.isNaN(H))return"";const M=new Date(H),K=_=>String(_).padStart(2,"0");return`${K(M.getDate())}/${K(M.getMonth()+1)} à ${K(M.getHours())}:${K(M.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?g:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),T?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(T)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&B>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(B)})})]}),L!==null&&D&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(B,D)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),S!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:S})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),S===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),z>0&&t.jsxs("span",{className:"ev",children:["⏳ ",z]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(q)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:H=>{H.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||w,onClick:A,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:H=>n({type:"filters",patch:{search:H.target.value}})})]})]})]})}class Ct{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],s=a+i,l=Math.abs(a)<Math.abs(i)?a-(s-i):i-(s-a);l&&(r[n++]=l),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,o=a[--r],s=n+o,i=o-(s-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=s+o,o==n-s&&(s=n))}return s}}function*Ws(e){for(const a of e)yield*a}function to(e){return Array.from(Ws(e))}var Ne=1e-6,he=Math.PI,Qe=he/2,ir=he/4,Xe=he*2,ct=180/he,Ve=he/180,ze=Math.abs,Gs=Math.atan,Zt=Math.atan2,Te=Math.cos,qe=Math.sin,Ys=Math.sign||function(e){return e>0?1:e<0?-1:0},At=Math.sqrt;function Ks(e){return e>1?0:e<-1?he:Math.acos(e)}function ea(e){return e>1?Qe:e<-1?-Qe:Math.asin(e)}function Je(){}function Ea(e,a){e&&lr.hasOwnProperty(e.type)&&lr[e.type](e,a)}var sr={Feature:function(e,a){Ea(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ea(r[n].geometry,a)}},lr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){tn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)tn(r[n],a,0)},Polygon:function(e,a){dr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)dr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ea(r[n],a)}};function tn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function dr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)tn(e[r],a,1);a.polygonEnd()}function qt(e,a){e&&sr.hasOwnProperty(e.type)?sr[e.type](e,a):Ea(e,a)}function an(e){return[Zt(e[1],e[0]),ea(e[2])]}function Mt(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*qe(a),qe(r)]}function ca(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Sa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ha(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function pa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function nn(e){var a=At(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function rn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function on(e,a){return ze(e)>he&&(e-=Math.round(e/Xe)*Xe),[e,a]}on.invert=on;function Qs(e,a,r){return(e%=Xe)?a||r?rn(pr(e),ur(a,r)):pr(e):a||r?ur(a,r):on}function cr(e){return function(a,r){return a+=e,ze(a)>he&&(a-=Math.round(a/Xe)*Xe),[a,r]}}function pr(e){var a=cr(e);return a.invert=cr(-e),a}function ur(e,a){var r=Te(e),n=qe(e),o=Te(a),i=qe(a);function s(l,c){var x=Te(c),d=Te(l)*x,h=qe(l)*x,p=qe(c),b=p*r+d*n;return[Zt(h*o-b*i,d*r-p*n),ea(b*o+h*i)]}return s.invert=function(l,c){var x=Te(c),d=Te(l)*x,h=qe(l)*x,p=qe(c),b=p*o-h*i;return[Zt(h*o+p*i,d*r+b*n),ea(b*r-d*n)]},s}function Js(e,a,r,n,o,i){if(r){var s=Te(a),l=qe(a),c=n*r;o==null?(o=a+n*Xe,i=a-c/2):(o=mr(s,o),i=mr(s,i),(n>0?o<i:o>i)&&(o+=n*Xe));for(var x,d=o;n>0?d>i:d<i;d-=c)x=an([s,-l*Te(d),-l*qe(d)]),e.point(x[0],x[1])}}function mr(e,a){a=Mt(a),a[0]-=e,nn(a);var r=Ks(-a[1]);return((-a[2]<0?-r:r)+Xe-Ne)%Xe}function ao(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Je,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ga(e,a){return ze(e[0]-a[0])<Ne&&ze(e[1]-a[1])<Ne}function ua(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function no(e,a,r,n,o){var i=[],s=[],l,c;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,y=m[0],f=m[v],j;if(ga(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),l=0;l<v;++l)o.point((y=m[l])[0],y[1]);o.lineEnd();return}f[0]+=2*Ne}i.push(j=new ua(y,m,null,!0)),s.push(j.o=new ua(y,null,j,!1)),i.push(j=new ua(f,m,null,!1)),s.push(j.o=new ua(f,null,j,!0))}}),!!i.length){for(s.sort(a),fr(i),fr(s),l=0,c=s.length;l<c;++l)s[l].e=r=!r;for(var x=i[0],d,h;;){for(var p=x,b=!0;p.v;)if((p=p.n)===x)return;d=p.z,o.lineStart();do{if(p.v=p.o.v=!0,p.e){if(b)for(l=0,c=d.length;l<c;++l)o.point((h=d[l])[0],h[1]);else n(p.x,p.n.x,1,o);p=p.n}else{if(b)for(d=p.p.z,l=d.length-1;l>=0;--l)o.point((h=d[l])[0],h[1]);else n(p.x,p.p.x,-1,o);p=p.p}p=p.o,d=p.z,b=!b}while(!p.v);o.lineEnd()}}}function fr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Va(e){return ze(e[0])<=he?e[0]:Ys(e[0])*((ze(e[0])+he)%Xe-he)}function Xs(e,a){var r=Va(a),n=a[1],o=qe(n),i=[qe(r),-Te(r),0],s=0,l=0,c=new Ct;o===1?n=Qe+Ne:o===-1&&(n=-Qe-Ne);for(var x=0,d=e.length;x<d;++x)if(p=(h=e[x]).length)for(var h,p,b=h[p-1],m=Va(b),v=b[1]/2+ir,y=qe(v),f=Te(v),j=0;j<p;++j,m=w,y=A,f=S,b=E){var E=h[j],w=Va(E),N=E[1]/2+ir,A=qe(N),S=Te(N),q=w-m,z=q>=0?1:-1,F=z*q,D=F>he,B=y*A;if(c.add(Zt(B*z*qe(F),f*S+B*Te(F))),s+=D?q+z*Xe:q,D^m>=r^w>=r){var L=Sa(Mt(b),Mt(E));nn(L);var R=Sa(i,L);nn(R);var g=(D^q>=0?-1:1)*ea(R[2]);(n>g||n===g&&(L[0]||L[1]))&&(l+=D^q>=0?1:-1)}}return(s<-Ne||s<Ne&&c<-1e-12)^l&1}function ro(e,a,r,n){return function(o){var i=a(o),s=ao(),l=a(s),c=!1,x,d,h,p={point:b,lineStart:v,lineEnd:y,polygonStart:function(){p.point=f,p.lineStart=j,p.lineEnd=E,d=[],x=[]},polygonEnd:function(){p.point=b,p.lineStart=v,p.lineEnd=y,d=to(d);var w=Xs(x,n);d.length?(c||(o.polygonStart(),c=!0),no(d,el,w,r,o)):w&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),d=x=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(w,N){e(w,N)&&o.point(w,N)}function m(w,N){i.point(w,N)}function v(){p.point=m,i.lineStart()}function y(){p.point=b,i.lineEnd()}function f(w,N){h.push([w,N]),l.point(w,N)}function j(){l.lineStart(),h=[]}function E(){f(h[0][0],h[0][1]),l.lineEnd();var w=l.clean(),N=s.result(),A,S=N.length,q,z,F;if(h.pop(),x.push(h),h=null,!!S){if(w&1){if(z=N[0],(q=z.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),A=0;A<q;++A)o.point((F=z[A])[0],F[1]);o.lineEnd()}return}S>1&&w&2&&N.push(N.pop().concat(N.shift())),d.push(N.filter(Zs))}}return p}}function Zs(e){return e.length>1}function el(e,a){return((e=e.x)[0]<0?e[1]-Qe-Ne:Qe-e[1])-((a=a.x)[0]<0?a[1]-Qe-Ne:Qe-a[1])}const hr=ro(function(){return!0},tl,nl,[-he,-Qe]);function tl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,s){var l=i>0?he:-he,c=ze(i-a);ze(c-he)<Ne?(e.point(a,r=(r+s)/2>0?Qe:-Qe),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&c>=he&&(ze(a-n)<Ne&&(a-=n*Ne),ze(i-l)<Ne&&(i-=l*Ne),r=al(a,r,i,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=s),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function al(e,a,r,n){var o,i,s=qe(e-r);return ze(s)>Ne?Gs((qe(a)*(i=Te(n))*qe(r)-qe(n)*(o=Te(a))*qe(e))/(o*i*s)):(a+n)/2}function nl(e,a,r,n){var o;if(e==null)o=r*Qe,n.point(-he,o),n.point(0,o),n.point(he,o),n.point(he,0),n.point(he,-o),n.point(0,-o),n.point(-he,-o),n.point(-he,0),n.point(-he,o);else if(ze(e[0]-a[0])>Ne){var i=e[0]<a[0]?he:-he;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function rl(e){var a=Te(e),r=2*Ve,n=a>0,o=ze(a)>Ne;function i(d,h,p,b){Js(b,e,r,p,d,h)}function s(d,h){return Te(d)*Te(h)>a}function l(d){var h,p,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(y,f){var j=[y,f],E,w=s(y,f),N=n?w?0:x(y,f):w?x(y+(y<0?he:-he),f):0;if(!h&&(m=b=w)&&d.lineStart(),w!==b&&(E=c(h,j),(!E||ga(h,E)||ga(j,E))&&(j[2]=1)),w!==b)v=0,w?(d.lineStart(),E=c(j,h),d.point(E[0],E[1])):(E=c(h,j),d.point(E[0],E[1],2),d.lineEnd()),h=E;else if(o&&h&&n^w){var A;!(N&p)&&(A=c(j,h,!0))&&(v=0,n?(d.lineStart(),d.point(A[0][0],A[0][1]),d.point(A[1][0],A[1][1]),d.lineEnd()):(d.point(A[1][0],A[1][1]),d.lineEnd(),d.lineStart(),d.point(A[0][0],A[0][1],3)))}w&&(!h||!ga(h,j))&&d.point(j[0],j[1]),h=j,b=w,p=N},lineEnd:function(){b&&d.lineEnd(),h=null},clean:function(){return v|(m&&b)<<1}}}function c(d,h,p){var b=Mt(d),m=Mt(h),v=[1,0,0],y=Sa(b,m),f=ca(y,y),j=y[0],E=f-j*j;if(!E)return!p&&d;var w=a*f/E,N=-a*j/E,A=Sa(v,y),S=pa(v,w),q=pa(y,N);Ha(S,q);var z=A,F=ca(S,z),D=ca(z,z),B=F*F-D*(ca(S,S)-1);if(!(B<0)){var L=At(B),R=pa(z,(-F-L)/D);if(Ha(R,S),R=an(R),!p)return R;var g=d[0],T=h[0],$=d[1],Q=h[1],H;T<g&&(H=g,g=T,T=H);var M=T-g,K=ze(M-he)<Ne,_=K||M<Ne;if(!K&&Q<$&&(H=$,$=Q,Q=H),_?K?$+Q>0^R[1]<(ze(R[0]-g)<Ne?$:Q):$<=R[1]&&R[1]<=Q:M>he^(g<=R[0]&&R[0]<=T)){var J=pa(z,(-F+L)/D);return Ha(J,S),[R,an(J)]}}}function x(d,h){var p=n?e:he-e,b=0;return d<-p?b|=1:d>p&&(b|=2),h<-p?b|=4:h>p&&(b|=8),b}return ro(s,l,i,n?[0,-e]:[-he,e-he])}function ol(e,a,r,n,o,i){var s=e[0],l=e[1],c=a[0],x=a[1],d=0,h=1,p=c-s,b=x-l,m;if(m=r-s,!(!p&&m>0)){if(m/=p,p<0){if(m<d)return;m<h&&(h=m)}else if(p>0){if(m>h)return;m>d&&(d=m)}if(m=o-s,!(!p&&m<0)){if(m/=p,p<0){if(m>h)return;m>d&&(d=m)}else if(p>0){if(m<d)return;m<h&&(h=m)}if(m=n-l,!(!b&&m>0)){if(m/=b,b<0){if(m<d)return;m<h&&(h=m)}else if(b>0){if(m>h)return;m>d&&(d=m)}if(m=i-l,!(!b&&m<0)){if(m/=b,b<0){if(m>h)return;m>d&&(d=m)}else if(b>0){if(m<d)return;m<h&&(h=m)}return d>0&&(e[0]=s+d*p,e[1]=l+d*b),h<1&&(a[0]=s+h*p,a[1]=l+h*b),!0}}}}}var Wt=1e9,ma=-Wt;function il(e,a,r,n){function o(x,d){return e<=x&&x<=r&&a<=d&&d<=n}function i(x,d,h,p){var b=0,m=0;if(x==null||(b=s(x,h))!==(m=s(d,h))||c(x,d)<0^h>0)do p.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+h+4)%4)!==m);else p.point(d[0],d[1])}function s(x,d){return ze(x[0]-e)<Ne?d>0?0:3:ze(x[0]-r)<Ne?d>0?2:1:ze(x[1]-a)<Ne?d>0?1:0:d>0?3:2}function l(x,d){return c(x.x,d.x)}function c(x,d){var h=s(x,1),p=s(d,1);return h!==p?h-p:h===0?d[1]-x[1]:h===1?x[0]-d[0]:h===2?x[1]-d[1]:d[0]-x[0]}return function(x){var d=x,h=ao(),p,b,m,v,y,f,j,E,w,N,A,S={point:q,lineStart:B,lineEnd:L,polygonStart:F,polygonEnd:D};function q(g,T){o(g,T)&&d.point(g,T)}function z(){for(var g=0,T=0,$=b.length;T<$;++T)for(var Q=b[T],H=1,M=Q.length,K=Q[0],_,J,X=K[0],me=K[1];H<M;++H)_=X,J=me,K=Q[H],X=K[0],me=K[1],J<=n?me>n&&(X-_)*(n-J)>(me-J)*(e-_)&&++g:me<=n&&(X-_)*(n-J)<(me-J)*(e-_)&&--g;return g}function F(){d=h,p=[],b=[],A=!0}function D(){var g=z(),T=A&&g,$=(p=to(p)).length;(T||$)&&(x.polygonStart(),T&&(x.lineStart(),i(null,null,1,x),x.lineEnd()),$&&no(p,l,g,i,x),x.polygonEnd()),d=x,p=b=m=null}function B(){S.point=R,b&&b.push(m=[]),N=!0,w=!1,j=E=NaN}function L(){p&&(R(v,y),f&&w&&h.rejoin(),p.push(h.result())),S.point=q,w&&d.lineEnd()}function R(g,T){var $=o(g,T);if(b&&m.push([g,T]),N)v=g,y=T,f=$,N=!1,$&&(d.lineStart(),d.point(g,T));else if($&&w)d.point(g,T);else{var Q=[j=Math.max(ma,Math.min(Wt,j)),E=Math.max(ma,Math.min(Wt,E))],H=[g=Math.max(ma,Math.min(Wt,g)),T=Math.max(ma,Math.min(Wt,T))];ol(Q,H,e,a,r,n)?(w||(d.lineStart(),d.point(Q[0],Q[1])),d.point(H[0],H[1]),$||d.lineEnd(),A=!1):$&&(d.lineStart(),d.point(g,T),A=!1)}j=g,E=T,w=$}return S}}const sn=e=>e;var Wa=new Ct,ln=new Ct,oo,io,dn,cn,ut={point:Je,lineStart:Je,lineEnd:Je,polygonStart:function(){ut.lineStart=sl,ut.lineEnd=dl},polygonEnd:function(){ut.lineStart=ut.lineEnd=ut.point=Je,Wa.add(ze(ln)),ln=new Ct},result:function(){var e=Wa/2;return Wa=new Ct,e}};function sl(){ut.point=ll}function ll(e,a){ut.point=so,oo=dn=e,io=cn=a}function so(e,a){ln.add(cn*e-dn*a),dn=e,cn=a}function dl(){so(oo,io)}var Ot=1/0,Ca=Ot,ta=-Ot,za=ta,Aa={point:cl,lineStart:Je,lineEnd:Je,polygonStart:Je,polygonEnd:Je,result:function(){var e=[[Ot,Ca],[ta,za]];return ta=za=-(Ca=Ot=1/0),e}};function cl(e,a){e<Ot&&(Ot=e),e>ta&&(ta=e),a<Ca&&(Ca=a),a>za&&(za=a)}var pn=0,un=0,Gt=0,Ta=0,qa=0,Lt=0,mn=0,fn=0,Yt=0,lo,co,st,lt,Ke={point:zt,lineStart:xr,lineEnd:gr,polygonStart:function(){Ke.lineStart=ml,Ke.lineEnd=fl},polygonEnd:function(){Ke.point=zt,Ke.lineStart=xr,Ke.lineEnd=gr},result:function(){var e=Yt?[mn/Yt,fn/Yt]:Lt?[Ta/Lt,qa/Lt]:Gt?[pn/Gt,un/Gt]:[NaN,NaN];return pn=un=Gt=Ta=qa=Lt=mn=fn=Yt=0,e}};function zt(e,a){pn+=e,un+=a,++Gt}function xr(){Ke.point=pl}function pl(e,a){Ke.point=ul,zt(st=e,lt=a)}function ul(e,a){var r=e-st,n=a-lt,o=At(r*r+n*n);Ta+=o*(st+e)/2,qa+=o*(lt+a)/2,Lt+=o,zt(st=e,lt=a)}function gr(){Ke.point=zt}function ml(){Ke.point=hl}function fl(){po(lo,co)}function hl(e,a){Ke.point=po,zt(lo=st=e,co=lt=a)}function po(e,a){var r=e-st,n=a-lt,o=At(r*r+n*n);Ta+=o*(st+e)/2,qa+=o*(lt+a)/2,Lt+=o,o=lt*e-st*a,mn+=o*(st+e),fn+=o*(lt+a),Yt+=o*3,zt(st=e,lt=a)}function uo(e){this._context=e}uo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Xe);break}}},result:Je};var hn=new Ct,Ga,mo,fo,Kt,Qt,aa={point:Je,lineStart:function(){aa.point=xl},lineEnd:function(){Ga&&ho(mo,fo),aa.point=Je},polygonStart:function(){Ga=!0},polygonEnd:function(){Ga=null},result:function(){var e=+hn;return hn=new Ct,e}};function xl(e,a){aa.point=ho,mo=Kt=e,fo=Qt=a}function ho(e,a){Kt-=e,Qt-=a,hn.add(At(Kt*Kt+Qt*Qt)),Kt=e,Qt=a}let br,La,vr,yr;class wr{constructor(a){this._append=a==null?xo:gl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==vr||this._append!==La){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,vr=n,La=this._append,yr=this._,this._=o}this._+=yr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function xo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function gl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return xo;if(a!==br){const r=10**a;br=a,La=function(o){let i=1;this._+=o[0];for(const s=o.length;i<s;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return La}function bl(e,a){let r=3,n=4.5,o,i;function s(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),qt(l,o(i))),i.result()}return s.area=function(l){return qt(l,o(ut)),ut.result()},s.measure=function(l){return qt(l,o(aa)),aa.result()},s.bounds=function(l){return qt(l,o(Aa)),Aa.result()},s.centroid=function(l){return qt(l,o(Ke)),Ke.result()},s.projection=function(l){return arguments.length?(o=l==null?(e=null,sn):(e=l).stream,s):e},s.context=function(l){return arguments.length?(i=l==null?(a=null,new wr(r)):new uo(a=l),typeof n!="function"&&i.pointRadius(n),s):a},s.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),s):n},s.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const c=Math.floor(l);if(!(c>=0))throw new RangeError(`invalid digits: ${l}`);r=c}return a===null&&(i=new wr(r)),s},s.projection(e).digits(r).context(a)}function Nn(e){return function(a){var r=new xn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function xn(){}xn.prototype={constructor:xn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function En(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),qt(r,e.stream(Aa)),a(Aa.result()),n!=null&&e.clipExtent(n),e}function go(e,a,r){return En(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],s=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-s*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([l,c])},r)}function vl(e,a,r){return go(e,[[0,0],a],r)}function yl(e,a,r){return En(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),s=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([s,l])},r)}function wl(e,a,r){return En(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),s=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([s,l])},r)}var kr=16,kl=Te(30*Ve);function jr(e,a){return+a?Nl(e,a):jl(e)}function jl(e){return Nn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Nl(e,a){function r(n,o,i,s,l,c,x,d,h,p,b,m,v,y){var f=x-n,j=d-o,E=f*f+j*j;if(E>4*a&&v--){var w=s+p,N=l+b,A=c+m,S=At(w*w+N*N+A*A),q=ea(A/=S),z=ze(ze(A)-1)<Ne||ze(i-h)<Ne?(i+h)/2:Zt(N,w),F=e(z,q),D=F[0],B=F[1],L=D-n,R=B-o,g=j*L-f*R;(g*g/E>a||ze((f*L+j*R)/E-.5)>.3||s*p+l*b+c*m<kl)&&(r(n,o,i,s,l,c,D,B,z,w/=S,N/=S,A,v,y),y.point(D,B),r(D,B,z,w,N,A,x,d,h,p,b,m,v,y))}}return function(n){var o,i,s,l,c,x,d,h,p,b,m,v,y={point:f,lineStart:j,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=N},polygonEnd:function(){n.polygonEnd(),y.lineStart=j}};function f(q,z){q=e(q,z),n.point(q[0],q[1])}function j(){h=NaN,y.point=E,n.lineStart()}function E(q,z){var F=Mt([q,z]),D=e(q,z);r(h,p,d,b,m,v,h=D[0],p=D[1],d=q,b=F[0],m=F[1],v=F[2],kr,n),n.point(h,p)}function w(){y.point=f,n.lineEnd()}function N(){j(),y.point=A,y.lineEnd=S}function A(q,z){E(o=q,z),i=h,s=p,l=b,c=m,x=v,y.point=E}function S(){r(h,p,d,b,m,v,i,s,o,l,c,x,kr,n),y.lineEnd=w,w()}return y}}var El=Nn({point:function(e,a){this.stream.point(e*Ve,a*Ve)}});function Sl(e){return Nn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Cl(e,a,r,n,o){function i(s,l){return s*=n,l*=o,[a+e*s,r-e*l]}return i.invert=function(s,l){return[(s-a)/e*n,(r-l)/e*o]},i}function Nr(e,a,r,n,o,i){if(!i)return Cl(e,a,r,n,o);var s=Te(i),l=qe(i),c=s*e,x=l*e,d=s/e,h=l/e,p=(l*r-s*a)/e,b=(l*a+s*r)/e;function m(v,y){return v*=n,y*=o,[c*v-x*y+a,r-x*v-c*y]}return m.invert=function(v,y){return[n*(d*v-h*y+p),o*(b-h*v-d*y)]},m}function zl(e){return Al(function(){return e})()}function Al(e){var a,r=150,n=480,o=250,i=0,s=0,l=0,c=0,x=0,d,h=0,p=1,b=1,m=null,v=hr,y=null,f,j,E,w=sn,N=.5,A,S,q,z,F;function D(g){return q(g[0]*Ve,g[1]*Ve)}function B(g){return g=q.invert(g[0],g[1]),g&&[g[0]*ct,g[1]*ct]}D.stream=function(g){return z&&F===g?z:z=El(Sl(d)(v(A(w(F=g)))))},D.preclip=function(g){return arguments.length?(v=g,m=void 0,R()):v},D.postclip=function(g){return arguments.length?(w=g,y=f=j=E=null,R()):w},D.clipAngle=function(g){return arguments.length?(v=+g?rl(m=g*Ve):(m=null,hr),R()):m*ct},D.clipExtent=function(g){return arguments.length?(w=g==null?(y=f=j=E=null,sn):il(y=+g[0][0],f=+g[0][1],j=+g[1][0],E=+g[1][1]),R()):y==null?null:[[y,f],[j,E]]},D.scale=function(g){return arguments.length?(r=+g,L()):r},D.translate=function(g){return arguments.length?(n=+g[0],o=+g[1],L()):[n,o]},D.center=function(g){return arguments.length?(i=g[0]%360*Ve,s=g[1]%360*Ve,L()):[i*ct,s*ct]},D.rotate=function(g){return arguments.length?(l=g[0]%360*Ve,c=g[1]%360*Ve,x=g.length>2?g[2]%360*Ve:0,L()):[l*ct,c*ct,x*ct]},D.angle=function(g){return arguments.length?(h=g%360*Ve,L()):h*ct},D.reflectX=function(g){return arguments.length?(p=g?-1:1,L()):p<0},D.reflectY=function(g){return arguments.length?(b=g?-1:1,L()):b<0},D.precision=function(g){return arguments.length?(A=jr(S,N=g*g),R()):At(N)},D.fitExtent=function(g,T){return go(D,g,T)},D.fitSize=function(g,T){return vl(D,g,T)},D.fitWidth=function(g,T){return yl(D,g,T)},D.fitHeight=function(g,T){return wl(D,g,T)};function L(){var g=Nr(r,0,0,p,b,h).apply(null,a(i,s)),T=Nr(r,n-g[0],o-g[1],p,b,h);return d=Qs(l,c,x),S=rn(a,T),q=rn(d,S),A=jr(S,N),R()}function R(){return z=F=null,D}return function(){return a=e.apply(this,arguments),D.invert=a.invert&&B,L()}}function bo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}bo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,s=i*i;r-=o=(r*(1.007226+i*(.015085+s*(-.044475+.028874*i-.005916*s)))-a)/(1.007226+i*(.015085*3+s*(-.044475*7+.028874*9*i-.005916*11*s)))}while(ze(o)>Ne&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Tl(){return zl(bo).scale(175.295)}function ql(e){return e}function Ll(e){if(e==null)return ql;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],s=e.translate[1];return function(l,c){c||(a=r=0);var x=2,d=l.length,h=new Array(d);for(h[0]=(a+=l[0])*n+i,h[1]=(r+=l[1])*o+s;x<d;)h[x]=l[x],++x;return h}}function Fl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Rl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Er(e,r)})}:Er(e,a)}function Er(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Ml(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Ml(e,a){var r=Ll(e.transform),n=e.arcs;function o(d,h){h.length&&h.pop();for(var p=n[d<0?~d:d],b=0,m=p.length;b<m;++b)h.push(r(p[b],b));d<0&&Fl(h,m)}function i(d){return r(d)}function s(d){for(var h=[],p=0,b=d.length;p<b;++p)o(d[p],h);return h.length<2&&h.push(h[0]),h}function l(d){for(var h=s(d);h.length<4;)h.push(h[0]);return h}function c(d){return d.map(l)}function x(d){var h=d.type,p;switch(h){case"GeometryCollection":return{type:h,geometries:d.geometries.map(x)};case"Point":p=i(d.coordinates);break;case"MultiPoint":p=d.coordinates.map(i);break;case"LineString":p=s(d.arcs);break;case"MultiLineString":p=d.arcs.map(s);break;case"Polygon":p=c(d.arcs);break;case"MultiPolygon":p=d.arcs.map(c);break;default:return null}return{type:h,coordinates:p}}return x(a)}const vo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Ol=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Dl(e,a,r){const n=vo[e];if(!n||!n.length)return-1;const o=Ol(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(s=>o.includes(s)))return i}return Math.floor(r*n.length)%n.length}let fa=null;function Il(){return fa||(fa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Rl(r,n),i=Tl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=bl(i),l=(o.features||[]).filter(d=>{var h;return(((h=d.properties)==null?void 0:h.name)||"")!=="Antarctica"}).map(d=>{var b;const h=((b=d.properties)==null?void 0:b.name)||"",p=s(d)||"";return p?{i2:si(h)||null,n:h,d:p}:null}).filter(d=>!!d);if(!l.length)return null;const c={};for(const[d,h]of Object.entries(li)){const p=i(h);p&&(c[d]={x:p[0],y:p[1]})}const x={};for(const[d,h]of Object.entries(vo)){const p=h.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));p.length&&(x[d]=p)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:c,metros:x}}catch{return null}})(),fa)}function Pl(e){const[a,r]=u.useState(null);return u.useEffect(()=>{if(!e||a)return;let n=!1;return Il().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Bl="8 40 984 210",_l={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Sr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Cr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function $l(e,a){const[r,n]=u.useState(1);return u.useEffect(()=>{let o=!0,i=0;const s=()=>{var x;if(!o)return;const c=(x=e.current)==null?void 0:x.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(s)};s();const l=new ResizeObserver(()=>s());return e.current&&l.observe(e.current),window.addEventListener("resize",s),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function zr({msgs:e}){const[a,r]=u.useState(0);u.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],s)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Ul(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:s,lang:l,t:c,data:x,dossiers:d,source:h}=Y(),p=x.loading&&!d.length,b=u.useRef(null),m=u.useRef(null),v=Pl(e.continent==="monde"),y=e.continent==="monde"?v:yn.find(g=>g.key===e.continent)||null,f=$l(b,e.continent+":"+e.mapFolded+":"+!!y),[j,E]=u.useState(new Map),[w,N]=u.useState(null);u.useEffect(()=>{const g=b.current;if(!g)return;const T=new Map;g.querySelectorAll("path[data-i2]").forEach($=>{const Q=$.dataset.i2;if(Q)try{const H=$.getBBox();H.width>0&&T.set(Q,{x:H.x,y:H.y,w:H.width,h:H.height})}catch{}}),E(T)},[e.continent,f,y]);const A=u.useMemo(()=>r.filter(g=>g.cc),[r]),S=u.useMemo(()=>{const g=new Map;return A.forEach(T=>g.set(T.cc,(g.get(T.cc)||0)+1)),g},[A]),q=e.continent==="monde"&&v?v.anchors:null,z=e.continent==="monde"&&v?v.metros:null,F=u.useMemo(()=>A.map(g=>{const T=Cr(g.name||g.id||""),$=Cr((g.id||g.name||"")+"·y");if(q&&g.cc){const _=z?z[g.cc]:void 0;if(_&&_.length){const X=Dl(g.cc,g.city,T);if(X>=0&&_[X])return{d:g,x:_[X].x+(T-.5)*5,y:_[X].y+($-.5)*5}}const J=q[g.cc];if(J)return{d:g,x:J.x+(T-.5)*10,y:J.y+($-.5)*10}}const Q=g.cc?j.get(g.cc):void 0;if(!Q)return null;const H=_l[`${e.continent}:${g.cc||""}`];if(H)return{d:g,x:Q.x+Q.w*(H.fx+(T-.5)*H.sx),y:Q.y+Q.h*(H.fy+($-.5)*H.sy)};const M=(T-.5)*Math.min(Q.w*.55,60),K=($-.5)*Math.min(Q.h*.55,60);return{d:g,x:Q.x+Q.w/2+M,y:Q.y+Q.h/2+K}}).filter(g=>!!g),[A,j,q,z,e.continent]),D=g=>f>0?g/f:g,B=u.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:Sr[g],fr:c.plabels[g].toUpperCase(),en:c.plabels[g].toUpperCase(),n:r.filter(T=>T.kind==="target"&&Ae(T)===g).length})).filter(g=>g.n>0):Dn.map((g,T)=>({...g,n:r.filter($=>In($)===T).length})),[r,n,c.plabels]),L=i?s.get(i):null,R=L?F.find(g=>g.d.id===L.id):null;return y?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:[p&&t.jsx(zr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?Bl:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?y.fr:y.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:y.countries.map((g,T)=>t.jsx("g",{className:"ct"+(g.i2&&S.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},T))}),t.jsx("g",{children:F.map(g=>{const T=Dn[In(g.d)],$=!!Re(g.d),Q=g.d.kind==="target",H=n&&Q?Sr[Ae(g.d)]:T.c,M=!n&&De(g.d);return t.jsxs("g",{className:"co"+(M?" done":""),onMouseEnter:()=>{var J,X;const K=(J=m.current)==null?void 0:J.getBoundingClientRect(),_=(X=b.current)==null?void 0:X.createSVGPoint();if(_&&b.current&&K){_.x=g.x,_.y=g.y;const me=_.matrixTransform(b.current.getScreenCTM());N({x:me.x-K.left,y:me.y-K.top,label:g.d.name+" · "+(Pt(g.d.cc,l)||g.d.countryLabel||"")})}o(g.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var J;if(h==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const K=(J=b.current)==null?void 0:J.createSVGPoint();let _=null;if(K&&b.current){K.x=g.x,K.y=g.y;const X=K.matrixTransform(b.current.getScreenCTM());_={x:X.x,y:X.y}}a({type:"popup",id:g.d.id,anchor:_})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:D(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:D(T.px),fill:H,stroke:$?"#DC2626":"#ffffff",strokeWidth:D($?2.2:1.3)})]},g.d.id||g.d.name)})}),R&&t.jsx("circle",{className:"ring on",cx:R.x,cy:R.y,r:D(13),fill:"none",stroke:"#0F172A",strokeWidth:D(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:B.map((g,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),l==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},T))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:t.jsx(zr,{msgs:c.loadMsgs})})}function Hl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function yo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:s,lang:l}=Y(),c=a.filters,[x,d]=u.useState(!1),[h,p]=u.useState(!1),b=u.useRef(null),m=u.useRef(null),v=u.useMemo(()=>a.continent==="monde"?n:n.filter(R=>R.continent===a.continent),[n,a.continent]),y=R=>v.filter(g=>R!=="country"&&c.country.length&&!c.country.includes(g.cc||"")?!1:ja(g,c,i,R==="country"?void 0:R)),f=R=>!i||R.kind!=="op",j=u.useMemo(()=>{const R=y("win").filter(f),g=T=>R.filter($=>($.date?Math.max(0,Math.floor((Date.now()-Date.parse($.date))/864e5)):9999)<=T).length;return[g(0),g(7),g(30),R.length]},[v,c,i]),E=u.useMemo(()=>c.day?y("win").filter(f).filter(R=>(R.date||"").slice(0,10)===c.day).length:0,[v,c,i]),w=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,N=w+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);u.useEffect(()=>{a.openFacet&&d(!1)},[a.openFacet]),u.useEffect(()=>{if(!x&&!h)return;const R=T=>{var Q,H;const $=T.target;x&&!((Q=b.current)!=null&&Q.contains($))&&d(!1),h&&!((H=m.current)!=null&&H.contains($))&&p(!1)},g=T=>{T.key==="Escape"&&(d(!1),p(!1))};return document.addEventListener("mousedown",R),document.addEventListener("keydown",g),()=>{document.removeEventListener("mousedown",R),document.removeEventListener("keydown",g)}},[x,h]);const A=(R,g,T,$="fbtn")=>t.jsxs("button",{type:"button",className:$,"aria-expanded":a.openFacet===R,onClick:()=>r({type:"openFacet",facet:R}),children:[t.jsx("span",{className:"fl",children:g}),T>0&&t.jsx("span",{className:"n",children:T}),t.jsx("span",{className:"cv",children:"▾"})]},R),S=["1","7","30","all"],q=Math.max(0,S.indexOf(c.win||"all")),z=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(Hl(c.day,l))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>p(R=>!R),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[q]}),t.jsx("b",{children:j[q]}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:S.map((R,g)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===R,onClick:()=>{r({type:"filters",patch:{win:R}}),p(!1)},children:[o.datesShort[g],t.jsx("span",{className:"n",children:j[g]})]},R))})]}):t.jsx("div",{className:"seg",children:S.map((R,g)=>t.jsxs("button",{type:"button","aria-pressed":c.win===R,onClick:()=>r({type:"filters",patch:{win:R}}),children:[t.jsx("span",{className:"sl",children:o.dates[g]}),t.jsx("b",{children:j[g]})]},R))}),F=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:R=>r({type:"filters",patch:{search:R.target.value}})})]}),D=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):A("sec",o.fSector,c.sector.length),A("pay",o.fCountry,c.country.length),A("det",o.fEngine,c.engine.length),A("sta",o.fStage,c.stage.length),i&&A("ang","Angle",c.angle.length),i&&A("mem","Mémo",c.memoLevel.length)]}),B=(R=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),R&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(w?" on":""),"aria-expanded":x,"aria-haspopup":"true",onClick:()=>{d(R=>!R),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),w>0&&t.jsx("span",{className:"n",children:w}),t.jsx("span",{className:"cv",children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:D})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:z}),t.jsxs("div",{className:"fstrip-b",children:[F,L,B(!1)]})]}),a.openFacet&&t.jsx(Ar,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[z,F,D,t.jsx("span",{className:"fgrow"}),B()]}),a.openFacet&&t.jsx(Ar,{poolFor:y})]})}function Ar({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=Y(),i=a.filters,s=a.openFacet,{title:l,cols:c,options:x}=u.useMemo(()=>{if(s==="sig"){const m=e("signal").filter(f=>Re(f)),v=new Map;m.forEach(f=>{const j=f.engine||"";v.set(j,(v.get(j)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Qa([...v.keys()],o).map(f=>({v:f,label:St(f)+" "+Ge(f,o),n:v.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(s==="sec"){const m=e("sector"),v=new Map;return m.forEach(y=>{y.sector&&v.set(y.sector,(v.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:i.sector.includes(y)}))}}if(s==="pay"){const m=e("country"),v=new Map;return m.forEach(y=>{y.cc&&v.set(y.cc,(v.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:Pt(y,o)||y,n:f,html:!1,on:i.country.includes(y)}))}}if(s==="det"){const m=e("engine"),v=new Map;return m.forEach(y=>{y.engine&&v.set(y.engine,(v.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Qa([...v.keys()],o).map(y=>({v:y,label:St(y)+" "+Ge(y,o)+' <span style="color:var(--dim);font-size:10px">· '+di(ci(y),o)+"</span>",n:v.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(s==="ang"){const m=e("angle"),v=new Map;return m.forEach(y=>{y.angle&&v.set(y.angle,(v.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(y)}))}}if(s==="mem"){const m=e("memoLevel"),v=new Map;m.forEach(f=>{if(f.kind==="target"){const j=bn(f);v.set(j,(v.get(j)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:y[f],n:v.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const p=e("stage"),b=new Map;return p.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,v)=>v[1]-m[1]).map(([m,v])=>({v:m,label:m,n:v,html:!1,on:i.stage.includes(m)}))}},[s,a,o]),d=p=>{if(s==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(p)?i.signalEngines.filter(v=>v!==p):[...i.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:p})},h=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:h,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:x.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>d(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function wo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:s,t:l}=Y(),c=u.useMemo(()=>{const b={};return r.forEach(m=>{ja(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[x,d]=u.useState(!1),h=u.useRef(null);u.useEffect(()=>{if(!x)return;const b=v=>{var y;(y=h.current)!=null&&y.contains(v.target)||d(!1)},m=v=>{v.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[x]);const p=b=>{const m=yn.find(v=>v.key===b);return b==="monde"?l.contWorld:s==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:h,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>d(b=>!b),children:[p(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Pn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),d(!1)},children:[p(b),t.jsx("span",{className:"n",children:c[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[Pn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[p(b),t.jsx("span",{className:"n",children:c[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function ko(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Vl(e){var o;const a=[],r=new Set,n=i=>{const s=(i||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Tr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:s}){const{t:l}=Y();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:l.rsEvalOne})]},c.name))})]}):null}function jo({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=Y(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Tr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Tr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Wl({card:e,onEvaluate:a,onAddAll:r}){var l,c,x;const{t:n}=Y(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ko(e.summary_md||"").map((d,h)=>t.jsx("p",{children:d},h))})]}),t.jsx(jo,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Gl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Yl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:s}=Y(),l=o,[c,x]=u.useState(null),[d,h]=u.useState(null),[p,b]=u.useState(null),[m,v]=u.useState(!1);u.useEffect(()=>{let f=!0;return(async()=>{const j=await _r({email:s,cbToken:l});f&&x(j)})(),()=>{f=!1}},[s,l,n]);const y=f=>{h(f),b(null),v(!0),(async()=>{const j=await pi(f.id);b(j),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{h(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Gl(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!p&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&p&&t.jsx(Wl,{card:p,onEvaluate:a,onAddAll:r})]})]})}const ba=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Jt(e){return/^https?:\/\//i.test((e||"").trim())}function ot(e){const a=(e||"").trim();return a?Jt(a)?a:ba.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Kl(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Ql(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:s,evalBusy:l,evalCards:c,caps:x,data:d,canWrite:h,source:p,dossiers:b,doAnalyse:m,liveMemos:v,pipe:y}=Y(),f=a==="client",j=u.useMemo(()=>r||(p!=="default"?ui():""),[r,p]),[E,w]=u.useState(""),[N,A]=u.useState(!1),[S,q]=u.useState(""),[z,F]=u.useState(""),[D,B]=u.useState(""),[L,R]=u.useState(!1),[g,T]=u.useState(!1),[$,Q]=u.useState(""),[H,M]=u.useState(!1),[K,_]=u.useState(""),[J,X]=u.useState([]),me=u.useRef(!1),[U,se]=u.useState(!1),[fe,Le]=u.useState(!1),[ae,ue]=u.useState(!1),xe=u.useRef(!1),[ce,Z]=u.useState(""),[re,le]=u.useState(""),[be,Se]=u.useState(!1),[oe,pe]=u.useState(!1),[_e,Ie]=u.useState(0),[Ce,ve]=u.useState(""),[ye,He]=u.useState(null),[Fe,dt]=u.useState(null),[ft,vt]=u.useState(!1),[nt,yt]=u.useState(null),[wt,Ze]=u.useState(0),ht=u.useRef(!1),kt=E.trim()?ba.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting,C=u.useMemo(()=>$.split(`
`).map(I=>I.trim()).filter(Boolean).slice(0,15),[$]);u.useEffect(()=>{if(typeof window>"u")return;const I=new URLSearchParams(window.location.search),ee=(I.get("rs")||"").trim(),ie=(I.get("rstext")||"").trim();ee&&/^https?:\/\//i.test(ee)&&Z(ee),ie&&le(ie),(ee&&/^https?:\/\//i.test(ee)||ie)&&se(!0)},[]),u.useEffect(()=>{const I=ee=>{const ie=ee.detail||{},k=String(ie.url||"").trim(),P=String(ie.text||"").trim();k&&/^https?:\/\//i.test(k)&&Z(k),P&&le(P),(k&&/^https?:\/\//i.test(k)||P)&&(se(!0),w(""),q(""),Se(!0),window.setTimeout(()=>Se(!1),900))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),u.useEffect(()=>{const I=ee=>{const ie=ee.detail||{},k=String(ie.name||"").trim();if(!k)return;se(!1),w(k),q(k);const P=ot(String(ie.website||ie.domain||""));F(P),B(ot(String(ie.url||""))),R(!P),A(!0),window.setTimeout(()=>A(!1),900)};return window.addEventListener("ppmap:prefill",I),()=>window.removeEventListener("ppmap:prefill",I)},[]),u.useEffect(()=>{const I=(S||"").trim();if(!I||U||z){(z||!I||U)&&R(!1);return}const ee=b.find(P=>Be(P.name)===Be(I)),ie=ot((ee==null?void 0:ee.website)||"")||ot((ee==null?void 0:ee.domain)||"");if(ie){F(ie),R(!1);return}let k=!0;return R(!0),$r(I).then(P=>{var W,te;if(!k)return;const O=ot(P.website||"")||ot(((te=(W=P.candidates)==null?void 0:W[0])==null?void 0:te.url)||"");O&&F(O)}).catch(()=>{}).finally(()=>{k&&R(!1)}),()=>{k=!1}},[S,U,z,b]),u.useEffect(()=>{const I=ee=>{var k;const ie=String(((k=ee.detail)==null?void 0:k.url)||"").trim();Jt(ie)&&window.open(ie,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",I),()=>window.removeEventListener("ppmap:view",I)},[]),u.useEffect(()=>{if(xe.current===U)return;xe.current=U,ue(!0);const I=window.setTimeout(()=>ue(!1),560);return()=>window.clearTimeout(I)},[U]),u.useEffect(()=>{if(typeof window>"u")return;const I=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ee=document.querySelector(".atl2.ops, .atl2.cibles");if(!I||!ee)return;const ie=()=>ee.style.setProperty("--demand-h",`${I.offsetHeight}px`);ie();const k=new ResizeObserver(ie);return k.observe(I),()=>k.disconnect()},[p,N,be,g,U,ae,L]),u.useEffect(()=>{if(!h&&!j){yt(null);return}let I=!0;return(async()=>{const ee=await _r({email:n,cbToken:j});I&&yt(ee.length)})(),()=>{I=!1}},[h,j,n,wt]);const G=J.length?J:c,V=d.credits,ne=u.useCallback(I=>{const ee=I.map(ie=>(ie||"").trim()).filter(Boolean);ee.length&&(Q(ie=>{const k=ie.split(`
`).map(W=>W.trim()).filter(Boolean),P=new Set(k.map(W=>W.toLowerCase())),O=ee.filter(W=>!P.has(W.toLowerCase()));return[...k,...O].slice(0,15).join(`
`)}),T(!0))},[]);u.useEffect(()=>{if(!oe)return;Ie(0);const I=window.setInterval(()=>Ie(ee=>ee+1),1e3);return()=>window.clearInterval(I)},[oe]);const ge=u.useMemo(()=>{const I=E.trim().toLowerCase();return!I||!y?null:b.find(ee=>Be(ee.name)===I&&Ae(ee)===1)||null},[E,b,y]),de=()=>{const I=E.trim();if(I){if(ge){m(ge);return}o(null,I),f&&w("")}},Me=async()=>{if(!f){o(null,C[0]||"");return}if(!C.length||H)return;M(!0),me.current=!1;const I=[];for(let ee=0;ee<C.length&&!me.current;ee++){_(e.evaluating(ee+1,C.length,C[ee]));const ie=await Ur(r,C[ee],"atelier2");if(I.unshift({name:ie.company||C[ee],verdict:ie.verdict,reason:ie.reason||"",remaining:ie.remaining??null}),X([...I]),ie.verdict==="quota"){I.unshift({name:"",verdict:"quota",reason:e.quota(C.length-ee-1),remaining:0}),X([...I]),Q(C.slice(ee+1).join(`
`)),_(""),M(!1);return}}_(""),Q(me.current?C.slice(I.length).join(`
`):""),M(!1)},Ye=async()=>{var ie,k,P;if(ht.current)return;const I=ce.trim().replace(/\s+/g,""),ee=re.trim();if(!I&&!ee){ve(e.rsNeed);return}if(!f&&!j){o(null,I||ee.slice(0,80));return}ht.current=!0,ve(""),He(null),dt(null),pe(!0);try{const O=await fi({url:I,text:ee,email:n,cbToken:j});if(pe(!1),!O||O.status!=="success"){ve((O==null?void 0:O.message)||"Erreur");return}He(O),se(!1),ne((((ie=O.prospective)==null?void 0:ie.companies_to_evaluate)||[]).map(te=>(te==null?void 0:te.name)||"")),dt({state:"pending"});const W=await hi(O,{email:n,cbToken:j});dt(W.ok?{state:"ok",scopeLabel:((k=W.summary)==null?void 0:k.scope_label)||"",scope:((P=W.summary)==null?void 0:P.scope)||""}:{state:"fail",msg:W.error||""}),W.ok&&Ze(te=>te+1)}finally{ht.current=!1,pe(!1)}},je=[ye==null?void 0:ye.industry,...(ye==null?void 0:ye.market_tags)||[],ye==null?void 0:ye.author].map(I=>(I||"").trim()).filter(Boolean),rt=(Fe==null?void 0:Fe.state)==="pending",_t=Fe&&(rt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Fe.state==="ok"?t.jsx("span",{className:"rslink ok",children:Fe.scope&&Fe.scope!=="public"?e.rsSavedIn(Fe.scopeLabel||Fe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Fe.msg,children:e.rsSaveFail})),Tt=Vl(ye).length,Oe=U,Pe=(S||E).trim(),et=b.find(I=>Be(I.name)===Be(Pe)),$t=ot(E)||z||ot((et==null?void 0:et.website)||"")||ot((et==null?void 0:et.domain)||""),Ut=D||ot((et==null?void 0:et.url)||""),ia=ge?e.actAnalyse:Pe?e.evalGoOn(Pe.length>22?Pe.slice(0,21)+"…":Pe):e.evalGo,Ma=oe?`${mi(ce.trim())==="youtube"&&ce.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(_e)}`:rt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Oe?" rs-mode":"")+(S&&E.trim()===S||N||be?" pair":"")+(N||be||ae?" echo":"")+(ae?" swap":""),children:[t.jsxs("div",{className:"drow"+((Oe?be:N)||ae?" flash":"")+((Oe?ce.trim():ba.test(E.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Oe?ce:E,placeholder:Oe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Oe?600:200,spellCheck:Oe?!1:void 0,inputMode:Oe?"url":void 0,onChange:I=>{if(Oe){Z(I.target.value);return}w(I.target.value),S&&I.target.value.trim()!==S&&(q(""),F(""),B(""),R(!1))},onKeyDown:I=>{I.key==="Enter"&&(Oe?Ye():de())}}),t.jsx("span",{className:"detect"+(Oe?" off":"")+(ba.test(E.trim())?" url":""),children:kt})]}),t.jsx("span",{className:"dacts",children:Oe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(oe?" loading":""),disabled:oe||rt||!ce.trim()&&!re.trim(),onClick:()=>{Ye()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Ma})]}),t.jsxs("a",{className:"viewbtn"+(Jt(ce)?"":" off"),href:Jt(ce)?ce.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:I=>{Jt(ce)||I.preventDefault()},children:[t.jsx(Kl,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ge?" analyse":"")+(l?" loading":""),disabled:l,onClick:de,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ia})]}),t.jsxs("a",{className:"viewbtn sm"+(L?" searching":$t?"":" off"),href:$t||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":L||void 0,title:L?e.viewSiteBusyHint:e.viewSiteHint,onClick:I=>{$t||I.preventDefault()},children:[L&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),L?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(Ut?"":" off"),href:Ut||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:I=>{Ut||I.preventDefault()},children:e.viewSrc})]})}),x.showCredits&&V&&t.jsxs("button",{type:"button",className:"credits"+(V.total_available<=0&&!V.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:V.unlimited?"∞":V.total_available}),!V.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",V.daily_grant+V.purchased]}),V.total_available<=0&&!V.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>T(!g),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(U?" on":""),onClick:()=>se(!U),children:e.rsOpen}),nt!==null&&nt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ft?" on":""),onClick:()=>vt(!ft),children:e.rsArchOpen(nt)})]}),ft&&t.jsx(Yl,{bump:wt,cbToken:j,onClose:()=>vt(!1),onEvaluate:I=>o(null,I),onAddAll:ne}),t.jsx("div",{className:"rsp slim"+(U?" on":" off"),"aria-hidden":!U,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:U?void 0:-1,onClick:()=>Le(I=>!I),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:fe?"▴":"▾"})]}),fe&&t.jsx("textarea",{className:"rstext",value:re,placeholder:e.rsTextPh,tabIndex:U?void 0:-1,onChange:I=>le(I.target.value)})]})}),Ce&&t.jsx("div",{className:"rserr",children:Ce}),ye&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ye.title}),ye.source_url&&t.jsx("a",{href:ye.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{He(null),dt(null)},children:"×"})]}),ye.market&&t.jsx("p",{className:"rsmk",children:ye.market}),je.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),je.map(I=>t.jsx("span",{children:I},I))]}),t.jsxs("div",{className:"rsbody",children:[ye.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ye.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ko(ye.summary_md||"").map((I,ee)=>t.jsx("p",{children:I},ee))})]}),t.jsx(jo,{card:ye,onEvaluate:I=>o(null,I),onAddAll:ne}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Tt)}),_t]})]}),g&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:$,placeholder:e.bulkPh,onChange:I=>Q(I.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(H?" loading":""),style:{justifyContent:"center"},disabled:H||!C.length,onClick:()=>{Me()},children:[t.jsx("span",{className:"fill"}),H&&K?K:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(C.length)})]})]}),G.slice(0,1).map((I,ee)=>{const ie=I.verdict==="kept",k=I.verdict==="quota",P=ie?"var(--brand)":k?"var(--bolt)":"var(--red)",O=ie?"var(--brand-l)":k?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":P,"--bgc":O},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ie?"✓ "+e.kept:k?"⏳":"✗ "+e.dropped})}),I.name&&t.jsx("span",{className:"rn",children:I.name}),t.jsx("span",{className:"rr",children:I.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",I.reason]}):null}),!!(I.candidates&&I.candidates.length)&&t.jsx("span",{className:"sitepick",children:I.candidates.map(W=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:W.url.startsWith("http")?W.url:`https://${W.url}`,target:"_blank",rel:"nofollow noopener",children:[(W.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,W.url),children:e.evalPickGo})]},W.url))}),!k&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:ie?1:5});const W=(I.name||"").trim().toLowerCase();window.setTimeout(()=>{const te=[...document.querySelectorAll(".atl2 .list .row")].find(Ee=>{var we;return(((we=Ee.querySelector(".rnm"))==null?void 0:we.textContent)||"").trim().toLowerCase().includes(W)});te&&(te.scrollIntoView({behavior:"smooth",block:"center"}),te.classList.add("flashrow"),window.setTimeout(()=>te.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ie?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ee)}),f&&(i.kept+i.dropped>0||G.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Jl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Xl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Y(),i=e.memoConsole?r.get(e.memoConsole):null,s=u.useMemo(()=>i?[i.reasoning||"",Jl(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=bt(i),c=bn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:s?s.split(`

`).map((x,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Rt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Sn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Y(),[s,l]=u.useState(!1),[c,x]=u.useState(null),d=n.pipe&&o==="client"&&!n.lockActions,h=async()=>{if(!d||s)return;l(!0);const p=await xi(r,e);if(l(!1),!p){i(a.actErr);return}x(p.results||[])};return u.useEffect(()=>{if(!d)return;const p=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&h()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,d]),u.useEffect(()=>{if(d)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),h())}catch{}},[e,d]),d?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{h()},children:s?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Zl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ha=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ed(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ha(a.slice(n));break}r+=ha(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ha(a.slice(o));break}const s=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(s),c=l?l[2].toLowerCase():"";l&&Zl.has(c)?r+=`<${l[1]}${c}>`:r+=ha(a.slice(o,i+1)),n=i+1}return r}const qr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function $e({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function td(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ad({o:e}){const{t:a,doDeep:r}=Y(),[n,o]=u.useState(!1),i=bt(e),s=[e.reasoning||"",td(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[i&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:i}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),s.length?s.join(`

`).split(`

`).map((l,c)=>t.jsx("p",{className:"cdtxt",children:l},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Rt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:l=>{l.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:l=>{l.stopPropagation(),o(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:l=>l.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:l=>l.stopPropagation()})]})}function Cn({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=Y(),i=ra(e),s=bt(e),l=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),h=u.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.reasoning?1:0)+(s?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Rt(e)?1:0}].filter(v=>v.n>0),[e,a,l,s,c,x,d]),[p,b]=u.useState("");if(!h.length)return null;const m=h.some(v=>v.k===p)?p:h[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:h.map(v=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===v.k,"data-tour":"tab-"+v.k,className:m===v.k?"on":"",onClick:y=>{y.stopPropagation(),b(v.k)},children:v.lib},v.k))}),t.jsxs("div",{className:"cdbody",onClick:v=>v.stopPropagation(),children:[m==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[t.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx($e,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx($e,{k:a.cdVerdictDate,v:qr(e.verdictDate,r)})]})]}),m==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:ed(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(nd,{o:e})]}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdSector,v:e.sector}),t.jsx($e,{k:a.cdStage,v:e.stage}),t.jsx($e,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx($e,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx($e,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx($e,{k:a.cdAngle,v:e.angle}),t.jsx($e,{k:a.cdDetected,v:qr(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdName,v:e.contactName}),t.jsx($e,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx($e,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="memo"&&t.jsx(ad,{o:e}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx($e,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function nd({o:e}){const{t:a,token:r}=Y(),[n,o]=u.useState(!1),[i,s]=u.useState(null),l=async()=>{n||(o(!0),s(await gi(r,e.name,e.website||e.domain||"")),o(!1))},c=(i==null?void 0:i.blocs)||{},x=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],d=x.some(([,h])=>h);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[x.filter(([,h])=>h).map(([h,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:h}),t.jsx("p",{children:p})]},h)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function oa({spec:e}){const a=u.useRef(null),r=u.useRef(null),[n,o]=u.useState(!1);return u.useEffect(()=>{const i=a.current;if(!i)return;let s=!1;const l=()=>{const x=Math.max(280,Math.min(560,i.clientWidth||320));Bn({kind:"op",card:e},x).then(d=>{!s&&d&&i.isConnected&&i.replaceChildren(d)})},c=window.requestAnimationFrame(l);return()=>{s=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),u.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let s=!1;Bn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!s&&c&&i.isConnected&&i.replaceChildren(c)});const l=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{s=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&It.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const rd=`
...
`;function od(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:s,top:l}}function id(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:s,askEvaluate:l,doAnalyse:c,doDecide:x,doPromote:d,doRepeche:h,doApproach:p,doDeep:b,doOnboard:m,outbound:v,evalBusy:y}=Y(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const j=Re(f),E=Ae(f),w=bt(f),N=ra(f),A=f.kind==="target",S=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return It.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:rd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:od(e.popupAnchor,!!f.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(mt(f.date)),Ge(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[f.cc]}),children:(Pt(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>S({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>S({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Bt(f.amountEur,o)})]}),i.pipe&&A&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[St(f.engine)," ",t.jsx("b",{children:Ge(f.engine,o)})," — ",bi(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(gt,{o:f,lg:!0})," ",t.jsx(Ra,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Hr(j,o))," · ",n.win7(Vr(j,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(oa,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&A&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&A&&t.jsx(Cn,{o:f})]}),t.jsx(Sn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||s!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(f,!1),a({type:"popup",id:null})},children:n.actNo}),Rt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function sd(){const{lang:e,token:a,dossiers:r,caps:n}=Y(),o=a||"home",{names:i,verdicts:s}=u.useMemo(()=>{const c=[],x={};return r.forEach(d=>{d.kind!=="target"||!d.name||(c.push(d.name),x[d.name]=vi(d)||"")}),{names:c,verdicts:x}},[r]);return{diff:u.useMemo(()=>i.length?yi(o,i,s,e):null,[o,i.length]),names:i,verdicts:s,scope:o,caps:n}}function ld(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:s}=Y(),l=i.loading&&!s.length,c=u.useRef({});u.useEffect(()=>{c.current={...r}},[r]);const x=p=>{const b=c.current[p],m=b!==void 0?r[p]-b:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ja[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:p})},children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(m>0?" up":m<0?" down":""),children:[r[p],m!==0&&t.jsxs("em",{className:"delta",children:[m>0?"+":"−",Math.abs(m)]})]})]},p)},d=(p,b,m)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${Ja[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:p})},children:[t.jsx("span",{className:"l",children:m.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),h=(p,b,m,v=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:v,onClick:m,children:p},b);return t.jsxs("div",{className:"funnel"+(l?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[h("↩",n.toolUndo,o,e.undo.length===0),h("↺",n.toolReset,()=>{a({type:"reset"})}),h("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),h("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),h("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function dd(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:s}=Y(),l=u.useRef(null),[c,x]=u.useState(60);u.useEffect(()=>{let m=0;const v=()=>{var w;const y=l.current;if(!y)return;const f=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!f)return;const j=f.getBoundingClientRect(),E=y.getBoundingClientRect();x(Math.max(20,Math.min(j.left+j.width/2-E.left,E.width-30)))};return m=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",v)}},[e.ptab]);const d=e.ptab;let h=r.tuto[d].p;if(d===3){const m=n.filter(f=>f.kind==="target"&&Ae(f)===3),v=m.filter(f=>Xa(f)==="auto").length,y=m.filter(f=>Xa(f)==="cd").length;h=r.tutoPending(v,y,m.length)}const p=(()=>{if(s!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(d===1){const m=n.filter(v=>v.kind==="target"&&Ae(v)===1&&!o.has(v.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(v=>v.id)})}}return null})(),b=wi(d);return t.jsxs("div",{ref:l,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Ja[d]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:h}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}const Ya=600,Nt=62,Lr="atl2:fstats";function cd(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Y(),[s,l]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Lr)==="on"}catch{return!1}}),c=r.stats,x=u.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const h=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,p=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((N,A)=>Math.max(N,A.s||0),0),m=x.length?Ya/x.length:0,v=Math.max(4,m-4),y=x.length>=5&&b>0,f=r.marketEstimate||0,j=h(new Date().toISOString().slice(0,10)),E=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&d&&w.push({cle:"fenetre",periode:e.funPerWindow(h(d),j),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:E(c.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[w.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([A,S],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(A)}),t.jsx("i",{children:S})]},N.cle+S)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(f),Math.min(100,Math.round((c.screened||0)/f*100)))})]}),N.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const A=!s;l(A),A&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Lr,A?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},N.cle)),s&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ya} ${Nt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((N,A)=>{const S=(N.s||0)/b*(Nt-4),q=(N.m||0)/b*(Nt-4),z=A*m+(m-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${h(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:Nt-2-S,width:v,height:S,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:Nt-2-q,width:v,height:q,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:Nt-1.5,x2:Ya,y2:Nt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:h(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const No={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function zn({o:e,locked:a=!1}){const{t:r}=Y(),n=ra(e),o=bt(e),i=Ae(e),s=Xa(e),l=ki(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(No[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&s==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&s==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(Is,{o:e})]})}const Dt=e=>e.length>22?e.slice(0,21)+"…":e,va=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Fa(e){return va.has(e.engine||"")}function pt(e){return!!e.noCo||Fa(e)&&!!e.url}function na(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Eo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function pd({on:e,rev:a}){const[r,n]=u.useState(null),[o,i]=u.useState({top:0,left:0,width:0});return u.useEffect(()=>{if(!e){n(null);return}const s=()=>{var m,v,y;const l=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const x=l.getBoundingClientRect(),d=c?c.getBoundingClientRect().bottom:x.top;i({top:Math.round(d),left:Math.round(x.left),width:Math.round(x.width)});const h=[...l.querySelectorAll(":scope .grp")];let p=null;for(const f of h){const j=f.querySelector(".grp-h");j&&j.getBoundingClientRect().bottom<=d+2&&(p=f)}if(!p){n(null);return}const b=p.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return s(),window.addEventListener("scroll",s,{passive:!0}),window.addEventListener("resize",s),()=>{window.removeEventListener("scroll",s),window.removeEventListener("resize",s)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function ud(e){const r=()=>{const n=Eo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Fr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Y(),[i,s]=u.useState(!1);if(u.useEffect(()=>{n||s(!1)},[n]),De(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Dt(e.name))})]})}function An({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:s,doPromote:l,doRepeche:c,doApproach:x,dispatch:d,liveMemos:h}=Y(),p=m=>v=>{v.stopPropagation(),m()};if(r.lockActions){const m=p(()=>d({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Ae(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Dt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),na(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Fa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),na(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Fr,{o:e})});const b=Ae(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Fr,{o:e})});if(b===1){const m=h.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(wa,{item:m,serverOff:h.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:p(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:p(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:p(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:p(()=>x(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:p(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function md({o:e}){const{t:a,doThumb:r,thumbOf:n}=Y(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function fd({o:e}){const{lang:a}=Y();return Re(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(gt,{o:e}),t.jsx(Ra,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[St(e.engine||"")," ",Ge(e.engine||"",a)]})})}function hd({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:s,fresh:l}){const{dispatch:c,caps:x,markRow:d,markedId:h,favIds:p,toggleFav:b,t:m}=Y(),v=Ae(e),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,j=f<=0?0:f<=7?1:f<=30?2:3,E=x.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][v]:y[j],w=p.has(e.id),N=A=>{if(a)return;if(s){s(e.id);return}if(x.pipe||e.kind==="op"){n();return}const S=A.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return t.jsxs(u.Fragment,{children:[t.jsxs("div",{className:"row"+(h===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(x.pipe&&e.kind==="target"?" p"+v:"")+(w?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx(To,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),Re(e)&&t.jsx(gt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[x.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:w?1:.35,padding:0,marginRight:4},onClick:A=>{A.stopPropagation(),b(e)},children:w?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(A=>A&&A!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:A=>{A.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",Dt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(xd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(fd,{o:e}),x.pipe&&t.jsx(zn,{o:e,locked:a}),x.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(An,{o:e}),x.showThumbs&&t.jsx(md,{o:e})]}),r&&!a&&!s&&t.jsx(vd,{o:e})]})}function xd({o:e}){const{lang:a,caps:r}=Y();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Bt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function gd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Y(),s=(p,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:p})},l=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),c=Bt(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=De(e),h=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped})]}):pt(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{p.stopPropagation(),na(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Dt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(oa,{spec:e.card})})]})}function bd({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Y();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ge(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(An,{o:e})}),t.jsx(Cn,{o:e})]})}function So({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:s,caps:l,dossiers:c}=Y(),x=u.useRef(null),d=We(e);if(u.useEffect(()=>{if(!d||!(e!=null&&e.decryptHtml))return;const g=x.current;if(!g)return;let T=!1;return Ka(()=>import("./fit-BnaWm7z_.js"),[]).then(async $=>{await $.ensureEditoCss(),!(T||!g.isConnected)&&($.beautifyEditoRows(g),$.mountCardFits(g))}),()=>{T=!0}},[d,e==null?void 0:e.decryptHtml]),!e&&!a){const g=c.find(We);if(g)return t.jsx(So,{o:g})}const h=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),p=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||h,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!h||ka(h),y=(e==null?void 0:e.engine)||"",f=We(e),j=e?Bt(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),w=(()=>{const g=/https?:\/\/(?:www\.)?([^/]+)/.exec(p);return g?g[1].replace(/^www\./,"").slice(0,40):""})(),N=c.find(We),A=((N==null?void 0:N.url)||"").trim(),S=!!p&&!!A&&(p===A||p.endsWith(A)||A.endsWith(p)),q=(g,T=!1)=>$=>{$.stopPropagation(),T&&s({type:"continent",key:"monde"}),s({type:"filters",patch:g})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const z=()=>{h&&(s({type:"continent",key:"monde"}),s({type:"filters",patch:{search:h}}))},F=()=>{e!=null&&e.sector&&s({type:"filters",patch:{sector:[e.sector]}})},D=()=>{na({url:p,headline:b,tagline:e==null?void 0:e.tagline,name:h})},B=e?De(e):!1,L=B&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",R=f?r.doEdito.replace(/^📖\s*/,""):y?Ge(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[R,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),p&&!f&&(v||Fa({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:p,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:g=>g.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,w?t.jsx("em",{children:w}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:x,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),j&&t.jsx("span",{className:"oc-amt",children:j})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(oa,{spec:m})}),(p&&!S&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[p&&!S&&!f&&t.jsxs("a",{className:"zoom-src",href:p,target:"_blank",rel:"nofollow noopener",onClick:g=>g.stopPropagation(),children:[r.zoomSrc,w?` · ${w}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:g=>{g.stopPropagation(),s({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[B?t.jsxs("span",{className:"verdict",style:{"--c":L?"var(--brand)":"var(--red)"},children:[L?"✓":"✗"," ",t.jsx("b",{children:L?r.kept:r.dropped})]}):!v&&h?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:g=>{g.stopPropagation(),o(e,h)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Dt(h))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,p&&!f&&(v||Fa({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&h?" ghost":""),onClick:g=>{g.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&h&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),F()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),z()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Dt(h)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&h&&l.pipe&&t.jsx(Sn,{name:h})]})]})}function vd({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:s}=Y();return!o.pipe&&e.kind==="op"?t.jsx(gd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Cn,{o:e}),t.jsx(Ps,{o:e}),t.jsx($s,{o:e}),t.jsx(Sn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(zn,{o:e})})]}),e.card&&t.jsx(oa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[St(e.engine||"")," ",Ge(e.engine||"",r)]}),Re(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(gt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function yd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:s,doDecide:l,lang:c}=Y();if(!s.pipe&&e.kind==="op"){const h=Bt(e.amountEur,c),p=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(oa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),h&&t.jsx("span",{className:"damt",children:h})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[St(e.engine||"")," ",Ge(e.engine||"",c)]}),Re(e)&&t.jsx(gt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(p?` · ${p}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(An,{o:e})})]})}const x=Ae(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][x];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":d},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(zn,{o:e}),Re(e)&&t.jsx(gt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&s.pipe&&x===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemo," →"]})]})}function wd(){const{t:e}=Y(),[a,r]=u.useState(0);return u.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function kd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Y(),i=o==="en",s=d=>n.plabels[d]||"",l=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),c=l.includes(0)?0:l.sort((d,h)=>(e[h]||0)-(e[d]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:i?`${x} ${x>1?"files":"file"} in “${s(c)}”`:`${x} dossier${x>1?"s":""} dans « ${s(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+s(c)," →"]})]})}function jd(){var yt,wt,Ze,ht,kt;const e=Y(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:s,scopedAll:l,markRow:c,lang:x,sessTally:d,data:h,dossiers:p,source:b,focusExtra:m,byId:v,token:y}=e,f=Yr(),j=u.useMemo(()=>{var V,ne,ge,de;if(!y||b==="ops")return null;const C=(((V=f==null?void 0:f.ed)==null?void 0:V.date)||(f==null?void 0:f.day)||"").slice(0,10),G=[(ne=f==null?void 0:f.ed)==null?void 0:ne.html,(ge=f==null?void 0:f.ed)==null?void 0:ge.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:x==="en"?"Today's brief":"Brief du jour",headline:x==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((de=f==null?void 0:f.ed)==null?void 0:de.date)||C,decryptHtml:G||void 0,date:C,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,x,(yt=f==null?void 0:f.ed)==null?void 0:yt.html,(wt=f==null?void 0:f.ed)==null?void 0:wt.acquirers_html,(Ze=f==null?void 0:f.ed)==null?void 0:Ze.date,f==null?void 0:f.day]),E=C=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Gr,[w,N]=u.useState(new Set);u.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[A,S]=u.useState(null);u.useEffect(()=>{S(null)},[a.ptab,a.continent]);const[q,z]=u.useState(!a.mapFolded);u.useEffect(()=>{if(a.mapFolded){z(!1);return}const C=document.getElementById("atl2-stage");if(!C){z(!1);return}const G=new IntersectionObserver(([V])=>z(!!V&&V.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return G.observe(C),()=>G.disconnect()},[a.mapFolded]);const F=a.mapFolded||!q,D=C=>N(G=>{const V=new Set(G);return V.has(C)?V.delete(C):V.add(C),V}),B=b==="ops"||o.pipe,[L,R]=u.useState("all"),[g,T]=u.useState(null),[$,Q]=u.useState(!1),H=u.useRef(!0);u.useEffect(()=>{if(H.current){H.current=!1;return}R("all"),Q(!1)},[a.ptab,a.continent]),u.useEffect(()=>{if(!$)return;const C=G=>{var V,ne;(ne=(V=G.target)==null?void 0:V.closest)!=null&&ne.call(V,".atl2 .doable")||Q(!1)};return document.addEventListener("click",C,!0),()=>document.removeEventListener("click",C,!0)},[$]);const M=u.useMemo(()=>{var G;const C=new Map;for(const V of Ns(((G=f==null?void 0:f.ed)==null?void 0:G.html)||""))C.has(V.t)||C.set(V.t,V.html);return C},[(ht=f==null?void 0:f.ed)==null?void 0:ht.html]),K=u.useCallback(C=>{if(C.decryptHtml)return C.decryptHtml;if(!M.size)return;const G=(C.name||"").trim().toLowerCase();if(G.length<3)return;const V=M.get(G);if(V)return V;for(const[ne,ge]of M)if(ne.includes(G)||G.includes(ne))return ge},[M]),{diff:_}=sd(),[J,X]=u.useState(!1),me=a.filters.win==="1"&&!a.filters.day,[U,se]=u.useState(!1),fe=u.useMemo(()=>new Set(((_==null?void 0:_.added)||[]).map(C=>C.trim().toLowerCase()).filter(Boolean)),[_]),Le=u.useMemo(()=>{if(!fe.size)return 0;const C={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return p.filter(G=>!We(G)&&fe.has((G.name||"").trim().toLowerCase())&&Xt(G,C,o.pipe)).length},[p,fe,a,o.pipe]);u.useEffect(()=>{const C=()=>{se(!1),R("all"),Q(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",C),()=>window.removeEventListener("ppmap:tunnel",C)},[]),u.useEffect(()=>{se(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const ae=u.useMemo(()=>{const G=U&&fe.size>0||a.filters.signalOnly||L!=="all"?l:s;let V=wn(G,a.sort);return V=V.filter(ne=>!We(ne)),U&&fe.size&&(V=V.filter(ne=>fe.has((ne.name||"").trim().toLowerCase()))),L==="explore"?V=V.filter(pt):L==="eval"&&(V=V.filter(ne=>!pt(ne)&&!ne.noCo&&(ne.kind==="op"||!De(ne)))),V},[s,l,a.sort,L,U,fe]),xe=u.useMemo(()=>o.pipe?p.filter(C=>C.kind==="target"&&!We(C)&&Re(C)&&(a.continent==="monde"||C.continent===a.continent)):ae.filter(C=>Re(C)&&!De(C)),[o.pipe,p,ae,a.continent]).length,ce=u.useMemo(()=>o.pipe?ae:ae.filter(C=>!De(C)&&!C.noCo&&!pt(C)),[ae,o.pipe]),Z=b==="ops"?ae.filter(pt).length:0,re=U?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,le=a.filters,be=[];if(le.day)be.push({k:"day",lib:n.fDay(le.day.slice(8,10)+"/"+le.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(le.win&&le.win!=="all"){const C=["1","7","30"].indexOf(le.win);C>=0&&be.push({k:"win",lib:n.dates[C],off:()=>r({type:"filters",patch:{win:"all"}})})}const Se=C=>C.length<=2?C.join(", "):`${C.length} ${n.fSelected}`;for(const C of["sector","country","engine"]){const G=le[C];G&&G.length&&be.push({k:C,lib:Se(G),off:()=>r({type:"clearFacet",facet:C})})}le.search&&be.push({k:"search",lib:"🔍 "+le.search,off:()=>r({type:"filters",patch:{search:""}})}),U&&fe.size&&be.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>se(!1)}),le.signalOnly&&be.push({k:"sig",lib:"🔴 "+n.sigDock(xe||le.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const oe=(C,G,V="",ne=!1)=>t.jsxs("button",{type:"button","data-s":C,className:V,"aria-sort":a.sort.key===C?a.sort.dir===1?"ascending":"descending":"none",style:ne?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:C}),children:[G,t.jsx("span",{className:"ar",children:a.sort.key===C&&a.sort.dir===1?"▴":"▾"})]},C),pe=u.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const C=new Map;ae.forEach(ne=>{const ge=ne.engine||"?";C.has(ge)||C.set(ge,[]),C.get(ge).push(ne)});const G={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},V=Qa([...C.keys()],x);return[...C.entries()].sort((ne,ge)=>{const de=G[ne[0]]??10+V.indexOf(ne[0]),Me=G[ge[0]]??10+V.indexOf(ge[0]);return de-Me})},[ae,o.pipe,a.groupBy,x]),_e=pe?pe.filter(([C])=>va.has(C)).length:0,Ie=(()=>{var G;return((G=(pe?pe.flatMap(([,V])=>V):ae)[0])==null?void 0:G.id)??null})(),Ce=u.useRef(!1),ve=u.useMemo(()=>p.find(We)||j,[p,j]);u.useEffect(()=>{const C=()=>{Ce.current=!0,se(!1)};return window.addEventListener("ppmap:reveal",C),window.addEventListener("ppmap:focus",C),()=>{window.removeEventListener("ppmap:reveal",C),window.removeEventListener("ppmap:focus",C)}},[]),u.useEffect(()=>{const C=()=>{ve&&r({type:"focus",id:ve.id})};return window.addEventListener("ppmap:edito",C),()=>window.removeEventListener("ppmap:edito",C)},[ve,r]),u.useEffect(()=>{if(!a.focusId)return;T(a.focusId);const C=window.setTimeout(()=>T(null),900);return()=>window.clearTimeout(C)},[a.focusId]),u.useEffect(()=>{if(B&&!(a.focusId&&(ae.some(C=>C.id===a.focusId)||p.some(C=>C.id===a.focusId)||a.focusId===(ve==null?void 0:ve.id)))&&!m){if(ve){r({type:"focus",id:ve.id});return}Ie&&r({type:"focus",id:Ie})}},[B,a.focusId,ae,Ie,m,r,p,b,ve]),u.useEffect(()=>{if(!B||!a.focusId||ve&&a.focusId===ve.id||ae.some(G=>G.id===a.focusId))return;const C=p.find(G=>G.id===a.focusId);if(C){if(Ce.current){C.kind==="op"?R(pt(C)?"explore":"eval"):L!=="all"&&R("all");return}L!=="all"&&Ie&&r({type:"focus",id:Ie})}},[B,a.focusId,L,ae,p,Ie,r,ve]),u.useEffect(()=>{if(!B||!a.focusId||!Ce.current)return;const C=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!C){const ge=ae.findIndex(de=>de.id===a.focusId);if(ge>=0){const de=pe?"":"pt"+a.ptab;if(de){const Me=a.shown[de]||E();ge>=Me&&r({type:"more",group:de,by:ge-Me+8})}}return}Ce.current=!1;const G=Eo(),V=C.getBoundingClientRect();V.top>=G-2&&V.bottom<=window.innerHeight-4||ud(C)},[B,a.focusId,a.ptab,ae,a.shown,pe,r]),u.useEffect(()=>{if(typeof window>"u")return;const C=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),G=document.querySelector(".atl2.ops, .atl2.cibles");if(!C||!G)return;const V=()=>G.style.setProperty("--listhead-h",`${C.offsetHeight}px`);V();const ne=new ResizeObserver(V);return ne.observe(C),()=>ne.disconnect()},[F,a.dens,a.mapFolded]);const ye=u.useMemo(()=>{if(!B||!a.focusId)return null;if(j&&a.focusId===j.id)return j;const C=ae.find(V=>V.id===a.focusId)||p.find(V=>V.id===a.focusId)||null;if(!C)return null;const G=K(C);return G&&G!==C.decryptHtml?{...C,decryptHtml:G}:C},[B,a.focusId,ae,p,K,j]),He=o.lockRowsAfter;let Fe=0;const dt=(C,G)=>{let V=a.shown[G]||E();return C.length-V<=4&&(V=C.length),C.slice(0,V).map(de=>{const Me=He!==null&&Fe>=He;Fe++;const Ye=K(de),je=Ye&&Ye!==de.decryptHtml?{...de,decryptHtml:Ye}:de,rt=!B&&a.dens!=="maxi"&&(a.dens==="deplie"||(A?A==="open":!!Ye)),_t=w.has(de.id)?!rt:rt,Tt=B?Oe=>{Ce.current=!0,r({type:"focus",id:Oe});const Pe=v.get(Oe);Pe&&(pt(Pe)?na(Pe):Pe.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Pe.name,url:Pe.url||"",website:Pe.website||"",domain:Pe.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(yd,{o:je,locked:Me,selected:B&&a.focusId===de.id,onSelect:Tt},de.id):t.jsx(hd,{o:je,locked:Me,open:_t,onToggle:()=>D(de.id),selected:B&&a.focusId===de.id,echo:g===de.id,fresh:fe.has((de.name||"").trim().toLowerCase()),onSelect:Tt},de.id)})},ft="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ae.length?"":" list-empty"),vt=t.jsxs(t.Fragment,{children:[pe?pe.map(([C,G])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:St(C)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:C==="ma"?n.grpMa:C==="fundraising"?n.grpLev:va.has(C)&&_e<=1?n.grpNews:C==="nominations"?n.grpNom:C==="media"?n.grpNewsOther:C==="recrutements"?n.grpHire:va.has(C)?n.grpNews+" · "+Ge(C,x):Ge(C,x)}),t.jsx("div",{className:"s",children:n.grpCount(G.filter(V=>!De(V)).length,G.length)})]})]}),dt(G,C)]},C)):dt(ae,"pt"+a.ptab),h.loading&&!p.length&&t.jsx(wd,{}),!ae.length&&!(h.loading&&!p.length)&&(o.pipe&&L==="all"?t.jsx(kd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),nt=t.jsxs("div",{className:"listhead"+(F?" mapoff":""),children:[F&&t.jsx("div",{className:"lh-tools",children:t.jsx(yo,{compact:!0})}),o.showFunnel&&J&&me&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(Hs,{}),t.jsx(cd,{})]}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(ld,{}),t.jsx(dd,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(me?" on":""),"aria-pressed":me,title:n.morningDockTitle,onClick:()=>{if(me){r({type:"filters",patch:{win:"all",day:""}}),X(!1);return}se(!1),R("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),X(!0)},children:["📊 ",n.morningDock(typeof((kt=h.stats)==null?void 0:kt.screened_today)=="number"?h.stats.screened_today:0)]}),_&&!_.firstVisit&&(_.added.length>0||_.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(U?" on":""),"aria-pressed":U,title:n.sinceSub,onClick:()=>{const C=!U;se(C),X(!1),R("all"),C&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(Le),_!=null&&_.lastDate?` · ${n.sinceSince(_.lastDate)}`:""]}),xe>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{se(!1),X(!1),R("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(xe)]})]}),!U&&t.jsxs("span",{className:"main",children:[t.jsx("b",{children:ae.length})," ",re]}),t.jsx("span",{className:"dot",children:"·"}),F&&t.jsx(wo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[F?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),be.map(C=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:G=>{G.stopPropagation(),C.off()},children:[C.lib,t.jsx("i",{children:"×"})]},C.k)),b==="ops"&&ae.length>0&&!F&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ae.length-Z," ",n.zoomPulseEval,Z>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",Z," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([C,G])=>t.jsxs("button",{type:"button","data-d":C,"aria-pressed":a.dens===C||C==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:C}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:G})]},C))}),!B&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":A==="open",onClick:()=>{S("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":A==="closed",onClick:()=>{S("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var Ye;const C={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},G=p.filter(je=>Xt(je,C,o.pipe)&&!We(je)),V=G.filter(je=>!pt(je)&&!je.noCo&&(je.kind==="op"||!De(je))).length,ne=G.filter(pt).length,ge=o.pipe?G.filter(je=>je.kind!=="op"&&Ae(je)===1).length:0,de=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ge?` ${ge}`:""}`]]:[],["eval",`${n.doEval}${V?` ${V}`:""}`],["explore",`${n.doExplore}${ne?` ${ne}`:""}`]],Me=((Ye=de.find(([je])=>je===L))==null?void 0:Ye[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":$,onClick:()=>Q(je=>!je),children:[Me,t.jsx("i",{children:"▾"})]}),$&&t.jsx("div",{className:"dolist",children:de.map(([je,rt])=>t.jsx("button",{type:"button","aria-pressed":L===je,onClick:()=>{if(Q(!1),je==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}R(je),je!=="all"&&(se(!1),X(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:rt},je))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:C=>r({type:"sort",key:C.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([C,G])=>t.jsx("option",{value:C,children:G},C))})]}),o.showChain&&ce.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ce.map(C=>C.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ce.length):n.chainAll(ce.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!B&&nt,a.dens!=="maxi"&&!B&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),oe("country",n.colCountry),oe("name",n.colCompany),oe("amount",n.colAmount,"h-amt",!0),oe("stage",n.colStage,"h-stade"),oe("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[oe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),oe("memo",n.colMemo)]}),o.pipe&&oe("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),B?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[nt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),oe("country",n.colCountry),oe("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[oe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),oe("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ft,children:vt})]}),t.jsxs("aside",{className:"readpane"+((ye?We(ye):!m&&ve)?" is-edito":""),"aria-label":x==="fr"?"Dossier":"File",children:[ve&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===ve.id,onClick:()=>r({type:"focus",id:ve.id}),children:n.doEdito}),j&&a.focusId===j.id?t.jsx("div",{className:"zoom",children:t.jsx(As,{})}):ye&&o.pipe?t.jsx(bd,{o:ye}):t.jsx(So,{o:ye,extra:ye?null:m})]})]}):t.jsx("div",{className:ft,children:vt}),(()=>{const C=pe||[["pt"+a.ptab,ae]];let G=0,V=0;for(const[ge,de]of C){V+=de.length;let Me=a.shown[ge]||E();de.length-Me<=4&&(Me=de.length),G+=Math.min(de.length,Me)}const ne=V-G;return ne<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>C.forEach(([ge,de])=>r({type:"more",group:ge,by:de.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(ne,ne)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(G,V)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}}),B&&b==="ops"&&a.dens!=="maxi"&&t.jsx(pd,{on:!!pe,rev:(pe||[]).map(([C,G])=>C+G.length).join("|")})]})}function Rr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Nd(e,a){const r=ji(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Ed(e,a){const n=[a.head.split("|").map(Rr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",Nd(o,a.plabels),ra(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Rr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Sd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Cd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function it({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function zd({o:e,qa:a}){const{t:r,lang:n,fund:o}=Y(),i=(e.cribleStatus||"").trim().toUpperCase()||(ra(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=bt(e),l=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(it,{k:r.cdSector,v:e.sector}),t.jsx(it,{k:r.cdStage,v:e.stage}),t.jsx(it,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(it,{k:r.cdSite,v:e.domain||e.website}),t.jsx(it,{k:r.cdName,v:e.contactName}),t.jsx(it,{k:r.cdEmail,v:e.contactEmail}),t.jsx(it,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(it,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(it,{k:r.cdAngle,v:e.angle}),t.jsx(it,{k:r.cdDetected,v:Cd(e.date,n)})]}),c.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,x])=>x).map(([x,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:d})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Ad(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:s}=Y(),[l,c]=u.useState({}),x=25,d=u.useMemo(()=>n.slice(0,x),[n]);u.useEffect(()=>{d.length&&Ni(r,d.map(b=>b.name)).then(c)},[r,d]);const h=i.stats,p=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),h&&typeof h.screened=="number"&&t.jsxs("p",{children:[p(h.screened)," ",e.funScreened(""),typeof h.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(h.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(i.marketEstimate)),", ",Math.round(h.screened/i.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(zd,{o:b,qa:l[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Td=50;function Tn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Y(),[i,s]=u.useState(null),[l,c]=u.useState(!1),[x,d]=u.useState(""),[h,p]=u.useState(0),[b,m]=u.useState(""),[v,y]=u.useState(!1),[f,j]=u.useState(0),E=u.useRef(null),w=u.useRef(null),N=()=>{j(0),w.current&&window.clearInterval(w.current),w.current=window.setInterval(()=>j(z=>z+1),1e3)},A=()=>{w.current&&(window.clearInterval(w.current),w.current=null)};u.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),w.current&&window.clearInterval(w.current)},[]);const S=async z=>{c(!0),d(""),N();const F=await a();if(c(!1),A(),F.ok){s(F);return}if(F.busy){d(o.alertPreviewBusy);return}if(!z){d(o.alertPreviewFail);return}p(Td),A(),E.current=window.setInterval(()=>{p(D=>D>1?D-1:(E.current&&window.clearInterval(E.current),S(!1),0))},1e3)},q=async()=>{if(n||v||l)return;y(!0),m(""),N();const z=await r();y(!1),A(),m(z.ok?o.alertTestOk(z.sentTo||""):z.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||v||h>0,onClick:()=>{S(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||l,onClick:()=>{q()},children:v?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),h>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(h)}),x&&t.jsx("p",{className:"mnote warn",children:x}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Ft="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ue({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=Y();return It.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function qd(){const{st:e}=Y();switch(e.modal){case"chain":return t.jsx(Fd,{});case"space":return t.jsx(Rd,{});case"alert":return t.jsx(Md,{});case"queue":return t.jsx(Bd,{});case"export":return t.jsx(_d,{});case"plug":return t.jsx(Hd,{});case"recharge":return t.jsx(Wd,{});case"cover":return t.jsx(Yd,{});case"dossier":return t.jsx(Gd,{});case"crit":return t.jsx(Kd,{});case"tuto":return t.jsx(Qd,{});case"rdv":return t.jsx(Ld,{});case"memoalert":return t.jsx($d,{});default:return null}}function Ld(){const{dispatch:e,fund:a,t:r}=Y(),n=a||r.rdvCoFallback;return It.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Jr,children:jn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Na}`,children:Na})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],s)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(s+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Yi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function Fd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:s,evalBusy:l,caps:c,memoQueued:x,doAnalyse:d}=Y(),h=i==="client",p=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,m=p[b],v=b>=p.length;return It.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Pt(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(mt(m.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ge(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Bt(m.amountEur,o)})]}),Re(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(gt,{o:m,lg:!0})," ",t.jsx(Ra,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(h&&De(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),h&&De(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Et(m)==="retenu"?"var(--brand)":Et(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Et(m)==="retenu"?"✓ "+n.kept:Et(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&c.pipe&&Ae(m)===1&&!x.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(h&&De(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{s(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function Rd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Y(),i=o==="client",s=u.useMemo(()=>i?r.filter(h=>De(h)):[],[r,i]),l=u.useMemo(()=>wn(s.filter(h=>Et(h)==="retenu"),{key:"signal",dir:-1}),[s]),c=u.useMemo(()=>s.filter(h=>Et(h)==="ecarte"),[s]),x=e.spaceTab==="retenu"?l:c,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ue,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(h=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof h.score=="number"&&h.score>0?h.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:h.name}),t.jsx("div",{className:"rr",children:h.reasoning||h.tagline||""})]})]},h.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Md(){const{mode:e}=Y();return e==="client"||e==="apercu"?t.jsx(Od,{}):t.jsx(Pd,{})}function Od(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Y(),[i,s]=u.useState("d"),l=o!=="client";return t.jsxs(Ue,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Dd,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(Id,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(Co,{})]})}function Dd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=u.useState(null),[l,c]=u.useState(!1),[x,d]=u.useState(0);u.useEffect(()=>{let q=!0;return c(!1),Un(a).then(z=>{q&&(z?s(z):c(!0))}),()=>{q=!1}},[a,x]);const h=u.useRef({}),[p,b]=u.useState({}),[m,v]=u.useState(!1),[y,f]=u.useState(!1),j=u.useRef(null);u.useEffect(()=>()=>{j.current&&window.clearTimeout(j.current)},[]);const E=q=>{const z=h.current;Object.keys(z).length&&(v(!0),Un(a,z).then(F=>{if(!F){v(!1),o(e.actErr);return}if(F.throttled&&q<3){j.current=window.setTimeout(()=>E(q+1),5400);return}if(h.current={},b({}),s(F),v(!1),F.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},w=q=>{r||(h.current={...h.current,...q},b(z=>({...z,...q})),j.current&&window.clearTimeout(j.current),j.current=window.setTimeout(()=>E(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(q=>q+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...p},A=q=>!N.sections||N.sections.includes(q),S=q=>{const z=N.sections||e.alertSec.map(([F])=>F);w({sections:A(q)?z.filter(F=>F!==q):[...z,q]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>w({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>w({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([q,z])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:A(q),disabled:r,onChange:()=>S(q)}),t.jsxs("span",{children:[z,q==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},q))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Tn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ri(a),onTest:()=>Fi(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Id({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=u.useState(null),[l,c]=u.useState(!1),[x,d]=u.useState(0);u.useEffect(()=>{let m=!0;return c(!1),Hn(a).then(v=>{m&&(v?s(v):c(!0))}),()=>{m=!1}},[a,x]);const h=m=>{r||Hn(a,m).then(v=>{if(!v){o(e.actErr);return}s(v),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const p=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>h({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:m=>h({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Tn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Oi(a),onTest:()=>Mi(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Co(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Y(),[s,l]=u.useState(i||""),[c,x]=u.useState(!1),[d,h]=u.useState(!1);u.useEffect(()=>{i&&l(i)},[i]);const p=e.filters,b=u.useMemo(()=>n.filter(f=>Re(f)).length,[n]),m=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(s)||d)){h(!0);try{await fetch(`${gn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:p.sector,countries:p.country,source:i?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{h(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(f=>Ge(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(f=>Pt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Pd(){const{t:e}=Y();return t.jsx(Ue,{title:e.alertTitle,icon:"🔔",children:t.jsx(Co,{})})}function Bd(){var D,B;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:s,caps:l,dispatch:c,liveMemos:x}=Y(),[d,h]=u.useState(()=>Ia(r)),[p,b]=u.useState(()=>!Ia(r)),[m,v]=u.useState([]),[y,f]=u.useState(0),j=n==="client",E=u.useMemo(()=>{const L=new Map;return o.forEach(R=>{const g=(R.name||"").trim().toLowerCase();g&&!L.has(g)&&L.set(g,R)}),L},[o]);u.useEffect(()=>{let L=!0;return(!Ia(r)||y>0)&&b(!0),(async()=>{const[R,g]=await Promise.all([vn(r,y>0),Br(a)]);L&&(R&&h(R),b(!1),v(g))})(),()=>{L=!1}},[a,r,y]);const w=p&&!d,N=(d==null?void 0:d.per_day)??0,A=((D=d==null?void 0:d.analyzed_today)==null?void 0:D.length)??0,S=d==null?void 0:d.offre,q=(d==null?void 0:d.pool_meta)||[],z=u.useMemo(()=>{const L=new Map;for(const R of(d==null?void 0:d.scheduled)||[])for(const g of R.names||[])L.has(g)||L.set(g,{label:R.day_label,date:R.date});return L},[d==null?void 0:d.scheduled]),F=(d==null?void 0:d.in_progress)||[];return t.jsxs(Ue,{title:e.queueTitle,wide:!0,children:[S&&t.jsxs("div",{className:"qoffre"+(S.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:S.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:S.delai})]}),t.jsx("span",{className:"osp"}),S.rythme>0?t.jsx("span",{className:"or",children:e.qRate(S.rythme)}):S.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(S.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:w?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(A,A+(((B=d==null?void 0:d.pool_order)==null?void 0:B.length)??0))}})}),S&&t.jsxs("div",{className:"qeta",children:[S.file===0?e.qEtaDone:S.rythme<=0?e.qEtaPaused:e.qEta(S.file,S.rythme,S.jours_restants),S.en_retard&&t.jsxs("em",{children:[" ",e.qLate(S.delai,S.plafond)]})]}),!w&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(S==null?void 0:S.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(F.length>0||x.items.some(L=>L.status==="boot"||L.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[x.items.filter(L=>L.status==="boot"||L.status==="running"||L.status==="error").map(L=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:L.name}),t.jsx("span",{className:"qd",children:L.memoType||""}),t.jsx(wa,{item:L,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+L.name)),F.filter(L=>!x.liveOf(L.name)).map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.name}),t.jsxs("span",{className:"qd",children:[L.memo_type||"",L.age_min?` · ${Math.round(L.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:L.state||""})]},"ip-"+L.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.company}),t.jsxs("span",{className:"qd",children:[L.memo_type,typeof L.est_min=="number"?` · ~${L.est_min} min`:""]}),t.jsx("span",{className:"qt",children:L.status}),L.url&&t.jsx("a",{className:"qgo",href:L.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),j&&L.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{$n(a,L.company,"retry").then(()=>f(R=>R+1))},children:e.queueRetry}),j&&L.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{$n(a,L.company,"delete").then(()=>f(R=>R+1))},children:e.queueDelete})]},L.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",w?e.qUpNextWait:e.qUpNext(q.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[w&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!w&&q.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),q.map((L,R)=>{const g=z.get(L.name),T=E.get((L.name||"").trim().toLowerCase()),$=x.liveOf(L.name),Q=!!(T&&s.has(T.id))||!!($&&($.status==="boot"||$.status==="running")),H=!!(T&&Ae(T)===1&&!T.memoUrl)&&!$;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),g?t.jsx("span",{className:"qwhen"+(g.label==="demain"?" soon":""),children:g.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:L.name}),L.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof L.score=="number"&&t.jsx("span",{className:"qs2",children:L.score}),$&&($.status==="boot"||$.status==="running")&&t.jsx(wa,{item:$,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),H&&(l.lockActions||!j?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:Q,onClick:()=>{i(T),f(M=>M+1)},children:Q?e.actAnalyseQueued:e.actAnalyse})),L.excerpt&&t.jsx("span",{className:"qex",children:L.excerpt})]},L.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([L,R])=>t.jsxs("li",{children:[t.jsx("b",{children:L})," — ",R]},L))})]})}function _d(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:s}=Y(),l=`${Ft}/cibles/list.csv?token=${a}`,c=`${Ft}/cibles/list.json?token=${a}`,x=`${Ft}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${l}")`,h=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:d},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:x,href:x}],b=!o.lockActions&&n.length>0,m=()=>{Sd(Ed(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ue,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:y,value:f,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>h(f),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function $d(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Y(),i=o!=="client",[s,l]=u.useState(null),[c,x]=u.useState(!1),[d,h]=u.useState(0),[p,b]=u.useState(!1);u.useEffect(()=>{let f=!0;return x(!1),_n(a).then(j=>{f&&(j?l(j):x(!0))}),()=>{f=!1}},[a,d]);const m=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=f=>{if(i||!s)return;const j={enabled:f.enabled??!!s.enabled,email:f.email??(s.email||""),sections:f.sections??m()};b(!0),_n(a,j).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}l(E),r(e.memoAlertSaved)})};if(c)return t.jsx(Ue,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>h(f=>f+1),children:e.retry})]})});if(!s)return t.jsx(Ue,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs(Ue,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:i||p,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(Ud,{value:s.email||"",readOnly:i||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>v({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:i||p,onChange:()=>v({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:j})]},f))}),t.jsx(Tn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Si(a,y),onTest:()=>Ei(a,y)})]})}function Ud({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,s]=u.useState(e);u.useEffect(()=>{s(e)},[e]);const l=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:x=>s(x.target.value),onKeyDown:x=>{x.key==="Enter"&&l&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!c,onClick:()=>o(i.trim()),children:n})]})]})}function Hd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Y(),[i,s]=u.useState(null),[l,c]=u.useState(!1),[x,d]=u.useState(null),[h,p]=u.useState(""),[b,m]=u.useState(0);u.useEffect(()=>{let E=!0;return c(!1),Za(a).then(w=>{E&&(w?s({configured:w.configured,url_hint:w.url_hint}):c(!0))}),Ai(a).then(w=>{E&&d(w)}),()=>{E=!1}},[a,b]);const v=(E,w)=>{o&&Za(a,E).then(N=>{if(!N||N.ok===!1){n(e.actErr);return}E.test&&N.sent===!1?n(e.plugTestThrottled):r(w),m(A=>A+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',f=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${Ft}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ue,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(E=>E+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:h,disabled:!o,onChange:E=>p(E.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!h.trim(),onClick:()=>v({url:h.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:f}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(f).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Vd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Vd(){const{t:e,token:a,lang:r}=Y(),[n,o]=u.useState("valides"),[i,s]=u.useState(!1),[l,c]=u.useState(null),[x,d]=u.useState(null),[h,p]=u.useState(!1),[b,m]=u.useState(!1),[v,y]=u.useState(null),[f,j]=u.useState(null),[E,w]=u.useState(null),N=`atl2:bulk:${a}:${n}`;u.useEffect(()=>{Za(a).then(B=>{j(B&&B.configured?B.url_hint||"webhook":null)})},[a]),u.useEffect(()=>{c(null),d(null),p(!1),y(null);try{const B=JSON.parse(localStorage.getItem(N)||"null");w(B&&Date.now()-Date.parse(B.t)<24*3600*1e3?B:null)}catch{w(null)}},[N]);const A=async()=>{s(!0),p(!1),y(null);const B=await qi(a,n);c(B),d(B.ok?n:null),s(!1)},S=u.useRef(!1),q=async()=>{if(S.current)return;S.current=!0,m(!0);const B=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await Li(a,n,"webhook",void 0,B)}finally{S.current=!1}if(m(!1),p(!1),y(L),L.ok&&(L.pushed||0)>0){const R={t:new Date().toISOString(),n:L.pushed||0};w(R);try{localStorage.setItem(N,JSON.stringify(R))}catch{}}},z=l!=null&&l.ok&&l.ready||0,F=!!(l!=null&&l.ok)&&x===n&&z>0&&!!f&&!E,D=E?new Date(E.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:B=>o(B.target.value),children:e.plugBulkTabs.map(([B,L])=>t.jsx("option",{value:B,children:L},B))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{A()},children:i?"…":e.plugBulkPreview})]}),l&&(l.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(l.ready||0,l.linkedinReady||0,(l.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(l!=null&&l.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),E&&t.jsx("p",{className:"mnote",children:e.bulkLocked(D,E.n)}),!E&&!!(l!=null&&l.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!E&&!l&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),F&&!h&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),F&&h&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(z,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{q()},children:b?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>p(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function Wd(){const{t:e,data:a,lang:r}=Y(),n=a.credits,o=a.email,i=async s=>{if(!o)return;const l=window.location.href.split("?")[0];try{const x=await(await fetch(`${gn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:s,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(Ue,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Gd(){const{t:e}=Y();return t.jsx(Ue,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Ad,{})})}function Yd(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:s,flash:l}=Y(),[c,x]=u.useState(null),[d,h]=u.useState(!1);u.useEffect(()=>{let z=!0;if(i)return vn(i).then(F=>{z&&F&&typeof F.per_day=="number"&&x(F.per_day)}),()=>{z=!1}},[i]);const[p,b]=u.useState(null);u.useEffect(()=>{if(!o)return;let z=!0;return zi(o).then(F=>{z&&b(F)}),()=>{z=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(z=>z.kind==="target"&&De(z)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(v/y*100)):null,j=(m==null?void 0:m.window_days)||30,E=v>0?v/j:0,w=y>0?Math.max(0,y-v):0,A=y>0&&E>0&&v>=100?Math.round(w/E):null,S=z=>Math.round(z).toLocaleString(a==="en"?"en-US":"fr-FR"),q=z=>{d||!s||(h(!0),Ti(o,z).then(F=>{if(h(!1),F===null){l(e.actErr);return}x(F),l(e.alertSaved)}))};return t.jsxs(Ue,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(S(v))}),y>0&&t.jsx("span",{children:e.covOf(S(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),A!==null&&t.jsx("p",{className:"mnote",children:e.covEta(A)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(S(E))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.shown)})," ",e.funShown]})]}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((z,F)=>t.jsxs("tr",{className:z.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[z.code,z.geo?` · ${z.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof z.n=="number"?S(z.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:z.source}),z.elargi&&t.jsx("em",{children:e.covWide(String(z.demande||""))}),z.erreur&&t.jsx("em",{children:e.covMissing})]})]},F)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:S(p.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),s&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(z=>t.jsx("button",{type:"button",className:c===z?"on":"",disabled:d,onClick:()=>q(z),children:z===0?"⏸":z},z))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Kd(){var f,j,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:s,lang:l}=Y(),c=n==="client",x=u.useMemo(()=>{const w=new Set;return a.forEach(N=>{N.angle&&w.add(N.angle)}),[...w]},[a]),[d,h]=u.useState(""),[p,b]=u.useState(""),[m,v]=u.useState(!1),y=async()=>{const w=d.trim();if(!(!w||m||!c)){v(!0),b("");try{const A=await(await fetch(`${Ft}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&b(String(A.reply)),A.job_id){b(e.critChatRunning);const S=async()=>{const q=await fetch(`${Ft}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(z=>z.json()).catch(()=>null);if(q&&q.done){b(String(q.reply||q.clarification||q.summary||"✓")),v(!1),q.applied&&o(e.alertSaved);return}setTimeout(()=>{S()},8e3)};setTimeout(()=>{S()},8e3),h("");return}h("")}finally{p.startsWith("⏳")||v(!1)}}};return t.jsxs(Ue,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=i==null?void 0:i.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var N,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((N=w.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(S=>t.jsx("li",{children:S},S))})]}),!!((A=w.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(S=>t.jsx("li",{children:S},S))})]})]})]},w.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:x.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||m,onChange:w=>h(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!d.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Ci,{fund:s,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(No[w]||"v-cons"),children:w}),t.jsx("span",{children:N})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",N]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Qd(){const{t:e,dispatch:a,startTour:r}=Y(),n=o=>{var i,s;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs(Ue,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+s))})]})}const zo="atl2:mapfold",Jd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(zo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Xd=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Ao=u.createContext(null),Y=()=>{const e=u.useContext(Ao);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function gt({o:e,lg:a}){const{lang:r}=Y(),n=Re(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Vn(n,r),children:[n.emoji," ",Vn(n,r)]}):null}function Ra({o:e,src:a}){const{lang:r,t:n}=Y(),o=Re(e);if(!o)return null;const i=$i(o),s=Ui(o);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(Hr(o,r))+" · "+n.win7(Vr(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Zd(e,a,r){const n=(r||"").trim();if(n){const i=e.find(s=>(s.url||"")===n);if(i)return i}const o=Be(a);if(o)return e.find(i=>Be(i.name)===o)||e.find(i=>{const s=Be(i.name);return s.length>=3&&(o.includes(s)||s.includes(o))})}function ec(){const{scoped:e,t:a,st:r,dispatch:n}=Y(),o=u.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,s=e.filter(h=>!We(h)),l=s.length,c=s.filter(h=>!h.noCo).length,x=s.filter(h=>!!h.noCo).length,d=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:d?"7":"all"}});else{const h=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:h,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",x," ",a.zoomPulseExplore]})]})]})}function tc(){const{t:e,lang:a,data:r,dispatch:n}=Y(),o=r.stats,i=l=>l.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const s=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:s>0?e.covOf(i(s)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function To({o:e}){const{lang:a}=Y(),r=_i(e.cc),n=e.cc?Pt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Mr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",ac=!1;function nc(){const[e,a]=u.useState(!1);return u.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const qo=e=>`atl2:tour:${e||"anon"}`;function rc(e){try{return localStorage.getItem(qo(e))==="1"}catch{return!0}}function Or(e){try{localStorage.setItem(qo(e),"1")}catch{}}function oc(e,a,r,n,o,i){const s=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function cc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var ie;const{lang:s}=Di(),l=ss[s],c=vs(e,s,a),[x,d]=u.useReducer(ks,void 0,()=>ys((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Xd():Jd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),h=u.useRef(!0);u.useEffect(()=>{if(h.current){h.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(zo,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e,a]),u.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const k=()=>{window.innerWidth<=760&&d({type:"mapFold",folded:!0})};return k(),window.addEventListener("resize",k),()=>window.removeEventListener("resize",k)},[a]);const p=u.useRef(i);p.current=i,u.useEffect(()=>{var k;(k=p.current)==null||k.call(p,x.filters)},[x.filters]);const[b,m]=u.useState(()=>{if(typeof window>"u")return"both";try{const k=localStorage.getItem("atl2:chrome-mode");if(k==="eval"||k==="filt"||k==="both")return k;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=u.useState(null),[f,j]=u.useState(null),[E,w]=u.useState(null),[N,A]=u.useState({kept:0,dropped:0}),[S,q]=u.useState(!1),[z,F]=u.useState(""),[D,B]=u.useState(!1),[L,R]=u.useState(null),[g,T]=u.useState(!1),[$,Q]=u.useState(!1),[,H]=u.useState(0),M=()=>H(k=>k+1),K=u.useRef([]),_=u.useRef(new Set),J=u.useRef(new Set),[X,me]=u.useState([]),[U,se]=u.useState([]),[fe,Le]=u.useState(0),ae=u.useRef(new Map),ue=u.useRef(null),{mode:xe}=c,ce=u.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),Z=ce.pipe,re=c.session.token||"",le=xe==="client"&&!e;u.useEffect(()=>{if(!re||!Z)return;let k=!0;const P=async()=>{const te=await Hi(re);!k||!te||(se(te.runs),Le(Date.now()/1e3-te.now),me(Ee=>Ee.filter(we=>!te.runs.some(tt=>Be(tt.company)===Be(we.name)))))};P();const O=X.length>0||U.some(te=>te.status==="running"),W=window.setInterval(()=>{P()},O?8e3:25e3);return()=>{k=!1,window.clearInterval(W)}},[re,Z,X.length,U.some(k=>k.status==="running")]);const be=u.useMemo(()=>{const k=[],P=new Set;for(const O of X){const W=Be(O.name);!W||P.has(W)||(P.add(W),k.push({name:O.name,id:O.id,status:"boot",started:O.started,estMin:O.estMin,memoType:"instant"}))}for(const O of U){const W=Be(O.company);if(!W||P.has(W))continue;P.add(W);const te=O.status==="error"?"error":O.status==="done"?"done":"running";k.push({name:O.company,status:te,started:O.started||0,estMin:O.est_min||(O.memo_type==="detailed"?40:15),url:O.url,error:O.error,memoType:O.memo_type,note:O.note})}return k},[X,U]),Se=k=>be.find(P=>Be(P.name)===Be(k))||null,oe=(k,P)=>{me(O=>O.some(W=>Be(W.name)===Be(k.name))?O:[...O,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:P==="detailed"?40:15}]),_.current.add(k.id),M()};u.useEffect(()=>{if(document.querySelector(`link[href="${Mr}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=Mr,document.head.appendChild(k)},[]);const pe=(k,P=!1)=>{F(k),B(P),ue.current&&clearTimeout(ue.current),ue.current=setTimeout(()=>F(""),P?4200:2400)},_e=k=>pe(k,!0),Ie=u.useMemo(()=>{const k=new Map;return c.dossiers.forEach(P=>{P.id&&k.set(P.id,P)}),k},[c.dossiers]),Ce=u.useMemo(()=>c.dossiers.filter(k=>Xt(k,x,Z)),[c.dossiers,x,Z]),ve=u.useRef(!1);u.useEffect(()=>{if(ve.current||e||c.loading||!c.dossiers.length)return;if(!ce.showFunnel||rc(c.session.token||"")){ve.current=!0;return}ve.current=!0;const k=window.setTimeout(()=>{Or(c.session.token||""),T(!0)},700);return()=>window.clearTimeout(k)},[e,c.loading,c.dossiers.length,ce.showFunnel,c.session.token]);const ye=u.useMemo(()=>c.dossiers.filter(k=>js(k,x,Z,c.favIds)),[c.dossiers,x,Z,c.favIds]),He=u.useMemo(()=>Ii(Ce,c.favIds),[Ce,c.favIds]),Fe=u.useRef(!1);u.useEffect(()=>{if(Fe.current)return;if(!Z||a==="ops"){Fe.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Fe.current=!0;return}if(c.loading)return;Fe.current=!0;const k=Pi(He);k!==x.ptab&&d({type:"ptab",tab:k})},[Z,a,n==null?void 0:n.ptab,c.loading,He,x.ptab]);const dt=u.useMemo(()=>{const k=Zr(c.dossiers);return k?mt(k)===0?l.tourToday:eo(k,s):l.tourNoRun},[c.dossiers,l,s]),ft=u.useMemo(()=>c.dossiers.some(k=>!!k.memoUrl||!!k.summary||Rt(k)),[c.dossiers]),[vt,nt]=u.useState(!1);u.useEffect(()=>{if(c.loading){nt(!1);return}if(c.dossiers.length>0||c.error){nt(!0);return}const k=window.setTimeout(()=>nt(!0),6e3);return()=>window.clearTimeout(k)},[c.loading,c.dossiers.length,c.error]);const yt=(c.marketEstimate||0)>0||typeof((ie=c.stats)==null?void 0:ie.screened)=="number"&&c.stats.screened>0,wt=u.useMemo(()=>[1,0,2,4,5,3].find(k=>(He[k]||0)>0)??0,[He]),Ze=yn.find(k=>k.key===x.continent),ht=x.continent==="monde"?l.contWorld:(s==="fr"?Ze==null?void 0:Ze.fr:Ze==null?void 0:Ze.en)||"";u.useEffect(()=>{const k=P=>{var W;const O=(((W=P.detail)==null?void 0:W.name)||"").trim();O&&kt(null,O)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),u.useEffect(()=>{const k=P=>{const O=P.detail||{},W=String(O.id||"").trim(),te=String(O.name||"").trim(),Ee=String(O.url||"").trim(),we=W&&Ie.get(W)||Zd(c.dossiers,te,Ee);if(we){if(j(null),Xt(we,x,Z)||(x.continent!=="monde"&&we.continent!==x.continent&&d({type:"continent",key:we.continent||"monde"}),d({type:"reset"})),Z&&we.kind!=="op"){const ke=Ae(we);typeof ke=="number"&&ke!==x.ptab&&d({type:"ptab",tab:ke})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),d({type:"focus",id:we.id}),(we.noCo||["media","nominations","recrutements"].includes(we.engine||""))&&(we.url||we.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:we.url||"",text:[we.headline,we.tagline].filter(Boolean).join(`
`)}})):we.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:we.name,url:we.url||"",website:we.website||"",domain:we.domain||""}}));return}!te&&!Ee||(d({type:"focus",id:W||null}),j({name:te,headline:String(O.text||"").trim()||te,url:Ee,card:O.card}),Ee&&(ka(te)||!te)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee,text:String(O.text||"").trim()}})):te&&!ka(te)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:te}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),u.useEffect(()=>{const k=W=>{const te={},Ee=String((W==null?void 0:W.sector)||"").trim();Ee&&(te.sector=[Ee]);const we=String((W==null?void 0:W.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(we)&&(te.day=we);const tt=String((W==null?void 0:W.search)||"").trim();tt&&(te.search=tt);const ke=String((W==null?void 0:W.dealKind)||"").trim();(ke==="ma"||ke==="levee"||ke==="other")&&(te.dealKind=[ke]),Object.keys(te).length&&d({type:"filters",patch:te})},P=W=>k(W.detail),O=W=>{W.data&&W.data.type==="pp-filter"&&k(W.data)};return window.addEventListener("ppmap:filter",P),window.addEventListener("message",O),()=>{window.removeEventListener("ppmap:filter",P),window.removeEventListener("message",O)}},[]),u.useEffect(()=>{const k=P=>{var te;const O=(((te=P.detail)==null?void 0:te.name)||"").trim().toLowerCase();if(!O)return;const W=c.dossiers.find(Ee=>(Ee.name||"").trim().toLowerCase()===O);W&&d(a==="ops"?{type:"focus",id:W.id}:{type:"popup",id:W.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const kt=(k,P)=>{const O=((k==null?void 0:k.name)||P||"").trim();if(!le){w({kicker:O});return}!O||S||(q(!0),(async()=>{try{let W=O;const te=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(te)W=te;else try{const ke=await $r(O);if(ke!=null&&ke.website)W=ke.website;else if(((ke==null?void 0:ke.candidates)||[]).length===1)W=ke.candidates[0].url;else if(((ke==null?void 0:ke.candidates)||[]).length>1){K.current=[{name:O,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(ke.candidates||[]).slice(0,5)},...K.current].slice(0,8),M();return}}catch{}const Ee=await Ur(re,W,"atelier2"),we={name:Ee.company||O,verdict:Ee.verdict,reason:Ee.reason||"",remaining:Ee.remaining??null};K.current=[we,...K.current].slice(0,8),Ee.verdict==="kept"&&A(ke=>({...ke,kept:ke.kept+1})),Ee.verdict==="ruled_out"&&A(ke=>({...ke,dropped:ke.dropped+1}));const tt=k||c.dossiers.find(ke=>(ke.name||"").toLowerCase()===O.toLowerCase());tt&&(Ee.verdict==="kept"?tt.verdict=tt.verdict||"MATCH":Ee.verdict==="ruled_out"&&(tt.verdict="NO MATCH"),Ee.reason&&(tt.reasoning=Ee.reason)),M()}finally{q(!1)}})())},C=k=>{if(!le){w({kicker:k.name});return}oe(k,"instant"),Ht(re,"fast_request",k.name||"",""),pe(l.memoInstantSent(k.name))},G=k=>ae.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),V=(k,P)=>d({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:P}}),ne=async(k,P,O)=>{const W=k.ceoStatus||"";k.ceoStatus=P,M();const te=await Pa(re,{status:P,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(O==null?void 0:O.note)!==void 0?{note:O.note}:{},...O!=null&&O.via?{via:O.via}:{}});return te.ok?te.skipped?(k.ceoStatus=W,M(),_e(l.actNotPersisted),!1):((O==null?void 0:O.undo)!==!1&&V(k,W),O!=null&&O.msg&&pe(O.msg),(P==="Validé"||P==="Écarté")&&!k.ceoNote&&(O==null?void 0:O.note)===void 0&&R({o:k,yes:P==="Validé"}),!0):(k.ceoStatus=W,M(),_e(l.actErr),!1)},ge=async(k,P)=>{const O=await Pa(re,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:P,via:"note"});return!O.ok||O.skipped?(_e(O.skipped?l.actNotPersisted:l.actErr),!1):(k.ceoNote=P,M(),!0)},de=u.useRef(new Map),Me=k=>de.current.has(k.id)?de.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),Ye=(k,P)=>{de.current.set(k.id,P),M()},je=(k,P)=>{le&&ne(k,P?"Validé":"Écarté",{msg:P?l.decidedYes(k.name):l.decidedNo(k.name)})},rt=k=>{le&&ne(k,"À trancher",{msg:l.promoted(k.name)})},_t=k=>{le&&(async()=>{const P=k.ceoStatus||"";k.ceoStatus="Retenu",M();const O=await Pa(re,{status:"Retenu",check_id:k.checkId,company:k.name});if(!O.ok||O.skipped){k.ceoStatus=P,M(),_e(O.skipped?l.actNotPersisted:l.actErr);return}V(k,P),pe(l.repeched(k.name))})()},Tt=()=>{const k=x.undo[x.undo.length-1];if(!k){pe(l.undoNone);return}const P=Ie.get(k.id);if(!P){d({type:"undoPop"}),pe(l.undoNone);return}let O=k.prevCeoStatus;if(!O)if((P.verdict||"").toUpperCase().includes("CALL"))O="À trancher";else{pe(l.undoLockedTitle);return}(async()=>await ne(P,O,{undo:!1})&&(d({type:"undoPop"}),P.ceoStatus=k.prevCeoStatus,M(),pe(l.undoDone(P.name))))()},Oe=k=>{le&&(J.current.add(k.id),M(),(async()=>{const P=await Vi(re,k.name,"email");if(!P||P.ok===!1){J.current.delete(k.id),M(),_e(l.actErr);return}Ht(re,"approach",k.name||"",""),pe(l.actApproachSent)})())},Pe=(k,P)=>{le&&(async()=>{if(!(await Ht(re,P?"yes":"no",k.name||"","")).ok){_e(l.actErr);return}ae.current.set(k.id,P?"yes":"no"),M(),pe(P?l.thumbUpDone:l.thumbDnDone)})()},et=k=>{!le||!Rt(k)||(oe(k,"detailed"),Ht(re,"detailed_request",k.name||"",""),pe(l.memoDeepSent(k.name)))},$t=k=>{const P=new Set(c.favIds),O=P.has(k.id);O?P.delete(k.id):P.add(k.id),c.setFavIds(P),le&&Wi(re,{id:k.id,co:k.name},O)},Ut=()=>{!le||$||window.confirm(l.identSyncConfirm)&&(Q(!0),(async()=>{const k=await Gi(re);Q(!1),k?pe(l.identSyncDone):_e(l.actErr)})())},ia=/proplace/i.test(c.fund||""),Ma=k=>{!le||!ia||(Ht(re,"onboard_request",k.name||"",""),pe(l.onboardSent(k.name)))},I={st:x,dispatch:d,t:l,lang:s,mode:xe,caps:ce,pipe:Z,token:re,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:_t,thumbOf:G,canWrite:le,commitStatus:ne,saveNote:ge,stageOf:Me,setStage:Ye,flashErr:_e,startTour:()=>T(!0),dossiers:c.dossiers,scopedAll:Ce,scoped:ye,counts:He,byId:Ie,contName:ht,favIds:c.favIds,toggleFav:$t,askEvaluate:kt,doAnalyse:C,doDecide:je,doPromote:rt,doApproach:Oe,doThumb:Pe,doDeep:et,doUndo:Tt,doSync:Ut,doOnboard:Ma,outbound:ia,memoQueued:_.current,liveMemos:{items:be,serverOff:fe,liveOf:Se},approachDone:J.current,sessTally:N,evalCards:K.current,evalBusy:S,markRow:y,markedId:v,flash:pe,focusExtra:f};u.useEffect(()=>{const k=P=>{P.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const ee=k=>re?t.jsx(Ss,{token:re,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(Ao.Provider,{value:I,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(re?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:ps}),ee(t.jsxs("div",{className:"app"+(Z?" pipe":"")+(re?" has-thesis":""),children:[ce.showTicker&&t.jsx(at,{name:"live",children:t.jsxs("div",{className:"live-stack"+(re?" live-stack--cibles":""),children:[t.jsx(Fs,{}),!!re&&t.jsx(Cs,{})]})}),ce.showIdent&&t.jsx(at,{name:"identite",children:t.jsx(Vs,{})}),!1,ac,ce.showFunnel&&t.jsx(at,{name:"entonnoir",children:t.jsx(ic,{})}),!x.mapFolded&&t.jsx(at,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(wo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(ec,{}),a!=="ops"&&ce.showFunnel&&t.jsx(tc,{}),t.jsx(Ul,{}),t.jsx(yo,{})]})]})}),ce.showDemand&&Z&&t.jsx(at,{name:"direct",children:t.jsx(Xi,{items:be,serverOff:fe,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>d({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([k,P])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===k,onClick:()=>{m(k);try{localStorage.setItem("atl2:chrome-mode",k)}catch{}},children:P},k))}),ce.showDemand&&t.jsx(at,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Ql,{})})}),ce.showDemand&&x.memoConsole&&t.jsx(at,{name:"console",children:t.jsx(Xl,{})}),ce.pipe&&!!re&&t.jsx(at,{name:"moteurs",children:t.jsx(rs,{})}),t.jsx(at,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(jd,{})}),c.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:l.retry})]})]})),x.popupId&&x.dens!=="liste"&&a!=="ops"&&t.jsx(at,{name:"fiche",children:t.jsx(id,{})}),t.jsx(at,{name:"modales",children:t.jsx(qd,{})}),t.jsx(Os,{}),L&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:L.o.name}),t.jsx(_s,{placeholder:L.yes?l.whyYesPh:l.whyNoPh,onDone:k=>{const P=L.o;R(null),k&&ge(P,k).then(O=>{O&&pe(l.csNoteSaved)})}})]}),g&&vt&&t.jsx(Us,{steps:oc(l,dt,ft,wt,yt,He[3]||0),onClose:()=>{T(!1),Or(re)}}),t.jsx(nc,{}),ce.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:Jr,children:jn}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${Na}`,children:Na})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),z&&t.jsx("div",{className:"flash on"+(D?" err":""),children:z}),E&&t.jsx(Bi,{variant:"acquirer",initialCompany:Dr().co,initialWebsite:Dr().site,onClose:()=>w(null)})]})})}function ic(){const{t:e}=Y(),[a,r]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Dr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function sc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{To as FlagCell,gt as SigBadge,Ra as SigWin,cc as default,sc as fmtShort,Y as useV2};
;/* deploy-1788031542 */
