...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,qo=Mo+Oo;function oa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Fo(){const e=oa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Po(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Fo();return r==="0"?"client":r==="1"||oa("embed")==="1"&&oa("chrome")==="1"?"apercu":"client"}const Do={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Io=e=>Do[e],He=e=>Object.assign(e,{continent:Dr(e.cc)});function Gt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Bo=60*60*1e3;function $o(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Bo?null:a}catch{return null}}function kt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const _o=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Uo(e,a,r="default"){const n=r!=="default",i=h.useMemo(()=>e||n?{mode:"anon"}:zr(),[e,n]),o=h.useMemo(()=>n?"visiteur":Po(e,i),[e,i,n]),l=h.useMemo(()=>Io(o),[o]),s=o!=="visiteur",p=_o(r),[g,c]=h.useState([]),[d,u]=h.useState(""),[x,f]=h.useState(null),[b,v]=h.useState(null),[m,y]=h.useState(null),[j,w]=h.useState(()=>new Map),[E,z]=h.useState(()=>new Map),[R,B]=h.useState(""),[S,M]=h.useState(new Set),[q,L]=h.useState(null),[U,k]=h.useState(!0),[N,T]=h.useState(!1),[H,G]=h.useState(0),[Z,A]=h.useState(0),O=h.useRef(0),I=h.useMemo(()=>{var D;if(o!=="client")return"";try{return((D=Ar())==null?void 0:D.email)||""}catch{return""}},[o]);h.useEffect(()=>{const D=++O.current;let _=!0;const W=()=>_&&D===O.current,J=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),oe=$o(J);return oe?(c(oe.objs.map(He)),oe.fund&&u(oe.fund),f(oe.marketEstimate??null),v(oe.criteria??null),y(oe.stats??null),B(oe.generatedAt||""),k(!1)):k(!0),(async()=>{try{if(r==="ops"){const ue=await Ht(),pe=((ue==null?void 0:ue.recent_ops)||[]).map(Q=>{const te=Yt(Q.company_name||Q.title?Q:{...Q,title:(Q.headline_fr||Q.headline||"").slice(0,120)},a),ge=String(Q.rubrique||"").toLowerCase();return te&&(ge==="nominations"||ge==="recrutements")&&(te.engine=ge),te&&!String(Q.company_name||"").trim()&&(te.noCo=!0),te}).filter(Q=>!!Q).map(Q=>(Tr((Q.name||"").trim())||(Q.noCo=!0),Q));try{const Q=await Lr(),te=Rr(Q),ge=((Q==null?void 0:Q.date)||"").slice(0,10);if(te.length&&ge){const K=new Set;for(const se of pe){if(se.noCo||(se.date||"").slice(0,10)!==ge)continue;const ee=Da(te,K,se.name,"");ee>=0&&(K.add(ee),se.decryptHtml=te[ee].html)}for(const se of pe){if(se.decryptHtml||(se.date||"").slice(0,10)!==ge)continue;const ee=Da(te,K,"",se.headline||se.tagline||se.name);ee>=0&&(K.add(ee),se.decryptHtml=te[ee].html)}}}catch{}if(!W())return;c(pe.map(He)),kt(J,{objs:pe})}else if(typeof r=="object"){const pe=(await Ia()||[]).filter(te=>(te.slug||"")===r.research).map(te=>Ba(te,a)).filter(te=>!!te),Q=Gt(await $a(pe,a));if(!W())return;c(Q.map(He)),kt(J,{objs:Q})}else if(s&&i.token){const ue=Mr(i.token),pe=Ht(),Q=Or(i.token),te=qr(i.token),ge=Fr(i.token),K=await ue;let se=K?K.targets:[];W()&&K&&(u(K.fund||""),f(K.marketEstimate??null),v(K.criteria??null),y(K.stats??null),B(K.generatedAt||""),c(se.map(He)),k(!1),T(!1));const[ee,Be,fe,he]=await Promise.all([pe,Q,te,ge]),Fe=((ee==null?void 0:ee.recent_ops)||[]).map(Ne=>Yt(Ne,a)).filter(Ne=>!!Ne);if(se=[...se,...Fe],!W())return;c(se.map(He));const Ue=new Set;for(const Ne of Be){const Pe=(Ne.id||Ne.co||"").toString().trim().toLowerCase();Pe&&Ue.add(Pe.startsWith("t:")?Pe:"t:"+Pe)}M(Ue),w(fe),z(he),K&&kt(J,{fund:K.fund,marketEstimate:K.marketEstimate,criteria:K.criteria,stats:K.stats,generatedAt:K.generatedAt,objs:se})}else{const ue=Pr(),pe=Ia(),Q=Ht(),te=await ue;W()&&te.length&&(c(Gt(te).map(He)),k(!1),T(!1));const[ge,K]=await Promise.all([pe,Q]),se=(ge||[]).map(he=>Ba(he,a)).filter(he=>!!he),ee=await $a(se,a),Be=((K==null?void 0:K.recent_ops)||[]).map(he=>Yt(he,a)).filter(he=>!!he),fe=Gt([...te,...ee,...Be]);if(!W())return;c(fe.map(He)),kt(J,{objs:fe})}W()&&T(!1)}catch{W()&&!oe&&T(!0)}finally{W()&&k(!1)}})(),()=>{_=!1}},[s,i.token,a,H,p]),h.useEffect(()=>{if(!l.showCredits||!I){L(null);return}let D=!0;return(async()=>{try{const _=await fetch(`${ja}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:I})});if(!_.ok)return;const W=await _.json();D&&W&&W.ok!==!1&&L(W)}catch{}})(),()=>{D=!1}},[l.showCredits,I,Z]);const F=h.useCallback(D=>M(new Set(D)),[]);return{session:i,mode:o,caps:l,fund:d,email:I,marketEstimate:x,generatedAt:R,criteria:b,stats:m,thumbs:j,stages:E,dossiers:g,favIds:S,setFavIds:F,credits:q,reloadCredits:()=>A(D=>D+1),loading:U,error:N,refresh:()=>G(D=>D+1)}}const Bn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Vo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Bn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Ho(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Bn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??$n)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const $n=40;function za(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!xe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Na(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(nt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&We(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function _n(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:za(e,a.filters,r)}function Yo(e,a,r,n){return!(!_n(e,a,r)||r&&!Ir(e,a.ptab,n))}function Aa(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-nt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=xe(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const Wo=["ma","levees","nominations","recrutements","actualites"],Go=300,Kt=7,Ko={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Un={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Qo=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Qa(e){const a=xe(e);if(a)return"sig:"+(a.theme&&Un.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Xo(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=P(),s=l==="en",[p,g]=h.useState("all"),[c,d]=h.useState(!1),u=h.useMemo(()=>{const S=(a.filters.day||"").slice(0,10),M=k=>!(!o&&a.continent!=="monde"&&k.continent!==a.continent||S&&(k.date||"").slice(0,10)!==S),q=e.filter(k=>M(k)&&xe(k)),L=e.filter(k=>M(k)&&k.kind==="op"&&!xe(k)&&(S?!0:nt(k.date)<=Kt)),U=S||new Date().toISOString().slice(0,10);return L.sort((k,N)=>{const T=(k.date||"").slice(0,10)===U?0:1,H=(N.date||"").slice(0,10)===U?0:1;return T!==H?T-H:(N.amountEur||0)-(k.amountEur||0)}),[...Aa(q,{key:"signal",dir:-1}),...L]},[e,a.continent,a.filters.day,o]),x=h.useMemo(()=>{const S={};for(const M of u){const q=Qa(M);S[q]=(S[q]||0)+1}return S},[u]),f=h.useMemo(()=>p==="all"?u:u.filter(S=>Qa(S)===p),[u,p]),b=h.useMemo(()=>f.slice(0,Go),[f]),v=f.length-b.length,m=S=>S==="all"?u.length:x[S]||0,y=S=>S==="all"?s?"All":"Tout":S.startsWith("sig:")?Un[s?"en":"fr"][S.slice(4)]||"🔔":Ko[s?"en":"fr"][S],j=[{k:"all"}],w=Wo.filter(S=>m(S)>0||S===p);if(w.length){j.push({g:s?"DEALS":"OPÉRATIONS"});for(const S of w)j.push({k:S})}const E=Qo.map(S=>"sig:"+S).filter(S=>m(S)>0||S===p);if(E.length){j.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const S of E)j.push({k:S})}const z=S=>{try{return new Date(S+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return S}},R=(()=>{const S=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?s?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return S?(s?`LIVE covers the events of ${z(S)}.`:`Le LIVE regroupe les événements du ${z(S)}.`)+M:(s?`LIVE covers the still-open signals and the deals of the last ${Kt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Kt} derniers jours.`)+M})(),B=S=>b.map(M=>t.jsxs("button",{type:"button",className:"tk"+(ye(M)?" spent":""),onClick:q=>{const L=q.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:L.left+L.width/2,y:L.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(Xe,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(gr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Al(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(_t,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},S+(M.id||M.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},S+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:S=>{S.currentTarget.contains(S.relatedTarget)||d(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":c,onClick:()=>d(S=>!S),children:[y(p),t.jsx("b",{children:m(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!c,children:[t.jsx("span",{className:"tkfilscope",children:R}),j.map(S=>"g"in S?t.jsx("span",{className:"tkfilg",children:S.g},S.g):t.jsxs("button",{type:"button","aria-pressed":S.k===p,onClick:()=>{g(S.k),d(!1)},children:[y(S.k),t.jsx("b",{children:m(S.k)})]},S.k))]})]}),t.jsx("div",{className:"win",children:b.length?t.jsxs("div",{className:"run",children:[B(0),B(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const Jo="aDx8z7Hzksus",Vn="+33 6 83 10 72 86",Xa="alexandre@proplace.co",Zo=`tel:${Vn.replace(/[^\d+]/g,"")}`,Ja="pp-rdv-slot";function ei(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ti(){const{t:e,caps:a,fund:r}=P();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:ni}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Zo,children:Vn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Xa}`,children:Xa})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Ao,{filloutId:Jo,parameters:r?{company_name:r}:void 0})})]})}function ai(){const[e,a]=h.useState(()=>typeof document>"u"?null:document.getElementById(Ja));return h.useEffect(()=>{e||a(document.getElementById(Ja))},[e]),e?rt.createPortal(t.jsx(ti,{}),e):null}const ni=`
...
`;class me extends h.Component{constructor(){super(...arguments);Fa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ri=8;function oi(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=P(),[s,p]=h.useState(!1),[g,c]=h.useState(!1),[d,u]=h.useState(!1),x=r||"home",{names:f,verdicts:b}=h.useMemo(()=>{const w=[],E={};return n.forEach(z=>{z.kind!=="target"||!z.name||(w.push(z.name),E[z.name]=Br(z)||"")}),{names:w,verdicts:E}},[n]),v=h.useMemo(()=>f.length?$r(x,f,b,a):null,[x,f.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const m=g?v.added:v.added.slice(0,ri),y=v.added.length-m.length,j=w=>{const E=n.find(z=>z.name===w);E&&(o(E.id),l({type:"popup",id:E.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),_r(x,f,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[m.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>c(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),d&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Qt=600,Ye=62,Za="atl2:fstats";function ii(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=P(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Za)==="on"}catch{return!1}}),p=r.stats,g=h.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),c=h.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const d=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),x=g.reduce((y,j)=>Math.max(y,j.s||0),0),f=g.length?Qt/g.length:0,b=Math.max(4,f-4),v=g.length>=5&&x>0,m=[[p.screened,e.funScreened(d(c)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[m.map(([y,j,w],E)=>t.jsxs("span",{className:"fst-t",children:[E>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:j}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Za,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Qt} ${Ye}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((y,j)=>{const w=(y.s||0)/x*(Ye-4),E=(y.m||0)/x*(Ye-4),z=j*f+(f-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${d(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:Ye-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:Ye-2-E,width:b,height:E,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Ye-1.5,x2:Qt,y2:Ye-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:d(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const si=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function li({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=P(),[o,l]=h.useState(""),[s,p]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),c=(ot(e)||"").startsWith("CALL")&&je(e)===3,d=je(e)>=2,u=async f=>{if(o||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(f);const b=await i(e,f);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},x=c?[["Validé",a.csYes],["Écarté",a.csNo]]:si.filter(([f])=>!(d&&f==="Retenu")).map(([f,b])=>[f,a[b]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),x.map(([f,b])=>t.jsx("button",{type:"button",className:"csb"+(g===f?" on":"")+(o===f?" busy":""),disabled:!!o,onClick:()=>{u(f)},children:b},f)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(di,{o:e})]})}function di({o:e}){const{t:a,saveNote:r,flash:n}=P(),[i,o]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[p,g]=h.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),d=async()=>{if(l||!c)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&d()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{d()},children:p?a.csNoteSaved:a.csNoteOk})]})}function ci({placeholder:e,onDone:a}){const{t:r}=P(),[n,i]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function pi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=P(),[p,g]=h.useState(!1);if(!n.pipe||!i||n.lockActions||je(e)!==4)return null;const c=o(e),d=(c==null?void 0:c.stage)||"todo",u=async m=>{if(p||m===d)return;g(!0);const y=c;l(e,{stage:m,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),en+=1);en=j;const w=await Ur(r,{company:e.name||"",stage:m,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},x=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,f=x?Math.floor((Date.now()-Date.parse(x))/864e5):0,b=d==="sent"&&x&&f>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(d===m?" on":""),disabled:p,onClick:()=>{u(m)},children:y},m)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let en=0;const jt=8,Nt=340;function tn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function ui({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=P(),[l,s]=h.useState(0),[p,g]=h.useState(null),[c,d]=h.useState([]),u=h.useRef(!1);h.useEffect(()=>{u.current||(u.current=!0,d(e.filter(j=>!!document.querySelector(j.need||j.sel))))},[e]);const x=c[l],f=l>=c.length;h.useEffect(()=>{x&&(x.ptab!==void 0&&o.ptab!==x.ptab&&n({type:"ptab",tab:x.ptab}),x.dens&&o.dens!==x.dens&&n({type:"dens",dens:x.dens}))},[l,x]);const b=h.useCallback(()=>{if(!x){g(null);return}const j=document.querySelector(x.sel);if(!j){g(null);return}j.scrollIntoView({block:"nearest",behavior:"smooth"}),g(j.getBoundingClientRect())},[x]);h.useLayoutEffect(()=>{b();const j=window.setTimeout(b,260),w=()=>b();return window.addEventListener("scroll",w,!0),window.addEventListener("resize",w),()=>{window.clearTimeout(j),window.removeEventListener("scroll",w,!0),window.removeEventListener("resize",w)}},[b]);const v=h.useRef(a);if(v.current=a,h.useEffect(()=>{const j=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),v.current()):w.key==="ArrowRight"?s(E=>E+1):w.key==="ArrowLeft"&&s(E=>Math.max(0,E-1))};return document.addEventListener("keydown",j,!0),()=>document.removeEventListener("keydown",j,!0)},[]),!c.length)return null;let m=null;if(f){const j=i[3]||0;j>0?m={title:j===1?r.ahaATitle1:r.ahaATitleN(j),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:(i[1]||0)>0?m={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:()=>{n({type:"ptab",tab:1}),a()}}:m={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Nt};if(!f&&p){const j=p.bottom+14,E=window.innerHeight-j>190?j:Math.max(12,p.top-200);y={left:Math.min(Math.max(12,p.left+p.width/2-Nt/2),window.innerWidth-Nt-12),top:E,width:Nt}}return rt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!f&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-jt,top:p.top-jt,width:p.width+jt*2,height:p.height+jt*2}}),(f||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(f?" fin":""),style:y,children:[f&&m?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:m.title}),t.jsx("p",{children:t.jsx(tn,{text:m.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:m.go,children:m.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(l+1,c.length)}),t.jsx("h3",{children:x==null?void 0:x.title}),t.jsx("p",{children:t.jsx(tn,{text:(x==null?void 0:x.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(j=>Math.max(0,j-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(j=>j+1),children:l===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function fi(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,dispatch:l}=P(),s=r?a:e,p=h.useMemo(()=>s.filter(m=>nt(m.date)===0&&m.kind==="target"),[s]),g=h.useMemo(()=>r?a.filter(m=>je(m)===0).slice().sort((m,y)=>(y.date||"").localeCompare(m.date||"")):[],[a,r]),c=h.useMemo(()=>p.filter(m=>r?je(m)===0:!ye(m)),[p,r]),d=r?g:c,u=r?a.length-g.length:p.length-c.length,x=r?a.length:p.length,f=x?Math.min(100,u/x*100):100;let b;r?b=i.morningThesis(p.length,g.length):p.length?u===0?b=i.goalSourced(p.length):u>=p.length?b=i.goalCleared:b=i.goalDone(u,p.length):b=i.goalSourced(0);const v=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&g.length&&l({type:"chainStart",queue:g.map(m=>m.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:b}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:f+"%"}})}),d.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:v,children:r?i.morningEval(d.length):o.pileMode?i.goalContinue(d.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function mi(){var M,q;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:g,startTour:c}=P(),[d,u]=h.useState(null),[x,f]=h.useState([]),b=p==="client";h.useEffect(()=>{if(!i||!o)return;let L=!0;return(async()=>{const[U,k]=await Promise.all([Sa(o),qn(i)]);L&&(U&&u(U),f(k))})(),()=>{L=!1}},[i,o]);const v=(d==null?void 0:d.per_day)??null,m=((M=d==null?void 0:d.pool_order)==null?void 0:M.length)??0,y=x.filter(L=>L.status==="running").length,j=h.useMemo(()=>s.filter(L=>L.kind==="target"&&ye(L)).length,[s]),w=l.marketEstimate,E=typeof((q=l.stats)==null?void 0:q.screened)=="number"?l.stats.screened:j,z=w&&w>0?Math.min(100,Math.round(E/w*100)):null,R=L=>L.toLocaleString(a==="en"?"en-US":"fr-FR"),B=(o||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),S=(()=>{const L=Date.parse(l.generatedAt||"");if(Number.isNaN(L))return"";const U=new Date(L),k=N=>String(N).padStart(2,"0");return`${k(U.getDate())}/${k(U.getMonth()+1)} à ${k(U.getHours())}:${k(U.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:B}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),S&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(S)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[z===null&&E>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(E)})})]}),z!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:z+"%"}})}),t.jsxs("b",{children:[z," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(E,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(m)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function xi(){const{t:e,counts:a,dispatch:r}=P();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const hi=["--p0","--p1","--p2","--p3","--p4"];function gi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=P(),s=o.loading&&!l.length,p=h.useRef({});h.useEffect(()=>{p.current={...r}},[r]);const g=u=>{const x=p.current[u],f=x!==void 0?r[u]-x:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${hi[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(f>0?" up":f<0?" down":""),children:[r[u],f!==0&&t.jsxs("em",{className:"delta",children:[f>0?"+":"−",Math.abs(f)]})]})]},u)},c=(u,x,f)=>t.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:f.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),d=(u,x,f,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:x,disabled:b,onClick:f,children:u},x);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[c(5,!1,n.plabels[5]),c(7,!0,n.plabels[7]),c(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[d("↩",n.toolUndo,i,e.undo.length===0),d("↺",n.toolReset,()=>{a({type:"reset"})}),d("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),d("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),d("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const bi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function vi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=P(),s=h.useRef(null),[p,g]=h.useState(60);h.useEffect(()=>{let x=0;const f=()=>{var j;const b=s.current;if(!b)return;const v=(j=b.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!v)return;const m=v.getBoundingClientRect(),y=b.getBoundingClientRect();g(Math.max(20,Math.min(m.left+m.width/2-y.left,y.width-30)))};return x=requestAnimationFrame(f),window.addEventListener("resize",f),()=>{cancelAnimationFrame(x),window.removeEventListener("resize",f)}},[e.ptab]);const c=e.ptab;let d=r.tuto[c].p;if(c===3){const x=n.filter(v=>v.kind==="target"&&je(v)===3),f=x.filter(v=>aa(v)==="auto").length,b=x.filter(v=>aa(v)==="cd").length;d=r.tutoPending(f,b,x.length)}const u=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(x=>x.id)})};if(c===1){const x=n.filter(f=>f.kind==="target"&&je(f)===1&&!i.has(f.id)).slice(0,10);if(x.length)return{label:r.tuto[1].a,run:()=>x.forEach(f=>o(f))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":bi[c],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:d}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Ke{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*yi(e){for(const a of e)yield*a}function Hn(e){return Array.from(yi(e))}var ne=1e-6,X=Math.PI,ze=X/2,an=X/4,Te=X*2,De=180/X,Ce=X/180,ie=Math.abs,wi=Math.atan,ht=Math.atan2,de=Math.cos,ce=Math.sin,ki=Math.sign||function(e){return e>0?1:e<0?-1:0},Je=Math.sqrt;function ji(e){return e>1?0:e<-1?X:Math.acos(e)}function gt(e){return e>1?ze:e<-1?-ze:Math.asin(e)}function Ae(){}function Rt(e,a){e&&rn.hasOwnProperty(e.type)&&rn[e.type](e,a)}var nn={Feature:function(e,a){Rt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Rt(r[n].geometry,a)}},rn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ia(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ia(r[n],a,0)},Polygon:function(e,a){on(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)on(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Rt(r[n],a)}};function ia(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function on(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ia(e[r],a,1);a.polygonEnd()}function Ze(e,a){e&&nn.hasOwnProperty(e.type)?nn[e.type](e,a):Rt(e,a)}function sa(e){return[ht(e[1],e[0]),gt(e[2])]}function tt(e){var a=e[0],r=e[1],n=de(r);return[n*de(a),n*ce(a),ce(r)]}function St(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Mt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Xt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Ct(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function la(e){var a=Je(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function da(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function ca(e,a){return ie(e)>X&&(e-=Math.round(e/Te)*Te),[e,a]}ca.invert=ca;function Ni(e,a,r){return(e%=Te)?a||r?da(ln(e),dn(a,r)):ln(e):a||r?dn(a,r):ca}function sn(e){return function(a,r){return a+=e,ie(a)>X&&(a-=Math.round(a/Te)*Te),[a,r]}}function ln(e){var a=sn(e);return a.invert=sn(-e),a}function dn(e,a){var r=de(e),n=ce(e),i=de(a),o=ce(a);function l(s,p){var g=de(p),c=de(s)*g,d=ce(s)*g,u=ce(p),x=u*r+c*n;return[ht(d*i-x*o,c*r-u*n),gt(x*i+d*o)]}return l.invert=function(s,p){var g=de(p),c=de(s)*g,d=ce(s)*g,u=ce(p),x=u*i-d*o;return[ht(d*i+u*o,c*r+x*n),gt(x*r-c*n)]},l}function Si(e,a,r,n,i,o){if(r){var l=de(a),s=ce(a),p=n*r;i==null?(i=a+n*Te,o=a-p/2):(i=cn(l,i),o=cn(l,o),(n>0?i<o:i>o)&&(i+=n*Te));for(var g,c=i;n>0?c>o:c<o;c-=p)g=sa([l,-s*de(c),-s*ce(c)]),e.point(g[0],g[1])}}function cn(e,a){a=tt(a),a[0]-=e,la(a);var r=ji(-a[1]);return((-a[2]<0?-r:r)+Te-ne)%Te}function Yn(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ae,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Lt(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Et(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Wn(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(f){if(!((b=f.length-1)<=0)){var b,v=f[0],m=f[b],y;if(Lt(v,m)){if(!v[2]&&!m[2]){for(i.lineStart(),s=0;s<b;++s)i.point((v=f[s])[0],v[1]);i.lineEnd();return}m[0]+=2*ne}o.push(y=new Et(v,f,null,!0)),l.push(y.o=new Et(v,null,y,!1)),o.push(y=new Et(m,f,null,!1)),l.push(y.o=new Et(m,null,y,!0))}}),!!o.length){for(l.sort(a),pn(o),pn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var g=o[0],c,d;;){for(var u=g,x=!0;u.v;)if((u=u.n)===g)return;c=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(x)for(s=0,p=c.length;s<p;++s)i.point((d=c[s])[0],d[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(x)for(c=u.p.z,s=c.length-1;s>=0;--s)i.point((d=c[s])[0],d[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,c=u.z,x=!x}while(!u.v);i.lineEnd()}}}function pn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function Jt(e){return ie(e[0])<=X?e[0]:ki(e[0])*((ie(e[0])+X)%Te-X)}function Ci(e,a){var r=Jt(a),n=a[1],i=ce(n),o=[ce(r),-de(r),0],l=0,s=0,p=new Ke;i===1?n=ze+ne:i===-1&&(n=-ze-ne);for(var g=0,c=e.length;g<c;++g)if(u=(d=e[g]).length)for(var d,u,x=d[u-1],f=Jt(x),b=x[1]/2+an,v=ce(b),m=de(b),y=0;y<u;++y,f=w,v=z,m=R,x=j){var j=d[y],w=Jt(j),E=j[1]/2+an,z=ce(E),R=de(E),B=w-f,S=B>=0?1:-1,M=S*B,q=M>X,L=v*z;if(p.add(ht(L*S*ce(M),m*R+L*de(M))),l+=q?B+S*Te:B,q^f>=r^w>=r){var U=Mt(tt(x),tt(j));la(U);var k=Mt(o,U);la(k);var N=(q^B>=0?-1:1)*gt(k[2]);(n>N||n===N&&(U[0]||U[1]))&&(s+=q^B>=0?1:-1)}}return(l<-ne||l<ne&&p<-1e-12)^s&1}function Gn(e,a,r,n){return function(i){var o=a(i),l=Yn(),s=a(l),p=!1,g,c,d,u={point:x,lineStart:b,lineEnd:v,polygonStart:function(){u.point=m,u.lineStart=y,u.lineEnd=j,c=[],g=[]},polygonEnd:function(){u.point=x,u.lineStart=b,u.lineEnd=v,c=Hn(c);var w=Ci(g,n);c.length?(p||(i.polygonStart(),p=!0),Wn(c,zi,w,r,i)):w&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),c=g=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function x(w,E){e(w,E)&&i.point(w,E)}function f(w,E){o.point(w,E)}function b(){u.point=f,o.lineStart()}function v(){u.point=x,o.lineEnd()}function m(w,E){d.push([w,E]),s.point(w,E)}function y(){s.lineStart(),d=[]}function j(){m(d[0][0],d[0][1]),s.lineEnd();var w=s.clean(),E=l.result(),z,R=E.length,B,S,M;if(d.pop(),g.push(d),d=null,!!R){if(w&1){if(S=E[0],(B=S.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),z=0;z<B;++z)i.point((M=S[z])[0],M[1]);i.lineEnd()}return}R>1&&w&2&&E.push(E.pop().concat(E.shift())),c.push(E.filter(Ei))}}return u}}function Ei(e){return e.length>1}function zi(e,a){return((e=e.x)[0]<0?e[1]-ze-ne:ze-e[1])-((a=a.x)[0]<0?a[1]-ze-ne:ze-a[1])}const un=Gn(function(){return!0},Ai,Li,[-X,-ze]);function Ai(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?X:-X,p=ie(o-a);ie(p-X)<ne?(e.point(a,r=(r+l)/2>0?ze:-ze),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=X&&(ie(a-n)<ne&&(a-=n*ne),ie(o-s)<ne&&(o-=s*ne),r=Ti(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ti(e,a,r,n){var i,o,l=ce(e-r);return ie(l)>ne?wi((ce(a)*(o=de(n))*ce(r)-ce(n)*(i=de(a))*ce(e))/(i*o*l)):(a+n)/2}function Li(e,a,r,n){var i;if(e==null)i=r*ze,n.point(-X,i),n.point(0,i),n.point(X,i),n.point(X,0),n.point(X,-i),n.point(0,-i),n.point(-X,-i),n.point(-X,0),n.point(-X,i);else if(ie(e[0]-a[0])>ne){var o=e[0]<a[0]?X:-X;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ri(e){var a=de(e),r=2*Ce,n=a>0,i=ie(a)>ne;function o(c,d,u,x){Si(x,e,r,u,c,d)}function l(c,d){return de(c)*de(d)>a}function s(c){var d,u,x,f,b;return{lineStart:function(){f=x=!1,b=1},point:function(v,m){var y=[v,m],j,w=l(v,m),E=n?w?0:g(v,m):w?g(v+(v<0?X:-X),m):0;if(!d&&(f=x=w)&&c.lineStart(),w!==x&&(j=p(d,y),(!j||Lt(d,j)||Lt(y,j))&&(y[2]=1)),w!==x)b=0,w?(c.lineStart(),j=p(y,d),c.point(j[0],j[1])):(j=p(d,y),c.point(j[0],j[1],2),c.lineEnd()),d=j;else if(i&&d&&n^w){var z;!(E&u)&&(z=p(y,d,!0))&&(b=0,n?(c.lineStart(),c.point(z[0][0],z[0][1]),c.point(z[1][0],z[1][1]),c.lineEnd()):(c.point(z[1][0],z[1][1]),c.lineEnd(),c.lineStart(),c.point(z[0][0],z[0][1],3)))}w&&(!d||!Lt(d,y))&&c.point(y[0],y[1]),d=y,x=w,u=E},lineEnd:function(){x&&c.lineEnd(),d=null},clean:function(){return b|(f&&x)<<1}}}function p(c,d,u){var x=tt(c),f=tt(d),b=[1,0,0],v=Mt(x,f),m=St(v,v),y=v[0],j=m-y*y;if(!j)return!u&&c;var w=a*m/j,E=-a*y/j,z=Mt(b,v),R=Ct(b,w),B=Ct(v,E);Xt(R,B);var S=z,M=St(R,S),q=St(S,S),L=M*M-q*(St(R,R)-1);if(!(L<0)){var U=Je(L),k=Ct(S,(-M-U)/q);if(Xt(k,R),k=sa(k),!u)return k;var N=c[0],T=d[0],H=c[1],G=d[1],Z;T<N&&(Z=N,N=T,T=Z);var A=T-N,O=ie(A-X)<ne,I=O||A<ne;if(!O&&G<H&&(Z=H,H=G,G=Z),I?O?H+G>0^k[1]<(ie(k[0]-N)<ne?H:G):H<=k[1]&&k[1]<=G:A>X^(N<=k[0]&&k[0]<=T)){var F=Ct(S,(-M+U)/q);return Xt(F,R),[k,sa(F)]}}}function g(c,d){var u=n?e:X-e,x=0;return c<-u?x|=1:c>u&&(x|=2),d<-u?x|=4:d>u&&(x|=8),x}return Gn(l,s,o,n?[0,-e]:[-X,e-X])}function Mi(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],g=a[1],c=0,d=1,u=p-l,x=g-s,f;if(f=r-l,!(!u&&f>0)){if(f/=u,u<0){if(f<c)return;f<d&&(d=f)}else if(u>0){if(f>d)return;f>c&&(c=f)}if(f=i-l,!(!u&&f<0)){if(f/=u,u<0){if(f>d)return;f>c&&(c=f)}else if(u>0){if(f<c)return;f<d&&(d=f)}if(f=n-s,!(!x&&f>0)){if(f/=x,x<0){if(f<c)return;f<d&&(d=f)}else if(x>0){if(f>d)return;f>c&&(c=f)}if(f=o-s,!(!x&&f<0)){if(f/=x,x<0){if(f>d)return;f>c&&(c=f)}else if(x>0){if(f<c)return;f<d&&(d=f)}return c>0&&(e[0]=l+c*u,e[1]=s+c*x),d<1&&(a[0]=l+d*u,a[1]=s+d*x),!0}}}}}var ct=1e9,zt=-ct;function Oi(e,a,r,n){function i(g,c){return e<=g&&g<=r&&a<=c&&c<=n}function o(g,c,d,u){var x=0,f=0;if(g==null||(x=l(g,d))!==(f=l(c,d))||p(g,c)<0^d>0)do u.point(x===0||x===3?e:r,x>1?n:a);while((x=(x+d+4)%4)!==f);else u.point(c[0],c[1])}function l(g,c){return ie(g[0]-e)<ne?c>0?0:3:ie(g[0]-r)<ne?c>0?2:1:ie(g[1]-a)<ne?c>0?1:0:c>0?3:2}function s(g,c){return p(g.x,c.x)}function p(g,c){var d=l(g,1),u=l(c,1);return d!==u?d-u:d===0?c[1]-g[1]:d===1?g[0]-c[0]:d===2?g[1]-c[1]:c[0]-g[0]}return function(g){var c=g,d=Yn(),u,x,f,b,v,m,y,j,w,E,z,R={point:B,lineStart:L,lineEnd:U,polygonStart:M,polygonEnd:q};function B(N,T){i(N,T)&&c.point(N,T)}function S(){for(var N=0,T=0,H=x.length;T<H;++T)for(var G=x[T],Z=1,A=G.length,O=G[0],I,F,D=O[0],_=O[1];Z<A;++Z)I=D,F=_,O=G[Z],D=O[0],_=O[1],F<=n?_>n&&(D-I)*(n-F)>(_-F)*(e-I)&&++N:_<=n&&(D-I)*(n-F)<(_-F)*(e-I)&&--N;return N}function M(){c=d,u=[],x=[],z=!0}function q(){var N=S(),T=z&&N,H=(u=Hn(u)).length;(T||H)&&(g.polygonStart(),T&&(g.lineStart(),o(null,null,1,g),g.lineEnd()),H&&Wn(u,s,N,o,g),g.polygonEnd()),c=g,u=x=f=null}function L(){R.point=k,x&&x.push(f=[]),E=!0,w=!1,y=j=NaN}function U(){u&&(k(b,v),m&&w&&d.rejoin(),u.push(d.result())),R.point=B,w&&c.lineEnd()}function k(N,T){var H=i(N,T);if(x&&f.push([N,T]),E)b=N,v=T,m=H,E=!1,H&&(c.lineStart(),c.point(N,T));else if(H&&w)c.point(N,T);else{var G=[y=Math.max(zt,Math.min(ct,y)),j=Math.max(zt,Math.min(ct,j))],Z=[N=Math.max(zt,Math.min(ct,N)),T=Math.max(zt,Math.min(ct,T))];Mi(G,Z,e,a,r,n)?(w||(c.lineStart(),c.point(G[0],G[1])),c.point(Z[0],Z[1]),H||c.lineEnd(),z=!1):H&&(c.lineStart(),c.point(N,T),z=!1)}y=N,j=T,w=H}return R}}const pa=e=>e;var Zt=new Ke,ua=new Ke,Kn,Qn,fa,ma,Ie={point:Ae,lineStart:Ae,lineEnd:Ae,polygonStart:function(){Ie.lineStart=qi,Ie.lineEnd=Pi},polygonEnd:function(){Ie.lineStart=Ie.lineEnd=Ie.point=Ae,Zt.add(ie(ua)),ua=new Ke},result:function(){var e=Zt/2;return Zt=new Ke,e}};function qi(){Ie.point=Fi}function Fi(e,a){Ie.point=Xn,Kn=fa=e,Qn=ma=a}function Xn(e,a){ua.add(ma*e-fa*a),fa=e,ma=a}function Pi(){Xn(Kn,Qn)}var at=1/0,Ot=at,bt=-at,qt=bt,Ft={point:Di,lineStart:Ae,lineEnd:Ae,polygonStart:Ae,polygonEnd:Ae,result:function(){var e=[[at,Ot],[bt,qt]];return bt=qt=-(Ot=at=1/0),e}};function Di(e,a){e<at&&(at=e),e>bt&&(bt=e),a<Ot&&(Ot=a),a>qt&&(qt=a)}var xa=0,ha=0,pt=0,Pt=0,Dt=0,et=0,ga=0,ba=0,ut=0,Jn,Zn,Me,Oe,Ee={point:Qe,lineStart:fn,lineEnd:mn,polygonStart:function(){Ee.lineStart=$i,Ee.lineEnd=_i},polygonEnd:function(){Ee.point=Qe,Ee.lineStart=fn,Ee.lineEnd=mn},result:function(){var e=ut?[ga/ut,ba/ut]:et?[Pt/et,Dt/et]:pt?[xa/pt,ha/pt]:[NaN,NaN];return xa=ha=pt=Pt=Dt=et=ga=ba=ut=0,e}};function Qe(e,a){xa+=e,ha+=a,++pt}function fn(){Ee.point=Ii}function Ii(e,a){Ee.point=Bi,Qe(Me=e,Oe=a)}function Bi(e,a){var r=e-Me,n=a-Oe,i=Je(r*r+n*n);Pt+=i*(Me+e)/2,Dt+=i*(Oe+a)/2,et+=i,Qe(Me=e,Oe=a)}function mn(){Ee.point=Qe}function $i(){Ee.point=Ui}function _i(){er(Jn,Zn)}function Ui(e,a){Ee.point=er,Qe(Jn=Me=e,Zn=Oe=a)}function er(e,a){var r=e-Me,n=a-Oe,i=Je(r*r+n*n);Pt+=i*(Me+e)/2,Dt+=i*(Oe+a)/2,et+=i,i=Oe*e-Me*a,ga+=i*(Me+e),ba+=i*(Oe+a),ut+=i*3,Qe(Me=e,Oe=a)}function tr(e){this._context=e}tr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Te);break}}},result:Ae};var va=new Ke,ea,ar,nr,ft,mt,vt={point:Ae,lineStart:function(){vt.point=Vi},lineEnd:function(){ea&&rr(ar,nr),vt.point=Ae},polygonStart:function(){ea=!0},polygonEnd:function(){ea=null},result:function(){var e=+va;return va=new Ke,e}};function Vi(e,a){vt.point=rr,ar=ft=e,nr=mt=a}function rr(e,a){ft-=e,mt-=a,va.add(Je(ft*ft+mt*mt)),ft=e,mt=a}let xn,It,hn,gn;class bn{constructor(a){this._append=a==null?or:Hi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==hn||this._append!==It){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,hn=n,It=this._append,gn=this._,this._=i}this._+=gn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function or(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Hi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return or;if(a!==xn){const r=10**a;xn=a,It=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return It}function Yi(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Ze(s,i(o))),o.result()}return l.area=function(s){return Ze(s,i(Ie)),Ie.result()},l.measure=function(s){return Ze(s,i(vt)),vt.result()},l.bounds=function(s){return Ze(s,i(Ft)),Ft.result()},l.centroid=function(s){return Ze(s,i(Ee)),Ee.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,pa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new bn(r)):new tr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new bn(r)),l},l.projection(e).digits(r).context(a)}function Ta(e){return function(a){var r=new ya;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ya(){}ya.prototype={constructor:ya,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function La(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ze(r,e.stream(Ft)),a(Ft.result()),n!=null&&e.clipExtent(n),e}function ir(e,a,r){return La(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function Wi(e,a,r){return ir(e,[[0,0],a],r)}function Gi(e,a,r){return La(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Ki(e,a,r){return La(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var vn=16,Qi=de(30*Ce);function yn(e,a){return+a?Ji(e,a):Xi(e)}function Xi(e){return Ta({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Ji(e,a){function r(n,i,o,l,s,p,g,c,d,u,x,f,b,v){var m=g-n,y=c-i,j=m*m+y*y;if(j>4*a&&b--){var w=l+u,E=s+x,z=p+f,R=Je(w*w+E*E+z*z),B=gt(z/=R),S=ie(ie(z)-1)<ne||ie(o-d)<ne?(o+d)/2:ht(E,w),M=e(S,B),q=M[0],L=M[1],U=q-n,k=L-i,N=y*U-m*k;(N*N/j>a||ie((m*U+y*k)/j-.5)>.3||l*u+s*x+p*f<Qi)&&(r(n,i,o,l,s,p,q,L,S,w/=R,E/=R,z,b,v),v.point(q,L),r(q,L,S,w,E,z,g,c,d,u,x,f,b,v))}}return function(n){var i,o,l,s,p,g,c,d,u,x,f,b,v={point:m,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=E},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function m(B,S){B=e(B,S),n.point(B[0],B[1])}function y(){d=NaN,v.point=j,n.lineStart()}function j(B,S){var M=tt([B,S]),q=e(B,S);r(d,u,c,x,f,b,d=q[0],u=q[1],c=B,x=M[0],f=M[1],b=M[2],vn,n),n.point(d,u)}function w(){v.point=m,n.lineEnd()}function E(){y(),v.point=z,v.lineEnd=R}function z(B,S){j(i=B,S),o=d,l=u,s=x,p=f,g=b,v.point=j}function R(){r(d,u,c,x,f,b,o,l,i,s,p,g,vn,n),v.lineEnd=w,w()}return v}}var Zi=Ta({point:function(e,a){this.stream.point(e*Ce,a*Ce)}});function es(e){return Ta({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ts(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function wn(e,a,r,n,i,o){if(!o)return ts(e,a,r,n,i);var l=de(o),s=ce(o),p=l*e,g=s*e,c=l/e,d=s/e,u=(s*r-l*a)/e,x=(s*a+l*r)/e;function f(b,v){return b*=n,v*=i,[p*b-g*v+a,r-g*b-p*v]}return f.invert=function(b,v){return[n*(c*b-d*v+u),i*(x-d*b-c*v)]},f}function as(e){return ns(function(){return e})()}function ns(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,g=0,c,d=0,u=1,x=1,f=null,b=un,v=null,m,y,j,w=pa,E=.5,z,R,B,S,M;function q(N){return B(N[0]*Ce,N[1]*Ce)}function L(N){return N=B.invert(N[0],N[1]),N&&[N[0]*De,N[1]*De]}q.stream=function(N){return S&&M===N?S:S=Zi(es(c)(b(z(w(M=N)))))},q.preclip=function(N){return arguments.length?(b=N,f=void 0,k()):b},q.postclip=function(N){return arguments.length?(w=N,v=m=y=j=null,k()):w},q.clipAngle=function(N){return arguments.length?(b=+N?Ri(f=N*Ce):(f=null,un),k()):f*De},q.clipExtent=function(N){return arguments.length?(w=N==null?(v=m=y=j=null,pa):Oi(v=+N[0][0],m=+N[0][1],y=+N[1][0],j=+N[1][1]),k()):v==null?null:[[v,m],[y,j]]},q.scale=function(N){return arguments.length?(r=+N,U()):r},q.translate=function(N){return arguments.length?(n=+N[0],i=+N[1],U()):[n,i]},q.center=function(N){return arguments.length?(o=N[0]%360*Ce,l=N[1]%360*Ce,U()):[o*De,l*De]},q.rotate=function(N){return arguments.length?(s=N[0]%360*Ce,p=N[1]%360*Ce,g=N.length>2?N[2]%360*Ce:0,U()):[s*De,p*De,g*De]},q.angle=function(N){return arguments.length?(d=N%360*Ce,U()):d*De},q.reflectX=function(N){return arguments.length?(u=N?-1:1,U()):u<0},q.reflectY=function(N){return arguments.length?(x=N?-1:1,U()):x<0},q.precision=function(N){return arguments.length?(z=yn(R,E=N*N),k()):Je(E)},q.fitExtent=function(N,T){return ir(q,N,T)},q.fitSize=function(N,T){return Wi(q,N,T)},q.fitWidth=function(N,T){return Gi(q,N,T)},q.fitHeight=function(N,T){return Ki(q,N,T)};function U(){var N=wn(r,0,0,u,x,d).apply(null,a(o,l)),T=wn(r,n-N[0],i-N[1],u,x,d);return c=Ni(s,p,g),R=da(a,T),B=da(c,R),z=yn(R,E),k()}function k(){return S=M=null,q}return function(){return a=e.apply(this,arguments),q.invert=a.invert&&L,U()}}function sr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}sr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function rs(){return as(sr).scale(175.295)}function os(e){return e}function is(e){if(e==null)return os;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var g=2,c=s.length,d=new Array(c);for(d[0]=(a+=s[0])*n+o,d[1]=(r+=s[1])*i+l;g<c;)d[g]=s[g],++g;return d}}function ss(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ls(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return kn(e,r)})}:kn(e,a)}function kn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=ds(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function ds(e,a){var r=is(e.transform),n=e.arcs;function i(c,d){d.length&&d.pop();for(var u=n[c<0?~c:c],x=0,f=u.length;x<f;++x)d.push(r(u[x],x));c<0&&ss(d,f)}function o(c){return r(c)}function l(c){for(var d=[],u=0,x=c.length;u<x;++u)i(c[u],d);return d.length<2&&d.push(d[0]),d}function s(c){for(var d=l(c);d.length<4;)d.push(d[0]);return d}function p(c){return c.map(s)}function g(c){var d=c.type,u;switch(d){case"GeometryCollection":return{type:d,geometries:c.geometries.map(g)};case"Point":u=o(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(o);break;case"LineString":u=l(c.arcs);break;case"MultiLineString":u=c.arcs.map(l);break;case"Polygon":u=p(c.arcs);break;case"MultiPolygon":u=c.arcs.map(p);break;default:return null}return{type:d,coordinates:u}}return g(a)}const lr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},cs=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ps(e,a,r){const n=lr[e];if(!n||!n.length)return-1;const i=cs(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let At=null;function us(){return At||(At=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ls(r,n),o=rs().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Yi(o),s=(i.features||[]).filter(c=>{var d;return(((d=c.properties)==null?void 0:d.name)||"")!=="Antarctica"}).map(c=>{var x;const d=((x=c.properties)==null?void 0:x.name)||"",u=l(c)||"";return u?{i2:Vr(d)||null,n:d,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const p={};for(const[c,d]of Object.entries(Hr)){const u=o(d);u&&(p[c]={x:u[0],y:u[1]})}const g={};for(const[c,d]of Object.entries(lr)){const u=d.map(x=>o(x.ll)).filter(x=>!!x).map(([x,f])=>({x,y:f}));u.length&&(g[c]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:g}}catch{return null}})(),At)}function fs(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return us().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const ms={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},jn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Nn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function xs(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let i=!0,o=0;const l=()=>{var g;if(!i)return;const p=(g=e.current)==null?void 0:g.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function hs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p,data:g,dossiers:c}=P(),d=g.loading&&!c.length,u=h.useRef(null),x=h.useRef(null),f=fs(e.continent==="monde"),b=e.continent==="monde"?f:Ca.find(k=>k.key===e.continent)||null,v=xs(u,e.continent+":"+e.mapFolded+":"+!!b),[m,y]=h.useState(new Map),[j,w]=h.useState(null);h.useEffect(()=>{const k=u.current;if(!k)return;const N=new Map;k.querySelectorAll("path[data-i2]").forEach(T=>{const H=T.dataset.i2;if(H)try{const G=T.getBBox();G.width>0&&N.set(H,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(N)},[e.continent,v,b]);const E=h.useMemo(()=>r.filter(k=>k.cc),[r]),z=h.useMemo(()=>{const k=new Map;return E.forEach(N=>k.set(N.cc,(k.get(N.cc)||0)+1)),k},[E]),R=e.continent==="monde"&&f?f.anchors:null,B=e.continent==="monde"&&f?f.metros:null,S=h.useMemo(()=>E.map(k=>{const N=Nn(k.name||k.id||""),T=Nn((k.id||k.name||"")+"·y");if(R&&k.cc){const O=B?B[k.cc]:void 0;if(O&&O.length){const F=ps(k.cc,k.city,N);if(F>=0&&O[F])return{d:k,x:O[F].x+(N-.5)*5,y:O[F].y+(T-.5)*5}}const I=R[k.cc];if(I)return{d:k,x:I.x+(N-.5)*10,y:I.y+(T-.5)*10}}const H=k.cc?m.get(k.cc):void 0;if(!H)return null;const G=ms[`${e.continent}:${k.cc||""}`];if(G)return{d:k,x:H.x+H.w*(G.fx+(N-.5)*G.sx),y:H.y+H.h*(G.fy+(T-.5)*G.sy)};const Z=(N-.5)*Math.min(H.w*.55,60),A=(T-.5)*Math.min(H.h*.55,60);return{d:k,x:H.x+H.w/2+Z,y:H.y+H.h/2+A}}).filter(k=>!!k),[E,m,R,B,e.continent]),M=k=>v>0?k/v:k,q=h.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:jn[k],fr:p.plabels[k].toUpperCase(),en:p.plabels[k].toUpperCase(),n:r.filter(N=>N.kind==="target"&&je(N)===k).length})).filter(k=>k.n>0):_a.map((k,N)=>({...k,n:r.filter(T=>Ua(T)===N).length})),[r,n,p.plabels]),L=o?l.get(o):null,U=L?S.find(k=>k.d.id===L.id):null;return b?t.jsxs("div",{className:"mapzone"+(d?" waiting":""),ref:x,children:[t.jsxs("svg",{ref:u,viewBox:b.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?b.fr:b.en,onMouseLeave:()=>{w(null),i(null)},children:[t.jsx("g",{children:b.countries.map((k,N)=>t.jsx("g",{className:"ct"+(k.i2&&z.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},N))}),t.jsx("g",{children:S.map(k=>{const N=_a[Ua(k.d)],T=!!xe(k.d),H=k.d.kind==="target",G=n&&H?jn[je(k.d)]:N.c,Z=!n&&ye(k.d);return t.jsxs("g",{className:"co"+(Z?" done":""),onMouseEnter:()=>{var I,F;const A=(I=x.current)==null?void 0:I.getBoundingClientRect(),O=(F=u.current)==null?void 0:F.createSVGPoint();if(O&&u.current&&A){O.x=k.x,O.y=k.y;const D=O.matrixTransform(u.current.getScreenCTM());w({x:D.x-A.left,y:D.y-A.top,label:k.d.name+" · "+(it(k.d.cc,s)||k.d.countryLabel||"")})}i(k.d.id)},onMouseLeave:()=>{w(null),i(null)},onClick:()=>{var I;const A=(I=u.current)==null?void 0:I.createSVGPoint();let O=null;if(A&&u.current){A.x=k.x,A.y=k.y;const F=A.matrixTransform(u.current.getScreenCTM());O={x:F.x,y:F.y}}a({type:"popup",id:k.d.id,anchor:O})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:M(Math.max(11,N.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:M(N.px),fill:G,stroke:T?"#DC2626":"#ffffff",strokeWidth:M(T?2.2:1.3)})]},k.d.id||k.d.name)})}),U&&t.jsx("circle",{className:"ring on",cx:U.x,cy:U.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:q.map((k,N)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},N))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:x})}function gs(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function bs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=P(),s=e.filters,p=h.useMemo(()=>e.continent==="monde"?r:r.filter(f=>f.continent===e.continent),[r,e.continent]),g=f=>p.filter(b=>f!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:za(b,s,i,f==="country"?void 0:f)),c=h.useMemo(()=>{const f=g("win"),b=v=>f.filter(m=>(m.date?Math.max(0,Math.floor((Date.now()-Date.parse(m.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),f.length]},[p,s,i]),d=h.useMemo(()=>s.day?g("win").filter(f=>(f.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),x=(f,b,v,m="fbtn")=>t.jsxs("button",{type:"button",className:m,"aria-expanded":e.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},f);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(gs(s.day,l)),t.jsx("b",{children:d})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[n.dates[b],t.jsx("b",{children:c[b]})]},f))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):x("sec",n.fSector,s.sector.length),x("pay",n.fCountry,s.country.length),x("det",n.fEngine,s.engine.length),x("sta",n.fStage,s.stage.length),i&&x("ang","Angle",s.angle.length),i&&x("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(vs,{poolFor:g})]})}function vs({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=P(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:g}=h.useMemo(()=>{if(l==="sig"){const f=e("signal").filter(m=>xe(m)),b=new Map;f.forEach(m=>{const y=m.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:f.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...na([...b.keys()],i).map(m=>({v:m,label:Ge(m)+" "+qe(m,i),n:b.get(m)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(m)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const f=e("sector"),b=new Map;return f.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v,n:m,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const f=e("country"),b=new Map;return f.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:it(v,i)||v,n:m,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const f=e("engine"),b=new Map;return f.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:na([...b.keys()],i).map(v=>({v,label:Ge(v)+" "+qe(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Yr(Wr(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const f=e("angle"),b=new Map;return f.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v.replace(/[_-]+/g," "),n:m,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const f=e("memoLevel"),b=new Map;f.forEach(m=>{if(m.kind==="target"){const y=Na(m);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(m=>({v:String(m),label:v[m],n:b.get(m)||0,html:!1,on:o.memoLevel.includes(m)}))}}const u=e("stage"),x=new Map;return u.forEach(f=>{f.stage&&x.set(f.stage,(x.get(f.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...x.entries()].sort((f,b)=>b[1]-f[1]).map(([f,b])=>({v:f,label:f,n:b,html:!1,on:o.stage.includes(f)}))}},[l,a,i]),c=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const f=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},d=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:d,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>c(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function dr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function ys(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Sn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=P();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function cr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=P(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Sn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Sn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function ws({card:e,onEvaluate:a,onAddAll:r}){var s,p,g;const{t:n}=P(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:dr(e.summary_md||"").map((c,d)=>t.jsx("p",{children:c},d))})]}),t.jsx(cr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function ks(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function js({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=P(),s=i,[p,g]=h.useState(null),[c,d]=h.useState(null),[u,x]=h.useState(null),[f,b]=h.useState(!1);h.useEffect(()=>{let m=!0;return(async()=>{const y=await Fn({email:l,cbToken:s});m&&g(y)})(),()=>{m=!1}},[l,s,n]);const v=m=>{d(m),x(null),b(!0),(async()=>{const y=await Gr(m.id);x(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{d(null),x(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[ks(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?o.rsPub:o.rsPriv})]},m.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),f&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!f&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!f&&u&&t.jsx(ws,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Cn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Ns(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:g,data:c,canWrite:d,source:u}=P(),x=a==="client",f=h.useMemo(()=>r||(u!=="default"?Kr():""),[r,u]),[b,v]=h.useState(""),[m,y]=h.useState(!1),[j,w]=h.useState(""),[E,z]=h.useState(!1),[R,B]=h.useState(""),[S,M]=h.useState([]),q=h.useRef(!1),[L,U]=h.useState(!1),[k,N]=h.useState(""),[T,H]=h.useState(""),[G,Z]=h.useState(!1),[A,O]=h.useState(0),[I,F]=h.useState(""),[D,_]=h.useState(null),[W,J]=h.useState(null),[oe,ue]=h.useState(!1),[pe,Q]=h.useState(null),[te,ge]=h.useState(0),K=h.useRef(!1),se=b.trim()?Cn.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,ee=h.useMemo(()=>j.split(`
`).map($=>$.trim()).filter(Boolean).slice(0,15),[j]);h.useEffect(()=>{if(typeof window>"u")return;const $=(new URLSearchParams(window.location.search).get("rs")||"").trim();!$||!/^https?:\/\//i.test($)||(N($),U(!0))},[]),h.useEffect(()=>{const $=ae=>{var be;const le=String(((be=ae.detail)==null?void 0:be.url)||"").trim();!le||!/^https?:\/\//i.test(le)||(N(le),U(!0))};return window.addEventListener("ppmap:research",$),()=>window.removeEventListener("ppmap:research",$)},[]),h.useEffect(()=>{if(!d&&!f){Q(null);return}let $=!0;return(async()=>{const ae=await Fn({email:n,cbToken:f});$&&Q(ae.length)})(),()=>{$=!1}},[d,f,n,te]);const Be=S.length?S:p,fe=c.credits,he=h.useCallback($=>{const ae=$.map(le=>(le||"").trim()).filter(Boolean);ae.length&&(w(le=>{const be=le.split(`
