...
.atl2 .bulk .side .hint{white-space:nowrap}`,Go=`
...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,Ko=Yo+Go;function da(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Qo(){const e=da("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Jo(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Qo();return r==="0"?"client":r==="1"||da("embed")==="1"&&da("chrome")==="1"?"apercu":"client"}const Xo={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Zo=e=>Xo[e];function ei(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const We=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!_n(a)||ei(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Jr(e.cc)})};function Zt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const ti=60*60*1e3;function ai(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>ti?null:a}catch{return null}}function Et(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ni=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function ri(e,a,r="default"){const n=r!=="default",i=h.useMemo(()=>e||n?{mode:"anon"}:_r(),[e,n]),o=h.useMemo(()=>n?"visiteur":Jo(e,i),[e,i,n]),l=h.useMemo(()=>Zo(o),[o]),s=o!=="visiteur",d=ni(r),[x,c]=h.useState([]),[f,u]=h.useState(""),[b,p]=h.useState(null),[g,v]=h.useState(null),[m,w]=h.useState(null),[N,y]=h.useState(()=>new Map),[C,T]=h.useState(()=>new Map),[E,M]=h.useState(""),[R,z]=h.useState(new Set),[L,$]=h.useState(null),[_,k]=h.useState(!0),[j,O]=h.useState(!1),[B,H]=h.useState(0),[Z,re]=h.useState(0),G=h.useRef(0),J=h.useMemo(()=>{var q;if(o!=="client")return"";try{return((q=Ur())==null?void 0:q.email)||""}catch{return""}},[o]);h.useEffect(()=>{const q=++G.current;let F=!0;const I=()=>F&&q===G.current,W=(s&&i.token?i.token:"pub:"+a)+(d?":"+d:""),Y=ai(W);return Y?(c(Y.objs.map(We)),Y.fund&&u(Y.fund),p(Y.marketEstimate??null),v(Y.criteria??null),w(Y.stats??null),M(Y.generatedAt||""),k(!1)):k(!0),(async()=>{try{if(r==="ops"){const se=await Qt(),le=((se==null?void 0:se.recent_ops)||[]).map(K=>{const X=Jt(K.company_name||K.title?K:{...K,title:(K.headline_fr||K.headline||"").slice(0,120)},a),he=String(K.rubrique||"").toLowerCase();return X&&(he==="nominations"||he==="recrutements")&&(X.engine=he),X&&!String(K.company_name||"").trim()&&(X.noCo=!0),X}).filter(K=>!!K).map(K=>(_n((K.name||"").trim())||(K.noCo=!0),K));try{const K=await Vr(),X=Hr(K),he=((K==null?void 0:K.date)||"").slice(0,10);if(X.length&&he){const ee=new Set;for(const ce of le){if(ce.noCo||(ce.date||"").slice(0,10)!==he)continue;const ae=Ha(X,ee,ce.name,"");ae>=0&&(ee.add(ae),ce.decryptHtml=X[ae].html)}for(const ce of le){if(ce.decryptHtml||(ce.date||"").slice(0,10)!==he)continue;const ae=Ha(X,ee,"",ce.headline||ce.tagline||ce.name);ae>=0&&(ee.add(ae),ce.decryptHtml=X[ae].html)}}}catch{}if(!I())return;c(le.map(We)),Et(W,{objs:le})}else if(typeof r=="object"){const le=(await Wa()||[]).filter(X=>(X.slug||"")===r.research).map(X=>Ya(X,a)).filter(X=>!!X),K=Zt(await Ga(le,a));if(!I())return;c(K.map(We)),Et(W,{objs:K})}else if(s&&i.token){const se=Wr(i.token),le=Qt(),K=Yr(i.token),X=Gr(i.token),he=Kr(i.token),ee=await se;let ce=ee?ee.targets:[];I()&&ee&&(u(ee.fund||""),p(ee.marketEstimate??null),v(ee.criteria??null),w(ee.stats??null),M(ee.generatedAt||""),c(ce.map(We)),k(!1),O(!1));const[ae,Oe,xe,ve]=await Promise.all([le,K,X,he]),qe=((ae==null?void 0:ae.recent_ops)||[]).map(Ee=>Jt(Ee,a)).filter(Ee=>!!Ee);if(ce=[...ce,...qe],!I())return;c(ce.map(We));const tt=new Set;for(const Ee of Oe){const Be=(Ee.id||Ee.co||"").toString().trim().toLowerCase();Be&&tt.add(Be.startsWith("t:")?Be:"t:"+Be)}z(tt),y(xe),T(ve),ee&&Et(W,{fund:ee.fund,marketEstimate:ee.marketEstimate,criteria:ee.criteria,stats:ee.stats,generatedAt:ee.generatedAt,objs:ce})}else{const se=Qr(),le=Wa(),K=Qt(),X=await se;I()&&X.length&&(c(Zt(X).map(We)),k(!1),O(!1));const[he,ee]=await Promise.all([le,K]),ce=(he||[]).map(ve=>Ya(ve,a)).filter(ve=>!!ve),ae=await Ga(ce,a),Oe=((ee==null?void 0:ee.recent_ops)||[]).map(ve=>Jt(ve,a)).filter(ve=>!!ve),xe=Zt([...X,...ae,...Oe]);if(!I())return;c(xe.map(We)),Et(W,{objs:xe})}I()&&O(!1)}catch{I()&&!Y&&O(!0)}finally{I()&&k(!1)}})(),()=>{F=!1}},[s,i.token,a,B,d]),h.useEffect(()=>{if(!l.showCredits||!J){$(null);return}let q=!0;return(async()=>{try{const F=await fetch(`${Aa}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:J})});if(!F.ok)return;const I=await F.json();q&&I&&I.ok!==!1&&$(I)}catch{}})(),()=>{q=!1}},[l.showCredits,J,Z]);const A=h.useCallback(q=>z(new Set(q)),[]);return{session:i,mode:o,caps:l,fund:f,email:J,marketEstimate:b,generatedAt:E,criteria:g,stats:m,thumbs:N,stages:C,dossiers:x,favIds:R,setFavIds:A,credits:L,reloadCredits:()=>re(q=>q+1),loading:_,error:j,refresh:()=>H(q=>q+1)}}const Gn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),oi=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Gn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function ii(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Gn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Kn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Kn=40;function Ra(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ge(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(za(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(He(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ge(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Qn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ra(e,a.filters,r)}function si(e,a,r,n){return!(!Qn(e,a,r)||r&&!Xr(e,a.ptab,n))}function qa(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-He(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=ge(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const li=["ma","levees","nominations","recrutements","actualites"],ci=300,ea=7,di={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Jn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},pi=["hiring","raised","news","posting","building","community","registry","exodus","other"];function nn(e){const a=ge(e);if(a)return"sig:"+(a.theme&&Jn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function ui(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=P(),s=l==="en",[d,x]=h.useState("all"),[c,f]=h.useState(!1),u=h.useMemo(()=>{const z=(a.filters.day||"").slice(0,10),L=j=>!(!o&&a.continent!=="monde"&&j.continent!==a.continent||z&&(j.date||"").slice(0,10)!==z),$=e.filter(j=>L(j)&&ge(j)),_=e.filter(j=>L(j)&&j.kind==="op"&&!ge(j)&&(z?!0:He(j.date)<=ea)),k=z||new Date().toISOString().slice(0,10);return _.sort((j,O)=>{const B=(j.date||"").slice(0,10)===k?0:1,H=(O.date||"").slice(0,10)===k?0:1;return B!==H?B-H:(O.amountEur||0)-(j.amountEur||0)}),[...qa($,{key:"signal",dir:-1}),..._]},[e,a.continent,a.filters.day,o]),b=h.useMemo(()=>{const z={};for(const L of u){const $=nn(L);z[$]=(z[$]||0)+1}return z},[u]),p=h.useMemo(()=>d==="all"?u:u.filter(z=>nn(z)===d),[u,d]),g=h.useMemo(()=>p.slice(0,ci),[p]),v=p.length-g.length,m=h.useRef(null);h.useEffect(()=>{var j,O;const z=m.current;if(!z)return;const L=()=>{const B=z.scrollWidth;B<200||(z.style.animationDuration=Math.max(60,Math.round(B/26))+"s")};L();const $=requestAnimationFrame(L),_=window.setTimeout(L,1200);let k=!0;return(O=(j=document.fonts)==null?void 0:j.ready)==null||O.then(()=>{k&&L()}),()=>{k=!1,cancelAnimationFrame($),window.clearTimeout(_)}},[g.length,d]);const w=z=>z==="all"?u.length:b[z]||0,N=z=>z==="all"?s?"All":"Tout":z.startsWith("sig:")?Jn[s?"en":"fr"][z.slice(4)]||"🔔":di[s?"en":"fr"][z],y=[{k:"all"}],C=li.filter(z=>w(z)>0||z===d);if(C.length){y.push({g:s?"DEALS":"OPÉRATIONS"});for(const z of C)y.push({k:z})}const T=pi.map(z=>"sig:"+z).filter(z=>w(z)>0||z===d);if(T.length){y.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const z of T)y.push({k:z})}const E=z=>{try{return new Date(z+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return z}},M=(()=>{const z=(a.filters.day||"").slice(0,10),L=!o&&a.continent!=="monde"&&i?s?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return z?(s?`LIVE covers the events of ${E(z)}.`:`Le LIVE regroupe les événements du ${E(z)}.`)+L:(s?`LIVE covers the still-open signals and the deals of the last ${ea} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ea} derniers jours.`)+L})(),R=z=>g.map(L=>t.jsxs("button",{type:"button",className:"tk"+(Ce(L)?" spent":""),onClick:$=>{const _=$.currentTarget.getBoundingClientRect();n({type:"popup",id:L.id,anchor:{x:_.left+_.width/2,y:_.bottom}})},title:L.name+(L.tagline?" — "+L.tagline:""),children:[t.jsx(Xe,{o:L}),t.jsxs("span",{className:"who",children:[t.jsx(Er,{o:L}),t.jsx("span",{className:"co",children:L.name})]}),typeof L.amountEur=="number"&&L.amountEur>0&&t.jsx("span",{className:"am",children:Hl(L.amountEur)}),L.sector&&t.jsx("span",{className:"mt",children:L.sector}),t.jsx(Gt,{o:L}),t.jsx("span",{className:"tkgo",children:"→"})]},z+(L.id||L.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},z+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:z=>{z.currentTarget.contains(z.relatedTarget)||f(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":c,onClick:()=>f(z=>!z),children:[N(d),t.jsx("b",{children:w(d)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!c,children:[t.jsx("span",{className:"tkfilscope",children:M}),y.map(z=>"g"in z?t.jsx("span",{className:"tkfilg",children:z.g},z.g):t.jsxs("button",{type:"button","aria-pressed":z.k===d,onClick:()=>{x(z.k),f(!1)},children:[N(z.k),t.jsx("b",{children:w(z.k)})]},z.k))]})]}),t.jsx("div",{className:"win",children:g.length?t.jsxs("div",{className:"run",ref:m,children:[R(0),R(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const fi="aDx8z7Hzksus",Ma="+33 6 83 10 72 86",Pt="alexandre@proplace.co",Xn=`tel:${Ma.replace(/[^\d+]/g,"")}`,rn="pp-rdv-slot";function mi(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function hi(){const{t:e,caps:a,fund:r}=P();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:gi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Xn,children:Ma}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Pt}`,children:Pt})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Uo,{filloutId:fi,parameters:r?{company_name:r}:void 0})})]})}function xi(){const[e,a]=h.useState(()=>typeof document>"u"?null:document.getElementById(rn));return h.useEffect(()=>{e||a(document.getElementById(rn))},[e]),e?lt.createPortal(t.jsx(hi,{}),e):null}const gi=`
...
`;class be extends h.Component{constructor(){super(...arguments);Ua(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const bi=8;function vi(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=P(),[s,d]=h.useState(!1),[x,c]=h.useState(!1),[f,u]=h.useState(!1),b=r||"home",{names:p,verdicts:g}=h.useMemo(()=>{const y=[],C={};return n.forEach(T=>{T.kind!=="target"||!T.name||(y.push(T.name),C[T.name]=Zr(T)||"")}),{names:y,verdicts:C}},[n]),v=h.useMemo(()=>p.length?eo(b,p,g,a):null,[b,p.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const m=x?v.added:v.added.slice(0,bi),w=v.added.length-m.length,N=y=>{const C=n.find(T=>T.name===y);C&&(o(C.id),l({type:"popup",id:C.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{d(!0),to(b,p,g,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[m.map(y=>t.jsx("button",{type:"button",onClick:()=>N(y),children:y},y)),w>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>c(!0),children:e.sinceMore(w)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(y=>!y),children:e.sinceOut(v.gone.length)}),f&&v.gone.slice(0,20).map(y=>t.jsx("span",{className:"gone",children:y},y))]})]})}const ta=600,Ye=62,on="atl2:fstats";function yi(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=P(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(on)==="on"}catch{return!1}}),d=r.stats,x=h.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),c=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const f=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,u=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((N,y)=>Math.max(N,y.s||0),0),p=x.length?ta/x.length:0,g=Math.max(4,p-4),v=x.length>=5&&b>0,w=[[typeof d.screened_window=="number"?d.screened_window:d.screened,e.funScreened(c?f(c):"",f(new Date().toISOString().slice(0,10))),d.screened_today],...typeof d.kept=="number"?[[d.kept,e.funKept,d.kept_today]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed,d.analyzed_today]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[w.map(([N,y,C],T)=>t.jsxs("span",{className:"fst-t",children:[T>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(N)}),t.jsx("i",{children:y}),l&&typeof C=="number"&&C>0&&t.jsx("em",{children:e.funToday(C)})]},y)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const N=!l;s(N),N&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(on,N?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ta} ${Ye}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((N,y)=>{const C=(N.s||0)/b*(Ye-4),T=(N.m||0)/b*(Ye-4),E=y*p+(p-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:E,y:Ye-2-C,width:g,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:E,y:Ye-2-T,width:g,height:T,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:Ye-1.5,x2:ta,y2:Ye-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const wi=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ki({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=P(),[o,l]=h.useState(""),[s,d]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),c=(Ze(e)||"").startsWith("CALL")&&ke(e)===3,f=ke(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const g=await i(e,p);l(""),g&&(d(!0),setTimeout(()=>d(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:wi.filter(([p])=>!(f&&p==="Retenu")).map(([p,g])=>[p,a[g]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,g])=>t.jsx("button",{type:"button",className:"csb"+(x===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:g},p)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ji,{o:e})]})}function ji({o:e}){const{t:a,saveNote:r,flash:n}=P(),[i,o]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[d,x]=h.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(l||!c)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{f()},children:d?a.csNoteSaved:a.csNoteOk})]})}function Ni({placeholder:e,onDone:a}){const{t:r}=P(),[n,i]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Si({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=P(),[d,x]=h.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const c=o(e),f=(c==null?void 0:c.stage)||"todo",u=async m=>{if(d||m===f)return;x(!0);const w=c;l(e,{stage:m,stamps:(c==null?void 0:c.stamps)||{}});const N=Math.max(Date.now(),sn+=1);sn=N;const y=await ao(r,{company:e.name||"",stage:m,cts:N,deal_id:e.airtableId,check_id:e.checkId});x(!1),!y.stale&&(y.ok||(l(e,w),s(a.actErr)))},b=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=f==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,w])=>t.jsx("button",{type:"button",className:"stgb"+(f===m?" on":""),disabled:d,onClick:()=>{u(m)},children:w},m)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let sn=0;const At=8,zt=360;function ln({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function cn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(ln,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(ln,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function Ci({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=P(),[l,s]=h.useState(0),[d,x]=h.useState(null),[c,f]=h.useState([]),u=h.useRef(!1),b=h.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=h.useRef(!1);h.useEffect(()=>{const E=b.current;return()=>{p.current||(n({type:"ptab",tab:E.ptab}),n({type:"dens",dens:E.dens}),n({type:"modal",modal:E.modal}))}},[]),h.useEffect(()=>{u.current||(u.current=!0,f(e.filter(E=>!!document.querySelector(E.need||E.sel))))},[e]);const g=c[l],v=l>=c.length;h.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const E=g.click,M=window.setTimeout(()=>{const R=document.querySelector(E);R&&R.getAttribute("aria-selected")!=="true"&&R.click()},60);return()=>window.clearTimeout(M)}},[l,g]);const m=h.useRef(-1),w=h.useCallback(()=>{if(!g){x(null);return}const E=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!E){x(null);return}m.current!==l&&(m.current=l,E.scrollIntoView({block:"nearest",behavior:"smooth"}));const M=E.getBoundingClientRect();x(R=>R&&Math.abs(R.top-M.top)<1&&Math.abs(R.left-M.left)<1&&Math.abs(R.width-M.width)<1&&Math.abs(R.height-M.height)<1?R:M)},[g,l]);h.useLayoutEffect(()=>{w();const E=[90,300,700,1300].map(R=>window.setTimeout(w,R)),M=()=>w();return window.addEventListener("scroll",M,!0),window.addEventListener("resize",M),()=>{E.forEach(R=>window.clearTimeout(R)),window.removeEventListener("scroll",M,!0),window.removeEventListener("resize",M)}},[w]);const N=h.useRef(a);if(N.current=a,h.useEffect(()=>{const E=M=>{M.key==="Escape"?(M.preventDefault(),M.stopPropagation(),N.current()):M.key==="ArrowRight"?s(R=>R+1):M.key==="ArrowLeft"&&s(R=>Math.max(0,R-1))};return document.addEventListener("keydown",E,!0),()=>document.removeEventListener("keydown",E,!0)},[]),!c.length)return null;let y=null;const C=E=>()=>{p.current=!0,n({type:"modal",modal:null}),E()};if(v){const E=i[3]||0;E>0?y={title:E===1?r.ahaATitle1:r.ahaATitleN(E),body:r.ahaABody,btn:r.ahaABtn,go:C(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:C(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:C(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:C(()=>{n({type:"modal",modal:"crit"}),a()})}}let T={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:zt};if(!v&&d){const E=d.bottom+14,R=window.innerHeight-E>190?E:Math.max(12,d.top-200);T={left:Math.min(Math.max(12,d.left+d.width/2-zt/2),window.innerWidth-zt-12),top:R,width:zt}}return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-At,top:d.top-At,width:d.width+At*2,height:d.height+At*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:T,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(cn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(cn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(E=>Math.max(0,E-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(E=>E+1),children:l===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Zn(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function er(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Ei(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,dispatch:s}=P(),d=r?a:e,x=h.useMemo(()=>d.filter(C=>He(C.date)===0&&C.kind==="target"),[d]),c=h.useMemo(()=>r?a.filter(C=>ke(C)===0).slice().sort((C,T)=>(T.date||"").localeCompare(C.date||"")):[],[a,r]),f=h.useMemo(()=>x.filter(C=>r?ke(C)===0:!Ce(C)),[x,r]),u=r?c:f,b=r?a.length-c.length:x.length-f.length,p=r?a.length:x.length,g=p?Math.min(100,b/p*100):100,v=h.useMemo(()=>Zn(d),[d]),m=!!v&&He(v)>0,w=h.useMemo(()=>m?d.filter(C=>(C.date||"").slice(0,10)===v):[],[d,v,m]);let N;m?N=i.morningLast(w.length,c.length,er(v,l)):r?N=i.morningThesis(x.length,c.length):x.length?b===0?N=i.goalSourced(x.length):b>=x.length?N=i.goalCleared:N=i.goalDone(b,x.length):N=i.goalSourced(0);const y=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&c.length&&s({type:"chainStart",queue:c.map(C=>C.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:g+"%"}})}),u.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:y,children:r?i.morningEval(u.length):o.pileMode?i.goalContinue(u.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ai(){var $,_;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:d,doSync:x,startTour:c}=P(),[f,u]=h.useState(null),[b,p]=h.useState(!0),[g,v]=h.useState([]),m=d==="client";h.useEffect(()=>{if(!i||!o)return;let k=!0;return p(!0),(async()=>{const[j,O]=await Promise.all([Ta(o),Un(i)]);k&&(j&&u(j),p(!1),v(O))})(),()=>{k=!1}},[i,o]);const w=(f==null?void 0:f.per_day)??null,N=(($=f==null?void 0:f.pool_order)==null?void 0:$.length)??0,y=g.filter(k=>k.status==="running").length,C=h.useMemo(()=>s.filter(k=>k.kind==="target"&&Ce(k)).length,[s]),T=l.marketEstimate,E=typeof((_=l.stats)==null?void 0:_.screened)=="number"?l.stats.screened:C,M=T&&T>0?Math.min(100,Math.round(E/T*100)):null,R=k=>k.toLocaleString(a==="en"?"en-US":"fr-FR"),z=(o||"P").split(/\s+/).map(k=>k[0]).join("").slice(0,2).toUpperCase(),L=(()=>{const k=Date.parse(l.generatedAt||"");if(Number.isNaN(k))return"";const j=new Date(k),O=B=>String(B).padStart(2,"0");return`${O(j.getDate())}/${O(j.getMonth()+1)} à ${O(j.getHours())}:${O(j.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:z}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),L&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(L)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[M===null&&E>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(E)})})]}),M!==null&&T&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:M+"%"}})}),t.jsxs("b",{children:[M," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(E,T)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),w!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:w})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),w===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(N)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:k=>{k.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!m,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:k=>n({type:"filters",patch:{search:k.target.value}})})]})]})]})}const zi=["--p0","--p1","--p2","--p3","--p4"];function Ti(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=P(),s=o.loading&&!l.length,d=h.useRef({});h.useEffect(()=>{d.current={...r}},[r]);const x=u=>{const b=d.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${zi[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},c=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),f=(u,b,p,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[c(5,!1,n.plabels[5]),c(7,!0,n.plabels[7]),c(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[f("↩",n.toolUndo,i,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Li=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Ri(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=P(),s=h.useRef(null),[d,x]=h.useState(60);h.useEffect(()=>{let b=0;const p=()=>{var N;const g=s.current;if(!g)return;const v=(N=g.parentElement)==null?void 0:N.querySelector('.funnel [aria-selected="true"]');if(!v)return;const m=v.getBoundingClientRect(),w=g.getBoundingClientRect();x(Math.max(20,Math.min(m.left+m.width/2-w.left,w.width-30)))};return b=requestAnimationFrame(p),window.addEventListener("resize",p),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",p)}},[e.ptab]);const c=e.ptab;let f=r.tuto[c].p;if(c===3){const b=n.filter(v=>v.kind==="target"&&ke(v)===3),p=b.filter(v=>sa(v)==="auto").length,g=b.filter(v=>sa(v)==="cd").length;f=r.tutoPending(p,g,b.length)}const u=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(b=>b.id)})};if(c===1){const b=n.filter(p=>p.kind==="target"&&ke(p)===1&&!i.has(p.id)).slice(0,10);if(b.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:b.map(p=>p.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Li[c],"--ax":d+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:f}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Qe{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*qi(e){for(const a of e)yield*a}function tr(e){return Array.from(qi(e))}var ne=1e-6,Q=Math.PI,Te=Q/2,dn=Q/4,Re=Q*2,_e=180/Q,Se=Q/180,ie=Math.abs,Mi=Math.atan,vt=Math.atan2,pe=Math.cos,ue=Math.sin,Oi=Math.sign||function(e){return e>0?1:e<0?-1:0},et=Math.sqrt;function Fi(e){return e>1?0:e<-1?Q:Math.acos(e)}function yt(e){return e>1?Te:e<-1?-Te:Math.asin(e)}function Le(){}function Dt(e,a){e&&un.hasOwnProperty(e.type)&&un[e.type](e,a)}var pn={Feature:function(e,a){Dt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Dt(r[n].geometry,a)}},un={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){pa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)pa(r[n],a,0)},Polygon:function(e,a){fn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)fn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Dt(r[n],a)}};function pa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function fn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)pa(e[r],a,1);a.polygonEnd()}function nt(e,a){e&&pn.hasOwnProperty(e.type)?pn[e.type](e,a):Dt(e,a)}function ua(e){return[vt(e[1],e[0]),yt(e[2])]}function it(e){var a=e[0],r=e[1],n=pe(r);return[n*pe(a),n*ue(a),ue(r)]}function Tt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function It(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function aa(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Lt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function fa(e){var a=et(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ma(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function ha(e,a){return ie(e)>Q&&(e-=Math.round(e/Re)*Re),[e,a]}ha.invert=ha;function Pi(e,a,r){return(e%=Re)?a||r?ma(hn(e),xn(a,r)):hn(e):a||r?xn(a,r):ha}function mn(e){return function(a,r){return a+=e,ie(a)>Q&&(a-=Math.round(a/Re)*Re),[a,r]}}function hn(e){var a=mn(e);return a.invert=mn(-e),a}function xn(e,a){var r=pe(e),n=ue(e),i=pe(a),o=ue(a);function l(s,d){var x=pe(d),c=pe(s)*x,f=ue(s)*x,u=ue(d),b=u*r+c*n;return[vt(f*i-b*o,c*r-u*n),yt(b*i+f*o)]}return l.invert=function(s,d){var x=pe(d),c=pe(s)*x,f=ue(s)*x,u=ue(d),b=u*i-f*o;return[vt(f*i+u*o,c*r+b*n),yt(b*r-c*n)]},l}function Di(e,a,r,n,i,o){if(r){var l=pe(a),s=ue(a),d=n*r;i==null?(i=a+n*Re,o=a-d/2):(i=gn(l,i),o=gn(l,o),(n>0?i<o:i>o)&&(i+=n*Re));for(var x,c=i;n>0?c>o:c<o;c-=d)x=ua([l,-s*pe(c),-s*ue(c)]),e.point(x[0],x[1])}}function gn(e,a){a=it(a),a[0]-=e,fa(a);var r=Fi(-a[1]);return((-a[2]<0?-r:r)+Re-ne)%Re}function ar(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Le,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ft(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Rt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function nr(e,a,r,n,i){var o=[],l=[],s,d;if(e.forEach(function(p){if(!((g=p.length-1)<=0)){var g,v=p[0],m=p[g],w;if(Ft(v,m)){if(!v[2]&&!m[2]){for(i.lineStart(),s=0;s<g;++s)i.point((v=p[s])[0],v[1]);i.lineEnd();return}m[0]+=2*ne}o.push(w=new Rt(v,p,null,!0)),l.push(w.o=new Rt(v,null,w,!1)),o.push(w=new Rt(m,p,null,!1)),l.push(w.o=new Rt(m,null,w,!0))}}),!!o.length){for(l.sort(a),bn(o),bn(l),s=0,d=l.length;s<d;++s)l[s].e=r=!r;for(var x=o[0],c,f;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;c=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,d=c.length;s<d;++s)i.point((f=c[s])[0],f[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(c=u.p.z,s=c.length-1;s>=0;--s)i.point((f=c[s])[0],f[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);i.lineEnd()}}}function bn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function na(e){return ie(e[0])<=Q?e[0]:Oi(e[0])*((ie(e[0])+Q)%Re-Q)}function Ii(e,a){var r=na(a),n=a[1],i=ue(n),o=[ue(r),-pe(r),0],l=0,s=0,d=new Qe;i===1?n=Te+ne:i===-1&&(n=-Te-ne);for(var x=0,c=e.length;x<c;++x)if(u=(f=e[x]).length)for(var f,u,b=f[u-1],p=na(b),g=b[1]/2+dn,v=ue(g),m=pe(g),w=0;w<u;++w,p=y,v=T,m=E,b=N){var N=f[w],y=na(N),C=N[1]/2+dn,T=ue(C),E=pe(C),M=y-p,R=M>=0?1:-1,z=R*M,L=z>Q,$=v*T;if(d.add(vt($*R*ue(z),m*E+$*pe(z))),l+=L?M+R*Re:M,L^p>=r^y>=r){var _=It(it(b),it(N));fa(_);var k=It(o,_);fa(k);var j=(L^M>=0?-1:1)*yt(k[2]);(n>j||n===j&&(_[0]||_[1]))&&(s+=L^M>=0?1:-1)}}return(l<-ne||l<ne&&d<-1e-12)^s&1}function rr(e,a,r,n){return function(i){var o=a(i),l=ar(),s=a(l),d=!1,x,c,f,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=m,u.lineStart=w,u.lineEnd=N,c=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,c=tr(c);var y=Ii(x,n);c.length?(d||(i.polygonStart(),d=!0),nr(c,Bi,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),c=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,C){e(y,C)&&i.point(y,C)}function p(y,C){o.point(y,C)}function g(){u.point=p,o.lineStart()}function v(){u.point=b,o.lineEnd()}function m(y,C){f.push([y,C]),s.point(y,C)}function w(){s.lineStart(),f=[]}function N(){m(f[0][0],f[0][1]),s.lineEnd();var y=s.clean(),C=l.result(),T,E=C.length,M,R,z;if(f.pop(),x.push(f),f=null,!!E){if(y&1){if(R=C[0],(M=R.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),T=0;T<M;++T)i.point((z=R[T])[0],z[1]);i.lineEnd()}return}E>1&&y&2&&C.push(C.pop().concat(C.shift())),c.push(C.filter($i))}}return u}}function $i(e){return e.length>1}function Bi(e,a){return((e=e.x)[0]<0?e[1]-Te-ne:Te-e[1])-((a=a.x)[0]<0?a[1]-Te-ne:Te-a[1])}const vn=rr(function(){return!0},_i,Vi,[-Q,-Te]);function _i(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?Q:-Q,d=ie(o-a);ie(d-Q)<ne?(e.point(a,r=(r+l)/2>0?Te:-Te),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&d>=Q&&(ie(a-n)<ne&&(a-=n*ne),ie(o-s)<ne&&(o-=s*ne),r=Ui(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ui(e,a,r,n){var i,o,l=ue(e-r);return ie(l)>ne?Mi((ue(a)*(o=pe(n))*ue(r)-ue(n)*(i=pe(a))*ue(e))/(i*o*l)):(a+n)/2}function Vi(e,a,r,n){var i;if(e==null)i=r*Te,n.point(-Q,i),n.point(0,i),n.point(Q,i),n.point(Q,0),n.point(Q,-i),n.point(0,-i),n.point(-Q,-i),n.point(-Q,0),n.point(-Q,i);else if(ie(e[0]-a[0])>ne){var o=e[0]<a[0]?Q:-Q;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Hi(e){var a=pe(e),r=2*Se,n=a>0,i=ie(a)>ne;function o(c,f,u,b){Di(b,e,r,u,c,f)}function l(c,f){return pe(c)*pe(f)>a}function s(c){var f,u,b,p,g;return{lineStart:function(){p=b=!1,g=1},point:function(v,m){var w=[v,m],N,y=l(v,m),C=n?y?0:x(v,m):y?x(v+(v<0?Q:-Q),m):0;if(!f&&(p=b=y)&&c.lineStart(),y!==b&&(N=d(f,w),(!N||Ft(f,N)||Ft(w,N))&&(w[2]=1)),y!==b)g=0,y?(c.lineStart(),N=d(w,f),c.point(N[0],N[1])):(N=d(f,w),c.point(N[0],N[1],2),c.lineEnd()),f=N;else if(i&&f&&n^y){var T;!(C&u)&&(T=d(w,f,!0))&&(g=0,n?(c.lineStart(),c.point(T[0][0],T[0][1]),c.point(T[1][0],T[1][1]),c.lineEnd()):(c.point(T[1][0],T[1][1]),c.lineEnd(),c.lineStart(),c.point(T[0][0],T[0][1],3)))}y&&(!f||!Ft(f,w))&&c.point(w[0],w[1]),f=w,b=y,u=C},lineEnd:function(){b&&c.lineEnd(),f=null},clean:function(){return g|(p&&b)<<1}}}function d(c,f,u){var b=it(c),p=it(f),g=[1,0,0],v=It(b,p),m=Tt(v,v),w=v[0],N=m-w*w;if(!N)return!u&&c;var y=a*m/N,C=-a*w/N,T=It(g,v),E=Lt(g,y),M=Lt(v,C);aa(E,M);var R=T,z=Tt(E,R),L=Tt(R,R),$=z*z-L*(Tt(E,E)-1);if(!($<0)){var _=et($),k=Lt(R,(-z-_)/L);if(aa(k,E),k=ua(k),!u)return k;var j=c[0],O=f[0],B=c[1],H=f[1],Z;O<j&&(Z=j,j=O,O=Z);var re=O-j,G=ie(re-Q)<ne,J=G||re<ne;if(!G&&H<B&&(Z=B,B=H,H=Z),J?G?B+H>0^k[1]<(ie(k[0]-j)<ne?B:H):B<=k[1]&&k[1]<=H:re>Q^(j<=k[0]&&k[0]<=O)){var A=Lt(R,(-z+_)/L);return aa(A,E),[k,ua(A)]}}}function x(c,f){var u=n?e:Q-e,b=0;return c<-u?b|=1:c>u&&(b|=2),f<-u?b|=4:f>u&&(b|=8),b}return rr(l,s,o,n?[0,-e]:[-Q,e-Q])}function Wi(e,a,r,n,i,o){var l=e[0],s=e[1],d=a[0],x=a[1],c=0,f=1,u=d-l,b=x-s,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<c)return;p<f&&(f=p)}else if(u>0){if(p>f)return;p>c&&(c=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>f)return;p>c&&(c=p)}else if(u>0){if(p<c)return;p<f&&(f=p)}if(p=n-s,!(!b&&p>0)){if(p/=b,b<0){if(p<c)return;p<f&&(f=p)}else if(b>0){if(p>f)return;p>c&&(c=p)}if(p=o-s,!(!b&&p<0)){if(p/=b,b<0){if(p>f)return;p>c&&(c=p)}else if(b>0){if(p<c)return;p<f&&(f=p)}return c>0&&(e[0]=l+c*u,e[1]=s+c*b),f<1&&(a[0]=l+f*u,a[1]=s+f*b),!0}}}}}var ft=1e9,qt=-ft;function Yi(e,a,r,n){function i(x,c){return e<=x&&x<=r&&a<=c&&c<=n}function o(x,c,f,u){var b=0,p=0;if(x==null||(b=l(x,f))!==(p=l(c,f))||d(x,c)<0^f>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+f+4)%4)!==p);else u.point(c[0],c[1])}function l(x,c){return ie(x[0]-e)<ne?c>0?0:3:ie(x[0]-r)<ne?c>0?2:1:ie(x[1]-a)<ne?c>0?1:0:c>0?3:2}function s(x,c){return d(x.x,c.x)}function d(x,c){var f=l(x,1),u=l(c,1);return f!==u?f-u:f===0?c[1]-x[1]:f===1?x[0]-c[0]:f===2?x[1]-c[1]:c[0]-x[0]}return function(x){var c=x,f=ar(),u,b,p,g,v,m,w,N,y,C,T,E={point:M,lineStart:$,lineEnd:_,polygonStart:z,polygonEnd:L};function M(j,O){i(j,O)&&c.point(j,O)}function R(){for(var j=0,O=0,B=b.length;O<B;++O)for(var H=b[O],Z=1,re=H.length,G=H[0],J,A,q=G[0],F=G[1];Z<re;++Z)J=q,A=F,G=H[Z],q=G[0],F=G[1],A<=n?F>n&&(q-J)*(n-A)>(F-A)*(e-J)&&++j:F<=n&&(q-J)*(n-A)<(F-A)*(e-J)&&--j;return j}function z(){c=f,u=[],b=[],T=!0}function L(){var j=R(),O=T&&j,B=(u=tr(u)).length;(O||B)&&(x.polygonStart(),O&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),B&&nr(u,s,j,o,x),x.polygonEnd()),c=x,u=b=p=null}function $(){E.point=k,b&&b.push(p=[]),C=!0,y=!1,w=N=NaN}function _(){u&&(k(g,v),m&&y&&f.rejoin(),u.push(f.result())),E.point=M,y&&c.lineEnd()}function k(j,O){var B=i(j,O);if(b&&p.push([j,O]),C)g=j,v=O,m=B,C=!1,B&&(c.lineStart(),c.point(j,O));else if(B&&y)c.point(j,O);else{var H=[w=Math.max(qt,Math.min(ft,w)),N=Math.max(qt,Math.min(ft,N))],Z=[j=Math.max(qt,Math.min(ft,j)),O=Math.max(qt,Math.min(ft,O))];Wi(H,Z,e,a,r,n)?(y||(c.lineStart(),c.point(H[0],H[1])),c.point(Z[0],Z[1]),B||c.lineEnd(),T=!1):B&&(c.lineStart(),c.point(j,O),T=!1)}w=j,N=O,y=B}return E}}const xa=e=>e;var ra=new Qe,ga=new Qe,or,ir,ba,va,Ue={point:Le,lineStart:Le,lineEnd:Le,polygonStart:function(){Ue.lineStart=Gi,Ue.lineEnd=Qi},polygonEnd:function(){Ue.lineStart=Ue.lineEnd=Ue.point=Le,ra.add(ie(ga)),ga=new Qe},result:function(){var e=ra/2;return ra=new Qe,e}};function Gi(){Ue.point=Ki}function Ki(e,a){Ue.point=sr,or=ba=e,ir=va=a}function sr(e,a){ga.add(va*e-ba*a),ba=e,va=a}function Qi(){sr(or,ir)}var st=1/0,$t=st,wt=-st,Bt=wt,_t={point:Ji,lineStart:Le,lineEnd:Le,polygonStart:Le,polygonEnd:Le,result:function(){var e=[[st,$t],[wt,Bt]];return wt=Bt=-($t=st=1/0),e}};function Ji(e,a){e<st&&(st=e),e>wt&&(wt=e),a<$t&&($t=a),a>Bt&&(Bt=a)}var ya=0,wa=0,mt=0,Ut=0,Vt=0,rt=0,ka=0,ja=0,ht=0,lr,cr,De,Ie,ze={point:Je,lineStart:yn,lineEnd:wn,polygonStart:function(){ze.lineStart=es,ze.lineEnd=ts},polygonEnd:function(){ze.point=Je,ze.lineStart=yn,ze.lineEnd=wn},result:function(){var e=ht?[ka/ht,ja/ht]:rt?[Ut/rt,Vt/rt]:mt?[ya/mt,wa/mt]:[NaN,NaN];return ya=wa=mt=Ut=Vt=rt=ka=ja=ht=0,e}};function Je(e,a){ya+=e,wa+=a,++mt}function yn(){ze.point=Xi}function Xi(e,a){ze.point=Zi,Je(De=e,Ie=a)}function Zi(e,a){var r=e-De,n=a-Ie,i=et(r*r+n*n);Ut+=i*(De+e)/2,Vt+=i*(Ie+a)/2,rt+=i,Je(De=e,Ie=a)}function wn(){ze.point=Je}function es(){ze.point=as}function ts(){dr(lr,cr)}function as(e,a){ze.point=dr,Je(lr=De=e,cr=Ie=a)}function dr(e,a){var r=e-De,n=a-Ie,i=et(r*r+n*n);Ut+=i*(De+e)/2,Vt+=i*(Ie+a)/2,rt+=i,i=Ie*e-De*a,ka+=i*(De+e),ja+=i*(Ie+a),ht+=i*3,Je(De=e,Ie=a)}function pr(e){this._context=e}pr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Re);break}}},result:Le};var Na=new Qe,oa,ur,fr,xt,gt,kt={point:Le,lineStart:function(){kt.point=ns},lineEnd:function(){oa&&mr(ur,fr),kt.point=Le},polygonStart:function(){oa=!0},polygonEnd:function(){oa=null},result:function(){var e=+Na;return Na=new Qe,e}};function ns(e,a){kt.point=mr,ur=xt=e,fr=gt=a}function mr(e,a){xt-=e,gt-=a,Na.add(et(xt*xt+gt*gt)),xt=e,gt=a}let kn,Ht,jn,Nn;class Sn{constructor(a){this._append=a==null?hr:rs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==jn||this._append!==Ht){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,jn=n,Ht=this._append,Nn=this._,this._=i}this._+=Nn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function hr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function rs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return hr;if(a!==kn){const r=10**a;kn=a,Ht=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Ht}function os(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),nt(s,i(o))),o.result()}return l.area=function(s){return nt(s,i(Ue)),Ue.result()},l.measure=function(s){return nt(s,i(kt)),kt.result()},l.bounds=function(s){return nt(s,i(_t)),_t.result()},l.centroid=function(s){return nt(s,i(ze)),ze.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,xa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new Sn(r)):new pr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const d=Math.floor(s);if(!(d>=0))throw new RangeError(`invalid digits: ${s}`);r=d}return a===null&&(o=new Sn(r)),l},l.projection(e).digits(r).context(a)}function Oa(e){return function(a){var r=new Sa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Sa(){}Sa.prototype={constructor:Sa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Fa(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),nt(r,e.stream(_t)),a(_t.result()),n!=null&&e.clipExtent(n),e}function xr(e,a,r){return Fa(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,d])},r)}function is(e,a,r){return xr(e,[[0,0],a],r)}function ss(e,a,r){return Fa(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function ls(e,a,r){return Fa(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var Cn=16,cs=pe(30*Se);function En(e,a){return+a?ps(e,a):ds(e)}function ds(e){return Oa({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ps(e,a){function r(n,i,o,l,s,d,x,c,f,u,b,p,g,v){var m=x-n,w=c-i,N=m*m+w*w;if(N>4*a&&g--){var y=l+u,C=s+b,T=d+p,E=et(y*y+C*C+T*T),M=yt(T/=E),R=ie(ie(T)-1)<ne||ie(o-f)<ne?(o+f)/2:vt(C,y),z=e(R,M),L=z[0],$=z[1],_=L-n,k=$-i,j=w*_-m*k;(j*j/N>a||ie((m*_+w*k)/N-.5)>.3||l*u+s*b+d*p<cs)&&(r(n,i,o,l,s,d,L,$,R,y/=E,C/=E,T,g,v),v.point(L,$),r(L,$,R,y,C,T,x,c,f,u,b,p,g,v))}}return function(n){var i,o,l,s,d,x,c,f,u,b,p,g,v={point:m,lineStart:w,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=C},polygonEnd:function(){n.polygonEnd(),v.lineStart=w}};function m(M,R){M=e(M,R),n.point(M[0],M[1])}function w(){f=NaN,v.point=N,n.lineStart()}function N(M,R){var z=it([M,R]),L=e(M,R);r(f,u,c,b,p,g,f=L[0],u=L[1],c=M,b=z[0],p=z[1],g=z[2],Cn,n),n.point(f,u)}function y(){v.point=m,n.lineEnd()}function C(){w(),v.point=T,v.lineEnd=E}function T(M,R){N(i=M,R),o=f,l=u,s=b,d=p,x=g,v.point=N}function E(){r(f,u,c,b,p,g,o,l,i,s,d,x,Cn,n),v.lineEnd=y,y()}return v}}var us=Oa({point:function(e,a){this.stream.point(e*Se,a*Se)}});function fs(e){return Oa({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ms(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function An(e,a,r,n,i,o){if(!o)return ms(e,a,r,n,i);var l=pe(o),s=ue(o),d=l*e,x=s*e,c=l/e,f=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function p(g,v){return g*=n,v*=i,[d*g-x*v+a,r-x*g-d*v]}return p.invert=function(g,v){return[n*(c*g-f*v+u),i*(b-f*g-c*v)]},p}function hs(e){return xs(function(){return e})()}function xs(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,d=0,x=0,c,f=0,u=1,b=1,p=null,g=vn,v=null,m,w,N,y=xa,C=.5,T,E,M,R,z;function L(j){return M(j[0]*Se,j[1]*Se)}function $(j){return j=M.invert(j[0],j[1]),j&&[j[0]*_e,j[1]*_e]}L.stream=function(j){return R&&z===j?R:R=us(fs(c)(g(T(y(z=j)))))},L.preclip=function(j){return arguments.length?(g=j,p=void 0,k()):g},L.postclip=function(j){return arguments.length?(y=j,v=m=w=N=null,k()):y},L.clipAngle=function(j){return arguments.length?(g=+j?Hi(p=j*Se):(p=null,vn),k()):p*_e},L.clipExtent=function(j){return arguments.length?(y=j==null?(v=m=w=N=null,xa):Yi(v=+j[0][0],m=+j[0][1],w=+j[1][0],N=+j[1][1]),k()):v==null?null:[[v,m],[w,N]]},L.scale=function(j){return arguments.length?(r=+j,_()):r},L.translate=function(j){return arguments.length?(n=+j[0],i=+j[1],_()):[n,i]},L.center=function(j){return arguments.length?(o=j[0]%360*Se,l=j[1]%360*Se,_()):[o*_e,l*_e]},L.rotate=function(j){return arguments.length?(s=j[0]%360*Se,d=j[1]%360*Se,x=j.length>2?j[2]%360*Se:0,_()):[s*_e,d*_e,x*_e]},L.angle=function(j){return arguments.length?(f=j%360*Se,_()):f*_e},L.reflectX=function(j){return arguments.length?(u=j?-1:1,_()):u<0},L.reflectY=function(j){return arguments.length?(b=j?-1:1,_()):b<0},L.precision=function(j){return arguments.length?(T=En(E,C=j*j),k()):et(C)},L.fitExtent=function(j,O){return xr(L,j,O)},L.fitSize=function(j,O){return is(L,j,O)},L.fitWidth=function(j,O){return ss(L,j,O)},L.fitHeight=function(j,O){return ls(L,j,O)};function _(){var j=An(r,0,0,u,b,f).apply(null,a(o,l)),O=An(r,n-j[0],i-j[1],u,b,f);return c=Pi(s,d,x),E=ma(a,O),M=ma(c,E),T=En(E,C),k()}function k(){return R=z=null,L}return function(){return a=e.apply(this,arguments),L.invert=a.invert&&$,_()}}function gr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}gr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function gs(){return hs(gr).scale(175.295)}function bs(e){return e}function vs(e){if(e==null)return bs;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,d){d||(a=r=0);var x=2,c=s.length,f=new Array(c);for(f[0]=(a+=s[0])*n+o,f[1]=(r+=s[1])*i+l;x<c;)f[x]=s[x],++x;return f}}function ys(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ws(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return zn(e,r)})}:zn(e,a)}function zn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=ks(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function ks(e,a){var r=vs(e.transform),n=e.arcs;function i(c,f){f.length&&f.pop();for(var u=n[c<0?~c:c],b=0,p=u.length;b<p;++b)f.push(r(u[b],b));c<0&&ys(f,p)}function o(c){return r(c)}function l(c){for(var f=[],u=0,b=c.length;u<b;++u)i(c[u],f);return f.length<2&&f.push(f[0]),f}function s(c){for(var f=l(c);f.length<4;)f.push(f[0]);return f}function d(c){return c.map(s)}function x(c){var f=c.type,u;switch(f){case"GeometryCollection":return{type:f,geometries:c.geometries.map(x)};case"Point":u=o(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(o);break;case"LineString":u=l(c.arcs);break;case"MultiLineString":u=c.arcs.map(l);break;case"Polygon":u=d(c.arcs);break;case"MultiPolygon":u=c.arcs.map(d);break;default:return null}return{type:f,coordinates:u}}return x(a)}const br={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},js=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Ns(e,a,r){const n=br[e];if(!n||!n.length)return-1;const i=js(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Mt=null;function Ss(){return Mt||(Mt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ws(r,n),o=gs().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=os(o),s=(i.features||[]).filter(c=>{var f;return(((f=c.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(c=>{var b;const f=((b=c.properties)==null?void 0:b.name)||"",u=l(c)||"";return u?{i2:no(f)||null,n:f,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const d={};for(const[c,f]of Object.entries(ro)){const u=o(f);u&&(d[c]={x:u[0],y:u[1]})}const x={};for(const[c,f]of Object.entries(br)){const u=f.map(b=>o(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(x[c]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:d,metros:x}}catch{return null}})(),Mt)}function Cs(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return Ss().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const Es={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Tn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Ln(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function As(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let i=!0,o=0;const l=()=>{var x;if(!i)return;const d=(x=e.current)==null?void 0:x.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function zs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:d,data:x,dossiers:c}=P(),f=x.loading&&!c.length,u=h.useRef(null),b=h.useRef(null),p=Cs(e.continent==="monde"),g=e.continent==="monde"?p:La.find(k=>k.key===e.continent)||null,v=As(u,e.continent+":"+e.mapFolded+":"+!!g),[m,w]=h.useState(new Map),[N,y]=h.useState(null);h.useEffect(()=>{const k=u.current;if(!k)return;const j=new Map;k.querySelectorAll("path[data-i2]").forEach(O=>{const B=O.dataset.i2;if(B)try{const H=O.getBBox();H.width>0&&j.set(B,{x:H.x,y:H.y,w:H.width,h:H.height})}catch{}}),w(j)},[e.continent,v,g]);const C=h.useMemo(()=>r.filter(k=>k.cc),[r]),T=h.useMemo(()=>{const k=new Map;return C.forEach(j=>k.set(j.cc,(k.get(j.cc)||0)+1)),k},[C]),E=e.continent==="monde"&&p?p.anchors:null,M=e.continent==="monde"&&p?p.metros:null,R=h.useMemo(()=>C.map(k=>{const j=Ln(k.name||k.id||""),O=Ln((k.id||k.name||"")+"·y");if(E&&k.cc){const G=M?M[k.cc]:void 0;if(G&&G.length){const A=Ns(k.cc,k.city,j);if(A>=0&&G[A])return{d:k,x:G[A].x+(j-.5)*5,y:G[A].y+(O-.5)*5}}const J=E[k.cc];if(J)return{d:k,x:J.x+(j-.5)*10,y:J.y+(O-.5)*10}}const B=k.cc?m.get(k.cc):void 0;if(!B)return null;const H=Es[`${e.continent}:${k.cc||""}`];if(H)return{d:k,x:B.x+B.w*(H.fx+(j-.5)*H.sx),y:B.y+B.h*(H.fy+(O-.5)*H.sy)};const Z=(j-.5)*Math.min(B.w*.55,60),re=(O-.5)*Math.min(B.h*.55,60);return{d:k,x:B.x+B.w/2+Z,y:B.y+B.h/2+re}}).filter(k=>!!k),[C,m,E,M,e.continent]),z=k=>v>0?k/v:k,L=h.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:Tn[k],fr:d.plabels[k].toUpperCase(),en:d.plabels[k].toUpperCase(),n:r.filter(j=>j.kind==="target"&&ke(j)===k).length})).filter(k=>k.n>0):Ka.map((k,j)=>({...k,n:r.filter(O=>Qa(O)===j).length})),[r,n,d.plabels]),$=o?l.get(o):null,_=$?R.find(k=>k.d.id===$.id):null;return g?t.jsxs("div",{className:"mapzone"+(f?" waiting":""),ref:b,children:[t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?g.fr:g.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:g.countries.map((k,j)=>t.jsx("g",{className:"ct"+(k.i2&&T.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},j))}),t.jsx("g",{children:R.map(k=>{const j=Ka[Qa(k.d)],O=!!ge(k.d),B=k.d.kind==="target",H=n&&B?Tn[ke(k.d)]:j.c,Z=!n&&Ce(k.d);return t.jsxs("g",{className:"co"+(Z?" done":""),onMouseEnter:()=>{var J,A;const re=(J=b.current)==null?void 0:J.getBoundingClientRect(),G=(A=u.current)==null?void 0:A.createSVGPoint();if(G&&u.current&&re){G.x=k.x,G.y=k.y;const q=G.matrixTransform(u.current.getScreenCTM());y({x:q.x-re.left,y:q.y-re.top,label:k.d.name+" · "+(ct(k.d.cc,s)||k.d.countryLabel||"")})}i(k.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var J;const re=(J=u.current)==null?void 0:J.createSVGPoint();let G=null;if(re&&u.current){re.x=k.x,re.y=k.y;const A=re.matrixTransform(u.current.getScreenCTM());G={x:A.x,y:A.y}}a({type:"popup",id:k.d.id,anchor:G})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:z(Math.max(11,j.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:z(j.px),fill:H,stroke:O?"#DC2626":"#ffffff",strokeWidth:z(O?2.2:1.3)})]},k.d.id||k.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:z(13),fill:"none",stroke:"#0F172A",strokeWidth:z(2)})]}),t.jsx("div",{className:"hov"+(N?" on":""),style:N?{left:N.x,top:N.y}:void 0,children:N==null?void 0:N.label}),t.jsx("div",{className:"legend",children:L.map((k,j)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},j))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:b})}function Ts(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Ls(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=P(),s=e.filters,d=h.useMemo(()=>e.continent==="monde"?r:r.filter(p=>p.continent===e.continent),[r,e.continent]),x=p=>d.filter(g=>p!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:Ra(g,s,i,p==="country"?void 0:p)),c=h.useMemo(()=>{const p=x("win"),g=v=>p.filter(m=>(m.date?Math.max(0,Math.floor((Date.now()-Date.parse(m.date))/864e5)):9999)<=v).length;return[g(0),g(7),g(30),p.length]},[d,s,i]),f=h.useMemo(()=>s.day?x("win").filter(p=>(p.date||"").slice(0,10)===s.day).length:0,[d,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),b=(p,g,v,m="fbtn")=>t.jsxs("button",{type:"button",className:m,"aria-expanded":e.openFacet===p,onClick:()=>a({type:"openFacet",facet:p}),children:[t.jsx("span",{className:"fl",children:g}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},p);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:n.fDay(Ts(s.day,l))}),t.jsx("b",{children:f})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((p,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===p,onClick:()=>a({type:"filters",patch:{win:p}}),children:[t.jsx("span",{className:"sl",children:n.dates[g]}),t.jsx("b",{children:c[g]})]},p))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:p=>a({type:"filters",patch:{search:p.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):b("sec",n.fSector,s.sector.length),b("pay",n.fCountry,s.country.length),b("det",n.fEngine,s.engine.length),b("sta",n.fStage,s.stage.length),i&&b("ang","Angle",s.angle.length),i&&b("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(d.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Rs,{poolFor:x})]})}function Rs({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=P(),o=a.filters,l=a.openFacet,{title:s,cols:d,options:x}=h.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(m=>ge(m)),g=new Map;p.forEach(m=>{const w=m.engine||"";g.set(w,(g.get(w)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...la([...g.keys()],i).map(m=>({v:m,label:Ke(m)+" "+$e(m,i),n:g.get(m)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(m)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const p=e("sector"),g=new Map;return p.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v,n:m,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const p=e("country"),g=new Map;return p.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:ct(v,i)||v,n:m,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const p=e("engine"),g=new Map;return p.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:la([...g.keys()],i).map(v=>({v,label:Ke(v)+" "+$e(v,i)+' <span style="color:var(--dim);font-size:10px">· '+oo(io(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const p=e("angle"),g=new Map;return p.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v.replace(/[_-]+/g," "),n:m,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const p=e("memoLevel"),g=new Map;p.forEach(m=>{if(m.kind==="target"){const w=za(m);g.set(w,(g.get(w)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(m=>({v:String(m),label:v[m],n:g.get(m)||0,html:!1,on:o.memoLevel.includes(m)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,g)=>g[1]-p[1]).map(([p,g])=>({v:p,label:p,n:g,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),c=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},f=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>c(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function vr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function qs(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Rn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=P();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:s.rsEvalOne})]},d.name))})]}):null}function yr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=P(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Rn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Rn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Ms({card:e,onEvaluate:a,onAddAll:r}){var s,d,x;const{t:n}=P(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:vr(e.summary_md||"").map((c,f)=>t.jsx("p",{children:c},f))})]}),t.jsx(yr,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function Os(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Fs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=P(),s=i,[d,x]=h.useState(null),[c,f]=h.useState(null),[u,b]=h.useState(null),[p,g]=h.useState(!1);h.useEffect(()=>{let m=!0;return(async()=>{const w=await Vn({email:l,cbToken:s});m&&x(w)})(),()=>{m=!1}},[l,s,n]);const v=m=>{f(m),b(null),g(!0),(async()=>{const w=await so(m.id);b(w),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[Os(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?o.rsPub:o.rsPriv})]},m.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(Ms,{card:u,onEvaluate:a,onAddAll:r})]})]})}const qn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Ps(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:d,caps:x,data:c,canWrite:f,source:u}=P(),b=a==="client",p=h.useMemo(()=>r||(u!=="default"?lo():""),[r,u]),[g,v]=h.useState(""),[m,w]=h.useState(!1),[N,y]=h.useState(""),[C,T]=h.useState(!1),[E,M]=h.useState(""),[R,z]=h.useState([]),L=h.useRef(!1),[$,_]=h.useState(!1),[k,j]=h.useState(""),[O,B]=h.useState(""),[H,Z]=h.useState(!1),[re,G]=h.useState(0),[J,A]=h.useState(""),[q,F]=h.useState(null),[I,W]=h.useState(null),[Y,se]=h.useState(!1),[le,K]=h.useState(null),[X,he]=h.useState(0),ee=h.useRef(!1),ce=g.trim()?qn.test(g.trim())?e.evalUrl:e.evalName:e.evalWaiting,ae=h.useMemo(()=>N.split(`
`).map(D=>D.trim()).filter(Boolean).slice(0,15),[N]);h.useEffect(()=>{if(typeof window>"u")return;const D=(new URLSearchParams(window.location.search).get("rs")||"").trim();!D||!/^https?:\/\//i.test(D)||(j(D),_(!0))},[]),h.useEffect(()=>{const D=te=>{var ye;const oe=String(((ye=te.detail)==null?void 0:ye.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(j(oe),_(!0))};return window.addEventListener("ppmap:research",D),()=>window.removeEventListener("ppmap:research",D)},[]),h.useEffect(()=>{if(!f&&!p){K(null);return}let D=!0;return(async()=>{const te=await Vn({email:n,cbToken:p});D&&K(te.length)})(),()=>{D=!1}},[f,p,n,X]);const Oe=R.length?R:d,xe=c.credits,ve=h.useCallback(D=>{const te=D.map(oe=>(oe||"").trim()).filter(Boolean);te.length&&(y(oe=>{const ye=oe.split(`
...
`)}),w(!0))},[]);h.useEffect(()=>{if(!H)return;G(0);const D=window.setInterval(()=>G(te=>te+1),1e3);return()=>window.clearInterval(D)},[H]);const qe=()=>{const D=g.trim();D&&(i(null,D),v(""))},tt=async()=>{if(!b){i(null,ae[0]||"");return}if(!ae.length||C)return;T(!0),L.current=!1;const D=[];for(let te=0;te<ae.length&&!L.current;te++){M(e.evaluating(te+1,ae.length,ae[te]));const oe=await Hn(r,ae[te],"atelier2");if(D.unshift({name:oe.company||ae[te],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),z([...D]),oe.verdict==="quota"){D.unshift({name:"",verdict:"quota",reason:e.quota(ae.length-te-1),remaining:0}),z([...D]),y(ae.slice(te+1).join(`
`)),M(""),T(!1);return}}M(""),y(L.current?ae.slice(D.length).join(`
`):""),T(!1)},Ee=async()=>{var oe,ye,Ve;if(ee.current)return;const D=k.trim().replace(/\s+/g,""),te=O.trim();if(!D&&!te){A(e.rsNeed);return}if(!b&&!p){i(null,D||te.slice(0,80));return}ee.current=!0,A(""),F(null),W(null),Z(!0);try{const je=await po({url:D,text:te,email:n,cbToken:p});if(Z(!1),!je||je.status!=="success"){A((je==null?void 0:je.message)||"Erreur");return}F(je),_(!1),ve((((oe=je.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),W({state:"pending"});const de=await uo(je,{email:n,cbToken:p});W(de.ok?{state:"ok",scopeLabel:((ye=de.summary)==null?void 0:ye.scope_label)||"",scope:((Ve=de.summary)==null?void 0:Ve.scope)||""}:{state:"fail",msg:de.error||""}),de.ok&&he(Ae=>Ae+1)}finally{ee.current=!1,Z(!1)}},Be=[q==null?void 0:q.industry,...(q==null?void 0:q.market_tags)||[],q==null?void 0:q.author].map(D=>(D||"").trim()).filter(Boolean),dt=(I==null?void 0:I.state)==="pending",Nt=I&&(dt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):I.state==="ok"?t.jsx("span",{className:"rslink ok",children:I.scope&&I.scope!=="public"?e.rsSavedIn(I.scopeLabel||I.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:I.msg,children:e.rsSaveFail})),at=qs(q).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:g,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:D=>v(D.target.value),onKeyDown:D=>{D.key==="Enter"&&qe()}}),t.jsx("span",{className:"detect"+(qn.test(g.trim())?" url":""),children:ce})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:qe,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),x.showCredits&&xe&&t.jsxs("button",{type:"button",className:"credits"+(xe.total_available<=0&&!xe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:xe.unlimited?"∞":xe.total_available}),!xe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",xe.daily_grant+xe.purchased]}),xe.total_available<=0&&!xe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>w(!m),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+($?" on":""),onClick:()=>_(!$),children:e.rsOpen}),le!==null&&le>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Y?" on":""),onClick:()=>se(!Y),children:e.rsArchOpen(le)})]}),Y&&t.jsx(Fs,{bump:X,cbToken:p,onClose:()=>se(!1),onEvaluate:D=>i(null,D),onAddAll:ve}),$&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:k,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:D=>j(D.target.value),onKeyDown:D=>{D.key==="Enter"&&Ee()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:O,placeholder:e.rsTextPh,onChange:D=>B(D.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(H?" loading":""),style:{justifyContent:"center"},disabled:H||dt||!k.trim()&&!O.trim(),onClick:()=>{Ee()},children:[t.jsx("span",{className:"fill"}),H?`${co(k.trim())==="youtube"&&k.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(re)}`:dt?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),J&&t.jsx("div",{className:"rserr",children:J}),q&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:q.title}),q.source_url&&t.jsx("a",{href:q.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{F(null),W(null)},children:"×"})]}),q.market&&t.jsx("p",{className:"rsmk",children:q.market}),Be.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Be.map(D=>t.jsx("span",{children:D},D))]}),t.jsxs("div",{className:"rsbody",children:[q.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${q.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:vr(q.summary_md||"").map((D,te)=>t.jsx("p",{children:D},te))})]}),t.jsx(yr,{card:q,onEvaluate:D=>i(null,D),onAddAll:ve}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(at)}),Nt]})]}),m&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:N,placeholder:e.bulkPh,onChange:D=>y(D.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(C?" loading":""),style:{justifyContent:"center"},disabled:C||!ae.length,onClick:()=>{tt()},children:[t.jsx("span",{className:"fill"}),C&&E?E:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(ae.length)})]})]}),Oe.slice(0,1).map((D,te)=>{const oe=D.verdict==="kept",ye=D.verdict==="quota",Ve=oe?"var(--brand)":ye?"var(--bolt)":"var(--red)",je=oe?"var(--brand-l)":ye?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ve,"--bgc":je},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:ye?"⏳":"✗ "+e.dropped})}),D.name&&t.jsx("span",{className:"rn",children:D.name}),t.jsx("span",{className:"rr",children:D.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",D.reason]}):null}),!!(D.candidates&&D.candidates.length)&&t.jsx("span",{className:"sitepick",children:D.candidates.map(de=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:de.url.startsWith("http")?de.url:`https://${de.url}`,target:"_blank",rel:"nofollow noopener",children:[(de.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,de.url),children:e.evalPickGo})]},de.url))}),!ye&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:oe?1:5});const de=(D.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ae=[...document.querySelectorAll(".atl2 .list .row")].find(Kt=>{var St;return(((St=Kt.querySelector(".rnm"))==null?void 0:St.textContent)||"").trim().toLowerCase().includes(de)});Ae&&(Ae.scrollIntoView({behavior:"smooth",block:"center"}),Ae.classList.add("flashrow"),window.setTimeout(()=>Ae.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},te)}),b&&(o.kept+o.dropped>0||Oe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Ds(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Is(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=P(),o=e.memoConsole?r.get(e.memoConsole):null,l=h.useMemo(()=>o?[o.reasoning||"",Ds(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const s=Ze(o),d=za(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((x,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[ot(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const ia={},Mn=(ia==null?void 0:ia.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function On(){return new Date().toISOString().slice(0,10)}const Pa=h.createContext(null);function $s(){return h.useContext(Pa)}function Bs(e){if(!e||typeof DOMParser>"u")return[];try{const r=[...new DOMParser().parseFromString(e,"text/html").querySelectorAll("div,section")].find(i=>/en bref/i.test(i.textContent||"")&&i.querySelector("li"));return(r?[...r.querySelectorAll("li")]:[]).map(i=>(i.textContent||"").replace(/\s+/g," ").trim()).filter(i=>i.length>3).slice(0,4)}catch{return[]}}function _s(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),s.querySelectorAll("*").forEach(d=>{const x=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(c=>d.removeAttribute(c.name)),x&&/^https?:\/\//i.test(x)&&(d.setAttribute("href",x),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Ca(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Us(){const{ed:e,isEn:a,day:r,loading:n}=Da(),i=h.useMemo(()=>Bs((e==null?void 0:e.html)||""),[e==null?void 0:e.html]);if(n&&!e)return null;const o=Ca(r,a);return i.length?t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:(a?"Daily brief · ":"Brief du jour · ")+o}),t.jsx("ul",{children:i.map((l,s)=>t.jsx("li",{children:l},s))})]}):t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:a?"Daily brief":"Brief du jour"}),t.jsx("p",{className:"tlp",children:a?`Edition of ${o}.`:`Édition du ${o}.`})]})}function Da(){const e=h.useContext(Pa);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Vs({token:e,children:a}){const{dispatch:r,st:n,lang:i}=P(),[o,l]=h.useState(()=>n.filters.day||On()),[s,d]=h.useState(null),[x,c]=h.useState(!1),f=h.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){l(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=h.useCallback(()=>{l(On());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);h.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),h.useEffect(()=>{const g=v=>{var w;const m=(w=v.detail)==null?void 0:w.day;typeof m=="string"&&f(m)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[f]),h.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),h.useEffect(()=>{if(!e||!o)return;let g=!1;c(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${Mn}/cibles/edition.json?${v}`).then(m=>m.json()).then(m=>{g||d(m)}).catch(()=>{g||d({ok:!1,error:"network"})}).finally(()=>{g||c(!1)}),()=>{g=!0}},[e,o]);const b=h.useMemo(()=>`${Mn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=h.useMemo(()=>({token:e,day:o,ed:s,loading:x,pickDay:f,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,s,x,f,u,n.filters.day,b,i]);return t.jsx(Pa.Provider,{value:p,children:a})}function Hs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Da();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(fo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function Ws(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Da(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,d=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
...
`;function Gs(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function Ks(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:d,doDecide:x,doPromote:c,doRepeche:f,doApproach:u,doDeep:b,doOnboard:p,outbound:g,evalBusy:v}=P(),m=e.popupId?r.get(e.popupId):null;if(!m)return null;const w=ge(m),N=ke(m),y=Ze(m),C=m.kind==="target",T=E=>{a({type:"filters",patch:E}),a({type:"popup",id:null})};return lt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Ys}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Gs(e.popupAnchor,!!m.card),onClick:E=>E.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:m.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(He(m.date)),$e(m.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[m.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>T({country:[m.cc]}),children:(ct(m.cc,i)||m.countryLabel||"").toUpperCase()}),m.sector&&t.jsx("button",{type:"button",onClick:()=>T({sector:[m.sector]}),children:m.sector.toUpperCase()}),m.stage&&t.jsx("button",{type:"button",onClick:()=>T({stage:[m.stage]}),children:m.stage.toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{className:"am2",children:jt(m.amountEur,i)})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ke(m.engine)," ",t.jsx("b",{children:$e(m.engine,i)})," — ",ho(m.engine,i),m.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",m.noteTitle]})]}),w?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Xe,{o:m,lg:!0})," ",t.jsx(Gt,{o:m,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Wn(w,i))," · ",n.win7(Yn(w,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),m.card?t.jsx(Yt,{spec:m.card}):null,m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&N>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),o.pipe&&C&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof m.score=="number"&&m.score>0?" · "+n.score(m.score):""]})})]}),t.jsx(wr,{name:m.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[N===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)]}),N===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),N===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),N===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(m,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(m,!1),a({type:"popup",id:null})},children:n.actNo}),ot(m)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(m),a({type:"popup",id:null})},children:n.memoDeep})]}),N===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),N===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),m.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:m.id}),a({type:"popup",id:null})},children:"📄"}),g&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(m),a({type:"popup",id:null})},children:"🚀"})]}):m.engine==="media"&&m.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var E;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"popup",id:null}),(E=document.querySelector(".atl2 .demand"))==null||E.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(m.name),onClick:()=>s(m),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)," →"]}),m.website&&t.jsx("a",{className:"psite",href:m.website.startsWith("http")?m.website:"https://"+m.website,target:"_blank",rel:"noopener noreferrer",title:m.website,children:"🌐"})]})]})]}),document.body)}const Qs=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ot=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Js(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Ot(a.slice(n));break}r+=Ot(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Ot(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),d=s?s[2].toLowerCase():"";s&&Qs.has(d)?r+=`<${s[1]}${d}>`:r+=Ot(a.slice(i,o+1)),n=o+1}return r}const Fn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function we({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Xs(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Zs({o:e}){const{t:a,doDeep:r}=P(),n=Ze(e),i=[e.reasoning||"",Xs(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[n&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:n}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),i.length?i.join(`

`).split(`

`).map((o,l)=>t.jsx("p",{className:"cdtxt",children:o},l)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[ot(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:o=>{o.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:o=>o.stopPropagation(),children:a.memoOpenFull})]})]})}function el({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=P(),o=Wt(e),l=Ze(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,c=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),f=h.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:c},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||ot(e)?1:0}].filter(g=>g.n>0),[e,a,s,l,d,x,c]),[u,b]=h.useState("");if(!f.length)return null;const p=f.some(g=>g.k===u)?u:f[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:f.map(g=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===g.k,"data-tour":"tab-"+g.k,className:p===g.k?"on":"",onClick:v=>{v.stopPropagation(),b(g.k)},children:g.lib},g.k))}),t.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(we,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(we,{k:a.cdVerdictDate,v:Fn(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Js(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(tl,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdSector,v:e.sector}),t.jsx(we,{k:a.cdStage,v:e.stage}),t.jsx(we,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(we,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(we,{k:a.cdAngle,v:e.angle}),t.jsx(we,{k:a.cdDetected,v:Fn(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdName,v:e.contactName}),t.jsx(we,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(Zs,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(we,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function tl({o:e}){const{t:a,token:r}=P(),[n,i]=h.useState(!1),[o,l]=h.useState(null),s=async()=>{n||(i(!0),l(await xo(r,e.name,e.website||e.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},x=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],c=x.some(([,f])=>f);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&c&&t.jsxs(t.Fragment,{children:[x.filter(([,f])=>f).map(([f,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:f}),t.jsx("p",{children:u})]},f)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!c&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const kr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ia({o:e}){const{t:a}=P(),r=Wt(e),n=Ze(e),i=ke(e),o=sa(e),l=go(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(kr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const Ea=e=>e.length>22?e.slice(0,21)+"…":e;function Pn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=P(),[o,l]=h.useState(!1);if(h.useEffect(()=>{n||l(!1)},[n]),Ce(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Ea(e.name))})]})}function jr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:d,doApproach:x,dispatch:c}=P();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:b=>{b.stopPropagation(),c({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var p;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(p=document.querySelector(".atl2 .demand"))==null||p.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var p;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(p=document.querySelector(".atl2 .demand"))==null||p.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Pn,{o:e})});const f=ke(e),u=b=>p=>{p.stopPropagation(),b()};if(f===0)return t.jsx("span",{className:"cell",children:t.jsx(Pn,{o:e})});if(f===1){const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:u(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(f===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})});if(f===4){const b=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:b,onClick:u(()=>x(e)),children:b?a.actApproachSent:a.actApproach})})}return f===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):f===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>c({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function al({o:e}){const{t:a,doThumb:r,thumbOf:n}=P(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function nl({o:e}){const{lang:a}=P();return ge(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Xe,{o:e}),t.jsx(Gt,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ke(e.engine||"")," ",$e(e.engine||"",a)]})})}function rl({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:d,favIds:x,toggleFav:c}=P(),f=ke(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,p=b<=0?0:b<=7?1:b<=30?2:3,g=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][f]:u[p],v=x.has(e.id),m=w=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const N=w.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:N.left+Math.min(280,N.width/3),y:N.bottom}})};return t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"row"+(d===e.id||r?" on":"")+(r?" open":"")+(a?" tzr":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:m,children:[t.jsx("span",{className:"pt",style:{"--c":g}}),t.jsx(Er,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:v?1:.35,padding:0,marginRight:4},onClick:w=>{w.stopPropagation(),c(e)},children:v?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(w=>w&&w!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(ol,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(nl,{o:e}),l.pipe&&t.jsx(Ia,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(jr,{o:e}),l.showThumbs&&t.jsx(al,{o:e})]}),r&&!a&&t.jsx(sl,{o:e})]})}function ol({o:e}){const{lang:a,caps:r}=P();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=jt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function il({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=P(),l=(u,b=!1)=>p=>{p.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),d=jt(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=Ce(e),f=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Ea(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Ea(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Yt,{spec:e.card})})]})}function sl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=P();return!i.pipe&&e.kind==="op"?t.jsx(il,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(el,{o:e}),t.jsx(ki,{o:e}),t.jsx(Si,{o:e}),t.jsx(wr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Ia,{o:e})})]}),e.card&&t.jsx(Yt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ke(e.engine||"")," ",$e(e.engine||"",r)]}),ge(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Xe,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function ll({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:l}=P();if(!i.pipe&&e.kind==="op"){const x=jt(e.amountEur,l),c=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),f=(u,b=!1)=>p=>{p.stopPropagation(),b&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Yt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:f({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:f({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:f({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Ke(e.engine||"")," ",$e(e.engine||"",l)]}),ge(e)&&t.jsx(Xe,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(c?` · ${c}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(jr,{o:e})})]})}const s=ke(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" tzr":""),style:{"--c":d},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Ia,{o:e}),ge(e)&&t.jsx(Xe,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function cl(){const{t:e}=P(),[a,r]=h.useState(0);return h.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function dl({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=P(),o=i==="en",l=c=>n.plabels[c]||"",s=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),d=s.includes(0)?0:s.sort((c,f)=>(e[f]||0)-(e[c]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?o?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:o?`${x} ${x>1?"files":"file"} in “${l(d)}”`:`${x} dossier${x>1?"s":""} dans « ${l(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(o?"Open ":"Ouvrir ")+l(d)," →"]})]})}function pl(){var J;const e=P(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,lang:s,sessTally:d,data:x,dossiers:c,source:f}=e,u=i.lockRowsAfter!==null?Number.MAX_SAFE_INTEGER:f==="ops"?8:Kn,[b,p]=h.useState(new Set);h.useEffect(()=>{p(new Set)},[a.ptab,a.continent]);const[g,v]=h.useState(null);h.useEffect(()=>{v(null)},[a.ptab,a.continent]);const m=A=>p(q=>{const F=new Set(q);return F.has(A)?F.delete(A):F.add(A),F}),[w,N]=h.useState("all"),[y,C]=h.useState(!1);h.useEffect(()=>{N("all"),C(!1)},[a.ptab,a.continent]),h.useEffect(()=>{if(!y)return;const A=q=>{var F,I;(I=(F=q.target)==null?void 0:F.closest)!=null&&I.call(F,".atl2 .doable")||C(!1)};return document.addEventListener("click",A),()=>document.removeEventListener("click",A)},[y]);const T=$s(),E=h.useMemo(()=>{var q;const A=new Map;for(const F of _s(((q=T==null?void 0:T.ed)==null?void 0:q.html)||""))A.has(F.t)||A.set(F.t,F.html);return A},[(J=T==null?void 0:T.ed)==null?void 0:J.html]),M=h.useCallback(A=>{if(A.decryptHtml)return A.decryptHtml;if(!E.size)return;const q=(A.name||"").trim().toLowerCase();if(q.length<3)return;const F=E.get(q);if(F)return F;for(const[I,W]of E)if(I.includes(q)||q.includes(I))return W},[E]),R=h.useMemo(()=>{const A=qa(l,a.sort);return w==="all"?A:A.filter(q=>w==="explore"?!!q.noCo:!q.noCo)},[l,a.sort,f,w]),z=h.useMemo(()=>R.filter(A=>ge(A)&&!Ce(A)).length,[R]),L=h.useMemo(()=>i.pipe?R:R.filter(A=>!Ce(A)&&!A.noCo),[R,i.pipe]),$=f==="ops"?R.filter(A=>A.noCo).length:0,_=i.pipe?n.plabels[a.ptab].toLowerCase():f==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,k=a.filters,j=[];if(k.day)j.push({k:"day",lib:n.fDay(k.day.slice(8,10)+"/"+k.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(k.win&&k.win!=="all"){const A=["1","7","30"].indexOf(k.win);A>=0&&j.push({k:"win",lib:n.dates[A],off:()=>r({type:"filters",patch:{win:"all"}})})}const O=A=>A.length<=2?A.join(", "):`${A.length} ${n.fSelected}`;for(const A of["sector","country","engine"]){const q=k[A];q&&q.length&&j.push({k:A,lib:O(q),off:()=>r({type:"clearFacet",facet:A})})}k.search&&j.push({k:"search",lib:"🔍 "+k.search,off:()=>r({type:"filters",patch:{search:""}})});const B=(A,q,F="",I=!1)=>t.jsxs("button",{type:"button","data-s":A,className:F,"aria-sort":a.sort.key===A?a.sort.dir===1?"ascending":"descending":"none",style:I?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:A}),children:[q,t.jsx("span",{className:"ar",children:a.sort.key===A&&a.sort.dir===1?"▴":"▾"})]},A),H=h.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const A=new Map;R.forEach(I=>{const W=I.engine||"?";A.has(W)||A.set(W,[]),A.get(W).push(I)});const q={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},F=la([...A.keys()],s);return[...A.entries()].sort((I,W)=>{const Y=q[I[0]]??10+F.indexOf(I[0]),se=q[W[0]]??10+F.indexOf(W[0]);return Y-se})},[R,i.pipe,a.groupBy,s]),Z=i.lockRowsAfter;let re=0;const G=(A,q)=>{let F=a.shown[q]||u;return A.length-F<=4&&(F=A.length),A.slice(0,F).map(Y=>{const se=Z!==null&&re>=Z;re++;const le=M(Y),K=le&&le!==Y.decryptHtml?{...Y,decryptHtml:le}:Y,X=a.dens!=="maxi"&&(a.dens==="deplie"||(g?g==="open":!!le)),he=b.has(Y.id)?!X:X;return a.dens==="maxi"?t.jsx(ll,{o:K,locked:se},Y.id):t.jsx(rl,{o:K,locked:se,open:he,onToggle:()=>m(Y.id)},Y.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:R.length})," ",_]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",j.map(A=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:q=>{q.stopPropagation(),A.off()},children:[A.lib,t.jsx("i",{children:"×"})]},A.k)),f==="ops"&&R.length>0&&" — "+n.edSplit(R.length-$,$)]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||f==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([A,q])=>t.jsxs("button",{type:"button","data-d":A,"aria-pressed":a.dens===A||A==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:A}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:q})]},A))}),(i.showFunnel||f==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":g==="open",onClick:()=>{v("open"),p(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":g==="closed",onClick:()=>{v("closed"),p(new Set)},children:n.foldAllLbl}),f==="ops"&&t.jsxs("button",{type:"button","aria-pressed":g===null,onClick:()=>{v(null),p(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||f==="ops")&&(()=>{var F;const A=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],q=((F=A.find(([I])=>I===w))==null?void 0:F[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":y,onClick:()=>C(I=>!I),children:[q,t.jsx("i",{children:"▾"})]}),y&&t.jsx("div",{className:"dolist",children:A.map(([I,W])=>t.jsx("button",{type:"button","aria-pressed":w===I,onClick:()=>{N(I),C(!1)},children:W},I))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:A=>r({type:"sort",key:A.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([A,q])=>t.jsx("option",{value:A,children:q},A))})]}),i.showChain&&L.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:L.map(A=>A.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(L.length):n.chainAll(L.length)]})]}),z>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(z)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),B("country",n.colCountry),B("name",n.colCompany),B("amount",n.colAmount,"h-amt",!0),B("stage",n.colStage,"h-stade"),B("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&B("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(f==="ops"?" opsl":"")+(R.length?"":" list-empty"),children:[H?H.map(([A,q])=>t.jsxs(h.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ke(A)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:$e(A,s)}),t.jsx("div",{className:"s",children:n.grpCount(q.filter(F=>!Ce(F)).length,q.length)})]})]}),G(q,A)]},A)):G(R,"pt"+a.ptab),x.loading&&!c.length&&t.jsx(cl,{}),!R.length&&!(x.loading&&!c.length)&&(i.pipe?t.jsx(dl,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const A=H||[["pt"+a.ptab,R]];let q=0,F=0;for(const[W,Y]of A){F+=Y.length;let se=a.shown[W]||u;Y.length-se<=4&&(se=Y.length),q+=Math.min(Y.length,se)}const I=F-q;return I<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>A.forEach(([W,Y])=>r({type:"more",group:W,by:Y.length,base:u})),children:[t.jsx("span",{className:"more-label",children:n.more(I,I)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(q,F)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}})]})}function Dn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ul(e,a){const r=bo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function fl(e,a){const n=[a.head.split("|").map(Dn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",ul(i,a.plabels),Wt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Dn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function ml(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const hl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Pe({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function xl({o:e,qa:a}){const{t:r,lang:n,fund:i}=P(),o=(e.cribleStatus||"").trim().toUpperCase()||(Wt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Ze(e),s=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Pe,{k:r.cdSector,v:e.sector}),t.jsx(Pe,{k:r.cdStage,v:e.stage}),t.jsx(Pe,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Pe,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Pe,{k:r.cdName,v:e.contactName}),t.jsx(Pe,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Pe,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Pe,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Pe,{k:r.cdAngle,v:e.angle}),t.jsx(Pe,{k:r.cdDetected,v:hl(e.date,n)})]}),d.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,x])=>x).map(([x,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:c})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function gl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=P(),[s,d]=h.useState({}),x=25,c=h.useMemo(()=>n.slice(0,x),[n]);h.useEffect(()=>{c.length&&vo(r,c.map(b=>b.name)).then(d)},[r,c]);const f=o.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),f&&typeof f.screened=="number"&&t.jsxs("p",{children:[u(f.screened)," ",e.funScreened(""),typeof f.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(f.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(f.screened/o.marketEstimate*100)," %"]})]})]}),c.map(b=>t.jsx(xl,{o:b,qa:s[b.name]},b.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const bl=50;function $a({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=P(),[o,l]=h.useState(null),[s,d]=h.useState(!1),[x,c]=h.useState(""),[f,u]=h.useState(0),[b,p]=h.useState(""),[g,v]=h.useState(!1),m=h.useRef(null);h.useEffect(()=>()=>{m.current&&window.clearInterval(m.current)},[]);const w=async y=>{d(!0),c("");const C=await a();if(d(!1),C.ok){l(C);return}if(C.busy){c(i.alertPreviewBusy);return}if(!y){c(i.alertPreviewFail);return}u(bl),m.current=window.setInterval(()=>{u(T=>T>1?T-1:(m.current&&window.clearInterval(m.current),w(!1),0))},1e3)},N=async()=>{if(n||g)return;v(!0),p("");const y=await r();v(!1),p(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||f>0,onClick:()=>{w(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||g,onClick:()=>{N()},children:g?"…":i.alertTest})]}),f>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(f)}),x&&t.jsx("p",{className:"mnote warn",children:x}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const bt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ne({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=P();return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function vl(){const{st:e}=P();switch(e.modal){case"chain":return t.jsx(wl,{});case"space":return t.jsx(kl,{});case"alert":return t.jsx(jl,{});case"queue":return t.jsx(Al,{});case"export":return t.jsx(zl,{});case"plug":return t.jsx(Rl,{});case"recharge":return t.jsx(Ml,{});case"cover":return t.jsx(Fl,{});case"dossier":return t.jsx(Ol,{});case"crit":return t.jsx(Pl,{});case"tuto":return t.jsx(Dl,{});case"rdv":return t.jsx(yl,{});case"memoalert":return t.jsx(Tl,{});default:return null}}function yl(){const{dispatch:e,fund:a}=P(),r=typeof document<"u"&&!!document.getElementById("rdv");return h.useEffect(()=>{r&&(e({type:"modal",modal:null}),mi())},[r,e]),r?null:t.jsx(ko,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function wl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s,caps:d,memoQueued:x,doAnalyse:c}=P(),f=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,p=u[b],g=b>=u.length;return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:g?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(g?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:g||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[ct(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(He(p.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:$e(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:jt(p.amountEur,i)})]}),ge(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Xe,{o:p,lg:!0})," ",t.jsx(Gt,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),f&&Ce(p)&&t.jsxs("div",{className:"vbox",style:{"--c":Ge(p)==="retenu"?"var(--brand)":Ge(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ge(p)==="retenu"?"✓ "+n.kept:Ge(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!g&&p&&d.pipe&&ke(p)===1&&!x.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!g&&p&&!(f&&Ce(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(g?{type:"modal",modal:null}:{type:"chainNext"}),children:g?n.closeBtn:n.skip})]})]})})}),document.body)}function kl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=P(),o=i==="client",l=h.useMemo(()=>o?r.filter(f=>Ce(f)):[],[r,o]),s=h.useMemo(()=>qa(l.filter(f=>Ge(f)==="retenu"),{key:"signal",dir:-1}),[l]),d=h.useMemo(()=>l.filter(f=>Ge(f)==="ecarte"),[l]),x=e.spaceTab==="retenu"?s:d,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ne,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(f=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof f.score=="number"&&f.score>0?f.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:f.name}),t.jsx("div",{className:"rr",children:f.reasoning||f.tagline||""})]})]},f.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function jl(){const{mode:e}=P();return e==="client"||e==="apercu"?t.jsx(Nl,{}):t.jsx(El,{})}function Nl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=P(),[o,l]=h.useState("d"),s=i!=="client";return t.jsxs(Ne,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(Sl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(Cl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(Nr,{})]})}function Sl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,d]=h.useState(!1),[x,c]=h.useState(0);h.useEffect(()=>{let p=!0;return d(!1),en(a).then(g=>{p&&(g?l(g):d(!0))}),()=>{p=!1}},[a,x]);const f=p=>{r||en(a,p).then(g=>{if(!g){i(e.actErr);return}l(g),g.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),b=p=>{const g=o.sections||e.alertSec.map(([v])=>v);f({sections:u(p)?g.filter(v=>v!==p):[...g,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,g])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>b(p)}),t.jsxs("span",{children:[g,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx($a,{label:e.alertPreview,readOnly:r,onPreview:()=>zo(a),onTest:()=>Ao(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Cl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,d]=h.useState(!1),[x,c]=h.useState(0);h.useEffect(()=>{let p=!0;return d(!1),tn(a).then(g=>{p&&(g?l(g):d(!0))}),()=>{p=!1}},[a,x]);const f=p=>{r||tn(a,p).then(g=>{if(!g){i(e.actErr);return}l(g),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,b=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>f({dow:Number(p.target.value)}),children:e.alertDow.map((p,g)=>t.jsx("option",{value:g,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx($a,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Lo(a),onTest:()=>To(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Nr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=P(),[l,s]=h.useState(o||""),[d,x]=h.useState(!1),[c,f]=h.useState(!1);h.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,b=h.useMemo(()=>n.filter(m=>ge(m)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(l)||c)){f(!0);try{await fetch(`${Aa}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{f(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(m=>$e(m,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(m=>ct(m,r)||m).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([m,w])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:m}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:w}})]},m))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:m=>s(m.target.value),onKeyDown:m=>{m.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function El(){const{t:e}=P();return t.jsx(Ne,{title:e.alertTitle,icon:"🔔",children:t.jsx(Nr,{})})}function Al(){var g,v,m;const{t:e,token:a,fund:r,mode:n,flash:i}=P(),[o,l]=h.useState(null),[s,d]=h.useState([]),[x,c]=h.useState(0),f=n==="client";h.useEffect(()=>{let w=!0;return(async()=>{const[N,y]=await Promise.all([Ta(r),Un(a)]);w&&(N&&l(N),d(y))})(),()=>{w=!1}},[a,r,x]);const u=(o==null?void 0:o.per_day)??2,b=((g=o==null?void 0:o.analyzed_today)==null?void 0:g.length)??0,p=(v=o==null?void 0:o.tomorrow)!=null&&v.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return t.jsxs(Ne,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(b,b+(((m=o==null?void 0:o.pool_order)==null?void 0:m.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(w=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:w.company}),t.jsxs("span",{className:"qd",children:[w.memo_type,typeof w.est_min=="number"?` · ~${w.est_min} min`:""]}),t.jsx("span",{className:"qt",children:w.status}),w.url&&t.jsx("a",{className:"qgo",href:w.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),f&&w.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Za(a,w.company,"retry").then(()=>c(N=>N+1))},children:e.queueRetry}),f&&w.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Za(a,w.company,"delete").then(()=>c(N=>N+1))},children:e.queueDelete})]},w.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[p.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),p.slice(0,10).map((w,N)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",N+1]}),t.jsx("b",{children:w.name}),typeof w.score=="number"&&t.jsx("span",{className:"qs2",children:w.score})]},w.name))]})]})}function zl(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=P(),s=`${bt}/cibles/list.csv?token=${a}`,d=`${bt}/cibles/list.json?token=${a}`,x=`${bt}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,f=v=>{var m;(m=navigator.clipboard)==null||m.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:x,href:x}],b=!i.lockActions&&n.length>0,p=()=>{ml(fl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([m])=>m===v)||["",""])[1]})),r(e.exportViewDone(n.length))},g=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ne,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:g,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:m,href:w})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>f(m),children:e.exportCopy}),w&&t.jsx("a",{className:"exb",href:w,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Tl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=P(),o=i!=="client",[l,s]=h.useState(null),[d,x]=h.useState(!1),[c,f]=h.useState(0),[u,b]=h.useState(!1);h.useEffect(()=>{let m=!0;return x(!1),Xa(a).then(w=>{m&&(w?s(w):x(!0))}),()=>{m=!1}},[a,c]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=m=>{if(o||!l)return;const w={enabled:m.enabled??!!l.enabled,email:m.email??(l.email||""),sections:m.sections??p()};b(!0),Xa(a,w).then(N=>{if(b(!1),!N){n(e.memoAlertErr);return}s(N),r(e.memoAlertSaved)})};if(d)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(m=>m+1),children:e.retry})]})});if(!l)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=p();return t.jsxs(Ne,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Ll,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:m=>g({email:m})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([m,w])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[m],disabled:o||u,onChange:()=>g({sections:{...v,[m]:!v[m]}})}),t.jsx("span",{children:w})]},m))}),t.jsx($a,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>wo(a,v),onTest:()=>yo(a,v)})]})}function Ll({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=h.useState(e);h.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:x=>l(x.target.value),onKeyDown:x=>{x.key==="Enter"&&s&&d&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!d,onClick:()=>i(o.trim()),children:n})]})]})}function Rl(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=P(),[o,l]=h.useState(null),[s,d]=h.useState(!1),[x,c]=h.useState(null),[f,u]=h.useState(""),[b,p]=h.useState(0);h.useEffect(()=>{let m=!0;return d(!1),ca(a).then(w=>{m&&(w?l({configured:w.configured,url_hint:w.url_hint}):d(!0))}),No(a).then(w=>{m&&c(w)}),()=>{m=!1}},[a,b]);const g=(m,w)=>{i&&ca(a,m).then(N=>{if(!N||N.ok===!1){n(e.actErr);return}m.test&&N.sent===!1?n(e.plugTestThrottled):r(w),p(y=>y+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(Ne,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(m=>m+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:f,disabled:!i,onChange:m=>u(m.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!f.trim(),onClick:()=>g({url:f.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(ql,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var m;(m=navigator.clipboard)==null||m.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function ql(){const{t:e,token:a,lang:r}=P(),[n,i]=h.useState("valides"),[o,l]=h.useState(!1),[s,d]=h.useState(null),[x,c]=h.useState(null),[f,u]=h.useState(!1),[b,p]=h.useState(!1),[g,v]=h.useState(null),[m,w]=h.useState(null),[N,y]=h.useState(null),C=`atl2:bulk:${a}:${n}`;h.useEffect(()=>{ca(a).then($=>{w($&&$.configured?$.url_hint||"webhook":null)})},[a]),h.useEffect(()=>{d(null),c(null),u(!1),v(null);try{const $=JSON.parse(localStorage.getItem(C)||"null");y($&&Date.now()-Date.parse($.t)<24*3600*1e3?$:null)}catch{y(null)}},[C]);const T=async()=>{l(!0),u(!1),v(null);const $=await Co(a,n);d($),c($.ok?n:null),l(!1)},E=h.useRef(!1),M=async()=>{if(E.current)return;E.current=!0,p(!0);const $=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await Eo(a,n,"webhook",void 0,$)}finally{E.current=!1}if(p(!1),u(!1),v(_),_.ok&&(_.pushed||0)>0){const k={t:new Date().toISOString(),n:_.pushed||0};y(k);try{localStorage.setItem(C,JSON.stringify(k))}catch{}}},R=s!=null&&s.ok&&s.ready||0,z=!!(s!=null&&s.ok)&&x===n&&R>0&&!!m&&!N,L=N?new Date(N.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:$=>i($.target.value),children:e.plugBulkTabs.map(([$,_])=>t.jsx("option",{value:$,children:_},$))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{T()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),N&&t.jsx("p",{className:"mnote",children:e.bulkLocked(L,N.n)}),!N&&!!(s!=null&&s.ok)&&!m&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!N&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),z&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),z&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(R,m||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{M()},children:b?e.bulkSending:e.bulkConfirm(m||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),g&&(g.ok?g.replayed?t.jsx("p",{className:"mnote",children:g.pending?e.bulkPending:e.bulkReplayed}):(g.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:g.error||e.actErr}))]})}function Ml(){const{t:e,data:a,lang:r}=P(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const x=await(await fetch(`${Aa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(Ne,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Ol(){const{t:e}=P();return t.jsx(Ne,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(gl,{})})}function Fl(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:s}=P(),[d,x]=h.useState(null),[c,f]=h.useState(!1);h.useEffect(()=>{let E=!0;if(o)return Ta(o).then(M=>{E&&M&&typeof M.per_day=="number"&&x(M.per_day)}),()=>{E=!1}},[o]);const u=r.stats,b=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(E=>E.kind==="target"&&Ce(E)).length,p=r.marketEstimate||0,g=p>0?Math.min(100,Math.round(b/p*100)):null,v=(u==null?void 0:u.window_days)||30,m=b>0?b/v:0,w=p>0?Math.max(0,p-b):0,y=p>0&&m>0&&b>=100?Math.round(w/m):null,C=E=>Math.round(E).toLocaleString(a==="en"?"en-US":"fr-FR"),T=E=>{c||!l||(f(!0),So(i,E).then(M=>{if(f(!1),M===null){s(e.actErr);return}x(M),s(e.alertSaved)}))};return t.jsxs(Ne,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(b))}),p>0&&t.jsx("span",{children:e.covOf(C(p))})]}),g!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:g+"%"}}),t.jsxs("em",{children:[g," %"]})]}),y!==null&&t.jsx("p",{className:"mnote",children:e.covEta(y)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),m>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(m))}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(u.shown)})," ",e.covShown]})]}),l&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(E=>t.jsx("button",{type:"button",className:d===E?"on":"",disabled:c,onClick:()=>T(E),children:E===0?"⏸":E},E))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Pl(){var m,w,N;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:s}=P(),d=n==="client",x=h.useMemo(()=>{const y=new Set;return a.forEach(C=>{C.angle&&y.add(C.angle)}),[...y]},[a]),[c,f]=h.useState(""),[u,b]=h.useState(""),[p,g]=h.useState(!1),v=async()=>{const y=c.trim();if(!(!y||p||!d)){g(!0),b("");try{const T=await(await fetch(`${bt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&b(String(T.reply)),T.job_id){b(e.critChatRunning);const E=async()=>{const M=await fetch(`${bt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(R=>R.json()).catch(()=>null);if(M&&M.done){b(String(M.reply||M.clarification||M.summary||"✓")),g(!1),M.applied&&i(e.alertSaved);return}setTimeout(()=>{E()},8e3)};setTimeout(()=>{E()},8e3),f("");return}f("")}finally{u.startsWith("⏳")||g(!1)}}};return t.jsxs(Ne,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((m=o.points)!=null&&m.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((w=o==null?void 0:o.angles)!=null&&w.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var C,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((C=y.look)!=null&&C.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(E=>t.jsx("li",{children:E},E))})]}),!!((T=y.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(E=>t.jsx("li",{children:E},E))})]})]})]},y.title)})]}),!!((N=o==null?void 0:o.gate)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:x.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!d||p,onChange:y=>f(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!d||p||!c.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(jo,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(kr[y]||"v-cons"),children:y}),t.jsx("span",{children:C})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",C]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Dl(){const{t:e,dispatch:a,startTour:r}=P(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ne,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const Sr="atl2:mapfold",Il=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Sr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Cr=h.createContext(null),P=()=>{const e=h.useContext(Cr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Xe({o:e,lg:a}){const{lang:r}=P(),n=ge(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:an(n,r),children:[n.emoji," ",an(n,r)]}):null}function Gt({o:e,src:a}){const{lang:r,t:n}=P(),i=ge(e);if(!i)return null;const o=Fo(i),l=Po(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Wn(i,r))+" · "+n.win7(Yn(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,d)=>t.jsx("i",{className:d<o?"on":""},d))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Er({o:e}){const{lang:a}=P(),r=Oo(e.cc),n=e.cc?ct(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const In="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",$l=!1,Ar=e=>`atl2:tour:${e||"anon"}`;function Bl(e){try{return localStorage.getItem(Ar(e))==="1"}catch{return!0}}function $n(e){try{localStorage.setItem(Ar(e),"1")}catch{}}function _l(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Gl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var _a;const{lang:l}=Ro(),s=Wo[l],d=ri(e,l,a),[x,c]=h.useReducer(ii,void 0,()=>oi((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Il(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),f=h.useRef(!0);h.useEffect(()=>{if(f.current){f.current=!1;return}if(!e)try{localStorage.setItem(Sr,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e]);const u=h.useRef(o);u.current=o,h.useEffect(()=>{var S;(S=u.current)==null||S.call(u,x.filters)},[x.filters]);const[b,p]=h.useState(null),[g,v]=h.useState(null),[m,w]=h.useState({kept:0,dropped:0}),[N,y]=h.useState(!1),[C,T]=h.useState(""),[E,M]=h.useState(!1),[R,z]=h.useState(null),[L,$]=h.useState(!1),[_,k]=h.useState(!1),[,j]=h.useState(0),O=()=>j(S=>S+1),B=h.useRef([]),H=h.useRef(new Set),Z=h.useRef(new Set),re=h.useRef(new Map),G=h.useRef(null),{mode:J}=d,A=h.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),q=A.pipe,F=d.session.token||"",I=J==="client"&&!e;h.useEffect(()=>{if(document.querySelector(`link[href="${In}"]`))return;const S=document.createElement("link");S.rel="stylesheet",S.href=In,document.head.appendChild(S)},[]);const W=(S,U=!1)=>{T(S),M(U),G.current&&clearTimeout(G.current),G.current=setTimeout(()=>T(""),U?4200:2400)},Y=S=>W(S,!0),se=h.useMemo(()=>{const S=new Map;return d.dossiers.forEach(U=>{U.id&&S.set(U.id,U)}),S},[d.dossiers]),le=h.useMemo(()=>d.dossiers.filter(S=>Qn(S,x,q)),[d.dossiers,x,q]),K=h.useRef(!1);h.useEffect(()=>{if(K.current||e||d.loading||!d.dossiers.length)return;if(!A.showFunnel||Bl(d.session.token||"")){K.current=!0;return}K.current=!0;const S=window.setTimeout(()=>{$n(d.session.token||""),$(!0)},700);return()=>window.clearTimeout(S)},[e,d.loading,d.dossiers.length,A.showFunnel,d.session.token]);const X=h.useMemo(()=>d.dossiers.filter(S=>si(S,x,q,d.favIds)),[d.dossiers,x,q,d.favIds]),he=h.useMemo(()=>qo(le,d.favIds),[le,d.favIds]),ee=h.useMemo(()=>{const S=Zn(d.dossiers);return S?He(S)===0?s.tourToday:er(S,l):s.tourNoRun},[d.dossiers,s,l]),ce=h.useMemo(()=>d.dossiers.some(S=>!!S.memoUrl||!!S.summary||ot(S)),[d.dossiers]),[ae,Oe]=h.useState(!1);h.useEffect(()=>{if(d.loading){Oe(!1);return}if(d.dossiers.length>0||d.error){Oe(!0);return}const S=window.setTimeout(()=>Oe(!0),6e3);return()=>window.clearTimeout(S)},[d.loading,d.dossiers.length,d.error]);const xe=(d.marketEstimate||0)>0||typeof((_a=d.stats)==null?void 0:_a.screened)=="number"&&d.stats.screened>0,ve=h.useMemo(()=>[1,0,2,4,5,3].find(S=>(he[S]||0)>0)??0,[he]),qe=La.find(S=>S.key===x.continent),tt=x.continent==="monde"?s.contWorld:(l==="fr"?qe==null?void 0:qe.fr:qe==null?void 0:qe.en)||"";h.useEffect(()=>{const S=U=>{var fe;const V=(((fe=U.detail)==null?void 0:fe.name)||"").trim();V&&Ee(null,V)};return window.addEventListener("ppmap:evaluate",S),()=>window.removeEventListener("ppmap:evaluate",S)}),h.useEffect(()=>{const S=fe=>{const Me=String(fe||"").trim();Me&&c({type:"filters",patch:{sector:[Me]}})},U=fe=>{var Me;return S((Me=fe.detail)==null?void 0:Me.sector)},V=fe=>{fe.data&&fe.data.type==="pp-filter"&&S(fe.data.sector)};return window.addEventListener("ppmap:filter",U),window.addEventListener("message",V),()=>{window.removeEventListener("ppmap:filter",U),window.removeEventListener("message",V)}},[]);const Ee=(S,U)=>{const V=((S==null?void 0:S.name)||U||"").trim();if(!I){v({kicker:V});return}!V||N||(y(!0),(async()=>{try{let fe=V;const Me=((S==null?void 0:S.website)||(S==null?void 0:S.domain)||"").trim();if(Me)fe=Me;else try{const me=await Do(V);if(me!=null&&me.website)fe=me.website;else if(((me==null?void 0:me.candidates)||[]).length===1)fe=me.candidates[0].url;else if(((me==null?void 0:me.candidates)||[]).length>1){B.current=[{name:V,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(me.candidates||[]).slice(0,5)},...B.current].slice(0,8),O();return}}catch{}const Fe=await Hn(F,fe,"atelier2"),Or={name:Fe.company||V,verdict:Fe.verdict,reason:Fe.reason||"",remaining:Fe.remaining??null};B.current=[Or,...B.current].slice(0,8),Fe.verdict==="kept"&&w(me=>({...me,kept:me.kept+1})),Fe.verdict==="ruled_out"&&w(me=>({...me,dropped:me.dropped+1}));const pt=S||d.dossiers.find(me=>(me.name||"").toLowerCase()===V.toLowerCase());pt&&(Fe.verdict==="kept"?pt.verdict=pt.verdict||"MATCH":Fe.verdict==="ruled_out"&&(pt.verdict="NO MATCH"),Fe.reason&&(pt.reasoning=Fe.reason)),O()}finally{y(!1)}})())},Be=S=>{if(!I){v({kicker:S.name});return}H.current.add(S.id),ut(F,"fast_request",S.name||"",""),W(s.memoInstantSent(S.name)),O()},dt=S=>re.current.get(S.id)??d.thumbs.get((S.name||"").trim().toLowerCase()),Nt=(S,U)=>c({type:"undoPush",entry:{id:S.id,name:S.name,prevCeoStatus:U}}),at=async(S,U,V)=>{const fe=S.ceoStatus||"";S.ceoStatus=U,O();const Me=await Xt(F,{status:U,airtable_id:S.airtableId,check_id:S.checkId,company:S.name,...(V==null?void 0:V.note)!==void 0?{note:V.note}:{},...V!=null&&V.via?{via:V.via}:{}});return Me.ok?Me.skipped?(S.ceoStatus=fe,O(),Y(s.actNotPersisted),!1):((V==null?void 0:V.undo)!==!1&&Nt(S,fe),V!=null&&V.msg&&W(V.msg),(U==="Validé"||U==="Écarté")&&!S.ceoNote&&(V==null?void 0:V.note)===void 0&&z({o:S,yes:U==="Validé"}),!0):(S.ceoStatus=fe,O(),Y(s.actErr),!1)},D=async(S,U)=>{const V=await Xt(F,{status:S.ceoStatus||"Retenu",airtable_id:S.airtableId,check_id:S.checkId,company:S.name,note:U,via:"note"});return!V.ok||V.skipped?(Y(V.skipped?s.actNotPersisted:s.actErr),!1):(S.ceoNote=U,O(),!0)},te=h.useRef(new Map),oe=S=>te.current.has(S.id)?te.current.get(S.id):d.stages.get((S.name||"").trim().toLowerCase()),ye=(S,U)=>{te.current.set(S.id,U),O()},Ve=(S,U)=>{I&&at(S,U?"Validé":"Écarté",{msg:U?s.decidedYes(S.name):s.decidedNo(S.name)})},je=S=>{I&&at(S,"À trancher",{msg:s.promoted(S.name)})},de=S=>{I&&(async()=>{const U=S.ceoStatus||"";S.ceoStatus="Retenu",O();const V=await Xt(F,{status:"Retenu",check_id:S.checkId,company:S.name});if(!V.ok||V.skipped){S.ceoStatus=U,O(),Y(V.skipped?s.actNotPersisted:s.actErr);return}Nt(S,U),W(s.repeched(S.name))})()},Ae=()=>{const S=x.undo[x.undo.length-1];if(!S){W(s.undoNone);return}const U=se.get(S.id);if(!U){c({type:"undoPop"}),W(s.undoNone);return}let V=S.prevCeoStatus;if(!V)if((U.verdict||"").toUpperCase().includes("CALL"))V="À trancher";else{W(s.undoLockedTitle);return}(async()=>await at(U,V,{undo:!1})&&(c({type:"undoPop"}),U.ceoStatus=S.prevCeoStatus,O(),W(s.undoDone(U.name))))()},Kt=S=>{I&&(Z.current.add(S.id),O(),(async()=>{const U=await Io(F,S.name,"email");if(!U||U.ok===!1){Z.current.delete(S.id),O(),Y(s.actErr);return}ut(F,"approach",S.name||"",""),W(s.actApproachSent)})())},St=(S,U)=>{I&&(async()=>{if(!(await ut(F,U?"yes":"no",S.name||"","")).ok){Y(s.actErr);return}re.current.set(S.id,U?"yes":"no"),O(),W(U?s.thumbUpDone:s.thumbDnDone)})()},zr=S=>{!I||!ot(S)||(ut(F,"detailed_request",S.name||"",""),W(s.memoDeepSent(S.name)))},Tr=S=>{const U=new Set(d.favIds),V=U.has(S.id);V?U.delete(S.id):U.add(S.id),d.setFavIds(U),I&&$o(F,{id:S.id,co:S.name},V)},Lr=()=>{!I||_||window.confirm(s.identSyncConfirm)&&(k(!0),(async()=>{const S=await Bo(F);k(!1),S?W(s.identSyncDone):Y(s.actErr)})())},Ba=/proplace/i.test(d.fund||""),Rr=S=>{!I||!Ba||(ut(F,"onboard_request",S.name||"",""),W(s.onboardSent(S.name)))},qr={st:x,dispatch:c,t:s,lang:l,mode:J,caps:A,pipe:q,token:F,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:de,thumbOf:dt,canWrite:I,commitStatus:at,saveNote:D,stageOf:oe,setStage:ye,flashErr:Y,startTour:()=>$(!0),dossiers:d.dossiers,scopedAll:le,scoped:X,counts:he,byId:se,contName:tt,favIds:d.favIds,toggleFav:Tr,askEvaluate:Ee,doAnalyse:Be,doDecide:Ve,doPromote:je,doApproach:Kt,doThumb:St,doDeep:zr,doUndo:Ae,doSync:Lr,doOnboard:Rr,outbound:Ba,memoQueued:H.current,approachDone:Z.current,sessTally:m,evalCards:B.current,evalBusy:N,markRow:p,markedId:b,flash:W};h.useEffect(()=>{const S=U=>{U.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",S),()=>window.removeEventListener("keydown",S)},[]);const Mr=S=>F?t.jsx(Vs,{token:F,children:S}):t.jsx(t.Fragment,{children:S});return t.jsx(Cr.Provider,{value:qr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Ko}),A.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:Xn,children:Ma}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Pt}`,children:Pt})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),Mr(t.jsxs("div",{className:"app"+(q?" pipe":"")+(F?" has-thesis":""),children:[A.showTicker&&t.jsx(be,{name:"live",children:t.jsxs("div",{className:"live-stack"+(F?" live-stack--cibles":""),children:[t.jsx(ui,{}),!!F&&t.jsx(Hs,{})]})}),A.showIdent&&t.jsx(be,{name:"identite",children:t.jsx(Ai,{})}),!!F&&t.jsx(be,{name:"lead",children:t.jsx(Us,{})}),!!F&&t.jsx(be,{name:"brief",children:t.jsx(Ws,{})}),$l,A.showMorning&&t.jsx(be,{name:"matin",children:t.jsx(Ei,{})}),t.jsx(be,{name:"fraicheur",children:t.jsx(vi,{})}),t.jsx(be,{name:"mesure",children:t.jsx(yi,{})}),A.showFunnel&&t.jsx(be,{name:"entonnoir",children:t.jsx(Ul,{})}),A.showFunnel&&t.jsx(be,{name:"tunnel",children:t.jsx(Ti,{})}),A.showFunnel&&t.jsx(be,{name:"tuto",children:t.jsx(Ri,{})}),t.jsx(be,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Vl,{}),t.jsxs("div",{className:"stage"+(x.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(zs,{}),t.jsx(Ls,{})]})]})}),A.showDemand&&t.jsx(be,{name:"evaluation",children:t.jsx(Ps,{})}),A.showDemand&&x.memoConsole&&t.jsx(be,{name:"console",children:t.jsx(Is,{})}),t.jsx(be,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(pl,{})}),d.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:s.retry})]})]})),x.popupId&&t.jsx(be,{name:"fiche",children:t.jsx(Ks,{})}),t.jsx(be,{name:"modales",children:t.jsx(vl,{})}),t.jsx(xi,{}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(Ni,{placeholder:R.yes?s.whyYesPh:s.whyNoPh,onDone:S=>{const U=R.o;z(null),S&&D(U,S).then(V=>{V&&W(s.csNoteSaved)})}})]}),L&&ae&&t.jsx(Ci,{steps:_l(s,ee,ce,ve,xe),onClose:()=>{$(!1),$n(F)}}),C&&t.jsx("div",{className:"flash on"+(E?" err":""),children:C}),g&&t.jsx(Mo,{variant:"acquirer",initialCompany:Bn().co,initialWebsite:Bn().site,onClose:()=>v(null)})]})})}function Ul(){const{t:e}=P(),[a,r]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Vl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:i,t:o}=P(),l=h.useMemo(()=>{const s={};return e.forEach(d=>{Ra(d,a.filters,n)&&(s.monde=(s.monde||0)+1,d.continent&&(s[d.continent]=(s[d.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[_o.map(s=>{const d=La.find(c=>c.key===s),x=s==="monde"?o.contWorld:i==="fr"?d.fr:d.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[x,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Bn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Hl(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Er as FlagCell,Xe as SigBadge,Gt as SigWin,Gl as default,Hl as fmtShort,P as useV2};
