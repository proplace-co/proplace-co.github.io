...
`;class G extends p.Component{constructor(){super(...arguments);it(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(n,r){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,n,r.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const kr=8;function jr(){const{t,lang:a,token:n,dossiers:r,caps:i,markRow:o,dispatch:l}=A(),[d,c]=p.useState(!1),[f,b]=p.useState(!1),[s,v]=p.useState(!1),h=n||"home",{names:x,verdicts:g}=p.useMemo(()=>{const w=[],k={};return r.forEach(N=>{N.kind!=="target"||!N.name||(w.push(N.name),k[N.name]=va(N)||"")}),{names:w,verdicts:k}},[r]),m=p.useMemo(()=>x.length?ya(h,x,g,a):null,[h,x.length]);if(!i.pipe||d||!m||m.firstVisit||!m.added.length&&!m.gone.length)return null;const u=f?m.added:m.added.slice(0,kr),y=m.added.length-u.length,C=w=>{const k=r.find(N=>N.name===w);k&&(o(k.id),l({type:"popup",id:k.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(m.added.length,m.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{c(!0),wa(h,x,g,m.fp,a)},children:"×"})]}),!!m.added.length&&e.jsxs("div",{className:"since-c",children:[u.map(w=>e.jsx("button",{type:"button",onClick:()=>C(w),children:w},w)),y>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>b(!0),children:t.sinceMore(y)})]}),!!m.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>v(w=>!w),children:t.sinceOut(m.gone.length)}),s&&m.gone.slice(0,20).map(w=>e.jsx("span",{className:"gone",children:w},w))]})]})}const _e=600,xe=62,wt="atl2:fstats";function Nr(){const{t,lang:a,data:n,caps:r,st:i,dispatch:o}=A(),[l,d]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(wt)==="on"}catch{return!1}}),c=n.stats,f=p.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),b=p.useMemo(()=>{if(c!=null&&c.since)return c.since;const y=new Date;return y.setDate(y.getDate()-((c==null?void 0:c.window_days)||30)),y.toISOString().slice(0,10)},[c==null?void 0:c.since,c==null?void 0:c.window_days]);if(!r.showFunnel||!c||typeof c.screened!="number")return null;const s=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,v=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),h=f.reduce((y,C)=>Math.max(y,C.s||0),0),x=f.length?_e/f.length:0,g=Math.max(4,x-4),m=f.length>=5&&h>0,u=[[c.screened,t.funScreened(s(b)),c.screened_today],...typeof c.kept=="number"?[[c.kept,t.funKept,c.kept_today]]:[],...typeof c.analyzed=="number"?[[c.analyzed,t.funAnalyzed,c.analyzed_today]]:[],...typeof c.shown=="number"?[[c.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(l?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[u.map(([y,C,w],k)=>e.jsxs("span",{className:"fst-t",children:[k>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:v(y)}),e.jsx("i",{children:C}),l&&typeof w=="number"&&w>0&&e.jsx("em",{children:t.funToday(w)})]},C)),m&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?t.fstatsHide:t.fstatsShow,onClick:()=>{const y=!l;d(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(wt,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&m&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${_e} ${xe}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[f.map((y,C)=>{const w=(y.s||0)/h*(xe-4),k=(y.m||0)/h*(xe-4),N=C*x+(x-g)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${s(y.d)} — ${y.s} ${t.actScreened} · ${y.m} ${t.actKept}`}),e.jsx("rect",{x:N,y:xe-2-w,width:g,height:w,fill:"#cfe0d6"}),e.jsx("rect",{x:N,y:xe-2-k,width:g,height:k,fill:"#185c38"})]},y.d)}),e.jsx("line",{x1:0,y1:xe-1.5,x2:_e,y2:xe-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:s(f[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const Sr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Cr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:i}=A(),[o,l]=p.useState(""),[d,c]=p.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const f=(t.ceoStatus||"").trim(),b=(Le(t)||"").startsWith("CALL")&&te(t)===3,s=te(t)>=2,v=async x=>{if(o||x==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(x);const g=await i(t,x);l(""),g&&(c(!0),setTimeout(()=>c(!1),2200))},h=b?[["Validé",a.csYes],["Écarté",a.csNo]]:Sr.filter(([x])=>!(s&&x==="Retenu")).map(([x,g])=>[x,a[g]]);return e.jsxs("div",{className:"csp",onClick:x=>x.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([x,g])=>e.jsx("button",{type:"button",className:"csb"+(f===x?" on":"")+(o===x?" busy":""),disabled:!!o,onClick:()=>{v(x)},children:g},x)),d&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(zr,{o:t})]})}function zr({o:t}){const{t:a,saveNote:n,flash:r}=A(),[i,o]=p.useState(t.ceoNote||""),[l,d]=p.useState(!1),[c,f]=p.useState(!1),b=i.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(l||!b)return;d(!0);const v=await n(t,i.trim());d(!1),v&&(f(!0),setTimeout(()=>f(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:v=>o(v.target.value),onKeyDown:v=>{v.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:l||!b,onClick:()=>{s()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Er({placeholder:t,onDone:a}){const{t:n}=A(),[r,i]=p.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Tr({o:t}){var m;const{t:a,token:n,caps:r,canWrite:i,stageOf:o,setStage:l,flashErr:d}=A(),[c,f]=p.useState(!1);if(!r.pipe||!i||r.lockActions||te(t)!==4)return null;const b=o(t),s=(b==null?void 0:b.stage)||"todo",v=async u=>{if(c||u===s)return;f(!0);const y=b;l(t,{stage:u,stamps:(b==null?void 0:b.stamps)||{}});const C=Math.max(Date.now(),kt+=1);kt=C;const w=await ka(n,{company:t.name||"",stage:u,cts:C,deal_id:t.airtableId,check_id:t.checkId});f(!1),!w.stale&&(w.ok||(l(t,y),d(a.actErr)))},h=(m=b==null?void 0:b.stamps)==null?void 0:m.sent,x=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,g=s==="sent"&&h&&x>=4;return e.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,y])=>e.jsx("button",{type:"button",className:"stgb"+(s===u?" on":""),disabled:c,onClick:()=>{v(u)},children:y},u)),g&&e.jsx("span",{className:"stgj4",children:a.j4Badge(x)})]})}let kt=0;const Me=8,qe=340;function jt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function Ar({steps:t,onClose:a}){const{t:n,dispatch:r,counts:i,scoped:o,byId:l,st:d}=A(),[c,f]=p.useState(0),[b,s]=p.useState(null),[v,h]=p.useState([]),x=p.useRef(!1);p.useEffect(()=>{x.current||(x.current=!0,h(t.filter(k=>!!document.querySelector(k.need||k.sel))))},[t]);const g=v[c],m=c>=v.length;p.useEffect(()=>{g&&(g.ptab!==void 0&&d.ptab!==g.ptab&&r({type:"ptab",tab:g.ptab}),g.dens&&d.dens!==g.dens&&r({type:"dens",dens:g.dens}))},[c,g]);const u=p.useCallback(()=>{if(!g){s(null);return}const k=document.querySelector(g.sel);if(!k){s(null);return}k.scrollIntoView({block:"nearest",behavior:"smooth"}),s(k.getBoundingClientRect())},[g]);p.useLayoutEffect(()=>{u();const k=window.setTimeout(u,260),N=()=>u();return window.addEventListener("scroll",N,!0),window.addEventListener("resize",N),()=>{window.clearTimeout(k),window.removeEventListener("scroll",N,!0),window.removeEventListener("resize",N)}},[u]);const y=p.useRef(a);if(y.current=a,p.useEffect(()=>{const k=N=>{N.key==="Escape"?(N.preventDefault(),N.stopPropagation(),y.current()):N.key==="ArrowRight"?f(z=>z+1):N.key==="ArrowLeft"&&f(z=>Math.max(0,z-1))};return document.addEventListener("keydown",k,!0),()=>document.removeEventListener("keydown",k,!0)},[]),!v.length)return null;let C=null;if(m){const k=i[3]||0,N=o.find(z=>z.memoUrl)||[...l.values()].find(z=>z.memoUrl);k>0?C={title:k===1?n.ahaATitle1:n.ahaATitleN(k),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:N?C={title:n.ahaBTitle,body:n.ahaBBody(N.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:N.id}),a()}}:C={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:qe};if(!m&&b){const k=b.bottom+14,z=window.innerHeight-k>190?k:Math.max(12,b.top-200);w={left:Math.min(Math.max(12,b.left+b.width/2-qe/2),window.innerWidth-qe-12),top:z,width:qe}}return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!m&&b&&e.jsx("div",{className:"tour-hole",style:{left:b.left-Me,top:b.top-Me,width:b.width+Me*2,height:b.height+Me*2}}),(m||!b)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(m?" fin":""),style:w,children:[m&&C?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:C.title}),e.jsx("p",{children:e.jsx(jt,{text:C.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>f(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:C.go,children:C.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(c+1,v.length)}),e.jsx("h3",{children:g==null?void 0:g.title}),e.jsx("p",{children:e.jsx(jt,{text:(g==null?void 0:g.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:c===0,onClick:()=>f(k=>Math.max(0,k-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>f(k=>k+1),children:c===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Lr(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:i}=A(),o=p.useMemo(()=>t.filter(s=>we(s.date)===0&&s.kind==="target"),[t]),l=p.useMemo(()=>o.filter(s=>a?te(s)===0:!Z(s)),[o,a]),d=o.length-l.length,c=o.length?Math.min(100,d/o.length*100):100;let f;a?f=n.morningThesis(o.length,d,l.length):o.length?d===0?f=n.goalSourced(o.length):d>=o.length?f=n.goalCleared:f=n.goalDone(d,o.length):f=n.goalSourced(0);const b=()=>{a?(i({type:"ptab",tab:0}),i({type:"filters",patch:{win:"1"}})):i({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:f}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:c+"%"}})}),l.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:b,children:a?n.morningEval(l.length):r.pileMode?n.goalContinue(l.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Or(){var D,M;const{t,lang:a,st:n,dispatch:r,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:f,startTour:b}=A(),[s,v]=p.useState(null),[h,x]=p.useState([]),g=c==="client";p.useEffect(()=>{if(!i||!o)return;let E=!0;return(async()=>{const[P,L]=await Promise.all([Qe(o),Rt(i)]);E&&(P&&v(P),x(L))})(),()=>{E=!1}},[i,o]);const m=(s==null?void 0:s.per_day)??null,u=((D=s==null?void 0:s.pool_order)==null?void 0:D.length)??0,y=h.filter(E=>E.status==="running").length,C=p.useMemo(()=>d.filter(E=>E.kind==="target"&&Z(E)).length,[d]),w=l.marketEstimate,k=typeof((M=l.stats)==null?void 0:M.screened)=="number"?l.stats.screened:C,N=w&&w>0?Math.min(100,Math.round(k/w*100)):null,z=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),S=(o||"P").split(/\s+/).map(E=>E[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const E=Date.parse(l.generatedAt||"");if(Number.isNaN(E))return"";const P=new Date(E),L=I=>String(I).padStart(2,"0");return`${L(P.getDate())}/${L(P.getMonth()+1)} à ${L(P.getHours())}:${L(P.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:S}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),T&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(T)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:b,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[N===null&&k>0&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsx("span",{className:"ev",children:e.jsx("b",{children:z(k)})})]}),N!==null&&w&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:N+"%"}})}),e.jsxs("b",{children:[N," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(k,w)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>r({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),m!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"q",children:m})," ",t.identPerDay]}),e.jsx("span",{className:"edv"})]}),m===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),y>0&&e.jsxs("span",{className:"ev",children:["⏳ ",y]}),e.jsx("span",{className:"ego",children:t.identPending(u)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:E=>{E.stopPropagation(),r({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!g,onClick:f,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:n.filters.search,onChange:E=>r({type:"filters",patch:{search:E.target.value}})})]})]})]})}function Rr(){const{t,counts:a,dispatch:n}=A();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,i],o)=>{const l=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(l?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:i}),l&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Fr=["--p0","--p1","--p2","--p3","--p4"];function Dr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:i}=A(),o=p.useRef({});p.useEffect(()=>{o.current={...n}},[n]);const l=f=>{const b=o.current[f],s=b!==void 0?n[f]-b:0;return e.jsxs("button",{type:"button",className:"step"+(f===3&&n[3]>0?" wait":""),style:{"--c":`var(${Fr[f]})`,"--tc":f<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===f,title:r.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[e.jsxs("span",{className:"l",children:[r.plabels[f].toUpperCase(),f===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[f],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},f)},d=(f,b,s)=>e.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":f===5?"var(--p5)":f===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===f,title:r.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[f]})]},f),c=(f,b,s,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:b,disabled:v,onClick:s,children:f},b);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),e.jsxs("div",{className:"offtrack",children:[d(5,!1,r.plabels[5]),d(7,!0,r.plabels[7]),d(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[c("↩",r.toolUndo,i,t.undo.length===0),c("↺",r.toolReset,()=>{a({type:"reset"})}),c("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),c("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),c("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Mr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function qr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:i,doAnalyse:o,mode:l}=A(),d=p.useRef(null),[c,f]=p.useState(60);p.useEffect(()=>{let h=0;const x=()=>{var C;const g=d.current;if(!g)return;const m=(C=g.parentElement)==null?void 0:C.querySelector('.funnel [aria-selected="true"]');if(!m)return;const u=m.getBoundingClientRect(),y=g.getBoundingClientRect();f(Math.max(20,Math.min(u.left+u.width/2-y.left,y.width-30)))};return h=requestAnimationFrame(x),window.addEventListener("resize",x),()=>{cancelAnimationFrame(h),window.removeEventListener("resize",x)}},[t.ptab]);const b=t.ptab;let s=n.tuto[b].p;if(b===3){const h=r.filter(m=>m.kind==="target"&&te(m)===3),x=h.filter(m=>Ye(m)==="auto").length,g=h.filter(m=>Ye(m)==="cd").length;s=n.tutoPending(x,g,h.length)}const v=(()=>{if(l!=="client")return null;if(b===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(h=>h.id)})};if(b===1){const h=r.filter(x=>x.kind==="target"&&te(x)===1&&!i.has(x.id)).slice(0,10);if(h.length)return{label:n.tuto[1].a,run:()=>h.forEach(x=>o(x))}}return null})();return e.jsxs("div",{ref:d,className:"tuto mini",style:{"--bg":Mr[b],"--ax":c+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[b].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const Nt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function St(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Pr(t,a){const[n,r]=p.useState(1);return p.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const c=(f=t.current)==null?void 0:f.getScreenCTM();c&&c.a>0?r(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return t.current&&d.observe(t.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[t,a]),n}function Ir(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:i,markedId:o,byId:l,lang:d,t:c}=A(),f=p.useRef(null),b=p.useRef(null),s=Je.find(S=>S.key===t.continent),v=Pr(f,t.continent+":"+t.mapFolded),[h,x]=p.useState(new Map),[g,m]=p.useState(null);p.useEffect(()=>{const S=f.current;if(!S)return;const T=new Map;S.querySelectorAll("path[data-i2]").forEach(D=>{const M=D.dataset.i2;if(M)try{const E=D.getBBox();E.width>0&&T.set(M,{x:E.x,y:E.y,w:E.width,h:E.height})}catch{}}),x(T)},[t.continent,v]);const u=p.useMemo(()=>n.filter(S=>S.cc),[n]),y=p.useMemo(()=>{const S=new Map;return u.forEach(T=>S.set(T.cc,(S.get(T.cc)||0)+1)),S},[u]),C=p.useMemo(()=>u.map(S=>{const T=S.cc?h.get(S.cc):void 0;if(!T)return null;const D=St(S.name||S.id||""),M=St((S.id||S.name||"")+"·y"),E=(D-.5)*Math.min(T.w*.55,60),P=(M-.5)*Math.min(T.h*.55,60);return{d:S,x:T.x+T.w/2+E,y:T.y+T.h/2+P}}).filter(S=>!!S),[u,h]),w=S=>v>0?S/v:S,k=p.useMemo(()=>r?[0,1,2,3,4,5].map(S=>({c:Nt[S],fr:c.plabels[S].toUpperCase(),en:c.plabels[S].toUpperCase(),n:n.filter(T=>T.kind==="target"&&te(T)===S).length})).filter(S=>S.n>0):pt.map((S,T)=>({...S,n:n.filter(D=>ut(D)===T).length})),[n,r,c.plabels]),N=o?l.get(o):null,z=N?C.find(S=>S.d.id===N.id):null;return e.jsxs("div",{className:"mapzone",ref:b,children:[e.jsxs("svg",{ref:f,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":d==="fr"?s.fr:s.en,onMouseLeave:()=>{m(null),i(null)},children:[e.jsx("g",{children:s.countries.map((S,T)=>e.jsx("g",{className:"ct"+(S.i2&&y.get(S.i2)?"":" empty"),children:e.jsx("path",{d:S.d,"data-i2":S.i2||void 0})},T))}),e.jsx("g",{children:C.map(S=>{const T=pt[ut(S.d)],D=!!Q(S.d),M=S.d.kind==="target",E=r&&M?Nt[te(S.d)]:T.c,P=!r&&Z(S.d);return e.jsxs("g",{className:"co"+(P?" done":""),onMouseEnter:()=>{var F,_;const L=(F=b.current)==null?void 0:F.getBoundingClientRect(),I=(_=f.current)==null?void 0:_.createSVGPoint();if(I&&f.current&&L){I.x=S.x,I.y=S.y;const ie=I.matrixTransform(f.current.getScreenCTM());m({x:ie.x-L.left,y:ie.y-L.top,label:S.d.name+" · "+(ke(S.d.cc,d)||S.d.countryLabel||"")})}i(S.d.id)},onMouseLeave:()=>{m(null),i(null)},onClick:()=>{var F;const L=(F=f.current)==null?void 0:F.createSVGPoint();let I=null;if(L&&f.current){L.x=S.x,L.y=S.y;const _=L.matrixTransform(f.current.getScreenCTM());I={x:_.x,y:_.y}}a({type:"popup",id:S.d.id,anchor:I})},children:[e.jsx("circle",{className:"h",cx:S.x,cy:S.y,r:w(Math.max(11,T.px+7))}),e.jsx("circle",{className:"v",cx:S.x,cy:S.y,r:w(T.px),fill:E,stroke:D?"#DC2626":"#ffffff",strokeWidth:w(D?2.2:1.3)})]},S.d.id||S.d.name)})}),z&&e.jsx("circle",{className:"ring on",cx:z.x,cy:z.y,r:w(13),fill:"none",stroke:"#0F172A",strokeWidth:w(2)})]}),e.jsx("div",{className:"hov"+(g?" on":""),style:g?{left:g.x,top:g.y}:void 0,children:g==null?void 0:g.label}),e.jsx("div",{className:"legend",children:k.map((S,T)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":S.c}}),d==="fr"?S.fr:S.en," ",e.jsx("b",{children:S.n})]},T))}),n.some(S=>!S.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",c.notLocated," ",e.jsx("b",{children:n.filter(S=>!S.cc).length})]})})]})}function Br(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:i,contName:o}=A(),l=t.filters,d=p.useMemo(()=>n.filter(h=>h.continent===t.continent),[n,t.continent]),c=h=>d.filter(x=>h!=="country"&&l.country.length&&!l.country.includes(x.cc||"")?!1:tt(x,l,i,h==="country"?void 0:h)),f=p.useMemo(()=>{const h=c("win"),x=g=>h.filter(m=>(m.date?Math.max(0,Math.floor((Date.now()-Date.parse(m.date))/864e5)):9999)<=g).length;return[x(0),x(7),x(30),h.length]},[d,l,i]),b=p.useMemo(()=>{if(i)return null;const h=c("status"),x={all:h.length,todo:0,retenu:0,pending:0,ecarte:0};return h.forEach(g=>{x[de(g)]+=1}),x},[d,l,i]),s=l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+(l.signalOnly?1:0)+(l.win!=="all"?1:0)+(!i&&l.status!=="all"?1:0)+(l.search.trim()?1:0),v=(h,x,g,m="fbtn")=>e.jsxs("button",{type:"button",className:m,"aria-expanded":t.openFacet===h,onClick:()=>a({type:"openFacet",facet:h}),children:[e.jsx("span",{className:"fl",children:x}),g>0&&e.jsx("span",{className:"n",children:g}),e.jsx("span",{className:"cv",children:"▾"})]},h);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((h,x)=>e.jsxs("button",{type:"button","aria-pressed":l.win===h,onClick:()=>a({type:"filters",patch:{win:h}}),children:[r.dates[x],e.jsx("b",{children:f[x]})]},h))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:l.search,onChange:h=>a({type:"filters",patch:{search:h.target.value}})})]}),!i&&b&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([h,x])=>e.jsxs("button",{type:"button","aria-pressed":l.status===h,onClick:()=>a({type:"filters",patch:{status:h}}),children:[x,e.jsx("b",{children:b[h]??0})]},h))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),l.signalOnly&&e.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,l.sector.length),v("pay",r.fCountry,l.country.length),v("det",r.fEngine,l.engine.length),v("sta",r.fStage,l.stage.length),i&&v("ang","Angle",l.angle.length),i&&v("mem","Mémo",l.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(d.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx($r,{poolFor:c})]})}function $r({poolFor:t}){const{st:a,dispatch:n,t:r,lang:i}=A(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:f}=p.useMemo(()=>{if(l==="sig"){const x=t("signal").filter(u=>Q(u)),g=new Map;x.forEach(u=>{const y=u.engine||"";g.set(y,(g.get(y)||0)+1)});const m=[{v:"*",label:r.fpSigAll,n:x.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ft([...g.keys()],i).map(u=>({v:u,label:ye(u)+" "+se(u,i),n:g.get(u)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(u)}))];return{title:r.fpSigTitle,cols:2,options:m}}if(l==="sec"){const x=t("sector"),g=new Map;return x.forEach(m=>{m.sector&&g.set(m.sector,(g.get(m.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((m,u)=>u[1]-m[1]).map(([m,u])=>({v:m,label:m,n:u,html:!1,on:o.sector.includes(m)}))}}if(l==="pay"){const x=t("country"),g=new Map;return x.forEach(m=>{m.cc&&g.set(m.cc,(g.get(m.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((m,u)=>u[1]-m[1]).map(([m,u])=>({v:m,label:ke(m,i)||m,n:u,html:!1,on:o.country.includes(m)}))}}if(l==="det"){const x=t("engine"),g=new Map;return x.forEach(m=>{m.engine&&g.set(m.engine,(g.get(m.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:ft([...g.keys()],i).map(m=>({v:m,label:ye(m)+" "+se(m,i)+' <span style="color:var(--dim);font-size:10px">· '+ja(Na(m),i)+"</span>",n:g.get(m)||0,html:!0,on:o.engine.includes(m)}))}}if(l==="ang"){const x=t("angle"),g=new Map;return x.forEach(m=>{m.angle&&g.set(m.angle,(g.get(m.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((m,u)=>u[1]-m[1]).map(([m,u])=>({v:m,label:m.replace(/[_-]+/g," "),n:u,html:!1,on:o.angle.includes(m)}))}}if(l==="mem"){const x=t("memoLevel"),g=new Map;x.forEach(u=>{if(u.kind==="target"){const y=Ke(u);g.set(y,(g.get(y)||0)+1)}});const m=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(u=>({v:String(u),label:m[u],n:g.get(u)||0,html:!1,on:o.memoLevel.includes(u)}))}}const v=t("stage"),h=new Map;return v.forEach(x=>{x.stage&&h.set(x.stage,(h.get(x.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((x,g)=>g[1]-x[1]).map(([x,g])=>({v:x,label:x,n:g,html:!1,on:o.stage.includes(x)}))}},[l,a,i]),b=v=>{if(l==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const x=o.signalEngines.includes(v)?o.signalEngines.filter(g=>g!==v):[...o.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:x}})}return}if(l==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:v})},s=()=>{n(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:d}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(c===2?" two":""),children:f.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>b(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const Ct=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Vr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:i,dispatch:o,evalBusy:l,evalCards:d,caps:c,data:f}=A(),b=a==="client",[s,v]=p.useState(""),[h,x]=p.useState(!1),[g,m]=p.useState(""),[u,y]=p.useState(!1),[C,w]=p.useState(""),[k,N]=p.useState([]),z=p.useRef(!1),S=s.trim()?Ct.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,T=p.useMemo(()=>g.split(`
`).map(L=>L.trim()).filter(Boolean).slice(0,15),[g]),D=k.length?k:d,M=f.credits,E=()=>{const L=s.trim();L&&(r(null,L),v(""))},P=async()=>{if(!b){r(null,T[0]||"");return}if(!T.length||u)return;y(!0),z.current=!1;const L=[];for(let I=0;I<T.length&&!z.current;I++){w(t.evaluating(I+1,T.length,T[I]));const F=await Ft(n,T[I],"atelier2");if(L.unshift({name:F.company||T[I],verdict:F.verdict,reason:F.reason||"",remaining:F.remaining??null}),N([...L]),F.verdict==="quota"){L.unshift({name:"",verdict:"quota",reason:t.quota(T.length-I-1),remaining:0}),N([...L]);break}}w(""),m(""),y(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:L=>v(L.target.value),onKeyDown:L=>{L.key==="Enter"&&E()}}),e.jsx("span",{className:"detect"+(Ct.test(s.trim())?" url":""),children:S})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),disabled:l,onClick:E,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),c.showCredits&&M&&e.jsxs("button",{type:"button",className:"credits"+(M.total_available<=0&&!M.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:M.unlimited?"∞":M.total_available}),!M.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",M.daily_grant+M.purchased]}),M.total_available<=0&&!M.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>x(!h),children:t.evalMulti})}),h&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:g,placeholder:t.bulkPh,onChange:L=>m(L.target.value.split(`
`).slice(0,15).join(`
