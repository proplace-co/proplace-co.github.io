...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,Po=qo+Fo;function ca(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Do(){const e=ca("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Io(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Do();return r==="0"?"client":r==="1"||ca("embed")==="1"&&ca("chrome")==="1"?"apercu":"client"}const $o={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Bo=e=>$o[e];function _o(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Ye=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Fn(a)||_o(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ir(e.cc)})};function Xt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Uo=60*60*1e3;function Vo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Uo?null:a}catch{return null}}function St(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ho=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Yo(e,a,r="default"){const n=r!=="default",i=h.useMemo(()=>e||n?{mode:"anon"}:Tr(),[e,n]),o=h.useMemo(()=>n?"visiteur":Io(e,i),[e,i,n]),l=h.useMemo(()=>Bo(o),[o]),s=o!=="visiteur",p=Ho(r),[g,c]=h.useState([]),[f,u]=h.useState(""),[x,d]=h.useState(null),[b,v]=h.useState(null),[m,y]=h.useState(null),[j,w]=h.useState(()=>new Map),[E,A]=h.useState(()=>new Map),[R,B]=h.useState(""),[C,M]=h.useState(new Set),[O,L]=h.useState(null),[_,k]=h.useState(!0),[N,T]=h.useState(!1),[H,G]=h.useState(0),[Z,z]=h.useState(0),q=h.useRef(0),$=h.useMemo(()=>{var D;if(o!=="client")return"";try{return((D=Lr())==null?void 0:D.email)||""}catch{return""}},[o]);h.useEffect(()=>{const D=++q.current;let U=!0;const W=()=>U&&D===q.current,X=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),re=Vo(X);return re?(c(re.objs.map(Ye)),re.fund&&u(re.fund),d(re.marketEstimate??null),v(re.criteria??null),y(re.stats??null),B(re.generatedAt||""),k(!1)):k(!0),(async()=>{try{if(r==="ops"){const me=await Kt(),pe=((me==null?void 0:me.recent_ops)||[]).map(Q=>{const te=Qt(Q.company_name||Q.title?Q:{...Q,title:(Q.headline_fr||Q.headline||"").slice(0,120)},a),ve=String(Q.rubrique||"").toLowerCase();return te&&(ve==="nominations"||ve==="recrutements")&&(te.engine=ve),te&&!String(Q.company_name||"").trim()&&(te.noCo=!0),te}).filter(Q=>!!Q).map(Q=>(Fn((Q.name||"").trim())||(Q.noCo=!0),Q));try{const Q=await Rr(),te=Mr(Q),ve=((Q==null?void 0:Q.date)||"").slice(0,10);if(te.length&&ve){const K=new Set;for(const se of pe){if(se.noCo||(se.date||"").slice(0,10)!==ve)continue;const ee=Ia(te,K,se.name,"");ee>=0&&(K.add(ee),se.decryptHtml=te[ee].html)}for(const se of pe){if(se.decryptHtml||(se.date||"").slice(0,10)!==ve)continue;const ee=Ia(te,K,"",se.headline||se.tagline||se.name);ee>=0&&(K.add(ee),se.decryptHtml=te[ee].html)}}}catch{}if(!W())return;c(pe.map(Ye)),St(X,{objs:pe})}else if(typeof r=="object"){const pe=(await $a()||[]).filter(te=>(te.slug||"")===r.research).map(te=>Ba(te,a)).filter(te=>!!te),Q=Xt(await _a(pe,a));if(!W())return;c(Q.map(Ye)),St(X,{objs:Q})}else if(s&&i.token){const me=Or(i.token),pe=Kt(),Q=qr(i.token),te=Fr(i.token),ve=Pr(i.token),K=await me;let se=K?K.targets:[];W()&&K&&(u(K.fund||""),d(K.marketEstimate??null),v(K.criteria??null),y(K.stats??null),B(K.generatedAt||""),c(se.map(Ye)),k(!1),T(!1));const[ee,Ue,xe,ge]=await Promise.all([pe,Q,te,ve]),Ie=((ee==null?void 0:ee.recent_ops)||[]).map(Se=>Qt(Se,a)).filter(Se=>!!Se);if(se=[...se,...Ie],!W())return;c(se.map(Ye));const He=new Set;for(const Se of Ue){const $e=(Se.id||Se.co||"").toString().trim().toLowerCase();$e&&He.add($e.startsWith("t:")?$e:"t:"+$e)}M(He),w(xe),A(ge),K&&St(X,{fund:K.fund,marketEstimate:K.marketEstimate,criteria:K.criteria,stats:K.stats,generatedAt:K.generatedAt,objs:se})}else{const me=Dr(),pe=$a(),Q=Kt(),te=await me;W()&&te.length&&(c(Xt(te).map(Ye)),k(!1),T(!1));const[ve,K]=await Promise.all([pe,Q]),se=(ve||[]).map(ge=>Ba(ge,a)).filter(ge=>!!ge),ee=await _a(se,a),Ue=((K==null?void 0:K.recent_ops)||[]).map(ge=>Qt(ge,a)).filter(ge=>!!ge),xe=Xt([...te,...ee,...Ue]);if(!W())return;c(xe.map(Ye)),St(X,{objs:xe})}W()&&T(!1)}catch{W()&&!re&&T(!0)}finally{W()&&k(!1)}})(),()=>{U=!1}},[s,i.token,a,H,p]),h.useEffect(()=>{if(!l.showCredits||!$){L(null);return}let D=!0;return(async()=>{try{const U=await fetch(`${Ca}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:$})});if(!U.ok)return;const W=await U.json();D&&W&&W.ok!==!1&&L(W)}catch{}})(),()=>{D=!1}},[l.showCredits,$,Z]);const P=h.useCallback(D=>M(new Set(D)),[]);return{session:i,mode:o,caps:l,fund:f,email:$,marketEstimate:x,generatedAt:R,criteria:b,stats:m,thumbs:j,stages:E,dossiers:g,favIds:C,setFavIds:P,credits:O,reloadCredits:()=>z(D=>D+1),loading:_,error:N,refresh:()=>G(D=>D+1)}}const _n=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Wo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{..._n(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Go(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:_n(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Un)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Un=40;function Ta(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!he(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ea(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ot(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ge(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Vn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ta(e,a.filters,r)}function Ko(e,a,r,n){return!(!Vn(e,a,r)||r&&!$r(e,a.ptab,n))}function La(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ot(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=he(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const Qo=["ma","levees","nominations","recrutements","actualites"],Jo=300,Zt=7,Xo={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Hn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Zo=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ja(e){const a=he(e);if(a)return"sig:"+(a.theme&&Hn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function ei(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=F(),s=l==="en",[p,g]=h.useState("all"),[c,f]=h.useState(!1),u=h.useMemo(()=>{const C=(a.filters.day||"").slice(0,10),M=k=>!(!o&&a.continent!=="monde"&&k.continent!==a.continent||C&&(k.date||"").slice(0,10)!==C),O=e.filter(k=>M(k)&&he(k)),L=e.filter(k=>M(k)&&k.kind==="op"&&!he(k)&&(C?!0:ot(k.date)<=Zt)),_=C||new Date().toISOString().slice(0,10);return L.sort((k,N)=>{const T=(k.date||"").slice(0,10)===_?0:1,H=(N.date||"").slice(0,10)===_?0:1;return T!==H?T-H:(N.amountEur||0)-(k.amountEur||0)}),[...La(O,{key:"signal",dir:-1}),...L]},[e,a.continent,a.filters.day,o]),x=h.useMemo(()=>{const C={};for(const M of u){const O=Ja(M);C[O]=(C[O]||0)+1}return C},[u]),d=h.useMemo(()=>p==="all"?u:u.filter(C=>Ja(C)===p),[u,p]),b=h.useMemo(()=>d.slice(0,Jo),[d]),v=d.length-b.length,m=C=>C==="all"?u.length:x[C]||0,y=C=>C==="all"?s?"All":"Tout":C.startsWith("sig:")?Hn[s?"en":"fr"][C.slice(4)]||"🔔":Xo[s?"en":"fr"][C],j=[{k:"all"}],w=Qo.filter(C=>m(C)>0||C===p);if(w.length){j.push({g:s?"DEALS":"OPÉRATIONS"});for(const C of w)j.push({k:C})}const E=Zo.map(C=>"sig:"+C).filter(C=>m(C)>0||C===p);if(E.length){j.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const C of E)j.push({k:C})}const A=C=>{try{return new Date(C+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return C}},R=(()=>{const C=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?s?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return C?(s?`LIVE covers the events of ${A(C)}.`:`Le LIVE regroupe les événements du ${A(C)}.`)+M:(s?`LIVE covers the still-open signals and the deals of the last ${Zt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Zt} derniers jours.`)+M})(),B=C=>b.map(M=>t.jsxs("button",{type:"button",className:"tk"+(Ae(M)?" spent":""),onClick:O=>{const L=O.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:L.left+L.width/2,y:L.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(Xe,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(yr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Ol(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(Ht,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},C+(M.id||M.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},C+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:C=>{C.currentTarget.contains(C.relatedTarget)||f(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":c,onClick:()=>f(C=>!C),children:[y(p),t.jsx("b",{children:m(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!c,children:[t.jsx("span",{className:"tkfilscope",children:R}),j.map(C=>"g"in C?t.jsx("span",{className:"tkfilg",children:C.g},C.g):t.jsxs("button",{type:"button","aria-pressed":C.k===p,onClick:()=>{g(C.k),f(!1)},children:[y(C.k),t.jsx("b",{children:m(C.k)})]},C.k))]})]}),t.jsx("div",{className:"win",children:b.length?t.jsxs("div",{className:"run",children:[B(0),B(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const ti="aDx8z7Hzksus",Yn="+33 6 83 10 72 86",Xa="alexandre@proplace.co",ai=`tel:${Yn.replace(/[^\d+]/g,"")}`,Za="pp-rdv-slot";function ni(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ri(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:ii}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:ai,children:Yn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Xa}`,children:Xa})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Lo,{filloutId:ti,parameters:r?{company_name:r}:void 0})})]})}function oi(){const[e,a]=h.useState(()=>typeof document>"u"?null:document.getElementById(Za));return h.useEffect(()=>{e||a(document.getElementById(Za))},[e]),e?it.createPortal(t.jsx(ri,{}),e):null}const ii=`
...
`;class be extends h.Component{constructor(){super(...arguments);Pa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const si=8;function li(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=F(),[s,p]=h.useState(!1),[g,c]=h.useState(!1),[f,u]=h.useState(!1),x=r||"home",{names:d,verdicts:b}=h.useMemo(()=>{const w=[],E={};return n.forEach(A=>{A.kind!=="target"||!A.name||(w.push(A.name),E[A.name]=Br(A)||"")}),{names:w,verdicts:E}},[n]),v=h.useMemo(()=>d.length?_r(x,d,b,a):null,[x,d.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const m=g?v.added:v.added.slice(0,si),y=v.added.length-m.length,j=w=>{const E=n.find(A=>A.name===w);E&&(o(E.id),l({type:"popup",id:E.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Ur(x,d,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[m.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>c(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),f&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const ea=600,We=62,en="atl2:fstats";function ci(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=F(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(en)==="on"}catch{return!1}}),p=r.stats,g=h.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),c=h.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const f=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),x=g.reduce((y,j)=>Math.max(y,j.s||0),0),d=g.length?ea/g.length:0,b=Math.max(4,d-4),v=g.length>=5&&x>0,m=[[p.screened,e.funScreened(f(c)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[m.map(([y,j,w],E)=>t.jsxs("span",{className:"fst-t",children:[E>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:j}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(en,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ea} ${We}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((y,j)=>{const w=(y.s||0)/x*(We-4),E=(y.m||0)/x*(We-4),A=j*d+(d-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:We-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:We-2-E,width:b,height:E,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:We-1.5,x2:ea,y2:We-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const di=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function pi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=F(),[o,l]=h.useState(""),[s,p]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),c=(Ze(e)||"").startsWith("CALL")&&ke(e)===3,f=ke(e)>=2,u=async d=>{if(o||d==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(d);const b=await i(e,d);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},x=c?[["Validé",a.csYes],["Écarté",a.csNo]]:di.filter(([d])=>!(f&&d==="Retenu")).map(([d,b])=>[d,a[b]]);return t.jsxs("div",{className:"csp",onClick:d=>d.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),x.map(([d,b])=>t.jsx("button",{type:"button",className:"csb"+(g===d?" on":"")+(o===d?" busy":""),disabled:!!o,onClick:()=>{u(d)},children:b},d)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ui,{o:e})]})}function ui({o:e}){const{t:a,saveNote:r,flash:n}=F(),[i,o]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[p,g]=h.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(l||!c)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{f()},children:p?a.csNoteSaved:a.csNoteOk})]})}function fi({placeholder:e,onDone:a}){const{t:r}=F(),[n,i]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function mi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=F(),[p,g]=h.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const c=o(e),f=(c==null?void 0:c.stage)||"todo",u=async m=>{if(p||m===f)return;g(!0);const y=c;l(e,{stage:m,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),tn+=1);tn=j;const w=await Vr(r,{company:e.name||"",stage:m,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},x=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,d=x?Math.floor((Date.now()-Date.parse(x))/864e5):0,b=f==="sent"&&x&&d>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(f===m?" on":""),disabled:p,onClick:()=>{u(m)},children:y},m)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(d)})]})}let tn=0;const Ct=8,Et=340;function an({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function xi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=F(),[l,s]=h.useState(0),[p,g]=h.useState(null),[c,f]=h.useState([]),u=h.useRef(!1);h.useEffect(()=>{u.current||(u.current=!0,f(e.filter(j=>!!document.querySelector(j.need||j.sel))))},[e]);const x=c[l],d=l>=c.length;h.useEffect(()=>{x&&(x.ptab!==void 0&&o.ptab!==x.ptab&&n({type:"ptab",tab:x.ptab}),x.dens&&o.dens!==x.dens&&n({type:"dens",dens:x.dens}))},[l,x]);const b=h.useCallback(()=>{if(!x){g(null);return}const j=document.querySelector(x.sel);if(!j){g(null);return}j.scrollIntoView({block:"nearest",behavior:"smooth"}),g(j.getBoundingClientRect())},[x]);h.useLayoutEffect(()=>{b();const j=window.setTimeout(b,260),w=()=>b();return window.addEventListener("scroll",w,!0),window.addEventListener("resize",w),()=>{window.clearTimeout(j),window.removeEventListener("scroll",w,!0),window.removeEventListener("resize",w)}},[b]);const v=h.useRef(a);if(v.current=a,h.useEffect(()=>{const j=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),v.current()):w.key==="ArrowRight"?s(E=>E+1):w.key==="ArrowLeft"&&s(E=>Math.max(0,E-1))};return document.addEventListener("keydown",j,!0),()=>document.removeEventListener("keydown",j,!0)},[]),!c.length)return null;let m=null;if(d){const j=i[3]||0;j>0?m={title:j===1?r.ahaATitle1:r.ahaATitleN(j),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:(i[1]||0)>0?m={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:()=>{n({type:"ptab",tab:1}),a()}}:m={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Et};if(!d&&p){const j=p.bottom+14,E=window.innerHeight-j>190?j:Math.max(12,p.top-200);y={left:Math.min(Math.max(12,p.left+p.width/2-Et/2),window.innerWidth-Et-12),top:E,width:Et}}return it.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!d&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-Ct,top:p.top-Ct,width:p.width+Ct*2,height:p.height+Ct*2}}),(d||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(d?" fin":""),style:y,children:[d&&m?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:m.title}),t.jsx("p",{children:t.jsx(an,{text:m.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:m.go,children:m.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(l+1,c.length)}),t.jsx("h3",{children:x==null?void 0:x.title}),t.jsx("p",{children:t.jsx(an,{text:(x==null?void 0:x.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(j=>Math.max(0,j-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(j=>j+1),children:l===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function hi(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,dispatch:l}=F(),s=r?a:e,p=h.useMemo(()=>s.filter(m=>ot(m.date)===0&&m.kind==="target"),[s]),g=h.useMemo(()=>r?a.filter(m=>ke(m)===0).slice().sort((m,y)=>(y.date||"").localeCompare(m.date||"")):[],[a,r]),c=h.useMemo(()=>p.filter(m=>r?ke(m)===0:!Ae(m)),[p,r]),f=r?g:c,u=r?a.length-g.length:p.length-c.length,x=r?a.length:p.length,d=x?Math.min(100,u/x*100):100;let b;r?b=i.morningThesis(p.length,g.length):p.length?u===0?b=i.goalSourced(p.length):u>=p.length?b=i.goalCleared:b=i.goalDone(u,p.length):b=i.goalSourced(0);const v=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&g.length&&l({type:"chainStart",queue:g.map(m=>m.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:b}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:d+"%"}})}),f.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:v,children:r?i.morningEval(f.length):o.pileMode?i.goalContinue(f.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function gi(){var M,O;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:g,startTour:c}=F(),[f,u]=h.useState(null),[x,d]=h.useState([]),b=p==="client";h.useEffect(()=>{if(!i||!o)return;let L=!0;return(async()=>{const[_,k]=await Promise.all([Aa(o),Pn(i)]);L&&(_&&u(_),d(k))})(),()=>{L=!1}},[i,o]);const v=(f==null?void 0:f.per_day)??null,m=((M=f==null?void 0:f.pool_order)==null?void 0:M.length)??0,y=x.filter(L=>L.status==="running").length,j=h.useMemo(()=>s.filter(L=>L.kind==="target"&&Ae(L)).length,[s]),w=l.marketEstimate,E=typeof((O=l.stats)==null?void 0:O.screened)=="number"?l.stats.screened:j,A=w&&w>0?Math.min(100,Math.round(E/w*100)):null,R=L=>L.toLocaleString(a==="en"?"en-US":"fr-FR"),B=(o||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),C=(()=>{const L=Date.parse(l.generatedAt||"");if(Number.isNaN(L))return"";const _=new Date(L),k=N=>String(N).padStart(2,"0");return`${k(_.getDate())}/${k(_.getMonth()+1)} à ${k(_.getHours())}:${k(_.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:B}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),C&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(C)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[A===null&&E>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(E)})})]}),A!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:A+"%"}})}),t.jsxs("b",{children:[A," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(E,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(m)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function bi(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const vi=["--p0","--p1","--p2","--p3","--p4"];function yi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=F(),s=o.loading&&!l.length,p=h.useRef({});h.useEffect(()=>{p.current={...r}},[r]);const g=u=>{const x=p.current[u],d=x!==void 0?r[u]-x:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${vi[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(d>0?" up":d<0?" down":""),children:[r[u],d!==0&&t.jsxs("em",{className:"delta",children:[d>0?"+":"−",Math.abs(d)]})]})]},u)},c=(u,x,d)=>t.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:d.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),f=(u,x,d,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:x,disabled:b,onClick:d,children:u},x);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[c(5,!1,n.plabels[5]),c(7,!0,n.plabels[7]),c(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[f("↩",n.toolUndo,i,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const wi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function ki(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=F(),s=h.useRef(null),[p,g]=h.useState(60);h.useEffect(()=>{let x=0;const d=()=>{var j;const b=s.current;if(!b)return;const v=(j=b.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!v)return;const m=v.getBoundingClientRect(),y=b.getBoundingClientRect();g(Math.max(20,Math.min(m.left+m.width/2-y.left,y.width-30)))};return x=requestAnimationFrame(d),window.addEventListener("resize",d),()=>{cancelAnimationFrame(x),window.removeEventListener("resize",d)}},[e.ptab]);const c=e.ptab;let f=r.tuto[c].p;if(c===3){const x=n.filter(v=>v.kind==="target"&&ke(v)===3),d=x.filter(v=>ia(v)==="auto").length,b=x.filter(v=>ia(v)==="cd").length;f=r.tutoPending(d,b,x.length)}const u=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(x=>x.id)})};if(c===1){const x=n.filter(d=>d.kind==="target"&&ke(d)===1&&!i.has(d.id)).slice(0,10);if(x.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:x.map(d=>d.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":wi[c],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:f}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Qe{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*ji(e){for(const a of e)yield*a}function Wn(e){return Array.from(ji(e))}var ne=1e-6,J=Math.PI,Te=J/2,nn=J/4,Re=J*2,Be=180/J,Ee=J/180,ie=Math.abs,Ni=Math.atan,gt=Math.atan2,ce=Math.cos,de=Math.sin,Si=Math.sign||function(e){return e>0?1:e<0?-1:0},et=Math.sqrt;function Ci(e){return e>1?0:e<-1?J:Math.acos(e)}function bt(e){return e>1?Te:e<-1?-Te:Math.asin(e)}function Le(){}function qt(e,a){e&&on.hasOwnProperty(e.type)&&on[e.type](e,a)}var rn={Feature:function(e,a){qt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)qt(r[n].geometry,a)}},on={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){da(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)da(r[n],a,0)},Polygon:function(e,a){sn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)sn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)qt(r[n],a)}};function da(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function sn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)da(e[r],a,1);a.polygonEnd()}function tt(e,a){e&&rn.hasOwnProperty(e.type)?rn[e.type](e,a):qt(e,a)}function pa(e){return[gt(e[1],e[0]),bt(e[2])]}function nt(e){var a=e[0],r=e[1],n=ce(r);return[n*ce(a),n*de(a),de(r)]}function At(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ft(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ta(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function zt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ua(e){var a=et(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function fa(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function ma(e,a){return ie(e)>J&&(e-=Math.round(e/Re)*Re),[e,a]}ma.invert=ma;function Ei(e,a,r){return(e%=Re)?a||r?fa(cn(e),dn(a,r)):cn(e):a||r?dn(a,r):ma}function ln(e){return function(a,r){return a+=e,ie(a)>J&&(a-=Math.round(a/Re)*Re),[a,r]}}function cn(e){var a=ln(e);return a.invert=ln(-e),a}function dn(e,a){var r=ce(e),n=de(e),i=ce(a),o=de(a);function l(s,p){var g=ce(p),c=ce(s)*g,f=de(s)*g,u=de(p),x=u*r+c*n;return[gt(f*i-x*o,c*r-u*n),bt(x*i+f*o)]}return l.invert=function(s,p){var g=ce(p),c=ce(s)*g,f=de(s)*g,u=de(p),x=u*i-f*o;return[gt(f*i+u*o,c*r+x*n),bt(x*r-c*n)]},l}function Ai(e,a,r,n,i,o){if(r){var l=ce(a),s=de(a),p=n*r;i==null?(i=a+n*Re,o=a-p/2):(i=pn(l,i),o=pn(l,o),(n>0?i<o:i>o)&&(i+=n*Re));for(var g,c=i;n>0?c>o:c<o;c-=p)g=pa([l,-s*ce(c),-s*de(c)]),e.point(g[0],g[1])}}function pn(e,a){a=nt(a),a[0]-=e,ua(a);var r=Ci(-a[1]);return((-a[2]<0?-r:r)+Re-ne)%Re}function Gn(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Le,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ot(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Tt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Kn(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(d){if(!((b=d.length-1)<=0)){var b,v=d[0],m=d[b],y;if(Ot(v,m)){if(!v[2]&&!m[2]){for(i.lineStart(),s=0;s<b;++s)i.point((v=d[s])[0],v[1]);i.lineEnd();return}m[0]+=2*ne}o.push(y=new Tt(v,d,null,!0)),l.push(y.o=new Tt(v,null,y,!1)),o.push(y=new Tt(m,d,null,!1)),l.push(y.o=new Tt(m,null,y,!0))}}),!!o.length){for(l.sort(a),un(o),un(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var g=o[0],c,f;;){for(var u=g,x=!0;u.v;)if((u=u.n)===g)return;c=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(x)for(s=0,p=c.length;s<p;++s)i.point((f=c[s])[0],f[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(x)for(c=u.p.z,s=c.length-1;s>=0;--s)i.point((f=c[s])[0],f[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,c=u.z,x=!x}while(!u.v);i.lineEnd()}}}function un(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function aa(e){return ie(e[0])<=J?e[0]:Si(e[0])*((ie(e[0])+J)%Re-J)}function zi(e,a){var r=aa(a),n=a[1],i=de(n),o=[de(r),-ce(r),0],l=0,s=0,p=new Qe;i===1?n=Te+ne:i===-1&&(n=-Te-ne);for(var g=0,c=e.length;g<c;++g)if(u=(f=e[g]).length)for(var f,u,x=f[u-1],d=aa(x),b=x[1]/2+nn,v=de(b),m=ce(b),y=0;y<u;++y,d=w,v=A,m=R,x=j){var j=f[y],w=aa(j),E=j[1]/2+nn,A=de(E),R=ce(E),B=w-d,C=B>=0?1:-1,M=C*B,O=M>J,L=v*A;if(p.add(gt(L*C*de(M),m*R+L*ce(M))),l+=O?B+C*Re:B,O^d>=r^w>=r){var _=Ft(nt(x),nt(j));ua(_);var k=Ft(o,_);ua(k);var N=(O^B>=0?-1:1)*bt(k[2]);(n>N||n===N&&(_[0]||_[1]))&&(s+=O^B>=0?1:-1)}}return(l<-ne||l<ne&&p<-1e-12)^s&1}function Qn(e,a,r,n){return function(i){var o=a(i),l=Gn(),s=a(l),p=!1,g,c,f,u={point:x,lineStart:b,lineEnd:v,polygonStart:function(){u.point=m,u.lineStart=y,u.lineEnd=j,c=[],g=[]},polygonEnd:function(){u.point=x,u.lineStart=b,u.lineEnd=v,c=Wn(c);var w=zi(g,n);c.length?(p||(i.polygonStart(),p=!0),Kn(c,Li,w,r,i)):w&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),c=g=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function x(w,E){e(w,E)&&i.point(w,E)}function d(w,E){o.point(w,E)}function b(){u.point=d,o.lineStart()}function v(){u.point=x,o.lineEnd()}function m(w,E){f.push([w,E]),s.point(w,E)}function y(){s.lineStart(),f=[]}function j(){m(f[0][0],f[0][1]),s.lineEnd();var w=s.clean(),E=l.result(),A,R=E.length,B,C,M;if(f.pop(),g.push(f),f=null,!!R){if(w&1){if(C=E[0],(B=C.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),A=0;A<B;++A)i.point((M=C[A])[0],M[1]);i.lineEnd()}return}R>1&&w&2&&E.push(E.pop().concat(E.shift())),c.push(E.filter(Ti))}}return u}}function Ti(e){return e.length>1}function Li(e,a){return((e=e.x)[0]<0?e[1]-Te-ne:Te-e[1])-((a=a.x)[0]<0?a[1]-Te-ne:Te-a[1])}const fn=Qn(function(){return!0},Ri,Oi,[-J,-Te]);function Ri(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?J:-J,p=ie(o-a);ie(p-J)<ne?(e.point(a,r=(r+l)/2>0?Te:-Te),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=J&&(ie(a-n)<ne&&(a-=n*ne),ie(o-s)<ne&&(o-=s*ne),r=Mi(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Mi(e,a,r,n){var i,o,l=de(e-r);return ie(l)>ne?Ni((de(a)*(o=ce(n))*de(r)-de(n)*(i=ce(a))*de(e))/(i*o*l)):(a+n)/2}function Oi(e,a,r,n){var i;if(e==null)i=r*Te,n.point(-J,i),n.point(0,i),n.point(J,i),n.point(J,0),n.point(J,-i),n.point(0,-i),n.point(-J,-i),n.point(-J,0),n.point(-J,i);else if(ie(e[0]-a[0])>ne){var o=e[0]<a[0]?J:-J;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function qi(e){var a=ce(e),r=2*Ee,n=a>0,i=ie(a)>ne;function o(c,f,u,x){Ai(x,e,r,u,c,f)}function l(c,f){return ce(c)*ce(f)>a}function s(c){var f,u,x,d,b;return{lineStart:function(){d=x=!1,b=1},point:function(v,m){var y=[v,m],j,w=l(v,m),E=n?w?0:g(v,m):w?g(v+(v<0?J:-J),m):0;if(!f&&(d=x=w)&&c.lineStart(),w!==x&&(j=p(f,y),(!j||Ot(f,j)||Ot(y,j))&&(y[2]=1)),w!==x)b=0,w?(c.lineStart(),j=p(y,f),c.point(j[0],j[1])):(j=p(f,y),c.point(j[0],j[1],2),c.lineEnd()),f=j;else if(i&&f&&n^w){var A;!(E&u)&&(A=p(y,f,!0))&&(b=0,n?(c.lineStart(),c.point(A[0][0],A[0][1]),c.point(A[1][0],A[1][1]),c.lineEnd()):(c.point(A[1][0],A[1][1]),c.lineEnd(),c.lineStart(),c.point(A[0][0],A[0][1],3)))}w&&(!f||!Ot(f,y))&&c.point(y[0],y[1]),f=y,x=w,u=E},lineEnd:function(){x&&c.lineEnd(),f=null},clean:function(){return b|(d&&x)<<1}}}function p(c,f,u){var x=nt(c),d=nt(f),b=[1,0,0],v=Ft(x,d),m=At(v,v),y=v[0],j=m-y*y;if(!j)return!u&&c;var w=a*m/j,E=-a*y/j,A=Ft(b,v),R=zt(b,w),B=zt(v,E);ta(R,B);var C=A,M=At(R,C),O=At(C,C),L=M*M-O*(At(R,R)-1);if(!(L<0)){var _=et(L),k=zt(C,(-M-_)/O);if(ta(k,R),k=pa(k),!u)return k;var N=c[0],T=f[0],H=c[1],G=f[1],Z;T<N&&(Z=N,N=T,T=Z);var z=T-N,q=ie(z-J)<ne,$=q||z<ne;if(!q&&G<H&&(Z=H,H=G,G=Z),$?q?H+G>0^k[1]<(ie(k[0]-N)<ne?H:G):H<=k[1]&&k[1]<=G:z>J^(N<=k[0]&&k[0]<=T)){var P=zt(C,(-M+_)/O);return ta(P,R),[k,pa(P)]}}}function g(c,f){var u=n?e:J-e,x=0;return c<-u?x|=1:c>u&&(x|=2),f<-u?x|=4:f>u&&(x|=8),x}return Qn(l,s,o,n?[0,-e]:[-J,e-J])}function Fi(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],g=a[1],c=0,f=1,u=p-l,x=g-s,d;if(d=r-l,!(!u&&d>0)){if(d/=u,u<0){if(d<c)return;d<f&&(f=d)}else if(u>0){if(d>f)return;d>c&&(c=d)}if(d=i-l,!(!u&&d<0)){if(d/=u,u<0){if(d>f)return;d>c&&(c=d)}else if(u>0){if(d<c)return;d<f&&(f=d)}if(d=n-s,!(!x&&d>0)){if(d/=x,x<0){if(d<c)return;d<f&&(f=d)}else if(x>0){if(d>f)return;d>c&&(c=d)}if(d=o-s,!(!x&&d<0)){if(d/=x,x<0){if(d>f)return;d>c&&(c=d)}else if(x>0){if(d<c)return;d<f&&(f=d)}return c>0&&(e[0]=l+c*u,e[1]=s+c*x),f<1&&(a[0]=l+f*u,a[1]=s+f*x),!0}}}}}var pt=1e9,Lt=-pt;function Pi(e,a,r,n){function i(g,c){return e<=g&&g<=r&&a<=c&&c<=n}function o(g,c,f,u){var x=0,d=0;if(g==null||(x=l(g,f))!==(d=l(c,f))||p(g,c)<0^f>0)do u.point(x===0||x===3?e:r,x>1?n:a);while((x=(x+f+4)%4)!==d);else u.point(c[0],c[1])}function l(g,c){return ie(g[0]-e)<ne?c>0?0:3:ie(g[0]-r)<ne?c>0?2:1:ie(g[1]-a)<ne?c>0?1:0:c>0?3:2}function s(g,c){return p(g.x,c.x)}function p(g,c){var f=l(g,1),u=l(c,1);return f!==u?f-u:f===0?c[1]-g[1]:f===1?g[0]-c[0]:f===2?g[1]-c[1]:c[0]-g[0]}return function(g){var c=g,f=Gn(),u,x,d,b,v,m,y,j,w,E,A,R={point:B,lineStart:L,lineEnd:_,polygonStart:M,polygonEnd:O};function B(N,T){i(N,T)&&c.point(N,T)}function C(){for(var N=0,T=0,H=x.length;T<H;++T)for(var G=x[T],Z=1,z=G.length,q=G[0],$,P,D=q[0],U=q[1];Z<z;++Z)$=D,P=U,q=G[Z],D=q[0],U=q[1],P<=n?U>n&&(D-$)*(n-P)>(U-P)*(e-$)&&++N:U<=n&&(D-$)*(n-P)<(U-P)*(e-$)&&--N;return N}function M(){c=f,u=[],x=[],A=!0}function O(){var N=C(),T=A&&N,H=(u=Wn(u)).length;(T||H)&&(g.polygonStart(),T&&(g.lineStart(),o(null,null,1,g),g.lineEnd()),H&&Kn(u,s,N,o,g),g.polygonEnd()),c=g,u=x=d=null}function L(){R.point=k,x&&x.push(d=[]),E=!0,w=!1,y=j=NaN}function _(){u&&(k(b,v),m&&w&&f.rejoin(),u.push(f.result())),R.point=B,w&&c.lineEnd()}function k(N,T){var H=i(N,T);if(x&&d.push([N,T]),E)b=N,v=T,m=H,E=!1,H&&(c.lineStart(),c.point(N,T));else if(H&&w)c.point(N,T);else{var G=[y=Math.max(Lt,Math.min(pt,y)),j=Math.max(Lt,Math.min(pt,j))],Z=[N=Math.max(Lt,Math.min(pt,N)),T=Math.max(Lt,Math.min(pt,T))];Fi(G,Z,e,a,r,n)?(w||(c.lineStart(),c.point(G[0],G[1])),c.point(Z[0],Z[1]),H||c.lineEnd(),A=!1):H&&(c.lineStart(),c.point(N,T),A=!1)}y=N,j=T,w=H}return R}}const xa=e=>e;var na=new Qe,ha=new Qe,Jn,Xn,ga,ba,_e={point:Le,lineStart:Le,lineEnd:Le,polygonStart:function(){_e.lineStart=Di,_e.lineEnd=$i},polygonEnd:function(){_e.lineStart=_e.lineEnd=_e.point=Le,na.add(ie(ha)),ha=new Qe},result:function(){var e=na/2;return na=new Qe,e}};function Di(){_e.point=Ii}function Ii(e,a){_e.point=Zn,Jn=ga=e,Xn=ba=a}function Zn(e,a){ha.add(ba*e-ga*a),ga=e,ba=a}function $i(){Zn(Jn,Xn)}var rt=1/0,Pt=rt,vt=-rt,Dt=vt,It={point:Bi,lineStart:Le,lineEnd:Le,polygonStart:Le,polygonEnd:Le,result:function(){var e=[[rt,Pt],[vt,Dt]];return vt=Dt=-(Pt=rt=1/0),e}};function Bi(e,a){e<rt&&(rt=e),e>vt&&(vt=e),a<Pt&&(Pt=a),a>Dt&&(Dt=a)}var va=0,ya=0,ut=0,$t=0,Bt=0,at=0,wa=0,ka=0,ft=0,er,tr,Fe,Pe,ze={point:Je,lineStart:mn,lineEnd:xn,polygonStart:function(){ze.lineStart=Vi,ze.lineEnd=Hi},polygonEnd:function(){ze.point=Je,ze.lineStart=mn,ze.lineEnd=xn},result:function(){var e=ft?[wa/ft,ka/ft]:at?[$t/at,Bt/at]:ut?[va/ut,ya/ut]:[NaN,NaN];return va=ya=ut=$t=Bt=at=wa=ka=ft=0,e}};function Je(e,a){va+=e,ya+=a,++ut}function mn(){ze.point=_i}function _i(e,a){ze.point=Ui,Je(Fe=e,Pe=a)}function Ui(e,a){var r=e-Fe,n=a-Pe,i=et(r*r+n*n);$t+=i*(Fe+e)/2,Bt+=i*(Pe+a)/2,at+=i,Je(Fe=e,Pe=a)}function xn(){ze.point=Je}function Vi(){ze.point=Yi}function Hi(){ar(er,tr)}function Yi(e,a){ze.point=ar,Je(er=Fe=e,tr=Pe=a)}function ar(e,a){var r=e-Fe,n=a-Pe,i=et(r*r+n*n);$t+=i*(Fe+e)/2,Bt+=i*(Pe+a)/2,at+=i,i=Pe*e-Fe*a,wa+=i*(Fe+e),ka+=i*(Pe+a),ft+=i*3,Je(Fe=e,Pe=a)}function nr(e){this._context=e}nr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Re);break}}},result:Le};var ja=new Qe,ra,rr,or,mt,xt,yt={point:Le,lineStart:function(){yt.point=Wi},lineEnd:function(){ra&&ir(rr,or),yt.point=Le},polygonStart:function(){ra=!0},polygonEnd:function(){ra=null},result:function(){var e=+ja;return ja=new Qe,e}};function Wi(e,a){yt.point=ir,rr=mt=e,or=xt=a}function ir(e,a){mt-=e,xt-=a,ja.add(et(mt*mt+xt*xt)),mt=e,xt=a}let hn,_t,gn,bn;class vn{constructor(a){this._append=a==null?sr:Gi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==gn||this._append!==_t){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,gn=n,_t=this._append,bn=this._,this._=i}this._+=bn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function sr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Gi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return sr;if(a!==hn){const r=10**a;hn=a,_t=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return _t}function Ki(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),tt(s,i(o))),o.result()}return l.area=function(s){return tt(s,i(_e)),_e.result()},l.measure=function(s){return tt(s,i(yt)),yt.result()},l.bounds=function(s){return tt(s,i(It)),It.result()},l.centroid=function(s){return tt(s,i(ze)),ze.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,xa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new vn(r)):new nr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new vn(r)),l},l.projection(e).digits(r).context(a)}function Ra(e){return function(a){var r=new Na;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Na(){}Na.prototype={constructor:Na,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ma(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),tt(r,e.stream(It)),a(It.result()),n!=null&&e.clipExtent(n),e}function lr(e,a,r){return Ma(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function Qi(e,a,r){return lr(e,[[0,0],a],r)}function Ji(e,a,r){return Ma(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Xi(e,a,r){return Ma(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var yn=16,Zi=ce(30*Ee);function wn(e,a){return+a?ts(e,a):es(e)}function es(e){return Ra({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ts(e,a){function r(n,i,o,l,s,p,g,c,f,u,x,d,b,v){var m=g-n,y=c-i,j=m*m+y*y;if(j>4*a&&b--){var w=l+u,E=s+x,A=p+d,R=et(w*w+E*E+A*A),B=bt(A/=R),C=ie(ie(A)-1)<ne||ie(o-f)<ne?(o+f)/2:gt(E,w),M=e(C,B),O=M[0],L=M[1],_=O-n,k=L-i,N=y*_-m*k;(N*N/j>a||ie((m*_+y*k)/j-.5)>.3||l*u+s*x+p*d<Zi)&&(r(n,i,o,l,s,p,O,L,C,w/=R,E/=R,A,b,v),v.point(O,L),r(O,L,C,w,E,A,g,c,f,u,x,d,b,v))}}return function(n){var i,o,l,s,p,g,c,f,u,x,d,b,v={point:m,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=E},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function m(B,C){B=e(B,C),n.point(B[0],B[1])}function y(){f=NaN,v.point=j,n.lineStart()}function j(B,C){var M=nt([B,C]),O=e(B,C);r(f,u,c,x,d,b,f=O[0],u=O[1],c=B,x=M[0],d=M[1],b=M[2],yn,n),n.point(f,u)}function w(){v.point=m,n.lineEnd()}function E(){y(),v.point=A,v.lineEnd=R}function A(B,C){j(i=B,C),o=f,l=u,s=x,p=d,g=b,v.point=j}function R(){r(f,u,c,x,d,b,o,l,i,s,p,g,yn,n),v.lineEnd=w,w()}return v}}var as=Ra({point:function(e,a){this.stream.point(e*Ee,a*Ee)}});function ns(e){return Ra({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function rs(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function kn(e,a,r,n,i,o){if(!o)return rs(e,a,r,n,i);var l=ce(o),s=de(o),p=l*e,g=s*e,c=l/e,f=s/e,u=(s*r-l*a)/e,x=(s*a+l*r)/e;function d(b,v){return b*=n,v*=i,[p*b-g*v+a,r-g*b-p*v]}return d.invert=function(b,v){return[n*(c*b-f*v+u),i*(x-f*b-c*v)]},d}function os(e){return is(function(){return e})()}function is(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,g=0,c,f=0,u=1,x=1,d=null,b=fn,v=null,m,y,j,w=xa,E=.5,A,R,B,C,M;function O(N){return B(N[0]*Ee,N[1]*Ee)}function L(N){return N=B.invert(N[0],N[1]),N&&[N[0]*Be,N[1]*Be]}O.stream=function(N){return C&&M===N?C:C=as(ns(c)(b(A(w(M=N)))))},O.preclip=function(N){return arguments.length?(b=N,d=void 0,k()):b},O.postclip=function(N){return arguments.length?(w=N,v=m=y=j=null,k()):w},O.clipAngle=function(N){return arguments.length?(b=+N?qi(d=N*Ee):(d=null,fn),k()):d*Be},O.clipExtent=function(N){return arguments.length?(w=N==null?(v=m=y=j=null,xa):Pi(v=+N[0][0],m=+N[0][1],y=+N[1][0],j=+N[1][1]),k()):v==null?null:[[v,m],[y,j]]},O.scale=function(N){return arguments.length?(r=+N,_()):r},O.translate=function(N){return arguments.length?(n=+N[0],i=+N[1],_()):[n,i]},O.center=function(N){return arguments.length?(o=N[0]%360*Ee,l=N[1]%360*Ee,_()):[o*Be,l*Be]},O.rotate=function(N){return arguments.length?(s=N[0]%360*Ee,p=N[1]%360*Ee,g=N.length>2?N[2]%360*Ee:0,_()):[s*Be,p*Be,g*Be]},O.angle=function(N){return arguments.length?(f=N%360*Ee,_()):f*Be},O.reflectX=function(N){return arguments.length?(u=N?-1:1,_()):u<0},O.reflectY=function(N){return arguments.length?(x=N?-1:1,_()):x<0},O.precision=function(N){return arguments.length?(A=wn(R,E=N*N),k()):et(E)},O.fitExtent=function(N,T){return lr(O,N,T)},O.fitSize=function(N,T){return Qi(O,N,T)},O.fitWidth=function(N,T){return Ji(O,N,T)},O.fitHeight=function(N,T){return Xi(O,N,T)};function _(){var N=kn(r,0,0,u,x,f).apply(null,a(o,l)),T=kn(r,n-N[0],i-N[1],u,x,f);return c=Ei(s,p,g),R=fa(a,T),B=fa(c,R),A=wn(R,E),k()}function k(){return C=M=null,O}return function(){return a=e.apply(this,arguments),O.invert=a.invert&&L,_()}}function cr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}cr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ss(){return os(cr).scale(175.295)}function ls(e){return e}function cs(e){if(e==null)return ls;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var g=2,c=s.length,f=new Array(c);for(f[0]=(a+=s[0])*n+o,f[1]=(r+=s[1])*i+l;g<c;)f[g]=s[g],++g;return f}}function ds(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ps(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return jn(e,r)})}:jn(e,a)}function jn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=us(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function us(e,a){var r=cs(e.transform),n=e.arcs;function i(c,f){f.length&&f.pop();for(var u=n[c<0?~c:c],x=0,d=u.length;x<d;++x)f.push(r(u[x],x));c<0&&ds(f,d)}function o(c){return r(c)}function l(c){for(var f=[],u=0,x=c.length;u<x;++u)i(c[u],f);return f.length<2&&f.push(f[0]),f}function s(c){for(var f=l(c);f.length<4;)f.push(f[0]);return f}function p(c){return c.map(s)}function g(c){var f=c.type,u;switch(f){case"GeometryCollection":return{type:f,geometries:c.geometries.map(g)};case"Point":u=o(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(o);break;case"LineString":u=l(c.arcs);break;case"MultiLineString":u=c.arcs.map(l);break;case"Polygon":u=p(c.arcs);break;case"MultiPolygon":u=c.arcs.map(p);break;default:return null}return{type:f,coordinates:u}}return g(a)}const dr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},fs=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ms(e,a,r){const n=dr[e];if(!n||!n.length)return-1;const i=fs(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Rt=null;function xs(){return Rt||(Rt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ps(r,n),o=ss().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Ki(o),s=(i.features||[]).filter(c=>{var f;return(((f=c.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(c=>{var x;const f=((x=c.properties)==null?void 0:x.name)||"",u=l(c)||"";return u?{i2:Hr(f)||null,n:f,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const p={};for(const[c,f]of Object.entries(Yr)){const u=o(f);u&&(p[c]={x:u[0],y:u[1]})}const g={};for(const[c,f]of Object.entries(dr)){const u=f.map(x=>o(x.ll)).filter(x=>!!x).map(([x,d])=>({x,y:d}));u.length&&(g[c]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:g}}catch{return null}})(),Rt)}function hs(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return xs().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const gs={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Nn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Sn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function bs(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let i=!0,o=0;const l=()=>{var g;if(!i)return;const p=(g=e.current)==null?void 0:g.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function vs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p,data:g,dossiers:c}=F(),f=g.loading&&!c.length,u=h.useRef(null),x=h.useRef(null),d=hs(e.continent==="monde"),b=e.continent==="monde"?d:za.find(k=>k.key===e.continent)||null,v=bs(u,e.continent+":"+e.mapFolded+":"+!!b),[m,y]=h.useState(new Map),[j,w]=h.useState(null);h.useEffect(()=>{const k=u.current;if(!k)return;const N=new Map;k.querySelectorAll("path[data-i2]").forEach(T=>{const H=T.dataset.i2;if(H)try{const G=T.getBBox();G.width>0&&N.set(H,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(N)},[e.continent,v,b]);const E=h.useMemo(()=>r.filter(k=>k.cc),[r]),A=h.useMemo(()=>{const k=new Map;return E.forEach(N=>k.set(N.cc,(k.get(N.cc)||0)+1)),k},[E]),R=e.continent==="monde"&&d?d.anchors:null,B=e.continent==="monde"&&d?d.metros:null,C=h.useMemo(()=>E.map(k=>{const N=Sn(k.name||k.id||""),T=Sn((k.id||k.name||"")+"·y");if(R&&k.cc){const q=B?B[k.cc]:void 0;if(q&&q.length){const P=ms(k.cc,k.city,N);if(P>=0&&q[P])return{d:k,x:q[P].x+(N-.5)*5,y:q[P].y+(T-.5)*5}}const $=R[k.cc];if($)return{d:k,x:$.x+(N-.5)*10,y:$.y+(T-.5)*10}}const H=k.cc?m.get(k.cc):void 0;if(!H)return null;const G=gs[`${e.continent}:${k.cc||""}`];if(G)return{d:k,x:H.x+H.w*(G.fx+(N-.5)*G.sx),y:H.y+H.h*(G.fy+(T-.5)*G.sy)};const Z=(N-.5)*Math.min(H.w*.55,60),z=(T-.5)*Math.min(H.h*.55,60);return{d:k,x:H.x+H.w/2+Z,y:H.y+H.h/2+z}}).filter(k=>!!k),[E,m,R,B,e.continent]),M=k=>v>0?k/v:k,O=h.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:Nn[k],fr:p.plabels[k].toUpperCase(),en:p.plabels[k].toUpperCase(),n:r.filter(N=>N.kind==="target"&&ke(N)===k).length})).filter(k=>k.n>0):Ua.map((k,N)=>({...k,n:r.filter(T=>Va(T)===N).length})),[r,n,p.plabels]),L=o?l.get(o):null,_=L?C.find(k=>k.d.id===L.id):null;return b?t.jsxs("div",{className:"mapzone"+(f?" waiting":""),ref:x,children:[t.jsxs("svg",{ref:u,viewBox:b.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?b.fr:b.en,onMouseLeave:()=>{w(null),i(null)},children:[t.jsx("g",{children:b.countries.map((k,N)=>t.jsx("g",{className:"ct"+(k.i2&&A.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},N))}),t.jsx("g",{children:C.map(k=>{const N=Ua[Va(k.d)],T=!!he(k.d),H=k.d.kind==="target",G=n&&H?Nn[ke(k.d)]:N.c,Z=!n&&Ae(k.d);return t.jsxs("g",{className:"co"+(Z?" done":""),onMouseEnter:()=>{var $,P;const z=($=x.current)==null?void 0:$.getBoundingClientRect(),q=(P=u.current)==null?void 0:P.createSVGPoint();if(q&&u.current&&z){q.x=k.x,q.y=k.y;const D=q.matrixTransform(u.current.getScreenCTM());w({x:D.x-z.left,y:D.y-z.top,label:k.d.name+" · "+(st(k.d.cc,s)||k.d.countryLabel||"")})}i(k.d.id)},onMouseLeave:()=>{w(null),i(null)},onClick:()=>{var $;const z=($=u.current)==null?void 0:$.createSVGPoint();let q=null;if(z&&u.current){z.x=k.x,z.y=k.y;const P=z.matrixTransform(u.current.getScreenCTM());q={x:P.x,y:P.y}}a({type:"popup",id:k.d.id,anchor:q})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:M(Math.max(11,N.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:M(N.px),fill:G,stroke:T?"#DC2626":"#ffffff",strokeWidth:M(T?2.2:1.3)})]},k.d.id||k.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:O.map((k,N)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},N))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:x})}function ys(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function ws(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=F(),s=e.filters,p=h.useMemo(()=>e.continent==="monde"?r:r.filter(d=>d.continent===e.continent),[r,e.continent]),g=d=>p.filter(b=>d!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:Ta(b,s,i,d==="country"?void 0:d)),c=h.useMemo(()=>{const d=g("win"),b=v=>d.filter(m=>(m.date?Math.max(0,Math.floor((Date.now()-Date.parse(m.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),d.length]},[p,s,i]),f=h.useMemo(()=>s.day?g("win").filter(d=>(d.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),x=(d,b,v,m="fbtn")=>t.jsxs("button",{type:"button",className:m,"aria-expanded":e.openFacet===d,onClick:()=>a({type:"openFacet",facet:d}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},d);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(ys(s.day,l)),t.jsx("b",{children:f})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((d,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===d,onClick:()=>a({type:"filters",patch:{win:d}}),children:[n.dates[b],t.jsx("b",{children:c[b]})]},d))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:d=>a({type:"filters",patch:{search:d.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):x("sec",n.fSector,s.sector.length),x("pay",n.fCountry,s.country.length),x("det",n.fEngine,s.engine.length),x("sta",n.fStage,s.stage.length),i&&x("ang","Angle",s.angle.length),i&&x("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(ks,{poolFor:g})]})}function ks({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:g}=h.useMemo(()=>{if(l==="sig"){const d=e("signal").filter(m=>he(m)),b=new Map;d.forEach(m=>{const y=m.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:d.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...sa([...b.keys()],i).map(m=>({v:m,label:Ke(m)+" "+De(m,i),n:b.get(m)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(m)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const d=e("sector"),b=new Map;return d.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v,n:m,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const d=e("country"),b=new Map;return d.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:st(v,i)||v,n:m,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const d=e("engine"),b=new Map;return d.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:sa([...b.keys()],i).map(v=>({v,label:Ke(v)+" "+De(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Wr(Gr(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const d=e("angle"),b=new Map;return d.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v.replace(/[_-]+/g," "),n:m,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const d=e("memoLevel"),b=new Map;d.forEach(m=>{if(m.kind==="target"){const y=Ea(m);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(m=>({v:String(m),label:v[m],n:b.get(m)||0,html:!1,on:o.memoLevel.includes(m)}))}}const u=e("stage"),x=new Map;return u.forEach(d=>{d.stage&&x.set(d.stage,(x.get(d.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...x.entries()].sort((d,b)=>b[1]-d[1]).map(([d,b])=>({v:d,label:d,n:b,html:!1,on:o.stage.includes(d)}))}},[l,a,i]),c=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const d=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:d}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},f=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>c(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function pr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function js(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Cn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=F();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function ur({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=F(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Cn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Cn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Ns({card:e,onEvaluate:a,onAddAll:r}){var s,p,g;const{t:n}=F(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:pr(e.summary_md||"").map((c,f)=>t.jsx("p",{children:c},f))})]}),t.jsx(ur,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function Ss(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Cs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=F(),s=i,[p,g]=h.useState(null),[c,f]=h.useState(null),[u,x]=h.useState(null),[d,b]=h.useState(!1);h.useEffect(()=>{let m=!0;return(async()=>{const y=await Dn({email:l,cbToken:s});m&&g(y)})(),()=>{m=!1}},[l,s,n]);const v=m=>{f(m),x(null),b(!0),(async()=>{const y=await Kr(m.id);x(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),x(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[Ss(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?o.rsPub:o.rsPriv})]},m.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),d&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!d&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!d&&u&&t.jsx(Ns,{card:u,onEvaluate:a,onAddAll:r})]})]})}const En=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Es(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:g,data:c,canWrite:f,source:u}=F(),x=a==="client",d=h.useMemo(()=>r||(u!=="default"?Qr():""),[r,u]),[b,v]=h.useState(""),[m,y]=h.useState(!1),[j,w]=h.useState(""),[E,A]=h.useState(!1),[R,B]=h.useState(""),[C,M]=h.useState([]),O=h.useRef(!1),[L,_]=h.useState(!1),[k,N]=h.useState(""),[T,H]=h.useState(""),[G,Z]=h.useState(!1),[z,q]=h.useState(0),[$,P]=h.useState(""),[D,U]=h.useState(null),[W,X]=h.useState(null),[re,me]=h.useState(!1),[pe,Q]=h.useState(null),[te,ve]=h.useState(0),K=h.useRef(!1),se=b.trim()?En.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,ee=h.useMemo(()=>j.split(`
`).map(I=>I.trim()).filter(Boolean).slice(0,15),[j]);h.useEffect(()=>{if(typeof window>"u")return;const I=(new URLSearchParams(window.location.search).get("rs")||"").trim();!I||!/^https?:\/\//i.test(I)||(N(I),_(!0))},[]),h.useEffect(()=>{const I=ae=>{var ye;const oe=String(((ye=ae.detail)==null?void 0:ye.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(N(oe),_(!0))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),h.useEffect(()=>{if(!f&&!d){Q(null);return}let I=!0;return(async()=>{const ae=await Dn({email:n,cbToken:d});I&&Q(ae.length)})(),()=>{I=!1}},[f,d,n,te]);const Ue=C.length?C:p,xe=c.credits,ge=h.useCallback(I=>{const ae=I.map(oe=>(oe||"").trim()).filter(Boolean);ae.length&&(w(oe=>{const ye=oe.split(`
