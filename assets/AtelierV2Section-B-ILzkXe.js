...
body.pp-desk .atl2.cibles .srceng{position:relative;z-index:1}
/* Une pièce blanche : URL colle sous le LIVE, 62 retenues colle pile dessous.
   Pas de marge, pas de rayon, pas de filet — sinon les moteurs transparaissent. */
body.pp-desk .atl2.cibles .eval-stick.is-stuck{padding:0!important;background:#fff!important}
body.pp-desk .atl2.cibles .eval-stick.is-stuck .demand{border-radius:0!important;
...
body.pp-desk .atl2.cibles .listhead.mapoff{top:calc(var(--pp-gap,60px) + var(--pp-live-h,0px) + var(--demand-h,0px))!important;
  ...
  box-shadow:none!important;margin-top:0!important;z-index:40}
body.pp-desk .atl2.cibles .readpane{top:calc(var(--pp-gap,60px) + var(--pp-live-h,0px) + var(--demand-h,0px))!important;
  z-index:21}
...
/* ExtraFields hors des lignes. Analyser compact. La largeur 63/37 de
   l'édito est posée par EMBED_SCROLL_CSS (chrome=1) : ne pas forcer 100%. */
.atl2.cibles .desk{width:100%;min-width:0}
.atl2.cibles .desk-list{min-width:0;box-sizing:border-box}
...
.atl2.cibles .readpane{min-width:0;max-width:100%;box-sizing:border-box}
.atl2.cibles .readpane .edito-go,.atl2.cibles .readpane .pane-edito{
  min-width:0;max-width:100%;box-sizing:border-box;overflow:hidden}
.atl2.cibles .readpane .edito-go .eg-sub{min-width:0;overflow:hidden;
  text-overflow:ellipsis;white-space:nowrap}
.atl2.cibles .readpane .zoom{max-width:100%;box-sizing:border-box}
