...
`,rr=tr+ar;function nr(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function or(t,a){return t||a.mode!=="client"||!a.token?"visiteur":nr("teaser")==="1"?"apercu":"client"}const ir={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},lr=t=>ir[t],me=t=>Object.assign(t,{continent:ha(t.cc)});function He(t){const a=new Set,n=[];for(const r of t){const i=(r.name||"").toLowerCase();!i||a.has(i)||(a.add(i),n.push(r))}return n}const sr=60*60*1e3;function dr(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>sr?null:a}catch{return null}}function De(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const cr=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function pr(t,a,n="default"){const r=n!=="default",i=p.useMemo(()=>t||r?{mode:"anon"}:ca(),[t,r]),o=p.useMemo(()=>r?"visiteur":or(t,i),[t,i,r]),l=p.useMemo(()=>lr(o),[o]),d=o!=="visiteur",c=cr(n),[f,b]=p.useState([]),[s,v]=p.useState(""),[h,x]=p.useState(null),[g,m]=p.useState(null),[u,w]=p.useState(null),[S,k]=p.useState(()=>new Map),[y,C]=p.useState(()=>new Map),[z,N]=p.useState(""),[T,D]=p.useState(new Set),[q,E]=p.useState(null),[P,L]=p.useState(!0),[I,F]=p.useState(!1),[_,ie]=p.useState(0),[ce,Oe]=p.useState(0),ge=p.useRef(0),pe=p.useMemo(()=>{var V;if(o!=="client")return"";try{return((V=pa())==null?void 0:V.email)||""}catch{return""}},[o]);p.useEffect(()=>{const V=++ge.current;let U=!0;const M=()=>U&&V===ge.current,B=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),H=dr(B);return H?(b(H.objs.map(me)),H.fund&&v(H.fund),x(H.marketEstimate??null),m(H.criteria??null),w(H.stats??null),N(H.generatedAt||""),L(!1)):L(!0),(async()=>{try{if(n==="ops"){const ne=await $e(),ae=((ne==null?void 0:ne.recent_ops)||[]).map(J=>Ve(J,a)).filter(J=>!!J);if(!M())return;b(ae.map(me)),De(B,{objs:ae})}else if(typeof n=="object"){const ae=(await st()||[]).filter(X=>(X.slug||"")===n.research).map(X=>dt(X,a)).filter(X=>!!X),J=He(await ct(ae,a));if(!M())return;b(J.map(me)),De(B,{objs:J})}else if(d&&i.token){const ne=ua(i.token),ae=$e(),J=fa(i.token),X=ma(i.token),Ne=xa(i.token),$=await ne;let le=$?$.targets:[];M()&&$&&(v($.fund||""),x($.marketEstimate??null),m($.criteria??null),w($.stats??null),N($.generatedAt||""),b(le.map(me)),L(!1),F(!1));const[ue,Se,he,re]=await Promise.all([ae,J,X,Ne]),be=((ue==null?void 0:ue.recent_ops)||[]).map(oe=>Ve(oe,a)).filter(oe=>!!oe);if(le=[...le,...be],!M())return;b(le.map(me));const Ce=new Set;for(const oe of Se){const ve=(oe.id||oe.co||"").toString().trim().toLowerCase();ve&&Ce.add(ve.startsWith("t:")?ve:"t:"+ve)}D(Ce),k(he),C(re),$&&De(B,{fund:$.fund,marketEstimate:$.marketEstimate,criteria:$.criteria,stats:$.stats,generatedAt:$.generatedAt,objs:le})}else{const ne=ga(),ae=st(),J=$e(),X=await ne;M()&&X.length&&(b(He(X).map(me)),L(!1),F(!1));const[Ne,$]=await Promise.all([ae,J]),le=(Ne||[]).map(re=>dt(re,a)).filter(re=>!!re),ue=await ct(le,a),Se=(($==null?void 0:$.recent_ops)||[]).map(re=>Ve(re,a)).filter(re=>!!re),he=He([...X,...ue,...Se]);if(!M())return;b(he.map(me)),De(B,{objs:he})}M()&&F(!1)}catch{M()&&!H&&F(!0)}finally{M()&&L(!1)}})(),()=>{U=!1}},[d,i.token,a,_,c]),p.useEffect(()=>{if(!l.showCredits||!pe){E(null);return}let V=!0;return(async()=>{try{const U=await fetch(`${Ge}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:pe})});if(!U.ok)return;const M=await U.json();V&&M&&M.ok!==!1&&E(M)}catch{}})(),()=>{V=!1}},[l.showCredits,pe,ce]);const Y=p.useCallback(V=>D(new Set(V)),[]);return{session:i,mode:o,caps:l,fund:s,email:pe,marketEstimate:h,generatedAt:z,criteria:g,stats:u,thumbs:S,stages:y,dossiers:f,favIds:T,setFavIds:Y,credits:q,reloadCredits:()=>Oe(V=>V+1),loading:P,error:I,refresh:()=>ie(V=>V+1)}}const Mt=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),ur=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...Mt(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function fr(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(i=>i!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(i=>i!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Mt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Ie)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Ie=60;function tt(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!Q(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(Ke(t)))return!1;if(r!=="win"&&a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(we(t.date)>i)return!1}if(r!=="status"&&!n&&a.status!=="all"&&de(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Pt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:tt(t,a.filters,n)}function mr(t,a,n,r){return!(!Pt(t,a,n)||n&&!ba(t,a.ptab,r))}function at(t,a){const n=a.key,r=i=>{switch(n){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-we(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=Q(i);return o?100-(o.left??0):-1}}};return[...t].sort((i,o)=>{const l=r(i),d=r(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}function xr(){const{dossiers:t,st:a,t:n,dispatch:r,contName:i,pipe:o}=A(),l=p.useMemo(()=>{const c=s=>o?!0:s.continent===a.continent,f=t.filter(s=>c(s)&&Q(s)),b=t.filter(s=>c(s)&&s.kind==="op"&&!Q(s)&&(s.dealKind==="ma"||s.dealKind==="levee")&&we(s.date)<=2);return b.sort((s,v)=>(v.amountEur||0)-(s.amountEur||0)),[...at(f,{key:"signal",dir:-1}),...b].slice(0,40)},[t,a.continent,o]),d=c=>l.map(f=>e.jsxs("button",{type:"button",className:"tk"+(Z(f)?" spent":""),onClick:b=>{const s=b.currentTarget.getBoundingClientRect();r({type:"popup",id:f.id,anchor:{x:s.left+s.width/2,y:s.bottom}})},title:f.name+(f.tagline?" — "+f.tagline:""),children:[e.jsx(je,{o:f}),e.jsxs("span",{className:"who",children:[e.jsx(Ht,{o:f}),e.jsx("span",{className:"co",children:f.name})]}),typeof f.amountEur=="number"&&f.amountEur>0&&e.jsx("span",{className:"am",children:Fn(f.amountEur)}),f.sector&&e.jsx("span",{className:"mt",children:f.sector}),e.jsx(Be,{o:f}),e.jsx("span",{className:"tkgo",children:"→"})]},c+(f.id||f.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:l.length})]}),e.jsx("div",{className:"win",children:l.length?e.jsxs("div",{className:"run",children:[d(0),d(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(i)})})})]})}const gr="aDx8z7Hzksus",It="+33 6 83 10 72 86",vt="alexandre@proplace.co",hr=`tel:${It.replace(/[^\d+]/g,"")}`,yt="pp-rdv-slot";function br(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function vr(){const{t,caps:a,fund:n}=A(),r=a.showOnb,i=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:wr}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:hr,children:It}),t.rdvSubMid,e.jsx("a",{href:`mailto:${vt}`,children:vt})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(i).map(([o,l],d)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(d+1)}),e.jsx("b",{children:o}),e.jsx("span",{children:l})]},o))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(Ja,{filloutId:gr,parameters:n?{company_name:n}:void 0})})]})}function yr(){const[t,a]=p.useState(()=>typeof document>"u"?null:document.getElementById(yt));return p.useEffect(()=>{t||a(document.getElementById(yt))},[t]),t?Ae.createPortal(e.jsx(vr,{}),t):null}const wr=`
...
`;class G extends p.Component{constructor(){super(...arguments);it(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(n,r){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,n,r.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const kr=8;function jr(){const{t,lang:a,token:n,dossiers:r,caps:i,markRow:o,dispatch:l}=A(),[d,c]=p.useState(!1),[f,b]=p.useState(!1),[s,v]=p.useState(!1),h=n||"home",{names:x,verdicts:g}=p.useMemo(()=>{const k=[],y={};return r.forEach(C=>{C.kind!=="target"||!C.name||(k.push(C.name),y[C.name]=va(C)||"")}),{names:k,verdicts:y}},[r]),m=p.useMemo(()=>x.length?ya(h,x,g,a):null,[h,x.length]);if(!i.pipe||d||!m||m.firstVisit||!m.added.length&&!m.gone.length)return null;const u=f?m.added:m.added.slice(0,kr),w=m.added.length-u.length,S=k=>{const y=r.find(C=>C.name===k);y&&(o(y.id),l({type:"popup",id:y.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(m.added.length,m.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{c(!0),wa(h,x,g,m.fp,a)},children:"×"})]}),!!m.added.length&&e.jsxs("div",{className:"since-c",children:[u.map(k=>e.jsx("button",{type:"button",onClick:()=>S(k),children:k},k)),w>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>b(!0),children:t.sinceMore(w)})]}),!!m.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>v(k=>!k),children:t.sinceOut(m.gone.length)}),s&&m.gone.slice(0,20).map(k=>e.jsx("span",{className:"gone",children:k},k))]})]})}const _e=600,xe=62,wt="atl2:fstats";function Nr(){const{t,lang:a,data:n,caps:r,st:i,dispatch:o}=A(),[l,d]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(wt)==="on"}catch{return!1}}),c=n.stats,f=p.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),b=p.useMemo(()=>{if(c!=null&&c.since)return c.since;const w=new Date;return w.setDate(w.getDate()-((c==null?void 0:c.window_days)||30)),w.toISOString().slice(0,10)},[c==null?void 0:c.since,c==null?void 0:c.window_days]);if(!r.showFunnel||!c||typeof c.screened!="number")return null;const s=w=>a==="en"?w.slice(5,10):`${w.slice(8,10)}/${w.slice(5,7)}`,v=w=>w.toLocaleString(a==="en"?"en-US":"fr-FR"),h=f.reduce((w,S)=>Math.max(w,S.s||0),0),x=f.length?_e/f.length:0,g=Math.max(4,x-4),m=f.length>=5&&h>0,u=[[c.screened,t.funScreened(s(b)),c.screened_today],...typeof c.kept=="number"?[[c.kept,t.funKept,c.kept_today]]:[],...typeof c.analyzed=="number"?[[c.analyzed,t.funAnalyzed,c.analyzed_today]]:[],...typeof c.shown=="number"?[[c.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(l?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[u.map(([w,S,k],y)=>e.jsxs("span",{className:"fst-t",children:[y>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:v(w)}),e.jsx("i",{children:S}),l&&typeof k=="number"&&k>0&&e.jsx("em",{children:t.funToday(k)})]},S)),m&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?t.fstatsHide:t.fstatsShow,onClick:()=>{const w=!l;d(w),w&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(wt,w?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&m&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${_e} ${xe}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[f.map((w,S)=>{const k=(w.s||0)/h*(xe-4),y=(w.m||0)/h*(xe-4),C=S*x+(x-g)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${s(w.d)} — ${w.s} ${t.actScreened} · ${w.m} ${t.actKept}`}),e.jsx("rect",{x:C,y:xe-2-k,width:g,height:k,fill:"#cfe0d6"}),e.jsx("rect",{x:C,y:xe-2-y,width:g,height:y,fill:"#185c38"})]},w.d)}),e.jsx("line",{x1:0,y1:xe-1.5,x2:_e,y2:xe-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:s(f[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const Sr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Cr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:i}=A(),[o,l]=p.useState(""),[d,c]=p.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const f=(t.ceoStatus||"").trim(),b=(Le(t)||"").startsWith("CALL")&&te(t)===3,s=te(t)>=2,v=async x=>{if(o||x==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(x);const g=await i(t,x);l(""),g&&(c(!0),setTimeout(()=>c(!1),2200))},h=b?[["Validé",a.csYes],["Écarté",a.csNo]]:Sr.filter(([x])=>!(s&&x==="Retenu")).map(([x,g])=>[x,a[g]]);return e.jsxs("div",{className:"csp",onClick:x=>x.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([x,g])=>e.jsx("button",{type:"button",className:"csb"+(f===x?" on":"")+(o===x?" busy":""),disabled:!!o,onClick:()=>{v(x)},children:g},x)),d&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(zr,{o:t})]})}function zr({o:t}){const{t:a,saveNote:n,flash:r}=A(),[i,o]=p.useState(t.ceoNote||""),[l,d]=p.useState(!1),[c,f]=p.useState(!1),b=i.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(l||!b)return;d(!0);const v=await n(t,i.trim());d(!1),v&&(f(!0),setTimeout(()=>f(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:v=>o(v.target.value),onKeyDown:v=>{v.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:l||!b,onClick:()=>{s()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Er({placeholder:t,onDone:a}){const{t:n}=A(),[r,i]=p.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Tr({o:t}){var m;const{t:a,token:n,caps:r,canWrite:i,stageOf:o,setStage:l,flashErr:d}=A(),[c,f]=p.useState(!1);if(!r.pipe||!i||r.lockActions||te(t)!==4)return null;const b=o(t),s=(b==null?void 0:b.stage)||"todo",v=async u=>{if(c||u===s)return;f(!0);const w=b;l(t,{stage:u,stamps:(b==null?void 0:b.stamps)||{}});const S=Math.max(Date.now(),kt+=1);kt=S;const k=await ka(n,{company:t.name||"",stage:u,cts:S,deal_id:t.airtableId,check_id:t.checkId});f(!1),!k.stale&&(k.ok||(l(t,w),d(a.actErr)))},h=(m=b==null?void 0:b.stamps)==null?void 0:m.sent,x=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,g=s==="sent"&&h&&x>=4;return e.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,w])=>e.jsx("button",{type:"button",className:"stgb"+(s===u?" on":""),disabled:c,onClick:()=>{v(u)},children:w},u)),g&&e.jsx("span",{className:"stgj4",children:a.j4Badge(x)})]})}let kt=0;const qe=8,Me=340;function jt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function Ar({steps:t,onClose:a}){const{t:n,dispatch:r,counts:i,scoped:o,byId:l,st:d}=A(),[c,f]=p.useState(0),[b,s]=p.useState(null),[v,h]=p.useState([]),x=p.useRef(!1);p.useEffect(()=>{x.current||(x.current=!0,h(t.filter(y=>!!document.querySelector(y.need||y.sel))))},[t]);const g=v[c],m=c>=v.length;p.useEffect(()=>{g&&(g.ptab!==void 0&&d.ptab!==g.ptab&&r({type:"ptab",tab:g.ptab}),g.dens&&d.dens!==g.dens&&r({type:"dens",dens:g.dens}))},[c,g]);const u=p.useCallback(()=>{if(!g){s(null);return}const y=document.querySelector(g.sel);if(!y){s(null);return}y.scrollIntoView({block:"nearest",behavior:"smooth"}),s(y.getBoundingClientRect())},[g]);p.useLayoutEffect(()=>{u();const y=window.setTimeout(u,260),C=()=>u();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{window.clearTimeout(y),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[u]);const w=p.useRef(a);if(w.current=a,p.useEffect(()=>{const y=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),w.current()):C.key==="ArrowRight"?f(z=>z+1):C.key==="ArrowLeft"&&f(z=>Math.max(0,z-1))};return document.addEventListener("keydown",y,!0),()=>document.removeEventListener("keydown",y,!0)},[]),!v.length)return null;let S=null;if(m){const y=i[3]||0,C=o.find(z=>z.memoUrl)||[...l.values()].find(z=>z.memoUrl);y>0?S={title:y===1?n.ahaATitle1:n.ahaATitleN(y),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:C?S={title:n.ahaBTitle,body:n.ahaBBody(C.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:C.id}),a()}}:S={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let k={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Me};if(!m&&b){const y=b.bottom+14,z=window.innerHeight-y>190?y:Math.max(12,b.top-200);k={left:Math.min(Math.max(12,b.left+b.width/2-Me/2),window.innerWidth-Me-12),top:z,width:Me}}return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!m&&b&&e.jsx("div",{className:"tour-hole",style:{left:b.left-qe,top:b.top-qe,width:b.width+qe*2,height:b.height+qe*2}}),(m||!b)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(m?" fin":""),style:k,children:[m&&S?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:S.title}),e.jsx("p",{children:e.jsx(jt,{text:S.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>f(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:S.go,children:S.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(c+1,v.length)}),e.jsx("h3",{children:g==null?void 0:g.title}),e.jsx("p",{children:e.jsx(jt,{text:(g==null?void 0:g.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:c===0,onClick:()=>f(y=>Math.max(0,y-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>f(y=>y+1),children:c===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Lr(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:i}=A(),o=p.useMemo(()=>t.filter(s=>we(s.date)===0&&s.kind==="target"),[t]),l=p.useMemo(()=>o.filter(s=>a?te(s)===0:!Z(s)),[o,a]),d=o.length-l.length,c=o.length?Math.min(100,d/o.length*100):100;let f;a?f=n.morningThesis(o.length,d,l.length):o.length?d===0?f=n.goalSourced(o.length):d>=o.length?f=n.goalCleared:f=n.goalDone(d,o.length):f=n.goalSourced(0);const b=()=>{a?(i({type:"ptab",tab:0}),i({type:"filters",patch:{win:"1"}})):i({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:f}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:c+"%"}})}),l.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:b,children:a?n.morningEval(l.length):r.pileMode?n.goalContinue(l.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Or(){var D,q;const{t,lang:a,st:n,dispatch:r,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:f,startTour:b}=A(),[s,v]=p.useState(null),[h,x]=p.useState([]),g=c==="client";p.useEffect(()=>{if(!i||!o)return;let E=!0;return(async()=>{const[P,L]=await Promise.all([Qe(o),Rt(i)]);E&&(P&&v(P),x(L))})(),()=>{E=!1}},[i,o]);const m=(s==null?void 0:s.per_day)??null,u=((D=s==null?void 0:s.pool_order)==null?void 0:D.length)??0,w=h.filter(E=>E.status==="running").length,S=p.useMemo(()=>d.filter(E=>E.kind==="target"&&Z(E)).length,[d]),k=l.marketEstimate,y=typeof((q=l.stats)==null?void 0:q.screened)=="number"?l.stats.screened:S,C=k&&k>0?Math.min(100,Math.round(y/k*100)):null,z=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),N=(o||"P").split(/\s+/).map(E=>E[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const E=Date.parse(l.generatedAt||"");if(Number.isNaN(E))return"";const P=new Date(E),L=I=>String(I).padStart(2,"0");return`${L(P.getDate())}/${L(P.getMonth()+1)} à ${L(P.getHours())}:${L(P.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),T&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(T)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:b,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[C===null&&y>0&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsx("span",{className:"ev",children:e.jsx("b",{children:z(y)})})]}),C!==null&&k&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:C+"%"}})}),e.jsxs("b",{children:[C," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(y,k)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>r({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),m!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"q",children:m})," ",t.identPerDay]}),e.jsx("span",{className:"edv"})]}),m===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),w>0&&e.jsxs("span",{className:"ev",children:["⏳ ",w]}),e.jsx("span",{className:"ego",children:t.identPending(u)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:E=>{E.stopPropagation(),r({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!g,onClick:f,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:n.filters.search,onChange:E=>r({type:"filters",patch:{search:E.target.value}})})]})]})]})}function Rr(){const{t,counts:a,dispatch:n}=A();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,i],o)=>{const l=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(l?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:i}),l&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Fr=["--p0","--p1","--p2","--p3","--p4"];function Dr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:i}=A(),o=p.useRef({});p.useEffect(()=>{o.current={...n}},[n]);const l=f=>{const b=o.current[f],s=b!==void 0?n[f]-b:0;return e.jsxs("button",{type:"button",className:"step"+(f===3&&n[3]>0?" wait":""),style:{"--c":`var(${Fr[f]})`,"--tc":f<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===f,title:r.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[e.jsxs("span",{className:"l",children:[r.plabels[f].toUpperCase(),f===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[f],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},f)},d=(f,b,s)=>e.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":f===5?"var(--p5)":f===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===f,title:r.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[f]})]},f),c=(f,b,s,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:b,disabled:v,onClick:s,children:f},b);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),e.jsxs("div",{className:"offtrack",children:[d(5,!1,r.plabels[5]),d(7,!0,r.plabels[7]),d(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[c("↩",r.toolUndo,i,t.undo.length===0),c("↺",r.toolReset,()=>{a({type:"reset"})}),c("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),c("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),c("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const qr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Mr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:i,doAnalyse:o,mode:l}=A(),d=p.useRef(null),[c,f]=p.useState(60);p.useEffect(()=>{let h=0;const x=()=>{var S;const g=d.current;if(!g)return;const m=(S=g.parentElement)==null?void 0:S.querySelector('.funnel [aria-selected="true"]');if(!m)return;const u=m.getBoundingClientRect(),w=g.getBoundingClientRect();f(Math.max(20,Math.min(u.left+u.width/2-w.left,w.width-30)))};return h=requestAnimationFrame(x),window.addEventListener("resize",x),()=>{cancelAnimationFrame(h),window.removeEventListener("resize",x)}},[t.ptab]);const b=t.ptab;let s=n.tuto[b].p;if(b===3){const h=r.filter(m=>m.kind==="target"&&te(m)===3),x=h.filter(m=>Ye(m)==="auto").length,g=h.filter(m=>Ye(m)==="cd").length;s=n.tutoPending(x,g,h.length)}const v=(()=>{if(l!=="client")return null;if(b===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(h=>h.id)})};if(b===1){const h=r.filter(x=>x.kind==="target"&&te(x)===1&&!i.has(x.id)).slice(0,10);if(h.length)return{label:n.tuto[1].a,run:()=>h.forEach(x=>o(x))}}return null})();return e.jsxs("div",{ref:d,className:"tuto mini",style:{"--bg":qr[b],"--ax":c+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[b].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const Nt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function St(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Pr(t,a){const[n,r]=p.useState(1);return p.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const c=(f=t.current)==null?void 0:f.getScreenCTM();c&&c.a>0?r(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return t.current&&d.observe(t.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[t,a]),n}function Ir(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:i,markedId:o,byId:l,lang:d,t:c}=A(),f=p.useRef(null),b=p.useRef(null),s=Je.find(N=>N.key===t.continent),v=Pr(f,t.continent+":"+t.mapFolded),[h,x]=p.useState(new Map),[g,m]=p.useState(null);p.useEffect(()=>{const N=f.current;if(!N)return;const T=new Map;N.querySelectorAll("path[data-i2]").forEach(D=>{const q=D.dataset.i2;if(q)try{const E=D.getBBox();E.width>0&&T.set(q,{x:E.x,y:E.y,w:E.width,h:E.height})}catch{}}),x(T)},[t.continent,v]);const u=p.useMemo(()=>n.filter(N=>N.cc),[n]),w=p.useMemo(()=>{const N=new Map;return u.forEach(T=>N.set(T.cc,(N.get(T.cc)||0)+1)),N},[u]),S=p.useMemo(()=>u.map(N=>{const T=N.cc?h.get(N.cc):void 0;if(!T)return null;const D=St(N.name||N.id||""),q=St((N.id||N.name||"")+"·y"),E=(D-.5)*Math.min(T.w*.55,60),P=(q-.5)*Math.min(T.h*.55,60);return{d:N,x:T.x+T.w/2+E,y:T.y+T.h/2+P}}).filter(N=>!!N),[u,h]),k=N=>v>0?N/v:N,y=p.useMemo(()=>r?[0,1,2,3,4,5].map(N=>({c:Nt[N],fr:c.plabels[N].toUpperCase(),en:c.plabels[N].toUpperCase(),n:n.filter(T=>T.kind==="target"&&te(T)===N).length})).filter(N=>N.n>0):pt.map((N,T)=>({...N,n:n.filter(D=>ut(D)===T).length})),[n,r,c.plabels]),C=o?l.get(o):null,z=C?S.find(N=>N.d.id===C.id):null;return e.jsxs("div",{className:"mapzone",ref:b,children:[e.jsxs("svg",{ref:f,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":d==="fr"?s.fr:s.en,onMouseLeave:()=>{m(null),i(null)},children:[e.jsx("g",{children:s.countries.map((N,T)=>e.jsx("g",{className:"ct"+(N.i2&&w.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},T))}),e.jsx("g",{children:S.map(N=>{const T=pt[ut(N.d)],D=!!Q(N.d),q=N.d.kind==="target",E=r&&q?Nt[te(N.d)]:T.c,P=!r&&Z(N.d);return e.jsxs("g",{className:"co"+(P?" done":""),onMouseEnter:()=>{var F,_;const L=(F=b.current)==null?void 0:F.getBoundingClientRect(),I=(_=f.current)==null?void 0:_.createSVGPoint();if(I&&f.current&&L){I.x=N.x,I.y=N.y;const ie=I.matrixTransform(f.current.getScreenCTM());m({x:ie.x-L.left,y:ie.y-L.top,label:N.d.name+" · "+(ke(N.d.cc,d)||N.d.countryLabel||"")})}i(N.d.id)},onMouseLeave:()=>{m(null),i(null)},onClick:()=>{var F;const L=(F=f.current)==null?void 0:F.createSVGPoint();let I=null;if(L&&f.current){L.x=N.x,L.y=N.y;const _=L.matrixTransform(f.current.getScreenCTM());I={x:_.x,y:_.y}}a({type:"popup",id:N.d.id,anchor:I})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:k(Math.max(11,T.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:k(T.px),fill:E,stroke:D?"#DC2626":"#ffffff",strokeWidth:k(D?2.2:1.3)})]},N.d.id||N.d.name)})}),z&&e.jsx("circle",{className:"ring on",cx:z.x,cy:z.y,r:k(13),fill:"none",stroke:"#0F172A",strokeWidth:k(2)})]}),e.jsx("div",{className:"hov"+(g?" on":""),style:g?{left:g.x,top:g.y}:void 0,children:g==null?void 0:g.label}),e.jsx("div",{className:"legend",children:y.map((N,T)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),d==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},T))}),n.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",c.notLocated," ",e.jsx("b",{children:n.filter(N=>!N.cc).length})]})})]})}function Br(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:i,contName:o}=A(),l=t.filters,d=p.useMemo(()=>n.filter(h=>h.continent===t.continent),[n,t.continent]),c=h=>d.filter(x=>h!=="country"&&l.country.length&&!l.country.includes(x.cc||"")?!1:tt(x,l,i,h==="country"?void 0:h)),f=p.useMemo(()=>{const h=c("win"),x=g=>h.filter(m=>(m.date?Math.max(0,Math.floor((Date.now()-Date.parse(m.date))/864e5)):9999)<=g).length;return[x(0),x(7),x(30),h.length]},[d,l,i]),b=p.useMemo(()=>{if(i)return null;const h=c("status"),x={all:h.length,todo:0,retenu:0,pending:0,ecarte:0};return h.forEach(g=>{x[de(g)]+=1}),x},[d,l,i]),s=l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+(l.signalOnly?1:0)+(l.win!=="all"?1:0)+(!i&&l.status!=="all"?1:0)+(l.search.trim()?1:0),v=(h,x,g,m="fbtn")=>e.jsxs("button",{type:"button",className:m,"aria-expanded":t.openFacet===h,onClick:()=>a({type:"openFacet",facet:h}),children:[e.jsx("span",{className:"fl",children:x}),g>0&&e.jsx("span",{className:"n",children:g}),e.jsx("span",{className:"cv",children:"▾"})]},h);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((h,x)=>e.jsxs("button",{type:"button","aria-pressed":l.win===h,onClick:()=>a({type:"filters",patch:{win:h}}),children:[r.dates[x],e.jsx("b",{children:f[x]})]},h))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:l.search,onChange:h=>a({type:"filters",patch:{search:h.target.value}})})]}),!i&&b&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([h,x])=>e.jsxs("button",{type:"button","aria-pressed":l.status===h,onClick:()=>a({type:"filters",patch:{status:h}}),children:[x,e.jsx("b",{children:b[h]??0})]},h))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),l.signalOnly&&e.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,l.sector.length),v("pay",r.fCountry,l.country.length),v("det",r.fEngine,l.engine.length),v("sta",r.fStage,l.stage.length),i&&v("ang","Angle",l.angle.length),i&&v("mem","Mémo",l.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(d.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx($r,{poolFor:c})]})}function $r({poolFor:t}){const{st:a,dispatch:n,t:r,lang:i}=A(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:f}=p.useMemo(()=>{if(l==="sig"){const x=t("signal").filter(u=>Q(u)),g=new Map;x.forEach(u=>{const w=u.engine||"";g.set(w,(g.get(w)||0)+1)});const m=[{v:"*",label:r.fpSigAll,n:x.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ft([...g.keys()],i).map(u=>({v:u,label:ye(u)+" "+se(u,i),n:g.get(u)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(u)}))];return{title:r.fpSigTitle,cols:2,options:m}}if(l==="sec"){const x=t("sector"),g=new Map;return x.forEach(m=>{m.sector&&g.set(m.sector,(g.get(m.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((m,u)=>u[1]-m[1]).map(([m,u])=>({v:m,label:m,n:u,html:!1,on:o.sector.includes(m)}))}}if(l==="pay"){const x=t("country"),g=new Map;return x.forEach(m=>{m.cc&&g.set(m.cc,(g.get(m.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((m,u)=>u[1]-m[1]).map(([m,u])=>({v:m,label:ke(m,i)||m,n:u,html:!1,on:o.country.includes(m)}))}}if(l==="det"){const x=t("engine"),g=new Map;return x.forEach(m=>{m.engine&&g.set(m.engine,(g.get(m.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:ft([...g.keys()],i).map(m=>({v:m,label:ye(m)+" "+se(m,i)+' <span style="color:var(--dim);font-size:10px">· '+ja(Na(m),i)+"</span>",n:g.get(m)||0,html:!0,on:o.engine.includes(m)}))}}if(l==="ang"){const x=t("angle"),g=new Map;return x.forEach(m=>{m.angle&&g.set(m.angle,(g.get(m.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((m,u)=>u[1]-m[1]).map(([m,u])=>({v:m,label:m.replace(/[_-]+/g," "),n:u,html:!1,on:o.angle.includes(m)}))}}if(l==="mem"){const x=t("memoLevel"),g=new Map;x.forEach(u=>{if(u.kind==="target"){const w=Ke(u);g.set(w,(g.get(w)||0)+1)}});const m=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(u=>({v:String(u),label:m[u],n:g.get(u)||0,html:!1,on:o.memoLevel.includes(u)}))}}const v=t("stage"),h=new Map;return v.forEach(x=>{x.stage&&h.set(x.stage,(h.get(x.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((x,g)=>g[1]-x[1]).map(([x,g])=>({v:x,label:x,n:g,html:!1,on:o.stage.includes(x)}))}},[l,a,i]),b=v=>{if(l==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const x=o.signalEngines.includes(v)?o.signalEngines.filter(g=>g!==v):[...o.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:x}})}return}if(l==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:v})},s=()=>{n(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:d}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(c===2?" two":""),children:f.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>b(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const Ct=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Vr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:i,dispatch:o,evalBusy:l,evalCards:d,caps:c,data:f}=A(),b=a==="client",[s,v]=p.useState(""),[h,x]=p.useState(!1),[g,m]=p.useState(""),[u,w]=p.useState(!1),[S,k]=p.useState(""),[y,C]=p.useState([]),z=p.useRef(!1),N=s.trim()?Ct.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,T=p.useMemo(()=>g.split(`
`).map(L=>L.trim()).filter(Boolean).slice(0,15),[g]),D=y.length?y:d,q=f.credits,E=()=>{const L=s.trim();L&&(r(null,L),v(""))},P=async()=>{if(!b){r(null,T[0]||"");return}if(!T.length||u)return;w(!0),z.current=!1;const L=[];for(let I=0;I<T.length&&!z.current;I++){k(t.evaluating(I+1,T.length,T[I]));const F=await Ft(n,T[I],"atelier2");if(L.unshift({name:F.company||T[I],verdict:F.verdict,reason:F.reason||"",remaining:F.remaining??null}),C([...L]),F.verdict==="quota"){L.unshift({name:"",verdict:"quota",reason:t.quota(T.length-I-1),remaining:0}),C([...L]);break}}k(""),m(""),w(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:L=>v(L.target.value),onKeyDown:L=>{L.key==="Enter"&&E()}}),e.jsx("span",{className:"detect"+(Ct.test(s.trim())?" url":""),children:N})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),disabled:l,onClick:E,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),c.showCredits&&q&&e.jsxs("button",{type:"button",className:"credits"+(q.total_available<=0&&!q.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:q.unlimited?"∞":q.total_available}),!q.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",q.daily_grant+q.purchased]}),q.total_available<=0&&!q.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>x(!h),children:t.evalMulti})}),h&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:g,placeholder:t.bulkPh,onChange:L=>m(L.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{justifyContent:"center"},disabled:u||!T.length,onClick:()=>{P()},children:[e.jsx("span",{className:"fill"}),u&&S?S:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(T.length)})]})]}),D.slice(0,1).map((L,I)=>{const F=L.verdict==="kept",_=L.verdict==="quota",ie=F?"var(--brand)":_?"var(--bolt)":"var(--red)",ce=F?"var(--brand-l)":_?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":ie,"--bgc":ce},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:F?"✓ "+t.kept:_?"⏳":"✗ "+t.dropped})}),L.name&&e.jsx("span",{className:"rn",children:L.name}),e.jsx("span",{className:"rr",children:L.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",L.reason]}):null}),!_&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(F?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},I)}),b&&(i.kept+i.dropped>0||D.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(i.kept,i.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Ur(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Hr(){const{st:t,dispatch:a,byId:n,t:r,doDeep:i}=A(),o=t.memoConsole?n.get(t.memoConsole):null,l=p.useMemo(()=>o?[o.reasoning||"",Ur(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const d=Le(o),c=Ke(o);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:o.name}),d&&e.jsx("span",{className:"vv",children:d}),typeof o.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:r.memoSynth})}),e.jsx("div",{className:"mb2",children:l?l.split(`

`).map((f,b)=>e.jsx("p",{style:{margin:"0 0 10px"},children:f},b)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[Xe(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:c===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}const _r=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Pe=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Yr(t){const a=String(t||"");if(!a)return"";let n="",r=0;for(;r<a.length;){const i=a.indexOf("<",r);if(i<0){n+=Pe(a.slice(r));break}n+=Pe(a.slice(r,i));const o=a.indexOf(">",i);if(o<0){n+=Pe(a.slice(i));break}const l=a.slice(i+1,o).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&_r.has(c)?n+=`<${d[1]}${c}>`:n+=Pe(a.slice(i,o+1)),r=o+1}return n}const zt=(t,a)=>{const n=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(n)?a==="en"?n:`${n.slice(8,10)}/${n.slice(5,7)}/${n.slice(0,4)}`:""};function K({k:t,v:a,href:n}){return a==null||a===""?null:e.jsxs("div",{className:"cdl",children:[e.jsx("span",{className:"cdk",children:t}),n?e.jsx("a",{className:"cdv",href:n,target:"_blank",rel:"noopener noreferrer",children:String(a)}):e.jsx("span",{className:"cdv",children:String(a)})]})}function Wr({o:t}){const{t:a,lang:n,dispatch:r,caps:i}=A(),o=Ze(t),l=Le(t),d=(t.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[t.sector,t.stage,t.countryLabel,t.city,t.website,t.domain,t.linkedinCompany,t.angle,t.date].filter(Boolean).length,f=[t.contactName,t.contactEmail,t.contactLinkedin].filter(Boolean).length,b=[t.ceoStatus,t.ceoNote,i.pipe?t.memoUrl:"",i.pipe?t.memoPdfUrl:""].filter(Boolean).length+(typeof t.engagement=="number"&&t.engagement>0?1:0),s=p.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(t.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:t.summary?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:b}].filter(g=>g.n>0),[t,a,d,l,c,f,b]),[v,h]=p.useState("");if(!s.length)return null;const x=s.some(g=>g.k===v)?v:s[0].k;return e.jsxs("div",{className:"cdtabs",children:[e.jsx("div",{className:"cdnav",role:"tablist",children:s.map(g=>e.jsx("button",{type:"button",role:"tab","aria-selected":x===g.k,className:x===g.k?"on":"",onClick:m=>{m.stopPropagation(),h(g.k)},children:g.lib},g.k))}),e.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[x==="conv"&&e.jsxs(e.Fragment,{children:[d&&e.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[e.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),e.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.reasoning&&e.jsx("p",{className:"cdtxt",children:t.reasoning}),l&&e.jsxs("div",{className:"cdv1 memo",children:[e.jsx("b",{children:l}),e.jsx("span",{className:"cdw",children:a.cdMemo(t.memoType||"")})]}),e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(K,{k:a.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(K,{k:a.cdVerdictDate,v:zt(t.verdictDate,n)})]})]}),x==="ana"&&t.summary&&e.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Yr(t.summary)}}),x==="soc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdSector,v:t.sector}),e.jsx(K,{k:a.cdStage,v:t.stage}),e.jsx(K,{k:a.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(K,{k:a.cdSite,v:t.domain||t.website,href:t.website||void 0}),e.jsx(K,{k:a.cdLinkedin,v:t.linkedinCompany?"LinkedIn":"",href:t.linkedinCompany}),e.jsx(K,{k:a.cdAngle,v:t.angle}),e.jsx(K,{k:a.cdDetected,v:zt(t.date,n)})]}),x==="ctc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdName,v:t.contactName}),e.jsx(K,{k:a.cdEmail,v:t.contactEmail,href:t.contactEmail?`mailto:${t.contactEmail}`:void 0}),e.jsx(K,{k:a.cdLinkedin,v:t.contactLinkedin?"LinkedIn":"",href:t.contactLinkedin})]}),x==="suivi"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdCeoStatus,v:t.ceoStatus}),e.jsx(K,{k:a.cdEngagement,v:typeof t.engagement=="number"&&t.engagement>0?t.engagement:""})]}),t.ceoNote&&e.jsxs("p",{className:"cdtxt",children:["💬 ",t.ceoNote]}),i.pipe&&(t.memoUrl||t.memoPdfUrl)&&e.jsxs("div",{className:"cdacts",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),t.memoPdfUrl&&e.jsx("a",{className:"abtn",href:t.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Bt({name:t}){const{t:a,token:n,caps:r,mode:i,flashErr:o}=A(),[l,d]=p.useState(!1),[c,f]=p.useState(null);if(!r.pipe||i!=="client"||r.lockActions)return null;const b=async()=>{if(l)return;d(!0);const s=await Sa(n,t);if(d(!1),!s){o(a.actErr);return}f(s.results||[])};return e.jsxs("div",{className:"simb",onClick:s=>s.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{b()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:c.map(s=>e.jsxs("li",{children:[e.jsx("b",{className:s.verdict==="kept"?"ok":"ko",children:s.company}),s.reason&&e.jsx("span",{children:s.reason})]},s.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const $t={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function rt({o:t}){const{t:a}=A(),n=Ze(t),r=Le(t),i=te(t),o=Ye(t),l=Ca(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+($t[r]||"v-cons"),title:a.vt[r],children:r}):i===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&e.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}function Et({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:i}=A(),[o,l]=p.useState(!1);if(p.useEffect(()=>{r||l(!1)},[r]),Z(t)){const f=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[f?"✓":"✗"," ",e.jsx("b",{children:f?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const c=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:r,onClick:f=>{f.stopPropagation(),l(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function Gr({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:i,doAnalyse:o,doDecide:l,doPromote:d,doRepeche:c,doApproach:f,dispatch:b}=A();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:h=>{h.stopPropagation(),b({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(Et,{o:t})});const s=te(t),v=h=>x=>{x.stopPropagation(),h()};if(s===0)return e.jsx("span",{className:"cell",children:e.jsx(Et,{o:t})});if(s===1){const h=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:h,onClick:v(()=>o(t)),children:h?a.actAnalyseQueued:a.actAnalyse})})}if(s===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:v(()=>l(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:v(()=>l(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})});if(s===4){const h=i.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:h,onClick:v(()=>f(t)),children:h?a.actApproachSent:a.actApproach})})}return s===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>d(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})}):s===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>c(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:v(()=>b({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function Kr({o:t}){const{t:a,doThumb:n,thumbOf:r}=A(),i=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function Qr({o:t}){const{lang:a}=A();return Q(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(je,{o:t}),e.jsx(Be,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[ye(t.engine||"")," ",se(t.engine||"",a)]})})}function Jr({o:t,locked:a,open:n,onToggle:r}){const{st:i,dispatch:o,caps:l,markRow:d,markedId:c,favIds:f,toggleFav:b}=A(),s=te(t),v=["#0F172A","#475C6E","#8798A8","#B9C6D2"],h=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,x=h<=0?0:h<=7?1:h<=30?2:3,g=l.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][s]:v[x],m=f.has(t.id),u=w=>{if(a)return;if(l.pipe){r();return}const S=w.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"row"+(c===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>d(t.id),onMouseLeave:()=>d(null),onClick:u,children:[e.jsx("span",{className:"pt",style:{"--c":g}}),e.jsx(Ht,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[l.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:m?1:.35,padding:0,marginRight:4},onClick:w=>{w.stopPropagation(),b(t)},children:m?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(w=>w&&w!==t.name)||""})]}),e.jsx(Xr,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(Qr,{o:t}),l.pipe&&e.jsx(rt,{o:t}),l.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(Gr,{o:t}),l.showThumbs&&e.jsx(Kr,{o:t})]}),(n||i.dens==="deplie")&&!a&&e.jsx(Zr,{o:t})]})}function Xr({o:t}){const{lang:a,caps:n}=A();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=et(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function Zr({o:t}){const{t:a,lang:n,dispatch:r,caps:i,outbound:o,doOnboard:l}=A();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),e.jsx(Wr,{o:t}),e.jsx(Cr,{o:t}),e.jsx(Tr,{o:t}),e.jsx(Bt,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(rt,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[ye(t.engine||"")," ",se(t.engine||"",n)]}),Q(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(je,{o:t})})]}),i.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(t),children:a.actOnboard})]})]})]})}function en({o:t,locked:a}){const{t:n,dispatch:r,caps:i,doDecide:o}=A(),l=te(t),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":d},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(rt,{o:t}),Q(t)&&e.jsx(je,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&i.pipe&&l===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function tn(){const t=A(),{st:a,dispatch:n,t:r,caps:i,scoped:o,lang:l,sessTally:d,data:c,dossiers:f}=t,[b,s]=p.useState(new Set);p.useEffect(()=>{s(new Set)},[a.ptab,a.continent]);const v=y=>s(C=>{const z=new Set(C);return z.has(y)?z.delete(y):z.add(y),z}),h=p.useMemo(()=>at(o,a.sort),[o,a.sort]),x=p.useMemo(()=>h.filter(y=>Q(y)&&!Z(y)).length,[h]),g=i.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,m=(y,C,z="",N=!1)=>e.jsxs("button",{type:"button","data-s":y,className:z,"aria-sort":a.sort.key===y?a.sort.dir===1?"ascending":"descending":"none",style:N?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:y}),children:[C,e.jsx("span",{className:"ar",children:a.sort.key===y&&a.sort.dir===1?"▴":"▾"})]},y),u=p.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const y=new Map;return h.forEach(C=>{const z=C.engine||"?";y.has(z)||y.set(z,[]),y.get(z).push(C)}),[...y.entries()]},[h,i.pipe,a.groupBy]),w=i.lockRowsAfter;let S=0;const k=(y,C)=>{const z=a.shown[C]||Ie,T=y.slice(0,z).map(D=>{const q=w!==null&&S>=w;return S++,a.dens==="maxi"?e.jsx(en,{o:D,locked:q},D.id):e.jsx(Jr,{o:D,locked:q,open:b.has(D.id),onToggle:()=>v(D.id)},D.id)});return y.length>z&&T.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:C,by:Ie}),children:r.more(Math.min(Ie,y.length-z),y.length-z)},C+":more")),T};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:h.length})," ",g]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,i.pipe&&t.fund?" · "+t.fund:""]}),i.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),i.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([y,C])=>e.jsxs("button",{type:"button","data-d":y,"aria-pressed":a.dens===y,onClick:()=>n({type:"dens",dens:y}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:C})]},y))}),i.showChain&&h.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:h.filter(y=>i.pipe?!0:!Z(y)).map(y=>y.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",i.pipe?r.browse(h.length):r.chainAll(h.filter(y=>!Z(y)).length)]})]}),x>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(x)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),m("country",r.colCountry),m("name",r.colCompany),m("amount",r.colAmount,"h-amt",!0),m("stage",r.colStage,"h-stade"),m("signal",r.colSignal,"h-sig"),i.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),i.pipe&&m("score",r.colScore,"h-sc",!0),e.jsx("span",{}),i.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[u?u.map(([y,C])=>e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:ye(y)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:se(y,l)}),e.jsx("div",{className:"s",children:r.grpCount(C.filter(z=>!Z(z)).length,C.length)})]})]}),k(C,y)]},y)):k(h,"pt"+a.ptab),!h.length&&!(c.loading&&!f.length)&&e.jsx("div",{className:"void",children:i.pipe?r.emptyTab:r.emptyScope})]}),i.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(d.kept>0||d.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(d.kept,d.dropped)}})]})}const an=`
...
`;function rn(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,i=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let l=t.y+10;return l+n>i-8&&(l=Math.max(8,t.y-n-14)),l<8&&(l=8),{left:o,top:l}}function nn(){const{st:t,dispatch:a,byId:n,t:r,lang:i,caps:o,mode:l,askEvaluate:d,doAnalyse:c,doDecide:f,doPromote:b,doRepeche:s,doApproach:v,doDeep:h,doOnboard:x,outbound:g,evalBusy:m}=A(),u=t.popupId?n.get(t.popupId):null;if(!u)return null;const w=Q(u),S=te(u),k=Le(u),y=u.kind==="target",C=z=>{a({type:"filters",patch:z}),a({type:"popup",id:null})};return Ae.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:an}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:rn(t.popupAnchor),onClick:z=>z.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:u.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(we(u.date)),se(u.engine,i))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[u.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[u.cc]}),children:(ke(u.cc,i)||u.countryLabel||"").toUpperCase()}),u.sector&&e.jsx("button",{type:"button",onClick:()=>C({sector:[u.sector]}),children:u.sector.toUpperCase()}),u.stage&&e.jsx("button",{type:"button",onClick:()=>C({stage:[u.stage]}),children:u.stage.toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{className:"am2",children:et(u.amountEur,i)})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[ye(u.engine)," ",e.jsx("b",{children:se(u.engine,i)})," — ",za(u.engine,i),u.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",u.noteTitle]})]}),w?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(je,{o:u,lg:!0})," ",e.jsx(Be,{o:u,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(Dt(w,i))," · ",r.win7(qt(w,i))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&S>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),o.pipe&&y&&k&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[k,typeof u.score=="number"&&u.score>0?" · "+r.score(u.score):""]})})]}),e.jsx(Bt,{name:u.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[S===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:m,onClick:()=>d(u),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),S===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),S===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{b(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),S===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(u,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(u,!1),a({type:"popup",id:null})},children:r.actNo}),Xe(u)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{h(u),a({type:"popup",id:null})},children:r.memoDeep})]}),S===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{v(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),S===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),u.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:u.id}),a({type:"popup",id:null})},children:"📄"}),g&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{x(u),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:m,onClick:()=>d(u),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),u.website&&e.jsx("a",{className:"psite",href:u.website.startsWith("http")?u.website:"https://"+u.website,target:"_blank",rel:"noopener noreferrer",title:u.website,children:"🌐"})]})]})]}),document.body)}function Tt(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function on(t,a){const n=Ea(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function ln(t,a){const r=[a.head.split("|").map(Tt).join(";")];for(const i of t){const o=a.stageOf(i);r.push([i.name||"",on(i,a.plabels),Ze(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Tt).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function sn(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const dn=50;function nt({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:i}=A(),[o,l]=p.useState(null),[d,c]=p.useState(!1),[f,b]=p.useState(""),[s,v]=p.useState(0),[h,x]=p.useState(""),[g,m]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>()=>{u.current&&window.clearInterval(u.current)},[]);const w=async k=>{c(!0),b("");const y=await a();if(c(!1),y.ok){l(y);return}if(y.busy){b(i.alertPreviewBusy);return}if(!k){b(i.alertPreviewFail);return}v(dn),u.current=window.setInterval(()=>{v(C=>C>1?C-1:(u.current&&window.clearInterval(u.current),w(!1),0))},1e3)},S=async()=>{if(r||g)return;m(!0),x("");const k=await n();m(!1),x(k.ok?i.alertTestOk(k.sentTo||""):k.error||i.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:d||s>0,onClick:()=>{w(!0)},children:d?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||g,onClick:()=>{S()},children:g?"…":i.alertTest})]}),s>0&&e.jsx("p",{className:"mnote",children:i.alertPreviewRetry(s)}),f&&e.jsx("p",{className:"mnote warn",children:f}),h&&e.jsx("p",{className:"mnote",children:h}),!h&&e.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Te="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function ee({title:t,icon:a,children:n,wide:r}){const{dispatch:i}=A();return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function cn(){const{st:t}=A();switch(t.modal){case"chain":return e.jsx(un,{});case"space":return e.jsx(fn,{});case"alert":return e.jsx(mn,{});case"queue":return e.jsx(vn,{});case"export":return e.jsx(yn,{});case"plug":return e.jsx(jn,{});case"recharge":return e.jsx(Sn,{});case"cover":return e.jsx(Cn,{});case"crit":return e.jsx(zn,{});case"tuto":return e.jsx(En,{});case"rdv":return e.jsx(pn,{});case"memoalert":return e.jsx(wn,{});default:return null}}function pn(){const{dispatch:t,fund:a}=A(),n=typeof document<"u"&&!!document.getElementById("rdv");return p.useEffect(()=>{n&&(t({type:"modal",modal:null}),br())},[n,t]),n?null:e.jsx(La,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function un(){const{st:t,dispatch:a,byId:n,t:r,lang:i,mode:o,askEvaluate:l,evalBusy:d}=A(),c=o==="client",f=t.chain.queue.map(h=>n.get(h)).filter(h=>!!h),b=t.chain.idx,s=f[b],v=b>=f.length;return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:v?r.finished:`${b+1} / ${f.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(v?100:b/Math.max(1,f.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:v||!s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(f.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:s.name}),e.jsx("div",{className:"sub",children:[ke(s.cc,i)||s.countryLabel,s.sector,s.stage,r.daysAgo(we(s.date))].filter(Boolean).map(h=>String(h).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:se(s.engine,i).toUpperCase()}),typeof s.amountEur=="number"&&s.amountEur>0&&e.jsx("span",{children:et(s.amountEur,i)})]}),Q(s)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(je,{o:s,lg:!0})," ",e.jsx(Be,{o:s,src:!0})]}),(s.tagline||s.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:s.tagline||s.headline})]}),s.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:s.reasoning})]}),c&&Z(s)&&e.jsxs("div",{className:"vbox",style:{"--c":de(s)==="retenu"?"var(--brand)":de(s)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:de(s)==="retenu"?"✓ "+r.kept:de(s)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:s.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!v&&s&&!(c&&Z(s))&&e.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(s)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?r.closeBtn:r.skip})]})]})})}),document.body)}function fn(){const{st:t,dispatch:a,dossiers:n,t:r,mode:i}=A(),o=i==="client",l=p.useMemo(()=>o?n.filter(s=>Z(s)):[],[n,o]),d=p.useMemo(()=>at(l.filter(s=>de(s)==="retenu"),{key:"signal",dir:-1}),[l]),c=p.useMemo(()=>l.filter(s=>de(s)==="ecarte"),[l]),f=t.spaceTab==="retenu"?d:c,b=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(ee,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:d.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:c.length})]})]}),f.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),f.slice(0,40).map(s=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":b},children:typeof s.score=="number"&&s.score>0?s.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:s.name}),e.jsx("div",{className:"rr",children:s.reasoning||s.tagline||""})]})]},s.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function mn(){const{mode:t}=A();return t==="client"||t==="apercu"?e.jsx(xn,{}):e.jsx(bn,{})}function xn(){const{t,token:a,flash:n,flashErr:r,mode:i}=A(),[o,l]=p.useState("d"),d=i!=="client";return e.jsxs(ee,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:t.alertTabWeekly})]}),o==="d"?e.jsx(gn,{t,token:a,readOnly:d,flash:n,flashErr:r}):e.jsx(hn,{t,token:a,readOnly:d,flash:n,flashErr:r})]})}function gn({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,l]=p.useState(null),[d,c]=p.useState(!1),[f,b]=p.useState(0);p.useEffect(()=>{let x=!0;return c(!1),gt(a).then(g=>{x&&(g?l(g):c(!0))}),()=>{x=!1}},[a,f]);const s=x=>{n||gt(a,x).then(g=>{if(!g){i(t.actErr);return}l(g),g.throttled?i(t.alertThrottled):r(t.alertSaved)})};if(d)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(x=>x+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=x=>!o.sections||o.sections.includes(x),h=x=>{const g=o.sections||t.alertSec.map(([m])=>m);s({sections:v(x)?g.filter(m=>m!==x):[...g,x]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([x,g])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:v(x),disabled:n,onChange:()=>h(x)}),e.jsxs("span",{children:[g,x==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},x))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(nt,{label:t.alertPreview,readOnly:n,onPreview:()=>Pa(a),onTest:()=>Ma(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function hn({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,l]=p.useState(null),[d,c]=p.useState(!1),[f,b]=p.useState(0);p.useEffect(()=>{let x=!0;return c(!1),ht(a).then(g=>{x&&(g?l(g):c(!0))}),()=>{x=!1}},[a,f]);const s=x=>{n||ht(a,x).then(g=>{if(!g){i(t.actErr);return}l(g),r(t.alertSaved)})};if(d)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(x=>x+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=o.dow??0,h=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:v,disabled:n,onChange:x=>s({dow:Number(x.target.value)}),children:t.alertDow.map((x,g)=>e.jsx("option",{value:g,children:x},x))}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,h-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[h," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,h+1)}),disabled:n,children:"＋"})]})]}),e.jsx(nt,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>Ba(a),onTest:()=>Ia(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function bn(){const{st:t,t:a,lang:n,scoped:r,contName:i}=A(),[o,l]=p.useState(""),[d,c]=p.useState(!1),[f,b]=p.useState(!1),s=t.filters,v=p.useMemo(()=>r.filter(m=>Q(m)).length,[r]),h=s.win==="1"?0:s.win==="7"?1:s.win==="30"?2:3,x=async()=>{if(!(!/.+@.+\..+/.test(o)||f)){b(!0);try{await fetch(`${Ge}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o.trim(),sectors:s.sector,countries:s.country,source:"atelier2",website:""})}),c(!0)}finally{b(!1)}}},g=[[a.amRows.continent,i],[a.amRows.since,a.amSince[h]],[a.amRows.signal,s.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,s.engine.length?s.engine.map(m=>se(m,n)).join(", "):a.amAllEngines],[a.amRows.sectors,s.sector.length?s.sector.join(", "):a.amAllSectors],[a.amRows.countries,s.country.length?s.country.map(m=>ke(m,n)||m).join(", "):a.amAllCountries],[a.amRows.stages,s.stage.length?s.stage.join(", "):a.amAllStages]];return e.jsx(ee,{title:a.alertTitle,icon:"🔔",children:d?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(o)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:g.map(([m,u])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:m}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:u}})]},m))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:o,onChange:m=>l(m.target.value),onKeyDown:m=>{m.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function vn(){var g,m,u;const{t,token:a,fund:n,mode:r,flash:i}=A(),[o,l]=p.useState(null),[d,c]=p.useState([]),[f,b]=p.useState(0),s=r==="client";p.useEffect(()=>{let w=!0;return(async()=>{const[S,k]=await Promise.all([Qe(n),Rt(a)]);w&&(S&&l(S),c(k))})(),()=>{w=!1}},[a,n,f]);const v=(o==null?void 0:o.per_day)??2,h=((g=o==null?void 0:o.analyzed_today)==null?void 0:g.length)??0,x=(m=o==null?void 0:o.tomorrow)!=null&&m.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(ee,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(h,h+(((u=o==null?void 0:o.pool_order)==null?void 0:u.length)??0))}})}),e.jsxs("div",{className:"qrate",children:[t.covRate," — ",e.jsx("b",{children:t.covRateNow(v)})]})]}),d.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:d.map(w=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:w.company}),e.jsxs("span",{className:"qd",children:[w.memo_type,typeof w.est_min=="number"?` · ~${w.est_min} min`:""]}),e.jsx("span",{className:"qt",children:w.status}),w.url&&e.jsx("a",{className:"qgo",href:w.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),s&&w.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{xt(a,w.company,"retry").then(()=>b(S=>S+1))},children:t.queueRetry}),s&&w.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{xt(a,w.company,"delete").then(()=>b(S=>S+1))},children:t.queueDelete})]},w.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[x.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),x.slice(0,10).map((w,S)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",S+1]}),e.jsx("b",{children:w.name}),typeof w.score=="number"&&e.jsx("span",{className:"qs2",children:w.score})]},w.name))]})]})}function yn(){const{t,token:a,flash:n,scoped:r,caps:i,stageOf:o,dispatch:l}=A(),d=`${Te}/cibles/list.csv?token=${a}`,c=`${Te}/cibles/list.json?token=${a}`,f=`${Te}/cibles/export.xlsx?token=${a}&scope=full`,b=`=IMPORTDATA("${d}")`,s=m=>{var u;(u=navigator.clipboard)==null||u.writeText(m).then(()=>n(t.exportCopied))},v=[{def:t.exportCsv,value:d,href:d},{def:t.exportSheet,value:b},{def:t.exportLive,value:c,href:c},{def:t.exportXlsx,value:f,href:f}],h=!i.lockActions&&r.length>0,x=()=>{sn(ln(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:m=>(t.stg.find(([u])=>u===m)||["",""])[1]})),n(t.exportViewDone(r.length))},g=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return e.jsxs(ee,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),h&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🖨️"}),e.jsxs("div",{children:[e.jsx("b",{children:t.printTitle}),e.jsx("p",{children:t.printDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb",onClick:g,children:t.printBtn})]})}),h&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:x,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:v.map(({def:m,value:u,href:w})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:m[0]}),e.jsxs("div",{children:[e.jsx("b",{children:m[1]}),e.jsx("p",{children:m[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>s(u),children:t.exportCopy}),w&&e.jsx("a",{className:"exb",href:w,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},m[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function wn(){const{t,token:a,flash:n,flashErr:r,mode:i}=A(),o=i!=="client",[l,d]=p.useState(null),[c,f]=p.useState(!1),[b,s]=p.useState(0),[v,h]=p.useState(!1);p.useEffect(()=>{let u=!0;return f(!1),mt(a).then(w=>{u&&(w?d(w):f(!0))}),()=>{u=!1}},[a,b]);const x=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=u=>{if(o||!l)return;const w={enabled:u.enabled??!!l.enabled,email:u.email??(l.email||""),sections:u.sections??x()};h(!0),mt(a,w).then(S=>{if(h(!1),!S){r(t.memoAlertErr);return}d(S),n(t.memoAlertSaved)})};if(c)return e.jsx(ee,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:t.retry})]})});if(!l)return e.jsx(ee,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const m=x();return e.jsxs(ee,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||v,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),e.jsx(kn,{value:l.email||"",readOnly:o||v,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:u=>g({email:u})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([u,w])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!m[u],disabled:o||v,onChange:()=>g({sections:{...m,[u]:!m[u]}})}),e.jsx("span",{children:w})]},u))}),e.jsx(nt,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>Aa(a,m),onTest:()=>Ta(a,m)})]})}function kn({value:t,readOnly:a,label:n,okLabel:r,onSave:i}){const[o,l]=p.useState(t);p.useEffect(()=>{l(t)},[t]);const d=o.trim()!==t.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&d&&c&&i(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>i(o.trim()),children:r})]})]})}function jn(){const{t,token:a,flash:n,flashErr:r,canWrite:i}=A(),[o,l]=p.useState(null),[d,c]=p.useState(!1),[f,b]=p.useState(null),[s,v]=p.useState(""),[h,x]=p.useState(0);p.useEffect(()=>{let u=!0;return c(!1),We(a).then(w=>{u&&(w?l({configured:w.configured,url_hint:w.url_hint}):c(!0))}),Ra(a).then(w=>{u&&b(w)}),()=>{u=!1}},[a,h]);const g=(u,w)=>{i&&We(a,u).then(S=>{if(!S||S.ok===!1){r(t.actErr);return}u.test&&S.sent===!1?r(t.plugTestThrottled):n(w),x(k=>k+1)})},m='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(ee,{title:t.plugTitle,icon:"🔌",wide:!0,children:[f&&e.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?t.plugAutoOn(f.destination||"webhook"):t.plugAutoOff}),d?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>x(u=>u+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:s,disabled:!i,onChange:u=>v(u.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!i||!s.trim(),onClick:()=>g({url:s.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(Nn,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:m}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var u;(u=navigator.clipboard)==null||u.writeText(m).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function Nn(){const{t,token:a,lang:n}=A(),[r,i]=p.useState("valides"),[o,l]=p.useState(!1),[d,c]=p.useState(null),[f,b]=p.useState(null),[s,v]=p.useState(!1),[h,x]=p.useState(!1),[g,m]=p.useState(null),[u,w]=p.useState(null),[S,k]=p.useState(null),y=`atl2:bulk:${a}:${r}`;p.useEffect(()=>{We(a).then(E=>{w(E&&E.configured?E.url_hint||"webhook":null)})},[a]),p.useEffect(()=>{c(null),b(null),v(!1),m(null);try{const E=JSON.parse(localStorage.getItem(y)||"null");k(E&&Date.now()-Date.parse(E.t)<24*3600*1e3?E:null)}catch{k(null)}},[y]);const C=async()=>{l(!0),v(!1),m(null);const E=await Da(a,r);c(E),b(E.ok?r:null),l(!1)},z=p.useRef(!1),N=async()=>{if(z.current)return;z.current=!0,x(!0);const E=`${a}:${r}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let P;try{P=await qa(a,r,"webhook",void 0,E)}finally{z.current=!1}if(x(!1),v(!1),m(P),P.ok&&(P.pushed||0)>0){const L={t:new Date().toISOString(),n:P.pushed||0};k(L);try{localStorage.setItem(y,JSON.stringify(L))}catch{}}},T=d!=null&&d.ok&&d.ready||0,D=!!(d!=null&&d.ok)&&f===r&&T>0&&!!u&&!S,q=S?new Date(S.t).toLocaleString(n==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:r,onChange:E=>i(E.target.value),children:t.plugBulkTabs.map(([E,P])=>e.jsx("option",{value:E,children:P},E))}),e.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{C()},children:o?"…":t.plugBulkPreview})]}),d&&(d.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr})),!!(d!=null&&d.ok)&&e.jsx("p",{className:"mnote dim",children:t.bulkScope}),S&&e.jsx("p",{className:"mnote",children:t.bulkLocked(q,S.n)}),!S&&!!(d!=null&&d.ok)&&!u&&e.jsx("p",{className:"mnote warn",children:t.bulkNoDest}),!S&&!d&&e.jsx("p",{className:"mnote dim",children:t.bulkPreviewFirst}),D&&!s&&e.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>v(!0),children:t.bulkArm}),D&&s&&e.jsxs("div",{className:"bulkc",children:[e.jsx("p",{className:"mnote warn",children:t.bulkWarn(T,u||"")}),e.jsx("button",{type:"button",className:"abtn dgr",disabled:h,onClick:()=>{N()},children:h?t.bulkSending:t.bulkConfirm(u||"")}),e.jsx("button",{type:"button",className:"abtn",disabled:h,onClick:()=>v(!1),children:t.bulkCancel})]}),g&&(g.ok?g.replayed?e.jsx("p",{className:"mnote",children:g.pending?t.bulkPending:t.bulkReplayed}):(g.pushed||0)>0?e.jsx("p",{className:"mnote",children:t.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):e.jsx("p",{className:"mnote warn",children:t.bulkNone}):e.jsx("p",{className:"mnote warn",children:g.error||t.actErr}))]})}function Sn(){const{t,data:a,lang:n}=A(),r=a.credits,i=a.email,o=async l=>{if(!i)return;const d=window.location.href.split("?")[0];try{const f=await(await fetch(`${Ge}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return e.jsxs(ee,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(l=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(l.credits,l.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:t.rechargeBuy})]},l.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function Cn(){const{t,lang:a,data:n,dossiers:r,token:i,canWrite:o,flash:l}=A(),[d,c]=p.useState(null),[f,b]=p.useState(!1);p.useEffect(()=>{let y=!0;return Qe(i).then(C=>{y&&C&&typeof C.per_day=="number"&&c(C.per_day)}),()=>{y=!1}},[i]);const s=n.stats,v=typeof(s==null?void 0:s.screened)=="number"?s.screened:r.filter(y=>y.kind==="target"&&Z(y)).length,h=n.marketEstimate||0,x=h>0?Math.min(100,Math.round(v/h*100)):null,g=(s==null?void 0:s.window_days)||30,m=v>0?v/g:0,u=h>0?Math.max(0,h-v):0,w=h>0&&m>0?Math.round(u/m):null,S=y=>Math.round(y).toLocaleString(a==="en"?"en-US":"fr-FR"),k=y=>{f||!o||(b(!0),Fa(i,y).then(C=>{if(b(!1),C===null){l(t.actErr);return}c(C),l(t.alertSaved)}))};return e.jsxs(ee,{title:t.coverTitle,icon:"🌍",children:[e.jsxs("div",{className:"covg",children:[e.jsx("b",{children:t.covScreened(S(v))}),h>0&&e.jsx("span",{children:t.covOf(S(h))})]}),x!==null?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"covbar",children:[e.jsx("i",{style:{width:x+"%"}}),e.jsxs("em",{children:[x," %"]})]}),w!==null&&e.jsx("p",{className:"mnote",children:t.covEta(w)})]}):e.jsx("p",{className:"mnote dim",children:t.covNoEst}),m>0&&e.jsx("p",{className:"mnote",children:t.covPace(S(m))}),s&&e.jsxs("div",{className:"covf",children:[typeof s.kept=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:S(s.kept)})," ",t.covKept]}),typeof s.analyzed=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:S(s.analyzed)})," ",t.covAna]}),typeof s.shown=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:S(s.shown)})," ",t.covShown]})]}),o&&d!==null&&e.jsxs("div",{className:"covr",children:[e.jsxs("div",{className:"covrh",children:[e.jsx("span",{children:t.covRate}),e.jsx("b",{children:t.covRateNow(d)})]}),e.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(y=>e.jsx("button",{type:"button",className:d===y?"on":"",disabled:f,onClick:()=>k(y),children:y===0?"⏸":y},y))}),e.jsx("p",{className:"mnote dim",children:t.covRateHint})]})]})}function zn(){var u,w,S;const{t,dossiers:a,token:n,mode:r,flash:i,criteria:o}=A(),l=r==="client",d=p.useMemo(()=>{const k=new Set;return a.forEach(y=>{y.angle&&k.add(y.angle)}),[...k]},[a]),[c,f]=p.useState(null);p.useEffect(()=>{let k=!0;return Oa(n).then(y=>{k&&f(y.thumbs)}),()=>{k=!1}},[n]);const[b,s]=p.useState(""),[v,h]=p.useState(""),[x,g]=p.useState(!1),m=async()=>{const k=b.trim();if(!(!k||x||!l)){g(!0),h("");try{const C=await(await fetch(`${Te}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:k,who:"atelier2"})})).json().catch(()=>({}));if(C.reply&&h(String(C.reply)),C.job_id){h(t.critChatRunning);const z=async()=>{const N=await fetch(`${Te}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:C.job_id})}).then(T=>T.json()).catch(()=>null);if(N&&N.done){h(String(N.reply||N.clarification||N.summary||"✓")),g(!1),N.applied&&i(t.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),s("");return}s("")}finally{v.startsWith("⏳")||g(!1)}}};return e.jsxs(ee,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((u=o.points)!=null&&u.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(k=>e.jsx("li",{children:k},k))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((w=o==null?void 0:o.angles)!=null&&w.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(k=>{var y,C;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:k.title}),k.why&&e.jsx("p",{className:"why",children:k.why}),e.jsxs("div",{className:"lo",children:[!!((y=k.look)!=null&&y.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:k.look.map(z=>e.jsx("li",{children:z},z))})]}),!!((C=k.out)!=null&&C.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:k.out.map(z=>e.jsx("li",{children:z},z))})]})]})]},k.title)})]}),!!((S=o==null?void 0:o.gate)!=null&&S.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(k=>e.jsxs("li",{children:[k.k&&e.jsx("b",{children:k.k}),k.t]},k.t))})]}),d.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:d.map(k=>e.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:b,disabled:!l||x,onChange:k=>s(k.target.value),onKeyDown:k=>{k.key==="Enter"&&m()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(x?" loading":""),style:{padding:"12px 18px"},disabled:!l||x||!b.trim(),onClick:()=>void m(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),v&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:v})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),c===null?e.jsx("div",{className:"sp-empty",children:"…"}):c.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:c.slice(0,12).map((k,y)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:k.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:k.company}),e.jsx("span",{className:"qd",children:(k.ts||"").slice(0,10)})]},y))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([k,y])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+($t[k]||"v-cons"),children:k}),e.jsx("span",{children:y})]},k))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([k,y])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:k}),e.jsxs("span",{children:["← ",y]})]},k))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function En(){const{t,dispatch:a,startTour:n}=A(),r=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return e.jsxs(ee,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([i,o],l)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:l+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const Vt="atl2:mapfold",Tn=()=>{if(typeof window>"u")return!1;try{const t=localStorage.getItem(Vt);if(t==="on")return!0;if(t==="off")return!1}catch{}return window.innerHeight<1e3},Ut=p.createContext(null),A=()=>{const t=p.useContext(Ut);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function je({o:t,lg:a}){const{lang:n}=A(),r=Q(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:bt(r,n),children:[r.emoji," ",bt(r,n)]}):null}function Be({o:t,src:a}){const{lang:n,t:r}=A(),i=Q(t);if(!i)return null;const o=_a(i),l=Ya(i);return e.jsxs("em",{className:"sigwin"+(l?" hot":""),title:r.signaledOn(Dt(i,n))+" · "+r.win7(qt(i,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>e.jsx("i",{className:c<o?"on":""},c))}),e.jsx("span",{className:"lb",children:l?r.lastDay:r.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&e.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Ht({o:t}){const{lang:a}=A(),n=Ha(t.cc),r=t.cc?ke(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const At="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",_t=t=>`atl2:tour:${t||"anon"}`;function An(t){try{return localStorage.getItem(_t(t))==="1"}catch{return!0}}function Lt(t){try{localStorage.setItem(_t(t),"1")}catch{}}function Ln(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function Mn({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:i,onFiltersChange:o}){const{lang:l}=$a(),d=er[l],c=pr(t,l,a),[f,b]=p.useReducer(fr,void 0,()=>ur((r==null?void 0:r.continent)??"europe",t||Tn(),{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),s=p.useRef(!0);p.useEffect(()=>{if(s.current){s.current=!1;return}if(!t)try{localStorage.setItem(Vt,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,t]);const v=p.useRef(o);v.current=o,p.useEffect(()=>{var j;(j=v.current)==null||j.call(v,f.filters)},[f.filters]);const[h,x]=p.useState(null),[g,m]=p.useState(null),[u,w]=p.useState({kept:0,dropped:0}),[S,k]=p.useState(!1),[y,C]=p.useState(""),[z,N]=p.useState(!1),[T,D]=p.useState(null),[q,E]=p.useState(!1),[P,L]=p.useState(!1),[,I]=p.useState(0),F=()=>I(j=>j+1),_=p.useRef([]),ie=p.useRef(new Set),ce=p.useRef(new Set),Oe=p.useRef(new Map),ge=p.useRef(null),{mode:pe}=c,Y=p.useMemo(()=>i?{...c.caps,...i}:c.caps,[c.caps,i]),V=Y.pipe,U=c.session.token||"",M=pe==="client"&&!t;p.useEffect(()=>{if(document.querySelector(`link[href="${At}"]`))return;const j=document.createElement("link");j.rel="stylesheet",j.href=At,document.head.appendChild(j)},[]);const B=(j,O=!1)=>{C(j),N(O),ge.current&&clearTimeout(ge.current),ge.current=setTimeout(()=>C(""),O?4200:2400)},H=j=>B(j,!0),ne=p.useMemo(()=>{const j=new Map;return c.dossiers.forEach(O=>{O.id&&j.set(O.id,O)}),j},[c.dossiers]),ae=p.useMemo(()=>c.dossiers.filter(j=>Pt(j,f,V)),[c.dossiers,f,V]),J=p.useRef(!1);p.useEffect(()=>{if(J.current||t||c.loading||!c.dossiers.length)return;if(!Y.showFunnel||An(c.session.token||"")){J.current=!0;return}J.current=!0;const j=window.setTimeout(()=>{Lt(c.session.token||""),E(!0)},700);return()=>window.clearTimeout(j)},[t,c.loading,c.dossiers.length,Y.showFunnel,c.session.token]);const X=p.useMemo(()=>c.dossiers.filter(j=>mr(j,f,V,c.favIds)),[c.dossiers,f,V,c.favIds]),Ne=p.useMemo(()=>Va(ae,c.favIds),[ae,c.favIds]),$=Je.find(j=>j.key===f.continent),le=l==="fr"?$.fr:$.en,ue=(j,O)=>{const R=((j==null?void 0:j.name)||O||"").trim();if(!M){m({kicker:R});return}!R||S||(k(!0),(async()=>{try{const W=await Ft(U,R,"atelier2"),Re={name:W.company||R,verdict:W.verdict,reason:W.reason||"",remaining:W.remaining??null};_.current=[Re,..._.current].slice(0,8),W.verdict==="kept"&&w(fe=>({...fe,kept:fe.kept+1})),W.verdict==="ruled_out"&&w(fe=>({...fe,dropped:fe.dropped+1}));const ze=j||c.dossiers.find(fe=>(fe.name||"").toLowerCase()===R.toLowerCase());ze&&(W.verdict==="kept"?ze.verdict=ze.verdict||"MATCH":W.verdict==="ruled_out"&&(ze.verdict="NO MATCH"),W.reason&&(ze.reasoning=W.reason)),F()}finally{k(!1)}})())},Se=j=>{if(!M){m({kicker:j.name});return}ie.current.add(j.id),Ee(U,"fast_request",j.name||"",""),B(d.memoInstantSent(j.name)),F()},he=j=>Oe.current.get(j.id)??c.thumbs.get((j.name||"").trim().toLowerCase()),re=(j,O)=>b({type:"undoPush",entry:{id:j.id,name:j.name,prevCeoStatus:O}}),be=async(j,O,R)=>{const W=j.ceoStatus||"";j.ceoStatus=O,F();const Re=await Ue(U,{status:O,airtable_id:j.airtableId,check_id:j.checkId,company:j.name,...(R==null?void 0:R.note)!==void 0?{note:R.note}:{},...R!=null&&R.via?{via:R.via}:{}});return Re.ok?Re.skipped?(j.ceoStatus=W,F(),H(d.actNotPersisted),!1):((R==null?void 0:R.undo)!==!1&&re(j,W),R!=null&&R.msg&&B(R.msg),(O==="Validé"||O==="Écarté")&&!j.ceoNote&&(R==null?void 0:R.note)===void 0&&D({o:j,yes:O==="Validé"}),!0):(j.ceoStatus=W,F(),H(d.actErr),!1)},Ce=async(j,O)=>{const R=await Ue(U,{status:j.ceoStatus||"Retenu",airtable_id:j.airtableId,check_id:j.checkId,company:j.name,note:O,via:"note"});return!R.ok||R.skipped?(H(R.skipped?d.actNotPersisted:d.actErr),!1):(j.ceoNote=O,F(),!0)},oe=p.useRef(new Map),ve=j=>oe.current.has(j.id)?oe.current.get(j.id):c.stages.get((j.name||"").trim().toLowerCase()),Yt=(j,O)=>{oe.current.set(j.id,O),F()},Wt=(j,O)=>{M&&be(j,O?"Validé":"Écarté",{msg:O?d.decidedYes(j.name):d.decidedNo(j.name)})},Gt=j=>{M&&be(j,"À trancher",{msg:d.promoted(j.name)})},Kt=j=>{M&&(async()=>{const O=j.ceoStatus||"";j.ceoStatus="Retenu",F();const R=await Ue(U,{status:"Retenu",check_id:j.checkId,company:j.name});if(!R.ok||R.skipped){j.ceoStatus=O,F(),H(R.skipped?d.actNotPersisted:d.actErr);return}re(j,O),B(d.repeched(j.name))})()},Qt=()=>{const j=f.undo[f.undo.length-1];if(!j){B(d.undoNone);return}const O=ne.get(j.id);if(!O){b({type:"undoPop"}),B(d.undoNone);return}let R=j.prevCeoStatus;if(!R)if((O.verdict||"").toUpperCase().includes("CALL"))R="À trancher";else{B(d.undoLockedTitle);return}(async()=>await be(O,R,{undo:!1})&&(b({type:"undoPop"}),O.ceoStatus=j.prevCeoStatus,F(),B(d.undoDone(O.name))))()},Jt=j=>{M&&(ce.current.add(j.id),F(),(async()=>{const O=await Wa(U,j.name,"email");if(!O||O.ok===!1){ce.current.delete(j.id),F(),H(d.actErr);return}Ee(U,"approach",j.name||"",""),B(d.actApproachSent)})())},Xt=(j,O)=>{M&&(async()=>{if(!(await Ee(U,O?"yes":"no",j.name||"","")).ok){H(d.actErr);return}Oe.current.set(j.id,O?"yes":"no"),F(),B(O?d.thumbUpDone:d.thumbDnDone)})()},Zt=j=>{!M||!Xe(j)||(Ee(U,"detailed_request",j.name||"",""),B(d.memoDeepSent(j.name)))},ea=j=>{const O=new Set(c.favIds),R=O.has(j.id);R?O.delete(j.id):O.add(j.id),c.setFavIds(O),M&&Ga(U,{id:j.id,co:j.name},R)},ta=()=>{!M||P||window.confirm(d.identSyncConfirm)&&(L(!0),(async()=>{const j=await Ka(U);L(!1),j?B(d.identSyncDone):H(d.actErr)})())},ot=/proplace/i.test(c.fund||""),aa=j=>{!M||!ot||(Ee(U,"onboard_request",j.name||"",""),B(d.onboardSent(j.name)))},ra={st:f,dispatch:b,t:d,lang:l,mode:pe,caps:Y,pipe:V,token:U,fund:c.fund,email:c.email,criteria:c.criteria,data:c,doRepeche:Kt,thumbOf:he,canWrite:M,commitStatus:be,saveNote:Ce,stageOf:ve,setStage:Yt,flashErr:H,startTour:()=>E(!0),dossiers:c.dossiers,scopedAll:ae,scoped:X,counts:Ne,byId:ne,contName:le,favIds:c.favIds,toggleFav:ea,askEvaluate:ue,doAnalyse:Se,doDecide:Wt,doPromote:Gt,doApproach:Jt,doThumb:Xt,doDeep:Zt,doUndo:Qt,doSync:ta,doOnboard:aa,outbound:ot,memoQueued:ie.current,approachDone:ce.current,sessTally:u,evalCards:_.current,evalBusy:S,markRow:x,markedId:h,flash:B};return p.useEffect(()=>{const j=O=>{O.key==="Escape"&&(b({type:"popup",id:null}),b({type:"modal",modal:null}),b({type:"openFacet",facet:null}))};return window.addEventListener("keydown",j),()=>window.removeEventListener("keydown",j)},[]),e.jsx(Ut.Provider,{value:ra,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:rr}),e.jsxs("div",{className:"app"+(V?" pipe":""),children:[Y.showTicker&&e.jsx(G,{name:"live",children:e.jsx(xr,{})}),Y.showIdent&&e.jsx(G,{name:"identite",children:e.jsx(Or,{})}),Y.showOnb&&e.jsx(G,{name:"onboarding",children:e.jsx(Rr,{})}),e.jsx(G,{name:"matin",children:e.jsx(Lr,{})}),e.jsx(G,{name:"fraicheur",children:e.jsx(jr,{})}),e.jsx(G,{name:"mesure",children:e.jsx(Nr,{})}),Y.showFunnel&&e.jsx(G,{name:"entonnoir",children:e.jsx(On,{})}),Y.showFunnel&&e.jsx(G,{name:"tunnel",children:e.jsx(Dr,{})}),Y.showFunnel&&e.jsx(G,{name:"tuto",children:e.jsx(Mr,{})}),e.jsx(G,{name:"carte",fallback:e.jsx("div",{className:"void",children:d.loadError}),children:e.jsxs("div",{className:"fzone",children:[e.jsx(Rn,{}),e.jsxs("div",{className:"stage"+(f.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(Ir,{}),e.jsx(Br,{})]})]})}),Y.showDemand&&e.jsx(G,{name:"evaluation",children:e.jsx(Vr,{})}),Y.showDemand&&f.memoConsole&&e.jsx(G,{name:"console",children:e.jsx(Hr,{})}),e.jsx(G,{name:"liste",fallback:e.jsxs("div",{className:"void",children:[d.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:e.jsx(tn,{})}),c.loading&&e.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&e.jsxs("div",{className:"void",children:[d.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]}),Y.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:d.lockbarText}),e.jsx("button",{type:"button",onClick:()=>b({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),f.popupId&&e.jsx(G,{name:"fiche",children:e.jsx(nn,{})}),e.jsx(G,{name:"modales",children:e.jsx(cn,{})}),e.jsx(yr,{}),T&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:T.o.name}),e.jsx(Er,{placeholder:T.yes?d.whyYesPh:d.whyNoPh,onDone:j=>{const O=T.o;D(null),j&&Ce(O,j).then(R=>{R&&B(d.csNoteSaved)})}})]}),q&&e.jsx(Ar,{steps:Ln(d),onClose:()=>{E(!1),Lt(U)}}),y&&e.jsx("div",{className:"flash on"+(z?" err":""),children:y}),g&&e.jsx(Ua,{variant:"acquirer",initialCompany:Ot().co,initialWebsite:Ot().site,onClose:()=>m(null)})]})})}function On(){const{t}=A(),[a,n]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Rn(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:i,t:o}=A(),l=p.useMemo(()=>{const d={};return t.forEach(c=>{c.continent&&tt(c,a.filters,r)&&(d[c.continent]=(d[c.continent]||0)+1)}),d},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[Qa.map(d=>{const c=Je.find(f=>f.key===d);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===d,onClick:()=>n({type:"continent",key:d}),children:[i==="fr"?c.fr:c.en,e.jsx("span",{className:"n",children:l[d]||0})]},d)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Ot(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Fn(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{Ht as FlagCell,je as SigBadge,Be as SigWin,Mn as default,Fn as fmtShort,A as useV2};
