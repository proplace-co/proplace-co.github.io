...
`;class G extends c.Component{constructor(){super(...arguments);rt(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(n,r){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,n,r.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const vr=8;function yr(){const{t,lang:a,token:n,dossiers:r,caps:l,markRow:o,dispatch:i}=E(),[d,p]=c.useState(!1),[f,h]=c.useState(!1),[s,v]=c.useState(!1),b=n||"home",{names:m,verdicts:g}=c.useMemo(()=>{const y=[],S={};return r.forEach(C=>{C.kind!=="target"||!C.name||(y.push(C.name),S[C.name]=ha(C)||"")}),{names:y,verdicts:S}},[r]),x=c.useMemo(()=>m.length?ba(b,m,g,a):null,[b,m.length]);if(!l.pipe||d||!x||x.firstVisit||!x.added.length&&!x.gone.length)return null;const u=f?x.added:x.added.slice(0,vr),w=x.added.length-u.length,k=y=>{const S=r.find(C=>C.name===y);S&&(o(S.id),i({type:"popup",id:S.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(x.added.length,x.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{p(!0),va(b,m,g,x.fp,a)},children:"×"})]}),!!x.added.length&&e.jsxs("div",{className:"since-c",children:[u.map(y=>e.jsx("button",{type:"button",onClick:()=>k(y),children:y},y)),w>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>h(!0),children:t.sinceMore(w)})]}),!!x.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>v(y=>!y),children:t.sinceOut(x.gone.length)}),s&&x.gone.slice(0,20).map(y=>e.jsx("span",{className:"gone",children:y},y))]})]})}const _e=600,me=62,bt="atl2:fstats";function wr(){const{t,lang:a,data:n,caps:r,st:l,dispatch:o}=E(),[i,d]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(bt)==="on"}catch{return!1}}),p=n.stats,f=c.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),h=c.useMemo(()=>{if(p!=null&&p.since)return p.since;const w=new Date;return w.setDate(w.getDate()-((p==null?void 0:p.window_days)||30)),w.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!r.showFunnel||!p||typeof p.screened!="number")return null;const s=w=>a==="en"?w.slice(5,10):`${w.slice(8,10)}/${w.slice(5,7)}`,v=w=>w.toLocaleString(a==="en"?"en-US":"fr-FR"),b=f.reduce((w,k)=>Math.max(w,k.s||0),0),m=f.length?_e/f.length:0,g=Math.max(4,m-4),x=f.length>=5&&b>0,u=[[p.screened,t.funScreened(s(h)),p.screened_today],...typeof p.kept=="number"?[[p.kept,t.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,t.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(i?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[u.map(([w,k,y],S)=>e.jsxs("span",{className:"fst-t",children:[S>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:v(w)}),e.jsx("i",{children:k}),i&&typeof y=="number"&&y>0&&e.jsx("em",{children:t.funToday(y)})]},k)),x&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":i,title:i?t.fstatsHide:t.fstatsShow,onClick:()=>{const w=!i;d(w),w&&!l.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(bt,w?"on":"off")}catch{}},children:i?"⌃":"⌄"})]}),i&&x&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${_e} ${me}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[f.map((w,k)=>{const y=(w.s||0)/b*(me-4),S=(w.m||0)/b*(me-4),C=k*m+(m-g)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${s(w.d)} — ${w.s} ${t.actScreened} · ${w.m} ${t.actKept}`}),e.jsx("rect",{x:C,y:me-2-y,width:g,height:y,fill:"#cfe0d6"}),e.jsx("rect",{x:C,y:me-2-S,width:g,height:S,fill:"#185c38"})]},w.d)}),e.jsx("line",{x1:0,y1:me-1.5,x2:_e,y2:me-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:s(f[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const kr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function jr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:l}=E(),[o,i]=c.useState(""),[d,p]=c.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const f=(t.ceoStatus||"").trim(),h=(Pe(t)||"").startsWith("CALL")&&ee(t)===3,s=ee(t)>=2,v=async m=>{if(o||m==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;i(m);const g=await l(t,m);i(""),g&&(p(!0),setTimeout(()=>p(!1),2200))},b=h?[["Validé",a.csYes],["Écarté",a.csNo]]:kr.filter(([m])=>!(s&&m==="Retenu")).map(([m,g])=>[m,a[g]]);return e.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,g])=>e.jsx("button",{type:"button",className:"csb"+(f===m?" on":"")+(o===m?" busy":""),disabled:!!o,onClick:()=>{v(m)},children:g},m)),d&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(Nr,{o:t})]})}function Nr({o:t}){const{t:a,saveNote:n,flash:r}=E(),[l,o]=c.useState(t.ceoNote||""),[i,d]=c.useState(!1),[p,f]=c.useState(!1),h=l.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(i||!h)return;d(!0);const v=await n(t,l.trim());d(!1),v&&(f(!0),setTimeout(()=>f(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:l,disabled:i,onChange:v=>o(v.target.value),onKeyDown:v=>{v.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:i||!h,onClick:()=>{s()},children:p?a.csNoteSaved:a.csNoteOk})]})}function Sr({placeholder:t,onDone:a}){const{t:n}=E(),[r,l]=c.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>l(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Cr({o:t}){var x;const{t:a,token:n,caps:r,canWrite:l,stageOf:o,setStage:i,flashErr:d}=E(),[p,f]=c.useState(!1);if(!r.pipe||!l||r.lockActions||ee(t)!==4)return null;const h=o(t),s=(h==null?void 0:h.stage)||"todo",v=async u=>{if(p||u===s)return;f(!0);const w=h;i(t,{stage:u,stamps:(h==null?void 0:h.stamps)||{}});const k=Math.max(Date.now(),vt+=1);vt=k;const y=await ya(n,{company:t.name||"",stage:u,cts:k,deal_id:t.airtableId,check_id:t.checkId});f(!1),!y.stale&&(y.ok||(i(t,w),d(a.actErr)))},b=(x=h==null?void 0:h.stamps)==null?void 0:x.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=s==="sent"&&b&&m>=4;return e.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,w])=>e.jsx("button",{type:"button",className:"stgb"+(s===u?" on":""),disabled:p,onClick:()=>{v(u)},children:w},u)),g&&e.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let vt=0;const Re=8,qe=340;function yt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function zr({steps:t,onClose:a}){const{t:n,dispatch:r,counts:l,scoped:o,byId:i,st:d}=E(),[p,f]=c.useState(0),[h,s]=c.useState(null),[v,b]=c.useState([]),m=c.useRef(!1);c.useEffect(()=>{m.current||(m.current=!0,b(t.filter(S=>!!document.querySelector(S.need||S.sel))))},[t]);const g=v[p],x=p>=v.length;c.useEffect(()=>{g&&(g.ptab!==void 0&&d.ptab!==g.ptab&&r({type:"ptab",tab:g.ptab}),g.dens&&d.dens!==g.dens&&r({type:"dens",dens:g.dens}))},[p,g]);const u=c.useCallback(()=>{if(!g){s(null);return}const S=document.querySelector(g.sel);if(!S){s(null);return}S.scrollIntoView({block:"nearest",behavior:"smooth"}),s(S.getBoundingClientRect())},[g]);c.useLayoutEffect(()=>{u();const S=window.setTimeout(u,260),C=()=>u();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{window.clearTimeout(S),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[u]);const w=c.useRef(a);if(w.current=a,c.useEffect(()=>{const S=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),w.current()):C.key==="ArrowRight"?f(F=>F+1):C.key==="ArrowLeft"&&f(F=>Math.max(0,F-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!v.length)return null;let k=null;if(x){const S=l[3]||0,C=o.find(F=>F.memoUrl)||[...i.values()].find(F=>F.memoUrl);S>0?k={title:S===1?n.ahaATitle1:n.ahaATitleN(S),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:C?k={title:n.ahaBTitle,body:n.ahaBBody(C.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:C.id}),a()}}:k={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:qe};if(!x&&h){const S=h.bottom+14,F=window.innerHeight-S>190?S:Math.max(12,h.top-200);y={left:Math.min(Math.max(12,h.left+h.width/2-qe/2),window.innerWidth-qe-12),top:F,width:qe}}return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!x&&h&&e.jsx("div",{className:"tour-hole",style:{left:h.left-Re,top:h.top-Re,width:h.width+Re*2,height:h.height+Re*2}}),(x||!h)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(x?" fin":""),style:y,children:[x&&k?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:k.title}),e.jsx("p",{children:e.jsx(yt,{text:k.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>f(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(p+1,v.length)}),e.jsx("h3",{children:g==null?void 0:g.title}),e.jsx("p",{children:e.jsx(yt,{text:(g==null?void 0:g.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:p===0,onClick:()=>f(S=>Math.max(0,S-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>f(S=>S+1),children:p===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Er(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:l}=E(),o=c.useMemo(()=>t.filter(s=>ye(s.date)===0&&s.kind==="target"),[t]),i=c.useMemo(()=>o.filter(s=>a?ee(s)===0:!X(s)),[o,a]),d=o.length-i.length,p=o.length?Math.min(100,d/o.length*100):100;let f;a?f=n.morningThesis(o.length,d,i.length):o.length?d===0?f=n.goalSourced(o.length):d>=o.length?f=n.goalCleared:f=n.goalDone(d,o.length):f=n.goalSourced(0);const h=()=>{a?(l({type:"ptab",tab:0}),l({type:"filters",patch:{win:"1"}})):l({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:f}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:p+"%"}})}),i.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:a?n.morningEval(i.length):r.pileMode?n.goalContinue(i.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Tr(){var P;const{t,st:a,dispatch:n,token:r,fund:l,data:o,dossiers:i,mode:d,doSync:p,startTour:f}=E(),[h,s]=c.useState(null),[v,b]=c.useState([]),[m,g]=c.useState(!1),x=d==="client";c.useEffect(()=>{if(!r||!l)return;let L=!0;return(async()=>{const[T,D]=await Promise.all([Tt(l),At(r)]);L&&(T&&s(T),b(D))})(),()=>{L=!1}},[r,l]);const u=(h==null?void 0:h.per_day)??null,w=((P=h==null?void 0:h.pool_order)==null?void 0:P.length)??0,k=v.filter(L=>L.status==="running").length,y=L=>{if(!x||u===null||m)return;const T=Math.max(0,Math.min(10,u+L));T!==u&&(g(!0),s(D=>D&&{...D,per_day:T}),Ot(r,T).then(D=>{g(!1),s(D===null?A=>A&&{...A,per_day:u}:A=>A&&{...A,per_day:D})}))},S=c.useMemo(()=>i.filter(L=>L.kind==="target"&&X(L)).length,[i]),C=o.marketEstimate,F=C&&C>0?Math.min(100,Math.round(S/C*100)):null,N=(l||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),z=(()=>{const L=Date.parse(o.generatedAt||"");if(Number.isNaN(L))return"";const T=new Date(L),D=A=>String(A).padStart(2,"0");return`${D(T.getDate())}/${D(T.getMonth()+1)} à ${D(T.getHours())}:${D(T.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:l})]}),e.jsx("h1",{children:t.identTitle(l||"…")}),e.jsx("span",{className:"idsp"}),z&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(z)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:f,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[F!==null&&C&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:F+"%"}})}),e.jsxs("b",{children:[F," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(S,C)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),u!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:L=>{L.stopPropagation(),y(-1)},children:"−"}),e.jsx("b",{className:"q",children:u})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:L=>{L.stopPropagation(),y(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),u===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),k>0&&e.jsxs("span",{className:"ev",children:["⏳ ",k]}),e.jsx("span",{className:"ego",children:t.identPending(w)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!x,onClick:p,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function Ar(){const{t,counts:a,dispatch:n}=E();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,l],o)=>{const i=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(i?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:l}),i&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Or=["--p0","--p1","--p2","--p3","--p4"];function Lr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:l}=E(),o=c.useRef({});c.useEffect(()=>{o.current={...n}},[n]);const i=f=>{const h=o.current[f],s=h!==void 0?n[f]-h:0;return e.jsxs("button",{type:"button",className:"step"+(f===3&&n[3]>0?" wait":""),style:{"--c":`var(${Or[f]})`,"--tc":f<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===f,title:r.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[e.jsxs("span",{className:"l",children:[r.plabels[f].toUpperCase(),f===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[f],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},f)},d=(f,h,s)=>e.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":f===5?"var(--p5)":f===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===f,title:r.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[f]})]},f),p=(f,h,s,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:h,disabled:v,onClick:s,children:f},h);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(i)}),e.jsxs("div",{className:"offtrack",children:[d(5,!1,r.plabels[5]),d(7,!0,r.plabels[7]),d(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[p("↩",r.toolUndo,l,t.undo.length===0),p("↺",r.toolReset,()=>{a({type:"reset"})}),p("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),p("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Fr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Rr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:l,doAnalyse:o,mode:i}=E(),d=c.useRef(null),[p,f]=c.useState(60);c.useEffect(()=>{let b=0;const m=()=>{var k;const g=d.current;if(!g)return;const x=(k=g.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!x)return;const u=x.getBoundingClientRect(),w=g.getBoundingClientRect();f(Math.max(20,Math.min(u.left+u.width/2-w.left,w.width-30)))};return b=requestAnimationFrame(m),window.addEventListener("resize",m),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",m)}},[t.ptab]);const h=t.ptab;let s=n.tuto[h].p;if(h===3){const b=r.filter(x=>x.kind==="target"&&ee(x)===3),m=b.filter(x=>He(x)==="auto").length,g=b.filter(x=>He(x)==="cd").length;s=n.tutoPending(m,g,b.length)}const v=(()=>{if(i!=="client")return null;if(h===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(h===1){const b=r.filter(m=>m.kind==="target"&&ee(m)===1&&!l.has(m.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(m=>o(m))}}return null})();return e.jsxs("div",{ref:d,className:"tuto mini",style:{"--bg":Fr[h],"--ax":p+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[h].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const wt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function kt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function qr(t,a){const[n,r]=c.useState(1);return c.useEffect(()=>{let l=!0,o=0;const i=()=>{var f;if(!l)return;const p=(f=t.current)==null?void 0:f.getScreenCTM();p&&p.a>0?r(p.a):o=requestAnimationFrame(i)};i();const d=new ResizeObserver(()=>i());return t.current&&d.observe(t.current),window.addEventListener("resize",i),()=>{l=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",i)}},[t,a]),n}function Dr(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:l,markedId:o,byId:i,lang:d,t:p}=E(),f=c.useRef(null),h=c.useRef(null),s=Ke.find(N=>N.key===t.continent),v=qr(f,t.continent+":"+t.mapFolded),[b,m]=c.useState(new Map),[g,x]=c.useState(null);c.useEffect(()=>{const N=f.current;if(!N)return;const z=new Map;N.querySelectorAll("path[data-i2]").forEach(P=>{const L=P.dataset.i2;if(L)try{const T=P.getBBox();T.width>0&&z.set(L,{x:T.x,y:T.y,w:T.width,h:T.height})}catch{}}),m(z)},[t.continent,v]);const u=c.useMemo(()=>n.filter(N=>N.cc),[n]),w=c.useMemo(()=>{const N=new Map;return u.forEach(z=>N.set(z.cc,(N.get(z.cc)||0)+1)),N},[u]),k=c.useMemo(()=>u.map(N=>{const z=N.cc?b.get(N.cc):void 0;if(!z)return null;const P=kt(N.name||N.id||""),L=kt((N.id||N.name||"")+"·y"),T=(P-.5)*Math.min(z.w*.55,60),D=(L-.5)*Math.min(z.h*.55,60);return{d:N,x:z.x+z.w/2+T,y:z.y+z.h/2+D}}).filter(N=>!!N),[u,b]),y=N=>v>0?N/v:N,S=c.useMemo(()=>r?[0,1,2,3,4,5].map(N=>({c:wt[N],fr:p.plabels[N].toUpperCase(),en:p.plabels[N].toUpperCase(),n:n.filter(z=>z.kind==="target"&&ee(z)===N).length})).filter(N=>N.n>0):st.map((N,z)=>({...N,n:n.filter(P=>dt(P)===z).length})),[n,r,p.plabels]),C=o?i.get(o):null,F=C?k.find(N=>N.d.id===C.id):null;return e.jsxs("div",{className:"mapzone",ref:h,children:[e.jsxs("svg",{ref:f,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":d==="fr"?s.fr:s.en,onMouseLeave:()=>{x(null),l(null)},children:[e.jsx("g",{children:s.countries.map((N,z)=>e.jsx("g",{className:"ct"+(N.i2&&w.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},z))}),e.jsx("g",{children:k.map(N=>{const z=st[dt(N.d)],P=!!K(N.d),L=N.d.kind==="target",T=r&&L?wt[ee(N.d)]:z.c,D=!r&&X(N.d);return e.jsxs("g",{className:"co"+(D?" done":""),onMouseEnter:()=>{var q,H;const A=(q=h.current)==null?void 0:q.getBoundingClientRect(),B=(H=f.current)==null?void 0:H.createSVGPoint();if(B&&f.current&&A){B.x=N.x,B.y=N.y;const oe=B.matrixTransform(f.current.getScreenCTM());x({x:oe.x-A.left,y:oe.y-A.top,label:N.d.name+" · "+(we(N.d.cc,d)||N.d.countryLabel||"")})}l(N.d.id)},onMouseLeave:()=>{x(null),l(null)},onClick:()=>{var q;const A=(q=f.current)==null?void 0:q.createSVGPoint();let B=null;if(A&&f.current){A.x=N.x,A.y=N.y;const H=A.matrixTransform(f.current.getScreenCTM());B={x:H.x,y:H.y}}a({type:"popup",id:N.d.id,anchor:B})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:y(Math.max(11,z.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:y(z.px),fill:T,stroke:P?"#DC2626":"#ffffff",strokeWidth:y(P?2.2:1.3)})]},N.d.id||N.d.name)})}),F&&e.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:y(13),fill:"none",stroke:"#0F172A",strokeWidth:y(2)})]}),e.jsx("div",{className:"hov"+(g?" on":""),style:g?{left:g.x,top:g.y}:void 0,children:g==null?void 0:g.label}),e.jsx("div",{className:"legend",children:S.map((N,z)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),d==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},z))}),n.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",p.notLocated," ",e.jsx("b",{children:n.filter(N=>!N.cc).length})]})})]})}function Mr(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:l,contName:o}=E(),i=t.filters,d=c.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),p=b=>d.filter(m=>b!=="country"&&i.country.length&&!i.country.includes(m.cc||"")?!1:Xe(m,i,l,b==="country"?void 0:b)),f=c.useMemo(()=>{const b=p("win"),m=g=>b.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=g).length;return[m(0),m(7),m(30),b.length]},[d,i,l]),h=c.useMemo(()=>{if(l)return null;const b=p("status"),m={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(g=>{m[se(g)]+=1}),m},[d,i,l]),s=i.sector.length+i.country.length+i.engine.length+i.stage.length+i.angle.length+i.memoLevel.length+(i.signalOnly?1:0)+(i.win!=="all"?1:0)+(!l&&i.status!=="all"?1:0)+(i.search.trim()?1:0),v=(b,m,g,x="fbtn")=>e.jsxs("button",{type:"button",className:x,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:m}),g>0&&e.jsx("span",{className:"n",children:g}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,m)=>e.jsxs("button",{type:"button","aria-pressed":i.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[m],e.jsx("b",{children:f[m]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:i.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!l&&h&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,m])=>e.jsxs("button",{type:"button","aria-pressed":i.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[m,e.jsx("b",{children:h[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),i.signalOnly&&e.jsx("span",{className:"n",children:i.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,i.sector.length),v("pay",r.fCountry,i.country.length),v("det",r.fEngine,i.engine.length),v("sta",r.fStage,i.stage.length),l&&v("ang","Angle",i.angle.length),l&&v("mem","Mémo",i.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(d.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(Pr,{poolFor:p})]})}function Pr({poolFor:t}){const{st:a,dispatch:n,t:r,lang:l}=E(),o=a.filters,i=a.openFacet,{title:d,cols:p,options:f}=c.useMemo(()=>{if(i==="sig"){const m=t("signal").filter(u=>K(u)),g=new Map;m.forEach(u=>{const w=u.engine||"";g.set(w,(g.get(w)||0)+1)});const x=[{v:"*",label:r.fpSigAll,n:m.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ct([...g.keys()],l).map(u=>({v:u,label:ve(u)+" "+ie(u,l),n:g.get(u)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(u)}))];return{title:r.fpSigTitle,cols:2,options:x}}if(i==="sec"){const m=t("sector"),g=new Map;return m.forEach(x=>{x.sector&&g.set(x.sector,(g.get(x.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:x,n:u,html:!1,on:o.sector.includes(x)}))}}if(i==="pay"){const m=t("country"),g=new Map;return m.forEach(x=>{x.cc&&g.set(x.cc,(g.get(x.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:we(x,l)||x,n:u,html:!1,on:o.country.includes(x)}))}}if(i==="det"){const m=t("engine"),g=new Map;return m.forEach(x=>{x.engine&&g.set(x.engine,(g.get(x.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:ct([...g.keys()],l).map(x=>({v:x,label:ve(x)+" "+ie(x,l)+' <span style="color:var(--dim);font-size:10px">· '+wa(ka(x),l)+"</span>",n:g.get(x)||0,html:!0,on:o.engine.includes(x)}))}}if(i==="ang"){const m=t("angle"),g=new Map;return m.forEach(x=>{x.angle&&g.set(x.angle,(g.get(x.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:x.replace(/[_-]+/g," "),n:u,html:!1,on:o.angle.includes(x)}))}}if(i==="mem"){const m=t("memoLevel"),g=new Map;m.forEach(u=>{if(u.kind==="target"){const w=Ge(u);g.set(w,(g.get(w)||0)+1)}});const x=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(u=>({v:String(u),label:x[u],n:g.get(u)||0,html:!1,on:o.memoLevel.includes(u)}))}}const v=t("stage"),b=new Map;return v.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,g)=>g[1]-m[1]).map(([m,g])=>({v:m,label:m,n:g,html:!1,on:o.stage.includes(m)}))}},[i,a,l]),h=v=>{if(i==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const m=o.signalEngines.includes(v)?o.signalEngines.filter(g=>g!==v):[...o.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(i==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage",value:v})},s=()=>{n(i==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:i==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:d}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(p===2?" two":""),children:f.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>h(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const jt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Br(){const{t,mode:a,token:n,askEvaluate:r,sessTally:l,dispatch:o,evalBusy:i,evalCards:d,caps:p,data:f}=E(),h=a==="client",[s,v]=c.useState(""),[b,m]=c.useState(!1),[g,x]=c.useState(""),[u,w]=c.useState(!1),[k,y]=c.useState(""),[S,C]=c.useState([]),F=c.useRef(!1),N=s.trim()?jt.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,z=c.useMemo(()=>g.split(`
`).map(A=>A.trim()).filter(Boolean).slice(0,15),[g]),P=S.length?S:d,L=f.credits,T=()=>{const A=s.trim();A&&(r(null,A),v(""))},D=async()=>{if(!h){r(null,z[0]||"");return}if(!z.length||u)return;w(!0),F.current=!1;const A=[];for(let B=0;B<z.length&&!F.current;B++){y(t.evaluating(B+1,z.length,z[B]));const q=await Lt(n,z[B],"atelier2");if(A.unshift({name:q.company||z[B],verdict:q.verdict,reason:q.reason||"",remaining:q.remaining??null}),C([...A]),q.verdict==="quota"){A.unshift({name:"",verdict:"quota",reason:t.quota(z.length-B-1),remaining:0}),C([...A]);break}}y(""),x(""),w(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:A=>v(A.target.value),onKeyDown:A=>{A.key==="Enter"&&T()}}),e.jsx("span",{className:"detect"+(jt.test(s.trim())?" url":""),children:N})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),disabled:i,onClick:T,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),p.showCredits&&L&&e.jsxs("button",{type:"button",className:"credits"+(L.total_available<=0&&!L.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:L.unlimited?"∞":L.total_available}),!L.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",L.daily_grant+L.purchased]}),L.total_available<=0&&!L.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>m(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:g,placeholder:t.bulkPh,onChange:A=>x(A.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{justifyContent:"center"},disabled:u||!z.length,onClick:()=>{D()},children:[e.jsx("span",{className:"fill"}),u&&k?k:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(z.length)})]})]}),P.slice(0,1).map((A,B)=>{const q=A.verdict==="kept",H=A.verdict==="quota",oe=q?"var(--brand)":H?"var(--bolt)":"var(--red)",de=q?"var(--brand-l)":H?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":oe,"--bgc":de},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:q?"✓ "+t.kept:H?"⏳":"✗ "+t.dropped})}),A.name&&e.jsx("span",{className:"rn",children:A.name}),e.jsx("span",{className:"rr",children:A.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",A.reason]}):null}),!H&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(q?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},B)}),h&&(l.kept+l.dropped>0||P.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(l.kept,l.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Ir(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function $r(){const{st:t,dispatch:a,byId:n,t:r,doDeep:l}=E(),o=t.memoConsole?n.get(t.memoConsole):null,i=c.useMemo(()=>o?[o.reasoning||"",Ir(o.summary||"")].filter(Boolean).join(`
