...
.atl2 .bulk .side .hint{white-space:nowrap}`,ms=`
...
`,hs=us+ms+fs;function nn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function xs(){const e=nn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function gs(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=xs();return r==="0"?"client":r==="1"||nn("embed")==="1"&&nn("chrome")==="1"?"apercu":"client"}const bs={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},vs=e=>bs[e];function Sa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const St=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!$r(a)||Sa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Zo(e.cc)})};function Ha(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const ys=60*60*1e3;function ws(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>ys?null:a}catch{return null}}function ua(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ks=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function js(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:$o(),[e,n]),i=p.useMemo(()=>n?"visiteur":gs(e,o),[e,o,n]),l=p.useMemo(()=>vs(i),[i]),s=i!=="visiteur",c=ks(r),[g,d]=p.useState([]),[x,u]=p.useState(""),[b,m]=p.useState(null),[v,y]=p.useState(null),[f,j]=p.useState(null),[N,w]=p.useState(()=>new Map),[E,A]=p.useState(()=>new Map),[C,L]=p.useState(""),[T,R]=p.useState(new Set),[I,B]=p.useState(null),[F,M]=p.useState(!0),[h,q]=p.useState(!1),[H,J]=p.useState(0),[_,D]=p.useState(0),K=p.useRef(0),W=p.useMemo(()=>{var te;if(i!=="client")return"";try{return((te=Uo())==null?void 0:te.email)||""}catch{return""}},[i]);p.useEffect(()=>{const te=++K.current;let he=!0;const ee=()=>he&&te===K.current,ce=(s&&o.token?o.token:"pub:"+a)+(c?":"+c:""),pe=ws(ce);return pe?(d(pe.objs.map(St)),pe.fund&&u(pe.fund),m(pe.marketEstimate??null),y(pe.criteria??null),j(pe.stats??null),L(pe.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(r==="ops"){const je=await Ba(),be=((je==null?void 0:je.recent_ops)||[]).map(le=>{const ue=ya(le.company_name||le.title?le:{...le,title:(le.headline_fr||le.headline||"").slice(0,120)},a),oe=String(le.rubrique||"").toLowerCase();return ue&&(oe==="nominations"||oe==="recrutements")&&(ue.engine=oe),ue&&!String(le.company_name||"").trim()&&(ue.noCo=!0),ue}).filter(le=>!!le).map(le=>($r((le.name||"").trim())||(le.noCo=!0),le));try{const le=Ho(),ue=await Vo(),oe=((ue==null?void 0:ue.date)||"").slice(0,10),$=le?le.doc:ue,ne=Wo($),fe=((le==null?void 0:le.day)||($==null?void 0:$.date)||oe||"").slice(0,10);if(fe&&ne.length){const we=new Set;for(const Ne of be){if((Ne.date||"").slice(0,10)!==fe)continue;const ve=Dn(ne,we,Ne.name,"");ve>=0&&(we.add(ve),Ne.decryptHtml=ne[ve].html)}for(const Ne of be){if(Ne.decryptHtml||(Ne.date||"").slice(0,10)!==fe)continue;const ve=Dn(ne,we,"",Ne.headline||Ne.tagline||Ne.name);ve>=0&&(we.add(ve),Ne.decryptHtml=ne[ve].html)}}if(fe){const we=(($==null?void 0:$.title_fr)||"").trim(),Ne=(($==null?void 0:$.lead_fr)||"").trim(),ve=Go($),re=(($==null?void 0:$.url)||"").trim();we&&(ve||re)&&be.unshift({id:`edito:${fe}`,kind:"op",name:we,cc:null,date:fe,engine:"edito",dealKind:"other",headline:we,tagline:Ne||we,decryptHtml:ve||void 0,url:re,noCo:!0})}}catch{}if(!ee())return;d(be.map(St)),ua(ce,{objs:be})}else if(typeof r=="object"){const be=(await In()||[]).filter(ue=>(ue.slug||"")===r.research).map(ue=>Pn(ue,a)).filter(ue=>!!ue),le=Ha(await Bn(be,a));if(!ee())return;d(le.map(St)),ua(ce,{objs:le})}else if(s&&o.token){const je=Yo(o.token),be=Ba(),le=Ko(o.token),ue=Qo(o.token),oe=Jo(o.token),$=await je;let ne=$?$.targets:[];ee()&&$&&(u($.fund||""),m($.marketEstimate??null),y($.criteria??null),j($.stats??null),L($.generatedAt||""),d(ne.map(St)),M(!1),q(!1));const[fe,we,Ne,ve]=await Promise.all([be,le,ue,oe]),re=((fe==null?void 0:fe.recent_ops)||[]).map(me=>ya(me,a)).filter(me=>!!me),Te=new Set(ne.map(me=>me.id));if(ne=[...ne,...re.filter(me=>!Te.has(me.id)&&(Te.add(me.id),!0))],!ee())return;d(ne.map(St));const Qe=new Set;for(const me of we){const Ee=(me.id||me.co||"").toString().trim().toLowerCase();Ee&&Qe.add(Ee.startsWith("t:")?Ee:"t:"+Ee)}R(Qe),w(Ne),A(ve),$&&ua(ce,{fund:$.fund,marketEstimate:$.marketEstimate,criteria:$.criteria,stats:$.stats,generatedAt:$.generatedAt,objs:ne})}else{const je=Xo(),be=In(),le=Ba(),ue=await je;ee()&&ue.length&&(d(Ha(ue).map(St)),M(!1),q(!1));const[oe,$]=await Promise.all([be,le]),ne=(oe||[]).map(ve=>Pn(ve,a)).filter(ve=>!!ve),fe=await Bn(ne,a),we=(($==null?void 0:$.recent_ops)||[]).map(ve=>ya(ve,a)).filter(ve=>!!ve),Ne=Ha([...ue,...fe,...we]);if(!ee())return;d(Ne.map(St)),ua(ce,{objs:Ne})}ee()&&q(!1)}catch{ee()&&!pe&&q(!0)}finally{ee()&&M(!1)}})(),()=>{he=!1}},[s,o.token,a,H,c]),p.useEffect(()=>{if(!l.showCredits||!W){B(null);return}let te=!0;return(async()=>{try{const he=await fetch(`${yn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:W})});if(!he.ok)return;const ee=await he.json();te&&ee&&ee.ok!==!1&&B(ee)}catch{}})(),()=>{te=!1}},[l.showCredits,W,_]);const Q=p.useCallback(te=>R(new Set(te)),[]);return{session:o,mode:i,caps:l,fund:x,email:W,marketEstimate:b,generatedAt:C,criteria:v,stats:f,thumbs:N,stages:E,dossiers:g,favIds:T,setFavIds:Q,credits:I,reloadCredits:()=>D(te=>te+1),loading:F,error:h,refresh:()=>J(te=>te+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const wa=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ca(e){return wa.has(e.engine||"")}function Ve(e){return!!e.noCo||Ca(e)&&!!e.url}const Kr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ns=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Kr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Es=new Set(["signal","amount","score","crible","memo"]);function Ss(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Kr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Es.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Qr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Qr=80;function za(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Pe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(wn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(xt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&zt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function na(e,a,r){return We(e)?za(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:za(e,a.filters,r)}function Cs(e,a,r,n){return!(!na(e,a,r)||r&&!ei(e,a.ptab,n))}function Nn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-xt(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return ai(o);case"memo":return ti(o);case"signal":{const i=Pe(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),s=n(i);return l<s?-a.dir:l>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const Va={},Zn=(Va==null?void 0:Va.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function er(){return new Date().toISOString().slice(0,10)}const En=p.createContext(null);function Jr(){return p.useContext(En)}function zs(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),l=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),s.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(d=>c.removeAttribute(d.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function As(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),l=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(l);!s&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function tr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),l=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),l&&n.setAttribute("class",l),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function ar(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${i} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${i} ${r[1]}`}function Xr(){const e=p.useContext(En);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ts({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Y(),[i,l]=p.useState(()=>n.filters.day||er()),[s,c]=p.useState(null),[g,d]=p.useState(!1),x=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){l(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{l(er());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=y=>{var j;const f=(j=y.detail)==null?void 0:j.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[x]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let v=!1;d(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Zn}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{v||c(f)}).catch(()=>{v||c({ok:!1,error:"network"})}).finally(()=>{v||d(!1)}),()=>{v=!0}},[e,i]);const b=p.useMemo(()=>`${Zn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=p.useMemo(()=>({token:e,day:i,ed:s,loading:g,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,g,x,u,n.filters.day,b,o]);return t.jsx(En.Provider,{value:m,children:a})}function qs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Xr(),[o,i]=p.useState(()=>n||Ur());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const l=s=>{var c;return i(!!((c=s.detail)!=null&&c.open))};return window.addEventListener(Na,l),()=>window.removeEventListener(Na,l)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(ni,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Ls(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function nr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function rr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Fs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Xr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok,g=p.useRef(null),[d,x]=p.useState("fonds"),[u,b]=p.useState(null),[m,v]=p.useState("idle"),y=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),y.current=!1,x("fonds")},[e]),p.useEffect(()=>{if(d!=="jour"||y.current)return;y.current=!0;let E=!0;return v("load"),Ls(e).then(A=>{E&&(b(A),v("fait"))}),()=>{E=!1}},[d,e]);const f=p.useMemo(()=>As((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),j=p.useRef(null);p.useEffect(()=>{const E=j.current;if(!E||!f)return;let A=!1;return Xa(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(A||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{A=!0}},[f]);const N=p.useMemo(()=>tr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),w=p.useMemo(()=>tr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const E=g.current;if(!E||!N)return;let A=!1;return Xa(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(A||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{A=!0}},[N]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":d==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":d==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),d==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),d==="fonds"&&r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?nr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:ar(e,!0)}),"."]}):nr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:ar(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),d==="fonds"&&l&&N?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:N}}):null,d==="fonds"&&l&&w?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:w}}):null,d==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:j,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:rr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:rr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Rs=300,ma=7,Ms={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Zr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Os=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Wa(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(si(r)&&r!=="media")return"news:"+r;const n=Pe(e);return n?"sig:"+(n.theme&&Zr.fr[n.theme]?n.theme:"other"):"actualites"}function Ds(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:l,fund:s}=Y(),c=Jr(),g=l==="en",[d,x]=p.useState("all"),[u,b]=p.useState(!1),m=p.useMemo(()=>{var he;const h=(a.filters.day||"").slice(0,10),q=ee=>!(!i&&a.continent!=="monde"&&ee.continent!==a.continent||h&&(ee.date||"").slice(0,10)!==h),H=e.filter(ee=>q(ee)&&Pe(ee)&&(!i||ee.kind!=="target"||Ae(ee)!==5)),J=i&&(((he=c==null?void 0:c.ed)==null?void 0:he.ops)||[]).length?c.ed.ops.map(ee=>ya(ee,l)).filter(ee=>!!ee).map(ee=>(ee.briefOnly=!0,ee)).filter(ee=>!h||(ee.date||"").slice(0,10)===h):[],_=e.filter(ee=>q(ee)&&ee.kind==="op"&&(h?!0:xt(ee.date)<=ma)),D=i?J.length?J:_.filter(ee=>{const ce=(s||"").trim().toLowerCase();if(!ce)return!1;const pe=ee.match||null;return pe?Object.keys(pe).map(je=>je.trim().toLowerCase()).includes(ce):!1}):_,K=h||new Date().toISOString().slice(0,10),W=ee=>{const ce=Wa(ee);return ce==="ma"?0:ce==="levees"?1:2};D.sort((ee,ce)=>{const pe=W(ee)-W(ce);if(pe)return pe;const je=(ee.date||"").slice(0,10)===K?0:1,be=(ce.date||"").slice(0,10)===K?0:1;return je!==be?je-be:(ce.amountEur||0)-(ee.amountEur||0)});const Q=new Set,te=[];for(const ee of[...D,...Nn(H,{key:"signal",dir:-1})]){const ce=ee.id||ee.name;!ce||Q.has(ce)||(Q.add(ce),te.push(ee))}return i&&te.length===0?e.filter(ce=>q(ce)&&xt(ce.date)<=ma).sort((ce,pe)=>(pe.date||"").localeCompare(ce.date||"")).slice(0,80):te},[e,a.continent,a.filters.day,i,s,l,c]),v=p.useMemo(()=>{const h={};for(const q of m){const H=Wa(q);h[H]=(h[H]||0)+1}return h},[m]),y=p.useMemo(()=>d==="all"?m:m.filter(h=>Wa(h)===d),[m,d]),f=p.useMemo(()=>y.slice(0,Rs),[y]),j=y.length-f.length,N=p.useRef(null);p.useEffect(()=>{var D,K;const h=N.current;if(!h)return;const q=()=>{const W=h.scrollWidth;W<200||(h.style.animationDuration=Math.max(18,Math.round(W/130))+"s")};q();const H=requestAnimationFrame(q),J=window.setTimeout(q,1200);let _=!0;return(K=(D=document.fonts)==null?void 0:D.ready)==null||K.then(()=>{_&&q()}),()=>{_=!1,cancelAnimationFrame(H),window.clearTimeout(J)}},[f.length,d]);const w=h=>h==="all"?m.length:v[h]||0,E=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return Zr[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const q=h.slice(5);return oi[q]?ii(q,g?"en":"fr"):h}return Ms[g?"en":"fr"][h]},A=[{k:"all"}],C=["ma","levees"].filter(h=>w(h)>0||h===d);if(C.length){A.push({g:g?"Deals":"Opérations"});for(const h of C)A.push({k:h})}const L=["nominations","recrutements"].filter(h=>w(h)>0||h===d),T=ri.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>w(h)>0||h===d),R=w("actualites")>0||d==="actualites"?["actualites"]:[];if(L.length||T.length||R.length){A.push({g:g?"News":"Actualités"});for(const h of L)A.push({k:h});for(const h of T)A.push({k:h});for(const h of R)A.push({k:h})}const I=Os.map(h=>"sig:"+h).filter(h=>w(h)>0||h===d);if(I.length){A.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of I)A.push({k:h})}const B=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},F=(()=>{const h=(a.filters.day||"").slice(0,10),q=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(g?`LIVE covers the events of ${B(h)}.`:`Le LIVE regroupe les événements du ${B(h)}.`)+q:(g?`LIVE covers the still-open signals and the deals of the last ${ma} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ma} derniers jours.`)+q})(),M=h=>f.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Be(q)?" spent":""),onClick:H=>{const J=q.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:J?"":q.id,name:q.name,url:q.url||"",text:q.tagline||q.headline||"",card:q.card}}))}catch{}if(J||n({type:"focus",id:q.id}),a.dens!=="liste"){const _=H.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:_.left+_.width/2,y:_.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(wt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(Fo,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:pc(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Ia,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(q.id||q.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(h=>!h),children:[E(d),t.jsx("b",{children:w(d)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:F}),A.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===d,onClick:()=>{x(h.k),b(!1)},children:[E(h.k),t.jsx("b",{children:w(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:N,children:[M(0),M(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(Ps,{isEn:g})]})}const Is=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Ps({isEn:e}){const[a,r]=p.useState(()=>Ur());p.useEffect(()=>{const o=i=>{var l;return r(!!((l=i.detail)!=null&&l.open))};return window.addEventListener(Na,o),()=>window.removeEventListener(Na,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>li(!a),children:Is})}const Sn="+33 6 83 10 72 86",Aa="alexandre@proplace.co",eo=`tel:${Sn.replace(/[^\d+]/g,"")}`;function Bs(){return null}class rt extends p.Component{constructor(){super(...arguments);Mn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const to=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function or(e,a){if((kt(e)||"").startsWith("CALL")&&Ae(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ae(e)>=2;return to.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const ir=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",_s={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function $s({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:l}=Y(),[s,c]=p.useState(""),[g,d]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!x)return;const j=N=>{b.current&&!b.current.contains(N.target)&&(u(!1),d(!1))};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),v=async j=>{if(s)return;if(j==="Analysé"&&!e.memoUrl){d(!0);return}c(j);const N=(or(e,a).find(([E])=>E===j)||[j,j])[1],w=await o(e,j,{msg:a.csMoved(e.name,N)});c(""),w&&(d(!1),u(!1))},y=or(e,a),f=j=>(y.find(([N])=>N===j)||[])[1]||j;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:j=>j.stopPropagation(),children:y.map(([j,N])=>t.jsx("button",{type:"button",className:"rsd "+(j==="Validé"?"yes":"no")+(s===j?" busy":""),disabled:!!s,onClick:()=>{v(j)},children:N},j))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:j=>j.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!s,title:a.csLabel,className:"rsel rs-"+ir(m),onClick:()=>{u(j=>!j),d(!1)},children:s?f(s)+"…":m?f(m):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([j,N])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===j,className:"rsopt"+(m===j?" on":"")+(s===j?" busy":""),disabled:!!s,onClick:()=>{if(j===m){u(!1);return}v(j)},children:[t.jsx("i",{className:"pt2",style:{background:_s[ir(j)]}}),N]},j))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{i(e),d(!1),u(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const j=await o(e,"Analysé");c(""),j&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function Us({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Y(),[i,l]=p.useState(""),[s,c]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(kt(e)||"").startsWith("CALL")&&Ae(e)===3,x=Ae(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(m);const v=await o(e,m);l(""),v&&(c(!0),setTimeout(()=>c(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:to.filter(([m])=>!(x&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:v},m)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Hs,{o:e})]})}function Hs({o:e}){const{t:a,saveNote:r,flash:n}=Y(),[o,i]=p.useState(e.ceoNote||""),[l,s]=p.useState(!1),[c,g]=p.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!d)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:l,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{x()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Vs({placeholder:e,onDone:a}){const{t:r}=Y(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Ws({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:l,flashErr:s}=Y(),[c,g]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Ae(e)!==4)return null;const d=i(e),x=(d==null?void 0:d.stage)||"todo",u=async f=>{if(c||f===x)return;g(!0);const j=d;l(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const N=Math.max(Date.now(),sr+=1);sr=N;const w=await di(r,{company:e.name||"",stage:f,cts:N,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(l(e,j),s(a.actErr)))},b=(y=d==null?void 0:d.stamps)==null?void 0:y.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,j])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:c,onClick:()=>{u(f)},children:j},f)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let sr=0;const Kt=8,yt=360;function lr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function dr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(lr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(lr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function Gs({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Y(),[l,s]=p.useState(0),[c,g]=p.useState(null),[d,x]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=p.useRef(!1);p.useEffect(()=>{const C=b.current;return()=>{m.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const v=d[l],y=l>=d.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const C=v.click,L=window.setTimeout(()=>{const T=document.querySelector(C);T&&T.getAttribute("aria-selected")!=="true"&&T.click()},60);return()=>window.clearTimeout(L)}},[l,v]);const f=p.useRef(-1),j=p.useCallback(()=>{if(!v){g(null);return}const C=R=>{if(!R)return null;for(const I of document.querySelectorAll(R)){const B=I.getBoundingClientRect();if(B.width>1&&B.height>1)return I}return null},L=C(v.sel)||C(v.need);if(!L){g(null);return}f.current!==l&&(f.current=l,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const T=L.getBoundingClientRect();g(R=>R&&Math.abs(R.top-T.top)<1&&Math.abs(R.left-T.left)<1&&Math.abs(R.width-T.width)<1&&Math.abs(R.height-T.height)<1?R:T)},[v,l]);p.useLayoutEffect(()=>{j();const C=[90,300,700,1300].map(R=>window.setTimeout(j,R)),L=window.setInterval(j,400),T=()=>j();return window.addEventListener("scroll",T,!0),window.addEventListener("resize",T),()=>{C.forEach(R=>window.clearTimeout(R)),window.clearInterval(L),window.removeEventListener("scroll",T,!0),window.removeEventListener("resize",T)}},[j]);const N=p.useRef(a);if(N.current=a,p.useEffect(()=>{const C=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),N.current()):L.key==="ArrowRight"?s(T=>T+1):L.key==="ArrowLeft"&&s(T=>Math.max(0,T-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!d.length)return null;let w=null;const E=C=>()=>{m.current=!0,n({type:"modal",modal:null}),C()};if(y){const C=o[3]||0;C>0?w={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:E(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?w={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:E(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?w={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:E(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:E(()=>{n({type:"modal",modal:"crit"}),a()})}}let A={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:yt};if(!y&&c){const C=c.bottom+14,L=window.innerHeight-C;let T=L>190?C:Math.max(12,c.top-200),R=Math.min(Math.max(12,c.left+c.width/2-yt/2),window.innerWidth-yt-12);L<=190&&c.top<212&&(window.innerWidth-c.right>=yt+40?R=Math.min(c.right+26,window.innerWidth-yt-12):c.left>=yt+40&&(R=Math.max(12,c.left-yt-26)),T=Math.max(12,c.top-Kt)),A={left:R,top:T,width:yt}}return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Kt,top:c.top-Kt,width:c.width+Kt*2,height:c.height+Kt*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:A,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(dr,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(dr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(C=>C+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function ao(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function no(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Ys(){var L,T;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:l,data:s,dispatch:c}=Y(),g=r?a:e,d=p.useMemo(()=>g.filter(R=>xt(R.date)===0&&R.kind==="target"),[g]),x=p.useMemo(()=>r?a.filter(R=>R.kind==="target"&&Ae(R)===0).slice().sort((R,I)=>(I.date||"").localeCompare(R.date||"")):[],[a,r]),u=p.useMemo(()=>d.filter(R=>r?Ae(R)===0:!Be(R)),[d,r]),b=r?x:u,m=r?a.length-x.length:d.length-u.length,v=r?a.length:d.length,y=v?Math.min(100,m/v*100):100,f=p.useMemo(()=>ao(g),[g]),j=!!f&&xt(f)>0,N=p.useMemo(()=>j?g.filter(R=>(R.date||"").slice(0,10)===f):[],[g,f,j]),w=typeof((L=s.stats)==null?void 0:L.kept_today)=="number"?s.stats.kept_today:null,E=typeof((T=s.stats)==null?void 0:T.screened_today)=="number"?s.stats.screened_today:d.length;let A;j?A=o.morningLast(N.length,x.length,no(f,l)):r?A=o.morningThesis(E,x.length,w):d.length?m===0?A=o.goalSourced(d.length):m>=d.length?A=o.goalCleared:A=o.goalDone(m,d.length):A=o.goalSourced(0);const C=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&x.length&&c({type:"chainStart",queue:x.map(R=>R.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:A}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ks(){var H,J;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:l,dossiers:s,mode:c,doSync:g,startTour:d,flash:x,flashErr:u}=Y(),[b,m]=p.useState(null),[v,y]=p.useState(!0),[f,j]=p.useState([]),N=c==="client";p.useEffect(()=>{if(!o||!i)return;let _=!0;return y(!0),(async()=>{const[D,K]=await Promise.all([kn(i),Hr(o)]);_&&(D&&m(D),y(!1),j(K))})(),()=>{_=!1}},[o,i]);const[w,E]=p.useState(!1),A=()=>{!N||w||!i||(E(!0),ci(i).then(_=>{E(!1),_?x(e.identRepubDone):u(e.actErr)}))},C=(b==null?void 0:b.per_day)??null,L=((H=b==null?void 0:b.pool_order)==null?void 0:H.length)??0,T=f.filter(_=>_.status==="running").length,R=p.useMemo(()=>s.filter(_=>_.kind==="target"&&Be(_)).length,[s]),I=l.marketEstimate,B=typeof((J=l.stats)==null?void 0:J.screened)=="number"?l.stats.screened:R,F=I&&I>0?Math.min(100,Math.round(B/I*100)):null,M=_=>_.toLocaleString(a==="en"?"en-US":"fr-FR"),h=(i||"P").split(/\s+/).map(_=>_[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const _=Date.parse(l.generatedAt||"");if(Number.isNaN(_))return"";const D=new Date(_),K=W=>String(W).padStart(2,"0");return`${K(D.getDate())}/${K(D.getMonth()+1)} à ${K(D.getHours())}:${K(D.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),q?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[F===null&&B>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:M(B)})})]}),F!==null&&I&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:F+"%"}})}),t.jsxs("b",{children:[F," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(B,I)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),C===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),T>0&&t.jsxs("span",{className:"ev",children:["⏳ ",T]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:_=>{_.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!N||w,onClick:A,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!N,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:_=>n({type:"filters",patch:{search:_.target.value}})})]})]})]})}class Tt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],l=a+i,s=Math.abs(a)<Math.abs(i)?a-(l-i):i-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,o=a[--r],l=n+o,i=o-(l-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=l+o,o==n-l&&(l=n))}return l}}function*Qs(e){for(const a of e)yield*a}function ro(e){return Array.from(Qs(e))}var ke=1e-6,de=Math.PI,Ze=de/2,cr=de/4,tt=de*2,ft=180/de,Ye=de/180,ze=Math.abs,Js=Math.atan,ra=Math.atan2,Le=Math.cos,Fe=Math.sin,Xs=Math.sign||function(e){return e>0?1:e<0?-1:0},Lt=Math.sqrt;function Zs(e){return e>1?0:e<-1?de:Math.acos(e)}function oa(e){return e>1?Ze:e<-1?-Ze:Math.asin(e)}function et(){}function Ta(e,a){e&&ur.hasOwnProperty(e.type)&&ur[e.type](e,a)}var pr={Feature:function(e,a){Ta(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ta(r[n].geometry,a)}},ur={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){rn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)rn(r[n],a,0)},Polygon:function(e,a){mr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)mr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ta(r[n],a)}};function rn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function mr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)rn(e[r],a,1);a.polygonEnd()}function Ot(e,a){e&&pr.hasOwnProperty(e.type)?pr[e.type](e,a):Ta(e,a)}function on(e){return[ra(e[1],e[0]),oa(e[2])]}function Bt(e){var a=e[0],r=e[1],n=Le(r);return[n*Le(a),n*Fe(a),Fe(r)]}function fa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function qa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ga(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ha(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function sn(e){var a=Lt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ln(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function dn(e,a){return ze(e)>de&&(e-=Math.round(e/tt)*tt),[e,a]}dn.invert=dn;function el(e,a,r){return(e%=tt)?a||r?ln(hr(e),xr(a,r)):hr(e):a||r?xr(a,r):dn}function fr(e){return function(a,r){return a+=e,ze(a)>de&&(a-=Math.round(a/tt)*tt),[a,r]}}function hr(e){var a=fr(e);return a.invert=fr(-e),a}function xr(e,a){var r=Le(e),n=Fe(e),o=Le(a),i=Fe(a);function l(s,c){var g=Le(c),d=Le(s)*g,x=Fe(s)*g,u=Fe(c),b=u*r+d*n;return[ra(x*o-b*i,d*r-u*n),oa(b*o+x*i)]}return l.invert=function(s,c){var g=Le(c),d=Le(s)*g,x=Fe(s)*g,u=Fe(c),b=u*o-x*i;return[ra(x*o+u*i,d*r+b*n),oa(b*r-d*n)]},l}function tl(e,a,r,n,o,i){if(r){var l=Le(a),s=Fe(a),c=n*r;o==null?(o=a+n*tt,i=a-c/2):(o=gr(l,o),i=gr(l,i),(n>0?o<i:o>i)&&(o+=n*tt));for(var g,d=o;n>0?d>i:d<i;d-=c)g=on([l,-s*Le(d),-s*Fe(d)]),e.point(g[0],g[1])}}function gr(e,a){a=Bt(a),a[0]-=e,sn(a);var r=Zs(-a[1]);return((-a[2]<0?-r:r)+tt-ke)%tt}function oo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:et,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ka(e,a){return ze(e[0]-a[0])<ke&&ze(e[1]-a[1])<ke}function xa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function io(e,a,r,n,o){var i=[],l=[],s,c;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,y=m[0],f=m[v],j;if(ka(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),s=0;s<v;++s)o.point((y=m[s])[0],y[1]);o.lineEnd();return}f[0]+=2*ke}i.push(j=new xa(y,m,null,!0)),l.push(j.o=new xa(y,null,j,!1)),i.push(j=new xa(f,m,null,!1)),l.push(j.o=new xa(f,null,j,!0))}}),!!i.length){for(l.sort(a),br(i),br(l),s=0,c=l.length;s<c;++s)l[s].e=r=!r;for(var g=i[0],d,x;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;d=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,c=d.length;s<c;++s)o.point((x=d[s])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(d=u.p.z,s=d.length-1;s>=0;--s)o.point((x=d[s])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);o.lineEnd()}}}function br(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Ya(e){return ze(e[0])<=de?e[0]:Xs(e[0])*((ze(e[0])+de)%tt-de)}function al(e,a){var r=Ya(a),n=a[1],o=Fe(n),i=[Fe(r),-Le(r),0],l=0,s=0,c=new Tt;o===1?n=Ze+ke:o===-1&&(n=-Ze-ke);for(var g=0,d=e.length;g<d;++g)if(u=(x=e[g]).length)for(var x,u,b=x[u-1],m=Ya(b),v=b[1]/2+cr,y=Fe(v),f=Le(v),j=0;j<u;++j,m=w,y=A,f=C,b=N){var N=x[j],w=Ya(N),E=N[1]/2+cr,A=Fe(E),C=Le(E),L=w-m,T=L>=0?1:-1,R=T*L,I=R>de,B=y*A;if(c.add(ra(B*T*Fe(R),f*C+B*Le(R))),l+=I?L+T*tt:L,I^m>=r^w>=r){var F=qa(Bt(b),Bt(N));sn(F);var M=qa(i,F);sn(M);var h=(I^L>=0?-1:1)*oa(M[2]);(n>h||n===h&&(F[0]||F[1]))&&(s+=I^L>=0?1:-1)}}return(l<-ke||l<ke&&c<-1e-12)^s&1}function so(e,a,r,n){return function(o){var i=a(o),l=oo(),s=a(l),c=!1,g,d,x,u={point:b,lineStart:v,lineEnd:y,polygonStart:function(){u.point=f,u.lineStart=j,u.lineEnd=N,d=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=y,d=ro(d);var w=al(g,n);d.length?(c||(o.polygonStart(),c=!0),io(d,rl,w,r,o)):w&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),d=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(w,E){e(w,E)&&o.point(w,E)}function m(w,E){i.point(w,E)}function v(){u.point=m,i.lineStart()}function y(){u.point=b,i.lineEnd()}function f(w,E){x.push([w,E]),s.point(w,E)}function j(){s.lineStart(),x=[]}function N(){f(x[0][0],x[0][1]),s.lineEnd();var w=s.clean(),E=l.result(),A,C=E.length,L,T,R;if(x.pop(),g.push(x),x=null,!!C){if(w&1){if(T=E[0],(L=T.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),A=0;A<L;++A)o.point((R=T[A])[0],R[1]);o.lineEnd()}return}C>1&&w&2&&E.push(E.pop().concat(E.shift())),d.push(E.filter(nl))}}return u}}function nl(e){return e.length>1}function rl(e,a){return((e=e.x)[0]<0?e[1]-Ze-ke:Ze-e[1])-((a=a.x)[0]<0?a[1]-Ze-ke:Ze-a[1])}const vr=so(function(){return!0},ol,sl,[-de,-Ze]);function ol(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,l){var s=i>0?de:-de,c=ze(i-a);ze(c-de)<ke?(e.point(a,r=(r+l)/2>0?Ze:-Ze),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&c>=de&&(ze(a-n)<ke&&(a-=n*ke),ze(i-s)<ke&&(i-=s*ke),r=il(a,r,i,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function il(e,a,r,n){var o,i,l=Fe(e-r);return ze(l)>ke?Js((Fe(a)*(i=Le(n))*Fe(r)-Fe(n)*(o=Le(a))*Fe(e))/(o*i*l)):(a+n)/2}function sl(e,a,r,n){var o;if(e==null)o=r*Ze,n.point(-de,o),n.point(0,o),n.point(de,o),n.point(de,0),n.point(de,-o),n.point(0,-o),n.point(-de,-o),n.point(-de,0),n.point(-de,o);else if(ze(e[0]-a[0])>ke){var i=e[0]<a[0]?de:-de;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function ll(e){var a=Le(e),r=2*Ye,n=a>0,o=ze(a)>ke;function i(d,x,u,b){tl(b,e,r,u,d,x)}function l(d,x){return Le(d)*Le(x)>a}function s(d){var x,u,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(y,f){var j=[y,f],N,w=l(y,f),E=n?w?0:g(y,f):w?g(y+(y<0?de:-de),f):0;if(!x&&(m=b=w)&&d.lineStart(),w!==b&&(N=c(x,j),(!N||ka(x,N)||ka(j,N))&&(j[2]=1)),w!==b)v=0,w?(d.lineStart(),N=c(j,x),d.point(N[0],N[1])):(N=c(x,j),d.point(N[0],N[1],2),d.lineEnd()),x=N;else if(o&&x&&n^w){var A;!(E&u)&&(A=c(j,x,!0))&&(v=0,n?(d.lineStart(),d.point(A[0][0],A[0][1]),d.point(A[1][0],A[1][1]),d.lineEnd()):(d.point(A[1][0],A[1][1]),d.lineEnd(),d.lineStart(),d.point(A[0][0],A[0][1],3)))}w&&(!x||!ka(x,j))&&d.point(j[0],j[1]),x=j,b=w,u=E},lineEnd:function(){b&&d.lineEnd(),x=null},clean:function(){return v|(m&&b)<<1}}}function c(d,x,u){var b=Bt(d),m=Bt(x),v=[1,0,0],y=qa(b,m),f=fa(y,y),j=y[0],N=f-j*j;if(!N)return!u&&d;var w=a*f/N,E=-a*j/N,A=qa(v,y),C=ha(v,w),L=ha(y,E);Ga(C,L);var T=A,R=fa(C,T),I=fa(T,T),B=R*R-I*(fa(C,C)-1);if(!(B<0)){var F=Lt(B),M=ha(T,(-R-F)/I);if(Ga(M,C),M=on(M),!u)return M;var h=d[0],q=x[0],H=d[1],J=x[1],_;q<h&&(_=h,h=q,q=_);var D=q-h,K=ze(D-de)<ke,W=K||D<ke;if(!K&&J<H&&(_=H,H=J,J=_),W?K?H+J>0^M[1]<(ze(M[0]-h)<ke?H:J):H<=M[1]&&M[1]<=J:D>de^(h<=M[0]&&M[0]<=q)){var Q=ha(T,(-R+F)/I);return Ga(Q,C),[M,on(Q)]}}}function g(d,x){var u=n?e:de-e,b=0;return d<-u?b|=1:d>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return so(l,s,i,n?[0,-e]:[-de,e-de])}function dl(e,a,r,n,o,i){var l=e[0],s=e[1],c=a[0],g=a[1],d=0,x=1,u=c-l,b=g-s,m;if(m=r-l,!(!u&&m>0)){if(m/=u,u<0){if(m<d)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>d&&(d=m)}if(m=o-l,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>d&&(d=m)}else if(u>0){if(m<d)return;m<x&&(x=m)}if(m=n-s,!(!b&&m>0)){if(m/=b,b<0){if(m<d)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>d&&(d=m)}if(m=i-s,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>d&&(d=m)}else if(b>0){if(m<d)return;m<x&&(x=m)}return d>0&&(e[0]=l+d*u,e[1]=s+d*b),x<1&&(a[0]=l+x*u,a[1]=s+x*b),!0}}}}}var Qt=1e9,ga=-Qt;function cl(e,a,r,n){function o(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function i(g,d,x,u){var b=0,m=0;if(g==null||(b=l(g,x))!==(m=l(d,x))||c(g,d)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(d[0],d[1])}function l(g,d){return ze(g[0]-e)<ke?d>0?0:3:ze(g[0]-r)<ke?d>0?2:1:ze(g[1]-a)<ke?d>0?1:0:d>0?3:2}function s(g,d){return c(g.x,d.x)}function c(g,d){var x=l(g,1),u=l(d,1);return x!==u?x-u:x===0?d[1]-g[1]:x===1?g[0]-d[0]:x===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,x=oo(),u,b,m,v,y,f,j,N,w,E,A,C={point:L,lineStart:B,lineEnd:F,polygonStart:R,polygonEnd:I};function L(h,q){o(h,q)&&d.point(h,q)}function T(){for(var h=0,q=0,H=b.length;q<H;++q)for(var J=b[q],_=1,D=J.length,K=J[0],W,Q,te=K[0],he=K[1];_<D;++_)W=te,Q=he,K=J[_],te=K[0],he=K[1],Q<=n?he>n&&(te-W)*(n-Q)>(he-Q)*(e-W)&&++h:he<=n&&(te-W)*(n-Q)<(he-Q)*(e-W)&&--h;return h}function R(){d=x,u=[],b=[],A=!0}function I(){var h=T(),q=A&&h,H=(u=ro(u)).length;(q||H)&&(g.polygonStart(),q&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),H&&io(u,s,h,i,g),g.polygonEnd()),d=g,u=b=m=null}function B(){C.point=M,b&&b.push(m=[]),E=!0,w=!1,j=N=NaN}function F(){u&&(M(v,y),f&&w&&x.rejoin(),u.push(x.result())),C.point=L,w&&d.lineEnd()}function M(h,q){var H=o(h,q);if(b&&m.push([h,q]),E)v=h,y=q,f=H,E=!1,H&&(d.lineStart(),d.point(h,q));else if(H&&w)d.point(h,q);else{var J=[j=Math.max(ga,Math.min(Qt,j)),N=Math.max(ga,Math.min(Qt,N))],_=[h=Math.max(ga,Math.min(Qt,h)),q=Math.max(ga,Math.min(Qt,q))];dl(J,_,e,a,r,n)?(w||(d.lineStart(),d.point(J[0],J[1])),d.point(_[0],_[1]),H||d.lineEnd(),A=!1):H&&(d.lineStart(),d.point(h,q),A=!1)}j=h,N=q,w=H}return C}}const cn=e=>e;var Ka=new Tt,pn=new Tt,lo,co,un,mn,ht={point:et,lineStart:et,lineEnd:et,polygonStart:function(){ht.lineStart=pl,ht.lineEnd=ml},polygonEnd:function(){ht.lineStart=ht.lineEnd=ht.point=et,Ka.add(ze(pn)),pn=new Tt},result:function(){var e=Ka/2;return Ka=new Tt,e}};function pl(){ht.point=ul}function ul(e,a){ht.point=po,lo=un=e,co=mn=a}function po(e,a){pn.add(mn*e-un*a),un=e,mn=a}function ml(){po(lo,co)}var _t=1/0,La=_t,ia=-_t,Fa=ia,Ra={point:fl,lineStart:et,lineEnd:et,polygonStart:et,polygonEnd:et,result:function(){var e=[[_t,La],[ia,Fa]];return ia=Fa=-(La=_t=1/0),e}};function fl(e,a){e<_t&&(_t=e),e>ia&&(ia=e),a<La&&(La=a),a>Fa&&(Fa=a)}var fn=0,hn=0,Jt=0,Ma=0,Oa=0,Dt=0,xn=0,gn=0,Xt=0,uo,mo,ct,pt,Xe={point:qt,lineStart:yr,lineEnd:wr,polygonStart:function(){Xe.lineStart=gl,Xe.lineEnd=bl},polygonEnd:function(){Xe.point=qt,Xe.lineStart=yr,Xe.lineEnd=wr},result:function(){var e=Xt?[xn/Xt,gn/Xt]:Dt?[Ma/Dt,Oa/Dt]:Jt?[fn/Jt,hn/Jt]:[NaN,NaN];return fn=hn=Jt=Ma=Oa=Dt=xn=gn=Xt=0,e}};function qt(e,a){fn+=e,hn+=a,++Jt}function yr(){Xe.point=hl}function hl(e,a){Xe.point=xl,qt(ct=e,pt=a)}function xl(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Ma+=o*(ct+e)/2,Oa+=o*(pt+a)/2,Dt+=o,qt(ct=e,pt=a)}function wr(){Xe.point=qt}function gl(){Xe.point=vl}function bl(){fo(uo,mo)}function vl(e,a){Xe.point=fo,qt(uo=ct=e,mo=pt=a)}function fo(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Ma+=o*(ct+e)/2,Oa+=o*(pt+a)/2,Dt+=o,o=pt*e-ct*a,xn+=o*(ct+e),gn+=o*(pt+a),Xt+=o*3,qt(ct=e,pt=a)}function ho(e){this._context=e}ho.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,tt);break}}},result:et};var bn=new Tt,Qa,xo,go,Zt,ea,sa={point:et,lineStart:function(){sa.point=yl},lineEnd:function(){Qa&&bo(xo,go),sa.point=et},polygonStart:function(){Qa=!0},polygonEnd:function(){Qa=null},result:function(){var e=+bn;return bn=new Tt,e}};function yl(e,a){sa.point=bo,xo=Zt=e,go=ea=a}function bo(e,a){Zt-=e,ea-=a,bn.add(Lt(Zt*Zt+ea*ea)),Zt=e,ea=a}let kr,Da,jr,Nr;class Er{constructor(a){this._append=a==null?vo:wl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==jr||this._append!==Da){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,jr=n,Da=this._append,Nr=this._,this._=o}this._+=Nr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function vo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function wl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return vo;if(a!==kr){const r=10**a;kr=a,Da=function(o){let i=1;this._+=o[0];for(const l=o.length;i<l;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Da}function kl(e,a){let r=3,n=4.5,o,i;function l(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Ot(s,o(i))),i.result()}return l.area=function(s){return Ot(s,o(ht)),ht.result()},l.measure=function(s){return Ot(s,o(sa)),sa.result()},l.bounds=function(s){return Ot(s,o(Ra)),Ra.result()},l.centroid=function(s){return Ot(s,o(Xe)),Xe.result()},l.projection=function(s){return arguments.length?(o=s==null?(e=null,cn):(e=s).stream,l):e},l.context=function(s){return arguments.length?(i=s==null?(a=null,new Er(r)):new ho(a=s),typeof n!="function"&&i.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const c=Math.floor(s);if(!(c>=0))throw new RangeError(`invalid digits: ${s}`);r=c}return a===null&&(i=new Er(r)),l},l.projection(e).digits(r).context(a)}function Cn(e){return function(a){var r=new vn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function vn(){}vn.prototype={constructor:vn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function zn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ot(r,e.stream(Ra)),a(Ra.result()),n!=null&&e.clipExtent(n),e}function yo(e,a,r){return zn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],l=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,c])},r)}function jl(e,a,r){return yo(e,[[0,0],a],r)}function Nl(e,a,r){return zn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),l=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([l,s])},r)}function El(e,a,r){return zn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),l=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,s])},r)}var Sr=16,Sl=Le(30*Ye);function Cr(e,a){return+a?zl(e,a):Cl(e)}function Cl(e){return Cn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function zl(e,a){function r(n,o,i,l,s,c,g,d,x,u,b,m,v,y){var f=g-n,j=d-o,N=f*f+j*j;if(N>4*a&&v--){var w=l+u,E=s+b,A=c+m,C=Lt(w*w+E*E+A*A),L=oa(A/=C),T=ze(ze(A)-1)<ke||ze(i-x)<ke?(i+x)/2:ra(E,w),R=e(T,L),I=R[0],B=R[1],F=I-n,M=B-o,h=j*F-f*M;(h*h/N>a||ze((f*F+j*M)/N-.5)>.3||l*u+s*b+c*m<Sl)&&(r(n,o,i,l,s,c,I,B,T,w/=C,E/=C,A,v,y),y.point(I,B),r(I,B,T,w,E,A,g,d,x,u,b,m,v,y))}}return function(n){var o,i,l,s,c,g,d,x,u,b,m,v,y={point:f,lineStart:j,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=E},polygonEnd:function(){n.polygonEnd(),y.lineStart=j}};function f(L,T){L=e(L,T),n.point(L[0],L[1])}function j(){x=NaN,y.point=N,n.lineStart()}function N(L,T){var R=Bt([L,T]),I=e(L,T);r(x,u,d,b,m,v,x=I[0],u=I[1],d=L,b=R[0],m=R[1],v=R[2],Sr,n),n.point(x,u)}function w(){y.point=f,n.lineEnd()}function E(){j(),y.point=A,y.lineEnd=C}function A(L,T){N(o=L,T),i=x,l=u,s=b,c=m,g=v,y.point=N}function C(){r(x,u,d,b,m,v,i,l,o,s,c,g,Sr,n),y.lineEnd=w,w()}return y}}var Al=Cn({point:function(e,a){this.stream.point(e*Ye,a*Ye)}});function Tl(e){return Cn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ql(e,a,r,n,o){function i(l,s){return l*=n,s*=o,[a+e*l,r-e*s]}return i.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*o]},i}function zr(e,a,r,n,o,i){if(!i)return ql(e,a,r,n,o);var l=Le(i),s=Fe(i),c=l*e,g=s*e,d=l/e,x=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function m(v,y){return v*=n,y*=o,[c*v-g*y+a,r-g*v-c*y]}return m.invert=function(v,y){return[n*(d*v-x*y+u),o*(b-x*v-d*y)]},m}function Ll(e){return Fl(function(){return e})()}function Fl(e){var a,r=150,n=480,o=250,i=0,l=0,s=0,c=0,g=0,d,x=0,u=1,b=1,m=null,v=vr,y=null,f,j,N,w=cn,E=.5,A,C,L,T,R;function I(h){return L(h[0]*Ye,h[1]*Ye)}function B(h){return h=L.invert(h[0],h[1]),h&&[h[0]*ft,h[1]*ft]}I.stream=function(h){return T&&R===h?T:T=Al(Tl(d)(v(A(w(R=h)))))},I.preclip=function(h){return arguments.length?(v=h,m=void 0,M()):v},I.postclip=function(h){return arguments.length?(w=h,y=f=j=N=null,M()):w},I.clipAngle=function(h){return arguments.length?(v=+h?ll(m=h*Ye):(m=null,vr),M()):m*ft},I.clipExtent=function(h){return arguments.length?(w=h==null?(y=f=j=N=null,cn):cl(y=+h[0][0],f=+h[0][1],j=+h[1][0],N=+h[1][1]),M()):y==null?null:[[y,f],[j,N]]},I.scale=function(h){return arguments.length?(r=+h,F()):r},I.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],F()):[n,o]},I.center=function(h){return arguments.length?(i=h[0]%360*Ye,l=h[1]%360*Ye,F()):[i*ft,l*ft]},I.rotate=function(h){return arguments.length?(s=h[0]%360*Ye,c=h[1]%360*Ye,g=h.length>2?h[2]%360*Ye:0,F()):[s*ft,c*ft,g*ft]},I.angle=function(h){return arguments.length?(x=h%360*Ye,F()):x*ft},I.reflectX=function(h){return arguments.length?(u=h?-1:1,F()):u<0},I.reflectY=function(h){return arguments.length?(b=h?-1:1,F()):b<0},I.precision=function(h){return arguments.length?(A=Cr(C,E=h*h),M()):Lt(E)},I.fitExtent=function(h,q){return yo(I,h,q)},I.fitSize=function(h,q){return jl(I,h,q)},I.fitWidth=function(h,q){return Nl(I,h,q)},I.fitHeight=function(h,q){return El(I,h,q)};function F(){var h=zr(r,0,0,u,b,x).apply(null,a(i,l)),q=zr(r,n-h[0],o-h[1],u,b,x);return d=el(s,c,g),C=ln(a,q),L=ln(d,C),A=Cr(C,E),M()}function M(){return T=R=null,I}return function(){return a=e.apply(this,arguments),I.invert=a.invert&&B,F()}}function wo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}wo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,l=i*i;r-=o=(r*(1.007226+i*(.015085+l*(-.044475+.028874*i-.005916*l)))-a)/(1.007226+i*(.015085*3+l*(-.044475*7+.028874*9*i-.005916*11*l)))}while(ze(o)>ke&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Rl(){return Ll(wo).scale(175.295)}function Ml(e){return e}function Ol(e){if(e==null)return Ml;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],l=e.translate[1];return function(s,c){c||(a=r=0);var g=2,d=s.length,x=new Array(d);for(x[0]=(a+=s[0])*n+i,x[1]=(r+=s[1])*o+l;g<d;)x[g]=s[g],++g;return x}}function Dl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Il(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Ar(e,r)})}:Ar(e,a)}function Ar(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Pl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Pl(e,a){var r=Ol(e.transform),n=e.arcs;function o(d,x){x.length&&x.pop();for(var u=n[d<0?~d:d],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));d<0&&Dl(x,m)}function i(d){return r(d)}function l(d){for(var x=[],u=0,b=d.length;u<b;++u)o(d[u],x);return x.length<2&&x.push(x[0]),x}function s(d){for(var x=l(d);x.length<4;)x.push(x[0]);return x}function c(d){return d.map(s)}function g(d){var x=d.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:d.geometries.map(g)};case"Point":u=i(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(i);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=c(d.arcs);break;case"MultiPolygon":u=d.arcs.map(c);break;default:return null}return{type:x,coordinates:u}}return g(a)}const ko={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Bl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function _l(e,a,r){const n=ko[e];if(!n||!n.length)return-1;const o=Bl(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(l=>o.includes(l)))return i}return Math.floor(r*n.length)%n.length}let ba=null;function $l(){return ba||(ba=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Il(r,n),i=Rl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=kl(i),s=(o.features||[]).filter(d=>{var x;return(((x=d.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(d=>{var b;const x=((b=d.properties)==null?void 0:b.name)||"",u=l(d)||"";return u?{i2:pi(x)||null,n:x,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const c={};for(const[d,x]of Object.entries(ui)){const u=i(x);u&&(c[d]={x:u[0],y:u[1]})}const g={};for(const[d,x]of Object.entries(ko)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(g[d]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:c,metros:g}}catch{return null}})(),ba)}function Ul(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return $l().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Hl="8 40 984 210",Vl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Tr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function qr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Wl(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const l=()=>{var g;if(!o)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Lr({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],l)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Gl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:l,lang:s,t:c,data:g,dossiers:d,source:x}=Y(),u=g.loading&&!d.length,b=p.useRef(null),m=p.useRef(null),v=Ul(e.continent==="monde"),y=e.continent==="monde"?v:jn.find(h=>h.key===e.continent)||null,f=Wl(b,e.continent+":"+e.mapFolded+":"+!!y),[j,N]=p.useState(new Map),[w,E]=p.useState(null);p.useEffect(()=>{const h=b.current;if(!h)return;const q=new Map;h.querySelectorAll("path[data-i2]").forEach(H=>{const J=H.dataset.i2;if(J)try{const _=H.getBBox();_.width>0&&q.set(J,{x:_.x,y:_.y,w:_.width,h:_.height})}catch{}}),N(q)},[e.continent,f,y]);const A=p.useMemo(()=>r.filter(h=>h.cc),[r]),C=p.useMemo(()=>{const h=new Map;return A.forEach(q=>h.set(q.cc,(h.get(q.cc)||0)+1)),h},[A]),L=e.continent==="monde"&&v?v.anchors:null,T=e.continent==="monde"&&v?v.metros:null,R=p.useMemo(()=>A.map(h=>{const q=qr(h.name||h.id||""),H=qr((h.id||h.name||"")+"·y");if(L&&h.cc){const W=T?T[h.cc]:void 0;if(W&&W.length){const te=_l(h.cc,h.city,q);if(te>=0&&W[te])return{d:h,x:W[te].x+(q-.5)*5,y:W[te].y+(H-.5)*5}}const Q=L[h.cc];if(Q)return{d:h,x:Q.x+(q-.5)*10,y:Q.y+(H-.5)*10}}const J=h.cc?j.get(h.cc):void 0;if(!J)return null;const _=Vl[`${e.continent}:${h.cc||""}`];if(_)return{d:h,x:J.x+J.w*(_.fx+(q-.5)*_.sx),y:J.y+J.h*(_.fy+(H-.5)*_.sy)};const D=(q-.5)*Math.min(J.w*.55,60),K=(H-.5)*Math.min(J.h*.55,60);return{d:h,x:J.x+J.w/2+D,y:J.y+J.h/2+K}}).filter(h=>!!h),[A,j,L,T,e.continent]),I=h=>f>0?h/f:h,B=p.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:Tr[h],fr:c.plabels[h].toUpperCase(),en:c.plabels[h].toUpperCase(),n:r.filter(q=>q.kind==="target"&&Ae(q)===h).length})).filter(h=>h.n>0):_n.map((h,q)=>({...h,n:r.filter(H=>$n(H)===q).length})),[r,n,c.plabels]),F=i?l.get(i):null,M=F?R.find(h=>h.d.id===F.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Lr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?Hl:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?y.fr:y.en,onMouseLeave:()=>{E(null),o(null)},children:[t.jsx("g",{children:y.countries.map((h,q)=>t.jsx("g",{className:"ct"+(h.i2&&C.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},q))}),t.jsx("g",{children:R.map(h=>{const q=_n[$n(h.d)],H=!!Pe(h.d),J=h.d.kind==="target",_=n&&J?Tr[Ae(h.d)]:q.c,D=!n&&Be(h.d);return t.jsxs("g",{className:"co"+(D?" done":""),onMouseEnter:()=>{var Q,te;const K=(Q=m.current)==null?void 0:Q.getBoundingClientRect(),W=(te=b.current)==null?void 0:te.createSVGPoint();if(W&&b.current&&K){W.x=h.x,W.y=h.y;const he=W.matrixTransform(b.current.getScreenCTM());E({x:he.x-K.left,y:he.y-K.top,label:h.d.name+" · "+(Ht(h.d.cc,s)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{E(null),o(null)},onClick:()=>{var Q;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const K=(Q=b.current)==null?void 0:Q.createSVGPoint();let W=null;if(K&&b.current){K.x=h.x,K.y=h.y;const te=K.matrixTransform(b.current.getScreenCTM());W={x:te.x,y:te.y}}a({type:"popup",id:h.d.id,anchor:W})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:I(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:I(q.px),fill:_,stroke:H?"#DC2626":"#ffffff",strokeWidth:I(H?2.2:1.3)})]},h.d.id||h.d.name)})}),M&&t.jsx("circle",{className:"ring on",cx:M.x,cy:M.y,r:I(13),fill:"none",stroke:"#0F172A",strokeWidth:I(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:B.map((h,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),s==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},q))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Lr,{msgs:c.loadMsgs})})}function Yl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function jo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:l,lang:s}=Y(),c=a.filters,[g,d]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null),m=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(M=>M.continent===a.continent),[n,a.continent]),y=M=>v.filter(h=>M!=="country"&&c.country.length&&!c.country.includes(h.cc||"")?!1:za(h,c,i,M==="country"?void 0:M)),f=M=>!i||M.kind!=="op",j=p.useMemo(()=>{const M=y("win").filter(f),h=q=>M.filter(H=>(H.date?Math.max(0,Math.floor((Date.now()-Date.parse(H.date))/864e5)):9999)<=q).length;return[h(0),h(7),h(30),M.length]},[v,c,i]),N=p.useMemo(()=>c.day?y("win").filter(f).filter(M=>(M.date||"").slice(0,10)===c.day).length:0,[v,c,i]),w=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,E=w+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&d(!1)},[a.openFacet]),p.useEffect(()=>{if(!g&&!x)return;const M=q=>{var J,_;const H=q.target;g&&!((J=b.current)!=null&&J.contains(H))&&d(!1),x&&!((_=m.current)!=null&&_.contains(H))&&u(!1)},h=q=>{q.key==="Escape"&&(d(!1),u(!1))};return document.addEventListener("mousedown",M),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",M),document.removeEventListener("keydown",h)}},[g,x]);const A=(M,h,q,H="fbtn")=>t.jsxs("button",{type:"button",className:H,"aria-expanded":a.openFacet===M,onClick:()=>r({type:"openFacet",facet:M}),children:[t.jsx("span",{className:"fl",children:h}),q>0&&t.jsx("span",{className:"n",children:q}),t.jsx("span",{className:"cv",children:"▾"})]},M),C=["1","7","30","all"],L=Math.max(0,C.indexOf(c.win||"all")),T=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(Yl(c.day,s))}),t.jsx("b",{children:N})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(M=>!M),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:j[L]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((M,h)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===M,onClick:()=>{r({type:"filters",patch:{win:M}}),u(!1)},children:[o.datesShort[h],t.jsx("span",{className:"n",children:j[h]})]},M))})]}):t.jsx("div",{className:"seg",children:C.map((M,h)=>t.jsxs("button",{type:"button","aria-pressed":c.win===M,onClick:()=>r({type:"filters",patch:{win:M}}),children:[t.jsx("span",{className:"sl",children:o.dates[h]}),t.jsx("b",{children:j[h]})]},M))}),R=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:M=>r({type:"filters",patch:{search:M.target.value}})})]}),I=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):A("sec",o.fSector,c.sector.length),A("pay",o.fCountry,c.country.length),A("det",o.fEngine,c.engine.length),A("sta",o.fStage,c.stage.length),i&&A("ang","Angle",c.angle.length),i&&A("mem","Mémo",c.memoLevel.length)]}),B=(M=!1)=>t.jsxs("div",{className:"frow2",children:[E>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(E)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),M&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),F=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(w?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{d(M=>!M),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),w>0&&t.jsx("span",{className:"n",children:w}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:I})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:T}),t.jsxs("div",{className:"fstrip-b",children:[R,F,B(!1)]})]}),a.openFacet&&t.jsx(Fr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[T,R,I,t.jsx("span",{className:"fgrow"}),B()]}),a.openFacet&&t.jsx(Fr,{poolFor:y})]})}function Fr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=Y(),i=a.filters,l=a.openFacet,{title:s,cols:c,options:g}=p.useMemo(()=>{if(l==="sig"){const m=e("signal").filter(f=>Pe(f)),v=new Map;m.forEach(f=>{const j=f.engine||"";v.set(j,(v.get(j)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Za([...v.keys()],o).map(f=>({v:f,label:At(f)+" "+Ke(f,o),n:v.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const m=e("sector"),v=new Map;return m.forEach(y=>{y.sector&&v.set(y.sector,(v.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:i.sector.includes(y)}))}}if(l==="pay"){const m=e("country"),v=new Map;return m.forEach(y=>{y.cc&&v.set(y.cc,(v.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:Ht(y,o)||y,n:f,html:!1,on:i.country.includes(y)}))}}if(l==="det"){const m=e("engine"),v=new Map;return m.forEach(y=>{y.engine&&v.set(y.engine,(v.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Za([...v.keys()],o).map(y=>({v:y,label:At(y)+" "+Ke(y,o)+' <span style="color:var(--dim);font-size:10px">· '+mi(fi(y),o)+"</span>",n:v.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(l==="ang"){const m=e("angle"),v=new Map;return m.forEach(y=>{y.angle&&v.set(y.angle,(v.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(y)}))}}if(l==="mem"){const m=e("memoLevel"),v=new Map;m.forEach(f=>{if(f.kind==="target"){const j=wn(f);v.set(j,(v.get(j)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:y[f],n:v.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const u=e("stage"),b=new Map;return u.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,v)=>v[1]-m[1]).map(([m,v])=>({v:m,label:m,n:v,html:!1,on:i.stage.includes(m)}))}},[l,a,o]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(u)?i.signalEngines.filter(v=>v!==u):[...i.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function No({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:l,t:s}=Y(),c=p.useMemo(()=>{const b={};return r.forEach(m=>{za(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,d]=p.useState(!1),x=p.useRef(null);p.useEffect(()=>{if(!g)return;const b=v=>{var y;(y=x.current)!=null&&y.contains(v.target)||d(!1)},m=v=>{v.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const u=b=>{const m=jn.find(v=>v.key===b);return b==="monde"?s.contWorld:l==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>d(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Un.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),d(!1)},children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[Un.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})})]})}function Eo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Kl(e){var o;const a=[],r=new Set,n=i=>{const l=(i||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Rr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:l}){const{t:s}=Y();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:s.rsEvalOne})]},c.name))})]}):null}function So({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=Y(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Rr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Rr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Ql({card:e,onEvaluate:a,onAddAll:r}){var s,c,g;const{t:n}=Y(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Eo(e.summary_md||"").map((d,x)=>t.jsx("p",{children:d},x))})]}),t.jsx(So,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Jl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Xl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:l}=Y(),s=o,[c,g]=p.useState(null),[d,x]=p.useState(null),[u,b]=p.useState(null),[m,v]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const j=await Vr({email:l,cbToken:s});f&&g(j)})(),()=>{f=!1}},[l,s,n]);const y=f=>{x(f),b(null),v(!0),(async()=>{const j=await hi(f.id);b(j),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Jl(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(Ql,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ja=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ta(e){return/^https?:\/\//i.test((e||"").trim())}function lt(e){const a=(e||"").trim();return a?ta(a)?a:ja.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Zl(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function ed(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:l,evalBusy:s,evalCards:c,caps:g,data:d,canWrite:x,source:u,dossiers:b,doAnalyse:m,liveMemos:v,pipe:y}=Y(),f=a==="client",j=p.useMemo(()=>r||(u!=="default"?xi():""),[r,u]),[N,w]=p.useState(""),[E,A]=p.useState(!1),[C,L]=p.useState(""),[T,R]=p.useState(""),[I,B]=p.useState(""),[F,M]=p.useState(!1),[h,q]=p.useState(!1),H="atl2:evalq:"+(r||"anon"),[J,_]=p.useState(()=>{try{return JSON.parse(localStorage.getItem(H)||"[]")}catch{return[]}});p.useEffect(()=>{try{localStorage.setItem(H,JSON.stringify(J.slice(0,30)))}catch{}},[J,H]);const D=(k,O)=>_(P=>P.map((X,Z)=>Z===k?{...X,...O}:X)),K=(k,O)=>{const P=O.trim();P&&(D(k,{name:P,status:"resolving",site:"",candidates:void 0}),en(P).then(X=>{const Z=X.candidates||[];X.website?D(k,{site:X.website,status:"ready"}):Z.length===1?D(k,{site:Z[0].url,status:"ready"}):Z.length>1?D(k,{status:"pick",candidates:Z.slice(0,4)}):D(k,{status:"ready"})}).catch(()=>D(k,{status:"ready"})))},[W,Q]=p.useState(!1),te=async()=>{if(W)return;const k=J.map((O,P)=>({r:O,i:P})).filter(({r:O})=>O.name.trim()&&O.status!=="kept"&&O.status!=="out"&&O.status!=="resolving");if(k.length){Q(!0);for(const{r:O,i:P}of k){const X=await Wr(r,(O.site||O.name).trim(),"atelier2");if(X.verdict==="quota"){ue(Z=>[{name:"",verdict:"quota",reason:X.reason||"",remaining:0},...Z].slice(0,8));break}D(P,{status:X.verdict==="kept"?"kept":"out",reason:X.reason||""}),ue(Z=>[{name:X.company||O.name,verdict:X.verdict,reason:X.reason||"",remaining:X.remaining??null},...Z].slice(0,8))}Q(!1)}},[he,ee]=p.useState(""),[ce,pe]=p.useState(!1),[je,be]=p.useState(""),[le,ue]=p.useState([]);p.useRef(!1);const[oe,$]=p.useState(!1),[ne,fe]=p.useState(!1),[we,Ne]=p.useState(!1),ve=p.useRef(!1),[re,Te]=p.useState(""),[Qe,me]=p.useState(""),[Ee,Ft]=p.useState(!1),[Oe,He]=p.useState(!1),[Re,at]=p.useState(0),[jt,ot]=p.useState(""),[Se,gt]=p.useState(null),[Me,ut]=p.useState(null),[mt,Nt]=p.useState(!1),[bt,vt]=p.useState(null),[it,Et]=p.useState(0),z=p.useRef(!1),U=N.trim()?ja.test(N.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useMemo(()=>he.split(`
`).map(k=>k.trim()).filter(Boolean).slice(0,15),[he]),p.useEffect(()=>{if(typeof window>"u")return;const k=new URLSearchParams(window.location.search),O=(k.get("rs")||"").trim(),P=(k.get("rstext")||"").trim();O&&/^https?:\/\//i.test(O)&&Te(O),P&&me(P),(O&&/^https?:\/\//i.test(O)||P)&&$(!0)},[]),p.useEffect(()=>{const k=O=>{const P=O.detail||{},X=String(P.url||"").trim(),Z=String(P.text||"").trim();X&&/^https?:\/\//i.test(X)&&Te(X),Z&&me(Z),(X&&/^https?:\/\//i.test(X)||Z)&&($(!0),w(""),L(""),Ft(!0),window.setTimeout(()=>Ft(!1),900))};return window.addEventListener("ppmap:research",k),()=>window.removeEventListener("ppmap:research",k)},[]),p.useEffect(()=>{const k=O=>{const P=O.detail||{},X=String(P.name||"").trim();if(!X)return;$(!1),w(X),L(X);const Z=lt(String(P.website||P.domain||""));R(Z),B(lt(String(P.url||""))),M(!Z),A(!0),window.setTimeout(()=>A(!1),900)};return window.addEventListener("ppmap:prefill",k),()=>window.removeEventListener("ppmap:prefill",k)},[]),p.useEffect(()=>{const k=(C||"").trim();if(!k||oe||T){(T||!k||oe)&&M(!1);return}const O=b.find(Z=>$e(Z.name)===$e(k)),P=lt((O==null?void 0:O.website)||"")||lt((O==null?void 0:O.domain)||"");if(P){R(P),M(!1);return}let X=!0;return M(!0),en(k).then(Z=>{var ge,qe;if(!X)return;const se=lt(Z.website||"")||lt(((qe=(ge=Z.candidates)==null?void 0:ge[0])==null?void 0:qe.url)||"");se&&R(se)}).catch(()=>{}).finally(()=>{X&&M(!1)}),()=>{X=!1}},[C,oe,T,b]),p.useEffect(()=>{const k=O=>{var X;const P=String(((X=O.detail)==null?void 0:X.url)||"").trim();ta(P)&&window.open(P,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",k),()=>window.removeEventListener("ppmap:view",k)},[]),p.useEffect(()=>{if(ve.current===oe)return;ve.current=oe,Ne(!0);const k=window.setTimeout(()=>Ne(!1),560);return()=>window.clearTimeout(k)},[oe]),p.useEffect(()=>{if(typeof window>"u")return;const k=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),O=document.querySelector(".atl2.ops, .atl2.cibles");if(!k||!O)return;const P=()=>O.style.setProperty("--demand-h",`${k.offsetHeight}px`);P();const X=new ResizeObserver(P);return X.observe(k),()=>X.disconnect()},[u,E,Ee,h,oe,we,F]),p.useEffect(()=>{if(!x&&!j){vt(null);return}let k=!0;return(async()=>{const O=await Vr({email:n,cbToken:j});k&&vt(O.length)})(),()=>{k=!1}},[x,j,n,it]);const V=le.length?le:c,ae=d.credits,xe=p.useCallback(k=>{const O=k.map(P=>(P||"").trim()).filter(Boolean);O.length&&(ee(P=>{const X=P.split(`
...
`)}),q(!0))},[]);p.useEffect(()=>{if(!Oe)return;at(0);const k=window.setInterval(()=>at(O=>O+1),1e3);return()=>window.clearInterval(k)},[Oe]);const ie=p.useMemo(()=>{const k=N.trim().toLowerCase();return!k||!y?null:b.find(O=>$e(O.name)===k&&Ae(O)===1)||null},[N,b,y]),De=()=>{const k=N.trim();if(k){if(ie){m(ie);return}o(null,k),f&&w("")}},Je=async()=>{var P,X,Z;if(z.current)return;const k=re.trim().replace(/\s+/g,""),O=Qe.trim();if(!k&&!O){ot(e.rsNeed);return}if(!f&&!j){o(null,k||O.slice(0,80));return}z.current=!0,ot(""),gt(null),ut(null),He(!0);try{const se=await bi({url:k,text:O,email:n,cbToken:j});if(He(!1),!se||se.status!=="success"){ot((se==null?void 0:se.message)||"Erreur");return}gt(se),$(!1),xe((((P=se.prospective)==null?void 0:P.companies_to_evaluate)||[]).map(qe=>(qe==null?void 0:qe.name)||"")),ut({state:"pending"});const ge=await vi(se,{email:n,cbToken:j});ut(ge.ok?{state:"ok",scopeLabel:((X=ge.summary)==null?void 0:X.scope_label)||"",scope:((Z=ge.summary)==null?void 0:Z.scope)||""}:{state:"fail",msg:ge.error||""}),ge.ok&&Et(qe=>qe+1)}finally{z.current=!1,He(!1)}},ye=[Se==null?void 0:Se.industry,...(Se==null?void 0:Se.market_tags)||[],Se==null?void 0:Se.author].map(k=>(k||"").trim()).filter(Boolean),st=(Me==null?void 0:Me.state)==="pending",Wt=Me&&(st?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Me.state==="ok"?t.jsx("span",{className:"rslink ok",children:Me.scope&&Me.scope!=="public"?e.rsSavedIn(Me.scopeLabel||Me.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Me.msg,children:e.rsSaveFail})),Rt=Kl(Se).length,Ie=oe,_e=(C||N).trim(),nt=b.find(k=>$e(k.name)===$e(_e)),Gt=lt(N)||T||lt((nt==null?void 0:nt.website)||"")||lt((nt==null?void 0:nt.domain)||""),Mt=I||lt((nt==null?void 0:nt.url)||""),S=ie?e.actAnalyse:_e?e.evalGoOn(_e.length>22?_e.slice(0,21)+"…":_e):e.evalGo,G=Oe?`${gi(re.trim())==="youtube"&&re.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Re)}`:st?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Ie?" rs-mode":"")+(C&&N.trim()===C||E||Ee?" pair":"")+(E||Ee||we?" echo":"")+(we?" swap":""),children:[t.jsxs("div",{className:"drow"+((Ie?Ee:E)||we?" flash":"")+((Ie?re.trim():ja.test(N.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Ie?re:N,placeholder:Ie?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Ie?600:200,spellCheck:Ie?!1:void 0,inputMode:Ie?"url":void 0,onChange:k=>{if(Ie){Te(k.target.value);return}w(k.target.value),C&&k.target.value.trim()!==C&&(L(""),R(""),B(""),M(!1))},onKeyDown:k=>{k.key==="Enter"&&(Ie?Je():De())}}),t.jsx("span",{className:"detect"+(Ie?" off":"")+(ja.test(N.trim())?" url":""),children:U})]}),t.jsx("span",{className:"dacts",children:Ie?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Oe?" loading":""),disabled:Oe||st||!re.trim()&&!Qe.trim(),onClick:()=>{Je()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:G})]}),t.jsxs("a",{className:"viewbtn"+(ta(re)?"":" off"),href:ta(re)?re.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:k=>{ta(re)||k.preventDefault()},children:[t.jsx(Zl,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ie?" analyse":"")+(s?" loading":""),disabled:s,onClick:De,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:S})]}),t.jsxs("a",{className:"viewbtn sm"+(F?" searching":Gt?"":" off"),href:Gt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:k=>{Gt||k.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(Mt?"":" off"),href:Mt||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:k=>{Mt||k.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&ae&&t.jsxs("button",{type:"button",className:"credits"+(ae.total_available<=0&&!ae.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ae.unlimited?"∞":ae.total_available}),!ae.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ae.daily_grant+ae.purchased]}),ae.total_available<=0&&!ae.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>q(!h),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(oe?" on":""),onClick:()=>$(!oe),children:e.rsOpen}),bt!==null&&bt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(mt?" on":""),onClick:()=>Nt(!mt),children:e.rsArchOpen(bt)})]}),mt&&t.jsx(Xl,{bump:it,cbToken:j,onClose:()=>Nt(!1),onEvaluate:k=>o(null,k),onAddAll:xe}),t.jsx("div",{className:"rsp slim"+(oe?" on":" off"),"aria-hidden":!oe,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:oe?void 0:-1,onClick:()=>fe(k=>!k),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:ne?"▴":"▾"})]}),ne&&t.jsx("textarea",{className:"rstext",value:Qe,placeholder:e.rsTextPh,tabIndex:oe?void 0:-1,onChange:k=>me(k.target.value)})]})}),jt&&t.jsx("div",{className:"rserr",children:jt}),Se&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:Se.title}),Se.source_url&&t.jsx("a",{href:Se.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{gt(null),ut(null)},children:"×"})]}),Se.market&&t.jsx("p",{className:"rsmk",children:Se.market}),ye.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),ye.map(k=>t.jsx("span",{children:k},k))]}),t.jsxs("div",{className:"rsbody",children:[Se.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${Se.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Eo(Se.summary_md||"").map((k,O)=>t.jsx("p",{children:k},O))})]}),t.jsx(So,{card:Se,onEvaluate:k=>o(null,k),onAddAll:xe}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Rt)}),Wt]})]}),h&&t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[J.map((k,O)=>t.jsxs("div",{className:"eq-row",children:[t.jsx("input",{value:k.name,placeholder:e.eqNamePh,onChange:P=>{const X=P.target.value.split(`
`).map(Z=>Z.trim()).filter(Boolean);X.length>1?(_(Z=>{const se=[...Z];return se.splice(O,1,...X.map(ge=>({name:ge,site:"",status:""}))),se.slice(0,30)}),X.forEach((Z,se)=>window.setTimeout(()=>K(O+se,Z),80*se))):D(O,{name:P.target.value})},onBlur:()=>{k.name.trim()&&!k.site&&k.status!=="resolving"&&k.status!=="pick"&&K(O,k.name)},onKeyDown:P=>{P.key==="Enter"&&K(O,k.name)}}),t.jsxs("span",{className:"eq-site",children:[k.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:"…"}),k.status==="pick"&&(k.candidates||[]).map(P=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>D(O,{site:P.url,status:"ready",candidates:void 0}),children:(P.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,26)},P.url)),k.status!=="resolving"&&k.status!=="pick"&&(k.site?t.jsxs("a",{href:k.site.startsWith("http")?k.site:"https://"+k.site,target:"_blank",rel:"nofollow noopener",children:[k.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,30)," ↗"]}):t.jsx("em",{children:k.name.trim()&&k.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-st s-"+(k.status||"vide"),title:k.reason||"",children:k.status==="kept"?"✓ "+e.kept:k.status==="out"?"✗ "+e.dropped:k.status==="ready"?e.eqReady:k.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>_(P=>P.filter((X,Z)=>Z!==O)),children:"×"})]},O)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>_(k=>[...k,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(W?" loading":""),style:{justifyContent:"center"},disabled:W||!J.some(k=>k.name.trim()&&k.status!=="kept"&&k.status!=="out"),onClick:()=>{te()},children:[t.jsx("span",{className:"fill"}),W?e.eqRunning:e.eqGo(J.filter(k=>k.name.trim()&&k.status!=="kept"&&k.status!=="out").length)]}),t.jsx("span",{className:"hint",children:e.eqHint}),J.some(k=>k.status==="kept"||k.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",style:{marginTop:6},onClick:()=>_(k=>k.filter(O=>O.status!=="kept"&&O.status!=="out")),children:e.eqClearDone})]})]}),V.slice(0,1).map((k,O)=>{const P=k.verdict==="kept",X=k.verdict==="quota",Z=k.verdict==="unresolved",se=P?"var(--brand)":X?"var(--bolt)":Z?"var(--blue)":"var(--red)",ge=P?"var(--brand-l)":X?"#FEF3C7":Z?"#EEF4FF":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":se,"--bgc":ge},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:P?"✓ "+e.kept:X?"⏳":Z?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),k.name&&t.jsx("span",{className:"rn",children:k.name}),t.jsx("span",{className:"rr",children:k.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",k.reason]}):null}),!!(k.candidates&&k.candidates.length)&&t.jsx("span",{className:"sitepick",children:k.candidates.map(qe=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:qe.url.startsWith("http")?qe.url:`https://${qe.url}`,target:"_blank",rel:"nofollow noopener",children:[(qe.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,qe.url,k.name),children:e.evalPickGo})]},qe.url))}),!X&&!Z&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:P?1:5});const qe=(k.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ce=[...document.querySelectorAll(".atl2 .list .row")].find(Mo=>{var Rn;return(((Rn=Mo.querySelector(".rnm"))==null?void 0:Rn.textContent)||"").trim().toLowerCase().includes(qe)});Ce&&(Ce.scrollIntoView({behavior:"smooth",block:"center"}),Ce.classList.add("flashrow"),window.setTimeout(()=>Ce.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(P?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},O)}),f&&(i.kept+i.dropped>0||V.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function td(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ad(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Y(),i=e.memoConsole?r.get(e.memoConsole):null,l=p.useMemo(()=>i?[i.reasoning||"",td(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const s=kt(i),c=wn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Pt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function An({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Y(),[l,s]=p.useState(!1),[c,g]=p.useState(null),d=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!d||l)return;s(!0);const u=await yi(r,e);if(s(!1),!u){i(a.actErr);return}g(u.results||[])};return p.useEffect(()=>{if(!d)return;const u=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,d]),p.useEffect(()=>{if(d)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,d]),d?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{x()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const nd=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),va=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function rd(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=va(a.slice(n));break}r+=va(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=va(a.slice(o));break}const l=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=s?s[2].toLowerCase():"";s&&nd.has(c)?r+=`<${s[1]}${c}>`:r+=va(a.slice(o,i+1)),n=i+1}return r}const Mr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ue({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function od(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function id({o:e}){const{t:a,doDeep:r}=Y(),[n,o]=p.useState(!1),i=kt(e),l=[e.reasoning||"",od(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[i&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:i}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((s,c)=>t.jsx("p",{className:"cdtxt",children:s},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Pt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:s=>{s.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:s=>{s.stopPropagation(),o(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:s=>s.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:s=>s.stopPropagation()})]})}function Tn({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=Y(),i=da(e),l=kt(e),s=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=p.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Pt(e)?1:0}].filter(v=>v.n>0),[e,a,s,l,c,g,d]),[u,b]=p.useState("");if(!x.length)return null;const m=x.some(v=>v.k===u)?u:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(v=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===v.k,"data-tour":"tab-"+v.k,className:m===v.k?"on":"",onClick:y=>{y.stopPropagation(),b(v.k)},children:v.lib},v.k))}),t.jsxs("div",{className:"cdbody",onClick:v=>v.stopPropagation(),children:[m==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ue,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Ue,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Ue,{k:a.cdVerdictDate,v:Mr(e.verdictDate,r)})]})]}),m==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:rd(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(sd,{o:e})]}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ue,{k:a.cdSector,v:e.sector}),t.jsx(Ue,{k:a.cdStage,v:e.stage}),t.jsx(Ue,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ue,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Ue,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Ue,{k:a.cdAngle,v:e.angle}),t.jsx(Ue,{k:a.cdDetected,v:Mr(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ue,{k:a.cdName,v:e.contactName}),t.jsx(Ue,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Ue,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="memo"&&t.jsx(id,{o:e}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ue,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Ue,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function sd({o:e}){const{t:a,token:r}=Y(),[n,o]=p.useState(!1),[i,l]=p.useState(null),s=async()=>{n||(o(!0),l(await wi(r,e.name,e.website||e.domain||"")),o(!1))},c=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],d=g.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[g.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function ca({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let l=!1;const s=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Hn({kind:"op",card:e},g).then(d=>{!l&&d&&i.isConnected&&i.replaceChildren(d)})},c=window.requestAnimationFrame(s);return()=>{l=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let l=!1;Hn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&i.isConnected&&i.replaceChildren(c)});const s=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const ld=`
...
`;function dd(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function cd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:l,askEvaluate:s,doAnalyse:c,doDecide:g,doPromote:d,doRepeche:x,doApproach:u,doDeep:b,doOnboard:m,outbound:v,evalBusy:y}=Y(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const j=Pe(f),N=Ae(f),w=kt(f),E=da(f),A=f.kind==="target",C=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Ut.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:ld}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:dd(e.popupAnchor,!!f.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(xt(f.date)),Ke(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[f.cc]}),children:(Ht(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Vt(f.amountEur,o)})]}),i.pipe&&A&&t.jsxs("div",{className:"pstat",children:[E&&t.jsx("span",{className:"vd "+(E==="MATCH"?"v-ok":"v-no"),title:n.vt[E],children:E}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[N]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[At(f.engine)," ",t.jsx("b",{children:Ke(f.engine,o)})," — ",ki(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(wt,{o:f,lg:!0})," ",t.jsx(Ia,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Gr(j,o))," · ",n.win7(Yr(j,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(ca,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&N>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&A&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&A&&t.jsx(Tn,{o:f})]}),t.jsx(An,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||l!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[N===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),N===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),N===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),N===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),Pt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),N===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),N===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function pd(){const{lang:e,token:a,dossiers:r,caps:n}=Y(),o=a||"home",{names:i,verdicts:l}=p.useMemo(()=>{const c=[],g={};return r.forEach(d=>{d.kind!=="target"||!d.name||(c.push(d.name),g[d.name]=ji(d)||"")}),{names:c,verdicts:g}},[r]);return{diff:p.useMemo(()=>i.length?Ni(o,i,l,e):null,[o,i.length]),names:i,verdicts:l,scope:o,caps:n}}function ud(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:l,caps:s}=Y(),[c,g]=p.useState(!1),[d,x]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!c)return;const N=w=>{u.current&&!u.current.contains(w.target)&&g(!1)};return document.addEventListener("click",N,!0),()=>document.removeEventListener("click",N,!0)},[c]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...s.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!l.length,v=p.useRef({});p.useEffect(()=>{v.current={...r}},[r]);const y=N=>{const w=v.current[N],E=w!==void 0?r[N]-w:0;return t.jsxs("button",{type:"button",className:"step"+(N===3&&r[3]>0?" wait":""),style:{"--c":`var(${aa[N]})`,"--tc":N<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===N,title:n.phelp[N],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:N})},children:[t.jsxs("span",{className:"l",children:[n.plabels[N].toUpperCase(),N===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(E>0?" up":E<0?" down":""),children:[r[N],E!==0&&t.jsxs("em",{className:"delta",children:[E>0?"+":"−",Math.abs(E)]})]})]},N)},f=(N,w,E)=>t.jsxs("button",{type:"button",className:"off"+(w?" view":""),style:{"--c":`var(${aa[N]})`},"aria-selected":e.ptab===N,title:n.phelp[N],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:N})},children:[t.jsx("span",{className:"l",children:E.toUpperCase()}),t.jsx("span",{className:"n",children:r[N]})]},N),j=(N,w,E,A=!1)=>t.jsx("button",{type:"button",className:"tool",title:w,disabled:A,onClick:E,children:N},w);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(y)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[j("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(d?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":c,title:n.toolSort,onClick:()=>g(N=>!N),children:"⇅"}),c&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([N,w])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===N,className:"sortopt"+(e.sort.key===N?" on":""),onClick:()=>a({type:"sort",key:N}),children:[w,t.jsx("i",{children:e.sort.key===N?e.sort.dir===1?"↑":"↓":""})]},N))})]}),j("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),j("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function md(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:l}=Y(),s=p.useRef(null),[c,g]=p.useState(60);p.useEffect(()=>{let m=0;const v=()=>{var w;const y=s.current;if(!y)return;const f=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!f)return;const j=f.getBoundingClientRect(),N=y.getBoundingClientRect();g(Math.max(20,Math.min(j.left+j.width/2-N.left,N.width-30)))};return m=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",v)}},[e.ptab]);const d=e.ptab;let x=r.tuto[d].p;if(d===3){const m=n.filter(f=>f.kind==="target"&&Ae(f)===3),v=m.filter(f=>tn(f)==="auto").length,y=m.filter(f=>tn(f)==="cd").length;x=r.tutoPending(v,y,m.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(d===1){const m=n.filter(v=>v.kind==="target"&&Ae(v)===1&&!o.has(v.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(v=>v.id)})}}return null})(),b=Ei(d);return t.jsxs("div",{ref:s,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${aa[d]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const Ja=600,Ct=62,Or="atl2:fstats";function fd(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Y(),[l,s]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Or)==="on"}catch{return!1}}),c=r.stats,g=p.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const x=E=>a==="en"?E.slice(5,10):`${E.slice(8,10)}/${E.slice(5,7)}`,u=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((E,A)=>Math.max(E,A.s||0),0),m=g.length?Ja/g.length:0,v=Math.max(4,m-4),y=g.length>=5&&b>0,f=r.marketEstimate||0,j=x(new Date().toISOString().slice(0,10)),N=E=>[...typeof E=="number"?[[E,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&d&&w.push({cle:"fenetre",periode:e.funPerWindow(x(d),j),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:N(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[w.map(E=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:E.periode}),E.etapes.map(([A,C],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(A)}),t.jsx("i",{children:C})]},E.cle+C)),E.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((c.screened||0)/f*100)))})]}),E.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const A=!l;s(A),A&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Or,A?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},E.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ja} ${Ct}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((E,A)=>{const C=(E.s||0)/b*(Ct-4),L=(E.m||0)/b*(Ct-4),T=A*m+(m-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(E.d)} — ${E.s} ${e.actScreened} · ${E.m} ${e.actKept}`}),t.jsx("rect",{x:T,y:Ct-2-C,width:v,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:T,y:Ct-2-L,width:v,height:L,fill:"#185c38"})]},E.d)}),t.jsx("line",{x1:0,y1:Ct-1.5,x2:Ja,y2:Ct-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Co={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function qn({o:e,locked:a=!1}){const{t:r}=Y(),n=da(e),o=kt(e),i=Ae(e),l=tn(e),s=Si(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Co[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx($s,{o:e})]})}const $t=e=>e.length>22?e.slice(0,21)+"…":e;function la(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function zo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function hd({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const l=()=>{var m,v,y;const s=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!s){n(null);return}const g=s.getBoundingClientRect(),d=c?c.getBoundingClientRect().bottom:g.top;i({top:Math.round(d),left:Math.round(g.left),width:Math.round(g.width)});const x=[...s.querySelectorAll(":scope .grp")];let u=null;for(const f of x){const j=f.querySelector(".grp-h");j&&j.getBoundingClientRect().bottom<=d+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function xd(e){const r=()=>{const n=zo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Dr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Y(),[i,l]=p.useState(!1);if(p.useEffect(()=>{n||l(!1)},[n]),Be(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn($t(e.name))})]})}function Ln({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:l,doPromote:s,doRepeche:c,doApproach:g,dispatch:d,liveMemos:x}=Y(),u=m=>v=>{v.stopPropagation(),m()};if(r.lockActions){const m=u(()=>d({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Ae(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn($t(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),la(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Ca(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),la(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Dr,{o:e})});const b=Ae(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Dr,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ea,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:u(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function gd({o:e}){const{t:a,doThumb:r,thumbOf:n}=Y(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function bd({o:e}){const{lang:a}=Y();return Pe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(wt,{o:e}),t.jsx(Ia,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[At(e.engine||"")," ",Ke(e.engine||"",a)]})})}function vd({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:l,fresh:s}){const{dispatch:c,caps:g,markRow:d,markedId:x,favIds:u,toggleFav:b,t:m}=Y(),v=Ae(e),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,j=f<=0?0:f<=7?1:f<=30?2:3,N=g.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][v]:y[j],w=u.has(e.id),E=A=>{if(a)return;if(l){l(e.id);return}if(g.pipe||e.kind==="op"){n();return}const C=A.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+v:"")+(w?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:E,children:[t.jsx("span",{className:"pt",style:{"--c":N}}),t.jsx(Fo,{o:e}),t.jsxs("span",{className:"nd",children:[s&&t.jsx("span",{className:"rfresh",children:"✨"}),Pe(e)&&t.jsx(wt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:w?1:.35,padding:0,marginRight:4},onClick:A=>{A.stopPropagation(),b(e)},children:w?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Ve(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(A=>A&&A!==e.name)||""]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:A=>{A.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",$t(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(yd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(bd,{o:e}),g.pipe&&t.jsx(qn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Ln,{o:e}),g.showThumbs&&t.jsx(gd,{o:e})]}),r&&!a&&!l&&t.jsx(jd,{o:e})]})}function yd({o:e}){const{lang:a,caps:r}=Y();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Vt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function wd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Y(),l=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Vt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Be(e),x=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Ve(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),la(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn($t(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ca,{spec:e.card})})]})}function kd({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Y();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ke(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Ln,{o:e})}),t.jsx(Tn,{o:e})]})}function Ao({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:l,caps:s,dossiers:c}=Y(),g=p.useRef(null),d=We(e);if(p.useEffect(()=>{if(!d||!(e!=null&&e.decryptHtml))return;const h=g.current;if(!h)return;let q=!1;return Xa(()=>import("./fit-BnaWm7z_.js"),[]).then(async H=>{await H.ensureEditoCss(),!(q||!h.isConnected)&&(H.beautifyEditoRows(h),H.mountCardFits(h))}),()=>{q=!0}},[d,e==null?void 0:e.decryptHtml]),!e&&!a){const h=c.find(We);if(h)return t.jsx(Ao,{o:h})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!x||Sa(x),y=(e==null?void 0:e.engine)||"",f=We(e),j=e?Vt(e.amountEur,n):"",N=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),w=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),E=c.find(We),A=((E==null?void 0:E.url)||"").trim(),C=!!u&&!!A&&(u===A||u.endsWith(A)||A.endsWith(u)),L=(h,q=!1)=>H=>{H.stopPropagation(),q&&l({type:"continent",key:"monde"}),l({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const T=()=>{x&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:x}}))},R=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},I=()=>{la({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},B=e?Be(e):!1,F=B&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",M=f?r.doEdito.replace(/^📖\s*/,""):y?Ke(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[M,N?` · ${N}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(v||Ca({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,w?t.jsx("em",{children:w}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),j&&t.jsx("span",{className:"oc-amt",children:j})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(ca,{spec:m})}),(u&&!C&&!f||E&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!C&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,w?` · ${w}`:""," ↗"]}),E&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),l({type:"focus",id:E.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[B?t.jsxs("span",{className:"verdict",style:{"--c":F?"var(--brand)":"var(--red)"},children:[F?"✓":"✗"," ",t.jsx("b",{children:F?r.kept:r.dropped})]}):!v&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:h=>{h.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn($t(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(v||Ca({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&x?" ghost":""),onClick:h=>{h.stopPropagation(),I()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!s.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),R()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:$t(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&x&&s.pipe&&t.jsx(An,{name:x})]})]})}function jd({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:l}=Y();return!o.pipe&&e.kind==="op"?t.jsx(wd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Tn,{o:e}),t.jsx(Us,{o:e}),t.jsx(Ws,{o:e}),t.jsx(An,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(qn,{o:e})})]}),e.card&&t.jsx(ca,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[At(e.engine||"")," ",Ke(e.engine||"",r)]}),Pe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(wt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Nd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:l,doDecide:s,lang:c}=Y();if(!l.pipe&&e.kind==="op"){const x=Vt(e.amountEur,c),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ca,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[At(e.engine||"")," ",Ke(e.engine||"",c)]}),Pe(e)&&t.jsx(wt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Ln,{o:e})})]})}const g=Ae(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":d},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(qn,{o:e}),Pe(e)&&t.jsx(wt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>s(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>s(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemo," →"]})]})}function Ed(){const{t:e}=Y(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Sd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Y(),i=o==="en",l=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),c=s.includes(0)?0:s.sort((d,x)=>(e[x]||0)-(e[d]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${l(c)}”`:`${g} dossier${g>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+l(c)," →"]})]})}function Cd(){var Nt,bt,vt,it,Et;const e=Y(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:l,scopedAll:s,markRow:c,lang:g,sessTally:d,data:x,dossiers:u,source:b,focusExtra:m,byId:v,token:y}=e,f=Jr(),j=p.useMemo(()=>{var V,ae,xe,ie;if(!y||b==="ops")return null;const z=(((V=f==null?void 0:f.ed)==null?void 0:V.date)||(f==null?void 0:f.day)||"").slice(0,10),U=[(ae=f==null?void 0:f.ed)==null?void 0:ae.html,(xe=f==null?void 0:f.ed)==null?void 0:xe.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((ie=f==null?void 0:f.ed)==null?void 0:ie.date)||z,decryptHtml:U||void 0,date:z,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,g,(Nt=f==null?void 0:f.ed)==null?void 0:Nt.html,(bt=f==null?void 0:f.ed)==null?void 0:bt.acquirers_html,(vt=f==null?void 0:f.ed)==null?void 0:vt.date,f==null?void 0:f.day]),N=z=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Qr,[w,E]=p.useState(new Set);p.useEffect(()=>{E(new Set)},[a.ptab,a.continent]);const[A,C]=p.useState(null);p.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[L,T]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){T(!1);return}const z=document.getElementById("atl2-stage");if(!z){T(!1);return}const U=new IntersectionObserver(([V])=>T(!!V&&V.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return U.observe(z),()=>U.disconnect()},[a.mapFolded]);const R=a.mapFolded||!L,I=z=>E(U=>{const V=new Set(U);return V.has(z)?V.delete(z):V.add(z),V}),B=b==="ops"||o.pipe,[F,M]=p.useState("all"),[h,q]=p.useState(!1),[H,J]=p.useState(null),[_,D]=p.useState(!1),K=p.useRef(!0);p.useEffect(()=>{if(K.current){K.current=!1;return}M("all"),D(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!_)return;const z=U=>{var V,ae;(ae=(V=U.target)==null?void 0:V.closest)!=null&&ae.call(V,".atl2 .doable")||D(!1)};return document.addEventListener("click",z,!0),()=>document.removeEventListener("click",z,!0)},[_]);const W=p.useMemo(()=>{var U;const z=new Map;for(const V of zs(((U=f==null?void 0:f.ed)==null?void 0:U.html)||""))z.has(V.t)||z.set(V.t,V.html);return z},[(it=f==null?void 0:f.ed)==null?void 0:it.html]),Q=p.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!W.size)return;const U=(z.name||"").trim().toLowerCase();if(U.length<3)return;const V=W.get(U);if(V)return V;for(const[ae,xe]of W)if(ae.includes(U)||U.includes(ae))return xe},[W]),{diff:te}=pd(),[he,ee]=p.useState(!1),ce=a.filters.win==="1"&&!a.filters.day,[pe,je]=p.useState(!1),be=p.useMemo(()=>new Set(((te==null?void 0:te.added)||[]).map(z=>z.trim().toLowerCase()).filter(Boolean)),[te]),le=p.useMemo(()=>{if(!be.size)return 0;const z={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(U=>!We(U)&&be.has((U.name||"").trim().toLowerCase())&&na(U,z,o.pipe)).length},[u,be,a,o.pipe]);p.useEffect(()=>{const z=()=>{je(!1),q(!1),M("all"),D(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",z),()=>window.removeEventListener("ppmap:tunnel",z)},[]),p.useEffect(()=>{je(!1),q(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const ue=p.useMemo(()=>{const z=s.filter(V=>!We(V)&&Ve(V));let U="";for(const V of z){const ae=(V.date||"").slice(0,10);ae&&(!U||ae<U)&&(U=ae)}return{n:z.length,since:U?U.split("-").reverse().slice(0,2).join("/"):""}},[s]),oe=ue.n,$=p.useMemo(()=>{const U=pe&&be.size>0||a.filters.signalOnly||F!=="all"||h?s:l;let V=Nn(U,a.sort);return V=V.filter(ae=>!We(ae)),pe&&be.size&&(V=V.filter(ae=>be.has((ae.name||"").trim().toLowerCase()))),h||F==="explore"?V=V.filter(Ve):F==="eval"?V=V.filter(ae=>!Ve(ae)&&!ae.noCo&&(ae.kind==="op"||!Be(ae))):o.pipe&&(V=V.filter(ae=>!Ve(ae))),V},[l,s,a.sort,F,pe,be,h,o.pipe]),fe=p.useMemo(()=>o.pipe?u.filter(z=>z.kind==="target"&&!We(z)&&Pe(z)&&(a.continent==="monde"||z.continent===a.continent)):$.filter(z=>Pe(z)&&!Be(z)),[o.pipe,u,$,a.continent]).length,we=p.useMemo(()=>o.pipe?$:$.filter(z=>!Be(z)&&!z.noCo&&!Ve(z)),[$,o.pipe]),Ne=b==="ops"?$.filter(Ve).length:0,ve=pe?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,re=a.filters,Te=[];if(re.day)Te.push({k:"day",lib:n.fDay(re.day.slice(8,10)+"/"+re.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(re.win&&re.win!=="all"){const z=["1","7","30"].indexOf(re.win);z>=0&&Te.push({k:"win",lib:n.dates[z],off:()=>r({type:"filters",patch:{win:"all"}})})}const Qe=z=>z.length<=2?z.join(", "):`${z.length} ${n.fSelected}`;for(const z of["sector","country","engine"]){const U=re[z];U&&U.length&&Te.push({k:z,lib:Qe(U),off:()=>r({type:"clearFacet",facet:z})})}re.search&&Te.push({k:"search",lib:"🔍 "+re.search,off:()=>r({type:"filters",patch:{search:""}})}),pe&&be.size&&Te.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>je(!1)}),re.signalOnly&&Te.push({k:"sig",lib:"🔴 "+n.sigDock(fe||re.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const me=(z,U,V="",ae=!1)=>t.jsxs("button",{type:"button","data-s":z,className:V,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:ae?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[U,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),Ee=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const z=new Map;$.forEach(ae=>{const xe=ae.engine||"?";z.has(xe)||z.set(xe,[]),z.get(xe).push(ae)});const U={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},V=Za([...z.keys()],g);return[...z.entries()].sort((ae,xe)=>{const ie=U[ae[0]]??10+V.indexOf(ae[0]),De=U[xe[0]]??10+V.indexOf(xe[0]);return ie-De})},[$,o.pipe,a.groupBy,g]),Ft=Ee?Ee.filter(([z])=>wa.has(z)).length:0,Oe=(()=>{var U;return((U=(Ee?Ee.flatMap(([,V])=>V):$)[0])==null?void 0:U.id)??null})(),He=p.useRef(!1),Re=p.useMemo(()=>u.find(We)||j,[u,j]);p.useEffect(()=>{const z=()=>{He.current=!0,je(!1)};return window.addEventListener("ppmap:reveal",z),window.addEventListener("ppmap:focus",z),()=>{window.removeEventListener("ppmap:reveal",z),window.removeEventListener("ppmap:focus",z)}},[]),p.useEffect(()=>{const z=()=>{Re&&r({type:"focus",id:Re.id})};return window.addEventListener("ppmap:edito",z),()=>window.removeEventListener("ppmap:edito",z)},[Re,r]),p.useEffect(()=>{if(!a.focusId)return;J(a.focusId);const z=window.setTimeout(()=>J(null),900);return()=>window.clearTimeout(z)},[a.focusId]),p.useEffect(()=>{if(B&&!(a.focusId&&($.some(z=>z.id===a.focusId)||u.some(z=>z.id===a.focusId)||a.focusId===(Re==null?void 0:Re.id)))&&!m){if(Re){r({type:"focus",id:Re.id});return}Oe&&r({type:"focus",id:Oe})}},[B,a.focusId,$,Oe,m,r,u,b,Re]),p.useEffect(()=>{if(!B||!a.focusId||Re&&a.focusId===Re.id||$.some(U=>U.id===a.focusId))return;const z=u.find(U=>U.id===a.focusId);if(z){if(He.current){z.kind==="op"?M(Ve(z)?"explore":"eval"):F!=="all"&&M("all");return}F!=="all"&&Oe&&r({type:"focus",id:Oe})}},[B,a.focusId,F,$,u,Oe,r,Re]),p.useEffect(()=>{if(!B||!a.focusId||!He.current)return;const z=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!z){const xe=$.findIndex(ie=>ie.id===a.focusId);if(xe>=0){const ie=Ee?"":"pt"+a.ptab;if(ie){const De=a.shown[ie]||N();xe>=De&&r({type:"more",group:ie,by:xe-De+8})}}return}He.current=!1;const U=zo(),V=z.getBoundingClientRect();V.top>=U-2&&V.bottom<=window.innerHeight-4||xd(z)},[B,a.focusId,a.ptab,$,a.shown,Ee,r]),p.useEffect(()=>{if(typeof window>"u")return;const z=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),U=document.querySelector(".atl2.ops, .atl2.cibles");if(!z||!U)return;const V=()=>U.style.setProperty("--listhead-h",`${z.offsetHeight}px`);V();const ae=new ResizeObserver(V);return ae.observe(z),()=>ae.disconnect()},[R,a.dens,a.mapFolded]);const at=p.useMemo(()=>{if(!B||!a.focusId)return null;if(j&&a.focusId===j.id)return j;const z=$.find(V=>V.id===a.focusId)||u.find(V=>V.id===a.focusId)||null;if(!z)return null;const U=Q(z);return U&&U!==z.decryptHtml?{...z,decryptHtml:U}:z},[B,a.focusId,$,u,Q,j]),jt=o.lockRowsAfter;let ot=0;const Se=(z,U)=>{let V=a.shown[U]||N();return z.length-V<=4&&(V=z.length),z.slice(0,V).map(ie=>{const De=jt!==null&&ot>=jt;ot++;const Je=Q(ie),ye=Je&&Je!==ie.decryptHtml?{...ie,decryptHtml:Je}:ie,st=!B&&a.dens!=="maxi"&&(a.dens==="deplie"||(A?A==="open":!!Je)),Wt=w.has(ie.id)?!st:st,Rt=B?Ie=>{He.current=!0,r({type:"focus",id:Ie});const _e=v.get(Ie);_e&&(Ve(_e)?la(_e):_e.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:_e.name,url:_e.url||"",website:_e.website||"",domain:_e.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Nd,{o:ye,locked:De,selected:B&&a.focusId===ie.id,onSelect:Rt},ie.id):t.jsx(vd,{o:ye,locked:De,open:Wt,onToggle:()=>I(ie.id),selected:B&&a.focusId===ie.id,echo:H===ie.id,fresh:be.has((ie.name||"").trim().toLowerCase()),onSelect:Rt},ie.id)})},gt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+($.length?"":" list-empty"),Me=t.jsxs(t.Fragment,{children:[Ee?Ee.map(([z,U])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:At(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:z==="ma"?n.grpMa:z==="fundraising"?n.grpLev:wa.has(z)&&Ft<=1?n.grpNews:z==="nominations"?n.grpNom:z==="media"?n.grpNewsOther:z==="recrutements"?n.grpHire:wa.has(z)?n.grpNews+" · "+Ke(z,g):Ke(z,g)}),t.jsx("div",{className:"s",children:n.grpCount(U.filter(V=>!Be(V)).length,U.length)})]})]}),Se(U,z)]},z)):Se($,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(Ed,{}),!$.length&&!(x.loading&&!u.length)&&(o.pipe&&F==="all"?t.jsx(Sd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),ut=t.jsxs(t.Fragment,{children:[!pe&&!h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+aa[a.ptab]+")"},children:$.length})," ",ve]}),h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+aa[a.ptab]+")"},children:$.length})," ",n.newsWord]}),(!pe||h)&&t.jsx("span",{className:"dot",children:"·"}),R&&t.jsx(No,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[R?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),Te.map(z=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:U=>{U.stopPropagation(),z.off()},children:[z.lib,t.jsx("i",{children:"×"})]},z.k)),b==="ops"&&$.length>0&&!R&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",$.length-Ne," ",n.zoomPulseEval,Ne>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",Ne," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),mt=t.jsxs("div",{className:"listhead"+(R?" mapoff":""),children:[R&&t.jsx("div",{className:"lh-tools",children:t.jsx(jo,{compact:!0})}),o.showFunnel&&he&&ce&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(Ys,{}),t.jsx(fd,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:ut}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(ud,{}),t.jsx(md,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ce?" on":""),"aria-pressed":ce,title:n.morningDockTitle,onClick:()=>{if(ce){r({type:"filters",patch:{win:"all",day:""}}),ee(!1);return}je(!1),q(!1),M("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),ee(!0)},children:["📊 ",n.morningDock(typeof((Et=x.stats)==null?void 0:Et.screened_today)=="number"?x.stats.screened_today:0)]}),te&&!te.firstVisit&&(te.added.length>0||te.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(pe?" on":""),"aria-pressed":pe,title:n.sinceSub,onClick:()=>{const z=!pe;je(z),q(!1),ee(!1),M("all"),z&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(le),te!=null&&te.lastDate?` · ${n.sinceSince(te.lastDate)}`:""]}),fe>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{je(!1),q(!1),ee(!1),M("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(fe)]}),o.pipe&&oe>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(h?" on":""),"aria-pressed":h,title:n.newsDockHint,onClick:()=>{const z=!h;q(z),je(!1),ee(!1),M("all"),z&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(oe),ue.since?` · ${n.newsSince(ue.since)}`:""]})]}),!o.showFunnel&&ut,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,U])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:U})]},z))}),!B&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":A==="open",onClick:()=>{C("open"),E(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":A==="closed",onClick:()=>{C("closed"),E(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var Je;const z={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},U=u.filter(ye=>na(ye,z,o.pipe)&&!We(ye)),V=U.filter(ye=>!Ve(ye)&&!ye.noCo&&(ye.kind==="op"||!Be(ye))).length,ae=U.filter(Ve).length,xe=o.pipe?U.filter(ye=>ye.kind!=="op"&&Ae(ye)===1).length:0,ie=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${xe?` ${xe}`:""}`]]:[],["eval",`${n.doEval}${V?` ${V}`:""}`],["explore",`${n.doExplore}${ae?` ${ae}`:""}`]],De=((Je=ie.find(([ye])=>ye===F))==null?void 0:Je[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":_,onClick:()=>D(ye=>!ye),children:[De,t.jsx("i",{children:"▾"})]}),_&&t.jsx("div",{className:"dolist",children:ie.map(([ye,st])=>t.jsx("button",{type:"button","aria-pressed":F===ye,onClick:()=>{if(D(!1),ye==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}M(ye),ye!=="all"&&(je(!1),q(!1),ee(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:st},ye))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([z,U])=>t.jsx("option",{value:z,children:U},z))})]}),o.showChain&&we.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:we.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(we.length):n.chainAll(we.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!B&&mt,a.dens!=="maxi"&&!B&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),me("country",n.colCountry),me("name",n.colCompany),me("amount",n.colAmount,"h-amt",!0),me("stage",n.colStage,"h-stade"),me("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[me("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),me("memo",n.colMemo)]}),o.pipe&&me("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),B?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[mt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),me("country",n.colCountry),me("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[me("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),me("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:gt,children:Me})]}),t.jsxs("aside",{className:"readpane"+((at?We(at):!m&&Re)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[Re&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===Re.id,onClick:()=>r({type:"focus",id:Re.id}),children:n.doEdito}),j&&a.focusId===j.id?t.jsx("div",{className:"zoom",children:t.jsx(Fs,{})}):at&&o.pipe?t.jsx(kd,{o:at}):t.jsx(Ao,{o:at,extra:at?null:m})]})]}):t.jsx("div",{className:gt,children:Me}),(()=>{const z=Ee||[["pt"+a.ptab,$]];let U=0,V=0;for(const[xe,ie]of z){V+=ie.length;let De=a.shown[xe]||N();ie.length-De<=4&&(De=ie.length),U+=Math.min(ie.length,De)}const ae=V-U;return ae<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([xe,ie])=>r({type:"more",group:xe,by:ie.length,base:N()})),children:[t.jsx("span",{className:"more-label",children:n.more(ae,ae)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(U,V)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}}),B&&b==="ops"&&a.dens!=="maxi"&&t.jsx(hd,{on:!!Ee,rev:(Ee||[]).map(([z,U])=>z+U.length).join("|")})]})}function Ir(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function zd(e,a){const r=Ci(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Ad(e,a){const n=[a.head.split("|").map(Ir).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",zd(o,a.plabels),da(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Ir).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Td(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const qd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function dt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Ld({o:e,qa:a}){const{t:r,lang:n,fund:o}=Y(),i=(e.cribleStatus||"").trim().toUpperCase()||(da(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=kt(e),s=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(dt,{k:r.cdSector,v:e.sector}),t.jsx(dt,{k:r.cdStage,v:e.stage}),t.jsx(dt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(dt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(dt,{k:r.cdName,v:e.contactName}),t.jsx(dt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(dt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(dt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(dt,{k:r.cdAngle,v:e.angle}),t.jsx(dt,{k:r.cdDetected,v:qd(e.date,n)})]}),c.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,g])=>g).map(([g,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:d})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Fd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:l}=Y(),[s,c]=p.useState({}),g=25,d=p.useMemo(()=>n.slice(0,g),[n]);p.useEffect(()=>{d.length&&zi(r,d.map(b=>b.name)).then(c)},[r,d]);const x=i.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(x.screened/i.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(Ld,{o:b,qa:s[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Rd=50;function Fn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Y(),[i,l]=p.useState(null),[s,c]=p.useState(!1),[g,d]=p.useState(""),[x,u]=p.useState(0),[b,m]=p.useState(""),[v,y]=p.useState(!1),[f,j]=p.useState(0),N=p.useRef(null),w=p.useRef(null),E=()=>{j(0),w.current&&window.clearInterval(w.current),w.current=window.setInterval(()=>j(T=>T+1),1e3)},A=()=>{w.current&&(window.clearInterval(w.current),w.current=null)};p.useEffect(()=>()=>{N.current&&window.clearInterval(N.current),w.current&&window.clearInterval(w.current)},[]);const C=async T=>{c(!0),d(""),E();const R=await a();if(c(!1),A(),R.ok){l(R);return}if(R.busy){d(o.alertPreviewBusy);return}if(!T){d(o.alertPreviewFail);return}u(Rd),A(),N.current=window.setInterval(()=>{u(I=>I>1?I-1:(N.current&&window.clearInterval(N.current),C(!1),0))},1e3)},L=async()=>{if(n||v||s)return;y(!0),m(""),E();const T=await r();y(!1),A(),m(T.ok?o.alertTestOk(T.sentTo||""):T.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||v||x>0,onClick:()=>{C(!0)},children:s?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||s,onClick:()=>{L()},children:v?o.alertBtnTestBusy:o.alertTest})]}),s&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const It="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ge({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=Y();return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Md(){const{st:e}=Y();switch(e.modal){case"chain":return t.jsx(Dd,{});case"space":return t.jsx(Id,{});case"alert":return t.jsx(Pd,{});case"queue":return t.jsx(Hd,{});case"export":return t.jsx(Vd,{});case"plug":return t.jsx(Yd,{});case"recharge":return t.jsx(Qd,{});case"cover":return t.jsx(Xd,{});case"dossier":return t.jsx(Jd,{});case"crit":return t.jsx(Zd,{});case"tuto":return t.jsx(ec,{});case"rdv":return t.jsx(Od,{});case"memoalert":return t.jsx(Wd,{});default:return null}}function Od(){const{dispatch:e,fund:a,t:r}=Y(),n=a||r.rdvCoFallback;return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:eo,children:Sn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Aa}`,children:Aa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Xi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function Dd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:l,evalBusy:s,caps:c,memoQueued:g,doAnalyse:d}=Y(),x=i==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,m=u[b],v=b>=u.length;return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Ht(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(xt(m.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ke(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Vt(m.amountEur,o)})]}),Pe(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(wt,{o:m,lg:!0})," ",t.jsx(Ia,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&Be(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&Be(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":zt(m)==="retenu"?"var(--brand)":zt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:zt(m)==="retenu"?"✓ "+n.kept:zt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&c.pipe&&Ae(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(x&&Be(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function Id(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Y(),i=o==="client",l=p.useMemo(()=>i?r.filter(x=>Be(x)):[],[r,i]),s=p.useMemo(()=>Nn(l.filter(x=>zt(x)==="retenu"),{key:"signal",dir:-1}),[l]),c=p.useMemo(()=>l.filter(x=>zt(x)==="ecarte"),[l]),g=e.spaceTab==="retenu"?s:c,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ge,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Pd(){const{mode:e}=Y();return e==="client"||e==="apercu"?t.jsx(Bd,{}):t.jsx(Ud,{})}function Bd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Y(),[i,l]=p.useState("d"),s=o!=="client";return t.jsxs(Ge,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(_d,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx($d,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(To,{})]})}function _d({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=p.useState(null),[s,c]=p.useState(!1),[g,d]=p.useState(0);p.useEffect(()=>{let L=!0;return c(!1),Gn(a).then(T=>{L&&(T?l(T):c(!0))}),()=>{L=!1}},[a,g]);const x=p.useRef({}),[u,b]=p.useState({}),[m,v]=p.useState(!1),[y,f]=p.useState(!1),j=p.useRef(null);p.useEffect(()=>()=>{j.current&&window.clearTimeout(j.current)},[]);const N=L=>{const T=x.current;Object.keys(T).length&&(v(!0),Gn(a,T).then(R=>{if(!R){v(!1),o(e.actErr);return}if(R.throttled&&L<3){j.current=window.setTimeout(()=>N(L+1),5400);return}if(x.current={},b({}),l(R),v(!1),R.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},w=L=>{r||(x.current={...x.current,...L},b(T=>({...T,...L})),j.current&&window.clearTimeout(j.current),j.current=window.setTimeout(()=>N(1),700))};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const E={...i,...u},A=L=>!E.sections||E.sections.includes(L),C=L=>{const T=E.sections||e.alertSec.map(([R])=>R);w({sections:A(L)?T.filter(R=>R!==L):[...T,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":E.enabled===!0,disabled:r,style:E.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!E.enabled}),children:E.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>w({hour:Math.max(6,(E.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[E.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>w({hour:Math.min(21,(E.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,T])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:A(L),disabled:r,onChange:()=>C(L)}),t.jsxs("span",{children:[T,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Fn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ii(a),onTest:()=>Di(a)}),E.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),E.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",E.email_lead,E.last_sent?` · ${e.updatedAt(E.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function $d({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=p.useState(null),[s,c]=p.useState(!1),[g,d]=p.useState(0);p.useEffect(()=>{let m=!0;return c(!1),Yn(a).then(v=>{m&&(v?l(v):c(!0))}),()=>{m=!1}},[a,g]);const x=m=>{r||Yn(a,m).then(v=>{if(!v){o(e.actErr);return}l(v),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Fn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Bi(a),onTest:()=>Pi(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function To(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Y(),[l,s]=p.useState(i||""),[c,g]=p.useState(!1),[d,x]=p.useState(!1);p.useEffect(()=>{i&&s(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(f=>Pe(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){x(!0);try{await fetch(`${yn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Ke(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>Ht(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!i,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Ud(){const{t:e}=Y();return t.jsx(Ge,{title:e.alertTitle,icon:"🔔",children:t.jsx(To,{})})}function Hd(){var I,B;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:l,caps:s,dispatch:c,liveMemos:g}=Y(),[d,x]=p.useState(()=>_a(r)),[u,b]=p.useState(()=>!_a(r)),[m,v]=p.useState([]),[y,f]=p.useState(0),j=n==="client",N=p.useMemo(()=>{const F=new Map;return o.forEach(M=>{const h=(M.name||"").trim().toLowerCase();h&&!F.has(h)&&F.set(h,M)}),F},[o]);p.useEffect(()=>{let F=!0;return(!_a(r)||y>0)&&b(!0),(async()=>{const[M,h]=await Promise.all([kn(r,y>0),Hr(a)]);F&&(M&&x(M),b(!1),v(h))})(),()=>{F=!1}},[a,r,y]);const w=u&&!d,E=(d==null?void 0:d.per_day)??0,A=((I=d==null?void 0:d.analyzed_today)==null?void 0:I.length)??0,C=d==null?void 0:d.offre,L=(d==null?void 0:d.pool_meta)||[],T=p.useMemo(()=>{const F=new Map;for(const M of(d==null?void 0:d.scheduled)||[])for(const h of M.names||[])F.has(h)||F.set(h,{label:M.day_label,date:M.date});return F},[d==null?void 0:d.scheduled]),R=(d==null?void 0:d.in_progress)||[];return t.jsxs(Ge,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:w?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(A,A+(((B=d==null?void 0:d.pool_order)==null?void 0:B.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!w&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(E)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(R.length>0||g.items.some(F=>F.status==="boot"||F.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(F=>F.status==="boot"||F.status==="running"||F.status==="error").map(F=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:F.name}),t.jsx("span",{className:"qd",children:F.memoType||""}),t.jsx(Ea,{item:F,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+F.name)),R.filter(F=>!g.liveOf(F.name)).map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.name}),t.jsxs("span",{className:"qd",children:[F.memo_type||"",F.age_min?` · ${Math.round(F.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:F.state||""})]},"ip-"+F.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.company}),t.jsxs("span",{className:"qd",children:[F.memo_type,typeof F.est_min=="number"?` · ~${F.est_min} min`:""]}),t.jsx("span",{className:"qt",children:F.status}),F.url&&t.jsx("a",{className:"qgo",href:F.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),j&&F.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Wn(a,F.company,"retry").then(()=>f(M=>M+1))},children:e.queueRetry}),j&&F.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Wn(a,F.company,"delete").then(()=>f(M=>M+1))},children:e.queueDelete})]},F.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",w?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[w&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!w&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((F,M)=>{const h=T.get(F.name),q=N.get((F.name||"").trim().toLowerCase()),H=g.liveOf(F.name),J=!!(q&&l.has(q.id))||!!(H&&(H.status==="boot"||H.status==="running")),_=!!(q&&Ae(q)===1&&!q.memoUrl)&&!H;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",M+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:F.name}),F.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof F.score=="number"&&t.jsx("span",{className:"qs2",children:F.score}),H&&(H.status==="boot"||H.status==="running")&&t.jsx(Ea,{item:H,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),_&&(s.lockActions||!j?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:J,onClick:()=>{i(q),f(D=>D+1)},children:J?e.actAnalyseQueued:e.actAnalyse})),F.excerpt&&t.jsx("span",{className:"qex",children:F.excerpt})]},F.name+":"+M)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([F,M])=>t.jsxs("li",{children:[t.jsx("b",{children:F})," — ",M]},F))})]})}function Vd(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:l}=Y(),s=`${It}/cibles/list.csv?token=${a}`,c=`${It}/cibles/list.json?token=${a}`,g=`${It}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,x=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{Td(Ad(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ge,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:f,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Wd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Y(),i=o!=="client",[l,s]=p.useState(null),[c,g]=p.useState(!1),[d,x]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let f=!0;return g(!1),Vn(a).then(j=>{f&&(j?s(j):g(!0))}),()=>{f=!1}},[a,d]);const m=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=f=>{if(i||!l)return;const j={enabled:f.enabled??!!l.enabled,email:f.email??(l.email||""),sections:f.sections??m()};b(!0),Vn(a,j).then(N=>{if(b(!1),!N){n(e.memoAlertErr);return}s(N),r(e.memoAlertSaved)})};if(c)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!l)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs(Ge,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:i||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Gd,{value:l.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>v({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:i||u,onChange:()=>v({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:j})]},f))}),t.jsx(Fn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Ti(a,y),onTest:()=>Ai(a,y)})]})}function Gd({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,l]=p.useState(e);p.useEffect(()=>{l(e)},[e]);const s=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&s&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!c,onClick:()=>o(i.trim()),children:n})]})]})}function Yd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Y(),[i,l]=p.useState(null),[s,c]=p.useState(!1),[g,d]=p.useState(null),[x,u]=p.useState(""),[b,m]=p.useState(0);p.useEffect(()=>{let N=!0;return c(!1),an(a).then(w=>{N&&(w?l({configured:w.configured,url_hint:w.url_hint}):c(!0))}),Fi(a).then(w=>{N&&d(w)}),()=>{N=!1}},[a,b]);const v=(N,w)=>{o&&an(a,N).then(E=>{if(!E||E.ok===!1){n(e.actErr);return}N.test&&E.sent===!1?n(e.plugTestThrottled):r(w),m(A=>A+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',f=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${It}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ge,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(N=>N+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!o,onChange:N=>u(N.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!x.trim(),onClick:()=>v({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:f}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(f).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Kd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Kd(){const{t:e,token:a,lang:r}=Y(),[n,o]=p.useState("valides"),[i,l]=p.useState(!1),[s,c]=p.useState(null),[g,d]=p.useState(null),[x,u]=p.useState(!1),[b,m]=p.useState(!1),[v,y]=p.useState(null),[f,j]=p.useState(null),[N,w]=p.useState(null),E=`atl2:bulk:${a}:${n}`;p.useEffect(()=>{an(a).then(B=>{j(B&&B.configured?B.url_hint||"webhook":null)})},[a]),p.useEffect(()=>{c(null),d(null),u(!1),y(null);try{const B=JSON.parse(localStorage.getItem(E)||"null");w(B&&Date.now()-Date.parse(B.t)<24*3600*1e3?B:null)}catch{w(null)}},[E]);const A=async()=>{l(!0),u(!1),y(null);const B=await Mi(a,n);c(B),d(B.ok?n:null),l(!1)},C=p.useRef(!1),L=async()=>{if(C.current)return;C.current=!0,m(!0);const B=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let F;try{F=await Oi(a,n,"webhook",void 0,B)}finally{C.current=!1}if(m(!1),u(!1),y(F),F.ok&&(F.pushed||0)>0){const M={t:new Date().toISOString(),n:F.pushed||0};w(M);try{localStorage.setItem(E,JSON.stringify(M))}catch{}}},T=s!=null&&s.ok&&s.ready||0,R=!!(s!=null&&s.ok)&&g===n&&T>0&&!!f&&!N,I=N?new Date(N.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:B=>o(B.target.value),children:e.plugBulkTabs.map(([B,F])=>t.jsx("option",{value:B,children:F},B))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{A()},children:i?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),N&&t.jsx("p",{className:"mnote",children:e.bulkLocked(I,N.n)}),!N&&!!(s!=null&&s.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!N&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),R&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),R&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(T,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{L()},children:b?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function Qd(){const{t:e,data:a,lang:r}=Y(),n=a.credits,o=a.email,i=async l=>{if(!o)return;const s=window.location.href.split("?")[0];try{const g=await(await fetch(`${yn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ge,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Jd(){const{t:e}=Y();return t.jsx(Ge,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Fd,{})})}function Xd(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:l,flash:s}=Y(),[c,g]=p.useState(null),[d,x]=p.useState(!1);p.useEffect(()=>{let T=!0;if(i)return kn(i).then(R=>{T&&R&&typeof R.per_day=="number"&&g(R.per_day)}),()=>{T=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let T=!0;return Li(o).then(R=>{T&&b(R)}),()=>{T=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(T=>T.kind==="target"&&Be(T)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(v/y*100)):null,j=(m==null?void 0:m.window_days)||30,N=v>0?v/j:0,w=y>0?Math.max(0,y-v):0,A=y>0&&N>0&&v>=100?Math.round(w/N):null,C=T=>Math.round(T).toLocaleString(a==="en"?"en-US":"fr-FR"),L=T=>{d||!l||(x(!0),Ri(o,T).then(R=>{if(x(!1),R===null){s(e.actErr);return}g(R),s(e.alertSaved)}))};return t.jsxs(Ge,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(v))}),y>0&&t.jsx("span",{children:e.covOf(C(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),A!==null&&t.jsx("p",{className:"mnote",children:e.covEta(A)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),N>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(N))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((T,R)=>t.jsxs("tr",{className:T.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[T.code,T.geo?` · ${T.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof T.n=="number"?C(T.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:T.source}),T.elargi&&t.jsx("em",{children:e.covWide(String(T.demande||""))}),T.erreur&&t.jsx("em",{children:e.covMissing})]})]},R)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(u.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(T=>t.jsx("button",{type:"button",className:c===T?"on":"",disabled:d,onClick:()=>L(T),children:T===0?"⏸":T},T))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Zd(){var f,j,N;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:l,lang:s}=Y(),c=n==="client",g=p.useMemo(()=>{const w=new Set;return a.forEach(E=>{E.angle&&w.add(E.angle)}),[...w]},[a]),[d,x]=p.useState(""),[u,b]=p.useState(""),[m,v]=p.useState(!1),y=async()=>{const w=d.trim();if(!(!w||m||!c)){v(!0),b("");try{const A=await(await fetch(`${It}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&b(String(A.reply)),A.job_id){b(e.critChatRunning);const C=async()=>{const L=await fetch(`${It}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(T=>T.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),v(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||v(!1)}}};return t.jsxs(Ge,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=i==null?void 0:i.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var E,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((E=w.look)!=null&&E.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((A=w.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},w.title)})]}),!!((N=i==null?void 0:i.gate)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||m,onChange:w=>x(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!d.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(qi,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Co[w]||"v-cons"),children:w}),t.jsx("span",{children:E})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",E]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function ec(){const{t:e,dispatch:a,startTour:r}=Y(),n=o=>{var i,l;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ge,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+l))})]})}const qo="atl2:mapfold",tc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(qo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},ac=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Lo=p.createContext(null),Y=()=>{const e=p.useContext(Lo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function wt({o:e,lg:a}){const{lang:r}=Y(),n=Pe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Kn(n,r),children:[n.emoji," ",Kn(n,r)]}):null}function Ia({o:e,src:a}){const{lang:r,t:n}=Y(),o=Pe(e);if(!o)return null;const i=Wi(o),l=Gi(o);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Gr(o,r))+" · "+n.win7(Yr(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function nc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(l=>(l.url||"")===n);if(i)return i}const o=$e(a);if(o)return e.find(i=>$e(i.name)===o)||e.find(i=>{const l=$e(i.name);return l.length>=3&&(o.includes(l)||l.includes(o))})}function rc(){const{scoped:e,t:a,st:r,dispatch:n}=Y(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,l=e.filter(x=>!We(x)),s=l.length,c=l.filter(x=>!x.noCo).length,g=l.filter(x=>!!x.noCo).length,d=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:d?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:s}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function oc(){const{t:e,lang:a,data:r,dispatch:n}=Y(),o=r.stats,i=s=>s.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const l=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:l>0?e.covOf(i(l)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function Fo({o:e}){const{lang:a}=Y(),r=Vi(e.cc),n=e.cc?Ht(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Pr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",ic=!1;function sc(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Ro=e=>`atl2:tour:${e||"anon"}`;function lc(e){try{return localStorage.getItem(Ro(e))==="1"}catch{return!0}}function Br(e){try{localStorage.setItem(Ro(e),"1")}catch{}}function dc(e,a,r,n,o,i){const l=e.tourT,s=e.howto;return[{sel:".atl2 .ident",title:l.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:l.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:l.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:l.live,body:e.fhintLive},{sel:".atl2 .goal",title:l.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:l.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:l.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:l.tuto,body:s[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:l.demand,body:s[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:l.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:l.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:l.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:l.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:l.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:l.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:l.tools,body:s[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:l.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:l.crit,body:s[0][0],modal:"crit"}].filter(Boolean)}function fc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Mt;const{lang:l}=_i(),s=ps[l],c=js(e,l,a),[g,d]=p.useReducer(Ss,void 0,()=>Ns((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?ac():tc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=p.useRef(!0);p.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(qo,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const S=()=>{window.innerWidth<=760&&d({type:"mapFold",folded:!0})};return S(),window.addEventListener("resize",S),()=>window.removeEventListener("resize",S)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var S;(S=u.current)==null||S.call(u,g.filters)},[g.filters]);const[b,m]=p.useState(()=>{if(typeof window>"u")return"both";try{const S=localStorage.getItem("atl2:chrome-mode");if(S==="eval"||S==="filt"||S==="both")return S;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=p.useState(null),[f,j]=p.useState(null),[N,w]=p.useState(null),[E,A]=p.useState({kept:0,dropped:0}),[C,L]=p.useState(!1),[T,R]=p.useState(""),[I,B]=p.useState(!1),[F,M]=p.useState(null),[h,q]=p.useState(!1),[H,J]=p.useState(!1),[,_]=p.useState(0),D=()=>_(S=>S+1),K=p.useRef([]),W=p.useRef(new Set),Q=p.useRef(new Set),[te,he]=p.useState([]),[ee,ce]=p.useState([]),[pe,je]=p.useState(0),be=p.useRef(new Map),le=p.useRef(null),{mode:ue}=c,oe=p.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),$=oe.pipe,ne=c.session.token||"",fe=ue==="client"&&!e;p.useEffect(()=>{if(!ne||!$)return;let S=!0;const G=async()=>{const P=await Yi(ne);!S||!P||(ce(P.runs),je(Date.now()/1e3-P.now),he(X=>X.filter(Z=>!P.runs.some(se=>$e(se.company)===$e(Z.name)))))};G();const k=te.length>0||ee.some(P=>P.status==="running"),O=window.setInterval(()=>{G()},k?8e3:25e3);return()=>{S=!1,window.clearInterval(O)}},[ne,$,te.length,ee.some(S=>S.status==="running")]);const we=p.useMemo(()=>{const S=[],G=new Set;for(const k of te){const O=$e(k.name);!O||G.has(O)||(G.add(O),S.push({name:k.name,id:k.id,status:"boot",started:k.started,estMin:k.estMin,memoType:"instant"}))}for(const k of ee){const O=$e(k.company);if(!O||G.has(O))continue;G.add(O);const P=k.status==="error"?"error":k.status==="done"?"done":"running";S.push({name:k.company,status:P,started:k.started||0,estMin:k.est_min||(k.memo_type==="detailed"?40:15),url:k.url,error:k.error,memoType:k.memo_type,note:k.note})}return S},[te,ee]),Ne=S=>we.find(G=>$e(G.name)===$e(S))||null,ve=(S,G)=>{he(k=>k.some(O=>$e(O.name)===$e(S.name))?k:[...k,{name:S.name,id:S.id,started:Date.now()/1e3,estMin:G==="detailed"?40:15}]),W.current.add(S.id),D()};p.useEffect(()=>{if(document.querySelector(`link[href="${Pr}"]`))return;const S=document.createElement("link");S.rel="stylesheet",S.href=Pr,document.head.appendChild(S)},[]);const re=(S,G=!1)=>{R(S),B(G),le.current&&clearTimeout(le.current),le.current=setTimeout(()=>R(""),G?4200:2400)},Te=S=>re(S,!0),Qe=p.useMemo(()=>{const S=new Map;return c.dossiers.forEach(G=>{G.id&&S.set(G.id,G)}),S},[c.dossiers]),me=p.useMemo(()=>c.dossiers.filter(S=>na(S,g,$)),[c.dossiers,g,$]),Ee=p.useRef(!1);p.useEffect(()=>{if(Ee.current||e||c.loading||!c.dossiers.length)return;if(!oe.showFunnel||lc(c.session.token||"")){Ee.current=!0;return}Ee.current=!0;const S=window.setTimeout(()=>{Br(c.session.token||""),q(!0)},700);return()=>window.clearTimeout(S)},[e,c.loading,c.dossiers.length,oe.showFunnel,c.session.token]);const Ft=p.useMemo(()=>c.dossiers.filter(S=>Cs(S,g,$,c.favIds)),[c.dossiers,g,$,c.favIds]),Oe=p.useMemo(()=>$i(me.filter(S=>!Ve(S)),c.favIds),[me,c.favIds]),He=p.useRef(!1);p.useEffect(()=>{if(He.current)return;if(!$||a==="ops"){He.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){He.current=!0;return}if(c.loading)return;He.current=!0;const S=Ui(Oe);S!==g.ptab&&d({type:"ptab",tab:S})},[$,a,n==null?void 0:n.ptab,c.loading,Oe,g.ptab]);const Re=p.useMemo(()=>{const S=ao(c.dossiers);return S?xt(S)===0?s.tourToday:no(S,l):s.tourNoRun},[c.dossiers,s,l]),at=p.useMemo(()=>c.dossiers.some(S=>!!S.memoUrl||!!S.summary||Pt(S)),[c.dossiers]),[jt,ot]=p.useState(!1);p.useEffect(()=>{if(c.loading){ot(!1);return}if(c.dossiers.length>0||c.error){ot(!0);return}const S=window.setTimeout(()=>ot(!0),6e3);return()=>window.clearTimeout(S)},[c.loading,c.dossiers.length,c.error]);const Se=(c.marketEstimate||0)>0||typeof((Mt=c.stats)==null?void 0:Mt.screened)=="number"&&c.stats.screened>0,gt=p.useMemo(()=>[1,0,2,4,5,3].find(S=>(Oe[S]||0)>0)??0,[Oe]),Me=jn.find(S=>S.key===g.continent),ut=g.continent==="monde"?s.contWorld:(l==="fr"?Me==null?void 0:Me.fr:Me==null?void 0:Me.en)||"";p.useEffect(()=>{const S=G=>{var O;const k=(((O=G.detail)==null?void 0:O.name)||"").trim();k&&mt(null,k)};return window.addEventListener("ppmap:evaluate",S),()=>window.removeEventListener("ppmap:evaluate",S)}),p.useEffect(()=>{const S=G=>{const k=G.detail||{},O=String(k.id||"").trim(),P=String(k.name||"").trim(),X=String(k.url||"").trim(),Z=O&&Qe.get(O)||nc(c.dossiers,P,X);if(Z){if(j(null),na(Z,g,$)||(g.continent!=="monde"&&Z.continent!==g.continent&&d({type:"continent",key:Z.continent||"monde"}),d({type:"reset"})),$&&Z.kind!=="op"){const ge=Ae(Z);typeof ge=="number"&&ge!==g.ptab&&d({type:"ptab",tab:ge})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),d({type:"focus",id:Z.id}),(Z.noCo||["media","nominations","recrutements"].includes(Z.engine||""))&&(Z.url||Z.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Z.url||"",text:[Z.headline,Z.tagline].filter(Boolean).join(`
`)}})):Z.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Z.name,url:Z.url||"",website:Z.website||"",domain:Z.domain||""}}));return}!P&&!X||(d({type:"focus",id:O||null}),j({name:P,headline:String(k.text||"").trim()||P,url:X,card:k.card}),X&&(Sa(P)||!P)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:X,text:String(k.text||"").trim()}})):P&&!Sa(P)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:P}})))};return window.addEventListener("ppmap:focus",S),()=>window.removeEventListener("ppmap:focus",S)}),p.useEffect(()=>{const S=O=>{const P={},X=String((O==null?void 0:O.sector)||"").trim();X&&(P.sector=[X]);const Z=String((O==null?void 0:O.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Z)&&(P.day=Z);const se=String((O==null?void 0:O.search)||"").trim();se&&(P.search=se);const ge=String((O==null?void 0:O.dealKind)||"").trim();(ge==="ma"||ge==="levee"||ge==="other")&&(P.dealKind=[ge]),Object.keys(P).length&&d({type:"filters",patch:P})},G=O=>S(O.detail),k=O=>{O.data&&O.data.type==="pp-filter"&&S(O.data)};return window.addEventListener("ppmap:filter",G),window.addEventListener("message",k),()=>{window.removeEventListener("ppmap:filter",G),window.removeEventListener("message",k)}},[]),p.useEffect(()=>{const S=G=>{var P;const k=(((P=G.detail)==null?void 0:P.name)||"").trim().toLowerCase();if(!k)return;const O=c.dossiers.find(X=>(X.name||"").trim().toLowerCase()===k);O&&d(a==="ops"?{type:"focus",id:O.id}:{type:"popup",id:O.id})};return window.addEventListener("ppmap:similar",S),()=>window.removeEventListener("ppmap:similar",S)});const mt=(S,G,k)=>{const O=(k||(S==null?void 0:S.name)||G||"").trim();if(!fe){w({kicker:O});return}!O||C||(L(!0),(async()=>{try{let P=(G||O).trim();const X=((S==null?void 0:S.website)||(S==null?void 0:S.domain)||"").trim();if(!(/^https?:\/\//i.test(P)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(P)&&!/\s/.test(P)))if(X)P=X;else try{const Ce=await en(O);if(Ce!=null&&Ce.website)P=Ce.website;else if(((Ce==null?void 0:Ce.candidates)||[]).length===1)P=Ce.candidates[0].url;else if(((Ce==null?void 0:Ce.candidates)||[]).length>1){K.current=[{name:O,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(Ce.candidates||[]).slice(0,5)},...K.current].slice(0,8),D();return}}catch{}const se=await Wr(ne,P,"atelier2"),ge={name:se.company||O,verdict:se.verdict,reason:se.reason||"",remaining:se.remaining??null};K.current=[ge,...K.current].slice(0,8),se.verdict==="kept"&&A(Ce=>({...Ce,kept:Ce.kept+1})),se.verdict==="ruled_out"&&A(Ce=>({...Ce,dropped:Ce.dropped+1}));const qe=S||c.dossiers.find(Ce=>(Ce.name||"").toLowerCase()===O.toLowerCase());qe&&(se.verdict==="kept"?qe.verdict=qe.verdict||"MATCH":se.verdict==="ruled_out"&&(qe.verdict="NO MATCH"),se.reason&&(qe.reasoning=se.reason)),D()}finally{L(!1)}})())},Nt=S=>{if(!fe){w({kicker:S.name});return}ve(S,"instant"),Yt(ne,"fast_request",S.name||"",""),re(s.memoInstantSent(S.name))},bt=S=>be.current.get(S.id)??c.thumbs.get((S.name||"").trim().toLowerCase()),vt=(S,G)=>d({type:"undoPush",entry:{id:S.id,name:S.name,prevCeoStatus:G}}),it=async(S,G,k)=>{const O=S.ceoStatus||"";S.ceoStatus=G,D();const P=await $a(ne,{status:G,airtable_id:S.airtableId,check_id:S.checkId,company:S.name,...(k==null?void 0:k.note)!==void 0?{note:k.note}:{},...k!=null&&k.via?{via:k.via}:{}});return P.ok?P.skipped?(S.ceoStatus=O,D(),Te(s.actNotPersisted),!1):((k==null?void 0:k.undo)!==!1&&vt(S,O),k!=null&&k.msg&&re(k.msg),(G==="Validé"||G==="Écarté")&&!S.ceoNote&&(k==null?void 0:k.note)===void 0&&M({o:S,yes:G==="Validé"}),!0):(S.ceoStatus=O,D(),Te(s.actErr),!1)},Et=async(S,G)=>{const k=await $a(ne,{status:S.ceoStatus||"Retenu",airtable_id:S.airtableId,check_id:S.checkId,company:S.name,note:G,via:"note"});return!k.ok||k.skipped?(Te(k.skipped?s.actNotPersisted:s.actErr),!1):(S.ceoNote=G,D(),!0)},z=p.useRef(new Map),U=S=>z.current.has(S.id)?z.current.get(S.id):c.stages.get((S.name||"").trim().toLowerCase()),V=(S,G)=>{z.current.set(S.id,G),D()},ae=(S,G)=>{fe&&it(S,G?"Validé":"Écarté",{msg:G?s.decidedYes(S.name):s.decidedNo(S.name)})},xe=S=>{fe&&it(S,"À trancher",{msg:s.promoted(S.name)})},ie=S=>{fe&&(async()=>{const G=S.ceoStatus||"";S.ceoStatus="Retenu",D();const k=await $a(ne,{status:"Retenu",check_id:S.checkId,company:S.name});if(!k.ok||k.skipped){S.ceoStatus=G,D(),Te(k.skipped?s.actNotPersisted:s.actErr);return}vt(S,G),re(s.repeched(S.name))})()},De=()=>{const S=g.undo[g.undo.length-1];if(!S){re(s.undoNone);return}const G=Qe.get(S.id);if(!G){d({type:"undoPop"}),re(s.undoNone);return}let k=S.prevCeoStatus;if(!k)if((G.verdict||"").toUpperCase().includes("CALL"))k="À trancher";else{re(s.undoLockedTitle);return}(async()=>await it(G,k,{undo:!1})&&(d({type:"undoPop"}),G.ceoStatus=S.prevCeoStatus,D(),re(s.undoDone(G.name))))()},Je=S=>{fe&&(Q.current.add(S.id),D(),(async()=>{const G=await Ki(ne,S.name,"email");if(!G||G.ok===!1){Q.current.delete(S.id),D(),Te(s.actErr);return}Yt(ne,"approach",S.name||"",""),re(s.actApproachSent)})())},ye=(S,G)=>{fe&&(async()=>{if(!(await Yt(ne,G?"yes":"no",S.name||"","")).ok){Te(s.actErr);return}be.current.set(S.id,G?"yes":"no"),D(),re(G?s.thumbUpDone:s.thumbDnDone)})()},st=S=>{!fe||!Pt(S)||(ve(S,"detailed"),Yt(ne,"detailed_request",S.name||"",""),re(s.memoDeepSent(S.name)))},Wt=S=>{const G=new Set(c.favIds),k=G.has(S.id);k?G.delete(S.id):G.add(S.id),c.setFavIds(G),fe&&Qi(ne,{id:S.id,co:S.name},k)},Rt=()=>{!fe||H||window.confirm(s.identSyncConfirm)&&(J(!0),(async()=>{const S=await Ji(ne);J(!1),S?re(s.identSyncDone):Te(s.actErr)})())},Ie=/proplace/i.test(c.fund||""),_e=S=>{!fe||!Ie||(Yt(ne,"onboard_request",S.name||"",""),re(s.onboardSent(S.name)))},nt={st:g,dispatch:d,t:s,lang:l,mode:ue,caps:oe,pipe:$,token:ne,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:ie,thumbOf:bt,canWrite:fe,commitStatus:it,saveNote:Et,stageOf:U,setStage:V,flashErr:Te,startTour:()=>q(!0),dossiers:c.dossiers,scopedAll:me,scoped:Ft,counts:Oe,byId:Qe,contName:ut,favIds:c.favIds,toggleFav:Wt,askEvaluate:mt,doAnalyse:Nt,doDecide:ae,doPromote:xe,doApproach:Je,doThumb:ye,doDeep:st,doUndo:De,doSync:Rt,doOnboard:_e,outbound:Ie,memoQueued:W.current,liveMemos:{items:we,serverOff:pe,liveOf:Ne},approachDone:Q.current,sessTally:E,evalCards:K.current,evalBusy:C,markRow:y,markedId:v,flash:re,focusExtra:f};p.useEffect(()=>{const S=G=>{G.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",S),()=>window.removeEventListener("keydown",S)},[]);const Gt=S=>ne?t.jsx(Ts,{token:ne,children:S}):t.jsx(t.Fragment,{children:S});return t.jsx(Lo.Provider,{value:nt,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ne?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:hs}),Gt(t.jsxs("div",{className:"app"+($?" pipe":"")+(ne?" has-thesis":""),children:[oe.showTicker&&t.jsx(rt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ne?" live-stack--cibles":""),children:[t.jsx(Ds,{}),!!ne&&t.jsx(qs,{})]})}),oe.showIdent&&t.jsx(rt,{name:"identite",children:t.jsx(Ks,{})}),!1,ic,oe.showFunnel&&t.jsx(rt,{name:"entonnoir",children:t.jsx(cc,{})}),!g.mapFolded&&t.jsx(rt,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(No,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(rc,{}),a!=="ops"&&oe.showFunnel&&t.jsx(oc,{}),t.jsx(Gl,{}),t.jsx(jo,{})]})]})}),oe.showDemand&&$&&t.jsx(rt,{name:"direct",children:t.jsx(as,{items:we,serverOff:pe,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>d({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([S,G])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===S,onClick:()=>{m(S);try{localStorage.setItem("atl2:chrome-mode",S)}catch{}},children:G},S))}),oe.showDemand&&t.jsx(rt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(ed,{})})}),oe.showDemand&&g.memoConsole&&t.jsx(rt,{name:"console",children:t.jsx(ad,{})}),oe.pipe&&!!ne&&t.jsx(rt,{name:"moteurs",children:t.jsx(ls,{})}),t.jsx(rt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(Cd,{})}),c.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:s.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(rt,{name:"fiche",children:t.jsx(cd,{})}),t.jsx(rt,{name:"modales",children:t.jsx(Md,{})}),t.jsx(Bs,{}),F&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:F.o.name}),t.jsx(Vs,{placeholder:F.yes?s.whyYesPh:s.whyNoPh,onDone:S=>{const G=F.o;M(null),S&&Et(G,S).then(k=>{k&&re(s.csNoteSaved)})}})]}),h&&jt&&t.jsx(Gs,{steps:dc(s,Re,at,gt,Se,Oe[3]||0),onClose:()=>{q(!1),Br(ne)}}),t.jsx(sc,{}),oe.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:eo,children:Sn}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Aa}`,children:Aa})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),T&&t.jsx("div",{className:"flash on"+(I?" err":""),children:T}),N&&t.jsx(Hi,{variant:"acquirer",initialCompany:_r().co,initialWebsite:_r().site,onClose:()=>w(null)})]})})}function cc(){const{t:e}=Y(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function _r(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function pc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Fo as FlagCell,wt as SigBadge,Ia as SigWin,fc as default,pc as fmtShort,Y as useV2};
