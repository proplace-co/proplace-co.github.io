...
.atl2 .app > .ticker{position:sticky;top:var(--pp-gap,68px);z-index:32}
.atl2:has(> .lockbar.on) .app > .ticker{top:calc(var(--pp-gap,68px) + 46px)}
.atl2 .listhead{position:sticky;z-index:31;background:var(--panel);
  top:calc(var(--pp-gap,68px) + 44px)}
.atl2:has(> .lockbar.on) .listhead{top:calc(var(--pp-gap,68px) + 90px)}
body.pp-navfold .atl2 .app > .ticker{top:26px}
body.pp-navfold .atl2 .listhead{top:70px}
@media (max-width:760px){
  .atl2 .app > .ticker,.atl2 .listhead{position:static}}
...
/* L'ENCART « nouvelles depuis votre visite » ÉCRASAIT LE RESTE (17/08 : « on
   comprend plus rien »). Un pavé vert pleine largeur, bordé, avec dix noms en
   pastilles, entre la phrase du matin et la chaîne de mesure : trois surfaces
   qui se disputaient l'attention. Il devient une note discrète — même
   information, même liste dépliable, mais il ne crie plus par-dessus les
   chiffres qui, eux, décrivent le travail. */
.atl2 .since{flex:none;margin:0 14px 4px;padding:4px 2px;border-radius:0;
  background:transparent;border:0;border-bottom:1px solid var(--line)}
.atl2 .since-h{display:flex;align-items:center;gap:8px}
.atl2 .since-h b{flex:1;font-size:11.5px;color:var(--sub);font-weight:600}
.atl2 .since-c button{background:var(--panel2)!important;border-color:var(--line)!important;
...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,Zo=Jo+Xo;function pa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function ei(){const e=pa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function ti(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=ei();return r==="0"?"client":r==="1"||pa("embed")==="1"&&pa("chrome")==="1"?"apercu":"client"}const ai={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},ni=e=>ai[e];function ri(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Ye=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Un(a)||ri(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Zr(e.cc)})};function ea(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const oi=60*60*1e3;function ii(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>oi?null:a}catch{return null}}function Et(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const si=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function li(e,a,r="default"){const n=r!=="default",i=f.useMemo(()=>e||n?{mode:"anon"}:Vr(),[e,n]),o=f.useMemo(()=>n?"visiteur":ti(e,i),[e,i,n]),l=f.useMemo(()=>ni(o),[o]),s=o!=="visiteur",p=si(r),[g,d]=f.useState([]),[m,u]=f.useState(""),[b,c]=f.useState(null),[h,v]=f.useState(null),[x,C]=f.useState(null),[k,y]=f.useState(()=>new Map),[w,z]=f.useState(()=>new Map),[q,M]=f.useState(""),[E,F]=f.useState(new Set),[A,O]=f.useState(null),[_,j]=f.useState(!0),[N,L]=f.useState(!1),[$,U]=f.useState(0),[V,Q]=f.useState(0),Y=f.useRef(0),X=f.useMemo(()=>{var R;if(o!=="client")return"";try{return((R=Hr())==null?void 0:R.email)||""}catch{return""}},[o]);f.useEffect(()=>{const R=++Y.current;let P=!0;const B=()=>P&&R===Y.current,G=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),K=ii(G);return K?(d(K.objs.map(Ye)),K.fund&&u(K.fund),c(K.marketEstimate??null),v(K.criteria??null),C(K.stats??null),M(K.generatedAt||""),j(!1)):j(!0),(async()=>{try{if(r==="ops"){const se=await Jt(),le=((se==null?void 0:se.recent_ops)||[]).map(J=>{const ee=Xt(J.company_name||J.title?J:{...J,title:(J.headline_fr||J.headline||"").slice(0,120)},a),he=String(J.rubrique||"").toLowerCase();return ee&&(he==="nominations"||he==="recrutements")&&(ee.engine=he),ee&&!String(J.company_name||"").trim()&&(ee.noCo=!0),ee}).filter(J=>!!J).map(J=>(Un((J.name||"").trim())||(J.noCo=!0),J));try{const J=await Wr(),ee=Yr(J),he=((J==null?void 0:J.date)||"").slice(0,10);if(ee.length&&he){const te=new Set;for(const ce of le){if(ce.noCo||(ce.date||"").slice(0,10)!==he)continue;const ne=Ha(ee,te,ce.name,"");ne>=0&&(te.add(ne),ce.decryptHtml=ee[ne].html)}for(const ce of le){if(ce.decryptHtml||(ce.date||"").slice(0,10)!==he)continue;const ne=Ha(ee,te,"",ce.headline||ce.tagline||ce.name);ne>=0&&(te.add(ne),ce.decryptHtml=ee[ne].html)}}}catch{}if(!B())return;d(le.map(Ye)),Et(G,{objs:le})}else if(typeof r=="object"){const le=(await Wa()||[]).filter(ee=>(ee.slug||"")===r.research).map(ee=>Ya(ee,a)).filter(ee=>!!ee),J=ea(await Ga(le,a));if(!B())return;d(J.map(Ye)),Et(G,{objs:J})}else if(s&&i.token){const se=Gr(i.token),le=Jt(),J=Kr(i.token),ee=Qr(i.token),he=Jr(i.token),te=await se;let ce=te?te.targets:[];B()&&te&&(u(te.fund||""),c(te.marketEstimate??null),v(te.criteria??null),C(te.stats??null),M(te.generatedAt||""),d(ce.map(Ye)),j(!1),L(!1));const[ne,Oe,xe,ye]=await Promise.all([le,J,ee,he]),Re=((ne==null?void 0:ne.recent_ops)||[]).map(Ee=>Xt(Ee,a)).filter(Ee=>!!Ee);if(ce=[...ce,...Re],!B())return;d(ce.map(Ye));const tt=new Set;for(const Ee of Oe){const Be=(Ee.id||Ee.co||"").toString().trim().toLowerCase();Be&&tt.add(Be.startsWith("t:")?Be:"t:"+Be)}F(tt),y(xe),z(ye),te&&Et(G,{fund:te.fund,marketEstimate:te.marketEstimate,criteria:te.criteria,stats:te.stats,generatedAt:te.generatedAt,objs:ce})}else{const se=Xr(),le=Wa(),J=Jt(),ee=await se;B()&&ee.length&&(d(ea(ee).map(Ye)),j(!1),L(!1));const[he,te]=await Promise.all([le,J]),ce=(he||[]).map(ye=>Ya(ye,a)).filter(ye=>!!ye),ne=await Ga(ce,a),Oe=((te==null?void 0:te.recent_ops)||[]).map(ye=>Xt(ye,a)).filter(ye=>!!ye),xe=ea([...ee,...ne,...Oe]);if(!B())return;d(xe.map(Ye)),Et(G,{objs:xe})}B()&&L(!1)}catch{B()&&!K&&L(!0)}finally{B()&&j(!1)}})(),()=>{P=!1}},[s,i.token,a,$,p]),f.useEffect(()=>{if(!l.showCredits||!X){O(null);return}let R=!0;return(async()=>{try{const P=await fetch(`${Aa}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:X})});if(!P.ok)return;const B=await P.json();R&&B&&B.ok!==!1&&O(B)}catch{}})(),()=>{R=!1}},[l.showCredits,X,V]);const T=f.useCallback(R=>F(new Set(R)),[]);return{session:i,mode:o,caps:l,fund:m,email:X,marketEstimate:b,generatedAt:q,criteria:h,stats:x,thumbs:k,stages:w,dossiers:g,favIds:E,setFavIds:T,credits:A,reloadCredits:()=>Q(R=>R+1),loading:_,error:N,refresh:()=>U(R=>R+1)}}const Kn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),ci=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Kn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function di(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Kn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Qn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Qn=40;function La(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ge(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ta(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(He(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ke(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function Jn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:La(e,a.filters,r)}function pi(e,a,r,n){return!(!Jn(e,a,r)||r&&!eo(e,a.ptab,n))}function Ra(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-He(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=ge(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const ui=["ma","levees","nominations","recrutements","actualites"],mi=300,ta=7,fi={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Xn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},hi=["hiring","raised","news","posting","building","community","registry","exodus","other"];function nn(e){const a=ge(e);if(a)return"sig:"+(a.theme&&Xn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function xi(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:s}=D(),p=l==="en",[g,d]=f.useState("all"),[m,u]=f.useState(!1),b=f.useMemo(()=>{const A=(a.filters.day||"").slice(0,10),O=L=>{if(!o&&a.continent!=="monde"&&L.continent!==a.continent||A&&(L.date||"").slice(0,10)!==A)return!1;if(o&&L.kind==="op"){const $=(s||"").trim().toLowerCase();if(!$)return!1;const U=L.match||null;if(!U||!Object.keys(U).map(Q=>Q.trim().toLowerCase()).includes($))return!1}return!0},_=e.filter(L=>O(L)&&ge(L)),j=e.filter(L=>O(L)&&L.kind==="op"&&!ge(L)&&(A?!0:He(L.date)<=ta)),N=A||new Date().toISOString().slice(0,10);return j.sort((L,$)=>{const U=(L.date||"").slice(0,10)===N?0:1,V=($.date||"").slice(0,10)===N?0:1;return U!==V?U-V:($.amountEur||0)-(L.amountEur||0)}),[...Ra(_,{key:"signal",dir:-1}),...j]},[e,a.continent,a.filters.day,o,s]),c=f.useMemo(()=>{const A={};for(const O of b){const _=nn(O);A[_]=(A[_]||0)+1}return A},[b]),h=f.useMemo(()=>g==="all"?b:b.filter(A=>nn(A)===g),[b,g]),v=f.useMemo(()=>h.slice(0,mi),[h]),x=h.length-v.length,C=f.useRef(null);f.useEffect(()=>{var L,$;const A=C.current;if(!A)return;const O=()=>{const U=A.scrollWidth;U<200||(A.style.animationDuration=Math.max(30,Math.round(U/70))+"s")};O();const _=requestAnimationFrame(O),j=window.setTimeout(O,1200);let N=!0;return($=(L=document.fonts)==null?void 0:L.ready)==null||$.then(()=>{N&&O()}),()=>{N=!1,cancelAnimationFrame(_),window.clearTimeout(j)}},[v.length,g]);const k=A=>A==="all"?b.length:c[A]||0,y=A=>A==="all"?p?"All":"Tout":A.startsWith("sig:")?Xn[p?"en":"fr"][A.slice(4)]||"🔔":fi[p?"en":"fr"][A],w=[{k:"all"}],z=ui.filter(A=>k(A)>0||A===g);if(z.length){w.push({g:p?"DEALS":"OPÉRATIONS"});for(const A of z)w.push({k:A})}const q=hi.map(A=>"sig:"+A).filter(A=>k(A)>0||A===g);if(q.length){w.push({g:p?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const A of q)w.push({k:A})}const M=A=>{try{return new Date(A+"T12:00:00Z").toLocaleDateString(p?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return A}},E=(()=>{const A=(a.filters.day||"").slice(0,10),O=!o&&a.continent!=="monde"&&i?p?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return A?(p?`LIVE covers the events of ${M(A)}.`:`Le LIVE regroupe les événements du ${M(A)}.`)+O:(p?`LIVE covers the still-open signals and the deals of the last ${ta} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ta} derniers jours.`)+O})(),F=A=>v.map(O=>t.jsxs("button",{type:"button",className:"tk"+(Ce(O)?" spent":""),onClick:_=>{const j=_.currentTarget.getBoundingClientRect();n({type:"popup",id:O.id,anchor:{x:j.left+j.width/2,y:j.bottom}})},title:O.name+(O.tagline?" — "+O.tagline:""),children:[t.jsx(Ze,{o:O}),t.jsxs("span",{className:"who",children:[t.jsx(Tr,{o:O}),t.jsx("span",{className:"co",children:O.name})]}),typeof O.amountEur=="number"&&O.amountEur>0&&t.jsx("span",{className:"am",children:Ql(O.amountEur)}),O.sector&&t.jsx("span",{className:"mt",children:O.sector}),t.jsx(Kt,{o:O}),t.jsx("span",{className:"tkgo",children:"→"})]},A+(O.id||O.name))).concat(x>0?[t.jsx("span",{className:"tk quiet",children:p?`+ ${x} more — filter by section to see them`:`+ ${x} autres — filtrez par rubrique pour les voir`},A+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:A=>{A.currentTarget.contains(A.relatedTarget)||u(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":m,onClick:()=>u(A=>!A),children:[y(g),t.jsx("b",{children:k(g)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!m,children:[t.jsx("span",{className:"tkfilscope",children:E}),w.map(A=>"g"in A?t.jsx("span",{className:"tkfilg",children:A.g},A.g):t.jsxs("button",{type:"button","aria-pressed":A.k===g,onClick:()=>{d(A.k),u(!1)},children:[y(A.k),t.jsx("b",{children:k(A.k)})]},A.k))]})]}),t.jsx("div",{className:"win",children:v.length?t.jsxs("div",{className:"run",ref:C,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const gi="aDx8z7Hzksus",Ma="+33 6 83 10 72 86",Pt="alexandre@proplace.co",Zn=`tel:${Ma.replace(/[^\d+]/g,"")}`,rn="pp-rdv-slot";function bi(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function vi(){const{t:e,caps:a,fund:r}=D();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:wi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Zn,children:Ma}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Pt}`,children:Pt})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Yo,{filloutId:gi,parameters:r?{company_name:r}:void 0})})]})}function yi(){const[e,a]=f.useState(()=>typeof document>"u"?null:document.getElementById(rn));return f.useEffect(()=>{e||a(document.getElementById(rn))},[e]),e?ct.createPortal(t.jsx(vi,{}),e):null}const wi=`
...
`;class ve extends f.Component{constructor(){super(...arguments);Ua(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ki=8;function ji(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=D(),[s,p]=f.useState(!1),[g,d]=f.useState(!1),[m,u]=f.useState(!1),b=r||"home",{names:c,verdicts:h}=f.useMemo(()=>{const y=[],w={};return n.forEach(z=>{z.kind!=="target"||!z.name||(y.push(z.name),w[z.name]=to(z)||"")}),{names:y,verdicts:w}},[n]),v=f.useMemo(()=>c.length?ao(b,c,h,a):null,[b,c.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const x=g?v.added:v.added.slice(0,ki),C=v.added.length-x.length,k=y=>{const w=n.find(z=>z.name===y);w&&(o(w.id),l({type:"popup",id:w.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),no(b,c,h,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[x.map(y=>t.jsx("button",{type:"button",onClick:()=>k(y),children:y},y)),C>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(C)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(y=>!y),children:e.sinceOut(v.gone.length)}),m&&v.gone.slice(0,20).map(y=>t.jsx("span",{className:"gone",children:y},y))]})]})}const aa=600,Ge=62,on="atl2:fstats";function Ni(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=D(),[l,s]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(on)==="on"}catch{return!1}}),p=r.stats,g=f.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=(p==null?void 0:p.since)||"";if(!n.showFunnel||!p||typeof p.screened!="number")return null;const m=w=>a==="en"?w.slice(5,10):`${w.slice(8,10)}/${w.slice(5,7)}`,u=w=>w.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((w,z)=>Math.max(w,z.s||0),0),c=g.length?aa/g.length:0,h=Math.max(4,c-4),v=g.length>=5&&b>0,x=r.marketEstimate||0,C=m(new Date().toISOString().slice(0,10)),k=w=>[...typeof w=="number"?[[w,e.funScreened("","")]]:[],...typeof p.kept=="number"?[[p.kept,e.funKept]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown]]:[]],y=[];return typeof p.screened_window=="number"&&d&&y.push({cle:"fenetre",periode:e.funPerWindow(m(d),C),etapes:[[p.screened_window,e.funScreened("","")]]}),typeof p.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:k(p.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[y.map(w=>t.jsxs("div",{className:"fst-row fst-lab",children:[t.jsx("span",{className:"fst-per",children:w.periode}),w.etapes.map(([z,q],M)=>t.jsxs("span",{className:"fst-t",children:[M>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(z)}),t.jsx("i",{children:q})]},w.cle+q)),w.cle==="total"&&x>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(x),Math.min(100,Math.round((p.screened||0)/x*100)))})]}),w.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const z=!l;s(z),z&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(on,z?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},w.cle)),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${aa} ${Ge}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((w,z)=>{const q=(w.s||0)/b*(Ge-4),M=(w.m||0)/b*(Ge-4),E=z*c+(c-h)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(w.d)} — ${w.s} ${e.actScreened} · ${w.m} ${e.actKept}`}),t.jsx("rect",{x:E,y:Ge-2-q,width:h,height:q,fill:"#cfe0d6"}),t.jsx("rect",{x:E,y:Ge-2-M,width:h,height:M,fill:"#185c38"})]},w.d)}),t.jsx("line",{x1:0,y1:Ge-1.5,x2:aa,y2:Ge-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const er=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Si(e,a){if((We(e)||"").startsWith("CALL")&&be(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=be(e)>=2;return er.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function Ci({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=D(),[s,p]=f.useState(!1),[g,d]=f.useState(""),[m,u]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),c=async h=>{if(g)return;if(h==="Analysé"&&!e.memoUrl){u(!0);return}d(h);const v=await i(e,h);d(""),v&&(p(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:h=>h.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{p(h=>!h),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),s&&t.jsx("span",{className:"rstm",children:m?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),p(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{d("Analysé");const h=await i(e,"Analysé");d(""),h&&(p(!1),u(!1))})()},children:a.csAnaAnyway})]}):Si(e,a).map(([h,v])=>t.jsx("button",{type:"button",className:"rsti"+(b===h?" on":"")+(g===h?" busy":""),disabled:!!g,onClick:()=>{c(h)},children:v},h))})]})}function Ei({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=D(),[o,l]=f.useState(""),[s,p]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(We(e)||"").startsWith("CALL")&&be(e)===3,m=be(e)>=2,u=async c=>{if(o||c==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(c);const h=await i(e,c);l(""),h&&(p(!0),setTimeout(()=>p(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:er.filter(([c])=>!(m&&c==="Retenu")).map(([c,h])=>[c,a[h]]);return t.jsxs("div",{className:"csp",onClick:c=>c.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([c,h])=>t.jsx("button",{type:"button",className:"csb"+(g===c?" on":"")+(o===c?" busy":""),disabled:!!o,onClick:()=>{u(c)},children:h},c)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Ai,{o:e})]})}function Ai({o:e}){const{t:a,saveNote:r,flash:n}=D(),[i,o]=f.useState(e.ceoNote||""),[l,s]=f.useState(!1),[p,g]=f.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!d)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{m()},children:p?a.csNoteSaved:a.csNoteOk})]})}function Ti({placeholder:e,onDone:a}){const{t:r}=D(),[n,i]=f.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function zi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=D(),[p,g]=f.useState(!1);if(!n.pipe||!i||n.lockActions||be(e)!==4)return null;const d=o(e),m=(d==null?void 0:d.stage)||"todo",u=async x=>{if(p||x===m)return;g(!0);const C=d;l(e,{stage:x,stamps:(d==null?void 0:d.stamps)||{}});const k=Math.max(Date.now(),sn+=1);sn=k;const y=await ro(r,{company:e.name||"",stage:x,cts:k,deal_id:e.airtableId,check_id:e.checkId});g(!1),!y.stale&&(y.ok||(l(e,C),s(a.actErr)))},b=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,c=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,h=m==="sent"&&b&&c>=4;return t.jsxs("div",{className:"stg",onClick:x=>x.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([x,C])=>t.jsx("button",{type:"button",className:"stgb"+(m===x?" on":""),disabled:p,onClick:()=>{u(x)},children:C},x)),h&&t.jsx("span",{className:"stgj4",children:a.j4Badge(c)})]})}let sn=0;const At=8,Tt=360;function ln({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function cn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(ln,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(ln,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function qi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=D(),[l,s]=f.useState(0),[p,g]=f.useState(null),[d,m]=f.useState([]),u=f.useRef(!1),b=f.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),c=f.useRef(!1);f.useEffect(()=>{const q=b.current;return()=>{c.current||(n({type:"ptab",tab:q.ptab}),n({type:"dens",dens:q.dens}),n({type:"modal",modal:q.modal}))}},[]),f.useEffect(()=>{u.current||(u.current=!0,m(e.filter(q=>!!document.querySelector(q.need||q.sel))))},[e]);const h=d[l],v=l>=d.length;f.useEffect(()=>{if(h&&(h.ptab!==void 0&&o.ptab!==h.ptab&&n({type:"ptab",tab:h.ptab}),h.dens&&o.dens!==h.dens&&n({type:"dens",dens:h.dens}),o.modal!==(h.modal??null)&&n({type:"modal",modal:h.modal??null}),h.click)){const q=h.click,M=window.setTimeout(()=>{const E=document.querySelector(q);E&&E.getAttribute("aria-selected")!=="true"&&E.click()},60);return()=>window.clearTimeout(M)}},[l,h]);const x=f.useRef(-1),C=f.useCallback(()=>{if(!h){g(null);return}const q=document.querySelector(h.sel)||(h.need?document.querySelector(h.need):null);if(!q){g(null);return}x.current!==l&&(x.current=l,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const M=q.getBoundingClientRect();g(E=>E&&Math.abs(E.top-M.top)<1&&Math.abs(E.left-M.left)<1&&Math.abs(E.width-M.width)<1&&Math.abs(E.height-M.height)<1?E:M)},[h,l]);f.useLayoutEffect(()=>{C();const q=[90,300,700,1300].map(E=>window.setTimeout(C,E)),M=()=>C();return window.addEventListener("scroll",M,!0),window.addEventListener("resize",M),()=>{q.forEach(E=>window.clearTimeout(E)),window.removeEventListener("scroll",M,!0),window.removeEventListener("resize",M)}},[C]);const k=f.useRef(a);if(k.current=a,f.useEffect(()=>{const q=M=>{M.key==="Escape"?(M.preventDefault(),M.stopPropagation(),k.current()):M.key==="ArrowRight"?s(E=>E+1):M.key==="ArrowLeft"&&s(E=>Math.max(0,E-1))};return document.addEventListener("keydown",q,!0),()=>document.removeEventListener("keydown",q,!0)},[]),!d.length)return null;let y=null;const w=q=>()=>{c.current=!0,n({type:"modal",modal:null}),q()};if(v){const q=i[3]||0;q>0?y={title:q===1?r.ahaATitle1:r.ahaATitleN(q),body:r.ahaABody,btn:r.ahaABtn,go:w(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:w(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:w(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:w(()=>{n({type:"modal",modal:"crit"}),a()})}}let z={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Tt};if(!v&&p){const q=p.bottom+14,E=window.innerHeight-q>190?q:Math.max(12,p.top-200);z={left:Math.min(Math.max(12,p.left+p.width/2-Tt/2),window.innerWidth-Tt-12),top:E,width:Tt}}return ct.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-At,top:p.top-At,width:p.width+At*2,height:p.height+At*2}}),(v||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:z,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(cn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:h==null?void 0:h.title}),t.jsx(cn,{text:(h==null?void 0:h.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(q=>Math.max(0,q-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(q=>q+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function tr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function ar(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Li(){var M,E;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:s,dispatch:p}=D(),g=r?a:e,d=f.useMemo(()=>g.filter(F=>He(F.date)===0&&F.kind==="target"),[g]),m=f.useMemo(()=>r?a.filter(F=>be(F)===0).slice().sort((F,A)=>(A.date||"").localeCompare(F.date||"")):[],[a,r]),u=f.useMemo(()=>d.filter(F=>r?be(F)===0:!Ce(F)),[d,r]),b=r?m:u,c=r?a.length-m.length:d.length-u.length,h=r?a.length:d.length,v=h?Math.min(100,c/h*100):100,x=f.useMemo(()=>tr(g),[g]),C=!!x&&He(x)>0,k=f.useMemo(()=>C?g.filter(F=>(F.date||"").slice(0,10)===x):[],[g,x,C]),y=typeof((M=s.stats)==null?void 0:M.kept_today)=="number"?s.stats.kept_today:null,w=typeof((E=s.stats)==null?void 0:E.screened_today)=="number"?s.stats.screened_today:d.length;let z;C?z=i.morningLast(k.length,m.length,ar(x,l)):r?z=i.morningThesis(w,m.length,y):d.length?c===0?z=i.goalSourced(d.length):c>=d.length?z=i.goalCleared:z=i.goalDone(c,d.length):z=i.goalSourced(0);const q=()=>{if(!r){p({type:"pile",on:!0});return}p({type:"ptab",tab:0}),n==="client"&&m.length&&p({type:"chainStart",queue:m.map(F=>F.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:z}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:q,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ri(){var $,U;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:g,startTour:d,flash:m,flashErr:u}=D(),[b,c]=f.useState(null),[h,v]=f.useState(!0),[x,C]=f.useState([]),k=p==="client";f.useEffect(()=>{if(!i||!o)return;let V=!0;return v(!0),(async()=>{const[Q,Y]=await Promise.all([za(o),Vn(i)]);V&&(Q&&c(Q),v(!1),C(Y))})(),()=>{V=!1}},[i,o]);const[y,w]=f.useState(!1),z=()=>{!k||y||!o||(w(!0),oo(o).then(V=>{w(!1),V?m(e.identRepubDone):u(e.actErr)}))},q=(b==null?void 0:b.per_day)??null,M=(($=b==null?void 0:b.pool_order)==null?void 0:$.length)??0,E=x.filter(V=>V.status==="running").length,F=f.useMemo(()=>s.filter(V=>V.kind==="target"&&Ce(V)).length,[s]),A=l.marketEstimate,O=typeof((U=l.stats)==null?void 0:U.screened)=="number"?l.stats.screened:F,_=A&&A>0?Math.min(100,Math.round(O/A*100)):null,j=V=>V.toLocaleString(a==="en"?"en-US":"fr-FR"),N=(o||"P").split(/\s+/).map(V=>V[0]).join("").slice(0,2).toUpperCase(),L=(()=>{const V=Date.parse(l.generatedAt||"");if(Number.isNaN(V))return"";const Q=new Date(V),Y=X=>String(X).padStart(2,"0");return`${Y(Q.getDate())}/${Y(Q.getMonth()+1)} à ${Y(Q.getHours())}:${Y(Q.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?N:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),L?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(L)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[_===null&&O>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:j(O)})})]}),_!==null&&A&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:_+"%"}})}),t.jsxs("b",{children:[_," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(O,A)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),q!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:q})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),q===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),E>0&&t.jsxs("span",{className:"ev",children:["⏳ ",E]}),t.jsx("span",{className:"ego",children:h?e.identPendingWait:e.identPending(M)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:V=>{V.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!k||y,onClick:z,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!k,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:V=>n({type:"filters",patch:{search:V.target.value}})})]})]})]})}const Mi=["--p0","--p1","--p2","--p3","--p4"];function Oi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=D(),s=o.loading&&!l.length,p=f.useRef({});f.useEffect(()=>{p.current={...r}},[r]);const g=u=>{const b=p.current[u],c=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Mi[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(c>0?" up":c<0?" down":""),children:[r[u],c!==0&&t.jsxs("em",{className:"delta",children:[c>0?"+":"−",Math.abs(c)]})]})]},u)},d=(u,b,c)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:c.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,c,h=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:h,onClick:c,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Fi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Pi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=D(),s=f.useRef(null),[p,g]=f.useState(60);f.useEffect(()=>{let b=0;const c=()=>{var k;const h=s.current;if(!h)return;const v=(k=h.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!v)return;const x=v.getBoundingClientRect(),C=h.getBoundingClientRect();g(Math.max(20,Math.min(x.left+x.width/2-C.left,C.width-30)))};return b=requestAnimationFrame(c),window.addEventListener("resize",c),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",c)}},[e.ptab]);const d=e.ptab;let m=r.tuto[d].p;if(d===3){const b=n.filter(v=>v.kind==="target"&&be(v)===3),c=b.filter(v=>la(v)==="auto").length,h=b.filter(v=>la(v)==="cd").length;m=r.tutoPending(c,h,b.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(b=>b.id)})};if(d===1){const b=n.filter(c=>c.kind==="target"&&be(c)===1&&!i.has(c.id)).slice(0,10);if(b.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:b.map(c=>c.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Fi[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Je{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Di(e){for(const a of e)yield*a}function nr(e){return Array.from(Di(e))}var re=1e-6,Z=Math.PI,ze=Z/2,dn=Z/4,Le=Z*2,_e=180/Z,Se=Z/180,ie=Math.abs,Ii=Math.atan,vt=Math.atan2,pe=Math.cos,ue=Math.sin,$i=Math.sign||function(e){return e>0?1:e<0?-1:0},et=Math.sqrt;function Bi(e){return e>1?0:e<-1?Z:Math.acos(e)}function yt(e){return e>1?ze:e<-1?-ze:Math.asin(e)}function qe(){}function Dt(e,a){e&&un.hasOwnProperty(e.type)&&un[e.type](e,a)}var pn={Feature:function(e,a){Dt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Dt(r[n].geometry,a)}},un={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ua(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ua(r[n],a,0)},Polygon:function(e,a){mn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)mn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Dt(r[n],a)}};function ua(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function mn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ua(e[r],a,1);a.polygonEnd()}function nt(e,a){e&&pn.hasOwnProperty(e.type)?pn[e.type](e,a):Dt(e,a)}function ma(e){return[vt(e[1],e[0]),yt(e[2])]}function st(e){var a=e[0],r=e[1],n=pe(r);return[n*pe(a),n*ue(a),ue(r)]}function zt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function It(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function na(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function qt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function fa(e){var a=et(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ha(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function xa(e,a){return ie(e)>Z&&(e-=Math.round(e/Le)*Le),[e,a]}xa.invert=xa;function _i(e,a,r){return(e%=Le)?a||r?ha(hn(e),xn(a,r)):hn(e):a||r?xn(a,r):xa}function fn(e){return function(a,r){return a+=e,ie(a)>Z&&(a-=Math.round(a/Le)*Le),[a,r]}}function hn(e){var a=fn(e);return a.invert=fn(-e),a}function xn(e,a){var r=pe(e),n=ue(e),i=pe(a),o=ue(a);function l(s,p){var g=pe(p),d=pe(s)*g,m=ue(s)*g,u=ue(p),b=u*r+d*n;return[vt(m*i-b*o,d*r-u*n),yt(b*i+m*o)]}return l.invert=function(s,p){var g=pe(p),d=pe(s)*g,m=ue(s)*g,u=ue(p),b=u*i-m*o;return[vt(m*i+u*o,d*r+b*n),yt(b*r-d*n)]},l}function Ui(e,a,r,n,i,o){if(r){var l=pe(a),s=ue(a),p=n*r;i==null?(i=a+n*Le,o=a-p/2):(i=gn(l,i),o=gn(l,o),(n>0?i<o:i>o)&&(i+=n*Le));for(var g,d=i;n>0?d>o:d<o;d-=p)g=ma([l,-s*pe(d),-s*ue(d)]),e.point(g[0],g[1])}}function gn(e,a){a=st(a),a[0]-=e,fa(a);var r=Bi(-a[1]);return((-a[2]<0?-r:r)+Le-re)%Le}function rr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:qe,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ft(e,a){return ie(e[0]-a[0])<re&&ie(e[1]-a[1])<re}function Lt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function or(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(c){if(!((h=c.length-1)<=0)){var h,v=c[0],x=c[h],C;if(Ft(v,x)){if(!v[2]&&!x[2]){for(i.lineStart(),s=0;s<h;++s)i.point((v=c[s])[0],v[1]);i.lineEnd();return}x[0]+=2*re}o.push(C=new Lt(v,c,null,!0)),l.push(C.o=new Lt(v,null,C,!1)),o.push(C=new Lt(x,c,null,!1)),l.push(C.o=new Lt(x,null,C,!0))}}),!!o.length){for(l.sort(a),bn(o),bn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var g=o[0],d,m;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,p=d.length;s<p;++s)i.point((m=d[s])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(d=u.p.z,s=d.length-1;s>=0;--s)i.point((m=d[s])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);i.lineEnd()}}}function bn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function ra(e){return ie(e[0])<=Z?e[0]:$i(e[0])*((ie(e[0])+Z)%Le-Z)}function Vi(e,a){var r=ra(a),n=a[1],i=ue(n),o=[ue(r),-pe(r),0],l=0,s=0,p=new Je;i===1?n=ze+re:i===-1&&(n=-ze-re);for(var g=0,d=e.length;g<d;++g)if(u=(m=e[g]).length)for(var m,u,b=m[u-1],c=ra(b),h=b[1]/2+dn,v=ue(h),x=pe(h),C=0;C<u;++C,c=y,v=z,x=q,b=k){var k=m[C],y=ra(k),w=k[1]/2+dn,z=ue(w),q=pe(w),M=y-c,E=M>=0?1:-1,F=E*M,A=F>Z,O=v*z;if(p.add(vt(O*E*ue(F),x*q+O*pe(F))),l+=A?M+E*Le:M,A^c>=r^y>=r){var _=It(st(b),st(k));fa(_);var j=It(o,_);fa(j);var N=(A^M>=0?-1:1)*yt(j[2]);(n>N||n===N&&(_[0]||_[1]))&&(s+=A^M>=0?1:-1)}}return(l<-re||l<re&&p<-1e-12)^s&1}function ir(e,a,r,n){return function(i){var o=a(i),l=rr(),s=a(l),p=!1,g,d,m,u={point:b,lineStart:h,lineEnd:v,polygonStart:function(){u.point=x,u.lineStart=C,u.lineEnd=k,d=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=h,u.lineEnd=v,d=nr(d);var y=Vi(g,n);d.length?(p||(i.polygonStart(),p=!0),or(d,Wi,y,r,i)):y&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),d=g=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,w){e(y,w)&&i.point(y,w)}function c(y,w){o.point(y,w)}function h(){u.point=c,o.lineStart()}function v(){u.point=b,o.lineEnd()}function x(y,w){m.push([y,w]),s.point(y,w)}function C(){s.lineStart(),m=[]}function k(){x(m[0][0],m[0][1]),s.lineEnd();var y=s.clean(),w=l.result(),z,q=w.length,M,E,F;if(m.pop(),g.push(m),m=null,!!q){if(y&1){if(E=w[0],(M=E.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),z=0;z<M;++z)i.point((F=E[z])[0],F[1]);i.lineEnd()}return}q>1&&y&2&&w.push(w.pop().concat(w.shift())),d.push(w.filter(Hi))}}return u}}function Hi(e){return e.length>1}function Wi(e,a){return((e=e.x)[0]<0?e[1]-ze-re:ze-e[1])-((a=a.x)[0]<0?a[1]-ze-re:ze-a[1])}const vn=ir(function(){return!0},Yi,Ki,[-Z,-ze]);function Yi(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?Z:-Z,p=ie(o-a);ie(p-Z)<re?(e.point(a,r=(r+l)/2>0?ze:-ze),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=Z&&(ie(a-n)<re&&(a-=n*re),ie(o-s)<re&&(o-=s*re),r=Gi(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Gi(e,a,r,n){var i,o,l=ue(e-r);return ie(l)>re?Ii((ue(a)*(o=pe(n))*ue(r)-ue(n)*(i=pe(a))*ue(e))/(i*o*l)):(a+n)/2}function Ki(e,a,r,n){var i;if(e==null)i=r*ze,n.point(-Z,i),n.point(0,i),n.point(Z,i),n.point(Z,0),n.point(Z,-i),n.point(0,-i),n.point(-Z,-i),n.point(-Z,0),n.point(-Z,i);else if(ie(e[0]-a[0])>re){var o=e[0]<a[0]?Z:-Z;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Qi(e){var a=pe(e),r=2*Se,n=a>0,i=ie(a)>re;function o(d,m,u,b){Ui(b,e,r,u,d,m)}function l(d,m){return pe(d)*pe(m)>a}function s(d){var m,u,b,c,h;return{lineStart:function(){c=b=!1,h=1},point:function(v,x){var C=[v,x],k,y=l(v,x),w=n?y?0:g(v,x):y?g(v+(v<0?Z:-Z),x):0;if(!m&&(c=b=y)&&d.lineStart(),y!==b&&(k=p(m,C),(!k||Ft(m,k)||Ft(C,k))&&(C[2]=1)),y!==b)h=0,y?(d.lineStart(),k=p(C,m),d.point(k[0],k[1])):(k=p(m,C),d.point(k[0],k[1],2),d.lineEnd()),m=k;else if(i&&m&&n^y){var z;!(w&u)&&(z=p(C,m,!0))&&(h=0,n?(d.lineStart(),d.point(z[0][0],z[0][1]),d.point(z[1][0],z[1][1]),d.lineEnd()):(d.point(z[1][0],z[1][1]),d.lineEnd(),d.lineStart(),d.point(z[0][0],z[0][1],3)))}y&&(!m||!Ft(m,C))&&d.point(C[0],C[1]),m=C,b=y,u=w},lineEnd:function(){b&&d.lineEnd(),m=null},clean:function(){return h|(c&&b)<<1}}}function p(d,m,u){var b=st(d),c=st(m),h=[1,0,0],v=It(b,c),x=zt(v,v),C=v[0],k=x-C*C;if(!k)return!u&&d;var y=a*x/k,w=-a*C/k,z=It(h,v),q=qt(h,y),M=qt(v,w);na(q,M);var E=z,F=zt(q,E),A=zt(E,E),O=F*F-A*(zt(q,q)-1);if(!(O<0)){var _=et(O),j=qt(E,(-F-_)/A);if(na(j,q),j=ma(j),!u)return j;var N=d[0],L=m[0],$=d[1],U=m[1],V;L<N&&(V=N,N=L,L=V);var Q=L-N,Y=ie(Q-Z)<re,X=Y||Q<re;if(!Y&&U<$&&(V=$,$=U,U=V),X?Y?$+U>0^j[1]<(ie(j[0]-N)<re?$:U):$<=j[1]&&j[1]<=U:Q>Z^(N<=j[0]&&j[0]<=L)){var T=qt(E,(-F+_)/A);return na(T,q),[j,ma(T)]}}}function g(d,m){var u=n?e:Z-e,b=0;return d<-u?b|=1:d>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return ir(l,s,o,n?[0,-e]:[-Z,e-Z])}function Ji(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],g=a[1],d=0,m=1,u=p-l,b=g-s,c;if(c=r-l,!(!u&&c>0)){if(c/=u,u<0){if(c<d)return;c<m&&(m=c)}else if(u>0){if(c>m)return;c>d&&(d=c)}if(c=i-l,!(!u&&c<0)){if(c/=u,u<0){if(c>m)return;c>d&&(d=c)}else if(u>0){if(c<d)return;c<m&&(m=c)}if(c=n-s,!(!b&&c>0)){if(c/=b,b<0){if(c<d)return;c<m&&(m=c)}else if(b>0){if(c>m)return;c>d&&(d=c)}if(c=o-s,!(!b&&c<0)){if(c/=b,b<0){if(c>m)return;c>d&&(d=c)}else if(b>0){if(c<d)return;c<m&&(m=c)}return d>0&&(e[0]=l+d*u,e[1]=s+d*b),m<1&&(a[0]=l+m*u,a[1]=s+m*b),!0}}}}}var ft=1e9,Rt=-ft;function Xi(e,a,r,n){function i(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function o(g,d,m,u){var b=0,c=0;if(g==null||(b=l(g,m))!==(c=l(d,m))||p(g,d)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==c);else u.point(d[0],d[1])}function l(g,d){return ie(g[0]-e)<re?d>0?0:3:ie(g[0]-r)<re?d>0?2:1:ie(g[1]-a)<re?d>0?1:0:d>0?3:2}function s(g,d){return p(g.x,d.x)}function p(g,d){var m=l(g,1),u=l(d,1);return m!==u?m-u:m===0?d[1]-g[1]:m===1?g[0]-d[0]:m===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,m=rr(),u,b,c,h,v,x,C,k,y,w,z,q={point:M,lineStart:O,lineEnd:_,polygonStart:F,polygonEnd:A};function M(N,L){i(N,L)&&d.point(N,L)}function E(){for(var N=0,L=0,$=b.length;L<$;++L)for(var U=b[L],V=1,Q=U.length,Y=U[0],X,T,R=Y[0],P=Y[1];V<Q;++V)X=R,T=P,Y=U[V],R=Y[0],P=Y[1],T<=n?P>n&&(R-X)*(n-T)>(P-T)*(e-X)&&++N:P<=n&&(R-X)*(n-T)<(P-T)*(e-X)&&--N;return N}function F(){d=m,u=[],b=[],z=!0}function A(){var N=E(),L=z&&N,$=(u=nr(u)).length;(L||$)&&(g.polygonStart(),L&&(g.lineStart(),o(null,null,1,g),g.lineEnd()),$&&or(u,s,N,o,g),g.polygonEnd()),d=g,u=b=c=null}function O(){q.point=j,b&&b.push(c=[]),w=!0,y=!1,C=k=NaN}function _(){u&&(j(h,v),x&&y&&m.rejoin(),u.push(m.result())),q.point=M,y&&d.lineEnd()}function j(N,L){var $=i(N,L);if(b&&c.push([N,L]),w)h=N,v=L,x=$,w=!1,$&&(d.lineStart(),d.point(N,L));else if($&&y)d.point(N,L);else{var U=[C=Math.max(Rt,Math.min(ft,C)),k=Math.max(Rt,Math.min(ft,k))],V=[N=Math.max(Rt,Math.min(ft,N)),L=Math.max(Rt,Math.min(ft,L))];Ji(U,V,e,a,r,n)?(y||(d.lineStart(),d.point(U[0],U[1])),d.point(V[0],V[1]),$||d.lineEnd(),z=!1):$&&(d.lineStart(),d.point(N,L),z=!1)}C=N,k=L,y=$}return q}}const ga=e=>e;var oa=new Je,ba=new Je,sr,lr,va,ya,Ue={point:qe,lineStart:qe,lineEnd:qe,polygonStart:function(){Ue.lineStart=Zi,Ue.lineEnd=ts},polygonEnd:function(){Ue.lineStart=Ue.lineEnd=Ue.point=qe,oa.add(ie(ba)),ba=new Je},result:function(){var e=oa/2;return oa=new Je,e}};function Zi(){Ue.point=es}function es(e,a){Ue.point=cr,sr=va=e,lr=ya=a}function cr(e,a){ba.add(ya*e-va*a),va=e,ya=a}function ts(){cr(sr,lr)}var lt=1/0,$t=lt,wt=-lt,Bt=wt,_t={point:as,lineStart:qe,lineEnd:qe,polygonStart:qe,polygonEnd:qe,result:function(){var e=[[lt,$t],[wt,Bt]];return wt=Bt=-($t=lt=1/0),e}};function as(e,a){e<lt&&(lt=e),e>wt&&(wt=e),a<$t&&($t=a),a>Bt&&(Bt=a)}var wa=0,ka=0,ht=0,Ut=0,Vt=0,rt=0,ja=0,Na=0,xt=0,dr,pr,De,Ie,Te={point:Xe,lineStart:yn,lineEnd:wn,polygonStart:function(){Te.lineStart=os,Te.lineEnd=is},polygonEnd:function(){Te.point=Xe,Te.lineStart=yn,Te.lineEnd=wn},result:function(){var e=xt?[ja/xt,Na/xt]:rt?[Ut/rt,Vt/rt]:ht?[wa/ht,ka/ht]:[NaN,NaN];return wa=ka=ht=Ut=Vt=rt=ja=Na=xt=0,e}};function Xe(e,a){wa+=e,ka+=a,++ht}function yn(){Te.point=ns}function ns(e,a){Te.point=rs,Xe(De=e,Ie=a)}function rs(e,a){var r=e-De,n=a-Ie,i=et(r*r+n*n);Ut+=i*(De+e)/2,Vt+=i*(Ie+a)/2,rt+=i,Xe(De=e,Ie=a)}function wn(){Te.point=Xe}function os(){Te.point=ss}function is(){ur(dr,pr)}function ss(e,a){Te.point=ur,Xe(dr=De=e,pr=Ie=a)}function ur(e,a){var r=e-De,n=a-Ie,i=et(r*r+n*n);Ut+=i*(De+e)/2,Vt+=i*(Ie+a)/2,rt+=i,i=Ie*e-De*a,ja+=i*(De+e),Na+=i*(Ie+a),xt+=i*3,Xe(De=e,Ie=a)}function mr(e){this._context=e}mr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Le);break}}},result:qe};var Sa=new Je,ia,fr,hr,gt,bt,kt={point:qe,lineStart:function(){kt.point=ls},lineEnd:function(){ia&&xr(fr,hr),kt.point=qe},polygonStart:function(){ia=!0},polygonEnd:function(){ia=null},result:function(){var e=+Sa;return Sa=new Je,e}};function ls(e,a){kt.point=xr,fr=gt=e,hr=bt=a}function xr(e,a){gt-=e,bt-=a,Sa.add(et(gt*gt+bt*bt)),gt=e,bt=a}let kn,Ht,jn,Nn;class Sn{constructor(a){this._append=a==null?gr:cs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==jn||this._append!==Ht){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,jn=n,Ht=this._append,Nn=this._,this._=i}this._+=Nn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function gr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function cs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return gr;if(a!==kn){const r=10**a;kn=a,Ht=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Ht}function ds(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),nt(s,i(o))),o.result()}return l.area=function(s){return nt(s,i(Ue)),Ue.result()},l.measure=function(s){return nt(s,i(kt)),kt.result()},l.bounds=function(s){return nt(s,i(_t)),_t.result()},l.centroid=function(s){return nt(s,i(Te)),Te.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,ga):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new Sn(r)):new mr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new Sn(r)),l},l.projection(e).digits(r).context(a)}function Oa(e){return function(a){var r=new Ca;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Ca(){}Ca.prototype={constructor:Ca,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Fa(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),nt(r,e.stream(_t)),a(_t.result()),n!=null&&e.clipExtent(n),e}function br(e,a,r){return Fa(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function ps(e,a,r){return br(e,[[0,0],a],r)}function us(e,a,r){return Fa(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function ms(e,a,r){return Fa(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var Cn=16,fs=pe(30*Se);function En(e,a){return+a?xs(e,a):hs(e)}function hs(e){return Oa({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function xs(e,a){function r(n,i,o,l,s,p,g,d,m,u,b,c,h,v){var x=g-n,C=d-i,k=x*x+C*C;if(k>4*a&&h--){var y=l+u,w=s+b,z=p+c,q=et(y*y+w*w+z*z),M=yt(z/=q),E=ie(ie(z)-1)<re||ie(o-m)<re?(o+m)/2:vt(w,y),F=e(E,M),A=F[0],O=F[1],_=A-n,j=O-i,N=C*_-x*j;(N*N/k>a||ie((x*_+C*j)/k-.5)>.3||l*u+s*b+p*c<fs)&&(r(n,i,o,l,s,p,A,O,E,y/=q,w/=q,z,h,v),v.point(A,O),r(A,O,E,y,w,z,g,d,m,u,b,c,h,v))}}return function(n){var i,o,l,s,p,g,d,m,u,b,c,h,v={point:x,lineStart:C,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=w},polygonEnd:function(){n.polygonEnd(),v.lineStart=C}};function x(M,E){M=e(M,E),n.point(M[0],M[1])}function C(){m=NaN,v.point=k,n.lineStart()}function k(M,E){var F=st([M,E]),A=e(M,E);r(m,u,d,b,c,h,m=A[0],u=A[1],d=M,b=F[0],c=F[1],h=F[2],Cn,n),n.point(m,u)}function y(){v.point=x,n.lineEnd()}function w(){C(),v.point=z,v.lineEnd=q}function z(M,E){k(i=M,E),o=m,l=u,s=b,p=c,g=h,v.point=k}function q(){r(m,u,d,b,c,h,o,l,i,s,p,g,Cn,n),v.lineEnd=y,y()}return v}}var gs=Oa({point:function(e,a){this.stream.point(e*Se,a*Se)}});function bs(e){return Oa({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function vs(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function An(e,a,r,n,i,o){if(!o)return vs(e,a,r,n,i);var l=pe(o),s=ue(o),p=l*e,g=s*e,d=l/e,m=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function c(h,v){return h*=n,v*=i,[p*h-g*v+a,r-g*h-p*v]}return c.invert=function(h,v){return[n*(d*h-m*v+u),i*(b-m*h-d*v)]},c}function ys(e){return ws(function(){return e})()}function ws(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,g=0,d,m=0,u=1,b=1,c=null,h=vn,v=null,x,C,k,y=ga,w=.5,z,q,M,E,F;function A(N){return M(N[0]*Se,N[1]*Se)}function O(N){return N=M.invert(N[0],N[1]),N&&[N[0]*_e,N[1]*_e]}A.stream=function(N){return E&&F===N?E:E=gs(bs(d)(h(z(y(F=N)))))},A.preclip=function(N){return arguments.length?(h=N,c=void 0,j()):h},A.postclip=function(N){return arguments.length?(y=N,v=x=C=k=null,j()):y},A.clipAngle=function(N){return arguments.length?(h=+N?Qi(c=N*Se):(c=null,vn),j()):c*_e},A.clipExtent=function(N){return arguments.length?(y=N==null?(v=x=C=k=null,ga):Xi(v=+N[0][0],x=+N[0][1],C=+N[1][0],k=+N[1][1]),j()):v==null?null:[[v,x],[C,k]]},A.scale=function(N){return arguments.length?(r=+N,_()):r},A.translate=function(N){return arguments.length?(n=+N[0],i=+N[1],_()):[n,i]},A.center=function(N){return arguments.length?(o=N[0]%360*Se,l=N[1]%360*Se,_()):[o*_e,l*_e]},A.rotate=function(N){return arguments.length?(s=N[0]%360*Se,p=N[1]%360*Se,g=N.length>2?N[2]%360*Se:0,_()):[s*_e,p*_e,g*_e]},A.angle=function(N){return arguments.length?(m=N%360*Se,_()):m*_e},A.reflectX=function(N){return arguments.length?(u=N?-1:1,_()):u<0},A.reflectY=function(N){return arguments.length?(b=N?-1:1,_()):b<0},A.precision=function(N){return arguments.length?(z=En(q,w=N*N),j()):et(w)},A.fitExtent=function(N,L){return br(A,N,L)},A.fitSize=function(N,L){return ps(A,N,L)},A.fitWidth=function(N,L){return us(A,N,L)},A.fitHeight=function(N,L){return ms(A,N,L)};function _(){var N=An(r,0,0,u,b,m).apply(null,a(o,l)),L=An(r,n-N[0],i-N[1],u,b,m);return d=_i(s,p,g),q=ha(a,L),M=ha(d,q),z=En(q,w),j()}function j(){return E=F=null,A}return function(){return a=e.apply(this,arguments),A.invert=a.invert&&O,_()}}function vr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}vr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>re&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ks(){return ys(vr).scale(175.295)}function js(e){return e}function Ns(e){if(e==null)return js;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var g=2,d=s.length,m=new Array(d);for(m[0]=(a+=s[0])*n+o,m[1]=(r+=s[1])*i+l;g<d;)m[g]=s[g],++g;return m}}function Ss(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function Cs(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Tn(e,r)})}:Tn(e,a)}function Tn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=Es(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function Es(e,a){var r=Ns(e.transform),n=e.arcs;function i(d,m){m.length&&m.pop();for(var u=n[d<0?~d:d],b=0,c=u.length;b<c;++b)m.push(r(u[b],b));d<0&&Ss(m,c)}function o(d){return r(d)}function l(d){for(var m=[],u=0,b=d.length;u<b;++u)i(d[u],m);return m.length<2&&m.push(m[0]),m}function s(d){for(var m=l(d);m.length<4;)m.push(m[0]);return m}function p(d){return d.map(s)}function g(d){var m=d.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:d.geometries.map(g)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=p(d.arcs);break;case"MultiPolygon":u=d.arcs.map(p);break;default:return null}return{type:m,coordinates:u}}return g(a)}const yr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},As=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Ts(e,a,r){const n=yr[e];if(!n||!n.length)return-1;const i=As(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Mt=null;function zs(){return Mt||(Mt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=Cs(r,n),o=ks().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=ds(o),s=(i.features||[]).filter(d=>{var m;return(((m=d.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(d=>{var b;const m=((b=d.properties)==null?void 0:b.name)||"",u=l(d)||"";return u?{i2:io(m)||null,n:m,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const p={};for(const[d,m]of Object.entries(so)){const u=o(m);u&&(p[d]={x:u[0],y:u[1]})}const g={};for(const[d,m]of Object.entries(yr)){const u=m.map(b=>o(b.ll)).filter(b=>!!b).map(([b,c])=>({x:b,y:c}));u.length&&(g[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:g}}catch{return null}})(),Mt)}function qs(e){const[a,r]=f.useState(null);return f.useEffect(()=>{if(!e||a)return;let n=!1;return zs().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const Ls={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},zn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function qn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Rs(e,a){const[r,n]=f.useState(1);return f.useEffect(()=>{let i=!0,o=0;const l=()=>{var g;if(!i)return;const p=(g=e.current)==null?void 0:g.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Ln({msgs:e}){const[a,r]=f.useState(0);f.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Ms(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p,data:g,dossiers:d}=D(),m=g.loading&&!d.length,u=f.useRef(null),b=f.useRef(null),c=qs(e.continent==="monde"),h=e.continent==="monde"?c:qa.find(j=>j.key===e.continent)||null,v=Rs(u,e.continent+":"+e.mapFolded+":"+!!h),[x,C]=f.useState(new Map),[k,y]=f.useState(null);f.useEffect(()=>{const j=u.current;if(!j)return;const N=new Map;j.querySelectorAll("path[data-i2]").forEach(L=>{const $=L.dataset.i2;if($)try{const U=L.getBBox();U.width>0&&N.set($,{x:U.x,y:U.y,w:U.width,h:U.height})}catch{}}),C(N)},[e.continent,v,h]);const w=f.useMemo(()=>r.filter(j=>j.cc),[r]),z=f.useMemo(()=>{const j=new Map;return w.forEach(N=>j.set(N.cc,(j.get(N.cc)||0)+1)),j},[w]),q=e.continent==="monde"&&c?c.anchors:null,M=e.continent==="monde"&&c?c.metros:null,E=f.useMemo(()=>w.map(j=>{const N=qn(j.name||j.id||""),L=qn((j.id||j.name||"")+"·y");if(q&&j.cc){const Y=M?M[j.cc]:void 0;if(Y&&Y.length){const T=Ts(j.cc,j.city,N);if(T>=0&&Y[T])return{d:j,x:Y[T].x+(N-.5)*5,y:Y[T].y+(L-.5)*5}}const X=q[j.cc];if(X)return{d:j,x:X.x+(N-.5)*10,y:X.y+(L-.5)*10}}const $=j.cc?x.get(j.cc):void 0;if(!$)return null;const U=Ls[`${e.continent}:${j.cc||""}`];if(U)return{d:j,x:$.x+$.w*(U.fx+(N-.5)*U.sx),y:$.y+$.h*(U.fy+(L-.5)*U.sy)};const V=(N-.5)*Math.min($.w*.55,60),Q=(L-.5)*Math.min($.h*.55,60);return{d:j,x:$.x+$.w/2+V,y:$.y+$.h/2+Q}}).filter(j=>!!j),[w,x,q,M,e.continent]),F=j=>v>0?j/v:j,A=f.useMemo(()=>n?[0,1,2,3,4,5].map(j=>({c:zn[j],fr:p.plabels[j].toUpperCase(),en:p.plabels[j].toUpperCase(),n:r.filter(N=>N.kind==="target"&&be(N)===j).length})).filter(j=>j.n>0):Ka.map((j,N)=>({...j,n:r.filter(L=>Qa(L)===N).length})),[r,n,p.plabels]),O=o?l.get(o):null,_=O?E.find(j=>j.d.id===O.id):null;return h?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[m&&t.jsx(Ln,{msgs:p.loadMsgs}),t.jsxs("svg",{ref:u,viewBox:h.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?h.fr:h.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:h.countries.map((j,N)=>t.jsx("g",{className:"ct"+(j.i2&&z.get(j.i2)?"":" empty"),children:t.jsx("path",{d:j.d,"data-i2":j.i2||void 0})},N))}),t.jsx("g",{children:E.map(j=>{const N=Ka[Qa(j.d)],L=!!ge(j.d),$=j.d.kind==="target",U=n&&$?zn[be(j.d)]:N.c,V=!n&&Ce(j.d);return t.jsxs("g",{className:"co"+(V?" done":""),onMouseEnter:()=>{var X,T;const Q=(X=b.current)==null?void 0:X.getBoundingClientRect(),Y=(T=u.current)==null?void 0:T.createSVGPoint();if(Y&&u.current&&Q){Y.x=j.x,Y.y=j.y;const R=Y.matrixTransform(u.current.getScreenCTM());y({x:R.x-Q.left,y:R.y-Q.top,label:j.d.name+" · "+(dt(j.d.cc,s)||j.d.countryLabel||"")})}i(j.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var X;const Q=(X=u.current)==null?void 0:X.createSVGPoint();let Y=null;if(Q&&u.current){Q.x=j.x,Q.y=j.y;const T=Q.matrixTransform(u.current.getScreenCTM());Y={x:T.x,y:T.y}}a({type:"popup",id:j.d.id,anchor:Y})},children:[t.jsx("circle",{className:"h",cx:j.x,cy:j.y,r:F(Math.max(11,N.px+7))}),t.jsx("circle",{className:"v",cx:j.x,cy:j.y,r:F(N.px),fill:U,stroke:L?"#DC2626":"#ffffff",strokeWidth:F(L?2.2:1.3)})]},j.d.id||j.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:F(13),fill:"none",stroke:"#0F172A",strokeWidth:F(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:A.map((j,N)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":j.c}}),s==="fr"?j.fr:j.en," ",t.jsx("b",{children:j.n})]},N))}),r.some(j=>!j.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(j=>!j.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:t.jsx(Ln,{msgs:p.loadMsgs})})}function Os(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Fs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=D(),s=e.filters,p=f.useMemo(()=>e.continent==="monde"?r:r.filter(c=>c.continent===e.continent),[r,e.continent]),g=c=>p.filter(h=>c!=="country"&&s.country.length&&!s.country.includes(h.cc||"")?!1:La(h,s,i,c==="country"?void 0:c)),d=f.useMemo(()=>{const c=g("win"),h=v=>c.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=v).length;return[h(0),h(7),h(30),c.length]},[p,s,i]),m=f.useMemo(()=>s.day?g("win").filter(c=>(c.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=(s.acquirer.trim()?1:0)+s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),b=(c,h,v,x="fbtn")=>t.jsxs("button",{type:"button",className:x,"aria-expanded":e.openFacet===c,onClick:()=>a({type:"openFacet",facet:c}),children:[t.jsx("span",{className:"fl",children:h}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},c);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:n.fDay(Os(s.day,l))}),t.jsx("b",{children:m})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((c,h)=>t.jsxs("button",{type:"button","aria-pressed":s.win===c,onClick:()=>a({type:"filters",patch:{win:c}}),children:[t.jsx("span",{className:"sl",children:n.dates[h]}),t.jsx("b",{children:d[h]})]},c))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:c=>a({type:"filters",patch:{search:c.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):b("sec",n.fSector,s.sector.length),b("pay",n.fCountry,s.country.length),b("det",n.fEngine,s.engine.length),b("sta",n.fStage,s.stage.length),i&&b("ang","Angle",s.angle.length),i&&b("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Ps,{poolFor:g})]})}function Ps({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=D(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:g}=f.useMemo(()=>{if(l==="sig"){const c=e("signal").filter(x=>ge(x)),h=new Map;c.forEach(x=>{const C=x.engine||"";h.set(C,(h.get(C)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:c.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ca([...h.keys()],i).map(x=>({v:x,label:Qe(x)+" "+$e(x,i),n:h.get(x)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(x)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const c=e("sector"),h=new Map;return c.forEach(v=>{v.sector&&h.set(v.sector,(h.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...h.entries()].sort((v,x)=>x[1]-v[1]).map(([v,x])=>({v,label:v,n:x,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const c=e("country"),h=new Map;return c.forEach(v=>{v.cc&&h.set(v.cc,(h.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...h.entries()].sort((v,x)=>x[1]-v[1]).map(([v,x])=>({v,label:dt(v,i)||v,n:x,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const c=e("engine"),h=new Map;return c.forEach(v=>{v.engine&&h.set(v.engine,(h.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ca([...h.keys()],i).map(v=>({v,label:Qe(v)+" "+$e(v,i)+' <span style="color:var(--dim);font-size:10px">· '+lo(co(v),i)+"</span>",n:h.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const c=e("angle"),h=new Map;return c.forEach(v=>{v.angle&&h.set(v.angle,(h.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...h.entries()].sort((v,x)=>x[1]-v[1]).map(([v,x])=>({v,label:v.replace(/[_-]+/g," "),n:x,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const c=e("memoLevel"),h=new Map;c.forEach(x=>{if(x.kind==="target"){const C=Ta(x);h.set(C,(h.get(C)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(x=>({v:String(x),label:v[x],n:h.get(x)||0,html:!1,on:o.memoLevel.includes(x)}))}}const u=e("stage"),b=new Map;return u.forEach(c=>{c.stage&&b.set(c.stage,(b.get(c.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((c,h)=>h[1]-c[1]).map(([c,h])=>({v:c,label:c,n:h,html:!1,on:o.stage.includes(c)}))}},[l,a,i]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const c=o.signalEngines.includes(u)?o.signalEngines.filter(h=>h!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:c}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function wr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ds(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Rn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=D();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function kr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=D(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Rn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Rn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Is({card:e,onEvaluate:a,onAddAll:r}){var s,p,g;const{t:n}=D(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:wr(e.summary_md||"").map((d,m)=>t.jsx("p",{children:d},m))})]}),t.jsx(kr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function $s(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Bs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=D(),s=i,[p,g]=f.useState(null),[d,m]=f.useState(null),[u,b]=f.useState(null),[c,h]=f.useState(!1);f.useEffect(()=>{let x=!0;return(async()=>{const C=await Hn({email:l,cbToken:s});x&&g(C)})(),()=>{x=!1}},[l,s,n]);const v=x=>{m(x),b(null),h(!0),(async()=>{const C=await po(x.id);b(C),h(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(x=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(x),children:[t.jsx("span",{className:"ti",children:x.title}),t.jsxs("span",{className:"me",children:[$s(x.created_at),x.industry?` · ${x.industry}`:"",x.author?` · ${x.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(x.cited_n||0,x.evaluate_n||0)}),t.jsx("span",{className:"st"+(x.published?" on":""),children:x.published?o.rsPub:o.rsPriv})]},x.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),c&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!c&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!c&&u&&t.jsx(Is,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Mn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function _s(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:g,data:d,canWrite:m,source:u}=D(),b=a==="client",c=f.useMemo(()=>r||(u!=="default"?uo():""),[r,u]),[h,v]=f.useState(""),[x,C]=f.useState(!1),[k,y]=f.useState(""),[w,z]=f.useState(!1),[q,M]=f.useState(""),[E,F]=f.useState([]),A=f.useRef(!1),[O,_]=f.useState(!1),[j,N]=f.useState(""),[L,$]=f.useState(""),[U,V]=f.useState(!1),[Q,Y]=f.useState(0),[X,T]=f.useState(""),[R,P]=f.useState(null),[B,G]=f.useState(null),[K,se]=f.useState(!1),[le,J]=f.useState(null),[ee,he]=f.useState(0),te=f.useRef(!1),ce=h.trim()?Mn.test(h.trim())?e.evalUrl:e.evalName:e.evalWaiting,ne=f.useMemo(()=>k.split(`
`).map(I=>I.trim()).filter(Boolean).slice(0,15),[k]);f.useEffect(()=>{if(typeof window>"u")return;const I=(new URLSearchParams(window.location.search).get("rs")||"").trim();!I||!/^https?:\/\//i.test(I)||(N(I),_(!0))},[]),f.useEffect(()=>{const I=ae=>{var we;const oe=String(((we=ae.detail)==null?void 0:we.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(N(oe),_(!0))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),f.useEffect(()=>{if(!m&&!c){J(null);return}let I=!0;return(async()=>{const ae=await Hn({email:n,cbToken:c});I&&J(ae.length)})(),()=>{I=!1}},[m,c,n,ee]);const Oe=E.length?E:p,xe=d.credits,ye=f.useCallback(I=>{const ae=I.map(oe=>(oe||"").trim()).filter(Boolean);ae.length&&(y(oe=>{const we=oe.split(`
`).map(de=>de.trim()).filter(Boolean),Ve=new Set(we.map(de=>de.toLowerCase())),je=ae.filter(de=>!Ve.has(de.toLowerCase()));return[...we,...je].slice(0,15).join(`
`)}),C(!0))},[]);f.useEffect(()=>{if(!U)return;Y(0);const I=window.setInterval(()=>Y(ae=>ae+1),1e3);return()=>window.clearInterval(I)},[U]);const Re=()=>{const I=h.trim();I&&(i(null,I),v(""))},tt=async()=>{if(!b){i(null,ne[0]||"");return}if(!ne.length||w)return;z(!0),A.current=!1;const I=[];for(let ae=0;ae<ne.length&&!A.current;ae++){M(e.evaluating(ae+1,ne.length,ne[ae]));const oe=await Wn(r,ne[ae],"atelier2");if(I.unshift({name:oe.company||ne[ae],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),F([...I]),oe.verdict==="quota"){I.unshift({name:"",verdict:"quota",reason:e.quota(ne.length-ae-1),remaining:0}),F([...I]),y(ne.slice(ae+1).join(`
`)),M(""),z(!1);return}}M(""),y(A.current?ne.slice(I.length).join(`
`):""),z(!1)},Ee=async()=>{var oe,we,Ve;if(te.current)return;const I=j.trim().replace(/\s+/g,""),ae=L.trim();if(!I&&!ae){T(e.rsNeed);return}if(!b&&!c){i(null,I||ae.slice(0,80));return}te.current=!0,T(""),P(null),G(null),V(!0);try{const je=await fo({url:I,text:ae,email:n,cbToken:c});if(V(!1),!je||je.status!=="success"){T((je==null?void 0:je.message)||"Erreur");return}P(je),_(!1),ye((((oe=je.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),G({state:"pending"});const de=await ho(je,{email:n,cbToken:c});G(de.ok?{state:"ok",scopeLabel:((we=de.summary)==null?void 0:we.scope_label)||"",scope:((Ve=de.summary)==null?void 0:Ve.scope)||""}:{state:"fail",msg:de.error||""}),de.ok&&he(Ae=>Ae+1)}finally{te.current=!1,V(!1)}},Be=[R==null?void 0:R.industry,...(R==null?void 0:R.market_tags)||[],R==null?void 0:R.author].map(I=>(I||"").trim()).filter(Boolean),pt=(B==null?void 0:B.state)==="pending",Nt=B&&(pt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):B.state==="ok"?t.jsx("span",{className:"rslink ok",children:B.scope&&B.scope!=="public"?e.rsSavedIn(B.scopeLabel||B.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:B.msg,children:e.rsSaveFail})),at=Ds(R).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:h,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:I=>v(I.target.value),onKeyDown:I=>{I.key==="Enter"&&Re()}}),t.jsx("span",{className:"detect"+(Mn.test(h.trim())?" url":""),children:ce})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:Re,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),g.showCredits&&xe&&t.jsxs("button",{type:"button",className:"credits"+(xe.total_available<=0&&!xe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:xe.unlimited?"∞":xe.total_available}),!xe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",xe.daily_grant+xe.purchased]}),xe.total_available<=0&&!xe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>C(!x),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(O?" on":""),onClick:()=>_(!O),children:e.rsOpen}),le!==null&&le>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(K?" on":""),onClick:()=>se(!K),children:e.rsArchOpen(le)})]}),K&&t.jsx(Bs,{bump:ee,cbToken:c,onClose:()=>se(!1),onEvaluate:I=>i(null,I),onAddAll:ye}),O&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:j,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:I=>N(I.target.value),onKeyDown:I=>{I.key==="Enter"&&Ee()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:L,placeholder:e.rsTextPh,onChange:I=>$(I.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(U?" loading":""),style:{justifyContent:"center"},disabled:U||pt||!j.trim()&&!L.trim(),onClick:()=>{Ee()},children:[t.jsx("span",{className:"fill"}),U?`${mo(j.trim())==="youtube"&&j.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Q)}`:pt?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),X&&t.jsx("div",{className:"rserr",children:X}),R&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:R.title}),R.source_url&&t.jsx("a",{href:R.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{P(null),G(null)},children:"×"})]}),R.market&&t.jsx("p",{className:"rsmk",children:R.market}),Be.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Be.map(I=>t.jsx("span",{children:I},I))]}),t.jsxs("div",{className:"rsbody",children:[R.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${R.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:wr(R.summary_md||"").map((I,ae)=>t.jsx("p",{children:I},ae))})]}),t.jsx(kr,{card:R,onEvaluate:I=>i(null,I),onAddAll:ye}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(at)}),Nt]})]}),x&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:k,placeholder:e.bulkPh,onChange:I=>y(I.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(w?" loading":""),style:{justifyContent:"center"},disabled:w||!ne.length,onClick:()=>{tt()},children:[t.jsx("span",{className:"fill"}),w&&q?q:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(ne.length)})]})]}),Oe.slice(0,1).map((I,ae)=>{const oe=I.verdict==="kept",we=I.verdict==="quota",Ve=oe?"var(--brand)":we?"var(--bolt)":"var(--red)",je=oe?"var(--brand-l)":we?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ve,"--bgc":je},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:we?"⏳":"✗ "+e.dropped})}),I.name&&t.jsx("span",{className:"rn",children:I.name}),t.jsx("span",{className:"rr",children:I.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",I.reason]}):null}),!!(I.candidates&&I.candidates.length)&&t.jsx("span",{className:"sitepick",children:I.candidates.map(de=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:de.url.startsWith("http")?de.url:`https://${de.url}`,target:"_blank",rel:"nofollow noopener",children:[(de.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,de.url),children:e.evalPickGo})]},de.url))}),!we&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:oe?1:5});const de=(I.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ae=[...document.querySelectorAll(".atl2 .list .row")].find(Qt=>{var St;return(((St=Qt.querySelector(".rnm"))==null?void 0:St.textContent)||"").trim().toLowerCase().includes(de)});Ae&&(Ae.scrollIntoView({behavior:"smooth",block:"center"}),Ae.classList.add("flashrow"),window.setTimeout(()=>Ae.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),b&&(o.kept+o.dropped>0||Oe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Us(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Vs(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=D(),o=e.memoConsole?r.get(e.memoConsole):null,l=f.useMemo(()=>o?[o.reasoning||"",Us(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const s=We(o),p=Ta(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[it(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const sa={},On=(sa==null?void 0:sa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Fn(){return new Date().toISOString().slice(0,10)}const Pa=f.createContext(null);function Hs(){return f.useContext(Pa)}function Ws(e){if(!e||typeof DOMParser>"u")return[];try{const r=[...new DOMParser().parseFromString(e,"text/html").querySelectorAll("div,section")].find(i=>/en bref/i.test(i.textContent||"")&&i.querySelector("li"));return(r?[...r.querySelectorAll("li")]:[]).map(i=>(i.textContent||"").replace(/\s+/g," ").trim()).filter(i=>i.length>3).slice(0,4)}catch{return[]}}function Ys(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(p=>p.remove()),s.querySelectorAll("*").forEach(p=>{const g=p.tagName==="A"?p.getAttribute("href"):null;[...p.attributes].forEach(d=>p.removeAttribute(d.name)),g&&/^https?:\/\//i.test(g)&&(p.setAttribute("href",g),p.setAttribute("target","_blank"),p.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Ea(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Gs(){const{ed:e,isEn:a,day:r,loading:n}=Da(),i=f.useMemo(()=>Ws((e==null?void 0:e.html)||""),[e==null?void 0:e.html]);if(n&&!e)return null;const o=Ea(r,a);return i.length?t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:(a?"Daily brief · ":"Brief du jour · ")+o}),t.jsx("ul",{children:i.map((l,s)=>t.jsx("li",{children:l},s))})]}):t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:a?"Daily brief":"Brief du jour"}),t.jsx("p",{className:"tlp",children:a?`Edition of ${o}.`:`Édition du ${o}.`})]})}function Da(){const e=f.useContext(Pa);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ks({token:e,children:a}){const{dispatch:r,st:n,lang:i}=D(),[o,l]=f.useState(()=>n.filters.day||Fn()),[s,p]=f.useState(null),[g,d]=f.useState(!1),m=f.useCallback(h=>{if(/^\d{4}-\d{2}-\d{2}$/.test(h)){l(h);try{r({type:"filters",patch:{day:h,win:"all"}})}catch{}}},[r]),u=f.useCallback(()=>{l(Fn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);f.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),f.useEffect(()=>{const h=v=>{var C;const x=(C=v.detail)==null?void 0:C.day;typeof x=="string"&&m(x)};return window.addEventListener("pp-edition-day",h),()=>window.removeEventListener("pp-edition-day",h)},[m]),f.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),f.useEffect(()=>{if(!e||!o)return;let h=!1;d(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${On}/cibles/edition.json?${v}`).then(x=>x.json()).then(x=>{h||p(x)}).catch(()=>{h||p({ok:!1,error:"network"})}).finally(()=>{h||d(!1)}),()=>{h=!0}},[e,o]);const b=f.useMemo(()=>`${On}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),c=f.useMemo(()=>({token:e,day:o,ed:s,loading:g,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,s,g,m,u,n.filters.day,b,i]);return t.jsx(Pa.Provider,{value:c,children:a})}function Qs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Da();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(xo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function Js(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Da(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,p=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
...
`;function Zs(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function el(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:p,doDecide:g,doPromote:d,doRepeche:m,doApproach:u,doDeep:b,doOnboard:c,outbound:h,evalBusy:v}=D(),x=e.popupId?r.get(e.popupId):null;if(!x)return null;const C=ge(x),k=be(x),y=We(x),w=x.kind==="target",z=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return ct.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Xs}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Zs(e.popupAnchor,!!x.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:x.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(He(x.date)),$e(x.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[x.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>z({country:[x.cc]}),children:(dt(x.cc,i)||x.countryLabel||"").toUpperCase()}),x.sector&&t.jsx("button",{type:"button",onClick:()=>z({sector:[x.sector]}),children:x.sector.toUpperCase()}),x.stage&&t.jsx("button",{type:"button",onClick:()=>z({stage:[x.stage]}),children:x.stage.toUpperCase()}),typeof x.amountEur=="number"&&x.amountEur>0&&t.jsx("span",{className:"am2",children:jt(x.amountEur,i)})]}),(x.tagline||x.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:x.tagline||x.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Qe(x.engine)," ",t.jsx("b",{children:$e(x.engine,i)})," — ",bo(x.engine,i),x.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",x.noteTitle]})]}),C?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ze,{o:x,lg:!0})," ",t.jsx(Kt,{o:x,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Yn(C,i))," · ",n.win7(Gn(C,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),x.card?t.jsx(Gt,{spec:x.card}):null,x.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&k>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:x.reasoning})]}),o.pipe&&w&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof x.score=="number"&&x.score>0?" · "+n.score(x.score):""]})})]}),t.jsx(jr,{name:x.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[k===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)]}),k===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),k===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),k===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(x,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(x,!1),a({type:"popup",id:null})},children:n.actNo}),it(x)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(x),a({type:"popup",id:null})},children:n.memoDeep})]}),k===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),k===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),x.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:x.id}),a({type:"popup",id:null})},children:"📄"}),h&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{c(x),a({type:"popup",id:null})},children:"🚀"})]}):x.engine==="media"&&x.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(x.name),onClick:()=>s(x),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)," →"]}),x.website&&t.jsx("a",{className:"psite",href:x.website.startsWith("http")?x.website:"https://"+x.website,target:"_blank",rel:"noopener noreferrer",title:x.website,children:"🌐"})]})]})]}),document.body)}const tl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ot=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function al(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Ot(a.slice(n));break}r+=Ot(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Ot(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&tl.has(p)?r+=`<${s[1]}${p}>`:r+=Ot(a.slice(i,o+1)),n=o+1}return r}const Pn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ke({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function nl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function rl({o:e}){const{t:a,doDeep:r}=D(),n=We(e),i=[e.reasoning||"",nl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[n&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:n}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),i.length?i.join(`

`).split(`

`).map((o,l)=>t.jsx("p",{className:"cdtxt",children:o},l)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[it(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:o=>{o.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:o=>o.stopPropagation(),children:a.memoOpenFull})]})]})}function ol({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=D(),o=Yt(e),l=We(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),m=f.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||it(e)?1:0}].filter(h=>h.n>0),[e,a,s,l,p,g,d]),[u,b]=f.useState("");if(!m.length)return null;const c=m.some(h=>h.k===u)?u:m[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:m.map(h=>t.jsx("button",{type:"button",role:"tab","aria-selected":c===h.k,"data-tour":"tab-"+h.k,className:c===h.k?"on":"",onClick:v=>{v.stopPropagation(),b(h.k)},children:h.lib},h.k))}),t.jsxs("div",{className:"cdbody",onClick:h=>h.stopPropagation(),children:[c==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(ke,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(ke,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(ke,{k:a.cdVerdictDate,v:Pn(e.verdictDate,r)})]})]}),c==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:al(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(il,{o:e})]}),c==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ke,{k:a.cdSector,v:e.sector}),t.jsx(ke,{k:a.cdStage,v:e.stage}),t.jsx(ke,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ke,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(ke,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(ke,{k:a.cdAngle,v:e.angle}),t.jsx(ke,{k:a.cdDetected,v:Pn(e.date,r)})]}),c==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ke,{k:a.cdName,v:e.contactName}),t.jsx(ke,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(ke,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),c==="memo"&&t.jsx(rl,{o:e}),c==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(ke,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(ke,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function il({o:e}){const{t:a,token:r}=D(),[n,i]=f.useState(!1),[o,l]=f.useState(null),s=async()=>{n||(i(!0),l(await vo(r,e.name,e.website||e.domain||"")),i(!1))},p=(o==null?void 0:o.blocs)||{},g=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=g.some(([,m])=>m);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&d&&t.jsxs(t.Fragment,{children:[g.filter(([,m])=>m).map(([m,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:m}),t.jsx("p",{children:u})]},m)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!d&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const Nr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ia({o:e}){const{t:a}=D(),r=Yt(e),n=We(e),i=be(e),o=la(e),l=yo(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(Nr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const Wt=e=>e.length>22?e.slice(0,21)+"…":e;function Dn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=D(),[o,l]=f.useState(!1);if(f.useEffect(()=>{n||l(!1)},[n]),Ce(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Wt(e.name))})]})}function Sr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:p,doApproach:g,dispatch:d}=D();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:b=>{b.stopPropagation(),d({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var c;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(c=document.querySelector(".atl2 .demand"))==null||c.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var c;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(c=document.querySelector(".atl2 .demand"))==null||c.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Dn,{o:e})});const m=be(e),u=b=>c=>{c.stopPropagation(),b()};if(m===0)return t.jsx("span",{className:"cell",children:t.jsx(Dn,{o:e})});if(m===1){const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:u(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(m===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(m===4){const b=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:b,onClick:u(()=>g(e)),children:b?a.actApproachSent:a.actApproach})})}return m===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):m===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function sl({o:e}){const{t:a,doThumb:r,thumbOf:n}=D(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function ll({o:e}){const{lang:a}=D();return ge(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ze,{o:e}),t.jsx(Kt,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Qe(e.engine||"")," ",$e(e.engine||"",a)]})})}function cl({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:p,favIds:g,toggleFav:d,t:m}=D(),u=be(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],c=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,h=c<=0?0:c<=7?1:c<=30?2:3,v=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:b[h],x=g.has(e.id),C=k=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const y=k.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:y.left+Math.min(280,y.width/3),y:y.bottom}})};return t.jsxs(f.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" tzr":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:C,children:[t.jsx("span",{className:"pt",style:{"--c":v}}),t.jsx(Tr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:x?1:.35,padding:0,marginRight:4},onClick:k=>{k.stopPropagation(),d(e)},children:x?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(k=>k&&k!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:k=>{k.stopPropagation(),o({type:"acquirer",value:e.acquirer||""})},children:["← ",Wt(e.acquirer)]}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(dl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(ll,{o:e}),l.pipe&&t.jsx(Ia,{o:e}),l.pipe&&!a&&t.jsx(Ci,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Sr,{o:e}),l.showThumbs&&t.jsx(sl,{o:e})]}),r&&!a&&t.jsx(ul,{o:e})]})}function dl({o:e}){const{lang:a,caps:r}=D();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=jt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function pl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=D(),l=(u,b=!1)=>c=>{c.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),p=jt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ce(e),m=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),p&&t.jsx("span",{className:"oc-amt",children:p}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},children:[m?"✓":"✗"," ",t.jsx("b",{children:m?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Wt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Wt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Gt,{spec:e.card})})]})}function ul({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=D();return!i.pipe&&e.kind==="op"?t.jsx(pl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(ol,{o:e}),t.jsx(Ei,{o:e}),t.jsx(zi,{o:e}),t.jsx(jr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Ia,{o:e})})]}),e.card&&t.jsx(Gt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Qe(e.engine||"")," ",$e(e.engine||"",r)]}),ge(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ze,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function ml({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:l}=D();if(!i.pipe&&e.kind==="op"){const g=jt(e.amountEur,l),d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),m=(u,b=!1)=>c=>{c.stopPropagation(),b&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Gt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:m({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:m({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:m({stage:[e.stage]}),children:e.stage}),g&&t.jsx("span",{className:"damt",children:g})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Qe(e.engine||"")," ",$e(e.engine||"",l)]}),ge(e)&&t.jsx(Ze,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Sr,{o:e})})]})}const s=be(e),p=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" tzr":""),style:{"--c":p},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Ia,{o:e}),ge(e)&&t.jsx(Ze,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function fl(){const{t:e}=D(),[a,r]=f.useState(0);return f.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function hl({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=D(),o=i==="en",l=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),p=s.includes(0)?0:s.sort((d,m)=>(e[m]||0)-(e[d]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?o?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:o?`${g} ${g>1?"files":"file"} in “${l(p)}”`:`${g} dossier${g>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(o?"Open ":"Ouvrir ")+l(p)," →"]})]})}function xl(){var X;const e=D(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,lang:s,sessTally:p,data:g,dossiers:d,source:m}=e,u=i.lockRowsAfter!==null?Number.MAX_SAFE_INTEGER:m==="ops"?8:Qn,[b,c]=f.useState(new Set);f.useEffect(()=>{c(new Set)},[a.ptab,a.continent]);const[h,v]=f.useState(null);f.useEffect(()=>{v(null)},[a.ptab,a.continent]);const x=T=>c(R=>{const P=new Set(R);return P.has(T)?P.delete(T):P.add(T),P}),[C,k]=f.useState("all"),[y,w]=f.useState(!1);f.useEffect(()=>{k("all"),w(!1)},[a.ptab,a.continent]),f.useEffect(()=>{if(!y)return;const T=R=>{var P,B;(B=(P=R.target)==null?void 0:P.closest)!=null&&B.call(P,".atl2 .doable")||w(!1)};return document.addEventListener("click",T),()=>document.removeEventListener("click",T)},[y]);const z=Hs(),q=f.useMemo(()=>{var R;const T=new Map;for(const P of Ys(((R=z==null?void 0:z.ed)==null?void 0:R.html)||""))T.has(P.t)||T.set(P.t,P.html);return T},[(X=z==null?void 0:z.ed)==null?void 0:X.html]),M=f.useCallback(T=>{if(T.decryptHtml)return T.decryptHtml;if(!q.size)return;const R=(T.name||"").trim().toLowerCase();if(R.length<3)return;const P=q.get(R);if(P)return P;for(const[B,G]of q)if(B.includes(R)||R.includes(B))return G},[q]),E=f.useMemo(()=>{const T=Ra(l,a.sort);return C==="all"?T:T.filter(R=>C==="explore"?!!R.noCo:!R.noCo)},[l,a.sort,m,C]),F=f.useMemo(()=>E.filter(T=>ge(T)&&!Ce(T)).length,[E]),A=f.useMemo(()=>i.pipe?E:E.filter(T=>!Ce(T)&&!T.noCo),[E,i.pipe]),O=m==="ops"?E.filter(T=>T.noCo).length:0,_=i.pipe?n.plabels[a.ptab].toLowerCase():m==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,j=a.filters,N=[];if(j.day)N.push({k:"day",lib:n.fDay(j.day.slice(8,10)+"/"+j.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(j.win&&j.win!=="all"){const T=["1","7","30"].indexOf(j.win);T>=0&&N.push({k:"win",lib:n.dates[T],off:()=>r({type:"filters",patch:{win:"all"}})})}const L=T=>T.length<=2?T.join(", "):`${T.length} ${n.fSelected}`;for(const T of["sector","country","engine"]){const R=j[T];R&&R.length&&N.push({k:T,lib:L(R),off:()=>r({type:"clearFacet",facet:T})})}j.search&&N.push({k:"search",lib:"🔍 "+j.search,off:()=>r({type:"filters",patch:{search:""}})});const $=(T,R,P="",B=!1)=>t.jsxs("button",{type:"button","data-s":T,className:P,"aria-sort":a.sort.key===T?a.sort.dir===1?"ascending":"descending":"none",style:B?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:T}),children:[R,t.jsx("span",{className:"ar",children:a.sort.key===T&&a.sort.dir===1?"▴":"▾"})]},T),U=f.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const T=new Map;E.forEach(B=>{const G=B.engine||"?";T.has(G)||T.set(G,[]),T.get(G).push(B)});const R={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},P=ca([...T.keys()],s);return[...T.entries()].sort((B,G)=>{const K=R[B[0]]??10+P.indexOf(B[0]),se=R[G[0]]??10+P.indexOf(G[0]);return K-se})},[E,i.pipe,a.groupBy,s]),V=i.lockRowsAfter;let Q=0;const Y=(T,R)=>{let P=a.shown[R]||u;return T.length-P<=4&&(P=T.length),T.slice(0,P).map(K=>{const se=V!==null&&Q>=V;Q++;const le=M(K),J=le&&le!==K.decryptHtml?{...K,decryptHtml:le}:K,ee=a.dens!=="maxi"&&(a.dens==="deplie"||(h?h==="open":!!le)),he=b.has(K.id)?!ee:ee;return a.dens==="maxi"?t.jsx(ml,{o:J,locked:se},K.id):t.jsx(cl,{o:J,locked:se,open:he,onToggle:()=>x(K.id)},K.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:E.length})," ",_]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",N.map(T=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:R=>{R.stopPropagation(),T.off()},children:[T.lib,t.jsx("i",{children:"×"})]},T.k)),m==="ops"&&E.length>0&&" — "+n.edSplit(E.length-O,O)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||m==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([T,R])=>t.jsxs("button",{type:"button","data-d":T,"aria-pressed":a.dens===T||T==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:T}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:R})]},T))}),(i.showFunnel||m==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":h==="open",onClick:()=>{v("open"),c(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":h==="closed",onClick:()=>{v("closed"),c(new Set)},children:n.foldAllLbl}),m==="ops"&&t.jsxs("button",{type:"button","aria-pressed":h===null,onClick:()=>{v(null),c(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||m==="ops")&&(()=>{var P;const T=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],R=((P=T.find(([B])=>B===C))==null?void 0:P[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":y,onClick:()=>w(B=>!B),children:[R,t.jsx("i",{children:"▾"})]}),y&&t.jsx("div",{className:"dolist",children:T.map(([B,G])=>t.jsx("button",{type:"button","aria-pressed":C===B,onClick:()=>{k(B),w(!1)},children:G},B))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:T=>r({type:"sort",key:T.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([T,R])=>t.jsx("option",{value:T,children:R},T))})]}),i.showChain&&A.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:A.map(T=>T.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(A.length):n.chainAll(A.length)]})]}),F>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(F)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),$("country",n.colCountry),$("name",n.colCompany),$("amount",n.colAmount,"h-amt",!0),$("stage",n.colStage,"h-stade"),$("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&$("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(m==="ops"?" opsl":"")+(E.length?"":" list-empty"),children:[U?U.map(([T,R])=>t.jsxs(f.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Qe(T)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:$e(T,s)}),t.jsx("div",{className:"s",children:n.grpCount(R.filter(P=>!Ce(P)).length,R.length)})]})]}),Y(R,T)]},T)):Y(E,"pt"+a.ptab),g.loading&&!d.length&&t.jsx(fl,{}),!E.length&&!(g.loading&&!d.length)&&(i.pipe?t.jsx(hl,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const T=U||[["pt"+a.ptab,E]];let R=0,P=0;for(const[G,K]of T){P+=K.length;let se=a.shown[G]||u;K.length-se<=4&&(se=K.length),R+=Math.min(K.length,se)}const B=P-R;return B<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>T.forEach(([G,K])=>r({type:"more",group:G,by:K.length,base:u})),children:[t.jsx("span",{className:"more-label",children:n.more(B,B)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(R,P)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}})]})}function In(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function gl(e,a){const r=wo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function bl(e,a){const n=[a.head.split("|").map(In).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",gl(i,a.plabels),Yt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(In).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function vl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const yl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Pe({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function wl({o:e,qa:a}){const{t:r,lang:n,fund:i}=D(),o=(e.cribleStatus||"").trim().toUpperCase()||(Yt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=We(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Pe,{k:r.cdSector,v:e.sector}),t.jsx(Pe,{k:r.cdStage,v:e.stage}),t.jsx(Pe,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Pe,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Pe,{k:r.cdName,v:e.contactName}),t.jsx(Pe,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Pe,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Pe,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Pe,{k:r.cdAngle,v:e.angle}),t.jsx(Pe,{k:r.cdDetected,v:yl(e.date,n)})]}),p.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,g])=>g).map(([g,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:d})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function kl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=D(),[s,p]=f.useState({}),g=25,d=f.useMemo(()=>n.slice(0,g),[n]);f.useEffect(()=>{d.length&&ko(r,d.map(b=>b.name)).then(p)},[r,d]);const m=o.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),m&&typeof m.screened=="number"&&t.jsxs("p",{children:[u(m.screened)," ",e.funScreened(""),typeof m.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(m.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(m.screened/o.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(wl,{o:b,qa:s[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const jl=50;function $a({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=D(),[o,l]=f.useState(null),[s,p]=f.useState(!1),[g,d]=f.useState(""),[m,u]=f.useState(0),[b,c]=f.useState(""),[h,v]=f.useState(!1),x=f.useRef(null);f.useEffect(()=>()=>{x.current&&window.clearInterval(x.current)},[]);const C=async y=>{p(!0),d("");const w=await a();if(p(!1),w.ok){l(w);return}if(w.busy){d(i.alertPreviewBusy);return}if(!y){d(i.alertPreviewFail);return}u(jl),x.current=window.setInterval(()=>{u(z=>z>1?z-1:(x.current&&window.clearInterval(x.current),C(!1),0))},1e3)},k=async()=>{if(n||h)return;v(!0),c("");const y=await r();v(!1),c(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||m>0,onClick:()=>{C(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||h,onClick:()=>{k()},children:h?"…":i.alertTest})]}),m>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(m)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const ot="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ne({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=D();return ct.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Nl(){const{st:e}=D();switch(e.modal){case"chain":return t.jsx(Cl,{});case"space":return t.jsx(El,{});case"alert":return t.jsx(Al,{});case"queue":return t.jsx(Rl,{});case"export":return t.jsx(Ml,{});case"plug":return t.jsx(Pl,{});case"recharge":return t.jsx(Il,{});case"cover":return t.jsx(Bl,{});case"dossier":return t.jsx($l,{});case"crit":return t.jsx(_l,{});case"tuto":return t.jsx(Ul,{});case"rdv":return t.jsx(Sl,{});case"memoalert":return t.jsx(Ol,{});default:return null}}function Sl(){const{dispatch:e,fund:a}=D(),r=typeof document<"u"&&!!document.getElementById("rdv");return f.useEffect(()=>{r&&(e({type:"modal",modal:null}),bi())},[r,e]),r?null:t.jsx(So,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Cl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s,caps:p,memoQueued:g,doAnalyse:d}=D(),m=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,c=u[b],h=b>=u.length;return ct.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:h?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(h?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:h||!c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:c.name}),t.jsx("div",{className:"sub",children:[dt(c.cc,i)||c.countryLabel,c.sector,c.stage,n.daysAgo(He(c.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:$e(c.engine,i).toUpperCase()}),typeof c.amountEur=="number"&&c.amountEur>0&&t.jsx("span",{children:jt(c.amountEur,i)})]}),ge(c)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ze,{o:c,lg:!0})," ",t.jsx(Kt,{o:c,src:!0})]}),(c.tagline||c.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:c.tagline||c.headline})]}),c.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:c.reasoning})]}),m&&Ce(c)&&t.jsxs("div",{className:"vbox",style:{"--c":Ke(c)==="retenu"?"var(--brand)":Ke(c)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ke(c)==="retenu"?"✓ "+n.kept:Ke(c)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:c.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!h&&c&&p.pipe&&be(c)===1&&!g.has(c.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(c),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!h&&c&&!(m&&Ce(c))&&(c.noCo&&c.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:c.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(c)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(h?{type:"modal",modal:null}:{type:"chainNext"}),children:h?n.closeBtn:n.skip})]})]})})}),document.body)}function El(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=D(),o=i==="client",l=f.useMemo(()=>o?r.filter(m=>Ce(m)):[],[r,o]),s=f.useMemo(()=>Ra(l.filter(m=>Ke(m)==="retenu"),{key:"signal",dir:-1}),[l]),p=f.useMemo(()=>l.filter(m=>Ke(m)==="ecarte"),[l]),g=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ne,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(m=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof m.score=="number"&&m.score>0?m.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:m.name}),t.jsx("div",{className:"rr",children:m.reasoning||m.tagline||""})]})]},m.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Al(){const{mode:e}=D();return e==="client"||e==="apercu"?t.jsx(Tl,{}):t.jsx(Ll,{})}function Tl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=D(),[o,l]=f.useState("d"),s=i!=="client";return t.jsxs(Ne,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(zl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(ql,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(Cr,{})]})}function zl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=f.useState(null),[s,p]=f.useState(!1),[g,d]=f.useState(0);f.useEffect(()=>{let c=!0;return p(!1),en(a).then(h=>{c&&(h?l(h):p(!0))}),()=>{c=!1}},[a,g]);const m=c=>{r||en(a,c).then(h=>{if(!h){i(e.actErr);return}l(h),h.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(c=>c+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=c=>!o.sections||o.sections.includes(c),b=c=>{const h=o.sections||e.alertSec.map(([v])=>v);m({sections:u(c)?h.filter(v=>v!==c):[...h,c]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([c,h])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(c),disabled:r,onChange:()=>b(c)}),t.jsxs("span",{children:[h,c==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},c))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx($a,{label:e.alertPreview,readOnly:r,onPreview:()=>Ro(a),onTest:()=>Lo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function ql({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=f.useState(null),[s,p]=f.useState(!1),[g,d]=f.useState(0);f.useEffect(()=>{let c=!0;return p(!1),tn(a).then(h=>{c&&(h?l(h):p(!0))}),()=>{c=!1}},[a,g]);const m=c=>{r||tn(a,c).then(h=>{if(!h){i(e.actErr);return}l(h),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(c=>c+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,b=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:c=>m({dow:Number(c.target.value)}),children:e.alertDow.map((c,h)=>t.jsx("option",{value:h,children:c},c))}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx($a,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Oo(a),onTest:()=>Mo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Cr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=D(),[l,s]=f.useState(o||""),[p,g]=f.useState(!1),[d,m]=f.useState(!1);f.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,b=f.useMemo(()=>n.filter(x=>ge(x)).length,[n]),c=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,h=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){m(!0);try{await fetch(`${Aa}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{m(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[c]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(x=>$e(x,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(x=>dt(x,r)||x).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([x,C])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:x}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:C}})]},x))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:x=>s(x.target.value),onKeyDown:x=>{x.key==="Enter"&&h()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void h(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Ll(){const{t:e}=D();return t.jsx(Ne,{title:e.alertTitle,icon:"🔔",children:t.jsx(Cr,{})})}function Rl(){var C,k;const{t:e,token:a,fund:r,mode:n,flash:i}=D(),[o,l]=f.useState(null),[s,p]=f.useState([]),[g,d]=f.useState(0),m=n==="client";f.useEffect(()=>{let y=!0;return(async()=>{const[w,z]=await Promise.all([za(r),Vn(a)]);y&&(w&&l(w),p(z))})(),()=>{y=!1}},[a,r,g]);const u=(o==null?void 0:o.per_day)??0,b=((C=o==null?void 0:o.analyzed_today)==null?void 0:C.length)??0,c=o==null?void 0:o.offre,h=(o==null?void 0:o.pool_meta)||[],v=f.useMemo(()=>{const y=new Map;for(const w of(o==null?void 0:o.scheduled)||[])for(const z of w.names||[])y.has(z)||y.set(z,{label:w.day_label,date:w.date});return y},[o==null?void 0:o.scheduled]),x=(o==null?void 0:o.in_progress)||[];return t.jsxs(Ne,{title:e.queueTitle,wide:!0,children:[c&&t.jsxs("div",{className:"qoffre"+(c.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:c.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:c.delai})]}),t.jsx("span",{className:"osp"}),c.rythme>0?t.jsx("span",{className:"or",children:e.qRate(c.rythme)}):c.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(c.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(b,b+(((k=o==null?void 0:o.pool_order)==null?void 0:k.length)??0))}})}),c&&t.jsxs("div",{className:"qeta",children:[c.file===0?e.qEtaDone:c.rythme<=0?e.qEtaPaused:e.qEta(c.file,c.rythme,c.jours_restants),c.en_retard&&t.jsxs("em",{children:[" ",e.qLate(c.delai,c.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)}),(c==null?void 0:c.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsx("div",{className:"qrows",children:x.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.name}),t.jsxs("span",{className:"qd",children:[y.memo_type||"",y.age_min?` · ${Math.round(y.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:y.state||""})]},"ip-"+y.name))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),m&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Za(a,y.company,"retry").then(()=>d(w=>w+1))},children:e.queueRetry}),m&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Za(a,y.company,"delete").then(()=>d(w=>w+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(h.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[h.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),h.map((y,w)=>{const z=v.get(y.name);return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",w+1]}),z?t.jsx("span",{className:"qwhen"+(z.label==="demain"?" soon":""),children:z.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:y.name}),y.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score}),y.excerpt&&t.jsx("span",{className:"qex",children:y.excerpt})]},y.name+":"+w)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([y,w])=>t.jsxs("li",{children:[t.jsx("b",{children:y})," — ",w]},y))})]})}function Ml(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=D(),s=`${ot}/cibles/list.csv?token=${a}`,p=`${ot}/cibles/list.json?token=${a}`,g=`${ot}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,m=v=>{var x;(x=navigator.clipboard)==null||x.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:g,href:g}],b=!i.lockActions&&n.length>0,c=()=>{vl(bl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([x])=>x===v)||["",""])[1]})),r(e.exportViewDone(n.length))},h=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ne,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:h,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:c,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:x,href:C})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>m(x),children:e.exportCopy}),C&&t.jsx("a",{className:"exb",href:C,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Ol(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=D(),o=i!=="client",[l,s]=f.useState(null),[p,g]=f.useState(!1),[d,m]=f.useState(0),[u,b]=f.useState(!1);f.useEffect(()=>{let x=!0;return g(!1),Xa(a).then(C=>{x&&(C?s(C):g(!0))}),()=>{x=!1}},[a,d]);const c=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},h=x=>{if(o||!l)return;const C={enabled:x.enabled??!!l.enabled,email:x.email??(l.email||""),sections:x.sections??c()};b(!0),Xa(a,C).then(k=>{if(b(!1),!k){n(e.memoAlertErr);return}s(k),r(e.memoAlertSaved)})};if(p)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(x=>x+1),children:e.retry})]})});if(!l)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=c();return t.jsxs(Ne,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>h({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Fl,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:x=>h({email:x})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([x,C])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[x],disabled:o||u,onChange:()=>h({sections:{...v,[x]:!v[x]}})}),t.jsx("span",{children:C})]},x))}),t.jsx($a,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>No(a,v),onTest:()=>jo(a,v)})]})}function Fl({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=f.useState(e);f.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),p=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&s&&p&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>i(o.trim()),children:n})]})]})}function Pl(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=D(),[o,l]=f.useState(null),[s,p]=f.useState(!1),[g,d]=f.useState(null),[m,u]=f.useState(""),[b,c]=f.useState(0);f.useEffect(()=>{let k=!0;return p(!1),da(a).then(y=>{k&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),Ao(a).then(y=>{k&&d(y)}),()=>{k=!1}},[a,b]);const h=(k,y)=>{i&&da(a,k).then(w=>{if(!w||w.ok===!1){n(e.actErr);return}k.test&&w.sent===!1?n(e.plugTestThrottled):r(y),c(z=>z+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',x=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),C=`curl -X POST ${ot}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ne,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(k=>k+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:m,disabled:!i,onChange:k=>u(k.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!m.trim(),onClick:()=>h({url:m.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>h({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>h({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:x}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var k;(k=navigator.clipboard)==null||k.writeText(x).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Dl,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:C}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var k;(k=navigator.clipboard)==null||k.writeText(C).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var k;(k=navigator.clipboard)==null||k.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Dl(){const{t:e,token:a,lang:r}=D(),[n,i]=f.useState("valides"),[o,l]=f.useState(!1),[s,p]=f.useState(null),[g,d]=f.useState(null),[m,u]=f.useState(!1),[b,c]=f.useState(!1),[h,v]=f.useState(null),[x,C]=f.useState(null),[k,y]=f.useState(null),w=`atl2:bulk:${a}:${n}`;f.useEffect(()=>{da(a).then(O=>{C(O&&O.configured?O.url_hint||"webhook":null)})},[a]),f.useEffect(()=>{p(null),d(null),u(!1),v(null);try{const O=JSON.parse(localStorage.getItem(w)||"null");y(O&&Date.now()-Date.parse(O.t)<24*3600*1e3?O:null)}catch{y(null)}},[w]);const z=async()=>{l(!0),u(!1),v(null);const O=await zo(a,n);p(O),d(O.ok?n:null),l(!1)},q=f.useRef(!1),M=async()=>{if(q.current)return;q.current=!0,c(!0);const O=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await qo(a,n,"webhook",void 0,O)}finally{q.current=!1}if(c(!1),u(!1),v(_),_.ok&&(_.pushed||0)>0){const j={t:new Date().toISOString(),n:_.pushed||0};y(j);try{localStorage.setItem(w,JSON.stringify(j))}catch{}}},E=s!=null&&s.ok&&s.ready||0,F=!!(s!=null&&s.ok)&&g===n&&E>0&&!!x&&!k,A=k?new Date(k.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:O=>i(O.target.value),children:e.plugBulkTabs.map(([O,_])=>t.jsx("option",{value:O,children:_},O))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{z()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),k&&t.jsx("p",{className:"mnote",children:e.bulkLocked(A,k.n)}),!k&&!!(s!=null&&s.ok)&&!x&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!k&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),F&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),F&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(E,x||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{M()},children:b?e.bulkSending:e.bulkConfirm(x||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),h&&(h.ok?h.replayed?t.jsx("p",{className:"mnote",children:h.pending?e.bulkPending:e.bulkReplayed}):(h.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(h.pushed||0,h.linkedinReady||0,h.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:h.error||e.actErr}))]})}function Il(){const{t:e,data:a,lang:r}=D(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const g=await(await fetch(`${Aa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ne,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function $l(){const{t:e}=D();return t.jsx(Ne,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(kl,{})})}function Bl(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:s}=D(),[p,g]=f.useState(null),[d,m]=f.useState(!1);f.useEffect(()=>{let E=!0;if(o)return za(o).then(F=>{E&&F&&typeof F.per_day=="number"&&g(F.per_day)}),()=>{E=!1}},[o]);const[u,b]=f.useState(null);f.useEffect(()=>{if(!i)return;let E=!0;return Eo(i).then(F=>{E&&b(F)}),()=>{E=!1}},[i]);const c=r.stats,h=typeof(c==null?void 0:c.screened)=="number"?c.screened:n.filter(E=>E.kind==="target"&&Ce(E)).length,v=r.marketEstimate||0,x=v>0?Math.min(100,Math.round(h/v*100)):null,C=(c==null?void 0:c.window_days)||30,k=h>0?h/C:0,y=v>0?Math.max(0,v-h):0,z=v>0&&k>0&&h>=100?Math.round(y/k):null,q=E=>Math.round(E).toLocaleString(a==="en"?"en-US":"fr-FR"),M=E=>{d||!l||(m(!0),To(i,E).then(F=>{if(m(!1),F===null){s(e.actErr);return}g(F),s(e.alertSaved)}))};return t.jsxs(Ne,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(q(h))}),v>0&&t.jsx("span",{children:e.covOf(q(v))})]}),x!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:x+"%"}}),t.jsxs("em",{children:[x," %"]})]}),z!==null&&t.jsx("p",{className:"mnote",children:e.covEta(z)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),k>=1&&t.jsx("p",{className:"mnote",children:e.covPace(q(k))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsx("table",{children:t.jsxs("tbody",{children:[(u.detail||[]).map((E,F)=>t.jsxs("tr",{className:E.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[E.code,E.geo?` · ${E.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof E.n=="number"?q(E.n):"—"}),t.jsxs("td",{className:"cs",children:[E.source,E.elargi&&t.jsxs("em",{children:[" · ",e.covWide(String(E.demande||""))]}),E.erreur&&t.jsxs("em",{children:[" · ",e.covMissing]})]})]},F)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:q(u.total||v)})}),t.jsx("td",{className:"cs"})]})]})}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),c&&t.jsxs("div",{className:"covf",children:[typeof c.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(c.kept)})," ",e.covKept]}),typeof c.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(c.analyzed)})," ",e.covAna]}),typeof c.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(c.shown)})," ",e.covShown]})]}),l&&p!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(p)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(E=>t.jsx("button",{type:"button",className:p===E?"on":"",disabled:d,onClick:()=>M(E),children:E===0?"⏸":E},E))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function _l(){var x,C,k;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:s}=D(),p=n==="client",g=f.useMemo(()=>{const y=new Set;return a.forEach(w=>{w.angle&&y.add(w.angle)}),[...y]},[a]),[d,m]=f.useState(""),[u,b]=f.useState(""),[c,h]=f.useState(!1),v=async()=>{const y=d.trim();if(!(!y||c||!p)){h(!0),b("");try{const z=await(await fetch(`${ot}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(z.reply&&b(String(z.reply)),z.job_id){b(e.critChatRunning);const q=async()=>{const M=await fetch(`${ot}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:z.job_id})}).then(E=>E.json()).catch(()=>null);if(M&&M.done){b(String(M.reply||M.clarification||M.summary||"✓")),h(!1),M.applied&&i(e.alertSaved);return}setTimeout(()=>{q()},8e3)};setTimeout(()=>{q()},8e3),m("");return}m("")}finally{u.startsWith("⏳")||h(!1)}}};return t.jsxs(Ne,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((x=o.points)!=null&&x.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((C=o==null?void 0:o.angles)!=null&&C.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var w,z;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((w=y.look)!=null&&w.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(q=>t.jsx("li",{children:q},q))})]}),!!((z=y.out)!=null&&z.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(q=>t.jsx("li",{children:q},q))})]})]})]},y.title)})]}),!!((k=o==null?void 0:o.gate)!=null&&k.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!p||c,onChange:y=>m(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},disabled:!p||c||!d.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Co,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,w])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Nr[y]||"v-cons"),children:y}),t.jsx("span",{children:w})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,w])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",w]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Ul(){const{t:e,dispatch:a,startTour:r}=D(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ne,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const Er="atl2:mapfold",Vl=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Er);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Ar=f.createContext(null),D=()=>{const e=f.useContext(Ar);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ze({o:e,lg:a}){const{lang:r}=D(),n=ge(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:an(n,r),children:[n.emoji," ",an(n,r)]}):null}function Kt({o:e,src:a}){const{lang:r,t:n}=D(),i=ge(e);if(!i)return null;const o=$o(i),l=Bo(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Yn(i,r))+" · "+n.win7(Gn(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<o?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Tr({o:e}){const{lang:a}=D(),r=Io(e.cc),n=e.cc?dt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const $n="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Hl=!1,zr=e=>`atl2:tour:${e||"anon"}`;function Wl(e){try{return localStorage.getItem(zr(e))==="1"}catch{return!0}}function Bn(e){try{localStorage.setItem(zr(e),"1")}catch{}}function Yl(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Zl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var _a;const{lang:l}=Fo(),s=Qo[l],p=li(e,l,a),[g,d]=f.useReducer(di,void 0,()=>ci((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Vl(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),m=f.useRef(!0);f.useEffect(()=>{if(m.current){m.current=!1;return}if(!e)try{localStorage.setItem(Er,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e]);const u=f.useRef(o);u.current=o,f.useEffect(()=>{var S;(S=u.current)==null||S.call(u,g.filters)},[g.filters]);const[b,c]=f.useState(null),[h,v]=f.useState(null),[x,C]=f.useState({kept:0,dropped:0}),[k,y]=f.useState(!1),[w,z]=f.useState(""),[q,M]=f.useState(!1),[E,F]=f.useState(null),[A,O]=f.useState(!1),[_,j]=f.useState(!1),[,N]=f.useState(0),L=()=>N(S=>S+1),$=f.useRef([]),U=f.useRef(new Set),V=f.useRef(new Set),Q=f.useRef(new Map),Y=f.useRef(null),{mode:X}=p,T=f.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[p.caps,i,a]),R=T.pipe,P=p.session.token||"",B=X==="client"&&!e;f.useEffect(()=>{if(document.querySelector(`link[href="${$n}"]`))return;const S=document.createElement("link");S.rel="stylesheet",S.href=$n,document.head.appendChild(S)},[]);const G=(S,H=!1)=>{z(S),M(H),Y.current&&clearTimeout(Y.current),Y.current=setTimeout(()=>z(""),H?4200:2400)},K=S=>G(S,!0),se=f.useMemo(()=>{const S=new Map;return p.dossiers.forEach(H=>{H.id&&S.set(H.id,H)}),S},[p.dossiers]),le=f.useMemo(()=>p.dossiers.filter(S=>Jn(S,g,R)),[p.dossiers,g,R]),J=f.useRef(!1);f.useEffect(()=>{if(J.current||e||p.loading||!p.dossiers.length)return;if(!T.showFunnel||Wl(p.session.token||"")){J.current=!0;return}J.current=!0;const S=window.setTimeout(()=>{Bn(p.session.token||""),O(!0)},700);return()=>window.clearTimeout(S)},[e,p.loading,p.dossiers.length,T.showFunnel,p.session.token]);const ee=f.useMemo(()=>p.dossiers.filter(S=>pi(S,g,R,p.favIds)),[p.dossiers,g,R,p.favIds]),he=f.useMemo(()=>Po(le,p.favIds),[le,p.favIds]),te=f.useMemo(()=>{const S=tr(p.dossiers);return S?He(S)===0?s.tourToday:ar(S,l):s.tourNoRun},[p.dossiers,s,l]),ce=f.useMemo(()=>p.dossiers.some(S=>!!S.memoUrl||!!S.summary||it(S)),[p.dossiers]),[ne,Oe]=f.useState(!1);f.useEffect(()=>{if(p.loading){Oe(!1);return}if(p.dossiers.length>0||p.error){Oe(!0);return}const S=window.setTimeout(()=>Oe(!0),6e3);return()=>window.clearTimeout(S)},[p.loading,p.dossiers.length,p.error]);const xe=(p.marketEstimate||0)>0||typeof((_a=p.stats)==null?void 0:_a.screened)=="number"&&p.stats.screened>0,ye=f.useMemo(()=>[1,0,2,4,5,3].find(S=>(he[S]||0)>0)??0,[he]),Re=qa.find(S=>S.key===g.continent),tt=g.continent==="monde"?s.contWorld:(l==="fr"?Re==null?void 0:Re.fr:Re==null?void 0:Re.en)||"";f.useEffect(()=>{const S=H=>{var me;const W=(((me=H.detail)==null?void 0:me.name)||"").trim();W&&Ee(null,W)};return window.addEventListener("ppmap:evaluate",S),()=>window.removeEventListener("ppmap:evaluate",S)}),f.useEffect(()=>{const S=me=>{const Me=String(me||"").trim();Me&&d({type:"filters",patch:{sector:[Me]}})},H=me=>{var Me;return S((Me=me.detail)==null?void 0:Me.sector)},W=me=>{me.data&&me.data.type==="pp-filter"&&S(me.data.sector)};return window.addEventListener("ppmap:filter",H),window.addEventListener("message",W),()=>{window.removeEventListener("ppmap:filter",H),window.removeEventListener("message",W)}},[]);const Ee=(S,H)=>{const W=((S==null?void 0:S.name)||H||"").trim();if(!B){v({kicker:W});return}!W||k||(y(!0),(async()=>{try{let me=W;const Me=((S==null?void 0:S.website)||(S==null?void 0:S.domain)||"").trim();if(Me)me=Me;else try{const fe=await _o(W);if(fe!=null&&fe.website)me=fe.website;else if(((fe==null?void 0:fe.candidates)||[]).length===1)me=fe.candidates[0].url;else if(((fe==null?void 0:fe.candidates)||[]).length>1){$.current=[{name:W,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(fe.candidates||[]).slice(0,5)},...$.current].slice(0,8),L();return}}catch{}const Fe=await Wn(P,me,"atelier2"),Pr={name:Fe.company||W,verdict:Fe.verdict,reason:Fe.reason||"",remaining:Fe.remaining??null};$.current=[Pr,...$.current].slice(0,8),Fe.verdict==="kept"&&C(fe=>({...fe,kept:fe.kept+1})),Fe.verdict==="ruled_out"&&C(fe=>({...fe,dropped:fe.dropped+1}));const ut=S||p.dossiers.find(fe=>(fe.name||"").toLowerCase()===W.toLowerCase());ut&&(Fe.verdict==="kept"?ut.verdict=ut.verdict||"MATCH":Fe.verdict==="ruled_out"&&(ut.verdict="NO MATCH"),Fe.reason&&(ut.reasoning=Fe.reason)),L()}finally{y(!1)}})())},Be=S=>{if(!B){v({kicker:S.name});return}U.current.add(S.id),mt(P,"fast_request",S.name||"",""),G(s.memoInstantSent(S.name)),L()},pt=S=>Q.current.get(S.id)??p.thumbs.get((S.name||"").trim().toLowerCase()),Nt=(S,H)=>d({type:"undoPush",entry:{id:S.id,name:S.name,prevCeoStatus:H}}),at=async(S,H,W)=>{const me=S.ceoStatus||"";S.ceoStatus=H,L();const Me=await Zt(P,{status:H,airtable_id:S.airtableId,check_id:S.checkId,company:S.name,...(W==null?void 0:W.note)!==void 0?{note:W.note}:{},...W!=null&&W.via?{via:W.via}:{}});return Me.ok?Me.skipped?(S.ceoStatus=me,L(),K(s.actNotPersisted),!1):((W==null?void 0:W.undo)!==!1&&Nt(S,me),W!=null&&W.msg&&G(W.msg),(H==="Validé"||H==="Écarté")&&!S.ceoNote&&(W==null?void 0:W.note)===void 0&&F({o:S,yes:H==="Validé"}),!0):(S.ceoStatus=me,L(),K(s.actErr),!1)},I=async(S,H)=>{const W=await Zt(P,{status:S.ceoStatus||"Retenu",airtable_id:S.airtableId,check_id:S.checkId,company:S.name,note:H,via:"note"});return!W.ok||W.skipped?(K(W.skipped?s.actNotPersisted:s.actErr),!1):(S.ceoNote=H,L(),!0)},ae=f.useRef(new Map),oe=S=>ae.current.has(S.id)?ae.current.get(S.id):p.stages.get((S.name||"").trim().toLowerCase()),we=(S,H)=>{ae.current.set(S.id,H),L()},Ve=(S,H)=>{B&&at(S,H?"Validé":"Écarté",{msg:H?s.decidedYes(S.name):s.decidedNo(S.name)})},je=S=>{B&&at(S,"À trancher",{msg:s.promoted(S.name)})},de=S=>{B&&(async()=>{const H=S.ceoStatus||"";S.ceoStatus="Retenu",L();const W=await Zt(P,{status:"Retenu",check_id:S.checkId,company:S.name});if(!W.ok||W.skipped){S.ceoStatus=H,L(),K(W.skipped?s.actNotPersisted:s.actErr);return}Nt(S,H),G(s.repeched(S.name))})()},Ae=()=>{const S=g.undo[g.undo.length-1];if(!S){G(s.undoNone);return}const H=se.get(S.id);if(!H){d({type:"undoPop"}),G(s.undoNone);return}let W=S.prevCeoStatus;if(!W)if((H.verdict||"").toUpperCase().includes("CALL"))W="À trancher";else{G(s.undoLockedTitle);return}(async()=>await at(H,W,{undo:!1})&&(d({type:"undoPop"}),H.ceoStatus=S.prevCeoStatus,L(),G(s.undoDone(H.name))))()},Qt=S=>{B&&(V.current.add(S.id),L(),(async()=>{const H=await Uo(P,S.name,"email");if(!H||H.ok===!1){V.current.delete(S.id),L(),K(s.actErr);return}mt(P,"approach",S.name||"",""),G(s.actApproachSent)})())},St=(S,H)=>{B&&(async()=>{if(!(await mt(P,H?"yes":"no",S.name||"","")).ok){K(s.actErr);return}Q.current.set(S.id,H?"yes":"no"),L(),G(H?s.thumbUpDone:s.thumbDnDone)})()},qr=S=>{!B||!it(S)||(mt(P,"detailed_request",S.name||"",""),G(s.memoDeepSent(S.name)))},Lr=S=>{const H=new Set(p.favIds),W=H.has(S.id);W?H.delete(S.id):H.add(S.id),p.setFavIds(H),B&&Vo(P,{id:S.id,co:S.name},W)},Rr=()=>{!B||_||window.confirm(s.identSyncConfirm)&&(j(!0),(async()=>{const S=await Ho(P);j(!1),S?G(s.identSyncDone):K(s.actErr)})())},Ba=/proplace/i.test(p.fund||""),Mr=S=>{!B||!Ba||(mt(P,"onboard_request",S.name||"",""),G(s.onboardSent(S.name)))},Or={st:g,dispatch:d,t:s,lang:l,mode:X,caps:T,pipe:R,token:P,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:de,thumbOf:pt,canWrite:B,commitStatus:at,saveNote:I,stageOf:oe,setStage:we,flashErr:K,startTour:()=>O(!0),dossiers:p.dossiers,scopedAll:le,scoped:ee,counts:he,byId:se,contName:tt,favIds:p.favIds,toggleFav:Lr,askEvaluate:Ee,doAnalyse:Be,doDecide:Ve,doPromote:je,doApproach:Qt,doThumb:St,doDeep:qr,doUndo:Ae,doSync:Rr,doOnboard:Mr,outbound:Ba,memoQueued:U.current,approachDone:V.current,sessTally:x,evalCards:$.current,evalBusy:k,markRow:c,markedId:b,flash:G};f.useEffect(()=>{const S=H=>{H.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",S),()=>window.removeEventListener("keydown",S)},[]);const Fr=S=>P?t.jsx(Ks,{token:P,children:S}):t.jsx(t.Fragment,{children:S});return t.jsx(Ar.Provider,{value:Or,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Zo}),T.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:Zn,children:Ma}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Pt}`,children:Pt})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),Fr(t.jsxs("div",{className:"app"+(R?" pipe":"")+(P?" has-thesis":""),children:[T.showTicker&&t.jsx(ve,{name:"live",children:t.jsxs("div",{className:"live-stack"+(P?" live-stack--cibles":""),children:[t.jsx(xi,{}),!!P&&t.jsx(Qs,{})]})}),T.showIdent&&t.jsx(ve,{name:"identite",children:t.jsx(Ri,{})}),!!P&&t.jsx(ve,{name:"lead",children:t.jsx(Gs,{})}),!!P&&t.jsx(ve,{name:"brief",children:t.jsx(Js,{})}),Hl,T.showMorning&&t.jsx(ve,{name:"matin",children:t.jsx(Li,{})}),t.jsx(ve,{name:"fraicheur",children:t.jsx(ji,{})}),t.jsx(ve,{name:"mesure",children:t.jsx(Ni,{})}),T.showFunnel&&t.jsx(ve,{name:"entonnoir",children:t.jsx(Gl,{})}),T.showFunnel&&t.jsx(ve,{name:"tunnel",children:t.jsx(Oi,{})}),T.showFunnel&&t.jsx(ve,{name:"tuto",children:t.jsx(Pi,{})}),t.jsx(ve,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Kl,{}),t.jsxs("div",{className:"stage"+(g.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(Ms,{}),t.jsx(Fs,{})]})]})}),T.showDemand&&t.jsx(ve,{name:"evaluation",children:t.jsx(_s,{})}),T.showDemand&&g.memoConsole&&t.jsx(ve,{name:"console",children:t.jsx(Vs,{})}),t.jsx(ve,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(xl,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),g.popupId&&t.jsx(ve,{name:"fiche",children:t.jsx(el,{})}),t.jsx(ve,{name:"modales",children:t.jsx(Nl,{})}),t.jsx(yi,{}),E&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:E.o.name}),t.jsx(Ti,{placeholder:E.yes?s.whyYesPh:s.whyNoPh,onDone:S=>{const H=E.o;F(null),S&&I(H,S).then(W=>{W&&G(s.csNoteSaved)})}})]}),A&&ne&&t.jsx(qi,{steps:Yl(s,te,ce,ye,xe),onClose:()=>{O(!1),Bn(P)}}),w&&t.jsx("div",{className:"flash on"+(q?" err":""),children:w}),h&&t.jsx(Do,{variant:"acquirer",initialCompany:_n().co,initialWebsite:_n().site,onClose:()=>v(null)})]})})}function Gl(){const{t:e}=D(),[a,r]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Kl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:i,t:o}=D(),l=f.useMemo(()=>{const s={};return e.forEach(p=>{La(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[Wo.map(s=>{const p=qa.find(d=>d.key===s),g=s==="monde"?o.contWorld:i==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[g,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function _n(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ql(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Tr as FlagCell,Ze as SigBadge,Kt as SigWin,Zl as default,Ql as fmtShort,D as useV2};
