...
`,Vi=Ui+Hi;function Ba(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Wi(){const e=Ba("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Yi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Wi();return r==="0"?"client":r==="1"||Ba("embed")==="1"&&Ba("chrome")==="1"?"apercu":"client"}const Gi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ki=e=>Gi[e];function ua(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const ft=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!kr(a)||ua(a))&&(e.noCo=!0)}return Object.assign(e,{continent:qo(e.cc)})};function Ca(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Qi=60*60*1e3;function Ji(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Qi?null:a}catch{return null}}function Xt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Xi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Zi(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:wo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Yi(e,i),[e,i,n]),l=m.useMemo(()=>Ki(o),[o]),d=o!=="visiteur",c=Xi(r),[f,s]=m.useState([]),[x,u]=m.useState(""),[g,p]=m.useState(null),[b,y]=m.useState(null),[h,N]=m.useState(null),[E,w]=m.useState(()=>new Map),[A,L]=m.useState(()=>new Map),[T,C]=m.useState(""),[S,j]=m.useState(new Set),[M,D]=m.useState(null),[O,_]=m.useState(!0),[v,q]=m.useState(!1),[H,U]=m.useState(0),[$,V]=m.useState(0),K=m.useRef(0),Q=m.useMemo(()=>{var ae;if(o!=="client")return"";try{return((ae=ko())==null?void 0:ae.email)||""}catch{return""}},[o]);m.useEffect(()=>{const ae=++K.current;let be=!0;const G=()=>be&&ae===K.current,pe=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),oe=Ji(pe);return oe?(s(oe.objs.map(ft)),oe.fund&&u(oe.fund),p(oe.marketEstimate??null),y(oe.criteria??null),N(oe.stats??null),C(oe.generatedAt||""),_(!1)):_(!0),(async()=>{try{if(r==="ops"){const we=await Sa(),me=((we==null?void 0:we.recent_ops)||[]).map(Z=>{const ee=la(Z.company_name||Z.title?Z:{...Z,title:(Z.headline_fr||Z.headline||"").slice(0,120)},a),J=String(Z.rubrique||"").toLowerCase();return ee&&(J==="nominations"||J==="recrutements")&&(ee.engine=J),ee&&!String(Z.company_name||"").trim()&&(ee.noCo=!0),ee}).filter(Z=>!!Z).map(Z=>(kr((Z.name||"").trim())||(Z.noCo=!0),Z));try{const Z=jo(),ee=Z&&Z.doc||await No(),J=So(ee),te=((Z==null?void 0:Z.day)||(ee==null?void 0:ee.date)||"").slice(0,10);if(te&&J.length){const xe=new Set;for(const W of me){if((W.date||"").slice(0,10)!==te)continue;const ue=Nn(J,xe,W.name,"");ue>=0&&(xe.add(ue),W.decryptHtml=J[ue].html)}for(const W of me){if(W.decryptHtml||(W.date||"").slice(0,10)!==te)continue;const ue=Nn(J,xe,"",W.headline||W.tagline||W.name);ue>=0&&(xe.add(ue),W.decryptHtml=J[ue].html)}}if(te){const xe=((ee==null?void 0:ee.title_fr)||"").trim(),W=((ee==null?void 0:ee.lead_fr)||"").trim(),ue=Eo(ee),ie=((ee==null?void 0:ee.url)||"").trim();xe&&ue&&me.unshift({id:`edito:${te}`,kind:"op",name:xe,cc:null,date:te,engine:"edito",dealKind:"other",headline:W||xe,tagline:W||xe,decryptHtml:ue,url:ie,noCo:!0})}}catch{}if(!G())return;s(me.map(ft)),Xt(pe,{objs:me})}else if(typeof r=="object"){const me=(await Sn()||[]).filter(ee=>(ee.slug||"")===r.research).map(ee=>En(ee,a)).filter(ee=>!!ee),Z=Ca(await Cn(me,a));if(!G())return;s(Z.map(ft)),Xt(pe,{objs:Z})}else if(d&&i.token){const we=Co(i.token),me=Sa(),Z=zo(i.token),ee=Ao(i.token),J=To(i.token),te=await we;let xe=te?te.targets:[];G()&&te&&(u(te.fund||""),p(te.marketEstimate??null),y(te.criteria??null),N(te.stats??null),C(te.generatedAt||""),s(xe.map(ft)),_(!1),q(!1));const[W,ue,ie,he]=await Promise.all([me,Z,ee,J]),Oe=((W==null?void 0:W.recent_ops)||[]).map(qe=>la(qe,a)).filter(qe=>!!qe);if(xe=[...xe,...Oe],!G())return;s(xe.map(ft));const $e=new Set;for(const qe of ue){const He=(qe.id||qe.co||"").toString().trim().toLowerCase();He&&$e.add(He.startsWith("t:")?He:"t:"+He)}j($e),w(ie),L(he),te&&Xt(pe,{fund:te.fund,marketEstimate:te.marketEstimate,criteria:te.criteria,stats:te.stats,generatedAt:te.generatedAt,objs:xe})}else{const we=Lo(),me=Sn(),Z=Sa(),ee=await we;G()&&ee.length&&(s(Ca(ee).map(ft)),_(!1),q(!1));const[J,te]=await Promise.all([me,Z]),xe=(J||[]).map(he=>En(he,a)).filter(he=>!!he),W=await Cn(xe,a),ue=((te==null?void 0:te.recent_ops)||[]).map(he=>la(he,a)).filter(he=>!!he),ie=Ca([...ee,...W,...ue]);if(!G())return;s(ie.map(ft)),Xt(pe,{objs:ie})}G()&&q(!1)}catch{G()&&!oe&&q(!0)}finally{G()&&_(!1)}})(),()=>{be=!1}},[d,i.token,a,H,c]),m.useEffect(()=>{if(!l.showCredits||!Q){D(null);return}let ae=!0;return(async()=>{try{const be=await fetch(`${rn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Q})});if(!be.ok)return;const G=await be.json();ae&&G&&G.ok!==!1&&D(G)}catch{}})(),()=>{ae=!1}},[l.showCredits,Q,$]);const le=m.useCallback(ae=>j(new Set(ae)),[]);return{session:i,mode:o,caps:l,fund:x,email:Q,marketEstimate:g,generatedAt:T,criteria:b,stats:h,thumbs:E,stages:A,dossiers:f,favIds:S,setFavIds:le,credits:M,reloadCredits:()=>V(ae=>ae+1),loading:O,error:v,refresh:()=>U(ae=>ae+1)}}function gt(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Er=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),es=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Er(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ts=new Set(["signal","amount","score","crible","memo"]);function as(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Er(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ts.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Cr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Cr=80;function ma(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Le(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(on(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(pt(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&ht(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function zr(e,a,r){return gt(e)?ma(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ma(e,a.filters,r)}function ns(e,a,r,n){return!(!zr(e,a,r)||r&&!Mo(e,a.ptab,n))}function cn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-pt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Fo(i);case"memo":return Ro(i);case"signal":{const o=Le(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const za={},Pn=(za==null?void 0:za.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Dn(){return new Date().toISOString().slice(0,10)}const pn=m.createContext(null);function Ar(){return m.useContext(pn)}function rs(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const f=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(c.setAttribute("href",f),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function In(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Tr(){const e=m.useContext(pn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function os({token:e,children:a}){const{dispatch:r,st:n,lang:i}=I(),[o,l]=m.useState(()=>n.filters.day||Dn()),[d,c]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l(Dn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=y=>{var N;const h=(N=y.detail)==null?void 0:N.day;typeof h=="string"&&x(h)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${Pn}/cibles/edition.json?${y}`).then(h=>h.json()).then(h=>{b||c(h)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const g=m.useMemo(()=>`${Pn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:d,loading:f,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:g,isEn:i==="en"}),[e,o,d,f,x,u,n.filters.day,g,i]);return t.jsx(pn.Provider,{value:p,children:a})}function is(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Tr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:In(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:In(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const ls=300,Zt=7,ds={fr:{ma:"M&A",levees:"Levées de fonds",nominations:"Nominations",recrutements:"Offres d'emploi",actualites:"Autres actualités"},en:{ma:"M&A",levees:"Fundraising",nominations:"Appointments",recrutements:"Job offers",actualites:"Other news"}},Lr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},cs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Aa(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if($o(r)&&r!=="media")return"news:"+r;const n=Le(e);return n?"sig:"+(n.theme&&Lr.fr[n.theme]?n.theme:"other"):"actualites"}function ps(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:d}=I(),c=Ar(),f=l==="en",[s,x]=m.useState("all"),[u,g]=m.useState(!1),p=m.useMemo(()=>{var be;const v=(a.filters.day||"").slice(0,10),q=G=>!(!o&&a.continent!=="monde"&&G.continent!==a.continent||v&&(G.date||"").slice(0,10)!==v),H=e.filter(G=>q(G)&&Le(G)&&(!o||G.kind!=="target"||ze(G)!==5)),U=o&&(((be=c==null?void 0:c.ed)==null?void 0:be.ops)||[]).length?c.ed.ops.map(G=>la(G,l)).filter(G=>!!G).filter(G=>!v||(G.date||"").slice(0,10)===v):[],$=e.filter(G=>q(G)&&G.kind==="op"&&(v?!0:pt(G.date)<=Zt)),V=o?U.length?U:$.filter(G=>{const pe=(d||"").trim().toLowerCase();if(!pe)return!1;const oe=G.match||null;return oe?Object.keys(oe).map(we=>we.trim().toLowerCase()).includes(pe):!1}):$,K=v||new Date().toISOString().slice(0,10),Q=G=>{const pe=Aa(G);return pe==="ma"?0:pe==="levees"?1:2};V.sort((G,pe)=>{const oe=Q(G)-Q(pe);if(oe)return oe;const we=(G.date||"").slice(0,10)===K?0:1,me=(pe.date||"").slice(0,10)===K?0:1;return we!==me?we-me:(pe.amountEur||0)-(G.amountEur||0)});const le=new Set,ae=[];for(const G of[...V,...cn(H,{key:"signal",dir:-1})]){const pe=G.id||G.name;!pe||le.has(pe)||(le.add(pe),ae.push(G))}return o&&ae.length===0?e.filter(pe=>q(pe)&&pt(pe.date)<=Zt).sort((pe,oe)=>(oe.date||"").localeCompare(pe.date||"")).slice(0,80):ae},[e,a.continent,a.filters.day,o,d,l,c]),b=m.useMemo(()=>{const v={};for(const q of p){const H=Aa(q);v[H]=(v[H]||0)+1}return v},[p]),y=m.useMemo(()=>s==="all"?p:p.filter(v=>Aa(v)===s),[p,s]),h=m.useMemo(()=>y.slice(0,ls),[y]),N=y.length-h.length,E=m.useRef(null);m.useEffect(()=>{var V,K;const v=E.current;if(!v)return;const q=()=>{const Q=v.scrollWidth;Q<200||(v.style.animationDuration=Math.max(18,Math.round(Q/130))+"s")};q();const H=requestAnimationFrame(q),U=window.setTimeout(q,1200);let $=!0;return(K=(V=document.fonts)==null?void 0:V.ready)==null||K.then(()=>{$&&q()}),()=>{$=!1,cancelAnimationFrame(H),window.clearTimeout(U)}},[h.length,s]);const w=v=>v==="all"?p.length:b[v]||0,A=v=>{if(v==="all")return f?"All":"Tout";if(v.startsWith("sig:"))return Lr[f?"en":"fr"][v.slice(4)]||"🔔";if(v.startsWith("news:")){const q=v.slice(5);return Do[q]?Io(q,f?"en":"fr"):v}return ds[f?"en":"fr"][v]},L=[{k:"all"}],T=["ma","levees"].filter(v=>w(v)>0||v===s);if(T.length){L.push({g:f?"Deals":"Opérations"});for(const v of T)L.push({k:v})}const C=["nominations","recrutements"].filter(v=>w(v)>0||v===s),S=Po.filter(v=>v!=="media").map(v=>"news:"+v).filter(v=>w(v)>0||v===s),j=w("actualites")>0||s==="actualites"?["actualites"]:[];if(C.length||S.length||j.length){L.push({g:f?"News":"Actualités"});for(const v of C)L.push({k:v});for(const v of S)L.push({k:v});for(const v of j)L.push({k:v})}const M=cs.map(v=>"sig:"+v).filter(v=>w(v)>0||v===s);if(M.length){L.push({g:f?"Signals (your engines)":"Signaux (vos moteurs)"});for(const v of M)L.push({k:v})}const D=v=>{try{return new Date(v+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return v}},O=(()=>{const v=(a.filters.day||"").slice(0,10),q=!o&&a.continent!=="monde"&&i?f?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return v?(f?`LIVE covers the events of ${D(v)}.`:`Le LIVE regroupe les événements du ${D(v)}.`)+q:(f?`LIVE covers the still-open signals and the deals of the last ${Zt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Zt} derniers jours.`)+q})(),_=v=>h.map(q=>t.jsxs("button",{type:"button",className:"tk"+(De(q)?" spent":""),onClick:H=>{if(n({type:"focus",id:q.id}),a.dens!=="liste"){const U=H.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:U.left+U.width/2,y:U.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(wt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(po,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Dd(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(ja,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},v+(q.id||q.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},v+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:v=>{v.currentTarget.contains(v.relatedTarget)||g(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>g(v=>!v),children:[A(s),t.jsx("b",{children:w(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:O}),L.map(v=>"g"in v?t.jsx("span",{className:"tkfilg",children:v.g},v.g):t.jsxs("button",{type:"button","aria-pressed":v.k===s,onClick:()=>{x(v.k),g(!1)},children:[A(v.k),t.jsx("b",{children:w(v.k)})]},v.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:E,children:[_(0),_(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!c&&t.jsx(ms,{isEn:f})]})}const us=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function ms({isEn:e}){const[a,r]=m.useState(()=>Bo());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(zn,i),()=>window.removeEventListener(zn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>_o(!a),children:us})}const un="+33 6 83 10 72 86",fa="alexandre@proplace.co",qr=`tel:${un.replace(/[^\d+]/g,"")}`;function fs(){return null}class Re extends m.Component{constructor(){super(...arguments);kn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Ta=600,xt=62,$n="atl2:fstats";function xs(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=I(),[l,d]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem($n)==="on"}catch{return!1}}),c=r.stats,f=m.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const x=A=>a==="en"?A.slice(5,10):`${A.slice(8,10)}/${A.slice(5,7)}`,u=A=>A.toLocaleString(a==="en"?"en-US":"fr-FR"),g=f.reduce((A,L)=>Math.max(A,L.s||0),0),p=f.length?Ta/f.length:0,b=Math.max(4,p-4),y=f.length>=5&&g>0,h=r.marketEstimate||0,N=x(new Date().toISOString().slice(0,10)),E=A=>[...typeof A=="number"?[[A,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&s&&w.push({cle:"fenetre",periode:e.funPerWindow(x(s),N),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:E(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[w.map(A=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:A.periode}),A.etapes.map(([L,T],C)=>t.jsxs("span",{className:"fst-t",children:[C>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(L)}),t.jsx("i",{children:T})]},A.cle+T)),A.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((c.screened||0)/h*100)))})]}),A.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const L=!l;d(L),L&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem($n,L?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},A.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ta} ${xt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((A,L)=>{const T=(A.s||0)/g*(xt-4),C=(A.m||0)/g*(xt-4),S=L*p+(p-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(A.d)} — ${A.s} ${e.actScreened} · ${A.m} ${e.actKept}`}),t.jsx("rect",{x:S,y:xt-2-T,width:b,height:T,fill:"#cfe0d6"}),t.jsx("rect",{x:S,y:xt-2-C,width:b,height:C,fill:"#185c38"})]},A.d)}),t.jsx("line",{x1:0,y1:xt-1.5,x2:Ta,y2:xt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Mr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function hs(e,a){if((mt(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return Mr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function gs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=I(),[d,c]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),p=async b=>{if(f)return;if(b==="Analysé"&&!e.memoUrl){u(!0);return}s(b);const y=await i(e,b);s(""),y&&(c(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(b=>!b),u(!1)},children:[g||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]}):hs(e,a).map(([b,y])=>t.jsx("button",{type:"button",className:"rsti"+(g===b?" on":"")+(f===b?" busy":""),disabled:!!f,onClick:()=>{p(b)},children:y},b))})]})}function bs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=I(),[o,l]=m.useState(""),[d,c]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),s=(mt(e)||"").startsWith("CALL")&&ze(e)===3,x=ze(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const b=await i(e,p);l(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},g=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Mr.filter(([p])=>!(x&&p==="Retenu")).map(([p,b])=>[p,a[b]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),g.map(([p,b])=>t.jsx("button",{type:"button",className:"csb"+(f===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:b},p)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(vs,{o:e})]})}function vs({o:e}){const{t:a,saveNote:r,flash:n}=I(),[i,o]=m.useState(e.ceoNote||""),[l,d]=m.useState(!1),[c,f]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!s)return;d(!0);const u=await r(e,i.trim());d(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{x()},children:c?a.csNoteSaved:a.csNoteOk})]})}function ys({placeholder:e,onDone:a}){const{t:r}=I(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ws({o:e}){var y;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:d}=I(),[c,f]=m.useState(!1);if(!n.pipe||!i||n.lockActions||ze(e)!==4)return null;const s=o(e),x=(s==null?void 0:s.stage)||"todo",u=async h=>{if(c||h===x)return;f(!0);const N=s;l(e,{stage:h,stamps:(s==null?void 0:s.stamps)||{}});const E=Math.max(Date.now(),Bn+=1);Bn=E;const w=await Uo(r,{company:e.name||"",stage:h,cts:E,deal_id:e.airtableId,check_id:e.checkId});f(!1),!w.stale&&(w.ok||(l(e,N),d(a.actErr)))},g=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,p=g?Math.floor((Date.now()-Date.parse(g))/864e5):0,b=x==="sent"&&g&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,N])=>t.jsx("button",{type:"button",className:"stgb"+(x===h?" on":""),disabled:c,onClick:()=>{u(h)},children:N},h)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let Bn=0;const ea=8,ta=360;function _n({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Un({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(_n,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(_n,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function ks({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=I(),[l,d]=m.useState(0),[c,f]=m.useState(null),[s,x]=m.useState([]),u=m.useRef(!1),g=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=m.useRef(!1);m.useEffect(()=>{const T=g.current;return()=>{p.current||(n({type:"ptab",tab:T.ptab}),n({type:"dens",dens:T.dens}),n({type:"modal",modal:T.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,x(e.filter(T=>!!document.querySelector(T.need||T.sel))))},[e]);const b=s[l],y=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const T=b.click,C=window.setTimeout(()=>{const S=document.querySelector(T);S&&S.getAttribute("aria-selected")!=="true"&&S.click()},60);return()=>window.clearTimeout(C)}},[l,b]);const h=m.useRef(-1),N=m.useCallback(()=>{if(!b){f(null);return}const T=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!T){f(null);return}h.current!==l&&(h.current=l,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const C=T.getBoundingClientRect();f(S=>S&&Math.abs(S.top-C.top)<1&&Math.abs(S.left-C.left)<1&&Math.abs(S.width-C.width)<1&&Math.abs(S.height-C.height)<1?S:C)},[b,l]);m.useLayoutEffect(()=>{N();const T=[90,300,700,1300].map(S=>window.setTimeout(N,S)),C=()=>N();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{T.forEach(S=>window.clearTimeout(S)),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[N]);const E=m.useRef(a);if(E.current=a,m.useEffect(()=>{const T=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),E.current()):C.key==="ArrowRight"?d(S=>S+1):C.key==="ArrowLeft"&&d(S=>Math.max(0,S-1))};return document.addEventListener("keydown",T,!0),()=>document.removeEventListener("keydown",T,!0)},[]),!s.length)return null;let w=null;const A=T=>()=>{p.current=!0,n({type:"modal",modal:null}),T()};if(y){const T=i[3]||0;T>0?w={title:T===1?r.ahaATitle1:r.ahaATitleN(T),body:r.ahaABody,btn:r.ahaABtn,go:A(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?w={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:A(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?w={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:A(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:A(()=>{n({type:"modal",modal:"crit"}),a()})}}let L={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:ta};if(!y&&c){const T=c.bottom+14,S=window.innerHeight-T>190?T:Math.max(12,c.top-200);L={left:Math.min(Math.max(12,c.left+c.width/2-ta/2),window.innerWidth-ta-12),top:S,width:ta}}return qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-ea,top:c.top-ea,width:c.width+ea*2,height:c.height+ea*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:L,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(Un,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Un,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(T=>Math.max(0,T-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(T=>T+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Rr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Fr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function js(){var C,S;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:d,dispatch:c}=I(),f=r?a:e,s=m.useMemo(()=>f.filter(j=>pt(j.date)===0&&j.kind==="target"),[f]),x=m.useMemo(()=>r?a.filter(j=>j.kind==="target"&&ze(j)===0).slice().sort((j,M)=>(M.date||"").localeCompare(j.date||"")):[],[a,r]),u=m.useMemo(()=>s.filter(j=>r?ze(j)===0:!De(j)),[s,r]),g=r?x:u,p=r?a.length-x.length:s.length-u.length,b=r?a.length:s.length,y=b?Math.min(100,p/b*100):100,h=m.useMemo(()=>Rr(f),[f]),N=!!h&&pt(h)>0,E=m.useMemo(()=>N?f.filter(j=>(j.date||"").slice(0,10)===h):[],[f,h,N]),w=typeof((C=d.stats)==null?void 0:C.kept_today)=="number"?d.stats.kept_today:null,A=typeof((S=d.stats)==null?void 0:S.screened_today)=="number"?d.stats.screened_today:s.length;let L;N?L=i.morningLast(E.length,x.length,Fr(h,l)):r?L=i.morningThesis(A,x.length,w):s.length?p===0?L=i.goalSourced(s.length):p>=s.length?L=i.goalCleared:L=i.goalDone(p,s.length):L=i.goalSourced(0);const T=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&x.length&&c({type:"chainStart",queue:x.map(j=>j.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:L}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),g.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:T,children:r?i.morningEval(g.length):o.pileMode?i.goalContinue(g.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ns(){var H,U;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:f,startTour:s,flash:x,flashErr:u}=I(),[g,p]=m.useState(null),[b,y]=m.useState(!0),[h,N]=m.useState([]),E=c==="client";m.useEffect(()=>{if(!i||!o)return;let $=!0;return y(!0),(async()=>{const[V,K]=await Promise.all([sn(o),jr(i)]);$&&(V&&p(V),y(!1),N(K))})(),()=>{$=!1}},[i,o]);const[w,A]=m.useState(!1),L=()=>{!E||w||!o||(A(!0),Ho(o).then($=>{A(!1),$?x(e.identRepubDone):u(e.actErr)}))},T=(g==null?void 0:g.per_day)??null,C=((H=g==null?void 0:g.pool_order)==null?void 0:H.length)??0,S=h.filter($=>$.status==="running").length,j=m.useMemo(()=>d.filter($=>$.kind==="target"&&De($)).length,[d]),M=l.marketEstimate,D=typeof((U=l.stats)==null?void 0:U.screened)=="number"?l.stats.screened:j,O=M&&M>0?Math.min(100,Math.round(D/M*100)):null,_=$=>$.toLocaleString(a==="en"?"en-US":"fr-FR"),v=(o||"P").split(/\s+/).map($=>$[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const $=Date.parse(l.generatedAt||"");if(Number.isNaN($))return"";const V=new Date($),K=Q=>String(Q).padStart(2,"0");return`${K(V.getDate())}/${K(V.getMonth()+1)} à ${K(V.getHours())}:${K(V.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?v:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),q?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[O===null&&D>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:_(D)})})]}),O!==null&&M&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:O+"%"}})}),t.jsxs("b",{children:[O," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(D,M)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),T!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:T})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),T===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),S>0&&t.jsxs("span",{className:"ev",children:["⏳ ",S]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(C)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:$=>{$.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||w,onClick:L,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:$=>n({type:"filters",patch:{search:$.target.value}})})]})]})]})}function Ss(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=I(),d=o.loading&&!l.length,c=m.useRef({});m.useEffect(()=>{c.current={...r}},[r]);const f=u=>{const g=c.current[u],p=g!==void 0?r[u]-g:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Oa[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},s=(u,g,p)=>t.jsxs("button",{type:"button",className:"off"+(g?" view":""),style:{"--c":`var(${Oa[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),x=(u,g,p,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:g,disabled:b,onClick:p,children:u},g);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[x("↩",n.toolUndo,i,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Es(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=I(),d=m.useRef(null),[c,f]=m.useState(60);m.useEffect(()=>{let p=0;const b=()=>{var w;const y=d.current;if(!y)return;const h=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!h)return;const N=h.getBoundingClientRect(),E=y.getBoundingClientRect();f(Math.max(20,Math.min(N.left+N.width/2-E.left,E.width-30)))};return p=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let x=r.tuto[s].p;if(s===3){const p=n.filter(h=>h.kind==="target"&&ze(h)===3),b=p.filter(h=>Pa(h)==="auto").length,y=p.filter(h=>Pa(h)==="cd").length;x=r.tutoPending(b,y,p.length)}const u=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(s===1){const p=n.filter(b=>b.kind==="target"&&ze(b)===1&&!i.has(b.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(b=>b.id)})}}return null})(),g=Vo(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(g?"":" on-dark"),style:{"--bg":`var(${Oa[s]})`,"--ax":c+"px","--stc":g?"var(--ink)":"#fff","--stt":g?"#fff":"var(--ink)","--tc":g?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class vt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,d=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Cs(e){for(const a of e)yield*a}function Or(e){return Array.from(Cs(e))}var ge=1e-6,ce=Math.PI,Ke=ce/2,Hn=ce/4,Je=ce*2,dt=180/ce,_e=ce/180,je=Math.abs,zs=Math.atan,_t=Math.atan2,Se=Math.cos,Ee=Math.sin,As=Math.sign||function(e){return e>0?1:e<0?-1:0},kt=Math.sqrt;function Ts(e){return e>1?0:e<-1?ce:Math.acos(e)}function Ut(e){return e>1?Ke:e<-1?-Ke:Math.asin(e)}function Qe(){}function xa(e,a){e&&Wn.hasOwnProperty(e.type)&&Wn[e.type](e,a)}var Vn={Feature:function(e,a){xa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)xa(r[n].geometry,a)}},Wn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){_a(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)_a(r[n],a,0)},Polygon:function(e,a){Yn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Yn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)xa(r[n],a)}};function _a(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Yn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)_a(e[r],a,1);a.polygonEnd()}function St(e,a){e&&Vn.hasOwnProperty(e.type)?Vn[e.type](e,a):xa(e,a)}function Ua(e){return[_t(e[1],e[0]),Ut(e[2])]}function At(e){var a=e[0],r=e[1],n=Se(r);return[n*Se(a),n*Ee(a),Ee(r)]}function aa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function ha(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function La(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function na(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Ha(e){var a=kt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Va(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Wa(e,a){return je(e)>ce&&(e-=Math.round(e/Je)*Je),[e,a]}Wa.invert=Wa;function Ls(e,a,r){return(e%=Je)?a||r?Va(Kn(e),Qn(a,r)):Kn(e):a||r?Qn(a,r):Wa}function Gn(e){return function(a,r){return a+=e,je(a)>ce&&(a-=Math.round(a/Je)*Je),[a,r]}}function Kn(e){var a=Gn(e);return a.invert=Gn(-e),a}function Qn(e,a){var r=Se(e),n=Ee(e),i=Se(a),o=Ee(a);function l(d,c){var f=Se(c),s=Se(d)*f,x=Ee(d)*f,u=Ee(c),g=u*r+s*n;return[_t(x*i-g*o,s*r-u*n),Ut(g*i+x*o)]}return l.invert=function(d,c){var f=Se(c),s=Se(d)*f,x=Ee(d)*f,u=Ee(c),g=u*i-x*o;return[_t(x*i+u*o,s*r+g*n),Ut(g*r-s*n)]},l}function qs(e,a,r,n,i,o){if(r){var l=Se(a),d=Ee(a),c=n*r;i==null?(i=a+n*Je,o=a-c/2):(i=Jn(l,i),o=Jn(l,o),(n>0?i<o:i>o)&&(i+=n*Je));for(var f,s=i;n>0?s>o:s<o;s-=c)f=Ua([l,-d*Se(s),-d*Ee(s)]),e.point(f[0],f[1])}}function Jn(e,a){a=At(a),a[0]-=e,Ha(a);var r=Ts(-a[1]);return((-a[2]<0?-r:r)+Je-ge)%Je}function Pr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Qe,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function da(e,a){return je(e[0]-a[0])<ge&&je(e[1]-a[1])<ge}function ra(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Dr(e,a,r,n,i){var o=[],l=[],d,c;if(e.forEach(function(p){if(!((b=p.length-1)<=0)){var b,y=p[0],h=p[b],N;if(da(y,h)){if(!y[2]&&!h[2]){for(i.lineStart(),d=0;d<b;++d)i.point((y=p[d])[0],y[1]);i.lineEnd();return}h[0]+=2*ge}o.push(N=new ra(y,p,null,!0)),l.push(N.o=new ra(y,null,N,!1)),o.push(N=new ra(h,p,null,!1)),l.push(N.o=new ra(h,null,N,!0))}}),!!o.length){for(l.sort(a),Xn(o),Xn(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var f=o[0],s,x;;){for(var u=f,g=!0;u.v;)if((u=u.n)===f)return;s=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(g)for(d=0,c=s.length;d<c;++d)i.point((x=s[d])[0],x[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(g)for(s=u.p.z,d=s.length-1;d>=0;--d)i.point((x=s[d])[0],x[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,s=u.z,g=!g}while(!u.v);i.lineEnd()}}}function Xn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function qa(e){return je(e[0])<=ce?e[0]:As(e[0])*((je(e[0])+ce)%Je-ce)}function Ms(e,a){var r=qa(a),n=a[1],i=Ee(n),o=[Ee(r),-Se(r),0],l=0,d=0,c=new vt;i===1?n=Ke+ge:i===-1&&(n=-Ke-ge);for(var f=0,s=e.length;f<s;++f)if(u=(x=e[f]).length)for(var x,u,g=x[u-1],p=qa(g),b=g[1]/2+Hn,y=Ee(b),h=Se(b),N=0;N<u;++N,p=w,y=L,h=T,g=E){var E=x[N],w=qa(E),A=E[1]/2+Hn,L=Ee(A),T=Se(A),C=w-p,S=C>=0?1:-1,j=S*C,M=j>ce,D=y*L;if(c.add(_t(D*S*Ee(j),h*T+D*Se(j))),l+=M?C+S*Je:C,M^p>=r^w>=r){var O=ha(At(g),At(E));Ha(O);var _=ha(o,O);Ha(_);var v=(M^C>=0?-1:1)*Ut(_[2]);(n>v||n===v&&(O[0]||O[1]))&&(d+=M^C>=0?1:-1)}}return(l<-ge||l<ge&&c<-1e-12)^d&1}function Ir(e,a,r,n){return function(i){var o=a(i),l=Pr(),d=a(l),c=!1,f,s,x,u={point:g,lineStart:b,lineEnd:y,polygonStart:function(){u.point=h,u.lineStart=N,u.lineEnd=E,s=[],f=[]},polygonEnd:function(){u.point=g,u.lineStart=b,u.lineEnd=y,s=Or(s);var w=Ms(f,n);s.length?(c||(i.polygonStart(),c=!0),Dr(s,Fs,w,r,i)):w&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),s=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function g(w,A){e(w,A)&&i.point(w,A)}function p(w,A){o.point(w,A)}function b(){u.point=p,o.lineStart()}function y(){u.point=g,o.lineEnd()}function h(w,A){x.push([w,A]),d.point(w,A)}function N(){d.lineStart(),x=[]}function E(){h(x[0][0],x[0][1]),d.lineEnd();var w=d.clean(),A=l.result(),L,T=A.length,C,S,j;if(x.pop(),f.push(x),x=null,!!T){if(w&1){if(S=A[0],(C=S.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),L=0;L<C;++L)i.point((j=S[L])[0],j[1]);i.lineEnd()}return}T>1&&w&2&&A.push(A.pop().concat(A.shift())),s.push(A.filter(Rs))}}return u}}function Rs(e){return e.length>1}function Fs(e,a){return((e=e.x)[0]<0?e[1]-Ke-ge:Ke-e[1])-((a=a.x)[0]<0?a[1]-Ke-ge:Ke-a[1])}const Zn=Ir(function(){return!0},Os,Ds,[-ce,-Ke]);function Os(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var d=o>0?ce:-ce,c=je(o-a);je(c-ce)<ge?(e.point(a,r=(r+l)/2>0?Ke:-Ke),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(o,r),i=0):n!==d&&c>=ce&&(je(a-n)<ge&&(a-=n*ge),je(o-d)<ge&&(o-=d*ge),r=Ps(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),i=0),e.point(a=o,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ps(e,a,r,n){var i,o,l=Ee(e-r);return je(l)>ge?zs((Ee(a)*(o=Se(n))*Ee(r)-Ee(n)*(i=Se(a))*Ee(e))/(i*o*l)):(a+n)/2}function Ds(e,a,r,n){var i;if(e==null)i=r*Ke,n.point(-ce,i),n.point(0,i),n.point(ce,i),n.point(ce,0),n.point(ce,-i),n.point(0,-i),n.point(-ce,-i),n.point(-ce,0),n.point(-ce,i);else if(je(e[0]-a[0])>ge){var o=e[0]<a[0]?ce:-ce;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Is(e){var a=Se(e),r=2*_e,n=a>0,i=je(a)>ge;function o(s,x,u,g){qs(g,e,r,u,s,x)}function l(s,x){return Se(s)*Se(x)>a}function d(s){var x,u,g,p,b;return{lineStart:function(){p=g=!1,b=1},point:function(y,h){var N=[y,h],E,w=l(y,h),A=n?w?0:f(y,h):w?f(y+(y<0?ce:-ce),h):0;if(!x&&(p=g=w)&&s.lineStart(),w!==g&&(E=c(x,N),(!E||da(x,E)||da(N,E))&&(N[2]=1)),w!==g)b=0,w?(s.lineStart(),E=c(N,x),s.point(E[0],E[1])):(E=c(x,N),s.point(E[0],E[1],2),s.lineEnd()),x=E;else if(i&&x&&n^w){var L;!(A&u)&&(L=c(N,x,!0))&&(b=0,n?(s.lineStart(),s.point(L[0][0],L[0][1]),s.point(L[1][0],L[1][1]),s.lineEnd()):(s.point(L[1][0],L[1][1]),s.lineEnd(),s.lineStart(),s.point(L[0][0],L[0][1],3)))}w&&(!x||!da(x,N))&&s.point(N[0],N[1]),x=N,g=w,u=A},lineEnd:function(){g&&s.lineEnd(),x=null},clean:function(){return b|(p&&g)<<1}}}function c(s,x,u){var g=At(s),p=At(x),b=[1,0,0],y=ha(g,p),h=aa(y,y),N=y[0],E=h-N*N;if(!E)return!u&&s;var w=a*h/E,A=-a*N/E,L=ha(b,y),T=na(b,w),C=na(y,A);La(T,C);var S=L,j=aa(T,S),M=aa(S,S),D=j*j-M*(aa(T,T)-1);if(!(D<0)){var O=kt(D),_=na(S,(-j-O)/M);if(La(_,T),_=Ua(_),!u)return _;var v=s[0],q=x[0],H=s[1],U=x[1],$;q<v&&($=v,v=q,q=$);var V=q-v,K=je(V-ce)<ge,Q=K||V<ge;if(!K&&U<H&&($=H,H=U,U=$),Q?K?H+U>0^_[1]<(je(_[0]-v)<ge?H:U):H<=_[1]&&_[1]<=U:V>ce^(v<=_[0]&&_[0]<=q)){var le=na(S,(-j+O)/M);return La(le,T),[_,Ua(le)]}}}function f(s,x){var u=n?e:ce-e,g=0;return s<-u?g|=1:s>u&&(g|=2),x<-u?g|=4:x>u&&(g|=8),g}return Ir(l,d,o,n?[0,-e]:[-ce,e-ce])}function $s(e,a,r,n,i,o){var l=e[0],d=e[1],c=a[0],f=a[1],s=0,x=1,u=c-l,g=f-d,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<s)return;p<x&&(x=p)}else if(u>0){if(p>x)return;p>s&&(s=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>x)return;p>s&&(s=p)}else if(u>0){if(p<s)return;p<x&&(x=p)}if(p=n-d,!(!g&&p>0)){if(p/=g,g<0){if(p<s)return;p<x&&(x=p)}else if(g>0){if(p>x)return;p>s&&(s=p)}if(p=o-d,!(!g&&p<0)){if(p/=g,g<0){if(p>x)return;p>s&&(s=p)}else if(g>0){if(p<s)return;p<x&&(x=p)}return s>0&&(e[0]=l+s*u,e[1]=d+s*g),x<1&&(a[0]=l+x*u,a[1]=d+x*g),!0}}}}}var Ot=1e9,oa=-Ot;function Bs(e,a,r,n){function i(f,s){return e<=f&&f<=r&&a<=s&&s<=n}function o(f,s,x,u){var g=0,p=0;if(f==null||(g=l(f,x))!==(p=l(s,x))||c(f,s)<0^x>0)do u.point(g===0||g===3?e:r,g>1?n:a);while((g=(g+x+4)%4)!==p);else u.point(s[0],s[1])}function l(f,s){return je(f[0]-e)<ge?s>0?0:3:je(f[0]-r)<ge?s>0?2:1:je(f[1]-a)<ge?s>0?1:0:s>0?3:2}function d(f,s){return c(f.x,s.x)}function c(f,s){var x=l(f,1),u=l(s,1);return x!==u?x-u:x===0?s[1]-f[1]:x===1?f[0]-s[0]:x===2?f[1]-s[1]:s[0]-f[0]}return function(f){var s=f,x=Pr(),u,g,p,b,y,h,N,E,w,A,L,T={point:C,lineStart:D,lineEnd:O,polygonStart:j,polygonEnd:M};function C(v,q){i(v,q)&&s.point(v,q)}function S(){for(var v=0,q=0,H=g.length;q<H;++q)for(var U=g[q],$=1,V=U.length,K=U[0],Q,le,ae=K[0],be=K[1];$<V;++$)Q=ae,le=be,K=U[$],ae=K[0],be=K[1],le<=n?be>n&&(ae-Q)*(n-le)>(be-le)*(e-Q)&&++v:be<=n&&(ae-Q)*(n-le)<(be-le)*(e-Q)&&--v;return v}function j(){s=x,u=[],g=[],L=!0}function M(){var v=S(),q=L&&v,H=(u=Or(u)).length;(q||H)&&(f.polygonStart(),q&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),H&&Dr(u,d,v,o,f),f.polygonEnd()),s=f,u=g=p=null}function D(){T.point=_,g&&g.push(p=[]),A=!0,w=!1,N=E=NaN}function O(){u&&(_(b,y),h&&w&&x.rejoin(),u.push(x.result())),T.point=C,w&&s.lineEnd()}function _(v,q){var H=i(v,q);if(g&&p.push([v,q]),A)b=v,y=q,h=H,A=!1,H&&(s.lineStart(),s.point(v,q));else if(H&&w)s.point(v,q);else{var U=[N=Math.max(oa,Math.min(Ot,N)),E=Math.max(oa,Math.min(Ot,E))],$=[v=Math.max(oa,Math.min(Ot,v)),q=Math.max(oa,Math.min(Ot,q))];$s(U,$,e,a,r,n)?(w||(s.lineStart(),s.point(U[0],U[1])),s.point($[0],$[1]),H||s.lineEnd(),L=!1):H&&(s.lineStart(),s.point(v,q),L=!1)}N=v,E=q,w=H}return T}}const Ya=e=>e;var Ma=new vt,Ga=new vt,$r,Br,Ka,Qa,ct={point:Qe,lineStart:Qe,lineEnd:Qe,polygonStart:function(){ct.lineStart=_s,ct.lineEnd=Hs},polygonEnd:function(){ct.lineStart=ct.lineEnd=ct.point=Qe,Ma.add(je(Ga)),Ga=new vt},result:function(){var e=Ma/2;return Ma=new vt,e}};function _s(){ct.point=Us}function Us(e,a){ct.point=_r,$r=Ka=e,Br=Qa=a}function _r(e,a){Ga.add(Qa*e-Ka*a),Ka=e,Qa=a}function Hs(){_r($r,Br)}var Tt=1/0,ga=Tt,Ht=-Tt,ba=Ht,va={point:Vs,lineStart:Qe,lineEnd:Qe,polygonStart:Qe,polygonEnd:Qe,result:function(){var e=[[Tt,ga],[Ht,ba]];return Ht=ba=-(ga=Tt=1/0),e}};function Vs(e,a){e<Tt&&(Tt=e),e>Ht&&(Ht=e),a<ga&&(ga=a),a>ba&&(ba=a)}var Ja=0,Xa=0,Pt=0,ya=0,wa=0,Et=0,Za=0,en=0,Dt=0,Ur,Hr,tt,at,Ge={point:yt,lineStart:er,lineEnd:tr,polygonStart:function(){Ge.lineStart=Gs,Ge.lineEnd=Ks},polygonEnd:function(){Ge.point=yt,Ge.lineStart=er,Ge.lineEnd=tr},result:function(){var e=Dt?[Za/Dt,en/Dt]:Et?[ya/Et,wa/Et]:Pt?[Ja/Pt,Xa/Pt]:[NaN,NaN];return Ja=Xa=Pt=ya=wa=Et=Za=en=Dt=0,e}};function yt(e,a){Ja+=e,Xa+=a,++Pt}function er(){Ge.point=Ws}function Ws(e,a){Ge.point=Ys,yt(tt=e,at=a)}function Ys(e,a){var r=e-tt,n=a-at,i=kt(r*r+n*n);ya+=i*(tt+e)/2,wa+=i*(at+a)/2,Et+=i,yt(tt=e,at=a)}function tr(){Ge.point=yt}function Gs(){Ge.point=Qs}function Ks(){Vr(Ur,Hr)}function Qs(e,a){Ge.point=Vr,yt(Ur=tt=e,Hr=at=a)}function Vr(e,a){var r=e-tt,n=a-at,i=kt(r*r+n*n);ya+=i*(tt+e)/2,wa+=i*(at+a)/2,Et+=i,i=at*e-tt*a,Za+=i*(tt+e),en+=i*(at+a),Dt+=i*3,yt(tt=e,at=a)}function Wr(e){this._context=e}Wr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Je);break}}},result:Qe};var tn=new vt,Ra,Yr,Gr,It,$t,Vt={point:Qe,lineStart:function(){Vt.point=Js},lineEnd:function(){Ra&&Kr(Yr,Gr),Vt.point=Qe},polygonStart:function(){Ra=!0},polygonEnd:function(){Ra=null},result:function(){var e=+tn;return tn=new vt,e}};function Js(e,a){Vt.point=Kr,Yr=It=e,Gr=$t=a}function Kr(e,a){It-=e,$t-=a,tn.add(kt(It*It+$t*$t)),It=e,$t=a}let ar,ka,nr,rr;class or{constructor(a){this._append=a==null?Qr:Xs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==nr||this._append!==ka){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,nr=n,ka=this._append,rr=this._,this._=i}this._+=rr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Qr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Xs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Qr;if(a!==ar){const r=10**a;ar=a,ka=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return ka}function Zs(e,a){let r=3,n=4.5,i,o;function l(d){return d&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),St(d,i(o))),o.result()}return l.area=function(d){return St(d,i(ct)),ct.result()},l.measure=function(d){return St(d,i(Vt)),Vt.result()},l.bounds=function(d){return St(d,i(va)),va.result()},l.centroid=function(d){return St(d,i(Ge)),Ge.result()},l.projection=function(d){return arguments.length?(i=d==null?(e=null,Ya):(e=d).stream,l):e},l.context=function(d){return arguments.length?(o=d==null?(a=null,new or(r)):new Wr(a=d),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(o.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(o=new or(r)),l},l.projection(e).digits(r).context(a)}function mn(e){return function(a){var r=new an;for(var n in e)r[n]=e[n];return r.stream=a,r}}function an(){}an.prototype={constructor:an,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function fn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),St(r,e.stream(va)),a(va.result()),n!=null&&e.clipExtent(n),e}function Jr(e,a,r){return fn(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),d=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function el(e,a,r){return Jr(e,[[0,0],a],r)}function tl(e,a,r){return fn(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,d=-o*n[0][1];e.scale(150*o).translate([l,d])},r)}function al(e,a,r){return fn(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],d=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,d])},r)}var ir=16,nl=Se(30*_e);function sr(e,a){return+a?ol(e,a):rl(e)}function rl(e){return mn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ol(e,a){function r(n,i,o,l,d,c,f,s,x,u,g,p,b,y){var h=f-n,N=s-i,E=h*h+N*N;if(E>4*a&&b--){var w=l+u,A=d+g,L=c+p,T=kt(w*w+A*A+L*L),C=Ut(L/=T),S=je(je(L)-1)<ge||je(o-x)<ge?(o+x)/2:_t(A,w),j=e(S,C),M=j[0],D=j[1],O=M-n,_=D-i,v=N*O-h*_;(v*v/E>a||je((h*O+N*_)/E-.5)>.3||l*u+d*g+c*p<nl)&&(r(n,i,o,l,d,c,M,D,S,w/=T,A/=T,L,b,y),y.point(M,D),r(M,D,S,w,A,L,f,s,x,u,g,p,b,y))}}return function(n){var i,o,l,d,c,f,s,x,u,g,p,b,y={point:h,lineStart:N,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=A},polygonEnd:function(){n.polygonEnd(),y.lineStart=N}};function h(C,S){C=e(C,S),n.point(C[0],C[1])}function N(){x=NaN,y.point=E,n.lineStart()}function E(C,S){var j=At([C,S]),M=e(C,S);r(x,u,s,g,p,b,x=M[0],u=M[1],s=C,g=j[0],p=j[1],b=j[2],ir,n),n.point(x,u)}function w(){y.point=h,n.lineEnd()}function A(){N(),y.point=L,y.lineEnd=T}function L(C,S){E(i=C,S),o=x,l=u,d=g,c=p,f=b,y.point=E}function T(){r(x,u,s,g,p,b,o,l,i,d,c,f,ir,n),y.lineEnd=w,w()}return y}}var il=mn({point:function(e,a){this.stream.point(e*_e,a*_e)}});function sl(e){return mn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ll(e,a,r,n,i){function o(l,d){return l*=n,d*=i,[a+e*l,r-e*d]}return o.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*i]},o}function lr(e,a,r,n,i,o){if(!o)return ll(e,a,r,n,i);var l=Se(o),d=Ee(o),c=l*e,f=d*e,s=l/e,x=d/e,u=(d*r-l*a)/e,g=(d*a+l*r)/e;function p(b,y){return b*=n,y*=i,[c*b-f*y+a,r-f*b-c*y]}return p.invert=function(b,y){return[n*(s*b-x*y+u),i*(g-x*b-s*y)]},p}function dl(e){return cl(function(){return e})()}function cl(e){var a,r=150,n=480,i=250,o=0,l=0,d=0,c=0,f=0,s,x=0,u=1,g=1,p=null,b=Zn,y=null,h,N,E,w=Ya,A=.5,L,T,C,S,j;function M(v){return C(v[0]*_e,v[1]*_e)}function D(v){return v=C.invert(v[0],v[1]),v&&[v[0]*dt,v[1]*dt]}M.stream=function(v){return S&&j===v?S:S=il(sl(s)(b(L(w(j=v)))))},M.preclip=function(v){return arguments.length?(b=v,p=void 0,_()):b},M.postclip=function(v){return arguments.length?(w=v,y=h=N=E=null,_()):w},M.clipAngle=function(v){return arguments.length?(b=+v?Is(p=v*_e):(p=null,Zn),_()):p*dt},M.clipExtent=function(v){return arguments.length?(w=v==null?(y=h=N=E=null,Ya):Bs(y=+v[0][0],h=+v[0][1],N=+v[1][0],E=+v[1][1]),_()):y==null?null:[[y,h],[N,E]]},M.scale=function(v){return arguments.length?(r=+v,O()):r},M.translate=function(v){return arguments.length?(n=+v[0],i=+v[1],O()):[n,i]},M.center=function(v){return arguments.length?(o=v[0]%360*_e,l=v[1]%360*_e,O()):[o*dt,l*dt]},M.rotate=function(v){return arguments.length?(d=v[0]%360*_e,c=v[1]%360*_e,f=v.length>2?v[2]%360*_e:0,O()):[d*dt,c*dt,f*dt]},M.angle=function(v){return arguments.length?(x=v%360*_e,O()):x*dt},M.reflectX=function(v){return arguments.length?(u=v?-1:1,O()):u<0},M.reflectY=function(v){return arguments.length?(g=v?-1:1,O()):g<0},M.precision=function(v){return arguments.length?(L=sr(T,A=v*v),_()):kt(A)},M.fitExtent=function(v,q){return Jr(M,v,q)},M.fitSize=function(v,q){return el(M,v,q)},M.fitWidth=function(v,q){return tl(M,v,q)},M.fitHeight=function(v,q){return al(M,v,q)};function O(){var v=lr(r,0,0,u,g,x).apply(null,a(o,l)),q=lr(r,n-v[0],i-v[1],u,g,x);return s=Ls(d,c,f),T=Va(a,q),C=Va(s,T),L=sr(T,A),_()}function _(){return S=j=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&D,O()}}function Xr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Xr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(je(i)>ge&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function pl(){return dl(Xr).scale(175.295)}function ul(e){return e}function ml(e){if(e==null)return ul;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var f=2,s=d.length,x=new Array(s);for(x[0]=(a+=d[0])*n+o,x[1]=(r+=d[1])*i+l;f<s;)x[f]=d[f],++f;return x}}function fl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function xl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return dr(e,r)})}:dr(e,a)}function dr(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=hl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function hl(e,a){var r=ml(e.transform),n=e.arcs;function i(s,x){x.length&&x.pop();for(var u=n[s<0?~s:s],g=0,p=u.length;g<p;++g)x.push(r(u[g],g));s<0&&fl(x,p)}function o(s){return r(s)}function l(s){for(var x=[],u=0,g=s.length;u<g;++u)i(s[u],x);return x.length<2&&x.push(x[0]),x}function d(s){for(var x=l(s);x.length<4;)x.push(x[0]);return x}function c(s){return s.map(d)}function f(s){var x=s.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:s.geometries.map(f)};case"Point":u=o(s.coordinates);break;case"MultiPoint":u=s.coordinates.map(o);break;case"LineString":u=l(s.arcs);break;case"MultiLineString":u=s.arcs.map(l);break;case"Polygon":u=c(s.arcs);break;case"MultiPolygon":u=s.arcs.map(c);break;default:return null}return{type:x,coordinates:u}}return f(a)}const Zr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},gl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function bl(e,a,r){const n=Zr[e];if(!n||!n.length)return-1;const i=gl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let ia=null;function vl(){return ia||(ia=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=xl(r,n),o=pl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Zs(o),d=(i.features||[]).filter(s=>{var x;return(((x=s.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(s=>{var g;const x=((g=s.properties)==null?void 0:g.name)||"",u=l(s)||"";return u?{i2:Wo(x)||null,n:x,d:u}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,x]of Object.entries(Yo)){const u=o(x);u&&(c[s]={x:u[0],y:u[1]})}const f={};for(const[s,x]of Object.entries(Zr)){const u=x.map(g=>o(g.ll)).filter(g=>!!g).map(([g,p])=>({x:g,y:p}));u.length&&(f[s]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:d,anchors:c,metros:f}}catch{return null}})(),ia)}function yl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return vl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const wl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},cr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function pr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function kl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const c=(f=e.current)==null?void 0:f.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function ur({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function jl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:d,t:c,data:f,dossiers:s,source:x}=I(),u=f.loading&&!s.length,g=m.useRef(null),p=m.useRef(null),b=yl(e.continent==="monde"),y=e.continent==="monde"?b:ln.find(v=>v.key===e.continent)||null,h=kl(g,e.continent+":"+e.mapFolded+":"+!!y),[N,E]=m.useState(new Map),[w,A]=m.useState(null);m.useEffect(()=>{const v=g.current;if(!v)return;const q=new Map;v.querySelectorAll("path[data-i2]").forEach(H=>{const U=H.dataset.i2;if(U)try{const $=H.getBBox();$.width>0&&q.set(U,{x:$.x,y:$.y,w:$.width,h:$.height})}catch{}}),E(q)},[e.continent,h,y]);const L=m.useMemo(()=>r.filter(v=>v.cc),[r]),T=m.useMemo(()=>{const v=new Map;return L.forEach(q=>v.set(q.cc,(v.get(q.cc)||0)+1)),v},[L]),C=e.continent==="monde"&&b?b.anchors:null,S=e.continent==="monde"&&b?b.metros:null,j=m.useMemo(()=>L.map(v=>{const q=pr(v.name||v.id||""),H=pr((v.id||v.name||"")+"·y");if(C&&v.cc){const Q=S?S[v.cc]:void 0;if(Q&&Q.length){const ae=bl(v.cc,v.city,q);if(ae>=0&&Q[ae])return{d:v,x:Q[ae].x+(q-.5)*5,y:Q[ae].y+(H-.5)*5}}const le=C[v.cc];if(le)return{d:v,x:le.x+(q-.5)*10,y:le.y+(H-.5)*10}}const U=v.cc?N.get(v.cc):void 0;if(!U)return null;const $=wl[`${e.continent}:${v.cc||""}`];if($)return{d:v,x:U.x+U.w*($.fx+(q-.5)*$.sx),y:U.y+U.h*($.fy+(H-.5)*$.sy)};const V=(q-.5)*Math.min(U.w*.55,60),K=(H-.5)*Math.min(U.h*.55,60);return{d:v,x:U.x+U.w/2+V,y:U.y+U.h/2+K}}).filter(v=>!!v),[L,N,C,S,e.continent]),M=v=>h>0?v/h:v,D=m.useMemo(()=>n?[0,1,2,3,4,5].map(v=>({c:cr[v],fr:c.plabels[v].toUpperCase(),en:c.plabels[v].toUpperCase(),n:r.filter(q=>q.kind==="target"&&ze(q)===v).length})).filter(v=>v.n>0):An.map((v,q)=>({...v,n:r.filter(H=>Tn(H)===q).length})),[r,n,c.plabels]),O=o?l.get(o):null,_=O?j.find(v=>v.d.id===O.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:[u&&t.jsx(ur,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:g,viewBox:y.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{A(null),i(null)},children:[t.jsx("g",{children:y.countries.map((v,q)=>t.jsx("g",{className:"ct"+(v.i2&&T.get(v.i2)?"":" empty"),children:t.jsx("path",{d:v.d,"data-i2":v.i2||void 0})},q))}),t.jsx("g",{children:j.map(v=>{const q=An[Tn(v.d)],H=!!Le(v.d),U=v.d.kind==="target",$=n&&U?cr[ze(v.d)]:q.c,V=!n&&De(v.d);return t.jsxs("g",{className:"co"+(V?" done":""),onMouseEnter:()=>{var le,ae;const K=(le=p.current)==null?void 0:le.getBoundingClientRect(),Q=(ae=g.current)==null?void 0:ae.createSVGPoint();if(Q&&g.current&&K){Q.x=v.x,Q.y=v.y;const be=Q.matrixTransform(g.current.getScreenCTM());A({x:be.x-K.left,y:be.y-K.top,label:v.d.name+" · "+(Mt(v.d.cc,d)||v.d.countryLabel||"")})}i(v.d.id)},onMouseLeave:()=>{A(null),i(null)},onClick:()=>{var le;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:v.d.id}),(v.d.noCo||["media","nominations","recrutements"].includes(v.d.engine||""))&&(v.d.url||v.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:v.d.url||"",text:[v.d.headline,v.d.tagline].filter(Boolean).join(`
`)}})):v.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:v.d.name}}));return}const K=(le=g.current)==null?void 0:le.createSVGPoint();let Q=null;if(K&&g.current){K.x=v.x,K.y=v.y;const ae=K.matrixTransform(g.current.getScreenCTM());Q={x:ae.x,y:ae.y}}a({type:"popup",id:v.d.id,anchor:Q})},children:[t.jsx("circle",{className:"h",cx:v.x,cy:v.y,r:M(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:v.x,cy:v.y,r:M(q.px),fill:$,stroke:H?"#DC2626":"#ffffff",strokeWidth:M(H?2.2:1.3)})]},v.d.id||v.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:D.map((v,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":v.c}}),d==="fr"?v.fr:v.en," ",t.jsx("b",{children:v.n})]},q))}),r.some(v=>!v.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(v=>!v.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:t.jsx(ur,{msgs:c.loadMsgs})})}function Nl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function eo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:d}=I(),c=a.filters,[f,s]=m.useState(!1),x=m.useRef(null),u=m.useMemo(()=>a.continent==="monde"?n:n.filter(C=>C.continent===a.continent),[n,a.continent]),g=C=>u.filter(S=>C!=="country"&&c.country.length&&!c.country.includes(S.cc||"")?!1:ma(S,c,o,C==="country"?void 0:C)),p=m.useMemo(()=>{const C=g("win"),S=j=>C.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=j).length;return[S(0),S(7),S(30),C.length]},[u,c,o]),b=m.useMemo(()=>c.day?g("win").filter(C=>(C.date||"").slice(0,10)===c.day).length:0,[u,c,o]),y=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,h=y+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!f)return;const C=j=>{var M;(M=x.current)!=null&&M.contains(j.target)||s(!1)},S=j=>{j.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",C),document.addEventListener("keydown",S),()=>{document.removeEventListener("mousedown",C),document.removeEventListener("keydown",S)}},[f]);const N=(C,S,j,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===C,onClick:()=>r({type:"openFacet",facet:C}),children:[t.jsx("span",{className:"fl",children:S}),j>0&&t.jsx("span",{className:"n",children:j}),t.jsx("span",{className:"cv",children:"▾"})]},C),E=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(Nl(c.day,d))}),t.jsx("b",{children:b})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((C,S)=>t.jsxs("button",{type:"button","aria-pressed":c.win===C,onClick:()=>r({type:"filters",patch:{win:C}}),children:[t.jsx("span",{className:"sl",children:i.dates[S]}),t.jsx("b",{children:p[S]})]},C))}),w=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:c.search,onChange:C=>r({type:"filters",patch:{search:C.target.value}})})]}),A=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",i.fSector,c.sector.length),N("pay",i.fCountry,c.country.length),N("det",i.fEngine,c.engine.length),N("sta",i.fStage,c.stage.length),o&&N("ang","Angle",c.angle.length),o&&N("mem","Mémo",c.memoLevel.length)]}),L=(C=!1)=>t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),C&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),T=t.jsxs("div",{className:"fmenu",ref:x,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(y?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{s(C=>!C),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),y>0&&t.jsx("span",{className:"n",children:y}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:A})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[!c.day&&t.jsx("div",{className:"fstrip-a",children:E}),t.jsxs("div",{className:"fstrip-b",children:[w,T,L(a.mapFolded)]})]}),a.openFacet&&t.jsx(mr,{poolFor:g})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[E,w,A,t.jsx("span",{className:"fgrow"}),L()]}),a.openFacet&&t.jsx(mr,{poolFor:g})]})}function mr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=I(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:f}=m.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(h=>Le(h)),b=new Map;p.forEach(h=>{const N=h.engine||"";b.set(N,(b.get(N)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Da([...b.keys()],i).map(h=>({v:h,label:bt(h)+" "+Ue(h,i),n:b.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const p=e("sector"),b=new Map;return p.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y,n:h,html:!1,on:o.sector.includes(y)}))}}if(l==="pay"){const p=e("country"),b=new Map;return p.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:Mt(y,i)||y,n:h,html:!1,on:o.country.includes(y)}))}}if(l==="det"){const p=e("engine"),b=new Map;return p.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Da([...b.keys()],i).map(y=>({v:y,label:bt(y)+" "+Ue(y,i)+' <span style="color:var(--dim);font-size:10px">· '+Go(Ko(y),i)+"</span>",n:b.get(y)||0,html:!0,on:o.engine.includes(y)}))}}if(l==="ang"){const p=e("angle"),b=new Map;return p.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(y)}))}}if(l==="mem"){const p=e("memoLevel"),b=new Map;p.forEach(h=>{if(h.kind==="target"){const N=on(h);b.set(N,(b.get(N)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:y[h],n:b.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),g=new Map;return u.forEach(p=>{p.stage&&g.set(p.stage,(g.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...g.entries()].sort((p,b)=>b[1]-p[1]).map(([p,b])=>({v:p,label:p,n:b,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),s=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:f.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>s(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function to({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:d}=I(),c=m.useMemo(()=>{const g={};return r.forEach(p=>{ma(p,n.filters,o)&&(g.monde=(g.monde||0)+1,p.continent&&(g[p.continent]=(g[p.continent]||0)+1))}),g},[r,n.filters,o]),[f,s]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>{if(!f)return;const g=b=>{var y;(y=x.current)!=null&&y.contains(b.target)||s(!1)},p=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",g),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",g),document.removeEventListener("keydown",p)}},[f]);const u=g=>{const p=ln.find(b=>b.key===g);return g==="monde"?d.contWorld:l==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>s(g=>!g),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Ln.map(g=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===g,onClick:()=>{i({type:"continent",key:g}),s(!1)},children:[u(g),t.jsx("span",{className:"n",children:c[g]||0})]},g))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Ln.map(g=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===g,onClick:()=>i({type:"continent",key:g}),children:[u(g),t.jsx("span",{className:"n",children:c[g]||0})]},g)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function ao(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Sl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function fr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:d}=I();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function no({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=I(),i=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(fr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(fr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function El({card:e,onEvaluate:a,onAddAll:r}){var d,c,f;const{t:n}=I(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ao(e.summary_md||"").map((s,x)=>t.jsx("p",{children:s},x))})]}),t.jsx(no,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Cl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function zl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=I(),d=i,[c,f]=m.useState(null),[s,x]=m.useState(null),[u,g]=m.useState(null),[p,b]=m.useState(!1);m.useEffect(()=>{let h=!0;return(async()=>{const N=await Nr({email:l,cbToken:d});h&&f(N)})(),()=>{h=!1}},[l,d,n]);const y=h=>{x(h),g(null),b(!0),(async()=>{const N=await Qo(h.id);g(N),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),g(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[Cl(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(El,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Fa=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function xr(e){return/^https?:\/\//i.test((e||"").trim())}function Al(e){const a=(e||"").trim(),r=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/i.exec(a);return r?`https://www.youtube.com/embed/${r[1]}?rel=0`:a}function Tl(e){try{return new URL(e).hostname.replace(/^www\./,"")}catch{return e}}function Ll(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:d,evalCards:c,caps:f,data:s,canWrite:x,source:u,dossiers:g,doAnalyse:p,liveMemos:b,pipe:y}=I(),h=a==="client",N=m.useMemo(()=>r||(u!=="default"?Jo():""),[r,u]),[E,w]=m.useState(""),[A,L]=m.useState(!1),[T,C]=m.useState(""),[S,j]=m.useState(!1),[M,D]=m.useState(""),[O,_]=m.useState(!1),[v,q]=m.useState(""),[H,U]=m.useState([]),$=m.useRef(!1),[V,K]=m.useState(!1),[Q,le]=m.useState(""),[ae,be]=m.useState(""),[G,pe]=m.useState(!1),[oe,we]=m.useState(""),[me,Z]=m.useState(!1),[ee,J]=m.useState(0),[te,xe]=m.useState(""),[W,ue]=m.useState(null),[ie,he]=m.useState(null),[Oe,$e]=m.useState(!1),[qe,He]=m.useState(null),[Xe,nt]=m.useState(0),ut=m.useRef(!1),jt=E.trim()?Fa.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting,Me=m.useMemo(()=>M.split(`
`).map(R=>R.trim()).filter(Boolean).slice(0,15),[M]);m.useEffect(()=>{if(typeof window>"u")return;const R=new URLSearchParams(window.location.search),ne=(R.get("rs")||"").trim(),se=(R.get("rstext")||"").trim();ne&&/^https?:\/\//i.test(ne)&&le(ne),se&&be(se),(ne&&/^https?:\/\//i.test(ne)||se)&&K(!0)},[]),m.useEffect(()=>{const R=ne=>{const se=ne.detail||{},fe=String(se.url||"").trim(),Ve=String(se.text||"").trim();fe&&/^https?:\/\//i.test(fe)&&le(fe),Ve&&be(Ve),(fe&&/^https?:\/\//i.test(fe)||Ve)&&(K(!0),w(""),C(""),pe(!0),window.setTimeout(()=>pe(!1),900))};return window.addEventListener("ppmap:research",R),()=>window.removeEventListener("ppmap:research",R)},[]),m.useEffect(()=>{const R=ne=>{const se=ne.detail||{},fe=String(se.name||"").trim();fe&&(K(!1),w(fe),C(fe),L(!0),window.setTimeout(()=>L(!1),900))};return window.addEventListener("ppmap:prefill",R),()=>window.removeEventListener("ppmap:prefill",R)},[]),m.useEffect(()=>{const R=ne=>{var fe;const se=String(((fe=ne.detail)==null?void 0:fe.url)||"").trim();xr(se)&&we(se)};return window.addEventListener("ppmap:view",R),()=>window.removeEventListener("ppmap:view",R)},[]),m.useEffect(()=>{if(!oe)return;const R=ne=>{ne.key==="Escape"&&we("")};return document.addEventListener("keydown",R),()=>document.removeEventListener("keydown",R)},[oe]),m.useEffect(()=>{if(typeof window>"u"||u!=="ops")return;const R=document.querySelector(".atl2.ops .eval-stick")||document.querySelector(".atl2.ops .demand"),ne=document.querySelector(".atl2.ops");if(!R||!ne)return;const se=()=>ne.style.setProperty("--demand-h",`${R.offsetHeight}px`);se();const fe=new ResizeObserver(se);return fe.observe(R),()=>fe.disconnect()},[u,A,G,S,V]),m.useEffect(()=>{if(!x&&!N){He(null);return}let R=!0;return(async()=>{const ne=await Nr({email:n,cbToken:N});R&&He(ne.length)})(),()=>{R=!1}},[x,N,n,Xe]);const z=H.length?H:c,P=s.credits,Y=m.useCallback(R=>{const ne=R.map(se=>(se||"").trim()).filter(Boolean);ne.length&&(D(se=>{const fe=se.split(`
`).map(Ne=>Ne.trim()).filter(Boolean),Ve=new Set(fe.map(Ne=>Ne.toLowerCase())),Pe=ne.filter(Ne=>!Ve.has(Ne.toLowerCase()));return[...fe,...Pe].slice(0,15).join(`
`)}),j(!0))},[]);m.useEffect(()=>{if(!me)return;J(0);const R=window.setInterval(()=>J(ne=>ne+1),1e3);return()=>window.clearInterval(R)},[me]);const re=m.useMemo(()=>{const R=E.trim().toLowerCase();return!R||!y?null:g.find(ne=>Ye(ne.name)===R&&ze(ne)===1)||null},[E,g,y]),Ce=()=>{const R=E.trim();if(R){if(re){p(re);return}i(null,R),h&&w("")}},ve=async()=>{if(!h){i(null,Me[0]||"");return}if(!Me.length||O)return;_(!0),$.current=!1;const R=[];for(let ne=0;ne<Me.length&&!$.current;ne++){q(e.evaluating(ne+1,Me.length,Me[ne]));const se=await Sr(r,Me[ne],"atelier2");if(R.unshift({name:se.company||Me[ne],verdict:se.verdict,reason:se.reason||"",remaining:se.remaining??null}),U([...R]),se.verdict==="quota"){R.unshift({name:"",verdict:"quota",reason:e.quota(Me.length-ne-1),remaining:0}),U([...R]),D(Me.slice(ne+1).join(`
`)),q(""),_(!1);return}}q(""),D($.current?Me.slice(R.length).join(`
`):""),_(!1)},Be=async()=>{var se,fe,Ve;if(ut.current)return;const R=Q.trim().replace(/\s+/g,""),ne=ae.trim();if(!R&&!ne){xe(e.rsNeed);return}if(!h&&!N){i(null,R||ne.slice(0,80));return}ut.current=!0,xe(""),ue(null),he(null),Z(!0);try{const Pe=await Zo({url:R,text:ne,email:n,cbToken:N});if(Z(!1),!Pe||Pe.status!=="success"){xe((Pe==null?void 0:Pe.message)||"Erreur");return}ue(Pe),K(!1),Y((((se=Pe.prospective)==null?void 0:se.companies_to_evaluate)||[]).map(We=>(We==null?void 0:We.name)||"")),he({state:"pending"});const Ne=await ei(Pe,{email:n,cbToken:N});he(Ne.ok?{state:"ok",scopeLabel:((fe=Ne.summary)==null?void 0:fe.scope_label)||"",scope:((Ve=Ne.summary)==null?void 0:Ve.scope)||""}:{state:"fail",msg:Ne.error||""}),Ne.ok&&nt(We=>We+1)}finally{ut.current=!1,Z(!1)}},rt=[W==null?void 0:W.industry,...(W==null?void 0:W.market_tags)||[],W==null?void 0:W.author].map(R=>(R||"").trim()).filter(Boolean),ot=(ie==null?void 0:ie.state)==="pending",it=ie&&(ot?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):ie.state==="ok"?t.jsx("span",{className:"rslink ok",children:ie.scope&&ie.scope!=="public"?e.rsSavedIn(ie.scopeLabel||ie.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:ie.msg,children:e.rsSaveFail})),Nt=Sl(W).length,Ae=V,st=(T||E).trim(),lt=re?e.actAnalyse:st?e.evalGoOn(st.length>22?st.slice(0,21)+"…":st):e.evalGo,Na=me?`${Xo(Q.trim())==="youtube"&&Q.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ee)}`:ot?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Ae?" rs-mode":"")+(T&&E.trim()===T||A||G?" pair":"")+(A||G?" echo":""),children:[t.jsxs("div",{className:"drow"+((Ae?G:A)?" flash":"")+((Ae?Q.trim():Fa.test(E.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Ae?Q:E,placeholder:Ae?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Ae?600:200,spellCheck:Ae?!1:void 0,inputMode:Ae?"url":void 0,onChange:R=>{if(Ae){le(R.target.value);return}w(R.target.value),T&&R.target.value.trim()!==T&&C("")},onKeyDown:R=>{R.key==="Enter"&&(Ae?Be():Ce())}}),!Ae&&t.jsx("span",{className:"detect"+(Fa.test(E.trim())?" url":""),children:jt})]}),Ae?t.jsxs(t.Fragment,{children:[t.jsx("button",{type:"button",className:"viewbtn"+(oe?" on":""),disabled:!xr(Q),title:oe?e.viewLinkClose:e.viewLink,onClick:()=>we(oe?"":Q.trim()),children:oe?e.viewLinkClose:e.viewLink}),t.jsxs("button",{type:"button",className:"evalbtn"+(me?" loading":""),disabled:me||ot||!Q.trim()&&!ae.trim(),onClick:()=>{Be()},children:[t.jsx("span",{className:"fill"}),Na]})]}):t.jsxs("button",{type:"button",className:"evalbtn"+(re?" analyse":"")+(d?" loading":""),disabled:d,onClick:Ce,children:[t.jsx("span",{className:"fill"}),lt]}),f.showCredits&&P&&t.jsxs("button",{type:"button",className:"credits"+(P.total_available<=0&&!P.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:P.unlimited?"∞":P.total_available}),!P.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",P.daily_grant+P.purchased]}),P.total_available<=0&&!P.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(R=>R.status==="boot"||R.status==="running").map(R=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:R.name}),t.jsx(Bt,{item:R,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+R.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>j(!S),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(V?" on":""),onClick:()=>K(!V),children:e.rsOpen}),qe!==null&&qe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Oe?" on":""),onClick:()=>$e(!Oe),children:e.rsArchOpen(qe)})]}),Oe&&t.jsx(zl,{bump:Xe,cbToken:N,onClose:()=>$e(!1),onEvaluate:R=>i(null,R),onAddAll:Y}),V&&t.jsxs("div",{className:"rsp on slim",children:[t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:ae,placeholder:e.rsTextPh,onChange:R=>be(R.target.value)})]}),te&&t.jsx("div",{className:"rserr",children:te}),W&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:W.title}),W.source_url&&t.jsx("a",{href:W.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ue(null),he(null)},children:"×"})]}),W.market&&t.jsx("p",{className:"rsmk",children:W.market}),rt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),rt.map(R=>t.jsx("span",{children:R},R))]}),t.jsxs("div",{className:"rsbody",children:[W.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${W.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ao(W.summary_md||"").map((R,ne)=>t.jsx("p",{children:R},ne))})]}),t.jsx(no,{card:W,onEvaluate:R=>i(null,R),onAddAll:Y}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Nt)}),it]})]}),S&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:M,placeholder:e.bulkPh,onChange:R=>D(R.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(O?" loading":""),style:{justifyContent:"center"},disabled:O||!Me.length,onClick:()=>{ve()},children:[t.jsx("span",{className:"fill"}),O&&v?v:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(Me.length)})]})]}),z.slice(0,1).map((R,ne)=>{const se=R.verdict==="kept",fe=R.verdict==="quota",Ve=se?"var(--brand)":fe?"var(--bolt)":"var(--red)",Pe=se?"var(--brand-l)":fe?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ve,"--bgc":Pe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:se?"✓ "+e.kept:fe?"⏳":"✗ "+e.dropped})}),R.name&&t.jsx("span",{className:"rn",children:R.name}),t.jsx("span",{className:"rr",children:R.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",R.reason]}):null}),!!(R.candidates&&R.candidates.length)&&t.jsx("span",{className:"sitepick",children:R.candidates.map(Ne=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ne.url.startsWith("http")?Ne.url:`https://${Ne.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ne.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Ne.url),children:e.evalPickGo})]},Ne.url))}),!fe&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:se?1:5});const Ne=(R.name||"").trim().toLowerCase();window.setTimeout(()=>{const We=[...document.querySelectorAll(".atl2 .list .row")].find(Kt=>{var Qt;return(((Qt=Kt.querySelector(".rnm"))==null?void 0:Qt.textContent)||"").trim().toLowerCase().includes(Ne)});We&&(We.scrollIntoView({behavior:"smooth",block:"center"}),We.classList.add("flashrow"),window.setTimeout(()=>We.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(se?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ne)}),h&&(o.kept+o.dropped>0||z.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]}),oe&&t.jsxs("div",{className:"artview",role:"dialog","aria-label":e.viewLink,children:[t.jsxs("div",{className:"artview-bar",children:[t.jsx("b",{children:Tl(oe)}),t.jsx("span",{className:"artview-hint",children:e.viewLinkHint}),t.jsxs("a",{href:oe,target:"_blank",rel:"noopener noreferrer",children:[e.viewLinkTab," ↗"]}),t.jsx("button",{type:"button",className:"artview-x",onClick:()=>we(""),"aria-label":e.viewLinkClose,children:"×"})]}),t.jsx("iframe",{src:Al(oe),title:e.viewLink,sandbox:"allow-scripts allow-same-origin allow-popups allow-forms allow-presentation",referrerPolicy:"no-referrer-when-downgrade"})]})]})}function ql(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ml(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=I(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",ql(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const d=mt(o),c=on(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((f,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[zt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function xn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=I(),[l,d]=m.useState(!1),[c,f]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,x=async()=>{if(!s||l)return;d(!0);const u=await ti(r,e);if(d(!1),!u){o(a.actErr);return}f(u.results||[])};return m.useEffect(()=>{if(!s)return;const u=g=>{var b;const p=String(((b=g.detail)==null?void 0:b.name)||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,s]),m.useEffect(()=>{if(s)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{x()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Rl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),sa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Fl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=sa(a.slice(n));break}r+=sa(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=sa(a.slice(i));break}const l=a.slice(i+1,o).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Rl.has(c)?r+=`<${d[1]}${c}>`:r+=sa(a.slice(i,o+1)),n=o+1}return r}const hr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Fe({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ol(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Pl({o:e}){const{t:a,doDeep:r}=I(),[n,i]=m.useState(!1),o=mt(e),l=[e.reasoning||"",Ol(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[zt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),i(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function hn({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=I(),o=Yt(e),l=mt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||zt(e)?1:0}].filter(b=>b.n>0),[e,a,d,l,c,f,s]),[u,g]=m.useState("");if(!x.length)return null;const p=x.some(b=>b.k===u)?u:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===b.k,"data-tour":"tab-"+b.k,className:p===b.k?"on":"",onClick:y=>{y.stopPropagation(),g(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Fe,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Fe,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Fe,{k:a.cdVerdictDate,v:hr(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Fl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Dl,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Fe,{k:a.cdSector,v:e.sector}),t.jsx(Fe,{k:a.cdStage,v:e.stage}),t.jsx(Fe,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Fe,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Fe,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Fe,{k:a.cdAngle,v:e.angle}),t.jsx(Fe,{k:a.cdDetected,v:hr(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Fe,{k:a.cdName,v:e.contactName}),t.jsx(Fe,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Fe,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(Pl,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Fe,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Fe,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Dl({o:e}){const{t:a,token:r}=I(),[n,i]=m.useState(!1),[o,l]=m.useState(null),d=async()=>{n||(i(!0),l(await ai(r,e.name,e.website||e.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=f.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[f.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Gt({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const d=()=>{const f=Math.max(280,Math.min(560,o.clientWidth||320));qn({kind:"op",card:e},f).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;qn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&o.isConnected&&o.replaceChildren(c)});const d=c=>{c.key==="Escape"&&i(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Il=`
...
`;function $l(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let d=e.y+10;return d+n>o-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function Bl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:d,doAnalyse:c,doDecide:f,doPromote:s,doRepeche:x,doApproach:u,doDeep:g,doOnboard:p,outbound:b,evalBusy:y}=I(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const N=Le(h),E=ze(h),w=mt(h),A=Yt(h),L=h.kind==="target",T=C=>{a({type:"filters",patch:C}),a({type:"popup",id:null})};return qt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Il}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:$l(e.popupAnchor,!!h.card),onClick:C=>C.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(pt(h.date)),Ue(h.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>T({country:[h.cc]}),children:(Mt(h.cc,i)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>T({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>T({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:Rt(h.amountEur,i)})]}),o.pipe&&L&&t.jsxs("div",{className:"pstat",children:[A&&t.jsx("span",{className:"vd "+(A==="MATCH"?"v-ok":"v-no"),title:n.vt[A],children:A}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[bt(h.engine)," ",t.jsx("b",{children:Ue(h.engine,i)})," — ",ni(h.engine,i),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),N?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(wt,{o:h,lg:!0})," ",t.jsx(ja,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(dn(N,i))," · ",n.win7(pa(N,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(Gt,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),o.pipe&&L&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),o.pipe&&L&&t.jsx(hn,{o:h})]}),t.jsx(xn,{name:h.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(h,!1),a({type:"popup",id:null})},children:n.actNo}),zt(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{g(h),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var C;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(C=document.querySelector(".atl2 .demand"))==null||C.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(h.name),onClick:()=>d(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}const _l=8;function Ul(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=I(),[d,c]=m.useState(!1),[f,s]=m.useState(!1),[x,u]=m.useState(!1),g=`atl2:sincemini:${r||"home"}`,[p,b]=m.useState(()=>{try{return localStorage.getItem(g)==="1"}catch{return!1}}),y=()=>{b(C=>{try{localStorage.setItem(g,C?"0":"1")}catch{}return!C})},h=r||"home",{names:N,verdicts:E}=m.useMemo(()=>{const C=[],S={};return n.forEach(j=>{j.kind!=="target"||!j.name||(C.push(j.name),S[j.name]=ri(j)||"")}),{names:C,verdicts:S}},[n]),w=m.useMemo(()=>N.length?oi(h,N,E,a):null,[h,N.length]);if(!i.pipe||d||!w||w.firstVisit||!w.added.length&&!w.gone.length)return null;const A=f?w.added:w.added.slice(0,_l),L=w.added.length-A.length,T=C=>{const S=n.find(j=>j.name===C);S&&(o(S.id),l({type:"popup",id:S.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(w.added.length,w.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:y,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{c(!0),ii(h,N,E,w.fp,a)},children:"×"})]}),!!w.added.length&&t.jsxs("div",{className:"sg-c",children:[A.map(C=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>T(C),children:t.jsx("b",{children:C})},C)),L>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>s(!0),children:e.sinceMore(L)})]}),!!w.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(C=>!C),children:e.sinceOut(w.gone.length)}),x&&w.gone.slice(0,20).map(C=>t.jsx("span",{className:"gone",children:C},C))]})]})}const ro={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function gn({o:e,locked:a=!1}){const{t:r}=I(),n=Yt(e),i=mt(e),o=ze(e),l=Pa(e),d=li(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(ro[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(gs,{o:e})]})}const Lt=e=>e.length>22?e.slice(0,21)+"…":e,ca=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function bn(e){return ca.has(e.engine||"")}function nn(e){return!!e.noCo||bn(e)&&!!e.url}function Wt(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function oo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Hl(e){const r=()=>{const n=oo(),i=e.getBoundingClientRect().top-n-8;Math.abs(i)<2||window.scrollBy({top:i,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function gr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=I(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),De(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Lt(e.name))})]})}function vn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:d,doRepeche:c,doApproach:f,dispatch:s,liveMemos:x}=I();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p=>{p.stopPropagation(),s({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Wt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return bn(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Wt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(gr,{o:e})});const u=ze(e),g=p=>b=>{b.stopPropagation(),p()};if(u===0)return t.jsx("span",{className:"cell",children:t.jsx(gr,{o:e})});if(u===1){const p=x.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Bt,{item:p,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:g(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:g(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:g(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(u===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:g(()=>f(e)),children:p?a.actApproachSent:a.actApproach})})}return u===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:g(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):u===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:g(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:g(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Vl({o:e}){const{t:a,doThumb:r,thumbOf:n}=I(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Wl({o:e}){const{lang:a}=I();return Le(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(wt,{o:e}),t.jsx(ja,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[bt(e.engine||"")," ",Ue(e.engine||"",a)]})})}function Yl({o:e,locked:a,open:r,onToggle:n,selected:i,echo:o,onSelect:l}){const{dispatch:d,caps:c,markRow:f,markedId:s,favIds:x,toggleFav:u,t:g}=I(),p=ze(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,h=y<=0?0:y<=7?1:y<=30?2:3,N=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][p]:b[h],E=x.has(e.id),w=A=>{if(a)return;if(l){l(e.id);return}if(c.pipe||e.kind==="op"){n();return}const L=A.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:L.left+Math.min(280,L.width/3),y:L.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(o?" echo":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>f(e.id),onMouseLeave:()=>f(null),onClick:w,children:[t.jsx("span",{className:"pt",style:{"--c":N}}),t.jsx(po,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:E?1:.35,padding:0,marginRight:4},onClick:A=>{A.stopPropagation(),u(e)},children:E?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(A=>A&&A!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:g.acqSee(e.acquirer),onClick:A=>{A.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",Lt(e.acquirer)]}),gt(e)?t.jsx("span",{className:"rdec",title:g.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:g.zoomNewsMark,children:"📰"}):null]}),t.jsx(Gl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Wl,{o:e}),c.pipe&&t.jsx(gn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(vn,{o:e}),c.showThumbs&&t.jsx(Vl,{o:e})]}),r&&!a&&!l&&t.jsx(Jl,{o:e})]})}function Gl({o:e}){const{lang:a,caps:r}=I();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Rt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Kl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=I(),l=(u,g=!1)=>p=>{p.stopPropagation(),g&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Rt(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=De(e),x=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):nn(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),Wt(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Lt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Lt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Gt,{spec:e.card})})]})}function Ql({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=I();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ue(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(vn,{o:e})}),t.jsx(hn,{o:e})]})}function io({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:d,dossiers:c}=I();if(!e&&!a){const O=c.find(gt);if(O)return t.jsx(io,{o:O})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),s=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),x=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),g=e?!!e.noCo:!f||ua(f),p=(e==null?void 0:e.engine)||"",b=gt(e),y=e?Rt(e.amountEur,n):"",h=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),N=(()=>{const O=/https?:\/\/(?:www\.)?([^/]+)/.exec(s);return O?O[1].replace(/^www\./,"").slice(0,40):""})(),E=c.find(gt),w=((E==null?void 0:E.url)||"").trim(),A=!!s&&!!w&&(s===w||s.endsWith(w)||w.endsWith(s)),L=(O,_=!1)=>v=>{v.stopPropagation(),_&&l({type:"continent",key:"monde"}),l({type:"filters",patch:O})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const T=()=>{f&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:f}}))},C=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},S=()=>{Wt({url:s,headline:x,tagline:e==null?void 0:e.tagline,name:f})},j=e?De(e):!1,M=j&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",D=b?r.doEdito.replace(/^📖\s*/,""):p?Ue(p,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[D,h?` · ${h}`:""]}),t.jsx("h3",{className:"zoom-h",children:x}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{className:"ed-decrypt-b zoom-body",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(Gt,{spec:u})}),(s&&!A||w)&&t.jsxs("div",{className:"zoom-srcbox",children:[s&&!A&&t.jsxs("a",{className:"zoom-src",href:s,target:"_blank",rel:"nofollow noopener",onClick:O=>O.stopPropagation(),children:[r.zoomSrc,N?` · ${N}`:""," ↗"]}),w&&t.jsxs("a",{className:"zoom-src zoom-src-art",href:w,target:"_blank",rel:"noopener noreferrer",onClick:O=>O.stopPropagation(),children:[r.zoomArt," ↗"]})]}),t.jsxs("div",{className:"zoom-acts",children:[j?t.jsxs("span",{className:"verdict",style:{"--c":M?"var(--brand)":"var(--red)"},children:[M?"✓":"✗"," ",t.jsx("b",{children:M?r.kept:r.dropped})]}):!g&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:o,onClick:O=>{O.stopPropagation(),i(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Lt(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,s&&(g||bn({engine:p}))&&t.jsxs("div",{className:"zp-pair",children:[t.jsxs("button",{type:"button",className:"zp-go ghost",onClick:O=>{O.stopPropagation(),window.dispatchEvent(new CustomEvent("ppmap:view",{detail:{url:s}}))},children:[t.jsx("span",{className:"zp-ico",children:"👁"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.viewLink}),t.jsx("em",{children:N||r.zoomSrc})]})]}),t.jsxs("button",{type:"button",className:"zp-go"+(!g&&f?" ghost":""),onClick:O=>{O.stopPropagation(),S()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]})]}),!g&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:O=>{O.stopPropagation(),C()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:O=>{O.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Lt(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!g&&f&&d.pipe&&t.jsx(xn,{name:f})]})]})}function Jl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=I();return!i.pipe&&e.kind==="op"?t.jsx(Kl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(hn,{o:e}),t.jsx(bs,{o:e}),t.jsx(ws,{o:e}),t.jsx(xn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(gn,{o:e})})]}),e.card&&t.jsx(Gt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[bt(e.engine||"")," ",Ue(e.engine||"",r)]}),Le(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(wt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Xl({o:e,locked:a,selected:r,onSelect:n}){const{t:i,dispatch:o,caps:l,doDecide:d,lang:c}=I();if(!l.pipe&&e.kind==="op"){const x=Rt(e.amountEur,c),u=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),g=(p,b=!1)=>y=>{y.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Gt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:g({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:g({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:g({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[bt(e.engine||"")," ",Ue(e.engine||"",c)]}),Le(e)&&t.jsx(wt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(vn,{o:e})})]})}const f=ze(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][f];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(gn,{o:e}),Le(e)&&t.jsx(wt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&f===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:i.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:i.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>o({type:"memoConsole",id:e.id}),children:[i.actMemo," →"]})]})}function Zl(){const{t:e}=I(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function ed({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=I(),o=i==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,x)=>(e[x]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${l(c)}”`:`${f} dossier${f>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(o?"Open ":"Ouvrir ")+l(c)," →"]})]})}function td(){var jt,Me;const e=I(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:d,markRow:c,lang:f,sessTally:s,data:x,dossiers:u,source:g,focusExtra:p,byId:b}=e,y=z=>i.lockRowsAfter!==null||g==="ops"?Number.MAX_SAFE_INTEGER:Cr,[h,N]=m.useState(new Set);m.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[E,w]=m.useState(null);m.useEffect(()=>{w(null)},[a.ptab,a.continent]);const[A,L]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){L(!1);return}const z=document.getElementById("atl2-stage");if(!z){L(!1);return}const P=new IntersectionObserver(([Y])=>L(!!Y&&Y.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return P.observe(z),()=>P.disconnect()},[a.mapFolded]);const T=a.mapFolded||!A,C=z=>N(P=>{const Y=new Set(P);return Y.has(z)?Y.delete(z):Y.add(z),Y}),S=g==="ops"||i.pipe,[j,M]=m.useState("all"),[D,O]=m.useState(null),[_,v]=m.useState(!1),q=m.useRef(!0);m.useEffect(()=>{if(q.current){q.current=!1;return}M("all"),v(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!_)return;const z=P=>{var Y,re;(re=(Y=P.target)==null?void 0:Y.closest)!=null&&re.call(Y,".atl2 .doable")||v(!1)};return document.addEventListener("click",z),()=>document.removeEventListener("click",z)},[_]);const H=Ar(),U=m.useMemo(()=>{var P;const z=new Map;for(const Y of rs(((P=H==null?void 0:H.ed)==null?void 0:P.html)||""))z.has(Y.t)||z.set(Y.t,Y.html);return z},[(jt=H==null?void 0:H.ed)==null?void 0:jt.html]),$=m.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!U.size)return;const P=(z.name||"").trim().toLowerCase();if(P.length<3)return;const Y=U.get(P);if(Y)return Y;for(const[re,Ce]of U)if(re.includes(P)||P.includes(re))return Ce},[U]),V=m.useMemo(()=>{let z=cn(l,a.sort);return z=z.filter(P=>!gt(P)),j==="explore"?z=z.filter(nn):j==="eval"&&(z=z.filter(P=>!P.noCo)),z},[l,a.sort,j,$]),K=m.useMemo(()=>i.pipe?d.filter(z=>Le(z)&&si(z)):V.filter(z=>Le(z)&&!De(z)),[i.pipe,d,V]),Q=K.length,[le,ae]=m.useState(!1),[be,G]=m.useState(!1),pe=`atl2:sigmini:${((Me=x.session)==null?void 0:Me.token)||"home"}`,[oe,we]=m.useState(()=>{try{return localStorage.getItem(pe)==="1"}catch{return!1}}),me=m.useMemo(()=>i.pipe?V:V.filter(z=>!De(z)&&!z.noCo),[V,i.pipe]),Z=g==="ops"?V.filter(z=>z.noCo).length:0,ee=i.pipe?n.plabels[a.ptab].toLowerCase():g==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,J=a.filters,te=[];if(J.day)te.push({k:"day",lib:n.fDay(J.day.slice(8,10)+"/"+J.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(J.win&&J.win!=="all"){const z=["1","7","30"].indexOf(J.win);z>=0&&te.push({k:"win",lib:n.dates[z],off:()=>r({type:"filters",patch:{win:"all"}})})}const xe=z=>z.length<=2?z.join(", "):`${z.length} ${n.fSelected}`;for(const z of["sector","country","engine"]){const P=J[z];P&&P.length&&te.push({k:z,lib:xe(P),off:()=>r({type:"clearFacet",facet:z})})}J.search&&te.push({k:"search",lib:"🔍 "+J.search,off:()=>r({type:"filters",patch:{search:""}})});const W=(z,P,Y="",re=!1)=>t.jsxs("button",{type:"button","data-s":z,className:Y,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:re?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[P,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),ue=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const z=new Map;V.forEach(re=>{const Ce=re.engine||"?";z.has(Ce)||z.set(Ce,[]),z.get(Ce).push(re)});const P={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},Y=Da([...z.keys()],f);return[...z.entries()].sort((re,Ce)=>{const ve=P[re[0]]??10+Y.indexOf(re[0]),Be=P[Ce[0]]??10+Y.indexOf(Ce[0]);return ve-Be})},[V,i.pipe,a.groupBy,f]),ie=ue?ue.filter(([z])=>ca.has(z)).length:0,he=(()=>{var P;return((P=(ue?ue.flatMap(([,Y])=>Y):V)[0])==null?void 0:P.id)??null})(),Oe=m.useRef(!1);m.useEffect(()=>{const z=()=>{Oe.current=!0};return window.addEventListener("ppmap:reveal",z),window.addEventListener("ppmap:focus",z),()=>{window.removeEventListener("ppmap:reveal",z),window.removeEventListener("ppmap:focus",z)}},[]),m.useEffect(()=>{if(!a.focusId)return;O(a.focusId);const z=window.setTimeout(()=>O(null),900);return()=>window.clearTimeout(z)},[a.focusId]),m.useEffect(()=>{S&&(a.focusId&&(V.some(z=>z.id===a.focusId)||u.some(z=>z.id===a.focusId))||p||he&&r({type:"focus",id:he}))},[S,a.focusId,V,he,p,r,u]),m.useEffect(()=>{!S||!a.focusId||j!=="all"&&!V.some(z=>z.id===a.focusId)&&u.some(z=>z.id===a.focusId)&&M("all")},[S,a.focusId,j,V,u]),m.useEffect(()=>{if(!S||!a.focusId||!Oe.current)return;Oe.current=!1;const z=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel");if(!z)return;const P=oo(),Y=z.getBoundingClientRect();Y.top>=P-2&&Y.bottom<=window.innerHeight-4||Hl(z)},[S,a.focusId]),m.useEffect(()=>{if(typeof window>"u")return;const z=document.querySelector(".atl2.ops .listhead"),P=document.querySelector(".atl2.ops");if(!z||!P)return;const Y=()=>P.style.setProperty("--listhead-h",`${z.offsetHeight}px`);Y();const re=new ResizeObserver(Y);return re.observe(z),()=>re.disconnect()},[T,a.dens,a.mapFolded]);const $e=m.useMemo(()=>{if(!S||!a.focusId)return null;const z=V.find(Y=>Y.id===a.focusId)||u.find(Y=>Y.id===a.focusId)||null;if(!z)return null;const P=$(z);return P&&P!==z.decryptHtml?{...z,decryptHtml:P}:z},[S,a.focusId,V,u,$]),qe=i.lockRowsAfter;let He=0;const Xe=(z,P)=>{let Y=a.shown[P]||y();return z.length-Y<=4&&(Y=z.length),z.slice(0,Y).map(ve=>{const Be=qe!==null&&He>=qe;He++;const rt=$(ve),ot=rt&&rt!==ve.decryptHtml?{...ve,decryptHtml:rt}:ve,it=!S&&a.dens!=="maxi"&&(a.dens==="deplie"||(E?E==="open":!!rt)),Nt=h.has(ve.id)?!it:it,Ae=S?st=>{Oe.current=!0,r({type:"focus",id:st});const lt=b.get(st);lt&&(nn(lt)?Wt(lt):lt.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:lt.name}})))}:void 0;return a.dens==="maxi"?t.jsx(Xl,{o:ot,locked:Be,selected:S&&a.focusId===ve.id,onSelect:Ae},ve.id):t.jsx(Yl,{o:ot,locked:Be,open:Nt,onToggle:()=>C(ve.id),selected:S&&a.focusId===ve.id,echo:D===ve.id,onSelect:Ae},ve.id)})},nt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(g==="ops"?" opsl":"")+(V.length?"":" list-empty"),ut=t.jsxs(t.Fragment,{children:[ue?ue.map(([z,P])=>t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:bt(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:z==="ma"?n.grpMa:z==="fundraising"?n.grpLev:ca.has(z)&&ie<=1?n.grpNews:z==="nominations"?n.grpNom:z==="media"?n.grpNewsOther:z==="recrutements"?n.grpHire:ca.has(z)?n.grpNews+" · "+Ue(z,f):Ue(z,f)}),t.jsx("div",{className:"s",children:n.grpCount(P.filter(Y=>!De(Y)).length,P.length)})]})]}),Xe(P,z)]},z)):Xe(V,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(Zl,{}),!V.length&&!(x.loading&&!u.length)&&(i.pipe?t.jsx(ed,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(T?" mapoff":""),children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:V.length})," ",ee]}),t.jsx("span",{className:"dot",children:"·"}),T&&t.jsx(to,{variant:"compact",mapToggle:!0}),t.jsxs("span",{className:"ctx",children:[T?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),te.map(z=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:P=>{P.stopPropagation(),z.off()},children:[z.lib,t.jsx("i",{children:"×"})]},z.k)),g==="ops"&&V.length>0&&" — "+n.edSplit(V.length-Z,Z)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||g==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,P])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:P})]},z))}),!S&&i.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":E==="open",onClick:()=>{w("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":E==="closed",onClick:()=>{w("closed"),N(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||g==="ops")&&(()=>{var Y;const z=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],P=((Y=z.find(([re])=>re===j))==null?void 0:Y[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":_,onClick:()=>v(re=>!re),children:[P,t.jsx("i",{children:"▾"})]}),_&&t.jsx("div",{className:"dolist",children:z.map(([re,Ce])=>t.jsx("button",{type:"button","aria-pressed":j===re,onClick:()=>{M(re),v(!1)},children:Ce},re))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([z,P])=>t.jsx("option",{value:z,children:P},z))})]}),i.showChain&&me.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:me.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(me.length):n.chainAll(me.length)]}),T&&t.jsx(eo,{compact:!0})]}),t.jsx(Ul,{}),Q>0&&!a.filters.signalOnly&&!be&&t.jsxs("div",{className:"sigstrip"+(oe?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(Q)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!oe,title:oe?n.boxExpand:n.boxCollapse,onClick:()=>we(z=>{try{localStorage.setItem(pe,z?"0":"1")}catch{}return!z}),children:oe?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>G(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(le?K:K.slice(0,12)).map(z=>{const P=Le(z);return P?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(dn(P,f),pa(P,f)),onClick:()=>{c(z.id),r({type:"popup",id:z.id})},children:[t.jsx("b",{children:z.name}),t.jsxs("i",{children:[P.emoji," ",Ia(P,f)]}),t.jsx("em",{children:pa(P,f)})]},"sg-"+z.id):null}),!le&&K.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>ae(!0),children:n.sigStripMore(K.length-12)})]})]}),a.dens!=="maxi"&&!S&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),W("country",n.colCountry),W("name",n.colCompany),W("amount",n.colAmount,"h-amt",!0),W("stage",n.colStage,"h-stade"),W("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[W("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),W("memo",n.colMemo)]}),i.pipe&&W("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),S?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),W("country",n.colCountry),W("name",n.colCompany),W("amount",n.colAmount,"h-amt",!0),W("stage",n.colStage,"h-stade"),W("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:nt,children:ut})]}),t.jsx("aside",{className:"readpane","aria-label":f==="fr"?"Dossier":"File",children:i.pipe?t.jsx(Ql,{o:$e}):t.jsx(io,{o:$e,extra:$e?null:p})})]}):t.jsx("div",{className:nt,children:ut}),(()=>{const z=ue||[["pt"+a.ptab,V]];let P=0,Y=0;for(const[Ce,ve]of z){Y+=ve.length;let Be=a.shown[Ce]||y();ve.length-Be<=4&&(Be=ve.length),P+=Math.min(ve.length,Be)}const re=Y-P;return re<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([Ce,ve])=>r({type:"more",group:Ce,by:ve.length,base:y()})),children:[t.jsx("span",{className:"more-label",children:n.more(re,re)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(P,Y)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}})]})}function br(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ad(e,a){const r=di(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function nd(e,a){const n=[a.head.split("|").map(br).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",ad(i,a.plabels),Yt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(br).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function rd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const od=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function et({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function id({o:e,qa:a}){const{t:r,lang:n,fund:i}=I(),o=(e.cribleStatus||"").trim().toUpperCase()||(Yt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=mt(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(et,{k:r.cdSector,v:e.sector}),t.jsx(et,{k:r.cdStage,v:e.stage}),t.jsx(et,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(et,{k:r.cdSite,v:e.domain||e.website}),t.jsx(et,{k:r.cdName,v:e.contactName}),t.jsx(et,{k:r.cdEmail,v:e.contactEmail}),t.jsx(et,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(et,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(et,{k:r.cdAngle,v:e.angle}),t.jsx(et,{k:r.cdDetected,v:od(e.date,n)})]}),c.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,f])=>f).map(([f,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:s})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function sd(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=I(),[d,c]=m.useState({}),f=25,s=m.useMemo(()=>n.slice(0,f),[n]);m.useEffect(()=>{s.length&&ci(r,s.map(g=>g.name)).then(c)},[r,s]);const x=o.stats,u=g=>g.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(x.screened/o.marketEstimate*100)," %"]})]})]}),s.map(g=>t.jsx(id,{o:g,qa:d[g.name]},g.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const ld=50;function yn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=I(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(0),[g,p]=m.useState(""),[b,y]=m.useState(!1),h=m.useRef(null);m.useEffect(()=>()=>{h.current&&window.clearInterval(h.current)},[]);const N=async w=>{c(!0),s("");const A=await a();if(c(!1),A.ok){l(A);return}if(A.busy){s(i.alertPreviewBusy);return}if(!w){s(i.alertPreviewFail);return}u(ld),h.current=window.setInterval(()=>{u(L=>L>1?L-1:(h.current&&window.clearInterval(h.current),N(!1),0))},1e3)},E=async()=>{if(n||b)return;y(!0),p("");const w=await r();y(!1),p(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||x>0,onClick:()=>{N(!0)},children:d?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{E()},children:b?"…":i.alertTest})]}),x>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(x)}),f&&t.jsx("p",{className:"mnote warn",children:f}),g&&t.jsx("p",{className:"mnote",children:g}),!g&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const Ct="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ie({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=I();return qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function dd(){const{st:e}=I();switch(e.modal){case"chain":return t.jsx(pd,{});case"space":return t.jsx(ud,{});case"alert":return t.jsx(md,{});case"queue":return t.jsx(bd,{});case"export":return t.jsx(vd,{});case"plug":return t.jsx(kd,{});case"recharge":return t.jsx(Nd,{});case"cover":return t.jsx(Ed,{});case"dossier":return t.jsx(Sd,{});case"crit":return t.jsx(Cd,{});case"tuto":return t.jsx(zd,{});case"rdv":return t.jsx(cd,{});case"memoalert":return t.jsx(yd,{});default:return null}}function cd(){const{dispatch:e,fund:a,t:r}=I(),n=a||r.rdvCoFallback;return qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:qr,children:un}),r.rdvSubMid,t.jsx("a",{href:`mailto:${fa}`,children:fa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Fi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function pd(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:d,caps:c,memoQueued:f,doAnalyse:s}=I(),x=o==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),g=e.chain.idx,p=u[g],b=g>=u.length;return qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${g+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:g/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[Mt(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(pt(p.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ue(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:Rt(p.amountEur,i)})]}),Le(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(wt,{o:p,lg:!0})," ",t.jsx(ja,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),x&&De(p)&&t.jsxs("div",{className:"vbox",style:{"--c":ht(p)==="retenu"?"var(--brand)":ht(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:ht(p)==="retenu"?"✓ "+n.kept:ht(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&p&&c.pipe&&ze(p)===1&&!f.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&p&&!(x&&De(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function ud(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=I(),o=i==="client",l=m.useMemo(()=>o?r.filter(x=>De(x)):[],[r,o]),d=m.useMemo(()=>cn(l.filter(x=>ht(x)==="retenu"),{key:"signal",dir:-1}),[l]),c=m.useMemo(()=>l.filter(x=>ht(x)==="ecarte"),[l]),f=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ie,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function md(){const{mode:e}=I();return e==="client"||e==="apercu"?t.jsx(fd,{}):t.jsx(gd,{})}function fd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=I(),[o,l]=m.useState("d"),d=i!=="client";return t.jsxs(Ie,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(xd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="w"&&t.jsx(hd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="m"&&t.jsx(so,{})]})}function xd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),Fn(a).then(b=>{p&&(b?l(b):c(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||Fn(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),g=p=>{const b=o.sections||e.alertSec.map(([y])=>y);x({sections:u(p)?b.filter(y=>y!==p):[...b,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>g(p)}),t.jsxs("span",{children:[b,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(yn,{label:e.alertPreview,readOnly:r,onPreview:()=>yi(a),onTest:()=>vi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function hd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),On(a).then(b=>{p&&(b?l(b):c(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||On(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,g=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>x({dow:Number(p.target.value)}),children:e.alertDow.map((p,b)=>t.jsx("option",{value:b,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,g-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[g," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,g+1)}),disabled:r,children:"＋"})]})]}),t.jsx(yn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ki(a),onTest:()=>wi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function so(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=I(),[l,d]=m.useState(o||""),[c,f]=m.useState(!1),[s,x]=m.useState(!1);m.useEffect(()=>{o&&d(o)},[o]);const u=e.filters,g=m.useMemo(()=>n.filter(h=>Le(h)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){x(!0);try{await fetch(`${rn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{x(!1)}}},y=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>Ue(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>Mt(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([h,N])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:N}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:h=>d(h.target.value),onKeyDown:h=>{h.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,g)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function gd(){const{t:e}=I();return t.jsx(Ie,{title:e.alertTitle,icon:"🔔",children:t.jsx(so,{})})}function bd(){var C,S;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:d,dispatch:c,liveMemos:f}=I(),[s,x]=m.useState(null),[u,g]=m.useState([]),[p,b]=m.useState(0),y=n==="client",h=m.useMemo(()=>{const j=new Map;return i.forEach(M=>{const D=(M.name||"").trim().toLowerCase();D&&!j.has(D)&&j.set(D,M)}),j},[i]);m.useEffect(()=>{let j=!0;return(async()=>{const[M,D]=await Promise.all([sn(r),jr(a)]);j&&(M&&x(M),g(D))})(),()=>{j=!1}},[a,r,p]);const N=(s==null?void 0:s.per_day)??0,E=((C=s==null?void 0:s.analyzed_today)==null?void 0:C.length)??0,w=s==null?void 0:s.offre,A=(s==null?void 0:s.pool_meta)||[],L=m.useMemo(()=>{const j=new Map;for(const M of(s==null?void 0:s.scheduled)||[])for(const D of M.names||[])j.has(D)||j.set(D,{label:M.day_label,date:M.date});return j},[s==null?void 0:s.scheduled]),T=(s==null?void 0:s.in_progress)||[];return t.jsxs(Ie,{title:e.queueTitle,wide:!0,children:[w&&t.jsxs("div",{className:"qoffre"+(w.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:w.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:w.delai})]}),t.jsx("span",{className:"osp"}),w.rythme>0?t.jsx("span",{className:"or",children:e.qRate(w.rythme)}):w.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(w.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(E,E+(((S=s==null?void 0:s.pool_order)==null?void 0:S.length)??0))}})}),w&&t.jsxs("div",{className:"qeta",children:[w.file===0?e.qEtaDone:w.rythme<=0?e.qEtaPaused:e.qEta(w.file,w.rythme,w.jours_restants),w.en_retard&&t.jsxs("em",{children:[" ",e.qLate(w.delai,w.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(w==null?void 0:w.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(T.length>0||f.items.some(j=>j.status==="boot"||j.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[f.items.filter(j=>j.status==="boot"||j.status==="running"||j.status==="error").map(j=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:j.name}),t.jsx("span",{className:"qd",children:j.memoType||""}),t.jsx(Bt,{item:j,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+j.name)),T.filter(j=>!f.liveOf(j.name)).map(j=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:j.name}),t.jsxs("span",{className:"qd",children:[j.memo_type||"",j.age_min?` · ${Math.round(j.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:j.state||""})]},"ip-"+j.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(j=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:j.company}),t.jsxs("span",{className:"qd",children:[j.memo_type,typeof j.est_min=="number"?` · ~${j.est_min} min`:""]}),t.jsx("span",{className:"qt",children:j.status}),j.url&&t.jsx("a",{className:"qgo",href:j.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),y&&j.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Rn(a,j.company,"retry").then(()=>b(M=>M+1))},children:e.queueRetry}),y&&j.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Rn(a,j.company,"delete").then(()=>b(M=>M+1))},children:e.queueDelete})]},j.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(A.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[A.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),A.map((j,M)=>{const D=L.get(j.name),O=h.get((j.name||"").trim().toLowerCase()),_=f.liveOf(j.name),v=!!(O&&l.has(O.id))||!!(_&&(_.status==="boot"||_.status==="running")),q=!!(O&&ze(O)===1&&!O.memoUrl)&&!_;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",M+1]}),D?t.jsx("span",{className:"qwhen"+(D.label==="demain"?" soon":""),children:D.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:j.name}),j.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof j.score=="number"&&t.jsx("span",{className:"qs2",children:j.score}),_&&(_.status==="boot"||_.status==="running")&&t.jsx(Bt,{item:_,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),q&&(d.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:v,onClick:()=>{o(O),b(H=>H+1)},children:v?e.actAnalyseQueued:e.actAnalyse})),j.excerpt&&t.jsx("span",{className:"qex",children:j.excerpt})]},j.name+":"+M)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([j,M])=>t.jsxs("li",{children:[t.jsx("b",{children:j})," — ",M]},j))})]})}function vd(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=I(),d=`${Ct}/cibles/list.csv?token=${a}`,c=`${Ct}/cibles/list.json?token=${a}`,f=`${Ct}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,x=y=>{var h;(h=navigator.clipboard)==null||h.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:f,href:f}],g=!i.lockActions&&n.length>0,p=()=>{rd(nd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:y=>(e.stg.find(([h])=>h===y)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ie,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:h,href:N})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(h),children:e.exportCopy}),N&&t.jsx("a",{className:"exb",href:N,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function yd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=I(),o=i!=="client",[l,d]=m.useState(null),[c,f]=m.useState(!1),[s,x]=m.useState(0),[u,g]=m.useState(!1);m.useEffect(()=>{let h=!0;return f(!1),Mn(a).then(N=>{h&&(N?d(N):f(!0))}),()=>{h=!1}},[a,s]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=h=>{if(o||!l)return;const N={enabled:h.enabled??!!l.enabled,email:h.email??(l.email||""),sections:h.sections??p()};g(!0),Mn(a,N).then(E=>{if(g(!1),!E){n(e.memoAlertErr);return}d(E),r(e.memoAlertSaved)})};if(c)return t.jsx(Ie,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(h=>h+1),children:e.retry})]})});if(!l)return t.jsx(Ie,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=p();return t.jsxs(Ie,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(wd,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>b({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,N])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[h],disabled:o||u,onChange:()=>b({sections:{...y,[h]:!y[h]}})}),t.jsx("span",{children:N})]},h))}),t.jsx(yn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>ui(a,y),onTest:()=>pi(a,y)})]})}function wd({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const d=o.trim()!==e.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&d&&c&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>i(o.trim()),children:n})]})]})}function kd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=I(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(null),[x,u]=m.useState(""),[g,p]=m.useState(0);m.useEffect(()=>{let E=!0;return c(!1),$a(a).then(w=>{E&&(w?l({configured:w.configured,url_hint:w.url_hint}):c(!0))}),xi(a).then(w=>{E&&s(w)}),()=>{E=!1}},[a,g]);const b=(E,w)=>{i&&$a(a,E).then(A=>{if(!A||A.ok===!1){n(e.actErr);return}E.test&&A.sent===!1?n(e.plugTestThrottled):r(w),p(L=>L+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),N=`curl -X POST ${Ct}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ie,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(E=>E+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!i,onChange:E=>u(E.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!x.trim(),onClick:()=>b({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(jd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:N}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(N).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function jd(){const{t:e,token:a,lang:r}=I(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[d,c]=m.useState(null),[f,s]=m.useState(null),[x,u]=m.useState(!1),[g,p]=m.useState(!1),[b,y]=m.useState(null),[h,N]=m.useState(null),[E,w]=m.useState(null),A=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{$a(a).then(D=>{N(D&&D.configured?D.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{c(null),s(null),u(!1),y(null);try{const D=JSON.parse(localStorage.getItem(A)||"null");w(D&&Date.now()-Date.parse(D.t)<24*3600*1e3?D:null)}catch{w(null)}},[A]);const L=async()=>{l(!0),u(!1),y(null);const D=await gi(a,n);c(D),s(D.ok?n:null),l(!1)},T=m.useRef(!1),C=async()=>{if(T.current)return;T.current=!0,p(!0);const D=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let O;try{O=await bi(a,n,"webhook",void 0,D)}finally{T.current=!1}if(p(!1),u(!1),y(O),O.ok&&(O.pushed||0)>0){const _={t:new Date().toISOString(),n:O.pushed||0};w(_);try{localStorage.setItem(A,JSON.stringify(_))}catch{}}},S=d!=null&&d.ok&&d.ready||0,j=!!(d!=null&&d.ok)&&f===n&&S>0&&!!h&&!E,M=E?new Date(E.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:D=>i(D.target.value),children:e.plugBulkTabs.map(([D,O])=>t.jsx("option",{value:D,children:O},D))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{L()},children:o?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),E&&t.jsx("p",{className:"mnote",children:e.bulkLocked(M,E.n)}),!E&&!!(d!=null&&d.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!E&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),j&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),j&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(S,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:g,onClick:()=>{C()},children:g?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:g,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function Nd(){const{t:e,data:a,lang:r}=I(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const d=window.location.href.split("?")[0];try{const f=await(await fetch(`${rn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(Ie,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Sd(){const{t:e}=I();return t.jsx(Ie,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(sd,{})})}function Ed(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:d}=I(),[c,f]=m.useState(null),[s,x]=m.useState(!1);m.useEffect(()=>{let S=!0;if(o)return sn(o).then(j=>{S&&j&&typeof j.per_day=="number"&&f(j.per_day)}),()=>{S=!1}},[o]);const[u,g]=m.useState(null);m.useEffect(()=>{if(!i)return;let S=!0;return fi(i).then(j=>{S&&g(j)}),()=>{S=!1}},[i]);const p=r.stats,b=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(S=>S.kind==="target"&&De(S)).length,y=r.marketEstimate||0,h=y>0?Math.min(100,Math.round(b/y*100)):null,N=(p==null?void 0:p.window_days)||30,E=b>0?b/N:0,w=y>0?Math.max(0,y-b):0,L=y>0&&E>0&&b>=100?Math.round(w/E):null,T=S=>Math.round(S).toLocaleString(a==="en"?"en-US":"fr-FR"),C=S=>{s||!l||(x(!0),hi(i,S).then(j=>{if(x(!1),j===null){d(e.actErr);return}f(j),d(e.alertSaved)}))};return t.jsxs(Ie,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(T(b))}),y>0&&t.jsx("span",{children:e.covOf(T(y))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),L!==null&&t.jsx("p",{className:"mnote",children:e.covEta(L)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(T(E))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((S,j)=>t.jsxs("tr",{className:S.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[S.code,S.geo?` · ${S.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof S.n=="number"?T(S.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:S.source}),S.elargi&&t.jsx("em",{children:e.covWide(String(S.demande||""))}),S.erreur&&t.jsx("em",{children:e.covMissing})]})]},j)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:T(u.total||y)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:T(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:T(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:T(p.shown)})," ",e.funShown]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(S=>t.jsx("button",{type:"button",className:c===S?"on":"",disabled:s,onClick:()=>C(S),children:S===0?"⏸":S},S))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Cd(){var h,N,E;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:d}=I(),c=n==="client",f=m.useMemo(()=>{const w=new Set;return a.forEach(A=>{A.angle&&w.add(A.angle)}),[...w]},[a]),[s,x]=m.useState(""),[u,g]=m.useState(""),[p,b]=m.useState(!1),y=async()=>{const w=s.trim();if(!(!w||p||!c)){b(!0),g("");try{const L=await(await fetch(`${Ct}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(L.reply&&g(String(L.reply)),L.job_id){g(e.critChatRunning);const T=async()=>{const C=await fetch(`${Ct}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:L.job_id})}).then(S=>S.json()).catch(()=>null);if(C&&C.done){g(String(C.reply||C.clarification||C.summary||"✓")),b(!1),C.applied&&i(e.alertSaved);return}setTimeout(()=>{T()},8e3)};setTimeout(()=>{T()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(Ie,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((h=o.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((N=o==null?void 0:o.angles)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var A,L;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((A=w.look)!=null&&A.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(T=>t.jsx("li",{children:T},T))})]}),!!((L=w.out)!=null&&L.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(T=>t.jsx("li",{children:T},T))})]})]})]},w.title)})]}),!!((E=o==null?void 0:o.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||p,onChange:w=>x(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!c||p||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(mi,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(ro[w]||"v-cons"),children:w}),t.jsx("span",{children:A})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",A]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function zd(){const{t:e,dispatch:a,startTour:r}=I(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ie,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const lo="atl2:mapfold",Ad=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(lo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Td=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},co=m.createContext(null),I=()=>{const e=m.useContext(co);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function wt({o:e,lg:a}){const{lang:r}=I(),n=Le(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ia(n,r),children:[n.emoji," ",Ia(n,r)]}):null}function ja({o:e,src:a}){const{lang:r,t:n}=I(),i=Le(e);if(!i)return null;const o=zi(i),l=Ai(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(dn(i,r))+" · "+n.win7(pa(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<o?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Ld(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=Ye(a);if(i)return e.find(o=>Ye(o.name)===i)||e.find(o=>{const l=Ye(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function qd(){const{scoped:e,t:a,st:r,dispatch:n}=I(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.filter(x=>!gt(x)),d=l.length,c=l.filter(x=>!x.noCo).length,f=l.filter(x=>!!x.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const x=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",f," ",a.zoomPulseExplore]})]})]})}function po({o:e}){const{lang:a}=I(),r=Ci(e.cc),n=e.cc?Mt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const vr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Md=!1;function Rd(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const uo=e=>`atl2:tour:${e||"anon"}`;function Fd(e){try{return localStorage.getItem(uo(e))==="1"}catch{return!0}}function yr(e){try{localStorage.setItem(uo(e),"1")}catch{}}function Od(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Bd({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var wn;const{lang:l}=ji(),d=_i[l],c=Zi(e,l,a),[f,s]=m.useReducer(as,void 0,()=>es((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Td():Ad()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=m.useRef(!0);m.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(lo,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e,a]);const u=m.useRef(o);u.current=o,m.useEffect(()=>{var k;(k=u.current)==null||k.call(u,f.filters)},[f.filters]);const[g,p]=m.useState(null),[b,y]=m.useState(null),[h,N]=m.useState(null),[E,w]=m.useState({kept:0,dropped:0}),[A,L]=m.useState(!1),[T,C]=m.useState(""),[S,j]=m.useState(!1),[M,D]=m.useState(null),[O,_]=m.useState(!1),[v,q]=m.useState(!1),[,H]=m.useState(0),U=()=>H(k=>k+1),$=m.useRef([]),V=m.useRef(new Set),K=m.useRef(new Set),[Q,le]=m.useState([]),[ae,be]=m.useState([]),[G,pe]=m.useState(0),oe=m.useRef(new Map),we=m.useRef(null),{mode:me}=c,Z=m.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),ee=Z.pipe,J=c.session.token||"",te=me==="client"&&!e;m.useEffect(()=>{if(!J||!ee)return;let k=!0;const B=async()=>{const de=await Ti(J);!k||!de||(be(de.runs),pe(Date.now()/1e3-de.now),le(ke=>ke.filter(Te=>!de.runs.some(Ze=>Ye(Ze.company)===Ye(Te.name)))))};B();const F=Q.length>0||ae.some(de=>de.status==="running"),X=window.setInterval(()=>{B()},F?8e3:25e3);return()=>{k=!1,window.clearInterval(X)}},[J,ee,Q.length,ae.some(k=>k.status==="running")]);const xe=m.useMemo(()=>{const k=[],B=new Set;for(const F of Q){const X=Ye(F.name);!X||B.has(X)||(B.add(X),k.push({name:F.name,id:F.id,status:"boot",started:F.started,estMin:F.estMin,memoType:"instant"}))}for(const F of ae){const X=Ye(F.company);if(!X||B.has(X))continue;B.add(X);const de=F.status==="error"?"error":F.status==="done"?"done":"running";k.push({name:F.company,status:de,started:F.started||0,estMin:F.est_min||(F.memo_type==="detailed"?40:15),url:F.url,error:F.error,memoType:F.memo_type})}return k},[Q,ae]),W=k=>xe.find(B=>Ye(B.name)===Ye(k))||null,ue=(k,B)=>{le(F=>F.some(X=>Ye(X.name)===Ye(k.name))?F:[...F,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:B==="detailed"?40:15}]),V.current.add(k.id),U()};m.useEffect(()=>{if(document.querySelector(`link[href="${vr}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=vr,document.head.appendChild(k)},[]);const ie=(k,B=!1)=>{C(k),j(B),we.current&&clearTimeout(we.current),we.current=setTimeout(()=>C(""),B?4200:2400)},he=k=>ie(k,!0),Oe=m.useMemo(()=>{const k=new Map;return c.dossiers.forEach(B=>{B.id&&k.set(B.id,B)}),k},[c.dossiers]),$e=m.useMemo(()=>c.dossiers.filter(k=>zr(k,f,ee)),[c.dossiers,f,ee]),qe=m.useRef(!1);m.useEffect(()=>{if(qe.current||e||c.loading||!c.dossiers.length)return;if(!Z.showFunnel||Fd(c.session.token||"")){qe.current=!0;return}qe.current=!0;const k=window.setTimeout(()=>{yr(c.session.token||""),_(!0)},700);return()=>window.clearTimeout(k)},[e,c.loading,c.dossiers.length,Z.showFunnel,c.session.token]);const He=m.useMemo(()=>c.dossiers.filter(k=>ns(k,f,ee,c.favIds)),[c.dossiers,f,ee,c.favIds]),Xe=m.useMemo(()=>Ni($e,c.favIds),[$e,c.favIds]),nt=m.useRef(!1);m.useEffect(()=>{if(nt.current)return;if(!ee||a==="ops"){nt.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){nt.current=!0;return}if(c.loading)return;nt.current=!0;const k=Si(Xe);k!==f.ptab&&s({type:"ptab",tab:k})},[ee,a,n==null?void 0:n.ptab,c.loading,Xe,f.ptab]);const ut=m.useMemo(()=>{const k=Rr(c.dossiers);return k?pt(k)===0?d.tourToday:Fr(k,l):d.tourNoRun},[c.dossiers,d,l]),jt=m.useMemo(()=>c.dossiers.some(k=>!!k.memoUrl||!!k.summary||zt(k)),[c.dossiers]),[Me,z]=m.useState(!1);m.useEffect(()=>{if(c.loading){z(!1);return}if(c.dossiers.length>0||c.error){z(!0);return}const k=window.setTimeout(()=>z(!0),6e3);return()=>window.clearTimeout(k)},[c.loading,c.dossiers.length,c.error]);const P=(c.marketEstimate||0)>0||typeof((wn=c.stats)==null?void 0:wn.screened)=="number"&&c.stats.screened>0,Y=m.useMemo(()=>[1,0,2,4,5,3].find(k=>(Xe[k]||0)>0)??0,[Xe]),re=ln.find(k=>k.key===f.continent),Ce=f.continent==="monde"?d.contWorld:(l==="fr"?re==null?void 0:re.fr:re==null?void 0:re.en)||"";m.useEffect(()=>{const k=B=>{var X;const F=(((X=B.detail)==null?void 0:X.name)||"").trim();F&&ve(null,F)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),m.useEffect(()=>{if(a!=="ops")return;const k=B=>{const F=B.detail||{},X=String(F.id||"").trim(),de=String(F.name||"").trim(),ke=String(F.url||"").trim(),Te=X&&Oe.get(X)||Ld(c.dossiers,de,ke);if(Te){y(null),window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Te.id}),(Te.noCo||["media","nominations","recrutements"].includes(Te.engine||""))&&(Te.url||Te.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Te.url||"",text:[Te.headline,Te.tagline].filter(Boolean).join(`
`)}})):Te.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Te.name}}));return}!de&&!ke||(s({type:"focus",id:null}),y({name:de,headline:String(F.text||"").trim()||de,url:ke,card:F.card}),ke&&(ua(de)||!de)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:ke,text:String(F.text||"").trim()}})):de&&!ua(de)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:de,url:ke}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),m.useEffect(()=>{const k=X=>{const de={},ke=String((X==null?void 0:X.sector)||"").trim();ke&&(de.sector=[ke]);const Te=String((X==null?void 0:X.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Te)&&(de.day=Te);const Ze=String((X==null?void 0:X.search)||"").trim();Ze&&(de.search=Ze);const ye=String((X==null?void 0:X.dealKind)||"").trim();(ye==="ma"||ye==="levee"||ye==="other")&&(de.dealKind=[ye]),Object.keys(de).length&&s({type:"filters",patch:de})},B=X=>k(X.detail),F=X=>{X.data&&X.data.type==="pp-filter"&&k(X.data)};return window.addEventListener("ppmap:filter",B),window.addEventListener("message",F),()=>{window.removeEventListener("ppmap:filter",B),window.removeEventListener("message",F)}},[]),m.useEffect(()=>{const k=B=>{var de;const F=(((de=B.detail)==null?void 0:de.name)||"").trim().toLowerCase();if(!F)return;const X=c.dossiers.find(ke=>(ke.name||"").trim().toLowerCase()===F);X&&s(a==="ops"?{type:"focus",id:X.id}:{type:"popup",id:X.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const ve=(k,B)=>{const F=((k==null?void 0:k.name)||B||"").trim();if(!te){N({kicker:F});return}!F||A||(L(!0),(async()=>{try{let X=F;const de=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(de)X=de;else try{const ye=await Li(F);if(ye!=null&&ye.website)X=ye.website;else if(((ye==null?void 0:ye.candidates)||[]).length===1)X=ye.candidates[0].url;else if(((ye==null?void 0:ye.candidates)||[]).length>1){$.current=[{name:F,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(ye.candidates||[]).slice(0,5)},...$.current].slice(0,8),U();return}}catch{}const ke=await Sr(J,X,"atelier2"),Te={name:ke.company||F,verdict:ke.verdict,reason:ke.reason||"",remaining:ke.remaining??null};$.current=[Te,...$.current].slice(0,8),ke.verdict==="kept"&&w(ye=>({...ye,kept:ye.kept+1})),ke.verdict==="ruled_out"&&w(ye=>({...ye,dropped:ye.dropped+1}));const Ze=k||c.dossiers.find(ye=>(ye.name||"").toLowerCase()===F.toLowerCase());Ze&&(ke.verdict==="kept"?Ze.verdict=Ze.verdict||"MATCH":ke.verdict==="ruled_out"&&(Ze.verdict="NO MATCH"),ke.reason&&(Ze.reasoning=ke.reason)),U()}finally{L(!1)}})())},Be=k=>{if(!te){N({kicker:k.name});return}ue(k,"instant"),Ft(J,"fast_request",k.name||"",""),ie(d.memoInstantSent(k.name))},rt=k=>oe.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),ot=(k,B)=>s({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:B}}),it=async(k,B,F)=>{const X=k.ceoStatus||"";k.ceoStatus=B,U();const de=await Ea(J,{status:B,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(F==null?void 0:F.note)!==void 0?{note:F.note}:{},...F!=null&&F.via?{via:F.via}:{}});return de.ok?de.skipped?(k.ceoStatus=X,U(),he(d.actNotPersisted),!1):((F==null?void 0:F.undo)!==!1&&ot(k,X),F!=null&&F.msg&&ie(F.msg),(B==="Validé"||B==="Écarté")&&!k.ceoNote&&(F==null?void 0:F.note)===void 0&&D({o:k,yes:B==="Validé"}),!0):(k.ceoStatus=X,U(),he(d.actErr),!1)},Nt=async(k,B)=>{const F=await Ea(J,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:B,via:"note"});return!F.ok||F.skipped?(he(F.skipped?d.actNotPersisted:d.actErr),!1):(k.ceoNote=B,U(),!0)},Ae=m.useRef(new Map),st=k=>Ae.current.has(k.id)?Ae.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),lt=(k,B)=>{Ae.current.set(k.id,B),U()},Na=(k,B)=>{te&&it(k,B?"Validé":"Écarté",{msg:B?d.decidedYes(k.name):d.decidedNo(k.name)})},R=k=>{te&&it(k,"À trancher",{msg:d.promoted(k.name)})},ne=k=>{te&&(async()=>{const B=k.ceoStatus||"";k.ceoStatus="Retenu",U();const F=await Ea(J,{status:"Retenu",check_id:k.checkId,company:k.name});if(!F.ok||F.skipped){k.ceoStatus=B,U(),he(F.skipped?d.actNotPersisted:d.actErr);return}ot(k,B),ie(d.repeched(k.name))})()},se=()=>{const k=f.undo[f.undo.length-1];if(!k){ie(d.undoNone);return}const B=Oe.get(k.id);if(!B){s({type:"undoPop"}),ie(d.undoNone);return}let F=k.prevCeoStatus;if(!F)if((B.verdict||"").toUpperCase().includes("CALL"))F="À trancher";else{ie(d.undoLockedTitle);return}(async()=>await it(B,F,{undo:!1})&&(s({type:"undoPop"}),B.ceoStatus=k.prevCeoStatus,U(),ie(d.undoDone(B.name))))()},fe=k=>{te&&(K.current.add(k.id),U(),(async()=>{const B=await qi(J,k.name,"email");if(!B||B.ok===!1){K.current.delete(k.id),U(),he(d.actErr);return}Ft(J,"approach",k.name||"",""),ie(d.actApproachSent)})())},Ve=(k,B)=>{te&&(async()=>{if(!(await Ft(J,B?"yes":"no",k.name||"","")).ok){he(d.actErr);return}oe.current.set(k.id,B?"yes":"no"),U(),ie(B?d.thumbUpDone:d.thumbDnDone)})()},Pe=k=>{!te||!zt(k)||(ue(k,"detailed"),Ft(J,"detailed_request",k.name||"",""),ie(d.memoDeepSent(k.name)))},Ne=k=>{const B=new Set(c.favIds),F=B.has(k.id);F?B.delete(k.id):B.add(k.id),c.setFavIds(B),te&&Mi(J,{id:k.id,co:k.name},F)},We=()=>{!te||v||window.confirm(d.identSyncConfirm)&&(q(!0),(async()=>{const k=await Ri(J);q(!1),k?ie(d.identSyncDone):he(d.actErr)})())},Kt=/proplace/i.test(c.fund||""),Qt=k=>{!te||!Kt||(Ft(J,"onboard_request",k.name||"",""),ie(d.onboardSent(k.name)))},mo={st:f,dispatch:s,t:d,lang:l,mode:me,caps:Z,pipe:ee,token:J,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:ne,thumbOf:rt,canWrite:te,commitStatus:it,saveNote:Nt,stageOf:st,setStage:lt,flashErr:he,startTour:()=>_(!0),dossiers:c.dossiers,scopedAll:$e,scoped:He,counts:Xe,byId:Oe,contName:Ce,favIds:c.favIds,toggleFav:Ne,askEvaluate:ve,doAnalyse:Be,doDecide:Na,doPromote:R,doApproach:fe,doThumb:Ve,doDeep:Pe,doUndo:se,doSync:We,doOnboard:Qt,outbound:Kt,memoQueued:V.current,liveMemos:{items:xe,serverOff:G,liveOf:W},approachDone:K.current,sessTally:E,evalCards:$.current,evalBusy:A,markRow:p,markedId:g,flash:ie,focusExtra:b};m.useEffect(()=>{const k=B=>{B.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const fo=k=>J?t.jsx(os,{token:J,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(co.Provider,{value:mo,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(J?" cibles":""),children:[t.jsx("style",{children:Vi}),Z.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:qr,children:un}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${fa}`,children:fa})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),fo(t.jsxs("div",{className:"app"+(ee?" pipe":"")+(J?" has-thesis":""),children:[Z.showTicker&&t.jsx(Re,{name:"live",children:t.jsxs("div",{className:"live-stack"+(J?" live-stack--cibles":""),children:[t.jsx(ps,{}),!!J&&t.jsx(is,{})]})}),Z.showIdent&&t.jsx(Re,{name:"identite",children:t.jsx(Ns,{})}),!1,!!J&&t.jsx(Re,{name:"brief",children:t.jsx(ss,{})}),Md,Z.showMorning&&t.jsx(Re,{name:"matin",children:t.jsx(js,{})}),t.jsx(Re,{name:"mesure",children:t.jsx(xs,{})}),Z.showFunnel&&t.jsx(Re,{name:"entonnoir",children:t.jsx(Pd,{})}),Z.showFunnel&&t.jsx(Re,{name:"tunnel",children:t.jsx(Ss,{})}),Z.showFunnel&&t.jsx(Re,{name:"tuto",children:t.jsx(Es,{})}),!f.mapFolded&&t.jsx(Re,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(to,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(qd,{}),t.jsx(jl,{}),t.jsx(eo,{})]})]})}),Z.showDemand&&ee&&t.jsx(Re,{name:"direct",children:t.jsx(Ii,{items:xe,serverOff:G,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),Z.showDemand&&t.jsx(Re,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Ll,{})})}),Z.showDemand&&f.memoConsole&&t.jsx(Re,{name:"console",children:t.jsx(Ml,{})}),t.jsx(Re,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(td,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),f.popupId&&f.dens!=="liste"&&a!=="ops"&&t.jsx(Re,{name:"fiche",children:t.jsx(Bl,{})}),t.jsx(Re,{name:"modales",children:t.jsx(dd,{})}),t.jsx(fs,{}),M&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:M.o.name}),t.jsx(ys,{placeholder:M.yes?d.whyYesPh:d.whyNoPh,onDone:k=>{const B=M.o;D(null),k&&Nt(B,k).then(F=>{F&&ie(d.csNoteSaved)})}})]}),O&&Me&&t.jsx(ks,{steps:Od(d,ut,jt,Y,P),onClose:()=>{_(!1),yr(J)}}),t.jsx(Rd,{}),T&&t.jsx("div",{className:"flash on"+(S?" err":""),children:T}),h&&t.jsx(Ei,{variant:"acquirer",initialCompany:wr().co,initialWebsite:wr().site,onClose:()=>N(null)})]})})}function Pd(){const{t:e}=I(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function wr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Dd(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{po as FlagCell,wt as SigBadge,ja as SigWin,Bd as default,Dd as fmtShort,I as useV2};
