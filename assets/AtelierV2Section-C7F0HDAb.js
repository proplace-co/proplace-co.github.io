...
/* Sticky : URL s'aligne sur la colonne liste (62 retenues), pas sur l'édito. */
@media (min-width:861px){
  body.pp-desk .atl2.cibles.url-stuck .eval-stick{
    width:calc(62% + var(--v3-pad,24px));box-sizing:border-box}
}
...
`,Tl=Cl+zl+Al+ql;function bn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ll(){const e=bn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Fl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ll();return r==="0"?"client":r==="1"||bn("embed")==="1"&&bn("chrome")==="1"?"apercu":"client"}const Rl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ol=e=>Rl[e];function Da(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Lt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!vo(a)||Da(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ji(e.cc)})};function tn(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ml=60*60*1e3;function Dl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ml?null:a}catch{return null}}function va(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Il=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Pl(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:_i(),[e,n]),i=p.useMemo(()=>n?"visiteur":Fl(e,o),[e,o,n]),d=p.useMemo(()=>Ol(i),[i]),s=i!=="visiteur",l=Il(r),[h,c]=p.useState([]),[g,f]=p.useState(""),[b,m]=p.useState(null),[v,w]=p.useState(null),[u,y]=p.useState(null),[E,k]=p.useState(()=>new Map),[j,N]=p.useState(()=>new Map),[q,S]=p.useState(""),[L,z]=p.useState(new Set),[M,$]=p.useState(null),[U,F]=p.useState(!0),[x,T]=p.useState(!1),[D,Y]=p.useState(0),[ee,C]=p.useState(0),B=p.useRef(0),I=p.useMemo(()=>{var H;if(i!=="client")return"";try{return((H=Bi())==null?void 0:H.email)||""}catch{return""}},[i]);p.useEffect(()=>{const H=++B.current;let ce=!0;const te=()=>ce&&H===B.current,le=(s&&o.token?o.token:"pub:"+a)+(l?":"+l:""),xe=Dl(le);return xe?(c(xe.objs.map(Lt)),xe.fund&&f(xe.fund),m(xe.marketEstimate??null),w(xe.criteria??null),y(xe.stats??null),S(xe.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const he=await Ja(),we=((he==null?void 0:he.recent_ops)||[]).map(pe=>{const Ne=za(pe.company_name||pe.title?pe:{...pe,title:(pe.headline_fr||pe.headline||"").slice(0,120)},a),ze=String(pe.rubrique||"").toLowerCase();return Ne&&(ze==="nominations"||ze==="recrutements")&&(Ne.engine=ze),Ne&&!String(pe.company_name||"").trim()&&(Ne.noCo=!0),Ne}).filter(pe=>!!pe).map(pe=>(vo((pe.name||"").trim())||(pe.noCo=!0),pe));try{const pe=$i(),Ne=await Ui(),ze=((Ne==null?void 0:Ne.date)||"").slice(0,10),ue=pe?pe.doc:Ne,be=Hi(ue),ye=((pe==null?void 0:pe.day)||(ue==null?void 0:ue.date)||ze||"").slice(0,10);if(ye&&be.length){const Z=new Set;for(const P of we){if((P.date||"").slice(0,10)!==ye)continue;const Q=tr(be,Z,P.name,"");Q>=0&&(Z.add(Q),P.decryptHtml=be[Q].html)}for(const P of we){if(P.decryptHtml||(P.date||"").slice(0,10)!==ye)continue;const Q=tr(be,Z,"",P.headline||P.tagline||P.name);Q>=0&&(Z.add(Q),P.decryptHtml=be[Q].html)}}if(ye){const Z=((ue==null?void 0:ue.title_fr)||"").trim(),P=((ue==null?void 0:ue.lead_fr)||"").trim(),Q=Vi(ue),ie=((ue==null?void 0:ue.url)||"").trim();Z&&(Q||ie)&&we.unshift({id:`edito:${ye}`,kind:"op",name:Z,cc:null,date:ye,engine:"edito",dealKind:"other",headline:Z,tagline:P||Z,decryptHtml:Q||void 0,url:ie,noCo:!0})}}catch{}if(!te())return;c(we.map(Lt)),va(le,{objs:we})}else if(typeof r=="object"){const we=(await ar()||[]).filter(Ne=>(Ne.slug||"")===r.research).map(Ne=>nr(Ne,a)).filter(Ne=>!!Ne),pe=tn(await rr(we,a));if(!te())return;c(pe.map(Lt)),va(le,{objs:pe})}else if(s&&o.token){const he=Wi(o.token),we=Ja(),pe=Gi(o.token),Ne=Yi(o.token),ze=Qi(o.token),ue=await he;let be=ue?ue.targets:[];te()&&ue&&(f(ue.fund||""),m(ue.marketEstimate??null),w(ue.criteria??null),y(ue.stats??null),S(ue.generatedAt||""),c(be.map(Lt)),F(!1),T(!1));const[ye,Z,P,Q]=await Promise.all([we,pe,Ne,ze]),ie=((ye==null?void 0:ye.recent_ops)||[]).map(W=>za(W,a)).filter(W=>!!W),oe=new Set(be.map(W=>W.id));if(be=[...be,...ie.filter(W=>!oe.has(W.id)&&(oe.add(W.id),!0))],!te())return;c(be.map(Lt));const me=new Set;for(const W of Z){const se=(W.id||W.co||"").toString().trim().toLowerCase();se&&me.add(se.startsWith("t:")?se:"t:"+se)}z(me),k(P),N(Q),ue&&va(le,{fund:ue.fund,marketEstimate:ue.marketEstimate,criteria:ue.criteria,stats:ue.stats,generatedAt:ue.generatedAt,objs:be})}else{const he=Ki(),we=ar(),pe=Ja(),Ne=await he;te()&&Ne.length&&(c(tn(Ne).map(Lt)),F(!1),T(!1));const[ze,ue]=await Promise.all([we,pe]),be=(ze||[]).map(Q=>nr(Q,a)).filter(Q=>!!Q),ye=await rr(be,a),Z=((ue==null?void 0:ue.recent_ops)||[]).map(Q=>za(Q,a)).filter(Q=>!!Q),P=tn([...Ne,...ye,...Z]);if(!te())return;c(P.map(Lt)),va(le,{objs:P})}te()&&T(!1)}catch{te()&&!xe&&T(!0)}finally{te()&&F(!1)}})(),()=>{ce=!1}},[s,o.token,a,D,l]),p.useEffect(()=>{if(!d.showCredits||!I){$(null);return}let H=!0;return(async()=>{try{const ce=await fetch(`${ha}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:I})});if(!ce.ok)return;const te=await ce.json();H&&te&&te.ok!==!1&&$(te)}catch{}})(),()=>{H=!1}},[d.showCredits,I,ee]);const K=p.useCallback(H=>z(new Set(H)),[]);return{session:o,mode:i,caps:d,fund:g,email:I,marketEstimate:b,generatedAt:q,criteria:v,thesisMode:String((v==null?void 0:v.mode)||""),stats:u,thumbs:E,stages:j,dossiers:h,patchStatuses:(H,ce)=>{c(te=>{let le=!1;const xe=te.map(he=>{if(!he.checkId)return he;const we=H.get(he.checkId);return!we||we===(he.ceoStatus||"")||!ce(he.id)?he:(le=!0,{...he,ceoStatus:we})});return le?xe:te})},favIds:L,setFavIds:K,credits:M,reloadCredits:()=>C(H=>H+1),loading:U,error:x,refresh:()=>Y(H=>H+1)}}function Be(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Aa=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ia(e){return Aa.has(e.engine||"")}function Ke(e){return!!e.noCo||Ia(e)&&!!e.url}const Po=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),_l=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Po(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Bl=new Set(["signal","amount","score","crible","memo"]);function $l(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Po(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Bl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??_o)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const _o=80;function Pa(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!_e(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Mn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ut(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ft(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(yo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function Rt(e,a,r){return Be(e)?Pa(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Pa(e,a.filters,r)}function Ul(e,a,r,n){return!(!Rt(e,a,r)||r&&!wo(e,a.ptab,n))}function Bn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-ut(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Zi(o)||null;case"memo":return Xi(o)||null;case"signal":{const i=_e(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),s=n(i);return d===null||s===null?d===s?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<s?-a.dir:d>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const an={},Er=(an==null?void 0:an.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function jr(){return new Date().toISOString().slice(0,10)}const $n=p.createContext(null);function Bo(){return p.useContext($n)}function Hl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(l=>l.remove()),s.querySelectorAll("*").forEach(l=>{const h=l.tagName==="A"?l.getAttribute("href"):null;[...l.attributes].forEach(c=>l.removeAttribute(c.name)),h&&/^https?:\/\//i.test(h)&&(l.setAttribute("href",h),l.setAttribute("target","_blank"),l.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:s.outerHTML})}}catch{}return a}function $o(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Vl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),l=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!s&&!l&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),$o(r),r.innerHTML):e}catch{return e}}function Nr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),$o(r),r.innerHTML):e}catch{return e}}function Sr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Uo(){const e=p.useContext($n);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Wl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=X(),[i,d]=p.useState(()=>n.filters.day||jr()),[s,l]=p.useState(null),[h,c]=p.useState(!1),g=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){d(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),f=p.useCallback(()=>{d(jr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=w=>{var y;const u=(y=w.detail)==null?void 0:y.day;typeof u=="string"&&g(u)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[g]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let v=!1;c(!0);const w=new URLSearchParams({token:e,date:i});return fetch(`${Er}/cibles/edition.json?${w}`).then(u=>u.json()).then(u=>{v||l(u)}).catch(()=>{v||l({ok:!1,error:"network"})}).finally(()=>{v||c(!1)}),()=>{v=!0}},[e,i]);const b=p.useMemo(()=>`${Er}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=p.useMemo(()=>({token:e,day:i,ed:s,loading:h,pickDay:g,pickWindow:f,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,h,g,f,n.filters.day,b,o]);return t.jsx($n.Provider,{value:m,children:a})}function Gl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Uo(),[o,i]=p.useState(()=>n||ko());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const d=s=>{var l;return i(!!((l=s.detail)!=null&&l.open))};return window.addEventListener(Fa,d),()=>window.removeEventListener(Fa,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(es,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Yl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Cr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function zr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Ql(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Uo(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!d,l=a&&!a.ok,h=p.useRef(null),[c,g]=p.useState("fonds"),[f,b]=p.useState(null),[m,v]=p.useState("idle"),w=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),w.current=!1,g("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||w.current)return;w.current=!0;let j=!0;return v("load"),Yl(e).then(N=>{j&&(b(N),v("fait"))}),()=>{j=!1}},[c,e]);const u=p.useMemo(()=>Vl((f==null?void 0:f.html)||""),[f==null?void 0:f.html]),y=p.useRef(null);p.useEffect(()=>{const j=y.current;if(!j||!u)return;let N=!1;return hn(()=>import("./fit-DX-mzLKR.js"),[]).then(async q=>{await q.ensureEditoCss(),!(N||!j.isConnected)&&(q.beautifyEditoRows(j),q.mountCardFits(j))}),()=>{N=!0}},[u]);const E=p.useMemo(()=>Nr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>Nr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const j=h.current;if(!j||!E)return;let N=!1;return hn(()=>import("./fit-DX-mzLKR.js"),[]).then(async q=>{await q.ensureEditoCss(),!(N||!j.isConnected)&&(q.beautifyEditoRows(j),q.mountCardFits(j))}),()=>{N=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const j=(a==null?void 0:a.date)||e,N=/^(\d{4})-(\d{2})-(\d{2})/.exec(j);return N?i?`${N[2]}/${N[3]}/${N[1]}`:`${N[3]}/${N[2]}/${N[1]}`:j})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>g("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>g("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&l&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Cr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Sr(e,!0)}),"."]}):Cr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Sr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>g("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&d&&E?t.jsx("div",{ref:h,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,c==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(u?t.jsxs(t.Fragment,{children:[(f==null?void 0:f.title)&&t.jsx("h3",{className:"thesis-brief__title thesis-brief__jour-h",children:f.title}),t.jsx("div",{ref:y,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:u}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:zr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:zr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Kl=300,wa=7,Jl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Ho={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Xl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function nn(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(rs(r)&&r!=="media")return"news:"+r;const n=_e(e);return n?"sig:"+(n.theme&&Ho.fr[n.theme]?n.theme:"other"):"actualites"}function Zl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:s}=X(),l=Bo(),h=d==="en",[c,g]=p.useState("all"),[f,b]=p.useState(!1),m=p.useMemo(()=>{var ce;const x=(a.filters.day||"").slice(0,10),T=te=>!(!i&&a.continent!=="monde"&&te.continent!==a.continent||x&&(te.date||"").slice(0,10)!==x),D=e.filter(te=>T(te)&&_e(te)&&(!i||te.kind!=="target"||Te(te)!==5)),Y=i&&(((ce=l==null?void 0:l.ed)==null?void 0:ce.ops)||[]).length?l.ed.ops.map(te=>za(te,d)).filter(te=>!!te).map(te=>(te.briefOnly=!0,te)).filter(te=>!x||(te.date||"").slice(0,10)===x):[],ee=e.filter(te=>T(te)&&te.kind==="op"&&(x?!0:ut(te.date)<=wa)),C=i?Y.length?Y:ee.filter(te=>{const le=(s||"").trim().toLowerCase();if(!le)return!1;const xe=te.match||null;return xe?Object.keys(xe).map(he=>he.trim().toLowerCase()).includes(le):!1}):ee,B=x||new Date().toISOString().slice(0,10),I=te=>{const le=nn(te);return le==="ma"?0:le==="levees"?1:2};C.sort((te,le)=>{const xe=I(te)-I(le);if(xe)return xe;const he=(te.date||"").slice(0,10)===B?0:1,we=(le.date||"").slice(0,10)===B?0:1;return he!==we?he-we:(le.amountEur||0)-(te.amountEur||0)});const K=new Set,H=[];for(const te of[...C,...Bn(D,{key:"signal",dir:-1})]){const le=te.id||te.name;!le||K.has(le)||(K.add(le),H.push(te))}return i&&H.length===0?e.filter(le=>T(le)&&ut(le.date)<=wa).sort((le,xe)=>(xe.date||"").localeCompare(le.date||"")).slice(0,80):H},[e,a.continent,a.filters.day,i,s,d,l]),v=p.useMemo(()=>{const x={};for(const T of m){const D=nn(T);x[D]=(x[D]||0)+1}return x},[m]),w=p.useMemo(()=>c==="all"?m:m.filter(x=>nn(x)===c),[m,c]),u=p.useMemo(()=>w.slice(0,Kl),[w]),y=w.length-u.length,E=p.useRef(null);p.useEffect(()=>{var C,B;const x=E.current;if(!x)return;const T=()=>{const I=x.scrollWidth;I<200||(x.style.animationDuration=Math.max(18,Math.round(I/130))+"s")};T();const D=requestAnimationFrame(T),Y=window.setTimeout(T,1200);let ee=!0;return(B=(C=document.fonts)==null?void 0:C.ready)==null||B.then(()=>{ee&&T()}),()=>{ee=!1,cancelAnimationFrame(D),window.clearTimeout(Y)}},[u.length,c]);const k=x=>x==="all"?m.length:v[x]||0,j=x=>{if(x==="all")return h?"All":"Tout";if(x.startsWith("sig:"))return Ho[h?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const T=x.slice(5);return as[T]?ns(T,h?"en":"fr"):x}return Jl[h?"en":"fr"][x]},N=[{k:"all"}],q=["ma","levees"].filter(x=>k(x)>0||x===c);if(q.length){N.push({g:h?"Deals":"Opérations"});for(const x of q)N.push({k:x})}const S=["nominations","recrutements"].filter(x=>k(x)>0||x===c),L=ts.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===c),z=k("actualites")>0||c==="actualites"?["actualites"]:[];if(S.length||L.length||z.length){N.push({g:h?"News":"Actualités"});for(const x of S)N.push({k:x});for(const x of L)N.push({k:x});for(const x of z)N.push({k:x})}const M=Xl.map(x=>"sig:"+x).filter(x=>k(x)>0||x===c);if(M.length){N.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of M)N.push({k:x})}const $=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},U=(()=>{const x=(a.filters.day||"").slice(0,10),T=!i&&a.continent!=="monde"&&o?h?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(h?`LIVE covers the events of ${$(x)}.`:`Le LIVE regroupe les événements du ${$(x)}.`)+T:(h?`LIVE covers the still-open signals and the deals of the last ${wa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${wa} derniers jours.`)+T})(),F=x=>u.map(T=>t.jsxs("button",{type:"button",className:"tk"+(Ue(T)?" spent":""),onClick:D=>{const Y=T.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:Y?"":T.id,name:T.name,url:T.url||"",text:T.tagline||T.headline||"",card:T.card}}))}catch{}if(Y||n({type:"focus",id:T.id}),a.dens!=="liste"){const ee=D.currentTarget.getBoundingClientRect();n({type:"popup",id:T.id,anchor:{x:ee.left+ee.width/2,y:ee.bottom}})}},title:Ue(T)?h?`${T.name} — already screened (dimmed)`:`${T.name} — déjà évaluée (grisée)`:T.name+(T.tagline?" — "+T.tagline:""),children:[t.jsx(Ct,{o:T}),t.jsxs("span",{className:"who",children:[t.jsx(Ci,{o:T}),t.jsx("span",{className:"co",children:T.name})]}),(()=>{const D=(T.tagline||T.headline||"").trim();return D&&D!==T.name?t.jsx("span",{className:"what",children:D}):null})(),typeof T.amountEur=="number"&&T.amountEur>0&&t.jsx("span",{className:"am",children:eu(T.amountEur)}),T.sector&&t.jsx("span",{className:"mt",children:T.sector}),t.jsx(Qa,{o:T}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(T.id||T.name))).concat(y>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${y} more — filter by section to see them`:`+ ${y} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":f,onClick:()=>b(x=>!x),children:[j(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!f,children:[t.jsx("span",{className:"tkfilscope",children:U}),N.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===c,onClick:()=>{g(x.k),b(!1)},children:[j(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:u.length?t.jsxs("div",{className:"run",ref:E,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!l&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!l&&t.jsx(td,{isEn:h})]})}const ed=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function td({isEn:e}){const[a,r]=p.useState(()=>ko());p.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Fa,o),()=>window.removeEventListener(Fa,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>os(!a),children:ed})}class pt extends p.Component{constructor(){super(...arguments);Xn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Vo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Ar(e,a){if((zt(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return Vo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const qr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",ad={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function nd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=X(),[s,l]=p.useState(""),[h,c]=p.useState(!1),[g,f]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!g)return;const y=E=>{b.current&&!b.current.contains(E.target)&&(f(!1),c(!1))};return document.addEventListener("click",y,!0),()=>document.removeEventListener("click",y,!0)},[g]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),v=async y=>{if(s)return;if(y==="Analysé"&&!e.memoUrl){c(!0);return}l(y);const E=(Ar(e,a).find(([j])=>j===y)||[y,y])[1],k=await o(e,y,{msg:a.csMoved(e.name,E)});l(""),k&&(c(!1),f(!1))},w=Ar(e,a),u=y=>(w.find(([E])=>E===y)||[])[1]||y;return w.length===2?t.jsx("span",{className:"rstat rst2",onClick:y=>y.stopPropagation(),children:w.map(([y,E])=>t.jsx("button",{type:"button",className:"rsd "+(y==="Validé"?"yes":"no")+(s===y?" busy":""),disabled:!!s,onClick:()=>{v(y)},children:E},y))}):t.jsxs("span",{className:"rstat"+(g||h?" rs-open":""),ref:b,onClick:y=>y.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":g,disabled:!!s,title:a.csLabel,className:"rsel rs-"+qr(m),onClick:()=>{f(y=>!y),c(!1)},children:s?u(s)+"…":m?u(m):a.csNone}),g&&!h&&t.jsx("span",{className:"rsmenu",role:"listbox",children:w.map(([y,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===y,className:"rsopt"+(m===y?" on":"")+(s===y?" busy":""),disabled:!!s,onClick:()=>{if(y===m){f(!1);return}v(y)},children:[t.jsx("i",{className:"pt2",style:{background:ad[qr(y)]}}),E]},y))}),h&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),c(!1),f(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const y=await o(e,"Analysé");l(""),y&&(c(!1),f(!1))})()},children:a.csAnaAnyway})]})})]})}function rd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=X(),[i,d]=p.useState(""),[s,l]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),c=(zt(e)||"").startsWith("CALL")&&Te(e)===3,g=Te(e)>=2,f=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(m);const v=await o(e,m);d(""),v&&(l(!0),setTimeout(()=>l(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:Vo.filter(([m])=>!(g&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(h===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{f(m)},children:v},m)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(od,{o:e})]})}function od({o:e}){const{t:a,saveNote:r,flash:n}=X(),[o,i]=p.useState(e.ceoNote||""),[d,s]=p.useState(!1),[l,h]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),g=async()=>{if(d||!c)return;s(!0);const f=await r(e,o.trim());s(!1),f&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:f=>i(f.target.value),onKeyDown:f=>{f.key==="Enter"&&g()}}),t.jsx("button",{type:"button",disabled:d||!c,onClick:()=>{g()},children:l?a.csNoteSaved:a.csNoteOk})]})}function Tr({placeholder:e,onDone:a}){const{t:r}=X(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function id({o:e}){var w;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:s}=X(),[l,h]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Te(e)!==4)return null;const c=i(e),g=(c==null?void 0:c.stage)||"todo",f=async u=>{if(l||u===g)return;h(!0);const y=c;d(e,{stage:u,stamps:(c==null?void 0:c.stamps)||{}});const E=Math.max(Date.now(),Lr+=1);Lr=E;const k=await is(r,{company:e.name||"",stage:u,cts:E,deal_id:e.airtableId,check_id:e.checkId});h(!1),!k.stale&&(k.ok||(d(e,y),s(a.actErr)))},b=(w=c==null?void 0:c.stamps)==null?void 0:w.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=g==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,y])=>t.jsx("button",{type:"button",className:"stgb"+(g===u?" on":""),disabled:l,onClick:()=>{f(u)},children:y},u)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let Lr=0;const Zt=8,Nt=360;function Fr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Rr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Fr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Fr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function sd({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=X(),[d,s]=p.useState(0),[l,h]=p.useState(null),[c,g]=p.useState([]),f=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=p.useRef(!1);p.useEffect(()=>{const q=b.current;return()=>{m.current||(n({type:"ptab",tab:q.ptab}),n({type:"dens",dens:q.dens}),n({type:"modal",modal:q.modal}))}},[]),p.useEffect(()=>{f.current||(f.current=!0,g(e.filter(q=>!!document.querySelector(q.need||q.sel))))},[e]);const v=c[d],w=d>=c.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const q=v.click,S=window.setTimeout(()=>{const L=document.querySelector(q);L&&L.getAttribute("aria-selected")!=="true"&&L.click()},60);return()=>window.clearTimeout(S)}},[d,v]);const u=p.useRef(-1),y=p.useCallback(()=>{if(!v){h(null);return}const q=z=>{if(!z)return null;for(const M of document.querySelectorAll(z)){const $=M.getBoundingClientRect();if($.width>1&&$.height>1)return M}return null},S=q(v.sel)||q(v.need);if(!S){h(null);return}u.current!==d&&(u.current=d,S.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=S.getBoundingClientRect();h(z=>z&&Math.abs(z.top-L.top)<1&&Math.abs(z.left-L.left)<1&&Math.abs(z.width-L.width)<1&&Math.abs(z.height-L.height)<1?z:L)},[v,d]);p.useLayoutEffect(()=>{y();const q=[90,300,700,1300].map(z=>window.setTimeout(y,z)),S=window.setInterval(y,400),L=()=>y();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{q.forEach(z=>window.clearTimeout(z)),window.clearInterval(S),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[y]);const E=p.useRef(a);if(E.current=a,p.useEffect(()=>{const q=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),E.current()):S.key==="ArrowRight"?s(L=>L+1):S.key==="ArrowLeft"&&s(L=>Math.max(0,L-1))};return document.addEventListener("keydown",q,!0),()=>document.removeEventListener("keydown",q,!0)},[]),!c.length)return null;let k=null;const j=q=>()=>{m.current=!0,n({type:"modal",modal:null}),q()};if(w){const q=o[3]||0;q>0?k={title:q===1?r.ahaATitle1:r.ahaATitleN(q),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let N={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Nt};if(!w&&l){const q=l.bottom+14,S=window.innerHeight-q;let L=S>190?q:Math.max(12,l.top-200),z=Math.min(Math.max(12,l.left+l.width/2-Nt/2),window.innerWidth-Nt-12);S<=190&&l.top<212&&(window.innerWidth-l.right>=Nt+40?z=Math.min(l.right+26,window.innerWidth-Nt-12):l.left>=Nt+40&&(z=Math.max(12,l.left-Nt-26)),L=Math.max(12,l.top-Zt)),N={left:z,top:L,width:Nt}}return Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!w&&l&&t.jsx("div",{className:"tour-hole",style:{left:l.left-Zt,top:l.top-Zt,width:l.width+Zt*2,height:l.height+Zt*2}}),(w||!l)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(w?" fin":""),style:N,children:[w&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Rr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(Rr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>s(q=>Math.max(0,q-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(q=>q+1),children:d===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Wo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Go(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ld(){var S,L;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:s,dispatch:l}=X(),h=r?a:e,c=p.useMemo(()=>h.filter(z=>ut(z.date)===0&&z.kind==="target"),[h]),g=p.useMemo(()=>r?a.filter(z=>z.kind==="target"&&Te(z)===0).slice().sort((z,M)=>(M.date||"").localeCompare(z.date||"")):[],[a,r]),f=p.useMemo(()=>c.filter(z=>r?Te(z)===0:!Ue(z)),[c,r]),b=r?g:f,m=r?a.length-g.length:c.length-f.length,v=r?a.length:c.length,w=v?Math.min(100,m/v*100):100,u=p.useMemo(()=>Wo(h),[h]),y=!!u&&ut(u)>0,E=p.useMemo(()=>y?h.filter(z=>(z.date||"").slice(0,10)===u):[],[h,u,y]),k=typeof((S=s.stats)==null?void 0:S.kept_today)=="number"?s.stats.kept_today:null,j=typeof((L=s.stats)==null?void 0:L.screened_today)=="number"?s.stats.screened_today:c.length;let N;y?N=o.morningLast(E.length,g.length,Go(u,d)):r?N=o.morningThesis(j,g.length,k):c.length?m===0?N=o.goalSourced(c.length):m>=c.length?N=o.goalCleared:N=o.goalDone(m,c.length):N=o.goalSourced(0);const q=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&g.length&&l({type:"chainStart",queue:g.map(z=>z.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:w+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:q,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function dd(){const{t:e,st:a,dispatch:r,fund:n,data:o,mode:i,doSync:d,startTour:s}=X(),l=i==="client",[h,c]=p.useState(!1),[g,f]=p.useState(""),b=()=>{!l||h||!n||(c(!0),f(""),ss(n).then(w=>{if(c(!1),w.pending){f(e.refreshSlow);return}if(!w.ok){w.error&&console.warn("[republish]",w.error),f(e.refreshKo);return}const u=w.entered??0,y=w.left??0;f(w.unchanged||!u&&!y?e.refreshSame:e.refreshDone(u,y)),o.refresh()}))},m=(n||"P").split(/\s+/).map(w=>w[0]).join("").slice(0,2).toUpperCase(),v=(()=>{const w=Date.parse(o.generatedAt||"");if(Number.isNaN(w))return"";const u=new Date(w),y=E=>String(E).padStart(2,"0");return`${y(u.getDate())}/${y(u.getMonth()+1)} à ${y(u.getHours())}:${y(u.getMinutes())}`})();return t.jsx("div",{className:"ident",children:t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:n?m:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:n||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:n?e.identTitle(n):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),v?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(v)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!l||h,onClick:b,children:h?"⏳":"📰"}),(h||!!g)&&t.jsxs("span",{className:"repubst",children:[h?e.refreshRun:g,!h&&t.jsx("button",{type:"button",onClick:()=>f(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!l,onClick:d,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:a.filters.search,onChange:w=>r({type:"filters",patch:{search:w.target.value}})})]})]})})}class Mt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,s=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);s&&(r[n++]=s),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*pd(e){for(const a of e)yield*a}function Yo(e){return Array.from(pd(e))}var Le=1e-6,Se=Math.PI,it=Se/2,Or=Se/4,lt=Se*2,vt=180/Se,et=Se/180,Fe=Math.abs,cd=Math.atan,da=Math.atan2,Oe=Math.cos,Me=Math.sin,ud=Math.sign||function(e){return e>0?1:e<0?-1:0},_t=Math.sqrt;function md(e){return e>1?0:e<-1?Se:Math.acos(e)}function pa(e){return e>1?it:e<-1?-it:Math.asin(e)}function st(){}function _a(e,a){e&&Dr.hasOwnProperty(e.type)&&Dr[e.type](e,a)}var Mr={Feature:function(e,a){_a(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)_a(r[n].geometry,a)}},Dr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){vn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)vn(r[n],a,0)},Polygon:function(e,a){Ir(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Ir(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)_a(r[n],a)}};function vn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Ir(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)vn(e[r],a,1);a.polygonEnd()}function Ut(e,a){e&&Mr.hasOwnProperty(e.type)?Mr[e.type](e,a):_a(e,a)}function wn(e){return[da(e[1],e[0]),pa(e[2])]}function Wt(e){var a=e[0],r=e[1],n=Oe(r);return[n*Oe(a),n*Me(a),Me(r)]}function ya(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ba(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function rn(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ka(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function yn(e){var a=_t(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function kn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function En(e,a){return Fe(e)>Se&&(e-=Math.round(e/lt)*lt),[e,a]}En.invert=En;function fd(e,a,r){return(e%=lt)?a||r?kn(_r(e),Br(a,r)):_r(e):a||r?Br(a,r):En}function Pr(e){return function(a,r){return a+=e,Fe(a)>Se&&(a-=Math.round(a/lt)*lt),[a,r]}}function _r(e){var a=Pr(e);return a.invert=Pr(-e),a}function Br(e,a){var r=Oe(e),n=Me(e),o=Oe(a),i=Me(a);function d(s,l){var h=Oe(l),c=Oe(s)*h,g=Me(s)*h,f=Me(l),b=f*r+c*n;return[da(g*o-b*i,c*r-f*n),pa(b*o+g*i)]}return d.invert=function(s,l){var h=Oe(l),c=Oe(s)*h,g=Me(s)*h,f=Me(l),b=f*o-g*i;return[da(g*o+f*i,c*r+b*n),pa(b*r-c*n)]},d}function hd(e,a,r,n,o,i){if(r){var d=Oe(a),s=Me(a),l=n*r;o==null?(o=a+n*lt,i=a-l/2):(o=$r(d,o),i=$r(d,i),(n>0?o<i:o>i)&&(o+=n*lt));for(var h,c=o;n>0?c>i:c<i;c-=l)h=wn([d,-s*Oe(c),-s*Me(c)]),e.point(h[0],h[1])}}function $r(e,a){a=Wt(a),a[0]-=e,yn(a);var r=md(-a[1]);return((-a[2]<0?-r:r)+lt-Le)%lt}function Qo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:st,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function qa(e,a){return Fe(e[0]-a[0])<Le&&Fe(e[1]-a[1])<Le}function Ea(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Ko(e,a,r,n,o){var i=[],d=[],s,l;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,w=m[0],u=m[v],y;if(qa(w,u)){if(!w[2]&&!u[2]){for(o.lineStart(),s=0;s<v;++s)o.point((w=m[s])[0],w[1]);o.lineEnd();return}u[0]+=2*Le}i.push(y=new Ea(w,m,null,!0)),d.push(y.o=new Ea(w,null,y,!1)),i.push(y=new Ea(u,m,null,!1)),d.push(y.o=new Ea(u,null,y,!0))}}),!!i.length){for(d.sort(a),Ur(i),Ur(d),s=0,l=d.length;s<l;++s)d[s].e=r=!r;for(var h=i[0],c,g;;){for(var f=h,b=!0;f.v;)if((f=f.n)===h)return;c=f.z,o.lineStart();do{if(f.v=f.o.v=!0,f.e){if(b)for(s=0,l=c.length;s<l;++s)o.point((g=c[s])[0],g[1]);else n(f.x,f.n.x,1,o);f=f.n}else{if(b)for(c=f.p.z,s=c.length-1;s>=0;--s)o.point((g=c[s])[0],g[1]);else n(f.x,f.p.x,-1,o);f=f.p}f=f.o,c=f.z,b=!b}while(!f.v);o.lineEnd()}}}function Ur(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function on(e){return Fe(e[0])<=Se?e[0]:ud(e[0])*((Fe(e[0])+Se)%lt-Se)}function gd(e,a){var r=on(a),n=a[1],o=Me(n),i=[Me(r),-Oe(r),0],d=0,s=0,l=new Mt;o===1?n=it+Le:o===-1&&(n=-it-Le);for(var h=0,c=e.length;h<c;++h)if(f=(g=e[h]).length)for(var g,f,b=g[f-1],m=on(b),v=b[1]/2+Or,w=Me(v),u=Oe(v),y=0;y<f;++y,m=k,w=N,u=q,b=E){var E=g[y],k=on(E),j=E[1]/2+Or,N=Me(j),q=Oe(j),S=k-m,L=S>=0?1:-1,z=L*S,M=z>Se,$=w*N;if(l.add(da($*L*Me(z),u*q+$*Oe(z))),d+=M?S+L*lt:S,M^m>=r^k>=r){var U=Ba(Wt(b),Wt(E));yn(U);var F=Ba(i,U);yn(F);var x=(M^S>=0?-1:1)*pa(F[2]);(n>x||n===x&&(U[0]||U[1]))&&(s+=M^S>=0?1:-1)}}return(d<-Le||d<Le&&l<-1e-12)^s&1}function Jo(e,a,r,n){return function(o){var i=a(o),d=Qo(),s=a(d),l=!1,h,c,g,f={point:b,lineStart:v,lineEnd:w,polygonStart:function(){f.point=u,f.lineStart=y,f.lineEnd=E,c=[],h=[]},polygonEnd:function(){f.point=b,f.lineStart=v,f.lineEnd=w,c=Yo(c);var k=gd(h,n);c.length?(l||(o.polygonStart(),l=!0),Ko(c,bd,k,r,o)):k&&(l||(o.polygonStart(),l=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),l&&(o.polygonEnd(),l=!1),c=h=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function m(k,j){i.point(k,j)}function v(){f.point=m,i.lineStart()}function w(){f.point=b,i.lineEnd()}function u(k,j){g.push([k,j]),s.point(k,j)}function y(){s.lineStart(),g=[]}function E(){u(g[0][0],g[0][1]),s.lineEnd();var k=s.clean(),j=d.result(),N,q=j.length,S,L,z;if(g.pop(),h.push(g),g=null,!!q){if(k&1){if(L=j[0],(S=L.length-1)>0){for(l||(o.polygonStart(),l=!0),o.lineStart(),N=0;N<S;++N)o.point((z=L[N])[0],z[1]);o.lineEnd()}return}q>1&&k&2&&j.push(j.pop().concat(j.shift())),c.push(j.filter(xd))}}return f}}function xd(e){return e.length>1}function bd(e,a){return((e=e.x)[0]<0?e[1]-it-Le:it-e[1])-((a=a.x)[0]<0?a[1]-it-Le:it-a[1])}const Hr=Jo(function(){return!0},vd,yd,[-Se,-it]);function vd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var s=i>0?Se:-Se,l=Fe(i-a);Fe(l-Se)<Le?(e.point(a,r=(r+d)/2>0?it:-it),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&l>=Se&&(Fe(a-n)<Le&&(a-=n*Le),Fe(i-s)<Le&&(i-=s*Le),r=wd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=d),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function wd(e,a,r,n){var o,i,d=Me(e-r);return Fe(d)>Le?cd((Me(a)*(i=Oe(n))*Me(r)-Me(n)*(o=Oe(a))*Me(e))/(o*i*d)):(a+n)/2}function yd(e,a,r,n){var o;if(e==null)o=r*it,n.point(-Se,o),n.point(0,o),n.point(Se,o),n.point(Se,0),n.point(Se,-o),n.point(0,-o),n.point(-Se,-o),n.point(-Se,0),n.point(-Se,o);else if(Fe(e[0]-a[0])>Le){var i=e[0]<a[0]?Se:-Se;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function kd(e){var a=Oe(e),r=2*et,n=a>0,o=Fe(a)>Le;function i(c,g,f,b){hd(b,e,r,f,c,g)}function d(c,g){return Oe(c)*Oe(g)>a}function s(c){var g,f,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(w,u){var y=[w,u],E,k=d(w,u),j=n?k?0:h(w,u):k?h(w+(w<0?Se:-Se),u):0;if(!g&&(m=b=k)&&c.lineStart(),k!==b&&(E=l(g,y),(!E||qa(g,E)||qa(y,E))&&(y[2]=1)),k!==b)v=0,k?(c.lineStart(),E=l(y,g),c.point(E[0],E[1])):(E=l(g,y),c.point(E[0],E[1],2),c.lineEnd()),g=E;else if(o&&g&&n^k){var N;!(j&f)&&(N=l(y,g,!0))&&(v=0,n?(c.lineStart(),c.point(N[0][0],N[0][1]),c.point(N[1][0],N[1][1]),c.lineEnd()):(c.point(N[1][0],N[1][1]),c.lineEnd(),c.lineStart(),c.point(N[0][0],N[0][1],3)))}k&&(!g||!qa(g,y))&&c.point(y[0],y[1]),g=y,b=k,f=j},lineEnd:function(){b&&c.lineEnd(),g=null},clean:function(){return v|(m&&b)<<1}}}function l(c,g,f){var b=Wt(c),m=Wt(g),v=[1,0,0],w=Ba(b,m),u=ya(w,w),y=w[0],E=u-y*y;if(!E)return!f&&c;var k=a*u/E,j=-a*y/E,N=Ba(v,w),q=ka(v,k),S=ka(w,j);rn(q,S);var L=N,z=ya(q,L),M=ya(L,L),$=z*z-M*(ya(q,q)-1);if(!($<0)){var U=_t($),F=ka(L,(-z-U)/M);if(rn(F,q),F=wn(F),!f)return F;var x=c[0],T=g[0],D=c[1],Y=g[1],ee;T<x&&(ee=x,x=T,T=ee);var C=T-x,B=Fe(C-Se)<Le,I=B||C<Le;if(!B&&Y<D&&(ee=D,D=Y,Y=ee),I?B?D+Y>0^F[1]<(Fe(F[0]-x)<Le?D:Y):D<=F[1]&&F[1]<=Y:C>Se^(x<=F[0]&&F[0]<=T)){var K=ka(L,(-z+U)/M);return rn(K,q),[F,wn(K)]}}}function h(c,g){var f=n?e:Se-e,b=0;return c<-f?b|=1:c>f&&(b|=2),g<-f?b|=4:g>f&&(b|=8),b}return Jo(d,s,i,n?[0,-e]:[-Se,e-Se])}function Ed(e,a,r,n,o,i){var d=e[0],s=e[1],l=a[0],h=a[1],c=0,g=1,f=l-d,b=h-s,m;if(m=r-d,!(!f&&m>0)){if(m/=f,f<0){if(m<c)return;m<g&&(g=m)}else if(f>0){if(m>g)return;m>c&&(c=m)}if(m=o-d,!(!f&&m<0)){if(m/=f,f<0){if(m>g)return;m>c&&(c=m)}else if(f>0){if(m<c)return;m<g&&(g=m)}if(m=n-s,!(!b&&m>0)){if(m/=b,b<0){if(m<c)return;m<g&&(g=m)}else if(b>0){if(m>g)return;m>c&&(c=m)}if(m=i-s,!(!b&&m<0)){if(m/=b,b<0){if(m>g)return;m>c&&(c=m)}else if(b>0){if(m<c)return;m<g&&(g=m)}return c>0&&(e[0]=d+c*f,e[1]=s+c*b),g<1&&(a[0]=d+g*f,a[1]=s+g*b),!0}}}}}var ta=1e9,ja=-ta;function jd(e,a,r,n){function o(h,c){return e<=h&&h<=r&&a<=c&&c<=n}function i(h,c,g,f){var b=0,m=0;if(h==null||(b=d(h,g))!==(m=d(c,g))||l(h,c)<0^g>0)do f.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+g+4)%4)!==m);else f.point(c[0],c[1])}function d(h,c){return Fe(h[0]-e)<Le?c>0?0:3:Fe(h[0]-r)<Le?c>0?2:1:Fe(h[1]-a)<Le?c>0?1:0:c>0?3:2}function s(h,c){return l(h.x,c.x)}function l(h,c){var g=d(h,1),f=d(c,1);return g!==f?g-f:g===0?c[1]-h[1]:g===1?h[0]-c[0]:g===2?h[1]-c[1]:c[0]-h[0]}return function(h){var c=h,g=Qo(),f,b,m,v,w,u,y,E,k,j,N,q={point:S,lineStart:$,lineEnd:U,polygonStart:z,polygonEnd:M};function S(x,T){o(x,T)&&c.point(x,T)}function L(){for(var x=0,T=0,D=b.length;T<D;++T)for(var Y=b[T],ee=1,C=Y.length,B=Y[0],I,K,H=B[0],ce=B[1];ee<C;++ee)I=H,K=ce,B=Y[ee],H=B[0],ce=B[1],K<=n?ce>n&&(H-I)*(n-K)>(ce-K)*(e-I)&&++x:ce<=n&&(H-I)*(n-K)<(ce-K)*(e-I)&&--x;return x}function z(){c=g,f=[],b=[],N=!0}function M(){var x=L(),T=N&&x,D=(f=Yo(f)).length;(T||D)&&(h.polygonStart(),T&&(h.lineStart(),i(null,null,1,h),h.lineEnd()),D&&Ko(f,s,x,i,h),h.polygonEnd()),c=h,f=b=m=null}function $(){q.point=F,b&&b.push(m=[]),j=!0,k=!1,y=E=NaN}function U(){f&&(F(v,w),u&&k&&g.rejoin(),f.push(g.result())),q.point=S,k&&c.lineEnd()}function F(x,T){var D=o(x,T);if(b&&m.push([x,T]),j)v=x,w=T,u=D,j=!1,D&&(c.lineStart(),c.point(x,T));else if(D&&k)c.point(x,T);else{var Y=[y=Math.max(ja,Math.min(ta,y)),E=Math.max(ja,Math.min(ta,E))],ee=[x=Math.max(ja,Math.min(ta,x)),T=Math.max(ja,Math.min(ta,T))];Ed(Y,ee,e,a,r,n)?(k||(c.lineStart(),c.point(Y[0],Y[1])),c.point(ee[0],ee[1]),D||c.lineEnd(),N=!1):D&&(c.lineStart(),c.point(x,T),N=!1)}y=x,E=T,k=D}return q}}const jn=e=>e;var sn=new Mt,Nn=new Mt,Xo,Zo,Sn,Cn,yt={point:st,lineStart:st,lineEnd:st,polygonStart:function(){yt.lineStart=Nd,yt.lineEnd=Cd},polygonEnd:function(){yt.lineStart=yt.lineEnd=yt.point=st,sn.add(Fe(Nn)),Nn=new Mt},result:function(){var e=sn/2;return sn=new Mt,e}};function Nd(){yt.point=Sd}function Sd(e,a){yt.point=ei,Xo=Sn=e,Zo=Cn=a}function ei(e,a){Nn.add(Cn*e-Sn*a),Sn=e,Cn=a}function Cd(){ei(Xo,Zo)}var Gt=1/0,$a=Gt,ca=-Gt,Ua=ca,Ha={point:zd,lineStart:st,lineEnd:st,polygonStart:st,polygonEnd:st,result:function(){var e=[[Gt,$a],[ca,Ua]];return ca=Ua=-($a=Gt=1/0),e}};function zd(e,a){e<Gt&&(Gt=e),e>ca&&(ca=e),a<$a&&($a=a),a>Ua&&(Ua=a)}var zn=0,An=0,aa=0,Va=0,Wa=0,Ht=0,qn=0,Tn=0,na=0,ti,ai,gt,xt,ot={point:Dt,lineStart:Vr,lineEnd:Wr,polygonStart:function(){ot.lineStart=Td,ot.lineEnd=Ld},polygonEnd:function(){ot.point=Dt,ot.lineStart=Vr,ot.lineEnd=Wr},result:function(){var e=na?[qn/na,Tn/na]:Ht?[Va/Ht,Wa/Ht]:aa?[zn/aa,An/aa]:[NaN,NaN];return zn=An=aa=Va=Wa=Ht=qn=Tn=na=0,e}};function Dt(e,a){zn+=e,An+=a,++aa}function Vr(){ot.point=Ad}function Ad(e,a){ot.point=qd,Dt(gt=e,xt=a)}function qd(e,a){var r=e-gt,n=a-xt,o=_t(r*r+n*n);Va+=o*(gt+e)/2,Wa+=o*(xt+a)/2,Ht+=o,Dt(gt=e,xt=a)}function Wr(){ot.point=Dt}function Td(){ot.point=Fd}function Ld(){ni(ti,ai)}function Fd(e,a){ot.point=ni,Dt(ti=gt=e,ai=xt=a)}function ni(e,a){var r=e-gt,n=a-xt,o=_t(r*r+n*n);Va+=o*(gt+e)/2,Wa+=o*(xt+a)/2,Ht+=o,o=xt*e-gt*a,qn+=o*(gt+e),Tn+=o*(xt+a),na+=o*3,Dt(gt=e,xt=a)}function ri(e){this._context=e}ri.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,lt);break}}},result:st};var Ln=new Mt,ln,oi,ii,ra,oa,ua={point:st,lineStart:function(){ua.point=Rd},lineEnd:function(){ln&&si(oi,ii),ua.point=st},polygonStart:function(){ln=!0},polygonEnd:function(){ln=null},result:function(){var e=+Ln;return Ln=new Mt,e}};function Rd(e,a){ua.point=si,oi=ra=e,ii=oa=a}function si(e,a){ra-=e,oa-=a,Ln.add(_t(ra*ra+oa*oa)),ra=e,oa=a}let Gr,Ga,Yr,Qr;class Kr{constructor(a){this._append=a==null?li:Od(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Yr||this._append!==Ga){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Yr=n,Ga=this._append,Qr=this._,this._=o}this._+=Qr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function li(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Od(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return li;if(a!==Gr){const r=10**a;Gr=a,Ga=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ga}function Md(e,a){let r=3,n=4.5,o,i;function d(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Ut(s,o(i))),i.result()}return d.area=function(s){return Ut(s,o(yt)),yt.result()},d.measure=function(s){return Ut(s,o(ua)),ua.result()},d.bounds=function(s){return Ut(s,o(Ha)),Ha.result()},d.centroid=function(s){return Ut(s,o(ot)),ot.result()},d.projection=function(s){return arguments.length?(o=s==null?(e=null,jn):(e=s).stream,d):e},d.context=function(s){return arguments.length?(i=s==null?(a=null,new Kr(r)):new ri(a=s),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),d):n},d.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const l=Math.floor(s);if(!(l>=0))throw new RangeError(`invalid digits: ${s}`);r=l}return a===null&&(i=new Kr(r)),d},d.projection(e).digits(r).context(a)}function Un(e){return function(a){var r=new Fn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Fn(){}Fn.prototype={constructor:Fn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Hn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ut(r,e.stream(Ha)),a(Ha.result()),n!=null&&e.clipExtent(n),e}function di(e,a,r){return Hn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,l=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([s,l])},r)}function Dd(e,a,r){return di(e,[[0,0],a],r)}function Id(e,a,r){return Hn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([d,s])},r)}function Pd(e,a,r){return Hn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,s])},r)}var Jr=16,_d=Oe(30*et);function Xr(e,a){return+a?$d(e,a):Bd(e)}function Bd(e){return Un({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function $d(e,a){function r(n,o,i,d,s,l,h,c,g,f,b,m,v,w){var u=h-n,y=c-o,E=u*u+y*y;if(E>4*a&&v--){var k=d+f,j=s+b,N=l+m,q=_t(k*k+j*j+N*N),S=pa(N/=q),L=Fe(Fe(N)-1)<Le||Fe(i-g)<Le?(i+g)/2:da(j,k),z=e(L,S),M=z[0],$=z[1],U=M-n,F=$-o,x=y*U-u*F;(x*x/E>a||Fe((u*U+y*F)/E-.5)>.3||d*f+s*b+l*m<_d)&&(r(n,o,i,d,s,l,M,$,L,k/=q,j/=q,N,v,w),w.point(M,$),r(M,$,L,k,j,N,h,c,g,f,b,m,v,w))}}return function(n){var o,i,d,s,l,h,c,g,f,b,m,v,w={point:u,lineStart:y,lineEnd:k,polygonStart:function(){n.polygonStart(),w.lineStart=j},polygonEnd:function(){n.polygonEnd(),w.lineStart=y}};function u(S,L){S=e(S,L),n.point(S[0],S[1])}function y(){g=NaN,w.point=E,n.lineStart()}function E(S,L){var z=Wt([S,L]),M=e(S,L);r(g,f,c,b,m,v,g=M[0],f=M[1],c=S,b=z[0],m=z[1],v=z[2],Jr,n),n.point(g,f)}function k(){w.point=u,n.lineEnd()}function j(){y(),w.point=N,w.lineEnd=q}function N(S,L){E(o=S,L),i=g,d=f,s=b,l=m,h=v,w.point=E}function q(){r(g,f,c,b,m,v,i,d,o,s,l,h,Jr,n),w.lineEnd=k,k()}return w}}var Ud=Un({point:function(e,a){this.stream.point(e*et,a*et)}});function Hd(e){return Un({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Vd(e,a,r,n,o){function i(d,s){return d*=n,s*=o,[a+e*d,r-e*s]}return i.invert=function(d,s){return[(d-a)/e*n,(r-s)/e*o]},i}function Zr(e,a,r,n,o,i){if(!i)return Vd(e,a,r,n,o);var d=Oe(i),s=Me(i),l=d*e,h=s*e,c=d/e,g=s/e,f=(s*r-d*a)/e,b=(s*a+d*r)/e;function m(v,w){return v*=n,w*=o,[l*v-h*w+a,r-h*v-l*w]}return m.invert=function(v,w){return[n*(c*v-g*w+f),o*(b-g*v-c*w)]},m}function Wd(e){return Gd(function(){return e})()}function Gd(e){var a,r=150,n=480,o=250,i=0,d=0,s=0,l=0,h=0,c,g=0,f=1,b=1,m=null,v=Hr,w=null,u,y,E,k=jn,j=.5,N,q,S,L,z;function M(x){return S(x[0]*et,x[1]*et)}function $(x){return x=S.invert(x[0],x[1]),x&&[x[0]*vt,x[1]*vt]}M.stream=function(x){return L&&z===x?L:L=Ud(Hd(c)(v(N(k(z=x)))))},M.preclip=function(x){return arguments.length?(v=x,m=void 0,F()):v},M.postclip=function(x){return arguments.length?(k=x,w=u=y=E=null,F()):k},M.clipAngle=function(x){return arguments.length?(v=+x?kd(m=x*et):(m=null,Hr),F()):m*vt},M.clipExtent=function(x){return arguments.length?(k=x==null?(w=u=y=E=null,jn):jd(w=+x[0][0],u=+x[0][1],y=+x[1][0],E=+x[1][1]),F()):w==null?null:[[w,u],[y,E]]},M.scale=function(x){return arguments.length?(r=+x,U()):r},M.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],U()):[n,o]},M.center=function(x){return arguments.length?(i=x[0]%360*et,d=x[1]%360*et,U()):[i*vt,d*vt]},M.rotate=function(x){return arguments.length?(s=x[0]%360*et,l=x[1]%360*et,h=x.length>2?x[2]%360*et:0,U()):[s*vt,l*vt,h*vt]},M.angle=function(x){return arguments.length?(g=x%360*et,U()):g*vt},M.reflectX=function(x){return arguments.length?(f=x?-1:1,U()):f<0},M.reflectY=function(x){return arguments.length?(b=x?-1:1,U()):b<0},M.precision=function(x){return arguments.length?(N=Xr(q,j=x*x),F()):_t(j)},M.fitExtent=function(x,T){return di(M,x,T)},M.fitSize=function(x,T){return Dd(M,x,T)},M.fitWidth=function(x,T){return Id(M,x,T)},M.fitHeight=function(x,T){return Pd(M,x,T)};function U(){var x=Zr(r,0,0,f,b,g).apply(null,a(i,d)),T=Zr(r,n-x[0],o-x[1],f,b,g);return c=fd(s,l,h),q=kn(a,T),S=kn(c,q),N=Xr(q,j),F()}function F(){return L=z=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&$,U()}}function pi(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}pi.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Fe(o)>Le&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Yd(){return Wd(pi).scale(175.295)}function Qd(e){return e}function Kd(e){if(e==null)return Qd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(s,l){l||(a=r=0);var h=2,c=s.length,g=new Array(c);for(g[0]=(a+=s[0])*n+i,g[1]=(r+=s[1])*o+d;h<c;)g[h]=s[h],++h;return g}}function Jd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Xd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return eo(e,r)})}:eo(e,a)}function eo(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Zd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Zd(e,a){var r=Kd(e.transform),n=e.arcs;function o(c,g){g.length&&g.pop();for(var f=n[c<0?~c:c],b=0,m=f.length;b<m;++b)g.push(r(f[b],b));c<0&&Jd(g,m)}function i(c){return r(c)}function d(c){for(var g=[],f=0,b=c.length;f<b;++f)o(c[f],g);return g.length<2&&g.push(g[0]),g}function s(c){for(var g=d(c);g.length<4;)g.push(g[0]);return g}function l(c){return c.map(s)}function h(c){var g=c.type,f;switch(g){case"GeometryCollection":return{type:g,geometries:c.geometries.map(h)};case"Point":f=i(c.coordinates);break;case"MultiPoint":f=c.coordinates.map(i);break;case"LineString":f=d(c.arcs);break;case"MultiLineString":f=c.arcs.map(d);break;case"Polygon":f=l(c.arcs);break;case"MultiPolygon":f=c.arcs.map(l);break;default:return null}return{type:g,coordinates:f}}return h(a)}const ci={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ep=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function tp(e,a,r){const n=ci[e];if(!n||!n.length)return-1;const o=ep(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let Na=null;function ap(){return Na||(Na=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Xd(r,n),i=Yd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Md(i),s=(o.features||[]).filter(c=>{var g;return(((g=c.properties)==null?void 0:g.name)||"")!=="Antarctica"}).map(c=>{var b;const g=((b=c.properties)==null?void 0:b.name)||"",f=d(c)||"";return f?{i2:ls(g)||null,n:g,d:f}:null}).filter(c=>!!c);if(!s.length)return null;const l={};for(const[c,g]of Object.entries(ds)){const f=i(g);f&&(l[c]={x:f[0],y:f[1]})}const h={};for(const[c,g]of Object.entries(ci)){const f=g.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));f.length&&(h[c]=f)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:l,metros:h}}catch{return null}})(),Na)}function np(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return ap().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const rp="8 40 984 210",op={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},to=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function ao(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ip(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const d=()=>{var h;if(!o)return;const l=(h=e.current)==null?void 0:h.getScreenCTM();l&&l.a>0?n(l.a):i=requestAnimationFrame(d)};d();const s=new ResizeObserver(()=>d());return e.current&&s.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function no({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function sp(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:s,t:l,data:h,dossiers:c,source:g}=X(),f=h.loading&&!c.length,b=p.useRef(null),m=p.useRef(null),v=np(e.continent==="monde"),w=e.continent==="monde"?v:Dn.find(x=>x.key===e.continent)||null,u=ip(b,e.continent+":"+e.mapFolded+":"+!!w),[y,E]=p.useState(new Map),[k,j]=p.useState(null);p.useEffect(()=>{const x=b.current;if(!x)return;const T=new Map;x.querySelectorAll("path[data-i2]").forEach(D=>{const Y=D.dataset.i2;if(Y)try{const ee=D.getBBox();ee.width>0&&T.set(Y,{x:ee.x,y:ee.y,w:ee.width,h:ee.height})}catch{}}),E(T)},[e.continent,u,w]);const N=p.useMemo(()=>r.filter(x=>x.cc),[r]),q=p.useMemo(()=>{const x=new Map;return N.forEach(T=>x.set(T.cc,(x.get(T.cc)||0)+1)),x},[N]),S=e.continent==="monde"&&v?v.anchors:null,L=e.continent==="monde"&&v?v.metros:null,z=p.useMemo(()=>N.map(x=>{const T=ao(x.name||x.id||""),D=ao((x.id||x.name||"")+"·y");if(S&&x.cc){const I=L?L[x.cc]:void 0;if(I&&I.length){const H=tp(x.cc,x.city,T);if(H>=0&&I[H])return{d:x,x:I[H].x+(T-.5)*5,y:I[H].y+(D-.5)*5}}const K=S[x.cc];if(K)return{d:x,x:K.x+(T-.5)*10,y:K.y+(D-.5)*10}}const Y=x.cc?y.get(x.cc):void 0;if(!Y)return null;const ee=op[`${e.continent}:${x.cc||""}`];if(ee)return{d:x,x:Y.x+Y.w*(ee.fx+(T-.5)*ee.sx),y:Y.y+Y.h*(ee.fy+(D-.5)*ee.sy)};const C=(T-.5)*Math.min(Y.w*.55,60),B=(D-.5)*Math.min(Y.h*.55,60);return{d:x,x:Y.x+Y.w/2+C,y:Y.y+Y.h/2+B}}).filter(x=>!!x),[N,y,S,L,e.continent]),M=x=>u>0?x/u:x,$=p.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:to[x],fr:l.plabels[x],en:l.plabels[x],n:r.filter(T=>T.kind==="target"&&Te(T)===x).length})).filter(x=>x.n>0):or.map((x,T)=>({...x,n:r.filter(D=>ir(D)===T).length})),[r,n,l.plabels]),U=i?d.get(i):null,F=U?z.find(x=>x.d.id===U.id):null;return w?t.jsxs("div",{className:"mapzone"+(f?" waiting":""),"data-cont":e.continent,ref:m,children:[f&&t.jsx(no,{msgs:l.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?rp:w.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?w.fr:w.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:w.countries.map((x,T)=>t.jsx("g",{className:"ct"+(x.i2&&q.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},T))}),t.jsx("g",{children:z.map(x=>{const T=or[ir(x.d)],D=!!_e(x.d),Y=x.d.kind==="target",ee=n&&Y?to[Te(x.d)]:T.c,C=!n&&Ue(x.d);return t.jsxs("g",{className:"co"+(C?" done":""),onMouseEnter:()=>{var K,H;const B=(K=m.current)==null?void 0:K.getBoundingClientRect(),I=(H=b.current)==null?void 0:H.createSVGPoint();if(I&&b.current&&B){I.x=x.x,I.y=x.y;const ce=I.matrixTransform(b.current.getScreenCTM());j({x:ce.x-B.left,y:ce.y-B.top,label:x.d.name+" · "+(Kt(x.d.cc,s)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var K;if(g==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const B=(K=b.current)==null?void 0:K.createSVGPoint();let I=null;if(B&&b.current){B.x=x.x,B.y=x.y;const H=B.matrixTransform(b.current.getScreenCTM());I={x:H.x,y:H.y}}a({type:"popup",id:x.d.id,anchor:I})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:M(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:M(T.px),fill:ee,stroke:D?"#E5484D":"#ffffff",strokeWidth:M(D?2.2:1.3)})]},x.d.id||x.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:M(13),fill:"none",stroke:"#16233A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:$.map((x,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),s==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},T))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",l.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(f?" waiting":""),"data-cont":e.continent,ref:m,children:t.jsx(no,{msgs:l.loadMsgs})})}function lp(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function ui({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:s}=X(),l=a.filters,[h,c]=p.useState(!1),[g,f]=p.useState(!1),b=p.useRef(null),m=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),w=F=>v.filter(x=>F!=="country"&&l.country.length&&!l.country.includes(x.cc||"")?!1:Pa(x,l,i,F==="country"?void 0:F)),u=F=>!i||F.kind!=="op",y=p.useMemo(()=>{const F=w("win").filter(u),x=T=>F.filter(D=>(D.date?Math.max(0,Math.floor((Date.now()-Date.parse(D.date))/864e5)):9999)<=T).length;return[x(0),x(7),x(30),F.length]},[v,l,i]),E=p.useMemo(()=>l.day?w("win").filter(u).filter(F=>(F.date||"").slice(0,10)===l.day).length:0,[v,l,i]),k=(l.signalOnly?1:0)+l.sector.length+l.market.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+l.crible.length,j=k+(l.acquirer.trim()?1:0)+(l.day||l.win!=="all"?1:0)+(l.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!h&&!g)return;const F=T=>{var Y,ee;const D=T.target;h&&!((Y=b.current)!=null&&Y.contains(D))&&c(!1),g&&!((ee=m.current)!=null&&ee.contains(D))&&f(!1)},x=T=>{T.key==="Escape"&&(c(!1),f(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",x)}},[h,g]);const N=(F,x,T,D="fbtn")=>t.jsxs("button",{type:"button",className:D,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:x}),T>0&&t.jsx("span",{className:"n",children:T}),t.jsx("span",{className:"cv",children:"▾"})]},F),q=["1","7","30","all"],S=Math.max(0,q.indexOf(l.win||"all")),L=l.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(lp(l.day,s))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>f(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[S]}),t.jsx("b",{children:y[S]}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:q.map((F,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":l.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),f(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:y[x]})]},F))})]}):t.jsx("div",{className:"seg",children:q.map((F,x)=>t.jsxs("button",{type:"button","aria-pressed":l.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:y[x]})]},F))}),z=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:l.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),M=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),l.signalOnly&&t.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),l.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:l.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",o.fSector,l.sector.length),(n.some(F=>!!F.market)||l.market.length>0)&&N("mar",o.fMarket,l.market.length),N("pay",o.fCountry,l.country.length),N("det",o.fEngine,l.engine.length),N("sta",o.fStage,l.stage.length),i&&N("crib",o.fVerdict,l.crible.length),i&&N("ang","Angle",l.angle.length),i&&N("mem","Mémo",l.memoLevel.length)]}),$=(F=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),U=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{c(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:M})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(l.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:L}),t.jsxs("div",{className:"fstrip-b",children:[z,U,$(!1)]})]}),a.openFacet&&t.jsx(ro,{poolFor:w})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[L,z,M,t.jsx("span",{className:"fgrow"}),$()]}),a.openFacet&&t.jsx(ro,{poolFor:w})]})}function ro({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=X(),s=a.filters,l=a.openFacet,{title:h,cols:c,options:g}=p.useMemo(()=>{if(l==="sig"){const w=e("signal").filter(E=>_e(E)),u=new Map;w.forEach(E=>{const k=E.engine||"";u.set(k,(u.get(k)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:w.length,html:!0,on:s.signalOnly&&!s.signalEngines.length},...gn([...u.keys()],o).map(E=>({v:E,label:Ot(E)+" "+tt(E,o),n:u.get(E)||0,html:!1,on:s.signalOnly&&s.signalEngines.includes(E)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="crib"){const w=e("crible").filter(y=>!i||wo(y,a.ptab,d.favIds)),u=new Map;return w.forEach(y=>{const E=yo(y);E&&E!=="NEW"&&u.set(E,(u.get(E)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...u.entries()].sort((y,E)=>(sr[y[0]]??9)-(sr[E[0]]??9)||E[1]-y[1]).map(([y,E])=>({v:y,label:'<span class="fdot" style="background:'+(ps[y]||"#94A3B8")+'"></span>'+y,n:E,html:!0,on:s.crible.includes(y)}))}}if(l==="sec"){const w=e("sector"),u=new Map;return w.forEach(y=>{y.sector&&u.set(y.sector,(u.get(y.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...u.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y,n:E,html:!1,on:s.sector.includes(y)}))}}if(l==="mar"){const w=e("market"),u=new Map;return w.forEach(y=>{y.market&&u.set(y.market,(u.get(y.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...u.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y,n:E,html:!1,on:s.market.includes(y)}))}}if(l==="pay"){const w=e("country"),u=new Map;return w.forEach(y=>{y.cc&&u.set(y.cc,(u.get(y.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...u.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:Kt(y,o)||y,n:E,html:!1,on:s.country.includes(y)}))}}if(l==="det"){const w=e("engine"),u=new Map;return w.forEach(y=>{y.engine&&u.set(y.engine,(u.get(y.engine)||0)+1)}),{title:n.fEngine,cols:2,options:gn([...u.keys()],o).map(y=>({v:y,label:Ot(y)+" "+tt(y,o)+' <span style="color:var(--dim);font-size:10px">· '+cs(us(y),o)+"</span>",n:u.get(y)||0,html:!0,on:s.engine.includes(y)}))}}if(l==="ang"){const w=e("angle"),u=new Map;return w.forEach(y=>{y.angle&&u.set(y.angle,(u.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...u.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y.replace(/[_-]+/g," "),n:E,html:!1,on:s.angle.includes(y)}))}}if(l==="mem"){const w=e("memoLevel"),u=new Map;w.forEach(E=>{if(E.kind==="target"){const k=Mn(E);u.set(k,(u.get(k)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(E=>({v:String(E),label:y[E],n:u.get(E)||0,html:!1,on:s.memoLevel.includes(E)}))}}const m=e("stage"),v=new Map;return m.forEach(w=>{w.stage&&v.set(w.stage,(v.get(w.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...v.entries()].sort((w,u)=>u[1]-w[1]).map(([w,u])=>({v:w,label:w,n:u,html:!1,on:s.stage.includes(w)}))}},[l,a,o]),f=m=>{if(l==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(s.signalOnly&&!s.signalEngines.length),signalEngines:[]}});else{const w=s.signalEngines.includes(m)?s.signalEngines.filter(u=>u!==m):[...s.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:w}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage",value:m})},b=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:h}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>f(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function mi({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:s}=X(),l=p.useMemo(()=>{const b={};return r.forEach(m=>{Pa(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[h,c]=p.useState(!1),g=p.useRef(null);p.useEffect(()=>{if(!h)return;const b=v=>{var w;(w=g.current)!=null&&w.contains(v.target)||c(!1)},m=v=>{v.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[h]);const f=b=>{const m=Dn.find(v=>v.key===b);return b==="monde"?s.contWorld:d==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:g,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[f(n.continent),t.jsx("span",{className:"n",children:l[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:lr.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[f(b),t.jsx("span",{className:"n",children:l[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:s.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:s.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[lr.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[f(b),t.jsx("span",{className:"n",children:l[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:s.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:s.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]})]})}function Rn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function fi(e){return"atl2:evalq:"+(e||"anon")}function dp(e,a){const r=fi(e),n=Rn(r),o=new Set(n.map(s=>(s.name||"").trim().toLowerCase())),i=a.map(s=>(s||"").trim()).filter(s=>s&&!o.has(s.toLowerCase())).map(s=>({name:s,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function pp(){const{t:e,lang:a,data:r,dossiers:n}=X(),o=r.session.token||"",i=fi(o),[d,s]=p.useState(()=>Rn(i)),l=p.useRef(!1),[h,c]=p.useState(!1);p.useEffect(()=>{try{const C=d.slice(0,30).map(({descBusy:B,evalBusy:I,...K})=>K);localStorage.setItem(i,JSON.stringify(C)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[d,i]),p.useEffect(()=>{const C=()=>{if(l.current)return;const B=Rn(i);s(I=>JSON.stringify(I.map(({descBusy:K,evalBusy:H,...ce})=>ce))===JSON.stringify(B)?I:B)};return window.addEventListener("atl2:evalq",C),window.addEventListener("storage",C),()=>{window.removeEventListener("atl2:evalq",C),window.removeEventListener("storage",C)}},[i]);const[g,f]=p.useState([]),[b,m]=p.useState(""),[v,w]=p.useState(!1),[u,y]=p.useState(!1),[E,k]=p.useState(""),j=p.useCallback((C,B)=>s(I=>I.map((K,H)=>H===C?{...K,...B}:K)),[]),N=p.useCallback((C,B)=>{const I=B.trim();I&&(j(C,{name:I,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),In(I).then(K=>{const H=K.candidates||[];K.website?j(C,{site:K.website,status:"ready"}):H.length===1?j(C,{site:H[0].url,status:"ready"}):H.length>1?j(C,{status:"pick",candidates:H.slice(0,6)}):j(C,{status:"ready"})}).catch(()=>j(C,{status:"ready"})))},[j]),q=p.useCallback((C,B,I)=>{j(C,{descBusy:!0}),Eo(o,B,I).then(K=>{if(K.quota){c(!0),j(C,{descBusy:!1,descDone:!0});return}const H=K.blocs||{},ce=(H.synthese||H.value_prop||H.produit||H.modele||"").trim();j(C,{descBusy:!1,descDone:!0,desc:ce})}).catch(()=>j(C,{descBusy:!1,descDone:!0}))},[j,o]);p.useEffect(()=>{const C=d.findIndex(I=>I.auto&&I.name.trim()&&I.status==="");if(C>=0){N(C,d[C].name);return}if(h)return;const B=d.findIndex(I=>I.status==="ready"&&I.site&&!I.descDone&&!I.descBusy);B>=0&&q(B,d[B].name,d[B].site)},[d,N,q,h]);const[S,L]=p.useState(!1),z=p.useCallback(async(C,B)=>{j(C,{evalBusy:!0});const I=(B.site||B.name).trim(),K=await jo(o,I,"atelier2");return K.verdict==="quota"?(j(C,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:K.reason||"",remaining:0}})),!1):(j(C,{evalBusy:!1,status:K.verdict==="kept"?"kept":"out",reason:K.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:K.company||B.name,verdict:K.verdict,reason:K.reason||"",remaining:K.remaining??null}})),!0)},[j,o]),M=async()=>{if(S)return;const C=d.map((B,I)=>({r:B,i:I})).filter(({r:B})=>B.name.trim()&&B.status!=="kept"&&B.status!=="out"&&B.status!=="resolving");if(C.length){L(!0);for(const{r:B,i:I}of C)if(!await z(I,B))break;L(!1)}},$=p.useMemo(()=>{const C=new Set,B=[];return d.filter(I=>I.status==="kept").forEach(I=>{const K=I.name.trim().toLowerCase();K&&!C.has(K)&&(C.add(K),B.push(I.name.trim()))}),n.filter(I=>Te(I)>=1&&Te(I)<=4&&(I.website||I.domain)).forEach(I=>{const K=(I.name||"").trim().toLowerCase();K&&!C.has(K)&&(C.add(K),B.push((I.name||"").trim()))}),B},[d,n]),U=p.useMemo(()=>{const C=new Set;return n.forEach(B=>{const I=(B.name||"").trim().toLowerCase();I&&C.add(I)}),d.forEach(B=>{const I=B.name.trim().toLowerCase();I&&C.add(I)}),C},[n,d]),F=async()=>{if(b||!$.length)return;y(!1);const C=[];for(const B of $.slice(0,2)){m(B);const I=await No(o,B);if(I){if(I.verdict==="quota"){w(!0);break}(I.results||[]).forEach(K=>{const H=(K.company||"").trim().toLowerCase();!H||U.has(H)||C.some(ce=>ce.name.toLowerCase()===H)||C.push({name:(K.company||"").trim(),verdict:K.verdict||"",reason:K.reason,from:B})})}}m(""),y(!0),f(B=>[...C,...B].slice(0,24))},x=async(C,B)=>{if(b)return;y(!1),m(C==="thesis"?e.pxThesis:B);const I=await fs(o,C,B,6);if(m(""),y(!0),!I)return;if(I.verdict==="quota"){w(!0);return}const K=[];(I.results||[]).forEach(H=>{const ce=(H.company||"").trim().toLowerCase();!ce||U.has(ce)||K.some(te=>te.name.toLowerCase()===ce)||K.push({name:(H.company||"").trim(),verdict:H.verdict||"",reason:H.reason,from:C==="thesis"?e.pxThesis:B})}),f(H=>[...K,...H].slice(0,24))},T=()=>{const C=E.trim();C.length<3||x(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(C)?"registry":"keyword",C)},D=C=>{s(B=>[...B,{name:C.name,site:"",status:"",auto:!0}].slice(0,30)),f(B=>B.filter(I=>I.name!==C.name))},Y=d.filter(C=>C.name.trim()&&C.status!=="kept"&&C.status!=="out").length,ee=C=>C.name.trim()&&C.status!=="kept"&&C.status!=="out"&&C.status!=="resolving"&&!C.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{className:"eq-h-go",children:e.eqRunOneShort})]}),d.map((C,B)=>t.jsxs("div",{className:"eq-item"+(C.status==="kept"?" r-kept":C.status==="out"?" r-out":""),children:[t.jsxs("div",{className:"eq-row"+(C.status==="kept"?" r-kept":C.status==="out"?" r-out":""),children:[t.jsx("input",{value:C.name,placeholder:e.eqNamePh,onChange:I=>{const K=I.target.value.split(`
`).map(H=>H.trim()).filter(Boolean);K.length>1?s(H=>{const ce=[...H];return ce.splice(B,1,...K.map(te=>({name:te,site:"",status:"",auto:!0}))),ce.slice(0,30)}):j(B,{name:I.target.value})},onBlur:()=>{C.name.trim()&&!C.site&&C.status!=="resolving"&&C.status!=="pick"&&N(B,C.name)},onKeyDown:I=>{I.key==="Enter"&&N(B,C.name)}}),t.jsxs("span",{className:"eq-site",children:[C.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),C.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:I=>{const K=I.target.value;K&&j(B,{site:K,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(C.candidates||[]).map(I=>t.jsx("option",{value:I.url,children:(I.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},I.url))]}),C.status!=="resolving"&&C.status!=="pick"&&(C.site?t.jsxs("a",{href:C.site.startsWith("http")?C.site:"https://"+C.site,target:"_blank",rel:"nofollow noopener",children:[C.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:C.name.trim()&&C.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:C.desc||"",children:C.descBusy?t.jsx("i",{children:e.eqDescBusy}):C.desc?C.desc:t.jsx("em",{children:C.descDone?h?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(C.status||"vide"),title:C.reason||"",children:C.status==="kept"?"✓ "+e.kept:C.status==="out"?"✗ "+e.dropped:C.status==="ready"?e.eqReady:C.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>s(I=>I.filter((K,H)=>H!==B)),children:"×"}),(C.name.trim()||C.site)&&C.status!=="kept"&&C.status!=="out"?t.jsxs(Ya,{lang:a,storeKey:(C.site||C.name).trim(),className:"eq-go",title:e.eqRunOne,disabled:!ee(C)||S,confirmLabel:"⚡ "+e.eqRunOneShort,onConfirm:()=>{z(B,C)},children:[C.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}):t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!ee(C)||S,onClick:()=>{z(B,C)},children:[C.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]})]}),(C.name.trim()||C.site)&&C.status!=="kept"&&C.status!=="out"&&t.jsx(ms,{lang:a,variant:"row",storeKey:(C.site||C.name).trim()})]},B)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>s(C=>[...C,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!b,onClick:()=>{x("thesis","")},children:b===e.pxThesis?e.sgBusy(b):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:E,placeholder:e.pxPlace,onChange:C=>k(C.target.value),onKeyDown:C=>{C.key==="Enter"&&T()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b||E.trim().length<3,onClick:T,children:e.pxGoFree}),!!$.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b,onClick:()=>{F()},children:b&&b!==e.pxThesis&&b!==E?e.sgBusy(b):e.sgGo}),!!$.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom($[0],$.length)}),v&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),u&&!g.length&&!v&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),g.map(C=>t.jsxs("span",{className:"eq-sc"+(C.verdict==="kept"?" ok":""),title:(C.reason||"")+" — "+e.sgVia(C.from),children:[t.jsx("b",{children:C.name}),C.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>D(C),children:"+"})]},C.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),d.some(C=>C.status==="kept"||C.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>s(C=>C.filter(B=>B.status!=="kept"&&B.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(S?" loading":""),style:{justifyContent:"center"},disabled:S||!Y,onClick:()=>{M()},children:[t.jsx("span",{className:"fill"}),S?e.eqRunning:e.eqGo(Y)]})]})]})]})}const cp={deals:"ma-deals",news:"veille"};function oo(e){return(e.url||e.title||"").trim()}function up(e){const a=(e.title||"").replace(/\s+/g," ").trim();if(!a)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const r=/^(.{2,72}?)[:–—|]/.exec(a);return r?r[1].trim():(a.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||a).slice(0,72).trim()}function mp({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,canWrite:i,flash:d}=X(),[s,l]=p.useState(null),[h,c]=p.useState({deals:[],news:[]}),[g,f]=p.useState({deals:!1,news:!1}),[b,m]=p.useState(null),[v,w]=p.useState(""),u=p.useRef(!1),y=p.useCallback(async z=>{if(!o)return[];if(g[z])return h[z];m(z),w("");const M=await hs(cp[z],o,n);return m(null),!M.ok&&M.error?(w(M.error),[]):(c($=>({...$,[z]:M.items})),f($=>({...$,[z]:!0})),M.items)},[o,n,g,h]);p.useEffect(()=>{s&&y(s)},[s,y]);const E=p.useCallback(z=>h[z].map(oo).filter(Boolean),[h]),k=p.useMemo(()=>{var $,U;if(!o)return{deals:[],news:[]};const z={deals:E("deals"),news:E("news")},M=Do("feed:"+o,z);return{deals:(($=M.deals)==null?void 0:$.noms)||[],news:((U=M.news)==null?void 0:U.noms)||[]}},[o,E]),j=p.useRef(null);p.useEffect(()=>{j.current&&!s&&o&&Io("feed:"+o,{deals:E("deals"),news:E("news")}),j.current=s},[s,o,E]);const N=z=>{const M=z.map(up).filter(Boolean);if(!M.length){d(r.feedEmptyDeals);return}a(M),l(null),d(r.feedSent(M.length))},q=(z,M)=>{const $=(z.url||"").trim();if(M==="news"&&$&&/^https?:\/\//i.test($)){window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:$}})),l(null);return}N([z])},S=async z=>{if(s===z){l(null);return}if(u.current)return;u.current=!0;const M=await y(z);if(u.current=!1,M.length){N(M);return}l(z)},L=z=>{const M=h[z],$=new Set(k[z].map(U=>U.toLowerCase()));return t.jsxs("div",{className:"dfpane"+(s===z?" on":""),hidden:s!==z,children:[t.jsx("p",{className:"dfh",children:z==="deals"?r.feedDealsH:r.feedNewsH}),b===z&&t.jsx("p",{className:"dfload",children:n==="en"?"Loading…":"Chargement…"}),s===z&&!!v&&t.jsx("p",{className:"dferr",children:v}),g[z]&&!M.length&&!b&&t.jsx("p",{className:"dfempty",children:z==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!M.length&&t.jsx("ul",{className:"dflist",children:M.map((U,F)=>{const x=oo(U),T=$.has(x.toLowerCase()),D=(U.url||"").trim();return t.jsxs("li",{className:T?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:U.title||D}),t.jsx("span",{children:[U.source,U.sector_fr,(U.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[D&&t.jsx("a",{href:D,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),i&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>q(U,z),children:z==="deals"?r.feedToEval:r.feedToExtract})]})]},x||F)})})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(z=>{const M=k[z].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(z==="deals"?"ddeals":"dnews")+(s===z?" on":"")+(b===z?" busy":""),"aria-busy":b===z||void 0,onClick:()=>{S(z)},children:[b===z?n==="en"?"Loading…":"Chargement…":z==="deals"?r.feedDeals:r.feedNews,M>0&&b!==z&&t.jsx("em",{title:r.feedHint,children:r.feedNew(M)})]},z)}),s&&L(s)]})}function hi(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function fp(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function io({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:s}=X();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(l=>l.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(l=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:l.name}),l.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),l.line1&&t.jsx("p",{className:"w",children:l.line1}),l.line2&&t.jsx("p",{className:"r",children:l.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(l.name),children:s.rsEvalOne})]},l.name))})]}):null}function gi({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=X(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(io,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(io,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function hp({card:e,onEvaluate:a,onAddAll:r}){var s,l,h;const{t:n}=X(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:hi(e.summary_md||"").map((c,g)=>t.jsx("p",{children:c},g))})]}),t.jsx(gi,{card:e,onEvaluate:a,onAddAll:r}),(((l=e.prospective)==null?void 0:l.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(c=>t.jsx("li",{children:c},c))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function gp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function xp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=X(),s=o,[l,h]=p.useState(null),[c,g]=p.useState(null),[f,b]=p.useState(null),[m,v]=p.useState(!1);p.useEffect(()=>{let u=!0;return(async()=>{const y=await So({email:d,cbToken:s});u&&h(y)})(),()=>{u=!1}},[d,s,n]);const w=u=>{g(u),b(null),v(!0),(async()=>{const y=await gs(u.id);b(y),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{g(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&l&&t.jsx("span",{className:"n",children:l.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[l===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),l!==null&&l.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(l||[]).map(u=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>w(u),children:[t.jsx("span",{className:"ti",children:u.title}),t.jsxs("span",{className:"me",children:[gp(u.created_at),u.industry?` · ${u.industry}`:"",u.author?` · ${u.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(u.cited_n||0,u.evaluate_n||0)}),t.jsx("span",{className:"st"+(u.published?" on":""),children:u.published?i.rsPub:i.rsPriv})]},u.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!f&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&f&&t.jsx(hp,{card:f,onEvaluate:a,onAddAll:r})]})]})}const Ta=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ia(e){return/^https?:\/\//i.test((e||"").trim())}function ct(e){const a=(e||"").trim();return a?ia(a)?a:Ta.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function bp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function vp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:s,evalBusy:l,evalCards:h,caps:c,data:g,canWrite:f,source:b,dossiers:m,doAnalyse:v,liveMemos:w,pipe:u}=X(),y=r==="client",E=p.useMemo(()=>n||(b!=="default"?xs():""),[n,b]),[k,j]=p.useState(""),[N,q]=p.useState(!1),[S,L]=p.useState(""),[z,M]=p.useState(""),[$,U]=p.useState(""),[F,x]=p.useState(!1),[T,D]=p.useState(!1),[Y,ee]=p.useState([]);p.useEffect(()=>{const R=_=>{const V=_.detail;V&&ee(ae=>[V,...ae].slice(0,8))};return window.addEventListener("ppmap:evalcard",R),()=>window.removeEventListener("ppmap:evalcard",R)},[]);const[C,B]=p.useState(!1),[I,K]=p.useState(!1),[H,ce]=p.useState(!1),te=p.useRef(!1),[le,xe]=p.useState(""),[he,we]=p.useState(""),[pe,Ne]=p.useState(!1),[ze,ue]=p.useState(!1),[be,ye]=p.useState(0),[Z,P]=p.useState(""),[Q,ie]=p.useState(null),[oe,me]=p.useState(null),[W,se]=p.useState(!1),[ve,ke]=p.useState(null),[Ee,ge]=p.useState(0),Ie=p.useRef(!1),Je=k.trim()?Ta.test(k.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const R=new URLSearchParams(window.location.search),_=(R.get("rs")||"").trim(),V=(R.get("rstext")||"").trim();_&&/^https?:\/\//i.test(_)&&xe(_),V&&we(V),(_&&/^https?:\/\//i.test(_)||V)&&B(!0)},[]),p.useEffect(()=>{const R=_=>{const V=_.detail||{},ae=String(V.url||"").trim(),re=String(V.text||"").trim();ae&&/^https?:\/\//i.test(ae)&&xe(ae),re&&we(re),(ae&&/^https?:\/\//i.test(ae)||re)&&(B(!0),j(""),L(""),Ne(!0),window.setTimeout(()=>Ne(!1),900))};return window.addEventListener("ppmap:research",R),()=>window.removeEventListener("ppmap:research",R)},[]),p.useEffect(()=>{const R=_=>{const V=_.detail||{},ae=String(V.name||"").trim();if(!ae)return;B(!1),j(ae),L(ae);const re=ct(String(V.website||V.domain||""));M(re),U(ct(String(V.url||""))),x(!re),q(!0),window.setTimeout(()=>q(!1),900)};return window.addEventListener("ppmap:prefill",R),()=>window.removeEventListener("ppmap:prefill",R)},[]),p.useEffect(()=>{const R=(S||"").trim();if(!R||C||z){(z||!R||C)&&x(!1);return}const _=$e(R),V=m.find(Ae=>$e(Ae.name)===_)||m.find(Ae=>{const de=$e(Ae.name);return de.length>=3&&(_.includes(de)||de.includes(_))}),ae=ct((V==null?void 0:V.website)||"")||ct((V==null?void 0:V.domain)||""),re=ct((V==null?void 0:V.url)||"");if(re&&U(Ae=>Ae||re),ae){M(ae),x(!1);return}let je=!0;return x(!0),In(R).then(Ae=>{var He,jt;if(!je)return;const de=ct(Ae.website||"")||ct(((jt=(He=Ae.candidates)==null?void 0:He[0])==null?void 0:jt.url)||"");de&&M(de)}).catch(()=>{}).finally(()=>{je&&x(!1)}),()=>{je=!1}},[S,C,z,m]),p.useEffect(()=>{const R=_=>{var ae;const V=String(((ae=_.detail)==null?void 0:ae.url)||"").trim();ia(V)&&window.open(V,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",R),()=>window.removeEventListener("ppmap:view",R)},[]),p.useEffect(()=>{if(te.current===C)return;te.current=C,ce(!0);const R=window.setTimeout(()=>ce(!1),560);return()=>window.clearTimeout(R)},[C]),p.useEffect(()=>{if(typeof window>"u")return;const R=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),_=document.querySelector(".atl2.ops, .atl2.cibles");if(!R||!_)return;const V=_.classList.contains("cibles")?document.querySelector(".atl2.cibles .live-stack"):null,ae=()=>{const je=parseFloat(window.getComputedStyle(R).top)||0,Ae=R.getBoundingClientRect().top<=je+1;R.classList.toggle("is-stuck",Ae),_.classList.toggle("url-stuck",Ae);const de=Math.round(R.getBoundingClientRect().height);_.style.setProperty("--demand-h",`${de}px`);const He=window.matchMedia("(min-width: 861px)").matches;V&&He?_.style.setProperty("--pp-live-h",`${Math.round(V.getBoundingClientRect().height)}px`):_.classList.contains("cibles")&&_.style.setProperty("--pp-live-h","0px")};ae();const re=new ResizeObserver(ae);return re.observe(R),V&&re.observe(V),window.addEventListener("scroll",ae,!0),window.addEventListener("resize",ae),()=>{re.disconnect(),R.classList.remove("is-stuck"),_.classList.remove("url-stuck"),window.removeEventListener("scroll",ae,!0),window.removeEventListener("resize",ae)}},[b,N,pe,T,C,H,F]),p.useEffect(()=>{if(!f&&!E){ke(null);return}let R=!0;return(async()=>{const _=await So({email:o,cbToken:E});R&&ke(_.length)})(),()=>{R=!1}},[f,E,o,Ee]);const at=Y.length?Y:h,Ce=g.credits,dt=p.useCallback(R=>{dp(n,R)&&(D(!1),s({type:"ptab",tab:0}),requestAnimationFrame(()=>{const _=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!_)return;const V=window.scrollY+_.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,V),behavior:"smooth"})}))},[n,s]);p.useEffect(()=>{if(!ze)return;ye(0);const R=window.setInterval(()=>ye(_=>_+1),1e3);return()=>window.clearInterval(R)},[ze]);const nt=p.useMemo(()=>{const R=k.trim().toLowerCase();return!R||!u?null:m.find(_=>$e(_.name)===R&&Te(_)===1)||null},[k,m,u]),Xe=()=>{const R=k.trim();if(R){if(nt){v(nt);return}i(null,R),y&&j("")}},rt=async()=>{var V,ae,re;if(Ie.current)return;const R=le.trim().replace(/\s+/g,""),_=he.trim();if(!R&&!_){P(e.rsNeed);return}if(!y&&!E){i(null,R||_.slice(0,80));return}Ie.current=!0,P(""),ie(null),me(null),ue(!0);try{const je=await vs({url:R,text:_,email:o,cbToken:E});if(ue(!1),!je||je.status!=="success"){P((je==null?void 0:je.message)||"Erreur");return}ie(je),B(!1),dt((((V=je.prospective)==null?void 0:V.companies_to_evaluate)||[]).map(de=>(de==null?void 0:de.name)||"")),me({state:"pending"});const Ae=await ws(je,{email:o,cbToken:E});me(Ae.ok?{state:"ok",scopeLabel:((ae=Ae.summary)==null?void 0:ae.scope_label)||"",scope:((re=Ae.summary)==null?void 0:re.scope)||""}:{state:"fail",msg:Ae.error||""}),Ae.ok&&ge(de=>de+1)}finally{Ie.current=!1,ue(!1)}},At=[Q==null?void 0:Q.industry,...(Q==null?void 0:Q.market_tags)||[],Q==null?void 0:Q.author].map(R=>(R||"").trim()).filter(Boolean),bt=(oe==null?void 0:oe.state)==="pending",Bt=oe&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):oe.state==="ok"?t.jsx("span",{className:"rslink ok",children:oe.scope&&oe.scope!=="public"?e.rsSavedIn(oe.scopeLabel||oe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:oe.msg,children:e.rsSaveFail})),$t=fp(Q).length,Pe=C,Ze=(S||k).trim(),Ge=m.find(R=>$e(R.name)===$e(Ze)),mt=ct(k)||z||ct((Ge==null?void 0:Ge.website)||"")||ct((Ge==null?void 0:Ge.domain)||""),Et=$||ct((Ge==null?void 0:Ge.url)||""),qt=nt?e.actAnalyse:Ze?e.evalGoOn(Ze.length>22?Ze.slice(0,21)+"…":Ze):e.evalGo,O=ze?`${bs(le.trim())==="youtube"&&le.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(be)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Pe?" rs-mode":"")+(S&&k.trim()===S||N||pe?" pair":"")+(N||pe||H?" echo":"")+(H?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((Pe?pe:N)||H?" flash":"")+((Pe?le.trim():Ta.test(k.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Pe?le:k,placeholder:Pe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Pe?600:200,spellCheck:Pe?!1:void 0,inputMode:Pe?"url":void 0,onChange:R=>{if(Pe){xe(R.target.value);return}j(R.target.value),S&&R.target.value.trim()!==S&&(L(""),M(""),U(""),x(!1))},onKeyDown:R=>{R.key==="Enter"&&(Pe?rt():Xe())}}),t.jsx("span",{className:"detect"+(Pe?" off":"")+(Ta.test(k.trim())?" url":""),children:Je})]}),t.jsx("span",{className:"dacts",children:Pe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ze?" loading":""),disabled:ze||bt||!le.trim()&&!he.trim(),onClick:()=>{rt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:O})]}),t.jsxs("a",{className:"viewbtn"+(ia(le)?"":" off"),href:ia(le)?le.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:R=>{ia(le)||R.preventDefault()},children:[t.jsx(bp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs(Ya,{lang:a,storeKey:((nt==null?void 0:nt.name)||k).trim(),className:"evalbtn"+(nt?" analyse":"")+(l?" loading":""),disabled:l,confirmLabel:qt,onConfirm:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:qt})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(F?" searching":mt?"":" off"),href:mt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:R=>{mt||R.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite,!F&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(Et?"":" off"),href:Et||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:R=>{Et||R.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),c.showCredits&&Ce&&b==="ops"&&t.jsxs("button",{type:"button",className:"credits"+(Ce.total_available<=0&&!Ce.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Ce.unlimited?"∞":Ce.total_available}),!Ce.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Ce.daily_grant+Ce.purchased]}),Ce.total_available<=0&&!Ce.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{s({type:"ptab",tab:0}),D(!1),requestAnimationFrame(()=>{const R=document.querySelector(".atl2.cibles .desk-list");if(!R)return;const _=window.scrollY+R.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,_),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(C?" on":""),onClick:()=>{const R=!C;B(R),R&&(s({type:"ptab",tab:0}),requestAnimationFrame(()=>{const _=document.querySelector(".atl2.cibles .desk-list .evalq, .atl2.cibles .desk-list");if(!_)return;const V=window.scrollY+_.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,V),behavior:"smooth"})}))},children:e.rsOpen}),ve!==null&&ve>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(W?" on":""),onClick:()=>se(!W),children:e.rsArchOpen(ve)}),c.pipe&&!!n&&t.jsx(mp,{pageToken:E,onAddNames:dt})]}),W&&t.jsx(xp,{bump:Ee,cbToken:E,onClose:()=>se(!1),onEvaluate:R=>i(null,R),onAddAll:dt}),t.jsx("div",{className:"rsp slim"+(C?" on":" off"),"aria-hidden":!C,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:C?void 0:-1,onClick:()=>K(R=>!R),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:I?"▴":"▾"})]}),I&&t.jsx("textarea",{className:"rstext",value:he,placeholder:e.rsTextPh,tabIndex:C?void 0:-1,onChange:R=>we(R.target.value)})]})}),Z&&t.jsx("div",{className:"rserr",children:Z}),Q&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:Q.title}),Q.source_url&&t.jsx("a",{href:Q.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ie(null),me(null)},children:"×"})]}),Q.market&&t.jsx("p",{className:"rsmk",children:Q.market}),At.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),At.map(R=>t.jsx("span",{children:R},R))]}),t.jsxs("div",{className:"rsbody",children:[Q.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${Q.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:hi(Q.summary_md||"").map((R,_)=>t.jsx("p",{children:R},_))})]}),t.jsx(gi,{card:Q,onEvaluate:R=>i(null,R),onAddAll:dt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound($t)}),Bt]})]}),at.slice(0,1).map((R,_)=>{const V=R.verdict==="kept",ae=R.verdict==="quota",re=R.verdict==="unresolved",je=V?"var(--brand)":ae?"var(--bolt)":re?"var(--blue)":"var(--red)",Ae=V?"var(--brand-l)":ae?"#FFF3D6":re?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":je,"--bgc":Ae},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:V?"✓ "+e.kept:ae?"⏳":re?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),R.name&&t.jsx("span",{className:"rn",children:R.name}),t.jsx("span",{className:"rr",children:R.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",R.reason]}):null}),!!(R.candidates&&R.candidates.length)&&t.jsx("span",{className:"sitepick",children:R.candidates.map(de=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:de.url.startsWith("http")?de.url:`https://${de.url}`,target:"_blank",rel:"nofollow noopener",children:[(de.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,de.url,R.name),children:e.evalPickGo})]},de.url))}),!ae&&!re&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:V?1:5});const de=(R.name||"").trim().toLowerCase();window.setTimeout(()=>{const He=[...document.querySelectorAll(".atl2 .list .row")].find(jt=>{var Tt;return(((Tt=jt.querySelector(".rnm"))==null?void 0:Tt.textContent)||"").trim().toLowerCase().includes(de)});He&&(He.scrollIntoView({behavior:"smooth",block:"center"}),He.classList.add("flashrow"),window.setTimeout(()=>He.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(V?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},_)}),y&&(d.kept+d.dropped>0||at.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function wp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function yp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=X(),i=e.memoConsole?r.get(e.memoConsole):null,d=p.useMemo(()=>i?[i.reasoning||"",wp(i.summary||"")].filter(Boolean).join(`
...
`).map((h,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:h},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Vt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:l===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Vn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=X(),[d,s]=p.useState(!1),[l,h]=p.useState(null),c=n.pipe&&o==="client"&&!n.lockActions,g=async()=>{if(!c||d)return;s(!0);const f=await No(r,e);if(s(!1),!f){i(a.actErr);return}h(f.results||[])};return p.useEffect(()=>{if(!c)return;const f=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&g()};return window.addEventListener("ppmap:similar",f),()=>window.removeEventListener("ppmap:similar",f)},[e,c]),p.useEffect(()=>{if(c)try{const f=(sessionStorage.getItem("pp:similar")||"").trim();f&&f.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),g())}catch{}},[e,c]),c?t.jsxs("div",{className:"simb",onClick:f=>f.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{g()},children:d?a.similarBusy:a.similar}),l&&(l.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:l.map(f=>t.jsxs("li",{children:[t.jsx("b",{className:f.verdict==="kept"?"ok":"ko",children:f.company}),f.reason&&t.jsx("span",{children:f.reason})]},f.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const kp=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Sa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ma(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}function On(e){const a=ma(e);if(!a)return"";try{return new URL(a).hostname.replace(/^www\./,"")}catch{return""}}function Ep(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=Sa(a.slice(n));break}r+=Sa(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=Sa(a.slice(o));break}const d=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(d),l=s?s[2].toLowerCase():"";s&&kp.has(l)?r+=`<${s[1]}${l}>`:r+=Sa(a.slice(o,i+1)),n=i+1}return r}const jp=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),so={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function xi(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(jp.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const s=d.name.toLowerCase();(!(so["*"].has(s)||((r=so[o])==null?void 0:r.has(s)))||s.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(s=>s.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(s)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}xi(n)}}function La(e){const a=e.cloneNode(!0);return xi(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Np={swot:null,summary:"",syn:"",pnl:"",cf:"",roi:"",reco:"",plan:"",pruned:[]},Sp=/chiffre|revenu|revenue|\barr\b|ebitda|marge|gross|fcf|free cash|net|total|r[ée]sultat|cash|capex|nopat|moic|irr|\btri\b|roi|entry|\bev\b|invested|synerg/i,Cp=[["syn",/synerg/i],["pnl",/compte de r[ée]sultat|p\s*&\s*l|profit\s*(?:and|&)\s*loss|income statement/i],["cf",/flux de tr[ée]sorerie|cash\s*-?\s*flow/i],["roi",/\broi\b|return on investment|retour sur investissement/i],["reco",/verdict post|post[- ]model verdict|conviction quantitative/i]];function It(e){return String(e||"").replace(/<script[\s\S]*?<\/script>/gi," ").replace(/<style[\s\S]*?<\/style>/gi," ").replace(/<[^>]+>/g," ").replace(/&nbsp;/gi," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#39;|&apos;/g,"'").replace(/&quot;/g,'"').replace(/\s+/g," ").trim()}function bi(e,a){const r=e.slice(a),n=/<div\b|<\/div\s*>/gi;let o=0,i;for(;i=n.exec(r);)if(i[0][1]!=="/")o+=1;else if(o-=1,o===0)return e.slice(a,a+i.index+i[0].length);return""}function dn(e,a){const n=new RegExp(`<div\\b[^>]*\\bid="${a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}"`,"i").exec(e);return n?bi(e,n.index):""}function zp(e,a=14){const r=e.match(/<tr\b[\s\S]*?<\/tr\s*>/gi)||[];if(r.length<=a)return{html:e,pruned:!1};const n=[];for(let d=0;d<r.length-1;d+=1){const s=r[d],l=/<t[dh]\b[^>]*>([\s\S]*?)<\/t[dh]\s*>/i.exec(s),h=l?It(l[1]):"";if((d<2||/<th/i.test(s)||Sp.test(h))&&n.push(s),n.length>=a-1)break}n.push(r[r.length-1]);const o=n.length<3?r.slice(0,a):n;return{html:(/^\s*<table\b[^>]*>/i.exec(e)||["<table>"])[0]+o.join("")+"</table>",pruned:!0}}function Ap(e,a=14){let r=!1;return{html:e.replace(/<table\b[\s\S]*?<\/table\s*>/gi,o=>{const i=zp(o,a);return r=r||i.pruned,i.html}),pruned:r}}function qp(e){const a={s:[],w:[],o:[],t:[]},r=[["s","s-green"],["w","s-red"],["o","s-blue"],["t","s-orange"]];for(const[n,o]of r){const i=new RegExp(`<div\\b[^>]*class="[^"]*swot-item[^"]*\\b${o}\\b[^"]*"`,"i").exec(e);if(!i)return null;const d=bi(e,i.index);let s=(d.match(/<li\b[^>]*>([\s\S]*?)<\/li\s*>/gi)||[]).map(l=>It(l));if(!s.length){const l=/<p\b[^>]*>([\s\S]*?)<\/p\s*>/i.exec(d);l&&(s=[It(l[1])])}if(s=s.filter(l=>l&&!/not available/i.test(l)&&!/non disponible/i.test(l)).map(l=>l.slice(0,260)).slice(0,4),!s.length)return null;a[n]=s}return a}function Tp(e){const a=e.search(/id=["']company-summary["']/i);if(a<0)return"";const r=e.slice(a,a+9e3),n=/(?:EN R[ÉE]SUM[ÉE]|EN QUELQUES MOTS|IN SUMMARY|IN A FEW WORDS|IN A NUTSHELL|TL;DR)[\s:]*(?:<\/?span[^>]*>[\s:]*)*([\s\S]+?)(?=<br|<hr|<\/div|<h[23]|⚠|✅|🚀|❓|$)/i.exec(r);return n?It(n[1]).slice(0,600):""}function Lp(e,a,r){if(r<0)return"";const n=/<h3\b[^>]*>([\s\S]*?)<\/h3\s*>/gi;n.lastIndex=r;let o;for(;o=n.exec(e);){if(!a.test(It(o[1])))continue;const i=/<h3\b[^>]*>/i.exec(e.slice(o.index+o[0].length));return i?e.slice(o.index,o.index+o[0].length+i.index):e.slice(o.index,Math.min(e.length,o.index+o[0].length+6e4))}return""}function lo(e){let a=e.replace(/^\s*<div\b[^>]*>/i,"").replace(/<\/div\s*>\s*$/i,"");return a=a.replace(/<h2\b[^>]*class="[^"]*section-title[^"]*"[^>]*>[\s\S]*?<\/h2\s*>/gi,""),a=a.replace(/<details\b[\s\S]*?<\/details\s*>/gi,""),a.trim()}function pn(e,a){if(e.length<=a)return e;const r=e.slice(0,a),n=r.lastIndexOf(">");return n>=0?r.slice(0,n+1):r}function Fp(e){const a={...Np,pruned:[]};if(!e)return a;try{const n=dn(e,"swot");n&&(a.swot=qp(n))}catch{}try{a.summary=Tp(e)}catch{}try{const n=dn(e,"action-plan");if(n){const o=lo(n);a.plan=pn(o,12e3)}}catch{}const r=e.search(/id=["']financial-forecast["']/i);for(const[n,o]of Cp)try{let i=Lp(e,o,r);if(!i)continue;const d=Ap(i);i=pn(d.html,45e3),It(i)&&(a[n]=i,d.pruned&&a.pruned.push(n))}catch{}if(!a.reco)try{const n=dn(e,"conviction");if(n){const o=pn(lo(n),8e3);It(o)&&(a.reco=o)}}catch{}return a}function Rp(e){return e?!!(e.swot||e.summary||e.syn||e.pnl||e.cf||e.roi||e.reco||e.plan):!1}const cn=new Map;function vi(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=cn.get(a);return r||(r=Op(a).catch(()=>null),r.then(n=>{n||cn.delete(a)}),cn.set(a,r)),r}async function Op(e){var f,b;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=await a.text(),n=new DOMParser().parseFromString(r,"text/html"),o=m=>{var v;return(((v=n.querySelector(m))==null?void 0:v.textContent)||"").trim()},i=n.querySelector(".sb-score"),d=((f=Array.from((i==null?void 0:i.classList)||[]).find(m=>m.startsWith("sb-score-")))==null?void 0:f.slice(9))||"",s=[];let l=null;const h=Array.from(n.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const m of h){if(m.classList.contains("sb-nav-heading")){l={label:(m.textContent||"").trim(),items:[]},s.push(l);continue}const v=m.getAttribute("href")||"";if(!v.startsWith("#"))continue;const w=v.slice(1),u=Dp(n,w);u&&(l||(l={label:"",items:[]},s.push(l)),l.items.push({id:w,title:(m.textContent||"").trim(),html:u,poids:u.length}))}const c=((b=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:b[1])||"",g={score:o(".sb-score"),scoreTone:d,tags:Array.from(n.querySelectorAll(".sb-tag")).map(m=>(m.textContent||"").trim()).filter(Boolean),name:o(".sidebar-company-name"),tagline:o(".sidebar-tagline"),desc:o(".meta-desc"),groups:s.filter(m=>m.items.length),mindmapSlug:n.querySelector(".cm-mindmap-png")?c:"",comite:Mp(n,Fp(r))};return g.groups.length?g:null}function Mp(e,a){const r=n=>{if(!n)return"";const o=e.createElement("div");return o.innerHTML=n,La(o)};return{...a,syn:r(a.syn),pnl:r(a.pnl),cf:r(a.cf),roi:r(a.roi),reco:r(a.reco),plan:r(a.plan)}}const po={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Dp(e,a){const r=e.getElementById(a),n=r?co(e,r):"";if(n)return n;const o=po[a]?e.querySelector(po[a]):null;return o&&o!==r?co(e,o):""}function co(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),La(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(l=>/^h3$/i.test(l.tagName))[0]===a)for(const l of i){if(l===a)break;/^h2$/i.test(l.tagName)||o.appendChild(l.cloneNode(!0))}let s=a.nextElementSibling;for(;s&&!/^h3$/i.test(s.tagName);)o.appendChild(s.cloneNode(!0)),s=s.nextElementSibling;return o.children.length?La(o):""}return La(a)}const un=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function We({k:e,v:a,href:r,wide:n}){return a==null||a===""?null:t.jsxs("div",{className:"cdl"+(n?" cdw":""),children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ip({k:e,vals:a}){const r=(a||[]).filter(Boolean);return r.length?t.jsxs("div",{className:"cdl cdw",children:[t.jsx("span",{className:"cdk",children:e}),t.jsx("span",{className:"cdtags",children:r.map(n=>t.jsx("span",{className:"cdtag",children:n},n))})]}):null}function uo(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function mo({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const mn=new Map;function Pp(e,a){const{token:r}=X(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=mn.get(i);d||(d=ys(r,e.name,e.checkId),mn.set(i,d),d.then(l=>{(!l||!l.reasoning&&!l.summaryHtml)&&mn.delete(i)}));let s=!0;return d.then(l=>{s&&l&&o({id:e.id,d:l})}),()=>{s=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const _p=6e4;function Bp({o:e}){const{t:a,doDeep:r}=X(),[n,o]=p.useState(null),[i,d]=p.useState(e.memoUrl?"load":"off"),[s,l]=p.useState(()=>new Set),[h,c]=p.useState(!1),g=p.useRef(new Map);p.useEffect(()=>{let v=!0;if(l(new Set),c(!1),g.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),vi(e.memoUrl).then(w=>{v&&(o(w),d(w?"ok":"err"))}),()=>{v=!1}},[e.memoUrl]);const f=zt(e),b=v=>{var w;return(w=g.current.get(v))==null?void 0:w.scrollIntoView({behavior:"smooth",block:"start"})},m=t.jsxs("div",{className:"cdacts",children:[Vt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:v=>{v.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const v=[e.reasoning||"",uo(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[v.length?v.join(`

`).split(`

`).map((w,u)=>t.jsx("p",{className:"cdtxt",children:w},u)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),m]})}if(i!=="ok"){const v=[e.reasoning||"",uo(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[f&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:f}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),v.length>0&&v.join(`

`).split(`

`).map((w,u)=>t.jsx("p",{className:"cdtxt",children:w},u)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:w=>{w.stopPropagation(),c(u=>!u)},children:h?a.memoHideHere:a.memoReadHere})}),h&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:w=>w.stopPropagation()}),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[f&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:f}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(v=>t.jsx("span",{className:"md-tag",children:v},v)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(v=>v.items.map(w=>t.jsx("button",{type:"button",className:"md-jump",onClick:u=>{u.stopPropagation(),b(w.id)},children:w.title},w.id)))}),n.groups.map((v,w)=>t.jsxs("div",{className:"md-grp",children:[v.label&&t.jsx("div",{className:"md-grp-h",children:v.label}),v.items.map(u=>{const y=u.poids>_p&&!s.has(u.id),E=u.id==="fiche-contact"||u.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:k=>{k&&g.current.set(u.id,k)},children:[t.jsx("h4",{className:"md-h",children:u.title}),E&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:k=>k.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:"LinkedIn"})]}),y?t.jsx("button",{type:"button",className:"abtn md-more",onClick:k=>{k.stopPropagation(),l(j=>new Set(j).add(u.id))},children:a.memoUnfold(Math.round(u.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:E?u.html.replace(/>\s*unavailable(\s+unavailable)*\s*</gi,"><"):u.html}}),!y&&n.mindmapSlug&&u.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${ha}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:k=>k.stopPropagation()})]})]},u.id)})]},v.label||w)),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:a.memoOpenFull})]})}function $p({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:s}=X(),[l,h]=p.useState(!1),[c,g]=p.useState(!1),[f,b]=p.useState(!1),[m,v]=p.useState(null),[w,u]=p.useState(""),[y,E]=p.useState(null),[k,j]=p.useState(""),N={airtableId:e.airtableId,checkId:e.checkId},q=!!(e.airtableId||e.checkId),S=m&&m.id===e.id?m.entries:[],L=!!m&&m.id===e.id;if(p.useEffect(()=>{u(""),E(null),b(!1)},[e.id]),p.useEffect(()=>{if(!l||L||!q||!o)return;let M=!0;g(!0),b(!1);const $=e.id;return dr(r,"list",N).then(U=>{if(!(!M||$!==e.id)){if(g(!1),!U.ok){b(!0);return}v({id:$,entries:U.entries})}}),()=>{M=!1}},[l,L,q,r,e.id,o]),!n.pipe||!o||!q)return null;const z=(M,$)=>{g(!0);const U=e.id;dr(r,M,N,$).then(F=>{if(U===e.id){if(g(!1),!F.ok){d(a.notesErr);return}v({id:U,entries:F.entries}),b(!1),M==="add"&&(u(""),i(a.notesAdded)),M==="edit"&&E(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":l,onClick:M=>{M.stopPropagation(),h($=>!$)},children:[t.jsx("b",{children:a.notesT}),S.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(S.length)}),t.jsx("i",{children:l?"▾":"▸"})]}),l&&t.jsxs("div",{className:"dn-b",onClick:M=>M.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),c&&!S.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),f&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!c&&!f&&L&&!S.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),S.map(M=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:s==="fr"?M.date.split("-").reverse().join("/"):M.date}),y===M.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:k,rows:3,onChange:$=>j($.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||!k.trim(),onClick:()=>z("edit",{entryId:M.id,text:k.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>E(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:M.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{E(M.id),j(M.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:c,onClick:()=>{window.confirm(a.notesDelAsk)&&z("delete",{entryId:M.id})},children:a.notesDel})]})]})]},M.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:w,onChange:M=>u(M.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:c||!w.trim(),onClick:()=>z("add",{text:w.trim()}),children:a.notesAdd})]})]})]})}function Wn({o:e}){var j;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:d}=X(),s=ga(e),l=zt(e),h=(e.cribleStatus||"").trim().toUpperCase()||(s==="NO MATCH"?"NO MATCH":s==="MATCH"?"MATCH":""),c=[e.sector,e.market,(e.tags||[]).filter(Boolean).length?"1":"",e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.provQuery,On(e.provUrl||""),Ra(e),e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,f=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(h?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Vt(e)?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:f}].filter(N=>N.n>0),[e,a,o,h,l,c,g,f]),[m,v]=p.useState(""),w=b.some(N=>N.k===m)?m:((j=b[0])==null?void 0:j.k)||"";p.useEffect(()=>{const N=q=>{var L;const S=String(((L=q.detail)==null?void 0:L.tab)||"");S&&b.some(z=>z.k===S)&&v(S)};return window.addEventListener("ppmap:card-tab",N),()=>window.removeEventListener("ppmap:card-tab",N)},[b]);const u=Pp(e,w==="eval"||w==="conv");if(!b.length)return null;const y=((u==null?void 0:u.reasoning)||"").length>(e.reasoning||"").length?u.reasoning:e.reasoning||"",E=((u==null?void 0:u.summaryHtml)||"").length>(e.summary||"").length?u.summaryHtml:e.summary||"",k=(u==null?void 0:u.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(N=>t.jsx("button",{type:"button",role:"tab","aria-selected":w===N.k,"data-tour":"tab-"+N.k,className:w===N.k?"on":"",onClick:q=>{q.stopPropagation(),v(N.k)},children:N.lib},N.k))}),t.jsxs("div",{className:"cdbody",onClick:N=>N.stopPropagation(),children:[w==="eval"&&t.jsxs(t.Fragment,{children:[h&&t.jsxs("div",{className:"cdv1"+(h==="NO MATCH"?" out":""),children:[t.jsx("b",{children:h==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(mo,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),y&&y.split(`

`).map((N,q)=>t.jsx("p",{className:"cdtxt",children:N},q)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Up,{o:e})]}),w==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof k=="number"&&t.jsx(mo,{v:k,sur:100,k:a.cdConvScore}),un(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",un(e.verdictDate,r)]})]}),E&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:Ep(E)}})]}),w==="memo"&&t.jsx(Bp,{o:e}),w==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(We,{k:a.cdSector,v:e.sector}),t.jsx(We,{k:a.cdMarket,v:e.market,wide:!0}),t.jsx(Ip,{k:a.cdTags,vals:e.tags}),t.jsx(We,{k:a.cdStage,v:e.stage}),t.jsx(We,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(We,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(We,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(We,{k:a.cdAngle,v:e.angle}),t.jsx(We,{k:a.cdDetected,v:un(e.date,r)}),t.jsx(We,{k:a.cdQuery,v:e.provQuery,wide:!0}),t.jsx(We,{k:a.cdSrc,v:On(e.provUrl||""),href:ma(e.provUrl||"")}),t.jsx(We,{k:a.cdAngleSrc,v:Ra(e)})]}),w==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(We,{k:a.cdName,v:e.contactName}),t.jsx(We,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(We,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(We,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),w==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(We,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx($p,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(e),children:a.actRegen})]})]})]})]})}const Ca=new Map;function Up({o:e}){const{t:a,token:r}=X(),[n,o]=p.useState(!1),[i,d]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const g=`${r}:${e.name.toLowerCase()}`;let f=Ca.get(g);f||(f=Co(r,[e.name]).then(m=>m[e.name]||Object.values(m)[0]||null).catch(()=>null),Ca.set(g,f),f.then(m=>{(!m||!m.ok)&&Ca.delete(g)}));let b=!0;return f.then(m=>{b&&m&&m.ok&&d(m)}),()=>{b=!1}},[r,e.id,e.name]);const s=async()=>{if(n)return;o(!0);const g=await Eo(r,e.name,e.website||e.domain||"");d(g),g.ok&&Ca.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(g)),o(!1)},l=(i==null?void 0:i.blocs)||{},h=[[a.qaVP,l.value_prop],[a.qaProduct,l.produit],[a.qaModel,l.modele],[a.qaSummary,l.synthese]],c=h.some(([,g])=>g);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&c&&t.jsxs(t.Fragment,{children:[h.filter(([,g])=>g).map(([g,f])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:g}),t.jsx("p",{children:f})]},g)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!c&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function Jt({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const s=()=>{const h=Math.max(280,Math.min(560,i.clientWidth||320));pr({kind:"op",card:e},h).then(c=>{!d&&c&&i.isConnected&&i.replaceChildren(c)})},l=window.requestAnimationFrame(s);return()=>{d=!0,window.cancelAnimationFrame(l),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;pr({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(l=>{!d&&l&&i.isConnected&&i.replaceChildren(l)});const s=l=>{l.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{d=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Hp=`
...
`;function Vp(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:d,top:s}}function Wp(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:s,doAnalyse:l,doDecide:h,doPromote:c,doRepeche:g,doApproach:f,doDeep:b,doOnboard:m,outbound:v,evalBusy:w}=X(),u=e.popupId?r.get(e.popupId):null;if(!u)return null;const y=_e(u),E=Te(u),k=zt(u),j=ga(u),N=u.kind==="target",q=S=>{a({type:"filters",patch:S}),a({type:"popup",id:null})};return Qt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Hp}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Vp(e.popupAnchor,!!u.card),onClick:S=>S.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:u.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ut(u.date)),tt(u.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[u.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>q({country:[u.cc]}),children:(Kt(u.cc,o)||u.countryLabel||"").toUpperCase()}),u.sector&&t.jsx("button",{type:"button",onClick:()=>q({sector:[u.sector]}),children:u.sector.toUpperCase()}),u.stage&&t.jsx("button",{type:"button",onClick:()=>q({stage:[u.stage]}),children:u.stage.toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{className:"am2",children:Pt(u.amountEur,o)})]}),i.pipe&&N&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),u.ceoStatus&&t.jsx("span",{className:"pstep own",children:u.ceoStatus})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ot(u.engine)," ",t.jsx("b",{children:tt(u.engine,o)})," — ",ks(u.engine,o),u.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",u.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ct,{o:u,lg:!0})," ",t.jsx(Qa,{o:u,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(zo(y,o))," · ",n.win7(Ao(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),u.card?t.jsx(Jt,{spec:u.card}):null,u.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),i.pipe&&N&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof u.score=="number"&&u.score>0?" · "+n.score(u.score):""]})}),i.pipe&&N&&t.jsx(Wn,{o:u})]}),t.jsx(Vn,{name:u.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>s(u),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(u.name.length>22?u.name.slice(0,21)+"…":u.name)]}),E===1&&t.jsxs(Ya,{lang:o,storeKey:u.name,className:"evalbtn memo",style:{flex:1,justifyContent:"center"},confirmLabel:n.actAnalyse,onConfirm:()=>{l(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(u,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(u,!1),a({type:"popup",id:null})},children:n.actNo}),Vt(u)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(u),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),u.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:u.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(u),a({type:"popup",id:null})},children:"🚀"})]}):u.engine==="media"&&u.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var S;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"popup",id:null}),(S=document.querySelector(".atl2 .demand"))==null||S.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:w,title:n.evalGoOn(u.name),onClick:()=>s(u),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>s(u),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(u.name.length>22?u.name.slice(0,21)+"…":u.name)," →"]}),u.website&&t.jsx("a",{className:"psite",href:u.website.startsWith("http")?u.website:"https://"+u.website,target:"_blank",rel:"noopener noreferrer",title:u.website,children:"🌐"})]})]})]}),document.body)}function Gp(){const{lang:e,token:a,dossiers:r,caps:n}=X(),o=a||"home",{names:i,verdicts:d}=p.useMemo(()=>{const l=[],h={};return r.forEach(c=>{c.kind!=="target"||!c.name||(l.push(c.name),h[c.name]=Es(c)||"")}),{names:l,verdicts:h}},[r]);return{diff:p.useMemo(()=>i.length?js(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function Yp(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:s}=X(),[l,h]=p.useState(!1),[c,g]=p.useState(!1),f=p.useRef(null);p.useEffect(()=>{if(!l)return;const E=k=>{f.current&&!f.current.contains(k.target)&&h(!1)};return document.addEventListener("click",E,!0),()=>document.removeEventListener("click",E,!0)},[l]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...s.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!d.length,v=p.useRef({});p.useEffect(()=>{v.current={...r}},[r]);const w=E=>{const k=v.current[E],j=k!==void 0?r[E]-k:0;return t.jsxs("button",{type:"button",className:"step"+(E===3&&r[3]>0?" wait":""),style:{"--c":`var(${la[E]})`,"--tc":E<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsxs("span",{className:"l",children:[n.plabels[E],E===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(j>0?" up":j<0?" down":""),children:[r[E],j!==0&&t.jsxs("em",{className:"delta",children:[j>0?"+":"−",Math.abs(j)]})]})]},E)},u=(E,k,j)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),"data-off":E,style:{"--c":`var(${la[E]})`},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsx("span",{className:"l",children:j}),t.jsx("span",{className:"n",children:r[E]})]},E),y=(E,k,j,N=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:N,onClick:j,children:E},k);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(w)}),t.jsxs("div",{className:"offtrack",children:[u(5,!1,n.plabels[5]),u(7,!0,n.plabels[7]),u(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[y("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(c?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"}),a({type:"ptab",tab:1}),a({type:"continent",key:s.pipe?"europe":"monde"}),a({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}g(!0),window.setTimeout(()=>g(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:f,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":l,title:n.toolSort,onClick:()=>h(E=>!E),children:"⇅"}),l&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([E,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===E,className:"sortopt"+(e.sort.key===E?" on":""),onClick:()=>a({type:"sort",key:E}),children:[k,t.jsx("i",{children:e.sort.key===E?e.sort.dir===1?"↑":"↓":""})]},E))})]}),y("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),y("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Qp(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,mode:s,data:l}=X(),h=p.useRef(null),[c,g]=p.useState(60);p.useEffect(()=>{let q=0;const S=()=>{var U;const L=h.current;if(!L)return;const z=(U=L.parentElement)==null?void 0:U.querySelector('.funnel [aria-selected="true"]');if(!z)return;const M=z.getBoundingClientRect(),$=L.getBoundingClientRect();g(Math.max(20,Math.min(M.left+M.width/2-$.left,$.width-30)))};return q=requestAnimationFrame(S),window.addEventListener("resize",S),()=>{cancelAnimationFrame(q),window.removeEventListener("resize",S)}},[e.ptab]);const f=e.ptab;let b=r.tuto[f].p;if(f===3){const q=i.filter(z=>z.kind==="target"&&Te(z)===3),S=q.filter(z=>xn(z)==="auto").length,L=q.filter(z=>xn(z)==="cd").length;b=r.tutoPending(S,L,q.length)}const m=(()=>{var q;if(s!=="client")return null;if(f===0&&i.length)return{label:r.tuto[0].a,locked:!1,run:()=>a({type:"chainStart",queue:i.map(S=>S.id)})};if(f===1){const S=i.filter(L=>L.kind==="target"&&Te(L)===1&&!d.has(L.id)).slice(0,10);if(S.length){const L=String(((q=l.credits)==null?void 0:q.plan)||"").toLowerCase(),z=L==="enterprise"||L==="entreprise";return{label:r.tuto[1].a,locked:!z,run:()=>{z&&a({type:"chainStart",queue:S.map(M=>M.id)})}}}}return null})(),v=Ns(f),w=f===1||f===2,u=f===5,y=f===7,E=f===6,k=v||u||y,j=r.plabels[f]+" · "+(o[f]??0),N=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:h,className:"tuto mini"+(k?"":" on-dark")+(w?" etape-on":"")+(u?" etape-out":"")+(y?" etape-view":"")+(E?" etape-fav":""),style:{"--bg":`var(${la[f]})`,"--ax":c+"px","--stc":k?"var(--ink)":"#fff","--stt":k?"#fff":"var(--ink)","--tc":k?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:j}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),m&&t.jsx("button",{type:"button",className:"tprim"+(m.locked?" lock":""),disabled:!!m.locked,title:m.locked?r.analyseLockHint:void 0,onClick:m.run,children:m.locked?"🔒 "+r.analyseLock:m.label}),f!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:N})]})}const fn=600,St=62,fo="atl2:fstats";function Kp(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=X(),[d,s]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(fo)==="on"}catch{return!1}}),l=r.stats,h=p.useMemo(()=>((l==null?void 0:l.by_day)||[]).slice(-30),[l]),c=(l==null?void 0:l.since)||"";if(!n.showFunnel||!l||typeof l.screened!="number")return null;const g=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,f=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),b=h.reduce((j,N)=>Math.max(j,N.s||0),0),m=h.length?fn/h.length:0,v=Math.max(4,m-4),w=h.length>=5&&b>0,u=r.marketEstimate||0,y=g(new Date().toISOString().slice(0,10)),E=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof l.kept=="number"?[[l.kept,e.funKept]]:[],...typeof l.analyzed=="number"?[[l.analyzed,e.funAnalyzed]]:[],...typeof l.shown=="number"?[[l.shown,e.funShown]]:[]],k=[];return typeof l.screened_window=="number"&&c&&k.push({cle:"fenetre",periode:e.funPerWindow(g(c),y),etapes:[[l.screened_window,e.funScreened("","")]]}),typeof l.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:E(l.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([N,q],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:f(N)}),t.jsx("i",{children:q})]},j.cle+q)),j.cle==="total"&&u>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(f(u),Math.min(100,Math.round((l.screened||0)/u*100)))})]}),j.cle==="total"&&(l.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),j.cle===k[k.length-1].cle&&w&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const N=!d;s(N),N&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(fo,N?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},j.cle)),d&&w&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${fn} ${St}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((j,N)=>{const q=(j.s||0)/b*(St-4),S=(j.m||0)/b*(St-4),L=N*m+(m-v)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===j.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}),onKeyDown:z=>{z.key!=="Enter"&&z.key!==" "||(z.preventDefault(),i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}))},children:[t.jsx("title",{children:`${g(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:L-1,y:0,width:v+2,height:St,fill:"transparent"}),t.jsx("rect",{x:L,y:St-2-q,width:v,height:q,fill:"#cfe0d6"}),t.jsx("rect",{x:L,y:St-2-S,width:v,height:S,fill:"#0E7F3F"})]},j.d)}),t.jsx("line",{x1:0,y1:St-1.5,x2:fn,y2:St-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:g(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const wi={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Gn({o:e,locked:a=!1}){const{t:r}=X(),n=ga(e),o=zt(e),i=Te(e),d=xn(e),s=Ss(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(wi[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(nd,{o:e})]})}const Yt=e=>e.length>22?e.slice(0,21)+"…":e;function fa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function yi(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .fzone:has(.stage.folded), .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .fzone:has(.stage.folded), .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Jp({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const d=()=>{var m,v,w;const s=document.querySelector(".atl2.ops .desk-list"),l=document.querySelector(".atl2.ops .listhead");if(!s){n(null);return}const h=s.getBoundingClientRect(),c=l?l.getBoundingClientRect().bottom:h.top;i({top:Math.round(c),left:Math.round(h.left),width:Math.round(h.width)});const g=[...s.querySelectorAll(":scope .grp")];let f=null;for(const u of g){const y=u.querySelector(".grp-h");y&&y.getBoundingClientRect().bottom<=c+2&&(f=u)}if(!f){n(null);return}const b=f.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((w=b.querySelector(".s"))==null?void 0:w.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Xp(e){const r=()=>{const n=yi(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function ho({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=X(),[i,d]=p.useState(!1);if(p.useEffect(()=>{n||d(!1)},[n]),Ue(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const l=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(l?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Yt(e.name))})]})}function sa(e,a){e({type:"focus",id:a.id}),window.setTimeout(()=>{var r;window.dispatchEvent(new CustomEvent("ppmap:card-tab",{detail:{tab:"memo"}})),(r=document.querySelector(".atl2 .readpane"))==null||r.scrollIntoView({block:"nearest"})},40)}function Yn({o:e}){const{t:a,lang:r,caps:n,memoQueued:o,approachDone:i,doAnalyse:d,doDecide:s,doPromote:l,doRepeche:h,doApproach:c,dispatch:g,liveMemos:f}=X(),b=v=>w=>{w.stopPropagation(),v()};if(n.lockActions){const v=b(()=>g({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:v,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const w=Te(e);return w===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:v,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Yt(e.name))})]})}):w===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:v,children:a.actAnalyse})}):w===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:v,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:v,children:a.actNo})]})}):w===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:v,children:a.actPromote})}):w===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:v,children:a.actApproach})}):w===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:v,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:v,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:v=>{v.stopPropagation(),fa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Ia(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:v=>{v.stopPropagation(),fa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!n.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(ho,{o:e})});const m=Te(e);if(m===0)return t.jsx("span",{className:"cell",children:t.jsx(ho,{o:e})});if(m===1){const v=f.liveOf(e.name);if(v&&(v.status==="boot"||v.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ma,{item:v,serverOff:f.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const w=o.has(e.id);return t.jsx("span",{className:"cell cell-an",children:t.jsx(Ya,{lang:r,storeKey:e.name,className:"memobtn",disabled:w,confirmLabel:a.actAnalyse,onConfirm:()=>d(e),children:w?a.actAnalyseQueued:a.actAnalyse})})}if(m===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>sa(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(m===4){const v=i.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:v,onClick:b(()=>c(e)),children:v?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:b(()=>g({type:"modal",modal:"plug"})),children:a.actConn}),t.jsx("button",{type:"button",className:"lk sm dsrow",title:a.dsBtn,onClick:b(()=>g({type:"dossierOpen",id:e.id})),children:a.dsBtn})]})}return m===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>sa(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):m===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>h(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>sa(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>sa(g,e)),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Zp({o:e}){const{t:a,doThumb:r,thumbOf:n}=X(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function ec({o:e}){const{lang:a}=X();return _e(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ct,{o:e}),t.jsx(Qa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ot(e.engine||"")," ",tt(e.engine||"",a)]})})}function tc({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:s}){const{dispatch:l,caps:h,markRow:c,markedId:g,favIds:f,toggleFav:b,t:m}=X(),v=Te(e),w=["#16233A","#475C6E","#8798A8","#B9C6D2"],u=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,y=u<=0?0:u<=7?1:u<=30?2:3,E=h.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][v]:w[y],k=f.has(e.id),j=N=>{if(a)return;if(d){d(e.id);return}if(h.pipe||e.kind==="op"){n();return}const q=N.currentTarget.getBoundingClientRect();l({type:"popup",id:e.id,anchor:{x:q.left+Math.min(280,q.width/3),y:q.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(g===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(h.pipe&&e.kind==="target"?" p"+v:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>c(e.id),onMouseLeave:()=>c(null),onClick:j,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx(Ci,{o:e}),t.jsxs("span",{className:"nd",children:[s&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${m.cdEngagement} ${Math.round(e.engagement*10)/10} · ${m.cdEngagementHint}`,children:"🔥"}),_e(e)&&t.jsx(Ct,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[h.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Ke(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(N=>N&&N!==e.name)||""]}),h.pipe&&!h.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:N=>N.stopPropagation(),children:[e.website&&t.jsx("a",{href:ma(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowSite,title:m.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:ma(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowLi,title:m.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":m.rowMail,title:m.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":m.rowTel,title:m.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:N=>{N.stopPropagation(),l({type:"acquirer",value:e.acquirer||""})},children:["← ",Yt(e.acquirer)]}),Be(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(ac,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(ec,{o:e}),h.pipe&&t.jsx(Gn,{o:e,locked:a}),h.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Yn,{o:e}),h.showThumbs&&t.jsx(Zp,{o:e})]}),r&&!a&&!d&&t.jsx(oc,{o:e})]})}function ac({o:e}){const{lang:a,caps:r}=X();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Pt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function nc({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=X(),d=(f,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:f})},s=(()=>{const f=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return f?f[1].slice(0,40):""})(),l=Pt(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=Ue(e),g=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),l&&t.jsx("span",{className:"oc-amt",children:l}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped})]}):Ke(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:f=>{f.stopPropagation(),fa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:f=>{f.stopPropagation(),n(e)},children:a.evalGoOn(Yt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:f=>f.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Jt,{spec:e.card})})]})}function rc({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=X();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=[e.tagline,e.headline,e.reasoning].find(h=>h&&h!==e.name)||"",s=Pt(e.amountEur,r),l=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return h?h[1].replace(/^www\./,"").slice(0,40):""})();return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[tt(e.engine||"",r),i?` · ${i}`:"",s?` · ${s}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Yn,{o:e})})]}),(e.sector||e.countryLabel||e.stage||e.acquirer)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null,e.acquirer?t.jsxs("span",{children:["← ",e.acquirer]}):null]}),(d||e.decryptHtml||e.url||e.card)&&t.jsxs("div",{className:"zoom-news",children:[d?t.jsx("p",{className:"zoom-lead",children:d}):null,e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):null,e.card?t.jsx("div",{className:"zoom-card",children:t.jsx(Jt,{spec:e.card})}):null,e.url?t.jsxs("a",{className:"zoom-src",href:e.url,target:"_blank",rel:"nofollow noopener",children:[a.zoomSrc,l?` · ${l}`:""," ↗"]}):null]}),t.jsx(Wn,{o:e})]})}function ki({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:s,dossiers:l}=X(),h=p.useRef(null),c=Be(e);if(p.useEffect(()=>{if(!c||!(e!=null&&e.decryptHtml))return;const x=h.current;if(!x)return;let T=!1;return hn(()=>import("./fit-DX-mzLKR.js"),[]).then(async D=>{await D.ensureEditoCss(),!(T||!x.isConnected)&&(D.beautifyEditoRows(x),D.mountCardFits(x))}),()=>{T=!0}},[c,e==null?void 0:e.decryptHtml]),!e&&!a){const x=l.find(Be);if(x)return t.jsx(ki,{o:x})}const g=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),f=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||g,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!g||Da(g),w=(e==null?void 0:e.engine)||"",u=Be(e),y=e?Pt(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const x=/https?:\/\/(?:www\.)?([^/]+)/.exec(f);return x?x[1].replace(/^www\./,"").slice(0,40):""})(),j=l.find(Be),N=((j==null?void 0:j.url)||"").trim(),q=!!f&&!!N&&(f===N||f.endsWith(N)||N.endsWith(f)),S=(x,T=!1)=>D=>{D.stopPropagation(),T&&d({type:"continent",key:"monde"}),d({type:"filters",patch:x})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const L=()=>{g&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:g}}))},z=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},M=()=>{fa({url:f,headline:b,tagline:e==null?void 0:e.tagline,name:g})},$=e?Ue(e):!1,U=$&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",F=u?r.doEdito.replace(/^📖\s*/,""):w?tt(w,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[F,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),f&&!u&&(v||Ia({engine:w}))&&t.jsxs("a",{className:"zoom-ext",href:f,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:x=>x.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:h,className:"ed-decrypt-b zoom-body"+(u?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:S({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:S({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:S({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(Jt,{spec:m})}),(f&&!q&&!u||j&&!u)&&t.jsxs("div",{className:"zoom-srcbox",children:[f&&!q&&!u&&t.jsxs("a",{className:"zoom-src",href:f,target:"_blank",rel:"nofollow noopener",onClick:x=>x.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!u&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:x=>{x.stopPropagation(),d({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[$?t.jsxs("span",{className:"verdict",style:{"--c":U?"var(--brand)":"var(--red)"},children:[U?"✓":"✗"," ",t.jsx("b",{children:U?r.kept:r.dropped})]}):!v&&g?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:x=>{x.stopPropagation(),o(e,g)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Yt(g))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,f&&!u&&(v||Ia({engine:w}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&g?" ghost":""),onClick:x=>{x.stopPropagation(),M()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&g&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!s.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),z()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),L()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Yt(g)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&g&&s.pipe&&t.jsx(Vn,{name:g})]})]})}function oc({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=X();return!o.pipe&&e.kind==="op"?t.jsx(nc,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Wn,{o:e}),t.jsx(rd,{o:e}),t.jsx(id,{o:e}),t.jsx(Vn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Gn,{o:e})})]}),e.card&&t.jsx(Jt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ot(e.engine||"")," ",tt(e.engine||"",r)]}),_e(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ct,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function ic({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:s,lang:l}=X();if(!d.pipe&&e.kind==="op"){const g=Pt(e.amountEur,l),f=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>w=>{w.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Jt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),g&&t.jsx("span",{className:"damt",children:g})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Ot(e.engine||"")," ",tt(e.engine||"",l)]}),_e(e)&&t.jsx(Ct,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(f?` · ${f}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Yn,{o:e})})]})}const h=Te(e),c=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][h];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":c},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Gn,{o:e}),_e(e)&&t.jsx(Ct,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&h===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>s(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>s(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>sa(i,e),children:[o.actMemoOf(e.memoType)," →"]})]})}function sc(){const{t:e}=X(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function lc({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=X(),i=o==="en",d=c=>n.plabels[c]||"",s=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),l=s.includes(0)?0:s.sort((c,g)=>(e[g]||0)-(e[c]||0))[0];if(l===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[l]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:l===0?i?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:i?`${h} ${h>1?"files":"file"} in “${d(l)}”`:`${h} dossier${h>1?"s":""} dans « ${d(l)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:l}),children:[(i?"Open ":"Ouvrir ")+d(l)," →"]})]})}function dc(){var Ge,mt,Et,qt;const e=X(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:s,markRow:l,lang:h,sessTally:c,data:g,dossiers:f,source:b,focusExtra:m,byId:v,token:w}=e,u=Bo(),y=p.useMemo(()=>{var _,V,ae,re;if(!w||b==="ops")return null;const O=(((_=u==null?void 0:u.ed)==null?void 0:_.date)||(u==null?void 0:u.day)||"").slice(0,10),R=[(V=u==null?void 0:u.ed)==null?void 0:V.html,(ae=u==null?void 0:u.ed)==null?void 0:ae.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:h==="en"?"Today's brief":"Brief du jour",headline:h==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((re=u==null?void 0:u.ed)==null?void 0:re.date)||O,decryptHtml:R||void 0,date:O,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[w,b,h,(Ge=u==null?void 0:u.ed)==null?void 0:Ge.html,(mt=u==null?void 0:u.ed)==null?void 0:mt.acquirers_html,(Et=u==null?void 0:u.ed)==null?void 0:Et.date,u==null?void 0:u.day]),E=O=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:_o,[k,j]=p.useState(new Set);p.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[N,q]=p.useState(null);p.useEffect(()=>{q(null)},[a.ptab,a.continent]);const[S,L]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){L(!1);return}const O=document.getElementById("atl2-stage");if(!O){L(!1);return}const R=new IntersectionObserver(([_])=>L(!!_&&_.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return R.observe(O),()=>R.disconnect()},[a.mapFolded]);const z=!a.mapFolded&&!S,M=O=>j(R=>{const _=new Set(R);return _.has(O)?_.delete(O):_.add(O),_}),$=b==="ops"||o.pipe,[U,F]=p.useState("all"),[x,T]=p.useState(!1),[D,Y]=p.useState(null),[ee,C]=p.useState(!1),B=p.useRef(!0);p.useEffect(()=>{if(B.current){B.current=!1;return}F("all"),C(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!ee)return;const O=R=>{var _,V;(V=(_=R.target)==null?void 0:_.closest)!=null&&V.call(_,".atl2 .doable")||C(!1)};return document.addEventListener("click",O,!0),()=>document.removeEventListener("click",O,!0)},[ee]);const I=p.useMemo(()=>{var R;const O=new Map;for(const _ of Hl(((R=u==null?void 0:u.ed)==null?void 0:R.html)||""))O.has(_.t)||O.set(_.t,_.html);return O},[(qt=u==null?void 0:u.ed)==null?void 0:qt.html]),K=p.useCallback(O=>{if(O.decryptHtml)return O.decryptHtml;if(!I.size)return;const R=(O.name||"").trim().toLowerCase();if(R.length<3)return;const _=I.get(R);if(_)return _;for(const[V,ae]of I)if(V.includes(R)||R.includes(V))return ae},[I]),{diff:H}=Gp(),[ce,te]=p.useState(!1),le=a.filters.win==="1"&&!a.filters.day,[xe,he]=p.useState(!1),[we,pe]=p.useState(!1),Ne=p.useMemo(()=>{const O={...a,filters:{...a.filters,win:"all",day:""}};return f.filter(R=>!Be(R)&&ut(R.date)===0&&Rt(R,O,o.pipe)).length},[f,a,o.pipe]),ze=p.useMemo(()=>new Set(((H==null?void 0:H.added)||[]).map(O=>O.trim().toLowerCase()).filter(Boolean)),[H]),ue=p.useMemo(()=>{if(!ze.size)return 0;const O={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return f.filter(R=>!Be(R)&&ze.has((R.name||"").trim().toLowerCase())&&Rt(R,O,o.pipe)).length},[f,ze,a,o.pipe]);p.useEffect(()=>{const O=()=>{pe(!1),T(!1),he(!1),F("all"),C(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",O),()=>window.removeEventListener("ppmap:tunnel",O)},[]),p.useEffect(()=>{pe(!1),T(!1),he(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const be=p.useMemo(()=>{const O=s.filter(_=>!Be(_)&&Ke(_));let R="";for(const _ of O){const V=(_.date||"").slice(0,10);V&&(!R||V<R)&&(R=V)}return{n:O.length,since:R?R.split("-").reverse().slice(0,2).join("/"):""}},[s]),ye=be.n,Z=p.useMemo(()=>{const R=we&&ze.size>0||a.filters.signalOnly||U!=="all"||x||xe?s:d;let _=Bn(R,a.sort);return _=_.filter(V=>!Be(V)),xe&&(_=_.filter(V=>ut(V.date)===0)),we&&ze.size&&(_=_.filter(V=>ze.has((V.name||"").trim().toLowerCase()))),x||U==="explore"?_=_.filter(Ke):U==="eval"?_=_.filter(V=>!Ke(V)&&!V.noCo&&(V.kind==="op"||!Ue(V))):o.pipe&&(_=_.filter(V=>!Ke(V))),_},[d,s,a.sort,U,we,ze,x,xe,o.pipe]),Q=p.useMemo(()=>o.pipe?f.filter(O=>O.kind==="target"&&!Be(O)&&_e(O)&&(a.continent==="monde"||O.continent===a.continent)):Z.filter(O=>_e(O)&&!Ue(O)),[o.pipe,f,Z,a.continent]).length,ie=p.useMemo(()=>o.pipe?Z:Z.filter(O=>!Ue(O)&&!O.noCo&&!Ke(O)),[Z,o.pipe]),oe=b==="ops"?Z.filter(Ke).length:0,me=xe?n.morningList:we?n.sinceList:o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,W=a.filters,se=W.sector.length+W.market.length+W.country.length+W.engine.length+W.stage.length+W.crible.length+W.angle.length+W.memoLevel.length+W.dealKind.length+(W.signalOnly?1:0)+(W.acquirer.trim()?1:0)+(W.search.trim()?1:0),ve=[];if(W.day)ve.push({k:"day",lib:n.fDay(W.day.slice(8,10)+"/"+W.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(W.win&&W.win!=="all"){const O=["1","7","30"].indexOf(W.win);O>=0&&ve.push({k:"win",lib:n.dates[O],off:()=>r({type:"filters",patch:{win:"all"}})})}const ke=O=>O.length<=2?O.join(", "):`${O.length} ${n.fSelected}`;for(const O of["sector","market","country","engine","crible"]){const R=W[O];R&&R.length&&ve.push({k:O,lib:ke(R),off:()=>r({type:"clearFacet",facet:O})})}W.search&&ve.push({k:"search",lib:"🔍 "+W.search,off:()=>r({type:"filters",patch:{search:""}})}),we&&ze.size&&ve.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>pe(!1)}),W.signalOnly&&ve.push({k:"sig",lib:"🔴 "+n.sigDock(Q||W.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const Ee=(O,R,_="",V=!1)=>t.jsxs("button",{type:"button","data-s":O,className:_,"aria-sort":a.sort.key===O?a.sort.dir===1?"ascending":"descending":"none",style:V?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:O}),children:[R,t.jsx("span",{className:"ar",children:a.sort.key===O&&a.sort.dir===1?"▴":"▾"})]},O),ge=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const O=new Map;Z.forEach(V=>{const ae=V.engine||"?";O.has(ae)||O.set(ae,[]),O.get(ae).push(V)});const R={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},_=gn([...O.keys()],h);return[...O.entries()].sort((V,ae)=>{const re=R[V[0]]??10+_.indexOf(V[0]),je=R[ae[0]]??10+_.indexOf(ae[0]);return re-je})},[Z,o.pipe,a.groupBy,h]),Ie=ge?ge.filter(([O])=>Aa.has(O)).length:0,Je=(()=>{var R;return((R=(ge?ge.flatMap(([,_])=>_):Z)[0])==null?void 0:R.id)??null})(),at=p.useRef(!1),Ce=p.useMemo(()=>f.find(Be)||y,[f,y]),[dt,nt]=p.useState(!1);p.useEffect(()=>{const O=()=>{at.current=!0,pe(!1)};return window.addEventListener("ppmap:reveal",O),window.addEventListener("ppmap:focus",O),()=>{window.removeEventListener("ppmap:reveal",O),window.removeEventListener("ppmap:focus",O)}},[]),p.useEffect(()=>{const O=()=>{Ce&&r({type:"focus",id:Ce.id})};return window.addEventListener("ppmap:edito",O),()=>window.removeEventListener("ppmap:edito",O)},[Ce,r]),p.useEffect(()=>{if(!a.focusId)return;Y(a.focusId);const O=window.setTimeout(()=>Y(null),900);return()=>window.clearTimeout(O)},[a.focusId]),p.useEffect(()=>{if($&&!(a.focusId&&(Z.some(O=>O.id===a.focusId)||f.some(O=>O.id===a.focusId)||a.focusId===(Ce==null?void 0:Ce.id)))&&!m){if(Ce){r({type:"focus",id:Ce.id});return}Je&&r({type:"focus",id:Je})}},[$,a.focusId,Z,Je,m,r,f,b,Ce]),p.useEffect(()=>{if(!$||!a.focusId||Ce&&a.focusId===Ce.id||Z.some(R=>R.id===a.focusId))return;const O=f.find(R=>R.id===a.focusId);if(O){if(at.current){O.kind==="op"?F(Ke(O)?"explore":"eval"):U!=="all"&&F("all");return}U!=="all"&&Je&&r({type:"focus",id:Je})}},[$,a.focusId,U,Z,f,Je,r,Ce]),p.useEffect(()=>{if(!$||!a.focusId||!at.current)return;const O=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!O){const ae=Z.findIndex(re=>re.id===a.focusId);if(ae>=0){const re=ge?"":"pt"+a.ptab;if(re){const je=a.shown[re]||E();ae>=je&&r({type:"more",group:re,by:ae-je+8})}}return}at.current=!1;const R=yi(),_=O.getBoundingClientRect();_.top>=R-2&&_.bottom<=window.innerHeight-4||Xp(O)},[$,a.focusId,a.ptab,Z,a.shown,ge,r]),p.useEffect(()=>{if(typeof window>"u")return;const O=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),R=document.querySelector(".atl2.ops, .atl2.cibles");if(!O||!R)return;const _=document.querySelector(".atl2 .fzone"),V=()=>{R.style.setProperty("--listhead-h",`${O.offsetHeight}px`);const re=!!(_&&_.querySelector(".stage.folded"));R.style.setProperty("--fold-h",re&&_?`${_.offsetHeight}px`:"0px")};V();const ae=new ResizeObserver(V);return ae.observe(O),_&&ae.observe(_),()=>ae.disconnect()},[z,a.dens,a.mapFolded]);const Xe=p.useMemo(()=>{if(!$||!a.focusId)return null;if(y&&a.focusId===y.id)return y;const O=Z.find(_=>_.id===a.focusId)||f.find(_=>_.id===a.focusId)||null;if(!O)return null;const R=K(O);return R&&R!==O.decryptHtml?{...O,decryptHtml:R}:O},[$,a.focusId,Z,f,K,y]),rt=o.lockRowsAfter;let At=0;const bt=(O,R)=>{let _=a.shown[R]||E();return O.length-_<=4&&(_=O.length),O.slice(0,_).map(re=>{const je=rt!==null&&At>=rt;At++;const Ae=K(re),de=Ae&&Ae!==re.decryptHtml?{...re,decryptHtml:Ae}:re,He=!$&&a.dens!=="maxi"&&(a.dens==="deplie"||(N?N==="open":!!Ae)),jt=k.has(re.id)?!He:He,Tt=$?xa=>{at.current=!0,r({type:"focus",id:xa});const ft=v.get(xa);ft&&(Ke(ft)?fa(ft):ft.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ft.name,url:ft.url||"",website:ft.website||"",domain:ft.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(ic,{o:de,locked:je,selected:$&&a.focusId===re.id,onSelect:Tt},re.id):t.jsx(tc,{o:de,locked:je,open:jt,onToggle:()=>M(re.id),selected:$&&a.focusId===re.id,echo:D===re.id,fresh:ze.has((re.name||"").trim().toLowerCase()),onSelect:Tt},re.id)})},Bt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(Z.length?"":" list-empty"),$t=t.jsxs(t.Fragment,{children:[ge?ge.map(([O,R])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ot(O)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:O==="ma"?n.grpMa:O==="fundraising"?n.grpLev:Aa.has(O)&&Ie<=1?n.grpNews:O==="nominations"?n.grpNom:O==="media"?n.grpNewsOther:O==="recrutements"?n.grpHire:Aa.has(O)?n.grpNews+" · "+tt(O,h):tt(O,h)}),t.jsx("div",{className:"s",children:n.grpCount(R.filter(_=>!Ue(_)).length,R.length)})]})]}),bt(R,O)]},O)):bt(Z,"pt"+a.ptab),g.loading&&!f.length&&t.jsx(sc,{}),o.pipe&&a.ptab===0&&!x&&!we&&!xe&&U==="all"&&!a.filters.signalOnly&&!g.loading&&t.jsx(pp,{}),!Z.length&&!(g.loading&&!f.length)&&(o.pipe&&U==="all"?t.jsx(lc,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(W.win!=="all"||!!W.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),se>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(se)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),Pe=t.jsxs(t.Fragment,{children:[!x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+la[a.ptab]+")"},children:Z.length})," ",me]}),x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+la[a.ptab]+")"},children:Z.length})," ",n.newsWord]}),t.jsx("span",{className:"dot",children:"·"}),z&&t.jsx(mi,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[z?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ve.map(O=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:R=>{R.stopPropagation(),O.off()},children:[O.lib,t.jsx("i",{children:"×"})]},O.k)),b==="ops"&&Z.length>0&&!z&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",Z.length-oe," ",n.zoomPulseEval,oe>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",oe," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),Ze=t.jsxs("div",{className:"listhead"+(z?" mapoff":""),children:[z&&t.jsx("div",{className:"lh-tools",children:t.jsx(ui,{compact:!0})}),o.showFunnel&&ce&&le&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(ld,{}),t.jsx(Kp,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:Pe}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Yp,{}),t.jsx(Qp,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(xe?" on":""),"aria-pressed":xe,title:n.morningDockTitle,onClick:()=>{if(xe){he(!1),te(!1);return}pe(!1),T(!1),F("all"),he(!0),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}}),te(!1)},children:["📊 ",n.morningDock(Ne)]}),H&&!H.firstVisit&&(H.added.length>0||H.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(we?" on":""),"aria-pressed":we,title:n.sinceSub,onClick:()=>{const O=!we;pe(O),T(!1),he(!1),te(!1),F("all"),O&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(ue),H!=null&&H.lastDate?` · ${n.sinceSince(H.lastDate)}`:""]}),Q>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{pe(!1),T(!1),he(!1),te(!1),F("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(Q)]}),o.pipe&&ye>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(x?" on":""),"aria-pressed":x,title:n.newsDockHint,onClick:()=>{const O=!x;T(O),pe(!1),he(!1),te(!1),F("all"),O&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ye),be.since?` · ${n.newsSince(be.since)}`:""]})]}),!o.showFunnel&&Pe,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([O,R])=>t.jsxs("button",{type:"button","data-d":O,"aria-pressed":a.dens===O||O==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:O}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:R})]},O))}),!$&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":N==="open",onClick:()=>{q("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":N==="closed",onClick:()=>{q("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var Ae;const O={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},R=f.filter(de=>Rt(de,O,o.pipe)&&!Be(de)),_=R.filter(de=>!Ke(de)&&!de.noCo&&(de.kind==="op"||!Ue(de))).length,V=R.filter(Ke).length,ae=o.pipe?R.filter(de=>de.kind!=="op"&&Te(de)===1).length:0,re=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ae?` ${ae}`:""}`]]:[],["eval",`${n.doEval}${_?` ${_}`:""}`],["explore",`${n.doExplore}${V?` ${V}`:""}`]],je=((Ae=re.find(([de])=>de===U))==null?void 0:Ae[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":ee,onClick:()=>C(de=>!de),children:[je,t.jsx("i",{children:"▾"})]}),ee&&t.jsx("div",{className:"dolist",children:re.map(([de,He])=>t.jsx("button",{type:"button","aria-pressed":U===de,onClick:()=>{if(C(!1),de==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}F(de),de!=="all"&&(pe(!1),T(!1),te(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:He},de))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:O=>r({type:"sort",key:O.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([O,R])=>t.jsx("option",{value:O,children:R},O))})]}),o.showChain&&t.jsxs("span",{className:"chainwrap"+(ie.length===0?" empty":""),children:[t.jsxs("button",{type:"button",className:"chain",disabled:ie.length===0,title:n.chainHint,onClick:()=>{ie.length&&r({type:"chainStart",queue:ie.map(O=>O.id)})},children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ie.length):n.chainAll(ie.length)]}),!o.pipe&&t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!$&&Ze,a.dens!=="maxi"&&!$&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Ee("country",n.colCountry),Ee("name",n.colCompany),Ee("amount",n.colAmount,"h-amt",!0),Ee("stage",n.colStage,"h-stade"),Ee("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Ee("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Ee("memo",n.colMemo)]}),o.pipe&&Ee("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),$?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[Ze,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Ee("country",n.colCountry),Ee("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Ee("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Ee("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:Bt,children:$t})]}),t.jsxs("aside",{className:"readpane"+((Xe?Be(Xe):!m&&Ce)?" is-edito":""),"aria-label":h==="fr"?"Dossier":"File",children:[Ce&&(()=>{const O=a.focusId===Ce.id&&!dt,R=(Ce.headline||Ce.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":O,onClick:()=>{if(O){nt(!0);return}nt(!1),r({type:"focus",id:Ce.id})},children:[t.jsx("span",{className:"eg-t",children:h==="en"?"Today’s editorial":"Édito du jour"}),R&&t.jsx("span",{className:"eg-sub",children:R}),t.jsx("span",{className:"eg-chev",children:O?h==="en"?"Collapse ▴":"Replier ▴":h==="en"?"Read ▾":"Lire ▾"})]})})(),!!(Ce&&(Xe?Be(Xe):!m))&&dt?null:y&&a.focusId===y.id?t.jsx("div",{className:"zoom",children:t.jsx(Ql,{})}):Xe&&o.pipe?t.jsx(rc,{o:Xe}):t.jsx(ki,{o:Xe,extra:Xe?null:m})]})]}):t.jsx("div",{className:Bt,children:$t}),(()=>{const O=ge||[["pt"+a.ptab,Z]];let R=0,_=0;for(const[ae,re]of O){_+=re.length;let je=a.shown[ae]||E();re.length-je<=4&&(je=re.length),R+=Math.min(re.length,je)}const V=_-R;return V<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>O.forEach(([ae,re])=>r({type:"more",group:ae,by:re.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(V,V)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(R,_)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}}),$&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Jp,{on:!!ge,rev:(ge||[]).map(([O,R])=>O+R.length).join("|")})]})}function go(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function pc(e,a){const r=Cs(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function cc(e,a){const n=[a.head.split("|").map(go).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",pc(o,a.plabels),ga(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(go).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function uc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const mc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ye({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function ea({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function fc({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=X(),d=(e.cribleStatus||"").trim().toUpperCase()||(ga(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=zt(e),l=(a==null?void 0:a.blocs)||{},h=[[n.qaVP,l.value_prop],[n.qaProduct,l.produit],[n.qaModel,l.modele],[n.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Ye,{k:n.cdSector,v:e.sector}),t.jsx(Ye,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(Ye,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(Ye,{k:n.cdStage,v:e.stage}),t.jsx(Ye,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ye,{k:n.cdSite,v:e.domain||e.website}),t.jsx(Ye,{k:n.cdName,v:e.contactName}),t.jsx(Ye,{k:n.cdEmail,v:e.contactEmail}),t.jsx(Ye,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Ye,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Ye,{k:n.cdAngle,v:e.angle}),t.jsx(Ye,{k:n.cdDetected,v:mc(e.date,o)})]}),!!(e.provQuery||e.provUrl||Ra(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(Ye,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(Ye,{k:n.cdSrc,v:On(e.provUrl||""),href:ma(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(Ye,{k:n.cdAngleSrc,v:Ra(e)})]})]}),h.some(([,c])=>c)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),h.filter(([,c])=>c).map(([c,g])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:c}),t.jsx("p",{children:g})]},c))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([c,g,f])=>t.jsxs("div",{className:"dssq "+c,children:[t.jsx("b",{children:g}),t.jsx("ul",{children:f.map(b=>t.jsx("li",{children:b},b))})]},c))})]}),t.jsx(ea,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(ea,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(ea,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(ea,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(ea,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function hc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d,st:s}=X(),[l,h]=p.useState({}),[c,g]=p.useState({}),f=25,b=12,m=p.useMemo(()=>{if(s.dossierId){const u=n.find(y=>y.id===s.dossierId)||i.dossiers.find(y=>y.id===s.dossierId);return u?[u]:n.slice(0,f)}return n.slice(0,f)},[n,s.dossierId,i.dossiers]);p.useEffect(()=>{m.length&&Co(r,m.map(u=>u.name)).then(h)},[r,m]),p.useEffect(()=>{const u=m.filter(k=>!!k.memoUrl).slice(0,b);if(!u.length){g({});return}let y=!1;const E={};return(async()=>{for(const k of u){if(y)return;try{const j=await vi(k.memoUrl||"");if(y)return;j&&Rp(j.comite)&&(E[k.id]=j.comite,g({...E}))}catch{}}})(),()=>{y=!0}},[m]);const v=i.stats,w=u=>u.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(m.length)}),!s.dossierId&&n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),v&&typeof v.screened=="number"&&t.jsxs("p",{children:[w(v.screened)," ",e.funScreened(""),typeof v.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",w(v.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(w(i.marketEstimate)),", ",Math.round(v.screened/i.marketEstimate*100)," %"]})]})]}),m.map(u=>t.jsx(fc,{o:u,qa:l[u.name],comite:c[u.id]},u.id)),!m.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const gc=50;function Qn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=X(),[i,d]=p.useState(null),[s,l]=p.useState(!1),[h,c]=p.useState(""),[g,f]=p.useState(0),[b,m]=p.useState(""),[v,w]=p.useState(!1),[u,y]=p.useState(0),E=p.useRef(null),k=p.useRef(null),j=()=>{y(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>y(L=>L+1),1e3)},N=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};p.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),k.current&&window.clearInterval(k.current)},[]);const q=async L=>{l(!0),c(""),j();const z=await a();if(l(!1),N(),z.ok){d(z);return}if(z.busy){c(o.alertPreviewBusy);return}if(!L){c(o.alertPreviewFail);return}f(gc),N(),E.current=window.setInterval(()=>{f(M=>M>1?M-1:(E.current&&window.clearInterval(E.current),q(!1),0))},1e3)},S=async()=>{if(n||v||s)return;w(!0),m(""),j();const L=await r();w(!1),N(),m(L.ok?o.alertTestOk(L.sentTo||""):L.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||v||g>0,onClick:()=>{q(!0)},children:s?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||s,onClick:()=>{S()},children:v?o.alertBtnTestBusy:o.alertTest})]}),s&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(u)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(u)]}),g>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(g)}),h&&t.jsx("p",{className:"mnote warn",children:h}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const kt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Qe({title:e,icon:a,children:r,wide:n,kind:o,lead:i}){const{dispatch:d}=X(),s=o==="plug"?"min(720px,100%)":"min(760px,100%)";return Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:l=>{l.target===l.currentTarget&&d({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard"+(o?" m-"+o:""),style:n?{width:s}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsxs("div",{className:"mh-txt",children:[t.jsx("h2",{children:e}),i&&t.jsx("p",{className:"mh-lead",children:i})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>d({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function xc(){const{st:e}=X();switch(e.modal){case"chain":return t.jsx(vc,{});case"space":return t.jsx(wc,{});case"alert":return t.jsx(yc,{});case"queue":return t.jsx(Sc,{});case"export":return t.jsx(Cc,{});case"plug":return t.jsx(qc,{});case"approach":return t.jsx(Tc,{});case"recharge":return t.jsx(Rc,{});case"cover":return t.jsx(Mc,{});case"dossier":return t.jsx(Oc,{});case"crit":return t.jsx(_c,{});case"tuto":return t.jsx(Bc,{});case"rdv":return t.jsx(bc,{});case"memoalert":return t.jsx(zc,{});default:return null}}function bc(){const{dispatch:e,fund:a,t:r}=X(),n=a||r.rdvCoFallback;return Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:To,children:qo}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(al,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function vc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:s,caps:l,memoQueued:h,doAnalyse:c}=X(),g=i==="client",f=e.chain.queue.map(w=>r.get(w)).filter(w=>!!w),b=e.chain.idx,m=f[b],v=b>=f.length;return Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${f.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,f.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(f.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Kt(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(ut(m.date))].filter(Boolean).map(w=>String(w)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:tt(m.engine,o)}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Pt(m.amountEur,o)})]}),_e(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ct,{o:m,lg:!0})," ",t.jsx(Qa,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(g&&Ue(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),g&&Ue(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Ft(m)==="retenu"?"var(--brand)":Ft(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ft(m)==="retenu"?"✓ "+n.kept:Ft(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&l.pipe&&Te(m)===1&&!h.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(g&&Ue(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var w;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(w=document.querySelector(".atl2 .demand"))==null||w.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{d(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function wc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=X(),i=o==="client",d=p.useMemo(()=>i?r.filter(g=>Ue(g)):[],[r,i]),s=p.useMemo(()=>Bn(d.filter(g=>Ft(g)==="retenu"),{key:"signal",dir:-1}),[d]),l=p.useMemo(()=>d.filter(g=>Ft(g)==="ecarte"),[d]),h=e.spaceTab==="retenu"?s:l,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Qe,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:l.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(g=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof g.score=="number"&&g.score>0?g.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:g.name}),t.jsx("div",{className:"rr",children:g.reasoning||g.tagline||""})]})]},g.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function yc(){const{mode:e}=X();return e==="client"||e==="apercu"?t.jsx(kc,{}):t.jsx(Nc,{})}function kc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=X(),[i,d]=p.useState("d"),s=o!=="client";return t.jsxs(Qe,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Ec,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(jc,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(Ei,{})]})}function Ec({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[s,l]=p.useState(!1),[h,c]=p.useState(0);p.useEffect(()=>{let S=!0;return l(!1),hr(a).then(L=>{S&&(L?d(L):l(!0))}),()=>{S=!1}},[a,h]);const g=p.useRef({}),[f,b]=p.useState({}),[m,v]=p.useState(!1),[w,u]=p.useState(!1),y=p.useRef(null);p.useEffect(()=>()=>{y.current&&window.clearTimeout(y.current)},[]);const E=S=>{const L=g.current;Object.keys(L).length&&(v(!0),hr(a,L).then(z=>{if(!z){v(!1),o(e.actErr);return}if(z.throttled&&S<3){y.current=window.setTimeout(()=>E(S+1),5400);return}if(g.current={},b({}),d(z),v(!1),z.throttled){o(e.alertThrottled);return}u(!0),window.setTimeout(()=>u(!1),2e3),n(e.alertSaved)}))},k=S=>{r||(g.current={...g.current,...S},b(L=>({...L,...S})),y.current&&window.clearTimeout(y.current),y.current=window.setTimeout(()=>E(1),700))};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(S=>S+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...f},N=S=>!j.sections||j.sections.includes(S),q=S=>{const L=j.sections||e.alertSec.map(([z])=>z);k({sections:N(S)?L.filter(z=>z!==S):[...L,S]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&w&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([S,L])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:N(S),disabled:r,onChange:()=>q(S)}),t.jsxs("span",{children:[L,S==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},S))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Qn,{label:e.alertPreview,readOnly:r,onPreview:()=>_s(a),onTest:()=>Ps(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function jc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[s,l]=p.useState(!1),[h,c]=p.useState(0);p.useEffect(()=>{let m=!0;return l(!1),gr(a).then(v=>{m&&(v?d(v):l(!0))}),()=>{m=!1}},[a,h]);const g=m=>{r||gr(a,m).then(v=>{if(!v){o(e.actErr);return}d(v),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const f=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:f,disabled:r,onChange:m=>g({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Qn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>$s(a),onTest:()=>Bs(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ei(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=X(),[d,s]=p.useState(i||""),[l,h]=p.useState(!1),[c,g]=p.useState(!1);p.useEffect(()=>{i&&s(i)},[i]);const f=e.filters,b=p.useMemo(()=>n.filter(u=>_e(u)).length,[n]),m=f.win==="1"?0:f.win==="7"?1:f.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(d)||c)){g(!0);try{await fetch(`${ha}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:f.sector,countries:f.country,source:i?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{g(!1)}}},w=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,f.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,f.engine.length?f.engine.map(u=>tt(u,r)).join(", "):a.amAllEngines],[a.amRows.sectors,f.sector.length?f.sector.join(", "):a.amAllSectors],[a.amRows.countries,f.country.length?f.country.map(u=>Kt(u,r)||u).join(", "):a.amAllCountries],[a.amRows.stages,f.stage.length?f.stage.join(", "):a.amAllStages]];return l?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:w.map(([u,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:u}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},u))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:u=>s(u.target.value),onKeyDown:u=>{u.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Nc(){const{t:e}=X();return t.jsx(Qe,{title:e.alertTitle,icon:"🔔",children:t.jsx(Ei,{})})}function Sc(){var $,U;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:s,dispatch:l,liveMemos:h,data:c}=X(),[g,f]=p.useState(()=>Xa(r)),[b,m]=p.useState(()=>!Xa(r)),[v,w]=p.useState([]),[u,y]=p.useState(0),E=n==="client",k=p.useMemo(()=>{const F=new Map;return o.forEach(x=>{const T=(x.name||"").trim().toLowerCase();T&&!F.has(T)&&F.set(T,x)}),F},[o]);p.useEffect(()=>{let F=!0;return(!Xa(r)||u>0)&&m(!0),(async()=>{const[x,T]=await Promise.all([Pn(r,u>0),Lo(a)]);F&&(x&&f(x),m(!1),w(T))})(),()=>{F=!1}},[a,r,u]);const j=b&&!g,N=(g==null?void 0:g.per_day)??0,q=(($=g==null?void 0:g.analyzed_today)==null?void 0:$.length)??0,S=g==null?void 0:g.offre,L=(g==null?void 0:g.pool_meta)||[],z=p.useMemo(()=>{const F=new Map;for(const x of(g==null?void 0:g.scheduled)||[])for(const T of x.names||[])F.has(T)||F.set(T,{label:x.day_label,date:x.date});return F},[g==null?void 0:g.scheduled]),M=(g==null?void 0:g.in_progress)||[];return t.jsxs(Qe,{title:e.queueTitle,wide:!0,children:[!!c.credits&&!c.credits.unlimited&&!!(c.credits.packs||[]).length&&t.jsxs("div",{className:"qcredits",children:[t.jsxs("p",{className:"qcredits-h",children:[t.jsx("b",{children:e.creditsCap})," ",c.credits.total_available," / ",c.credits.daily_grant+c.credits.purchased," ",e.creditsToday]}),t.jsx("p",{className:"qcredits-n",children:e.creditsTrialHint(c.credits.daily_grant)}),t.jsx("div",{className:"packs",children:c.credits.packs.map(F=>t.jsxs("div",{className:"pack",children:[t.jsx("b",{className:"pk-n",children:F.credits}),t.jsx("span",{className:"pk-u",children:e.creditsUnit}),t.jsxs("span",{className:"pk-p",children:[F.price_eur," €"]}),t.jsx("button",{type:"button",onClick:()=>{const x=c.email;if(!x)return;const T=window.location.href.split("?")[0];fetch(`${ha}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:x,lookup_key:F.lookup_key,success_url:T+"?credits=ok",cancel_url:T+"?credits=cancel"})}).then(D=>D.json()).then(D=>{D.url&&(window.location.href=D.url)}).catch(()=>{})},children:e.rechargeBuy})]},F.lookup_key))})]}),S&&t.jsxs("div",{className:"qoffre"+(S.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:S.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:S.delai})]}),t.jsx("span",{className:"osp"}),S.rythme>0?t.jsx("span",{className:"or",children:e.qRate(S.rythme)}):S.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(S.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:j?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(q,q+(((U=g==null?void 0:g.pool_order)==null?void 0:U.length)??0))}})}),S&&t.jsxs("div",{className:"qeta",children:[S.file===0?e.qEtaDone:S.rythme<=0?e.qEtaPaused:e.qEta(S.file,S.rythme,S.jours_restants),S.en_retard&&t.jsxs("em",{children:[" ",e.qLate(S.delai,S.plafond)]})]}),!j&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(S==null?void 0:S.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(M.length>0||h.items.some(F=>F.status==="boot"||F.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[h.items.filter(F=>F.status==="boot"||F.status==="running"||F.status==="error").map(F=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:F.name}),t.jsx("span",{className:"qd",children:F.memoType||""}),t.jsx(Ma,{item:F,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+F.name)),M.filter(F=>!h.liveOf(F.name)).map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.name}),t.jsxs("span",{className:"qd",children:[F.memo_type||"",F.age_min?` · ${Math.round(F.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:F.state||""})]},"ip-"+F.name))]})]}),v.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:v.map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.company}),t.jsxs("span",{className:"qd",children:[F.memo_type,typeof F.est_min=="number"?` · ~${F.est_min} min`:""]}),t.jsx("span",{className:"qt",children:F.status}),F.url&&t.jsx("a",{className:"qgo",href:F.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(F.memo_type)}),E&&F.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{mr(a,F.company,"retry").then(()=>y(x=>x+1))},children:e.queueRetry}),E&&F.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{mr(a,F.company,"delete").then(()=>y(x=>x+1))},children:e.queueDelete})]},F.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",j?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[j&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!j&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((F,x)=>{const T=z.get(F.name),D=k.get((F.name||"").trim().toLowerCase()),Y=h.liveOf(F.name),ee=!!(D&&d.has(D.id))||!!(Y&&(Y.status==="boot"||Y.status==="running")),C=!!(D&&Te(D)===1&&!D.memoUrl)&&!Y;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",x+1]}),T?t.jsx("span",{className:"qwhen"+(T.label==="demain"?" soon":""),children:T.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:F.name}),F.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof F.score=="number"&&t.jsx("span",{className:"qs2",children:F.score}),Y&&(Y.status==="boot"||Y.status==="running")&&t.jsx(Ma,{item:Y,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),C&&(s.lockActions||!E?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>l({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:ee,onClick:()=>{i(D),y(B=>B+1)},children:ee?e.actAnalyseQueued:e.actAnalyse})),F.excerpt&&t.jsx("span",{className:"qex",children:F.excerpt})]},F.name+":"+x)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([F,x])=>t.jsxs("li",{children:[t.jsx("b",{children:F})," — ",x]},F))})]})}function Cc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=X(),s=`${kt}/cibles/list.csv?token=${a}`,l=`${kt}/cibles/list.json?token=${a}`,h=`${kt}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,g=w=>{var u;(u=navigator.clipboard)==null||u.writeText(w).then(()=>r(e.exportCopied))},f=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:l,href:l},{def:e.exportXlsx,value:h,href:h}],b=!o.lockActions&&n.length>0,m=()=>{uc(cc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:w=>(e.stg.find(([u])=>u===w)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Qe,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:f.map(({def:w,value:u,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:w[0]}),t.jsxs("div",{children:[t.jsx("b",{children:w[1]}),t.jsx("p",{children:w[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>g(u),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},w[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function zc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=X(),i=o!=="client",[d,s]=p.useState(null),[l,h]=p.useState(!1),[c,g]=p.useState(0),[f,b]=p.useState(!1);p.useEffect(()=>{let u=!0;return h(!1),cr(a).then(y=>{u&&(y?s(y):h(!0))}),()=>{u=!1}},[a,c]);const m=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=u=>{if(i||!d)return;const y={enabled:u.enabled??!!d.enabled,email:u.email??(d.email||""),sections:u.sections??m()};b(!0),cr(a,y).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}s(E),r(e.memoAlertSaved)})};if(l)return t.jsx(Qe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>g(u=>u+1),children:e.retry})]})});if(!d)return t.jsx(Qe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const w=m();return t.jsxs(Qe,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||f,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(Ac,{value:d.email||"",readOnly:i||f,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:u=>v({email:u})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([u,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!w[u],disabled:i||f,onChange:()=>v({sections:{...w,[u]:!w[u]}})}),t.jsx("span",{children:y})]},u))}),t.jsx(Qn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>As(a,w),onTest:()=>zs(a,w)})]})}function Ac({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=p.useState(e);p.useEffect(()=>{d(e)},[e]);const s=i.trim()!==e.trim(),l=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:h=>d(h.target.value),onKeyDown:h=>{h.key==="Enter"&&s&&l&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!l,onClick:()=>o(i.trim()),children:n})]})]})}function qc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=X(),[i,d]=p.useState(null),[s,l]=p.useState(!1),[h,c]=p.useState(null),[g,f]=p.useState(!1),[b,m]=p.useState(""),[v,w]=p.useState(0),[u,y]=p.useState("webhook"),[E,k]=p.useState("webhook"),[j,N]=p.useState(""),q=p.useRef(!1);p.useEffect(()=>{let D=!0;return l(!1),ur(a).then(Y=>{D&&(Y?d({configured:Y.configured,url_hint:Y.url_hint}):l(!0))}),Fs(a).then(Y=>{if(D){if(!Y){f(!0);return}f(!1),c(Y),q.current||(q.current=!0,Y.destination==="instantly"&&(y(ee=>ee==="webhook"?"instantly":ee),k(ee=>ee==="webhook"?"instantly":ee)),Y.campaign_id&&N(ee=>ee||Y.campaign_id||""))}}),()=>{D=!1}},[a,v]);const S=(D,Y)=>{o&&ur(a,D).then(ee=>{if(!ee||ee.ok===!1){n(e.actErr);return}D.test&&ee.sent===!1?n(e.plugTestThrottled):r(Y),w(C=>C+1)})},L='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',z=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),M=`curl -X POST ${kt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,$=`curl -X POST ${kt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`,U=[{k:"webhook",t:e.plugDestCrm,s:e.plugDestCrmS},{k:"instantly",t:e.plugDestInst,s:e.plugAideInst},{k:"script",t:e.plugDestScript,s:e.plugDestScriptS}],F=E==="instantly"?e.plugStep2Inst:E==="script"?e.plugStep2Script:e.plugStep2Wh,x=E==="instantly"?e.plugAideInst:E==="script"?e.plugAideScript:e.plugAideWh,T=D=>{k(D),D!=="script"&&y(D)};return t.jsxs(Qe,{title:e.plugTitle,icon:"🔌",wide:!0,kind:"plug",lead:e.plugLead,children:[h&&t.jsxs("div",{className:"plugetat"+(h.enabled?" on":""),children:[t.jsx("i",{}),t.jsx("b",{children:h.enabled?e.plugEtatOn:e.plugEtatOff})]}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>w(D=>D+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"1"}),t.jsx("h4",{children:e.plugStep1})]}),t.jsx("div",{className:"plugdests",children:U.map(D=>{const Y=E===D.k;return t.jsxs("button",{type:"button",className:"plugdest"+(Y?" on":""),onClick:()=>T(D.k),children:[t.jsx("span",{className:"pradio","aria-hidden":"true"}),t.jsx("b",{children:D.t}),t.jsx("em",{children:D.s})]},D.k)})}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"2"}),t.jsx("h4",{children:F})]}),E==="script"?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:M}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(M).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}):E==="instantly"?t.jsx("div",{className:"mfield pill",children:t.jsx("input",{type:"text",maxLength:80,placeholder:e.plugCampPh,value:j,disabled:!o,onChange:D=>N(D.target.value)})}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"mfield pill",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:D=>m(D.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>S({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>S({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>S({remove:!0},e.plugRemoved),children:e.plugRemove})]})]}),t.jsx("p",{className:"mnote dim",children:x}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"3"}),t.jsx("h4",{children:e.plugStep3})]}),t.jsx(Lc,{auto:h,autoKo:g,destKind:u,camp:j,onRetry:()=>w(D=>D+1),onDone:D=>{c(D),f(!1)}}),t.jsx("p",{className:"mnote dim",children:e.plugHow3}),t.jsxs("details",{className:"plugex plugpay",children:[t.jsxs("summary",{children:[t.jsx("b",{children:e.plugExT}),t.jsx("span",{children:e.plugPayloadSub})]}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:z}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(z).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult}),t.jsx("p",{className:"mnote dim",children:e.plugVars})]}),t.jsx("div",{"data-tour":"plug-bulk",children:t.jsx(Fc,{destKind:u,setDestKind:D=>{y(D),k(D)},camp:j,setCamp:N,whHint:i!=null&&i.configured?i.url_hint||"webhook":null})}),E!=="script"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:M}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(M).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm","data-tour":"plug-crm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:$}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText($).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Tc(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:s}=X(),l=p.useMemo(()=>r.find(x=>x.id===n.approachId)||null,[r,n.approachId]),[h,c]=p.useState("email"),[g,f]=p.useState(0),[b,m]=p.useState({}),[v,w]=p.useState(!1),[u,y]=p.useState(""),[E,k]=p.useState({});if(p.useEffect(()=>{!l||b[h]||v||(w(!0),y(""),Ls(a,l.name,h).then(x=>{if(w(!1),!x||x.ok===!1){y((x==null?void 0:x.error)||e.apprFail);return}m(T=>({...T,[h]:x}))}))},[l,h,a]),!l)return null;const j=b[h],N=(j==null?void 0:j.sequence)||[],q=N[g],S=x=>`${h}|${g}|${x}`,L=x=>{const T=S(x);return T in E?E[T]:String(((q==null?void 0:q[x])??"")||"")},z=(x,T)=>k(D=>({...D,[S(x)]:T})),M=S("subject")in E||S("body")in E||S("message")in E,$=L(h==="email"?"body":"message"),U=L("subject"),F=h==="email"&&U?`${U}

${$}`:$;return t.jsxs(Qe,{title:e.apprT(l.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(x=>t.jsx("button",{type:"button",className:"apch"+(h===x?" on":""),"aria-pressed":h===x,onClick:()=>{c(x),f(0)},children:x==="email"?e.apprChEmail:e.apprChLi},x)),t.jsx("span",{className:"sp"}),N.map((x,T)=>t.jsxs("button",{type:"button",className:"apday"+(g===T?" on":""),"aria-pressed":g===T,onClick:()=>f(T),children:[x.day||`J${T}`,[`${h}|${T}|subject`,`${h}|${T}|body`,`${h}|${T}|message`].some(D=>D in E)&&t.jsx("i",{children:"✎"})]},x.day||T))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,j!=null&&j.sender?" · "+e.apprSender(j.sender):""]}),v&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!u&&!v&&t.jsxs("p",{className:"mnote warn",children:[u," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{m(x=>{const T={...x};return delete T[h],T}),y("")},children:e.retry})]}),!v&&!u&&!q&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),q&&t.jsxs(t.Fragment,{children:[h==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:U,onChange:x=>z("subject",x.target.value)})]}),h==="linkedin"&&g===0&&(j==null?void 0:j.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:$,onChange:x=>z(h==="email"?"body":"message",x.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var x;(x=navigator.clipboard)==null||x.writeText(F).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),h==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(l.contactEmail||"")}?subject=${encodeURIComponent(U)}&body=${encodeURIComponent($)}`,children:e.apprMailto}),M&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Lc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:s,flash:l,flashErr:h,canWrite:c}=X(),[g,f]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),v=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,w=()=>{if(g||!c||m)return;f(!0),(b?fr(s,!1):fr(s,!0,r,n.trim()||void 0)).then(y=>{if(f(!1),!y){h(d.actErr);return}o(y),l(y.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:g||!c||!!m,title:m||void 0,onClick:w,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),m===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:m}),v&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function Fc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:s,canWrite:l}=X(),[h,c]=p.useState("valides"),[g,f]=p.useState(!1),[b,m]=p.useState(null),[v,w]=p.useState(null),[u,y]=p.useState(!1),[E,k]=p.useState(!1),[j,N]=p.useState(null),[q,S]=p.useState(null),L=`atl2:bulk:${d}:${h}:${e}`;p.useEffect(()=>{m(null),w(null),y(!1),N(null);try{const C=localStorage.getItem(L)||localStorage.getItem(`atl2:bulk:${d}:${h}`),B=JSON.parse(C||"null");S(B&&Date.now()-Date.parse(B.t)<24*3600*1e3?B:null)}catch{S(null)}},[L,h,d]);const z=e==="instantly"&&!r.trim(),M=`${h}|${e}|${r.trim()}`,$=async()=>{if(z||!l)return;f(!0),y(!1),N(null);const C=await Ds(d,h,e,r.trim()||void 0);m(C),w(C.ok?M:null),f(!1)},U=p.useRef(!1);if(!l)return null;const F=async()=>{if(U.current||!l)return;U.current=!0,k(!0);const C=`${d}:${h}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let B;try{B=await Is(d,h,e,r.trim()||void 0,C)}finally{U.current=!1}if(k(!1),y(!1),N(B),B.ok&&(B.pushed||0)>0){const I={t:new Date().toISOString(),n:B.pushed||0};S(I);try{localStorage.setItem(L,JSON.stringify(I))}catch{}}};u&&v!==null&&v!==M&&y(!1);const x=o,T=b!=null&&b.ok&&b.ready||0,D=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":x||"",Y=!!(b!=null&&b.ok)&&v===M&&T>0&&!!D&&!q,ee=q?new Date(q.t).toLocaleString(s==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:h,onChange:C=>c(C.target.value),children:i.plugBulkTabs.map(([C,B])=>t.jsx("option",{value:C,children:B},C))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:C=>a(C.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:C=>n(C.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:g||z,onClick:()=>{$()},children:g?"…":i.plugBulkPreview})]}),z&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),q&&t.jsx("p",{className:"mnote",children:i.bulkLocked(ee,q.n)}),!q&&!!(b!=null&&b.ok)&&!D&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!q&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),Y&&!u&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>y(!0),children:i.bulkArm}),Y&&u&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(T,D)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:E,onClick:()=>{F()},children:E?i.bulkSending:i.bulkConfirm(D)}),t.jsx("button",{type:"button",className:"abtn",disabled:E,onClick:()=>y(!1),children:i.bulkCancel})]}),j&&(j.ok?j.replayed?t.jsx("p",{className:"mnote",children:j.pending?i.bulkPending:i.bulkReplayed}):(j.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(j.pushed||0,j.linkedinReady||0,j.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:j.error||i.actErr}))]})}function Rc(){const{t:e,data:a,lang:r}=X(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const s=window.location.href.split("?")[0];try{const h=await(await fetch(`${ha}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(Qe,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("b",{className:"pk-n",children:d.credits}),t.jsx("span",{className:"pk-u",children:e.creditsUnit}),t.jsxs("span",{className:"pk-p",children:[d.price_eur," €"]}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Oc(){const{t:e}=X();return t.jsx(Qe,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(hc,{})})}function Mc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:s}=X(),[l,h]=p.useState(null),[c,g]=p.useState(!1);p.useEffect(()=>{let L=!0;if(i)return Pn(i).then(z=>{L&&z&&typeof z.per_day=="number"&&h(z.per_day)}),()=>{L=!1}},[i]);const[f,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let L=!0;return Ts(o).then(z=>{L&&b(z)}),()=>{L=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(L=>L.kind==="target"&&Ue(L)).length,w=r.marketEstimate||0,u=w>0?Math.min(100,Math.round(v/w*100)):null,y=(m==null?void 0:m.window_days)||30,E=v>0?v/y:0,k=w>0?Math.max(0,w-v):0,N=w>0&&E>0&&v>=100?Math.round(k/E):null,q=L=>Math.round(L).toLocaleString(a==="en"?"en-US":"fr-FR"),S=L=>{c||!d||(g(!0),Fo(o,L).then(z=>{if(g(!1),z===null){s(e.actErr);return}h(z),s(e.alertSaved)}))};return t.jsxs(Qe,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(q(v))}),w>0&&t.jsx("span",{children:e.covOf(q(w))})]}),u!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:u+"%"}}),t.jsxs("em",{children:[u," %"]})]}),N!==null&&t.jsx("p",{className:"mnote",children:e.covEta(N)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(q(E))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:q(m.shown)})," ",e.funShown]})]}),(f==null?void 0:f.ok)&&(f.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),f.perimetre&&t.jsx("p",{className:"mnote",children:f.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(f.detail||[]).map((L,z)=>t.jsxs("tr",{className:L.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[L.code,L.geo?` · ${L.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof L.n=="number"?q(L.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:L.source}),L.elargi&&t.jsx("em",{children:e.covWide(String(L.demande||""))}),L.erreur&&t.jsx("em",{children:e.covMissing})]})]},z)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:q(f.total||w)})}),t.jsx("td",{className:"mks"})]})]})]}),(f.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((f.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(f.sources||[]).join(" · "),f.calcule_le?` — ${e.covComputedAt(f.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&l!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(l)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(L=>t.jsx("button",{type:"button",className:l===L?"on":"",disabled:c,onClick:()=>S(L),children:L===0?"⏸":L},L))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function ji(e,a,r){const n=await fetch(`${kt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${kt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Dc(){const{t:e,token:a,canWrite:r}=X(),[n,o]=p.useState(null),[i,d]=p.useState(""),[s,l]=p.useState(""),[h,c]=p.useState(!1),g=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,f=p.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const m=JSON.parse(localStorage.getItem(g)||"null");return!!m&&Date.now()-(m.t||0)<14*24*3600*1e3}catch{return!1}},[g,n==null?void 0:n.pattern]);if(p.useEffect(()=>{if(!r)return;let m=!0;return Os(a).then(v=>{m&&o(v)}),()=>{m=!1}},[a,r]),!r||h||f||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),ji(a,n.instruction||"","atelier2-avis").then(m=>{if(d(m.applied?"ok":"ko"),m.applied||l(m.encours?e.propSlow:m.reply),m.applied)try{localStorage.setItem(g,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:s||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{c(!0);try{localStorage.setItem(g,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Ic(){var j;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=X(),[i,d]=p.useState(!1),[s,l]=p.useState(null),[h,c]=p.useState(!1),[g,f]=p.useState([]),[b,m]=p.useState(null),[v,w]=p.useState([]);if(!r)return null;const u=()=>{d(!0),c(!1),f([]),w([]),Ms(a).then(N=>{if(d(!1),!N){c(!0),l(null);return}l(N)})},y=N=>{b||(m(N.title),ji(a,N.instruction,"atelier2-prop").then(q=>{m(null),q.applied?(w(S=>[...S,N.title]),n(e.propApplied)):q.encours?n(e.propSlow):o(q.reply||e.propApplyFail)}))},E=((s==null?void 0:s.proposals)||[]).filter(N=>!g.includes(N.title)&&!v.includes(N.title)),k=((j=s==null?void 0:s.counts)==null?void 0:j.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:u,children:i?e.propWait:e.propBtn}),!i&&h&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!h&&s&&!(s.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:s.reason==="not_enough_signals"?e.propFew(k):e.propNone}),E.map(N=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[N.section]||N.section}),t.jsx("p",{className:"propt",children:N.title}),N.why&&t.jsx("p",{className:"mnote dim",children:N.why}),N.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",N.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>y(N),children:b===N.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>f(q=>[...q,N.title]),children:e.propSkip})]})]},N.title))]})}function Pc(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=X(),[s,l]=p.useState(null),[h,c]=p.useState(!1),[g,f]=p.useState(!1),[b,m]=p.useState(""),[v,w]=p.useState(""),[u,y]=p.useState(!1),E=p.useRef(!1);if(p.useEffect(()=>{if(!a||!r)return;let N=!0;return Rs(a).then(q=>{N&&(c(!0),!(!q||E.current)&&(l(q),m(q.fit),w(q.note)))}),()=>{N=!1}},[a,r]),!r)return null;const k=()=>{if(!(!b||u)){if(s&&s.fit===b&&s.note===v.trim()){f(!1);return}y(!0),wt(a,"thesis_fit",b,v.trim(),"",d.email||"").then(N=>{if(y(!1),!N.ok){o(e.fitKo);return}l({fit:b,note:v.trim(),ts:new Date().toISOString()}),f(!1),n(e.fitSaved)})}},j=N=>N==="yes"?e.fitYes:N==="partial"?e.fitPartial:e.fitNo;if(s&&!g){const N=new Date(String(s.ts||"")),q=Number.isNaN(N.getTime())?"":N.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:j(s.fit)}),s.note?` — ${s.note}`:""]}),!!q&&t.jsx("p",{className:"mnote dim",children:q}),t.jsx("button",{type:"button",className:"lk",onClick:()=>f(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(N=>t.jsx("button",{type:"button","aria-pressed":b===N,className:"fitopt"+(b===N?" on":""),onClick:()=>{E.current=!0,m(N)},children:j(N)},N))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:v,onChange:N=>{E.current=!0,w(N.target.value)},onKeyDown:N=>{N.key==="Enter"&&k()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||u,onClick:k,children:u?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!h&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function _c(){var u,y,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:s}=X(),l=n==="client",h=p.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[c,g]=p.useState(""),[f,b]=p.useState(""),[m,v]=p.useState(!1),w=async()=>{const k=c.trim();if(!(!k||m||!l)){v(!0),b("");try{const N=await(await fetch(`${kt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(N.reply&&b(String(N.reply)),N.job_id){b(e.critChatRunning);const q=async()=>{const S=await fetch(`${kt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:N.job_id})}).then(L=>L.json()).catch(()=>null);if(S&&S.done){b(String(S.reply||S.clarification||S.summary||"✓")),v(!1),S.applied&&o(e.alertSaved);return}setTimeout(()=>{q()},8e3)};setTimeout(()=>{q()},8e3),g("");return}g("")}finally{f.startsWith("⏳")||v(!1)}}};return t.jsxs(Qe,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((u=i.points)!=null&&u.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,N;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(q=>t.jsx("li",{children:q},q))})]}),!!((N=k.out)!=null&&N.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(q=>t.jsx("li",{children:q},q))})]})]})]},k.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsx(Pc,{}),t.jsx(Dc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!l||m,onChange:k=>g(k.target.value),onKeyDown:k=>{k.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!l||m||!c.trim(),onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),f&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:f})]}),t.jsx(Ic,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(qs,{fund:d,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(wi[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Bc(){const{t:e,dispatch:a,startTour:r}=X(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Qe,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const Ni="atl2:mapfold",$c=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Ni);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Uc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Si=p.createContext(null),X=()=>{const e=p.useContext(Si);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ct({o:e,lg:a}){const{lang:r}=X(),n=_e(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:xr(n,r),children:[n.emoji," ",xr(n,r)]}):null}function Qa({o:e,src:a}){const{lang:r,t:n}=X(),o=_e(e);if(!o)return null;const i=Qs(o),d=Ks(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(zo(o,r))+" · "+n.win7(Ao(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,l)=>t.jsx("i",{className:l<i?"on":""},l))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Hc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=$e(a);if(o)return e.find(i=>$e(i.name)===o)||e.find(i=>{const d=$e(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Vc(){const{scoped:e,t:a,st:r,dispatch:n}=X(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(g=>!Be(g)),s=d.length,l=d.filter(g=>!g.noCo).length,h=d.filter(g=>!!g.noCo).length,c=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:c?"7":"all"}});else{const g=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:g,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:s}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",l," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",h," ",a.zoomPulseExplore]})]})]})}function Wc(){var v;const{t:e,lang:a,data:r,dispatch:n,dossiers:o,st:i,caps:d}=X(),s=w=>w.toLocaleString(a==="en"?"en-US":"fr-FR"),l={...i,filters:{...i.filters,win:"all",day:""}},h=o.filter(w=>!Be(w)&&Rt(w,l,d.pipe)),c=h.length,g=h.filter(w=>Te(w)===1).length,f=h.filter(w=>Te(w)===2).length,b=typeof((v=r.stats)==null?void 0:v.screened)=="number"?r.stats.screened:0;if(c<=0&&b<=0)return null;const m=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:s(c)}),t.jsx("span",{children:m>0?e.covOf(s(m)):e.covScreened("").trim()}),t.jsxs("ul",{children:[t.jsxs("li",{children:["✅ ",s(g)," ",e.covKept]}),t.jsxs("li",{children:["⚡ ",s(f)," ",e.covAna]})]})]})}const Gc=[0,1,2,3,5,10];function Yc(){var q;const{t:e,token:a,fund:r,mode:n,dispatch:o,flash:i,flashErr:d,data:s}=X(),[l,h]=p.useState(null),[c,g]=p.useState(!0),[f,b]=p.useState([]),[m,v]=p.useState(!1),w=n==="client",u=s.credits,y=!!u&&!u.unlimited;p.useEffect(()=>{if(!a||!r)return;let S=!0;return g(!0),(async()=>{const[L,z]=await Promise.all([Pn(r),Lo(a)]);S&&(L&&h(L),g(!1),b(z))})(),()=>{S=!1}},[a,r]);const E=(l==null?void 0:l.per_day)??null,k=((q=l==null?void 0:l.pool_order)==null?void 0:q.length)??0,j=f.filter(S=>S.status==="running").length,N=S=>{!w||m||!a||(v(!0),Fo(a,S).then(L=>{if(v(!1),L===null){d(e.actErr);return}h(z=>z&&{...z,per_day:L}),i(e.alertSaved)}))};return t.jsxs("div",{className:"map-pulse map-engine",children:[t.jsxs("button",{type:"button",className:"map-engine-hit",title:e.queueTitle,onClick:()=>o({type:"modal",modal:"queue"}),children:[t.jsx("em",{children:e.identEngine}),t.jsx("b",{children:E===null?"—":E}),t.jsx("span",{children:e.identPerDay}),t.jsxs("ul",{children:[E===0&&t.jsx("li",{children:t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause})}),j>0&&t.jsxs("li",{children:["⏳ ",j]}),t.jsx("li",{children:c?e.identPendingWait:e.identPending(k)})]})]}),E!==null&&t.jsx("div",{className:"map-engine-rate covrb",role:"group","aria-label":e.covRate,children:Gc.map(S=>t.jsx("button",{type:"button",className:E===S?"on":"",disabled:!w||m,title:S===0?e.identPauseTitle:e.covRateNow(S),onClick:()=>N(S),children:S===0?"⏸":S},S))}),t.jsxs("button",{type:"button",className:"map-engine-alert",title:e.memoAlertSub,onClick:()=>o({type:"modal",modal:"memoalert"}),children:["🔔 ",e.memoAlertBtn]}),y&&u&&t.jsxs("div",{className:"map-engine-credits",children:[t.jsx("em",{children:e.creditsCap}),t.jsxs("b",{children:[u.total_available,t.jsxs("span",{children:[" / ",u.daily_grant+u.purchased]})]}),t.jsx("span",{children:e.creditsToday})]})]})}function Ci({o:e}){const{lang:a}=X(),r=Ys(e.cc),n=e.cc?Kt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:16,height:16,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Qc=!1;function Kc(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const zi=e=>`atl2:tour:${e||"anon"}`;function Jc(e){try{return localStorage.getItem(zi(e))==="1"}catch{return!0}}function xo(e){try{localStorage.setItem(zi(e),"1")}catch{}}function Xc(e,a,r,n,o,i,d,s){const l=e.tourT,h=e.howto;return[{sel:".atl2 .ident",title:l.ident,body:e.fhintIdent},o?{sel:".atl2 .map-pulse",title:l.cover,body:e.fhintCover,need:".atl2 .map-hud"}:null,{sel:".atl2 .map-engine",title:l.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:l.live,body:e.fhintLive},{sel:".atl2 .goal",title:l.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:l.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:l.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:l.tuto,body:h[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:l.demand,body:h[1][0]},{sel:".atl2 .dmulti.ddeals",title:l.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:l.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:l.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:l.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:l.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:l.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:l.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:l.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:l.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:l.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-bulk"]',need:".atl2 .ic[data-tour=plug]",title:l.campout,body:e.fhintCampout,modal:"plug"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-crm"]',need:".atl2 .ic[data-tour=plug]",title:l.addcrm,body:e.fhintAddcrm,modal:"plug"}:null,...[2,4,5].filter(c=>(s[c]||0)>0).map(c=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:c===2?l.tabAna:c===4?l.tabValid:l.tabRej,body:c===2?e.fhintTabAna:c===4?e.fhintTabValid:e.fhintTabRej,ptab:c})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:l.rank,body:e.fhintRank},{sel:".atl2 .learn",title:l.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:l.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:l.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:l.tools,body:h[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:l.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:l.crit,body:h[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:l.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:l.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:l.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function nu({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Jn;const{lang:d}=Us(),s=Pl(e,d,a),l=p.useMemo(()=>({...Sl[d],...Nl(d,s.thesisMode)}),[d,s.thesisMode]),[h,c]=p.useReducer($l,void 0,()=>_l((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Uc():$c()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),g=p.useRef(!0);p.useEffect(()=>{if(g.current){g.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Ni,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const A=()=>{window.innerWidth<=760&&c({type:"mapFold",folded:!0})};return A(),window.addEventListener("resize",A),()=>window.removeEventListener("resize",A)},[a]);const f=p.useRef(i);f.current=i,p.useEffect(()=>{var A;(A=f.current)==null||A.call(f,h.filters)},[h.filters]);const[b,m]=p.useState(()=>{if(typeof window>"u")return"both";try{const A=localStorage.getItem("atl2:chrome-mode");if(A==="eval"||A==="filt"||A==="both")return A;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,w]=p.useState(null),[u,y]=p.useState(null),[E,k]=p.useState(null),[j,N]=p.useState({kept:0,dropped:0}),[q,S]=p.useState(!1),[L,z]=p.useState(""),[M,$]=p.useState(!1),[U,F]=p.useState(null),[x,T]=p.useState(null),[D,Y]=p.useState(!1),[ee,C]=p.useState(!1),[,B]=p.useState(0),I=()=>B(A=>A+1),K=p.useRef([]),H=p.useRef(new Set),ce=p.useRef(new Set),[te,le]=p.useState([]),[xe,he]=p.useState([]),[we,pe]=p.useState(0),Ne=p.useRef(new Map),ze=p.useRef(null),{mode:ue}=s,be=p.useMemo(()=>({...s.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[s.caps,o,a]),ye=be.pipe,Z=s.session.token||"",P=ue==="client"&&!e;p.useEffect(()=>{if(!Z||!ye)return;let A=!0;const J=async()=>{const fe=await Js(Z);!A||!fe||(he(fe.runs),pe(Date.now()/1e3-fe.now),le(Re=>Re.filter(qe=>!fe.runs.some(Ve=>$e(Ve.company)===$e(qe.name)))))};J();const G=te.length>0||xe.some(fe=>fe.status==="running"),ne=window.setInterval(()=>{J()},G?8e3:25e3);return()=>{A=!1,window.clearInterval(ne)}},[Z,ye,te.length,xe.some(A=>A.status==="running")]),p.useEffect(()=>{if(!Z||!ye||!P)return;let A=!0;const J=async()=>{const ne=await Xs(Z);if(!A||!ne.length)return;const fe=new Map;ne.forEach(Re=>{const qe=String(Re.ceo_status||"").trim();qe&&Re.check_id&&fe.set(String(Re.check_id),qe)}),s.patchStatuses(fe,Re=>Date.now()-(re.current.get(Re)||0)>9e4)};J();const G=window.setInterval(()=>{J()},6e4);return()=>{A=!1,window.clearInterval(G)}},[Z,ye,P]);const Q=p.useMemo(()=>{const A=[],J=new Set;for(const G of te){const ne=$e(G.name);!ne||J.has(ne)||(J.add(ne),A.push({name:G.name,id:G.id,status:"boot",started:G.started,estMin:G.estMin,memoType:"instant"}))}for(const G of xe){const ne=$e(G.company);if(!ne||J.has(ne))continue;J.add(ne);const fe=G.status==="error"?"error":G.status==="done"?"done":"running";A.push({name:G.company,status:fe,started:G.started||0,estMin:G.est_min||(G.memo_type==="detailed"?40:15),url:G.url,error:G.error,memoType:G.memo_type,note:G.note})}return A},[te,xe]),ie=A=>Q.find(J=>$e(J.name)===$e(A))||null,oe=(A,J)=>{le(G=>G.some(ne=>$e(ne.name)===$e(A.name))?G:[...G,{name:A.name,id:A.id,started:Date.now()/1e3,estMin:J==="detailed"?40:15}]),H.current.add(A.id),I()},me=(A,J=!1)=>{z(A),$(J),ze.current&&clearTimeout(ze.current),ze.current=setTimeout(()=>z(""),J?4200:2400)},W=A=>me(A,!0),se=p.useMemo(()=>{const A=new Map;return s.dossiers.forEach(J=>{J.id&&A.set(J.id,J)}),A},[s.dossiers]),ve=p.useMemo(()=>s.dossiers.filter(A=>Rt(A,h,ye)),[s.dossiers,h,ye]),ke=p.useRef(!1);p.useEffect(()=>{if(ke.current||s.loading||!s.dossiers.length)return;if(e&&!s.session.token){ke.current=!0;return}if(!be.showFunnel||Jc(s.session.token||"")){ke.current=!0;return}ke.current=!0;const A=window.setTimeout(()=>{xo(s.session.token||""),Y(!0)},700);return()=>window.clearTimeout(A)},[e,s.loading,s.dossiers.length,be.showFunnel,s.session.token]);const Ee=p.useMemo(()=>s.dossiers.filter(A=>Ul(A,h,ye,s.favIds)),[s.dossiers,h,ye,s.favIds]),ge=p.useMemo(()=>Hs(ve.filter(A=>!Ke(A)),s.favIds),[ve,s.favIds]),Ie=p.useRef(!1);p.useEffect(()=>{if(Ie.current)return;if(!ye||a==="ops"){Ie.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Ie.current=!0;return}if(s.loading)return;Ie.current=!0;const A=Vs(ge);A!==h.ptab&&c({type:"ptab",tab:A})},[ye,a,n==null?void 0:n.ptab,s.loading,ge,h.ptab]);const Je=p.useMemo(()=>{const A=Wo(s.dossiers);return A?ut(A)===0?l.tourToday:Go(A,d):l.tourNoRun},[s.dossiers,l,d]),at=p.useMemo(()=>s.dossiers.some(A=>!!A.memoUrl||!!A.summary||Vt(A)),[s.dossiers]),[Ce,dt]=p.useState(!1);p.useEffect(()=>{if(s.loading){dt(!1);return}if(s.dossiers.length>0||s.error){dt(!0);return}const A=window.setTimeout(()=>dt(!0),6e3);return()=>window.clearTimeout(A)},[s.loading,s.dossiers.length,s.error]);const nt=(s.marketEstimate||0)>0||typeof((Jn=s.stats)==null?void 0:Jn.screened)=="number"&&s.stats.screened>0,Xe=p.useMemo(()=>[1,0,2,4,5,3].find(A=>(ge[A]||0)>0)??0,[ge]),rt=Dn.find(A=>A.key===h.continent),At=h.continent==="monde"?l.contWorld:(d==="fr"?rt==null?void 0:rt.fr:rt==null?void 0:rt.en)||"";p.useEffect(()=>{const A=J=>{var ne;const G=(((ne=J.detail)==null?void 0:ne.name)||"").trim();G&&bt(null,G)};return window.addEventListener("ppmap:evaluate",A),()=>window.removeEventListener("ppmap:evaluate",A)}),p.useEffect(()=>{const A=J=>{const G=J.detail||{},ne=String(G.id||"").trim(),fe=String(G.name||"").trim(),Re=String(G.url||"").trim(),qe=ne&&se.get(ne)||Hc(s.dossiers,fe,Re);if(qe){if(y(null),Rt(qe,h,ye)||(h.continent!=="monde"&&qe.continent!==h.continent&&c({type:"continent",key:qe.continent||"monde"}),c({type:"reset"})),ye&&qe.kind!=="op"){const ht=Te(qe);typeof ht=="number"&&ht!==h.ptab&&c({type:"ptab",tab:ht})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),c({type:"focus",id:qe.id}),(qe.noCo||["media","nominations","recrutements"].includes(qe.engine||""))&&(qe.url||qe.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:qe.url||"",text:[qe.headline,qe.tagline].filter(Boolean).join(`
`)}})):qe.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:qe.name,url:qe.url||"",website:qe.website||"",domain:qe.domain||""}}));return}!fe&&!Re||(c({type:"focus",id:ne||null}),y({name:fe,headline:String(G.text||"").trim()||fe,url:Re,card:G.card}),Re&&(Da(fe)||!fe)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Re,text:String(G.text||"").trim()}})):fe&&!Da(fe)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:fe}})))};return window.addEventListener("ppmap:focus",A),()=>window.removeEventListener("ppmap:focus",A)}),p.useEffect(()=>{const A=ne=>{const fe={},Re=String((ne==null?void 0:ne.sector)||"").trim();Re&&(fe.sector=[Re]);const qe=String((ne==null?void 0:ne.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(qe)&&(fe.day=qe);const Ve=String((ne==null?void 0:ne.search)||"").trim();Ve&&(fe.search=Ve);const ht=String((ne==null?void 0:ne.dealKind)||"").trim();(ht==="ma"||ht==="levee"||ht==="other")&&(fe.dealKind=[ht]),Object.keys(fe).length&&c({type:"filters",patch:fe})},J=ne=>A(ne.detail),G=ne=>{ne.data&&ne.data.type==="pp-filter"&&A(ne.data)};return window.addEventListener("ppmap:filter",J),window.addEventListener("message",G),()=>{window.removeEventListener("ppmap:filter",J),window.removeEventListener("message",G)}},[]),p.useEffect(()=>{const A=J=>{var fe;const G=(((fe=J.detail)==null?void 0:fe.name)||"").trim().toLowerCase();if(!G)return;const ne=s.dossiers.find(Re=>(Re.name||"").trim().toLowerCase()===G);ne&&c(a==="ops"?{type:"focus",id:ne.id}:{type:"popup",id:ne.id})};return window.addEventListener("ppmap:similar",A),()=>window.removeEventListener("ppmap:similar",A)});const bt=(A,J,G)=>{const ne=(G||(A==null?void 0:A.name)||J||"").trim();if(!P){k({kicker:ne});return}!ne||q||(S(!0),(async()=>{try{let fe=(J||ne).trim();const Re=((A==null?void 0:A.website)||(A==null?void 0:A.domain)||"").trim();if(!(/^https?:\/\//i.test(fe)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(fe)&&!/\s/.test(fe)))if(Re)fe=Re;else try{const De=await In(ne);if(De!=null&&De.website)fe=De.website;else if(((De==null?void 0:De.candidates)||[]).length===1)fe=De.candidates[0].url;else if(((De==null?void 0:De.candidates)||[]).length>1){K.current=[{name:ne,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(De.candidates||[]).slice(0,5)},...K.current].slice(0,8),I();return}}catch{}const Ve=await jo(Z,fe,"atelier2"),ht={name:Ve.company||ne,verdict:Ve.verdict,reason:Ve.reason||"",remaining:Ve.remaining??null};K.current=[ht,...K.current].slice(0,8),Ve.verdict==="kept"&&N(De=>({...De,kept:De.kept+1})),Ve.verdict==="ruled_out"&&N(De=>({...De,dropped:De.dropped+1}));const Xt=A||s.dossiers.find(De=>(De.name||"").toLowerCase()===ne.toLowerCase());Xt&&(Ve.verdict==="kept"?Xt.verdict=Xt.verdict||"MATCH":Ve.verdict==="ruled_out"&&(Xt.verdict="NO MATCH"),Ve.reason&&(Xt.reasoning=Ve.reason)),I()}finally{S(!1)}})())},Bt=A=>{if(!P){k({kicker:A.name});return}oe(A,"instant"),wt(Z,"fast_request",A.name||"",""),me(l.memoInstantSent(A.name))},$t=A=>Ne.current.get(A.id)??s.thumbs.get((A.name||"").trim().toLowerCase()),Pe=(A,J)=>c({type:"undoPush",entry:{id:A.id,name:A.name,prevCeoStatus:J}}),Ze=async(A,J,G)=>{const ne=A.ceoStatus||"";re.current.set(A.id,Date.now()),A.ceoStatus=J,I();const fe=await Za(Z,{status:J,airtable_id:A.airtableId,check_id:A.checkId,company:A.name,...(G==null?void 0:G.note)!==void 0?{note:G.note}:{},...G!=null&&G.via?{via:G.via}:{}});return fe.ok?fe.skipped?(A.ceoStatus=ne,I(),W(l.actNotPersisted),!1):((G==null?void 0:G.undo)!==!1&&Pe(A,ne),G!=null&&G.msg&&me(G.msg),(J==="Validé"||J==="Écarté")&&!A.ceoNote&&(G==null?void 0:G.note)===void 0&&F({o:A,yes:J==="Validé"}),!0):(A.ceoStatus=ne,I(),W(l.actErr),!1)},Ge=async(A,J)=>{const G=await Za(Z,{status:A.ceoStatus||"Retenu",airtable_id:A.airtableId,check_id:A.checkId,company:A.name,note:J,via:"note"});return!G.ok||G.skipped?(W(G.skipped?l.actNotPersisted:l.actErr),!1):(A.ceoNote=J,I(),!0)},mt=p.useRef(new Map),Et=A=>mt.current.has(A.id)?mt.current.get(A.id):s.stages.get((A.name||"").trim().toLowerCase()),qt=(A,J)=>{mt.current.set(A.id,J),I()},O=(A,J)=>{P&&Ze(A,J?"Validé":"Écarté",{msg:J?l.decidedYes(A.name):l.decidedNo(A.name)})},R=A=>{P&&Ze(A,"À trancher",{msg:l.promoted(A.name)})},_=A=>{P&&(async()=>{const J=A.ceoStatus||"";A.ceoStatus="Retenu",I();const G=await Za(Z,{status:"Retenu",check_id:A.checkId,company:A.name});if(!G.ok||G.skipped){A.ceoStatus=J,I(),W(G.skipped?l.actNotPersisted:l.actErr);return}Pe(A,J),me(l.repeched(A.name))})()},V=()=>{const A=h.undo[h.undo.length-1];if(!A){me(l.undoNone);return}const J=se.get(A.id);if(!J){c({type:"undoPop"}),me(l.undoNone);return}let G=A.prevCeoStatus;if(!G)if((J.verdict||"").toUpperCase().includes("CALL"))G="À trancher";else{me(l.undoLockedTitle);return}(async()=>await Ze(J,G,{undo:!1})&&(c({type:"undoPop"}),J.ceoStatus=A.prevCeoStatus,I(),me(l.undoDone(J.name))))()},ae=A=>{P&&(ce.current.add(A.id),I(),c({type:"approachOpen",id:A.id}),wt(Z,"approach",A.name||"","","",s.email||""))},re=p.useRef(new Map),je=p.useRef(!1),[Ae,de]=p.useState(0);p.useEffect(()=>{if(!Z||e||!P||je.current)return;je.current=!0;const A=new Date().toISOString().slice(0,10),J=s.email||"",G=`cbv_${Z}_${J}_${A}`,ne=`atl2:vue:${Z}:${A}`;try{if(localStorage.getItem(G)||localStorage.getItem(ne))return}catch{}wt(Z,"view","","","",J).then(fe=>{if(!fe.ok){je.current=!1;return}try{localStorage.setItem(G,"1")}catch{}})},[Z,e,P,s.email]),p.useEffect(()=>{if(!Z||!ye||e||!P||!s.generatedAt)return;let A=!0;const J=()=>{document.hidden||Zs(Z,s.generatedAt||"").then(ne=>{A&&de(ne)})};J();const G=window.setInterval(J,6e4);return()=>{A=!1,window.clearInterval(G)}},[Z,ye,e,s.generatedAt]);const He=(A,J)=>{P&&(async()=>{if(!(await wt(Z,J?"yes":"no",A.name||"",(A.ceoNote||"").slice(0,400),A.sector||"",s.email||"")).ok){W(l.actErr);return}Ne.current.set(A.id,J?"yes":"no"),I(),me(J?l.thumbUpDone:l.thumbDnDone),T({o:A,up:J})})()},jt=A=>{!P||!Vt(A)||(oe(A,"detailed"),wt(Z,"detailed_request",A.name||"","","",s.email||""),me(l.memoDeepSent(A.name)))},Tt=A=>{!P||!A.memoUrl||window.confirm(l.memoRegenAsk(A.name))&&(oe(A,"detailed"),wt(Z,"detailed_regen",A.name||"","","",s.email||""),me(l.memoDeepSent(A.name)))},xa=A=>{const J=new Set(s.favIds),G=J.has(A.id);G?J.delete(A.id):J.add(A.id),s.setFavIds(J),P&&el(Z,{id:A.id,co:A.name},G)},ft=()=>{!P||ee||window.confirm(l.identSyncConfirm)&&(C(!0),(async()=>{const A=await tl(Z);C(!1),A?me(l.identSyncDone):W(l.actErr)})())},Kn=/proplace/i.test(s.fund||""),Ai=A=>{!P||!Kn||(wt(Z,"onboard_request",A.name||"",""),me(l.onboardSent(A.name)))},qi={st:h,dispatch:c,t:l,lang:d,mode:ue,caps:be,pipe:ye,token:Z,fund:s.fund,email:s.email,criteria:s.criteria,source:a||"default",data:s,doRepeche:_,thumbOf:$t,canWrite:P,commitStatus:Ze,saveNote:Ge,stageOf:Et,setStage:qt,flashErr:W,startTour:()=>Y(!0),dossiers:s.dossiers,scopedAll:ve,scoped:Ee,counts:ge,byId:se,contName:At,favIds:s.favIds,toggleFav:xa,askEvaluate:bt,doAnalyse:Bt,doDecide:O,doPromote:R,doApproach:ae,doThumb:He,doDeep:jt,doRegen:Tt,doUndo:V,doSync:ft,doOnboard:Ai,outbound:Kn,memoQueued:H.current,liveMemos:{items:Q,serverOff:we,liveOf:ie},approachDone:ce.current,sessTally:j,evalCards:K.current,evalBusy:q,markRow:w,markedId:v,flash:me,focusExtra:u};p.useEffect(()=>{const A=J=>{J.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[]);const Ti=A=>Z?t.jsx(Wl,{token:Z,children:A}):t.jsx(t.Fragment,{children:A});return t.jsx(Si.Provider,{value:qi,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(Z?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Tl}),Ti(t.jsxs("div",{className:"app"+(ye?" pipe":"")+(Z?" has-thesis":""),children:[be.showTicker&&t.jsx(pt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(Z?" live-stack--cibles":""),children:[t.jsx(Zl,{}),!!Z&&t.jsx(Gl,{})]})}),be.showIdent&&t.jsx(pt,{name:"identite",children:t.jsx(dd,{})}),!1,Qc,be.showFunnel&&t.jsx(pt,{name:"entonnoir",children:t.jsx(Zc,{})}),t.jsx(pt,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(mi,{variant:h.mapFolded?"compact":"tabs"}),t.jsxs("div",{className:"stage"+(h.mapFolded?" folded":""),id:"atl2-stage",children:[!h.mapFolded&&a==="ops"&&t.jsx(Vc,{}),!h.mapFolded&&a!=="ops"&&(be.showFunnel||be.showIdent)&&t.jsxs("div",{className:"map-hud",children:[be.showFunnel&&t.jsx(Wc,{}),be.showIdent&&t.jsx(Yc,{})]}),!h.mapFolded&&t.jsx(sp,{}),t.jsx(ui,{compact:!!h.mapFolded})]})]})}),be.showDemand&&ye&&t.jsx(pt,{name:"direct",children:t.jsx(il,{items:Q,serverOff:we,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([A,J])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===A,onClick:()=>{m(A);try{localStorage.setItem("atl2:chrome-mode",A)}catch{}},children:J},A))}),be.showDemand&&t.jsx(pt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(vp,{})})}),be.showDemand&&h.memoConsole&&t.jsx(pt,{name:"console",children:t.jsx(yp,{})}),be.pipe&&!!Z&&t.jsx(pt,{name:"moteurs",children:t.jsx(vl,{})}),Ae>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:l.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{de(0),s.refresh()},children:l.freshGo})]}),t.jsx(pt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(dc,{})}),be.pipe&&!!Z&&t.jsx("p",{className:"privnote",children:l.privLink}),s.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),s.error&&!s.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:s.refresh,children:l.retry})]})]})),h.popupId&&h.dens!=="liste"&&a!=="ops"&&t.jsx(pt,{name:"fiche",children:t.jsx(Wp,{})}),t.jsx(pt,{name:"modales",children:t.jsx(xc,{})}),t.jsx(Ws,{}),x&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:x.o.name}),t.jsx(Tr,{placeholder:x.up?l.thumbWhyUpPh:l.thumbWhyDnPh,onDone:A=>{const J=x.o;T(null),A&&wt(Z,"note",J.name||"",A,J.sector||"",s.email||"").then(G=>{G.ok&&me(l.csNoteSaved)})}})]}),U&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:U.o.name}),t.jsx(Tr,{placeholder:U.yes?l.whyYesPh:l.whyNoPh,onDone:A=>{const J=U.o;F(null),A&&Ge(J,A).then(G=>{G&&me(l.csNoteSaved)})}})]}),D&&Ce&&t.jsx(sd,{steps:Xc(l,Je,at,Xe,nt,ge[3]||0,ge[4]||0,ge),onClose:()=>{Y(!1),xo(Z)}}),t.jsx(Kc,{}),be.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:To,children:qo}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),L&&t.jsx("div",{className:"flash on"+(M?" err":""),children:L}),E&&t.jsx(Gs,{variant:"acquirer",initialCompany:bo().co,initialWebsite:bo().site,onClose:()=>k(null)})]})})}function Zc(){const{t:e}=X(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function bo(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function eu(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Ci as FlagCell,Ct as SigBadge,Qa as SigWin,nu as default,eu as fmtShort,X as useV2};
