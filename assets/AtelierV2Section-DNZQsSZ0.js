...
.atl2 .bulk .side .hint{white-space:nowrap}`,Ca=`
...
`,Sa=Na+Ca;function za(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function Ea(t,a){return t||a.mode!=="client"||!a.token?"visiteur":za("teaser")==="1"?"apercu":"client"}const Ta={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},Aa=t=>Ta[t],fe=t=>Object.assign(t,{continent:ea(t.cc)});function Ie(t){const a=new Set,n=[];for(const r of t){const o=(r.name||"").toLowerCase();!o||a.has(o)||(a.add(o),n.push(r))}return n}const Oa=60*60*1e3;function La(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Oa?null:a}catch{return null}}function Te(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Fa=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function Ma(t,a,n="default"){const r=n!=="default",o=u.useMemo(()=>t||r?{mode:"anon"}:Gt(),[t,r]),i=u.useMemo(()=>r?"visiteur":Ea(t,o),[t,o,r]),s=u.useMemo(()=>Aa(i),[i]),c=i!=="visiteur",p=Fa(n),[d,x]=u.useState([]),[l,v]=u.useState(""),[b,m]=u.useState(null),[h,g]=u.useState(null),[f,N]=u.useState(()=>new Map),[k,j]=u.useState(()=>new Map),[C,A]=u.useState(""),[F,w]=u.useState(new Set),[S,P]=u.useState(null),[O,R]=u.useState(!0),[M,z]=u.useState(!1),[B,I]=u.useState(0),[_,ae]=u.useState(0),de=u.useRef(0),$=u.useMemo(()=>{var q;if(i!=="client")return"";try{return((q=Wt())==null?void 0:q.email)||""}catch{return""}},[i]);u.useEffect(()=>{const q=++de.current;let V=!0;const D=()=>V&&q===de.current,W=(c&&o.token?o.token:"pub:"+a)+(p?":"+p:""),te=La(W);return te?(x(te.objs.map(fe)),te.fund&&v(te.fund),m(te.marketEstimate??null),g(te.criteria??null),A(te.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(n==="ops"){const X=await De(),Z=((X==null?void 0:X.recent_ops)||[]).map(ee=>qe(ee,a)).filter(ee=>!!ee);if(!D())return;x(Z.map(fe)),Te(W,{objs:Z})}else if(typeof n=="object"){const Z=(await Je()||[]).filter(K=>(K.slug||"")===n.research).map(K=>Xe(K,a)).filter(K=>!!K),ee=Ie(await Ze(Z,a));if(!D())return;x(ee.map(fe)),Te(W,{objs:ee})}else if(c&&o.token){const X=Kt(o.token),Z=De(),ee=Qt(o.token),K=Jt(o.token),xe=Xt(o.token),U=await X;let ne=U?U.targets:[];D()&&U&&(v(U.fund||""),m(U.marketEstimate??null),g(U.criteria??null),A(U.generatedAt||""),x(ne.map(fe)),R(!1),z(!1));const[ce,we,pe,G]=await Promise.all([Z,ee,K,xe]),Se=((ce==null?void 0:ce.recent_ops)||[]).map(le=>qe(le,a)).filter(le=>!!le);if(ne=[...ne,...Se],!D())return;x(ne.map(fe));const me=new Set;for(const le of we){const ge=(le.id||le.co||"").toString().trim().toLowerCase();ge&&me.add(ge.startsWith("t:")?ge:"t:"+ge)}w(me),N(pe),j(G),U&&Te(W,{fund:U.fund,marketEstimate:U.marketEstimate,criteria:U.criteria,generatedAt:U.generatedAt,objs:ne})}else{const X=Zt(),Z=Je(),ee=De(),K=await X;D()&&K.length&&(x(Ie(K).map(fe)),R(!1),z(!1));const[xe,U]=await Promise.all([Z,ee]),ne=(xe||[]).map(G=>Xe(G,a)).filter(G=>!!G),ce=await Ze(ne,a),we=((U==null?void 0:U.recent_ops)||[]).map(G=>qe(G,a)).filter(G=>!!G),pe=Ie([...K,...ce,...we]);if(!D())return;x(pe.map(fe)),Te(W,{objs:pe})}D()&&z(!1)}catch{D()&&!te&&z(!0)}finally{D()&&R(!1)}})(),()=>{V=!1}},[c,o.token,a,B,p]),u.useEffect(()=>{if(!s.showCredits||!$){P(null);return}let q=!0;return(async()=>{try{const V=await fetch(`${$e}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:$})});if(!V.ok)return;const D=await V.json();q&&D&&D.ok!==!1&&P(D)}catch{}})(),()=>{q=!1}},[s.showCredits,$,_]);const ie=u.useCallback(q=>w(new Set(q)),[]);return{session:o,mode:i,caps:s,fund:l,email:$,marketEstimate:b,generatedAt:C,criteria:h,thumbs:f,stages:k,dossiers:d,favIds:F,setFavIds:ie,credits:S,reloadCredits:()=>ae(q=>q+1),loading:O,error:M,refresh:()=>I(q=>q+1)}}const Ct=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Ra=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...Ct(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Da(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(o=>o!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(o=>o!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Ct(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Le)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Le=60;function Ye(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!Y(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(Ve(t)))return!1;if(r!=="win"&&a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(be(t.date)>o)return!1}if(r!=="status"&&!n&&a.status!=="all"&&se(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(o))return!1}return!0}function St(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:Ye(t,a.filters,n)}function qa(t,a,n,r){return!(!St(t,a,n)||n&&!ta(t,a.ptab,r))}function Ge(t,a){const n=a.key,r=o=>{switch(n){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-be(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"signal":{const i=Y(o);return i?100-(i.left??0):-1}}};return[...t].sort((o,i)=>{const s=r(o),c=r(i);return s<c?-a.dir:s>c?a.dir:(o.name||"").localeCompare(i.name||"")})}function Ba(){const{dossiers:t,st:a,t:n,dispatch:r,contName:o,pipe:i}=T(),s=u.useMemo(()=>{const p=l=>i?!0:l.continent===a.continent,d=t.filter(l=>p(l)&&Y(l)),x=t.filter(l=>p(l)&&l.kind==="op"&&!Y(l)&&(l.dealKind==="ma"||l.dealKind==="levee")&&be(l.date)<=2);return x.sort((l,v)=>(v.amountEur||0)-(l.amountEur||0)),[...Ge(d,{key:"signal",dir:-1}),...x].slice(0,40)},[t,a.continent,i]),c=p=>s.map(d=>e.jsxs("button",{type:"button",className:"tk"+(Q(d)?" spent":""),onClick:x=>{const l=x.currentTarget.getBoundingClientRect();r({type:"popup",id:d.id,anchor:{x:l.left+l.width/2,y:l.bottom}})},title:d.name+(d.tagline?" — "+d.tagline:""),children:[e.jsx(ye,{o:d}),e.jsxs("span",{className:"who",children:[e.jsx(At,{o:d}),e.jsx("span",{className:"co",children:d.name})]}),typeof d.amountEur=="number"&&d.amountEur>0&&e.jsx("span",{className:"am",children:Ur(d.amountEur)}),d.sector&&e.jsx("span",{className:"mt",children:d.sector}),e.jsx(Re,{o:d}),e.jsx("span",{className:"tkgo",children:"→"})]},p+(d.id||d.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:s.length})]}),e.jsx("div",{className:"win",children:s.length?e.jsxs("div",{className:"run",children:[c(0),c(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(o)})})})]})}const Ia="aDx8z7Hzksus",zt="+33 6 83 10 72 86",lt="alexandre@proplace.co",Pa=`tel:${zt.replace(/[^\d+]/g,"")}`,st="pp-rdv-slot";function $a(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Va(){const{t,caps:a,fund:n}=T(),r=a.showOnb,o=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:_a}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:Pa,children:zt}),t.rdvSubMid,e.jsx("a",{href:`mailto:${lt}`,children:lt})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(o).map(([i,s],c)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(c+1)}),e.jsx("b",{children:i}),e.jsx("span",{children:s})]},i))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(ya,{filloutId:Ia,parameters:n?{company_name:n}:void 0})})]})}function Ua(){const[t,a]=u.useState(()=>typeof document>"u"?null:document.getElementById(st));return u.useEffect(()=>{t||a(document.getElementById(st))},[t]),t?Ce.createPortal(e.jsx(Va,{}),t):null}const _a=`
...
`,Ha=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Ya({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:o}=T(),[i,s]=u.useState(""),[c,p]=u.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const d=(t.ceoStatus||"").trim(),x=(Me(t)||"").startsWith("CALL")&&J(t)===3,l=J(t)>=2,v=async m=>{if(i||m==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(m);const h=await o(t,m);s(""),h&&(p(!0),setTimeout(()=>p(!1),2200))},b=x?[["Validé",a.csYes],["Écarté",a.csNo]]:Ha.filter(([m])=>!(l&&m==="Retenu")).map(([m,h])=>[m,a[h]]);return e.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,h])=>e.jsx("button",{type:"button",className:"csb"+(d===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{v(m)},children:h},m)),c&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(Ga,{o:t})]})}function Ga({o:t}){const{t:a,saveNote:n,flash:r}=T(),[o,i]=u.useState(t.ceoNote||""),[s,c]=u.useState(!1),[p,d]=u.useState(!1),x=o.trim()!==(t.ceoNote||"").trim(),l=async()=>{if(s||!x)return;c(!0);const v=await n(t,o.trim());c(!1),v&&(d(!0),setTimeout(()=>d(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:s,onChange:v=>i(v.target.value),onKeyDown:v=>{v.key==="Enter"&&l()}}),e.jsx("button",{type:"button",disabled:s||!x,onClick:()=>{l()},children:p?a.csNoteSaved:a.csNoteOk})]})}function Wa({placeholder:t,onDone:a}){const{t:n}=T(),[r,o]=u.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(r.trim()),i.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Ka({o:t}){var g;const{t:a,token:n,caps:r,canWrite:o,stageOf:i,setStage:s,flashErr:c}=T(),[p,d]=u.useState(!1);if(!r.pipe||!o||r.lockActions||J(t)!==4)return null;const x=i(t),l=(x==null?void 0:x.stage)||"todo",v=async f=>{if(p||f===l)return;d(!0);const N=x;s(t,{stage:f,stamps:(x==null?void 0:x.stamps)||{}});const k=Math.max(Date.now(),dt+=1);dt=k;const j=await aa(n,{company:t.name||"",stage:f,cts:k,deal_id:t.airtableId,check_id:t.checkId});d(!1),!j.stale&&(j.ok||(s(t,N),c(a.actErr)))},b=(g=x==null?void 0:x.stamps)==null?void 0:g.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,h=l==="sent"&&b&&m>=4;return e.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,N])=>e.jsx("button",{type:"button",className:"stgb"+(l===f?" on":""),disabled:p,onClick:()=>{v(f)},children:N},f)),h&&e.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let dt=0;const Ae=8,Oe=340;function ct({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function Qa({steps:t,onClose:a}){const{t:n,dispatch:r,counts:o,scoped:i,byId:s,st:c}=T(),[p,d]=u.useState(0),[x,l]=u.useState(null),[v,b]=u.useState([]),m=u.useRef(!1);u.useEffect(()=>{m.current||(m.current=!0,b(t.filter(C=>!!document.querySelector(C.need||C.sel))))},[t]);const h=v[p],g=p>=v.length;u.useEffect(()=>{h&&(h.ptab!==void 0&&c.ptab!==h.ptab&&r({type:"ptab",tab:h.ptab}),h.dens&&c.dens!==h.dens&&r({type:"dens",dens:h.dens}))},[p,h]);const f=u.useCallback(()=>{if(!h){l(null);return}const C=document.querySelector(h.sel);if(!C){l(null);return}C.scrollIntoView({block:"nearest",behavior:"smooth"}),l(C.getBoundingClientRect())},[h]);u.useLayoutEffect(()=>{f();const C=window.setTimeout(f,260),A=()=>f();return window.addEventListener("scroll",A,!0),window.addEventListener("resize",A),()=>{window.clearTimeout(C),window.removeEventListener("scroll",A,!0),window.removeEventListener("resize",A)}},[f]);const N=u.useRef(a);if(N.current=a,u.useEffect(()=>{const C=A=>{A.key==="Escape"?(A.preventDefault(),A.stopPropagation(),N.current()):A.key==="ArrowRight"?d(F=>F+1):A.key==="ArrowLeft"&&d(F=>Math.max(0,F-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!v.length)return null;let k=null;if(g){const C=o[3]||0,A=i.find(F=>F.memoUrl)||[...s.values()].find(F=>F.memoUrl);C>0?k={title:C===1?n.ahaATitle1:n.ahaATitleN(C),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:A?k={title:n.ahaBTitle,body:n.ahaBBody(A.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:A.id}),a()}}:k={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let j={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Oe};if(!g&&x){const C=x.bottom+14,F=window.innerHeight-C>190?C:Math.max(12,x.top-200);j={left:Math.min(Math.max(12,x.left+x.width/2-Oe/2),window.innerWidth-Oe-12),top:F,width:Oe}}return Ce.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!g&&x&&e.jsx("div",{className:"tour-hole",style:{left:x.left-Ae,top:x.top-Ae,width:x.width+Ae*2,height:x.height+Ae*2}}),(g||!x)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(g?" fin":""),style:j,children:[g&&k?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:k.title}),e.jsx("p",{children:e.jsx(ct,{text:k.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>d(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(p+1,v.length)}),e.jsx("h3",{children:h==null?void 0:h.title}),e.jsx("p",{children:e.jsx(ct,{text:(h==null?void 0:h.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:p===0,onClick:()=>d(C=>Math.max(0,C-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>d(C=>C+1),children:p===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Ja(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:o}=T(),i=u.useMemo(()=>t.filter(l=>be(l.date)===0&&l.kind==="target"),[t]),s=u.useMemo(()=>i.filter(l=>a?J(l)===0:!Q(l)),[i,a]),c=i.length-s.length,p=i.length?Math.min(100,c/i.length*100):100;let d;a?d=n.morningThesis(i.length,c,s.length):i.length?c===0?d=n.goalSourced(i.length):c>=i.length?d=n.goalCleared:d=n.goalDone(c,i.length):d=n.goalSourced(0);const x=()=>{a?(o({type:"ptab",tab:0}),o({type:"filters",patch:{win:"1"}})):o({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:d}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:p+"%"}})}),s.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:x,children:a?n.morningEval(s.length):r.pileMode?n.goalContinue(s.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Xa(){var P;const{t,st:a,dispatch:n,token:r,fund:o,data:i,dossiers:s,mode:c,doSync:p,startTour:d}=T(),[x,l]=u.useState(null),[v,b]=u.useState([]),[m,h]=u.useState(!1),g=c==="client";u.useEffect(()=>{if(!r||!o)return;let O=!0;return(async()=>{const[R,M]=await Promise.all([vt(o),yt(r)]);O&&(R&&l(R),b(M))})(),()=>{O=!1}},[r,o]);const f=(x==null?void 0:x.per_day)??null,N=((P=x==null?void 0:x.pool_order)==null?void 0:P.length)??0,k=v.filter(O=>O.status==="running").length,j=O=>{if(!g||f===null||m)return;const R=Math.max(0,Math.min(10,f+O));R!==f&&(h(!0),l(M=>M&&{...M,per_day:R}),wt(r,R).then(M=>{h(!1),l(M===null?z=>z&&{...z,per_day:f}:z=>z&&{...z,per_day:M})}))},C=u.useMemo(()=>s.filter(O=>O.kind==="target"&&Q(O)).length,[s]),A=i.marketEstimate,F=A&&A>0?Math.min(100,Math.round(C/A*100)):null,w=(o||"P").split(/\s+/).map(O=>O[0]).join("").slice(0,2).toUpperCase(),S=(()=>{const O=Date.parse(i.generatedAt||"");if(Number.isNaN(O))return"";const R=new Date(O),M=z=>String(z).padStart(2,"0");return`${M(R.getDate())}/${M(R.getMonth()+1)} à ${M(R.getHours())}:${M(R.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:w}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),S&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(S)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:d,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[F!==null&&A&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:F+"%"}})}),e.jsxs("b",{children:[F," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(C,A)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),f!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),j(-1)},children:"−"}),e.jsx("b",{className:"q",children:f})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),j(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),f===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),k>0&&e.jsxs("span",{className:"ev",children:["⏳ ",k]}),e.jsx("span",{className:"ego",children:t.identPending(N)})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!g,onClick:p,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:O=>n({type:"filters",patch:{search:O.target.value}})})]})]})]})}function Za(){const{t,counts:a,dispatch:n}=T();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,o],i)=>{const s=i===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(s?" go":""),children:[e.jsx("span",{className:"s4n",children:i+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:o}),s&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},i)})})]})}const er=["--p0","--p1","--p2","--p3","--p4"];function tr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:o}=T(),i=u.useRef({});u.useEffect(()=>{i.current={...n}},[n]);const s=d=>{const x=i.current[d],l=x!==void 0?n[d]-x:0;return e.jsxs("button",{type:"button",className:"step"+(d===3&&n[3]>0?" wait":""),style:{"--c":`var(${er[d]})`,"--tc":d<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===d,title:r.phelp[d],onClick:()=>a({type:"ptab",tab:d}),children:[e.jsxs("span",{className:"l",children:[r.plabels[d].toUpperCase(),d===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(l>0?" up":l<0?" down":""),children:[n[d],l!==0&&e.jsxs("em",{className:"delta",children:[l>0?"+":"−",Math.abs(l)]})]})]},d)},c=(d,x,l)=>e.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":d===5?"var(--p5)":d===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===d,title:r.phelp[d],onClick:()=>a({type:"ptab",tab:d}),children:[e.jsx("span",{className:"l",children:l.toUpperCase()}),e.jsx("span",{className:"n",children:n[d]})]},d),p=(d,x,l,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:x,disabled:v,onClick:l,children:d},x);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(s)}),e.jsxs("div",{className:"offtrack",children:[c(5,!1,r.plabels[5]),c(7,!0,r.plabels[7]),c(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[p("↩",r.toolUndo,o,t.undo.length===0),p("↺",r.toolReset,()=>{a({type:"reset"})}),p("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),p("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const ar=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function rr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:o,doAnalyse:i,mode:s}=T(),c=u.useRef(null),[p,d]=u.useState(60);u.useEffect(()=>{let b=0;const m=()=>{var k;const h=c.current;if(!h)return;const g=(k=h.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!g)return;const f=g.getBoundingClientRect(),N=h.getBoundingClientRect();d(Math.max(20,Math.min(f.left+f.width/2-N.left,N.width-30)))};return b=requestAnimationFrame(m),window.addEventListener("resize",m),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",m)}},[t.ptab]);const x=t.ptab;let l=n.tuto[x].p;if(x===3){const b=r.filter(g=>g.kind==="target"&&J(g)===3),m=b.filter(g=>Pe(g)==="auto").length,h=b.filter(g=>Pe(g)==="cd").length;l=n.tutoPending(m,h,b.length)}const v=(()=>{if(s!=="client")return null;if(x===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(x===1){const b=r.filter(m=>m.kind==="target"&&J(m)===1&&!o.has(m.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(m=>i(m))}}return null})();return e.jsxs("div",{ref:c,className:"tuto mini",style:{"--bg":ar[x],"--ax":p+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[x].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:l}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const pt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function ut(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function nr(t,a){const[n,r]=u.useState(1);return u.useEffect(()=>{let o=!0,i=0;const s=()=>{var d;if(!o)return;const p=(d=t.current)==null?void 0:d.getScreenCTM();p&&p.a>0?r(p.a):i=requestAnimationFrame(s)};s();const c=new ResizeObserver(()=>s());return t.current&&c.observe(t.current),window.addEventListener("resize",s),()=>{o=!1,cancelAnimationFrame(i),c.disconnect(),window.removeEventListener("resize",s)}},[t,a]),n}function or(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:o,markedId:i,byId:s,lang:c,t:p}=T(),d=u.useRef(null),x=u.useRef(null),l=Ue.find(w=>w.key===t.continent),v=nr(d,t.continent+":"+t.mapFolded),[b,m]=u.useState(new Map),[h,g]=u.useState(null);u.useEffect(()=>{const w=d.current;if(!w)return;const S=new Map;w.querySelectorAll("path[data-i2]").forEach(P=>{const O=P.dataset.i2;if(O)try{const R=P.getBBox();R.width>0&&S.set(O,{x:R.x,y:R.y,w:R.width,h:R.height})}catch{}}),m(S)},[t.continent,v]);const f=u.useMemo(()=>n.filter(w=>w.cc),[n]),N=u.useMemo(()=>{const w=new Map;return f.forEach(S=>w.set(S.cc,(w.get(S.cc)||0)+1)),w},[f]),k=u.useMemo(()=>f.map(w=>{const S=w.cc?b.get(w.cc):void 0;if(!S)return null;const P=ut(w.name||w.id||""),O=ut((w.id||w.name||"")+"·y"),R=(P-.5)*Math.min(S.w*.55,60),M=(O-.5)*Math.min(S.h*.55,60);return{d:w,x:S.x+S.w/2+R,y:S.y+S.h/2+M}}).filter(w=>!!w),[f,b]),j=w=>v>0?w/v:w,C=u.useMemo(()=>r?[0,1,2,3,4,5].map(w=>({c:pt[w],fr:p.plabels[w].toUpperCase(),en:p.plabels[w].toUpperCase(),n:n.filter(S=>S.kind==="target"&&J(S)===w).length})).filter(w=>w.n>0):et.map((w,S)=>({...w,n:n.filter(P=>tt(P)===S).length})),[n,r,p.plabels]),A=i?s.get(i):null,F=A?k.find(w=>w.d.id===A.id):null;return e.jsxs("div",{className:"mapzone",ref:x,children:[e.jsxs("svg",{ref:d,viewBox:l.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":c==="fr"?l.fr:l.en,onMouseLeave:()=>{g(null),o(null)},children:[e.jsx("g",{children:l.countries.map((w,S)=>e.jsx("g",{className:"ct"+(w.i2&&N.get(w.i2)?"":" empty"),children:e.jsx("path",{d:w.d,"data-i2":w.i2||void 0})},S))}),e.jsx("g",{children:k.map(w=>{const S=et[tt(w.d)],P=!!Y(w.d),O=w.d.kind==="target",R=r&&O?pt[J(w.d)]:S.c,M=!r&&Q(w.d);return e.jsxs("g",{className:"co"+(M?" done":""),onMouseEnter:()=>{var I,_;const z=(I=x.current)==null?void 0:I.getBoundingClientRect(),B=(_=d.current)==null?void 0:_.createSVGPoint();if(B&&d.current&&z){B.x=w.x,B.y=w.y;const ae=B.matrixTransform(d.current.getScreenCTM());g({x:ae.x-z.left,y:ae.y-z.top,label:w.d.name+" · "+(ve(w.d.cc,c)||w.d.countryLabel||"")})}o(w.d.id)},onMouseLeave:()=>{g(null),o(null)},onClick:()=>{var I;const z=(I=d.current)==null?void 0:I.createSVGPoint();let B=null;if(z&&d.current){z.x=w.x,z.y=w.y;const _=z.matrixTransform(d.current.getScreenCTM());B={x:_.x,y:_.y}}a({type:"popup",id:w.d.id,anchor:B})},children:[e.jsx("circle",{className:"h",cx:w.x,cy:w.y,r:j(Math.max(11,S.px+7))}),e.jsx("circle",{className:"v",cx:w.x,cy:w.y,r:j(S.px),fill:R,stroke:P?"#DC2626":"#ffffff",strokeWidth:j(P?2.2:1.3)})]},w.d.id||w.d.name)})}),F&&e.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:j(13),fill:"none",stroke:"#0F172A",strokeWidth:j(2)})]}),e.jsx("div",{className:"hov"+(h?" on":""),style:h?{left:h.x,top:h.y}:void 0,children:h==null?void 0:h.label}),e.jsx("div",{className:"legend",children:C.map((w,S)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":w.c}}),c==="fr"?w.fr:w.en," ",e.jsx("b",{children:w.n})]},S))}),n.some(w=>!w.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",p.notLocated," ",e.jsx("b",{children:n.filter(w=>!w.cc).length})]})})]})}function ir(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:o,contName:i}=T(),s=t.filters,c=u.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),p=b=>c.filter(m=>b!=="country"&&s.country.length&&!s.country.includes(m.cc||"")?!1:Ye(m,s,o,b==="country"?void 0:b)),d=u.useMemo(()=>{const b=p("win"),m=h=>b.filter(g=>(g.date?Math.max(0,Math.floor((Date.now()-Date.parse(g.date))/864e5)):9999)<=h).length;return[m(0),m(7),m(30),b.length]},[c,s,o]),x=u.useMemo(()=>{if(o)return null;const b=p("status"),m={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(h=>{m[se(h)]+=1}),m},[c,s,o]),l=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.win!=="all"?1:0)+(!o&&s.status!=="all"?1:0)+(s.search.trim()?1:0),v=(b,m,h,g="fbtn")=>e.jsxs("button",{type:"button",className:g,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:m}),h>0&&e.jsx("span",{className:"n",children:h}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,m)=>e.jsxs("button",{type:"button","aria-pressed":s.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[m],e.jsx("b",{children:d[m]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:s.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!o&&x&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,m])=>e.jsxs("button",{type:"button","aria-pressed":s.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[m,e.jsx("b",{children:x[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),s.signalOnly&&e.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,s.sector.length),v("pay",r.fCountry,s.country.length),v("det",r.fEngine,s.engine.length),v("sta",r.fStage,s.stage.length),o&&v("ang","Angle",s.angle.length),o&&v("mem","Mémo",s.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),l>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(c.length,i),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(l)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(lr,{poolFor:p})]})}function lr({poolFor:t}){const{st:a,dispatch:n,t:r,lang:o}=T(),i=a.filters,s=a.openFacet,{title:c,cols:p,options:d}=u.useMemo(()=>{if(s==="sig"){const m=t("signal").filter(f=>Y(f)),h=new Map;m.forEach(f=>{const N=f.engine||"";h.set(N,(h.get(N)||0)+1)});const g=[{v:"*",label:r.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...at([...h.keys()],o).map(f=>({v:f,label:he(f)+" "+oe(f,o),n:h.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:r.fpSigTitle,cols:2,options:g}}if(s==="sec"){const m=t("sector"),h=new Map;return m.forEach(g=>{g.sector&&h.set(g.sector,(h.get(g.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...h.entries()].sort((g,f)=>f[1]-g[1]).map(([g,f])=>({v:g,label:g,n:f,html:!1,on:i.sector.includes(g)}))}}if(s==="pay"){const m=t("country"),h=new Map;return m.forEach(g=>{g.cc&&h.set(g.cc,(h.get(g.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...h.entries()].sort((g,f)=>f[1]-g[1]).map(([g,f])=>({v:g,label:ve(g,o)||g,n:f,html:!1,on:i.country.includes(g)}))}}if(s==="det"){const m=t("engine"),h=new Map;return m.forEach(g=>{g.engine&&h.set(g.engine,(h.get(g.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:at([...h.keys()],o).map(g=>({v:g,label:he(g)+" "+oe(g,o)+' <span style="color:var(--dim);font-size:10px">· '+ra(na(g),o)+"</span>",n:h.get(g)||0,html:!0,on:i.engine.includes(g)}))}}if(s==="ang"){const m=t("angle"),h=new Map;return m.forEach(g=>{g.angle&&h.set(g.angle,(h.get(g.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...h.entries()].sort((g,f)=>f[1]-g[1]).map(([g,f])=>({v:g,label:g.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(g)}))}}if(s==="mem"){const m=t("memoLevel"),h=new Map;m.forEach(f=>{if(f.kind==="target"){const N=Ve(f);h.set(N,(h.get(N)||0)+1)}});const g=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:g[f],n:h.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const v=t("stage"),b=new Map;return v.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,h)=>h[1]-m[1]).map(([m,h])=>({v:m,label:m,n:h,html:!1,on:i.stage.includes(m)}))}},[s,a,o]),x=v=>{if(s==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(v)?i.signalEngines.filter(h=>h!==v):[...i.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(s==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:v})},l=()=>{n(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:c}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:l,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(p===2?" two":""),children:d.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>x(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const ft=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function sr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:o,dispatch:i,evalBusy:s,evalCards:c,caps:p,data:d}=T(),x=a==="client",[l,v]=u.useState(""),[b,m]=u.useState(!1),[h,g]=u.useState(""),[f,N]=u.useState(!1),[k,j]=u.useState(""),[C,A]=u.useState([]),F=u.useRef(!1),w=l.trim()?ft.test(l.trim())?t.evalUrl:t.evalName:t.evalWaiting,S=u.useMemo(()=>h.split(`
`).map(z=>z.trim()).filter(Boolean).slice(0,15),[h]),P=C.length?C:c,O=d.credits,R=()=>{const z=l.trim();z&&(r(null,z),v(""))},M=async()=>{if(!x){r(null,S[0]||"");return}if(!S.length||f)return;N(!0),F.current=!1;const z=[];for(let B=0;B<S.length&&!F.current;B++){j(t.evaluating(B+1,S.length,S[B]));const I=await kt(n,S[B],"atelier2");if(z.unshift({name:I.company||S[B],verdict:I.verdict,reason:I.reason||"",remaining:I.remaining??null}),A([...z]),I.verdict==="quota"){z.unshift({name:"",verdict:"quota",reason:t.quota(S.length-B-1),remaining:0}),A([...z]);break}}j(""),g(""),N(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:l,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:z=>v(z.target.value),onKeyDown:z=>{z.key==="Enter"&&R()}}),e.jsx("span",{className:"detect"+(ft.test(l.trim())?" url":""),children:w})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:R,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),p.showCredits&&O&&e.jsxs("button",{type:"button",className:"credits"+(O.total_available<=0&&!O.unlimited?" empty":""),onClick:()=>i({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:O.unlimited?"∞":O.total_available}),!O.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",O.daily_grant+O.purchased]}),O.total_available<=0&&!O.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>m(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:h,placeholder:t.bulkPh,onChange:z=>g(z.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{justifyContent:"center"},disabled:f||!S.length,onClick:()=>{M()},children:[e.jsx("span",{className:"fill"}),f&&k?k:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(S.length)})]})]}),P.slice(0,1).map((z,B)=>{const I=z.verdict==="kept",_=z.verdict==="quota",ae=I?"var(--brand)":_?"var(--bolt)":"var(--red)",de=I?"var(--brand-l)":_?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":ae,"--bgc":de},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:I?"✓ "+t.kept:_?"⏳":"✗ "+t.dropped})}),z.name&&e.jsx("span",{className:"rn",children:z.name}),e.jsx("span",{className:"rr",children:z.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",z.reason]}):null}),!_&&e.jsx("button",{type:"button",className:"go",onClick:()=>i({type:"modal",modal:"space"}),children:t.seeSpace(I?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},B)}),x&&(o.kept+o.dropped>0||P.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(o.kept,o.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>i({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function dr(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function cr(){const{st:t,dispatch:a,byId:n,t:r,doDeep:o}=T(),i=t.memoConsole?n.get(t.memoConsole):null,s=u.useMemo(()=>i?[i.reasoning||"",dr(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const c=Me(i),p=Ve(i);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:i.name}),c&&e.jsx("span",{className:"vv",children:c}),typeof i.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:r.memoSynth})}),e.jsx("div",{className:"mb2",children:s?s.split(`

`).map((d,x)=>e.jsx("p",{style:{margin:"0 0 10px"},children:d},x)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[_e(i)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:p===2?r.critMemoKinds:""}),i.memoUrl&&e.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}const Et={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function We({o:t}){const{t:a}=T(),n=Fe(t),r=Me(t),o=J(t),i=Pe(t),s=oa(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(Et[r]||"v-cons"),title:a.vt[r],children:r}):o===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,o===3&&i==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),o===3&&i==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),o===3&&s!==null&&e.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:a.waitTitle(s),children:a.waitChip(s)})]})}function xt({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:o}=T(),[i,s]=u.useState(!1);if(u.useEffect(()=>{r||s(!1)},[r]),Q(t)){const d=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":d?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[d?"✓":"✗"," ",e.jsx("b",{children:d?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const p=i&&r;return e.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:r,onClick:d=>{d.stopPropagation(),s(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function pr({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:o,doAnalyse:i,doDecide:s,doPromote:c,doRepeche:p,doApproach:d,dispatch:x}=T();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),x({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(xt,{o:t})});const l=J(t),v=b=>m=>{m.stopPropagation(),b()};if(l===0)return e.jsx("span",{className:"cell",children:e.jsx(xt,{o:t})});if(l===1){const b=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:v(()=>i(t)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(l===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:v(()=>s(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:v(()=>s(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>x({type:"memoConsole",id:t.id})),children:"📄"})]})});if(l===4){const b=o.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:b,onClick:v(()=>d(t)),children:b?a.actApproachSent:a.actApproach})})}return l===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>c(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>x({type:"memoConsole",id:t.id})),children:"📄"})]})}):l===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>p(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>x({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:v(()=>x({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function ur({o:t}){const{t:a,doThumb:n,thumbOf:r}=T(),o=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),n(t,!1)},children:"👎"})]})}function fr({o:t}){const{lang:a}=T();return Y(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(ye,{o:t}),e.jsx(Re,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[he(t.engine||"")," ",oe(t.engine||"",a)]})})}function xr({o:t,locked:a,open:n,onToggle:r}){const{st:o,dispatch:i,caps:s,markRow:c,markedId:p,favIds:d,toggleFav:x}=T(),l=J(t),v=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,m=b<=0?0:b<=7?1:b<=30?2:3,h=s.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][l]:v[m],g=d.has(t.id),f=N=>{if(a)return;if(s.pipe){r();return}const k=N.currentTarget.getBoundingClientRect();i({type:"popup",id:t.id,anchor:{x:k.left+Math.min(280,k.width/3),y:k.bottom}})};return e.jsxs(u.Fragment,{children:[e.jsxs("div",{className:"row"+(p===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>c(t.id),onMouseLeave:()=>c(null),onClick:f,children:[e.jsx("span",{className:"pt",style:{"--c":h}}),e.jsx(At,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[s.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:g?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),x(t)},children:g?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(N=>N&&N!==t.name)||""})]}),e.jsx(mr,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(fr,{o:t}),s.pipe&&e.jsx(We,{o:t}),s.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(pr,{o:t}),s.showThumbs&&e.jsx(ur,{o:t})]}),(n||o.dens==="deplie")&&!a&&e.jsx(gr,{o:t})]})}function mr({o:t}){const{lang:a,caps:n}=T();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=He(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function gr({o:t}){const{t:a,lang:n,dispatch:r,caps:o,outbound:i,doOnboard:s}=T();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),t.reasoning&&e.jsxs("div",{className:"dec"+(Fe(t)==="NO MATCH"?" out":""),title:t.reasoning,children:[e.jsx("em",{children:Fe(t)==="NO MATCH"?a.vOut:a.vKept}),t.reasoning.length>340?`${t.reasoning.slice(0,340)}…`:t.reasoning]}),t.ceoNote&&e.jsxs("div",{className:"ceonote",children:["💬 ",e.jsx("i",{children:t.ceoNote})]}),e.jsx(Ya,{o:t}),e.jsx(Ka,{o:t}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(We,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[he(t.engine||"")," ",oe(t.engine||"",n)]}),Y(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(ye,{o:t})})]}),o.pipe&&(t.memoUrl||i)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),i&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(t),children:a.actOnboard})]})]})]})}function hr({o:t,locked:a}){const{t:n,dispatch:r,caps:o,doDecide:i}=T(),s=J(t),c=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":c},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(We,{o:t}),Y(t)&&e.jsx(ye,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&o.pipe&&s===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>i(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>i(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function br(){const t=T(),{st:a,dispatch:n,t:r,caps:o,scoped:i,lang:s,sessTally:c}=t,[p,d]=u.useState(new Set);u.useEffect(()=>{d(new Set)},[a.ptab,a.continent]);const x=k=>d(j=>{const C=new Set(j);return C.has(k)?C.delete(k):C.add(k),C}),l=u.useMemo(()=>Ge(i,a.sort),[i,a.sort]),v=u.useMemo(()=>l.filter(k=>Y(k)&&!Q(k)).length,[l]),b=o.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,m=(k,j,C="",A=!1)=>e.jsxs("button",{type:"button","data-s":k,className:C,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:A?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:k}),children:[j,e.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),h=u.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const k=new Map;return l.forEach(j=>{const C=j.engine||"?";k.has(C)||k.set(C,[]),k.get(C).push(j)}),[...k.entries()]},[l,o.pipe,a.groupBy]),g=o.lockRowsAfter;let f=0;const N=(k,j)=>{const C=a.shown[j]||Le,F=k.slice(0,C).map(w=>{const S=g!==null&&f>=g;return f++,a.dens==="maxi"?e.jsx(hr,{o:w,locked:S},w.id):e.jsx(xr,{o:w,locked:S,open:p.has(w.id),onToggle:()=>x(w.id)},w.id)});return k.length>C&&F.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:j,by:Le}),children:r.more(Math.min(Le,k.length-C),k.length-C)},j+":more")),F};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:l.length})," ",b]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,o.pipe&&t.fund?" · "+t.fund:""]}),o.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),o.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([k,j])=>e.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k,onClick:()=>n({type:"dens",dens:k}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:j})]},k))}),o.showChain&&l.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:l.filter(k=>o.pipe?!0:!Q(k)).map(k=>k.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",o.pipe?r.browse(l.length):r.chainAll(l.filter(k=>!Q(k)).length)]})]}),v>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(v)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),m("country",r.colCountry),m("name",r.colCompany),m("amount",r.colAmount,"h-amt",!0),m("stage",r.colStage,"h-stade"),m("signal",r.colSignal,"h-sig"),o.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),o.pipe&&m("score",r.colScore,"h-sc",!0),e.jsx("span",{}),o.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[h?h.map(([k,j])=>e.jsxs(u.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:he(k)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:oe(k,s)}),e.jsx("div",{className:"s",children:r.grpCount(j.filter(C=>!Q(C)).length,j.length)})]})]}),N(j,k)]},k)):N(l,"pt"+a.ptab),!l.length&&e.jsx("div",{className:"void",children:o.pipe?r.emptyTab:r.emptyScope})]}),o.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(c.kept>0||c.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(c.kept,c.dropped)}})]})}const vr=`
...
`;function yr(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,o=window.innerHeight,i=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let s=t.y+10;return s+n>o-8&&(s=Math.max(8,t.y-n-14)),s<8&&(s=8),{left:i,top:s}}function wr(){const{st:t,dispatch:a,byId:n,t:r,lang:o,caps:i,mode:s,askEvaluate:c,doAnalyse:p,doDecide:d,doPromote:x,doRepeche:l,doApproach:v,doDeep:b,doOnboard:m,outbound:h,evalBusy:g}=T(),f=t.popupId?n.get(t.popupId):null;if(!f)return null;const N=Y(f),k=J(f),j=Me(f),C=f.kind==="target",A=F=>{a({type:"filters",patch:F}),a({type:"popup",id:null})};return Ce.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:vr}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:yr(t.popupAnchor),onClick:F=>F.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:f.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(be(f.date)),oe(f.engine,o))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[f.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[f.cc]}),children:(ve(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&e.jsx("button",{type:"button",onClick:()=>A({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&e.jsx("button",{type:"button",onClick:()=>A({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&e.jsx("span",{className:"am2",children:He(f.amountEur,o)})]}),(f.tagline||f.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:f.tagline||f.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[he(f.engine)," ",e.jsx("b",{children:oe(f.engine,o)})," — ",ia(f.engine,o),f.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",f.noteTitle]})]}),N?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(ye,{o:f,lg:!0})," ",e.jsx(Re,{o:f,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(jt(N,o))," · ",r.win7(Nt(N,o))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),f.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:i.pipe&&k>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&C&&j&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[j,typeof f.score=="number"&&f.score>0?" · "+r.score(f.score):""]})})]}),e.jsxs("div",{className:"pf",children:[i.lockActions||s!=="client"&&i.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):i.pipe?e.jsxs(e.Fragment,{children:[k===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>c(f),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),k===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),k===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),k===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{d(f,!1),a({type:"popup",id:null})},children:r.actNo}),_e(f)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:r.memoDeep})]}),k===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{v(f),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),k===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{l(f),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),f.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),h&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>c(f),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),f.website&&e.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function mt(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function kr(t,a){const n=la(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function jr(t,a){const r=[a.head.split("|").map(mt).join(";")];for(const o of t){const i=a.stageOf(o);r.push([o.name||"",kr(o,a.plabels),Fe(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(mt).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function Nr(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const Ne="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function re({title:t,icon:a,children:n,wide:r}){const{dispatch:o}=T();return Ce.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function Cr(){const{st:t}=T();switch(t.modal){case"chain":return e.jsx(zr,{});case"space":return e.jsx(Er,{});case"alert":return e.jsx(Tr,{});case"queue":return e.jsx(Lr,{});case"export":return e.jsx(Fr,{});case"plug":return e.jsx(Mr,{});case"recharge":return e.jsx(Rr,{});case"cover":return e.jsx(Dr,{});case"crit":return e.jsx(qr,{});case"tuto":return e.jsx(Br,{});case"rdv":return e.jsx(Sr,{});default:return null}}function Sr(){const{dispatch:t,fund:a}=T(),n=typeof document<"u"&&!!document.getElementById("rdv");return u.useEffect(()=>{n&&(t({type:"modal",modal:null}),$a())},[n,t]),n?null:e.jsx(sa,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function zr(){const{st:t,dispatch:a,byId:n,t:r,lang:o,mode:i,askEvaluate:s,evalBusy:c}=T(),p=i==="client",d=t.chain.queue.map(b=>n.get(b)).filter(b=>!!b),x=t.chain.idx,l=d[x],v=x>=d.length;return Ce.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:v?r.finished:`${x+1} / ${d.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(v?100:x/Math.max(1,d.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:v||!l?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(d.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:l.name}),e.jsx("div",{className:"sub",children:[ve(l.cc,o)||l.countryLabel,l.sector,l.stage,r.daysAgo(be(l.date))].filter(Boolean).map(b=>String(b).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:oe(l.engine,o).toUpperCase()}),typeof l.amountEur=="number"&&l.amountEur>0&&e.jsx("span",{children:He(l.amountEur,o)})]}),Y(l)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(ye,{o:l,lg:!0})," ",e.jsx(Re,{o:l,src:!0})]}),(l.tagline||l.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:l.tagline||l.headline})]}),l.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:l.reasoning})]}),p&&Q(l)&&e.jsxs("div",{className:"vbox",style:{"--c":se(l)==="retenu"?"var(--brand)":se(l)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:se(l)==="retenu"?"✓ "+r.kept:se(l)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:l.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!v&&l&&!(p&&Q(l))&&e.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:c,onClick:()=>{s(l)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?r.closeBtn:r.skip})]})]})})}),document.body)}function Er(){const{st:t,dispatch:a,dossiers:n,t:r,mode:o}=T(),i=o==="client",s=u.useMemo(()=>i?n.filter(l=>Q(l)):[],[n,i]),c=u.useMemo(()=>Ge(s.filter(l=>se(l)==="retenu"),{key:"signal",dir:-1}),[s]),p=u.useMemo(()=>s.filter(l=>se(l)==="ecarte"),[s]),d=t.spaceTab==="retenu"?c:p,x=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(re,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:c.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:p.length})]})]}),d.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),d.slice(0,40).map(l=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":x},children:typeof l.score=="number"&&l.score>0?l.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:l.name}),e.jsx("div",{className:"rr",children:l.reasoning||l.tagline||""})]})]},l.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function Tr(){const{mode:t}=T();return t==="client"||t==="apercu"?e.jsx(Ar,{}):e.jsx(Or,{})}function Ar(){const{t,token:a,flash:n,flashErr:r,mode:o}=T(),[i,s]=u.useState(null),[c,p]=u.useState(!1),[d,x]=u.useState(0),l=o!=="client";u.useEffect(()=>{let b=!0;return p(!1),ot(a).then(m=>{b&&(m?s(m):p(!0))}),()=>{b=!1}},[a,d]);const v=b=>{l||ot(a,b).then(m=>{if(!m){r(t.actErr);return}s(m),m.throttled?r(t.alertThrottled):n(t.alertSaved)})};return e.jsx(re,{title:t.alertTitle,icon:"🔔",children:c?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>x(b=>b+1),children:t.retry})]}):i?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:l,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>v({hour:Math.max(6,(i.hour??7)-1)}),disabled:l,children:"−"}),e.jsxs("b",{children:[i.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>v({hour:Math.min(21,(i.hour??7)+1)}),disabled:l,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:l,style:i.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>v({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:l,style:i.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>v({days:"daily"}),children:t.alertEveryday})]})]}),i.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),i.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${t.updatedAt(i.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]}):e.jsx("div",{className:"sp-empty",children:"…"})})}function Or(){const{st:t,t:a,lang:n,scoped:r,contName:o}=T(),[i,s]=u.useState(""),[c,p]=u.useState(!1),[d,x]=u.useState(!1),l=t.filters,v=u.useMemo(()=>r.filter(g=>Y(g)).length,[r]),b=l.win==="1"?0:l.win==="7"?1:l.win==="30"?2:3,m=async()=>{if(!(!/.+@.+\..+/.test(i)||d)){x(!0);try{await fetch(`${$e}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i.trim(),sectors:l.sector,countries:l.country,source:"atelier2",website:""})}),p(!0)}finally{x(!1)}}},h=[[a.amRows.continent,o],[a.amRows.since,a.amSince[b]],[a.amRows.signal,l.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,l.engine.length?l.engine.map(g=>oe(g,n)).join(", "):a.amAllEngines],[a.amRows.sectors,l.sector.length?l.sector.join(", "):a.amAllSectors],[a.amRows.countries,l.country.length?l.country.map(g=>ve(g,n)||g).join(", "):a.amAllCountries],[a.amRows.stages,l.stage.length?l.stage.join(", "):a.amAllStages]];return e.jsx(re,{title:a.alertTitle,icon:"🔔",children:c?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(i)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:h.map(([g,f])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:g}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:f}})]},g))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:i,onChange:g=>s(g.target.value),onKeyDown:g=>{g.key==="Enter"&&m()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void m(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function Lr(){var h,g,f;const{t,token:a,fund:n,mode:r,flash:o}=T(),[i,s]=u.useState(null),[c,p]=u.useState([]),[d,x]=u.useState(0),l=r==="client";u.useEffect(()=>{let N=!0;return(async()=>{const[k,j]=await Promise.all([vt(n),yt(a)]);N&&(k&&s(k),p(j))})(),()=>{N=!1}},[a,n,d]);const v=(i==null?void 0:i.per_day)??2,b=((h=i==null?void 0:i.analyzed_today)==null?void 0:h.length)??0,m=(g=i==null?void 0:i.tomorrow)!=null&&g.length?i.tomorrow:((i==null?void 0:i.pool_meta)||[]).slice(0,10);return e.jsxs(re,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(b,b+(((f=i==null?void 0:i.pool_order)==null?void 0:f.length)??0))}})}),e.jsx("div",{className:"qrate",children:t.queueRate}),e.jsx("div",{className:"qrates",children:[1,2,3,5,10].map(N=>e.jsx("button",{type:"button",className:"qr"+(v===N?" on":""),disabled:!l,onClick:()=>{wt(a,N).then(k=>{k!==null&&(x(j=>j+1),o(t.alertSaved))})},children:e.jsxs("b",{children:[N,"/j"]})},N))})]}),c.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:c.map(N=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:N.company}),e.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),e.jsx("span",{className:"qt",children:N.status}),N.url&&e.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),l&&N.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{nt(a,N.company,"retry").then(()=>x(k=>k+1))},children:t.queueRetry}),l&&N.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{nt(a,N.company,"delete").then(()=>x(k=>k+1))},children:t.queueDelete})]},N.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[m.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),m.slice(0,10).map((N,k)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",k+1]}),e.jsx("b",{children:N.name}),typeof N.score=="number"&&e.jsx("span",{className:"qs2",children:N.score})]},N.name))]})]})}function Fr(){const{t,token:a,flash:n,scoped:r,caps:o,stageOf:i}=T(),s=`${Ne}/cibles/list.csv?token=${a}`,c=`${Ne}/cibles/list.json?token=${a}`,p=`${Ne}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,x=m=>{var h;(h=navigator.clipboard)==null||h.writeText(m).then(()=>n(t.exportCopied))},l=[{def:t.exportCsv,value:s,href:s},{def:t.exportSheet,value:d},{def:t.exportLive,value:c,href:c},{def:t.exportXlsx,value:p,href:p}],v=!o.lockActions&&r.length>0,b=()=>{Nr(jr(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:i,stageLabel:m=>(t.stg.find(([h])=>h===m)||["",""])[1]})),n(t.exportViewDone(r.length))};return e.jsxs(re,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:b,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:l.map(({def:m,value:h,href:g})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:m[0]}),e.jsxs("div",{children:[e.jsx("b",{children:m[1]}),e.jsx("p",{children:m[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>x(h),children:t.exportCopy}),g&&e.jsx("a",{className:"exb",href:g,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},m[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function Mr(){const{t,token:a,flash:n,mode:r}=T(),[o,i]=u.useState(null),[s,c]=u.useState(""),p=r==="client";u.useEffect(()=>{let l=!0;return rt(a).then(v=>{l&&v&&i(v)}),()=>{l=!1}},[a]);const d=(l,v)=>{p&&rt(a,l).then(b=>{b&&b.ok!==!1&&(n(v),i({configured:!l.remove&&(l.url?!0:o==null?void 0:o.configured),url_hint:b.url_hint}))})},x='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(re,{title:t.plugTitle,icon:"🔌",children:[e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.plugWebhook}),e.jsxs("p",{children:[t.plugWebhookHint,o!=null&&o.configured?` — ${t.plugConfigured}${o.url_hint?` (${o.url_hint})`:""}`:""]}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:"https://…",value:s,onChange:l=>c(l.target.value),disabled:!p}),e.jsx("button",{type:"button",className:"abtn p",disabled:!p||!s.trim(),onClick:()=>d({url:s.trim()},t.alertSaved),children:t.plugSave}),e.jsx("button",{type:"button",className:"abtn",disabled:!p||!(o!=null&&o.configured),onClick:()=>d({test:!0},t.plugTest+" ✓"),children:t.plugTest}),e.jsx("button",{type:"button",className:"abtn",disabled:!p||!(o!=null&&o.configured),onClick:()=>d({remove:!0},t.plugRemove+" ✓"),children:t.plugRemove})]})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.plugMcp}),e.jsx("p",{children:t.plugMcpHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{readOnly:!0,value:x}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var l;(l=navigator.clipboard)==null||l.writeText(x).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function Rr(){const{t,data:a,lang:n}=T(),r=a.credits,o=a.email,i=async s=>{if(!o)return;const c=window.location.href.split("?")[0];try{const d=await(await fetch(`${$e}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:s,success_url:c+"?credits=ok",cancel_url:c+"?credits=cancel"})})).json();d.url&&(window.location.href=d.url)}catch{}};return e.jsxs(re,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(s=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(s.credits,s.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{i(s.lookup_key)},children:t.rechargeBuy})]},s.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function Dr(){const{t,data:a,dossiers:n}=T(),r=n.filter(i=>i.kind==="target"&&Q(i)).length,o=a.marketEstimate||0;return e.jsx(re,{title:t.coverTitle,icon:"🌍",children:o>0?e.jsx("p",{dangerouslySetInnerHTML:{__html:t.coverBody(r,o)}}):e.jsx("p",{children:t.coverScreened(r)})})}function qr(){var f,N,k;const{t,dossiers:a,token:n,mode:r,flash:o,criteria:i}=T(),s=r==="client",c=u.useMemo(()=>{const j=new Set;return a.forEach(C=>{C.angle&&j.add(C.angle)}),[...j]},[a]),[p,d]=u.useState(null);u.useEffect(()=>{let j=!0;return da(n).then(C=>{j&&d(C.thumbs)}),()=>{j=!1}},[n]);const[x,l]=u.useState(""),[v,b]=u.useState(""),[m,h]=u.useState(!1),g=async()=>{const j=x.trim();if(!(!j||m||!s)){h(!0),b("");try{const A=await(await fetch(`${Ne}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:j,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&b(String(A.reply)),A.job_id){b(t.critChatRunning);const F=async()=>{const w=await fetch(`${Ne}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(S=>S.json()).catch(()=>null);if(w&&w.done){b(String(w.reply||w.clarification||w.summary||"✓")),h(!1),w.applied&&o(t.alertSaved);return}setTimeout(()=>{F()},8e3)};setTimeout(()=>{F()},8e3),l("");return}l("")}finally{v.startsWith("⏳")||h(!1)}}};return e.jsxs(re,{title:t.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&e.jsx("ul",{className:"critpts",children:i.points.map(j=>e.jsx("li",{children:j},j))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((N=i==null?void 0:i.angles)!=null&&N.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||t.critProfilsSub}),i.angles.map(j=>{var C,A;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:j.title}),j.why&&e.jsx("p",{className:"why",children:j.why}),e.jsxs("div",{className:"lo",children:[!!((C=j.look)!=null&&C.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:j.look.map(F=>e.jsx("li",{children:F},F))})]}),!!((A=j.out)!=null&&A.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:j.out.map(F=>e.jsx("li",{children:F},F))})]})]})]},j.title)})]}),!!((k=i==null?void 0:i.gate)!=null&&k.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),i.gate.length===1&&!i.gate[0].k?e.jsx("p",{className:"gate1",children:i.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:i.gate.map(j=>e.jsxs("li",{children:[j.k&&e.jsx("b",{children:j.k}),j.t]},j.t))})]}),c.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:c.map(j=>e.jsx("li",{style:{marginBottom:5},children:j.replace(/[_-]+/g," ")},j))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:x,disabled:!s||m,onChange:j=>l(j.target.value),onKeyDown:j=>{j.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!s||m||!x.trim(),onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),v&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:v})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),p===null?e.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((j,C)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:j.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:j.company}),e.jsx("span",{className:"qd",children:(j.ts||"").slice(0,10)})]},C))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([j,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Et[j]||"v-cons"),children:j}),e.jsx("span",{children:C})]},j))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([j,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:j}),e.jsxs("span",{children:["← ",C]})]},j))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function Br(){const{t,dispatch:a,startTour:n}=T(),r=o=>{var i,s;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return e.jsxs(re,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([o,i],s)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(i),onKeyDown:c=>{(c.key==="Enter"||c.key===" ")&&(c.preventDefault(),r(i))},children:[e.jsx("span",{className:"n",children:s+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+s))})]})}const Tt=u.createContext(null),T=()=>{const t=u.useContext(Tt);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function ye({o:t,lg:a}){const{lang:n}=T(),r=Y(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:it(r,n),children:[r.emoji," ",it(r,n)]}):null}function Re({o:t,src:a}){const{lang:n,t:r}=T(),o=Y(t);if(!o)return null;const i=xa(o),s=ma(o);return e.jsxs("em",{className:"sigwin"+(s?" hot":""),title:r.signaledOn(jt(o,n))+" · "+r.win7(Nt(o,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(c,p)=>e.jsx("i",{className:p<i?"on":""},p))}),e.jsx("span",{className:"lb",children:s?r.lastDay:r.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&e.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:c=>c.stopPropagation(),children:"↗"})]})}function At({o:t}){const{lang:a}=T(),n=fa(t.cc),r=t.cc?ve(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const gt="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Ot=t=>`atl2:tour:${t||"anon"}`;function Ir(t){try{return localStorage.getItem(Ot(t))==="1"}catch{return!0}}function ht(t){try{localStorage.setItem(Ot(t),"1")}catch{}}function Pr(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function Hr({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:o,onFiltersChange:i}){const{lang:s}=ca(),c=ja[s],p=Ma(t,s,a),[d,x]=u.useReducer(Da,void 0,()=>Ra((r==null?void 0:r.continent)??"europe",t,{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),l=u.useRef(i);l.current=i,u.useEffect(()=>{var y;(y=l.current)==null||y.call(l,d.filters)},[d.filters]);const[v,b]=u.useState(null),[m,h]=u.useState(null),[g,f]=u.useState({kept:0,dropped:0}),[N,k]=u.useState(!1),[j,C]=u.useState(""),[A,F]=u.useState(!1),[w,S]=u.useState(null),[P,O]=u.useState(!1),[,R]=u.useState(0),M=()=>R(y=>y+1),z=u.useRef([]),B=u.useRef(new Set),I=u.useRef(new Set),_=u.useRef(new Map),ae=u.useRef(null),{mode:de}=p,$=u.useMemo(()=>o?{...p.caps,...o}:p.caps,[p.caps,o]),ie=$.pipe,q=p.session.token||"",V=de==="client"&&!t;u.useEffect(()=>{if(document.querySelector(`link[href="${gt}"]`))return;const y=document.createElement("link");y.rel="stylesheet",y.href=gt,document.head.appendChild(y)},[]);const D=(y,E=!1)=>{C(y),F(E),ae.current&&clearTimeout(ae.current),ae.current=setTimeout(()=>C(""),E?4200:2400)},W=y=>D(y,!0),te=u.useMemo(()=>{const y=new Map;return p.dossiers.forEach(E=>{E.id&&y.set(E.id,E)}),y},[p.dossiers]),X=u.useMemo(()=>p.dossiers.filter(y=>St(y,d,ie)),[p.dossiers,d,ie]),Z=u.useRef(!1);u.useEffect(()=>{if(Z.current||t||p.loading||!p.dossiers.length)return;if(!$.showFunnel||Ir(p.session.token||"")){Z.current=!0;return}Z.current=!0;const y=window.setTimeout(()=>{ht(p.session.token||""),O(!0)},700);return()=>window.clearTimeout(y)},[t,p.loading,p.dossiers.length,$.showFunnel,p.session.token]);const ee=u.useMemo(()=>p.dossiers.filter(y=>qa(y,d,ie,p.favIds)),[p.dossiers,d,ie,p.favIds]),K=u.useMemo(()=>pa(X,p.favIds),[X,p.favIds]),xe=Ue.find(y=>y.key===d.continent),U=s==="fr"?xe.fr:xe.en,ne=(y,E)=>{const L=((y==null?void 0:y.name)||E||"").trim();if(!V){h({kicker:L});return}!L||N||(k(!0),(async()=>{try{const H=await kt(q,L,"atelier2"),ze={name:H.company||L,verdict:H.verdict,reason:H.reason||"",remaining:H.remaining??null};z.current=[ze,...z.current].slice(0,8),H.verdict==="kept"&&f(ue=>({...ue,kept:ue.kept+1})),H.verdict==="ruled_out"&&f(ue=>({...ue,dropped:ue.dropped+1}));const ke=y||p.dossiers.find(ue=>(ue.name||"").toLowerCase()===L.toLowerCase());ke&&(H.verdict==="kept"?ke.verdict=ke.verdict||"MATCH":H.verdict==="ruled_out"&&(ke.verdict="NO MATCH"),H.reason&&(ke.reasoning=H.reason)),M()}finally{k(!1)}})())},ce=y=>{if(!V){h({kicker:y.name});return}B.current.add(y.id),je(q,"fast_request",y.name||"",""),D(c.memoInstantSent(y.name)),M()},we=y=>_.current.get(y.id)??p.thumbs.get((y.name||"").trim().toLowerCase()),pe=(y,E)=>x({type:"undoPush",entry:{id:y.id,name:y.name,prevCeoStatus:E}}),G=async(y,E,L)=>{const H=y.ceoStatus||"";y.ceoStatus=E,M();const ze=await Be(q,{status:E,airtable_id:y.airtableId,check_id:y.checkId,company:y.name,...(L==null?void 0:L.note)!==void 0?{note:L.note}:{},...L!=null&&L.via?{via:L.via}:{}});return ze.ok?ze.skipped?(y.ceoStatus=H,M(),W(c.actNotPersisted),!1):((L==null?void 0:L.undo)!==!1&&pe(y,H),L!=null&&L.msg&&D(L.msg),(E==="Validé"||E==="Écarté")&&!y.ceoNote&&(L==null?void 0:L.note)===void 0&&S({o:y,yes:E==="Validé"}),!0):(y.ceoStatus=H,M(),W(c.actErr),!1)},Se=async(y,E)=>{const L=await Be(q,{status:y.ceoStatus||"Retenu",airtable_id:y.airtableId,check_id:y.checkId,company:y.name,note:E,via:"note"});return!L.ok||L.skipped?(W(L.skipped?c.actNotPersisted:c.actErr),!1):(y.ceoNote=E,M(),!0)},me=u.useRef(new Map),le=y=>me.current.has(y.id)?me.current.get(y.id):p.stages.get((y.name||"").trim().toLowerCase()),ge=(y,E)=>{me.current.set(y.id,E),M()},Lt=(y,E)=>{V&&G(y,E?"Validé":"Écarté",{msg:E?c.decidedYes(y.name):c.decidedNo(y.name)})},Ft=y=>{V&&G(y,"À trancher",{msg:c.promoted(y.name)})},Mt=y=>{V&&(async()=>{const E=y.ceoStatus||"";y.ceoStatus="Retenu",M();const L=await Be(q,{status:"Retenu",check_id:y.checkId,company:y.name});if(!L.ok||L.skipped){y.ceoStatus=E,M(),W(L.skipped?c.actNotPersisted:c.actErr);return}pe(y,E),D(c.repeched(y.name))})()},Rt=()=>{const y=d.undo[d.undo.length-1];if(!y){D(c.undoNone);return}const E=te.get(y.id);if(!E){x({type:"undoPop"}),D(c.undoNone);return}let L=y.prevCeoStatus;if(!L)if((E.verdict||"").toUpperCase().includes("CALL"))L="À trancher";else{D(c.undoLockedTitle);return}(async()=>await G(E,L,{undo:!1})&&(x({type:"undoPop"}),E.ceoStatus=y.prevCeoStatus,M(),D(c.undoDone(E.name))))()},Dt=y=>{V&&(I.current.add(y.id),M(),(async()=>{const E=await ga(q,y.name,"email");if(!E||E.ok===!1){I.current.delete(y.id),M(),W(c.actErr);return}je(q,"approach",y.name||"",""),D(c.actApproachSent)})())},qt=(y,E)=>{V&&(async()=>{if(!(await je(q,E?"yes":"no",y.name||"","")).ok){W(c.actErr);return}_.current.set(y.id,E?"yes":"no"),M(),D(E?c.thumbUpDone:c.thumbDnDone)})()},Bt=y=>{!V||!_e(y)||(je(q,"detailed_request",y.name||"",""),D(c.memoDeepSent(y.name)))},It=y=>{const E=new Set(p.favIds),L=E.has(y.id);L?E.delete(y.id):E.add(y.id),p.setFavIds(E),V&&ha(q,{id:y.id,co:y.name},L)},Pt=()=>{V&&(ba(q),D(c.identSyncDone))},Ke=/proplace/i.test(p.fund||""),$t=y=>{!V||!Ke||(je(q,"onboard_request",y.name||"",""),D(c.onboardSent(y.name)))},Vt={st:d,dispatch:x,t:c,lang:s,mode:de,caps:$,pipe:ie,token:q,fund:p.fund,email:p.email,criteria:p.criteria,data:p,doRepeche:Mt,thumbOf:we,canWrite:V,commitStatus:G,saveNote:Se,stageOf:le,setStage:ge,flashErr:W,startTour:()=>O(!0),dossiers:p.dossiers,scopedAll:X,scoped:ee,counts:K,byId:te,contName:U,favIds:p.favIds,toggleFav:It,askEvaluate:ne,doAnalyse:ce,doDecide:Lt,doPromote:Ft,doApproach:Dt,doThumb:qt,doDeep:Bt,doUndo:Rt,doSync:Pt,doOnboard:$t,outbound:Ke,memoQueued:B.current,approachDone:I.current,sessTally:g,evalCards:z.current,evalBusy:N,markRow:b,markedId:v,flash:D};return u.useEffect(()=>{const y=E=>{E.key==="Escape"&&(x({type:"popup",id:null}),x({type:"modal",modal:null}),x({type:"openFacet",facet:null}))};return window.addEventListener("keydown",y),()=>window.removeEventListener("keydown",y)},[]),e.jsx(Tt.Provider,{value:Vt,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Sa}),e.jsxs("div",{className:"app"+(ie?" pipe":""),children:[$.showTicker&&e.jsx(Ba,{}),$.showIdent&&e.jsx(Xa,{}),$.showOnb&&e.jsx(Za,{}),e.jsx(Ja,{}),$.showFunnel&&e.jsx($r,{}),$.showFunnel&&e.jsx(tr,{}),$.showFunnel&&e.jsx(rr,{}),e.jsxs("div",{className:"fzone",children:[e.jsx(Vr,{}),e.jsxs("div",{className:"stage"+(d.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(or,{}),e.jsx(ir,{})]})]}),$.showDemand&&e.jsx(sr,{}),$.showDemand&&d.memoConsole&&e.jsx(cr,{}),e.jsx(br,{}),p.loading&&e.jsx("div",{className:"void",children:c.loadingV2}),p.error&&!p.loading&&e.jsxs("div",{className:"void",children:[c.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:c.retry})]})]}),$.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:c.lockbarText}),e.jsx("button",{type:"button",onClick:()=>x({type:"modal",modal:"rdv"}),children:c.lockbarCta})]}),d.popupId&&e.jsx(wr,{}),e.jsx(Cr,{}),e.jsx(Ua,{}),w&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:w.o.name}),e.jsx(Wa,{placeholder:w.yes?c.whyYesPh:c.whyNoPh,onDone:y=>{const E=w.o;S(null),y&&Se(E,y).then(L=>{L&&D(c.csNoteSaved)})}})]}),P&&e.jsx(Qa,{steps:Pr(c),onClose:()=>{O(!1),ht(q)}}),j&&e.jsx("div",{className:"flash on"+(A?" err":""),children:j}),m&&e.jsx(ua,{variant:"acquirer",initialCompany:bt().co,initialWebsite:bt().site,onClose:()=>h(null)})]})})}function $r(){const{t}=T(),[a,n]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Vr(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:o,t:i}=T(),s=u.useMemo(()=>{const c={};return t.forEach(p=>{p.continent&&Ye(p,a.filters,r)&&(c[p.continent]=(c[p.continent]||0)+1)}),c},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[va.map(c=>{const p=Ue.find(d=>d.key===c);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===c,onClick:()=>n({type:"continent",key:c}),children:[o==="fr"?p.fr:p.en,e.jsx("span",{className:"n",children:s[c]||0})]},c)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?i.showMap:i.hideMap})})]})}function bt(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ur(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{At as FlagCell,ye as SigBadge,Re as SigWin,Hr as default,Ur as fmtShort,T as useV2};
