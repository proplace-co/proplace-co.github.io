...
`,Yi=Vi+Wi;function Ya(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Gi(){const e=Ya("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ki(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Gi();return r==="0"?"client":r==="1"||Ya("embed")==="1"&&Ya("chrome")==="1"?"apercu":"client"}const Qi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ji=e=>Qi[e];function xa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const bt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Sr(a)||xa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ro(e.cc)})};function Ma(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Xi=60*60*1e3;function Zi(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Xi?null:a}catch{return null}}function ea(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const es=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function ts(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:jo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Ki(e,i),[e,i,n]),l=m.useMemo(()=>Ji(o),[o]),d=o!=="visiteur",c=es(r),[f,s]=m.useState([]),[x,u]=m.useState(""),[h,p]=m.useState(null),[b,y]=m.useState(null),[g,j]=m.useState(null),[N,w]=m.useState(()=>new Map),[C,T]=m.useState(()=>new Map),[A,L]=m.useState(""),[z,S]=m.useState(new Set),[R,_]=m.useState(null),[M,O]=m.useState(!0),[v,q]=m.useState(!1),[H,B]=m.useState(0),[U,W]=m.useState(0),X=m.useRef(0),Y=m.useMemo(()=>{var te;if(o!=="client")return"";try{return((te=No())==null?void 0:te.email)||""}catch{return""}},[o]);m.useEffect(()=>{const te=++X.current;let we=!0;const G=()=>we&&te===X.current,pe=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),xe=Zi(pe);return xe?(s(xe.objs.map(bt)),xe.fund&&u(xe.fund),p(xe.marketEstimate??null),y(xe.criteria??null),j(xe.stats??null),L(xe.generatedAt||""),O(!1)):O(!0),(async()=>{try{if(r==="ops"){const ue=await La(),ke=((ue==null?void 0:ue.recent_ops)||[]).map(J=>{const Z=ca(J.company_name||J.title?J:{...J,title:(J.headline_fr||J.headline||"").slice(0,120)},a),K=String(J.rubrique||"").toLowerCase();return Z&&(K==="nominations"||K==="recrutements")&&(Z.engine=K),Z&&!String(J.company_name||"").trim()&&(Z.noCo=!0),Z}).filter(J=>!!J).map(J=>(Sr((J.name||"").trim())||(J.noCo=!0),J));try{const J=So(),Z=J&&J.doc||await Eo(),K=Co(Z),ee=((J==null?void 0:J.day)||(Z==null?void 0:Z.date)||"").slice(0,10);if(ee&&K.length){const me=new Set;for(const re of ke){if((re.date||"").slice(0,10)!==ee)continue;const fe=Cn(K,me,re.name,"");fe>=0&&(me.add(fe),re.decryptHtml=K[fe].html)}for(const re of ke){if(re.decryptHtml||(re.date||"").slice(0,10)!==ee)continue;const fe=Cn(K,me,"",re.headline||re.tagline||re.name);fe>=0&&(me.add(fe),re.decryptHtml=K[fe].html)}}if(ee){const me=((Z==null?void 0:Z.title_fr)||"").trim(),re=((Z==null?void 0:Z.lead_fr)||"").trim(),fe=zo(Z),he=((Z==null?void 0:Z.url)||"").trim();me&&(fe||he)&&ke.unshift({id:`edito:${ee}`,kind:"op",name:me,cc:null,date:ee,engine:"edito",dealKind:"other",headline:re||me,tagline:re||me,decryptHtml:fe||void 0,url:he,noCo:!0})}}catch{}if(!G())return;s(ke.map(bt)),ea(pe,{objs:ke})}else if(typeof r=="object"){const ke=(await zn()||[]).filter(Z=>(Z.slug||"")===r.research).map(Z=>An(Z,a)).filter(Z=>!!Z),J=Ma(await Tn(ke,a));if(!G())return;s(J.map(bt)),ea(pe,{objs:J})}else if(d&&i.token){const ue=Ao(i.token),ke=La(),J=To(i.token),Z=Lo(i.token),K=qo(i.token),ee=await ue;let me=ee?ee.targets:[];G()&&ee&&(u(ee.fund||""),p(ee.marketEstimate??null),y(ee.criteria??null),j(ee.stats??null),L(ee.generatedAt||""),s(me.map(bt)),O(!1),q(!1));const[re,fe,he,ge]=await Promise.all([ke,J,Z,K]),Fe=((re==null?void 0:re.recent_ops)||[]).map(Te=>ca(Te,a)).filter(Te=>!!Te);if(me=[...me,...Fe],!G())return;s(me.map(bt));const le=new Set;for(const Te of fe){const Le=(Te.id||Te.co||"").toString().trim().toLowerCase();Le&&le.add(Le.startsWith("t:")?Le:"t:"+Le)}S(le),w(he),T(ge),ee&&ea(pe,{fund:ee.fund,marketEstimate:ee.marketEstimate,criteria:ee.criteria,stats:ee.stats,generatedAt:ee.generatedAt,objs:me})}else{const ue=Mo(),ke=zn(),J=La(),Z=await ue;G()&&Z.length&&(s(Ma(Z).map(bt)),O(!1),q(!1));const[K,ee]=await Promise.all([ke,J]),me=(K||[]).map(ge=>An(ge,a)).filter(ge=>!!ge),re=await Tn(me,a),fe=((ee==null?void 0:ee.recent_ops)||[]).map(ge=>ca(ge,a)).filter(ge=>!!ge),he=Ma([...Z,...re,...fe]);if(!G())return;s(he.map(bt)),ea(pe,{objs:he})}G()&&q(!1)}catch{G()&&!xe&&q(!0)}finally{G()&&O(!1)}})(),()=>{we=!1}},[d,i.token,a,H,c]),m.useEffect(()=>{if(!l.showCredits||!Y){_(null);return}let te=!0;return(async()=>{try{const we=await fetch(`${cn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Y})});if(!we.ok)return;const G=await we.json();te&&G&&G.ok!==!1&&_(G)}catch{}})(),()=>{te=!1}},[l.showCredits,Y,U]);const oe=m.useCallback(te=>S(new Set(te)),[]);return{session:i,mode:o,caps:l,fund:x,email:Y,marketEstimate:h,generatedAt:A,criteria:b,stats:g,thumbs:N,stages:C,dossiers:f,favIds:z,setFavIds:oe,credits:R,reloadCredits:()=>W(te=>te+1),loading:M,error:v,refresh:()=>B(te=>te+1)}}function rt(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Ar=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),as=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Ar(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ns=new Set(["signal","amount","score","crible","memo"]);function rs(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Ar(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ns.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Tr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Tr=80;function ha(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Re(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(pn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(lt(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&yt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function Lr(e,a,r){return rt(e)?ha(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ha(e,a.filters,r)}function os(e,a,r,n){return!(!Lr(e,a,r)||r&&!Fo(e,a.ptab,n))}function xn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-lt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Po(i);case"memo":return Oo(i);case"signal":{const o=Re(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const Ra={},Bn=(Ra==null?void 0:Ra.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function $n(){return new Date().toISOString().slice(0,10)}const hn=m.createContext(null);function qr(){return m.useContext(hn)}function is(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const f=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(c.setAttribute("href",f),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function _n(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Mr(){const e=m.useContext(hn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ss({token:e,children:a}){const{dispatch:r,st:n,lang:i}=$(),[o,l]=m.useState(()=>n.filters.day||$n()),[d,c]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l($n());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=y=>{var j;const g=(j=y.detail)==null?void 0:j.day;typeof g=="string"&&x(g)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${Bn}/cibles/edition.json?${y}`).then(g=>g.json()).then(g=>{b||c(g)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const h=m.useMemo(()=>`${Bn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:d,loading:f,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:h,isEn:i==="en"}),[e,o,d,f,x,u,n.filters.day,h,i]);return t.jsx(hn.Provider,{value:p,children:a})}function ls(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Mr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Do,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})]})}function ds(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Mr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:_n(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:_n(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const cs=300,ta=7,ps={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Rr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},us=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Fa(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(_o(r)&&r!=="media")return"news:"+r;const n=Re(e);return n?"sig:"+(n.theme&&Rr.fr[n.theme]?n.theme:"other"):"actualites"}function ms(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:d}=$(),c=qr(),f=l==="en",[s,x]=m.useState("all"),[u,h]=m.useState(!1),p=m.useMemo(()=>{var we;const v=(a.filters.day||"").slice(0,10),q=G=>!(!o&&a.continent!=="monde"&&G.continent!==a.continent||v&&(G.date||"").slice(0,10)!==v),H=e.filter(G=>q(G)&&Re(G)&&(!o||G.kind!=="target"||qe(G)!==5)),B=o&&(((we=c==null?void 0:c.ed)==null?void 0:we.ops)||[]).length?c.ed.ops.map(G=>ca(G,l)).filter(G=>!!G).filter(G=>!v||(G.date||"").slice(0,10)===v):[],U=e.filter(G=>q(G)&&G.kind==="op"&&(v?!0:lt(G.date)<=ta)),W=o?B.length?B:U.filter(G=>{const pe=(d||"").trim().toLowerCase();if(!pe)return!1;const xe=G.match||null;return xe?Object.keys(xe).map(ue=>ue.trim().toLowerCase()).includes(pe):!1}):U,X=v||new Date().toISOString().slice(0,10),Y=G=>{const pe=Fa(G);return pe==="ma"?0:pe==="levees"?1:2};W.sort((G,pe)=>{const xe=Y(G)-Y(pe);if(xe)return xe;const ue=(G.date||"").slice(0,10)===X?0:1,ke=(pe.date||"").slice(0,10)===X?0:1;return ue!==ke?ue-ke:(pe.amountEur||0)-(G.amountEur||0)});const oe=new Set,te=[];for(const G of[...W,...xn(H,{key:"signal",dir:-1})]){const pe=G.id||G.name;!pe||oe.has(pe)||(oe.add(pe),te.push(G))}return o&&te.length===0?e.filter(pe=>q(pe)&&lt(pe.date)<=ta).sort((pe,xe)=>(xe.date||"").localeCompare(pe.date||"")).slice(0,80):te},[e,a.continent,a.filters.day,o,d,l,c]),b=m.useMemo(()=>{const v={};for(const q of p){const H=Fa(q);v[H]=(v[H]||0)+1}return v},[p]),y=m.useMemo(()=>s==="all"?p:p.filter(v=>Fa(v)===s),[p,s]),g=m.useMemo(()=>y.slice(0,cs),[y]),j=y.length-g.length,N=m.useRef(null);m.useEffect(()=>{var W,X;const v=N.current;if(!v)return;const q=()=>{const Y=v.scrollWidth;Y<200||(v.style.animationDuration=Math.max(18,Math.round(Y/130))+"s")};q();const H=requestAnimationFrame(q),B=window.setTimeout(q,1200);let U=!0;return(X=(W=document.fonts)==null?void 0:W.ready)==null||X.then(()=>{U&&q()}),()=>{U=!1,cancelAnimationFrame(H),window.clearTimeout(B)}},[g.length,s]);const w=v=>v==="all"?p.length:b[v]||0,C=v=>{if(v==="all")return f?"All":"Tout";if(v.startsWith("sig:"))return Rr[f?"en":"fr"][v.slice(4)]||"🔔";if(v.startsWith("news:")){const q=v.slice(5);return Bo[q]?$o(q,f?"en":"fr"):v}return ps[f?"en":"fr"][v]},T=[{k:"all"}],A=["ma","levees"].filter(v=>w(v)>0||v===s);if(A.length){T.push({g:f?"Deals":"Opérations"});for(const v of A)T.push({k:v})}const L=["nominations","recrutements"].filter(v=>w(v)>0||v===s),z=Io.filter(v=>v!=="media").map(v=>"news:"+v).filter(v=>w(v)>0||v===s),S=w("actualites")>0||s==="actualites"?["actualites"]:[];if(L.length||z.length||S.length){T.push({g:f?"News":"Actualités"});for(const v of L)T.push({k:v});for(const v of z)T.push({k:v});for(const v of S)T.push({k:v})}const R=us.map(v=>"sig:"+v).filter(v=>w(v)>0||v===s);if(R.length){T.push({g:f?"Signals (your engines)":"Signaux (vos moteurs)"});for(const v of R)T.push({k:v})}const _=v=>{try{return new Date(v+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return v}},M=(()=>{const v=(a.filters.day||"").slice(0,10),q=!o&&a.continent!=="monde"&&i?f?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return v?(f?`LIVE covers the events of ${_(v)}.`:`Le LIVE regroupe les événements du ${_(v)}.`)+q:(f?`LIVE covers the still-open signals and the deals of the last ${ta} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ta} derniers jours.`)+q})(),O=v=>g.map(q=>t.jsxs("button",{type:"button",className:"tk"+($e(q)?" spent":""),onClick:H=>{if(n({type:"focus",id:q.id}),a.dens!=="liste"){const B=H.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:B.left+B.width/2,y:B.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(Nt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(xo,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Id(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Ca,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},v+(q.id||q.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},v+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:v=>{v.currentTarget.contains(v.relatedTarget)||h(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>h(v=>!v),children:[C(s),t.jsx("b",{children:w(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:M}),T.map(v=>"g"in v?t.jsx("span",{className:"tkfilg",children:v.g},v.g):t.jsxs("button",{type:"button","aria-pressed":v.k===s,onClick:()=>{x(v.k),h(!1)},children:[C(v.k),t.jsx("b",{children:w(v.k)})]},v.k))]})]}),t.jsx("div",{className:"win",children:g.length?t.jsxs("div",{className:"run",ref:N,children:[O(0),O(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!c&&t.jsx(xs,{isEn:f})]})}const fs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function xs({isEn:e}){const[a,r]=m.useState(()=>Uo());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(Ln,i),()=>window.removeEventListener(Ln,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Ho(!a),children:fs})}const gn="+33 6 83 10 72 86",ga="alexandre@proplace.co",Fr=`tel:${gn.replace(/[^\d+]/g,"")}`;function hs(){return null}class Pe extends m.Component{constructor(){super(...arguments);Sn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Oa=600,vt=62,Un="atl2:fstats";function gs(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=$(),[l,d]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Un)==="on"}catch{return!1}}),c=r.stats,f=m.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const x=C=>a==="en"?C.slice(5,10):`${C.slice(8,10)}/${C.slice(5,7)}`,u=C=>C.toLocaleString(a==="en"?"en-US":"fr-FR"),h=f.reduce((C,T)=>Math.max(C,T.s||0),0),p=f.length?Oa/f.length:0,b=Math.max(4,p-4),y=f.length>=5&&h>0,g=r.marketEstimate||0,j=x(new Date().toISOString().slice(0,10)),N=C=>[...typeof C=="number"?[[C,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&s&&w.push({cle:"fenetre",periode:e.funPerWindow(x(s),j),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:N(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[w.map(C=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:C.periode}),C.etapes.map(([T,A],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(T)}),t.jsx("i",{children:A})]},C.cle+A)),C.cle==="total"&&g>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(g),Math.min(100,Math.round((c.screened||0)/g*100)))})]}),C.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const T=!l;d(T),T&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Un,T?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},C.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Oa} ${vt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((C,T)=>{const A=(C.s||0)/h*(vt-4),L=(C.m||0)/h*(vt-4),z=T*p+(p-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(C.d)} — ${C.s} ${e.actScreened} · ${C.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:vt-2-A,width:b,height:A,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:vt-2-L,width:b,height:L,fill:"#185c38"})]},C.d)}),t.jsx("line",{x1:0,y1:vt-1.5,x2:Oa,y2:vt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Or=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function bs(e,a){if((ut(e)||"").startsWith("CALL")&&qe(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=qe(e)>=2;return Or.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function vs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=$(),[d,c]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),p=async b=>{if(f)return;if(b==="Analysé"&&!e.memoUrl){u(!0);return}s(b);const y=await i(e,b);s(""),y&&(c(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(b=>!b),u(!1)},children:[h||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]}):bs(e,a).map(([b,y])=>t.jsx("button",{type:"button",className:"rsti"+(h===b?" on":"")+(f===b?" busy":""),disabled:!!f,onClick:()=>{p(b)},children:y},b))})]})}function ys({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=$(),[o,l]=m.useState(""),[d,c]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),s=(ut(e)||"").startsWith("CALL")&&qe(e)===3,x=qe(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const b=await i(e,p);l(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},h=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Or.filter(([p])=>!(x&&p==="Retenu")).map(([p,b])=>[p,a[b]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([p,b])=>t.jsx("button",{type:"button",className:"csb"+(f===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:b},p)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ws,{o:e})]})}function ws({o:e}){const{t:a,saveNote:r,flash:n}=$(),[i,o]=m.useState(e.ceoNote||""),[l,d]=m.useState(!1),[c,f]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!s)return;d(!0);const u=await r(e,i.trim());d(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{x()},children:c?a.csNoteSaved:a.csNoteOk})]})}function ks({placeholder:e,onDone:a}){const{t:r}=$(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function js({o:e}){var y;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:d}=$(),[c,f]=m.useState(!1);if(!n.pipe||!i||n.lockActions||qe(e)!==4)return null;const s=o(e),x=(s==null?void 0:s.stage)||"todo",u=async g=>{if(c||g===x)return;f(!0);const j=s;l(e,{stage:g,stamps:(s==null?void 0:s.stamps)||{}});const N=Math.max(Date.now(),Hn+=1);Hn=N;const w=await Vo(r,{company:e.name||"",stage:g,cts:N,deal_id:e.airtableId,check_id:e.checkId});f(!1),!w.stale&&(w.ok||(l(e,j),d(a.actErr)))},h=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,p=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,b=x==="sent"&&h&&p>=4;return t.jsxs("div",{className:"stg",onClick:g=>g.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([g,j])=>t.jsx("button",{type:"button",className:"stgb"+(x===g?" on":""),disabled:c,onClick:()=>{u(g)},children:j},g)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let Hn=0;const aa=8,na=360;function Vn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Wn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(Vn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(Vn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function Ns({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=$(),[l,d]=m.useState(0),[c,f]=m.useState(null),[s,x]=m.useState([]),u=m.useRef(!1),h=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=m.useRef(!1);m.useEffect(()=>{const A=h.current;return()=>{p.current||(n({type:"ptab",tab:A.ptab}),n({type:"dens",dens:A.dens}),n({type:"modal",modal:A.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,x(e.filter(A=>!!document.querySelector(A.need||A.sel))))},[e]);const b=s[l],y=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const A=b.click,L=window.setTimeout(()=>{const z=document.querySelector(A);z&&z.getAttribute("aria-selected")!=="true"&&z.click()},60);return()=>window.clearTimeout(L)}},[l,b]);const g=m.useRef(-1),j=m.useCallback(()=>{if(!b){f(null);return}const A=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!A){f(null);return}g.current!==l&&(g.current=l,A.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=A.getBoundingClientRect();f(z=>z&&Math.abs(z.top-L.top)<1&&Math.abs(z.left-L.left)<1&&Math.abs(z.width-L.width)<1&&Math.abs(z.height-L.height)<1?z:L)},[b,l]);m.useLayoutEffect(()=>{j();const A=[90,300,700,1300].map(z=>window.setTimeout(j,z)),L=()=>j();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{A.forEach(z=>window.clearTimeout(z)),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[j]);const N=m.useRef(a);if(N.current=a,m.useEffect(()=>{const A=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),N.current()):L.key==="ArrowRight"?d(z=>z+1):L.key==="ArrowLeft"&&d(z=>Math.max(0,z-1))};return document.addEventListener("keydown",A,!0),()=>document.removeEventListener("keydown",A,!0)},[]),!s.length)return null;let w=null;const C=A=>()=>{p.current=!0,n({type:"modal",modal:null}),A()};if(y){const A=i[3]||0;A>0?w={title:A===1?r.ahaATitle1:r.ahaATitleN(A),body:r.ahaABody,btn:r.ahaABtn,go:C(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?w={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:C(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?w={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:C(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:C(()=>{n({type:"modal",modal:"crit"}),a()})}}let T={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:na};if(!y&&c){const A=c.bottom+14,z=window.innerHeight-A>190?A:Math.max(12,c.top-200);T={left:Math.min(Math.max(12,c.left+c.width/2-na/2),window.innerWidth-na-12),top:z,width:na}}return Ft.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-aa,top:c.top-aa,width:c.width+aa*2,height:c.height+aa*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:T,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(Wn,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Wn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(A=>Math.max(0,A-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(A=>A+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Pr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Dr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Ss(){var L,z;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:d,dispatch:c}=$(),f=r?a:e,s=m.useMemo(()=>f.filter(S=>lt(S.date)===0&&S.kind==="target"),[f]),x=m.useMemo(()=>r?a.filter(S=>S.kind==="target"&&qe(S)===0).slice().sort((S,R)=>(R.date||"").localeCompare(S.date||"")):[],[a,r]),u=m.useMemo(()=>s.filter(S=>r?qe(S)===0:!$e(S)),[s,r]),h=r?x:u,p=r?a.length-x.length:s.length-u.length,b=r?a.length:s.length,y=b?Math.min(100,p/b*100):100,g=m.useMemo(()=>Pr(f),[f]),j=!!g&&lt(g)>0,N=m.useMemo(()=>j?f.filter(S=>(S.date||"").slice(0,10)===g):[],[f,g,j]),w=typeof((L=d.stats)==null?void 0:L.kept_today)=="number"?d.stats.kept_today:null,C=typeof((z=d.stats)==null?void 0:z.screened_today)=="number"?d.stats.screened_today:s.length;let T;j?T=i.morningLast(N.length,x.length,Dr(g,l)):r?T=i.morningThesis(C,x.length,w):s.length?p===0?T=i.goalSourced(s.length):p>=s.length?T=i.goalCleared:T=i.goalDone(p,s.length):T=i.goalSourced(0);const A=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&x.length&&c({type:"chainStart",queue:x.map(S=>S.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:T}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),h.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:A,children:r?i.morningEval(h.length):o.pileMode?i.goalContinue(h.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Es(){var H,B;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:f,startTour:s,flash:x,flashErr:u}=$(),[h,p]=m.useState(null),[b,y]=m.useState(!0),[g,j]=m.useState([]),N=c==="client";m.useEffect(()=>{if(!i||!o)return;let U=!0;return y(!0),(async()=>{const[W,X]=await Promise.all([un(o),Er(i)]);U&&(W&&p(W),y(!1),j(X))})(),()=>{U=!1}},[i,o]);const[w,C]=m.useState(!1),T=()=>{!N||w||!o||(C(!0),Wo(o).then(U=>{C(!1),U?x(e.identRepubDone):u(e.actErr)}))},A=(h==null?void 0:h.per_day)??null,L=((H=h==null?void 0:h.pool_order)==null?void 0:H.length)??0,z=g.filter(U=>U.status==="running").length,S=m.useMemo(()=>d.filter(U=>U.kind==="target"&&$e(U)).length,[d]),R=l.marketEstimate,_=typeof((B=l.stats)==null?void 0:B.screened)=="number"?l.stats.screened:S,M=R&&R>0?Math.min(100,Math.round(_/R*100)):null,O=U=>U.toLocaleString(a==="en"?"en-US":"fr-FR"),v=(o||"P").split(/\s+/).map(U=>U[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const U=Date.parse(l.generatedAt||"");if(Number.isNaN(U))return"";const W=new Date(U),X=Y=>String(Y).padStart(2,"0");return`${X(W.getDate())}/${X(W.getMonth()+1)} à ${X(W.getHours())}:${X(W.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?v:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),q?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[M===null&&_>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:O(_)})})]}),M!==null&&R&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:M+"%"}})}),t.jsxs("b",{children:[M," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(_,R)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),A!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:A})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),A===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),z>0&&t.jsxs("span",{className:"ev",children:["⏳ ",z]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:U=>{U.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!N||w,onClick:T,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!N,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:U=>n({type:"filters",patch:{search:U.target.value}})})]})]})]})}function Cs(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=$(),d=o.loading&&!l.length,c=m.useRef({});m.useEffect(()=>{c.current={...r}},[r]);const f=u=>{const h=c.current[u],p=h!==void 0?r[u]-h:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${_a[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},s=(u,h,p)=>t.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":`var(${_a[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),x=(u,h,p,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:h,disabled:b,onClick:p,children:u},h);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[x("↩",n.toolUndo,i,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function zs(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=$(),d=m.useRef(null),[c,f]=m.useState(60);m.useEffect(()=>{let p=0;const b=()=>{var w;const y=d.current;if(!y)return;const g=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!g)return;const j=g.getBoundingClientRect(),N=y.getBoundingClientRect();f(Math.max(20,Math.min(j.left+j.width/2-N.left,N.width-30)))};return p=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let x=r.tuto[s].p;if(s===3){const p=n.filter(g=>g.kind==="target"&&qe(g)===3),b=p.filter(g=>Ua(g)==="auto").length,y=p.filter(g=>Ua(g)==="cd").length;x=r.tutoPending(b,y,p.length)}const u=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(s===1){const p=n.filter(b=>b.kind==="target"&&qe(b)===1&&!i.has(b.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(b=>b.id)})}}return null})(),h=Yo(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(h?"":" on-dark"),style:{"--bg":`var(${_a[s]})`,"--ax":c+"px","--stc":h?"var(--ink)":"#fff","--stt":h?"#fff":"var(--ink)","--tc":h?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class kt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,d=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*As(e){for(const a of e)yield*a}function Ir(e){return Array.from(As(e))}var ye=1e-6,ce=Math.PI,Ge=ce/2,Yn=ce/4,Qe=ce*2,it=180/ce,He=ce/180,Se=Math.abs,Ts=Math.atan,Vt=Math.atan2,ze=Math.cos,Ae=Math.sin,Ls=Math.sign||function(e){return e>0?1:e<0?-1:0},St=Math.sqrt;function qs(e){return e>1?0:e<-1?ce:Math.acos(e)}function Wt(e){return e>1?Ge:e<-1?-Ge:Math.asin(e)}function Ke(){}function ba(e,a){e&&Kn.hasOwnProperty(e.type)&&Kn[e.type](e,a)}var Gn={Feature:function(e,a){ba(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)ba(r[n].geometry,a)}},Kn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Ga(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Ga(r[n],a,0)},Polygon:function(e,a){Qn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Qn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)ba(r[n],a)}};function Ga(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Qn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Ga(e[r],a,1);a.polygonEnd()}function Ct(e,a){e&&Gn.hasOwnProperty(e.type)?Gn[e.type](e,a):ba(e,a)}function Ka(e){return[Vt(e[1],e[0]),Wt(e[2])]}function qt(e){var a=e[0],r=e[1],n=ze(r);return[n*ze(a),n*Ae(a),Ae(r)]}function ra(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function va(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Pa(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function oa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Qa(e){var a=St(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Ja(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Xa(e,a){return Se(e)>ce&&(e-=Math.round(e/Qe)*Qe),[e,a]}Xa.invert=Xa;function Ms(e,a,r){return(e%=Qe)?a||r?Ja(Xn(e),Zn(a,r)):Xn(e):a||r?Zn(a,r):Xa}function Jn(e){return function(a,r){return a+=e,Se(a)>ce&&(a-=Math.round(a/Qe)*Qe),[a,r]}}function Xn(e){var a=Jn(e);return a.invert=Jn(-e),a}function Zn(e,a){var r=ze(e),n=Ae(e),i=ze(a),o=Ae(a);function l(d,c){var f=ze(c),s=ze(d)*f,x=Ae(d)*f,u=Ae(c),h=u*r+s*n;return[Vt(x*i-h*o,s*r-u*n),Wt(h*i+x*o)]}return l.invert=function(d,c){var f=ze(c),s=ze(d)*f,x=Ae(d)*f,u=Ae(c),h=u*i-x*o;return[Vt(x*i+u*o,s*r+h*n),Wt(h*r-s*n)]},l}function Rs(e,a,r,n,i,o){if(r){var l=ze(a),d=Ae(a),c=n*r;i==null?(i=a+n*Qe,o=a-c/2):(i=er(l,i),o=er(l,o),(n>0?i<o:i>o)&&(i+=n*Qe));for(var f,s=i;n>0?s>o:s<o;s-=c)f=Ka([l,-d*ze(s),-d*Ae(s)]),e.point(f[0],f[1])}}function er(e,a){a=qt(a),a[0]-=e,Qa(a);var r=qs(-a[1]);return((-a[2]<0?-r:r)+Qe-ye)%Qe}function Br(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ke,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function pa(e,a){return Se(e[0]-a[0])<ye&&Se(e[1]-a[1])<ye}function ia(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function $r(e,a,r,n,i){var o=[],l=[],d,c;if(e.forEach(function(p){if(!((b=p.length-1)<=0)){var b,y=p[0],g=p[b],j;if(pa(y,g)){if(!y[2]&&!g[2]){for(i.lineStart(),d=0;d<b;++d)i.point((y=p[d])[0],y[1]);i.lineEnd();return}g[0]+=2*ye}o.push(j=new ia(y,p,null,!0)),l.push(j.o=new ia(y,null,j,!1)),o.push(j=new ia(g,p,null,!1)),l.push(j.o=new ia(g,null,j,!0))}}),!!o.length){for(l.sort(a),tr(o),tr(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var f=o[0],s,x;;){for(var u=f,h=!0;u.v;)if((u=u.n)===f)return;s=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(h)for(d=0,c=s.length;d<c;++d)i.point((x=s[d])[0],x[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(h)for(s=u.p.z,d=s.length-1;d>=0;--d)i.point((x=s[d])[0],x[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,s=u.z,h=!h}while(!u.v);i.lineEnd()}}}function tr(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function Da(e){return Se(e[0])<=ce?e[0]:Ls(e[0])*((Se(e[0])+ce)%Qe-ce)}function Fs(e,a){var r=Da(a),n=a[1],i=Ae(n),o=[Ae(r),-ze(r),0],l=0,d=0,c=new kt;i===1?n=Ge+ye:i===-1&&(n=-Ge-ye);for(var f=0,s=e.length;f<s;++f)if(u=(x=e[f]).length)for(var x,u,h=x[u-1],p=Da(h),b=h[1]/2+Yn,y=Ae(b),g=ze(b),j=0;j<u;++j,p=w,y=T,g=A,h=N){var N=x[j],w=Da(N),C=N[1]/2+Yn,T=Ae(C),A=ze(C),L=w-p,z=L>=0?1:-1,S=z*L,R=S>ce,_=y*T;if(c.add(Vt(_*z*Ae(S),g*A+_*ze(S))),l+=R?L+z*Qe:L,R^p>=r^w>=r){var M=va(qt(h),qt(N));Qa(M);var O=va(o,M);Qa(O);var v=(R^L>=0?-1:1)*Wt(O[2]);(n>v||n===v&&(M[0]||M[1]))&&(d+=R^L>=0?1:-1)}}return(l<-ye||l<ye&&c<-1e-12)^d&1}function _r(e,a,r,n){return function(i){var o=a(i),l=Br(),d=a(l),c=!1,f,s,x,u={point:h,lineStart:b,lineEnd:y,polygonStart:function(){u.point=g,u.lineStart=j,u.lineEnd=N,s=[],f=[]},polygonEnd:function(){u.point=h,u.lineStart=b,u.lineEnd=y,s=Ir(s);var w=Fs(f,n);s.length?(c||(i.polygonStart(),c=!0),$r(s,Ps,w,r,i)):w&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),s=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function h(w,C){e(w,C)&&i.point(w,C)}function p(w,C){o.point(w,C)}function b(){u.point=p,o.lineStart()}function y(){u.point=h,o.lineEnd()}function g(w,C){x.push([w,C]),d.point(w,C)}function j(){d.lineStart(),x=[]}function N(){g(x[0][0],x[0][1]),d.lineEnd();var w=d.clean(),C=l.result(),T,A=C.length,L,z,S;if(x.pop(),f.push(x),x=null,!!A){if(w&1){if(z=C[0],(L=z.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),T=0;T<L;++T)i.point((S=z[T])[0],S[1]);i.lineEnd()}return}A>1&&w&2&&C.push(C.pop().concat(C.shift())),s.push(C.filter(Os))}}return u}}function Os(e){return e.length>1}function Ps(e,a){return((e=e.x)[0]<0?e[1]-Ge-ye:Ge-e[1])-((a=a.x)[0]<0?a[1]-Ge-ye:Ge-a[1])}const ar=_r(function(){return!0},Ds,Bs,[-ce,-Ge]);function Ds(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var d=o>0?ce:-ce,c=Se(o-a);Se(c-ce)<ye?(e.point(a,r=(r+l)/2>0?Ge:-Ge),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(o,r),i=0):n!==d&&c>=ce&&(Se(a-n)<ye&&(a-=n*ye),Se(o-d)<ye&&(o-=d*ye),r=Is(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),i=0),e.point(a=o,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Is(e,a,r,n){var i,o,l=Ae(e-r);return Se(l)>ye?Ts((Ae(a)*(o=ze(n))*Ae(r)-Ae(n)*(i=ze(a))*Ae(e))/(i*o*l)):(a+n)/2}function Bs(e,a,r,n){var i;if(e==null)i=r*Ge,n.point(-ce,i),n.point(0,i),n.point(ce,i),n.point(ce,0),n.point(ce,-i),n.point(0,-i),n.point(-ce,-i),n.point(-ce,0),n.point(-ce,i);else if(Se(e[0]-a[0])>ye){var o=e[0]<a[0]?ce:-ce;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function $s(e){var a=ze(e),r=2*He,n=a>0,i=Se(a)>ye;function o(s,x,u,h){Rs(h,e,r,u,s,x)}function l(s,x){return ze(s)*ze(x)>a}function d(s){var x,u,h,p,b;return{lineStart:function(){p=h=!1,b=1},point:function(y,g){var j=[y,g],N,w=l(y,g),C=n?w?0:f(y,g):w?f(y+(y<0?ce:-ce),g):0;if(!x&&(p=h=w)&&s.lineStart(),w!==h&&(N=c(x,j),(!N||pa(x,N)||pa(j,N))&&(j[2]=1)),w!==h)b=0,w?(s.lineStart(),N=c(j,x),s.point(N[0],N[1])):(N=c(x,j),s.point(N[0],N[1],2),s.lineEnd()),x=N;else if(i&&x&&n^w){var T;!(C&u)&&(T=c(j,x,!0))&&(b=0,n?(s.lineStart(),s.point(T[0][0],T[0][1]),s.point(T[1][0],T[1][1]),s.lineEnd()):(s.point(T[1][0],T[1][1]),s.lineEnd(),s.lineStart(),s.point(T[0][0],T[0][1],3)))}w&&(!x||!pa(x,j))&&s.point(j[0],j[1]),x=j,h=w,u=C},lineEnd:function(){h&&s.lineEnd(),x=null},clean:function(){return b|(p&&h)<<1}}}function c(s,x,u){var h=qt(s),p=qt(x),b=[1,0,0],y=va(h,p),g=ra(y,y),j=y[0],N=g-j*j;if(!N)return!u&&s;var w=a*g/N,C=-a*j/N,T=va(b,y),A=oa(b,w),L=oa(y,C);Pa(A,L);var z=T,S=ra(A,z),R=ra(z,z),_=S*S-R*(ra(A,A)-1);if(!(_<0)){var M=St(_),O=oa(z,(-S-M)/R);if(Pa(O,A),O=Ka(O),!u)return O;var v=s[0],q=x[0],H=s[1],B=x[1],U;q<v&&(U=v,v=q,q=U);var W=q-v,X=Se(W-ce)<ye,Y=X||W<ye;if(!X&&B<H&&(U=H,H=B,B=U),Y?X?H+B>0^O[1]<(Se(O[0]-v)<ye?H:B):H<=O[1]&&O[1]<=B:W>ce^(v<=O[0]&&O[0]<=q)){var oe=oa(z,(-S+M)/R);return Pa(oe,A),[O,Ka(oe)]}}}function f(s,x){var u=n?e:ce-e,h=0;return s<-u?h|=1:s>u&&(h|=2),x<-u?h|=4:x>u&&(h|=8),h}return _r(l,d,o,n?[0,-e]:[-ce,e-ce])}function _s(e,a,r,n,i,o){var l=e[0],d=e[1],c=a[0],f=a[1],s=0,x=1,u=c-l,h=f-d,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<s)return;p<x&&(x=p)}else if(u>0){if(p>x)return;p>s&&(s=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>x)return;p>s&&(s=p)}else if(u>0){if(p<s)return;p<x&&(x=p)}if(p=n-d,!(!h&&p>0)){if(p/=h,h<0){if(p<s)return;p<x&&(x=p)}else if(h>0){if(p>x)return;p>s&&(s=p)}if(p=o-d,!(!h&&p<0)){if(p/=h,h<0){if(p>x)return;p>s&&(s=p)}else if(h>0){if(p<s)return;p<x&&(x=p)}return s>0&&(e[0]=l+s*u,e[1]=d+s*h),x<1&&(a[0]=l+x*u,a[1]=d+x*h),!0}}}}}var It=1e9,sa=-It;function Us(e,a,r,n){function i(f,s){return e<=f&&f<=r&&a<=s&&s<=n}function o(f,s,x,u){var h=0,p=0;if(f==null||(h=l(f,x))!==(p=l(s,x))||c(f,s)<0^x>0)do u.point(h===0||h===3?e:r,h>1?n:a);while((h=(h+x+4)%4)!==p);else u.point(s[0],s[1])}function l(f,s){return Se(f[0]-e)<ye?s>0?0:3:Se(f[0]-r)<ye?s>0?2:1:Se(f[1]-a)<ye?s>0?1:0:s>0?3:2}function d(f,s){return c(f.x,s.x)}function c(f,s){var x=l(f,1),u=l(s,1);return x!==u?x-u:x===0?s[1]-f[1]:x===1?f[0]-s[0]:x===2?f[1]-s[1]:s[0]-f[0]}return function(f){var s=f,x=Br(),u,h,p,b,y,g,j,N,w,C,T,A={point:L,lineStart:_,lineEnd:M,polygonStart:S,polygonEnd:R};function L(v,q){i(v,q)&&s.point(v,q)}function z(){for(var v=0,q=0,H=h.length;q<H;++q)for(var B=h[q],U=1,W=B.length,X=B[0],Y,oe,te=X[0],we=X[1];U<W;++U)Y=te,oe=we,X=B[U],te=X[0],we=X[1],oe<=n?we>n&&(te-Y)*(n-oe)>(we-oe)*(e-Y)&&++v:we<=n&&(te-Y)*(n-oe)<(we-oe)*(e-Y)&&--v;return v}function S(){s=x,u=[],h=[],T=!0}function R(){var v=z(),q=T&&v,H=(u=Ir(u)).length;(q||H)&&(f.polygonStart(),q&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),H&&$r(u,d,v,o,f),f.polygonEnd()),s=f,u=h=p=null}function _(){A.point=O,h&&h.push(p=[]),C=!0,w=!1,j=N=NaN}function M(){u&&(O(b,y),g&&w&&x.rejoin(),u.push(x.result())),A.point=L,w&&s.lineEnd()}function O(v,q){var H=i(v,q);if(h&&p.push([v,q]),C)b=v,y=q,g=H,C=!1,H&&(s.lineStart(),s.point(v,q));else if(H&&w)s.point(v,q);else{var B=[j=Math.max(sa,Math.min(It,j)),N=Math.max(sa,Math.min(It,N))],U=[v=Math.max(sa,Math.min(It,v)),q=Math.max(sa,Math.min(It,q))];_s(B,U,e,a,r,n)?(w||(s.lineStart(),s.point(B[0],B[1])),s.point(U[0],U[1]),H||s.lineEnd(),T=!1):H&&(s.lineStart(),s.point(v,q),T=!1)}j=v,N=q,w=H}return A}}const Za=e=>e;var Ia=new kt,en=new kt,Ur,Hr,tn,an,st={point:Ke,lineStart:Ke,lineEnd:Ke,polygonStart:function(){st.lineStart=Hs,st.lineEnd=Ws},polygonEnd:function(){st.lineStart=st.lineEnd=st.point=Ke,Ia.add(Se(en)),en=new kt},result:function(){var e=Ia/2;return Ia=new kt,e}};function Hs(){st.point=Vs}function Vs(e,a){st.point=Vr,Ur=tn=e,Hr=an=a}function Vr(e,a){en.add(an*e-tn*a),tn=e,an=a}function Ws(){Vr(Ur,Hr)}var Mt=1/0,ya=Mt,Yt=-Mt,wa=Yt,ka={point:Ys,lineStart:Ke,lineEnd:Ke,polygonStart:Ke,polygonEnd:Ke,result:function(){var e=[[Mt,ya],[Yt,wa]];return Yt=wa=-(ya=Mt=1/0),e}};function Ys(e,a){e<Mt&&(Mt=e),e>Yt&&(Yt=e),a<ya&&(ya=a),a>wa&&(wa=a)}var nn=0,rn=0,Bt=0,ja=0,Na=0,At=0,on=0,sn=0,$t=0,Wr,Yr,at,nt,Ye={point:jt,lineStart:nr,lineEnd:rr,polygonStart:function(){Ye.lineStart=Qs,Ye.lineEnd=Js},polygonEnd:function(){Ye.point=jt,Ye.lineStart=nr,Ye.lineEnd=rr},result:function(){var e=$t?[on/$t,sn/$t]:At?[ja/At,Na/At]:Bt?[nn/Bt,rn/Bt]:[NaN,NaN];return nn=rn=Bt=ja=Na=At=on=sn=$t=0,e}};function jt(e,a){nn+=e,rn+=a,++Bt}function nr(){Ye.point=Gs}function Gs(e,a){Ye.point=Ks,jt(at=e,nt=a)}function Ks(e,a){var r=e-at,n=a-nt,i=St(r*r+n*n);ja+=i*(at+e)/2,Na+=i*(nt+a)/2,At+=i,jt(at=e,nt=a)}function rr(){Ye.point=jt}function Qs(){Ye.point=Xs}function Js(){Gr(Wr,Yr)}function Xs(e,a){Ye.point=Gr,jt(Wr=at=e,Yr=nt=a)}function Gr(e,a){var r=e-at,n=a-nt,i=St(r*r+n*n);ja+=i*(at+e)/2,Na+=i*(nt+a)/2,At+=i,i=nt*e-at*a,on+=i*(at+e),sn+=i*(nt+a),$t+=i*3,jt(at=e,nt=a)}function Kr(e){this._context=e}Kr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Qe);break}}},result:Ke};var ln=new kt,Ba,Qr,Jr,_t,Ut,Gt={point:Ke,lineStart:function(){Gt.point=Zs},lineEnd:function(){Ba&&Xr(Qr,Jr),Gt.point=Ke},polygonStart:function(){Ba=!0},polygonEnd:function(){Ba=null},result:function(){var e=+ln;return ln=new kt,e}};function Zs(e,a){Gt.point=Xr,Qr=_t=e,Jr=Ut=a}function Xr(e,a){_t-=e,Ut-=a,ln.add(St(_t*_t+Ut*Ut)),_t=e,Ut=a}let or,Sa,ir,sr;class lr{constructor(a){this._append=a==null?Zr:el(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==ir||this._append!==Sa){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,ir=n,Sa=this._append,sr=this._,this._=i}this._+=sr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Zr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function el(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Zr;if(a!==or){const r=10**a;or=a,Sa=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Sa}function tl(e,a){let r=3,n=4.5,i,o;function l(d){return d&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Ct(d,i(o))),o.result()}return l.area=function(d){return Ct(d,i(st)),st.result()},l.measure=function(d){return Ct(d,i(Gt)),Gt.result()},l.bounds=function(d){return Ct(d,i(ka)),ka.result()},l.centroid=function(d){return Ct(d,i(Ye)),Ye.result()},l.projection=function(d){return arguments.length?(i=d==null?(e=null,Za):(e=d).stream,l):e},l.context=function(d){return arguments.length?(o=d==null?(a=null,new lr(r)):new Kr(a=d),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(o.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(o=new lr(r)),l},l.projection(e).digits(r).context(a)}function bn(e){return function(a){var r=new dn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function dn(){}dn.prototype={constructor:dn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function vn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ct(r,e.stream(ka)),a(ka.result()),n!=null&&e.clipExtent(n),e}function eo(e,a,r){return vn(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),d=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function al(e,a,r){return eo(e,[[0,0],a],r)}function nl(e,a,r){return vn(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,d=-o*n[0][1];e.scale(150*o).translate([l,d])},r)}function rl(e,a,r){return vn(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],d=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,d])},r)}var dr=16,ol=ze(30*He);function cr(e,a){return+a?sl(e,a):il(e)}function il(e){return bn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function sl(e,a){function r(n,i,o,l,d,c,f,s,x,u,h,p,b,y){var g=f-n,j=s-i,N=g*g+j*j;if(N>4*a&&b--){var w=l+u,C=d+h,T=c+p,A=St(w*w+C*C+T*T),L=Wt(T/=A),z=Se(Se(T)-1)<ye||Se(o-x)<ye?(o+x)/2:Vt(C,w),S=e(z,L),R=S[0],_=S[1],M=R-n,O=_-i,v=j*M-g*O;(v*v/N>a||Se((g*M+j*O)/N-.5)>.3||l*u+d*h+c*p<ol)&&(r(n,i,o,l,d,c,R,_,z,w/=A,C/=A,T,b,y),y.point(R,_),r(R,_,z,w,C,T,f,s,x,u,h,p,b,y))}}return function(n){var i,o,l,d,c,f,s,x,u,h,p,b,y={point:g,lineStart:j,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=C},polygonEnd:function(){n.polygonEnd(),y.lineStart=j}};function g(L,z){L=e(L,z),n.point(L[0],L[1])}function j(){x=NaN,y.point=N,n.lineStart()}function N(L,z){var S=qt([L,z]),R=e(L,z);r(x,u,s,h,p,b,x=R[0],u=R[1],s=L,h=S[0],p=S[1],b=S[2],dr,n),n.point(x,u)}function w(){y.point=g,n.lineEnd()}function C(){j(),y.point=T,y.lineEnd=A}function T(L,z){N(i=L,z),o=x,l=u,d=h,c=p,f=b,y.point=N}function A(){r(x,u,s,h,p,b,o,l,i,d,c,f,dr,n),y.lineEnd=w,w()}return y}}var ll=bn({point:function(e,a){this.stream.point(e*He,a*He)}});function dl(e){return bn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function cl(e,a,r,n,i){function o(l,d){return l*=n,d*=i,[a+e*l,r-e*d]}return o.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*i]},o}function pr(e,a,r,n,i,o){if(!o)return cl(e,a,r,n,i);var l=ze(o),d=Ae(o),c=l*e,f=d*e,s=l/e,x=d/e,u=(d*r-l*a)/e,h=(d*a+l*r)/e;function p(b,y){return b*=n,y*=i,[c*b-f*y+a,r-f*b-c*y]}return p.invert=function(b,y){return[n*(s*b-x*y+u),i*(h-x*b-s*y)]},p}function pl(e){return ul(function(){return e})()}function ul(e){var a,r=150,n=480,i=250,o=0,l=0,d=0,c=0,f=0,s,x=0,u=1,h=1,p=null,b=ar,y=null,g,j,N,w=Za,C=.5,T,A,L,z,S;function R(v){return L(v[0]*He,v[1]*He)}function _(v){return v=L.invert(v[0],v[1]),v&&[v[0]*it,v[1]*it]}R.stream=function(v){return z&&S===v?z:z=ll(dl(s)(b(T(w(S=v)))))},R.preclip=function(v){return arguments.length?(b=v,p=void 0,O()):b},R.postclip=function(v){return arguments.length?(w=v,y=g=j=N=null,O()):w},R.clipAngle=function(v){return arguments.length?(b=+v?$s(p=v*He):(p=null,ar),O()):p*it},R.clipExtent=function(v){return arguments.length?(w=v==null?(y=g=j=N=null,Za):Us(y=+v[0][0],g=+v[0][1],j=+v[1][0],N=+v[1][1]),O()):y==null?null:[[y,g],[j,N]]},R.scale=function(v){return arguments.length?(r=+v,M()):r},R.translate=function(v){return arguments.length?(n=+v[0],i=+v[1],M()):[n,i]},R.center=function(v){return arguments.length?(o=v[0]%360*He,l=v[1]%360*He,M()):[o*it,l*it]},R.rotate=function(v){return arguments.length?(d=v[0]%360*He,c=v[1]%360*He,f=v.length>2?v[2]%360*He:0,M()):[d*it,c*it,f*it]},R.angle=function(v){return arguments.length?(x=v%360*He,M()):x*it},R.reflectX=function(v){return arguments.length?(u=v?-1:1,M()):u<0},R.reflectY=function(v){return arguments.length?(h=v?-1:1,M()):h<0},R.precision=function(v){return arguments.length?(T=cr(A,C=v*v),O()):St(C)},R.fitExtent=function(v,q){return eo(R,v,q)},R.fitSize=function(v,q){return al(R,v,q)},R.fitWidth=function(v,q){return nl(R,v,q)},R.fitHeight=function(v,q){return rl(R,v,q)};function M(){var v=pr(r,0,0,u,h,x).apply(null,a(o,l)),q=pr(r,n-v[0],i-v[1],u,h,x);return s=Ms(d,c,f),A=Ja(a,q),L=Ja(s,A),T=cr(A,C),O()}function O(){return z=S=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&_,M()}}function to(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}to.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(Se(i)>ye&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ml(){return pl(to).scale(175.295)}function fl(e){return e}function xl(e){if(e==null)return fl;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var f=2,s=d.length,x=new Array(s);for(x[0]=(a+=d[0])*n+o,x[1]=(r+=d[1])*i+l;f<s;)x[f]=d[f],++f;return x}}function hl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function gl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return ur(e,r)})}:ur(e,a)}function ur(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=bl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function bl(e,a){var r=xl(e.transform),n=e.arcs;function i(s,x){x.length&&x.pop();for(var u=n[s<0?~s:s],h=0,p=u.length;h<p;++h)x.push(r(u[h],h));s<0&&hl(x,p)}function o(s){return r(s)}function l(s){for(var x=[],u=0,h=s.length;u<h;++u)i(s[u],x);return x.length<2&&x.push(x[0]),x}function d(s){for(var x=l(s);x.length<4;)x.push(x[0]);return x}function c(s){return s.map(d)}function f(s){var x=s.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:s.geometries.map(f)};case"Point":u=o(s.coordinates);break;case"MultiPoint":u=s.coordinates.map(o);break;case"LineString":u=l(s.arcs);break;case"MultiLineString":u=s.arcs.map(l);break;case"Polygon":u=c(s.arcs);break;case"MultiPolygon":u=s.arcs.map(c);break;default:return null}return{type:x,coordinates:u}}return f(a)}const ao={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},vl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function yl(e,a,r){const n=ao[e];if(!n||!n.length)return-1;const i=vl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let la=null;function wl(){return la||(la=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=gl(r,n),o=ml().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=tl(o),d=(i.features||[]).filter(s=>{var x;return(((x=s.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(s=>{var h;const x=((h=s.properties)==null?void 0:h.name)||"",u=l(s)||"";return u?{i2:Go(x)||null,n:x,d:u}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,x]of Object.entries(Ko)){const u=o(x);u&&(c[s]={x:u[0],y:u[1]})}const f={};for(const[s,x]of Object.entries(ao)){const u=x.map(h=>o(h.ll)).filter(h=>!!h).map(([h,p])=>({x:h,y:p}));u.length&&(f[s]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:d,anchors:c,metros:f}}catch{return null}})(),la)}function kl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return wl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const jl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},mr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function fr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Nl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const c=(f=e.current)==null?void 0:f.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function xr({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Sl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:d,t:c,data:f,dossiers:s,source:x}=$(),u=f.loading&&!s.length,h=m.useRef(null),p=m.useRef(null),b=kl(e.continent==="monde"),y=e.continent==="monde"?b:mn.find(v=>v.key===e.continent)||null,g=Nl(h,e.continent+":"+e.mapFolded+":"+!!y),[j,N]=m.useState(new Map),[w,C]=m.useState(null);m.useEffect(()=>{const v=h.current;if(!v)return;const q=new Map;v.querySelectorAll("path[data-i2]").forEach(H=>{const B=H.dataset.i2;if(B)try{const U=H.getBBox();U.width>0&&q.set(B,{x:U.x,y:U.y,w:U.width,h:U.height})}catch{}}),N(q)},[e.continent,g,y]);const T=m.useMemo(()=>r.filter(v=>v.cc),[r]),A=m.useMemo(()=>{const v=new Map;return T.forEach(q=>v.set(q.cc,(v.get(q.cc)||0)+1)),v},[T]),L=e.continent==="monde"&&b?b.anchors:null,z=e.continent==="monde"&&b?b.metros:null,S=m.useMemo(()=>T.map(v=>{const q=fr(v.name||v.id||""),H=fr((v.id||v.name||"")+"·y");if(L&&v.cc){const Y=z?z[v.cc]:void 0;if(Y&&Y.length){const te=yl(v.cc,v.city,q);if(te>=0&&Y[te])return{d:v,x:Y[te].x+(q-.5)*5,y:Y[te].y+(H-.5)*5}}const oe=L[v.cc];if(oe)return{d:v,x:oe.x+(q-.5)*10,y:oe.y+(H-.5)*10}}const B=v.cc?j.get(v.cc):void 0;if(!B)return null;const U=jl[`${e.continent}:${v.cc||""}`];if(U)return{d:v,x:B.x+B.w*(U.fx+(q-.5)*U.sx),y:B.y+B.h*(U.fy+(H-.5)*U.sy)};const W=(q-.5)*Math.min(B.w*.55,60),X=(H-.5)*Math.min(B.h*.55,60);return{d:v,x:B.x+B.w/2+W,y:B.y+B.h/2+X}}).filter(v=>!!v),[T,j,L,z,e.continent]),R=v=>g>0?v/g:v,_=m.useMemo(()=>n?[0,1,2,3,4,5].map(v=>({c:mr[v],fr:c.plabels[v].toUpperCase(),en:c.plabels[v].toUpperCase(),n:r.filter(q=>q.kind==="target"&&qe(q)===v).length})).filter(v=>v.n>0):qn.map((v,q)=>({...v,n:r.filter(H=>Mn(H)===q).length})),[r,n,c.plabels]),M=o?l.get(o):null,O=M?S.find(v=>v.d.id===M.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:[u&&t.jsx(xr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:h,viewBox:y.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{C(null),i(null)},children:[t.jsx("g",{children:y.countries.map((v,q)=>t.jsx("g",{className:"ct"+(v.i2&&A.get(v.i2)?"":" empty"),children:t.jsx("path",{d:v.d,"data-i2":v.i2||void 0})},q))}),t.jsx("g",{children:S.map(v=>{const q=qn[Mn(v.d)],H=!!Re(v.d),B=v.d.kind==="target",U=n&&B?mr[qe(v.d)]:q.c,W=!n&&$e(v.d);return t.jsxs("g",{className:"co"+(W?" done":""),onMouseEnter:()=>{var oe,te;const X=(oe=p.current)==null?void 0:oe.getBoundingClientRect(),Y=(te=h.current)==null?void 0:te.createSVGPoint();if(Y&&h.current&&X){Y.x=v.x,Y.y=v.y;const we=Y.matrixTransform(h.current.getScreenCTM());C({x:we.x-X.left,y:we.y-X.top,label:v.d.name+" · "+(Ot(v.d.cc,d)||v.d.countryLabel||"")})}i(v.d.id)},onMouseLeave:()=>{C(null),i(null)},onClick:()=>{var oe;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:v.d.id}),(v.d.noCo||["media","nominations","recrutements"].includes(v.d.engine||""))&&(v.d.url||v.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:v.d.url||"",text:[v.d.headline,v.d.tagline].filter(Boolean).join(`
`)}})):v.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:v.d.name,url:v.d.url||""}}));return}const X=(oe=h.current)==null?void 0:oe.createSVGPoint();let Y=null;if(X&&h.current){X.x=v.x,X.y=v.y;const te=X.matrixTransform(h.current.getScreenCTM());Y={x:te.x,y:te.y}}a({type:"popup",id:v.d.id,anchor:Y})},children:[t.jsx("circle",{className:"h",cx:v.x,cy:v.y,r:R(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:v.x,cy:v.y,r:R(q.px),fill:U,stroke:H?"#DC2626":"#ffffff",strokeWidth:R(H?2.2:1.3)})]},v.d.id||v.d.name)})}),O&&t.jsx("circle",{className:"ring on",cx:O.x,cy:O.y,r:R(13),fill:"none",stroke:"#0F172A",strokeWidth:R(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:_.map((v,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":v.c}}),d==="fr"?v.fr:v.en," ",t.jsx("b",{children:v.n})]},q))}),r.some(v=>!v.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(v=>!v.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:t.jsx(xr,{msgs:c.loadMsgs})})}function El(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function no({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:d}=$(),c=a.filters,[f,s]=m.useState(!1),[x,u]=m.useState(!1),h=m.useRef(null),p=m.useRef(null),b=m.useMemo(()=>a.continent==="monde"?n:n.filter(M=>M.continent===a.continent),[n,a.continent]),y=M=>b.filter(O=>M!=="country"&&c.country.length&&!c.country.includes(O.cc||"")?!1:ha(O,c,o,M==="country"?void 0:M)),g=m.useMemo(()=>{const M=y("win"),O=v=>M.filter(q=>(q.date?Math.max(0,Math.floor((Date.now()-Date.parse(q.date))/864e5)):9999)<=v).length;return[O(0),O(7),O(30),M.length]},[b,c,o]),j=m.useMemo(()=>c.day?y("win").filter(M=>(M.date||"").slice(0,10)===c.day).length:0,[b,c,o]),N=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,w=N+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!f&&!x)return;const M=v=>{var H,B;const q=v.target;f&&!((H=h.current)!=null&&H.contains(q))&&s(!1),x&&!((B=p.current)!=null&&B.contains(q))&&u(!1)},O=v=>{v.key==="Escape"&&(s(!1),u(!1))};return document.addEventListener("mousedown",M),document.addEventListener("keydown",O),()=>{document.removeEventListener("mousedown",M),document.removeEventListener("keydown",O)}},[f,x]);const C=(M,O,v,q="fbtn")=>t.jsxs("button",{type:"button",className:q,"aria-expanded":a.openFacet===M,onClick:()=>r({type:"openFacet",facet:M}),children:[t.jsx("span",{className:"fl",children:O}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},M),T=["1","7","30","all"],A=Math.max(0,T.indexOf(c.win||"all")),L=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(El(c.day,d))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:p,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(M=>!M),children:[t.jsx("span",{className:"winpick-k",children:i.winMenu}),t.jsx("span",{className:"winpick-v",children:i.datesShort[A]}),t.jsx("b",{children:g[A]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:T.map((M,O)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===M,onClick:()=>{r({type:"filters",patch:{win:M}}),u(!1)},children:[i.datesShort[O],t.jsx("span",{className:"n",children:g[O]})]},M))})]}):t.jsx("div",{className:"seg",children:T.map((M,O)=>t.jsxs("button",{type:"button","aria-pressed":c.win===M,onClick:()=>r({type:"filters",patch:{win:M}}),children:[t.jsx("span",{className:"sl",children:i.dates[O]}),t.jsx("b",{children:g[O]})]},M))}),z=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:c.search,onChange:M=>r({type:"filters",patch:{search:M.target.value}})})]}),S=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):C("sec",i.fSector,c.sector.length),C("pay",i.fCountry,c.country.length),C("det",i.fEngine,c.engine.length),C("sta",i.fStage,c.stage.length),o&&C("ang","Angle",c.angle.length),o&&C("mem","Mémo",c.memoLevel.length)]}),R=(M=!1)=>t.jsxs("div",{className:"frow2",children:[w>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(b.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(w)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),M&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),_=t.jsxs("div",{className:"fmenu",ref:h,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(N?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{s(M=>!M),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),N>0&&t.jsx("span",{className:"n",children:N}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:S})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:L}),t.jsxs("div",{className:"fstrip-b",children:[z,_,R(!1)]})]}),a.openFacet&&t.jsx(hr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[L,z,S,t.jsx("span",{className:"fgrow"}),R()]}),a.openFacet&&t.jsx(hr,{poolFor:y})]})}function hr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:f}=m.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(g=>Re(g)),b=new Map;p.forEach(g=>{const j=g.engine||"";b.set(j,(b.get(j)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Ha([...b.keys()],i).map(g=>({v:g,label:wt(g)+" "+Ve(g,i),n:b.get(g)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(g)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const p=e("sector"),b=new Map;return p.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,g)=>g[1]-y[1]).map(([y,g])=>({v:y,label:y,n:g,html:!1,on:o.sector.includes(y)}))}}if(l==="pay"){const p=e("country"),b=new Map;return p.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,g)=>g[1]-y[1]).map(([y,g])=>({v:y,label:Ot(y,i)||y,n:g,html:!1,on:o.country.includes(y)}))}}if(l==="det"){const p=e("engine"),b=new Map;return p.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Ha([...b.keys()],i).map(y=>({v:y,label:wt(y)+" "+Ve(y,i)+' <span style="color:var(--dim);font-size:10px">· '+Qo(Jo(y),i)+"</span>",n:b.get(y)||0,html:!0,on:o.engine.includes(y)}))}}if(l==="ang"){const p=e("angle"),b=new Map;return p.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,g)=>g[1]-y[1]).map(([y,g])=>({v:y,label:y.replace(/[_-]+/g," "),n:g,html:!1,on:o.angle.includes(y)}))}}if(l==="mem"){const p=e("memoLevel"),b=new Map;p.forEach(g=>{if(g.kind==="target"){const j=pn(g);b.set(j,(b.get(j)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(g=>({v:String(g),label:y[g],n:b.get(g)||0,html:!1,on:o.memoLevel.includes(g)}))}}const u=e("stage"),h=new Map;return u.forEach(p=>{p.stage&&h.set(p.stage,(h.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((p,b)=>b[1]-p[1]).map(([p,b])=>({v:p,label:p,n:b,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),s=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:f.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>s(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function ro({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:d}=$(),c=m.useMemo(()=>{const h={};return r.forEach(p=>{ha(p,n.filters,o)&&(h.monde=(h.monde||0)+1,p.continent&&(h[p.continent]=(h[p.continent]||0)+1))}),h},[r,n.filters,o]),[f,s]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>{if(!f)return;const h=b=>{var y;(y=x.current)!=null&&y.contains(b.target)||s(!1)},p=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",h),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",h),document.removeEventListener("keydown",p)}},[f]);const u=h=>{const p=mn.find(b=>b.key===h);return h==="monde"?d.contWorld:l==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>s(h=>!h),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Rn.map(h=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===h,onClick:()=>{i({type:"continent",key:h}),s(!1)},children:[u(h),t.jsx("span",{className:"n",children:c[h]||0})]},h))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Rn.map(h=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===h,onClick:()=>i({type:"continent",key:h}),children:[u(h),t.jsx("span",{className:"n",children:c[h]||0})]},h)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function oo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Cl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function gr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:d}=$();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function io({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=$(),i=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(gr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(gr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function zl({card:e,onEvaluate:a,onAddAll:r}){var d,c,f;const{t:n}=$(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:oo(e.summary_md||"").map((s,x)=>t.jsx("p",{children:s},x))})]}),t.jsx(io,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Al(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Tl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=$(),d=i,[c,f]=m.useState(null),[s,x]=m.useState(null),[u,h]=m.useState(null),[p,b]=m.useState(!1);m.useEffect(()=>{let g=!0;return(async()=>{const j=await Cr({email:l,cbToken:d});g&&f(j)})(),()=>{g=!1}},[l,d,n]);const y=g=>{x(g),h(null),b(!0),(async()=>{const j=await Xo(g.id);h(j),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),h(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(g=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(g),children:[t.jsx("span",{className:"ti",children:g.title}),t.jsxs("span",{className:"me",children:[Al(g.created_at),g.industry?` · ${g.industry}`:"",g.author?` · ${g.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(g.cited_n||0,g.evaluate_n||0)}),t.jsx("span",{className:"st"+(g.published?" on":""),children:g.published?o.rsPub:o.rsPriv})]},g.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(zl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ua=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function zt(e){return/^https?:\/\//i.test((e||"").trim())}function $a(e){const a=(e||"").trim();return a?zt(a)?a:ua.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function br(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Ll(){var Xt;const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:d,evalCards:c,caps:f,data:s,canWrite:x,source:u,dossiers:h,doAnalyse:p,liveMemos:b,pipe:y}=$(),g=a==="client",j=m.useMemo(()=>r||(u!=="default"?Zo():""),[r,u]),[N,w]=m.useState(""),[C,T]=m.useState(!1),[A,L]=m.useState(""),[z,S]=m.useState(""),[R,_]=m.useState(!1),[M,O]=m.useState(""),[v,q]=m.useState(!1),[H,B]=m.useState(""),[U,W]=m.useState([]),X=m.useRef(!1),[Y,oe]=m.useState(!1),[te,we]=m.useState(!1),[G,pe]=m.useState(!1),xe=m.useRef(!1),[ue,ke]=m.useState(""),[J,Z]=m.useState(""),[K,ee]=m.useState(!1),[me,re]=m.useState(!1),[fe,he]=m.useState(0),[ge,Fe]=m.useState(""),[le,Te]=m.useState(null),[Le,Ue]=m.useState(null),[Je,mt]=m.useState(!1),[dt,ft]=m.useState(null),[ot,E]=m.useState(0),I=m.useRef(!1),V=N.trim()?ua.test(N.trim())?e.evalUrl:e.evalName:e.evalWaiting,ne=m.useMemo(()=>M.split(`
`).map(F=>F.trim()).filter(Boolean).slice(0,15),[M]);m.useEffect(()=>{if(typeof window>"u")return;const F=new URLSearchParams(window.location.search),ae=(F.get("rs")||"").trim(),se=(F.get("rstext")||"").trim();ae&&/^https?:\/\//i.test(ae)&&ke(ae),se&&(Z(se),we(!0)),(ae&&/^https?:\/\//i.test(ae)||se)&&oe(!0)},[]),m.useEffect(()=>{const F=ae=>{const se=ae.detail||{},ve=String(se.url||"").trim(),We=String(se.text||"").trim();ve&&/^https?:\/\//i.test(ve)&&ke(ve),We&&(Z(We),we(!0)),(ve&&/^https?:\/\//i.test(ve)||We)&&(oe(!0),w(""),L(""),ee(!0),window.setTimeout(()=>ee(!1),900))};return window.addEventListener("ppmap:research",F),()=>window.removeEventListener("ppmap:research",F)},[]),m.useEffect(()=>{const F=ae=>{const se=ae.detail||{},ve=String(se.name||"").trim();ve&&(oe(!1),w(ve),L(ve),S($a(String(se.url||""))),T(!0),window.setTimeout(()=>T(!1),900))};return window.addEventListener("ppmap:prefill",F),()=>window.removeEventListener("ppmap:prefill",F)},[]),m.useEffect(()=>{const F=ae=>{var ve;const se=String(((ve=ae.detail)==null?void 0:ve.url)||"").trim();zt(se)&&window.open(se,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",F),()=>window.removeEventListener("ppmap:view",F)},[]),m.useEffect(()=>{if(xe.current===Y)return;xe.current=Y,pe(!0);const F=window.setTimeout(()=>pe(!1),560);return()=>window.clearTimeout(F)},[Y]),m.useEffect(()=>{if(typeof window>"u"||u!=="ops")return;const F=document.querySelector(".atl2.ops .eval-stick")||document.querySelector(".atl2.ops .demand"),ae=document.querySelector(".atl2.ops");if(!F||!ae)return;const se=()=>ae.style.setProperty("--demand-h",`${F.offsetHeight}px`);se();const ve=new ResizeObserver(se);return ve.observe(F),()=>ve.disconnect()},[u,C,K,R,Y,G]),m.useEffect(()=>{if(!x&&!j){ft(null);return}let F=!0;return(async()=>{const ae=await Cr({email:n,cbToken:j});F&&ft(ae.length)})(),()=>{F=!1}},[x,j,n,ot]);const Ce=U.length?U:c,ie=s.credits,be=m.useCallback(F=>{const ae=F.map(se=>(se||"").trim()).filter(Boolean);ae.length&&(O(se=>{const ve=se.split(`
`).map(k=>k.trim()).filter(Boolean),We=new Set(ve.map(k=>k.toLowerCase())),Oe=ae.filter(k=>!We.has(k.toLowerCase()));return[...ve,...Oe].slice(0,15).join(`
`)}),_(!0))},[]);m.useEffect(()=>{if(!me)return;he(0);const F=window.setInterval(()=>he(ae=>ae+1),1e3);return()=>window.clearInterval(F)},[me]);const Ie=m.useMemo(()=>{const F=N.trim().toLowerCase();return!F||!y?null:h.find(ae=>Be(ae.name)===F&&qe(ae)===1)||null},[N,h,y]),Ze=()=>{const F=N.trim();if(F){if(Ie){p(Ie);return}i(null,F),g&&w("")}},xt=async()=>{if(!g){i(null,ne[0]||"");return}if(!ne.length||v)return;q(!0),X.current=!1;const F=[];for(let ae=0;ae<ne.length&&!X.current;ae++){B(e.evaluating(ae+1,ne.length,ne[ae]));const se=await zr(r,ne[ae],"atelier2");if(F.unshift({name:se.company||ne[ae],verdict:se.verdict,reason:se.reason||"",remaining:se.remaining??null}),W([...F]),se.verdict==="quota"){F.unshift({name:"",verdict:"quota",reason:e.quota(ne.length-ae-1),remaining:0}),W([...F]),O(ne.slice(ae+1).join(`
`)),B(""),q(!1);return}}B(""),O(X.current?ne.slice(F.length).join(`
`):""),q(!1)},ct=async()=>{var se,ve,We;if(I.current)return;const F=ue.trim().replace(/\s+/g,""),ae=J.trim();if(!F&&!ae){Fe(e.rsNeed);return}if(!g&&!j){i(null,F||ae.slice(0,80));return}I.current=!0,Fe(""),Te(null),Ue(null),re(!0);try{const Oe=await ti({url:F,text:ae,email:n,cbToken:j});if(re(!1),!Oe||Oe.status!=="success"){Fe((Oe==null?void 0:Oe.message)||"Erreur");return}Te(Oe),oe(!1),be((((se=Oe.prospective)==null?void 0:se.companies_to_evaluate)||[]).map(D=>(D==null?void 0:D.name)||"")),Ue({state:"pending"});const k=await ai(Oe,{email:n,cbToken:j});Ue(k.ok?{state:"ok",scopeLabel:((ve=k.summary)==null?void 0:ve.scope_label)||"",scope:((We=k.summary)==null?void 0:We.scope)||""}:{state:"fail",msg:k.error||""}),k.ok&&E(D=>D+1)}finally{I.current=!1,re(!1)}},ht=[le==null?void 0:le.industry,...(le==null?void 0:le.market_tags)||[],le==null?void 0:le.author].map(F=>(F||"").trim()).filter(Boolean),pt=(Le==null?void 0:Le.state)==="pending",et=Le&&(pt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Le.state==="ok"?t.jsx("span",{className:"rslink ok",children:Le.scope&&Le.scope!=="public"?e.rsSavedIn(Le.scopeLabel||Le.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Le.msg,children:e.rsSaveFail})),za=Cl(le).length,Ee=Y,gt=(A||N).trim(),Et=$a(N)||z||$a(((Xt=h.find(F=>Be(F.name)===Be(gt)))==null?void 0:Xt.url)||""),Aa=Ie?e.actAnalyse:gt?e.evalGoOn(gt.length>22?gt.slice(0,21)+"…":gt):e.evalGo,Ta=me?`${ei(ue.trim())==="youtube"&&ue.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(fe)}`:pt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Ee?" rs-mode":"")+(A&&N.trim()===A||C||K?" pair":"")+(C||K||G?" echo":"")+(G?" swap":""),children:[t.jsxs("div",{className:"drow"+((Ee?K:C)||G?" flash":"")+((Ee?ue.trim():ua.test(N.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Ee?ue:N,placeholder:Ee?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Ee?600:200,spellCheck:Ee?!1:void 0,inputMode:Ee?"url":void 0,onChange:F=>{if(Ee){ke(F.target.value);return}w(F.target.value),A&&F.target.value.trim()!==A&&(L(""),S(""))},onKeyDown:F=>{F.key==="Enter"&&(Ee?ct():Ze())}}),t.jsx("span",{className:"detect"+(Ee?" off":"")+(ua.test(N.trim())?" url":""),children:V})]}),t.jsxs("span",{className:"dacts"+(Ee?" rs":" ev"),children:[t.jsxs("span",{className:"dacts-ev","aria-hidden":Ee,children:[t.jsxs("a",{className:"viewbtn"+(Et?"":" off"),href:Et||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,tabIndex:Ee||!Et?-1:void 0,onClick:F=>{Et||F.preventDefault()},children:[t.jsx(br,{}),e.viewSite]}),t.jsxs("button",{type:"button",className:"evalbtn"+(Ie?" analyse":"")+(d?" loading":""),tabIndex:Ee?-1:void 0,disabled:Ee||d,onClick:Ze,children:[t.jsx("span",{className:"fill"}),Aa]})]}),t.jsxs("span",{className:"dacts-rs","aria-hidden":!Ee,children:[t.jsxs("a",{className:"viewbtn"+(zt(ue)?"":" off"),href:zt(ue)?ue.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,tabIndex:!Ee||!zt(ue)?-1:void 0,onClick:F=>{zt(ue)||F.preventDefault()},children:[t.jsx(br,{}),e.viewLink]}),t.jsxs("button",{type:"button",className:"evalbtn"+(me?" loading":""),tabIndex:Ee?void 0:-1,disabled:!Ee||me||pt||!ue.trim()&&!J.trim(),onClick:()=>{ct()},children:[t.jsx("span",{className:"fill"}),Ta]})]})]}),f.showCredits&&ie&&t.jsxs("button",{type:"button",className:"credits"+(ie.total_available<=0&&!ie.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ie.unlimited?"∞":ie.total_available}),!ie.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ie.daily_grant+ie.purchased]}),ie.total_available<=0&&!ie.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(F=>F.status==="boot"||F.status==="running").map(F=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:F.name}),t.jsx(Ht,{item:F,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+F.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>_(!R),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(Y?" on":""),onClick:()=>oe(!Y),children:e.rsOpen}),dt!==null&&dt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Je?" on":""),onClick:()=>mt(!Je),children:e.rsArchOpen(dt)})]}),Je&&t.jsx(Tl,{bump:ot,cbToken:j,onClose:()=>mt(!1),onEvaluate:F=>i(null,F),onAddAll:be}),t.jsx("div",{className:"rsp slim"+(Y?" on":" off")+(te||J.trim()?" wide":""),"aria-hidden":!Y,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:Y?void 0:-1,onClick:()=>we(F=>!F),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:te||J.trim()?"▴":"▾"})]}),(te||!!J.trim())&&t.jsx("textarea",{className:"rstext",value:J,placeholder:e.rsTextPh,tabIndex:Y?void 0:-1,onChange:F=>Z(F.target.value)})]})}),ge&&t.jsx("div",{className:"rserr",children:ge}),le&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:le.title}),le.source_url&&t.jsx("a",{href:le.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{Te(null),Ue(null)},children:"×"})]}),le.market&&t.jsx("p",{className:"rsmk",children:le.market}),ht.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),ht.map(F=>t.jsx("span",{children:F},F))]}),t.jsxs("div",{className:"rsbody",children:[le.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${le.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:oo(le.summary_md||"").map((F,ae)=>t.jsx("p",{children:F},ae))})]}),t.jsx(io,{card:le,onEvaluate:F=>i(null,F),onAddAll:be}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(za)}),et]})]}),R&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:M,placeholder:e.bulkPh,onChange:F=>O(F.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(v?" loading":""),style:{justifyContent:"center"},disabled:v||!ne.length,onClick:()=>{xt()},children:[t.jsx("span",{className:"fill"}),v&&H?H:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(ne.length)})]})]}),Ce.slice(0,1).map((F,ae)=>{const se=F.verdict==="kept",ve=F.verdict==="quota",We=se?"var(--brand)":ve?"var(--bolt)":"var(--red)",Oe=se?"var(--brand-l)":ve?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":We,"--bgc":Oe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:se?"✓ "+e.kept:ve?"⏳":"✗ "+e.dropped})}),F.name&&t.jsx("span",{className:"rn",children:F.name}),t.jsx("span",{className:"rr",children:F.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",F.reason]}):null}),!!(F.candidates&&F.candidates.length)&&t.jsx("span",{className:"sitepick",children:F.candidates.map(k=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:k.url.startsWith("http")?k.url:`https://${k.url}`,target:"_blank",rel:"nofollow noopener",children:[(k.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,k.url),children:e.evalPickGo})]},k.url))}),!ve&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:se?1:5});const k=(F.name||"").trim().toLowerCase();window.setTimeout(()=>{const D=[...document.querySelectorAll(".atl2 .list .row")].find(P=>{var Q;return(((Q=P.querySelector(".rnm"))==null?void 0:Q.textContent)||"").trim().toLowerCase().includes(k)});D&&(D.scrollIntoView({behavior:"smooth",block:"center"}),D.classList.add("flashrow"),window.setTimeout(()=>D.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(se?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),g&&(o.kept+o.dropped>0||Ce.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function ql(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ml(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=$(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",ql(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const d=ut(o),c=pn(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((f,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Lt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function yn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=$(),[l,d]=m.useState(!1),[c,f]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,x=async()=>{if(!s||l)return;d(!0);const u=await ni(r,e);if(d(!1),!u){o(a.actErr);return}f(u.results||[])};return m.useEffect(()=>{if(!s)return;const u=h=>{var b;const p=String(((b=h.detail)==null?void 0:b.name)||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,s]),m.useEffect(()=>{if(s)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{x()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Rl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),da=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Fl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=da(a.slice(n));break}r+=da(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=da(a.slice(i));break}const l=a.slice(i+1,o).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Rl.has(c)?r+=`<${d[1]}${c}>`:r+=da(a.slice(i,o+1)),n=o+1}return r}const vr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function De({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ol(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Pl({o:e}){const{t:a,doDeep:r}=$(),[n,i]=m.useState(!1),o=ut(e),l=[e.reasoning||"",Ol(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Lt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),i(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function wn({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=$(),o=Qt(e),l=ut(e),d=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Lt(e)?1:0}].filter(b=>b.n>0),[e,a,d,l,c,f,s]),[u,h]=m.useState("");if(!x.length)return null;const p=x.some(b=>b.k===u)?u:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===b.k,"data-tour":"tab-"+b.k,className:p===b.k?"on":"",onClick:y=>{y.stopPropagation(),h(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(De,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(De,{k:a.cdVerdictDate,v:vr(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Fl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Dl,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdSector,v:e.sector}),t.jsx(De,{k:a.cdStage,v:e.stage}),t.jsx(De,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(De,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(De,{k:a.cdAngle,v:e.angle}),t.jsx(De,{k:a.cdDetected,v:vr(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdName,v:e.contactName}),t.jsx(De,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(Pl,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(De,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Dl({o:e}){const{t:a,token:r}=$(),[n,i]=m.useState(!1),[o,l]=m.useState(null),d=async()=>{n||(i(!0),l(await ri(r,e.name,e.website||e.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=f.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[f.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Jt({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const d=()=>{const f=Math.max(280,Math.min(560,o.clientWidth||320));Fn({kind:"op",card:e},f).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;Fn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&o.isConnected&&o.replaceChildren(c)});const d=c=>{c.key==="Escape"&&i(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&Ft.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Il=`
...
`;function Bl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let d=e.y+10;return d+n>o-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function $l(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:d,doAnalyse:c,doDecide:f,doPromote:s,doRepeche:x,doApproach:u,doDeep:h,doOnboard:p,outbound:b,evalBusy:y}=$(),g=e.popupId?r.get(e.popupId):null;if(!g)return null;const j=Re(g),N=qe(g),w=ut(g),C=Qt(g),T=g.kind==="target",A=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Ft.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Il}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Bl(e.popupAnchor,!!g.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:g.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(lt(g.date)),Ve(g.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[g.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[g.cc]}),children:(Ot(g.cc,i)||g.countryLabel||"").toUpperCase()}),g.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[g.sector]}),children:g.sector.toUpperCase()}),g.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[g.stage]}),children:g.stage.toUpperCase()}),typeof g.amountEur=="number"&&g.amountEur>0&&t.jsx("span",{className:"am2",children:Pt(g.amountEur,i)})]}),o.pipe&&T&&t.jsxs("div",{className:"pstat",children:[C&&t.jsx("span",{className:"vd "+(C==="MATCH"?"v-ok":"v-no"),title:n.vt[C],children:C}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[N]}),g.ceoStatus&&t.jsx("span",{className:"pstep own",children:g.ceoStatus})]}),(g.tagline||g.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:g.tagline||g.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[wt(g.engine)," ",t.jsx("b",{children:Ve(g.engine,i)})," — ",oi(g.engine,i),g.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",g.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Nt,{o:g,lg:!0})," ",t.jsx(Ca,{o:g,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(fn(j,i))," · ",n.win7(fa(j,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),g.card?t.jsx(Jt,{spec:g.card}):null,g.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&N>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:g.reasoning})]}),o.pipe&&T&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof g.score=="number"&&g.score>0?" · "+n.score(g.score):""]})}),o.pipe&&T&&t.jsx(wn,{o:g})]}),t.jsx(yn,{name:g.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[N===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(g),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(g.name.length>22?g.name.slice(0,21)+"…":g.name)]}),N===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),N===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),N===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(g,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(g,!1),a({type:"popup",id:null})},children:n.actNo}),Lt(g)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{h(g),a({type:"popup",id:null})},children:n.memoDeep})]}),N===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),N===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),g.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:g.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(g),a({type:"popup",id:null})},children:"🚀"})]}):g.engine==="media"&&g.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(g.name),onClick:()=>d(g),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(g),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(g.name.length>22?g.name.slice(0,21)+"…":g.name)," →"]}),g.website&&t.jsx("a",{className:"psite",href:g.website.startsWith("http")?g.website:"https://"+g.website,target:"_blank",rel:"noopener noreferrer",title:g.website,children:"🌐"})]})]})]}),document.body)}const _l=8;function Ul(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=$(),[d,c]=m.useState(!1),[f,s]=m.useState(!1),[x,u]=m.useState(!1),h=`atl2:sincemini:${r||"home"}`,[p,b]=m.useState(()=>{try{return localStorage.getItem(h)==="1"}catch{return!1}}),y=()=>{b(L=>{try{localStorage.setItem(h,L?"0":"1")}catch{}return!L})},g=r||"home",{names:j,verdicts:N}=m.useMemo(()=>{const L=[],z={};return n.forEach(S=>{S.kind!=="target"||!S.name||(L.push(S.name),z[S.name]=ii(S)||"")}),{names:L,verdicts:z}},[n]),w=m.useMemo(()=>j.length?si(g,j,N,a):null,[g,j.length]);if(!i.pipe||d||!w||w.firstVisit||!w.added.length&&!w.gone.length)return null;const C=f?w.added:w.added.slice(0,_l),T=w.added.length-C.length,A=L=>{const z=n.find(S=>S.name===L);z&&(o(z.id),l({type:"popup",id:z.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(w.added.length,w.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:y,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{c(!0),li(g,j,N,w.fp,a)},children:"×"})]}),!!w.added.length&&t.jsxs("div",{className:"sg-c",children:[C.map(L=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>A(L),children:t.jsx("b",{children:L})},L)),T>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>s(!0),children:e.sinceMore(T)})]}),!!w.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(L=>!L),children:e.sinceOut(w.gone.length)}),x&&w.gone.slice(0,20).map(L=>t.jsx("span",{className:"gone",children:L},L))]})]})}const so={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function kn({o:e,locked:a=!1}){const{t:r}=$(),n=Qt(e),i=ut(e),o=qe(e),l=Ua(e),d=ci(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(so[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(vs,{o:e})]})}const Rt=e=>e.length>22?e.slice(0,21)+"…":e,ma=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ea(e){return ma.has(e.engine||"")}function lo(e){return!!e.noCo||Ea(e)&&!!e.url}function Kt(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function co(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Hl({on:e,rev:a}){const[r,n]=m.useState(null),[i,o]=m.useState({top:0,left:0,width:0});return m.useEffect(()=>{if(!e){n(null);return}const l=()=>{var p,b,y;const d=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!d){n(null);return}const f=d.getBoundingClientRect(),s=c?c.getBoundingClientRect().bottom:f.top;o({top:Math.round(s),left:Math.round(f.left),width:Math.round(f.width)});const x=[...d.querySelectorAll(":scope .grp")];let u=null;for(const g of x){const j=g.querySelector(".grp-h");j&&j.getBoundingClientRect().bottom<=s+2&&(u=g)}if(!u){n(null);return}const h=u.querySelector(".grp-h");if(!h){n(null);return}n({ic:(((p=h.querySelector(".ic"))==null?void 0:p.textContent)||"").trim(),t:(((b=h.querySelector(".t"))==null?void 0:b.textContent)||"").trim(),s:(((y=h.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||i.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:i.top,left:i.left,width:i.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Vl(e){const r=()=>{const n=co(),i=e.getBoundingClientRect().top-n-8;Math.abs(i)<2||window.scrollBy({top:i,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function yr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=$(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),$e(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Rt(e.name))})]})}function jn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:d,doRepeche:c,doApproach:f,dispatch:s,liveMemos:x}=$();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p=>{p.stopPropagation(),s({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Kt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return Ea(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Kt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(yr,{o:e})});const u=qe(e),h=p=>b=>{b.stopPropagation(),p()};if(u===0)return t.jsx("span",{className:"cell",children:t.jsx(yr,{o:e})});if(u===1){const p=x.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ht,{item:p,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:h(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:h(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:h(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(u===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:h(()=>f(e)),children:p?a.actApproachSent:a.actApproach})})}return u===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:h(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):u===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:h(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:h(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Wl({o:e}){const{t:a,doThumb:r,thumbOf:n}=$(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Yl({o:e}){const{lang:a}=$();return Re(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Nt,{o:e}),t.jsx(Ca,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[wt(e.engine||"")," ",Ve(e.engine||"",a)]})})}function Gl({o:e,locked:a,open:r,onToggle:n,selected:i,echo:o,onSelect:l}){const{dispatch:d,caps:c,markRow:f,markedId:s,favIds:x,toggleFav:u,t:h}=$(),p=qe(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,g=y<=0?0:y<=7?1:y<=30?2:3,j=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][p]:b[g],N=x.has(e.id),w=C=>{if(a)return;if(l){l(e.id);return}if(c.pipe||e.kind==="op"){n();return}const T=C.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:T.left+Math.min(280,T.width/3),y:T.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(o?" echo":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>f(e.id),onMouseLeave:()=>f(null),onClick:w,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(xo,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:N?1:.35,padding:0,marginRight:4},onClick:C=>{C.stopPropagation(),u(e)},children:N?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(C=>C&&C!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:h.acqSee(e.acquirer),onClick:C=>{C.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",Rt(e.acquirer)]}),rt(e)?t.jsx("span",{className:"rdec",title:h.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:h.zoomNewsMark,children:"📰"}):null]}),t.jsx(Kl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Yl,{o:e}),c.pipe&&t.jsx(kn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(jn,{o:e}),c.showThumbs&&t.jsx(Wl,{o:e})]}),r&&!a&&!l&&t.jsx(Xl,{o:e})]})}function Kl({o:e}){const{lang:a,caps:r}=$();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Pt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Ql({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=$(),l=(u,h=!1)=>p=>{p.stopPropagation(),h&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Pt(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=$e(e),x=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):lo(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),Kt(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Rt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Rt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Jt,{spec:e.card})})]})}function Jl({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=$();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ve(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(jn,{o:e})}),t.jsx(wn,{o:e})]})}function po({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:d,dossiers:c}=$();if(!e&&!a){const M=c.find(rt);if(M)return t.jsx(po,{o:M})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),s=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),x=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),h=e?!!e.noCo:!f||xa(f),p=(e==null?void 0:e.engine)||"",b=rt(e),y=e?Pt(e.amountEur,n):"",g=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),j=(()=>{const M=/https?:\/\/(?:www\.)?([^/]+)/.exec(s);return M?M[1].replace(/^www\./,"").slice(0,40):""})(),N=c.find(rt),w=((N==null?void 0:N.url)||"").trim(),C=!!s&&!!w&&(s===w||s.endsWith(w)||w.endsWith(s)),T=(M,O=!1)=>v=>{v.stopPropagation(),O&&l({type:"continent",key:"monde"}),l({type:"filters",patch:M})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const A=()=>{f&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:f}}))},L=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},z=()=>{Kt({url:s,headline:x,tagline:e==null?void 0:e.tagline,name:f})},S=e?$e(e):!1,R=S&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",_=b?r.doEdito.replace(/^📖\s*/,""):p?Ve(p,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[_,g?` · ${g}`:""]}),t.jsx("h3",{className:"zoom-h",children:x}),s&&!b&&(h||Ea({engine:p}))&&t.jsxs("a",{className:"zoom-ext",href:s,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:M=>M.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,j?t.jsx("em",{children:j}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{className:"ed-decrypt-b zoom-body",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:T({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:T({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:T({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(Jt,{spec:u})}),(s&&!C&&!b||N&&!b)&&t.jsxs("div",{className:"zoom-srcbox",children:[s&&!C&&!b&&t.jsxs("a",{className:"zoom-src",href:s,target:"_blank",rel:"nofollow noopener",onClick:M=>M.stopPropagation(),children:[r.zoomSrc,j?` · ${j}`:""," ↗"]}),N&&!b&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:M=>{M.stopPropagation(),l({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[S?t.jsxs("span",{className:"verdict",style:{"--c":R?"var(--brand)":"var(--red)"},children:[R?"✓":"✗"," ",t.jsx("b",{children:R?r.kept:r.dropped})]}):!h&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:o,onClick:M=>{M.stopPropagation(),i(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Rt(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,s&&!b&&(h||Ea({engine:p}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!h&&f?" ghost":""),onClick:M=>{M.stopPropagation(),z()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!h&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:M=>{M.stopPropagation(),L()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:M=>{M.stopPropagation(),A()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Rt(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!h&&f&&d.pipe&&t.jsx(yn,{name:f})]})]})}function Xl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=$();return!i.pipe&&e.kind==="op"?t.jsx(Ql,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(wn,{o:e}),t.jsx(ys,{o:e}),t.jsx(js,{o:e}),t.jsx(yn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(kn,{o:e})})]}),e.card&&t.jsx(Jt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[wt(e.engine||"")," ",Ve(e.engine||"",r)]}),Re(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Nt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Zl({o:e,locked:a,selected:r,onSelect:n}){const{t:i,dispatch:o,caps:l,doDecide:d,lang:c}=$();if(!l.pipe&&e.kind==="op"){const x=Pt(e.amountEur,c),u=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),h=(p,b=!1)=>y=>{y.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Jt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:h({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:h({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:h({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[wt(e.engine||"")," ",Ve(e.engine||"",c)]}),Re(e)&&t.jsx(Nt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(jn,{o:e})})]})}const f=qe(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][f];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(kn,{o:e}),Re(e)&&t.jsx(Nt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&f===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:i.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:i.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>o({type:"memoConsole",id:e.id}),children:[i.actMemo," →"]})]})}function ed(){const{t:e}=$(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function td({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=i==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,x)=>(e[x]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${l(c)}”`:`${f} dossier${f>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(o?"Open ":"Ouvrir ")+l(c)," →"]})]})}function ad(){var ft,ot;const e=$(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:d,markRow:c,lang:f,sessTally:s,data:x,dossiers:u,source:h,focusExtra:p,byId:b}=e,y=E=>i.lockRowsAfter!==null||h==="ops"?Number.MAX_SAFE_INTEGER:Tr,[g,j]=m.useState(new Set);m.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[N,w]=m.useState(null);m.useEffect(()=>{w(null)},[a.ptab,a.continent]);const[C,T]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){T(!1);return}const E=document.getElementById("atl2-stage");if(!E){T(!1);return}const I=new IntersectionObserver(([V])=>T(!!V&&V.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return I.observe(E),()=>I.disconnect()},[a.mapFolded]);const A=a.mapFolded||!C,L=E=>j(I=>{const V=new Set(I);return V.has(E)?V.delete(E):V.add(E),V}),z=h==="ops"||i.pipe,[S,R]=m.useState("all"),[_,M]=m.useState(null),[O,v]=m.useState(!1),q=m.useRef(!0);m.useEffect(()=>{if(q.current){q.current=!1;return}R("all"),v(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!O)return;const E=I=>{var V,ne;(ne=(V=I.target)==null?void 0:V.closest)!=null&&ne.call(V,".atl2 .doable")||v(!1)};return document.addEventListener("click",E),()=>document.removeEventListener("click",E)},[O]);const H=qr(),B=m.useMemo(()=>{var I;const E=new Map;for(const V of is(((I=H==null?void 0:H.ed)==null?void 0:I.html)||""))E.has(V.t)||E.set(V.t,V.html);return E},[(ft=H==null?void 0:H.ed)==null?void 0:ft.html]),U=m.useCallback(E=>{if(E.decryptHtml)return E.decryptHtml;if(!B.size)return;const I=(E.name||"").trim().toLowerCase();if(I.length<3)return;const V=B.get(I);if(V)return V;for(const[ne,Ce]of B)if(ne.includes(I)||I.includes(ne))return Ce},[B]),W=m.useMemo(()=>{let E=xn(l,a.sort);return E=E.filter(I=>!rt(I)),S==="explore"?E=E.filter(I=>!!I.noCo):S==="eval"&&(E=E.filter(I=>!I.noCo)),E},[l,a.sort,S,U]),X=m.useMemo(()=>i.pipe?d.filter(E=>Re(E)&&di(E)):W.filter(E=>Re(E)&&!$e(E)),[i.pipe,d,W]),Y=X.length,[oe,te]=m.useState(!1),[we,G]=m.useState(!1),pe=`atl2:sigmini:${((ot=x.session)==null?void 0:ot.token)||"home"}`,[xe,ue]=m.useState(()=>{try{return localStorage.getItem(pe)==="1"}catch{return!1}}),ke=m.useMemo(()=>i.pipe?W:W.filter(E=>!$e(E)&&!E.noCo),[W,i.pipe]),J=h==="ops"?W.filter(E=>E.noCo).length:0,Z=i.pipe?n.plabels[a.ptab].toLowerCase():h==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,K=a.filters,ee=[];if(K.day)ee.push({k:"day",lib:n.fDay(K.day.slice(8,10)+"/"+K.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(K.win&&K.win!=="all"){const E=["1","7","30"].indexOf(K.win);E>=0&&ee.push({k:"win",lib:n.dates[E],off:()=>r({type:"filters",patch:{win:"all"}})})}const me=E=>E.length<=2?E.join(", "):`${E.length} ${n.fSelected}`;for(const E of["sector","country","engine"]){const I=K[E];I&&I.length&&ee.push({k:E,lib:me(I),off:()=>r({type:"clearFacet",facet:E})})}K.search&&ee.push({k:"search",lib:"🔍 "+K.search,off:()=>r({type:"filters",patch:{search:""}})});const re=(E,I,V="",ne=!1)=>t.jsxs("button",{type:"button","data-s":E,className:V,"aria-sort":a.sort.key===E?a.sort.dir===1?"ascending":"descending":"none",style:ne?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:E}),children:[I,t.jsx("span",{className:"ar",children:a.sort.key===E&&a.sort.dir===1?"▴":"▾"})]},E),fe=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const E=new Map;W.forEach(ne=>{const Ce=ne.engine||"?";E.has(Ce)||E.set(Ce,[]),E.get(Ce).push(ne)});const I={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},V=Ha([...E.keys()],f);return[...E.entries()].sort((ne,Ce)=>{const ie=I[ne[0]]??10+V.indexOf(ne[0]),be=I[Ce[0]]??10+V.indexOf(Ce[0]);return ie-be})},[W,i.pipe,a.groupBy,f]),he=fe?fe.filter(([E])=>ma.has(E)).length:0,ge=(()=>{var I;return((I=(fe?fe.flatMap(([,V])=>V):W)[0])==null?void 0:I.id)??null})(),Fe=m.useRef(!1),le=m.useMemo(()=>u.find(rt)||null,[u]);m.useEffect(()=>{const E=()=>{Fe.current=!0};return window.addEventListener("ppmap:reveal",E),window.addEventListener("ppmap:focus",E),()=>{window.removeEventListener("ppmap:reveal",E),window.removeEventListener("ppmap:focus",E)}},[]),m.useEffect(()=>{const E=()=>{le&&r({type:"focus",id:le.id})};return window.addEventListener("ppmap:edito",E),()=>window.removeEventListener("ppmap:edito",E)},[le,r]),m.useEffect(()=>{if(!a.focusId)return;M(a.focusId);const E=window.setTimeout(()=>M(null),900);return()=>window.clearTimeout(E)},[a.focusId]),m.useEffect(()=>{z&&(a.focusId&&(W.some(E=>E.id===a.focusId)||u.some(E=>E.id===a.focusId))||p||ge&&r({type:"focus",id:ge}))},[z,a.focusId,W,ge,p,r,u]),m.useEffect(()=>{if(!(!z||!a.focusId)&&S!=="all"&&!W.some(E=>E.id===a.focusId)&&u.some(E=>E.id===a.focusId)){if(Fe.current){R("all");return}ge&&r({type:"focus",id:ge})}},[z,a.focusId,S,W,u,ge,r]),m.useEffect(()=>{if(!z||!a.focusId||!Fe.current)return;Fe.current=!1;const E=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel");if(!E)return;const I=co(),V=E.getBoundingClientRect();V.top>=I-2&&V.bottom<=window.innerHeight-4||Vl(E)},[z,a.focusId]),m.useEffect(()=>{if(typeof window>"u")return;const E=document.querySelector(".atl2.ops .listhead"),I=document.querySelector(".atl2.ops");if(!E||!I)return;const V=()=>I.style.setProperty("--listhead-h",`${E.offsetHeight}px`);V();const ne=new ResizeObserver(V);return ne.observe(E),()=>ne.disconnect()},[A,a.dens,a.mapFolded]);const Te=m.useMemo(()=>{if(!z||!a.focusId)return null;const E=W.find(V=>V.id===a.focusId)||u.find(V=>V.id===a.focusId)||null;if(!E)return null;const I=U(E);return I&&I!==E.decryptHtml?{...E,decryptHtml:I}:E},[z,a.focusId,W,u,U]),Le=i.lockRowsAfter;let Ue=0;const Je=(E,I)=>{let V=a.shown[I]||y();return E.length-V<=4&&(V=E.length),E.slice(0,V).map(ie=>{const be=Le!==null&&Ue>=Le;Ue++;const Ie=U(ie),Ze=Ie&&Ie!==ie.decryptHtml?{...ie,decryptHtml:Ie}:ie,xt=!z&&a.dens!=="maxi"&&(a.dens==="deplie"||(N?N==="open":!!Ie)),ct=g.has(ie.id)?!xt:xt,ht=z?pt=>{Fe.current=!0,r({type:"focus",id:pt});const et=b.get(pt);et&&(lo(et)?Kt(et):et.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:et.name,url:et.url||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Zl,{o:Ze,locked:be,selected:z&&a.focusId===ie.id,onSelect:ht},ie.id):t.jsx(Gl,{o:Ze,locked:be,open:ct,onToggle:()=>L(ie.id),selected:z&&a.focusId===ie.id,echo:_===ie.id,onSelect:ht},ie.id)})},mt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(h==="ops"?" opsl":"")+(W.length?"":" list-empty"),dt=t.jsxs(t.Fragment,{children:[fe?fe.map(([E,I])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:wt(E)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:E==="ma"?n.grpMa:E==="fundraising"?n.grpLev:ma.has(E)&&he<=1?n.grpNews:E==="nominations"?n.grpNom:E==="media"?n.grpNewsOther:E==="recrutements"?n.grpHire:ma.has(E)?n.grpNews+" · "+Ve(E,f):Ve(E,f)}),t.jsx("div",{className:"s",children:n.grpCount(I.filter(V=>!$e(V)).length,I.length)})]})]}),Je(I,E)]},E)):Je(W,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(ed,{}),!W.length&&!(x.loading&&!u.length)&&(i.pipe?t.jsx(td,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(A?" mapoff":""),children:[t.jsxs("div",{className:"lh-top",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:W.length})," ",Z]}),t.jsx("span",{className:"dot",children:"·"}),A&&t.jsx(ro,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[A?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),ee.map(E=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:I=>{I.stopPropagation(),E.off()},children:[E.lib,t.jsx("i",{children:"×"})]},E.k)),h==="ops"&&W.length>0&&!A&&" — "+n.edSplit(W.length-J,J)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||h==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([E,I])=>t.jsxs("button",{type:"button","data-d":E,"aria-pressed":a.dens===E||E==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:E}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:I})]},E))}),!z&&i.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":N==="open",onClick:()=>{w("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":N==="closed",onClick:()=>{w("closed"),j(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||h==="ops")&&(()=>{var ie;const E=l.filter(be=>!rt(be)),I=E.filter(be=>!be.noCo).length,V=E.filter(be=>!!be.noCo).length,ne=[["all",n.doAll],["eval",`${n.doEval}${I?` ${I}`:""}`],["explore",`${n.doExplore}${V?` ${V}`:""}`]],Ce=((ie=ne.find(([be])=>be===S))==null?void 0:ie[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":O,onClick:()=>v(be=>!be),children:[Ce,t.jsx("i",{children:"▾"})]}),O&&t.jsx("div",{className:"dolist",children:ne.map(([be,Ie])=>t.jsx("button",{type:"button","aria-pressed":S===be,onClick:()=>{R(be),v(!1)},children:Ie},be))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:E=>r({type:"sort",key:E.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([E,I])=>t.jsx("option",{value:E,children:I},E))})]}),i.showChain&&ke.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ke.map(E=>E.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(ke.length):n.chainAll(ke.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]}),A&&t.jsx("div",{className:"lh-tools",children:t.jsx(no,{compact:!0})})]}),t.jsx(Ul,{}),Y>0&&!a.filters.signalOnly&&!we&&t.jsxs("div",{className:"sigstrip"+(xe?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(Y)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!xe,title:xe?n.boxExpand:n.boxCollapse,onClick:()=>ue(E=>{try{localStorage.setItem(pe,E?"0":"1")}catch{}return!E}),children:xe?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>G(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(oe?X:X.slice(0,12)).map(E=>{const I=Re(E);return I?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(fn(I,f),fa(I,f)),onClick:()=>{c(E.id),r({type:"popup",id:E.id})},children:[t.jsx("b",{children:E.name}),t.jsxs("i",{children:[I.emoji," ",Va(I,f)]}),t.jsx("em",{children:fa(I,f)})]},"sg-"+E.id):null}),!oe&&X.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>te(!0),children:n.sigStripMore(X.length-12)})]})]}),a.dens!=="maxi"&&!z&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),re("country",n.colCountry),re("name",n.colCompany),re("amount",n.colAmount,"h-amt",!0),re("stage",n.colStage,"h-stade"),re("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[re("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),re("memo",n.colMemo)]}),i.pipe&&re("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),z?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),re("country",n.colCountry),re("name",n.colCompany),re("amount",n.colAmount,"h-amt",!0),re("stage",n.colStage,"h-stade"),re("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:mt,children:dt})]}),t.jsxs("aside",{className:"readpane"+(h==="ops"&&(Te?rt(Te):!p)?" is-edito":""),"aria-label":f==="fr"?"Dossier":"File",children:[h==="ops"&&le&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===le.id,onClick:()=>r({type:"focus",id:le.id}),children:n.doEdito}),i.pipe?t.jsx(Jl,{o:Te}):t.jsx(po,{o:Te,extra:Te?null:p})]})]}):t.jsx("div",{className:mt,children:dt}),(()=>{const E=fe||[["pt"+a.ptab,W]];let I=0,V=0;for(const[Ce,ie]of E){V+=ie.length;let be=a.shown[Ce]||y();ie.length-be<=4&&(be=ie.length),I+=Math.min(ie.length,be)}const ne=V-I;return ne<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>E.forEach(([Ce,ie])=>r({type:"more",group:Ce,by:ie.length,base:y()})),children:[t.jsx("span",{className:"more-label",children:n.more(ne,ne)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(I,V)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}}),z&&h==="ops"&&a.dens!=="maxi"&&t.jsx(Hl,{on:!!fe,rev:(fe||[]).map(([E,I])=>E+I.length).join("|")})]})}function wr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function nd(e,a){const r=pi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function rd(e,a){const n=[a.head.split("|").map(wr).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",nd(i,a.plabels),Qt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(wr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function od(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const id=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function tt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function sd({o:e,qa:a}){const{t:r,lang:n,fund:i}=$(),o=(e.cribleStatus||"").trim().toUpperCase()||(Qt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=ut(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(tt,{k:r.cdSector,v:e.sector}),t.jsx(tt,{k:r.cdStage,v:e.stage}),t.jsx(tt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(tt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(tt,{k:r.cdName,v:e.contactName}),t.jsx(tt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(tt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(tt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(tt,{k:r.cdAngle,v:e.angle}),t.jsx(tt,{k:r.cdDetected,v:id(e.date,n)})]}),c.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,f])=>f).map(([f,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:s})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function ld(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=$(),[d,c]=m.useState({}),f=25,s=m.useMemo(()=>n.slice(0,f),[n]);m.useEffect(()=>{s.length&&ui(r,s.map(h=>h.name)).then(c)},[r,s]);const x=o.stats,u=h=>h.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(x.screened/o.marketEstimate*100)," %"]})]})]}),s.map(h=>t.jsx(sd,{o:h,qa:d[h.name]},h.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const dd=50;function Nn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=$(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(0),[h,p]=m.useState(""),[b,y]=m.useState(!1),g=m.useRef(null);m.useEffect(()=>()=>{g.current&&window.clearInterval(g.current)},[]);const j=async w=>{c(!0),s("");const C=await a();if(c(!1),C.ok){l(C);return}if(C.busy){s(i.alertPreviewBusy);return}if(!w){s(i.alertPreviewFail);return}u(dd),g.current=window.setInterval(()=>{u(T=>T>1?T-1:(g.current&&window.clearInterval(g.current),j(!1),0))},1e3)},N=async()=>{if(n||b)return;y(!0),p("");const w=await r();y(!1),p(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||x>0,onClick:()=>{j(!0)},children:d?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{N()},children:b?"…":i.alertTest})]}),x>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(x)}),f&&t.jsx("p",{className:"mnote warn",children:f}),h&&t.jsx("p",{className:"mnote",children:h}),!h&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const Tt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function _e({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=$();return Ft.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function cd(){const{st:e}=$();switch(e.modal){case"chain":return t.jsx(ud,{});case"space":return t.jsx(md,{});case"alert":return t.jsx(fd,{});case"queue":return t.jsx(vd,{});case"export":return t.jsx(yd,{});case"plug":return t.jsx(jd,{});case"recharge":return t.jsx(Sd,{});case"cover":return t.jsx(Cd,{});case"dossier":return t.jsx(Ed,{});case"crit":return t.jsx(zd,{});case"tuto":return t.jsx(Ad,{});case"rdv":return t.jsx(pd,{});case"memoalert":return t.jsx(wd,{});default:return null}}function pd(){const{dispatch:e,fund:a,t:r}=$(),n=a||r.rdvCoFallback;return Ft.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Fr,children:gn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${ga}`,children:ga})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Pi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function ud(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:d,caps:c,memoQueued:f,doAnalyse:s}=$(),x=o==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),h=e.chain.idx,p=u[h],b=h>=u.length;return Ft.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${h+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:h/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[Ot(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(lt(p.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ve(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:Pt(p.amountEur,i)})]}),Re(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Nt,{o:p,lg:!0})," ",t.jsx(Ca,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),x&&$e(p)&&t.jsxs("div",{className:"vbox",style:{"--c":yt(p)==="retenu"?"var(--brand)":yt(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:yt(p)==="retenu"?"✓ "+n.kept:yt(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&p&&c.pipe&&qe(p)===1&&!f.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&p&&!(x&&$e(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function md(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=$(),o=i==="client",l=m.useMemo(()=>o?r.filter(x=>$e(x)):[],[r,o]),d=m.useMemo(()=>xn(l.filter(x=>yt(x)==="retenu"),{key:"signal",dir:-1}),[l]),c=m.useMemo(()=>l.filter(x=>yt(x)==="ecarte"),[l]),f=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(_e,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function fd(){const{mode:e}=$();return e==="client"||e==="apercu"?t.jsx(xd,{}):t.jsx(bd,{})}function xd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),[o,l]=m.useState("d"),d=i!=="client";return t.jsxs(_e,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(hd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="w"&&t.jsx(gd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="m"&&t.jsx(uo,{})]})}function hd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),Dn(a).then(b=>{p&&(b?l(b):c(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||Dn(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),h=p=>{const b=o.sections||e.alertSec.map(([y])=>y);x({sections:u(p)?b.filter(y=>y!==p):[...b,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>h(p)}),t.jsxs("span",{children:[b,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Nn,{label:e.alertPreview,readOnly:r,onPreview:()=>ki(a),onTest:()=>wi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function gd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),In(a).then(b=>{p&&(b?l(b):c(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||In(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,h=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>x({dow:Number(p.target.value)}),children:e.alertDow.map((p,b)=>t.jsx("option",{value:b,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,h-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[h," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,h+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Nn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Ni(a),onTest:()=>ji(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function uo(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=$(),[l,d]=m.useState(o||""),[c,f]=m.useState(!1),[s,x]=m.useState(!1);m.useEffect(()=>{o&&d(o)},[o]);const u=e.filters,h=m.useMemo(()=>n.filter(g=>Re(g)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){x(!0);try{await fetch(`${cn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{x(!1)}}},y=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(g=>Ve(g,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(g=>Ot(g,r)||g).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([g,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:g}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},g))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:g=>d(g.target.value),onKeyDown:g=>{g.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,h)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function bd(){const{t:e}=$();return t.jsx(_e,{title:e.alertTitle,icon:"🔔",children:t.jsx(uo,{})})}function vd(){var L,z;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:d,dispatch:c,liveMemos:f}=$(),[s,x]=m.useState(null),[u,h]=m.useState([]),[p,b]=m.useState(0),y=n==="client",g=m.useMemo(()=>{const S=new Map;return i.forEach(R=>{const _=(R.name||"").trim().toLowerCase();_&&!S.has(_)&&S.set(_,R)}),S},[i]);m.useEffect(()=>{let S=!0;return(async()=>{const[R,_]=await Promise.all([un(r),Er(a)]);S&&(R&&x(R),h(_))})(),()=>{S=!1}},[a,r,p]);const j=(s==null?void 0:s.per_day)??0,N=((L=s==null?void 0:s.analyzed_today)==null?void 0:L.length)??0,w=s==null?void 0:s.offre,C=(s==null?void 0:s.pool_meta)||[],T=m.useMemo(()=>{const S=new Map;for(const R of(s==null?void 0:s.scheduled)||[])for(const _ of R.names||[])S.has(_)||S.set(_,{label:R.day_label,date:R.date});return S},[s==null?void 0:s.scheduled]),A=(s==null?void 0:s.in_progress)||[];return t.jsxs(_e,{title:e.queueTitle,wide:!0,children:[w&&t.jsxs("div",{className:"qoffre"+(w.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:w.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:w.delai})]}),t.jsx("span",{className:"osp"}),w.rythme>0?t.jsx("span",{className:"or",children:e.qRate(w.rythme)}):w.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(w.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(N,N+(((z=s==null?void 0:s.pool_order)==null?void 0:z.length)??0))}})}),w&&t.jsxs("div",{className:"qeta",children:[w.file===0?e.qEtaDone:w.rythme<=0?e.qEtaPaused:e.qEta(w.file,w.rythme,w.jours_restants),w.en_retard&&t.jsxs("em",{children:[" ",e.qLate(w.delai,w.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(w==null?void 0:w.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(A.length>0||f.items.some(S=>S.status==="boot"||S.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[f.items.filter(S=>S.status==="boot"||S.status==="running"||S.status==="error").map(S=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:S.name}),t.jsx("span",{className:"qd",children:S.memoType||""}),t.jsx(Ht,{item:S,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+S.name)),A.filter(S=>!f.liveOf(S.name)).map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.name}),t.jsxs("span",{className:"qd",children:[S.memo_type||"",S.age_min?` · ${Math.round(S.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:S.state||""})]},"ip-"+S.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.company}),t.jsxs("span",{className:"qd",children:[S.memo_type,typeof S.est_min=="number"?` · ~${S.est_min} min`:""]}),t.jsx("span",{className:"qt",children:S.status}),S.url&&t.jsx("a",{className:"qgo",href:S.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),y&&S.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Pn(a,S.company,"retry").then(()=>b(R=>R+1))},children:e.queueRetry}),y&&S.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Pn(a,S.company,"delete").then(()=>b(R=>R+1))},children:e.queueDelete})]},S.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(C.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[C.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),C.map((S,R)=>{const _=T.get(S.name),M=g.get((S.name||"").trim().toLowerCase()),O=f.liveOf(S.name),v=!!(M&&l.has(M.id))||!!(O&&(O.status==="boot"||O.status==="running")),q=!!(M&&qe(M)===1&&!M.memoUrl)&&!O;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),_?t.jsx("span",{className:"qwhen"+(_.label==="demain"?" soon":""),children:_.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:S.name}),S.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof S.score=="number"&&t.jsx("span",{className:"qs2",children:S.score}),O&&(O.status==="boot"||O.status==="running")&&t.jsx(Ht,{item:O,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),q&&(d.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:v,onClick:()=>{o(M),b(H=>H+1)},children:v?e.actAnalyseQueued:e.actAnalyse})),S.excerpt&&t.jsx("span",{className:"qex",children:S.excerpt})]},S.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([S,R])=>t.jsxs("li",{children:[t.jsx("b",{children:S})," — ",R]},S))})]})}function yd(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=$(),d=`${Tt}/cibles/list.csv?token=${a}`,c=`${Tt}/cibles/list.json?token=${a}`,f=`${Tt}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,x=y=>{var g;(g=navigator.clipboard)==null||g.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:f,href:f}],h=!i.lockActions&&n.length>0,p=()=>{od(rd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:y=>(e.stg.find(([g])=>g===y)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(_e,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:g,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(g),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function wd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),o=i!=="client",[l,d]=m.useState(null),[c,f]=m.useState(!1),[s,x]=m.useState(0),[u,h]=m.useState(!1);m.useEffect(()=>{let g=!0;return f(!1),On(a).then(j=>{g&&(j?d(j):f(!0))}),()=>{g=!1}},[a,s]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=g=>{if(o||!l)return;const j={enabled:g.enabled??!!l.enabled,email:g.email??(l.email||""),sections:g.sections??p()};h(!0),On(a,j).then(N=>{if(h(!1),!N){n(e.memoAlertErr);return}d(N),r(e.memoAlertSaved)})};if(c)return t.jsx(_e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(g=>g+1),children:e.retry})]})});if(!l)return t.jsx(_e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=p();return t.jsxs(_e,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(kd,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:g=>b({email:g})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([g,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[g],disabled:o||u,onChange:()=>b({sections:{...y,[g]:!y[g]}})}),t.jsx("span",{children:j})]},g))}),t.jsx(Nn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>fi(a,y),onTest:()=>mi(a,y)})]})}function kd({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const d=o.trim()!==e.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&d&&c&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>i(o.trim()),children:n})]})]})}function jd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=$(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(null),[x,u]=m.useState(""),[h,p]=m.useState(0);m.useEffect(()=>{let N=!0;return c(!1),Wa(a).then(w=>{N&&(w?l({configured:w.configured,url_hint:w.url_hint}):c(!0))}),gi(a).then(w=>{N&&s(w)}),()=>{N=!1}},[a,h]);const b=(N,w)=>{i&&Wa(a,N).then(C=>{if(!C||C.ok===!1){n(e.actErr);return}N.test&&C.sent===!1?n(e.plugTestThrottled):r(w),p(T=>T+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',g=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${Tt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(_e,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(N=>N+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!i,onChange:N=>u(N.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!x.trim(),onClick:()=>b({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:g}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(g).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Nd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Nd(){const{t:e,token:a,lang:r}=$(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[d,c]=m.useState(null),[f,s]=m.useState(null),[x,u]=m.useState(!1),[h,p]=m.useState(!1),[b,y]=m.useState(null),[g,j]=m.useState(null),[N,w]=m.useState(null),C=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Wa(a).then(_=>{j(_&&_.configured?_.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{c(null),s(null),u(!1),y(null);try{const _=JSON.parse(localStorage.getItem(C)||"null");w(_&&Date.now()-Date.parse(_.t)<24*3600*1e3?_:null)}catch{w(null)}},[C]);const T=async()=>{l(!0),u(!1),y(null);const _=await vi(a,n);c(_),s(_.ok?n:null),l(!1)},A=m.useRef(!1),L=async()=>{if(A.current)return;A.current=!0,p(!0);const _=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await yi(a,n,"webhook",void 0,_)}finally{A.current=!1}if(p(!1),u(!1),y(M),M.ok&&(M.pushed||0)>0){const O={t:new Date().toISOString(),n:M.pushed||0};w(O);try{localStorage.setItem(C,JSON.stringify(O))}catch{}}},z=d!=null&&d.ok&&d.ready||0,S=!!(d!=null&&d.ok)&&f===n&&z>0&&!!g&&!N,R=N?new Date(N.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:_=>i(_.target.value),children:e.plugBulkTabs.map(([_,M])=>t.jsx("option",{value:_,children:M},_))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{T()},children:o?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),N&&t.jsx("p",{className:"mnote",children:e.bulkLocked(R,N.n)}),!N&&!!(d!=null&&d.ok)&&!g&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!N&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),S&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),S&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(z,g||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:h,onClick:()=>{L()},children:h?e.bulkSending:e.bulkConfirm(g||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:h,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function Sd(){const{t:e,data:a,lang:r}=$(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const d=window.location.href.split("?")[0];try{const f=await(await fetch(`${cn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(_e,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Ed(){const{t:e}=$();return t.jsx(_e,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(ld,{})})}function Cd(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:d}=$(),[c,f]=m.useState(null),[s,x]=m.useState(!1);m.useEffect(()=>{let z=!0;if(o)return un(o).then(S=>{z&&S&&typeof S.per_day=="number"&&f(S.per_day)}),()=>{z=!1}},[o]);const[u,h]=m.useState(null);m.useEffect(()=>{if(!i)return;let z=!0;return hi(i).then(S=>{z&&h(S)}),()=>{z=!1}},[i]);const p=r.stats,b=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(z=>z.kind==="target"&&$e(z)).length,y=r.marketEstimate||0,g=y>0?Math.min(100,Math.round(b/y*100)):null,j=(p==null?void 0:p.window_days)||30,N=b>0?b/j:0,w=y>0?Math.max(0,y-b):0,T=y>0&&N>0&&b>=100?Math.round(w/N):null,A=z=>Math.round(z).toLocaleString(a==="en"?"en-US":"fr-FR"),L=z=>{s||!l||(x(!0),bi(i,z).then(S=>{if(x(!1),S===null){d(e.actErr);return}f(S),d(e.alertSaved)}))};return t.jsxs(_e,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(A(b))}),y>0&&t.jsx("span",{children:e.covOf(A(y))})]}),g!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:g+"%"}}),t.jsxs("em",{children:[g," %"]})]}),T!==null&&t.jsx("p",{className:"mnote",children:e.covEta(T)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),N>=1&&t.jsx("p",{className:"mnote",children:e.covPace(A(N))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((z,S)=>t.jsxs("tr",{className:z.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[z.code,z.geo?` · ${z.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof z.n=="number"?A(z.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:z.source}),z.elargi&&t.jsx("em",{children:e.covWide(String(z.demande||""))}),z.erreur&&t.jsx("em",{children:e.covMissing})]})]},S)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:A(u.total||y)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:A(p.shown)})," ",e.funShown]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(z=>t.jsx("button",{type:"button",className:c===z?"on":"",disabled:s,onClick:()=>L(z),children:z===0?"⏸":z},z))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function zd(){var g,j,N;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:d}=$(),c=n==="client",f=m.useMemo(()=>{const w=new Set;return a.forEach(C=>{C.angle&&w.add(C.angle)}),[...w]},[a]),[s,x]=m.useState(""),[u,h]=m.useState(""),[p,b]=m.useState(!1),y=async()=>{const w=s.trim();if(!(!w||p||!c)){b(!0),h("");try{const T=await(await fetch(`${Tt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&h(String(T.reply)),T.job_id){h(e.critChatRunning);const A=async()=>{const L=await fetch(`${Tt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(z=>z.json()).catch(()=>null);if(L&&L.done){h(String(L.reply||L.clarification||L.summary||"✓")),b(!1),L.applied&&i(e.alertSaved);return}setTimeout(()=>{A()},8e3)};setTimeout(()=>{A()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(_e,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((g=o.points)!=null&&g.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=o==null?void 0:o.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var C,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((C=w.look)!=null&&C.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(A=>t.jsx("li",{children:A},A))})]}),!!((T=w.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(A=>t.jsx("li",{children:A},A))})]})]})]},w.title)})]}),!!((N=o==null?void 0:o.gate)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||p,onChange:w=>x(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!c||p||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(xi,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(so[w]||"v-cons"),children:w}),t.jsx("span",{children:C})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",C]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Ad(){const{t:e,dispatch:a,startTour:r}=$(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(_e,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const mo="atl2:mapfold",Td=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(mo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Ld=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},fo=m.createContext(null),$=()=>{const e=m.useContext(fo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Nt({o:e,lg:a}){const{lang:r}=$(),n=Re(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Va(n,r),children:[n.emoji," ",Va(n,r)]}):null}function Ca({o:e,src:a}){const{lang:r,t:n}=$(),i=Re(e);if(!i)return null;const o=Ti(i),l=Li(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(fn(i,r))+" · "+n.win7(fa(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<o?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function qd(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=Be(a);if(i)return e.find(o=>Be(o.name)===i)||e.find(o=>{const l=Be(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function Md(){const{scoped:e,t:a,st:r,dispatch:n}=$(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.filter(x=>!rt(x)),d=l.length,c=l.filter(x=>!x.noCo).length,f=l.filter(x=>!!x.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const x=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",f," ",a.zoomPulseExplore]})]})]})}function xo({o:e}){const{lang:a}=$(),r=Ai(e.cc),n=e.cc?Ot(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const kr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Rd=!1;function Fd(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const ho=e=>`atl2:tour:${e||"anon"}`;function Od(e){try{return localStorage.getItem(ho(e))==="1"}catch{return!0}}function jr(e){try{localStorage.setItem(ho(e),"1")}catch{}}function Pd(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function _d({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var Oe;const{lang:l}=Si(),d=Hi[l],c=ts(e,l,a),[f,s]=m.useReducer(rs,void 0,()=>as((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Ld():Td()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=m.useRef(!0);m.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(mo,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e,a]);const u=m.useRef(o);u.current=o,m.useEffect(()=>{var k;(k=u.current)==null||k.call(u,f.filters)},[f.filters]);const[h,p]=m.useState(null),[b,y]=m.useState(null),[g,j]=m.useState(null),[N,w]=m.useState({kept:0,dropped:0}),[C,T]=m.useState(!1),[A,L]=m.useState(""),[z,S]=m.useState(!1),[R,_]=m.useState(null),[M,O]=m.useState(!1),[v,q]=m.useState(!1),[,H]=m.useState(0),B=()=>H(k=>k+1),U=m.useRef([]),W=m.useRef(new Set),X=m.useRef(new Set),[Y,oe]=m.useState([]),[te,we]=m.useState([]),[G,pe]=m.useState(0),xe=m.useRef(new Map),ue=m.useRef(null),{mode:ke}=c,J=m.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),Z=J.pipe,K=c.session.token||"",ee=ke==="client"&&!e;m.useEffect(()=>{if(!K||!Z)return;let k=!0;const D=async()=>{const de=await qi(K);!k||!de||(we(de.runs),pe(Date.now()/1e3-de.now),oe(Ne=>Ne.filter(Me=>!de.runs.some(Xe=>Be(Xe.company)===Be(Me.name)))))};D();const P=Y.length>0||te.some(de=>de.status==="running"),Q=window.setInterval(()=>{D()},P?8e3:25e3);return()=>{k=!1,window.clearInterval(Q)}},[K,Z,Y.length,te.some(k=>k.status==="running")]);const me=m.useMemo(()=>{const k=[],D=new Set;for(const P of Y){const Q=Be(P.name);!Q||D.has(Q)||(D.add(Q),k.push({name:P.name,id:P.id,status:"boot",started:P.started,estMin:P.estMin,memoType:"instant"}))}for(const P of te){const Q=Be(P.company);if(!Q||D.has(Q))continue;D.add(Q);const de=P.status==="error"?"error":P.status==="done"?"done":"running";k.push({name:P.company,status:de,started:P.started||0,estMin:P.est_min||(P.memo_type==="detailed"?40:15),url:P.url,error:P.error,memoType:P.memo_type})}return k},[Y,te]),re=k=>me.find(D=>Be(D.name)===Be(k))||null,fe=(k,D)=>{oe(P=>P.some(Q=>Be(Q.name)===Be(k.name))?P:[...P,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:D==="detailed"?40:15}]),W.current.add(k.id),B()};m.useEffect(()=>{if(document.querySelector(`link[href="${kr}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=kr,document.head.appendChild(k)},[]);const he=(k,D=!1)=>{L(k),S(D),ue.current&&clearTimeout(ue.current),ue.current=setTimeout(()=>L(""),D?4200:2400)},ge=k=>he(k,!0),Fe=m.useMemo(()=>{const k=new Map;return c.dossiers.forEach(D=>{D.id&&k.set(D.id,D)}),k},[c.dossiers]),le=m.useMemo(()=>c.dossiers.filter(k=>Lr(k,f,Z)),[c.dossiers,f,Z]),Te=m.useRef(!1);m.useEffect(()=>{if(Te.current||e||c.loading||!c.dossiers.length)return;if(!J.showFunnel||Od(c.session.token||"")){Te.current=!0;return}Te.current=!0;const k=window.setTimeout(()=>{jr(c.session.token||""),O(!0)},700);return()=>window.clearTimeout(k)},[e,c.loading,c.dossiers.length,J.showFunnel,c.session.token]);const Le=m.useMemo(()=>c.dossiers.filter(k=>os(k,f,Z,c.favIds)),[c.dossiers,f,Z,c.favIds]),Ue=m.useMemo(()=>Ei(le,c.favIds),[le,c.favIds]),Je=m.useRef(!1);m.useEffect(()=>{if(Je.current)return;if(!Z||a==="ops"){Je.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Je.current=!0;return}if(c.loading)return;Je.current=!0;const k=Ci(Ue);k!==f.ptab&&s({type:"ptab",tab:k})},[Z,a,n==null?void 0:n.ptab,c.loading,Ue,f.ptab]);const mt=m.useMemo(()=>{const k=Pr(c.dossiers);return k?lt(k)===0?d.tourToday:Dr(k,l):d.tourNoRun},[c.dossiers,d,l]),dt=m.useMemo(()=>c.dossiers.some(k=>!!k.memoUrl||!!k.summary||Lt(k)),[c.dossiers]),[ft,ot]=m.useState(!1);m.useEffect(()=>{if(c.loading){ot(!1);return}if(c.dossiers.length>0||c.error){ot(!0);return}const k=window.setTimeout(()=>ot(!0),6e3);return()=>window.clearTimeout(k)},[c.loading,c.dossiers.length,c.error]);const E=(c.marketEstimate||0)>0||typeof((Oe=c.stats)==null?void 0:Oe.screened)=="number"&&c.stats.screened>0,I=m.useMemo(()=>[1,0,2,4,5,3].find(k=>(Ue[k]||0)>0)??0,[Ue]),V=mn.find(k=>k.key===f.continent),ne=f.continent==="monde"?d.contWorld:(l==="fr"?V==null?void 0:V.fr:V==null?void 0:V.en)||"";m.useEffect(()=>{const k=D=>{var Q;const P=(((Q=D.detail)==null?void 0:Q.name)||"").trim();P&&Ce(null,P)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),m.useEffect(()=>{if(a!=="ops")return;const k=D=>{const P=D.detail||{},Q=String(P.id||"").trim(),de=String(P.name||"").trim(),Ne=String(P.url||"").trim(),Me=Q&&Fe.get(Q)||qd(c.dossiers,de,Ne);if(Me){y(null),window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Me.id}),(Me.noCo||["media","nominations","recrutements"].includes(Me.engine||""))&&(Me.url||Me.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Me.url||"",text:[Me.headline,Me.tagline].filter(Boolean).join(`
`)}})):Me.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Me.name,url:Me.url||""}}));return}!de&&!Ne||(s({type:"focus",id:null}),y({name:de,headline:String(P.text||"").trim()||de,url:Ne,card:P.card}),Ne&&(xa(de)||!de)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ne,text:String(P.text||"").trim()}})):de&&!xa(de)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:de,url:Ne}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),m.useEffect(()=>{const k=Q=>{const de={},Ne=String((Q==null?void 0:Q.sector)||"").trim();Ne&&(de.sector=[Ne]);const Me=String((Q==null?void 0:Q.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Me)&&(de.day=Me);const Xe=String((Q==null?void 0:Q.search)||"").trim();Xe&&(de.search=Xe);const je=String((Q==null?void 0:Q.dealKind)||"").trim();(je==="ma"||je==="levee"||je==="other")&&(de.dealKind=[je]),Object.keys(de).length&&s({type:"filters",patch:de})},D=Q=>k(Q.detail),P=Q=>{Q.data&&Q.data.type==="pp-filter"&&k(Q.data)};return window.addEventListener("ppmap:filter",D),window.addEventListener("message",P),()=>{window.removeEventListener("ppmap:filter",D),window.removeEventListener("message",P)}},[]),m.useEffect(()=>{const k=D=>{var de;const P=(((de=D.detail)==null?void 0:de.name)||"").trim().toLowerCase();if(!P)return;const Q=c.dossiers.find(Ne=>(Ne.name||"").trim().toLowerCase()===P);Q&&s(a==="ops"?{type:"focus",id:Q.id}:{type:"popup",id:Q.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const Ce=(k,D)=>{const P=((k==null?void 0:k.name)||D||"").trim();if(!ee){j({kicker:P});return}!P||C||(T(!0),(async()=>{try{let Q=P;const de=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(de)Q=de;else try{const je=await Mi(P);if(je!=null&&je.website)Q=je.website;else if(((je==null?void 0:je.candidates)||[]).length===1)Q=je.candidates[0].url;else if(((je==null?void 0:je.candidates)||[]).length>1){U.current=[{name:P,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(je.candidates||[]).slice(0,5)},...U.current].slice(0,8),B();return}}catch{}const Ne=await zr(K,Q,"atelier2"),Me={name:Ne.company||P,verdict:Ne.verdict,reason:Ne.reason||"",remaining:Ne.remaining??null};U.current=[Me,...U.current].slice(0,8),Ne.verdict==="kept"&&w(je=>({...je,kept:je.kept+1})),Ne.verdict==="ruled_out"&&w(je=>({...je,dropped:je.dropped+1}));const Xe=k||c.dossiers.find(je=>(je.name||"").toLowerCase()===P.toLowerCase());Xe&&(Ne.verdict==="kept"?Xe.verdict=Xe.verdict||"MATCH":Ne.verdict==="ruled_out"&&(Xe.verdict="NO MATCH"),Ne.reason&&(Xe.reasoning=Ne.reason)),B()}finally{T(!1)}})())},ie=k=>{if(!ee){j({kicker:k.name});return}fe(k,"instant"),Dt(K,"fast_request",k.name||"",""),he(d.memoInstantSent(k.name))},be=k=>xe.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),Ie=(k,D)=>s({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:D}}),Ze=async(k,D,P)=>{const Q=k.ceoStatus||"";k.ceoStatus=D,B();const de=await qa(K,{status:D,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(P==null?void 0:P.note)!==void 0?{note:P.note}:{},...P!=null&&P.via?{via:P.via}:{}});return de.ok?de.skipped?(k.ceoStatus=Q,B(),ge(d.actNotPersisted),!1):((P==null?void 0:P.undo)!==!1&&Ie(k,Q),P!=null&&P.msg&&he(P.msg),(D==="Validé"||D==="Écarté")&&!k.ceoNote&&(P==null?void 0:P.note)===void 0&&_({o:k,yes:D==="Validé"}),!0):(k.ceoStatus=Q,B(),ge(d.actErr),!1)},xt=async(k,D)=>{const P=await qa(K,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:D,via:"note"});return!P.ok||P.skipped?(ge(P.skipped?d.actNotPersisted:d.actErr),!1):(k.ceoNote=D,B(),!0)},ct=m.useRef(new Map),ht=k=>ct.current.has(k.id)?ct.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),pt=(k,D)=>{ct.current.set(k.id,D),B()},et=(k,D)=>{ee&&Ze(k,D?"Validé":"Écarté",{msg:D?d.decidedYes(k.name):d.decidedNo(k.name)})},za=k=>{ee&&Ze(k,"À trancher",{msg:d.promoted(k.name)})},Ee=k=>{ee&&(async()=>{const D=k.ceoStatus||"";k.ceoStatus="Retenu",B();const P=await qa(K,{status:"Retenu",check_id:k.checkId,company:k.name});if(!P.ok||P.skipped){k.ceoStatus=D,B(),ge(P.skipped?d.actNotPersisted:d.actErr);return}Ie(k,D),he(d.repeched(k.name))})()},gt=()=>{const k=f.undo[f.undo.length-1];if(!k){he(d.undoNone);return}const D=Fe.get(k.id);if(!D){s({type:"undoPop"}),he(d.undoNone);return}let P=k.prevCeoStatus;if(!P)if((D.verdict||"").toUpperCase().includes("CALL"))P="À trancher";else{he(d.undoLockedTitle);return}(async()=>await Ze(D,P,{undo:!1})&&(s({type:"undoPop"}),D.ceoStatus=k.prevCeoStatus,B(),he(d.undoDone(D.name))))()},Et=k=>{ee&&(X.current.add(k.id),B(),(async()=>{const D=await Ri(K,k.name,"email");if(!D||D.ok===!1){X.current.delete(k.id),B(),ge(d.actErr);return}Dt(K,"approach",k.name||"",""),he(d.actApproachSent)})())},Aa=(k,D)=>{ee&&(async()=>{if(!(await Dt(K,D?"yes":"no",k.name||"","")).ok){ge(d.actErr);return}xe.current.set(k.id,D?"yes":"no"),B(),he(D?d.thumbUpDone:d.thumbDnDone)})()},Ta=k=>{!ee||!Lt(k)||(fe(k,"detailed"),Dt(K,"detailed_request",k.name||"",""),he(d.memoDeepSent(k.name)))},Xt=k=>{const D=new Set(c.favIds),P=D.has(k.id);P?D.delete(k.id):D.add(k.id),c.setFavIds(D),ee&&Fi(K,{id:k.id,co:k.name},P)},F=()=>{!ee||v||window.confirm(d.identSyncConfirm)&&(q(!0),(async()=>{const k=await Oi(K);q(!1),k?he(d.identSyncDone):ge(d.actErr)})())},ae=/proplace/i.test(c.fund||""),se=k=>{!ee||!ae||(Dt(K,"onboard_request",k.name||"",""),he(d.onboardSent(k.name)))},ve={st:f,dispatch:s,t:d,lang:l,mode:ke,caps:J,pipe:Z,token:K,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:Ee,thumbOf:be,canWrite:ee,commitStatus:Ze,saveNote:xt,stageOf:ht,setStage:pt,flashErr:ge,startTour:()=>O(!0),dossiers:c.dossiers,scopedAll:le,scoped:Le,counts:Ue,byId:Fe,contName:ne,favIds:c.favIds,toggleFav:Xt,askEvaluate:Ce,doAnalyse:ie,doDecide:et,doPromote:za,doApproach:Et,doThumb:Aa,doDeep:Ta,doUndo:gt,doSync:F,doOnboard:se,outbound:ae,memoQueued:W.current,liveMemos:{items:me,serverOff:G,liveOf:re},approachDone:X.current,sessTally:N,evalCards:U.current,evalBusy:C,markRow:p,markedId:h,flash:he,focusExtra:b};m.useEffect(()=>{const k=D=>{D.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const We=k=>K?t.jsx(ss,{token:K,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(fo.Provider,{value:ve,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(K?" cibles":""),children:[t.jsx("style",{children:Yi}),J.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:Fr,children:gn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${ga}`,children:ga})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),We(t.jsxs("div",{className:"app"+(Z?" pipe":"")+(K?" has-thesis":""),children:[J.showTicker&&t.jsx(Pe,{name:"live",children:t.jsxs("div",{className:"live-stack"+(K?" live-stack--cibles":""),children:[t.jsx(ms,{}),!!K&&t.jsx(ls,{})]})}),J.showIdent&&t.jsx(Pe,{name:"identite",children:t.jsx(Es,{})}),!1,!!K&&t.jsx(Pe,{name:"brief",children:t.jsx(ds,{})}),Rd,J.showMorning&&t.jsx(Pe,{name:"matin",children:t.jsx(Ss,{})}),t.jsx(Pe,{name:"mesure",children:t.jsx(gs,{})}),J.showFunnel&&t.jsx(Pe,{name:"entonnoir",children:t.jsx(Dd,{})}),J.showFunnel&&t.jsx(Pe,{name:"tunnel",children:t.jsx(Cs,{})}),J.showFunnel&&t.jsx(Pe,{name:"tuto",children:t.jsx(zs,{})}),!f.mapFolded&&t.jsx(Pe,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(ro,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Md,{}),t.jsx(Sl,{}),t.jsx(no,{})]})]})}),J.showDemand&&Z&&t.jsx(Pe,{name:"direct",children:t.jsx($i,{items:me,serverOff:G,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),J.showDemand&&t.jsx(Pe,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Ll,{})})}),J.showDemand&&f.memoConsole&&t.jsx(Pe,{name:"console",children:t.jsx(Ml,{})}),t.jsx(Pe,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(ad,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),f.popupId&&f.dens!=="liste"&&a!=="ops"&&t.jsx(Pe,{name:"fiche",children:t.jsx($l,{})}),t.jsx(Pe,{name:"modales",children:t.jsx(cd,{})}),t.jsx(hs,{}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(ks,{placeholder:R.yes?d.whyYesPh:d.whyNoPh,onDone:k=>{const D=R.o;_(null),k&&xt(D,k).then(P=>{P&&he(d.csNoteSaved)})}})]}),M&&ft&&t.jsx(Ns,{steps:Pd(d,mt,dt,I,E),onClose:()=>{O(!1),jr(K)}}),t.jsx(Fd,{}),A&&t.jsx("div",{className:"flash on"+(z?" err":""),children:A}),g&&t.jsx(zi,{variant:"acquirer",initialCompany:Nr().co,initialWebsite:Nr().site,onClose:()=>j(null)})]})})}function Dd(){const{t:e}=$(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Nr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Id(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{xo as FlagCell,Nt as SigBadge,Ca as SigWin,_d as default,Id as fmtShort,$ as useV2};
