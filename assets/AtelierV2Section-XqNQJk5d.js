...
.atl2 .bulk .side .hint{white-space:nowrap}`,Rl=`
...
`,Dl=Fl+Rl+Ol+Ml;function jn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Il(){const e=jn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Pl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Il();return r==="0"?"client":r==="1"||jn("embed")==="1"&&jn("chrome")==="1"?"apercu":"client"}const _l={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Bl=e=>_l[e];function Kt(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||/\?$/.test(a)||/^(this|that|these|those|why|what|what'?s|how|when|where|who|which|is|are|do|does|did|can)\b/i.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const It=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Za(a)||Kt(a))&&(e.noCo=!0)}return Object.assign(e,{continent:ns(e.cc)})};function ln(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const $l=60*60*1e3;function Ul(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>$l?null:a}catch{return null}}function ja(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Hl=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Vl(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:Wi(),[e,n]),i=p.useMemo(()=>n?"visiteur":Pl(e,o),[e,o,n]),d=p.useMemo(()=>Bl(i),[i]),l=i!=="visiteur",s=Hl(r),[h,c]=p.useState([]),[x,u]=p.useState(""),[b,f]=p.useState(null),[w,v]=p.useState(null),[m,y]=p.useState(null),[E,k]=p.useState(()=>new Map),[j,N]=p.useState(()=>new Map),[C,T]=p.useState(""),[L,O]=p.useState(new Set),[M,V]=p.useState(null),[J,F]=p.useState(!0),[g,A]=p.useState(!1),[S,I]=p.useState(0),[U,Q]=p.useState(0),ne=p.useRef(0),z=p.useMemo(()=>{var D;if(i!=="client")return"";try{return((D=Gi())==null?void 0:D.email)||""}catch{return""}},[i]);p.useEffect(()=>{const D=++ne.current;let ee=!0;const $=()=>ee&&D===ne.current,oe=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),fe=Ul(oe);return fe?(c(fe.objs.map(It)),fe.fund&&u(fe.fund),f(fe.marketEstimate??null),v(fe.criteria??null),y(fe.stats??null),T(fe.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const be=await nn(),ke=((be==null?void 0:be.recent_ops)||[]).map(ue=>{const Se=Ra(ue.company_name||ue.title?ue:{...ue,title:(ue.headline_fr||ue.headline||"").slice(0,120)},a),Ae=String(ue.rubrique||"").toLowerCase();return Se&&(Ae==="nominations"||Ae==="recrutements")&&(Se.engine=Ae),Se&&!String(ue.company_name||"").trim()&&(Se.noCo=!0),Se}).filter(ue=>!!ue).map(ue=>(Za((ue.name||"").trim())||(ue.noCo=!0),ue));try{const ue=Yi(),Se=await Qi(),Ae=((Se==null?void 0:Se.date)||"").slice(0,10),me=ue?ue.doc:Se,we=Ki(me),Ee=((ue==null?void 0:ue.day)||(me==null?void 0:me.date)||Ae||"").slice(0,10);if(Ee&&we.length){const te=new Set;for(const P of ke){if((P.date||"").slice(0,10)!==Ee)continue;const K=lr(we,te,P.name,"");K>=0&&(te.add(K),P.decryptHtml=we[K].html)}for(const P of ke){if(P.decryptHtml||(P.date||"").slice(0,10)!==Ee)continue;const K=lr(we,te,"",P.headline||P.tagline||P.name);K>=0&&(te.add(K),P.decryptHtml=we[K].html)}}if(Ee){const te=((me==null?void 0:me.title_fr)||"").trim(),P=((me==null?void 0:me.lead_fr)||"").trim(),K=Ji(me),se=((me==null?void 0:me.url)||"").trim();te&&(K||se)&&ke.unshift({id:`edito:${Ee}`,kind:"op",name:te,cc:null,date:Ee,engine:"edito",dealKind:"other",headline:te,tagline:P||te,decryptHtml:K||void 0,url:se,noCo:!0})}}catch{}if(!$())return;c(ke.map(It)),ja(oe,{objs:ke})}else if(typeof r=="object"){const ke=(await dr()||[]).filter(Se=>(Se.slug||"")===r.research).map(Se=>pr(Se,a)).filter(Se=>!!Se),ue=ln(await cr(ke,a));if(!$())return;c(ue.map(It)),ja(oe,{objs:ue})}else if(l&&o.token){const be=Xi(o.token),ke=nn(),ue=Zi(o.token),Se=es(o.token),Ae=ts(o.token),me=await be;let we=me?me.targets:[];$()&&me&&(u(me.fund||""),f(me.marketEstimate??null),v(me.criteria??null),y(me.stats??null),T(me.generatedAt||""),c(we.map(It)),F(!1),A(!1));const[Ee,te,P,K]=await Promise.all([ke,ue,Se,Ae]),se=((Ee==null?void 0:Ee.recent_ops)||[]).map(H=>Ra(H,a)).filter(H=>!!H),le=new Set(we.map(H=>H.id));if(we=[...we,...se.filter(H=>!le.has(H.id)&&(le.add(H.id),!0))],!$())return;c(we.map(It));const he=new Set;for(const H of te){const de=(H.id||H.co||"").toString().trim().toLowerCase();de&&he.add(de.startsWith("t:")?de:"t:"+de)}O(he),k(P),N(K),me&&ja(oe,{fund:me.fund,marketEstimate:me.marketEstimate,criteria:me.criteria,stats:me.stats,generatedAt:me.generatedAt,objs:we})}else{const be=as(),ke=dr(),ue=nn(),Se=await be;$()&&Se.length&&(c(ln(Se).map(It)),F(!1),A(!1));const[Ae,me]=await Promise.all([ke,ue]),we=(Ae||[]).map(K=>pr(K,a)).filter(K=>!!K),Ee=await cr(we,a),te=((me==null?void 0:me.recent_ops)||[]).map(K=>Ra(K,a)).filter(K=>!!K),P=ln([...Se,...Ee,...te]);if(!$())return;c(P.map(It)),ja(oe,{objs:P})}$()&&A(!1)}catch{$()&&!fe&&A(!0)}finally{$()&&F(!1)}})(),()=>{ee=!1}},[l,o.token,a,S,s]),p.useEffect(()=>{if(!d.showCredits||!z){V(null);return}let D=!0;return(async()=>{try{const ee=await fetch(`${ya}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:z})});if(!ee.ok)return;const $=await ee.json();D&&$&&$.ok!==!1&&V($)}catch{}})(),()=>{D=!1}},[d.showCredits,z,U]);const B=p.useCallback(D=>O(new Set(D)),[]);return{session:o,mode:i,caps:d,fund:x,email:z,marketEstimate:b,generatedAt:C,criteria:w,thesisMode:String((w==null?void 0:w.mode)||""),stats:m,thumbs:E,stages:j,dossiers:h,patchStatuses:(D,ee)=>{c($=>{let oe=!1;const fe=$.map(be=>{if(!be.checkId)return be;const ke=D.get(be.checkId);return!ke||ke===(be.ceoStatus||"")||!ee(be.id)?be:(oe=!0,{...be,ceoStatus:ke})});return oe?fe:$})},favIds:L,setFavIds:B,credits:M,reloadCredits:()=>Q(D=>D+1),loading:J,error:g,refresh:()=>I(D=>D+1)}}function Ge(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Oa=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ua(e){return Oa.has(e.engine||"")}function nt(e){return!!e.noCo||Ua(e)&&!!e.url}const Wo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Wl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Wo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Gl=new Set(["signal","amount","score","crible","memo"]);function Yl(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Wo(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Gl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Go)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Go=80;function Ha(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!He(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Un(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(gt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Pt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(Co(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function _t(e,a,r){return Ge(e)?Ha(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ha(e,a.filters,r)}function Ql(e,a,r,n){return!(!_t(e,a,r)||r&&!zo(e,a.ptab,n))}function Yn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-gt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return os(o)||null;case"memo":return rs(o)||null;case"signal":{const i=He(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const dn={},qr=(dn==null?void 0:dn.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Tr(){return new Date().toISOString().slice(0,10)}const Qn=p.createContext(null);function Yo(){return p.useContext(Qn)}function Kl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const h=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(c=>s.removeAttribute(c.name)),h&&/^https?:\/\//i.test(h)&&(s.setAttribute("href",h),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Qo(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Jl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Qo(r),r.innerHTML):e}catch{return e}}function Lr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Qo(r),r.innerHTML):e}catch{return e}}function Fr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Ko(){const e=p.useContext(Qn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Xl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Z(),[i,d]=p.useState(()=>n.filters.day||Tr()),[l,s]=p.useState(null),[h,c]=p.useState(!1),x=p.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{d(Tr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const w=v=>{var y;const m=(y=v.detail)==null?void 0:y.day;typeof m=="string"&&x(m)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let w=!1;c(!0);const v=new URLSearchParams({token:e,date:i});return fetch(`${qr}/cibles/edition.json?${v}`).then(m=>m.json()).then(m=>{w||s(m)}).catch(()=>{w||s({ok:!1,error:"network"})}).finally(()=>{w||c(!1)}),()=>{w=!0}},[e,i]);const b=p.useMemo(()=>`${qr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),f=p.useMemo(()=>({token:e,day:i,ed:l,loading:h,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,h,x,u,n.filters.day,b,o]);return t.jsx(Qn.Provider,{value:f,children:a})}function Zl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Ko(),[o,i]=p.useState(()=>n||Ao());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(Pa,d),()=>window.removeEventListener(Pa,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(is,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function ed(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Rr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Or(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function td(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Ko(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,h=p.useRef(null),[c,x]=p.useState("fonds"),[u,b]=p.useState(null),[f,w]=p.useState("idle"),v=p.useRef(!1);p.useEffect(()=>{b(null),w("idle"),v.current=!1,x("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||v.current)return;v.current=!0;let j=!0;return w("load"),ed(e).then(N=>{j&&(b(N),w("fait"))}),()=>{j=!1}},[c,e]);const m=p.useMemo(()=>Jl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),y=p.useRef(null);p.useEffect(()=>{const j=y.current;if(!j||!m)return;let N=!1;return yn(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!j.isConnected)&&(C.beautifyEditoRows(j),C.mountCardFits(j))}),()=>{N=!0}},[m]);const E=p.useMemo(()=>Lr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>Lr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const j=h.current;if(!j||!E)return;let N=!1;return yn(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!j.isConnected)&&(C.beautifyEditoRows(j),C.mountCardFits(j))}),()=>{N=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const j=(a==null?void 0:a.date)||e,N=/^(\d{4})-(\d{2})-(\d{2})/.exec(j);return N?i?`${N[2]}/${N[3]}/${N[1]}`:`${N[3]}/${N[2]}/${N[1]}`:j})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&s&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Rr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Fr(e,!0)}),"."]}):Rr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Fr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&d&&E?t.jsx("div",{ref:h,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,c==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(m?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title thesis-brief__jour-h",children:u.title}),t.jsx("div",{ref:y,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:m}})]}):t.jsx("p",{className:f==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:f!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Or(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Or(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const ad=300,Na=7,nd={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Jo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},rd=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Sa(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(ps(r)&&r!=="media")return"news:"+r;const n=He(e);return n?"sig:"+(n.theme&&Jo.fr[n.theme]?n.theme:"other"):"actualites"}function od(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=Z(),s=Yo(),h=d==="en",[c,x]=p.useState("all"),[u,b]=p.useState(!1),f=p.useMemo(()=>{var ee;const g=(a.filters.day||"").slice(0,10),A=$=>!(!i&&a.continent!=="monde"&&$.continent!==a.continent||g&&($.date||"").slice(0,10)!==g),S=e.filter($=>A($)&&He($)&&(!i||$.kind!=="target"||Te($)!==5)),I=i&&(((ee=s==null?void 0:s.ed)==null?void 0:ee.ops)||[]).length?s.ed.ops.map($=>Ra($,d)).filter($=>!!$).map($=>($.briefOnly=!0,$)).filter($=>!g||($.date||"").slice(0,10)===g):[],U=e.filter($=>A($)&&$.kind==="op"&&(g?!0:gt($.date)<=Na)),Q=i?I.length?I:U.filter($=>{const oe=(l||"").trim().toLowerCase();if(!oe)return!1;const fe=$.match||null;return fe?Object.keys(fe).map(be=>be.trim().toLowerCase()).includes(oe):!1}):U,ne=g||new Date().toISOString().slice(0,10),z=$=>{const oe=Sa($);return oe==="ma"?0:oe==="levees"?1:2};Q.sort(($,oe)=>{const fe=z($)-z(oe);if(fe)return fe;const be=($.date||"").slice(0,10)===ne?0:1,ke=(oe.date||"").slice(0,10)===ne?0:1;return be!==ke?be-ke:(oe.amountEur||0)-($.amountEur||0)});const B=new Set,D=[];for(const $ of[...Q,...Yn(S,{key:"signal",dir:-1})]){const oe=$.id||$.name;!oe||B.has(oe)||(B.add(oe),D.push($))}return i&&D.length===0?e.filter(oe=>A(oe)&&gt(oe.date)<=Na).sort((oe,fe)=>(fe.date||"").localeCompare(oe.date||"")).slice(0,80):D},[e,a.continent,a.filters.day,i,l,d,s]),w=p.useMemo(()=>{const g={};for(const A of f){const S=Sa(A);g[S]=(g[S]||0)+1}return g},[f]),v=p.useMemo(()=>c==="all"?f:f.filter(g=>Sa(g)===c),[f,c]),m=p.useMemo(()=>v.slice(0,ad),[v]),y=v.length-m.length,E=p.useRef(null);p.useEffect(()=>{var Q,ne;const g=E.current;if(!g)return;const A=()=>{const z=g.scrollWidth;z<200||(g.style.animationDuration=Math.max(18,Math.round(z/130))+"s")};A();const S=requestAnimationFrame(A),I=window.setTimeout(A,1200);let U=!0;return(ne=(Q=document.fonts)==null?void 0:Q.ready)==null||ne.then(()=>{U&&A()}),()=>{U=!1,cancelAnimationFrame(S),window.clearTimeout(I)}},[m.length,c]);const k=g=>g==="all"?f.length:w[g]||0,j=g=>{if(g==="all")return h?"All":"Tout";if(g.startsWith("sig:"))return Jo[h?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const A=g.slice(5);return ls[A]?ds(A,h?"en":"fr"):g}return nd[h?"en":"fr"][g]},N=[{k:"all"}],C=["ma","levees"].filter(g=>k(g)>0||g===c);if(C.length){N.push({g:h?"Deals":"Opérations"});for(const g of C)N.push({k:g})}const T=["nominations","recrutements"].filter(g=>k(g)>0||g===c),L=ss.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>k(g)>0||g===c),O=k("actualites")>0||c==="actualites"?["actualites"]:[];if(T.length||L.length||O.length){N.push({g:h?"News":"Actualités"});for(const g of T)N.push({k:g});for(const g of L)N.push({k:g});for(const g of O)N.push({k:g})}const M=rd.map(g=>"sig:"+g).filter(g=>k(g)>0||g===c);if(M.length){N.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of M)N.push({k:g})}const V=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},J=(()=>{const g=(a.filters.day||"").slice(0,10),A=!i&&a.continent!=="monde"&&o?h?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return g?(h?`LIVE covers the events of ${V(g)}.`:`Le LIVE regroupe les événements du ${V(g)}.`)+A:(h?`LIVE covers the still-open signals and the deals of the last ${Na} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Na} derniers jours.`)+A})(),F=g=>m.map(A=>t.jsxs("button",{type:"button",className:"tk"+(Qe(A)?" spent":""),onClick:S=>{const I=A.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:I?"":A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(I||n({type:"focus",id:A.id}),a.dens!=="liste"){const U=S.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:U.left+U.width/2,y:U.bottom}})}},title:Qe(A)?h?`${A.name} — already screened (dimmed)`:`${A.name} — déjà évaluée (grisée)`:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(Ft,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(Mi,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),(()=>{const S=(A.tagline||A.headline||"").trim();if(S&&S!==A.name)return t.jsx("span",{className:"what",children:S});const I=Sa(A),U=I==="ma"?h?"M&A deal":"opération M&A":I==="levees"?h?"fundraising":"levée de fonds":I==="nominations"?h?"appointment":"nomination":I==="recrutements"?h?"hiring":"recrutement":I.startsWith("sig:")?h?"engine signal":"signal moteur":I.startsWith("news:")?h?"news":"actualité":A.kind==="target"?h?"sourced target":"cible sourcée":h?"news item":"actualité";return t.jsx("span",{className:"what dim",children:U})})(),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:lu(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx(tn,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(A.id||A.name))).concat(y>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${y} more — filter by section to see them`:`+ ${y} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(g=>!g),children:[j(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:J}),N.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===c,onClick:()=>{x(g.k),b(!1)},children:[j(g.k),t.jsx("b",{children:k(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:m.length?t.jsxs("div",{className:"run",ref:E,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!s&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!s&&t.jsx(sd,{isEn:h})]})}const id=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function sd({isEn:e}){const[a,r]=p.useState(()=>Ao());p.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Pa,o),()=>window.removeEventListener(Pa,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>cs(!a),children:id})}class ft extends p.Component{constructor(){super(...arguments);or(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Xo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Mr(e,a){if((Rt(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return Xo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const Dr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",ld={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function dd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=Z(),[l,s]=p.useState(""),[h,c]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!x)return;const y=E=>{b.current&&!b.current.contains(E.target)&&(u(!1),c(!1))};return document.addEventListener("click",y,!0),()=>document.removeEventListener("click",y,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const f=(e.ceoStatus||"").trim(),w=async y=>{if(l)return;if(y==="Analysé"&&!e.memoUrl){c(!0);return}s(y);const E=(Mr(e,a).find(([j])=>j===y)||[y,y])[1],k=await o(e,y,{msg:a.csMoved(e.name,E)});s(""),k&&(c(!1),u(!1))},v=Mr(e,a),m=y=>(v.find(([E])=>E===y)||[])[1]||y;return v.length===2?t.jsx("span",{className:"rstat rst2",onClick:y=>y.stopPropagation(),children:v.map(([y,E])=>t.jsx("button",{type:"button",className:"rsd "+(y==="Validé"?"yes":"no")+(l===y?" busy":""),disabled:!!l,onClick:()=>{w(y)},children:E},y))}):t.jsxs("span",{className:"rstat"+(x||h?" rs-open":""),ref:b,onClick:y=>y.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+Dr(f),onClick:()=>{u(y=>!y),c(!1)},children:l?m(l)+"…":f?m(f):a.csNone}),x&&!h&&t.jsx("span",{className:"rsmenu",role:"listbox",children:v.map(([y,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":f===y,className:"rsopt"+(f===y?" on":"")+(l===y?" busy":""),disabled:!!l,onClick:()=>{if(y===f){u(!1);return}w(y)},children:[t.jsx("i",{className:"pt2",style:{background:ld[Dr(y)]}}),E]},y))}),h&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),c(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const y=await o(e,"Analysé");s(""),y&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function pd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Z(),[i,d]=p.useState(""),[l,s]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),c=(Rt(e)||"").startsWith("CALL")&&Te(e)===3,x=Te(e)>=2,u=async f=>{if(i||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(f);const w=await o(e,f);d(""),w&&(s(!0),setTimeout(()=>s(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:Xo.filter(([f])=>!(x&&f==="Retenu")).map(([f,w])=>[f,a[w]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([f,w])=>t.jsx("button",{type:"button",className:"csb"+(h===f?" on":"")+(i===f?" busy":""),disabled:!!i,onClick:()=>{u(f)},children:w},f)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(cd,{o:e})]})}function cd({o:e}){const{t:a,saveNote:r,flash:n}=Z(),[o,i]=p.useState(e.ceoNote||""),[d,l]=p.useState(!1),[s,h]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!c)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!c,onClick:()=>{x()},children:s?a.csNoteSaved:a.csNoteOk})]})}function Ir({placeholder:e,onDone:a}){const{t:r}=Z(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ud({o:e}){var v;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=Z(),[s,h]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Te(e)!==4)return null;const c=i(e),x=(c==null?void 0:c.stage)||"todo",u=async m=>{if(s||m===x)return;h(!0);const y=c;d(e,{stage:m,stamps:(c==null?void 0:c.stamps)||{}});const E=Math.max(Date.now(),Pr+=1);Pr=E;const k=await us(r,{company:e.name||"",stage:m,cts:E,deal_id:e.airtableId,check_id:e.checkId});h(!1),!k.stale&&(k.ok||(d(e,y),l(a.actErr)))},b=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,f=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=x==="sent"&&b&&f>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(x===m?" on":""),disabled:s,onClick:()=>{u(m)},children:y},m)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let Pr=0;const oa=8,Tt=360;function _r({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Br({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(_r,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(_r,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function md({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Z(),[d,l]=p.useState(0),[s,h]=p.useState(null),[c,x]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),f=p.useRef(!1);p.useEffect(()=>{const C=b.current;return()=>{f.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const w=c[d],v=d>=c.length;p.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const C=w.click,T=window.setTimeout(()=>{const L=document.querySelector(C);L&&L.getAttribute("aria-selected")!=="true"&&L.click()},60);return()=>window.clearTimeout(T)}},[d,w]);const m=p.useRef(-1),y=p.useCallback(()=>{if(!w){h(null);return}const C=O=>{if(!O)return null;for(const M of document.querySelectorAll(O)){const V=M.getBoundingClientRect();if(V.width>1&&V.height>1)return M}return null},T=C(w.sel)||C(w.need);if(!T){h(null);return}m.current!==d&&(m.current=d,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=T.getBoundingClientRect();h(O=>O&&Math.abs(O.top-L.top)<1&&Math.abs(O.left-L.left)<1&&Math.abs(O.width-L.width)<1&&Math.abs(O.height-L.height)<1?O:L)},[w,d]);p.useLayoutEffect(()=>{y();const C=[90,300,700,1300].map(O=>window.setTimeout(y,O)),T=window.setInterval(y,400),L=()=>y();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{C.forEach(O=>window.clearTimeout(O)),window.clearInterval(T),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[y]);const E=p.useRef(a);if(E.current=a,p.useEffect(()=>{const C=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),E.current()):T.key==="ArrowRight"?l(L=>L+1):T.key==="ArrowLeft"&&l(L=>Math.max(0,L-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!c.length)return null;let k=null;const j=C=>()=>{f.current=!0,n({type:"modal",modal:null}),C()};if(v){const C=o[3]||0;C>0?k={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let N={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Tt};if(!v&&s){const C=s.bottom+14,T=window.innerHeight-C;let L=T>190?C:Math.max(12,s.top-200),O=Math.min(Math.max(12,s.left+s.width/2-Tt/2),window.innerWidth-Tt-12);T<=190&&s.top<212&&(window.innerWidth-s.right>=Tt+40?O=Math.min(s.right+26,window.innerWidth-Tt-12):s.left>=Tt+40&&(O=Math.max(12,s.left-Tt-26)),L=Math.max(12,s.top-oa)),N={left:O,top:L,width:Tt}}return ea.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&s&&t.jsx("div",{className:"tour-hole",style:{left:s.left-oa,top:s.top-oa,width:s.width+oa*2,height:s.height+oa*2}}),(v||!s)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:N,children:[v&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Br,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(Br,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(C=>C+1),children:d===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Zo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function ei(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function fd(){var T,L;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:s}=Z(),h=r?a:e,c=p.useMemo(()=>h.filter(O=>gt(O.date)===0&&O.kind==="target"),[h]),x=p.useMemo(()=>r?a.filter(O=>O.kind==="target"&&Te(O)===0).slice().sort((O,M)=>(M.date||"").localeCompare(O.date||"")):[],[a,r]),u=p.useMemo(()=>c.filter(O=>r?Te(O)===0:!Qe(O)),[c,r]),b=r?x:u,f=r?a.length-x.length:c.length-u.length,w=r?a.length:c.length,v=w?Math.min(100,f/w*100):100,m=p.useMemo(()=>Zo(h),[h]),y=!!m&&gt(m)>0,E=p.useMemo(()=>y?h.filter(O=>(O.date||"").slice(0,10)===m):[],[h,m,y]),k=typeof((T=l.stats)==null?void 0:T.kept_today)=="number"?l.stats.kept_today:null,j=typeof((L=l.stats)==null?void 0:L.screened_today)=="number"?l.stats.screened_today:c.length;let N;y?N=o.morningLast(E.length,x.length,ei(m,d)):r?N=o.morningThesis(j,x.length,k):c.length?f===0?N=o.goalSourced(c.length):f>=c.length?N=o.goalCleared:N=o.goalDone(f,c.length):N=o.goalSourced(0);const C=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&x.length&&s({type:"chainStart",queue:x.map(O=>O.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function hd(){const{t:e,st:a,dispatch:r,fund:n,data:o,mode:i,doSync:d,startTour:l}=Z(),s=i==="client",[h,c]=p.useState(!1),[x,u]=p.useState(""),b=()=>{!s||h||!n||(c(!0),u(""),ms(n).then(v=>{if(c(!1),v.pending){u(e.refreshSlow);return}if(!v.ok){v.error&&console.warn("[republish]",v.error),u(e.refreshKo);return}const m=v.entered??0,y=v.left??0;u(v.unchanged||!m&&!y?e.refreshSame:e.refreshDone(m,y)),o.refresh()}))},f=(n||"P").split(/\s+/).map(v=>v[0]).join("").slice(0,2).toUpperCase(),w=(()=>{const v=Date.parse(o.generatedAt||"");if(Number.isNaN(v))return"";const m=new Date(v),y=E=>String(E).padStart(2,"0");return`${y(m.getDate())}/${y(m.getMonth()+1)} à ${y(m.getHours())}:${y(m.getMinutes())}`})();return t.jsx("div",{className:"ident",children:t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:n?f:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:n||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:n?e.identTitle(n):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),w?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(w)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!s||h,onClick:b,children:h?"⏳":"📰"}),(h||!!x)&&t.jsxs("span",{className:"repubst",children:[h?e.refreshRun:x,!h&&t.jsx("button",{type:"button",onClick:()=>u(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!s,onClick:d,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:l,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:a.filters.search,onChange:v=>r({type:"filters",patch:{search:v.target.value}})})]})]})})}class $t{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*gd(e){for(const a of e)yield*a}function ti(e){return Array.from(gd(e))}var Le=1e-6,ze=Math.PI,lt=ze/2,$r=ze/4,pt=ze*2,jt=180/ze,rt=ze/180,Me=Math.abs,xd=Math.atan,ha=Math.atan2,Pe=Math.cos,_e=Math.sin,bd=Math.sign||function(e){return e>0?1:e<0?-1:0},Wt=Math.sqrt;function vd(e){return e>1?0:e<-1?ze:Math.acos(e)}function ga(e){return e>1?lt:e<-1?-lt:Math.asin(e)}function dt(){}function Va(e,a){e&&Hr.hasOwnProperty(e.type)&&Hr[e.type](e,a)}var Ur={Feature:function(e,a){Va(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Va(r[n].geometry,a)}},Hr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Nn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Nn(r[n],a,0)},Polygon:function(e,a){Vr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Vr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Va(r[n],a)}};function Nn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Vr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Nn(e[r],a,1);a.polygonEnd()}function Gt(e,a){e&&Ur.hasOwnProperty(e.type)?Ur[e.type](e,a):Va(e,a)}function Sn(e){return[ha(e[1],e[0]),ga(e[2])]}function Jt(e){var a=e[0],r=e[1],n=Pe(r);return[n*Pe(a),n*_e(a),_e(r)]}function za(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Wa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function pn(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Ca(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function zn(e){var a=Wt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Cn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function An(e,a){return Me(e)>ze&&(e-=Math.round(e/pt)*pt),[e,a]}An.invert=An;function wd(e,a,r){return(e%=pt)?a||r?Cn(Gr(e),Yr(a,r)):Gr(e):a||r?Yr(a,r):An}function Wr(e){return function(a,r){return a+=e,Me(a)>ze&&(a-=Math.round(a/pt)*pt),[a,r]}}function Gr(e){var a=Wr(e);return a.invert=Wr(-e),a}function Yr(e,a){var r=Pe(e),n=_e(e),o=Pe(a),i=_e(a);function d(l,s){var h=Pe(s),c=Pe(l)*h,x=_e(l)*h,u=_e(s),b=u*r+c*n;return[ha(x*o-b*i,c*r-u*n),ga(b*o+x*i)]}return d.invert=function(l,s){var h=Pe(s),c=Pe(l)*h,x=_e(l)*h,u=_e(s),b=u*o-x*i;return[ha(x*o+u*i,c*r+b*n),ga(b*r-c*n)]},d}function yd(e,a,r,n,o,i){if(r){var d=Pe(a),l=_e(a),s=n*r;o==null?(o=a+n*pt,i=a-s/2):(o=Qr(d,o),i=Qr(d,i),(n>0?o<i:o>i)&&(o+=n*pt));for(var h,c=o;n>0?c>i:c<i;c-=s)h=Sn([d,-l*Pe(c),-l*_e(c)]),e.point(h[0],h[1])}}function Qr(e,a){a=Jt(a),a[0]-=e,zn(a);var r=vd(-a[1]);return((-a[2]<0?-r:r)+pt-Le)%pt}function ai(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:dt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ma(e,a){return Me(e[0]-a[0])<Le&&Me(e[1]-a[1])<Le}function Aa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function ni(e,a,r,n,o){var i=[],d=[],l,s;if(e.forEach(function(f){if(!((w=f.length-1)<=0)){var w,v=f[0],m=f[w],y;if(Ma(v,m)){if(!v[2]&&!m[2]){for(o.lineStart(),l=0;l<w;++l)o.point((v=f[l])[0],v[1]);o.lineEnd();return}m[0]+=2*Le}i.push(y=new Aa(v,f,null,!0)),d.push(y.o=new Aa(v,null,y,!1)),i.push(y=new Aa(m,f,null,!1)),d.push(y.o=new Aa(m,null,y,!0))}}),!!i.length){for(d.sort(a),Kr(i),Kr(d),l=0,s=d.length;l<s;++l)d[l].e=r=!r;for(var h=i[0],c,x;;){for(var u=h,b=!0;u.v;)if((u=u.n)===h)return;c=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,s=c.length;l<s;++l)o.point((x=c[l])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(c=u.p.z,l=c.length-1;l>=0;--l)o.point((x=c[l])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Kr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function cn(e){return Me(e[0])<=ze?e[0]:bd(e[0])*((Me(e[0])+ze)%pt-ze)}function kd(e,a){var r=cn(a),n=a[1],o=_e(n),i=[_e(r),-Pe(r),0],d=0,l=0,s=new $t;o===1?n=lt+Le:o===-1&&(n=-lt-Le);for(var h=0,c=e.length;h<c;++h)if(u=(x=e[h]).length)for(var x,u,b=x[u-1],f=cn(b),w=b[1]/2+$r,v=_e(w),m=Pe(w),y=0;y<u;++y,f=k,v=N,m=C,b=E){var E=x[y],k=cn(E),j=E[1]/2+$r,N=_e(j),C=Pe(j),T=k-f,L=T>=0?1:-1,O=L*T,M=O>ze,V=v*N;if(s.add(ha(V*L*_e(O),m*C+V*Pe(O))),d+=M?T+L*pt:T,M^f>=r^k>=r){var J=Wa(Jt(b),Jt(E));zn(J);var F=Wa(i,J);zn(F);var g=(M^T>=0?-1:1)*ga(F[2]);(n>g||n===g&&(J[0]||J[1]))&&(l+=M^T>=0?1:-1)}}return(d<-Le||d<Le&&s<-1e-12)^l&1}function ri(e,a,r,n){return function(o){var i=a(o),d=ai(),l=a(d),s=!1,h,c,x,u={point:b,lineStart:w,lineEnd:v,polygonStart:function(){u.point=m,u.lineStart=y,u.lineEnd=E,c=[],h=[]},polygonEnd:function(){u.point=b,u.lineStart=w,u.lineEnd=v,c=ti(c);var k=kd(h,n);c.length?(s||(o.polygonStart(),s=!0),ni(c,jd,k,r,o)):k&&(s||(o.polygonStart(),s=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),s&&(o.polygonEnd(),s=!1),c=h=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function f(k,j){i.point(k,j)}function w(){u.point=f,i.lineStart()}function v(){u.point=b,i.lineEnd()}function m(k,j){x.push([k,j]),l.point(k,j)}function y(){l.lineStart(),x=[]}function E(){m(x[0][0],x[0][1]),l.lineEnd();var k=l.clean(),j=d.result(),N,C=j.length,T,L,O;if(x.pop(),h.push(x),x=null,!!C){if(k&1){if(L=j[0],(T=L.length-1)>0){for(s||(o.polygonStart(),s=!0),o.lineStart(),N=0;N<T;++N)o.point((O=L[N])[0],O[1]);o.lineEnd()}return}C>1&&k&2&&j.push(j.pop().concat(j.shift())),c.push(j.filter(Ed))}}return u}}function Ed(e){return e.length>1}function jd(e,a){return((e=e.x)[0]<0?e[1]-lt-Le:lt-e[1])-((a=a.x)[0]<0?a[1]-lt-Le:lt-a[1])}const Jr=ri(function(){return!0},Nd,zd,[-ze,-lt]);function Nd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?ze:-ze,s=Me(i-a);Me(s-ze)<Le?(e.point(a,r=(r+d)/2>0?lt:-lt),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&s>=ze&&(Me(a-n)<Le&&(a-=n*Le),Me(i-l)<Le&&(i-=l*Le),r=Sd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Sd(e,a,r,n){var o,i,d=_e(e-r);return Me(d)>Le?xd((_e(a)*(i=Pe(n))*_e(r)-_e(n)*(o=Pe(a))*_e(e))/(o*i*d)):(a+n)/2}function zd(e,a,r,n){var o;if(e==null)o=r*lt,n.point(-ze,o),n.point(0,o),n.point(ze,o),n.point(ze,0),n.point(ze,-o),n.point(0,-o),n.point(-ze,-o),n.point(-ze,0),n.point(-ze,o);else if(Me(e[0]-a[0])>Le){var i=e[0]<a[0]?ze:-ze;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Cd(e){var a=Pe(e),r=2*rt,n=a>0,o=Me(a)>Le;function i(c,x,u,b){yd(b,e,r,u,c,x)}function d(c,x){return Pe(c)*Pe(x)>a}function l(c){var x,u,b,f,w;return{lineStart:function(){f=b=!1,w=1},point:function(v,m){var y=[v,m],E,k=d(v,m),j=n?k?0:h(v,m):k?h(v+(v<0?ze:-ze),m):0;if(!x&&(f=b=k)&&c.lineStart(),k!==b&&(E=s(x,y),(!E||Ma(x,E)||Ma(y,E))&&(y[2]=1)),k!==b)w=0,k?(c.lineStart(),E=s(y,x),c.point(E[0],E[1])):(E=s(x,y),c.point(E[0],E[1],2),c.lineEnd()),x=E;else if(o&&x&&n^k){var N;!(j&u)&&(N=s(y,x,!0))&&(w=0,n?(c.lineStart(),c.point(N[0][0],N[0][1]),c.point(N[1][0],N[1][1]),c.lineEnd()):(c.point(N[1][0],N[1][1]),c.lineEnd(),c.lineStart(),c.point(N[0][0],N[0][1],3)))}k&&(!x||!Ma(x,y))&&c.point(y[0],y[1]),x=y,b=k,u=j},lineEnd:function(){b&&c.lineEnd(),x=null},clean:function(){return w|(f&&b)<<1}}}function s(c,x,u){var b=Jt(c),f=Jt(x),w=[1,0,0],v=Wa(b,f),m=za(v,v),y=v[0],E=m-y*y;if(!E)return!u&&c;var k=a*m/E,j=-a*y/E,N=Wa(w,v),C=Ca(w,k),T=Ca(v,j);pn(C,T);var L=N,O=za(C,L),M=za(L,L),V=O*O-M*(za(C,C)-1);if(!(V<0)){var J=Wt(V),F=Ca(L,(-O-J)/M);if(pn(F,C),F=Sn(F),!u)return F;var g=c[0],A=x[0],S=c[1],I=x[1],U;A<g&&(U=g,g=A,A=U);var Q=A-g,ne=Me(Q-ze)<Le,z=ne||Q<Le;if(!ne&&I<S&&(U=S,S=I,I=U),z?ne?S+I>0^F[1]<(Me(F[0]-g)<Le?S:I):S<=F[1]&&F[1]<=I:Q>ze^(g<=F[0]&&F[0]<=A)){var B=Ca(L,(-O+J)/M);return pn(B,C),[F,Sn(B)]}}}function h(c,x){var u=n?e:ze-e,b=0;return c<-u?b|=1:c>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return ri(d,l,i,n?[0,-e]:[-ze,e-ze])}function Ad(e,a,r,n,o,i){var d=e[0],l=e[1],s=a[0],h=a[1],c=0,x=1,u=s-d,b=h-l,f;if(f=r-d,!(!u&&f>0)){if(f/=u,u<0){if(f<c)return;f<x&&(x=f)}else if(u>0){if(f>x)return;f>c&&(c=f)}if(f=o-d,!(!u&&f<0)){if(f/=u,u<0){if(f>x)return;f>c&&(c=f)}else if(u>0){if(f<c)return;f<x&&(x=f)}if(f=n-l,!(!b&&f>0)){if(f/=b,b<0){if(f<c)return;f<x&&(x=f)}else if(b>0){if(f>x)return;f>c&&(c=f)}if(f=i-l,!(!b&&f<0)){if(f/=b,b<0){if(f>x)return;f>c&&(c=f)}else if(b>0){if(f<c)return;f<x&&(x=f)}return c>0&&(e[0]=d+c*u,e[1]=l+c*b),x<1&&(a[0]=d+x*u,a[1]=l+x*b),!0}}}}}var sa=1e9,qa=-sa;function qd(e,a,r,n){function o(h,c){return e<=h&&h<=r&&a<=c&&c<=n}function i(h,c,x,u){var b=0,f=0;if(h==null||(b=d(h,x))!==(f=d(c,x))||s(h,c)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==f);else u.point(c[0],c[1])}function d(h,c){return Me(h[0]-e)<Le?c>0?0:3:Me(h[0]-r)<Le?c>0?2:1:Me(h[1]-a)<Le?c>0?1:0:c>0?3:2}function l(h,c){return s(h.x,c.x)}function s(h,c){var x=d(h,1),u=d(c,1);return x!==u?x-u:x===0?c[1]-h[1]:x===1?h[0]-c[0]:x===2?h[1]-c[1]:c[0]-h[0]}return function(h){var c=h,x=ai(),u,b,f,w,v,m,y,E,k,j,N,C={point:T,lineStart:V,lineEnd:J,polygonStart:O,polygonEnd:M};function T(g,A){o(g,A)&&c.point(g,A)}function L(){for(var g=0,A=0,S=b.length;A<S;++A)for(var I=b[A],U=1,Q=I.length,ne=I[0],z,B,D=ne[0],ee=ne[1];U<Q;++U)z=D,B=ee,ne=I[U],D=ne[0],ee=ne[1],B<=n?ee>n&&(D-z)*(n-B)>(ee-B)*(e-z)&&++g:ee<=n&&(D-z)*(n-B)<(ee-B)*(e-z)&&--g;return g}function O(){c=x,u=[],b=[],N=!0}function M(){var g=L(),A=N&&g,S=(u=ti(u)).length;(A||S)&&(h.polygonStart(),A&&(h.lineStart(),i(null,null,1,h),h.lineEnd()),S&&ni(u,l,g,i,h),h.polygonEnd()),c=h,u=b=f=null}function V(){C.point=F,b&&b.push(f=[]),j=!0,k=!1,y=E=NaN}function J(){u&&(F(w,v),m&&k&&x.rejoin(),u.push(x.result())),C.point=T,k&&c.lineEnd()}function F(g,A){var S=o(g,A);if(b&&f.push([g,A]),j)w=g,v=A,m=S,j=!1,S&&(c.lineStart(),c.point(g,A));else if(S&&k)c.point(g,A);else{var I=[y=Math.max(qa,Math.min(sa,y)),E=Math.max(qa,Math.min(sa,E))],U=[g=Math.max(qa,Math.min(sa,g)),A=Math.max(qa,Math.min(sa,A))];Ad(I,U,e,a,r,n)?(k||(c.lineStart(),c.point(I[0],I[1])),c.point(U[0],U[1]),S||c.lineEnd(),N=!1):S&&(c.lineStart(),c.point(g,A),N=!1)}y=g,E=A,k=S}return C}}const qn=e=>e;var un=new $t,Tn=new $t,oi,ii,Ln,Fn,St={point:dt,lineStart:dt,lineEnd:dt,polygonStart:function(){St.lineStart=Td,St.lineEnd=Fd},polygonEnd:function(){St.lineStart=St.lineEnd=St.point=dt,un.add(Me(Tn)),Tn=new $t},result:function(){var e=un/2;return un=new $t,e}};function Td(){St.point=Ld}function Ld(e,a){St.point=si,oi=Ln=e,ii=Fn=a}function si(e,a){Tn.add(Fn*e-Ln*a),Ln=e,Fn=a}function Fd(){si(oi,ii)}var Xt=1/0,Ga=Xt,xa=-Xt,Ya=xa,Qa={point:Rd,lineStart:dt,lineEnd:dt,polygonStart:dt,polygonEnd:dt,result:function(){var e=[[Xt,Ga],[xa,Ya]];return xa=Ya=-(Ga=Xt=1/0),e}};function Rd(e,a){e<Xt&&(Xt=e),e>xa&&(xa=e),a<Ga&&(Ga=a),a>Ya&&(Ya=a)}var Rn=0,On=0,la=0,Ka=0,Ja=0,Yt=0,Mn=0,Dn=0,da=0,li,di,vt,wt,st={point:Ut,lineStart:Xr,lineEnd:Zr,polygonStart:function(){st.lineStart=Dd,st.lineEnd=Id},polygonEnd:function(){st.point=Ut,st.lineStart=Xr,st.lineEnd=Zr},result:function(){var e=da?[Mn/da,Dn/da]:Yt?[Ka/Yt,Ja/Yt]:la?[Rn/la,On/la]:[NaN,NaN];return Rn=On=la=Ka=Ja=Yt=Mn=Dn=da=0,e}};function Ut(e,a){Rn+=e,On+=a,++la}function Xr(){st.point=Od}function Od(e,a){st.point=Md,Ut(vt=e,wt=a)}function Md(e,a){var r=e-vt,n=a-wt,o=Wt(r*r+n*n);Ka+=o*(vt+e)/2,Ja+=o*(wt+a)/2,Yt+=o,Ut(vt=e,wt=a)}function Zr(){st.point=Ut}function Dd(){st.point=Pd}function Id(){pi(li,di)}function Pd(e,a){st.point=pi,Ut(li=vt=e,di=wt=a)}function pi(e,a){var r=e-vt,n=a-wt,o=Wt(r*r+n*n);Ka+=o*(vt+e)/2,Ja+=o*(wt+a)/2,Yt+=o,o=wt*e-vt*a,Mn+=o*(vt+e),Dn+=o*(wt+a),da+=o*3,Ut(vt=e,wt=a)}function ci(e){this._context=e}ci.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,pt);break}}},result:dt};var In=new $t,mn,ui,mi,pa,ca,ba={point:dt,lineStart:function(){ba.point=_d},lineEnd:function(){mn&&fi(ui,mi),ba.point=dt},polygonStart:function(){mn=!0},polygonEnd:function(){mn=null},result:function(){var e=+In;return In=new $t,e}};function _d(e,a){ba.point=fi,ui=pa=e,mi=ca=a}function fi(e,a){pa-=e,ca-=a,In.add(Wt(pa*pa+ca*ca)),pa=e,ca=a}let eo,Xa,to,ao;class no{constructor(a){this._append=a==null?hi:Bd(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==to||this._append!==Xa){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,to=n,Xa=this._append,ao=this._,this._=o}this._+=ao;break}}}result(){const a=this._;return this._="",a.length?a:null}}function hi(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Bd(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return hi;if(a!==eo){const r=10**a;eo=a,Xa=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Xa}function $d(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Gt(l,o(i))),i.result()}return d.area=function(l){return Gt(l,o(St)),St.result()},d.measure=function(l){return Gt(l,o(ba)),ba.result()},d.bounds=function(l){return Gt(l,o(Qa)),Qa.result()},d.centroid=function(l){return Gt(l,o(st)),st.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,qn):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new no(r)):new ci(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const s=Math.floor(l);if(!(s>=0))throw new RangeError(`invalid digits: ${l}`);r=s}return a===null&&(i=new no(r)),d},d.projection(e).digits(r).context(a)}function Kn(e){return function(a){var r=new Pn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Pn(){}Pn.prototype={constructor:Pn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Jn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Gt(r,e.stream(Qa)),a(Qa.result()),n!=null&&e.clipExtent(n),e}function gi(e,a,r){return Jn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,s=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,s])},r)}function Ud(e,a,r){return gi(e,[[0,0],a],r)}function Hd(e,a,r){return Jn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function Vd(e,a,r){return Jn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var ro=16,Wd=Pe(30*rt);function oo(e,a){return+a?Yd(e,a):Gd(e)}function Gd(e){return Kn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Yd(e,a){function r(n,o,i,d,l,s,h,c,x,u,b,f,w,v){var m=h-n,y=c-o,E=m*m+y*y;if(E>4*a&&w--){var k=d+u,j=l+b,N=s+f,C=Wt(k*k+j*j+N*N),T=ga(N/=C),L=Me(Me(N)-1)<Le||Me(i-x)<Le?(i+x)/2:ha(j,k),O=e(L,T),M=O[0],V=O[1],J=M-n,F=V-o,g=y*J-m*F;(g*g/E>a||Me((m*J+y*F)/E-.5)>.3||d*u+l*b+s*f<Wd)&&(r(n,o,i,d,l,s,M,V,L,k/=C,j/=C,N,w,v),v.point(M,V),r(M,V,L,k,j,N,h,c,x,u,b,f,w,v))}}return function(n){var o,i,d,l,s,h,c,x,u,b,f,w,v={point:m,lineStart:y,lineEnd:k,polygonStart:function(){n.polygonStart(),v.lineStart=j},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function m(T,L){T=e(T,L),n.point(T[0],T[1])}function y(){x=NaN,v.point=E,n.lineStart()}function E(T,L){var O=Jt([T,L]),M=e(T,L);r(x,u,c,b,f,w,x=M[0],u=M[1],c=T,b=O[0],f=O[1],w=O[2],ro,n),n.point(x,u)}function k(){v.point=m,n.lineEnd()}function j(){y(),v.point=N,v.lineEnd=C}function N(T,L){E(o=T,L),i=x,d=u,l=b,s=f,h=w,v.point=E}function C(){r(x,u,c,b,f,w,i,d,o,l,s,h,ro,n),v.lineEnd=k,k()}return v}}var Qd=Kn({point:function(e,a){this.stream.point(e*rt,a*rt)}});function Kd(e){return Kn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Jd(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function io(e,a,r,n,o,i){if(!i)return Jd(e,a,r,n,o);var d=Pe(i),l=_e(i),s=d*e,h=l*e,c=d/e,x=l/e,u=(l*r-d*a)/e,b=(l*a+d*r)/e;function f(w,v){return w*=n,v*=o,[s*w-h*v+a,r-h*w-s*v]}return f.invert=function(w,v){return[n*(c*w-x*v+u),o*(b-x*w-c*v)]},f}function Xd(e){return Zd(function(){return e})()}function Zd(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,s=0,h=0,c,x=0,u=1,b=1,f=null,w=Jr,v=null,m,y,E,k=qn,j=.5,N,C,T,L,O;function M(g){return T(g[0]*rt,g[1]*rt)}function V(g){return g=T.invert(g[0],g[1]),g&&[g[0]*jt,g[1]*jt]}M.stream=function(g){return L&&O===g?L:L=Qd(Kd(c)(w(N(k(O=g)))))},M.preclip=function(g){return arguments.length?(w=g,f=void 0,F()):w},M.postclip=function(g){return arguments.length?(k=g,v=m=y=E=null,F()):k},M.clipAngle=function(g){return arguments.length?(w=+g?Cd(f=g*rt):(f=null,Jr),F()):f*jt},M.clipExtent=function(g){return arguments.length?(k=g==null?(v=m=y=E=null,qn):qd(v=+g[0][0],m=+g[0][1],y=+g[1][0],E=+g[1][1]),F()):v==null?null:[[v,m],[y,E]]},M.scale=function(g){return arguments.length?(r=+g,J()):r},M.translate=function(g){return arguments.length?(n=+g[0],o=+g[1],J()):[n,o]},M.center=function(g){return arguments.length?(i=g[0]%360*rt,d=g[1]%360*rt,J()):[i*jt,d*jt]},M.rotate=function(g){return arguments.length?(l=g[0]%360*rt,s=g[1]%360*rt,h=g.length>2?g[2]%360*rt:0,J()):[l*jt,s*jt,h*jt]},M.angle=function(g){return arguments.length?(x=g%360*rt,J()):x*jt},M.reflectX=function(g){return arguments.length?(u=g?-1:1,J()):u<0},M.reflectY=function(g){return arguments.length?(b=g?-1:1,J()):b<0},M.precision=function(g){return arguments.length?(N=oo(C,j=g*g),F()):Wt(j)},M.fitExtent=function(g,A){return gi(M,g,A)},M.fitSize=function(g,A){return Ud(M,g,A)},M.fitWidth=function(g,A){return Hd(M,g,A)},M.fitHeight=function(g,A){return Vd(M,g,A)};function J(){var g=io(r,0,0,u,b,x).apply(null,a(i,d)),A=io(r,n-g[0],o-g[1],u,b,x);return c=wd(l,s,h),C=Cn(a,A),T=Cn(c,C),N=oo(C,j),F()}function F(){return L=O=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&V,J()}}function xi(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}xi.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Me(o)>Le&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function ep(){return Xd(xi).scale(175.295)}function tp(e){return e}function ap(e){if(e==null)return tp;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,s){s||(a=r=0);var h=2,c=l.length,x=new Array(c);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+d;h<c;)x[h]=l[h],++h;return x}}function np(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function rp(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return so(e,r)})}:so(e,a)}function so(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=op(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function op(e,a){var r=ap(e.transform),n=e.arcs;function o(c,x){x.length&&x.pop();for(var u=n[c<0?~c:c],b=0,f=u.length;b<f;++b)x.push(r(u[b],b));c<0&&np(x,f)}function i(c){return r(c)}function d(c){for(var x=[],u=0,b=c.length;u<b;++u)o(c[u],x);return x.length<2&&x.push(x[0]),x}function l(c){for(var x=d(c);x.length<4;)x.push(x[0]);return x}function s(c){return c.map(l)}function h(c){var x=c.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:c.geometries.map(h)};case"Point":u=i(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(i);break;case"LineString":u=d(c.arcs);break;case"MultiLineString":u=c.arcs.map(d);break;case"Polygon":u=s(c.arcs);break;case"MultiPolygon":u=c.arcs.map(s);break;default:return null}return{type:x,coordinates:u}}return h(a)}const bi={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ip=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function sp(e,a,r){const n=bi[e];if(!n||!n.length)return-1;const o=ip(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let Ta=null;function lp(){return Ta||(Ta=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=rp(r,n),i=ep().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=$d(i),l=(o.features||[]).filter(c=>{var x;return(((x=c.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(c=>{var b;const x=((b=c.properties)==null?void 0:b.name)||"",u=d(c)||"";return u?{i2:fs(x)||null,n:x,d:u}:null}).filter(c=>!!c);if(!l.length)return null;const s={};for(const[c,x]of Object.entries(hs)){const u=i(x);u&&(s[c]={x:u[0],y:u[1]})}const h={};for(const[c,x]of Object.entries(bi)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,f])=>({x:b,y:f}));u.length&&(h[c]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:s,metros:h}}catch{return null}})(),Ta)}function dp(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return lp().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const pp="8 40 984 210",cp={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},lo=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function po(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function up(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const d=()=>{var h;if(!o)return;const s=(h=e.current)==null?void 0:h.getScreenCTM();s&&s.a>0?n(s.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function co({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function mp(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:s,data:h,dossiers:c,source:x}=Z(),u=h.loading&&!c.length,b=p.useRef(null),f=p.useRef(null),w=dp(e.continent==="monde"),v=e.continent==="monde"?w:Hn.find(g=>g.key===e.continent)||null,m=up(b,e.continent+":"+e.mapFolded+":"+!!v),[y,E]=p.useState(new Map),[k,j]=p.useState(null);p.useEffect(()=>{const g=b.current;if(!g)return;const A=new Map;g.querySelectorAll("path[data-i2]").forEach(S=>{const I=S.dataset.i2;if(I)try{const U=S.getBBox();U.width>0&&A.set(I,{x:U.x,y:U.y,w:U.width,h:U.height})}catch{}}),E(A)},[e.continent,m,v]);const N=p.useMemo(()=>r.filter(g=>g.cc),[r]),C=p.useMemo(()=>{const g=new Map;return N.forEach(A=>g.set(A.cc,(g.get(A.cc)||0)+1)),g},[N]),T=e.continent==="monde"&&w?w.anchors:null,L=e.continent==="monde"&&w?w.metros:null,O=p.useMemo(()=>N.map(g=>{const A=po(g.name||g.id||""),S=po((g.id||g.name||"")+"·y");if(T&&g.cc){const z=L?L[g.cc]:void 0;if(z&&z.length){const D=sp(g.cc,g.city,A);if(D>=0&&z[D])return{d:g,x:z[D].x+(A-.5)*5,y:z[D].y+(S-.5)*5}}const B=T[g.cc];if(B)return{d:g,x:B.x+(A-.5)*10,y:B.y+(S-.5)*10}}const I=g.cc?y.get(g.cc):void 0;if(!I)return null;const U=cp[`${e.continent}:${g.cc||""}`];if(U)return{d:g,x:I.x+I.w*(U.fx+(A-.5)*U.sx),y:I.y+I.h*(U.fy+(S-.5)*U.sy)};const Q=(A-.5)*Math.min(I.w*.55,60),ne=(S-.5)*Math.min(I.h*.55,60);return{d:g,x:I.x+I.w/2+Q,y:I.y+I.h/2+ne}}).filter(g=>!!g),[N,y,T,L,e.continent]),M=g=>m>0?g/m:g,V=p.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:lo[g],fr:s.plabels[g],en:s.plabels[g],n:r.filter(A=>A.kind==="target"&&Te(A)===g).length})).filter(g=>g.n>0):ur.map((g,A)=>({...g,n:r.filter(S=>mr(S)===A).length})),[r,n,s.plabels]),J=i?d.get(i):null,F=J?O.find(g=>g.d.id===J.id):null;return v?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:f,children:[u&&t.jsx(co,{msgs:s.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?pp:v.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?v.fr:v.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:v.countries.map((g,A)=>t.jsx("g",{className:"ct"+(g.i2&&C.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},A))}),t.jsx("g",{children:O.map(g=>{const A=ur[mr(g.d)],S=!!He(g.d),I=g.d.kind==="target",U=n&&I?lo[Te(g.d)]:A.c,Q=!n&&Qe(g.d);return t.jsxs("g",{className:"co"+(Q?" done":""),onMouseEnter:()=>{var B,D;const ne=(B=f.current)==null?void 0:B.getBoundingClientRect(),z=(D=b.current)==null?void 0:D.createSVGPoint();if(z&&b.current&&ne){z.x=g.x,z.y=g.y;const ee=z.matrixTransform(b.current.getScreenCTM());j({x:ee.x-ne.left,y:ee.y-ne.top,label:g.d.name+" · "+(ta(g.d.cc,l)||g.d.countryLabel||"")})}o(g.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var B;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const ne=(B=b.current)==null?void 0:B.createSVGPoint();let z=null;if(ne&&b.current){ne.x=g.x,ne.y=g.y;const D=ne.matrixTransform(b.current.getScreenCTM());z={x:D.x,y:D.y}}a({type:"popup",id:g.d.id,anchor:z})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:M(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:M(A.px),fill:U,stroke:S?"#E5484D":"#ffffff",strokeWidth:M(S?2.2:1.3)})]},g.d.id||g.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:M(13),fill:"none",stroke:"#16233A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:V.map((g,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),l==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},A))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",s.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:f,children:t.jsx(co,{msgs:s.loadMsgs})})}function fp(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function vi({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=Z(),s=a.filters,[h,c]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null),f=p.useRef(null),w=p.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),v=F=>w.filter(g=>F!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:Ha(g,s,i,F==="country"?void 0:F)),m=F=>!i||F.kind!=="op",y=p.useMemo(()=>{const F=v("win").filter(m),g=A=>F.filter(S=>(S.date?Math.max(0,Math.floor((Date.now()-Date.parse(S.date))/864e5)):9999)<=A).length;return[g(0),g(7),g(30),F.length]},[w,s,i]),E=p.useMemo(()=>s.day?v("win").filter(m).filter(F=>(F.date||"").slice(0,10)===s.day).length:0,[w,s,i]),k=(s.signalOnly?1:0)+s.sector.length+s.market.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+s.crible.length,j=k+(s.acquirer.trim()?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!h&&!x)return;const F=A=>{var I,U;const S=A.target;h&&!((I=b.current)!=null&&I.contains(S))&&c(!1),x&&!((U=f.current)!=null&&U.contains(S))&&u(!1)},g=A=>{A.key==="Escape"&&(c(!1),u(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",g),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",g)}},[h,x]);const N=(F,g,A,S="fbtn")=>t.jsxs("button",{type:"button",className:S,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:g}),A>0&&t.jsx("span",{className:"n",children:A}),t.jsx("span",{className:"cv",children:"▾"})]},F),C=["1","7","30","all"],T=Math.max(0,C.indexOf(s.win||"all")),L=s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(fp(s.day,l))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:f,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:y[T]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((F,g)=>t.jsxs("button",{type:"button",role:"option","aria-selected":s.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),u(!1)},children:[o.datesShort[g],t.jsx("span",{className:"n",children:y[g]})]},F))})]}):t.jsx("div",{className:"seg",children:C.map((F,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:o.dates[g]}),t.jsx("b",{children:y[g]})]},F))}),O=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:s.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),M=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",o.fSector,s.sector.length),(n.some(F=>!!F.market)||s.market.length>0)&&N("mar",o.fMarket,s.market.length),N("pay",o.fCountry,s.country.length),N("det",o.fEngine,s.engine.length),N("sta",o.fStage,s.stage.length),i&&N("crib",o.fVerdict,s.crible.length),i&&N("ang","Angle",s.angle.length),i&&N("mem","Mémo",s.memoLevel.length)]}),V=(F=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),J=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{c(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:M})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(s.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:L}),t.jsxs("div",{className:"fstrip-b",children:[O,J,V(!1)]})]}),a.openFacet&&t.jsx(uo,{poolFor:v})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[L,O,M,t.jsx("span",{className:"fgrow"}),V()]}),a.openFacet&&t.jsx(uo,{poolFor:v})]})}function uo({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=Z(),l=a.filters,s=a.openFacet,{title:h,cols:c,options:x}=p.useMemo(()=>{if(s==="sig"){const v=e("signal").filter(E=>He(E)),m=new Map;v.forEach(E=>{const k=E.engine||"";m.set(k,(m.get(k)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:v.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...kn([...m.keys()],o).map(E=>({v:E,label:Bt(E)+" "+ot(E,o),n:m.get(E)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(E)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(s==="crib"){const v=e("crible").filter(y=>!i||zo(y,a.ptab,d.favIds)),m=new Map;return v.forEach(y=>{const E=Co(y);E&&E!=="NEW"&&m.set(E,(m.get(E)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...m.entries()].sort((y,E)=>(fr[y[0]]??9)-(fr[E[0]]??9)||E[1]-y[1]).map(([y,E])=>({v:y,label:'<span class="fdot" style="background:'+(gs[y]||"#94A3B8")+'"></span>'+y,n:E,html:!0,on:l.crible.includes(y)}))}}if(s==="sec"){const v=e("sector"),m=new Map;return v.forEach(y=>{y.sector&&m.set(y.sector,(m.get(y.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y,n:E,html:!1,on:l.sector.includes(y)}))}}if(s==="mar"){const v=e("market"),m=new Map;return v.forEach(y=>{y.market&&m.set(y.market,(m.get(y.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y,n:E,html:!1,on:l.market.includes(y)}))}}if(s==="pay"){const v=e("country"),m=new Map;return v.forEach(y=>{y.cc&&m.set(y.cc,(m.get(y.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:ta(y,o)||y,n:E,html:!1,on:l.country.includes(y)}))}}if(s==="det"){const v=e("engine"),m=new Map;return v.forEach(y=>{y.engine&&m.set(y.engine,(m.get(y.engine)||0)+1)}),{title:n.fEngine,cols:2,options:kn([...m.keys()],o).map(y=>({v:y,label:Bt(y)+" "+ot(y,o)+' <span style="color:var(--dim);font-size:10px">· '+xs(bs(y),o)+"</span>",n:m.get(y)||0,html:!0,on:l.engine.includes(y)}))}}if(s==="ang"){const v=e("angle"),m=new Map;return v.forEach(y=>{y.angle&&m.set(y.angle,(m.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y.replace(/[_-]+/g," "),n:E,html:!1,on:l.angle.includes(y)}))}}if(s==="mem"){const v=e("memoLevel"),m=new Map;v.forEach(E=>{if(E.kind==="target"){const k=Un(E);m.set(k,(m.get(k)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(E=>({v:String(E),label:y[E],n:m.get(E)||0,html:!1,on:l.memoLevel.includes(E)}))}}const f=e("stage"),w=new Map;return f.forEach(v=>{v.stage&&w.set(v.stage,(w.get(v.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v,n:m,html:!1,on:l.stage.includes(v)}))}},[s,a,o]),u=f=>{if(s==="sig"){if(f==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const v=l.signalEngines.includes(f)?l.signalEngines.filter(m=>m!==f):[...l.signalEngines,f];r({type:"filters",patch:{signalOnly:!0,signalEngines:v}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(f)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage",value:f})},b=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:h}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:x.map(f=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":f.on,onClick:()=>u(f.v),children:[t.jsx("span",{className:"bx"}),f.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:f.label}}):t.jsx("span",{className:"l",children:f.label}),t.jsx("span",{className:"n",children:f.n})]},f.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function wi({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=Z(),s=p.useMemo(()=>{const b={};return r.forEach(f=>{Ha(f,n.filters,i)&&(b.monde=(b.monde||0)+1,f.continent&&(b[f.continent]=(b[f.continent]||0)+1))}),b},[r,n.filters,i]),[h,c]=p.useState(!1),x=p.useRef(null);p.useEffect(()=>{if(!h)return;const b=w=>{var v;(v=x.current)!=null&&v.contains(w.target)||c(!1)},f=w=>{w.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",f),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",f)}},[h]);const u=b=>{const f=Hn.find(w=>w.key===b);return b==="monde"?l.contWorld:d==="fr"?f.fr:f.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:s[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:hr.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[hr.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]})]})}function _n(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function yi(e){return"atl2:evalq:"+(e||"anon")}function hp(e,a){const r=yi(e),n=_n(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}let Bn=null;function gp(e){Bn=e;try{window.dispatchEvent(new CustomEvent("atl2:extract-note",{detail:e}))}catch{}}function xp(){const{t:e,lang:a,data:r,dossiers:n}=Z(),o=r.session.token||"",i=yi(o),[d,l]=p.useState(()=>_n(i)),s=p.useRef(!1),[h,c]=p.useState(!1);p.useEffect(()=>{try{const z=d.slice(0,30).map(({descBusy:B,evalBusy:D,...ee})=>ee);localStorage.setItem(i,JSON.stringify(z)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[d,i]),p.useEffect(()=>{const z=()=>{if(s.current)return;const B=_n(i);l(D=>JSON.stringify(D.map(({descBusy:ee,evalBusy:$,...oe})=>oe))===JSON.stringify(B)?D:B)};return window.addEventListener("atl2:evalq",z),window.addEventListener("storage",z),()=>{window.removeEventListener("atl2:evalq",z),window.removeEventListener("storage",z)}},[i]);const[x,u]=p.useState([]),[b,f]=p.useState(""),[w,v]=p.useState(!1),[m,y]=p.useState(!1),[E,k]=p.useState(""),[j,N]=p.useState(()=>Bn);p.useEffect(()=>{const z=B=>{var ee,$;const D=B.detail;D&&((ee=D.cited)!=null&&ee.length||($=D.match)!=null&&$.length||D.title)&&N(D)};return window.addEventListener("atl2:extract-note",z),()=>window.removeEventListener("atl2:extract-note",z)},[]);const C=p.useCallback((z,B)=>l(D=>D.map((ee,$)=>$===z?{...ee,...B}:ee)),[]),T=p.useCallback((z,B)=>{const D=B.trim();D&&(C(z,{name:D,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Vn(D).then(ee=>{const $=ee.candidates||[];ee.website?C(z,{site:ee.website,status:"ready"}):$.length===1?C(z,{site:$[0].url,status:"ready"}):$.length>1?C(z,{status:"pick",candidates:$.slice(0,6)}):C(z,{status:"ready"})}).catch(()=>C(z,{status:"ready"})))},[C]),L=p.useCallback((z,B,D)=>{C(z,{descBusy:!0}),qo(o,B,D).then(ee=>{if(ee.quota){c(!0),C(z,{descBusy:!1,descDone:!0});return}const $=ee.blocs||{},oe=($.synthese||$.value_prop||$.produit||$.modele||"").trim();C(z,{descBusy:!1,descDone:!0,desc:oe})}).catch(()=>C(z,{descBusy:!1,descDone:!0}))},[C,o]);p.useEffect(()=>{const z=d.findIndex(D=>D.auto&&D.name.trim()&&D.status==="");if(z>=0){T(z,d[z].name);return}if(h)return;const B=d.findIndex(D=>D.status==="ready"&&D.site&&!D.descDone&&!D.descBusy);B>=0&&L(B,d[B].name,d[B].site)},[d,T,L,h]);const[O,M]=p.useState(!1),V=p.useCallback(async(z,B)=>{C(z,{evalBusy:!0});const D=(B.site||B.name).trim(),ee=await To(o,D,"atelier2");return ee.verdict==="quota"?(C(z,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:ee.reason||"",remaining:0}})),!1):(C(z,{evalBusy:!1,status:ee.verdict==="kept"?"kept":"out",reason:ee.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:ee.company||B.name,verdict:ee.verdict,reason:ee.reason||"",remaining:ee.remaining??null}})),!0)},[C,o]),J=async()=>{if(O)return;const z=d.map((B,D)=>({r:B,i:D})).filter(({r:B})=>B.name.trim()&&B.status!=="kept"&&B.status!=="out"&&B.status!=="resolving");if(z.length){M(!0);for(const{r:B,i:D}of z)if(!await V(D,B))break;M(!1)}},F=p.useMemo(()=>{const z=new Set,B=[];return d.filter(D=>D.status==="kept").forEach(D=>{const ee=D.name.trim().toLowerCase();ee&&!z.has(ee)&&(z.add(ee),B.push(D.name.trim()))}),n.filter(D=>Te(D)>=1&&Te(D)<=4&&(D.website||D.domain)).forEach(D=>{const ee=(D.name||"").trim().toLowerCase();ee&&!z.has(ee)&&(z.add(ee),B.push((D.name||"").trim()))}),B},[d,n]),g=p.useMemo(()=>{const z=new Set;return n.forEach(B=>{const D=(B.name||"").trim().toLowerCase();D&&z.add(D)}),d.forEach(B=>{const D=B.name.trim().toLowerCase();D&&z.add(D)}),z},[n,d]),A=async()=>{if(b||!F.length)return;y(!1);const z=[];for(const B of F.slice(0,2)){f(B);const D=await Lo(o,B);if(D){if(D.verdict==="quota"){v(!0);break}(D.results||[]).forEach(ee=>{const $=(ee.company||"").trim().toLowerCase();!$||g.has($)||z.some(oe=>oe.name.toLowerCase()===$)||z.push({name:(ee.company||"").trim(),verdict:ee.verdict||"",reason:ee.reason,from:B})})}}f(""),y(!0),u(B=>[...z,...B].slice(0,24))},S=async(z,B)=>{if(b)return;y(!1),f(z==="thesis"?e.pxThesis:B);const D=await ws(o,z,B,6);if(f(""),y(!0),!D)return;if(D.verdict==="quota"){v(!0);return}const ee=[];(D.results||[]).forEach($=>{const oe=($.company||"").trim().toLowerCase();!oe||g.has(oe)||ee.some(fe=>fe.name.toLowerCase()===oe)||ee.push({name:($.company||"").trim(),verdict:$.verdict||"",reason:$.reason,from:z==="thesis"?e.pxThesis:B})}),u($=>[...ee,...$].slice(0,24))},I=()=>{const z=E.trim();z.length<3||S(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(z)?"registry":"keyword",z)},U=z=>{l(B=>[...B,{name:z.name,site:"",status:"",auto:!0}].slice(0,30)),u(B=>B.filter(D=>D.name!==z.name))},Q=d.filter(z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out").length,ne=z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving"&&!z.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[j&&t.jsxs("div",{className:"eq-note"+(j.fallback?" fb":""),children:[t.jsxs("b",{children:[j.fallback?e.rsNoteFallback:e.rsNoteRead,j.title?` « ${j.title.length>90?j.title.slice(0,89)+"…":j.title} »`:""]}),!!j.cited.length&&t.jsxs("p",{className:"eq-nl",children:[e.rsNoteCited," ",t.jsx("i",{children:j.cited.join(" · ")})]}),!!j.match.length&&t.jsxs("p",{className:"eq-nl",children:[e.rsNoteMatch," ",t.jsx("i",{children:j.match.join(" · ")})]}),!j.match.length&&!!j.cited.length&&t.jsx("p",{className:"eq-nl",children:e.rsNoteNoMatch}),t.jsx("p",{className:"eq-nl",children:e.rsNoteAdded(j.added)}),t.jsx("button",{type:"button",className:"eq-note-x",onClick:()=>{Bn=null,N(null)},title:e.rsClose,children:"×"})]}),t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{className:"eq-h-go",children:e.eqRunOneShort})]}),d.map((z,B)=>t.jsxs("div",{className:"eq-item"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsxs("div",{className:"eq-row"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsx("input",{value:z.name,placeholder:e.eqNamePh,onChange:D=>{const ee=D.target.value.split(`
`).map($=>$.trim()).filter(Boolean);ee.length>1?l($=>{const oe=[...$];return oe.splice(B,1,...ee.map(fe=>({name:fe,site:"",status:"",auto:!0}))),oe.slice(0,30)}):C(B,{name:D.target.value})},onBlur:()=>{z.name.trim()&&!z.site&&z.status!=="resolving"&&z.status!=="pick"&&T(B,z.name)},onKeyDown:D=>{D.key==="Enter"&&T(B,z.name)}}),t.jsxs("span",{className:"eq-site",children:[z.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),z.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:D=>{const ee=D.target.value;ee&&C(B,{site:ee,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(z.candidates||[]).map(D=>t.jsx("option",{value:D.url,children:(D.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},D.url))]}),z.status!=="resolving"&&z.status!=="pick"&&(z.site?t.jsxs("a",{href:z.site.startsWith("http")?z.site:"https://"+z.site,target:"_blank",rel:"nofollow noopener",children:[z.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:z.name.trim()&&z.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:z.desc||"",children:z.descBusy?t.jsx("i",{children:e.eqDescBusy}):z.desc?z.desc:t.jsx("em",{children:z.descDone?h?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(z.status||"vide"),title:z.reason||"",children:z.status==="kept"?"✓ "+e.kept:z.status==="out"?"✗ "+e.dropped:z.status==="ready"?e.eqReady:z.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>l(D=>D.filter((ee,$)=>$!==B)),children:"×"}),(z.name.trim()||z.site)&&z.status!=="kept"&&z.status!=="out"?t.jsxs(en,{lang:a,storeKey:(z.site||z.name).trim(),className:"eq-go",title:e.eqRunOne,disabled:!ne(z)||O,confirmLabel:"⚡ "+e.eqRunOneShort,onConfirm:()=>{V(B,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}):t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!ne(z)||O,onClick:()=>{V(B,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]})]}),(z.name.trim()||z.site)&&z.status!=="kept"&&z.status!=="out"&&t.jsx(vs,{lang:a,variant:"row",storeKey:(z.site||z.name).trim()})]},B)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>l(z=>[...z,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!b,onClick:()=>{S("thesis","")},children:b===e.pxThesis?e.sgBusy(b):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:E,placeholder:e.pxPlace,onChange:z=>k(z.target.value),onKeyDown:z=>{z.key==="Enter"&&I()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b||E.trim().length<3,onClick:I,children:e.pxGoFree}),!!F.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b,onClick:()=>{A()},children:b&&b!==e.pxThesis&&b!==E?e.sgBusy(b):e.sgGo}),!!F.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(F[0],F.length)}),w&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),m&&!x.length&&!w&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),x.map(z=>t.jsxs("span",{className:"eq-sc"+(z.verdict==="kept"?" ok":""),title:(z.reason||"")+" — "+e.sgVia(z.from),children:[t.jsx("b",{children:z.name}),z.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>U(z),children:"+"})]},z.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),d.some(z=>z.status==="kept"||z.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>l(z=>z.filter(B=>B.status!=="kept"&&B.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(O?" loading":""),style:{justifyContent:"center"},disabled:O||!Q,onClick:()=>{J()},children:[t.jsx("span",{className:"fill"}),O?e.eqRunning:e.eqGo(Q)]})]})]})]})}const bp={deals:"ma-deals",news:"veille"},ki=/^(deals?|news|breaking|live|update|analysis|markets?|opinion|icymi)$/i,vp=/^(this|that|these|those|why|what|what'?s|how|when|where|who|which|is|are|do|does|did|can|could|should|would|will|a|an|the|les?|la|des?|une?|un)\b/i,wp=/\b(labor day|workers?|toast|monday|tuesday|wednesday|thursday|friday|saturday|sunday|assessment|volunteer)\b/i,yp=/\b(?:buys?|buying|to\s+buy|acquired?|acquires?|to\s+acquire|acquiert|rachet(?:e|é|ée)?|raises?|raised|l[èe]ve|merges?\s+with)\b/i;function Ei(e){const a=(e||"").trim();return!(!a||a.length<2||a.length>48||ki.test(a)||vp.test(a)||wp.test(a)||Kt(a)||!Za(a))}function mo(e){return(e.url||e.title||"").trim()}function fn(e){const a=(e.kind||"").toLowerCase(),r=(e.ingest_kind||"").toLowerCase();if(a==="article"||a==="news"||a==="media"||r==="url"||r==="youtube")return!0;const n=(e.title||"").replace(/\s+/g," ").trim();return n?Kt(n)||yp.test(n)?!0:!Za(n):!!(e.url||"").trim()}function Xn(e){let a=(e||"").replace(/\s+/g," ").trim();a=a.replace(/^\s*(?:deals?|news|breaking|live|update|analysis)\s*[:–—|]\s*/i,"");const r=[],n=d=>{let l=(d||"").replace(/[\u2018\u2019\u201c\u201d'"«»]/g,"").trim();l=l.replace(/^(the|le|la|les|l['’])\s+/i,"").trim(),l=l.replace(/\s+(?:'s|retirement|business|unit|division|arm|operations?)\b.*$/i,"").trim(),Ei(l)&&(r.some(s=>s.toLowerCase()===l.toLowerCase())||r.push(l))},o=a.match(/^(.{2,48}?)\s+(?:buys?|buying|to\s+buy|acquired?|acquires?|to\s+acquire|acquiert|rachet(?:e|é|ée)?|raises?|raised|l[èe]ve|merges?\s+with)\s+(.{2,60}?)(?:\s+(?:for|pour|en|in|at|à|from|de)\b|$)/i);if(o&&(n(o[1]),n(o[2]),r.length))return r;const i=a.match(/^(.{2,48}?)\s*[:–—]/);return i&&n(i[1]),r}function fo(e){const a=Xn(e.title||"");if(a.length)return a[0];const r=(e.title||"").replace(/\s+/g," ").trim();if(!r)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const n=/^(.{2,72}?)[:–—|]/.exec(r);return n&&!ki.test(n[1].trim())?n[1].trim():(r.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||r).slice(0,72).trim()}function kp({pageToken:e,onAddNames:a,onPanel:r}){const{t:n,lang:o,token:i,canWrite:d,flash:l}=Z(),[s,h]=p.useState(null),[c,x]=p.useState(!1),[u,b]=p.useState({deals:[],news:[]}),[f,w]=p.useState({deals:!1,news:!1}),[v,m]=p.useState(null),[y,E]=p.useState(""),k=p.useCallback(async F=>{if(!i)return[];if(f[F])return u[F];m(F),E("");const g=Date.now(),A=await ys(bp[F],i,o),S=700-(Date.now()-g);return S>0&&await new Promise(I=>window.setTimeout(I,S)),m(null),!A.ok&&A.error?(E(A.error),[]):(b(I=>({...I,[F]:A.items})),w(I=>({...I,[F]:!0})),A.items)},[i,o,f,u]);p.useEffect(()=>{s&&k(s)},[s,k]);const j=p.useCallback(F=>u[F].map(mo).filter(Boolean),[u]),N=p.useMemo(()=>{var A,S;if(!i)return{deals:[],news:[]};const F={deals:j("deals"),news:j("news")},g=Ho("feed:"+i,F);return{deals:((A=g.deals)==null?void 0:A.noms)||[],news:((S=g.news)==null?void 0:S.noms)||[]}},[i,j]),C=p.useRef(null);p.useEffect(()=>{C.current&&!s&&i&&Vo("feed:"+i,{deals:j("deals"),news:j("news")}),C.current=s},[s,i,j]);const T=()=>{h(null),x(!1),r==null||r(!1)},L=F=>{const g=[],A=new Set,S=I=>{const U=I.trim();!U||A.has(U.toLowerCase())||(A.add(U.toLowerCase()),g.push(U))};F.forEach(I=>{fn(I)?Xn(I.title||"").forEach(S):S(fo(I))}),g.length&&(a(g),T(),l(n.feedSent(g.length)))},O=F=>{const g=fo(F);g&&(window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g,url:(F.url||"").trim()}})),T(),l(n.feedPasted(g)),requestAnimationFrame(()=>{var A;(A=document.querySelector(".atl2 .eval-stick, .atl2 .demand"))==null||A.scrollIntoView({block:"center",behavior:"smooth"})}))},M=F=>{if(fn(F)){const g=(F.url||"").trim(),A=(F.title||"").trim();if(!g&&!A)return;window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g,text:A,auto:!0}})),T(),l(n.feedExtracting);return}O(F)},V=F=>{h(g=>{const A=g===F?null:F;return A&&x(!1),r==null||r(!!A),A})},J=F=>{const g=u[F],A=new Set(N[F].map(I=>I.toLowerCase())),S=v===F||s===F&&!f[F]&&!y;return t.jsxs("div",{className:"dfpane"+(s===F?" on":"")+(c?" tall":""),hidden:s!==F,children:[t.jsxs("div",{className:"dfhow",children:[t.jsxs("div",{className:"dfhow-h",children:[t.jsx("p",{className:"dfh",children:F==="deals"?n.feedDealsH:n.feedNewsH}),t.jsxs("span",{className:"dfhow-acts",children:[t.jsx("button",{type:"button",className:"dffold",onClick:()=>x(I=>!I),children:c?n.feedShrink:n.feedExpand}),t.jsx("button",{type:"button",className:"dffold",onClick:T,children:n.feedFold})]})]}),t.jsx("p",{className:"dfh2",children:F==="deals"?n.feedDealsHow:n.feedNewsHow})]}),S&&t.jsxs("div",{className:"dfwait",role:"status","aria-live":"polite",children:[t.jsx("i",{className:"dfspin","aria-hidden":"true"}),t.jsxs("div",{children:[t.jsx("b",{children:F==="deals"?n.feedWaitDeals:n.feedWaitNews}),t.jsx("span",{className:"dfbar",children:t.jsx("i",{})})]})]}),s===F&&!!y&&t.jsx("p",{className:"dferr",children:y}),f[F]&&!g.length&&!v&&t.jsx("p",{className:"dfempty",children:F==="deals"?n.feedEmptyDeals:n.feedEmptyNews}),!!g.length&&!S&&t.jsxs(t.Fragment,{children:[F==="deals"&&d&&g.length>1&&t.jsxs("button",{type:"button",className:"dfall",onClick:()=>L(g),children:[n.feedPutAll," (",g.length,")"]}),t.jsx("ul",{className:"dflist",children:g.map((I,U)=>{const Q=mo(I),ne=A.has(Q.toLowerCase()),z=(I.url||"").trim();return t.jsxs("li",{className:ne?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:I.title||z}),t.jsx("span",{children:[I.source,I.sector_fr,(I.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[z&&t.jsx("a",{href:z,target:"_blank",rel:"noopener noreferrer",children:n.feedOpen}),d&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>M(I),children:fn(I)?n.rowExtract:n.feedPutEval})]})]},Q||U)})})]})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(F=>{const g=N[F].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(F==="deals"?"ddeals":"dnews")+(s===F?" on":"")+(v===F?" busy":""),title:F==="deals"?n.feedDealsH:n.feedNewsH,"aria-expanded":s===F,"aria-busy":v===F||void 0,onClick:()=>V(F),children:[v===F?o==="en"?"Loading…":"Chargement…":F==="deals"?n.feedDeals:n.feedNews,g>0&&v!==F&&t.jsx("em",{title:n.feedHint,children:n.feedNew(g)})]},F)}),s&&J(s)]})}function ji(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ep(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function ho({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=Z();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(s=>s.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(s=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:s.name}),s.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),s.line1&&t.jsx("p",{className:"w",children:s.line1}),s.line2&&t.jsx("p",{className:"r",children:s.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(s.name),children:l.rsEvalOne})]},s.name))})]}):null}function Ni({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=Z(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(ho,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(ho,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function jp({card:e,onEvaluate:a,onAddAll:r}){var l,s,h;const{t:n}=Z(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ji(e.summary_md||"").map((c,x)=>t.jsx("p",{children:c},x))})]}),t.jsx(Ni,{card:e,onEvaluate:a,onAddAll:r}),(((s=e.prospective)==null?void 0:s.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(c=>t.jsx("li",{children:c},c))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function Np(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Sp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=Z(),l=o,[s,h]=p.useState(null),[c,x]=p.useState(null),[u,b]=p.useState(null),[f,w]=p.useState(!1);p.useEffect(()=>{let m=!0;return(async()=>{const y=await Fo({email:d,cbToken:l});m&&h(y)})(),()=>{m=!1}},[d,l,n]);const v=m=>{x(m),b(null),w(!0),(async()=>{const y=await ks(m.id);b(y),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(s||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[Np(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?i.rsPub:i.rsPriv})]},m.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?i.rsPub:i.rsPriv})]}),f&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!f&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!f&&u&&t.jsx(jp,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Da=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ua(e){return/^https?:\/\//i.test((e||"").trim())}function ht(e){const a=(e||"").trim();return a?ua(a)?a:Da.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function zp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Cp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:l,evalBusy:s,evalCards:h,caps:c,data:x,canWrite:u,source:b,dossiers:f,doAnalyse:w,liveMemos:v,pipe:m}=Z(),y=r==="client",E=p.useMemo(()=>n||(b!=="default"?Es():""),[n,b]),[k,j]=p.useState(""),[N,C]=p.useState(!1),[T,L]=p.useState(""),[O,M]=p.useState(""),[V,J]=p.useState(""),[F,g]=p.useState(!1),[A,S]=p.useState(!1),[I,U]=p.useState([]);p.useEffect(()=>{const _=G=>{const re=G.detail;re&&U(ge=>[re,...ge].slice(0,8))};return window.addEventListener("ppmap:evalcard",_),()=>window.removeEventListener("ppmap:evalcard",_)},[]);const[Q,ne]=p.useState(!1),[z,B]=p.useState(!1),[D,ee]=p.useState(!1),$=p.useRef(!1),[oe,fe]=p.useState(""),[be,ke]=p.useState(""),[ue,Se]=p.useState(!1),[Ae,me]=p.useState(!1),[we,Ee]=p.useState(0),[te,P]=p.useState(""),[K,se]=p.useState(null),[le,he]=p.useState(null),[H,de]=p.useState(!1),[ye,je]=p.useState(null),[Ne,ve]=p.useState(0),$e=p.useRef(!1),tt=p.useRef(()=>{}),ct=k.trim()?Da.test(k.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const _=new URLSearchParams(window.location.search),G=(_.get("rs")||"").trim(),re=(_.get("rstext")||"").trim();G&&/^https?:\/\//i.test(G)&&fe(G),re&&ke(re),(G&&/^https?:\/\//i.test(G)||re)&&ne(!0)},[]),p.useEffect(()=>{const _=G=>{const re=G.detail||{},ge=String(re.url||"").trim(),pe=String(re.text||"").trim(),Oe=ge&&/^https?:\/\//i.test(ge)?ge:"";Oe&&fe(Oe),pe&&ke(pe),(Oe||pe)&&(ne(!0),j(""),L(""),P(""),B(!1),Se(!0),window.setTimeout(()=>Se(!1),900),re.auto&&window.setTimeout(()=>{tt.current({url:Oe,text:pe})},0))};return window.addEventListener("ppmap:research",_),()=>window.removeEventListener("ppmap:research",_)},[]),p.useEffect(()=>{const _=G=>{const re=G.detail||{},ge=String(re.name||"").trim();if(!ge)return;ne(!1),j(ge),L(ge);const pe=ht(String(re.website||re.domain||""));M(pe),J(ht(String(re.url||""))),g(!pe),C(!0),window.setTimeout(()=>C(!1),900)};return window.addEventListener("ppmap:prefill",_),()=>window.removeEventListener("ppmap:prefill",_)},[]),p.useEffect(()=>{const _=(T||"").trim();if(!_||Q||O){(O||!_||Q)&&g(!1);return}const G=Ye(_),re=f.find(Ce=>Ye(Ce.name)===G)||f.find(Ce=>{const Fe=Ye(Ce.name);return Fe.length>=3&&(G.includes(Fe)||Fe.includes(G))}),ge=ht((re==null?void 0:re.website)||"")||ht((re==null?void 0:re.domain)||""),pe=ht((re==null?void 0:re.url)||"");if(pe&&J(Ce=>Ce||pe),ge){M(ge),g(!1);return}let Oe=!0;return g(!0),Vn(_).then(Ce=>{var Ke,We;if(!Oe)return;const Fe=ht(Ce.website||"")||ht(((We=(Ke=Ce.candidates)==null?void 0:Ke[0])==null?void 0:We.url)||"");Fe&&M(Fe)}).catch(()=>{}).finally(()=>{Oe&&g(!1)}),()=>{Oe=!1}},[T,Q,O,f]),p.useEffect(()=>{const _=G=>{var ge;const re=String(((ge=G.detail)==null?void 0:ge.url)||"").trim();ua(re)&&window.open(re,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",_),()=>window.removeEventListener("ppmap:view",_)},[]),p.useEffect(()=>{if($.current===Q)return;$.current=Q,ee(!0);const _=window.setTimeout(()=>ee(!1),560);return()=>window.clearTimeout(_)},[Q]),p.useEffect(()=>{if(typeof window>"u")return;const _=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),G=document.querySelector(".atl2.ops, .atl2.cibles");if(!_||!G)return;const re=G.classList.contains("cibles")?document.querySelector(".atl2.cibles .live-stack"):null,ge=()=>{const Oe=parseFloat(window.getComputedStyle(_).top)||0,Ce=_.getBoundingClientRect().top<=Oe+1;_.classList.toggle("is-stuck",Ce),G.classList.toggle("url-stuck",Ce);const Fe=Math.round(_.getBoundingClientRect().height);G.style.setProperty("--demand-h",`${Fe}px`);const Ke=window.matchMedia("(min-width: 861px)").matches;re&&Ke?G.style.setProperty("--pp-live-h",`${Math.round(re.getBoundingClientRect().height)}px`):G.classList.contains("cibles")&&G.style.setProperty("--pp-live-h","0px")};ge();const pe=new ResizeObserver(ge);return pe.observe(_),re&&pe.observe(re),window.addEventListener("scroll",ge,!0),window.addEventListener("resize",ge),()=>{pe.disconnect(),_.classList.remove("is-stuck"),G.classList.remove("url-stuck"),window.removeEventListener("scroll",ge,!0),window.removeEventListener("resize",ge)}},[b,N,ue,A,Q,D,F]),p.useEffect(()=>{if(!u&&!E){je(null);return}let _=!0;return(async()=>{const G=await Fo({email:o,cbToken:E});_&&je(G.length)})(),()=>{_=!1}},[u,E,o,Ne]);const Re=I.length?I:h,Ve=x.credits,yt=p.useCallback(_=>{const G=hp(n,_);return S(!1),l({type:"ptab",tab:0}),requestAnimationFrame(()=>{const re=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!re)return;const ge=window.scrollY+re.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,ge),behavior:"smooth"})}),G},[n,l]);p.useEffect(()=>{if(!Ae)return;Ee(0);const _=window.setInterval(()=>Ee(G=>G+1),1e3);return()=>window.clearInterval(_)},[Ae]);const Ue=p.useMemo(()=>{const _=k.trim().toLowerCase();return!_||!m?null:f.find(G=>Ye(G.name)===_&&Te(G)===1)||null},[k,f,m]),it=()=>{const _=k.trim();if(_){if(Ue){w(Ue);return}i(null,_),y&&j("")}},Ot=(_,G,re,ge)=>{const pe=re.length?re:G,Oe=yt(pe)||0;gp({title:(_.title||"").trim(),url:(_.source_url||"").trim(),cited:G,match:re,added:Oe,fallback:ge})},kt=async _=>{var ge,pe,Oe;if($e.current)return;const G=((_==null?void 0:_.url)??oe).trim().replace(/\s+/g,""),re=((_==null?void 0:_.text)??be).trim();if(!G&&!re){P(e.rsNeed);return}if(!y&&!E){i(null,G||re.slice(0,80));return}$e.current=!0,P(""),se(null),he(null),me(!0);try{const Ce=await Ns({url:G,text:re,email:o,cbToken:E});me(!1);const Fe=mt=>(mt||[]).map(qt=>((qt==null?void 0:qt.name)||"").trim()).filter(Ei);if(!Ce||Ce.status!=="success"){const mt=Xn(re||(Ce==null?void 0:Ce.title)||"");if(mt.length){const qt={status:"success",title:re||G,source_url:G,summary_md:e.rsNoteFallback,companies_cited:mt.map(na=>({name:na})),prospective:{companies_to_evaluate:mt.map(na=>({name:na}))}};P(""),se(qt),ne(!1),Ot(qt,mt,mt,!0);return}se(null),B(!0),P((Ce!=null&&Ce.message?Ce.message+" — ":"")+e.rsNoteNone);return}se(Ce),ne(!1);const Ke=Fe(Ce.companies_cited),We=Fe((ge=Ce.prospective)==null?void 0:ge.companies_to_evaluate);Ot(Ce,Ke,We,!1),he({state:"pending"});const ut=await Ss(Ce,{email:o,cbToken:E});he(ut.ok?{state:"ok",scopeLabel:((pe=ut.summary)==null?void 0:pe.scope_label)||"",scope:((Oe=ut.summary)==null?void 0:Oe.scope)||""}:{state:"fail",msg:ut.error||""}),ut.ok&&ve(mt=>mt+1)}finally{$e.current=!1,me(!1)}};tt.current=_=>{kt(_)};const Mt=[K==null?void 0:K.industry,...(K==null?void 0:K.market_tags)||[],K==null?void 0:K.author].map(_=>(_||"").trim()).filter(Boolean),Ct=(le==null?void 0:le.state)==="pending",At=()=>{de(!0),requestAnimationFrame(()=>{var _;(_=document.querySelector(".atl2 .rsarch"))==null||_.scrollIntoView({block:"nearest",behavior:"smooth"})})},Et=le&&(Ct?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):le.state==="ok"?t.jsxs("button",{type:"button",className:"rslink ok",onClick:At,children:[le.scope&&le.scope!=="public"?e.rsSavedIn(le.scopeLabel||le.scope.replace(/^fund:/,"")):e.rsSaved," ",e.rsSavedOpen]}):t.jsx("span",{className:"rslink fail",title:le.msg,children:e.rsSaveFail})),Dt=Ep(K).length,De=Q,xt=(T||k).trim(),at=f.find(_=>Ye(_.name)===Ye(xt)),R=ht(k)||O||ht((at==null?void 0:at.website)||"")||ht((at==null?void 0:at.domain)||""),W=V||ht((at==null?void 0:at.url)||""),ae=Ue?e.actAnalyse:xt?e.evalGoOn(xt.length>22?xt.slice(0,21)+"…":xt):e.evalGo,ce=Ae?`${js(oe.trim())==="youtube"&&oe.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(we)}`:Ct?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(De?" rs-mode":"")+(T&&k.trim()===T||N||ue?" pair":"")+(N||ue||D?" echo":"")+(D?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:De?a==="en"?"Extract companies from an article":"Extraire les sociétés d’un article":a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:De?a==="en"?"Paste an article or video URL — Stan lists the companies, then you pick which ones to screen.":"Collez l’URL d’un article ou d’une vidéo — Stan en sort les sociétés, vous choisissez lesquelles évaluer.":a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((De?ue:N)||D?" flash":"")+((De?oe.trim():Da.test(k.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:De?oe:k,placeholder:De?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:De?600:200,spellCheck:De?!1:void 0,inputMode:De?"url":void 0,onChange:_=>{if(De){fe(_.target.value);return}j(_.target.value),T&&_.target.value.trim()!==T&&(L(""),M(""),J(""),g(!1))},onKeyDown:_=>{_.key==="Enter"&&(De?kt():it())}}),t.jsx("span",{className:"detect"+(De?" off":"")+(Da.test(k.trim())?" url":""),children:ct})]}),t.jsx("span",{className:"dacts",children:De?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Ae?" loading":""),disabled:Ae||Ct||!oe.trim()&&!be.trim(),onClick:()=>{kt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ce})]}),t.jsxs("a",{className:"viewbtn"+(ua(oe)?"":" off"),href:ua(oe)?oe.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:_=>{ua(oe)||_.preventDefault()},children:[t.jsx(zp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs(en,{lang:a,storeKey:((Ue==null?void 0:Ue.name)||k).trim(),className:"evalbtn"+(Ue?" analyse":"")+(s?" loading":""),disabled:s,confirmLabel:ae,onConfirm:it,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ae})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(F?" searching":R?"":" off"),href:R||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:_=>{R||_.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite,!F&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(W?"":" off"),href:W||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:_=>{W||_.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),c.showCredits&&Ve&&b==="ops"&&t.jsxs("button",{type:"button",className:"credits"+(Ve.total_available<=0&&!Ve.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Ve.unlimited?"∞":Ve.total_available}),!Ve.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Ve.daily_grant+Ve.purchased]}),Ve.total_available<=0&&!Ve.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{l({type:"ptab",tab:0}),S(!1),requestAnimationFrame(()=>{const _=document.querySelector(".atl2.cibles .desk-list");if(!_)return;const G=window.scrollY+_.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,G),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(Q?" on":""),title:e.rsOpenHint,onClick:()=>ne(!Q),children:e.rsOpen}),ye!==null&&ye>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(H?" on":""),onClick:()=>{H?de(!1):At()},children:e.rsArchOpen(ye)}),c.pipe&&!!n&&t.jsx(kp,{pageToken:E,onAddNames:yt,onPanel:()=>{B(!1)}})]}),H&&t.jsx(Sp,{bump:Ne,cbToken:E,onClose:()=>de(!1),onEvaluate:_=>i(null,_),onAddAll:yt}),t.jsx("div",{className:"rsp slim"+(Q?" on":" off"),"aria-hidden":!Q,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:Q?void 0:-1,onClick:()=>B(_=>!_),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:z?"▴":"▾"})]}),t.jsx("button",{type:"button",className:"dffold",tabIndex:Q?void 0:-1,onClick:()=>{ne(!1),B(!1),P("")},children:e.feedFold}),z&&t.jsx("textarea",{className:"rstext",value:be,placeholder:e.rsTextPh,tabIndex:Q?void 0:-1,onChange:_=>ke(_.target.value)})]})}),te&&t.jsxs("div",{className:"rserr",children:[te,t.jsx("button",{type:"button",className:"eq-note-x",title:e.rsClose,onClick:()=>P(""),children:"×"})]}),K&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:K.title}),K.source_url&&t.jsx("a",{href:K.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{se(null),he(null)},children:"×"})]}),K.market&&t.jsx("p",{className:"rsmk",children:K.market}),Mt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Mt.map(_=>t.jsx("span",{children:_},_))]}),t.jsxs("div",{className:"rsbody",children:[K.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${K.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ji(K.summary_md||"").map((_,G)=>t.jsx("p",{children:_},G))})]}),t.jsx(Ni,{card:K,onEvaluate:_=>i(null,_),onAddAll:yt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Dt)}),Et]})]}),Re.slice(0,1).map((_,G)=>{const re=_.verdict==="kept",ge=_.verdict==="quota",pe=_.verdict==="unresolved",Oe=re?"var(--brand)":ge?"var(--bolt)":pe?"var(--blue)":"var(--red)",Ce=re?"var(--brand-l)":ge?"#FFF3D6":pe?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":Oe,"--bgc":Ce},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:re?"✓ "+e.kept:ge?"⏳":pe?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),_.name&&t.jsx("span",{className:"rn",children:_.name}),t.jsx("span",{className:"rr",children:_.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",_.reason]}):null}),!!(_.candidates&&_.candidates.length)&&t.jsx("span",{className:"sitepick",children:_.candidates.map(Fe=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Fe.url.startsWith("http")?Fe.url:`https://${Fe.url}`,target:"_blank",rel:"nofollow noopener",children:[(Fe.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Fe.url,_.name),children:e.evalPickGo})]},Fe.url))}),!ge&&!pe&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:re?1:5});const Fe=(_.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ke=[...document.querySelectorAll(".atl2 .list .row")].find(We=>{var ut;return(((ut=We.querySelector(".rnm"))==null?void 0:ut.textContent)||"").trim().toLowerCase().includes(Fe)});Ke&&(Ke.scrollIntoView({behavior:"smooth",block:"center"}),Ke.classList.add("flashrow"),window.setTimeout(()=>Ke.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(re?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},G)}),y&&(d.kept+d.dropped>0||Re.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Ap(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function qp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Z(),i=e.memoConsole?r.get(e.memoConsole):null,d=p.useMemo(()=>i?[i.reasoning||"",Ap(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=Rt(i),s=Un(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:d?d.split(`

`).map((h,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:h},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Qt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:s===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Zn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Z(),[d,l]=p.useState(!1),[s,h]=p.useState(null),c=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!c||d)return;l(!0);const u=await Lo(r,e);if(l(!1),!u){i(a.actErr);return}h(u.results||[])};return p.useEffect(()=>{if(!c)return;const u=b=>{var w;const f=String(((w=b.detail)==null?void 0:w.name)||"").trim();f&&f.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,c]),p.useEffect(()=>{if(c)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,c]),c?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{x()},children:d?a.similarBusy:a.similar}),s&&(s.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:s.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Tp=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),La=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function va(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}function $n(e){const a=va(e);if(!a)return"";try{return new URL(a).hostname.replace(/^www\./,"")}catch{return""}}function Lp(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=La(a.slice(n));break}r+=La(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=La(a.slice(o));break}const d=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(d),s=l?l[2].toLowerCase():"";l&&Tp.has(s)?r+=`<${l[1]}${s}>`:r+=La(a.slice(o,i+1)),n=i+1}return r}const Fp=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),go={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function Si(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(Fp.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const l=d.name.toLowerCase();(!(go["*"].has(l)||((r=go[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}Si(n)}}function Ia(e){const a=e.cloneNode(!0);return Si(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Rp={swot:null,summary:"",syn:"",pnl:"",cf:"",roi:"",reco:"",plan:"",pruned:[]},Op=/chiffre|revenu|revenue|\barr\b|ebitda|marge|gross|fcf|free cash|net|total|r[ée]sultat|cash|capex|nopat|moic|irr|\btri\b|roi|entry|\bev\b|invested|synerg/i,Mp=[["syn",/synerg/i],["pnl",/compte de r[ée]sultat|p\s*&\s*l|profit\s*(?:and|&)\s*loss|income statement/i],["cf",/flux de tr[ée]sorerie|cash\s*-?\s*flow/i],["roi",/\broi\b|return on investment|retour sur investissement/i],["reco",/verdict post|post[- ]model verdict|conviction quantitative/i]];function Ht(e){return String(e||"").replace(/<script[\s\S]*?<\/script>/gi," ").replace(/<style[\s\S]*?<\/style>/gi," ").replace(/<[^>]+>/g," ").replace(/&nbsp;/gi," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#39;|&apos;/g,"'").replace(/&quot;/g,'"').replace(/\s+/g," ").trim()}function zi(e,a){const r=e.slice(a),n=/<div\b|<\/div\s*>/gi;let o=0,i;for(;i=n.exec(r);)if(i[0][1]!=="/")o+=1;else if(o-=1,o===0)return e.slice(a,a+i.index+i[0].length);return""}function hn(e,a){const n=new RegExp(`<div\\b[^>]*\\bid="${a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}"`,"i").exec(e);return n?zi(e,n.index):""}function Dp(e,a=14){const r=e.match(/<tr\b[\s\S]*?<\/tr\s*>/gi)||[];if(r.length<=a)return{html:e,pruned:!1};const n=[];for(let d=0;d<r.length-1;d+=1){const l=r[d],s=/<t[dh]\b[^>]*>([\s\S]*?)<\/t[dh]\s*>/i.exec(l),h=s?Ht(s[1]):"";if((d<2||/<th/i.test(l)||Op.test(h))&&n.push(l),n.length>=a-1)break}n.push(r[r.length-1]);const o=n.length<3?r.slice(0,a):n;return{html:(/^\s*<table\b[^>]*>/i.exec(e)||["<table>"])[0]+o.join("")+"</table>",pruned:!0}}function Ip(e,a=14){let r=!1;return{html:e.replace(/<table\b[\s\S]*?<\/table\s*>/gi,o=>{const i=Dp(o,a);return r=r||i.pruned,i.html}),pruned:r}}function Pp(e){const a={s:[],w:[],o:[],t:[]},r=[["s","s-green"],["w","s-red"],["o","s-blue"],["t","s-orange"]];for(const[n,o]of r){const i=new RegExp(`<div\\b[^>]*class="[^"]*swot-item[^"]*\\b${o}\\b[^"]*"`,"i").exec(e);if(!i)return null;const d=zi(e,i.index);let l=(d.match(/<li\b[^>]*>([\s\S]*?)<\/li\s*>/gi)||[]).map(s=>Ht(s));if(!l.length){const s=/<p\b[^>]*>([\s\S]*?)<\/p\s*>/i.exec(d);s&&(l=[Ht(s[1])])}if(l=l.filter(s=>s&&!/not available/i.test(s)&&!/non disponible/i.test(s)).map(s=>s.slice(0,260)).slice(0,4),!l.length)return null;a[n]=l}return a}function _p(e){const a=e.search(/id=["']company-summary["']/i);if(a<0)return"";const r=e.slice(a,a+9e3),n=/(?:EN R[ÉE]SUM[ÉE]|EN QUELQUES MOTS|IN SUMMARY|IN A FEW WORDS|IN A NUTSHELL|TL;DR)[\s:]*(?:<\/?span[^>]*>[\s:]*)*([\s\S]+?)(?=<br|<hr|<\/div|<h[23]|⚠|✅|🚀|❓|$)/i.exec(r);return n?Ht(n[1]).slice(0,600):""}function Bp(e,a,r){if(r<0)return"";const n=/<h3\b[^>]*>([\s\S]*?)<\/h3\s*>/gi;n.lastIndex=r;let o;for(;o=n.exec(e);){if(!a.test(Ht(o[1])))continue;const i=/<h3\b[^>]*>/i.exec(e.slice(o.index+o[0].length));return i?e.slice(o.index,o.index+o[0].length+i.index):e.slice(o.index,Math.min(e.length,o.index+o[0].length+6e4))}return""}function xo(e){let a=e.replace(/^\s*<div\b[^>]*>/i,"").replace(/<\/div\s*>\s*$/i,"");return a=a.replace(/<h2\b[^>]*class="[^"]*section-title[^"]*"[^>]*>[\s\S]*?<\/h2\s*>/gi,""),a=a.replace(/<details\b[\s\S]*?<\/details\s*>/gi,""),a.trim()}function gn(e,a){if(e.length<=a)return e;const r=e.slice(0,a),n=r.lastIndexOf(">");return n>=0?r.slice(0,n+1):r}function $p(e){const a={...Rp,pruned:[]};if(!e)return a;try{const n=hn(e,"swot");n&&(a.swot=Pp(n))}catch{}try{a.summary=_p(e)}catch{}try{const n=hn(e,"action-plan");if(n){const o=xo(n);a.plan=gn(o,12e3)}}catch{}const r=e.search(/id=["']financial-forecast["']/i);for(const[n,o]of Mp)try{let i=Bp(e,o,r);if(!i)continue;const d=Ip(i);i=gn(d.html,45e3),Ht(i)&&(a[n]=i,d.pruned&&a.pruned.push(n))}catch{}if(!a.reco)try{const n=hn(e,"conviction");if(n){const o=gn(xo(n),8e3);Ht(o)&&(a.reco=o)}}catch{}return a}function Up(e){return e?!!(e.swot||e.summary||e.syn||e.pnl||e.cf||e.roi||e.reco||e.plan):!1}const xn=new Map;function Ci(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=xn.get(a);return r||(r=Hp(a).catch(()=>null),r.then(n=>{n||xn.delete(a)}),xn.set(a,r)),r}async function Hp(e){var u,b;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=await a.text(),n=new DOMParser().parseFromString(r,"text/html"),o=f=>{var w;return(((w=n.querySelector(f))==null?void 0:w.textContent)||"").trim()},i=n.querySelector(".sb-score"),d=((u=Array.from((i==null?void 0:i.classList)||[]).find(f=>f.startsWith("sb-score-")))==null?void 0:u.slice(9))||"",l=[];let s=null;const h=Array.from(n.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const f of h){if(f.classList.contains("sb-nav-heading")){s={label:(f.textContent||"").trim(),items:[]},l.push(s);continue}const w=f.getAttribute("href")||"";if(!w.startsWith("#"))continue;const v=w.slice(1),m=Wp(n,v);m&&(s||(s={label:"",items:[]},l.push(s)),s.items.push({id:v,title:(f.textContent||"").trim(),html:m,poids:m.length}))}const c=((b=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:b[1])||"",x={score:o(".sb-score"),scoreTone:d,tags:Array.from(n.querySelectorAll(".sb-tag")).map(f=>(f.textContent||"").trim()).filter(Boolean),name:o(".sidebar-company-name"),tagline:o(".sidebar-tagline"),desc:o(".meta-desc"),groups:l.filter(f=>f.items.length),mindmapSlug:n.querySelector(".cm-mindmap-png")?c:"",comite:Vp(n,$p(r))};return x.groups.length?x:null}function Vp(e,a){const r=n=>{if(!n)return"";const o=e.createElement("div");return o.innerHTML=n,Ia(o)};return{...a,syn:r(a.syn),pnl:r(a.pnl),cf:r(a.cf),roi:r(a.roi),reco:r(a.reco),plan:r(a.plan)}}const bo={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Wp(e,a){const r=e.getElementById(a),n=r?vo(e,r):"";if(n)return n;const o=bo[a]?e.querySelector(bo[a]):null;return o&&o!==r?vo(e,o):""}function vo(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Ia(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(s=>/^h3$/i.test(s.tagName))[0]===a)for(const s of i){if(s===a)break;/^h2$/i.test(s.tagName)||o.appendChild(s.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?Ia(o):""}return Ia(a)}const bn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Xe({k:e,v:a,href:r,wide:n}){return a==null||a===""?null:t.jsxs("div",{className:"cdl"+(n?" cdw":""),children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Gp({k:e,vals:a}){const r=(a||[]).filter(Boolean);return r.length?t.jsxs("div",{className:"cdl cdw",children:[t.jsx("span",{className:"cdk",children:e}),t.jsx("span",{className:"cdtags",children:r.map(n=>t.jsx("span",{className:"cdtag",children:n},n))})]}):null}function wo(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function yo({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const vn=new Map;function Yp(e,a){const{token:r}=Z(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=vn.get(i);d||(d=zs(r,e.name,e.checkId),vn.set(i,d),d.then(s=>{(!s||!s.reasoning&&!s.summaryHtml)&&vn.delete(i)}));let l=!0;return d.then(s=>{l&&s&&o({id:e.id,d:s})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Qp=6e4;function Kp({o:e}){const{t:a,doDeep:r}=Z(),[n,o]=p.useState(null),[i,d]=p.useState(e.memoUrl?"load":"off"),[l,s]=p.useState(()=>new Set),[h,c]=p.useState(!1),x=p.useRef(new Map);p.useEffect(()=>{let w=!0;if(s(new Set),c(!1),x.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),Ci(e.memoUrl).then(v=>{w&&(o(v),d(v?"ok":"err"))}),()=>{w=!1}},[e.memoUrl]);const u=Rt(e),b=w=>{var v;return(v=x.current.get(w))==null?void 0:v.scrollIntoView({behavior:"smooth",block:"start"})},f=t.jsxs("div",{className:"cdacts",children:[Qt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:w=>{w.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const w=[e.reasoning||"",wo(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[w.length?w.join(`
...
`).map((v,m)=>t.jsx("p",{className:"cdtxt",children:v},m)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:v=>{v.stopPropagation(),c(m=>!m)},children:h?a.memoHideHere:a.memoReadHere})}),h&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:v=>v.stopPropagation()}),f,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(w=>t.jsx("span",{className:"md-tag",children:w},w)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(w=>w.items.map(v=>t.jsx("button",{type:"button",className:"md-jump",onClick:m=>{m.stopPropagation(),b(v.id)},children:v.title},v.id)))}),n.groups.map((w,v)=>t.jsxs("div",{className:"md-grp",children:[w.label&&t.jsx("div",{className:"md-grp-h",children:w.label}),w.items.map(m=>{const y=m.poids>Qp&&!l.has(m.id),E=m.id==="fiche-contact"||m.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:k=>{k&&x.current.set(m.id,k)},children:[t.jsx("h4",{className:"md-h",children:m.title}),E&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:k=>k.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:"LinkedIn"})]}),y?t.jsx("button",{type:"button",className:"abtn md-more",onClick:k=>{k.stopPropagation(),s(j=>new Set(j).add(m.id))},children:a.memoUnfold(Math.round(m.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:E?m.html.replace(/>\s*unavailable(\s+unavailable)*\s*</gi,"><"):m.html}}),!y&&n.mindmapSlug&&m.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${ya}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:k=>k.stopPropagation()})]})]},m.id)})]},w.label||v)),f,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull})]})}function Jp({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:l}=Z(),[s,h]=p.useState(!1),[c,x]=p.useState(!1),[u,b]=p.useState(!1),[f,w]=p.useState(null),[v,m]=p.useState(""),[y,E]=p.useState(null),[k,j]=p.useState(""),N={airtableId:e.airtableId,checkId:e.checkId},C=!!(e.airtableId||e.checkId),T=f&&f.id===e.id?f.entries:[],L=!!f&&f.id===e.id;if(p.useEffect(()=>{m(""),E(null),b(!1)},[e.id]),p.useEffect(()=>{if(!s||L||!C||!o)return;let M=!0;x(!0),b(!1);const V=e.id;return gr(r,"list",N).then(J=>{if(!(!M||V!==e.id)){if(x(!1),!J.ok){b(!0);return}w({id:V,entries:J.entries})}}),()=>{M=!1}},[s,L,C,r,e.id,o]),!n.pipe||!o||!C)return null;const O=(M,V)=>{x(!0);const J=e.id;gr(r,M,N,V).then(F=>{if(J===e.id){if(x(!1),!F.ok){d(a.notesErr);return}w({id:J,entries:F.entries}),b(!1),M==="add"&&(m(""),i(a.notesAdded)),M==="edit"&&E(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":s,onClick:M=>{M.stopPropagation(),h(V=>!V)},children:[t.jsx("b",{children:a.notesT}),T.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(T.length)}),t.jsx("i",{children:s?"▾":"▸"})]}),s&&t.jsxs("div",{className:"dn-b",onClick:M=>M.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),c&&!T.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!c&&!u&&L&&!T.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),T.map(M=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:l==="fr"?M.date.split("-").reverse().join("/"):M.date}),y===M.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:k,rows:3,onChange:V=>j(V.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||!k.trim(),onClick:()=>O("edit",{entryId:M.id,text:k.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>E(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:M.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{E(M.id),j(M.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:c,onClick:()=>{window.confirm(a.notesDelAsk)&&O("delete",{entryId:M.id})},children:a.notesDel})]})]})]},M.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:v,onChange:M=>m(M.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:c||!v.trim(),onClick:()=>O("add",{text:v.trim()}),children:a.notesAdd})]})]})]})}function er({o:e}){var j;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:d}=Z(),l=ka(e),s=Rt(e),h=(e.cribleStatus||"").trim().toUpperCase()||(l==="NO MATCH"?"NO MATCH":l==="MATCH"?"MATCH":""),c=[e.sector,e.market,(e.tags||[]).filter(Boolean).length?"1":"",e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.provQuery,$n(e.provUrl||""),_a(e),e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,u=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(h?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Qt(e)?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:u}].filter(N=>N.n>0),[e,a,o,h,s,c,x,u]),[f,w]=p.useState(""),v=b.some(N=>N.k===f)?f:((j=b[0])==null?void 0:j.k)||"";p.useEffect(()=>{const N=C=>{var L;const T=String(((L=C.detail)==null?void 0:L.tab)||"");T&&b.some(O=>O.k===T)&&w(T)};return window.addEventListener("ppmap:card-tab",N),()=>window.removeEventListener("ppmap:card-tab",N)},[b]);const m=Yp(e,v==="eval"||v==="conv");if(!b.length)return null;const y=((m==null?void 0:m.reasoning)||"").length>(e.reasoning||"").length?m.reasoning:e.reasoning||"",E=((m==null?void 0:m.summaryHtml)||"").length>(e.summary||"").length?m.summaryHtml:e.summary||"",k=(m==null?void 0:m.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(N=>t.jsx("button",{type:"button",role:"tab","aria-selected":v===N.k,"data-tour":"tab-"+N.k,className:v===N.k?"on":"",onClick:C=>{C.stopPropagation(),w(N.k)},children:N.lib},N.k))}),t.jsxs("div",{className:"cdbody",onClick:N=>N.stopPropagation(),children:[v==="eval"&&t.jsxs(t.Fragment,{children:[h&&t.jsxs("div",{className:"cdv1"+(h==="NO MATCH"?" out":""),children:[t.jsx("b",{children:h==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(yo,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),y&&y.split(`

`).map((N,C)=>t.jsx("p",{className:"cdtxt",children:N},C)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Xp,{o:e})]}),v==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof k=="number"&&t.jsx(yo,{v:k,sur:100,k:a.cdConvScore}),bn(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",bn(e.verdictDate,r)]})]}),E&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:Lp(E)}})]}),v==="memo"&&t.jsx(Kp,{o:e}),v==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Xe,{k:a.cdSector,v:e.sector}),t.jsx(Xe,{k:a.cdMarket,v:e.market,wide:!0}),t.jsx(Gp,{k:a.cdTags,vals:e.tags}),t.jsx(Xe,{k:a.cdStage,v:e.stage}),t.jsx(Xe,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Xe,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Xe,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Xe,{k:a.cdAngle,v:e.angle}),t.jsx(Xe,{k:a.cdDetected,v:bn(e.date,r)}),t.jsx(Xe,{k:a.cdQuery,v:e.provQuery,wide:!0}),t.jsx(Xe,{k:a.cdSrc,v:$n(e.provUrl||""),href:va(e.provUrl||"")}),t.jsx(Xe,{k:a.cdAngleSrc,v:_a(e)})]}),v==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Xe,{k:a.cdName,v:e.contactName}),t.jsx(Xe,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Xe,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(Xe,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),v==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(Xe,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(Jp,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(e),children:a.actRegen})]})]})]})]})}const Fa=new Map;function Xp({o:e}){const{t:a,token:r}=Z(),[n,o]=p.useState(!1),[i,d]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const x=`${r}:${e.name.toLowerCase()}`;let u=Fa.get(x);u||(u=Ro(r,[e.name]).then(f=>f[e.name]||Object.values(f)[0]||null).catch(()=>null),Fa.set(x,u),u.then(f=>{(!f||!f.ok)&&Fa.delete(x)}));let b=!0;return u.then(f=>{b&&f&&f.ok&&d(f)}),()=>{b=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const x=await qo(r,e.name,e.website||e.domain||"");d(x),x.ok&&Fa.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(x)),o(!1)},s=(i==null?void 0:i.blocs)||{},h=[[a.qaVP,s.value_prop],[a.qaProduct,s.produit],[a.qaModel,s.modele],[a.qaSummary,s.synthese]],c=h.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&c&&t.jsxs(t.Fragment,{children:[h.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!c&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function aa({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const l=()=>{const h=Math.max(280,Math.min(560,i.clientWidth||320));xr({kind:"op",card:e},h).then(c=>{!d&&c&&i.isConnected&&i.replaceChildren(c)})},s=window.requestAnimationFrame(l);return()=>{d=!0,window.cancelAnimationFrame(s),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;xr({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(s=>{!d&&s&&i.isConnected&&i.replaceChildren(s)});const l=s=>{s.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{d=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&ea.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Zp=`
...
`;function ec(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:d,top:l}}function tc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:l,doAnalyse:s,doDecide:h,doPromote:c,doRepeche:x,doApproach:u,doDeep:b,doOnboard:f,outbound:w,evalBusy:v}=Z(),m=e.popupId?r.get(e.popupId):null;if(!m)return null;const y=He(m),E=Te(m),k=Rt(m),j=ka(m),N=m.kind==="target",C=T=>{a({type:"filters",patch:T}),a({type:"popup",id:null})};return ea.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Zp}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:ec(e.popupAnchor,!!m.card),onClick:T=>T.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:m.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(gt(m.date)),ot(m.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[m.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[m.cc]}),children:(ta(m.cc,o)||m.countryLabel||"").toUpperCase()}),m.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[m.sector]}),children:m.sector.toUpperCase()}),m.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[m.stage]}),children:m.stage.toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{className:"am2",children:Vt(m.amountEur,o)})]}),i.pipe&&N&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),m.ceoStatus&&t.jsx("span",{className:"pstep own",children:m.ceoStatus})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Bt(m.engine)," ",t.jsx("b",{children:ot(m.engine,o)})," — ",Cs(m.engine,o),m.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",m.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ft,{o:m,lg:!0})," ",t.jsx(tn,{o:m,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Oo(y,o))," · ",n.win7(Mo(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),m.card?t.jsx(aa,{spec:m.card}):null,m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),i.pipe&&N&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof m.score=="number"&&m.score>0?" · "+n.score(m.score):""]})}),i.pipe&&N&&t.jsx(er,{o:m})]}),t.jsx(Zn,{name:m.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>l(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)]}),E===1&&t.jsxs(en,{lang:o,storeKey:m.name,className:"evalbtn memo",style:{flex:1,justifyContent:"center"},confirmLabel:n.actAnalyse,onConfirm:()=>{s(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(m,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(m,!1),a({type:"popup",id:null})},children:n.actNo}),Qt(m)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(m),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),m.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:m.id}),a({type:"popup",id:null})},children:"📄"}),w&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{f(m),a({type:"popup",id:null})},children:"🚀"})]}):m.engine==="media"&&m.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var T;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"popup",id:null}),(T=document.querySelector(".atl2 .demand"))==null||T.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(m.name),onClick:()=>l(m),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>l(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)," →"]}),m.website&&t.jsx("a",{className:"psite",href:m.website.startsWith("http")?m.website:"https://"+m.website,target:"_blank",rel:"noopener noreferrer",title:m.website,children:"🌐"})]})]})]}),document.body)}function ac(){const{lang:e,token:a,dossiers:r,caps:n}=Z(),o=a||"home",{names:i,verdicts:d}=p.useMemo(()=>{const s=[],h={};return r.forEach(c=>{c.kind!=="target"||!c.name||(s.push(c.name),h[c.name]=As(c)||"")}),{names:s,verdicts:h}},[r]);return{diff:p.useMemo(()=>i.length?qs(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function nc(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:l}=Z(),[s,h]=p.useState(!1),[c,x]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!s)return;const E=k=>{u.current&&!u.current.contains(k.target)&&h(!1)};return document.addEventListener("click",E,!0),()=>document.removeEventListener("click",E,!0)},[s]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],f=i.loading&&!d.length,w=p.useRef({});p.useEffect(()=>{w.current={...r}},[r]);const v=E=>{const k=w.current[E],j=k!==void 0?r[E]-k:0;return t.jsxs("button",{type:"button",className:"step"+(E===3&&r[3]>0?" wait":""),style:{"--c":`var(${fa[E]})`,"--tc":E<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsxs("span",{className:"l",children:[n.plabels[E],E===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(j>0?" up":j<0?" down":""),children:[r[E],j!==0&&t.jsxs("em",{className:"delta",children:[j>0?"+":"−",Math.abs(j)]})]})]},E)},m=(E,k,j)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),"data-off":E,style:{"--c":`var(${fa[E]})`},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsx("span",{className:"l",children:j}),t.jsx("span",{className:"n",children:r[E]})]},E),y=(E,k,j,N=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:N,onClick:j,children:E},k);return t.jsxs("div",{className:"funnel"+(f?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(v)}),t.jsxs("div",{className:"offtrack",children:[m(5,!1,n.plabels[5]),m(7,!0,n.plabels[7]),m(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[y("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(c?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"}),a({type:"ptab",tab:1}),a({type:"continent",key:l.pipe?"europe":"monde"}),a({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":s,title:n.toolSort,onClick:()=>h(E=>!E),children:"⇅"}),s&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([E,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===E,className:"sortopt"+(e.sort.key===E?" on":""),onClick:()=>a({type:"sort",key:E}),children:[k,t.jsx("i",{children:e.sort.key===E?e.sort.dir===1?"↑":"↓":""})]},E))})]}),y("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),y("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function rc(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,mode:l,data:s}=Z(),h=p.useRef(null),[c,x]=p.useState(60);p.useEffect(()=>{let C=0;const T=()=>{var J;const L=h.current;if(!L)return;const O=(J=L.parentElement)==null?void 0:J.querySelector('.funnel [aria-selected="true"]');if(!O)return;const M=O.getBoundingClientRect(),V=L.getBoundingClientRect();x(Math.max(20,Math.min(M.left+M.width/2-V.left,V.width-30)))};return C=requestAnimationFrame(T),window.addEventListener("resize",T),()=>{cancelAnimationFrame(C),window.removeEventListener("resize",T)}},[e.ptab]);const u=e.ptab;let b=r.tuto[u].p;if(u===3){const C=i.filter(O=>O.kind==="target"&&Te(O)===3),T=C.filter(O=>En(O)==="auto").length,L=C.filter(O=>En(O)==="cd").length;b=r.tutoPending(T,L,C.length)}const f=(()=>{var C;if(l!=="client")return null;if(u===0&&i.length)return{label:r.tuto[0].a,locked:!1,run:()=>a({type:"chainStart",queue:i.map(T=>T.id)})};if(u===1){const T=i.filter(L=>L.kind==="target"&&Te(L)===1&&!d.has(L.id)).slice(0,10);if(T.length){const L=String(((C=s.credits)==null?void 0:C.plan)||"").toLowerCase(),O=L==="enterprise"||L==="entreprise";return{label:r.tuto[1].a,locked:!O,run:()=>{O&&a({type:"chainStart",queue:T.map(M=>M.id)})}}}}return null})(),w=Ts(u),v=u===1||u===2,m=u===5,y=u===7,E=u===6,k=w||m||y,j=r.plabels[u]+" · "+(o[u]??0),N=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:h,className:"tuto mini"+(k?"":" on-dark")+(v?" etape-on":"")+(m?" etape-out":"")+(y?" etape-view":"")+(E?" etape-fav":""),style:{"--bg":`var(${fa[u]})`,"--ax":c+"px","--stc":k?"var(--ink)":"#fff","--stt":k?"#fff":"var(--ink)","--tc":k?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:j}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),f&&t.jsx("button",{type:"button",className:"tprim"+(f.locked?" lock":""),disabled:!!f.locked,title:f.locked?r.analyseLockHint:void 0,onClick:f.run,children:f.locked?"🔒 "+r.analyseLock:f.label}),u!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:N})]})}const wn=600,Lt=62,ko="atl2:fstats";function oc(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Z(),[d,l]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(ko)==="on"}catch{return!1}}),s=r.stats,h=p.useMemo(()=>((s==null?void 0:s.by_day)||[]).slice(-30),[s]),c=(s==null?void 0:s.since)||"";if(!n.showFunnel||!s||typeof s.screened!="number")return null;const x=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,u=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),b=h.reduce((j,N)=>Math.max(j,N.s||0),0),f=h.length?wn/h.length:0,w=Math.max(4,f-4),v=h.length>=5&&b>0,m=r.marketEstimate||0,y=x(new Date().toISOString().slice(0,10)),E=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof s.kept=="number"?[[s.kept,e.funKept]]:[],...typeof s.analyzed=="number"?[[s.analyzed,e.funAnalyzed]]:[],...typeof s.shown=="number"?[[s.shown,e.funShown]]:[]],k=[];return typeof s.screened_window=="number"&&c&&k.push({cle:"fenetre",periode:e.funPerWindow(x(c),y),etapes:[[s.screened_window,e.funScreened("","")]]}),typeof s.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:E(s.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([N,C],T)=>t.jsxs("span",{className:"fst-t",children:[T>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(N)}),t.jsx("i",{children:C})]},j.cle+C)),j.cle==="total"&&m>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(m),Math.min(100,Math.round((s.screened||0)/m*100)))})]}),j.cle==="total"&&(s.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),j.cle===k[k.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const N=!d;l(N),N&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(ko,N?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},j.cle)),d&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${wn} ${Lt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((j,N)=>{const C=(j.s||0)/b*(Lt-4),T=(j.m||0)/b*(Lt-4),L=N*f+(f-w)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===j.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}),onKeyDown:O=>{O.key!=="Enter"&&O.key!==" "||(O.preventDefault(),i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}))},children:[t.jsx("title",{children:`${x(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:L-1,y:0,width:w+2,height:Lt,fill:"transparent"}),t.jsx("rect",{x:L,y:Lt-2-C,width:w,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:L,y:Lt-2-T,width:w,height:T,fill:"#0E7F3F"})]},j.d)}),t.jsx("line",{x1:0,y1:Lt-1.5,x2:wn,y2:Lt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Ai={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function tr({o:e,locked:a=!1}){const{t:r}=Z(),n=ka(e),o=Rt(e),i=Te(e),d=En(e),l=Ls(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Ai[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(dd,{o:e})]})}const Zt=e=>e.length>22?e.slice(0,21)+"…":e;function wa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function qi(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .fzone:has(.stage.folded), .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .fzone:has(.stage.folded), .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function ic({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const d=()=>{var f,w,v;const l=document.querySelector(".atl2.ops .desk-list"),s=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const h=l.getBoundingClientRect(),c=s?s.getBoundingClientRect().bottom:h.top;i({top:Math.round(c),left:Math.round(h.left),width:Math.round(h.width)});const x=[...l.querySelectorAll(":scope .grp")];let u=null;for(const m of x){const y=m.querySelector(".grp-h");y&&y.getBoundingClientRect().bottom<=c+2&&(u=m)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((f=b.querySelector(".ic"))==null?void 0:f.textContent)||"").trim(),t:(((w=b.querySelector(".t"))==null?void 0:w.textContent)||"").trim(),s:(((v=b.querySelector(".s"))==null?void 0:v.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function sc(e){const r=()=>{const n=qi(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Eo({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Z(),[i,d]=p.useState(!1);if(p.useEffect(()=>{n||d(!1)},[n]),Qe(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const s=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(s?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Zt(e.name))})]})}function ma(e,a){e({type:"focus",id:a.id}),window.setTimeout(()=>{var r;window.dispatchEvent(new CustomEvent("ppmap:card-tab",{detail:{tab:"memo"}})),(r=document.querySelector(".atl2 .readpane"))==null||r.scrollIntoView({block:"nearest"})},40)}function ar({o:e}){const{t:a,lang:r,caps:n,memoQueued:o,approachDone:i,doAnalyse:d,doDecide:l,doPromote:s,doRepeche:h,doApproach:c,dispatch:x,liveMemos:u}=Z(),b=w=>v=>{v.stopPropagation(),w()};if(n.lockActions){const w=b(()=>x({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:w,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Te(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:w,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Zt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:w,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:w,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:w,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:w,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:w,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:w,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:w,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:w=>{w.stopPropagation(),wa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Ua(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:w=>{w.stopPropagation(),wa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!n.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Eo,{o:e})});const f=Te(e);if(f===0)return t.jsx("span",{className:"cell",children:t.jsx(Eo,{o:e})});if(f===1){const w=u.liveOf(e.name);if(w&&(w.status==="boot"||w.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx($a,{item:w,serverOff:u.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=o.has(e.id);return t.jsx("span",{className:"cell cell-an",children:t.jsx(en,{lang:r,storeKey:e.name,className:"memobtn",disabled:v,confirmLabel:a.actAnalyse,onConfirm:()=>d(e),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(f===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ma(x,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(f===4){const w=i.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:w,onClick:b(()=>c(e)),children:w?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:b(()=>x({type:"modal",modal:"plug"})),children:a.actConn}),t.jsx("button",{type:"button",className:"lk sm dsrow",title:a.dsBtn,onClick:b(()=>x({type:"dossierOpen",id:e.id})),children:a.dsBtn})]})}return f===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ma(x,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):f===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>h(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ma(x,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>ma(x,e)),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function lc({o:e}){const{t:a,doThumb:r,thumbOf:n}=Z(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function dc({o:e}){const{lang:a}=Z();return He(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ft,{o:e}),t.jsx(tn,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Bt(e.engine||"")," ",ot(e.engine||"",a)]})})}function pc({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:l}){const{dispatch:s,caps:h,markRow:c,markedId:x,favIds:u,toggleFav:b,t:f}=Z(),w=Te(e),v=["#16233A","#475C6E","#8798A8","#B9C6D2"],m=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,y=m<=0?0:m<=7?1:m<=30?2:3,E=h.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][w]:v[y],k=u.has(e.id),j=N=>{if(a)return;if(d){d(e.id);return}if(h.pipe||e.kind==="op"){n();return}const C=N.currentTarget.getBoundingClientRect();s({type:"popup",id:e.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(h.pipe&&e.kind==="target"?" p"+w:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>c(e.id),onMouseLeave:()=>c(null),onClick:j,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx(Mi,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${f.cdEngagement} ${Math.round(e.engagement*10)/10} · ${f.cdEngagementHint}`,children:"🔥"}),He(e)&&t.jsx(Ft,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[h.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[nt(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(N=>N&&N!==e.name)||""]}),h.pipe&&!h.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:N=>N.stopPropagation(),children:[e.website&&t.jsx("a",{href:va(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":f.rowSite,title:f.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:va(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":f.rowLi,title:f.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":f.rowMail,title:f.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":f.rowTel,title:f.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:f.acqSee(e.acquirer),onClick:N=>{N.stopPropagation(),s({type:"acquirer",value:e.acquirer||""})},children:["← ",Zt(e.acquirer)]}),Ge(e)?t.jsx("span",{className:"rdec",title:f.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:f.zoomNewsMark,children:"📰"}):null]}),t.jsx(cc,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(dc,{o:e}),h.pipe&&t.jsx(tr,{o:e,locked:a}),h.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(ar,{o:e}),h.showThumbs&&t.jsx(lc,{o:e})]}),r&&!a&&!d&&t.jsx(fc,{o:e})]})}function cc({o:e}){const{lang:a,caps:r}=Z();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Vt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function uc({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Z(),d=(u,b=!1)=>f=>{f.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),s=Vt(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=Qe(e),x=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),s&&t.jsx("span",{className:"oc-amt",children:s}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):nt(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),wa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Zt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(aa,{spec:e.card})})]})}function mc({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Z();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=[e.tagline,e.headline,e.reasoning].find(h=>h&&h!==e.name)||"",l=Vt(e.amountEur,r),s=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return h?h[1].replace(/^www\./,"").slice(0,40):""})();return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[ot(e.engine||"",r),i?` · ${i}`:"",l?` · ${l}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(ar,{o:e})})]}),(e.sector||e.countryLabel||e.stage||e.acquirer)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null,e.acquirer?t.jsxs("span",{children:["← ",e.acquirer]}):null]}),(d||e.decryptHtml||e.url||e.card)&&t.jsxs("div",{className:"zoom-news",children:[d?t.jsx("p",{className:"zoom-lead",children:d}):null,e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):null,e.card?t.jsx("div",{className:"zoom-card",children:t.jsx(aa,{spec:e.card})}):null,e.url?t.jsxs("a",{className:"zoom-src",href:e.url,target:"_blank",rel:"nofollow noopener",children:[a.zoomSrc,s?` · ${s}`:""," ↗"]}):null]}),t.jsx(er,{o:e})]})}function Ti({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:l,dossiers:s}=Z(),h=p.useRef(null),c=Ge(e);if(p.useEffect(()=>{if(!c||!(e!=null&&e.decryptHtml))return;const g=h.current;if(!g)return;let A=!1;return yn(()=>import("./fit-DX-mzLKR.js"),[]).then(async S=>{await S.ensureEditoCss(),!(A||!g.isConnected)&&(S.beautifyEditoRows(g),S.mountCardFits(g))}),()=>{A=!0}},[c,e==null?void 0:e.decryptHtml]),!e&&!a){const g=s.find(Ge);if(g)return t.jsx(Ti,{o:g})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,f=(e==null?void 0:e.card)||(a==null?void 0:a.card),w=e?!!e.noCo:!x||Kt(x),v=(e==null?void 0:e.engine)||"",m=Ge(e),y=e?Vt(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const g=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return g?g[1].replace(/^www\./,"").slice(0,40):""})(),j=s.find(Ge),N=((j==null?void 0:j.url)||"").trim(),C=!!u&&!!N&&(u===N||u.endsWith(N)||N.endsWith(u)),T=(g,A=!1)=>S=>{S.stopPropagation(),A&&d({type:"continent",key:"monde"}),d({type:"filters",patch:g})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const L=()=>{x&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:x}}))},O=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},M=()=>{wa({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},V=e?Qe(e):!1,J=V&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",F=m?r.doEdito.replace(/^📖\s*/,""):v?ot(v,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[F,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!m&&(w||Ua({engine:v}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:g=>g.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:h,className:"ed-decrypt-b zoom-body"+(m?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:T({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:T({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:T({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),f&&t.jsx("div",{className:"zoom-card",children:t.jsx(aa,{spec:f})}),(u&&!C&&!m||j&&!m)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!C&&!m&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:g=>g.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!m&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:g=>{g.stopPropagation(),d({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[V?t.jsxs("span",{className:"verdict",style:{"--c":J?"var(--brand)":"var(--red)"},children:[J?"✓":"✗"," ",t.jsx("b",{children:J?r.kept:r.dropped})]}):!w&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:g=>{g.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Zt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!m&&(w||Ua({engine:v}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!w&&x?" ghost":""),onClick:g=>{g.stopPropagation(),M()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!w&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),O()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),L()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Zt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!w&&x&&l.pipe&&t.jsx(Zn,{name:x})]})]})}function fc({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=Z();return!o.pipe&&e.kind==="op"?t.jsx(uc,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(er,{o:e}),t.jsx(pd,{o:e}),t.jsx(ud,{o:e}),t.jsx(Zn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(tr,{o:e})})]}),e.card&&t.jsx(aa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Bt(e.engine||"")," ",ot(e.engine||"",r)]}),He(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ft,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function hc({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:l,lang:s}=Z();if(!d.pipe&&e.kind==="op"){const x=Vt(e.amountEur,s),u=(()=>{const f=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return f?f[1].slice(0,32):""})(),b=(f,w=!1)=>v=>{v.stopPropagation(),w&&i({type:"continent",key:"monde"}),i({type:"filters",patch:f})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(aa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Bt(e.engine||"")," ",ot(e.engine||"",s)]}),He(e)&&t.jsx(Ft,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:f=>f.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(ar,{o:e})})]})}const h=Te(e),c=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][h];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":c},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(tr,{o:e}),He(e)&&t.jsx(Ft,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&h===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>ma(i,e),children:[o.actMemoOf(e.memoType)," →"]})]})}function gc(){const{t:e}=Z(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function xc({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Z(),i=o==="en",d=c=>n.plabels[c]||"",l=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),s=l.includes(0)?0:l.sort((c,x)=>(e[x]||0)-(e[c]||0))[0];if(s===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[s]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:s===0?i?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:i?`${h} ${h>1?"files":"file"} in “${d(s)}”`:`${h} dossier${h>1?"s":""} dans « ${d(s)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:s}),children:[(i?"Open ":"Ouvrir ")+d(s)," →"]})]})}function bc(){var Dt,De,xt,at;const e=Z(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:l,markRow:s,lang:h,sessTally:c,data:x,dossiers:u,source:b,focusExtra:f,byId:w,token:v}=e,m=Yo(),y=p.useMemo(()=>{var ae,ce,_,G;if(!v||b==="ops")return null;const R=(((ae=m==null?void 0:m.ed)==null?void 0:ae.date)||(m==null?void 0:m.day)||"").slice(0,10),W=[(ce=m==null?void 0:m.ed)==null?void 0:ce.html,(_=m==null?void 0:m.ed)==null?void 0:_.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:h==="en"?"Today's brief":"Brief du jour",headline:h==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((G=m==null?void 0:m.ed)==null?void 0:G.date)||R,decryptHtml:W||void 0,date:R,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[v,b,h,(Dt=m==null?void 0:m.ed)==null?void 0:Dt.html,(De=m==null?void 0:m.ed)==null?void 0:De.acquirers_html,(xt=m==null?void 0:m.ed)==null?void 0:xt.date,m==null?void 0:m.day]),E=R=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Go,[k,j]=p.useState(new Set);p.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[N,C]=p.useState(null);p.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[T,L]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){L(!1);return}const R=document.getElementById("atl2-stage");if(!R){L(!1);return}const W=new IntersectionObserver(([ae])=>L(!!ae&&ae.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return W.observe(R),()=>W.disconnect()},[a.mapFolded]);const O=a.mapFolded||!T,M=R=>j(W=>{const ae=new Set(W);return ae.has(R)?ae.delete(R):ae.add(R),ae}),V=b==="ops"||o.pipe,[J,F]=p.useState("all"),[g,A]=p.useState(!1),[S,I]=p.useState(null),[U,Q]=p.useState(!1),ne=p.useRef(!0);p.useEffect(()=>{if(ne.current){ne.current=!1;return}F("all"),Q(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!U)return;const R=W=>{var ae,ce;(ce=(ae=W.target)==null?void 0:ae.closest)!=null&&ce.call(ae,".atl2 .doable")||Q(!1)};return document.addEventListener("click",R,!0),()=>document.removeEventListener("click",R,!0)},[U]);const z=p.useMemo(()=>{var W;const R=new Map;for(const ae of Kl(((W=m==null?void 0:m.ed)==null?void 0:W.html)||""))R.has(ae.t)||R.set(ae.t,ae.html);return R},[(at=m==null?void 0:m.ed)==null?void 0:at.html]),B=p.useCallback(R=>{if(R.decryptHtml)return R.decryptHtml;if(!z.size)return;const W=(R.name||"").trim().toLowerCase();if(W.length<3)return;const ae=z.get(W);if(ae)return ae;for(const[ce,_]of z)if(ce.includes(W)||W.includes(ce))return _},[z]),{diff:D}=ac(),[ee,$]=p.useState(!1),oe=a.filters.win==="1"&&!a.filters.day,[fe,be]=p.useState(!1),[ke,ue]=p.useState(!1),Se=p.useMemo(()=>{const R={...a,filters:{...a.filters,win:"all",day:""}};return u.filter(W=>!Ge(W)&&gt(W.date)===0&&_t(W,R,o.pipe)).length},[u,a,o.pipe]),Ae=p.useMemo(()=>new Set(((D==null?void 0:D.added)||[]).map(R=>R.trim().toLowerCase()).filter(Boolean)),[D]),me=p.useMemo(()=>{if(!Ae.size)return 0;const R={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(W=>!Ge(W)&&Ae.has((W.name||"").trim().toLowerCase())&&_t(W,R,o.pipe)).length},[u,Ae,a,o.pipe]);p.useEffect(()=>{const R=()=>{ue(!1),A(!1),be(!1),F("all"),Q(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",R),()=>window.removeEventListener("ppmap:tunnel",R)},[]),p.useEffect(()=>{ue(!1),A(!1),be(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const we=p.useMemo(()=>{const R=l.filter(ae=>!Ge(ae)&&nt(ae));let W="";for(const ae of R){const ce=(ae.date||"").slice(0,10);ce&&(!W||ce<W)&&(W=ce)}return{n:R.length,since:W?W.split("-").reverse().slice(0,2).join("/"):""}},[l]),Ee=we.n,te=p.useMemo(()=>{const W=ke&&Ae.size>0||a.filters.signalOnly||J!=="all"||g||fe?l:d;let ae=Yn(W,a.sort);return ae=ae.filter(ce=>!Ge(ce)),fe&&(ae=ae.filter(ce=>gt(ce.date)===0)),ke&&Ae.size&&(ae=ae.filter(ce=>Ae.has((ce.name||"").trim().toLowerCase()))),g||J==="explore"?ae=ae.filter(nt):J==="eval"?ae=ae.filter(ce=>!nt(ce)&&!ce.noCo&&(ce.kind==="op"||!Qe(ce))):o.pipe&&(ae=ae.filter(ce=>!nt(ce))),ae},[d,l,a.sort,J,ke,Ae,g,fe,o.pipe]),K=p.useMemo(()=>o.pipe?u.filter(R=>R.kind==="target"&&!Ge(R)&&He(R)&&(a.continent==="monde"||R.continent===a.continent)):te.filter(R=>He(R)&&!Qe(R)),[o.pipe,u,te,a.continent]).length,se=p.useMemo(()=>o.pipe?te:te.filter(R=>!Qe(R)&&!R.noCo&&!nt(R)),[te,o.pipe]),le=b==="ops"?te.filter(nt).length:0,he=fe?n.morningList:ke?n.sinceList:o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,H=a.filters,de=H.sector.length+H.market.length+H.country.length+H.engine.length+H.stage.length+H.crible.length+H.angle.length+H.memoLevel.length+H.dealKind.length+(H.signalOnly?1:0)+(H.acquirer.trim()?1:0)+(H.search.trim()?1:0),ye=[];if(H.day)ye.push({k:"day",lib:n.fDay(H.day.slice(8,10)+"/"+H.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(H.win&&H.win!=="all"){const R=["1","7","30"].indexOf(H.win);R>=0&&ye.push({k:"win",lib:n.dates[R],off:()=>r({type:"filters",patch:{win:"all"}})})}const je=R=>R.length<=2?R.join(", "):`${R.length} ${n.fSelected}`;for(const R of["sector","market","country","engine","crible"]){const W=H[R];W&&W.length&&ye.push({k:R,lib:je(W),off:()=>r({type:"clearFacet",facet:R})})}H.search&&ye.push({k:"search",lib:"🔍 "+H.search,off:()=>r({type:"filters",patch:{search:""}})}),ke&&Ae.size&&ye.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>ue(!1)}),H.signalOnly&&ye.push({k:"sig",lib:"🔴 "+n.sigDock(K||H.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const Ne=(R,W,ae="",ce=!1)=>t.jsxs("button",{type:"button","data-s":R,className:ae,"aria-sort":a.sort.key===R?a.sort.dir===1?"ascending":"descending":"none",style:ce?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:R}),children:[W,t.jsx("span",{className:"ar",children:a.sort.key===R&&a.sort.dir===1?"▴":"▾"})]},R),ve=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const R=new Map;te.forEach(ce=>{const _=ce.engine||"?";R.has(_)||R.set(_,[]),R.get(_).push(ce)});const W={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},ae=kn([...R.keys()],h);return[...R.entries()].sort((ce,_)=>{const G=W[ce[0]]??10+ae.indexOf(ce[0]),re=W[_[0]]??10+ae.indexOf(_[0]);return G-re})},[te,o.pipe,a.groupBy,h]),$e=ve?ve.filter(([R])=>Oa.has(R)).length:0,tt=(()=>{var W;return((W=(ve?ve.flatMap(([,ae])=>ae):te)[0])==null?void 0:W.id)??null})(),ct=p.useRef(!1),Re=p.useMemo(()=>u.find(Ge)||y,[u,y]),[Ve,yt]=p.useState(!1);p.useEffect(()=>{const R=()=>{ct.current=!0,ue(!1)};return window.addEventListener("ppmap:reveal",R),window.addEventListener("ppmap:focus",R),()=>{window.removeEventListener("ppmap:reveal",R),window.removeEventListener("ppmap:focus",R)}},[]),p.useEffect(()=>{const R=()=>{Re&&r({type:"focus",id:Re.id})};return window.addEventListener("ppmap:edito",R),()=>window.removeEventListener("ppmap:edito",R)},[Re,r]),p.useEffect(()=>{if(!a.focusId)return;I(a.focusId);const R=window.setTimeout(()=>I(null),900);return()=>window.clearTimeout(R)},[a.focusId]),p.useEffect(()=>{if(V&&!(a.focusId&&(te.some(R=>R.id===a.focusId)||u.some(R=>R.id===a.focusId)||a.focusId===(Re==null?void 0:Re.id)))&&!f){if(Re){r({type:"focus",id:Re.id});return}tt&&r({type:"focus",id:tt})}},[V,a.focusId,te,tt,f,r,u,b,Re]),p.useEffect(()=>{if(!V||!a.focusId||Re&&a.focusId===Re.id||te.some(W=>W.id===a.focusId))return;const R=u.find(W=>W.id===a.focusId);if(R){if(ct.current){R.kind==="op"?F(nt(R)?"explore":"eval"):J!=="all"&&F("all");return}J!=="all"&&tt&&r({type:"focus",id:tt})}},[V,a.focusId,J,te,u,tt,r,Re]),p.useEffect(()=>{if(!V||!a.focusId||!ct.current)return;const R=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!R){const _=te.findIndex(G=>G.id===a.focusId);if(_>=0){const G=ve?"":"pt"+a.ptab;if(G){const re=a.shown[G]||E();_>=re&&r({type:"more",group:G,by:_-re+8})}}return}ct.current=!1;const W=qi(),ae=R.getBoundingClientRect();ae.top>=W-2&&ae.bottom<=window.innerHeight-4||sc(R)},[V,a.focusId,a.ptab,te,a.shown,ve,r]),p.useEffect(()=>{if(typeof window>"u")return;const R=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),W=document.querySelector(".atl2.ops, .atl2.cibles");if(!R||!W)return;const ae=document.querySelector(".atl2 .fzone"),ce=()=>{W.style.setProperty("--listhead-h",`${R.offsetHeight}px`);const G=!!(ae&&ae.querySelector(".stage.folded"));W.style.setProperty("--fold-h",G&&ae?`${ae.offsetHeight}px`:"0px")};ce();const _=new ResizeObserver(ce);return _.observe(R),ae&&_.observe(ae),()=>_.disconnect()},[O,a.dens,a.mapFolded]);const Ue=p.useMemo(()=>{if(!V||!a.focusId)return null;if(y&&a.focusId===y.id)return y;const R=te.find(ae=>ae.id===a.focusId)||u.find(ae=>ae.id===a.focusId)||null;if(!R)return null;const W=B(R);return W&&W!==R.decryptHtml?{...R,decryptHtml:W}:R},[V,a.focusId,te,u,B,y]),it=o.lockRowsAfter;let Ot=0;const kt=(R,W)=>{let ae=a.shown[W]||E();return R.length-ae<=4&&(ae=R.length),R.slice(0,ae).map(G=>{const re=it!==null&&Ot>=it;Ot++;const ge=B(G),pe=ge&&ge!==G.decryptHtml?{...G,decryptHtml:ge}:G,Oe=!V&&a.dens!=="maxi"&&(a.dens==="deplie"||(N?N==="open":!!ge)),Ce=k.has(G.id)?!Oe:Oe,Fe=V?Ke=>{ct.current=!0,r({type:"focus",id:Ke});const We=w.get(Ke);We&&(nt(We)?wa(We):We.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:We.name,url:We.url||"",website:We.website||"",domain:We.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(hc,{o:pe,locked:re,selected:V&&a.focusId===G.id,onSelect:Fe},G.id):t.jsx(pc,{o:pe,locked:re,open:Ce,onToggle:()=>M(G.id),selected:V&&a.focusId===G.id,echo:S===G.id,fresh:Ae.has((G.name||"").trim().toLowerCase()),onSelect:Fe},G.id)})},Mt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(te.length?"":" list-empty"),Ct=t.jsxs(t.Fragment,{children:[ve?ve.map(([R,W])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Bt(R)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:R==="ma"?n.grpMa:R==="fundraising"?n.grpLev:Oa.has(R)&&$e<=1?n.grpNews:R==="nominations"?n.grpNom:R==="media"?n.grpNewsOther:R==="recrutements"?n.grpHire:Oa.has(R)?n.grpNews+" · "+ot(R,h):ot(R,h)}),t.jsx("div",{className:"s",children:n.grpCount(W.filter(ae=>!Qe(ae)).length,W.length)})]})]}),kt(W,R)]},R)):kt(te,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(gc,{}),o.pipe&&a.ptab===0&&!g&&!ke&&!fe&&J==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(xp,{}),!te.length&&!(x.loading&&!u.length)&&(o.pipe&&J==="all"?t.jsx(xc,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(H.win!=="all"||!!H.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),de>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(de)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),At=t.jsxs(t.Fragment,{children:[!g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+fa[a.ptab]+")"},children:te.length})," ",he]}),g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+fa[a.ptab]+")"},children:te.length})," ",n.newsWord]}),t.jsx("span",{className:"dot",children:"·"}),O&&!a.mapFolded&&t.jsx(wi,{variant:"compact",mapToggle:!1}),t.jsxs("span",{className:"ctx",children:[O?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ye.map(R=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:W=>{W.stopPropagation(),R.off()},children:[R.lib,t.jsx("i",{children:"×"})]},R.k)),b==="ops"&&te.length>0&&!O&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",te.length-le," ",n.zoomPulseEval,le>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",le," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),Et=t.jsxs("div",{className:"listhead"+(O?" mapoff":""),children:[O&&t.jsx("div",{className:"lh-tools",children:t.jsx(vi,{compact:!0})}),o.showFunnel&&ee&&oe&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(fd,{}),t.jsx(oc,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:At}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(nc,{}),t.jsx(rc,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(fe?" on":""),"aria-pressed":fe,title:n.morningDockTitle,onClick:()=>{if(fe){be(!1),$(!1);return}ue(!1),A(!1),F("all"),be(!0),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}}),$(!1)},children:["📊 ",n.morningDock(Se)]}),D&&!D.firstVisit&&(D.added.length>0||D.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(ke?" on":""),"aria-pressed":ke,title:n.sinceSub,onClick:()=>{const R=!ke;ue(R),A(!1),be(!1),$(!1),F("all"),R&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(me),D!=null&&D.lastDate?` · ${n.sinceSince(D.lastDate)}`:""]}),K>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{ue(!1),A(!1),be(!1),$(!1),F("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(K)]}),o.pipe&&Ee>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(g?" on":""),"aria-pressed":g,title:n.newsDockHint,onClick:()=>{const R=!g;A(R),ue(!1),be(!1),$(!1),F("all"),R&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(Ee),we.since?` · ${n.newsSince(we.since)}`:""]})]}),!o.showFunnel&&At,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([R,W])=>t.jsxs("button",{type:"button","data-d":R,"aria-pressed":a.dens===R||R==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:R}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:W})]},R))}),!V&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":N==="open",onClick:()=>{C("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":N==="closed",onClick:()=>{C("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var ge;const R={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},W=u.filter(pe=>_t(pe,R,o.pipe)&&!Ge(pe)),ae=W.filter(pe=>!nt(pe)&&!pe.noCo&&(pe.kind==="op"||!Qe(pe))).length,ce=W.filter(nt).length,_=o.pipe?W.filter(pe=>pe.kind!=="op"&&Te(pe)===1).length:0,G=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${_?` ${_}`:""}`]]:[],["eval",`${n.doEval}${ae?` ${ae}`:""}`],["explore",`${n.doExplore}${ce?` ${ce}`:""}`]],re=((ge=G.find(([pe])=>pe===J))==null?void 0:ge[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":U,onClick:()=>Q(pe=>!pe),children:[re,t.jsx("i",{children:"▾"})]}),U&&t.jsx("div",{className:"dolist",children:G.map(([pe,Oe])=>t.jsx("button",{type:"button","aria-pressed":J===pe,onClick:()=>{if(Q(!1),pe==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}F(pe),pe!=="all"&&(ue(!1),A(!1),$(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:Oe},pe))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:R=>r({type:"sort",key:R.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([R,W])=>t.jsx("option",{value:R,children:W},R))})]}),o.showChain&&t.jsxs("span",{className:"chainwrap"+(se.length===0?" empty":""),children:[t.jsxs("button",{type:"button",className:"chain",disabled:se.length===0,title:n.chainHint,onClick:()=>{se.length&&r({type:"chainStart",queue:se.map(R=>R.id)})},children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(se.length):n.chainAll(se.length)]}),!o.pipe&&t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!V&&Et,a.dens!=="maxi"&&!V&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Ne("country",n.colCountry),Ne("name",n.colCompany),Ne("amount",n.colAmount,"h-amt",!0),Ne("stage",n.colStage,"h-stade"),Ne("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Ne("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Ne("memo",n.colMemo)]}),o.pipe&&Ne("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),V?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[Et,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Ne("country",n.colCountry),Ne("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Ne("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Ne("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:Mt,children:Ct})]}),t.jsxs("aside",{className:"readpane"+((Ue?Ge(Ue):!f&&Re)?" is-edito":""),"aria-label":h==="fr"?"Dossier":"File",children:[Re&&(()=>{const R=a.focusId===Re.id&&!Ve,W=(Re.headline||Re.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":R,onClick:()=>{if(R){yt(!0);return}yt(!1),r({type:"focus",id:Re.id})},children:[t.jsx("span",{className:"eg-t",children:h==="en"?"Today’s editorial":"Édito du jour"}),W&&t.jsx("span",{className:"eg-sub",children:W}),t.jsx("span",{className:"eg-chev",children:R?h==="en"?"Collapse ▴":"Replier ▴":h==="en"?"Read ▾":"Lire ▾"})]})})(),!!(Re&&(Ue?Ge(Ue):!f))&&Ve?null:y&&a.focusId===y.id?t.jsx("div",{className:"zoom",children:t.jsx(td,{})}):Ue&&o.pipe?t.jsx(mc,{o:Ue}):t.jsx(Ti,{o:Ue,extra:Ue?null:f})]})]}):t.jsx("div",{className:Mt,children:Ct}),(()=>{const R=ve||[["pt"+a.ptab,te]];let W=0,ae=0;for(const[_,G]of R){ae+=G.length;let re=a.shown[_]||E();G.length-re<=4&&(re=G.length),W+=Math.min(G.length,re)}const ce=ae-W;return ce<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>R.forEach(([_,G])=>r({type:"more",group:_,by:G.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(ce,ce)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(W,ae)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}}),V&&b==="ops"&&a.dens!=="maxi"&&t.jsx(ic,{on:!!ve,rev:(ve||[]).map(([R,W])=>R+W.length).join("|")})]})}function jo(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function vc(e,a){const r=Fs(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function wc(e,a){const n=[a.head.split("|").map(jo).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",vc(o,a.plabels),ka(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(jo).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function yc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const kc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ze({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function ia({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function Ec({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=Z(),d=(e.cribleStatus||"").trim().toUpperCase()||(ka(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Rt(e),s=(a==null?void 0:a.blocs)||{},h=[[n.qaVP,s.value_prop],[n.qaProduct,s.produit],[n.qaModel,s.modele],[n.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Ze,{k:n.cdSector,v:e.sector}),t.jsx(Ze,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(Ze,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(Ze,{k:n.cdStage,v:e.stage}),t.jsx(Ze,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ze,{k:n.cdSite,v:e.domain||e.website}),t.jsx(Ze,{k:n.cdName,v:e.contactName}),t.jsx(Ze,{k:n.cdEmail,v:e.contactEmail}),t.jsx(Ze,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Ze,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Ze,{k:n.cdAngle,v:e.angle}),t.jsx(Ze,{k:n.cdDetected,v:kc(e.date,o)})]}),!!(e.provQuery||e.provUrl||_a(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(Ze,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(Ze,{k:n.cdSrc,v:$n(e.provUrl||""),href:va(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(Ze,{k:n.cdAngleSrc,v:_a(e)})]})]}),h.some(([,c])=>c)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),h.filter(([,c])=>c).map(([c,x])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:c}),t.jsx("p",{children:x})]},c))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([c,x,u])=>t.jsxs("div",{className:"dssq "+c,children:[t.jsx("b",{children:x}),t.jsx("ul",{children:u.map(b=>t.jsx("li",{children:b},b))})]},c))})]}),t.jsx(ia,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(ia,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(ia,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(ia,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(ia,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function jc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d,st:l}=Z(),[s,h]=p.useState({}),[c,x]=p.useState({}),u=25,b=12,f=p.useMemo(()=>{if(l.dossierId){const m=n.find(y=>y.id===l.dossierId)||i.dossiers.find(y=>y.id===l.dossierId);return m?[m]:n.slice(0,u)}return n.slice(0,u)},[n,l.dossierId,i.dossiers]);p.useEffect(()=>{f.length&&Ro(r,f.map(m=>m.name)).then(h)},[r,f]),p.useEffect(()=>{const m=f.filter(k=>!!k.memoUrl).slice(0,b);if(!m.length){x({});return}let y=!1;const E={};return(async()=>{for(const k of m){if(y)return;try{const j=await Ci(k.memoUrl||"");if(y)return;j&&Up(j.comite)&&(E[k.id]=j.comite,x({...E}))}catch{}}})(),()=>{y=!0}},[f]);const w=i.stats,v=m=>m.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(f.length)}),!l.dossierId&&n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),w&&typeof w.screened=="number"&&t.jsxs("p",{children:[v(w.screened)," ",e.funScreened(""),typeof w.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",v(w.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(v(i.marketEstimate)),", ",Math.round(w.screened/i.marketEstimate*100)," %"]})]})]}),f.map(m=>t.jsx(Ec,{o:m,qa:s[m.name],comite:c[m.id]},m.id)),!f.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Nc=50;function nr({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Z(),[i,d]=p.useState(null),[l,s]=p.useState(!1),[h,c]=p.useState(""),[x,u]=p.useState(0),[b,f]=p.useState(""),[w,v]=p.useState(!1),[m,y]=p.useState(0),E=p.useRef(null),k=p.useRef(null),j=()=>{y(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>y(L=>L+1),1e3)},N=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};p.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),k.current&&window.clearInterval(k.current)},[]);const C=async L=>{s(!0),c(""),j();const O=await a();if(s(!1),N(),O.ok){d(O);return}if(O.busy){c(o.alertPreviewBusy);return}if(!L){c(o.alertPreviewFail);return}u(Nc),N(),E.current=window.setInterval(()=>{u(M=>M>1?M-1:(E.current&&window.clearInterval(E.current),C(!1),0))},1e3)},T=async()=>{if(n||w||l)return;v(!0),f(""),j();const L=await r();v(!1),N(),f(L.ok?o.alertTestOk(L.sentTo||""):L.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||w||x>0,onClick:()=>{C(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||w||l,onClick:()=>{T()},children:w?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(m)]}),w&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(m)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),h&&t.jsx("p",{className:"mnote warn",children:h}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const zt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function et({title:e,icon:a,children:r,wide:n,kind:o,lead:i}){const{dispatch:d}=Z(),l=o==="plug"?"min(720px,100%)":"min(760px,100%)";return ea.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:s=>{s.target===s.currentTarget&&d({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard"+(o?" m-"+o:""),style:n?{width:l}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsxs("div",{className:"mh-txt",children:[t.jsx("h2",{children:e}),i&&t.jsx("p",{className:"mh-lead",children:i})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>d({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Sc(){const{st:e}=Z();switch(e.modal){case"chain":return t.jsx(Cc,{});case"space":return t.jsx(Ac,{});case"alert":return t.jsx(qc,{});case"queue":return t.jsx(Oc,{});case"export":return t.jsx(Mc,{});case"plug":return t.jsx(Pc,{});case"approach":return t.jsx(_c,{});case"recharge":return t.jsx(Uc,{});case"cover":return t.jsx(Vc,{});case"dossier":return t.jsx(Hc,{});case"crit":return t.jsx(Qc,{});case"tuto":return t.jsx(Kc,{});case"rdv":return t.jsx(zc,{});case"memoalert":return t.jsx(Dc,{});default:return null}}function zc(){const{dispatch:e,fund:a,t:r}=Z(),n=a||r.rdvCoFallback;return ea.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Io,children:Do}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Ba}`,children:Ba})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(ll,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function Cc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:l,caps:s,memoQueued:h,doAnalyse:c}=Z(),x=i==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,f=u[b],w=b>=u.length;return ea.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:w?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(w?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:w||!f?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:f.name}),t.jsx("div",{className:"sub",children:[ta(f.cc,o)||f.countryLabel,f.sector,f.stage,n.daysAgo(gt(f.date))].filter(Boolean).map(v=>String(v)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:ot(f.engine,o)}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{children:Vt(f.amountEur,o)})]}),He(f)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ft,{o:f,lg:!0})," ",t.jsx(tn,{o:f,src:!0})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),f.reasoning&&!(x&&Qe(f))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),x&&Qe(f)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Pt(f)==="retenu"?"var(--brand)":Pt(f)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Pt(f)==="retenu"?"✓ "+n.kept:Pt(f)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:f.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!w&&f&&s.pipe&&Te(f)===1&&!h.has(f.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(f),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!w&&f&&!(x&&Qe(f))&&(f.noCo&&f.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{d(f)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(w?{type:"modal",modal:null}:{type:"chainNext"}),children:w?n.closeBtn:n.skip})]})]})})}),document.body)}function Ac(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Z(),i=o==="client",d=p.useMemo(()=>i?r.filter(x=>Qe(x)):[],[r,i]),l=p.useMemo(()=>Yn(d.filter(x=>Pt(x)==="retenu"),{key:"signal",dir:-1}),[d]),s=p.useMemo(()=>d.filter(x=>Pt(x)==="ecarte"),[d]),h=e.spaceTab==="retenu"?l:s,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(et,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:s.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function qc(){const{mode:e}=Z();return e==="client"||e==="apercu"?t.jsx(Tc,{}):t.jsx(Rc,{})}function Tc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Z(),[i,d]=p.useState("d"),l=o!=="client";return t.jsxs(et,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Lc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(Fc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(Li,{})]})}function Lc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[l,s]=p.useState(!1),[h,c]=p.useState(0);p.useEffect(()=>{let T=!0;return s(!1),kr(a).then(L=>{T&&(L?d(L):s(!0))}),()=>{T=!1}},[a,h]);const x=p.useRef({}),[u,b]=p.useState({}),[f,w]=p.useState(!1),[v,m]=p.useState(!1),y=p.useRef(null);p.useEffect(()=>()=>{y.current&&window.clearTimeout(y.current)},[]);const E=T=>{const L=x.current;Object.keys(L).length&&(w(!0),kr(a,L).then(O=>{if(!O){w(!1),o(e.actErr);return}if(O.throttled&&T<3){y.current=window.setTimeout(()=>E(T+1),5400);return}if(x.current={},b({}),d(O),w(!1),O.throttled){o(e.alertThrottled);return}m(!0),window.setTimeout(()=>m(!1),2e3),n(e.alertSaved)}))},k=T=>{r||(x.current={...x.current,...T},b(L=>({...L,...T})),y.current&&window.clearTimeout(y.current),y.current=window.setTimeout(()=>E(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(T=>T+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...u},N=T=>!j.sections||j.sections.includes(T),C=T=>{const L=j.sections||e.alertSec.map(([O])=>O);k({sections:N(T)?L.filter(O=>O!==T):[...L,T]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,f&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!f&&v&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([T,L])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:N(T),disabled:r,onChange:()=>C(T)}),t.jsxs("span",{children:[L,T==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},T))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(nr,{label:e.alertPreview,readOnly:r,onPreview:()=>Ws(a),onTest:()=>Vs(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Fc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[l,s]=p.useState(!1),[h,c]=p.useState(0);p.useEffect(()=>{let f=!0;return s(!1),Er(a).then(w=>{f&&(w?d(w):s(!0))}),()=>{f=!1}},[a,h]);const x=f=>{r||Er(a,f).then(w=>{if(!w){o(e.actErr);return}d(w),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:f=>x({dow:Number(f.target.value)}),children:e.alertDow.map((f,w)=>t.jsx("option",{value:w,children:f},f))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(nr,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Ys(a),onTest:()=>Gs(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Li(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Z(),[d,l]=p.useState(i||""),[s,h]=p.useState(!1),[c,x]=p.useState(!1);p.useEffect(()=>{i&&l(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(m=>He(m)).length,[n]),f=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,w=async()=>{if(!(!/.+@.+\..+/.test(d)||c)){x(!0);try{await fetch(`${ya}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{x(!1)}}},v=[[a.amRows.continent,o],[a.amRows.since,a.amSince[f]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(m=>ot(m,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(m=>ta(m,r)||m).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return s?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([m,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:m}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},m))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:m=>l(m.target.value),onKeyDown:m=>{m.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Rc(){const{t:e}=Z();return t.jsx(et,{title:e.alertTitle,icon:"🔔",children:t.jsx(Li,{})})}function Oc(){var g,A;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:l,dispatch:s,liveMemos:h,data:c,flash:x}=Z(),[u,b]=p.useState(()=>rn(r)),[f,w]=p.useState(()=>!rn(r)),[v,m]=p.useState([]),[y,E]=p.useState(0),[k,j]=p.useState(!1),N=n==="client",C=p.useMemo(()=>{const S=new Map;return o.forEach(I=>{const U=(I.name||"").trim().toLowerCase();U&&!S.has(U)&&S.set(U,I)}),S},[o]);p.useEffect(()=>{let S=!0;return(!rn(r)||y>0)&&w(!0),(async()=>{const[I,U]=await Promise.all([Wn(r,y>0),Po(a)]);S&&(I&&b(I),w(!1),m(U))})(),()=>{S=!1}},[a,r,y]);const T=f&&!u,L=(u==null?void 0:u.per_day)??0,O=((g=u==null?void 0:u.analyzed_today)==null?void 0:g.length)??0,M=u==null?void 0:u.offre,V=(u==null?void 0:u.pool_meta)||[],J=p.useMemo(()=>{const S=new Map;for(const I of(u==null?void 0:u.scheduled)||[])for(const U of I.names||[])S.has(U)||S.set(U,{label:I.day_label,date:I.date});return S},[u==null?void 0:u.scheduled]),F=(u==null?void 0:u.in_progress)||[];return t.jsxs(et,{title:e.queueTitle,wide:!0,children:[M&&t.jsxs("div",{className:"qoffre"+(M.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:M.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:M.delai})]}),t.jsx("span",{className:"osp"}),M.rythme>0?t.jsx("span",{className:"or",children:e.qRate(M.rythme)}):M.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(M.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:T?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(O,O+(((A=u==null?void 0:u.pool_order)==null?void 0:A.length)??0))}})}),M&&t.jsxs("div",{className:"qeta",children:[M.file===0?e.qEtaDone:M.rythme<=0?e.qEtaPaused:e.qEta(M.file,M.rythme,M.jours_restants),M.en_retard&&t.jsxs("em",{children:[" ",e.qLate(M.delai,M.plafond)]})]}),!T&&t.jsxs("div",{className:"qrate",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate})," — ",t.jsx("b",{children:e.covRateNow(L)}),(M==null?void 0:M.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]}),N&&t.jsx("div",{className:"covrb",role:"group","aria-label":e.covRate,children:[0,1,2,3,5,10].map(S=>t.jsx("button",{type:"button",className:L===S?"on":"",disabled:k,title:S===0?e.identPauseTitle:e.covRateNow(S),onClick:()=>{k||!a||(j(!0),_o(a,S).then(I=>{j(!1),I!==null&&(b(U=>U&&{...U,per_day:I}),x(e.alertSaved))}))},children:S===0?"⏸":S},S))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint}),!!c.credits&&!c.credits.unlimited&&!!(c.credits.packs||[]).length&&t.jsxs("div",{className:"qpacks-mini",children:[t.jsxs("span",{children:[e.creditsCap," ",c.credits.total_available,"/",c.credits.daily_grant+c.credits.purchased," · ",e.creditsPacksLbl]}),t.jsx("div",{children:c.credits.packs.map(S=>t.jsxs("button",{type:"button",className:"qpack-mini",onClick:()=>{const I=c.email;if(!I)return;const U=window.location.href.split("?")[0];fetch(`${ya}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:I,lookup_key:S.lookup_key,success_url:U+"?credits=ok",cancel_url:U+"?credits=cancel"})}).then(Q=>Q.json()).then(Q=>{Q.url&&(window.location.href=Q.url)}).catch(()=>{})},children:[S.credits," · ",S.price_eur," €"]},S.lookup_key))})]})]})]}),(F.length>0||h.items.some(S=>S.status==="boot"||S.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[h.items.filter(S=>S.status==="boot"||S.status==="running"||S.status==="error").map(S=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:S.name}),t.jsx("span",{className:"qd",children:S.memoType||""}),t.jsx($a,{item:S,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+S.name)),F.filter(S=>!h.liveOf(S.name)).map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.name}),t.jsxs("span",{className:"qd",children:[S.memo_type||"",S.age_min?` · ${Math.round(S.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:S.state||""})]},"ip-"+S.name))]})]}),v.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:v.map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.company}),t.jsxs("span",{className:"qd",children:[S.memo_type,typeof S.est_min=="number"?` · ~${S.est_min} min`:""]}),t.jsx("span",{className:"qt",children:S.status}),S.url&&t.jsx("a",{className:"qgo",href:S.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(S.memo_type)}),N&&S.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{wr(a,S.company,"retry").then(()=>E(I=>I+1))},children:e.queueRetry}),N&&S.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{wr(a,S.company,"delete").then(()=>E(I=>I+1))},children:e.queueDelete})]},S.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",T?e.qUpNextWait:e.qUpNext(V.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[T&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!T&&V.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),V.map((S,I)=>{const U=J.get(S.name),Q=C.get((S.name||"").trim().toLowerCase()),ne=h.liveOf(S.name),z=!!(Q&&d.has(Q.id))||!!(ne&&(ne.status==="boot"||ne.status==="running")),B=!!(Q&&Te(Q)===1&&!Q.memoUrl)&&!ne;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",I+1]}),U?t.jsx("span",{className:"qwhen"+(U.label==="demain"?" soon":""),children:U.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:S.name}),S.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof S.score=="number"&&t.jsx("span",{className:"qs2",children:S.score}),ne&&(ne.status==="boot"||ne.status==="running")&&t.jsx($a,{item:ne,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),B&&(l.lockActions||!N?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>s({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:z,onClick:()=>{i(Q),E(D=>D+1)},children:z?e.actAnalyseQueued:e.actAnalyse})),S.excerpt&&t.jsx("span",{className:"qex",children:S.excerpt})]},S.name+":"+I)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([S,I])=>t.jsxs("li",{children:[t.jsx("b",{children:S})," — ",I]},S))})]})}function Mc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=Z(),l=`${zt}/cibles/list.csv?token=${a}`,s=`${zt}/cibles/list.json?token=${a}`,h=`${zt}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${l}")`,x=v=>{var m;(m=navigator.clipboard)==null||m.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:c},{def:e.exportLive,value:s,href:s},{def:e.exportXlsx,value:h,href:h}],b=!o.lockActions&&n.length>0,f=()=>{yc(wc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:v=>(e.stg.find(([m])=>m===v)||["",""])[1]})),r(e.exportViewDone(n.length))},w=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(et,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:w,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:f,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:m,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(m),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Dc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Z(),i=o!=="client",[d,l]=p.useState(null),[s,h]=p.useState(!1),[c,x]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let m=!0;return h(!1),br(a).then(y=>{m&&(y?l(y):h(!0))}),()=>{m=!1}},[a,c]);const f=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},w=m=>{if(i||!d)return;const y={enabled:m.enabled??!!d.enabled,email:m.email??(d.email||""),sections:m.sections??f()};b(!0),br(a,y).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}l(E),r(e.memoAlertSaved)})};if(s)return t.jsx(et,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(m=>m+1),children:e.retry})]})});if(!d)return t.jsx(et,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=f();return t.jsxs(et,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||u,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(Ic,{value:d.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:m=>w({email:m})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([m,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[m],disabled:i||u,onChange:()=>w({sections:{...v,[m]:!v[m]}})}),t.jsx("span",{children:y})]},m))}),t.jsx(nr,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Os(a,v),onTest:()=>Rs(a,v)})]})}function Ic({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=p.useState(e);p.useEffect(()=>{d(e)},[e]);const l=i.trim()!==e.trim(),s=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:h=>d(h.target.value),onKeyDown:h=>{h.key==="Enter"&&l&&s&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!s,onClick:()=>o(i.trim()),children:n})]})]})}function Pc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Z(),[i,d]=p.useState(null),[l,s]=p.useState(!1),[h,c]=p.useState(null),[x,u]=p.useState(!1),[b,f]=p.useState(""),[w,v]=p.useState(0),[m,y]=p.useState("webhook"),[E,k]=p.useState("webhook"),[j,N]=p.useState(""),C=p.useRef(!1);p.useEffect(()=>{let S=!0;return s(!1),vr(a).then(I=>{S&&(I?d({configured:I.configured,url_hint:I.url_hint}):s(!0))}),Ps(a).then(I=>{if(S){if(!I){u(!0);return}u(!1),c(I),C.current||(C.current=!0,I.destination==="instantly"&&(y(U=>U==="webhook"?"instantly":U),k(U=>U==="webhook"?"instantly":U)),I.campaign_id&&N(U=>U||I.campaign_id||""))}}),()=>{S=!1}},[a,w]);const T=(S,I)=>{o&&vr(a,S).then(U=>{if(!U||U.ok===!1){n(e.actErr);return}S.test&&U.sent===!1?n(e.plugTestThrottled):r(I),v(Q=>Q+1)})},L='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',O=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),M=`curl -X POST ${zt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,V=`curl -X POST ${zt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`,J=[{k:"webhook",t:e.plugDestCrm,s:e.plugDestCrmS},{k:"instantly",t:e.plugDestInst,s:e.plugDestInstS},{k:"script",t:e.plugDestScript,s:e.plugDestScriptS}],F=E==="instantly"?e.plugStep2Inst:E==="script"?e.plugStep2Script:e.plugStep2Wh,g=E==="instantly"?e.plugAideInst:E==="script"?e.plugAideScript:e.plugAideWh,A=S=>{k(S),S!=="script"&&y(S)};return t.jsxs(et,{title:e.plugTitle,icon:"🔌",wide:!0,kind:"plug",lead:e.plugLead,children:[h&&t.jsxs("div",{className:"plugetat"+(h.enabled?" on":""),children:[t.jsx("i",{}),t.jsx("b",{children:h.enabled?e.plugEtatOn:e.plugEtatOff})]}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>v(S=>S+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"1"}),t.jsx("h4",{children:e.plugStep1})]}),t.jsx("div",{className:"plugdests",children:J.map(S=>{const I=E===S.k;return t.jsxs("button",{type:"button",className:"plugdest"+(I?" on":""),onClick:()=>A(S.k),children:[t.jsx("span",{className:"pradio","aria-hidden":"true"}),t.jsx("b",{children:S.t}),t.jsx("em",{children:S.s})]},S.k)})}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"2"}),t.jsx("h4",{children:F})]}),E==="script"?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:M}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(M).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}):E==="instantly"?t.jsx("div",{className:"mfield pill",children:t.jsx("input",{type:"text",maxLength:80,placeholder:e.plugCampPh,value:j,disabled:!o,onChange:S=>N(S.target.value)})}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"mfield pill",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:S=>f(S.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>T({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>T({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>T({remove:!0},e.plugRemoved),children:e.plugRemove})]})]}),t.jsx("p",{className:"mnote dim",children:g}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"3"}),t.jsx("h4",{children:e.plugStep3})]}),t.jsx(Bc,{auto:h,autoKo:x,destKind:m,camp:j,onRetry:()=>v(S=>S+1),onDone:S=>{c(S),u(!1)}}),t.jsx("p",{className:"mnote dim",children:e.plugHow3}),t.jsxs("details",{className:"plugex plugpay",children:[t.jsxs("summary",{children:[t.jsx("b",{children:e.plugExT}),t.jsx("span",{children:e.plugPayloadSub})]}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:O}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(O).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult}),t.jsx("p",{className:"mnote dim",children:e.plugVars})]}),t.jsx("div",{"data-tour":"plug-bulk",children:t.jsx($c,{destKind:m,setDestKind:S=>{y(S),k(S)},camp:j,setCamp:N,whHint:i!=null&&i.configured?i.url_hint||"webhook":null})}),E!=="script"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:M}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(M).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm","data-tour":"plug-crm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:V}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(V).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function _c(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:l}=Z(),s=p.useMemo(()=>r.find(g=>g.id===n.approachId)||null,[r,n.approachId]),[h,c]=p.useState("email"),[x,u]=p.useState(0),[b,f]=p.useState({}),[w,v]=p.useState(!1),[m,y]=p.useState(""),[E,k]=p.useState({});if(p.useEffect(()=>{!s||b[h]||w||(v(!0),y(""),Is(a,s.name,h).then(g=>{if(v(!1),!g||g.ok===!1){y((g==null?void 0:g.error)||e.apprFail);return}f(A=>({...A,[h]:g}))}))},[s,h,a]),!s)return null;const j=b[h],N=(j==null?void 0:j.sequence)||[],C=N[x],T=g=>`${h}|${x}|${g}`,L=g=>{const A=T(g);return A in E?E[A]:String(((C==null?void 0:C[g])??"")||"")},O=(g,A)=>k(S=>({...S,[T(g)]:A})),M=T("subject")in E||T("body")in E||T("message")in E,V=L(h==="email"?"body":"message"),J=L("subject"),F=h==="email"&&J?`${J}

${V}`:V;return t.jsxs(et,{title:e.apprT(s.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(g=>t.jsx("button",{type:"button",className:"apch"+(h===g?" on":""),"aria-pressed":h===g,onClick:()=>{c(g),u(0)},children:g==="email"?e.apprChEmail:e.apprChLi},g)),t.jsx("span",{className:"sp"}),N.map((g,A)=>t.jsxs("button",{type:"button",className:"apday"+(x===A?" on":""),"aria-pressed":x===A,onClick:()=>u(A),children:[g.day||`J${A}`,[`${h}|${A}|subject`,`${h}|${A}|body`,`${h}|${A}|message`].some(S=>S in E)&&t.jsx("i",{children:"✎"})]},g.day||A))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,j!=null&&j.sender?" · "+e.apprSender(j.sender):""]}),w&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!m&&!w&&t.jsxs("p",{className:"mnote warn",children:[m," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{f(g=>{const A={...g};return delete A[h],A}),y("")},children:e.retry})]}),!w&&!m&&!C&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),C&&t.jsxs(t.Fragment,{children:[h==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:J,onChange:g=>O("subject",g.target.value)})]}),h==="linkedin"&&x===0&&(j==null?void 0:j.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:V,onChange:g=>O(h==="email"?"body":"message",g.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var g;(g=navigator.clipboard)==null||g.writeText(F).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),h==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(s.contactEmail||"")}?subject=${encodeURIComponent(J)}&body=${encodeURIComponent(V)}`,children:e.apprMailto}),M&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Bc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:l,flash:s,flashErr:h,canWrite:c}=Z(),[x,u]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,f=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),w=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,v=()=>{if(x||!c||f)return;u(!0),(b?yr(l,!1):yr(l,!0,r,n.trim()||void 0)).then(y=>{if(u(!1),!y){h(d.actErr);return}o(y),s(y.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!c||!!f,title:f||void 0,onClick:v,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),f===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:f}),w&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function $c({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:l,canWrite:s}=Z(),[h,c]=p.useState("valides"),[x,u]=p.useState(!1),[b,f]=p.useState(null),[w,v]=p.useState(null),[m,y]=p.useState(!1),[E,k]=p.useState(!1),[j,N]=p.useState(null),[C,T]=p.useState(null),L=`atl2:bulk:${d}:${h}:${e}`;p.useEffect(()=>{f(null),v(null),y(!1),N(null);try{const Q=localStorage.getItem(L)||localStorage.getItem(`atl2:bulk:${d}:${h}`),ne=JSON.parse(Q||"null");T(ne&&Date.now()-Date.parse(ne.t)<24*3600*1e3?ne:null)}catch{T(null)}},[L,h,d]);const O=e==="instantly"&&!r.trim(),M=`${h}|${e}|${r.trim()}`,V=async()=>{if(O||!s)return;u(!0),y(!1),N(null);const Q=await Us(d,h,e,r.trim()||void 0);f(Q),v(Q.ok?M:null),u(!1)},J=p.useRef(!1);if(!s)return null;const F=async()=>{if(J.current||!s)return;J.current=!0,k(!0);const Q=`${d}:${h}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let ne;try{ne=await Hs(d,h,e,r.trim()||void 0,Q)}finally{J.current=!1}if(k(!1),y(!1),N(ne),ne.ok&&(ne.pushed||0)>0){const z={t:new Date().toISOString(),n:ne.pushed||0};T(z);try{localStorage.setItem(L,JSON.stringify(z))}catch{}}};m&&w!==null&&w!==M&&y(!1);const g=o,A=b!=null&&b.ok&&b.ready||0,S=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":g||"",I=!!(b!=null&&b.ok)&&w===M&&A>0&&!!S&&!C,U=C?new Date(C.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:h,onChange:Q=>c(Q.target.value),children:i.plugBulkTabs.map(([Q,ne])=>t.jsx("option",{value:Q,children:ne},Q))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:Q=>a(Q.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:Q=>n(Q.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||O,onClick:()=>{V()},children:x?"…":i.plugBulkPreview})]}),O&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),C&&t.jsx("p",{className:"mnote",children:i.bulkLocked(U,C.n)}),!C&&!!(b!=null&&b.ok)&&!S&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!C&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),I&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>y(!0),children:i.bulkArm}),I&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(A,S)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:E,onClick:()=>{F()},children:E?i.bulkSending:i.bulkConfirm(S)}),t.jsx("button",{type:"button",className:"abtn",disabled:E,onClick:()=>y(!1),children:i.bulkCancel})]}),j&&(j.ok?j.replayed?t.jsx("p",{className:"mnote",children:j.pending?i.bulkPending:i.bulkReplayed}):(j.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(j.pushed||0,j.linkedinReady||0,j.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:j.error||i.actErr}))]})}function Uc(){const{t:e,data:a,lang:r}=Z(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const l=window.location.href.split("?")[0];try{const h=await(await fetch(`${ya}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(et,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("b",{className:"pk-n",children:d.credits}),t.jsx("span",{className:"pk-u",children:e.creditsUnit}),t.jsxs("span",{className:"pk-p",children:[d.price_eur," €"]}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Hc(){const{t:e}=Z();return t.jsx(et,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(jc,{})})}function Vc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:l}=Z(),[s,h]=p.useState(null),[c,x]=p.useState(!1);p.useEffect(()=>{let L=!0;if(i)return Wn(i).then(O=>{L&&O&&typeof O.per_day=="number"&&h(O.per_day)}),()=>{L=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let L=!0;return Ds(o).then(O=>{L&&b(O)}),()=>{L=!1}},[o]);const f=r.stats,w=typeof(f==null?void 0:f.screened)=="number"?f.screened:n.filter(L=>L.kind==="target"&&Qe(L)).length,v=r.marketEstimate||0,m=v>0?Math.min(100,Math.round(w/v*100)):null,y=(f==null?void 0:f.window_days)||30,E=w>0?w/y:0,k=v>0?Math.max(0,v-w):0,N=v>0&&E>0&&w>=100?Math.round(k/E):null,C=L=>Math.round(L).toLocaleString(a==="en"?"en-US":"fr-FR"),T=L=>{c||!d||(x(!0),_o(o,L).then(O=>{if(x(!1),O===null){l(e.actErr);return}h(O),l(e.alertSaved)}))};return t.jsxs(et,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(w))}),v>0&&t.jsx("span",{children:e.covOf(C(v))})]}),m!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:m+"%"}}),t.jsxs("em",{children:[m," %"]})]}),N!==null&&t.jsx("p",{className:"mnote",children:e.covEta(N)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(E))}),f&&t.jsxs("div",{className:"covf",children:[typeof f.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(f.kept)})," ",e.covKept]}),typeof f.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(f.analyzed)})," ",e.covAna]}),typeof f.shown=="number"&&f.shown!==f.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(f.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((L,O)=>t.jsxs("tr",{className:L.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[L.code,L.geo?` · ${L.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof L.n=="number"?C(L.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:L.source}),L.elargi&&t.jsx("em",{children:e.covWide(String(L.demande||""))}),L.erreur&&t.jsx("em",{children:e.covMissing})]})]},O)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(u.total||v)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(L=>t.jsx("button",{type:"button",className:s===L?"on":"",disabled:c,onClick:()=>T(L),children:L===0?"⏸":L},L))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function Fi(e,a,r){const n=await fetch(`${zt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${zt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Wc(){const{t:e,token:a,canWrite:r}=Z(),[n,o]=p.useState(null),[i,d]=p.useState(""),[l,s]=p.useState(""),[h,c]=p.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=p.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const f=JSON.parse(localStorage.getItem(x)||"null");return!!f&&Date.now()-(f.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(p.useEffect(()=>{if(!r)return;let f=!0;return Bs(a).then(w=>{f&&o(w)}),()=>{f=!1}},[a,r]),!r||h||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),Fi(a,n.instruction||"","atelier2-avis").then(f=>{if(d(f.applied?"ok":"ko"),f.applied||s(f.encours?e.propSlow:f.reply),f.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:l||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{c(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Gc(){var j;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=Z(),[i,d]=p.useState(!1),[l,s]=p.useState(null),[h,c]=p.useState(!1),[x,u]=p.useState([]),[b,f]=p.useState(null),[w,v]=p.useState([]);if(!r)return null;const m=()=>{d(!0),c(!1),u([]),v([]),$s(a).then(N=>{if(d(!1),!N){c(!0),s(null);return}s(N)})},y=N=>{b||(f(N.title),Fi(a,N.instruction,"atelier2-prop").then(C=>{f(null),C.applied?(v(T=>[...T,N.title]),n(e.propApplied)):C.encours?n(e.propSlow):o(C.reply||e.propApplyFail)}))},E=((l==null?void 0:l.proposals)||[]).filter(N=>!x.includes(N.title)&&!w.includes(N.title)),k=((j=l==null?void 0:l.counts)==null?void 0:j.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:m,children:i?e.propWait:e.propBtn}),!i&&h&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!h&&l&&!(l.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:l.reason==="not_enough_signals"?e.propFew(k):e.propNone}),E.map(N=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[N.section]||N.section}),t.jsx("p",{className:"propt",children:N.title}),N.why&&t.jsx("p",{className:"mnote dim",children:N.why}),N.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",N.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>y(N),children:b===N.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(C=>[...C,N.title]),children:e.propSkip})]})]},N.title))]})}function Yc(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=Z(),[l,s]=p.useState(null),[h,c]=p.useState(!1),[x,u]=p.useState(!1),[b,f]=p.useState(""),[w,v]=p.useState(""),[m,y]=p.useState(!1),E=p.useRef(!1);if(p.useEffect(()=>{if(!a||!r)return;let N=!0;return _s(a).then(C=>{N&&(c(!0),!(!C||E.current)&&(s(C),f(C.fit),v(C.note)))}),()=>{N=!1}},[a,r]),!r)return null;const k=()=>{if(!(!b||m)){if(l&&l.fit===b&&l.note===w.trim()){u(!1);return}y(!0),Nt(a,"thesis_fit",b,w.trim(),"",d.email||"").then(N=>{if(y(!1),!N.ok){o(e.fitKo);return}s({fit:b,note:w.trim(),ts:new Date().toISOString()}),u(!1),n(e.fitSaved)})}},j=N=>N==="yes"?e.fitYes:N==="partial"?e.fitPartial:e.fitNo;if(l&&!x){const N=new Date(String(l.ts||"")),C=Number.isNaN(N.getTime())?"":N.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:j(l.fit)}),l.note?` — ${l.note}`:""]}),!!C&&t.jsx("p",{className:"mnote dim",children:C}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(N=>t.jsx("button",{type:"button","aria-pressed":b===N,className:"fitopt"+(b===N?" on":""),onClick:()=>{E.current=!0,f(N)},children:j(N)},N))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:w,onChange:N=>{E.current=!0,v(N.target.value)},onKeyDown:N=>{N.key==="Enter"&&k()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||m,onClick:k,children:m?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!h&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function Qc(){var m,y,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:l}=Z(),s=n==="client",h=p.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[c,x]=p.useState(""),[u,b]=p.useState(""),[f,w]=p.useState(!1),v=async()=>{const k=c.trim();if(!(!k||f||!s)){w(!0),b("");try{const N=await(await fetch(`${zt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(N.reply&&b(String(N.reply)),N.job_id){b(e.critChatRunning);const C=async()=>{const T=await fetch(`${zt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:N.job_id})}).then(L=>L.json()).catch(()=>null);if(T&&T.done){b(String(T.reply||T.clarification||T.summary||"✓")),w(!1),T.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||w(!1)}}};return t.jsxs(et,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((m=i.points)!=null&&m.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,N;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((N=k.out)!=null&&N.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},k.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsx(Yc,{}),t.jsx(Wc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!s||f,onChange:k=>x(k.target.value),onKeyDown:k=>{k.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!s||f||!c.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(Gc,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Ms,{fund:d,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Ai[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Kc(){const{t:e,dispatch:a,startTour:r}=Z(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(et,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const Ri="atl2:mapfold",Jc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Ri);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Xc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Oi=p.createContext(null),Z=()=>{const e=p.useContext(Oi);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ft({o:e,lg:a}){const{lang:r}=Z(),n=He(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:jr(n,r),children:[n.emoji," ",jr(n,r)]}):null}function tn({o:e,src:a}){const{lang:r,t:n}=Z(),o=He(e);if(!o)return null;const i=tl(o),d=al(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(Oo(o,r))+" · "+n.win7(Mo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,s)=>t.jsx("i",{className:s<i?"on":""},s))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Zc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Ye(a);if(o)return e.find(i=>Ye(i.name)===o)||e.find(i=>{const d=Ye(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function eu(){const{scoped:e,t:a,st:r,dispatch:n}=Z(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(x=>!Ge(x)),l=d.length,s=d.filter(x=>!x.noCo).length,h=d.filter(x=>!!x.noCo).length,c=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:c?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",s," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",h," ",a.zoomPulseExplore]})]})]})}function tu(){var w;const{t:e,lang:a,data:r,dispatch:n,dossiers:o,st:i,caps:d}=Z(),l=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR"),s={...i,filters:{...i.filters,win:"all",day:""}},h=o.filter(v=>!Ge(v)&&_t(v,s,d.pipe)),c=h.length,x=h.filter(v=>Te(v)===1).length,u=h.filter(v=>Te(v)===2).length,b=typeof((w=r.stats)==null?void 0:w.screened)=="number"?r.stats.screened:0;if(c<=0&&b<=0)return null;const f=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:l(c)}),t.jsx("span",{children:f>0?e.covOf(l(f)):e.covScreened("").trim()}),t.jsxs("ul",{children:[t.jsxs("li",{children:["✅ ",l(x)," ",e.covKept]}),t.jsxs("li",{children:["⚡ ",l(u)," ",e.covAna]})]})]})}function au(){var v;const{t:e,token:a,fund:r,dispatch:n,data:o}=Z(),[i,d]=p.useState(null),[l,s]=p.useState(!0),[h,c]=p.useState([]),x=o.credits,u=!!x&&!x.unlimited;p.useEffect(()=>{if(!a||!r)return;let m=!0;return s(!0),(async()=>{const[y,E]=await Promise.all([Wn(r),Po(a)]);m&&(y&&d(y),s(!1),c(E))})(),()=>{m=!1}},[a,r]);const b=(i==null?void 0:i.per_day)??null,f=((v=i==null?void 0:i.pool_order)==null?void 0:v.length)??0,w=h.filter(m=>m.status==="running").length;return t.jsxs("div",{className:"map-pulse map-engine",children:[t.jsxs("button",{type:"button",className:"map-engine-hit",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("em",{children:e.identEngine}),t.jsx("b",{children:b===null?"—":b}),t.jsx("span",{children:e.identPerDay}),t.jsxs("ul",{children:[b===0&&t.jsx("li",{children:t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause})}),w>0&&t.jsxs("li",{children:["⏳ ",w]}),t.jsx("li",{children:l?e.identPendingWait:e.identPending(f)})]})]}),t.jsxs("button",{type:"button",className:"map-engine-alert",title:e.memoAlertSub,onClick:()=>n({type:"modal",modal:"memoalert"}),children:["🔔 ",e.memoAlertBtn]}),u&&x&&t.jsxs("div",{className:"map-engine-credits",children:[t.jsx("em",{children:e.creditsCap}),t.jsxs("b",{children:[x.total_available,t.jsxs("span",{children:[" / ",x.daily_grant+x.purchased]})]}),t.jsx("span",{children:e.creditsToday})]})]})}function Mi({o:e}){const{lang:a}=Z(),r=el(e.cc),n=e.cc?ta(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:16,height:16,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const nu=!1;function ru(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Di=e=>`atl2:tour:${e||"anon"}`;function ou(e){try{return localStorage.getItem(Di(e))==="1"}catch{return!0}}function No(e){try{localStorage.setItem(Di(e),"1")}catch{}}function iu(e,a,r,n,o,i,d,l){const s=e.tourT,h=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .map-pulse",title:s.cover,body:e.fhintCover,need:".atl2 .map-hud"}:null,{sel:".atl2 .map-engine",title:s.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:h[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:h[1][0]},{sel:".atl2 .dmulti.ddeals",title:s.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:s.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:s.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:s.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:s.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:s.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-bulk"]',need:".atl2 .ic[data-tour=plug]",title:s.campout,body:e.fhintCampout,modal:"plug"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-crm"]',need:".atl2 .ic[data-tour=plug]",title:s.addcrm,body:e.fhintAddcrm,modal:"plug"}:null,...[2,4,5].filter(c=>(l[c]||0)>0).map(c=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:c===2?s.tabAna:c===4?s.tabValid:s.tabRej,body:c===2?e.fhintTabAna:c===4?e.fhintTabValid:e.fhintTabRej,ptab:c})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:s.rank,body:e.fhintRank},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:s.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:h[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:h[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:s.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:s.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:s.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function cu({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var rr;const{lang:d}=Qs(),l=Vl(e,d,a),s=p.useMemo(()=>({...Ll[d],...Tl(d,l.thesisMode)}),[d,l.thesisMode]),[h,c]=p.useReducer(Yl,void 0,()=>Wl((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Xc():Jc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=p.useRef(!0);p.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Ri,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const q=()=>{window.innerWidth<=760&&c({type:"mapFold",folded:!0})};return q(),window.addEventListener("resize",q),()=>window.removeEventListener("resize",q)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var q;(q=u.current)==null||q.call(u,h.filters)},[h.filters]);const[b,f]=p.useState(()=>{if(typeof window>"u")return"both";try{const q=localStorage.getItem("atl2:chrome-mode");if(q==="eval"||q==="filt"||q==="both")return q;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[w,v]=p.useState(null),[m,y]=p.useState(null),[E,k]=p.useState(null),[j,N]=p.useState({kept:0,dropped:0}),[C,T]=p.useState(!1),[L,O]=p.useState(""),[M,V]=p.useState(!1),[J,F]=p.useState(null),[g,A]=p.useState(null),[S,I]=p.useState(!1),[U,Q]=p.useState(!1),[,ne]=p.useState(0),z=()=>ne(q=>q+1),B=p.useRef([]),D=p.useRef(new Set),ee=p.useRef(new Set),[$,oe]=p.useState([]),[fe,be]=p.useState([]),[ke,ue]=p.useState(0),Se=p.useRef(new Map),Ae=p.useRef(null),{mode:me}=l,we=p.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),Ee=we.pipe,te=l.session.token||"",P=me==="client"&&!e;p.useEffect(()=>{if(!te||!Ee)return;let q=!0;const X=async()=>{const xe=await nl(te);!q||!xe||(be(xe.runs),ue(Date.now()/1e3-xe.now),oe(Ie=>Ie.filter(qe=>!xe.runs.some(Je=>Ye(Je.company)===Ye(qe.name)))))};X();const Y=$.length>0||fe.some(xe=>xe.status==="running"),ie=window.setInterval(()=>{X()},Y?8e3:25e3);return()=>{q=!1,window.clearInterval(ie)}},[te,Ee,$.length,fe.some(q=>q.status==="running")]),p.useEffect(()=>{if(!te||!Ee||!P)return;let q=!0;const X=async()=>{const ie=await rl(te);if(!q||!ie.length)return;const xe=new Map;ie.forEach(Ie=>{const qe=String(Ie.ceo_status||"").trim();qe&&Ie.check_id&&xe.set(String(Ie.check_id),qe)}),l.patchStatuses(xe,Ie=>Date.now()-(G.current.get(Ie)||0)>9e4)};X();const Y=window.setInterval(()=>{X()},6e4);return()=>{q=!1,window.clearInterval(Y)}},[te,Ee,P]);const K=p.useMemo(()=>{const q=[],X=new Set;for(const Y of $){const ie=Ye(Y.name);!ie||X.has(ie)||(X.add(ie),q.push({name:Y.name,id:Y.id,status:"boot",started:Y.started,estMin:Y.estMin,memoType:"instant"}))}for(const Y of fe){const ie=Ye(Y.company);if(!ie||X.has(ie))continue;X.add(ie);const xe=Y.status==="error"?"error":Y.status==="done"?"done":"running";q.push({name:Y.company,status:xe,started:Y.started||0,estMin:Y.est_min||(Y.memo_type==="detailed"?40:15),url:Y.url,error:Y.error,memoType:Y.memo_type,note:Y.note})}return q},[$,fe]),se=q=>K.find(X=>Ye(X.name)===Ye(q))||null,le=(q,X)=>{oe(Y=>Y.some(ie=>Ye(ie.name)===Ye(q.name))?Y:[...Y,{name:q.name,id:q.id,started:Date.now()/1e3,estMin:X==="detailed"?40:15}]),D.current.add(q.id),z()},he=(q,X=!1)=>{O(q),V(X),Ae.current&&clearTimeout(Ae.current),Ae.current=setTimeout(()=>O(""),X?4200:2400)},H=q=>he(q,!0),de=p.useMemo(()=>{const q=new Map;return l.dossiers.forEach(X=>{X.id&&q.set(X.id,X)}),q},[l.dossiers]),ye=p.useMemo(()=>l.dossiers.filter(q=>_t(q,h,Ee)),[l.dossiers,h,Ee]),je=p.useRef(!1);p.useEffect(()=>{if(je.current||l.loading||!l.dossiers.length)return;if(e&&!l.session.token){je.current=!0;return}if(!we.showFunnel||ou(l.session.token||"")){je.current=!0;return}je.current=!0;const q=window.setTimeout(()=>{No(l.session.token||""),I(!0)},700);return()=>window.clearTimeout(q)},[e,l.loading,l.dossiers.length,we.showFunnel,l.session.token]);const Ne=p.useMemo(()=>l.dossiers.filter(q=>Ql(q,h,Ee,l.favIds)),[l.dossiers,h,Ee,l.favIds]),ve=p.useMemo(()=>Ks(ye.filter(q=>!nt(q)),l.favIds),[ye,l.favIds]),$e=p.useRef(!1);p.useEffect(()=>{if($e.current)return;if(!Ee||a==="ops"){$e.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){$e.current=!0;return}if(l.loading)return;$e.current=!0;const q=Js(ve);q!==h.ptab&&c({type:"ptab",tab:q})},[Ee,a,n==null?void 0:n.ptab,l.loading,ve,h.ptab]);const tt=p.useMemo(()=>{const q=Zo(l.dossiers);return q?gt(q)===0?s.tourToday:ei(q,d):s.tourNoRun},[l.dossiers,s,d]),ct=p.useMemo(()=>l.dossiers.some(q=>!!q.memoUrl||!!q.summary||Qt(q)),[l.dossiers]),[Re,Ve]=p.useState(!1);p.useEffect(()=>{if(l.loading){Ve(!1);return}if(l.dossiers.length>0||l.error){Ve(!0);return}const q=window.setTimeout(()=>Ve(!0),6e3);return()=>window.clearTimeout(q)},[l.loading,l.dossiers.length,l.error]);const yt=(l.marketEstimate||0)>0||typeof((rr=l.stats)==null?void 0:rr.screened)=="number"&&l.stats.screened>0,Ue=p.useMemo(()=>[1,0,2,4,5,3].find(q=>(ve[q]||0)>0)??0,[ve]),it=Hn.find(q=>q.key===h.continent),Ot=h.continent==="monde"?s.contWorld:(d==="fr"?it==null?void 0:it.fr:it==null?void 0:it.en)||"";p.useEffect(()=>{const q=X=>{var ie;const Y=(((ie=X.detail)==null?void 0:ie.name)||"").trim();Y&&kt(null,Y)};return window.addEventListener("ppmap:evaluate",q),()=>window.removeEventListener("ppmap:evaluate",q)}),p.useEffect(()=>{const q=X=>{const Y=X.detail||{},ie=String(Y.id||"").trim(),xe=String(Y.name||"").trim(),Ie=String(Y.url||"").trim(),qe=ie&&de.get(ie)||Zc(l.dossiers,xe,Ie);if(qe){if(y(null),_t(qe,h,Ee)||(h.continent!=="monde"&&qe.continent!==h.continent&&c({type:"continent",key:qe.continent||"monde"}),c({type:"reset"})),Ee&&qe.kind!=="op"){const bt=Te(qe);typeof bt=="number"&&bt!==h.ptab&&c({type:"ptab",tab:bt})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),c({type:"focus",id:qe.id}),(qe.noCo||["media","nominations","recrutements"].includes(qe.engine||""))&&(qe.url||qe.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:qe.url||"",text:[qe.headline,qe.tagline].filter(Boolean).join(`
`)}})):qe.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:qe.name,url:qe.url||"",website:qe.website||"",domain:qe.domain||""}}));return}!xe&&!Ie||(c({type:"focus",id:ie||null}),y({name:xe,headline:String(Y.text||"").trim()||xe,url:Ie,card:Y.card}),Ie&&(Kt(xe)||!xe)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ie,text:String(Y.text||"").trim()}})):xe&&!Kt(xe)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:xe}})))};return window.addEventListener("ppmap:focus",q),()=>window.removeEventListener("ppmap:focus",q)}),p.useEffect(()=>{const q=ie=>{const xe={},Ie=String((ie==null?void 0:ie.sector)||"").trim();Ie&&(xe.sector=[Ie]);const qe=String((ie==null?void 0:ie.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(qe)&&(xe.day=qe);const Je=String((ie==null?void 0:ie.search)||"").trim();Je&&(xe.search=Je);const bt=String((ie==null?void 0:ie.dealKind)||"").trim();(bt==="ma"||bt==="levee"||bt==="other")&&(xe.dealKind=[bt]),Object.keys(xe).length&&c({type:"filters",patch:xe})},X=ie=>q(ie.detail),Y=ie=>{ie.data&&ie.data.type==="pp-filter"&&q(ie.data)};return window.addEventListener("ppmap:filter",X),window.addEventListener("message",Y),()=>{window.removeEventListener("ppmap:filter",X),window.removeEventListener("message",Y)}},[]),p.useEffect(()=>{const q=X=>{var xe;const Y=(((xe=X.detail)==null?void 0:xe.name)||"").trim().toLowerCase();if(!Y)return;const ie=l.dossiers.find(Ie=>(Ie.name||"").trim().toLowerCase()===Y);ie&&c(a==="ops"?{type:"focus",id:ie.id}:{type:"popup",id:ie.id})};return window.addEventListener("ppmap:similar",q),()=>window.removeEventListener("ppmap:similar",q)});const kt=(q,X,Y)=>{const ie=(Y||(q==null?void 0:q.name)||X||"").trim();if(!P){k({kicker:ie});return}!ie||C||(T(!0),(async()=>{try{let xe=(X||ie).trim();const Ie=((q==null?void 0:q.website)||(q==null?void 0:q.domain)||"").trim();if(!(/^https?:\/\//i.test(xe)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(xe)&&!/\s/.test(xe)))if(Ie)xe=Ie;else try{const Be=await Vn(ie);if(Be!=null&&Be.website)xe=Be.website;else if(((Be==null?void 0:Be.candidates)||[]).length===1)xe=Be.candidates[0].url;else if(((Be==null?void 0:Be.candidates)||[]).length>1){B.current=[{name:ie,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(Be.candidates||[]).slice(0,5)},...B.current].slice(0,8),z();return}}catch{}const Je=await To(te,xe,"atelier2"),bt={name:Je.company||ie,verdict:Je.verdict,reason:Je.reason||"",remaining:Je.remaining??null};B.current=[bt,...B.current].slice(0,8),Je.verdict==="kept"&&N(Be=>({...Be,kept:Be.kept+1})),Je.verdict==="ruled_out"&&N(Be=>({...Be,dropped:Be.dropped+1}));const ra=q||l.dossiers.find(Be=>(Be.name||"").toLowerCase()===ie.toLowerCase());ra&&(Je.verdict==="kept"?ra.verdict=ra.verdict||"MATCH":Je.verdict==="ruled_out"&&(ra.verdict="NO MATCH"),Je.reason&&(ra.reasoning=Je.reason)),z()}finally{T(!1)}})())},Mt=q=>{if(!P){k({kicker:q.name});return}le(q,"instant"),Nt(te,"fast_request",q.name||"",""),he(s.memoInstantSent(q.name))},Ct=q=>Se.current.get(q.id)??l.thumbs.get((q.name||"").trim().toLowerCase()),At=(q,X)=>c({type:"undoPush",entry:{id:q.id,name:q.name,prevCeoStatus:X}}),Et=async(q,X,Y)=>{const ie=q.ceoStatus||"";G.current.set(q.id,Date.now()),q.ceoStatus=X,z();const xe=await on(te,{status:X,airtable_id:q.airtableId,check_id:q.checkId,company:q.name,...(Y==null?void 0:Y.note)!==void 0?{note:Y.note}:{},...Y!=null&&Y.via?{via:Y.via}:{}});return xe.ok?xe.skipped?(q.ceoStatus=ie,z(),H(s.actNotPersisted),!1):((Y==null?void 0:Y.undo)!==!1&&At(q,ie),Y!=null&&Y.msg&&he(Y.msg),(X==="Validé"||X==="Écarté")&&!q.ceoNote&&(Y==null?void 0:Y.note)===void 0&&F({o:q,yes:X==="Validé"}),!0):(q.ceoStatus=ie,z(),H(s.actErr),!1)},Dt=async(q,X)=>{const Y=await on(te,{status:q.ceoStatus||"Retenu",airtable_id:q.airtableId,check_id:q.checkId,company:q.name,note:X,via:"note"});return!Y.ok||Y.skipped?(H(Y.skipped?s.actNotPersisted:s.actErr),!1):(q.ceoNote=X,z(),!0)},De=p.useRef(new Map),xt=q=>De.current.has(q.id)?De.current.get(q.id):l.stages.get((q.name||"").trim().toLowerCase()),at=(q,X)=>{De.current.set(q.id,X),z()},R=(q,X)=>{P&&Et(q,X?"Validé":"Écarté",{msg:X?s.decidedYes(q.name):s.decidedNo(q.name)})},W=q=>{P&&Et(q,"À trancher",{msg:s.promoted(q.name)})},ae=q=>{P&&(async()=>{const X=q.ceoStatus||"";q.ceoStatus="Retenu",z();const Y=await on(te,{status:"Retenu",check_id:q.checkId,company:q.name});if(!Y.ok||Y.skipped){q.ceoStatus=X,z(),H(Y.skipped?s.actNotPersisted:s.actErr);return}At(q,X),he(s.repeched(q.name))})()},ce=()=>{const q=h.undo[h.undo.length-1];if(!q){he(s.undoNone);return}const X=de.get(q.id);if(!X){c({type:"undoPop"}),he(s.undoNone);return}let Y=q.prevCeoStatus;if(!Y)if((X.verdict||"").toUpperCase().includes("CALL"))Y="À trancher";else{he(s.undoLockedTitle);return}(async()=>await Et(X,Y,{undo:!1})&&(c({type:"undoPop"}),X.ceoStatus=q.prevCeoStatus,z(),he(s.undoDone(X.name))))()},_=q=>{P&&(ee.current.add(q.id),z(),c({type:"approachOpen",id:q.id}),Nt(te,"approach",q.name||"","","",l.email||""))},G=p.useRef(new Map),re=p.useRef(!1),[ge,pe]=p.useState(0);p.useEffect(()=>{if(!te||e||!P||re.current)return;re.current=!0;const q=new Date().toISOString().slice(0,10),X=l.email||"",Y=`cbv_${te}_${X}_${q}`,ie=`atl2:vue:${te}:${q}`;try{if(localStorage.getItem(Y)||localStorage.getItem(ie))return}catch{}Nt(te,"view","","","",X).then(xe=>{if(!xe.ok){re.current=!1;return}try{localStorage.setItem(Y,"1")}catch{}})},[te,e,P,l.email]),p.useEffect(()=>{if(!te||!Ee||e||!P||!l.generatedAt)return;let q=!0;const X=()=>{document.hidden||ol(te,l.generatedAt||"").then(ie=>{q&&pe(ie)})};X();const Y=window.setInterval(X,6e4);return()=>{q=!1,window.clearInterval(Y)}},[te,Ee,e,l.generatedAt]);const Oe=(q,X)=>{P&&(async()=>{if(!(await Nt(te,X?"yes":"no",q.name||"",(q.ceoNote||"").slice(0,400),q.sector||"",l.email||"")).ok){H(s.actErr);return}Se.current.set(q.id,X?"yes":"no"),z(),he(X?s.thumbUpDone:s.thumbDnDone),A({o:q,up:X})})()},Ce=q=>{!P||!Qt(q)||(le(q,"detailed"),Nt(te,"detailed_request",q.name||"","","",l.email||""),he(s.memoDeepSent(q.name)))},Fe=q=>{!P||!q.memoUrl||window.confirm(s.memoRegenAsk(q.name))&&(le(q,"detailed"),Nt(te,"detailed_regen",q.name||"","","",l.email||""),he(s.memoDeepSent(q.name)))},Ke=q=>{const X=new Set(l.favIds),Y=X.has(q.id);Y?X.delete(q.id):X.add(q.id),l.setFavIds(X),P&&il(te,{id:q.id,co:q.name},Y)},We=()=>{!P||U||window.confirm(s.identSyncConfirm)&&(Q(!0),(async()=>{const q=await sl(te);Q(!1),q?he(s.identSyncDone):H(s.actErr)})())},ut=/proplace/i.test(l.fund||""),mt=q=>{!P||!ut||(Nt(te,"onboard_request",q.name||"",""),he(s.onboardSent(q.name)))},qt={st:h,dispatch:c,t:s,lang:d,mode:me,caps:we,pipe:Ee,token:te,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:ae,thumbOf:Ct,canWrite:P,commitStatus:Et,saveNote:Dt,stageOf:xt,setStage:at,flashErr:H,startTour:()=>I(!0),dossiers:l.dossiers,scopedAll:ye,scoped:Ne,counts:ve,byId:de,contName:Ot,favIds:l.favIds,toggleFav:Ke,askEvaluate:kt,doAnalyse:Mt,doDecide:R,doPromote:W,doApproach:_,doThumb:Oe,doDeep:Ce,doRegen:Fe,doUndo:ce,doSync:We,doOnboard:mt,outbound:ut,memoQueued:D.current,liveMemos:{items:K,serverOff:ke,liveOf:se},approachDone:ee.current,sessTally:j,evalCards:B.current,evalBusy:C,markRow:v,markedId:w,flash:he,focusExtra:m};p.useEffect(()=>{const q=X=>{X.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",q),()=>window.removeEventListener("keydown",q)},[]);const na=q=>te?t.jsx(Xl,{token:te,children:q}):t.jsx(t.Fragment,{children:q});return t.jsx(Oi.Provider,{value:qt,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(te?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Dl}),na(t.jsxs("div",{className:"app"+(Ee?" pipe":"")+(te?" has-thesis":""),children:[we.showTicker&&t.jsx(ft,{name:"live",children:t.jsxs("div",{className:"live-stack"+(te?" live-stack--cibles":""),children:[t.jsx(od,{}),!!te&&t.jsx(Zl,{})]})}),we.showIdent&&t.jsx(ft,{name:"identite",children:t.jsx(hd,{})}),!1,nu,we.showFunnel&&t.jsx(ft,{name:"entonnoir",children:t.jsx(su,{})}),t.jsx(ft,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(wi,{variant:"tabs"}),!h.mapFolded&&t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(eu,{}),a!=="ops"&&(we.showFunnel||we.showIdent)&&t.jsxs("div",{className:"map-hud",children:[we.showFunnel&&t.jsx(tu,{}),we.showIdent&&t.jsx(au,{})]}),t.jsx(mp,{}),t.jsx(vi,{})]})]})}),we.showDemand&&Ee&&t.jsx(ft,{name:"direct",children:t.jsx(ul,{items:K,serverOff:ke,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([q,X])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===q,onClick:()=>{f(q);try{localStorage.setItem("atl2:chrome-mode",q)}catch{}},children:X},q))}),we.showDemand&&t.jsx(ft,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Cp,{})})}),we.showDemand&&h.memoConsole&&t.jsx(ft,{name:"console",children:t.jsx(qp,{})}),we.pipe&&!!te&&t.jsx(ft,{name:"moteurs",children:t.jsx(Nl,{})}),ge>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:s.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{pe(0),l.refresh()},children:s.freshGo})]}),t.jsx(ft,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(bc,{})}),we.pipe&&!!te&&t.jsx("p",{className:"privnote",children:s.privLink}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),h.popupId&&h.dens!=="liste"&&a!=="ops"&&t.jsx(ft,{name:"fiche",children:t.jsx(tc,{})}),t.jsx(ft,{name:"modales",children:t.jsx(Sc,{})}),t.jsx(Xs,{}),g&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:g.o.name}),t.jsx(Ir,{placeholder:g.up?s.thumbWhyUpPh:s.thumbWhyDnPh,onDone:q=>{const X=g.o;A(null),q&&Nt(te,"note",X.name||"",q,X.sector||"",l.email||"").then(Y=>{Y.ok&&he(s.csNoteSaved)})}})]}),J&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:J.o.name}),t.jsx(Ir,{placeholder:J.yes?s.whyYesPh:s.whyNoPh,onDone:q=>{const X=J.o;F(null),q&&Dt(X,q).then(Y=>{Y&&he(s.csNoteSaved)})}})]}),S&&Re&&t.jsx(md,{steps:iu(s,tt,ct,Ue,yt,ve[3]||0,ve[4]||0,ve),onClose:()=>{I(!1),No(te)}}),t.jsx(ru,{}),we.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:Io,children:Do}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Ba}`,children:Ba})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),L&&t.jsx("div",{className:"flash on"+(M?" err":""),children:L}),E&&t.jsx(Zs,{variant:"acquirer",initialCompany:So().co,initialWebsite:So().site,onClose:()=>k(null)})]})})}function su(){const{t:e}=Z(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function So(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function lu(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Mi as FlagCell,Ft as SigBadge,tn as SigWin,cu as default,lu as fmtShort,Z as useV2};
