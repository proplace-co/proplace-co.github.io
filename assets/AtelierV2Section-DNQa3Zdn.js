...
.atl2 .bulk .side .hint{white-space:nowrap}`,Pa=`
...
`,Ba=qa+Pa;function Ia(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function $a(t,a){return t||a.mode!=="client"||!a.token?"visiteur":Ia("teaser")==="1"?"apercu":"client"}const Va={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},Ua=t=>Va[t],fe=t=>Object.assign(t,{continent:na(t.cc)});function Be(t){const a=new Set,n=[];for(const r of t){const l=(r.name||"").toLowerCase();!l||a.has(l)||(a.add(l),n.push(r))}return n}const _a=60*60*1e3;function Ha(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>_a?null:a}catch{return null}}function Te(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ya=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function Wa(t,a,n="default"){const r=n!=="default",l=c.useMemo(()=>t||r?{mode:"anon"}:Jt(),[t,r]),o=c.useMemo(()=>r?"visiteur":$a(t,l),[t,l,r]),i=c.useMemo(()=>Ua(o),[o]),u=o!=="visiteur",f=Ya(n),[p,g]=c.useState([]),[s,v]=c.useState(""),[b,m]=c.useState(null),[x,h]=c.useState(null),[d,N]=c.useState(()=>new Map),[w,k]=c.useState(()=>new Map),[C,z]=c.useState(""),[F,j]=c.useState(new Set),[E,I]=c.useState(null),[L,M]=c.useState(!0),[R,T]=c.useState(!1),[P,B]=c.useState(0),[_,re]=c.useState(0),de=c.useRef(0),$=c.useMemo(()=>{var q;if(o!=="client")return"";try{return((q=Xt())==null?void 0:q.email)||""}catch{return""}},[o]);c.useEffect(()=>{const q=++de.current;let V=!0;const D=()=>V&&q===de.current,G=(u&&l.token?l.token:"pub:"+a)+(f?":"+f:""),ae=Ha(G);return ae?(g(ae.objs.map(fe)),ae.fund&&v(ae.fund),m(ae.marketEstimate??null),h(ae.criteria??null),z(ae.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(n==="ops"){const Z=await De(),ee=((Z==null?void 0:Z.recent_ops)||[]).map(te=>qe(te,a)).filter(te=>!!te);if(!D())return;g(ee.map(fe)),Te(G,{objs:ee})}else if(typeof n=="object"){const ee=(await Xe()||[]).filter(K=>(K.slug||"")===n.research).map(K=>Ze(K,a)).filter(K=>!!K),te=Be(await et(ee,a));if(!D())return;g(te.map(fe)),Te(G,{objs:te})}else if(u&&l.token){const Z=Zt(l.token),ee=De(),te=ea(l.token),K=ta(l.token),me=aa(l.token),U=await Z;let ne=U?U.targets:[];D()&&U&&(v(U.fund||""),m(U.marketEstimate??null),h(U.criteria??null),z(U.generatedAt||""),g(ne.map(fe)),M(!1),T(!1));const[ce,we,pe,W]=await Promise.all([ee,te,K,me]),Se=((ce==null?void 0:ce.recent_ops)||[]).map(ie=>qe(ie,a)).filter(ie=>!!ie);if(ne=[...ne,...Se],!D())return;g(ne.map(fe));const xe=new Set;for(const ie of we){const ge=(ie.id||ie.co||"").toString().trim().toLowerCase();ge&&xe.add(ge.startsWith("t:")?ge:"t:"+ge)}j(xe),N(pe),k(W),U&&Te(G,{fund:U.fund,marketEstimate:U.marketEstimate,criteria:U.criteria,generatedAt:U.generatedAt,objs:ne})}else{const Z=ra(),ee=Xe(),te=De(),K=await Z;D()&&K.length&&(g(Be(K).map(fe)),M(!1),T(!1));const[me,U]=await Promise.all([ee,te]),ne=(me||[]).map(W=>Ze(W,a)).filter(W=>!!W),ce=await et(ne,a),we=((U==null?void 0:U.recent_ops)||[]).map(W=>qe(W,a)).filter(W=>!!W),pe=Be([...K,...ce,...we]);if(!D())return;g(pe.map(fe)),Te(G,{objs:pe})}D()&&T(!1)}catch{D()&&!ae&&T(!0)}finally{D()&&M(!1)}})(),()=>{V=!1}},[u,l.token,a,P,f]),c.useEffect(()=>{if(!i.showCredits||!$){I(null);return}let q=!0;return(async()=>{try{const V=await fetch(`${$e}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:$})});if(!V.ok)return;const D=await V.json();q&&D&&D.ok!==!1&&I(D)}catch{}})(),()=>{q=!1}},[i.showCredits,$,_]);const le=c.useCallback(q=>j(new Set(q)),[]);return{session:l,mode:o,caps:i,fund:s,email:$,marketEstimate:b,generatedAt:C,criteria:x,thumbs:d,stages:w,dossiers:p,favIds:F,setFavIds:le,credits:E,reloadCredits:()=>re(q=>q+1),loading:L,error:R,refresh:()=>B(q=>q+1)}}const Et=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Ga=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...Et(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Ka(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(l=>l!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(l=>l!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Et(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Oe)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Oe=60;function Ye(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!Y(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(Ve(t)))return!1;if(r!=="win"&&a.win!=="all"){const l=a.win==="1"?0:a.win==="7"?7:30;if(be(t.date)>l)return!1}if(r!=="status"&&!n&&a.status!=="all"&&se(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const l=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(l))return!1}return!0}function Tt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:Ye(t,a.filters,n)}function Qa(t,a,n,r){return!(!Tt(t,a,n)||n&&!oa(t,a.ptab,r))}function We(t,a){const n=a.key,r=l=>{switch(n){case"name":return(l.name||"").toLowerCase();case"country":return l.countryLabel||l.cc||"";case"stage":return l.stage||"";case"amount":return l.amountEur||-1;case"age":return-be(l.date);case"score":return typeof l.score=="number"?l.score:-1;case"signal":{const o=Y(l);return o?100-(o.left??0):-1}}};return[...t].sort((l,o)=>{const i=r(l),u=r(o);return i<u?-a.dir:i>u?a.dir:(l.name||"").localeCompare(o.name||"")})}function Ja(){const{dossiers:t,st:a,t:n,dispatch:r,contName:l,pipe:o}=S(),i=c.useMemo(()=>{const f=s=>o?!0:s.continent===a.continent,p=t.filter(s=>f(s)&&Y(s)),g=t.filter(s=>f(s)&&s.kind==="op"&&!Y(s)&&(s.dealKind==="ma"||s.dealKind==="levee")&&be(s.date)<=2);return g.sort((s,v)=>(v.amountEur||0)-(s.amountEur||0)),[...We(p,{key:"signal",dir:-1}),...g].slice(0,40)},[t,a.continent,o]),u=f=>i.map(p=>e.jsxs("button",{type:"button",className:"tk"+(Q(p)?" spent":""),onClick:g=>{const s=g.currentTarget.getBoundingClientRect();r({type:"popup",id:p.id,anchor:{x:s.left+s.width/2,y:s.bottom}})},title:p.name+(p.tagline?" — "+p.tagline:""),children:[e.jsx(ye,{o:p}),e.jsxs("span",{className:"who",children:[e.jsx(Rt,{o:p}),e.jsx("span",{className:"co",children:p.name})]}),typeof p.amountEur=="number"&&p.amountEur>0&&e.jsx("span",{className:"am",children:dn(p.amountEur)}),p.sector&&e.jsx("span",{className:"mt",children:p.sector}),e.jsx(Me,{o:p}),e.jsx("span",{className:"tkgo",children:"→"})]},f+(p.id||p.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:i.length})]}),e.jsx("div",{className:"win",children:i.length?e.jsxs("div",{className:"run",children:[u(0),u(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(l)})})})]})}const Xa="aDx8z7Hzksus",At="+33 6 83 10 72 86",ct="alexandre@proplace.co",Za=`tel:${At.replace(/[^\d+]/g,"")}`,pt="pp-rdv-slot";function er(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function tr(){const{t,caps:a,fund:n}=S(),r=a.showOnb,l=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:rr}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:Za,children:At}),t.rdvSubMid,e.jsx("a",{href:`mailto:${ct}`,children:ct})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(l).map(([o,i],u)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(u+1)}),e.jsx("b",{children:o}),e.jsx("span",{children:i})]},o))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(Fa,{filloutId:Xa,parameters:n?{company_name:n}:void 0})})]})}function ar(){const[t,a]=c.useState(()=>typeof document>"u"?null:document.getElementById(pt));return c.useEffect(()=>{t||a(document.getElementById(pt))},[t]),t?Ce.createPortal(e.jsx(tr,{}),t):null}const rr=`
...
`,nr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function or({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:l}=S(),[o,i]=c.useState(""),[u,f]=c.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const p=(t.ceoStatus||"").trim(),g=(Re(t)||"").startsWith("CALL")&&X(t)===3,s=X(t)>=2,v=async m=>{if(o||m==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;i(m);const x=await l(t,m);i(""),x&&(f(!0),setTimeout(()=>f(!1),2200))},b=g?[["Validé",a.csYes],["Écarté",a.csNo]]:nr.filter(([m])=>!(s&&m==="Retenu")).map(([m,x])=>[m,a[x]]);return e.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,x])=>e.jsx("button",{type:"button",className:"csb"+(p===m?" on":"")+(o===m?" busy":""),disabled:!!o,onClick:()=>{v(m)},children:x},m)),u&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(lr,{o:t})]})}function lr({o:t}){const{t:a,saveNote:n,flash:r}=S(),[l,o]=c.useState(t.ceoNote||""),[i,u]=c.useState(!1),[f,p]=c.useState(!1),g=l.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(i||!g)return;u(!0);const v=await n(t,l.trim());u(!1),v&&(p(!0),setTimeout(()=>p(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:l,disabled:i,onChange:v=>o(v.target.value),onKeyDown:v=>{v.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:i||!g,onClick:()=>{s()},children:f?a.csNoteSaved:a.csNoteOk})]})}function ir({placeholder:t,onDone:a}){const{t:n}=S(),[r,l]=c.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>l(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function sr({o:t}){var h;const{t:a,token:n,caps:r,canWrite:l,stageOf:o,setStage:i,flashErr:u}=S(),[f,p]=c.useState(!1);if(!r.pipe||!l||r.lockActions||X(t)!==4)return null;const g=o(t),s=(g==null?void 0:g.stage)||"todo",v=async d=>{if(f||d===s)return;p(!0);const N=g;i(t,{stage:d,stamps:(g==null?void 0:g.stamps)||{}});const w=Math.max(Date.now(),ut+=1);ut=w;const k=await la(n,{company:t.name||"",stage:d,cts:w,deal_id:t.airtableId,check_id:t.checkId});p(!1),!k.stale&&(k.ok||(i(t,N),u(a.actErr)))},b=(h=g==null?void 0:g.stamps)==null?void 0:h.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,x=s==="sent"&&b&&m>=4;return e.jsxs("div",{className:"stg",onClick:d=>d.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([d,N])=>e.jsx("button",{type:"button",className:"stgb"+(s===d?" on":""),disabled:f,onClick:()=>{v(d)},children:N},d)),x&&e.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let ut=0;const Ae=8,Le=340;function ft({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function dr({steps:t,onClose:a}){const{t:n,dispatch:r,counts:l,scoped:o,byId:i,st:u}=S(),[f,p]=c.useState(0),[g,s]=c.useState(null),[v,b]=c.useState([]),m=c.useRef(!1);c.useEffect(()=>{m.current||(m.current=!0,b(t.filter(C=>!!document.querySelector(C.need||C.sel))))},[t]);const x=v[f],h=f>=v.length;c.useEffect(()=>{x&&(x.ptab!==void 0&&u.ptab!==x.ptab&&r({type:"ptab",tab:x.ptab}),x.dens&&u.dens!==x.dens&&r({type:"dens",dens:x.dens}))},[f,x]);const d=c.useCallback(()=>{if(!x){s(null);return}const C=document.querySelector(x.sel);if(!C){s(null);return}C.scrollIntoView({block:"nearest",behavior:"smooth"}),s(C.getBoundingClientRect())},[x]);c.useLayoutEffect(()=>{d();const C=window.setTimeout(d,260),z=()=>d();return window.addEventListener("scroll",z,!0),window.addEventListener("resize",z),()=>{window.clearTimeout(C),window.removeEventListener("scroll",z,!0),window.removeEventListener("resize",z)}},[d]);const N=c.useRef(a);if(N.current=a,c.useEffect(()=>{const C=z=>{z.key==="Escape"?(z.preventDefault(),z.stopPropagation(),N.current()):z.key==="ArrowRight"?p(F=>F+1):z.key==="ArrowLeft"&&p(F=>Math.max(0,F-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!v.length)return null;let w=null;if(h){const C=l[3]||0,z=o.find(F=>F.memoUrl)||[...i.values()].find(F=>F.memoUrl);C>0?w={title:C===1?n.ahaATitle1:n.ahaATitleN(C),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:z?w={title:n.ahaBTitle,body:n.ahaBBody(z.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:z.id}),a()}}:w={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let k={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Le};if(!h&&g){const C=g.bottom+14,F=window.innerHeight-C>190?C:Math.max(12,g.top-200);k={left:Math.min(Math.max(12,g.left+g.width/2-Le/2),window.innerWidth-Le-12),top:F,width:Le}}return Ce.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!h&&g&&e.jsx("div",{className:"tour-hole",style:{left:g.left-Ae,top:g.top-Ae,width:g.width+Ae*2,height:g.height+Ae*2}}),(h||!g)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(h?" fin":""),style:k,children:[h&&w?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:w.title}),e.jsx("p",{children:e.jsx(ft,{text:w.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>p(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(f+1,v.length)}),e.jsx("h3",{children:x==null?void 0:x.title}),e.jsx("p",{children:e.jsx(ft,{text:(x==null?void 0:x.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:f===0,onClick:()=>p(C=>Math.max(0,C-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>p(C=>C+1),children:f===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function cr(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:l}=S(),o=c.useMemo(()=>t.filter(s=>be(s.date)===0&&s.kind==="target"),[t]),i=c.useMemo(()=>o.filter(s=>a?X(s)===0:!Q(s)),[o,a]),u=o.length-i.length,f=o.length?Math.min(100,u/o.length*100):100;let p;a?p=n.morningThesis(o.length,u,i.length):o.length?u===0?p=n.goalSourced(o.length):u>=o.length?p=n.goalCleared:p=n.goalDone(u,o.length):p=n.goalSourced(0);const g=()=>{a?(l({type:"ptab",tab:0}),l({type:"filters",patch:{win:"1"}})):l({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:p}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:f+"%"}})}),i.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:g,children:a?n.morningEval(i.length):r.pileMode?n.goalContinue(i.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function pr(){var I;const{t,st:a,dispatch:n,token:r,fund:l,data:o,dossiers:i,mode:u,doSync:f,startTour:p}=S(),[g,s]=c.useState(null),[v,b]=c.useState([]),[m,x]=c.useState(!1),h=u==="client";c.useEffect(()=>{if(!r||!l)return;let L=!0;return(async()=>{const[M,R]=await Promise.all([kt(l),jt(r)]);L&&(M&&s(M),b(R))})(),()=>{L=!1}},[r,l]);const d=(g==null?void 0:g.per_day)??null,N=((I=g==null?void 0:g.pool_order)==null?void 0:I.length)??0,w=v.filter(L=>L.status==="running").length,k=L=>{if(!h||d===null||m)return;const M=Math.max(0,Math.min(10,d+L));M!==d&&(x(!0),s(R=>R&&{...R,per_day:M}),Nt(r,M).then(R=>{x(!1),s(R===null?T=>T&&{...T,per_day:d}:T=>T&&{...T,per_day:R})}))},C=c.useMemo(()=>i.filter(L=>L.kind==="target"&&Q(L)).length,[i]),z=o.marketEstimate,F=z&&z>0?Math.min(100,Math.round(C/z*100)):null,j=(l||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const L=Date.parse(o.generatedAt||"");if(Number.isNaN(L))return"";const M=new Date(L),R=T=>String(T).padStart(2,"0");return`${R(M.getDate())}/${R(M.getMonth()+1)} à ${R(M.getHours())}:${R(M.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:j}),e.jsx("i",{children:l})]}),e.jsx("h1",{children:t.identTitle(l||"…")}),e.jsx("span",{className:"idsp"}),E&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(E)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:p,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[F!==null&&z&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:F+"%"}})}),e.jsxs("b",{children:[F," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(C,z)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),d!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:L=>{L.stopPropagation(),k(-1)},children:"−"}),e.jsx("b",{className:"q",children:d})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:L=>{L.stopPropagation(),k(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),d===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),w>0&&e.jsxs("span",{className:"ev",children:["⏳ ",w]}),e.jsx("span",{className:"ego",children:t.identPending(N)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!h,onClick:f,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function ur(){const{t,counts:a,dispatch:n}=S();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,l],o)=>{const i=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(i?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:l}),i&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const fr=["--p0","--p1","--p2","--p3","--p4"];function mr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:l}=S(),o=c.useRef({});c.useEffect(()=>{o.current={...n}},[n]);const i=p=>{const g=o.current[p],s=g!==void 0?n[p]-g:0;return e.jsxs("button",{type:"button",className:"step"+(p===3&&n[3]>0?" wait":""),style:{"--c":`var(${fr[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===p,title:r.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[e.jsxs("span",{className:"l",children:[r.plabels[p].toUpperCase(),p===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[p],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},p)},u=(p,g,s)=>e.jsxs("button",{type:"button",className:"off"+(g?" view":""),style:{"--c":p===5?"var(--p5)":p===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===p,title:r.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[p]})]},p),f=(p,g,s,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:g,disabled:v,onClick:s,children:p},g);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(i)}),e.jsxs("div",{className:"offtrack",children:[u(5,!1,r.plabels[5]),u(7,!0,r.plabels[7]),u(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[f("↩",r.toolUndo,l,t.undo.length===0),f("↺",r.toolReset,()=>{a({type:"reset"})}),f("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),f("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const xr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function gr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:l,doAnalyse:o,mode:i}=S(),u=c.useRef(null),[f,p]=c.useState(60);c.useEffect(()=>{let b=0;const m=()=>{var w;const x=u.current;if(!x)return;const h=(w=x.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!h)return;const d=h.getBoundingClientRect(),N=x.getBoundingClientRect();p(Math.max(20,Math.min(d.left+d.width/2-N.left,N.width-30)))};return b=requestAnimationFrame(m),window.addEventListener("resize",m),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",m)}},[t.ptab]);const g=t.ptab;let s=n.tuto[g].p;if(g===3){const b=r.filter(h=>h.kind==="target"&&X(h)===3),m=b.filter(h=>Ie(h)==="auto").length,x=b.filter(h=>Ie(h)==="cd").length;s=n.tutoPending(m,x,b.length)}const v=(()=>{if(i!=="client")return null;if(g===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(g===1){const b=r.filter(m=>m.kind==="target"&&X(m)===1&&!l.has(m.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(m=>o(m))}}return null})();return e.jsxs("div",{ref:u,className:"tuto mini",style:{"--bg":xr[g],"--ax":f+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[g].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const mt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function xt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function hr(t,a){const[n,r]=c.useState(1);return c.useEffect(()=>{let l=!0,o=0;const i=()=>{var p;if(!l)return;const f=(p=t.current)==null?void 0:p.getScreenCTM();f&&f.a>0?r(f.a):o=requestAnimationFrame(i)};i();const u=new ResizeObserver(()=>i());return t.current&&u.observe(t.current),window.addEventListener("resize",i),()=>{l=!1,cancelAnimationFrame(o),u.disconnect(),window.removeEventListener("resize",i)}},[t,a]),n}function br(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:l,markedId:o,byId:i,lang:u,t:f}=S(),p=c.useRef(null),g=c.useRef(null),s=Ue.find(j=>j.key===t.continent),v=hr(p,t.continent+":"+t.mapFolded),[b,m]=c.useState(new Map),[x,h]=c.useState(null);c.useEffect(()=>{const j=p.current;if(!j)return;const E=new Map;j.querySelectorAll("path[data-i2]").forEach(I=>{const L=I.dataset.i2;if(L)try{const M=I.getBBox();M.width>0&&E.set(L,{x:M.x,y:M.y,w:M.width,h:M.height})}catch{}}),m(E)},[t.continent,v]);const d=c.useMemo(()=>n.filter(j=>j.cc),[n]),N=c.useMemo(()=>{const j=new Map;return d.forEach(E=>j.set(E.cc,(j.get(E.cc)||0)+1)),j},[d]),w=c.useMemo(()=>d.map(j=>{const E=j.cc?b.get(j.cc):void 0;if(!E)return null;const I=xt(j.name||j.id||""),L=xt((j.id||j.name||"")+"·y"),M=(I-.5)*Math.min(E.w*.55,60),R=(L-.5)*Math.min(E.h*.55,60);return{d:j,x:E.x+E.w/2+M,y:E.y+E.h/2+R}}).filter(j=>!!j),[d,b]),k=j=>v>0?j/v:j,C=c.useMemo(()=>r?[0,1,2,3,4,5].map(j=>({c:mt[j],fr:f.plabels[j].toUpperCase(),en:f.plabels[j].toUpperCase(),n:n.filter(E=>E.kind==="target"&&X(E)===j).length})).filter(j=>j.n>0):tt.map((j,E)=>({...j,n:n.filter(I=>at(I)===E).length})),[n,r,f.plabels]),z=o?i.get(o):null,F=z?w.find(j=>j.d.id===z.id):null;return e.jsxs("div",{className:"mapzone",ref:g,children:[e.jsxs("svg",{ref:p,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":u==="fr"?s.fr:s.en,onMouseLeave:()=>{h(null),l(null)},children:[e.jsx("g",{children:s.countries.map((j,E)=>e.jsx("g",{className:"ct"+(j.i2&&N.get(j.i2)?"":" empty"),children:e.jsx("path",{d:j.d,"data-i2":j.i2||void 0})},E))}),e.jsx("g",{children:w.map(j=>{const E=tt[at(j.d)],I=!!Y(j.d),L=j.d.kind==="target",M=r&&L?mt[X(j.d)]:E.c,R=!r&&Q(j.d);return e.jsxs("g",{className:"co"+(R?" done":""),onMouseEnter:()=>{var B,_;const T=(B=g.current)==null?void 0:B.getBoundingClientRect(),P=(_=p.current)==null?void 0:_.createSVGPoint();if(P&&p.current&&T){P.x=j.x,P.y=j.y;const re=P.matrixTransform(p.current.getScreenCTM());h({x:re.x-T.left,y:re.y-T.top,label:j.d.name+" · "+(ve(j.d.cc,u)||j.d.countryLabel||"")})}l(j.d.id)},onMouseLeave:()=>{h(null),l(null)},onClick:()=>{var B;const T=(B=p.current)==null?void 0:B.createSVGPoint();let P=null;if(T&&p.current){T.x=j.x,T.y=j.y;const _=T.matrixTransform(p.current.getScreenCTM());P={x:_.x,y:_.y}}a({type:"popup",id:j.d.id,anchor:P})},children:[e.jsx("circle",{className:"h",cx:j.x,cy:j.y,r:k(Math.max(11,E.px+7))}),e.jsx("circle",{className:"v",cx:j.x,cy:j.y,r:k(E.px),fill:M,stroke:I?"#DC2626":"#ffffff",strokeWidth:k(I?2.2:1.3)})]},j.d.id||j.d.name)})}),F&&e.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:k(13),fill:"none",stroke:"#0F172A",strokeWidth:k(2)})]}),e.jsx("div",{className:"hov"+(x?" on":""),style:x?{left:x.x,top:x.y}:void 0,children:x==null?void 0:x.label}),e.jsx("div",{className:"legend",children:C.map((j,E)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":j.c}}),u==="fr"?j.fr:j.en," ",e.jsx("b",{children:j.n})]},E))}),n.some(j=>!j.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",f.notLocated," ",e.jsx("b",{children:n.filter(j=>!j.cc).length})]})})]})}function vr(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:l,contName:o}=S(),i=t.filters,u=c.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),f=b=>u.filter(m=>b!=="country"&&i.country.length&&!i.country.includes(m.cc||"")?!1:Ye(m,i,l,b==="country"?void 0:b)),p=c.useMemo(()=>{const b=f("win"),m=x=>b.filter(h=>(h.date?Math.max(0,Math.floor((Date.now()-Date.parse(h.date))/864e5)):9999)<=x).length;return[m(0),m(7),m(30),b.length]},[u,i,l]),g=c.useMemo(()=>{if(l)return null;const b=f("status"),m={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(x=>{m[se(x)]+=1}),m},[u,i,l]),s=i.sector.length+i.country.length+i.engine.length+i.stage.length+i.angle.length+i.memoLevel.length+(i.signalOnly?1:0)+(i.win!=="all"?1:0)+(!l&&i.status!=="all"?1:0)+(i.search.trim()?1:0),v=(b,m,x,h="fbtn")=>e.jsxs("button",{type:"button",className:h,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:m}),x>0&&e.jsx("span",{className:"n",children:x}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,m)=>e.jsxs("button",{type:"button","aria-pressed":i.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[m],e.jsx("b",{children:p[m]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:i.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!l&&g&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,m])=>e.jsxs("button",{type:"button","aria-pressed":i.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[m,e.jsx("b",{children:g[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),i.signalOnly&&e.jsx("span",{className:"n",children:i.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,i.sector.length),v("pay",r.fCountry,i.country.length),v("det",r.fEngine,i.engine.length),v("sta",r.fStage,i.stage.length),l&&v("ang","Angle",i.angle.length),l&&v("mem","Mémo",i.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(u.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(yr,{poolFor:f})]})}function yr({poolFor:t}){const{st:a,dispatch:n,t:r,lang:l}=S(),o=a.filters,i=a.openFacet,{title:u,cols:f,options:p}=c.useMemo(()=>{if(i==="sig"){const m=t("signal").filter(d=>Y(d)),x=new Map;m.forEach(d=>{const N=d.engine||"";x.set(N,(x.get(N)||0)+1)});const h=[{v:"*",label:r.fpSigAll,n:m.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...rt([...x.keys()],l).map(d=>({v:d,label:he(d)+" "+oe(d,l),n:x.get(d)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(d)}))];return{title:r.fpSigTitle,cols:2,options:h}}if(i==="sec"){const m=t("sector"),x=new Map;return m.forEach(h=>{h.sector&&x.set(h.sector,(x.get(h.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...x.entries()].sort((h,d)=>d[1]-h[1]).map(([h,d])=>({v:h,label:h,n:d,html:!1,on:o.sector.includes(h)}))}}if(i==="pay"){const m=t("country"),x=new Map;return m.forEach(h=>{h.cc&&x.set(h.cc,(x.get(h.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...x.entries()].sort((h,d)=>d[1]-h[1]).map(([h,d])=>({v:h,label:ve(h,l)||h,n:d,html:!1,on:o.country.includes(h)}))}}if(i==="det"){const m=t("engine"),x=new Map;return m.forEach(h=>{h.engine&&x.set(h.engine,(x.get(h.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:rt([...x.keys()],l).map(h=>({v:h,label:he(h)+" "+oe(h,l)+' <span style="color:var(--dim);font-size:10px">· '+ia(sa(h),l)+"</span>",n:x.get(h)||0,html:!0,on:o.engine.includes(h)}))}}if(i==="ang"){const m=t("angle"),x=new Map;return m.forEach(h=>{h.angle&&x.set(h.angle,(x.get(h.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...x.entries()].sort((h,d)=>d[1]-h[1]).map(([h,d])=>({v:h,label:h.replace(/[_-]+/g," "),n:d,html:!1,on:o.angle.includes(h)}))}}if(i==="mem"){const m=t("memoLevel"),x=new Map;m.forEach(d=>{if(d.kind==="target"){const N=Ve(d);x.set(N,(x.get(N)||0)+1)}});const h=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(d=>({v:String(d),label:h[d],n:x.get(d)||0,html:!1,on:o.memoLevel.includes(d)}))}}const v=t("stage"),b=new Map;return v.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,x)=>x[1]-m[1]).map(([m,x])=>({v:m,label:m,n:x,html:!1,on:o.stage.includes(m)}))}},[i,a,l]),g=v=>{if(i==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const m=o.signalEngines.includes(v)?o.signalEngines.filter(x=>x!==v):[...o.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(i==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage",value:v})},s=()=>{n(i==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:i==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:u}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(f===2?" two":""),children:p.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>g(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const gt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function wr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:l,dispatch:o,evalBusy:i,evalCards:u,caps:f,data:p}=S(),g=a==="client",[s,v]=c.useState(""),[b,m]=c.useState(!1),[x,h]=c.useState(""),[d,N]=c.useState(!1),[w,k]=c.useState(""),[C,z]=c.useState([]),F=c.useRef(!1),j=s.trim()?gt.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,E=c.useMemo(()=>x.split(`
`).map(T=>T.trim()).filter(Boolean).slice(0,15),[x]),I=C.length?C:u,L=p.credits,M=()=>{const T=s.trim();T&&(r(null,T),v(""))},R=async()=>{if(!g){r(null,E[0]||"");return}if(!E.length||d)return;N(!0),F.current=!1;const T=[];for(let P=0;P<E.length&&!F.current;P++){k(t.evaluating(P+1,E.length,E[P]));const B=await Ct(n,E[P],"atelier2");if(T.unshift({name:B.company||E[P],verdict:B.verdict,reason:B.reason||"",remaining:B.remaining??null}),z([...T]),B.verdict==="quota"){T.unshift({name:"",verdict:"quota",reason:t.quota(E.length-P-1),remaining:0}),z([...T]);break}}k(""),h(""),N(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:T=>v(T.target.value),onKeyDown:T=>{T.key==="Enter"&&M()}}),e.jsx("span",{className:"detect"+(gt.test(s.trim())?" url":""),children:j})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),disabled:i,onClick:M,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),f.showCredits&&L&&e.jsxs("button",{type:"button",className:"credits"+(L.total_available<=0&&!L.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:L.unlimited?"∞":L.total_available}),!L.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",L.daily_grant+L.purchased]}),L.total_available<=0&&!L.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>m(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:x,placeholder:t.bulkPh,onChange:T=>h(T.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{justifyContent:"center"},disabled:d||!E.length,onClick:()=>{R()},children:[e.jsx("span",{className:"fill"}),d&&w?w:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(E.length)})]})]}),I.slice(0,1).map((T,P)=>{const B=T.verdict==="kept",_=T.verdict==="quota",re=B?"var(--brand)":_?"var(--bolt)":"var(--red)",de=B?"var(--brand-l)":_?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":re,"--bgc":de},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:B?"✓ "+t.kept:_?"⏳":"✗ "+t.dropped})}),T.name&&e.jsx("span",{className:"rn",children:T.name}),e.jsx("span",{className:"rr",children:T.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",T.reason]}):null}),!_&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(B?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},P)}),g&&(l.kept+l.dropped>0||I.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(l.kept,l.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function kr(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function jr(){const{st:t,dispatch:a,byId:n,t:r,doDeep:l}=S(),o=t.memoConsole?n.get(t.memoConsole):null,i=c.useMemo(()=>o?[o.reasoning||"",kr(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const u=Re(o),f=Ve(o);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:o.name}),u&&e.jsx("span",{className:"vv",children:u}),typeof o.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:r.memoSynth})}),e.jsx("div",{className:"mb2",children:i?i.split(`

`).map((p,g)=>e.jsx("p",{style:{margin:"0 0 10px"},children:p},g)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[_e(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>l(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:f===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}function Lt({name:t}){const{t:a,token:n,caps:r,mode:l,flashErr:o}=S(),[i,u]=c.useState(!1),[f,p]=c.useState(null);if(!r.pipe||l!=="client"||r.lockActions)return null;const g=async()=>{if(i)return;u(!0);const s=await da(n,t);if(u(!1),!s){o(a.actErr);return}p(s.results||[])};return e.jsxs("div",{className:"simb",onClick:s=>s.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{g()},children:i?a.similarBusy:a.similar}),f&&(f.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:f.map(s=>e.jsxs("li",{children:[e.jsx("b",{className:s.verdict==="kept"?"ok":"ko",children:s.company}),s.reason&&e.jsx("span",{children:s.reason})]},s.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Ot={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ge({o:t}){const{t:a}=S(),n=Fe(t),r=Re(t),l=X(t),o=Ie(t),i=ca(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(Ot[r]||"v-cons"),title:a.vt[r],children:r}):l===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,l===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),l===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),l===3&&i!==null&&e.jsx("span",{className:"wait2 "+(i>10?"hot":i>=5?"warm":""),title:a.waitTitle(i),children:a.waitChip(i)})]})}function ht({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:l}=S(),[o,i]=c.useState(!1);if(c.useEffect(()=>{r||i(!1)},[r]),Q(t)){const p=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":p?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[p?"✓":"✗"," ",e.jsx("b",{children:p?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const f=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(f?" loading":""),disabled:r,onClick:p=>{p.stopPropagation(),i(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function Nr({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:l,doAnalyse:o,doDecide:i,doPromote:u,doRepeche:f,doApproach:p,dispatch:g}=S();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),g({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(ht,{o:t})});const s=X(t),v=b=>m=>{m.stopPropagation(),b()};if(s===0)return e.jsx("span",{className:"cell",children:e.jsx(ht,{o:t})});if(s===1){const b=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:v(()=>o(t)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(s===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:v(()=>i(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:v(()=>i(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>g({type:"memoConsole",id:t.id})),children:"📄"})]})});if(s===4){const b=l.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:b,onClick:v(()=>p(t)),children:b?a.actApproachSent:a.actApproach})})}return s===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>u(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>g({type:"memoConsole",id:t.id})),children:"📄"})]})}):s===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>f(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>g({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:v(()=>g({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function Cr({o:t}){const{t:a,doThumb:n,thumbOf:r}=S(),l=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(l==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(l==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function Sr({o:t}){const{lang:a}=S();return Y(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(ye,{o:t}),e.jsx(Me,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[he(t.engine||"")," ",oe(t.engine||"",a)]})})}function zr({o:t,locked:a,open:n,onToggle:r}){const{st:l,dispatch:o,caps:i,markRow:u,markedId:f,favIds:p,toggleFav:g}=S(),s=X(t),v=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,m=b<=0?0:b<=7?1:b<=30?2:3,x=i.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][s]:v[m],h=p.has(t.id),d=N=>{if(a)return;if(i.pipe){r();return}const w=N.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:w.left+Math.min(280,w.width/3),y:w.bottom}})};return e.jsxs(c.Fragment,{children:[e.jsxs("div",{className:"row"+(f===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>u(t.id),onMouseLeave:()=>u(null),onClick:d,children:[e.jsx("span",{className:"pt",style:{"--c":x}}),e.jsx(Rt,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[i.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:h?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),g(t)},children:h?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(N=>N&&N!==t.name)||""})]}),e.jsx(Er,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(Sr,{o:t}),i.pipe&&e.jsx(Ge,{o:t}),i.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(Nr,{o:t}),i.showThumbs&&e.jsx(Cr,{o:t})]}),(n||l.dens==="deplie")&&!a&&e.jsx(Tr,{o:t})]})}function Er({o:t}){const{lang:a,caps:n}=S();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=He(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function Tr({o:t}){const{t:a,lang:n,dispatch:r,caps:l,outbound:o,doOnboard:i}=S();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),t.reasoning&&e.jsxs("div",{className:"dec"+(Fe(t)==="NO MATCH"?" out":""),title:t.reasoning,children:[e.jsx("em",{children:Fe(t)==="NO MATCH"?a.vOut:a.vKept}),t.reasoning.length>340?`${t.reasoning.slice(0,340)}…`:t.reasoning]}),t.ceoNote&&e.jsxs("div",{className:"ceonote",children:["💬 ",e.jsx("i",{children:t.ceoNote})]}),e.jsx(or,{o:t}),e.jsx(sr,{o:t}),e.jsx(Lt,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(Ge,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[he(t.engine||"")," ",oe(t.engine||"",n)]}),Y(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(ye,{o:t})})]}),l.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>i(t),children:a.actOnboard})]})]})]})}function Ar({o:t,locked:a}){const{t:n,dispatch:r,caps:l,doDecide:o}=S(),i=X(t),u=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][i];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":u},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(Ge,{o:t}),Y(t)&&e.jsx(ye,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&l.pipe&&i===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function Lr(){const t=S(),{st:a,dispatch:n,t:r,caps:l,scoped:o,lang:i,sessTally:u}=t,[f,p]=c.useState(new Set);c.useEffect(()=>{p(new Set)},[a.ptab,a.continent]);const g=w=>p(k=>{const C=new Set(k);return C.has(w)?C.delete(w):C.add(w),C}),s=c.useMemo(()=>We(o,a.sort),[o,a.sort]),v=c.useMemo(()=>s.filter(w=>Y(w)&&!Q(w)).length,[s]),b=l.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,m=(w,k,C="",z=!1)=>e.jsxs("button",{type:"button","data-s":w,className:C,"aria-sort":a.sort.key===w?a.sort.dir===1?"ascending":"descending":"none",style:z?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:w}),children:[k,e.jsx("span",{className:"ar",children:a.sort.key===w&&a.sort.dir===1?"▴":"▾"})]},w),x=c.useMemo(()=>{if(l.pipe||a.groupBy==="none")return null;const w=new Map;return s.forEach(k=>{const C=k.engine||"?";w.has(C)||w.set(C,[]),w.get(C).push(k)}),[...w.entries()]},[s,l.pipe,a.groupBy]),h=l.lockRowsAfter;let d=0;const N=(w,k)=>{const C=a.shown[k]||Oe,F=w.slice(0,C).map(j=>{const E=h!==null&&d>=h;return d++,a.dens==="maxi"?e.jsx(Ar,{o:j,locked:E},j.id):e.jsx(zr,{o:j,locked:E,open:f.has(j.id),onToggle:()=>g(j.id)},j.id)});return w.length>C&&F.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:k,by:Oe}),children:r.more(Math.min(Oe,w.length-C),w.length-C)},k+":more")),F};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:s.length})," ",b]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,l.pipe&&t.fund?" · "+t.fund:""]}),l.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),l.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([w,k])=>e.jsxs("button",{type:"button","data-d":w,"aria-pressed":a.dens===w,onClick:()=>n({type:"dens",dens:w}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:k})]},w))}),l.showChain&&s.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:s.filter(w=>l.pipe?!0:!Q(w)).map(w=>w.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",l.pipe?r.browse(s.length):r.chainAll(s.filter(w=>!Q(w)).length)]})]}),v>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(v)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),m("country",r.colCountry),m("name",r.colCompany),m("amount",r.colAmount,"h-amt",!0),m("stage",r.colStage,"h-stade"),m("signal",r.colSignal,"h-sig"),l.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),l.pipe&&m("score",r.colScore,"h-sc",!0),e.jsx("span",{}),l.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[x?x.map(([w,k])=>e.jsxs(c.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:he(w)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:oe(w,i)}),e.jsx("div",{className:"s",children:r.grpCount(k.filter(C=>!Q(C)).length,k.length)})]})]}),N(k,w)]},w)):N(s,"pt"+a.ptab),!s.length&&e.jsx("div",{className:"void",children:l.pipe?r.emptyTab:r.emptyScope})]}),l.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(u.kept>0||u.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(u.kept,u.dropped)}})]})}const Or=`
...
`;function Fr(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,l=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let i=t.y+10;return i+n>l-8&&(i=Math.max(8,t.y-n-14)),i<8&&(i=8),{left:o,top:i}}function Rr(){const{st:t,dispatch:a,byId:n,t:r,lang:l,caps:o,mode:i,askEvaluate:u,doAnalyse:f,doDecide:p,doPromote:g,doRepeche:s,doApproach:v,doDeep:b,doOnboard:m,outbound:x,evalBusy:h}=S(),d=t.popupId?n.get(t.popupId):null;if(!d)return null;const N=Y(d),w=X(d),k=Re(d),C=d.kind==="target",z=F=>{a({type:"filters",patch:F}),a({type:"popup",id:null})};return Ce.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Or}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Fr(t.popupAnchor),onClick:F=>F.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:d.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(be(d.date)),oe(d.engine,l))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[d.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>z({country:[d.cc]}),children:(ve(d.cc,l)||d.countryLabel||"").toUpperCase()}),d.sector&&e.jsx("button",{type:"button",onClick:()=>z({sector:[d.sector]}),children:d.sector.toUpperCase()}),d.stage&&e.jsx("button",{type:"button",onClick:()=>z({stage:[d.stage]}),children:d.stage.toUpperCase()}),typeof d.amountEur=="number"&&d.amountEur>0&&e.jsx("span",{className:"am2",children:He(d.amountEur,l)})]}),(d.tagline||d.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:d.tagline||d.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[he(d.engine)," ",e.jsx("b",{children:oe(d.engine,l)})," — ",pa(d.engine,l),d.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",d.noteTitle]})]}),N?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(ye,{o:d,lg:!0})," ",e.jsx(Me,{o:d,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(St(N,l))," · ",r.win7(zt(N,l))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),d.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&w>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:d.reasoning})]}),o.pipe&&C&&k&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[k,typeof d.score=="number"&&d.score>0?" · "+r.score(d.score):""]})})]}),e.jsx(Lt,{name:d.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||i!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[w===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:h,onClick:()=>u(d),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),w===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{f(d),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),w===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(d),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),w===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(d,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{p(d,!1),a({type:"popup",id:null})},children:r.actNo}),_e(d)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{b(d),a({type:"popup",id:null})},children:r.memoDeep})]}),w===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{v(d),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),w===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(d),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),d.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:d.id}),a({type:"popup",id:null})},children:"📄"}),x&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{m(d),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:h,onClick:()=>u(d),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),d.website&&e.jsx("a",{className:"psite",href:d.website.startsWith("http")?d.website:"https://"+d.website,target:"_blank",rel:"noopener noreferrer",title:d.website,children:"🌐"})]})]})]}),document.body)}function bt(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Mr(t,a){const n=ua(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function Dr(t,a){const r=[a.head.split("|").map(bt).join(";")];for(const l of t){const o=a.stageOf(l);r.push([l.name||"",Mr(l,a.plabels),Fe(l)||l.verdict||"",typeof l.score=="number"?l.score:"",l.countryLabel||l.cc||"",l.sector||"",o?a.stageLabel(o.stage):"",l.contactName||"",l.contactEmail||"",l.memoUrl||"",(l.date||"").slice(0,10),(l.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(bt).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function qr(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const Pr=50;function Ke({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:l}=S(),[o,i]=c.useState(null),[u,f]=c.useState(!1),[p,g]=c.useState(""),[s,v]=c.useState(0),[b,m]=c.useState(""),[x,h]=c.useState(!1),d=c.useRef(null);c.useEffect(()=>()=>{d.current&&window.clearInterval(d.current)},[]);const N=async k=>{f(!0),g("");const C=await a();if(f(!1),C.ok){i(C);return}if(C.busy){g(l.alertPreviewBusy);return}if(!k){g(l.alertPreviewFail);return}v(Pr),d.current=window.setInterval(()=>{v(z=>z>1?z-1:(d.current&&window.clearInterval(d.current),N(!1),0))},1e3)},w=async()=>{if(r||x)return;h(!0),m("");const k=await n();h(!1),m(k.ok?l.alertTestOk(k.sentTo||""):k.error||l.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:u||s>0,onClick:()=>{N(!0)},children:u?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||x,onClick:()=>{w()},children:x?"…":l.alertTest})]}),s>0&&e.jsx("p",{className:"mnote",children:l.alertPreviewRetry(s)}),p&&e.jsx("p",{className:"mnote warn",children:p}),b&&e.jsx("p",{className:"mnote",children:b}),!b&&e.jsx("p",{className:"mnote dim",children:l.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:l.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:l.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Ne="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function J({title:t,icon:a,children:n,wide:r}){const{dispatch:l}=S();return Ce.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&l({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>l({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function Br(){const{st:t}=S();switch(t.modal){case"chain":return e.jsx($r,{});case"space":return e.jsx(Vr,{});case"alert":return e.jsx(Ur,{});case"queue":return e.jsx(Gr,{});case"export":return e.jsx(Kr,{});case"plug":return e.jsx(Xr,{});case"recharge":return e.jsx(en,{});case"cover":return e.jsx(tn,{});case"crit":return e.jsx(an,{});case"tuto":return e.jsx(rn,{});case"rdv":return e.jsx(Ir,{});case"memoalert":return e.jsx(Qr,{});default:return null}}function Ir(){const{dispatch:t,fund:a}=S(),n=typeof document<"u"&&!!document.getElementById("rdv");return c.useEffect(()=>{n&&(t({type:"modal",modal:null}),er())},[n,t]),n?null:e.jsx(xa,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function $r(){const{st:t,dispatch:a,byId:n,t:r,lang:l,mode:o,askEvaluate:i,evalBusy:u}=S(),f=o==="client",p=t.chain.queue.map(b=>n.get(b)).filter(b=>!!b),g=t.chain.idx,s=p[g],v=g>=p.length;return Ce.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:v?r.finished:`${g+1} / ${p.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(v?100:g/Math.max(1,p.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:v||!s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(p.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:s.name}),e.jsx("div",{className:"sub",children:[ve(s.cc,l)||s.countryLabel,s.sector,s.stage,r.daysAgo(be(s.date))].filter(Boolean).map(b=>String(b).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:oe(s.engine,l).toUpperCase()}),typeof s.amountEur=="number"&&s.amountEur>0&&e.jsx("span",{children:He(s.amountEur,l)})]}),Y(s)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(ye,{o:s,lg:!0})," ",e.jsx(Me,{o:s,src:!0})]}),(s.tagline||s.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:s.tagline||s.headline})]}),s.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:s.reasoning})]}),f&&Q(s)&&e.jsxs("div",{className:"vbox",style:{"--c":se(s)==="retenu"?"var(--brand)":se(s)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:se(s)==="retenu"?"✓ "+r.kept:se(s)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:s.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!v&&s&&!(f&&Q(s))&&e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:u,onClick:()=>{i(s)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?r.closeBtn:r.skip})]})]})})}),document.body)}function Vr(){const{st:t,dispatch:a,dossiers:n,t:r,mode:l}=S(),o=l==="client",i=c.useMemo(()=>o?n.filter(s=>Q(s)):[],[n,o]),u=c.useMemo(()=>We(i.filter(s=>se(s)==="retenu"),{key:"signal",dir:-1}),[i]),f=c.useMemo(()=>i.filter(s=>se(s)==="ecarte"),[i]),p=t.spaceTab==="retenu"?u:f,g=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(J,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:u.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:f.length})]})]}),p.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),p.slice(0,40).map(s=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":g},children:typeof s.score=="number"&&s.score>0?s.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:s.name}),e.jsx("div",{className:"rr",children:s.reasoning||s.tagline||""})]})]},s.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function Ur(){const{mode:t}=S();return t==="client"||t==="apercu"?e.jsx(_r,{}):e.jsx(Wr,{})}function _r(){const{t,token:a,flash:n,flashErr:r,mode:l}=S(),[o,i]=c.useState("d"),u=l!=="client";return e.jsxs(J,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>i("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>i("w"),children:t.alertTabWeekly})]}),o==="d"?e.jsx(Hr,{t,token:a,readOnly:u,flash:n,flashErr:r}):e.jsx(Yr,{t,token:a,readOnly:u,flash:n,flashErr:r})]})}function Hr({t,token:a,readOnly:n,flash:r,flashErr:l}){const[o,i]=c.useState(null),[u,f]=c.useState(!1),[p,g]=c.useState(0);c.useEffect(()=>{let m=!0;return f(!1),it(a).then(x=>{m&&(x?i(x):f(!0))}),()=>{m=!1}},[a,p]);const s=m=>{n||it(a,m).then(x=>{if(!x){l(t.actErr);return}i(x),x.throttled?l(t.alertThrottled):r(t.alertSaved)})};if(u)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>g(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=m=>!o.sections||o.sections.includes(m),b=m=>{const x=o.sections||t.alertSec.map(([h])=>h);s({sections:v(m)?x.filter(h=>h!==m):[...x,m]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([m,x])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:v(m),disabled:n,onChange:()=>b(m)}),e.jsxs("span",{children:[x,m==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},m))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(Ke,{label:t.alertPreview,readOnly:n,onPreview:()=>ya(a),onTest:()=>va(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Yr({t,token:a,readOnly:n,flash:r,flashErr:l}){const[o,i]=c.useState(null),[u,f]=c.useState(!1),[p,g]=c.useState(0);c.useEffect(()=>{let m=!0;return f(!1),st(a).then(x=>{m&&(x?i(x):f(!0))}),()=>{m=!1}},[a,p]);const s=m=>{n||st(a,m).then(x=>{if(!x){l(t.actErr);return}i(x),r(t.alertSaved)})};if(u)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>g(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=o.dow??0,b=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:v,disabled:n,onChange:m=>s({dow:Number(m.target.value)}),children:t.alertDow.map((m,x)=>e.jsx("option",{value:x,children:m},m))}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,b-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[b," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,b+1)}),disabled:n,children:"＋"})]})]}),e.jsx(Ke,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>ka(a),onTest:()=>wa(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Wr(){const{st:t,t:a,lang:n,scoped:r,contName:l}=S(),[o,i]=c.useState(""),[u,f]=c.useState(!1),[p,g]=c.useState(!1),s=t.filters,v=c.useMemo(()=>r.filter(h=>Y(h)).length,[r]),b=s.win==="1"?0:s.win==="7"?1:s.win==="30"?2:3,m=async()=>{if(!(!/.+@.+\..+/.test(o)||p)){g(!0);try{await fetch(`${$e}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o.trim(),sectors:s.sector,countries:s.country,source:"atelier2",website:""})}),f(!0)}finally{g(!1)}}},x=[[a.amRows.continent,l],[a.amRows.since,a.amSince[b]],[a.amRows.signal,s.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,s.engine.length?s.engine.map(h=>oe(h,n)).join(", "):a.amAllEngines],[a.amRows.sectors,s.sector.length?s.sector.join(", "):a.amAllSectors],[a.amRows.countries,s.country.length?s.country.map(h=>ve(h,n)||h).join(", "):a.amAllCountries],[a.amRows.stages,s.stage.length?s.stage.join(", "):a.amAllStages]];return e.jsx(J,{title:a.alertTitle,icon:"🔔",children:u?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(o)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:x.map(([h,d])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:h}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:d}})]},h))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:o,onChange:h=>i(h.target.value),onKeyDown:h=>{h.key==="Enter"&&m()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void m(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function Gr(){var x,h,d;const{t,token:a,fund:n,mode:r,flash:l}=S(),[o,i]=c.useState(null),[u,f]=c.useState([]),[p,g]=c.useState(0),s=r==="client";c.useEffect(()=>{let N=!0;return(async()=>{const[w,k]=await Promise.all([kt(n),jt(a)]);N&&(w&&i(w),f(k))})(),()=>{N=!1}},[a,n,p]);const v=(o==null?void 0:o.per_day)??2,b=((x=o==null?void 0:o.analyzed_today)==null?void 0:x.length)??0,m=(h=o==null?void 0:o.tomorrow)!=null&&h.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(J,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(b,b+(((d=o==null?void 0:o.pool_order)==null?void 0:d.length)??0))}})}),e.jsx("div",{className:"qrate",children:t.queueRate}),e.jsx("div",{className:"qrates",children:[1,2,3,5,10].map(N=>e.jsx("button",{type:"button",className:"qr"+(v===N?" on":""),disabled:!s,onClick:()=>{Nt(a,N).then(w=>{w!==null&&(g(k=>k+1),l(t.alertSaved))})},children:e.jsxs("b",{children:[N,"/j"]})},N))})]}),u.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:u.map(N=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:N.company}),e.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),e.jsx("span",{className:"qt",children:N.status}),N.url&&e.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),s&&N.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{lt(a,N.company,"retry").then(()=>g(w=>w+1))},children:t.queueRetry}),s&&N.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{lt(a,N.company,"delete").then(()=>g(w=>w+1))},children:t.queueDelete})]},N.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[m.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),m.slice(0,10).map((N,w)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",w+1]}),e.jsx("b",{children:N.name}),typeof N.score=="number"&&e.jsx("span",{className:"qs2",children:N.score})]},N.name))]})]})}function Kr(){const{t,token:a,flash:n,scoped:r,caps:l,stageOf:o}=S(),i=`${Ne}/cibles/list.csv?token=${a}`,u=`${Ne}/cibles/list.json?token=${a}`,f=`${Ne}/cibles/export.xlsx?token=${a}&scope=full`,p=`=IMPORTDATA("${i}")`,g=m=>{var x;(x=navigator.clipboard)==null||x.writeText(m).then(()=>n(t.exportCopied))},s=[{def:t.exportCsv,value:i,href:i},{def:t.exportSheet,value:p},{def:t.exportLive,value:u,href:u},{def:t.exportXlsx,value:f,href:f}],v=!l.lockActions&&r.length>0,b=()=>{qr(Dr(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:m=>(t.stg.find(([x])=>x===m)||["",""])[1]})),n(t.exportViewDone(r.length))};return e.jsxs(J,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:b,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:s.map(({def:m,value:x,href:h})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:m[0]}),e.jsxs("div",{children:[e.jsx("b",{children:m[1]}),e.jsx("p",{children:m[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>g(x),children:t.exportCopy}),h&&e.jsx("a",{className:"exb",href:h,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},m[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function Qr(){const{t,token:a,flash:n,flashErr:r,mode:l}=S(),o=l!=="client",[i,u]=c.useState(null),[f,p]=c.useState(!1),[g,s]=c.useState(0),[v,b]=c.useState(!1);c.useEffect(()=>{let d=!0;return p(!1),nt(a).then(N=>{d&&(N?u(N):p(!0))}),()=>{d=!1}},[a,g]);const m=()=>(i==null?void 0:i.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},x=d=>{if(o||!i)return;const N={enabled:d.enabled??!!i.enabled,email:d.email??(i.email||""),sections:d.sections??m()};b(!0),nt(a,N).then(w=>{if(b(!1),!w){r(t.memoAlertErr);return}u(w),n(t.memoAlertSaved)})};if(f)return e.jsx(J,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>s(d=>d+1),children:t.retry})]})});if(!i)return e.jsx(J,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const h=m();return e.jsxs(J,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:o||v,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),e.jsx(Jr,{value:i.email||"",readOnly:o||v,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:d=>x({email:d})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([d,N])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!h[d],disabled:o||v,onChange:()=>x({sections:{...h,[d]:!h[d]}})}),e.jsx("span",{children:N})]},d))}),e.jsx(Ke,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>ma(a,h),onTest:()=>fa(a,h)})]})}function Jr({value:t,readOnly:a,label:n,okLabel:r,onSave:l}){const[o,i]=c.useState(t);c.useEffect(()=>{i(t)},[t]);const u=o.trim()!==t.trim(),f=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&u&&f&&l(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!u||!f,onClick:()=>l(o.trim()),children:r})]})]})}function Xr(){const{t,token:a,flash:n,flashErr:r,canWrite:l}=S(),[o,i]=c.useState(null),[u,f]=c.useState(!1),[p,g]=c.useState(null),[s,v]=c.useState(""),[b,m]=c.useState(0);c.useEffect(()=>{let d=!0;return f(!1),ot(a).then(N=>{d&&(N?i({configured:N.configured,url_hint:N.url_hint}):f(!0))}),ha(a).then(N=>{d&&g(N)}),()=>{d=!1}},[a,b]);const x=(d,N)=>{l&&ot(a,d).then(w=>{if(!w||w.ok===!1){r(t.actErr);return}d.test&&w.sent===!1?r(t.plugTestThrottled):n(N),m(k=>k+1)})},h='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(J,{title:t.plugTitle,icon:"🔌",wide:!0,children:[p&&e.jsx("p",{className:"mnote"+(p.enabled?" warn":""),children:p.enabled?t.plugAutoOn(p.destination||"webhook"):t.plugAutoOff}),u?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>m(d=>d+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:s,disabled:!l,onChange:d=>v(d.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!l||!s.trim(),onClick:()=>x({url:s.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!l,onClick:()=>x({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!l,onClick:()=>x({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(Zr,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:h}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var d;(d=navigator.clipboard)==null||d.writeText(h).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function Zr(){const{t,token:a}=S(),[n,r]=c.useState("valides"),[l,o]=c.useState(!1),[i,u]=c.useState(null),f=async()=>{o(!0),u(await ba(a,n)),o(!1)};return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:n,onChange:p=>r(p.target.value),children:t.plugBulkTabs.map(([p,g])=>e.jsx("option",{value:p,children:g},p))}),e.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{f()},children:l?"…":t.plugBulkPreview})]}),i&&(i.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(i.ready||0,i.linkedinReady||0,(i.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr}))]})}function en(){const{t,data:a,lang:n}=S(),r=a.credits,l=a.email,o=async i=>{if(!l)return;const u=window.location.href.split("?")[0];try{const p=await(await fetch(`${$e}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l,lookup_key:i,success_url:u+"?credits=ok",cancel_url:u+"?credits=cancel"})})).json();p.url&&(window.location.href=p.url)}catch{}};return e.jsxs(J,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(i=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(i.credits,i.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(i.lookup_key)},children:t.rechargeBuy})]},i.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function tn(){const{t,data:a,dossiers:n}=S(),r=n.filter(o=>o.kind==="target"&&Q(o)).length,l=a.marketEstimate||0;return e.jsx(J,{title:t.coverTitle,icon:"🌍",children:l>0?e.jsx("p",{dangerouslySetInnerHTML:{__html:t.coverBody(r,l)}}):e.jsx("p",{children:t.coverScreened(r)})})}function an(){var d,N,w;const{t,dossiers:a,token:n,mode:r,flash:l,criteria:o}=S(),i=r==="client",u=c.useMemo(()=>{const k=new Set;return a.forEach(C=>{C.angle&&k.add(C.angle)}),[...k]},[a]),[f,p]=c.useState(null);c.useEffect(()=>{let k=!0;return ga(n).then(C=>{k&&p(C.thumbs)}),()=>{k=!1}},[n]);const[g,s]=c.useState(""),[v,b]=c.useState(""),[m,x]=c.useState(!1),h=async()=>{const k=g.trim();if(!(!k||m||!i)){x(!0),b("");try{const z=await(await fetch(`${Ne}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:k,who:"atelier2"})})).json().catch(()=>({}));if(z.reply&&b(String(z.reply)),z.job_id){b(t.critChatRunning);const F=async()=>{const j=await fetch(`${Ne}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:z.job_id})}).then(E=>E.json()).catch(()=>null);if(j&&j.done){b(String(j.reply||j.clarification||j.summary||"✓")),x(!1),j.applied&&l(t.alertSaved);return}setTimeout(()=>{F()},8e3)};setTimeout(()=>{F()},8e3),s("");return}s("")}finally{v.startsWith("⏳")||x(!1)}}};return e.jsxs(J,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((d=o.points)!=null&&d.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(k=>e.jsx("li",{children:k},k))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((N=o==null?void 0:o.angles)!=null&&N.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(k=>{var C,z;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:k.title}),k.why&&e.jsx("p",{className:"why",children:k.why}),e.jsxs("div",{className:"lo",children:[!!((C=k.look)!=null&&C.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:k.look.map(F=>e.jsx("li",{children:F},F))})]}),!!((z=k.out)!=null&&z.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:k.out.map(F=>e.jsx("li",{children:F},F))})]})]})]},k.title)})]}),!!((w=o==null?void 0:o.gate)!=null&&w.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(k=>e.jsxs("li",{children:[k.k&&e.jsx("b",{children:k.k}),k.t]},k.t))})]}),u.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:u.map(k=>e.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:g,disabled:!i||m,onChange:k=>s(k.target.value),onKeyDown:k=>{k.key==="Enter"&&h()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!i||m||!g.trim(),onClick:()=>void h(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),v&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:v})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),f===null?e.jsx("div",{className:"sp-empty",children:"…"}):f.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:f.slice(0,12).map((k,C)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:k.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:k.company}),e.jsx("span",{className:"qd",children:(k.ts||"").slice(0,10)})]},C))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([k,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Ot[k]||"v-cons"),children:k}),e.jsx("span",{children:C})]},k))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([k,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:k}),e.jsxs("span",{children:["← ",C]})]},k))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function rn(){const{t,dispatch:a,startTour:n}=S(),r=l=>{var o,i;a({type:"modal",modal:null}),l==="crit"||l==="plug"||l==="alert"?a({type:"modal",modal:l}):l.startsWith("tab")?a({type:"ptab",tab:Number(l.slice(3))}):l==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(i=document.querySelector(".atl2 .demand input"))==null||i.focus())};return e.jsxs(J,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([l,o],i)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:u=>{(u.key==="Enter"||u.key===" ")&&(u.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:i+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:l.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+i))})]})}const Ft=c.createContext(null),S=()=>{const t=c.useContext(Ft);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function ye({o:t,lg:a}){const{lang:n}=S(),r=Y(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:dt(r,n),children:[r.emoji," ",dt(r,n)]}):null}function Me({o:t,src:a}){const{lang:n,t:r}=S(),l=Y(t);if(!l)return null;const o=za(l),i=Ea(l);return e.jsxs("em",{className:"sigwin"+(i?" hot":""),title:r.signaledOn(St(l,n))+" · "+r.win7(zt(l,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(u,f)=>e.jsx("i",{className:f<o?"on":""},f))}),e.jsx("span",{className:"lb",children:i?r.lastDay:r.daysLeft(Math.max(0,l.left??0))}),a&&l.url&&e.jsx("a",{href:l.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:u=>u.stopPropagation(),children:"↗"})]})}function Rt({o:t}){const{lang:a}=S(),n=Sa(t.cc),r=t.cc?ve(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const vt="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Mt=t=>`atl2:tour:${t||"anon"}`;function nn(t){try{return localStorage.getItem(Mt(t))==="1"}catch{return!0}}function yt(t){try{localStorage.setItem(Mt(t),"1")}catch{}}function on(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function pn({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:l,onFiltersChange:o}){const{lang:i}=ja(),u=Da[i],f=Wa(t,i,a),[p,g]=c.useReducer(Ka,void 0,()=>Ga((r==null?void 0:r.continent)??"europe",t,{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),s=c.useRef(o);s.current=o,c.useEffect(()=>{var y;(y=s.current)==null||y.call(s,p.filters)},[p.filters]);const[v,b]=c.useState(null),[m,x]=c.useState(null),[h,d]=c.useState({kept:0,dropped:0}),[N,w]=c.useState(!1),[k,C]=c.useState(""),[z,F]=c.useState(!1),[j,E]=c.useState(null),[I,L]=c.useState(!1),[,M]=c.useState(0),R=()=>M(y=>y+1),T=c.useRef([]),P=c.useRef(new Set),B=c.useRef(new Set),_=c.useRef(new Map),re=c.useRef(null),{mode:de}=f,$=c.useMemo(()=>l?{...f.caps,...l}:f.caps,[f.caps,l]),le=$.pipe,q=f.session.token||"",V=de==="client"&&!t;c.useEffect(()=>{if(document.querySelector(`link[href="${vt}"]`))return;const y=document.createElement("link");y.rel="stylesheet",y.href=vt,document.head.appendChild(y)},[]);const D=(y,A=!1)=>{C(y),F(A),re.current&&clearTimeout(re.current),re.current=setTimeout(()=>C(""),A?4200:2400)},G=y=>D(y,!0),ae=c.useMemo(()=>{const y=new Map;return f.dossiers.forEach(A=>{A.id&&y.set(A.id,A)}),y},[f.dossiers]),Z=c.useMemo(()=>f.dossiers.filter(y=>Tt(y,p,le)),[f.dossiers,p,le]),ee=c.useRef(!1);c.useEffect(()=>{if(ee.current||t||f.loading||!f.dossiers.length)return;if(!$.showFunnel||nn(f.session.token||"")){ee.current=!0;return}ee.current=!0;const y=window.setTimeout(()=>{yt(f.session.token||""),L(!0)},700);return()=>window.clearTimeout(y)},[t,f.loading,f.dossiers.length,$.showFunnel,f.session.token]);const te=c.useMemo(()=>f.dossiers.filter(y=>Qa(y,p,le,f.favIds)),[f.dossiers,p,le,f.favIds]),K=c.useMemo(()=>Na(Z,f.favIds),[Z,f.favIds]),me=Ue.find(y=>y.key===p.continent),U=i==="fr"?me.fr:me.en,ne=(y,A)=>{const O=((y==null?void 0:y.name)||A||"").trim();if(!V){x({kicker:O});return}!O||N||(w(!0),(async()=>{try{const H=await Ct(q,O,"atelier2"),ze={name:H.company||O,verdict:H.verdict,reason:H.reason||"",remaining:H.remaining??null};T.current=[ze,...T.current].slice(0,8),H.verdict==="kept"&&d(ue=>({...ue,kept:ue.kept+1})),H.verdict==="ruled_out"&&d(ue=>({...ue,dropped:ue.dropped+1}));const ke=y||f.dossiers.find(ue=>(ue.name||"").toLowerCase()===O.toLowerCase());ke&&(H.verdict==="kept"?ke.verdict=ke.verdict||"MATCH":H.verdict==="ruled_out"&&(ke.verdict="NO MATCH"),H.reason&&(ke.reasoning=H.reason)),R()}finally{w(!1)}})())},ce=y=>{if(!V){x({kicker:y.name});return}P.current.add(y.id),je(q,"fast_request",y.name||"",""),D(u.memoInstantSent(y.name)),R()},we=y=>_.current.get(y.id)??f.thumbs.get((y.name||"").trim().toLowerCase()),pe=(y,A)=>g({type:"undoPush",entry:{id:y.id,name:y.name,prevCeoStatus:A}}),W=async(y,A,O)=>{const H=y.ceoStatus||"";y.ceoStatus=A,R();const ze=await Pe(q,{status:A,airtable_id:y.airtableId,check_id:y.checkId,company:y.name,...(O==null?void 0:O.note)!==void 0?{note:O.note}:{},...O!=null&&O.via?{via:O.via}:{}});return ze.ok?ze.skipped?(y.ceoStatus=H,R(),G(u.actNotPersisted),!1):((O==null?void 0:O.undo)!==!1&&pe(y,H),O!=null&&O.msg&&D(O.msg),(A==="Validé"||A==="Écarté")&&!y.ceoNote&&(O==null?void 0:O.note)===void 0&&E({o:y,yes:A==="Validé"}),!0):(y.ceoStatus=H,R(),G(u.actErr),!1)},Se=async(y,A)=>{const O=await Pe(q,{status:y.ceoStatus||"Retenu",airtable_id:y.airtableId,check_id:y.checkId,company:y.name,note:A,via:"note"});return!O.ok||O.skipped?(G(O.skipped?u.actNotPersisted:u.actErr),!1):(y.ceoNote=A,R(),!0)},xe=c.useRef(new Map),ie=y=>xe.current.has(y.id)?xe.current.get(y.id):f.stages.get((y.name||"").trim().toLowerCase()),ge=(y,A)=>{xe.current.set(y.id,A),R()},Dt=(y,A)=>{V&&W(y,A?"Validé":"Écarté",{msg:A?u.decidedYes(y.name):u.decidedNo(y.name)})},qt=y=>{V&&W(y,"À trancher",{msg:u.promoted(y.name)})},Pt=y=>{V&&(async()=>{const A=y.ceoStatus||"";y.ceoStatus="Retenu",R();const O=await Pe(q,{status:"Retenu",check_id:y.checkId,company:y.name});if(!O.ok||O.skipped){y.ceoStatus=A,R(),G(O.skipped?u.actNotPersisted:u.actErr);return}pe(y,A),D(u.repeched(y.name))})()},Bt=()=>{const y=p.undo[p.undo.length-1];if(!y){D(u.undoNone);return}const A=ae.get(y.id);if(!A){g({type:"undoPop"}),D(u.undoNone);return}let O=y.prevCeoStatus;if(!O)if((A.verdict||"").toUpperCase().includes("CALL"))O="À trancher";else{D(u.undoLockedTitle);return}(async()=>await W(A,O,{undo:!1})&&(g({type:"undoPop"}),A.ceoStatus=y.prevCeoStatus,R(),D(u.undoDone(A.name))))()},It=y=>{V&&(B.current.add(y.id),R(),(async()=>{const A=await Ta(q,y.name,"email");if(!A||A.ok===!1){B.current.delete(y.id),R(),G(u.actErr);return}je(q,"approach",y.name||"",""),D(u.actApproachSent)})())},$t=(y,A)=>{V&&(async()=>{if(!(await je(q,A?"yes":"no",y.name||"","")).ok){G(u.actErr);return}_.current.set(y.id,A?"yes":"no"),R(),D(A?u.thumbUpDone:u.thumbDnDone)})()},Vt=y=>{!V||!_e(y)||(je(q,"detailed_request",y.name||"",""),D(u.memoDeepSent(y.name)))},Ut=y=>{const A=new Set(f.favIds),O=A.has(y.id);O?A.delete(y.id):A.add(y.id),f.setFavIds(A),V&&Aa(q,{id:y.id,co:y.name},O)},_t=()=>{V&&(La(q),D(u.identSyncDone))},Qe=/proplace/i.test(f.fund||""),Ht=y=>{!V||!Qe||(je(q,"onboard_request",y.name||"",""),D(u.onboardSent(y.name)))},Yt={st:p,dispatch:g,t:u,lang:i,mode:de,caps:$,pipe:le,token:q,fund:f.fund,email:f.email,criteria:f.criteria,data:f,doRepeche:Pt,thumbOf:we,canWrite:V,commitStatus:W,saveNote:Se,stageOf:ie,setStage:ge,flashErr:G,startTour:()=>L(!0),dossiers:f.dossiers,scopedAll:Z,scoped:te,counts:K,byId:ae,contName:U,favIds:f.favIds,toggleFav:Ut,askEvaluate:ne,doAnalyse:ce,doDecide:Dt,doPromote:qt,doApproach:It,doThumb:$t,doDeep:Vt,doUndo:Bt,doSync:_t,doOnboard:Ht,outbound:Qe,memoQueued:P.current,approachDone:B.current,sessTally:h,evalCards:T.current,evalBusy:N,markRow:b,markedId:v,flash:D};return c.useEffect(()=>{const y=A=>{A.key==="Escape"&&(g({type:"popup",id:null}),g({type:"modal",modal:null}),g({type:"openFacet",facet:null}))};return window.addEventListener("keydown",y),()=>window.removeEventListener("keydown",y)},[]),e.jsx(Ft.Provider,{value:Yt,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Ba}),e.jsxs("div",{className:"app"+(le?" pipe":""),children:[$.showTicker&&e.jsx(Ja,{}),$.showIdent&&e.jsx(pr,{}),$.showOnb&&e.jsx(ur,{}),e.jsx(cr,{}),$.showFunnel&&e.jsx(ln,{}),$.showFunnel&&e.jsx(mr,{}),$.showFunnel&&e.jsx(gr,{}),e.jsxs("div",{className:"fzone",children:[e.jsx(sn,{}),e.jsxs("div",{className:"stage"+(p.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(br,{}),e.jsx(vr,{})]})]}),$.showDemand&&e.jsx(wr,{}),$.showDemand&&p.memoConsole&&e.jsx(jr,{}),e.jsx(Lr,{}),f.loading&&e.jsx("div",{className:"void",children:u.loadingV2}),f.error&&!f.loading&&e.jsxs("div",{className:"void",children:[u.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:f.refresh,children:u.retry})]})]}),$.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:u.lockbarText}),e.jsx("button",{type:"button",onClick:()=>g({type:"modal",modal:"rdv"}),children:u.lockbarCta})]}),p.popupId&&e.jsx(Rr,{}),e.jsx(Br,{}),e.jsx(ar,{}),j&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:j.o.name}),e.jsx(ir,{placeholder:j.yes?u.whyYesPh:u.whyNoPh,onDone:y=>{const A=j.o;E(null),y&&Se(A,y).then(O=>{O&&D(u.csNoteSaved)})}})]}),I&&e.jsx(dr,{steps:on(u),onClose:()=>{L(!1),yt(q)}}),k&&e.jsx("div",{className:"flash on"+(z?" err":""),children:k}),m&&e.jsx(Ca,{variant:"acquirer",initialCompany:wt().co,initialWebsite:wt().site,onClose:()=>x(null)})]})})}function ln(){const{t}=S(),[a,n]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function sn(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:l,t:o}=S(),i=c.useMemo(()=>{const u={};return t.forEach(f=>{f.continent&&Ye(f,a.filters,r)&&(u[f.continent]=(u[f.continent]||0)+1)}),u},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[Oa.map(u=>{const f=Ue.find(p=>p.key===u);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===u,onClick:()=>n({type:"continent",key:u}),children:[l==="fr"?f.fr:f.en,e.jsx("span",{className:"n",children:i[u]||0})]},u)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function wt(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function dn(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{Rt as FlagCell,ye as SigBadge,Me as SigWin,pn as default,dn as fmtShort,S as useV2};
