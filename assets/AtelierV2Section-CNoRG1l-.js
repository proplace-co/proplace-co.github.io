...
.atl2 .bulk .side .hint{white-space:nowrap}`,wl=`
...
`,El=yl+wl+kl+jl;function fn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Nl(){const e=fn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Sl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Nl();return r==="0"?"client":r==="1"||fn("embed")==="1"&&fn("chrome")==="1"?"apercu":"client"}const Cl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},zl=e=>Cl[e];function La(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const At=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!ho(a)||La(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Yi(e.cc)})};function Ja(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Al=60*60*1e3;function ql(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Al?null:a}catch{return null}}function ha(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Tl=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ll(e,a,r="default"){const n=r!=="default",o=c.useMemo(()=>e||n?{mode:"anon"}:Di(),[e,n]),i=c.useMemo(()=>n?"visiteur":Sl(e,o),[e,o,n]),d=c.useMemo(()=>zl(i),[i]),l=i!=="visiteur",s=Tl(r),[g,p]=c.useState([]),[x,u]=c.useState(""),[b,m]=c.useState(null),[w,k]=c.useState(null),[f,v]=c.useState(null),[j,y]=c.useState(()=>new Map),[N,E]=c.useState(()=>new Map),[S,L]=c.useState(""),[T,I]=c.useState(new Set),[M,U]=c.useState(null),[q,R]=c.useState(!0),[h,A]=c.useState(!1),[$,X]=c.useState(0),[z,D]=c.useState(0),O=c.useRef(0),_=c.useMemo(()=>{var ee;if(i!=="client")return"";try{return((ee=Ii())==null?void 0:ee.email)||""}catch{return""}},[i]);c.useEffect(()=>{const ee=++O.current;let ge=!0;const ae=()=>ge&&ee===O.current,de=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),ue=ql(de);return ue?(p(ue.objs.map(At)),ue.fund&&u(ue.fund),m(ue.marketEstimate??null),k(ue.criteria??null),v(ue.stats??null),L(ue.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const fe=await Ga(),ve=((fe==null?void 0:fe.recent_ops)||[]).map(xe=>{const ye=Ea(xe.company_name||xe.title?xe:{...xe,title:(xe.headline_fr||xe.headline||"").slice(0,120)},a),ze=String(xe.rubrique||"").toLowerCase();return ye&&(ze==="nominations"||ze==="recrutements")&&(ye.engine=ze),ye&&!String(xe.company_name||"").trim()&&(ye.noCo=!0),ye}).filter(xe=>!!xe).map(xe=>(ho((xe.name||"").trim())||(xe.noCo=!0),xe));try{const xe=Pi(),ye=await _i(),ze=((ye==null?void 0:ye.date)||"").slice(0,10),ne=xe?xe.doc:ye,B=Bi(ne),te=((xe==null?void 0:xe.day)||(ne==null?void 0:ne.date)||ze||"").slice(0,10);if(te&&B.length){const H=new Set;for(const V of ve){if((V.date||"").slice(0,10)!==te)continue;const W=Zn(B,H,V.name,"");W>=0&&(H.add(W),V.decryptHtml=B[W].html)}for(const V of ve){if(V.decryptHtml||(V.date||"").slice(0,10)!==te)continue;const W=Zn(B,H,"",V.headline||V.tagline||V.name);W>=0&&(H.add(W),V.decryptHtml=B[W].html)}}if(te){const H=((ne==null?void 0:ne.title_fr)||"").trim(),V=((ne==null?void 0:ne.lead_fr)||"").trim(),W=$i(ne),ie=((ne==null?void 0:ne.url)||"").trim();H&&(W||ie)&&ve.unshift({id:`edito:${te}`,kind:"op",name:H,cc:null,date:te,engine:"edito",dealKind:"other",headline:H,tagline:V||H,decryptHtml:W||void 0,url:ie,noCo:!0})}}catch{}if(!ae())return;p(ve.map(At)),ha(de,{objs:ve})}else if(typeof r=="object"){const ve=(await er()||[]).filter(ye=>(ye.slug||"")===r.research).map(ye=>tr(ye,a)).filter(ye=>!!ye),xe=Ja(await ar(ve,a));if(!ae())return;p(xe.map(At)),ha(de,{objs:xe})}else if(l&&o.token){const fe=Ui(o.token),ve=Ga(),xe=Hi(o.token),ye=Vi(o.token),ze=Wi(o.token),ne=await fe;let B=ne?ne.targets:[];ae()&&ne&&(u(ne.fund||""),m(ne.marketEstimate??null),k(ne.criteria??null),v(ne.stats??null),L(ne.generatedAt||""),p(B.map(At)),R(!1),A(!1));const[te,H,V,W]=await Promise.all([ve,xe,ye,ze]),ie=((te==null?void 0:te.recent_ops)||[]).map(be=>Ea(be,a)).filter(be=>!!be),le=new Set(B.map(be=>be.id));if(B=[...B,...ie.filter(be=>!le.has(be.id)&&(le.add(be.id),!0))],!ae())return;p(B.map(At));const pe=new Set;for(const be of H){const ke=(be.id||be.co||"").toString().trim().toLowerCase();ke&&pe.add(ke.startsWith("t:")?ke:"t:"+ke)}I(pe),y(V),E(W),ne&&ha(de,{fund:ne.fund,marketEstimate:ne.marketEstimate,criteria:ne.criteria,stats:ne.stats,generatedAt:ne.generatedAt,objs:B})}else{const fe=Gi(),ve=er(),xe=Ga(),ye=await fe;ae()&&ye.length&&(p(Ja(ye).map(At)),R(!1),A(!1));const[ze,ne]=await Promise.all([ve,xe]),B=(ze||[]).map(W=>tr(W,a)).filter(W=>!!W),te=await ar(B,a),H=((ne==null?void 0:ne.recent_ops)||[]).map(W=>Ea(W,a)).filter(W=>!!W),V=Ja([...ye,...te,...H]);if(!ae())return;p(V.map(At)),ha(de,{objs:V})}ae()&&A(!1)}catch{ae()&&!ue&&A(!0)}finally{ae()&&R(!1)}})(),()=>{ge=!1}},[l,o.token,a,$,s]),c.useEffect(()=>{if(!d.showCredits||!_){U(null);return}let ee=!0;return(async()=>{try{const ge=await fetch(`${Ha}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:_})});if(!ge.ok)return;const ae=await ge.json();ee&&ae&&ae.ok!==!1&&U(ae)}catch{}})(),()=>{ee=!1}},[d.showCredits,_,z]);const J=c.useCallback(ee=>I(new Set(ee)),[]);return{session:o,mode:i,caps:d,fund:x,email:_,marketEstimate:b,generatedAt:S,criteria:w,thesisMode:String((w==null?void 0:w.mode)||""),stats:f,thumbs:j,stages:N,dossiers:g,patchStatuses:(ee,ge)=>{p(ae=>{let de=!1;const ue=ae.map(fe=>{if(!fe.checkId)return fe;const ve=ee.get(fe.checkId);return!ve||ve===(fe.ceoStatus||"")||!ge(fe.id)?fe:(de=!0,{...fe,ceoStatus:ve})});return de?ue:ae})},favIds:T,setFavIds:J,credits:M,reloadCredits:()=>D(ee=>ee+1),loading:q,error:h,refresh:()=>X(ee=>ee+1)}}function Qe(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Na=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ra(e){return Na.has(e.engine||"")}function Ye(e){return!!e.noCo||Ra(e)&&!!e.url}const Ro=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Rl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Ro(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,memoTab:0,undo:[],mapFolded:a}),Fl=new Set(["signal","amount","score","crible","memo"]);function Ol(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Ro(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Fl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Fo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Fo=80;function Fa(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Ie(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ln(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(wt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&qt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(xo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function oa(e,a,r){return Qe(e)?Fa(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Fa(e,a.filters,r)}function Ml(e,a,r,n){return!(!oa(e,a,r)||r&&!go(e,a.ptab,n))}function Dn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-wt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Ki(o)||null;case"memo":return Qi(o)||null;case"signal":{const i=Ie(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Xa={},vr=(Xa==null?void 0:Xa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function yr(){return new Date().toISOString().slice(0,10)}const In=c.createContext(null);function Oo(){return c.useContext(In)}function Dl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const g=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(p=>s.removeAttribute(p.name)),g&&/^https?:\/\//i.test(g)&&(s.setAttribute("href",g),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Il(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function wr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function kr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Mo(){const e=c.useContext(In);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Pl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=K(),[i,d]=c.useState(()=>n.filters.day||yr()),[l,s]=c.useState(null),[g,p]=c.useState(!1),x=c.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),u=c.useCallback(()=>{d(yr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);c.useEffect(()=>{const w=k=>{var v;const f=(v=k.detail)==null?void 0:v.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),c.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),c.useEffect(()=>{if(!e||!i)return;let w=!1;p(!0);const k=new URLSearchParams({token:e,date:i});return fetch(`${vr}/cibles/edition.json?${k}`).then(f=>f.json()).then(f=>{w||s(f)}).catch(()=>{w||s({ok:!1,error:"network"})}).finally(()=>{w||p(!1)}),()=>{w=!0}},[e,i]);const b=c.useMemo(()=>`${vr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=c.useMemo(()=>({token:e,day:i,ed:l,loading:g,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,g,x,u,n.filters.day,b,o]);return t.jsx(In.Provider,{value:m,children:a})}function _l(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Mo(),[o,i]=c.useState(()=>n||bo());return c.useEffect(()=>{n&&i(!0)},[n]),c.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(Aa,d),()=>window.removeEventListener(Aa,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Ji,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Bl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function jr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Er(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function $l(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Mo(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,g=c.useRef(null),[p,x]=c.useState("fonds"),[u,b]=c.useState(null),[m,w]=c.useState("idle"),k=c.useRef(!1);c.useEffect(()=>{b(null),w("idle"),k.current=!1,x("fonds")},[e]),c.useEffect(()=>{if(p!=="jour"||k.current)return;k.current=!0;let N=!0;return w("load"),Bl(e).then(E=>{N&&(b(E),w("fait"))}),()=>{N=!1}},[p,e]);const f=c.useMemo(()=>Il((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),v=c.useRef(null);c.useEffect(()=>{const N=v.current;if(!N||!f)return;let E=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(E||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{E=!0}},[f]);const j=c.useMemo(()=>wr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),y=c.useMemo(()=>wr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return c.useEffect(()=>{const N=g.current;if(!N||!j)return;let E=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(E||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{E=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const N=(a==null?void 0:a.date)||e,E=/^(\d{4})-(\d{2})-(\d{2})/.exec(N);return E?i?`${E[2]}/${E[3]}/${E[1]}`:`${E[3]}/${E[2]}/${E[1]}`:N})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":p==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":p==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),p==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),p==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p==="fonds"&&s&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),p==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?jr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:kr(e,!0)}),"."]}):jr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:kr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),p==="fonds"&&d&&j?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,p==="fonds"&&d&&y?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:y}}):null,p==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:v,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Er(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Er(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Ul=300,ga=7,Hl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Do={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Vl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Za(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(ts(r)&&r!=="media")return"news:"+r;const n=Ie(e);return n?"sig:"+(n.theme&&Do.fr[n.theme]?n.theme:"other"):"actualites"}function Wl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=K(),s=Oo(),g=d==="en",[p,x]=c.useState("all"),[u,b]=c.useState(!1),m=c.useMemo(()=>{var ge;const h=(a.filters.day||"").slice(0,10),A=ae=>!(!i&&a.continent!=="monde"&&ae.continent!==a.continent||h&&(ae.date||"").slice(0,10)!==h),$=e.filter(ae=>A(ae)&&Ie(ae)&&(!i||ae.kind!=="target"||Ce(ae)!==5)),X=i&&(((ge=s==null?void 0:s.ed)==null?void 0:ge.ops)||[]).length?s.ed.ops.map(ae=>Ea(ae,d)).filter(ae=>!!ae).map(ae=>(ae.briefOnly=!0,ae)).filter(ae=>!h||(ae.date||"").slice(0,10)===h):[],z=e.filter(ae=>A(ae)&&ae.kind==="op"&&(h?!0:wt(ae.date)<=ga)),D=i?X.length?X:z.filter(ae=>{const de=(l||"").trim().toLowerCase();if(!de)return!1;const ue=ae.match||null;return ue?Object.keys(ue).map(fe=>fe.trim().toLowerCase()).includes(de):!1}):z,O=h||new Date().toISOString().slice(0,10),_=ae=>{const de=Za(ae);return de==="ma"?0:de==="levees"?1:2};D.sort((ae,de)=>{const ue=_(ae)-_(de);if(ue)return ue;const fe=(ae.date||"").slice(0,10)===O?0:1,ve=(de.date||"").slice(0,10)===O?0:1;return fe!==ve?fe-ve:(de.amountEur||0)-(ae.amountEur||0)});const J=new Set,ee=[];for(const ae of[...D,...Dn($,{key:"signal",dir:-1})]){const de=ae.id||ae.name;!de||J.has(de)||(J.add(de),ee.push(ae))}return i&&ee.length===0?e.filter(de=>A(de)&&wt(de.date)<=ga).sort((de,ue)=>(ue.date||"").localeCompare(de.date||"")).slice(0,80):ee},[e,a.continent,a.filters.day,i,l,d,s]),w=c.useMemo(()=>{const h={};for(const A of m){const $=Za(A);h[$]=(h[$]||0)+1}return h},[m]),k=c.useMemo(()=>p==="all"?m:m.filter(h=>Za(h)===p),[m,p]),f=c.useMemo(()=>k.slice(0,Ul),[k]),v=k.length-f.length,j=c.useRef(null);c.useEffect(()=>{var D,O;const h=j.current;if(!h)return;const A=()=>{const _=h.scrollWidth;_<200||(h.style.animationDuration=Math.max(18,Math.round(_/130))+"s")};A();const $=requestAnimationFrame(A),X=window.setTimeout(A,1200);let z=!0;return(O=(D=document.fonts)==null?void 0:D.ready)==null||O.then(()=>{z&&A()}),()=>{z=!1,cancelAnimationFrame($),window.clearTimeout(X)}},[f.length,p]);const y=h=>h==="all"?m.length:w[h]||0,N=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return Do[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const A=h.slice(5);return Zi[A]?es(A,g?"en":"fr"):h}return Hl[g?"en":"fr"][h]},E=[{k:"all"}],S=["ma","levees"].filter(h=>y(h)>0||h===p);if(S.length){E.push({g:g?"Deals":"Opérations"});for(const h of S)E.push({k:h})}const L=["nominations","recrutements"].filter(h=>y(h)>0||h===p),T=Xi.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>y(h)>0||h===p),I=y("actualites")>0||p==="actualites"?["actualites"]:[];if(L.length||T.length||I.length){E.push({g:g?"News":"Actualités"});for(const h of L)E.push({k:h});for(const h of T)E.push({k:h});for(const h of I)E.push({k:h})}const M=Vl.map(h=>"sig:"+h).filter(h=>y(h)>0||h===p);if(M.length){E.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of M)E.push({k:h})}const U=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},q=(()=>{const h=(a.filters.day||"").slice(0,10),A=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(g?`LIVE covers the events of ${U(h)}.`:`Le LIVE regroupe les événements du ${U(h)}.`)+A:(g?`LIVE covers the still-open signals and the deals of the last ${ga} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ga} derniers jours.`)+A})(),R=h=>f.map(A=>t.jsxs("button",{type:"button",className:"tk"+(_e(A)?" spent":""),onClick:$=>{const X=A.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:X?"":A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(X||n({type:"focus",id:A.id}),a.dens!=="liste"){const z=$.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:z.left+z.width/2,y:z.bottom}})}},title:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(Et,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(ki,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:Uc(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx(Va,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(A.id||A.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(h=>!h),children:[N(p),t.jsx("b",{children:y(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:q}),E.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===p,onClick:()=>{x(h.k),b(!1)},children:[N(h.k),t.jsx("b",{children:y(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:j,children:[R(0),R(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!s&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!s&&t.jsx(Yl,{isEn:g})]})}const Gl=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Yl({isEn:e}){const[a,r]=c.useState(()=>bo());c.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Aa,o),()=>window.removeEventListener(Aa,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>as(!a),children:Gl})}const Pn="+33 6 83 10 72 86",Oa="alexandre@proplace.co",Io=`tel:${Pn.replace(/[^\d+]/g,"")}`;function Ql(){return null}class lt extends c.Component{constructor(){super(...arguments);Kn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Po=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Nr(e,a){if((Nt(e)||"").startsWith("CALL")&&Ce(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ce(e)>=2;return Po.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const Sr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",Kl={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function Jl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=K(),[l,s]=c.useState(""),[g,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null);if(c.useEffect(()=>{if(!x)return;const v=j=>{b.current&&!b.current.contains(j.target)&&(u(!1),p(!1))};return document.addEventListener("click",v,!0),()=>document.removeEventListener("click",v,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),w=async v=>{if(l)return;if(v==="Analysé"&&!e.memoUrl){p(!0);return}s(v);const j=(Nr(e,a).find(([N])=>N===v)||[v,v])[1],y=await o(e,v,{msg:a.csMoved(e.name,j)});s(""),y&&(p(!1),u(!1))},k=Nr(e,a),f=v=>(k.find(([j])=>j===v)||[])[1]||v;return k.length===2?t.jsx("span",{className:"rstat rst2",onClick:v=>v.stopPropagation(),children:k.map(([v,j])=>t.jsx("button",{type:"button",className:"rsd "+(v==="Validé"?"yes":"no")+(l===v?" busy":""),disabled:!!l,onClick:()=>{w(v)},children:j},v))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:v=>v.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+Sr(m),onClick:()=>{u(v=>!v),p(!1)},children:l?f(l)+"…":m?f(m):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:k.map(([v,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===v,className:"rsopt"+(m===v?" on":"")+(l===v?" busy":""),disabled:!!l,onClick:()=>{if(v===m){u(!1);return}w(v)},children:[t.jsx("i",{className:"pt2",style:{background:Kl[Sr(v)]}}),j]},v))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),p(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const v=await o(e,"Analysé");s(""),v&&(p(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function Xl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=K(),[i,d]=c.useState(""),[l,s]=c.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),p=(Nt(e)||"").startsWith("CALL")&&Ce(e)===3,x=Ce(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(m);const w=await o(e,m);d(""),w&&(s(!0),setTimeout(()=>s(!1),2200))},b=p?[["Validé",a.csYes],["Écarté",a.csNo]]:Po.filter(([m])=>!(x&&m==="Retenu")).map(([m,w])=>[m,a[w]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,w])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:w},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Zl,{o:e})]})}function Zl({o:e}){const{t:a,saveNote:r,flash:n}=K(),[o,i]=c.useState(e.ceoNote||""),[d,l]=c.useState(!1),[s,g]=c.useState(!1),p=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!p)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!p,onClick:()=>{x()},children:s?a.csNoteSaved:a.csNoteOk})]})}function Cr({placeholder:e,onDone:a}){const{t:r}=K(),[n,o]=c.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ed({o:e}){var k;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=K(),[s,g]=c.useState(!1);if(!n.pipe||!o||n.lockActions||Ce(e)!==4)return null;const p=i(e),x=(p==null?void 0:p.stage)||"todo",u=async f=>{if(s||f===x)return;g(!0);const v=p;d(e,{stage:f,stamps:(p==null?void 0:p.stamps)||{}});const j=Math.max(Date.now(),zr+=1);zr=j;const y=await ns(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!y.stale&&(y.ok||(d(e,v),l(a.actErr)))},b=(k=p==null?void 0:p.stamps)==null?void 0:k.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,v])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:s,onClick:()=>{u(f)},children:v},f)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let zr=0;const Kt=8,kt=360;function Ar({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function qr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Ar,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Ar,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function td({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=K(),[d,l]=c.useState(0),[s,g]=c.useState(null),[p,x]=c.useState([]),u=c.useRef(!1),b=c.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=c.useRef(!1);c.useEffect(()=>{const S=b.current;return()=>{m.current||(n({type:"ptab",tab:S.ptab}),n({type:"dens",dens:S.dens}),n({type:"modal",modal:S.modal}))}},[]),c.useEffect(()=>{u.current||(u.current=!0,x(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const w=p[d],k=d>=p.length;c.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const S=w.click,L=window.setTimeout(()=>{const T=document.querySelector(S);T&&T.getAttribute("aria-selected")!=="true"&&T.click()},60);return()=>window.clearTimeout(L)}},[d,w]);const f=c.useRef(-1),v=c.useCallback(()=>{if(!w){g(null);return}const S=I=>{if(!I)return null;for(const M of document.querySelectorAll(I)){const U=M.getBoundingClientRect();if(U.width>1&&U.height>1)return M}return null},L=S(w.sel)||S(w.need);if(!L){g(null);return}f.current!==d&&(f.current=d,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const T=L.getBoundingClientRect();g(I=>I&&Math.abs(I.top-T.top)<1&&Math.abs(I.left-T.left)<1&&Math.abs(I.width-T.width)<1&&Math.abs(I.height-T.height)<1?I:T)},[w,d]);c.useLayoutEffect(()=>{v();const S=[90,300,700,1300].map(I=>window.setTimeout(v,I)),L=window.setInterval(v,400),T=()=>v();return window.addEventListener("scroll",T,!0),window.addEventListener("resize",T),()=>{S.forEach(I=>window.clearTimeout(I)),window.clearInterval(L),window.removeEventListener("scroll",T,!0),window.removeEventListener("resize",T)}},[v]);const j=c.useRef(a);if(j.current=a,c.useEffect(()=>{const S=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),j.current()):L.key==="ArrowRight"?l(T=>T+1):L.key==="ArrowLeft"&&l(T=>Math.max(0,T-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!p.length)return null;let y=null;const N=S=>()=>{m.current=!0,n({type:"modal",modal:null}),S()};if(k){const S=o[3]||0;S>0?y={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?y={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?y={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let E={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:kt};if(!k&&s){const S=s.bottom+14,L=window.innerHeight-S;let T=L>190?S:Math.max(12,s.top-200),I=Math.min(Math.max(12,s.left+s.width/2-kt/2),window.innerWidth-kt-12);L<=190&&s.top<212&&(window.innerWidth-s.right>=kt+40?I=Math.min(s.right+26,window.innerWidth-kt-12):s.left>=kt+40&&(I=Math.max(12,s.left-kt-26)),T=Math.max(12,s.top-Kt)),E={left:I,top:T,width:kt}}return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!k&&s&&t.jsx("div",{className:"tour-hole",style:{left:s.left-Kt,top:s.top-Kt,width:s.width+Kt*2,height:s.height+Kt*2}}),(k||!s)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(k?" fin":""),style:E,children:[k&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(qr,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(p.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,p.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/p.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(qr,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(S=>S+1),children:d===p.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function _o(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Bo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ad(){var L,T;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:s}=K(),g=r?a:e,p=c.useMemo(()=>g.filter(I=>wt(I.date)===0&&I.kind==="target"),[g]),x=c.useMemo(()=>r?a.filter(I=>I.kind==="target"&&Ce(I)===0).slice().sort((I,M)=>(M.date||"").localeCompare(I.date||"")):[],[a,r]),u=c.useMemo(()=>p.filter(I=>r?Ce(I)===0:!_e(I)),[p,r]),b=r?x:u,m=r?a.length-x.length:p.length-u.length,w=r?a.length:p.length,k=w?Math.min(100,m/w*100):100,f=c.useMemo(()=>_o(g),[g]),v=!!f&&wt(f)>0,j=c.useMemo(()=>v?g.filter(I=>(I.date||"").slice(0,10)===f):[],[g,f,v]),y=typeof((L=l.stats)==null?void 0:L.kept_today)=="number"?l.stats.kept_today:null,N=typeof((T=l.stats)==null?void 0:T.screened_today)=="number"?l.stats.screened_today:p.length;let E;v?E=o.morningLast(j.length,x.length,Bo(f,d)):r?E=o.morningThesis(N,x.length,y):p.length?m===0?E=o.goalSourced(p.length):m>=p.length?E=o.goalCleared:E=o.goalDone(m,p.length):E=o.goalSourced(0);const S=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&x.length&&s({type:"chainStart",queue:x.map(I=>I.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:E}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:k+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:S,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function nd(){var z,D;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:d,dossiers:l,mode:s,doSync:g,startTour:p,flash:x,flashErr:u}=K(),[b,m]=c.useState(null),[w,k]=c.useState(!0),[f,v]=c.useState([]),j=s==="client";c.useEffect(()=>{if(!o||!i)return;let O=!0;return k(!0),(async()=>{const[_,J]=await Promise.all([Rn(i),vo(o)]);O&&(_&&m(_),k(!1),v(J))})(),()=>{O=!1}},[o,i]);const[y,N]=c.useState(!1),[E,S]=c.useState(""),L=()=>{!j||y||!i||(N(!0),S(""),rs(i).then(O=>{if(N(!1),O.pending){S(e.refreshSlow);return}if(!O.ok){O.error&&console.warn("[republish]",O.error),S(e.refreshKo);return}const _=O.entered??0,J=O.left??0;S(O.unchanged||!_&&!J?e.refreshSame:e.refreshDone(_,J)),d.refresh()}))},T=(b==null?void 0:b.per_day)??null,I=((z=b==null?void 0:b.pool_order)==null?void 0:z.length)??0,M=f.filter(O=>O.status==="running").length,U=c.useMemo(()=>l.filter(O=>O.kind==="target"&&_e(O)).length,[l]),q=d.marketEstimate,R=typeof((D=d.stats)==null?void 0:D.screened)=="number"?d.stats.screened:U,h=q&&q>0?Math.min(100,Math.round(R/q*100)):null,A=O=>O.toLocaleString(a==="en"?"en-US":"fr-FR"),$=(i||"P").split(/\s+/).map(O=>O[0]).join("").slice(0,2).toUpperCase(),X=(()=>{const O=Date.parse(d.generatedAt||"");if(Number.isNaN(O))return"";const _=new Date(O),J=ee=>String(ee).padStart(2,"0");return`${J(_.getDate())}/${J(_.getMonth()+1)} à ${J(_.getHours())}:${J(_.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?$:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),X?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(X)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||y,onClick:L,children:y?"⏳":"📰"}),(y||!!E)&&t.jsxs("span",{className:"repubst",children:[y?e.refreshRun:E,!y&&t.jsx("button",{type:"button",onClick:()=>S(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:g,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:p,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:O=>n({type:"filters",patch:{search:O.target.value}})})]})]}),t.jsxs("div",{className:"idmain",children:[h===null&&R>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:A(R)})})]}),h!==null&&q&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:h+"%"}})}),t.jsxs("b",{children:[h," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(R,q)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),T!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:T})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),T===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),M>0&&t.jsxs("span",{className:"ev",children:["⏳ ",M]})]}),t.jsxs("span",{className:"filec",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:a==="en"?"Queue":"File"}),t.jsx("span",{className:"ego",children:w?e.identPendingWait:e.identPending(I)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:O=>{O.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]})]})]})}class Lt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*rd(e){for(const a of e)yield*a}function $o(e){return Array.from(rd(e))}var Se=1e-6,we=Math.PI,at=we/2,Tr=we/4,rt=we*2,xt=180/we,Xe=we/180,Ae=Math.abs,od=Math.atan,ia=Math.atan2,Re=Math.cos,Fe=Math.sin,id=Math.sign||function(e){return e>0?1:e<0?-1:0},Ot=Math.sqrt;function sd(e){return e>1?0:e<-1?we:Math.acos(e)}function sa(e){return e>1?at:e<-1?-at:Math.asin(e)}function nt(){}function Ma(e,a){e&&Rr.hasOwnProperty(e.type)&&Rr[e.type](e,a)}var Lr={Feature:function(e,a){Ma(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ma(r[n].geometry,a)}},Rr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){hn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)hn(r[n],a,0)},Polygon:function(e,a){Fr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Fr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ma(r[n],a)}};function hn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Fr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)hn(e[r],a,1);a.polygonEnd()}function _t(e,a){e&&Lr.hasOwnProperty(e.type)?Lr[e.type](e,a):Ma(e,a)}function gn(e){return[ia(e[1],e[0]),sa(e[2])]}function Ut(e){var a=e[0],r=e[1],n=Re(r);return[n*Re(a),n*Fe(a),Fe(r)]}function xa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Da(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function en(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ba(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function xn(e){var a=Ot(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function bn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function vn(e,a){return Ae(e)>we&&(e-=Math.round(e/rt)*rt),[e,a]}vn.invert=vn;function ld(e,a,r){return(e%=rt)?a||r?bn(Mr(e),Dr(a,r)):Mr(e):a||r?Dr(a,r):vn}function Or(e){return function(a,r){return a+=e,Ae(a)>we&&(a-=Math.round(a/rt)*rt),[a,r]}}function Mr(e){var a=Or(e);return a.invert=Or(-e),a}function Dr(e,a){var r=Re(e),n=Fe(e),o=Re(a),i=Fe(a);function d(l,s){var g=Re(s),p=Re(l)*g,x=Fe(l)*g,u=Fe(s),b=u*r+p*n;return[ia(x*o-b*i,p*r-u*n),sa(b*o+x*i)]}return d.invert=function(l,s){var g=Re(s),p=Re(l)*g,x=Fe(l)*g,u=Fe(s),b=u*o-x*i;return[ia(x*o+u*i,p*r+b*n),sa(b*r-p*n)]},d}function dd(e,a,r,n,o,i){if(r){var d=Re(a),l=Fe(a),s=n*r;o==null?(o=a+n*rt,i=a-s/2):(o=Ir(d,o),i=Ir(d,i),(n>0?o<i:o>i)&&(o+=n*rt));for(var g,p=o;n>0?p>i:p<i;p-=s)g=gn([d,-l*Re(p),-l*Fe(p)]),e.point(g[0],g[1])}}function Ir(e,a){a=Ut(a),a[0]-=e,xn(a);var r=sd(-a[1]);return((-a[2]<0?-r:r)+rt-Se)%rt}function Uo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:nt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Sa(e,a){return Ae(e[0]-a[0])<Se&&Ae(e[1]-a[1])<Se}function va(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Ho(e,a,r,n,o){var i=[],d=[],l,s;if(e.forEach(function(m){if(!((w=m.length-1)<=0)){var w,k=m[0],f=m[w],v;if(Sa(k,f)){if(!k[2]&&!f[2]){for(o.lineStart(),l=0;l<w;++l)o.point((k=m[l])[0],k[1]);o.lineEnd();return}f[0]+=2*Se}i.push(v=new va(k,m,null,!0)),d.push(v.o=new va(k,null,v,!1)),i.push(v=new va(f,m,null,!1)),d.push(v.o=new va(f,null,v,!0))}}),!!i.length){for(d.sort(a),Pr(i),Pr(d),l=0,s=d.length;l<s;++l)d[l].e=r=!r;for(var g=i[0],p,x;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;p=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,s=p.length;l<s;++l)o.point((x=p[l])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(p=u.p.z,l=p.length-1;l>=0;--l)o.point((x=p[l])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,p=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Pr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function tn(e){return Ae(e[0])<=we?e[0]:id(e[0])*((Ae(e[0])+we)%rt-we)}function pd(e,a){var r=tn(a),n=a[1],o=Fe(n),i=[Fe(r),-Re(r),0],d=0,l=0,s=new Lt;o===1?n=at+Se:o===-1&&(n=-at-Se);for(var g=0,p=e.length;g<p;++g)if(u=(x=e[g]).length)for(var x,u,b=x[u-1],m=tn(b),w=b[1]/2+Tr,k=Fe(w),f=Re(w),v=0;v<u;++v,m=y,k=E,f=S,b=j){var j=x[v],y=tn(j),N=j[1]/2+Tr,E=Fe(N),S=Re(N),L=y-m,T=L>=0?1:-1,I=T*L,M=I>we,U=k*E;if(s.add(ia(U*T*Fe(I),f*S+U*Re(I))),d+=M?L+T*rt:L,M^m>=r^y>=r){var q=Da(Ut(b),Ut(j));xn(q);var R=Da(i,q);xn(R);var h=(M^L>=0?-1:1)*sa(R[2]);(n>h||n===h&&(q[0]||q[1]))&&(l+=M^L>=0?1:-1)}}return(d<-Se||d<Se&&s<-1e-12)^l&1}function Vo(e,a,r,n){return function(o){var i=a(o),d=Uo(),l=a(d),s=!1,g,p,x,u={point:b,lineStart:w,lineEnd:k,polygonStart:function(){u.point=f,u.lineStart=v,u.lineEnd=j,p=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=w,u.lineEnd=k,p=$o(p);var y=pd(g,n);p.length?(s||(o.polygonStart(),s=!0),Ho(p,ud,y,r,o)):y&&(s||(o.polygonStart(),s=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),s&&(o.polygonEnd(),s=!1),p=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(y,N){e(y,N)&&o.point(y,N)}function m(y,N){i.point(y,N)}function w(){u.point=m,i.lineStart()}function k(){u.point=b,i.lineEnd()}function f(y,N){x.push([y,N]),l.point(y,N)}function v(){l.lineStart(),x=[]}function j(){f(x[0][0],x[0][1]),l.lineEnd();var y=l.clean(),N=d.result(),E,S=N.length,L,T,I;if(x.pop(),g.push(x),x=null,!!S){if(y&1){if(T=N[0],(L=T.length-1)>0){for(s||(o.polygonStart(),s=!0),o.lineStart(),E=0;E<L;++E)o.point((I=T[E])[0],I[1]);o.lineEnd()}return}S>1&&y&2&&N.push(N.pop().concat(N.shift())),p.push(N.filter(cd))}}return u}}function cd(e){return e.length>1}function ud(e,a){return((e=e.x)[0]<0?e[1]-at-Se:at-e[1])-((a=a.x)[0]<0?a[1]-at-Se:at-a[1])}const _r=Vo(function(){return!0},md,hd,[-we,-at]);function md(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?we:-we,s=Ae(i-a);Ae(s-we)<Se?(e.point(a,r=(r+d)/2>0?at:-at),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&s>=we&&(Ae(a-n)<Se&&(a-=n*Se),Ae(i-l)<Se&&(i-=l*Se),r=fd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function fd(e,a,r,n){var o,i,d=Fe(e-r);return Ae(d)>Se?od((Fe(a)*(i=Re(n))*Fe(r)-Fe(n)*(o=Re(a))*Fe(e))/(o*i*d)):(a+n)/2}function hd(e,a,r,n){var o;if(e==null)o=r*at,n.point(-we,o),n.point(0,o),n.point(we,o),n.point(we,0),n.point(we,-o),n.point(0,-o),n.point(-we,-o),n.point(-we,0),n.point(-we,o);else if(Ae(e[0]-a[0])>Se){var i=e[0]<a[0]?we:-we;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function gd(e){var a=Re(e),r=2*Xe,n=a>0,o=Ae(a)>Se;function i(p,x,u,b){dd(b,e,r,u,p,x)}function d(p,x){return Re(p)*Re(x)>a}function l(p){var x,u,b,m,w;return{lineStart:function(){m=b=!1,w=1},point:function(k,f){var v=[k,f],j,y=d(k,f),N=n?y?0:g(k,f):y?g(k+(k<0?we:-we),f):0;if(!x&&(m=b=y)&&p.lineStart(),y!==b&&(j=s(x,v),(!j||Sa(x,j)||Sa(v,j))&&(v[2]=1)),y!==b)w=0,y?(p.lineStart(),j=s(v,x),p.point(j[0],j[1])):(j=s(x,v),p.point(j[0],j[1],2),p.lineEnd()),x=j;else if(o&&x&&n^y){var E;!(N&u)&&(E=s(v,x,!0))&&(w=0,n?(p.lineStart(),p.point(E[0][0],E[0][1]),p.point(E[1][0],E[1][1]),p.lineEnd()):(p.point(E[1][0],E[1][1]),p.lineEnd(),p.lineStart(),p.point(E[0][0],E[0][1],3)))}y&&(!x||!Sa(x,v))&&p.point(v[0],v[1]),x=v,b=y,u=N},lineEnd:function(){b&&p.lineEnd(),x=null},clean:function(){return w|(m&&b)<<1}}}function s(p,x,u){var b=Ut(p),m=Ut(x),w=[1,0,0],k=Da(b,m),f=xa(k,k),v=k[0],j=f-v*v;if(!j)return!u&&p;var y=a*f/j,N=-a*v/j,E=Da(w,k),S=ba(w,y),L=ba(k,N);en(S,L);var T=E,I=xa(S,T),M=xa(T,T),U=I*I-M*(xa(S,S)-1);if(!(U<0)){var q=Ot(U),R=ba(T,(-I-q)/M);if(en(R,S),R=gn(R),!u)return R;var h=p[0],A=x[0],$=p[1],X=x[1],z;A<h&&(z=h,h=A,A=z);var D=A-h,O=Ae(D-we)<Se,_=O||D<Se;if(!O&&X<$&&(z=$,$=X,X=z),_?O?$+X>0^R[1]<(Ae(R[0]-h)<Se?$:X):$<=R[1]&&R[1]<=X:D>we^(h<=R[0]&&R[0]<=A)){var J=ba(T,(-I+q)/M);return en(J,S),[R,gn(J)]}}}function g(p,x){var u=n?e:we-e,b=0;return p<-u?b|=1:p>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return Vo(d,l,i,n?[0,-e]:[-we,e-we])}function xd(e,a,r,n,o,i){var d=e[0],l=e[1],s=a[0],g=a[1],p=0,x=1,u=s-d,b=g-l,m;if(m=r-d,!(!u&&m>0)){if(m/=u,u<0){if(m<p)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>p&&(p=m)}if(m=o-d,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>p&&(p=m)}else if(u>0){if(m<p)return;m<x&&(x=m)}if(m=n-l,!(!b&&m>0)){if(m/=b,b<0){if(m<p)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>p&&(p=m)}if(m=i-l,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>p&&(p=m)}else if(b>0){if(m<p)return;m<x&&(x=m)}return p>0&&(e[0]=d+p*u,e[1]=l+p*b),x<1&&(a[0]=d+x*u,a[1]=l+x*b),!0}}}}}var Xt=1e9,ya=-Xt;function bd(e,a,r,n){function o(g,p){return e<=g&&g<=r&&a<=p&&p<=n}function i(g,p,x,u){var b=0,m=0;if(g==null||(b=d(g,x))!==(m=d(p,x))||s(g,p)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(p[0],p[1])}function d(g,p){return Ae(g[0]-e)<Se?p>0?0:3:Ae(g[0]-r)<Se?p>0?2:1:Ae(g[1]-a)<Se?p>0?1:0:p>0?3:2}function l(g,p){return s(g.x,p.x)}function s(g,p){var x=d(g,1),u=d(p,1);return x!==u?x-u:x===0?p[1]-g[1]:x===1?g[0]-p[0]:x===2?g[1]-p[1]:p[0]-g[0]}return function(g){var p=g,x=Uo(),u,b,m,w,k,f,v,j,y,N,E,S={point:L,lineStart:U,lineEnd:q,polygonStart:I,polygonEnd:M};function L(h,A){o(h,A)&&p.point(h,A)}function T(){for(var h=0,A=0,$=b.length;A<$;++A)for(var X=b[A],z=1,D=X.length,O=X[0],_,J,ee=O[0],ge=O[1];z<D;++z)_=ee,J=ge,O=X[z],ee=O[0],ge=O[1],J<=n?ge>n&&(ee-_)*(n-J)>(ge-J)*(e-_)&&++h:ge<=n&&(ee-_)*(n-J)<(ge-J)*(e-_)&&--h;return h}function I(){p=x,u=[],b=[],E=!0}function M(){var h=T(),A=E&&h,$=(u=$o(u)).length;(A||$)&&(g.polygonStart(),A&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),$&&Ho(u,l,h,i,g),g.polygonEnd()),p=g,u=b=m=null}function U(){S.point=R,b&&b.push(m=[]),N=!0,y=!1,v=j=NaN}function q(){u&&(R(w,k),f&&y&&x.rejoin(),u.push(x.result())),S.point=L,y&&p.lineEnd()}function R(h,A){var $=o(h,A);if(b&&m.push([h,A]),N)w=h,k=A,f=$,N=!1,$&&(p.lineStart(),p.point(h,A));else if($&&y)p.point(h,A);else{var X=[v=Math.max(ya,Math.min(Xt,v)),j=Math.max(ya,Math.min(Xt,j))],z=[h=Math.max(ya,Math.min(Xt,h)),A=Math.max(ya,Math.min(Xt,A))];xd(X,z,e,a,r,n)?(y||(p.lineStart(),p.point(X[0],X[1])),p.point(z[0],z[1]),$||p.lineEnd(),E=!1):$&&(p.lineStart(),p.point(h,A),E=!1)}v=h,j=A,y=$}return S}}const yn=e=>e;var an=new Lt,wn=new Lt,Wo,Go,kn,jn,vt={point:nt,lineStart:nt,lineEnd:nt,polygonStart:function(){vt.lineStart=vd,vt.lineEnd=wd},polygonEnd:function(){vt.lineStart=vt.lineEnd=vt.point=nt,an.add(Ae(wn)),wn=new Lt},result:function(){var e=an/2;return an=new Lt,e}};function vd(){vt.point=yd}function yd(e,a){vt.point=Yo,Wo=kn=e,Go=jn=a}function Yo(e,a){wn.add(jn*e-kn*a),kn=e,jn=a}function wd(){Yo(Wo,Go)}var Ht=1/0,Ia=Ht,la=-Ht,Pa=la,_a={point:kd,lineStart:nt,lineEnd:nt,polygonStart:nt,polygonEnd:nt,result:function(){var e=[[Ht,Ia],[la,Pa]];return la=Pa=-(Ia=Ht=1/0),e}};function kd(e,a){e<Ht&&(Ht=e),e>la&&(la=e),a<Ia&&(Ia=a),a>Pa&&(Pa=a)}var En=0,Nn=0,Zt=0,Ba=0,$a=0,Bt=0,Sn=0,Cn=0,ea=0,Qo,Ko,ut,mt,tt={point:Rt,lineStart:Br,lineEnd:$r,polygonStart:function(){tt.lineStart=Nd,tt.lineEnd=Sd},polygonEnd:function(){tt.point=Rt,tt.lineStart=Br,tt.lineEnd=$r},result:function(){var e=ea?[Sn/ea,Cn/ea]:Bt?[Ba/Bt,$a/Bt]:Zt?[En/Zt,Nn/Zt]:[NaN,NaN];return En=Nn=Zt=Ba=$a=Bt=Sn=Cn=ea=0,e}};function Rt(e,a){En+=e,Nn+=a,++Zt}function Br(){tt.point=jd}function jd(e,a){tt.point=Ed,Rt(ut=e,mt=a)}function Ed(e,a){var r=e-ut,n=a-mt,o=Ot(r*r+n*n);Ba+=o*(ut+e)/2,$a+=o*(mt+a)/2,Bt+=o,Rt(ut=e,mt=a)}function $r(){tt.point=Rt}function Nd(){tt.point=Cd}function Sd(){Jo(Qo,Ko)}function Cd(e,a){tt.point=Jo,Rt(Qo=ut=e,Ko=mt=a)}function Jo(e,a){var r=e-ut,n=a-mt,o=Ot(r*r+n*n);Ba+=o*(ut+e)/2,$a+=o*(mt+a)/2,Bt+=o,o=mt*e-ut*a,Sn+=o*(ut+e),Cn+=o*(mt+a),ea+=o*3,Rt(ut=e,mt=a)}function Xo(e){this._context=e}Xo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,rt);break}}},result:nt};var zn=new Lt,nn,Zo,ei,ta,aa,da={point:nt,lineStart:function(){da.point=zd},lineEnd:function(){nn&&ti(Zo,ei),da.point=nt},polygonStart:function(){nn=!0},polygonEnd:function(){nn=null},result:function(){var e=+zn;return zn=new Lt,e}};function zd(e,a){da.point=ti,Zo=ta=e,ei=aa=a}function ti(e,a){ta-=e,aa-=a,zn.add(Ot(ta*ta+aa*aa)),ta=e,aa=a}let Ur,Ua,Hr,Vr;class Wr{constructor(a){this._append=a==null?ai:Ad(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Hr||this._append!==Ua){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Hr=n,Ua=this._append,Vr=this._,this._=o}this._+=Vr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ai(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Ad(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ai;if(a!==Ur){const r=10**a;Ur=a,Ua=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ua}function qd(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),_t(l,o(i))),i.result()}return d.area=function(l){return _t(l,o(vt)),vt.result()},d.measure=function(l){return _t(l,o(da)),da.result()},d.bounds=function(l){return _t(l,o(_a)),_a.result()},d.centroid=function(l){return _t(l,o(tt)),tt.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,yn):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new Wr(r)):new Xo(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const s=Math.floor(l);if(!(s>=0))throw new RangeError(`invalid digits: ${l}`);r=s}return a===null&&(i=new Wr(r)),d},d.projection(e).digits(r).context(a)}function _n(e){return function(a){var r=new An;for(var n in e)r[n]=e[n];return r.stream=a,r}}function An(){}An.prototype={constructor:An,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Bn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),_t(r,e.stream(_a)),a(_a.result()),n!=null&&e.clipExtent(n),e}function ni(e,a,r){return Bn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,s=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,s])},r)}function Td(e,a,r){return ni(e,[[0,0],a],r)}function Ld(e,a,r){return Bn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function Rd(e,a,r){return Bn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var Gr=16,Fd=Re(30*Xe);function Yr(e,a){return+a?Md(e,a):Od(e)}function Od(e){return _n({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Md(e,a){function r(n,o,i,d,l,s,g,p,x,u,b,m,w,k){var f=g-n,v=p-o,j=f*f+v*v;if(j>4*a&&w--){var y=d+u,N=l+b,E=s+m,S=Ot(y*y+N*N+E*E),L=sa(E/=S),T=Ae(Ae(E)-1)<Se||Ae(i-x)<Se?(i+x)/2:ia(N,y),I=e(T,L),M=I[0],U=I[1],q=M-n,R=U-o,h=v*q-f*R;(h*h/j>a||Ae((f*q+v*R)/j-.5)>.3||d*u+l*b+s*m<Fd)&&(r(n,o,i,d,l,s,M,U,T,y/=S,N/=S,E,w,k),k.point(M,U),r(M,U,T,y,N,E,g,p,x,u,b,m,w,k))}}return function(n){var o,i,d,l,s,g,p,x,u,b,m,w,k={point:f,lineStart:v,lineEnd:y,polygonStart:function(){n.polygonStart(),k.lineStart=N},polygonEnd:function(){n.polygonEnd(),k.lineStart=v}};function f(L,T){L=e(L,T),n.point(L[0],L[1])}function v(){x=NaN,k.point=j,n.lineStart()}function j(L,T){var I=Ut([L,T]),M=e(L,T);r(x,u,p,b,m,w,x=M[0],u=M[1],p=L,b=I[0],m=I[1],w=I[2],Gr,n),n.point(x,u)}function y(){k.point=f,n.lineEnd()}function N(){v(),k.point=E,k.lineEnd=S}function E(L,T){j(o=L,T),i=x,d=u,l=b,s=m,g=w,k.point=j}function S(){r(x,u,p,b,m,w,i,d,o,l,s,g,Gr,n),k.lineEnd=y,y()}return k}}var Dd=_n({point:function(e,a){this.stream.point(e*Xe,a*Xe)}});function Id(e){return _n({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Pd(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function Qr(e,a,r,n,o,i){if(!i)return Pd(e,a,r,n,o);var d=Re(i),l=Fe(i),s=d*e,g=l*e,p=d/e,x=l/e,u=(l*r-d*a)/e,b=(l*a+d*r)/e;function m(w,k){return w*=n,k*=o,[s*w-g*k+a,r-g*w-s*k]}return m.invert=function(w,k){return[n*(p*w-x*k+u),o*(b-x*w-p*k)]},m}function _d(e){return Bd(function(){return e})()}function Bd(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,s=0,g=0,p,x=0,u=1,b=1,m=null,w=_r,k=null,f,v,j,y=yn,N=.5,E,S,L,T,I;function M(h){return L(h[0]*Xe,h[1]*Xe)}function U(h){return h=L.invert(h[0],h[1]),h&&[h[0]*xt,h[1]*xt]}M.stream=function(h){return T&&I===h?T:T=Dd(Id(p)(w(E(y(I=h)))))},M.preclip=function(h){return arguments.length?(w=h,m=void 0,R()):w},M.postclip=function(h){return arguments.length?(y=h,k=f=v=j=null,R()):y},M.clipAngle=function(h){return arguments.length?(w=+h?gd(m=h*Xe):(m=null,_r),R()):m*xt},M.clipExtent=function(h){return arguments.length?(y=h==null?(k=f=v=j=null,yn):bd(k=+h[0][0],f=+h[0][1],v=+h[1][0],j=+h[1][1]),R()):k==null?null:[[k,f],[v,j]]},M.scale=function(h){return arguments.length?(r=+h,q()):r},M.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],q()):[n,o]},M.center=function(h){return arguments.length?(i=h[0]%360*Xe,d=h[1]%360*Xe,q()):[i*xt,d*xt]},M.rotate=function(h){return arguments.length?(l=h[0]%360*Xe,s=h[1]%360*Xe,g=h.length>2?h[2]%360*Xe:0,q()):[l*xt,s*xt,g*xt]},M.angle=function(h){return arguments.length?(x=h%360*Xe,q()):x*xt},M.reflectX=function(h){return arguments.length?(u=h?-1:1,q()):u<0},M.reflectY=function(h){return arguments.length?(b=h?-1:1,q()):b<0},M.precision=function(h){return arguments.length?(E=Yr(S,N=h*h),R()):Ot(N)},M.fitExtent=function(h,A){return ni(M,h,A)},M.fitSize=function(h,A){return Td(M,h,A)},M.fitWidth=function(h,A){return Ld(M,h,A)},M.fitHeight=function(h,A){return Rd(M,h,A)};function q(){var h=Qr(r,0,0,u,b,x).apply(null,a(i,d)),A=Qr(r,n-h[0],o-h[1],u,b,x);return p=ld(l,s,g),S=bn(a,A),L=bn(p,S),E=Yr(S,N),R()}function R(){return T=I=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&U,q()}}function ri(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}ri.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Ae(o)>Se&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function $d(){return _d(ri).scale(175.295)}function Ud(e){return e}function Hd(e){if(e==null)return Ud;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,s){s||(a=r=0);var g=2,p=l.length,x=new Array(p);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+d;g<p;)x[g]=l[g],++g;return x}}function Vd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Wd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Kr(e,r)})}:Kr(e,a)}function Kr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Gd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Gd(e,a){var r=Hd(e.transform),n=e.arcs;function o(p,x){x.length&&x.pop();for(var u=n[p<0?~p:p],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));p<0&&Vd(x,m)}function i(p){return r(p)}function d(p){for(var x=[],u=0,b=p.length;u<b;++u)o(p[u],x);return x.length<2&&x.push(x[0]),x}function l(p){for(var x=d(p);x.length<4;)x.push(x[0]);return x}function s(p){return p.map(l)}function g(p){var x=p.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:p.geometries.map(g)};case"Point":u=i(p.coordinates);break;case"MultiPoint":u=p.coordinates.map(i);break;case"LineString":u=d(p.arcs);break;case"MultiLineString":u=p.arcs.map(d);break;case"Polygon":u=s(p.arcs);break;case"MultiPolygon":u=p.arcs.map(s);break;default:return null}return{type:x,coordinates:u}}return g(a)}const oi={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Yd=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Qd(e,a,r){const n=oi[e];if(!n||!n.length)return-1;const o=Yd(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let wa=null;function Kd(){return wa||(wa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Wd(r,n),i=$d().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=qd(i),l=(o.features||[]).filter(p=>{var x;return(((x=p.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(p=>{var b;const x=((b=p.properties)==null?void 0:b.name)||"",u=d(p)||"";return u?{i2:os(x)||null,n:x,d:u}:null}).filter(p=>!!p);if(!l.length)return null;const s={};for(const[p,x]of Object.entries(is)){const u=i(x);u&&(s[p]={x:u[0],y:u[1]})}const g={};for(const[p,x]of Object.entries(oi)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(g[p]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:s,metros:g}}catch{return null}})(),wa)}function Jd(e){const[a,r]=c.useState(null);return c.useEffect(()=>{if(!e||a)return;let n=!1;return Kd().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Xd="8 40 984 210",Zd={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Jr=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function Xr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ep(e,a){const[r,n]=c.useState(1);return c.useEffect(()=>{let o=!0,i=0;const d=()=>{var g;if(!o)return;const s=(g=e.current)==null?void 0:g.getScreenCTM();s&&s.a>0?n(s.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function Zr({msgs:e}){const[a,r]=c.useState(0);c.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function tp(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:s,data:g,dossiers:p,source:x}=K(),u=g.loading&&!p.length,b=c.useRef(null),m=c.useRef(null),w=Jd(e.continent==="monde"),k=e.continent==="monde"?w:Fn.find(h=>h.key===e.continent)||null,f=ep(b,e.continent+":"+e.mapFolded+":"+!!k),[v,j]=c.useState(new Map),[y,N]=c.useState(null);c.useEffect(()=>{const h=b.current;if(!h)return;const A=new Map;h.querySelectorAll("path[data-i2]").forEach($=>{const X=$.dataset.i2;if(X)try{const z=$.getBBox();z.width>0&&A.set(X,{x:z.x,y:z.y,w:z.width,h:z.height})}catch{}}),j(A)},[e.continent,f,k]);const E=c.useMemo(()=>r.filter(h=>h.cc),[r]),S=c.useMemo(()=>{const h=new Map;return E.forEach(A=>h.set(A.cc,(h.get(A.cc)||0)+1)),h},[E]),L=e.continent==="monde"&&w?w.anchors:null,T=e.continent==="monde"&&w?w.metros:null,I=c.useMemo(()=>E.map(h=>{const A=Xr(h.name||h.id||""),$=Xr((h.id||h.name||"")+"·y");if(L&&h.cc){const _=T?T[h.cc]:void 0;if(_&&_.length){const ee=Qd(h.cc,h.city,A);if(ee>=0&&_[ee])return{d:h,x:_[ee].x+(A-.5)*5,y:_[ee].y+($-.5)*5}}const J=L[h.cc];if(J)return{d:h,x:J.x+(A-.5)*10,y:J.y+($-.5)*10}}const X=h.cc?v.get(h.cc):void 0;if(!X)return null;const z=Zd[`${e.continent}:${h.cc||""}`];if(z)return{d:h,x:X.x+X.w*(z.fx+(A-.5)*z.sx),y:X.y+X.h*(z.fy+($-.5)*z.sy)};const D=(A-.5)*Math.min(X.w*.55,60),O=($-.5)*Math.min(X.h*.55,60);return{d:h,x:X.x+X.w/2+D,y:X.y+X.h/2+O}}).filter(h=>!!h),[E,v,L,T,e.continent]),M=h=>f>0?h/f:h,U=c.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:Jr[h],fr:s.plabels[h],en:s.plabels[h],n:r.filter(A=>A.kind==="target"&&Ce(A)===h).length})).filter(h=>h.n>0):nr.map((h,A)=>({...h,n:r.filter($=>rr($)===A).length})),[r,n,s.plabels]),q=i?d.get(i):null,R=q?I.find(h=>h.d.id===q.id):null;return k?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Zr,{msgs:s.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?Xd:k.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?k.fr:k.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:k.countries.map((h,A)=>t.jsx("g",{className:"ct"+(h.i2&&S.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},A))}),t.jsx("g",{children:I.map(h=>{const A=nr[rr(h.d)],$=!!Ie(h.d),X=h.d.kind==="target",z=n&&X?Jr[Ce(h.d)]:A.c,D=!n&&_e(h.d);return t.jsxs("g",{className:"co"+(D?" done":""),onMouseEnter:()=>{var J,ee;const O=(J=m.current)==null?void 0:J.getBoundingClientRect(),_=(ee=b.current)==null?void 0:ee.createSVGPoint();if(_&&b.current&&O){_.x=h.x,_.y=h.y;const ge=_.matrixTransform(b.current.getScreenCTM());N({x:ge.x-O.left,y:ge.y-O.top,label:h.d.name+" · "+(Gt(h.d.cc,l)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var J;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const O=(J=b.current)==null?void 0:J.createSVGPoint();let _=null;if(O&&b.current){O.x=h.x,O.y=h.y;const ee=O.matrixTransform(b.current.getScreenCTM());_={x:ee.x,y:ee.y}}a({type:"popup",id:h.d.id,anchor:_})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:M(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:M(A.px),fill:z,stroke:$?"#E5484D":"#ffffff",strokeWidth:M($?2.2:1.3)})]},h.d.id||h.d.name)})}),R&&t.jsx("circle",{className:"ring on",cx:R.x,cy:R.y,r:M(13),fill:"none",stroke:"#16233A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(y?" on":""),style:y?{left:y.x,top:y.y}:void 0,children:y==null?void 0:y.label}),t.jsx("div",{className:"legend",children:U.map((h,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),l==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},A))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",s.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Zr,{msgs:s.loadMsgs})})}function ap(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function ii({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=K(),s=a.filters,[g,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null),m=c.useRef(null),w=c.useMemo(()=>a.continent==="monde"?n:n.filter(R=>R.continent===a.continent),[n,a.continent]),k=R=>w.filter(h=>R!=="country"&&s.country.length&&!s.country.includes(h.cc||"")?!1:Fa(h,s,i,R==="country"?void 0:R)),f=R=>!i||R.kind!=="op",v=c.useMemo(()=>{const R=k("win").filter(f),h=A=>R.filter($=>($.date?Math.max(0,Math.floor((Date.now()-Date.parse($.date))/864e5)):9999)<=A).length;return[h(0),h(7),h(30),R.length]},[w,s,i]),j=c.useMemo(()=>s.day?k("win").filter(f).filter(R=>(R.date||"").slice(0,10)===s.day).length:0,[w,s,i]),y=(s.signalOnly?1:0)+s.sector.length+s.market.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+s.crible.length,N=y+(s.acquirer.trim()?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0);c.useEffect(()=>{a.openFacet&&p(!1)},[a.openFacet]),c.useEffect(()=>{if(!g&&!x)return;const R=A=>{var X,z;const $=A.target;g&&!((X=b.current)!=null&&X.contains($))&&p(!1),x&&!((z=m.current)!=null&&z.contains($))&&u(!1)},h=A=>{A.key==="Escape"&&(p(!1),u(!1))};return document.addEventListener("mousedown",R),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",R),document.removeEventListener("keydown",h)}},[g,x]);const E=(R,h,A,$="fbtn")=>t.jsxs("button",{type:"button",className:$,"aria-expanded":a.openFacet===R,onClick:()=>r({type:"openFacet",facet:R}),children:[t.jsx("span",{className:"fl",children:h}),A>0&&t.jsx("span",{className:"n",children:A}),t.jsx("span",{className:"cv",children:"▾"})]},R),S=["1","7","30","all"],L=Math.max(0,S.indexOf(s.win||"all")),T=s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(ap(s.day,l))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(R=>!R),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:v[L]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:S.map((R,h)=>t.jsxs("button",{type:"button",role:"option","aria-selected":s.win===R,onClick:()=>{r({type:"filters",patch:{win:R}}),u(!1)},children:[o.datesShort[h],t.jsx("span",{className:"n",children:v[h]})]},R))})]}):t.jsx("div",{className:"seg",children:S.map((R,h)=>t.jsxs("button",{type:"button","aria-pressed":s.win===R,onClick:()=>r({type:"filters",patch:{win:R}}),children:[t.jsx("span",{className:"sl",children:o.dates[h]}),t.jsx("b",{children:v[h]})]},R))}),I=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:s.search,onChange:R=>r({type:"filters",patch:{search:R.target.value}})})]}),M=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):E("sec",o.fSector,s.sector.length),(n.some(R=>!!R.market)||s.market.length>0)&&E("mar",o.fMarket,s.market.length),E("pay",o.fCountry,s.country.length),E("det",o.fEngine,s.engine.length),E("sta",o.fStage,s.stage.length),i&&E("crib",o.fVerdict,s.crible.length),i&&E("ang","Angle",s.angle.length),i&&E("mem","Mémo",s.memoLevel.length)]}),U=(R=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),R&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),q=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(y?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{p(R=>!R),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),y>0&&t.jsx("span",{className:"n",children:y}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:M})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(s.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:T}),t.jsxs("div",{className:"fstrip-b",children:[I,q,U(!1)]})]}),a.openFacet&&t.jsx(eo,{poolFor:k})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[T,I,M,t.jsx("span",{className:"fgrow"}),U()]}),a.openFacet&&t.jsx(eo,{poolFor:k})]})}function eo({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=K(),l=a.filters,s=a.openFacet,{title:g,cols:p,options:x}=c.useMemo(()=>{if(s==="sig"){const k=e("signal").filter(j=>Ie(j)),f=new Map;k.forEach(j=>{const y=j.engine||"";f.set(y,(f.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:k.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...un([...f.keys()],o).map(j=>({v:j,label:Tt(j)+" "+Ze(j,o),n:f.get(j)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(s==="crib"){const k=e("crible").filter(v=>!i||go(v,a.ptab,d.favIds)),f=new Map;return k.forEach(v=>{const j=xo(v);j&&j!=="NEW"&&f.set(j,(f.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((v,j)=>(or[v[0]]??9)-(or[j[0]]??9)||j[1]-v[1]).map(([v,j])=>({v,label:'<span class="fdot" style="background:'+(ss[v]||"#94A3B8")+'"></span>'+v,n:j,html:!0,on:l.crible.includes(v)}))}}if(s==="sec"){const k=e("sector"),f=new Map;return k.forEach(v=>{v.sector&&f.set(v.sector,(f.get(v.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:l.sector.includes(v)}))}}if(s==="mar"){const k=e("market"),f=new Map;return k.forEach(v=>{v.market&&f.set(v.market,(f.get(v.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:l.market.includes(v)}))}}if(s==="pay"){const k=e("country"),f=new Map;return k.forEach(v=>{v.cc&&f.set(v.cc,(f.get(v.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:Gt(v,o)||v,n:j,html:!1,on:l.country.includes(v)}))}}if(s==="det"){const k=e("engine"),f=new Map;return k.forEach(v=>{v.engine&&f.set(v.engine,(f.get(v.engine)||0)+1)}),{title:n.fEngine,cols:2,options:un([...f.keys()],o).map(v=>({v,label:Tt(v)+" "+Ze(v,o)+' <span style="color:var(--dim);font-size:10px">· '+ls(ds(v),o)+"</span>",n:f.get(v)||0,html:!0,on:l.engine.includes(v)}))}}if(s==="ang"){const k=e("angle"),f=new Map;return k.forEach(v=>{v.angle&&f.set(v.angle,(f.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v.replace(/[_-]+/g," "),n:j,html:!1,on:l.angle.includes(v)}))}}if(s==="mem"){const k=e("memoLevel"),f=new Map;k.forEach(j=>{if(j.kind==="target"){const y=Ln(j);f.set(y,(f.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:v[j],n:f.get(j)||0,html:!1,on:l.memoLevel.includes(j)}))}}const m=e("stage"),w=new Map;return m.forEach(k=>{k.stage&&w.set(k.stage,(w.get(k.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:k,n:f,html:!1,on:l.stage.includes(k)}))}},[s,a,o]),u=m=>{if(s==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const k=l.signalEngines.includes(m)?l.signalEngines.filter(f=>f!==m):[...l.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:k}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage",value:m})},b=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:g}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>u(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function si({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=K(),s=c.useMemo(()=>{const b={};return r.forEach(m=>{Fa(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,p]=c.useState(!1),x=c.useRef(null);c.useEffect(()=>{if(!g)return;const b=w=>{var k;(k=x.current)!=null&&k.contains(w.target)||p(!1)},m=w=>{w.key==="Escape"&&p(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const u=b=>{const m=Fn.find(w=>w.key===b);return b==="monde"?l.contWorld:d==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>p(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:s[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:ir.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),p(!1)},children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[ir.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function qn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function li(e){return"atl2:evalq:"+(e||"anon")}function np(e,a){const r=li(e),n=qn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function di(){const{t:e,data:a,dossiers:r}=K(),n=a.session.token||"",o=li(n),[i,d]=c.useState(()=>qn(o)),l=c.useRef(!1),[s,g]=c.useState(!1);c.useEffect(()=>{try{const z=i.slice(0,30).map(({descBusy:D,evalBusy:O,..._})=>_);localStorage.setItem(o,JSON.stringify(z)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[i,o]),c.useEffect(()=>{const z=()=>{if(l.current)return;const D=qn(o);d(O=>JSON.stringify(O.map(({descBusy:_,evalBusy:J,...ee})=>ee))===JSON.stringify(D)?O:D)};return window.addEventListener("atl2:evalq",z),window.addEventListener("storage",z),()=>{window.removeEventListener("atl2:evalq",z),window.removeEventListener("storage",z)}},[o]);const[p,x]=c.useState([]),[u,b]=c.useState(""),[m,w]=c.useState(!1),[k,f]=c.useState(!1),[v,j]=c.useState(""),y=c.useCallback((z,D)=>d(O=>O.map((_,J)=>J===z?{..._,...D}:_)),[]),N=c.useCallback((z,D)=>{const O=D.trim();O&&(y(z,{name:O,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),On(O).then(_=>{const J=_.candidates||[];_.website?y(z,{site:_.website,status:"ready"}):J.length===1?y(z,{site:J[0].url,status:"ready"}):J.length>1?y(z,{status:"pick",candidates:J.slice(0,4)}):y(z,{status:"ready"})}).catch(()=>y(z,{status:"ready"})))},[y]),E=c.useCallback((z,D,O)=>{y(z,{descBusy:!0}),yo(n,D,O).then(_=>{if(_.quota){g(!0),y(z,{descBusy:!1,descDone:!0});return}const J=_.blocs||{},ee=(J.synthese||J.value_prop||J.produit||J.modele||"").trim();y(z,{descBusy:!1,descDone:!0,desc:ee})}).catch(()=>y(z,{descBusy:!1,descDone:!0}))},[y,n]);c.useEffect(()=>{const z=i.findIndex(O=>O.auto&&O.name.trim()&&O.status==="");if(z>=0){N(z,i[z].name);return}if(s)return;const D=i.findIndex(O=>O.status==="ready"&&O.site&&!O.descDone&&!O.descBusy);D>=0&&E(D,i[D].name,i[D].site)},[i,N,E,s]);const[S,L]=c.useState(!1),T=c.useCallback(async(z,D)=>{y(z,{evalBusy:!0});const O=await wo(n,(D.site||D.name).trim(),"atelier2");return O.verdict==="quota"?(y(z,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:O.reason||"",remaining:0}})),!1):(y(z,{evalBusy:!1,status:O.verdict==="kept"?"kept":"out",reason:O.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:O.company||D.name,verdict:O.verdict,reason:O.reason||"",remaining:O.remaining??null}})),!0)},[y,n]),I=async()=>{if(S)return;const z=i.map((D,O)=>({r:D,i:O})).filter(({r:D})=>D.name.trim()&&D.status!=="kept"&&D.status!=="out"&&D.status!=="resolving");if(z.length){L(!0);for(const{r:D,i:O}of z)if(!await T(O,D))break;L(!1)}},M=c.useMemo(()=>{const z=new Set,D=[];return i.filter(O=>O.status==="kept").forEach(O=>{const _=O.name.trim().toLowerCase();_&&!z.has(_)&&(z.add(_),D.push(O.name.trim()))}),r.filter(O=>Ce(O)>=1&&Ce(O)<=4&&(O.website||O.domain)).forEach(O=>{const _=(O.name||"").trim().toLowerCase();_&&!z.has(_)&&(z.add(_),D.push((O.name||"").trim()))}),D},[i,r]),U=c.useMemo(()=>{const z=new Set;return r.forEach(D=>{const O=(D.name||"").trim().toLowerCase();O&&z.add(O)}),i.forEach(D=>{const O=D.name.trim().toLowerCase();O&&z.add(O)}),z},[r,i]),q=async()=>{if(u||!M.length)return;f(!1);const z=[];for(const D of M.slice(0,2)){b(D);const O=await ko(n,D);if(O){if(O.verdict==="quota"){w(!0);break}(O.results||[]).forEach(_=>{const J=(_.company||"").trim().toLowerCase();!J||U.has(J)||z.some(ee=>ee.name.toLowerCase()===J)||z.push({name:(_.company||"").trim(),verdict:_.verdict||"",reason:_.reason,from:D})})}}b(""),f(!0),x(D=>[...z,...D].slice(0,24))},R=async(z,D)=>{if(u)return;f(!1),b(z==="thesis"?e.pxThesis:D);const O=await ps(n,z,D,6);if(b(""),f(!0),!O)return;if(O.verdict==="quota"){w(!0);return}const _=[];(O.results||[]).forEach(J=>{const ee=(J.company||"").trim().toLowerCase();!ee||U.has(ee)||_.some(ge=>ge.name.toLowerCase()===ee)||_.push({name:(J.company||"").trim(),verdict:J.verdict||"",reason:J.reason,from:z==="thesis"?e.pxThesis:D})}),x(J=>[..._,...J].slice(0,24))},h=()=>{const z=v.trim();z.length<3||R(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(z)?"registry":"keyword",z)},A=z=>{d(D=>[...D,{name:z.name,site:"",status:"",auto:!0}].slice(0,30)),x(D=>D.filter(O=>O.name!==z.name))},$=i.filter(z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out").length,X=z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving"&&!z.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((z,D)=>t.jsxs("div",{className:"eq-row"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsx("input",{value:z.name,placeholder:e.eqNamePh,onChange:O=>{const _=O.target.value.split(`
`).map(J=>J.trim()).filter(Boolean);_.length>1?d(J=>{const ee=[...J];return ee.splice(D,1,..._.map(ge=>({name:ge,site:"",status:"",auto:!0}))),ee.slice(0,30)}):y(D,{name:O.target.value})},onBlur:()=>{z.name.trim()&&!z.site&&z.status!=="resolving"&&z.status!=="pick"&&N(D,z.name)},onKeyDown:O=>{O.key==="Enter"&&N(D,z.name)}}),t.jsxs("span",{className:"eq-site",children:[z.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),z.status==="pick"&&(z.candidates||[]).map(O=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>y(D,{site:O.url,status:"ready",candidates:void 0}),children:(O.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},O.url)),z.status!=="resolving"&&z.status!=="pick"&&(z.site?t.jsxs("a",{href:z.site.startsWith("http")?z.site:"https://"+z.site,target:"_blank",rel:"nofollow noopener",children:[z.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:z.name.trim()&&z.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:z.desc||"",children:z.descBusy?t.jsx("i",{children:e.eqDescBusy}):z.desc?z.desc:t.jsx("em",{children:z.descDone?s?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(z.status||"vide"),title:z.reason||"",children:z.status==="kept"?"✓ "+e.kept:z.status==="out"?"✗ "+e.dropped:z.status==="ready"?e.eqReady:z.status==="pick"?e.eqPick:""}),t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!X(z)||S,onClick:()=>{T(D,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>d(O=>O.filter((_,J)=>J!==D)),children:"×"})]},D)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>d(z=>[...z,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!u,onClick:()=>{R("thesis","")},children:u===e.pxThesis?e.sgBusy(u):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:v,placeholder:e.pxPlace,onChange:z=>j(z.target.value),onKeyDown:z=>{z.key==="Enter"&&h()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u||v.trim().length<3,onClick:h,children:e.pxGoFree}),!!M.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u,onClick:()=>{q()},children:u&&u!==e.pxThesis&&u!==v?e.sgBusy(u):e.sgGo}),!!M.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(M[0],M.length)}),m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),k&&!p.length&&!m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),p.map(z=>t.jsxs("span",{className:"eq-sc"+(z.verdict==="kept"?" ok":""),title:(z.reason||"")+" — "+e.sgVia(z.from),children:[t.jsx("b",{children:z.name}),z.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>A(z),children:"+"})]},z.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),i.some(z=>z.status==="kept"||z.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>d(z=>z.filter(D=>D.status!=="kept"&&D.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(S?" loading":""),style:{justifyContent:"center"},disabled:S||!$,onClick:()=>{I()},children:[t.jsx("span",{className:"fill"}),S?e.eqRunning:e.eqGo($)]})]})]})]})}function pi(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function ci(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function to({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=K();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(s=>s.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(s=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:s.name}),s.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),s.line1&&t.jsx("p",{className:"w",children:s.line1}),s.line2&&t.jsx("p",{className:"r",children:s.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(s.name),children:l.rsEvalOne})]},s.name))})]}):null}function $n({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=K(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(to,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(to,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function rp({card:e,onEvaluate:a,onAddAll:r}){var l,s,g;const{t:n}=K(),o=[e.industry,...e.market_tags||[],e.author].map(p=>(p||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(p=>p&&p.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(p=>t.jsx("span",{children:p},p))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:pi(e.summary_md||"").map((p,x)=>t.jsx("p",{children:p},x))})]}),t.jsx($n,{card:e,onEvaluate:a,onAddAll:r}),(((s=e.prospective)==null?void 0:s.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(p=>t.jsx("li",{children:p},p))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(p=>t.jsx("a",{href:p.url,target:"_blank",rel:"noopener noreferrer",children:p.label||p.url},p.url))})]})]})}function op(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function ip({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=K(),l=o,[s,g]=c.useState(null),[p,x]=c.useState(null),[u,b]=c.useState(null),[m,w]=c.useState(!1);c.useEffect(()=>{let f=!0;return(async()=>{const v=await jo({email:d,cbToken:l});f&&g(v)})(),()=>{f=!1}},[d,l,n]);const k=f=>{x(f),b(null),w(!0),(async()=>{const v=await cs(f.id);b(v),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[p?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),p&&t.jsx("span",{className:"ti",children:p.title}),!p&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!p&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(s||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>k(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[op(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),p&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[p.source_url&&t.jsx("a",{href:p.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),p.published&&p.page_url&&t.jsx("a",{href:p.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(p.published?" on":""),children:p.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(rp,{card:u,onEvaluate:a,onAddAll:r})]})]})}const sp={deals:"ma-deals",news:"veille"};function ao(e){return(e.url||e.title||"").trim()}function lp({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,email:i,askEvaluate:d,canWrite:l}=K(),[s,g]=c.useState(null),[p,x]=c.useState({deals:[],news:[]}),[u,b]=c.useState({deals:!1,news:!1}),[m,w]=c.useState(null),[k,f]=c.useState(""),[v,j]=c.useState(""),[y,N]=c.useState(null),E=c.useRef(!1),S=c.useCallback(async q=>{if(!o||u[q])return;w(q),f("");const R=await us(sp[q],o,n);if(w(null),!R.ok&&R.error){f(R.error);return}x(h=>({...h,[q]:R.items})),b(h=>({...h,[q]:!0}))},[o,n,u]);c.useEffect(()=>{s&&S(s)},[s,S]);const L=c.useCallback(q=>p[q].map(ao).filter(Boolean),[p]),T=c.useMemo(()=>{var h,A;if(!o)return{deals:[],news:[]};const q={deals:L("deals"),news:L("news")},R=To("feed:"+o,q);return{deals:((h=R.deals)==null?void 0:h.noms)||[],news:((A=R.news)==null?void 0:A.noms)||[]}},[o,L]),I=c.useRef(null);c.useEffect(()=>{I.current&&!s&&o&&Lo("feed:"+o,{deals:L("deals"),news:L("news")}),I.current=s},[s,o,L]);const M=async q=>{const R=(q.url||"").trim();if(!R||!/^https?:\/\//i.test(R)||E.current)return;E.current=!0,j(R),N(null);const h=await Eo({url:R,email:i,cbToken:e});E.current=!1,j(""),N(h)},U=q=>{const R=p[q],h=new Set(T[q].map(A=>A.toLowerCase()));return t.jsxs("div",{className:"dfpane"+(s===q?" on":""),hidden:s!==q,children:[t.jsx("p",{className:"dfh",children:q==="deals"?r.feedDealsH:r.feedNewsH}),m===q&&t.jsx("p",{className:"dfload",children:n==="en"?"Loading…":"Chargement…"}),s===q&&!!k&&t.jsx("p",{className:"dferr",children:k}),u[q]&&!R.length&&!m&&t.jsx("p",{className:"dfempty",children:q==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!R.length&&t.jsx("ul",{className:"dflist",children:R.map((A,$)=>{const X=ao(A),z=h.has(X.toLowerCase()),D=(A.url||"").trim();return t.jsxs("li",{className:z?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:A.title||D}),t.jsx("span",{children:[A.source,A.sector_fr,(A.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[D&&t.jsx("a",{href:D,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),D&&/^https?:\/\//i.test(D)&&l&&t.jsx("button",{type:"button",className:"dfan",disabled:!!v,onClick:()=>{M(A)},children:v===D?"…":r.feedAnalyse})]})]},X||$)})})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(q=>{const R=T[q].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(q==="deals"?"ddeals":"dnews")+(s===q?" on":""),onClick:()=>g(s===q?null:q),children:[q==="deals"?r.feedDeals:r.feedNews,R>0&&t.jsx("em",{title:r.feedHint,children:r.feedNew(R)})]},q)}),s&&U(s),y&&t.jsxs("div",{className:"rscard dfrs",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:y.title}),t.jsx("button",{type:"button",className:"rsx",onClick:()=>N(null),children:"×"})]}),t.jsx($n,{card:y,onEvaluate:q=>d(null,q),onAddAll:a}),t.jsx("div",{className:"rsfoot",children:t.jsx("span",{children:r.rsFound(ci(y).length)})})]})]})}const Ca=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function na(e){return/^https?:\/\//i.test((e||"").trim())}function ct(e){const a=(e||"").trim();return a?na(a)?a:Ca.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function dp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function pp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:l,evalBusy:s,evalCards:g,caps:p,data:x,canWrite:u,source:b,dossiers:m,doAnalyse:w,liveMemos:k,pipe:f}=K(),v=r==="client",j=c.useMemo(()=>n||(b!=="default"?ms():""),[n,b]),[y,N]=c.useState(""),[E,S]=c.useState(!1),[L,T]=c.useState(""),[I,M]=c.useState(""),[U,q]=c.useState(""),[R,h]=c.useState(!1),[A,$]=c.useState(!1),[X,z]=c.useState([]);c.useEffect(()=>{const P=oe=>{const re=oe.detail;re&&z(ce=>[re,...ce].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[D,O]=c.useState(!1),[_,J]=c.useState(!1),[ee,ge]=c.useState(!1),ae=c.useRef(!1),[de,ue]=c.useState(""),[fe,ve]=c.useState(""),[xe,ye]=c.useState(!1),[ze,ne]=c.useState(!1),[B,te]=c.useState(0),[H,V]=c.useState(""),[W,ie]=c.useState(null),[le,pe]=c.useState(null),[be,ke]=c.useState(!1),[qe,ot]=c.useState(null),[it,Be]=c.useState(0),Ne=c.useRef(!1),Mt=y.trim()?Ca.test(y.trim())?e.evalUrl:e.evalName:e.evalWaiting;c.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),oe=(P.get("rs")||"").trim(),re=(P.get("rstext")||"").trim();oe&&/^https?:\/\//i.test(oe)&&ue(oe),re&&ve(re),(oe&&/^https?:\/\//i.test(oe)||re)&&O(!0)},[]),c.useEffect(()=>{const P=oe=>{const re=oe.detail||{},ce=String(re.url||"").trim(),je=String(re.text||"").trim();ce&&/^https?:\/\//i.test(ce)&&ue(ce),je&&ve(je),(ce&&/^https?:\/\//i.test(ce)||je)&&(O(!0),N(""),T(""),ye(!0),window.setTimeout(()=>ye(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),c.useEffect(()=>{const P=oe=>{const re=oe.detail||{},ce=String(re.name||"").trim();if(!ce)return;O(!1),N(ce),T(ce);const je=ct(String(re.website||re.domain||""));M(je),q(ct(String(re.url||""))),h(!je),S(!0),window.setTimeout(()=>S(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),c.useEffect(()=>{const P=(L||"").trim();if(!P||D||I){(I||!P||D)&&h(!1);return}const oe=m.find(je=>He(je.name)===He(P)),re=ct((oe==null?void 0:oe.website)||"")||ct((oe==null?void 0:oe.domain)||"");if(re){M(re),h(!1);return}let ce=!0;return h(!0),On(P).then(je=>{var Pe,Te;if(!ce)return;const he=ct(je.website||"")||ct(((Te=(Pe=je.candidates)==null?void 0:Pe[0])==null?void 0:Te.url)||"");he&&M(he)}).catch(()=>{}).finally(()=>{ce&&h(!1)}),()=>{ce=!1}},[L,D,I,m]),c.useEffect(()=>{const P=oe=>{var ce;const re=String(((ce=oe.detail)==null?void 0:ce.url)||"").trim();na(re)&&window.open(re,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),c.useEffect(()=>{if(ae.current===D)return;ae.current=D,ge(!0);const P=window.setTimeout(()=>ge(!1),560);return()=>window.clearTimeout(P)},[D]),c.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),oe=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!oe)return;const re=()=>oe.style.setProperty("--demand-h",`${P.offsetHeight}px`);re();const ce=new ResizeObserver(re);return ce.observe(P),()=>ce.disconnect()},[b,E,xe,A,D,ee,R]),c.useEffect(()=>{if(!u&&!j){ot(null);return}let P=!0;return(async()=>{const oe=await jo({email:o,cbToken:j});P&&ot(oe.length)})(),()=>{P=!1}},[u,j,o,it]);const St=X.length?X:g,Me=x.credits,st=c.useCallback(P=>{np(n,P)&&$(!0)},[n]);c.useEffect(()=>{if(!ze)return;te(0);const P=window.setInterval(()=>te(oe=>oe+1),1e3);return()=>window.clearInterval(P)},[ze]);const ft=c.useMemo(()=>{const P=y.trim().toLowerCase();return!P||!f?null:m.find(oe=>He(oe.name)===P&&Ce(oe)===1)||null},[y,m,f]),Ct=()=>{const P=y.trim();if(P){if(ft){w(ft);return}i(null,P),v&&N("")}},et=async()=>{var re,ce,je;if(Ne.current)return;const P=de.trim().replace(/\s+/g,""),oe=fe.trim();if(!P&&!oe){V(e.rsNeed);return}if(!v&&!j){i(null,P||oe.slice(0,80));return}Ne.current=!0,V(""),ie(null),pe(null),ne(!0);try{const he=await Eo({url:P,text:oe,email:o,cbToken:j});if(ne(!1),!he||he.status!=="success"){V((he==null?void 0:he.message)||"Erreur");return}ie(he),O(!1),st((((re=he.prospective)==null?void 0:re.companies_to_evaluate)||[]).map(Te=>(Te==null?void 0:Te.name)||"")),pe({state:"pending"});const Pe=await hs(he,{email:o,cbToken:j});pe(Pe.ok?{state:"ok",scopeLabel:((ce=Pe.summary)==null?void 0:ce.scope_label)||"",scope:((je=Pe.summary)==null?void 0:je.scope)||""}:{state:"fail",msg:Pe.error||""}),Pe.ok&&Be(Te=>Te+1)}finally{Ne.current=!1,ne(!1)}},zt=[W==null?void 0:W.industry,...(W==null?void 0:W.market_tags)||[],W==null?void 0:W.author].map(P=>(P||"").trim()).filter(Boolean),ht=(le==null?void 0:le.state)==="pending",Dt=le&&(ht?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):le.state==="ok"?t.jsx("span",{className:"rslink ok",children:le.scope&&le.scope!=="public"?e.rsSavedIn(le.scopeLabel||le.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:le.msg,children:e.rsSaveFail})),It=ci(W).length,De=D,Ke=(L||y).trim(),Ve=m.find(P=>He(P.name)===He(Ke)),dt=ct(y)||I||ct((Ve==null?void 0:Ve.website)||"")||ct((Ve==null?void 0:Ve.domain)||""),F=U||ct((Ve==null?void 0:Ve.url)||""),Q=ft?e.actAnalyse:Ke?e.evalGoOn(Ke.length>22?Ke.slice(0,21)+"…":Ke):e.evalGo,Z=ze?`${fs(de.trim())==="youtube"&&de.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(B)}`:ht?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(De?" rs-mode":"")+(L&&y.trim()===L||E||xe?" pair":"")+(E||xe||ee?" echo":"")+(ee?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((De?xe:E)||ee?" flash":"")+((De?de.trim():Ca.test(y.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:De?de:y,placeholder:De?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:De?600:200,spellCheck:De?!1:void 0,inputMode:De?"url":void 0,onChange:P=>{if(De){ue(P.target.value);return}N(P.target.value),L&&P.target.value.trim()!==L&&(T(""),M(""),q(""),h(!1))},onKeyDown:P=>{P.key==="Enter"&&(De?et():Ct())}}),t.jsx("span",{className:"detect"+(De?" off":"")+(Ca.test(y.trim())?" url":""),children:Mt})]}),t.jsx("span",{className:"dacts",children:De?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ze?" loading":""),disabled:ze||ht||!de.trim()&&!fe.trim(),onClick:()=>{et()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Z})]}),t.jsxs("a",{className:"viewbtn"+(na(de)?"":" off"),href:na(de)?de.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{na(de)||P.preventDefault()},children:[t.jsx(dp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ft?" analyse":"")+(s?" loading":""),disabled:s,onClick:Ct,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Q})]}),t.jsxs("a",{className:"viewbtn sm"+(R?" searching":dt?"":" off"),href:dt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":R||void 0,title:R?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{dt||P.preventDefault()},children:[R&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),R?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(F?"":" off"),href:F||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{F||P.preventDefault()},children:e.viewSrc})]})}),p.showCredits&&Me&&t.jsxs("button",{type:"button",className:"credits"+(Me.total_available<=0&&!Me.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Me.unlimited?"∞":Me.total_available}),!Me.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Me.daily_grant+Me.purchased]}),Me.total_available<=0&&!Me.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{l({type:"ptab",tab:0}),$(!1),requestAnimationFrame(()=>{const P=document.querySelector(".atl2.cibles .desk-list");if(!P)return;const oe=window.scrollY+P.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,oe),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(D?" on":""),onClick:()=>O(!D),children:e.rsOpen}),qe!==null&&qe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(be?" on":""),onClick:()=>ke(!be),children:e.rsArchOpen(qe)}),p.pipe&&!!n&&t.jsx(lp,{pageToken:j,onAddNames:st})]}),be&&t.jsx(ip,{bump:it,cbToken:j,onClose:()=>ke(!1),onEvaluate:P=>i(null,P),onAddAll:st}),t.jsx("div",{className:"rsp slim"+(D?" on":" off"),"aria-hidden":!D,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:D?void 0:-1,onClick:()=>J(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:_?"▴":"▾"})]}),_&&t.jsx("textarea",{className:"rstext",value:fe,placeholder:e.rsTextPh,tabIndex:D?void 0:-1,onChange:P=>ve(P.target.value)})]})}),H&&t.jsx("div",{className:"rserr",children:H}),W&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:W.title}),W.source_url&&t.jsx("a",{href:W.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ie(null),pe(null)},children:"×"})]}),W.market&&t.jsx("p",{className:"rsmk",children:W.market}),zt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),zt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[W.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${W.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:pi(W.summary_md||"").map((P,oe)=>t.jsx("p",{children:P},oe))})]}),t.jsx($n,{card:W,onEvaluate:P=>i(null,P),onAddAll:st}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(It)}),Dt]})]}),A&&t.jsx(di,{}),St.slice(0,1).map((P,oe)=>{const re=P.verdict==="kept",ce=P.verdict==="quota",je=P.verdict==="unresolved",he=re?"var(--brand)":ce?"var(--bolt)":je?"var(--blue)":"var(--red)",Pe=re?"var(--brand-l)":ce?"#FFF3D6":je?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":he,"--bgc":Pe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:re?"✓ "+e.kept:ce?"⏳":je?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(Te=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Te.url.startsWith("http")?Te.url:`https://${Te.url}`,target:"_blank",rel:"nofollow noopener",children:[(Te.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Te.url,P.name),children:e.evalPickGo})]},Te.url))}),!ce&&!je&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:re?1:5});const Te=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const gt=[...document.querySelectorAll(".atl2 .list .row")].find(Pt=>{var Je;return(((Je=Pt.querySelector(".rnm"))==null?void 0:Je.textContent)||"").trim().toLowerCase().includes(Te)});gt&&(gt.scrollIntoView({behavior:"smooth",block:"center"}),gt.classList.add("flashrow"),window.setTimeout(()=>gt.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(re?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},oe)}),v&&(d.kept+d.dropped>0||St.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function cp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function up(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=K(),i=e.memoConsole?r.get(e.memoConsole):null,d=c.useMemo(()=>i?[i.reasoning||"",cp(i.summary||"")].filter(Boolean).join(`
...
`).map((g,p)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},p)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[$t(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:s===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Un({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=K(),[d,l]=c.useState(!1),[s,g]=c.useState(null),p=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!p||d)return;l(!0);const u=await ko(r,e);if(l(!1),!u){i(a.actErr);return}g(u.results||[])};return c.useEffect(()=>{if(!p)return;const u=b=>{var w;const m=String(((w=b.detail)==null?void 0:w.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,p]),c.useEffect(()=>{if(p)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,p]),p?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{x()},children:d?a.similarBusy:a.similar}),s&&(s.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:s.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const mp=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ka=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function pa(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}function Tn(e){const a=pa(e);if(!a)return"";try{return new URL(a).hostname.replace(/^www\./,"")}catch{return""}}function fp(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ka(a.slice(n));break}r+=ka(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ka(a.slice(o));break}const d=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(d),s=l?l[2].toLowerCase():"";l&&mp.has(s)?r+=`<${l[1]}${s}>`:r+=ka(a.slice(o,i+1)),n=i+1}return r}const hp=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),no={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function ui(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(hp.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const l=d.name.toLowerCase();(!(no["*"].has(l)||((r=no[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}ui(n)}}function za(e){const a=e.cloneNode(!0);return ui(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const gp={swot:null,summary:"",syn:"",pnl:"",cf:"",roi:"",reco:"",plan:"",pruned:[]},xp=/chiffre|revenu|revenue|\barr\b|ebitda|marge|gross|fcf|free cash|net|total|r[ée]sultat|cash|capex|nopat|moic|irr|\btri\b|roi|entry|\bev\b|invested|synerg/i,bp=[["syn",/synerg/i],["pnl",/compte de r[ée]sultat|p\s*&\s*l|profit\s*(?:and|&)\s*loss|income statement/i],["cf",/flux de tr[ée]sorerie|cash\s*-?\s*flow/i],["roi",/\broi\b|return on investment|retour sur investissement/i],["reco",/verdict post|post[- ]model verdict|conviction quantitative/i]];function Ft(e){return String(e||"").replace(/<script[\s\S]*?<\/script>/gi," ").replace(/<style[\s\S]*?<\/style>/gi," ").replace(/<[^>]+>/g," ").replace(/&nbsp;/gi," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#39;|&apos;/g,"'").replace(/&quot;/g,'"').replace(/\s+/g," ").trim()}function mi(e,a){const r=e.slice(a),n=/<div\b|<\/div\s*>/gi;let o=0,i;for(;i=n.exec(r);)if(i[0][1]!=="/")o+=1;else if(o-=1,o===0)return e.slice(a,a+i.index+i[0].length);return""}function rn(e,a){const n=new RegExp(`<div\\b[^>]*\\bid="${a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}"`,"i").exec(e);return n?mi(e,n.index):""}function vp(e,a=14){const r=e.match(/<tr\b[\s\S]*?<\/tr\s*>/gi)||[];if(r.length<=a)return{html:e,pruned:!1};const n=[];for(let d=0;d<r.length-1;d+=1){const l=r[d],s=/<t[dh]\b[^>]*>([\s\S]*?)<\/t[dh]\s*>/i.exec(l),g=s?Ft(s[1]):"";if((d<2||/<th/i.test(l)||xp.test(g))&&n.push(l),n.length>=a-1)break}n.push(r[r.length-1]);const o=n.length<3?r.slice(0,a):n;return{html:(/^\s*<table\b[^>]*>/i.exec(e)||["<table>"])[0]+o.join("")+"</table>",pruned:!0}}function yp(e,a=14){let r=!1;return{html:e.replace(/<table\b[\s\S]*?<\/table\s*>/gi,o=>{const i=vp(o,a);return r=r||i.pruned,i.html}),pruned:r}}function wp(e){const a={s:[],w:[],o:[],t:[]},r=[["s","s-green"],["w","s-red"],["o","s-blue"],["t","s-orange"]];for(const[n,o]of r){const i=new RegExp(`<div\\b[^>]*class="[^"]*swot-item[^"]*\\b${o}\\b[^"]*"`,"i").exec(e);if(!i)return null;const d=mi(e,i.index);let l=(d.match(/<li\b[^>]*>([\s\S]*?)<\/li\s*>/gi)||[]).map(s=>Ft(s));if(!l.length){const s=/<p\b[^>]*>([\s\S]*?)<\/p\s*>/i.exec(d);s&&(l=[Ft(s[1])])}if(l=l.filter(s=>s&&!/not available/i.test(s)&&!/non disponible/i.test(s)).map(s=>s.slice(0,260)).slice(0,4),!l.length)return null;a[n]=l}return a}function kp(e){const a=e.search(/id=["']company-summary["']/i);if(a<0)return"";const r=e.slice(a,a+9e3),n=/(?:EN R[ÉE]SUM[ÉE]|EN QUELQUES MOTS|IN SUMMARY|IN A FEW WORDS|IN A NUTSHELL|TL;DR)[\s:]*(?:<\/?span[^>]*>[\s:]*)*([\s\S]+?)(?=<br|<hr|<\/div|<h[23]|⚠|✅|🚀|❓|$)/i.exec(r);return n?Ft(n[1]).slice(0,600):""}function jp(e,a,r){if(r<0)return"";const n=/<h3\b[^>]*>([\s\S]*?)<\/h3\s*>/gi;n.lastIndex=r;let o;for(;o=n.exec(e);){if(!a.test(Ft(o[1])))continue;const i=/<h3\b[^>]*>/i.exec(e.slice(o.index+o[0].length));return i?e.slice(o.index,o.index+o[0].length+i.index):e.slice(o.index,Math.min(e.length,o.index+o[0].length+6e4))}return""}function ro(e){let a=e.replace(/^\s*<div\b[^>]*>/i,"").replace(/<\/div\s*>\s*$/i,"");return a=a.replace(/<h2\b[^>]*class="[^"]*section-title[^"]*"[^>]*>[\s\S]*?<\/h2\s*>/gi,""),a=a.replace(/<details\b[\s\S]*?<\/details\s*>/gi,""),a.trim()}function on(e,a){if(e.length<=a)return e;const r=e.slice(0,a),n=r.lastIndexOf(">");return n>=0?r.slice(0,n+1):r}function Ep(e){const a={...gp,pruned:[]};if(!e)return a;try{const n=rn(e,"swot");n&&(a.swot=wp(n))}catch{}try{a.summary=kp(e)}catch{}try{const n=rn(e,"action-plan");if(n){const o=ro(n);a.plan=on(o,12e3)}}catch{}const r=e.search(/id=["']financial-forecast["']/i);for(const[n,o]of bp)try{let i=jp(e,o,r);if(!i)continue;const d=yp(i);i=on(d.html,45e3),Ft(i)&&(a[n]=i,d.pruned&&a.pruned.push(n))}catch{}if(!a.reco)try{const n=rn(e,"conviction");if(n){const o=on(ro(n),8e3);Ft(o)&&(a.reco=o)}}catch{}return a}function Np(e){return e?!!(e.swot||e.summary||e.syn||e.pnl||e.cf||e.roi||e.reco||e.plan):!1}const sn=new Map;function fi(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=sn.get(a);return r||(r=Sp(a).catch(()=>null),r.then(n=>{n||sn.delete(a)}),sn.set(a,r)),r}async function Sp(e){var u,b;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=await a.text(),n=new DOMParser().parseFromString(r,"text/html"),o=m=>{var w;return(((w=n.querySelector(m))==null?void 0:w.textContent)||"").trim()},i=n.querySelector(".sb-score"),d=((u=Array.from((i==null?void 0:i.classList)||[]).find(m=>m.startsWith("sb-score-")))==null?void 0:u.slice(9))||"",l=[];let s=null;const g=Array.from(n.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const m of g){if(m.classList.contains("sb-nav-heading")){s={label:(m.textContent||"").trim(),items:[]},l.push(s);continue}const w=m.getAttribute("href")||"";if(!w.startsWith("#"))continue;const k=w.slice(1),f=zp(n,k);f&&(s||(s={label:"",items:[]},l.push(s)),s.items.push({id:k,title:(m.textContent||"").trim(),html:f,poids:f.length}))}const p=((b=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:b[1])||"",x={score:o(".sb-score"),scoreTone:d,tags:Array.from(n.querySelectorAll(".sb-tag")).map(m=>(m.textContent||"").trim()).filter(Boolean),name:o(".sidebar-company-name"),tagline:o(".sidebar-tagline"),desc:o(".meta-desc"),groups:l.filter(m=>m.items.length),mindmapSlug:n.querySelector(".cm-mindmap-png")?p:"",comite:Cp(n,Ep(r))};return x.groups.length?x:null}function Cp(e,a){const r=n=>{if(!n)return"";const o=e.createElement("div");return o.innerHTML=n,za(o)};return{...a,syn:r(a.syn),pnl:r(a.pnl),cf:r(a.cf),roi:r(a.roi),reco:r(a.reco),plan:r(a.plan)}}const oo={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function zp(e,a){const r=e.getElementById(a),n=r?io(e,r):"";if(n)return n;const o=oo[a]?e.querySelector(oo[a]):null;return o&&o!==r?io(e,o):""}function io(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),za(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(s=>/^h3$/i.test(s.tagName))[0]===a)for(const s of i){if(s===a)break;/^h2$/i.test(s.tagName)||o.appendChild(s.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?za(o):""}return za(a)}const ln=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ue({k:e,v:a,href:r,wide:n}){return a==null||a===""?null:t.jsxs("div",{className:"cdl"+(n?" cdw":""),children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ap({k:e,vals:a}){const r=(a||[]).filter(Boolean);return r.length?t.jsxs("div",{className:"cdl cdw",children:[t.jsx("span",{className:"cdk",children:e}),t.jsx("span",{className:"cdtags",children:r.map(n=>t.jsx("span",{className:"cdtag",children:n},n))})]}):null}function so(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function lo({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const dn=new Map;function qp(e,a){const{token:r}=K(),[n,o]=c.useState(null);return c.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=dn.get(i);d||(d=gs(r,e.name,e.checkId),dn.set(i,d),d.then(s=>{(!s||!s.reasoning&&!s.summaryHtml)&&dn.delete(i)}));let l=!0;return d.then(s=>{l&&s&&o({id:e.id,d:s})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Tp=6e4;function Lp({o:e}){const{t:a,doDeep:r}=K(),[n,o]=c.useState(null),[i,d]=c.useState(e.memoUrl?"load":"off"),[l,s]=c.useState(()=>new Set),[g,p]=c.useState(!1),x=c.useRef(new Map);c.useEffect(()=>{let w=!0;if(s(new Set),p(!1),x.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),fi(e.memoUrl).then(k=>{w&&(o(k),d(k?"ok":"err"))}),()=>{w=!1}},[e.memoUrl]);const u=Nt(e),b=w=>{var k;return(k=x.current.get(w))==null?void 0:k.scrollIntoView({behavior:"smooth",block:"start"})},m=t.jsxs("div",{className:"cdacts",children:[$t(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:w=>{w.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const w=[e.reasoning||"",so(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[w.length?w.join(`

`).split(`

`).map((k,f)=>t.jsx("p",{className:"cdtxt",children:k},f)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),m]})}if(i!=="ok"){const w=[e.reasoning||"",so(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),w.length>0&&w.join(`

`).split(`

`).map((k,f)=>t.jsx("p",{className:"cdtxt",children:k},f)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:k=>{k.stopPropagation(),p(f=>!f)},children:g?a.memoHideHere:a.memoReadHere})}),g&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:k=>k.stopPropagation()}),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(w=>t.jsx("span",{className:"md-tag",children:w},w)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(w=>w.items.map(k=>t.jsx("button",{type:"button",className:"md-jump",onClick:f=>{f.stopPropagation(),b(k.id)},children:k.title},k.id)))}),n.groups.map((w,k)=>t.jsxs("div",{className:"md-grp",children:[w.label&&t.jsx("div",{className:"md-grp-h",children:w.label}),w.items.map(f=>{const v=f.poids>Tp&&!l.has(f.id),j=f.id==="fiche-contact"||f.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:y=>{y&&x.current.set(f.id,y)},children:[t.jsx("h4",{className:"md-h",children:f.title}),j&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:y=>y.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:"LinkedIn"})]}),v?t.jsx("button",{type:"button",className:"abtn md-more",onClick:y=>{y.stopPropagation(),s(N=>new Set(N).add(f.id))},children:a.memoUnfold(Math.round(f.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:f.html}}),!v&&n.mindmapSlug&&f.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Ha}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:y=>y.stopPropagation()})]})]},f.id)})]},w.label||k)),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull})]})}function Rp({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:l}=K(),[s,g]=c.useState(!1),[p,x]=c.useState(!1),[u,b]=c.useState(!1),[m,w]=c.useState(null),[k,f]=c.useState(""),[v,j]=c.useState(null),[y,N]=c.useState(""),E={airtableId:e.airtableId,checkId:e.checkId},S=!!(e.airtableId||e.checkId),L=m&&m.id===e.id?m.entries:[],T=!!m&&m.id===e.id;if(c.useEffect(()=>{f(""),j(null),b(!1)},[e.id]),c.useEffect(()=>{if(!s||T||!S||!o)return;let M=!0;x(!0),b(!1);const U=e.id;return sr(r,"list",E).then(q=>{if(!(!M||U!==e.id)){if(x(!1),!q.ok){b(!0);return}w({id:U,entries:q.entries})}}),()=>{M=!1}},[s,T,S,r,e.id,o]),!n.pipe||!o||!S)return null;const I=(M,U)=>{x(!0);const q=e.id;sr(r,M,E,U).then(R=>{if(q===e.id){if(x(!1),!R.ok){d(a.notesErr);return}w({id:q,entries:R.entries}),b(!1),M==="add"&&(f(""),i(a.notesAdded)),M==="edit"&&j(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":s,onClick:M=>{M.stopPropagation(),g(U=>!U)},children:[t.jsx("b",{children:a.notesT}),L.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(L.length)}),t.jsx("i",{children:s?"▾":"▸"})]}),s&&t.jsxs("div",{className:"dn-b",onClick:M=>M.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),p&&!L.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!p&&!u&&T&&!L.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),L.map(M=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:l==="fr"?M.date.split("-").reverse().join("/"):M.date}),v===M.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:y,rows:3,onChange:U=>N(U.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:p||!y.trim(),onClick:()=>I("edit",{entryId:M.id,text:y.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>j(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:M.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{j(M.id),N(M.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:p,onClick:()=>{window.confirm(a.notesDelAsk)&&I("delete",{entryId:M.id})},children:a.notesDel})]})]})]},M.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:k,onChange:M=>f(M.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:p||!k.trim(),onClick:()=>I("add",{text:k.trim()}),children:a.notesAdd})]})]})]})}function Hn({o:e}){var N;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:d}=K(),l=ua(e),s=Nt(e),g=(e.cribleStatus||"").trim().toUpperCase()||(l==="NO MATCH"?"NO MATCH":l==="MATCH"?"MATCH":""),p=[e.sector,e.market,(e.tags||[]).filter(Boolean).length?"1":"",e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.provQuery,Tn(e.provUrl||""),qa(e),e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,u=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=c.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(g?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||$t(e)?1:0},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:u}].filter(E=>E.n>0),[e,a,o,g,s,p,x,u]),[m,w]=c.useState(""),k=b.some(E=>E.k===m)?m:((N=b[0])==null?void 0:N.k)||"",f=qp(e,k==="eval"||k==="conv");if(!b.length)return null;const v=((f==null?void 0:f.reasoning)||"").length>(e.reasoning||"").length?f.reasoning:e.reasoning||"",j=((f==null?void 0:f.summaryHtml)||"").length>(e.summary||"").length?f.summaryHtml:e.summary||"",y=(f==null?void 0:f.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(E=>t.jsx("button",{type:"button",role:"tab","aria-selected":k===E.k,"data-tour":"tab-"+E.k,className:k===E.k?"on":"",onClick:S=>{S.stopPropagation(),w(E.k)},children:E.lib},E.k))}),t.jsxs("div",{className:"cdbody",onClick:E=>E.stopPropagation(),children:[k==="eval"&&t.jsxs(t.Fragment,{children:[g&&t.jsxs("div",{className:"cdv1"+(g==="NO MATCH"?" out":""),children:[t.jsx("b",{children:g==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(lo,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),v&&v.split(`

`).map((E,S)=>t.jsx("p",{className:"cdtxt",children:E},S)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Fp,{o:e})]}),k==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof y=="number"&&t.jsx(lo,{v:y,sur:100,k:a.cdConvScore}),ln(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",ln(e.verdictDate,r)]})]}),j&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:fp(j)}})]}),k==="memo"&&t.jsx(Lp,{o:e}),k==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ue,{k:a.cdSector,v:e.sector}),t.jsx(Ue,{k:a.cdMarket,v:e.market,wide:!0}),t.jsx(Ap,{k:a.cdTags,vals:e.tags}),t.jsx(Ue,{k:a.cdStage,v:e.stage}),t.jsx(Ue,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ue,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Ue,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Ue,{k:a.cdAngle,v:e.angle}),t.jsx(Ue,{k:a.cdDetected,v:ln(e.date,r)}),t.jsx(Ue,{k:a.cdQuery,v:e.provQuery,wide:!0}),t.jsx(Ue,{k:a.cdSrc,v:Tn(e.provUrl||""),href:pa(e.provUrl||"")}),t.jsx(Ue,{k:a.cdAngleSrc,v:qa(e)})]}),k==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ue,{k:a.cdName,v:e.contactName}),t.jsx(Ue,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Ue,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(Ue,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),k==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(Ue,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(Rp,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(e),children:a.actRegen})]})]})]})]})}const ja=new Map;function Fp({o:e}){const{t:a,token:r}=K(),[n,o]=c.useState(!1),[i,d]=c.useState(null);c.useEffect(()=>{if(!r||!e.name)return;const x=`${r}:${e.name.toLowerCase()}`;let u=ja.get(x);u||(u=No(r,[e.name]).then(m=>m[e.name]||Object.values(m)[0]||null).catch(()=>null),ja.set(x,u),u.then(m=>{(!m||!m.ok)&&ja.delete(x)}));let b=!0;return u.then(m=>{b&&m&&m.ok&&d(m)}),()=>{b=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const x=await yo(r,e.name,e.website||e.domain||"");d(x),x.ok&&ja.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(x)),o(!1)},s=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,s.value_prop],[a.qaProduct,s.produit],[a.qaModel,s.modele],[a.qaSummary,s.synthese]],p=g.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&p&&t.jsxs(t.Fragment,{children:[g.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!p&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function ma({spec:e}){const a=c.useRef(null),r=c.useRef(null),[n,o]=c.useState(!1);return c.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const l=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));lr({kind:"op",card:e},g).then(p=>{!d&&p&&i.isConnected&&i.replaceChildren(p)})},s=window.requestAnimationFrame(l);return()=>{d=!0,window.cancelAnimationFrame(s),i.replaceChildren()}},[e]),c.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;lr({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(s=>{!d&&s&&i.isConnected&&i.replaceChildren(s)});const l=s=>{s.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{d=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Op=`
...
`;function Mp(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:d,top:l}}function Dp(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:l,doAnalyse:s,doDecide:g,doPromote:p,doRepeche:x,doApproach:u,doDeep:b,doOnboard:m,outbound:w,evalBusy:k}=K(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const v=Ie(f),j=Ce(f),y=Nt(f),N=ua(f),E=f.kind==="target",S=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Wt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Op}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Mp(e.popupAnchor,!!f.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(wt(f.date)),Ze(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[f.cc]}),children:(Gt(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>S({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>S({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Yt(f.amountEur,o)})]}),i.pipe&&E&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Tt(f.engine)," ",t.jsx("b",{children:Ze(f.engine,o)})," — ",xs(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),v?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Et,{o:f,lg:!0})," ",t.jsx(Va,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(So(v,o))," · ",n.win7(Co(v,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(ma,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&E&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&E&&t.jsx(Hn,{o:f})]}),t.jsx(Un,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{s(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),$t(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),w&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:k,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Ip(){const{lang:e,token:a,dossiers:r,caps:n}=K(),o=a||"home",{names:i,verdicts:d}=c.useMemo(()=>{const s=[],g={};return r.forEach(p=>{p.kind!=="target"||!p.name||(s.push(p.name),g[p.name]=bs(p)||"")}),{names:s,verdicts:g}},[r]);return{diff:c.useMemo(()=>i.length?vs(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function Pp(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:l}=K(),[s,g]=c.useState(!1),[p,x]=c.useState(!1),u=c.useRef(null);c.useEffect(()=>{if(!s)return;const j=y=>{u.current&&!u.current.contains(y.target)&&g(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[s]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!d.length,w=c.useRef({});c.useEffect(()=>{w.current={...r}},[r]);const k=j=>{const y=w.current[j],N=y!==void 0?r[j]-y:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${ra[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j],j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[j],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},j)},f=(j,y,N)=>t.jsxs("button",{type:"button",className:"off"+(y?" view":""),style:{"--c":`var(${ra[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:N}),t.jsx("span",{className:"n",children:r[j]})]},j),v=(j,y,N,E=!1)=>t.jsx("button",{type:"button",className:"tool",title:y,disabled:E,onClick:N,children:j},y);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(k)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[v("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(p?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":s,title:n.toolSort,onClick:()=>g(j=>!j),children:"⇅"}),s&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([j,y])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[y,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),v("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),v("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function _p(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,doAnalyse:l,mode:s}=K(),g=c.useRef(null),[p,x]=c.useState(60);c.useEffect(()=>{let j=0;const y=()=>{var T;const N=g.current;if(!N)return;const E=(T=N.parentElement)==null?void 0:T.querySelector('.funnel [aria-selected="true"]');if(!E)return;const S=E.getBoundingClientRect(),L=N.getBoundingClientRect();x(Math.max(20,Math.min(S.left+S.width/2-L.left,L.width-30)))};return j=requestAnimationFrame(y),window.addEventListener("resize",y),()=>{cancelAnimationFrame(j),window.removeEventListener("resize",y)}},[e.ptab]);const u=e.ptab;let b=r.tuto[u].p;if(u===3){const j=i.filter(E=>E.kind==="target"&&Ce(E)===3),y=j.filter(E=>mn(E)==="auto").length,N=j.filter(E=>mn(E)==="cd").length;b=r.tutoPending(y,N,j.length)}const m=(()=>{if(s!=="client")return null;if(u===0&&i.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:i.map(j=>j.id)})};if(u===1){const j=i.filter(y=>y.kind==="target"&&Ce(y)===1&&!d.has(y.id)).slice(0,10);if(j.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:j.map(y=>y.id)})}}return null})(),w=ys(u),k=u===1||u===2,f=r.plabels[u]+" · "+(o[u]??0),v=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:g,className:"tuto mini"+(w?"":" on-dark")+(k?" etape-on":""),style:{"--bg":`var(${ra[u]})`,"--ax":p+"px","--stc":w?"var(--ink)":"#fff","--stt":w?"#fff":"var(--ink)","--tc":w?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:f}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label}),u!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:v})]})}const pn=600,jt=62,po="atl2:fstats";function Bp(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=K(),[d,l]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(po)==="on"}catch{return!1}}),s=r.stats,g=c.useMemo(()=>((s==null?void 0:s.by_day)||[]).slice(-30),[s]),p=(s==null?void 0:s.since)||"";if(!n.showFunnel||!s||typeof s.screened!="number")return null;const x=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,u=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((N,E)=>Math.max(N,E.s||0),0),m=g.length?pn/g.length:0,w=Math.max(4,m-4),k=g.length>=5&&b>0,f=r.marketEstimate||0,v=x(new Date().toISOString().slice(0,10)),j=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof s.kept=="number"?[[s.kept,e.funKept]]:[],...typeof s.analyzed=="number"?[[s.analyzed,e.funAnalyzed]]:[],...typeof s.shown=="number"?[[s.shown,e.funShown]]:[]],y=[];return typeof s.screened_window=="number"&&p&&y.push({cle:"fenetre",periode:e.funPerWindow(x(p),v),etapes:[[s.screened_window,e.funScreened("","")]]}),typeof s.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:j(s.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[y.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([E,S],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(E)}),t.jsx("i",{children:S})]},N.cle+S)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((s.screened||0)/f*100)))})]}),N.cle==="total"&&(s.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),N.cle===y[y.length-1].cle&&k&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const E=!d;l(E),E&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(po,E?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},N.cle)),d&&k&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${pn} ${jt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((N,E)=>{const S=(N.s||0)/b*(jt-4),L=(N.m||0)/b*(jt-4),T=E*m+(m-w)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===N.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===N.d?{day:"",win:"all"}:{day:N.d,win:"all"}}),onKeyDown:I=>{I.key!=="Enter"&&I.key!==" "||(I.preventDefault(),i({type:"filters",patch:o.filters.day===N.d?{day:"",win:"all"}:{day:N.d,win:"all"}}))},children:[t.jsx("title",{children:`${x(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:T-1,y:0,width:w+2,height:jt,fill:"transparent"}),t.jsx("rect",{x:T,y:jt-2-S,width:w,height:S,fill:"#cfe0d6"}),t.jsx("rect",{x:T,y:jt-2-L,width:w,height:L,fill:"#0E7F3F"})]},N.d)}),t.jsx("line",{x1:0,y1:jt-1.5,x2:pn,y2:jt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const hi={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Vn({o:e,locked:a=!1}){const{t:r}=K(),n=ua(e),o=Nt(e),i=Ce(e),d=mn(e),l=ws(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(hi[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(Jl,{o:e})]})}const Vt=e=>e.length>22?e.slice(0,21)+"…":e;function ca(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function gi(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function $p({on:e,rev:a}){const[r,n]=c.useState(null),[o,i]=c.useState({top:0,left:0,width:0});return c.useEffect(()=>{if(!e){n(null);return}const d=()=>{var m,w,k;const l=document.querySelector(".atl2.ops .desk-list"),s=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const g=l.getBoundingClientRect(),p=s?s.getBoundingClientRect().bottom:g.top;i({top:Math.round(p),left:Math.round(g.left),width:Math.round(g.width)});const x=[...l.querySelectorAll(":scope .grp")];let u=null;for(const f of x){const v=f.querySelector(".grp-h");v&&v.getBoundingClientRect().bottom<=p+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((w=b.querySelector(".t"))==null?void 0:w.textContent)||"").trim(),s:(((k=b.querySelector(".s"))==null?void 0:k.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Up(e){const r=()=>{const n=gi(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function co({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=K(),[i,d]=c.useState(!1);if(c.useEffect(()=>{n||d(!1)},[n]),_e(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const s=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(s?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Vt(e.name))})]})}function Wn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:d,doPromote:l,doRepeche:s,doApproach:g,dispatch:p,liveMemos:x}=K(),u=m=>w=>{w.stopPropagation(),m()};if(r.lockActions){const m=u(()=>p({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const w=Ce(e);return w===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Vt(e.name))})]})}):w===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):w===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):w===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):w===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):w===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ca(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Ra(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ca(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(co,{o:e})});const b=Ce(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(co,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ta,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const w=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:w,onClick:u(()=>i(e)),children:w?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>d(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>d(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const m=o.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>g(e)),children:m?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:u(()=>p({type:"modal",modal:"plug"})),children:a.actConn})]})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>p({type:"focus",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Hp({o:e}){const{t:a,doThumb:r,thumbOf:n}=K(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Vp({o:e}){const{lang:a}=K();return Ie(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Et,{o:e}),t.jsx(Va,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Tt(e.engine||"")," ",Ze(e.engine||"",a)]})})}function Wp({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:l}){const{dispatch:s,caps:g,markRow:p,markedId:x,favIds:u,toggleFav:b,t:m}=K(),w=Ce(e),k=["#16233A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=f<=0?0:f<=7?1:f<=30?2:3,j=g.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][w]:k[v],y=u.has(e.id),N=E=>{if(a)return;if(d){d(e.id);return}if(g.pipe||e.kind==="op"){n();return}const S=E.currentTarget.getBoundingClientRect();s({type:"popup",id:e.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return t.jsxs(c.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+w:"")+(y?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>p(e.id),onMouseLeave:()=>p(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(ki,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${m.cdEngagement} ${Math.round(e.engagement*10)/10} · ${m.cdEngagementHint}`,children:"🔥"}),Ie(e)&&t.jsx(Et,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:y?1:.35,padding:0,marginRight:4},onClick:E=>{E.stopPropagation(),b(e)},children:y?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Ye(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(E=>E&&E!==e.name)||""]}),g.pipe&&!g.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:E=>E.stopPropagation(),children:[e.website&&t.jsx("a",{href:pa(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowSite,title:m.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:pa(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowLi,title:m.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":m.rowMail,title:m.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":m.rowTel,title:m.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:E=>{E.stopPropagation(),s({type:"acquirer",value:e.acquirer||""})},children:["← ",Vt(e.acquirer)]}),Qe(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(Gp,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Vp,{o:e}),g.pipe&&t.jsx(Vn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Wn,{o:e}),g.showThumbs&&t.jsx(Hp,{o:e})]}),r&&!a&&!d&&t.jsx(Kp,{o:e})]})}function Gp({o:e}){const{lang:a,caps:r}=K();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Yt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Yp({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=K(),d=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),s=Yt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),p=_e(e),x=p&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),s&&t.jsx("span",{className:"oc-amt",children:s}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[p?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Ye(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),ca(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Vt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ma,{spec:e.card})})]})}function Qp({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=K();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ze(e.engine||"",r),i?` · ${i}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Wn,{o:e})})]}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx(Hn,{o:e})]})}function xi({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:l,dossiers:s}=K(),g=c.useRef(null),p=Qe(e);if(c.useEffect(()=>{if(!p||!(e!=null&&e.decryptHtml))return;const h=g.current;if(!h)return;let A=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async $=>{await $.ensureEditoCss(),!(A||!h.isConnected)&&($.beautifyEditoRows(h),$.mountCardFits(h))}),()=>{A=!0}},[p,e==null?void 0:e.decryptHtml]),!e&&!a){const h=s.find(Qe);if(h)return t.jsx(xi,{o:h})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),w=e?!!e.noCo:!x||La(x),k=(e==null?void 0:e.engine)||"",f=Qe(e),v=e?Yt(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),y=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),N=s.find(Qe),E=((N==null?void 0:N.url)||"").trim(),S=!!u&&!!E&&(u===E||u.endsWith(E)||E.endsWith(u)),L=(h,A=!1)=>$=>{$.stopPropagation(),A&&d({type:"continent",key:"monde"}),d({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const T=()=>{x&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:x}}))},I=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},M=()=>{ca({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},U=e?_e(e):!1,q=U&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",R=f?r.doEdito.replace(/^📖\s*/,""):k?Ze(k,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[R,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(w||Ra({engine:k}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,y?t.jsx("em",{children:y}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),v&&t.jsx("span",{className:"oc-amt",children:v})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(ma,{spec:m})}),(u&&!S&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!S&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,y?` · ${y}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),d({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[U?t.jsxs("span",{className:"verdict",style:{"--c":q?"var(--brand)":"var(--red)"},children:[q?"✓":"✗"," ",t.jsx("b",{children:q?r.kept:r.dropped})]}):!w&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:h=>{h.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Vt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(w||Ra({engine:k}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!w&&x?" ghost":""),onClick:h=>{h.stopPropagation(),M()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!w&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),I()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Vt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!w&&x&&l.pipe&&t.jsx(Un,{name:x})]})]})}function Kp({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=K();return!o.pipe&&e.kind==="op"?t.jsx(Yp,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Hn,{o:e}),t.jsx(Xl,{o:e}),t.jsx(ed,{o:e}),t.jsx(Un,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Vn,{o:e})})]}),e.card&&t.jsx(ma,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Tt(e.engine||"")," ",Ze(e.engine||"",r)]}),Ie(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Et,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function Jp({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:l,lang:s}=K();if(!d.pipe&&e.kind==="op"){const x=Yt(e.amountEur,s),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,w=!1)=>k=>{k.stopPropagation(),w&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ma,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Tt(e.engine||"")," ",Ze(e.engine||"",s)]}),Ie(e)&&t.jsx(Et,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Wn,{o:e})})]})}const g=Ce(e),p=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":p},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Vn,{o:e}),Ie(e)&&t.jsx(Et,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"focus",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function Xp(){const{t:e}=K(),[a,r]=c.useState(0);return c.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Zp({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=K(),i=o==="en",d=p=>n.plabels[p]||"",l=[0,1,2,3,4,5,6,7].filter(p=>p!==a.ptab&&(e[p]||0)>0),s=l.includes(0)?0:l.sort((p,x)=>(e[x]||0)-(e[p]||0))[0];if(s===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[s]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:s===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${d(s)}”`:`${g} dossier${g>1?"s":""} dans « ${d(s)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:s}),children:[(i?"Open ":"Ouvrir ")+d(s)," →"]})]})}function ec(){var It,De,Ke,Ve,dt;const e=K(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:l,markRow:s,lang:g,sessTally:p,data:x,dossiers:u,source:b,focusExtra:m,byId:w,token:k}=e,f=Oo(),v=c.useMemo(()=>{var Z,P,oe,re;if(!k||b==="ops")return null;const F=(((Z=f==null?void 0:f.ed)==null?void 0:Z.date)||(f==null?void 0:f.day)||"").slice(0,10),Q=[(P=f==null?void 0:f.ed)==null?void 0:P.html,(oe=f==null?void 0:f.ed)==null?void 0:oe.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((re=f==null?void 0:f.ed)==null?void 0:re.date)||F,decryptHtml:Q||void 0,date:F,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[k,b,g,(It=f==null?void 0:f.ed)==null?void 0:It.html,(De=f==null?void 0:f.ed)==null?void 0:De.acquirers_html,(Ke=f==null?void 0:f.ed)==null?void 0:Ke.date,f==null?void 0:f.day]),j=F=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Fo,[y,N]=c.useState(new Set);c.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[E,S]=c.useState(null);c.useEffect(()=>{S(null)},[a.ptab,a.continent]);const[L,T]=c.useState(!a.mapFolded);c.useEffect(()=>{if(a.mapFolded){T(!1);return}const F=document.getElementById("atl2-stage");if(!F){T(!1);return}const Q=new IntersectionObserver(([Z])=>T(!!Z&&Z.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return Q.observe(F),()=>Q.disconnect()},[a.mapFolded]);const I=a.mapFolded||!L,M=F=>N(Q=>{const Z=new Set(Q);return Z.has(F)?Z.delete(F):Z.add(F),Z}),U=b==="ops"||o.pipe,[q,R]=c.useState("all"),[h,A]=c.useState(!1),[$,X]=c.useState(null),[z,D]=c.useState(!1),O=c.useRef(!0);c.useEffect(()=>{if(O.current){O.current=!1;return}R("all"),D(!1)},[a.ptab,a.continent]),c.useEffect(()=>{if(!z)return;const F=Q=>{var Z,P;(P=(Z=Q.target)==null?void 0:Z.closest)!=null&&P.call(Z,".atl2 .doable")||D(!1)};return document.addEventListener("click",F,!0),()=>document.removeEventListener("click",F,!0)},[z]);const _=c.useMemo(()=>{var Q;const F=new Map;for(const Z of Dl(((Q=f==null?void 0:f.ed)==null?void 0:Q.html)||""))F.has(Z.t)||F.set(Z.t,Z.html);return F},[(Ve=f==null?void 0:f.ed)==null?void 0:Ve.html]),J=c.useCallback(F=>{if(F.decryptHtml)return F.decryptHtml;if(!_.size)return;const Q=(F.name||"").trim().toLowerCase();if(Q.length<3)return;const Z=_.get(Q);if(Z)return Z;for(const[P,oe]of _)if(P.includes(Q)||Q.includes(P))return oe},[_]),{diff:ee}=Ip(),[ge,ae]=c.useState(!1),de=a.filters.win==="1"&&!a.filters.day,[ue,fe]=c.useState(!1),ve=c.useMemo(()=>new Set(((ee==null?void 0:ee.added)||[]).map(F=>F.trim().toLowerCase()).filter(Boolean)),[ee]),xe=c.useMemo(()=>{if(!ve.size)return 0;const F={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(Q=>!Qe(Q)&&ve.has((Q.name||"").trim().toLowerCase())&&oa(Q,F,o.pipe)).length},[u,ve,a,o.pipe]);c.useEffect(()=>{const F=()=>{fe(!1),A(!1),R("all"),D(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",F),()=>window.removeEventListener("ppmap:tunnel",F)},[]),c.useEffect(()=>{fe(!1),A(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const ye=c.useMemo(()=>{const F=l.filter(Z=>!Qe(Z)&&Ye(Z));let Q="";for(const Z of F){const P=(Z.date||"").slice(0,10);P&&(!Q||P<Q)&&(Q=P)}return{n:F.length,since:Q?Q.split("-").reverse().slice(0,2).join("/"):""}},[l]),ze=ye.n,ne=c.useMemo(()=>{const Q=ue&&ve.size>0||a.filters.signalOnly||q!=="all"||h?l:d;let Z=Dn(Q,a.sort);return Z=Z.filter(P=>!Qe(P)),ue&&ve.size&&(Z=Z.filter(P=>ve.has((P.name||"").trim().toLowerCase()))),h||q==="explore"?Z=Z.filter(Ye):q==="eval"?Z=Z.filter(P=>!Ye(P)&&!P.noCo&&(P.kind==="op"||!_e(P))):o.pipe&&(Z=Z.filter(P=>!Ye(P))),Z},[d,l,a.sort,q,ue,ve,h,o.pipe]),te=c.useMemo(()=>o.pipe?u.filter(F=>F.kind==="target"&&!Qe(F)&&Ie(F)&&(a.continent==="monde"||F.continent===a.continent)):ne.filter(F=>Ie(F)&&!_e(F)),[o.pipe,u,ne,a.continent]).length,H=c.useMemo(()=>o.pipe?ne:ne.filter(F=>!_e(F)&&!F.noCo&&!Ye(F)),[ne,o.pipe]),V=b==="ops"?ne.filter(Ye).length:0,W=ue?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,ie=a.filters,le=ie.sector.length+ie.market.length+ie.country.length+ie.engine.length+ie.stage.length+ie.crible.length+ie.angle.length+ie.memoLevel.length+ie.dealKind.length+(ie.signalOnly?1:0)+(ie.acquirer.trim()?1:0)+(ie.search.trim()?1:0),pe=[];if(ie.day)pe.push({k:"day",lib:n.fDay(ie.day.slice(8,10)+"/"+ie.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(ie.win&&ie.win!=="all"){const F=["1","7","30"].indexOf(ie.win);F>=0&&pe.push({k:"win",lib:n.dates[F],off:()=>r({type:"filters",patch:{win:"all"}})})}const be=F=>F.length<=2?F.join(", "):`${F.length} ${n.fSelected}`;for(const F of["sector","market","country","engine","crible"]){const Q=ie[F];Q&&Q.length&&pe.push({k:F,lib:be(Q),off:()=>r({type:"clearFacet",facet:F})})}ie.search&&pe.push({k:"search",lib:"🔍 "+ie.search,off:()=>r({type:"filters",patch:{search:""}})}),ue&&ve.size&&pe.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>fe(!1)}),ie.signalOnly&&pe.push({k:"sig",lib:"🔴 "+n.sigDock(te||ie.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const ke=(F,Q,Z="",P=!1)=>t.jsxs("button",{type:"button","data-s":F,className:Z,"aria-sort":a.sort.key===F?a.sort.dir===1?"ascending":"descending":"none",style:P?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:F}),children:[Q,t.jsx("span",{className:"ar",children:a.sort.key===F&&a.sort.dir===1?"▴":"▾"})]},F),qe=c.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const F=new Map;ne.forEach(P=>{const oe=P.engine||"?";F.has(oe)||F.set(oe,[]),F.get(oe).push(P)});const Q={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},Z=un([...F.keys()],g);return[...F.entries()].sort((P,oe)=>{const re=Q[P[0]]??10+Z.indexOf(P[0]),ce=Q[oe[0]]??10+Z.indexOf(oe[0]);return re-ce})},[ne,o.pipe,a.groupBy,g]),ot=qe?qe.filter(([F])=>Na.has(F)).length:0,it=(()=>{var Q;return((Q=(qe?qe.flatMap(([,Z])=>Z):ne)[0])==null?void 0:Q.id)??null})(),Be=c.useRef(!1),Ne=c.useMemo(()=>u.find(Qe)||v,[u,v]),[Mt,St]=c.useState(!1);c.useEffect(()=>{const F=()=>{Be.current=!0,fe(!1)};return window.addEventListener("ppmap:reveal",F),window.addEventListener("ppmap:focus",F),()=>{window.removeEventListener("ppmap:reveal",F),window.removeEventListener("ppmap:focus",F)}},[]),c.useEffect(()=>{const F=()=>{Ne&&r({type:"focus",id:Ne.id})};return window.addEventListener("ppmap:edito",F),()=>window.removeEventListener("ppmap:edito",F)},[Ne,r]),c.useEffect(()=>{if(!a.focusId)return;X(a.focusId);const F=window.setTimeout(()=>X(null),900);return()=>window.clearTimeout(F)},[a.focusId]),c.useEffect(()=>{if(U&&!(a.focusId&&(ne.some(F=>F.id===a.focusId)||u.some(F=>F.id===a.focusId)||a.focusId===(Ne==null?void 0:Ne.id)))&&!m){if(Ne){r({type:"focus",id:Ne.id});return}it&&r({type:"focus",id:it})}},[U,a.focusId,ne,it,m,r,u,b,Ne]),c.useEffect(()=>{if(!U||!a.focusId||Ne&&a.focusId===Ne.id||ne.some(Q=>Q.id===a.focusId))return;const F=u.find(Q=>Q.id===a.focusId);if(F){if(Be.current){F.kind==="op"?R(Ye(F)?"explore":"eval"):q!=="all"&&R("all");return}q!=="all"&&it&&r({type:"focus",id:it})}},[U,a.focusId,q,ne,u,it,r,Ne]),c.useEffect(()=>{if(!U||!a.focusId||!Be.current)return;const F=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!F){const oe=ne.findIndex(re=>re.id===a.focusId);if(oe>=0){const re=qe?"":"pt"+a.ptab;if(re){const ce=a.shown[re]||j();oe>=ce&&r({type:"more",group:re,by:oe-ce+8})}}return}Be.current=!1;const Q=gi(),Z=F.getBoundingClientRect();Z.top>=Q-2&&Z.bottom<=window.innerHeight-4||Up(F)},[U,a.focusId,a.ptab,ne,a.shown,qe,r]),c.useEffect(()=>{if(typeof window>"u")return;const F=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),Q=document.querySelector(".atl2.ops, .atl2.cibles");if(!F||!Q)return;const Z=()=>Q.style.setProperty("--listhead-h",`${F.offsetHeight}px`);Z();const P=new ResizeObserver(Z);return P.observe(F),()=>P.disconnect()},[I,a.dens,a.mapFolded]);const Me=c.useMemo(()=>{if(!U||!a.focusId)return null;if(v&&a.focusId===v.id)return v;const F=ne.find(Z=>Z.id===a.focusId)||u.find(Z=>Z.id===a.focusId)||null;if(!F)return null;const Q=J(F);return Q&&Q!==F.decryptHtml?{...F,decryptHtml:Q}:F},[U,a.focusId,ne,u,J,v]),st=o.lockRowsAfter;let ft=0;const Ct=(F,Q)=>{let Z=a.shown[Q]||j();return F.length-Z<=4&&(Z=F.length),F.slice(0,Z).map(re=>{const ce=st!==null&&ft>=st;ft++;const je=J(re),he=je&&je!==re.decryptHtml?{...re,decryptHtml:je}:re,Pe=!U&&a.dens!=="maxi"&&(a.dens==="deplie"||(E?E==="open":!!je)),Te=y.has(re.id)?!Pe:Pe,gt=U?Pt=>{Be.current=!0,r({type:"focus",id:Pt});const Je=w.get(Pt);Je&&(Ye(Je)?ca(Je):Je.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Je.name,url:Je.url||"",website:Je.website||"",domain:Je.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Jp,{o:he,locked:ce,selected:U&&a.focusId===re.id,onSelect:gt},re.id):t.jsx(Wp,{o:he,locked:ce,open:Te,onToggle:()=>M(re.id),selected:U&&a.focusId===re.id,echo:$===re.id,fresh:ve.has((re.name||"").trim().toLowerCase()),onSelect:gt},re.id)})},et="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ne.length?"":" list-empty"),zt=t.jsxs(t.Fragment,{children:[qe?qe.map(([F,Q])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Tt(F)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:F==="ma"?n.grpMa:F==="fundraising"?n.grpLev:Na.has(F)&&ot<=1?n.grpNews:F==="nominations"?n.grpNom:F==="media"?n.grpNewsOther:F==="recrutements"?n.grpHire:Na.has(F)?n.grpNews+" · "+Ze(F,g):Ze(F,g)}),t.jsx("div",{className:"s",children:n.grpCount(Q.filter(Z=>!_e(Z)).length,Q.length)})]})]}),Ct(Q,F)]},F)):Ct(ne,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(Xp,{}),o.pipe&&a.ptab===0&&!h&&!ue&&q==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(di,{}),!ne.length&&!(x.loading&&!u.length)&&(o.pipe&&q==="all"?t.jsx(Zp,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(ie.win!=="all"||!!ie.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),le>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(le)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),ht=t.jsxs(t.Fragment,{children:[!ue&&!h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ra[a.ptab]+")"},children:ne.length})," ",W]}),h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ra[a.ptab]+")"},children:ne.length})," ",n.newsWord]}),(!ue||h)&&t.jsx("span",{className:"dot",children:"·"}),I&&t.jsx(si,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[I?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),pe.map(F=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:Q=>{Q.stopPropagation(),F.off()},children:[F.lib,t.jsx("i",{children:"×"})]},F.k)),b==="ops"&&ne.length>0&&!I&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ne.length-V," ",n.zoomPulseEval,V>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",V," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),Dt=t.jsxs("div",{className:"listhead"+(I?" mapoff":""),children:[I&&t.jsx("div",{className:"lh-tools",children:t.jsx(ii,{compact:!0})}),o.showFunnel&&ge&&de&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(ad,{}),t.jsx(Bp,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:ht}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Pp,{}),t.jsx(_p,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(de?" on":""),"aria-pressed":de,title:n.morningDockTitle,onClick:()=>{if(de){r({type:"filters",patch:{win:"all",day:""}}),ae(!1);return}fe(!1),A(!1),R("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),ae(!0)},children:["📊 ",n.morningDock(typeof((dt=x.stats)==null?void 0:dt.screened_today)=="number"?x.stats.screened_today:0)]}),ee&&!ee.firstVisit&&(ee.added.length>0||ee.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(ue?" on":""),"aria-pressed":ue,title:n.sinceSub,onClick:()=>{const F=!ue;fe(F),A(!1),ae(!1),R("all"),F&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(xe),ee!=null&&ee.lastDate?` · ${n.sinceSince(ee.lastDate)}`:""]}),te>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{fe(!1),A(!1),ae(!1),R("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(te)]}),o.pipe&&ze>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(h?" on":""),"aria-pressed":h,title:n.newsDockHint,onClick:()=>{const F=!h;A(F),fe(!1),ae(!1),R("all"),F&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ze),ye.since?` · ${n.newsSince(ye.since)}`:""]})]}),!o.showFunnel&&ht,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([F,Q])=>t.jsxs("button",{type:"button","data-d":F,"aria-pressed":a.dens===F||F==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:F}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:Q})]},F))}),!U&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":E==="open",onClick:()=>{S("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":E==="closed",onClick:()=>{S("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var je;const F={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},Q=u.filter(he=>oa(he,F,o.pipe)&&!Qe(he)),Z=Q.filter(he=>!Ye(he)&&!he.noCo&&(he.kind==="op"||!_e(he))).length,P=Q.filter(Ye).length,oe=o.pipe?Q.filter(he=>he.kind!=="op"&&Ce(he)===1).length:0,re=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${oe?` ${oe}`:""}`]]:[],["eval",`${n.doEval}${Z?` ${Z}`:""}`],["explore",`${n.doExplore}${P?` ${P}`:""}`]],ce=((je=re.find(([he])=>he===q))==null?void 0:je[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":z,onClick:()=>D(he=>!he),children:[ce,t.jsx("i",{children:"▾"})]}),z&&t.jsx("div",{className:"dolist",children:re.map(([he,Pe])=>t.jsx("button",{type:"button","aria-pressed":q===he,onClick:()=>{if(D(!1),he==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}R(he),he!=="all"&&(fe(!1),A(!1),ae(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:Pe},he))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:F=>r({type:"sort",key:F.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([F,Q])=>t.jsx("option",{value:F,children:Q},F))})]}),o.showChain&&H.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:H.map(F=>F.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(H.length):n.chainAll(H.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!U&&Dt,a.dens!=="maxi"&&!U&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ke("country",n.colCountry),ke("name",n.colCompany),ke("amount",n.colAmount,"h-amt",!0),ke("stage",n.colStage,"h-stade"),ke("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ke("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ke("memo",n.colMemo)]}),o.pipe&&ke("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),U?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[Dt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ke("country",n.colCountry),ke("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ke("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ke("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:et,children:zt})]}),t.jsxs("aside",{className:"readpane"+((Me?Qe(Me):!m&&Ne)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[Ne&&(()=>{const F=a.focusId===Ne.id&&!Mt,Q=(Ne.headline||Ne.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":F,onClick:()=>{if(F){St(!0);return}St(!1),r({type:"focus",id:Ne.id})},children:[t.jsx("span",{className:"eg-t",children:g==="en"?"Today’s editorial":"Édito du jour"}),Q&&t.jsx("span",{className:"eg-sub",children:Q}),t.jsx("span",{className:"eg-chev",children:F?g==="en"?"Collapse ▴":"Replier ▴":g==="en"?"Read ▾":"Lire ▾"})]})})(),v&&a.focusId===v.id&&Mt?null:v&&a.focusId===v.id?t.jsx("div",{className:"zoom",children:t.jsx($l,{})}):Me&&o.pipe?t.jsx(Qp,{o:Me}):t.jsx(xi,{o:Me,extra:Me?null:m})]})]}):t.jsx("div",{className:et,children:zt}),(()=>{const F=qe||[["pt"+a.ptab,ne]];let Q=0,Z=0;for(const[oe,re]of F){Z+=re.length;let ce=a.shown[oe]||j();re.length-ce<=4&&(ce=re.length),Q+=Math.min(re.length,ce)}const P=Z-Q;return P<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>F.forEach(([oe,re])=>r({type:"more",group:oe,by:re.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(P,P)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(Q,Z)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}}),U&&b==="ops"&&a.dens!=="maxi"&&t.jsx($p,{on:!!qe,rev:(qe||[]).map(([F,Q])=>F+Q.length).join("|")})]})}function uo(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function tc(e,a){const r=ks(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function ac(e,a){const n=[a.head.split("|").map(uo).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",tc(o,a.plabels),ua(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(uo).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function nc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const rc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function We({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function Jt({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function oc({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=K(),d=(e.cribleStatus||"").trim().toUpperCase()||(ua(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Nt(e),s=(a==null?void 0:a.blocs)||{},g=[[n.qaVP,s.value_prop],[n.qaProduct,s.produit],[n.qaModel,s.modele],[n.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(We,{k:n.cdSector,v:e.sector}),t.jsx(We,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(We,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(We,{k:n.cdStage,v:e.stage}),t.jsx(We,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(We,{k:n.cdSite,v:e.domain||e.website}),t.jsx(We,{k:n.cdName,v:e.contactName}),t.jsx(We,{k:n.cdEmail,v:e.contactEmail}),t.jsx(We,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(We,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(We,{k:n.cdAngle,v:e.angle}),t.jsx(We,{k:n.cdDetected,v:rc(e.date,o)})]}),!!(e.provQuery||e.provUrl||qa(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(We,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(We,{k:n.cdSrc,v:Tn(e.provUrl||""),href:pa(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(We,{k:n.cdAngleSrc,v:qa(e)})]})]}),g.some(([,p])=>p)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),g.filter(([,p])=>p).map(([p,x])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:p}),t.jsx("p",{children:x})]},p))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([p,x,u])=>t.jsxs("div",{className:"dssq "+p,children:[t.jsx("b",{children:x}),t.jsx("ul",{children:u.map(b=>t.jsx("li",{children:b},b))})]},p))})]}),t.jsx(Jt,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function ic(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d}=K(),[l,s]=c.useState({}),[g,p]=c.useState({}),x=25,u=12,b=c.useMemo(()=>n.slice(0,x),[n]);c.useEffect(()=>{b.length&&No(r,b.map(k=>k.name)).then(s)},[r,b]),c.useEffect(()=>{const k=b.filter(j=>!!j.memoUrl).slice(0,u);if(!k.length){p({});return}let f=!1;const v={};return(async()=>{for(const j of k){if(f)return;try{const y=await fi(j.memoUrl||"");if(f)return;y&&Np(y.comite)&&(v[j.id]=y.comite,p({...v}))}catch{}}})(),()=>{f=!0}},[b]);const m=i.stats,w=k=>k.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(b.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),m&&typeof m.screened=="number"&&t.jsxs("p",{children:[w(m.screened)," ",e.funScreened(""),typeof m.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",w(m.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(w(i.marketEstimate)),", ",Math.round(m.screened/i.marketEstimate*100)," %"]})]})]}),b.map(k=>t.jsx(oc,{o:k,qa:l[k.name],comite:g[k.id]},k.id)),!b.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const sc=50;function Gn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=K(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(""),[x,u]=c.useState(0),[b,m]=c.useState(""),[w,k]=c.useState(!1),[f,v]=c.useState(0),j=c.useRef(null),y=c.useRef(null),N=()=>{v(0),y.current&&window.clearInterval(y.current),y.current=window.setInterval(()=>v(T=>T+1),1e3)},E=()=>{y.current&&(window.clearInterval(y.current),y.current=null)};c.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),y.current&&window.clearInterval(y.current)},[]);const S=async T=>{s(!0),p(""),N();const I=await a();if(s(!1),E(),I.ok){d(I);return}if(I.busy){p(o.alertPreviewBusy);return}if(!T){p(o.alertPreviewFail);return}u(sc),E(),j.current=window.setInterval(()=>{u(M=>M>1?M-1:(j.current&&window.clearInterval(j.current),S(!1),0))},1e3)},L=async()=>{if(n||w||l)return;k(!0),m(""),N();const T=await r();k(!1),E(),m(T.ok?o.alertTestOk(T.sentTo||""):T.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||w||x>0,onClick:()=>{S(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||w||l,onClick:()=>{L()},children:w?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),w&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const yt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ge({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=K();return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function lc(){const{st:e}=K();switch(e.modal){case"chain":return t.jsx(pc,{});case"space":return t.jsx(cc,{});case"alert":return t.jsx(uc,{});case"queue":return t.jsx(xc,{});case"export":return t.jsx(bc,{});case"plug":return t.jsx(wc,{});case"approach":return t.jsx(kc,{});case"recharge":return t.jsx(Nc,{});case"cover":return t.jsx(Cc,{});case"dossier":return t.jsx(Sc,{});case"crit":return t.jsx(Tc,{});case"tuto":return t.jsx(Lc,{});case"rdv":return t.jsx(dc,{});case"memoalert":return t.jsx(vc,{});default:return null}}function dc(){const{dispatch:e,fund:a,t:r}=K(),n=a||r.rdvCoFallback;return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Io,children:Pn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Js,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function pc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:l,caps:s,memoQueued:g,doAnalyse:p}=K(),x=i==="client",u=e.chain.queue.map(k=>r.get(k)).filter(k=>!!k),b=e.chain.idx,m=u[b],w=b>=u.length;return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:w?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(w?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:w||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Gt(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(wt(m.date))].filter(Boolean).map(k=>String(k)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ze(m.engine,o)}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Yt(m.amountEur,o)})]}),Ie(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Et,{o:m,lg:!0})," ",t.jsx(Va,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&_e(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&_e(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":qt(m)==="retenu"?"var(--brand)":qt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:qt(m)==="retenu"?"✓ "+n.kept:qt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!w&&m&&s.pipe&&Ce(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{p(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!w&&m&&!(x&&_e(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var k;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(k=document.querySelector(".atl2 .demand"))==null||k.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{d(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(w?{type:"modal",modal:null}:{type:"chainNext"}),children:w?n.closeBtn:n.skip})]})]})})}),document.body)}function cc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=K(),i=o==="client",d=c.useMemo(()=>i?r.filter(x=>_e(x)):[],[r,i]),l=c.useMemo(()=>Dn(d.filter(x=>qt(x)==="retenu"),{key:"signal",dir:-1}),[d]),s=c.useMemo(()=>d.filter(x=>qt(x)==="ecarte"),[d]),g=e.spaceTab==="retenu"?l:s,p=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ge,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:s.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":p},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function uc(){const{mode:e}=K();return e==="client"||e==="apercu"?t.jsx(mc,{}):t.jsx(gc,{})}function mc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=K(),[i,d]=c.useState("d"),l=o!=="client";return t.jsxs(Ge,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(fc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(hc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(bi,{})]})}function fc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(0);c.useEffect(()=>{let L=!0;return s(!1),mr(a).then(T=>{L&&(T?d(T):s(!0))}),()=>{L=!1}},[a,g]);const x=c.useRef({}),[u,b]=c.useState({}),[m,w]=c.useState(!1),[k,f]=c.useState(!1),v=c.useRef(null);c.useEffect(()=>()=>{v.current&&window.clearTimeout(v.current)},[]);const j=L=>{const T=x.current;Object.keys(T).length&&(w(!0),mr(a,T).then(I=>{if(!I){w(!1),o(e.actErr);return}if(I.throttled&&L<3){v.current=window.setTimeout(()=>j(L+1),5400);return}if(x.current={},b({}),d(I),w(!1),I.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},y=L=>{r||(x.current={...x.current,...L},b(T=>({...T,...L})),v.current&&window.clearTimeout(v.current),v.current=window.setTimeout(()=>j(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...u},E=L=>!N.sections||N.sections.includes(L),S=L=>{const T=N.sections||e.alertSec.map(([I])=>I);y({sections:E(L)?T.filter(I=>I!==L):[...T,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>y({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>y({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>y({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>y({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>y({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&k&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,T])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:E(L),disabled:r,onChange:()=>S(L)}),t.jsxs("span",{children:[T,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Gn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ms(a),onTest:()=>Os(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function hc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(0);c.useEffect(()=>{let m=!0;return s(!1),fr(a).then(w=>{m&&(w?d(w):s(!0))}),()=>{m=!1}},[a,g]);const x=m=>{r||fr(a,m).then(w=>{if(!w){o(e.actErr);return}d(w),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,w)=>t.jsx("option",{value:w,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Gn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Is(a),onTest:()=>Ds(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function bi(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=K(),[d,l]=c.useState(i||""),[s,g]=c.useState(!1),[p,x]=c.useState(!1);c.useEffect(()=>{i&&l(i)},[i]);const u=e.filters,b=c.useMemo(()=>n.filter(f=>Ie(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,w=async()=>{if(!(!/.+@.+\..+/.test(d)||p)){x(!0);try{await fetch(`${Ha}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},k=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Ze(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>Gt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return s?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:k.map(([f,v])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:v}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function gc(){const{t:e}=K();return t.jsx(Ge,{title:e.alertTitle,icon:"🔔",children:t.jsx(bi,{})})}function xc(){var M,U;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:l,dispatch:s,liveMemos:g}=K(),[p,x]=c.useState(()=>Ya(r)),[u,b]=c.useState(()=>!Ya(r)),[m,w]=c.useState([]),[k,f]=c.useState(0),v=n==="client",j=c.useMemo(()=>{const q=new Map;return o.forEach(R=>{const h=(R.name||"").trim().toLowerCase();h&&!q.has(h)&&q.set(h,R)}),q},[o]);c.useEffect(()=>{let q=!0;return(!Ya(r)||k>0)&&b(!0),(async()=>{const[R,h]=await Promise.all([Rn(r,k>0),vo(a)]);q&&(R&&x(R),b(!1),w(h))})(),()=>{q=!1}},[a,r,k]);const y=u&&!p,N=(p==null?void 0:p.per_day)??0,E=((M=p==null?void 0:p.analyzed_today)==null?void 0:M.length)??0,S=p==null?void 0:p.offre,L=(p==null?void 0:p.pool_meta)||[],T=c.useMemo(()=>{const q=new Map;for(const R of(p==null?void 0:p.scheduled)||[])for(const h of R.names||[])q.has(h)||q.set(h,{label:R.day_label,date:R.date});return q},[p==null?void 0:p.scheduled]),I=(p==null?void 0:p.in_progress)||[];return t.jsxs(Ge,{title:e.queueTitle,wide:!0,children:[S&&t.jsxs("div",{className:"qoffre"+(S.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:S.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:S.delai})]}),t.jsx("span",{className:"osp"}),S.rythme>0?t.jsx("span",{className:"or",children:e.qRate(S.rythme)}):S.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(S.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:y?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(E,E+(((U=p==null?void 0:p.pool_order)==null?void 0:U.length)??0))}})}),S&&t.jsxs("div",{className:"qeta",children:[S.file===0?e.qEtaDone:S.rythme<=0?e.qEtaPaused:e.qEta(S.file,S.rythme,S.jours_restants),S.en_retard&&t.jsxs("em",{children:[" ",e.qLate(S.delai,S.plafond)]})]}),!y&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(S==null?void 0:S.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(I.length>0||g.items.some(q=>q.status==="boot"||q.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(q=>q.status==="boot"||q.status==="running"||q.status==="error").map(q=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:q.name}),t.jsx("span",{className:"qd",children:q.memoType||""}),t.jsx(Ta,{item:q,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+q.name)),I.filter(q=>!g.liveOf(q.name)).map(q=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:q.name}),t.jsxs("span",{className:"qd",children:[q.memo_type||"",q.age_min?` · ${Math.round(q.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:q.state||""})]},"ip-"+q.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(q=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:q.company}),t.jsxs("span",{className:"qd",children:[q.memo_type,typeof q.est_min=="number"?` · ~${q.est_min} min`:""]}),t.jsx("span",{className:"qt",children:q.status}),q.url&&t.jsx("a",{className:"qgo",href:q.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(q.memo_type)}),v&&q.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{cr(a,q.company,"retry").then(()=>f(R=>R+1))},children:e.queueRetry}),v&&q.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{cr(a,q.company,"delete").then(()=>f(R=>R+1))},children:e.queueDelete})]},q.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",y?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[y&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!y&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((q,R)=>{const h=T.get(q.name),A=j.get((q.name||"").trim().toLowerCase()),$=g.liveOf(q.name),X=!!(A&&d.has(A.id))||!!($&&($.status==="boot"||$.status==="running")),z=!!(A&&Ce(A)===1&&!A.memoUrl)&&!$;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:q.name}),q.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof q.score=="number"&&t.jsx("span",{className:"qs2",children:q.score}),$&&($.status==="boot"||$.status==="running")&&t.jsx(Ta,{item:$,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),z&&(l.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>s({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:X,onClick:()=>{i(A),f(D=>D+1)},children:X?e.actAnalyseQueued:e.actAnalyse})),q.excerpt&&t.jsx("span",{className:"qex",children:q.excerpt})]},q.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([q,R])=>t.jsxs("li",{children:[t.jsx("b",{children:q})," — ",R]},q))})]})}function bc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=K(),l=`${yt}/cibles/list.csv?token=${a}`,s=`${yt}/cibles/list.json?token=${a}`,g=`${yt}/cibles/export.xlsx?token=${a}&scope=full`,p=`=IMPORTDATA("${l}")`,x=k=>{var f;(f=navigator.clipboard)==null||f.writeText(k).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:p},{def:e.exportLive,value:s,href:s},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{nc(ac(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:k=>(e.stg.find(([f])=>f===k)||["",""])[1]})),r(e.exportViewDone(n.length))},w=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ge,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:w,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:k,value:f,href:v})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:k[0]}),t.jsxs("div",{children:[t.jsx("b",{children:k[1]}),t.jsx("p",{children:k[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),v&&t.jsx("a",{className:"exb",href:v,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},k[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function vc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=K(),i=o!=="client",[d,l]=c.useState(null),[s,g]=c.useState(!1),[p,x]=c.useState(0),[u,b]=c.useState(!1);c.useEffect(()=>{let f=!0;return g(!1),dr(a).then(v=>{f&&(v?l(v):g(!0))}),()=>{f=!1}},[a,p]);const m=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},w=f=>{if(i||!d)return;const v={enabled:f.enabled??!!d.enabled,email:f.email??(d.email||""),sections:f.sections??m()};b(!0),dr(a,v).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}l(j),r(e.memoAlertSaved)})};if(s)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!d)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const k=m();return t.jsxs(Ge,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||u,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(yc,{value:d.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>w({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!k[f],disabled:i||u,onChange:()=>w({sections:{...k,[f]:!k[f]}})}),t.jsx("span",{children:v})]},f))}),t.jsx(Gn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Es(a,k),onTest:()=>js(a,k)})]})}function yc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=c.useState(e);c.useEffect(()=>{d(e)},[e]);const l=i.trim()!==e.trim(),s=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>d(g.target.value),onKeyDown:g=>{g.key==="Enter"&&l&&s&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!s,onClick:()=>o(i.trim()),children:n})]})]})}function wc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=K(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(null),[x,u]=c.useState(!1),[b,m]=c.useState(""),[w,k]=c.useState(0),[f,v]=c.useState("webhook"),[j,y]=c.useState(""),N=c.useRef(!1);c.useEffect(()=>{let M=!0;return s(!1),pr(a).then(U=>{M&&(U?d({configured:U.configured,url_hint:U.url_hint}):s(!0))}),zs(a).then(U=>{if(M){if(!U){u(!0);return}u(!1),p(U),N.current||(N.current=!0,U.destination==="instantly"&&v(q=>q==="webhook"?"instantly":q),U.campaign_id&&y(q=>q||U.campaign_id||""))}}),()=>{M=!1}},[a,w]);const E=(M,U)=>{o&&pr(a,M).then(q=>{if(!q||q.ok===!1){n(e.actErr);return}M.test&&q.sent===!1?n(e.plugTestThrottled):r(U),k(R=>R+1)})},S='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',L=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),T=`curl -X POST ${yt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,I=`curl -X POST ${yt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`;return t.jsxs(Ge,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>k(M=>M+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:M=>m(M.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>E({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>E({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>E({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Ec,{destKind:f,setDestKind:v,camp:j,setCamp:y,whHint:i!=null&&i.configured?i.url_hint||"webhook":null}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugVarsT}),t.jsx("p",{className:"mnote",children:e.plugVars})]}),t.jsx(jc,{auto:g,autoKo:x,destKind:f,camp:j,onRetry:()=>k(M=>M+1),onDone:M=>{p(M),u(!1)}}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:T}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(T).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:S}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(S).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:I}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(I).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function kc(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:l}=K(),s=c.useMemo(()=>r.find(h=>h.id===n.approachId)||null,[r,n.approachId]),[g,p]=c.useState("email"),[x,u]=c.useState(0),[b,m]=c.useState({}),[w,k]=c.useState(!1),[f,v]=c.useState(""),[j,y]=c.useState({});if(c.useEffect(()=>{!s||b[g]||w||(k(!0),v(""),Cs(a,s.name,g).then(h=>{if(k(!1),!h||h.ok===!1){v((h==null?void 0:h.error)||e.apprFail);return}m(A=>({...A,[g]:h}))}))},[s,g,a]),!s)return null;const N=b[g],E=(N==null?void 0:N.sequence)||[],S=E[x],L=h=>`${g}|${x}|${h}`,T=h=>{const A=L(h);return A in j?j[A]:String(((S==null?void 0:S[h])??"")||"")},I=(h,A)=>y($=>({...$,[L(h)]:A})),M=L("subject")in j||L("body")in j||L("message")in j,U=T(g==="email"?"body":"message"),q=T("subject"),R=g==="email"&&q?`${q}

${U}`:U;return t.jsxs(Ge,{title:e.apprT(s.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(h=>t.jsx("button",{type:"button",className:"apch"+(g===h?" on":""),"aria-pressed":g===h,onClick:()=>{p(h),u(0)},children:h==="email"?e.apprChEmail:e.apprChLi},h)),t.jsx("span",{className:"sp"}),E.map((h,A)=>t.jsxs("button",{type:"button",className:"apday"+(x===A?" on":""),"aria-pressed":x===A,onClick:()=>u(A),children:[h.day||`J${A}`,[`${g}|${A}|subject`,`${g}|${A}|body`,`${g}|${A}|message`].some($=>$ in j)&&t.jsx("i",{children:"✎"})]},h.day||A))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,N!=null&&N.sender?" · "+e.apprSender(N.sender):""]}),w&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!f&&!w&&t.jsxs("p",{className:"mnote warn",children:[f," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{m(h=>{const A={...h};return delete A[g],A}),v("")},children:e.retry})]}),!w&&!f&&!S&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),S&&t.jsxs(t.Fragment,{children:[g==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:q,onChange:h=>I("subject",h.target.value)})]}),g==="linkedin"&&x===0&&(N==null?void 0:N.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:U,onChange:h=>I(g==="email"?"body":"message",h.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var h;(h=navigator.clipboard)==null||h.writeText(R).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),g==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(s.contactEmail||"")}?subject=${encodeURIComponent(q)}&body=${encodeURIComponent(U)}`,children:e.apprMailto}),M&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function jc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:l,flash:s,flashErr:g,canWrite:p}=K(),[x,u]=c.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),w=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,k=()=>{if(x||!p||m)return;u(!0),(b?ur(l,!1):ur(l,!0,r,n.trim()||void 0)).then(v=>{if(u(!1),!v){g(d.actErr);return}o(v),s(v.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!p||!!m,title:m||void 0,onClick:k,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),m===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:m}),w&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function Ec({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:l,canWrite:s}=K(),[g,p]=c.useState("valides"),[x,u]=c.useState(!1),[b,m]=c.useState(null),[w,k]=c.useState(null),[f,v]=c.useState(!1),[j,y]=c.useState(!1),[N,E]=c.useState(null),[S,L]=c.useState(null),T=`atl2:bulk:${d}:${g}:${e}`;c.useEffect(()=>{m(null),k(null),v(!1),E(null);try{const D=localStorage.getItem(T)||localStorage.getItem(`atl2:bulk:${d}:${g}`),O=JSON.parse(D||"null");L(O&&Date.now()-Date.parse(O.t)<24*3600*1e3?O:null)}catch{L(null)}},[T,g,d]);const I=e==="instantly"&&!r.trim(),M=`${g}|${e}|${r.trim()}`,U=async()=>{if(I||!s)return;u(!0),v(!1),E(null);const D=await Rs(d,g,e,r.trim()||void 0);m(D),k(D.ok?M:null),u(!1)},q=c.useRef(!1);if(!s)return null;const R=async()=>{if(q.current||!s)return;q.current=!0,y(!0);const D=`${d}:${g}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let O;try{O=await Fs(d,g,e,r.trim()||void 0,D)}finally{q.current=!1}if(y(!1),v(!1),E(O),O.ok&&(O.pushed||0)>0){const _={t:new Date().toISOString(),n:O.pushed||0};L(_);try{localStorage.setItem(T,JSON.stringify(_))}catch{}}};f&&w!==null&&w!==M&&v(!1);const h=o,A=b!=null&&b.ok&&b.ready||0,$=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":h||"",X=!!(b!=null&&b.ok)&&w===M&&A>0&&!!$&&!S,z=S?new Date(S.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:g,onChange:D=>p(D.target.value),children:i.plugBulkTabs.map(([D,O])=>t.jsx("option",{value:D,children:O},D))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:D=>a(D.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:D=>n(D.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||I,onClick:()=>{U()},children:x?"…":i.plugBulkPreview})]}),I&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),S&&t.jsx("p",{className:"mnote",children:i.bulkLocked(z,S.n)}),!S&&!!(b!=null&&b.ok)&&!$&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!S&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),X&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>v(!0),children:i.bulkArm}),X&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(A,$)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:j,onClick:()=>{R()},children:j?i.bulkSending:i.bulkConfirm($)}),t.jsx("button",{type:"button",className:"abtn",disabled:j,onClick:()=>v(!1),children:i.bulkCancel})]}),N&&(N.ok?N.replayed?t.jsx("p",{className:"mnote",children:N.pending?i.bulkPending:i.bulkReplayed}):(N.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(N.pushed||0,N.linkedinReady||0,N.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:N.error||i.actErr}))]})}function Nc(){const{t:e,data:a,lang:r}=K(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const l=window.location.href.split("?")[0];try{const g=await(await fetch(`${Ha}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ge,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(d.credits,d.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Sc(){const{t:e}=K();return t.jsx(Ge,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(ic,{})})}function Cc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:l}=K(),[s,g]=c.useState(null),[p,x]=c.useState(!1);c.useEffect(()=>{let T=!0;if(i)return Rn(i).then(I=>{T&&I&&typeof I.per_day=="number"&&g(I.per_day)}),()=>{T=!1}},[i]);const[u,b]=c.useState(null);c.useEffect(()=>{if(!o)return;let T=!0;return Ss(o).then(I=>{T&&b(I)}),()=>{T=!1}},[o]);const m=r.stats,w=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(T=>T.kind==="target"&&_e(T)).length,k=r.marketEstimate||0,f=k>0?Math.min(100,Math.round(w/k*100)):null,v=(m==null?void 0:m.window_days)||30,j=w>0?w/v:0,y=k>0?Math.max(0,k-w):0,E=k>0&&j>0&&w>=100?Math.round(y/j):null,S=T=>Math.round(T).toLocaleString(a==="en"?"en-US":"fr-FR"),L=T=>{p||!d||(x(!0),Ts(o,T).then(I=>{if(x(!1),I===null){l(e.actErr);return}g(I),l(e.alertSaved)}))};return t.jsxs(Ge,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(S(w))}),k>0&&t.jsx("span",{children:e.covOf(S(k))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),E!==null&&t.jsx("p",{className:"mnote",children:e.covEta(E)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(S(j))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((T,I)=>t.jsxs("tr",{className:T.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[T.code,T.geo?` · ${T.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof T.n=="number"?S(T.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:T.source}),T.elargi&&t.jsx("em",{children:e.covWide(String(T.demande||""))}),T.erreur&&t.jsx("em",{children:e.covMissing})]})]},I)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:S(u.total||k)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(T=>t.jsx("button",{type:"button",className:s===T?"on":"",disabled:p,onClick:()=>L(T),children:T===0?"⏸":T},T))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function vi(e,a,r){const n=await fetch(`${yt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${yt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function zc(){const{t:e,token:a,canWrite:r}=K(),[n,o]=c.useState(null),[i,d]=c.useState(""),[l,s]=c.useState(""),[g,p]=c.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=c.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const m=JSON.parse(localStorage.getItem(x)||"null");return!!m&&Date.now()-(m.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(c.useEffect(()=>{if(!r)return;let m=!0;return qs(a).then(w=>{m&&o(w)}),()=>{m=!1}},[a,r]),!r||g||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),vi(a,n.instruction||"","atelier2-avis").then(m=>{if(d(m.applied?"ok":"ko"),m.applied||s(m.encours?e.propSlow:m.reply),m.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:l||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{p(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Ac(){var N;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=K(),[i,d]=c.useState(!1),[l,s]=c.useState(null),[g,p]=c.useState(!1),[x,u]=c.useState([]),[b,m]=c.useState(null),[w,k]=c.useState([]);if(!r)return null;const f=()=>{d(!0),p(!1),u([]),k([]),Ls(a).then(E=>{if(d(!1),!E){p(!0),s(null);return}s(E)})},v=E=>{b||(m(E.title),vi(a,E.instruction,"atelier2-prop").then(S=>{m(null),S.applied?(k(L=>[...L,E.title]),n(e.propApplied)):S.encours?n(e.propSlow):o(S.reply||e.propApplyFail)}))},j=((l==null?void 0:l.proposals)||[]).filter(E=>!x.includes(E.title)&&!w.includes(E.title)),y=((N=l==null?void 0:l.counts)==null?void 0:N.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:f,children:i?e.propWait:e.propBtn}),!i&&g&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!g&&l&&!(l.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:l.reason==="not_enough_signals"?e.propFew(y):e.propNone}),j.map(E=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[E.section]||E.section}),t.jsx("p",{className:"propt",children:E.title}),E.why&&t.jsx("p",{className:"mnote dim",children:E.why}),E.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",E.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>v(E),children:b===E.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(S=>[...S,E.title]),children:e.propSkip})]})]},E.title))]})}function qc(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=K(),[l,s]=c.useState(null),[g,p]=c.useState(!1),[x,u]=c.useState(!1),[b,m]=c.useState(""),[w,k]=c.useState(""),[f,v]=c.useState(!1),j=c.useRef(!1);if(c.useEffect(()=>{if(!a||!r)return;let E=!0;return As(a).then(S=>{E&&(p(!0),!(!S||j.current)&&(s(S),m(S.fit),k(S.note)))}),()=>{E=!1}},[a,r]),!r)return null;const y=()=>{if(!(!b||f)){if(l&&l.fit===b&&l.note===w.trim()){u(!1);return}v(!0),bt(a,"thesis_fit",b,w.trim(),"",d.email||"").then(E=>{if(v(!1),!E.ok){o(e.fitKo);return}s({fit:b,note:w.trim(),ts:new Date().toISOString()}),u(!1),n(e.fitSaved)})}},N=E=>E==="yes"?e.fitYes:E==="partial"?e.fitPartial:e.fitNo;if(l&&!x){const E=new Date(String(l.ts||"")),S=Number.isNaN(E.getTime())?"":E.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:N(l.fit)}),l.note?` — ${l.note}`:""]}),!!S&&t.jsx("p",{className:"mnote dim",children:S}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(E=>t.jsx("button",{type:"button","aria-pressed":b===E,className:"fitopt"+(b===E?" on":""),onClick:()=>{j.current=!0,m(E)},children:N(E)},E))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:w,onChange:E=>{j.current=!0,k(E.target.value)},onKeyDown:E=>{E.key==="Enter"&&y()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||f,onClick:y,children:f?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!g&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function Tc(){var f,v,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:l}=K(),s=n==="client",g=c.useMemo(()=>{const y=new Set;return a.forEach(N=>{N.angle&&y.add(N.angle)}),[...y]},[a]),[p,x]=c.useState(""),[u,b]=c.useState(""),[m,w]=c.useState(!1),k=async()=>{const y=p.trim();if(!(!y||m||!s)){w(!0),b("");try{const E=await(await fetch(`${yt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(E.reply&&b(String(E.reply)),E.job_id){b(e.critChatRunning);const S=async()=>{const L=await fetch(`${yt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:E.job_id})}).then(T=>T.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),w(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{S()},8e3)};setTimeout(()=>{S()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||w(!1)}}};return t.jsxs(Ge,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((v=i==null?void 0:i.angles)!=null&&v.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(y=>{var N,E;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((N=y.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(S=>t.jsx("li",{children:S},S))})]}),!!((E=y.out)!=null&&E.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(S=>t.jsx("li",{children:S},S))})]})]})]},y.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsx(qc,{}),t.jsx(zc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:p,disabled:!s||m,onChange:y=>x(y.target.value),onKeyDown:y=>{y.key==="Enter"&&k()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!s||m||!p.trim(),onClick:()=>void k(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(Ac,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Ns,{fund:d,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(hi[y]||"v-cons"),children:y}),t.jsx("span",{children:N})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",N]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Lc(){const{t:e,dispatch:a,startTour:r}=K(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Ge,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const yi="atl2:mapfold",Rc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(yi);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Fc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},wi=c.createContext(null),K=()=>{const e=c.useContext(wi);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Et({o:e,lg:a}){const{lang:r}=K(),n=Ie(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:hr(n,r),children:[n.emoji," ",hr(n,r)]}):null}function Va({o:e,src:a}){const{lang:r,t:n}=K(),o=Ie(e);if(!o)return null;const i=Hs(o),d=Vs(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(So(o,r))+" · "+n.win7(Co(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,s)=>t.jsx("i",{className:s<i?"on":""},s))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Oc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=He(a);if(o)return e.find(i=>He(i.name)===o)||e.find(i=>{const d=He(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Mc(){const{scoped:e,t:a,st:r,dispatch:n}=K(),o=c.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(x=>!Qe(x)),l=d.length,s=d.filter(x=>!x.noCo).length,g=d.filter(x=>!!x.noCo).length,p=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:p?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",s," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function Dc(){const{t:e,lang:a,data:r,dispatch:n}=K(),o=r.stats,i=l=>l.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const d=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:d>0?e.covOf(i(d)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function ki({o:e}){const{lang:a}=K(),r=Us(e.cc),n=e.cc?Gt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Ic=!1;function Pc(){const[e,a]=c.useState(!1);return c.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const ji=e=>`atl2:tour:${e||"anon"}`;function _c(e){try{return localStorage.getItem(ji(e))==="1"}catch{return!0}}function mo(e){try{localStorage.setItem(ji(e),"1")}catch{}}function Bc(e,a,r,n,o,i,d,l){const s=e.tourT,g=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:g[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:g[1][0]},{sel:".atl2 .dmulti.ddeals",title:s.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:s.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:s.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:s.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:s.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:s.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,...[2,4,5].filter(p=>(l[p]||0)>0).map(p=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:p===2?s.tabAna:p===4?s.tabValid:s.tabRej,body:p===2?e.fhintTabAna:p===4?e.fhintTabValid:e.fhintTabRej,ptab:p})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:s.rank,body:e.fhintRank},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:s.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:g[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:g[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:s.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:s.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:s.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function Wc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Qn;const{lang:d}=Ps(),l=Ll(e,d,a),s=c.useMemo(()=>({...vl[d],...bl(d,l.thesisMode)}),[d,l.thesisMode]),[g,p]=c.useReducer(Ol,void 0,()=>Rl((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Fc():Rc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=c.useRef(!0);c.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(yi,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),c.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const C=()=>{window.innerWidth<=760&&p({type:"mapFold",folded:!0})};return C(),window.addEventListener("resize",C),()=>window.removeEventListener("resize",C)},[a]);const u=c.useRef(i);u.current=i,c.useEffect(()=>{var C;(C=u.current)==null||C.call(u,g.filters)},[g.filters]);const[b,m]=c.useState(()=>{if(typeof window>"u")return"both";try{const C=localStorage.getItem("atl2:chrome-mode");if(C==="eval"||C==="filt"||C==="both")return C;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[w,k]=c.useState(null),[f,v]=c.useState(null),[j,y]=c.useState(null),[N,E]=c.useState({kept:0,dropped:0}),[S,L]=c.useState(!1),[T,I]=c.useState(""),[M,U]=c.useState(!1),[q,R]=c.useState(null),[h,A]=c.useState(null),[$,X]=c.useState(!1),[z,D]=c.useState(!1),[,O]=c.useState(0),_=()=>O(C=>C+1),J=c.useRef([]),ee=c.useRef(new Set),ge=c.useRef(new Set),[ae,de]=c.useState([]),[ue,fe]=c.useState([]),[ve,xe]=c.useState(0),ye=c.useRef(new Map),ze=c.useRef(null),{mode:ne}=l,B=c.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),te=B.pipe,H=l.session.token||"",V=ne==="client"&&!e;c.useEffect(()=>{if(!H||!te)return;let C=!0;const Y=async()=>{const me=await Ws(H);!C||!me||(fe(me.runs),xe(Date.now()/1e3-me.now),de(Le=>Le.filter(Ee=>!me.runs.some($e=>He($e.company)===He(Ee.name)))))};Y();const G=ae.length>0||ue.some(me=>me.status==="running"),se=window.setInterval(()=>{Y()},G?8e3:25e3);return()=>{C=!1,window.clearInterval(se)}},[H,te,ae.length,ue.some(C=>C.status==="running")]),c.useEffect(()=>{if(!H||!te||!V)return;let C=!0;const Y=async()=>{const se=await Gs(H);if(!C||!se.length)return;const me=new Map;se.forEach(Le=>{const Ee=String(Le.ceo_status||"").trim();Ee&&Le.check_id&&me.set(String(Le.check_id),Ee)}),l.patchStatuses(me,Le=>Date.now()-(je.current.get(Le)||0)>9e4)};Y();const G=window.setInterval(()=>{Y()},6e4);return()=>{C=!1,window.clearInterval(G)}},[H,te,V]);const W=c.useMemo(()=>{const C=[],Y=new Set;for(const G of ae){const se=He(G.name);!se||Y.has(se)||(Y.add(se),C.push({name:G.name,id:G.id,status:"boot",started:G.started,estMin:G.estMin,memoType:"instant"}))}for(const G of ue){const se=He(G.company);if(!se||Y.has(se))continue;Y.add(se);const me=G.status==="error"?"error":G.status==="done"?"done":"running";C.push({name:G.company,status:me,started:G.started||0,estMin:G.est_min||(G.memo_type==="detailed"?40:15),url:G.url,error:G.error,memoType:G.memo_type,note:G.note})}return C},[ae,ue]),ie=C=>W.find(Y=>He(Y.name)===He(C))||null,le=(C,Y)=>{de(G=>G.some(se=>He(se.name)===He(C.name))?G:[...G,{name:C.name,id:C.id,started:Date.now()/1e3,estMin:Y==="detailed"?40:15}]),ee.current.add(C.id),_()},pe=(C,Y=!1)=>{I(C),U(Y),ze.current&&clearTimeout(ze.current),ze.current=setTimeout(()=>I(""),Y?4200:2400)},be=C=>pe(C,!0),ke=c.useMemo(()=>{const C=new Map;return l.dossiers.forEach(Y=>{Y.id&&C.set(Y.id,Y)}),C},[l.dossiers]),qe=c.useMemo(()=>l.dossiers.filter(C=>oa(C,g,te)),[l.dossiers,g,te]),ot=c.useRef(!1);c.useEffect(()=>{if(ot.current||l.loading||!l.dossiers.length)return;if(e&&!l.session.token){ot.current=!0;return}if(!B.showFunnel||_c(l.session.token||"")){ot.current=!0;return}ot.current=!0;const C=window.setTimeout(()=>{mo(l.session.token||""),X(!0)},700);return()=>window.clearTimeout(C)},[e,l.loading,l.dossiers.length,B.showFunnel,l.session.token]);const it=c.useMemo(()=>l.dossiers.filter(C=>Ml(C,g,te,l.favIds)),[l.dossiers,g,te,l.favIds]),Be=c.useMemo(()=>_s(qe.filter(C=>!Ye(C)),l.favIds),[qe,l.favIds]),Ne=c.useRef(!1);c.useEffect(()=>{if(Ne.current)return;if(!te||a==="ops"){Ne.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Ne.current=!0;return}if(l.loading)return;Ne.current=!0;const C=Bs(Be);C!==g.ptab&&p({type:"ptab",tab:C})},[te,a,n==null?void 0:n.ptab,l.loading,Be,g.ptab]);const Mt=c.useMemo(()=>{const C=_o(l.dossiers);return C?wt(C)===0?s.tourToday:Bo(C,d):s.tourNoRun},[l.dossiers,s,d]),St=c.useMemo(()=>l.dossiers.some(C=>!!C.memoUrl||!!C.summary||$t(C)),[l.dossiers]),[Me,st]=c.useState(!1);c.useEffect(()=>{if(l.loading){st(!1);return}if(l.dossiers.length>0||l.error){st(!0);return}const C=window.setTimeout(()=>st(!0),6e3);return()=>window.clearTimeout(C)},[l.loading,l.dossiers.length,l.error]);const ft=(l.marketEstimate||0)>0||typeof((Qn=l.stats)==null?void 0:Qn.screened)=="number"&&l.stats.screened>0,Ct=c.useMemo(()=>[1,0,2,4,5,3].find(C=>(Be[C]||0)>0)??0,[Be]),et=Fn.find(C=>C.key===g.continent),zt=g.continent==="monde"?s.contWorld:(d==="fr"?et==null?void 0:et.fr:et==null?void 0:et.en)||"";c.useEffect(()=>{const C=Y=>{var se;const G=(((se=Y.detail)==null?void 0:se.name)||"").trim();G&&ht(null,G)};return window.addEventListener("ppmap:evaluate",C),()=>window.removeEventListener("ppmap:evaluate",C)}),c.useEffect(()=>{const C=Y=>{const G=Y.detail||{},se=String(G.id||"").trim(),me=String(G.name||"").trim(),Le=String(G.url||"").trim(),Ee=se&&ke.get(se)||Oc(l.dossiers,me,Le);if(Ee){if(v(null),oa(Ee,g,te)||(g.continent!=="monde"&&Ee.continent!==g.continent&&p({type:"continent",key:Ee.continent||"monde"}),p({type:"reset"})),te&&Ee.kind!=="op"){const pt=Ce(Ee);typeof pt=="number"&&pt!==g.ptab&&p({type:"ptab",tab:pt})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),p({type:"focus",id:Ee.id}),(Ee.noCo||["media","nominations","recrutements"].includes(Ee.engine||""))&&(Ee.url||Ee.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee.url||"",text:[Ee.headline,Ee.tagline].filter(Boolean).join(`
`)}})):Ee.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ee.name,url:Ee.url||"",website:Ee.website||"",domain:Ee.domain||""}}));return}!me&&!Le||(p({type:"focus",id:se||null}),v({name:me,headline:String(G.text||"").trim()||me,url:Le,card:G.card}),Le&&(La(me)||!me)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Le,text:String(G.text||"").trim()}})):me&&!La(me)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:me}})))};return window.addEventListener("ppmap:focus",C),()=>window.removeEventListener("ppmap:focus",C)}),c.useEffect(()=>{const C=se=>{const me={},Le=String((se==null?void 0:se.sector)||"").trim();Le&&(me.sector=[Le]);const Ee=String((se==null?void 0:se.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ee)&&(me.day=Ee);const $e=String((se==null?void 0:se.search)||"").trim();$e&&(me.search=$e);const pt=String((se==null?void 0:se.dealKind)||"").trim();(pt==="ma"||pt==="levee"||pt==="other")&&(me.dealKind=[pt]),Object.keys(me).length&&p({type:"filters",patch:me})},Y=se=>C(se.detail),G=se=>{se.data&&se.data.type==="pp-filter"&&C(se.data)};return window.addEventListener("ppmap:filter",Y),window.addEventListener("message",G),()=>{window.removeEventListener("ppmap:filter",Y),window.removeEventListener("message",G)}},[]),c.useEffect(()=>{const C=Y=>{var me;const G=(((me=Y.detail)==null?void 0:me.name)||"").trim().toLowerCase();if(!G)return;const se=l.dossiers.find(Le=>(Le.name||"").trim().toLowerCase()===G);se&&p(a==="ops"?{type:"focus",id:se.id}:{type:"popup",id:se.id})};return window.addEventListener("ppmap:similar",C),()=>window.removeEventListener("ppmap:similar",C)});const ht=(C,Y,G)=>{const se=(G||(C==null?void 0:C.name)||Y||"").trim();if(!V){y({kicker:se});return}!se||S||(L(!0),(async()=>{try{let me=(Y||se).trim();const Le=((C==null?void 0:C.website)||(C==null?void 0:C.domain)||"").trim();if(!(/^https?:\/\//i.test(me)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(me)&&!/\s/.test(me)))if(Le)me=Le;else try{const Oe=await On(se);if(Oe!=null&&Oe.website)me=Oe.website;else if(((Oe==null?void 0:Oe.candidates)||[]).length===1)me=Oe.candidates[0].url;else if(((Oe==null?void 0:Oe.candidates)||[]).length>1){J.current=[{name:se,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(Oe.candidates||[]).slice(0,5)},...J.current].slice(0,8),_();return}}catch{}const $e=await wo(H,me,"atelier2"),pt={name:$e.company||se,verdict:$e.verdict,reason:$e.reason||"",remaining:$e.remaining??null};J.current=[pt,...J.current].slice(0,8),$e.verdict==="kept"&&E(Oe=>({...Oe,kept:Oe.kept+1})),$e.verdict==="ruled_out"&&E(Oe=>({...Oe,dropped:Oe.dropped+1}));const Qt=C||l.dossiers.find(Oe=>(Oe.name||"").toLowerCase()===se.toLowerCase());Qt&&($e.verdict==="kept"?Qt.verdict=Qt.verdict||"MATCH":$e.verdict==="ruled_out"&&(Qt.verdict="NO MATCH"),$e.reason&&(Qt.reasoning=$e.reason)),_()}finally{L(!1)}})())},Dt=C=>{if(!V){y({kicker:C.name});return}le(C,"instant"),bt(H,"fast_request",C.name||"",""),pe(s.memoInstantSent(C.name))},It=C=>ye.current.get(C.id)??l.thumbs.get((C.name||"").trim().toLowerCase()),De=(C,Y)=>p({type:"undoPush",entry:{id:C.id,name:C.name,prevCeoStatus:Y}}),Ke=async(C,Y,G)=>{const se=C.ceoStatus||"";je.current.set(C.id,Date.now()),C.ceoStatus=Y,_();const me=await Qa(H,{status:Y,airtable_id:C.airtableId,check_id:C.checkId,company:C.name,...(G==null?void 0:G.note)!==void 0?{note:G.note}:{},...G!=null&&G.via?{via:G.via}:{}});return me.ok?me.skipped?(C.ceoStatus=se,_(),be(s.actNotPersisted),!1):((G==null?void 0:G.undo)!==!1&&De(C,se),G!=null&&G.msg&&pe(G.msg),(Y==="Validé"||Y==="Écarté")&&!C.ceoNote&&(G==null?void 0:G.note)===void 0&&R({o:C,yes:Y==="Validé"}),!0):(C.ceoStatus=se,_(),be(s.actErr),!1)},Ve=async(C,Y)=>{const G=await Qa(H,{status:C.ceoStatus||"Retenu",airtable_id:C.airtableId,check_id:C.checkId,company:C.name,note:Y,via:"note"});return!G.ok||G.skipped?(be(G.skipped?s.actNotPersisted:s.actErr),!1):(C.ceoNote=Y,_(),!0)},dt=c.useRef(new Map),F=C=>dt.current.has(C.id)?dt.current.get(C.id):l.stages.get((C.name||"").trim().toLowerCase()),Q=(C,Y)=>{dt.current.set(C.id,Y),_()},Z=(C,Y)=>{V&&Ke(C,Y?"Validé":"Écarté",{msg:Y?s.decidedYes(C.name):s.decidedNo(C.name)})},P=C=>{V&&Ke(C,"À trancher",{msg:s.promoted(C.name)})},oe=C=>{V&&(async()=>{const Y=C.ceoStatus||"";C.ceoStatus="Retenu",_();const G=await Qa(H,{status:"Retenu",check_id:C.checkId,company:C.name});if(!G.ok||G.skipped){C.ceoStatus=Y,_(),be(G.skipped?s.actNotPersisted:s.actErr);return}De(C,Y),pe(s.repeched(C.name))})()},re=()=>{const C=g.undo[g.undo.length-1];if(!C){pe(s.undoNone);return}const Y=ke.get(C.id);if(!Y){p({type:"undoPop"}),pe(s.undoNone);return}let G=C.prevCeoStatus;if(!G)if((Y.verdict||"").toUpperCase().includes("CALL"))G="À trancher";else{pe(s.undoLockedTitle);return}(async()=>await Ke(Y,G,{undo:!1})&&(p({type:"undoPop"}),Y.ceoStatus=C.prevCeoStatus,_(),pe(s.undoDone(Y.name))))()},ce=C=>{V&&(ge.current.add(C.id),_(),p({type:"approachOpen",id:C.id}),bt(H,"approach",C.name||"","","",l.email||""))},je=c.useRef(new Map),he=c.useRef(!1),[Pe,Te]=c.useState(0);c.useEffect(()=>{if(!H||e||!V||he.current)return;he.current=!0;const C=new Date().toISOString().slice(0,10),Y=`atl2:vue:${H}:${C}`;try{if(localStorage.getItem(Y))return}catch{}bt(H,"view","","","",l.email||"").then(G=>{if(!G.ok){he.current=!1;return}try{localStorage.setItem(Y,"1")}catch{}})},[H,e]),c.useEffect(()=>{if(!H||!te||e||!V||!l.generatedAt)return;let C=!0;const Y=()=>{document.hidden||Ys(H,l.generatedAt||"").then(se=>{C&&Te(se)})};Y();const G=window.setInterval(Y,6e4);return()=>{C=!1,window.clearInterval(G)}},[H,te,e,l.generatedAt]);const gt=(C,Y)=>{V&&(async()=>{if(!(await bt(H,Y?"yes":"no",C.name||"",(C.ceoNote||"").slice(0,400),C.sector||"",l.email||"")).ok){be(s.actErr);return}ye.current.set(C.id,Y?"yes":"no"),_(),pe(Y?s.thumbUpDone:s.thumbDnDone),A({o:C,up:Y})})()},Pt=C=>{!V||!$t(C)||(le(C,"detailed"),bt(H,"detailed_request",C.name||"","","",l.email||""),pe(s.memoDeepSent(C.name)))},Je=C=>{!V||!C.memoUrl||window.confirm(s.memoRegenAsk(C.name))&&(le(C,"detailed"),bt(H,"detailed_regen",C.name||"","","",l.email||""),pe(s.memoDeepSent(C.name)))},Ei=C=>{const Y=new Set(l.favIds),G=Y.has(C.id);G?Y.delete(C.id):Y.add(C.id),l.setFavIds(Y),V&&Qs(H,{id:C.id,co:C.name},G)},Ni=()=>{!V||z||window.confirm(s.identSyncConfirm)&&(D(!0),(async()=>{const C=await Ks(H);D(!1),C?pe(s.identSyncDone):be(s.actErr)})())},Yn=/proplace/i.test(l.fund||""),Si=C=>{!V||!Yn||(bt(H,"onboard_request",C.name||"",""),pe(s.onboardSent(C.name)))},Ci={st:g,dispatch:p,t:s,lang:d,mode:ne,caps:B,pipe:te,token:H,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:oe,thumbOf:It,canWrite:V,commitStatus:Ke,saveNote:Ve,stageOf:F,setStage:Q,flashErr:be,startTour:()=>X(!0),dossiers:l.dossiers,scopedAll:qe,scoped:it,counts:Be,byId:ke,contName:zt,favIds:l.favIds,toggleFav:Ei,askEvaluate:ht,doAnalyse:Dt,doDecide:Z,doPromote:P,doApproach:ce,doThumb:gt,doDeep:Pt,doRegen:Je,doUndo:re,doSync:Ni,doOnboard:Si,outbound:Yn,memoQueued:ee.current,liveMemos:{items:W,serverOff:ve,liveOf:ie},approachDone:ge.current,sessTally:N,evalCards:J.current,evalBusy:S,markRow:k,markedId:w,flash:pe,focusExtra:f};c.useEffect(()=>{const C=Y=>{Y.key==="Escape"&&(p({type:"popup",id:null}),p({type:"modal",modal:null}),p({type:"openFacet",facet:null}))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[]);const zi=C=>H?t.jsx(Pl,{token:H,children:C}):t.jsx(t.Fragment,{children:C});return t.jsx(wi.Provider,{value:Ci,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(H?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:El}),zi(t.jsxs("div",{className:"app"+(te?" pipe":"")+(H?" has-thesis":""),children:[B.showTicker&&t.jsx(lt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(H?" live-stack--cibles":""),children:[t.jsx(Wl,{}),!!H&&t.jsx(_l,{})]})}),B.showIdent&&t.jsx(lt,{name:"identite",children:t.jsx(nd,{})}),!1,Ic,B.showFunnel&&t.jsx(lt,{name:"entonnoir",children:t.jsx($c,{})}),!g.mapFolded&&t.jsx(lt,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(si,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Mc,{}),a!=="ops"&&B.showFunnel&&t.jsx(Dc,{}),t.jsx(tp,{}),t.jsx(ii,{})]})]})}),B.showDemand&&te&&t.jsx(lt,{name:"direct",children:t.jsx(tl,{items:W,serverOff:ve,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>p({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([C,Y])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===C,onClick:()=>{m(C);try{localStorage.setItem("atl2:chrome-mode",C)}catch{}},children:Y},C))}),B.showDemand&&t.jsx(lt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(pp,{})})}),B.showDemand&&g.memoConsole&&t.jsx(lt,{name:"console",children:t.jsx(up,{})}),B.pipe&&!!H&&t.jsx(lt,{name:"moteurs",children:t.jsx(ul,{})}),Pe>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:s.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Te(0),l.refresh()},children:s.freshGo})]}),t.jsx(lt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(ec,{})}),B.pipe&&!!H&&t.jsx("p",{className:"privnote",children:s.privLink}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(lt,{name:"fiche",children:t.jsx(Dp,{})}),t.jsx(lt,{name:"modales",children:t.jsx(lc,{})}),t.jsx(Ql,{}),h&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:h.o.name}),t.jsx(Cr,{placeholder:h.up?s.thumbWhyUpPh:s.thumbWhyDnPh,onDone:C=>{const Y=h.o;A(null),C&&bt(H,"note",Y.name||"",C,Y.sector||"",l.email||"").then(G=>{G.ok&&pe(s.csNoteSaved)})}})]}),q&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:q.o.name}),t.jsx(Cr,{placeholder:q.yes?s.whyYesPh:s.whyNoPh,onDone:C=>{const Y=q.o;R(null),C&&Ve(Y,C).then(G=>{G&&pe(s.csNoteSaved)})}})]}),$&&Me&&t.jsx(td,{steps:Bc(s,Mt,St,Ct,ft,Be[3]||0,Be[4]||0,Be),onClose:()=>{X(!1),mo(H)}}),t.jsx(Pc,{}),B.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:Io,children:Pn}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("button",{type:"button",onClick:()=>p({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),T&&t.jsx("div",{className:"flash on"+(M?" err":""),children:T}),j&&t.jsx($s,{variant:"acquirer",initialCompany:fo().co,initialWebsite:fo().site,onClose:()=>y(null)})]})})}function $c(){const{t:e}=K(),[a,r]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function fo(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Uc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{ki as FlagCell,Et as SigBadge,Va as SigWin,Wc as default,Uc as fmtShort,K as useV2};
