...
`,Ji=Ki+Qi;function Qa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Xi(){const e=Qa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Zi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Xi();return r==="0"?"client":r==="1"||Qa("embed")==="1"&&Qa("chrome")==="1"?"apercu":"client"}const es={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},ts=e=>es[e];function wa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const yt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!zr(a)||wa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:$o(e.cc)})};function Pa(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const as=60*60*1e3;function ns(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>as?null:a}catch{return null}}function ia(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const rs=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function os(e,a,r="default"){const n=r!=="default",o=u.useMemo(()=>e||n?{mode:"anon"}:To(),[e,n]),i=u.useMemo(()=>n?"visiteur":Zi(e,o),[e,o,n]),l=u.useMemo(()=>ts(i),[i]),d=i!=="visiteur",c=rs(r),[g,s]=u.useState([]),[x,p]=u.useState(""),[b,m]=u.useState(null),[v,y]=u.useState(null),[h,j]=u.useState(null),[S,k]=u.useState(()=>new Map),[N,T]=u.useState(()=>new Map),[E,q]=u.useState(""),[C,R]=u.useState(new Set),[I,$]=u.useState(null),[L,F]=u.useState(!0),[f,A]=u.useState(!1),[B,W]=u.useState(0),[V,Q]=u.useState(0),Z=u.useRef(0),J=u.useMemo(()=>{var te;if(i!=="client")return"";try{return((te=qo())==null?void 0:te.email)||""}catch{return""}},[i]);u.useEffect(()=>{const te=++Z.current;let he=!0;const U=()=>he&&te===Z.current,de=(d&&o.token?o.token:"pub:"+a)+(c?":"+c:""),xe=ns(de);return xe?(s(xe.objs.map(yt)),xe.fund&&p(xe.fund),m(xe.marketEstimate??null),y(xe.criteria??null),j(xe.stats??null),q(xe.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const ae=await Ma(),ze=((ae==null?void 0:ae.recent_ops)||[]).map(ie=>{const me=ha(ie.company_name||ie.title?ie:{...ie,title:(ie.headline_fr||ie.headline||"").slice(0,120)},a),se=String(ie.rubrique||"").toLowerCase();return me&&(se==="nominations"||se==="recrutements")&&(me.engine=se),me&&!String(ie.company_name||"").trim()&&(me.noCo=!0),me}).filter(ie=>!!ie).map(ie=>(zr((ie.name||"").trim())||(ie.noCo=!0),ie));try{const ie=Lo(),me=await Fo(),se=((me==null?void 0:me.date)||"").slice(0,10),K=ie?ie.doc:me,G=Ro(K),le=((ie==null?void 0:ie.day)||(K==null?void 0:K.date)||se||"").slice(0,10);if(le&&G.length){const Se=new Set;for(const ce of ze){if((ce.date||"").slice(0,10)!==le)continue;const oe=An(G,Se,ce.name,"");oe>=0&&(Se.add(oe),ce.decryptHtml=G[oe].html)}for(const ce of ze){if(ce.decryptHtml||(ce.date||"").slice(0,10)!==le)continue;const oe=An(G,Se,"",ce.headline||ce.tagline||ce.name);oe>=0&&(Se.add(oe),ce.decryptHtml=G[oe].html)}}if(le){const Se=((K==null?void 0:K.title_fr)||"").trim(),ce=((K==null?void 0:K.lead_fr)||"").trim(),oe=Mo(K),ke=((K==null?void 0:K.url)||"").trim();Se&&(oe||ke)&&ze.unshift({id:`edito:${le}`,kind:"op",name:Se,cc:null,date:le,engine:"edito",dealKind:"other",headline:Se,tagline:ce||Se,decryptHtml:oe||void 0,url:ke,noCo:!0})}}catch{}if(!U())return;s(ze.map(yt)),ia(de,{objs:ze})}else if(typeof r=="object"){const ze=(await Tn()||[]).filter(me=>(me.slug||"")===r.research).map(me=>qn(me,a)).filter(me=>!!me),ie=Pa(await Ln(ze,a));if(!U())return;s(ie.map(yt)),ia(de,{objs:ie})}else if(d&&o.token){const ae=Oo(o.token),ze=Ma(),ie=Do(o.token),me=Po(o.token),se=Io(o.token),K=await ae;let G=K?K.targets:[];U()&&K&&(p(K.fund||""),m(K.marketEstimate??null),y(K.criteria??null),j(K.stats??null),q(K.generatedAt||""),s(G.map(yt)),F(!1),A(!1));const[le,Se,ce,oe]=await Promise.all([ze,ie,me,se]),ke=((le==null?void 0:le.recent_ops)||[]).map(Re=>ha(Re,a)).filter(Re=>!!Re);if(G=[...G,...ke],!U())return;s(G.map(yt));const Fe=new Set;for(const Re of Se){const ve=(Re.id||Re.co||"").toString().trim().toLowerCase();ve&&Fe.add(ve.startsWith("t:")?ve:"t:"+ve)}R(Fe),k(ce),T(oe),K&&ia(de,{fund:K.fund,marketEstimate:K.marketEstimate,criteria:K.criteria,stats:K.stats,generatedAt:K.generatedAt,objs:G})}else{const ae=Bo(),ze=Tn(),ie=Ma(),me=await ae;U()&&me.length&&(s(Pa(me).map(yt)),F(!1),A(!1));const[se,K]=await Promise.all([ze,ie]),G=(se||[]).map(oe=>qn(oe,a)).filter(oe=>!!oe),le=await Ln(G,a),Se=((K==null?void 0:K.recent_ops)||[]).map(oe=>ha(oe,a)).filter(oe=>!!oe),ce=Pa([...me,...le,...Se]);if(!U())return;s(ce.map(yt)),ia(de,{objs:ce})}U()&&A(!1)}catch{U()&&!xe&&A(!0)}finally{U()&&F(!1)}})(),()=>{he=!1}},[d,o.token,a,B,c]),u.useEffect(()=>{if(!l.showCredits||!J){$(null);return}let te=!0;return(async()=>{try{const he=await fetch(`${mn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:J})});if(!he.ok)return;const U=await he.json();te&&U&&U.ok!==!1&&$(U)}catch{}})(),()=>{te=!1}},[l.showCredits,J,V]);const ue=u.useCallback(te=>R(new Set(te)),[]);return{session:o,mode:i,caps:l,fund:x,email:J,marketEstimate:b,generatedAt:E,criteria:v,stats:h,thumbs:S,stages:N,dossiers:g,favIds:C,setFavIds:ue,credits:I,reloadCredits:()=>Q(te=>te+1),loading:L,error:f,refresh:()=>W(te=>te+1)}}function Xe(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Dr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),is=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Dr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ss=new Set(["signal","amount","score","crible","memo"]);function ls(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Dr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ss.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Pr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Pr=80;function ka(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Oe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(fn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(dt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&jt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function Ir(e,a,r){return Xe(e)?ka(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ka(e,a.filters,r)}function ds(e,a,r,n){return!(!Ir(e,a,r)||r&&!_o(e,a.ptab,n))}function gn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-dt(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Ho(o);case"memo":return Uo(o);case"signal":{const i=Oe(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),d=n(i);return l<d?-a.dir:l>d?a.dir:(o.name||"").localeCompare(i.name||"")})}const Ia={},_n=(Ia==null?void 0:Ia.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Un(){return new Date().toISOString().slice(0,10)}const bn=u.createContext(null);function Br(){return u.useContext(bn)}function cs(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),l=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function Hn(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null;[...n.attributes].forEach(i=>n.removeAttribute(i.name)),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Vn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${i} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${i} ${r[1]}`}function $r(){const e=u.useContext(bn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ps({token:e,children:a}){const{dispatch:r,st:n,lang:o}=H(),[i,l]=u.useState(()=>n.filters.day||Un()),[d,c]=u.useState(null),[g,s]=u.useState(!1),x=u.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){l(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),p=u.useCallback(()=>{l(Un());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);u.useEffect(()=>{const v=y=>{var j;const h=(j=y.detail)==null?void 0:j.day;typeof h=="string"&&x(h)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[x]),u.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),u.useEffect(()=>{if(!e||!i)return;let v=!1;s(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${_n}/cibles/edition.json?${y}`).then(h=>h.json()).then(h=>{v||c(h)}).catch(()=>{v||c({ok:!1,error:"network"})}).finally(()=>{v||s(!1)}),()=>{v=!0}},[e,i]);const b=u.useMemo(()=>`${_n}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=u.useMemo(()=>({token:e,day:i,ed:d,loading:g,pickDay:x,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,d,g,x,p,n.filters.day,b,o]);return t.jsx(bn.Provider,{value:m,children:a})}function us(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=$r(),[o,i]=u.useState(()=>n||Ar());return u.useEffect(()=>{n&&i(!0)},[n]),u.useEffect(()=>{const l=d=>{var c;return i(!!((c=d.detail)!=null&&c.open))};return window.addEventListener(ya,l),()=>window.removeEventListener(ya,l)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Vo,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}function Wn(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function ms(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function fs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=$r(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok,g=u.useRef(null),s=u.useMemo(()=>Hn((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),x=u.useMemo(()=>Hn((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return u.useEffect(()=>{const p=g.current;if(!p||!s)return;let b=!1;return Tr(()=>import("./fit-BnaWm7z_.js"),[]).then(async m=>{await m.ensureEditoCss(),!(b||!p.isConnected)&&(m.beautifyEditoRows(p),m.mountCardFits(p))}),()=>{b=!0}},[s]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Wn(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Vn(e,!0)}),"."]}):Wn(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Vn(e)}),"."]})}),t.jsx("a",{className:"thesis-brief__all",href:ms(e),target:"_blank",rel:"noopener noreferrer",children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),l&&s?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:s}}):null,l&&x?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:x}}):null,o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const xs=300,sa=7,hs={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},_r={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},gs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ba(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Ko(r)&&r!=="media")return"news:"+r;const n=Oe(e);return n?"sig:"+(n.theme&&_r.fr[n.theme]?n.theme:"other"):"actualites"}function bs(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:l,fund:d}=H(),c=Br(),g=l==="en",[s,x]=u.useState("all"),[p,b]=u.useState(!1),m=u.useMemo(()=>{var he;const f=(a.filters.day||"").slice(0,10),A=U=>!(!i&&a.continent!=="monde"&&U.continent!==a.continent||f&&(U.date||"").slice(0,10)!==f),B=e.filter(U=>A(U)&&Oe(U)&&(!i||U.kind!=="target"||Te(U)!==5)),W=i&&(((he=c==null?void 0:c.ed)==null?void 0:he.ops)||[]).length?c.ed.ops.map(U=>ha(U,l)).filter(U=>!!U).filter(U=>!f||(U.date||"").slice(0,10)===f):[],V=e.filter(U=>A(U)&&U.kind==="op"&&(f?!0:dt(U.date)<=sa)),Q=i?W.length?W:V.filter(U=>{const de=(d||"").trim().toLowerCase();if(!de)return!1;const xe=U.match||null;return xe?Object.keys(xe).map(ae=>ae.trim().toLowerCase()).includes(de):!1}):V,Z=f||new Date().toISOString().slice(0,10),J=U=>{const de=Ba(U);return de==="ma"?0:de==="levees"?1:2};Q.sort((U,de)=>{const xe=J(U)-J(de);if(xe)return xe;const ae=(U.date||"").slice(0,10)===Z?0:1,ze=(de.date||"").slice(0,10)===Z?0:1;return ae!==ze?ae-ze:(de.amountEur||0)-(U.amountEur||0)});const ue=new Set,te=[];for(const U of[...Q,...gn(B,{key:"signal",dir:-1})]){const de=U.id||U.name;!de||ue.has(de)||(ue.add(de),te.push(U))}return i&&te.length===0?e.filter(de=>A(de)&&dt(de.date)<=sa).sort((de,xe)=>(xe.date||"").localeCompare(de.date||"")).slice(0,80):te},[e,a.continent,a.filters.day,i,d,l,c]),v=u.useMemo(()=>{const f={};for(const A of m){const B=Ba(A);f[B]=(f[B]||0)+1}return f},[m]),y=u.useMemo(()=>s==="all"?m:m.filter(f=>Ba(f)===s),[m,s]),h=u.useMemo(()=>y.slice(0,xs),[y]),j=y.length-h.length,S=u.useRef(null);u.useEffect(()=>{var Q,Z;const f=S.current;if(!f)return;const A=()=>{const J=f.scrollWidth;J<200||(f.style.animationDuration=Math.max(18,Math.round(J/130))+"s")};A();const B=requestAnimationFrame(A),W=window.setTimeout(A,1200);let V=!0;return(Z=(Q=document.fonts)==null?void 0:Q.ready)==null||Z.then(()=>{V&&A()}),()=>{V=!1,cancelAnimationFrame(B),window.clearTimeout(W)}},[h.length,s]);const k=f=>f==="all"?m.length:v[f]||0,N=f=>{if(f==="all")return g?"All":"Tout";if(f.startsWith("sig:"))return _r[g?"en":"fr"][f.slice(4)]||"🔔";if(f.startsWith("news:")){const A=f.slice(5);return Yo[A]?Go(A,g?"en":"fr"):f}return hs[g?"en":"fr"][f]},T=[{k:"all"}],E=["ma","levees"].filter(f=>k(f)>0||f===s);if(E.length){T.push({g:g?"Deals":"Opérations"});for(const f of E)T.push({k:f})}const q=["nominations","recrutements"].filter(f=>k(f)>0||f===s),C=Wo.filter(f=>f!=="media").map(f=>"news:"+f).filter(f=>k(f)>0||f===s),R=k("actualites")>0||s==="actualites"?["actualites"]:[];if(q.length||C.length||R.length){T.push({g:g?"News":"Actualités"});for(const f of q)T.push({k:f});for(const f of C)T.push({k:f});for(const f of R)T.push({k:f})}const I=gs.map(f=>"sig:"+f).filter(f=>k(f)>0||f===s);if(I.length){T.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const f of I)T.push({k:f})}const $=f=>{try{return new Date(f+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return f}},L=(()=>{const f=(a.filters.day||"").slice(0,10),A=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return f?(g?`LIVE covers the events of ${$(f)}.`:`Le LIVE regroupe les événements du ${$(f)}.`)+A:(g?`LIVE covers the still-open signals and the deals of the last ${sa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${sa} derniers jours.`)+A})(),F=f=>h.map(A=>t.jsxs("button",{type:"button",className:"tk"+(Be(A)?" spent":""),onClick:B=>{try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(n({type:"focus",id:A.id}),a.dens!=="liste"){const W=B.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:W.left+W.width/2,y:W.bottom}})}},title:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(zt,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(ko,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:Wd(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx(Fa,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},f+(A.id||A.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},f+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:f=>{f.currentTarget.contains(f.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>b(f=>!f),children:[N(s),t.jsx("b",{children:k(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:L}),T.map(f=>"g"in f?t.jsx("span",{className:"tkfilg",children:f.g},f.g):t.jsxs("button",{type:"button","aria-pressed":f.k===s,onClick:()=>{x(f.k),b(!1)},children:[N(f.k),t.jsx("b",{children:k(f.k)})]},f.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:S,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(ys,{isEn:g})]})}const vs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function ys({isEn:e}){const[a,r]=u.useState(()=>Ar());u.useEffect(()=>{const o=i=>{var l;return r(!!((l=i.detail)!=null&&l.open))};return window.addEventListener(ya,o),()=>window.removeEventListener(ya,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Qo(!a),children:vs})}const vn="+33 6 83 10 72 86",ja="alexandre@proplace.co",Ur=`tel:${vn.replace(/[^\d+]/g,"")}`;function ws(){return null}class tt extends u.Component{constructor(){super(...arguments);Cn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Hr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ks(e,a){if((ut(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return Hr.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}function js({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:l}=H(),[d,c]=u.useState(!1),[g,s]=u.useState(""),[x,p]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),m=async v=>{if(g)return;if(v==="Analysé"&&!e.memoUrl){p(!0);return}s(v);const y=await o(e,v);s(""),y&&(c(!1),p(!1))};return t.jsxs("span",{className:"rstat",onClick:v=>v.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(v=>!v),p(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{i(e),p(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const v=await o(e,"Analysé");s(""),v&&(c(!1),p(!1))})()},children:a.csAnaAnyway})]}):ks(e,a).map(([v,y])=>t.jsx("button",{type:"button",className:"rsti"+(b===v?" on":"")+(g===v?" busy":""),disabled:!!g,onClick:()=>{m(v)},children:y},v))})]})}function Ns({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=H(),[i,l]=u.useState(""),[d,c]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),s=(ut(e)||"").startsWith("CALL")&&Te(e)===3,x=Te(e)>=2,p=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(m);const v=await o(e,m);l(""),v&&(c(!0),setTimeout(()=>c(!1),2200))},b=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Hr.filter(([m])=>!(x&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{p(m)},children:v},m)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Es,{o:e})]})}function Es({o:e}){const{t:a,saveNote:r,flash:n}=H(),[o,i]=u.useState(e.ceoNote||""),[l,d]=u.useState(!1),[c,g]=u.useState(!1),s=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!s)return;d(!0);const p=await r(e,o.trim());d(!1),p&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:l,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{x()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Ss({placeholder:e,onDone:a}){const{t:r}=H(),[n,o]=u.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Cs({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:l,flashErr:d}=H(),[c,g]=u.useState(!1);if(!n.pipe||!o||n.lockActions||Te(e)!==4)return null;const s=i(e),x=(s==null?void 0:s.stage)||"todo",p=async h=>{if(c||h===x)return;g(!0);const j=s;l(e,{stage:h,stamps:(s==null?void 0:s.stamps)||{}});const S=Math.max(Date.now(),Yn+=1);Yn=S;const k=await Jo(r,{company:e.name||"",stage:h,cts:S,deal_id:e.airtableId,check_id:e.checkId});g(!1),!k.stale&&(k.ok||(l(e,j),d(a.actErr)))},b=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,j])=>t.jsx("button",{type:"button",className:"stgb"+(x===h?" on":""),disabled:c,onClick:()=>{p(h)},children:j},h)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let Yn=0;const la=8,da=360;function Gn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Kn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Gn,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Gn,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function zs({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=H(),[l,d]=u.useState(0),[c,g]=u.useState(null),[s,x]=u.useState([]),p=u.useRef(!1),b=u.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=u.useRef(!1);u.useEffect(()=>{const E=b.current;return()=>{m.current||(n({type:"ptab",tab:E.ptab}),n({type:"dens",dens:E.dens}),n({type:"modal",modal:E.modal}))}},[]),u.useEffect(()=>{p.current||(p.current=!0,x(e.filter(E=>!!document.querySelector(E.need||E.sel))))},[e]);const v=s[l],y=l>=s.length;u.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const E=v.click,q=window.setTimeout(()=>{const C=document.querySelector(E);C&&C.getAttribute("aria-selected")!=="true"&&C.click()},60);return()=>window.clearTimeout(q)}},[l,v]);const h=u.useRef(-1),j=u.useCallback(()=>{if(!v){g(null);return}const E=document.querySelector(v.sel)||(v.need?document.querySelector(v.need):null);if(!E){g(null);return}h.current!==l&&(h.current=l,E.scrollIntoView({block:"nearest",behavior:"smooth"}));const q=E.getBoundingClientRect();g(C=>C&&Math.abs(C.top-q.top)<1&&Math.abs(C.left-q.left)<1&&Math.abs(C.width-q.width)<1&&Math.abs(C.height-q.height)<1?C:q)},[v,l]);u.useLayoutEffect(()=>{j();const E=[90,300,700,1300].map(C=>window.setTimeout(j,C)),q=()=>j();return window.addEventListener("scroll",q,!0),window.addEventListener("resize",q),()=>{E.forEach(C=>window.clearTimeout(C)),window.removeEventListener("scroll",q,!0),window.removeEventListener("resize",q)}},[j]);const S=u.useRef(a);if(S.current=a,u.useEffect(()=>{const E=q=>{q.key==="Escape"?(q.preventDefault(),q.stopPropagation(),S.current()):q.key==="ArrowRight"?d(C=>C+1):q.key==="ArrowLeft"&&d(C=>Math.max(0,C-1))};return document.addEventListener("keydown",E,!0),()=>document.removeEventListener("keydown",E,!0)},[]),!s.length)return null;let k=null;const N=E=>()=>{m.current=!0,n({type:"modal",modal:null}),E()};if(y){const E=o[3]||0;E>0?k={title:E===1?r.ahaATitle1:r.ahaATitleN(E),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let T={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:da};if(!y&&c){const E=c.bottom+14,C=window.innerHeight-E>190?E:Math.max(12,c.top-200);T={left:Math.min(Math.max(12,c.left+c.width/2-da/2),window.innerWidth-da-12),top:C,width:da}}return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-la,top:c.top-la,width:c.width+la*2,height:c.height+la*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:T,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Kn,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(Kn,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(E=>Math.max(0,E-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(E=>E+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Vr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Wr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function As(){var q,C;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:l,data:d,dispatch:c}=H(),g=r?a:e,s=u.useMemo(()=>g.filter(R=>dt(R.date)===0&&R.kind==="target"),[g]),x=u.useMemo(()=>r?a.filter(R=>R.kind==="target"&&Te(R)===0).slice().sort((R,I)=>(I.date||"").localeCompare(R.date||"")):[],[a,r]),p=u.useMemo(()=>s.filter(R=>r?Te(R)===0:!Be(R)),[s,r]),b=r?x:p,m=r?a.length-x.length:s.length-p.length,v=r?a.length:s.length,y=v?Math.min(100,m/v*100):100,h=u.useMemo(()=>Vr(g),[g]),j=!!h&&dt(h)>0,S=u.useMemo(()=>j?g.filter(R=>(R.date||"").slice(0,10)===h):[],[g,h,j]),k=typeof((q=d.stats)==null?void 0:q.kept_today)=="number"?d.stats.kept_today:null,N=typeof((C=d.stats)==null?void 0:C.screened_today)=="number"?d.stats.screened_today:s.length;let T;j?T=o.morningLast(S.length,x.length,Wr(h,l)):r?T=o.morningThesis(N,x.length,k):s.length?m===0?T=o.goalSourced(s.length):m>=s.length?T=o.goalCleared:T=o.goalDone(m,s.length):T=o.goalSourced(0);const E=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&x.length&&c({type:"chainStart",queue:x.map(R=>R.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:T}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:E,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ts(){var B,W;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:l,dossiers:d,mode:c,doSync:g,startTour:s,flash:x,flashErr:p}=H(),[b,m]=u.useState(null),[v,y]=u.useState(!0),[h,j]=u.useState([]),S=c==="client";u.useEffect(()=>{if(!o||!i)return;let V=!0;return y(!0),(async()=>{const[Q,Z]=await Promise.all([xn(i),qr(o)]);V&&(Q&&m(Q),y(!1),j(Z))})(),()=>{V=!1}},[o,i]);const[k,N]=u.useState(!1),T=()=>{!S||k||!i||(N(!0),Xo(i).then(V=>{N(!1),V?x(e.identRepubDone):p(e.actErr)}))},E=(b==null?void 0:b.per_day)??null,q=((B=b==null?void 0:b.pool_order)==null?void 0:B.length)??0,C=h.filter(V=>V.status==="running").length,R=u.useMemo(()=>d.filter(V=>V.kind==="target"&&Be(V)).length,[d]),I=l.marketEstimate,$=typeof((W=l.stats)==null?void 0:W.screened)=="number"?l.stats.screened:R,L=I&&I>0?Math.min(100,Math.round($/I*100)):null,F=V=>V.toLocaleString(a==="en"?"en-US":"fr-FR"),f=(i||"P").split(/\s+/).map(V=>V[0]).join("").slice(0,2).toUpperCase(),A=(()=>{const V=Date.parse(l.generatedAt||"");if(Number.isNaN(V))return"";const Q=new Date(V),Z=J=>String(J).padStart(2,"0");return`${Z(Q.getDate())}/${Z(Q.getMonth()+1)} à ${Z(Q.getHours())}:${Z(Q.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?f:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),A?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(A)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&$>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:F($)})})]}),L!==null&&I&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf($,I)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),E!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:E})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),E===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),C>0&&t.jsxs("span",{className:"ev",children:["⏳ ",C]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(q)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:V=>{V.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!S||k,onClick:T,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!S,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:V=>n({type:"filters",patch:{search:V.target.value}})})]})]})]})}class Et{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],l=a+i,d=Math.abs(a)<Math.abs(i)?a-(l-i):i-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,o=a[--r],l=n+o,i=o-(l-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=l+o,o==n-l&&(l=n))}return l}}function*qs(e){for(const a of e)yield*a}function Yr(e){return Array.from(qs(e))}var we=1e-6,fe=Math.PI,We=fe/2,Qn=fe/4,Ge=fe*2,st=180/fe,_e=fe/180,Ce=Math.abs,Ls=Math.atan,Jt=Math.atan2,qe=Math.cos,Le=Math.sin,Fs=Math.sign||function(e){return e>0?1:e<0?-1:0},At=Math.sqrt;function Rs(e){return e>1?0:e<-1?fe:Math.acos(e)}function Xt(e){return e>1?We:e<-1?-We:Math.asin(e)}function Ye(){}function Na(e,a){e&&Xn.hasOwnProperty(e.type)&&Xn[e.type](e,a)}var Jn={Feature:function(e,a){Na(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Na(r[n].geometry,a)}},Xn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Ja(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Ja(r[n],a,0)},Polygon:function(e,a){Zn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Zn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Na(r[n],a)}};function Ja(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Zn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Ja(e[r],a,1);a.polygonEnd()}function Lt(e,a){e&&Jn.hasOwnProperty(e.type)?Jn[e.type](e,a):Na(e,a)}function Xa(e){return[Jt(e[1],e[0]),Xt(e[2])]}function Ot(e){var a=e[0],r=e[1],n=qe(r);return[n*qe(a),n*Le(a),Le(r)]}function ca(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ea(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function $a(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function pa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Za(e){var a=At(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function en(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function tn(e,a){return Ce(e)>fe&&(e-=Math.round(e/Ge)*Ge),[e,a]}tn.invert=tn;function Ms(e,a,r){return(e%=Ge)?a||r?en(tr(e),ar(a,r)):tr(e):a||r?ar(a,r):tn}function er(e){return function(a,r){return a+=e,Ce(a)>fe&&(a-=Math.round(a/Ge)*Ge),[a,r]}}function tr(e){var a=er(e);return a.invert=er(-e),a}function ar(e,a){var r=qe(e),n=Le(e),o=qe(a),i=Le(a);function l(d,c){var g=qe(c),s=qe(d)*g,x=Le(d)*g,p=Le(c),b=p*r+s*n;return[Jt(x*o-b*i,s*r-p*n),Xt(b*o+x*i)]}return l.invert=function(d,c){var g=qe(c),s=qe(d)*g,x=Le(d)*g,p=Le(c),b=p*o-x*i;return[Jt(x*o+p*i,s*r+b*n),Xt(b*r-s*n)]},l}function Os(e,a,r,n,o,i){if(r){var l=qe(a),d=Le(a),c=n*r;o==null?(o=a+n*Ge,i=a-c/2):(o=nr(l,o),i=nr(l,i),(n>0?o<i:o>i)&&(o+=n*Ge));for(var g,s=o;n>0?s>i:s<i;s-=c)g=Xa([l,-d*qe(s),-d*Le(s)]),e.point(g[0],g[1])}}function nr(e,a){a=Ot(a),a[0]-=e,Za(a);var r=Rs(-a[1]);return((-a[2]<0?-r:r)+Ge-we)%Ge}function Gr(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Ye,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ga(e,a){return Ce(e[0]-a[0])<we&&Ce(e[1]-a[1])<we}function ua(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Kr(e,a,r,n,o){var i=[],l=[],d,c;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,y=m[0],h=m[v],j;if(ga(y,h)){if(!y[2]&&!h[2]){for(o.lineStart(),d=0;d<v;++d)o.point((y=m[d])[0],y[1]);o.lineEnd();return}h[0]+=2*we}i.push(j=new ua(y,m,null,!0)),l.push(j.o=new ua(y,null,j,!1)),i.push(j=new ua(h,m,null,!1)),l.push(j.o=new ua(h,null,j,!0))}}),!!i.length){for(l.sort(a),rr(i),rr(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var g=i[0],s,x;;){for(var p=g,b=!0;p.v;)if((p=p.n)===g)return;s=p.z,o.lineStart();do{if(p.v=p.o.v=!0,p.e){if(b)for(d=0,c=s.length;d<c;++d)o.point((x=s[d])[0],x[1]);else n(p.x,p.n.x,1,o);p=p.n}else{if(b)for(s=p.p.z,d=s.length-1;d>=0;--d)o.point((x=s[d])[0],x[1]);else n(p.x,p.p.x,-1,o);p=p.p}p=p.o,s=p.z,b=!b}while(!p.v);o.lineEnd()}}}function rr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function _a(e){return Ce(e[0])<=fe?e[0]:Fs(e[0])*((Ce(e[0])+fe)%Ge-fe)}function Ds(e,a){var r=_a(a),n=a[1],o=Le(n),i=[Le(r),-qe(r),0],l=0,d=0,c=new Et;o===1?n=We+we:o===-1&&(n=-We-we);for(var g=0,s=e.length;g<s;++g)if(p=(x=e[g]).length)for(var x,p,b=x[p-1],m=_a(b),v=b[1]/2+Qn,y=Le(v),h=qe(v),j=0;j<p;++j,m=k,y=T,h=E,b=S){var S=x[j],k=_a(S),N=S[1]/2+Qn,T=Le(N),E=qe(N),q=k-m,C=q>=0?1:-1,R=C*q,I=R>fe,$=y*T;if(c.add(Jt($*C*Le(R),h*E+$*qe(R))),l+=I?q+C*Ge:q,I^m>=r^k>=r){var L=Ea(Ot(b),Ot(S));Za(L);var F=Ea(i,L);Za(F);var f=(I^q>=0?-1:1)*Xt(F[2]);(n>f||n===f&&(L[0]||L[1]))&&(d+=I^q>=0?1:-1)}}return(l<-we||l<we&&c<-1e-12)^d&1}function Qr(e,a,r,n){return function(o){var i=a(o),l=Gr(),d=a(l),c=!1,g,s,x,p={point:b,lineStart:v,lineEnd:y,polygonStart:function(){p.point=h,p.lineStart=j,p.lineEnd=S,s=[],g=[]},polygonEnd:function(){p.point=b,p.lineStart=v,p.lineEnd=y,s=Yr(s);var k=Ds(g,n);s.length?(c||(o.polygonStart(),c=!0),Kr(s,Is,k,r,o)):k&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),s=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,N){e(k,N)&&o.point(k,N)}function m(k,N){i.point(k,N)}function v(){p.point=m,i.lineStart()}function y(){p.point=b,i.lineEnd()}function h(k,N){x.push([k,N]),d.point(k,N)}function j(){d.lineStart(),x=[]}function S(){h(x[0][0],x[0][1]),d.lineEnd();var k=d.clean(),N=l.result(),T,E=N.length,q,C,R;if(x.pop(),g.push(x),x=null,!!E){if(k&1){if(C=N[0],(q=C.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),T=0;T<q;++T)o.point((R=C[T])[0],R[1]);o.lineEnd()}return}E>1&&k&2&&N.push(N.pop().concat(N.shift())),s.push(N.filter(Ps))}}return p}}function Ps(e){return e.length>1}function Is(e,a){return((e=e.x)[0]<0?e[1]-We-we:We-e[1])-((a=a.x)[0]<0?a[1]-We-we:We-a[1])}const or=Qr(function(){return!0},Bs,_s,[-fe,-We]);function Bs(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,l){var d=i>0?fe:-fe,c=Ce(i-a);Ce(c-fe)<we?(e.point(a,r=(r+l)/2>0?We:-We),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(i,r),o=0):n!==d&&c>=fe&&(Ce(a-n)<we&&(a-=n*we),Ce(i-d)<we&&(i-=d*we),r=$s(a,r,i,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),o=0),e.point(a=i,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function $s(e,a,r,n){var o,i,l=Le(e-r);return Ce(l)>we?Ls((Le(a)*(i=qe(n))*Le(r)-Le(n)*(o=qe(a))*Le(e))/(o*i*l)):(a+n)/2}function _s(e,a,r,n){var o;if(e==null)o=r*We,n.point(-fe,o),n.point(0,o),n.point(fe,o),n.point(fe,0),n.point(fe,-o),n.point(0,-o),n.point(-fe,-o),n.point(-fe,0),n.point(-fe,o);else if(Ce(e[0]-a[0])>we){var i=e[0]<a[0]?fe:-fe;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Us(e){var a=qe(e),r=2*_e,n=a>0,o=Ce(a)>we;function i(s,x,p,b){Os(b,e,r,p,s,x)}function l(s,x){return qe(s)*qe(x)>a}function d(s){var x,p,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(y,h){var j=[y,h],S,k=l(y,h),N=n?k?0:g(y,h):k?g(y+(y<0?fe:-fe),h):0;if(!x&&(m=b=k)&&s.lineStart(),k!==b&&(S=c(x,j),(!S||ga(x,S)||ga(j,S))&&(j[2]=1)),k!==b)v=0,k?(s.lineStart(),S=c(j,x),s.point(S[0],S[1])):(S=c(x,j),s.point(S[0],S[1],2),s.lineEnd()),x=S;else if(o&&x&&n^k){var T;!(N&p)&&(T=c(j,x,!0))&&(v=0,n?(s.lineStart(),s.point(T[0][0],T[0][1]),s.point(T[1][0],T[1][1]),s.lineEnd()):(s.point(T[1][0],T[1][1]),s.lineEnd(),s.lineStart(),s.point(T[0][0],T[0][1],3)))}k&&(!x||!ga(x,j))&&s.point(j[0],j[1]),x=j,b=k,p=N},lineEnd:function(){b&&s.lineEnd(),x=null},clean:function(){return v|(m&&b)<<1}}}function c(s,x,p){var b=Ot(s),m=Ot(x),v=[1,0,0],y=Ea(b,m),h=ca(y,y),j=y[0],S=h-j*j;if(!S)return!p&&s;var k=a*h/S,N=-a*j/S,T=Ea(v,y),E=pa(v,k),q=pa(y,N);$a(E,q);var C=T,R=ca(E,C),I=ca(C,C),$=R*R-I*(ca(E,E)-1);if(!($<0)){var L=At($),F=pa(C,(-R-L)/I);if($a(F,E),F=Xa(F),!p)return F;var f=s[0],A=x[0],B=s[1],W=x[1],V;A<f&&(V=f,f=A,A=V);var Q=A-f,Z=Ce(Q-fe)<we,J=Z||Q<we;if(!Z&&W<B&&(V=B,B=W,W=V),J?Z?B+W>0^F[1]<(Ce(F[0]-f)<we?B:W):B<=F[1]&&F[1]<=W:Q>fe^(f<=F[0]&&F[0]<=A)){var ue=pa(C,(-R+L)/I);return $a(ue,E),[F,Xa(ue)]}}}function g(s,x){var p=n?e:fe-e,b=0;return s<-p?b|=1:s>p&&(b|=2),x<-p?b|=4:x>p&&(b|=8),b}return Qr(l,d,i,n?[0,-e]:[-fe,e-fe])}function Hs(e,a,r,n,o,i){var l=e[0],d=e[1],c=a[0],g=a[1],s=0,x=1,p=c-l,b=g-d,m;if(m=r-l,!(!p&&m>0)){if(m/=p,p<0){if(m<s)return;m<x&&(x=m)}else if(p>0){if(m>x)return;m>s&&(s=m)}if(m=o-l,!(!p&&m<0)){if(m/=p,p<0){if(m>x)return;m>s&&(s=m)}else if(p>0){if(m<s)return;m<x&&(x=m)}if(m=n-d,!(!b&&m>0)){if(m/=b,b<0){if(m<s)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>s&&(s=m)}if(m=i-d,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>s&&(s=m)}else if(b>0){if(m<s)return;m<x&&(x=m)}return s>0&&(e[0]=l+s*p,e[1]=d+s*b),x<1&&(a[0]=l+x*p,a[1]=d+x*b),!0}}}}}var Ht=1e9,ma=-Ht;function Vs(e,a,r,n){function o(g,s){return e<=g&&g<=r&&a<=s&&s<=n}function i(g,s,x,p){var b=0,m=0;if(g==null||(b=l(g,x))!==(m=l(s,x))||c(g,s)<0^x>0)do p.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else p.point(s[0],s[1])}function l(g,s){return Ce(g[0]-e)<we?s>0?0:3:Ce(g[0]-r)<we?s>0?2:1:Ce(g[1]-a)<we?s>0?1:0:s>0?3:2}function d(g,s){return c(g.x,s.x)}function c(g,s){var x=l(g,1),p=l(s,1);return x!==p?x-p:x===0?s[1]-g[1]:x===1?g[0]-s[0]:x===2?g[1]-s[1]:s[0]-g[0]}return function(g){var s=g,x=Gr(),p,b,m,v,y,h,j,S,k,N,T,E={point:q,lineStart:$,lineEnd:L,polygonStart:R,polygonEnd:I};function q(f,A){o(f,A)&&s.point(f,A)}function C(){for(var f=0,A=0,B=b.length;A<B;++A)for(var W=b[A],V=1,Q=W.length,Z=W[0],J,ue,te=Z[0],he=Z[1];V<Q;++V)J=te,ue=he,Z=W[V],te=Z[0],he=Z[1],ue<=n?he>n&&(te-J)*(n-ue)>(he-ue)*(e-J)&&++f:he<=n&&(te-J)*(n-ue)<(he-ue)*(e-J)&&--f;return f}function R(){s=x,p=[],b=[],T=!0}function I(){var f=C(),A=T&&f,B=(p=Yr(p)).length;(A||B)&&(g.polygonStart(),A&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),B&&Kr(p,d,f,i,g),g.polygonEnd()),s=g,p=b=m=null}function $(){E.point=F,b&&b.push(m=[]),N=!0,k=!1,j=S=NaN}function L(){p&&(F(v,y),h&&k&&x.rejoin(),p.push(x.result())),E.point=q,k&&s.lineEnd()}function F(f,A){var B=o(f,A);if(b&&m.push([f,A]),N)v=f,y=A,h=B,N=!1,B&&(s.lineStart(),s.point(f,A));else if(B&&k)s.point(f,A);else{var W=[j=Math.max(ma,Math.min(Ht,j)),S=Math.max(ma,Math.min(Ht,S))],V=[f=Math.max(ma,Math.min(Ht,f)),A=Math.max(ma,Math.min(Ht,A))];Hs(W,V,e,a,r,n)?(k||(s.lineStart(),s.point(W[0],W[1])),s.point(V[0],V[1]),B||s.lineEnd(),T=!1):B&&(s.lineStart(),s.point(f,A),T=!1)}j=f,S=A,k=B}return E}}const an=e=>e;var Ua=new Et,nn=new Et,Jr,Xr,rn,on,lt={point:Ye,lineStart:Ye,lineEnd:Ye,polygonStart:function(){lt.lineStart=Ws,lt.lineEnd=Gs},polygonEnd:function(){lt.lineStart=lt.lineEnd=lt.point=Ye,Ua.add(Ce(nn)),nn=new Et},result:function(){var e=Ua/2;return Ua=new Et,e}};function Ws(){lt.point=Ys}function Ys(e,a){lt.point=Zr,Jr=rn=e,Xr=on=a}function Zr(e,a){nn.add(on*e-rn*a),rn=e,on=a}function Gs(){Zr(Jr,Xr)}var Dt=1/0,Sa=Dt,Zt=-Dt,Ca=Zt,za={point:Ks,lineStart:Ye,lineEnd:Ye,polygonStart:Ye,polygonEnd:Ye,result:function(){var e=[[Dt,Sa],[Zt,Ca]];return Zt=Ca=-(Sa=Dt=1/0),e}};function Ks(e,a){e<Dt&&(Dt=e),e>Zt&&(Zt=e),a<Sa&&(Sa=a),a>Ca&&(Ca=a)}var sn=0,ln=0,Vt=0,Aa=0,Ta=0,Ft=0,dn=0,cn=0,Wt=0,eo,to,rt,ot,Ve={point:St,lineStart:ir,lineEnd:sr,polygonStart:function(){Ve.lineStart=Xs,Ve.lineEnd=Zs},polygonEnd:function(){Ve.point=St,Ve.lineStart=ir,Ve.lineEnd=sr},result:function(){var e=Wt?[dn/Wt,cn/Wt]:Ft?[Aa/Ft,Ta/Ft]:Vt?[sn/Vt,ln/Vt]:[NaN,NaN];return sn=ln=Vt=Aa=Ta=Ft=dn=cn=Wt=0,e}};function St(e,a){sn+=e,ln+=a,++Vt}function ir(){Ve.point=Qs}function Qs(e,a){Ve.point=Js,St(rt=e,ot=a)}function Js(e,a){var r=e-rt,n=a-ot,o=At(r*r+n*n);Aa+=o*(rt+e)/2,Ta+=o*(ot+a)/2,Ft+=o,St(rt=e,ot=a)}function sr(){Ve.point=St}function Xs(){Ve.point=el}function Zs(){ao(eo,to)}function el(e,a){Ve.point=ao,St(eo=rt=e,to=ot=a)}function ao(e,a){var r=e-rt,n=a-ot,o=At(r*r+n*n);Aa+=o*(rt+e)/2,Ta+=o*(ot+a)/2,Ft+=o,o=ot*e-rt*a,dn+=o*(rt+e),cn+=o*(ot+a),Wt+=o*3,St(rt=e,ot=a)}function no(e){this._context=e}no.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Ge);break}}},result:Ye};var pn=new Et,Ha,ro,oo,Yt,Gt,ea={point:Ye,lineStart:function(){ea.point=tl},lineEnd:function(){Ha&&io(ro,oo),ea.point=Ye},polygonStart:function(){Ha=!0},polygonEnd:function(){Ha=null},result:function(){var e=+pn;return pn=new Et,e}};function tl(e,a){ea.point=io,ro=Yt=e,oo=Gt=a}function io(e,a){Yt-=e,Gt-=a,pn.add(At(Yt*Yt+Gt*Gt)),Yt=e,Gt=a}let lr,qa,dr,cr;class pr{constructor(a){this._append=a==null?so:al(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==dr||this._append!==qa){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,dr=n,qa=this._append,cr=this._,this._=o}this._+=cr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function so(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function al(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return so;if(a!==lr){const r=10**a;lr=a,qa=function(o){let i=1;this._+=o[0];for(const l=o.length;i<l;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return qa}function nl(e,a){let r=3,n=4.5,o,i;function l(d){return d&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Lt(d,o(i))),i.result()}return l.area=function(d){return Lt(d,o(lt)),lt.result()},l.measure=function(d){return Lt(d,o(ea)),ea.result()},l.bounds=function(d){return Lt(d,o(za)),za.result()},l.centroid=function(d){return Lt(d,o(Ve)),Ve.result()},l.projection=function(d){return arguments.length?(o=d==null?(e=null,an):(e=d).stream,l):e},l.context=function(d){return arguments.length?(i=d==null?(a=null,new pr(r)):new no(a=d),typeof n!="function"&&i.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(i.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(i=new pr(r)),l},l.projection(e).digits(r).context(a)}function yn(e){return function(a){var r=new un;for(var n in e)r[n]=e[n];return r.stream=a,r}}function un(){}un.prototype={constructor:un,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function wn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Lt(r,e.stream(za)),a(za.result()),n!=null&&e.clipExtent(n),e}function lo(e,a,r){return wn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],l=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),d=+a[0][0]+(o-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function rl(e,a,r){return lo(e,[[0,0],a],r)}function ol(e,a,r){return wn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),l=(o-i*(n[1][0]+n[0][0]))/2,d=-i*n[0][1];e.scale(150*i).translate([l,d])},r)}function il(e,a,r){return wn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),l=-i*n[0][0],d=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,d])},r)}var ur=16,sl=qe(30*_e);function mr(e,a){return+a?dl(e,a):ll(e)}function ll(e){return yn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function dl(e,a){function r(n,o,i,l,d,c,g,s,x,p,b,m,v,y){var h=g-n,j=s-o,S=h*h+j*j;if(S>4*a&&v--){var k=l+p,N=d+b,T=c+m,E=At(k*k+N*N+T*T),q=Xt(T/=E),C=Ce(Ce(T)-1)<we||Ce(i-x)<we?(i+x)/2:Jt(N,k),R=e(C,q),I=R[0],$=R[1],L=I-n,F=$-o,f=j*L-h*F;(f*f/S>a||Ce((h*L+j*F)/S-.5)>.3||l*p+d*b+c*m<sl)&&(r(n,o,i,l,d,c,I,$,C,k/=E,N/=E,T,v,y),y.point(I,$),r(I,$,C,k,N,T,g,s,x,p,b,m,v,y))}}return function(n){var o,i,l,d,c,g,s,x,p,b,m,v,y={point:h,lineStart:j,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=N},polygonEnd:function(){n.polygonEnd(),y.lineStart=j}};function h(q,C){q=e(q,C),n.point(q[0],q[1])}function j(){x=NaN,y.point=S,n.lineStart()}function S(q,C){var R=Ot([q,C]),I=e(q,C);r(x,p,s,b,m,v,x=I[0],p=I[1],s=q,b=R[0],m=R[1],v=R[2],ur,n),n.point(x,p)}function k(){y.point=h,n.lineEnd()}function N(){j(),y.point=T,y.lineEnd=E}function T(q,C){S(o=q,C),i=x,l=p,d=b,c=m,g=v,y.point=S}function E(){r(x,p,s,b,m,v,i,l,o,d,c,g,ur,n),y.lineEnd=k,k()}return y}}var cl=yn({point:function(e,a){this.stream.point(e*_e,a*_e)}});function pl(e){return yn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ul(e,a,r,n,o){function i(l,d){return l*=n,d*=o,[a+e*l,r-e*d]}return i.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*o]},i}function fr(e,a,r,n,o,i){if(!i)return ul(e,a,r,n,o);var l=qe(i),d=Le(i),c=l*e,g=d*e,s=l/e,x=d/e,p=(d*r-l*a)/e,b=(d*a+l*r)/e;function m(v,y){return v*=n,y*=o,[c*v-g*y+a,r-g*v-c*y]}return m.invert=function(v,y){return[n*(s*v-x*y+p),o*(b-x*v-s*y)]},m}function ml(e){return fl(function(){return e})()}function fl(e){var a,r=150,n=480,o=250,i=0,l=0,d=0,c=0,g=0,s,x=0,p=1,b=1,m=null,v=or,y=null,h,j,S,k=an,N=.5,T,E,q,C,R;function I(f){return q(f[0]*_e,f[1]*_e)}function $(f){return f=q.invert(f[0],f[1]),f&&[f[0]*st,f[1]*st]}I.stream=function(f){return C&&R===f?C:C=cl(pl(s)(v(T(k(R=f)))))},I.preclip=function(f){return arguments.length?(v=f,m=void 0,F()):v},I.postclip=function(f){return arguments.length?(k=f,y=h=j=S=null,F()):k},I.clipAngle=function(f){return arguments.length?(v=+f?Us(m=f*_e):(m=null,or),F()):m*st},I.clipExtent=function(f){return arguments.length?(k=f==null?(y=h=j=S=null,an):Vs(y=+f[0][0],h=+f[0][1],j=+f[1][0],S=+f[1][1]),F()):y==null?null:[[y,h],[j,S]]},I.scale=function(f){return arguments.length?(r=+f,L()):r},I.translate=function(f){return arguments.length?(n=+f[0],o=+f[1],L()):[n,o]},I.center=function(f){return arguments.length?(i=f[0]%360*_e,l=f[1]%360*_e,L()):[i*st,l*st]},I.rotate=function(f){return arguments.length?(d=f[0]%360*_e,c=f[1]%360*_e,g=f.length>2?f[2]%360*_e:0,L()):[d*st,c*st,g*st]},I.angle=function(f){return arguments.length?(x=f%360*_e,L()):x*st},I.reflectX=function(f){return arguments.length?(p=f?-1:1,L()):p<0},I.reflectY=function(f){return arguments.length?(b=f?-1:1,L()):b<0},I.precision=function(f){return arguments.length?(T=mr(E,N=f*f),F()):At(N)},I.fitExtent=function(f,A){return lo(I,f,A)},I.fitSize=function(f,A){return rl(I,f,A)},I.fitWidth=function(f,A){return ol(I,f,A)},I.fitHeight=function(f,A){return il(I,f,A)};function L(){var f=fr(r,0,0,p,b,x).apply(null,a(i,l)),A=fr(r,n-f[0],o-f[1],p,b,x);return s=Ms(d,c,g),E=en(a,A),q=en(s,E),T=mr(E,N),F()}function F(){return C=R=null,I}return function(){return a=e.apply(this,arguments),I.invert=a.invert&&$,L()}}function co(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}co.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,l=i*i;r-=o=(r*(1.007226+i*(.015085+l*(-.044475+.028874*i-.005916*l)))-a)/(1.007226+i*(.015085*3+l*(-.044475*7+.028874*9*i-.005916*11*l)))}while(Ce(o)>we&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function xl(){return ml(co).scale(175.295)}function hl(e){return e}function gl(e){if(e==null)return hl;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var g=2,s=d.length,x=new Array(s);for(x[0]=(a+=d[0])*n+i,x[1]=(r+=d[1])*o+l;g<s;)x[g]=d[g],++g;return x}}function bl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function vl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return xr(e,r)})}:xr(e,a)}function xr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=yl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function yl(e,a){var r=gl(e.transform),n=e.arcs;function o(s,x){x.length&&x.pop();for(var p=n[s<0?~s:s],b=0,m=p.length;b<m;++b)x.push(r(p[b],b));s<0&&bl(x,m)}function i(s){return r(s)}function l(s){for(var x=[],p=0,b=s.length;p<b;++p)o(s[p],x);return x.length<2&&x.push(x[0]),x}function d(s){for(var x=l(s);x.length<4;)x.push(x[0]);return x}function c(s){return s.map(d)}function g(s){var x=s.type,p;switch(x){case"GeometryCollection":return{type:x,geometries:s.geometries.map(g)};case"Point":p=i(s.coordinates);break;case"MultiPoint":p=s.coordinates.map(i);break;case"LineString":p=l(s.arcs);break;case"MultiLineString":p=s.arcs.map(l);break;case"Polygon":p=c(s.arcs);break;case"MultiPolygon":p=s.arcs.map(c);break;default:return null}return{type:x,coordinates:p}}return g(a)}const po={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},wl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function kl(e,a,r){const n=po[e];if(!n||!n.length)return-1;const o=wl(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(l=>o.includes(l)))return i}return Math.floor(r*n.length)%n.length}let fa=null;function jl(){return fa||(fa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=vl(r,n),i=xl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=nl(i),d=(o.features||[]).filter(s=>{var x;return(((x=s.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(s=>{var b;const x=((b=s.properties)==null?void 0:b.name)||"",p=l(s)||"";return p?{i2:Zo(x)||null,n:x,d:p}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,x]of Object.entries(ei)){const p=i(x);p&&(c[s]={x:p[0],y:p[1]})}const g={};for(const[s,x]of Object.entries(po)){const p=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));p.length&&(g[s]=p)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:d,anchors:c,metros:g}}catch{return null}})(),fa)}function Nl(e){const[a,r]=u.useState(null);return u.useEffect(()=>{if(!e||a)return;let n=!1;return jl().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const El="8 40 984 210",Sl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},hr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function gr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Cl(e,a){const[r,n]=u.useState(1);return u.useEffect(()=>{let o=!0,i=0;const l=()=>{var g;if(!o)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{o=!1,cancelAnimationFrame(i),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function br({msgs:e}){const[a,r]=u.useState(0);u.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],l)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function zl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:l,lang:d,t:c,data:g,dossiers:s,source:x}=H(),p=g.loading&&!s.length,b=u.useRef(null),m=u.useRef(null),v=Nl(e.continent==="monde"),y=e.continent==="monde"?v:hn.find(f=>f.key===e.continent)||null,h=Cl(b,e.continent+":"+e.mapFolded+":"+!!y),[j,S]=u.useState(new Map),[k,N]=u.useState(null);u.useEffect(()=>{const f=b.current;if(!f)return;const A=new Map;f.querySelectorAll("path[data-i2]").forEach(B=>{const W=B.dataset.i2;if(W)try{const V=B.getBBox();V.width>0&&A.set(W,{x:V.x,y:V.y,w:V.width,h:V.height})}catch{}}),S(A)},[e.continent,h,y]);const T=u.useMemo(()=>r.filter(f=>f.cc),[r]),E=u.useMemo(()=>{const f=new Map;return T.forEach(A=>f.set(A.cc,(f.get(A.cc)||0)+1)),f},[T]),q=e.continent==="monde"&&v?v.anchors:null,C=e.continent==="monde"&&v?v.metros:null,R=u.useMemo(()=>T.map(f=>{const A=gr(f.name||f.id||""),B=gr((f.id||f.name||"")+"·y");if(q&&f.cc){const J=C?C[f.cc]:void 0;if(J&&J.length){const te=kl(f.cc,f.city,A);if(te>=0&&J[te])return{d:f,x:J[te].x+(A-.5)*5,y:J[te].y+(B-.5)*5}}const ue=q[f.cc];if(ue)return{d:f,x:ue.x+(A-.5)*10,y:ue.y+(B-.5)*10}}const W=f.cc?j.get(f.cc):void 0;if(!W)return null;const V=Sl[`${e.continent}:${f.cc||""}`];if(V)return{d:f,x:W.x+W.w*(V.fx+(A-.5)*V.sx),y:W.y+W.h*(V.fy+(B-.5)*V.sy)};const Q=(A-.5)*Math.min(W.w*.55,60),Z=(B-.5)*Math.min(W.h*.55,60);return{d:f,x:W.x+W.w/2+Q,y:W.y+W.h/2+Z}}).filter(f=>!!f),[T,j,q,C,e.continent]),I=f=>h>0?f/h:f,$=u.useMemo(()=>n?[0,1,2,3,4,5].map(f=>({c:hr[f],fr:c.plabels[f].toUpperCase(),en:c.plabels[f].toUpperCase(),n:r.filter(A=>A.kind==="target"&&Te(A)===f).length})).filter(f=>f.n>0):Fn.map((f,A)=>({...f,n:r.filter(B=>Rn(B)===A).length})),[r,n,c.plabels]),L=i?l.get(i):null,F=L?R.find(f=>f.d.id===L.id):null;return y?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:[p&&t.jsx(br,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?El:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:y.countries.map((f,A)=>t.jsx("g",{className:"ct"+(f.i2&&E.get(f.i2)?"":" empty"),children:t.jsx("path",{d:f.d,"data-i2":f.i2||void 0})},A))}),t.jsx("g",{children:R.map(f=>{const A=Fn[Rn(f.d)],B=!!Oe(f.d),W=f.d.kind==="target",V=n&&W?hr[Te(f.d)]:A.c,Q=!n&&Be(f.d);return t.jsxs("g",{className:"co"+(Q?" done":""),onMouseEnter:()=>{var ue,te;const Z=(ue=m.current)==null?void 0:ue.getBoundingClientRect(),J=(te=b.current)==null?void 0:te.createSVGPoint();if(J&&b.current&&Z){J.x=f.x,J.y=f.y;const he=J.matrixTransform(b.current.getScreenCTM());N({x:he.x-Z.left,y:he.y-Z.top,label:f.d.name+" · "+(It(f.d.cc,d)||f.d.countryLabel||"")})}o(f.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var ue;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:f.d.id}),(f.d.noCo||["media","nominations","recrutements"].includes(f.d.engine||""))&&(f.d.url||f.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.d.url||"",text:[f.d.headline,f.d.tagline].filter(Boolean).join(`
`)}})):f.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:f.d.name,url:f.d.url||"",website:f.d.website||"",domain:f.d.domain||""}}));return}const Z=(ue=b.current)==null?void 0:ue.createSVGPoint();let J=null;if(Z&&b.current){Z.x=f.x,Z.y=f.y;const te=Z.matrixTransform(b.current.getScreenCTM());J={x:te.x,y:te.y}}a({type:"popup",id:f.d.id,anchor:J})},children:[t.jsx("circle",{className:"h",cx:f.x,cy:f.y,r:I(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:f.x,cy:f.y,r:I(A.px),fill:V,stroke:B?"#DC2626":"#ffffff",strokeWidth:I(B?2.2:1.3)})]},f.d.id||f.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:I(13),fill:"none",stroke:"#0F172A",strokeWidth:I(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:$.map((f,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":f.c}}),d==="fr"?f.fr:f.en," ",t.jsx("b",{children:f.n})]},A))}),r.some(f=>!f.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(f=>!f.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:t.jsx(br,{msgs:c.loadMsgs})})}function Al(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function uo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:l,lang:d}=H(),c=a.filters,[g,s]=u.useState(!1),[x,p]=u.useState(!1),b=u.useRef(null),m=u.useRef(null),v=u.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),y=F=>v.filter(f=>F!=="country"&&c.country.length&&!c.country.includes(f.cc||"")?!1:ka(f,c,i,F==="country"?void 0:F)),h=F=>!i||F.kind!=="op",j=u.useMemo(()=>{const F=y("win").filter(h),f=A=>F.filter(B=>(B.date?Math.max(0,Math.floor((Date.now()-Date.parse(B.date))/864e5)):9999)<=A).length;return[f(0),f(7),f(30),F.length]},[v,c,i]),S=u.useMemo(()=>c.day?y("win").filter(h).filter(F=>(F.date||"").slice(0,10)===c.day).length:0,[v,c,i]),k=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,N=k+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);u.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),u.useEffect(()=>{if(!g&&!x)return;const F=A=>{var W,V;const B=A.target;g&&!((W=b.current)!=null&&W.contains(B))&&s(!1),x&&!((V=m.current)!=null&&V.contains(B))&&p(!1)},f=A=>{A.key==="Escape"&&(s(!1),p(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",f),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",f)}},[g,x]);const T=(F,f,A,B="fbtn")=>t.jsxs("button",{type:"button",className:B,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:f}),A>0&&t.jsx("span",{className:"n",children:A}),t.jsx("span",{className:"cv",children:"▾"})]},F),E=["1","7","30","all"],q=Math.max(0,E.indexOf(c.win||"all")),C=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(Al(c.day,d))}),t.jsx("b",{children:S})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>p(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[q]}),t.jsx("b",{children:j[q]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:E.map((F,f)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),p(!1)},children:[o.datesShort[f],t.jsx("span",{className:"n",children:j[f]})]},F))})]}):t.jsx("div",{className:"seg",children:E.map((F,f)=>t.jsxs("button",{type:"button","aria-pressed":c.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:o.dates[f]}),t.jsx("b",{children:j[f]})]},F))}),R=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),I=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):T("sec",o.fSector,c.sector.length),T("pay",o.fCountry,c.country.length),T("det",o.fEngine,c.engine.length),T("sta",o.fStage,c.stage.length),i&&T("ang","Angle",c.angle.length),i&&T("mem","Mémo",c.memoLevel.length)]}),$=(F=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{s(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:I})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:C}),t.jsxs("div",{className:"fstrip-b",children:[R,L,$(!1)]})]}),a.openFacet&&t.jsx(vr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[C,R,I,t.jsx("span",{className:"fgrow"}),$()]}),a.openFacet&&t.jsx(vr,{poolFor:y})]})}function vr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=H(),i=a.filters,l=a.openFacet,{title:d,cols:c,options:g}=u.useMemo(()=>{if(l==="sig"){const m=e("signal").filter(h=>Oe(h)),v=new Map;m.forEach(h=>{const j=h.engine||"";v.set(j,(v.get(j)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Wa([...v.keys()],o).map(h=>({v:h,label:Nt(h)+" "+Ue(h,o),n:v.get(h)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const m=e("sector"),v=new Map;return m.forEach(y=>{y.sector&&v.set(y.sector,(v.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y,n:h,html:!1,on:i.sector.includes(y)}))}}if(l==="pay"){const m=e("country"),v=new Map;return m.forEach(y=>{y.cc&&v.set(y.cc,(v.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:It(y,o)||y,n:h,html:!1,on:i.country.includes(y)}))}}if(l==="det"){const m=e("engine"),v=new Map;return m.forEach(y=>{y.engine&&v.set(y.engine,(v.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Wa([...v.keys()],o).map(y=>({v:y,label:Nt(y)+" "+Ue(y,o)+' <span style="color:var(--dim);font-size:10px">· '+ti(ai(y),o)+"</span>",n:v.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(l==="ang"){const m=e("angle"),v=new Map;return m.forEach(y=>{y.angle&&v.set(y.angle,(v.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y.replace(/[_-]+/g," "),n:h,html:!1,on:i.angle.includes(y)}))}}if(l==="mem"){const m=e("memoLevel"),v=new Map;m.forEach(h=>{if(h.kind==="target"){const j=fn(h);v.set(j,(v.get(j)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:y[h],n:v.get(h)||0,html:!1,on:i.memoLevel.includes(h)}))}}const p=e("stage"),b=new Map;return p.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,v)=>v[1]-m[1]).map(([m,v])=>({v:m,label:m,n:v,html:!1,on:i.stage.includes(m)}))}},[l,a,o]),s=p=>{if(l==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(p)?i.signalEngines.filter(v=>v!==p):[...i.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:p})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>s(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function mo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:l,t:d}=H(),c=u.useMemo(()=>{const b={};return r.forEach(m=>{ka(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,s]=u.useState(!1),x=u.useRef(null);u.useEffect(()=>{if(!g)return;const b=v=>{var y;(y=x.current)!=null&&y.contains(v.target)||s(!1)},m=v=>{v.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const p=b=>{const m=hn.find(v=>v.key===b);return b==="monde"?d.contWorld:l==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>s(b=>!b),children:[p(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Mn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),s(!1)},children:[p(b),t.jsx("span",{className:"n",children:c[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Mn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[p(b),t.jsx("span",{className:"n",children:c[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function fo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Tl(e){var o;const a=[],r=new Set,n=i=>{const l=(i||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function yr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:l}){const{t:d}=H();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function xo({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=H(),o=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),i=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(yr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(yr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function ql({card:e,onEvaluate:a,onAddAll:r}){var d,c,g;const{t:n}=H(),o=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),i=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:fo(e.summary_md||"").map((s,x)=>t.jsx("p",{children:s},x))})]}),t.jsx(xo,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Ll(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Fl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:l}=H(),d=o,[c,g]=u.useState(null),[s,x]=u.useState(null),[p,b]=u.useState(null),[m,v]=u.useState(!1);u.useEffect(()=>{let h=!0;return(async()=>{const j=await Lr({email:l,cbToken:d});h&&g(j)})(),()=>{h=!1}},[l,d,n]);const y=h=>{x(h),b(null),v(!0),(async()=>{const j=await ni(h.id);b(j),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[Ll(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?i.rsPub:i.rsPriv})]},h.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!p&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&p&&t.jsx(ql,{card:p,onEvaluate:a,onAddAll:r})]})]})}const ba=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Kt(e){return/^https?:\/\//i.test((e||"").trim())}function at(e){const a=(e||"").trim();return a?Kt(a)?a:ba.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Rl(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Ml(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:l,evalBusy:d,evalCards:c,caps:g,data:s,canWrite:x,source:p,dossiers:b,doAnalyse:m,liveMemos:v,pipe:y}=H(),h=a==="client",j=u.useMemo(()=>r||(p!=="default"?ri():""),[r,p]),[S,k]=u.useState(""),[N,T]=u.useState(!1),[E,q]=u.useState(""),[C,R]=u.useState(""),[I,$]=u.useState(""),[L,F]=u.useState(!1),[f,A]=u.useState(!1),[B,W]=u.useState(""),[V,Q]=u.useState(!1),[Z,J]=u.useState(""),[ue,te]=u.useState([]),he=u.useRef(!1),[U,de]=u.useState(!1),[xe,ae]=u.useState(!1),[ze,ie]=u.useState(!1),me=u.useRef(!1),[se,K]=u.useState(""),[G,le]=u.useState(""),[Se,ce]=u.useState(!1),[oe,ke]=u.useState(!1),[Fe,Re]=u.useState(0),[ve,Ie]=u.useState(""),[je,He]=u.useState(null),[Me,it]=u.useState(null),[ct,mt]=u.useState(!1),[Ze,ft]=u.useState(null),[xt,Ke]=u.useState(0),pt=u.useRef(!1),z=S.trim()?ba.test(S.trim())?e.evalUrl:e.evalName:e.evalWaiting,P=u.useMemo(()=>B.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[B]);u.useEffect(()=>{if(typeof window>"u")return;const O=new URLSearchParams(window.location.search),X=(O.get("rs")||"").trim(),re=(O.get("rstext")||"").trim();X&&/^https?:\/\//i.test(X)&&K(X),re&&le(re),(X&&/^https?:\/\//i.test(X)||re)&&de(!0)},[]),u.useEffect(()=>{const O=X=>{const re=X.detail||{},w=String(re.url||"").trim(),D=String(re.text||"").trim();w&&/^https?:\/\//i.test(w)&&K(w),D&&le(D),(w&&/^https?:\/\//i.test(w)||D)&&(de(!0),k(""),q(""),ce(!0),window.setTimeout(()=>ce(!1),900))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]),u.useEffect(()=>{const O=X=>{const re=X.detail||{},w=String(re.name||"").trim();if(!w)return;de(!1),k(w),q(w);const D=at(String(re.website||re.domain||""));R(D),$(at(String(re.url||""))),F(!D),T(!0),window.setTimeout(()=>T(!1),900)};return window.addEventListener("ppmap:prefill",O),()=>window.removeEventListener("ppmap:prefill",O)},[]),u.useEffect(()=>{const O=(E||"").trim();if(!O||U||C){(C||!O||U)&&F(!1);return}const X=b.find(D=>De(D.name)===De(O)),re=at((X==null?void 0:X.website)||"")||at((X==null?void 0:X.domain)||"");if(re){R(re),F(!1);return}let w=!0;return F(!0),Fr(O).then(D=>{var _,ee;if(!w)return;const M=at(D.website||"")||at(((ee=(_=D.candidates)==null?void 0:_[0])==null?void 0:ee.url)||"");M&&R(M)}).catch(()=>{}).finally(()=>{w&&F(!1)}),()=>{w=!1}},[E,U,C,b]),u.useEffect(()=>{const O=X=>{var w;const re=String(((w=X.detail)==null?void 0:w.url)||"").trim();Kt(re)&&window.open(re,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",O),()=>window.removeEventListener("ppmap:view",O)},[]),u.useEffect(()=>{if(me.current===U)return;me.current=U,ie(!0);const O=window.setTimeout(()=>ie(!1),560);return()=>window.clearTimeout(O)},[U]),u.useEffect(()=>{if(typeof window>"u")return;const O=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),X=document.querySelector(".atl2.ops, .atl2.cibles");if(!O||!X)return;const re=()=>X.style.setProperty("--demand-h",`${O.offsetHeight}px`);re();const w=new ResizeObserver(re);return w.observe(O),()=>w.disconnect()},[p,N,Se,f,U,ze,L]),u.useEffect(()=>{if(!x&&!j){ft(null);return}let O=!0;return(async()=>{const X=await Lr({email:n,cbToken:j});O&&ft(X.length)})(),()=>{O=!1}},[x,j,n,xt]);const Y=ue.length?ue:c,ne=s.credits,ye=u.useCallback(O=>{const X=O.map(re=>(re||"").trim()).filter(Boolean);X.length&&(W(re=>{const w=re.split(`
`).map(_=>_.trim()).filter(Boolean),D=new Set(w.map(_=>_.toLowerCase())),M=X.filter(_=>!D.has(_.toLowerCase()));return[...w,...M].slice(0,15).join(`
`)}),A(!0))},[]);u.useEffect(()=>{if(!oe)return;Re(0);const O=window.setInterval(()=>Re(X=>X+1),1e3);return()=>window.clearInterval(O)},[oe]);const pe=u.useMemo(()=>{const O=S.trim().toLowerCase();return!O||!y?null:b.find(X=>De(X.name)===O&&Te(X)===1)||null},[S,b,y]),be=()=>{const O=S.trim();if(O){if(pe){m(pe);return}o(null,O),h&&k("")}},et=async()=>{if(!h){o(null,P[0]||"");return}if(!P.length||V)return;Q(!0),he.current=!1;const O=[];for(let X=0;X<P.length&&!he.current;X++){J(e.evaluating(X+1,P.length,P[X]));const re=await Rr(r,P[X],"atelier2");if(O.unshift({name:re.company||P[X],verdict:re.verdict,reason:re.reason||"",remaining:re.remaining??null}),te([...O]),re.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(P.length-X-1),remaining:0}),te([...O]),W(P.slice(X+1).join(`
`)),J(""),Q(!1);return}}J(""),W(he.current?P.slice(O.length).join(`
`):""),Q(!1)},ht=async()=>{var re,w,D;if(pt.current)return;const O=se.trim().replace(/\s+/g,""),X=G.trim();if(!O&&!X){Ie(e.rsNeed);return}if(!h&&!j){o(null,O||X.slice(0,80));return}pt.current=!0,Ie(""),He(null),it(null),ke(!0);try{const M=await ii({url:O,text:X,email:n,cbToken:j});if(ke(!1),!M||M.status!=="success"){Ie((M==null?void 0:M.message)||"Erreur");return}He(M),de(!1),ye((((re=M.prospective)==null?void 0:re.companies_to_evaluate)||[]).map(ee=>(ee==null?void 0:ee.name)||"")),it({state:"pending"});const _=await si(M,{email:n,cbToken:j});it(_.ok?{state:"ok",scopeLabel:((w=_.summary)==null?void 0:w.scope_label)||"",scope:((D=_.summary)==null?void 0:D.scope)||""}:{state:"fail",msg:_.error||""}),_.ok&&Ke(ee=>ee+1)}finally{pt.current=!1,ke(!1)}},gt=[je==null?void 0:je.industry,...(je==null?void 0:je.market_tags)||[],je==null?void 0:je.author].map(O=>(O||"").trim()).filter(Boolean),bt=(Me==null?void 0:Me.state)==="pending",Tt=Me&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Me.state==="ok"?t.jsx("span",{className:"rslink ok",children:Me.scope&&Me.scope!=="public"?e.rsSavedIn(Me.scopeLabel||Me.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Me.msg,children:e.rsSaveFail})),qt=Tl(je).length,Ae=U,vt=(E||S).trim(),Qe=b.find(O=>De(O.name)===De(vt)),$t=at(S)||C||at((Qe==null?void 0:Qe.website)||"")||at((Qe==null?void 0:Qe.domain)||""),_t=I||at((Qe==null?void 0:Qe.url)||""),ra=pe?e.actAnalyse:vt?e.evalGoOn(vt.length>22?vt.slice(0,21)+"…":vt):e.evalGo,Ra=oe?`${oi(se.trim())==="youtube"&&se.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Fe)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Ae?" rs-mode":"")+(E&&S.trim()===E||N||Se?" pair":"")+(N||Se||ze?" echo":"")+(ze?" swap":""),children:[t.jsxs("div",{className:"drow"+((Ae?Se:N)||ze?" flash":"")+((Ae?se.trim():ba.test(S.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Ae?se:S,placeholder:Ae?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Ae?600:200,spellCheck:Ae?!1:void 0,inputMode:Ae?"url":void 0,onChange:O=>{if(Ae){K(O.target.value);return}k(O.target.value),E&&O.target.value.trim()!==E&&(q(""),R(""),$(""),F(!1))},onKeyDown:O=>{O.key==="Enter"&&(Ae?ht():be())}}),t.jsx("span",{className:"detect"+(Ae?" off":"")+(ba.test(S.trim())?" url":""),children:z})]}),t.jsx("span",{className:"dacts",children:Ae?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(oe?" loading":""),disabled:oe||bt||!se.trim()&&!G.trim(),onClick:()=>{ht()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Ra})]}),t.jsxs("a",{className:"viewbtn"+(Kt(se)?"":" off"),href:Kt(se)?se.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:O=>{Kt(se)||O.preventDefault()},children:[t.jsx(Rl,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(pe?" analyse":"")+(d?" loading":""),disabled:d,onClick:be,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ra})]}),t.jsxs("a",{className:"viewbtn sm"+(L?" searching":$t?"":" off"),href:$t||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":L||void 0,title:L?e.viewSiteBusyHint:e.viewSiteHint,onClick:O=>{$t||O.preventDefault()},children:[L&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),L?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(_t?"":" off"),href:_t||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:O=>{_t||O.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&ne&&t.jsxs("button",{type:"button",className:"credits"+(ne.total_available<=0&&!ne.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ne.unlimited?"∞":ne.total_available}),!ne.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ne.daily_grant+ne.purchased]}),ne.total_available<=0&&!ne.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),v.items.filter(O=>O.status==="boot"||O.status==="running").map(O=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:O.name}),t.jsx(Qt,{item:O,serverOff:v.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+O.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>A(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(U?" on":""),onClick:()=>de(!U),children:e.rsOpen}),Ze!==null&&Ze>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ct?" on":""),onClick:()=>mt(!ct),children:e.rsArchOpen(Ze)})]}),ct&&t.jsx(Fl,{bump:xt,cbToken:j,onClose:()=>mt(!1),onEvaluate:O=>o(null,O),onAddAll:ye}),t.jsx("div",{className:"rsp slim"+(U?" on":" off"),"aria-hidden":!U,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:U?void 0:-1,onClick:()=>ae(O=>!O),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:xe?"▴":"▾"})]}),xe&&t.jsx("textarea",{className:"rstext",value:G,placeholder:e.rsTextPh,tabIndex:U?void 0:-1,onChange:O=>le(O.target.value)})]})}),ve&&t.jsx("div",{className:"rserr",children:ve}),je&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:je.title}),je.source_url&&t.jsx("a",{href:je.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{He(null),it(null)},children:"×"})]}),je.market&&t.jsx("p",{className:"rsmk",children:je.market}),gt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),gt.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[je.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${je.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:fo(je.summary_md||"").map((O,X)=>t.jsx("p",{children:O},X))})]}),t.jsx(xo,{card:je,onEvaluate:O=>o(null,O),onAddAll:ye}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(qt)}),Tt]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:B,placeholder:e.bulkPh,onChange:O=>W(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(V?" loading":""),style:{justifyContent:"center"},disabled:V||!P.length,onClick:()=>{et()},children:[t.jsx("span",{className:"fill"}),V&&Z?Z:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(P.length)})]})]}),Y.slice(0,1).map((O,X)=>{const re=O.verdict==="kept",w=O.verdict==="quota",D=re?"var(--brand)":w?"var(--bolt)":"var(--red)",M=re?"var(--brand-l)":w?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":D,"--bgc":M},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:re?"✓ "+e.kept:w?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!!(O.candidates&&O.candidates.length)&&t.jsx("span",{className:"sitepick",children:O.candidates.map(_=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:_.url.startsWith("http")?_.url:`https://${_.url}`,target:"_blank",rel:"nofollow noopener",children:[(_.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,_.url),children:e.evalPickGo})]},_.url))}),!w&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:re?1:5});const _=(O.name||"").trim().toLowerCase();window.setTimeout(()=>{const ee=[...document.querySelectorAll(".atl2 .list .row")].find(Ne=>{var Ee;return(((Ee=Ne.querySelector(".rnm"))==null?void 0:Ee.textContent)||"").trim().toLowerCase().includes(_)});ee&&(ee.scrollIntoView({behavior:"smooth",block:"center"}),ee.classList.add("flashrow"),window.setTimeout(()=>ee.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(re?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},X)}),h&&(i.kept+i.dropped>0||Y.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Ol(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Dl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=H(),i=e.memoConsole?r.get(e.memoConsole):null,l=u.useMemo(()=>i?[i.reasoning||"",Ol(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const d=ut(i),c=fn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Mt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function kn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=H(),[l,d]=u.useState(!1),[c,g]=u.useState(null),s=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!s||l)return;d(!0);const p=await li(r,e);if(d(!1),!p){i(a.actErr);return}g(p.results||[])};return u.useEffect(()=>{if(!s)return;const p=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,s]),u.useEffect(()=>{if(s)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{x()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Pl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),xa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Il(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=xa(a.slice(n));break}r+=xa(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=xa(a.slice(o));break}const l=a.slice(o+1,i).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Pl.has(c)?r+=`<${d[1]}${c}>`:r+=xa(a.slice(o,i+1)),n=i+1}return r}const wr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Pe({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Bl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function $l({o:e}){const{t:a,doDeep:r}=H(),[n,o]=u.useState(!1),i=ut(e),l=[e.reasoning||"",Bl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[i&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:i}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Mt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),o(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function jn({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=H(),i=aa(e),l=ut(e),d=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=u.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Mt(e)?1:0}].filter(v=>v.n>0),[e,a,d,l,c,g,s]),[p,b]=u.useState("");if(!x.length)return null;const m=x.some(v=>v.k===p)?p:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(v=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===v.k,"data-tour":"tab-"+v.k,className:m===v.k?"on":"",onClick:y=>{y.stopPropagation(),b(v.k)},children:v.lib},v.k))}),t.jsxs("div",{className:"cdbody",onClick:v=>v.stopPropagation(),children:[m==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Pe,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Pe,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Pe,{k:a.cdVerdictDate,v:wr(e.verdictDate,r)})]})]}),m==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Il(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(_l,{o:e})]}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Pe,{k:a.cdSector,v:e.sector}),t.jsx(Pe,{k:a.cdStage,v:e.stage}),t.jsx(Pe,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Pe,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Pe,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Pe,{k:a.cdAngle,v:e.angle}),t.jsx(Pe,{k:a.cdDetected,v:wr(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Pe,{k:a.cdName,v:e.contactName}),t.jsx(Pe,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Pe,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="memo"&&t.jsx($l,{o:e}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Pe,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Pe,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function _l({o:e}){const{t:a,token:r}=H(),[n,o]=u.useState(!1),[i,l]=u.useState(null),d=async()=>{n||(o(!0),l(await di(r,e.name,e.website||e.domain||"")),o(!1))},c=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=g.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),i&&s&&t.jsxs(t.Fragment,{children:[g.filter(([,x])=>x).map(([x,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:p})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!s&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function na({spec:e}){const a=u.useRef(null),r=u.useRef(null),[n,o]=u.useState(!1);return u.useEffect(()=>{const i=a.current;if(!i)return;let l=!1;const d=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));On({kind:"op",card:e},g).then(s=>{!l&&s&&i.isConnected&&i.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),u.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let l=!1;On({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&i.isConnected&&i.replaceChildren(c)});const d=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Ul=`
...
`;function Hl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let d=e.y+10;return d+n>i-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function Vl(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:l,askEvaluate:d,doAnalyse:c,doDecide:g,doPromote:s,doRepeche:x,doApproach:p,doDeep:b,doOnboard:m,outbound:v,evalBusy:y}=H(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const j=Oe(h),S=Te(h),k=ut(h),N=aa(h),T=h.kind==="target",E=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return Pt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Ul}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Hl(e.popupAnchor,!!h.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(dt(h.date)),Ue(h.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>E({country:[h.cc]}),children:(It(h.cc,o)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>E({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>E({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:Bt(h.amountEur,o)})]}),i.pipe&&T&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[S]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Nt(h.engine)," ",t.jsx("b",{children:Ue(h.engine,o)})," — ",ci(h.engine,o),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(zt,{o:h,lg:!0})," ",t.jsx(Fa,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Mr(j,o))," · ",n.win7(Or(j,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(na,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&S>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),i.pipe&&T&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),i.pipe&&T&&t.jsx(jn,{o:h})]}),t.jsx(kn,{name:h.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||l!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[S===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),S===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),S===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),S===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(h,!1),a({type:"popup",id:null})},children:n.actNo}),Mt(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(h),a({type:"popup",id:null})},children:n.memoDeep})]}),S===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),S===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(h.name),onClick:()=>d(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}function Wl(){const{lang:e,token:a,dossiers:r,caps:n}=H(),o=a||"home",{names:i,verdicts:l}=u.useMemo(()=>{const c=[],g={};return r.forEach(s=>{s.kind!=="target"||!s.name||(c.push(s.name),g[s.name]=pi(s)||"")}),{names:c,verdicts:g}},[r]);return{diff:u.useMemo(()=>i.length?ui(o,i,l,e):null,[o,i.length]),names:i,verdicts:l,scope:o,caps:n}}function Yl(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:l}=H(),d=i.loading&&!l.length,c=u.useRef({});u.useEffect(()=>{c.current={...r}},[r]);const g=p=>{const b=c.current[p],m=b!==void 0?r[p]-b:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ya[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(m>0?" up":m<0?" down":""),children:[r[p],m!==0&&t.jsxs("em",{className:"delta",children:[m>0?"+":"−",Math.abs(m)]})]})]},p)},s=(p,b,m)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${Ya[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsx("span",{className:"l",children:m.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),x=(p,b,m,v=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:v,onClick:m,children:p},b);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[x("↩",n.toolUndo,o,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Gl(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:l}=H(),d=u.useRef(null),[c,g]=u.useState(60);u.useEffect(()=>{let m=0;const v=()=>{var k;const y=d.current;if(!y)return;const h=(k=y.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!h)return;const j=h.getBoundingClientRect(),S=y.getBoundingClientRect();g(Math.max(20,Math.min(j.left+j.width/2-S.left,S.width-30)))};return m=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",v)}},[e.ptab]);const s=e.ptab;let x=r.tuto[s].p;if(s===3){const m=n.filter(h=>h.kind==="target"&&Te(h)===3),v=m.filter(h=>Ga(h)==="auto").length,y=m.filter(h=>Ga(h)==="cd").length;x=r.tutoPending(v,y,m.length)}const p=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(s===1){const m=n.filter(v=>v.kind==="target"&&Te(v)===1&&!o.has(v.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(v=>v.id)})}}return null})(),b=mi(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Ya[s]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}const Va=600,wt=62,kr="atl2:fstats";function Kl(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=H(),[l,d]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(kr)==="on"}catch{return!1}}),c=r.stats,g=u.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const x=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,p=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((N,T)=>Math.max(N,T.s||0),0),m=g.length?Va/g.length:0,v=Math.max(4,m-4),y=g.length>=5&&b>0,h=r.marketEstimate||0,j=x(new Date().toISOString().slice(0,10)),S=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],k=[];return typeof c.screened_window=="number"&&s&&k.push({cle:"fenetre",periode:e.funPerWindow(x(s),j),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:S(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[k.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([T,E],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(T)}),t.jsx("i",{children:E})]},N.cle+E)),N.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(h),Math.min(100,Math.round((c.screened||0)/h*100)))})]}),N.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const T=!l;d(T),T&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(kr,T?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},N.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Va} ${wt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((N,T)=>{const E=(N.s||0)/b*(wt-4),q=(N.m||0)/b*(wt-4),C=T*m+(m-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:C,y:wt-2-E,width:v,height:E,fill:"#cfe0d6"}),t.jsx("rect",{x:C,y:wt-2-q,width:v,height:q,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:wt-1.5,x2:Va,y2:wt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const ho={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Nn({o:e,locked:a=!1}){const{t:r}=H(),n=aa(e),o=ut(e),i=Te(e),l=Ga(e),d=xi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(ho[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(js,{o:e})]})}const Ct=e=>e.length>22?e.slice(0,21)+"…":e,va=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function La(e){return va.has(e.engine||"")}function kt(e){return!!e.noCo||La(e)&&!!e.url}function ta(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function go(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Ql({on:e,rev:a}){const[r,n]=u.useState(null),[o,i]=u.useState({top:0,left:0,width:0});return u.useEffect(()=>{if(!e){n(null);return}const l=()=>{var m,v,y;const d=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!d){n(null);return}const g=d.getBoundingClientRect(),s=c?c.getBoundingClientRect().bottom:g.top;i({top:Math.round(s),left:Math.round(g.left),width:Math.round(g.width)});const x=[...d.querySelectorAll(":scope .grp")];let p=null;for(const h of x){const j=h.querySelector(".grp-h");j&&j.getBoundingClientRect().bottom<=s+2&&(p=h)}if(!p){n(null);return}const b=p.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Jl(e){const r=()=>{const n=go(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function jr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=H(),[i,l]=u.useState(!1);if(u.useEffect(()=>{n||l(!1)},[n]),Be(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Ct(e.name))})]})}function En({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:l,doPromote:d,doRepeche:c,doApproach:g,dispatch:s,liveMemos:x}=H(),p=m=>v=>{v.stopPropagation(),m()};if(r.lockActions){const m=p(()=>s({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Te(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Ct(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return La(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(jr,{o:e})});const b=Te(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(jr,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Qt,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:p(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:p(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:p(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:p(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:p(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Xl({o:e}){const{t:a,doThumb:r,thumbOf:n}=H(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Zl({o:e}){const{lang:a}=H();return Oe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(zt,{o:e}),t.jsx(Fa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Nt(e.engine||"")," ",Ue(e.engine||"",a)]})})}function ed({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:l}){const{dispatch:d,caps:c,markRow:g,markedId:s,favIds:x,toggleFav:p,t:b}=H(),m=Te(e),v=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,h=y<=0?0:y<=7?1:y<=30?2:3,j=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][m]:v[h],S=x.has(e.id),k=N=>{if(a)return;if(l){l(e.id);return}if(c.pipe||e.kind==="op"){n();return}const T=N.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:T.left+Math.min(280,T.width/3),y:T.bottom}})};return t.jsxs(u.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>g(e.id),onMouseLeave:()=>g(null),onClick:k,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(ko,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:S?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),p(e)},children:S?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(N=>N&&N!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:b.acqSee(e.acquirer),onClick:N=>{N.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",Ct(e.acquirer)]}),Xe(e)?t.jsx("span",{className:"rdec",title:b.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:b.zoomNewsMark,children:"📰"}):null]}),t.jsx(td,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Zl,{o:e}),c.pipe&&t.jsx(Nn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(En,{o:e}),c.showThumbs&&t.jsx(Xl,{o:e})]}),r&&!a&&!l&&t.jsx(rd,{o:e})]})}function td({o:e}){const{lang:a,caps:r}=H();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Bt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function ad({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=H(),l=(p,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:p})},d=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),c=Bt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=Be(e),x=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):kt(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{p.stopPropagation(),ta(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:o,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Ct(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Ct(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(na,{spec:e.card})})]})}function nd({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=H();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ue(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(En,{o:e})}),t.jsx(jn,{o:e})]})}function bo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:l,caps:d,dossiers:c}=H(),g=u.useRef(null),s=Xe(e);if(u.useEffect(()=>{if(!s||!(e!=null&&e.decryptHtml))return;const f=g.current;if(!f)return;let A=!1;return Tr(()=>import("./fit-BnaWm7z_.js"),[]).then(async B=>{await B.ensureEditoCss(),!(A||!f.isConnected)&&(B.beautifyEditoRows(f),B.mountCardFits(f))}),()=>{A=!0}},[s,e==null?void 0:e.decryptHtml]),!e&&!a){const f=c.find(Xe);if(f)return t.jsx(bo,{o:f})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),p=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!x||wa(x),y=(e==null?void 0:e.engine)||"",h=Xe(e),j=e?Bt(e.amountEur,n):"",S=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const f=/https?:\/\/(?:www\.)?([^/]+)/.exec(p);return f?f[1].replace(/^www\./,"").slice(0,40):""})(),N=c.find(Xe),T=((N==null?void 0:N.url)||"").trim(),E=!!p&&!!T&&(p===T||p.endsWith(T)||T.endsWith(p)),q=(f,A=!1)=>B=>{B.stopPropagation(),A&&l({type:"continent",key:"monde"}),l({type:"filters",patch:f})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const C=()=>{x&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:x}}))},R=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},I=()=>{ta({url:p,headline:b,tagline:e==null?void 0:e.tagline,name:x})},$=e?Be(e):!1,L=$&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",F=h?r.doEdito.replace(/^📖\s*/,""):y?Ue(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[F,S?` · ${S}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),p&&!h&&(v||La({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:p,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:f=>f.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(h?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),j&&t.jsx("span",{className:"oc-amt",children:j})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(na,{spec:m})}),(p&&!E&&!h||N&&!h)&&t.jsxs("div",{className:"zoom-srcbox",children:[p&&!E&&!h&&t.jsxs("a",{className:"zoom-src",href:p,target:"_blank",rel:"nofollow noopener",onClick:f=>f.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),N&&!h&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:f=>{f.stopPropagation(),l({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[$?t.jsxs("span",{className:"verdict",style:{"--c":L?"var(--brand)":"var(--red)"},children:[L?"✓":"✗"," ",t.jsx("b",{children:L?r.kept:r.dropped})]}):!v&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:f=>{f.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Ct(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,p&&!h&&(v||La({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&x?" ghost":""),onClick:f=>{f.stopPropagation(),I()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:f=>{f.stopPropagation(),R()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:f=>{f.stopPropagation(),C()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Ct(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&x&&d.pipe&&t.jsx(kn,{name:x})]})]})}function rd({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:l}=H();return!o.pipe&&e.kind==="op"?t.jsx(ad,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(jn,{o:e}),t.jsx(Ns,{o:e}),t.jsx(Cs,{o:e}),t.jsx(kn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Nn,{o:e})})]}),e.card&&t.jsx(na,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Nt(e.engine||"")," ",Ue(e.engine||"",r)]}),Oe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(zt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function od({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:l,doDecide:d,lang:c}=H();if(!l.pipe&&e.kind==="op"){const x=Bt(e.amountEur,c),p=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(na,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Nt(e.engine||"")," ",Ue(e.engine||"",c)]}),Oe(e)&&t.jsx(zt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(p?` · ${p}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(En,{o:e})})]})}const g=Te(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Nn,{o:e}),Oe(e)&&t.jsx(zt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemo," →"]})]})}function id(){const{t:e}=H(),[a,r]=u.useState(0);return u.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function sd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=H(),i=o==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,x)=>(e[x]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${l(c)}”`:`${g} dossier${g>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+l(c)," →"]})]})}function ld(){var Ze,ft,xt,Ke,pt;const e=H(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:l,scopedAll:d,markRow:c,lang:g,sessTally:s,data:x,dossiers:p,source:b,focusExtra:m,byId:v,token:y}=e,h=Br(),j=u.useMemo(()=>{var Y,ne,ye,pe;if(!y||b==="ops")return null;const z=(((Y=h==null?void 0:h.ed)==null?void 0:Y.date)||(h==null?void 0:h.day)||"").slice(0,10),P=[(ne=h==null?void 0:h.ed)==null?void 0:ne.html,(ye=h==null?void 0:h.ed)==null?void 0:ye.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((pe=h==null?void 0:h.ed)==null?void 0:pe.date)||z,decryptHtml:P||void 0,date:z,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,g,(Ze=h==null?void 0:h.ed)==null?void 0:Ze.html,(ft=h==null?void 0:h.ed)==null?void 0:ft.acquirers_html,(xt=h==null?void 0:h.ed)==null?void 0:xt.date,h==null?void 0:h.day]),S=z=>o.lockRowsAfter!==null||b==="ops"?Number.MAX_SAFE_INTEGER:Pr,[k,N]=u.useState(new Set);u.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[T,E]=u.useState(null);u.useEffect(()=>{E(null)},[a.ptab,a.continent]);const[q,C]=u.useState(!a.mapFolded);u.useEffect(()=>{if(a.mapFolded){C(!1);return}const z=document.getElementById("atl2-stage");if(!z){C(!1);return}const P=new IntersectionObserver(([Y])=>C(!!Y&&Y.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return P.observe(z),()=>P.disconnect()},[a.mapFolded]);const R=a.mapFolded||!q,I=z=>N(P=>{const Y=new Set(P);return Y.has(z)?Y.delete(z):Y.add(z),Y}),$=b==="ops"||o.pipe,[L,F]=u.useState("all"),[f,A]=u.useState(null),[B,W]=u.useState(!1),V=u.useRef(!0);u.useEffect(()=>{if(V.current){V.current=!1;return}F("all"),W(!1)},[a.ptab,a.continent]),u.useEffect(()=>{if(!B)return;const z=P=>{var Y,ne;(ne=(Y=P.target)==null?void 0:Y.closest)!=null&&ne.call(Y,".atl2 .doable")||W(!1)};return document.addEventListener("click",z),()=>document.removeEventListener("click",z)},[B]);const Q=u.useMemo(()=>{var P;const z=new Map;for(const Y of cs(((P=h==null?void 0:h.ed)==null?void 0:P.html)||""))z.has(Y.t)||z.set(Y.t,Y.html);return z},[(Ke=h==null?void 0:h.ed)==null?void 0:Ke.html]),Z=u.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!Q.size)return;const P=(z.name||"").trim().toLowerCase();if(P.length<3)return;const Y=Q.get(P);if(Y)return Y;for(const[ne,ye]of Q)if(ne.includes(P)||P.includes(ne))return ye},[Q]),{diff:J}=Wl(),[ue,te]=u.useState(!1),he=a.filters.win==="1"&&!a.filters.day,[U,de]=u.useState(!1),xe=u.useMemo(()=>new Set(((J==null?void 0:J.added)||[]).map(z=>z.trim().toLowerCase()).filter(Boolean)),[J]),ae=u.useMemo(()=>{const z=U&&xe.size?d:l;let P=gn(z,a.sort);return P=P.filter(Y=>!Xe(Y)),U&&xe.size&&(P=P.filter(Y=>xe.has((Y.name||"").trim().toLowerCase()))),L==="explore"?P=P.filter(kt):L==="eval"&&(P=P.filter(Y=>!kt(Y)&&!Y.noCo)),P},[l,d,a.sort,L,U,xe]),ie=u.useMemo(()=>o.pipe?d.filter(z=>Oe(z)&&fi(z)):ae.filter(z=>Oe(z)&&!Be(z)),[o.pipe,d,ae]).length,me=u.useMemo(()=>o.pipe?ae:ae.filter(z=>!Be(z)&&!z.noCo),[ae,o.pipe]),se=b==="ops"?ae.filter(kt).length:0,K=U?n.sinceDock(ae.length):o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,G=a.filters,le=[];if(G.day)le.push({k:"day",lib:n.fDay(G.day.slice(8,10)+"/"+G.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(G.win&&G.win!=="all"){const z=["1","7","30"].indexOf(G.win);z>=0&&le.push({k:"win",lib:n.dates[z],off:()=>r({type:"filters",patch:{win:"all"}})})}const Se=z=>z.length<=2?z.join(", "):`${z.length} ${n.fSelected}`;for(const z of["sector","country","engine"]){const P=G[z];P&&P.length&&le.push({k:z,lib:Se(P),off:()=>r({type:"clearFacet",facet:z})})}G.search&&le.push({k:"search",lib:"🔍 "+G.search,off:()=>r({type:"filters",patch:{search:""}})}),U&&xe.size&&le.push({k:"since",lib:"✨ "+n.sinceDock(xe.size),off:()=>de(!1)}),G.signalOnly&&le.push({k:"sig",lib:"🔴 "+n.sigDock(ie||G.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const ce=(z,P,Y="",ne=!1)=>t.jsxs("button",{type:"button","data-s":z,className:Y,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:ne?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[P,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),oe=u.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const z=new Map;ae.forEach(ne=>{const ye=ne.engine||"?";z.has(ye)||z.set(ye,[]),z.get(ye).push(ne)});const P={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},Y=Wa([...z.keys()],g);return[...z.entries()].sort((ne,ye)=>{const pe=P[ne[0]]??10+Y.indexOf(ne[0]),be=P[ye[0]]??10+Y.indexOf(ye[0]);return pe-be})},[ae,o.pipe,a.groupBy,g]),ke=oe?oe.filter(([z])=>va.has(z)).length:0,Fe=(()=>{var P;return((P=(oe?oe.flatMap(([,Y])=>Y):ae)[0])==null?void 0:P.id)??null})(),Re=u.useRef(!1),ve=u.useMemo(()=>p.find(Xe)||j,[p,j]);u.useEffect(()=>{const z=()=>{Re.current=!0};return window.addEventListener("ppmap:reveal",z),window.addEventListener("ppmap:focus",z),()=>{window.removeEventListener("ppmap:reveal",z),window.removeEventListener("ppmap:focus",z)}},[]),u.useEffect(()=>{const z=()=>{ve&&r({type:"focus",id:ve.id})};return window.addEventListener("ppmap:edito",z),()=>window.removeEventListener("ppmap:edito",z)},[ve,r]),u.useEffect(()=>{if(!a.focusId)return;A(a.focusId);const z=window.setTimeout(()=>A(null),900);return()=>window.clearTimeout(z)},[a.focusId]),u.useEffect(()=>{if($&&!(a.focusId&&(ae.some(z=>z.id===a.focusId)||p.some(z=>z.id===a.focusId)||a.focusId===(ve==null?void 0:ve.id)))&&!m){if(ve){r({type:"focus",id:ve.id});return}Fe&&r({type:"focus",id:Fe})}},[$,a.focusId,ae,Fe,m,r,p,b,ve]),u.useEffect(()=>{if(!(!$||!a.focusId)&&L!=="all"&&!(ve&&a.focusId===ve.id)&&!ae.some(z=>z.id===a.focusId)&&p.some(z=>z.id===a.focusId)){if(Re.current){F("all");return}Fe&&r({type:"focus",id:Fe})}},[$,a.focusId,L,ae,p,Fe,r]),u.useEffect(()=>{if(!$||!a.focusId||!Re.current)return;const z=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!z)return;Re.current=!1;const P=go(),Y=z.getBoundingClientRect();Y.top>=P-2&&Y.bottom<=window.innerHeight-4||Jl(z)},[$,a.focusId,a.ptab,ae]),u.useEffect(()=>{if(typeof window>"u")return;const z=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),P=document.querySelector(".atl2.ops, .atl2.cibles");if(!z||!P)return;const Y=()=>P.style.setProperty("--listhead-h",`${z.offsetHeight}px`);Y();const ne=new ResizeObserver(Y);return ne.observe(z),()=>ne.disconnect()},[R,a.dens,a.mapFolded]);const Ie=u.useMemo(()=>{if(!$||!a.focusId)return null;if(j&&a.focusId===j.id)return j;const z=ae.find(Y=>Y.id===a.focusId)||p.find(Y=>Y.id===a.focusId)||null;if(!z)return null;const P=Z(z);return P&&P!==z.decryptHtml?{...z,decryptHtml:P}:z},[$,a.focusId,ae,p,Z,j]),je=o.lockRowsAfter;let He=0;const Me=(z,P)=>{let Y=a.shown[P]||S();return z.length-Y<=4&&(Y=z.length),z.slice(0,Y).map(pe=>{const be=je!==null&&He>=je;He++;const et=Z(pe),ht=et&&et!==pe.decryptHtml?{...pe,decryptHtml:et}:pe,gt=!$&&a.dens!=="maxi"&&(a.dens==="deplie"||(T?T==="open":!!et)),bt=k.has(pe.id)?!gt:gt,Tt=$?qt=>{Re.current=!0,r({type:"focus",id:qt});const Ae=v.get(qt);Ae&&(kt(Ae)?ta(Ae):Ae.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ae.name,url:Ae.url||"",website:Ae.website||"",domain:Ae.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(od,{o:ht,locked:be,selected:$&&a.focusId===pe.id,onSelect:Tt},pe.id):t.jsx(ed,{o:ht,locked:be,open:bt,onToggle:()=>I(pe.id),selected:$&&a.focusId===pe.id,echo:f===pe.id,onSelect:Tt},pe.id)})},it="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ae.length?"":" list-empty"),ct=t.jsxs(t.Fragment,{children:[oe?oe.map(([z,P])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Nt(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:z==="ma"?n.grpMa:z==="fundraising"?n.grpLev:va.has(z)&&ke<=1?n.grpNews:z==="nominations"?n.grpNom:z==="media"?n.grpNewsOther:z==="recrutements"?n.grpHire:va.has(z)?n.grpNews+" · "+Ue(z,g):Ue(z,g)}),t.jsx("div",{className:"s",children:n.grpCount(P.filter(Y=>!Be(Y)).length,P.length)})]})]}),Me(P,z)]},z)):Me(ae,"pt"+a.ptab),x.loading&&!p.length&&t.jsx(id,{}),!ae.length&&!(x.loading&&!p.length)&&(o.pipe?t.jsx(sd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),mt=t.jsxs("div",{className:"listhead"+(R?" mapoff":""),children:[R&&t.jsx("div",{className:"lh-tools",children:t.jsx(uo,{compact:!0})}),o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(he?" on":""),"aria-pressed":he,title:n.morningDockTitle,onClick:()=>{if(he){r({type:"filters",patch:{win:"all",day:""}});return}r({type:"filters",patch:{win:"1",day:""}}),r({type:"ptab",tab:7}),te(!0)},children:["📊 ",n.morningDock(typeof((pt=x.stats)==null?void 0:pt.screened_today)=="number"?x.stats.screened_today:0)]}),J&&!J.firstVisit&&(J.added.length>0||J.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(U?" on":""),"aria-pressed":U,title:n.sinceSub,onClick:()=>de(z=>!z),children:["✨ ",n.sinceDock(J.added.length)]}),ie>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[]}}),children:["🔴 ",n.sigDock(ie)]})]}),o.showFunnel&&ue&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(As,{}),t.jsx(Kl,{})]}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Yl,{}),t.jsx(Gl,{})]}),t.jsxs("div",{className:"lh-top",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:ae.length})," ",K]}),t.jsx("span",{className:"dot",children:"·"}),R&&t.jsx(mo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[R?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),le.map(z=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:P=>{P.stopPropagation(),z.off()},children:[z.lib,t.jsx("i",{children:"×"})]},z.k)),b==="ops"&&ae.length>0&&!R&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ae.length-se," ",n.zoomPulseEval,se>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",se," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,P])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:P})]},z))}),!$&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":T==="open",onClick:()=>{E("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":T==="closed",onClick:()=>{E("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var pe;const z=l.filter(be=>!Xe(be)),P=z.filter(be=>!kt(be)&&!be.noCo).length,Y=z.filter(kt).length,ne=[["all",n.doAll],["eval",`${n.doEval}${P?` ${P}`:""}`],["explore",`${n.doExplore}${Y?` ${Y}`:""}`]],ye=((pe=ne.find(([be])=>be===L))==null?void 0:pe[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":B,onClick:()=>W(be=>!be),children:[ye,t.jsx("i",{children:"▾"})]}),B&&t.jsx("div",{className:"dolist",children:ne.map(([be,et])=>t.jsx("button",{type:"button","aria-pressed":L===be,onClick:()=>{F(be),W(!1)},children:et},be))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([z,P])=>t.jsx("option",{value:z,children:P},z))})]}),o.showChain&&me.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:me.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(me.length):n.chainAll(me.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!$&&mt,a.dens!=="maxi"&&!$&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ce("country",n.colCountry),ce("name",n.colCompany),ce("amount",n.colAmount,"h-amt",!0),ce("stage",n.colStage,"h-stade"),ce("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ce("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ce("memo",n.colMemo)]}),o.pipe&&ce("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),$?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[mt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ce("country",n.colCountry),ce("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ce("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ce("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:it,children:ct})]}),t.jsxs("aside",{className:"readpane"+((Ie?Xe(Ie):!m&&ve)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[ve&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===ve.id,onClick:()=>r({type:"focus",id:ve.id}),children:n.doEdito}),j&&a.focusId===j.id?t.jsx("div",{className:"zoom",children:t.jsx(fs,{})}):Ie&&o.pipe?t.jsx(nd,{o:Ie}):t.jsx(bo,{o:Ie,extra:Ie?null:m})]})]}):t.jsx("div",{className:it,children:ct}),(()=>{const z=oe||[["pt"+a.ptab,ae]];let P=0,Y=0;for(const[ye,pe]of z){Y+=pe.length;let be=a.shown[ye]||S();pe.length-be<=4&&(be=pe.length),P+=Math.min(pe.length,be)}const ne=Y-P;return ne<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([ye,pe])=>r({type:"more",group:ye,by:pe.length,base:S()})),children:[t.jsx("span",{className:"more-label",children:n.more(ne,ne)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(P,Y)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}}),$&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Ql,{on:!!oe,rev:(oe||[]).map(([z,P])=>z+P.length).join("|")})]})}function Nr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function dd(e,a){const r=hi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function cd(e,a){const n=[a.head.split("|").map(Nr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",dd(o,a.plabels),aa(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Nr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function pd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const ud=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function nt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function md({o:e,qa:a}){const{t:r,lang:n,fund:o}=H(),i=(e.cribleStatus||"").trim().toUpperCase()||(aa(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=ut(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(nt,{k:r.cdSector,v:e.sector}),t.jsx(nt,{k:r.cdStage,v:e.stage}),t.jsx(nt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(nt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(nt,{k:r.cdName,v:e.contactName}),t.jsx(nt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(nt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(nt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(nt,{k:r.cdAngle,v:e.angle}),t.jsx(nt,{k:r.cdDetected,v:ud(e.date,n)})]}),c.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,g])=>g).map(([g,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:s})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function fd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:l}=H(),[d,c]=u.useState({}),g=25,s=u.useMemo(()=>n.slice(0,g),[n]);u.useEffect(()=>{s.length&&gi(r,s.map(b=>b.name)).then(c)},[r,s]);const x=i.stats,p=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[p(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(x.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(i.marketEstimate)),", ",Math.round(x.screened/i.marketEstimate*100)," %"]})]})]}),s.map(b=>t.jsx(md,{o:b,qa:d[b.name]},b.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const xd=50;function Sn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=H(),[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(""),[x,p]=u.useState(0),[b,m]=u.useState(""),[v,y]=u.useState(!1),[h,j]=u.useState(0),S=u.useRef(null),k=u.useRef(null),N=()=>{j(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>j(C=>C+1),1e3)},T=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};u.useEffect(()=>()=>{S.current&&window.clearInterval(S.current),k.current&&window.clearInterval(k.current)},[]);const E=async C=>{c(!0),s(""),N();const R=await a();if(c(!1),T(),R.ok){l(R);return}if(R.busy){s(o.alertPreviewBusy);return}if(!C){s(o.alertPreviewFail);return}p(xd),T(),S.current=window.setInterval(()=>{p(I=>I>1?I-1:(S.current&&window.clearInterval(S.current),E(!1),0))},1e3)},q=async()=>{if(n||v||d)return;y(!0),m(""),N();const C=await r();y(!1),T(),m(C.ok?o.alertTestOk(C.sentTo||""):C.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||v||x>0,onClick:()=>{E(!0)},children:d?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||d,onClick:()=>{q()},children:v?o.alertBtnTestBusy:o.alertTest})]}),d&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(h)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(h)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Rt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function $e({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=H();return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function hd(){const{st:e}=H();switch(e.modal){case"chain":return t.jsx(bd,{});case"space":return t.jsx(vd,{});case"alert":return t.jsx(yd,{});case"queue":return t.jsx(Ed,{});case"export":return t.jsx(Sd,{});case"plug":return t.jsx(Ad,{});case"recharge":return t.jsx(qd,{});case"cover":return t.jsx(Fd,{});case"dossier":return t.jsx(Ld,{});case"crit":return t.jsx(Rd,{});case"tuto":return t.jsx(Md,{});case"rdv":return t.jsx(gd,{});case"memoalert":return t.jsx(Cd,{});default:return null}}function gd(){const{dispatch:e,fund:a,t:r}=H(),n=a||r.rdvCoFallback;return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Ur,children:vn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx($i,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function bd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:l,evalBusy:d,caps:c,memoQueued:g,doAnalyse:s}=H(),x=i==="client",p=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,m=p[b],v=b>=p.length;return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[It(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(dt(m.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ue(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Bt(m.amountEur,o)})]}),Oe(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(zt,{o:m,lg:!0})," ",t.jsx(Fa,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&Be(m)&&t.jsxs("div",{className:"vbox",style:{"--c":jt(m)==="retenu"?"var(--brand)":jt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:jt(m)==="retenu"?"✓ "+n.kept:jt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&c.pipe&&Te(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(x&&Be(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function vd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=H(),i=o==="client",l=u.useMemo(()=>i?r.filter(x=>Be(x)):[],[r,i]),d=u.useMemo(()=>gn(l.filter(x=>jt(x)==="retenu"),{key:"signal",dir:-1}),[l]),c=u.useMemo(()=>l.filter(x=>jt(x)==="ecarte"),[l]),g=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs($e,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function yd(){const{mode:e}=H();return e==="client"||e==="apercu"?t.jsx(wd,{}):t.jsx(Nd,{})}function wd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=H(),[i,l]=u.useState("d"),d=o!=="client";return t.jsxs($e,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(kd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),i==="w"&&t.jsx(jd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),i==="m"&&t.jsx(vo,{})]})}function kd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(0);u.useEffect(()=>{let q=!0;return c(!1),In(a).then(C=>{q&&(C?l(C):c(!0))}),()=>{q=!1}},[a,g]);const x=u.useRef({}),[p,b]=u.useState({}),[m,v]=u.useState(!1),[y,h]=u.useState(!1),j=u.useRef(null);u.useEffect(()=>()=>{j.current&&window.clearTimeout(j.current)},[]);const S=q=>{const C=x.current;Object.keys(C).length&&(v(!0),In(a,C).then(R=>{if(!R){v(!1),o(e.actErr);return}if(R.throttled&&q<3){j.current=window.setTimeout(()=>S(q+1),5400);return}if(x.current={},b({}),l(R),v(!1),R.throttled){o(e.alertThrottled);return}h(!0),window.setTimeout(()=>h(!1),2e3),n(e.alertSaved)}))},k=q=>{r||(x.current={...x.current,...q},b(C=>({...C,...q})),j.current&&window.clearTimeout(j.current),j.current=window.setTimeout(()=>S(1),700))};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(q=>q+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...p},T=q=>!N.sections||N.sections.includes(q),E=q=>{const C=N.sections||e.alertSec.map(([R])=>R);k({sections:T(q)?C.filter(R=>R!==q):[...C,q]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([q,C])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:T(q),disabled:r,onChange:()=>E(q)}),t.jsxs("span",{children:[C,q==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},q))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Sn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ci(a),onTest:()=>Si(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function jd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(0);u.useEffect(()=>{let m=!0;return c(!1),Bn(a).then(v=>{m&&(v?l(v):c(!0))}),()=>{m=!1}},[a,g]);const x=m=>{r||Bn(a,m).then(v=>{if(!v){o(e.actErr);return}l(v),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const p=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Sn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Ai(a),onTest:()=>zi(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function vo(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=H(),[l,d]=u.useState(i||""),[c,g]=u.useState(!1),[s,x]=u.useState(!1);u.useEffect(()=>{i&&d(i)},[i]);const p=e.filters,b=u.useMemo(()=>n.filter(h=>Oe(h)).length,[n]),m=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){x(!0);try{await fetch(`${mn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:p.sector,countries:p.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(h=>Ue(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(h=>It(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([h,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!i,onChange:h=>d(h.target.value),onKeyDown:h=>{h.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Nd(){const{t:e}=H();return t.jsx($e,{title:e.alertTitle,icon:"🔔",children:t.jsx(vo,{})})}function Ed(){var I,$;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:l,caps:d,dispatch:c,liveMemos:g}=H(),[s,x]=u.useState(()=>Oa(r)),[p,b]=u.useState(()=>!Oa(r)),[m,v]=u.useState([]),[y,h]=u.useState(0),j=n==="client",S=u.useMemo(()=>{const L=new Map;return o.forEach(F=>{const f=(F.name||"").trim().toLowerCase();f&&!L.has(f)&&L.set(f,F)}),L},[o]);u.useEffect(()=>{let L=!0;return(!Oa(r)||y>0)&&b(!0),(async()=>{const[F,f]=await Promise.all([xn(r,y>0),qr(a)]);L&&(F&&x(F),b(!1),v(f))})(),()=>{L=!1}},[a,r,y]);const k=p&&!s,N=(s==null?void 0:s.per_day)??0,T=((I=s==null?void 0:s.analyzed_today)==null?void 0:I.length)??0,E=s==null?void 0:s.offre,q=(s==null?void 0:s.pool_meta)||[],C=u.useMemo(()=>{const L=new Map;for(const F of(s==null?void 0:s.scheduled)||[])for(const f of F.names||[])L.has(f)||L.set(f,{label:F.day_label,date:F.date});return L},[s==null?void 0:s.scheduled]),R=(s==null?void 0:s.in_progress)||[];return t.jsxs($e,{title:e.queueTitle,wide:!0,children:[E&&t.jsxs("div",{className:"qoffre"+(E.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:E.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:E.delai})]}),t.jsx("span",{className:"osp"}),E.rythme>0?t.jsx("span",{className:"or",children:e.qRate(E.rythme)}):E.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(E.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(T,T+((($=s==null?void 0:s.pool_order)==null?void 0:$.length)??0))}})}),E&&t.jsxs("div",{className:"qeta",children:[E.file===0?e.qEtaDone:E.rythme<=0?e.qEtaPaused:e.qEta(E.file,E.rythme,E.jours_restants),E.en_retard&&t.jsxs("em",{children:[" ",e.qLate(E.delai,E.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(E==null?void 0:E.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(R.length>0||g.items.some(L=>L.status==="boot"||L.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(L=>L.status==="boot"||L.status==="running"||L.status==="error").map(L=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:L.name}),t.jsx("span",{className:"qd",children:L.memoType||""}),t.jsx(Qt,{item:L,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+L.name)),R.filter(L=>!g.liveOf(L.name)).map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.name}),t.jsxs("span",{className:"qd",children:[L.memo_type||"",L.age_min?` · ${Math.round(L.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:L.state||""})]},"ip-"+L.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.company}),t.jsxs("span",{className:"qd",children:[L.memo_type,typeof L.est_min=="number"?` · ~${L.est_min} min`:""]}),t.jsx("span",{className:"qt",children:L.status}),L.url&&t.jsx("a",{className:"qgo",href:L.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),j&&L.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Pn(a,L.company,"retry").then(()=>h(F=>F+1))},children:e.queueRetry}),j&&L.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Pn(a,L.company,"delete").then(()=>h(F=>F+1))},children:e.queueDelete})]},L.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(q.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&q.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),q.map((L,F)=>{const f=C.get(L.name),A=S.get((L.name||"").trim().toLowerCase()),B=g.liveOf(L.name),W=!!(A&&l.has(A.id))||!!(B&&(B.status==="boot"||B.status==="running")),V=!!(A&&Te(A)===1&&!A.memoUrl)&&!B;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",F+1]}),f?t.jsx("span",{className:"qwhen"+(f.label==="demain"?" soon":""),children:f.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:L.name}),L.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof L.score=="number"&&t.jsx("span",{className:"qs2",children:L.score}),B&&(B.status==="boot"||B.status==="running")&&t.jsx(Qt,{item:B,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),V&&(d.lockActions||!j?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:W,onClick:()=>{i(A),h(Q=>Q+1)},children:W?e.actAnalyseQueued:e.actAnalyse})),L.excerpt&&t.jsx("span",{className:"qex",children:L.excerpt})]},L.name+":"+F)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([L,F])=>t.jsxs("li",{children:[t.jsx("b",{children:L})," — ",F]},L))})]})}function Sd(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:l}=H(),d=`${Rt}/cibles/list.csv?token=${a}`,c=`${Rt}/cibles/list.json?token=${a}`,g=`${Rt}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,x=y=>{var h;(h=navigator.clipboard)==null||h.writeText(y).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{pd(cd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([h])=>h===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs($e,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:y,value:h,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(h),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Cd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=H(),i=o!=="client",[l,d]=u.useState(null),[c,g]=u.useState(!1),[s,x]=u.useState(0),[p,b]=u.useState(!1);u.useEffect(()=>{let h=!0;return g(!1),Dn(a).then(j=>{h&&(j?d(j):g(!0))}),()=>{h=!1}},[a,s]);const m=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=h=>{if(i||!l)return;const j={enabled:h.enabled??!!l.enabled,email:h.email??(l.email||""),sections:h.sections??m()};b(!0),Dn(a,j).then(S=>{if(b(!1),!S){n(e.memoAlertErr);return}d(S),r(e.memoAlertSaved)})};if(c)return t.jsx($e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(h=>h+1),children:e.retry})]})});if(!l)return t.jsx($e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs($e,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:i||p,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(zd,{value:l.email||"",readOnly:i||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>v({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[h],disabled:i||p,onChange:()=>v({sections:{...y,[h]:!y[h]}})}),t.jsx("span",{children:j})]},h))}),t.jsx(Sn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>vi(a,y),onTest:()=>bi(a,y)})]})}function zd({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,l]=u.useState(e);u.useEffect(()=>{l(e)},[e]);const d=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&d&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>o(i.trim()),children:n})]})]})}function Ad(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=H(),[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(null),[x,p]=u.useState(""),[b,m]=u.useState(0);u.useEffect(()=>{let S=!0;return c(!1),Ka(a).then(k=>{S&&(k?l({configured:k.configured,url_hint:k.url_hint}):c(!0))}),ki(a).then(k=>{S&&s(k)}),()=>{S=!1}},[a,b]);const v=(S,k)=>{o&&Ka(a,S).then(N=>{if(!N||N.ok===!1){n(e.actErr);return}S.test&&N.sent===!1?n(e.plugTestThrottled):r(k),m(T=>T+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${Rt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs($e,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(S=>S+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!o,onChange:S=>p(S.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!x.trim(),onClick:()=>v({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Td,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Td(){const{t:e,token:a,lang:r}=H(),[n,o]=u.useState("valides"),[i,l]=u.useState(!1),[d,c]=u.useState(null),[g,s]=u.useState(null),[x,p]=u.useState(!1),[b,m]=u.useState(!1),[v,y]=u.useState(null),[h,j]=u.useState(null),[S,k]=u.useState(null),N=`atl2:bulk:${a}:${n}`;u.useEffect(()=>{Ka(a).then($=>{j($&&$.configured?$.url_hint||"webhook":null)})},[a]),u.useEffect(()=>{c(null),s(null),p(!1),y(null);try{const $=JSON.parse(localStorage.getItem(N)||"null");k($&&Date.now()-Date.parse($.t)<24*3600*1e3?$:null)}catch{k(null)}},[N]);const T=async()=>{l(!0),p(!1),y(null);const $=await Ni(a,n);c($),s($.ok?n:null),l(!1)},E=u.useRef(!1),q=async()=>{if(E.current)return;E.current=!0,m(!0);const $=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await Ei(a,n,"webhook",void 0,$)}finally{E.current=!1}if(m(!1),p(!1),y(L),L.ok&&(L.pushed||0)>0){const F={t:new Date().toISOString(),n:L.pushed||0};k(F);try{localStorage.setItem(N,JSON.stringify(F))}catch{}}},C=d!=null&&d.ok&&d.ready||0,R=!!(d!=null&&d.ok)&&g===n&&C>0&&!!h&&!S,I=S?new Date(S.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:$=>o($.target.value),children:e.plugBulkTabs.map(([$,L])=>t.jsx("option",{value:$,children:L},$))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{T()},children:i?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),S&&t.jsx("p",{className:"mnote",children:e.bulkLocked(I,S.n)}),!S&&!!(d!=null&&d.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!S&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),R&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),R&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(C,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{q()},children:b?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>p(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function qd(){const{t:e,data:a,lang:r}=H(),n=a.credits,o=a.email,i=async l=>{if(!o)return;const d=window.location.href.split("?")[0];try{const g=await(await fetch(`${mn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs($e,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Ld(){const{t:e}=H();return t.jsx($e,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(fd,{})})}function Fd(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:l,flash:d}=H(),[c,g]=u.useState(null),[s,x]=u.useState(!1);u.useEffect(()=>{let C=!0;if(i)return xn(i).then(R=>{C&&R&&typeof R.per_day=="number"&&g(R.per_day)}),()=>{C=!1}},[i]);const[p,b]=u.useState(null);u.useEffect(()=>{if(!o)return;let C=!0;return wi(o).then(R=>{C&&b(R)}),()=>{C=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(C=>C.kind==="target"&&Be(C)).length,y=r.marketEstimate||0,h=y>0?Math.min(100,Math.round(v/y*100)):null,j=(m==null?void 0:m.window_days)||30,S=v>0?v/j:0,k=y>0?Math.max(0,y-v):0,T=y>0&&S>0&&v>=100?Math.round(k/S):null,E=C=>Math.round(C).toLocaleString(a==="en"?"en-US":"fr-FR"),q=C=>{s||!l||(x(!0),ji(o,C).then(R=>{if(x(!1),R===null){d(e.actErr);return}g(R),d(e.alertSaved)}))};return t.jsxs($e,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(E(v))}),y>0&&t.jsx("span",{children:e.covOf(E(y))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),T!==null&&t.jsx("p",{className:"mnote",children:e.covEta(T)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),S>=1&&t.jsx("p",{className:"mnote",children:e.covPace(E(S))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.shown)})," ",e.funShown]})]}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((C,R)=>t.jsxs("tr",{className:C.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[C.code,C.geo?` · ${C.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof C.n=="number"?E(C.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:C.source}),C.elargi&&t.jsx("em",{children:e.covWide(String(C.demande||""))}),C.erreur&&t.jsx("em",{children:e.covMissing})]})]},R)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:E(p.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:c===C?"on":"",disabled:s,onClick:()=>q(C),children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Rd(){var h,j,S;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:l,lang:d}=H(),c=n==="client",g=u.useMemo(()=>{const k=new Set;return a.forEach(N=>{N.angle&&k.add(N.angle)}),[...k]},[a]),[s,x]=u.useState(""),[p,b]=u.useState(""),[m,v]=u.useState(!1),y=async()=>{const k=s.trim();if(!(!k||m||!c)){v(!0),b("");try{const T=await(await fetch(`${Rt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&b(String(T.reply)),T.job_id){b(e.critChatRunning);const E=async()=>{const q=await fetch(`${Rt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(C=>C.json()).catch(()=>null);if(q&&q.done){b(String(q.reply||q.clarification||q.summary||"✓")),v(!1),q.applied&&o(e.alertSaved);return}setTimeout(()=>{E()},8e3)};setTimeout(()=>{E()},8e3),x("");return}x("")}finally{p.startsWith("⏳")||v(!1)}}};return t.jsxs($e,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((h=i.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=i==null?void 0:i.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var N,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((N=k.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(E=>t.jsx("li",{children:E},E))})]}),!!((T=k.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(E=>t.jsx("li",{children:E},E))})]})]})]},k.title)})]}),!!((S=i==null?void 0:i.gate)!=null&&S.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||m,onChange:k=>x(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(yi,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(ho[k]||"v-cons"),children:k}),t.jsx("span",{children:N})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",N]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Md(){const{t:e,dispatch:a,startTour:r}=H(),n=o=>{var i,l;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs($e,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+l))})]})}const yo="atl2:mapfold",Od=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(yo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Dd=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},wo=u.createContext(null),H=()=>{const e=u.useContext(wo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function zt({o:e,lg:a}){const{lang:r}=H(),n=Oe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:$n(n,r),children:[n.emoji," ",$n(n,r)]}):null}function Fa({o:e,src:a}){const{lang:r,t:n}=H(),o=Oe(e);if(!o)return null;const i=Mi(o),l=Oi(o);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Mr(o,r))+" · "+n.win7(Or(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Pd(e,a,r){const n=(r||"").trim();if(n){const i=e.find(l=>(l.url||"")===n);if(i)return i}const o=De(a);if(o)return e.find(i=>De(i.name)===o)||e.find(i=>{const l=De(i.name);return l.length>=3&&(o.includes(l)||l.includes(o))})}function Id(){const{scoped:e,t:a,st:r,dispatch:n}=H(),o=u.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,l=e.filter(x=>!Xe(x)),d=l.length,c=l.filter(x=>!x.noCo).length,g=l.filter(x=>!!x.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function Bd(){const{t:e,lang:a,data:r,dispatch:n}=H(),o=r.stats,i=d=>d.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const l=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:l>0?e.covOf(i(l)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function ko({o:e}){const{lang:a}=H(),r=Ri(e.cc),n=e.cc?It(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Er="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",$d=!1;function _d(){const[e,a]=u.useState(!1);return u.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const jo=e=>`atl2:tour:${e||"anon"}`;function Ud(e){try{return localStorage.getItem(jo(e))==="1"}catch{return!0}}function Sr(e){try{localStorage.setItem(jo(e),"1")}catch{}}function Hd(e,a,r,n,o){const i=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:i.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:i.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:i.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:i.live,body:e.fhintLive},{sel:".atl2 .goal",title:i.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:i.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:i.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:i.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:i.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:i.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:i.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:i.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:i.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:i.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:i.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:i.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:i.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Kd({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var re;const{lang:l}=Ti(),d=Gi[l],c=os(e,l,a),[g,s]=u.useReducer(ls,void 0,()=>is((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Dd():Od()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=u.useRef(!0);u.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(yo,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),u.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const w=()=>{window.innerWidth<=760&&s({type:"mapFold",folded:!0})};return w(),window.addEventListener("resize",w),()=>window.removeEventListener("resize",w)},[a]);const p=u.useRef(i);p.current=i,u.useEffect(()=>{var w;(w=p.current)==null||w.call(p,g.filters)},[g.filters]);const[b,m]=u.useState(()=>{if(typeof window>"u")return"both";try{const w=localStorage.getItem("atl2:chrome-mode");if(w==="eval"||w==="filt"||w==="both")return w;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=u.useState(null),[h,j]=u.useState(null),[S,k]=u.useState(null),[N,T]=u.useState({kept:0,dropped:0}),[E,q]=u.useState(!1),[C,R]=u.useState(""),[I,$]=u.useState(!1),[L,F]=u.useState(null),[f,A]=u.useState(!1),[B,W]=u.useState(!1),[,V]=u.useState(0),Q=()=>V(w=>w+1),Z=u.useRef([]),J=u.useRef(new Set),ue=u.useRef(new Set),[te,he]=u.useState([]),[U,de]=u.useState([]),[xe,ae]=u.useState(0),ze=u.useRef(new Map),ie=u.useRef(null),{mode:me}=c,se=u.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),K=se.pipe,G=c.session.token||"",le=me==="client"&&!e;u.useEffect(()=>{if(!G||!K)return;let w=!0;const D=async()=>{const ee=await Di(G);!w||!ee||(de(ee.runs),ae(Date.now()/1e3-ee.now),he(Ne=>Ne.filter(Ee=>!ee.runs.some(Je=>De(Je.company)===De(Ee.name)))))};D();const M=te.length>0||U.some(ee=>ee.status==="running"),_=window.setInterval(()=>{D()},M?8e3:25e3);return()=>{w=!1,window.clearInterval(_)}},[G,K,te.length,U.some(w=>w.status==="running")]);const Se=u.useMemo(()=>{const w=[],D=new Set;for(const M of te){const _=De(M.name);!_||D.has(_)||(D.add(_),w.push({name:M.name,id:M.id,status:"boot",started:M.started,estMin:M.estMin,memoType:"instant"}))}for(const M of U){const _=De(M.company);if(!_||D.has(_))continue;D.add(_);const ee=M.status==="error"?"error":M.status==="done"?"done":"running";w.push({name:M.company,status:ee,started:M.started||0,estMin:M.est_min||(M.memo_type==="detailed"?40:15),url:M.url,error:M.error,memoType:M.memo_type})}return w},[te,U]),ce=w=>Se.find(D=>De(D.name)===De(w))||null,oe=(w,D)=>{he(M=>M.some(_=>De(_.name)===De(w.name))?M:[...M,{name:w.name,id:w.id,started:Date.now()/1e3,estMin:D==="detailed"?40:15}]),J.current.add(w.id),Q()};u.useEffect(()=>{if(document.querySelector(`link[href="${Er}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=Er,document.head.appendChild(w)},[]);const ke=(w,D=!1)=>{R(w),$(D),ie.current&&clearTimeout(ie.current),ie.current=setTimeout(()=>R(""),D?4200:2400)},Fe=w=>ke(w,!0),Re=u.useMemo(()=>{const w=new Map;return c.dossiers.forEach(D=>{D.id&&w.set(D.id,D)}),w},[c.dossiers]),ve=u.useMemo(()=>c.dossiers.filter(w=>Ir(w,g,K)),[c.dossiers,g,K]),Ie=u.useRef(!1);u.useEffect(()=>{if(Ie.current||e||c.loading||!c.dossiers.length)return;if(!se.showFunnel||Ud(c.session.token||"")){Ie.current=!0;return}Ie.current=!0;const w=window.setTimeout(()=>{Sr(c.session.token||""),A(!0)},700);return()=>window.clearTimeout(w)},[e,c.loading,c.dossiers.length,se.showFunnel,c.session.token]);const je=u.useMemo(()=>c.dossiers.filter(w=>ds(w,g,K,c.favIds)),[c.dossiers,g,K,c.favIds]),He=u.useMemo(()=>qi(ve,c.favIds),[ve,c.favIds]),Me=u.useRef(!1);u.useEffect(()=>{if(Me.current)return;if(!K||a==="ops"){Me.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Me.current=!0;return}if(c.loading)return;Me.current=!0;const w=Li(He);w!==g.ptab&&s({type:"ptab",tab:w})},[K,a,n==null?void 0:n.ptab,c.loading,He,g.ptab]);const it=u.useMemo(()=>{const w=Vr(c.dossiers);return w?dt(w)===0?d.tourToday:Wr(w,l):d.tourNoRun},[c.dossiers,d,l]),ct=u.useMemo(()=>c.dossiers.some(w=>!!w.memoUrl||!!w.summary||Mt(w)),[c.dossiers]),[mt,Ze]=u.useState(!1);u.useEffect(()=>{if(c.loading){Ze(!1);return}if(c.dossiers.length>0||c.error){Ze(!0);return}const w=window.setTimeout(()=>Ze(!0),6e3);return()=>window.clearTimeout(w)},[c.loading,c.dossiers.length,c.error]);const ft=(c.marketEstimate||0)>0||typeof((re=c.stats)==null?void 0:re.screened)=="number"&&c.stats.screened>0,xt=u.useMemo(()=>[1,0,2,4,5,3].find(w=>(He[w]||0)>0)??0,[He]),Ke=hn.find(w=>w.key===g.continent),pt=g.continent==="monde"?d.contWorld:(l==="fr"?Ke==null?void 0:Ke.fr:Ke==null?void 0:Ke.en)||"";u.useEffect(()=>{const w=D=>{var _;const M=(((_=D.detail)==null?void 0:_.name)||"").trim();M&&z(null,M)};return window.addEventListener("ppmap:evaluate",w),()=>window.removeEventListener("ppmap:evaluate",w)}),u.useEffect(()=>{const w=D=>{const M=D.detail||{},_=String(M.id||"").trim(),ee=String(M.name||"").trim(),Ne=String(M.url||"").trim(),Ee=_&&Re.get(_)||Pd(c.dossiers,ee,Ne);if(Ee){if(j(null),K){const ge=Te(Ee);typeof ge=="number"&&ge!==g.ptab&&s({type:"ptab",tab:ge})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Ee.id}),(Ee.noCo||["media","nominations","recrutements"].includes(Ee.engine||""))&&(Ee.url||Ee.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee.url||"",text:[Ee.headline,Ee.tagline].filter(Boolean).join(`
`)}})):Ee.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ee.name,url:Ee.url||"",website:Ee.website||"",domain:Ee.domain||""}}));return}!ee&&!Ne||(s({type:"focus",id:_||null}),j({name:ee,headline:String(M.text||"").trim()||ee,url:Ne,card:M.card}),Ne&&(wa(ee)||!ee)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ne,text:String(M.text||"").trim()}})):ee&&!wa(ee)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ee}})))};return window.addEventListener("ppmap:focus",w),()=>window.removeEventListener("ppmap:focus",w)}),u.useEffect(()=>{const w=_=>{const ee={},Ne=String((_==null?void 0:_.sector)||"").trim();Ne&&(ee.sector=[Ne]);const Ee=String((_==null?void 0:_.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ee)&&(ee.day=Ee);const Je=String((_==null?void 0:_.search)||"").trim();Je&&(ee.search=Je);const ge=String((_==null?void 0:_.dealKind)||"").trim();(ge==="ma"||ge==="levee"||ge==="other")&&(ee.dealKind=[ge]),Object.keys(ee).length&&s({type:"filters",patch:ee})},D=_=>w(_.detail),M=_=>{_.data&&_.data.type==="pp-filter"&&w(_.data)};return window.addEventListener("ppmap:filter",D),window.addEventListener("message",M),()=>{window.removeEventListener("ppmap:filter",D),window.removeEventListener("message",M)}},[]),u.useEffect(()=>{const w=D=>{var ee;const M=(((ee=D.detail)==null?void 0:ee.name)||"").trim().toLowerCase();if(!M)return;const _=c.dossiers.find(Ne=>(Ne.name||"").trim().toLowerCase()===M);_&&s(a==="ops"?{type:"focus",id:_.id}:{type:"popup",id:_.id})};return window.addEventListener("ppmap:similar",w),()=>window.removeEventListener("ppmap:similar",w)});const z=(w,D)=>{const M=((w==null?void 0:w.name)||D||"").trim();if(!le){k({kicker:M});return}!M||E||(q(!0),(async()=>{try{let _=M;const ee=((w==null?void 0:w.website)||(w==null?void 0:w.domain)||"").trim();if(ee)_=ee;else try{const ge=await Fr(M);if(ge!=null&&ge.website)_=ge.website;else if(((ge==null?void 0:ge.candidates)||[]).length===1)_=ge.candidates[0].url;else if(((ge==null?void 0:ge.candidates)||[]).length>1){Z.current=[{name:M,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(ge.candidates||[]).slice(0,5)},...Z.current].slice(0,8),Q();return}}catch{}const Ne=await Rr(G,_,"atelier2"),Ee={name:Ne.company||M,verdict:Ne.verdict,reason:Ne.reason||"",remaining:Ne.remaining??null};Z.current=[Ee,...Z.current].slice(0,8),Ne.verdict==="kept"&&T(ge=>({...ge,kept:ge.kept+1})),Ne.verdict==="ruled_out"&&T(ge=>({...ge,dropped:ge.dropped+1}));const Je=w||c.dossiers.find(ge=>(ge.name||"").toLowerCase()===M.toLowerCase());Je&&(Ne.verdict==="kept"?Je.verdict=Je.verdict||"MATCH":Ne.verdict==="ruled_out"&&(Je.verdict="NO MATCH"),Ne.reason&&(Je.reasoning=Ne.reason)),Q()}finally{q(!1)}})())},P=w=>{if(!le){k({kicker:w.name});return}oe(w,"instant"),Ut(G,"fast_request",w.name||"",""),ke(d.memoInstantSent(w.name))},Y=w=>ze.current.get(w.id)??c.thumbs.get((w.name||"").trim().toLowerCase()),ne=(w,D)=>s({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:D}}),ye=async(w,D,M)=>{const _=w.ceoStatus||"";w.ceoStatus=D,Q();const ee=await Da(G,{status:D,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(M==null?void 0:M.note)!==void 0?{note:M.note}:{},...M!=null&&M.via?{via:M.via}:{}});return ee.ok?ee.skipped?(w.ceoStatus=_,Q(),Fe(d.actNotPersisted),!1):((M==null?void 0:M.undo)!==!1&&ne(w,_),M!=null&&M.msg&&ke(M.msg),(D==="Validé"||D==="Écarté")&&!w.ceoNote&&(M==null?void 0:M.note)===void 0&&F({o:w,yes:D==="Validé"}),!0):(w.ceoStatus=_,Q(),Fe(d.actErr),!1)},pe=async(w,D)=>{const M=await Da(G,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:D,via:"note"});return!M.ok||M.skipped?(Fe(M.skipped?d.actNotPersisted:d.actErr),!1):(w.ceoNote=D,Q(),!0)},be=u.useRef(new Map),et=w=>be.current.has(w.id)?be.current.get(w.id):c.stages.get((w.name||"").trim().toLowerCase()),ht=(w,D)=>{be.current.set(w.id,D),Q()},gt=(w,D)=>{le&&ye(w,D?"Validé":"Écarté",{msg:D?d.decidedYes(w.name):d.decidedNo(w.name)})},bt=w=>{le&&ye(w,"À trancher",{msg:d.promoted(w.name)})},Tt=w=>{le&&(async()=>{const D=w.ceoStatus||"";w.ceoStatus="Retenu",Q();const M=await Da(G,{status:"Retenu",check_id:w.checkId,company:w.name});if(!M.ok||M.skipped){w.ceoStatus=D,Q(),Fe(M.skipped?d.actNotPersisted:d.actErr);return}ne(w,D),ke(d.repeched(w.name))})()},qt=()=>{const w=g.undo[g.undo.length-1];if(!w){ke(d.undoNone);return}const D=Re.get(w.id);if(!D){s({type:"undoPop"}),ke(d.undoNone);return}let M=w.prevCeoStatus;if(!M)if((D.verdict||"").toUpperCase().includes("CALL"))M="À trancher";else{ke(d.undoLockedTitle);return}(async()=>await ye(D,M,{undo:!1})&&(s({type:"undoPop"}),D.ceoStatus=w.prevCeoStatus,Q(),ke(d.undoDone(D.name))))()},Ae=w=>{le&&(ue.current.add(w.id),Q(),(async()=>{const D=await Pi(G,w.name,"email");if(!D||D.ok===!1){ue.current.delete(w.id),Q(),Fe(d.actErr);return}Ut(G,"approach",w.name||"",""),ke(d.actApproachSent)})())},vt=(w,D)=>{le&&(async()=>{if(!(await Ut(G,D?"yes":"no",w.name||"","")).ok){Fe(d.actErr);return}ze.current.set(w.id,D?"yes":"no"),Q(),ke(D?d.thumbUpDone:d.thumbDnDone)})()},Qe=w=>{!le||!Mt(w)||(oe(w,"detailed"),Ut(G,"detailed_request",w.name||"",""),ke(d.memoDeepSent(w.name)))},$t=w=>{const D=new Set(c.favIds),M=D.has(w.id);M?D.delete(w.id):D.add(w.id),c.setFavIds(D),le&&Ii(G,{id:w.id,co:w.name},M)},_t=()=>{!le||B||window.confirm(d.identSyncConfirm)&&(W(!0),(async()=>{const w=await Bi(G);W(!1),w?ke(d.identSyncDone):Fe(d.actErr)})())},ra=/proplace/i.test(c.fund||""),Ra=w=>{!le||!ra||(Ut(G,"onboard_request",w.name||"",""),ke(d.onboardSent(w.name)))},O={st:g,dispatch:s,t:d,lang:l,mode:me,caps:se,pipe:K,token:G,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:Tt,thumbOf:Y,canWrite:le,commitStatus:ye,saveNote:pe,stageOf:et,setStage:ht,flashErr:Fe,startTour:()=>A(!0),dossiers:c.dossiers,scopedAll:ve,scoped:je,counts:He,byId:Re,contName:pt,favIds:c.favIds,toggleFav:$t,askEvaluate:z,doAnalyse:P,doDecide:gt,doPromote:bt,doApproach:Ae,doThumb:vt,doDeep:Qe,doUndo:qt,doSync:_t,doOnboard:Ra,outbound:ra,memoQueued:J.current,liveMemos:{items:Se,serverOff:xe,liveOf:ce},approachDone:ue.current,sessTally:N,evalCards:Z.current,evalBusy:E,markRow:y,markedId:v,flash:ke,focusExtra:h};u.useEffect(()=>{const w=D=>{D.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]);const X=w=>G?t.jsx(ps,{token:G,children:w}):t.jsx(t.Fragment,{children:w});return t.jsx(wo.Provider,{value:O,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(G?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Ji}),X(t.jsxs("div",{className:"app"+(K?" pipe":"")+(G?" has-thesis":""),children:[se.showTicker&&t.jsx(tt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(G?" live-stack--cibles":""),children:[t.jsx(bs,{}),!!G&&t.jsx(us,{})]})}),se.showIdent&&t.jsx(tt,{name:"identite",children:t.jsx(Ts,{})}),!1,$d,se.showFunnel&&t.jsx(tt,{name:"entonnoir",children:t.jsx(Vd,{})}),!g.mapFolded&&t.jsx(tt,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(mo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Id,{}),a!=="ops"&&se.showFunnel&&t.jsx(Bd,{}),t.jsx(zl,{}),t.jsx(uo,{})]})]})}),se.showDemand&&K&&t.jsx(tt,{name:"direct",children:t.jsx(Vi,{items:Se,serverOff:xe,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":d.chromeBoth,children:[["eval",d.chromeEval],["filt",d.chromeFilt],["both",d.chromeBoth]].map(([w,D])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===w,onClick:()=>{m(w);try{localStorage.setItem("atl2:chrome-mode",w)}catch{}},children:D},w))}),se.showDemand&&t.jsx(tt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Ml,{})})}),se.showDemand&&g.memoConsole&&t.jsx(tt,{name:"console",children:t.jsx(Dl,{})}),t.jsx(tt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(ld,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(tt,{name:"fiche",children:t.jsx(Vl,{})}),t.jsx(tt,{name:"modales",children:t.jsx(hd,{})}),t.jsx(ws,{}),L&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:L.o.name}),t.jsx(Ss,{placeholder:L.yes?d.whyYesPh:d.whyNoPh,onDone:w=>{const D=L.o;F(null),w&&pe(D,w).then(M=>{M&&ke(d.csNoteSaved)})}})]}),f&&mt&&t.jsx(zs,{steps:Hd(d,it,ct,xt,ft),onClose:()=>{A(!1),Sr(G)}}),t.jsx(_d,{}),se.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:Ur,children:vn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),C&&t.jsx("div",{className:"flash on"+(I?" err":""),children:C}),S&&t.jsx(Fi,{variant:"acquirer",initialCompany:Cr().co,initialWebsite:Cr().site,onClose:()=>k(null)})]})})}function Vd(){const{t:e}=H(),[a,r]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Cr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Wd(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{ko as FlagCell,zt as SigBadge,Fa as SigWin,Kd as default,Wd as fmtShort,H as useV2};
