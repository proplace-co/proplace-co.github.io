...
`,Zi=Ji+Xi;function Ja(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function es(){const e=Ja("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function ts(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=es();return r==="0"?"client":r==="1"||Ja("embed")==="1"&&Ja("chrome")==="1"?"apercu":"client"}const as={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},ns=e=>as[e];function wa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const wt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Lr(a)||wa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Uo(e.cc)})};function Pa(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const rs=60*60*1e3;function os(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>rs?null:a}catch{return null}}function ia(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const is=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function ss(e,a,r="default"){const n=r!=="default",o=u.useMemo(()=>e||n?{mode:"anon"}:Lo(),[e,n]),i=u.useMemo(()=>n?"visiteur":ts(e,o),[e,o,n]),l=u.useMemo(()=>ns(i),[i]),d=i!=="visiteur",c=is(r),[g,s]=u.useState([]),[h,p]=u.useState(""),[v,m]=u.useState(null),[b,y]=u.useState(null),[f,N]=u.useState(null),[S,k]=u.useState(()=>new Map),[j,z]=u.useState(()=>new Map),[E,q]=u.useState(""),[A,R]=u.useState(new Set),[P,B]=u.useState(null),[L,F]=u.useState(!0),[x,T]=u.useState(!1),[I,G]=u.useState(0),[W,Q]=u.useState(0),X=u.useRef(0),K=u.useMemo(()=>{var ee;if(i!=="client")return"";try{return((ee=Fo())==null?void 0:ee.email)||""}catch{return""}},[i]);u.useEffect(()=>{const ee=++X.current;let xe=!0;const U=()=>xe&&ee===X.current,le=(d&&o.token?o.token:"pub:"+a)+(c?":"+c:""),me=os(le);return me?(s(me.objs.map(wt)),me.fund&&p(me.fund),m(me.marketEstimate??null),y(me.criteria??null),N(me.stats??null),q(me.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const Le=await Ma(),te=((Le==null?void 0:Le.recent_ops)||[]).map(pe=>{const he=xa(pe.company_name||pe.title?pe:{...pe,title:(pe.headline_fr||pe.headline||"").slice(0,120)},a),se=String(pe.rubrique||"").toLowerCase();return he&&(se==="nominations"||se==="recrutements")&&(he.engine=se),he&&!String(pe.company_name||"").trim()&&(he.noCo=!0),he}).filter(pe=>!!pe).map(pe=>(Lr((pe.name||"").trim())||(pe.noCo=!0),pe));try{const pe=Ro(),he=await Mo(),se=((he==null?void 0:he.date)||"").slice(0,10),Y=pe?pe.doc:he,ae=Oo(Y),oe=((pe==null?void 0:pe.day)||(Y==null?void 0:Y.date)||se||"").slice(0,10);if(oe&&ae.length){const ge=new Set;for(const Ee of te){if((Ee.date||"").slice(0,10)!==oe)continue;const ne=qn(ae,ge,Ee.name,"");ne>=0&&(ge.add(ne),Ee.decryptHtml=ae[ne].html)}for(const Ee of te){if(Ee.decryptHtml||(Ee.date||"").slice(0,10)!==oe)continue;const ne=qn(ae,ge,"",Ee.headline||Ee.tagline||Ee.name);ne>=0&&(ge.add(ne),Ee.decryptHtml=ae[ne].html)}}if(oe){const ge=((Y==null?void 0:Y.title_fr)||"").trim(),Ee=((Y==null?void 0:Y.lead_fr)||"").trim(),ne=Do(Y),ce=((Y==null?void 0:Y.url)||"").trim();ge&&(ne||ce)&&te.unshift({id:`edito:${oe}`,kind:"op",name:ge,cc:null,date:oe,engine:"edito",dealKind:"other",headline:ge,tagline:Ee||ge,decryptHtml:ne||void 0,url:ce,noCo:!0})}}catch{}if(!U())return;s(te.map(wt)),ia(le,{objs:te})}else if(typeof r=="object"){const te=(await Ln()||[]).filter(he=>(he.slug||"")===r.research).map(he=>Fn(he,a)).filter(he=>!!he),pe=Pa(await Rn(te,a));if(!U())return;s(pe.map(wt)),ia(le,{objs:pe})}else if(d&&o.token){const Le=Po(o.token),te=Ma(),pe=Io(o.token),he=Bo(o.token),se=$o(o.token),Y=await Le;let ae=Y?Y.targets:[];U()&&Y&&(p(Y.fund||""),m(Y.marketEstimate??null),y(Y.criteria??null),N(Y.stats??null),q(Y.generatedAt||""),s(ae.map(wt)),F(!1),T(!1));const[oe,ge,Ee,ne]=await Promise.all([te,pe,he,se]),ce=((oe==null?void 0:oe.recent_ops)||[]).map(qe=>xa(qe,a)).filter(qe=>!!qe);if(ae=[...ae,...ce],!U())return;s(ae.map(wt));const Ie=new Set;for(const qe of ge){const Me=(qe.id||qe.co||"").toString().trim().toLowerCase();Me&&Ie.add(Me.startsWith("t:")?Me:"t:"+Me)}R(Ie),k(Ee),z(ne),Y&&ia(le,{fund:Y.fund,marketEstimate:Y.marketEstimate,criteria:Y.criteria,stats:Y.stats,generatedAt:Y.generatedAt,objs:ae})}else{const Le=_o(),te=Ln(),pe=Ma(),he=await Le;U()&&he.length&&(s(Pa(he).map(wt)),F(!1),T(!1));const[se,Y]=await Promise.all([te,pe]),ae=(se||[]).map(ne=>Fn(ne,a)).filter(ne=>!!ne),oe=await Rn(ae,a),ge=((Y==null?void 0:Y.recent_ops)||[]).map(ne=>xa(ne,a)).filter(ne=>!!ne),Ee=Pa([...he,...oe,...ge]);if(!U())return;s(Ee.map(wt)),ia(le,{objs:Ee})}U()&&T(!1)}catch{U()&&!me&&T(!0)}finally{U()&&F(!1)}})(),()=>{xe=!1}},[d,o.token,a,I,c]),u.useEffect(()=>{if(!l.showCredits||!K){B(null);return}let ee=!0;return(async()=>{try{const xe=await fetch(`${fn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:K})});if(!xe.ok)return;const U=await xe.json();ee&&U&&U.ok!==!1&&B(U)}catch{}})(),()=>{ee=!1}},[l.showCredits,K,W]);const ue=u.useCallback(ee=>R(new Set(ee)),[]);return{session:o,mode:i,caps:l,fund:h,email:K,marketEstimate:v,generatedAt:E,criteria:b,stats:f,thumbs:S,stages:j,dossiers:g,favIds:A,setFavIds:ue,credits:P,reloadCredits:()=>Q(ee=>ee+1),loading:L,error:x,refresh:()=>G(ee=>ee+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Br=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),ls=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Br(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ds=new Set(["signal","amount","score","crible","memo"]);function cs(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Br(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ds.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??$r)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const $r=80;function ka(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Re(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(hn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ct(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Nt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function bn(e,a,r){return We(e)?ka(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ka(e,a.filters,r)}function ps(e,a,r,n){return!(!bn(e,a,r)||r&&!Ho(e,a.ptab,n))}function vn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-ct(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Wo(o);case"memo":return Vo(o);case"signal":{const i=Re(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),d=n(i);return l<d?-a.dir:l>d?a.dir:(o.name||"").localeCompare(i.name||"")})}const Ia={},Hn=(Ia==null?void 0:Ia.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Vn(){return new Date().toISOString().slice(0,10)}const yn=u.createContext(null);function _r(){return u.useContext(yn)}function us(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),l=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function ms(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),l=o.value,d=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(l);!d&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function Wn(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),l=i==="tb-geo"||i==="tb-these"?i:"";[...n.attributes].forEach(d=>n.removeAttribute(d.name)),l&&n.setAttribute("class",l),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Gn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${i} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${i} ${r[1]}`}function Ur(){const e=u.useContext(yn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function fs({token:e,children:a}){const{dispatch:r,st:n,lang:o}=V(),[i,l]=u.useState(()=>n.filters.day||Vn()),[d,c]=u.useState(null),[g,s]=u.useState(!1),h=u.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),p=u.useCallback(()=>{l(Vn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);u.useEffect(()=>{const b=y=>{var N;const f=(N=y.detail)==null?void 0:N.day;typeof f=="string"&&h(f)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[h]),u.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),u.useEffect(()=>{if(!e||!i)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Hn}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{b||c(f)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,i]);const v=u.useMemo(()=>`${Hn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=u.useMemo(()=>({token:e,day:i,ed:d,loading:g,pickDay:h,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:v,isEn:o==="en"}),[e,i,d,g,h,p,n.filters.day,v,o]);return t.jsx(yn.Provider,{value:m,children:a})}function hs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Ur(),[o,i]=u.useState(()=>n||Fr());return u.useEffect(()=>{n&&i(!0)},[n]),u.useEffect(()=>{const l=d=>{var c;return i(!!((c=d.detail)!=null&&c.open))};return window.addEventListener(ya,l),()=>window.removeEventListener(ya,l)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Go,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function xs(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Yn(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Kn(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function gs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Ur(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok,g=u.useRef(null),[s,h]=u.useState("fonds"),[p,v]=u.useState(null),[m,b]=u.useState("idle"),y=u.useRef(!1);u.useEffect(()=>{v(null),b("idle"),y.current=!1,h("fonds")},[e]),u.useEffect(()=>{if(s!=="jour"||y.current)return;y.current=!0;let j=!0;return b("load"),xs(e).then(z=>{j&&(v(z),b("fait"))}),()=>{j=!1}},[s,e]);const f=u.useMemo(()=>ms((p==null?void 0:p.html)||""),[p==null?void 0:p.html]),N=u.useRef(null);u.useEffect(()=>{const j=N.current;if(!j||!f)return;let z=!1;return Wa(()=>import("./fit-BnaWm7z_.js"),[]).then(async E=>{await E.ensureEditoCss(),!(z||!j.isConnected)&&(E.beautifyEditoRows(j),E.mountCardFits(j))}),()=>{z=!0}},[f]);const S=u.useMemo(()=>Wn((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=u.useMemo(()=>Wn((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return u.useEffect(()=>{const j=g.current;if(!j||!S)return;let z=!1;return Wa(()=>import("./fit-BnaWm7z_.js"),[]).then(async E=>{await E.ensureEditoCss(),!(z||!j.isConnected)&&(E.beautifyEditoRows(j),E.mountCardFits(j))}),()=>{z=!0}},[S]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":s==="fonds",onClick:()=>h("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":s==="jour",onClick:()=>h("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),s==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),s==="fonds"&&r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),s==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s==="fonds"&&d&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Yn(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Gn(e,!0)}),"."]}):Yn(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Gn(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>h("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),s==="fonds"&&l&&S?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:S}}):null,s==="fonds"&&l&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,s==="jour"&&(f?t.jsxs(t.Fragment,{children:[(p==null?void 0:p.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:p.title}),t.jsx("div",{ref:N,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Kn(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Kn(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const bs=300,sa=7,vs={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Hr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},ys=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ba(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Jo(r)&&r!=="media")return"news:"+r;const n=Re(e);return n?"sig:"+(n.theme&&Hr.fr[n.theme]?n.theme:"other"):"actualites"}function ws(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:l,fund:d}=V(),c=_r(),g=l==="en",[s,h]=u.useState("all"),[p,v]=u.useState(!1),m=u.useMemo(()=>{var xe;const x=(a.filters.day||"").slice(0,10),T=U=>!(!i&&a.continent!=="monde"&&U.continent!==a.continent||x&&(U.date||"").slice(0,10)!==x),I=e.filter(U=>T(U)&&Re(U)&&(!i||U.kind!=="target"||ze(U)!==5)),G=i&&(((xe=c==null?void 0:c.ed)==null?void 0:xe.ops)||[]).length?c.ed.ops.map(U=>xa(U,l)).filter(U=>!!U).filter(U=>!x||(U.date||"").slice(0,10)===x):[],W=e.filter(U=>T(U)&&U.kind==="op"&&(x?!0:ct(U.date)<=sa)),Q=i?G.length?G:W.filter(U=>{const le=(d||"").trim().toLowerCase();if(!le)return!1;const me=U.match||null;return me?Object.keys(me).map(Le=>Le.trim().toLowerCase()).includes(le):!1}):W,X=x||new Date().toISOString().slice(0,10),K=U=>{const le=Ba(U);return le==="ma"?0:le==="levees"?1:2};Q.sort((U,le)=>{const me=K(U)-K(le);if(me)return me;const Le=(U.date||"").slice(0,10)===X?0:1,te=(le.date||"").slice(0,10)===X?0:1;return Le!==te?Le-te:(le.amountEur||0)-(U.amountEur||0)});const ue=new Set,ee=[];for(const U of[...Q,...vn(I,{key:"signal",dir:-1})]){const le=U.id||U.name;!le||ue.has(le)||(ue.add(le),ee.push(U))}return i&&ee.length===0?e.filter(le=>T(le)&&ct(le.date)<=sa).sort((le,me)=>(me.date||"").localeCompare(le.date||"")).slice(0,80):ee},[e,a.continent,a.filters.day,i,d,l,c]),b=u.useMemo(()=>{const x={};for(const T of m){const I=Ba(T);x[I]=(x[I]||0)+1}return x},[m]),y=u.useMemo(()=>s==="all"?m:m.filter(x=>Ba(x)===s),[m,s]),f=u.useMemo(()=>y.slice(0,bs),[y]),N=y.length-f.length,S=u.useRef(null);u.useEffect(()=>{var Q,X;const x=S.current;if(!x)return;const T=()=>{const K=x.scrollWidth;K<200||(x.style.animationDuration=Math.max(18,Math.round(K/130))+"s")};T();const I=requestAnimationFrame(T),G=window.setTimeout(T,1200);let W=!0;return(X=(Q=document.fonts)==null?void 0:Q.ready)==null||X.then(()=>{W&&T()}),()=>{W=!1,cancelAnimationFrame(I),window.clearTimeout(G)}},[f.length,s]);const k=x=>x==="all"?m.length:b[x]||0,j=x=>{if(x==="all")return g?"All":"Tout";if(x.startsWith("sig:"))return Hr[g?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const T=x.slice(5);return Ko[T]?Qo(T,g?"en":"fr"):x}return vs[g?"en":"fr"][x]},z=[{k:"all"}],E=["ma","levees"].filter(x=>k(x)>0||x===s);if(E.length){z.push({g:g?"Deals":"Opérations"});for(const x of E)z.push({k:x})}const q=["nominations","recrutements"].filter(x=>k(x)>0||x===s),A=Yo.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===s),R=k("actualites")>0||s==="actualites"?["actualites"]:[];if(q.length||A.length||R.length){z.push({g:g?"News":"Actualités"});for(const x of q)z.push({k:x});for(const x of A)z.push({k:x});for(const x of R)z.push({k:x})}const P=ys.map(x=>"sig:"+x).filter(x=>k(x)>0||x===s);if(P.length){z.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of P)z.push({k:x})}const B=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},L=(()=>{const x=(a.filters.day||"").slice(0,10),T=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(g?`LIVE covers the events of ${B(x)}.`:`Le LIVE regroupe les événements du ${B(x)}.`)+T:(g?`LIVE covers the still-open signals and the deals of the last ${sa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${sa} derniers jours.`)+T})(),F=x=>f.map(T=>t.jsxs("button",{type:"button",className:"tk"+($e(T)?" spent":""),onClick:I=>{try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:T.id,name:T.name,url:T.url||"",text:T.tagline||T.headline||"",card:T.card}}))}catch{}if(n({type:"focus",id:T.id}),a.dens!=="liste"){const G=I.currentTarget.getBoundingClientRect();n({type:"popup",id:T.id,anchor:{x:G.left+G.width/2,y:G.bottom}})}},title:T.name+(T.tagline?" — "+T.tagline:""),children:[t.jsx(ft,{o:T}),t.jsxs("span",{className:"who",children:[t.jsx(No,{o:T}),t.jsx("span",{className:"co",children:T.name})]}),typeof T.amountEur=="number"&&T.amountEur>0&&t.jsx("span",{className:"am",children:Yd(T.amountEur)}),T.sector&&t.jsx("span",{className:"mt",children:T.sector}),t.jsx(Fa,{o:T}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(T.id||T.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||v(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>v(x=>!x),children:[j(s),t.jsx("b",{children:k(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:L}),z.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===s,onClick:()=>{h(x.k),v(!1)},children:[j(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:S,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(js,{isEn:g})]})}const ks=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function js({isEn:e}){const[a,r]=u.useState(()=>Fr());u.useEffect(()=>{const o=i=>{var l;return r(!!((l=i.detail)!=null&&l.open))};return window.addEventListener(ya,o),()=>window.removeEventListener(ya,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Xo(!a),children:ks})}const wn="+33 6 83 10 72 86",ja="alexandre@proplace.co",Vr=`tel:${wn.replace(/[^\d+]/g,"")}`;function Ns(){return null}class at extends u.Component{constructor(){super(...arguments);An(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Wr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Qn(e,a){if((ht(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return Wr.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}function Es({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:l}=V(),[d,c]=u.useState(!1),[g,s]=u.useState(""),[h,p]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const v=(e.ceoStatus||"").trim(),m=async b=>{if(g)return;if(b==="Analysé"&&!e.memoUrl){p(!0);return}s(b);const y=(Qn(e,a).find(([N])=>N===b)||[b,b])[1],f=await o(e,b,{msg:a.csMoved(e.name,y)});s(""),f&&(c(!1),p(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(b=>!b),p(!1)},children:[v||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:h?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{i(e),p(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await o(e,"Analysé");s(""),b&&(c(!1),p(!1))})()},children:a.csAnaAnyway})]}):Qn(e,a).map(([b,y])=>t.jsx("button",{type:"button",className:"rsti"+(v===b?" on":"")+(g===b?" busy":""),disabled:!!g,onClick:()=>{m(b)},children:y},b))})]})}function Ss({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=V(),[i,l]=u.useState(""),[d,c]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),s=(ht(e)||"").startsWith("CALL")&&ze(e)===3,h=ze(e)>=2,p=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(m);const b=await o(e,m);l(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},v=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Wr.filter(([m])=>!(h&&m==="Retenu")).map(([m,b])=>[m,a[b]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([m,b])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{p(m)},children:b},m)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Cs,{o:e})]})}function Cs({o:e}){const{t:a,saveNote:r,flash:n}=V(),[o,i]=u.useState(e.ceoNote||""),[l,d]=u.useState(!1),[c,g]=u.useState(!1),s=o.trim()!==(e.ceoNote||"").trim(),h=async()=>{if(l||!s)return;d(!0);const p=await r(e,o.trim());d(!1),p&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:l,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&h()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{h()},children:c?a.csNoteSaved:a.csNoteOk})]})}function zs({placeholder:e,onDone:a}){const{t:r}=V(),[n,o]=u.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function As({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:l,flashErr:d}=V(),[c,g]=u.useState(!1);if(!n.pipe||!o||n.lockActions||ze(e)!==4)return null;const s=i(e),h=(s==null?void 0:s.stage)||"todo",p=async f=>{if(c||f===h)return;g(!0);const N=s;l(e,{stage:f,stamps:(s==null?void 0:s.stamps)||{}});const S=Math.max(Date.now(),Jn+=1);Jn=S;const k=await Zo(r,{company:e.name||"",stage:f,cts:S,deal_id:e.airtableId,check_id:e.checkId});g(!1),!k.stale&&(k.ok||(l(e,N),d(a.actErr)))},v=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,m=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,b=h==="sent"&&v&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,N])=>t.jsx("button",{type:"button",className:"stgb"+(h===f?" on":""),disabled:c,onClick:()=>{p(f)},children:N},f)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let Jn=0;const la=8,da=360;function Xn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Zn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Xn,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Xn,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function Ts({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=V(),[l,d]=u.useState(0),[c,g]=u.useState(null),[s,h]=u.useState([]),p=u.useRef(!1),v=u.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=u.useRef(!1);u.useEffect(()=>{const E=v.current;return()=>{m.current||(n({type:"ptab",tab:E.ptab}),n({type:"dens",dens:E.dens}),n({type:"modal",modal:E.modal}))}},[]),u.useEffect(()=>{p.current||(p.current=!0,h(e.filter(E=>!!document.querySelector(E.need||E.sel))))},[e]);const b=s[l],y=l>=s.length;u.useEffect(()=>{if(b&&(b.ptab!==void 0&&i.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&i.dens!==b.dens&&n({type:"dens",dens:b.dens}),i.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const E=b.click,q=window.setTimeout(()=>{const A=document.querySelector(E);A&&A.getAttribute("aria-selected")!=="true"&&A.click()},60);return()=>window.clearTimeout(q)}},[l,b]);const f=u.useRef(-1),N=u.useCallback(()=>{if(!b){g(null);return}const E=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!E){g(null);return}f.current!==l&&(f.current=l,E.scrollIntoView({block:"nearest",behavior:"smooth"}));const q=E.getBoundingClientRect();g(A=>A&&Math.abs(A.top-q.top)<1&&Math.abs(A.left-q.left)<1&&Math.abs(A.width-q.width)<1&&Math.abs(A.height-q.height)<1?A:q)},[b,l]);u.useLayoutEffect(()=>{N();const E=[90,300,700,1300].map(A=>window.setTimeout(N,A)),q=()=>N();return window.addEventListener("scroll",q,!0),window.addEventListener("resize",q),()=>{E.forEach(A=>window.clearTimeout(A)),window.removeEventListener("scroll",q,!0),window.removeEventListener("resize",q)}},[N]);const S=u.useRef(a);if(S.current=a,u.useEffect(()=>{const E=q=>{q.key==="Escape"?(q.preventDefault(),q.stopPropagation(),S.current()):q.key==="ArrowRight"?d(A=>A+1):q.key==="ArrowLeft"&&d(A=>Math.max(0,A-1))};return document.addEventListener("keydown",E,!0),()=>document.removeEventListener("keydown",E,!0)},[]),!s.length)return null;let k=null;const j=E=>()=>{m.current=!0,n({type:"modal",modal:null}),E()};if(y){const E=o[3]||0;E>0?k={title:E===1?r.ahaATitle1:r.ahaATitleN(E),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let z={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:da};if(!y&&c){const E=c.bottom+14,A=window.innerHeight-E>190?E:Math.max(12,c.top-200);z={left:Math.min(Math.max(12,c.left+c.width/2-da/2),window.innerWidth-da-12),top:A,width:da}}return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-la,top:c.top-la,width:c.width+la*2,height:c.height+la*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:z,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Zn,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Zn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(E=>Math.max(0,E-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(E=>E+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Gr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Yr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function qs(){var q,A;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:l,data:d,dispatch:c}=V(),g=r?a:e,s=u.useMemo(()=>g.filter(R=>ct(R.date)===0&&R.kind==="target"),[g]),h=u.useMemo(()=>r?a.filter(R=>R.kind==="target"&&ze(R)===0).slice().sort((R,P)=>(P.date||"").localeCompare(R.date||"")):[],[a,r]),p=u.useMemo(()=>s.filter(R=>r?ze(R)===0:!$e(R)),[s,r]),v=r?h:p,m=r?a.length-h.length:s.length-p.length,b=r?a.length:s.length,y=b?Math.min(100,m/b*100):100,f=u.useMemo(()=>Gr(g),[g]),N=!!f&&ct(f)>0,S=u.useMemo(()=>N?g.filter(R=>(R.date||"").slice(0,10)===f):[],[g,f,N]),k=typeof((q=d.stats)==null?void 0:q.kept_today)=="number"?d.stats.kept_today:null,j=typeof((A=d.stats)==null?void 0:A.screened_today)=="number"?d.stats.screened_today:s.length;let z;N?z=o.morningLast(S.length,h.length,Yr(f,l)):r?z=o.morningThesis(j,h.length,k):s.length?m===0?z=o.goalSourced(s.length):m>=s.length?z=o.goalCleared:z=o.goalDone(m,s.length):z=o.goalSourced(0);const E=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&h.length&&c({type:"chainStart",queue:h.map(R=>R.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:z}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),v.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:E,children:r?o.morningEval(v.length):i.pileMode?o.goalContinue(v.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ls(){var I,G;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:l,dossiers:d,mode:c,doSync:g,startTour:s,flash:h,flashErr:p}=V(),[v,m]=u.useState(null),[b,y]=u.useState(!0),[f,N]=u.useState([]),S=c==="client";u.useEffect(()=>{if(!o||!i)return;let W=!0;return y(!0),(async()=>{const[Q,X]=await Promise.all([xn(i),Rr(o)]);W&&(Q&&m(Q),y(!1),N(X))})(),()=>{W=!1}},[o,i]);const[k,j]=u.useState(!1),z=()=>{!S||k||!i||(j(!0),ei(i).then(W=>{j(!1),W?h(e.identRepubDone):p(e.actErr)}))},E=(v==null?void 0:v.per_day)??null,q=((I=v==null?void 0:v.pool_order)==null?void 0:I.length)??0,A=f.filter(W=>W.status==="running").length,R=u.useMemo(()=>d.filter(W=>W.kind==="target"&&$e(W)).length,[d]),P=l.marketEstimate,B=typeof((G=l.stats)==null?void 0:G.screened)=="number"?l.stats.screened:R,L=P&&P>0?Math.min(100,Math.round(B/P*100)):null,F=W=>W.toLocaleString(a==="en"?"en-US":"fr-FR"),x=(i||"P").split(/\s+/).map(W=>W[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const W=Date.parse(l.generatedAt||"");if(Number.isNaN(W))return"";const Q=new Date(W),X=K=>String(K).padStart(2,"0");return`${X(Q.getDate())}/${X(Q.getMonth()+1)} à ${X(Q.getHours())}:${X(Q.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?x:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),T?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(T)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&B>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:F(B)})})]}),L!==null&&P&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(B,P)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),E!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:E})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),E===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),A>0&&t.jsxs("span",{className:"ev",children:["⏳ ",A]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(q)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:W=>{W.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!S||k,onClick:z,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!S,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:W=>n({type:"filters",patch:{search:W.target.value}})})]})]})]})}class St{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],l=a+i,d=Math.abs(a)<Math.abs(i)?a-(l-i):i-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,o=a[--r],l=n+o,i=o-(l-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=l+o,o==n-l&&(l=n))}return l}}function*Fs(e){for(const a of e)yield*a}function Kr(e){return Array.from(Fs(e))}var ke=1e-6,fe=Math.PI,Ye=fe/2,er=fe/4,Qe=fe*2,lt=180/fe,Ue=fe/180,Se=Math.abs,Rs=Math.atan,Jt=Math.atan2,Ae=Math.cos,Te=Math.sin,Ms=Math.sign||function(e){return e>0?1:e<0?-1:0},At=Math.sqrt;function Os(e){return e>1?0:e<-1?fe:Math.acos(e)}function Xt(e){return e>1?Ye:e<-1?-Ye:Math.asin(e)}function Ke(){}function Na(e,a){e&&ar.hasOwnProperty(e.type)&&ar[e.type](e,a)}var tr={Feature:function(e,a){Na(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Na(r[n].geometry,a)}},ar={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Xa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Xa(r[n],a,0)},Polygon:function(e,a){nr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)nr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Na(r[n],a)}};function Xa(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function nr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Xa(e[r],a,1);a.polygonEnd()}function qt(e,a){e&&tr.hasOwnProperty(e.type)?tr[e.type](e,a):Na(e,a)}function Za(e){return[Jt(e[1],e[0]),Xt(e[2])]}function Mt(e){var a=e[0],r=e[1],n=Ae(r);return[n*Ae(a),n*Te(a),Te(r)]}function ca(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ea(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function $a(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function pa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function en(e){var a=At(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function tn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function an(e,a){return Se(e)>fe&&(e-=Math.round(e/Qe)*Qe),[e,a]}an.invert=an;function Ds(e,a,r){return(e%=Qe)?a||r?tn(or(e),ir(a,r)):or(e):a||r?ir(a,r):an}function rr(e){return function(a,r){return a+=e,Se(a)>fe&&(a-=Math.round(a/Qe)*Qe),[a,r]}}function or(e){var a=rr(e);return a.invert=rr(-e),a}function ir(e,a){var r=Ae(e),n=Te(e),o=Ae(a),i=Te(a);function l(d,c){var g=Ae(c),s=Ae(d)*g,h=Te(d)*g,p=Te(c),v=p*r+s*n;return[Jt(h*o-v*i,s*r-p*n),Xt(v*o+h*i)]}return l.invert=function(d,c){var g=Ae(c),s=Ae(d)*g,h=Te(d)*g,p=Te(c),v=p*o-h*i;return[Jt(h*o+p*i,s*r+v*n),Xt(v*r-s*n)]},l}function Ps(e,a,r,n,o,i){if(r){var l=Ae(a),d=Te(a),c=n*r;o==null?(o=a+n*Qe,i=a-c/2):(o=sr(l,o),i=sr(l,i),(n>0?o<i:o>i)&&(o+=n*Qe));for(var g,s=o;n>0?s>i:s<i;s-=c)g=Za([l,-d*Ae(s),-d*Te(s)]),e.point(g[0],g[1])}}function sr(e,a){a=Mt(a),a[0]-=e,en(a);var r=Os(-a[1]);return((-a[2]<0?-r:r)+Qe-ke)%Qe}function Qr(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Ke,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ga(e,a){return Se(e[0]-a[0])<ke&&Se(e[1]-a[1])<ke}function ua(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Jr(e,a,r,n,o){var i=[],l=[],d,c;if(e.forEach(function(m){if(!((b=m.length-1)<=0)){var b,y=m[0],f=m[b],N;if(ga(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),d=0;d<b;++d)o.point((y=m[d])[0],y[1]);o.lineEnd();return}f[0]+=2*ke}i.push(N=new ua(y,m,null,!0)),l.push(N.o=new ua(y,null,N,!1)),i.push(N=new ua(f,m,null,!1)),l.push(N.o=new ua(f,null,N,!0))}}),!!i.length){for(l.sort(a),lr(i),lr(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var g=i[0],s,h;;){for(var p=g,v=!0;p.v;)if((p=p.n)===g)return;s=p.z,o.lineStart();do{if(p.v=p.o.v=!0,p.e){if(v)for(d=0,c=s.length;d<c;++d)o.point((h=s[d])[0],h[1]);else n(p.x,p.n.x,1,o);p=p.n}else{if(v)for(s=p.p.z,d=s.length-1;d>=0;--d)o.point((h=s[d])[0],h[1]);else n(p.x,p.p.x,-1,o);p=p.p}p=p.o,s=p.z,v=!v}while(!p.v);o.lineEnd()}}}function lr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function _a(e){return Se(e[0])<=fe?e[0]:Ms(e[0])*((Se(e[0])+fe)%Qe-fe)}function Is(e,a){var r=_a(a),n=a[1],o=Te(n),i=[Te(r),-Ae(r),0],l=0,d=0,c=new St;o===1?n=Ye+ke:o===-1&&(n=-Ye-ke);for(var g=0,s=e.length;g<s;++g)if(p=(h=e[g]).length)for(var h,p,v=h[p-1],m=_a(v),b=v[1]/2+er,y=Te(b),f=Ae(b),N=0;N<p;++N,m=k,y=z,f=E,v=S){var S=h[N],k=_a(S),j=S[1]/2+er,z=Te(j),E=Ae(j),q=k-m,A=q>=0?1:-1,R=A*q,P=R>fe,B=y*z;if(c.add(Jt(B*A*Te(R),f*E+B*Ae(R))),l+=P?q+A*Qe:q,P^m>=r^k>=r){var L=Ea(Mt(v),Mt(S));en(L);var F=Ea(i,L);en(F);var x=(P^q>=0?-1:1)*Xt(F[2]);(n>x||n===x&&(L[0]||L[1]))&&(d+=P^q>=0?1:-1)}}return(l<-ke||l<ke&&c<-1e-12)^d&1}function Xr(e,a,r,n){return function(o){var i=a(o),l=Qr(),d=a(l),c=!1,g,s,h,p={point:v,lineStart:b,lineEnd:y,polygonStart:function(){p.point=f,p.lineStart=N,p.lineEnd=S,s=[],g=[]},polygonEnd:function(){p.point=v,p.lineStart=b,p.lineEnd=y,s=Kr(s);var k=Is(g,n);s.length?(c||(o.polygonStart(),c=!0),Jr(s,$s,k,r,o)):k&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),s=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function v(k,j){e(k,j)&&o.point(k,j)}function m(k,j){i.point(k,j)}function b(){p.point=m,i.lineStart()}function y(){p.point=v,i.lineEnd()}function f(k,j){h.push([k,j]),d.point(k,j)}function N(){d.lineStart(),h=[]}function S(){f(h[0][0],h[0][1]),d.lineEnd();var k=d.clean(),j=l.result(),z,E=j.length,q,A,R;if(h.pop(),g.push(h),h=null,!!E){if(k&1){if(A=j[0],(q=A.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),z=0;z<q;++z)o.point((R=A[z])[0],R[1]);o.lineEnd()}return}E>1&&k&2&&j.push(j.pop().concat(j.shift())),s.push(j.filter(Bs))}}return p}}function Bs(e){return e.length>1}function $s(e,a){return((e=e.x)[0]<0?e[1]-Ye-ke:Ye-e[1])-((a=a.x)[0]<0?a[1]-Ye-ke:Ye-a[1])}const dr=Xr(function(){return!0},_s,Hs,[-fe,-Ye]);function _s(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,l){var d=i>0?fe:-fe,c=Se(i-a);Se(c-fe)<ke?(e.point(a,r=(r+l)/2>0?Ye:-Ye),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(i,r),o=0):n!==d&&c>=fe&&(Se(a-n)<ke&&(a-=n*ke),Se(i-d)<ke&&(i-=d*ke),r=Us(a,r,i,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),o=0),e.point(a=i,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Us(e,a,r,n){var o,i,l=Te(e-r);return Se(l)>ke?Rs((Te(a)*(i=Ae(n))*Te(r)-Te(n)*(o=Ae(a))*Te(e))/(o*i*l)):(a+n)/2}function Hs(e,a,r,n){var o;if(e==null)o=r*Ye,n.point(-fe,o),n.point(0,o),n.point(fe,o),n.point(fe,0),n.point(fe,-o),n.point(0,-o),n.point(-fe,-o),n.point(-fe,0),n.point(-fe,o);else if(Se(e[0]-a[0])>ke){var i=e[0]<a[0]?fe:-fe;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Vs(e){var a=Ae(e),r=2*Ue,n=a>0,o=Se(a)>ke;function i(s,h,p,v){Ps(v,e,r,p,s,h)}function l(s,h){return Ae(s)*Ae(h)>a}function d(s){var h,p,v,m,b;return{lineStart:function(){m=v=!1,b=1},point:function(y,f){var N=[y,f],S,k=l(y,f),j=n?k?0:g(y,f):k?g(y+(y<0?fe:-fe),f):0;if(!h&&(m=v=k)&&s.lineStart(),k!==v&&(S=c(h,N),(!S||ga(h,S)||ga(N,S))&&(N[2]=1)),k!==v)b=0,k?(s.lineStart(),S=c(N,h),s.point(S[0],S[1])):(S=c(h,N),s.point(S[0],S[1],2),s.lineEnd()),h=S;else if(o&&h&&n^k){var z;!(j&p)&&(z=c(N,h,!0))&&(b=0,n?(s.lineStart(),s.point(z[0][0],z[0][1]),s.point(z[1][0],z[1][1]),s.lineEnd()):(s.point(z[1][0],z[1][1]),s.lineEnd(),s.lineStart(),s.point(z[0][0],z[0][1],3)))}k&&(!h||!ga(h,N))&&s.point(N[0],N[1]),h=N,v=k,p=j},lineEnd:function(){v&&s.lineEnd(),h=null},clean:function(){return b|(m&&v)<<1}}}function c(s,h,p){var v=Mt(s),m=Mt(h),b=[1,0,0],y=Ea(v,m),f=ca(y,y),N=y[0],S=f-N*N;if(!S)return!p&&s;var k=a*f/S,j=-a*N/S,z=Ea(b,y),E=pa(b,k),q=pa(y,j);$a(E,q);var A=z,R=ca(E,A),P=ca(A,A),B=R*R-P*(ca(E,E)-1);if(!(B<0)){var L=At(B),F=pa(A,(-R-L)/P);if($a(F,E),F=Za(F),!p)return F;var x=s[0],T=h[0],I=s[1],G=h[1],W;T<x&&(W=x,x=T,T=W);var Q=T-x,X=Se(Q-fe)<ke,K=X||Q<ke;if(!X&&G<I&&(W=I,I=G,G=W),K?X?I+G>0^F[1]<(Se(F[0]-x)<ke?I:G):I<=F[1]&&F[1]<=G:Q>fe^(x<=F[0]&&F[0]<=T)){var ue=pa(A,(-R+L)/P);return $a(ue,E),[F,Za(ue)]}}}function g(s,h){var p=n?e:fe-e,v=0;return s<-p?v|=1:s>p&&(v|=2),h<-p?v|=4:h>p&&(v|=8),v}return Xr(l,d,i,n?[0,-e]:[-fe,e-fe])}function Ws(e,a,r,n,o,i){var l=e[0],d=e[1],c=a[0],g=a[1],s=0,h=1,p=c-l,v=g-d,m;if(m=r-l,!(!p&&m>0)){if(m/=p,p<0){if(m<s)return;m<h&&(h=m)}else if(p>0){if(m>h)return;m>s&&(s=m)}if(m=o-l,!(!p&&m<0)){if(m/=p,p<0){if(m>h)return;m>s&&(s=m)}else if(p>0){if(m<s)return;m<h&&(h=m)}if(m=n-d,!(!v&&m>0)){if(m/=v,v<0){if(m<s)return;m<h&&(h=m)}else if(v>0){if(m>h)return;m>s&&(s=m)}if(m=i-d,!(!v&&m<0)){if(m/=v,v<0){if(m>h)return;m>s&&(s=m)}else if(v>0){if(m<s)return;m<h&&(h=m)}return s>0&&(e[0]=l+s*p,e[1]=d+s*v),h<1&&(a[0]=l+h*p,a[1]=d+h*v),!0}}}}}var Ht=1e9,ma=-Ht;function Gs(e,a,r,n){function o(g,s){return e<=g&&g<=r&&a<=s&&s<=n}function i(g,s,h,p){var v=0,m=0;if(g==null||(v=l(g,h))!==(m=l(s,h))||c(g,s)<0^h>0)do p.point(v===0||v===3?e:r,v>1?n:a);while((v=(v+h+4)%4)!==m);else p.point(s[0],s[1])}function l(g,s){return Se(g[0]-e)<ke?s>0?0:3:Se(g[0]-r)<ke?s>0?2:1:Se(g[1]-a)<ke?s>0?1:0:s>0?3:2}function d(g,s){return c(g.x,s.x)}function c(g,s){var h=l(g,1),p=l(s,1);return h!==p?h-p:h===0?s[1]-g[1]:h===1?g[0]-s[0]:h===2?g[1]-s[1]:s[0]-g[0]}return function(g){var s=g,h=Qr(),p,v,m,b,y,f,N,S,k,j,z,E={point:q,lineStart:B,lineEnd:L,polygonStart:R,polygonEnd:P};function q(x,T){o(x,T)&&s.point(x,T)}function A(){for(var x=0,T=0,I=v.length;T<I;++T)for(var G=v[T],W=1,Q=G.length,X=G[0],K,ue,ee=X[0],xe=X[1];W<Q;++W)K=ee,ue=xe,X=G[W],ee=X[0],xe=X[1],ue<=n?xe>n&&(ee-K)*(n-ue)>(xe-ue)*(e-K)&&++x:xe<=n&&(ee-K)*(n-ue)<(xe-ue)*(e-K)&&--x;return x}function R(){s=h,p=[],v=[],z=!0}function P(){var x=A(),T=z&&x,I=(p=Kr(p)).length;(T||I)&&(g.polygonStart(),T&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),I&&Jr(p,d,x,i,g),g.polygonEnd()),s=g,p=v=m=null}function B(){E.point=F,v&&v.push(m=[]),j=!0,k=!1,N=S=NaN}function L(){p&&(F(b,y),f&&k&&h.rejoin(),p.push(h.result())),E.point=q,k&&s.lineEnd()}function F(x,T){var I=o(x,T);if(v&&m.push([x,T]),j)b=x,y=T,f=I,j=!1,I&&(s.lineStart(),s.point(x,T));else if(I&&k)s.point(x,T);else{var G=[N=Math.max(ma,Math.min(Ht,N)),S=Math.max(ma,Math.min(Ht,S))],W=[x=Math.max(ma,Math.min(Ht,x)),T=Math.max(ma,Math.min(Ht,T))];Ws(G,W,e,a,r,n)?(k||(s.lineStart(),s.point(G[0],G[1])),s.point(W[0],W[1]),I||s.lineEnd(),z=!1):I&&(s.lineStart(),s.point(x,T),z=!1)}N=x,S=T,k=I}return E}}const nn=e=>e;var Ua=new St,rn=new St,Zr,eo,on,sn,dt={point:Ke,lineStart:Ke,lineEnd:Ke,polygonStart:function(){dt.lineStart=Ys,dt.lineEnd=Qs},polygonEnd:function(){dt.lineStart=dt.lineEnd=dt.point=Ke,Ua.add(Se(rn)),rn=new St},result:function(){var e=Ua/2;return Ua=new St,e}};function Ys(){dt.point=Ks}function Ks(e,a){dt.point=to,Zr=on=e,eo=sn=a}function to(e,a){rn.add(sn*e-on*a),on=e,sn=a}function Qs(){to(Zr,eo)}var Ot=1/0,Sa=Ot,Zt=-Ot,Ca=Zt,za={point:Js,lineStart:Ke,lineEnd:Ke,polygonStart:Ke,polygonEnd:Ke,result:function(){var e=[[Ot,Sa],[Zt,Ca]];return Zt=Ca=-(Sa=Ot=1/0),e}};function Js(e,a){e<Ot&&(Ot=e),e>Zt&&(Zt=e),a<Sa&&(Sa=a),a>Ca&&(Ca=a)}var ln=0,dn=0,Vt=0,Aa=0,Ta=0,Lt=0,cn=0,pn=0,Wt=0,ao,no,ot,it,Ge={point:Ct,lineStart:cr,lineEnd:pr,polygonStart:function(){Ge.lineStart=el,Ge.lineEnd=tl},polygonEnd:function(){Ge.point=Ct,Ge.lineStart=cr,Ge.lineEnd=pr},result:function(){var e=Wt?[cn/Wt,pn/Wt]:Lt?[Aa/Lt,Ta/Lt]:Vt?[ln/Vt,dn/Vt]:[NaN,NaN];return ln=dn=Vt=Aa=Ta=Lt=cn=pn=Wt=0,e}};function Ct(e,a){ln+=e,dn+=a,++Vt}function cr(){Ge.point=Xs}function Xs(e,a){Ge.point=Zs,Ct(ot=e,it=a)}function Zs(e,a){var r=e-ot,n=a-it,o=At(r*r+n*n);Aa+=o*(ot+e)/2,Ta+=o*(it+a)/2,Lt+=o,Ct(ot=e,it=a)}function pr(){Ge.point=Ct}function el(){Ge.point=al}function tl(){ro(ao,no)}function al(e,a){Ge.point=ro,Ct(ao=ot=e,no=it=a)}function ro(e,a){var r=e-ot,n=a-it,o=At(r*r+n*n);Aa+=o*(ot+e)/2,Ta+=o*(it+a)/2,Lt+=o,o=it*e-ot*a,cn+=o*(ot+e),pn+=o*(it+a),Wt+=o*3,Ct(ot=e,it=a)}function oo(e){this._context=e}oo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Qe);break}}},result:Ke};var un=new St,Ha,io,so,Gt,Yt,ea={point:Ke,lineStart:function(){ea.point=nl},lineEnd:function(){Ha&&lo(io,so),ea.point=Ke},polygonStart:function(){Ha=!0},polygonEnd:function(){Ha=null},result:function(){var e=+un;return un=new St,e}};function nl(e,a){ea.point=lo,io=Gt=e,so=Yt=a}function lo(e,a){Gt-=e,Yt-=a,un.add(At(Gt*Gt+Yt*Yt)),Gt=e,Yt=a}let ur,qa,mr,fr;class hr{constructor(a){this._append=a==null?co:rl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==mr||this._append!==qa){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,mr=n,qa=this._append,fr=this._,this._=o}this._+=fr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function co(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function rl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return co;if(a!==ur){const r=10**a;ur=a,qa=function(o){let i=1;this._+=o[0];for(const l=o.length;i<l;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return qa}function ol(e,a){let r=3,n=4.5,o,i;function l(d){return d&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),qt(d,o(i))),i.result()}return l.area=function(d){return qt(d,o(dt)),dt.result()},l.measure=function(d){return qt(d,o(ea)),ea.result()},l.bounds=function(d){return qt(d,o(za)),za.result()},l.centroid=function(d){return qt(d,o(Ge)),Ge.result()},l.projection=function(d){return arguments.length?(o=d==null?(e=null,nn):(e=d).stream,l):e},l.context=function(d){return arguments.length?(i=d==null?(a=null,new hr(r)):new oo(a=d),typeof n!="function"&&i.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(i.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(i=new hr(r)),l},l.projection(e).digits(r).context(a)}function kn(e){return function(a){var r=new mn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function mn(){}mn.prototype={constructor:mn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function jn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),qt(r,e.stream(za)),a(za.result()),n!=null&&e.clipExtent(n),e}function po(e,a,r){return jn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],l=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),d=+a[0][0]+(o-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function il(e,a,r){return po(e,[[0,0],a],r)}function sl(e,a,r){return jn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),l=(o-i*(n[1][0]+n[0][0]))/2,d=-i*n[0][1];e.scale(150*i).translate([l,d])},r)}function ll(e,a,r){return jn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),l=-i*n[0][0],d=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,d])},r)}var xr=16,dl=Ae(30*Ue);function gr(e,a){return+a?pl(e,a):cl(e)}function cl(e){return kn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function pl(e,a){function r(n,o,i,l,d,c,g,s,h,p,v,m,b,y){var f=g-n,N=s-o,S=f*f+N*N;if(S>4*a&&b--){var k=l+p,j=d+v,z=c+m,E=At(k*k+j*j+z*z),q=Xt(z/=E),A=Se(Se(z)-1)<ke||Se(i-h)<ke?(i+h)/2:Jt(j,k),R=e(A,q),P=R[0],B=R[1],L=P-n,F=B-o,x=N*L-f*F;(x*x/S>a||Se((f*L+N*F)/S-.5)>.3||l*p+d*v+c*m<dl)&&(r(n,o,i,l,d,c,P,B,A,k/=E,j/=E,z,b,y),y.point(P,B),r(P,B,A,k,j,z,g,s,h,p,v,m,b,y))}}return function(n){var o,i,l,d,c,g,s,h,p,v,m,b,y={point:f,lineStart:N,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=j},polygonEnd:function(){n.polygonEnd(),y.lineStart=N}};function f(q,A){q=e(q,A),n.point(q[0],q[1])}function N(){h=NaN,y.point=S,n.lineStart()}function S(q,A){var R=Mt([q,A]),P=e(q,A);r(h,p,s,v,m,b,h=P[0],p=P[1],s=q,v=R[0],m=R[1],b=R[2],xr,n),n.point(h,p)}function k(){y.point=f,n.lineEnd()}function j(){N(),y.point=z,y.lineEnd=E}function z(q,A){S(o=q,A),i=h,l=p,d=v,c=m,g=b,y.point=S}function E(){r(h,p,s,v,m,b,i,l,o,d,c,g,xr,n),y.lineEnd=k,k()}return y}}var ul=kn({point:function(e,a){this.stream.point(e*Ue,a*Ue)}});function ml(e){return kn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function fl(e,a,r,n,o){function i(l,d){return l*=n,d*=o,[a+e*l,r-e*d]}return i.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*o]},i}function br(e,a,r,n,o,i){if(!i)return fl(e,a,r,n,o);var l=Ae(i),d=Te(i),c=l*e,g=d*e,s=l/e,h=d/e,p=(d*r-l*a)/e,v=(d*a+l*r)/e;function m(b,y){return b*=n,y*=o,[c*b-g*y+a,r-g*b-c*y]}return m.invert=function(b,y){return[n*(s*b-h*y+p),o*(v-h*b-s*y)]},m}function hl(e){return xl(function(){return e})()}function xl(e){var a,r=150,n=480,o=250,i=0,l=0,d=0,c=0,g=0,s,h=0,p=1,v=1,m=null,b=dr,y=null,f,N,S,k=nn,j=.5,z,E,q,A,R;function P(x){return q(x[0]*Ue,x[1]*Ue)}function B(x){return x=q.invert(x[0],x[1]),x&&[x[0]*lt,x[1]*lt]}P.stream=function(x){return A&&R===x?A:A=ul(ml(s)(b(z(k(R=x)))))},P.preclip=function(x){return arguments.length?(b=x,m=void 0,F()):b},P.postclip=function(x){return arguments.length?(k=x,y=f=N=S=null,F()):k},P.clipAngle=function(x){return arguments.length?(b=+x?Vs(m=x*Ue):(m=null,dr),F()):m*lt},P.clipExtent=function(x){return arguments.length?(k=x==null?(y=f=N=S=null,nn):Gs(y=+x[0][0],f=+x[0][1],N=+x[1][0],S=+x[1][1]),F()):y==null?null:[[y,f],[N,S]]},P.scale=function(x){return arguments.length?(r=+x,L()):r},P.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],L()):[n,o]},P.center=function(x){return arguments.length?(i=x[0]%360*Ue,l=x[1]%360*Ue,L()):[i*lt,l*lt]},P.rotate=function(x){return arguments.length?(d=x[0]%360*Ue,c=x[1]%360*Ue,g=x.length>2?x[2]%360*Ue:0,L()):[d*lt,c*lt,g*lt]},P.angle=function(x){return arguments.length?(h=x%360*Ue,L()):h*lt},P.reflectX=function(x){return arguments.length?(p=x?-1:1,L()):p<0},P.reflectY=function(x){return arguments.length?(v=x?-1:1,L()):v<0},P.precision=function(x){return arguments.length?(z=gr(E,j=x*x),F()):At(j)},P.fitExtent=function(x,T){return po(P,x,T)},P.fitSize=function(x,T){return il(P,x,T)},P.fitWidth=function(x,T){return sl(P,x,T)},P.fitHeight=function(x,T){return ll(P,x,T)};function L(){var x=br(r,0,0,p,v,h).apply(null,a(i,l)),T=br(r,n-x[0],o-x[1],p,v,h);return s=Ds(d,c,g),E=tn(a,T),q=tn(s,E),z=gr(E,j),F()}function F(){return A=R=null,P}return function(){return a=e.apply(this,arguments),P.invert=a.invert&&B,L()}}function uo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}uo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,l=i*i;r-=o=(r*(1.007226+i*(.015085+l*(-.044475+.028874*i-.005916*l)))-a)/(1.007226+i*(.015085*3+l*(-.044475*7+.028874*9*i-.005916*11*l)))}while(Se(o)>ke&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function gl(){return hl(uo).scale(175.295)}function bl(e){return e}function vl(e){if(e==null)return bl;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var g=2,s=d.length,h=new Array(s);for(h[0]=(a+=d[0])*n+i,h[1]=(r+=d[1])*o+l;g<s;)h[g]=d[g],++g;return h}}function yl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function wl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return vr(e,r)})}:vr(e,a)}function vr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=kl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function kl(e,a){var r=vl(e.transform),n=e.arcs;function o(s,h){h.length&&h.pop();for(var p=n[s<0?~s:s],v=0,m=p.length;v<m;++v)h.push(r(p[v],v));s<0&&yl(h,m)}function i(s){return r(s)}function l(s){for(var h=[],p=0,v=s.length;p<v;++p)o(s[p],h);return h.length<2&&h.push(h[0]),h}function d(s){for(var h=l(s);h.length<4;)h.push(h[0]);return h}function c(s){return s.map(d)}function g(s){var h=s.type,p;switch(h){case"GeometryCollection":return{type:h,geometries:s.geometries.map(g)};case"Point":p=i(s.coordinates);break;case"MultiPoint":p=s.coordinates.map(i);break;case"LineString":p=l(s.arcs);break;case"MultiLineString":p=s.arcs.map(l);break;case"Polygon":p=c(s.arcs);break;case"MultiPolygon":p=s.arcs.map(c);break;default:return null}return{type:h,coordinates:p}}return g(a)}const mo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},jl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Nl(e,a,r){const n=mo[e];if(!n||!n.length)return-1;const o=jl(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(l=>o.includes(l)))return i}return Math.floor(r*n.length)%n.length}let fa=null;function El(){return fa||(fa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=wl(r,n),i=gl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=ol(i),d=(o.features||[]).filter(s=>{var h;return(((h=s.properties)==null?void 0:h.name)||"")!=="Antarctica"}).map(s=>{var v;const h=((v=s.properties)==null?void 0:v.name)||"",p=l(s)||"";return p?{i2:ti(h)||null,n:h,d:p}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,h]of Object.entries(ai)){const p=i(h);p&&(c[s]={x:p[0],y:p[1]})}const g={};for(const[s,h]of Object.entries(mo)){const p=h.map(v=>i(v.ll)).filter(v=>!!v).map(([v,m])=>({x:v,y:m}));p.length&&(g[s]=p)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:d,anchors:c,metros:g}}catch{return null}})(),fa)}function Sl(e){const[a,r]=u.useState(null);return u.useEffect(()=>{if(!e||a)return;let n=!1;return El().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Cl="8 40 984 210",zl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},yr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function wr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Al(e,a){const[r,n]=u.useState(1);return u.useEffect(()=>{let o=!0,i=0;const l=()=>{var g;if(!o)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{o=!1,cancelAnimationFrame(i),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function kr({msgs:e}){const[a,r]=u.useState(0);u.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],l)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Tl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:l,lang:d,t:c,data:g,dossiers:s,source:h}=V(),p=g.loading&&!s.length,v=u.useRef(null),m=u.useRef(null),b=Sl(e.continent==="monde"),y=e.continent==="monde"?b:gn.find(x=>x.key===e.continent)||null,f=Al(v,e.continent+":"+e.mapFolded+":"+!!y),[N,S]=u.useState(new Map),[k,j]=u.useState(null);u.useEffect(()=>{const x=v.current;if(!x)return;const T=new Map;x.querySelectorAll("path[data-i2]").forEach(I=>{const G=I.dataset.i2;if(G)try{const W=I.getBBox();W.width>0&&T.set(G,{x:W.x,y:W.y,w:W.width,h:W.height})}catch{}}),S(T)},[e.continent,f,y]);const z=u.useMemo(()=>r.filter(x=>x.cc),[r]),E=u.useMemo(()=>{const x=new Map;return z.forEach(T=>x.set(T.cc,(x.get(T.cc)||0)+1)),x},[z]),q=e.continent==="monde"&&b?b.anchors:null,A=e.continent==="monde"&&b?b.metros:null,R=u.useMemo(()=>z.map(x=>{const T=wr(x.name||x.id||""),I=wr((x.id||x.name||"")+"·y");if(q&&x.cc){const K=A?A[x.cc]:void 0;if(K&&K.length){const ee=Nl(x.cc,x.city,T);if(ee>=0&&K[ee])return{d:x,x:K[ee].x+(T-.5)*5,y:K[ee].y+(I-.5)*5}}const ue=q[x.cc];if(ue)return{d:x,x:ue.x+(T-.5)*10,y:ue.y+(I-.5)*10}}const G=x.cc?N.get(x.cc):void 0;if(!G)return null;const W=zl[`${e.continent}:${x.cc||""}`];if(W)return{d:x,x:G.x+G.w*(W.fx+(T-.5)*W.sx),y:G.y+G.h*(W.fy+(I-.5)*W.sy)};const Q=(T-.5)*Math.min(G.w*.55,60),X=(I-.5)*Math.min(G.h*.55,60);return{d:x,x:G.x+G.w/2+Q,y:G.y+G.h/2+X}}).filter(x=>!!x),[z,N,q,A,e.continent]),P=x=>f>0?x/f:x,B=u.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:yr[x],fr:c.plabels[x].toUpperCase(),en:c.plabels[x].toUpperCase(),n:r.filter(T=>T.kind==="target"&&ze(T)===x).length})).filter(x=>x.n>0):Mn.map((x,T)=>({...x,n:r.filter(I=>On(I)===T).length})),[r,n,c.plabels]),L=i?l.get(i):null,F=L?R.find(x=>x.d.id===L.id):null;return y?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:[p&&t.jsx(kr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:v,viewBox:e.continent==="monde"?Cl:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:y.countries.map((x,T)=>t.jsx("g",{className:"ct"+(x.i2&&E.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},T))}),t.jsx("g",{children:R.map(x=>{const T=Mn[On(x.d)],I=!!Re(x.d),G=x.d.kind==="target",W=n&&G?yr[ze(x.d)]:T.c,Q=!n&&$e(x.d);return t.jsxs("g",{className:"co"+(Q?" done":""),onMouseEnter:()=>{var ue,ee;const X=(ue=m.current)==null?void 0:ue.getBoundingClientRect(),K=(ee=v.current)==null?void 0:ee.createSVGPoint();if(K&&v.current&&X){K.x=x.x,K.y=x.y;const xe=K.matrixTransform(v.current.getScreenCTM());j({x:xe.x-X.left,y:xe.y-X.top,label:x.d.name+" · "+(Pt(x.d.cc,d)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var ue;if(h==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const X=(ue=v.current)==null?void 0:ue.createSVGPoint();let K=null;if(X&&v.current){X.x=x.x,X.y=x.y;const ee=X.matrixTransform(v.current.getScreenCTM());K={x:ee.x,y:ee.y}}a({type:"popup",id:x.d.id,anchor:K})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:P(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:P(T.px),fill:W,stroke:I?"#DC2626":"#ffffff",strokeWidth:P(I?2.2:1.3)})]},x.d.id||x.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:P(13),fill:"none",stroke:"#0F172A",strokeWidth:P(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:B.map((x,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),d==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},T))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:t.jsx(kr,{msgs:c.loadMsgs})})}function ql(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function fo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:l,lang:d}=V(),c=a.filters,[g,s]=u.useState(!1),[h,p]=u.useState(!1),v=u.useRef(null),m=u.useRef(null),b=u.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),y=F=>b.filter(x=>F!=="country"&&c.country.length&&!c.country.includes(x.cc||"")?!1:ka(x,c,i,F==="country"?void 0:F)),f=F=>!i||F.kind!=="op",N=u.useMemo(()=>{const F=y("win").filter(f),x=T=>F.filter(I=>(I.date?Math.max(0,Math.floor((Date.now()-Date.parse(I.date))/864e5)):9999)<=T).length;return[x(0),x(7),x(30),F.length]},[b,c,i]),S=u.useMemo(()=>c.day?y("win").filter(f).filter(F=>(F.date||"").slice(0,10)===c.day).length:0,[b,c,i]),k=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,j=k+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);u.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),u.useEffect(()=>{if(!g&&!h)return;const F=T=>{var G,W;const I=T.target;g&&!((G=v.current)!=null&&G.contains(I))&&s(!1),h&&!((W=m.current)!=null&&W.contains(I))&&p(!1)},x=T=>{T.key==="Escape"&&(s(!1),p(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",x)}},[g,h]);const z=(F,x,T,I="fbtn")=>t.jsxs("button",{type:"button",className:I,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:x}),T>0&&t.jsx("span",{className:"n",children:T}),t.jsx("span",{className:"cv",children:"▾"})]},F),E=["1","7","30","all"],q=Math.max(0,E.indexOf(c.win||"all")),A=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(ql(c.day,d))}),t.jsx("b",{children:S})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>p(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[q]}),t.jsx("b",{children:N[q]}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:E.map((F,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),p(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:N[x]})]},F))})]}):t.jsx("div",{className:"seg",children:E.map((F,x)=>t.jsxs("button",{type:"button","aria-pressed":c.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:N[x]})]},F))}),R=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),P=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):z("sec",o.fSector,c.sector.length),z("pay",o.fCountry,c.country.length),z("det",o.fEngine,c.engine.length),z("sta",o.fStage,c.stage.length),i&&z("ang","Angle",c.angle.length),i&&z("mem","Mémo",c.memoLevel.length)]}),B=(F=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(b.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:v,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{s(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:P})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:A}),t.jsxs("div",{className:"fstrip-b",children:[R,L,B(!1)]})]}),a.openFacet&&t.jsx(jr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[A,R,P,t.jsx("span",{className:"fgrow"}),B()]}),a.openFacet&&t.jsx(jr,{poolFor:y})]})}function jr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=V(),i=a.filters,l=a.openFacet,{title:d,cols:c,options:g}=u.useMemo(()=>{if(l==="sig"){const m=e("signal").filter(f=>Re(f)),b=new Map;m.forEach(f=>{const N=f.engine||"";b.set(N,(b.get(N)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Ga([...b.keys()],o).map(f=>({v:f,label:Et(f)+" "+He(f,o),n:b.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const m=e("sector"),b=new Map;return m.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:i.sector.includes(y)}))}}if(l==="pay"){const m=e("country"),b=new Map;return m.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:Pt(y,o)||y,n:f,html:!1,on:i.country.includes(y)}))}}if(l==="det"){const m=e("engine"),b=new Map;return m.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Ga([...b.keys()],o).map(y=>({v:y,label:Et(y)+" "+He(y,o)+' <span style="color:var(--dim);font-size:10px">· '+ni(ri(y),o)+"</span>",n:b.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(l==="ang"){const m=e("angle"),b=new Map;return m.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(y)}))}}if(l==="mem"){const m=e("memoLevel"),b=new Map;m.forEach(f=>{if(f.kind==="target"){const N=hn(f);b.set(N,(b.get(N)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:y[f],n:b.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const p=e("stage"),v=new Map;return p.forEach(m=>{m.stage&&v.set(m.stage,(v.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((m,b)=>b[1]-m[1]).map(([m,b])=>({v:m,label:m,n:b,html:!1,on:i.stage.includes(m)}))}},[l,a,o]),s=p=>{if(l==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(p)?i.signalEngines.filter(b=>b!==p):[...i.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:p})},h=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:h,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>s(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function ho({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:l,t:d}=V(),c=u.useMemo(()=>{const v={};return r.forEach(m=>{ka(m,n.filters,i)&&(v.monde=(v.monde||0)+1,m.continent&&(v[m.continent]=(v[m.continent]||0)+1))}),v},[r,n.filters,i]),[g,s]=u.useState(!1),h=u.useRef(null);u.useEffect(()=>{if(!g)return;const v=b=>{var y;(y=h.current)!=null&&y.contains(b.target)||s(!1)},m=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",v),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",v),document.removeEventListener("keydown",m)}},[g]);const p=v=>{const m=gn.find(b=>b.key===v);return v==="monde"?d.contWorld:l==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:h,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>s(v=>!v),children:[p(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Dn.map(v=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===v,onClick:()=>{o({type:"continent",key:v}),s(!1)},children:[p(v),t.jsx("span",{className:"n",children:c[v]||0})]},v))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Dn.map(v=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===v,onClick:()=>o({type:"continent",key:v}),children:[p(v),t.jsx("span",{className:"n",children:c[v]||0})]},v)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function xo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ll(e){var o;const a=[],r=new Set,n=i=>{const l=(i||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Nr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:l}){const{t:d}=V();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function go({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=V(),o=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),i=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Nr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Nr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Fl({card:e,onEvaluate:a,onAddAll:r}){var d,c,g;const{t:n}=V(),o=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),i=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:xo(e.summary_md||"").map((s,h)=>t.jsx("p",{children:s},h))})]}),t.jsx(go,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Rl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Ml({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:l}=V(),d=o,[c,g]=u.useState(null),[s,h]=u.useState(null),[p,v]=u.useState(null),[m,b]=u.useState(!1);u.useEffect(()=>{let f=!0;return(async()=>{const N=await Mr({email:l,cbToken:d});f&&g(N)})(),()=>{f=!1}},[l,d,n]);const y=f=>{h(f),v(null),b(!0),(async()=>{const N=await oi(f.id);v(N),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{h(null),v(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Rl(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!p&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&p&&t.jsx(Fl,{card:p,onEvaluate:a,onAddAll:r})]})]})}const ba=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Kt(e){return/^https?:\/\//i.test((e||"").trim())}function nt(e){const a=(e||"").trim();return a?Kt(a)?a:ba.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Ol(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Dl(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:l,evalBusy:d,evalCards:c,caps:g,data:s,canWrite:h,source:p,dossiers:v,doAnalyse:m,liveMemos:b,pipe:y}=V(),f=a==="client",N=u.useMemo(()=>r||(p!=="default"?ii():""),[r,p]),[S,k]=u.useState(""),[j,z]=u.useState(!1),[E,q]=u.useState(""),[A,R]=u.useState(""),[P,B]=u.useState(""),[L,F]=u.useState(!1),[x,T]=u.useState(!1),[I,G]=u.useState(""),[W,Q]=u.useState(!1),[X,K]=u.useState(""),[ue,ee]=u.useState([]),xe=u.useRef(!1),[U,le]=u.useState(!1),[me,Le]=u.useState(!1),[te,pe]=u.useState(!1),he=u.useRef(!1),[se,Y]=u.useState(""),[ae,oe]=u.useState(""),[ge,Ee]=u.useState(!1),[ne,ce]=u.useState(!1),[Ie,qe]=u.useState(0),[Me,Ce]=u.useState(""),[ve,Ve]=u.useState(null),[Fe,st]=u.useState(null),[pt,xt]=u.useState(!1),[tt,gt]=u.useState(null),[bt,Je]=u.useState(0),ut=u.useRef(!1),vt=S.trim()?ba.test(S.trim())?e.evalUrl:e.evalName:e.evalWaiting,C=u.useMemo(()=>I.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[I]);u.useEffect(()=>{if(typeof window>"u")return;const O=new URLSearchParams(window.location.search),J=(O.get("rs")||"").trim(),re=(O.get("rstext")||"").trim();J&&/^https?:\/\//i.test(J)&&Y(J),re&&oe(re),(J&&/^https?:\/\//i.test(J)||re)&&le(!0)},[]),u.useEffect(()=>{const O=J=>{const re=J.detail||{},w=String(re.url||"").trim(),D=String(re.text||"").trim();w&&/^https?:\/\//i.test(w)&&Y(w),D&&oe(D),(w&&/^https?:\/\//i.test(w)||D)&&(le(!0),k(""),q(""),Ee(!0),window.setTimeout(()=>Ee(!1),900))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]),u.useEffect(()=>{const O=J=>{const re=J.detail||{},w=String(re.name||"").trim();if(!w)return;le(!1),k(w),q(w);const D=nt(String(re.website||re.domain||""));R(D),B(nt(String(re.url||""))),F(!D),z(!0),window.setTimeout(()=>z(!1),900)};return window.addEventListener("ppmap:prefill",O),()=>window.removeEventListener("ppmap:prefill",O)},[]),u.useEffect(()=>{const O=(E||"").trim();if(!O||U||A){(A||!O||U)&&F(!1);return}const J=v.find(D=>Pe(D.name)===Pe(O)),re=nt((J==null?void 0:J.website)||"")||nt((J==null?void 0:J.domain)||"");if(re){R(re),F(!1);return}let w=!0;return F(!0),Or(O).then(D=>{var _,Z;if(!w)return;const M=nt(D.website||"")||nt(((Z=(_=D.candidates)==null?void 0:_[0])==null?void 0:Z.url)||"");M&&R(M)}).catch(()=>{}).finally(()=>{w&&F(!1)}),()=>{w=!1}},[E,U,A,v]),u.useEffect(()=>{const O=J=>{var w;const re=String(((w=J.detail)==null?void 0:w.url)||"").trim();Kt(re)&&window.open(re,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",O),()=>window.removeEventListener("ppmap:view",O)},[]),u.useEffect(()=>{if(he.current===U)return;he.current=U,pe(!0);const O=window.setTimeout(()=>pe(!1),560);return()=>window.clearTimeout(O)},[U]),u.useEffect(()=>{if(typeof window>"u")return;const O=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),J=document.querySelector(".atl2.ops, .atl2.cibles");if(!O||!J)return;const re=()=>J.style.setProperty("--demand-h",`${O.offsetHeight}px`);re();const w=new ResizeObserver(re);return w.observe(O),()=>w.disconnect()},[p,j,ge,x,U,te,L]),u.useEffect(()=>{if(!h&&!N){gt(null);return}let O=!0;return(async()=>{const J=await Mr({email:n,cbToken:N});O&&gt(J.length)})(),()=>{O=!1}},[h,N,n,bt]);const $=ue.length?ue:c,H=s.credits,de=u.useCallback(O=>{const J=O.map(re=>(re||"").trim()).filter(Boolean);J.length&&(G(re=>{const w=re.split(`
`).map(_=>_.trim()).filter(Boolean),D=new Set(w.map(_=>_.toLowerCase())),M=J.filter(_=>!D.has(_.toLowerCase()));return[...w,...M].slice(0,15).join(`
`)}),T(!0))},[]);u.useEffect(()=>{if(!ne)return;qe(0);const O=window.setInterval(()=>qe(J=>J+1),1e3);return()=>window.clearInterval(O)},[ne]);const be=u.useMemo(()=>{const O=S.trim().toLowerCase();return!O||!y?null:v.find(J=>Pe(J.name)===O&&ze(J)===1)||null},[S,v,y]),ie=()=>{const O=S.trim();if(O){if(be){m(be);return}o(null,O),f&&k("")}},we=async()=>{if(!f){o(null,C[0]||"");return}if(!C.length||W)return;Q(!0),xe.current=!1;const O=[];for(let J=0;J<C.length&&!xe.current;J++){K(e.evaluating(J+1,C.length,C[J]));const re=await Dr(r,C[J],"atelier2");if(O.unshift({name:re.company||C[J],verdict:re.verdict,reason:re.reason||"",remaining:re.remaining??null}),ee([...O]),re.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(C.length-J-1),remaining:0}),ee([...O]),G(C.slice(J+1).join(`
`)),K(""),Q(!1);return}}K(""),G(xe.current?C.slice(O.length).join(`
`):""),Q(!1)},Xe=async()=>{var re,w,D;if(ut.current)return;const O=se.trim().replace(/\s+/g,""),J=ae.trim();if(!O&&!J){Ce(e.rsNeed);return}if(!f&&!N){o(null,O||J.slice(0,80));return}ut.current=!0,Ce(""),Ve(null),st(null),ce(!0);try{const M=await li({url:O,text:J,email:n,cbToken:N});if(ce(!1),!M||M.status!=="success"){Ce((M==null?void 0:M.message)||"Erreur");return}Ve(M),le(!1),de((((re=M.prospective)==null?void 0:re.companies_to_evaluate)||[]).map(Z=>(Z==null?void 0:Z.name)||"")),st({state:"pending"});const _=await di(M,{email:n,cbToken:N});st(_.ok?{state:"ok",scopeLabel:((w=_.summary)==null?void 0:w.scope_label)||"",scope:((D=_.summary)==null?void 0:D.scope)||""}:{state:"fail",msg:_.error||""}),_.ok&&Je(Z=>Z+1)}finally{ut.current=!1,ce(!1)}},yt=[ve==null?void 0:ve.industry,...(ve==null?void 0:ve.market_tags)||[],ve==null?void 0:ve.author].map(O=>(O||"").trim()).filter(Boolean),mt=(Fe==null?void 0:Fe.state)==="pending",Bt=Fe&&(mt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Fe.state==="ok"?t.jsx("span",{className:"rslink ok",children:Fe.scope&&Fe.scope!=="public"?e.rsSavedIn(Fe.scopeLabel||Fe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Fe.msg,children:e.rsSaveFail})),Tt=Ll(ve).length,Oe=U,De=(E||S).trim(),Ze=v.find(O=>Pe(O.name)===Pe(De)),$t=nt(S)||A||nt((Ze==null?void 0:Ze.website)||"")||nt((Ze==null?void 0:Ze.domain)||""),_t=P||nt((Ze==null?void 0:Ze.url)||""),ra=be?e.actAnalyse:De?e.evalGoOn(De.length>22?De.slice(0,21)+"…":De):e.evalGo,Ra=ne?`${si(se.trim())==="youtube"&&se.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Ie)}`:mt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Oe?" rs-mode":"")+(E&&S.trim()===E||j||ge?" pair":"")+(j||ge||te?" echo":"")+(te?" swap":""),children:[t.jsxs("div",{className:"drow"+((Oe?ge:j)||te?" flash":"")+((Oe?se.trim():ba.test(S.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Oe?se:S,placeholder:Oe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Oe?600:200,spellCheck:Oe?!1:void 0,inputMode:Oe?"url":void 0,onChange:O=>{if(Oe){Y(O.target.value);return}k(O.target.value),E&&O.target.value.trim()!==E&&(q(""),R(""),B(""),F(!1))},onKeyDown:O=>{O.key==="Enter"&&(Oe?Xe():ie())}}),t.jsx("span",{className:"detect"+(Oe?" off":"")+(ba.test(S.trim())?" url":""),children:vt})]}),t.jsx("span",{className:"dacts",children:Oe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ne?" loading":""),disabled:ne||mt||!se.trim()&&!ae.trim(),onClick:()=>{Xe()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Ra})]}),t.jsxs("a",{className:"viewbtn"+(Kt(se)?"":" off"),href:Kt(se)?se.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:O=>{Kt(se)||O.preventDefault()},children:[t.jsx(Ol,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(be?" analyse":"")+(d?" loading":""),disabled:d,onClick:ie,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ra})]}),t.jsxs("a",{className:"viewbtn sm"+(L?" searching":$t?"":" off"),href:$t||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":L||void 0,title:L?e.viewSiteBusyHint:e.viewSiteHint,onClick:O=>{$t||O.preventDefault()},children:[L&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),L?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(_t?"":" off"),href:_t||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:O=>{_t||O.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&H&&t.jsxs("button",{type:"button",className:"credits"+(H.total_available<=0&&!H.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:H.unlimited?"∞":H.total_available}),!H.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",H.daily_grant+H.purchased]}),H.total_available<=0&&!H.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(O=>O.status==="boot"||O.status==="running").map(O=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:O.name}),t.jsx(Qt,{item:O,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+O.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>T(!x),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(U?" on":""),onClick:()=>le(!U),children:e.rsOpen}),tt!==null&&tt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(pt?" on":""),onClick:()=>xt(!pt),children:e.rsArchOpen(tt)})]}),pt&&t.jsx(Ml,{bump:bt,cbToken:N,onClose:()=>xt(!1),onEvaluate:O=>o(null,O),onAddAll:de}),t.jsx("div",{className:"rsp slim"+(U?" on":" off"),"aria-hidden":!U,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:U?void 0:-1,onClick:()=>Le(O=>!O),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:me?"▴":"▾"})]}),me&&t.jsx("textarea",{className:"rstext",value:ae,placeholder:e.rsTextPh,tabIndex:U?void 0:-1,onChange:O=>oe(O.target.value)})]})}),Me&&t.jsx("div",{className:"rserr",children:Me}),ve&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ve.title}),ve.source_url&&t.jsx("a",{href:ve.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{Ve(null),st(null)},children:"×"})]}),ve.market&&t.jsx("p",{className:"rsmk",children:ve.market}),yt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),yt.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[ve.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ve.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:xo(ve.summary_md||"").map((O,J)=>t.jsx("p",{children:O},J))})]}),t.jsx(go,{card:ve,onEvaluate:O=>o(null,O),onAddAll:de}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Tt)}),Bt]})]}),x&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:I,placeholder:e.bulkPh,onChange:O=>G(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(W?" loading":""),style:{justifyContent:"center"},disabled:W||!C.length,onClick:()=>{we()},children:[t.jsx("span",{className:"fill"}),W&&X?X:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(C.length)})]})]}),$.slice(0,1).map((O,J)=>{const re=O.verdict==="kept",w=O.verdict==="quota",D=re?"var(--brand)":w?"var(--bolt)":"var(--red)",M=re?"var(--brand-l)":w?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":D,"--bgc":M},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:re?"✓ "+e.kept:w?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!!(O.candidates&&O.candidates.length)&&t.jsx("span",{className:"sitepick",children:O.candidates.map(_=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:_.url.startsWith("http")?_.url:`https://${_.url}`,target:"_blank",rel:"nofollow noopener",children:[(_.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,_.url),children:e.evalPickGo})]},_.url))}),!w&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:re?1:5});const _=(O.name||"").trim().toLowerCase();window.setTimeout(()=>{const Z=[...document.querySelectorAll(".atl2 .list .row")].find(je=>{var Ne;return(((Ne=je.querySelector(".rnm"))==null?void 0:Ne.textContent)||"").trim().toLowerCase().includes(_)});Z&&(Z.scrollIntoView({behavior:"smooth",block:"center"}),Z.classList.add("flashrow"),window.setTimeout(()=>Z.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(re?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),f&&(i.kept+i.dropped>0||$.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Pl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Il(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=V(),i=e.memoConsole?r.get(e.memoConsole):null,l=u.useMemo(()=>i?[i.reasoning||"",Pl(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const d=ht(i),c=hn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Rt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Nn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=V(),[l,d]=u.useState(!1),[c,g]=u.useState(null),s=n.pipe&&o==="client"&&!n.lockActions,h=async()=>{if(!s||l)return;d(!0);const p=await ci(r,e);if(d(!1),!p){i(a.actErr);return}g(p.results||[])};return u.useEffect(()=>{if(!s)return;const p=v=>{var b;const m=String(((b=v.detail)==null?void 0:b.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&h()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,s]),u.useEffect(()=>{if(s)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),h())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{h()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Bl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ha=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function $l(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ha(a.slice(n));break}r+=ha(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ha(a.slice(o));break}const l=a.slice(o+1,i).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Bl.has(c)?r+=`<${d[1]}${c}>`:r+=ha(a.slice(o,i+1)),n=i+1}return r}const Er=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Be({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function _l(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ul({o:e}){const{t:a,doDeep:r}=V(),[n,o]=u.useState(!1),i=ht(e),l=[e.reasoning||"",_l(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[i&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:i}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Rt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),o(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function En({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=V(),i=aa(e),l=ht(e),d=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),h=u.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Rt(e)?1:0}].filter(b=>b.n>0),[e,a,d,l,c,g,s]),[p,v]=u.useState("");if(!h.length)return null;const m=h.some(b=>b.k===p)?p:h[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:h.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===b.k,"data-tour":"tab-"+b.k,className:m===b.k?"on":"",onClick:y=>{y.stopPropagation(),v(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[m==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Be,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Be,{k:a.cdVerdictDate,v:Er(e.verdictDate,r)})]})]}),m==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:$l(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(Hl,{o:e})]}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdSector,v:e.sector}),t.jsx(Be,{k:a.cdStage,v:e.stage}),t.jsx(Be,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Be,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Be,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Be,{k:a.cdAngle,v:e.angle}),t.jsx(Be,{k:a.cdDetected,v:Er(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdName,v:e.contactName}),t.jsx(Be,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Be,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="memo"&&t.jsx(Ul,{o:e}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Be,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Hl({o:e}){const{t:a,token:r}=V(),[n,o]=u.useState(!1),[i,l]=u.useState(null),d=async()=>{n||(o(!0),l(await pi(r,e.name,e.website||e.domain||"")),o(!1))},c=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=g.some(([,h])=>h);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),i&&s&&t.jsxs(t.Fragment,{children:[g.filter(([,h])=>h).map(([h,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:h}),t.jsx("p",{children:p})]},h)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!s&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function na({spec:e}){const a=u.useRef(null),r=u.useRef(null),[n,o]=u.useState(!1);return u.useEffect(()=>{const i=a.current;if(!i)return;let l=!1;const d=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Pn({kind:"op",card:e},g).then(s=>{!l&&s&&i.isConnected&&i.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),u.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let l=!1;Pn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&i.isConnected&&i.replaceChildren(c)});const d=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Vl=`
...
`;function Wl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let d=e.y+10;return d+n>i-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function Gl(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:l,askEvaluate:d,doAnalyse:c,doDecide:g,doPromote:s,doRepeche:h,doApproach:p,doDeep:v,doOnboard:m,outbound:b,evalBusy:y}=V(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const N=Re(f),S=ze(f),k=ht(f),j=aa(f),z=f.kind==="target",E=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return Dt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Vl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Wl(e.popupAnchor,!!f.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ct(f.date)),He(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>E({country:[f.cc]}),children:(Pt(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>E({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>E({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:It(f.amountEur,o)})]}),i.pipe&&z&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[S]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Et(f.engine)," ",t.jsx("b",{children:He(f.engine,o)})," — ",ui(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),N?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(ft,{o:f,lg:!0})," ",t.jsx(Fa,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Pr(N,o))," · ",n.win7(Ir(N,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(na,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&S>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&z&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&z&&t.jsx(En,{o:f})]}),t.jsx(Nn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||l!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[S===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),S===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),S===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),S===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),Rt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(f),a({type:"popup",id:null})},children:n.memoDeep})]}),S===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),S===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>d(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Yl(){const{lang:e,token:a,dossiers:r,caps:n}=V(),o=a||"home",{names:i,verdicts:l}=u.useMemo(()=>{const c=[],g={};return r.forEach(s=>{s.kind!=="target"||!s.name||(c.push(s.name),g[s.name]=mi(s)||"")}),{names:c,verdicts:g}},[r]);return{diff:u.useMemo(()=>i.length?fi(o,i,l,e):null,[o,i.length]),names:i,verdicts:l,scope:o,caps:n}}function Kl(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:l}=V(),d=i.loading&&!l.length,c=u.useRef({});u.useEffect(()=>{c.current={...r}},[r]);const g=p=>{const v=c.current[p],m=v!==void 0?r[p]-v:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ya[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(m>0?" up":m<0?" down":""),children:[r[p],m!==0&&t.jsxs("em",{className:"delta",children:[m>0?"+":"−",Math.abs(m)]})]})]},p)},s=(p,v,m)=>t.jsxs("button",{type:"button",className:"off"+(v?" view":""),style:{"--c":`var(${Ya[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsx("span",{className:"l",children:m.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),h=(p,v,m,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:v,disabled:b,onClick:m,children:p},v);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[h("↩",n.toolUndo,o,e.undo.length===0),h("↺",n.toolReset,()=>{a({type:"reset"})}),h("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),h("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),h("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Ql(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:l}=V(),d=u.useRef(null),[c,g]=u.useState(60);u.useEffect(()=>{let m=0;const b=()=>{var k;const y=d.current;if(!y)return;const f=(k=y.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!f)return;const N=f.getBoundingClientRect(),S=y.getBoundingClientRect();g(Math.max(20,Math.min(N.left+N.width/2-S.left,S.width-30)))};return m=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let h=r.tuto[s].p;if(s===3){const m=n.filter(f=>f.kind==="target"&&ze(f)===3),b=m.filter(f=>Ka(f)==="auto").length,y=m.filter(f=>Ka(f)==="cd").length;h=r.tutoPending(b,y,m.length)}const p=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(s===1){const m=n.filter(b=>b.kind==="target"&&ze(b)===1&&!o.has(b.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(b=>b.id)})}}return null})(),v=hi(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(v?"":" on-dark"),style:{"--bg":`var(${Ya[s]})`,"--ax":c+"px","--stc":v?"var(--ink)":"#fff","--stt":v?"#fff":"var(--ink)","--tc":v?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:h}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}const Va=600,kt=62,Sr="atl2:fstats";function Jl(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=V(),[l,d]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Sr)==="on"}catch{return!1}}),c=r.stats,g=u.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const h=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,p=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),v=g.reduce((j,z)=>Math.max(j,z.s||0),0),m=g.length?Va/g.length:0,b=Math.max(4,m-4),y=g.length>=5&&v>0,f=r.marketEstimate||0,N=h(new Date().toISOString().slice(0,10)),S=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],k=[];return typeof c.screened_window=="number"&&s&&k.push({cle:"fenetre",periode:e.funPerWindow(h(s),N),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:S(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([z,E],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(z)}),t.jsx("i",{children:E})]},j.cle+E)),j.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(f),Math.min(100,Math.round((c.screened||0)/f*100)))})]}),j.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const z=!l;d(z),z&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Sr,z?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},j.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Va} ${kt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((j,z)=>{const E=(j.s||0)/v*(kt-4),q=(j.m||0)/v*(kt-4),A=z*m+(m-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${h(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:kt-2-E,width:b,height:E,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:kt-2-q,width:b,height:q,fill:"#185c38"})]},j.d)}),t.jsx("line",{x1:0,y1:kt-1.5,x2:Va,y2:kt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:h(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const bo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Sn({o:e,locked:a=!1}){const{t:r}=V(),n=aa(e),o=ht(e),i=ze(e),l=Ka(e),d=gi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(bo[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(Es,{o:e})]})}const zt=e=>e.length>22?e.slice(0,21)+"…":e,va=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function La(e){return va.has(e.engine||"")}function jt(e){return!!e.noCo||La(e)&&!!e.url}function ta(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function vo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Xl({on:e,rev:a}){const[r,n]=u.useState(null),[o,i]=u.useState({top:0,left:0,width:0});return u.useEffect(()=>{if(!e){n(null);return}const l=()=>{var m,b,y;const d=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!d){n(null);return}const g=d.getBoundingClientRect(),s=c?c.getBoundingClientRect().bottom:g.top;i({top:Math.round(s),left:Math.round(g.left),width:Math.round(g.width)});const h=[...d.querySelectorAll(":scope .grp")];let p=null;for(const f of h){const N=f.querySelector(".grp-h");N&&N.getBoundingClientRect().bottom<=s+2&&(p=f)}if(!p){n(null);return}const v=p.querySelector(".grp-h");if(!v){n(null);return}n({ic:(((m=v.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((b=v.querySelector(".t"))==null?void 0:b.textContent)||"").trim(),s:(((y=v.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Zl(e){const r=()=>{const n=vo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Cr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=V(),[i,l]=u.useState(!1);if(u.useEffect(()=>{n||l(!1)},[n]),$e(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(zt(e.name))})]})}function Cn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:l,doPromote:d,doRepeche:c,doApproach:g,dispatch:s,liveMemos:h}=V(),p=m=>b=>{b.stopPropagation(),m()};if(r.lockActions){const m=p(()=>s({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const b=ze(e);return b===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(zt(e.name))})]})}):b===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):b===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):b===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):b===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):b===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return La(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Cr,{o:e})});const v=ze(e);if(v===0)return t.jsx("span",{className:"cell",children:t.jsx(Cr,{o:e})});if(v===1){const m=h.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Qt,{item:m,serverOff:h.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:p(()=>i(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(v===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:p(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:p(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(v===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:p(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return v===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):v===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:p(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function ed({o:e}){const{t:a,doThumb:r,thumbOf:n}=V(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function td({o:e}){const{lang:a}=V();return Re(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(ft,{o:e}),t.jsx(Fa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Et(e.engine||"")," ",He(e.engine||"",a)]})})}function ad({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:l,fresh:d}){const{dispatch:c,caps:g,markRow:s,markedId:h,favIds:p,toggleFav:v,t:m}=V(),b=ze(e),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,N=f<=0?0:f<=7?1:f<=30?2:3,S=g.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][b]:y[N],k=p.has(e.id),j=z=>{if(a)return;if(l){l(e.id);return}if(g.pipe||e.kind==="op"){n();return}const E=z.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:E.left+Math.min(280,E.width/3),y:E.bottom}})};return t.jsxs(u.Fragment,{children:[t.jsxs("div",{className:"row"+(h===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+b:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:j,children:[t.jsx("span",{className:"pt",style:{"--c":S}}),t.jsx(No,{o:e}),t.jsxs("span",{className:"nd",children:[d&&t.jsx("span",{className:"rfresh",children:"✨"}),Re(e)&&t.jsx(ft,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:z=>{z.stopPropagation(),v(e)},children:k?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(z=>z&&z!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:z=>{z.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",zt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(nd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(td,{o:e}),g.pipe&&t.jsx(Sn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Cn,{o:e}),g.showThumbs&&t.jsx(ed,{o:e})]}),r&&!a&&!l&&t.jsx(id,{o:e})]})}function nd({o:e}){const{lang:a,caps:r}=V();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=It(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function rd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=V(),l=(p,v=!1)=>m=>{m.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:p})},d=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),c=It(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=$e(e),h=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped})]}):jt(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{p.stopPropagation(),ta(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:o,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(zt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(zt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(na,{spec:e.card})})]})}function od({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=V();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[He(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Cn,{o:e})}),t.jsx(En,{o:e})]})}function yo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:l,caps:d,dossiers:c}=V(),g=u.useRef(null),s=We(e);if(u.useEffect(()=>{if(!s||!(e!=null&&e.decryptHtml))return;const x=g.current;if(!x)return;let T=!1;return Wa(()=>import("./fit-BnaWm7z_.js"),[]).then(async I=>{await I.ensureEditoCss(),!(T||!x.isConnected)&&(I.beautifyEditoRows(x),I.mountCardFits(x))}),()=>{T=!0}},[s,e==null?void 0:e.decryptHtml]),!e&&!a){const x=c.find(We);if(x)return t.jsx(yo,{o:x})}const h=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),p=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),v=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||h,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),b=e?!!e.noCo:!h||wa(h),y=(e==null?void 0:e.engine)||"",f=We(e),N=e?It(e.amountEur,n):"",S=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const x=/https?:\/\/(?:www\.)?([^/]+)/.exec(p);return x?x[1].replace(/^www\./,"").slice(0,40):""})(),j=c.find(We),z=((j==null?void 0:j.url)||"").trim(),E=!!p&&!!z&&(p===z||p.endsWith(z)||z.endsWith(p)),q=(x,T=!1)=>I=>{I.stopPropagation(),T&&l({type:"continent",key:"monde"}),l({type:"filters",patch:x})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const A=()=>{h&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:h}}))},R=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},P=()=>{ta({url:p,headline:v,tagline:e==null?void 0:e.tagline,name:h})},B=e?$e(e):!1,L=B&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",F=f?r.doEdito.replace(/^📖\s*/,""):y?He(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[F,S?` · ${S}`:""]}),t.jsx("h3",{className:"zoom-h",children:v}),p&&!f&&(b||La({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:p,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:x=>x.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),N&&t.jsx("span",{className:"oc-amt",children:N})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(na,{spec:m})}),(p&&!E&&!f||j&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[p&&!E&&!f&&t.jsxs("a",{className:"zoom-src",href:p,target:"_blank",rel:"nofollow noopener",onClick:x=>x.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:x=>{x.stopPropagation(),l({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[B?t.jsxs("span",{className:"verdict",style:{"--c":L?"var(--brand)":"var(--red)"},children:[L?"✓":"✗"," ",t.jsx("b",{children:L?r.kept:r.dropped})]}):!b&&h?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:x=>{x.stopPropagation(),o(e,h)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(zt(h))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,p&&!f&&(b||La({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!b&&h?" ghost":""),onClick:x=>{x.stopPropagation(),P()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!b&&h&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),R()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),A()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:zt(h)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!b&&h&&d.pipe&&t.jsx(Nn,{name:h})]})]})}function id({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:l}=V();return!o.pipe&&e.kind==="op"?t.jsx(rd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(En,{o:e}),t.jsx(Ss,{o:e}),t.jsx(As,{o:e}),t.jsx(Nn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Sn,{o:e})})]}),e.card&&t.jsx(na,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Et(e.engine||"")," ",He(e.engine||"",r)]}),Re(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(ft,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function sd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:l,doDecide:d,lang:c}=V();if(!l.pipe&&e.kind==="op"){const h=It(e.amountEur,c),p=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),v=(m,b=!1)=>y=>{y.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(na,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:v({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:v({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:v({stage:[e.stage]}),children:e.stage}),h&&t.jsx("span",{className:"damt",children:h})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Et(e.engine||"")," ",He(e.engine||"",c)]}),Re(e)&&t.jsx(ft,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(p?` · ${p}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Cn,{o:e})})]})}const g=ze(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Sn,{o:e}),Re(e)&&t.jsx(ft,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemo," →"]})]})}function ld(){const{t:e}=V(),[a,r]=u.useState(0);return u.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function dd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=V(),i=o==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,h)=>(e[h]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${l(c)}”`:`${g} dossier${g>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+l(c)," →"]})]})}function cd(){var gt,bt,Je,ut,vt;const e=V(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:l,scopedAll:d,markRow:c,lang:g,sessTally:s,data:h,dossiers:p,source:v,focusExtra:m,byId:b,token:y}=e,f=_r(),N=u.useMemo(()=>{var H,de,be,ie;if(!y||v==="ops")return null;const C=(((H=f==null?void 0:f.ed)==null?void 0:H.date)||(f==null?void 0:f.day)||"").slice(0,10),$=[(de=f==null?void 0:f.ed)==null?void 0:de.html,(be=f==null?void 0:f.ed)==null?void 0:be.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((ie=f==null?void 0:f.ed)==null?void 0:ie.date)||C,decryptHtml:$||void 0,date:C,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,v,g,(gt=f==null?void 0:f.ed)==null?void 0:gt.html,(bt=f==null?void 0:f.ed)==null?void 0:bt.acquirers_html,(Je=f==null?void 0:f.ed)==null?void 0:Je.date,f==null?void 0:f.day]),S=C=>o.lockRowsAfter!==null||v==="ops"?Number.MAX_SAFE_INTEGER:$r,[k,j]=u.useState(new Set);u.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[z,E]=u.useState(null);u.useEffect(()=>{E(null)},[a.ptab,a.continent]);const[q,A]=u.useState(!a.mapFolded);u.useEffect(()=>{if(a.mapFolded){A(!1);return}const C=document.getElementById("atl2-stage");if(!C){A(!1);return}const $=new IntersectionObserver(([H])=>A(!!H&&H.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return $.observe(C),()=>$.disconnect()},[a.mapFolded]);const R=a.mapFolded||!q,P=C=>j($=>{const H=new Set($);return H.has(C)?H.delete(C):H.add(C),H}),B=v==="ops"||o.pipe,[L,F]=u.useState("all"),[x,T]=u.useState(null),[I,G]=u.useState(!1),W=u.useRef(!0);u.useEffect(()=>{if(W.current){W.current=!1;return}F("all"),G(!1)},[a.ptab,a.continent]),u.useEffect(()=>{if(!I)return;const C=$=>{var H,de;(de=(H=$.target)==null?void 0:H.closest)!=null&&de.call(H,".atl2 .doable")||G(!1)};return document.addEventListener("click",C),()=>document.removeEventListener("click",C)},[I]);const Q=u.useMemo(()=>{var $;const C=new Map;for(const H of us((($=f==null?void 0:f.ed)==null?void 0:$.html)||""))C.has(H.t)||C.set(H.t,H.html);return C},[(ut=f==null?void 0:f.ed)==null?void 0:ut.html]),X=u.useCallback(C=>{if(C.decryptHtml)return C.decryptHtml;if(!Q.size)return;const $=(C.name||"").trim().toLowerCase();if($.length<3)return;const H=Q.get($);if(H)return H;for(const[de,be]of Q)if(de.includes($)||$.includes(de))return be},[Q]),{diff:K}=Yl(),[ue,ee]=u.useState(!1),xe=a.filters.win==="1"&&!a.filters.day,[U,le]=u.useState(!1),me=u.useMemo(()=>new Set(((K==null?void 0:K.added)||[]).map(C=>C.trim().toLowerCase()).filter(Boolean)),[K]),Le=u.useMemo(()=>{if(!me.size)return 0;const C={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return p.filter($=>!We($)&&me.has(($.name||"").trim().toLowerCase())&&bn($,C,o.pipe)).length},[p,me,a,o.pipe]),te=u.useMemo(()=>{const C=U&&me.size?d:l;let $=vn(C,a.sort);return $=$.filter(H=>!We(H)),U&&me.size&&($=$.filter(H=>me.has((H.name||"").trim().toLowerCase()))),L==="explore"?$=$.filter(jt):L==="eval"&&($=$.filter(H=>!jt(H)&&!H.noCo)),$},[l,d,a.sort,L,U,me]),he=u.useMemo(()=>o.pipe?d.filter(C=>Re(C)&&xi(C)):te.filter(C=>Re(C)&&!$e(C)),[o.pipe,d,te]).length,se=u.useMemo(()=>o.pipe?te:te.filter(C=>!$e(C)&&!C.noCo),[te,o.pipe]),Y=v==="ops"?te.filter(jt).length:0,ae=U?n.sinceLabel((K==null?void 0:K.lastDate)||""):o.pipe?n.plabels[a.ptab].toLowerCase():v==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,oe=a.filters,ge=[];if(oe.day)ge.push({k:"day",lib:n.fDay(oe.day.slice(8,10)+"/"+oe.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(oe.win&&oe.win!=="all"){const C=["1","7","30"].indexOf(oe.win);C>=0&&ge.push({k:"win",lib:n.dates[C],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ee=C=>C.length<=2?C.join(", "):`${C.length} ${n.fSelected}`;for(const C of["sector","country","engine"]){const $=oe[C];$&&$.length&&ge.push({k:C,lib:Ee($),off:()=>r({type:"clearFacet",facet:C})})}oe.search&&ge.push({k:"search",lib:"🔍 "+oe.search,off:()=>r({type:"filters",patch:{search:""}})}),U&&me.size&&ge.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>le(!1)}),oe.signalOnly&&ge.push({k:"sig",lib:"🔴 "+n.sigDock(he||oe.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const ne=(C,$,H="",de=!1)=>t.jsxs("button",{type:"button","data-s":C,className:H,"aria-sort":a.sort.key===C?a.sort.dir===1?"ascending":"descending":"none",style:de?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:C}),children:[$,t.jsx("span",{className:"ar",children:a.sort.key===C&&a.sort.dir===1?"▴":"▾"})]},C),ce=u.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const C=new Map;te.forEach(de=>{const be=de.engine||"?";C.has(be)||C.set(be,[]),C.get(be).push(de)});const $={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},H=Ga([...C.keys()],g);return[...C.entries()].sort((de,be)=>{const ie=$[de[0]]??10+H.indexOf(de[0]),we=$[be[0]]??10+H.indexOf(be[0]);return ie-we})},[te,o.pipe,a.groupBy,g]),Ie=ce?ce.filter(([C])=>va.has(C)).length:0,qe=(()=>{var $;return(($=(ce?ce.flatMap(([,H])=>H):te)[0])==null?void 0:$.id)??null})(),Me=u.useRef(!1),Ce=u.useMemo(()=>p.find(We)||N,[p,N]);u.useEffect(()=>{const C=()=>{Me.current=!0};return window.addEventListener("ppmap:reveal",C),window.addEventListener("ppmap:focus",C),()=>{window.removeEventListener("ppmap:reveal",C),window.removeEventListener("ppmap:focus",C)}},[]),u.useEffect(()=>{const C=()=>{Ce&&r({type:"focus",id:Ce.id})};return window.addEventListener("ppmap:edito",C),()=>window.removeEventListener("ppmap:edito",C)},[Ce,r]),u.useEffect(()=>{if(!a.focusId)return;T(a.focusId);const C=window.setTimeout(()=>T(null),900);return()=>window.clearTimeout(C)},[a.focusId]),u.useEffect(()=>{if(B&&!(a.focusId&&(te.some(C=>C.id===a.focusId)||p.some(C=>C.id===a.focusId)||a.focusId===(Ce==null?void 0:Ce.id)))&&!m){if(Ce){r({type:"focus",id:Ce.id});return}qe&&r({type:"focus",id:qe})}},[B,a.focusId,te,qe,m,r,p,v,Ce]),u.useEffect(()=>{if(!(!B||!a.focusId)&&L!=="all"&&!(Ce&&a.focusId===Ce.id)&&!te.some(C=>C.id===a.focusId)&&p.some(C=>C.id===a.focusId)){if(Me.current){F("all");return}qe&&r({type:"focus",id:qe})}},[B,a.focusId,L,te,p,qe,r]),u.useEffect(()=>{if(!B||!a.focusId||!Me.current)return;const C=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!C){const be=te.findIndex(ie=>ie.id===a.focusId);if(be>=0){const ie=ce?"":"pt"+a.ptab;if(ie){const we=a.shown[ie]||S();be>=we&&r({type:"more",group:ie,by:be-we+8})}}return}Me.current=!1;const $=vo(),H=C.getBoundingClientRect();H.top>=$-2&&H.bottom<=window.innerHeight-4||Zl(C)},[B,a.focusId,a.ptab,te,a.shown,ce,r]),u.useEffect(()=>{if(typeof window>"u")return;const C=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),$=document.querySelector(".atl2.ops, .atl2.cibles");if(!C||!$)return;const H=()=>$.style.setProperty("--listhead-h",`${C.offsetHeight}px`);H();const de=new ResizeObserver(H);return de.observe(C),()=>de.disconnect()},[R,a.dens,a.mapFolded]);const ve=u.useMemo(()=>{if(!B||!a.focusId)return null;if(N&&a.focusId===N.id)return N;const C=te.find(H=>H.id===a.focusId)||p.find(H=>H.id===a.focusId)||null;if(!C)return null;const $=X(C);return $&&$!==C.decryptHtml?{...C,decryptHtml:$}:C},[B,a.focusId,te,p,X,N]),Ve=o.lockRowsAfter;let Fe=0;const st=(C,$)=>{let H=a.shown[$]||S();return C.length-H<=4&&(H=C.length),C.slice(0,H).map(ie=>{const we=Ve!==null&&Fe>=Ve;Fe++;const Xe=X(ie),yt=Xe&&Xe!==ie.decryptHtml?{...ie,decryptHtml:Xe}:ie,mt=!B&&a.dens!=="maxi"&&(a.dens==="deplie"||(z?z==="open":!!Xe)),Bt=k.has(ie.id)?!mt:mt,Tt=B?Oe=>{Me.current=!0,r({type:"focus",id:Oe});const De=b.get(Oe);De&&(jt(De)?ta(De):De.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:De.name,url:De.url||"",website:De.website||"",domain:De.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(sd,{o:yt,locked:we,selected:B&&a.focusId===ie.id,onSelect:Tt},ie.id):t.jsx(ad,{o:yt,locked:we,open:Bt,onToggle:()=>P(ie.id),selected:B&&a.focusId===ie.id,echo:x===ie.id,fresh:me.has((ie.name||"").trim().toLowerCase()),onSelect:Tt},ie.id)})},pt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(v==="ops"?" opsl":"")+(te.length?"":" list-empty"),xt=t.jsxs(t.Fragment,{children:[ce?ce.map(([C,$])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Et(C)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:C==="ma"?n.grpMa:C==="fundraising"?n.grpLev:va.has(C)&&Ie<=1?n.grpNews:C==="nominations"?n.grpNom:C==="media"?n.grpNewsOther:C==="recrutements"?n.grpHire:va.has(C)?n.grpNews+" · "+He(C,g):He(C,g)}),t.jsx("div",{className:"s",children:n.grpCount($.filter(H=>!$e(H)).length,$.length)})]})]}),st($,C)]},C)):st(te,"pt"+a.ptab),h.loading&&!p.length&&t.jsx(ld,{}),!te.length&&!(h.loading&&!p.length)&&(o.pipe?t.jsx(dd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),tt=t.jsxs("div",{className:"listhead"+(R?" mapoff":""),children:[R&&t.jsx("div",{className:"lh-tools",children:t.jsx(fo,{compact:!0})}),o.showFunnel&&ue&&xe&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(qs,{}),t.jsx(Jl,{})]}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Kl,{}),t.jsx(Ql,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(xe?" on":""),"aria-pressed":xe,title:n.morningDockTitle,onClick:()=>{if(xe){r({type:"filters",patch:{win:"all",day:""}}),ee(!1);return}le(!1),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),ee(!0)},children:["📊 ",n.morningDock(typeof((vt=h.stats)==null?void 0:vt.screened_today)=="number"?h.stats.screened_today:0)]}),K&&!K.firstVisit&&(K.added.length>0||K.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(U?" on":""),"aria-pressed":U,title:n.sinceSub,onClick:()=>{const C=!U;le(C),ee(!1),C&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(Le)]}),he>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{le(!1),ee(!1),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(he)]})]}),t.jsxs("span",{className:"main",children:[t.jsx("b",{children:te.length})," ",ae]}),t.jsx("span",{className:"dot",children:"·"}),R&&t.jsx(ho,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[R?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ge.map(C=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:$=>{$.stopPropagation(),C.off()},children:[C.lib,t.jsx("i",{children:"×"})]},C.k)),v==="ops"&&te.length>0&&!R&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",te.length-Y," ",n.zoomPulseEval,Y>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",Y," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||v==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([C,$])=>t.jsxs("button",{type:"button","data-d":C,"aria-pressed":a.dens===C||C==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:C}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:$})]},C))}),!B&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":z==="open",onClick:()=>{E("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":z==="closed",onClick:()=>{E("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||v==="ops")&&(()=>{var ie;const C=l.filter(we=>!We(we)),$=C.filter(we=>!jt(we)&&!we.noCo).length,H=C.filter(jt).length,de=[["all",n.doAll],["eval",`${n.doEval}${$?` ${$}`:""}`],["explore",`${n.doExplore}${H?` ${H}`:""}`]],be=((ie=de.find(([we])=>we===L))==null?void 0:ie[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":I,onClick:()=>G(we=>!we),children:[be,t.jsx("i",{children:"▾"})]}),I&&t.jsx("div",{className:"dolist",children:de.map(([we,Xe])=>t.jsx("button",{type:"button","aria-pressed":L===we,onClick:()=>{F(we),G(!1)},children:Xe},we))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:C=>r({type:"sort",key:C.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([C,$])=>t.jsx("option",{value:C,children:$},C))})]}),o.showChain&&se.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:se.map(C=>C.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(se.length):n.chainAll(se.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!B&&tt,a.dens!=="maxi"&&!B&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ne("country",n.colCountry),ne("name",n.colCompany),ne("amount",n.colAmount,"h-amt",!0),ne("stage",n.colStage,"h-stade"),ne("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ne("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ne("memo",n.colMemo)]}),o.pipe&&ne("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),B?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[tt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ne("country",n.colCountry),ne("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ne("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ne("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:pt,children:xt})]}),t.jsxs("aside",{className:"readpane"+((ve?We(ve):!m&&Ce)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[Ce&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===Ce.id,onClick:()=>r({type:"focus",id:Ce.id}),children:n.doEdito}),N&&a.focusId===N.id?t.jsx("div",{className:"zoom",children:t.jsx(gs,{})}):ve&&o.pipe?t.jsx(od,{o:ve}):t.jsx(yo,{o:ve,extra:ve?null:m})]})]}):t.jsx("div",{className:pt,children:xt}),(()=>{const C=ce||[["pt"+a.ptab,te]];let $=0,H=0;for(const[be,ie]of C){H+=ie.length;let we=a.shown[be]||S();ie.length-we<=4&&(we=ie.length),$+=Math.min(ie.length,we)}const de=H-$;return de<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>C.forEach(([be,ie])=>r({type:"more",group:be,by:ie.length,base:S()})),children:[t.jsx("span",{className:"more-label",children:n.more(de,de)}),t.jsx("span",{className:"more-meta",children:n.moreMeta($,H)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}}),B&&v==="ops"&&a.dens!=="maxi"&&t.jsx(Xl,{on:!!ce,rev:(ce||[]).map(([C,$])=>C+$.length).join("|")})]})}function zr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function pd(e,a){const r=bi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function ud(e,a){const n=[a.head.split("|").map(zr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",pd(o,a.plabels),aa(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(zr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function md(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const fd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function rt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function hd({o:e,qa:a}){const{t:r,lang:n,fund:o}=V(),i=(e.cribleStatus||"").trim().toUpperCase()||(aa(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=ht(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(rt,{k:r.cdSector,v:e.sector}),t.jsx(rt,{k:r.cdStage,v:e.stage}),t.jsx(rt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(rt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(rt,{k:r.cdName,v:e.contactName}),t.jsx(rt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(rt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(rt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(rt,{k:r.cdAngle,v:e.angle}),t.jsx(rt,{k:r.cdDetected,v:fd(e.date,n)})]}),c.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,g])=>g).map(([g,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:s})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function xd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:l}=V(),[d,c]=u.useState({}),g=25,s=u.useMemo(()=>n.slice(0,g),[n]);u.useEffect(()=>{s.length&&vi(r,s.map(v=>v.name)).then(c)},[r,s]);const h=i.stats,p=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),h&&typeof h.screened=="number"&&t.jsxs("p",{children:[p(h.screened)," ",e.funScreened(""),typeof h.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(h.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(i.marketEstimate)),", ",Math.round(h.screened/i.marketEstimate*100)," %"]})]})]}),s.map(v=>t.jsx(hd,{o:v,qa:d[v.name]},v.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const gd=50;function zn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=V(),[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(""),[h,p]=u.useState(0),[v,m]=u.useState(""),[b,y]=u.useState(!1),[f,N]=u.useState(0),S=u.useRef(null),k=u.useRef(null),j=()=>{N(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>N(A=>A+1),1e3)},z=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};u.useEffect(()=>()=>{S.current&&window.clearInterval(S.current),k.current&&window.clearInterval(k.current)},[]);const E=async A=>{c(!0),s(""),j();const R=await a();if(c(!1),z(),R.ok){l(R);return}if(R.busy){s(o.alertPreviewBusy);return}if(!A){s(o.alertPreviewFail);return}p(gd),z(),S.current=window.setInterval(()=>{p(P=>P>1?P-1:(S.current&&window.clearInterval(S.current),E(!1),0))},1e3)},q=async()=>{if(n||b||d)return;y(!0),m(""),j();const A=await r();y(!1),z(),m(A.ok?o.alertTestOk(A.sentTo||""):A.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||b||h>0,onClick:()=>{E(!0)},children:d?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b||d,onClick:()=>{q()},children:b?o.alertBtnTestBusy:o.alertTest})]}),d&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),b&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),h>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(h)}),g&&t.jsx("p",{className:"mnote warn",children:g}),v&&t.jsx("p",{className:"mnote",children:v}),!v&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Ft="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function _e({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=V();return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function bd(){const{st:e}=V();switch(e.modal){case"chain":return t.jsx(yd,{});case"space":return t.jsx(wd,{});case"alert":return t.jsx(kd,{});case"queue":return t.jsx(Cd,{});case"export":return t.jsx(zd,{});case"plug":return t.jsx(qd,{});case"recharge":return t.jsx(Fd,{});case"cover":return t.jsx(Md,{});case"dossier":return t.jsx(Rd,{});case"crit":return t.jsx(Od,{});case"tuto":return t.jsx(Dd,{});case"rdv":return t.jsx(vd,{});case"memoalert":return t.jsx(Ad,{});default:return null}}function vd(){const{dispatch:e,fund:a,t:r}=V(),n=a||r.rdvCoFallback;return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Vr,children:wn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Ui,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function yd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:l,evalBusy:d,caps:c,memoQueued:g,doAnalyse:s}=V(),h=i==="client",p=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),v=e.chain.idx,m=p[v],b=v>=p.length;return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${v+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:v/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Pt(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(ct(m.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:He(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:It(m.amountEur,o)})]}),Re(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(ft,{o:m,lg:!0})," ",t.jsx(Fa,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),h&&$e(m)&&t.jsxs("div",{className:"vbox",style:{"--c":Nt(m)==="retenu"?"var(--brand)":Nt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Nt(m)==="retenu"?"✓ "+n.kept:Nt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&m&&c.pipe&&ze(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&m&&!(h&&$e(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function wd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=V(),i=o==="client",l=u.useMemo(()=>i?r.filter(h=>$e(h)):[],[r,i]),d=u.useMemo(()=>vn(l.filter(h=>Nt(h)==="retenu"),{key:"signal",dir:-1}),[l]),c=u.useMemo(()=>l.filter(h=>Nt(h)==="ecarte"),[l]),g=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(_e,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(h=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof h.score=="number"&&h.score>0?h.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:h.name}),t.jsx("div",{className:"rr",children:h.reasoning||h.tagline||""})]})]},h.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function kd(){const{mode:e}=V();return e==="client"||e==="apercu"?t.jsx(jd,{}):t.jsx(Sd,{})}function jd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=V(),[i,l]=u.useState("d"),d=o!=="client";return t.jsxs(_e,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Nd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),i==="w"&&t.jsx(Ed,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),i==="m"&&t.jsx(wo,{})]})}function Nd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(0);u.useEffect(()=>{let q=!0;return c(!1),$n(a).then(A=>{q&&(A?l(A):c(!0))}),()=>{q=!1}},[a,g]);const h=u.useRef({}),[p,v]=u.useState({}),[m,b]=u.useState(!1),[y,f]=u.useState(!1),N=u.useRef(null);u.useEffect(()=>()=>{N.current&&window.clearTimeout(N.current)},[]);const S=q=>{const A=h.current;Object.keys(A).length&&(b(!0),$n(a,A).then(R=>{if(!R){b(!1),o(e.actErr);return}if(R.throttled&&q<3){N.current=window.setTimeout(()=>S(q+1),5400);return}if(h.current={},v({}),l(R),b(!1),R.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},k=q=>{r||(h.current={...h.current,...q},v(A=>({...A,...q})),N.current&&window.clearTimeout(N.current),N.current=window.setTimeout(()=>S(1),700))};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(q=>q+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...p},z=q=>!j.sections||j.sections.includes(q),E=q=>{const A=j.sections||e.alertSec.map(([R])=>R);k({sections:z(q)?A.filter(R=>R!==q):[...A,q]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([q,A])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:z(q),disabled:r,onChange:()=>E(q)}),t.jsxs("span",{children:[A,q==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},q))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(zn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ai(a),onTest:()=>zi(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ed({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(0);u.useEffect(()=>{let m=!0;return c(!1),_n(a).then(b=>{m&&(b?l(b):c(!0))}),()=>{m=!1}},[a,g]);const h=m=>{r||_n(a,m).then(b=>{if(!b){o(e.actErr);return}l(b),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const p=i.dow??0,v=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>h({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:m=>h({dow:Number(m.target.value)}),children:e.alertDow.map((m,b)=>t.jsx("option",{value:b,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[v," h"]}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.min(21,v+1)}),disabled:r,children:"+"})]})]}),t.jsx(zn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>qi(a),onTest:()=>Ti(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function wo(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=V(),[l,d]=u.useState(i||""),[c,g]=u.useState(!1),[s,h]=u.useState(!1);u.useEffect(()=>{i&&d(i)},[i]);const p=e.filters,v=u.useMemo(()=>n.filter(f=>Re(f)).length,[n]),m=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){h(!0);try{await fetch(`${fn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:p.sector,countries:p.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{h(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(f=>He(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(f=>Pt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,N])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:N}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!i,onChange:f=>d(f.target.value),onKeyDown:f=>{f.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Sd(){const{t:e}=V();return t.jsx(_e,{title:e.alertTitle,icon:"🔔",children:t.jsx(wo,{})})}function Cd(){var P,B;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:l,caps:d,dispatch:c,liveMemos:g}=V(),[s,h]=u.useState(()=>Oa(r)),[p,v]=u.useState(()=>!Oa(r)),[m,b]=u.useState([]),[y,f]=u.useState(0),N=n==="client",S=u.useMemo(()=>{const L=new Map;return o.forEach(F=>{const x=(F.name||"").trim().toLowerCase();x&&!L.has(x)&&L.set(x,F)}),L},[o]);u.useEffect(()=>{let L=!0;return(!Oa(r)||y>0)&&v(!0),(async()=>{const[F,x]=await Promise.all([xn(r,y>0),Rr(a)]);L&&(F&&h(F),v(!1),b(x))})(),()=>{L=!1}},[a,r,y]);const k=p&&!s,j=(s==null?void 0:s.per_day)??0,z=((P=s==null?void 0:s.analyzed_today)==null?void 0:P.length)??0,E=s==null?void 0:s.offre,q=(s==null?void 0:s.pool_meta)||[],A=u.useMemo(()=>{const L=new Map;for(const F of(s==null?void 0:s.scheduled)||[])for(const x of F.names||[])L.has(x)||L.set(x,{label:F.day_label,date:F.date});return L},[s==null?void 0:s.scheduled]),R=(s==null?void 0:s.in_progress)||[];return t.jsxs(_e,{title:e.queueTitle,wide:!0,children:[E&&t.jsxs("div",{className:"qoffre"+(E.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:E.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:E.delai})]}),t.jsx("span",{className:"osp"}),E.rythme>0?t.jsx("span",{className:"or",children:e.qRate(E.rythme)}):E.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(E.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(z,z+(((B=s==null?void 0:s.pool_order)==null?void 0:B.length)??0))}})}),E&&t.jsxs("div",{className:"qeta",children:[E.file===0?e.qEtaDone:E.rythme<=0?e.qEtaPaused:e.qEta(E.file,E.rythme,E.jours_restants),E.en_retard&&t.jsxs("em",{children:[" ",e.qLate(E.delai,E.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(E==null?void 0:E.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(R.length>0||g.items.some(L=>L.status==="boot"||L.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(L=>L.status==="boot"||L.status==="running"||L.status==="error").map(L=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:L.name}),t.jsx("span",{className:"qd",children:L.memoType||""}),t.jsx(Qt,{item:L,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+L.name)),R.filter(L=>!g.liveOf(L.name)).map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.name}),t.jsxs("span",{className:"qd",children:[L.memo_type||"",L.age_min?` · ${Math.round(L.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:L.state||""})]},"ip-"+L.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.company}),t.jsxs("span",{className:"qd",children:[L.memo_type,typeof L.est_min=="number"?` · ~${L.est_min} min`:""]}),t.jsx("span",{className:"qt",children:L.status}),L.url&&t.jsx("a",{className:"qgo",href:L.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),N&&L.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Bn(a,L.company,"retry").then(()=>f(F=>F+1))},children:e.queueRetry}),N&&L.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Bn(a,L.company,"delete").then(()=>f(F=>F+1))},children:e.queueDelete})]},L.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(q.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&q.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),q.map((L,F)=>{const x=A.get(L.name),T=S.get((L.name||"").trim().toLowerCase()),I=g.liveOf(L.name),G=!!(T&&l.has(T.id))||!!(I&&(I.status==="boot"||I.status==="running")),W=!!(T&&ze(T)===1&&!T.memoUrl)&&!I;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",F+1]}),x?t.jsx("span",{className:"qwhen"+(x.label==="demain"?" soon":""),children:x.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:L.name}),L.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof L.score=="number"&&t.jsx("span",{className:"qs2",children:L.score}),I&&(I.status==="boot"||I.status==="running")&&t.jsx(Qt,{item:I,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),W&&(d.lockActions||!N?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:G,onClick:()=>{i(T),f(Q=>Q+1)},children:G?e.actAnalyseQueued:e.actAnalyse})),L.excerpt&&t.jsx("span",{className:"qex",children:L.excerpt})]},L.name+":"+F)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([L,F])=>t.jsxs("li",{children:[t.jsx("b",{children:L})," — ",F]},L))})]})}function zd(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:l}=V(),d=`${Ft}/cibles/list.csv?token=${a}`,c=`${Ft}/cibles/list.json?token=${a}`,g=`${Ft}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,h=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:g,href:g}],v=!o.lockActions&&n.length>0,m=()=>{md(ud(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(_e,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:y,value:f,href:N})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>h(f),children:e.exportCopy}),N&&t.jsx("a",{className:"exb",href:N,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Ad(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=V(),i=o!=="client",[l,d]=u.useState(null),[c,g]=u.useState(!1),[s,h]=u.useState(0),[p,v]=u.useState(!1);u.useEffect(()=>{let f=!0;return g(!1),In(a).then(N=>{f&&(N?d(N):g(!0))}),()=>{f=!1}},[a,s]);const m=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=f=>{if(i||!l)return;const N={enabled:f.enabled??!!l.enabled,email:f.email??(l.email||""),sections:f.sections??m()};v(!0),In(a,N).then(S=>{if(v(!1),!S){n(e.memoAlertErr);return}d(S),r(e.memoAlertSaved)})};if(c)return t.jsx(_e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>h(f=>f+1),children:e.retry})]})});if(!l)return t.jsx(_e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs(_e,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:i||p,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Td,{value:l.email||"",readOnly:i||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>b({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,N])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:i||p,onChange:()=>b({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:N})]},f))}),t.jsx(zn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>wi(a,y),onTest:()=>yi(a,y)})]})}function Td({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,l]=u.useState(e);u.useEffect(()=>{l(e)},[e]);const d=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&d&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>o(i.trim()),children:n})]})]})}function qd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=V(),[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(null),[h,p]=u.useState(""),[v,m]=u.useState(0);u.useEffect(()=>{let S=!0;return c(!1),Qa(a).then(k=>{S&&(k?l({configured:k.configured,url_hint:k.url_hint}):c(!0))}),Ni(a).then(k=>{S&&s(k)}),()=>{S=!1}},[a,v]);const b=(S,k)=>{o&&Qa(a,S).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}S.test&&j.sent===!1?n(e.plugTestThrottled):r(k),m(z=>z+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',f=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),N=`curl -X POST ${Ft}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(_e,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(S=>S+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:h,disabled:!o,onChange:S=>p(S.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!h.trim(),onClick:()=>b({url:h.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:f}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(f).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Ld,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:N}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(N).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Ld(){const{t:e,token:a,lang:r}=V(),[n,o]=u.useState("valides"),[i,l]=u.useState(!1),[d,c]=u.useState(null),[g,s]=u.useState(null),[h,p]=u.useState(!1),[v,m]=u.useState(!1),[b,y]=u.useState(null),[f,N]=u.useState(null),[S,k]=u.useState(null),j=`atl2:bulk:${a}:${n}`;u.useEffect(()=>{Qa(a).then(B=>{N(B&&B.configured?B.url_hint||"webhook":null)})},[a]),u.useEffect(()=>{c(null),s(null),p(!1),y(null);try{const B=JSON.parse(localStorage.getItem(j)||"null");k(B&&Date.now()-Date.parse(B.t)<24*3600*1e3?B:null)}catch{k(null)}},[j]);const z=async()=>{l(!0),p(!1),y(null);const B=await Si(a,n);c(B),s(B.ok?n:null),l(!1)},E=u.useRef(!1),q=async()=>{if(E.current)return;E.current=!0,m(!0);const B=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await Ci(a,n,"webhook",void 0,B)}finally{E.current=!1}if(m(!1),p(!1),y(L),L.ok&&(L.pushed||0)>0){const F={t:new Date().toISOString(),n:L.pushed||0};k(F);try{localStorage.setItem(j,JSON.stringify(F))}catch{}}},A=d!=null&&d.ok&&d.ready||0,R=!!(d!=null&&d.ok)&&g===n&&A>0&&!!f&&!S,P=S?new Date(S.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:B=>o(B.target.value),children:e.plugBulkTabs.map(([B,L])=>t.jsx("option",{value:B,children:L},B))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{z()},children:i?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),S&&t.jsx("p",{className:"mnote",children:e.bulkLocked(P,S.n)}),!S&&!!(d!=null&&d.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!S&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),R&&!h&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),R&&h&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(A,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{q()},children:v?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>p(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function Fd(){const{t:e,data:a,lang:r}=V(),n=a.credits,o=a.email,i=async l=>{if(!o)return;const d=window.location.href.split("?")[0];try{const g=await(await fetch(`${fn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(_e,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Rd(){const{t:e}=V();return t.jsx(_e,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(xd,{})})}function Md(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:l,flash:d}=V(),[c,g]=u.useState(null),[s,h]=u.useState(!1);u.useEffect(()=>{let A=!0;if(i)return xn(i).then(R=>{A&&R&&typeof R.per_day=="number"&&g(R.per_day)}),()=>{A=!1}},[i]);const[p,v]=u.useState(null);u.useEffect(()=>{if(!o)return;let A=!0;return ji(o).then(R=>{A&&v(R)}),()=>{A=!1}},[o]);const m=r.stats,b=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(A=>A.kind==="target"&&$e(A)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(b/y*100)):null,N=(m==null?void 0:m.window_days)||30,S=b>0?b/N:0,k=y>0?Math.max(0,y-b):0,z=y>0&&S>0&&b>=100?Math.round(k/S):null,E=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),q=A=>{s||!l||(h(!0),Ei(o,A).then(R=>{if(h(!1),R===null){d(e.actErr);return}g(R),d(e.alertSaved)}))};return t.jsxs(_e,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(E(b))}),y>0&&t.jsx("span",{children:e.covOf(E(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),z!==null&&t.jsx("p",{className:"mnote",children:e.covEta(z)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),S>=1&&t.jsx("p",{className:"mnote",children:e.covPace(E(S))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:E(m.shown)})," ",e.funShown]})]}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((A,R)=>t.jsxs("tr",{className:A.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[A.code,A.geo?` · ${A.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof A.n=="number"?E(A.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:A.source}),A.elargi&&t.jsx("em",{children:e.covWide(String(A.demande||""))}),A.erreur&&t.jsx("em",{children:e.covMissing})]})]},R)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:E(p.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:c===A?"on":"",disabled:s,onClick:()=>q(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Od(){var f,N,S;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:l,lang:d}=V(),c=n==="client",g=u.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[s,h]=u.useState(""),[p,v]=u.useState(""),[m,b]=u.useState(!1),y=async()=>{const k=s.trim();if(!(!k||m||!c)){b(!0),v("");try{const z=await(await fetch(`${Ft}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(z.reply&&v(String(z.reply)),z.job_id){v(e.critChatRunning);const E=async()=>{const q=await fetch(`${Ft}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:z.job_id})}).then(A=>A.json()).catch(()=>null);if(q&&q.done){v(String(q.reply||q.clarification||q.summary||"✓")),b(!1),q.applied&&o(e.alertSaved);return}setTimeout(()=>{E()},8e3)};setTimeout(()=>{E()},8e3),h("");return}h("")}finally{p.startsWith("⏳")||b(!1)}}};return t.jsxs(_e,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((N=i==null?void 0:i.angles)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,z;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(E=>t.jsx("li",{children:E},E))})]}),!!((z=k.out)!=null&&z.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(E=>t.jsx("li",{children:E},E))})]})]})]},k.title)})]}),!!((S=i==null?void 0:i.gate)!=null&&S.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||m,onChange:k=>h(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ki,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(bo[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Dd(){const{t:e,dispatch:a,startTour:r}=V(),n=o=>{var i,l;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(_e,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+l))})]})}const ko="atl2:mapfold",Pd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(ko);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Id=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},jo=u.createContext(null),V=()=>{const e=u.useContext(jo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function ft({o:e,lg:a}){const{lang:r}=V(),n=Re(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Un(n,r),children:[n.emoji," ",Un(n,r)]}):null}function Fa({o:e,src:a}){const{lang:r,t:n}=V(),o=Re(e);if(!o)return null;const i=Di(o),l=Pi(o);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Pr(o,r))+" · "+n.win7(Ir(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Bd(e,a,r){const n=(r||"").trim();if(n){const i=e.find(l=>(l.url||"")===n);if(i)return i}const o=Pe(a);if(o)return e.find(i=>Pe(i.name)===o)||e.find(i=>{const l=Pe(i.name);return l.length>=3&&(o.includes(l)||l.includes(o))})}function $d(){const{scoped:e,t:a,st:r,dispatch:n}=V(),o=u.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,l=e.filter(h=>!We(h)),d=l.length,c=l.filter(h=>!h.noCo).length,g=l.filter(h=>!!h.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const h=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:h,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function _d(){const{t:e,lang:a,data:r,dispatch:n}=V(),o=r.stats,i=d=>d.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const l=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:l>0?e.covOf(i(l)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function No({o:e}){const{lang:a}=V(),r=Oi(e.cc),n=e.cc?Pt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Ar="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Ud=!1;function Hd(){const[e,a]=u.useState(!1);return u.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Eo=e=>`atl2:tour:${e||"anon"}`;function Vd(e){try{return localStorage.getItem(Eo(e))==="1"}catch{return!0}}function Tr(e){try{localStorage.setItem(Eo(e),"1")}catch{}}function Wd(e,a,r,n,o){const i=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:i.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:i.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:i.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:i.live,body:e.fhintLive},{sel:".atl2 .goal",title:i.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:i.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:i.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:i.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:i.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:i.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:i.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:i.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:i.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:i.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:i.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:i.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:i.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Jd({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var re;const{lang:l}=Li(),d=Qi[l],c=ss(e,l,a),[g,s]=u.useReducer(cs,void 0,()=>ls((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Id():Pd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),h=u.useRef(!0);u.useEffect(()=>{if(h.current){h.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(ko,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),u.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const w=()=>{window.innerWidth<=760&&s({type:"mapFold",folded:!0})};return w(),window.addEventListener("resize",w),()=>window.removeEventListener("resize",w)},[a]);const p=u.useRef(i);p.current=i,u.useEffect(()=>{var w;(w=p.current)==null||w.call(p,g.filters)},[g.filters]);const[v,m]=u.useState(()=>{if(typeof window>"u")return"both";try{const w=localStorage.getItem("atl2:chrome-mode");if(w==="eval"||w==="filt"||w==="both")return w;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[b,y]=u.useState(null),[f,N]=u.useState(null),[S,k]=u.useState(null),[j,z]=u.useState({kept:0,dropped:0}),[E,q]=u.useState(!1),[A,R]=u.useState(""),[P,B]=u.useState(!1),[L,F]=u.useState(null),[x,T]=u.useState(!1),[I,G]=u.useState(!1),[,W]=u.useState(0),Q=()=>W(w=>w+1),X=u.useRef([]),K=u.useRef(new Set),ue=u.useRef(new Set),[ee,xe]=u.useState([]),[U,le]=u.useState([]),[me,Le]=u.useState(0),te=u.useRef(new Map),pe=u.useRef(null),{mode:he}=c,se=u.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),Y=se.pipe,ae=c.session.token||"",oe=he==="client"&&!e;u.useEffect(()=>{if(!ae||!Y)return;let w=!0;const D=async()=>{const Z=await Ii(ae);!w||!Z||(le(Z.runs),Le(Date.now()/1e3-Z.now),xe(je=>je.filter(Ne=>!Z.runs.some(et=>Pe(et.company)===Pe(Ne.name)))))};D();const M=ee.length>0||U.some(Z=>Z.status==="running"),_=window.setInterval(()=>{D()},M?8e3:25e3);return()=>{w=!1,window.clearInterval(_)}},[ae,Y,ee.length,U.some(w=>w.status==="running")]);const ge=u.useMemo(()=>{const w=[],D=new Set;for(const M of ee){const _=Pe(M.name);!_||D.has(_)||(D.add(_),w.push({name:M.name,id:M.id,status:"boot",started:M.started,estMin:M.estMin,memoType:"instant"}))}for(const M of U){const _=Pe(M.company);if(!_||D.has(_))continue;D.add(_);const Z=M.status==="error"?"error":M.status==="done"?"done":"running";w.push({name:M.company,status:Z,started:M.started||0,estMin:M.est_min||(M.memo_type==="detailed"?40:15),url:M.url,error:M.error,memoType:M.memo_type})}return w},[ee,U]),Ee=w=>ge.find(D=>Pe(D.name)===Pe(w))||null,ne=(w,D)=>{xe(M=>M.some(_=>Pe(_.name)===Pe(w.name))?M:[...M,{name:w.name,id:w.id,started:Date.now()/1e3,estMin:D==="detailed"?40:15}]),K.current.add(w.id),Q()};u.useEffect(()=>{if(document.querySelector(`link[href="${Ar}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=Ar,document.head.appendChild(w)},[]);const ce=(w,D=!1)=>{R(w),B(D),pe.current&&clearTimeout(pe.current),pe.current=setTimeout(()=>R(""),D?4200:2400)},Ie=w=>ce(w,!0),qe=u.useMemo(()=>{const w=new Map;return c.dossiers.forEach(D=>{D.id&&w.set(D.id,D)}),w},[c.dossiers]),Me=u.useMemo(()=>c.dossiers.filter(w=>bn(w,g,Y)),[c.dossiers,g,Y]),Ce=u.useRef(!1);u.useEffect(()=>{if(Ce.current||e||c.loading||!c.dossiers.length)return;if(!se.showFunnel||Vd(c.session.token||"")){Ce.current=!0;return}Ce.current=!0;const w=window.setTimeout(()=>{Tr(c.session.token||""),T(!0)},700);return()=>window.clearTimeout(w)},[e,c.loading,c.dossiers.length,se.showFunnel,c.session.token]);const ve=u.useMemo(()=>c.dossiers.filter(w=>ps(w,g,Y,c.favIds)),[c.dossiers,g,Y,c.favIds]),Ve=u.useMemo(()=>Fi(Me,c.favIds),[Me,c.favIds]),Fe=u.useRef(!1);u.useEffect(()=>{if(Fe.current)return;if(!Y||a==="ops"){Fe.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Fe.current=!0;return}if(c.loading)return;Fe.current=!0;const w=Ri(Ve);w!==g.ptab&&s({type:"ptab",tab:w})},[Y,a,n==null?void 0:n.ptab,c.loading,Ve,g.ptab]);const st=u.useMemo(()=>{const w=Gr(c.dossiers);return w?ct(w)===0?d.tourToday:Yr(w,l):d.tourNoRun},[c.dossiers,d,l]),pt=u.useMemo(()=>c.dossiers.some(w=>!!w.memoUrl||!!w.summary||Rt(w)),[c.dossiers]),[xt,tt]=u.useState(!1);u.useEffect(()=>{if(c.loading){tt(!1);return}if(c.dossiers.length>0||c.error){tt(!0);return}const w=window.setTimeout(()=>tt(!0),6e3);return()=>window.clearTimeout(w)},[c.loading,c.dossiers.length,c.error]);const gt=(c.marketEstimate||0)>0||typeof((re=c.stats)==null?void 0:re.screened)=="number"&&c.stats.screened>0,bt=u.useMemo(()=>[1,0,2,4,5,3].find(w=>(Ve[w]||0)>0)??0,[Ve]),Je=gn.find(w=>w.key===g.continent),ut=g.continent==="monde"?d.contWorld:(l==="fr"?Je==null?void 0:Je.fr:Je==null?void 0:Je.en)||"";u.useEffect(()=>{const w=D=>{var _;const M=(((_=D.detail)==null?void 0:_.name)||"").trim();M&&vt(null,M)};return window.addEventListener("ppmap:evaluate",w),()=>window.removeEventListener("ppmap:evaluate",w)}),u.useEffect(()=>{const w=D=>{const M=D.detail||{},_=String(M.id||"").trim(),Z=String(M.name||"").trim(),je=String(M.url||"").trim(),Ne=_&&qe.get(_)||Bd(c.dossiers,Z,je);if(Ne){if(N(null),Y){const ye=ze(Ne);typeof ye=="number"&&ye!==g.ptab&&s({type:"ptab",tab:ye})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Ne.id}),(Ne.noCo||["media","nominations","recrutements"].includes(Ne.engine||""))&&(Ne.url||Ne.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ne.url||"",text:[Ne.headline,Ne.tagline].filter(Boolean).join(`
`)}})):Ne.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ne.name,url:Ne.url||"",website:Ne.website||"",domain:Ne.domain||""}}));return}!Z&&!je||(s({type:"focus",id:_||null}),N({name:Z,headline:String(M.text||"").trim()||Z,url:je,card:M.card}),je&&(wa(Z)||!Z)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:je,text:String(M.text||"").trim()}})):Z&&!wa(Z)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Z}})))};return window.addEventListener("ppmap:focus",w),()=>window.removeEventListener("ppmap:focus",w)}),u.useEffect(()=>{const w=_=>{const Z={},je=String((_==null?void 0:_.sector)||"").trim();je&&(Z.sector=[je]);const Ne=String((_==null?void 0:_.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ne)&&(Z.day=Ne);const et=String((_==null?void 0:_.search)||"").trim();et&&(Z.search=et);const ye=String((_==null?void 0:_.dealKind)||"").trim();(ye==="ma"||ye==="levee"||ye==="other")&&(Z.dealKind=[ye]),Object.keys(Z).length&&s({type:"filters",patch:Z})},D=_=>w(_.detail),M=_=>{_.data&&_.data.type==="pp-filter"&&w(_.data)};return window.addEventListener("ppmap:filter",D),window.addEventListener("message",M),()=>{window.removeEventListener("ppmap:filter",D),window.removeEventListener("message",M)}},[]),u.useEffect(()=>{const w=D=>{var Z;const M=(((Z=D.detail)==null?void 0:Z.name)||"").trim().toLowerCase();if(!M)return;const _=c.dossiers.find(je=>(je.name||"").trim().toLowerCase()===M);_&&s(a==="ops"?{type:"focus",id:_.id}:{type:"popup",id:_.id})};return window.addEventListener("ppmap:similar",w),()=>window.removeEventListener("ppmap:similar",w)});const vt=(w,D)=>{const M=((w==null?void 0:w.name)||D||"").trim();if(!oe){k({kicker:M});return}!M||E||(q(!0),(async()=>{try{let _=M;const Z=((w==null?void 0:w.website)||(w==null?void 0:w.domain)||"").trim();if(Z)_=Z;else try{const ye=await Or(M);if(ye!=null&&ye.website)_=ye.website;else if(((ye==null?void 0:ye.candidates)||[]).length===1)_=ye.candidates[0].url;else if(((ye==null?void 0:ye.candidates)||[]).length>1){X.current=[{name:M,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(ye.candidates||[]).slice(0,5)},...X.current].slice(0,8),Q();return}}catch{}const je=await Dr(ae,_,"atelier2"),Ne={name:je.company||M,verdict:je.verdict,reason:je.reason||"",remaining:je.remaining??null};X.current=[Ne,...X.current].slice(0,8),je.verdict==="kept"&&z(ye=>({...ye,kept:ye.kept+1})),je.verdict==="ruled_out"&&z(ye=>({...ye,dropped:ye.dropped+1}));const et=w||c.dossiers.find(ye=>(ye.name||"").toLowerCase()===M.toLowerCase());et&&(je.verdict==="kept"?et.verdict=et.verdict||"MATCH":je.verdict==="ruled_out"&&(et.verdict="NO MATCH"),je.reason&&(et.reasoning=je.reason)),Q()}finally{q(!1)}})())},C=w=>{if(!oe){k({kicker:w.name});return}ne(w,"instant"),Ut(ae,"fast_request",w.name||"",""),ce(d.memoInstantSent(w.name))},$=w=>te.current.get(w.id)??c.thumbs.get((w.name||"").trim().toLowerCase()),H=(w,D)=>s({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:D}}),de=async(w,D,M)=>{const _=w.ceoStatus||"";w.ceoStatus=D,Q();const Z=await Da(ae,{status:D,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(M==null?void 0:M.note)!==void 0?{note:M.note}:{},...M!=null&&M.via?{via:M.via}:{}});return Z.ok?Z.skipped?(w.ceoStatus=_,Q(),Ie(d.actNotPersisted),!1):((M==null?void 0:M.undo)!==!1&&H(w,_),M!=null&&M.msg&&ce(M.msg),(D==="Validé"||D==="Écarté")&&!w.ceoNote&&(M==null?void 0:M.note)===void 0&&F({o:w,yes:D==="Validé"}),!0):(w.ceoStatus=_,Q(),Ie(d.actErr),!1)},be=async(w,D)=>{const M=await Da(ae,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:D,via:"note"});return!M.ok||M.skipped?(Ie(M.skipped?d.actNotPersisted:d.actErr),!1):(w.ceoNote=D,Q(),!0)},ie=u.useRef(new Map),we=w=>ie.current.has(w.id)?ie.current.get(w.id):c.stages.get((w.name||"").trim().toLowerCase()),Xe=(w,D)=>{ie.current.set(w.id,D),Q()},yt=(w,D)=>{oe&&de(w,D?"Validé":"Écarté",{msg:D?d.decidedYes(w.name):d.decidedNo(w.name)})},mt=w=>{oe&&de(w,"À trancher",{msg:d.promoted(w.name)})},Bt=w=>{oe&&(async()=>{const D=w.ceoStatus||"";w.ceoStatus="Retenu",Q();const M=await Da(ae,{status:"Retenu",check_id:w.checkId,company:w.name});if(!M.ok||M.skipped){w.ceoStatus=D,Q(),Ie(M.skipped?d.actNotPersisted:d.actErr);return}H(w,D),ce(d.repeched(w.name))})()},Tt=()=>{const w=g.undo[g.undo.length-1];if(!w){ce(d.undoNone);return}const D=qe.get(w.id);if(!D){s({type:"undoPop"}),ce(d.undoNone);return}let M=w.prevCeoStatus;if(!M)if((D.verdict||"").toUpperCase().includes("CALL"))M="À trancher";else{ce(d.undoLockedTitle);return}(async()=>await de(D,M,{undo:!1})&&(s({type:"undoPop"}),D.ceoStatus=w.prevCeoStatus,Q(),ce(d.undoDone(D.name))))()},Oe=w=>{oe&&(ue.current.add(w.id),Q(),(async()=>{const D=await Bi(ae,w.name,"email");if(!D||D.ok===!1){ue.current.delete(w.id),Q(),Ie(d.actErr);return}Ut(ae,"approach",w.name||"",""),ce(d.actApproachSent)})())},De=(w,D)=>{oe&&(async()=>{if(!(await Ut(ae,D?"yes":"no",w.name||"","")).ok){Ie(d.actErr);return}te.current.set(w.id,D?"yes":"no"),Q(),ce(D?d.thumbUpDone:d.thumbDnDone)})()},Ze=w=>{!oe||!Rt(w)||(ne(w,"detailed"),Ut(ae,"detailed_request",w.name||"",""),ce(d.memoDeepSent(w.name)))},$t=w=>{const D=new Set(c.favIds),M=D.has(w.id);M?D.delete(w.id):D.add(w.id),c.setFavIds(D),oe&&$i(ae,{id:w.id,co:w.name},M)},_t=()=>{!oe||I||window.confirm(d.identSyncConfirm)&&(G(!0),(async()=>{const w=await _i(ae);G(!1),w?ce(d.identSyncDone):Ie(d.actErr)})())},ra=/proplace/i.test(c.fund||""),Ra=w=>{!oe||!ra||(Ut(ae,"onboard_request",w.name||"",""),ce(d.onboardSent(w.name)))},O={st:g,dispatch:s,t:d,lang:l,mode:he,caps:se,pipe:Y,token:ae,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:Bt,thumbOf:$,canWrite:oe,commitStatus:de,saveNote:be,stageOf:we,setStage:Xe,flashErr:Ie,startTour:()=>T(!0),dossiers:c.dossiers,scopedAll:Me,scoped:ve,counts:Ve,byId:qe,contName:ut,favIds:c.favIds,toggleFav:$t,askEvaluate:vt,doAnalyse:C,doDecide:yt,doPromote:mt,doApproach:Oe,doThumb:De,doDeep:Ze,doUndo:Tt,doSync:_t,doOnboard:Ra,outbound:ra,memoQueued:K.current,liveMemos:{items:ge,serverOff:me,liveOf:Ee},approachDone:ue.current,sessTally:j,evalCards:X.current,evalBusy:E,markRow:y,markedId:b,flash:ce,focusExtra:f};u.useEffect(()=>{const w=D=>{D.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]);const J=w=>ae?t.jsx(fs,{token:ae,children:w}):t.jsx(t.Fragment,{children:w});return t.jsx(jo.Provider,{value:O,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ae?" cibles":"")+" chrome-"+v,children:[t.jsx("style",{children:Zi}),J(t.jsxs("div",{className:"app"+(Y?" pipe":"")+(ae?" has-thesis":""),children:[se.showTicker&&t.jsx(at,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ae?" live-stack--cibles":""),children:[t.jsx(ws,{}),!!ae&&t.jsx(hs,{})]})}),se.showIdent&&t.jsx(at,{name:"identite",children:t.jsx(Ls,{})}),!1,Ud,se.showFunnel&&t.jsx(at,{name:"entonnoir",children:t.jsx(Gd,{})}),!g.mapFolded&&t.jsx(at,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(ho,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx($d,{}),a!=="ops"&&se.showFunnel&&t.jsx(_d,{}),t.jsx(Tl,{}),t.jsx(fo,{})]})]})}),se.showDemand&&Y&&t.jsx(at,{name:"direct",children:t.jsx(Gi,{items:ge,serverOff:me,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":d.chromeBoth,children:[["eval",d.chromeEval],["filt",d.chromeFilt],["both",d.chromeBoth]].map(([w,D])=>t.jsx("button",{type:"button",role:"tab","aria-selected":v===w,onClick:()=>{m(w);try{localStorage.setItem("atl2:chrome-mode",w)}catch{}},children:D},w))}),se.showDemand&&t.jsx(at,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Dl,{})})}),se.showDemand&&g.memoConsole&&t.jsx(at,{name:"console",children:t.jsx(Il,{})}),t.jsx(at,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(cd,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(at,{name:"fiche",children:t.jsx(Gl,{})}),t.jsx(at,{name:"modales",children:t.jsx(bd,{})}),t.jsx(Ns,{}),L&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:L.o.name}),t.jsx(zs,{placeholder:L.yes?d.whyYesPh:d.whyNoPh,onDone:w=>{const D=L.o;F(null),w&&be(D,w).then(M=>{M&&ce(d.csNoteSaved)})}})]}),x&&xt&&t.jsx(Ts,{steps:Wd(d,st,pt,bt,gt),onClose:()=>{T(!1),Tr(ae)}}),t.jsx(Hd,{}),se.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:Vr,children:wn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),A&&t.jsx("div",{className:"flash on"+(P?" err":""),children:A}),S&&t.jsx(Mi,{variant:"acquirer",initialCompany:qr().co,initialWebsite:qr().site,onClose:()=>k(null)})]})})}function Gd(){const{t:e}=V(),[a,r]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function qr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Yd(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{No as FlagCell,ft as SigBadge,Fa as SigWin,Jd as default,Yd as fmtShort,V as useV2};
