...
`;class fe extends g.Component{constructor(){super(...arguments);La(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const $o=8;function _o(){const{t:e,lang:a,token:r,dossiers:n,caps:o,markRow:i,dispatch:c}=F(),[s,p]=g.useState(!1),[u,d]=g.useState(!1),[l,m]=g.useState(!1),h=r||"home",{names:f,verdicts:b}=g.useMemo(()=>{const w=[],j={};return n.forEach(S=>{S.kind!=="target"||!S.name||(w.push(S.name),j[S.name]=Tr(S)||"")}),{names:w,verdicts:j}},[n]),v=g.useMemo(()=>f.length?Ar(h,f,b,a):null,[h,f.length]);if(!o.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const x=u?v.added:v.added.slice(0,$o),y=v.added.length-x.length,N=w=>{const j=n.find(S=>S.name===w);j&&(i(j.id),c({type:"popup",id:j.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Lr(h,f,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[x.map(w=>t.jsx("button",{type:"button",onClick:()=>N(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>m(w=>!w),children:e.sinceOut(v.gone.length)}),l&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Ht=600,Be=62,Ya="atl2:fstats";function Uo(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=F(),[c,s]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Ya)==="on"}catch{return!1}}),p=r.stats,u=g.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=g.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const l=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,m=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),h=u.reduce((y,N)=>Math.max(y,N.s||0),0),f=u.length?Ht/u.length:0,b=Math.max(4,f-4),v=u.length>=5&&h>0,x=[[p.screened,e.funScreened(l(d)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(c?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[x.map(([y,N,w],j)=>t.jsxs("span",{className:"fst-t",children:[j>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:m(y)}),t.jsx("i",{children:N}),c&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},N)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":c,title:c?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!c;s(y),y&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Ya,y?"on":"off")}catch{}},children:c?"⌃":"⌄"})]}),c&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ht} ${Be}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[u.map((y,N)=>{const w=(y.s||0)/h*(Be-4),j=(y.m||0)/h*(Be-4),S=N*f+(f-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${l(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:S,y:Be-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:S,y:Be-2-j,width:b,height:j,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Be-1.5,x2:Ht,y2:Be-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:l(u[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Vo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Ho({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=F(),[i,c]=g.useState(""),[s,p]=g.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const u=(e.ceoStatus||"").trim(),d=(Xe(e)||"").startsWith("CALL")&&ve(e)===3,l=ve(e)>=2,m=async f=>{if(i||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;c(f);const b=await o(e,f);c(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},h=d?[["Validé",a.csYes],["Écarté",a.csNo]]:Vo.filter(([f])=>!(l&&f==="Retenu")).map(([f,b])=>[f,a[b]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([f,b])=>t.jsx("button",{type:"button",className:"csb"+(u===f?" on":"")+(i===f?" busy":""),disabled:!!i,onClick:()=>{m(f)},children:b},f)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Yo,{o:e})]})}function Yo({o:e}){const{t:a,saveNote:r,flash:n}=F(),[o,i]=g.useState(e.ceoNote||""),[c,s]=g.useState(!1),[p,u]=g.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),l=async()=>{if(c||!d)return;s(!0);const m=await r(e,o.trim());s(!1),m&&(u(!0),setTimeout(()=>u(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:c,onChange:m=>i(m.target.value),onKeyDown:m=>{m.key==="Enter"&&l()}}),t.jsx("button",{type:"button",disabled:c||!d,onClick:()=>{l()},children:p?a.csNoteSaved:a.csNoteOk})]})}function Wo({placeholder:e,onDone:a}){const{t:r}=F(),[n,o]=g.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Go({o:e}){var v;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:c,flashErr:s}=F(),[p,u]=g.useState(!1);if(!n.pipe||!o||n.lockActions||ve(e)!==4)return null;const d=i(e),l=(d==null?void 0:d.stage)||"todo",m=async x=>{if(p||x===l)return;u(!0);const y=d;c(e,{stage:x,stamps:(d==null?void 0:d.stamps)||{}});const N=Math.max(Date.now(),Wa+=1);Wa=N;const w=await Rr(r,{company:e.name||"",stage:x,cts:N,deal_id:e.airtableId,check_id:e.checkId});u(!1),!w.stale&&(w.ok||(c(e,y),s(a.actErr)))},h=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,f=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,b=l==="sent"&&h&&f>=4;return t.jsxs("div",{className:"stg",onClick:x=>x.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([x,y])=>t.jsx("button",{type:"button",className:"stgb"+(l===x?" on":""),disabled:p,onClick:()=>{m(x)},children:y},x)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let Wa=0;const gt=8,bt=340;function Ga({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Ko({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,scoped:i,byId:c,st:s}=F(),[p,u]=g.useState(0),[d,l]=g.useState(null),[m,h]=g.useState([]),f=g.useRef(!1);g.useEffect(()=>{f.current||(f.current=!0,h(e.filter(j=>!!document.querySelector(j.need||j.sel))))},[e]);const b=m[p],v=p>=m.length;g.useEffect(()=>{b&&(b.ptab!==void 0&&s.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&s.dens!==b.dens&&n({type:"dens",dens:b.dens}))},[p,b]);const x=g.useCallback(()=>{if(!b){l(null);return}const j=document.querySelector(b.sel);if(!j){l(null);return}j.scrollIntoView({block:"nearest",behavior:"smooth"}),l(j.getBoundingClientRect())},[b]);g.useLayoutEffect(()=>{x();const j=window.setTimeout(x,260),S=()=>x();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{window.clearTimeout(j),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[x]);const y=g.useRef(a);if(y.current=a,g.useEffect(()=>{const j=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),y.current()):S.key==="ArrowRight"?u(L=>L+1):S.key==="ArrowLeft"&&u(L=>Math.max(0,L-1))};return document.addEventListener("keydown",j,!0),()=>document.removeEventListener("keydown",j,!0)},[]),!m.length)return null;let N=null;if(v){const j=o[3]||0,S=i.find(L=>L.memoUrl)||[...c.values()].find(L=>L.memoUrl);j>0?N={title:j===1?r.ahaATitle1:r.ahaATitleN(j),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:S?N={title:r.ahaBTitle,body:r.ahaBBody(S.name),btn:r.ahaBBtn,go:()=>{n({type:"memoConsole",id:S.id}),a()}}:N={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:bt};if(!v&&d){const j=d.bottom+14,L=window.innerHeight-j>190?j:Math.max(12,d.top-200);w={left:Math.min(Math.max(12,d.left+d.width/2-bt/2),window.innerWidth-bt-12),top:L,width:bt}}return Je.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-gt,top:d.top-gt,width:d.width+gt*2,height:d.height+gt*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:w,children:[v&&N?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:N.title}),t.jsx("p",{children:t.jsx(Ga,{text:N.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>u(m.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:N.go,children:N.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(p+1,m.length)}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx("p",{children:t.jsx(Ga,{text:(b==null?void 0:b.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:p===0,onClick:()=>u(j=>Math.max(0,j-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>u(j=>j+1),children:p===m.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Qo(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,dispatch:c}=F(),s=r?a:e,p=g.useMemo(()=>s.filter(x=>Qe(x.date)===0&&x.kind==="target"),[s]),u=g.useMemo(()=>r?a.filter(x=>ve(x)===0).slice().sort((x,y)=>(y.date||"").localeCompare(x.date||"")):[],[a,r]),d=g.useMemo(()=>p.filter(x=>r?ve(x)===0:!we(x)),[p,r]),l=r?u:d,m=r?a.length-u.length:p.length-d.length,h=r?a.length:p.length,f=h?Math.min(100,m/h*100):100;let b;r?b=o.morningThesis(p.length,u.length):p.length?m===0?b=o.goalSourced(p.length):m>=p.length?b=o.goalCleared:b=o.goalDone(m,p.length):b=o.goalSourced(0);const v=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&u.length&&c({type:"chainStart",queue:u.map(x=>x.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:b}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:f+"%"}})}),l.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:v,children:r?o.morningEval(l.length):i.pileMode?o.goalContinue(l.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Jo(){var k,T;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:c,dossiers:s,mode:p,doSync:u,startTour:d}=F(),[l,m]=g.useState(null),[h,f]=g.useState([]),b=p==="client";g.useEffect(()=>{if(!o||!i)return;let A=!0;return(async()=>{const[O,R]=await Promise.all([ya(i),Nn(o)]);A&&(O&&m(O),f(R))})(),()=>{A=!1}},[o,i]);const v=(l==null?void 0:l.per_day)??null,x=((k=l==null?void 0:l.pool_order)==null?void 0:k.length)??0,y=h.filter(A=>A.status==="running").length,N=g.useMemo(()=>s.filter(A=>A.kind==="target"&&we(A)).length,[s]),w=c.marketEstimate,j=typeof((T=c.stats)==null?void 0:T.screened)=="number"?c.stats.screened:N,S=w&&w>0?Math.min(100,Math.round(j/w*100)):null,L=A=>A.toLocaleString(a==="en"?"en-US":"fr-FR"),P=(i||"P").split(/\s+/).map(A=>A[0]).join("").slice(0,2).toUpperCase(),z=(()=>{const A=Date.parse(c.generatedAt||"");if(Number.isNaN(A))return"";const O=new Date(A),R=E=>String(E).padStart(2,"0");return`${R(O.getDate())}/${R(O.getMonth()+1)} à ${R(O.getHours())}:${R(O.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:P}),t.jsx("i",{children:i})]}),t.jsx("h1",{children:e.identTitle(i||"…")}),t.jsx("span",{className:"idsp"}),z&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(z)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[S===null&&j>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:L(j)})})]}),S!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:S+"%"}})}),t.jsxs("b",{children:[S," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(j,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(x)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:A=>{A.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:u,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:A=>n({type:"filters",patch:{search:A.target.value}})})]})]})]})}function Xo(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,o],i)=>{const c=i===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(c?" go":""),children:[t.jsx("span",{className:"s4n",children:i+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:o}),c&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},i)})})]})}const Zo=["--p0","--p1","--p2","--p3","--p4"];function ei(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o}=F(),i=g.useRef({});g.useEffect(()=>{i.current={...r}},[r]);const c=u=>{const d=i.current[u],l=d!==void 0?r[u]-d:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Zo[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(l>0?" up":l<0?" down":""),children:[r[u],l!==0&&t.jsxs("em",{className:"delta",children:[l>0?"+":"−",Math.abs(l)]})]})]},u)},s=(u,d,l)=>t.jsxs("button",{type:"button",className:"off"+(d?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:l.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),p=(u,d,l,m=!1)=>t.jsx("button",{type:"button",className:"tool",title:d,disabled:m,onClick:l,children:u},d);return t.jsxs("div",{className:"funnel",children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(c)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[p("↩",n.toolUndo,o,e.undo.length===0),p("↺",n.toolReset,()=>{a({type:"reset"})}),p("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),p("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const ti=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function ai(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:c}=F(),s=g.useRef(null),[p,u]=g.useState(60);g.useEffect(()=>{let h=0;const f=()=>{var N;const b=s.current;if(!b)return;const v=(N=b.parentElement)==null?void 0:N.querySelector('.funnel [aria-selected="true"]');if(!v)return;const x=v.getBoundingClientRect(),y=b.getBoundingClientRect();u(Math.max(20,Math.min(x.left+x.width/2-y.left,y.width-30)))};return h=requestAnimationFrame(f),window.addEventListener("resize",f),()=>{cancelAnimationFrame(h),window.removeEventListener("resize",f)}},[e.ptab]);const d=e.ptab;let l=r.tuto[d].p;if(d===3){const h=n.filter(v=>v.kind==="target"&&ve(v)===3),f=h.filter(v=>Xt(v)==="auto").length,b=h.filter(v=>Xt(v)==="cd").length;l=r.tutoPending(f,b,h.length)}const m=(()=>{if(c!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(h=>h.id)})};if(d===1){const h=n.filter(f=>f.kind==="target"&&ve(f)===1&&!o.has(f.id)).slice(0,10);if(h.length)return{label:r.tuto[1].a,run:()=>h.forEach(f=>i(f))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":ti[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:l}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label})]})}class _e{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],c=a+i,s=Math.abs(a)<Math.abs(i)?a-(c-i):i-(c-a);s&&(r[n++]=s),a=c}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,c=0;if(r>0){for(c=a[--r];r>0&&(n=c,o=a[--r],c=n+o,i=o-(c-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=c+o,o==n-c&&(c=n))}return c}}function*ni(e){for(const a of e)yield*a}function Rn(e){return Array.from(ni(e))}var ee=1e-6,H=Math.PI,je=H/2,Ka=H/4,Se=H*2,Re=180/H,ye=H/180,te=Math.abs,ri=Math.atan,ct=Math.atan2,ie=Math.cos,se=Math.sin,oi=Math.sign||function(e){return e>0?1:e<0?-1:0},Ve=Math.sqrt;function ii(e){return e>1?0:e<-1?H:Math.acos(e)}function dt(e){return e>1?je:e<-1?-je:Math.asin(e)}function Ne(){}function Et(e,a){e&&Ja.hasOwnProperty(e.type)&&Ja[e.type](e,a)}var Qa={Feature:function(e,a){Et(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Et(r[n].geometry,a)}},Ja={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){aa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)aa(r[n],a,0)},Polygon:function(e,a){Xa(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Xa(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Et(r[n],a)}};function aa(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Xa(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)aa(e[r],a,1);a.polygonEnd()}function He(e,a){e&&Qa.hasOwnProperty(e.type)?Qa[e.type](e,a):Et(e,a)}function na(e){return[ct(e[1],e[0]),dt(e[2])]}function Ge(e){var a=e[0],r=e[1],n=ie(r);return[n*ie(a),n*se(a),se(r)]}function vt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function zt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Yt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function yt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ra(e){var a=Ve(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function oa(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function ia(e,a){return te(e)>H&&(e-=Math.round(e/Se)*Se),[e,a]}ia.invert=ia;function si(e,a,r){return(e%=Se)?a||r?oa(en(e),tn(a,r)):en(e):a||r?tn(a,r):ia}function Za(e){return function(a,r){return a+=e,te(a)>H&&(a-=Math.round(a/Se)*Se),[a,r]}}function en(e){var a=Za(e);return a.invert=Za(-e),a}function tn(e,a){var r=ie(e),n=se(e),o=ie(a),i=se(a);function c(s,p){var u=ie(p),d=ie(s)*u,l=se(s)*u,m=se(p),h=m*r+d*n;return[ct(l*o-h*i,d*r-m*n),dt(h*o+l*i)]}return c.invert=function(s,p){var u=ie(p),d=ie(s)*u,l=se(s)*u,m=se(p),h=m*o-l*i;return[ct(l*o+m*i,d*r+h*n),dt(h*r-d*n)]},c}function li(e,a,r,n,o,i){if(r){var c=ie(a),s=se(a),p=n*r;o==null?(o=a+n*Se,i=a-p/2):(o=an(c,o),i=an(c,i),(n>0?o<i:o>i)&&(o+=n*Se));for(var u,d=o;n>0?d>i:d<i;d-=p)u=na([c,-s*ie(d),-s*se(d)]),e.point(u[0],u[1])}}function an(e,a){a=Ge(a),a[0]-=e,ra(a);var r=ii(-a[1]);return((-a[2]<0?-r:r)+Se-ee)%Se}function Mn(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Ne,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ct(e,a){return te(e[0]-a[0])<ee&&te(e[1]-a[1])<ee}function wt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function qn(e,a,r,n,o){var i=[],c=[],s,p;if(e.forEach(function(f){if(!((b=f.length-1)<=0)){var b,v=f[0],x=f[b],y;if(Ct(v,x)){if(!v[2]&&!x[2]){for(o.lineStart(),s=0;s<b;++s)o.point((v=f[s])[0],v[1]);o.lineEnd();return}x[0]+=2*ee}i.push(y=new wt(v,f,null,!0)),c.push(y.o=new wt(v,null,y,!1)),i.push(y=new wt(x,f,null,!1)),c.push(y.o=new wt(x,null,y,!0))}}),!!i.length){for(c.sort(a),nn(i),nn(c),s=0,p=c.length;s<p;++s)c[s].e=r=!r;for(var u=i[0],d,l;;){for(var m=u,h=!0;m.v;)if((m=m.n)===u)return;d=m.z,o.lineStart();do{if(m.v=m.o.v=!0,m.e){if(h)for(s=0,p=d.length;s<p;++s)o.point((l=d[s])[0],l[1]);else n(m.x,m.n.x,1,o);m=m.n}else{if(h)for(d=m.p.z,s=d.length-1;s>=0;--s)o.point((l=d[s])[0],l[1]);else n(m.x,m.p.x,-1,o);m=m.p}m=m.o,d=m.z,h=!h}while(!m.v);o.lineEnd()}}}function nn(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Wt(e){return te(e[0])<=H?e[0]:oi(e[0])*((te(e[0])+H)%Se-H)}function ci(e,a){var r=Wt(a),n=a[1],o=se(n),i=[se(r),-ie(r),0],c=0,s=0,p=new _e;o===1?n=je+ee:o===-1&&(n=-je-ee);for(var u=0,d=e.length;u<d;++u)if(m=(l=e[u]).length)for(var l,m,h=l[m-1],f=Wt(h),b=h[1]/2+Ka,v=se(b),x=ie(b),y=0;y<m;++y,f=w,v=S,x=L,h=N){var N=l[y],w=Wt(N),j=N[1]/2+Ka,S=se(j),L=ie(j),P=w-f,z=P>=0?1:-1,k=z*P,T=k>H,A=v*S;if(p.add(ct(A*z*se(k),x*L+A*ie(k))),c+=T?P+z*Se:P,T^f>=r^w>=r){var O=zt(Ge(h),Ge(N));ra(O);var R=zt(i,O);ra(R);var E=(T^P>=0?-1:1)*dt(R[2]);(n>E||n===E&&(O[0]||O[1]))&&(s+=T^P>=0?1:-1)}}return(c<-ee||c<ee&&p<-1e-12)^s&1}function On(e,a,r,n){return function(o){var i=a(o),c=Mn(),s=a(c),p=!1,u,d,l,m={point:h,lineStart:b,lineEnd:v,polygonStart:function(){m.point=x,m.lineStart=y,m.lineEnd=N,d=[],u=[]},polygonEnd:function(){m.point=h,m.lineStart=b,m.lineEnd=v,d=Rn(d);var w=ci(u,n);d.length?(p||(o.polygonStart(),p=!0),qn(d,pi,w,r,o)):w&&(p||(o.polygonStart(),p=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),p&&(o.polygonEnd(),p=!1),d=u=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function h(w,j){e(w,j)&&o.point(w,j)}function f(w,j){i.point(w,j)}function b(){m.point=f,i.lineStart()}function v(){m.point=h,i.lineEnd()}function x(w,j){l.push([w,j]),s.point(w,j)}function y(){s.lineStart(),l=[]}function N(){x(l[0][0],l[0][1]),s.lineEnd();var w=s.clean(),j=c.result(),S,L=j.length,P,z,k;if(l.pop(),u.push(l),l=null,!!L){if(w&1){if(z=j[0],(P=z.length-1)>0){for(p||(o.polygonStart(),p=!0),o.lineStart(),S=0;S<P;++S)o.point((k=z[S])[0],k[1]);o.lineEnd()}return}L>1&&w&2&&j.push(j.pop().concat(j.shift())),d.push(j.filter(di))}}return m}}function di(e){return e.length>1}function pi(e,a){return((e=e.x)[0]<0?e[1]-je-ee:je-e[1])-((a=a.x)[0]<0?a[1]-je-ee:je-a[1])}const rn=On(function(){return!0},ui,mi,[-H,-je]);function ui(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,c){var s=i>0?H:-H,p=te(i-a);te(p-H)<ee?(e.point(a,r=(r+c)/2>0?je:-je),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&p>=H&&(te(a-n)<ee&&(a-=n*ee),te(i-s)<ee&&(i-=s*ee),r=fi(a,r,i,c),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=c),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function fi(e,a,r,n){var o,i,c=se(e-r);return te(c)>ee?ri((se(a)*(i=ie(n))*se(r)-se(n)*(o=ie(a))*se(e))/(o*i*c)):(a+n)/2}function mi(e,a,r,n){var o;if(e==null)o=r*je,n.point(-H,o),n.point(0,o),n.point(H,o),n.point(H,0),n.point(H,-o),n.point(0,-o),n.point(-H,-o),n.point(-H,0),n.point(-H,o);else if(te(e[0]-a[0])>ee){var i=e[0]<a[0]?H:-H;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function xi(e){var a=ie(e),r=2*ye,n=a>0,o=te(a)>ee;function i(d,l,m,h){li(h,e,r,m,d,l)}function c(d,l){return ie(d)*ie(l)>a}function s(d){var l,m,h,f,b;return{lineStart:function(){f=h=!1,b=1},point:function(v,x){var y=[v,x],N,w=c(v,x),j=n?w?0:u(v,x):w?u(v+(v<0?H:-H),x):0;if(!l&&(f=h=w)&&d.lineStart(),w!==h&&(N=p(l,y),(!N||Ct(l,N)||Ct(y,N))&&(y[2]=1)),w!==h)b=0,w?(d.lineStart(),N=p(y,l),d.point(N[0],N[1])):(N=p(l,y),d.point(N[0],N[1],2),d.lineEnd()),l=N;else if(o&&l&&n^w){var S;!(j&m)&&(S=p(y,l,!0))&&(b=0,n?(d.lineStart(),d.point(S[0][0],S[0][1]),d.point(S[1][0],S[1][1]),d.lineEnd()):(d.point(S[1][0],S[1][1]),d.lineEnd(),d.lineStart(),d.point(S[0][0],S[0][1],3)))}w&&(!l||!Ct(l,y))&&d.point(y[0],y[1]),l=y,h=w,m=j},lineEnd:function(){h&&d.lineEnd(),l=null},clean:function(){return b|(f&&h)<<1}}}function p(d,l,m){var h=Ge(d),f=Ge(l),b=[1,0,0],v=zt(h,f),x=vt(v,v),y=v[0],N=x-y*y;if(!N)return!m&&d;var w=a*x/N,j=-a*y/N,S=zt(b,v),L=yt(b,w),P=yt(v,j);Yt(L,P);var z=S,k=vt(L,z),T=vt(z,z),A=k*k-T*(vt(L,L)-1);if(!(A<0)){var O=Ve(A),R=yt(z,(-k-O)/T);if(Yt(R,L),R=na(R),!m)return R;var E=d[0],M=l[0],_=d[1],W=l[1],J;M<E&&(J=E,E=M,M=J);var pe=M-E,B=te(pe-H)<ee,le=B||pe<ee;if(!B&&W<_&&(J=_,_=W,W=J),le?B?_+W>0^R[1]<(te(R[0]-E)<ee?_:W):_<=R[1]&&R[1]<=W:pe>H^(E<=R[0]&&R[0]<=M)){var U=yt(z,(-k+O)/T);return Yt(U,L),[R,na(U)]}}}function u(d,l){var m=n?e:H-e,h=0;return d<-m?h|=1:d>m&&(h|=2),l<-m?h|=4:l>m&&(h|=8),h}return On(c,s,i,n?[0,-e]:[-H,e-H])}function hi(e,a,r,n,o,i){var c=e[0],s=e[1],p=a[0],u=a[1],d=0,l=1,m=p-c,h=u-s,f;if(f=r-c,!(!m&&f>0)){if(f/=m,m<0){if(f<d)return;f<l&&(l=f)}else if(m>0){if(f>l)return;f>d&&(d=f)}if(f=o-c,!(!m&&f<0)){if(f/=m,m<0){if(f>l)return;f>d&&(d=f)}else if(m>0){if(f<d)return;f<l&&(l=f)}if(f=n-s,!(!h&&f>0)){if(f/=h,h<0){if(f<d)return;f<l&&(l=f)}else if(h>0){if(f>l)return;f>d&&(d=f)}if(f=i-s,!(!h&&f<0)){if(f/=h,h<0){if(f>l)return;f>d&&(d=f)}else if(h>0){if(f<d)return;f<l&&(l=f)}return d>0&&(e[0]=c+d*m,e[1]=s+d*h),l<1&&(a[0]=c+l*m,a[1]=s+l*h),!0}}}}}var nt=1e9,kt=-nt;function gi(e,a,r,n){function o(u,d){return e<=u&&u<=r&&a<=d&&d<=n}function i(u,d,l,m){var h=0,f=0;if(u==null||(h=c(u,l))!==(f=c(d,l))||p(u,d)<0^l>0)do m.point(h===0||h===3?e:r,h>1?n:a);while((h=(h+l+4)%4)!==f);else m.point(d[0],d[1])}function c(u,d){return te(u[0]-e)<ee?d>0?0:3:te(u[0]-r)<ee?d>0?2:1:te(u[1]-a)<ee?d>0?1:0:d>0?3:2}function s(u,d){return p(u.x,d.x)}function p(u,d){var l=c(u,1),m=c(d,1);return l!==m?l-m:l===0?d[1]-u[1]:l===1?u[0]-d[0]:l===2?u[1]-d[1]:d[0]-u[0]}return function(u){var d=u,l=Mn(),m,h,f,b,v,x,y,N,w,j,S,L={point:P,lineStart:A,lineEnd:O,polygonStart:k,polygonEnd:T};function P(E,M){o(E,M)&&d.point(E,M)}function z(){for(var E=0,M=0,_=h.length;M<_;++M)for(var W=h[M],J=1,pe=W.length,B=W[0],le,U,G=B[0],$=B[1];J<pe;++J)le=G,U=$,B=W[J],G=B[0],$=B[1],U<=n?$>n&&(G-le)*(n-U)>($-U)*(e-le)&&++E:$<=n&&(G-le)*(n-U)<($-U)*(e-le)&&--E;return E}function k(){d=l,m=[],h=[],S=!0}function T(){var E=z(),M=S&&E,_=(m=Rn(m)).length;(M||_)&&(u.polygonStart(),M&&(u.lineStart(),i(null,null,1,u),u.lineEnd()),_&&qn(m,s,E,i,u),u.polygonEnd()),d=u,m=h=f=null}function A(){L.point=R,h&&h.push(f=[]),j=!0,w=!1,y=N=NaN}function O(){m&&(R(b,v),x&&w&&l.rejoin(),m.push(l.result())),L.point=P,w&&d.lineEnd()}function R(E,M){var _=o(E,M);if(h&&f.push([E,M]),j)b=E,v=M,x=_,j=!1,_&&(d.lineStart(),d.point(E,M));else if(_&&w)d.point(E,M);else{var W=[y=Math.max(kt,Math.min(nt,y)),N=Math.max(kt,Math.min(nt,N))],J=[E=Math.max(kt,Math.min(nt,E)),M=Math.max(kt,Math.min(nt,M))];hi(W,J,e,a,r,n)?(w||(d.lineStart(),d.point(W[0],W[1])),d.point(J[0],J[1]),_||d.lineEnd(),S=!1):_&&(d.lineStart(),d.point(E,M),S=!1)}y=E,N=M,w=_}return L}}const sa=e=>e;var Gt=new _e,la=new _e,Fn,Pn,ca,da,Me={point:Ne,lineStart:Ne,lineEnd:Ne,polygonStart:function(){Me.lineStart=bi,Me.lineEnd=yi},polygonEnd:function(){Me.lineStart=Me.lineEnd=Me.point=Ne,Gt.add(te(la)),la=new _e},result:function(){var e=Gt/2;return Gt=new _e,e}};function bi(){Me.point=vi}function vi(e,a){Me.point=Dn,Fn=ca=e,Pn=da=a}function Dn(e,a){la.add(da*e-ca*a),ca=e,da=a}function yi(){Dn(Fn,Pn)}var Ke=1/0,Tt=Ke,pt=-Ke,At=pt,Lt={point:wi,lineStart:Ne,lineEnd:Ne,polygonStart:Ne,polygonEnd:Ne,result:function(){var e=[[Ke,Tt],[pt,At]];return pt=At=-(Tt=Ke=1/0),e}};function wi(e,a){e<Ke&&(Ke=e),e>pt&&(pt=e),a<Tt&&(Tt=a),a>At&&(At=a)}var pa=0,ua=0,rt=0,Rt=0,Mt=0,Ye=0,fa=0,ma=0,ot=0,In,Bn,Te,Ae,ke={point:Ue,lineStart:on,lineEnd:sn,polygonStart:function(){ke.lineStart=Ni,ke.lineEnd=Si},polygonEnd:function(){ke.point=Ue,ke.lineStart=on,ke.lineEnd=sn},result:function(){var e=ot?[fa/ot,ma/ot]:Ye?[Rt/Ye,Mt/Ye]:rt?[pa/rt,ua/rt]:[NaN,NaN];return pa=ua=rt=Rt=Mt=Ye=fa=ma=ot=0,e}};function Ue(e,a){pa+=e,ua+=a,++rt}function on(){ke.point=ki}function ki(e,a){ke.point=ji,Ue(Te=e,Ae=a)}function ji(e,a){var r=e-Te,n=a-Ae,o=Ve(r*r+n*n);Rt+=o*(Te+e)/2,Mt+=o*(Ae+a)/2,Ye+=o,Ue(Te=e,Ae=a)}function sn(){ke.point=Ue}function Ni(){ke.point=Ci}function Si(){$n(In,Bn)}function Ci(e,a){ke.point=$n,Ue(In=Te=e,Bn=Ae=a)}function $n(e,a){var r=e-Te,n=a-Ae,o=Ve(r*r+n*n);Rt+=o*(Te+e)/2,Mt+=o*(Ae+a)/2,Ye+=o,o=Ae*e-Te*a,fa+=o*(Te+e),ma+=o*(Ae+a),ot+=o*3,Ue(Te=e,Ae=a)}function _n(e){this._context=e}_n.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Se);break}}},result:Ne};var xa=new _e,Kt,Un,Vn,it,st,ut={point:Ne,lineStart:function(){ut.point=Ei},lineEnd:function(){Kt&&Hn(Un,Vn),ut.point=Ne},polygonStart:function(){Kt=!0},polygonEnd:function(){Kt=null},result:function(){var e=+xa;return xa=new _e,e}};function Ei(e,a){ut.point=Hn,Un=it=e,Vn=st=a}function Hn(e,a){it-=e,st-=a,xa.add(Ve(it*it+st*st)),it=e,st=a}let ln,qt,cn,dn;class pn{constructor(a){this._append=a==null?Yn:zi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==cn||this._append!==qt){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,cn=n,qt=this._append,dn=this._,this._=o}this._+=dn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Yn(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function zi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Yn;if(a!==ln){const r=10**a;ln=a,qt=function(o){let i=1;this._+=o[0];for(const c=o.length;i<c;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return qt}function Ti(e,a){let r=3,n=4.5,o,i;function c(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),He(s,o(i))),i.result()}return c.area=function(s){return He(s,o(Me)),Me.result()},c.measure=function(s){return He(s,o(ut)),ut.result()},c.bounds=function(s){return He(s,o(Lt)),Lt.result()},c.centroid=function(s){return He(s,o(ke)),ke.result()},c.projection=function(s){return arguments.length?(o=s==null?(e=null,sa):(e=s).stream,c):e},c.context=function(s){return arguments.length?(i=s==null?(a=null,new pn(r)):new _n(a=s),typeof n!="function"&&i.pointRadius(n),c):a},c.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),c):n},c.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(i=new pn(r)),c},c.projection(e).digits(r).context(a)}function Sa(e){return function(a){var r=new ha;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ha(){}ha.prototype={constructor:ha,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ca(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),He(r,e.stream(Lt)),a(Lt.result()),n!=null&&e.clipExtent(n),e}function Wn(e,a,r){return Ca(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],c=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-c*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(i-c*(n[1][1]+n[0][1]))/2;e.scale(150*c).translate([s,p])},r)}function Ai(e,a,r){return Wn(e,[[0,0],a],r)}function Li(e,a,r){return Ca(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),c=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([c,s])},r)}function Ri(e,a,r){return Ca(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),c=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([c,s])},r)}var un=16,Mi=ie(30*ye);function fn(e,a){return+a?Oi(e,a):qi(e)}function qi(e){return Sa({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Oi(e,a){function r(n,o,i,c,s,p,u,d,l,m,h,f,b,v){var x=u-n,y=d-o,N=x*x+y*y;if(N>4*a&&b--){var w=c+m,j=s+h,S=p+f,L=Ve(w*w+j*j+S*S),P=dt(S/=L),z=te(te(S)-1)<ee||te(i-l)<ee?(i+l)/2:ct(j,w),k=e(z,P),T=k[0],A=k[1],O=T-n,R=A-o,E=y*O-x*R;(E*E/N>a||te((x*O+y*R)/N-.5)>.3||c*m+s*h+p*f<Mi)&&(r(n,o,i,c,s,p,T,A,z,w/=L,j/=L,S,b,v),v.point(T,A),r(T,A,z,w,j,S,u,d,l,m,h,f,b,v))}}return function(n){var o,i,c,s,p,u,d,l,m,h,f,b,v={point:x,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=j},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function x(P,z){P=e(P,z),n.point(P[0],P[1])}function y(){l=NaN,v.point=N,n.lineStart()}function N(P,z){var k=Ge([P,z]),T=e(P,z);r(l,m,d,h,f,b,l=T[0],m=T[1],d=P,h=k[0],f=k[1],b=k[2],un,n),n.point(l,m)}function w(){v.point=x,n.lineEnd()}function j(){y(),v.point=S,v.lineEnd=L}function S(P,z){N(o=P,z),i=l,c=m,s=h,p=f,u=b,v.point=N}function L(){r(l,m,d,h,f,b,i,c,o,s,p,u,un,n),v.lineEnd=w,w()}return v}}var Fi=Sa({point:function(e,a){this.stream.point(e*ye,a*ye)}});function Pi(e){return Sa({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Di(e,a,r,n,o){function i(c,s){return c*=n,s*=o,[a+e*c,r-e*s]}return i.invert=function(c,s){return[(c-a)/e*n,(r-s)/e*o]},i}function mn(e,a,r,n,o,i){if(!i)return Di(e,a,r,n,o);var c=ie(i),s=se(i),p=c*e,u=s*e,d=c/e,l=s/e,m=(s*r-c*a)/e,h=(s*a+c*r)/e;function f(b,v){return b*=n,v*=o,[p*b-u*v+a,r-u*b-p*v]}return f.invert=function(b,v){return[n*(d*b-l*v+m),o*(h-l*b-d*v)]},f}function Ii(e){return Bi(function(){return e})()}function Bi(e){var a,r=150,n=480,o=250,i=0,c=0,s=0,p=0,u=0,d,l=0,m=1,h=1,f=null,b=rn,v=null,x,y,N,w=sa,j=.5,S,L,P,z,k;function T(E){return P(E[0]*ye,E[1]*ye)}function A(E){return E=P.invert(E[0],E[1]),E&&[E[0]*Re,E[1]*Re]}T.stream=function(E){return z&&k===E?z:z=Fi(Pi(d)(b(S(w(k=E)))))},T.preclip=function(E){return arguments.length?(b=E,f=void 0,R()):b},T.postclip=function(E){return arguments.length?(w=E,v=x=y=N=null,R()):w},T.clipAngle=function(E){return arguments.length?(b=+E?xi(f=E*ye):(f=null,rn),R()):f*Re},T.clipExtent=function(E){return arguments.length?(w=E==null?(v=x=y=N=null,sa):gi(v=+E[0][0],x=+E[0][1],y=+E[1][0],N=+E[1][1]),R()):v==null?null:[[v,x],[y,N]]},T.scale=function(E){return arguments.length?(r=+E,O()):r},T.translate=function(E){return arguments.length?(n=+E[0],o=+E[1],O()):[n,o]},T.center=function(E){return arguments.length?(i=E[0]%360*ye,c=E[1]%360*ye,O()):[i*Re,c*Re]},T.rotate=function(E){return arguments.length?(s=E[0]%360*ye,p=E[1]%360*ye,u=E.length>2?E[2]%360*ye:0,O()):[s*Re,p*Re,u*Re]},T.angle=function(E){return arguments.length?(l=E%360*ye,O()):l*Re},T.reflectX=function(E){return arguments.length?(m=E?-1:1,O()):m<0},T.reflectY=function(E){return arguments.length?(h=E?-1:1,O()):h<0},T.precision=function(E){return arguments.length?(S=fn(L,j=E*E),R()):Ve(j)},T.fitExtent=function(E,M){return Wn(T,E,M)},T.fitSize=function(E,M){return Ai(T,E,M)},T.fitWidth=function(E,M){return Li(T,E,M)},T.fitHeight=function(E,M){return Ri(T,E,M)};function O(){var E=mn(r,0,0,m,h,l).apply(null,a(i,c)),M=mn(r,n-E[0],o-E[1],m,h,l);return d=si(s,p,u),L=oa(a,M),P=oa(d,L),S=fn(L,j),R()}function R(){return z=k=null,T}return function(){return a=e.apply(this,arguments),T.invert=a.invert&&A,O()}}function Gn(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Gn.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,c=i*i;r-=o=(r*(1.007226+i*(.015085+c*(-.044475+.028874*i-.005916*c)))-a)/(1.007226+i*(.015085*3+c*(-.044475*7+.028874*9*i-.005916*11*c)))}while(te(o)>ee&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function $i(){return Ii(Gn).scale(175.295)}function _i(e){return e}function Ui(e){if(e==null)return _i;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],c=e.translate[1];return function(s,p){p||(a=r=0);var u=2,d=s.length,l=new Array(d);for(l[0]=(a+=s[0])*n+i,l[1]=(r+=s[1])*o+c;u<d;)l[u]=s[u],++u;return l}}function Vi(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Hi(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return xn(e,r)})}:xn(e,a)}function xn(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Yi(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Yi(e,a){var r=Ui(e.transform),n=e.arcs;function o(d,l){l.length&&l.pop();for(var m=n[d<0?~d:d],h=0,f=m.length;h<f;++h)l.push(r(m[h],h));d<0&&Vi(l,f)}function i(d){return r(d)}function c(d){for(var l=[],m=0,h=d.length;m<h;++m)o(d[m],l);return l.length<2&&l.push(l[0]),l}function s(d){for(var l=c(d);l.length<4;)l.push(l[0]);return l}function p(d){return d.map(s)}function u(d){var l=d.type,m;switch(l){case"GeometryCollection":return{type:l,geometries:d.geometries.map(u)};case"Point":m=i(d.coordinates);break;case"MultiPoint":m=d.coordinates.map(i);break;case"LineString":m=c(d.arcs);break;case"MultiLineString":m=d.arcs.map(c);break;case"Polygon":m=p(d.arcs);break;case"MultiPolygon":m=d.arcs.map(p);break;default:return null}return{type:l,coordinates:m}}return u(a)}let jt=null;function Wi(){return jt||(jt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Hi(r,n),i=$i().fitExtent([[8,8],[992,492]],{type:"Sphere"}),c=Ti(i),s=(o.features||[]).filter(u=>{var d;return(((d=u.properties)==null?void 0:d.name)||"")!=="Antarctica"}).map(u=>{var m;const d=((m=u.properties)==null?void 0:m.name)||"",l=c(u)||"";return l?{i2:Mr(d)||null,n:d,d:l}:null}).filter(u=>!!u);if(!s.length)return null;const p={};for(const[u,d]of Object.entries(qr)){const l=i(d);l&&(p[u]={x:l[0],y:l[1]})}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p}}catch{return null}})(),jt)}function Gi(e){const[a,r]=g.useState(null);return g.useEffect(()=>{if(!e||a)return;let n=!1;return Wi().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const hn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Nt(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Ki(e,a){const[r,n]=g.useState(1);return g.useEffect(()=>{let o=!0,i=0;const c=()=>{var u;if(!o)return;const p=(u=e.current)==null?void 0:u.getScreenCTM();p&&p.a>0?n(p.a):i=requestAnimationFrame(c)};c();const s=new ResizeObserver(()=>c());return e.current&&s.observe(e.current),window.addEventListener("resize",c),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",c)}},[e,a]),r}function Qi(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:c,lang:s,t:p}=F(),u=g.useRef(null),d=g.useRef(null),l=Gi(e.continent==="monde"),m=e.continent==="monde"?l:wa.find(k=>k.key===e.continent)||null,h=Ki(u,e.continent+":"+e.mapFolded+":"+!!m),[f,b]=g.useState(new Map),[v,x]=g.useState(null);g.useEffect(()=>{const k=u.current;if(!k)return;const T=new Map;k.querySelectorAll("path[data-i2]").forEach(A=>{const O=A.dataset.i2;if(O)try{const R=A.getBBox();R.width>0&&T.set(O,{x:R.x,y:R.y,w:R.width,h:R.height})}catch{}}),b(T)},[e.continent,h,m]);const y=g.useMemo(()=>r.filter(k=>k.cc),[r]),N=g.useMemo(()=>{const k=new Map;return y.forEach(T=>k.set(T.cc,(k.get(T.cc)||0)+1)),k},[y]),w=e.continent==="monde"&&l?l.anchors:null,j=g.useMemo(()=>y.map(k=>{const T=w&&k.cc?w[k.cc]:void 0;if(T){const _=Nt(k.name||k.id||""),W=Nt((k.id||k.name||"")+"·y");return{d:k,x:T.x+(_-.5)*10,y:T.y+(W-.5)*10}}const A=k.cc?f.get(k.cc):void 0;if(!A)return null;const O=Nt(k.name||k.id||""),R=Nt((k.id||k.name||"")+"·y"),E=(O-.5)*Math.min(A.w*.55,60),M=(R-.5)*Math.min(A.h*.55,60);return{d:k,x:A.x+A.w/2+E,y:A.y+A.h/2+M}}).filter(k=>!!k),[y,f,w]),S=k=>h>0?k/h:k,L=g.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:hn[k],fr:p.plabels[k].toUpperCase(),en:p.plabels[k].toUpperCase(),n:r.filter(T=>T.kind==="target"&&ve(T)===k).length})).filter(k=>k.n>0):Fa.map((k,T)=>({...k,n:r.filter(A=>Pa(A)===T).length})),[r,n,p.plabels]),P=i?c.get(i):null,z=P?j.find(k=>k.d.id===P.id):null;return m?t.jsxs("div",{className:"mapzone",ref:d,children:[t.jsxs("svg",{ref:u,viewBox:m.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?m.fr:m.en,onMouseLeave:()=>{x(null),o(null)},children:[t.jsx("g",{children:m.countries.map((k,T)=>t.jsx("g",{className:"ct"+(k.i2&&N.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},T))}),t.jsx("g",{children:j.map(k=>{const T=Fa[Pa(k.d)],A=!!he(k.d),O=k.d.kind==="target",R=n&&O?hn[ve(k.d)]:T.c,E=!n&&we(k.d);return t.jsxs("g",{className:"co"+(E?" done":""),onMouseEnter:()=>{var W,J;const M=(W=d.current)==null?void 0:W.getBoundingClientRect(),_=(J=u.current)==null?void 0:J.createSVGPoint();if(_&&u.current&&M){_.x=k.x,_.y=k.y;const pe=_.matrixTransform(u.current.getScreenCTM());x({x:pe.x-M.left,y:pe.y-M.top,label:k.d.name+" · "+(Ze(k.d.cc,s)||k.d.countryLabel||"")})}o(k.d.id)},onMouseLeave:()=>{x(null),o(null)},onClick:()=>{var W;const M=(W=u.current)==null?void 0:W.createSVGPoint();let _=null;if(M&&u.current){M.x=k.x,M.y=k.y;const J=M.matrixTransform(u.current.getScreenCTM());_={x:J.x,y:J.y}}a({type:"popup",id:k.d.id,anchor:_})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:S(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:S(T.px),fill:R,stroke:A?"#DC2626":"#ffffff",strokeWidth:S(A?2.2:1.3)})]},k.d.id||k.d.name)})}),z&&t.jsx("circle",{className:"ring on",cx:z.x,cy:z.y,r:S(13),fill:"none",stroke:"#0F172A",strokeWidth:S(2)})]}),t.jsx("div",{className:"hov"+(v?" on":""),style:v?{left:v.x,top:v.y}:void 0,children:v==null?void 0:v.label}),t.jsx("div",{className:"legend",children:L.map((k,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},T))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:d})}function Ji(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Xi(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:o,contName:i,lang:c}=F(),s=e.filters,p=g.useMemo(()=>e.continent==="monde"?r:r.filter(f=>f.continent===e.continent),[r,e.continent]),u=f=>p.filter(b=>f!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:ja(b,s,o,f==="country"?void 0:f)),d=g.useMemo(()=>{const f=u("win"),b=v=>f.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),f.length]},[p,s,o]),l=g.useMemo(()=>s.day?u("win").filter(f=>(f.date||"").slice(0,10)===s.day).length:0,[p,s,o]),m=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),h=(f,b,v,x="fbtn")=>t.jsxs("button",{type:"button",className:x,"aria-expanded":e.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},f);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(Ji(s.day,c)),t.jsx("b",{children:l})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[n.dates[b],t.jsx("b",{children:d[b]})]},f))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):h("sec",n.fSector,s.sector.length),h("pay",n.fCountry,s.country.length),h("det",n.fEngine,s.engine.length),h("sta",n.fStage,s.stage.length),o&&h("ang","Angle",s.angle.length),o&&h("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),m>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,i),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(m)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Zi,{poolFor:u})]})}function Zi({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=F(),i=a.filters,c=a.openFacet,{title:s,cols:p,options:u}=g.useMemo(()=>{if(c==="sig"){const f=e("signal").filter(x=>he(x)),b=new Map;f.forEach(x=>{const y=x.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:f.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Zt([...b.keys()],o).map(x=>({v:x,label:We(x)+" "+qe(x,o),n:b.get(x)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(x)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(c==="sec"){const f=e("sector"),b=new Map;return f.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,x)=>x[1]-v[1]).map(([v,x])=>({v,label:v,n:x,html:!1,on:i.sector.includes(v)}))}}if(c==="pay"){const f=e("country"),b=new Map;return f.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,x)=>x[1]-v[1]).map(([v,x])=>({v,label:Ze(v,o)||v,n:x,html:!1,on:i.country.includes(v)}))}}if(c==="det"){const f=e("engine"),b=new Map;return f.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Zt([...b.keys()],o).map(v=>({v,label:We(v)+" "+qe(v,o)+' <span style="color:var(--dim);font-size:10px">· '+Or(Fr(v),o)+"</span>",n:b.get(v)||0,html:!0,on:i.engine.includes(v)}))}}if(c==="ang"){const f=e("angle"),b=new Map;return f.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,x)=>x[1]-v[1]).map(([v,x])=>({v,label:v.replace(/[_-]+/g," "),n:x,html:!1,on:i.angle.includes(v)}))}}if(c==="mem"){const f=e("memoLevel"),b=new Map;f.forEach(x=>{if(x.kind==="target"){const y=va(x);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(x=>({v:String(x),label:v[x],n:b.get(x)||0,html:!1,on:i.memoLevel.includes(x)}))}}const m=e("stage"),h=new Map;return m.forEach(f=>{f.stage&&h.set(f.stage,(h.get(f.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((f,b)=>b[1]-f[1]).map(([f,b])=>({v:f,label:f,n:b,html:!1,on:i.stage.includes(f)}))}},[c,a,o]),d=m=>{if(c==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const f=i.signalEngines.includes(m)?i.signalEngines.filter(b=>b!==m):[...i.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(c==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage",value:m})},l=()=>{r(c==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:c==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:l,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:u.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>d(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}const gn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function es(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function ts(){var Le;const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:c,evalBusy:s,evalCards:p,caps:u,data:d}=F(),l=a==="client",[m,h]=g.useState(""),[f,b]=g.useState(!1),[v,x]=g.useState(""),[y,N]=g.useState(!1),[w,j]=g.useState(""),[S,L]=g.useState([]),P=g.useRef(!1),[z,k]=g.useState(!1),[T,A]=g.useState(""),[O,R]=g.useState(""),[E,M]=g.useState(!1),[_,W]=g.useState(0),[J,pe]=g.useState(""),[B,le]=g.useState(null),[U,G]=g.useState(null),$=g.useRef(!1),Q=m.trim()?gn.test(m.trim())?e.evalUrl:e.evalName:e.evalWaiting,V=g.useMemo(()=>v.split(`
`).map(q=>q.trim()).filter(Boolean).slice(0,15),[v]);g.useEffect(()=>{if(typeof window>"u")return;const q=(new URLSearchParams(window.location.search).get("rs")||"").trim();!q||!/^https?:\/\//i.test(q)||(A(q),k(!0))},[]),g.useEffect(()=>{const q=X=>{var Z;const ae=String(((Z=X.detail)==null?void 0:Z.url)||"").trim();!ae||!/^https?:\/\//i.test(ae)||(A(ae),k(!0))};return window.addEventListener("ppmap:research",q),()=>window.removeEventListener("ppmap:research",q)},[]);const re=S.length?S:p,ne=d.credits;g.useEffect(()=>{if(!E)return;W(0);const q=window.setInterval(()=>W(X=>X+1),1e3);return()=>window.clearInterval(q)},[E]);const ue=()=>{const q=m.trim();q&&(o(null,q),h(""))},K=async()=>{if(!l){o(null,V[0]||"");return}if(!V.length||y)return;N(!0),P.current=!1;const q=[];for(let X=0;X<V.length&&!P.current;X++){j(e.evaluating(X+1,V.length,V[X]));const ae=await Sn(r,V[X],"atelier2");if(q.unshift({name:ae.company||V[X],verdict:ae.verdict,reason:ae.reason||"",remaining:ae.remaining??null}),L([...q]),ae.verdict==="quota"){q.unshift({name:"",verdict:"quota",reason:e.quota(V.length-X-1),remaining:0}),L([...q]),x(V.slice(X+1).join(`
`)),j(""),N(!1);return}}j(""),x(P.current?V.slice(q.length).join(`
`):""),N(!1)},oe=async()=>{var ae;if($.current)return;const q=T.trim().replace(/\s+/g,""),X=O.trim();if(!q&&!X){pe(e.rsNeed);return}if(!l){o(null,q||X.slice(0,80));return}$.current=!0,pe(""),le(null),G(null),M(!0);try{const Z=await Dr({url:q,text:X,email:n,cbToken:r});if(M(!1),!Z||Z.status!=="success"){pe((Z==null?void 0:Z.message)||"Erreur");return}le(Z),k(!1);const Ee=(((ae=Z.prospective)==null?void 0:ae.companies_to_evaluate)||[]).map(Fe=>((Fe==null?void 0:Fe.name)||"").trim()).filter(Boolean);Ee.length&&(x(Fe=>{const ft=Fe.split(`
...
`)}),b(!0)),G({state:"pending"});const Oe=await Ir(Z,{email:n,cbToken:r});G(Oe.ok&&Oe.url?{state:"ok",url:Oe.url}:{state:"fail",msg:Oe.error||""})}finally{$.current=!1,M(!1)}},Ce=(((Le=B==null?void 0:B.prospective)==null?void 0:Le.companies_to_evaluate)||[]).filter(q=>q&&q.name),Y=[B==null?void 0:B.industry,...(B==null?void 0:B.market_tags)||[],B==null?void 0:B.author].map(q=>(q||"").trim()).filter(Boolean),ce=(U==null?void 0:U.state)==="pending",ge=U&&(ce?t.jsx("span",{className:"rslink pend",children:e.rsPublishing}):U.state==="ok"?t.jsx("a",{className:"rslink",href:U.url,target:"_blank",rel:"noopener noreferrer",children:e.rsLink}):t.jsx("span",{className:"rslink fail",title:U.msg,children:e.rsPublishFail})),me=f&&Ce.length>0;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:m,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:q=>h(q.target.value),onKeyDown:q=>{q.key==="Enter"&&ue()}}),t.jsx("span",{className:"detect"+(gn.test(m.trim())?" url":""),children:Q})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:ue,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),u.showCredits&&ne&&t.jsxs("button",{type:"button",className:"credits"+(ne.total_available<=0&&!ne.unlimited?" empty":""),onClick:()=>c({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ne.unlimited?"∞":ne.total_available}),!ne.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ne.daily_grant+ne.purchased]}),ne.total_available<=0&&!ne.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>b(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(z?" on":""),onClick:()=>k(!z),children:e.rsOpen})]}),z&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:T,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:q=>A(q.target.value),onKeyDown:q=>{q.key==="Enter"&&oe()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:O,placeholder:e.rsTextPh,onChange:q=>R(q.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(E?" loading":""),style:{justifyContent:"center"},disabled:E||ce||!T.trim()&&!O.trim(),onClick:()=>{oe()},children:[t.jsx("span",{className:"fill"}),E?`${Pr(T.trim())==="youtube"&&T.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(_)}`:ce?e.rsPublishing:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),J&&t.jsx("div",{className:"rserr",children:J}),B&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:B.title}),B.source_url&&t.jsx("a",{href:B.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{le(null),G(null)},children:"×"})]}),B.market&&t.jsx("p",{className:"rsmk",children:B.market}),Y.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Y.map(q=>t.jsx("span",{children:q},q))]}),t.jsxs("div",{className:"rsbody",children:[B.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${B.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:es(B.summary_md||"").map((q,X)=>t.jsx("p",{children:q},X))})]}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Ce.length)}),!me&&ge]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:v,placeholder:e.bulkPh,onChange:q=>x(q.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(y?" loading":""),style:{justifyContent:"center"},disabled:y||!V.length,onClick:()=>{K()},children:[t.jsx("span",{className:"fill"}),y&&w?w:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(V.length)}),me&&ge]})]}),re.slice(0,1).map((q,X)=>{const ae=q.verdict==="kept",Z=q.verdict==="quota",Ee=ae?"var(--brand)":Z?"var(--bolt)":"var(--red)",Oe=ae?"var(--brand-l)":Z?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ee,"--bgc":Oe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ae?"✓ "+e.kept:Z?"⏳":"✗ "+e.dropped})}),q.name&&t.jsx("span",{className:"rn",children:q.name}),t.jsx("span",{className:"rr",children:q.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",q.reason]}):null}),!Z&&t.jsx("button",{type:"button",className:"go",onClick:()=>c({type:"modal",modal:"space"}),children:e.seeSpace(ae?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},X)}),l&&(i.kept+i.dropped>0||re.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>c({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function as(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ns(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=F(),i=e.memoConsole?r.get(e.memoConsole):null,c=g.useMemo(()=>i?[i.reasoning||"",as(i.summary||"")].filter(Boolean).join(`
...
`)}`}function ks(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const js=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ze({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Ns({o:e,qa:a}){const{t:r,lang:n,fund:o}=F(),i=(e.cribleStatus||"").trim().toUpperCase()||(Pt(e)==="NO MATCH"?"NO MATCH":"MATCH"),c=Xe(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,c&&t.jsx("em",{children:c})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(ze,{k:r.cdSector,v:e.sector}),t.jsx(ze,{k:r.cdStage,v:e.stage}),t.jsx(ze,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ze,{k:r.cdSite,v:e.domain||e.website}),t.jsx(ze,{k:r.cdName,v:e.contactName}),t.jsx(ze,{k:r.cdEmail,v:e.contactEmail}),t.jsx(ze,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(ze,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(ze,{k:r.cdAngle,v:e.angle}),t.jsx(ze,{k:r.cdDetected,v:js(e.date,n)})]}),p.some(([,u])=>u)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,u])=>u).map(([u,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:u}),t.jsx("p",{children:d})]},u))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Ss(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:c}=F(),[s,p]=g.useState({}),u=25,d=g.useMemo(()=>n.slice(0,u),[n]);g.useEffect(()=>{d.length&&Hr(r,d.map(h=>h.name)).then(p)},[r,d]);const l=i.stats,m=h=>h.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),l&&typeof l.screened=="number"&&t.jsxs("p",{children:[m(l.screened)," ",e.funScreened(""),typeof l.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",m(l.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(m(i.marketEstimate)),", ",Math.round(l.screened/i.marketEstimate*100)," %"]})]})]}),d.map(h=>t.jsx(Ns,{o:h,qa:s[h.name]},h.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Cs=50;function Ta({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=F(),[i,c]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(""),[l,m]=g.useState(0),[h,f]=g.useState(""),[b,v]=g.useState(!1),x=g.useRef(null);g.useEffect(()=>()=>{x.current&&window.clearInterval(x.current)},[]);const y=async w=>{p(!0),d("");const j=await a();if(p(!1),j.ok){c(j);return}if(j.busy){d(o.alertPreviewBusy);return}if(!w){d(o.alertPreviewFail);return}m(Cs),x.current=window.setInterval(()=>{m(S=>S>1?S-1:(x.current&&window.clearInterval(x.current),y(!1),0))},1e3)},N=async()=>{if(n||b)return;v(!0),f("");const w=await r();v(!1),f(w.ok?o.alertTestOk(w.sentTo||""):w.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||l>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{N()},children:b?"…":o.alertTest})]}),l>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(l)}),u&&t.jsx("p",{className:"mnote warn",children:u}),h&&t.jsx("p",{className:"mnote",children:h}),!h&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const lt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function be({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=F();return Je.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Es(){const{st:e}=F();switch(e.modal){case"chain":return t.jsx(Ts,{});case"space":return t.jsx(As,{});case"alert":return t.jsx(Ls,{});case"queue":return t.jsx(Fs,{});case"export":return t.jsx(Ps,{});case"plug":return t.jsx(Bs,{});case"recharge":return t.jsx(_s,{});case"cover":return t.jsx(Vs,{});case"dossier":return t.jsx(Us,{});case"crit":return t.jsx(Hs,{});case"tuto":return t.jsx(Ys,{});case"rdv":return t.jsx(zs,{});case"memoalert":return t.jsx(Ds,{});default:return null}}function zs(){const{dispatch:e,fund:a}=F(),r=typeof document<"u"&&!!document.getElementById("rdv");return g.useEffect(()=>{r&&(e({type:"modal",modal:null}),Po())},[r,e]),r?null:t.jsx(Gr,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Ts(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:c,evalBusy:s}=F(),p=i==="client",u=e.chain.queue.map(h=>r.get(h)).filter(h=>!!h),d=e.chain.idx,l=u[d],m=d>=u.length;return Je.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:m?n.finished:`${d+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(m?100:d/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:m||!l?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:l.name}),t.jsx("div",{className:"sub",children:[Ze(l.cc,o)||l.countryLabel,l.sector,l.stage,n.daysAgo(Qe(l.date))].filter(Boolean).map(h=>String(h).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:qe(l.engine,o).toUpperCase()}),typeof l.amountEur=="number"&&l.amountEur>0&&t.jsx("span",{children:Ft(l.amountEur,o)})]}),he(l)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(et,{o:l,lg:!0})," ",t.jsx(Dt,{o:l,src:!0})]}),(l.tagline||l.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:l.tagline||l.headline})]}),l.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:l.reasoning})]}),p&&we(l)&&t.jsxs("div",{className:"vbox",style:{"--c":$e(l)==="retenu"?"var(--brand)":$e(l)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:$e(l)==="retenu"?"✓ "+n.kept:$e(l)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:l.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!m&&l&&!(p&&we(l))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{c(l)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(m?{type:"modal",modal:null}:{type:"chainNext"}),children:m?n.closeBtn:n.skip})]})]})})}),document.body)}function As(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=F(),i=o==="client",c=g.useMemo(()=>i?r.filter(l=>we(l)):[],[r,i]),s=g.useMemo(()=>Na(c.filter(l=>$e(l)==="retenu"),{key:"signal",dir:-1}),[c]),p=g.useMemo(()=>c.filter(l=>$e(l)==="ecarte"),[c]),u=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(be,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),u.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),u.slice(0,40).map(l=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof l.score=="number"&&l.score>0?l.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:l.name}),t.jsx("div",{className:"rr",children:l.reasoning||l.tagline||""})]})]},l.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Ls(){const{mode:e}=F();return e==="client"||e==="apercu"?t.jsx(Rs,{}):t.jsx(Os,{})}function Rs(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=F(),[i,c]=g.useState("d"),s=o!=="client";return t.jsxs(be,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>c("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>c("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>c("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Ms,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(qs,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(Jn,{})]})}function Ms({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,c]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(0);g.useEffect(()=>{let f=!0;return p(!1),$a(a).then(b=>{f&&(b?c(b):p(!0))}),()=>{f=!1}},[a,u]);const l=f=>{r||$a(a,f).then(b=>{if(!b){o(e.actErr);return}c(b),b.throttled?o(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=f=>!i.sections||i.sections.includes(f),h=f=>{const b=i.sections||e.alertSec.map(([v])=>v);l({sections:m(f)?b.filter(v=>v!==f):[...b,f]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>l({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>l({hour:Math.max(6,(i.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[i.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>l({hour:Math.min(21,(i.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>l({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>l({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([f,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:m(f),disabled:r,onChange:()=>h(f)}),t.jsxs("span",{children:[b,f==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},f))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ta,{label:e.alertPreview,readOnly:r,onPreview:()=>to(a),onTest:()=>eo(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function qs({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,c]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(0);g.useEffect(()=>{let f=!0;return p(!1),_a(a).then(b=>{f&&(b?c(b):p(!0))}),()=>{f=!1}},[a,u]);const l=f=>{r||_a(a,f).then(b=>{if(!b){o(e.actErr);return}c(b),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=i.dow??0,h=i.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>l({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:m,disabled:r,onChange:f=>l({dow:Number(f.target.value)}),children:e.alertDow.map((f,b)=>t.jsx("option",{value:b,children:f},f))}),t.jsx("button",{type:"button",onClick:()=>l({hour:Math.max(6,h-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[h," h"]}),t.jsx("button",{type:"button",onClick:()=>l({hour:Math.min(21,h+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ta,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>no(a),onTest:()=>ao(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Jn(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=F(),[c,s]=g.useState(i||""),[p,u]=g.useState(!1),[d,l]=g.useState(!1);g.useEffect(()=>{i&&s(i)},[i]);const m=e.filters,h=g.useMemo(()=>n.filter(x=>he(x)).length,[n]),f=m.win==="1"?0:m.win==="7"?1:m.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(c)||d)){l(!0);try{await fetch(`${ba}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:c.trim(),sectors:m.sector,countries:m.country,source:i?"atelier2-client":"atelier2",website:""})}),u(!0)}finally{l(!1)}}},v=[[a.amRows.continent,o],[a.amRows.since,a.amSince[f]],[a.amRows.signal,m.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,m.engine.length?m.engine.map(x=>qe(x,r)).join(", "):a.amAllEngines],[a.amRows.sectors,m.sector.length?m.sector.join(", "):a.amAllSectors],[a.amRows.countries,m.country.length?m.country.map(x=>Ze(x,r)||x).join(", "):a.amAllCountries],[a.amRows.stages,m.stage.length?m.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(c)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([x,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:x}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},x))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:c,readOnly:!!i,onChange:x=>s(x.target.value),onKeyDown:x=>{x.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,h)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Os(){const{t:e}=F();return t.jsx(be,{title:e.alertTitle,icon:"🔔",children:t.jsx(Jn,{})})}function Fs(){var b,v,x;const{t:e,token:a,fund:r,mode:n,flash:o}=F(),[i,c]=g.useState(null),[s,p]=g.useState([]),[u,d]=g.useState(0),l=n==="client";g.useEffect(()=>{let y=!0;return(async()=>{const[N,w]=await Promise.all([ya(r),Nn(a)]);y&&(N&&c(N),p(w))})(),()=>{y=!1}},[a,r,u]);const m=(i==null?void 0:i.per_day)??2,h=((b=i==null?void 0:i.analyzed_today)==null?void 0:b.length)??0,f=(v=i==null?void 0:i.tomorrow)!=null&&v.length?i.tomorrow:((i==null?void 0:i.pool_meta)||[]).slice(0,10);return t.jsxs(be,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(h,h+(((x=i==null?void 0:i.pool_order)==null?void 0:x.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(m)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),l&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Ba(a,y.company,"retry").then(()=>d(N=>N+1))},children:e.queueRetry}),l&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Ba(a,y.company,"delete").then(()=>d(N=>N+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[f.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),f.slice(0,10).map((y,N)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",N+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Ps(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:c}=F(),s=`${lt}/cibles/list.csv?token=${a}`,p=`${lt}/cibles/list.json?token=${a}`,u=`${lt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,l=v=>{var x;(x=navigator.clipboard)==null||x.writeText(v).then(()=>r(e.exportCopied))},m=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:u,href:u}],h=!o.lockActions&&n.length>0,f=()=>{ks(ws(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:v=>(e.stg.find(([x])=>x===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(be,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>c({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:f,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:m.map(({def:v,value:x,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l(x),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Ds(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=F(),i=o!=="client",[c,s]=g.useState(null),[p,u]=g.useState(!1),[d,l]=g.useState(0),[m,h]=g.useState(!1);g.useEffect(()=>{let x=!0;return u(!1),Ia(a).then(y=>{x&&(y?s(y):u(!0))}),()=>{x=!1}},[a,d]);const f=()=>(c==null?void 0:c.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=x=>{if(i||!c)return;const y={enabled:x.enabled??!!c.enabled,email:x.email??(c.email||""),sections:x.sections??f()};h(!0),Ia(a,y).then(N=>{if(h(!1),!N){n(e.memoAlertErr);return}s(N),r(e.memoAlertSaved)})};if(p)return t.jsx(be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>l(x=>x+1),children:e.retry})]})});if(!c)return t.jsx(be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=f();return t.jsxs(be,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":c.enabled===!0,disabled:i||m,style:c.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!c.enabled}),children:c.enabled?"ON":"OFF"})})]}),t.jsx(Is,{value:c.email||"",readOnly:i||m,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:x=>b({email:x})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([x,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[x],disabled:i||m,onChange:()=>b({sections:{...v,[x]:!v[x]}})}),t.jsx("span",{children:y})]},x))}),t.jsx(Ta,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Wr(a,v),onTest:()=>Yr(a,v)})]})}function Is({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,c]=g.useState(e);g.useEffect(()=>{c(e)},[e]);const s=i.trim()!==e.trim(),p=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:u=>c(u.target.value),onKeyDown:u=>{u.key==="Enter"&&s&&p&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>o(i.trim()),children:n})]})]})}function Bs(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=F(),[i,c]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(null),[l,m]=g.useState(""),[h,f]=g.useState(0);g.useEffect(()=>{let x=!0;return p(!1),ea(a).then(y=>{x&&(y?c({configured:y.configured,url_hint:y.url_hint}):p(!0))}),Qr(a).then(y=>{x&&d(y)}),()=>{x=!1}},[a,h]);const b=(x,y)=>{o&&ea(a,x).then(N=>{if(!N||N.ok===!1){n(e.actErr);return}x.test&&N.sent===!1?n(e.plugTestThrottled):r(y),f(w=>w+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(be,{title:e.plugTitle,icon:"🔌",wide:!0,children:[u&&t.jsx("p",{className:"mnote"+(u.enabled?" warn":""),children:u.enabled?e.plugAutoOn(u.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(x=>x+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:l,disabled:!o,onChange:x=>m(x.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!l.trim(),onClick:()=>b({url:l.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx($s,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var x;(x=navigator.clipboard)==null||x.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function $s(){const{t:e,token:a,lang:r}=F(),[n,o]=g.useState("valides"),[i,c]=g.useState(!1),[s,p]=g.useState(null),[u,d]=g.useState(null),[l,m]=g.useState(!1),[h,f]=g.useState(!1),[b,v]=g.useState(null),[x,y]=g.useState(null),[N,w]=g.useState(null),j=`atl2:bulk:${a}:${n}`;g.useEffect(()=>{ea(a).then(A=>{y(A&&A.configured?A.url_hint||"webhook":null)})},[a]),g.useEffect(()=>{p(null),d(null),m(!1),v(null);try{const A=JSON.parse(localStorage.getItem(j)||"null");w(A&&Date.now()-Date.parse(A.t)<24*3600*1e3?A:null)}catch{w(null)}},[j]);const S=async()=>{c(!0),m(!1),v(null);const A=await Xr(a,n);p(A),d(A.ok?n:null),c(!1)},L=g.useRef(!1),P=async()=>{if(L.current)return;L.current=!0,f(!0);const A=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let O;try{O=await Zr(a,n,"webhook",void 0,A)}finally{L.current=!1}if(f(!1),m(!1),v(O),O.ok&&(O.pushed||0)>0){const R={t:new Date().toISOString(),n:O.pushed||0};w(R);try{localStorage.setItem(j,JSON.stringify(R))}catch{}}},z=s!=null&&s.ok&&s.ready||0,k=!!(s!=null&&s.ok)&&u===n&&z>0&&!!x&&!N,T=N?new Date(N.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:A=>o(A.target.value),children:e.plugBulkTabs.map(([A,O])=>t.jsx("option",{value:A,children:O},A))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{S()},children:i?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),N&&t.jsx("p",{className:"mnote",children:e.bulkLocked(T,N.n)}),!N&&!!(s!=null&&s.ok)&&!x&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!N&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),k&&!l&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>m(!0),children:e.bulkArm}),k&&l&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(z,x||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:h,onClick:()=>{P()},children:h?e.bulkSending:e.bulkConfirm(x||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:h,onClick:()=>m(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function _s(){const{t:e,data:a,lang:r}=F(),n=a.credits,o=a.email,i=async c=>{if(!o)return;const s=window.location.href.split("?")[0];try{const u=await(await fetch(`${ba}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:c,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();u.url&&(window.location.href=u.url)}catch{}};return t.jsxs(be,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(c=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(c.credits,c.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(c.lookup_key)},children:e.rechargeBuy})]},c.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Us(){const{t:e}=F();return t.jsx(be,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Ss,{})})}function Vs(){const{t:e,lang:a,data:r,dossiers:n,token:o,canWrite:i,flash:c}=F(),[s,p]=g.useState(null),[u,d]=g.useState(!1);g.useEffect(()=>{let S=!0;return ya(o).then(L=>{S&&L&&typeof L.per_day=="number"&&p(L.per_day)}),()=>{S=!1}},[o]);const l=r.stats,m=typeof(l==null?void 0:l.screened)=="number"?l.screened:n.filter(S=>S.kind==="target"&&we(S)).length,h=r.marketEstimate||0,f=h>0?Math.min(100,Math.round(m/h*100)):null,b=(l==null?void 0:l.window_days)||30,v=m>0?m/b:0,x=h>0?Math.max(0,h-m):0,N=h>0&&v>0&&m>=100?Math.round(x/v):null,w=S=>Math.round(S).toLocaleString(a==="en"?"en-US":"fr-FR"),j=S=>{u||!i||(d(!0),Jr(o,S).then(L=>{if(d(!1),L===null){c(e.actErr);return}p(L),c(e.alertSaved)}))};return t.jsxs(be,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(m))}),h>0&&t.jsx("span",{children:e.covOf(w(h))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),N!==null&&t.jsx("p",{className:"mnote",children:e.covEta(N)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),v>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(v))}),l&&t.jsxs("div",{className:"covf",children:[typeof l.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(l.kept)})," ",e.covKept]}),typeof l.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(l.analyzed)})," ",e.covAna]}),typeof l.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(l.shown)})," ",e.covShown]})]}),i&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(S=>t.jsx("button",{type:"button",className:s===S?"on":"",disabled:u,onClick:()=>j(S),children:S===0?"⏸":S},S))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Hs(){var x,y,N;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i}=F(),c=n==="client",s=g.useMemo(()=>{const w=new Set;return a.forEach(j=>{j.angle&&w.add(j.angle)}),[...w]},[a]),[p,u]=g.useState(null);g.useEffect(()=>{let w=!0;return Kr(r).then(j=>{w&&u(j.thumbs)}),()=>{w=!1}},[r]);const[d,l]=g.useState(""),[m,h]=g.useState(""),[f,b]=g.useState(!1),v=async()=>{const w=d.trim();if(!(!w||f||!c)){b(!0),h("");try{const S=await(await fetch(`${lt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(S.reply&&h(String(S.reply)),S.job_id){h(e.critChatRunning);const L=async()=>{const P=await fetch(`${lt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:S.job_id})}).then(z=>z.json()).catch(()=>null);if(P&&P.done){h(String(P.reply||P.clarification||P.summary||"✓")),b(!1),P.applied&&o(e.alertSaved);return}setTimeout(()=>{L()},8e3)};setTimeout(()=>{L()},8e3),l("");return}l("")}finally{m.startsWith("⏳")||b(!1)}}};return t.jsxs(be,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((x=i.points)!=null&&x.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var j,S;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((j=w.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(L=>t.jsx("li",{children:L},L))})]}),!!((S=w.out)!=null&&S.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(L=>t.jsx("li",{children:L},L))})]})]})]},w.title)})]}),!!((N=i==null?void 0:i.gate)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||f,onChange:w=>l(w.target.value),onKeyDown:w=>{w.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!c||f||!d.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),m&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:m})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,j)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},j))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Qn[w]||"v-cons"),children:w}),t.jsx("span",{children:j})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",j]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Ys(){const{t:e,dispatch:a,startTour:r}=F(),n=o=>{var i,c;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(c=document.querySelector(".atl2 .demand input"))==null||c.focus())};return t.jsxs(be,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],c)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:c+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+c))})]})}const Jt={},yn=(Jt==null?void 0:Jt.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ot(){return new Date().toISOString().slice(0,10)}const Xn=g.createContext(null);function Zn(){const e=g.useContext(Xn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ws({token:e,children:a}){const{dispatch:r,st:n,lang:o}=F(),[i,c]=g.useState(()=>n.filters.day||Ot()),[s,p]=g.useState(null),[u,d]=g.useState(!1),l=g.useCallback(f=>{if(/^\d{4}-\d{2}-\d{2}$/.test(f)){c(f);try{r({type:"filters",patch:{day:f,win:"all"}})}catch{}}},[r]);g.useEffect(()=>{n.filters.day||l(Ot())},[]),g.useEffect(()=>{const f=b=>{var x;const v=(x=b.detail)==null?void 0:x.day;typeof v=="string"&&l(v)};return window.addEventListener("pp-edition-day",f),()=>window.removeEventListener("pp-edition-day",f)},[l]),g.useEffect(()=>{n.filters.day&&n.filters.day!==i&&c(n.filters.day)},[n.filters.day]),g.useEffect(()=>{if(!e||!i)return;let f=!1;d(!0);const b=new URLSearchParams({token:e,date:i});return fetch(`${yn}/cibles/edition.json?${b}`).then(v=>v.json()).then(v=>{f||p(v)}).catch(()=>{f||p({ok:!1,error:"network"})}).finally(()=>{f||d(!1)}),()=>{f=!0}},[e,i]);const m=g.useMemo(()=>`${yn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),h=g.useMemo(()=>({token:e,day:i,ed:s,loading:u,pickDay:l,daysUrl:m,isEn:o==="en"}),[e,i,s,u,l,m,o]);return t.jsx(Xn.Provider,{value:h,children:a})}function Gs(){const{day:e,daysUrl:a,pickDay:r,isEn:n}=Zn();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!i&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),s&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["No thesis brief for ",t.jsx("b",{children:e})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):t.jsxs(t.Fragment,{children:["Pas encore de brief de thèse pour le ",t.jsx("b",{children:e}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),i&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,i&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,e&&e!==Ot()&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:()=>n(Ot()),children:o?"← Back to today":"← Revenir à aujourd’hui"})]})}const er="atl2:mapfold",Qs=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(er);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},tr=g.createContext(null),F=()=>{const e=g.useContext(tr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function et({o:e,lg:a}){const{lang:r}=F(),n=he(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ua(n,r),children:[n.emoji," ",Ua(n,r)]}):null}function Dt({o:e,src:a}){const{lang:r,t:n}=F(),o=he(e);if(!o)return null;const i=co(o),c=po(o);return t.jsxs("em",{className:"sigwin"+(c?" hot":""),title:n.signaledOn(Cn(o,r))+" · "+n.win7(En(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<i?"on":""},p))}),t.jsx("span",{className:"lb",children:c?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function ar({o:e}){const{lang:a}=F(),r=lo(e.cc),n=e.cc?Ze(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const wn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",nr=e=>`atl2:tour:${e||"anon"}`;function Js(e){try{return localStorage.getItem(nr(e))==="1"}catch{return!0}}function kn(e){try{localStorage.setItem(nr(e),"1")}catch{}}function Xs(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function rl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){const{lang:c}=oo(),s=vo[c],p=Ao(e,c,a),[u,d]=g.useReducer(Ro,void 0,()=>Lo((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Qs(),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??(a==="ops"?"deplie":void 0),filters:r,modal:n==null?void 0:n.modal})),l=g.useRef(!0);g.useEffect(()=>{if(l.current){l.current=!1;return}if(!e)try{localStorage.setItem(er,u.mapFolded?"on":"off")}catch{}},[u.mapFolded,e]);const m=g.useRef(i);m.current=i,g.useEffect(()=>{var C;(C=m.current)==null||C.call(m,u.filters)},[u.filters]);const[h,f]=g.useState(null),[b,v]=g.useState(null),[x,y]=g.useState({kept:0,dropped:0}),[N,w]=g.useState(!1),[j,S]=g.useState(""),[L,P]=g.useState(!1),[z,k]=g.useState(null),[T,A]=g.useState(!1),[O,R]=g.useState(!1),[,E]=g.useState(0),M=()=>E(C=>C+1),_=g.useRef([]),W=g.useRef(new Set),J=g.useRef(new Set),pe=g.useRef(new Map),B=g.useRef(null),{mode:le}=p,U=g.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[p.caps,o,a]),G=U.pipe,$=p.session.token||"",Q=le==="client"&&!e;g.useEffect(()=>{if(document.querySelector(`link[href="${wn}"]`))return;const C=document.createElement("link");C.rel="stylesheet",C.href=wn,document.head.appendChild(C)},[]);const V=(C,D=!1)=>{S(C),P(D),B.current&&clearTimeout(B.current),B.current=setTimeout(()=>S(""),D?4200:2400)},re=C=>V(C,!0),ne=g.useMemo(()=>{const C=new Map;return p.dossiers.forEach(D=>{D.id&&C.set(D.id,D)}),C},[p.dossiers]),ue=g.useMemo(()=>p.dossiers.filter(C=>An(C,u,G)),[p.dossiers,u,G]),K=g.useRef(!1);g.useEffect(()=>{if(K.current||e||p.loading||!p.dossiers.length)return;if(!U.showFunnel||Js(p.session.token||"")){K.current=!0;return}K.current=!0;const C=window.setTimeout(()=>{kn(p.session.token||""),A(!0)},700);return()=>window.clearTimeout(C)},[e,p.loading,p.dossiers.length,U.showFunnel,p.session.token]);const oe=g.useMemo(()=>p.dossiers.filter(C=>Mo(C,u,G,p.favIds)),[p.dossiers,u,G,p.favIds]),Ce=g.useMemo(()=>io(ue,p.favIds),[ue,p.favIds]),Y=wa.find(C=>C.key===u.continent),ce=u.continent==="monde"?s.contWorld:(c==="fr"?Y==null?void 0:Y.fr:Y==null?void 0:Y.en)||"";g.useEffect(()=>{const C=D=>{var de;const I=(((de=D.detail)==null?void 0:de.name)||"").trim();I&&ge(null,I)};return window.addEventListener("ppmap:evaluate",C),()=>window.removeEventListener("ppmap:evaluate",C)});const ge=(C,D)=>{const I=((C==null?void 0:C.name)||D||"").trim();if(!Q){v({kicker:I});return}!I||N||(w(!0),(async()=>{try{const de=await Sn($,I,"atelier2"),mt={name:de.company||I,verdict:de.verdict,reason:de.reason||"",remaining:de.remaining??null};_.current=[mt,..._.current].slice(0,8),de.verdict==="kept"&&y(De=>({...De,kept:De.kept+1})),de.verdict==="ruled_out"&&y(De=>({...De,dropped:De.dropped+1}));const tt=C||p.dossiers.find(De=>(De.name||"").toLowerCase()===I.toLowerCase());tt&&(de.verdict==="kept"?tt.verdict=tt.verdict||"MATCH":de.verdict==="ruled_out"&&(tt.verdict="NO MATCH"),de.reason&&(tt.reasoning=de.reason)),M()}finally{w(!1)}})())},me=C=>{if(!Q){v({kicker:C.name});return}W.current.add(C.id),at($,"fast_request",C.name||"",""),V(s.memoInstantSent(C.name)),M()},Le=C=>pe.current.get(C.id)??p.thumbs.get((C.name||"").trim().toLowerCase()),q=(C,D)=>d({type:"undoPush",entry:{id:C.id,name:C.name,prevCeoStatus:D}}),X=async(C,D,I)=>{const de=C.ceoStatus||"";C.ceoStatus=D,M();const mt=await Ut($,{status:D,airtable_id:C.airtableId,check_id:C.checkId,company:C.name,...(I==null?void 0:I.note)!==void 0?{note:I.note}:{},...I!=null&&I.via?{via:I.via}:{}});return mt.ok?mt.skipped?(C.ceoStatus=de,M(),re(s.actNotPersisted),!1):((I==null?void 0:I.undo)!==!1&&q(C,de),I!=null&&I.msg&&V(I.msg),(D==="Validé"||D==="Écarté")&&!C.ceoNote&&(I==null?void 0:I.note)===void 0&&k({o:C,yes:D==="Validé"}),!0):(C.ceoStatus=de,M(),re(s.actErr),!1)},ae=async(C,D)=>{const I=await Ut($,{status:C.ceoStatus||"Retenu",airtable_id:C.airtableId,check_id:C.checkId,company:C.name,note:D,via:"note"});return!I.ok||I.skipped?(re(I.skipped?s.actNotPersisted:s.actErr),!1):(C.ceoNote=D,M(),!0)},Z=g.useRef(new Map),Ee=C=>Z.current.has(C.id)?Z.current.get(C.id):p.stages.get((C.name||"").trim().toLowerCase()),Oe=(C,D)=>{Z.current.set(C.id,D),M()},Fe=(C,D)=>{Q&&X(C,D?"Validé":"Écarté",{msg:D?s.decidedYes(C.name):s.decidedNo(C.name)})},ft=C=>{Q&&X(C,"À trancher",{msg:s.promoted(C.name)})},It=C=>{Q&&(async()=>{const D=C.ceoStatus||"";C.ceoStatus="Retenu",M();const I=await Ut($,{status:"Retenu",check_id:C.checkId,company:C.name});if(!I.ok||I.skipped){C.ceoStatus=D,M(),re(I.skipped?s.actNotPersisted:s.actErr);return}q(C,D),V(s.repeched(C.name))})()},Bt=()=>{const C=u.undo[u.undo.length-1];if(!C){V(s.undoNone);return}const D=ne.get(C.id);if(!D){d({type:"undoPop"}),V(s.undoNone);return}let I=C.prevCeoStatus;if(!I)if((D.verdict||"").toUpperCase().includes("CALL"))I="À trancher";else{V(s.undoLockedTitle);return}(async()=>await X(D,I,{undo:!1})&&(d({type:"undoPop"}),D.ceoStatus=C.prevCeoStatus,M(),V(s.undoDone(D.name))))()},Pe=C=>{Q&&(J.current.add(C.id),M(),(async()=>{const D=await uo($,C.name,"email");if(!D||D.ok===!1){J.current.delete(C.id),M(),re(s.actErr);return}at($,"approach",C.name||"",""),V(s.actApproachSent)})())},rr=(C,D)=>{Q&&(async()=>{if(!(await at($,D?"yes":"no",C.name||"","")).ok){re(s.actErr);return}pe.current.set(C.id,D?"yes":"no"),M(),V(D?s.thumbUpDone:s.thumbDnDone)})()},or=C=>{!Q||!ka(C)||(at($,"detailed_request",C.name||"",""),V(s.memoDeepSent(C.name)))},ir=C=>{const D=new Set(p.favIds),I=D.has(C.id);I?D.delete(C.id):D.add(C.id),p.setFavIds(D),Q&&fo($,{id:C.id,co:C.name},I)},sr=()=>{!Q||O||window.confirm(s.identSyncConfirm)&&(R(!0),(async()=>{const C=await mo($);R(!1),C?V(s.identSyncDone):re(s.actErr)})())},Aa=/proplace/i.test(p.fund||""),lr=C=>{!Q||!Aa||(at($,"onboard_request",C.name||"",""),V(s.onboardSent(C.name)))},cr={st:u,dispatch:d,t:s,lang:c,mode:le,caps:U,pipe:G,token:$,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:It,thumbOf:Le,canWrite:Q,commitStatus:X,saveNote:ae,stageOf:Ee,setStage:Oe,flashErr:re,startTour:()=>A(!0),dossiers:p.dossiers,scopedAll:ue,scoped:oe,counts:Ce,byId:ne,contName:ce,favIds:p.favIds,toggleFav:ir,askEvaluate:ge,doAnalyse:me,doDecide:Fe,doPromote:ft,doApproach:Pe,doThumb:rr,doDeep:or,doUndo:Bt,doSync:sr,doOnboard:lr,outbound:Aa,memoQueued:W.current,approachDone:J.current,sessTally:x,evalCards:_.current,evalBusy:N,markRow:f,markedId:h,flash:V};g.useEffect(()=>{const C=D=>{D.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[]);const dr=C=>$?t.jsx(Ws,{token:$,children:C}):t.jsx(t.Fragment,{children:C});return t.jsx(tr.Provider,{value:cr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:ko}),dr(t.jsxs("div",{className:"app"+(G?" pipe":"")+($?" has-thesis":""),children:[U.showTicker&&t.jsx(fe,{name:"live",children:t.jsxs("div",{className:"live-stack"+($?" live-stack--cibles":""),children:[t.jsx(qo,{}),!!$&&t.jsx(Gs,{})]})}),U.showIdent&&t.jsx(fe,{name:"identite",children:t.jsx(Jo,{})}),U.showOnb&&t.jsx(fe,{name:"onboarding",children:t.jsx(Xo,{})}),U.showMorning&&t.jsx(fe,{name:"matin",children:t.jsx(Qo,{})}),t.jsx(fe,{name:"fraicheur",children:t.jsx(_o,{})}),t.jsx(fe,{name:"mesure",children:t.jsx(Uo,{})}),U.showFunnel&&t.jsx(fe,{name:"entonnoir",children:t.jsx(Zs,{})}),U.showFunnel&&t.jsx(fe,{name:"tunnel",children:t.jsx(ei,{})}),U.showFunnel&&t.jsx(fe,{name:"tuto",children:t.jsx(ai,{})}),t.jsx(fe,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(el,{}),t.jsxs("div",{className:"stage"+(u.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(Qi,{}),t.jsx(Xi,{})]})]})}),U.showDemand&&t.jsx(fe,{name:"evaluation",children:t.jsx(ts,{})}),U.showDemand&&u.memoConsole&&t.jsx(fe,{name:"console",children:t.jsx(ns,{})}),t.jsx(fe,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(vs,{})}),!!$&&t.jsx(fe,{name:"edition",children:t.jsx(Ks,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),U.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),u.popupId&&t.jsx(fe,{name:"fiche",children:t.jsx(is,{})}),t.jsx(fe,{name:"modales",children:t.jsx(Es,{})}),t.jsx(Io,{}),z&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:z.o.name}),t.jsx(Wo,{placeholder:z.yes?s.whyYesPh:s.whyNoPh,onDone:C=>{const D=z.o;k(null),C&&ae(D,C).then(I=>{I&&V(s.csNoteSaved)})}})]}),T&&t.jsx(Ko,{steps:Xs(s),onClose:()=>{A(!1),kn($)}}),j&&t.jsx("div",{className:"flash on"+(L?" err":""),children:j}),b&&t.jsx(so,{variant:"acquirer",initialCompany:jn().co,initialWebsite:jn().site,onClose:()=>v(null)})]})})}function Zs(){const{t:e}=F(),[a,r]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function el(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:o,t:i}=F(),c=g.useMemo(()=>{const s={};return e.forEach(p=>{ja(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[xo.map(s=>{const p=wa.find(d=>d.key===s),u=s==="monde"?i.contWorld:o==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[u,t.jsx("span",{className:"n",children:c[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?i.showMap:i.hideMap})})]})}function jn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function tl(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{ar as FlagCell,et as SigBadge,Dt as SigWin,rl as default,tl as fmtShort,F as useV2};
