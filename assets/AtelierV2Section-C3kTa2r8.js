...
.atl2 .bulk .side .hint{white-space:nowrap}`,yl=`
...
`,jl=vl+yl+wl+kl;function fn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function El(){const e=fn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Nl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=El();return r==="0"?"client":r==="1"||fn("embed")==="1"&&fn("chrome")==="1"?"apercu":"client"}const Sl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Cl=e=>Sl[e];function La(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const qt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!fo(a)||La(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Gi(e.cc)})};function Ja(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const zl=60*60*1e3;function Al(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>zl?null:a}catch{return null}}function ha(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ql=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Tl(e,a,r="default"){const n=r!=="default",o=c.useMemo(()=>e||n?{mode:"anon"}:Mi(),[e,n]),i=c.useMemo(()=>n?"visiteur":Nl(e,o),[e,o,n]),d=c.useMemo(()=>Cl(i),[i]),l=i!=="visiteur",s=ql(r),[g,p]=c.useState([]),[x,m]=c.useState(""),[b,u]=c.useState(null),[w,k]=c.useState(null),[f,v]=c.useState(null),[j,y]=c.useState(()=>new Map),[N,E]=c.useState(()=>new Map),[S,T]=c.useState(""),[C,L]=c.useState(new Set),[D,H]=c.useState(null),[R,O]=c.useState(!0),[h,q]=c.useState(!1),[M,W]=c.useState(0),[z,I]=c.useState(0),P=c.useRef(0),U=c.useMemo(()=>{var $;if(i!=="client")return"";try{return(($=Di())==null?void 0:$.email)||""}catch{return""}},[i]);c.useEffect(()=>{const $=++P.current;let le=!0;const J=()=>le&&$===P.current,de=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),he=Al(de);return he?(p(he.objs.map(qt)),he.fund&&m(he.fund),u(he.marketEstimate??null),k(he.criteria??null),v(he.stats??null),T(he.generatedAt||""),O(!1)):O(!0),(async()=>{try{if(r==="ops"){const xe=await Ga(),be=((xe==null?void 0:xe.recent_ops)||[]).map(ve=>{const ye=Ea(ve.company_name||ve.title?ve:{...ve,title:(ve.headline_fr||ve.headline||"").slice(0,120)},a),Te=String(ve.rubrique||"").toLowerCase();return ye&&(Te==="nominations"||Te==="recrutements")&&(ye.engine=Te),ye&&!String(ve.company_name||"").trim()&&(ye.noCo=!0),ye}).filter(ve=>!!ve).map(ve=>(fo((ve.name||"").trim())||(ve.noCo=!0),ve));try{const ve=Ii(),ye=await Pi(),Te=((ye==null?void 0:ye.date)||"").slice(0,10),ne=ve?ve.doc:ye,ke=_i(ne),B=((ve==null?void 0:ve.day)||(ne==null?void 0:ne.date)||Te||"").slice(0,10);if(B&&ke.length){const V=new Set;for(const Y of be){if((Y.date||"").slice(0,10)!==B)continue;const Q=Xn(ke,V,Y.name,"");Q>=0&&(V.add(Q),Y.decryptHtml=ke[Q].html)}for(const Y of be){if(Y.decryptHtml||(Y.date||"").slice(0,10)!==B)continue;const Q=Xn(ke,V,"",Y.headline||Y.tagline||Y.name);Q>=0&&(V.add(Q),Y.decryptHtml=ke[Q].html)}}if(B){const V=((ne==null?void 0:ne.title_fr)||"").trim(),Y=((ne==null?void 0:ne.lead_fr)||"").trim(),Q=Bi(ne),se=((ne==null?void 0:ne.url)||"").trim();V&&(Q||se)&&be.unshift({id:`edito:${B}`,kind:"op",name:V,cc:null,date:B,engine:"edito",dealKind:"other",headline:V,tagline:Y||V,decryptHtml:Q||void 0,url:se,noCo:!0})}}catch{}if(!J())return;p(be.map(qt)),ha(de,{objs:be})}else if(typeof r=="object"){const be=(await Zn()||[]).filter(ye=>(ye.slug||"")===r.research).map(ye=>er(ye,a)).filter(ye=>!!ye),ve=Ja(await tr(be,a));if(!J())return;p(ve.map(qt)),ha(de,{objs:ve})}else if(l&&o.token){const xe=$i(o.token),be=Ga(),ve=Ui(o.token),ye=Hi(o.token),Te=Vi(o.token),ne=await xe;let ke=ne?ne.targets:[];J()&&ne&&(m(ne.fund||""),u(ne.marketEstimate??null),k(ne.criteria??null),v(ne.stats??null),T(ne.generatedAt||""),p(ke.map(qt)),O(!1),q(!1));const[B,V,Y,Q]=await Promise.all([be,ve,ye,Te]),se=((B==null?void 0:B.recent_ops)||[]).map(ue=>Ea(ue,a)).filter(ue=>!!ue),pe=new Set(ke.map(ue=>ue.id));if(ke=[...ke,...se.filter(ue=>!pe.has(ue.id)&&(pe.add(ue.id),!0))],!J())return;p(ke.map(qt));const re=new Set;for(const ue of V){const ce=(ue.id||ue.co||"").toString().trim().toLowerCase();ce&&re.add(ce.startsWith("t:")?ce:"t:"+ce)}L(re),y(Y),E(Q),ne&&ha(de,{fund:ne.fund,marketEstimate:ne.marketEstimate,criteria:ne.criteria,stats:ne.stats,generatedAt:ne.generatedAt,objs:ke})}else{const xe=Wi(),be=Zn(),ve=Ga(),ye=await xe;J()&&ye.length&&(p(Ja(ye).map(qt)),O(!1),q(!1));const[Te,ne]=await Promise.all([be,ve]),ke=(Te||[]).map(Q=>er(Q,a)).filter(Q=>!!Q),B=await tr(ke,a),V=((ne==null?void 0:ne.recent_ops)||[]).map(Q=>Ea(Q,a)).filter(Q=>!!Q),Y=Ja([...ye,...B,...V]);if(!J())return;p(Y.map(qt)),ha(de,{objs:Y})}J()&&q(!1)}catch{J()&&!he&&q(!0)}finally{J()&&O(!1)}})(),()=>{le=!1}},[l,o.token,a,M,s]),c.useEffect(()=>{if(!d.showCredits||!U){H(null);return}let $=!0;return(async()=>{try{const le=await fetch(`${Ha}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:U})});if(!le.ok)return;const J=await le.json();$&&J&&J.ok!==!1&&H(J)}catch{}})(),()=>{$=!1}},[d.showCredits,U,z]);const ae=c.useCallback($=>L(new Set($)),[]);return{session:o,mode:i,caps:d,fund:x,email:U,marketEstimate:b,generatedAt:S,criteria:w,thesisMode:String((w==null?void 0:w.mode)||""),stats:f,thumbs:j,stages:N,dossiers:g,patchStatuses:($,le)=>{p(J=>{let de=!1;const he=J.map(xe=>{if(!xe.checkId)return xe;const be=$.get(xe.checkId);return!be||be===(xe.ceoStatus||"")||!le(xe.id)?xe:(de=!0,{...xe,ceoStatus:be})});return de?he:J})},favIds:C,setFavIds:ae,credits:D,reloadCredits:()=>I($=>$+1),loading:R,error:h,refresh:()=>W($=>$+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Na=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Fa(e){return Na.has(e.engine||"")}function Je(e){return!!e.noCo||Fa(e)&&!!e.url}const Lo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ll=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Lo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Fl=new Set(["signal","amount","score","crible","memo"]);function Rl(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Lo(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Fl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Fo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Fo=80;function Ra(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!$e(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ln(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(kt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Tt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(go(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function oa(e,a,r){return We(e)?Ra(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ra(e,a.filters,r)}function Ol(e,a,r,n){return!(!oa(e,a,r)||r&&!ho(e,a.ptab,n))}function Dn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-kt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Qi(o)||null;case"memo":return Yi(o)||null;case"signal":{const i=$e(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Xa={},br=(Xa==null?void 0:Xa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function vr(){return new Date().toISOString().slice(0,10)}const In=c.createContext(null);function Ro(){return c.useContext(In)}function Ml(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const g=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(p=>s.removeAttribute(p.name)),g&&/^https?:\/\//i.test(g)&&(s.setAttribute("href",g),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Oo(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Dl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Oo(r),r.innerHTML):e}catch{return e}}function yr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Oo(r),r.innerHTML):e}catch{return e}}function wr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Mo(){const e=c.useContext(In);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Il({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Z(),[i,d]=c.useState(()=>n.filters.day||vr()),[l,s]=c.useState(null),[g,p]=c.useState(!1),x=c.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),m=c.useCallback(()=>{d(vr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);c.useEffect(()=>{const w=k=>{var v;const f=(v=k.detail)==null?void 0:v.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),c.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),c.useEffect(()=>{if(!e||!i)return;let w=!1;p(!0);const k=new URLSearchParams({token:e,date:i});return fetch(`${br}/cibles/edition.json?${k}`).then(f=>f.json()).then(f=>{w||s(f)}).catch(()=>{w||s({ok:!1,error:"network"})}).finally(()=>{w||p(!1)}),()=>{w=!0}},[e,i]);const b=c.useMemo(()=>`${br}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),u=c.useMemo(()=>({token:e,day:i,ed:l,loading:g,pickDay:x,pickWindow:m,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,g,x,m,n.filters.day,b,o]);return t.jsx(In.Provider,{value:u,children:a})}function Pl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Mo(),[o,i]=c.useState(()=>n||xo());return c.useEffect(()=>{n&&i(!0)},[n]),c.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(Aa,d),()=>window.removeEventListener(Aa,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Ki,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function _l(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function kr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function jr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Bl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Mo(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,g=c.useRef(null),[p,x]=c.useState("fonds"),[m,b]=c.useState(null),[u,w]=c.useState("idle"),k=c.useRef(!1);c.useEffect(()=>{b(null),w("idle"),k.current=!1,x("fonds")},[e]),c.useEffect(()=>{if(p!=="jour"||k.current)return;k.current=!0;let N=!0;return w("load"),_l(e).then(E=>{N&&(b(E),w("fait"))}),()=>{N=!1}},[p,e]);const f=c.useMemo(()=>Dl((m==null?void 0:m.html)||""),[m==null?void 0:m.html]),v=c.useRef(null);c.useEffect(()=>{const N=v.current;if(!N||!f)return;let E=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(E||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{E=!0}},[f]);const j=c.useMemo(()=>yr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),y=c.useMemo(()=>yr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return c.useEffect(()=>{const N=g.current;if(!N||!j)return;let E=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(E||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{E=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const N=(a==null?void 0:a.date)||e,E=/^(\d{4})-(\d{2})-(\d{2})/.exec(N);return E?i?`${E[2]}/${E[3]}/${E[1]}`:`${E[3]}/${E[2]}/${E[1]}`:N})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":p==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":p==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),p==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),p==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p==="fonds"&&s&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),p==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?kr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:wr(e,!0)}),"."]}):kr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:wr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),p==="fonds"&&d&&j?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,p==="fonds"&&d&&y?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:y}}):null,p==="jour"&&(f?t.jsxs(t.Fragment,{children:[(m==null?void 0:m.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:m.title}),t.jsx("div",{ref:v,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:u==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:u!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:jr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:jr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const $l=300,ga=7,Ul={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Do={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Hl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Za(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(es(r)&&r!=="media")return"news:"+r;const n=$e(e);return n?"sig:"+(n.theme&&Do.fr[n.theme]?n.theme:"other"):"actualites"}function Vl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=Z(),s=Ro(),g=d==="en",[p,x]=c.useState("all"),[m,b]=c.useState(!1),u=c.useMemo(()=>{var le;const h=(a.filters.day||"").slice(0,10),q=J=>!(!i&&a.continent!=="monde"&&J.continent!==a.continent||h&&(J.date||"").slice(0,10)!==h),M=e.filter(J=>q(J)&&$e(J)&&(!i||J.kind!=="target"||Ae(J)!==5)),W=i&&(((le=s==null?void 0:s.ed)==null?void 0:le.ops)||[]).length?s.ed.ops.map(J=>Ea(J,d)).filter(J=>!!J).map(J=>(J.briefOnly=!0,J)).filter(J=>!h||(J.date||"").slice(0,10)===h):[],z=e.filter(J=>q(J)&&J.kind==="op"&&(h?!0:kt(J.date)<=ga)),I=i?W.length?W:z.filter(J=>{const de=(l||"").trim().toLowerCase();if(!de)return!1;const he=J.match||null;return he?Object.keys(he).map(xe=>xe.trim().toLowerCase()).includes(de):!1}):z,P=h||new Date().toISOString().slice(0,10),U=J=>{const de=Za(J);return de==="ma"?0:de==="levees"?1:2};I.sort((J,de)=>{const he=U(J)-U(de);if(he)return he;const xe=(J.date||"").slice(0,10)===P?0:1,be=(de.date||"").slice(0,10)===P?0:1;return xe!==be?xe-be:(de.amountEur||0)-(J.amountEur||0)});const ae=new Set,$=[];for(const J of[...I,...Dn(M,{key:"signal",dir:-1})]){const de=J.id||J.name;!de||ae.has(de)||(ae.add(de),$.push(J))}return i&&$.length===0?e.filter(de=>q(de)&&kt(de.date)<=ga).sort((de,he)=>(he.date||"").localeCompare(de.date||"")).slice(0,80):$},[e,a.continent,a.filters.day,i,l,d,s]),w=c.useMemo(()=>{const h={};for(const q of u){const M=Za(q);h[M]=(h[M]||0)+1}return h},[u]),k=c.useMemo(()=>p==="all"?u:u.filter(h=>Za(h)===p),[u,p]),f=c.useMemo(()=>k.slice(0,$l),[k]),v=k.length-f.length,j=c.useRef(null);c.useEffect(()=>{var I,P;const h=j.current;if(!h)return;const q=()=>{const U=h.scrollWidth;U<200||(h.style.animationDuration=Math.max(18,Math.round(U/130))+"s")};q();const M=requestAnimationFrame(q),W=window.setTimeout(q,1200);let z=!0;return(P=(I=document.fonts)==null?void 0:I.ready)==null||P.then(()=>{z&&q()}),()=>{z=!1,cancelAnimationFrame(M),window.clearTimeout(W)}},[f.length,p]);const y=h=>h==="all"?u.length:w[h]||0,N=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return Do[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const q=h.slice(5);return Xi[q]?Zi(q,g?"en":"fr"):h}return Ul[g?"en":"fr"][h]},E=[{k:"all"}],S=["ma","levees"].filter(h=>y(h)>0||h===p);if(S.length){E.push({g:g?"Deals":"Opérations"});for(const h of S)E.push({k:h})}const T=["nominations","recrutements"].filter(h=>y(h)>0||h===p),C=Ji.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>y(h)>0||h===p),L=y("actualites")>0||p==="actualites"?["actualites"]:[];if(T.length||C.length||L.length){E.push({g:g?"News":"Actualités"});for(const h of T)E.push({k:h});for(const h of C)E.push({k:h});for(const h of L)E.push({k:h})}const D=Hl.map(h=>"sig:"+h).filter(h=>y(h)>0||h===p);if(D.length){E.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of D)E.push({k:h})}const H=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},R=(()=>{const h=(a.filters.day||"").slice(0,10),q=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(g?`LIVE covers the events of ${H(h)}.`:`Le LIVE regroupe les événements du ${H(h)}.`)+q:(g?`LIVE covers the still-open signals and the deals of the last ${ga} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ga} derniers jours.`)+q})(),O=h=>f.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ge(q)?" spent":""),onClick:M=>{const W=q.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:W?"":q.id,name:q.name,url:q.url||"",text:q.tagline||q.headline||"",card:q.card}}))}catch{}if(W||n({type:"focus",id:q.id}),a.dens!=="liste"){const z=M.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:z.left+z.width/2,y:z.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(Nt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(wi,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Wc(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Va,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(q.id||q.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":m,onClick:()=>b(h=>!h),children:[N(p),t.jsx("b",{children:y(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!m,children:[t.jsx("span",{className:"tkfilscope",children:R}),E.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===p,onClick:()=>{x(h.k),b(!1)},children:[N(h.k),t.jsx("b",{children:y(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:j,children:[O(0),O(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!s&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!s&&t.jsx(Gl,{isEn:g})]})}const Wl=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Gl({isEn:e}){const[a,r]=c.useState(()=>xo());c.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Aa,o),()=>window.removeEventListener(Aa,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>ts(!a),children:Wl})}const Pn="+33 6 83 10 72 86",Oa="alexandre@proplace.co",Io=`tel:${Pn.replace(/[^\d+]/g,"")}`;function Yl(){return null}class dt extends c.Component{constructor(){super(...arguments);Qn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Po=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Er(e,a){if((St(e)||"").startsWith("CALL")&&Ae(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ae(e)>=2;return Po.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const Nr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",Ql={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function Kl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=Z(),[l,s]=c.useState(""),[g,p]=c.useState(!1),[x,m]=c.useState(!1),b=c.useRef(null);if(c.useEffect(()=>{if(!x)return;const v=j=>{b.current&&!b.current.contains(j.target)&&(m(!1),p(!1))};return document.addEventListener("click",v,!0),()=>document.removeEventListener("click",v,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const u=(e.ceoStatus||"").trim(),w=async v=>{if(l)return;if(v==="Analysé"&&!e.memoUrl){p(!0);return}s(v);const j=(Er(e,a).find(([N])=>N===v)||[v,v])[1],y=await o(e,v,{msg:a.csMoved(e.name,j)});s(""),y&&(p(!1),m(!1))},k=Er(e,a),f=v=>(k.find(([j])=>j===v)||[])[1]||v;return k.length===2?t.jsx("span",{className:"rstat rst2",onClick:v=>v.stopPropagation(),children:k.map(([v,j])=>t.jsx("button",{type:"button",className:"rsd "+(v==="Validé"?"yes":"no")+(l===v?" busy":""),disabled:!!l,onClick:()=>{w(v)},children:j},v))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:v=>v.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+Nr(u),onClick:()=>{m(v=>!v),p(!1)},children:l?f(l)+"…":u?f(u):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:k.map(([v,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":u===v,className:"rsopt"+(u===v?" on":"")+(l===v?" busy":""),disabled:!!l,onClick:()=>{if(v===u){m(!1);return}w(v)},children:[t.jsx("i",{className:"pt2",style:{background:Ql[Nr(v)]}}),j]},v))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),p(!1),m(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const v=await o(e,"Analysé");s(""),v&&(p(!1),m(!1))})()},children:a.csAnaAnyway})]})})]})}function Jl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Z(),[i,d]=c.useState(""),[l,s]=c.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),p=(St(e)||"").startsWith("CALL")&&Ae(e)===3,x=Ae(e)>=2,m=async u=>{if(i||u==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(u);const w=await o(e,u);d(""),w&&(s(!0),setTimeout(()=>s(!1),2200))},b=p?[["Validé",a.csYes],["Écarté",a.csNo]]:Po.filter(([u])=>!(x&&u==="Retenu")).map(([u,w])=>[u,a[w]]);return t.jsxs("div",{className:"csp",onClick:u=>u.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([u,w])=>t.jsx("button",{type:"button",className:"csb"+(g===u?" on":"")+(i===u?" busy":""),disabled:!!i,onClick:()=>{m(u)},children:w},u)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Xl,{o:e})]})}function Xl({o:e}){const{t:a,saveNote:r,flash:n}=Z(),[o,i]=c.useState(e.ceoNote||""),[d,l]=c.useState(!1),[s,g]=c.useState(!1),p=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!p)return;l(!0);const m=await r(e,o.trim());l(!1),m&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:m=>i(m.target.value),onKeyDown:m=>{m.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!p,onClick:()=>{x()},children:s?a.csNoteSaved:a.csNoteOk})]})}function Sr({placeholder:e,onDone:a}){const{t:r}=Z(),[n,o]=c.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Zl({o:e}){var k;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=Z(),[s,g]=c.useState(!1);if(!n.pipe||!o||n.lockActions||Ae(e)!==4)return null;const p=i(e),x=(p==null?void 0:p.stage)||"todo",m=async f=>{if(s||f===x)return;g(!0);const v=p;d(e,{stage:f,stamps:(p==null?void 0:p.stamps)||{}});const j=Math.max(Date.now(),Cr+=1);Cr=j;const y=await as(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!y.stale&&(y.ok||(d(e,v),l(a.actErr)))},b=(k=p==null?void 0:p.stamps)==null?void 0:k.sent,u=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=x==="sent"&&b&&u>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,v])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:s,onClick:()=>{m(f)},children:v},f)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(u)})]})}let Cr=0;const Kt=8,jt=360;function zr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Ar({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(zr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(zr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function ed({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Z(),[d,l]=c.useState(0),[s,g]=c.useState(null),[p,x]=c.useState([]),m=c.useRef(!1),b=c.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),u=c.useRef(!1);c.useEffect(()=>{const S=b.current;return()=>{u.current||(n({type:"ptab",tab:S.ptab}),n({type:"dens",dens:S.dens}),n({type:"modal",modal:S.modal}))}},[]),c.useEffect(()=>{m.current||(m.current=!0,x(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const w=p[d],k=d>=p.length;c.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const S=w.click,T=window.setTimeout(()=>{const C=document.querySelector(S);C&&C.getAttribute("aria-selected")!=="true"&&C.click()},60);return()=>window.clearTimeout(T)}},[d,w]);const f=c.useRef(-1),v=c.useCallback(()=>{if(!w){g(null);return}const S=L=>{if(!L)return null;for(const D of document.querySelectorAll(L)){const H=D.getBoundingClientRect();if(H.width>1&&H.height>1)return D}return null},T=S(w.sel)||S(w.need);if(!T){g(null);return}f.current!==d&&(f.current=d,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const C=T.getBoundingClientRect();g(L=>L&&Math.abs(L.top-C.top)<1&&Math.abs(L.left-C.left)<1&&Math.abs(L.width-C.width)<1&&Math.abs(L.height-C.height)<1?L:C)},[w,d]);c.useLayoutEffect(()=>{v();const S=[90,300,700,1300].map(L=>window.setTimeout(v,L)),T=window.setInterval(v,400),C=()=>v();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{S.forEach(L=>window.clearTimeout(L)),window.clearInterval(T),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[v]);const j=c.useRef(a);if(j.current=a,c.useEffect(()=>{const S=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),j.current()):T.key==="ArrowRight"?l(C=>C+1):T.key==="ArrowLeft"&&l(C=>Math.max(0,C-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!p.length)return null;let y=null;const N=S=>()=>{u.current=!0,n({type:"modal",modal:null}),S()};if(k){const S=o[3]||0;S>0?y={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?y={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?y={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let E={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:jt};if(!k&&s){const S=s.bottom+14,T=window.innerHeight-S;let C=T>190?S:Math.max(12,s.top-200),L=Math.min(Math.max(12,s.left+s.width/2-jt/2),window.innerWidth-jt-12);T<=190&&s.top<212&&(window.innerWidth-s.right>=jt+40?L=Math.min(s.right+26,window.innerWidth-jt-12):s.left>=jt+40&&(L=Math.max(12,s.left-jt-26)),C=Math.max(12,s.top-Kt)),E={left:L,top:C,width:jt}}return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!k&&s&&t.jsx("div",{className:"tour-hole",style:{left:s.left-Kt,top:s.top-Kt,width:s.width+Kt*2,height:s.height+Kt*2}}),(k||!s)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(k?" fin":""),style:E,children:[k&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(Ar,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(p.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,p.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/p.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(Ar,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(S=>S+1),children:d===p.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function _o(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Bo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function td(){var T,C;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:s}=Z(),g=r?a:e,p=c.useMemo(()=>g.filter(L=>kt(L.date)===0&&L.kind==="target"),[g]),x=c.useMemo(()=>r?a.filter(L=>L.kind==="target"&&Ae(L)===0).slice().sort((L,D)=>(D.date||"").localeCompare(L.date||"")):[],[a,r]),m=c.useMemo(()=>p.filter(L=>r?Ae(L)===0:!Ge(L)),[p,r]),b=r?x:m,u=r?a.length-x.length:p.length-m.length,w=r?a.length:p.length,k=w?Math.min(100,u/w*100):100,f=c.useMemo(()=>_o(g),[g]),v=!!f&&kt(f)>0,j=c.useMemo(()=>v?g.filter(L=>(L.date||"").slice(0,10)===f):[],[g,f,v]),y=typeof((T=l.stats)==null?void 0:T.kept_today)=="number"?l.stats.kept_today:null,N=typeof((C=l.stats)==null?void 0:C.screened_today)=="number"?l.stats.screened_today:p.length;let E;v?E=o.morningLast(j.length,x.length,Bo(f,d)):r?E=o.morningThesis(N,x.length,y):p.length?u===0?E=o.goalSourced(p.length):u>=p.length?E=o.goalCleared:E=o.goalDone(u,p.length):E=o.goalSourced(0);const S=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&x.length&&s({type:"chainStart",queue:x.map(L=>L.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:E}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:k+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:S,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}const ad=[0,1,2,3,5,10];function nd(){var ae;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:d,scopedAll:l,mode:s,doSync:g,startTour:p,flash:x,flashErr:m}=Z(),[b,u]=c.useState(null),[w,k]=c.useState(!0),[f,v]=c.useState([]),j=s==="client";c.useEffect(()=>{if(!o||!i)return;let $=!0;return k(!0),(async()=>{const[le,J]=await Promise.all([Fn(i),bo(o)]);$&&(le&&u(le),k(!1),v(J))})(),()=>{$=!1}},[o,i]);const[y,N]=c.useState(!1),[E,S]=c.useState(""),T=()=>{!j||y||!i||(N(!0),S(""),ns(i).then($=>{if(N(!1),$.pending){S(e.refreshSlow);return}if(!$.ok){$.error&&console.warn("[republish]",$.error),S(e.refreshKo);return}const le=$.entered??0,J=$.left??0;S($.unchanged||!le&&!J?e.refreshSame:e.refreshDone(le,J)),d.refresh()}))},C=(b==null?void 0:b.per_day)??null,L=((ae=b==null?void 0:b.pool_order)==null?void 0:ae.length)??0,D=f.filter($=>$.status==="running").length,[H,R]=c.useState(!1),O=$=>{!j||H||!o||(R(!0),vo(o,$).then(le=>{if(R(!1),le===null){m(e.actErr);return}u(J=>J&&{...J,per_day:le}),x(e.alertSaved)}))},h=d.marketEstimate,q=c.useMemo(()=>l.filter($=>!We($)).length,[l]),M=h&&h>0?Math.min(100,Math.round(q/h*100)):null,W=$=>$.toLocaleString(a==="en"?"en-US":"fr-FR"),z=b==null?void 0:b.offre,I=z&&z.rythme>0&&z.file>0?z.jours_restants:null,P=(i||"P").split(/\s+/).map($=>$[0]).join("").slice(0,2).toUpperCase(),U=(()=>{const $=Date.parse(d.generatedAt||"");if(Number.isNaN($))return"";const le=new Date($),J=de=>String(de).padStart(2,"0");return`${J(le.getDate())}/${J(le.getMonth()+1)} à ${J(le.getHours())}:${J(le.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?P:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),U?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(U)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||y,onClick:T,children:y?"⏳":"📰"}),(y||!!E)&&t.jsxs("span",{className:"repubst",children:[y?e.refreshRun:E,!y&&t.jsx("button",{type:"button",onClick:()=>S(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:g,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:p,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:$=>n({type:"filters",patch:{search:$.target.value}})})]})]}),t.jsxs("div",{className:"idmain",children:[t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),M!==null&&h?t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:M+"%"}})}),t.jsx("b",{children:W(q)})]}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(q,h)}})]}):t.jsx("span",{className:"ev",children:t.jsx("b",{children:W(q)})}),z&&t.jsxs("span",{className:"eeta",children:[z.libelle," · ",z.delai,I!=null?` · ${e.identEtaDays(I)}`:C===0?` · ${e.qEtaPaused}`:""]}),C!==null&&t.jsx("span",{className:"ev covrb erate",role:"group","aria-label":e.covRate,onClick:$=>$.stopPropagation(),children:ad.map($=>t.jsx("button",{type:"button",className:C===$?"on":"",disabled:!j||H,title:$===0?e.identPauseTitle:e.covRateNow($),onClick:()=>O($),children:$===0?"⏸":$},$))})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),C===0&&t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),D>0&&t.jsxs("span",{className:"ev",children:["⏳ ",D]}),t.jsx("span",{className:"ego",children:w?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:$=>{$.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]})]})]})}class Ft{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*rd(e){for(const a of e)yield*a}function $o(e){return Array.from(rd(e))}var Ce=1e-6,je=Math.PI,ot=je/2,qr=je/4,st=je*2,bt=180/je,et=je/180,Le=Math.abs,od=Math.atan,ia=Math.atan2,Oe=Math.cos,Me=Math.sin,id=Math.sign||function(e){return e>0?1:e<0?-1:0},Mt=Math.sqrt;function sd(e){return e>1?0:e<-1?je:Math.acos(e)}function sa(e){return e>1?ot:e<-1?-ot:Math.asin(e)}function it(){}function Ma(e,a){e&&Lr.hasOwnProperty(e.type)&&Lr[e.type](e,a)}var Tr={Feature:function(e,a){Ma(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ma(r[n].geometry,a)}},Lr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){hn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)hn(r[n],a,0)},Polygon:function(e,a){Fr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Fr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ma(r[n],a)}};function hn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Fr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)hn(e[r],a,1);a.polygonEnd()}function _t(e,a){e&&Tr.hasOwnProperty(e.type)?Tr[e.type](e,a):Ma(e,a)}function gn(e){return[ia(e[1],e[0]),sa(e[2])]}function Ut(e){var a=e[0],r=e[1],n=Oe(r);return[n*Oe(a),n*Me(a),Me(r)]}function xa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Da(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function en(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ba(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function xn(e){var a=Mt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function bn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function vn(e,a){return Le(e)>je&&(e-=Math.round(e/st)*st),[e,a]}vn.invert=vn;function ld(e,a,r){return(e%=st)?a||r?bn(Or(e),Mr(a,r)):Or(e):a||r?Mr(a,r):vn}function Rr(e){return function(a,r){return a+=e,Le(a)>je&&(a-=Math.round(a/st)*st),[a,r]}}function Or(e){var a=Rr(e);return a.invert=Rr(-e),a}function Mr(e,a){var r=Oe(e),n=Me(e),o=Oe(a),i=Me(a);function d(l,s){var g=Oe(s),p=Oe(l)*g,x=Me(l)*g,m=Me(s),b=m*r+p*n;return[ia(x*o-b*i,p*r-m*n),sa(b*o+x*i)]}return d.invert=function(l,s){var g=Oe(s),p=Oe(l)*g,x=Me(l)*g,m=Me(s),b=m*o-x*i;return[ia(x*o+m*i,p*r+b*n),sa(b*r-p*n)]},d}function dd(e,a,r,n,o,i){if(r){var d=Oe(a),l=Me(a),s=n*r;o==null?(o=a+n*st,i=a-s/2):(o=Dr(d,o),i=Dr(d,i),(n>0?o<i:o>i)&&(o+=n*st));for(var g,p=o;n>0?p>i:p<i;p-=s)g=gn([d,-l*Oe(p),-l*Me(p)]),e.point(g[0],g[1])}}function Dr(e,a){a=Ut(a),a[0]-=e,xn(a);var r=sd(-a[1]);return((-a[2]<0?-r:r)+st-Ce)%st}function Uo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:it,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Sa(e,a){return Le(e[0]-a[0])<Ce&&Le(e[1]-a[1])<Ce}function va(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Ho(e,a,r,n,o){var i=[],d=[],l,s;if(e.forEach(function(u){if(!((w=u.length-1)<=0)){var w,k=u[0],f=u[w],v;if(Sa(k,f)){if(!k[2]&&!f[2]){for(o.lineStart(),l=0;l<w;++l)o.point((k=u[l])[0],k[1]);o.lineEnd();return}f[0]+=2*Ce}i.push(v=new va(k,u,null,!0)),d.push(v.o=new va(k,null,v,!1)),i.push(v=new va(f,u,null,!1)),d.push(v.o=new va(f,null,v,!0))}}),!!i.length){for(d.sort(a),Ir(i),Ir(d),l=0,s=d.length;l<s;++l)d[l].e=r=!r;for(var g=i[0],p,x;;){for(var m=g,b=!0;m.v;)if((m=m.n)===g)return;p=m.z,o.lineStart();do{if(m.v=m.o.v=!0,m.e){if(b)for(l=0,s=p.length;l<s;++l)o.point((x=p[l])[0],x[1]);else n(m.x,m.n.x,1,o);m=m.n}else{if(b)for(p=m.p.z,l=p.length-1;l>=0;--l)o.point((x=p[l])[0],x[1]);else n(m.x,m.p.x,-1,o);m=m.p}m=m.o,p=m.z,b=!b}while(!m.v);o.lineEnd()}}}function Ir(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function tn(e){return Le(e[0])<=je?e[0]:id(e[0])*((Le(e[0])+je)%st-je)}function pd(e,a){var r=tn(a),n=a[1],o=Me(n),i=[Me(r),-Oe(r),0],d=0,l=0,s=new Ft;o===1?n=ot+Ce:o===-1&&(n=-ot-Ce);for(var g=0,p=e.length;g<p;++g)if(m=(x=e[g]).length)for(var x,m,b=x[m-1],u=tn(b),w=b[1]/2+qr,k=Me(w),f=Oe(w),v=0;v<m;++v,u=y,k=E,f=S,b=j){var j=x[v],y=tn(j),N=j[1]/2+qr,E=Me(N),S=Oe(N),T=y-u,C=T>=0?1:-1,L=C*T,D=L>je,H=k*E;if(s.add(ia(H*C*Me(L),f*S+H*Oe(L))),d+=D?T+C*st:T,D^u>=r^y>=r){var R=Da(Ut(b),Ut(j));xn(R);var O=Da(i,R);xn(O);var h=(D^T>=0?-1:1)*sa(O[2]);(n>h||n===h&&(R[0]||R[1]))&&(l+=D^T>=0?1:-1)}}return(d<-Ce||d<Ce&&s<-1e-12)^l&1}function Vo(e,a,r,n){return function(o){var i=a(o),d=Uo(),l=a(d),s=!1,g,p,x,m={point:b,lineStart:w,lineEnd:k,polygonStart:function(){m.point=f,m.lineStart=v,m.lineEnd=j,p=[],g=[]},polygonEnd:function(){m.point=b,m.lineStart=w,m.lineEnd=k,p=$o(p);var y=pd(g,n);p.length?(s||(o.polygonStart(),s=!0),Ho(p,ud,y,r,o)):y&&(s||(o.polygonStart(),s=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),s&&(o.polygonEnd(),s=!1),p=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(y,N){e(y,N)&&o.point(y,N)}function u(y,N){i.point(y,N)}function w(){m.point=u,i.lineStart()}function k(){m.point=b,i.lineEnd()}function f(y,N){x.push([y,N]),l.point(y,N)}function v(){l.lineStart(),x=[]}function j(){f(x[0][0],x[0][1]),l.lineEnd();var y=l.clean(),N=d.result(),E,S=N.length,T,C,L;if(x.pop(),g.push(x),x=null,!!S){if(y&1){if(C=N[0],(T=C.length-1)>0){for(s||(o.polygonStart(),s=!0),o.lineStart(),E=0;E<T;++E)o.point((L=C[E])[0],L[1]);o.lineEnd()}return}S>1&&y&2&&N.push(N.pop().concat(N.shift())),p.push(N.filter(cd))}}return m}}function cd(e){return e.length>1}function ud(e,a){return((e=e.x)[0]<0?e[1]-ot-Ce:ot-e[1])-((a=a.x)[0]<0?a[1]-ot-Ce:ot-a[1])}const Pr=Vo(function(){return!0},md,hd,[-je,-ot]);function md(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?je:-je,s=Le(i-a);Le(s-je)<Ce?(e.point(a,r=(r+d)/2>0?ot:-ot),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&s>=je&&(Le(a-n)<Ce&&(a-=n*Ce),Le(i-l)<Ce&&(i-=l*Ce),r=fd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function fd(e,a,r,n){var o,i,d=Me(e-r);return Le(d)>Ce?od((Me(a)*(i=Oe(n))*Me(r)-Me(n)*(o=Oe(a))*Me(e))/(o*i*d)):(a+n)/2}function hd(e,a,r,n){var o;if(e==null)o=r*ot,n.point(-je,o),n.point(0,o),n.point(je,o),n.point(je,0),n.point(je,-o),n.point(0,-o),n.point(-je,-o),n.point(-je,0),n.point(-je,o);else if(Le(e[0]-a[0])>Ce){var i=e[0]<a[0]?je:-je;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function gd(e){var a=Oe(e),r=2*et,n=a>0,o=Le(a)>Ce;function i(p,x,m,b){dd(b,e,r,m,p,x)}function d(p,x){return Oe(p)*Oe(x)>a}function l(p){var x,m,b,u,w;return{lineStart:function(){u=b=!1,w=1},point:function(k,f){var v=[k,f],j,y=d(k,f),N=n?y?0:g(k,f):y?g(k+(k<0?je:-je),f):0;if(!x&&(u=b=y)&&p.lineStart(),y!==b&&(j=s(x,v),(!j||Sa(x,j)||Sa(v,j))&&(v[2]=1)),y!==b)w=0,y?(p.lineStart(),j=s(v,x),p.point(j[0],j[1])):(j=s(x,v),p.point(j[0],j[1],2),p.lineEnd()),x=j;else if(o&&x&&n^y){var E;!(N&m)&&(E=s(v,x,!0))&&(w=0,n?(p.lineStart(),p.point(E[0][0],E[0][1]),p.point(E[1][0],E[1][1]),p.lineEnd()):(p.point(E[1][0],E[1][1]),p.lineEnd(),p.lineStart(),p.point(E[0][0],E[0][1],3)))}y&&(!x||!Sa(x,v))&&p.point(v[0],v[1]),x=v,b=y,m=N},lineEnd:function(){b&&p.lineEnd(),x=null},clean:function(){return w|(u&&b)<<1}}}function s(p,x,m){var b=Ut(p),u=Ut(x),w=[1,0,0],k=Da(b,u),f=xa(k,k),v=k[0],j=f-v*v;if(!j)return!m&&p;var y=a*f/j,N=-a*v/j,E=Da(w,k),S=ba(w,y),T=ba(k,N);en(S,T);var C=E,L=xa(S,C),D=xa(C,C),H=L*L-D*(xa(S,S)-1);if(!(H<0)){var R=Mt(H),O=ba(C,(-L-R)/D);if(en(O,S),O=gn(O),!m)return O;var h=p[0],q=x[0],M=p[1],W=x[1],z;q<h&&(z=h,h=q,q=z);var I=q-h,P=Le(I-je)<Ce,U=P||I<Ce;if(!P&&W<M&&(z=M,M=W,W=z),U?P?M+W>0^O[1]<(Le(O[0]-h)<Ce?M:W):M<=O[1]&&O[1]<=W:I>je^(h<=O[0]&&O[0]<=q)){var ae=ba(C,(-L+R)/D);return en(ae,S),[O,gn(ae)]}}}function g(p,x){var m=n?e:je-e,b=0;return p<-m?b|=1:p>m&&(b|=2),x<-m?b|=4:x>m&&(b|=8),b}return Vo(d,l,i,n?[0,-e]:[-je,e-je])}function xd(e,a,r,n,o,i){var d=e[0],l=e[1],s=a[0],g=a[1],p=0,x=1,m=s-d,b=g-l,u;if(u=r-d,!(!m&&u>0)){if(u/=m,m<0){if(u<p)return;u<x&&(x=u)}else if(m>0){if(u>x)return;u>p&&(p=u)}if(u=o-d,!(!m&&u<0)){if(u/=m,m<0){if(u>x)return;u>p&&(p=u)}else if(m>0){if(u<p)return;u<x&&(x=u)}if(u=n-l,!(!b&&u>0)){if(u/=b,b<0){if(u<p)return;u<x&&(x=u)}else if(b>0){if(u>x)return;u>p&&(p=u)}if(u=i-l,!(!b&&u<0)){if(u/=b,b<0){if(u>x)return;u>p&&(p=u)}else if(b>0){if(u<p)return;u<x&&(x=u)}return p>0&&(e[0]=d+p*m,e[1]=l+p*b),x<1&&(a[0]=d+x*m,a[1]=l+x*b),!0}}}}}var Xt=1e9,ya=-Xt;function bd(e,a,r,n){function o(g,p){return e<=g&&g<=r&&a<=p&&p<=n}function i(g,p,x,m){var b=0,u=0;if(g==null||(b=d(g,x))!==(u=d(p,x))||s(g,p)<0^x>0)do m.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==u);else m.point(p[0],p[1])}function d(g,p){return Le(g[0]-e)<Ce?p>0?0:3:Le(g[0]-r)<Ce?p>0?2:1:Le(g[1]-a)<Ce?p>0?1:0:p>0?3:2}function l(g,p){return s(g.x,p.x)}function s(g,p){var x=d(g,1),m=d(p,1);return x!==m?x-m:x===0?p[1]-g[1]:x===1?g[0]-p[0]:x===2?g[1]-p[1]:p[0]-g[0]}return function(g){var p=g,x=Uo(),m,b,u,w,k,f,v,j,y,N,E,S={point:T,lineStart:H,lineEnd:R,polygonStart:L,polygonEnd:D};function T(h,q){o(h,q)&&p.point(h,q)}function C(){for(var h=0,q=0,M=b.length;q<M;++q)for(var W=b[q],z=1,I=W.length,P=W[0],U,ae,$=P[0],le=P[1];z<I;++z)U=$,ae=le,P=W[z],$=P[0],le=P[1],ae<=n?le>n&&($-U)*(n-ae)>(le-ae)*(e-U)&&++h:le<=n&&($-U)*(n-ae)<(le-ae)*(e-U)&&--h;return h}function L(){p=x,m=[],b=[],E=!0}function D(){var h=C(),q=E&&h,M=(m=$o(m)).length;(q||M)&&(g.polygonStart(),q&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),M&&Ho(m,l,h,i,g),g.polygonEnd()),p=g,m=b=u=null}function H(){S.point=O,b&&b.push(u=[]),N=!0,y=!1,v=j=NaN}function R(){m&&(O(w,k),f&&y&&x.rejoin(),m.push(x.result())),S.point=T,y&&p.lineEnd()}function O(h,q){var M=o(h,q);if(b&&u.push([h,q]),N)w=h,k=q,f=M,N=!1,M&&(p.lineStart(),p.point(h,q));else if(M&&y)p.point(h,q);else{var W=[v=Math.max(ya,Math.min(Xt,v)),j=Math.max(ya,Math.min(Xt,j))],z=[h=Math.max(ya,Math.min(Xt,h)),q=Math.max(ya,Math.min(Xt,q))];xd(W,z,e,a,r,n)?(y||(p.lineStart(),p.point(W[0],W[1])),p.point(z[0],z[1]),M||p.lineEnd(),E=!1):M&&(p.lineStart(),p.point(h,q),E=!1)}v=h,j=q,y=M}return S}}const yn=e=>e;var an=new Ft,wn=new Ft,Wo,Go,kn,jn,yt={point:it,lineStart:it,lineEnd:it,polygonStart:function(){yt.lineStart=vd,yt.lineEnd=wd},polygonEnd:function(){yt.lineStart=yt.lineEnd=yt.point=it,an.add(Le(wn)),wn=new Ft},result:function(){var e=an/2;return an=new Ft,e}};function vd(){yt.point=yd}function yd(e,a){yt.point=Yo,Wo=kn=e,Go=jn=a}function Yo(e,a){wn.add(jn*e-kn*a),kn=e,jn=a}function wd(){Yo(Wo,Go)}var Ht=1/0,Ia=Ht,la=-Ht,Pa=la,_a={point:kd,lineStart:it,lineEnd:it,polygonStart:it,polygonEnd:it,result:function(){var e=[[Ht,Ia],[la,Pa]];return la=Pa=-(Ia=Ht=1/0),e}};function kd(e,a){e<Ht&&(Ht=e),e>la&&(la=e),a<Ia&&(Ia=a),a>Pa&&(Pa=a)}var En=0,Nn=0,Zt=0,Ba=0,$a=0,Bt=0,Sn=0,Cn=0,ea=0,Qo,Ko,mt,ft,rt={point:Rt,lineStart:_r,lineEnd:Br,polygonStart:function(){rt.lineStart=Nd,rt.lineEnd=Sd},polygonEnd:function(){rt.point=Rt,rt.lineStart=_r,rt.lineEnd=Br},result:function(){var e=ea?[Sn/ea,Cn/ea]:Bt?[Ba/Bt,$a/Bt]:Zt?[En/Zt,Nn/Zt]:[NaN,NaN];return En=Nn=Zt=Ba=$a=Bt=Sn=Cn=ea=0,e}};function Rt(e,a){En+=e,Nn+=a,++Zt}function _r(){rt.point=jd}function jd(e,a){rt.point=Ed,Rt(mt=e,ft=a)}function Ed(e,a){var r=e-mt,n=a-ft,o=Mt(r*r+n*n);Ba+=o*(mt+e)/2,$a+=o*(ft+a)/2,Bt+=o,Rt(mt=e,ft=a)}function Br(){rt.point=Rt}function Nd(){rt.point=Cd}function Sd(){Jo(Qo,Ko)}function Cd(e,a){rt.point=Jo,Rt(Qo=mt=e,Ko=ft=a)}function Jo(e,a){var r=e-mt,n=a-ft,o=Mt(r*r+n*n);Ba+=o*(mt+e)/2,$a+=o*(ft+a)/2,Bt+=o,o=ft*e-mt*a,Sn+=o*(mt+e),Cn+=o*(ft+a),ea+=o*3,Rt(mt=e,ft=a)}function Xo(e){this._context=e}Xo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,st);break}}},result:it};var zn=new Ft,nn,Zo,ei,ta,aa,da={point:it,lineStart:function(){da.point=zd},lineEnd:function(){nn&&ti(Zo,ei),da.point=it},polygonStart:function(){nn=!0},polygonEnd:function(){nn=null},result:function(){var e=+zn;return zn=new Ft,e}};function zd(e,a){da.point=ti,Zo=ta=e,ei=aa=a}function ti(e,a){ta-=e,aa-=a,zn.add(Mt(ta*ta+aa*aa)),ta=e,aa=a}let $r,Ua,Ur,Hr;class Vr{constructor(a){this._append=a==null?ai:Ad(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Ur||this._append!==Ua){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Ur=n,Ua=this._append,Hr=this._,this._=o}this._+=Hr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ai(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Ad(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ai;if(a!==$r){const r=10**a;$r=a,Ua=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ua}function qd(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),_t(l,o(i))),i.result()}return d.area=function(l){return _t(l,o(yt)),yt.result()},d.measure=function(l){return _t(l,o(da)),da.result()},d.bounds=function(l){return _t(l,o(_a)),_a.result()},d.centroid=function(l){return _t(l,o(rt)),rt.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,yn):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new Vr(r)):new Xo(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const s=Math.floor(l);if(!(s>=0))throw new RangeError(`invalid digits: ${l}`);r=s}return a===null&&(i=new Vr(r)),d},d.projection(e).digits(r).context(a)}function _n(e){return function(a){var r=new An;for(var n in e)r[n]=e[n];return r.stream=a,r}}function An(){}An.prototype={constructor:An,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Bn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),_t(r,e.stream(_a)),a(_a.result()),n!=null&&e.clipExtent(n),e}function ni(e,a,r){return Bn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,s=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,s])},r)}function Td(e,a,r){return ni(e,[[0,0],a],r)}function Ld(e,a,r){return Bn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function Fd(e,a,r){return Bn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var Wr=16,Rd=Oe(30*et);function Gr(e,a){return+a?Md(e,a):Od(e)}function Od(e){return _n({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Md(e,a){function r(n,o,i,d,l,s,g,p,x,m,b,u,w,k){var f=g-n,v=p-o,j=f*f+v*v;if(j>4*a&&w--){var y=d+m,N=l+b,E=s+u,S=Mt(y*y+N*N+E*E),T=sa(E/=S),C=Le(Le(E)-1)<Ce||Le(i-x)<Ce?(i+x)/2:ia(N,y),L=e(C,T),D=L[0],H=L[1],R=D-n,O=H-o,h=v*R-f*O;(h*h/j>a||Le((f*R+v*O)/j-.5)>.3||d*m+l*b+s*u<Rd)&&(r(n,o,i,d,l,s,D,H,C,y/=S,N/=S,E,w,k),k.point(D,H),r(D,H,C,y,N,E,g,p,x,m,b,u,w,k))}}return function(n){var o,i,d,l,s,g,p,x,m,b,u,w,k={point:f,lineStart:v,lineEnd:y,polygonStart:function(){n.polygonStart(),k.lineStart=N},polygonEnd:function(){n.polygonEnd(),k.lineStart=v}};function f(T,C){T=e(T,C),n.point(T[0],T[1])}function v(){x=NaN,k.point=j,n.lineStart()}function j(T,C){var L=Ut([T,C]),D=e(T,C);r(x,m,p,b,u,w,x=D[0],m=D[1],p=T,b=L[0],u=L[1],w=L[2],Wr,n),n.point(x,m)}function y(){k.point=f,n.lineEnd()}function N(){v(),k.point=E,k.lineEnd=S}function E(T,C){j(o=T,C),i=x,d=m,l=b,s=u,g=w,k.point=j}function S(){r(x,m,p,b,u,w,i,d,o,l,s,g,Wr,n),k.lineEnd=y,y()}return k}}var Dd=_n({point:function(e,a){this.stream.point(e*et,a*et)}});function Id(e){return _n({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Pd(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function Yr(e,a,r,n,o,i){if(!i)return Pd(e,a,r,n,o);var d=Oe(i),l=Me(i),s=d*e,g=l*e,p=d/e,x=l/e,m=(l*r-d*a)/e,b=(l*a+d*r)/e;function u(w,k){return w*=n,k*=o,[s*w-g*k+a,r-g*w-s*k]}return u.invert=function(w,k){return[n*(p*w-x*k+m),o*(b-x*w-p*k)]},u}function _d(e){return Bd(function(){return e})()}function Bd(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,s=0,g=0,p,x=0,m=1,b=1,u=null,w=Pr,k=null,f,v,j,y=yn,N=.5,E,S,T,C,L;function D(h){return T(h[0]*et,h[1]*et)}function H(h){return h=T.invert(h[0],h[1]),h&&[h[0]*bt,h[1]*bt]}D.stream=function(h){return C&&L===h?C:C=Dd(Id(p)(w(E(y(L=h)))))},D.preclip=function(h){return arguments.length?(w=h,u=void 0,O()):w},D.postclip=function(h){return arguments.length?(y=h,k=f=v=j=null,O()):y},D.clipAngle=function(h){return arguments.length?(w=+h?gd(u=h*et):(u=null,Pr),O()):u*bt},D.clipExtent=function(h){return arguments.length?(y=h==null?(k=f=v=j=null,yn):bd(k=+h[0][0],f=+h[0][1],v=+h[1][0],j=+h[1][1]),O()):k==null?null:[[k,f],[v,j]]},D.scale=function(h){return arguments.length?(r=+h,R()):r},D.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],R()):[n,o]},D.center=function(h){return arguments.length?(i=h[0]%360*et,d=h[1]%360*et,R()):[i*bt,d*bt]},D.rotate=function(h){return arguments.length?(l=h[0]%360*et,s=h[1]%360*et,g=h.length>2?h[2]%360*et:0,R()):[l*bt,s*bt,g*bt]},D.angle=function(h){return arguments.length?(x=h%360*et,R()):x*bt},D.reflectX=function(h){return arguments.length?(m=h?-1:1,R()):m<0},D.reflectY=function(h){return arguments.length?(b=h?-1:1,R()):b<0},D.precision=function(h){return arguments.length?(E=Gr(S,N=h*h),O()):Mt(N)},D.fitExtent=function(h,q){return ni(D,h,q)},D.fitSize=function(h,q){return Td(D,h,q)},D.fitWidth=function(h,q){return Ld(D,h,q)},D.fitHeight=function(h,q){return Fd(D,h,q)};function R(){var h=Yr(r,0,0,m,b,x).apply(null,a(i,d)),q=Yr(r,n-h[0],o-h[1],m,b,x);return p=ld(l,s,g),S=bn(a,q),T=bn(p,S),E=Gr(S,N),O()}function O(){return C=L=null,D}return function(){return a=e.apply(this,arguments),D.invert=a.invert&&H,R()}}function ri(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}ri.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Le(o)>Ce&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function $d(){return _d(ri).scale(175.295)}function Ud(e){return e}function Hd(e){if(e==null)return Ud;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,s){s||(a=r=0);var g=2,p=l.length,x=new Array(p);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+d;g<p;)x[g]=l[g],++g;return x}}function Vd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Wd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Qr(e,r)})}:Qr(e,a)}function Qr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Gd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Gd(e,a){var r=Hd(e.transform),n=e.arcs;function o(p,x){x.length&&x.pop();for(var m=n[p<0?~p:p],b=0,u=m.length;b<u;++b)x.push(r(m[b],b));p<0&&Vd(x,u)}function i(p){return r(p)}function d(p){for(var x=[],m=0,b=p.length;m<b;++m)o(p[m],x);return x.length<2&&x.push(x[0]),x}function l(p){for(var x=d(p);x.length<4;)x.push(x[0]);return x}function s(p){return p.map(l)}function g(p){var x=p.type,m;switch(x){case"GeometryCollection":return{type:x,geometries:p.geometries.map(g)};case"Point":m=i(p.coordinates);break;case"MultiPoint":m=p.coordinates.map(i);break;case"LineString":m=d(p.arcs);break;case"MultiLineString":m=p.arcs.map(d);break;case"Polygon":m=s(p.arcs);break;case"MultiPolygon":m=p.arcs.map(s);break;default:return null}return{type:x,coordinates:m}}return g(a)}const oi={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Yd=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Qd(e,a,r){const n=oi[e];if(!n||!n.length)return-1;const o=Yd(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let wa=null;function Kd(){return wa||(wa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Wd(r,n),i=$d().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=qd(i),l=(o.features||[]).filter(p=>{var x;return(((x=p.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(p=>{var b;const x=((b=p.properties)==null?void 0:b.name)||"",m=d(p)||"";return m?{i2:rs(x)||null,n:x,d:m}:null}).filter(p=>!!p);if(!l.length)return null;const s={};for(const[p,x]of Object.entries(os)){const m=i(x);m&&(s[p]={x:m[0],y:m[1]})}const g={};for(const[p,x]of Object.entries(oi)){const m=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,u])=>({x:b,y:u}));m.length&&(g[p]=m)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:s,metros:g}}catch{return null}})(),wa)}function Jd(e){const[a,r]=c.useState(null);return c.useEffect(()=>{if(!e||a)return;let n=!1;return Kd().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Xd="8 40 984 210",Zd={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Kr=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function Jr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ep(e,a){const[r,n]=c.useState(1);return c.useEffect(()=>{let o=!0,i=0;const d=()=>{var g;if(!o)return;const s=(g=e.current)==null?void 0:g.getScreenCTM();s&&s.a>0?n(s.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function Xr({msgs:e}){const[a,r]=c.useState(0);c.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function tp(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:s,data:g,dossiers:p,source:x}=Z(),m=g.loading&&!p.length,b=c.useRef(null),u=c.useRef(null),w=Jd(e.continent==="monde"),k=e.continent==="monde"?w:Rn.find(h=>h.key===e.continent)||null,f=ep(b,e.continent+":"+e.mapFolded+":"+!!k),[v,j]=c.useState(new Map),[y,N]=c.useState(null);c.useEffect(()=>{const h=b.current;if(!h)return;const q=new Map;h.querySelectorAll("path[data-i2]").forEach(M=>{const W=M.dataset.i2;if(W)try{const z=M.getBBox();z.width>0&&q.set(W,{x:z.x,y:z.y,w:z.width,h:z.height})}catch{}}),j(q)},[e.continent,f,k]);const E=c.useMemo(()=>r.filter(h=>h.cc),[r]),S=c.useMemo(()=>{const h=new Map;return E.forEach(q=>h.set(q.cc,(h.get(q.cc)||0)+1)),h},[E]),T=e.continent==="monde"&&w?w.anchors:null,C=e.continent==="monde"&&w?w.metros:null,L=c.useMemo(()=>E.map(h=>{const q=Jr(h.name||h.id||""),M=Jr((h.id||h.name||"")+"·y");if(T&&h.cc){const U=C?C[h.cc]:void 0;if(U&&U.length){const $=Qd(h.cc,h.city,q);if($>=0&&U[$])return{d:h,x:U[$].x+(q-.5)*5,y:U[$].y+(M-.5)*5}}const ae=T[h.cc];if(ae)return{d:h,x:ae.x+(q-.5)*10,y:ae.y+(M-.5)*10}}const W=h.cc?v.get(h.cc):void 0;if(!W)return null;const z=Zd[`${e.continent}:${h.cc||""}`];if(z)return{d:h,x:W.x+W.w*(z.fx+(q-.5)*z.sx),y:W.y+W.h*(z.fy+(M-.5)*z.sy)};const I=(q-.5)*Math.min(W.w*.55,60),P=(M-.5)*Math.min(W.h*.55,60);return{d:h,x:W.x+W.w/2+I,y:W.y+W.h/2+P}}).filter(h=>!!h),[E,v,T,C,e.continent]),D=h=>f>0?h/f:h,H=c.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:Kr[h],fr:s.plabels[h],en:s.plabels[h],n:r.filter(q=>q.kind==="target"&&Ae(q)===h).length})).filter(h=>h.n>0):ar.map((h,q)=>({...h,n:r.filter(M=>nr(M)===q).length})),[r,n,s.plabels]),R=i?d.get(i):null,O=R?L.find(h=>h.d.id===R.id):null;return k?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:u,children:[m&&t.jsx(Xr,{msgs:s.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?Xd:k.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?k.fr:k.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:k.countries.map((h,q)=>t.jsx("g",{className:"ct"+(h.i2&&S.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},q))}),t.jsx("g",{children:L.map(h=>{const q=ar[nr(h.d)],M=!!$e(h.d),W=h.d.kind==="target",z=n&&W?Kr[Ae(h.d)]:q.c,I=!n&&Ge(h.d);return t.jsxs("g",{className:"co"+(I?" done":""),onMouseEnter:()=>{var ae,$;const P=(ae=u.current)==null?void 0:ae.getBoundingClientRect(),U=($=b.current)==null?void 0:$.createSVGPoint();if(U&&b.current&&P){U.x=h.x,U.y=h.y;const le=U.matrixTransform(b.current.getScreenCTM());N({x:le.x-P.left,y:le.y-P.top,label:h.d.name+" · "+(Gt(h.d.cc,l)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var ae;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const P=(ae=b.current)==null?void 0:ae.createSVGPoint();let U=null;if(P&&b.current){P.x=h.x,P.y=h.y;const $=P.matrixTransform(b.current.getScreenCTM());U={x:$.x,y:$.y}}a({type:"popup",id:h.d.id,anchor:U})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:D(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:D(q.px),fill:z,stroke:M?"#E5484D":"#ffffff",strokeWidth:D(M?2.2:1.3)})]},h.d.id||h.d.name)})}),O&&t.jsx("circle",{className:"ring on",cx:O.x,cy:O.y,r:D(13),fill:"none",stroke:"#16233A",strokeWidth:D(2)})]}),t.jsx("div",{className:"hov"+(y?" on":""),style:y?{left:y.x,top:y.y}:void 0,children:y==null?void 0:y.label}),t.jsx("div",{className:"legend",children:H.map((h,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),l==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},q))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",s.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:u,children:t.jsx(Xr,{msgs:s.loadMsgs})})}function ap(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function ii({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=Z(),s=a.filters,[g,p]=c.useState(!1),[x,m]=c.useState(!1),b=c.useRef(null),u=c.useRef(null),w=c.useMemo(()=>a.continent==="monde"?n:n.filter(O=>O.continent===a.continent),[n,a.continent]),k=O=>w.filter(h=>O!=="country"&&s.country.length&&!s.country.includes(h.cc||"")?!1:Ra(h,s,i,O==="country"?void 0:O)),f=O=>!i||O.kind!=="op",v=c.useMemo(()=>{const O=k("win").filter(f),h=q=>O.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=q).length;return[h(0),h(7),h(30),O.length]},[w,s,i]),j=c.useMemo(()=>s.day?k("win").filter(f).filter(O=>(O.date||"").slice(0,10)===s.day).length:0,[w,s,i]),y=(s.signalOnly?1:0)+s.sector.length+s.market.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+s.crible.length,N=y+(s.acquirer.trim()?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0);c.useEffect(()=>{a.openFacet&&p(!1)},[a.openFacet]),c.useEffect(()=>{if(!g&&!x)return;const O=q=>{var W,z;const M=q.target;g&&!((W=b.current)!=null&&W.contains(M))&&p(!1),x&&!((z=u.current)!=null&&z.contains(M))&&m(!1)},h=q=>{q.key==="Escape"&&(p(!1),m(!1))};return document.addEventListener("mousedown",O),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",O),document.removeEventListener("keydown",h)}},[g,x]);const E=(O,h,q,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===O,onClick:()=>r({type:"openFacet",facet:O}),children:[t.jsx("span",{className:"fl",children:h}),q>0&&t.jsx("span",{className:"n",children:q}),t.jsx("span",{className:"cv",children:"▾"})]},O),S=["1","7","30","all"],T=Math.max(0,S.indexOf(s.win||"all")),C=s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(ap(s.day,l))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:u,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>m(O=>!O),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:v[T]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:S.map((O,h)=>t.jsxs("button",{type:"button",role:"option","aria-selected":s.win===O,onClick:()=>{r({type:"filters",patch:{win:O}}),m(!1)},children:[o.datesShort[h],t.jsx("span",{className:"n",children:v[h]})]},O))})]}):t.jsx("div",{className:"seg",children:S.map((O,h)=>t.jsxs("button",{type:"button","aria-pressed":s.win===O,onClick:()=>r({type:"filters",patch:{win:O}}),children:[t.jsx("span",{className:"sl",children:o.dates[h]}),t.jsx("b",{children:v[h]})]},O))}),L=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:s.search,onChange:O=>r({type:"filters",patch:{search:O.target.value}})})]}),D=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):E("sec",o.fSector,s.sector.length),(n.some(O=>!!O.market)||s.market.length>0)&&E("mar",o.fMarket,s.market.length),E("pay",o.fCountry,s.country.length),E("det",o.fEngine,s.engine.length),E("sta",o.fStage,s.stage.length),i&&E("crib",o.fVerdict,s.crible.length),i&&E("ang","Angle",s.angle.length),i&&E("mem","Mémo",s.memoLevel.length)]}),H=(O=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),O&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),R=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(y?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{p(O=>!O),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),y>0&&t.jsx("span",{className:"n",children:y}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:D})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(s.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:C}),t.jsxs("div",{className:"fstrip-b",children:[L,R,H(!1)]})]}),a.openFacet&&t.jsx(Zr,{poolFor:k})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[C,L,D,t.jsx("span",{className:"fgrow"}),H()]}),a.openFacet&&t.jsx(Zr,{poolFor:k})]})}function Zr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=Z(),l=a.filters,s=a.openFacet,{title:g,cols:p,options:x}=c.useMemo(()=>{if(s==="sig"){const k=e("signal").filter(j=>$e(j)),f=new Map;k.forEach(j=>{const y=j.engine||"";f.set(y,(f.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:k.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...un([...f.keys()],o).map(j=>({v:j,label:Lt(j)+" "+tt(j,o),n:f.get(j)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(s==="crib"){const k=e("crible").filter(v=>!i||ho(v,a.ptab,d.favIds)),f=new Map;return k.forEach(v=>{const j=go(v);j&&j!=="NEW"&&f.set(j,(f.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((v,j)=>(rr[v[0]]??9)-(rr[j[0]]??9)||j[1]-v[1]).map(([v,j])=>({v,label:'<span class="fdot" style="background:'+(is[v]||"#94A3B8")+'"></span>'+v,n:j,html:!0,on:l.crible.includes(v)}))}}if(s==="sec"){const k=e("sector"),f=new Map;return k.forEach(v=>{v.sector&&f.set(v.sector,(f.get(v.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:l.sector.includes(v)}))}}if(s==="mar"){const k=e("market"),f=new Map;return k.forEach(v=>{v.market&&f.set(v.market,(f.get(v.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:l.market.includes(v)}))}}if(s==="pay"){const k=e("country"),f=new Map;return k.forEach(v=>{v.cc&&f.set(v.cc,(f.get(v.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:Gt(v,o)||v,n:j,html:!1,on:l.country.includes(v)}))}}if(s==="det"){const k=e("engine"),f=new Map;return k.forEach(v=>{v.engine&&f.set(v.engine,(f.get(v.engine)||0)+1)}),{title:n.fEngine,cols:2,options:un([...f.keys()],o).map(v=>({v,label:Lt(v)+" "+tt(v,o)+' <span style="color:var(--dim);font-size:10px">· '+ss(ls(v),o)+"</span>",n:f.get(v)||0,html:!0,on:l.engine.includes(v)}))}}if(s==="ang"){const k=e("angle"),f=new Map;return k.forEach(v=>{v.angle&&f.set(v.angle,(f.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v.replace(/[_-]+/g," "),n:j,html:!1,on:l.angle.includes(v)}))}}if(s==="mem"){const k=e("memoLevel"),f=new Map;k.forEach(j=>{if(j.kind==="target"){const y=Ln(j);f.set(y,(f.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:v[j],n:f.get(j)||0,html:!1,on:l.memoLevel.includes(j)}))}}const u=e("stage"),w=new Map;return u.forEach(k=>{k.stage&&w.set(k.stage,(w.get(k.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:k,n:f,html:!1,on:l.stage.includes(k)}))}},[s,a,o]),m=u=>{if(s==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const k=l.signalEngines.includes(u)?l.signalEngines.filter(f=>f!==u):[...l.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:k}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage",value:u})},b=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:g}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>m(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function si({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=Z(),s=c.useMemo(()=>{const b={};return r.forEach(u=>{Ra(u,n.filters,i)&&(b.monde=(b.monde||0)+1,u.continent&&(b[u.continent]=(b[u.continent]||0)+1))}),b},[r,n.filters,i]),[g,p]=c.useState(!1),x=c.useRef(null);c.useEffect(()=>{if(!g)return;const b=w=>{var k;(k=x.current)!=null&&k.contains(w.target)||p(!1)},u=w=>{w.key==="Escape"&&p(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",u),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",u)}},[g]);const m=b=>{const u=Rn.find(w=>w.key===b);return b==="monde"?l.contWorld:d==="fr"?u.fr:u.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>p(b=>!b),children:[m(n.continent),t.jsx("span",{className:"n",children:s[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:or.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),p(!1)},children:[m(b),t.jsx("span",{className:"n",children:s[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[or.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[m(b),t.jsx("span",{className:"n",children:s[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]})]})}function qn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function li(e){return"atl2:evalq:"+(e||"anon")}function np(e,a){const r=li(e),n=qn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function rp(){const{t:e,data:a,dossiers:r}=Z(),n=a.session.token||"",o=li(n),[i,d]=c.useState(()=>qn(o)),l=c.useRef(!1),[s,g]=c.useState(!1);c.useEffect(()=>{try{const z=i.slice(0,30).map(({descBusy:I,evalBusy:P,...U})=>U);localStorage.setItem(o,JSON.stringify(z)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[i,o]),c.useEffect(()=>{const z=()=>{if(l.current)return;const I=qn(o);d(P=>JSON.stringify(P.map(({descBusy:U,evalBusy:ae,...$})=>$))===JSON.stringify(I)?P:I)};return window.addEventListener("atl2:evalq",z),window.addEventListener("storage",z),()=>{window.removeEventListener("atl2:evalq",z),window.removeEventListener("storage",z)}},[o]);const[p,x]=c.useState([]),[m,b]=c.useState(""),[u,w]=c.useState(!1),[k,f]=c.useState(!1),[v,j]=c.useState(""),y=c.useCallback((z,I)=>d(P=>P.map((U,ae)=>ae===z?{...U,...I}:U)),[]),N=c.useCallback((z,I)=>{const P=I.trim();P&&(y(z,{name:P,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),On(P).then(U=>{const ae=U.candidates||[];U.website?y(z,{site:U.website,status:"ready"}):ae.length===1?y(z,{site:ae[0].url,status:"ready"}):ae.length>1?y(z,{status:"pick",candidates:ae.slice(0,6)}):y(z,{status:"ready"})}).catch(()=>y(z,{status:"ready"})))},[y]),E=c.useCallback((z,I,P)=>{y(z,{descBusy:!0}),yo(n,I,P).then(U=>{if(U.quota){g(!0),y(z,{descBusy:!1,descDone:!0});return}const ae=U.blocs||{},$=(ae.synthese||ae.value_prop||ae.produit||ae.modele||"").trim();y(z,{descBusy:!1,descDone:!0,desc:$})}).catch(()=>y(z,{descBusy:!1,descDone:!0}))},[y,n]);c.useEffect(()=>{const z=i.findIndex(P=>P.auto&&P.name.trim()&&P.status==="");if(z>=0){N(z,i[z].name);return}if(s)return;const I=i.findIndex(P=>P.status==="ready"&&P.site&&!P.descDone&&!P.descBusy);I>=0&&E(I,i[I].name,i[I].site)},[i,N,E,s]);const[S,T]=c.useState(!1),C=c.useCallback(async(z,I)=>{y(z,{evalBusy:!0});const P=await wo(n,(I.site||I.name).trim(),"atelier2");return P.verdict==="quota"?(y(z,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:P.reason||"",remaining:0}})),!1):(y(z,{evalBusy:!1,status:P.verdict==="kept"?"kept":"out",reason:P.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:P.company||I.name,verdict:P.verdict,reason:P.reason||"",remaining:P.remaining??null}})),!0)},[y,n]),L=async()=>{if(S)return;const z=i.map((I,P)=>({r:I,i:P})).filter(({r:I})=>I.name.trim()&&I.status!=="kept"&&I.status!=="out"&&I.status!=="resolving");if(z.length){T(!0);for(const{r:I,i:P}of z)if(!await C(P,I))break;T(!1)}},D=c.useMemo(()=>{const z=new Set,I=[];return i.filter(P=>P.status==="kept").forEach(P=>{const U=P.name.trim().toLowerCase();U&&!z.has(U)&&(z.add(U),I.push(P.name.trim()))}),r.filter(P=>Ae(P)>=1&&Ae(P)<=4&&(P.website||P.domain)).forEach(P=>{const U=(P.name||"").trim().toLowerCase();U&&!z.has(U)&&(z.add(U),I.push((P.name||"").trim()))}),I},[i,r]),H=c.useMemo(()=>{const z=new Set;return r.forEach(I=>{const P=(I.name||"").trim().toLowerCase();P&&z.add(P)}),i.forEach(I=>{const P=I.name.trim().toLowerCase();P&&z.add(P)}),z},[r,i]),R=async()=>{if(m||!D.length)return;f(!1);const z=[];for(const I of D.slice(0,2)){b(I);const P=await ko(n,I);if(P){if(P.verdict==="quota"){w(!0);break}(P.results||[]).forEach(U=>{const ae=(U.company||"").trim().toLowerCase();!ae||H.has(ae)||z.some($=>$.name.toLowerCase()===ae)||z.push({name:(U.company||"").trim(),verdict:U.verdict||"",reason:U.reason,from:I})})}}b(""),f(!0),x(I=>[...z,...I].slice(0,24))},O=async(z,I)=>{if(m)return;f(!1),b(z==="thesis"?e.pxThesis:I);const P=await ds(n,z,I,6);if(b(""),f(!0),!P)return;if(P.verdict==="quota"){w(!0);return}const U=[];(P.results||[]).forEach(ae=>{const $=(ae.company||"").trim().toLowerCase();!$||H.has($)||U.some(le=>le.name.toLowerCase()===$)||U.push({name:(ae.company||"").trim(),verdict:ae.verdict||"",reason:ae.reason,from:z==="thesis"?e.pxThesis:I})}),x(ae=>[...U,...ae].slice(0,24))},h=()=>{const z=v.trim();z.length<3||O(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(z)?"registry":"keyword",z)},q=z=>{d(I=>[...I,{name:z.name,site:"",status:"",auto:!0}].slice(0,30)),x(I=>I.filter(P=>P.name!==z.name))},M=i.filter(z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out").length,W=z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving"&&!z.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((z,I)=>t.jsxs("div",{className:"eq-row"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsx("input",{value:z.name,placeholder:e.eqNamePh,onChange:P=>{const U=P.target.value.split(`
`).map(ae=>ae.trim()).filter(Boolean);U.length>1?d(ae=>{const $=[...ae];return $.splice(I,1,...U.map(le=>({name:le,site:"",status:"",auto:!0}))),$.slice(0,30)}):y(I,{name:P.target.value})},onBlur:()=>{z.name.trim()&&!z.site&&z.status!=="resolving"&&z.status!=="pick"&&N(I,z.name)},onKeyDown:P=>{P.key==="Enter"&&N(I,z.name)}}),t.jsxs("span",{className:"eq-site",children:[z.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),z.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:P=>{const U=P.target.value;U&&y(I,{site:U,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(z.candidates||[]).map(P=>t.jsx("option",{value:P.url,children:(P.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},P.url))]}),z.status!=="resolving"&&z.status!=="pick"&&(z.site?t.jsxs("a",{href:z.site.startsWith("http")?z.site:"https://"+z.site,target:"_blank",rel:"nofollow noopener",children:[z.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:z.name.trim()&&z.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:z.desc||"",children:z.descBusy?t.jsx("i",{children:e.eqDescBusy}):z.desc?z.desc:t.jsx("em",{children:z.descDone?s?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(z.status||"vide"),title:z.reason||"",children:z.status==="kept"?"✓ "+e.kept:z.status==="out"?"✗ "+e.dropped:z.status==="ready"?e.eqReady:z.status==="pick"?e.eqPick:""}),t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!W(z)||S,onClick:()=>{C(I,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>d(P=>P.filter((U,ae)=>ae!==I)),children:"×"})]},I)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>d(z=>[...z,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!m,onClick:()=>{O("thesis","")},children:m===e.pxThesis?e.sgBusy(m):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:v,placeholder:e.pxPlace,onChange:z=>j(z.target.value),onKeyDown:z=>{z.key==="Enter"&&h()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!m||v.trim().length<3,onClick:h,children:e.pxGoFree}),!!D.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!m,onClick:()=>{R()},children:m&&m!==e.pxThesis&&m!==v?e.sgBusy(m):e.sgGo}),!!D.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(D[0],D.length)}),u&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),k&&!p.length&&!u&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),p.map(z=>t.jsxs("span",{className:"eq-sc"+(z.verdict==="kept"?" ok":""),title:(z.reason||"")+" — "+e.sgVia(z.from),children:[t.jsx("b",{children:z.name}),z.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>q(z),children:"+"})]},z.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),i.some(z=>z.status==="kept"||z.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>d(z=>z.filter(I=>I.status!=="kept"&&I.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(S?" loading":""),style:{justifyContent:"center"},disabled:S||!M,onClick:()=>{L()},children:[t.jsx("span",{className:"fill"}),S?e.eqRunning:e.eqGo(M)]})]})]})]})}const op={deals:"ma-deals",news:"veille"};function eo(e){return(e.url||e.title||"").trim()}function ip(e){const a=(e.title||"").replace(/\s+/g," ").trim();if(!a)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const r=/^(.{2,72}?)[:–—|]/.exec(a);return r?r[1].trim():(a.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||a).slice(0,72).trim()}function sp({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,canWrite:i}=Z(),[d,l]=c.useState(null),[s,g]=c.useState({deals:[],news:[]}),[p,x]=c.useState({deals:!1,news:!1}),[m,b]=c.useState(null),[u,w]=c.useState(""),k=c.useRef(!1),f=c.useCallback(async C=>{if(!o)return[];if(p[C])return s[C];b(C),w("");const L=await ps(op[C],o,n);return b(null),!L.ok&&L.error?(w(L.error),[]):(g(D=>({...D,[C]:L.items})),x(D=>({...D,[C]:!0})),L.items)},[o,n,p,s]);c.useEffect(()=>{d&&f(d)},[d,f]);const v=c.useCallback(C=>s[C].map(eo).filter(Boolean),[s]),j=c.useMemo(()=>{var D,H;if(!o)return{deals:[],news:[]};const C={deals:v("deals"),news:v("news")},L=qo("feed:"+o,C);return{deals:((D=L.deals)==null?void 0:D.noms)||[],news:((H=L.news)==null?void 0:H.noms)||[]}},[o,v]),y=c.useRef(null);c.useEffect(()=>{y.current&&!d&&o&&To("feed:"+o,{deals:v("deals"),news:v("news")}),y.current=d},[d,o,v]);const N=C=>{const L=C.map(ip).filter(Boolean);L.length&&(a(L),l(null))},E=(C,L)=>{const D=(C.url||"").trim();if(L==="news"&&D&&/^https?:\/\//i.test(D)){window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:D}})),l(null);return}N([C])},S=async C=>{if(d===C){l(null);return}if(k.current)return;k.current=!0;const L=await f(C);if(k.current=!1,C==="deals"&&L.length){N(L);return}l(C)},T=C=>{const L=s[C],D=new Set(j[C].map(H=>H.toLowerCase()));return t.jsxs("div",{className:"dfpane"+(d===C?" on":""),hidden:d!==C,children:[t.jsx("p",{className:"dfh",children:C==="deals"?r.feedDealsH:r.feedNewsH}),m===C&&t.jsx("p",{className:"dfload",children:n==="en"?"Loading…":"Chargement…"}),d===C&&!!u&&t.jsx("p",{className:"dferr",children:u}),p[C]&&!L.length&&!m&&t.jsx("p",{className:"dfempty",children:C==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!L.length&&t.jsx("ul",{className:"dflist",children:L.map((H,R)=>{const O=eo(H),h=D.has(O.toLowerCase()),q=(H.url||"").trim();return t.jsxs("li",{className:h?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:H.title||q}),t.jsx("span",{children:[H.source,H.sector_fr,(H.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[q&&t.jsx("a",{href:q,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),i&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>E(H,C),children:C==="deals"?r.feedToEval:r.feedToExtract})]})]},O||R)})})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(C=>{const L=j[C].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(C==="deals"?"ddeals":"dnews")+(d===C?" on":""),onClick:()=>{S(C)},children:[C==="deals"?r.feedDeals:r.feedNews,L>0&&t.jsx("em",{title:r.feedHint,children:r.feedNew(L)})]},C)}),d&&T(d)]})}function di(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function lp(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function to({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=Z();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(s=>s.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(s=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:s.name}),s.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),s.line1&&t.jsx("p",{className:"w",children:s.line1}),s.line2&&t.jsx("p",{className:"r",children:s.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(s.name),children:l.rsEvalOne})]},s.name))})]}):null}function pi({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=Z(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(to,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(to,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function dp({card:e,onEvaluate:a,onAddAll:r}){var l,s,g;const{t:n}=Z(),o=[e.industry,...e.market_tags||[],e.author].map(p=>(p||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(p=>p&&p.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(p=>t.jsx("span",{children:p},p))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:di(e.summary_md||"").map((p,x)=>t.jsx("p",{children:p},x))})]}),t.jsx(pi,{card:e,onEvaluate:a,onAddAll:r}),(((s=e.prospective)==null?void 0:s.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(p=>t.jsx("li",{children:p},p))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(p=>t.jsx("a",{href:p.url,target:"_blank",rel:"noopener noreferrer",children:p.label||p.url},p.url))})]})]})}function pp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function cp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=Z(),l=o,[s,g]=c.useState(null),[p,x]=c.useState(null),[m,b]=c.useState(null),[u,w]=c.useState(!1);c.useEffect(()=>{let f=!0;return(async()=>{const v=await jo({email:d,cbToken:l});f&&g(v)})(),()=>{f=!1}},[d,l,n]);const k=f=>{x(f),b(null),w(!0),(async()=>{const v=await cs(f.id);b(v),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[p?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),p&&t.jsx("span",{className:"ti",children:p.title}),!p&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!p&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(s||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>k(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[pp(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),p&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[p.source_url&&t.jsx("a",{href:p.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),p.published&&p.page_url&&t.jsx("a",{href:p.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(p.published?" on":""),children:p.published?i.rsPub:i.rsPriv})]}),u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!u&&!m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!u&&m&&t.jsx(dp,{card:m,onEvaluate:a,onAddAll:r})]})]})}const Ca=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function na(e){return/^https?:\/\//i.test((e||"").trim())}function pt(e){const a=(e||"").trim();return a?na(a)?a:Ca.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function up(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function mp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:l,evalBusy:s,evalCards:g,caps:p,data:x,canWrite:m,source:b,dossiers:u,doAnalyse:w,liveMemos:k,pipe:f}=Z(),v=r==="client",j=c.useMemo(()=>n||(b!=="default"?us():""),[n,b]),[y,N]=c.useState(""),[E,S]=c.useState(!1),[T,C]=c.useState(""),[L,D]=c.useState(""),[H,R]=c.useState(""),[O,h]=c.useState(!1),[q,M]=c.useState(!1),[W,z]=c.useState([]);c.useEffect(()=>{const _=oe=>{const ee=oe.detail;ee&&z(me=>[ee,...me].slice(0,8))};return window.addEventListener("ppmap:evalcard",_),()=>window.removeEventListener("ppmap:evalcard",_)},[]);const[I,P]=c.useState(!1),[U,ae]=c.useState(!1),[$,le]=c.useState(!1),J=c.useRef(!1),[de,he]=c.useState(""),[xe,be]=c.useState(""),[ve,ye]=c.useState(!1),[Te,ne]=c.useState(!1),[ke,B]=c.useState(0),[V,Y]=c.useState(""),[Q,se]=c.useState(null),[pe,re]=c.useState(null),[ue,ce]=c.useState(!1),[we,qe]=c.useState(null),[De,Pe]=c.useState(0),Ee=c.useRef(!1),Dt=y.trim()?Ca.test(y.trim())?e.evalUrl:e.evalName:e.evalWaiting;c.useEffect(()=>{if(typeof window>"u")return;const _=new URLSearchParams(window.location.search),oe=(_.get("rs")||"").trim(),ee=(_.get("rstext")||"").trim();oe&&/^https?:\/\//i.test(oe)&&he(oe),ee&&be(ee),(oe&&/^https?:\/\//i.test(oe)||ee)&&P(!0)},[]),c.useEffect(()=>{const _=oe=>{const ee=oe.detail||{},me=String(ee.url||"").trim(),Ne=String(ee.text||"").trim();me&&/^https?:\/\//i.test(me)&&he(me),Ne&&be(Ne),(me&&/^https?:\/\//i.test(me)||Ne)&&(P(!0),N(""),C(""),ye(!0),window.setTimeout(()=>ye(!1),900))};return window.addEventListener("ppmap:research",_),()=>window.removeEventListener("ppmap:research",_)},[]),c.useEffect(()=>{const _=oe=>{const ee=oe.detail||{},me=String(ee.name||"").trim();if(!me)return;P(!1),N(me),C(me);const Ne=pt(String(ee.website||ee.domain||""));D(Ne),R(pt(String(ee.url||""))),h(!Ne),S(!0),window.setTimeout(()=>S(!1),900)};return window.addEventListener("ppmap:prefill",_),()=>window.removeEventListener("ppmap:prefill",_)},[]),c.useEffect(()=>{const _=(T||"").trim();if(!_||I||L){(L||!_||I)&&h(!1);return}const oe=Ue(_),ee=u.find(Fe=>Ue(Fe.name)===oe)||u.find(Fe=>{const ze=Ue(Fe.name);return ze.length>=3&&(oe.includes(ze)||ze.includes(oe))}),me=pt((ee==null?void 0:ee.website)||"")||pt((ee==null?void 0:ee.domain)||""),Ne=pt((ee==null?void 0:ee.url)||"");if(Ne&&R(Fe=>Fe||Ne),me){D(me),h(!1);return}let ge=!0;return h(!0),On(_).then(Fe=>{var nt,xt;if(!ge)return;const ze=pt(Fe.website||"")||pt(((xt=(nt=Fe.candidates)==null?void 0:nt[0])==null?void 0:xt.url)||"");ze&&D(ze)}).catch(()=>{}).finally(()=>{ge&&h(!1)}),()=>{ge=!1}},[T,I,L,u]),c.useEffect(()=>{const _=oe=>{var me;const ee=String(((me=oe.detail)==null?void 0:me.url)||"").trim();na(ee)&&window.open(ee,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",_),()=>window.removeEventListener("ppmap:view",_)},[]),c.useEffect(()=>{if(J.current===I)return;J.current=I,le(!0);const _=window.setTimeout(()=>le(!1),560);return()=>window.clearTimeout(_)},[I]),c.useEffect(()=>{if(typeof window>"u")return;const _=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),oe=document.querySelector(".atl2.ops, .atl2.cibles");if(!_||!oe)return;const ee=()=>oe.style.setProperty("--demand-h",`${_.offsetHeight}px`);ee();const me=new ResizeObserver(ee);return me.observe(_),()=>me.disconnect()},[b,E,ve,q,I,$,O]),c.useEffect(()=>{if(!m&&!j){qe(null);return}let _=!0;return(async()=>{const oe=await jo({email:o,cbToken:j});_&&qe(oe.length)})(),()=>{_=!1}},[m,j,o,De]);const Ct=W.length?W:g,_e=x.credits,lt=c.useCallback(_=>{np(n,_)&&(M(!1),l({type:"ptab",tab:0}),requestAnimationFrame(()=>{const oe=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!oe)return;const ee=window.scrollY+oe.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,ee),behavior:"smooth"})}))},[n,l]);c.useEffect(()=>{if(!Te)return;B(0);const _=window.setInterval(()=>B(oe=>oe+1),1e3);return()=>window.clearInterval(_)},[Te]);const ht=c.useMemo(()=>{const _=y.trim().toLowerCase();return!_||!f?null:u.find(oe=>Ue(oe.name)===_&&Ae(oe)===1)||null},[y,u,f]),zt=()=>{const _=y.trim();if(_){if(ht){w(ht);return}i(null,_),v&&N("")}},at=async()=>{var ee,me,Ne;if(Ee.current)return;const _=de.trim().replace(/\s+/g,""),oe=xe.trim();if(!_&&!oe){Y(e.rsNeed);return}if(!v&&!j){i(null,_||oe.slice(0,80));return}Ee.current=!0,Y(""),se(null),re(null),ne(!0);try{const ge=await fs({url:_,text:oe,email:o,cbToken:j});if(ne(!1),!ge||ge.status!=="success"){Y((ge==null?void 0:ge.message)||"Erreur");return}se(ge),P(!1),lt((((ee=ge.prospective)==null?void 0:ee.companies_to_evaluate)||[]).map(ze=>(ze==null?void 0:ze.name)||"")),re({state:"pending"});const Fe=await hs(ge,{email:o,cbToken:j});re(Fe.ok?{state:"ok",scopeLabel:((me=Fe.summary)==null?void 0:me.scope_label)||"",scope:((Ne=Fe.summary)==null?void 0:Ne.scope)||""}:{state:"fail",msg:Fe.error||""}),Fe.ok&&Pe(ze=>ze+1)}finally{Ee.current=!1,ne(!1)}},At=[Q==null?void 0:Q.industry,...(Q==null?void 0:Q.market_tags)||[],Q==null?void 0:Q.author].map(_=>(_||"").trim()).filter(Boolean),gt=(pe==null?void 0:pe.state)==="pending",It=pe&&(gt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):pe.state==="ok"?t.jsx("span",{className:"rslink ok",children:pe.scope&&pe.scope!=="public"?e.rsSavedIn(pe.scopeLabel||pe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:pe.msg,children:e.rsSaveFail})),Pt=lp(Q).length,Be=I,Xe=(T||y).trim(),Ye=u.find(_=>Ue(_.name)===Ue(Xe)),ct=pt(y)||L||pt((Ye==null?void 0:Ye.website)||"")||pt((Ye==null?void 0:Ye.domain)||""),F=H||pt((Ye==null?void 0:Ye.url)||""),X=ht?e.actAnalyse:Xe?e.evalGoOn(Xe.length>22?Xe.slice(0,21)+"…":Xe):e.evalGo,te=Te?`${ms(de.trim())==="youtube"&&de.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ke)}`:gt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Be?" rs-mode":"")+(T&&y.trim()===T||E||ve?" pair":"")+(E||ve||$?" echo":"")+($?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((Be?ve:E)||$?" flash":"")+((Be?de.trim():Ca.test(y.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Be?de:y,placeholder:Be?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Be?600:200,spellCheck:Be?!1:void 0,inputMode:Be?"url":void 0,onChange:_=>{if(Be){he(_.target.value);return}N(_.target.value),T&&_.target.value.trim()!==T&&(C(""),D(""),R(""),h(!1))},onKeyDown:_=>{_.key==="Enter"&&(Be?at():zt())}}),t.jsx("span",{className:"detect"+(Be?" off":"")+(Ca.test(y.trim())?" url":""),children:Dt})]}),t.jsx("span",{className:"dacts",children:Be?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Te?" loading":""),disabled:Te||gt||!de.trim()&&!xe.trim(),onClick:()=>{at()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:te})]}),t.jsxs("a",{className:"viewbtn"+(na(de)?"":" off"),href:na(de)?de.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:_=>{na(de)||_.preventDefault()},children:[t.jsx(up,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ht?" analyse":"")+(s?" loading":""),disabled:s,onClick:zt,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:X})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(O?" searching":ct?"":" off"),href:ct||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":O||void 0,title:O?e.viewSiteBusyHint:e.viewSiteHint,onClick:_=>{ct||_.preventDefault()},children:[O&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),O?e.viewSiteBusy:e.viewSite,!O&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(F?"":" off"),href:F||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:_=>{F||_.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),p.showCredits&&_e&&t.jsxs("button",{type:"button",className:"credits"+(_e.total_available<=0&&!_e.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:_e.unlimited?"∞":_e.total_available}),!_e.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",_e.daily_grant+_e.purchased]}),_e.total_available<=0&&!_e.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{l({type:"ptab",tab:0}),M(!1),requestAnimationFrame(()=>{const _=document.querySelector(".atl2.cibles .desk-list");if(!_)return;const oe=window.scrollY+_.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,oe),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(I?" on":""),onClick:()=>P(!I),children:e.rsOpen}),we!==null&&we>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ue?" on":""),onClick:()=>ce(!ue),children:e.rsArchOpen(we)}),p.pipe&&!!n&&t.jsx(sp,{pageToken:j,onAddNames:lt})]}),ue&&t.jsx(cp,{bump:De,cbToken:j,onClose:()=>ce(!1),onEvaluate:_=>i(null,_),onAddAll:lt}),t.jsx("div",{className:"rsp slim"+(I?" on":" off"),"aria-hidden":!I,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:I?void 0:-1,onClick:()=>ae(_=>!_),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:U?"▴":"▾"})]}),U&&t.jsx("textarea",{className:"rstext",value:xe,placeholder:e.rsTextPh,tabIndex:I?void 0:-1,onChange:_=>be(_.target.value)})]})}),V&&t.jsx("div",{className:"rserr",children:V}),Q&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:Q.title}),Q.source_url&&t.jsx("a",{href:Q.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{se(null),re(null)},children:"×"})]}),Q.market&&t.jsx("p",{className:"rsmk",children:Q.market}),At.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),At.map(_=>t.jsx("span",{children:_},_))]}),t.jsxs("div",{className:"rsbody",children:[Q.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${Q.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:di(Q.summary_md||"").map((_,oe)=>t.jsx("p",{children:_},oe))})]}),t.jsx(pi,{card:Q,onEvaluate:_=>i(null,_),onAddAll:lt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Pt)}),It]})]}),Ct.slice(0,1).map((_,oe)=>{const ee=_.verdict==="kept",me=_.verdict==="quota",Ne=_.verdict==="unresolved",ge=ee?"var(--brand)":me?"var(--bolt)":Ne?"var(--blue)":"var(--red)",Fe=ee?"var(--brand-l)":me?"#FFF3D6":Ne?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":ge,"--bgc":Fe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ee?"✓ "+e.kept:me?"⏳":Ne?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),_.name&&t.jsx("span",{className:"rn",children:_.name}),t.jsx("span",{className:"rr",children:_.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",_.reason]}):null}),!!(_.candidates&&_.candidates.length)&&t.jsx("span",{className:"sitepick",children:_.candidates.map(ze=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:ze.url.startsWith("http")?ze.url:`https://${ze.url}`,target:"_blank",rel:"nofollow noopener",children:[(ze.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,ze.url,_.name),children:e.evalPickGo})]},ze.url))}),!me&&!Ne&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:ee?1:5});const ze=(_.name||"").trim().toLowerCase();window.setTimeout(()=>{const nt=[...document.querySelectorAll(".atl2 .list .row")].find(xt=>{var Ze;return(((Ze=xt.querySelector(".rnm"))==null?void 0:Ze.textContent)||"").trim().toLowerCase().includes(ze)});nt&&(nt.scrollIntoView({behavior:"smooth",block:"center"}),nt.classList.add("flashrow"),window.setTimeout(()=>nt.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ee?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},oe)}),v&&(d.kept+d.dropped>0||Ct.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function fp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function hp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Z(),i=e.memoConsole?r.get(e.memoConsole):null,d=c.useMemo(()=>i?[i.reasoning||"",fp(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=St(i),s=Ln(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:d?d.split(`

`).map((g,p)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},p)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[$t(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:s===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function $n({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Z(),[d,l]=c.useState(!1),[s,g]=c.useState(null),p=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!p||d)return;l(!0);const m=await ko(r,e);if(l(!1),!m){i(a.actErr);return}g(m.results||[])};return c.useEffect(()=>{if(!p)return;const m=b=>{var w;const u=String(((w=b.detail)==null?void 0:w.name)||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",m),()=>window.removeEventListener("ppmap:similar",m)},[e,p]),c.useEffect(()=>{if(p)try{const m=(sessionStorage.getItem("pp:similar")||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,p]),p?t.jsxs("div",{className:"simb",onClick:m=>m.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{x()},children:d?a.similarBusy:a.similar}),s&&(s.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:s.map(m=>t.jsxs("li",{children:[t.jsx("b",{className:m.verdict==="kept"?"ok":"ko",children:m.company}),m.reason&&t.jsx("span",{children:m.reason})]},m.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const gp=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ka=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function pa(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}function Tn(e){const a=pa(e);if(!a)return"";try{return new URL(a).hostname.replace(/^www\./,"")}catch{return""}}function xp(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ka(a.slice(n));break}r+=ka(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ka(a.slice(o));break}const d=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(d),s=l?l[2].toLowerCase():"";l&&gp.has(s)?r+=`<${l[1]}${s}>`:r+=ka(a.slice(o,i+1)),n=i+1}return r}const bp=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),ao={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function ci(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(bp.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const l=d.name.toLowerCase();(!(ao["*"].has(l)||((r=ao[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}ci(n)}}function za(e){const a=e.cloneNode(!0);return ci(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const vp={swot:null,summary:"",syn:"",pnl:"",cf:"",roi:"",reco:"",plan:"",pruned:[]},yp=/chiffre|revenu|revenue|\barr\b|ebitda|marge|gross|fcf|free cash|net|total|r[ée]sultat|cash|capex|nopat|moic|irr|\btri\b|roi|entry|\bev\b|invested|synerg/i,wp=[["syn",/synerg/i],["pnl",/compte de r[ée]sultat|p\s*&\s*l|profit\s*(?:and|&)\s*loss|income statement/i],["cf",/flux de tr[ée]sorerie|cash\s*-?\s*flow/i],["roi",/\broi\b|return on investment|retour sur investissement/i],["reco",/verdict post|post[- ]model verdict|conviction quantitative/i]];function Ot(e){return String(e||"").replace(/<script[\s\S]*?<\/script>/gi," ").replace(/<style[\s\S]*?<\/style>/gi," ").replace(/<[^>]+>/g," ").replace(/&nbsp;/gi," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#39;|&apos;/g,"'").replace(/&quot;/g,'"').replace(/\s+/g," ").trim()}function ui(e,a){const r=e.slice(a),n=/<div\b|<\/div\s*>/gi;let o=0,i;for(;i=n.exec(r);)if(i[0][1]!=="/")o+=1;else if(o-=1,o===0)return e.slice(a,a+i.index+i[0].length);return""}function rn(e,a){const n=new RegExp(`<div\\b[^>]*\\bid="${a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}"`,"i").exec(e);return n?ui(e,n.index):""}function kp(e,a=14){const r=e.match(/<tr\b[\s\S]*?<\/tr\s*>/gi)||[];if(r.length<=a)return{html:e,pruned:!1};const n=[];for(let d=0;d<r.length-1;d+=1){const l=r[d],s=/<t[dh]\b[^>]*>([\s\S]*?)<\/t[dh]\s*>/i.exec(l),g=s?Ot(s[1]):"";if((d<2||/<th/i.test(l)||yp.test(g))&&n.push(l),n.length>=a-1)break}n.push(r[r.length-1]);const o=n.length<3?r.slice(0,a):n;return{html:(/^\s*<table\b[^>]*>/i.exec(e)||["<table>"])[0]+o.join("")+"</table>",pruned:!0}}function jp(e,a=14){let r=!1;return{html:e.replace(/<table\b[\s\S]*?<\/table\s*>/gi,o=>{const i=kp(o,a);return r=r||i.pruned,i.html}),pruned:r}}function Ep(e){const a={s:[],w:[],o:[],t:[]},r=[["s","s-green"],["w","s-red"],["o","s-blue"],["t","s-orange"]];for(const[n,o]of r){const i=new RegExp(`<div\\b[^>]*class="[^"]*swot-item[^"]*\\b${o}\\b[^"]*"`,"i").exec(e);if(!i)return null;const d=ui(e,i.index);let l=(d.match(/<li\b[^>]*>([\s\S]*?)<\/li\s*>/gi)||[]).map(s=>Ot(s));if(!l.length){const s=/<p\b[^>]*>([\s\S]*?)<\/p\s*>/i.exec(d);s&&(l=[Ot(s[1])])}if(l=l.filter(s=>s&&!/not available/i.test(s)&&!/non disponible/i.test(s)).map(s=>s.slice(0,260)).slice(0,4),!l.length)return null;a[n]=l}return a}function Np(e){const a=e.search(/id=["']company-summary["']/i);if(a<0)return"";const r=e.slice(a,a+9e3),n=/(?:EN R[ÉE]SUM[ÉE]|EN QUELQUES MOTS|IN SUMMARY|IN A FEW WORDS|IN A NUTSHELL|TL;DR)[\s:]*(?:<\/?span[^>]*>[\s:]*)*([\s\S]+?)(?=<br|<hr|<\/div|<h[23]|⚠|✅|🚀|❓|$)/i.exec(r);return n?Ot(n[1]).slice(0,600):""}function Sp(e,a,r){if(r<0)return"";const n=/<h3\b[^>]*>([\s\S]*?)<\/h3\s*>/gi;n.lastIndex=r;let o;for(;o=n.exec(e);){if(!a.test(Ot(o[1])))continue;const i=/<h3\b[^>]*>/i.exec(e.slice(o.index+o[0].length));return i?e.slice(o.index,o.index+o[0].length+i.index):e.slice(o.index,Math.min(e.length,o.index+o[0].length+6e4))}return""}function no(e){let a=e.replace(/^\s*<div\b[^>]*>/i,"").replace(/<\/div\s*>\s*$/i,"");return a=a.replace(/<h2\b[^>]*class="[^"]*section-title[^"]*"[^>]*>[\s\S]*?<\/h2\s*>/gi,""),a=a.replace(/<details\b[\s\S]*?<\/details\s*>/gi,""),a.trim()}function on(e,a){if(e.length<=a)return e;const r=e.slice(0,a),n=r.lastIndexOf(">");return n>=0?r.slice(0,n+1):r}function Cp(e){const a={...vp,pruned:[]};if(!e)return a;try{const n=rn(e,"swot");n&&(a.swot=Ep(n))}catch{}try{a.summary=Np(e)}catch{}try{const n=rn(e,"action-plan");if(n){const o=no(n);a.plan=on(o,12e3)}}catch{}const r=e.search(/id=["']financial-forecast["']/i);for(const[n,o]of wp)try{let i=Sp(e,o,r);if(!i)continue;const d=jp(i);i=on(d.html,45e3),Ot(i)&&(a[n]=i,d.pruned&&a.pruned.push(n))}catch{}if(!a.reco)try{const n=rn(e,"conviction");if(n){const o=on(no(n),8e3);Ot(o)&&(a.reco=o)}}catch{}return a}function zp(e){return e?!!(e.swot||e.summary||e.syn||e.pnl||e.cf||e.roi||e.reco||e.plan):!1}const sn=new Map;function mi(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=sn.get(a);return r||(r=Ap(a).catch(()=>null),r.then(n=>{n||sn.delete(a)}),sn.set(a,r)),r}async function Ap(e){var m,b;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=await a.text(),n=new DOMParser().parseFromString(r,"text/html"),o=u=>{var w;return(((w=n.querySelector(u))==null?void 0:w.textContent)||"").trim()},i=n.querySelector(".sb-score"),d=((m=Array.from((i==null?void 0:i.classList)||[]).find(u=>u.startsWith("sb-score-")))==null?void 0:m.slice(9))||"",l=[];let s=null;const g=Array.from(n.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const u of g){if(u.classList.contains("sb-nav-heading")){s={label:(u.textContent||"").trim(),items:[]},l.push(s);continue}const w=u.getAttribute("href")||"";if(!w.startsWith("#"))continue;const k=w.slice(1),f=Tp(n,k);f&&(s||(s={label:"",items:[]},l.push(s)),s.items.push({id:k,title:(u.textContent||"").trim(),html:f,poids:f.length}))}const p=((b=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:b[1])||"",x={score:o(".sb-score"),scoreTone:d,tags:Array.from(n.querySelectorAll(".sb-tag")).map(u=>(u.textContent||"").trim()).filter(Boolean),name:o(".sidebar-company-name"),tagline:o(".sidebar-tagline"),desc:o(".meta-desc"),groups:l.filter(u=>u.items.length),mindmapSlug:n.querySelector(".cm-mindmap-png")?p:"",comite:qp(n,Cp(r))};return x.groups.length?x:null}function qp(e,a){const r=n=>{if(!n)return"";const o=e.createElement("div");return o.innerHTML=n,za(o)};return{...a,syn:r(a.syn),pnl:r(a.pnl),cf:r(a.cf),roi:r(a.roi),reco:r(a.reco),plan:r(a.plan)}}const ro={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Tp(e,a){const r=e.getElementById(a),n=r?oo(e,r):"";if(n)return n;const o=ro[a]?e.querySelector(ro[a]):null;return o&&o!==r?oo(e,o):""}function oo(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),za(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(s=>/^h3$/i.test(s.tagName))[0]===a)for(const s of i){if(s===a)break;/^h2$/i.test(s.tagName)||o.appendChild(s.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?za(o):""}return za(a)}const ln=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ve({k:e,v:a,href:r,wide:n}){return a==null||a===""?null:t.jsxs("div",{className:"cdl"+(n?" cdw":""),children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Lp({k:e,vals:a}){const r=(a||[]).filter(Boolean);return r.length?t.jsxs("div",{className:"cdl cdw",children:[t.jsx("span",{className:"cdk",children:e}),t.jsx("span",{className:"cdtags",children:r.map(n=>t.jsx("span",{className:"cdtag",children:n},n))})]}):null}function io(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function so({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const dn=new Map;function Fp(e,a){const{token:r}=Z(),[n,o]=c.useState(null);return c.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=dn.get(i);d||(d=gs(r,e.name,e.checkId),dn.set(i,d),d.then(s=>{(!s||!s.reasoning&&!s.summaryHtml)&&dn.delete(i)}));let l=!0;return d.then(s=>{l&&s&&o({id:e.id,d:s})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Rp=6e4;function Op({o:e}){const{t:a,doDeep:r}=Z(),[n,o]=c.useState(null),[i,d]=c.useState(e.memoUrl?"load":"off"),[l,s]=c.useState(()=>new Set),[g,p]=c.useState(!1),x=c.useRef(new Map);c.useEffect(()=>{let w=!0;if(s(new Set),p(!1),x.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),mi(e.memoUrl).then(k=>{w&&(o(k),d(k?"ok":"err"))}),()=>{w=!1}},[e.memoUrl]);const m=St(e),b=w=>{var k;return(k=x.current.get(w))==null?void 0:k.scrollIntoView({behavior:"smooth",block:"start"})},u=t.jsxs("div",{className:"cdacts",children:[$t(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:w=>{w.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const w=[e.reasoning||"",io(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[w.length?w.join(`

`).split(`

`).map((k,f)=>t.jsx("p",{className:"cdtxt",children:k},f)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),u]})}if(i!=="ok"){const w=[e.reasoning||"",io(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[m&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:m}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),w.length>0&&w.join(`

`).split(`

`).map((k,f)=>t.jsx("p",{className:"cdtxt",children:k},f)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:k=>{k.stopPropagation(),p(f=>!f)},children:g?a.memoHideHere:a.memoReadHere})}),g&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:k=>k.stopPropagation()}),u,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[m&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:m}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(w=>t.jsx("span",{className:"md-tag",children:w},w)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(w=>w.items.map(k=>t.jsx("button",{type:"button",className:"md-jump",onClick:f=>{f.stopPropagation(),b(k.id)},children:k.title},k.id)))}),n.groups.map((w,k)=>t.jsxs("div",{className:"md-grp",children:[w.label&&t.jsx("div",{className:"md-grp-h",children:w.label}),w.items.map(f=>{const v=f.poids>Rp&&!l.has(f.id),j=f.id==="fiche-contact"||f.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:y=>{y&&x.current.set(f.id,y)},children:[t.jsx("h4",{className:"md-h",children:f.title}),j&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:y=>y.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:"LinkedIn"})]}),v?t.jsx("button",{type:"button",className:"abtn md-more",onClick:y=>{y.stopPropagation(),s(N=>new Set(N).add(f.id))},children:a.memoUnfold(Math.round(f.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:f.html}}),!v&&n.mindmapSlug&&f.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Ha}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:y=>y.stopPropagation()})]})]},f.id)})]},w.label||k)),u,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull})]})}function Mp({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:l}=Z(),[s,g]=c.useState(!1),[p,x]=c.useState(!1),[m,b]=c.useState(!1),[u,w]=c.useState(null),[k,f]=c.useState(""),[v,j]=c.useState(null),[y,N]=c.useState(""),E={airtableId:e.airtableId,checkId:e.checkId},S=!!(e.airtableId||e.checkId),T=u&&u.id===e.id?u.entries:[],C=!!u&&u.id===e.id;if(c.useEffect(()=>{f(""),j(null),b(!1)},[e.id]),c.useEffect(()=>{if(!s||C||!S||!o)return;let D=!0;x(!0),b(!1);const H=e.id;return ir(r,"list",E).then(R=>{if(!(!D||H!==e.id)){if(x(!1),!R.ok){b(!0);return}w({id:H,entries:R.entries})}}),()=>{D=!1}},[s,C,S,r,e.id,o]),!n.pipe||!o||!S)return null;const L=(D,H)=>{x(!0);const R=e.id;ir(r,D,E,H).then(O=>{if(R===e.id){if(x(!1),!O.ok){d(a.notesErr);return}w({id:R,entries:O.entries}),b(!1),D==="add"&&(f(""),i(a.notesAdded)),D==="edit"&&j(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":s,onClick:D=>{D.stopPropagation(),g(H=>!H)},children:[t.jsx("b",{children:a.notesT}),T.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(T.length)}),t.jsx("i",{children:s?"▾":"▸"})]}),s&&t.jsxs("div",{className:"dn-b",onClick:D=>D.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),p&&!T.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),m&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!p&&!m&&C&&!T.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),T.map(D=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:l==="fr"?D.date.split("-").reverse().join("/"):D.date}),v===D.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:y,rows:3,onChange:H=>N(H.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:p||!y.trim(),onClick:()=>L("edit",{entryId:D.id,text:y.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>j(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:D.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{j(D.id),N(D.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:p,onClick:()=>{window.confirm(a.notesDelAsk)&&L("delete",{entryId:D.id})},children:a.notesDel})]})]})]},D.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:k,onChange:D=>f(D.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:p||!k.trim(),onClick:()=>L("add",{text:k.trim()}),children:a.notesAdd})]})]})]})}function Un({o:e}){var N;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:d}=Z(),l=ua(e),s=St(e),g=(e.cribleStatus||"").trim().toUpperCase()||(l==="NO MATCH"?"NO MATCH":l==="MATCH"?"MATCH":""),p=[e.sector,e.market,(e.tags||[]).filter(Boolean).length?"1":"",e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.provQuery,Tn(e.provUrl||""),qa(e),e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,m=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=c.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(g?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||$t(e)?1:0},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:m}].filter(E=>E.n>0),[e,a,o,g,s,p,x,m]),[u,w]=c.useState(""),k=b.some(E=>E.k===u)?u:((N=b[0])==null?void 0:N.k)||"",f=Fp(e,k==="eval"||k==="conv");if(!b.length)return null;const v=((f==null?void 0:f.reasoning)||"").length>(e.reasoning||"").length?f.reasoning:e.reasoning||"",j=((f==null?void 0:f.summaryHtml)||"").length>(e.summary||"").length?f.summaryHtml:e.summary||"",y=(f==null?void 0:f.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(E=>t.jsx("button",{type:"button",role:"tab","aria-selected":k===E.k,"data-tour":"tab-"+E.k,className:k===E.k?"on":"",onClick:S=>{S.stopPropagation(),w(E.k)},children:E.lib},E.k))}),t.jsxs("div",{className:"cdbody",onClick:E=>E.stopPropagation(),children:[k==="eval"&&t.jsxs(t.Fragment,{children:[g&&t.jsxs("div",{className:"cdv1"+(g==="NO MATCH"?" out":""),children:[t.jsx("b",{children:g==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(so,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),v&&v.split(`

`).map((E,S)=>t.jsx("p",{className:"cdtxt",children:E},S)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Dp,{o:e})]}),k==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof y=="number"&&t.jsx(so,{v:y,sur:100,k:a.cdConvScore}),ln(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",ln(e.verdictDate,r)]})]}),j&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:xp(j)}})]}),k==="memo"&&t.jsx(Op,{o:e}),k==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ve,{k:a.cdSector,v:e.sector}),t.jsx(Ve,{k:a.cdMarket,v:e.market,wide:!0}),t.jsx(Lp,{k:a.cdTags,vals:e.tags}),t.jsx(Ve,{k:a.cdStage,v:e.stage}),t.jsx(Ve,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ve,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Ve,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Ve,{k:a.cdAngle,v:e.angle}),t.jsx(Ve,{k:a.cdDetected,v:ln(e.date,r)}),t.jsx(Ve,{k:a.cdQuery,v:e.provQuery,wide:!0}),t.jsx(Ve,{k:a.cdSrc,v:Tn(e.provUrl||""),href:pa(e.provUrl||"")}),t.jsx(Ve,{k:a.cdAngleSrc,v:qa(e)})]}),k==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ve,{k:a.cdName,v:e.contactName}),t.jsx(Ve,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Ve,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(Ve,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),k==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(Ve,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(Mp,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(e),children:a.actRegen})]})]})]})]})}const ja=new Map;function Dp({o:e}){const{t:a,token:r}=Z(),[n,o]=c.useState(!1),[i,d]=c.useState(null);c.useEffect(()=>{if(!r||!e.name)return;const x=`${r}:${e.name.toLowerCase()}`;let m=ja.get(x);m||(m=Eo(r,[e.name]).then(u=>u[e.name]||Object.values(u)[0]||null).catch(()=>null),ja.set(x,m),m.then(u=>{(!u||!u.ok)&&ja.delete(x)}));let b=!0;return m.then(u=>{b&&u&&u.ok&&d(u)}),()=>{b=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const x=await yo(r,e.name,e.website||e.domain||"");d(x),x.ok&&ja.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(x)),o(!1)},s=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,s.value_prop],[a.qaProduct,s.produit],[a.qaModel,s.modele],[a.qaSummary,s.synthese]],p=g.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&p&&t.jsxs(t.Fragment,{children:[g.filter(([,x])=>x).map(([x,m])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:m})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!p&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function ma({spec:e}){const a=c.useRef(null),r=c.useRef(null),[n,o]=c.useState(!1);return c.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const l=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));sr({kind:"op",card:e},g).then(p=>{!d&&p&&i.isConnected&&i.replaceChildren(p)})},s=window.requestAnimationFrame(l);return()=>{d=!0,window.cancelAnimationFrame(s),i.replaceChildren()}},[e]),c.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;sr({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(s=>{!d&&s&&i.isConnected&&i.replaceChildren(s)});const l=s=>{s.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{d=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Ip=`
...
`;function Pp(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:d,top:l}}function _p(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:l,doAnalyse:s,doDecide:g,doPromote:p,doRepeche:x,doApproach:m,doDeep:b,doOnboard:u,outbound:w,evalBusy:k}=Z(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const v=$e(f),j=Ae(f),y=St(f),N=ua(f),E=f.kind==="target",S=T=>{a({type:"filters",patch:T}),a({type:"popup",id:null})};return Wt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Ip}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Pp(e.popupAnchor,!!f.card),onClick:T=>T.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(kt(f.date)),tt(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[f.cc]}),children:(Gt(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>S({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>S({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Yt(f.amountEur,o)})]}),i.pipe&&E&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Lt(f.engine)," ",t.jsx("b",{children:tt(f.engine,o)})," — ",xs(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),v?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Nt,{o:f,lg:!0})," ",t.jsx(Va,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(No(v,o))," · ",n.win7(So(v,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(ma,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&E&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&E&&t.jsx(Un,{o:f})]}),t.jsx($n,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{s(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),$t(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),w&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{u(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var T;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(T=document.querySelector(".atl2 .demand"))==null||T.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:k,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Bp(){const{lang:e,token:a,dossiers:r,caps:n}=Z(),o=a||"home",{names:i,verdicts:d}=c.useMemo(()=>{const s=[],g={};return r.forEach(p=>{p.kind!=="target"||!p.name||(s.push(p.name),g[p.name]=bs(p)||"")}),{names:s,verdicts:g}},[r]);return{diff:c.useMemo(()=>i.length?vs(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function $p(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:l}=Z(),[s,g]=c.useState(!1),[p,x]=c.useState(!1),m=c.useRef(null);c.useEffect(()=>{if(!s)return;const j=y=>{m.current&&!m.current.contains(y.target)&&g(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[s]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],u=i.loading&&!d.length,w=c.useRef({});c.useEffect(()=>{w.current={...r}},[r]);const k=j=>{const y=w.current[j],N=y!==void 0?r[j]-y:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${ra[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j],j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[j],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},j)},f=(j,y,N)=>t.jsxs("button",{type:"button",className:"off"+(y?" view":""),"data-off":j,style:{"--c":`var(${ra[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:N}),t.jsx("span",{className:"n",children:r[j]})]},j),v=(j,y,N,E=!1)=>t.jsx("button",{type:"button",className:"tool",title:y,disabled:E,onClick:N,children:j},y);return t.jsxs("div",{className:"funnel"+(u?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(k)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[v("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(p?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"}),a({type:"ptab",tab:1}),a({type:"continent",key:l.pipe?"europe":"monde"}),a({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:m,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":s,title:n.toolSort,onClick:()=>g(j=>!j),children:"⇅"}),s&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([j,y])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[y,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),v("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),v("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Up(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,doAnalyse:l,mode:s,data:g}=Z(),p=c.useRef(null),[x,m]=c.useState(60);c.useEffect(()=>{let y=0;const N=()=>{var L;const E=p.current;if(!E)return;const S=(L=E.parentElement)==null?void 0:L.querySelector('.funnel [aria-selected="true"]');if(!S)return;const T=S.getBoundingClientRect(),C=E.getBoundingClientRect();m(Math.max(20,Math.min(T.left+T.width/2-C.left,C.width-30)))};return y=requestAnimationFrame(N),window.addEventListener("resize",N),()=>{cancelAnimationFrame(y),window.removeEventListener("resize",N)}},[e.ptab]);const b=e.ptab;let u=r.tuto[b].p;if(b===3){const y=i.filter(S=>S.kind==="target"&&Ae(S)===3),N=y.filter(S=>mn(S)==="auto").length,E=y.filter(S=>mn(S)==="cd").length;u=r.tutoPending(N,E,y.length)}const w=(()=>{var y;if(s!=="client")return null;if(b===0&&i.length)return{label:r.tuto[0].a,locked:!1,run:()=>a({type:"chainStart",queue:i.map(N=>N.id)})};if(b===1){const N=i.filter(E=>E.kind==="target"&&Ae(E)===1&&!d.has(E.id)).slice(0,10);if(N.length){const E=String(((y=g.credits)==null?void 0:y.plan)||"").toLowerCase(),S=E==="enterprise"||E==="entreprise";return{label:r.tuto[1].a,locked:!S,run:()=>{S&&a({type:"chainStart",queue:N.map(T=>T.id)})}}}}return null})(),k=ys(b),f=b===1||b===2,v=r.plabels[b]+" · "+(o[b]??0),j=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:p,className:"tuto mini"+(k?"":" on-dark")+(f?" etape-on":""),style:{"--bg":`var(${ra[b]})`,"--ax":x+"px","--stc":k?"var(--ink)":"#fff","--stt":k?"#fff":"var(--ink)","--tc":k?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:v}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:u}})]})}),w&&t.jsx("button",{type:"button",className:"tprim"+(w.locked?" lock":""),disabled:!!w.locked,title:w.locked?r.analyseLockHint:void 0,onClick:w.run,children:w.locked?"🔒 "+r.analyseLock:w.label}),b!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:j})]})}const pn=600,Et=62,lo="atl2:fstats";function Hp(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Z(),[d,l]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(lo)==="on"}catch{return!1}}),s=r.stats,g=c.useMemo(()=>((s==null?void 0:s.by_day)||[]).slice(-30),[s]),p=(s==null?void 0:s.since)||"";if(!n.showFunnel||!s||typeof s.screened!="number")return null;const x=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,m=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((N,E)=>Math.max(N,E.s||0),0),u=g.length?pn/g.length:0,w=Math.max(4,u-4),k=g.length>=5&&b>0,f=r.marketEstimate||0,v=x(new Date().toISOString().slice(0,10)),j=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof s.kept=="number"?[[s.kept,e.funKept]]:[],...typeof s.analyzed=="number"?[[s.analyzed,e.funAnalyzed]]:[],...typeof s.shown=="number"?[[s.shown,e.funShown]]:[]],y=[];return typeof s.screened_window=="number"&&p&&y.push({cle:"fenetre",periode:e.funPerWindow(x(p),v),etapes:[[s.screened_window,e.funScreened("","")]]}),typeof s.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:j(s.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[y.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([E,S],T)=>t.jsxs("span",{className:"fst-t",children:[T>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:m(E)}),t.jsx("i",{children:S})]},N.cle+S)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(m(f),Math.min(100,Math.round((s.screened||0)/f*100)))})]}),N.cle==="total"&&(s.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),N.cle===y[y.length-1].cle&&k&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const E=!d;l(E),E&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(lo,E?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},N.cle)),d&&k&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${pn} ${Et}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((N,E)=>{const S=(N.s||0)/b*(Et-4),T=(N.m||0)/b*(Et-4),C=E*u+(u-w)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===N.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===N.d?{day:"",win:"all"}:{day:N.d,win:"all"}}),onKeyDown:L=>{L.key!=="Enter"&&L.key!==" "||(L.preventDefault(),i({type:"filters",patch:o.filters.day===N.d?{day:"",win:"all"}:{day:N.d,win:"all"}}))},children:[t.jsx("title",{children:`${x(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:C-1,y:0,width:w+2,height:Et,fill:"transparent"}),t.jsx("rect",{x:C,y:Et-2-S,width:w,height:S,fill:"#cfe0d6"}),t.jsx("rect",{x:C,y:Et-2-T,width:w,height:T,fill:"#0E7F3F"})]},N.d)}),t.jsx("line",{x1:0,y1:Et-1.5,x2:pn,y2:Et-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const fi={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Hn({o:e,locked:a=!1}){const{t:r}=Z(),n=ua(e),o=St(e),i=Ae(e),d=mn(e),l=ws(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(fi[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(Kl,{o:e})]})}const Vt=e=>e.length>22?e.slice(0,21)+"…":e;function ca(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function hi(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Vp({on:e,rev:a}){const[r,n]=c.useState(null),[o,i]=c.useState({top:0,left:0,width:0});return c.useEffect(()=>{if(!e){n(null);return}const d=()=>{var u,w,k;const l=document.querySelector(".atl2.ops .desk-list"),s=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const g=l.getBoundingClientRect(),p=s?s.getBoundingClientRect().bottom:g.top;i({top:Math.round(p),left:Math.round(g.left),width:Math.round(g.width)});const x=[...l.querySelectorAll(":scope .grp")];let m=null;for(const f of x){const v=f.querySelector(".grp-h");v&&v.getBoundingClientRect().bottom<=p+2&&(m=f)}if(!m){n(null);return}const b=m.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((u=b.querySelector(".ic"))==null?void 0:u.textContent)||"").trim(),t:(((w=b.querySelector(".t"))==null?void 0:w.textContent)||"").trim(),s:(((k=b.querySelector(".s"))==null?void 0:k.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Wp(e){const r=()=>{const n=hi(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function po({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Z(),[i,d]=c.useState(!1);if(c.useEffect(()=>{n||d(!1)},[n]),Ge(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const s=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(s?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Vt(e.name))})]})}function Vn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:d,doPromote:l,doRepeche:s,doApproach:g,dispatch:p,liveMemos:x}=Z(),m=u=>w=>{w.stopPropagation(),u()};if(r.lockActions){const u=m(()=>p({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:u,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const w=Ae(e);return w===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:u,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Vt(e.name))})]})}):w===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:u,children:a.actAnalyse})}):w===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:u,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:u,children:a.actNo})]})}):w===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:u,children:a.actPromote})}):w===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:u,children:a.actApproach})}):w===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:u,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:u,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{u.stopPropagation(),ca(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Fa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{u.stopPropagation(),ca(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(po,{o:e})});const b=Ae(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(po,{o:e})});if(b===1){const u=x.liveOf(e.name);if(u&&(u.status==="boot"||u.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ta,{item:u,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const w=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:w,onClick:m(()=>i(e)),children:w?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:m(()=>d(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:m(()=>d(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:m(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const u=o.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:u,onClick:m(()=>g(e)),children:u?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:m(()=>p({type:"modal",modal:"plug"})),children:a.actConn}),t.jsx("button",{type:"button",className:"lk sm dsrow",title:a.dsBtn,onClick:m(()=>p({type:"dossierOpen",id:e.id})),children:a.dsBtn})]})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:m(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>s(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:m(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:m(()=>p({type:"focus",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Gp({o:e}){const{t:a,doThumb:r,thumbOf:n}=Z(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Yp({o:e}){const{lang:a}=Z();return $e(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Nt,{o:e}),t.jsx(Va,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Lt(e.engine||"")," ",tt(e.engine||"",a)]})})}function Qp({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:l}){const{dispatch:s,caps:g,markRow:p,markedId:x,favIds:m,toggleFav:b,t:u}=Z(),w=Ae(e),k=["#16233A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=f<=0?0:f<=7?1:f<=30?2:3,j=g.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][w]:k[v],y=m.has(e.id),N=E=>{if(a)return;if(d){d(e.id);return}if(g.pipe||e.kind==="op"){n();return}const S=E.currentTarget.getBoundingClientRect();s({type:"popup",id:e.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return t.jsxs(c.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+w:"")+(y?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>p(e.id),onMouseLeave:()=>p(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(wi,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${u.cdEngagement} ${Math.round(e.engagement*10)/10} · ${u.cdEngagementHint}`,children:"🔥"}),$e(e)&&t.jsx(Nt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:y?1:.35,padding:0,marginRight:4},onClick:E=>{E.stopPropagation(),b(e)},children:y?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Je(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(E=>E&&E!==e.name)||""]}),g.pipe&&!g.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:E=>E.stopPropagation(),children:[e.website&&t.jsx("a",{href:pa(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":u.rowSite,title:u.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:pa(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":u.rowLi,title:u.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":u.rowMail,title:u.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":u.rowTel,title:u.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:u.acqSee(e.acquirer),onClick:E=>{E.stopPropagation(),s({type:"acquirer",value:e.acquirer||""})},children:["← ",Vt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:u.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:u.zoomNewsMark,children:"📰"}):null]}),t.jsx(Kp,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Yp,{o:e}),g.pipe&&t.jsx(Hn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Vn,{o:e}),g.showThumbs&&t.jsx(Gp,{o:e})]}),r&&!a&&!d&&t.jsx(Zp,{o:e})]})}function Kp({o:e}){const{lang:a,caps:r}=Z();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Yt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Jp({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Z(),d=(m,b=!1)=>u=>{u.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})},l=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,40):""})(),s=Yt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),p=Ge(e),x=p&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),s&&t.jsx("span",{className:"oc-amt",children:s}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[p?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Je(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:m=>{m.stopPropagation(),ca(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:m=>{m.stopPropagation(),n(e)},children:a.evalGoOn(Vt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ma,{spec:e.card})})]})}function Xp({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Z();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[tt(e.engine||"",r),i?` · ${i}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Vn,{o:e})})]}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx(Un,{o:e})]})}function gi({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:l,dossiers:s}=Z(),g=c.useRef(null),p=We(e);if(c.useEffect(()=>{if(!p||!(e!=null&&e.decryptHtml))return;const h=g.current;if(!h)return;let q=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async M=>{await M.ensureEditoCss(),!(q||!h.isConnected)&&(M.beautifyEditoRows(h),M.mountCardFits(h))}),()=>{q=!0}},[p,e==null?void 0:e.decryptHtml]),!e&&!a){const h=s.find(We);if(h)return t.jsx(gi,{o:h})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),m=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),w=e?!!e.noCo:!x||La(x),k=(e==null?void 0:e.engine)||"",f=We(e),v=e?Yt(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),y=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(m);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),N=s.find(We),E=((N==null?void 0:N.url)||"").trim(),S=!!m&&!!E&&(m===E||m.endsWith(E)||E.endsWith(m)),T=(h,q=!1)=>M=>{M.stopPropagation(),q&&d({type:"continent",key:"monde"}),d({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const C=()=>{x&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:x}}))},L=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},D=()=>{ca({url:m,headline:b,tagline:e==null?void 0:e.tagline,name:x})},H=e?Ge(e):!1,R=H&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",O=f?r.doEdito.replace(/^📖\s*/,""):k?tt(k,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[O,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),m&&!f&&(w||Fa({engine:k}))&&t.jsxs("a",{className:"zoom-ext",href:m,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,y?t.jsx("em",{children:y}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:T({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:T({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:T({stage:[e.stage]}),children:e.stage}),v&&t.jsx("span",{className:"oc-amt",children:v})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(ma,{spec:u})}),(m&&!S&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[m&&!S&&!f&&t.jsxs("a",{className:"zoom-src",href:m,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,y?` · ${y}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),d({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[H?t.jsxs("span",{className:"verdict",style:{"--c":R?"var(--brand)":"var(--red)"},children:[R?"✓":"✗"," ",t.jsx("b",{children:R?r.kept:r.dropped})]}):!w&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:h=>{h.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Vt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,m&&!f&&(w||Fa({engine:k}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!w&&x?" ghost":""),onClick:h=>{h.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!w&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),L()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),C()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Vt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!w&&x&&l.pipe&&t.jsx($n,{name:x})]})]})}function Zp({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=Z();return!o.pipe&&e.kind==="op"?t.jsx(Jp,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Un,{o:e}),t.jsx(Jl,{o:e}),t.jsx(Zl,{o:e}),t.jsx($n,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Hn,{o:e})})]}),e.card&&t.jsx(ma,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Lt(e.engine||"")," ",tt(e.engine||"",r)]}),$e(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Nt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function ec({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:l,lang:s}=Z();if(!d.pipe&&e.kind==="op"){const x=Yt(e.amountEur,s),m=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),b=(u,w=!1)=>k=>{k.stopPropagation(),w&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ma,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Lt(e.engine||"")," ",tt(e.engine||"",s)]}),$e(e)&&t.jsx(Nt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(m?` · ${m}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Vn,{o:e})})]})}const g=Ae(e),p=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":p},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Hn,{o:e}),$e(e)&&t.jsx(Nt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"focus",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function tc(){const{t:e}=Z(),[a,r]=c.useState(0);return c.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function ac({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Z(),i=o==="en",d=p=>n.plabels[p]||"",l=[0,1,2,3,4,5,6,7].filter(p=>p!==a.ptab&&(e[p]||0)>0),s=l.includes(0)?0:l.sort((p,x)=>(e[x]||0)-(e[p]||0))[0];if(s===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[s]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:s===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${d(s)}”`:`${g} dossier${g>1?"s":""} dans « ${d(s)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:s}),children:[(i?"Open ":"Ouvrir ")+d(s)," →"]})]})}function nc(){var Pt,Be,Xe,Ye,ct;const e=Z(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:l,markRow:s,lang:g,sessTally:p,data:x,dossiers:m,source:b,focusExtra:u,byId:w,token:k}=e,f=Ro(),v=c.useMemo(()=>{var te,_,oe,ee;if(!k||b==="ops")return null;const F=(((te=f==null?void 0:f.ed)==null?void 0:te.date)||(f==null?void 0:f.day)||"").slice(0,10),X=[(_=f==null?void 0:f.ed)==null?void 0:_.html,(oe=f==null?void 0:f.ed)==null?void 0:oe.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((ee=f==null?void 0:f.ed)==null?void 0:ee.date)||F,decryptHtml:X||void 0,date:F,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[k,b,g,(Pt=f==null?void 0:f.ed)==null?void 0:Pt.html,(Be=f==null?void 0:f.ed)==null?void 0:Be.acquirers_html,(Xe=f==null?void 0:f.ed)==null?void 0:Xe.date,f==null?void 0:f.day]),j=F=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Fo,[y,N]=c.useState(new Set);c.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[E,S]=c.useState(null);c.useEffect(()=>{S(null)},[a.ptab,a.continent]);const[T,C]=c.useState(!a.mapFolded);c.useEffect(()=>{if(a.mapFolded){C(!1);return}const F=document.getElementById("atl2-stage");if(!F){C(!1);return}const X=new IntersectionObserver(([te])=>C(!!te&&te.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return X.observe(F),()=>X.disconnect()},[a.mapFolded]);const L=!a.mapFolded&&!T,D=F=>N(X=>{const te=new Set(X);return te.has(F)?te.delete(F):te.add(F),te}),H=b==="ops"||o.pipe,[R,O]=c.useState("all"),[h,q]=c.useState(!1),[M,W]=c.useState(null),[z,I]=c.useState(!1),P=c.useRef(!0);c.useEffect(()=>{if(P.current){P.current=!1;return}O("all"),I(!1)},[a.ptab,a.continent]),c.useEffect(()=>{if(!z)return;const F=X=>{var te,_;(_=(te=X.target)==null?void 0:te.closest)!=null&&_.call(te,".atl2 .doable")||I(!1)};return document.addEventListener("click",F,!0),()=>document.removeEventListener("click",F,!0)},[z]);const U=c.useMemo(()=>{var X;const F=new Map;for(const te of Ml(((X=f==null?void 0:f.ed)==null?void 0:X.html)||""))F.has(te.t)||F.set(te.t,te.html);return F},[(Ye=f==null?void 0:f.ed)==null?void 0:Ye.html]),ae=c.useCallback(F=>{if(F.decryptHtml)return F.decryptHtml;if(!U.size)return;const X=(F.name||"").trim().toLowerCase();if(X.length<3)return;const te=U.get(X);if(te)return te;for(const[_,oe]of U)if(_.includes(X)||X.includes(_))return oe},[U]),{diff:$}=Bp(),[le,J]=c.useState(!1),de=a.filters.win==="1"&&!a.filters.day,[he,xe]=c.useState(!1),be=c.useMemo(()=>new Set((($==null?void 0:$.added)||[]).map(F=>F.trim().toLowerCase()).filter(Boolean)),[$]),ve=c.useMemo(()=>{if(!be.size)return 0;const F={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return m.filter(X=>!We(X)&&be.has((X.name||"").trim().toLowerCase())&&oa(X,F,o.pipe)).length},[m,be,a,o.pipe]);c.useEffect(()=>{const F=()=>{xe(!1),q(!1),O("all"),I(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",F),()=>window.removeEventListener("ppmap:tunnel",F)},[]),c.useEffect(()=>{xe(!1),q(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const ye=c.useMemo(()=>{const F=l.filter(te=>!We(te)&&Je(te));let X="";for(const te of F){const _=(te.date||"").slice(0,10);_&&(!X||_<X)&&(X=_)}return{n:F.length,since:X?X.split("-").reverse().slice(0,2).join("/"):""}},[l]),Te=ye.n,ne=c.useMemo(()=>{const X=he&&be.size>0||a.filters.signalOnly||R!=="all"||h?l:d;let te=Dn(X,a.sort);return te=te.filter(_=>!We(_)),he&&be.size&&(te=te.filter(_=>be.has((_.name||"").trim().toLowerCase()))),h||R==="explore"?te=te.filter(Je):R==="eval"?te=te.filter(_=>!Je(_)&&!_.noCo&&(_.kind==="op"||!Ge(_))):o.pipe&&(te=te.filter(_=>!Je(_))),te},[d,l,a.sort,R,he,be,h,o.pipe]),B=c.useMemo(()=>o.pipe?m.filter(F=>F.kind==="target"&&!We(F)&&$e(F)&&(a.continent==="monde"||F.continent===a.continent)):ne.filter(F=>$e(F)&&!Ge(F)),[o.pipe,m,ne,a.continent]).length,V=c.useMemo(()=>o.pipe?ne:ne.filter(F=>!Ge(F)&&!F.noCo&&!Je(F)),[ne,o.pipe]),Y=b==="ops"?ne.filter(Je).length:0,Q=he?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,se=a.filters,pe=se.sector.length+se.market.length+se.country.length+se.engine.length+se.stage.length+se.crible.length+se.angle.length+se.memoLevel.length+se.dealKind.length+(se.signalOnly?1:0)+(se.acquirer.trim()?1:0)+(se.search.trim()?1:0),re=[];if(se.day)re.push({k:"day",lib:n.fDay(se.day.slice(8,10)+"/"+se.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(se.win&&se.win!=="all"){const F=["1","7","30"].indexOf(se.win);F>=0&&re.push({k:"win",lib:n.dates[F],off:()=>r({type:"filters",patch:{win:"all"}})})}const ue=F=>F.length<=2?F.join(", "):`${F.length} ${n.fSelected}`;for(const F of["sector","market","country","engine","crible"]){const X=se[F];X&&X.length&&re.push({k:F,lib:ue(X),off:()=>r({type:"clearFacet",facet:F})})}se.search&&re.push({k:"search",lib:"🔍 "+se.search,off:()=>r({type:"filters",patch:{search:""}})}),he&&be.size&&re.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>xe(!1)}),se.signalOnly&&re.push({k:"sig",lib:"🔴 "+n.sigDock(B||se.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const ce=(F,X,te="",_=!1)=>t.jsxs("button",{type:"button","data-s":F,className:te,"aria-sort":a.sort.key===F?a.sort.dir===1?"ascending":"descending":"none",style:_?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:F}),children:[X,t.jsx("span",{className:"ar",children:a.sort.key===F&&a.sort.dir===1?"▴":"▾"})]},F),we=c.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const F=new Map;ne.forEach(_=>{const oe=_.engine||"?";F.has(oe)||F.set(oe,[]),F.get(oe).push(_)});const X={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},te=un([...F.keys()],g);return[...F.entries()].sort((_,oe)=>{const ee=X[_[0]]??10+te.indexOf(_[0]),me=X[oe[0]]??10+te.indexOf(oe[0]);return ee-me})},[ne,o.pipe,a.groupBy,g]),qe=we?we.filter(([F])=>Na.has(F)).length:0,De=(()=>{var X;return((X=(we?we.flatMap(([,te])=>te):ne)[0])==null?void 0:X.id)??null})(),Pe=c.useRef(!1),Ee=c.useMemo(()=>m.find(We)||v,[m,v]),[Dt,Ct]=c.useState(!1);c.useEffect(()=>{const F=()=>{Pe.current=!0,xe(!1)};return window.addEventListener("ppmap:reveal",F),window.addEventListener("ppmap:focus",F),()=>{window.removeEventListener("ppmap:reveal",F),window.removeEventListener("ppmap:focus",F)}},[]),c.useEffect(()=>{const F=()=>{Ee&&r({type:"focus",id:Ee.id})};return window.addEventListener("ppmap:edito",F),()=>window.removeEventListener("ppmap:edito",F)},[Ee,r]),c.useEffect(()=>{if(!a.focusId)return;W(a.focusId);const F=window.setTimeout(()=>W(null),900);return()=>window.clearTimeout(F)},[a.focusId]),c.useEffect(()=>{if(H&&!(a.focusId&&(ne.some(F=>F.id===a.focusId)||m.some(F=>F.id===a.focusId)||a.focusId===(Ee==null?void 0:Ee.id)))&&!u){if(Ee){r({type:"focus",id:Ee.id});return}De&&r({type:"focus",id:De})}},[H,a.focusId,ne,De,u,r,m,b,Ee]),c.useEffect(()=>{if(!H||!a.focusId||Ee&&a.focusId===Ee.id||ne.some(X=>X.id===a.focusId))return;const F=m.find(X=>X.id===a.focusId);if(F){if(Pe.current){F.kind==="op"?O(Je(F)?"explore":"eval"):R!=="all"&&O("all");return}R!=="all"&&De&&r({type:"focus",id:De})}},[H,a.focusId,R,ne,m,De,r,Ee]),c.useEffect(()=>{if(!H||!a.focusId||!Pe.current)return;const F=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!F){const oe=ne.findIndex(ee=>ee.id===a.focusId);if(oe>=0){const ee=we?"":"pt"+a.ptab;if(ee){const me=a.shown[ee]||j();oe>=me&&r({type:"more",group:ee,by:oe-me+8})}}return}Pe.current=!1;const X=hi(),te=F.getBoundingClientRect();te.top>=X-2&&te.bottom<=window.innerHeight-4||Wp(F)},[H,a.focusId,a.ptab,ne,a.shown,we,r]),c.useEffect(()=>{if(typeof window>"u")return;const F=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),X=document.querySelector(".atl2.ops, .atl2.cibles");if(!F||!X)return;const te=()=>X.style.setProperty("--listhead-h",`${F.offsetHeight}px`);te();const _=new ResizeObserver(te);return _.observe(F),()=>_.disconnect()},[L,a.dens,a.mapFolded]);const _e=c.useMemo(()=>{if(!H||!a.focusId)return null;if(v&&a.focusId===v.id)return v;const F=ne.find(te=>te.id===a.focusId)||m.find(te=>te.id===a.focusId)||null;if(!F)return null;const X=ae(F);return X&&X!==F.decryptHtml?{...F,decryptHtml:X}:F},[H,a.focusId,ne,m,ae,v]),lt=o.lockRowsAfter;let ht=0;const zt=(F,X)=>{let te=a.shown[X]||j();return F.length-te<=4&&(te=F.length),F.slice(0,te).map(ee=>{const me=lt!==null&&ht>=lt;ht++;const Ne=ae(ee),ge=Ne&&Ne!==ee.decryptHtml?{...ee,decryptHtml:Ne}:ee,Fe=!H&&a.dens!=="maxi"&&(a.dens==="deplie"||(E?E==="open":!!Ne)),ze=y.has(ee.id)?!Fe:Fe,nt=H?xt=>{Pe.current=!0,r({type:"focus",id:xt});const Ze=w.get(xt);Ze&&(Je(Ze)?ca(Ze):Ze.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ze.name,url:Ze.url||"",website:Ze.website||"",domain:Ze.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(ec,{o:ge,locked:me,selected:H&&a.focusId===ee.id,onSelect:nt},ee.id):t.jsx(Qp,{o:ge,locked:me,open:ze,onToggle:()=>D(ee.id),selected:H&&a.focusId===ee.id,echo:M===ee.id,fresh:be.has((ee.name||"").trim().toLowerCase()),onSelect:nt},ee.id)})},at="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ne.length?"":" list-empty"),At=t.jsxs(t.Fragment,{children:[we?we.map(([F,X])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Lt(F)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:F==="ma"?n.grpMa:F==="fundraising"?n.grpLev:Na.has(F)&&qe<=1?n.grpNews:F==="nominations"?n.grpNom:F==="media"?n.grpNewsOther:F==="recrutements"?n.grpHire:Na.has(F)?n.grpNews+" · "+tt(F,g):tt(F,g)}),t.jsx("div",{className:"s",children:n.grpCount(X.filter(te=>!Ge(te)).length,X.length)})]})]}),zt(X,F)]},F)):zt(ne,"pt"+a.ptab),x.loading&&!m.length&&t.jsx(tc,{}),o.pipe&&a.ptab===0&&!h&&!he&&R==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(rp,{}),!ne.length&&!(x.loading&&!m.length)&&(o.pipe&&R==="all"?t.jsx(ac,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(se.win!=="all"||!!se.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),pe>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(pe)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),gt=t.jsxs(t.Fragment,{children:[!he&&!h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ra[a.ptab]+")"},children:ne.length})," ",Q]}),h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ra[a.ptab]+")"},children:ne.length})," ",n.newsWord]}),(!he||h)&&t.jsx("span",{className:"dot",children:"·"}),L&&t.jsx(si,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[L?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),re.map(F=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:X=>{X.stopPropagation(),F.off()},children:[F.lib,t.jsx("i",{children:"×"})]},F.k)),b==="ops"&&ne.length>0&&!L&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ne.length-Y," ",n.zoomPulseEval,Y>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",Y," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),It=t.jsxs("div",{className:"listhead"+(L?" mapoff":""),children:[L&&t.jsx("div",{className:"lh-tools",children:t.jsx(ii,{compact:!0})}),o.showFunnel&&le&&de&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(td,{}),t.jsx(Hp,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:gt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx($p,{}),t.jsx(Up,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(de?" on":""),"aria-pressed":de,title:n.morningDockTitle,onClick:()=>{if(de){r({type:"filters",patch:{win:"all",day:""}}),J(!1);return}xe(!1),q(!1),O("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),J(!0)},children:["📊 ",n.morningDock(typeof((ct=x.stats)==null?void 0:ct.screened_today)=="number"?x.stats.screened_today:0)]}),$&&!$.firstVisit&&($.added.length>0||$.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(he?" on":""),"aria-pressed":he,title:n.sinceSub,onClick:()=>{const F=!he;xe(F),q(!1),J(!1),O("all"),F&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(ve),$!=null&&$.lastDate?` · ${n.sinceSince($.lastDate)}`:""]}),B>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{xe(!1),q(!1),J(!1),O("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(B)]}),o.pipe&&Te>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(h?" on":""),"aria-pressed":h,title:n.newsDockHint,onClick:()=>{const F=!h;q(F),xe(!1),J(!1),O("all"),F&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(Te),ye.since?` · ${n.newsSince(ye.since)}`:""]})]}),!o.showFunnel&&gt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([F,X])=>t.jsxs("button",{type:"button","data-d":F,"aria-pressed":a.dens===F||F==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:F}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:X})]},F))}),!H&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":E==="open",onClick:()=>{S("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":E==="closed",onClick:()=>{S("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var Ne;const F={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},X=m.filter(ge=>oa(ge,F,o.pipe)&&!We(ge)),te=X.filter(ge=>!Je(ge)&&!ge.noCo&&(ge.kind==="op"||!Ge(ge))).length,_=X.filter(Je).length,oe=o.pipe?X.filter(ge=>ge.kind!=="op"&&Ae(ge)===1).length:0,ee=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${oe?` ${oe}`:""}`]]:[],["eval",`${n.doEval}${te?` ${te}`:""}`],["explore",`${n.doExplore}${_?` ${_}`:""}`]],me=((Ne=ee.find(([ge])=>ge===R))==null?void 0:Ne[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":z,onClick:()=>I(ge=>!ge),children:[me,t.jsx("i",{children:"▾"})]}),z&&t.jsx("div",{className:"dolist",children:ee.map(([ge,Fe])=>t.jsx("button",{type:"button","aria-pressed":R===ge,onClick:()=>{if(I(!1),ge==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}O(ge),ge!=="all"&&(xe(!1),q(!1),J(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:Fe},ge))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:F=>r({type:"sort",key:F.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([F,X])=>t.jsx("option",{value:F,children:X},F))})]}),o.showChain&&V.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:V.map(F=>F.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(V.length):n.chainAll(V.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!H&&It,a.dens!=="maxi"&&!H&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ce("country",n.colCountry),ce("name",n.colCompany),ce("amount",n.colAmount,"h-amt",!0),ce("stage",n.colStage,"h-stade"),ce("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ce("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ce("memo",n.colMemo)]}),o.pipe&&ce("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),H?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[It,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ce("country",n.colCountry),ce("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ce("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ce("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:at,children:At})]}),t.jsxs("aside",{className:"readpane"+((_e?We(_e):!u&&Ee)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[Ee&&(()=>{const F=a.focusId===Ee.id&&!Dt,X=(Ee.headline||Ee.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":F,onClick:()=>{if(F){Ct(!0);return}Ct(!1),r({type:"focus",id:Ee.id})},children:[t.jsx("span",{className:"eg-t",children:g==="en"?"Today’s editorial":"Édito du jour"}),X&&t.jsx("span",{className:"eg-sub",children:X}),t.jsx("span",{className:"eg-chev",children:F?g==="en"?"Collapse ▴":"Replier ▴":g==="en"?"Read ▾":"Lire ▾"})]})})(),v&&a.focusId===v.id&&Dt?null:v&&a.focusId===v.id?t.jsx("div",{className:"zoom",children:t.jsx(Bl,{})}):_e&&o.pipe?t.jsx(Xp,{o:_e}):t.jsx(gi,{o:_e,extra:_e?null:u})]})]}):t.jsx("div",{className:at,children:At}),(()=>{const F=we||[["pt"+a.ptab,ne]];let X=0,te=0;for(const[oe,ee]of F){te+=ee.length;let me=a.shown[oe]||j();ee.length-me<=4&&(me=ee.length),X+=Math.min(ee.length,me)}const _=te-X;return _<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>F.forEach(([oe,ee])=>r({type:"more",group:oe,by:ee.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(_,_)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(X,te)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}}),H&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Vp,{on:!!we,rev:(we||[]).map(([F,X])=>F+X.length).join("|")})]})}function co(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function rc(e,a){const r=ks(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function oc(e,a){const n=[a.head.split("|").map(co).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",rc(o,a.plabels),ua(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(co).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function ic(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const sc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Qe({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function Jt({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function lc({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=Z(),d=(e.cribleStatus||"").trim().toUpperCase()||(ua(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=St(e),s=(a==null?void 0:a.blocs)||{},g=[[n.qaVP,s.value_prop],[n.qaProduct,s.produit],[n.qaModel,s.modele],[n.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Qe,{k:n.cdSector,v:e.sector}),t.jsx(Qe,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(Qe,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(Qe,{k:n.cdStage,v:e.stage}),t.jsx(Qe,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Qe,{k:n.cdSite,v:e.domain||e.website}),t.jsx(Qe,{k:n.cdName,v:e.contactName}),t.jsx(Qe,{k:n.cdEmail,v:e.contactEmail}),t.jsx(Qe,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Qe,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Qe,{k:n.cdAngle,v:e.angle}),t.jsx(Qe,{k:n.cdDetected,v:sc(e.date,o)})]}),!!(e.provQuery||e.provUrl||qa(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(Qe,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(Qe,{k:n.cdSrc,v:Tn(e.provUrl||""),href:pa(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(Qe,{k:n.cdAngleSrc,v:qa(e)})]})]}),g.some(([,p])=>p)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),g.filter(([,p])=>p).map(([p,x])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:p}),t.jsx("p",{children:x})]},p))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([p,x,m])=>t.jsxs("div",{className:"dssq "+p,children:[t.jsx("b",{children:x}),t.jsx("ul",{children:m.map(b=>t.jsx("li",{children:b},b))})]},p))})]}),t.jsx(Jt,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function dc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d,st:l}=Z(),[s,g]=c.useState({}),[p,x]=c.useState({}),m=25,b=12,u=c.useMemo(()=>{if(l.dossierId){const f=n.find(v=>v.id===l.dossierId)||i.dossiers.find(v=>v.id===l.dossierId);return f?[f]:n.slice(0,m)}return n.slice(0,m)},[n,l.dossierId,i.dossiers]);c.useEffect(()=>{u.length&&Eo(r,u.map(f=>f.name)).then(g)},[r,u]),c.useEffect(()=>{const f=u.filter(y=>!!y.memoUrl).slice(0,b);if(!f.length){x({});return}let v=!1;const j={};return(async()=>{for(const y of f){if(v)return;try{const N=await mi(y.memoUrl||"");if(v)return;N&&zp(N.comite)&&(j[y.id]=N.comite,x({...j}))}catch{}}})(),()=>{v=!0}},[u]);const w=i.stats,k=f=>f.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(u.length)}),!l.dossierId&&n.length>m&&t.jsx("span",{className:"mnote dim",children:e.dsCap(m,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),w&&typeof w.screened=="number"&&t.jsxs("p",{children:[k(w.screened)," ",e.funScreened(""),typeof w.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",k(w.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(k(i.marketEstimate)),", ",Math.round(w.screened/i.marketEstimate*100)," %"]})]})]}),u.map(f=>t.jsx(lc,{o:f,qa:s[f.name],comite:p[f.id]},f.id)),!u.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const pc=50;function Wn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Z(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(""),[x,m]=c.useState(0),[b,u]=c.useState(""),[w,k]=c.useState(!1),[f,v]=c.useState(0),j=c.useRef(null),y=c.useRef(null),N=()=>{v(0),y.current&&window.clearInterval(y.current),y.current=window.setInterval(()=>v(C=>C+1),1e3)},E=()=>{y.current&&(window.clearInterval(y.current),y.current=null)};c.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),y.current&&window.clearInterval(y.current)},[]);const S=async C=>{s(!0),p(""),N();const L=await a();if(s(!1),E(),L.ok){d(L);return}if(L.busy){p(o.alertPreviewBusy);return}if(!C){p(o.alertPreviewFail);return}m(pc),E(),j.current=window.setInterval(()=>{m(D=>D>1?D-1:(j.current&&window.clearInterval(j.current),S(!1),0))},1e3)},T=async()=>{if(n||w||l)return;k(!0),u(""),N();const C=await r();k(!1),E(),u(C.ok?o.alertTestOk(C.sentTo||""):C.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||w||x>0,onClick:()=>{S(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||w||l,onClick:()=>{T()},children:w?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),w&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const wt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ke({title:e,icon:a,children:r,wide:n,kind:o,lead:i}){const{dispatch:d}=Z(),l=o==="plug"?"min(720px,100%)":"min(760px,100%)";return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:s=>{s.target===s.currentTarget&&d({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard"+(o?" m-"+o:""),style:n?{width:l}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsxs("div",{className:"mh-txt",children:[t.jsx("h2",{children:e}),i&&t.jsx("p",{className:"mh-lead",children:i})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>d({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function cc(){const{st:e}=Z();switch(e.modal){case"chain":return t.jsx(mc,{});case"space":return t.jsx(fc,{});case"alert":return t.jsx(hc,{});case"queue":return t.jsx(yc,{});case"export":return t.jsx(wc,{});case"plug":return t.jsx(Ec,{});case"approach":return t.jsx(Nc,{});case"recharge":return t.jsx(zc,{});case"cover":return t.jsx(qc,{});case"dossier":return t.jsx(Ac,{});case"crit":return t.jsx(Rc,{});case"tuto":return t.jsx(Oc,{});case"rdv":return t.jsx(uc,{});case"memoalert":return t.jsx(kc,{});default:return null}}function uc(){const{dispatch:e,fund:a,t:r}=Z(),n=a||r.rdvCoFallback;return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Io,children:Pn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Ks,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function mc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:l,caps:s,memoQueued:g,doAnalyse:p}=Z(),x=i==="client",m=e.chain.queue.map(k=>r.get(k)).filter(k=>!!k),b=e.chain.idx,u=m[b],w=b>=m.length;return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:w?n.finished:`${b+1} / ${m.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(w?100:b/Math.max(1,m.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:w||!u?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(m.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:u.name}),t.jsx("div",{className:"sub",children:[Gt(u.cc,o)||u.countryLabel,u.sector,u.stage,n.daysAgo(kt(u.date))].filter(Boolean).map(k=>String(k)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:tt(u.engine,o)}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{children:Yt(u.amountEur,o)})]}),$e(u)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Nt,{o:u,lg:!0})," ",t.jsx(Va,{o:u,src:!0})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&!(x&&Ge(u))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),x&&Ge(u)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Tt(u)==="retenu"?"var(--brand)":Tt(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Tt(u)==="retenu"?"✓ "+n.kept:Tt(u)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!w&&u&&s.pipe&&Ae(u)===1&&!g.has(u.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{p(u),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!w&&u&&!(x&&Ge(u))&&(u.noCo&&u.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var k;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"modal",modal:null}),(k=document.querySelector(".atl2 .demand"))==null||k.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{d(u)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(w?{type:"modal",modal:null}:{type:"chainNext"}),children:w?n.closeBtn:n.skip})]})]})})}),document.body)}function fc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Z(),i=o==="client",d=c.useMemo(()=>i?r.filter(x=>Ge(x)):[],[r,i]),l=c.useMemo(()=>Dn(d.filter(x=>Tt(x)==="retenu"),{key:"signal",dir:-1}),[d]),s=c.useMemo(()=>d.filter(x=>Tt(x)==="ecarte"),[d]),g=e.spaceTab==="retenu"?l:s,p=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ke,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:s.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":p},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function hc(){const{mode:e}=Z();return e==="client"||e==="apercu"?t.jsx(gc,{}):t.jsx(vc,{})}function gc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Z(),[i,d]=c.useState("d"),l=o!=="client";return t.jsxs(Ke,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(xc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(bc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(xi,{})]})}function xc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(0);c.useEffect(()=>{let T=!0;return s(!1),ur(a).then(C=>{T&&(C?d(C):s(!0))}),()=>{T=!1}},[a,g]);const x=c.useRef({}),[m,b]=c.useState({}),[u,w]=c.useState(!1),[k,f]=c.useState(!1),v=c.useRef(null);c.useEffect(()=>()=>{v.current&&window.clearTimeout(v.current)},[]);const j=T=>{const C=x.current;Object.keys(C).length&&(w(!0),ur(a,C).then(L=>{if(!L){w(!1),o(e.actErr);return}if(L.throttled&&T<3){v.current=window.setTimeout(()=>j(T+1),5400);return}if(x.current={},b({}),d(L),w(!1),L.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},y=T=>{r||(x.current={...x.current,...T},b(C=>({...C,...T})),v.current&&window.clearTimeout(v.current),v.current=window.setTimeout(()=>j(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(T=>T+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...m},E=T=>!N.sections||N.sections.includes(T),S=T=>{const C=N.sections||e.alertSec.map(([L])=>L);y({sections:E(T)?C.filter(L=>L!==T):[...C,T]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>y({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>y({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>y({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>y({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>y({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,u&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!u&&k&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([T,C])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:E(T),disabled:r,onChange:()=>S(T)}),t.jsxs("span",{children:[C,T==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},T))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Wn,{label:e.alertPreview,readOnly:r,onPreview:()=>Os(a),onTest:()=>Rs(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function bc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(0);c.useEffect(()=>{let u=!0;return s(!1),mr(a).then(w=>{u&&(w?d(w):s(!0))}),()=>{u=!1}},[a,g]);const x=u=>{r||mr(a,u).then(w=>{if(!w){o(e.actErr);return}d(w),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(u=>u+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:m,disabled:r,onChange:u=>x({dow:Number(u.target.value)}),children:e.alertDow.map((u,w)=>t.jsx("option",{value:w,children:u},u))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Wn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Ds(a),onTest:()=>Ms(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function xi(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Z(),[d,l]=c.useState(i||""),[s,g]=c.useState(!1),[p,x]=c.useState(!1);c.useEffect(()=>{i&&l(i)},[i]);const m=e.filters,b=c.useMemo(()=>n.filter(f=>$e(f)).length,[n]),u=m.win==="1"?0:m.win==="7"?1:m.win==="30"?2:3,w=async()=>{if(!(!/.+@.+\..+/.test(d)||p)){x(!0);try{await fetch(`${Ha}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:m.sector,countries:m.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},k=[[a.amRows.continent,o],[a.amRows.since,a.amSince[u]],[a.amRows.signal,m.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,m.engine.length?m.engine.map(f=>tt(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,m.sector.length?m.sector.join(", "):a.amAllSectors],[a.amRows.countries,m.country.length?m.country.map(f=>Gt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,m.stage.length?m.stage.join(", "):a.amAllStages]];return s?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:k.map(([f,v])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:v}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function vc(){const{t:e}=Z();return t.jsx(Ke,{title:e.alertTitle,icon:"🔔",children:t.jsx(xi,{})})}function yc(){var D,H;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:l,dispatch:s,liveMemos:g}=Z(),[p,x]=c.useState(()=>Ya(r)),[m,b]=c.useState(()=>!Ya(r)),[u,w]=c.useState([]),[k,f]=c.useState(0),v=n==="client",j=c.useMemo(()=>{const R=new Map;return o.forEach(O=>{const h=(O.name||"").trim().toLowerCase();h&&!R.has(h)&&R.set(h,O)}),R},[o]);c.useEffect(()=>{let R=!0;return(!Ya(r)||k>0)&&b(!0),(async()=>{const[O,h]=await Promise.all([Fn(r,k>0),bo(a)]);R&&(O&&x(O),b(!1),w(h))})(),()=>{R=!1}},[a,r,k]);const y=m&&!p,N=(p==null?void 0:p.per_day)??0,E=((D=p==null?void 0:p.analyzed_today)==null?void 0:D.length)??0,S=p==null?void 0:p.offre,T=(p==null?void 0:p.pool_meta)||[],C=c.useMemo(()=>{const R=new Map;for(const O of(p==null?void 0:p.scheduled)||[])for(const h of O.names||[])R.has(h)||R.set(h,{label:O.day_label,date:O.date});return R},[p==null?void 0:p.scheduled]),L=(p==null?void 0:p.in_progress)||[];return t.jsxs(Ke,{title:e.queueTitle,wide:!0,children:[S&&t.jsxs("div",{className:"qoffre"+(S.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:S.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:S.delai})]}),t.jsx("span",{className:"osp"}),S.rythme>0?t.jsx("span",{className:"or",children:e.qRate(S.rythme)}):S.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(S.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:y?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(E,E+(((H=p==null?void 0:p.pool_order)==null?void 0:H.length)??0))}})}),S&&t.jsxs("div",{className:"qeta",children:[S.file===0?e.qEtaDone:S.rythme<=0?e.qEtaPaused:e.qEta(S.file,S.rythme,S.jours_restants),S.en_retard&&t.jsxs("em",{children:[" ",e.qLate(S.delai,S.plafond)]})]}),!y&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(S==null?void 0:S.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(L.length>0||g.items.some(R=>R.status==="boot"||R.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(R=>R.status==="boot"||R.status==="running"||R.status==="error").map(R=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:R.name}),t.jsx("span",{className:"qd",children:R.memoType||""}),t.jsx(Ta,{item:R,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+R.name)),L.filter(R=>!g.liveOf(R.name)).map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.name}),t.jsxs("span",{className:"qd",children:[R.memo_type||"",R.age_min?` · ${Math.round(R.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:R.state||""})]},"ip-"+R.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.company}),t.jsxs("span",{className:"qd",children:[R.memo_type,typeof R.est_min=="number"?` · ~${R.est_min} min`:""]}),t.jsx("span",{className:"qt",children:R.status}),R.url&&t.jsx("a",{className:"qgo",href:R.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(R.memo_type)}),v&&R.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{pr(a,R.company,"retry").then(()=>f(O=>O+1))},children:e.queueRetry}),v&&R.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{pr(a,R.company,"delete").then(()=>f(O=>O+1))},children:e.queueDelete})]},R.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",y?e.qUpNextWait:e.qUpNext(T.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[y&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!y&&T.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),T.map((R,O)=>{const h=C.get(R.name),q=j.get((R.name||"").trim().toLowerCase()),M=g.liveOf(R.name),W=!!(q&&d.has(q.id))||!!(M&&(M.status==="boot"||M.status==="running")),z=!!(q&&Ae(q)===1&&!q.memoUrl)&&!M;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",O+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:R.name}),R.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof R.score=="number"&&t.jsx("span",{className:"qs2",children:R.score}),M&&(M.status==="boot"||M.status==="running")&&t.jsx(Ta,{item:M,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),z&&(l.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>s({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:W,onClick:()=>{i(q),f(I=>I+1)},children:W?e.actAnalyseQueued:e.actAnalyse})),R.excerpt&&t.jsx("span",{className:"qex",children:R.excerpt})]},R.name+":"+O)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([R,O])=>t.jsxs("li",{children:[t.jsx("b",{children:R})," — ",O]},R))})]})}function wc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=Z(),l=`${wt}/cibles/list.csv?token=${a}`,s=`${wt}/cibles/list.json?token=${a}`,g=`${wt}/cibles/export.xlsx?token=${a}&scope=full`,p=`=IMPORTDATA("${l}")`,x=k=>{var f;(f=navigator.clipboard)==null||f.writeText(k).then(()=>r(e.exportCopied))},m=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:p},{def:e.exportLive,value:s,href:s},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,u=()=>{ic(oc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:k=>(e.stg.find(([f])=>f===k)||["",""])[1]})),r(e.exportViewDone(n.length))},w=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ke,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:w,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:u,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:m.map(({def:k,value:f,href:v})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:k[0]}),t.jsxs("div",{children:[t.jsx("b",{children:k[1]}),t.jsx("p",{children:k[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),v&&t.jsx("a",{className:"exb",href:v,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},k[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function kc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Z(),i=o!=="client",[d,l]=c.useState(null),[s,g]=c.useState(!1),[p,x]=c.useState(0),[m,b]=c.useState(!1);c.useEffect(()=>{let f=!0;return g(!1),lr(a).then(v=>{f&&(v?l(v):g(!0))}),()=>{f=!1}},[a,p]);const u=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},w=f=>{if(i||!d)return;const v={enabled:f.enabled??!!d.enabled,email:f.email??(d.email||""),sections:f.sections??u()};b(!0),lr(a,v).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}l(j),r(e.memoAlertSaved)})};if(s)return t.jsx(Ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!d)return t.jsx(Ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const k=u();return t.jsxs(Ke,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||m,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(jc,{value:d.email||"",readOnly:i||m,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>w({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!k[f],disabled:i||m,onChange:()=>w({sections:{...k,[f]:!k[f]}})}),t.jsx("span",{children:v})]},f))}),t.jsx(Wn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Es(a,k),onTest:()=>js(a,k)})]})}function jc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=c.useState(e);c.useEffect(()=>{d(e)},[e]);const l=i.trim()!==e.trim(),s=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>d(g.target.value),onKeyDown:g=>{g.key==="Enter"&&l&&s&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!s,onClick:()=>o(i.trim()),children:n})]})]})}function Ec(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Z(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(null),[x,m]=c.useState(!1),[b,u]=c.useState(""),[w,k]=c.useState(0),[f,v]=c.useState("webhook"),[j,y]=c.useState("webhook"),[N,E]=c.useState(""),S=c.useRef(!1);c.useEffect(()=>{let M=!0;return s(!1),dr(a).then(W=>{M&&(W?d({configured:W.configured,url_hint:W.url_hint}):s(!0))}),zs(a).then(W=>{if(M){if(!W){m(!0);return}m(!1),p(W),S.current||(S.current=!0,W.destination==="instantly"&&(v(z=>z==="webhook"?"instantly":z),y(z=>z==="webhook"?"instantly":z)),W.campaign_id&&E(z=>z||W.campaign_id||""))}}),()=>{M=!1}},[a,w]);const T=(M,W)=>{o&&dr(a,M).then(z=>{if(!z||z.ok===!1){n(e.actErr);return}M.test&&z.sent===!1?n(e.plugTestThrottled):r(W),k(I=>I+1)})},C='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',L=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),D=`curl -X POST ${wt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,H=`curl -X POST ${wt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`,R=[{k:"webhook",t:e.plugDestCrm,s:e.plugDestCrmS},{k:"instantly",t:e.plugDestInst,s:e.plugAideInst},{k:"script",t:e.plugDestScript,s:e.plugDestScriptS}],O=j==="instantly"?e.plugStep2Inst:j==="script"?e.plugStep2Script:e.plugStep2Wh,h=j==="instantly"?e.plugAideInst:j==="script"?e.plugAideScript:e.plugAideWh,q=M=>{y(M),M!=="script"&&v(M)};return t.jsxs(Ke,{title:e.plugTitle,icon:"🔌",wide:!0,kind:"plug",lead:e.plugLead,children:[g&&t.jsxs("div",{className:"plugetat"+(g.enabled?" on":""),children:[t.jsx("i",{}),t.jsx("b",{children:g.enabled?e.plugEtatOn:e.plugEtatOff})]}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>k(M=>M+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"1"}),t.jsx("h4",{children:e.plugStep1})]}),t.jsx("div",{className:"plugdests",children:R.map(M=>{const W=j===M.k;return t.jsxs("button",{type:"button",className:"plugdest"+(W?" on":""),onClick:()=>q(M.k),children:[t.jsx("span",{className:"pradio","aria-hidden":"true"}),t.jsx("b",{children:M.t}),t.jsx("em",{children:M.s})]},M.k)})}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"2"}),t.jsx("h4",{children:O})]}),j==="script"?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:D}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(D).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}):j==="instantly"?t.jsx("div",{className:"mfield pill",children:t.jsx("input",{type:"text",maxLength:80,placeholder:e.plugCampPh,value:N,disabled:!o,onChange:M=>E(M.target.value)})}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"mfield pill",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:M=>u(M.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>T({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>T({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>T({remove:!0},e.plugRemoved),children:e.plugRemove})]})]}),t.jsx("p",{className:"mnote dim",children:h}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"3"}),t.jsx("h4",{children:e.plugStep3})]}),t.jsx(Sc,{auto:g,autoKo:x,destKind:f,camp:N,onRetry:()=>k(M=>M+1),onDone:M=>{p(M),m(!1)}}),t.jsx("p",{className:"mnote dim",children:e.plugHow3}),t.jsxs("details",{className:"plugex plugpay",children:[t.jsxs("summary",{children:[t.jsx("b",{children:e.plugExT}),t.jsx("span",{children:e.plugPayloadSub})]}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult}),t.jsx("p",{className:"mnote dim",children:e.plugVars})]}),t.jsx("div",{"data-tour":"plug-bulk",children:t.jsx(Cc,{destKind:f,setDestKind:M=>{v(M),y(M)},camp:N,setCamp:E,whHint:i!=null&&i.configured?i.url_hint||"webhook":null})}),j!=="script"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:D}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(D).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:C}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(C).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm","data-tour":"plug-crm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:H}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(H).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Nc(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:l}=Z(),s=c.useMemo(()=>r.find(h=>h.id===n.approachId)||null,[r,n.approachId]),[g,p]=c.useState("email"),[x,m]=c.useState(0),[b,u]=c.useState({}),[w,k]=c.useState(!1),[f,v]=c.useState(""),[j,y]=c.useState({});if(c.useEffect(()=>{!s||b[g]||w||(k(!0),v(""),Cs(a,s.name,g).then(h=>{if(k(!1),!h||h.ok===!1){v((h==null?void 0:h.error)||e.apprFail);return}u(q=>({...q,[g]:h}))}))},[s,g,a]),!s)return null;const N=b[g],E=(N==null?void 0:N.sequence)||[],S=E[x],T=h=>`${g}|${x}|${h}`,C=h=>{const q=T(h);return q in j?j[q]:String(((S==null?void 0:S[h])??"")||"")},L=(h,q)=>y(M=>({...M,[T(h)]:q})),D=T("subject")in j||T("body")in j||T("message")in j,H=C(g==="email"?"body":"message"),R=C("subject"),O=g==="email"&&R?`${R}

${H}`:H;return t.jsxs(Ke,{title:e.apprT(s.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(h=>t.jsx("button",{type:"button",className:"apch"+(g===h?" on":""),"aria-pressed":g===h,onClick:()=>{p(h),m(0)},children:h==="email"?e.apprChEmail:e.apprChLi},h)),t.jsx("span",{className:"sp"}),E.map((h,q)=>t.jsxs("button",{type:"button",className:"apday"+(x===q?" on":""),"aria-pressed":x===q,onClick:()=>m(q),children:[h.day||`J${q}`,[`${g}|${q}|subject`,`${g}|${q}|body`,`${g}|${q}|message`].some(M=>M in j)&&t.jsx("i",{children:"✎"})]},h.day||q))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,N!=null&&N.sender?" · "+e.apprSender(N.sender):""]}),w&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!f&&!w&&t.jsxs("p",{className:"mnote warn",children:[f," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{u(h=>{const q={...h};return delete q[g],q}),v("")},children:e.retry})]}),!w&&!f&&!S&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),S&&t.jsxs(t.Fragment,{children:[g==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:R,onChange:h=>L("subject",h.target.value)})]}),g==="linkedin"&&x===0&&(N==null?void 0:N.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:H,onChange:h=>L(g==="email"?"body":"message",h.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var h;(h=navigator.clipboard)==null||h.writeText(O).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),g==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(s.contactEmail||"")}?subject=${encodeURIComponent(R)}&body=${encodeURIComponent(H)}`,children:e.apprMailto}),D&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Sc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:l,flash:s,flashErr:g,canWrite:p}=Z(),[x,m]=c.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,u=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),w=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,k=()=>{if(x||!p||u)return;m(!0),(b?cr(l,!1):cr(l,!0,r,n.trim()||void 0)).then(v=>{if(m(!1),!v){g(d.actErr);return}o(v),s(v.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!p||!!u,title:u||void 0,onClick:k,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),u===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:u}),w&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function Cc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:l,canWrite:s}=Z(),[g,p]=c.useState("valides"),[x,m]=c.useState(!1),[b,u]=c.useState(null),[w,k]=c.useState(null),[f,v]=c.useState(!1),[j,y]=c.useState(!1),[N,E]=c.useState(null),[S,T]=c.useState(null),C=`atl2:bulk:${d}:${g}:${e}`;c.useEffect(()=>{u(null),k(null),v(!1),E(null);try{const I=localStorage.getItem(C)||localStorage.getItem(`atl2:bulk:${d}:${g}`),P=JSON.parse(I||"null");T(P&&Date.now()-Date.parse(P.t)<24*3600*1e3?P:null)}catch{T(null)}},[C,g,d]);const L=e==="instantly"&&!r.trim(),D=`${g}|${e}|${r.trim()}`,H=async()=>{if(L||!s)return;m(!0),v(!1),E(null);const I=await Ls(d,g,e,r.trim()||void 0);u(I),k(I.ok?D:null),m(!1)},R=c.useRef(!1);if(!s)return null;const O=async()=>{if(R.current||!s)return;R.current=!0,y(!0);const I=`${d}:${g}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let P;try{P=await Fs(d,g,e,r.trim()||void 0,I)}finally{R.current=!1}if(y(!1),v(!1),E(P),P.ok&&(P.pushed||0)>0){const U={t:new Date().toISOString(),n:P.pushed||0};T(U);try{localStorage.setItem(C,JSON.stringify(U))}catch{}}};f&&w!==null&&w!==D&&v(!1);const h=o,q=b!=null&&b.ok&&b.ready||0,M=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":h||"",W=!!(b!=null&&b.ok)&&w===D&&q>0&&!!M&&!S,z=S?new Date(S.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:g,onChange:I=>p(I.target.value),children:i.plugBulkTabs.map(([I,P])=>t.jsx("option",{value:I,children:P},I))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:I=>a(I.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:I=>n(I.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||L,onClick:()=>{H()},children:x?"…":i.plugBulkPreview})]}),L&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),S&&t.jsx("p",{className:"mnote",children:i.bulkLocked(z,S.n)}),!S&&!!(b!=null&&b.ok)&&!M&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!S&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),W&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>v(!0),children:i.bulkArm}),W&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(q,M)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:j,onClick:()=>{O()},children:j?i.bulkSending:i.bulkConfirm(M)}),t.jsx("button",{type:"button",className:"abtn",disabled:j,onClick:()=>v(!1),children:i.bulkCancel})]}),N&&(N.ok?N.replayed?t.jsx("p",{className:"mnote",children:N.pending?i.bulkPending:i.bulkReplayed}):(N.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(N.pushed||0,N.linkedinReady||0,N.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:N.error||i.actErr}))]})}function zc(){const{t:e,data:a,lang:r}=Z(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const l=window.location.href.split("?")[0];try{const g=await(await fetch(`${Ha}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ke,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(d.credits,d.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Ac(){const{t:e}=Z();return t.jsx(Ke,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(dc,{})})}function qc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:l}=Z(),[s,g]=c.useState(null),[p,x]=c.useState(!1);c.useEffect(()=>{let C=!0;if(i)return Fn(i).then(L=>{C&&L&&typeof L.per_day=="number"&&g(L.per_day)}),()=>{C=!1}},[i]);const[m,b]=c.useState(null);c.useEffect(()=>{if(!o)return;let C=!0;return Ss(o).then(L=>{C&&b(L)}),()=>{C=!1}},[o]);const u=r.stats,w=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(C=>C.kind==="target"&&Ge(C)).length,k=r.marketEstimate||0,f=k>0?Math.min(100,Math.round(w/k*100)):null,v=(u==null?void 0:u.window_days)||30,j=w>0?w/v:0,y=k>0?Math.max(0,k-w):0,E=k>0&&j>0&&w>=100?Math.round(y/j):null,S=C=>Math.round(C).toLocaleString(a==="en"?"en-US":"fr-FR"),T=C=>{p||!d||(x(!0),vo(o,C).then(L=>{if(x(!1),L===null){l(e.actErr);return}g(L),l(e.alertSaved)}))};return t.jsxs(Ke,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(S(w))}),k>0&&t.jsx("span",{children:e.covOf(S(k))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),E!==null&&t.jsx("p",{className:"mnote",children:e.covEta(E)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(S(j))}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&u.shown!==u.kept&&t.jsxs("span",{children:[t.jsx("b",{children:S(u.shown)})," ",e.funShown]})]}),(m==null?void 0:m.ok)&&(m.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),m.perimetre&&t.jsx("p",{className:"mnote",children:m.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(m.detail||[]).map((C,L)=>t.jsxs("tr",{className:C.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[C.code,C.geo?` · ${C.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof C.n=="number"?S(C.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:C.source}),C.elargi&&t.jsx("em",{children:e.covWide(String(C.demande||""))}),C.erreur&&t.jsx("em",{children:e.covMissing})]})]},L)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:S(m.total||k)})}),t.jsx("td",{className:"mks"})]})]})]}),(m.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((m.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(m.sources||[]).join(" · "),m.calcule_le?` — ${e.covComputedAt(m.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:s===C?"on":"",disabled:p,onClick:()=>T(C),children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function bi(e,a,r){const n=await fetch(`${wt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${wt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Tc(){const{t:e,token:a,canWrite:r}=Z(),[n,o]=c.useState(null),[i,d]=c.useState(""),[l,s]=c.useState(""),[g,p]=c.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,m=c.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const u=JSON.parse(localStorage.getItem(x)||"null");return!!u&&Date.now()-(u.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(c.useEffect(()=>{if(!r)return;let u=!0;return qs(a).then(w=>{u&&o(w)}),()=>{u=!1}},[a,r]),!r||g||m||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),bi(a,n.instruction||"","atelier2-avis").then(u=>{if(d(u.applied?"ok":"ko"),u.applied||s(u.encours?e.propSlow:u.reply),u.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:l||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{p(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Lc(){var N;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=Z(),[i,d]=c.useState(!1),[l,s]=c.useState(null),[g,p]=c.useState(!1),[x,m]=c.useState([]),[b,u]=c.useState(null),[w,k]=c.useState([]);if(!r)return null;const f=()=>{d(!0),p(!1),m([]),k([]),Ts(a).then(E=>{if(d(!1),!E){p(!0),s(null);return}s(E)})},v=E=>{b||(u(E.title),bi(a,E.instruction,"atelier2-prop").then(S=>{u(null),S.applied?(k(T=>[...T,E.title]),n(e.propApplied)):S.encours?n(e.propSlow):o(S.reply||e.propApplyFail)}))},j=((l==null?void 0:l.proposals)||[]).filter(E=>!x.includes(E.title)&&!w.includes(E.title)),y=((N=l==null?void 0:l.counts)==null?void 0:N.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:f,children:i?e.propWait:e.propBtn}),!i&&g&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!g&&l&&!(l.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:l.reason==="not_enough_signals"?e.propFew(y):e.propNone}),j.map(E=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[E.section]||E.section}),t.jsx("p",{className:"propt",children:E.title}),E.why&&t.jsx("p",{className:"mnote dim",children:E.why}),E.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",E.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>v(E),children:b===E.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>m(S=>[...S,E.title]),children:e.propSkip})]})]},E.title))]})}function Fc(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=Z(),[l,s]=c.useState(null),[g,p]=c.useState(!1),[x,m]=c.useState(!1),[b,u]=c.useState(""),[w,k]=c.useState(""),[f,v]=c.useState(!1),j=c.useRef(!1);if(c.useEffect(()=>{if(!a||!r)return;let E=!0;return As(a).then(S=>{E&&(p(!0),!(!S||j.current)&&(s(S),u(S.fit),k(S.note)))}),()=>{E=!1}},[a,r]),!r)return null;const y=()=>{if(!(!b||f)){if(l&&l.fit===b&&l.note===w.trim()){m(!1);return}v(!0),vt(a,"thesis_fit",b,w.trim(),"",d.email||"").then(E=>{if(v(!1),!E.ok){o(e.fitKo);return}s({fit:b,note:w.trim(),ts:new Date().toISOString()}),m(!1),n(e.fitSaved)})}},N=E=>E==="yes"?e.fitYes:E==="partial"?e.fitPartial:e.fitNo;if(l&&!x){const E=new Date(String(l.ts||"")),S=Number.isNaN(E.getTime())?"":E.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:N(l.fit)}),l.note?` — ${l.note}`:""]}),!!S&&t.jsx("p",{className:"mnote dim",children:S}),t.jsx("button",{type:"button",className:"lk",onClick:()=>m(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(E=>t.jsx("button",{type:"button","aria-pressed":b===E,className:"fitopt"+(b===E?" on":""),onClick:()=>{j.current=!0,u(E)},children:N(E)},E))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:w,onChange:E=>{j.current=!0,k(E.target.value)},onKeyDown:E=>{E.key==="Enter"&&y()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||f,onClick:y,children:f?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!g&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function Rc(){var f,v,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:l}=Z(),s=n==="client",g=c.useMemo(()=>{const y=new Set;return a.forEach(N=>{N.angle&&y.add(N.angle)}),[...y]},[a]),[p,x]=c.useState(""),[m,b]=c.useState(""),[u,w]=c.useState(!1),k=async()=>{const y=p.trim();if(!(!y||u||!s)){w(!0),b("");try{const E=await(await fetch(`${wt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(E.reply&&b(String(E.reply)),E.job_id){b(e.critChatRunning);const S=async()=>{const T=await fetch(`${wt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:E.job_id})}).then(C=>C.json()).catch(()=>null);if(T&&T.done){b(String(T.reply||T.clarification||T.summary||"✓")),w(!1),T.applied&&o(e.alertSaved);return}setTimeout(()=>{S()},8e3)};setTimeout(()=>{S()},8e3),x("");return}x("")}finally{m.startsWith("⏳")||w(!1)}}};return t.jsxs(Ke,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((v=i==null?void 0:i.angles)!=null&&v.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(y=>{var N,E;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((N=y.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(S=>t.jsx("li",{children:S},S))})]}),!!((E=y.out)!=null&&E.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(S=>t.jsx("li",{children:S},S))})]})]})]},y.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsx(Fc,{}),t.jsx(Tc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:p,disabled:!s||u,onChange:y=>x(y.target.value),onKeyDown:y=>{y.key==="Enter"&&k()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},disabled:!s||u||!p.trim(),onClick:()=>void k(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),m&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:m})]}),t.jsx(Lc,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Ns,{fund:d,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(fi[y]||"v-cons"),children:y}),t.jsx("span",{children:N})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",N]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Oc(){const{t:e,dispatch:a,startTour:r}=Z(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Ke,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const vi="atl2:mapfold",Mc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(vi);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Dc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},yi=c.createContext(null),Z=()=>{const e=c.useContext(yi);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Nt({o:e,lg:a}){const{lang:r}=Z(),n=$e(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:fr(n,r),children:[n.emoji," ",fr(n,r)]}):null}function Va({o:e,src:a}){const{lang:r,t:n}=Z(),o=$e(e);if(!o)return null;const i=Us(o),d=Hs(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(No(o,r))+" · "+n.win7(So(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,s)=>t.jsx("i",{className:s<i?"on":""},s))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Ic(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Ue(a);if(o)return e.find(i=>Ue(i.name)===o)||e.find(i=>{const d=Ue(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Pc(){const{scoped:e,t:a,st:r,dispatch:n}=Z(),o=c.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(x=>!We(x)),l=d.length,s=d.filter(x=>!x.noCo).length,g=d.filter(x=>!!x.noCo).length,p=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:p?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",s," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function _c(){var x;const{t:e,lang:a,data:r,dispatch:n,scopedAll:o,counts:i}=Z(),d=m=>m.toLocaleString(a==="en"?"en-US":"fr-FR"),s=o.filter(m=>!We(m)).length,g=typeof((x=r.stats)==null?void 0:x.screened)=="number"?r.stats.screened:0;if(s<=0&&g<=0)return null;const p=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:d(s)}),t.jsx("span",{children:p>0?e.covOf(d(p)):e.covScreened("").trim()}),t.jsxs("ul",{children:[t.jsxs("li",{children:["✅ ",d(i[1]||0)," ",e.covKept]}),t.jsxs("li",{children:["⚡ ",d(i[2]||0)," ",e.covAna]})]})]})}function wi({o:e}){const{lang:a}=Z(),r=$s(e.cc),n=e.cc?Gt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:20,height:14,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Bc=!1;function $c(){const[e,a]=c.useState(!1);return c.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const ki=e=>`atl2:tour:${e||"anon"}`;function Uc(e){try{return localStorage.getItem(ki(e))==="1"}catch{return!0}}function uo(e){try{localStorage.setItem(ki(e),"1")}catch{}}function Hc(e,a,r,n,o,i,d,l){const s=e.tourT,g=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:g[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:g[1][0]},{sel:".atl2 .dmulti.ddeals",title:s.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:s.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:s.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:s.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:s.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:s.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-bulk"]',need:".atl2 .ic[data-tour=plug]",title:s.campout,body:e.fhintCampout,modal:"plug"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-crm"]',need:".atl2 .ic[data-tour=plug]",title:s.addcrm,body:e.fhintAddcrm,modal:"plug"}:null,...[2,4,5].filter(p=>(l[p]||0)>0).map(p=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:p===2?s.tabAna:p===4?s.tabValid:s.tabRej,body:p===2?e.fhintTabAna:p===4?e.fhintTabValid:e.fhintTabRej,ptab:p})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:s.rank,body:e.fhintRank},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:s.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:g[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:g[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:s.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:s.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:s.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function Qc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Yn;const{lang:d}=Is(),l=Tl(e,d,a),s=c.useMemo(()=>({...bl[d],...xl(d,l.thesisMode)}),[d,l.thesisMode]),[g,p]=c.useReducer(Rl,void 0,()=>Ll((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Dc():Mc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=c.useRef(!0);c.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(vi,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),c.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const A=()=>{window.innerWidth<=760&&p({type:"mapFold",folded:!0})};return A(),window.addEventListener("resize",A),()=>window.removeEventListener("resize",A)},[a]);const m=c.useRef(i);m.current=i,c.useEffect(()=>{var A;(A=m.current)==null||A.call(m,g.filters)},[g.filters]);const[b,u]=c.useState(()=>{if(typeof window>"u")return"both";try{const A=localStorage.getItem("atl2:chrome-mode");if(A==="eval"||A==="filt"||A==="both")return A;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[w,k]=c.useState(null),[f,v]=c.useState(null),[j,y]=c.useState(null),[N,E]=c.useState({kept:0,dropped:0}),[S,T]=c.useState(!1),[C,L]=c.useState(""),[D,H]=c.useState(!1),[R,O]=c.useState(null),[h,q]=c.useState(null),[M,W]=c.useState(!1),[z,I]=c.useState(!1),[,P]=c.useState(0),U=()=>P(A=>A+1),ae=c.useRef([]),$=c.useRef(new Set),le=c.useRef(new Set),[J,de]=c.useState([]),[he,xe]=c.useState([]),[be,ve]=c.useState(0),ye=c.useRef(new Map),Te=c.useRef(null),{mode:ne}=l,ke=c.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),B=ke.pipe,V=l.session.token||"",Y=ne==="client"&&!e;c.useEffect(()=>{if(!V||!B)return;let A=!0;const K=async()=>{const fe=await Vs(V);!A||!fe||(xe(fe.runs),ve(Date.now()/1e3-fe.now),de(Re=>Re.filter(Se=>!fe.runs.some(He=>Ue(He.company)===Ue(Se.name)))))};K();const G=J.length>0||he.some(fe=>fe.status==="running"),ie=window.setInterval(()=>{K()},G?8e3:25e3);return()=>{A=!1,window.clearInterval(ie)}},[V,B,J.length,he.some(A=>A.status==="running")]),c.useEffect(()=>{if(!V||!B||!Y)return;let A=!0;const K=async()=>{const ie=await Ws(V);if(!A||!ie.length)return;const fe=new Map;ie.forEach(Re=>{const Se=String(Re.ceo_status||"").trim();Se&&Re.check_id&&fe.set(String(Re.check_id),Se)}),l.patchStatuses(fe,Re=>Date.now()-(Ne.current.get(Re)||0)>9e4)};K();const G=window.setInterval(()=>{K()},6e4);return()=>{A=!1,window.clearInterval(G)}},[V,B,Y]);const Q=c.useMemo(()=>{const A=[],K=new Set;for(const G of J){const ie=Ue(G.name);!ie||K.has(ie)||(K.add(ie),A.push({name:G.name,id:G.id,status:"boot",started:G.started,estMin:G.estMin,memoType:"instant"}))}for(const G of he){const ie=Ue(G.company);if(!ie||K.has(ie))continue;K.add(ie);const fe=G.status==="error"?"error":G.status==="done"?"done":"running";A.push({name:G.company,status:fe,started:G.started||0,estMin:G.est_min||(G.memo_type==="detailed"?40:15),url:G.url,error:G.error,memoType:G.memo_type,note:G.note})}return A},[J,he]),se=A=>Q.find(K=>Ue(K.name)===Ue(A))||null,pe=(A,K)=>{de(G=>G.some(ie=>Ue(ie.name)===Ue(A.name))?G:[...G,{name:A.name,id:A.id,started:Date.now()/1e3,estMin:K==="detailed"?40:15}]),$.current.add(A.id),U()},re=(A,K=!1)=>{L(A),H(K),Te.current&&clearTimeout(Te.current),Te.current=setTimeout(()=>L(""),K?4200:2400)},ue=A=>re(A,!0),ce=c.useMemo(()=>{const A=new Map;return l.dossiers.forEach(K=>{K.id&&A.set(K.id,K)}),A},[l.dossiers]),we=c.useMemo(()=>l.dossiers.filter(A=>oa(A,g,B)),[l.dossiers,g,B]),qe=c.useRef(!1);c.useEffect(()=>{if(qe.current||l.loading||!l.dossiers.length)return;if(e&&!l.session.token){qe.current=!0;return}if(!ke.showFunnel||Uc(l.session.token||"")){qe.current=!0;return}qe.current=!0;const A=window.setTimeout(()=>{uo(l.session.token||""),W(!0)},700);return()=>window.clearTimeout(A)},[e,l.loading,l.dossiers.length,ke.showFunnel,l.session.token]);const De=c.useMemo(()=>l.dossiers.filter(A=>Ol(A,g,B,l.favIds)),[l.dossiers,g,B,l.favIds]),Pe=c.useMemo(()=>Ps(we.filter(A=>!Je(A)),l.favIds),[we,l.favIds]),Ee=c.useRef(!1);c.useEffect(()=>{if(Ee.current)return;if(!B||a==="ops"){Ee.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Ee.current=!0;return}if(l.loading)return;Ee.current=!0;const A=_s(Pe);A!==g.ptab&&p({type:"ptab",tab:A})},[B,a,n==null?void 0:n.ptab,l.loading,Pe,g.ptab]);const Dt=c.useMemo(()=>{const A=_o(l.dossiers);return A?kt(A)===0?s.tourToday:Bo(A,d):s.tourNoRun},[l.dossiers,s,d]),Ct=c.useMemo(()=>l.dossiers.some(A=>!!A.memoUrl||!!A.summary||$t(A)),[l.dossiers]),[_e,lt]=c.useState(!1);c.useEffect(()=>{if(l.loading){lt(!1);return}if(l.dossiers.length>0||l.error){lt(!0);return}const A=window.setTimeout(()=>lt(!0),6e3);return()=>window.clearTimeout(A)},[l.loading,l.dossiers.length,l.error]);const ht=(l.marketEstimate||0)>0||typeof((Yn=l.stats)==null?void 0:Yn.screened)=="number"&&l.stats.screened>0,zt=c.useMemo(()=>[1,0,2,4,5,3].find(A=>(Pe[A]||0)>0)??0,[Pe]),at=Rn.find(A=>A.key===g.continent),At=g.continent==="monde"?s.contWorld:(d==="fr"?at==null?void 0:at.fr:at==null?void 0:at.en)||"";c.useEffect(()=>{const A=K=>{var ie;const G=(((ie=K.detail)==null?void 0:ie.name)||"").trim();G&&gt(null,G)};return window.addEventListener("ppmap:evaluate",A),()=>window.removeEventListener("ppmap:evaluate",A)}),c.useEffect(()=>{const A=K=>{const G=K.detail||{},ie=String(G.id||"").trim(),fe=String(G.name||"").trim(),Re=String(G.url||"").trim(),Se=ie&&ce.get(ie)||Ic(l.dossiers,fe,Re);if(Se){if(v(null),oa(Se,g,B)||(g.continent!=="monde"&&Se.continent!==g.continent&&p({type:"continent",key:Se.continent||"monde"}),p({type:"reset"})),B&&Se.kind!=="op"){const ut=Ae(Se);typeof ut=="number"&&ut!==g.ptab&&p({type:"ptab",tab:ut})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),p({type:"focus",id:Se.id}),(Se.noCo||["media","nominations","recrutements"].includes(Se.engine||""))&&(Se.url||Se.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Se.url||"",text:[Se.headline,Se.tagline].filter(Boolean).join(`
`)}})):Se.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Se.name,url:Se.url||"",website:Se.website||"",domain:Se.domain||""}}));return}!fe&&!Re||(p({type:"focus",id:ie||null}),v({name:fe,headline:String(G.text||"").trim()||fe,url:Re,card:G.card}),Re&&(La(fe)||!fe)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Re,text:String(G.text||"").trim()}})):fe&&!La(fe)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:fe}})))};return window.addEventListener("ppmap:focus",A),()=>window.removeEventListener("ppmap:focus",A)}),c.useEffect(()=>{const A=ie=>{const fe={},Re=String((ie==null?void 0:ie.sector)||"").trim();Re&&(fe.sector=[Re]);const Se=String((ie==null?void 0:ie.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Se)&&(fe.day=Se);const He=String((ie==null?void 0:ie.search)||"").trim();He&&(fe.search=He);const ut=String((ie==null?void 0:ie.dealKind)||"").trim();(ut==="ma"||ut==="levee"||ut==="other")&&(fe.dealKind=[ut]),Object.keys(fe).length&&p({type:"filters",patch:fe})},K=ie=>A(ie.detail),G=ie=>{ie.data&&ie.data.type==="pp-filter"&&A(ie.data)};return window.addEventListener("ppmap:filter",K),window.addEventListener("message",G),()=>{window.removeEventListener("ppmap:filter",K),window.removeEventListener("message",G)}},[]),c.useEffect(()=>{const A=K=>{var fe;const G=(((fe=K.detail)==null?void 0:fe.name)||"").trim().toLowerCase();if(!G)return;const ie=l.dossiers.find(Re=>(Re.name||"").trim().toLowerCase()===G);ie&&p(a==="ops"?{type:"focus",id:ie.id}:{type:"popup",id:ie.id})};return window.addEventListener("ppmap:similar",A),()=>window.removeEventListener("ppmap:similar",A)});const gt=(A,K,G)=>{const ie=(G||(A==null?void 0:A.name)||K||"").trim();if(!Y){y({kicker:ie});return}!ie||S||(T(!0),(async()=>{try{let fe=(K||ie).trim();const Re=((A==null?void 0:A.website)||(A==null?void 0:A.domain)||"").trim();if(!(/^https?:\/\//i.test(fe)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(fe)&&!/\s/.test(fe)))if(Re)fe=Re;else try{const Ie=await On(ie);if(Ie!=null&&Ie.website)fe=Ie.website;else if(((Ie==null?void 0:Ie.candidates)||[]).length===1)fe=Ie.candidates[0].url;else if(((Ie==null?void 0:Ie.candidates)||[]).length>1){ae.current=[{name:ie,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(Ie.candidates||[]).slice(0,5)},...ae.current].slice(0,8),U();return}}catch{}const He=await wo(V,fe,"atelier2"),ut={name:He.company||ie,verdict:He.verdict,reason:He.reason||"",remaining:He.remaining??null};ae.current=[ut,...ae.current].slice(0,8),He.verdict==="kept"&&E(Ie=>({...Ie,kept:Ie.kept+1})),He.verdict==="ruled_out"&&E(Ie=>({...Ie,dropped:Ie.dropped+1}));const Qt=A||l.dossiers.find(Ie=>(Ie.name||"").toLowerCase()===ie.toLowerCase());Qt&&(He.verdict==="kept"?Qt.verdict=Qt.verdict||"MATCH":He.verdict==="ruled_out"&&(Qt.verdict="NO MATCH"),He.reason&&(Qt.reasoning=He.reason)),U()}finally{T(!1)}})())},It=A=>{if(!Y){y({kicker:A.name});return}pe(A,"instant"),vt(V,"fast_request",A.name||"",""),re(s.memoInstantSent(A.name))},Pt=A=>ye.current.get(A.id)??l.thumbs.get((A.name||"").trim().toLowerCase()),Be=(A,K)=>p({type:"undoPush",entry:{id:A.id,name:A.name,prevCeoStatus:K}}),Xe=async(A,K,G)=>{const ie=A.ceoStatus||"";Ne.current.set(A.id,Date.now()),A.ceoStatus=K,U();const fe=await Qa(V,{status:K,airtable_id:A.airtableId,check_id:A.checkId,company:A.name,...(G==null?void 0:G.note)!==void 0?{note:G.note}:{},...G!=null&&G.via?{via:G.via}:{}});return fe.ok?fe.skipped?(A.ceoStatus=ie,U(),ue(s.actNotPersisted),!1):((G==null?void 0:G.undo)!==!1&&Be(A,ie),G!=null&&G.msg&&re(G.msg),(K==="Validé"||K==="Écarté")&&!A.ceoNote&&(G==null?void 0:G.note)===void 0&&O({o:A,yes:K==="Validé"}),!0):(A.ceoStatus=ie,U(),ue(s.actErr),!1)},Ye=async(A,K)=>{const G=await Qa(V,{status:A.ceoStatus||"Retenu",airtable_id:A.airtableId,check_id:A.checkId,company:A.name,note:K,via:"note"});return!G.ok||G.skipped?(ue(G.skipped?s.actNotPersisted:s.actErr),!1):(A.ceoNote=K,U(),!0)},ct=c.useRef(new Map),F=A=>ct.current.has(A.id)?ct.current.get(A.id):l.stages.get((A.name||"").trim().toLowerCase()),X=(A,K)=>{ct.current.set(A.id,K),U()},te=(A,K)=>{Y&&Xe(A,K?"Validé":"Écarté",{msg:K?s.decidedYes(A.name):s.decidedNo(A.name)})},_=A=>{Y&&Xe(A,"À trancher",{msg:s.promoted(A.name)})},oe=A=>{Y&&(async()=>{const K=A.ceoStatus||"";A.ceoStatus="Retenu",U();const G=await Qa(V,{status:"Retenu",check_id:A.checkId,company:A.name});if(!G.ok||G.skipped){A.ceoStatus=K,U(),ue(G.skipped?s.actNotPersisted:s.actErr);return}Be(A,K),re(s.repeched(A.name))})()},ee=()=>{const A=g.undo[g.undo.length-1];if(!A){re(s.undoNone);return}const K=ce.get(A.id);if(!K){p({type:"undoPop"}),re(s.undoNone);return}let G=A.prevCeoStatus;if(!G)if((K.verdict||"").toUpperCase().includes("CALL"))G="À trancher";else{re(s.undoLockedTitle);return}(async()=>await Xe(K,G,{undo:!1})&&(p({type:"undoPop"}),K.ceoStatus=A.prevCeoStatus,U(),re(s.undoDone(K.name))))()},me=A=>{Y&&(le.current.add(A.id),U(),p({type:"approachOpen",id:A.id}),vt(V,"approach",A.name||"","","",l.email||""))},Ne=c.useRef(new Map),ge=c.useRef(!1),[Fe,ze]=c.useState(0);c.useEffect(()=>{if(!V||e||!Y||ge.current)return;ge.current=!0;const A=new Date().toISOString().slice(0,10),K=l.email||"",G=`cbv_${V}_${K}_${A}`,ie=`atl2:vue:${V}:${A}`;try{if(localStorage.getItem(G)||localStorage.getItem(ie))return}catch{}vt(V,"view","","","",K).then(fe=>{if(!fe.ok){ge.current=!1;return}try{localStorage.setItem(G,"1")}catch{}})},[V,e,Y,l.email]),c.useEffect(()=>{if(!V||!B||e||!Y||!l.generatedAt)return;let A=!0;const K=()=>{document.hidden||Gs(V,l.generatedAt||"").then(ie=>{A&&ze(ie)})};K();const G=window.setInterval(K,6e4);return()=>{A=!1,window.clearInterval(G)}},[V,B,e,l.generatedAt]);const nt=(A,K)=>{Y&&(async()=>{if(!(await vt(V,K?"yes":"no",A.name||"",(A.ceoNote||"").slice(0,400),A.sector||"",l.email||"")).ok){ue(s.actErr);return}ye.current.set(A.id,K?"yes":"no"),U(),re(K?s.thumbUpDone:s.thumbDnDone),q({o:A,up:K})})()},xt=A=>{!Y||!$t(A)||(pe(A,"detailed"),vt(V,"detailed_request",A.name||"","","",l.email||""),re(s.memoDeepSent(A.name)))},Ze=A=>{!Y||!A.memoUrl||window.confirm(s.memoRegenAsk(A.name))&&(pe(A,"detailed"),vt(V,"detailed_regen",A.name||"","","",l.email||""),re(s.memoDeepSent(A.name)))},ji=A=>{const K=new Set(l.favIds),G=K.has(A.id);G?K.delete(A.id):K.add(A.id),l.setFavIds(K),Y&&Ys(V,{id:A.id,co:A.name},G)},Ei=()=>{!Y||z||window.confirm(s.identSyncConfirm)&&(I(!0),(async()=>{const A=await Qs(V);I(!1),A?re(s.identSyncDone):ue(s.actErr)})())},Gn=/proplace/i.test(l.fund||""),Ni=A=>{!Y||!Gn||(vt(V,"onboard_request",A.name||"",""),re(s.onboardSent(A.name)))},Si={st:g,dispatch:p,t:s,lang:d,mode:ne,caps:ke,pipe:B,token:V,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:oe,thumbOf:Pt,canWrite:Y,commitStatus:Xe,saveNote:Ye,stageOf:F,setStage:X,flashErr:ue,startTour:()=>W(!0),dossiers:l.dossiers,scopedAll:we,scoped:De,counts:Pe,byId:ce,contName:At,favIds:l.favIds,toggleFav:ji,askEvaluate:gt,doAnalyse:It,doDecide:te,doPromote:_,doApproach:me,doThumb:nt,doDeep:xt,doRegen:Ze,doUndo:ee,doSync:Ei,doOnboard:Ni,outbound:Gn,memoQueued:$.current,liveMemos:{items:Q,serverOff:be,liveOf:se},approachDone:le.current,sessTally:N,evalCards:ae.current,evalBusy:S,markRow:k,markedId:w,flash:re,focusExtra:f};c.useEffect(()=>{const A=K=>{K.key==="Escape"&&(p({type:"popup",id:null}),p({type:"modal",modal:null}),p({type:"openFacet",facet:null}))};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[]);const Ci=A=>V?t.jsx(Il,{token:V,children:A}):t.jsx(t.Fragment,{children:A});return t.jsx(yi.Provider,{value:Si,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(V?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:jl}),Ci(t.jsxs("div",{className:"app"+(B?" pipe":"")+(V?" has-thesis":""),children:[ke.showTicker&&t.jsx(dt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(V?" live-stack--cibles":""),children:[t.jsx(Vl,{}),!!V&&t.jsx(Pl,{})]})}),ke.showIdent&&t.jsx(dt,{name:"identite",children:t.jsx(nd,{})}),!1,Bc,ke.showFunnel&&t.jsx(dt,{name:"entonnoir",children:t.jsx(Vc,{})}),t.jsx(dt,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(si,{variant:g.mapFolded?"compact":"tabs"}),t.jsxs("div",{className:"stage"+(g.mapFolded?" folded":""),id:"atl2-stage",children:[!g.mapFolded&&a==="ops"&&t.jsx(Pc,{}),!g.mapFolded&&a!=="ops"&&ke.showFunnel&&t.jsx(_c,{}),!g.mapFolded&&t.jsx(tp,{}),t.jsx(ii,{})]})]})}),ke.showDemand&&B&&t.jsx(dt,{name:"direct",children:t.jsx(el,{items:Q,serverOff:be,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>p({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([A,K])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===A,onClick:()=>{u(A);try{localStorage.setItem("atl2:chrome-mode",A)}catch{}},children:K},A))}),ke.showDemand&&t.jsx(dt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(mp,{})})}),ke.showDemand&&g.memoConsole&&t.jsx(dt,{name:"console",children:t.jsx(hp,{})}),ke.pipe&&!!V&&t.jsx(dt,{name:"moteurs",children:t.jsx(cl,{})}),Fe>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:s.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{ze(0),l.refresh()},children:s.freshGo})]}),t.jsx(dt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(nc,{})}),ke.pipe&&!!V&&t.jsx("p",{className:"privnote",children:s.privLink}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(dt,{name:"fiche",children:t.jsx(_p,{})}),t.jsx(dt,{name:"modales",children:t.jsx(cc,{})}),t.jsx(Yl,{}),h&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:h.o.name}),t.jsx(Sr,{placeholder:h.up?s.thumbWhyUpPh:s.thumbWhyDnPh,onDone:A=>{const K=h.o;q(null),A&&vt(V,"note",K.name||"",A,K.sector||"",l.email||"").then(G=>{G.ok&&re(s.csNoteSaved)})}})]}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(Sr,{placeholder:R.yes?s.whyYesPh:s.whyNoPh,onDone:A=>{const K=R.o;O(null),A&&Ye(K,A).then(G=>{G&&re(s.csNoteSaved)})}})]}),M&&_e&&t.jsx(ed,{steps:Hc(s,Dt,Ct,zt,ht,Pe[3]||0,Pe[4]||0,Pe),onClose:()=>{W(!1),uo(V)}}),t.jsx($c,{}),ke.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:Io,children:Pn}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("button",{type:"button",onClick:()=>p({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),C&&t.jsx("div",{className:"flash on"+(D?" err":""),children:C}),j&&t.jsx(Bs,{variant:"acquirer",initialCompany:mo().co,initialWebsite:mo().site,onClose:()=>y(null)})]})})}function Vc(){const{t:e}=Z(),[a,r]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function mo(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Wc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{wi as FlagCell,Nt as SigBadge,Va as SigWin,Qc as default,Wc as fmtShort,Z as useV2};
