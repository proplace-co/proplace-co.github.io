...
.atl2 .bulk .side .hint{white-space:nowrap}`,Xa=`
...
`,Za=Ja+Xa;function er(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function tr(t,a){return t||a.mode!=="client"||!a.token?"visiteur":er("teaser")==="1"?"apercu":"client"}const ar={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},rr=t=>ar[t],fe=t=>Object.assign(t,{continent:xa(t.cc)});function Ue(t){const a=new Set,n=[];for(const r of t){const l=(r.name||"").toLowerCase();!l||a.has(l)||(a.add(l),n.push(r))}return n}const nr=60*60*1e3;function or(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>nr?null:a}catch{return null}}function Fe(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const lr=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function ir(t,a,n="default"){const r=n!=="default",l=p.useMemo(()=>t||r?{mode:"anon"}:sa(),[t,r]),o=p.useMemo(()=>r?"visiteur":tr(t,l),[t,l,r]),i=p.useMemo(()=>rr(o),[o]),f=o!=="visiteur",d=lr(n),[u,h]=p.useState([]),[s,v]=p.useState(""),[b,m]=p.useState(null),[g,x]=p.useState(null),[c,y]=p.useState(null),[k,w]=p.useState(()=>new Map),[S,C]=p.useState(()=>new Map),[F,N]=p.useState(""),[E,P]=p.useState(new Set),[O,q]=p.useState(null),[D,T]=p.useState(!0),[B,R]=p.useState(!1),[H,oe]=p.useState(0),[de,Ae]=p.useState(0),xe=p.useRef(0),ce=p.useMemo(()=>{var V;if(o!=="client")return"";try{return((V=da())==null?void 0:V.email)||""}catch{return""}},[o]);p.useEffect(()=>{const V=++xe.current;let U=!0;const M=()=>U&&V===xe.current,I=(f&&l.token?l.token:"pub:"+a)+(d?":"+d:""),_=or(I);return _?(h(_.objs.map(fe)),_.fund&&v(_.fund),m(_.marketEstimate??null),x(_.criteria??null),y(_.stats??null),N(_.generatedAt||""),T(!1)):T(!0),(async()=>{try{if(n==="ops"){const re=await Ie(),te=((re==null?void 0:re.recent_ops)||[]).map(Q=>$e(Q,a)).filter(Q=>!!Q);if(!M())return;h(te.map(fe)),Fe(I,{objs:te})}else if(typeof n=="object"){const te=(await nt()||[]).filter(J=>(J.slug||"")===n.research).map(J=>ot(J,a)).filter(J=>!!J),Q=Ue(await lt(te,a));if(!M())return;h(Q.map(fe)),Fe(I,{objs:Q})}else if(f&&l.token){const re=ca(l.token),te=Ie(),Q=pa(l.token),J=ua(l.token),je=fa(l.token),$=await re;let le=$?$.targets:[];M()&&$&&(v($.fund||""),m($.marketEstimate??null),x($.criteria??null),y($.stats??null),N($.generatedAt||""),h(le.map(fe)),T(!1),R(!1));const[pe,Ne,ge,ae]=await Promise.all([te,Q,J,je]),he=((pe==null?void 0:pe.recent_ops)||[]).map(ne=>$e(ne,a)).filter(ne=>!!ne);if(le=[...le,...he],!M())return;h(le.map(fe));const Se=new Set;for(const ne of Ne){const be=(ne.id||ne.co||"").toString().trim().toLowerCase();be&&Se.add(be.startsWith("t:")?be:"t:"+be)}P(Se),w(ge),C(ae),$&&Fe(I,{fund:$.fund,marketEstimate:$.marketEstimate,criteria:$.criteria,stats:$.stats,generatedAt:$.generatedAt,objs:le})}else{const re=ma(),te=nt(),Q=Ie(),J=await re;M()&&J.length&&(h(Ue(J).map(fe)),T(!1),R(!1));const[je,$]=await Promise.all([te,Q]),le=(je||[]).map(ae=>ot(ae,a)).filter(ae=>!!ae),pe=await lt(le,a),Ne=(($==null?void 0:$.recent_ops)||[]).map(ae=>$e(ae,a)).filter(ae=>!!ae),ge=Ue([...J,...pe,...Ne]);if(!M())return;h(ge.map(fe)),Fe(I,{objs:ge})}M()&&R(!1)}catch{M()&&!_&&R(!0)}finally{M()&&T(!1)}})(),()=>{U=!1}},[f,l.token,a,H,d]),p.useEffect(()=>{if(!i.showCredits||!ce){q(null);return}let V=!0;return(async()=>{try{const U=await fetch(`${Ye}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ce})});if(!U.ok)return;const M=await U.json();V&&M&&M.ok!==!1&&q(M)}catch{}})(),()=>{V=!1}},[i.showCredits,ce,de]);const Y=p.useCallback(V=>P(new Set(V)),[]);return{session:l,mode:o,caps:i,fund:s,email:ce,marketEstimate:b,generatedAt:F,criteria:g,stats:c,thumbs:k,stages:S,dossiers:u,favIds:E,setFavIds:Y,credits:O,reloadCredits:()=>Ae(V=>V+1),loading:D,error:B,refresh:()=>oe(V=>V+1)}}const qt=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),sr=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...qt(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function dr(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(l=>l!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(l=>l!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:qt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Me)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Me=60;function Je(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!K(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(We(t)))return!1;if(r!=="win"&&a.win!=="all"){const l=a.win==="1"?0:a.win==="7"?7:30;if(ye(t.date)>l)return!1}if(r!=="status"&&!n&&a.status!=="all"&&se(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const l=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(l))return!1}return!0}function Mt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:Je(t,a.filters,n)}function cr(t,a,n,r){return!(!Mt(t,a,n)||n&&!ga(t,a.ptab,r))}function Xe(t,a){const n=a.key,r=l=>{switch(n){case"name":return(l.name||"").toLowerCase();case"country":return l.countryLabel||l.cc||"";case"stage":return l.stage||"";case"amount":return l.amountEur||-1;case"age":return-ye(l.date);case"score":return typeof l.score=="number"?l.score:-1;case"signal":{const o=K(l);return o?100-(o.left??0):-1}}};return[...t].sort((l,o)=>{const i=r(l),f=r(o);return i<f?-a.dir:i>f?a.dir:(l.name||"").localeCompare(o.name||"")})}function pr(){const{dossiers:t,st:a,t:n,dispatch:r,contName:l,pipe:o}=z(),i=p.useMemo(()=>{const d=s=>o?!0:s.continent===a.continent,u=t.filter(s=>d(s)&&K(s)),h=t.filter(s=>d(s)&&s.kind==="op"&&!K(s)&&(s.dealKind==="ma"||s.dealKind==="levee")&&ye(s.date)<=2);return h.sort((s,v)=>(v.amountEur||0)-(s.amountEur||0)),[...Xe(u,{key:"signal",dir:-1}),...h].slice(0,40)},[t,a.continent,o]),f=d=>i.map(u=>e.jsxs("button",{type:"button",className:"tk"+(X(u)?" spent":""),onClick:h=>{const s=h.currentTarget.getBoundingClientRect();r({type:"popup",id:u.id,anchor:{x:s.left+s.width/2,y:s.bottom}})},title:u.name+(u.tagline?" — "+u.tagline:""),children:[e.jsx(ke,{o:u}),e.jsxs("span",{className:"who",children:[e.jsx(Vt,{o:u}),e.jsx("span",{className:"co",children:u.name})]}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{className:"am",children:zn(u.amountEur)}),u.sector&&e.jsx("span",{className:"mt",children:u.sector}),e.jsx(Be,{o:u}),e.jsx("span",{className:"tkgo",children:"→"})]},d+(u.id||u.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:i.length})]}),e.jsx("div",{className:"win",children:i.length?e.jsxs("div",{className:"run",children:[f(0),f(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(l)})})})]})}const ur="aDx8z7Hzksus",Dt="+33 6 83 10 72 86",gt="alexandre@proplace.co",fr=`tel:${Dt.replace(/[^\d+]/g,"")}`,ht="pp-rdv-slot";function mr(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function xr(){const{t,caps:a,fund:n}=z(),r=a.showOnb,l=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:hr}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:fr,children:Dt}),t.rdvSubMid,e.jsx("a",{href:`mailto:${gt}`,children:gt})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(l).map(([o,i],f)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(f+1)}),e.jsx("b",{children:o}),e.jsx("span",{children:i})]},o))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(Wa,{filloutId:ur,parameters:n?{company_name:n}:void 0})})]})}function gr(){const[t,a]=p.useState(()=>typeof document>"u"?null:document.getElementById(ht));return p.useEffect(()=>{t||a(document.getElementById(ht))},[t]),t?Te.createPortal(e.jsx(xr,{}),t):null}const hr=`
...
`;class G extends p.Component{constructor(){super(...arguments);at(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(n,r){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,n,r.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const br=8;function vr(){const{t,lang:a,token:n,dossiers:r,caps:l,markRow:o,dispatch:i}=z(),[f,d]=p.useState(!1),[u,h]=p.useState(!1),[s,v]=p.useState(!1),b=n||"home",{names:m,verdicts:g}=p.useMemo(()=>{const w=[],S={};return r.forEach(C=>{C.kind!=="target"||!C.name||(w.push(C.name),S[C.name]=ha(C)||"")}),{names:w,verdicts:S}},[r]),x=p.useMemo(()=>m.length?ba(b,m,g,a):null,[b,m.length]);if(!l.pipe||f||!x||x.firstVisit||!x.added.length&&!x.gone.length)return null;const c=u?x.added:x.added.slice(0,br),y=x.added.length-c.length,k=w=>{const S=r.find(C=>C.name===w);S&&(o(S.id),i({type:"popup",id:S.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(x.added.length,x.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{d(!0),va(b,m,g,x.fp,a)},children:"×"})]}),!!x.added.length&&e.jsxs("div",{className:"since-c",children:[c.map(w=>e.jsx("button",{type:"button",onClick:()=>k(w),children:w},w)),y>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>h(!0),children:t.sinceMore(y)})]}),!!x.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>v(w=>!w),children:t.sinceOut(x.gone.length)}),s&&x.gone.slice(0,20).map(w=>e.jsx("span",{className:"gone",children:w},w))]})]})}const _e=600,me=62,bt="atl2:fstats";function yr(){const{t,lang:a,data:n,caps:r,st:l,dispatch:o}=z(),[i,f]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(bt)==="on"}catch{return!1}}),d=n.stats,u=p.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),h=p.useMemo(()=>{if(d!=null&&d.since)return d.since;const y=new Date;return y.setDate(y.getDate()-((d==null?void 0:d.window_days)||30)),y.toISOString().slice(0,10)},[d==null?void 0:d.since,d==null?void 0:d.window_days]);if(!r.showFunnel||!d||typeof d.screened!="number")return null;const s=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,v=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),b=u.reduce((y,k)=>Math.max(y,k.s||0),0),m=u.length?_e/u.length:0,g=Math.max(4,m-4),x=u.length>=5&&b>0,c=[[d.screened,t.funScreened(s(h)),d.screened_today],...typeof d.kept=="number"?[[d.kept,t.funKept,d.kept_today]]:[],...typeof d.analyzed=="number"?[[d.analyzed,t.funAnalyzed,d.analyzed_today]]:[],...typeof d.shown=="number"?[[d.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(i?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[c.map(([y,k,w],S)=>e.jsxs("span",{className:"fst-t",children:[S>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:v(y)}),e.jsx("i",{children:k}),i&&typeof w=="number"&&w>0&&e.jsx("em",{children:t.funToday(w)})]},k)),x&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":i,title:i?t.fstatsHide:t.fstatsShow,onClick:()=>{const y=!i;f(y),y&&!l.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(bt,y?"on":"off")}catch{}},children:i?"⌃":"⌄"})]}),i&&x&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${_e} ${me}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[u.map((y,k)=>{const w=(y.s||0)/b*(me-4),S=(y.m||0)/b*(me-4),C=k*m+(m-g)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${s(y.d)} — ${y.s} ${t.actScreened} · ${y.m} ${t.actKept}`}),e.jsx("rect",{x:C,y:me-2-w,width:g,height:w,fill:"#cfe0d6"}),e.jsx("rect",{x:C,y:me-2-S,width:g,height:S,fill:"#185c38"})]},y.d)}),e.jsx("line",{x1:0,y1:me-1.5,x2:_e,y2:me-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:s(u[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const wr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function kr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:l}=z(),[o,i]=p.useState(""),[f,d]=p.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const u=(t.ceoStatus||"").trim(),h=(Pe(t)||"").startsWith("CALL")&&ee(t)===3,s=ee(t)>=2,v=async m=>{if(o||m==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;i(m);const g=await l(t,m);i(""),g&&(d(!0),setTimeout(()=>d(!1),2200))},b=h?[["Validé",a.csYes],["Écarté",a.csNo]]:wr.filter(([m])=>!(s&&m==="Retenu")).map(([m,g])=>[m,a[g]]);return e.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,g])=>e.jsx("button",{type:"button",className:"csb"+(u===m?" on":"")+(o===m?" busy":""),disabled:!!o,onClick:()=>{v(m)},children:g},m)),f&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(jr,{o:t})]})}function jr({o:t}){const{t:a,saveNote:n,flash:r}=z(),[l,o]=p.useState(t.ceoNote||""),[i,f]=p.useState(!1),[d,u]=p.useState(!1),h=l.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(i||!h)return;f(!0);const v=await n(t,l.trim());f(!1),v&&(u(!0),setTimeout(()=>u(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:l,disabled:i,onChange:v=>o(v.target.value),onKeyDown:v=>{v.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:i||!h,onClick:()=>{s()},children:d?a.csNoteSaved:a.csNoteOk})]})}function Nr({placeholder:t,onDone:a}){const{t:n}=z(),[r,l]=p.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>l(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Sr({o:t}){var x;const{t:a,token:n,caps:r,canWrite:l,stageOf:o,setStage:i,flashErr:f}=z(),[d,u]=p.useState(!1);if(!r.pipe||!l||r.lockActions||ee(t)!==4)return null;const h=o(t),s=(h==null?void 0:h.stage)||"todo",v=async c=>{if(d||c===s)return;u(!0);const y=h;i(t,{stage:c,stamps:(h==null?void 0:h.stamps)||{}});const k=Math.max(Date.now(),vt+=1);vt=k;const w=await ya(n,{company:t.name||"",stage:c,cts:k,deal_id:t.airtableId,check_id:t.checkId});u(!1),!w.stale&&(w.ok||(i(t,y),f(a.actErr)))},b=(x=h==null?void 0:h.stamps)==null?void 0:x.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=s==="sent"&&b&&m>=4;return e.jsxs("div",{className:"stg",onClick:c=>c.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([c,y])=>e.jsx("button",{type:"button",className:"stgb"+(s===c?" on":""),disabled:d,onClick:()=>{v(c)},children:y},c)),g&&e.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let vt=0;const Re=8,qe=340;function yt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function Cr({steps:t,onClose:a}){const{t:n,dispatch:r,counts:l,scoped:o,byId:i,st:f}=z(),[d,u]=p.useState(0),[h,s]=p.useState(null),[v,b]=p.useState([]),m=p.useRef(!1);p.useEffect(()=>{m.current||(m.current=!0,b(t.filter(S=>!!document.querySelector(S.need||S.sel))))},[t]);const g=v[d],x=d>=v.length;p.useEffect(()=>{g&&(g.ptab!==void 0&&f.ptab!==g.ptab&&r({type:"ptab",tab:g.ptab}),g.dens&&f.dens!==g.dens&&r({type:"dens",dens:g.dens}))},[d,g]);const c=p.useCallback(()=>{if(!g){s(null);return}const S=document.querySelector(g.sel);if(!S){s(null);return}S.scrollIntoView({block:"nearest",behavior:"smooth"}),s(S.getBoundingClientRect())},[g]);p.useLayoutEffect(()=>{c();const S=window.setTimeout(c,260),C=()=>c();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{window.clearTimeout(S),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[c]);const y=p.useRef(a);if(y.current=a,p.useEffect(()=>{const S=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),y.current()):C.key==="ArrowRight"?u(F=>F+1):C.key==="ArrowLeft"&&u(F=>Math.max(0,F-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!v.length)return null;let k=null;if(x){const S=l[3]||0,C=o.find(F=>F.memoUrl)||[...i.values()].find(F=>F.memoUrl);S>0?k={title:S===1?n.ahaATitle1:n.ahaATitleN(S),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:C?k={title:n.ahaBTitle,body:n.ahaBBody(C.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:C.id}),a()}}:k={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:qe};if(!x&&h){const S=h.bottom+14,F=window.innerHeight-S>190?S:Math.max(12,h.top-200);w={left:Math.min(Math.max(12,h.left+h.width/2-qe/2),window.innerWidth-qe-12),top:F,width:qe}}return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!x&&h&&e.jsx("div",{className:"tour-hole",style:{left:h.left-Re,top:h.top-Re,width:h.width+Re*2,height:h.height+Re*2}}),(x||!h)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(x?" fin":""),style:w,children:[x&&k?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:k.title}),e.jsx("p",{children:e.jsx(yt,{text:k.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>u(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(d+1,v.length)}),e.jsx("h3",{children:g==null?void 0:g.title}),e.jsx("p",{children:e.jsx(yt,{text:(g==null?void 0:g.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>u(S=>Math.max(0,S-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>u(S=>S+1),children:d===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function zr(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:l}=z(),o=p.useMemo(()=>t.filter(s=>ye(s.date)===0&&s.kind==="target"),[t]),i=p.useMemo(()=>o.filter(s=>a?ee(s)===0:!X(s)),[o,a]),f=o.length-i.length,d=o.length?Math.min(100,f/o.length*100):100;let u;a?u=n.morningThesis(o.length,f,i.length):o.length?f===0?u=n.goalSourced(o.length):f>=o.length?u=n.goalCleared:u=n.goalDone(f,o.length):u=n.goalSourced(0);const h=()=>{a?(l({type:"ptab",tab:0}),l({type:"filters",patch:{win:"1"}})):l({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:u}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:d+"%"}})}),i.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:a?n.morningEval(i.length):r.pileMode?n.goalContinue(i.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Er(){var P;const{t,st:a,dispatch:n,token:r,fund:l,data:o,dossiers:i,mode:f,doSync:d,startTour:u}=z(),[h,s]=p.useState(null),[v,b]=p.useState([]),[m,g]=p.useState(!1),x=f==="client";p.useEffect(()=>{if(!r||!l)return;let O=!0;return(async()=>{const[q,D]=await Promise.all([Tt(l),At(r)]);O&&(q&&s(q),b(D))})(),()=>{O=!1}},[r,l]);const c=(h==null?void 0:h.per_day)??null,y=((P=h==null?void 0:h.pool_order)==null?void 0:P.length)??0,k=v.filter(O=>O.status==="running").length,w=O=>{if(!x||c===null||m)return;const q=Math.max(0,Math.min(10,c+O));q!==c&&(g(!0),s(D=>D&&{...D,per_day:q}),Ot(r,q).then(D=>{g(!1),s(D===null?T=>T&&{...T,per_day:c}:T=>T&&{...T,per_day:D})}))},S=p.useMemo(()=>i.filter(O=>O.kind==="target"&&X(O)).length,[i]),C=o.marketEstimate,F=C&&C>0?Math.min(100,Math.round(S/C*100)):null,N=(l||"P").split(/\s+/).map(O=>O[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const O=Date.parse(o.generatedAt||"");if(Number.isNaN(O))return"";const q=new Date(O),D=T=>String(T).padStart(2,"0");return`${D(q.getDate())}/${D(q.getMonth()+1)} à ${D(q.getHours())}:${D(q.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:l})]}),e.jsx("h1",{children:t.identTitle(l||"…")}),e.jsx("span",{className:"idsp"}),E&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(E)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:u,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[F!==null&&C&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:F+"%"}})}),e.jsxs("b",{children:[F," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(S,C)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),c!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),w(-1)},children:"−"}),e.jsx("b",{className:"q",children:c})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),w(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),c===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),k>0&&e.jsxs("span",{className:"ev",children:["⏳ ",k]}),e.jsx("span",{className:"ego",children:t.identPending(y)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:O=>{O.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!x,onClick:d,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:O=>n({type:"filters",patch:{search:O.target.value}})})]})]})]})}function Tr(){const{t,counts:a,dispatch:n}=z();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,l],o)=>{const i=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(i?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:l}),i&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Ar=["--p0","--p1","--p2","--p3","--p4"];function Or(){const{st:t,dispatch:a,counts:n,t:r,doUndo:l}=z(),o=p.useRef({});p.useEffect(()=>{o.current={...n}},[n]);const i=u=>{const h=o.current[u],s=h!==void 0?n[u]-h:0;return e.jsxs("button",{type:"button",className:"step"+(u===3&&n[3]>0?" wait":""),style:{"--c":`var(${Ar[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===u,title:r.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[e.jsxs("span",{className:"l",children:[r.plabels[u].toUpperCase(),u===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[u],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},u)},f=(u,h,s)=>e.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===u,title:r.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[u]})]},u),d=(u,h,s,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:h,disabled:v,onClick:s,children:u},h);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(i)}),e.jsxs("div",{className:"offtrack",children:[f(5,!1,r.plabels[5]),f(7,!0,r.plabels[7]),f(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[d("↩",r.toolUndo,l,t.undo.length===0),d("↺",r.toolReset,()=>{a({type:"reset"})}),d("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),d("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),d("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Lr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Fr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:l,doAnalyse:o,mode:i}=z(),f=p.useRef(null),[d,u]=p.useState(60);p.useEffect(()=>{let b=0;const m=()=>{var k;const g=f.current;if(!g)return;const x=(k=g.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!x)return;const c=x.getBoundingClientRect(),y=g.getBoundingClientRect();u(Math.max(20,Math.min(c.left+c.width/2-y.left,y.width-30)))};return b=requestAnimationFrame(m),window.addEventListener("resize",m),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",m)}},[t.ptab]);const h=t.ptab;let s=n.tuto[h].p;if(h===3){const b=r.filter(x=>x.kind==="target"&&ee(x)===3),m=b.filter(x=>He(x)==="auto").length,g=b.filter(x=>He(x)==="cd").length;s=n.tutoPending(m,g,b.length)}const v=(()=>{if(i!=="client")return null;if(h===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(h===1){const b=r.filter(m=>m.kind==="target"&&ee(m)===1&&!l.has(m.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(m=>o(m))}}return null})();return e.jsxs("div",{ref:f,className:"tuto mini",style:{"--bg":Lr[h],"--ax":d+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[h].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const wt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function kt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Rr(t,a){const[n,r]=p.useState(1);return p.useEffect(()=>{let l=!0,o=0;const i=()=>{var u;if(!l)return;const d=(u=t.current)==null?void 0:u.getScreenCTM();d&&d.a>0?r(d.a):o=requestAnimationFrame(i)};i();const f=new ResizeObserver(()=>i());return t.current&&f.observe(t.current),window.addEventListener("resize",i),()=>{l=!1,cancelAnimationFrame(o),f.disconnect(),window.removeEventListener("resize",i)}},[t,a]),n}function qr(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:l,markedId:o,byId:i,lang:f,t:d}=z(),u=p.useRef(null),h=p.useRef(null),s=Ge.find(N=>N.key===t.continent),v=Rr(u,t.continent+":"+t.mapFolded),[b,m]=p.useState(new Map),[g,x]=p.useState(null);p.useEffect(()=>{const N=u.current;if(!N)return;const E=new Map;N.querySelectorAll("path[data-i2]").forEach(P=>{const O=P.dataset.i2;if(O)try{const q=P.getBBox();q.width>0&&E.set(O,{x:q.x,y:q.y,w:q.width,h:q.height})}catch{}}),m(E)},[t.continent,v]);const c=p.useMemo(()=>n.filter(N=>N.cc),[n]),y=p.useMemo(()=>{const N=new Map;return c.forEach(E=>N.set(E.cc,(N.get(E.cc)||0)+1)),N},[c]),k=p.useMemo(()=>c.map(N=>{const E=N.cc?b.get(N.cc):void 0;if(!E)return null;const P=kt(N.name||N.id||""),O=kt((N.id||N.name||"")+"·y"),q=(P-.5)*Math.min(E.w*.55,60),D=(O-.5)*Math.min(E.h*.55,60);return{d:N,x:E.x+E.w/2+q,y:E.y+E.h/2+D}}).filter(N=>!!N),[c,b]),w=N=>v>0?N/v:N,S=p.useMemo(()=>r?[0,1,2,3,4,5].map(N=>({c:wt[N],fr:d.plabels[N].toUpperCase(),en:d.plabels[N].toUpperCase(),n:n.filter(E=>E.kind==="target"&&ee(E)===N).length})).filter(N=>N.n>0):it.map((N,E)=>({...N,n:n.filter(P=>st(P)===E).length})),[n,r,d.plabels]),C=o?i.get(o):null,F=C?k.find(N=>N.d.id===C.id):null;return e.jsxs("div",{className:"mapzone",ref:h,children:[e.jsxs("svg",{ref:u,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":f==="fr"?s.fr:s.en,onMouseLeave:()=>{x(null),l(null)},children:[e.jsx("g",{children:s.countries.map((N,E)=>e.jsx("g",{className:"ct"+(N.i2&&y.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},E))}),e.jsx("g",{children:k.map(N=>{const E=it[st(N.d)],P=!!K(N.d),O=N.d.kind==="target",q=r&&O?wt[ee(N.d)]:E.c,D=!r&&X(N.d);return e.jsxs("g",{className:"co"+(D?" done":""),onMouseEnter:()=>{var R,H;const T=(R=h.current)==null?void 0:R.getBoundingClientRect(),B=(H=u.current)==null?void 0:H.createSVGPoint();if(B&&u.current&&T){B.x=N.x,B.y=N.y;const oe=B.matrixTransform(u.current.getScreenCTM());x({x:oe.x-T.left,y:oe.y-T.top,label:N.d.name+" · "+(we(N.d.cc,f)||N.d.countryLabel||"")})}l(N.d.id)},onMouseLeave:()=>{x(null),l(null)},onClick:()=>{var R;const T=(R=u.current)==null?void 0:R.createSVGPoint();let B=null;if(T&&u.current){T.x=N.x,T.y=N.y;const H=T.matrixTransform(u.current.getScreenCTM());B={x:H.x,y:H.y}}a({type:"popup",id:N.d.id,anchor:B})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:w(Math.max(11,E.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:w(E.px),fill:q,stroke:P?"#DC2626":"#ffffff",strokeWidth:w(P?2.2:1.3)})]},N.d.id||N.d.name)})}),F&&e.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:w(13),fill:"none",stroke:"#0F172A",strokeWidth:w(2)})]}),e.jsx("div",{className:"hov"+(g?" on":""),style:g?{left:g.x,top:g.y}:void 0,children:g==null?void 0:g.label}),e.jsx("div",{className:"legend",children:S.map((N,E)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),f==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},E))}),n.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",d.notLocated," ",e.jsx("b",{children:n.filter(N=>!N.cc).length})]})})]})}function Mr(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:l,contName:o}=z(),i=t.filters,f=p.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),d=b=>f.filter(m=>b!=="country"&&i.country.length&&!i.country.includes(m.cc||"")?!1:Je(m,i,l,b==="country"?void 0:b)),u=p.useMemo(()=>{const b=d("win"),m=g=>b.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=g).length;return[m(0),m(7),m(30),b.length]},[f,i,l]),h=p.useMemo(()=>{if(l)return null;const b=d("status"),m={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(g=>{m[se(g)]+=1}),m},[f,i,l]),s=i.sector.length+i.country.length+i.engine.length+i.stage.length+i.angle.length+i.memoLevel.length+(i.signalOnly?1:0)+(i.win!=="all"?1:0)+(!l&&i.status!=="all"?1:0)+(i.search.trim()?1:0),v=(b,m,g,x="fbtn")=>e.jsxs("button",{type:"button",className:x,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:m}),g>0&&e.jsx("span",{className:"n",children:g}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,m)=>e.jsxs("button",{type:"button","aria-pressed":i.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[m],e.jsx("b",{children:u[m]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:i.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!l&&h&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,m])=>e.jsxs("button",{type:"button","aria-pressed":i.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[m,e.jsx("b",{children:h[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),i.signalOnly&&e.jsx("span",{className:"n",children:i.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,i.sector.length),v("pay",r.fCountry,i.country.length),v("det",r.fEngine,i.engine.length),v("sta",r.fStage,i.stage.length),l&&v("ang","Angle",i.angle.length),l&&v("mem","Mémo",i.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(f.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(Dr,{poolFor:d})]})}function Dr({poolFor:t}){const{st:a,dispatch:n,t:r,lang:l}=z(),o=a.filters,i=a.openFacet,{title:f,cols:d,options:u}=p.useMemo(()=>{if(i==="sig"){const m=t("signal").filter(c=>K(c)),g=new Map;m.forEach(c=>{const y=c.engine||"";g.set(y,(g.get(y)||0)+1)});const x=[{v:"*",label:r.fpSigAll,n:m.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...dt([...g.keys()],l).map(c=>({v:c,label:ve(c)+" "+ie(c,l),n:g.get(c)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(c)}))];return{title:r.fpSigTitle,cols:2,options:x}}if(i==="sec"){const m=t("sector"),g=new Map;return m.forEach(x=>{x.sector&&g.set(x.sector,(g.get(x.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((x,c)=>c[1]-x[1]).map(([x,c])=>({v:x,label:x,n:c,html:!1,on:o.sector.includes(x)}))}}if(i==="pay"){const m=t("country"),g=new Map;return m.forEach(x=>{x.cc&&g.set(x.cc,(g.get(x.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((x,c)=>c[1]-x[1]).map(([x,c])=>({v:x,label:we(x,l)||x,n:c,html:!1,on:o.country.includes(x)}))}}if(i==="det"){const m=t("engine"),g=new Map;return m.forEach(x=>{x.engine&&g.set(x.engine,(g.get(x.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:dt([...g.keys()],l).map(x=>({v:x,label:ve(x)+" "+ie(x,l)+' <span style="color:var(--dim);font-size:10px">· '+wa(ka(x),l)+"</span>",n:g.get(x)||0,html:!0,on:o.engine.includes(x)}))}}if(i==="ang"){const m=t("angle"),g=new Map;return m.forEach(x=>{x.angle&&g.set(x.angle,(g.get(x.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((x,c)=>c[1]-x[1]).map(([x,c])=>({v:x,label:x.replace(/[_-]+/g," "),n:c,html:!1,on:o.angle.includes(x)}))}}if(i==="mem"){const m=t("memoLevel"),g=new Map;m.forEach(c=>{if(c.kind==="target"){const y=We(c);g.set(y,(g.get(y)||0)+1)}});const x=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(c=>({v:String(c),label:x[c],n:g.get(c)||0,html:!1,on:o.memoLevel.includes(c)}))}}const v=t("stage"),b=new Map;return v.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,g)=>g[1]-m[1]).map(([m,g])=>({v:m,label:m,n:g,html:!1,on:o.stage.includes(m)}))}},[i,a,l]),h=v=>{if(i==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const m=o.signalEngines.includes(v)?o.signalEngines.filter(g=>g!==v):[...o.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(i==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage",value:v})},s=()=>{n(i==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:i==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:f}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(d===2?" two":""),children:u.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>h(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const jt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Pr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:l,dispatch:o,evalBusy:i,evalCards:f,caps:d,data:u}=z(),h=a==="client",[s,v]=p.useState(""),[b,m]=p.useState(!1),[g,x]=p.useState(""),[c,y]=p.useState(!1),[k,w]=p.useState(""),[S,C]=p.useState([]),F=p.useRef(!1),N=s.trim()?jt.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,E=p.useMemo(()=>g.split(`
`).map(T=>T.trim()).filter(Boolean).slice(0,15),[g]),P=S.length?S:f,O=u.credits,q=()=>{const T=s.trim();T&&(r(null,T),v(""))},D=async()=>{if(!h){r(null,E[0]||"");return}if(!E.length||c)return;y(!0),F.current=!1;const T=[];for(let B=0;B<E.length&&!F.current;B++){w(t.evaluating(B+1,E.length,E[B]));const R=await Lt(n,E[B],"atelier2");if(T.unshift({name:R.company||E[B],verdict:R.verdict,reason:R.reason||"",remaining:R.remaining??null}),C([...T]),R.verdict==="quota"){T.unshift({name:"",verdict:"quota",reason:t.quota(E.length-B-1),remaining:0}),C([...T]);break}}w(""),x(""),y(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:T=>v(T.target.value),onKeyDown:T=>{T.key==="Enter"&&q()}}),e.jsx("span",{className:"detect"+(jt.test(s.trim())?" url":""),children:N})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),disabled:i,onClick:q,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),d.showCredits&&O&&e.jsxs("button",{type:"button",className:"credits"+(O.total_available<=0&&!O.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:O.unlimited?"∞":O.total_available}),!O.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",O.daily_grant+O.purchased]}),O.total_available<=0&&!O.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>m(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:g,placeholder:t.bulkPh,onChange:T=>x(T.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{justifyContent:"center"},disabled:c||!E.length,onClick:()=>{D()},children:[e.jsx("span",{className:"fill"}),c&&k?k:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(E.length)})]})]}),P.slice(0,1).map((T,B)=>{const R=T.verdict==="kept",H=T.verdict==="quota",oe=R?"var(--brand)":H?"var(--bolt)":"var(--red)",de=R?"var(--brand-l)":H?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":oe,"--bgc":de},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:R?"✓ "+t.kept:H?"⏳":"✗ "+t.dropped})}),T.name&&e.jsx("span",{className:"rn",children:T.name}),e.jsx("span",{className:"rr",children:T.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",T.reason]}):null}),!H&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(R?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},B)}),h&&(l.kept+l.dropped>0||P.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(l.kept,l.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Br(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ir(){const{st:t,dispatch:a,byId:n,t:r,doDeep:l}=z(),o=t.memoConsole?n.get(t.memoConsole):null,i=p.useMemo(()=>o?[o.reasoning||"",Br(o.summary||"")].filter(Boolean).join(`
...
`).map((u,h)=>e.jsx("p",{style:{margin:"0 0 10px"},children:u},h)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[Ke(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>l(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:d===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}function Pt({name:t}){const{t:a,token:n,caps:r,mode:l,flashErr:o}=z(),[i,f]=p.useState(!1),[d,u]=p.useState(null);if(!r.pipe||l!=="client"||r.lockActions)return null;const h=async()=>{if(i)return;f(!0);const s=await ja(n,t);if(f(!1),!s){o(a.actErr);return}u(s.results||[])};return e.jsxs("div",{className:"simb",onClick:s=>s.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{h()},children:i?a.similarBusy:a.similar}),d&&(d.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:d.map(s=>e.jsxs("li",{children:[e.jsx("b",{className:s.verdict==="kept"?"ok":"ko",children:s.company}),s.reason&&e.jsx("span",{children:s.reason})]},s.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Bt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ze({o:t}){const{t:a}=z(),n=De(t),r=Pe(t),l=ee(t),o=He(t),i=Na(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(Bt[r]||"v-cons"),title:a.vt[r],children:r}):l===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,l===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),l===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),l===3&&i!==null&&e.jsx("span",{className:"wait2 "+(i>10?"hot":i>=5?"warm":""),title:a.waitTitle(i),children:a.waitChip(i)})]})}function Nt({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:l}=z(),[o,i]=p.useState(!1);if(p.useEffect(()=>{r||i(!1)},[r]),X(t)){const u=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":u?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[u?"✓":"✗"," ",e.jsx("b",{children:u?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const d=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:r,onClick:u=>{u.stopPropagation(),i(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function $r({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:l,doAnalyse:o,doDecide:i,doPromote:f,doRepeche:d,doApproach:u,dispatch:h}=z();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),h({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(Nt,{o:t})});const s=ee(t),v=b=>m=>{m.stopPropagation(),b()};if(s===0)return e.jsx("span",{className:"cell",children:e.jsx(Nt,{o:t})});if(s===1){const b=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:v(()=>o(t)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(s===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:v(()=>i(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:v(()=>i(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})});if(s===4){const b=l.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:b,onClick:v(()=>u(t)),children:b?a.actApproachSent:a.actApproach})})}return s===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>f(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):s===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>d(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:v(()=>h({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function Vr({o:t}){const{t:a,doThumb:n,thumbOf:r}=z(),l=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(l==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(l==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function Ur({o:t}){const{lang:a}=z();return K(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(ke,{o:t}),e.jsx(Be,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[ve(t.engine||"")," ",ie(t.engine||"",a)]})})}function _r({o:t,locked:a,open:n,onToggle:r}){const{st:l,dispatch:o,caps:i,markRow:f,markedId:d,favIds:u,toggleFav:h}=z(),s=ee(t),v=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,m=b<=0?0:b<=7?1:b<=30?2:3,g=i.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][s]:v[m],x=u.has(t.id),c=y=>{if(a)return;if(i.pipe){r();return}const k=y.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:k.left+Math.min(280,k.width/3),y:k.bottom}})};return e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"row"+(d===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>f(t.id),onMouseLeave:()=>f(null),onClick:c,children:[e.jsx("span",{className:"pt",style:{"--c":g}}),e.jsx(Vt,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[i.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:x?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),h(t)},children:x?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(y=>y&&y!==t.name)||""})]}),e.jsx(Hr,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(Ur,{o:t}),i.pipe&&e.jsx(Ze,{o:t}),i.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx($r,{o:t}),i.showThumbs&&e.jsx(Vr,{o:t})]}),(n||l.dens==="deplie")&&!a&&e.jsx(Yr,{o:t})]})}function Hr({o:t}){const{lang:a,caps:n}=z();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=Qe(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function Yr({o:t}){const{t:a,lang:n,dispatch:r,caps:l,outbound:o,doOnboard:i}=z();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),t.reasoning&&e.jsxs("div",{className:"dec"+(De(t)==="NO MATCH"?" out":""),title:t.reasoning,children:[e.jsx("em",{children:De(t)==="NO MATCH"?a.vOut:a.vKept}),t.reasoning.length>340?`${t.reasoning.slice(0,340)}…`:t.reasoning]}),t.ceoNote&&e.jsxs("div",{className:"ceonote",children:["💬 ",e.jsx("i",{children:t.ceoNote})]}),e.jsx(kr,{o:t}),e.jsx(Sr,{o:t}),e.jsx(Pt,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(Ze,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[ve(t.engine||"")," ",ie(t.engine||"",n)]}),K(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(ke,{o:t})})]}),l.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>i(t),children:a.actOnboard})]})]})]})}function Wr({o:t,locked:a}){const{t:n,dispatch:r,caps:l,doDecide:o}=z(),i=ee(t),f=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][i];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":f},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(Ze,{o:t}),K(t)&&e.jsx(ke,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&l.pipe&&i===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function Gr(){const t=z(),{st:a,dispatch:n,t:r,caps:l,scoped:o,lang:i,sessTally:f}=t,[d,u]=p.useState(new Set);p.useEffect(()=>{u(new Set)},[a.ptab,a.continent]);const h=k=>u(w=>{const S=new Set(w);return S.has(k)?S.delete(k):S.add(k),S}),s=p.useMemo(()=>Xe(o,a.sort),[o,a.sort]),v=p.useMemo(()=>s.filter(k=>K(k)&&!X(k)).length,[s]),b=l.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,m=(k,w,S="",C=!1)=>e.jsxs("button",{type:"button","data-s":k,className:S,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:C?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:k}),children:[w,e.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),g=p.useMemo(()=>{if(l.pipe||a.groupBy==="none")return null;const k=new Map;return s.forEach(w=>{const S=w.engine||"?";k.has(S)||k.set(S,[]),k.get(S).push(w)}),[...k.entries()]},[s,l.pipe,a.groupBy]),x=l.lockRowsAfter;let c=0;const y=(k,w)=>{const S=a.shown[w]||Me,F=k.slice(0,S).map(N=>{const E=x!==null&&c>=x;return c++,a.dens==="maxi"?e.jsx(Wr,{o:N,locked:E},N.id):e.jsx(_r,{o:N,locked:E,open:d.has(N.id),onToggle:()=>h(N.id)},N.id)});return k.length>S&&F.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:w,by:Me}),children:r.more(Math.min(Me,k.length-S),k.length-S)},w+":more")),F};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:s.length})," ",b]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,l.pipe&&t.fund?" · "+t.fund:""]}),l.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),l.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([k,w])=>e.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k,onClick:()=>n({type:"dens",dens:k}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:w})]},k))}),l.showChain&&s.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:s.filter(k=>l.pipe?!0:!X(k)).map(k=>k.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",l.pipe?r.browse(s.length):r.chainAll(s.filter(k=>!X(k)).length)]})]}),v>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(v)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),m("country",r.colCountry),m("name",r.colCompany),m("amount",r.colAmount,"h-amt",!0),m("stage",r.colStage,"h-stade"),m("signal",r.colSignal,"h-sig"),l.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),l.pipe&&m("score",r.colScore,"h-sc",!0),e.jsx("span",{}),l.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[g?g.map(([k,w])=>e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:ve(k)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:ie(k,i)}),e.jsx("div",{className:"s",children:r.grpCount(w.filter(S=>!X(S)).length,w.length)})]})]}),y(w,k)]},k)):y(s,"pt"+a.ptab),!s.length&&e.jsx("div",{className:"void",children:l.pipe?r.emptyTab:r.emptyScope})]}),l.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(f.kept>0||f.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(f.kept,f.dropped)}})]})}const Kr=`
...
`;function Qr(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,l=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let i=t.y+10;return i+n>l-8&&(i=Math.max(8,t.y-n-14)),i<8&&(i=8),{left:o,top:i}}function Jr(){const{st:t,dispatch:a,byId:n,t:r,lang:l,caps:o,mode:i,askEvaluate:f,doAnalyse:d,doDecide:u,doPromote:h,doRepeche:s,doApproach:v,doDeep:b,doOnboard:m,outbound:g,evalBusy:x}=z(),c=t.popupId?n.get(t.popupId):null;if(!c)return null;const y=K(c),k=ee(c),w=Pe(c),S=c.kind==="target",C=F=>{a({type:"filters",patch:F}),a({type:"popup",id:null})};return Te.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Kr}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Qr(t.popupAnchor),onClick:F=>F.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:c.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(ye(c.date)),ie(c.engine,l))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[c.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[c.cc]}),children:(we(c.cc,l)||c.countryLabel||"").toUpperCase()}),c.sector&&e.jsx("button",{type:"button",onClick:()=>C({sector:[c.sector]}),children:c.sector.toUpperCase()}),c.stage&&e.jsx("button",{type:"button",onClick:()=>C({stage:[c.stage]}),children:c.stage.toUpperCase()}),typeof c.amountEur=="number"&&c.amountEur>0&&e.jsx("span",{className:"am2",children:Qe(c.amountEur,l)})]}),(c.tagline||c.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:c.tagline||c.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[ve(c.engine)," ",e.jsx("b",{children:ie(c.engine,l)})," — ",Sa(c.engine,l),c.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",c.noteTitle]})]}),y?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(ke,{o:c,lg:!0})," ",e.jsx(Be,{o:c,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(Ft(y,l))," · ",r.win7(Rt(y,l))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),c.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&k>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:c.reasoning})]}),o.pipe&&S&&w&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[w,typeof c.score=="number"&&c.score>0?" · "+r.score(c.score):""]})})]}),e.jsx(Pt,{name:c.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||i!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[k===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>f(c),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),k===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(c),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),k===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(c),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),k===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(c,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{u(c,!1),a({type:"popup",id:null})},children:r.actNo}),Ke(c)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{b(c),a({type:"popup",id:null})},children:r.memoDeep})]}),k===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{v(c),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),k===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(c),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),c.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:c.id}),a({type:"popup",id:null})},children:"📄"}),g&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{m(c),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>f(c),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),c.website&&e.jsx("a",{className:"psite",href:c.website.startsWith("http")?c.website:"https://"+c.website,target:"_blank",rel:"noopener noreferrer",title:c.website,children:"🌐"})]})]})]}),document.body)}function St(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Xr(t,a){const n=Ca(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function Zr(t,a){const r=[a.head.split("|").map(St).join(";")];for(const l of t){const o=a.stageOf(l);r.push([l.name||"",Xr(l,a.plabels),De(l)||l.verdict||"",typeof l.score=="number"?l.score:"",l.countryLabel||l.cc||"",l.sector||"",o?a.stageLabel(o.stage):"",l.contactName||"",l.contactEmail||"",l.memoUrl||"",(l.date||"").slice(0,10),(l.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(St).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function en(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const tn=50;function et({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:l}=z(),[o,i]=p.useState(null),[f,d]=p.useState(!1),[u,h]=p.useState(""),[s,v]=p.useState(0),[b,m]=p.useState(""),[g,x]=p.useState(!1),c=p.useRef(null);p.useEffect(()=>()=>{c.current&&window.clearInterval(c.current)},[]);const y=async w=>{d(!0),h("");const S=await a();if(d(!1),S.ok){i(S);return}if(S.busy){h(l.alertPreviewBusy);return}if(!w){h(l.alertPreviewFail);return}v(tn),c.current=window.setInterval(()=>{v(C=>C>1?C-1:(c.current&&window.clearInterval(c.current),y(!1),0))},1e3)},k=async()=>{if(r||g)return;x(!0),m("");const w=await n();x(!1),m(w.ok?l.alertTestOk(w.sentTo||""):w.error||l.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:f||s>0,onClick:()=>{y(!0)},children:f?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||g,onClick:()=>{k()},children:g?"…":l.alertTest})]}),s>0&&e.jsx("p",{className:"mnote",children:l.alertPreviewRetry(s)}),u&&e.jsx("p",{className:"mnote warn",children:u}),b&&e.jsx("p",{className:"mnote",children:b}),!b&&e.jsx("p",{className:"mnote dim",children:l.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:l.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:l.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Ee="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Z({title:t,icon:a,children:n,wide:r}){const{dispatch:l}=z();return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&l({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>l({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function an(){const{st:t}=z();switch(t.modal){case"chain":return e.jsx(nn,{});case"space":return e.jsx(on,{});case"alert":return e.jsx(ln,{});case"queue":return e.jsx(un,{});case"export":return e.jsx(fn,{});case"plug":return e.jsx(gn,{});case"recharge":return e.jsx(bn,{});case"cover":return e.jsx(vn,{});case"crit":return e.jsx(yn,{});case"tuto":return e.jsx(wn,{});case"rdv":return e.jsx(rn,{});case"memoalert":return e.jsx(mn,{});default:return null}}function rn(){const{dispatch:t,fund:a}=z(),n=typeof document<"u"&&!!document.getElementById("rdv");return p.useEffect(()=>{n&&(t({type:"modal",modal:null}),mr())},[n,t]),n?null:e.jsx(Ta,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function nn(){const{st:t,dispatch:a,byId:n,t:r,lang:l,mode:o,askEvaluate:i,evalBusy:f}=z(),d=o==="client",u=t.chain.queue.map(b=>n.get(b)).filter(b=>!!b),h=t.chain.idx,s=u[h],v=h>=u.length;return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:v?r.finished:`${h+1} / ${u.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(v?100:h/Math.max(1,u.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:v||!s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(u.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:s.name}),e.jsx("div",{className:"sub",children:[we(s.cc,l)||s.countryLabel,s.sector,s.stage,r.daysAgo(ye(s.date))].filter(Boolean).map(b=>String(b).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:ie(s.engine,l).toUpperCase()}),typeof s.amountEur=="number"&&s.amountEur>0&&e.jsx("span",{children:Qe(s.amountEur,l)})]}),K(s)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(ke,{o:s,lg:!0})," ",e.jsx(Be,{o:s,src:!0})]}),(s.tagline||s.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:s.tagline||s.headline})]}),s.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:s.reasoning})]}),d&&X(s)&&e.jsxs("div",{className:"vbox",style:{"--c":se(s)==="retenu"?"var(--brand)":se(s)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:se(s)==="retenu"?"✓ "+r.kept:se(s)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:s.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!v&&s&&!(d&&X(s))&&e.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:f,onClick:()=>{i(s)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?r.closeBtn:r.skip})]})]})})}),document.body)}function on(){const{st:t,dispatch:a,dossiers:n,t:r,mode:l}=z(),o=l==="client",i=p.useMemo(()=>o?n.filter(s=>X(s)):[],[n,o]),f=p.useMemo(()=>Xe(i.filter(s=>se(s)==="retenu"),{key:"signal",dir:-1}),[i]),d=p.useMemo(()=>i.filter(s=>se(s)==="ecarte"),[i]),u=t.spaceTab==="retenu"?f:d,h=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(Z,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:f.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:d.length})]})]}),u.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),u.slice(0,40).map(s=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":h},children:typeof s.score=="number"&&s.score>0?s.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:s.name}),e.jsx("div",{className:"rr",children:s.reasoning||s.tagline||""})]})]},s.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function ln(){const{mode:t}=z();return t==="client"||t==="apercu"?e.jsx(sn,{}):e.jsx(pn,{})}function sn(){const{t,token:a,flash:n,flashErr:r,mode:l}=z(),[o,i]=p.useState("d"),f=l!=="client";return e.jsxs(Z,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>i("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>i("w"),children:t.alertTabWeekly})]}),o==="d"?e.jsx(dn,{t,token:a,readOnly:f,flash:n,flashErr:r}):e.jsx(cn,{t,token:a,readOnly:f,flash:n,flashErr:r})]})}function dn({t,token:a,readOnly:n,flash:r,flashErr:l}){const[o,i]=p.useState(null),[f,d]=p.useState(!1),[u,h]=p.useState(0);p.useEffect(()=>{let m=!0;return d(!1),ft(a).then(g=>{m&&(g?i(g):d(!0))}),()=>{m=!1}},[a,u]);const s=m=>{n||ft(a,m).then(g=>{if(!g){l(t.actErr);return}i(g),g.throttled?l(t.alertThrottled):r(t.alertSaved)})};if(f)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=m=>!o.sections||o.sections.includes(m),b=m=>{const g=o.sections||t.alertSec.map(([x])=>x);s({sections:v(m)?g.filter(x=>x!==m):[...g,m]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([m,g])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:v(m),disabled:n,onChange:()=>b(m)}),e.jsxs("span",{children:[g,m==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},m))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(et,{label:t.alertPreview,readOnly:n,onPreview:()=>Ra(a),onTest:()=>Fa(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function cn({t,token:a,readOnly:n,flash:r,flashErr:l}){const[o,i]=p.useState(null),[f,d]=p.useState(!1),[u,h]=p.useState(0);p.useEffect(()=>{let m=!0;return d(!1),mt(a).then(g=>{m&&(g?i(g):d(!0))}),()=>{m=!1}},[a,u]);const s=m=>{n||mt(a,m).then(g=>{if(!g){l(t.actErr);return}i(g),r(t.alertSaved)})};if(f)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=o.dow??0,b=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:v,disabled:n,onChange:m=>s({dow:Number(m.target.value)}),children:t.alertDow.map((m,g)=>e.jsx("option",{value:g,children:m},m))}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,b-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[b," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,b+1)}),disabled:n,children:"＋"})]})]}),e.jsx(et,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>Ma(a),onTest:()=>qa(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function pn(){const{st:t,t:a,lang:n,scoped:r,contName:l}=z(),[o,i]=p.useState(""),[f,d]=p.useState(!1),[u,h]=p.useState(!1),s=t.filters,v=p.useMemo(()=>r.filter(x=>K(x)).length,[r]),b=s.win==="1"?0:s.win==="7"?1:s.win==="30"?2:3,m=async()=>{if(!(!/.+@.+\..+/.test(o)||u)){h(!0);try{await fetch(`${Ye}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o.trim(),sectors:s.sector,countries:s.country,source:"atelier2",website:""})}),d(!0)}finally{h(!1)}}},g=[[a.amRows.continent,l],[a.amRows.since,a.amSince[b]],[a.amRows.signal,s.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,s.engine.length?s.engine.map(x=>ie(x,n)).join(", "):a.amAllEngines],[a.amRows.sectors,s.sector.length?s.sector.join(", "):a.amAllSectors],[a.amRows.countries,s.country.length?s.country.map(x=>we(x,n)||x).join(", "):a.amAllCountries],[a.amRows.stages,s.stage.length?s.stage.join(", "):a.amAllStages]];return e.jsx(Z,{title:a.alertTitle,icon:"🔔",children:f?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(o)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:g.map(([x,c])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:x}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:c}})]},x))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:o,onChange:x=>i(x.target.value),onKeyDown:x=>{x.key==="Enter"&&m()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},onClick:()=>void m(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function un(){var g,x,c;const{t,token:a,fund:n,mode:r,flash:l}=z(),[o,i]=p.useState(null),[f,d]=p.useState([]),[u,h]=p.useState(0),s=r==="client";p.useEffect(()=>{let y=!0;return(async()=>{const[k,w]=await Promise.all([Tt(n),At(a)]);y&&(k&&i(k),d(w))})(),()=>{y=!1}},[a,n,u]);const v=(o==null?void 0:o.per_day)??2,b=((g=o==null?void 0:o.analyzed_today)==null?void 0:g.length)??0,m=(x=o==null?void 0:o.tomorrow)!=null&&x.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(Z,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(b,b+(((c=o==null?void 0:o.pool_order)==null?void 0:c.length)??0))}})}),e.jsx("div",{className:"qrate",children:t.queueRate}),e.jsx("div",{className:"qrates",children:[1,2,3,5,10].map(y=>e.jsx("button",{type:"button",className:"qr"+(v===y?" on":""),disabled:!s,onClick:()=>{Ot(a,y).then(k=>{k!==null&&(h(w=>w+1),l(t.alertSaved))})},children:e.jsxs("b",{children:[y,"/j"]})},y))})]}),f.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:f.map(y=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:y.company}),e.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),e.jsx("span",{className:"qt",children:y.status}),y.url&&e.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),s&&y.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{ut(a,y.company,"retry").then(()=>h(k=>k+1))},children:t.queueRetry}),s&&y.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{ut(a,y.company,"delete").then(()=>h(k=>k+1))},children:t.queueDelete})]},y.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[m.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),m.slice(0,10).map((y,k)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",k+1]}),e.jsx("b",{children:y.name}),typeof y.score=="number"&&e.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function fn(){const{t,token:a,flash:n,scoped:r,caps:l,stageOf:o,dispatch:i}=z(),f=`${Ee}/cibles/list.csv?token=${a}`,d=`${Ee}/cibles/list.json?token=${a}`,u=`${Ee}/cibles/export.xlsx?token=${a}&scope=full`,h=`=IMPORTDATA("${f}")`,s=x=>{var c;(c=navigator.clipboard)==null||c.writeText(x).then(()=>n(t.exportCopied))},v=[{def:t.exportCsv,value:f,href:f},{def:t.exportSheet,value:h},{def:t.exportLive,value:d,href:d},{def:t.exportXlsx,value:u,href:u}],b=!l.lockActions&&r.length>0,m=()=>{en(Zr(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:x=>(t.stg.find(([c])=>c===x)||["",""])[1]})),n(t.exportViewDone(r.length))},g=()=>{i({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return e.jsxs(Z,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),b&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🖨️"}),e.jsxs("div",{children:[e.jsx("b",{children:t.printTitle}),e.jsx("p",{children:t.printDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb",onClick:g,children:t.printBtn})]})}),b&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:m,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:v.map(({def:x,value:c,href:y})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:x[0]}),e.jsxs("div",{children:[e.jsx("b",{children:x[1]}),e.jsx("p",{children:x[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>s(c),children:t.exportCopy}),y&&e.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},x[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function mn(){const{t,token:a,flash:n,flashErr:r,mode:l}=z(),o=l!=="client",[i,f]=p.useState(null),[d,u]=p.useState(!1),[h,s]=p.useState(0),[v,b]=p.useState(!1);p.useEffect(()=>{let c=!0;return u(!1),ct(a).then(y=>{c&&(y?f(y):u(!0))}),()=>{c=!1}},[a,h]);const m=()=>(i==null?void 0:i.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=c=>{if(o||!i)return;const y={enabled:c.enabled??!!i.enabled,email:c.email??(i.email||""),sections:c.sections??m()};b(!0),ct(a,y).then(k=>{if(b(!1),!k){r(t.memoAlertErr);return}f(k),n(t.memoAlertSaved)})};if(d)return e.jsx(Z,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>s(c=>c+1),children:t.retry})]})});if(!i)return e.jsx(Z,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const x=m();return e.jsxs(Z,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:o||v,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),e.jsx(xn,{value:i.email||"",readOnly:o||v,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:c=>g({email:c})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([c,y])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!x[c],disabled:o||v,onChange:()=>g({sections:{...x,[c]:!x[c]}})}),e.jsx("span",{children:y})]},c))}),e.jsx(et,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>Ea(a,x),onTest:()=>za(a,x)})]})}function xn({value:t,readOnly:a,label:n,okLabel:r,onSave:l}){const[o,i]=p.useState(t);p.useEffect(()=>{i(t)},[t]);const f=o.trim()!==t.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&f&&d&&l(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!f||!d,onClick:()=>l(o.trim()),children:r})]})]})}function gn(){const{t,token:a,flash:n,flashErr:r,canWrite:l}=z(),[o,i]=p.useState(null),[f,d]=p.useState(!1),[u,h]=p.useState(null),[s,v]=p.useState(""),[b,m]=p.useState(0);p.useEffect(()=>{let c=!0;return d(!1),pt(a).then(y=>{c&&(y?i({configured:y.configured,url_hint:y.url_hint}):d(!0))}),Oa(a).then(y=>{c&&h(y)}),()=>{c=!1}},[a,b]);const g=(c,y)=>{l&&pt(a,c).then(k=>{if(!k||k.ok===!1){r(t.actErr);return}c.test&&k.sent===!1?r(t.plugTestThrottled):n(y),m(w=>w+1)})},x='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(Z,{title:t.plugTitle,icon:"🔌",wide:!0,children:[u&&e.jsx("p",{className:"mnote"+(u.enabled?" warn":""),children:u.enabled?t.plugAutoOn(u.destination||"webhook"):t.plugAutoOff}),f?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>m(c=>c+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:s,disabled:!l,onChange:c=>v(c.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!l||!s.trim(),onClick:()=>g({url:s.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!l,onClick:()=>g({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!l,onClick:()=>g({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(hn,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:x}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var c;(c=navigator.clipboard)==null||c.writeText(x).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function hn(){const{t,token:a}=z(),[n,r]=p.useState("valides"),[l,o]=p.useState(!1),[i,f]=p.useState(null),d=async()=>{o(!0),f(await La(a,n)),o(!1)};return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:n,onChange:u=>r(u.target.value),children:t.plugBulkTabs.map(([u,h])=>e.jsx("option",{value:u,children:h},u))}),e.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{d()},children:l?"…":t.plugBulkPreview})]}),i&&(i.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(i.ready||0,i.linkedinReady||0,(i.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr}))]})}function bn(){const{t,data:a,lang:n}=z(),r=a.credits,l=a.email,o=async i=>{if(!l)return;const f=window.location.href.split("?")[0];try{const u=await(await fetch(`${Ye}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l,lookup_key:i,success_url:f+"?credits=ok",cancel_url:f+"?credits=cancel"})})).json();u.url&&(window.location.href=u.url)}catch{}};return e.jsxs(Z,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(i=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(i.credits,i.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(i.lookup_key)},children:t.rechargeBuy})]},i.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function vn(){const{t,data:a,dossiers:n}=z(),r=n.filter(o=>o.kind==="target"&&X(o)).length,l=a.marketEstimate||0;return e.jsx(Z,{title:t.coverTitle,icon:"🌍",children:l>0?e.jsx("p",{dangerouslySetInnerHTML:{__html:t.coverBody(r,l)}}):e.jsx("p",{children:t.coverScreened(r)})})}function yn(){var c,y,k;const{t,dossiers:a,token:n,mode:r,flash:l,criteria:o}=z(),i=r==="client",f=p.useMemo(()=>{const w=new Set;return a.forEach(S=>{S.angle&&w.add(S.angle)}),[...w]},[a]),[d,u]=p.useState(null);p.useEffect(()=>{let w=!0;return Aa(n).then(S=>{w&&u(S.thumbs)}),()=>{w=!1}},[n]);const[h,s]=p.useState(""),[v,b]=p.useState(""),[m,g]=p.useState(!1),x=async()=>{const w=h.trim();if(!(!w||m||!i)){g(!0),b("");try{const C=await(await fetch(`${Ee}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:w,who:"atelier2"})})).json().catch(()=>({}));if(C.reply&&b(String(C.reply)),C.job_id){b(t.critChatRunning);const F=async()=>{const N=await fetch(`${Ee}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:C.job_id})}).then(E=>E.json()).catch(()=>null);if(N&&N.done){b(String(N.reply||N.clarification||N.summary||"✓")),g(!1),N.applied&&l(t.alertSaved);return}setTimeout(()=>{F()},8e3)};setTimeout(()=>{F()},8e3),s("");return}s("")}finally{v.startsWith("⏳")||g(!1)}}};return e.jsxs(Z,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((c=o.points)!=null&&c.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(w=>e.jsx("li",{children:w},w))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(w=>{var S,C;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:w.title}),w.why&&e.jsx("p",{className:"why",children:w.why}),e.jsxs("div",{className:"lo",children:[!!((S=w.look)!=null&&S.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:w.look.map(F=>e.jsx("li",{children:F},F))})]}),!!((C=w.out)!=null&&C.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:w.out.map(F=>e.jsx("li",{children:F},F))})]})]})]},w.title)})]}),!!((k=o==null?void 0:o.gate)!=null&&k.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>e.jsxs("li",{children:[w.k&&e.jsx("b",{children:w.k}),w.t]},w.t))})]}),f.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(w=>e.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:h,disabled:!i||m,onChange:w=>s(w.target.value),onKeyDown:w=>{w.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!i||m||!h.trim(),onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),v&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:v})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),d===null?e.jsx("div",{className:"sp-empty",children:"…"}):d.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:d.slice(0,12).map((w,S)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:w.company}),e.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},S))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([w,S])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Bt[w]||"v-cons"),children:w}),e.jsx("span",{children:S})]},w))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([w,S])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:w}),e.jsxs("span",{children:["← ",S]})]},w))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function wn(){const{t,dispatch:a,startTour:n}=z(),r=l=>{var o,i;a({type:"modal",modal:null}),l==="crit"||l==="plug"||l==="alert"?a({type:"modal",modal:l}):l.startsWith("tab")?a({type:"ptab",tab:Number(l.slice(3))}):l==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(i=document.querySelector(".atl2 .demand input"))==null||i.focus())};return e.jsxs(Z,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([l,o],i)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:f=>{(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:i+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:l.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+i))})]})}const It="atl2:mapfold",kn=()=>{if(typeof window>"u")return!1;try{const t=localStorage.getItem(It);if(t==="on")return!0;if(t==="off")return!1}catch{}return window.innerHeight<1e3},$t=p.createContext(null),z=()=>{const t=p.useContext($t);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function ke({o:t,lg:a}){const{lang:n}=z(),r=K(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:xt(r,n),children:[r.emoji," ",xt(r,n)]}):null}function Be({o:t,src:a}){const{lang:n,t:r}=z(),l=K(t);if(!l)return null;const o=$a(l),i=Va(l);return e.jsxs("em",{className:"sigwin"+(i?" hot":""),title:r.signaledOn(Ft(l,n))+" · "+r.win7(Rt(l,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(f,d)=>e.jsx("i",{className:d<o?"on":""},d))}),e.jsx("span",{className:"lb",children:i?r.lastDay:r.daysLeft(Math.max(0,l.left??0))}),a&&l.url&&e.jsx("a",{href:l.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:f=>f.stopPropagation(),children:"↗"})]})}function Vt({o:t}){const{lang:a}=z(),n=Ia(t.cc),r=t.cc?we(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const Ct="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Ut=t=>`atl2:tour:${t||"anon"}`;function jn(t){try{return localStorage.getItem(Ut(t))==="1"}catch{return!0}}function zt(t){try{localStorage.setItem(Ut(t),"1")}catch{}}function Nn(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function An({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:l,onFiltersChange:o}){const{lang:i}=Da(),f=Qa[i],d=ir(t,i,a),[u,h]=p.useReducer(dr,void 0,()=>sr((r==null?void 0:r.continent)??"europe",t||kn(),{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),s=p.useRef(!0);p.useEffect(()=>{if(s.current){s.current=!1;return}if(!t)try{localStorage.setItem(It,u.mapFolded?"on":"off")}catch{}},[u.mapFolded,t]);const v=p.useRef(o);v.current=o,p.useEffect(()=>{var j;(j=v.current)==null||j.call(v,u.filters)},[u.filters]);const[b,m]=p.useState(null),[g,x]=p.useState(null),[c,y]=p.useState({kept:0,dropped:0}),[k,w]=p.useState(!1),[S,C]=p.useState(""),[F,N]=p.useState(!1),[E,P]=p.useState(null),[O,q]=p.useState(!1),[D,T]=p.useState(!1),[,B]=p.useState(0),R=()=>B(j=>j+1),H=p.useRef([]),oe=p.useRef(new Set),de=p.useRef(new Set),Ae=p.useRef(new Map),xe=p.useRef(null),{mode:ce}=d,Y=p.useMemo(()=>l?{...d.caps,...l}:d.caps,[d.caps,l]),V=Y.pipe,U=d.session.token||"",M=ce==="client"&&!t;p.useEffect(()=>{if(document.querySelector(`link[href="${Ct}"]`))return;const j=document.createElement("link");j.rel="stylesheet",j.href=Ct,document.head.appendChild(j)},[]);const I=(j,A=!1)=>{C(j),N(A),xe.current&&clearTimeout(xe.current),xe.current=setTimeout(()=>C(""),A?4200:2400)},_=j=>I(j,!0),re=p.useMemo(()=>{const j=new Map;return d.dossiers.forEach(A=>{A.id&&j.set(A.id,A)}),j},[d.dossiers]),te=p.useMemo(()=>d.dossiers.filter(j=>Mt(j,u,V)),[d.dossiers,u,V]),Q=p.useRef(!1);p.useEffect(()=>{if(Q.current||t||d.loading||!d.dossiers.length)return;if(!Y.showFunnel||jn(d.session.token||"")){Q.current=!0;return}Q.current=!0;const j=window.setTimeout(()=>{zt(d.session.token||""),q(!0)},700);return()=>window.clearTimeout(j)},[t,d.loading,d.dossiers.length,Y.showFunnel,d.session.token]);const J=p.useMemo(()=>d.dossiers.filter(j=>cr(j,u,V,d.favIds)),[d.dossiers,u,V,d.favIds]),je=p.useMemo(()=>Pa(te,d.favIds),[te,d.favIds]),$=Ge.find(j=>j.key===u.continent),le=i==="fr"?$.fr:$.en,pe=(j,A)=>{const L=((j==null?void 0:j.name)||A||"").trim();if(!M){x({kicker:L});return}!L||k||(w(!0),(async()=>{try{const W=await Lt(U,L,"atelier2"),Oe={name:W.company||L,verdict:W.verdict,reason:W.reason||"",remaining:W.remaining??null};H.current=[Oe,...H.current].slice(0,8),W.verdict==="kept"&&y(ue=>({...ue,kept:ue.kept+1})),W.verdict==="ruled_out"&&y(ue=>({...ue,dropped:ue.dropped+1}));const Ce=j||d.dossiers.find(ue=>(ue.name||"").toLowerCase()===L.toLowerCase());Ce&&(W.verdict==="kept"?Ce.verdict=Ce.verdict||"MATCH":W.verdict==="ruled_out"&&(Ce.verdict="NO MATCH"),W.reason&&(Ce.reasoning=W.reason)),R()}finally{w(!1)}})())},Ne=j=>{if(!M){x({kicker:j.name});return}oe.current.add(j.id),ze(U,"fast_request",j.name||"",""),I(f.memoInstantSent(j.name)),R()},ge=j=>Ae.current.get(j.id)??d.thumbs.get((j.name||"").trim().toLowerCase()),ae=(j,A)=>h({type:"undoPush",entry:{id:j.id,name:j.name,prevCeoStatus:A}}),he=async(j,A,L)=>{const W=j.ceoStatus||"";j.ceoStatus=A,R();const Oe=await Ve(U,{status:A,airtable_id:j.airtableId,check_id:j.checkId,company:j.name,...(L==null?void 0:L.note)!==void 0?{note:L.note}:{},...L!=null&&L.via?{via:L.via}:{}});return Oe.ok?Oe.skipped?(j.ceoStatus=W,R(),_(f.actNotPersisted),!1):((L==null?void 0:L.undo)!==!1&&ae(j,W),L!=null&&L.msg&&I(L.msg),(A==="Validé"||A==="Écarté")&&!j.ceoNote&&(L==null?void 0:L.note)===void 0&&P({o:j,yes:A==="Validé"}),!0):(j.ceoStatus=W,R(),_(f.actErr),!1)},Se=async(j,A)=>{const L=await Ve(U,{status:j.ceoStatus||"Retenu",airtable_id:j.airtableId,check_id:j.checkId,company:j.name,note:A,via:"note"});return!L.ok||L.skipped?(_(L.skipped?f.actNotPersisted:f.actErr),!1):(j.ceoNote=A,R(),!0)},ne=p.useRef(new Map),be=j=>ne.current.has(j.id)?ne.current.get(j.id):d.stages.get((j.name||"").trim().toLowerCase()),_t=(j,A)=>{ne.current.set(j.id,A),R()},Ht=(j,A)=>{M&&he(j,A?"Validé":"Écarté",{msg:A?f.decidedYes(j.name):f.decidedNo(j.name)})},Yt=j=>{M&&he(j,"À trancher",{msg:f.promoted(j.name)})},Wt=j=>{M&&(async()=>{const A=j.ceoStatus||"";j.ceoStatus="Retenu",R();const L=await Ve(U,{status:"Retenu",check_id:j.checkId,company:j.name});if(!L.ok||L.skipped){j.ceoStatus=A,R(),_(L.skipped?f.actNotPersisted:f.actErr);return}ae(j,A),I(f.repeched(j.name))})()},Gt=()=>{const j=u.undo[u.undo.length-1];if(!j){I(f.undoNone);return}const A=re.get(j.id);if(!A){h({type:"undoPop"}),I(f.undoNone);return}let L=j.prevCeoStatus;if(!L)if((A.verdict||"").toUpperCase().includes("CALL"))L="À trancher";else{I(f.undoLockedTitle);return}(async()=>await he(A,L,{undo:!1})&&(h({type:"undoPop"}),A.ceoStatus=j.prevCeoStatus,R(),I(f.undoDone(A.name))))()},Kt=j=>{M&&(de.current.add(j.id),R(),(async()=>{const A=await Ua(U,j.name,"email");if(!A||A.ok===!1){de.current.delete(j.id),R(),_(f.actErr);return}ze(U,"approach",j.name||"",""),I(f.actApproachSent)})())},Qt=(j,A)=>{M&&(async()=>{if(!(await ze(U,A?"yes":"no",j.name||"","")).ok){_(f.actErr);return}Ae.current.set(j.id,A?"yes":"no"),R(),I(A?f.thumbUpDone:f.thumbDnDone)})()},Jt=j=>{!M||!Ke(j)||(ze(U,"detailed_request",j.name||"",""),I(f.memoDeepSent(j.name)))},Xt=j=>{const A=new Set(d.favIds),L=A.has(j.id);L?A.delete(j.id):A.add(j.id),d.setFavIds(A),M&&_a(U,{id:j.id,co:j.name},L)},Zt=()=>{!M||D||window.confirm(f.identSyncConfirm)&&(T(!0),(async()=>{const j=await Ha(U);T(!1),j?I(f.identSyncDone):_(f.actErr)})())},tt=/proplace/i.test(d.fund||""),ea=j=>{!M||!tt||(ze(U,"onboard_request",j.name||"",""),I(f.onboardSent(j.name)))},ta={st:u,dispatch:h,t:f,lang:i,mode:ce,caps:Y,pipe:V,token:U,fund:d.fund,email:d.email,criteria:d.criteria,data:d,doRepeche:Wt,thumbOf:ge,canWrite:M,commitStatus:he,saveNote:Se,stageOf:be,setStage:_t,flashErr:_,startTour:()=>q(!0),dossiers:d.dossiers,scopedAll:te,scoped:J,counts:je,byId:re,contName:le,favIds:d.favIds,toggleFav:Xt,askEvaluate:pe,doAnalyse:Ne,doDecide:Ht,doPromote:Yt,doApproach:Kt,doThumb:Qt,doDeep:Jt,doUndo:Gt,doSync:Zt,doOnboard:ea,outbound:tt,memoQueued:oe.current,approachDone:de.current,sessTally:c,evalCards:H.current,evalBusy:k,markRow:m,markedId:b,flash:I};return p.useEffect(()=>{const j=A=>{A.key==="Escape"&&(h({type:"popup",id:null}),h({type:"modal",modal:null}),h({type:"openFacet",facet:null}))};return window.addEventListener("keydown",j),()=>window.removeEventListener("keydown",j)},[]),e.jsx($t.Provider,{value:ta,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Za}),e.jsxs("div",{className:"app"+(V?" pipe":""),children:[Y.showTicker&&e.jsx(G,{name:"live",children:e.jsx(pr,{})}),Y.showIdent&&e.jsx(G,{name:"identite",children:e.jsx(Er,{})}),Y.showOnb&&e.jsx(G,{name:"onboarding",children:e.jsx(Tr,{})}),e.jsx(G,{name:"matin",children:e.jsx(zr,{})}),e.jsx(G,{name:"fraicheur",children:e.jsx(vr,{})}),e.jsx(G,{name:"mesure",children:e.jsx(yr,{})}),Y.showFunnel&&e.jsx(G,{name:"entonnoir",children:e.jsx(Sn,{})}),Y.showFunnel&&e.jsx(G,{name:"tunnel",children:e.jsx(Or,{})}),Y.showFunnel&&e.jsx(G,{name:"tuto",children:e.jsx(Fr,{})}),e.jsx(G,{name:"carte",fallback:e.jsx("div",{className:"void",children:f.loadError}),children:e.jsxs("div",{className:"fzone",children:[e.jsx(Cn,{}),e.jsxs("div",{className:"stage"+(u.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(qr,{}),e.jsx(Mr,{})]})]})}),Y.showDemand&&e.jsx(G,{name:"evaluation",children:e.jsx(Pr,{})}),Y.showDemand&&u.memoConsole&&e.jsx(G,{name:"console",children:e.jsx(Ir,{})}),e.jsx(G,{name:"liste",fallback:e.jsxs("div",{className:"void",children:[f.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:f.retry})]}),children:e.jsx(Gr,{})}),d.loading&&e.jsx("div",{className:"void",children:f.loadingV2}),d.error&&!d.loading&&e.jsxs("div",{className:"void",children:[f.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:f.retry})]})]}),Y.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:f.lockbarText}),e.jsx("button",{type:"button",onClick:()=>h({type:"modal",modal:"rdv"}),children:f.lockbarCta})]}),u.popupId&&e.jsx(G,{name:"fiche",children:e.jsx(Jr,{})}),e.jsx(G,{name:"modales",children:e.jsx(an,{})}),e.jsx(gr,{}),E&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:E.o.name}),e.jsx(Nr,{placeholder:E.yes?f.whyYesPh:f.whyNoPh,onDone:j=>{const A=E.o;P(null),j&&Se(A,j).then(L=>{L&&I(f.csNoteSaved)})}})]}),O&&e.jsx(Cr,{steps:Nn(f),onClose:()=>{q(!1),zt(U)}}),S&&e.jsx("div",{className:"flash on"+(F?" err":""),children:S}),g&&e.jsx(Ba,{variant:"acquirer",initialCompany:Et().co,initialWebsite:Et().site,onClose:()=>x(null)})]})})}function Sn(){const{t}=z(),[a,n]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Cn(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:l,t:o}=z(),i=p.useMemo(()=>{const f={};return t.forEach(d=>{d.continent&&Je(d,a.filters,r)&&(f[d.continent]=(f[d.continent]||0)+1)}),f},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[Ya.map(f=>{const d=Ge.find(u=>u.key===f);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===f,onClick:()=>n({type:"continent",key:f}),children:[l==="fr"?d.fr:d.en,e.jsx("span",{className:"n",children:i[f]||0})]},f)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Et(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function zn(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{Vt as FlagCell,ke as SigBadge,Be as SigWin,An as default,zn as fmtShort,z as useV2};
