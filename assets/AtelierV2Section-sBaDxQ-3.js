...
.atl2 .bulk .side .hint{white-space:nowrap}`,Qs=`
...
`,Xs=Ys+Qs+Ks+Js;function ln(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Zs(){const e=ln("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function el(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Zs();return r==="0"?"client":r==="1"||ln("embed")==="1"&&ln("chrome")==="1"?"apercu":"client"}const tl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},al=e=>tl[e];function Sa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const zt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!ro(a)||Sa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:qi(e.cc)})};function Wa(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const nl=60*60*1e3;function rl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>nl?null:a}catch{return null}}function ca(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ol=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function il(e,a,r="default"){const n=r!=="default",o=c.useMemo(()=>e||n?{mode:"anon"}:vi(),[e,n]),i=c.useMemo(()=>n?"visiteur":el(e,o),[e,o,n]),d=c.useMemo(()=>al(i),[i]),s=i!=="visiteur",l=ol(r),[g,p]=c.useState([]),[x,u]=c.useState(""),[b,m]=c.useState(null),[w,k]=c.useState(null),[h,v]=c.useState(null),[j,y]=c.useState(()=>new Map),[E,N]=c.useState(()=>new Map),[C,L]=c.useState(""),[q,I]=c.useState(new Set),[F,$]=c.useState(null),[R,D]=c.useState(!0),[f,A]=c.useState(!1),[H,X]=c.useState(0),[S,O]=c.useState(0),M=c.useRef(0),_=c.useMemo(()=>{var Z;if(i!=="client")return"";try{return((Z=yi())==null?void 0:Z.email)||""}catch{return""}},[i]);c.useEffect(()=>{const Z=++M.current;let be=!0;const te=()=>be&&Z===M.current,pe=(s&&o.token?o.token:"pub:"+a)+(l?":"+l:""),me=rl(pe);return me?(p(me.objs.map(zt)),me.fund&&u(me.fund),m(me.marketEstimate??null),k(me.criteria??null),v(me.stats??null),L(me.generatedAt||""),D(!1)):D(!0),(async()=>{try{if(r==="ops"){const ge=await $a(),B=((ge==null?void 0:ge.recent_ops)||[]).map(Q=>{const G=ya(Q.company_name||Q.title?Q:{...Q,title:(Q.headline_fr||Q.headline||"").slice(0,120)},a),ae=String(Q.rubrique||"").toLowerCase();return G&&(ae==="nominations"||ae==="recrutements")&&(G.engine=ae),G&&!String(Q.company_name||"").trim()&&(G.noCo=!0),G}).filter(Q=>!!Q).map(Q=>(ro((Q.name||"").trim())||(Q.noCo=!0),Q));try{const Q=wi(),G=await ki(),ae=((G==null?void 0:G.date)||"").slice(0,10),U=Q?Q.doc:G,se=ji(U),le=((Q==null?void 0:Q.day)||(U==null?void 0:U.date)||ae||"").slice(0,10);if(le&&se.length){const ne=new Set;for(const ue of B){if((ue.date||"").slice(0,10)!==le)continue;const de=Hn(se,ne,ue.name,"");de>=0&&(ne.add(de),ue.decryptHtml=se[de].html)}for(const ue of B){if(ue.decryptHtml||(ue.date||"").slice(0,10)!==le)continue;const de=Hn(se,ne,"",ue.headline||ue.tagline||ue.name);de>=0&&(ne.add(de),ue.decryptHtml=se[de].html)}}if(le){const ne=((U==null?void 0:U.title_fr)||"").trim(),ue=((U==null?void 0:U.lead_fr)||"").trim(),de=Ei(U),xe=((U==null?void 0:U.url)||"").trim();ne&&(de||xe)&&B.unshift({id:`edito:${le}`,kind:"op",name:ne,cc:null,date:le,engine:"edito",dealKind:"other",headline:ne,tagline:ue||ne,decryptHtml:de||void 0,url:xe,noCo:!0})}}catch{}if(!te())return;p(B.map(zt)),ca(pe,{objs:B})}else if(typeof r=="object"){const B=(await Vn()||[]).filter(G=>(G.slug||"")===r.research).map(G=>Wn(G,a)).filter(G=>!!G),Q=Wa(await Gn(B,a));if(!te())return;p(Q.map(zt)),ca(pe,{objs:Q})}else if(s&&o.token){const ge=Ni(o.token),B=$a(),Q=Si(o.token),G=Ci(o.token),ae=zi(o.token),U=await ge;let se=U?U.targets:[];te()&&U&&(u(U.fund||""),m(U.marketEstimate??null),k(U.criteria??null),v(U.stats??null),L(U.generatedAt||""),p(se.map(zt)),D(!1),A(!1));const[le,ne,ue,de]=await Promise.all([B,Q,G,ae]),xe=((le==null?void 0:le.recent_ops)||[]).map(Ce=>ya(Ce,a)).filter(Ce=>!!Ce),Re=new Set(se.map(Ce=>Ce.id));if(se=[...se,...xe.filter(Ce=>!Re.has(Ce.id)&&(Re.add(Ce.id),!0))],!te())return;p(se.map(zt));const ye=new Set;for(const Ce of ne){const ze=(Ce.id||Ce.co||"").toString().trim().toLowerCase();ze&&ye.add(ze.startsWith("t:")?ze:"t:"+ze)}I(ye),y(ue),N(de),U&&ca(pe,{fund:U.fund,marketEstimate:U.marketEstimate,criteria:U.criteria,stats:U.stats,generatedAt:U.generatedAt,objs:se})}else{const ge=Ai(),B=Vn(),Q=$a(),G=await ge;te()&&G.length&&(p(Wa(G).map(zt)),D(!1),A(!1));const[ae,U]=await Promise.all([B,Q]),se=(ae||[]).map(de=>Wn(de,a)).filter(de=>!!de),le=await Gn(se,a),ne=((U==null?void 0:U.recent_ops)||[]).map(de=>ya(de,a)).filter(de=>!!de),ue=Wa([...G,...le,...ne]);if(!te())return;p(ue.map(zt)),ca(pe,{objs:ue})}te()&&A(!1)}catch{te()&&!me&&A(!0)}finally{te()&&D(!1)}})(),()=>{be=!1}},[s,o.token,a,H,l]),c.useEffect(()=>{if(!d.showCredits||!_){$(null);return}let Z=!0;return(async()=>{try{const be=await fetch(`${Ia}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:_})});if(!be.ok)return;const te=await be.json();Z&&te&&te.ok!==!1&&$(te)}catch{}})(),()=>{Z=!1}},[d.showCredits,_,S]);const ee=c.useCallback(Z=>I(new Set(Z)),[]);return{session:o,mode:i,caps:d,fund:x,email:_,marketEstimate:b,generatedAt:C,criteria:w,stats:h,thumbs:j,stages:E,dossiers:g,patchStatuses:(Z,be)=>{p(te=>{let pe=!1;const me=te.map(ge=>{if(!ge.checkId)return ge;const B=Z.get(ge.checkId);return!B||B===(ge.ceoStatus||"")||!be(ge.id)?ge:(pe=!0,{...ge,ceoStatus:B})});return pe?me:te})},favIds:q,setFavIds:ee,credits:F,reloadCredits:()=>O(Z=>Z+1),loading:R,error:f,refresh:()=>X(Z=>Z+1)}}function Qe(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const wa=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ca(e){return wa.has(e.engine||"")}function Ye(e){return!!e.noCo||Ca(e)&&!!e.url}const xo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),sl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...xo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,memoTab:0,undo:[],mapFolded:a}),ll=new Set(["signal","amount","score","crible","memo"]);function dl(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:xo(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ll.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??bo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const bo=80;function za(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Pe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Nn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(yt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&qt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(io(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function ta(e,a,r){return Qe(e)?za(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:za(e,a.filters,r)}function pl(e,a,r,n){return!(!ta(e,a,r)||r&&!oo(e,a.ptab,n))}function An(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-yt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Li(o)||null;case"memo":return Ti(o)||null;case"signal":{const i=Pe(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),s=n(i);return d===null||s===null?d===s?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<s?-a.dir:d>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const Ga={},pr=(Ga==null?void 0:Ga.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function cr(){return new Date().toISOString().slice(0,10)}const qn=c.createContext(null);function vo(){return c.useContext(qn)}function cl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(l=>l.remove()),s.querySelectorAll("*").forEach(l=>{const g=l.tagName==="A"?l.getAttribute("href"):null;[...l.attributes].forEach(p=>l.removeAttribute(p.name)),g&&/^https?:\/\//i.test(g)&&(l.setAttribute("href",g),l.setAttribute("target","_blank"),l.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:s.outerHTML})}}catch{}return a}function ul(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),l=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!s&&!l&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function ur(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function mr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function yo(){const e=c.useContext(qn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ml({token:e,children:a}){const{dispatch:r,st:n,lang:o}=K(),[i,d]=c.useState(()=>n.filters.day||cr()),[s,l]=c.useState(null),[g,p]=c.useState(!1),x=c.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),u=c.useCallback(()=>{d(cr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);c.useEffect(()=>{const w=k=>{var v;const h=(v=k.detail)==null?void 0:v.day;typeof h=="string"&&x(h)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),c.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),c.useEffect(()=>{if(!e||!i)return;let w=!1;p(!0);const k=new URLSearchParams({token:e,date:i});return fetch(`${pr}/cibles/edition.json?${k}`).then(h=>h.json()).then(h=>{w||l(h)}).catch(()=>{w||l({ok:!1,error:"network"})}).finally(()=>{w||p(!1)}),()=>{w=!0}},[e,i]);const b=c.useMemo(()=>`${pr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=c.useMemo(()=>({token:e,day:i,ed:s,loading:g,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,g,x,u,n.filters.day,b,o]);return t.jsx(qn.Provider,{value:m,children:a})}function fl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=yo(),[o,i]=c.useState(()=>n||so());return c.useEffect(()=>{n&&i(!0)},[n]),c.useEffect(()=>{const d=s=>{var l;return i(!!((l=s.detail)!=null&&l.open))};return window.addEventListener(Ea,d),()=>window.removeEventListener(Ea,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Fi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function hl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function fr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function hr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function gl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=yo(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!d,l=a&&!a.ok,g=c.useRef(null),[p,x]=c.useState("fonds"),[u,b]=c.useState(null),[m,w]=c.useState("idle"),k=c.useRef(!1);c.useEffect(()=>{b(null),w("idle"),k.current=!1,x("fonds")},[e]),c.useEffect(()=>{if(p!=="jour"||k.current)return;k.current=!0;let E=!0;return w("load"),hl(e).then(N=>{E&&(b(N),w("fait"))}),()=>{E=!1}},[p,e]);const h=c.useMemo(()=>ul((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),v=c.useRef(null);c.useEffect(()=>{const E=v.current;if(!E||!h)return;let N=!1;return rn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{N=!0}},[h]);const j=c.useMemo(()=>ur((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),y=c.useMemo(()=>ur((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return c.useEffect(()=>{const E=g.current;if(!E||!j)return;let N=!1;return rn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{N=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":p==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":p==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),p==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),p==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p==="fonds"&&l&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),p==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?fr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:mr(e,!0)}),"."]}):fr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:mr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),p==="fonds"&&d&&j?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,p==="fonds"&&d&&y?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:y}}):null,p==="jour"&&(h?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:v,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:h}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:hr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:hr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const xl=300,ua=7,bl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},wo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},vl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ya(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Di(r)&&r!=="media")return"news:"+r;const n=Pe(e);return n?"sig:"+(n.theme&&wo.fr[n.theme]?n.theme:"other"):"actualites"}function yl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:s}=K(),l=vo(),g=d==="en",[p,x]=c.useState("all"),[u,b]=c.useState(!1),m=c.useMemo(()=>{var be;const f=(a.filters.day||"").slice(0,10),A=te=>!(!i&&a.continent!=="monde"&&te.continent!==a.continent||f&&(te.date||"").slice(0,10)!==f),H=e.filter(te=>A(te)&&Pe(te)&&(!i||te.kind!=="target"||Se(te)!==5)),X=i&&(((be=l==null?void 0:l.ed)==null?void 0:be.ops)||[]).length?l.ed.ops.map(te=>ya(te,d)).filter(te=>!!te).map(te=>(te.briefOnly=!0,te)).filter(te=>!f||(te.date||"").slice(0,10)===f):[],S=e.filter(te=>A(te)&&te.kind==="op"&&(f?!0:yt(te.date)<=ua)),O=i?X.length?X:S.filter(te=>{const pe=(s||"").trim().toLowerCase();if(!pe)return!1;const me=te.match||null;return me?Object.keys(me).map(ge=>ge.trim().toLowerCase()).includes(pe):!1}):S,M=f||new Date().toISOString().slice(0,10),_=te=>{const pe=Ya(te);return pe==="ma"?0:pe==="levees"?1:2};O.sort((te,pe)=>{const me=_(te)-_(pe);if(me)return me;const ge=(te.date||"").slice(0,10)===M?0:1,B=(pe.date||"").slice(0,10)===M?0:1;return ge!==B?ge-B:(pe.amountEur||0)-(te.amountEur||0)});const ee=new Set,Z=[];for(const te of[...O,...An(H,{key:"signal",dir:-1})]){const pe=te.id||te.name;!pe||ee.has(pe)||(ee.add(pe),Z.push(te))}return i&&Z.length===0?e.filter(pe=>A(pe)&&yt(pe.date)<=ua).sort((pe,me)=>(me.date||"").localeCompare(pe.date||"")).slice(0,80):Z},[e,a.continent,a.filters.day,i,s,d,l]),w=c.useMemo(()=>{const f={};for(const A of m){const H=Ya(A);f[H]=(f[H]||0)+1}return f},[m]),k=c.useMemo(()=>p==="all"?m:m.filter(f=>Ya(f)===p),[m,p]),h=c.useMemo(()=>k.slice(0,xl),[k]),v=k.length-h.length,j=c.useRef(null);c.useEffect(()=>{var O,M;const f=j.current;if(!f)return;const A=()=>{const _=f.scrollWidth;_<200||(f.style.animationDuration=Math.max(18,Math.round(_/130))+"s")};A();const H=requestAnimationFrame(A),X=window.setTimeout(A,1200);let S=!0;return(M=(O=document.fonts)==null?void 0:O.ready)==null||M.then(()=>{S&&A()}),()=>{S=!1,cancelAnimationFrame(H),window.clearTimeout(X)}},[h.length,p]);const y=f=>f==="all"?m.length:w[f]||0,E=f=>{if(f==="all")return g?"All":"Tout";if(f.startsWith("sig:"))return wo[g?"en":"fr"][f.slice(4)]||"🔔";if(f.startsWith("news:")){const A=f.slice(5);return Oi[A]?Mi(A,g?"en":"fr"):f}return bl[g?"en":"fr"][f]},N=[{k:"all"}],C=["ma","levees"].filter(f=>y(f)>0||f===p);if(C.length){N.push({g:g?"Deals":"Opérations"});for(const f of C)N.push({k:f})}const L=["nominations","recrutements"].filter(f=>y(f)>0||f===p),q=Ri.filter(f=>f!=="media").map(f=>"news:"+f).filter(f=>y(f)>0||f===p),I=y("actualites")>0||p==="actualites"?["actualites"]:[];if(L.length||q.length||I.length){N.push({g:g?"News":"Actualités"});for(const f of L)N.push({k:f});for(const f of q)N.push({k:f});for(const f of I)N.push({k:f})}const F=vl.map(f=>"sig:"+f).filter(f=>y(f)>0||f===p);if(F.length){N.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const f of F)N.push({k:f})}const $=f=>{try{return new Date(f+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return f}},R=(()=>{const f=(a.filters.day||"").slice(0,10),A=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return f?(g?`LIVE covers the events of ${$(f)}.`:`Le LIVE regroupe les événements du ${$(f)}.`)+A:(g?`LIVE covers the still-open signals and the deals of the last ${ua} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ua} derniers jours.`)+A})(),D=f=>h.map(A=>t.jsxs("button",{type:"button",className:"tk"+(_e(A)?" spent":""),onClick:H=>{const X=A.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:X?"":A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(X||n({type:"focus",id:A.id}),a.dens!=="liste"){const S=H.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:S.left+S.width/2,y:S.bottom}})}},title:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(jt,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(ri,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:rc(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx(Pa,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},f+(A.id||A.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},f+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:f=>{f.currentTarget.contains(f.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(f=>!f),children:[E(p),t.jsx("b",{children:y(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:R}),N.map(f=>"g"in f?t.jsx("span",{className:"tkfilg",children:f.g},f.g):t.jsxs("button",{type:"button","aria-pressed":f.k===p,onClick:()=>{x(f.k),b(!1)},children:[E(f.k),t.jsx("b",{children:y(f.k)})]},f.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:j,children:[D(0),D(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!l&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!l&&t.jsx(kl,{isEn:g})]})}const wl=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function kl({isEn:e}){const[a,r]=c.useState(()=>so());c.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Ea,o),()=>window.removeEventListener(Ea,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Ii(!a),children:wl})}const Tn="+33 6 83 10 72 86",Aa="alexandre@proplace.co",ko=`tel:${Tn.replace(/[^\d+]/g,"")}`;function jl(){return null}class it extends c.Component{constructor(){super(...arguments);Bn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const jo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function gr(e,a){if((Et(e)||"").startsWith("CALL")&&Se(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Se(e)>=2;return jo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const xr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",El={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function Nl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=K(),[s,l]=c.useState(""),[g,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null);if(c.useEffect(()=>{if(!x)return;const v=j=>{b.current&&!b.current.contains(j.target)&&(u(!1),p(!1))};return document.addEventListener("click",v,!0),()=>document.removeEventListener("click",v,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),w=async v=>{if(s)return;if(v==="Analysé"&&!e.memoUrl){p(!0);return}l(v);const j=(gr(e,a).find(([E])=>E===v)||[v,v])[1],y=await o(e,v,{msg:a.csMoved(e.name,j)});l(""),y&&(p(!1),u(!1))},k=gr(e,a),h=v=>(k.find(([j])=>j===v)||[])[1]||v;return k.length===2?t.jsx("span",{className:"rstat rst2",onClick:v=>v.stopPropagation(),children:k.map(([v,j])=>t.jsx("button",{type:"button",className:"rsd "+(v==="Validé"?"yes":"no")+(s===v?" busy":""),disabled:!!s,onClick:()=>{w(v)},children:j},v))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:v=>v.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!s,title:a.csLabel,className:"rsel rs-"+xr(m),onClick:()=>{u(v=>!v),p(!1)},children:s?h(s)+"…":m?h(m):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:k.map(([v,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===v,className:"rsopt"+(m===v?" on":"")+(s===v?" busy":""),disabled:!!s,onClick:()=>{if(v===m){u(!1);return}w(v)},children:[t.jsx("i",{className:"pt2",style:{background:El[xr(v)]}}),j]},v))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),p(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const v=await o(e,"Analysé");l(""),v&&(p(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function Sl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=K(),[i,d]=c.useState(""),[s,l]=c.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),p=(Et(e)||"").startsWith("CALL")&&Se(e)===3,x=Se(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(m);const w=await o(e,m);d(""),w&&(l(!0),setTimeout(()=>l(!1),2200))},b=p?[["Validé",a.csYes],["Écarté",a.csNo]]:jo.filter(([m])=>!(x&&m==="Retenu")).map(([m,w])=>[m,a[w]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,w])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:w},m)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Cl,{o:e})]})}function Cl({o:e}){const{t:a,saveNote:r,flash:n}=K(),[o,i]=c.useState(e.ceoNote||""),[d,s]=c.useState(!1),[l,g]=c.useState(!1),p=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!p)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!p,onClick:()=>{x()},children:l?a.csNoteSaved:a.csNoteOk})]})}function br({placeholder:e,onDone:a}){const{t:r}=K(),[n,o]=c.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function zl({o:e}){var k;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:s}=K(),[l,g]=c.useState(!1);if(!n.pipe||!o||n.lockActions||Se(e)!==4)return null;const p=i(e),x=(p==null?void 0:p.stage)||"todo",u=async h=>{if(l||h===x)return;g(!0);const v=p;d(e,{stage:h,stamps:(p==null?void 0:p.stamps)||{}});const j=Math.max(Date.now(),vr+=1);vr=j;const y=await Pi(r,{company:e.name||"",stage:h,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!y.stale&&(y.ok||(d(e,v),s(a.actErr)))},b=(k=p==null?void 0:p.stamps)==null?void 0:k.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,v])=>t.jsx("button",{type:"button",className:"stgb"+(x===h?" on":""),disabled:l,onClick:()=>{u(h)},children:v},h)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let vr=0;const Gt=8,kt=360;function yr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function wr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(yr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(yr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function Al({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=K(),[d,s]=c.useState(0),[l,g]=c.useState(null),[p,x]=c.useState([]),u=c.useRef(!1),b=c.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=c.useRef(!1);c.useEffect(()=>{const C=b.current;return()=>{m.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),c.useEffect(()=>{u.current||(u.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const w=p[d],k=d>=p.length;c.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const C=w.click,L=window.setTimeout(()=>{const q=document.querySelector(C);q&&q.getAttribute("aria-selected")!=="true"&&q.click()},60);return()=>window.clearTimeout(L)}},[d,w]);const h=c.useRef(-1),v=c.useCallback(()=>{if(!w){g(null);return}const C=I=>{if(!I)return null;for(const F of document.querySelectorAll(I)){const $=F.getBoundingClientRect();if($.width>1&&$.height>1)return F}return null},L=C(w.sel)||C(w.need);if(!L){g(null);return}h.current!==d&&(h.current=d,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const q=L.getBoundingClientRect();g(I=>I&&Math.abs(I.top-q.top)<1&&Math.abs(I.left-q.left)<1&&Math.abs(I.width-q.width)<1&&Math.abs(I.height-q.height)<1?I:q)},[w,d]);c.useLayoutEffect(()=>{v();const C=[90,300,700,1300].map(I=>window.setTimeout(v,I)),L=window.setInterval(v,400),q=()=>v();return window.addEventListener("scroll",q,!0),window.addEventListener("resize",q),()=>{C.forEach(I=>window.clearTimeout(I)),window.clearInterval(L),window.removeEventListener("scroll",q,!0),window.removeEventListener("resize",q)}},[v]);const j=c.useRef(a);if(j.current=a,c.useEffect(()=>{const C=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),j.current()):L.key==="ArrowRight"?s(q=>q+1):L.key==="ArrowLeft"&&s(q=>Math.max(0,q-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!p.length)return null;let y=null;const E=C=>()=>{m.current=!0,n({type:"modal",modal:null}),C()};if(k){const C=o[3]||0;C>0?y={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:E(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?y={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:E(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?y={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:E(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:E(()=>{n({type:"modal",modal:"crit"}),a()})}}let N={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:kt};if(!k&&l){const C=l.bottom+14,L=window.innerHeight-C;let q=L>190?C:Math.max(12,l.top-200),I=Math.min(Math.max(12,l.left+l.width/2-kt/2),window.innerWidth-kt-12);L<=190&&l.top<212&&(window.innerWidth-l.right>=kt+40?I=Math.min(l.right+26,window.innerWidth-kt-12):l.left>=kt+40&&(I=Math.max(12,l.left-kt-26)),q=Math.max(12,l.top-Gt)),N={left:I,top:q,width:kt}}return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!k&&l&&t.jsx("div",{className:"tour-hole",style:{left:l.left-Gt,top:l.top-Gt,width:l.width+Gt*2,height:l.height+Gt*2}}),(k||!l)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(k?" fin":""),style:N,children:[k&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(wr,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(p.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,p.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/p.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(wr,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>s(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(C=>C+1),children:d===p.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Eo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function No(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ql(){var L,q;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:s,dispatch:l}=K(),g=r?a:e,p=c.useMemo(()=>g.filter(I=>yt(I.date)===0&&I.kind==="target"),[g]),x=c.useMemo(()=>r?a.filter(I=>I.kind==="target"&&Se(I)===0).slice().sort((I,F)=>(F.date||"").localeCompare(I.date||"")):[],[a,r]),u=c.useMemo(()=>p.filter(I=>r?Se(I)===0:!_e(I)),[p,r]),b=r?x:u,m=r?a.length-x.length:p.length-u.length,w=r?a.length:p.length,k=w?Math.min(100,m/w*100):100,h=c.useMemo(()=>Eo(g),[g]),v=!!h&&yt(h)>0,j=c.useMemo(()=>v?g.filter(I=>(I.date||"").slice(0,10)===h):[],[g,h,v]),y=typeof((L=s.stats)==null?void 0:L.kept_today)=="number"?s.stats.kept_today:null,E=typeof((q=s.stats)==null?void 0:q.screened_today)=="number"?s.stats.screened_today:p.length;let N;v?N=o.morningLast(j.length,x.length,No(h,d)):r?N=o.morningThesis(E,x.length,y):p.length?m===0?N=o.goalSourced(p.length):m>=p.length?N=o.goalCleared:N=o.goalDone(m,p.length):N=o.goalSourced(0);const C=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&x.length&&l({type:"chainStart",queue:x.map(I=>I.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:k+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Tl(){var H,X;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:d,dossiers:s,mode:l,doSync:g,startTour:p,flash:x,flashErr:u}=K(),[b,m]=c.useState(null),[w,k]=c.useState(!0),[h,v]=c.useState([]),j=l==="client";c.useEffect(()=>{if(!o||!i)return;let S=!0;return k(!0),(async()=>{const[O,M]=await Promise.all([Sn(i),lo(o)]);S&&(O&&m(O),k(!1),v(M))})(),()=>{S=!1}},[o,i]);const[y,E]=c.useState(!1),N=()=>{!j||y||!i||(E(!0),_i(i).then(S=>{E(!1),S?x(e.identRepubDone):u(e.actErr)}))},C=(b==null?void 0:b.per_day)??null,L=((H=b==null?void 0:b.pool_order)==null?void 0:H.length)??0,q=h.filter(S=>S.status==="running").length,I=c.useMemo(()=>s.filter(S=>S.kind==="target"&&_e(S)).length,[s]),F=d.marketEstimate,$=typeof((X=d.stats)==null?void 0:X.screened)=="number"?d.stats.screened:I,R=F&&F>0?Math.min(100,Math.round($/F*100)):null,D=S=>S.toLocaleString(a==="en"?"en-US":"fr-FR"),f=(i||"P").split(/\s+/).map(S=>S[0]).join("").slice(0,2).toUpperCase(),A=(()=>{const S=Date.parse(d.generatedAt||"");if(Number.isNaN(S))return"";const O=new Date(S),M=_=>String(_).padStart(2,"0");return`${M(O.getDate())}/${M(O.getMonth()+1)} à ${M(O.getHours())}:${M(O.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?f:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),A?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(A)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||y,onClick:N,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:g,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:p,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:S=>n({type:"filters",patch:{search:S.target.value}})})]})]}),t.jsxs("div",{className:"idmain",children:[R===null&&$>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:D($)})})]}),R!==null&&F&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:R+"%"}})}),t.jsxs("b",{children:[R," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf($,F)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),C===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),q>0&&t.jsxs("span",{className:"ev",children:["⏳ ",q]})]}),t.jsxs("span",{className:"filec",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:a==="en"?"Queue":"File"}),t.jsx("span",{className:"ego",children:w?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:S=>{S.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]})]})]})}class Lt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,s=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);s&&(r[n++]=s),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*Ll(e){for(const a of e)yield*a}function So(e){return Array.from(Ll(e))}var Ne=1e-6,ve=Math.PI,at=ve/2,kr=ve/4,rt=ve*2,xt=180/ve,Je=ve/180,Ae=Math.abs,Fl=Math.atan,aa=Math.atan2,Le=Math.cos,Fe=Math.sin,Rl=Math.sign||function(e){return e>0?1:e<0?-1:0},Rt=Math.sqrt;function Ol(e){return e>1?0:e<-1?ve:Math.acos(e)}function na(e){return e>1?at:e<-1?-at:Math.asin(e)}function nt(){}function qa(e,a){e&&Er.hasOwnProperty(e.type)&&Er[e.type](e,a)}var jr={Feature:function(e,a){qa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)qa(r[n].geometry,a)}},Er={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){dn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)dn(r[n],a,0)},Polygon:function(e,a){Nr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Nr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)qa(r[n],a)}};function dn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Nr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)dn(e[r],a,1);a.polygonEnd()}function Dt(e,a){e&&jr.hasOwnProperty(e.type)?jr[e.type](e,a):qa(e,a)}function pn(e){return[aa(e[1],e[0]),na(e[2])]}function _t(e){var a=e[0],r=e[1],n=Le(r);return[n*Le(a),n*Fe(a),Fe(r)]}function ma(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ta(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Qa(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function fa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function cn(e){var a=Rt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function un(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function mn(e,a){return Ae(e)>ve&&(e-=Math.round(e/rt)*rt),[e,a]}mn.invert=mn;function Ml(e,a,r){return(e%=rt)?a||r?un(Cr(e),zr(a,r)):Cr(e):a||r?zr(a,r):mn}function Sr(e){return function(a,r){return a+=e,Ae(a)>ve&&(a-=Math.round(a/rt)*rt),[a,r]}}function Cr(e){var a=Sr(e);return a.invert=Sr(-e),a}function zr(e,a){var r=Le(e),n=Fe(e),o=Le(a),i=Fe(a);function d(s,l){var g=Le(l),p=Le(s)*g,x=Fe(s)*g,u=Fe(l),b=u*r+p*n;return[aa(x*o-b*i,p*r-u*n),na(b*o+x*i)]}return d.invert=function(s,l){var g=Le(l),p=Le(s)*g,x=Fe(s)*g,u=Fe(l),b=u*o-x*i;return[aa(x*o+u*i,p*r+b*n),na(b*r-p*n)]},d}function Dl(e,a,r,n,o,i){if(r){var d=Le(a),s=Fe(a),l=n*r;o==null?(o=a+n*rt,i=a-l/2):(o=Ar(d,o),i=Ar(d,i),(n>0?o<i:o>i)&&(o+=n*rt));for(var g,p=o;n>0?p>i:p<i;p-=l)g=pn([d,-s*Le(p),-s*Fe(p)]),e.point(g[0],g[1])}}function Ar(e,a){a=_t(a),a[0]-=e,cn(a);var r=Ol(-a[1]);return((-a[2]<0?-r:r)+rt-Ne)%rt}function Co(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:nt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ka(e,a){return Ae(e[0]-a[0])<Ne&&Ae(e[1]-a[1])<Ne}function ha(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function zo(e,a,r,n,o){var i=[],d=[],s,l;if(e.forEach(function(m){if(!((w=m.length-1)<=0)){var w,k=m[0],h=m[w],v;if(ka(k,h)){if(!k[2]&&!h[2]){for(o.lineStart(),s=0;s<w;++s)o.point((k=m[s])[0],k[1]);o.lineEnd();return}h[0]+=2*Ne}i.push(v=new ha(k,m,null,!0)),d.push(v.o=new ha(k,null,v,!1)),i.push(v=new ha(h,m,null,!1)),d.push(v.o=new ha(h,null,v,!0))}}),!!i.length){for(d.sort(a),qr(i),qr(d),s=0,l=d.length;s<l;++s)d[s].e=r=!r;for(var g=i[0],p,x;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;p=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,l=p.length;s<l;++s)o.point((x=p[s])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(p=u.p.z,s=p.length-1;s>=0;--s)o.point((x=p[s])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,p=u.z,b=!b}while(!u.v);o.lineEnd()}}}function qr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Ka(e){return Ae(e[0])<=ve?e[0]:Rl(e[0])*((Ae(e[0])+ve)%rt-ve)}function Il(e,a){var r=Ka(a),n=a[1],o=Fe(n),i=[Fe(r),-Le(r),0],d=0,s=0,l=new Lt;o===1?n=at+Ne:o===-1&&(n=-at-Ne);for(var g=0,p=e.length;g<p;++g)if(u=(x=e[g]).length)for(var x,u,b=x[u-1],m=Ka(b),w=b[1]/2+kr,k=Fe(w),h=Le(w),v=0;v<u;++v,m=y,k=N,h=C,b=j){var j=x[v],y=Ka(j),E=j[1]/2+kr,N=Fe(E),C=Le(E),L=y-m,q=L>=0?1:-1,I=q*L,F=I>ve,$=k*N;if(l.add(aa($*q*Fe(I),h*C+$*Le(I))),d+=F?L+q*rt:L,F^m>=r^y>=r){var R=Ta(_t(b),_t(j));cn(R);var D=Ta(i,R);cn(D);var f=(F^L>=0?-1:1)*na(D[2]);(n>f||n===f&&(R[0]||R[1]))&&(s+=F^L>=0?1:-1)}}return(d<-Ne||d<Ne&&l<-1e-12)^s&1}function Ao(e,a,r,n){return function(o){var i=a(o),d=Co(),s=a(d),l=!1,g,p,x,u={point:b,lineStart:w,lineEnd:k,polygonStart:function(){u.point=h,u.lineStart=v,u.lineEnd=j,p=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=w,u.lineEnd=k,p=So(p);var y=Il(g,n);p.length?(l||(o.polygonStart(),l=!0),zo(p,_l,y,r,o)):y&&(l||(o.polygonStart(),l=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),l&&(o.polygonEnd(),l=!1),p=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(y,E){e(y,E)&&o.point(y,E)}function m(y,E){i.point(y,E)}function w(){u.point=m,i.lineStart()}function k(){u.point=b,i.lineEnd()}function h(y,E){x.push([y,E]),s.point(y,E)}function v(){s.lineStart(),x=[]}function j(){h(x[0][0],x[0][1]),s.lineEnd();var y=s.clean(),E=d.result(),N,C=E.length,L,q,I;if(x.pop(),g.push(x),x=null,!!C){if(y&1){if(q=E[0],(L=q.length-1)>0){for(l||(o.polygonStart(),l=!0),o.lineStart(),N=0;N<L;++N)o.point((I=q[N])[0],I[1]);o.lineEnd()}return}C>1&&y&2&&E.push(E.pop().concat(E.shift())),p.push(E.filter(Pl))}}return u}}function Pl(e){return e.length>1}function _l(e,a){return((e=e.x)[0]<0?e[1]-at-Ne:at-e[1])-((a=a.x)[0]<0?a[1]-at-Ne:at-a[1])}const Tr=Ao(function(){return!0},Bl,Ul,[-ve,-at]);function Bl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var s=i>0?ve:-ve,l=Ae(i-a);Ae(l-ve)<Ne?(e.point(a,r=(r+d)/2>0?at:-at),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&l>=ve&&(Ae(a-n)<Ne&&(a-=n*Ne),Ae(i-s)<Ne&&(i-=s*Ne),r=$l(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=d),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function $l(e,a,r,n){var o,i,d=Fe(e-r);return Ae(d)>Ne?Fl((Fe(a)*(i=Le(n))*Fe(r)-Fe(n)*(o=Le(a))*Fe(e))/(o*i*d)):(a+n)/2}function Ul(e,a,r,n){var o;if(e==null)o=r*at,n.point(-ve,o),n.point(0,o),n.point(ve,o),n.point(ve,0),n.point(ve,-o),n.point(0,-o),n.point(-ve,-o),n.point(-ve,0),n.point(-ve,o);else if(Ae(e[0]-a[0])>Ne){var i=e[0]<a[0]?ve:-ve;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Hl(e){var a=Le(e),r=2*Je,n=a>0,o=Ae(a)>Ne;function i(p,x,u,b){Dl(b,e,r,u,p,x)}function d(p,x){return Le(p)*Le(x)>a}function s(p){var x,u,b,m,w;return{lineStart:function(){m=b=!1,w=1},point:function(k,h){var v=[k,h],j,y=d(k,h),E=n?y?0:g(k,h):y?g(k+(k<0?ve:-ve),h):0;if(!x&&(m=b=y)&&p.lineStart(),y!==b&&(j=l(x,v),(!j||ka(x,j)||ka(v,j))&&(v[2]=1)),y!==b)w=0,y?(p.lineStart(),j=l(v,x),p.point(j[0],j[1])):(j=l(x,v),p.point(j[0],j[1],2),p.lineEnd()),x=j;else if(o&&x&&n^y){var N;!(E&u)&&(N=l(v,x,!0))&&(w=0,n?(p.lineStart(),p.point(N[0][0],N[0][1]),p.point(N[1][0],N[1][1]),p.lineEnd()):(p.point(N[1][0],N[1][1]),p.lineEnd(),p.lineStart(),p.point(N[0][0],N[0][1],3)))}y&&(!x||!ka(x,v))&&p.point(v[0],v[1]),x=v,b=y,u=E},lineEnd:function(){b&&p.lineEnd(),x=null},clean:function(){return w|(m&&b)<<1}}}function l(p,x,u){var b=_t(p),m=_t(x),w=[1,0,0],k=Ta(b,m),h=ma(k,k),v=k[0],j=h-v*v;if(!j)return!u&&p;var y=a*h/j,E=-a*v/j,N=Ta(w,k),C=fa(w,y),L=fa(k,E);Qa(C,L);var q=N,I=ma(C,q),F=ma(q,q),$=I*I-F*(ma(C,C)-1);if(!($<0)){var R=Rt($),D=fa(q,(-I-R)/F);if(Qa(D,C),D=pn(D),!u)return D;var f=p[0],A=x[0],H=p[1],X=x[1],S;A<f&&(S=f,f=A,A=S);var O=A-f,M=Ae(O-ve)<Ne,_=M||O<Ne;if(!M&&X<H&&(S=H,H=X,X=S),_?M?H+X>0^D[1]<(Ae(D[0]-f)<Ne?H:X):H<=D[1]&&D[1]<=X:O>ve^(f<=D[0]&&D[0]<=A)){var ee=fa(q,(-I+R)/F);return Qa(ee,C),[D,pn(ee)]}}}function g(p,x){var u=n?e:ve-e,b=0;return p<-u?b|=1:p>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return Ao(d,s,i,n?[0,-e]:[-ve,e-ve])}function Vl(e,a,r,n,o,i){var d=e[0],s=e[1],l=a[0],g=a[1],p=0,x=1,u=l-d,b=g-s,m;if(m=r-d,!(!u&&m>0)){if(m/=u,u<0){if(m<p)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>p&&(p=m)}if(m=o-d,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>p&&(p=m)}else if(u>0){if(m<p)return;m<x&&(x=m)}if(m=n-s,!(!b&&m>0)){if(m/=b,b<0){if(m<p)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>p&&(p=m)}if(m=i-s,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>p&&(p=m)}else if(b>0){if(m<p)return;m<x&&(x=m)}return p>0&&(e[0]=d+p*u,e[1]=s+p*b),x<1&&(a[0]=d+x*u,a[1]=s+x*b),!0}}}}}var Yt=1e9,ga=-Yt;function Wl(e,a,r,n){function o(g,p){return e<=g&&g<=r&&a<=p&&p<=n}function i(g,p,x,u){var b=0,m=0;if(g==null||(b=d(g,x))!==(m=d(p,x))||l(g,p)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(p[0],p[1])}function d(g,p){return Ae(g[0]-e)<Ne?p>0?0:3:Ae(g[0]-r)<Ne?p>0?2:1:Ae(g[1]-a)<Ne?p>0?1:0:p>0?3:2}function s(g,p){return l(g.x,p.x)}function l(g,p){var x=d(g,1),u=d(p,1);return x!==u?x-u:x===0?p[1]-g[1]:x===1?g[0]-p[0]:x===2?g[1]-p[1]:p[0]-g[0]}return function(g){var p=g,x=Co(),u,b,m,w,k,h,v,j,y,E,N,C={point:L,lineStart:$,lineEnd:R,polygonStart:I,polygonEnd:F};function L(f,A){o(f,A)&&p.point(f,A)}function q(){for(var f=0,A=0,H=b.length;A<H;++A)for(var X=b[A],S=1,O=X.length,M=X[0],_,ee,Z=M[0],be=M[1];S<O;++S)_=Z,ee=be,M=X[S],Z=M[0],be=M[1],ee<=n?be>n&&(Z-_)*(n-ee)>(be-ee)*(e-_)&&++f:be<=n&&(Z-_)*(n-ee)<(be-ee)*(e-_)&&--f;return f}function I(){p=x,u=[],b=[],N=!0}function F(){var f=q(),A=N&&f,H=(u=So(u)).length;(A||H)&&(g.polygonStart(),A&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),H&&zo(u,s,f,i,g),g.polygonEnd()),p=g,u=b=m=null}function $(){C.point=D,b&&b.push(m=[]),E=!0,y=!1,v=j=NaN}function R(){u&&(D(w,k),h&&y&&x.rejoin(),u.push(x.result())),C.point=L,y&&p.lineEnd()}function D(f,A){var H=o(f,A);if(b&&m.push([f,A]),E)w=f,k=A,h=H,E=!1,H&&(p.lineStart(),p.point(f,A));else if(H&&y)p.point(f,A);else{var X=[v=Math.max(ga,Math.min(Yt,v)),j=Math.max(ga,Math.min(Yt,j))],S=[f=Math.max(ga,Math.min(Yt,f)),A=Math.max(ga,Math.min(Yt,A))];Vl(X,S,e,a,r,n)?(y||(p.lineStart(),p.point(X[0],X[1])),p.point(S[0],S[1]),H||p.lineEnd(),N=!1):H&&(p.lineStart(),p.point(f,A),N=!1)}v=f,j=A,y=H}return C}}const fn=e=>e;var Ja=new Lt,hn=new Lt,qo,To,gn,xn,bt={point:nt,lineStart:nt,lineEnd:nt,polygonStart:function(){bt.lineStart=Gl,bt.lineEnd=Ql},polygonEnd:function(){bt.lineStart=bt.lineEnd=bt.point=nt,Ja.add(Ae(hn)),hn=new Lt},result:function(){var e=Ja/2;return Ja=new Lt,e}};function Gl(){bt.point=Yl}function Yl(e,a){bt.point=Lo,qo=gn=e,To=xn=a}function Lo(e,a){hn.add(xn*e-gn*a),gn=e,xn=a}function Ql(){Lo(qo,To)}var Bt=1/0,La=Bt,ra=-Bt,Fa=ra,Ra={point:Kl,lineStart:nt,lineEnd:nt,polygonStart:nt,polygonEnd:nt,result:function(){var e=[[Bt,La],[ra,Fa]];return ra=Fa=-(La=Bt=1/0),e}};function Kl(e,a){e<Bt&&(Bt=e),e>ra&&(ra=e),a<La&&(La=a),a>Fa&&(Fa=a)}var bn=0,vn=0,Qt=0,Oa=0,Ma=0,It=0,yn=0,wn=0,Kt=0,Fo,Ro,ut,mt,tt={point:Ft,lineStart:Lr,lineEnd:Fr,polygonStart:function(){tt.lineStart=Zl,tt.lineEnd=ed},polygonEnd:function(){tt.point=Ft,tt.lineStart=Lr,tt.lineEnd=Fr},result:function(){var e=Kt?[yn/Kt,wn/Kt]:It?[Oa/It,Ma/It]:Qt?[bn/Qt,vn/Qt]:[NaN,NaN];return bn=vn=Qt=Oa=Ma=It=yn=wn=Kt=0,e}};function Ft(e,a){bn+=e,vn+=a,++Qt}function Lr(){tt.point=Jl}function Jl(e,a){tt.point=Xl,Ft(ut=e,mt=a)}function Xl(e,a){var r=e-ut,n=a-mt,o=Rt(r*r+n*n);Oa+=o*(ut+e)/2,Ma+=o*(mt+a)/2,It+=o,Ft(ut=e,mt=a)}function Fr(){tt.point=Ft}function Zl(){tt.point=td}function ed(){Oo(Fo,Ro)}function td(e,a){tt.point=Oo,Ft(Fo=ut=e,Ro=mt=a)}function Oo(e,a){var r=e-ut,n=a-mt,o=Rt(r*r+n*n);Oa+=o*(ut+e)/2,Ma+=o*(mt+a)/2,It+=o,o=mt*e-ut*a,yn+=o*(ut+e),wn+=o*(mt+a),Kt+=o*3,Ft(ut=e,mt=a)}function Mo(e){this._context=e}Mo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,rt);break}}},result:nt};var kn=new Lt,Xa,Do,Io,Jt,Xt,oa={point:nt,lineStart:function(){oa.point=ad},lineEnd:function(){Xa&&Po(Do,Io),oa.point=nt},polygonStart:function(){Xa=!0},polygonEnd:function(){Xa=null},result:function(){var e=+kn;return kn=new Lt,e}};function ad(e,a){oa.point=Po,Do=Jt=e,Io=Xt=a}function Po(e,a){Jt-=e,Xt-=a,kn.add(Rt(Jt*Jt+Xt*Xt)),Jt=e,Xt=a}let Rr,Da,Or,Mr;class Dr{constructor(a){this._append=a==null?_o:nd(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Or||this._append!==Da){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Or=n,Da=this._append,Mr=this._,this._=o}this._+=Mr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function _o(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function nd(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return _o;if(a!==Rr){const r=10**a;Rr=a,Da=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Da}function rd(e,a){let r=3,n=4.5,o,i;function d(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Dt(s,o(i))),i.result()}return d.area=function(s){return Dt(s,o(bt)),bt.result()},d.measure=function(s){return Dt(s,o(oa)),oa.result()},d.bounds=function(s){return Dt(s,o(Ra)),Ra.result()},d.centroid=function(s){return Dt(s,o(tt)),tt.result()},d.projection=function(s){return arguments.length?(o=s==null?(e=null,fn):(e=s).stream,d):e},d.context=function(s){return arguments.length?(i=s==null?(a=null,new Dr(r)):new Mo(a=s),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),d):n},d.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const l=Math.floor(s);if(!(l>=0))throw new RangeError(`invalid digits: ${s}`);r=l}return a===null&&(i=new Dr(r)),d},d.projection(e).digits(r).context(a)}function Ln(e){return function(a){var r=new jn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function jn(){}jn.prototype={constructor:jn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Fn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Dt(r,e.stream(Ra)),a(Ra.result()),n!=null&&e.clipExtent(n),e}function Bo(e,a,r){return Fn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,l=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([s,l])},r)}function od(e,a,r){return Bo(e,[[0,0],a],r)}function id(e,a,r){return Fn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([d,s])},r)}function sd(e,a,r){return Fn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,s])},r)}var Ir=16,ld=Le(30*Je);function Pr(e,a){return+a?pd(e,a):dd(e)}function dd(e){return Ln({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function pd(e,a){function r(n,o,i,d,s,l,g,p,x,u,b,m,w,k){var h=g-n,v=p-o,j=h*h+v*v;if(j>4*a&&w--){var y=d+u,E=s+b,N=l+m,C=Rt(y*y+E*E+N*N),L=na(N/=C),q=Ae(Ae(N)-1)<Ne||Ae(i-x)<Ne?(i+x)/2:aa(E,y),I=e(q,L),F=I[0],$=I[1],R=F-n,D=$-o,f=v*R-h*D;(f*f/j>a||Ae((h*R+v*D)/j-.5)>.3||d*u+s*b+l*m<ld)&&(r(n,o,i,d,s,l,F,$,q,y/=C,E/=C,N,w,k),k.point(F,$),r(F,$,q,y,E,N,g,p,x,u,b,m,w,k))}}return function(n){var o,i,d,s,l,g,p,x,u,b,m,w,k={point:h,lineStart:v,lineEnd:y,polygonStart:function(){n.polygonStart(),k.lineStart=E},polygonEnd:function(){n.polygonEnd(),k.lineStart=v}};function h(L,q){L=e(L,q),n.point(L[0],L[1])}function v(){x=NaN,k.point=j,n.lineStart()}function j(L,q){var I=_t([L,q]),F=e(L,q);r(x,u,p,b,m,w,x=F[0],u=F[1],p=L,b=I[0],m=I[1],w=I[2],Ir,n),n.point(x,u)}function y(){k.point=h,n.lineEnd()}function E(){v(),k.point=N,k.lineEnd=C}function N(L,q){j(o=L,q),i=x,d=u,s=b,l=m,g=w,k.point=j}function C(){r(x,u,p,b,m,w,i,d,o,s,l,g,Ir,n),k.lineEnd=y,y()}return k}}var cd=Ln({point:function(e,a){this.stream.point(e*Je,a*Je)}});function ud(e){return Ln({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function md(e,a,r,n,o){function i(d,s){return d*=n,s*=o,[a+e*d,r-e*s]}return i.invert=function(d,s){return[(d-a)/e*n,(r-s)/e*o]},i}function _r(e,a,r,n,o,i){if(!i)return md(e,a,r,n,o);var d=Le(i),s=Fe(i),l=d*e,g=s*e,p=d/e,x=s/e,u=(s*r-d*a)/e,b=(s*a+d*r)/e;function m(w,k){return w*=n,k*=o,[l*w-g*k+a,r-g*w-l*k]}return m.invert=function(w,k){return[n*(p*w-x*k+u),o*(b-x*w-p*k)]},m}function fd(e){return hd(function(){return e})()}function hd(e){var a,r=150,n=480,o=250,i=0,d=0,s=0,l=0,g=0,p,x=0,u=1,b=1,m=null,w=Tr,k=null,h,v,j,y=fn,E=.5,N,C,L,q,I;function F(f){return L(f[0]*Je,f[1]*Je)}function $(f){return f=L.invert(f[0],f[1]),f&&[f[0]*xt,f[1]*xt]}F.stream=function(f){return q&&I===f?q:q=cd(ud(p)(w(N(y(I=f)))))},F.preclip=function(f){return arguments.length?(w=f,m=void 0,D()):w},F.postclip=function(f){return arguments.length?(y=f,k=h=v=j=null,D()):y},F.clipAngle=function(f){return arguments.length?(w=+f?Hl(m=f*Je):(m=null,Tr),D()):m*xt},F.clipExtent=function(f){return arguments.length?(y=f==null?(k=h=v=j=null,fn):Wl(k=+f[0][0],h=+f[0][1],v=+f[1][0],j=+f[1][1]),D()):k==null?null:[[k,h],[v,j]]},F.scale=function(f){return arguments.length?(r=+f,R()):r},F.translate=function(f){return arguments.length?(n=+f[0],o=+f[1],R()):[n,o]},F.center=function(f){return arguments.length?(i=f[0]%360*Je,d=f[1]%360*Je,R()):[i*xt,d*xt]},F.rotate=function(f){return arguments.length?(s=f[0]%360*Je,l=f[1]%360*Je,g=f.length>2?f[2]%360*Je:0,R()):[s*xt,l*xt,g*xt]},F.angle=function(f){return arguments.length?(x=f%360*Je,R()):x*xt},F.reflectX=function(f){return arguments.length?(u=f?-1:1,R()):u<0},F.reflectY=function(f){return arguments.length?(b=f?-1:1,R()):b<0},F.precision=function(f){return arguments.length?(N=Pr(C,E=f*f),D()):Rt(E)},F.fitExtent=function(f,A){return Bo(F,f,A)},F.fitSize=function(f,A){return od(F,f,A)},F.fitWidth=function(f,A){return id(F,f,A)},F.fitHeight=function(f,A){return sd(F,f,A)};function R(){var f=_r(r,0,0,u,b,x).apply(null,a(i,d)),A=_r(r,n-f[0],o-f[1],u,b,x);return p=Ml(s,l,g),C=un(a,A),L=un(p,C),N=Pr(C,E),D()}function D(){return q=I=null,F}return function(){return a=e.apply(this,arguments),F.invert=a.invert&&$,R()}}function $o(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}$o.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Ae(o)>Ne&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function gd(){return fd($o).scale(175.295)}function xd(e){return e}function bd(e){if(e==null)return xd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(s,l){l||(a=r=0);var g=2,p=s.length,x=new Array(p);for(x[0]=(a+=s[0])*n+i,x[1]=(r+=s[1])*o+d;g<p;)x[g]=s[g],++g;return x}}function vd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function yd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Br(e,r)})}:Br(e,a)}function Br(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=wd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function wd(e,a){var r=bd(e.transform),n=e.arcs;function o(p,x){x.length&&x.pop();for(var u=n[p<0?~p:p],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));p<0&&vd(x,m)}function i(p){return r(p)}function d(p){for(var x=[],u=0,b=p.length;u<b;++u)o(p[u],x);return x.length<2&&x.push(x[0]),x}function s(p){for(var x=d(p);x.length<4;)x.push(x[0]);return x}function l(p){return p.map(s)}function g(p){var x=p.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:p.geometries.map(g)};case"Point":u=i(p.coordinates);break;case"MultiPoint":u=p.coordinates.map(i);break;case"LineString":u=d(p.arcs);break;case"MultiLineString":u=p.arcs.map(d);break;case"Polygon":u=l(p.arcs);break;case"MultiPolygon":u=p.arcs.map(l);break;default:return null}return{type:x,coordinates:u}}return g(a)}const Uo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},kd=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function jd(e,a,r){const n=Uo[e];if(!n||!n.length)return-1;const o=kd(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let xa=null;function Ed(){return xa||(xa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=yd(r,n),i=gd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=rd(i),s=(o.features||[]).filter(p=>{var x;return(((x=p.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(p=>{var b;const x=((b=p.properties)==null?void 0:b.name)||"",u=d(p)||"";return u?{i2:Bi(x)||null,n:x,d:u}:null}).filter(p=>!!p);if(!s.length)return null;const l={};for(const[p,x]of Object.entries($i)){const u=i(x);u&&(l[p]={x:u[0],y:u[1]})}const g={};for(const[p,x]of Object.entries(Uo)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(g[p]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:l,metros:g}}catch{return null}})(),xa)}function Nd(e){const[a,r]=c.useState(null);return c.useEffect(()=>{if(!e||a)return;let n=!1;return Ed().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Sd="8 40 984 210",Cd={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},$r=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function Ur(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function zd(e,a){const[r,n]=c.useState(1);return c.useEffect(()=>{let o=!0,i=0;const d=()=>{var g;if(!o)return;const l=(g=e.current)==null?void 0:g.getScreenCTM();l&&l.a>0?n(l.a):i=requestAnimationFrame(d)};d();const s=new ResizeObserver(()=>d());return e.current&&s.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function Hr({msgs:e}){const[a,r]=c.useState(0);c.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Ad(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:s,t:l,data:g,dossiers:p,source:x}=K(),u=g.loading&&!p.length,b=c.useRef(null),m=c.useRef(null),w=Nd(e.continent==="monde"),k=e.continent==="monde"?w:Cn.find(f=>f.key===e.continent)||null,h=zd(b,e.continent+":"+e.mapFolded+":"+!!k),[v,j]=c.useState(new Map),[y,E]=c.useState(null);c.useEffect(()=>{const f=b.current;if(!f)return;const A=new Map;f.querySelectorAll("path[data-i2]").forEach(H=>{const X=H.dataset.i2;if(X)try{const S=H.getBBox();S.width>0&&A.set(X,{x:S.x,y:S.y,w:S.width,h:S.height})}catch{}}),j(A)},[e.continent,h,k]);const N=c.useMemo(()=>r.filter(f=>f.cc),[r]),C=c.useMemo(()=>{const f=new Map;return N.forEach(A=>f.set(A.cc,(f.get(A.cc)||0)+1)),f},[N]),L=e.continent==="monde"&&w?w.anchors:null,q=e.continent==="monde"&&w?w.metros:null,I=c.useMemo(()=>N.map(f=>{const A=Ur(f.name||f.id||""),H=Ur((f.id||f.name||"")+"·y");if(L&&f.cc){const _=q?q[f.cc]:void 0;if(_&&_.length){const Z=jd(f.cc,f.city,A);if(Z>=0&&_[Z])return{d:f,x:_[Z].x+(A-.5)*5,y:_[Z].y+(H-.5)*5}}const ee=L[f.cc];if(ee)return{d:f,x:ee.x+(A-.5)*10,y:ee.y+(H-.5)*10}}const X=f.cc?v.get(f.cc):void 0;if(!X)return null;const S=Cd[`${e.continent}:${f.cc||""}`];if(S)return{d:f,x:X.x+X.w*(S.fx+(A-.5)*S.sx),y:X.y+X.h*(S.fy+(H-.5)*S.sy)};const O=(A-.5)*Math.min(X.w*.55,60),M=(H-.5)*Math.min(X.h*.55,60);return{d:f,x:X.x+X.w/2+O,y:X.y+X.h/2+M}}).filter(f=>!!f),[N,v,L,q,e.continent]),F=f=>h>0?f/h:f,$=c.useMemo(()=>n?[0,1,2,3,4,5].map(f=>({c:$r[f],fr:l.plabels[f],en:l.plabels[f],n:r.filter(A=>A.kind==="target"&&Se(A)===f).length})).filter(f=>f.n>0):Yn.map((f,A)=>({...f,n:r.filter(H=>Qn(H)===A).length})),[r,n,l.plabels]),R=i?d.get(i):null,D=R?I.find(f=>f.d.id===R.id):null;return k?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Hr,{msgs:l.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?Sd:k.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?k.fr:k.en,onMouseLeave:()=>{E(null),o(null)},children:[t.jsx("g",{children:k.countries.map((f,A)=>t.jsx("g",{className:"ct"+(f.i2&&C.get(f.i2)?"":" empty"),children:t.jsx("path",{d:f.d,"data-i2":f.i2||void 0})},A))}),t.jsx("g",{children:I.map(f=>{const A=Yn[Qn(f.d)],H=!!Pe(f.d),X=f.d.kind==="target",S=n&&X?$r[Se(f.d)]:A.c,O=!n&&_e(f.d);return t.jsxs("g",{className:"co"+(O?" done":""),onMouseEnter:()=>{var ee,Z;const M=(ee=m.current)==null?void 0:ee.getBoundingClientRect(),_=(Z=b.current)==null?void 0:Z.createSVGPoint();if(_&&b.current&&M){_.x=f.x,_.y=f.y;const be=_.matrixTransform(b.current.getScreenCTM());E({x:be.x-M.left,y:be.y-M.top,label:f.d.name+" · "+(Ht(f.d.cc,s)||f.d.countryLabel||"")})}o(f.d.id)},onMouseLeave:()=>{E(null),o(null)},onClick:()=>{var ee;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:f.d.id}),(f.d.noCo||["media","nominations","recrutements"].includes(f.d.engine||""))&&(f.d.url||f.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.d.url||"",text:[f.d.headline,f.d.tagline].filter(Boolean).join(`
`)}})):f.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:f.d.name,url:f.d.url||"",website:f.d.website||"",domain:f.d.domain||""}}));return}const M=(ee=b.current)==null?void 0:ee.createSVGPoint();let _=null;if(M&&b.current){M.x=f.x,M.y=f.y;const Z=M.matrixTransform(b.current.getScreenCTM());_={x:Z.x,y:Z.y}}a({type:"popup",id:f.d.id,anchor:_})},children:[t.jsx("circle",{className:"h",cx:f.x,cy:f.y,r:F(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:f.x,cy:f.y,r:F(A.px),fill:S,stroke:H?"#E5484D":"#ffffff",strokeWidth:F(H?2.2:1.3)})]},f.d.id||f.d.name)})}),D&&t.jsx("circle",{className:"ring on",cx:D.x,cy:D.y,r:F(13),fill:"none",stroke:"#16233A",strokeWidth:F(2)})]}),t.jsx("div",{className:"hov"+(y?" on":""),style:y?{left:y.x,top:y.y}:void 0,children:y==null?void 0:y.label}),t.jsx("div",{className:"legend",children:$.map((f,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":f.c}}),s==="fr"?f.fr:f.en," ",t.jsx("b",{children:f.n})]},A))}),r.some(f=>!f.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",l.notLocated," ",t.jsx("b",{children:r.filter(f=>!f.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Hr,{msgs:l.loadMsgs})})}function qd(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Ho({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:s}=K(),l=a.filters,[g,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null),m=c.useRef(null),w=c.useMemo(()=>a.continent==="monde"?n:n.filter(D=>D.continent===a.continent),[n,a.continent]),k=D=>w.filter(f=>D!=="country"&&l.country.length&&!l.country.includes(f.cc||"")?!1:za(f,l,i,D==="country"?void 0:D)),h=D=>!i||D.kind!=="op",v=c.useMemo(()=>{const D=k("win").filter(h),f=A=>D.filter(H=>(H.date?Math.max(0,Math.floor((Date.now()-Date.parse(H.date))/864e5)):9999)<=A).length;return[f(0),f(7),f(30),D.length]},[w,l,i]),j=c.useMemo(()=>l.day?k("win").filter(h).filter(D=>(D.date||"").slice(0,10)===l.day).length:0,[w,l,i]),y=(l.signalOnly?1:0)+l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+l.crible.length,E=y+(l.acquirer.trim()?1:0)+(l.day||l.win!=="all"?1:0)+(l.search.trim()?1:0);c.useEffect(()=>{a.openFacet&&p(!1)},[a.openFacet]),c.useEffect(()=>{if(!g&&!x)return;const D=A=>{var X,S;const H=A.target;g&&!((X=b.current)!=null&&X.contains(H))&&p(!1),x&&!((S=m.current)!=null&&S.contains(H))&&u(!1)},f=A=>{A.key==="Escape"&&(p(!1),u(!1))};return document.addEventListener("mousedown",D),document.addEventListener("keydown",f),()=>{document.removeEventListener("mousedown",D),document.removeEventListener("keydown",f)}},[g,x]);const N=(D,f,A,H="fbtn")=>t.jsxs("button",{type:"button",className:H,"aria-expanded":a.openFacet===D,onClick:()=>r({type:"openFacet",facet:D}),children:[t.jsx("span",{className:"fl",children:f}),A>0&&t.jsx("span",{className:"n",children:A}),t.jsx("span",{className:"cv",children:"▾"})]},D),C=["1","7","30","all"],L=Math.max(0,C.indexOf(l.win||"all")),q=l.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(qd(l.day,s))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(D=>!D),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:v[L]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((D,f)=>t.jsxs("button",{type:"button",role:"option","aria-selected":l.win===D,onClick:()=>{r({type:"filters",patch:{win:D}}),u(!1)},children:[o.datesShort[f],t.jsx("span",{className:"n",children:v[f]})]},D))})]}):t.jsx("div",{className:"seg",children:C.map((D,f)=>t.jsxs("button",{type:"button","aria-pressed":l.win===D,onClick:()=>r({type:"filters",patch:{win:D}}),children:[t.jsx("span",{className:"sl",children:o.dates[f]}),t.jsx("b",{children:v[f]})]},D))}),I=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:l.search,onChange:D=>r({type:"filters",patch:{search:D.target.value}})})]}),F=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),l.signalOnly&&t.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),l.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:l.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",o.fSector,l.sector.length),N("pay",o.fCountry,l.country.length),N("det",o.fEngine,l.engine.length),N("sta",o.fStage,l.stage.length),i&&N("crib",o.fVerdict,l.crible.length),i&&N("ang","Angle",l.angle.length),i&&N("mem","Mémo",l.memoLevel.length)]}),$=(D=!1)=>t.jsxs("div",{className:"frow2",children:[E>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(E)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),D&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),R=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(y?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{p(D=>!D),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),y>0&&t.jsx("span",{className:"n",children:y}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:F})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(l.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:q}),t.jsxs("div",{className:"fstrip-b",children:[I,R,$(!1)]})]}),a.openFacet&&t.jsx(Vr,{poolFor:k})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[q,I,F,t.jsx("span",{className:"fgrow"}),$()]}),a.openFacet&&t.jsx(Vr,{poolFor:k})]})}function Vr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=K(),s=a.filters,l=a.openFacet,{title:g,cols:p,options:x}=c.useMemo(()=>{if(l==="sig"){const k=e("signal").filter(j=>Pe(j)),h=new Map;k.forEach(j=>{const y=j.engine||"";h.set(y,(h.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:k.length,html:!0,on:s.signalOnly&&!s.signalEngines.length},...on([...h.keys()],o).map(j=>({v:j,label:Tt(j)+" "+Xe(j,o),n:h.get(j)||0,html:!1,on:s.signalOnly&&s.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="crib"){const k=e("crible").filter(v=>!i||oo(v,a.ptab,d.favIds)),h=new Map;return k.forEach(v=>{const j=io(v);j&&j!=="NEW"&&h.set(j,(h.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...h.entries()].sort((v,j)=>(Kn[v[0]]??9)-(Kn[j[0]]??9)||j[1]-v[1]).map(([v,j])=>({v,label:'<span class="fdot" style="background:'+(Ui[v]||"#94A3B8")+'"></span>'+v,n:j,html:!0,on:s.crible.includes(v)}))}}if(l==="sec"){const k=e("sector"),h=new Map;return k.forEach(v=>{v.sector&&h.set(v.sector,(h.get(v.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...h.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:s.sector.includes(v)}))}}if(l==="pay"){const k=e("country"),h=new Map;return k.forEach(v=>{v.cc&&h.set(v.cc,(h.get(v.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...h.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:Ht(v,o)||v,n:j,html:!1,on:s.country.includes(v)}))}}if(l==="det"){const k=e("engine"),h=new Map;return k.forEach(v=>{v.engine&&h.set(v.engine,(h.get(v.engine)||0)+1)}),{title:n.fEngine,cols:2,options:on([...h.keys()],o).map(v=>({v,label:Tt(v)+" "+Xe(v,o)+' <span style="color:var(--dim);font-size:10px">· '+Hi(Vi(v),o)+"</span>",n:h.get(v)||0,html:!0,on:s.engine.includes(v)}))}}if(l==="ang"){const k=e("angle"),h=new Map;return k.forEach(v=>{v.angle&&h.set(v.angle,(h.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...h.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v.replace(/[_-]+/g," "),n:j,html:!1,on:s.angle.includes(v)}))}}if(l==="mem"){const k=e("memoLevel"),h=new Map;k.forEach(j=>{if(j.kind==="target"){const y=Nn(j);h.set(y,(h.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:v[j],n:h.get(j)||0,html:!1,on:s.memoLevel.includes(j)}))}}const m=e("stage"),w=new Map;return m.forEach(k=>{k.stage&&w.set(k.stage,(w.get(k.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((k,h)=>h[1]-k[1]).map(([k,h])=>({v:k,label:k,n:h,html:!1,on:s.stage.includes(k)}))}},[l,a,o]),u=m=>{if(l==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(s.signalOnly&&!s.signalEngines.length),signalEngines:[]}});else{const k=s.signalEngines.includes(m)?s.signalEngines.filter(h=>h!==m):[...s.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:k}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage",value:m})},b=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:g}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>u(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Vo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:s}=K(),l=c.useMemo(()=>{const b={};return r.forEach(m=>{za(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,p]=c.useState(!1),x=c.useRef(null);c.useEffect(()=>{if(!g)return;const b=w=>{var k;(k=x.current)!=null&&k.contains(w.target)||p(!1)},m=w=>{w.key==="Escape"&&p(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const u=b=>{const m=Cn.find(w=>w.key===b);return b==="monde"?s.contWorld:d==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>p(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:l[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Jn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),p(!1)},children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[Jn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})})]})}function En(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function Wo(e){return"atl2:evalq:"+(e||"anon")}function Td(e,a){const r=Wo(e),n=En(r),o=new Set(n.map(s=>(s.name||"").trim().toLowerCase())),i=a.map(s=>(s||"").trim()).filter(s=>s&&!o.has(s.toLowerCase())).map(s=>({name:s,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function Go(){const{t:e,data:a,dossiers:r}=K(),n=a.session.token||"",o=Wo(n),[i,d]=c.useState(()=>En(o)),s=c.useRef(!1),[l,g]=c.useState(!1);c.useEffect(()=>{try{const S=i.slice(0,30).map(({descBusy:O,evalBusy:M,..._})=>_);localStorage.setItem(o,JSON.stringify(S)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[i,o]),c.useEffect(()=>{const S=()=>{if(s.current)return;const O=En(o);d(M=>JSON.stringify(M.map(({descBusy:_,evalBusy:ee,...Z})=>Z))===JSON.stringify(O)?M:O)};return window.addEventListener("atl2:evalq",S),window.addEventListener("storage",S),()=>{window.removeEventListener("atl2:evalq",S),window.removeEventListener("storage",S)}},[o]);const[p,x]=c.useState([]),[u,b]=c.useState(""),[m,w]=c.useState(!1),[k,h]=c.useState(!1),[v,j]=c.useState(""),y=c.useCallback((S,O)=>d(M=>M.map((_,ee)=>ee===S?{..._,...O}:_)),[]),E=c.useCallback((S,O)=>{const M=O.trim();M&&(y(S,{name:M,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),zn(M).then(_=>{const ee=_.candidates||[];_.website?y(S,{site:_.website,status:"ready"}):ee.length===1?y(S,{site:ee[0].url,status:"ready"}):ee.length>1?y(S,{status:"pick",candidates:ee.slice(0,4)}):y(S,{status:"ready"})}).catch(()=>y(S,{status:"ready"})))},[y]),N=c.useCallback((S,O,M)=>{y(S,{descBusy:!0}),po(n,O,M).then(_=>{if(_.quota){g(!0),y(S,{descBusy:!1,descDone:!0});return}const ee=_.blocs||{},Z=(ee.synthese||ee.value_prop||ee.produit||ee.modele||"").trim();y(S,{descBusy:!1,descDone:!0,desc:Z})}).catch(()=>y(S,{descBusy:!1,descDone:!0}))},[y,n]);c.useEffect(()=>{const S=i.findIndex(M=>M.auto&&M.name.trim()&&M.status==="");if(S>=0){E(S,i[S].name);return}if(l)return;const O=i.findIndex(M=>M.status==="ready"&&M.site&&!M.descDone&&!M.descBusy);O>=0&&N(O,i[O].name,i[O].site)},[i,E,N,l]);const[C,L]=c.useState(!1),q=c.useCallback(async(S,O)=>{y(S,{evalBusy:!0});const M=await co(n,(O.site||O.name).trim(),"atelier2");return M.verdict==="quota"?(y(S,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:M.reason||"",remaining:0}})),!1):(y(S,{evalBusy:!1,status:M.verdict==="kept"?"kept":"out",reason:M.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:M.company||O.name,verdict:M.verdict,reason:M.reason||"",remaining:M.remaining??null}})),!0)},[y,n]),I=async()=>{if(C)return;const S=i.map((O,M)=>({r:O,i:M})).filter(({r:O})=>O.name.trim()&&O.status!=="kept"&&O.status!=="out"&&O.status!=="resolving");if(S.length){L(!0);for(const{r:O,i:M}of S)if(!await q(M,O))break;L(!1)}},F=c.useMemo(()=>{const S=new Set,O=[];return i.filter(M=>M.status==="kept").forEach(M=>{const _=M.name.trim().toLowerCase();_&&!S.has(_)&&(S.add(_),O.push(M.name.trim()))}),r.filter(M=>Se(M)>=1&&Se(M)<=4&&(M.website||M.domain)).forEach(M=>{const _=(M.name||"").trim().toLowerCase();_&&!S.has(_)&&(S.add(_),O.push((M.name||"").trim()))}),O},[i,r]),$=c.useMemo(()=>{const S=new Set;return r.forEach(O=>{const M=(O.name||"").trim().toLowerCase();M&&S.add(M)}),i.forEach(O=>{const M=O.name.trim().toLowerCase();M&&S.add(M)}),S},[r,i]),R=async()=>{if(u||!F.length)return;h(!1);const S=[];for(const O of F.slice(0,2)){b(O);const M=await uo(n,O);if(M){if(M.verdict==="quota"){w(!0);break}(M.results||[]).forEach(_=>{const ee=(_.company||"").trim().toLowerCase();!ee||$.has(ee)||S.some(Z=>Z.name.toLowerCase()===ee)||S.push({name:(_.company||"").trim(),verdict:_.verdict||"",reason:_.reason,from:O})})}}b(""),h(!0),x(O=>[...S,...O].slice(0,24))},D=async(S,O)=>{if(u)return;h(!1),b(S==="thesis"?e.pxThesis:O);const M=await Wi(n,S,O,6);if(b(""),h(!0),!M)return;if(M.verdict==="quota"){w(!0);return}const _=[];(M.results||[]).forEach(ee=>{const Z=(ee.company||"").trim().toLowerCase();!Z||$.has(Z)||_.some(be=>be.name.toLowerCase()===Z)||_.push({name:(ee.company||"").trim(),verdict:ee.verdict||"",reason:ee.reason,from:S==="thesis"?e.pxThesis:O})}),x(ee=>[..._,...ee].slice(0,24))},f=()=>{const S=v.trim();S.length<3||D(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(S)?"registry":"keyword",S)},A=S=>{d(O=>[...O,{name:S.name,site:"",status:"",auto:!0}].slice(0,30)),x(O=>O.filter(M=>M.name!==S.name))},H=i.filter(S=>S.name.trim()&&S.status!=="kept"&&S.status!=="out").length,X=S=>S.name.trim()&&S.status!=="kept"&&S.status!=="out"&&S.status!=="resolving"&&!S.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((S,O)=>t.jsxs("div",{className:"eq-row"+(S.status==="kept"?" r-kept":S.status==="out"?" r-out":""),children:[t.jsx("input",{value:S.name,placeholder:e.eqNamePh,onChange:M=>{const _=M.target.value.split(`
`).map(ee=>ee.trim()).filter(Boolean);_.length>1?d(ee=>{const Z=[...ee];return Z.splice(O,1,..._.map(be=>({name:be,site:"",status:"",auto:!0}))),Z.slice(0,30)}):y(O,{name:M.target.value})},onBlur:()=>{S.name.trim()&&!S.site&&S.status!=="resolving"&&S.status!=="pick"&&E(O,S.name)},onKeyDown:M=>{M.key==="Enter"&&E(O,S.name)}}),t.jsxs("span",{className:"eq-site",children:[S.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),S.status==="pick"&&(S.candidates||[]).map(M=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>y(O,{site:M.url,status:"ready",candidates:void 0}),children:(M.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},M.url)),S.status!=="resolving"&&S.status!=="pick"&&(S.site?t.jsxs("a",{href:S.site.startsWith("http")?S.site:"https://"+S.site,target:"_blank",rel:"nofollow noopener",children:[S.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:S.name.trim()&&S.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:S.desc||"",children:S.descBusy?t.jsx("i",{children:e.eqDescBusy}):S.desc?S.desc:t.jsx("em",{children:S.descDone?l?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(S.status||"vide"),title:S.reason||"",children:S.status==="kept"?"✓ "+e.kept:S.status==="out"?"✗ "+e.dropped:S.status==="ready"?e.eqReady:S.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!X(S)||C,onClick:()=>{q(O,S)},children:S.evalBusy?"⏳":"⚡"}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>d(M=>M.filter((_,ee)=>ee!==O)),children:"×"})]},O)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>d(S=>[...S,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]}),t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!u,onClick:()=>{D("thesis","")},children:u===e.pxThesis?e.sgBusy(u):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:v,placeholder:e.pxPlace,onChange:S=>j(S.target.value),onKeyDown:S=>{S.key==="Enter"&&f()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u||v.trim().length<3,onClick:f,children:e.pxGoFree}),!!F.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u,onClick:()=>{R()},children:u&&u!==e.pxThesis&&u!==v?e.sgBusy(u):e.sgGo}),!!F.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(F[0],F.length)}),m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),k&&!p.length&&!m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),p.map(S=>t.jsxs("span",{className:"eq-sc"+(S.verdict==="kept"?" ok":""),title:(S.reason||"")+" — "+e.sgVia(S.from),children:[t.jsx("b",{children:S.name}),S.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>A(S),children:"+"})]},S.name))]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(C?" loading":""),style:{justifyContent:"center"},disabled:C||!H,onClick:()=>{I()},children:[t.jsx("span",{className:"fill"}),C?e.eqRunning:e.eqGo(H)]}),t.jsx("span",{className:"hint",children:e.eqHint}),i.some(S=>S.status==="kept"||S.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>d(S=>S.filter(O=>O.status!=="kept"&&O.status!=="out")),children:e.eqClearDone})]})]})}function Yo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ld(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Wr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:s}=K();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(l=>l.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(l=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:l.name}),l.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),l.line1&&t.jsx("p",{className:"w",children:l.line1}),l.line2&&t.jsx("p",{className:"r",children:l.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(l.name),children:s.rsEvalOne})]},l.name))})]}):null}function Qo({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=K(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Wr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Wr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Fd({card:e,onEvaluate:a,onAddAll:r}){var s,l,g;const{t:n}=K(),o=[e.industry,...e.market_tags||[],e.author].map(p=>(p||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(p=>p&&p.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(p=>t.jsx("span",{children:p},p))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Yo(e.summary_md||"").map((p,x)=>t.jsx("p",{children:p},x))})]}),t.jsx(Qo,{card:e,onEvaluate:a,onAddAll:r}),(((l=e.prospective)==null?void 0:l.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(p=>t.jsx("li",{children:p},p))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(p=>t.jsx("a",{href:p.url,target:"_blank",rel:"noopener noreferrer",children:p.label||p.url},p.url))})]})]})}function Rd(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Od({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=K(),s=o,[l,g]=c.useState(null),[p,x]=c.useState(null),[u,b]=c.useState(null),[m,w]=c.useState(!1);c.useEffect(()=>{let h=!0;return(async()=>{const v=await mo({email:d,cbToken:s});h&&g(v)})(),()=>{h=!1}},[d,s,n]);const k=h=>{x(h),b(null),w(!0),(async()=>{const v=await Gi(h.id);b(v),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[p?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),p&&t.jsx("span",{className:"ti",children:p.title}),!p&&l&&t.jsx("span",{className:"n",children:l.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!p&&t.jsxs("div",{className:"rsarch-list",children:[l===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),l!==null&&l.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(l||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>k(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[Rd(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?i.rsPub:i.rsPriv})]},h.id))]}),p&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[p.source_url&&t.jsx("a",{href:p.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),p.published&&p.page_url&&t.jsx("a",{href:p.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(p.published?" on":""),children:p.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(Fd,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ja=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Zt(e){return/^https?:\/\//i.test((e||"").trim())}function pt(e){const a=(e||"").trim();return a?Zt(a)?a:ja.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Md(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Dd(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:s,evalBusy:l,evalCards:g,caps:p,data:x,canWrite:u,source:b,dossiers:m,doAnalyse:w,liveMemos:k,pipe:h}=K(),v=r==="client",j=c.useMemo(()=>n||(b!=="default"?Yi():""),[n,b]),[y,E]=c.useState(""),[N,C]=c.useState(!1),[L,q]=c.useState(""),[I,F]=c.useState(""),[$,R]=c.useState(""),[D,f]=c.useState(!1),[A,H]=c.useState(!1),[X,S]=c.useState([]);c.useEffect(()=>{const P=ie=>{const fe=ie.detail;fe&&S(oe=>[fe,...oe].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[O,M]=c.useState(!1),[_,ee]=c.useState(!1),[Z,be]=c.useState(!1),te=c.useRef(!1),[pe,me]=c.useState(""),[ge,B]=c.useState(""),[Q,G]=c.useState(!1),[ae,U]=c.useState(!1),[se,le]=c.useState(0),[ne,ue]=c.useState(""),[de,xe]=c.useState(null),[Re,ye]=c.useState(null),[Ce,ze]=c.useState(!1),[Me,ft]=c.useState(null),[ot,Be]=c.useState(0),ke=c.useRef(!1),st=y.trim()?ja.test(y.trim())?e.evalUrl:e.evalName:e.evalWaiting;c.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),ie=(P.get("rs")||"").trim(),fe=(P.get("rstext")||"").trim();ie&&/^https?:\/\//i.test(ie)&&me(ie),fe&&B(fe),(ie&&/^https?:\/\//i.test(ie)||fe)&&M(!0)},[]),c.useEffect(()=>{const P=ie=>{const fe=ie.detail||{},oe=String(fe.url||"").trim(),Ee=String(fe.text||"").trim();oe&&/^https?:\/\//i.test(oe)&&me(oe),Ee&&B(Ee),(oe&&/^https?:\/\//i.test(oe)||Ee)&&(M(!0),E(""),q(""),G(!0),window.setTimeout(()=>G(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),c.useEffect(()=>{const P=ie=>{const fe=ie.detail||{},oe=String(fe.name||"").trim();if(!oe)return;M(!1),E(oe),q(oe);const Ee=pt(String(fe.website||fe.domain||""));F(Ee),R(pt(String(fe.url||""))),f(!Ee),C(!0),window.setTimeout(()=>C(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),c.useEffect(()=>{const P=(L||"").trim();if(!P||O||I){(I||!P||O)&&f(!1);return}const ie=m.find(Ee=>Ue(Ee.name)===Ue(P)),fe=pt((ie==null?void 0:ie.website)||"")||pt((ie==null?void 0:ie.domain)||"");if(fe){F(fe),f(!1);return}let oe=!0;return f(!0),zn(P).then(Ee=>{var Ve,qe;if(!oe)return;const De=pt(Ee.website||"")||pt(((qe=(Ve=Ee.candidates)==null?void 0:Ve[0])==null?void 0:qe.url)||"");De&&F(De)}).catch(()=>{}).finally(()=>{oe&&f(!1)}),()=>{oe=!1}},[L,O,I,m]),c.useEffect(()=>{const P=ie=>{var oe;const fe=String(((oe=ie.detail)==null?void 0:oe.url)||"").trim();Zt(fe)&&window.open(fe,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),c.useEffect(()=>{if(te.current===O)return;te.current=O,be(!0);const P=window.setTimeout(()=>be(!1),560);return()=>window.clearTimeout(P)},[O]),c.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ie=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!ie)return;const fe=()=>ie.style.setProperty("--demand-h",`${P.offsetHeight}px`);fe();const oe=new ResizeObserver(fe);return oe.observe(P),()=>oe.disconnect()},[b,N,Q,A,O,Z,D]),c.useEffect(()=>{if(!u&&!j){ft(null);return}let P=!0;return(async()=>{const ie=await mo({email:o,cbToken:j});P&&ft(ie.length)})(),()=>{P=!1}},[u,j,o,ot]);const Nt=X.length?X:g,He=x.credits,lt=c.useCallback(P=>{Td(n,P)&&H(!0)},[n]);c.useEffect(()=>{if(!ae)return;le(0);const P=window.setInterval(()=>le(ie=>ie+1),1e3);return()=>window.clearInterval(P)},[ae]);const ht=c.useMemo(()=>{const P=y.trim().toLowerCase();return!P||!h?null:m.find(ie=>Ue(ie.name)===P&&Se(ie)===1)||null},[y,m,h]),St=()=>{const P=y.trim();if(P){if(ht){w(ht);return}i(null,P),v&&E("")}},Ze=async()=>{var fe,oe,Ee;if(ke.current)return;const P=pe.trim().replace(/\s+/g,""),ie=ge.trim();if(!P&&!ie){ue(e.rsNeed);return}if(!v&&!j){i(null,P||ie.slice(0,80));return}ke.current=!0,ue(""),xe(null),ye(null),U(!0);try{const De=await Ki({url:P,text:ie,email:o,cbToken:j});if(U(!1),!De||De.status!=="success"){ue((De==null?void 0:De.message)||"Erreur");return}xe(De),M(!1),lt((((fe=De.prospective)==null?void 0:fe.companies_to_evaluate)||[]).map(qe=>(qe==null?void 0:qe.name)||"")),ye({state:"pending"});const Ve=await Ji(De,{email:o,cbToken:j});ye(Ve.ok?{state:"ok",scopeLabel:((oe=Ve.summary)==null?void 0:oe.scope_label)||"",scope:((Ee=Ve.summary)==null?void 0:Ee.scope)||""}:{state:"fail",msg:Ve.error||""}),Ve.ok&&Be(qe=>qe+1)}finally{ke.current=!1,U(!1)}},Ct=[de==null?void 0:de.industry,...(de==null?void 0:de.market_tags)||[],de==null?void 0:de.author].map(P=>(P||"").trim()).filter(Boolean),gt=(Re==null?void 0:Re.state)==="pending",Ot=Re&&(gt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Re.state==="ok"?t.jsx("span",{className:"rslink ok",children:Re.scope&&Re.scope!=="public"?e.rsSavedIn(Re.scopeLabel||Re.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Re.msg,children:e.rsSaveFail})),Mt=Ld(de).length,Ie=O,Ke=(L||y).trim(),T=m.find(P=>Ue(P.name)===Ue(Ke)),V=pt(y)||I||pt((T==null?void 0:T.website)||"")||pt((T==null?void 0:T.domain)||""),J=$||pt((T==null?void 0:T.url)||""),ce=ht?e.actAnalyse:Ke?e.evalGoOn(Ke.length>22?Ke.slice(0,21)+"…":Ke):e.evalGo,je=ae?`${Qi(pe.trim())==="youtube"&&pe.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(se)}`:gt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Ie?" rs-mode":"")+(L&&y.trim()===L||N||Q?" pair":"")+(N||Q||Z?" echo":"")+(Z?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((Ie?Q:N)||Z?" flash":"")+((Ie?pe.trim():ja.test(y.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Ie?pe:y,placeholder:Ie?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Ie?600:200,spellCheck:Ie?!1:void 0,inputMode:Ie?"url":void 0,onChange:P=>{if(Ie){me(P.target.value);return}E(P.target.value),L&&P.target.value.trim()!==L&&(q(""),F(""),R(""),f(!1))},onKeyDown:P=>{P.key==="Enter"&&(Ie?Ze():St())}}),t.jsx("span",{className:"detect"+(Ie?" off":"")+(ja.test(y.trim())?" url":""),children:st})]}),t.jsx("span",{className:"dacts",children:Ie?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ae?" loading":""),disabled:ae||gt||!pe.trim()&&!ge.trim(),onClick:()=>{Ze()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:je})]}),t.jsxs("a",{className:"viewbtn"+(Zt(pe)?"":" off"),href:Zt(pe)?pe.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{Zt(pe)||P.preventDefault()},children:[t.jsx(Md,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ht?" analyse":"")+(l?" loading":""),disabled:l,onClick:St,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ce})]}),t.jsxs("a",{className:"viewbtn sm"+(D?" searching":V?"":" off"),href:V||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":D||void 0,title:D?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{V||P.preventDefault()},children:[D&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),D?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(J?"":" off"),href:J||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{J||P.preventDefault()},children:e.viewSrc})]})}),p.showCredits&&He&&t.jsxs("button",{type:"button",className:"credits"+(He.total_available<=0&&!He.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:He.unlimited?"∞":He.total_available}),!He.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",He.daily_grant+He.purchased]}),He.total_available<=0&&!He.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>H(!A),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(O?" on":""),onClick:()=>M(!O),children:e.rsOpen}),Me!==null&&Me>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Ce?" on":""),onClick:()=>ze(!Ce),children:e.rsArchOpen(Me)})]}),Ce&&t.jsx(Od,{bump:ot,cbToken:j,onClose:()=>ze(!1),onEvaluate:P=>i(null,P),onAddAll:lt}),t.jsx("div",{className:"rsp slim"+(O?" on":" off"),"aria-hidden":!O,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:O?void 0:-1,onClick:()=>ee(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:_?"▴":"▾"})]}),_&&t.jsx("textarea",{className:"rstext",value:ge,placeholder:e.rsTextPh,tabIndex:O?void 0:-1,onChange:P=>B(P.target.value)})]})}),ne&&t.jsx("div",{className:"rserr",children:ne}),de&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:de.title}),de.source_url&&t.jsx("a",{href:de.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{xe(null),ye(null)},children:"×"})]}),de.market&&t.jsx("p",{className:"rsmk",children:de.market}),Ct.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Ct.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[de.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${de.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Yo(de.summary_md||"").map((P,ie)=>t.jsx("p",{children:P},ie))})]}),t.jsx(Qo,{card:de,onEvaluate:P=>i(null,P),onAddAll:lt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Mt)}),Ot]})]}),A&&t.jsx(Go,{}),Nt.slice(0,1).map((P,ie)=>{const fe=P.verdict==="kept",oe=P.verdict==="quota",Ee=P.verdict==="unresolved",De=fe?"var(--brand)":oe?"var(--bolt)":Ee?"var(--blue)":"var(--red)",Ve=fe?"var(--brand-l)":oe?"#FFF3D6":Ee?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":De,"--bgc":Ve},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:fe?"✓ "+e.kept:oe?"⏳":Ee?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(qe=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:qe.url.startsWith("http")?qe.url:`https://${qe.url}`,target:"_blank",rel:"nofollow noopener",children:[(qe.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,qe.url,P.name),children:e.evalPickGo})]},qe.url))}),!oe&&!Ee&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:fe?1:5});const qe=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const We=[...document.querySelectorAll(".atl2 .list .row")].find(_a=>{var da;return(((da=_a.querySelector(".rnm"))==null?void 0:da.textContent)||"").trim().toLowerCase().includes(qe)});We&&(We.scrollIntoView({behavior:"smooth",block:"center"}),We.classList.add("flashrow"),window.setTimeout(()=>We.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(fe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ie)}),v&&(d.kept+d.dropped>0||Nt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Id(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Pd(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=K(),i=e.memoConsole?r.get(e.memoConsole):null,d=c.useMemo(()=>i?[i.reasoning||"",Id(i.summary||"")].filter(Boolean).join(`
...
`).map((g,p)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},p)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Pt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:l===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Rn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=K(),[d,s]=c.useState(!1),[l,g]=c.useState(null),p=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!p||d)return;s(!0);const u=await uo(r,e);if(s(!1),!u){i(a.actErr);return}g(u.results||[])};return c.useEffect(()=>{if(!p)return;const u=b=>{var w;const m=String(((w=b.detail)==null?void 0:w.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,p]),c.useEffect(()=>{if(p)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,p]),p?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{x()},children:d?a.similarBusy:a.similar}),l&&(l.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:l.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const _d=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ba=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Bd(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ba(a.slice(n));break}r+=ba(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ba(a.slice(o));break}const d=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(d),l=s?s[2].toLowerCase():"";s&&_d.has(l)?r+=`<${s[1]}${l}>`:r+=ba(a.slice(o,i+1)),n=i+1}return r}const $d=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),Gr={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function Ko(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if($d.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const s=d.name.toLowerCase();(!(Gr["*"].has(s)||((r=Gr[o])==null?void 0:r.has(s)))||s.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(s=>s.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(s)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}Ko(n)}}function Za(e){const a=e.cloneNode(!0);return Ko(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const en=new Map;function Ud(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=en.get(a);return r||(r=Hd(a).catch(()=>null),r.then(n=>{n||en.delete(a)}),en.set(a,r)),r}async function Hd(e){var x,u;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=new DOMParser().parseFromString(await a.text(),"text/html"),n=b=>{var m;return(((m=r.querySelector(b))==null?void 0:m.textContent)||"").trim()},o=r.querySelector(".sb-score"),i=((x=Array.from((o==null?void 0:o.classList)||[]).find(b=>b.startsWith("sb-score-")))==null?void 0:x.slice(9))||"",d=[];let s=null;const l=Array.from(r.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const b of l){if(b.classList.contains("sb-nav-heading")){s={label:(b.textContent||"").trim(),items:[]},d.push(s);continue}const m=b.getAttribute("href")||"";if(!m.startsWith("#"))continue;const w=m.slice(1),k=Vd(r,w);k&&(s||(s={label:"",items:[]},d.push(s)),s.items.push({id:w,title:(b.textContent||"").trim(),html:k,poids:k.length}))}const g=((u=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:u[1])||"",p={score:n(".sb-score"),scoreTone:i,tags:Array.from(r.querySelectorAll(".sb-tag")).map(b=>(b.textContent||"").trim()).filter(Boolean),name:n(".sidebar-company-name"),tagline:n(".sidebar-tagline"),desc:n(".meta-desc"),groups:d.filter(b=>b.items.length),mindmapSlug:r.querySelector(".cm-mindmap-png")?g:""};return p.groups.length?p:null}const Yr={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Vd(e,a){const r=e.getElementById(a),n=r?Qr(e,r):"";if(n)return n;const o=Yr[a]?e.querySelector(Yr[a]):null;return o&&o!==r?Qr(e,o):""}function Qr(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Za(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(l=>/^h3$/i.test(l.tagName))[0]===a)for(const l of i){if(l===a)break;/^h2$/i.test(l.tagName)||o.appendChild(l.cloneNode(!0))}let s=a.nextElementSibling;for(;s&&!/^h3$/i.test(s.tagName);)o.appendChild(s.cloneNode(!0)),s=s.nextElementSibling;return o.children.length?Za(o):""}return Za(a)}const tn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function et({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Kr(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Jr({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const an=new Map;function Wd(e,a){const{token:r}=K(),[n,o]=c.useState(null);return c.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=an.get(i);d||(d=Xi(r,e.name,e.checkId),an.set(i,d),d.then(l=>{(!l||!l.reasoning&&!l.summaryHtml)&&an.delete(i)}));let s=!0;return d.then(l=>{s&&l&&o({id:e.id,d:l})}),()=>{s=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Gd=6e4;function Yd({o:e}){const{t:a,doDeep:r}=K(),[n,o]=c.useState(null),[i,d]=c.useState(e.memoUrl?"load":"off"),[s,l]=c.useState(()=>new Set),[g,p]=c.useState(!1),x=c.useRef(new Map);c.useEffect(()=>{let w=!0;if(l(new Set),p(!1),x.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),Ud(e.memoUrl).then(k=>{w&&(o(k),d(k?"ok":"err"))}),()=>{w=!1}},[e.memoUrl]);const u=Et(e),b=w=>{var k;return(k=x.current.get(w))==null?void 0:k.scrollIntoView({behavior:"smooth",block:"start"})},m=t.jsxs("div",{className:"cdacts",children:[Pt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:w=>{w.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const w=[e.reasoning||"",Kr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[w.length?w.join(`

`).split(`

`).map((k,h)=>t.jsx("p",{className:"cdtxt",children:k},h)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),m]})}if(i!=="ok"){const w=[e.reasoning||"",Kr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),w.length>0&&w.join(`

`).split(`

`).map((k,h)=>t.jsx("p",{className:"cdtxt",children:k},h)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:k=>{k.stopPropagation(),p(h=>!h)},children:g?a.memoHideHere:a.memoReadHere})}),g&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:k=>k.stopPropagation()}),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(w=>t.jsx("span",{className:"md-tag",children:w},w)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(w=>w.items.map(k=>t.jsx("button",{type:"button",className:"md-jump",onClick:h=>{h.stopPropagation(),b(k.id)},children:k.title},k.id)))}),n.groups.map((w,k)=>t.jsxs("div",{className:"md-grp",children:[w.label&&t.jsx("div",{className:"md-grp-h",children:w.label}),w.items.map(h=>{const v=h.poids>Gd&&!s.has(h.id),j=h.id==="fiche-contact"||h.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:y=>{y&&x.current.set(h.id,y)},children:[t.jsx("h4",{className:"md-h",children:h.title}),j&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:y=>y.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:"LinkedIn"})]}),v?t.jsx("button",{type:"button",className:"abtn md-more",onClick:y=>{y.stopPropagation(),l(E=>new Set(E).add(h.id))},children:a.memoUnfold(Math.round(h.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:h.html}}),!v&&n.mindmapSlug&&h.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Ia}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:y=>y.stopPropagation()})]})]},h.id)})]},w.label||k)),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull})]})}function Qd({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:s}=K(),[l,g]=c.useState(!1),[p,x]=c.useState(!1),[u,b]=c.useState(!1),[m,w]=c.useState(null),[k,h]=c.useState(""),[v,j]=c.useState(null),[y,E]=c.useState(""),N={airtableId:e.airtableId,checkId:e.checkId},C=!!(e.airtableId||e.checkId),L=m&&m.id===e.id?m.entries:[],q=!!m&&m.id===e.id;if(c.useEffect(()=>{h(""),j(null),b(!1)},[e.id]),c.useEffect(()=>{if(!l||q||!C||!o)return;let F=!0;x(!0),b(!1);const $=e.id;return Xn(r,"list",N).then(R=>{if(!(!F||$!==e.id)){if(x(!1),!R.ok){b(!0);return}w({id:$,entries:R.entries})}}),()=>{F=!1}},[l,q,C,r,e.id,o]),!n.pipe||!o||!C)return null;const I=(F,$)=>{x(!0);const R=e.id;Xn(r,F,N,$).then(D=>{if(R===e.id){if(x(!1),!D.ok){d(a.notesErr);return}w({id:R,entries:D.entries}),b(!1),F==="add"&&(h(""),i(a.notesAdded)),F==="edit"&&j(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":l,onClick:F=>{F.stopPropagation(),g($=>!$)},children:[t.jsx("b",{children:a.notesT}),L.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(L.length)}),t.jsx("i",{children:l?"▾":"▸"})]}),l&&t.jsxs("div",{className:"dn-b",onClick:F=>F.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),p&&!L.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!p&&!u&&q&&!L.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),L.map(F=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:s==="fr"?F.date.split("-").reverse().join("/"):F.date}),v===F.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:y,rows:3,onChange:$=>E($.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:p||!y.trim(),onClick:()=>I("edit",{entryId:F.id,text:y.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>j(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:F.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{j(F.id),E(F.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:p,onClick:()=>{window.confirm(a.notesDelAsk)&&I("delete",{entryId:F.id})},children:a.notesDel})]})]})]},F.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:k,onChange:F=>h(F.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:p||!k.trim(),onClick:()=>I("add",{text:k.trim()}),children:a.notesAdd})]})]})]})}function On({o:e}){var E;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:d}=K(),s=sa(e),l=Et(e),g=(e.cribleStatus||"").trim().toUpperCase()||(s==="NO MATCH"?"NO MATCH":s==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,u=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=c.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(g?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Pt(e)?1:0},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:u}].filter(N=>N.n>0),[e,a,o,g,l,p,x,u]),[m,w]=c.useState(""),k=b.some(N=>N.k===m)?m:((E=b[0])==null?void 0:E.k)||"",h=Wd(e,k==="eval"||k==="conv");if(!b.length)return null;const v=((h==null?void 0:h.reasoning)||"").length>(e.reasoning||"").length?h.reasoning:e.reasoning||"",j=((h==null?void 0:h.summaryHtml)||"").length>(e.summary||"").length?h.summaryHtml:e.summary||"",y=(h==null?void 0:h.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(N=>t.jsx("button",{type:"button",role:"tab","aria-selected":k===N.k,"data-tour":"tab-"+N.k,className:k===N.k?"on":"",onClick:C=>{C.stopPropagation(),w(N.k)},children:N.lib},N.k))}),t.jsxs("div",{className:"cdbody",onClick:N=>N.stopPropagation(),children:[k==="eval"&&t.jsxs(t.Fragment,{children:[g&&t.jsxs("div",{className:"cdv1"+(g==="NO MATCH"?" out":""),children:[t.jsx("b",{children:g==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(Jr,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),v&&v.split(`

`).map((N,C)=>t.jsx("p",{className:"cdtxt",children:N},C)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Kd,{o:e})]}),k==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof y=="number"&&t.jsx(Jr,{v:y,sur:100,k:a.cdConvScore}),tn(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",tn(e.verdictDate,r)]})]}),j&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:Bd(j)}})]}),k==="memo"&&t.jsx(Yd,{o:e}),k==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(et,{k:a.cdSector,v:e.sector}),t.jsx(et,{k:a.cdStage,v:e.stage}),t.jsx(et,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(et,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(et,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(et,{k:a.cdAngle,v:e.angle}),t.jsx(et,{k:a.cdDetected,v:tn(e.date,r)})]}),k==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(et,{k:a.cdName,v:e.contactName}),t.jsx(et,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(et,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(et,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),k==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(et,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(Qd,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(e),children:a.actRegen})]})]})]})]})}const va=new Map;function Kd({o:e}){const{t:a,token:r}=K(),[n,o]=c.useState(!1),[i,d]=c.useState(null);c.useEffect(()=>{if(!r||!e.name)return;const x=`${r}:${e.name.toLowerCase()}`;let u=va.get(x);u||(u=fo(r,[e.name]).then(m=>m[e.name]||Object.values(m)[0]||null).catch(()=>null),va.set(x,u),u.then(m=>{(!m||!m.ok)&&va.delete(x)}));let b=!0;return u.then(m=>{b&&m&&m.ok&&d(m)}),()=>{b=!1}},[r,e.id,e.name]);const s=async()=>{if(n)return;o(!0);const x=await po(r,e.name,e.website||e.domain||"");d(x),x.ok&&va.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(x)),o(!1)},l=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,l.value_prop],[a.qaProduct,l.produit],[a.qaModel,l.modele],[a.qaSummary,l.synthese]],p=g.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&p&&t.jsxs(t.Fragment,{children:[g.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!p&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function la({spec:e}){const a=c.useRef(null),r=c.useRef(null),[n,o]=c.useState(!1);return c.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const s=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Zn({kind:"op",card:e},g).then(p=>{!d&&p&&i.isConnected&&i.replaceChildren(p)})},l=window.requestAnimationFrame(s);return()=>{d=!0,window.cancelAnimationFrame(l),i.replaceChildren()}},[e]),c.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;Zn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(l=>{!d&&l&&i.isConnected&&i.replaceChildren(l)});const s=l=>{l.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{d=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Jd=`
...
`;function Xd(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:d,top:s}}function Zd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:s,doAnalyse:l,doDecide:g,doPromote:p,doRepeche:x,doApproach:u,doDeep:b,doOnboard:m,outbound:w,evalBusy:k}=K(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const v=Pe(h),j=Se(h),y=Et(h),E=sa(h),N=h.kind==="target",C=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Ut.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Jd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Xd(e.popupAnchor,!!h.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(yt(h.date)),Xe(h.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[h.cc]}),children:(Ht(h.cc,o)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:Vt(h.amountEur,o)})]}),i.pipe&&N&&t.jsxs("div",{className:"pstat",children:[E&&t.jsx("span",{className:"vd "+(E==="MATCH"?"v-ok":"v-no"),title:n.vt[E],children:E}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Tt(h.engine)," ",t.jsx("b",{children:Xe(h.engine,o)})," — ",Zi(h.engine,o),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),v?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(jt,{o:h,lg:!0})," ",t.jsx(Pa,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(ho(v,o))," · ",n.win7(go(v,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(la,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),i.pipe&&N&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),i.pipe&&N&&t.jsx(On,{o:h})]}),t.jsx(Rn,{name:h.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>s(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{l(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(h,!1),a({type:"popup",id:null})},children:n.actNo}),Pt(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(h),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),w&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:k,title:n.evalGoOn(h.name),onClick:()=>s(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>s(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}function ep(){const{lang:e,token:a,dossiers:r,caps:n}=K(),o=a||"home",{names:i,verdicts:d}=c.useMemo(()=>{const l=[],g={};return r.forEach(p=>{p.kind!=="target"||!p.name||(l.push(p.name),g[p.name]=es(p)||"")}),{names:l,verdicts:g}},[r]);return{diff:c.useMemo(()=>i.length?ts(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function tp(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:s}=K(),[l,g]=c.useState(!1),[p,x]=c.useState(!1),u=c.useRef(null);c.useEffect(()=>{if(!l)return;const j=y=>{u.current&&!u.current.contains(y.target)&&g(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[l]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...s.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!d.length,w=c.useRef({});c.useEffect(()=>{w.current={...r}},[r]);const k=j=>{const y=w.current[j],E=y!==void 0?r[j]-y:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${ea[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j],j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(E>0?" up":E<0?" down":""),children:[r[j],E!==0&&t.jsxs("em",{className:"delta",children:[E>0?"+":"−",Math.abs(E)]})]})]},j)},h=(j,y,E)=>t.jsxs("button",{type:"button",className:"off"+(y?" view":""),style:{"--c":`var(${ea[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:E}),t.jsx("span",{className:"n",children:r[j]})]},j),v=(j,y,E,N=!1)=>t.jsx("button",{type:"button",className:"tool",title:y,disabled:N,onClick:E,children:j},y);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(k)}),t.jsxs("div",{className:"offtrack",children:[h(5,!1,n.plabels[5]),h(7,!0,n.plabels[7]),h(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[v("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(p?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":l,title:n.toolSort,onClick:()=>g(j=>!j),children:"⇅"}),l&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([j,y])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[y,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),v("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),v("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function ap(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,doAnalyse:s,mode:l}=K(),g=c.useRef(null),[p,x]=c.useState(60);c.useEffect(()=>{let j=0;const y=()=>{var q;const E=g.current;if(!E)return;const N=(q=E.parentElement)==null?void 0:q.querySelector('.funnel [aria-selected="true"]');if(!N)return;const C=N.getBoundingClientRect(),L=E.getBoundingClientRect();x(Math.max(20,Math.min(C.left+C.width/2-L.left,L.width-30)))};return j=requestAnimationFrame(y),window.addEventListener("resize",y),()=>{cancelAnimationFrame(j),window.removeEventListener("resize",y)}},[e.ptab]);const u=e.ptab;let b=r.tuto[u].p;if(u===3){const j=i.filter(N=>N.kind==="target"&&Se(N)===3),y=j.filter(N=>sn(N)==="auto").length,E=j.filter(N=>sn(N)==="cd").length;b=r.tutoPending(y,E,j.length)}const m=(()=>{if(l!=="client")return null;if(u===0&&i.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:i.map(j=>j.id)})};if(u===1){const j=i.filter(y=>y.kind==="target"&&Se(y)===1&&!d.has(y.id)).slice(0,10);if(j.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:j.map(y=>y.id)})}}return null})(),w=as(u),k=u===1||u===2,h=r.plabels[u]+" · "+(o[u]??0),v=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:g,className:"tuto mini"+(w?"":" on-dark")+(k?" etape-on":""),style:{"--bg":`var(${ea[u]})`,"--ax":p+"px","--stc":w?"var(--ink)":"#fff","--stt":w?"#fff":"var(--ink)","--tc":w?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:h}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label}),u!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:v})]})}const nn=600,At=62,Xr="atl2:fstats";function np(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=K(),[d,s]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Xr)==="on"}catch{return!1}}),l=r.stats,g=c.useMemo(()=>((l==null?void 0:l.by_day)||[]).slice(-30),[l]),p=(l==null?void 0:l.since)||"";if(!n.showFunnel||!l||typeof l.screened!="number")return null;const x=E=>a==="en"?E.slice(5,10):`${E.slice(8,10)}/${E.slice(5,7)}`,u=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((E,N)=>Math.max(E,N.s||0),0),m=g.length?nn/g.length:0,w=Math.max(4,m-4),k=g.length>=5&&b>0,h=r.marketEstimate||0,v=x(new Date().toISOString().slice(0,10)),j=E=>[...typeof E=="number"?[[E,e.funScreened("","")]]:[],...typeof l.kept=="number"?[[l.kept,e.funKept]]:[],...typeof l.analyzed=="number"?[[l.analyzed,e.funAnalyzed]]:[],...typeof l.shown=="number"?[[l.shown,e.funShown]]:[]],y=[];return typeof l.screened_window=="number"&&p&&y.push({cle:"fenetre",periode:e.funPerWindow(x(p),v),etapes:[[l.screened_window,e.funScreened("","")]]}),typeof l.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:j(l.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[y.map(E=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:E.periode}),E.etapes.map(([N,C],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(N)}),t.jsx("i",{children:C})]},E.cle+C)),E.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((l.screened||0)/h*100)))})]}),E.cle===y[y.length-1].cle&&k&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const N=!d;s(N),N&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Xr,N?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},E.cle)),d&&k&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${nn} ${At}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((E,N)=>{const C=(E.s||0)/b*(At-4),L=(E.m||0)/b*(At-4),q=N*m+(m-w)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(E.d)} — ${E.s} ${e.actScreened} · ${E.m} ${e.actKept}`}),t.jsx("rect",{x:q,y:At-2-C,width:w,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:q,y:At-2-L,width:w,height:L,fill:"#0E7F3F"})]},E.d)}),t.jsx("line",{x1:0,y1:At-1.5,x2:nn,y2:At-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}function Zr(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}const Jo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Mn({o:e,locked:a=!1}){const{t:r}=K(),n=sa(e),o=Et(e),i=Se(e),d=sn(e),s=ns(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Jo[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(Nl,{o:e})]})}const $t=e=>e.length>22?e.slice(0,21)+"…":e;function ia(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Xo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function rp({on:e,rev:a}){const[r,n]=c.useState(null),[o,i]=c.useState({top:0,left:0,width:0});return c.useEffect(()=>{if(!e){n(null);return}const d=()=>{var m,w,k;const s=document.querySelector(".atl2.ops .desk-list"),l=document.querySelector(".atl2.ops .listhead");if(!s){n(null);return}const g=s.getBoundingClientRect(),p=l?l.getBoundingClientRect().bottom:g.top;i({top:Math.round(p),left:Math.round(g.left),width:Math.round(g.width)});const x=[...s.querySelectorAll(":scope .grp")];let u=null;for(const h of x){const v=h.querySelector(".grp-h");v&&v.getBoundingClientRect().bottom<=p+2&&(u=h)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((w=b.querySelector(".t"))==null?void 0:w.textContent)||"").trim(),s:(((k=b.querySelector(".s"))==null?void 0:k.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function op(e){const r=()=>{const n=Xo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function eo({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=K(),[i,d]=c.useState(!1);if(c.useEffect(()=>{n||d(!1)},[n]),_e(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const l=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(l?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn($t(e.name))})]})}function Dn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:d,doPromote:s,doRepeche:l,doApproach:g,dispatch:p,liveMemos:x}=K(),u=m=>w=>{w.stopPropagation(),m()};if(r.lockActions){const m=u(()=>p({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const w=Se(e);return w===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn($t(e.name))})]})}):w===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):w===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):w===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):w===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):w===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ia(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Ca(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ia(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(eo,{o:e})});const b=Se(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(eo,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Na,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const w=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:w,onClick:u(()=>i(e)),children:w?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>d(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>d(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const m=o.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>g(e)),children:m?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:u(()=>p({type:"modal",modal:"plug"})),children:a.actConn})]})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>p({type:"memoConsole",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function ip({o:e}){const{t:a,doThumb:r,thumbOf:n}=K(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function sp({o:e}){const{lang:a}=K();return Pe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(jt,{o:e}),t.jsx(Pa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Tt(e.engine||"")," ",Xe(e.engine||"",a)]})})}function lp({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:s}){const{dispatch:l,caps:g,markRow:p,markedId:x,favIds:u,toggleFav:b,t:m}=K(),w=Se(e),k=["#16233A","#475C6E","#8798A8","#B9C6D2"],h=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=h<=0?0:h<=7?1:h<=30?2:3,j=g.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][w]:k[v],y=u.has(e.id),E=N=>{if(a)return;if(d){d(e.id);return}if(g.pipe||e.kind==="op"){n();return}const C=N.currentTarget.getBoundingClientRect();l({type:"popup",id:e.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return t.jsxs(c.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+w:"")+(y?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>p(e.id),onMouseLeave:()=>p(null),onClick:E,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(ri,{o:e}),t.jsxs("span",{className:"nd",children:[s&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${m.cdEngagement} ${Math.round(e.engagement*10)/10} · ${m.cdEngagementHint}`,children:"🔥"}),Pe(e)&&t.jsx(jt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:y?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),b(e)},children:y?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Ye(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(N=>N&&N!==e.name)||""]}),g.pipe&&!g.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:N=>N.stopPropagation(),children:[e.website&&t.jsx("a",{href:Zr(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowSite,title:m.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:Zr(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowLi,title:m.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":m.rowMail,title:m.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":m.rowTel,title:m.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:N=>{N.stopPropagation(),l({type:"acquirer",value:e.acquirer||""})},children:["← ",$t(e.acquirer)]}),Qe(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(dp,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(sp,{o:e}),g.pipe&&t.jsx(Mn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Dn,{o:e}),g.showThumbs&&t.jsx(ip,{o:e})]}),r&&!a&&!d&&t.jsx(up,{o:e})]})}function dp({o:e}){const{lang:a,caps:r}=K();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Vt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function pp({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=K(),d=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),l=Vt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),p=_e(e),x=p&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),l&&t.jsx("span",{className:"oc-amt",children:l}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[p?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Ye(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),ia(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn($t(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(la,{spec:e.card})})]})}function cp({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=K();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Xe(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Dn,{o:e})}),t.jsx(On,{o:e})]})}function Zo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:s,dossiers:l}=K(),g=c.useRef(null),p=Qe(e);if(c.useEffect(()=>{if(!p||!(e!=null&&e.decryptHtml))return;const f=g.current;if(!f)return;let A=!1;return rn(()=>import("./fit-BnaWm7z_.js"),[]).then(async H=>{await H.ensureEditoCss(),!(A||!f.isConnected)&&(H.beautifyEditoRows(f),H.mountCardFits(f))}),()=>{A=!0}},[p,e==null?void 0:e.decryptHtml]),!e&&!a){const f=l.find(Qe);if(f)return t.jsx(Zo,{o:f})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),w=e?!!e.noCo:!x||Sa(x),k=(e==null?void 0:e.engine)||"",h=Qe(e),v=e?Vt(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),y=(()=>{const f=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return f?f[1].replace(/^www\./,"").slice(0,40):""})(),E=l.find(Qe),N=((E==null?void 0:E.url)||"").trim(),C=!!u&&!!N&&(u===N||u.endsWith(N)||N.endsWith(u)),L=(f,A=!1)=>H=>{H.stopPropagation(),A&&d({type:"continent",key:"monde"}),d({type:"filters",patch:f})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const q=()=>{x&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:x}}))},I=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},F=()=>{ia({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},$=e?_e(e):!1,R=$&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",D=h?r.doEdito.replace(/^📖\s*/,""):k?Xe(k,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[D,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!h&&(w||Ca({engine:k}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:f=>f.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,y?t.jsx("em",{children:y}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(h?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),v&&t.jsx("span",{className:"oc-amt",children:v})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(la,{spec:m})}),(u&&!C&&!h||E&&!h)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!C&&!h&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:f=>f.stopPropagation(),children:[r.zoomSrc,y?` · ${y}`:""," ↗"]}),E&&!h&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:f=>{f.stopPropagation(),d({type:"focus",id:E.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[$?t.jsxs("span",{className:"verdict",style:{"--c":R?"var(--brand)":"var(--red)"},children:[R?"✓":"✗"," ",t.jsx("b",{children:R?r.kept:r.dropped})]}):!w&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:f=>{f.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn($t(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!h&&(w||Ca({engine:k}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!w&&x?" ghost":""),onClick:f=>{f.stopPropagation(),F()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!w&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!s.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:f=>{f.stopPropagation(),I()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:f=>{f.stopPropagation(),q()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:$t(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!w&&x&&s.pipe&&t.jsx(Rn,{name:x})]})]})}function up({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=K();return!o.pipe&&e.kind==="op"?t.jsx(pp,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(On,{o:e}),t.jsx(Sl,{o:e}),t.jsx(zl,{o:e}),t.jsx(Rn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Mn,{o:e})})]}),e.card&&t.jsx(la,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Tt(e.engine||"")," ",Xe(e.engine||"",r)]}),Pe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(jt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function mp({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:s,lang:l}=K();if(!d.pipe&&e.kind==="op"){const x=Vt(e.amountEur,l),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,w=!1)=>k=>{k.stopPropagation(),w&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(la,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Tt(e.engine||"")," ",Xe(e.engine||"",l)]}),Pe(e)&&t.jsx(jt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Dn,{o:e})})]})}const g=Se(e),p=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":p},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Mn,{o:e}),Pe(e)&&t.jsx(jt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>s(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>s(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function fp(){const{t:e}=K(),[a,r]=c.useState(0);return c.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function hp({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=K(),i=o==="en",d=p=>n.plabels[p]||"",s=[0,1,2,3,4,5,6,7].filter(p=>p!==a.ptab&&(e[p]||0)>0),l=s.includes(0)?0:s.sort((p,x)=>(e[x]||0)-(e[p]||0))[0];if(l===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[l]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:l===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${d(l)}”`:`${g} dossier${g>1?"s":""} dans « ${d(l)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:l}),children:[(i?"Open ":"Ouvrir ")+d(l)," →"]})]})}function gp(){var gt,Ot,Mt,Ie,Ke;const e=K(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:s,markRow:l,lang:g,sessTally:p,data:x,dossiers:u,source:b,focusExtra:m,byId:w,token:k}=e,h=vo(),v=c.useMemo(()=>{var J,ce,je,P;if(!k||b==="ops")return null;const T=(((J=h==null?void 0:h.ed)==null?void 0:J.date)||(h==null?void 0:h.day)||"").slice(0,10),V=[(ce=h==null?void 0:h.ed)==null?void 0:ce.html,(je=h==null?void 0:h.ed)==null?void 0:je.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((P=h==null?void 0:h.ed)==null?void 0:P.date)||T,decryptHtml:V||void 0,date:T,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[k,b,g,(gt=h==null?void 0:h.ed)==null?void 0:gt.html,(Ot=h==null?void 0:h.ed)==null?void 0:Ot.acquirers_html,(Mt=h==null?void 0:h.ed)==null?void 0:Mt.date,h==null?void 0:h.day]),j=T=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:bo,[y,E]=c.useState(new Set);c.useEffect(()=>{E(new Set)},[a.ptab,a.continent]);const[N,C]=c.useState(null);c.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[L,q]=c.useState(!a.mapFolded);c.useEffect(()=>{if(a.mapFolded){q(!1);return}const T=document.getElementById("atl2-stage");if(!T){q(!1);return}const V=new IntersectionObserver(([J])=>q(!!J&&J.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return V.observe(T),()=>V.disconnect()},[a.mapFolded]);const I=a.mapFolded||!L,F=T=>E(V=>{const J=new Set(V);return J.has(T)?J.delete(T):J.add(T),J}),$=b==="ops"||o.pipe,[R,D]=c.useState("all"),[f,A]=c.useState(!1),[H,X]=c.useState(null),[S,O]=c.useState(!1),M=c.useRef(!0);c.useEffect(()=>{if(M.current){M.current=!1;return}D("all"),O(!1)},[a.ptab,a.continent]),c.useEffect(()=>{if(!S)return;const T=V=>{var J,ce;(ce=(J=V.target)==null?void 0:J.closest)!=null&&ce.call(J,".atl2 .doable")||O(!1)};return document.addEventListener("click",T,!0),()=>document.removeEventListener("click",T,!0)},[S]);const _=c.useMemo(()=>{var V;const T=new Map;for(const J of cl(((V=h==null?void 0:h.ed)==null?void 0:V.html)||""))T.has(J.t)||T.set(J.t,J.html);return T},[(Ie=h==null?void 0:h.ed)==null?void 0:Ie.html]),ee=c.useCallback(T=>{if(T.decryptHtml)return T.decryptHtml;if(!_.size)return;const V=(T.name||"").trim().toLowerCase();if(V.length<3)return;const J=_.get(V);if(J)return J;for(const[ce,je]of _)if(ce.includes(V)||V.includes(ce))return je},[_]),{diff:Z}=ep(),[be,te]=c.useState(!1),pe=a.filters.win==="1"&&!a.filters.day,[me,ge]=c.useState(!1),B=c.useMemo(()=>new Set(((Z==null?void 0:Z.added)||[]).map(T=>T.trim().toLowerCase()).filter(Boolean)),[Z]),Q=c.useMemo(()=>{if(!B.size)return 0;const T={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(V=>!Qe(V)&&B.has((V.name||"").trim().toLowerCase())&&ta(V,T,o.pipe)).length},[u,B,a,o.pipe]);c.useEffect(()=>{const T=()=>{ge(!1),A(!1),D("all"),O(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",T),()=>window.removeEventListener("ppmap:tunnel",T)},[]),c.useEffect(()=>{ge(!1),A(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const G=c.useMemo(()=>{const T=s.filter(J=>!Qe(J)&&Ye(J));let V="";for(const J of T){const ce=(J.date||"").slice(0,10);ce&&(!V||ce<V)&&(V=ce)}return{n:T.length,since:V?V.split("-").reverse().slice(0,2).join("/"):""}},[s]),ae=G.n,U=c.useMemo(()=>{const V=me&&B.size>0||a.filters.signalOnly||R!=="all"||f?s:d;let J=An(V,a.sort);return J=J.filter(ce=>!Qe(ce)),me&&B.size&&(J=J.filter(ce=>B.has((ce.name||"").trim().toLowerCase()))),f||R==="explore"?J=J.filter(Ye):R==="eval"?J=J.filter(ce=>!Ye(ce)&&!ce.noCo&&(ce.kind==="op"||!_e(ce))):o.pipe&&(J=J.filter(ce=>!Ye(ce))),J},[d,s,a.sort,R,me,B,f,o.pipe]),le=c.useMemo(()=>o.pipe?u.filter(T=>T.kind==="target"&&!Qe(T)&&Pe(T)&&(a.continent==="monde"||T.continent===a.continent)):U.filter(T=>Pe(T)&&!_e(T)),[o.pipe,u,U,a.continent]).length,ne=c.useMemo(()=>o.pipe?U:U.filter(T=>!_e(T)&&!T.noCo&&!Ye(T)),[U,o.pipe]),ue=b==="ops"?U.filter(Ye).length:0,de=me?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,xe=a.filters,Re=xe.sector.length+xe.country.length+xe.engine.length+xe.stage.length+xe.crible.length+xe.angle.length+xe.memoLevel.length+xe.dealKind.length+(xe.signalOnly?1:0)+(xe.acquirer.trim()?1:0)+(xe.search.trim()?1:0),ye=[];if(xe.day)ye.push({k:"day",lib:n.fDay(xe.day.slice(8,10)+"/"+xe.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(xe.win&&xe.win!=="all"){const T=["1","7","30"].indexOf(xe.win);T>=0&&ye.push({k:"win",lib:n.dates[T],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ce=T=>T.length<=2?T.join(", "):`${T.length} ${n.fSelected}`;for(const T of["sector","country","engine","crible"]){const V=xe[T];V&&V.length&&ye.push({k:T,lib:Ce(V),off:()=>r({type:"clearFacet",facet:T})})}xe.search&&ye.push({k:"search",lib:"🔍 "+xe.search,off:()=>r({type:"filters",patch:{search:""}})}),me&&B.size&&ye.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>ge(!1)}),xe.signalOnly&&ye.push({k:"sig",lib:"🔴 "+n.sigDock(le||xe.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const ze=(T,V,J="",ce=!1)=>t.jsxs("button",{type:"button","data-s":T,className:J,"aria-sort":a.sort.key===T?a.sort.dir===1?"ascending":"descending":"none",style:ce?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:T}),children:[V,t.jsx("span",{className:"ar",children:a.sort.key===T&&a.sort.dir===1?"▴":"▾"})]},T),Me=c.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const T=new Map;U.forEach(ce=>{const je=ce.engine||"?";T.has(je)||T.set(je,[]),T.get(je).push(ce)});const V={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},J=on([...T.keys()],g);return[...T.entries()].sort((ce,je)=>{const P=V[ce[0]]??10+J.indexOf(ce[0]),ie=V[je[0]]??10+J.indexOf(je[0]);return P-ie})},[U,o.pipe,a.groupBy,g]),ft=Me?Me.filter(([T])=>wa.has(T)).length:0,ot=(()=>{var V;return((V=(Me?Me.flatMap(([,J])=>J):U)[0])==null?void 0:V.id)??null})(),Be=c.useRef(!1),ke=c.useMemo(()=>u.find(Qe)||v,[u,v]);c.useEffect(()=>{const T=()=>{Be.current=!0,ge(!1)};return window.addEventListener("ppmap:reveal",T),window.addEventListener("ppmap:focus",T),()=>{window.removeEventListener("ppmap:reveal",T),window.removeEventListener("ppmap:focus",T)}},[]),c.useEffect(()=>{const T=()=>{ke&&r({type:"focus",id:ke.id})};return window.addEventListener("ppmap:edito",T),()=>window.removeEventListener("ppmap:edito",T)},[ke,r]),c.useEffect(()=>{if(!a.focusId)return;X(a.focusId);const T=window.setTimeout(()=>X(null),900);return()=>window.clearTimeout(T)},[a.focusId]),c.useEffect(()=>{if($&&!(a.focusId&&(U.some(T=>T.id===a.focusId)||u.some(T=>T.id===a.focusId)||a.focusId===(ke==null?void 0:ke.id)))&&!m){if(ke){r({type:"focus",id:ke.id});return}ot&&r({type:"focus",id:ot})}},[$,a.focusId,U,ot,m,r,u,b,ke]),c.useEffect(()=>{if(!$||!a.focusId||ke&&a.focusId===ke.id||U.some(V=>V.id===a.focusId))return;const T=u.find(V=>V.id===a.focusId);if(T){if(Be.current){T.kind==="op"?D(Ye(T)?"explore":"eval"):R!=="all"&&D("all");return}R!=="all"&&ot&&r({type:"focus",id:ot})}},[$,a.focusId,R,U,u,ot,r,ke]),c.useEffect(()=>{if(!$||!a.focusId||!Be.current)return;const T=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!T){const je=U.findIndex(P=>P.id===a.focusId);if(je>=0){const P=Me?"":"pt"+a.ptab;if(P){const ie=a.shown[P]||j();je>=ie&&r({type:"more",group:P,by:je-ie+8})}}return}Be.current=!1;const V=Xo(),J=T.getBoundingClientRect();J.top>=V-2&&J.bottom<=window.innerHeight-4||op(T)},[$,a.focusId,a.ptab,U,a.shown,Me,r]),c.useEffect(()=>{if(typeof window>"u")return;const T=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),V=document.querySelector(".atl2.ops, .atl2.cibles");if(!T||!V)return;const J=()=>V.style.setProperty("--listhead-h",`${T.offsetHeight}px`);J();const ce=new ResizeObserver(J);return ce.observe(T),()=>ce.disconnect()},[I,a.dens,a.mapFolded]);const st=c.useMemo(()=>{if(!$||!a.focusId)return null;if(v&&a.focusId===v.id)return v;const T=U.find(J=>J.id===a.focusId)||u.find(J=>J.id===a.focusId)||null;if(!T)return null;const V=ee(T);return V&&V!==T.decryptHtml?{...T,decryptHtml:V}:T},[$,a.focusId,U,u,ee,v]),Nt=o.lockRowsAfter;let He=0;const lt=(T,V)=>{let J=a.shown[V]||j();return T.length-J<=4&&(J=T.length),T.slice(0,J).map(P=>{const ie=Nt!==null&&He>=Nt;He++;const fe=ee(P),oe=fe&&fe!==P.decryptHtml?{...P,decryptHtml:fe}:P,Ee=!$&&a.dens!=="maxi"&&(a.dens==="deplie"||(N?N==="open":!!fe)),De=y.has(P.id)?!Ee:Ee,Ve=$?qe=>{Be.current=!0,r({type:"focus",id:qe});const We=w.get(qe);We&&(Ye(We)?ia(We):We.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:We.name,url:We.url||"",website:We.website||"",domain:We.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(mp,{o:oe,locked:ie,selected:$&&a.focusId===P.id,onSelect:Ve},P.id):t.jsx(lp,{o:oe,locked:ie,open:De,onToggle:()=>F(P.id),selected:$&&a.focusId===P.id,echo:H===P.id,fresh:B.has((P.name||"").trim().toLowerCase()),onSelect:Ve},P.id)})},ht="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(U.length?"":" list-empty"),St=t.jsxs(t.Fragment,{children:[Me?Me.map(([T,V])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Tt(T)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:T==="ma"?n.grpMa:T==="fundraising"?n.grpLev:wa.has(T)&&ft<=1?n.grpNews:T==="nominations"?n.grpNom:T==="media"?n.grpNewsOther:T==="recrutements"?n.grpHire:wa.has(T)?n.grpNews+" · "+Xe(T,g):Xe(T,g)}),t.jsx("div",{className:"s",children:n.grpCount(V.filter(J=>!_e(J)).length,V.length)})]})]}),lt(V,T)]},T)):lt(U,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(fp,{}),o.pipe&&a.ptab===0&&!f&&!me&&R==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(Go,{}),!U.length&&!(x.loading&&!u.length)&&(o.pipe&&R==="all"?t.jsx(hp,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(xe.win!=="all"||!!xe.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),Re>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(Re)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),Ze=t.jsxs(t.Fragment,{children:[!me&&!f&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ea[a.ptab]+")"},children:U.length})," ",de]}),f&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ea[a.ptab]+")"},children:U.length})," ",n.newsWord]}),(!me||f)&&t.jsx("span",{className:"dot",children:"·"}),I&&t.jsx(Vo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[I?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ye.map(T=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:V=>{V.stopPropagation(),T.off()},children:[T.lib,t.jsx("i",{children:"×"})]},T.k)),b==="ops"&&U.length>0&&!I&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",U.length-ue," ",n.zoomPulseEval,ue>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",ue," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),Ct=t.jsxs("div",{className:"listhead"+(I?" mapoff":""),children:[I&&t.jsx("div",{className:"lh-tools",children:t.jsx(Ho,{compact:!0})}),o.showFunnel&&be&&pe&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(ql,{}),t.jsx(np,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:Ze}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(tp,{}),t.jsx(ap,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(pe?" on":""),"aria-pressed":pe,title:n.morningDockTitle,onClick:()=>{if(pe){r({type:"filters",patch:{win:"all",day:""}}),te(!1);return}ge(!1),A(!1),D("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),te(!0)},children:["📊 ",n.morningDock(typeof((Ke=x.stats)==null?void 0:Ke.screened_today)=="number"?x.stats.screened_today:0)]}),Z&&!Z.firstVisit&&(Z.added.length>0||Z.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(me?" on":""),"aria-pressed":me,title:n.sinceSub,onClick:()=>{const T=!me;ge(T),A(!1),te(!1),D("all"),T&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(Q),Z!=null&&Z.lastDate?` · ${n.sinceSince(Z.lastDate)}`:""]}),le>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{ge(!1),A(!1),te(!1),D("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(le)]}),o.pipe&&ae>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(f?" on":""),"aria-pressed":f,title:n.newsDockHint,onClick:()=>{const T=!f;A(T),ge(!1),te(!1),D("all"),T&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ae),G.since?` · ${n.newsSince(G.since)}`:""]})]}),!o.showFunnel&&Ze,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([T,V])=>t.jsxs("button",{type:"button","data-d":T,"aria-pressed":a.dens===T||T==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:T}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:V})]},T))}),!$&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":N==="open",onClick:()=>{C("open"),E(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":N==="closed",onClick:()=>{C("closed"),E(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var fe;const T={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},V=u.filter(oe=>ta(oe,T,o.pipe)&&!Qe(oe)),J=V.filter(oe=>!Ye(oe)&&!oe.noCo&&(oe.kind==="op"||!_e(oe))).length,ce=V.filter(Ye).length,je=o.pipe?V.filter(oe=>oe.kind!=="op"&&Se(oe)===1).length:0,P=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${je?` ${je}`:""}`]]:[],["eval",`${n.doEval}${J?` ${J}`:""}`],["explore",`${n.doExplore}${ce?` ${ce}`:""}`]],ie=((fe=P.find(([oe])=>oe===R))==null?void 0:fe[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":S,onClick:()=>O(oe=>!oe),children:[ie,t.jsx("i",{children:"▾"})]}),S&&t.jsx("div",{className:"dolist",children:P.map(([oe,Ee])=>t.jsx("button",{type:"button","aria-pressed":R===oe,onClick:()=>{if(O(!1),oe==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}D(oe),oe!=="all"&&(ge(!1),A(!1),te(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:Ee},oe))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:T=>r({type:"sort",key:T.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([T,V])=>t.jsx("option",{value:T,children:V},T))})]}),o.showChain&&ne.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ne.map(T=>T.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ne.length):n.chainAll(ne.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!$&&Ct,a.dens!=="maxi"&&!$&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ze("country",n.colCountry),ze("name",n.colCompany),ze("amount",n.colAmount,"h-amt",!0),ze("stage",n.colStage,"h-stade"),ze("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ze("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ze("memo",n.colMemo)]}),o.pipe&&ze("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),$?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[Ct,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ze("country",n.colCountry),ze("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ze("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ze("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ht,children:St})]}),t.jsxs("aside",{className:"readpane"+((st?Qe(st):!m&&ke)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[ke&&(()=>{const T=a.focusId===ke.id,V=(ke.headline||ke.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":T,onClick:()=>r({type:"focus",id:ke.id}),children:[t.jsx("span",{className:"eg-t",children:g==="en"?"Today’s editorial":"Édito du jour"}),V&&t.jsx("span",{className:"eg-sub",children:V}),t.jsx("span",{className:"eg-chev",children:T?g==="en"?"Collapse ▴":"Replier ▴":g==="en"?"Read ▾":"Lire ▾"})]})})(),v&&a.focusId===v.id?t.jsx("div",{className:"zoom",children:t.jsx(gl,{})}):st&&o.pipe?t.jsx(cp,{o:st}):t.jsx(Zo,{o:st,extra:st?null:m})]})]}):t.jsx("div",{className:ht,children:St}),(()=>{const T=Me||[["pt"+a.ptab,U]];let V=0,J=0;for(const[je,P]of T){J+=P.length;let ie=a.shown[je]||j();P.length-ie<=4&&(ie=P.length),V+=Math.min(P.length,ie)}const ce=J-V;return ce<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>T.forEach(([je,P])=>r({type:"more",group:je,by:P.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(ce,ce)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(V,J)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}}),$&&b==="ops"&&a.dens!=="maxi"&&t.jsx(rp,{on:!!Me,rev:(Me||[]).map(([T,V])=>T+V.length).join("|")})]})}function to(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function xp(e,a){const r=rs(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function bp(e,a){const n=[a.head.split("|").map(to).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",xp(o,a.plabels),sa(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(to).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function vp(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const yp=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ct({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function wp({o:e,qa:a}){const{t:r,lang:n,fund:o}=K(),i=(e.cribleStatus||"").trim().toUpperCase()||(sa(e)==="NO MATCH"?"NO MATCH":"MATCH"),d=Et(e),s=(a==null?void 0:a.blocs)||{},l=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,d&&t.jsx("em",{children:d})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(ct,{k:r.cdSector,v:e.sector}),t.jsx(ct,{k:r.cdStage,v:e.stage}),t.jsx(ct,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ct,{k:r.cdSite,v:e.domain||e.website}),t.jsx(ct,{k:r.cdName,v:e.contactName}),t.jsx(ct,{k:r.cdEmail,v:e.contactEmail}),t.jsx(ct,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(ct,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(ct,{k:r.cdAngle,v:e.angle}),t.jsx(ct,{k:r.cdDetected,v:yp(e.date,n)})]}),l.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),l.filter(([,g])=>g).map(([g,p])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:p})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function kp(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d}=K(),[s,l]=c.useState({}),g=25,p=c.useMemo(()=>n.slice(0,g),[n]);c.useEffect(()=>{p.length&&fo(r,p.map(b=>b.name)).then(l)},[r,p]);const x=i.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(p.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(x.screened/i.marketEstimate*100)," %"]})]})]}),p.map(b=>t.jsx(wp,{o:b,qa:s[b.name]},b.id)),!p.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const jp=50;function In({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=K(),[i,d]=c.useState(null),[s,l]=c.useState(!1),[g,p]=c.useState(""),[x,u]=c.useState(0),[b,m]=c.useState(""),[w,k]=c.useState(!1),[h,v]=c.useState(0),j=c.useRef(null),y=c.useRef(null),E=()=>{v(0),y.current&&window.clearInterval(y.current),y.current=window.setInterval(()=>v(q=>q+1),1e3)},N=()=>{y.current&&(window.clearInterval(y.current),y.current=null)};c.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),y.current&&window.clearInterval(y.current)},[]);const C=async q=>{l(!0),p(""),E();const I=await a();if(l(!1),N(),I.ok){d(I);return}if(I.busy){p(o.alertPreviewBusy);return}if(!q){p(o.alertPreviewFail);return}u(jp),N(),j.current=window.setInterval(()=>{u(F=>F>1?F-1:(j.current&&window.clearInterval(j.current),C(!1),0))},1e3)},L=async()=>{if(n||w||s)return;k(!0),m(""),E();const q=await r();k(!1),N(),m(q.ok?o.alertTestOk(q.sentTo||""):q.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||w||x>0,onClick:()=>{C(!0)},children:s?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||w||s,onClick:()=>{L()},children:w?o.alertBtnTestBusy:o.alertTest})]}),s&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(h)]}),w&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(h)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const vt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ge({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=K();return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Ep(){const{st:e}=K();switch(e.modal){case"chain":return t.jsx(Sp,{});case"space":return t.jsx(Cp,{});case"alert":return t.jsx(zp,{});case"queue":return t.jsx(Fp,{});case"export":return t.jsx(Rp,{});case"plug":return t.jsx(Dp,{});case"approach":return t.jsx(Ip,{});case"recharge":return t.jsx(Bp,{});case"cover":return t.jsx(Up,{});case"dossier":return t.jsx($p,{});case"crit":return t.jsx(Wp,{});case"tuto":return t.jsx(Gp,{});case"rdv":return t.jsx(Np,{});case"memoalert":return t.jsx(Op,{});default:return null}}function Np(){const{dispatch:e,fund:a,t:r}=K(),n=a||r.rdvCoFallback;return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:ko,children:Tn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Aa}`,children:Aa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Ls,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function Sp(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:s,caps:l,memoQueued:g,doAnalyse:p}=K(),x=i==="client",u=e.chain.queue.map(k=>r.get(k)).filter(k=>!!k),b=e.chain.idx,m=u[b],w=b>=u.length;return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:w?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(w?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:w||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Ht(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(yt(m.date))].filter(Boolean).map(k=>String(k)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Xe(m.engine,o)}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Vt(m.amountEur,o)})]}),Pe(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(jt,{o:m,lg:!0})," ",t.jsx(Pa,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&_e(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&_e(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":qt(m)==="retenu"?"var(--brand)":qt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:qt(m)==="retenu"?"✓ "+n.kept:qt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!w&&m&&l.pipe&&Se(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{p(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!w&&m&&!(x&&_e(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var k;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(k=document.querySelector(".atl2 .demand"))==null||k.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{d(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(w?{type:"modal",modal:null}:{type:"chainNext"}),children:w?n.closeBtn:n.skip})]})]})})}),document.body)}function Cp(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=K(),i=o==="client",d=c.useMemo(()=>i?r.filter(x=>_e(x)):[],[r,i]),s=c.useMemo(()=>An(d.filter(x=>qt(x)==="retenu"),{key:"signal",dir:-1}),[d]),l=c.useMemo(()=>d.filter(x=>qt(x)==="ecarte"),[d]),g=e.spaceTab==="retenu"?s:l,p=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ge,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:l.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":p},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function zp(){const{mode:e}=K();return e==="client"||e==="apercu"?t.jsx(Ap,{}):t.jsx(Lp,{})}function Ap(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=K(),[i,d]=c.useState("d"),s=o!=="client";return t.jsxs(Ge,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(qp,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(Tp,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(ei,{})]})}function qp({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[s,l]=c.useState(!1),[g,p]=c.useState(0);c.useEffect(()=>{let L=!0;return l(!1),rr(a).then(q=>{L&&(q?d(q):l(!0))}),()=>{L=!1}},[a,g]);const x=c.useRef({}),[u,b]=c.useState({}),[m,w]=c.useState(!1),[k,h]=c.useState(!1),v=c.useRef(null);c.useEffect(()=>()=>{v.current&&window.clearTimeout(v.current)},[]);const j=L=>{const q=x.current;Object.keys(q).length&&(w(!0),rr(a,q).then(I=>{if(!I){w(!1),o(e.actErr);return}if(I.throttled&&L<3){v.current=window.setTimeout(()=>j(L+1),5400);return}if(x.current={},b({}),d(I),w(!1),I.throttled){o(e.alertThrottled);return}h(!0),window.setTimeout(()=>h(!1),2e3),n(e.alertSaved)}))},y=L=>{r||(x.current={...x.current,...L},b(q=>({...q,...L})),v.current&&window.clearTimeout(v.current),v.current=window.setTimeout(()=>j(1),700))};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const E={...i,...u},N=L=>!E.sections||E.sections.includes(L),C=L=>{const q=E.sections||e.alertSec.map(([I])=>I);y({sections:N(L)?q.filter(I=>I!==L):[...q,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":E.enabled===!0,disabled:r,style:E.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>y({enabled:!E.enabled}),children:E.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>y({hour:Math.max(6,(E.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[E.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>y({hour:Math.min(21,(E.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>y({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>y({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&k&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,q])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:N(L),disabled:r,onChange:()=>C(L)}),t.jsxs("span",{children:[q,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(In,{label:e.alertPreview,readOnly:r,onPreview:()=>xs(a),onTest:()=>gs(a)}),E.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),E.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",E.email_lead,E.last_sent?` · ${e.updatedAt(E.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Tp({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[s,l]=c.useState(!1),[g,p]=c.useState(0);c.useEffect(()=>{let m=!0;return l(!1),or(a).then(w=>{m&&(w?d(w):l(!0))}),()=>{m=!1}},[a,g]);const x=m=>{r||or(a,m).then(w=>{if(!w){o(e.actErr);return}d(w),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,w)=>t.jsx("option",{value:w,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(In,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>vs(a),onTest:()=>bs(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function ei(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=K(),[d,s]=c.useState(i||""),[l,g]=c.useState(!1),[p,x]=c.useState(!1);c.useEffect(()=>{i&&s(i)},[i]);const u=e.filters,b=c.useMemo(()=>n.filter(h=>Pe(h)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,w=async()=>{if(!(!/.+@.+\..+/.test(d)||p)){x(!0);try{await fetch(`${Ia}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},k=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>Xe(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>Ht(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return l?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:k.map(([h,v])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:v}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:h=>s(h.target.value),onKeyDown:h=>{h.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Lp(){const{t:e}=K();return t.jsx(Ge,{title:e.alertTitle,icon:"🔔",children:t.jsx(ei,{})})}function Fp(){var F,$;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:s,dispatch:l,liveMemos:g}=K(),[p,x]=c.useState(()=>Ua(r)),[u,b]=c.useState(()=>!Ua(r)),[m,w]=c.useState([]),[k,h]=c.useState(0),v=n==="client",j=c.useMemo(()=>{const R=new Map;return o.forEach(D=>{const f=(D.name||"").trim().toLowerCase();f&&!R.has(f)&&R.set(f,D)}),R},[o]);c.useEffect(()=>{let R=!0;return(!Ua(r)||k>0)&&b(!0),(async()=>{const[D,f]=await Promise.all([Sn(r,k>0),lo(a)]);R&&(D&&x(D),b(!1),w(f))})(),()=>{R=!1}},[a,r,k]);const y=u&&!p,E=(p==null?void 0:p.per_day)??0,N=((F=p==null?void 0:p.analyzed_today)==null?void 0:F.length)??0,C=p==null?void 0:p.offre,L=(p==null?void 0:p.pool_meta)||[],q=c.useMemo(()=>{const R=new Map;for(const D of(p==null?void 0:p.scheduled)||[])for(const f of D.names||[])R.has(f)||R.set(f,{label:D.day_label,date:D.date});return R},[p==null?void 0:p.scheduled]),I=(p==null?void 0:p.in_progress)||[];return t.jsxs(Ge,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:y?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(N,N+((($=p==null?void 0:p.pool_order)==null?void 0:$.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!y&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(E)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(I.length>0||g.items.some(R=>R.status==="boot"||R.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(R=>R.status==="boot"||R.status==="running"||R.status==="error").map(R=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:R.name}),t.jsx("span",{className:"qd",children:R.memoType||""}),t.jsx(Na,{item:R,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+R.name)),I.filter(R=>!g.liveOf(R.name)).map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.name}),t.jsxs("span",{className:"qd",children:[R.memo_type||"",R.age_min?` · ${Math.round(R.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:R.state||""})]},"ip-"+R.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.company}),t.jsxs("span",{className:"qd",children:[R.memo_type,typeof R.est_min=="number"?` · ~${R.est_min} min`:""]}),t.jsx("span",{className:"qt",children:R.status}),R.url&&t.jsx("a",{className:"qgo",href:R.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(R.memo_type)}),v&&R.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{ar(a,R.company,"retry").then(()=>h(D=>D+1))},children:e.queueRetry}),v&&R.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{ar(a,R.company,"delete").then(()=>h(D=>D+1))},children:e.queueDelete})]},R.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",y?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[y&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!y&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((R,D)=>{const f=q.get(R.name),A=j.get((R.name||"").trim().toLowerCase()),H=g.liveOf(R.name),X=!!(A&&d.has(A.id))||!!(H&&(H.status==="boot"||H.status==="running")),S=!!(A&&Se(A)===1&&!A.memoUrl)&&!H;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",D+1]}),f?t.jsx("span",{className:"qwhen"+(f.label==="demain"?" soon":""),children:f.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:R.name}),R.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof R.score=="number"&&t.jsx("span",{className:"qs2",children:R.score}),H&&(H.status==="boot"||H.status==="running")&&t.jsx(Na,{item:H,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),S&&(s.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>l({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:X,onClick:()=>{i(A),h(O=>O+1)},children:X?e.actAnalyseQueued:e.actAnalyse})),R.excerpt&&t.jsx("span",{className:"qex",children:R.excerpt})]},R.name+":"+D)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([R,D])=>t.jsxs("li",{children:[t.jsx("b",{children:R})," — ",D]},R))})]})}function Rp(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=K(),s=`${vt}/cibles/list.csv?token=${a}`,l=`${vt}/cibles/list.json?token=${a}`,g=`${vt}/cibles/export.xlsx?token=${a}&scope=full`,p=`=IMPORTDATA("${s}")`,x=k=>{var h;(h=navigator.clipboard)==null||h.writeText(k).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:p},{def:e.exportLive,value:l,href:l},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{vp(bp(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:k=>(e.stg.find(([h])=>h===k)||["",""])[1]})),r(e.exportViewDone(n.length))},w=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ge,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:w,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:k,value:h,href:v})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:k[0]}),t.jsxs("div",{children:[t.jsx("b",{children:k[1]}),t.jsx("p",{children:k[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(h),children:e.exportCopy}),v&&t.jsx("a",{className:"exb",href:v,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},k[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Op(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=K(),i=o!=="client",[d,s]=c.useState(null),[l,g]=c.useState(!1),[p,x]=c.useState(0),[u,b]=c.useState(!1);c.useEffect(()=>{let h=!0;return g(!1),er(a).then(v=>{h&&(v?s(v):g(!0))}),()=>{h=!1}},[a,p]);const m=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},w=h=>{if(i||!d)return;const v={enabled:h.enabled??!!d.enabled,email:h.email??(d.email||""),sections:h.sections??m()};b(!0),er(a,v).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(l)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(h=>h+1),children:e.retry})]})});if(!d)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const k=m();return t.jsxs(Ge,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||u,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(Mp,{value:d.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>w({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!k[h],disabled:i||u,onChange:()=>w({sections:{...k,[h]:!k[h]}})}),t.jsx("span",{children:v})]},h))}),t.jsx(In,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>is(a,k),onTest:()=>os(a,k)})]})}function Mp({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=c.useState(e);c.useEffect(()=>{d(e)},[e]);const s=i.trim()!==e.trim(),l=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>d(g.target.value),onKeyDown:g=>{g.key==="Enter"&&s&&l&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!l,onClick:()=>o(i.trim()),children:n})]})]})}function Dp(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=K(),[i,d]=c.useState(null),[s,l]=c.useState(!1),[g,p]=c.useState(null),[x,u]=c.useState(!1),[b,m]=c.useState(""),[w,k]=c.useState(0),[h,v]=c.useState("webhook"),[j,y]=c.useState(""),E=c.useRef(!1);c.useEffect(()=>{let F=!0;return l(!1),tr(a).then($=>{F&&($?d({configured:$.configured,url_hint:$.url_hint}):l(!0))}),ps(a).then($=>{if(F){if(!$){u(!0);return}u(!1),p($),E.current||(E.current=!0,$.destination==="instantly"&&v(R=>R==="webhook"?"instantly":R),$.campaign_id&&y(R=>R||$.campaign_id||""))}}),()=>{F=!1}},[a,w]);const N=(F,$)=>{o&&tr(a,F).then(R=>{if(!R||R.ok===!1){n(e.actErr);return}F.test&&R.sent===!1?n(e.plugTestThrottled):r($),k(D=>D+1)})},C='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',L=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),q=`curl -X POST ${vt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,I=`curl -X POST ${vt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`;return t.jsxs(Ge,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>k(F=>F+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:F=>m(F.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>N({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>N({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>N({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(_p,{destKind:h,setDestKind:v,camp:j,setCamp:y,whHint:i!=null&&i.configured?i.url_hint||"webhook":null}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugVarsT}),t.jsx("p",{className:"mnote",children:e.plugVars})]}),t.jsx(Pp,{auto:g,autoKo:x,destKind:h,camp:j,onRetry:()=>k(F=>F+1),onDone:F=>{p(F),u(!1)}}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:q}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(q).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:C}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(C).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:I}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var F;(F=navigator.clipboard)==null||F.writeText(I).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Ip(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:s}=K(),l=c.useMemo(()=>r.find(f=>f.id===n.approachId)||null,[r,n.approachId]),[g,p]=c.useState("email"),[x,u]=c.useState(0),[b,m]=c.useState({}),[w,k]=c.useState(!1),[h,v]=c.useState(""),[j,y]=c.useState({});if(c.useEffect(()=>{!l||b[g]||w||(k(!0),v(""),ds(a,l.name,g).then(f=>{if(k(!1),!f||f.ok===!1){v((f==null?void 0:f.error)||e.apprFail);return}m(A=>({...A,[g]:f}))}))},[l,g,a]),!l)return null;const E=b[g],N=(E==null?void 0:E.sequence)||[],C=N[x],L=f=>`${g}|${x}|${f}`,q=f=>{const A=L(f);return A in j?j[A]:String(((C==null?void 0:C[f])??"")||"")},I=(f,A)=>y(H=>({...H,[L(f)]:A})),F=L("subject")in j||L("body")in j||L("message")in j,$=q(g==="email"?"body":"message"),R=q("subject"),D=g==="email"&&R?`${R}

${$}`:$;return t.jsxs(Ge,{title:e.apprT(l.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(f=>t.jsx("button",{type:"button",className:"apch"+(g===f?" on":""),"aria-pressed":g===f,onClick:()=>{p(f),u(0)},children:f==="email"?e.apprChEmail:e.apprChLi},f)),t.jsx("span",{className:"sp"}),N.map((f,A)=>t.jsxs("button",{type:"button",className:"apday"+(x===A?" on":""),"aria-pressed":x===A,onClick:()=>u(A),children:[f.day||`J${A}`,[`${g}|${A}|subject`,`${g}|${A}|body`,`${g}|${A}|message`].some(H=>H in j)&&t.jsx("i",{children:"✎"})]},f.day||A))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,E!=null&&E.sender?" · "+e.apprSender(E.sender):""]}),w&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!h&&!w&&t.jsxs("p",{className:"mnote warn",children:[h," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{m(f=>{const A={...f};return delete A[g],A}),v("")},children:e.retry})]}),!w&&!h&&!C&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),C&&t.jsxs(t.Fragment,{children:[g==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:R,onChange:f=>I("subject",f.target.value)})]}),g==="linkedin"&&x===0&&(E==null?void 0:E.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:$,onChange:f=>I(g==="email"?"body":"message",f.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var f;(f=navigator.clipboard)==null||f.writeText(D).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),g==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(l.contactEmail||"")}?subject=${encodeURIComponent(R)}&body=${encodeURIComponent($)}`,children:e.apprMailto}),F&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Pp({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:s,flash:l,flashErr:g,canWrite:p}=K(),[x,u]=c.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),w=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,k=()=>{if(x||!p||m)return;u(!0),(b?nr(s,!1):nr(s,!0,r,n.trim()||void 0)).then(v=>{if(u(!1),!v){g(d.actErr);return}o(v),l(v.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!p||!!m,title:m||void 0,onClick:k,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),m===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:m}),w&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function _p({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:s,canWrite:l}=K(),[g,p]=c.useState("valides"),[x,u]=c.useState(!1),[b,m]=c.useState(null),[w,k]=c.useState(null),[h,v]=c.useState(!1),[j,y]=c.useState(!1),[E,N]=c.useState(null),[C,L]=c.useState(null),q=`atl2:bulk:${d}:${g}:${e}`;c.useEffect(()=>{m(null),k(null),v(!1),N(null);try{const O=localStorage.getItem(q)||localStorage.getItem(`atl2:bulk:${d}:${g}`),M=JSON.parse(O||"null");L(M&&Date.now()-Date.parse(M.t)<24*3600*1e3?M:null)}catch{L(null)}},[q,g,d]);const I=e==="instantly"&&!r.trim(),F=`${g}|${e}|${r.trim()}`,$=async()=>{if(I||!l)return;u(!0),v(!1),N(null);const O=await fs(d,g,e,r.trim()||void 0);m(O),k(O.ok?F:null),u(!1)},R=c.useRef(!1);if(!l)return null;const D=async()=>{if(R.current||!l)return;R.current=!0,y(!0);const O=`${d}:${g}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await hs(d,g,e,r.trim()||void 0,O)}finally{R.current=!1}if(y(!1),v(!1),N(M),M.ok&&(M.pushed||0)>0){const _={t:new Date().toISOString(),n:M.pushed||0};L(_);try{localStorage.setItem(q,JSON.stringify(_))}catch{}}};h&&w!==null&&w!==F&&v(!1);const f=o,A=b!=null&&b.ok&&b.ready||0,H=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":f||"",X=!!(b!=null&&b.ok)&&w===F&&A>0&&!!H&&!C,S=C?new Date(C.t).toLocaleString(s==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:g,onChange:O=>p(O.target.value),children:i.plugBulkTabs.map(([O,M])=>t.jsx("option",{value:O,children:M},O))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:O=>a(O.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:O=>n(O.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||I,onClick:()=>{$()},children:x?"…":i.plugBulkPreview})]}),I&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),C&&t.jsx("p",{className:"mnote",children:i.bulkLocked(S,C.n)}),!C&&!!(b!=null&&b.ok)&&!H&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!C&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),X&&!h&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>v(!0),children:i.bulkArm}),X&&h&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(A,H)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:j,onClick:()=>{D()},children:j?i.bulkSending:i.bulkConfirm(H)}),t.jsx("button",{type:"button",className:"abtn",disabled:j,onClick:()=>v(!1),children:i.bulkCancel})]}),E&&(E.ok?E.replayed?t.jsx("p",{className:"mnote",children:E.pending?i.bulkPending:i.bulkReplayed}):(E.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(E.pushed||0,E.linkedinReady||0,E.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:E.error||i.actErr}))]})}function Bp(){const{t:e,data:a,lang:r}=K(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const s=window.location.href.split("?")[0];try{const g=await(await fetch(`${Ia}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ge,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(d.credits,d.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function $p(){const{t:e}=K();return t.jsx(Ge,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(kp,{})})}function Up(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:s}=K(),[l,g]=c.useState(null),[p,x]=c.useState(!1);c.useEffect(()=>{let q=!0;if(i)return Sn(i).then(I=>{q&&I&&typeof I.per_day=="number"&&g(I.per_day)}),()=>{q=!1}},[i]);const[u,b]=c.useState(null);c.useEffect(()=>{if(!o)return;let q=!0;return ls(o).then(I=>{q&&b(I)}),()=>{q=!1}},[o]);const m=r.stats,w=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(q=>q.kind==="target"&&_e(q)).length,k=r.marketEstimate||0,h=k>0?Math.min(100,Math.round(w/k*100)):null,v=(m==null?void 0:m.window_days)||30,j=w>0?w/v:0,y=k>0?Math.max(0,k-w):0,N=k>0&&j>0&&w>=100?Math.round(y/j):null,C=q=>Math.round(q).toLocaleString(a==="en"?"en-US":"fr-FR"),L=q=>{p||!d||(x(!0),us(o,q).then(I=>{if(x(!1),I===null){s(e.actErr);return}g(I),s(e.alertSaved)}))};return t.jsxs(Ge,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(w))}),k>0&&t.jsx("span",{children:e.covOf(C(k))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),N!==null&&t.jsx("p",{className:"mnote",children:e.covEta(N)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(j))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((q,I)=>t.jsxs("tr",{className:q.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[q.code,q.geo?` · ${q.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof q.n=="number"?C(q.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:q.source}),q.elargi&&t.jsx("em",{children:e.covWide(String(q.demande||""))}),q.erreur&&t.jsx("em",{children:e.covMissing})]})]},I)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(u.total||k)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&l!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(l)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(q=>t.jsx("button",{type:"button",className:l===q?"on":"",disabled:p,onClick:()=>L(q),children:q===0?"⏸":q},q))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function ti(e,a,r){const n=await fetch(`${vt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${vt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Hp(){const{t:e,token:a,canWrite:r}=K(),[n,o]=c.useState(null),[i,d]=c.useState(""),[s,l]=c.useState(""),[g,p]=c.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=c.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const m=JSON.parse(localStorage.getItem(x)||"null");return!!m&&Date.now()-(m.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(c.useEffect(()=>{if(!r)return;let m=!0;return cs(a).then(w=>{m&&o(w)}),()=>{m=!1}},[a,r]),!r||g||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),ti(a,n.instruction||"","atelier2-avis").then(m=>{if(d(m.applied?"ok":"ko"),m.applied||l(m.encours?e.propSlow:m.reply),m.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:s||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{p(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Vp(){var E;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=K(),[i,d]=c.useState(!1),[s,l]=c.useState(null),[g,p]=c.useState(!1),[x,u]=c.useState([]),[b,m]=c.useState(null),[w,k]=c.useState([]);if(!r)return null;const h=()=>{d(!0),p(!1),u([]),k([]),ms(a).then(N=>{if(d(!1),!N){p(!0),l(null);return}l(N)})},v=N=>{b||(m(N.title),ti(a,N.instruction,"atelier2-prop").then(C=>{m(null),C.applied?(k(L=>[...L,N.title]),n(e.propApplied)):C.encours?n(e.propSlow):o(C.reply||e.propApplyFail)}))},j=((s==null?void 0:s.proposals)||[]).filter(N=>!x.includes(N.title)&&!w.includes(N.title)),y=((E=s==null?void 0:s.counts)==null?void 0:E.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:h,children:i?e.propWait:e.propBtn}),!i&&g&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!g&&s&&!(s.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:s.reason==="not_enough_signals"?e.propFew(y):e.propNone}),j.map(N=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[N.section]||N.section}),t.jsx("p",{className:"propt",children:N.title}),N.why&&t.jsx("p",{className:"mnote dim",children:N.why}),N.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",N.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>v(N),children:b===N.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(C=>[...C,N.title]),children:e.propSkip})]})]},N.title))]})}function Wp(){var h,v,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:s}=K(),l=n==="client",g=c.useMemo(()=>{const y=new Set;return a.forEach(E=>{E.angle&&y.add(E.angle)}),[...y]},[a]),[p,x]=c.useState(""),[u,b]=c.useState(""),[m,w]=c.useState(!1),k=async()=>{const y=p.trim();if(!(!y||m||!l)){w(!0),b("");try{const N=await(await fetch(`${vt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(N.reply&&b(String(N.reply)),N.job_id){b(e.critChatRunning);const C=async()=>{const L=await fetch(`${vt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:N.job_id})}).then(q=>q.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),w(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||w(!1)}}};return t.jsxs(Ge,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((h=i.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((v=i==null?void 0:i.angles)!=null&&v.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(y=>{var E,N;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((E=y.look)!=null&&E.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((N=y.out)!=null&&N.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},y.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsx(Hp,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:p,disabled:!l||m,onChange:y=>x(y.target.value),onKeyDown:y=>{y.key==="Enter"&&k()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!l||m||!p.trim(),onClick:()=>void k(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(Vp,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ss,{fund:d,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Jo[y]||"v-cons"),children:y}),t.jsx("span",{children:E})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",E]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Gp(){const{t:e,dispatch:a,startTour:r}=K(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Ge,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const ai="atl2:mapfold",Yp=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(ai);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Qp=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},ni=c.createContext(null),K=()=>{const e=c.useContext(ni);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function jt({o:e,lg:a}){const{lang:r}=K(),n=Pe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:ir(n,r),children:[n.emoji," ",ir(n,r)]}):null}function Pa({o:e,src:a}){const{lang:r,t:n}=K(),o=Pe(e);if(!o)return null;const i=Ns(o),d=Ss(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(ho(o,r))+" · "+n.win7(go(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,l)=>t.jsx("i",{className:l<i?"on":""},l))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Kp(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Ue(a);if(o)return e.find(i=>Ue(i.name)===o)||e.find(i=>{const d=Ue(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Jp(){const{scoped:e,t:a,st:r,dispatch:n}=K(),o=c.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(x=>!Qe(x)),s=d.length,l=d.filter(x=>!x.noCo).length,g=d.filter(x=>!!x.noCo).length,p=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:p?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:s}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",l," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function Xp(){const{t:e,lang:a,data:r,dispatch:n}=K(),o=r.stats,i=s=>s.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const d=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:d>0?e.covOf(i(d)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function ri({o:e}){const{lang:a}=K(),r=Es(e.cc),n=e.cc?Ht(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Zp=!1;function ec(){const[e,a]=c.useState(!1);return c.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const oi=e=>`atl2:tour:${e||"anon"}`;function tc(e){try{return localStorage.getItem(oi(e))==="1"}catch{return!0}}function ao(e){try{localStorage.setItem(oi(e),"1")}catch{}}function ac(e,a,r,n,o,i,d,s){const l=e.tourT,g=e.howto;return[{sel:".atl2 .ident",title:l.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:l.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:l.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:l.live,body:e.fhintLive},{sel:".atl2 .goal",title:l.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:l.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:l.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:l.tuto,body:g[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:l.demand,body:g[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:l.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:l.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:l.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:l.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:l.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:l.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:l.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:l.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,...[2,4,5].filter(p=>(s[p]||0)>0).map(p=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:p===2?l.tabAna:p===4?l.tabValid:l.tabRej,body:p===2?e.fhintTabAna:p===4?e.fhintTabValid:e.fhintTabRej,ptab:p})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:l.rank,body:e.fhintRank},{sel:".atl2 .learn",title:l.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:l.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:l.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:l.tools,body:g[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:l.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:l.crit,body:g[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:l.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:l.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:l.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function sc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var _n;const{lang:d}=ys(),s=Gs[d],l=il(e,d,a),[g,p]=c.useReducer(dl,void 0,()=>sl((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Qp():Yp()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=c.useRef(!0);c.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(ai,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),c.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const z=()=>{window.innerWidth<=760&&p({type:"mapFold",folded:!0})};return z(),window.addEventListener("resize",z),()=>window.removeEventListener("resize",z)},[a]);const u=c.useRef(i);u.current=i,c.useEffect(()=>{var z;(z=u.current)==null||z.call(u,g.filters)},[g.filters]);const[b,m]=c.useState(()=>{if(typeof window>"u")return"both";try{const z=localStorage.getItem("atl2:chrome-mode");if(z==="eval"||z==="filt"||z==="both")return z;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[w,k]=c.useState(null),[h,v]=c.useState(null),[j,y]=c.useState(null),[E,N]=c.useState({kept:0,dropped:0}),[C,L]=c.useState(!1),[q,I]=c.useState(""),[F,$]=c.useState(!1),[R,D]=c.useState(null),[f,A]=c.useState(null),[H,X]=c.useState(!1),[S,O]=c.useState(!1),[,M]=c.useState(0),_=()=>M(z=>z+1),ee=c.useRef([]),Z=c.useRef(new Set),be=c.useRef(new Set),[te,pe]=c.useState([]),[me,ge]=c.useState([]),[B,Q]=c.useState(0),G=c.useRef(new Map),ae=c.useRef(null),{mode:U}=l,se=c.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),le=se.pipe,ne=l.session.token||"",ue=U==="client"&&!e;c.useEffect(()=>{if(!ne||!le)return;let z=!0;const Y=async()=>{const he=await Cs(ne);!z||!he||(ge(he.runs),Q(Date.now()/1e3-he.now),pe(Te=>Te.filter(we=>!he.runs.some($e=>Ue($e.company)===Ue(we.name)))))};Y();const W=te.length>0||me.some(he=>he.status==="running"),re=window.setInterval(()=>{Y()},W?8e3:25e3);return()=>{z=!1,window.clearInterval(re)}},[ne,le,te.length,me.some(z=>z.status==="running")]),c.useEffect(()=>{if(!ne||!le||!ue)return;let z=!0;const Y=async()=>{const re=await zs(ne);if(!z||!re.length)return;const he=new Map;re.forEach(Te=>{const we=String(Te.ceo_status||"").trim();we&&Te.check_id&&he.set(String(Te.check_id),we)}),l.patchStatuses(he,Te=>Date.now()-(Ee.current.get(Te)||0)>9e4)};Y();const W=window.setInterval(()=>{Y()},6e4);return()=>{z=!1,window.clearInterval(W)}},[ne,le,ue]);const de=c.useMemo(()=>{const z=[],Y=new Set;for(const W of te){const re=Ue(W.name);!re||Y.has(re)||(Y.add(re),z.push({name:W.name,id:W.id,status:"boot",started:W.started,estMin:W.estMin,memoType:"instant"}))}for(const W of me){const re=Ue(W.company);if(!re||Y.has(re))continue;Y.add(re);const he=W.status==="error"?"error":W.status==="done"?"done":"running";z.push({name:W.company,status:he,started:W.started||0,estMin:W.est_min||(W.memo_type==="detailed"?40:15),url:W.url,error:W.error,memoType:W.memo_type,note:W.note})}return z},[te,me]),xe=z=>de.find(Y=>Ue(Y.name)===Ue(z))||null,Re=(z,Y)=>{pe(W=>W.some(re=>Ue(re.name)===Ue(z.name))?W:[...W,{name:z.name,id:z.id,started:Date.now()/1e3,estMin:Y==="detailed"?40:15}]),Z.current.add(z.id),_()},ye=(z,Y=!1)=>{I(z),$(Y),ae.current&&clearTimeout(ae.current),ae.current=setTimeout(()=>I(""),Y?4200:2400)},Ce=z=>ye(z,!0),ze=c.useMemo(()=>{const z=new Map;return l.dossiers.forEach(Y=>{Y.id&&z.set(Y.id,Y)}),z},[l.dossiers]),Me=c.useMemo(()=>l.dossiers.filter(z=>ta(z,g,le)),[l.dossiers,g,le]),ft=c.useRef(!1);c.useEffect(()=>{if(ft.current||l.loading||!l.dossiers.length)return;if(e&&!l.session.token){ft.current=!0;return}if(!se.showFunnel||tc(l.session.token||"")){ft.current=!0;return}ft.current=!0;const z=window.setTimeout(()=>{ao(l.session.token||""),X(!0)},700);return()=>window.clearTimeout(z)},[e,l.loading,l.dossiers.length,se.showFunnel,l.session.token]);const ot=c.useMemo(()=>l.dossiers.filter(z=>pl(z,g,le,l.favIds)),[l.dossiers,g,le,l.favIds]),Be=c.useMemo(()=>ws(Me.filter(z=>!Ye(z)),l.favIds),[Me,l.favIds]),ke=c.useRef(!1);c.useEffect(()=>{if(ke.current)return;if(!le||a==="ops"){ke.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){ke.current=!0;return}if(l.loading)return;ke.current=!0;const z=ks(Be);z!==g.ptab&&p({type:"ptab",tab:z})},[le,a,n==null?void 0:n.ptab,l.loading,Be,g.ptab]);const st=c.useMemo(()=>{const z=Eo(l.dossiers);return z?yt(z)===0?s.tourToday:No(z,d):s.tourNoRun},[l.dossiers,s,d]),Nt=c.useMemo(()=>l.dossiers.some(z=>!!z.memoUrl||!!z.summary||Pt(z)),[l.dossiers]),[He,lt]=c.useState(!1);c.useEffect(()=>{if(l.loading){lt(!1);return}if(l.dossiers.length>0||l.error){lt(!0);return}const z=window.setTimeout(()=>lt(!0),6e3);return()=>window.clearTimeout(z)},[l.loading,l.dossiers.length,l.error]);const ht=(l.marketEstimate||0)>0||typeof((_n=l.stats)==null?void 0:_n.screened)=="number"&&l.stats.screened>0,St=c.useMemo(()=>[1,0,2,4,5,3].find(z=>(Be[z]||0)>0)??0,[Be]),Ze=Cn.find(z=>z.key===g.continent),Ct=g.continent==="monde"?s.contWorld:(d==="fr"?Ze==null?void 0:Ze.fr:Ze==null?void 0:Ze.en)||"";c.useEffect(()=>{const z=Y=>{var re;const W=(((re=Y.detail)==null?void 0:re.name)||"").trim();W&&gt(null,W)};return window.addEventListener("ppmap:evaluate",z),()=>window.removeEventListener("ppmap:evaluate",z)}),c.useEffect(()=>{const z=Y=>{const W=Y.detail||{},re=String(W.id||"").trim(),he=String(W.name||"").trim(),Te=String(W.url||"").trim(),we=re&&ze.get(re)||Kp(l.dossiers,he,Te);if(we){if(v(null),ta(we,g,le)||(g.continent!=="monde"&&we.continent!==g.continent&&p({type:"continent",key:we.continent||"monde"}),p({type:"reset"})),le&&we.kind!=="op"){const dt=Se(we);typeof dt=="number"&&dt!==g.ptab&&p({type:"ptab",tab:dt})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),p({type:"focus",id:we.id}),(we.noCo||["media","nominations","recrutements"].includes(we.engine||""))&&(we.url||we.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:we.url||"",text:[we.headline,we.tagline].filter(Boolean).join(`
`)}})):we.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:we.name,url:we.url||"",website:we.website||"",domain:we.domain||""}}));return}!he&&!Te||(p({type:"focus",id:re||null}),v({name:he,headline:String(W.text||"").trim()||he,url:Te,card:W.card}),Te&&(Sa(he)||!he)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Te,text:String(W.text||"").trim()}})):he&&!Sa(he)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:he}})))};return window.addEventListener("ppmap:focus",z),()=>window.removeEventListener("ppmap:focus",z)}),c.useEffect(()=>{const z=re=>{const he={},Te=String((re==null?void 0:re.sector)||"").trim();Te&&(he.sector=[Te]);const we=String((re==null?void 0:re.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(we)&&(he.day=we);const $e=String((re==null?void 0:re.search)||"").trim();$e&&(he.search=$e);const dt=String((re==null?void 0:re.dealKind)||"").trim();(dt==="ma"||dt==="levee"||dt==="other")&&(he.dealKind=[dt]),Object.keys(he).length&&p({type:"filters",patch:he})},Y=re=>z(re.detail),W=re=>{re.data&&re.data.type==="pp-filter"&&z(re.data)};return window.addEventListener("ppmap:filter",Y),window.addEventListener("message",W),()=>{window.removeEventListener("ppmap:filter",Y),window.removeEventListener("message",W)}},[]),c.useEffect(()=>{const z=Y=>{var he;const W=(((he=Y.detail)==null?void 0:he.name)||"").trim().toLowerCase();if(!W)return;const re=l.dossiers.find(Te=>(Te.name||"").trim().toLowerCase()===W);re&&p(a==="ops"?{type:"focus",id:re.id}:{type:"popup",id:re.id})};return window.addEventListener("ppmap:similar",z),()=>window.removeEventListener("ppmap:similar",z)});const gt=(z,Y,W)=>{const re=(W||(z==null?void 0:z.name)||Y||"").trim();if(!ue){y({kicker:re});return}!re||C||(L(!0),(async()=>{try{let he=(Y||re).trim();const Te=((z==null?void 0:z.website)||(z==null?void 0:z.domain)||"").trim();if(!(/^https?:\/\//i.test(he)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(he)&&!/\s/.test(he)))if(Te)he=Te;else try{const Oe=await zn(re);if(Oe!=null&&Oe.website)he=Oe.website;else if(((Oe==null?void 0:Oe.candidates)||[]).length===1)he=Oe.candidates[0].url;else if(((Oe==null?void 0:Oe.candidates)||[]).length>1){ee.current=[{name:re,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(Oe.candidates||[]).slice(0,5)},...ee.current].slice(0,8),_();return}}catch{}const $e=await co(ne,he,"atelier2"),dt={name:$e.company||re,verdict:$e.verdict,reason:$e.reason||"",remaining:$e.remaining??null};ee.current=[dt,...ee.current].slice(0,8),$e.verdict==="kept"&&N(Oe=>({...Oe,kept:Oe.kept+1})),$e.verdict==="ruled_out"&&N(Oe=>({...Oe,dropped:Oe.dropped+1}));const Wt=z||l.dossiers.find(Oe=>(Oe.name||"").toLowerCase()===re.toLowerCase());Wt&&($e.verdict==="kept"?Wt.verdict=Wt.verdict||"MATCH":$e.verdict==="ruled_out"&&(Wt.verdict="NO MATCH"),$e.reason&&(Wt.reasoning=$e.reason)),_()}finally{L(!1)}})())},Ot=z=>{if(!ue){y({kicker:z.name});return}Re(z,"instant"),wt(ne,"fast_request",z.name||"",""),ye(s.memoInstantSent(z.name))},Mt=z=>G.current.get(z.id)??l.thumbs.get((z.name||"").trim().toLowerCase()),Ie=(z,Y)=>p({type:"undoPush",entry:{id:z.id,name:z.name,prevCeoStatus:Y}}),Ke=async(z,Y,W)=>{const re=z.ceoStatus||"";Ee.current.set(z.id,Date.now()),z.ceoStatus=Y,_();const he=await Ha(ne,{status:Y,airtable_id:z.airtableId,check_id:z.checkId,company:z.name,...(W==null?void 0:W.note)!==void 0?{note:W.note}:{},...W!=null&&W.via?{via:W.via}:{}});return he.ok?he.skipped?(z.ceoStatus=re,_(),Ce(s.actNotPersisted),!1):((W==null?void 0:W.undo)!==!1&&Ie(z,re),W!=null&&W.msg&&ye(W.msg),(Y==="Validé"||Y==="Écarté")&&!z.ceoNote&&(W==null?void 0:W.note)===void 0&&D({o:z,yes:Y==="Validé"}),!0):(z.ceoStatus=re,_(),Ce(s.actErr),!1)},T=async(z,Y)=>{const W=await Ha(ne,{status:z.ceoStatus||"Retenu",airtable_id:z.airtableId,check_id:z.checkId,company:z.name,note:Y,via:"note"});return!W.ok||W.skipped?(Ce(W.skipped?s.actNotPersisted:s.actErr),!1):(z.ceoNote=Y,_(),!0)},V=c.useRef(new Map),J=z=>V.current.has(z.id)?V.current.get(z.id):l.stages.get((z.name||"").trim().toLowerCase()),ce=(z,Y)=>{V.current.set(z.id,Y),_()},je=(z,Y)=>{ue&&Ke(z,Y?"Validé":"Écarté",{msg:Y?s.decidedYes(z.name):s.decidedNo(z.name)})},P=z=>{ue&&Ke(z,"À trancher",{msg:s.promoted(z.name)})},ie=z=>{ue&&(async()=>{const Y=z.ceoStatus||"";z.ceoStatus="Retenu",_();const W=await Ha(ne,{status:"Retenu",check_id:z.checkId,company:z.name});if(!W.ok||W.skipped){z.ceoStatus=Y,_(),Ce(W.skipped?s.actNotPersisted:s.actErr);return}Ie(z,Y),ye(s.repeched(z.name))})()},fe=()=>{const z=g.undo[g.undo.length-1];if(!z){ye(s.undoNone);return}const Y=ze.get(z.id);if(!Y){p({type:"undoPop"}),ye(s.undoNone);return}let W=z.prevCeoStatus;if(!W)if((Y.verdict||"").toUpperCase().includes("CALL"))W="À trancher";else{ye(s.undoLockedTitle);return}(async()=>await Ke(Y,W,{undo:!1})&&(p({type:"undoPop"}),Y.ceoStatus=z.prevCeoStatus,_(),ye(s.undoDone(Y.name))))()},oe=z=>{ue&&(be.current.add(z.id),_(),p({type:"approachOpen",id:z.id}),wt(ne,"approach",z.name||"",""))},Ee=c.useRef(new Map),De=c.useRef(!1),[Ve,qe]=c.useState(0);c.useEffect(()=>{if(!ne||e||!ue||De.current)return;De.current=!0;const z=new Date().toISOString().slice(0,10),Y=`atl2:vue:${ne}:${z}`;try{if(localStorage.getItem(Y))return}catch{}wt(ne,"view","","").then(W=>{if(!W.ok){De.current=!1;return}try{localStorage.setItem(Y,"1")}catch{}})},[ne,e]),c.useEffect(()=>{if(!ne||!le||e||!ue||!l.generatedAt)return;let z=!0;const Y=()=>{document.hidden||As(ne,l.generatedAt||"").then(re=>{z&&qe(re)})};Y();const W=window.setInterval(Y,6e4);return()=>{z=!1,window.clearInterval(W)}},[ne,le,e,l.generatedAt]);const We=(z,Y)=>{ue&&(async()=>{if(!(await wt(ne,Y?"yes":"no",z.name||"",(z.ceoNote||"").slice(0,400),z.sector||"")).ok){Ce(s.actErr);return}G.current.set(z.id,Y?"yes":"no"),_(),ye(Y?s.thumbUpDone:s.thumbDnDone),A({o:z,up:Y})})()},_a=z=>{!ue||!Pt(z)||(Re(z,"detailed"),wt(ne,"detailed_request",z.name||"",""),ye(s.memoDeepSent(z.name)))},da=z=>{!ue||!z.memoUrl||window.confirm(s.memoRegenAsk(z.name))&&(Re(z,"detailed"),wt(ne,"detailed_regen",z.name||"",""),ye(s.memoDeepSent(z.name)))},ii=z=>{const Y=new Set(l.favIds),W=Y.has(z.id);W?Y.delete(z.id):Y.add(z.id),l.setFavIds(Y),ue&&qs(ne,{id:z.id,co:z.name},W)},si=()=>{!ue||S||window.confirm(s.identSyncConfirm)&&(O(!0),(async()=>{const z=await Ts(ne);O(!1),z?ye(s.identSyncDone):Ce(s.actErr)})())},Pn=/proplace/i.test(l.fund||""),li=z=>{!ue||!Pn||(wt(ne,"onboard_request",z.name||"",""),ye(s.onboardSent(z.name)))},di={st:g,dispatch:p,t:s,lang:d,mode:U,caps:se,pipe:le,token:ne,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:ie,thumbOf:Mt,canWrite:ue,commitStatus:Ke,saveNote:T,stageOf:J,setStage:ce,flashErr:Ce,startTour:()=>X(!0),dossiers:l.dossiers,scopedAll:Me,scoped:ot,counts:Be,byId:ze,contName:Ct,favIds:l.favIds,toggleFav:ii,askEvaluate:gt,doAnalyse:Ot,doDecide:je,doPromote:P,doApproach:oe,doThumb:We,doDeep:_a,doRegen:da,doUndo:fe,doSync:si,doOnboard:li,outbound:Pn,memoQueued:Z.current,liveMemos:{items:de,serverOff:B,liveOf:xe},approachDone:be.current,sessTally:E,evalCards:ee.current,evalBusy:C,markRow:k,markedId:w,flash:ye,focusExtra:h};c.useEffect(()=>{const z=Y=>{Y.key==="Escape"&&(p({type:"popup",id:null}),p({type:"modal",modal:null}),p({type:"openFacet",facet:null}))};return window.addEventListener("keydown",z),()=>window.removeEventListener("keydown",z)},[]);const pi=z=>ne?t.jsx(ml,{token:ne,children:z}):t.jsx(t.Fragment,{children:z});return t.jsx(ni.Provider,{value:di,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ne?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Xs}),pi(t.jsxs("div",{className:"app"+(le?" pipe":"")+(ne?" has-thesis":""),children:[se.showTicker&&t.jsx(it,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ne?" live-stack--cibles":""),children:[t.jsx(yl,{}),!!ne&&t.jsx(fl,{})]})}),se.showIdent&&t.jsx(it,{name:"identite",children:t.jsx(Tl,{})}),!1,Zp,se.showFunnel&&t.jsx(it,{name:"entonnoir",children:t.jsx(nc,{})}),!g.mapFolded&&t.jsx(it,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Vo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Jp,{}),a!=="ops"&&se.showFunnel&&t.jsx(Xp,{}),t.jsx(Ad,{}),t.jsx(Ho,{})]})]})}),se.showDemand&&le&&t.jsx(it,{name:"direct",children:t.jsx(Ms,{items:de,serverOff:B,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>p({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([z,Y])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===z,onClick:()=>{m(z);try{localStorage.setItem("atl2:chrome-mode",z)}catch{}},children:Y},z))}),se.showDemand&&t.jsx(it,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Dd,{})})}),se.showDemand&&g.memoConsole&&t.jsx(it,{name:"console",children:t.jsx(Pd,{})}),se.pipe&&!!ne&&t.jsx(it,{name:"moteurs",children:t.jsx(Hs,{})}),Ve>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:s.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{qe(0),l.refresh()},children:s.freshGo})]}),t.jsx(it,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(gp,{})}),se.pipe&&!!ne&&t.jsx("p",{className:"privnote",children:s.privLink}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(it,{name:"fiche",children:t.jsx(Zd,{})}),t.jsx(it,{name:"modales",children:t.jsx(Ep,{})}),t.jsx(jl,{}),f&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:f.o.name}),t.jsx(br,{placeholder:f.up?s.thumbWhyUpPh:s.thumbWhyDnPh,onDone:z=>{const Y=f.o;A(null),z&&wt(ne,"note",Y.name||"",z,Y.sector||"").then(W=>{W.ok&&ye(s.csNoteSaved)})}})]}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(br,{placeholder:R.yes?s.whyYesPh:s.whyNoPh,onDone:z=>{const Y=R.o;D(null),z&&T(Y,z).then(W=>{W&&ye(s.csNoteSaved)})}})]}),H&&He&&t.jsx(Al,{steps:ac(s,st,Nt,St,ht,Be[3]||0,Be[4]||0,Be),onClose:()=>{X(!1),ao(ne)}}),t.jsx(ec,{}),se.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:ko,children:Tn}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Aa}`,children:Aa})]}),t.jsx("button",{type:"button",onClick:()=>p({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),q&&t.jsx("div",{className:"flash on"+(F?" err":""),children:q}),j&&t.jsx(js,{variant:"acquirer",initialCompany:no().co,initialWebsite:no().site,onClose:()=>y(null)})]})})}function nc(){const{t:e}=K(),[a,r]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function no(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function rc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{ri as FlagCell,jt as SigBadge,Pa as SigWin,sc as default,rc as fmtShort,K as useV2};
