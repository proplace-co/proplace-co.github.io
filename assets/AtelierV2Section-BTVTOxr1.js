...
.atl2 .card.ops-open{display:grid!important;grid-template-columns:minmax(0,62ch) 340px;
  justify-content:start;gap:36px;align-items:start;padding:22px 28px 26px;background:#FBFCFE;
  border-bottom:1px solid var(--line)}
@media (max-width:1000px){.atl2 .card.ops-open{grid-template-columns:1fr;gap:18px;padding:18px 16px 20px}}
.atl2 .ops-open .oc-main{min-width:0;max-width:62ch}
...
`,Ti=Ai+zi;function ja(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function qi(){const e=ja("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Li(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=qi();return r==="0"?"client":r==="1"||ja("embed")==="1"&&ja("chrome")==="1"?"apercu":"client"}const Ri={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Mi=e=>Ri[e];function ir(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Xe=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!ga(a)||ir(a))&&(e.noCo=!0)}return Object.assign(e,{continent:wo(e.cc)})};function ca(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Oi=60*60*1e3;function Fi(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Oi?null:a}catch{return null}}function Mt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Di=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Pi(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:po(),[e,n]),o=m.useMemo(()=>n?"visiteur":Li(e,i),[e,i,n]),l=m.useMemo(()=>Mi(o),[o]),s=o!=="visiteur",d=Di(r),[x,c]=m.useState([]),[f,u]=m.useState(""),[b,p]=m.useState(null),[g,v]=m.useState(null),[h,S]=m.useState(null),[j,y]=m.useState(()=>new Map),[T,R]=m.useState(()=>new Map),[L,N]=m.useState(""),[E,k]=m.useState(new Set),[M,z]=m.useState(null),[O,C]=m.useState(!0),[A,F]=m.useState(!1),[U,G]=m.useState(0),[W,V]=m.useState(0),K=m.useRef(0),Q=m.useMemo(()=>{var ee;if(o!=="client")return"";try{return((ee=uo())==null?void 0:ee.email)||""}catch{return""}},[o]);m.useEffect(()=>{const ee=++K.current;let fe=!0;const ge=()=>fe&&ee===K.current,xe=(s&&i.token?i.token:"pub:"+a)+(d?":"+d:""),Z=Fi(xe);return Z?(c(Z.objs.map(Xe)),Z.fund&&u(Z.fund),p(Z.marketEstimate??null),v(Z.criteria??null),S(Z.stats??null),N(Z.generatedAt||""),C(!1)):C(!0),(async()=>{try{if(r==="ops"){const ie=await sa(),ae=((ie==null?void 0:ie.recent_ops)||[]).map(H=>{const J=Ut(H.company_name||H.title?H:{...H,title:(H.headline_fr||H.headline||"").slice(0,120)},a),ue=String(H.rubrique||"").toLowerCase();return J&&(ue==="nominations"||ue==="recrutements")&&(J.engine=ue),J&&!String(H.company_name||"").trim()&&(J.noCo=!0),J}).filter(H=>!!H).map(H=>(ga((H.name||"").trim())||(H.noCo=!0),H));try{const H=mo(),J=H&&H.doc||await fo(),ue=xo(J),q=((H==null?void 0:H.day)||(J==null?void 0:J.date)||"").slice(0,10);if(ue.length&&q){const $=new Set;for(const D of ae){if(D.noCo||(D.date||"").slice(0,10)!==q)continue;const Y=an(ue,$,D.name,"");Y>=0&&($.add(Y),D.decryptHtml=ue[Y].html)}for(const D of ae){if(D.decryptHtml||(D.date||"").slice(0,10)!==q)continue;const Y=an(ue,$,"",D.headline||D.tagline||D.name);Y>=0&&($.add(Y),D.decryptHtml=ue[Y].html)}ue.forEach((D,Y)=>{if($.has(Y))return;const ne=(D.t||"").trim(),X=ne.split(/[:–—]/)[0].trim().slice(0,80)||ne.slice(0,40);if(!X)return;const se=ne+" "+D.html,Ee=/\b(acquiert|rachat|rachet|fusion|buyout|offre sur)\b/i.test(se),ce=/\b(l[eè]ve|lev[ée]e|raises?|funding|s[eé]rie [a-z]|series [a-z])\b/i.test(se);ae.push({id:`edito:${q}:${Y}`,kind:"op",name:X,cc:null,date:q,engine:Ee?"ma":ce?"fundraising":"media",dealKind:Ee?"ma":ce?"levee":"other",headline:ne,decryptHtml:D.html,noCo:!ga(X)||ir(X)})})}}catch{}if(!ge())return;c(ae.map(Xe)),Mt(xe,{objs:ae})}else if(typeof r=="object"){const ae=(await nn()||[]).filter(J=>(J.slug||"")===r.research).map(J=>rn(J,a)).filter(J=>!!J),H=ca(await on(ae,a));if(!ge())return;c(H.map(Xe)),Mt(xe,{objs:H})}else if(s&&i.token){const ie=ho(i.token),ae=sa(),H=go(i.token),J=bo(i.token),ue=vo(i.token),q=await ie;let $=q?q.targets:[];ge()&&q&&(u(q.fund||""),p(q.marketEstimate??null),v(q.criteria??null),S(q.stats??null),N(q.generatedAt||""),c($.map(Xe)),C(!1),F(!1));const[D,Y,ne,X]=await Promise.all([ae,H,J,ue]),se=((D==null?void 0:D.recent_ops)||[]).map(ce=>Ut(ce,a)).filter(ce=>!!ce);if($=[...$,...se],!ge())return;c($.map(Xe));const Ee=new Set;for(const ce of Y){const Le=(ce.id||ce.co||"").toString().trim().toLowerCase();Le&&Ee.add(Le.startsWith("t:")?Le:"t:"+Le)}k(Ee),y(ne),R(X),q&&Mt(xe,{fund:q.fund,marketEstimate:q.marketEstimate,criteria:q.criteria,stats:q.stats,generatedAt:q.generatedAt,objs:$})}else{const ie=yo(),ae=nn(),H=sa(),J=await ie;ge()&&J.length&&(c(ca(J).map(Xe)),C(!1),F(!1));const[ue,q]=await Promise.all([ae,H]),$=(ue||[]).map(X=>rn(X,a)).filter(X=>!!X),D=await on($,a),Y=((q==null?void 0:q.recent_ops)||[]).map(X=>Ut(X,a)).filter(X=>!!X),ne=ca([...J,...D,...Y]);if(!ge())return;c(ne.map(Xe)),Mt(xe,{objs:ne})}ge()&&F(!1)}catch{ge()&&!Z&&F(!0)}finally{ge()&&C(!1)}})(),()=>{fe=!1}},[s,i.token,a,U,d]),m.useEffect(()=>{if(!l.showCredits||!Q){z(null);return}let ee=!0;return(async()=>{try{const fe=await fetch(`${Ia}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Q})});if(!fe.ok)return;const ge=await fe.json();ee&&ge&&ge.ok!==!1&&z(ge)}catch{}})(),()=>{ee=!1}},[l.showCredits,Q,W]);const te=m.useCallback(ee=>k(new Set(ee)),[]);return{session:i,mode:o,caps:l,fund:f,email:Q,marketEstimate:b,generatedAt:L,criteria:g,stats:h,thumbs:j,stages:T,dossiers:x,favIds:E,setFavIds:te,credits:M,reloadCredits:()=>V(ee=>ee+1),loading:O,error:A,refresh:()=>G(ee=>ee+1)}}const sr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ii=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...sr(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),$i=new Set(["signal","amount","score","crible","memo"]);function Bi(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:sr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:$i.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??lr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const lr=40;function Va(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!je(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes($a(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(Ke(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&et(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function cr(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Va(e,a.filters,r)}function _i(e,a,r,n){return!(!cr(e,a,r)||r&&!ko(e,a.ptab,n))}function Ha(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-Ke(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return No(i);case"memo":return jo(i);case"signal":{const o=je(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const da={},hn=(da==null?void 0:da.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function gn(){return new Date().toISOString().slice(0,10)}const Wa=m.createContext(null);function dr(){return m.useContext(Wa)}function Ui(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),s.querySelectorAll("*").forEach(d=>{const x=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(c=>d.removeAttribute(c.name)),x&&/^https?:\/\//i.test(x)&&(d.setAttribute("href",x),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function bn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function pr(){const e=m.useContext(Wa);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Vi({token:e,children:a}){const{dispatch:r,st:n,lang:i}=B(),[o,l]=m.useState(()=>n.filters.day||gn()),[s,d]=m.useState(null),[x,c]=m.useState(!1),f=m.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){l(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l(gn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);m.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),m.useEffect(()=>{const g=v=>{var S;const h=(S=v.detail)==null?void 0:S.day;typeof h=="string"&&f(h)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[f]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let g=!1;c(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${hn}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{g||d(h)}).catch(()=>{g||d({ok:!1,error:"network"})}).finally(()=>{g||c(!1)}),()=>{g=!0}},[e,o]);const b=m.useMemo(()=>`${hn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:s,loading:x,pickDay:f,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,s,x,f,u,n.filters.day,b,i]);return t.jsx(Wa.Provider,{value:p,children:a})}function Hi(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=pr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(So,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function Wi(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=pr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,d=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:bn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:bn(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const Yi=["ma","levees","nominations","recrutements","actualites"],Gi=300,pa=7,Ki={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},ur={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Qi=["hiring","raised","news","posting","building","community","registry","exodus","other"];function vn(e){const a=je(e);if(a)return"sig:"+(a.theme&&ur.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Ji(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:s}=B(),d=dr(),x=l==="en",[c,f]=m.useState("all"),[u,b]=m.useState(!1),p=m.useMemo(()=>{var W;const z=(a.filters.day||"").slice(0,10),O=V=>!(!o&&a.continent!=="monde"&&V.continent!==a.continent||z&&(V.date||"").slice(0,10)!==z),C=e.filter(V=>O(V)&&je(V)&&(!o||V.kind!=="target"||ke(V)!==5)),A=o&&(((W=d==null?void 0:d.ed)==null?void 0:W.ops)||[]).length?d.ed.ops.map(V=>Ut(V,l)).filter(V=>!!V).filter(V=>!z||(V.date||"").slice(0,10)===z):[],F=e.filter(V=>O(V)&&V.kind==="op"&&!je(V)&&(z?!0:Ke(V.date)<=pa)),U=o?A.length?A:F.filter(V=>{const K=(s||"").trim().toLowerCase();if(!K)return!1;const Q=V.match||null;return Q?Object.keys(Q).map(te=>te.trim().toLowerCase()).includes(K):!1}):F,G=z||new Date().toISOString().slice(0,10);return U.sort((V,K)=>{const Q=(V.date||"").slice(0,10)===G?0:1,te=(K.date||"").slice(0,10)===G?0:1;return Q!==te?Q-te:(K.amountEur||0)-(V.amountEur||0)}),[...Ha(C,{key:"signal",dir:-1}),...U]},[e,a.continent,a.filters.day,o,s,l,d]),g=m.useMemo(()=>{const z={};for(const O of p){const C=vn(O);z[C]=(z[C]||0)+1}return z},[p]),v=m.useMemo(()=>c==="all"?p:p.filter(z=>vn(z)===c),[p,c]),h=m.useMemo(()=>v.slice(0,Gi),[v]),S=v.length-h.length,j=m.useRef(null);m.useEffect(()=>{var U,G;const z=j.current;if(!z)return;const O=()=>{const W=z.scrollWidth;W<200||(z.style.animationDuration=Math.max(18,Math.round(W/130))+"s")};O();const C=requestAnimationFrame(O),A=window.setTimeout(O,1200);let F=!0;return(G=(U=document.fonts)==null?void 0:U.ready)==null||G.then(()=>{F&&O()}),()=>{F=!1,cancelAnimationFrame(C),window.clearTimeout(A)}},[h.length,c]);const y=z=>z==="all"?p.length:g[z]||0,T=z=>z==="all"?x?"All":"Tout":z.startsWith("sig:")?ur[x?"en":"fr"][z.slice(4)]||"🔔":Ki[x?"en":"fr"][z],R=[{k:"all"}],L=Yi.filter(z=>y(z)>0||z===c);if(L.length){R.push({g:x?"DEALS":"OPÉRATIONS"});for(const z of L)R.push({k:z})}const N=Qi.map(z=>"sig:"+z).filter(z=>y(z)>0||z===c);if(N.length){R.push({g:x?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const z of N)R.push({k:z})}const E=z=>{try{return new Date(z+"T12:00:00Z").toLocaleDateString(x?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return z}},k=(()=>{const z=(a.filters.day||"").slice(0,10),O=!o&&a.continent!=="monde"&&i?x?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return z?(x?`LIVE covers the events of ${E(z)}.`:`Le LIVE regroupe les événements du ${E(z)}.`)+O:(x?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+O})(),M=z=>h.map(O=>t.jsxs("button",{type:"button",className:"tk"+(qe(O)?" spent":""),onClick:C=>{const A=C.currentTarget.getBoundingClientRect();n({type:"popup",id:O.id,anchor:{x:A.left+A.width/2,y:A.bottom}})},title:O.name+(O.tagline?" — "+O.tagline:""),children:[t.jsx(rt,{o:O}),t.jsxs("span",{className:"who",children:[t.jsx(Wr,{o:O}),t.jsx("span",{className:"co",children:O.name})]}),typeof O.amountEur=="number"&&O.amountEur>0&&t.jsx("span",{className:"am",children:kc(O.amountEur)}),O.sector&&t.jsx("span",{className:"mt",children:O.sector}),t.jsx(na,{o:O}),t.jsx("span",{className:"tkgo",children:"→"})]},z+(O.id||O.name))).concat(S>0?[t.jsx("span",{className:"tk quiet",children:x?`+ ${S} more — filter by section to see them`:`+ ${S} autres — filtrez par rubrique pour les voir`},z+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:z=>{z.currentTarget.contains(z.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(z=>!z),children:[T(c),t.jsx("b",{children:y(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:k}),R.map(z=>"g"in z?t.jsx("span",{className:"tkfilg",children:z.g},z.g):t.jsxs("button",{type:"button","aria-pressed":z.k===c,onClick:()=>{f(z.k),b(!1)},children:[T(z.k),t.jsx("b",{children:y(z.k)})]},z.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:j,children:[M(0),M(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!d&&t.jsx(Zi,{isEn:x})]})}const Xi=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Zi({isEn:e}){const[a,r]=m.useState(()=>Eo());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(sn,i),()=>window.removeEventListener(sn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Co(!a),children:Xi})}const es="aDx8z7Hzksus",Ya="+33 6 83 10 72 86",Wt="alexandre@proplace.co",mr=`tel:${Ya.replace(/[^\d+]/g,"")}`,yn="pp-rdv-slot";function ts(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function as(){const{t:e,caps:a,fund:r}=B();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:rs}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:mr,children:Ya}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Wt}`,children:Wt})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(yi,{filloutId:es,parameters:r?{company_name:r}:void 0})})]})}function ns(){const[e,a]=m.useState(()=>typeof document>"u"?null:document.getElementById(yn));return m.useEffect(()=>{e||a(document.getElementById(yn))},[e]),e?mt.createPortal(t.jsx(as,{}),e):null}const rs=`
...
`;class Ce extends m.Component{constructor(){super(...arguments);en(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ua=600,Ze=62,wn="atl2:fstats";function os(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=B(),[l,s]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(wn)==="on"}catch{return!1}}),d=r.stats,x=m.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),c=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const f=T=>a==="en"?T.slice(5,10):`${T.slice(8,10)}/${T.slice(5,7)}`,u=T=>T.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((T,R)=>Math.max(T,R.s||0),0),p=x.length?ua/x.length:0,g=Math.max(4,p-4),v=x.length>=5&&b>0,h=r.marketEstimate||0,S=f(new Date().toISOString().slice(0,10)),j=T=>[...typeof T=="number"?[[T,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],y=[];return typeof d.screened_window=="number"&&c&&y.push({cle:"fenetre",periode:e.funPerWindow(f(c),S),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:j(d.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[y.map(T=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:T.periode}),T.etapes.map(([R,L],N)=>t.jsxs("span",{className:"fst-t",children:[N>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(R)}),t.jsx("i",{children:L})]},T.cle+L)),T.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((d.screened||0)/h*100)))})]}),T.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const R=!l;s(R),R&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(wn,R?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},T.cle)),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ua} ${Ze}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((T,R)=>{const L=(T.s||0)/b*(Ze-4),N=(T.m||0)/b*(Ze-4),E=R*p+(p-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(T.d)} — ${T.s} ${e.actScreened} · ${T.m} ${e.actKept}`}),t.jsx("rect",{x:E,y:Ze-2-L,width:g,height:L,fill:"#cfe0d6"}),t.jsx("rect",{x:E,y:Ze-2-N,width:g,height:N,fill:"#185c38"})]},T.d)}),t.jsx("line",{x1:0,y1:Ze-1.5,x2:ua,y2:Ze-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const fr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function is(e,a){if((Qe(e)||"").startsWith("CALL")&&ke(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ke(e)>=2;return fr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function ss({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=B(),[s,d]=m.useState(!1),[x,c]=m.useState(""),[f,u]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),p=async g=>{if(x)return;if(g==="Analysé"&&!e.memoUrl){u(!0);return}c(g);const v=await i(e,g);c(""),v&&(d(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:g=>g.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(g=>!g),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),s&&t.jsx("span",{className:"rstm",children:f?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),d(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const g=await i(e,"Analysé");c(""),g&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]}):is(e,a).map(([g,v])=>t.jsx("button",{type:"button",className:"rsti"+(b===g?" on":"")+(x===g?" busy":""),disabled:!!x,onClick:()=>{p(g)},children:v},g))})]})}function ls({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=B(),[o,l]=m.useState(""),[s,d]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),c=(Qe(e)||"").startsWith("CALL")&&ke(e)===3,f=ke(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const g=await i(e,p);l(""),g&&(d(!0),setTimeout(()=>d(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:fr.filter(([p])=>!(f&&p==="Retenu")).map(([p,g])=>[p,a[g]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,g])=>t.jsx("button",{type:"button",className:"csb"+(x===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:g},p)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(cs,{o:e})]})}function cs({o:e}){const{t:a,saveNote:r,flash:n}=B(),[i,o]=m.useState(e.ceoNote||""),[l,s]=m.useState(!1),[d,x]=m.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(l||!c)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{f()},children:d?a.csNoteSaved:a.csNoteOk})]})}function ds({placeholder:e,onDone:a}){const{t:r}=B(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ps({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=B(),[d,x]=m.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const c=o(e),f=(c==null?void 0:c.stage)||"todo",u=async h=>{if(d||h===f)return;x(!0);const S=c;l(e,{stage:h,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),kn+=1);kn=j;const y=await Ao(r,{company:e.name||"",stage:h,cts:j,deal_id:e.airtableId,check_id:e.checkId});x(!1),!y.stale&&(y.ok||(l(e,S),s(a.actErr)))},b=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=f==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,S])=>t.jsx("button",{type:"button",className:"stgb"+(f===h?" on":""),disabled:d,onClick:()=>{u(h)},children:S},h)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let kn=0;const Ot=8,Ft=360;function jn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Nn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(jn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(jn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function us({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=B(),[l,s]=m.useState(0),[d,x]=m.useState(null),[c,f]=m.useState([]),u=m.useRef(!1),b=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=m.useRef(!1);m.useEffect(()=>{const L=b.current;return()=>{p.current||(n({type:"ptab",tab:L.ptab}),n({type:"dens",dens:L.dens}),n({type:"modal",modal:L.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,f(e.filter(L=>!!document.querySelector(L.need||L.sel))))},[e]);const g=c[l],v=l>=c.length;m.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const L=g.click,N=window.setTimeout(()=>{const E=document.querySelector(L);E&&E.getAttribute("aria-selected")!=="true"&&E.click()},60);return()=>window.clearTimeout(N)}},[l,g]);const h=m.useRef(-1),S=m.useCallback(()=>{if(!g){x(null);return}const L=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!L){x(null);return}h.current!==l&&(h.current=l,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const N=L.getBoundingClientRect();x(E=>E&&Math.abs(E.top-N.top)<1&&Math.abs(E.left-N.left)<1&&Math.abs(E.width-N.width)<1&&Math.abs(E.height-N.height)<1?E:N)},[g,l]);m.useLayoutEffect(()=>{S();const L=[90,300,700,1300].map(E=>window.setTimeout(S,E)),N=()=>S();return window.addEventListener("scroll",N,!0),window.addEventListener("resize",N),()=>{L.forEach(E=>window.clearTimeout(E)),window.removeEventListener("scroll",N,!0),window.removeEventListener("resize",N)}},[S]);const j=m.useRef(a);if(j.current=a,m.useEffect(()=>{const L=N=>{N.key==="Escape"?(N.preventDefault(),N.stopPropagation(),j.current()):N.key==="ArrowRight"?s(E=>E+1):N.key==="ArrowLeft"&&s(E=>Math.max(0,E-1))};return document.addEventListener("keydown",L,!0),()=>document.removeEventListener("keydown",L,!0)},[]),!c.length)return null;let y=null;const T=L=>()=>{p.current=!0,n({type:"modal",modal:null}),L()};if(v){const L=i[3]||0;L>0?y={title:L===1?r.ahaATitle1:r.ahaATitleN(L),body:r.ahaABody,btn:r.ahaABtn,go:T(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:T(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:T(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:T(()=>{n({type:"modal",modal:"crit"}),a()})}}let R={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Ft};if(!v&&d){const L=d.bottom+14,E=window.innerHeight-L>190?L:Math.max(12,d.top-200);R={left:Math.min(Math.max(12,d.left+d.width/2-Ft/2),window.innerWidth-Ft-12),top:E,width:Ft}}return mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Ot,top:d.top-Ot,width:d.width+Ot*2,height:d.height+Ot*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:R,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(Nn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(Nn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(L=>Math.max(0,L-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(L=>L+1),children:l===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function xr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function hr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ms(){var N,E;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:s,dispatch:d}=B(),x=r?a:e,c=m.useMemo(()=>x.filter(k=>Ke(k.date)===0&&k.kind==="target"),[x]),f=m.useMemo(()=>r?a.filter(k=>k.kind==="target"&&ke(k)===0).slice().sort((k,M)=>(M.date||"").localeCompare(k.date||"")):[],[a,r]),u=m.useMemo(()=>c.filter(k=>r?ke(k)===0:!qe(k)),[c,r]),b=r?f:u,p=r?a.length-f.length:c.length-u.length,g=r?a.length:c.length,v=g?Math.min(100,p/g*100):100,h=m.useMemo(()=>xr(x),[x]),S=!!h&&Ke(h)>0,j=m.useMemo(()=>S?x.filter(k=>(k.date||"").slice(0,10)===h):[],[x,h,S]),y=typeof((N=s.stats)==null?void 0:N.kept_today)=="number"?s.stats.kept_today:null,T=typeof((E=s.stats)==null?void 0:E.screened_today)=="number"?s.stats.screened_today:c.length;let R;S?R=i.morningLast(j.length,f.length,hr(h,l)):r?R=i.morningThesis(T,f.length,y):c.length?p===0?R=i.goalSourced(c.length):p>=c.length?R=i.goalCleared:R=i.goalDone(p,c.length):R=i.goalSourced(0);const L=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&f.length&&d({type:"chainStart",queue:f.map(k=>k.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:R}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:L,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function fs(){var U,G;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:d,doSync:x,startTour:c,flash:f,flashErr:u}=B(),[b,p]=m.useState(null),[g,v]=m.useState(!0),[h,S]=m.useState([]),j=d==="client";m.useEffect(()=>{if(!i||!o)return;let W=!0;return v(!0),(async()=>{const[V,K]=await Promise.all([Ba(o),nr(i)]);W&&(V&&p(V),v(!1),S(K))})(),()=>{W=!1}},[i,o]);const[y,T]=m.useState(!1),R=()=>{!j||y||!o||(T(!0),zo(o).then(W=>{T(!1),W?f(e.identRepubDone):u(e.actErr)}))},L=(b==null?void 0:b.per_day)??null,N=((U=b==null?void 0:b.pool_order)==null?void 0:U.length)??0,E=h.filter(W=>W.status==="running").length,k=m.useMemo(()=>s.filter(W=>W.kind==="target"&&qe(W)).length,[s]),M=l.marketEstimate,z=typeof((G=l.stats)==null?void 0:G.screened)=="number"?l.stats.screened:k,O=M&&M>0?Math.min(100,Math.round(z/M*100)):null,C=W=>W.toLocaleString(a==="en"?"en-US":"fr-FR"),A=(o||"P").split(/\s+/).map(W=>W[0]).join("").slice(0,2).toUpperCase(),F=(()=>{const W=Date.parse(l.generatedAt||"");if(Number.isNaN(W))return"";const V=new Date(W),K=Q=>String(Q).padStart(2,"0");return`${K(V.getDate())}/${K(V.getMonth()+1)} à ${K(V.getHours())}:${K(V.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?A:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),F?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(F)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[O===null&&z>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:C(z)})})]}),O!==null&&M&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:O+"%"}})}),t.jsxs("b",{children:[O," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(z,M)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),L!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:L})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),L===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),E>0&&t.jsxs("span",{className:"ev",children:["⏳ ",E]}),t.jsx("span",{className:"ego",children:g?e.identPendingWait:e.identPending(N)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:W=>{W.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||y,onClick:R,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:W=>n({type:"filters",patch:{search:W.target.value}})})]})]})]})}function xs(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=B(),s=o.loading&&!l.length,d=m.useRef({});m.useEffect(()=>{d.current={...r}},[r]);const x=u=>{const b=d.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${ba[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},c=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${ba[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),f=(u,b,p,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[c(5,!1,n.plabels[5]),c(7,!0,n.plabels[7]),c(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[f("↩",n.toolUndo,i,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function hs(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=B(),s=m.useRef(null),[d,x]=m.useState(60);m.useEffect(()=>{let p=0;const g=()=>{var y;const v=s.current;if(!v)return;const h=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!h)return;const S=h.getBoundingClientRect(),j=v.getBoundingClientRect();x(Math.max(20,Math.min(S.left+S.width/2-j.left,j.width-30)))};return p=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",g)}},[e.ptab]);const c=e.ptab;let f=r.tuto[c].p;if(c===3){const p=n.filter(h=>h.kind==="target"&&ke(h)===3),g=p.filter(h=>va(h)==="auto").length,v=p.filter(h=>va(h)==="cd").length;f=r.tutoPending(g,v,p.length)}const u=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(c===1){const p=n.filter(g=>g.kind==="target"&&ke(g)===1&&!i.has(g.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(g=>g.id)})}}return null})(),b=To(c);return t.jsxs("div",{ref:s,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${ba[c]})`,"--ax":d+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:f}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class at{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*gs(e){for(const a of e)yield*a}function gr(e){return Array.from(gs(e))}var de=1e-6,re=Math.PI,Fe=re/2,Sn=re/4,Pe=re*2,We=180/re,Te=re/180,me=Math.abs,bs=Math.atan,jt=Math.atan2,be=Math.cos,ve=Math.sin,vs=Math.sign||function(e){return e>0?1:e<0?-1:0},ot=Math.sqrt;function ys(e){return e>1?0:e<-1?re:Math.acos(e)}function Nt(e){return e>1?Fe:e<-1?-Fe:Math.asin(e)}function De(){}function Yt(e,a){e&&Cn.hasOwnProperty(e.type)&&Cn[e.type](e,a)}var En={Feature:function(e,a){Yt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Yt(r[n].geometry,a)}},Cn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Na(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Na(r[n],a,0)},Polygon:function(e,a){An(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)An(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Yt(r[n],a)}};function Na(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function An(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Na(e[r],a,1);a.polygonEnd()}function st(e,a){e&&En.hasOwnProperty(e.type)?En[e.type](e,a):Yt(e,a)}function Sa(e){return[jt(e[1],e[0]),Nt(e[2])]}function pt(e){var a=e[0],r=e[1],n=be(r);return[n*be(a),n*ve(a),ve(r)]}function Dt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Gt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ma(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Pt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Ea(e){var a=ot(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Ca(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Aa(e,a){return me(e)>re&&(e-=Math.round(e/Pe)*Pe),[e,a]}Aa.invert=Aa;function ws(e,a,r){return(e%=Pe)?a||r?Ca(Tn(e),qn(a,r)):Tn(e):a||r?qn(a,r):Aa}function zn(e){return function(a,r){return a+=e,me(a)>re&&(a-=Math.round(a/Pe)*Pe),[a,r]}}function Tn(e){var a=zn(e);return a.invert=zn(-e),a}function qn(e,a){var r=be(e),n=ve(e),i=be(a),o=ve(a);function l(s,d){var x=be(d),c=be(s)*x,f=ve(s)*x,u=ve(d),b=u*r+c*n;return[jt(f*i-b*o,c*r-u*n),Nt(b*i+f*o)]}return l.invert=function(s,d){var x=be(d),c=be(s)*x,f=ve(s)*x,u=ve(d),b=u*i-f*o;return[jt(f*i+u*o,c*r+b*n),Nt(b*r-c*n)]},l}function ks(e,a,r,n,i,o){if(r){var l=be(a),s=ve(a),d=n*r;i==null?(i=a+n*Pe,o=a-d/2):(i=Ln(l,i),o=Ln(l,o),(n>0?i<o:i>o)&&(i+=n*Pe));for(var x,c=i;n>0?c>o:c<o;c-=d)x=Sa([l,-s*be(c),-s*ve(c)]),e.point(x[0],x[1])}}function Ln(e,a){a=pt(a),a[0]-=e,Ea(a);var r=ys(-a[1]);return((-a[2]<0?-r:r)+Pe-de)%Pe}function br(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:De,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Vt(e,a){return me(e[0]-a[0])<de&&me(e[1]-a[1])<de}function It(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function vr(e,a,r,n,i){var o=[],l=[],s,d;if(e.forEach(function(p){if(!((g=p.length-1)<=0)){var g,v=p[0],h=p[g],S;if(Vt(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),s=0;s<g;++s)i.point((v=p[s])[0],v[1]);i.lineEnd();return}h[0]+=2*de}o.push(S=new It(v,p,null,!0)),l.push(S.o=new It(v,null,S,!1)),o.push(S=new It(h,p,null,!1)),l.push(S.o=new It(h,null,S,!0))}}),!!o.length){for(l.sort(a),Rn(o),Rn(l),s=0,d=l.length;s<d;++s)l[s].e=r=!r;for(var x=o[0],c,f;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;c=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,d=c.length;s<d;++s)i.point((f=c[s])[0],f[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(c=u.p.z,s=c.length-1;s>=0;--s)i.point((f=c[s])[0],f[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);i.lineEnd()}}}function Rn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function fa(e){return me(e[0])<=re?e[0]:vs(e[0])*((me(e[0])+re)%Pe-re)}function js(e,a){var r=fa(a),n=a[1],i=ve(n),o=[ve(r),-be(r),0],l=0,s=0,d=new at;i===1?n=Fe+de:i===-1&&(n=-Fe-de);for(var x=0,c=e.length;x<c;++x)if(u=(f=e[x]).length)for(var f,u,b=f[u-1],p=fa(b),g=b[1]/2+Sn,v=ve(g),h=be(g),S=0;S<u;++S,p=y,v=R,h=L,b=j){var j=f[S],y=fa(j),T=j[1]/2+Sn,R=ve(T),L=be(T),N=y-p,E=N>=0?1:-1,k=E*N,M=k>re,z=v*R;if(d.add(jt(z*E*ve(k),h*L+z*be(k))),l+=M?N+E*Pe:N,M^p>=r^y>=r){var O=Gt(pt(b),pt(j));Ea(O);var C=Gt(o,O);Ea(C);var A=(M^N>=0?-1:1)*Nt(C[2]);(n>A||n===A&&(O[0]||O[1]))&&(s+=M^N>=0?1:-1)}}return(l<-de||l<de&&d<-1e-12)^s&1}function yr(e,a,r,n){return function(i){var o=a(i),l=br(),s=a(l),d=!1,x,c,f,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=h,u.lineStart=S,u.lineEnd=j,c=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,c=gr(c);var y=js(x,n);c.length?(d||(i.polygonStart(),d=!0),vr(c,Ss,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),c=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,T){e(y,T)&&i.point(y,T)}function p(y,T){o.point(y,T)}function g(){u.point=p,o.lineStart()}function v(){u.point=b,o.lineEnd()}function h(y,T){f.push([y,T]),s.point(y,T)}function S(){s.lineStart(),f=[]}function j(){h(f[0][0],f[0][1]),s.lineEnd();var y=s.clean(),T=l.result(),R,L=T.length,N,E,k;if(f.pop(),x.push(f),f=null,!!L){if(y&1){if(E=T[0],(N=E.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),R=0;R<N;++R)i.point((k=E[R])[0],k[1]);i.lineEnd()}return}L>1&&y&2&&T.push(T.pop().concat(T.shift())),c.push(T.filter(Ns))}}return u}}function Ns(e){return e.length>1}function Ss(e,a){return((e=e.x)[0]<0?e[1]-Fe-de:Fe-e[1])-((a=a.x)[0]<0?a[1]-Fe-de:Fe-a[1])}const Mn=yr(function(){return!0},Es,As,[-re,-Fe]);function Es(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?re:-re,d=me(o-a);me(d-re)<de?(e.point(a,r=(r+l)/2>0?Fe:-Fe),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&d>=re&&(me(a-n)<de&&(a-=n*de),me(o-s)<de&&(o-=s*de),r=Cs(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Cs(e,a,r,n){var i,o,l=ve(e-r);return me(l)>de?bs((ve(a)*(o=be(n))*ve(r)-ve(n)*(i=be(a))*ve(e))/(i*o*l)):(a+n)/2}function As(e,a,r,n){var i;if(e==null)i=r*Fe,n.point(-re,i),n.point(0,i),n.point(re,i),n.point(re,0),n.point(re,-i),n.point(0,-i),n.point(-re,-i),n.point(-re,0),n.point(-re,i);else if(me(e[0]-a[0])>de){var o=e[0]<a[0]?re:-re;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function zs(e){var a=be(e),r=2*Te,n=a>0,i=me(a)>de;function o(c,f,u,b){ks(b,e,r,u,c,f)}function l(c,f){return be(c)*be(f)>a}function s(c){var f,u,b,p,g;return{lineStart:function(){p=b=!1,g=1},point:function(v,h){var S=[v,h],j,y=l(v,h),T=n?y?0:x(v,h):y?x(v+(v<0?re:-re),h):0;if(!f&&(p=b=y)&&c.lineStart(),y!==b&&(j=d(f,S),(!j||Vt(f,j)||Vt(S,j))&&(S[2]=1)),y!==b)g=0,y?(c.lineStart(),j=d(S,f),c.point(j[0],j[1])):(j=d(f,S),c.point(j[0],j[1],2),c.lineEnd()),f=j;else if(i&&f&&n^y){var R;!(T&u)&&(R=d(S,f,!0))&&(g=0,n?(c.lineStart(),c.point(R[0][0],R[0][1]),c.point(R[1][0],R[1][1]),c.lineEnd()):(c.point(R[1][0],R[1][1]),c.lineEnd(),c.lineStart(),c.point(R[0][0],R[0][1],3)))}y&&(!f||!Vt(f,S))&&c.point(S[0],S[1]),f=S,b=y,u=T},lineEnd:function(){b&&c.lineEnd(),f=null},clean:function(){return g|(p&&b)<<1}}}function d(c,f,u){var b=pt(c),p=pt(f),g=[1,0,0],v=Gt(b,p),h=Dt(v,v),S=v[0],j=h-S*S;if(!j)return!u&&c;var y=a*h/j,T=-a*S/j,R=Gt(g,v),L=Pt(g,y),N=Pt(v,T);ma(L,N);var E=R,k=Dt(L,E),M=Dt(E,E),z=k*k-M*(Dt(L,L)-1);if(!(z<0)){var O=ot(z),C=Pt(E,(-k-O)/M);if(ma(C,L),C=Sa(C),!u)return C;var A=c[0],F=f[0],U=c[1],G=f[1],W;F<A&&(W=A,A=F,F=W);var V=F-A,K=me(V-re)<de,Q=K||V<de;if(!K&&G<U&&(W=U,U=G,G=W),Q?K?U+G>0^C[1]<(me(C[0]-A)<de?U:G):U<=C[1]&&C[1]<=G:V>re^(A<=C[0]&&C[0]<=F)){var te=Pt(E,(-k+O)/M);return ma(te,L),[C,Sa(te)]}}}function x(c,f){var u=n?e:re-e,b=0;return c<-u?b|=1:c>u&&(b|=2),f<-u?b|=4:f>u&&(b|=8),b}return yr(l,s,o,n?[0,-e]:[-re,e-re])}function Ts(e,a,r,n,i,o){var l=e[0],s=e[1],d=a[0],x=a[1],c=0,f=1,u=d-l,b=x-s,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<c)return;p<f&&(f=p)}else if(u>0){if(p>f)return;p>c&&(c=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>f)return;p>c&&(c=p)}else if(u>0){if(p<c)return;p<f&&(f=p)}if(p=n-s,!(!b&&p>0)){if(p/=b,b<0){if(p<c)return;p<f&&(f=p)}else if(b>0){if(p>f)return;p>c&&(c=p)}if(p=o-s,!(!b&&p<0)){if(p/=b,b<0){if(p>f)return;p>c&&(c=p)}else if(b>0){if(p<c)return;p<f&&(f=p)}return c>0&&(e[0]=l+c*u,e[1]=s+c*b),f<1&&(a[0]=l+f*u,a[1]=s+f*b),!0}}}}}var gt=1e9,$t=-gt;function qs(e,a,r,n){function i(x,c){return e<=x&&x<=r&&a<=c&&c<=n}function o(x,c,f,u){var b=0,p=0;if(x==null||(b=l(x,f))!==(p=l(c,f))||d(x,c)<0^f>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+f+4)%4)!==p);else u.point(c[0],c[1])}function l(x,c){return me(x[0]-e)<de?c>0?0:3:me(x[0]-r)<de?c>0?2:1:me(x[1]-a)<de?c>0?1:0:c>0?3:2}function s(x,c){return d(x.x,c.x)}function d(x,c){var f=l(x,1),u=l(c,1);return f!==u?f-u:f===0?c[1]-x[1]:f===1?x[0]-c[0]:f===2?x[1]-c[1]:c[0]-x[0]}return function(x){var c=x,f=br(),u,b,p,g,v,h,S,j,y,T,R,L={point:N,lineStart:z,lineEnd:O,polygonStart:k,polygonEnd:M};function N(A,F){i(A,F)&&c.point(A,F)}function E(){for(var A=0,F=0,U=b.length;F<U;++F)for(var G=b[F],W=1,V=G.length,K=G[0],Q,te,ee=K[0],fe=K[1];W<V;++W)Q=ee,te=fe,K=G[W],ee=K[0],fe=K[1],te<=n?fe>n&&(ee-Q)*(n-te)>(fe-te)*(e-Q)&&++A:fe<=n&&(ee-Q)*(n-te)<(fe-te)*(e-Q)&&--A;return A}function k(){c=f,u=[],b=[],R=!0}function M(){var A=E(),F=R&&A,U=(u=gr(u)).length;(F||U)&&(x.polygonStart(),F&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),U&&vr(u,s,A,o,x),x.polygonEnd()),c=x,u=b=p=null}function z(){L.point=C,b&&b.push(p=[]),T=!0,y=!1,S=j=NaN}function O(){u&&(C(g,v),h&&y&&f.rejoin(),u.push(f.result())),L.point=N,y&&c.lineEnd()}function C(A,F){var U=i(A,F);if(b&&p.push([A,F]),T)g=A,v=F,h=U,T=!1,U&&(c.lineStart(),c.point(A,F));else if(U&&y)c.point(A,F);else{var G=[S=Math.max($t,Math.min(gt,S)),j=Math.max($t,Math.min(gt,j))],W=[A=Math.max($t,Math.min(gt,A)),F=Math.max($t,Math.min(gt,F))];Ts(G,W,e,a,r,n)?(y||(c.lineStart(),c.point(G[0],G[1])),c.point(W[0],W[1]),U||c.lineEnd(),R=!1):U&&(c.lineStart(),c.point(A,F),R=!1)}S=A,j=F,y=U}return L}}const za=e=>e;var xa=new at,Ta=new at,wr,kr,qa,La,Ge={point:De,lineStart:De,lineEnd:De,polygonStart:function(){Ge.lineStart=Ls,Ge.lineEnd=Ms},polygonEnd:function(){Ge.lineStart=Ge.lineEnd=Ge.point=De,xa.add(me(Ta)),Ta=new at},result:function(){var e=xa/2;return xa=new at,e}};function Ls(){Ge.point=Rs}function Rs(e,a){Ge.point=jr,wr=qa=e,kr=La=a}function jr(e,a){Ta.add(La*e-qa*a),qa=e,La=a}function Ms(){jr(wr,kr)}var ut=1/0,Kt=ut,St=-ut,Qt=St,Jt={point:Os,lineStart:De,lineEnd:De,polygonStart:De,polygonEnd:De,result:function(){var e=[[ut,Kt],[St,Qt]];return St=Qt=-(Kt=ut=1/0),e}};function Os(e,a){e<ut&&(ut=e),e>St&&(St=e),a<Kt&&(Kt=a),a>Qt&&(Qt=a)}var Ra=0,Ma=0,bt=0,Xt=0,Zt=0,lt=0,Oa=0,Fa=0,vt=0,Nr,Sr,Be,_e,Oe={point:nt,lineStart:On,lineEnd:Fn,polygonStart:function(){Oe.lineStart=Ps,Oe.lineEnd=Is},polygonEnd:function(){Oe.point=nt,Oe.lineStart=On,Oe.lineEnd=Fn},result:function(){var e=vt?[Oa/vt,Fa/vt]:lt?[Xt/lt,Zt/lt]:bt?[Ra/bt,Ma/bt]:[NaN,NaN];return Ra=Ma=bt=Xt=Zt=lt=Oa=Fa=vt=0,e}};function nt(e,a){Ra+=e,Ma+=a,++bt}function On(){Oe.point=Fs}function Fs(e,a){Oe.point=Ds,nt(Be=e,_e=a)}function Ds(e,a){var r=e-Be,n=a-_e,i=ot(r*r+n*n);Xt+=i*(Be+e)/2,Zt+=i*(_e+a)/2,lt+=i,nt(Be=e,_e=a)}function Fn(){Oe.point=nt}function Ps(){Oe.point=$s}function Is(){Er(Nr,Sr)}function $s(e,a){Oe.point=Er,nt(Nr=Be=e,Sr=_e=a)}function Er(e,a){var r=e-Be,n=a-_e,i=ot(r*r+n*n);Xt+=i*(Be+e)/2,Zt+=i*(_e+a)/2,lt+=i,i=_e*e-Be*a,Oa+=i*(Be+e),Fa+=i*(_e+a),vt+=i*3,nt(Be=e,_e=a)}function Cr(e){this._context=e}Cr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Pe);break}}},result:De};var Da=new at,ha,Ar,zr,yt,wt,Et={point:De,lineStart:function(){Et.point=Bs},lineEnd:function(){ha&&Tr(Ar,zr),Et.point=De},polygonStart:function(){ha=!0},polygonEnd:function(){ha=null},result:function(){var e=+Da;return Da=new at,e}};function Bs(e,a){Et.point=Tr,Ar=yt=e,zr=wt=a}function Tr(e,a){yt-=e,wt-=a,Da.add(ot(yt*yt+wt*wt)),yt=e,wt=a}let Dn,ea,Pn,In;class $n{constructor(a){this._append=a==null?qr:_s(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Pn||this._append!==ea){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Pn=n,ea=this._append,In=this._,this._=i}this._+=In;break}}}result(){const a=this._;return this._="",a.length?a:null}}function qr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function _s(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return qr;if(a!==Dn){const r=10**a;Dn=a,ea=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return ea}function Us(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),st(s,i(o))),o.result()}return l.area=function(s){return st(s,i(Ge)),Ge.result()},l.measure=function(s){return st(s,i(Et)),Et.result()},l.bounds=function(s){return st(s,i(Jt)),Jt.result()},l.centroid=function(s){return st(s,i(Oe)),Oe.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,za):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new $n(r)):new Cr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const d=Math.floor(s);if(!(d>=0))throw new RangeError(`invalid digits: ${s}`);r=d}return a===null&&(o=new $n(r)),l},l.projection(e).digits(r).context(a)}function Ga(e){return function(a){var r=new Pa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Pa(){}Pa.prototype={constructor:Pa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ka(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),st(r,e.stream(Jt)),a(Jt.result()),n!=null&&e.clipExtent(n),e}function Lr(e,a,r){return Ka(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,d])},r)}function Vs(e,a,r){return Lr(e,[[0,0],a],r)}function Hs(e,a,r){return Ka(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Ws(e,a,r){return Ka(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var Bn=16,Ys=be(30*Te);function _n(e,a){return+a?Ks(e,a):Gs(e)}function Gs(e){return Ga({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Ks(e,a){function r(n,i,o,l,s,d,x,c,f,u,b,p,g,v){var h=x-n,S=c-i,j=h*h+S*S;if(j>4*a&&g--){var y=l+u,T=s+b,R=d+p,L=ot(y*y+T*T+R*R),N=Nt(R/=L),E=me(me(R)-1)<de||me(o-f)<de?(o+f)/2:jt(T,y),k=e(E,N),M=k[0],z=k[1],O=M-n,C=z-i,A=S*O-h*C;(A*A/j>a||me((h*O+S*C)/j-.5)>.3||l*u+s*b+d*p<Ys)&&(r(n,i,o,l,s,d,M,z,E,y/=L,T/=L,R,g,v),v.point(M,z),r(M,z,E,y,T,R,x,c,f,u,b,p,g,v))}}return function(n){var i,o,l,s,d,x,c,f,u,b,p,g,v={point:h,lineStart:S,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=T},polygonEnd:function(){n.polygonEnd(),v.lineStart=S}};function h(N,E){N=e(N,E),n.point(N[0],N[1])}function S(){f=NaN,v.point=j,n.lineStart()}function j(N,E){var k=pt([N,E]),M=e(N,E);r(f,u,c,b,p,g,f=M[0],u=M[1],c=N,b=k[0],p=k[1],g=k[2],Bn,n),n.point(f,u)}function y(){v.point=h,n.lineEnd()}function T(){S(),v.point=R,v.lineEnd=L}function R(N,E){j(i=N,E),o=f,l=u,s=b,d=p,x=g,v.point=j}function L(){r(f,u,c,b,p,g,o,l,i,s,d,x,Bn,n),v.lineEnd=y,y()}return v}}var Qs=Ga({point:function(e,a){this.stream.point(e*Te,a*Te)}});function Js(e){return Ga({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Xs(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function Un(e,a,r,n,i,o){if(!o)return Xs(e,a,r,n,i);var l=be(o),s=ve(o),d=l*e,x=s*e,c=l/e,f=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function p(g,v){return g*=n,v*=i,[d*g-x*v+a,r-x*g-d*v]}return p.invert=function(g,v){return[n*(c*g-f*v+u),i*(b-f*g-c*v)]},p}function Zs(e){return el(function(){return e})()}function el(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,d=0,x=0,c,f=0,u=1,b=1,p=null,g=Mn,v=null,h,S,j,y=za,T=.5,R,L,N,E,k;function M(A){return N(A[0]*Te,A[1]*Te)}function z(A){return A=N.invert(A[0],A[1]),A&&[A[0]*We,A[1]*We]}M.stream=function(A){return E&&k===A?E:E=Qs(Js(c)(g(R(y(k=A)))))},M.preclip=function(A){return arguments.length?(g=A,p=void 0,C()):g},M.postclip=function(A){return arguments.length?(y=A,v=h=S=j=null,C()):y},M.clipAngle=function(A){return arguments.length?(g=+A?zs(p=A*Te):(p=null,Mn),C()):p*We},M.clipExtent=function(A){return arguments.length?(y=A==null?(v=h=S=j=null,za):qs(v=+A[0][0],h=+A[0][1],S=+A[1][0],j=+A[1][1]),C()):v==null?null:[[v,h],[S,j]]},M.scale=function(A){return arguments.length?(r=+A,O()):r},M.translate=function(A){return arguments.length?(n=+A[0],i=+A[1],O()):[n,i]},M.center=function(A){return arguments.length?(o=A[0]%360*Te,l=A[1]%360*Te,O()):[o*We,l*We]},M.rotate=function(A){return arguments.length?(s=A[0]%360*Te,d=A[1]%360*Te,x=A.length>2?A[2]%360*Te:0,O()):[s*We,d*We,x*We]},M.angle=function(A){return arguments.length?(f=A%360*Te,O()):f*We},M.reflectX=function(A){return arguments.length?(u=A?-1:1,O()):u<0},M.reflectY=function(A){return arguments.length?(b=A?-1:1,O()):b<0},M.precision=function(A){return arguments.length?(R=_n(L,T=A*A),C()):ot(T)},M.fitExtent=function(A,F){return Lr(M,A,F)},M.fitSize=function(A,F){return Vs(M,A,F)},M.fitWidth=function(A,F){return Hs(M,A,F)},M.fitHeight=function(A,F){return Ws(M,A,F)};function O(){var A=Un(r,0,0,u,b,f).apply(null,a(o,l)),F=Un(r,n-A[0],i-A[1],u,b,f);return c=ws(s,d,x),L=Ca(a,F),N=Ca(c,L),R=_n(L,T),C()}function C(){return E=k=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&z,O()}}function Rr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Rr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(me(i)>de&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function tl(){return Zs(Rr).scale(175.295)}function al(e){return e}function nl(e){if(e==null)return al;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,d){d||(a=r=0);var x=2,c=s.length,f=new Array(c);for(f[0]=(a+=s[0])*n+o,f[1]=(r+=s[1])*i+l;x<c;)f[x]=s[x],++x;return f}}function rl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ol(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Vn(e,r)})}:Vn(e,a)}function Vn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=il(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function il(e,a){var r=nl(e.transform),n=e.arcs;function i(c,f){f.length&&f.pop();for(var u=n[c<0?~c:c],b=0,p=u.length;b<p;++b)f.push(r(u[b],b));c<0&&rl(f,p)}function o(c){return r(c)}function l(c){for(var f=[],u=0,b=c.length;u<b;++u)i(c[u],f);return f.length<2&&f.push(f[0]),f}function s(c){for(var f=l(c);f.length<4;)f.push(f[0]);return f}function d(c){return c.map(s)}function x(c){var f=c.type,u;switch(f){case"GeometryCollection":return{type:f,geometries:c.geometries.map(x)};case"Point":u=o(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(o);break;case"LineString":u=l(c.arcs);break;case"MultiLineString":u=c.arcs.map(l);break;case"Polygon":u=d(c.arcs);break;case"MultiPolygon":u=c.arcs.map(d);break;default:return null}return{type:f,coordinates:u}}return x(a)}const Mr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},sl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ll(e,a,r){const n=Mr[e];if(!n||!n.length)return-1;const i=sl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Bt=null;function cl(){return Bt||(Bt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ol(r,n),o=tl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Us(o),s=(i.features||[]).filter(c=>{var f;return(((f=c.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(c=>{var b;const f=((b=c.properties)==null?void 0:b.name)||"",u=l(c)||"";return u?{i2:qo(f)||null,n:f,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const d={};for(const[c,f]of Object.entries(Lo)){const u=o(f);u&&(d[c]={x:u[0],y:u[1]})}const x={};for(const[c,f]of Object.entries(Mr)){const u=f.map(b=>o(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(x[c]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:d,metros:x}}catch{return null}})(),Bt)}function dl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return cl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const pl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Hn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Wn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ul(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var x;if(!i)return;const d=(x=e.current)==null?void 0:x.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Yn({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function ml(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:d,data:x,dossiers:c}=B(),f=x.loading&&!c.length,u=m.useRef(null),b=m.useRef(null),p=dl(e.continent==="monde"),g=e.continent==="monde"?p:_a.find(C=>C.key===e.continent)||null,v=ul(u,e.continent+":"+e.mapFolded+":"+!!g),[h,S]=m.useState(new Map),[j,y]=m.useState(null);m.useEffect(()=>{const C=u.current;if(!C)return;const A=new Map;C.querySelectorAll("path[data-i2]").forEach(F=>{const U=F.dataset.i2;if(U)try{const G=F.getBBox();G.width>0&&A.set(U,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),S(A)},[e.continent,v,g]);const T=m.useMemo(()=>r.filter(C=>C.cc),[r]),R=m.useMemo(()=>{const C=new Map;return T.forEach(A=>C.set(A.cc,(C.get(A.cc)||0)+1)),C},[T]),L=e.continent==="monde"&&p?p.anchors:null,N=e.continent==="monde"&&p?p.metros:null,E=m.useMemo(()=>T.map(C=>{const A=Wn(C.name||C.id||""),F=Wn((C.id||C.name||"")+"·y");if(L&&C.cc){const K=N?N[C.cc]:void 0;if(K&&K.length){const te=ll(C.cc,C.city,A);if(te>=0&&K[te])return{d:C,x:K[te].x+(A-.5)*5,y:K[te].y+(F-.5)*5}}const Q=L[C.cc];if(Q)return{d:C,x:Q.x+(A-.5)*10,y:Q.y+(F-.5)*10}}const U=C.cc?h.get(C.cc):void 0;if(!U)return null;const G=pl[`${e.continent}:${C.cc||""}`];if(G)return{d:C,x:U.x+U.w*(G.fx+(A-.5)*G.sx),y:U.y+U.h*(G.fy+(F-.5)*G.sy)};const W=(A-.5)*Math.min(U.w*.55,60),V=(F-.5)*Math.min(U.h*.55,60);return{d:C,x:U.x+U.w/2+W,y:U.y+U.h/2+V}}).filter(C=>!!C),[T,h,L,N,e.continent]),k=C=>v>0?C/v:C,M=m.useMemo(()=>n?[0,1,2,3,4,5].map(C=>({c:Hn[C],fr:d.plabels[C].toUpperCase(),en:d.plabels[C].toUpperCase(),n:r.filter(A=>A.kind==="target"&&ke(A)===C).length})).filter(C=>C.n>0):ln.map((C,A)=>({...C,n:r.filter(F=>cn(F)===A).length})),[r,n,d.plabels]),z=o?l.get(o):null,O=z?E.find(C=>C.d.id===z.id):null;return g?t.jsxs("div",{className:"mapzone"+(f?" waiting":""),ref:b,children:[f&&t.jsx(Yn,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?g.fr:g.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:g.countries.map((C,A)=>t.jsx("g",{className:"ct"+(C.i2&&R.get(C.i2)?"":" empty"),children:t.jsx("path",{d:C.d,"data-i2":C.i2||void 0})},A))}),t.jsx("g",{children:E.map(C=>{const A=ln[cn(C.d)],F=!!je(C.d),U=C.d.kind==="target",G=n&&U?Hn[ke(C.d)]:A.c,W=!n&&qe(C.d);return t.jsxs("g",{className:"co"+(W?" done":""),onMouseEnter:()=>{var Q,te;const V=(Q=b.current)==null?void 0:Q.getBoundingClientRect(),K=(te=u.current)==null?void 0:te.createSVGPoint();if(K&&u.current&&V){K.x=C.x,K.y=C.y;const ee=K.matrixTransform(u.current.getScreenCTM());y({x:ee.x-V.left,y:ee.y-V.top,label:C.d.name+" · "+(ft(C.d.cc,s)||C.d.countryLabel||"")})}i(C.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var Q;const V=(Q=u.current)==null?void 0:Q.createSVGPoint();let K=null;if(V&&u.current){V.x=C.x,V.y=C.y;const te=V.matrixTransform(u.current.getScreenCTM());K={x:te.x,y:te.y}}a({type:"popup",id:C.d.id,anchor:K})},children:[t.jsx("circle",{className:"h",cx:C.x,cy:C.y,r:k(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:C.x,cy:C.y,r:k(A.px),fill:G,stroke:F?"#DC2626":"#ffffff",strokeWidth:k(F?2.2:1.3)})]},C.d.id||C.d.name)})}),O&&t.jsx("circle",{className:"ring on",cx:O.x,cy:O.y,r:k(13),fill:"none",stroke:"#0F172A",strokeWidth:k(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:M.map((C,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":C.c}}),s==="fr"?C.fr:C.en," ",t.jsx("b",{children:C.n})]},A))}),r.some(C=>!C.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(C=>!C.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(f?" waiting":""),ref:b,children:t.jsx(Yn,{msgs:d.loadMsgs})})}function fl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Or({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:s}=B(),d=a.filters,[x,c]=m.useState(!1),f=m.useRef(null),u=m.useMemo(()=>a.continent==="monde"?n:n.filter(N=>N.continent===a.continent),[n,a.continent]),b=N=>u.filter(E=>N!=="country"&&d.country.length&&!d.country.includes(E.cc||"")?!1:Va(E,d,o,N==="country"?void 0:N)),p=m.useMemo(()=>{const N=b("win"),E=k=>N.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=k).length;return[E(0),E(7),E(30),N.length]},[u,d,o]),g=m.useMemo(()=>d.day?b("win").filter(N=>(N.date||"").slice(0,10)===d.day).length:0,[u,d,o]),v=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,h=v+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),m.useEffect(()=>{if(!x)return;const N=k=>{var M;(M=f.current)!=null&&M.contains(k.target)||c(!1)},E=k=>{k.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",N),document.addEventListener("keydown",E),()=>{document.removeEventListener("mousedown",N),document.removeEventListener("keydown",E)}},[x]);const S=(N,E,k,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===N,onClick:()=>r({type:"openFacet",facet:N}),children:[t.jsx("span",{className:"fl",children:E}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:"▾"})]},N),j=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(fl(d.day,s))}),t.jsx("b",{children:g})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((N,E)=>t.jsxs("button",{type:"button","aria-pressed":d.win===N,onClick:()=>r({type:"filters",patch:{win:N}}),children:[t.jsx("span",{className:"sl",children:i.dates[E]}),t.jsx("b",{children:p[E]})]},N))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:N=>r({type:"filters",patch:{search:N.target.value}})})]}),T=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):S("sec",i.fSector,d.sector.length),S("pay",i.fCountry,d.country.length),S("det",i.fEngine,d.engine.length),S("sta",i.fStage,d.stage.length),o&&S("ang","Angle",d.angle.length),o&&S("mem","Mémo",d.memoLevel.length)]}),R=(N=!1)=>t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),N&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:f,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":x,"aria-haspopup":"true",onClick:()=>{c(N=>!N),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:T})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(d.day?" noday":""),children:[!d.day&&t.jsx("div",{className:"fstrip-a",children:j}),t.jsxs("div",{className:"fstrip-b",children:[y,L,R(!0)]})]}),a.openFacet&&t.jsx(Gn,{poolFor:b})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[j,y,T,t.jsx("span",{className:"fgrow"}),R()]}),a.openFacet&&t.jsx(Gn,{poolFor:b})]})}function Gn({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=B(),o=a.filters,l=a.openFacet,{title:s,cols:d,options:x}=m.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(h=>je(h)),g=new Map;p.forEach(h=>{const S=h.engine||"";g.set(S,(g.get(S)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ya([...g.keys()],i).map(h=>({v:h,label:tt(h)+" "+Ue(h,i),n:g.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const p=e("sector"),g=new Map;return p.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const p=e("country"),g=new Map;return p.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:ft(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const p=e("engine"),g=new Map;return p.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ya([...g.keys()],i).map(v=>({v,label:tt(v)+" "+Ue(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Ro(Mo(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const p=e("angle"),g=new Map;return p.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const p=e("memoLevel"),g=new Map;p.forEach(h=>{if(h.kind==="target"){const S=$a(h);g.set(S,(g.get(S)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:g.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,g)=>g[1]-p[1]).map(([p,g])=>({v:p,label:p,n:g,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),c=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},f=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>c(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Fr({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:s}=B(),d=m.useMemo(()=>{const b={};return r.forEach(p=>{Va(p,n.filters,o)&&(b.monde=(b.monde||0)+1,p.continent&&(b[p.continent]=(b[p.continent]||0)+1))}),b},[r,n.filters,o]),[x,c]=m.useState(!1),f=m.useRef(null);m.useEffect(()=>{if(!x)return;const b=g=>{var v;(v=f.current)!=null&&v.contains(g.target)||c(!1)},p=g=>{g.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",p)}},[x]);const u=b=>{const p=_a.find(g=>g.key===b);return b==="monde"?s.contWorld:l==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:f,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:d[n.continent]||0}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:dn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{i({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:d[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[dn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>i({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:d[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})})]})}function Dr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function xl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Kn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=B();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:s.rsEvalOne})]},d.name))})]}):null}function Pr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=B(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Kn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Kn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function hl({card:e,onEvaluate:a,onAddAll:r}){var s,d,x;const{t:n}=B(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Dr(e.summary_md||"").map((c,f)=>t.jsx("p",{children:c},f))})]}),t.jsx(Pr,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function gl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function bl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=B(),s=i,[d,x]=m.useState(null),[c,f]=m.useState(null),[u,b]=m.useState(null),[p,g]=m.useState(!1);m.useEffect(()=>{let h=!0;return(async()=>{const S=await rr({email:l,cbToken:s});h&&x(S)})(),()=>{h=!1}},[l,s,n]);const v=h=>{f(h),b(null),g(!0),(async()=>{const S=await Oo(h.id);b(S),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[gl(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(hl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Qn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function vl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:d,caps:x,data:c,canWrite:f,source:u,dossiers:b,doAnalyse:p,liveMemos:g,pipe:v}=B(),h=a==="client",S=m.useMemo(()=>r||(u!=="default"?Fo():""),[r,u]),[j,y]=m.useState(""),[T,R]=m.useState(!1),[L,N]=m.useState(""),[E,k]=m.useState(!1),[M,z]=m.useState(""),[O,C]=m.useState([]),A=m.useRef(!1),[F,U]=m.useState(!1),[G,W]=m.useState(""),[V,K]=m.useState(""),[Q,te]=m.useState(!1),[ee,fe]=m.useState(0),[ge,xe]=m.useState(""),[Z,ie]=m.useState(null),[ae,H]=m.useState(null),[J,ue]=m.useState(!1),[q,$]=m.useState(null),[D,Y]=m.useState(0),ne=m.useRef(!1),X=j.trim()?Qn.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting,se=m.useMemo(()=>L.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[L]);m.useEffect(()=>{if(typeof window>"u")return;const P=(new URLSearchParams(window.location.search).get("rs")||"").trim();!P||!/^https?:\/\//i.test(P)||(W(P),U(!0))},[]),m.useEffect(()=>{const P=le=>{var Ne;const pe=String(((Ne=le.detail)==null?void 0:Ne.url)||"").trim();!pe||!/^https?:\/\//i.test(pe)||(W(pe),U(!0))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),m.useEffect(()=>{if(!f&&!S){$(null);return}let P=!0;return(async()=>{const le=await rr({email:n,cbToken:S});P&&$(le.length)})(),()=>{P=!1}},[f,S,n,D]);const Ee=O.length?O:d,ce=c.credits,Le=m.useCallback(P=>{const le=P.map(pe=>(pe||"").trim()).filter(Boolean);le.length&&(N(pe=>{const Ne=pe.split(`
...
`)}),R(!0))},[]);m.useEffect(()=>{if(!Q)return;fe(0);const P=window.setInterval(()=>fe(le=>le+1),1e3);return()=>window.clearInterval(P)},[Q]);const Ve=m.useMemo(()=>{const P=j.trim().toLowerCase();return!P||!v?null:b.find(le=>Ye(le.name)===P&&ke(le)===1)||null},[j,b,v]),it=()=>{const P=j.trim();if(P){if(Ve){p(Ve);return}i(null,P),y("")}},xt=async()=>{if(!h){i(null,se[0]||"");return}if(!se.length||E)return;k(!0),A.current=!1;const P=[];for(let le=0;le<se.length&&!A.current;le++){z(e.evaluating(le+1,se.length,se[le]));const pe=await or(r,se[le],"atelier2");if(P.unshift({name:pe.company||se[le],verdict:pe.verdict,reason:pe.reason||"",remaining:pe.remaining??null}),C([...P]),pe.verdict==="quota"){P.unshift({name:"",verdict:"quota",reason:e.quota(se.length-le-1),remaining:0}),C([...P]),N(se.slice(le+1).join(`
`)),z(""),k(!1);return}}z(""),N(A.current?se.slice(P.length).join(`
`):""),k(!1)},zt=async()=>{var pe,Ne,He;if(ne.current)return;const P=G.trim().replace(/\s+/g,""),le=V.trim();if(!P&&!le){xe(e.rsNeed);return}if(!h&&!S){i(null,P||le.slice(0,80));return}ne.current=!0,xe(""),ie(null),H(null),te(!0);try{const Se=await Po({url:P,text:le,email:n,cbToken:S});if(te(!1),!Se||Se.status!=="success"){xe((Se==null?void 0:Se.message)||"Erreur");return}ie(Se),U(!1),Le((((pe=Se.prospective)==null?void 0:pe.companies_to_evaluate)||[]).map(Re=>(Re==null?void 0:Re.name)||"")),H({state:"pending"});const he=await Io(Se,{email:n,cbToken:S});H(he.ok?{state:"ok",scopeLabel:((Ne=he.summary)==null?void 0:Ne.scope_label)||"",scope:((He=he.summary)==null?void 0:He.scope)||""}:{state:"fail",msg:he.error||""}),he.ok&&Y(Re=>Re+1)}finally{ne.current=!1,te(!1)}},Tt=[Z==null?void 0:Z.industry,...(Z==null?void 0:Z.market_tags)||[],Z==null?void 0:Z.author].map(P=>(P||"").trim()).filter(Boolean),Ie=(ae==null?void 0:ae.state)==="pending",ra=ae&&(Ie?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):ae.state==="ok"?t.jsx("span",{className:"rslink ok",children:ae.scope&&ae.scope!=="public"?e.rsSavedIn(ae.scopeLabel||ae.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:ae.msg,children:e.rsSaveFail})),qt=xl(Z).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:j,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:P=>y(P.target.value),onKeyDown:P=>{P.key==="Enter"&&it()}}),t.jsx("span",{className:"detect"+(Qn.test(j.trim())?" url":""),children:X})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(Ve?" analyse":"")+(s?" loading":""),disabled:s,onClick:it,children:[t.jsx("span",{className:"fill"}),Ve?e.actAnalyse:e.evalGo]}),x.showCredits&&ce&&t.jsxs("button",{type:"button",className:"credits"+(ce.total_available<=0&&!ce.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ce.unlimited?"∞":ce.total_available}),!ce.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ce.daily_grant+ce.purchased]}),ce.total_available<=0&&!ce.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),g.items.filter(P=>P.status==="boot"||P.status==="running").map(P=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:P.name}),t.jsx(kt,{item:P,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+P.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>R(!T),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(F?" on":""),onClick:()=>U(!F),children:e.rsOpen}),q!==null&&q>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(J?" on":""),onClick:()=>ue(!J),children:e.rsArchOpen(q)})]}),J&&t.jsx(bl,{bump:D,cbToken:S,onClose:()=>ue(!1),onEvaluate:P=>i(null,P),onAddAll:Le}),F&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:G,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:P=>W(P.target.value),onKeyDown:P=>{P.key==="Enter"&&zt()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:V,placeholder:e.rsTextPh,onChange:P=>K(P.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Q?" loading":""),style:{justifyContent:"center"},disabled:Q||Ie||!G.trim()&&!V.trim(),onClick:()=>{zt()},children:[t.jsx("span",{className:"fill"}),Q?`${Do(G.trim())==="youtube"&&G.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ee)}`:Ie?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),ge&&t.jsx("div",{className:"rserr",children:ge}),Z&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:Z.title}),Z.source_url&&t.jsx("a",{href:Z.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ie(null),H(null)},children:"×"})]}),Z.market&&t.jsx("p",{className:"rsmk",children:Z.market}),Tt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Tt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[Z.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${Z.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Dr(Z.summary_md||"").map((P,le)=>t.jsx("p",{children:P},le))})]}),t.jsx(Pr,{card:Z,onEvaluate:P=>i(null,P),onAddAll:Le}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(qt)}),ra]})]}),T&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:L,placeholder:e.bulkPh,onChange:P=>N(P.target.value.split(`
`).slice(0,15).join(`
...
`).map((x,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[dt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Ir({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=B(),[l,s]=m.useState(!1),[d,x]=m.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const c=async()=>{if(l)return;s(!0);const f=await $o(r,e);if(s(!1),!f){o(a.actErr);return}x(f.results||[])};return t.jsxs("div",{className:"simb",onClick:f=>f.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{c()},children:l?a.similarBusy:a.similar}),d&&(d.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:d.map(f=>t.jsxs("li",{children:[t.jsx("b",{className:f.verdict==="kept"?"ok":"ko",children:f.company}),f.reason&&t.jsx("span",{children:f.reason})]},f.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const kl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),_t=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function jl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=_t(a.slice(n));break}r+=_t(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=_t(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),d=s?s[2].toLowerCase():"";s&&kl.has(d)?r+=`<${s[1]}${d}>`:r+=_t(a.slice(i,o+1)),n=o+1}return r}const Jn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ae({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Nl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Sl({o:e}){const{t:a,doDeep:r}=B(),[n,i]=m.useState(!1),o=Qe(e),l=[e.reasoning||"",Nl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((s,d)=>t.jsx("p",{className:"cdtxt",children:s},d)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[dt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:s=>{s.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:s=>{s.stopPropagation(),i(d=>!d)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:s=>s.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:s=>s.stopPropagation()})]})}function $r({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=B(),o=Ct(e),l=Qe(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,c=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),f=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:c},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||dt(e)?1:0}].filter(g=>g.n>0),[e,a,s,l,d,x,c]),[u,b]=m.useState("");if(!f.length)return null;const p=f.some(g=>g.k===u)?u:f[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:f.map(g=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===g.k,"data-tour":"tab-"+g.k,className:p===g.k?"on":"",onClick:v=>{v.stopPropagation(),b(g.k)},children:g.lib},g.k))}),t.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ae,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Ae,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Ae,{k:a.cdVerdictDate,v:Jn(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:jl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(El,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ae,{k:a.cdSector,v:e.sector}),t.jsx(Ae,{k:a.cdStage,v:e.stage}),t.jsx(Ae,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ae,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Ae,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Ae,{k:a.cdAngle,v:e.angle}),t.jsx(Ae,{k:a.cdDetected,v:Jn(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ae,{k:a.cdName,v:e.contactName}),t.jsx(Ae,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Ae,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(Sl,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ae,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Ae,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function El({o:e}){const{t:a,token:r}=B(),[n,i]=m.useState(!1),[o,l]=m.useState(null),s=async()=>{n||(i(!0),l(await Bo(r,e.name,e.website||e.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},x=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],c=x.some(([,f])=>f);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&c&&t.jsxs(t.Fragment,{children:[x.filter(([,f])=>f).map(([f,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:f}),t.jsx("p",{children:u})]},f)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!c&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function aa({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;return pn({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)}),()=>{l=!0,o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;pn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(d=>{!l&&d&&o.isConnected&&o.replaceChildren(d)});const s=d=>{d.key==="Escape"&&i(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Cl=`
...
`;function Al(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function zl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:d,doDecide:x,doPromote:c,doRepeche:f,doApproach:u,doDeep:b,doOnboard:p,outbound:g,evalBusy:v}=B(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const S=je(h),j=ke(h),y=Qe(h),T=Ct(h),R=h.kind==="target",L=N=>{a({type:"filters",patch:N}),a({type:"popup",id:null})};return mt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Cl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Al(e.popupAnchor,!!h.card),onClick:N=>N.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(Ke(h.date)),Ue(h.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>L({country:[h.cc]}),children:(ft(h.cc,i)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>L({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>L({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:At(h.amountEur,i)})]}),o.pipe&&R&&t.jsxs("div",{className:"pstat",children:[T&&t.jsx("span",{className:"vd "+(T==="MATCH"?"v-ok":"v-no"),title:n.vt[T],children:T}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[tt(h.engine)," ",t.jsx("b",{children:Ue(h.engine,i)})," — ",_o(h.engine,i),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),S?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(rt,{o:h,lg:!0})," ",t.jsx(na,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Ua(S,i))," · ",n.win7(Ht(S,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(aa,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),o.pipe&&R&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),o.pipe&&R&&t.jsx($r,{o:h})]}),t.jsx(Ir,{name:h.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(h,!1),a({type:"popup",id:null})},children:n.actNo}),dt(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(h),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),g&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var N;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(N=document.querySelector(".atl2 .demand"))==null||N.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(h.name),onClick:()=>s(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}const Tl=8;function ql(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=B(),[s,d]=m.useState(!1),[x,c]=m.useState(!1),[f,u]=m.useState(!1),b=`atl2:sincemini:${r||"home"}`,[p,g]=m.useState(()=>{try{return localStorage.getItem(b)==="1"}catch{return!1}}),v=()=>{g(N=>{try{localStorage.setItem(b,N?"0":"1")}catch{}return!N})},h=r||"home",{names:S,verdicts:j}=m.useMemo(()=>{const N=[],E={};return n.forEach(k=>{k.kind!=="target"||!k.name||(N.push(k.name),E[k.name]=Uo(k)||"")}),{names:N,verdicts:E}},[n]),y=m.useMemo(()=>S.length?Vo(h,S,j,a):null,[h,S.length]);if(!i.pipe||s||!y||y.firstVisit||!y.added.length&&!y.gone.length)return null;const T=x?y.added:y.added.slice(0,Tl),R=y.added.length-T.length,L=N=>{const E=n.find(k=>k.name===N);E&&(o(E.id),l({type:"popup",id:E.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(y.added.length,y.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:v,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{d(!0),Ho(h,S,j,y.fp,a)},children:"×"})]}),!!y.added.length&&t.jsxs("div",{className:"sg-c",children:[T.map(N=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>L(N),children:t.jsx("b",{children:N})},N)),R>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>c(!0),children:e.sinceMore(R)})]}),!!y.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(N=>!N),children:e.sinceOut(y.gone.length)}),f&&y.gone.slice(0,20).map(N=>t.jsx("span",{className:"gone",children:N},N))]})]})}const Br={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Qa({o:e,locked:a=!1}){const{t:r}=B(),n=Ct(e),i=Qe(e),o=ke(e),l=va(e),s=Yo(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(Br[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(ss,{o:e})]})}const ta=e=>e.length>22?e.slice(0,21)+"…":e;function Xn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=B(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),qe(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(ta(e.name))})]})}function _r({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:d,doApproach:x,dispatch:c,liveMemos:f}=B();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p=>{p.stopPropagation(),c({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{var g;p.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(g=document.querySelector(".atl2 .demand"))==null||g.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{var g;p.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(g=document.querySelector(".atl2 .demand"))==null||g.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Xn,{o:e})});const u=ke(e),b=p=>g=>{g.stopPropagation(),p()};if(u===0)return t.jsx("span",{className:"cell",children:t.jsx(Xn,{o:e})});if(u===1){const p=f.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(kt,{item:p,serverOff:f.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const g=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:g,onClick:b(()=>o(e)),children:g?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})});if(u===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:b(()=>x(e)),children:p?a.actApproachSent:a.actApproach})})}return u===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):u===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>c({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Ll({o:e}){const{t:a,doThumb:r,thumbOf:n}=B(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Rl({o:e}){const{lang:a}=B();return je(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(rt,{o:e}),t.jsx(na,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[tt(e.engine||"")," ",Ue(e.engine||"",a)]})})}function Ml({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:d,favIds:x,toggleFav:c,t:f}=B(),u=ke(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],p=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,g=p<=0?0:p<=7?1:p<=30?2:3,v=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:b[g],h=x.has(e.id),S=j=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const y=j.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:y.left+Math.min(280,y.width/3),y:y.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(d===e.id||r?" on":"")+(r?" open":"")+(a?" tzr":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:S,children:[t.jsx("span",{className:"pt",style:{"--c":v}}),t.jsx(Wr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:h?1:.35,padding:0,marginRight:4},onClick:j=>{j.stopPropagation(),c(e)},children:h?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(j=>j&&j!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:f.acqSee(e.acquirer),onClick:j=>{j.stopPropagation(),o({type:"acquirer",value:e.acquirer||""})},children:["← ",ta(e.acquirer)]}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(Ol,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Rl,{o:e}),l.pipe&&t.jsx(Qa,{o:e,locked:a}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(_r,{o:e}),l.showThumbs&&t.jsx(Ll,{o:e})]}),r&&!a&&t.jsx(Dl,{o:e})]})}function Ol({o:e}){const{lang:a,caps:r}=B();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=At(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Fl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=B(),l=(u,b=!1)=>p=>{p.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),d=At(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=qe(e),f=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ta(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ta(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(aa,{spec:e.card})})]})}function Dl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=B();return!i.pipe&&e.kind==="op"?t.jsx(Fl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx($r,{o:e}),t.jsx(ls,{o:e}),t.jsx(ps,{o:e}),t.jsx(Ir,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Qa,{o:e})})]}),e.card&&t.jsx(aa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[tt(e.engine||"")," ",Ue(e.engine||"",r)]}),je(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(rt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Pl({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:l}=B();if(!i.pipe&&e.kind==="op"){const x=At(e.amountEur,l),c=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),f=(u,b=!1)=>p=>{p.stopPropagation(),b&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(aa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:f({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:f({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:f({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[tt(e.engine||"")," ",Ue(e.engine||"",l)]}),je(e)&&t.jsx(rt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(c?` · ${c}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(_r,{o:e})})]})}const s=ke(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" tzr":""),style:{"--c":d},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Qa,{o:e}),je(e)&&t.jsx(rt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Il(){const{t:e}=B(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function $l({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=B(),o=i==="en",l=c=>n.plabels[c]||"",s=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),d=s.includes(0)?0:s.sort((c,f)=>(e[f]||0)-(e[c]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?o?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:o?`${x} ${x>1?"files":"file"} in “${l(d)}”`:`${x} dossier${x>1?"s":""} dans « ${l(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(o?"Open ":"Ouvrir ")+l(d)," →"]})]})}function Bl(){var J,ue;const e=B(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:s,markRow:d,lang:x,sessTally:c,data:f,dossiers:u,source:b}=e,p=q=>i.lockRowsAfter!==null||b==="ops"&&(q==="ma"||q==="fundraising")?Number.MAX_SAFE_INTEGER:b==="ops"?8:lr,[g,v]=m.useState(new Set);m.useEffect(()=>{v(new Set)},[a.ptab,a.continent]);const[h,S]=m.useState(null);m.useEffect(()=>{S(null)},[a.ptab,a.continent]);const j=q=>v($=>{const D=new Set($);return D.has(q)?D.delete(q):D.add(q),D}),[y,T]=m.useState("all"),[R,L]=m.useState(!1);m.useEffect(()=>{T("all"),L(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!R)return;const q=$=>{var D,Y;(Y=(D=$.target)==null?void 0:D.closest)!=null&&Y.call(D,".atl2 .doable")||L(!1)};return document.addEventListener("click",q),()=>document.removeEventListener("click",q)},[R]);const N=dr(),E=m.useMemo(()=>{var $;const q=new Map;for(const D of Ui((($=N==null?void 0:N.ed)==null?void 0:$.html)||""))q.has(D.t)||q.set(D.t,D.html);return q},[(J=N==null?void 0:N.ed)==null?void 0:J.html]),k=m.useCallback(q=>{if(q.decryptHtml)return q.decryptHtml;if(!E.size)return;const $=(q.name||"").trim().toLowerCase();if($.length<3)return;const D=E.get($);if(D)return D;for(const[Y,ne]of E)if(Y.includes($)||$.includes(Y))return ne},[E]),M=m.useMemo(()=>{const q=Ha(l,a.sort);return y==="all"?q:q.filter($=>y==="explore"?!!$.noCo:!$.noCo)},[l,a.sort,b,y]),z=m.useMemo(()=>i.pipe?s.filter(q=>je(q)&&Wo(q)):M.filter(q=>je(q)&&!qe(q)),[i.pipe,s,M]),O=z.length,[C,A]=m.useState(!1),[F,U]=m.useState(!1),G=`atl2:sigmini:${((ue=f.session)==null?void 0:ue.token)||"home"}`,[W,V]=m.useState(()=>{try{return localStorage.getItem(G)==="1"}catch{return!1}}),K=m.useMemo(()=>i.pipe?M:M.filter(q=>!qe(q)&&!q.noCo),[M,i.pipe]),Q=b==="ops"?M.filter(q=>q.noCo).length:0,te=i.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,ee=a.filters,fe=[];if(ee.day)fe.push({k:"day",lib:n.fDay(ee.day.slice(8,10)+"/"+ee.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(ee.win&&ee.win!=="all"){const q=["1","7","30"].indexOf(ee.win);q>=0&&fe.push({k:"win",lib:n.dates[q],off:()=>r({type:"filters",patch:{win:"all"}})})}const ge=q=>q.length<=2?q.join(", "):`${q.length} ${n.fSelected}`;for(const q of["sector","country","engine"]){const $=ee[q];$&&$.length&&fe.push({k:q,lib:ge($),off:()=>r({type:"clearFacet",facet:q})})}ee.search&&fe.push({k:"search",lib:"🔍 "+ee.search,off:()=>r({type:"filters",patch:{search:""}})});const xe=(q,$,D="",Y=!1)=>t.jsxs("button",{type:"button","data-s":q,className:D,"aria-sort":a.sort.key===q?a.sort.dir===1?"ascending":"descending":"none",style:Y?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:q}),children:[$,t.jsx("span",{className:"ar",children:a.sort.key===q&&a.sort.dir===1?"▴":"▾"})]},q),Z=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const q=new Map;M.forEach(Y=>{const ne=Y.engine||"?";q.has(ne)||q.set(ne,[]),q.get(ne).push(Y)});const $={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},D=ya([...q.keys()],x);return[...q.entries()].sort((Y,ne)=>{const X=$[Y[0]]??10+D.indexOf(Y[0]),se=$[ne[0]]??10+D.indexOf(ne[0]);return X-se})},[M,i.pipe,a.groupBy,x]),ie=i.lockRowsAfter;let ae=0;const H=(q,$)=>{let D=a.shown[$]||p($);return q.length-D<=4&&(D=q.length),q.slice(0,D).map(X=>{const se=ie!==null&&ae>=ie;ae++;const Ee=k(X),ce=Ee&&Ee!==X.decryptHtml?{...X,decryptHtml:Ee}:X,Le=X.engine==="ma"||X.engine==="fundraising",Ve=a.dens!=="maxi"&&(a.dens==="deplie"||(h?h==="open":!!Ee||b==="ops"&&Le)),it=g.has(X.id)?!Ve:Ve;return a.dens==="maxi"?t.jsx(Pl,{o:ce,locked:se},X.id):t.jsx(Ml,{o:ce,locked:se,open:it,onToggle:()=>j(X.id)},X.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(a.mapFolded?" mapoff":""),children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:M.length})," ",te]}),t.jsx("span",{className:"dot",children:"·"}),a.mapFolded&&t.jsx(Fr,{variant:"compact",mapToggle:!0}),t.jsxs("span",{className:"ctx",children:[a.mapFolded?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),fe.map(q=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:$=>{$.stopPropagation(),q.off()},children:[q.lib,t.jsx("i",{children:"×"})]},q.k)),b==="ops"&&M.length>0&&" — "+n.edSplit(M.length-Q,Q)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([q,$])=>t.jsxs("button",{type:"button","data-d":q,"aria-pressed":a.dens===q||q==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:q}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:$})]},q))}),(i.showFunnel||b==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":h==="open",onClick:()=>{S("open"),v(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":h==="closed",onClick:()=>{S("closed"),v(new Set)},children:n.foldAllLbl}),b==="ops"&&t.jsxs("button",{type:"button","aria-pressed":h===null,onClick:()=>{S(null),v(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||b==="ops")&&(()=>{var D;const q=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],$=((D=q.find(([Y])=>Y===y))==null?void 0:D[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":R,onClick:()=>L(Y=>!Y),children:[$,t.jsx("i",{children:"▾"})]}),R&&t.jsx("div",{className:"dolist",children:q.map(([Y,ne])=>t.jsx("button",{type:"button","aria-pressed":y===Y,onClick:()=>{T(Y),L(!1)},children:ne},Y))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:q=>r({type:"sort",key:q.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([q,$])=>t.jsx("option",{value:q,children:$},q))})]}),i.showChain&&K.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:K.map(q=>q.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(K.length):n.chainAll(K.length)]}),a.mapFolded&&t.jsx(Or,{compact:!0})]}),t.jsx(ql,{}),O>0&&!a.filters.signalOnly&&!F&&t.jsxs("div",{className:"sigstrip"+(W?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(O)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!W,title:W?n.boxExpand:n.boxCollapse,onClick:()=>V(q=>{try{localStorage.setItem(G,q?"0":"1")}catch{}return!q}),children:W?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>U(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(C?z:z.slice(0,12)).map(q=>{const $=je(q);return $?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(Ua($,x),Ht($,x)),onClick:()=>{d(q.id),r({type:"popup",id:q.id})},children:[t.jsx("b",{children:q.name}),t.jsxs("i",{children:[$.emoji," ",wa($,x)]}),t.jsx("em",{children:Ht($,x)})]},"sg-"+q.id):null}),!C&&z.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>A(!0),children:n.sigStripMore(z.length-12)})]})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),xe("country",n.colCountry),xe("name",n.colCompany),xe("amount",n.colAmount,"h-amt",!0),xe("stage",n.colStage,"h-stade"),xe("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[xe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),xe("memo",n.colMemo)]}),i.pipe&&xe("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(M.length?"":" list-empty"),children:[Z?Z.map(([q,$])=>t.jsxs(m.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:tt(q)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Ue(q,x)}),t.jsx("div",{className:"s",children:n.grpCount($.filter(D=>!qe(D)).length,$.length)})]})]}),H($,q)]},q)):H(M,"pt"+a.ptab),f.loading&&!u.length&&t.jsx(Il,{}),!M.length&&!(f.loading&&!u.length)&&(i.pipe?t.jsx($l,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const q=Z||[["pt"+a.ptab,M]];let $=0,D=0;for(const[ne,X]of q){D+=X.length;let se=a.shown[ne]||p(ne);X.length-se<=4&&(se=X.length),$+=Math.min(X.length,se)}const Y=D-$;return Y<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>q.forEach(([ne,X])=>r({type:"more",group:ne,by:X.length,base:p(ne)})),children:[t.jsx("span",{className:"more-label",children:n.more(Y,Y)}),t.jsx("span",{className:"more-meta",children:n.moreMeta($,D)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}})]})}function Zn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function _l(e,a){const r=Go(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Ul(e,a){const n=[a.head.split("|").map(Zn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",_l(i,a.plabels),Ct(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Zn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Vl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Hl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function $e({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Wl({o:e,qa:a}){const{t:r,lang:n,fund:i}=B(),o=(e.cribleStatus||"").trim().toUpperCase()||(Ct(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Qe(e),s=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx($e,{k:r.cdSector,v:e.sector}),t.jsx($e,{k:r.cdStage,v:e.stage}),t.jsx($e,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx($e,{k:r.cdSite,v:e.domain||e.website}),t.jsx($e,{k:r.cdName,v:e.contactName}),t.jsx($e,{k:r.cdEmail,v:e.contactEmail}),t.jsx($e,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx($e,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx($e,{k:r.cdAngle,v:e.angle}),t.jsx($e,{k:r.cdDetected,v:Hl(e.date,n)})]}),d.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,x])=>x).map(([x,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:c})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Yl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=B(),[s,d]=m.useState({}),x=25,c=m.useMemo(()=>n.slice(0,x),[n]);m.useEffect(()=>{c.length&&Ko(r,c.map(b=>b.name)).then(d)},[r,c]);const f=o.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),f&&typeof f.screened=="number"&&t.jsxs("p",{children:[u(f.screened)," ",e.funScreened(""),typeof f.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(f.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(f.screened/o.marketEstimate*100)," %"]})]})]}),c.map(b=>t.jsx(Wl,{o:b,qa:s[b.name]},b.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Gl=50;function Ja({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=B(),[o,l]=m.useState(null),[s,d]=m.useState(!1),[x,c]=m.useState(""),[f,u]=m.useState(0),[b,p]=m.useState(""),[g,v]=m.useState(!1),h=m.useRef(null);m.useEffect(()=>()=>{h.current&&window.clearInterval(h.current)},[]);const S=async y=>{d(!0),c("");const T=await a();if(d(!1),T.ok){l(T);return}if(T.busy){c(i.alertPreviewBusy);return}if(!y){c(i.alertPreviewFail);return}u(Gl),h.current=window.setInterval(()=>{u(R=>R>1?R-1:(h.current&&window.clearInterval(h.current),S(!1),0))},1e3)},j=async()=>{if(n||g)return;v(!0),p("");const y=await r();v(!1),p(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||f>0,onClick:()=>{S(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||g,onClick:()=>{j()},children:g?"…":i.alertTest})]}),f>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(f)}),x&&t.jsx("p",{className:"mnote warn",children:x}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const ct="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function ze({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=B();return mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Kl(){const{st:e}=B();switch(e.modal){case"chain":return t.jsx(Jl,{});case"space":return t.jsx(Xl,{});case"alert":return t.jsx(Zl,{});case"queue":return t.jsx(rc,{});case"export":return t.jsx(oc,{});case"plug":return t.jsx(lc,{});case"recharge":return t.jsx(dc,{});case"cover":return t.jsx(uc,{});case"dossier":return t.jsx(pc,{});case"crit":return t.jsx(mc,{});case"tuto":return t.jsx(fc,{});case"rdv":return t.jsx(Ql,{});case"memoalert":return t.jsx(ic,{});default:return null}}function Ql(){const{dispatch:e,fund:a}=B(),r=typeof document<"u"&&!!document.getElementById("rdv");return m.useEffect(()=>{r&&(e({type:"modal",modal:null}),ts())},[r,e]),r?null:t.jsx(Xo,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Jl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s,caps:d,memoQueued:x,doAnalyse:c}=B(),f=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,p=u[b],g=b>=u.length;return mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:g?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(g?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:g||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[ft(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(Ke(p.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ue(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:At(p.amountEur,i)})]}),je(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(rt,{o:p,lg:!0})," ",t.jsx(na,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),f&&qe(p)&&t.jsxs("div",{className:"vbox",style:{"--c":et(p)==="retenu"?"var(--brand)":et(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:et(p)==="retenu"?"✓ "+n.kept:et(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!g&&p&&d.pipe&&ke(p)===1&&!x.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!g&&p&&!(f&&qe(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(g?{type:"modal",modal:null}:{type:"chainNext"}),children:g?n.closeBtn:n.skip})]})]})})}),document.body)}function Xl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=B(),o=i==="client",l=m.useMemo(()=>o?r.filter(f=>qe(f)):[],[r,o]),s=m.useMemo(()=>Ha(l.filter(f=>et(f)==="retenu"),{key:"signal",dir:-1}),[l]),d=m.useMemo(()=>l.filter(f=>et(f)==="ecarte"),[l]),x=e.spaceTab==="retenu"?s:d,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(ze,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(f=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof f.score=="number"&&f.score>0?f.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:f.name}),t.jsx("div",{className:"rr",children:f.reasoning||f.tagline||""})]})]},f.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Zl(){const{mode:e}=B();return e==="client"||e==="apercu"?t.jsx(ec,{}):t.jsx(nc,{})}function ec(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=B(),[o,l]=m.useState("d"),s=i!=="client";return t.jsxs(ze,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(tc,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(ac,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(Ur,{})]})}function tc({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[s,d]=m.useState(!1),[x,c]=m.useState(0);m.useEffect(()=>{let p=!0;return d(!1),fn(a).then(g=>{p&&(g?l(g):d(!0))}),()=>{p=!1}},[a,x]);const f=p=>{r||fn(a,p).then(g=>{if(!g){i(e.actErr);return}l(g),g.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),b=p=>{const g=o.sections||e.alertSec.map(([v])=>v);f({sections:u(p)?g.filter(v=>v!==p):[...g,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,g])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>b(p)}),t.jsxs("span",{children:[g,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ja,{label:e.alertPreview,readOnly:r,onPreview:()=>ii(a),onTest:()=>oi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function ac({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[s,d]=m.useState(!1),[x,c]=m.useState(0);m.useEffect(()=>{let p=!0;return d(!1),xn(a).then(g=>{p&&(g?l(g):d(!0))}),()=>{p=!1}},[a,x]);const f=p=>{r||xn(a,p).then(g=>{if(!g){i(e.actErr);return}l(g),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,b=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>f({dow:Number(p.target.value)}),children:e.alertDow.map((p,g)=>t.jsx("option",{value:g,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ja,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>li(a),onTest:()=>si(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ur(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=B(),[l,s]=m.useState(o||""),[d,x]=m.useState(!1),[c,f]=m.useState(!1);m.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,b=m.useMemo(()=>n.filter(h=>je(h)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(l)||c)){f(!0);try{await fetch(`${Ia}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{f(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>Ue(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>ft(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([h,S])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:S}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:h=>s(h.target.value),onKeyDown:h=>{h.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function nc(){const{t:e}=B();return t.jsx(ze,{title:e.alertTitle,icon:"🔔",children:t.jsx(Ur,{})})}function rc(){var N,E;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:s,dispatch:d,liveMemos:x}=B(),[c,f]=m.useState(null),[u,b]=m.useState([]),[p,g]=m.useState(0),v=n==="client",h=m.useMemo(()=>{const k=new Map;return i.forEach(M=>{const z=(M.name||"").trim().toLowerCase();z&&!k.has(z)&&k.set(z,M)}),k},[i]);m.useEffect(()=>{let k=!0;return(async()=>{const[M,z]=await Promise.all([Ba(r),nr(a)]);k&&(M&&f(M),b(z))})(),()=>{k=!1}},[a,r,p]);const S=(c==null?void 0:c.per_day)??0,j=((N=c==null?void 0:c.analyzed_today)==null?void 0:N.length)??0,y=c==null?void 0:c.offre,T=(c==null?void 0:c.pool_meta)||[],R=m.useMemo(()=>{const k=new Map;for(const M of(c==null?void 0:c.scheduled)||[])for(const z of M.names||[])k.has(z)||k.set(z,{label:M.day_label,date:M.date});return k},[c==null?void 0:c.scheduled]),L=(c==null?void 0:c.in_progress)||[];return t.jsxs(ze,{title:e.queueTitle,wide:!0,children:[y&&t.jsxs("div",{className:"qoffre"+(y.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:y.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:y.delai})]}),t.jsx("span",{className:"osp"}),y.rythme>0?t.jsx("span",{className:"or",children:e.qRate(y.rythme)}):y.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(y.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(j,j+(((E=c==null?void 0:c.pool_order)==null?void 0:E.length)??0))}})}),y&&t.jsxs("div",{className:"qeta",children:[y.file===0?e.qEtaDone:y.rythme<=0?e.qEtaPaused:e.qEta(y.file,y.rythme,y.jours_restants),y.en_retard&&t.jsxs("em",{children:[" ",e.qLate(y.delai,y.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(S)}),(y==null?void 0:y.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(L.length>0||x.items.some(k=>k.status==="boot"||k.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[x.items.filter(k=>k.status==="boot"||k.status==="running"||k.status==="error").map(k=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:k.name}),t.jsx("span",{className:"qd",children:k.memoType||""}),t.jsx(kt,{item:k,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+k.name)),L.filter(k=>!x.liveOf(k.name)).map(k=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:k.name}),t.jsxs("span",{className:"qd",children:[k.memo_type||"",k.age_min?` · ${Math.round(k.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:k.state||""})]},"ip-"+k.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(k=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:k.company}),t.jsxs("span",{className:"qd",children:[k.memo_type,typeof k.est_min=="number"?` · ~${k.est_min} min`:""]}),t.jsx("span",{className:"qt",children:k.status}),k.url&&t.jsx("a",{className:"qgo",href:k.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),v&&k.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{mn(a,k.company,"retry").then(()=>g(M=>M+1))},children:e.queueRetry}),v&&k.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{mn(a,k.company,"delete").then(()=>g(M=>M+1))},children:e.queueDelete})]},k.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(T.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[T.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),T.map((k,M)=>{const z=R.get(k.name),O=h.get((k.name||"").trim().toLowerCase()),C=x.liveOf(k.name),A=!!(O&&l.has(O.id))||!!(C&&(C.status==="boot"||C.status==="running")),F=!!(O&&ke(O)===1&&!O.memoUrl)&&!C;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",M+1]}),z?t.jsx("span",{className:"qwhen"+(z.label==="demain"?" soon":""),children:z.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:k.name}),k.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof k.score=="number"&&t.jsx("span",{className:"qs2",children:k.score}),C&&(C.status==="boot"||C.status==="running")&&t.jsx(kt,{item:C,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),F&&(s.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>d({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:A,onClick:()=>{o(O),g(U=>U+1)},children:A?e.actAnalyseQueued:e.actAnalyse})),k.excerpt&&t.jsx("span",{className:"qex",children:k.excerpt})]},k.name+":"+M)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([k,M])=>t.jsxs("li",{children:[t.jsx("b",{children:k})," — ",M]},k))})]})}function oc(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=B(),s=`${ct}/cibles/list.csv?token=${a}`,d=`${ct}/cibles/list.json?token=${a}`,x=`${ct}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,f=v=>{var h;(h=navigator.clipboard)==null||h.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:x,href:x}],b=!i.lockActions&&n.length>0,p=()=>{Vl(Ul(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([h])=>h===v)||["",""])[1]})),r(e.exportViewDone(n.length))},g=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(ze,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:g,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:h,href:S})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>f(h),children:e.exportCopy}),S&&t.jsx("a",{className:"exb",href:S,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function ic(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=B(),o=i!=="client",[l,s]=m.useState(null),[d,x]=m.useState(!1),[c,f]=m.useState(0),[u,b]=m.useState(!1);m.useEffect(()=>{let h=!0;return x(!1),un(a).then(S=>{h&&(S?s(S):x(!0))}),()=>{h=!1}},[a,c]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=h=>{if(o||!l)return;const S={enabled:h.enabled??!!l.enabled,email:h.email??(l.email||""),sections:h.sections??p()};b(!0),un(a,S).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(d)return t.jsx(ze,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(h=>h+1),children:e.retry})]})});if(!l)return t.jsx(ze,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=p();return t.jsxs(ze,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(sc,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>g({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,S])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[h],disabled:o||u,onChange:()=>g({sections:{...v,[h]:!v[h]}})}),t.jsx("span",{children:S})]},h))}),t.jsx(Ja,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>Jo(a,v),onTest:()=>Qo(a,v)})]})}function sc({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:x=>l(x.target.value),onKeyDown:x=>{x.key==="Enter"&&s&&d&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!d,onClick:()=>i(o.trim()),children:n})]})]})}function lc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=B(),[o,l]=m.useState(null),[s,d]=m.useState(!1),[x,c]=m.useState(null),[f,u]=m.useState(""),[b,p]=m.useState(0);m.useEffect(()=>{let j=!0;return d(!1),ka(a).then(y=>{j&&(y?l({configured:y.configured,url_hint:y.url_hint}):d(!0))}),ti(a).then(y=>{j&&c(y)}),()=>{j=!1}},[a,b]);const g=(j,y)=>{i&&ka(a,j).then(T=>{if(!T||T.ok===!1){n(e.actErr);return}j.test&&T.sent===!1?n(e.plugTestThrottled):r(y),p(R=>R+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),S=`curl -X POST ${ct}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(ze,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(j=>j+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:f,disabled:!i,onChange:j=>u(j.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!f.trim(),onClick:()=>g({url:f.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(cc,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:S}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(S).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function cc(){const{t:e,token:a,lang:r}=B(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[s,d]=m.useState(null),[x,c]=m.useState(null),[f,u]=m.useState(!1),[b,p]=m.useState(!1),[g,v]=m.useState(null),[h,S]=m.useState(null),[j,y]=m.useState(null),T=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{ka(a).then(z=>{S(z&&z.configured?z.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{d(null),c(null),u(!1),v(null);try{const z=JSON.parse(localStorage.getItem(T)||"null");y(z&&Date.now()-Date.parse(z.t)<24*3600*1e3?z:null)}catch{y(null)}},[T]);const R=async()=>{l(!0),u(!1),v(null);const z=await ni(a,n);d(z),c(z.ok?n:null),l(!1)},L=m.useRef(!1),N=async()=>{if(L.current)return;L.current=!0,p(!0);const z=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let O;try{O=await ri(a,n,"webhook",void 0,z)}finally{L.current=!1}if(p(!1),u(!1),v(O),O.ok&&(O.pushed||0)>0){const C={t:new Date().toISOString(),n:O.pushed||0};y(C);try{localStorage.setItem(T,JSON.stringify(C))}catch{}}},E=s!=null&&s.ok&&s.ready||0,k=!!(s!=null&&s.ok)&&x===n&&E>0&&!!h&&!j,M=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:z=>i(z.target.value),children:e.plugBulkTabs.map(([z,O])=>t.jsx("option",{value:z,children:O},z))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{R()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(M,j.n)}),!j&&!!(s!=null&&s.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),k&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),k&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(E,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{N()},children:b?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),g&&(g.ok?g.replayed?t.jsx("p",{className:"mnote",children:g.pending?e.bulkPending:e.bulkReplayed}):(g.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:g.error||e.actErr}))]})}function dc(){const{t:e,data:a,lang:r}=B(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const x=await(await fetch(`${Ia}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(ze,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function pc(){const{t:e}=B();return t.jsx(ze,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Yl,{})})}function uc(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:s}=B(),[d,x]=m.useState(null),[c,f]=m.useState(!1);m.useEffect(()=>{let E=!0;if(o)return Ba(o).then(k=>{E&&k&&typeof k.per_day=="number"&&x(k.per_day)}),()=>{E=!1}},[o]);const[u,b]=m.useState(null);m.useEffect(()=>{if(!i)return;let E=!0;return ei(i).then(k=>{E&&b(k)}),()=>{E=!1}},[i]);const p=r.stats,g=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(E=>E.kind==="target"&&qe(E)).length,v=r.marketEstimate||0,h=v>0?Math.min(100,Math.round(g/v*100)):null,S=(p==null?void 0:p.window_days)||30,j=g>0?g/S:0,y=v>0?Math.max(0,v-g):0,R=v>0&&j>0&&g>=100?Math.round(y/j):null,L=E=>Math.round(E).toLocaleString(a==="en"?"en-US":"fr-FR"),N=E=>{c||!l||(f(!0),ai(i,E).then(k=>{if(f(!1),k===null){s(e.actErr);return}x(k),s(e.alertSaved)}))};return t.jsxs(ze,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(L(g))}),v>0&&t.jsx("span",{children:e.covOf(L(v))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),R!==null&&t.jsx("p",{className:"mnote",children:e.covEta(R)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(L(j))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((E,k)=>t.jsxs("tr",{className:E.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[E.code,E.geo?` · ${E.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof E.n=="number"?L(E.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:E.source}),E.elargi&&t.jsx("em",{children:e.covWide(String(E.demande||""))}),E.erreur&&t.jsx("em",{children:e.covMissing})]})]},k)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:L(u.total||v)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:L(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:L(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:L(p.shown)})," ",e.funShown]})]}),l&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(E=>t.jsx("button",{type:"button",className:d===E?"on":"",disabled:c,onClick:()=>N(E),children:E===0?"⏸":E},E))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function mc(){var h,S,j;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:s}=B(),d=n==="client",x=m.useMemo(()=>{const y=new Set;return a.forEach(T=>{T.angle&&y.add(T.angle)}),[...y]},[a]),[c,f]=m.useState(""),[u,b]=m.useState(""),[p,g]=m.useState(!1),v=async()=>{const y=c.trim();if(!(!y||p||!d)){g(!0),b("");try{const R=await(await fetch(`${ct}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(R.reply&&b(String(R.reply)),R.job_id){b(e.critChatRunning);const L=async()=>{const N=await fetch(`${ct}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:R.job_id})}).then(E=>E.json()).catch(()=>null);if(N&&N.done){b(String(N.reply||N.clarification||N.summary||"✓")),g(!1),N.applied&&i(e.alertSaved);return}setTimeout(()=>{L()},8e3)};setTimeout(()=>{L()},8e3),f("");return}f("")}finally{u.startsWith("⏳")||g(!1)}}};return t.jsxs(ze,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((h=o.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((S=o==null?void 0:o.angles)!=null&&S.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var T,R;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((T=y.look)!=null&&T.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(L=>t.jsx("li",{children:L},L))})]}),!!((R=y.out)!=null&&R.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(L=>t.jsx("li",{children:L},L))})]})]})]},y.title)})]}),!!((j=o==null?void 0:o.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:x.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!d||p,onChange:y=>f(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!d||p||!c.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Zo,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,T])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Br[y]||"v-cons"),children:y}),t.jsx("span",{children:T})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,T])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",T]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function fc(){const{t:e,dispatch:a,startTour:r}=B(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(ze,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const Vr="atl2:mapfold",xc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Vr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},hc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},Hr=m.createContext(null),B=()=>{const e=m.useContext(Hr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function rt({o:e,lg:a}){const{lang:r}=B(),n=je(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:wa(n,r),children:[n.emoji," ",wa(n,r)]}):null}function na({o:e,src:a}){const{lang:r,t:n}=B(),i=je(e);if(!i)return null;const o=mi(i),l=fi(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Ua(i,r))+" · "+n.win7(Ht(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,d)=>t.jsx("i",{className:d<o?"on":""},d))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Wr({o:e}){const{lang:a}=B(),r=ui(e.cc),n=e.cc?ft(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const er="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",gc=!1;function bc(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Yr=e=>`atl2:tour:${e||"anon"}`;function vc(e){try{return localStorage.getItem(Yr(e))==="1"}catch{return!0}}function tr(e){try{localStorage.setItem(Yr(e),"1")}catch{}}function yc(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Sc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var Za;const{lang:l}=ci(),s=Ci[l],d=Pi(e,l,a),[x,c]=m.useReducer(Bi,void 0,()=>Ii((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?hc():xc()),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),f=m.useRef(!0);m.useEffect(()=>{if(f.current){f.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Vr,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e,a]);const u=m.useRef(o);u.current=o,m.useEffect(()=>{var w;(w=u.current)==null||w.call(u,x.filters)},[x.filters]);const[b,p]=m.useState(null),[g,v]=m.useState(null),[h,S]=m.useState({kept:0,dropped:0}),[j,y]=m.useState(!1),[T,R]=m.useState(""),[L,N]=m.useState(!1),[E,k]=m.useState(null),[M,z]=m.useState(!1),[O,C]=m.useState(!1),[,A]=m.useState(0),F=()=>A(w=>w+1),U=m.useRef([]),G=m.useRef(new Set),W=m.useRef(new Set),[V,K]=m.useState([]),[Q,te]=m.useState([]),[ee,fe]=m.useState(0),ge=m.useRef(new Map),xe=m.useRef(null),{mode:Z}=d,ie=m.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),ae=ie.pipe,H=d.session.token||"",J=Z==="client"&&!e;m.useEffect(()=>{if(!H||!ae)return;let w=!0;const _=async()=>{const ye=await xi(H);!w||!ye||(te(ye.runs),fe(Date.now()/1e3-ye.now),K(Me=>Me.filter(ia=>!ye.runs.some(Je=>Ye(Je.company)===Ye(ia.name)))))};_();const I=V.length>0||Q.some(ye=>ye.status==="running"),oe=window.setInterval(()=>{_()},I?8e3:25e3);return()=>{w=!1,window.clearInterval(oe)}},[H,ae,V.length,Q.some(w=>w.status==="running")]);const ue=m.useMemo(()=>{const w=[],_=new Set;for(const I of V){const oe=Ye(I.name);!oe||_.has(oe)||(_.add(oe),w.push({name:I.name,id:I.id,status:"boot",started:I.started,estMin:I.estMin,memoType:"instant"}))}for(const I of Q){const oe=Ye(I.company);if(!oe||_.has(oe))continue;_.add(oe);const ye=I.status==="error"?"error":I.status==="done"?"done":"running";w.push({name:I.company,status:ye,started:I.started||0,estMin:I.est_min||(I.memo_type==="detailed"?40:15),url:I.url,error:I.error,memoType:I.memo_type})}return w},[V,Q]),q=w=>ue.find(_=>Ye(_.name)===Ye(w))||null,$=(w,_)=>{K(I=>I.some(oe=>Ye(oe.name)===Ye(w.name))?I:[...I,{name:w.name,id:w.id,started:Date.now()/1e3,estMin:_==="detailed"?40:15}]),G.current.add(w.id),F()};m.useEffect(()=>{if(document.querySelector(`link[href="${er}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=er,document.head.appendChild(w)},[]);const D=(w,_=!1)=>{R(w),N(_),xe.current&&clearTimeout(xe.current),xe.current=setTimeout(()=>R(""),_?4200:2400)},Y=w=>D(w,!0),ne=m.useMemo(()=>{const w=new Map;return d.dossiers.forEach(_=>{_.id&&w.set(_.id,_)}),w},[d.dossiers]),X=m.useMemo(()=>d.dossiers.filter(w=>cr(w,x,ae)),[d.dossiers,x,ae]),se=m.useRef(!1);m.useEffect(()=>{if(se.current||e||d.loading||!d.dossiers.length)return;if(!ie.showFunnel||vc(d.session.token||"")){se.current=!0;return}se.current=!0;const w=window.setTimeout(()=>{tr(d.session.token||""),z(!0)},700);return()=>window.clearTimeout(w)},[e,d.loading,d.dossiers.length,ie.showFunnel,d.session.token]);const Ee=m.useMemo(()=>d.dossiers.filter(w=>_i(w,x,ae,d.favIds)),[d.dossiers,x,ae,d.favIds]),ce=m.useMemo(()=>di(X,d.favIds),[X,d.favIds]),Le=m.useMemo(()=>{const w=xr(d.dossiers);return w?Ke(w)===0?s.tourToday:hr(w,l):s.tourNoRun},[d.dossiers,s,l]),Ve=m.useMemo(()=>d.dossiers.some(w=>!!w.memoUrl||!!w.summary||dt(w)),[d.dossiers]),[it,xt]=m.useState(!1);m.useEffect(()=>{if(d.loading){xt(!1);return}if(d.dossiers.length>0||d.error){xt(!0);return}const w=window.setTimeout(()=>xt(!0),6e3);return()=>window.clearTimeout(w)},[d.loading,d.dossiers.length,d.error]);const zt=(d.marketEstimate||0)>0||typeof((Za=d.stats)==null?void 0:Za.screened)=="number"&&d.stats.screened>0,Tt=m.useMemo(()=>[1,0,2,4,5,3].find(w=>(ce[w]||0)>0)??0,[ce]),Ie=_a.find(w=>w.key===x.continent),ra=x.continent==="monde"?s.contWorld:(l==="fr"?Ie==null?void 0:Ie.fr:Ie==null?void 0:Ie.en)||"";m.useEffect(()=>{const w=_=>{var oe;const I=(((oe=_.detail)==null?void 0:oe.name)||"").trim();I&&qt(null,I)};return window.addEventListener("ppmap:evaluate",w),()=>window.removeEventListener("ppmap:evaluate",w)}),m.useEffect(()=>{const w=oe=>{const ye=String(oe||"").trim();ye&&c({type:"filters",patch:{sector:[ye]}})},_=oe=>{var ye;return w((ye=oe.detail)==null?void 0:ye.sector)},I=oe=>{oe.data&&oe.data.type==="pp-filter"&&w(oe.data.sector)};return window.addEventListener("ppmap:filter",_),window.addEventListener("message",I),()=>{window.removeEventListener("ppmap:filter",_),window.removeEventListener("message",I)}},[]);const qt=(w,_)=>{const I=((w==null?void 0:w.name)||_||"").trim();if(!J){v({kicker:I});return}!I||j||(y(!0),(async()=>{try{let oe=I;const ye=((w==null?void 0:w.website)||(w==null?void 0:w.domain)||"").trim();if(ye)oe=ye;else try{const we=await hi(I);if(we!=null&&we.website)oe=we.website;else if(((we==null?void 0:we.candidates)||[]).length===1)oe=we.candidates[0].url;else if(((we==null?void 0:we.candidates)||[]).length>1){U.current=[{name:I,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(we.candidates||[]).slice(0,5)},...U.current].slice(0,8),F();return}}catch{}const Me=await or(H,oe,"atelier2"),ia={name:Me.company||I,verdict:Me.verdict,reason:Me.reason||"",remaining:Me.remaining??null};U.current=[ia,...U.current].slice(0,8),Me.verdict==="kept"&&S(we=>({...we,kept:we.kept+1})),Me.verdict==="ruled_out"&&S(we=>({...we,dropped:we.dropped+1}));const Je=w||d.dossiers.find(we=>(we.name||"").toLowerCase()===I.toLowerCase());Je&&(Me.verdict==="kept"?Je.verdict=Je.verdict||"MATCH":Me.verdict==="ruled_out"&&(Je.verdict="NO MATCH"),Me.reason&&(Je.reasoning=Me.reason)),F()}finally{y(!1)}})())},P=w=>{if(!J){v({kicker:w.name});return}$(w,"instant"),ht(H,"fast_request",w.name||"",""),D(s.memoInstantSent(w.name))},le=w=>ge.current.get(w.id)??d.thumbs.get((w.name||"").trim().toLowerCase()),pe=(w,_)=>c({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:_}}),Ne=async(w,_,I)=>{const oe=w.ceoStatus||"";w.ceoStatus=_,F();const ye=await la(H,{status:_,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(I==null?void 0:I.note)!==void 0?{note:I.note}:{},...I!=null&&I.via?{via:I.via}:{}});return ye.ok?ye.skipped?(w.ceoStatus=oe,F(),Y(s.actNotPersisted),!1):((I==null?void 0:I.undo)!==!1&&pe(w,oe),I!=null&&I.msg&&D(I.msg),(_==="Validé"||_==="Écarté")&&!w.ceoNote&&(I==null?void 0:I.note)===void 0&&k({o:w,yes:_==="Validé"}),!0):(w.ceoStatus=oe,F(),Y(s.actErr),!1)},He=async(w,_)=>{const I=await la(H,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:_,via:"note"});return!I.ok||I.skipped?(Y(I.skipped?s.actNotPersisted:s.actErr),!1):(w.ceoNote=_,F(),!0)},Se=m.useRef(new Map),he=w=>Se.current.has(w.id)?Se.current.get(w.id):d.stages.get((w.name||"").trim().toLowerCase()),Re=(w,_)=>{Se.current.set(w.id,_),F()},oa=(w,_)=>{J&&Ne(w,_?"Validé":"Écarté",{msg:_?s.decidedYes(w.name):s.decidedNo(w.name)})},Lt=w=>{J&&Ne(w,"À trancher",{msg:s.promoted(w.name)})},Gr=w=>{J&&(async()=>{const _=w.ceoStatus||"";w.ceoStatus="Retenu",F();const I=await la(H,{status:"Retenu",check_id:w.checkId,company:w.name});if(!I.ok||I.skipped){w.ceoStatus=_,F(),Y(I.skipped?s.actNotPersisted:s.actErr);return}pe(w,_),D(s.repeched(w.name))})()},Kr=()=>{const w=x.undo[x.undo.length-1];if(!w){D(s.undoNone);return}const _=ne.get(w.id);if(!_){c({type:"undoPop"}),D(s.undoNone);return}let I=w.prevCeoStatus;if(!I)if((_.verdict||"").toUpperCase().includes("CALL"))I="À trancher";else{D(s.undoLockedTitle);return}(async()=>await Ne(_,I,{undo:!1})&&(c({type:"undoPop"}),_.ceoStatus=w.prevCeoStatus,F(),D(s.undoDone(_.name))))()},Qr=w=>{J&&(W.current.add(w.id),F(),(async()=>{const _=await gi(H,w.name,"email");if(!_||_.ok===!1){W.current.delete(w.id),F(),Y(s.actErr);return}ht(H,"approach",w.name||"",""),D(s.actApproachSent)})())},Jr=(w,_)=>{J&&(async()=>{if(!(await ht(H,_?"yes":"no",w.name||"","")).ok){Y(s.actErr);return}ge.current.set(w.id,_?"yes":"no"),F(),D(_?s.thumbUpDone:s.thumbDnDone)})()},Xr=w=>{!J||!dt(w)||($(w,"detailed"),ht(H,"detailed_request",w.name||"",""),D(s.memoDeepSent(w.name)))},Zr=w=>{const _=new Set(d.favIds),I=_.has(w.id);I?_.delete(w.id):_.add(w.id),d.setFavIds(_),J&&bi(H,{id:w.id,co:w.name},I)},eo=()=>{!J||O||window.confirm(s.identSyncConfirm)&&(C(!0),(async()=>{const w=await vi(H);C(!1),w?D(s.identSyncDone):Y(s.actErr)})())},Xa=/proplace/i.test(d.fund||""),to=w=>{!J||!Xa||(ht(H,"onboard_request",w.name||"",""),D(s.onboardSent(w.name)))},ao={st:x,dispatch:c,t:s,lang:l,mode:Z,caps:ie,pipe:ae,token:H,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:Gr,thumbOf:le,canWrite:J,commitStatus:Ne,saveNote:He,stageOf:he,setStage:Re,flashErr:Y,startTour:()=>z(!0),dossiers:d.dossiers,scopedAll:X,scoped:Ee,counts:ce,byId:ne,contName:ra,favIds:d.favIds,toggleFav:Zr,askEvaluate:qt,doAnalyse:P,doDecide:oa,doPromote:Lt,doApproach:Qr,doThumb:Jr,doDeep:Xr,doUndo:Kr,doSync:eo,doOnboard:to,outbound:Xa,memoQueued:G.current,liveMemos:{items:ue,serverOff:ee,liveOf:q},approachDone:W.current,sessTally:h,evalCards:U.current,evalBusy:j,markRow:p,markedId:b,flash:D};m.useEffect(()=>{const w=_=>{_.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]);const no=w=>H?t.jsx(Vi,{token:H,children:w}):t.jsx(t.Fragment,{children:w});return t.jsx(Hr.Provider,{value:ao,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Ti}),ie.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:mr,children:Ya}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Wt}`,children:Wt})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),no(t.jsxs("div",{className:"app"+(ae?" pipe":"")+(H?" has-thesis":""),children:[ie.showTicker&&t.jsx(Ce,{name:"live",children:t.jsxs("div",{className:"live-stack"+(H?" live-stack--cibles":""),children:[t.jsx(Ji,{}),!!H&&t.jsx(Hi,{})]})}),ie.showIdent&&t.jsx(Ce,{name:"identite",children:t.jsx(fs,{})}),!1,!!H&&t.jsx(Ce,{name:"brief",children:t.jsx(Wi,{})}),gc,ie.showMorning&&t.jsx(Ce,{name:"matin",children:t.jsx(ms,{})}),t.jsx(Ce,{name:"mesure",children:t.jsx(os,{})}),ie.showFunnel&&t.jsx(Ce,{name:"entonnoir",children:t.jsx(wc,{})}),ie.showFunnel&&t.jsx(Ce,{name:"tunnel",children:t.jsx(xs,{})}),ie.showFunnel&&t.jsx(Ce,{name:"tuto",children:t.jsx(hs,{})}),!x.mapFolded&&t.jsx(Ce,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Fr,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[t.jsx(ml,{}),t.jsx(Or,{})]})]})}),ie.showDemand&&ae&&t.jsx(Ce,{name:"direct",children:t.jsx(Ni,{items:ue,serverOff:ee,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),ie.showDemand&&t.jsx(Ce,{name:"evaluation",children:t.jsx(vl,{})}),ie.showDemand&&x.memoConsole&&t.jsx(Ce,{name:"console",children:t.jsx(wl,{})}),t.jsx(Ce,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(Bl,{})}),d.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:s.retry})]})]})),x.popupId&&t.jsx(Ce,{name:"fiche",children:t.jsx(zl,{})}),t.jsx(Ce,{name:"modales",children:t.jsx(Kl,{})}),t.jsx(ns,{}),E&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:E.o.name}),t.jsx(ds,{placeholder:E.yes?s.whyYesPh:s.whyNoPh,onDone:w=>{const _=E.o;k(null),w&&He(_,w).then(I=>{I&&D(s.csNoteSaved)})}})]}),M&&it&&t.jsx(us,{steps:yc(s,Le,Ve,Tt,zt),onClose:()=>{z(!1),tr(H)}}),t.jsx(bc,{}),T&&t.jsx("div",{className:"flash on"+(L?" err":""),children:T}),g&&t.jsx(pi,{variant:"acquirer",initialCompany:ar().co,initialWebsite:ar().site,onClose:()=>v(null)})]})})}function wc(){const{t:e}=B(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function ar(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function kc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Wr as FlagCell,rt as SigBadge,na as SigWin,Sc as default,kc as fmtShort,B as useV2};
