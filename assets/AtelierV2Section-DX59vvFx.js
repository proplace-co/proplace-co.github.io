...
/* LA CARTE MARCHÉ repliée dans le séparateur de moteur */
.atl2 .grp-card{padding:10px 14px;background:var(--panel2);
  border-bottom:1px solid var(--line)}
.atl2 .grp-card img{display:block;max-width:640px;width:100%;
  border:1px solid var(--line);border-radius:8px}
...
`,wo=vo+yo;function Zt(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function ko(){const e=Zt("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function jo(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=ko();return r==="0"?"client":r==="1"||Zt("embed")==="1"&&Zt("chrome")==="1"?"apercu":"client"}const No={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},So=e=>No[e],Ie=e=>Object.assign(e,{continent:Sr(e.cc)});function _t(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Co=60*60*1e3;function Eo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Co?null:a}catch{return null}}function ht(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const zo=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function To(e,a,r="default"){const n=r!=="default",o=h.useMemo(()=>e||n?{mode:"anon"}:xr(),[e,n]),i=h.useMemo(()=>n?"visiteur":jo(e,o),[e,o,n]),c=h.useMemo(()=>So(i),[i]),s=i!=="visiteur",p=zo(r),[f,d]=h.useState([]),[l,m]=h.useState(""),[g,u]=h.useState(null),[v,b]=h.useState(null),[x,y]=h.useState(null),[N,w]=h.useState(()=>new Map),[S,C]=h.useState(()=>new Map),[L,F]=h.useState(""),[j,M]=h.useState(new Set),[q,R]=h.useState(null),[z,A]=h.useState(!0),[k,T]=h.useState(!1),[I,B]=h.useState(0),[W,he]=h.useState(0),_=h.useRef(0),le=h.useMemo(()=>{var K;if(i!=="client")return"";try{return((K=hr())==null?void 0:K.email)||""}catch{return""}},[i]);h.useEffect(()=>{const K=++_.current;let U=!0;const Q=()=>U&&K===_.current,H=(s&&o.token?o.token:"pub:"+a)+(p?":"+p:""),re=Eo(H);return re?(d(re.objs.map(Ie)),re.fund&&m(re.fund),u(re.marketEstimate??null),b(re.criteria??null),y(re.stats??null),F(re.generatedAt||""),A(!1)):A(!0),(async()=>{try{if(r==="ops"){const ne=await It(),pe=((ne==null?void 0:ne.recent_ops)||[]).filter(ee=>gr((ee.company_name||ee.title||"").trim())).map(ee=>Bt(ee,a)).filter(ee=>!!ee);try{const ee=await br(),oe=vr(ee),Ce=((ee==null?void 0:ee.date)||"").slice(0,10);if(oe.length&&Ce){const G=new Set;for(const de of pe){if((de.date||"").slice(0,10)!==Ce)continue;const ge=(de.name||"").trim().toLowerCase();if(!(ge.length<3)){for(let fe=0;fe<oe.length;fe++)if(!G.has(fe)&&oe[fe].t.includes(ge)){G.add(fe),de.decryptHtml=oe[fe].html;break}}}}}catch{}if(!Q())return;d(pe.map(Ie)),ht(H,{objs:pe})}else if(typeof r=="object"){const pe=(await Aa()||[]).filter(oe=>(oe.slug||"")===r.research).map(oe=>La(oe,a)).filter(oe=>!!oe),ee=_t(await Ra(pe,a));if(!Q())return;d(ee.map(Ie)),ht(H,{objs:ee})}else if(s&&o.token){const ne=yr(o.token),pe=It(),ee=wr(o.token),oe=kr(o.token),Ce=jr(o.token),G=await ne;let de=G?G.targets:[];Q()&&G&&(m(G.fund||""),u(G.marketEstimate??null),b(G.criteria??null),y(G.stats??null),F(G.generatedAt||""),d(de.map(Ie)),A(!1),T(!1));const[ge,fe,Le,O]=await Promise.all([pe,ee,oe,Ce]),J=((ge==null?void 0:ge.recent_ops)||[]).map(X=>Bt(X,a)).filter(X=>!!X);if(de=[...de,...J],!Q())return;d(de.map(Ie));const ae=new Set;for(const X of fe){const Ee=(X.id||X.co||"").toString().trim().toLowerCase();Ee&&ae.add(Ee.startsWith("t:")?Ee:"t:"+Ee)}M(ae),w(Le),C(O),G&&ht(H,{fund:G.fund,marketEstimate:G.marketEstimate,criteria:G.criteria,stats:G.stats,generatedAt:G.generatedAt,objs:de})}else{const ne=Nr(),pe=Aa(),ee=It(),oe=await ne;Q()&&oe.length&&(d(_t(oe).map(Ie)),A(!1),T(!1));const[Ce,G]=await Promise.all([pe,ee]),de=(Ce||[]).map(O=>La(O,a)).filter(O=>!!O),ge=await Ra(de,a),fe=((G==null?void 0:G.recent_ops)||[]).map(O=>Bt(O,a)).filter(O=>!!O),Le=_t([...oe,...ge,...fe]);if(!Q())return;d(Le.map(Ie)),ht(H,{objs:Le})}Q()&&T(!1)}catch{Q()&&!re&&T(!0)}finally{Q()&&A(!1)}})(),()=>{U=!1}},[s,o.token,a,I,p]),h.useEffect(()=>{if(!c.showCredits||!le){R(null);return}let K=!0;return(async()=>{try{const U=await fetch(`${xa}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:le})});if(!U.ok)return;const Q=await U.json();K&&Q&&Q.ok!==!1&&R(Q)}catch{}})(),()=>{K=!1}},[c.showCredits,le,W]);const V=h.useCallback(K=>M(new Set(K)),[]);return{session:o,mode:i,caps:c,fund:l,email:le,marketEstimate:g,generatedAt:L,criteria:v,stats:x,thumbs:N,stages:S,dossiers:f,favIds:j,setFavIds:V,credits:q,reloadCredits:()=>he(K=>K+1),loading:z,error:k,refresh:()=>B(K=>K+1)}}const Sn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Ao=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Sn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Lo(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Sn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Cn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Cn=40;function wa(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!xe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(ha(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(Qe(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&$e(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(o))return!1}return!0}function En(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:wa(e,a.filters,r)}function Ro(e,a,r,n){return!(!En(e,a,r)||r&&!Cr(e,a.ptab,n))}function ka(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-Qe(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"signal":{const i=xe(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const c=n(o),s=n(i);return c<s?-a.dir:c>s?a.dir:(o.name||"").localeCompare(i.name||"")})}function Mo(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i}=P(),c=h.useMemo(()=>{const p=(a.filters.day||"").slice(0,10),f=g=>!(!i&&a.continent!=="monde"&&g.continent!==a.continent||p&&(g.date||"").slice(0,10)!==p),d=e.filter(g=>f(g)&&xe(g)),l=e.filter(g=>f(g)&&g.kind==="op"&&!xe(g)&&(p?!0:Qe(g.date)<=7)),m=p||new Date().toISOString().slice(0,10);return l.sort((g,u)=>{const v=(g.date||"").slice(0,10)===m?0:1,b=(u.date||"").slice(0,10)===m?0:1;return v!==b?v-b:(u.amountEur||0)-(g.amountEur||0)}),[...ka(d,{key:"signal",dir:-1}),...l].slice(0,48)},[e,a.continent,a.filters.day,i]),s=p=>c.map(f=>t.jsxs("button",{type:"button",className:"tk"+(Ne(f)?" spent":""),onClick:d=>{const l=d.currentTarget.getBoundingClientRect();n({type:"popup",id:f.id,anchor:{x:l.left+l.width/2,y:l.bottom}})},title:f.name+(f.tagline?" — "+f.tagline:""),children:[t.jsx(Ze,{o:f}),t.jsxs("span",{className:"who",children:[t.jsx(er,{o:f}),t.jsx("span",{className:"co",children:f.name})]}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am",children:el(f.amountEur)}),f.sector&&t.jsx("span",{className:"mt",children:f.sector}),t.jsx(Ft,{o:f}),t.jsx("span",{className:"tkgo",children:"→"})]},p+(f.id||f.name)));return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live,t.jsx("span",{className:"cnt",children:c.length})]}),t.jsx("div",{className:"win",children:c.length?t.jsxs("div",{className:"run",children:[s(0),s(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})})]})}const qo="aDx8z7Hzksus",zn="+33 6 83 10 72 86",Ba="alexandre@proplace.co",Oo=`tel:${zn.replace(/[^\d+]/g,"")}`,$a="pp-rdv-slot";function Fo(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Po(){const{t:e,caps:a,fund:r}=P();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:Io}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Oo,children:zn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Ba}`,children:Ba})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([o,i],c)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(c+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(xo,{filloutId:qo,parameters:r?{company_name:r}:void 0})})]})}function Do(){const[e,a]=h.useState(()=>typeof document>"u"?null:document.getElementById($a));return h.useEffect(()=>{e||a(document.getElementById($a))},[e]),e?ut.createPortal(t.jsx(Po,{}),e):null}const Io=`
...
`;class ue extends h.Component{constructor(){super(...arguments);za(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Bo=8;function $o(){const{t:e,lang:a,token:r,dossiers:n,caps:o,markRow:i,dispatch:c}=P(),[s,p]=h.useState(!1),[f,d]=h.useState(!1),[l,m]=h.useState(!1),g=r||"home",{names:u,verdicts:v}=h.useMemo(()=>{const w=[],S={};return n.forEach(C=>{C.kind!=="target"||!C.name||(w.push(C.name),S[C.name]=Er(C)||"")}),{names:w,verdicts:S}},[n]),b=h.useMemo(()=>u.length?zr(g,u,v,a):null,[g,u.length]);if(!o.pipe||s||!b||b.firstVisit||!b.added.length&&!b.gone.length)return null;const x=f?b.added:b.added.slice(0,Bo),y=b.added.length-x.length,N=w=>{const S=n.find(C=>C.name===w);S&&(i(S.id),c({type:"popup",id:S.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(b.added.length,b.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Tr(g,u,v,b.fp,a)},children:"×"})]}),!!b.added.length&&t.jsxs("div",{className:"since-c",children:[x.map(w=>t.jsx("button",{type:"button",onClick:()=>N(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!b.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>m(w=>!w),children:e.sinceOut(b.gone.length)}),l&&b.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Ut=600,Be=62,_a="atl2:fstats";function _o(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=P(),[c,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(_a)==="on"}catch{return!1}}),p=r.stats,f=h.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=h.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const l=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,m=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),g=f.reduce((y,N)=>Math.max(y,N.s||0),0),u=f.length?Ut/f.length:0,v=Math.max(4,u-4),b=f.length>=5&&g>0,x=[[p.screened,e.funScreened(l(d)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(c?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[x.map(([y,N,w],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:m(y)}),t.jsx("i",{children:N}),c&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},N)),b&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":c,title:c?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!c;s(y),y&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(_a,y?"on":"off")}catch{}},children:c?"⌃":"⌄"})]}),c&&b&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ut} ${Be}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((y,N)=>{const w=(y.s||0)/g*(Be-4),S=(y.m||0)/g*(Be-4),C=N*u+(u-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${l(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:C,y:Be-2-w,width:v,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:C,y:Be-2-S,width:v,height:S,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Be-1.5,x2:Ut,y2:Be-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:l(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Uo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Vo({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=P(),[i,c]=h.useState(""),[s,p]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),d=(Je(e)||"").startsWith("CALL")&&ve(e)===3,l=ve(e)>=2,m=async u=>{if(i||u==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;c(u);const v=await o(e,u);c(""),v&&(p(!0),setTimeout(()=>p(!1),2200))},g=d?[["Validé",a.csYes],["Écarté",a.csNo]]:Uo.filter(([u])=>!(l&&u==="Retenu")).map(([u,v])=>[u,a[v]]);return t.jsxs("div",{className:"csp",onClick:u=>u.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),g.map(([u,v])=>t.jsx("button",{type:"button",className:"csb"+(f===u?" on":"")+(i===u?" busy":""),disabled:!!i,onClick:()=>{m(u)},children:v},u)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Ho,{o:e})]})}function Ho({o:e}){const{t:a,saveNote:r,flash:n}=P(),[o,i]=h.useState(e.ceoNote||""),[c,s]=h.useState(!1),[p,f]=h.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),l=async()=>{if(c||!d)return;s(!0);const m=await r(e,o.trim());s(!1),m&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:c,onChange:m=>i(m.target.value),onKeyDown:m=>{m.key==="Enter"&&l()}}),t.jsx("button",{type:"button",disabled:c||!d,onClick:()=>{l()},children:p?a.csNoteSaved:a.csNoteOk})]})}function Yo({placeholder:e,onDone:a}){const{t:r}=P(),[n,o]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Wo({o:e}){var b;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:c,flashErr:s}=P(),[p,f]=h.useState(!1);if(!n.pipe||!o||n.lockActions||ve(e)!==4)return null;const d=i(e),l=(d==null?void 0:d.stage)||"todo",m=async x=>{if(p||x===l)return;f(!0);const y=d;c(e,{stage:x,stamps:(d==null?void 0:d.stamps)||{}});const N=Math.max(Date.now(),Ua+=1);Ua=N;const w=await Ar(r,{company:e.name||"",stage:x,cts:N,deal_id:e.airtableId,check_id:e.checkId});f(!1),!w.stale&&(w.ok||(c(e,y),s(a.actErr)))},g=(b=d==null?void 0:d.stamps)==null?void 0:b.sent,u=g?Math.floor((Date.now()-Date.parse(g))/864e5):0,v=l==="sent"&&g&&u>=4;return t.jsxs("div",{className:"stg",onClick:x=>x.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([x,y])=>t.jsx("button",{type:"button",className:"stgb"+(l===x?" on":""),disabled:p,onClick:()=>{m(x)},children:y},x)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(u)})]})}let Ua=0;const gt=8,bt=340;function Va({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Go({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,scoped:i,byId:c,st:s}=P(),[p,f]=h.useState(0),[d,l]=h.useState(null),[m,g]=h.useState([]),u=h.useRef(!1);h.useEffect(()=>{u.current||(u.current=!0,g(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const v=m[p],b=p>=m.length;h.useEffect(()=>{v&&(v.ptab!==void 0&&s.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&s.dens!==v.dens&&n({type:"dens",dens:v.dens}))},[p,v]);const x=h.useCallback(()=>{if(!v){l(null);return}const S=document.querySelector(v.sel);if(!S){l(null);return}S.scrollIntoView({block:"nearest",behavior:"smooth"}),l(S.getBoundingClientRect())},[v]);h.useLayoutEffect(()=>{x();const S=window.setTimeout(x,260),C=()=>x();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{window.clearTimeout(S),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[x]);const y=h.useRef(a);if(y.current=a,h.useEffect(()=>{const S=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),y.current()):C.key==="ArrowRight"?f(L=>L+1):C.key==="ArrowLeft"&&f(L=>Math.max(0,L-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!m.length)return null;let N=null;if(b){const S=o[3]||0,C=i.find(L=>L.memoUrl)||[...c.values()].find(L=>L.memoUrl);S>0?N={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:C?N={title:r.ahaBTitle,body:r.ahaBBody(C.name),btn:r.ahaBBtn,go:()=>{n({type:"memoConsole",id:C.id}),a()}}:N={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:bt};if(!b&&d){const S=d.bottom+14,L=window.innerHeight-S>190?S:Math.max(12,d.top-200);w={left:Math.min(Math.max(12,d.left+d.width/2-bt/2),window.innerWidth-bt-12),top:L,width:bt}}return ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!b&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-gt,top:d.top-gt,width:d.width+gt*2,height:d.height+gt*2}}),(b||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(b?" fin":""),style:w,children:[b&&N?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:N.title}),t.jsx("p",{children:t.jsx(Va,{text:N.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>f(m.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:N.go,children:N.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(p+1,m.length)}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx("p",{children:t.jsx(Va,{text:(v==null?void 0:v.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:p===0,onClick:()=>f(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>f(S=>S+1),children:p===m.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Ko(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,dispatch:c}=P(),s=r?a:e,p=h.useMemo(()=>s.filter(x=>Qe(x.date)===0&&x.kind==="target"),[s]),f=h.useMemo(()=>r?a.filter(x=>ve(x)===0).slice().sort((x,y)=>(y.date||"").localeCompare(x.date||"")):[],[a,r]),d=h.useMemo(()=>p.filter(x=>r?ve(x)===0:!Ne(x)),[p,r]),l=r?f:d,m=r?a.length-f.length:p.length-d.length,g=r?a.length:p.length,u=g?Math.min(100,m/g*100):100;let v;r?v=o.morningThesis(p.length,f.length):p.length?m===0?v=o.goalSourced(p.length):m>=p.length?v=o.goalCleared:v=o.goalDone(m,p.length):v=o.goalSourced(0);const b=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&f.length&&c({type:"chainStart",queue:f.map(x=>x.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:v}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:u+"%"}})}),l.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:b,children:r?o.morningEval(l.length):i.pileMode?o.goalContinue(l.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Qo(){var M,q;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:c,dossiers:s,mode:p,doSync:f,startTour:d}=P(),[l,m]=h.useState(null),[g,u]=h.useState([]),v=p==="client";h.useEffect(()=>{if(!o||!i)return;let R=!0;return(async()=>{const[z,A]=await Promise.all([ga(i),wn(o)]);R&&(z&&m(z),u(A))})(),()=>{R=!1}},[o,i]);const b=(l==null?void 0:l.per_day)??null,x=((M=l==null?void 0:l.pool_order)==null?void 0:M.length)??0,y=g.filter(R=>R.status==="running").length,N=h.useMemo(()=>s.filter(R=>R.kind==="target"&&Ne(R)).length,[s]),w=c.marketEstimate,S=typeof((q=c.stats)==null?void 0:q.screened)=="number"?c.stats.screened:N,C=w&&w>0?Math.min(100,Math.round(S/w*100)):null,L=R=>R.toLocaleString(a==="en"?"en-US":"fr-FR"),F=(i||"P").split(/\s+/).map(R=>R[0]).join("").slice(0,2).toUpperCase(),j=(()=>{const R=Date.parse(c.generatedAt||"");if(Number.isNaN(R))return"";const z=new Date(R),A=k=>String(k).padStart(2,"0");return`${A(z.getDate())}/${A(z.getMonth()+1)} à ${A(z.getHours())}:${A(z.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:F}),t.jsx("i",{children:i})]}),t.jsx("h1",{children:e.identTitle(i||"…")}),t.jsx("span",{className:"idsp"}),j&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(j)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[C===null&&S>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:L(S)})})]}),C!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:C+"%"}})}),t.jsxs("b",{children:[C," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(S,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),b!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:b})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),b===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(x)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:R=>{R.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!v,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:R=>n({type:"filters",patch:{search:R.target.value}})})]})]})]})}function Jo(){const{t:e,counts:a,dispatch:r}=P();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,o],i)=>{const c=i===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(c?" go":""),children:[t.jsx("span",{className:"s4n",children:i+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:o}),c&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},i)})})]})}const Xo=["--p0","--p1","--p2","--p3","--p4"];function Zo(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o}=P(),i=h.useRef({});h.useEffect(()=>{i.current={...r}},[r]);const c=f=>{const d=i.current[f],l=d!==void 0?r[f]-d:0;return t.jsxs("button",{type:"button",className:"step"+(f===3&&r[3]>0?" wait":""),style:{"--c":`var(${Xo[f]})`,"--tc":f<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===f,title:n.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[t.jsxs("span",{className:"l",children:[n.plabels[f].toUpperCase(),f===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(l>0?" up":l<0?" down":""),children:[r[f],l!==0&&t.jsxs("em",{className:"delta",children:[l>0?"+":"−",Math.abs(l)]})]})]},f)},s=(f,d,l)=>t.jsxs("button",{type:"button",className:"off"+(d?" view":""),style:{"--c":f===5?"var(--p5)":f===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===f,title:n.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[t.jsx("span",{className:"l",children:l.toUpperCase()}),t.jsx("span",{className:"n",children:r[f]})]},f),p=(f,d,l,m=!1)=>t.jsx("button",{type:"button",className:"tool",title:d,disabled:m,onClick:l,children:f},d);return t.jsxs("div",{className:"funnel",children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(c)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[p("↩",n.toolUndo,o,e.undo.length===0),p("↺",n.toolReset,()=>{a({type:"reset"})}),p("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),p("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const ei=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function ti(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:c}=P(),s=h.useRef(null),[p,f]=h.useState(60);h.useEffect(()=>{let g=0;const u=()=>{var N;const v=s.current;if(!v)return;const b=(N=v.parentElement)==null?void 0:N.querySelector('.funnel [aria-selected="true"]');if(!b)return;const x=b.getBoundingClientRect(),y=v.getBoundingClientRect();f(Math.max(20,Math.min(x.left+x.width/2-y.left,y.width-30)))};return g=requestAnimationFrame(u),window.addEventListener("resize",u),()=>{cancelAnimationFrame(g),window.removeEventListener("resize",u)}},[e.ptab]);const d=e.ptab;let l=r.tuto[d].p;if(d===3){const g=n.filter(b=>b.kind==="target"&&ve(b)===3),u=g.filter(b=>Qt(b)==="auto").length,v=g.filter(b=>Qt(b)==="cd").length;l=r.tutoPending(u,v,g.length)}const m=(()=>{if(c!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(g=>g.id)})};if(d===1){const g=n.filter(u=>u.kind==="target"&&ve(u)===1&&!o.has(u.id)).slice(0,10);if(g.length)return{label:r.tuto[1].a,run:()=>g.forEach(u=>i(u))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":ei[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:l}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label})]})}class _e{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],c=a+i,s=Math.abs(a)<Math.abs(i)?a-(c-i):i-(c-a);s&&(r[n++]=s),a=c}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,c=0;if(r>0){for(c=a[--r];r>0&&(n=c,o=a[--r],c=n+o,i=o-(c-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=c+o,o==n-c&&(c=n))}return c}}function*ai(e){for(const a of e)yield*a}function Tn(e){return Array.from(ai(e))}var Z=1e-6,Y=Math.PI,ke=Y/2,Ha=Y/4,Se=Y*2,Re=180/Y,ye=Y/180,te=Math.abs,ni=Math.atan,lt=Math.atan2,ie=Math.cos,se=Math.sin,ri=Math.sign||function(e){return e>0?1:e<0?-1:0},Ve=Math.sqrt;function oi(e){return e>1?0:e<-1?Y:Math.acos(e)}function ct(e){return e>1?ke:e<-1?-ke:Math.asin(e)}function je(){}function Ct(e,a){e&&Wa.hasOwnProperty(e.type)&&Wa[e.type](e,a)}var Ya={Feature:function(e,a){Ct(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ct(r[n].geometry,a)}},Wa={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ea(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ea(r[n],a,0)},Polygon:function(e,a){Ga(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Ga(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ct(r[n],a)}};function ea(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Ga(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ea(e[r],a,1);a.polygonEnd()}function He(e,a){e&&Ya.hasOwnProperty(e.type)?Ya[e.type](e,a):Ct(e,a)}function ta(e){return[lt(e[1],e[0]),ct(e[2])]}function Ge(e){var a=e[0],r=e[1],n=ie(r);return[n*ie(a),n*se(a),se(r)]}function vt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Et(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Vt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function yt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function aa(e){var a=Ve(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function na(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function ra(e,a){return te(e)>Y&&(e-=Math.round(e/Se)*Se),[e,a]}ra.invert=ra;function ii(e,a,r){return(e%=Se)?a||r?na(Qa(e),Ja(a,r)):Qa(e):a||r?Ja(a,r):ra}function Ka(e){return function(a,r){return a+=e,te(a)>Y&&(a-=Math.round(a/Se)*Se),[a,r]}}function Qa(e){var a=Ka(e);return a.invert=Ka(-e),a}function Ja(e,a){var r=ie(e),n=se(e),o=ie(a),i=se(a);function c(s,p){var f=ie(p),d=ie(s)*f,l=se(s)*f,m=se(p),g=m*r+d*n;return[lt(l*o-g*i,d*r-m*n),ct(g*o+l*i)]}return c.invert=function(s,p){var f=ie(p),d=ie(s)*f,l=se(s)*f,m=se(p),g=m*o-l*i;return[lt(l*o+m*i,d*r+g*n),ct(g*r-d*n)]},c}function si(e,a,r,n,o,i){if(r){var c=ie(a),s=se(a),p=n*r;o==null?(o=a+n*Se,i=a-p/2):(o=Xa(c,o),i=Xa(c,i),(n>0?o<i:o>i)&&(o+=n*Se));for(var f,d=o;n>0?d>i:d<i;d-=p)f=ta([c,-s*ie(d),-s*se(d)]),e.point(f[0],f[1])}}function Xa(e,a){a=Ge(a),a[0]-=e,aa(a);var r=oi(-a[1]);return((-a[2]<0?-r:r)+Se-Z)%Se}function An(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:je,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function St(e,a){return te(e[0]-a[0])<Z&&te(e[1]-a[1])<Z}function wt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Ln(e,a,r,n,o){var i=[],c=[],s,p;if(e.forEach(function(u){if(!((v=u.length-1)<=0)){var v,b=u[0],x=u[v],y;if(St(b,x)){if(!b[2]&&!x[2]){for(o.lineStart(),s=0;s<v;++s)o.point((b=u[s])[0],b[1]);o.lineEnd();return}x[0]+=2*Z}i.push(y=new wt(b,u,null,!0)),c.push(y.o=new wt(b,null,y,!1)),i.push(y=new wt(x,u,null,!1)),c.push(y.o=new wt(x,null,y,!0))}}),!!i.length){for(c.sort(a),Za(i),Za(c),s=0,p=c.length;s<p;++s)c[s].e=r=!r;for(var f=i[0],d,l;;){for(var m=f,g=!0;m.v;)if((m=m.n)===f)return;d=m.z,o.lineStart();do{if(m.v=m.o.v=!0,m.e){if(g)for(s=0,p=d.length;s<p;++s)o.point((l=d[s])[0],l[1]);else n(m.x,m.n.x,1,o);m=m.n}else{if(g)for(d=m.p.z,s=d.length-1;s>=0;--s)o.point((l=d[s])[0],l[1]);else n(m.x,m.p.x,-1,o);m=m.p}m=m.o,d=m.z,g=!g}while(!m.v);o.lineEnd()}}}function Za(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Ht(e){return te(e[0])<=Y?e[0]:ri(e[0])*((te(e[0])+Y)%Se-Y)}function li(e,a){var r=Ht(a),n=a[1],o=se(n),i=[se(r),-ie(r),0],c=0,s=0,p=new _e;o===1?n=ke+Z:o===-1&&(n=-ke-Z);for(var f=0,d=e.length;f<d;++f)if(m=(l=e[f]).length)for(var l,m,g=l[m-1],u=Ht(g),v=g[1]/2+Ha,b=se(v),x=ie(v),y=0;y<m;++y,u=w,b=C,x=L,g=N){var N=l[y],w=Ht(N),S=N[1]/2+Ha,C=se(S),L=ie(S),F=w-u,j=F>=0?1:-1,M=j*F,q=M>Y,R=b*C;if(p.add(lt(R*j*se(M),x*L+R*ie(M))),c+=q?F+j*Se:F,q^u>=r^w>=r){var z=Et(Ge(g),Ge(N));aa(z);var A=Et(i,z);aa(A);var k=(q^F>=0?-1:1)*ct(A[2]);(n>k||n===k&&(z[0]||z[1]))&&(s+=q^F>=0?1:-1)}}return(c<-Z||c<Z&&p<-1e-12)^s&1}function Rn(e,a,r,n){return function(o){var i=a(o),c=An(),s=a(c),p=!1,f,d,l,m={point:g,lineStart:v,lineEnd:b,polygonStart:function(){m.point=x,m.lineStart=y,m.lineEnd=N,d=[],f=[]},polygonEnd:function(){m.point=g,m.lineStart=v,m.lineEnd=b,d=Tn(d);var w=li(f,n);d.length?(p||(o.polygonStart(),p=!0),Ln(d,di,w,r,o)):w&&(p||(o.polygonStart(),p=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),p&&(o.polygonEnd(),p=!1),d=f=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function g(w,S){e(w,S)&&o.point(w,S)}function u(w,S){i.point(w,S)}function v(){m.point=u,i.lineStart()}function b(){m.point=g,i.lineEnd()}function x(w,S){l.push([w,S]),s.point(w,S)}function y(){s.lineStart(),l=[]}function N(){x(l[0][0],l[0][1]),s.lineEnd();var w=s.clean(),S=c.result(),C,L=S.length,F,j,M;if(l.pop(),f.push(l),l=null,!!L){if(w&1){if(j=S[0],(F=j.length-1)>0){for(p||(o.polygonStart(),p=!0),o.lineStart(),C=0;C<F;++C)o.point((M=j[C])[0],M[1]);o.lineEnd()}return}L>1&&w&2&&S.push(S.pop().concat(S.shift())),d.push(S.filter(ci))}}return m}}function ci(e){return e.length>1}function di(e,a){return((e=e.x)[0]<0?e[1]-ke-Z:ke-e[1])-((a=a.x)[0]<0?a[1]-ke-Z:ke-a[1])}const en=Rn(function(){return!0},pi,fi,[-Y,-ke]);function pi(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,c){var s=i>0?Y:-Y,p=te(i-a);te(p-Y)<Z?(e.point(a,r=(r+c)/2>0?ke:-ke),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&p>=Y&&(te(a-n)<Z&&(a-=n*Z),te(i-s)<Z&&(i-=s*Z),r=ui(a,r,i,c),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=c),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function ui(e,a,r,n){var o,i,c=se(e-r);return te(c)>Z?ni((se(a)*(i=ie(n))*se(r)-se(n)*(o=ie(a))*se(e))/(o*i*c)):(a+n)/2}function fi(e,a,r,n){var o;if(e==null)o=r*ke,n.point(-Y,o),n.point(0,o),n.point(Y,o),n.point(Y,0),n.point(Y,-o),n.point(0,-o),n.point(-Y,-o),n.point(-Y,0),n.point(-Y,o);else if(te(e[0]-a[0])>Z){var i=e[0]<a[0]?Y:-Y;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function mi(e){var a=ie(e),r=2*ye,n=a>0,o=te(a)>Z;function i(d,l,m,g){si(g,e,r,m,d,l)}function c(d,l){return ie(d)*ie(l)>a}function s(d){var l,m,g,u,v;return{lineStart:function(){u=g=!1,v=1},point:function(b,x){var y=[b,x],N,w=c(b,x),S=n?w?0:f(b,x):w?f(b+(b<0?Y:-Y),x):0;if(!l&&(u=g=w)&&d.lineStart(),w!==g&&(N=p(l,y),(!N||St(l,N)||St(y,N))&&(y[2]=1)),w!==g)v=0,w?(d.lineStart(),N=p(y,l),d.point(N[0],N[1])):(N=p(l,y),d.point(N[0],N[1],2),d.lineEnd()),l=N;else if(o&&l&&n^w){var C;!(S&m)&&(C=p(y,l,!0))&&(v=0,n?(d.lineStart(),d.point(C[0][0],C[0][1]),d.point(C[1][0],C[1][1]),d.lineEnd()):(d.point(C[1][0],C[1][1]),d.lineEnd(),d.lineStart(),d.point(C[0][0],C[0][1],3)))}w&&(!l||!St(l,y))&&d.point(y[0],y[1]),l=y,g=w,m=S},lineEnd:function(){g&&d.lineEnd(),l=null},clean:function(){return v|(u&&g)<<1}}}function p(d,l,m){var g=Ge(d),u=Ge(l),v=[1,0,0],b=Et(g,u),x=vt(b,b),y=b[0],N=x-y*y;if(!N)return!m&&d;var w=a*x/N,S=-a*y/N,C=Et(v,b),L=yt(v,w),F=yt(b,S);Vt(L,F);var j=C,M=vt(L,j),q=vt(j,j),R=M*M-q*(vt(L,L)-1);if(!(R<0)){var z=Ve(R),A=yt(j,(-M-z)/q);if(Vt(A,L),A=ta(A),!m)return A;var k=d[0],T=l[0],I=d[1],B=l[1],W;T<k&&(W=k,k=T,T=W);var he=T-k,_=te(he-Y)<Z,le=_||he<Z;if(!_&&B<I&&(W=I,I=B,B=W),le?_?I+B>0^A[1]<(te(A[0]-k)<Z?I:B):I<=A[1]&&A[1]<=B:he>Y^(k<=A[0]&&A[0]<=T)){var V=yt(j,(-M+z)/q);return Vt(V,L),[A,ta(V)]}}}function f(d,l){var m=n?e:Y-e,g=0;return d<-m?g|=1:d>m&&(g|=2),l<-m?g|=4:l>m&&(g|=8),g}return Rn(c,s,i,n?[0,-e]:[-Y,e-Y])}function xi(e,a,r,n,o,i){var c=e[0],s=e[1],p=a[0],f=a[1],d=0,l=1,m=p-c,g=f-s,u;if(u=r-c,!(!m&&u>0)){if(u/=m,m<0){if(u<d)return;u<l&&(l=u)}else if(m>0){if(u>l)return;u>d&&(d=u)}if(u=o-c,!(!m&&u<0)){if(u/=m,m<0){if(u>l)return;u>d&&(d=u)}else if(m>0){if(u<d)return;u<l&&(l=u)}if(u=n-s,!(!g&&u>0)){if(u/=g,g<0){if(u<d)return;u<l&&(l=u)}else if(g>0){if(u>l)return;u>d&&(d=u)}if(u=i-s,!(!g&&u<0)){if(u/=g,g<0){if(u>l)return;u>d&&(d=u)}else if(g>0){if(u<d)return;u<l&&(l=u)}return d>0&&(e[0]=c+d*m,e[1]=s+d*g),l<1&&(a[0]=c+l*m,a[1]=s+l*g),!0}}}}}var at=1e9,kt=-at;function hi(e,a,r,n){function o(f,d){return e<=f&&f<=r&&a<=d&&d<=n}function i(f,d,l,m){var g=0,u=0;if(f==null||(g=c(f,l))!==(u=c(d,l))||p(f,d)<0^l>0)do m.point(g===0||g===3?e:r,g>1?n:a);while((g=(g+l+4)%4)!==u);else m.point(d[0],d[1])}function c(f,d){return te(f[0]-e)<Z?d>0?0:3:te(f[0]-r)<Z?d>0?2:1:te(f[1]-a)<Z?d>0?1:0:d>0?3:2}function s(f,d){return p(f.x,d.x)}function p(f,d){var l=c(f,1),m=c(d,1);return l!==m?l-m:l===0?d[1]-f[1]:l===1?f[0]-d[0]:l===2?f[1]-d[1]:d[0]-f[0]}return function(f){var d=f,l=An(),m,g,u,v,b,x,y,N,w,S,C,L={point:F,lineStart:R,lineEnd:z,polygonStart:M,polygonEnd:q};function F(k,T){o(k,T)&&d.point(k,T)}function j(){for(var k=0,T=0,I=g.length;T<I;++T)for(var B=g[T],W=1,he=B.length,_=B[0],le,V,K=_[0],U=_[1];W<he;++W)le=K,V=U,_=B[W],K=_[0],U=_[1],V<=n?U>n&&(K-le)*(n-V)>(U-V)*(e-le)&&++k:U<=n&&(K-le)*(n-V)<(U-V)*(e-le)&&--k;return k}function M(){d=l,m=[],g=[],C=!0}function q(){var k=j(),T=C&&k,I=(m=Tn(m)).length;(T||I)&&(f.polygonStart(),T&&(f.lineStart(),i(null,null,1,f),f.lineEnd()),I&&Ln(m,s,k,i,f),f.polygonEnd()),d=f,m=g=u=null}function R(){L.point=A,g&&g.push(u=[]),S=!0,w=!1,y=N=NaN}function z(){m&&(A(v,b),x&&w&&l.rejoin(),m.push(l.result())),L.point=F,w&&d.lineEnd()}function A(k,T){var I=o(k,T);if(g&&u.push([k,T]),S)v=k,b=T,x=I,S=!1,I&&(d.lineStart(),d.point(k,T));else if(I&&w)d.point(k,T);else{var B=[y=Math.max(kt,Math.min(at,y)),N=Math.max(kt,Math.min(at,N))],W=[k=Math.max(kt,Math.min(at,k)),T=Math.max(kt,Math.min(at,T))];xi(B,W,e,a,r,n)?(w||(d.lineStart(),d.point(B[0],B[1])),d.point(W[0],W[1]),I||d.lineEnd(),C=!1):I&&(d.lineStart(),d.point(k,T),C=!1)}y=k,N=T,w=I}return L}}const oa=e=>e;var Yt=new _e,ia=new _e,Mn,qn,sa,la,Me={point:je,lineStart:je,lineEnd:je,polygonStart:function(){Me.lineStart=gi,Me.lineEnd=vi},polygonEnd:function(){Me.lineStart=Me.lineEnd=Me.point=je,Yt.add(te(ia)),ia=new _e},result:function(){var e=Yt/2;return Yt=new _e,e}};function gi(){Me.point=bi}function bi(e,a){Me.point=On,Mn=sa=e,qn=la=a}function On(e,a){ia.add(la*e-sa*a),sa=e,la=a}function vi(){On(Mn,qn)}var Ke=1/0,zt=Ke,dt=-Ke,Tt=dt,At={point:yi,lineStart:je,lineEnd:je,polygonStart:je,polygonEnd:je,result:function(){var e=[[Ke,zt],[dt,Tt]];return dt=Tt=-(zt=Ke=1/0),e}};function yi(e,a){e<Ke&&(Ke=e),e>dt&&(dt=e),a<zt&&(zt=a),a>Tt&&(Tt=a)}var ca=0,da=0,nt=0,Lt=0,Rt=0,Ye=0,pa=0,ua=0,rt=0,Fn,Pn,Te,Ae,we={point:Ue,lineStart:tn,lineEnd:an,polygonStart:function(){we.lineStart=ji,we.lineEnd=Ni},polygonEnd:function(){we.point=Ue,we.lineStart=tn,we.lineEnd=an},result:function(){var e=rt?[pa/rt,ua/rt]:Ye?[Lt/Ye,Rt/Ye]:nt?[ca/nt,da/nt]:[NaN,NaN];return ca=da=nt=Lt=Rt=Ye=pa=ua=rt=0,e}};function Ue(e,a){ca+=e,da+=a,++nt}function tn(){we.point=wi}function wi(e,a){we.point=ki,Ue(Te=e,Ae=a)}function ki(e,a){var r=e-Te,n=a-Ae,o=Ve(r*r+n*n);Lt+=o*(Te+e)/2,Rt+=o*(Ae+a)/2,Ye+=o,Ue(Te=e,Ae=a)}function an(){we.point=Ue}function ji(){we.point=Si}function Ni(){Dn(Fn,Pn)}function Si(e,a){we.point=Dn,Ue(Fn=Te=e,Pn=Ae=a)}function Dn(e,a){var r=e-Te,n=a-Ae,o=Ve(r*r+n*n);Lt+=o*(Te+e)/2,Rt+=o*(Ae+a)/2,Ye+=o,o=Ae*e-Te*a,pa+=o*(Te+e),ua+=o*(Ae+a),rt+=o*3,Ue(Te=e,Ae=a)}function In(e){this._context=e}In.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Se);break}}},result:je};var fa=new _e,Wt,Bn,$n,ot,it,pt={point:je,lineStart:function(){pt.point=Ci},lineEnd:function(){Wt&&_n(Bn,$n),pt.point=je},polygonStart:function(){Wt=!0},polygonEnd:function(){Wt=null},result:function(){var e=+fa;return fa=new _e,e}};function Ci(e,a){pt.point=_n,Bn=ot=e,$n=it=a}function _n(e,a){ot-=e,it-=a,fa.add(Ve(ot*ot+it*it)),ot=e,it=a}let nn,Mt,rn,on;class sn{constructor(a){this._append=a==null?Un:Ei(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==rn||this._append!==Mt){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,rn=n,Mt=this._append,on=this._,this._=o}this._+=on;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Un(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Ei(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Un;if(a!==nn){const r=10**a;nn=a,Mt=function(o){let i=1;this._+=o[0];for(const c=o.length;i<c;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Mt}function zi(e,a){let r=3,n=4.5,o,i;function c(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),He(s,o(i))),i.result()}return c.area=function(s){return He(s,o(Me)),Me.result()},c.measure=function(s){return He(s,o(pt)),pt.result()},c.bounds=function(s){return He(s,o(At)),At.result()},c.centroid=function(s){return He(s,o(we)),we.result()},c.projection=function(s){return arguments.length?(o=s==null?(e=null,oa):(e=s).stream,c):e},c.context=function(s){return arguments.length?(i=s==null?(a=null,new sn(r)):new In(a=s),typeof n!="function"&&i.pointRadius(n),c):a},c.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),c):n},c.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(i=new sn(r)),c},c.projection(e).digits(r).context(a)}function ja(e){return function(a){var r=new ma;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ma(){}ma.prototype={constructor:ma,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Na(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),He(r,e.stream(At)),a(At.result()),n!=null&&e.clipExtent(n),e}function Vn(e,a,r){return Na(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],c=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-c*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(i-c*(n[1][1]+n[0][1]))/2;e.scale(150*c).translate([s,p])},r)}function Ti(e,a,r){return Vn(e,[[0,0],a],r)}function Ai(e,a,r){return Na(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),c=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([c,s])},r)}function Li(e,a,r){return Na(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),c=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([c,s])},r)}var ln=16,Ri=ie(30*ye);function cn(e,a){return+a?qi(e,a):Mi(e)}function Mi(e){return ja({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function qi(e,a){function r(n,o,i,c,s,p,f,d,l,m,g,u,v,b){var x=f-n,y=d-o,N=x*x+y*y;if(N>4*a&&v--){var w=c+m,S=s+g,C=p+u,L=Ve(w*w+S*S+C*C),F=ct(C/=L),j=te(te(C)-1)<Z||te(i-l)<Z?(i+l)/2:lt(S,w),M=e(j,F),q=M[0],R=M[1],z=q-n,A=R-o,k=y*z-x*A;(k*k/N>a||te((x*z+y*A)/N-.5)>.3||c*m+s*g+p*u<Ri)&&(r(n,o,i,c,s,p,q,R,j,w/=L,S/=L,C,v,b),b.point(q,R),r(q,R,j,w,S,C,f,d,l,m,g,u,v,b))}}return function(n){var o,i,c,s,p,f,d,l,m,g,u,v,b={point:x,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),b.lineStart=S},polygonEnd:function(){n.polygonEnd(),b.lineStart=y}};function x(F,j){F=e(F,j),n.point(F[0],F[1])}function y(){l=NaN,b.point=N,n.lineStart()}function N(F,j){var M=Ge([F,j]),q=e(F,j);r(l,m,d,g,u,v,l=q[0],m=q[1],d=F,g=M[0],u=M[1],v=M[2],ln,n),n.point(l,m)}function w(){b.point=x,n.lineEnd()}function S(){y(),b.point=C,b.lineEnd=L}function C(F,j){N(o=F,j),i=l,c=m,s=g,p=u,f=v,b.point=N}function L(){r(l,m,d,g,u,v,i,c,o,s,p,f,ln,n),b.lineEnd=w,w()}return b}}var Oi=ja({point:function(e,a){this.stream.point(e*ye,a*ye)}});function Fi(e){return ja({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Pi(e,a,r,n,o){function i(c,s){return c*=n,s*=o,[a+e*c,r-e*s]}return i.invert=function(c,s){return[(c-a)/e*n,(r-s)/e*o]},i}function dn(e,a,r,n,o,i){if(!i)return Pi(e,a,r,n,o);var c=ie(i),s=se(i),p=c*e,f=s*e,d=c/e,l=s/e,m=(s*r-c*a)/e,g=(s*a+c*r)/e;function u(v,b){return v*=n,b*=o,[p*v-f*b+a,r-f*v-p*b]}return u.invert=function(v,b){return[n*(d*v-l*b+m),o*(g-l*v-d*b)]},u}function Di(e){return Ii(function(){return e})()}function Ii(e){var a,r=150,n=480,o=250,i=0,c=0,s=0,p=0,f=0,d,l=0,m=1,g=1,u=null,v=en,b=null,x,y,N,w=oa,S=.5,C,L,F,j,M;function q(k){return F(k[0]*ye,k[1]*ye)}function R(k){return k=F.invert(k[0],k[1]),k&&[k[0]*Re,k[1]*Re]}q.stream=function(k){return j&&M===k?j:j=Oi(Fi(d)(v(C(w(M=k)))))},q.preclip=function(k){return arguments.length?(v=k,u=void 0,A()):v},q.postclip=function(k){return arguments.length?(w=k,b=x=y=N=null,A()):w},q.clipAngle=function(k){return arguments.length?(v=+k?mi(u=k*ye):(u=null,en),A()):u*Re},q.clipExtent=function(k){return arguments.length?(w=k==null?(b=x=y=N=null,oa):hi(b=+k[0][0],x=+k[0][1],y=+k[1][0],N=+k[1][1]),A()):b==null?null:[[b,x],[y,N]]},q.scale=function(k){return arguments.length?(r=+k,z()):r},q.translate=function(k){return arguments.length?(n=+k[0],o=+k[1],z()):[n,o]},q.center=function(k){return arguments.length?(i=k[0]%360*ye,c=k[1]%360*ye,z()):[i*Re,c*Re]},q.rotate=function(k){return arguments.length?(s=k[0]%360*ye,p=k[1]%360*ye,f=k.length>2?k[2]%360*ye:0,z()):[s*Re,p*Re,f*Re]},q.angle=function(k){return arguments.length?(l=k%360*ye,z()):l*Re},q.reflectX=function(k){return arguments.length?(m=k?-1:1,z()):m<0},q.reflectY=function(k){return arguments.length?(g=k?-1:1,z()):g<0},q.precision=function(k){return arguments.length?(C=cn(L,S=k*k),A()):Ve(S)},q.fitExtent=function(k,T){return Vn(q,k,T)},q.fitSize=function(k,T){return Ti(q,k,T)},q.fitWidth=function(k,T){return Ai(q,k,T)},q.fitHeight=function(k,T){return Li(q,k,T)};function z(){var k=dn(r,0,0,m,g,l).apply(null,a(i,c)),T=dn(r,n-k[0],o-k[1],m,g,l);return d=ii(s,p,f),L=na(a,T),F=na(d,L),C=cn(L,S),A()}function A(){return j=M=null,q}return function(){return a=e.apply(this,arguments),q.invert=a.invert&&R,z()}}function Hn(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Hn.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,c=i*i;r-=o=(r*(1.007226+i*(.015085+c*(-.044475+.028874*i-.005916*c)))-a)/(1.007226+i*(.015085*3+c*(-.044475*7+.028874*9*i-.005916*11*c)))}while(te(o)>Z&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Bi(){return Di(Hn).scale(175.295)}function $i(e){return e}function _i(e){if(e==null)return $i;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],c=e.translate[1];return function(s,p){p||(a=r=0);var f=2,d=s.length,l=new Array(d);for(l[0]=(a+=s[0])*n+i,l[1]=(r+=s[1])*o+c;f<d;)l[f]=s[f],++f;return l}}function Ui(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Vi(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return pn(e,r)})}:pn(e,a)}function pn(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Hi(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Hi(e,a){var r=_i(e.transform),n=e.arcs;function o(d,l){l.length&&l.pop();for(var m=n[d<0?~d:d],g=0,u=m.length;g<u;++g)l.push(r(m[g],g));d<0&&Ui(l,u)}function i(d){return r(d)}function c(d){for(var l=[],m=0,g=d.length;m<g;++m)o(d[m],l);return l.length<2&&l.push(l[0]),l}function s(d){for(var l=c(d);l.length<4;)l.push(l[0]);return l}function p(d){return d.map(s)}function f(d){var l=d.type,m;switch(l){case"GeometryCollection":return{type:l,geometries:d.geometries.map(f)};case"Point":m=i(d.coordinates);break;case"MultiPoint":m=d.coordinates.map(i);break;case"LineString":m=c(d.arcs);break;case"MultiLineString":m=d.arcs.map(c);break;case"Polygon":m=p(d.arcs);break;case"MultiPolygon":m=d.arcs.map(p);break;default:return null}return{type:l,coordinates:m}}return f(a)}let jt=null;function Yi(){return jt||(jt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Vi(r,n),i=Bi().fitExtent([[8,8],[992,492]],{type:"Sphere"}),c=zi(i),s=(o.features||[]).filter(p=>{var f;return(((f=p.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(p=>{var l;const f=((l=p.properties)==null?void 0:l.name)||"",d=c(p)||"";return d?{i2:Lr(f)||null,n:f,d}:null}).filter(p=>!!p);return s.length?{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s}:null}catch{return null}})(),jt)}function Wi(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return Yi().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const un=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function fn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Gi(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let o=!0,i=0;const c=()=>{var f;if(!o)return;const p=(f=e.current)==null?void 0:f.getScreenCTM();p&&p.a>0?n(p.a):i=requestAnimationFrame(c)};c();const s=new ResizeObserver(()=>c());return e.current&&s.observe(e.current),window.addEventListener("resize",c),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",c)}},[e,a]),r}function Ki(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:c,lang:s,t:p}=P(),f=h.useRef(null),d=h.useRef(null),l=Wi(e.continent==="monde"),m=e.continent==="monde"?l:ba.find(j=>j.key===e.continent)||null,g=Gi(f,e.continent+":"+e.mapFolded+":"+!!m),[u,v]=h.useState(new Map),[b,x]=h.useState(null);h.useEffect(()=>{const j=f.current;if(!j)return;const M=new Map;j.querySelectorAll("path[data-i2]").forEach(q=>{const R=q.dataset.i2;if(R)try{const z=q.getBBox();z.width>0&&M.set(R,{x:z.x,y:z.y,w:z.width,h:z.height})}catch{}}),v(M)},[e.continent,g,m]);const y=h.useMemo(()=>r.filter(j=>j.cc),[r]),N=h.useMemo(()=>{const j=new Map;return y.forEach(M=>j.set(M.cc,(j.get(M.cc)||0)+1)),j},[y]),w=h.useMemo(()=>y.map(j=>{const M=j.cc?u.get(j.cc):void 0;if(!M)return null;const q=fn(j.name||j.id||""),R=fn((j.id||j.name||"")+"·y"),z=(q-.5)*Math.min(M.w*.55,60),A=(R-.5)*Math.min(M.h*.55,60);return{d:j,x:M.x+M.w/2+z,y:M.y+M.h/2+A}}).filter(j=>!!j),[y,u]),S=j=>g>0?j/g:j,C=h.useMemo(()=>n?[0,1,2,3,4,5].map(j=>({c:un[j],fr:p.plabels[j].toUpperCase(),en:p.plabels[j].toUpperCase(),n:r.filter(M=>M.kind==="target"&&ve(M)===j).length})).filter(j=>j.n>0):Ma.map((j,M)=>({...j,n:r.filter(q=>qa(q)===M).length})),[r,n,p.plabels]),L=i?c.get(i):null,F=L?w.find(j=>j.d.id===L.id):null;return m?t.jsxs("div",{className:"mapzone",ref:d,children:[t.jsxs("svg",{ref:f,viewBox:m.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?m.fr:m.en,onMouseLeave:()=>{x(null),o(null)},children:[t.jsx("g",{children:m.countries.map((j,M)=>t.jsx("g",{className:"ct"+(j.i2&&N.get(j.i2)?"":" empty"),children:t.jsx("path",{d:j.d,"data-i2":j.i2||void 0})},M))}),t.jsx("g",{children:w.map(j=>{const M=Ma[qa(j.d)],q=!!xe(j.d),R=j.d.kind==="target",z=n&&R?un[ve(j.d)]:M.c,A=!n&&Ne(j.d);return t.jsxs("g",{className:"co"+(A?" done":""),onMouseEnter:()=>{var I,B;const k=(I=d.current)==null?void 0:I.getBoundingClientRect(),T=(B=f.current)==null?void 0:B.createSVGPoint();if(T&&f.current&&k){T.x=j.x,T.y=j.y;const W=T.matrixTransform(f.current.getScreenCTM());x({x:W.x-k.left,y:W.y-k.top,label:j.d.name+" · "+(Xe(j.d.cc,s)||j.d.countryLabel||"")})}o(j.d.id)},onMouseLeave:()=>{x(null),o(null)},onClick:()=>{var I;const k=(I=f.current)==null?void 0:I.createSVGPoint();let T=null;if(k&&f.current){k.x=j.x,k.y=j.y;const B=k.matrixTransform(f.current.getScreenCTM());T={x:B.x,y:B.y}}a({type:"popup",id:j.d.id,anchor:T})},children:[t.jsx("circle",{className:"h",cx:j.x,cy:j.y,r:S(Math.max(11,M.px+7))}),t.jsx("circle",{className:"v",cx:j.x,cy:j.y,r:S(M.px),fill:z,stroke:q?"#DC2626":"#ffffff",strokeWidth:S(q?2.2:1.3)})]},j.d.id||j.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:S(13),fill:"none",stroke:"#0F172A",strokeWidth:S(2)})]}),t.jsx("div",{className:"hov"+(b?" on":""),style:b?{left:b.x,top:b.y}:void 0,children:b==null?void 0:b.label}),t.jsx("div",{className:"legend",children:C.map((j,M)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":j.c}}),s==="fr"?j.fr:j.en," ",t.jsx("b",{children:j.n})]},M))}),r.some(j=>!j.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(j=>!j.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:d})}function Qi(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Ji(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:o,contName:i,lang:c}=P(),s=e.filters,p=h.useMemo(()=>e.continent==="monde"?r:r.filter(u=>u.continent===e.continent),[r,e.continent]),f=u=>p.filter(v=>u!=="country"&&s.country.length&&!s.country.includes(v.cc||"")?!1:wa(v,s,o,u==="country"?void 0:u)),d=h.useMemo(()=>{const u=f("win"),v=b=>u.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=b).length;return[v(0),v(7),v(30),u.length]},[p,s,o]),l=h.useMemo(()=>s.day?f("win").filter(u=>(u.date||"").slice(0,10)===s.day).length:0,[p,s,o]),m=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),g=(u,v,b,x="fbtn")=>t.jsxs("button",{type:"button",className:x,"aria-expanded":e.openFacet===u,onClick:()=>a({type:"openFacet",facet:u}),children:[t.jsx("span",{className:"fl",children:v}),b>0&&t.jsx("span",{className:"n",children:b}),t.jsx("span",{className:"cv",children:"▾"})]},u);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(Qi(s.day,c)),t.jsx("b",{children:l})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((u,v)=>t.jsxs("button",{type:"button","aria-pressed":s.win===u,onClick:()=>a({type:"filters",patch:{win:u}}),children:[n.dates[v],t.jsx("b",{children:d[v]})]},u))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:u=>a({type:"filters",patch:{search:u.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):g("sec",n.fSector,s.sector.length),g("pay",n.fCountry,s.country.length),g("det",n.fEngine,s.engine.length),g("sta",n.fStage,s.stage.length),o&&g("ang","Angle",s.angle.length),o&&g("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),m>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,i),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(m)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Xi,{poolFor:f})]})}function Xi({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=P(),i=a.filters,c=a.openFacet,{title:s,cols:p,options:f}=h.useMemo(()=>{if(c==="sig"){const u=e("signal").filter(x=>xe(x)),v=new Map;u.forEach(x=>{const y=x.engine||"";v.set(y,(v.get(y)||0)+1)});const b=[{v:"*",label:n.fpSigAll,n:u.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Jt([...v.keys()],o).map(x=>({v:x,label:We(x)+" "+qe(x,o),n:v.get(x)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(x)}))];return{title:n.fpSigTitle,cols:2,options:b}}if(c==="sec"){const u=e("sector"),v=new Map;return u.forEach(b=>{b.sector&&v.set(b.sector,(v.get(b.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((b,x)=>x[1]-b[1]).map(([b,x])=>({v:b,label:b,n:x,html:!1,on:i.sector.includes(b)}))}}if(c==="pay"){const u=e("country"),v=new Map;return u.forEach(b=>{b.cc&&v.set(b.cc,(v.get(b.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((b,x)=>x[1]-b[1]).map(([b,x])=>({v:b,label:Xe(b,o)||b,n:x,html:!1,on:i.country.includes(b)}))}}if(c==="det"){const u=e("engine"),v=new Map;return u.forEach(b=>{b.engine&&v.set(b.engine,(v.get(b.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Jt([...v.keys()],o).map(b=>({v:b,label:We(b)+" "+qe(b,o)+' <span style="color:var(--dim);font-size:10px">· '+Rr(Mr(b),o)+"</span>",n:v.get(b)||0,html:!0,on:i.engine.includes(b)}))}}if(c==="ang"){const u=e("angle"),v=new Map;return u.forEach(b=>{b.angle&&v.set(b.angle,(v.get(b.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((b,x)=>x[1]-b[1]).map(([b,x])=>({v:b,label:b.replace(/[_-]+/g," "),n:x,html:!1,on:i.angle.includes(b)}))}}if(c==="mem"){const u=e("memoLevel"),v=new Map;u.forEach(x=>{if(x.kind==="target"){const y=ha(x);v.set(y,(v.get(y)||0)+1)}});const b=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(x=>({v:String(x),label:b[x],n:v.get(x)||0,html:!1,on:i.memoLevel.includes(x)}))}}const m=e("stage"),g=new Map;return m.forEach(u=>{u.stage&&g.set(u.stage,(g.get(u.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...g.entries()].sort((u,v)=>v[1]-u[1]).map(([u,v])=>({v:u,label:u,n:v,html:!1,on:i.stage.includes(u)}))}},[c,a,o]),d=m=>{if(c==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const u=i.signalEngines.includes(m)?i.signalEngines.filter(v=>v!==m):[...i.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:u}})}return}if(c==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage",value:m})},l=()=>{r(c==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:c==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:l,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:f.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>d(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}const mn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Zi(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function es(){var Le;const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:c,evalBusy:s,evalCards:p,caps:f,data:d}=P(),l=a==="client",[m,g]=h.useState(""),[u,v]=h.useState(!1),[b,x]=h.useState(""),[y,N]=h.useState(!1),[w,S]=h.useState(""),[C,L]=h.useState([]),F=h.useRef(!1),[j,M]=h.useState(!1),[q,R]=h.useState(""),[z,A]=h.useState(""),[k,T]=h.useState(!1),[I,B]=h.useState(0),[W,he]=h.useState(""),[_,le]=h.useState(null),[V,K]=h.useState(null),U=h.useRef(!1),Q=m.trim()?mn.test(m.trim())?e.evalUrl:e.evalName:e.evalWaiting,H=h.useMemo(()=>b.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[b]);h.useEffect(()=>{if(typeof window>"u")return;const O=(new URLSearchParams(window.location.search).get("rs")||"").trim();!O||!/^https?:\/\//i.test(O)||(R(O),M(!0))},[]),h.useEffect(()=>{const O=J=>{var X;const ae=String(((X=J.detail)==null?void 0:X.url)||"").trim();!ae||!/^https?:\/\//i.test(ae)||(R(ae),M(!0))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]);const re=C.length?C:p,ne=d.credits;h.useEffect(()=>{if(!k)return;B(0);const O=window.setInterval(()=>B(J=>J+1),1e3);return()=>window.clearInterval(O)},[k]);const pe=()=>{const O=m.trim();O&&(o(null,O),g(""))},ee=async()=>{if(!l){o(null,H[0]||"");return}if(!H.length||y)return;N(!0),F.current=!1;const O=[];for(let J=0;J<H.length&&!F.current;J++){S(e.evaluating(J+1,H.length,H[J]));const ae=await kn(r,H[J],"atelier2");if(O.unshift({name:ae.company||H[J],verdict:ae.verdict,reason:ae.reason||"",remaining:ae.remaining??null}),L([...O]),ae.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(H.length-J-1),remaining:0}),L([...O]),x(H.slice(J+1).join(`
`)),S(""),N(!1);return}}S(""),x(F.current?H.slice(O.length).join(`
`):""),N(!1)},oe=async()=>{var ae;if(U.current)return;const O=q.trim().replace(/\s+/g,""),J=z.trim();if(!O&&!J){he(e.rsNeed);return}if(!l){o(null,O||J.slice(0,80));return}U.current=!0,he(""),le(null),K(null),T(!0);try{const X=await Or({url:O,text:J,email:n,cbToken:r});if(T(!1),!X||X.status!=="success"){he((X==null?void 0:X.message)||"Erreur");return}le(X),M(!1);const Ee=(((ae=X.prospective)==null?void 0:ae.companies_to_evaluate)||[]).map(Fe=>((Fe==null?void 0:Fe.name)||"").trim()).filter(Boolean);Ee.length&&(x(Fe=>{const ft=Fe.split(`
`).map(Pe=>Pe.trim()).filter(Boolean),Pt=new Set(ft.map(Pe=>Pe.toLowerCase())),Dt=Ee.filter(Pe=>!Pt.has(Pe.toLowerCase()));return[...ft,...Dt].slice(0,15).join(`
`)}),v(!0)),K({state:"pending"});const Oe=await Fr(X,{email:n,cbToken:r});K(Oe.ok&&Oe.url?{state:"ok",url:Oe.url}:{state:"fail",msg:Oe.error||""})}finally{U.current=!1,T(!1)}},Ce=(((Le=_==null?void 0:_.prospective)==null?void 0:Le.companies_to_evaluate)||[]).filter(O=>O&&O.name),G=[_==null?void 0:_.industry,...(_==null?void 0:_.market_tags)||[],_==null?void 0:_.author].map(O=>(O||"").trim()).filter(Boolean),de=(V==null?void 0:V.state)==="pending",ge=V&&(de?t.jsx("span",{className:"rslink pend",children:e.rsPublishing}):V.state==="ok"?t.jsx("a",{className:"rslink",href:V.url,target:"_blank",rel:"noopener noreferrer",children:e.rsLink}):t.jsx("span",{className:"rslink fail",title:V.msg,children:e.rsPublishFail})),fe=u&&Ce.length>0;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:m,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:O=>g(O.target.value),onKeyDown:O=>{O.key==="Enter"&&pe()}}),t.jsx("span",{className:"detect"+(mn.test(m.trim())?" url":""),children:Q})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:pe,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),f.showCredits&&ne&&t.jsxs("button",{type:"button",className:"credits"+(ne.total_available<=0&&!ne.unlimited?" empty":""),onClick:()=>c({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ne.unlimited?"∞":ne.total_available}),!ne.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ne.daily_grant+ne.purchased]}),ne.total_available<=0&&!ne.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>v(!u),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(j?" on":""),onClick:()=>M(!j),children:e.rsOpen})]}),j&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:q,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:O=>R(O.target.value),onKeyDown:O=>{O.key==="Enter"&&oe()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:z,placeholder:e.rsTextPh,onChange:O=>A(O.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(k?" loading":""),style:{justifyContent:"center"},disabled:k||de||!q.trim()&&!z.trim(),onClick:()=>{oe()},children:[t.jsx("span",{className:"fill"}),k?`${qr(q.trim())==="youtube"&&q.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(I)}`:de?e.rsPublishing:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),W&&t.jsx("div",{className:"rserr",children:W}),_&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:_.title}),_.source_url&&t.jsx("a",{href:_.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{le(null),K(null)},children:"×"})]}),_.market&&t.jsx("p",{className:"rsmk",children:_.market}),G.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),G.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[_.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${_.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Zi(_.summary_md||"").map((O,J)=>t.jsx("p",{children:O},J))})]}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Ce.length)}),!fe&&ge]})]}),u&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:b,placeholder:e.bulkPh,onChange:O=>x(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(y?" loading":""),style:{justifyContent:"center"},disabled:y||!H.length,onClick:()=>{ee()},children:[t.jsx("span",{className:"fill"}),y&&w?w:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(H.length)}),fe&&ge]})]}),re.slice(0,1).map((O,J)=>{const ae=O.verdict==="kept",X=O.verdict==="quota",Ee=ae?"var(--brand)":X?"var(--bolt)":"var(--red)",Oe=ae?"var(--brand-l)":X?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ee,"--bgc":Oe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ae?"✓ "+e.kept:X?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!X&&t.jsx("button",{type:"button",className:"go",onClick:()=>c({type:"modal",modal:"space"}),children:e.seeSpace(ae?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),l&&(i.kept+i.dropped>0||re.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>c({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function ts(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function as(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=P(),i=e.memoConsole?r.get(e.memoConsole):null,c=h.useMemo(()=>i?[i.reasoning||"",ts(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const s=Je(i),p=ha(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:c?c.split(`

`).map((f,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[va(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Yn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=P(),[c,s]=h.useState(!1),[p,f]=h.useState(null);if(!n.pipe||o!=="client"||n.lockActions)return null;const d=async()=>{if(c)return;s(!0);const l=await Pr(r,e);if(s(!1),!l){i(a.actErr);return}f(l.results||[])};return t.jsxs("div",{className:"simb",onClick:l=>l.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:c,onClick:()=>{d()},children:c?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(l=>t.jsxs("li",{children:[t.jsx("b",{className:l.verdict==="kept"?"ok":"ko",children:l.company}),l.reason&&t.jsx("span",{children:l.reason})]},l.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}function Wn({spec:e}){const a=h.useRef(null);return h.useEffect(()=>{const r=a.current;if(!r)return;let n=!1;return Ir({kind:"op",card:e},Math.max(240,r.clientWidth||320)).then(o=>{!n&&o&&r.isConnected&&r.replaceChildren(o)}),()=>{n=!0,r.replaceChildren()}},[e]),t.jsx("div",{ref:a,style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden"}})}const ns=`
...
`;function rs(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,c=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:c,top:s}}function os(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:c,askEvaluate:s,doAnalyse:p,doDecide:f,doPromote:d,doRepeche:l,doApproach:m,doDeep:g,doOnboard:u,outbound:v,evalBusy:b}=P(),x=e.popupId?r.get(e.popupId):null;if(!x)return null;const y=xe(x),N=ve(x),w=Je(x),S=x.kind==="target",C=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return ut.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:ns}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:rs(e.popupAnchor,!!x.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:x.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(Qe(x.date)),qe(x.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[x.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[x.cc]}),children:(Xe(x.cc,o)||x.countryLabel||"").toUpperCase()}),x.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[x.sector]}),children:x.sector.toUpperCase()}),x.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[x.stage]}),children:x.stage.toUpperCase()}),typeof x.amountEur=="number"&&x.amountEur>0&&t.jsx("span",{className:"am2",children:ya(x.amountEur,o)})]}),(x.tagline||x.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:x.tagline||x.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[We(x.engine)," ",t.jsx("b",{children:qe(x.engine,o)})," — ",Dr(x.engine,o),x.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",x.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ze,{o:x,lg:!0})," ",t.jsx(Ft,{o:x,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(jn(y,o))," · ",n.win7(Nn(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),x.card?t.jsx(Wn,{spec:x.card}):null,x.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&N>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:x.reasoning})]}),i.pipe&&S&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof x.score=="number"&&x.score>0?" · "+n.score(x.score):""]})})]}),t.jsx(Yn,{name:x.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||c!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[N===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:b,onClick:()=>s(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)]}),N===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),N===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),N===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(x,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(x,!1),a({type:"popup",id:null})},children:n.actNo}),va(x)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{g(x),a({type:"popup",id:null})},children:n.memoDeep})]}),N===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),N===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{l(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),x.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:x.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{u(x),a({type:"popup",id:null})},children:"🚀"})]}):x.engine==="media"&&x.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:b,title:n.evalGoOn(x.name),onClick:()=>s(x),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:b,onClick:()=>s(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)," →"]}),x.website&&t.jsx("a",{className:"psite",href:x.website.startsWith("http")?x.website:"https://"+x.website,target:"_blank",rel:"noopener noreferrer",title:x.website,children:"🌐"})]})]})]}),document.body)}const is=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Nt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ss(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=Nt(a.slice(n));break}r+=Nt(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=Nt(a.slice(o));break}const c=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(c),p=s?s[2].toLowerCase():"";s&&is.has(p)?r+=`<${s[1]}${p}>`:r+=Nt(a.slice(o,i+1)),n=i+1}return r}const xn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function me({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function ls({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=P(),i=Ot(e),c=Je(e),s=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),l=h.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(c?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:d}].filter(v=>v.n>0),[e,a,s,c,p,f,d]),[m,g]=h.useState("");if(!l.length)return null;const u=l.some(v=>v.k===m)?m:l[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:l.map(v=>t.jsx("button",{type:"button",role:"tab","aria-selected":u===v.k,className:u===v.k?"on":"",onClick:b=>{b.stopPropagation(),g(v.k)},children:v.lib},v.k))}),t.jsxs("div",{className:"cdbody",onClick:v=>v.stopPropagation(),children:[u==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),c&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:c}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(me,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(me,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(me,{k:a.cdVerdictDate,v:xn(e.verdictDate,r)})]})]}),u==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:ss(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(cs,{o:e})]}),u==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(me,{k:a.cdSector,v:e.sector}),t.jsx(me,{k:a.cdStage,v:e.stage}),t.jsx(me,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(me,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(me,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(me,{k:a.cdAngle,v:e.angle}),t.jsx(me,{k:a.cdDetected,v:xn(e.date,r)})]}),u==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(me,{k:a.cdName,v:e.contactName}),t.jsx(me,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(me,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),u==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(me,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(me,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function cs({o:e}){const{t:a,token:r}=P(),[n,o]=h.useState(!1),[i,c]=h.useState(null),s=async()=>{n||(o(!0),c(await Br(r,e.name,e.website||e.domain||"")),o(!1))},p=(i==null?void 0:i.blocs)||{},f=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=f.some(([,l])=>l);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[f.filter(([,l])=>l).map(([l,m])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:l}),t.jsx("p",{children:m})]},l)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}const Gn={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Sa({o:e}){const{t:a}=P(),r=Ot(e),n=Je(e),o=ve(e),i=Qt(e),c=_r(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(Gn[n]||"v-cons"),title:a.vt[n],children:n}):o===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,o===3&&i==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),o===3&&i==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),o===3&&c!==null&&t.jsx("span",{className:"wait2 "+(c>10?"hot":c>=5?"warm":""),title:a.waitTitle(c),children:a.waitChip(c)})]})}const ds=e=>e.length>22?e.slice(0,21)+"…":e;function Gt({o:e,compact:a=!1}){const{t:r,askEvaluate:n,evalBusy:o,lang:i}=P(),[c,s]=h.useState(!1);if(h.useEffect(()=>{o||s(!1)},[o]),Ne(e)){const d=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":d?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[d?"✓":"✗"," ",t.jsx("b",{children:d?r.kept:r.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const f=c&&o;return t.jsxs("button",{type:"button",className:"rev"+(a?" rev-min":"")+(f?" loading":""),disabled:o,title:r.evalGoOn(e.name),onClick:d=>{d.stopPropagation(),s(!0),n(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a?"⚡":r.evalGoOn(ds(e.name))})]})}function ps({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:c,doPromote:s,doRepeche:p,doApproach:f,dispatch:d}=P();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:g=>{g.stopPropagation(),d({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return e.engine==="media"&&e.url?t.jsxs("span",{className:"cell cell-duo",children:[t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:g=>{var u;g.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(u=document.querySelector(".atl2 .demand"))==null||u.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]}),t.jsx(Gt,{o:e,compact:!0})]}):t.jsx("span",{className:"cell",children:t.jsx(Gt,{o:e})});const l=ve(e),m=g=>u=>{u.stopPropagation(),g()};if(l===0)return t.jsx("span",{className:"cell",children:t.jsx(Gt,{o:e})});if(l===1){const g=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:g,onClick:m(()=>i(e)),children:g?a.actAnalyseQueued:a.actAnalyse})})}if(l===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:m(()=>c(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:m(()=>c(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(l===4){const g=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:g,onClick:m(()=>f(e)),children:g?a.actApproachSent:a.actApproach})})}return l===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):l===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:m(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function us({o:e}){const{t:a,doThumb:r,thumbOf:n}=P(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function fs({o:e}){const{lang:a}=P();return xe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ze,{o:e}),t.jsx(Ft,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[We(e.engine||"")," ",qe(e.engine||"",a)]})})}function ms({o:e,locked:a,open:r,onToggle:n}){const{st:o,dispatch:i,caps:c,markRow:s,markedId:p,favIds:f,toggleFav:d}=P(),l=ve(e),m=["#0F172A","#475C6E","#8798A8","#B9C6D2"],g=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,u=g<=0?0:g<=7?1:g<=30?2:3,v=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][l]:m[u],b=f.has(e.id),x=y=>{if(a)return;if(c.pipe||e.kind==="op"){n();return}const N=y.currentTarget.getBoundingClientRect();i({type:"popup",id:e.id,anchor:{x:N.left+Math.min(280,N.width/3),y:N.bottom}})};return t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:x,children:[t.jsx("span",{className:"pt",style:{"--c":v}}),t.jsx(er,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:b?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),d(e)},children:b?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""})]}),t.jsx(xs,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(fs,{o:e}),c.pipe&&t.jsx(Sa,{o:e}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(ps,{o:e}),c.showThumbs&&t.jsx(us,{o:e})]}),(r||o.dens==="deplie")&&!a&&t.jsx(hs,{o:e})]})}function xs({o:e}){const{lang:a,caps:r}=P();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=ya(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function hs({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:c}=P();return t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(ls,{o:e}),t.jsx(Vo,{o:e}),t.jsx(Wo,{o:e}),t.jsx(Yn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("span",{children:e.sector}),e.stage&&t.jsx("span",{children:e.stage}),e.countryLabel&&t.jsx("span",{children:e.countryLabel}),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Sa,{o:e})})]}),e.card&&t.jsx(Wn,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[We(e.engine||"")," ",qe(e.engine||"",r)]}),xe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ze,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsxs("div",{className:"sec2 acts2",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"btn p",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>c(e),children:a.actOnboard})]})]})]})}function gs({o:e,locked:a}){const{t:r,dispatch:n,caps:o,doDecide:i}=P(),c=ve(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][c];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":s},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Sa,{o:e}),xe(e)&&t.jsx(Ze,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&o.pipe&&c===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>i(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>i(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function bs(){const e=P(),{st:a,dispatch:r,t:n,caps:o,scoped:i,lang:c,sessTally:s,data:p,dossiers:f,source:d}=e,l=d==="ops"?8:Cn,[m,g]=h.useState({}),[u,v]=h.useState(null),b=a.filters.day;h.useEffect(()=>{if(d!=="ops"||!b){v(null);return}let z=!1;return $r(b).then(A=>{if(z||!(A!=null&&A.masthead))return;const k=A.masthead;v(Object.values(k).reduce((T,I)=>T+(Number(I)||0),0))}),()=>{z=!0}},[d,b]);const[x,y]=h.useState(new Set);h.useEffect(()=>{y(new Set)},[a.ptab,a.continent]);const N=z=>y(A=>{const k=new Set(A);return k.has(z)?k.delete(z):k.add(z),k}),w=h.useMemo(()=>ka(i,a.sort),[i,a.sort]),S=h.useMemo(()=>w.filter(z=>xe(z)&&!Ne(z)).length,[w]),C=h.useMemo(()=>o.pipe?w:w.filter(z=>!Ne(z)),[w,o.pipe]),L=o.pipe?n.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,F=(z,A,k="",T=!1)=>t.jsxs("button",{type:"button","data-s":z,className:k,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:T?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[A,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),j=h.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const z=new Map;w.forEach(T=>{const I=T.engine||"?";z.has(I)||z.set(I,[]),z.get(I).push(T)});const A={ma:0,fundraising:1,media:2},k=Jt([...z.keys()],c);return[...z.entries()].sort((T,I)=>{const B=A[T[0]]??10+k.indexOf(T[0]),W=A[I[0]]??10+k.indexOf(I[0]);return B-W})},[w,o.pipe,a.groupBy,c]),M=o.lockRowsAfter;let q=0;const R=(z,A)=>{const k=a.shown[A]||l,I=z.slice(0,k).map(B=>{const W=M!==null&&q>=M;return q++,a.dens==="maxi"?t.jsx(gs,{o:B,locked:W},B.id):t.jsx(ms,{o:B,locked:W,open:x.has(B.id),onToggle:()=>N(B.id)},B.id)});if(z.length>k){const B=Math.min(l,z.length-k),W=z.length-k;I.push(t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>r({type:"more",group:A,by:l,base:l}),children:[t.jsx("span",{className:"more-label",children:n.more(B,W)}),t.jsxs("span",{className:"more-meta",children:[n.moreMeta(k,z.length)," · ",W," ",c==="en"?"remaining":"restantes"]})]},A+":more"))}return I};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:w.length})," ",L]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,o.pipe&&e.fund?" · "+e.fund:"",d==="ops"&&b&&u!==null&&u>0&&(()=>{const z=f.filter(A=>(A.date||"").slice(0,10)===b).length;return" · "+n.toSendCtx(u,Math.max(0,u-z))})()]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),o.showFunnel&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["deplie",n.densOpen],["maxi",n.densMaxi]].map(([z,A])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z,onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:A})]},z))}),o.showChain&&C.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:C.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(C.length):n.chainAll(C.length)]})]}),S>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(S)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),F("country",n.colCountry),F("name",n.colCompany),F("amount",n.colAmount,"h-amt",!0),F("stage",n.colStage,"h-stade"),F("signal",n.colSignal,"h-sig"),o.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),o.pipe&&F("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[j?j.map(([z,A])=>{const k=d==="ops"&&(z==="ma"||z==="fundraising"),T=z==="ma"?"carte-ma":"carte-levees",I=b?`/actualites/operations/cartes/${T}-${b}.png`:`/actualites/operations/${T}-du-jour.png`;return t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:We(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:qe(z,c)}),t.jsx("div",{className:"s",children:n.grpCount(A.filter(B=>!Ne(B)).length,A.length)})]}),k&&t.jsxs("button",{type:"button",className:"go",onClick:()=>g(B=>({...B,[z]:!B[z]})),children:[m[z]?"▴ ":"▾ ",n.grpCard]})]}),k&&m[z]&&t.jsx("div",{className:"grp-card",children:t.jsx("img",{src:I,alt:"",loading:"lazy",onError:B=>{B.currentTarget.parentElement.style.display="none"}})}),R(A,z)]},z)}):R(w,"pt"+a.ptab),j&&(()=>{const z=j.reduce((A,[k,T])=>A+Math.max(0,T.length-(a.shown[k]||l)),0);return z?t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>j.forEach(([A])=>r({type:"more",group:A,by:l,base:l})),children:[t.jsx("span",{className:"more-label",children:n.more(Math.min(z,l*j.length),z)}),t.jsxs("span",{className:"more-meta",children:[z," ",c==="en"?"remaining":"restantes"]})]}):null})(),!w.length&&!(p.loading&&!f.length)&&t.jsx("div",{className:"void",children:o.pipe?n.emptyTab:n.emptyScope})]}),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}})]})}function hn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function vs(e,a){const r=Ur(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function ys(e,a){const n=[a.head.split("|").map(hn).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",vs(o,a.plabels),Ot(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(hn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function ws(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const ks=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ze({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function js({o:e,qa:a}){const{t:r,lang:n,fund:o}=P(),i=(e.cribleStatus||"").trim().toUpperCase()||(Ot(e)==="NO MATCH"?"NO MATCH":"MATCH"),c=Je(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,c&&t.jsx("em",{children:c})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(ze,{k:r.cdSector,v:e.sector}),t.jsx(ze,{k:r.cdStage,v:e.stage}),t.jsx(ze,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ze,{k:r.cdSite,v:e.domain||e.website}),t.jsx(ze,{k:r.cdName,v:e.contactName}),t.jsx(ze,{k:r.cdEmail,v:e.contactEmail}),t.jsx(ze,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(ze,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(ze,{k:r.cdAngle,v:e.angle}),t.jsx(ze,{k:r.cdDetected,v:ks(e.date,n)})]}),p.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,f])=>f).map(([f,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:d})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Ns(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:c}=P(),[s,p]=h.useState({}),f=25,d=h.useMemo(()=>n.slice(0,f),[n]);h.useEffect(()=>{d.length&&Vr(r,d.map(g=>g.name)).then(p)},[r,d]);const l=i.stats,m=g=>g.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),l&&typeof l.screened=="number"&&t.jsxs("p",{children:[m(l.screened)," ",e.funScreened(""),typeof l.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",m(l.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(m(i.marketEstimate)),", ",Math.round(l.screened/i.marketEstimate*100)," %"]})]})]}),d.map(g=>t.jsx(js,{o:g,qa:s[g.name]},g.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Ss=50;function Ca({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=P(),[i,c]=h.useState(null),[s,p]=h.useState(!1),[f,d]=h.useState(""),[l,m]=h.useState(0),[g,u]=h.useState(""),[v,b]=h.useState(!1),x=h.useRef(null);h.useEffect(()=>()=>{x.current&&window.clearInterval(x.current)},[]);const y=async w=>{p(!0),d("");const S=await a();if(p(!1),S.ok){c(S);return}if(S.busy){d(o.alertPreviewBusy);return}if(!w){d(o.alertPreviewFail);return}m(Ss),x.current=window.setInterval(()=>{m(C=>C>1?C-1:(x.current&&window.clearInterval(x.current),y(!1),0))},1e3)},N=async()=>{if(n||v)return;b(!0),u("");const w=await r();b(!1),u(w.ok?o.alertTestOk(w.sentTo||""):w.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||l>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v,onClick:()=>{N()},children:v?"…":o.alertTest})]}),l>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(l)}),f&&t.jsx("p",{className:"mnote warn",children:f}),g&&t.jsx("p",{className:"mnote",children:g}),!g&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const st="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function be({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=P();return ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Cs(){const{st:e}=P();switch(e.modal){case"chain":return t.jsx(zs,{});case"space":return t.jsx(Ts,{});case"alert":return t.jsx(As,{});case"queue":return t.jsx(Os,{});case"export":return t.jsx(Fs,{});case"plug":return t.jsx(Is,{});case"recharge":return t.jsx($s,{});case"cover":return t.jsx(Us,{});case"dossier":return t.jsx(_s,{});case"crit":return t.jsx(Vs,{});case"tuto":return t.jsx(Hs,{});case"rdv":return t.jsx(Es,{});case"memoalert":return t.jsx(Ps,{});default:return null}}function Es(){const{dispatch:e,fund:a}=P(),r=typeof document<"u"&&!!document.getElementById("rdv");return h.useEffect(()=>{r&&(e({type:"modal",modal:null}),Fo())},[r,e]),r?null:t.jsx(Wr,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function zs(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:c,evalBusy:s}=P(),p=i==="client",f=e.chain.queue.map(g=>r.get(g)).filter(g=>!!g),d=e.chain.idx,l=f[d],m=d>=f.length;return ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:m?n.finished:`${d+1} / ${f.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(m?100:d/Math.max(1,f.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:m||!l?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(f.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:l.name}),t.jsx("div",{className:"sub",children:[Xe(l.cc,o)||l.countryLabel,l.sector,l.stage,n.daysAgo(Qe(l.date))].filter(Boolean).map(g=>String(g).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:qe(l.engine,o).toUpperCase()}),typeof l.amountEur=="number"&&l.amountEur>0&&t.jsx("span",{children:ya(l.amountEur,o)})]}),xe(l)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ze,{o:l,lg:!0})," ",t.jsx(Ft,{o:l,src:!0})]}),(l.tagline||l.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:l.tagline||l.headline})]}),l.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:l.reasoning})]}),p&&Ne(l)&&t.jsxs("div",{className:"vbox",style:{"--c":$e(l)==="retenu"?"var(--brand)":$e(l)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:$e(l)==="retenu"?"✓ "+n.kept:$e(l)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:l.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!m&&l&&!(p&&Ne(l))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{c(l)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(m?{type:"modal",modal:null}:{type:"chainNext"}),children:m?n.closeBtn:n.skip})]})]})})}),document.body)}function Ts(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=P(),i=o==="client",c=h.useMemo(()=>i?r.filter(l=>Ne(l)):[],[r,i]),s=h.useMemo(()=>ka(c.filter(l=>$e(l)==="retenu"),{key:"signal",dir:-1}),[c]),p=h.useMemo(()=>c.filter(l=>$e(l)==="ecarte"),[c]),f=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(be,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(l=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof l.score=="number"&&l.score>0?l.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:l.name}),t.jsx("div",{className:"rr",children:l.reasoning||l.tagline||""})]})]},l.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function As(){const{mode:e}=P();return e==="client"||e==="apercu"?t.jsx(Ls,{}):t.jsx(qs,{})}function Ls(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=P(),[i,c]=h.useState("d"),s=o!=="client";return t.jsxs(be,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>c("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>c("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>c("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Rs,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(Ms,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(Kn,{})]})}function Rs({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,c]=h.useState(null),[s,p]=h.useState(!1),[f,d]=h.useState(0);h.useEffect(()=>{let u=!0;return p(!1),Pa(a).then(v=>{u&&(v?c(v):p(!0))}),()=>{u=!1}},[a,f]);const l=u=>{r||Pa(a,u).then(v=>{if(!v){o(e.actErr);return}c(v),v.throttled?o(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(u=>u+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=u=>!i.sections||i.sections.includes(u),g=u=>{const v=i.sections||e.alertSec.map(([b])=>b);l({sections:m(u)?v.filter(b=>b!==u):[...v,u]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>l({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>l({hour:Math.max(6,(i.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[i.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>l({hour:Math.min(21,(i.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>l({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>l({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([u,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:m(u),disabled:r,onChange:()=>g(u)}),t.jsxs("span",{children:[v,u==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},u))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ca,{label:e.alertPreview,readOnly:r,onPreview:()=>eo(a),onTest:()=>Zr(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ms({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,c]=h.useState(null),[s,p]=h.useState(!1),[f,d]=h.useState(0);h.useEffect(()=>{let u=!0;return p(!1),Da(a).then(v=>{u&&(v?c(v):p(!0))}),()=>{u=!1}},[a,f]);const l=u=>{r||Da(a,u).then(v=>{if(!v){o(e.actErr);return}c(v),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(u=>u+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=i.dow??0,g=i.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>l({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:m,disabled:r,onChange:u=>l({dow:Number(u.target.value)}),children:e.alertDow.map((u,v)=>t.jsx("option",{value:v,children:u},u))}),t.jsx("button",{type:"button",onClick:()=>l({hour:Math.max(6,g-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[g," h"]}),t.jsx("button",{type:"button",onClick:()=>l({hour:Math.min(21,g+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ca,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ao(a),onTest:()=>to(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Kn(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=P(),[c,s]=h.useState(i||""),[p,f]=h.useState(!1),[d,l]=h.useState(!1);h.useEffect(()=>{i&&s(i)},[i]);const m=e.filters,g=h.useMemo(()=>n.filter(x=>xe(x)).length,[n]),u=m.win==="1"?0:m.win==="7"?1:m.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(c)||d)){l(!0);try{await fetch(`${xa}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:c.trim(),sectors:m.sector,countries:m.country,source:i?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{l(!1)}}},b=[[a.amRows.continent,o],[a.amRows.since,a.amSince[u]],[a.amRows.signal,m.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,m.engine.length?m.engine.map(x=>qe(x,r)).join(", "):a.amAllEngines],[a.amRows.sectors,m.sector.length?m.sector.join(", "):a.amAllSectors],[a.amRows.countries,m.country.length?m.country.map(x=>Xe(x,r)||x).join(", "):a.amAllCountries],[a.amRows.stages,m.stage.length?m.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(c)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:b.map(([x,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:x}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},x))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:c,readOnly:!!i,onChange:x=>s(x.target.value),onKeyDown:x=>{x.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,g)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function qs(){const{t:e}=P();return t.jsx(be,{title:e.alertTitle,icon:"🔔",children:t.jsx(Kn,{})})}function Os(){var v,b,x;const{t:e,token:a,fund:r,mode:n,flash:o}=P(),[i,c]=h.useState(null),[s,p]=h.useState([]),[f,d]=h.useState(0),l=n==="client";h.useEffect(()=>{let y=!0;return(async()=>{const[N,w]=await Promise.all([ga(r),wn(a)]);y&&(N&&c(N),p(w))})(),()=>{y=!1}},[a,r,f]);const m=(i==null?void 0:i.per_day)??2,g=((v=i==null?void 0:i.analyzed_today)==null?void 0:v.length)??0,u=(b=i==null?void 0:i.tomorrow)!=null&&b.length?i.tomorrow:((i==null?void 0:i.pool_meta)||[]).slice(0,10);return t.jsxs(be,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(g,g+(((x=i==null?void 0:i.pool_order)==null?void 0:x.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(m)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),l&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Fa(a,y.company,"retry").then(()=>d(N=>N+1))},children:e.queueRetry}),l&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Fa(a,y.company,"delete").then(()=>d(N=>N+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[u.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),u.slice(0,10).map((y,N)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",N+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Fs(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:c}=P(),s=`${st}/cibles/list.csv?token=${a}`,p=`${st}/cibles/list.json?token=${a}`,f=`${st}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,l=b=>{var x;(x=navigator.clipboard)==null||x.writeText(b).then(()=>r(e.exportCopied))},m=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:f,href:f}],g=!o.lockActions&&n.length>0,u=()=>{ws(ys(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:b=>(e.stg.find(([x])=>x===b)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(be,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>c({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:u,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:m.map(({def:b,value:x,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:b[0]}),t.jsxs("div",{children:[t.jsx("b",{children:b[1]}),t.jsx("p",{children:b[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l(x),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},b[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Ps(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=P(),i=o!=="client",[c,s]=h.useState(null),[p,f]=h.useState(!1),[d,l]=h.useState(0),[m,g]=h.useState(!1);h.useEffect(()=>{let x=!0;return f(!1),Oa(a).then(y=>{x&&(y?s(y):f(!0))}),()=>{x=!1}},[a,d]);const u=()=>(c==null?void 0:c.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=x=>{if(i||!c)return;const y={enabled:x.enabled??!!c.enabled,email:x.email??(c.email||""),sections:x.sections??u()};g(!0),Oa(a,y).then(N=>{if(g(!1),!N){n(e.memoAlertErr);return}s(N),r(e.memoAlertSaved)})};if(p)return t.jsx(be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>l(x=>x+1),children:e.retry})]})});if(!c)return t.jsx(be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const b=u();return t.jsxs(be,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":c.enabled===!0,disabled:i||m,style:c.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!c.enabled}),children:c.enabled?"ON":"OFF"})})]}),t.jsx(Ds,{value:c.email||"",readOnly:i||m,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:x=>v({email:x})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([x,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!b[x],disabled:i||m,onChange:()=>v({sections:{...b,[x]:!b[x]}})}),t.jsx("span",{children:y})]},x))}),t.jsx(Ca,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Yr(a,b),onTest:()=>Hr(a,b)})]})}function Ds({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,c]=h.useState(e);h.useEffect(()=>{c(e)},[e]);const s=i.trim()!==e.trim(),p=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:f=>c(f.target.value),onKeyDown:f=>{f.key==="Enter"&&s&&p&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>o(i.trim()),children:n})]})]})}function Is(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=P(),[i,c]=h.useState(null),[s,p]=h.useState(!1),[f,d]=h.useState(null),[l,m]=h.useState(""),[g,u]=h.useState(0);h.useEffect(()=>{let x=!0;return p(!1),Xt(a).then(y=>{x&&(y?c({configured:y.configured,url_hint:y.url_hint}):p(!0))}),Kr(a).then(y=>{x&&d(y)}),()=>{x=!1}},[a,g]);const v=(x,y)=>{o&&Xt(a,x).then(N=>{if(!N||N.ok===!1){n(e.actErr);return}x.test&&N.sent===!1?n(e.plugTestThrottled):r(y),u(w=>w+1)})},b='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(be,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>u(x=>x+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:l,disabled:!o,onChange:x=>m(x.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!l.trim(),onClick:()=>v({url:l.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(Bs,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:b}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var x;(x=navigator.clipboard)==null||x.writeText(b).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function Bs(){const{t:e,token:a,lang:r}=P(),[n,o]=h.useState("valides"),[i,c]=h.useState(!1),[s,p]=h.useState(null),[f,d]=h.useState(null),[l,m]=h.useState(!1),[g,u]=h.useState(!1),[v,b]=h.useState(null),[x,y]=h.useState(null),[N,w]=h.useState(null),S=`atl2:bulk:${a}:${n}`;h.useEffect(()=>{Xt(a).then(R=>{y(R&&R.configured?R.url_hint||"webhook":null)})},[a]),h.useEffect(()=>{p(null),d(null),m(!1),b(null);try{const R=JSON.parse(localStorage.getItem(S)||"null");w(R&&Date.now()-Date.parse(R.t)<24*3600*1e3?R:null)}catch{w(null)}},[S]);const C=async()=>{c(!0),m(!1),b(null);const R=await Jr(a,n);p(R),d(R.ok?n:null),c(!1)},L=h.useRef(!1),F=async()=>{if(L.current)return;L.current=!0,u(!0);const R=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let z;try{z=await Xr(a,n,"webhook",void 0,R)}finally{L.current=!1}if(u(!1),m(!1),b(z),z.ok&&(z.pushed||0)>0){const A={t:new Date().toISOString(),n:z.pushed||0};w(A);try{localStorage.setItem(S,JSON.stringify(A))}catch{}}},j=s!=null&&s.ok&&s.ready||0,M=!!(s!=null&&s.ok)&&f===n&&j>0&&!!x&&!N,q=N?new Date(N.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:R=>o(R.target.value),children:e.plugBulkTabs.map(([R,z])=>t.jsx("option",{value:R,children:z},R))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{C()},children:i?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),N&&t.jsx("p",{className:"mnote",children:e.bulkLocked(q,N.n)}),!N&&!!(s!=null&&s.ok)&&!x&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!N&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),M&&!l&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>m(!0),children:e.bulkArm}),M&&l&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(j,x||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:g,onClick:()=>{F()},children:g?e.bulkSending:e.bulkConfirm(x||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:g,onClick:()=>m(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function $s(){const{t:e,data:a,lang:r}=P(),n=a.credits,o=a.email,i=async c=>{if(!o)return;const s=window.location.href.split("?")[0];try{const f=await(await fetch(`${xa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:c,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(be,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(c=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(c.credits,c.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(c.lookup_key)},children:e.rechargeBuy})]},c.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function _s(){const{t:e}=P();return t.jsx(be,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Ns,{})})}function Us(){const{t:e,lang:a,data:r,dossiers:n,token:o,canWrite:i,flash:c}=P(),[s,p]=h.useState(null),[f,d]=h.useState(!1);h.useEffect(()=>{let C=!0;return ga(o).then(L=>{C&&L&&typeof L.per_day=="number"&&p(L.per_day)}),()=>{C=!1}},[o]);const l=r.stats,m=typeof(l==null?void 0:l.screened)=="number"?l.screened:n.filter(C=>C.kind==="target"&&Ne(C)).length,g=r.marketEstimate||0,u=g>0?Math.min(100,Math.round(m/g*100)):null,v=(l==null?void 0:l.window_days)||30,b=m>0?m/v:0,x=g>0?Math.max(0,g-m):0,N=g>0&&b>0&&m>=100?Math.round(x/b):null,w=C=>Math.round(C).toLocaleString(a==="en"?"en-US":"fr-FR"),S=C=>{f||!i||(d(!0),Qr(o,C).then(L=>{if(d(!1),L===null){c(e.actErr);return}p(L),c(e.alertSaved)}))};return t.jsxs(be,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(m))}),g>0&&t.jsx("span",{children:e.covOf(w(g))})]}),u!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:u+"%"}}),t.jsxs("em",{children:[u," %"]})]}),N!==null&&t.jsx("p",{className:"mnote",children:e.covEta(N)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),b>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(b))}),l&&t.jsxs("div",{className:"covf",children:[typeof l.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(l.kept)})," ",e.covKept]}),typeof l.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(l.analyzed)})," ",e.covAna]}),typeof l.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(l.shown)})," ",e.covShown]})]}),i&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:s===C?"on":"",disabled:f,onClick:()=>S(C),children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Vs(){var x,y,N;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i}=P(),c=n==="client",s=h.useMemo(()=>{const w=new Set;return a.forEach(S=>{S.angle&&w.add(S.angle)}),[...w]},[a]),[p,f]=h.useState(null);h.useEffect(()=>{let w=!0;return Gr(r).then(S=>{w&&f(S.thumbs)}),()=>{w=!1}},[r]);const[d,l]=h.useState(""),[m,g]=h.useState(""),[u,v]=h.useState(!1),b=async()=>{const w=d.trim();if(!(!w||u||!c)){v(!0),g("");try{const C=await(await fetch(`${st}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(C.reply&&g(String(C.reply)),C.job_id){g(e.critChatRunning);const L=async()=>{const F=await fetch(`${st}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:C.job_id})}).then(j=>j.json()).catch(()=>null);if(F&&F.done){g(String(F.reply||F.clarification||F.summary||"✓")),v(!1),F.applied&&o(e.alertSaved);return}setTimeout(()=>{L()},8e3)};setTimeout(()=>{L()},8e3),l("");return}l("")}finally{m.startsWith("⏳")||v(!1)}}};return t.jsxs(be,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((x=i.points)!=null&&x.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var S,C;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((S=w.look)!=null&&S.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(L=>t.jsx("li",{children:L},L))})]}),!!((C=w.out)!=null&&C.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(L=>t.jsx("li",{children:L},L))})]})]})]},w.title)})]}),!!((N=i==null?void 0:i.gate)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||u,onChange:w=>l(w.target.value),onKeyDown:w=>{w.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},disabled:!c||u||!d.trim(),onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),m&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:m})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,S)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},S))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,S])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Gn[w]||"v-cons"),children:w}),t.jsx("span",{children:S})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,S])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",S]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Hs(){const{t:e,dispatch:a,startTour:r}=P(),n=o=>{var i,c;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(c=document.querySelector(".atl2 .demand input"))==null||c.focus())};return t.jsxs(be,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],c)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:c+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+c))})]})}const Kt={},gn=(Kt==null?void 0:Kt.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function qt(){return new Date().toISOString().slice(0,10)}const Qn=h.createContext(null);function Jn(){const e=h.useContext(Qn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ys({token:e,children:a}){const{dispatch:r,st:n,lang:o}=P(),[i,c]=h.useState(()=>n.filters.day||qt()),[s,p]=h.useState(null),[f,d]=h.useState(!1),l=h.useCallback(u=>{if(/^\d{4}-\d{2}-\d{2}$/.test(u)){c(u);try{r({type:"filters",patch:{day:u,win:"all"}})}catch{}}},[r]);h.useEffect(()=>{n.filters.day||l(qt())},[]),h.useEffect(()=>{const u=v=>{var x;const b=(x=v.detail)==null?void 0:x.day;typeof b=="string"&&l(b)};return window.addEventListener("pp-edition-day",u),()=>window.removeEventListener("pp-edition-day",u)},[l]),h.useEffect(()=>{n.filters.day&&n.filters.day!==i&&c(n.filters.day)},[n.filters.day]),h.useEffect(()=>{if(!e||!i)return;let u=!1;d(!0);const v=new URLSearchParams({token:e,date:i});return fetch(`${gn}/cibles/edition.json?${v}`).then(b=>b.json()).then(b=>{u||p(b)}).catch(()=>{u||p({ok:!1,error:"network"})}).finally(()=>{u||d(!1)}),()=>{u=!0}},[e,i]);const m=h.useMemo(()=>`${gn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),g=h.useMemo(()=>({token:e,day:i,ed:s,loading:f,pickDay:l,daysUrl:m,isEn:o==="en"}),[e,i,s,f,l,m,o]);return t.jsx(Qn.Provider,{value:g,children:a})}function Ws(){const{day:e,daysUrl:a,pickDay:r,isEn:n}=Jn();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsx("p",{className:"thesis-days__h",children:n?"Thesis brief · pick a day":"Brief thèse · choisir un jour"}),t.jsx(no,{mode:"local",theme:"light",month:e.slice(0,7),current:e,daysUrl:a,onPick:r})]})}function Gs(){const{day:e,ed:a,loading:r,pickDay:n,isEn:o}=Jn(),i=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),c=(a==null?void 0:a.ok)&&!i,s=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!i&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),s&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["No thesis brief for ",t.jsx("b",{children:e})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):t.jsxs(t.Fragment,{children:["Pas encore de brief de thèse pour le ",t.jsx("b",{children:e}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),i&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,i&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,e&&e!==qt()&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:()=>n(qt()),children:o?"← Back to today":"← Revenir à aujourd’hui"})]})}const Xn="atl2:mapfold",Ks=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Xn);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Zn=h.createContext(null),P=()=>{const e=h.useContext(Zn);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ze({o:e,lg:a}){const{lang:r}=P(),n=xe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ia(n,r),children:[n.emoji," ",Ia(n,r)]}):null}function Ft({o:e,src:a}){const{lang:r,t:n}=P(),o=xe(e);if(!o)return null;const i=lo(o),c=co(o);return t.jsxs("em",{className:"sigwin"+(c?" hot":""),title:n.signaledOn(jn(o,r))+" · "+n.win7(Nn(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<i?"on":""},p))}),t.jsx("span",{className:"lb",children:c?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function er({o:e}){const{lang:a}=P(),r=so(e.cc),n=e.cc?Xe(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const bn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",tr=e=>`atl2:tour:${e||"anon"}`;function Qs(e){try{return localStorage.getItem(tr(e))==="1"}catch{return!0}}function vn(e){try{localStorage.setItem(tr(e),"1")}catch{}}function Js(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function nl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){const{lang:c}=ro(),s=bo[c],p=To(e,c,a),[f,d]=h.useReducer(Lo,void 0,()=>Ao((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Ks(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),l=h.useRef(!0);h.useEffect(()=>{if(l.current){l.current=!1;return}if(!e)try{localStorage.setItem(Xn,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e]);const m=h.useRef(i);m.current=i,h.useEffect(()=>{var E;(E=m.current)==null||E.call(m,f.filters)},[f.filters]);const[g,u]=h.useState(null),[v,b]=h.useState(null),[x,y]=h.useState({kept:0,dropped:0}),[N,w]=h.useState(!1),[S,C]=h.useState(""),[L,F]=h.useState(!1),[j,M]=h.useState(null),[q,R]=h.useState(!1),[z,A]=h.useState(!1),[,k]=h.useState(0),T=()=>k(E=>E+1),I=h.useRef([]),B=h.useRef(new Set),W=h.useRef(new Set),he=h.useRef(new Map),_=h.useRef(null),{mode:le}=p,V=h.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[p.caps,o,a]),K=V.pipe,U=p.session.token||"",Q=le==="client"&&!e;h.useEffect(()=>{if(document.querySelector(`link[href="${bn}"]`))return;const E=document.createElement("link");E.rel="stylesheet",E.href=bn,document.head.appendChild(E)},[]);const H=(E,D=!1)=>{C(E),F(D),_.current&&clearTimeout(_.current),_.current=setTimeout(()=>C(""),D?4200:2400)},re=E=>H(E,!0),ne=h.useMemo(()=>{const E=new Map;return p.dossiers.forEach(D=>{D.id&&E.set(D.id,D)}),E},[p.dossiers]),pe=h.useMemo(()=>p.dossiers.filter(E=>En(E,f,K)),[p.dossiers,f,K]),ee=h.useRef(!1);h.useEffect(()=>{if(ee.current||e||p.loading||!p.dossiers.length)return;if(!V.showFunnel||Qs(p.session.token||"")){ee.current=!0;return}ee.current=!0;const E=window.setTimeout(()=>{vn(p.session.token||""),R(!0)},700);return()=>window.clearTimeout(E)},[e,p.loading,p.dossiers.length,V.showFunnel,p.session.token]);const oe=h.useMemo(()=>p.dossiers.filter(E=>Ro(E,f,K,p.favIds)),[p.dossiers,f,K,p.favIds]),Ce=h.useMemo(()=>oo(pe,p.favIds),[pe,p.favIds]),G=ba.find(E=>E.key===f.continent),de=f.continent==="monde"?s.contWorld:(c==="fr"?G==null?void 0:G.fr:G==null?void 0:G.en)||"";h.useEffect(()=>{const E=D=>{var ce;const $=(((ce=D.detail)==null?void 0:ce.name)||"").trim();$&&ge(null,$)};return window.addEventListener("ppmap:evaluate",E),()=>window.removeEventListener("ppmap:evaluate",E)});const ge=(E,D)=>{const $=((E==null?void 0:E.name)||D||"").trim();if(!Q){b({kicker:$});return}!$||N||(w(!0),(async()=>{try{const ce=await kn(U,$,"atelier2"),mt={name:ce.company||$,verdict:ce.verdict,reason:ce.reason||"",remaining:ce.remaining??null};I.current=[mt,...I.current].slice(0,8),ce.verdict==="kept"&&y(De=>({...De,kept:De.kept+1})),ce.verdict==="ruled_out"&&y(De=>({...De,dropped:De.dropped+1}));const et=E||p.dossiers.find(De=>(De.name||"").toLowerCase()===$.toLowerCase());et&&(ce.verdict==="kept"?et.verdict=et.verdict||"MATCH":ce.verdict==="ruled_out"&&(et.verdict="NO MATCH"),ce.reason&&(et.reasoning=ce.reason)),T()}finally{w(!1)}})())},fe=E=>{if(!Q){b({kicker:E.name});return}B.current.add(E.id),tt(U,"fast_request",E.name||"",""),H(s.memoInstantSent(E.name)),T()},Le=E=>he.current.get(E.id)??p.thumbs.get((E.name||"").trim().toLowerCase()),O=(E,D)=>d({type:"undoPush",entry:{id:E.id,name:E.name,prevCeoStatus:D}}),J=async(E,D,$)=>{const ce=E.ceoStatus||"";E.ceoStatus=D,T();const mt=await $t(U,{status:D,airtable_id:E.airtableId,check_id:E.checkId,company:E.name,...($==null?void 0:$.note)!==void 0?{note:$.note}:{},...$!=null&&$.via?{via:$.via}:{}});return mt.ok?mt.skipped?(E.ceoStatus=ce,T(),re(s.actNotPersisted),!1):(($==null?void 0:$.undo)!==!1&&O(E,ce),$!=null&&$.msg&&H($.msg),(D==="Validé"||D==="Écarté")&&!E.ceoNote&&($==null?void 0:$.note)===void 0&&M({o:E,yes:D==="Validé"}),!0):(E.ceoStatus=ce,T(),re(s.actErr),!1)},ae=async(E,D)=>{const $=await $t(U,{status:E.ceoStatus||"Retenu",airtable_id:E.airtableId,check_id:E.checkId,company:E.name,note:D,via:"note"});return!$.ok||$.skipped?(re($.skipped?s.actNotPersisted:s.actErr),!1):(E.ceoNote=D,T(),!0)},X=h.useRef(new Map),Ee=E=>X.current.has(E.id)?X.current.get(E.id):p.stages.get((E.name||"").trim().toLowerCase()),Oe=(E,D)=>{X.current.set(E.id,D),T()},Fe=(E,D)=>{Q&&J(E,D?"Validé":"Écarté",{msg:D?s.decidedYes(E.name):s.decidedNo(E.name)})},ft=E=>{Q&&J(E,"À trancher",{msg:s.promoted(E.name)})},Pt=E=>{Q&&(async()=>{const D=E.ceoStatus||"";E.ceoStatus="Retenu",T();const $=await $t(U,{status:"Retenu",check_id:E.checkId,company:E.name});if(!$.ok||$.skipped){E.ceoStatus=D,T(),re($.skipped?s.actNotPersisted:s.actErr);return}O(E,D),H(s.repeched(E.name))})()},Dt=()=>{const E=f.undo[f.undo.length-1];if(!E){H(s.undoNone);return}const D=ne.get(E.id);if(!D){d({type:"undoPop"}),H(s.undoNone);return}let $=E.prevCeoStatus;if(!$)if((D.verdict||"").toUpperCase().includes("CALL"))$="À trancher";else{H(s.undoLockedTitle);return}(async()=>await J(D,$,{undo:!1})&&(d({type:"undoPop"}),D.ceoStatus=E.prevCeoStatus,T(),H(s.undoDone(D.name))))()},Pe=E=>{Q&&(W.current.add(E.id),T(),(async()=>{const D=await po(U,E.name,"email");if(!D||D.ok===!1){W.current.delete(E.id),T(),re(s.actErr);return}tt(U,"approach",E.name||"",""),H(s.actApproachSent)})())},ar=(E,D)=>{Q&&(async()=>{if(!(await tt(U,D?"yes":"no",E.name||"","")).ok){re(s.actErr);return}he.current.set(E.id,D?"yes":"no"),T(),H(D?s.thumbUpDone:s.thumbDnDone)})()},nr=E=>{!Q||!va(E)||(tt(U,"detailed_request",E.name||"",""),H(s.memoDeepSent(E.name)))},rr=E=>{const D=new Set(p.favIds),$=D.has(E.id);$?D.delete(E.id):D.add(E.id),p.setFavIds(D),Q&&uo(U,{id:E.id,co:E.name},$)},or=()=>{!Q||z||window.confirm(s.identSyncConfirm)&&(A(!0),(async()=>{const E=await fo(U);A(!1),E?H(s.identSyncDone):re(s.actErr)})())},Ea=/proplace/i.test(p.fund||""),ir=E=>{!Q||!Ea||(tt(U,"onboard_request",E.name||"",""),H(s.onboardSent(E.name)))},sr={st:f,dispatch:d,t:s,lang:c,mode:le,caps:V,pipe:K,token:U,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:Pt,thumbOf:Le,canWrite:Q,commitStatus:J,saveNote:ae,stageOf:Ee,setStage:Oe,flashErr:re,startTour:()=>R(!0),dossiers:p.dossiers,scopedAll:pe,scoped:oe,counts:Ce,byId:ne,contName:de,favIds:p.favIds,toggleFav:rr,askEvaluate:ge,doAnalyse:fe,doDecide:Fe,doPromote:ft,doApproach:Pe,doThumb:ar,doDeep:nr,doUndo:Dt,doSync:or,doOnboard:ir,outbound:Ea,memoQueued:B.current,approachDone:W.current,sessTally:x,evalCards:I.current,evalBusy:N,markRow:u,markedId:g,flash:H};h.useEffect(()=>{const E=D=>{D.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",E),()=>window.removeEventListener("keydown",E)},[]);const lr=E=>U?t.jsx(Ys,{token:U,children:E}):t.jsx(t.Fragment,{children:E});return t.jsx(Zn.Provider,{value:sr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:wo}),lr(t.jsxs("div",{className:"app"+(K?" pipe":"")+(U?" has-thesis":""),children:[V.showTicker&&t.jsx(ue,{name:"live",children:t.jsxs("div",{className:"live-stack"+(U?" live-stack--cibles":""),children:[t.jsx(Mo,{}),!!U&&t.jsx(Ws,{})]})}),V.showIdent&&t.jsx(ue,{name:"identite",children:t.jsx(Qo,{})}),V.showOnb&&t.jsx(ue,{name:"onboarding",children:t.jsx(Jo,{})}),V.showMorning&&t.jsx(ue,{name:"matin",children:t.jsx(Ko,{})}),t.jsx(ue,{name:"fraicheur",children:t.jsx($o,{})}),t.jsx(ue,{name:"mesure",children:t.jsx(_o,{})}),V.showFunnel&&t.jsx(ue,{name:"entonnoir",children:t.jsx(Xs,{})}),V.showFunnel&&t.jsx(ue,{name:"tunnel",children:t.jsx(Zo,{})}),V.showFunnel&&t.jsx(ue,{name:"tuto",children:t.jsx(ti,{})}),t.jsx(ue,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Zs,{}),t.jsxs("div",{className:"stage"+(f.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(Ki,{}),t.jsx(Ji,{})]})]})}),V.showDemand&&t.jsx(ue,{name:"evaluation",children:t.jsx(es,{})}),V.showDemand&&f.memoConsole&&t.jsx(ue,{name:"console",children:t.jsx(as,{})}),t.jsx(ue,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(bs,{})}),!!U&&t.jsx(ue,{name:"edition",children:t.jsx(Gs,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),V.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),f.popupId&&t.jsx(ue,{name:"fiche",children:t.jsx(os,{})}),t.jsx(ue,{name:"modales",children:t.jsx(Cs,{})}),t.jsx(Do,{}),j&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:j.o.name}),t.jsx(Yo,{placeholder:j.yes?s.whyYesPh:s.whyNoPh,onDone:E=>{const D=j.o;M(null),E&&ae(D,E).then($=>{$&&H(s.csNoteSaved)})}})]}),q&&t.jsx(Go,{steps:Js(s),onClose:()=>{R(!1),vn(U)}}),S&&t.jsx("div",{className:"flash on"+(L?" err":""),children:S}),v&&t.jsx(io,{variant:"acquirer",initialCompany:yn().co,initialWebsite:yn().site,onClose:()=>b(null)})]})})}function Xs(){const{t:e}=P(),[a,r]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Zs(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:o,t:i}=P(),c=h.useMemo(()=>{const s={};return e.forEach(p=>{wa(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[mo.map(s=>{const p=ba.find(d=>d.key===s),f=s==="monde"?i.contWorld:o==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[f,t.jsx("span",{className:"n",children:c[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?i.showMap:i.hideMap})})]})}function yn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function el(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{er as FlagCell,Ze as SigBadge,Ft as SigWin,nl as default,el as fmtShort,P as useV2};
