...
`;class be extends h.Component{constructor(){super(...arguments);Pa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const si=8;function li(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=F(),[s,c]=h.useState(!1),[g,d]=h.useState(!1),[f,u]=h.useState(!1),x=r||"home",{names:p,verdicts:b}=h.useMemo(()=>{const w=[],E={};return n.forEach(A=>{A.kind!=="target"||!A.name||(w.push(A.name),E[A.name]=Br(A)||"")}),{names:w,verdicts:E}},[n]),v=h.useMemo(()=>p.length?_r(x,p,b,a):null,[x,p.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const m=g?v.added:v.added.slice(0,si),y=v.added.length-m.length,j=w=>{const E=n.find(A=>A.name===w);E&&(o(E.id),l({type:"popup",id:E.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{c(!0),Ur(x,p,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[m.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),f&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const ea=600,We=62,en="atl2:fstats";function di(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=F(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(en)==="on"}catch{return!1}}),c=r.stats,g=h.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=h.useMemo(()=>{if(c!=null&&c.since)return c.since;const y=new Date;return y.setDate(y.getDate()-((c==null?void 0:c.window_days)||30)),y.toISOString().slice(0,10)},[c==null?void 0:c.since,c==null?void 0:c.window_days]);if(!n.showFunnel||!c||typeof c.screened!="number")return null;const f=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),x=g.reduce((y,j)=>Math.max(y,j.s||0),0),p=g.length?ea/g.length:0,b=Math.max(4,p-4),v=g.length>=5&&x>0,m=[[c.screened,e.funScreened(f(d)),c.screened_today],...typeof c.kept=="number"?[[c.kept,e.funKept,c.kept_today]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed,c.analyzed_today]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[m.map(([y,j,w],E)=>t.jsxs("span",{className:"fst-t",children:[E>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:j}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(en,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ea} ${We}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((y,j)=>{const w=(y.s||0)/x*(We-4),E=(y.m||0)/x*(We-4),A=j*p+(p-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:We-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:We-2-E,width:b,height:E,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:We-1.5,x2:ea,y2:We-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const ci=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function pi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=F(),[o,l]=h.useState(""),[s,c]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(Ze(e)||"").startsWith("CALL")&&ke(e)===3,f=ke(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const b=await i(e,p);l(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},x=d?[["Validé",a.csYes],["Écarté",a.csNo]]:ci.filter(([p])=>!(f&&p==="Retenu")).map(([p,b])=>[p,a[b]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),x.map(([p,b])=>t.jsx("button",{type:"button",className:"csb"+(g===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:b},p)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ui,{o:e})]})}function ui({o:e}){const{t:a,saveNote:r,flash:n}=F(),[i,o]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[c,g]=h.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(l||!d)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{f()},children:c?a.csNoteSaved:a.csNoteOk})]})}function fi({placeholder:e,onDone:a}){const{t:r}=F(),[n,i]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function mi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=F(),[c,g]=h.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const d=o(e),f=(d==null?void 0:d.stage)||"todo",u=async m=>{if(c||m===f)return;g(!0);const y=d;l(e,{stage:m,stamps:(d==null?void 0:d.stamps)||{}});const j=Math.max(Date.now(),tn+=1);tn=j;const w=await Vr(r,{company:e.name||"",stage:m,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},x=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,p=x?Math.floor((Date.now()-Date.parse(x))/864e5):0,b=f==="sent"&&x&&p>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(f===m?" on":""),disabled:c,onClick:()=>{u(m)},children:y},m)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let tn=0;const Ct=8,Et=340;function an({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function xi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=F(),[l,s]=h.useState(0),[c,g]=h.useState(null),[d,f]=h.useState([]),u=h.useRef(!1);h.useEffect(()=>{u.current||(u.current=!0,f(e.filter(j=>!!document.querySelector(j.need||j.sel))))},[e]);const x=d[l],p=l>=d.length;h.useEffect(()=>{x&&(x.ptab!==void 0&&o.ptab!==x.ptab&&n({type:"ptab",tab:x.ptab}),x.dens&&o.dens!==x.dens&&n({type:"dens",dens:x.dens}))},[l,x]);const b=h.useCallback(()=>{if(!x){g(null);return}const j=document.querySelector(x.sel);if(!j){g(null);return}j.scrollIntoView({block:"nearest",behavior:"smooth"}),g(j.getBoundingClientRect())},[x]);h.useLayoutEffect(()=>{b();const j=window.setTimeout(b,260),w=()=>b();return window.addEventListener("scroll",w,!0),window.addEventListener("resize",w),()=>{window.clearTimeout(j),window.removeEventListener("scroll",w,!0),window.removeEventListener("resize",w)}},[b]);const v=h.useRef(a);if(v.current=a,h.useEffect(()=>{const j=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),v.current()):w.key==="ArrowRight"?s(E=>E+1):w.key==="ArrowLeft"&&s(E=>Math.max(0,E-1))};return document.addEventListener("keydown",j,!0),()=>document.removeEventListener("keydown",j,!0)},[]),!d.length)return null;let m=null;if(p){const j=i[3]||0;j>0?m={title:j===1?r.ahaATitle1:r.ahaATitleN(j),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:(i[1]||0)>0?m={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:()=>{n({type:"ptab",tab:1}),a()}}:m={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Et};if(!p&&c){const j=c.bottom+14,E=window.innerHeight-j>190?j:Math.max(12,c.top-200);y={left:Math.min(Math.max(12,c.left+c.width/2-Et/2),window.innerWidth-Et-12),top:E,width:Et}}return it.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!p&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Ct,top:c.top-Ct,width:c.width+Ct*2,height:c.height+Ct*2}}),(p||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(p?" fin":""),style:y,children:[p&&m?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:m.title}),t.jsx("p",{children:t.jsx(an,{text:m.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:m.go,children:m.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(l+1,d.length)}),t.jsx("h3",{children:x==null?void 0:x.title}),t.jsx("p",{children:t.jsx(an,{text:(x==null?void 0:x.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(j=>Math.max(0,j-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(j=>j+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function hi(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,dispatch:l}=F(),s=r?a:e,c=h.useMemo(()=>s.filter(m=>ot(m.date)===0&&m.kind==="target"),[s]),g=h.useMemo(()=>r?a.filter(m=>ke(m)===0).slice().sort((m,y)=>(y.date||"").localeCompare(m.date||"")):[],[a,r]),d=h.useMemo(()=>c.filter(m=>r?ke(m)===0:!Ae(m)),[c,r]),f=r?g:d,u=r?a.length-g.length:c.length-d.length,x=r?a.length:c.length,p=x?Math.min(100,u/x*100):100;let b;r?b=i.morningThesis(c.length,g.length):c.length?u===0?b=i.goalSourced(c.length):u>=c.length?b=i.goalCleared:b=i.goalDone(u,c.length):b=i.goalSourced(0);const v=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&g.length&&l({type:"chainStart",queue:g.map(m=>m.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:b}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:p+"%"}})}),f.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:v,children:r?i.morningEval(f.length):o.pileMode?i.goalContinue(f.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function gi(){var M,O;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:c,doSync:g,startTour:d}=F(),[f,u]=h.useState(null),[x,p]=h.useState([]),b=c==="client";h.useEffect(()=>{if(!i||!o)return;let L=!0;return(async()=>{const[_,k]=await Promise.all([Aa(o),Pn(i)]);L&&(_&&u(_),p(k))})(),()=>{L=!1}},[i,o]);const v=(f==null?void 0:f.per_day)??null,m=((M=f==null?void 0:f.pool_order)==null?void 0:M.length)??0,y=x.filter(L=>L.status==="running").length,j=h.useMemo(()=>s.filter(L=>L.kind==="target"&&Ae(L)).length,[s]),w=l.marketEstimate,E=typeof((O=l.stats)==null?void 0:O.screened)=="number"?l.stats.screened:j,A=w&&w>0?Math.min(100,Math.round(E/w*100)):null,R=L=>L.toLocaleString(a==="en"?"en-US":"fr-FR"),B=(o||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),C=(()=>{const L=Date.parse(l.generatedAt||"");if(Number.isNaN(L))return"";const _=new Date(L),k=N=>String(N).padStart(2,"0");return`${k(_.getDate())}/${k(_.getMonth()+1)} à ${k(_.getHours())}:${k(_.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:B}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),C&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(C)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[A===null&&E>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(E)})})]}),A!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:A+"%"}})}),t.jsxs("b",{children:[A," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(E,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(m)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function bi(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const vi=["--p0","--p1","--p2","--p3","--p4"];function yi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=F(),s=o.loading&&!l.length,c=h.useRef({});h.useEffect(()=>{c.current={...r}},[r]);const g=u=>{const x=c.current[u],p=x!==void 0?r[u]-x:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${vi[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},d=(u,x,p)=>t.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),f=(u,x,p,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:x,disabled:b,onClick:p,children:u},x);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[f("↩",n.toolUndo,i,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const wi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function ki(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=F(),s=h.useRef(null),[c,g]=h.useState(60);h.useEffect(()=>{let x=0;const p=()=>{var j;const b=s.current;if(!b)return;const v=(j=b.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!v)return;const m=v.getBoundingClientRect(),y=b.getBoundingClientRect();g(Math.max(20,Math.min(m.left+m.width/2-y.left,y.width-30)))};return x=requestAnimationFrame(p),window.addEventListener("resize",p),()=>{cancelAnimationFrame(x),window.removeEventListener("resize",p)}},[e.ptab]);const d=e.ptab;let f=r.tuto[d].p;if(d===3){const x=n.filter(v=>v.kind==="target"&&ke(v)===3),p=x.filter(v=>ia(v)==="auto").length,b=x.filter(v=>ia(v)==="cd").length;f=r.tutoPending(p,b,x.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(x=>x.id)})};if(d===1){const x=n.filter(p=>p.kind==="target"&&ke(p)===1&&!i.has(p.id)).slice(0,10);if(x.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:x.map(p=>p.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":wi[d],"--ax":c+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:f}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Qe{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*ji(e){for(const a of e)yield*a}function Wn(e){return Array.from(ji(e))}var ne=1e-6,J=Math.PI,Te=J/2,nn=J/4,Re=J*2,Be=180/J,Ee=J/180,ie=Math.abs,Ni=Math.atan,gt=Math.atan2,de=Math.cos,ce=Math.sin,Si=Math.sign||function(e){return e>0?1:e<0?-1:0},et=Math.sqrt;function Ci(e){return e>1?0:e<-1?J:Math.acos(e)}function bt(e){return e>1?Te:e<-1?-Te:Math.asin(e)}function Le(){}function qt(e,a){e&&on.hasOwnProperty(e.type)&&on[e.type](e,a)}var rn={Feature:function(e,a){qt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)qt(r[n].geometry,a)}},on={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ca(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ca(r[n],a,0)},Polygon:function(e,a){sn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)sn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)qt(r[n],a)}};function ca(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function sn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ca(e[r],a,1);a.polygonEnd()}function tt(e,a){e&&rn.hasOwnProperty(e.type)?rn[e.type](e,a):qt(e,a)}function pa(e){return[gt(e[1],e[0]),bt(e[2])]}function nt(e){var a=e[0],r=e[1],n=de(r);return[n*de(a),n*ce(a),ce(r)]}function At(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ft(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ta(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function zt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ua(e){var a=et(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function fa(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function ma(e,a){return ie(e)>J&&(e-=Math.round(e/Re)*Re),[e,a]}ma.invert=ma;function Ei(e,a,r){return(e%=Re)?a||r?fa(dn(e),cn(a,r)):dn(e):a||r?cn(a,r):ma}function ln(e){return function(a,r){return a+=e,ie(a)>J&&(a-=Math.round(a/Re)*Re),[a,r]}}function dn(e){var a=ln(e);return a.invert=ln(-e),a}function cn(e,a){var r=de(e),n=ce(e),i=de(a),o=ce(a);function l(s,c){var g=de(c),d=de(s)*g,f=ce(s)*g,u=ce(c),x=u*r+d*n;return[gt(f*i-x*o,d*r-u*n),bt(x*i+f*o)]}return l.invert=function(s,c){var g=de(c),d=de(s)*g,f=ce(s)*g,u=ce(c),x=u*i-f*o;return[gt(f*i+u*o,d*r+x*n),bt(x*r-d*n)]},l}function Ai(e,a,r,n,i,o){if(r){var l=de(a),s=ce(a),c=n*r;i==null?(i=a+n*Re,o=a-c/2):(i=pn(l,i),o=pn(l,o),(n>0?i<o:i>o)&&(i+=n*Re));for(var g,d=i;n>0?d>o:d<o;d-=c)g=pa([l,-s*de(d),-s*ce(d)]),e.point(g[0],g[1])}}function pn(e,a){a=nt(a),a[0]-=e,ua(a);var r=Ci(-a[1]);return((-a[2]<0?-r:r)+Re-ne)%Re}function Gn(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Le,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ot(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Tt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Kn(e,a,r,n,i){var o=[],l=[],s,c;if(e.forEach(function(p){if(!((b=p.length-1)<=0)){var b,v=p[0],m=p[b],y;if(Ot(v,m)){if(!v[2]&&!m[2]){for(i.lineStart(),s=0;s<b;++s)i.point((v=p[s])[0],v[1]);i.lineEnd();return}m[0]+=2*ne}o.push(y=new Tt(v,p,null,!0)),l.push(y.o=new Tt(v,null,y,!1)),o.push(y=new Tt(m,p,null,!1)),l.push(y.o=new Tt(m,null,y,!0))}}),!!o.length){for(l.sort(a),un(o),un(l),s=0,c=l.length;s<c;++s)l[s].e=r=!r;for(var g=o[0],d,f;;){for(var u=g,x=!0;u.v;)if((u=u.n)===g)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(x)for(s=0,c=d.length;s<c;++s)i.point((f=d[s])[0],f[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(x)for(d=u.p.z,s=d.length-1;s>=0;--s)i.point((f=d[s])[0],f[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,x=!x}while(!u.v);i.lineEnd()}}}function un(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function aa(e){return ie(e[0])<=J?e[0]:Si(e[0])*((ie(e[0])+J)%Re-J)}function zi(e,a){var r=aa(a),n=a[1],i=ce(n),o=[ce(r),-de(r),0],l=0,s=0,c=new Qe;i===1?n=Te+ne:i===-1&&(n=-Te-ne);for(var g=0,d=e.length;g<d;++g)if(u=(f=e[g]).length)for(var f,u,x=f[u-1],p=aa(x),b=x[1]/2+nn,v=ce(b),m=de(b),y=0;y<u;++y,p=w,v=A,m=R,x=j){var j=f[y],w=aa(j),E=j[1]/2+nn,A=ce(E),R=de(E),B=w-p,C=B>=0?1:-1,M=C*B,O=M>J,L=v*A;if(c.add(gt(L*C*ce(M),m*R+L*de(M))),l+=O?B+C*Re:B,O^p>=r^w>=r){var _=Ft(nt(x),nt(j));ua(_);var k=Ft(o,_);ua(k);var N=(O^B>=0?-1:1)*bt(k[2]);(n>N||n===N&&(_[0]||_[1]))&&(s+=O^B>=0?1:-1)}}return(l<-ne||l<ne&&c<-1e-12)^s&1}function Qn(e,a,r,n){return function(i){var o=a(i),l=Gn(),s=a(l),c=!1,g,d,f,u={point:x,lineStart:b,lineEnd:v,polygonStart:function(){u.point=m,u.lineStart=y,u.lineEnd=j,d=[],g=[]},polygonEnd:function(){u.point=x,u.lineStart=b,u.lineEnd=v,d=Wn(d);var w=zi(g,n);d.length?(c||(i.polygonStart(),c=!0),Kn(d,Li,w,r,i)):w&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),d=g=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function x(w,E){e(w,E)&&i.point(w,E)}function p(w,E){o.point(w,E)}function b(){u.point=p,o.lineStart()}function v(){u.point=x,o.lineEnd()}function m(w,E){f.push([w,E]),s.point(w,E)}function y(){s.lineStart(),f=[]}function j(){m(f[0][0],f[0][1]),s.lineEnd();var w=s.clean(),E=l.result(),A,R=E.length,B,C,M;if(f.pop(),g.push(f),f=null,!!R){if(w&1){if(C=E[0],(B=C.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),A=0;A<B;++A)i.point((M=C[A])[0],M[1]);i.lineEnd()}return}R>1&&w&2&&E.push(E.pop().concat(E.shift())),d.push(E.filter(Ti))}}return u}}function Ti(e){return e.length>1}function Li(e,a){return((e=e.x)[0]<0?e[1]-Te-ne:Te-e[1])-((a=a.x)[0]<0?a[1]-Te-ne:Te-a[1])}const fn=Qn(function(){return!0},Ri,Oi,[-J,-Te]);function Ri(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?J:-J,c=ie(o-a);ie(c-J)<ne?(e.point(a,r=(r+l)/2>0?Te:-Te),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&c>=J&&(ie(a-n)<ne&&(a-=n*ne),ie(o-s)<ne&&(o-=s*ne),r=Mi(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Mi(e,a,r,n){var i,o,l=ce(e-r);return ie(l)>ne?Ni((ce(a)*(o=de(n))*ce(r)-ce(n)*(i=de(a))*ce(e))/(i*o*l)):(a+n)/2}function Oi(e,a,r,n){var i;if(e==null)i=r*Te,n.point(-J,i),n.point(0,i),n.point(J,i),n.point(J,0),n.point(J,-i),n.point(0,-i),n.point(-J,-i),n.point(-J,0),n.point(-J,i);else if(ie(e[0]-a[0])>ne){var o=e[0]<a[0]?J:-J;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function qi(e){var a=de(e),r=2*Ee,n=a>0,i=ie(a)>ne;function o(d,f,u,x){Ai(x,e,r,u,d,f)}function l(d,f){return de(d)*de(f)>a}function s(d){var f,u,x,p,b;return{lineStart:function(){p=x=!1,b=1},point:function(v,m){var y=[v,m],j,w=l(v,m),E=n?w?0:g(v,m):w?g(v+(v<0?J:-J),m):0;if(!f&&(p=x=w)&&d.lineStart(),w!==x&&(j=c(f,y),(!j||Ot(f,j)||Ot(y,j))&&(y[2]=1)),w!==x)b=0,w?(d.lineStart(),j=c(y,f),d.point(j[0],j[1])):(j=c(f,y),d.point(j[0],j[1],2),d.lineEnd()),f=j;else if(i&&f&&n^w){var A;!(E&u)&&(A=c(y,f,!0))&&(b=0,n?(d.lineStart(),d.point(A[0][0],A[0][1]),d.point(A[1][0],A[1][1]),d.lineEnd()):(d.point(A[1][0],A[1][1]),d.lineEnd(),d.lineStart(),d.point(A[0][0],A[0][1],3)))}w&&(!f||!Ot(f,y))&&d.point(y[0],y[1]),f=y,x=w,u=E},lineEnd:function(){x&&d.lineEnd(),f=null},clean:function(){return b|(p&&x)<<1}}}function c(d,f,u){var x=nt(d),p=nt(f),b=[1,0,0],v=Ft(x,p),m=At(v,v),y=v[0],j=m-y*y;if(!j)return!u&&d;var w=a*m/j,E=-a*y/j,A=Ft(b,v),R=zt(b,w),B=zt(v,E);ta(R,B);var C=A,M=At(R,C),O=At(C,C),L=M*M-O*(At(R,R)-1);if(!(L<0)){var _=et(L),k=zt(C,(-M-_)/O);if(ta(k,R),k=pa(k),!u)return k;var N=d[0],T=f[0],H=d[1],G=f[1],Z;T<N&&(Z=N,N=T,T=Z);var z=T-N,q=ie(z-J)<ne,$=q||z<ne;if(!q&&G<H&&(Z=H,H=G,G=Z),$?q?H+G>0^k[1]<(ie(k[0]-N)<ne?H:G):H<=k[1]&&k[1]<=G:z>J^(N<=k[0]&&k[0]<=T)){var P=zt(C,(-M+_)/O);return ta(P,R),[k,pa(P)]}}}function g(d,f){var u=n?e:J-e,x=0;return d<-u?x|=1:d>u&&(x|=2),f<-u?x|=4:f>u&&(x|=8),x}return Qn(l,s,o,n?[0,-e]:[-J,e-J])}function Fi(e,a,r,n,i,o){var l=e[0],s=e[1],c=a[0],g=a[1],d=0,f=1,u=c-l,x=g-s,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<d)return;p<f&&(f=p)}else if(u>0){if(p>f)return;p>d&&(d=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>f)return;p>d&&(d=p)}else if(u>0){if(p<d)return;p<f&&(f=p)}if(p=n-s,!(!x&&p>0)){if(p/=x,x<0){if(p<d)return;p<f&&(f=p)}else if(x>0){if(p>f)return;p>d&&(d=p)}if(p=o-s,!(!x&&p<0)){if(p/=x,x<0){if(p>f)return;p>d&&(d=p)}else if(x>0){if(p<d)return;p<f&&(f=p)}return d>0&&(e[0]=l+d*u,e[1]=s+d*x),f<1&&(a[0]=l+f*u,a[1]=s+f*x),!0}}}}}var pt=1e9,Lt=-pt;function Pi(e,a,r,n){function i(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function o(g,d,f,u){var x=0,p=0;if(g==null||(x=l(g,f))!==(p=l(d,f))||c(g,d)<0^f>0)do u.point(x===0||x===3?e:r,x>1?n:a);while((x=(x+f+4)%4)!==p);else u.point(d[0],d[1])}function l(g,d){return ie(g[0]-e)<ne?d>0?0:3:ie(g[0]-r)<ne?d>0?2:1:ie(g[1]-a)<ne?d>0?1:0:d>0?3:2}function s(g,d){return c(g.x,d.x)}function c(g,d){var f=l(g,1),u=l(d,1);return f!==u?f-u:f===0?d[1]-g[1]:f===1?g[0]-d[0]:f===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,f=Gn(),u,x,p,b,v,m,y,j,w,E,A,R={point:B,lineStart:L,lineEnd:_,polygonStart:M,polygonEnd:O};function B(N,T){i(N,T)&&d.point(N,T)}function C(){for(var N=0,T=0,H=x.length;T<H;++T)for(var G=x[T],Z=1,z=G.length,q=G[0],$,P,D=q[0],U=q[1];Z<z;++Z)$=D,P=U,q=G[Z],D=q[0],U=q[1],P<=n?U>n&&(D-$)*(n-P)>(U-P)*(e-$)&&++N:U<=n&&(D-$)*(n-P)<(U-P)*(e-$)&&--N;return N}function M(){d=f,u=[],x=[],A=!0}function O(){var N=C(),T=A&&N,H=(u=Wn(u)).length;(T||H)&&(g.polygonStart(),T&&(g.lineStart(),o(null,null,1,g),g.lineEnd()),H&&Kn(u,s,N,o,g),g.polygonEnd()),d=g,u=x=p=null}function L(){R.point=k,x&&x.push(p=[]),E=!0,w=!1,y=j=NaN}function _(){u&&(k(b,v),m&&w&&f.rejoin(),u.push(f.result())),R.point=B,w&&d.lineEnd()}function k(N,T){var H=i(N,T);if(x&&p.push([N,T]),E)b=N,v=T,m=H,E=!1,H&&(d.lineStart(),d.point(N,T));else if(H&&w)d.point(N,T);else{var G=[y=Math.max(Lt,Math.min(pt,y)),j=Math.max(Lt,Math.min(pt,j))],Z=[N=Math.max(Lt,Math.min(pt,N)),T=Math.max(Lt,Math.min(pt,T))];Fi(G,Z,e,a,r,n)?(w||(d.lineStart(),d.point(G[0],G[1])),d.point(Z[0],Z[1]),H||d.lineEnd(),A=!1):H&&(d.lineStart(),d.point(N,T),A=!1)}y=N,j=T,w=H}return R}}const xa=e=>e;var na=new Qe,ha=new Qe,Jn,Xn,ga,ba,_e={point:Le,lineStart:Le,lineEnd:Le,polygonStart:function(){_e.lineStart=Di,_e.lineEnd=$i},polygonEnd:function(){_e.lineStart=_e.lineEnd=_e.point=Le,na.add(ie(ha)),ha=new Qe},result:function(){var e=na/2;return na=new Qe,e}};function Di(){_e.point=Ii}function Ii(e,a){_e.point=Zn,Jn=ga=e,Xn=ba=a}function Zn(e,a){ha.add(ba*e-ga*a),ga=e,ba=a}function $i(){Zn(Jn,Xn)}var rt=1/0,Pt=rt,vt=-rt,Dt=vt,It={point:Bi,lineStart:Le,lineEnd:Le,polygonStart:Le,polygonEnd:Le,result:function(){var e=[[rt,Pt],[vt,Dt]];return vt=Dt=-(Pt=rt=1/0),e}};function Bi(e,a){e<rt&&(rt=e),e>vt&&(vt=e),a<Pt&&(Pt=a),a>Dt&&(Dt=a)}var va=0,ya=0,ut=0,$t=0,Bt=0,at=0,wa=0,ka=0,ft=0,er,tr,Fe,Pe,ze={point:Je,lineStart:mn,lineEnd:xn,polygonStart:function(){ze.lineStart=Vi,ze.lineEnd=Hi},polygonEnd:function(){ze.point=Je,ze.lineStart=mn,ze.lineEnd=xn},result:function(){var e=ft?[wa/ft,ka/ft]:at?[$t/at,Bt/at]:ut?[va/ut,ya/ut]:[NaN,NaN];return va=ya=ut=$t=Bt=at=wa=ka=ft=0,e}};function Je(e,a){va+=e,ya+=a,++ut}function mn(){ze.point=_i}function _i(e,a){ze.point=Ui,Je(Fe=e,Pe=a)}function Ui(e,a){var r=e-Fe,n=a-Pe,i=et(r*r+n*n);$t+=i*(Fe+e)/2,Bt+=i*(Pe+a)/2,at+=i,Je(Fe=e,Pe=a)}function xn(){ze.point=Je}function Vi(){ze.point=Yi}function Hi(){ar(er,tr)}function Yi(e,a){ze.point=ar,Je(er=Fe=e,tr=Pe=a)}function ar(e,a){var r=e-Fe,n=a-Pe,i=et(r*r+n*n);$t+=i*(Fe+e)/2,Bt+=i*(Pe+a)/2,at+=i,i=Pe*e-Fe*a,wa+=i*(Fe+e),ka+=i*(Pe+a),ft+=i*3,Je(Fe=e,Pe=a)}function nr(e){this._context=e}nr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Re);break}}},result:Le};var ja=new Qe,ra,rr,or,mt,xt,yt={point:Le,lineStart:function(){yt.point=Wi},lineEnd:function(){ra&&ir(rr,or),yt.point=Le},polygonStart:function(){ra=!0},polygonEnd:function(){ra=null},result:function(){var e=+ja;return ja=new Qe,e}};function Wi(e,a){yt.point=ir,rr=mt=e,or=xt=a}function ir(e,a){mt-=e,xt-=a,ja.add(et(mt*mt+xt*xt)),mt=e,xt=a}let hn,_t,gn,bn;class vn{constructor(a){this._append=a==null?sr:Gi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==gn||this._append!==_t){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,gn=n,_t=this._append,bn=this._,this._=i}this._+=bn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function sr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Gi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return sr;if(a!==hn){const r=10**a;hn=a,_t=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return _t}function Ki(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),tt(s,i(o))),o.result()}return l.area=function(s){return tt(s,i(_e)),_e.result()},l.measure=function(s){return tt(s,i(yt)),yt.result()},l.bounds=function(s){return tt(s,i(It)),It.result()},l.centroid=function(s){return tt(s,i(ze)),ze.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,xa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new vn(r)):new nr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const c=Math.floor(s);if(!(c>=0))throw new RangeError(`invalid digits: ${s}`);r=c}return a===null&&(o=new vn(r)),l},l.projection(e).digits(r).context(a)}function Ra(e){return function(a){var r=new Na;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Na(){}Na.prototype={constructor:Na,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ma(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),tt(r,e.stream(It)),a(It.result()),n!=null&&e.clipExtent(n),e}function lr(e,a,r){return Ma(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,c])},r)}function Qi(e,a,r){return lr(e,[[0,0],a],r)}function Ji(e,a,r){return Ma(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Xi(e,a,r){return Ma(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var yn=16,Zi=de(30*Ee);function wn(e,a){return+a?ts(e,a):es(e)}function es(e){return Ra({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ts(e,a){function r(n,i,o,l,s,c,g,d,f,u,x,p,b,v){var m=g-n,y=d-i,j=m*m+y*y;if(j>4*a&&b--){var w=l+u,E=s+x,A=c+p,R=et(w*w+E*E+A*A),B=bt(A/=R),C=ie(ie(A)-1)<ne||ie(o-f)<ne?(o+f)/2:gt(E,w),M=e(C,B),O=M[0],L=M[1],_=O-n,k=L-i,N=y*_-m*k;(N*N/j>a||ie((m*_+y*k)/j-.5)>.3||l*u+s*x+c*p<Zi)&&(r(n,i,o,l,s,c,O,L,C,w/=R,E/=R,A,b,v),v.point(O,L),r(O,L,C,w,E,A,g,d,f,u,x,p,b,v))}}return function(n){var i,o,l,s,c,g,d,f,u,x,p,b,v={point:m,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=E},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function m(B,C){B=e(B,C),n.point(B[0],B[1])}function y(){f=NaN,v.point=j,n.lineStart()}function j(B,C){var M=nt([B,C]),O=e(B,C);r(f,u,d,x,p,b,f=O[0],u=O[1],d=B,x=M[0],p=M[1],b=M[2],yn,n),n.point(f,u)}function w(){v.point=m,n.lineEnd()}function E(){y(),v.point=A,v.lineEnd=R}function A(B,C){j(i=B,C),o=f,l=u,s=x,c=p,g=b,v.point=j}function R(){r(f,u,d,x,p,b,o,l,i,s,c,g,yn,n),v.lineEnd=w,w()}return v}}var as=Ra({point:function(e,a){this.stream.point(e*Ee,a*Ee)}});function ns(e){return Ra({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function rs(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function kn(e,a,r,n,i,o){if(!o)return rs(e,a,r,n,i);var l=de(o),s=ce(o),c=l*e,g=s*e,d=l/e,f=s/e,u=(s*r-l*a)/e,x=(s*a+l*r)/e;function p(b,v){return b*=n,v*=i,[c*b-g*v+a,r-g*b-c*v]}return p.invert=function(b,v){return[n*(d*b-f*v+u),i*(x-f*b-d*v)]},p}function os(e){return is(function(){return e})()}function is(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,c=0,g=0,d,f=0,u=1,x=1,p=null,b=fn,v=null,m,y,j,w=xa,E=.5,A,R,B,C,M;function O(N){return B(N[0]*Ee,N[1]*Ee)}function L(N){return N=B.invert(N[0],N[1]),N&&[N[0]*Be,N[1]*Be]}O.stream=function(N){return C&&M===N?C:C=as(ns(d)(b(A(w(M=N)))))},O.preclip=function(N){return arguments.length?(b=N,p=void 0,k()):b},O.postclip=function(N){return arguments.length?(w=N,v=m=y=j=null,k()):w},O.clipAngle=function(N){return arguments.length?(b=+N?qi(p=N*Ee):(p=null,fn),k()):p*Be},O.clipExtent=function(N){return arguments.length?(w=N==null?(v=m=y=j=null,xa):Pi(v=+N[0][0],m=+N[0][1],y=+N[1][0],j=+N[1][1]),k()):v==null?null:[[v,m],[y,j]]},O.scale=function(N){return arguments.length?(r=+N,_()):r},O.translate=function(N){return arguments.length?(n=+N[0],i=+N[1],_()):[n,i]},O.center=function(N){return arguments.length?(o=N[0]%360*Ee,l=N[1]%360*Ee,_()):[o*Be,l*Be]},O.rotate=function(N){return arguments.length?(s=N[0]%360*Ee,c=N[1]%360*Ee,g=N.length>2?N[2]%360*Ee:0,_()):[s*Be,c*Be,g*Be]},O.angle=function(N){return arguments.length?(f=N%360*Ee,_()):f*Be},O.reflectX=function(N){return arguments.length?(u=N?-1:1,_()):u<0},O.reflectY=function(N){return arguments.length?(x=N?-1:1,_()):x<0},O.precision=function(N){return arguments.length?(A=wn(R,E=N*N),k()):et(E)},O.fitExtent=function(N,T){return lr(O,N,T)},O.fitSize=function(N,T){return Qi(O,N,T)},O.fitWidth=function(N,T){return Ji(O,N,T)},O.fitHeight=function(N,T){return Xi(O,N,T)};function _(){var N=kn(r,0,0,u,x,f).apply(null,a(o,l)),T=kn(r,n-N[0],i-N[1],u,x,f);return d=Ei(s,c,g),R=fa(a,T),B=fa(d,R),A=wn(R,E),k()}function k(){return C=M=null,O}return function(){return a=e.apply(this,arguments),O.invert=a.invert&&L,_()}}function dr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}dr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ss(){return os(dr).scale(175.295)}function ls(e){return e}function ds(e){if(e==null)return ls;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,c){c||(a=r=0);var g=2,d=s.length,f=new Array(d);for(f[0]=(a+=s[0])*n+o,f[1]=(r+=s[1])*i+l;g<d;)f[g]=s[g],++g;return f}}function cs(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ps(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return jn(e,r)})}:jn(e,a)}function jn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=us(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function us(e,a){var r=ds(e.transform),n=e.arcs;function i(d,f){f.length&&f.pop();for(var u=n[d<0?~d:d],x=0,p=u.length;x<p;++x)f.push(r(u[x],x));d<0&&cs(f,p)}function o(d){return r(d)}function l(d){for(var f=[],u=0,x=d.length;u<x;++u)i(d[u],f);return f.length<2&&f.push(f[0]),f}function s(d){for(var f=l(d);f.length<4;)f.push(f[0]);return f}function c(d){return d.map(s)}function g(d){var f=d.type,u;switch(f){case"GeometryCollection":return{type:f,geometries:d.geometries.map(g)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=c(d.arcs);break;case"MultiPolygon":u=d.arcs.map(c);break;default:return null}return{type:f,coordinates:u}}return g(a)}const cr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},fs=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ms(e,a,r){const n=cr[e];if(!n||!n.length)return-1;const i=fs(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Rt=null;function xs(){return Rt||(Rt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ps(r,n),o=ss().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Ki(o),s=(i.features||[]).filter(d=>{var f;return(((f=d.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(d=>{var x;const f=((x=d.properties)==null?void 0:x.name)||"",u=l(d)||"";return u?{i2:Hr(f)||null,n:f,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const c={};for(const[d,f]of Object.entries(Yr)){const u=o(f);u&&(c[d]={x:u[0],y:u[1]})}const g={};for(const[d,f]of Object.entries(cr)){const u=f.map(x=>o(x.ll)).filter(x=>!!x).map(([x,p])=>({x,y:p}));u.length&&(g[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:c,metros:g}}catch{return null}})(),Rt)}function hs(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return xs().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const gs={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Nn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Sn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function bs(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let i=!0,o=0;const l=()=>{var g;if(!i)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function vs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:c,data:g,dossiers:d}=F(),f=g.loading&&!d.length,u=h.useRef(null),x=h.useRef(null),p=hs(e.continent==="monde"),b=e.continent==="monde"?p:za.find(k=>k.key===e.continent)||null,v=bs(u,e.continent+":"+e.mapFolded+":"+!!b),[m,y]=h.useState(new Map),[j,w]=h.useState(null);h.useEffect(()=>{const k=u.current;if(!k)return;const N=new Map;k.querySelectorAll("path[data-i2]").forEach(T=>{const H=T.dataset.i2;if(H)try{const G=T.getBBox();G.width>0&&N.set(H,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(N)},[e.continent,v,b]);const E=h.useMemo(()=>r.filter(k=>k.cc),[r]),A=h.useMemo(()=>{const k=new Map;return E.forEach(N=>k.set(N.cc,(k.get(N.cc)||0)+1)),k},[E]),R=e.continent==="monde"&&p?p.anchors:null,B=e.continent==="monde"&&p?p.metros:null,C=h.useMemo(()=>E.map(k=>{const N=Sn(k.name||k.id||""),T=Sn((k.id||k.name||"")+"·y");if(R&&k.cc){const q=B?B[k.cc]:void 0;if(q&&q.length){const P=ms(k.cc,k.city,N);if(P>=0&&q[P])return{d:k,x:q[P].x+(N-.5)*5,y:q[P].y+(T-.5)*5}}const $=R[k.cc];if($)return{d:k,x:$.x+(N-.5)*10,y:$.y+(T-.5)*10}}const H=k.cc?m.get(k.cc):void 0;if(!H)return null;const G=gs[`${e.continent}:${k.cc||""}`];if(G)return{d:k,x:H.x+H.w*(G.fx+(N-.5)*G.sx),y:H.y+H.h*(G.fy+(T-.5)*G.sy)};const Z=(N-.5)*Math.min(H.w*.55,60),z=(T-.5)*Math.min(H.h*.55,60);return{d:k,x:H.x+H.w/2+Z,y:H.y+H.h/2+z}}).filter(k=>!!k),[E,m,R,B,e.continent]),M=k=>v>0?k/v:k,O=h.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:Nn[k],fr:c.plabels[k].toUpperCase(),en:c.plabels[k].toUpperCase(),n:r.filter(N=>N.kind==="target"&&ke(N)===k).length})).filter(k=>k.n>0):Ua.map((k,N)=>({...k,n:r.filter(T=>Va(T)===N).length})),[r,n,c.plabels]),L=o?l.get(o):null,_=L?C.find(k=>k.d.id===L.id):null;return b?t.jsxs("div",{className:"mapzone"+(f?" waiting":""),ref:x,children:[t.jsxs("svg",{ref:u,viewBox:b.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?b.fr:b.en,onMouseLeave:()=>{w(null),i(null)},children:[t.jsx("g",{children:b.countries.map((k,N)=>t.jsx("g",{className:"ct"+(k.i2&&A.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},N))}),t.jsx("g",{children:C.map(k=>{const N=Ua[Va(k.d)],T=!!he(k.d),H=k.d.kind==="target",G=n&&H?Nn[ke(k.d)]:N.c,Z=!n&&Ae(k.d);return t.jsxs("g",{className:"co"+(Z?" done":""),onMouseEnter:()=>{var $,P;const z=($=x.current)==null?void 0:$.getBoundingClientRect(),q=(P=u.current)==null?void 0:P.createSVGPoint();if(q&&u.current&&z){q.x=k.x,q.y=k.y;const D=q.matrixTransform(u.current.getScreenCTM());w({x:D.x-z.left,y:D.y-z.top,label:k.d.name+" · "+(st(k.d.cc,s)||k.d.countryLabel||"")})}i(k.d.id)},onMouseLeave:()=>{w(null),i(null)},onClick:()=>{var $;const z=($=u.current)==null?void 0:$.createSVGPoint();let q=null;if(z&&u.current){z.x=k.x,z.y=k.y;const P=z.matrixTransform(u.current.getScreenCTM());q={x:P.x,y:P.y}}a({type:"popup",id:k.d.id,anchor:q})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:M(Math.max(11,N.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:M(N.px),fill:G,stroke:T?"#DC2626":"#ffffff",strokeWidth:M(T?2.2:1.3)})]},k.d.id||k.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:O.map((k,N)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},N))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:x})}function ys(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function ws(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=F(),s=e.filters,c=h.useMemo(()=>e.continent==="monde"?r:r.filter(p=>p.continent===e.continent),[r,e.continent]),g=p=>c.filter(b=>p!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:Ta(b,s,i,p==="country"?void 0:p)),d=h.useMemo(()=>{const p=g("win"),b=v=>p.filter(m=>(m.date?Math.max(0,Math.floor((Date.now()-Date.parse(m.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),p.length]},[c,s,i]),f=h.useMemo(()=>s.day?g("win").filter(p=>(p.date||"").slice(0,10)===s.day).length:0,[c,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),x=(p,b,v,m="fbtn")=>t.jsxs("button",{type:"button",className:m,"aria-expanded":e.openFacet===p,onClick:()=>a({type:"openFacet",facet:p}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},p);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(ys(s.day,l)),t.jsx("b",{children:f})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((p,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===p,onClick:()=>a({type:"filters",patch:{win:p}}),children:[n.dates[b],t.jsx("b",{children:d[b]})]},p))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:p=>a({type:"filters",patch:{search:p.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):x("sec",n.fSector,s.sector.length),x("pay",n.fCountry,s.country.length),x("det",n.fEngine,s.engine.length),x("sta",n.fStage,s.stage.length),i&&x("ang","Angle",s.angle.length),i&&x("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(c.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(ks,{poolFor:g})]})}function ks({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=a.filters,l=a.openFacet,{title:s,cols:c,options:g}=h.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(m=>he(m)),b=new Map;p.forEach(m=>{const y=m.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...sa([...b.keys()],i).map(m=>({v:m,label:Ke(m)+" "+De(m,i),n:b.get(m)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(m)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const p=e("sector"),b=new Map;return p.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v,n:m,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const p=e("country"),b=new Map;return p.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:st(v,i)||v,n:m,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const p=e("engine"),b=new Map;return p.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:sa([...b.keys()],i).map(v=>({v,label:Ke(v)+" "+De(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Wr(Gr(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const p=e("angle"),b=new Map;return p.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v.replace(/[_-]+/g," "),n:m,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const p=e("memoLevel"),b=new Map;p.forEach(m=>{if(m.kind==="target"){const y=Ea(m);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(m=>({v:String(m),label:v[m],n:b.get(m)||0,html:!1,on:o.memoLevel.includes(m)}))}}const u=e("stage"),x=new Map;return u.forEach(p=>{p.stage&&x.set(p.stage,(x.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...x.entries()].sort((p,b)=>b[1]-p[1]).map(([p,b])=>({v:p,label:p,n:b,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},f=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function pr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function js(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Cn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=F();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:s.rsEvalOne})]},c.name))})]}):null}function ur({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=F(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Cn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Cn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Ns({card:e,onEvaluate:a,onAddAll:r}){var s,c,g;const{t:n}=F(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:pr(e.summary_md||"").map((d,f)=>t.jsx("p",{children:d},f))})]}),t.jsx(ur,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Ss(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Cs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=F(),s=i,[c,g]=h.useState(null),[d,f]=h.useState(null),[u,x]=h.useState(null),[p,b]=h.useState(!1);h.useEffect(()=>{let m=!0;return(async()=>{const y=await Dn({email:l,cbToken:s});m&&g(y)})(),()=>{m=!1}},[l,s,n]);const v=m=>{f(m),x(null),b(!0),(async()=>{const y=await Kr(m.id);x(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),x(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[Ss(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?o.rsPub:o.rsPriv})]},m.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(Ns,{card:u,onEvaluate:a,onAddAll:r})]})]})}const En=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Es(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:c,caps:g,data:d,canWrite:f,source:u}=F(),x=a==="client",p=h.useMemo(()=>r||(u!=="default"?Qr():""),[r,u]),[b,v]=h.useState(""),[m,y]=h.useState(!1),[j,w]=h.useState(""),[E,A]=h.useState(!1),[R,B]=h.useState(""),[C,M]=h.useState([]),O=h.useRef(!1),[L,_]=h.useState(!1),[k,N]=h.useState(""),[T,H]=h.useState(""),[G,Z]=h.useState(!1),[z,q]=h.useState(0),[$,P]=h.useState(""),[D,U]=h.useState(null),[W,X]=h.useState(null),[re,me]=h.useState(!1),[pe,Q]=h.useState(null),[te,ve]=h.useState(0),K=h.useRef(!1),se=b.trim()?En.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,ee=h.useMemo(()=>j.split(`
`).map(I=>I.trim()).filter(Boolean).slice(0,15),[j]);h.useEffect(()=>{if(typeof window>"u")return;const I=(new URLSearchParams(window.location.search).get("rs")||"").trim();!I||!/^https?:\/\//i.test(I)||(N(I),_(!0))},[]),h.useEffect(()=>{const I=ae=>{var ye;const oe=String(((ye=ae.detail)==null?void 0:ye.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(N(oe),_(!0))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),h.useEffect(()=>{if(!f&&!p){Q(null);return}let I=!0;return(async()=>{const ae=await Dn({email:n,cbToken:p});I&&Q(ae.length)})(),()=>{I=!1}},[f,p,n,te]);const Ue=C.length?C:c,xe=d.credits,ge=h.useCallback(I=>{const ae=I.map(oe=>(oe||"").trim()).filter(Boolean);ae.length&&(w(oe=>{const ye=oe.split(`
