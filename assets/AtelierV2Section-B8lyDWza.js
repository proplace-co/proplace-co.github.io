...
.atl2 .bulk .side .hint{white-space:nowrap}`,Ma=`
...
`,Da=Fa+Ma;function Ra(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function qa(t,a){return t||a.mode!=="client"||!a.token?"visiteur":Ra("teaser")==="1"?"apercu":"client"}const Pa={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},Ba=t=>Pa[t],fe=t=>Object.assign(t,{continent:ra(t.cc)});function Be(t){const a=new Set,n=[];for(const r of t){const i=(r.name||"").toLowerCase();!i||a.has(i)||(a.add(i),n.push(r))}return n}const Ia=60*60*1e3;function $a(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ia?null:a}catch{return null}}function Te(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Va=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function Ua(t,a,n="default"){const r=n!=="default",i=d.useMemo(()=>t||r?{mode:"anon"}:Qt(),[t,r]),o=d.useMemo(()=>r?"visiteur":qa(t,i),[t,i,r]),l=d.useMemo(()=>Ba(o),[o]),p=o!=="visiteur",f=Va(n),[c,g]=d.useState([]),[s,v]=d.useState(""),[b,m]=d.useState(null),[x,h]=d.useState(null),[u,N]=d.useState(()=>new Map),[w,k]=d.useState(()=>new Map),[S,C]=d.useState(""),[F,j]=d.useState(new Set),[z,I]=d.useState(null),[L,D]=d.useState(!0),[M,E]=d.useState(!1),[P,B]=d.useState(0),[_,re]=d.useState(0),de=d.useRef(0),$=d.useMemo(()=>{var q;if(o!=="client")return"";try{return((q=Jt())==null?void 0:q.email)||""}catch{return""}},[o]);d.useEffect(()=>{const q=++de.current;let V=!0;const R=()=>V&&q===de.current,G=(p&&i.token?i.token:"pub:"+a)+(f?":"+f:""),ae=$a(G);return ae?(g(ae.objs.map(fe)),ae.fund&&v(ae.fund),m(ae.marketEstimate??null),h(ae.criteria??null),C(ae.generatedAt||""),D(!1)):D(!0),(async()=>{try{if(n==="ops"){const Z=await Re(),ee=((Z==null?void 0:Z.recent_ops)||[]).map(te=>qe(te,a)).filter(te=>!!te);if(!R())return;g(ee.map(fe)),Te(G,{objs:ee})}else if(typeof n=="object"){const ee=(await Xe()||[]).filter(K=>(K.slug||"")===n.research).map(K=>Ze(K,a)).filter(K=>!!K),te=Be(await et(ee,a));if(!R())return;g(te.map(fe)),Te(G,{objs:te})}else if(p&&i.token){const Z=Xt(i.token),ee=Re(),te=Zt(i.token),K=ea(i.token),me=ta(i.token),U=await Z;let ne=U?U.targets:[];R()&&U&&(v(U.fund||""),m(U.marketEstimate??null),h(U.criteria??null),C(U.generatedAt||""),g(ne.map(fe)),D(!1),E(!1));const[ce,we,pe,W]=await Promise.all([ee,te,K,me]),Ce=((ce==null?void 0:ce.recent_ops)||[]).map(le=>qe(le,a)).filter(le=>!!le);if(ne=[...ne,...Ce],!R())return;g(ne.map(fe));const xe=new Set;for(const le of we){const ge=(le.id||le.co||"").toString().trim().toLowerCase();ge&&xe.add(ge.startsWith("t:")?ge:"t:"+ge)}j(xe),N(pe),k(W),U&&Te(G,{fund:U.fund,marketEstimate:U.marketEstimate,criteria:U.criteria,generatedAt:U.generatedAt,objs:ne})}else{const Z=aa(),ee=Xe(),te=Re(),K=await Z;R()&&K.length&&(g(Be(K).map(fe)),D(!1),E(!1));const[me,U]=await Promise.all([ee,te]),ne=(me||[]).map(W=>Ze(W,a)).filter(W=>!!W),ce=await et(ne,a),we=((U==null?void 0:U.recent_ops)||[]).map(W=>qe(W,a)).filter(W=>!!W),pe=Be([...K,...ce,...we]);if(!R())return;g(pe.map(fe)),Te(G,{objs:pe})}R()&&E(!1)}catch{R()&&!ae&&E(!0)}finally{R()&&D(!1)}})(),()=>{V=!1}},[p,i.token,a,P,f]),d.useEffect(()=>{if(!l.showCredits||!$){I(null);return}let q=!0;return(async()=>{try{const V=await fetch(`${$e}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:$})});if(!V.ok)return;const R=await V.json();q&&R&&R.ok!==!1&&I(R)}catch{}})(),()=>{q=!1}},[l.showCredits,$,_]);const ie=d.useCallback(q=>j(new Set(q)),[]);return{session:i,mode:o,caps:l,fund:s,email:$,marketEstimate:b,generatedAt:S,criteria:x,thumbs:u,stages:w,dossiers:c,favIds:F,setFavIds:ie,credits:z,reloadCredits:()=>re(q=>q+1),loading:L,error:M,refresh:()=>B(q=>q+1)}}const Et=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),_a=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...Et(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Ha(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(i=>i!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(i=>i!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Et(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Oe)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Oe=60;function Ye(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!Y(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(Ve(t)))return!1;if(r!=="win"&&a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(be(t.date)>i)return!1}if(r!=="status"&&!n&&a.status!=="all"&&se(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Tt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:Ye(t,a.filters,n)}function Ya(t,a,n,r){return!(!Tt(t,a,n)||n&&!na(t,a.ptab,r))}function We(t,a){const n=a.key,r=i=>{switch(n){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-be(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=Y(i);return o?100-(o.left??0):-1}}};return[...t].sort((i,o)=>{const l=r(i),p=r(o);return l<p?-a.dir:l>p?a.dir:(i.name||"").localeCompare(o.name||"")})}function Wa(){const{dossiers:t,st:a,t:n,dispatch:r,contName:i,pipe:o}=T(),l=d.useMemo(()=>{const f=s=>o?!0:s.continent===a.continent,c=t.filter(s=>f(s)&&Y(s)),g=t.filter(s=>f(s)&&s.kind==="op"&&!Y(s)&&(s.dealKind==="ma"||s.dealKind==="levee")&&be(s.date)<=2);return g.sort((s,v)=>(v.amountEur||0)-(s.amountEur||0)),[...We(c,{key:"signal",dir:-1}),...g].slice(0,40)},[t,a.continent,o]),p=f=>l.map(c=>e.jsxs("button",{type:"button",className:"tk"+(Q(c)?" spent":""),onClick:g=>{const s=g.currentTarget.getBoundingClientRect();r({type:"popup",id:c.id,anchor:{x:s.left+s.width/2,y:s.bottom}})},title:c.name+(c.tagline?" — "+c.tagline:""),children:[e.jsx(ye,{o:c}),e.jsxs("span",{className:"who",children:[e.jsx(Ft,{o:c}),e.jsx("span",{className:"co",children:c.name})]}),typeof c.amountEur=="number"&&c.amountEur>0&&e.jsx("span",{className:"am",children:rn(c.amountEur)}),c.sector&&e.jsx("span",{className:"mt",children:c.sector}),e.jsx(De,{o:c}),e.jsx("span",{className:"tkgo",children:"→"})]},f+(c.id||c.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:l.length})]}),e.jsx("div",{className:"win",children:l.length?e.jsxs("div",{className:"run",children:[p(0),p(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(i)})})})]})}const Ga="aDx8z7Hzksus",At="+33 6 83 10 72 86",ct="alexandre@proplace.co",Ka=`tel:${At.replace(/[^\d+]/g,"")}`,pt="pp-rdv-slot";function Qa(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Ja(){const{t,caps:a,fund:n}=T(),r=a.showOnb,i=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:Za}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:Ka,children:At}),t.rdvSubMid,e.jsx("a",{href:`mailto:${ct}`,children:ct})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(i).map(([o,l],p)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(p+1)}),e.jsx("b",{children:o}),e.jsx("span",{children:l})]},o))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(Ta,{filloutId:Ga,parameters:n?{company_name:n}:void 0})})]})}function Xa(){const[t,a]=d.useState(()=>typeof document>"u"?null:document.getElementById(pt));return d.useEffect(()=>{t||a(document.getElementById(pt))},[t]),t?Se.createPortal(e.jsx(Ja,{}),t):null}const Za=`
...
`,er=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function tr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:i}=T(),[o,l]=d.useState(""),[p,f]=d.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const c=(t.ceoStatus||"").trim(),g=(Me(t)||"").startsWith("CALL")&&X(t)===3,s=X(t)>=2,v=async m=>{if(o||m==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(m);const x=await i(t,m);l(""),x&&(f(!0),setTimeout(()=>f(!1),2200))},b=g?[["Validé",a.csYes],["Écarté",a.csNo]]:er.filter(([m])=>!(s&&m==="Retenu")).map(([m,x])=>[m,a[x]]);return e.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,x])=>e.jsx("button",{type:"button",className:"csb"+(c===m?" on":"")+(o===m?" busy":""),disabled:!!o,onClick:()=>{v(m)},children:x},m)),p&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(ar,{o:t})]})}function ar({o:t}){const{t:a,saveNote:n,flash:r}=T(),[i,o]=d.useState(t.ceoNote||""),[l,p]=d.useState(!1),[f,c]=d.useState(!1),g=i.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(l||!g)return;p(!0);const v=await n(t,i.trim());p(!1),v&&(c(!0),setTimeout(()=>c(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:v=>o(v.target.value),onKeyDown:v=>{v.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:l||!g,onClick:()=>{s()},children:f?a.csNoteSaved:a.csNoteOk})]})}function rr({placeholder:t,onDone:a}){const{t:n}=T(),[r,i]=d.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function nr({o:t}){var h;const{t:a,token:n,caps:r,canWrite:i,stageOf:o,setStage:l,flashErr:p}=T(),[f,c]=d.useState(!1);if(!r.pipe||!i||r.lockActions||X(t)!==4)return null;const g=o(t),s=(g==null?void 0:g.stage)||"todo",v=async u=>{if(f||u===s)return;c(!0);const N=g;l(t,{stage:u,stamps:(g==null?void 0:g.stamps)||{}});const w=Math.max(Date.now(),ut+=1);ut=w;const k=await oa(n,{company:t.name||"",stage:u,cts:w,deal_id:t.airtableId,check_id:t.checkId});c(!1),!k.stale&&(k.ok||(l(t,N),p(a.actErr)))},b=(h=g==null?void 0:g.stamps)==null?void 0:h.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,x=s==="sent"&&b&&m>=4;return e.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,N])=>e.jsx("button",{type:"button",className:"stgb"+(s===u?" on":""),disabled:f,onClick:()=>{v(u)},children:N},u)),x&&e.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let ut=0;const Ae=8,Le=340;function ft({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function or({steps:t,onClose:a}){const{t:n,dispatch:r,counts:i,scoped:o,byId:l,st:p}=T(),[f,c]=d.useState(0),[g,s]=d.useState(null),[v,b]=d.useState([]),m=d.useRef(!1);d.useEffect(()=>{m.current||(m.current=!0,b(t.filter(S=>!!document.querySelector(S.need||S.sel))))},[t]);const x=v[f],h=f>=v.length;d.useEffect(()=>{x&&(x.ptab!==void 0&&p.ptab!==x.ptab&&r({type:"ptab",tab:x.ptab}),x.dens&&p.dens!==x.dens&&r({type:"dens",dens:x.dens}))},[f,x]);const u=d.useCallback(()=>{if(!x){s(null);return}const S=document.querySelector(x.sel);if(!S){s(null);return}S.scrollIntoView({block:"nearest",behavior:"smooth"}),s(S.getBoundingClientRect())},[x]);d.useLayoutEffect(()=>{u();const S=window.setTimeout(u,260),C=()=>u();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{window.clearTimeout(S),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[u]);const N=d.useRef(a);if(N.current=a,d.useEffect(()=>{const S=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),N.current()):C.key==="ArrowRight"?c(F=>F+1):C.key==="ArrowLeft"&&c(F=>Math.max(0,F-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!v.length)return null;let w=null;if(h){const S=i[3]||0,C=o.find(F=>F.memoUrl)||[...l.values()].find(F=>F.memoUrl);S>0?w={title:S===1?n.ahaATitle1:n.ahaATitleN(S),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:C?w={title:n.ahaBTitle,body:n.ahaBBody(C.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:C.id}),a()}}:w={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let k={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Le};if(!h&&g){const S=g.bottom+14,F=window.innerHeight-S>190?S:Math.max(12,g.top-200);k={left:Math.min(Math.max(12,g.left+g.width/2-Le/2),window.innerWidth-Le-12),top:F,width:Le}}return Se.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!h&&g&&e.jsx("div",{className:"tour-hole",style:{left:g.left-Ae,top:g.top-Ae,width:g.width+Ae*2,height:g.height+Ae*2}}),(h||!g)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(h?" fin":""),style:k,children:[h&&w?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:w.title}),e.jsx("p",{children:e.jsx(ft,{text:w.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>c(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(f+1,v.length)}),e.jsx("h3",{children:x==null?void 0:x.title}),e.jsx("p",{children:e.jsx(ft,{text:(x==null?void 0:x.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:f===0,onClick:()=>c(S=>Math.max(0,S-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>c(S=>S+1),children:f===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function ir(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:i}=T(),o=d.useMemo(()=>t.filter(s=>be(s.date)===0&&s.kind==="target"),[t]),l=d.useMemo(()=>o.filter(s=>a?X(s)===0:!Q(s)),[o,a]),p=o.length-l.length,f=o.length?Math.min(100,p/o.length*100):100;let c;a?c=n.morningThesis(o.length,p,l.length):o.length?p===0?c=n.goalSourced(o.length):p>=o.length?c=n.goalCleared:c=n.goalDone(p,o.length):c=n.goalSourced(0);const g=()=>{a?(i({type:"ptab",tab:0}),i({type:"filters",patch:{win:"1"}})):i({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:c}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:f+"%"}})}),l.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:g,children:a?n.morningEval(l.length):r.pileMode?n.goalContinue(l.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function lr(){var I;const{t,st:a,dispatch:n,token:r,fund:i,data:o,dossiers:l,mode:p,doSync:f,startTour:c}=T(),[g,s]=d.useState(null),[v,b]=d.useState([]),[m,x]=d.useState(!1),h=p==="client";d.useEffect(()=>{if(!r||!i)return;let L=!0;return(async()=>{const[D,M]=await Promise.all([kt(i),jt(r)]);L&&(D&&s(D),b(M))})(),()=>{L=!1}},[r,i]);const u=(g==null?void 0:g.per_day)??null,N=((I=g==null?void 0:g.pool_order)==null?void 0:I.length)??0,w=v.filter(L=>L.status==="running").length,k=L=>{if(!h||u===null||m)return;const D=Math.max(0,Math.min(10,u+L));D!==u&&(x(!0),s(M=>M&&{...M,per_day:D}),Nt(r,D).then(M=>{x(!1),s(M===null?E=>E&&{...E,per_day:u}:E=>E&&{...E,per_day:M})}))},S=d.useMemo(()=>l.filter(L=>L.kind==="target"&&Q(L)).length,[l]),C=o.marketEstimate,F=C&&C>0?Math.min(100,Math.round(S/C*100)):null,j=(i||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),z=(()=>{const L=Date.parse(o.generatedAt||"");if(Number.isNaN(L))return"";const D=new Date(L),M=E=>String(E).padStart(2,"0");return`${M(D.getDate())}/${M(D.getMonth()+1)} à ${M(D.getHours())}:${M(D.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:j}),e.jsx("i",{children:i})]}),e.jsx("h1",{children:t.identTitle(i||"…")}),e.jsx("span",{className:"idsp"}),z&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(z)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:c,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[F!==null&&C&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:F+"%"}})}),e.jsxs("b",{children:[F," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(S,C)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),u!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:L=>{L.stopPropagation(),k(-1)},children:"−"}),e.jsx("b",{className:"q",children:u})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:L=>{L.stopPropagation(),k(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),u===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),w>0&&e.jsxs("span",{className:"ev",children:["⏳ ",w]}),e.jsx("span",{className:"ego",children:t.identPending(N)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!h,onClick:f,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function sr(){const{t,counts:a,dispatch:n}=T();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,i],o)=>{const l=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(l?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:i}),l&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const dr=["--p0","--p1","--p2","--p3","--p4"];function cr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:i}=T(),o=d.useRef({});d.useEffect(()=>{o.current={...n}},[n]);const l=c=>{const g=o.current[c],s=g!==void 0?n[c]-g:0;return e.jsxs("button",{type:"button",className:"step"+(c===3&&n[3]>0?" wait":""),style:{"--c":`var(${dr[c]})`,"--tc":c<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===c,title:r.phelp[c],onClick:()=>a({type:"ptab",tab:c}),children:[e.jsxs("span",{className:"l",children:[r.plabels[c].toUpperCase(),c===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[c],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},c)},p=(c,g,s)=>e.jsxs("button",{type:"button",className:"off"+(g?" view":""),style:{"--c":c===5?"var(--p5)":c===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===c,title:r.phelp[c],onClick:()=>a({type:"ptab",tab:c}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[c]})]},c),f=(c,g,s,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:g,disabled:v,onClick:s,children:c},g);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),e.jsxs("div",{className:"offtrack",children:[p(5,!1,r.plabels[5]),p(7,!0,r.plabels[7]),p(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[f("↩",r.toolUndo,i,t.undo.length===0),f("↺",r.toolReset,()=>{a({type:"reset"})}),f("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),f("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const pr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function ur(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:i,doAnalyse:o,mode:l}=T(),p=d.useRef(null),[f,c]=d.useState(60);d.useEffect(()=>{let b=0;const m=()=>{var w;const x=p.current;if(!x)return;const h=(w=x.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!h)return;const u=h.getBoundingClientRect(),N=x.getBoundingClientRect();c(Math.max(20,Math.min(u.left+u.width/2-N.left,N.width-30)))};return b=requestAnimationFrame(m),window.addEventListener("resize",m),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",m)}},[t.ptab]);const g=t.ptab;let s=n.tuto[g].p;if(g===3){const b=r.filter(h=>h.kind==="target"&&X(h)===3),m=b.filter(h=>Ie(h)==="auto").length,x=b.filter(h=>Ie(h)==="cd").length;s=n.tutoPending(m,x,b.length)}const v=(()=>{if(l!=="client")return null;if(g===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(g===1){const b=r.filter(m=>m.kind==="target"&&X(m)===1&&!i.has(m.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(m=>o(m))}}return null})();return e.jsxs("div",{ref:p,className:"tuto mini",style:{"--bg":pr[g],"--ax":f+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[g].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const mt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function xt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function fr(t,a){const[n,r]=d.useState(1);return d.useEffect(()=>{let i=!0,o=0;const l=()=>{var c;if(!i)return;const f=(c=t.current)==null?void 0:c.getScreenCTM();f&&f.a>0?r(f.a):o=requestAnimationFrame(l)};l();const p=new ResizeObserver(()=>l());return t.current&&p.observe(t.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),p.disconnect(),window.removeEventListener("resize",l)}},[t,a]),n}function mr(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:i,markedId:o,byId:l,lang:p,t:f}=T(),c=d.useRef(null),g=d.useRef(null),s=Ue.find(j=>j.key===t.continent),v=fr(c,t.continent+":"+t.mapFolded),[b,m]=d.useState(new Map),[x,h]=d.useState(null);d.useEffect(()=>{const j=c.current;if(!j)return;const z=new Map;j.querySelectorAll("path[data-i2]").forEach(I=>{const L=I.dataset.i2;if(L)try{const D=I.getBBox();D.width>0&&z.set(L,{x:D.x,y:D.y,w:D.width,h:D.height})}catch{}}),m(z)},[t.continent,v]);const u=d.useMemo(()=>n.filter(j=>j.cc),[n]),N=d.useMemo(()=>{const j=new Map;return u.forEach(z=>j.set(z.cc,(j.get(z.cc)||0)+1)),j},[u]),w=d.useMemo(()=>u.map(j=>{const z=j.cc?b.get(j.cc):void 0;if(!z)return null;const I=xt(j.name||j.id||""),L=xt((j.id||j.name||"")+"·y"),D=(I-.5)*Math.min(z.w*.55,60),M=(L-.5)*Math.min(z.h*.55,60);return{d:j,x:z.x+z.w/2+D,y:z.y+z.h/2+M}}).filter(j=>!!j),[u,b]),k=j=>v>0?j/v:j,S=d.useMemo(()=>r?[0,1,2,3,4,5].map(j=>({c:mt[j],fr:f.plabels[j].toUpperCase(),en:f.plabels[j].toUpperCase(),n:n.filter(z=>z.kind==="target"&&X(z)===j).length})).filter(j=>j.n>0):tt.map((j,z)=>({...j,n:n.filter(I=>at(I)===z).length})),[n,r,f.plabels]),C=o?l.get(o):null,F=C?w.find(j=>j.d.id===C.id):null;return e.jsxs("div",{className:"mapzone",ref:g,children:[e.jsxs("svg",{ref:c,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":p==="fr"?s.fr:s.en,onMouseLeave:()=>{h(null),i(null)},children:[e.jsx("g",{children:s.countries.map((j,z)=>e.jsx("g",{className:"ct"+(j.i2&&N.get(j.i2)?"":" empty"),children:e.jsx("path",{d:j.d,"data-i2":j.i2||void 0})},z))}),e.jsx("g",{children:w.map(j=>{const z=tt[at(j.d)],I=!!Y(j.d),L=j.d.kind==="target",D=r&&L?mt[X(j.d)]:z.c,M=!r&&Q(j.d);return e.jsxs("g",{className:"co"+(M?" done":""),onMouseEnter:()=>{var B,_;const E=(B=g.current)==null?void 0:B.getBoundingClientRect(),P=(_=c.current)==null?void 0:_.createSVGPoint();if(P&&c.current&&E){P.x=j.x,P.y=j.y;const re=P.matrixTransform(c.current.getScreenCTM());h({x:re.x-E.left,y:re.y-E.top,label:j.d.name+" · "+(ve(j.d.cc,p)||j.d.countryLabel||"")})}i(j.d.id)},onMouseLeave:()=>{h(null),i(null)},onClick:()=>{var B;const E=(B=c.current)==null?void 0:B.createSVGPoint();let P=null;if(E&&c.current){E.x=j.x,E.y=j.y;const _=E.matrixTransform(c.current.getScreenCTM());P={x:_.x,y:_.y}}a({type:"popup",id:j.d.id,anchor:P})},children:[e.jsx("circle",{className:"h",cx:j.x,cy:j.y,r:k(Math.max(11,z.px+7))}),e.jsx("circle",{className:"v",cx:j.x,cy:j.y,r:k(z.px),fill:D,stroke:I?"#DC2626":"#ffffff",strokeWidth:k(I?2.2:1.3)})]},j.d.id||j.d.name)})}),F&&e.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:k(13),fill:"none",stroke:"#0F172A",strokeWidth:k(2)})]}),e.jsx("div",{className:"hov"+(x?" on":""),style:x?{left:x.x,top:x.y}:void 0,children:x==null?void 0:x.label}),e.jsx("div",{className:"legend",children:S.map((j,z)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":j.c}}),p==="fr"?j.fr:j.en," ",e.jsx("b",{children:j.n})]},z))}),n.some(j=>!j.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",f.notLocated," ",e.jsx("b",{children:n.filter(j=>!j.cc).length})]})})]})}function xr(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:i,contName:o}=T(),l=t.filters,p=d.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),f=b=>p.filter(m=>b!=="country"&&l.country.length&&!l.country.includes(m.cc||"")?!1:Ye(m,l,i,b==="country"?void 0:b)),c=d.useMemo(()=>{const b=f("win"),m=x=>b.filter(h=>(h.date?Math.max(0,Math.floor((Date.now()-Date.parse(h.date))/864e5)):9999)<=x).length;return[m(0),m(7),m(30),b.length]},[p,l,i]),g=d.useMemo(()=>{if(i)return null;const b=f("status"),m={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(x=>{m[se(x)]+=1}),m},[p,l,i]),s=l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+(l.signalOnly?1:0)+(l.win!=="all"?1:0)+(!i&&l.status!=="all"?1:0)+(l.search.trim()?1:0),v=(b,m,x,h="fbtn")=>e.jsxs("button",{type:"button",className:h,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:m}),x>0&&e.jsx("span",{className:"n",children:x}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,m)=>e.jsxs("button",{type:"button","aria-pressed":l.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[m],e.jsx("b",{children:c[m]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:l.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!i&&g&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,m])=>e.jsxs("button",{type:"button","aria-pressed":l.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[m,e.jsx("b",{children:g[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),l.signalOnly&&e.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,l.sector.length),v("pay",r.fCountry,l.country.length),v("det",r.fEngine,l.engine.length),v("sta",r.fStage,l.stage.length),i&&v("ang","Angle",l.angle.length),i&&v("mem","Mémo",l.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(gr,{poolFor:f})]})}function gr({poolFor:t}){const{st:a,dispatch:n,t:r,lang:i}=T(),o=a.filters,l=a.openFacet,{title:p,cols:f,options:c}=d.useMemo(()=>{if(l==="sig"){const m=t("signal").filter(u=>Y(u)),x=new Map;m.forEach(u=>{const N=u.engine||"";x.set(N,(x.get(N)||0)+1)});const h=[{v:"*",label:r.fpSigAll,n:m.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...rt([...x.keys()],i).map(u=>({v:u,label:he(u)+" "+oe(u,i),n:x.get(u)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(u)}))];return{title:r.fpSigTitle,cols:2,options:h}}if(l==="sec"){const m=t("sector"),x=new Map;return m.forEach(h=>{h.sector&&x.set(h.sector,(x.get(h.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...x.entries()].sort((h,u)=>u[1]-h[1]).map(([h,u])=>({v:h,label:h,n:u,html:!1,on:o.sector.includes(h)}))}}if(l==="pay"){const m=t("country"),x=new Map;return m.forEach(h=>{h.cc&&x.set(h.cc,(x.get(h.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...x.entries()].sort((h,u)=>u[1]-h[1]).map(([h,u])=>({v:h,label:ve(h,i)||h,n:u,html:!1,on:o.country.includes(h)}))}}if(l==="det"){const m=t("engine"),x=new Map;return m.forEach(h=>{h.engine&&x.set(h.engine,(x.get(h.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:rt([...x.keys()],i).map(h=>({v:h,label:he(h)+" "+oe(h,i)+' <span style="color:var(--dim);font-size:10px">· '+ia(la(h),i)+"</span>",n:x.get(h)||0,html:!0,on:o.engine.includes(h)}))}}if(l==="ang"){const m=t("angle"),x=new Map;return m.forEach(h=>{h.angle&&x.set(h.angle,(x.get(h.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...x.entries()].sort((h,u)=>u[1]-h[1]).map(([h,u])=>({v:h,label:h.replace(/[_-]+/g," "),n:u,html:!1,on:o.angle.includes(h)}))}}if(l==="mem"){const m=t("memoLevel"),x=new Map;m.forEach(u=>{if(u.kind==="target"){const N=Ve(u);x.set(N,(x.get(N)||0)+1)}});const h=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(u=>({v:String(u),label:h[u],n:x.get(u)||0,html:!1,on:o.memoLevel.includes(u)}))}}const v=t("stage"),b=new Map;return v.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,x)=>x[1]-m[1]).map(([m,x])=>({v:m,label:m,n:x,html:!1,on:o.stage.includes(m)}))}},[l,a,i]),g=v=>{if(l==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const m=o.signalEngines.includes(v)?o.signalEngines.filter(x=>x!==v):[...o.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(l==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:v})},s=()=>{n(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:p}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(f===2?" two":""),children:c.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>g(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const gt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function hr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:i,dispatch:o,evalBusy:l,evalCards:p,caps:f,data:c}=T(),g=a==="client",[s,v]=d.useState(""),[b,m]=d.useState(!1),[x,h]=d.useState(""),[u,N]=d.useState(!1),[w,k]=d.useState(""),[S,C]=d.useState([]),F=d.useRef(!1),j=s.trim()?gt.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,z=d.useMemo(()=>x.split(`
`).map(E=>E.trim()).filter(Boolean).slice(0,15),[x]),I=S.length?S:p,L=c.credits,D=()=>{const E=s.trim();E&&(r(null,E),v(""))},M=async()=>{if(!g){r(null,z[0]||"");return}if(!z.length||u)return;N(!0),F.current=!1;const E=[];for(let P=0;P<z.length&&!F.current;P++){k(t.evaluating(P+1,z.length,z[P]));const B=await St(n,z[P],"atelier2");if(E.unshift({name:B.company||z[P],verdict:B.verdict,reason:B.reason||"",remaining:B.remaining??null}),C([...E]),B.verdict==="quota"){E.unshift({name:"",verdict:"quota",reason:t.quota(z.length-P-1),remaining:0}),C([...E]);break}}k(""),h(""),N(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:E=>v(E.target.value),onKeyDown:E=>{E.key==="Enter"&&D()}}),e.jsx("span",{className:"detect"+(gt.test(s.trim())?" url":""),children:j})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),disabled:l,onClick:D,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),f.showCredits&&L&&e.jsxs("button",{type:"button",className:"credits"+(L.total_available<=0&&!L.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:L.unlimited?"∞":L.total_available}),!L.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",L.daily_grant+L.purchased]}),L.total_available<=0&&!L.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>m(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:x,placeholder:t.bulkPh,onChange:E=>h(E.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{justifyContent:"center"},disabled:u||!z.length,onClick:()=>{M()},children:[e.jsx("span",{className:"fill"}),u&&w?w:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(z.length)})]})]}),I.slice(0,1).map((E,P)=>{const B=E.verdict==="kept",_=E.verdict==="quota",re=B?"var(--brand)":_?"var(--bolt)":"var(--red)",de=B?"var(--brand-l)":_?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":re,"--bgc":de},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:B?"✓ "+t.kept:_?"⏳":"✗ "+t.dropped})}),E.name&&e.jsx("span",{className:"rn",children:E.name}),e.jsx("span",{className:"rr",children:E.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",E.reason]}):null}),!_&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(B?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},P)}),g&&(i.kept+i.dropped>0||I.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(i.kept,i.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function br(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function vr(){const{st:t,dispatch:a,byId:n,t:r,doDeep:i}=T(),o=t.memoConsole?n.get(t.memoConsole):null,l=d.useMemo(()=>o?[o.reasoning||"",br(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const p=Me(o),f=Ve(o);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:o.name}),p&&e.jsx("span",{className:"vv",children:p}),typeof o.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:r.memoSynth})}),e.jsx("div",{className:"mb2",children:l?l.split(`

`).map((c,g)=>e.jsx("p",{style:{margin:"0 0 10px"},children:c},g)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[_e(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:f===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}const Lt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ge({o:t}){const{t:a}=T(),n=Fe(t),r=Me(t),i=X(t),o=Ie(t),l=sa(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(Lt[r]||"v-cons"),title:a.vt[r],children:r}):i===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&e.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}function ht({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:i}=T(),[o,l]=d.useState(!1);if(d.useEffect(()=>{r||l(!1)},[r]),Q(t)){const c=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":c?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[c?"✓":"✗"," ",e.jsx("b",{children:c?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const f=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(f?" loading":""),disabled:r,onClick:c=>{c.stopPropagation(),l(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function yr({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:i,doAnalyse:o,doDecide:l,doPromote:p,doRepeche:f,doApproach:c,dispatch:g}=T();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),g({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(ht,{o:t})});const s=X(t),v=b=>m=>{m.stopPropagation(),b()};if(s===0)return e.jsx("span",{className:"cell",children:e.jsx(ht,{o:t})});if(s===1){const b=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:v(()=>o(t)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(s===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:v(()=>l(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:v(()=>l(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>g({type:"memoConsole",id:t.id})),children:"📄"})]})});if(s===4){const b=i.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:b,onClick:v(()=>c(t)),children:b?a.actApproachSent:a.actApproach})})}return s===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>p(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>g({type:"memoConsole",id:t.id})),children:"📄"})]})}):s===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>f(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>g({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:v(()=>g({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function wr({o:t}){const{t:a,doThumb:n,thumbOf:r}=T(),i=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function kr({o:t}){const{lang:a}=T();return Y(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(ye,{o:t}),e.jsx(De,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[he(t.engine||"")," ",oe(t.engine||"",a)]})})}function jr({o:t,locked:a,open:n,onToggle:r}){const{st:i,dispatch:o,caps:l,markRow:p,markedId:f,favIds:c,toggleFav:g}=T(),s=X(t),v=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,m=b<=0?0:b<=7?1:b<=30?2:3,x=l.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][s]:v[m],h=c.has(t.id),u=N=>{if(a)return;if(l.pipe){r();return}const w=N.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:w.left+Math.min(280,w.width/3),y:w.bottom}})};return e.jsxs(d.Fragment,{children:[e.jsxs("div",{className:"row"+(f===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>p(t.id),onMouseLeave:()=>p(null),onClick:u,children:[e.jsx("span",{className:"pt",style:{"--c":x}}),e.jsx(Ft,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[l.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:h?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),g(t)},children:h?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(N=>N&&N!==t.name)||""})]}),e.jsx(Nr,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(kr,{o:t}),l.pipe&&e.jsx(Ge,{o:t}),l.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(yr,{o:t}),l.showThumbs&&e.jsx(wr,{o:t})]}),(n||i.dens==="deplie")&&!a&&e.jsx(Sr,{o:t})]})}function Nr({o:t}){const{lang:a,caps:n}=T();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=He(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function Sr({o:t}){const{t:a,lang:n,dispatch:r,caps:i,outbound:o,doOnboard:l}=T();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),t.reasoning&&e.jsxs("div",{className:"dec"+(Fe(t)==="NO MATCH"?" out":""),title:t.reasoning,children:[e.jsx("em",{children:Fe(t)==="NO MATCH"?a.vOut:a.vKept}),t.reasoning.length>340?`${t.reasoning.slice(0,340)}…`:t.reasoning]}),t.ceoNote&&e.jsxs("div",{className:"ceonote",children:["💬 ",e.jsx("i",{children:t.ceoNote})]}),e.jsx(tr,{o:t}),e.jsx(nr,{o:t}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(Ge,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[he(t.engine||"")," ",oe(t.engine||"",n)]}),Y(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(ye,{o:t})})]}),i.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(t),children:a.actOnboard})]})]})]})}function Cr({o:t,locked:a}){const{t:n,dispatch:r,caps:i,doDecide:o}=T(),l=X(t),p=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":p},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(Ge,{o:t}),Y(t)&&e.jsx(ye,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&i.pipe&&l===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function zr(){const t=T(),{st:a,dispatch:n,t:r,caps:i,scoped:o,lang:l,sessTally:p}=t,[f,c]=d.useState(new Set);d.useEffect(()=>{c(new Set)},[a.ptab,a.continent]);const g=w=>c(k=>{const S=new Set(k);return S.has(w)?S.delete(w):S.add(w),S}),s=d.useMemo(()=>We(o,a.sort),[o,a.sort]),v=d.useMemo(()=>s.filter(w=>Y(w)&&!Q(w)).length,[s]),b=i.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,m=(w,k,S="",C=!1)=>e.jsxs("button",{type:"button","data-s":w,className:S,"aria-sort":a.sort.key===w?a.sort.dir===1?"ascending":"descending":"none",style:C?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:w}),children:[k,e.jsx("span",{className:"ar",children:a.sort.key===w&&a.sort.dir===1?"▴":"▾"})]},w),x=d.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const w=new Map;return s.forEach(k=>{const S=k.engine||"?";w.has(S)||w.set(S,[]),w.get(S).push(k)}),[...w.entries()]},[s,i.pipe,a.groupBy]),h=i.lockRowsAfter;let u=0;const N=(w,k)=>{const S=a.shown[k]||Oe,F=w.slice(0,S).map(j=>{const z=h!==null&&u>=h;return u++,a.dens==="maxi"?e.jsx(Cr,{o:j,locked:z},j.id):e.jsx(jr,{o:j,locked:z,open:f.has(j.id),onToggle:()=>g(j.id)},j.id)});return w.length>S&&F.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:k,by:Oe}),children:r.more(Math.min(Oe,w.length-S),w.length-S)},k+":more")),F};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:s.length})," ",b]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,i.pipe&&t.fund?" · "+t.fund:""]}),i.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),i.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([w,k])=>e.jsxs("button",{type:"button","data-d":w,"aria-pressed":a.dens===w,onClick:()=>n({type:"dens",dens:w}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:k})]},w))}),i.showChain&&s.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:s.filter(w=>i.pipe?!0:!Q(w)).map(w=>w.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",i.pipe?r.browse(s.length):r.chainAll(s.filter(w=>!Q(w)).length)]})]}),v>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(v)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),m("country",r.colCountry),m("name",r.colCompany),m("amount",r.colAmount,"h-amt",!0),m("stage",r.colStage,"h-stade"),m("signal",r.colSignal,"h-sig"),i.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),i.pipe&&m("score",r.colScore,"h-sc",!0),e.jsx("span",{}),i.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[x?x.map(([w,k])=>e.jsxs(d.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:he(w)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:oe(w,l)}),e.jsx("div",{className:"s",children:r.grpCount(k.filter(S=>!Q(S)).length,k.length)})]})]}),N(k,w)]},w)):N(s,"pt"+a.ptab),!s.length&&e.jsx("div",{className:"void",children:i.pipe?r.emptyTab:r.emptyScope})]}),i.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(p.kept>0||p.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(p.kept,p.dropped)}})]})}const Er=`
...
`;function Tr(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,i=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let l=t.y+10;return l+n>i-8&&(l=Math.max(8,t.y-n-14)),l<8&&(l=8),{left:o,top:l}}function Ar(){const{st:t,dispatch:a,byId:n,t:r,lang:i,caps:o,mode:l,askEvaluate:p,doAnalyse:f,doDecide:c,doPromote:g,doRepeche:s,doApproach:v,doDeep:b,doOnboard:m,outbound:x,evalBusy:h}=T(),u=t.popupId?n.get(t.popupId):null;if(!u)return null;const N=Y(u),w=X(u),k=Me(u),S=u.kind==="target",C=F=>{a({type:"filters",patch:F}),a({type:"popup",id:null})};return Se.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Er}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Tr(t.popupAnchor),onClick:F=>F.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:u.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(be(u.date)),oe(u.engine,i))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[u.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[u.cc]}),children:(ve(u.cc,i)||u.countryLabel||"").toUpperCase()}),u.sector&&e.jsx("button",{type:"button",onClick:()=>C({sector:[u.sector]}),children:u.sector.toUpperCase()}),u.stage&&e.jsx("button",{type:"button",onClick:()=>C({stage:[u.stage]}),children:u.stage.toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{className:"am2",children:He(u.amountEur,i)})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[he(u.engine)," ",e.jsx("b",{children:oe(u.engine,i)})," — ",da(u.engine,i),u.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",u.noteTitle]})]}),N?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(ye,{o:u,lg:!0})," ",e.jsx(De,{o:u,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(Ct(N,i))," · ",r.win7(zt(N,i))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&w>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),o.pipe&&S&&k&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[k,typeof u.score=="number"&&u.score>0?" · "+r.score(u.score):""]})})]}),e.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[w===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:h,onClick:()=>p(u),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),w===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{f(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),w===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),w===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(u,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{c(u,!1),a({type:"popup",id:null})},children:r.actNo}),_e(u)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{b(u),a({type:"popup",id:null})},children:r.memoDeep})]}),w===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{v(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),w===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),u.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:u.id}),a({type:"popup",id:null})},children:"📄"}),x&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{m(u),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:h,onClick:()=>p(u),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),u.website&&e.jsx("a",{className:"psite",href:u.website.startsWith("http")?u.website:"https://"+u.website,target:"_blank",rel:"noopener noreferrer",title:u.website,children:"🌐"})]})]})]}),document.body)}function bt(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Lr(t,a){const n=ca(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function Or(t,a){const r=[a.head.split("|").map(bt).join(";")];for(const i of t){const o=a.stageOf(i);r.push([i.name||"",Lr(i,a.plabels),Fe(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(bt).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function Fr(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const Mr=50;function Ke({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:i}=T(),[o,l]=d.useState(null),[p,f]=d.useState(!1),[c,g]=d.useState(""),[s,v]=d.useState(0),[b,m]=d.useState(""),[x,h]=d.useState(!1),u=d.useRef(null);d.useEffect(()=>()=>{u.current&&window.clearInterval(u.current)},[]);const N=async k=>{f(!0),g("");const S=await a();if(f(!1),S.ok){l(S);return}if(S.busy){g(i.alertPreviewBusy);return}if(!k){g(i.alertPreviewFail);return}v(Mr),u.current=window.setInterval(()=>{v(C=>C>1?C-1:(u.current&&window.clearInterval(u.current),N(!1),0))},1e3)},w=async()=>{if(r||x)return;h(!0),m("");const k=await n();h(!1),m(k.ok?i.alertTestOk(k.sentTo||""):k.error||i.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:p||s>0,onClick:()=>{N(!0)},children:p?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||x,onClick:()=>{w()},children:x?"…":i.alertTest})]}),s>0&&e.jsx("p",{className:"mnote",children:i.alertPreviewRetry(s)}),c&&e.jsx("p",{className:"mnote warn",children:c}),b&&e.jsx("p",{className:"mnote",children:b}),!b&&e.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Ne="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function J({title:t,icon:a,children:n,wide:r}){const{dispatch:i}=T();return Se.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function Dr(){const{st:t}=T();switch(t.modal){case"chain":return e.jsx(qr,{});case"space":return e.jsx(Pr,{});case"alert":return e.jsx(Br,{});case"queue":return e.jsx(_r,{});case"export":return e.jsx(Hr,{});case"plug":return e.jsx(Gr,{});case"recharge":return e.jsx(Kr,{});case"cover":return e.jsx(Qr,{});case"crit":return e.jsx(Jr,{});case"tuto":return e.jsx(Xr,{});case"rdv":return e.jsx(Rr,{});case"memoalert":return e.jsx(Yr,{});default:return null}}function Rr(){const{dispatch:t,fund:a}=T(),n=typeof document<"u"&&!!document.getElementById("rdv");return d.useEffect(()=>{n&&(t({type:"modal",modal:null}),Qa())},[n,t]),n?null:e.jsx(fa,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function qr(){const{st:t,dispatch:a,byId:n,t:r,lang:i,mode:o,askEvaluate:l,evalBusy:p}=T(),f=o==="client",c=t.chain.queue.map(b=>n.get(b)).filter(b=>!!b),g=t.chain.idx,s=c[g],v=g>=c.length;return Se.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:v?r.finished:`${g+1} / ${c.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(v?100:g/Math.max(1,c.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:v||!s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(c.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:s.name}),e.jsx("div",{className:"sub",children:[ve(s.cc,i)||s.countryLabel,s.sector,s.stage,r.daysAgo(be(s.date))].filter(Boolean).map(b=>String(b).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:oe(s.engine,i).toUpperCase()}),typeof s.amountEur=="number"&&s.amountEur>0&&e.jsx("span",{children:He(s.amountEur,i)})]}),Y(s)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(ye,{o:s,lg:!0})," ",e.jsx(De,{o:s,src:!0})]}),(s.tagline||s.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:s.tagline||s.headline})]}),s.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:s.reasoning})]}),f&&Q(s)&&e.jsxs("div",{className:"vbox",style:{"--c":se(s)==="retenu"?"var(--brand)":se(s)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:se(s)==="retenu"?"✓ "+r.kept:se(s)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:s.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!v&&s&&!(f&&Q(s))&&e.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:p,onClick:()=>{l(s)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?r.closeBtn:r.skip})]})]})})}),document.body)}function Pr(){const{st:t,dispatch:a,dossiers:n,t:r,mode:i}=T(),o=i==="client",l=d.useMemo(()=>o?n.filter(s=>Q(s)):[],[n,o]),p=d.useMemo(()=>We(l.filter(s=>se(s)==="retenu"),{key:"signal",dir:-1}),[l]),f=d.useMemo(()=>l.filter(s=>se(s)==="ecarte"),[l]),c=t.spaceTab==="retenu"?p:f,g=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(J,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:p.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:f.length})]})]}),c.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),c.slice(0,40).map(s=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":g},children:typeof s.score=="number"&&s.score>0?s.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:s.name}),e.jsx("div",{className:"rr",children:s.reasoning||s.tagline||""})]})]},s.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function Br(){const{mode:t}=T();return t==="client"||t==="apercu"?e.jsx(Ir,{}):e.jsx(Ur,{})}function Ir(){const{t,token:a,flash:n,flashErr:r,mode:i}=T(),[o,l]=d.useState("d"),p=i!=="client";return e.jsxs(J,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:t.alertTabWeekly})]}),o==="d"?e.jsx($r,{t,token:a,readOnly:p,flash:n,flashErr:r}):e.jsx(Vr,{t,token:a,readOnly:p,flash:n,flashErr:r})]})}function $r({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,l]=d.useState(null),[p,f]=d.useState(!1),[c,g]=d.useState(0);d.useEffect(()=>{let m=!0;return f(!1),lt(a).then(x=>{m&&(x?l(x):f(!0))}),()=>{m=!1}},[a,c]);const s=m=>{n||lt(a,m).then(x=>{if(!x){i(t.actErr);return}l(x),x.throttled?i(t.alertThrottled):r(t.alertSaved)})};if(p)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>g(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=m=>!o.sections||o.sections.includes(m),b=m=>{const x=o.sections||t.alertSec.map(([h])=>h);s({sections:v(m)?x.filter(h=>h!==m):[...x,m]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([m,x])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:v(m),disabled:n,onChange:()=>b(m)}),e.jsxs("span",{children:[x,m==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},m))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(Ke,{label:t.alertPreview,readOnly:n,onPreview:()=>ga(a),onTest:()=>xa(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Vr({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,l]=d.useState(null),[p,f]=d.useState(!1),[c,g]=d.useState(0);d.useEffect(()=>{let m=!0;return f(!1),st(a).then(x=>{m&&(x?l(x):f(!0))}),()=>{m=!1}},[a,c]);const s=m=>{n||st(a,m).then(x=>{if(!x){i(t.actErr);return}l(x),r(t.alertSaved)})};if(p)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>g(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=o.dow??0,b=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:v,disabled:n,onChange:m=>s({dow:Number(m.target.value)}),children:t.alertDow.map((m,x)=>e.jsx("option",{value:x,children:m},m))}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,b-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[b," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,b+1)}),disabled:n,children:"＋"})]})]}),e.jsx(Ke,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>ba(a),onTest:()=>ha(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Ur(){const{st:t,t:a,lang:n,scoped:r,contName:i}=T(),[o,l]=d.useState(""),[p,f]=d.useState(!1),[c,g]=d.useState(!1),s=t.filters,v=d.useMemo(()=>r.filter(h=>Y(h)).length,[r]),b=s.win==="1"?0:s.win==="7"?1:s.win==="30"?2:3,m=async()=>{if(!(!/.+@.+\..+/.test(o)||c)){g(!0);try{await fetch(`${$e}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o.trim(),sectors:s.sector,countries:s.country,source:"atelier2",website:""})}),f(!0)}finally{g(!1)}}},x=[[a.amRows.continent,i],[a.amRows.since,a.amSince[b]],[a.amRows.signal,s.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,s.engine.length?s.engine.map(h=>oe(h,n)).join(", "):a.amAllEngines],[a.amRows.sectors,s.sector.length?s.sector.join(", "):a.amAllSectors],[a.amRows.countries,s.country.length?s.country.map(h=>ve(h,n)||h).join(", "):a.amAllCountries],[a.amRows.stages,s.stage.length?s.stage.join(", "):a.amAllStages]];return e.jsx(J,{title:a.alertTitle,icon:"🔔",children:p?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(o)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:x.map(([h,u])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:h}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:u}})]},h))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:o,onChange:h=>l(h.target.value),onKeyDown:h=>{h.key==="Enter"&&m()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void m(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function _r(){var x,h,u;const{t,token:a,fund:n,mode:r,flash:i}=T(),[o,l]=d.useState(null),[p,f]=d.useState([]),[c,g]=d.useState(0),s=r==="client";d.useEffect(()=>{let N=!0;return(async()=>{const[w,k]=await Promise.all([kt(n),jt(a)]);N&&(w&&l(w),f(k))})(),()=>{N=!1}},[a,n,c]);const v=(o==null?void 0:o.per_day)??2,b=((x=o==null?void 0:o.analyzed_today)==null?void 0:x.length)??0,m=(h=o==null?void 0:o.tomorrow)!=null&&h.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(J,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(b,b+(((u=o==null?void 0:o.pool_order)==null?void 0:u.length)??0))}})}),e.jsx("div",{className:"qrate",children:t.queueRate}),e.jsx("div",{className:"qrates",children:[1,2,3,5,10].map(N=>e.jsx("button",{type:"button",className:"qr"+(v===N?" on":""),disabled:!s,onClick:()=>{Nt(a,N).then(w=>{w!==null&&(g(k=>k+1),i(t.alertSaved))})},children:e.jsxs("b",{children:[N,"/j"]})},N))})]}),p.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:p.map(N=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:N.company}),e.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),e.jsx("span",{className:"qt",children:N.status}),N.url&&e.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),s&&N.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{it(a,N.company,"retry").then(()=>g(w=>w+1))},children:t.queueRetry}),s&&N.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{it(a,N.company,"delete").then(()=>g(w=>w+1))},children:t.queueDelete})]},N.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[m.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),m.slice(0,10).map((N,w)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",w+1]}),e.jsx("b",{children:N.name}),typeof N.score=="number"&&e.jsx("span",{className:"qs2",children:N.score})]},N.name))]})]})}function Hr(){const{t,token:a,flash:n,scoped:r,caps:i,stageOf:o}=T(),l=`${Ne}/cibles/list.csv?token=${a}`,p=`${Ne}/cibles/list.json?token=${a}`,f=`${Ne}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${l}")`,g=m=>{var x;(x=navigator.clipboard)==null||x.writeText(m).then(()=>n(t.exportCopied))},s=[{def:t.exportCsv,value:l,href:l},{def:t.exportSheet,value:c},{def:t.exportLive,value:p,href:p},{def:t.exportXlsx,value:f,href:f}],v=!i.lockActions&&r.length>0,b=()=>{Fr(Or(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:m=>(t.stg.find(([x])=>x===m)||["",""])[1]})),n(t.exportViewDone(r.length))};return e.jsxs(J,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:b,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:s.map(({def:m,value:x,href:h})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:m[0]}),e.jsxs("div",{children:[e.jsx("b",{children:m[1]}),e.jsx("p",{children:m[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>g(x),children:t.exportCopy}),h&&e.jsx("a",{className:"exb",href:h,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},m[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function Yr(){const{t,token:a,flash:n,flashErr:r,mode:i}=T(),o=i!=="client",[l,p]=d.useState(null),[f,c]=d.useState(!1),[g,s]=d.useState(0),[v,b]=d.useState(!1);d.useEffect(()=>{let u=!0;return c(!1),nt(a).then(N=>{u&&(N?p(N):c(!0))}),()=>{u=!1}},[a,g]);const m=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},x=u=>{if(o||!l)return;const N={enabled:u.enabled??!!l.enabled,email:u.email??(l.email||""),sections:u.sections??m()};b(!0),nt(a,N).then(w=>{if(b(!1),!w){r(t.memoAlertErr);return}p(w),n(t.memoAlertSaved)})};if(f)return e.jsx(J,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:t.retry})]})});if(!l)return e.jsx(J,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const h=m();return e.jsxs(J,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||v,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),e.jsx(Wr,{value:l.email||"",readOnly:o||v,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:u=>x({email:u})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([u,N])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!h[u],disabled:o||v,onChange:()=>x({sections:{...h,[u]:!h[u]}})}),e.jsx("span",{children:N})]},u))}),e.jsx(Ke,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>ua(a,h),onTest:()=>pa(a,h)})]})}function Wr({value:t,readOnly:a,label:n,okLabel:r,onSave:i}){const[o,l]=d.useState(t);d.useEffect(()=>{l(t)},[t]);const p=o.trim()!==t.trim(),f=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:c=>l(c.target.value),onKeyDown:c=>{c.key==="Enter"&&p&&f&&i(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!p||!f,onClick:()=>i(o.trim()),children:r})]})]})}function Gr(){const{t,token:a,flash:n,mode:r}=T(),[i,o]=d.useState(null),[l,p]=d.useState(""),f=r==="client";d.useEffect(()=>{let s=!0;return ot(a).then(v=>{s&&v&&o(v)}),()=>{s=!1}},[a]);const c=(s,v)=>{f&&ot(a,s).then(b=>{b&&b.ok!==!1&&(n(v),o({configured:!s.remove&&(s.url?!0:i==null?void 0:i.configured),url_hint:b.url_hint}))})},g='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(J,{title:t.plugTitle,icon:"🔌",children:[e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.plugWebhook}),e.jsxs("p",{children:[t.plugWebhookHint,i!=null&&i.configured?` — ${t.plugConfigured}${i.url_hint?` (${i.url_hint})`:""}`:""]}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:"https://…",value:l,onChange:s=>p(s.target.value),disabled:!f}),e.jsx("button",{type:"button",className:"abtn p",disabled:!f||!l.trim(),onClick:()=>c({url:l.trim()},t.alertSaved),children:t.plugSave}),e.jsx("button",{type:"button",className:"abtn",disabled:!f||!(i!=null&&i.configured),onClick:()=>c({test:!0},t.plugTest+" ✓"),children:t.plugTest}),e.jsx("button",{type:"button",className:"abtn",disabled:!f||!(i!=null&&i.configured),onClick:()=>c({remove:!0},t.plugRemove+" ✓"),children:t.plugRemove})]})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.plugMcp}),e.jsx("p",{children:t.plugMcpHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{readOnly:!0,value:g}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var s;(s=navigator.clipboard)==null||s.writeText(g).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function Kr(){const{t,data:a,lang:n}=T(),r=a.credits,i=a.email,o=async l=>{if(!i)return;const p=window.location.href.split("?")[0];try{const c=await(await fetch(`${$e}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:p+"?credits=ok",cancel_url:p+"?credits=cancel"})})).json();c.url&&(window.location.href=c.url)}catch{}};return e.jsxs(J,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(l=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(l.credits,l.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:t.rechargeBuy})]},l.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function Qr(){const{t,data:a,dossiers:n}=T(),r=n.filter(o=>o.kind==="target"&&Q(o)).length,i=a.marketEstimate||0;return e.jsx(J,{title:t.coverTitle,icon:"🌍",children:i>0?e.jsx("p",{dangerouslySetInnerHTML:{__html:t.coverBody(r,i)}}):e.jsx("p",{children:t.coverScreened(r)})})}function Jr(){var u,N,w;const{t,dossiers:a,token:n,mode:r,flash:i,criteria:o}=T(),l=r==="client",p=d.useMemo(()=>{const k=new Set;return a.forEach(S=>{S.angle&&k.add(S.angle)}),[...k]},[a]),[f,c]=d.useState(null);d.useEffect(()=>{let k=!0;return ma(n).then(S=>{k&&c(S.thumbs)}),()=>{k=!1}},[n]);const[g,s]=d.useState(""),[v,b]=d.useState(""),[m,x]=d.useState(!1),h=async()=>{const k=g.trim();if(!(!k||m||!l)){x(!0),b("");try{const C=await(await fetch(`${Ne}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:k,who:"atelier2"})})).json().catch(()=>({}));if(C.reply&&b(String(C.reply)),C.job_id){b(t.critChatRunning);const F=async()=>{const j=await fetch(`${Ne}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:C.job_id})}).then(z=>z.json()).catch(()=>null);if(j&&j.done){b(String(j.reply||j.clarification||j.summary||"✓")),x(!1),j.applied&&i(t.alertSaved);return}setTimeout(()=>{F()},8e3)};setTimeout(()=>{F()},8e3),s("");return}s("")}finally{v.startsWith("⏳")||x(!1)}}};return e.jsxs(J,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((u=o.points)!=null&&u.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(k=>e.jsx("li",{children:k},k))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((N=o==null?void 0:o.angles)!=null&&N.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(k=>{var S,C;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:k.title}),k.why&&e.jsx("p",{className:"why",children:k.why}),e.jsxs("div",{className:"lo",children:[!!((S=k.look)!=null&&S.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:k.look.map(F=>e.jsx("li",{children:F},F))})]}),!!((C=k.out)!=null&&C.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:k.out.map(F=>e.jsx("li",{children:F},F))})]})]})]},k.title)})]}),!!((w=o==null?void 0:o.gate)!=null&&w.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(k=>e.jsxs("li",{children:[k.k&&e.jsx("b",{children:k.k}),k.t]},k.t))})]}),p.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:p.map(k=>e.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:g,disabled:!l||m,onChange:k=>s(k.target.value),onKeyDown:k=>{k.key==="Enter"&&h()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!l||m||!g.trim(),onClick:()=>void h(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),v&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:v})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),f===null?e.jsx("div",{className:"sp-empty",children:"…"}):f.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:f.slice(0,12).map((k,S)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:k.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:k.company}),e.jsx("span",{className:"qd",children:(k.ts||"").slice(0,10)})]},S))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([k,S])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Lt[k]||"v-cons"),children:k}),e.jsx("span",{children:S})]},k))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([k,S])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:k}),e.jsxs("span",{children:["← ",S]})]},k))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function Xr(){const{t,dispatch:a,startTour:n}=T(),r=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return e.jsxs(J,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([i,o],l)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:p=>{(p.key==="Enter"||p.key===" ")&&(p.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:l+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const Ot=d.createContext(null),T=()=>{const t=d.useContext(Ot);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function ye({o:t,lg:a}){const{lang:n}=T(),r=Y(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:dt(r,n),children:[r.emoji," ",dt(r,n)]}):null}function De({o:t,src:a}){const{lang:n,t:r}=T(),i=Y(t);if(!i)return null;const o=ja(i),l=Na(i);return e.jsxs("em",{className:"sigwin"+(l?" hot":""),title:r.signaledOn(Ct(i,n))+" · "+r.win7(zt(i,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(p,f)=>e.jsx("i",{className:f<o?"on":""},f))}),e.jsx("span",{className:"lb",children:l?r.lastDay:r.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&e.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:p=>p.stopPropagation(),children:"↗"})]})}function Ft({o:t}){const{lang:a}=T(),n=ka(t.cc),r=t.cc?ve(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const vt="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Mt=t=>`atl2:tour:${t||"anon"}`;function Zr(t){try{return localStorage.getItem(Mt(t))==="1"}catch{return!0}}function yt(t){try{localStorage.setItem(Mt(t),"1")}catch{}}function en(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function on({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:i,onFiltersChange:o}){const{lang:l}=va(),p=Oa[l],f=Ua(t,l,a),[c,g]=d.useReducer(Ha,void 0,()=>_a((r==null?void 0:r.continent)??"europe",t,{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),s=d.useRef(o);s.current=o,d.useEffect(()=>{var y;(y=s.current)==null||y.call(s,c.filters)},[c.filters]);const[v,b]=d.useState(null),[m,x]=d.useState(null),[h,u]=d.useState({kept:0,dropped:0}),[N,w]=d.useState(!1),[k,S]=d.useState(""),[C,F]=d.useState(!1),[j,z]=d.useState(null),[I,L]=d.useState(!1),[,D]=d.useState(0),M=()=>D(y=>y+1),E=d.useRef([]),P=d.useRef(new Set),B=d.useRef(new Set),_=d.useRef(new Map),re=d.useRef(null),{mode:de}=f,$=d.useMemo(()=>i?{...f.caps,...i}:f.caps,[f.caps,i]),ie=$.pipe,q=f.session.token||"",V=de==="client"&&!t;d.useEffect(()=>{if(document.querySelector(`link[href="${vt}"]`))return;const y=document.createElement("link");y.rel="stylesheet",y.href=vt,document.head.appendChild(y)},[]);const R=(y,A=!1)=>{S(y),F(A),re.current&&clearTimeout(re.current),re.current=setTimeout(()=>S(""),A?4200:2400)},G=y=>R(y,!0),ae=d.useMemo(()=>{const y=new Map;return f.dossiers.forEach(A=>{A.id&&y.set(A.id,A)}),y},[f.dossiers]),Z=d.useMemo(()=>f.dossiers.filter(y=>Tt(y,c,ie)),[f.dossiers,c,ie]),ee=d.useRef(!1);d.useEffect(()=>{if(ee.current||t||f.loading||!f.dossiers.length)return;if(!$.showFunnel||Zr(f.session.token||"")){ee.current=!0;return}ee.current=!0;const y=window.setTimeout(()=>{yt(f.session.token||""),L(!0)},700);return()=>window.clearTimeout(y)},[t,f.loading,f.dossiers.length,$.showFunnel,f.session.token]);const te=d.useMemo(()=>f.dossiers.filter(y=>Ya(y,c,ie,f.favIds)),[f.dossiers,c,ie,f.favIds]),K=d.useMemo(()=>ya(Z,f.favIds),[Z,f.favIds]),me=Ue.find(y=>y.key===c.continent),U=l==="fr"?me.fr:me.en,ne=(y,A)=>{const O=((y==null?void 0:y.name)||A||"").trim();if(!V){x({kicker:O});return}!O||N||(w(!0),(async()=>{try{const H=await St(q,O,"atelier2"),ze={name:H.company||O,verdict:H.verdict,reason:H.reason||"",remaining:H.remaining??null};E.current=[ze,...E.current].slice(0,8),H.verdict==="kept"&&u(ue=>({...ue,kept:ue.kept+1})),H.verdict==="ruled_out"&&u(ue=>({...ue,dropped:ue.dropped+1}));const ke=y||f.dossiers.find(ue=>(ue.name||"").toLowerCase()===O.toLowerCase());ke&&(H.verdict==="kept"?ke.verdict=ke.verdict||"MATCH":H.verdict==="ruled_out"&&(ke.verdict="NO MATCH"),H.reason&&(ke.reasoning=H.reason)),M()}finally{w(!1)}})())},ce=y=>{if(!V){x({kicker:y.name});return}P.current.add(y.id),je(q,"fast_request",y.name||"",""),R(p.memoInstantSent(y.name)),M()},we=y=>_.current.get(y.id)??f.thumbs.get((y.name||"").trim().toLowerCase()),pe=(y,A)=>g({type:"undoPush",entry:{id:y.id,name:y.name,prevCeoStatus:A}}),W=async(y,A,O)=>{const H=y.ceoStatus||"";y.ceoStatus=A,M();const ze=await Pe(q,{status:A,airtable_id:y.airtableId,check_id:y.checkId,company:y.name,...(O==null?void 0:O.note)!==void 0?{note:O.note}:{},...O!=null&&O.via?{via:O.via}:{}});return ze.ok?ze.skipped?(y.ceoStatus=H,M(),G(p.actNotPersisted),!1):((O==null?void 0:O.undo)!==!1&&pe(y,H),O!=null&&O.msg&&R(O.msg),(A==="Validé"||A==="Écarté")&&!y.ceoNote&&(O==null?void 0:O.note)===void 0&&z({o:y,yes:A==="Validé"}),!0):(y.ceoStatus=H,M(),G(p.actErr),!1)},Ce=async(y,A)=>{const O=await Pe(q,{status:y.ceoStatus||"Retenu",airtable_id:y.airtableId,check_id:y.checkId,company:y.name,note:A,via:"note"});return!O.ok||O.skipped?(G(O.skipped?p.actNotPersisted:p.actErr),!1):(y.ceoNote=A,M(),!0)},xe=d.useRef(new Map),le=y=>xe.current.has(y.id)?xe.current.get(y.id):f.stages.get((y.name||"").trim().toLowerCase()),ge=(y,A)=>{xe.current.set(y.id,A),M()},Dt=(y,A)=>{V&&W(y,A?"Validé":"Écarté",{msg:A?p.decidedYes(y.name):p.decidedNo(y.name)})},Rt=y=>{V&&W(y,"À trancher",{msg:p.promoted(y.name)})},qt=y=>{V&&(async()=>{const A=y.ceoStatus||"";y.ceoStatus="Retenu",M();const O=await Pe(q,{status:"Retenu",check_id:y.checkId,company:y.name});if(!O.ok||O.skipped){y.ceoStatus=A,M(),G(O.skipped?p.actNotPersisted:p.actErr);return}pe(y,A),R(p.repeched(y.name))})()},Pt=()=>{const y=c.undo[c.undo.length-1];if(!y){R(p.undoNone);return}const A=ae.get(y.id);if(!A){g({type:"undoPop"}),R(p.undoNone);return}let O=y.prevCeoStatus;if(!O)if((A.verdict||"").toUpperCase().includes("CALL"))O="À trancher";else{R(p.undoLockedTitle);return}(async()=>await W(A,O,{undo:!1})&&(g({type:"undoPop"}),A.ceoStatus=y.prevCeoStatus,M(),R(p.undoDone(A.name))))()},Bt=y=>{V&&(B.current.add(y.id),M(),(async()=>{const A=await Sa(q,y.name,"email");if(!A||A.ok===!1){B.current.delete(y.id),M(),G(p.actErr);return}je(q,"approach",y.name||"",""),R(p.actApproachSent)})())},It=(y,A)=>{V&&(async()=>{if(!(await je(q,A?"yes":"no",y.name||"","")).ok){G(p.actErr);return}_.current.set(y.id,A?"yes":"no"),M(),R(A?p.thumbUpDone:p.thumbDnDone)})()},$t=y=>{!V||!_e(y)||(je(q,"detailed_request",y.name||"",""),R(p.memoDeepSent(y.name)))},Vt=y=>{const A=new Set(f.favIds),O=A.has(y.id);O?A.delete(y.id):A.add(y.id),f.setFavIds(A),V&&Ca(q,{id:y.id,co:y.name},O)},Ut=()=>{V&&(za(q),R(p.identSyncDone))},Qe=/proplace/i.test(f.fund||""),_t=y=>{!V||!Qe||(je(q,"onboard_request",y.name||"",""),R(p.onboardSent(y.name)))},Ht={st:c,dispatch:g,t:p,lang:l,mode:de,caps:$,pipe:ie,token:q,fund:f.fund,email:f.email,criteria:f.criteria,data:f,doRepeche:qt,thumbOf:we,canWrite:V,commitStatus:W,saveNote:Ce,stageOf:le,setStage:ge,flashErr:G,startTour:()=>L(!0),dossiers:f.dossiers,scopedAll:Z,scoped:te,counts:K,byId:ae,contName:U,favIds:f.favIds,toggleFav:Vt,askEvaluate:ne,doAnalyse:ce,doDecide:Dt,doPromote:Rt,doApproach:Bt,doThumb:It,doDeep:$t,doUndo:Pt,doSync:Ut,doOnboard:_t,outbound:Qe,memoQueued:P.current,approachDone:B.current,sessTally:h,evalCards:E.current,evalBusy:N,markRow:b,markedId:v,flash:R};return d.useEffect(()=>{const y=A=>{A.key==="Escape"&&(g({type:"popup",id:null}),g({type:"modal",modal:null}),g({type:"openFacet",facet:null}))};return window.addEventListener("keydown",y),()=>window.removeEventListener("keydown",y)},[]),e.jsx(Ot.Provider,{value:Ht,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Da}),e.jsxs("div",{className:"app"+(ie?" pipe":""),children:[$.showTicker&&e.jsx(Wa,{}),$.showIdent&&e.jsx(lr,{}),$.showOnb&&e.jsx(sr,{}),e.jsx(ir,{}),$.showFunnel&&e.jsx(tn,{}),$.showFunnel&&e.jsx(cr,{}),$.showFunnel&&e.jsx(ur,{}),e.jsxs("div",{className:"fzone",children:[e.jsx(an,{}),e.jsxs("div",{className:"stage"+(c.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(mr,{}),e.jsx(xr,{})]})]}),$.showDemand&&e.jsx(hr,{}),$.showDemand&&c.memoConsole&&e.jsx(vr,{}),e.jsx(zr,{}),f.loading&&e.jsx("div",{className:"void",children:p.loadingV2}),f.error&&!f.loading&&e.jsxs("div",{className:"void",children:[p.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:f.refresh,children:p.retry})]})]}),$.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:p.lockbarText}),e.jsx("button",{type:"button",onClick:()=>g({type:"modal",modal:"rdv"}),children:p.lockbarCta})]}),c.popupId&&e.jsx(Ar,{}),e.jsx(Dr,{}),e.jsx(Xa,{}),j&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:j.o.name}),e.jsx(rr,{placeholder:j.yes?p.whyYesPh:p.whyNoPh,onDone:y=>{const A=j.o;z(null),y&&Ce(A,y).then(O=>{O&&R(p.csNoteSaved)})}})]}),I&&e.jsx(or,{steps:en(p),onClose:()=>{L(!1),yt(q)}}),k&&e.jsx("div",{className:"flash on"+(C?" err":""),children:k}),m&&e.jsx(wa,{variant:"acquirer",initialCompany:wt().co,initialWebsite:wt().site,onClose:()=>x(null)})]})})}function tn(){const{t}=T(),[a,n]=d.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function an(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:i,t:o}=T(),l=d.useMemo(()=>{const p={};return t.forEach(f=>{f.continent&&Ye(f,a.filters,r)&&(p[f.continent]=(p[f.continent]||0)+1)}),p},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[Ea.map(p=>{const f=Ue.find(c=>c.key===p);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===p,onClick:()=>n({type:"continent",key:p}),children:[i==="fr"?f.fr:f.en,e.jsx("span",{className:"n",children:l[p]||0})]},p)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function wt(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function rn(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{Ft as FlagCell,ye as SigBadge,De as SigWin,on as default,rn as fmtShort,T as useV2};
