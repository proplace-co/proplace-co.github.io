...
.atl2 .bulk .side .hint{white-space:nowrap}`,Ns=`
...
`,Ss=js+Ns+Es;function cn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Cs(){const e=cn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function zs(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Cs();return r==="0"?"client":r==="1"||cn("embed")==="1"&&cn("chrome")==="1"?"apercu":"client"}const As={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ts=e=>As[e];function Ca(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const St=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Jr(a)||Ca(a))&&(e.noCo=!0)}return Object.assign(e,{continent:ci(e.cc)})};function Wa(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const qs=60*60*1e3;function Ls(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>qs?null:a}catch{return null}}function ua(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Fs=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Rs(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:Zo(),[e,n]),i=p.useMemo(()=>n?"visiteur":zs(e,o),[e,o,n]),s=p.useMemo(()=>Ts(i),[i]),l=i!=="visiteur",c=Fs(r),[g,d]=p.useState([]),[h,u]=p.useState(""),[v,m]=p.useState(null),[b,y]=p.useState(null),[f,j]=p.useState(null),[N,w]=p.useState(()=>new Map),[E,A]=p.useState(()=>new Map),[C,L]=p.useState(""),[T,R]=p.useState(new Set),[I,B]=p.useState(null),[F,M]=p.useState(!0),[x,q]=p.useState(!1),[H,J]=p.useState(0),[_,D]=p.useState(0),K=p.useRef(0),W=p.useMemo(()=>{var te;if(i!=="client")return"";try{return((te=ei())==null?void 0:te.email)||""}catch{return""}},[i]);p.useEffect(()=>{const te=++K.current;let he=!0;const ee=()=>he&&te===K.current,ce=(l&&o.token?o.token:"pub:"+a)+(c?":"+c:""),pe=Ls(ce);return pe?(d(pe.objs.map(St)),pe.fund&&u(pe.fund),m(pe.marketEstimate??null),y(pe.criteria??null),j(pe.stats??null),L(pe.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(r==="ops"){const je=await $a(),be=((je==null?void 0:je.recent_ops)||[]).map(le=>{const ue=wa(le.company_name||le.title?le:{...le,title:(le.headline_fr||le.headline||"").slice(0,120)},a),oe=String(le.rubrique||"").toLowerCase();return ue&&(oe==="nominations"||oe==="recrutements")&&(ue.engine=oe),ue&&!String(le.company_name||"").trim()&&(ue.noCo=!0),ue}).filter(le=>!!le).map(le=>(Jr((le.name||"").trim())||(le.noCo=!0),le));try{const le=ti(),ue=await ai(),oe=((ue==null?void 0:ue.date)||"").slice(0,10),$=le?le.doc:ue,ne=ni($),fe=((le==null?void 0:le.day)||($==null?void 0:$.date)||oe||"").slice(0,10);if(fe&&ne.length){const we=new Set;for(const Ne of be){if((Ne.date||"").slice(0,10)!==fe)continue;const ve=$n(ne,we,Ne.name,"");ve>=0&&(we.add(ve),Ne.decryptHtml=ne[ve].html)}for(const Ne of be){if(Ne.decryptHtml||(Ne.date||"").slice(0,10)!==fe)continue;const ve=$n(ne,we,"",Ne.headline||Ne.tagline||Ne.name);ve>=0&&(we.add(ve),Ne.decryptHtml=ne[ve].html)}}if(fe){const we=(($==null?void 0:$.title_fr)||"").trim(),Ne=(($==null?void 0:$.lead_fr)||"").trim(),ve=ri($),re=(($==null?void 0:$.url)||"").trim();we&&(ve||re)&&be.unshift({id:`edito:${fe}`,kind:"op",name:we,cc:null,date:fe,engine:"edito",dealKind:"other",headline:we,tagline:Ne||we,decryptHtml:ve||void 0,url:re,noCo:!0})}}catch{}if(!ee())return;d(be.map(St)),ua(ce,{objs:be})}else if(typeof r=="object"){const be=(await Un()||[]).filter(ue=>(ue.slug||"")===r.research).map(ue=>Hn(ue,a)).filter(ue=>!!ue),le=Wa(await Vn(be,a));if(!ee())return;d(le.map(St)),ua(ce,{objs:le})}else if(l&&o.token){const je=oi(o.token),be=$a(),le=ii(o.token),ue=si(o.token),oe=li(o.token),$=await je;let ne=$?$.targets:[];ee()&&$&&(u($.fund||""),m($.marketEstimate??null),y($.criteria??null),j($.stats??null),L($.generatedAt||""),d(ne.map(St)),M(!1),q(!1));const[fe,we,Ne,ve]=await Promise.all([be,le,ue,oe]),re=((fe==null?void 0:fe.recent_ops)||[]).map(me=>wa(me,a)).filter(me=>!!me),Te=new Set(ne.map(me=>me.id));if(ne=[...ne,...re.filter(me=>!Te.has(me.id)&&(Te.add(me.id),!0))],!ee())return;d(ne.map(St));const Ke=new Set;for(const me of we){const Ee=(me.id||me.co||"").toString().trim().toLowerCase();Ee&&Ke.add(Ee.startsWith("t:")?Ee:"t:"+Ee)}R(Ke),w(Ne),A(ve),$&&ua(ce,{fund:$.fund,marketEstimate:$.marketEstimate,criteria:$.criteria,stats:$.stats,generatedAt:$.generatedAt,objs:ne})}else{const je=di(),be=Un(),le=$a(),ue=await je;ee()&&ue.length&&(d(Wa(ue).map(St)),M(!1),q(!1));const[oe,$]=await Promise.all([be,le]),ne=(oe||[]).map(ve=>Hn(ve,a)).filter(ve=>!!ve),fe=await Vn(ne,a),we=(($==null?void 0:$.recent_ops)||[]).map(ve=>wa(ve,a)).filter(ve=>!!ve),Ne=Wa([...ue,...fe,...we]);if(!ee())return;d(Ne.map(St)),ua(ce,{objs:Ne})}ee()&&q(!1)}catch{ee()&&!pe&&q(!0)}finally{ee()&&M(!1)}})(),()=>{he=!1}},[l,o.token,a,H,c]),p.useEffect(()=>{if(!s.showCredits||!W){B(null);return}let te=!0;return(async()=>{try{const he=await fetch(`${Pa}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:W})});if(!he.ok)return;const ee=await he.json();te&&ee&&ee.ok!==!1&&B(ee)}catch{}})(),()=>{te=!1}},[s.showCredits,W,_]);const Q=p.useCallback(te=>R(new Set(te)),[]);return{session:o,mode:i,caps:s,fund:h,email:W,marketEstimate:v,generatedAt:C,criteria:b,stats:f,thumbs:N,stages:E,dossiers:g,favIds:T,setFavIds:Q,credits:I,reloadCredits:()=>D(te=>te+1),loading:F,error:x,refresh:()=>J(te=>te+1)}}function Ve(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ka=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function za(e){return ka.has(e.engine||"")}function He(e){return!!e.noCo||za(e)&&!!e.url}const oo=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ms=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...oo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Os=new Set(["signal","amount","score","crible","memo"]);function Ds(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:oo(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Os.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??io)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const io=80;function Aa(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Pe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Sn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(xt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&zt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function na(e,a,r){return Ve(e)?Aa(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Aa(e,a.filters,r)}function Is(e,a,r,n){return!(!na(e,a,r)||r&&!pi(e,a.ptab,n))}function An(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-xt(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return mi(o);case"memo":return ui(o);case"signal":{const i=Pe(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const s=n(o),l=n(i);return s<l?-a.dir:s>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Ga={},rr=(Ga==null?void 0:Ga.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function or(){return new Date().toISOString().slice(0,10)}const Tn=p.createContext(null);function so(){return p.useContext(Tn)}function Ps(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),s=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),l.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(d=>c.removeAttribute(d.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Bs(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),s=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(s);!l&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function ir(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),s=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),s&&n.setAttribute("class",s),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function sr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${i} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${i} ${r[1]}`}function lo(){const e=p.useContext(Tn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function _s({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Y(),[i,s]=p.useState(()=>n.filters.day||or()),[l,c]=p.useState(null),[g,d]=p.useState(!1),h=p.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){s(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{s(or());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const b=y=>{var j;const f=(j=y.detail)==null?void 0:j.day;typeof f=="string"&&h(f)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[h]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&s(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let b=!1;d(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${rr}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{b||c(f)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||d(!1)}),()=>{b=!0}},[e,i]);const v=p.useMemo(()=>`${rr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=p.useMemo(()=>({token:e,day:i,ed:l,loading:g,pickDay:h,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:v,isEn:o==="en"}),[e,i,l,g,h,u,n.filters.day,v,o]);return t.jsx(Tn.Provider,{value:m,children:a})}function $s(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=lo(),[o,i]=p.useState(()=>n||Xr());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const s=l=>{var c;return i(!!((c=l.detail)!=null&&c.open))};return window.addEventListener(Ea,s),()=>window.removeEventListener(Ea,s)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(fi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Us(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function lr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function dr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Hs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=lo(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!s,c=a&&!a.ok,g=p.useRef(null),[d,h]=p.useState("fonds"),[u,v]=p.useState(null),[m,b]=p.useState("idle"),y=p.useRef(!1);p.useEffect(()=>{v(null),b("idle"),y.current=!1,h("fonds")},[e]),p.useEffect(()=>{if(d!=="jour"||y.current)return;y.current=!0;let E=!0;return b("load"),Us(e).then(A=>{E&&(v(A),b("fait"))}),()=>{E=!1}},[d,e]);const f=p.useMemo(()=>Bs((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),j=p.useRef(null);p.useEffect(()=>{const E=j.current;if(!E||!f)return;let A=!1;return rn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(A||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{A=!0}},[f]);const N=p.useMemo(()=>ir((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),w=p.useMemo(()=>ir((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const E=g.current;if(!E||!N)return;let A=!1;return rn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(A||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{A=!0}},[N]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":d==="fonds",onClick:()=>h("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":d==="jour",onClick:()=>h("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),d==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),d==="fonds"&&r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?lr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:sr(e,!0)}),"."]}):lr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:sr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>h("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),d==="fonds"&&s&&N?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:N}}):null,d==="fonds"&&s&&w?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:w}}):null,d==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:j,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:dr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:dr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Vs=300,ma=7,Ws={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},co={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Gs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ya(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(bi(r)&&r!=="media")return"news:"+r;const n=Pe(e);return n?"sig:"+(n.theme&&co.fr[n.theme]?n.theme:"other"):"actualites"}function Ys(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:s,fund:l}=Y(),c=so(),g=s==="en",[d,h]=p.useState("all"),[u,v]=p.useState(!1),m=p.useMemo(()=>{var he;const x=(a.filters.day||"").slice(0,10),q=ee=>!(!i&&a.continent!=="monde"&&ee.continent!==a.continent||x&&(ee.date||"").slice(0,10)!==x),H=e.filter(ee=>q(ee)&&Pe(ee)&&(!i||ee.kind!=="target"||Ae(ee)!==5)),J=i&&(((he=c==null?void 0:c.ed)==null?void 0:he.ops)||[]).length?c.ed.ops.map(ee=>wa(ee,s)).filter(ee=>!!ee).map(ee=>(ee.briefOnly=!0,ee)).filter(ee=>!x||(ee.date||"").slice(0,10)===x):[],_=e.filter(ee=>q(ee)&&ee.kind==="op"&&(x?!0:xt(ee.date)<=ma)),D=i?J.length?J:_.filter(ee=>{const ce=(l||"").trim().toLowerCase();if(!ce)return!1;const pe=ee.match||null;return pe?Object.keys(pe).map(je=>je.trim().toLowerCase()).includes(ce):!1}):_,K=x||new Date().toISOString().slice(0,10),W=ee=>{const ce=Ya(ee);return ce==="ma"?0:ce==="levees"?1:2};D.sort((ee,ce)=>{const pe=W(ee)-W(ce);if(pe)return pe;const je=(ee.date||"").slice(0,10)===K?0:1,be=(ce.date||"").slice(0,10)===K?0:1;return je!==be?je-be:(ce.amountEur||0)-(ee.amountEur||0)});const Q=new Set,te=[];for(const ee of[...D,...An(H,{key:"signal",dir:-1})]){const ce=ee.id||ee.name;!ce||Q.has(ce)||(Q.add(ce),te.push(ee))}return i&&te.length===0?e.filter(ce=>q(ce)&&xt(ce.date)<=ma).sort((ce,pe)=>(pe.date||"").localeCompare(ce.date||"")).slice(0,80):te},[e,a.continent,a.filters.day,i,l,s,c]),b=p.useMemo(()=>{const x={};for(const q of m){const H=Ya(q);x[H]=(x[H]||0)+1}return x},[m]),y=p.useMemo(()=>d==="all"?m:m.filter(x=>Ya(x)===d),[m,d]),f=p.useMemo(()=>y.slice(0,Vs),[y]),j=y.length-f.length,N=p.useRef(null);p.useEffect(()=>{var D,K;const x=N.current;if(!x)return;const q=()=>{const W=x.scrollWidth;W<200||(x.style.animationDuration=Math.max(18,Math.round(W/130))+"s")};q();const H=requestAnimationFrame(q),J=window.setTimeout(q,1200);let _=!0;return(K=(D=document.fonts)==null?void 0:D.ready)==null||K.then(()=>{_&&q()}),()=>{_=!1,cancelAnimationFrame(H),window.clearTimeout(J)}},[f.length,d]);const w=x=>x==="all"?m.length:b[x]||0,E=x=>{if(x==="all")return g?"All":"Tout";if(x.startsWith("sig:"))return co[g?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const q=x.slice(5);return xi[q]?gi(q,g?"en":"fr"):x}return Ws[g?"en":"fr"][x]},A=[{k:"all"}],C=["ma","levees"].filter(x=>w(x)>0||x===d);if(C.length){A.push({g:g?"Deals":"Opérations"});for(const x of C)A.push({k:x})}const L=["nominations","recrutements"].filter(x=>w(x)>0||x===d),T=hi.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>w(x)>0||x===d),R=w("actualites")>0||d==="actualites"?["actualites"]:[];if(L.length||T.length||R.length){A.push({g:g?"News":"Actualités"});for(const x of L)A.push({k:x});for(const x of T)A.push({k:x});for(const x of R)A.push({k:x})}const I=Gs.map(x=>"sig:"+x).filter(x=>w(x)>0||x===d);if(I.length){A.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of I)A.push({k:x})}const B=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},F=(()=>{const x=(a.filters.day||"").slice(0,10),q=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(g?`LIVE covers the events of ${B(x)}.`:`Le LIVE regroupe les événements du ${B(x)}.`)+q:(g?`LIVE covers the still-open signals and the deals of the last ${ma} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ma} derniers jours.`)+q})(),M=x=>f.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Be(q)?" spent":""),onClick:H=>{const J=q.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:J?"":q.id,name:q.name,url:q.url||"",text:q.tagline||q.headline||"",card:q.card}}))}catch{}if(J||n({type:"focus",id:q.id}),a.dens!=="liste"){const _=H.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:_.left+_.width/2,y:_.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(wt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(Ho,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Cc(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Ba,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(q.id||q.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||v(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>v(x=>!x),children:[E(d),t.jsx("b",{children:w(d)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:F}),A.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===d,onClick:()=>{h(x.k),v(!1)},children:[E(x.k),t.jsx("b",{children:w(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:N,children:[M(0),M(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(Qs,{isEn:g})]})}const Ks=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Qs({isEn:e}){const[a,r]=p.useState(()=>Xr());p.useEffect(()=>{const o=i=>{var s;return r(!!((s=i.detail)!=null&&s.open))};return window.addEventListener(Ea,o),()=>window.removeEventListener(Ea,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>vi(!a),children:Ks})}const qn="+33 6 83 10 72 86",Ta="alexandre@proplace.co",po=`tel:${qn.replace(/[^\d+]/g,"")}`;function Js(){return null}class nt extends p.Component{constructor(){super(...arguments);Bn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const uo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function cr(e,a){if((kt(e)||"").startsWith("CALL")&&Ae(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ae(e)>=2;return uo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const pr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",Xs={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function Zs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:s}=Y(),[l,c]=p.useState(""),[g,d]=p.useState(!1),[h,u]=p.useState(!1),v=p.useRef(null);if(p.useEffect(()=>{if(!h)return;const j=N=>{v.current&&!v.current.contains(N.target)&&(u(!1),d(!1))};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[h]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),b=async j=>{if(l)return;if(j==="Analysé"&&!e.memoUrl){d(!0);return}c(j);const N=(cr(e,a).find(([E])=>E===j)||[j,j])[1],w=await o(e,j,{msg:a.csMoved(e.name,N)});c(""),w&&(d(!1),u(!1))},y=cr(e,a),f=j=>(y.find(([N])=>N===j)||[])[1]||j;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:j=>j.stopPropagation(),children:y.map(([j,N])=>t.jsx("button",{type:"button",className:"rsd "+(j==="Validé"?"yes":"no")+(l===j?" busy":""),disabled:!!l,onClick:()=>{b(j)},children:N},j))}):t.jsxs("span",{className:"rstat"+(h||g?" rs-open":""),ref:v,onClick:j=>j.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":h,disabled:!!l,title:a.csLabel,className:"rsel rs-"+pr(m),onClick:()=>{u(j=>!j),d(!1)},children:l?f(l)+"…":m?f(m):a.csNone}),h&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([j,N])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===j,className:"rsopt"+(m===j?" on":"")+(l===j?" busy":""),disabled:!!l,onClick:()=>{if(j===m){u(!1);return}b(j)},children:[t.jsx("i",{className:"pt2",style:{background:Xs[pr(j)]}}),N]},j))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{i(e),d(!1),u(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const j=await o(e,"Analysé");c(""),j&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function el({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Y(),[i,s]=p.useState(""),[l,c]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(kt(e)||"").startsWith("CALL")&&Ae(e)===3,h=Ae(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(m);const b=await o(e,m);s(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},v=d?[["Validé",a.csYes],["Écarté",a.csNo]]:uo.filter(([m])=>!(h&&m==="Retenu")).map(([m,b])=>[m,a[b]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([m,b])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:b},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(tl,{o:e})]})}function tl({o:e}){const{t:a,saveNote:r,flash:n}=Y(),[o,i]=p.useState(e.ceoNote||""),[s,l]=p.useState(!1),[c,g]=p.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),h=async()=>{if(s||!d)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:s,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&h()}}),t.jsx("button",{type:"button",disabled:s||!d,onClick:()=>{h()},children:c?a.csNoteSaved:a.csNoteOk})]})}function al({placeholder:e,onDone:a}){const{t:r}=Y(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function nl({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:s,flashErr:l}=Y(),[c,g]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Ae(e)!==4)return null;const d=i(e),h=(d==null?void 0:d.stage)||"todo",u=async f=>{if(c||f===h)return;g(!0);const j=d;s(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const N=Math.max(Date.now(),ur+=1);ur=N;const w=await yi(r,{company:e.name||"",stage:f,cts:N,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(s(e,j),l(a.actErr)))},v=(y=d==null?void 0:d.stamps)==null?void 0:y.sent,m=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,b=h==="sent"&&v&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,j])=>t.jsx("button",{type:"button",className:"stgb"+(h===f?" on":""),disabled:c,onClick:()=>{u(f)},children:j},f)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let ur=0;const Kt=8,yt=360;function mr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function fr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(mr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(mr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function rl({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Y(),[s,l]=p.useState(0),[c,g]=p.useState(null),[d,h]=p.useState([]),u=p.useRef(!1),v=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=p.useRef(!1);p.useEffect(()=>{const C=v.current;return()=>{m.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,h(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const b=d[s],y=s>=d.length;p.useEffect(()=>{if(b&&(b.ptab!==void 0&&i.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&i.dens!==b.dens&&n({type:"dens",dens:b.dens}),i.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const C=b.click,L=window.setTimeout(()=>{const T=document.querySelector(C);T&&T.getAttribute("aria-selected")!=="true"&&T.click()},60);return()=>window.clearTimeout(L)}},[s,b]);const f=p.useRef(-1),j=p.useCallback(()=>{if(!b){g(null);return}const C=R=>{if(!R)return null;for(const I of document.querySelectorAll(R)){const B=I.getBoundingClientRect();if(B.width>1&&B.height>1)return I}return null},L=C(b.sel)||C(b.need);if(!L){g(null);return}f.current!==s&&(f.current=s,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const T=L.getBoundingClientRect();g(R=>R&&Math.abs(R.top-T.top)<1&&Math.abs(R.left-T.left)<1&&Math.abs(R.width-T.width)<1&&Math.abs(R.height-T.height)<1?R:T)},[b,s]);p.useLayoutEffect(()=>{j();const C=[90,300,700,1300].map(R=>window.setTimeout(j,R)),L=window.setInterval(j,400),T=()=>j();return window.addEventListener("scroll",T,!0),window.addEventListener("resize",T),()=>{C.forEach(R=>window.clearTimeout(R)),window.clearInterval(L),window.removeEventListener("scroll",T,!0),window.removeEventListener("resize",T)}},[j]);const N=p.useRef(a);if(N.current=a,p.useEffect(()=>{const C=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),N.current()):L.key==="ArrowRight"?l(T=>T+1):L.key==="ArrowLeft"&&l(T=>Math.max(0,T-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!d.length)return null;let w=null;const E=C=>()=>{m.current=!0,n({type:"modal",modal:null}),C()};if(y){const C=o[3]||0;C>0?w={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:E(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?w={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:E(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?w={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:E(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:E(()=>{n({type:"modal",modal:"crit"}),a()})}}let A={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:yt};if(!y&&c){const C=c.bottom+14,L=window.innerHeight-C;let T=L>190?C:Math.max(12,c.top-200),R=Math.min(Math.max(12,c.left+c.width/2-yt/2),window.innerWidth-yt-12);L<=190&&c.top<212&&(window.innerWidth-c.right>=yt+40?R=Math.min(c.right+26,window.innerWidth-yt-12):c.left>=yt+40&&(R=Math.max(12,c.left-yt-26)),T=Math.max(12,c.top-Kt)),A={left:R,top:T,width:yt}}return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Kt,top:c.top-Kt,width:c.width+Kt*2,height:c.height+Kt*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:A,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(fr,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(fr,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>l(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(C=>C+1),children:s===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function mo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function fo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ol(){var L,T;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:s,data:l,dispatch:c}=Y(),g=r?a:e,d=p.useMemo(()=>g.filter(R=>xt(R.date)===0&&R.kind==="target"),[g]),h=p.useMemo(()=>r?a.filter(R=>R.kind==="target"&&Ae(R)===0).slice().sort((R,I)=>(I.date||"").localeCompare(R.date||"")):[],[a,r]),u=p.useMemo(()=>d.filter(R=>r?Ae(R)===0:!Be(R)),[d,r]),v=r?h:u,m=r?a.length-h.length:d.length-u.length,b=r?a.length:d.length,y=b?Math.min(100,m/b*100):100,f=p.useMemo(()=>mo(g),[g]),j=!!f&&xt(f)>0,N=p.useMemo(()=>j?g.filter(R=>(R.date||"").slice(0,10)===f):[],[g,f,j]),w=typeof((L=l.stats)==null?void 0:L.kept_today)=="number"?l.stats.kept_today:null,E=typeof((T=l.stats)==null?void 0:T.screened_today)=="number"?l.stats.screened_today:d.length;let A;j?A=o.morningLast(N.length,h.length,fo(f,s)):r?A=o.morningThesis(E,h.length,w):d.length?m===0?A=o.goalSourced(d.length):m>=d.length?A=o.goalCleared:A=o.goalDone(m,d.length):A=o.goalSourced(0);const C=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&h.length&&c({type:"chainStart",queue:h.map(R=>R.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:A}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),v.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(v.length):i.pileMode?o.goalContinue(v.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function il(){var H,J;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:s,dossiers:l,mode:c,doSync:g,startTour:d,flash:h,flashErr:u}=Y(),[v,m]=p.useState(null),[b,y]=p.useState(!0),[f,j]=p.useState([]),N=c==="client";p.useEffect(()=>{if(!o||!i)return;let _=!0;return y(!0),(async()=>{const[D,K]=await Promise.all([Cn(i),Zr(o)]);_&&(D&&m(D),y(!1),j(K))})(),()=>{_=!1}},[o,i]);const[w,E]=p.useState(!1),A=()=>{!N||w||!i||(E(!0),wi(i).then(_=>{E(!1),_?h(e.identRepubDone):u(e.actErr)}))},C=(v==null?void 0:v.per_day)??null,L=((H=v==null?void 0:v.pool_order)==null?void 0:H.length)??0,T=f.filter(_=>_.status==="running").length,R=p.useMemo(()=>l.filter(_=>_.kind==="target"&&Be(_)).length,[l]),I=s.marketEstimate,B=typeof((J=s.stats)==null?void 0:J.screened)=="number"?s.stats.screened:R,F=I&&I>0?Math.min(100,Math.round(B/I*100)):null,M=_=>_.toLocaleString(a==="en"?"en-US":"fr-FR"),x=(i||"P").split(/\s+/).map(_=>_[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const _=Date.parse(s.generatedAt||"");if(Number.isNaN(_))return"";const D=new Date(_),K=W=>String(W).padStart(2,"0");return`${K(D.getDate())}/${K(D.getMonth()+1)} à ${K(D.getHours())}:${K(D.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?x:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),q?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[F===null&&B>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:M(B)})})]}),F!==null&&I&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:F+"%"}})}),t.jsxs("b",{children:[F," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(B,I)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),C===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),T>0&&t.jsxs("span",{className:"ev",children:["⏳ ",T]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:_=>{_.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!N||w,onClick:A,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!N,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:_=>n({type:"filters",patch:{search:_.target.value}})})]})]})]})}class Tt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],s=a+i,l=Math.abs(a)<Math.abs(i)?a-(s-i):i-(s-a);l&&(r[n++]=l),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,o=a[--r],s=n+o,i=o-(s-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=s+o,o==n-s&&(s=n))}return s}}function*sl(e){for(const a of e)yield*a}function ho(e){return Array.from(sl(e))}var ke=1e-6,de=Math.PI,Xe=de/2,hr=de/4,et=de*2,ft=180/de,Ge=de/180,ze=Math.abs,ll=Math.atan,ra=Math.atan2,Le=Math.cos,Fe=Math.sin,dl=Math.sign||function(e){return e>0?1:e<0?-1:0},Lt=Math.sqrt;function cl(e){return e>1?0:e<-1?de:Math.acos(e)}function oa(e){return e>1?Xe:e<-1?-Xe:Math.asin(e)}function Ze(){}function qa(e,a){e&&gr.hasOwnProperty(e.type)&&gr[e.type](e,a)}var xr={Feature:function(e,a){qa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)qa(r[n].geometry,a)}},gr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){pn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)pn(r[n],a,0)},Polygon:function(e,a){br(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)br(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)qa(r[n],a)}};function pn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function br(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)pn(e[r],a,1);a.polygonEnd()}function Ot(e,a){e&&xr.hasOwnProperty(e.type)?xr[e.type](e,a):qa(e,a)}function un(e){return[ra(e[1],e[0]),oa(e[2])]}function Bt(e){var a=e[0],r=e[1],n=Le(r);return[n*Le(a),n*Fe(a),Fe(r)]}function fa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function La(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ka(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ha(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function mn(e){var a=Lt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function fn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function hn(e,a){return ze(e)>de&&(e-=Math.round(e/et)*et),[e,a]}hn.invert=hn;function pl(e,a,r){return(e%=et)?a||r?fn(yr(e),wr(a,r)):yr(e):a||r?wr(a,r):hn}function vr(e){return function(a,r){return a+=e,ze(a)>de&&(a-=Math.round(a/et)*et),[a,r]}}function yr(e){var a=vr(e);return a.invert=vr(-e),a}function wr(e,a){var r=Le(e),n=Fe(e),o=Le(a),i=Fe(a);function s(l,c){var g=Le(c),d=Le(l)*g,h=Fe(l)*g,u=Fe(c),v=u*r+d*n;return[ra(h*o-v*i,d*r-u*n),oa(v*o+h*i)]}return s.invert=function(l,c){var g=Le(c),d=Le(l)*g,h=Fe(l)*g,u=Fe(c),v=u*o-h*i;return[ra(h*o+u*i,d*r+v*n),oa(v*r-d*n)]},s}function ul(e,a,r,n,o,i){if(r){var s=Le(a),l=Fe(a),c=n*r;o==null?(o=a+n*et,i=a-c/2):(o=kr(s,o),i=kr(s,i),(n>0?o<i:o>i)&&(o+=n*et));for(var g,d=o;n>0?d>i:d<i;d-=c)g=un([s,-l*Le(d),-l*Fe(d)]),e.point(g[0],g[1])}}function kr(e,a){a=Bt(a),a[0]-=e,mn(a);var r=cl(-a[1]);return((-a[2]<0?-r:r)+et-ke)%et}function xo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Ze,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ja(e,a){return ze(e[0]-a[0])<ke&&ze(e[1]-a[1])<ke}function xa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function go(e,a,r,n,o){var i=[],s=[],l,c;if(e.forEach(function(m){if(!((b=m.length-1)<=0)){var b,y=m[0],f=m[b],j;if(ja(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),l=0;l<b;++l)o.point((y=m[l])[0],y[1]);o.lineEnd();return}f[0]+=2*ke}i.push(j=new xa(y,m,null,!0)),s.push(j.o=new xa(y,null,j,!1)),i.push(j=new xa(f,m,null,!1)),s.push(j.o=new xa(f,null,j,!0))}}),!!i.length){for(s.sort(a),jr(i),jr(s),l=0,c=s.length;l<c;++l)s[l].e=r=!r;for(var g=i[0],d,h;;){for(var u=g,v=!0;u.v;)if((u=u.n)===g)return;d=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(v)for(l=0,c=d.length;l<c;++l)o.point((h=d[l])[0],h[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(v)for(d=u.p.z,l=d.length-1;l>=0;--l)o.point((h=d[l])[0],h[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,d=u.z,v=!v}while(!u.v);o.lineEnd()}}}function jr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Qa(e){return ze(e[0])<=de?e[0]:dl(e[0])*((ze(e[0])+de)%et-de)}function ml(e,a){var r=Qa(a),n=a[1],o=Fe(n),i=[Fe(r),-Le(r),0],s=0,l=0,c=new Tt;o===1?n=Xe+ke:o===-1&&(n=-Xe-ke);for(var g=0,d=e.length;g<d;++g)if(u=(h=e[g]).length)for(var h,u,v=h[u-1],m=Qa(v),b=v[1]/2+hr,y=Fe(b),f=Le(b),j=0;j<u;++j,m=w,y=A,f=C,v=N){var N=h[j],w=Qa(N),E=N[1]/2+hr,A=Fe(E),C=Le(E),L=w-m,T=L>=0?1:-1,R=T*L,I=R>de,B=y*A;if(c.add(ra(B*T*Fe(R),f*C+B*Le(R))),s+=I?L+T*et:L,I^m>=r^w>=r){var F=La(Bt(v),Bt(N));mn(F);var M=La(i,F);mn(M);var x=(I^L>=0?-1:1)*oa(M[2]);(n>x||n===x&&(F[0]||F[1]))&&(l+=I^L>=0?1:-1)}}return(s<-ke||s<ke&&c<-1e-12)^l&1}function bo(e,a,r,n){return function(o){var i=a(o),s=xo(),l=a(s),c=!1,g,d,h,u={point:v,lineStart:b,lineEnd:y,polygonStart:function(){u.point=f,u.lineStart=j,u.lineEnd=N,d=[],g=[]},polygonEnd:function(){u.point=v,u.lineStart=b,u.lineEnd=y,d=ho(d);var w=ml(g,n);d.length?(c||(o.polygonStart(),c=!0),go(d,hl,w,r,o)):w&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),d=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function v(w,E){e(w,E)&&o.point(w,E)}function m(w,E){i.point(w,E)}function b(){u.point=m,i.lineStart()}function y(){u.point=v,i.lineEnd()}function f(w,E){h.push([w,E]),l.point(w,E)}function j(){l.lineStart(),h=[]}function N(){f(h[0][0],h[0][1]),l.lineEnd();var w=l.clean(),E=s.result(),A,C=E.length,L,T,R;if(h.pop(),g.push(h),h=null,!!C){if(w&1){if(T=E[0],(L=T.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),A=0;A<L;++A)o.point((R=T[A])[0],R[1]);o.lineEnd()}return}C>1&&w&2&&E.push(E.pop().concat(E.shift())),d.push(E.filter(fl))}}return u}}function fl(e){return e.length>1}function hl(e,a){return((e=e.x)[0]<0?e[1]-Xe-ke:Xe-e[1])-((a=a.x)[0]<0?a[1]-Xe-ke:Xe-a[1])}const Nr=bo(function(){return!0},xl,bl,[-de,-Xe]);function xl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,s){var l=i>0?de:-de,c=ze(i-a);ze(c-de)<ke?(e.point(a,r=(r+s)/2>0?Xe:-Xe),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&c>=de&&(ze(a-n)<ke&&(a-=n*ke),ze(i-l)<ke&&(i-=l*ke),r=gl(a,r,i,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=s),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function gl(e,a,r,n){var o,i,s=Fe(e-r);return ze(s)>ke?ll((Fe(a)*(i=Le(n))*Fe(r)-Fe(n)*(o=Le(a))*Fe(e))/(o*i*s)):(a+n)/2}function bl(e,a,r,n){var o;if(e==null)o=r*Xe,n.point(-de,o),n.point(0,o),n.point(de,o),n.point(de,0),n.point(de,-o),n.point(0,-o),n.point(-de,-o),n.point(-de,0),n.point(-de,o);else if(ze(e[0]-a[0])>ke){var i=e[0]<a[0]?de:-de;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function vl(e){var a=Le(e),r=2*Ge,n=a>0,o=ze(a)>ke;function i(d,h,u,v){ul(v,e,r,u,d,h)}function s(d,h){return Le(d)*Le(h)>a}function l(d){var h,u,v,m,b;return{lineStart:function(){m=v=!1,b=1},point:function(y,f){var j=[y,f],N,w=s(y,f),E=n?w?0:g(y,f):w?g(y+(y<0?de:-de),f):0;if(!h&&(m=v=w)&&d.lineStart(),w!==v&&(N=c(h,j),(!N||ja(h,N)||ja(j,N))&&(j[2]=1)),w!==v)b=0,w?(d.lineStart(),N=c(j,h),d.point(N[0],N[1])):(N=c(h,j),d.point(N[0],N[1],2),d.lineEnd()),h=N;else if(o&&h&&n^w){var A;!(E&u)&&(A=c(j,h,!0))&&(b=0,n?(d.lineStart(),d.point(A[0][0],A[0][1]),d.point(A[1][0],A[1][1]),d.lineEnd()):(d.point(A[1][0],A[1][1]),d.lineEnd(),d.lineStart(),d.point(A[0][0],A[0][1],3)))}w&&(!h||!ja(h,j))&&d.point(j[0],j[1]),h=j,v=w,u=E},lineEnd:function(){v&&d.lineEnd(),h=null},clean:function(){return b|(m&&v)<<1}}}function c(d,h,u){var v=Bt(d),m=Bt(h),b=[1,0,0],y=La(v,m),f=fa(y,y),j=y[0],N=f-j*j;if(!N)return!u&&d;var w=a*f/N,E=-a*j/N,A=La(b,y),C=ha(b,w),L=ha(y,E);Ka(C,L);var T=A,R=fa(C,T),I=fa(T,T),B=R*R-I*(fa(C,C)-1);if(!(B<0)){var F=Lt(B),M=ha(T,(-R-F)/I);if(Ka(M,C),M=un(M),!u)return M;var x=d[0],q=h[0],H=d[1],J=h[1],_;q<x&&(_=x,x=q,q=_);var D=q-x,K=ze(D-de)<ke,W=K||D<ke;if(!K&&J<H&&(_=H,H=J,J=_),W?K?H+J>0^M[1]<(ze(M[0]-x)<ke?H:J):H<=M[1]&&M[1]<=J:D>de^(x<=M[0]&&M[0]<=q)){var Q=ha(T,(-R+F)/I);return Ka(Q,C),[M,un(Q)]}}}function g(d,h){var u=n?e:de-e,v=0;return d<-u?v|=1:d>u&&(v|=2),h<-u?v|=4:h>u&&(v|=8),v}return bo(s,l,i,n?[0,-e]:[-de,e-de])}function yl(e,a,r,n,o,i){var s=e[0],l=e[1],c=a[0],g=a[1],d=0,h=1,u=c-s,v=g-l,m;if(m=r-s,!(!u&&m>0)){if(m/=u,u<0){if(m<d)return;m<h&&(h=m)}else if(u>0){if(m>h)return;m>d&&(d=m)}if(m=o-s,!(!u&&m<0)){if(m/=u,u<0){if(m>h)return;m>d&&(d=m)}else if(u>0){if(m<d)return;m<h&&(h=m)}if(m=n-l,!(!v&&m>0)){if(m/=v,v<0){if(m<d)return;m<h&&(h=m)}else if(v>0){if(m>h)return;m>d&&(d=m)}if(m=i-l,!(!v&&m<0)){if(m/=v,v<0){if(m>h)return;m>d&&(d=m)}else if(v>0){if(m<d)return;m<h&&(h=m)}return d>0&&(e[0]=s+d*u,e[1]=l+d*v),h<1&&(a[0]=s+h*u,a[1]=l+h*v),!0}}}}}var Qt=1e9,ga=-Qt;function wl(e,a,r,n){function o(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function i(g,d,h,u){var v=0,m=0;if(g==null||(v=s(g,h))!==(m=s(d,h))||c(g,d)<0^h>0)do u.point(v===0||v===3?e:r,v>1?n:a);while((v=(v+h+4)%4)!==m);else u.point(d[0],d[1])}function s(g,d){return ze(g[0]-e)<ke?d>0?0:3:ze(g[0]-r)<ke?d>0?2:1:ze(g[1]-a)<ke?d>0?1:0:d>0?3:2}function l(g,d){return c(g.x,d.x)}function c(g,d){var h=s(g,1),u=s(d,1);return h!==u?h-u:h===0?d[1]-g[1]:h===1?g[0]-d[0]:h===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,h=xo(),u,v,m,b,y,f,j,N,w,E,A,C={point:L,lineStart:B,lineEnd:F,polygonStart:R,polygonEnd:I};function L(x,q){o(x,q)&&d.point(x,q)}function T(){for(var x=0,q=0,H=v.length;q<H;++q)for(var J=v[q],_=1,D=J.length,K=J[0],W,Q,te=K[0],he=K[1];_<D;++_)W=te,Q=he,K=J[_],te=K[0],he=K[1],Q<=n?he>n&&(te-W)*(n-Q)>(he-Q)*(e-W)&&++x:he<=n&&(te-W)*(n-Q)<(he-Q)*(e-W)&&--x;return x}function R(){d=h,u=[],v=[],A=!0}function I(){var x=T(),q=A&&x,H=(u=ho(u)).length;(q||H)&&(g.polygonStart(),q&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),H&&go(u,l,x,i,g),g.polygonEnd()),d=g,u=v=m=null}function B(){C.point=M,v&&v.push(m=[]),E=!0,w=!1,j=N=NaN}function F(){u&&(M(b,y),f&&w&&h.rejoin(),u.push(h.result())),C.point=L,w&&d.lineEnd()}function M(x,q){var H=o(x,q);if(v&&m.push([x,q]),E)b=x,y=q,f=H,E=!1,H&&(d.lineStart(),d.point(x,q));else if(H&&w)d.point(x,q);else{var J=[j=Math.max(ga,Math.min(Qt,j)),N=Math.max(ga,Math.min(Qt,N))],_=[x=Math.max(ga,Math.min(Qt,x)),q=Math.max(ga,Math.min(Qt,q))];yl(J,_,e,a,r,n)?(w||(d.lineStart(),d.point(J[0],J[1])),d.point(_[0],_[1]),H||d.lineEnd(),A=!1):H&&(d.lineStart(),d.point(x,q),A=!1)}j=x,N=q,w=H}return C}}const xn=e=>e;var Ja=new Tt,gn=new Tt,vo,yo,bn,vn,ht={point:Ze,lineStart:Ze,lineEnd:Ze,polygonStart:function(){ht.lineStart=kl,ht.lineEnd=Nl},polygonEnd:function(){ht.lineStart=ht.lineEnd=ht.point=Ze,Ja.add(ze(gn)),gn=new Tt},result:function(){var e=Ja/2;return Ja=new Tt,e}};function kl(){ht.point=jl}function jl(e,a){ht.point=wo,vo=bn=e,yo=vn=a}function wo(e,a){gn.add(vn*e-bn*a),bn=e,vn=a}function Nl(){wo(vo,yo)}var _t=1/0,Fa=_t,ia=-_t,Ra=ia,Ma={point:El,lineStart:Ze,lineEnd:Ze,polygonStart:Ze,polygonEnd:Ze,result:function(){var e=[[_t,Fa],[ia,Ra]];return ia=Ra=-(Fa=_t=1/0),e}};function El(e,a){e<_t&&(_t=e),e>ia&&(ia=e),a<Fa&&(Fa=a),a>Ra&&(Ra=a)}var yn=0,wn=0,Jt=0,Oa=0,Da=0,Dt=0,kn=0,jn=0,Xt=0,ko,jo,ct,pt,Je={point:qt,lineStart:Er,lineEnd:Sr,polygonStart:function(){Je.lineStart=zl,Je.lineEnd=Al},polygonEnd:function(){Je.point=qt,Je.lineStart=Er,Je.lineEnd=Sr},result:function(){var e=Xt?[kn/Xt,jn/Xt]:Dt?[Oa/Dt,Da/Dt]:Jt?[yn/Jt,wn/Jt]:[NaN,NaN];return yn=wn=Jt=Oa=Da=Dt=kn=jn=Xt=0,e}};function qt(e,a){yn+=e,wn+=a,++Jt}function Er(){Je.point=Sl}function Sl(e,a){Je.point=Cl,qt(ct=e,pt=a)}function Cl(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Oa+=o*(ct+e)/2,Da+=o*(pt+a)/2,Dt+=o,qt(ct=e,pt=a)}function Sr(){Je.point=qt}function zl(){Je.point=Tl}function Al(){No(ko,jo)}function Tl(e,a){Je.point=No,qt(ko=ct=e,jo=pt=a)}function No(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Oa+=o*(ct+e)/2,Da+=o*(pt+a)/2,Dt+=o,o=pt*e-ct*a,kn+=o*(ct+e),jn+=o*(pt+a),Xt+=o*3,qt(ct=e,pt=a)}function Eo(e){this._context=e}Eo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,et);break}}},result:Ze};var Nn=new Tt,Xa,So,Co,Zt,ea,sa={point:Ze,lineStart:function(){sa.point=ql},lineEnd:function(){Xa&&zo(So,Co),sa.point=Ze},polygonStart:function(){Xa=!0},polygonEnd:function(){Xa=null},result:function(){var e=+Nn;return Nn=new Tt,e}};function ql(e,a){sa.point=zo,So=Zt=e,Co=ea=a}function zo(e,a){Zt-=e,ea-=a,Nn.add(Lt(Zt*Zt+ea*ea)),Zt=e,ea=a}let Cr,Ia,zr,Ar;class Tr{constructor(a){this._append=a==null?Ao:Ll(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==zr||this._append!==Ia){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,zr=n,Ia=this._append,Ar=this._,this._=o}this._+=Ar;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Ao(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Ll(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Ao;if(a!==Cr){const r=10**a;Cr=a,Ia=function(o){let i=1;this._+=o[0];for(const s=o.length;i<s;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ia}function Fl(e,a){let r=3,n=4.5,o,i;function s(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Ot(l,o(i))),i.result()}return s.area=function(l){return Ot(l,o(ht)),ht.result()},s.measure=function(l){return Ot(l,o(sa)),sa.result()},s.bounds=function(l){return Ot(l,o(Ma)),Ma.result()},s.centroid=function(l){return Ot(l,o(Je)),Je.result()},s.projection=function(l){return arguments.length?(o=l==null?(e=null,xn):(e=l).stream,s):e},s.context=function(l){return arguments.length?(i=l==null?(a=null,new Tr(r)):new Eo(a=l),typeof n!="function"&&i.pointRadius(n),s):a},s.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),s):n},s.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const c=Math.floor(l);if(!(c>=0))throw new RangeError(`invalid digits: ${l}`);r=c}return a===null&&(i=new Tr(r)),s},s.projection(e).digits(r).context(a)}function Ln(e){return function(a){var r=new En;for(var n in e)r[n]=e[n];return r.stream=a,r}}function En(){}En.prototype={constructor:En,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Fn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ot(r,e.stream(Ma)),a(Ma.result()),n!=null&&e.clipExtent(n),e}function To(e,a,r){return Fn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],s=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-s*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([l,c])},r)}function Rl(e,a,r){return To(e,[[0,0],a],r)}function Ml(e,a,r){return Fn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),s=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([s,l])},r)}function Ol(e,a,r){return Fn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),s=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([s,l])},r)}var qr=16,Dl=Le(30*Ge);function Lr(e,a){return+a?Pl(e,a):Il(e)}function Il(e){return Ln({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Pl(e,a){function r(n,o,i,s,l,c,g,d,h,u,v,m,b,y){var f=g-n,j=d-o,N=f*f+j*j;if(N>4*a&&b--){var w=s+u,E=l+v,A=c+m,C=Lt(w*w+E*E+A*A),L=oa(A/=C),T=ze(ze(A)-1)<ke||ze(i-h)<ke?(i+h)/2:ra(E,w),R=e(T,L),I=R[0],B=R[1],F=I-n,M=B-o,x=j*F-f*M;(x*x/N>a||ze((f*F+j*M)/N-.5)>.3||s*u+l*v+c*m<Dl)&&(r(n,o,i,s,l,c,I,B,T,w/=C,E/=C,A,b,y),y.point(I,B),r(I,B,T,w,E,A,g,d,h,u,v,m,b,y))}}return function(n){var o,i,s,l,c,g,d,h,u,v,m,b,y={point:f,lineStart:j,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=E},polygonEnd:function(){n.polygonEnd(),y.lineStart=j}};function f(L,T){L=e(L,T),n.point(L[0],L[1])}function j(){h=NaN,y.point=N,n.lineStart()}function N(L,T){var R=Bt([L,T]),I=e(L,T);r(h,u,d,v,m,b,h=I[0],u=I[1],d=L,v=R[0],m=R[1],b=R[2],qr,n),n.point(h,u)}function w(){y.point=f,n.lineEnd()}function E(){j(),y.point=A,y.lineEnd=C}function A(L,T){N(o=L,T),i=h,s=u,l=v,c=m,g=b,y.point=N}function C(){r(h,u,d,v,m,b,i,s,o,l,c,g,qr,n),y.lineEnd=w,w()}return y}}var Bl=Ln({point:function(e,a){this.stream.point(e*Ge,a*Ge)}});function _l(e){return Ln({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function $l(e,a,r,n,o){function i(s,l){return s*=n,l*=o,[a+e*s,r-e*l]}return i.invert=function(s,l){return[(s-a)/e*n,(r-l)/e*o]},i}function Fr(e,a,r,n,o,i){if(!i)return $l(e,a,r,n,o);var s=Le(i),l=Fe(i),c=s*e,g=l*e,d=s/e,h=l/e,u=(l*r-s*a)/e,v=(l*a+s*r)/e;function m(b,y){return b*=n,y*=o,[c*b-g*y+a,r-g*b-c*y]}return m.invert=function(b,y){return[n*(d*b-h*y+u),o*(v-h*b-d*y)]},m}function Ul(e){return Hl(function(){return e})()}function Hl(e){var a,r=150,n=480,o=250,i=0,s=0,l=0,c=0,g=0,d,h=0,u=1,v=1,m=null,b=Nr,y=null,f,j,N,w=xn,E=.5,A,C,L,T,R;function I(x){return L(x[0]*Ge,x[1]*Ge)}function B(x){return x=L.invert(x[0],x[1]),x&&[x[0]*ft,x[1]*ft]}I.stream=function(x){return T&&R===x?T:T=Bl(_l(d)(b(A(w(R=x)))))},I.preclip=function(x){return arguments.length?(b=x,m=void 0,M()):b},I.postclip=function(x){return arguments.length?(w=x,y=f=j=N=null,M()):w},I.clipAngle=function(x){return arguments.length?(b=+x?vl(m=x*Ge):(m=null,Nr),M()):m*ft},I.clipExtent=function(x){return arguments.length?(w=x==null?(y=f=j=N=null,xn):wl(y=+x[0][0],f=+x[0][1],j=+x[1][0],N=+x[1][1]),M()):y==null?null:[[y,f],[j,N]]},I.scale=function(x){return arguments.length?(r=+x,F()):r},I.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],F()):[n,o]},I.center=function(x){return arguments.length?(i=x[0]%360*Ge,s=x[1]%360*Ge,F()):[i*ft,s*ft]},I.rotate=function(x){return arguments.length?(l=x[0]%360*Ge,c=x[1]%360*Ge,g=x.length>2?x[2]%360*Ge:0,F()):[l*ft,c*ft,g*ft]},I.angle=function(x){return arguments.length?(h=x%360*Ge,F()):h*ft},I.reflectX=function(x){return arguments.length?(u=x?-1:1,F()):u<0},I.reflectY=function(x){return arguments.length?(v=x?-1:1,F()):v<0},I.precision=function(x){return arguments.length?(A=Lr(C,E=x*x),M()):Lt(E)},I.fitExtent=function(x,q){return To(I,x,q)},I.fitSize=function(x,q){return Rl(I,x,q)},I.fitWidth=function(x,q){return Ml(I,x,q)},I.fitHeight=function(x,q){return Ol(I,x,q)};function F(){var x=Fr(r,0,0,u,v,h).apply(null,a(i,s)),q=Fr(r,n-x[0],o-x[1],u,v,h);return d=pl(l,c,g),C=fn(a,q),L=fn(d,C),A=Lr(C,E),M()}function M(){return T=R=null,I}return function(){return a=e.apply(this,arguments),I.invert=a.invert&&B,F()}}function qo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}qo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,s=i*i;r-=o=(r*(1.007226+i*(.015085+s*(-.044475+.028874*i-.005916*s)))-a)/(1.007226+i*(.015085*3+s*(-.044475*7+.028874*9*i-.005916*11*s)))}while(ze(o)>ke&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Vl(){return Ul(qo).scale(175.295)}function Wl(e){return e}function Gl(e){if(e==null)return Wl;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],s=e.translate[1];return function(l,c){c||(a=r=0);var g=2,d=l.length,h=new Array(d);for(h[0]=(a+=l[0])*n+i,h[1]=(r+=l[1])*o+s;g<d;)h[g]=l[g],++g;return h}}function Yl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Kl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Rr(e,r)})}:Rr(e,a)}function Rr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Ql(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Ql(e,a){var r=Gl(e.transform),n=e.arcs;function o(d,h){h.length&&h.pop();for(var u=n[d<0?~d:d],v=0,m=u.length;v<m;++v)h.push(r(u[v],v));d<0&&Yl(h,m)}function i(d){return r(d)}function s(d){for(var h=[],u=0,v=d.length;u<v;++u)o(d[u],h);return h.length<2&&h.push(h[0]),h}function l(d){for(var h=s(d);h.length<4;)h.push(h[0]);return h}function c(d){return d.map(l)}function g(d){var h=d.type,u;switch(h){case"GeometryCollection":return{type:h,geometries:d.geometries.map(g)};case"Point":u=i(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(i);break;case"LineString":u=s(d.arcs);break;case"MultiLineString":u=d.arcs.map(s);break;case"Polygon":u=c(d.arcs);break;case"MultiPolygon":u=d.arcs.map(c);break;default:return null}return{type:h,coordinates:u}}return g(a)}const Lo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Jl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Xl(e,a,r){const n=Lo[e];if(!n||!n.length)return-1;const o=Jl(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(s=>o.includes(s)))return i}return Math.floor(r*n.length)%n.length}let ba=null;function Zl(){return ba||(ba=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Kl(r,n),i=Vl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=Fl(i),l=(o.features||[]).filter(d=>{var h;return(((h=d.properties)==null?void 0:h.name)||"")!=="Antarctica"}).map(d=>{var v;const h=((v=d.properties)==null?void 0:v.name)||"",u=s(d)||"";return u?{i2:ki(h)||null,n:h,d:u}:null}).filter(d=>!!d);if(!l.length)return null;const c={};for(const[d,h]of Object.entries(ji)){const u=i(h);u&&(c[d]={x:u[0],y:u[1]})}const g={};for(const[d,h]of Object.entries(Lo)){const u=h.map(v=>i(v.ll)).filter(v=>!!v).map(([v,m])=>({x:v,y:m}));u.length&&(g[d]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:c,metros:g}}catch{return null}})(),ba)}function ed(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return Zl().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const td="8 40 984 210",ad={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Mr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Or(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function nd(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const s=()=>{var g;if(!o)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(s)};s();const l=new ResizeObserver(()=>s());return e.current&&l.observe(e.current),window.addEventListener("resize",s),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function Dr({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],s)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function rd(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:s,lang:l,t:c,data:g,dossiers:d,source:h}=Y(),u=g.loading&&!d.length,v=p.useRef(null),m=p.useRef(null),b=ed(e.continent==="monde"),y=e.continent==="monde"?b:zn.find(x=>x.key===e.continent)||null,f=nd(v,e.continent+":"+e.mapFolded+":"+!!y),[j,N]=p.useState(new Map),[w,E]=p.useState(null);p.useEffect(()=>{const x=v.current;if(!x)return;const q=new Map;x.querySelectorAll("path[data-i2]").forEach(H=>{const J=H.dataset.i2;if(J)try{const _=H.getBBox();_.width>0&&q.set(J,{x:_.x,y:_.y,w:_.width,h:_.height})}catch{}}),N(q)},[e.continent,f,y]);const A=p.useMemo(()=>r.filter(x=>x.cc),[r]),C=p.useMemo(()=>{const x=new Map;return A.forEach(q=>x.set(q.cc,(x.get(q.cc)||0)+1)),x},[A]),L=e.continent==="monde"&&b?b.anchors:null,T=e.continent==="monde"&&b?b.metros:null,R=p.useMemo(()=>A.map(x=>{const q=Or(x.name||x.id||""),H=Or((x.id||x.name||"")+"·y");if(L&&x.cc){const W=T?T[x.cc]:void 0;if(W&&W.length){const te=Xl(x.cc,x.city,q);if(te>=0&&W[te])return{d:x,x:W[te].x+(q-.5)*5,y:W[te].y+(H-.5)*5}}const Q=L[x.cc];if(Q)return{d:x,x:Q.x+(q-.5)*10,y:Q.y+(H-.5)*10}}const J=x.cc?j.get(x.cc):void 0;if(!J)return null;const _=ad[`${e.continent}:${x.cc||""}`];if(_)return{d:x,x:J.x+J.w*(_.fx+(q-.5)*_.sx),y:J.y+J.h*(_.fy+(H-.5)*_.sy)};const D=(q-.5)*Math.min(J.w*.55,60),K=(H-.5)*Math.min(J.h*.55,60);return{d:x,x:J.x+J.w/2+D,y:J.y+J.h/2+K}}).filter(x=>!!x),[A,j,L,T,e.continent]),I=x=>f>0?x/f:x,B=p.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:Mr[x],fr:c.plabels[x].toUpperCase(),en:c.plabels[x].toUpperCase(),n:r.filter(q=>q.kind==="target"&&Ae(q)===x).length})).filter(x=>x.n>0):Wn.map((x,q)=>({...x,n:r.filter(H=>Gn(H)===q).length})),[r,n,c.plabels]),F=i?s.get(i):null,M=F?R.find(x=>x.d.id===F.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Dr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:v,viewBox:e.continent==="monde"?td:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?y.fr:y.en,onMouseLeave:()=>{E(null),o(null)},children:[t.jsx("g",{children:y.countries.map((x,q)=>t.jsx("g",{className:"ct"+(x.i2&&C.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},q))}),t.jsx("g",{children:R.map(x=>{const q=Wn[Gn(x.d)],H=!!Pe(x.d),J=x.d.kind==="target",_=n&&J?Mr[Ae(x.d)]:q.c,D=!n&&Be(x.d);return t.jsxs("g",{className:"co"+(D?" done":""),onMouseEnter:()=>{var Q,te;const K=(Q=m.current)==null?void 0:Q.getBoundingClientRect(),W=(te=v.current)==null?void 0:te.createSVGPoint();if(W&&v.current&&K){W.x=x.x,W.y=x.y;const he=W.matrixTransform(v.current.getScreenCTM());E({x:he.x-K.left,y:he.y-K.top,label:x.d.name+" · "+(Ht(x.d.cc,l)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{E(null),o(null)},onClick:()=>{var Q;if(h==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const K=(Q=v.current)==null?void 0:Q.createSVGPoint();let W=null;if(K&&v.current){K.x=x.x,K.y=x.y;const te=K.matrixTransform(v.current.getScreenCTM());W={x:te.x,y:te.y}}a({type:"popup",id:x.d.id,anchor:W})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:I(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:I(q.px),fill:_,stroke:H?"#DC2626":"#ffffff",strokeWidth:I(H?2.2:1.3)})]},x.d.id||x.d.name)})}),M&&t.jsx("circle",{className:"ring on",cx:M.x,cy:M.y,r:I(13),fill:"none",stroke:"#0F172A",strokeWidth:I(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:B.map((x,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),l==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},q))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Dr,{msgs:c.loadMsgs})})}function od(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Fo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:s,lang:l}=Y(),c=a.filters,[g,d]=p.useState(!1),[h,u]=p.useState(!1),v=p.useRef(null),m=p.useRef(null),b=p.useMemo(()=>a.continent==="monde"?n:n.filter(M=>M.continent===a.continent),[n,a.continent]),y=M=>b.filter(x=>M!=="country"&&c.country.length&&!c.country.includes(x.cc||"")?!1:Aa(x,c,i,M==="country"?void 0:M)),f=M=>!i||M.kind!=="op",j=p.useMemo(()=>{const M=y("win").filter(f),x=q=>M.filter(H=>(H.date?Math.max(0,Math.floor((Date.now()-Date.parse(H.date))/864e5)):9999)<=q).length;return[x(0),x(7),x(30),M.length]},[b,c,i]),N=p.useMemo(()=>c.day?y("win").filter(f).filter(M=>(M.date||"").slice(0,10)===c.day).length:0,[b,c,i]),w=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,E=w+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&d(!1)},[a.openFacet]),p.useEffect(()=>{if(!g&&!h)return;const M=q=>{var J,_;const H=q.target;g&&!((J=v.current)!=null&&J.contains(H))&&d(!1),h&&!((_=m.current)!=null&&_.contains(H))&&u(!1)},x=q=>{q.key==="Escape"&&(d(!1),u(!1))};return document.addEventListener("mousedown",M),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",M),document.removeEventListener("keydown",x)}},[g,h]);const A=(M,x,q,H="fbtn")=>t.jsxs("button",{type:"button",className:H,"aria-expanded":a.openFacet===M,onClick:()=>r({type:"openFacet",facet:M}),children:[t.jsx("span",{className:"fl",children:x}),q>0&&t.jsx("span",{className:"n",children:q}),t.jsx("span",{className:"cv",children:"▾"})]},M),C=["1","7","30","all"],L=Math.max(0,C.indexOf(c.win||"all")),T=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(od(c.day,l))}),t.jsx("b",{children:N})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>u(M=>!M),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:j[L]}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((M,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===M,onClick:()=>{r({type:"filters",patch:{win:M}}),u(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:j[x]})]},M))})]}):t.jsx("div",{className:"seg",children:C.map((M,x)=>t.jsxs("button",{type:"button","aria-pressed":c.win===M,onClick:()=>r({type:"filters",patch:{win:M}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:j[x]})]},M))}),R=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:M=>r({type:"filters",patch:{search:M.target.value}})})]}),I=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):A("sec",o.fSector,c.sector.length),A("pay",o.fCountry,c.country.length),A("det",o.fEngine,c.engine.length),A("sta",o.fStage,c.stage.length),i&&A("ang","Angle",c.angle.length),i&&A("mem","Mémo",c.memoLevel.length)]}),B=(M=!1)=>t.jsxs("div",{className:"frow2",children:[E>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(b.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(E)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),M&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),F=t.jsxs("div",{className:"fmenu",ref:v,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(w?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{d(M=>!M),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),w>0&&t.jsx("span",{className:"n",children:w}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:I})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:T}),t.jsxs("div",{className:"fstrip-b",children:[R,F,B(!1)]})]}),a.openFacet&&t.jsx(Ir,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[T,R,I,t.jsx("span",{className:"fgrow"}),B()]}),a.openFacet&&t.jsx(Ir,{poolFor:y})]})}function Ir({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=Y(),i=a.filters,s=a.openFacet,{title:l,cols:c,options:g}=p.useMemo(()=>{if(s==="sig"){const m=e("signal").filter(f=>Pe(f)),b=new Map;m.forEach(f=>{const j=f.engine||"";b.set(j,(b.get(j)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...on([...b.keys()],o).map(f=>({v:f,label:At(f)+" "+Ye(f,o),n:b.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(s==="sec"){const m=e("sector"),b=new Map;return m.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:i.sector.includes(y)}))}}if(s==="pay"){const m=e("country"),b=new Map;return m.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:Ht(y,o)||y,n:f,html:!1,on:i.country.includes(y)}))}}if(s==="det"){const m=e("engine"),b=new Map;return m.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:on([...b.keys()],o).map(y=>({v:y,label:At(y)+" "+Ye(y,o)+' <span style="color:var(--dim);font-size:10px">· '+Ni(Ei(y),o)+"</span>",n:b.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(s==="ang"){const m=e("angle"),b=new Map;return m.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(y)}))}}if(s==="mem"){const m=e("memoLevel"),b=new Map;m.forEach(f=>{if(f.kind==="target"){const j=Sn(f);b.set(j,(b.get(j)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:y[f],n:b.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const u=e("stage"),v=new Map;return u.forEach(m=>{m.stage&&v.set(m.stage,(v.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((m,b)=>b[1]-m[1]).map(([m,b])=>({v:m,label:m,n:b,html:!1,on:i.stage.includes(m)}))}},[s,a,o]),d=u=>{if(s==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(u)?i.signalEngines.filter(b=>b!==u):[...i.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:u})},h=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:h,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Ro({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:s,t:l}=Y(),c=p.useMemo(()=>{const v={};return r.forEach(m=>{Aa(m,n.filters,i)&&(v.monde=(v.monde||0)+1,m.continent&&(v[m.continent]=(v[m.continent]||0)+1))}),v},[r,n.filters,i]),[g,d]=p.useState(!1),h=p.useRef(null);p.useEffect(()=>{if(!g)return;const v=b=>{var y;(y=h.current)!=null&&y.contains(b.target)||d(!1)},m=b=>{b.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",v),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",v),document.removeEventListener("keydown",m)}},[g]);const u=v=>{const m=zn.find(b=>b.key===v);return v==="monde"?l.contWorld:s==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:h,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>d(v=>!v),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Yn.map(v=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===v,onClick:()=>{o({type:"continent",key:v}),d(!1)},children:[u(v),t.jsx("span",{className:"n",children:c[v]||0})]},v))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[Yn.map(v=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===v,onClick:()=>o({type:"continent",key:v}),children:[u(v),t.jsx("span",{className:"n",children:c[v]||0})]},v)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function Mo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function id(e){var o;const a=[],r=new Set,n=i=>{const s=(i||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Pr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:s}){const{t:l}=Y();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:l.rsEvalOne})]},c.name))})]}):null}function Oo({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=Y(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Pr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Pr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function sd({card:e,onEvaluate:a,onAddAll:r}){var l,c,g;const{t:n}=Y(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Mo(e.summary_md||"").map((d,h)=>t.jsx("p",{children:d},h))})]}),t.jsx(Oo,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function ld(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function dd({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:s}=Y(),l=o,[c,g]=p.useState(null),[d,h]=p.useState(null),[u,v]=p.useState(null),[m,b]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const j=await eo({email:s,cbToken:l});f&&g(j)})(),()=>{f=!1}},[s,l,n]);const y=f=>{h(f),v(null),b(!0),(async()=>{const j=await Si(f.id);v(j),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{h(null),v(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[ld(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(sd,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Na=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ta(e){return/^https?:\/\//i.test((e||"").trim())}function lt(e){const a=(e||"").trim();return a?ta(a)?a:Na.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function cd(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function pd(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:s,evalBusy:l,evalCards:c,caps:g,data:d,canWrite:h,source:u,dossiers:v,doAnalyse:m,liveMemos:b,pipe:y}=Y(),f=a==="client",j=p.useMemo(()=>r||(u!=="default"?Ci():""),[r,u]),[N,w]=p.useState(""),[E,A]=p.useState(!1),[C,L]=p.useState(""),[T,R]=p.useState(""),[I,B]=p.useState(""),[F,M]=p.useState(!1),[x,q]=p.useState(!1),H="atl2:evalq:"+(r||"anon"),[J,_]=p.useState(()=>{try{return JSON.parse(localStorage.getItem(H)||"[]")}catch{return[]}});p.useEffect(()=>{try{localStorage.setItem(H,JSON.stringify(J.slice(0,30)))}catch{}},[J,H]);const D=(k,O)=>_(P=>P.map((X,Z)=>Z===k?{...X,...O}:X)),K=(k,O)=>{const P=O.trim();P&&(D(k,{name:P,status:"resolving",site:"",candidates:void 0}),sn(P).then(X=>{const Z=X.candidates||[];X.website?D(k,{site:X.website,status:"ready"}):Z.length===1?D(k,{site:Z[0].url,status:"ready"}):Z.length>1?D(k,{status:"pick",candidates:Z.slice(0,4)}):D(k,{status:"ready"})}).catch(()=>D(k,{status:"ready"})))},[W,Q]=p.useState(!1),te=async()=>{if(W)return;const k=J.map((O,P)=>({r:O,i:P})).filter(({r:O})=>O.name.trim()&&O.status!=="kept"&&O.status!=="out"&&O.status!=="resolving");if(k.length){Q(!0);for(const{r:O,i:P}of k){const X=await to(r,(O.site||O.name).trim(),"atelier2");if(X.verdict==="quota"){ue(Z=>[{name:"",verdict:"quota",reason:X.reason||"",remaining:0},...Z].slice(0,8));break}D(P,{status:X.verdict==="kept"?"kept":"out",reason:X.reason||""}),ue(Z=>[{name:X.company||O.name,verdict:X.verdict,reason:X.reason||"",remaining:X.remaining??null},...Z].slice(0,8))}Q(!1)}},[he,ee]=p.useState(""),[ce,pe]=p.useState(!1),[je,be]=p.useState(""),[le,ue]=p.useState([]);p.useRef(!1);const[oe,$]=p.useState(!1),[ne,fe]=p.useState(!1),[we,Ne]=p.useState(!1),ve=p.useRef(!1),[re,Te]=p.useState(""),[Ke,me]=p.useState(""),[Ee,Ft]=p.useState(!1),[Oe,Ue]=p.useState(!1),[Re,tt]=p.useState(0),[jt,ot]=p.useState(""),[Se,gt]=p.useState(null),[Me,ut]=p.useState(null),[mt,Nt]=p.useState(!1),[bt,vt]=p.useState(null),[it,Et]=p.useState(0),z=p.useRef(!1),U=N.trim()?Na.test(N.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useMemo(()=>he.split(`
`).map(k=>k.trim()).filter(Boolean).slice(0,15),[he]),p.useEffect(()=>{if(typeof window>"u")return;const k=new URLSearchParams(window.location.search),O=(k.get("rs")||"").trim(),P=(k.get("rstext")||"").trim();O&&/^https?:\/\//i.test(O)&&Te(O),P&&me(P),(O&&/^https?:\/\//i.test(O)||P)&&$(!0)},[]),p.useEffect(()=>{const k=O=>{const P=O.detail||{},X=String(P.url||"").trim(),Z=String(P.text||"").trim();X&&/^https?:\/\//i.test(X)&&Te(X),Z&&me(Z),(X&&/^https?:\/\//i.test(X)||Z)&&($(!0),w(""),L(""),Ft(!0),window.setTimeout(()=>Ft(!1),900))};return window.addEventListener("ppmap:research",k),()=>window.removeEventListener("ppmap:research",k)},[]),p.useEffect(()=>{const k=O=>{const P=O.detail||{},X=String(P.name||"").trim();if(!X)return;$(!1),w(X),L(X);const Z=lt(String(P.website||P.domain||""));R(Z),B(lt(String(P.url||""))),M(!Z),A(!0),window.setTimeout(()=>A(!1),900)};return window.addEventListener("ppmap:prefill",k),()=>window.removeEventListener("ppmap:prefill",k)},[]),p.useEffect(()=>{const k=(C||"").trim();if(!k||oe||T){(T||!k||oe)&&M(!1);return}const O=v.find(Z=>$e(Z.name)===$e(k)),P=lt((O==null?void 0:O.website)||"")||lt((O==null?void 0:O.domain)||"");if(P){R(P),M(!1);return}let X=!0;return M(!0),sn(k).then(Z=>{var ge,qe;if(!X)return;const se=lt(Z.website||"")||lt(((qe=(ge=Z.candidates)==null?void 0:ge[0])==null?void 0:qe.url)||"");se&&R(se)}).catch(()=>{}).finally(()=>{X&&M(!1)}),()=>{X=!1}},[C,oe,T,v]),p.useEffect(()=>{const k=O=>{var X;const P=String(((X=O.detail)==null?void 0:X.url)||"").trim();ta(P)&&window.open(P,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",k),()=>window.removeEventListener("ppmap:view",k)},[]),p.useEffect(()=>{if(ve.current===oe)return;ve.current=oe,Ne(!0);const k=window.setTimeout(()=>Ne(!1),560);return()=>window.clearTimeout(k)},[oe]),p.useEffect(()=>{if(typeof window>"u")return;const k=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),O=document.querySelector(".atl2.ops, .atl2.cibles");if(!k||!O)return;const P=()=>O.style.setProperty("--demand-h",`${k.offsetHeight}px`);P();const X=new ResizeObserver(P);return X.observe(k),()=>X.disconnect()},[u,E,Ee,x,oe,we,F]),p.useEffect(()=>{if(!h&&!j){vt(null);return}let k=!0;return(async()=>{const O=await eo({email:n,cbToken:j});k&&vt(O.length)})(),()=>{k=!1}},[h,j,n,it]);const V=le.length?le:c,ae=d.credits,xe=p.useCallback(k=>{const O=k.map(P=>(P||"").trim()).filter(Boolean);O.length&&(ee(P=>{const X=P.split(`
...
`)}),q(!0))},[]);p.useEffect(()=>{if(!Oe)return;tt(0);const k=window.setInterval(()=>tt(O=>O+1),1e3);return()=>window.clearInterval(k)},[Oe]);const ie=p.useMemo(()=>{const k=N.trim().toLowerCase();return!k||!y?null:v.find(O=>$e(O.name)===k&&Ae(O)===1)||null},[N,v,y]),De=()=>{const k=N.trim();if(k){if(ie){m(ie);return}o(null,k),f&&w("")}},Qe=async()=>{var P,X,Z;if(z.current)return;const k=re.trim().replace(/\s+/g,""),O=Ke.trim();if(!k&&!O){ot(e.rsNeed);return}if(!f&&!j){o(null,k||O.slice(0,80));return}z.current=!0,ot(""),gt(null),ut(null),Ue(!0);try{const se=await Ai({url:k,text:O,email:n,cbToken:j});if(Ue(!1),!se||se.status!=="success"){ot((se==null?void 0:se.message)||"Erreur");return}gt(se),$(!1),xe((((P=se.prospective)==null?void 0:P.companies_to_evaluate)||[]).map(qe=>(qe==null?void 0:qe.name)||"")),ut({state:"pending"});const ge=await Ti(se,{email:n,cbToken:j});ut(ge.ok?{state:"ok",scopeLabel:((X=ge.summary)==null?void 0:X.scope_label)||"",scope:((Z=ge.summary)==null?void 0:Z.scope)||""}:{state:"fail",msg:ge.error||""}),ge.ok&&Et(qe=>qe+1)}finally{z.current=!1,Ue(!1)}},ye=[Se==null?void 0:Se.industry,...(Se==null?void 0:Se.market_tags)||[],Se==null?void 0:Se.author].map(k=>(k||"").trim()).filter(Boolean),st=(Me==null?void 0:Me.state)==="pending",Wt=Me&&(st?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Me.state==="ok"?t.jsx("span",{className:"rslink ok",children:Me.scope&&Me.scope!=="public"?e.rsSavedIn(Me.scopeLabel||Me.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Me.msg,children:e.rsSaveFail})),Rt=id(Se).length,Ie=oe,_e=(C||N).trim(),at=v.find(k=>$e(k.name)===$e(_e)),Gt=lt(N)||T||lt((at==null?void 0:at.website)||"")||lt((at==null?void 0:at.domain)||""),Mt=I||lt((at==null?void 0:at.url)||""),S=ie?e.actAnalyse:_e?e.evalGoOn(_e.length>22?_e.slice(0,21)+"…":_e):e.evalGo,G=Oe?`${zi(re.trim())==="youtube"&&re.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Re)}`:st?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Ie?" rs-mode":"")+(C&&N.trim()===C||E||Ee?" pair":"")+(E||Ee||we?" echo":"")+(we?" swap":""),children:[t.jsxs("div",{className:"drow"+((Ie?Ee:E)||we?" flash":"")+((Ie?re.trim():Na.test(N.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Ie?re:N,placeholder:Ie?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Ie?600:200,spellCheck:Ie?!1:void 0,inputMode:Ie?"url":void 0,onChange:k=>{if(Ie){Te(k.target.value);return}w(k.target.value),C&&k.target.value.trim()!==C&&(L(""),R(""),B(""),M(!1))},onKeyDown:k=>{k.key==="Enter"&&(Ie?Qe():De())}}),t.jsx("span",{className:"detect"+(Ie?" off":"")+(Na.test(N.trim())?" url":""),children:U})]}),t.jsx("span",{className:"dacts",children:Ie?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Oe?" loading":""),disabled:Oe||st||!re.trim()&&!Ke.trim(),onClick:()=>{Qe()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:G})]}),t.jsxs("a",{className:"viewbtn"+(ta(re)?"":" off"),href:ta(re)?re.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:k=>{ta(re)||k.preventDefault()},children:[t.jsx(cd,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ie?" analyse":"")+(l?" loading":""),disabled:l,onClick:De,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:S})]}),t.jsxs("a",{className:"viewbtn sm"+(F?" searching":Gt?"":" off"),href:Gt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:k=>{Gt||k.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(Mt?"":" off"),href:Mt||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:k=>{Mt||k.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&ae&&t.jsxs("button",{type:"button",className:"credits"+(ae.total_available<=0&&!ae.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ae.unlimited?"∞":ae.total_available}),!ae.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ae.daily_grant+ae.purchased]}),ae.total_available<=0&&!ae.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>q(!x),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(oe?" on":""),onClick:()=>$(!oe),children:e.rsOpen}),bt!==null&&bt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(mt?" on":""),onClick:()=>Nt(!mt),children:e.rsArchOpen(bt)})]}),mt&&t.jsx(dd,{bump:it,cbToken:j,onClose:()=>Nt(!1),onEvaluate:k=>o(null,k),onAddAll:xe}),t.jsx("div",{className:"rsp slim"+(oe?" on":" off"),"aria-hidden":!oe,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:oe?void 0:-1,onClick:()=>fe(k=>!k),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:ne?"▴":"▾"})]}),ne&&t.jsx("textarea",{className:"rstext",value:Ke,placeholder:e.rsTextPh,tabIndex:oe?void 0:-1,onChange:k=>me(k.target.value)})]})}),jt&&t.jsx("div",{className:"rserr",children:jt}),Se&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:Se.title}),Se.source_url&&t.jsx("a",{href:Se.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{gt(null),ut(null)},children:"×"})]}),Se.market&&t.jsx("p",{className:"rsmk",children:Se.market}),ye.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),ye.map(k=>t.jsx("span",{children:k},k))]}),t.jsxs("div",{className:"rsbody",children:[Se.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${Se.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Mo(Se.summary_md||"").map((k,O)=>t.jsx("p",{children:k},O))})]}),t.jsx(Oo,{card:Se,onEvaluate:k=>o(null,k),onAddAll:xe}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Rt)}),Wt]})]}),x&&t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[J.map((k,O)=>t.jsxs("div",{className:"eq-row",children:[t.jsx("input",{value:k.name,placeholder:e.eqNamePh,onChange:P=>{const X=P.target.value.split(`
`).map(Z=>Z.trim()).filter(Boolean);X.length>1?(_(Z=>{const se=[...Z];return se.splice(O,1,...X.map(ge=>({name:ge,site:"",status:""}))),se.slice(0,30)}),X.forEach((Z,se)=>window.setTimeout(()=>K(O+se,Z),80*se))):D(O,{name:P.target.value})},onBlur:()=>{k.name.trim()&&!k.site&&k.status!=="resolving"&&k.status!=="pick"&&K(O,k.name)},onKeyDown:P=>{P.key==="Enter"&&K(O,k.name)}}),t.jsxs("span",{className:"eq-site",children:[k.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:"…"}),k.status==="pick"&&(k.candidates||[]).map(P=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>D(O,{site:P.url,status:"ready",candidates:void 0}),children:(P.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,26)},P.url)),k.status!=="resolving"&&k.status!=="pick"&&(k.site?t.jsxs("a",{href:k.site.startsWith("http")?k.site:"https://"+k.site,target:"_blank",rel:"nofollow noopener",children:[k.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,30)," ↗"]}):t.jsx("em",{children:k.name.trim()&&k.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-st s-"+(k.status||"vide"),title:k.reason||"",children:k.status==="kept"?"✓ "+e.kept:k.status==="out"?"✗ "+e.dropped:k.status==="ready"?e.eqReady:k.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>_(P=>P.filter((X,Z)=>Z!==O)),children:"×"})]},O)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>_(k=>[...k,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(W?" loading":""),style:{justifyContent:"center"},disabled:W||!J.some(k=>k.name.trim()&&k.status!=="kept"&&k.status!=="out"),onClick:()=>{te()},children:[t.jsx("span",{className:"fill"}),W?e.eqRunning:e.eqGo(J.filter(k=>k.name.trim()&&k.status!=="kept"&&k.status!=="out").length)]}),t.jsx("span",{className:"hint",children:e.eqHint}),J.some(k=>k.status==="kept"||k.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",style:{marginTop:6},onClick:()=>_(k=>k.filter(O=>O.status!=="kept"&&O.status!=="out")),children:e.eqClearDone})]})]}),V.slice(0,1).map((k,O)=>{const P=k.verdict==="kept",X=k.verdict==="quota",Z=k.verdict==="unresolved",se=P?"var(--brand)":X?"var(--bolt)":Z?"var(--blue)":"var(--red)",ge=P?"var(--brand-l)":X?"#FEF3C7":Z?"#EEF4FF":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":se,"--bgc":ge},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:P?"✓ "+e.kept:X?"⏳":Z?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),k.name&&t.jsx("span",{className:"rn",children:k.name}),t.jsx("span",{className:"rr",children:k.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",k.reason]}):null}),!!(k.candidates&&k.candidates.length)&&t.jsx("span",{className:"sitepick",children:k.candidates.map(qe=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:qe.url.startsWith("http")?qe.url:`https://${qe.url}`,target:"_blank",rel:"nofollow noopener",children:[(qe.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,qe.url,k.name),children:e.evalPickGo})]},qe.url))}),!X&&!Z&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:P?1:5});const qe=(k.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ce=[...document.querySelectorAll(".atl2 .list .row")].find(Wo=>{var Pn;return(((Pn=Wo.querySelector(".rnm"))==null?void 0:Pn.textContent)||"").trim().toLowerCase().includes(qe)});Ce&&(Ce.scrollIntoView({behavior:"smooth",block:"center"}),Ce.classList.add("flashrow"),window.setTimeout(()=>Ce.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(P?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},O)}),f&&(i.kept+i.dropped>0||V.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function ud(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function md(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Y(),i=e.memoConsole?r.get(e.memoConsole):null,s=p.useMemo(()=>i?[i.reasoning||"",ud(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=kt(i),c=Sn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:s?s.split(`

`).map((g,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Pt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Rn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Y(),[s,l]=p.useState(!1),[c,g]=p.useState(null),d=n.pipe&&o==="client"&&!n.lockActions,h=async()=>{if(!d||s)return;l(!0);const u=await qi(r,e);if(l(!1),!u){i(a.actErr);return}g(u.results||[])};return p.useEffect(()=>{if(!d)return;const u=v=>{var b;const m=String(((b=v.detail)==null?void 0:b.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&h()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,d]),p.useEffect(()=>{if(d)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),h())}catch{}},[e,d]),d?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{h()},children:s?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const fd=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),va=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function hd(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=va(a.slice(n));break}r+=va(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=va(a.slice(o));break}const s=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(s),c=l?l[2].toLowerCase():"";l&&fd.has(c)?r+=`<${l[1]}${c}>`:r+=va(a.slice(o,i+1)),n=i+1}return r}const xd=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),Br={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function Do(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(xd.has(o)){n.remove();continue}for(const s of Array.from(n.attributes)){const l=s.name.toLowerCase();(!(Br["*"].has(l)||((r=Br[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(s.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const s=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");s!==i&&(s?n.setAttribute("style",s):n.removeAttribute("style"))}if(o==="a"){const s=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(s)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const s=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(s)){n.remove();continue}n.setAttribute("loading","lazy")}Do(n)}}function Za(e){const a=e.cloneNode(!0);return Do(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const en=new Map;function gd(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=en.get(a);return r||(r=bd(a).catch(()=>null),r.then(n=>{n||en.delete(a)}),en.set(a,r)),r}async function bd(e){var h,u;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=new DOMParser().parseFromString(await a.text(),"text/html"),n=v=>{var m;return(((m=r.querySelector(v))==null?void 0:m.textContent)||"").trim()},o=r.querySelector(".sb-score"),i=((h=Array.from((o==null?void 0:o.classList)||[]).find(v=>v.startsWith("sb-score-")))==null?void 0:h.slice(9))||"",s=[];let l=null;const c=Array.from(r.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const v of c){if(v.classList.contains("sb-nav-heading")){l={label:(v.textContent||"").trim(),items:[]},s.push(l);continue}const m=v.getAttribute("href")||"";if(!m.startsWith("#"))continue;const b=m.slice(1),y=vd(r,b);y&&(l||(l={label:"",items:[]},s.push(l)),l.items.push({id:b,title:(v.textContent||"").trim(),html:y,poids:y.length}))}const g=((u=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:u[1])||"",d={score:n(".sb-score"),scoreTone:i,tags:Array.from(r.querySelectorAll(".sb-tag")).map(v=>(v.textContent||"").trim()).filter(Boolean),name:n(".sidebar-company-name"),tagline:n(".sidebar-tagline"),desc:n(".meta-desc"),groups:s.filter(v=>v.items.length),mindmapSlug:r.querySelector(".cm-mindmap-png")?g:""};return d.groups.length?d:null}const _r={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function vd(e,a){const r=e.getElementById(a),n=r?$r(e,r):"";if(n)return n;const o=_r[a]?e.querySelector(_r[a]):null;return o&&o!==r?$r(e,o):""}function $r(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Za(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(c=>/^h3$/i.test(c.tagName))[0]===a)for(const c of i){if(c===a)break;/^h2$/i.test(c.tagName)||o.appendChild(c.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?Za(o):""}return Za(a)}const tn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function rt({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ur(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Hr({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const an=new Map;function yd(e,a){const{token:r}=Y(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let s=an.get(i);s||(s=Li(r,e.name,e.checkId),an.set(i,s),s.then(c=>{(!c||!c.reasoning&&!c.summaryHtml)&&an.delete(i)}));let l=!0;return s.then(c=>{l&&c&&o({id:e.id,d:c})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const wd=6e4;function kd({o:e}){const{t:a,doDeep:r}=Y(),[n,o]=p.useState(null),[i,s]=p.useState(e.memoUrl?"load":"off"),[l,c]=p.useState(()=>new Set),[g,d]=p.useState(!1),h=p.useRef(new Map);p.useEffect(()=>{let b=!0;if(c(new Set),d(!1),h.current=new Map,!e.memoUrl){s("off"),o(null);return}return s("load"),o(null),gd(e.memoUrl).then(y=>{b&&(o(y),s(y?"ok":"err"))}),()=>{b=!1}},[e.memoUrl]);const u=kt(e),v=b=>{var y;return(y=h.current.get(b))==null?void 0:y.scrollIntoView({behavior:"smooth",block:"start"})},m=t.jsxs("div",{className:"cdacts",children:[Pt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:b=>{b.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:b=>b.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const b=[e.reasoning||"",Ur(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[b.length?b.join(`

`).split(`

`).map((y,f)=>t.jsx("p",{className:"cdtxt",children:y},f)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),m]})}if(i!=="ok"){const b=[e.reasoning||"",Ur(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),b.length>0&&b.join(`

`).split(`

`).map((y,f)=>t.jsx("p",{className:"cdtxt",children:y},f)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:y=>{y.stopPropagation(),d(f=>!f)},children:g?a.memoHideHere:a.memoReadHere})}),g&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:y=>y.stopPropagation()}),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(b=>t.jsx("span",{className:"md-tag",children:b},b)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(b=>b.items.map(y=>t.jsx("button",{type:"button",className:"md-jump",onClick:f=>{f.stopPropagation(),v(y.id)},children:y.title},y.id)))}),n.groups.map((b,y)=>t.jsxs("div",{className:"md-grp",children:[b.label&&t.jsx("div",{className:"md-grp-h",children:b.label}),b.items.map(f=>{const j=f.poids>wd&&!l.has(f.id),N=f.id==="fiche-contact"||f.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:w=>{w&&h.current.set(f.id,w)},children:[t.jsx("h4",{className:"md-h",children:f.title}),N&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:w=>w.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"LinkedIn"})]}),j?t.jsx("button",{type:"button",className:"abtn md-more",onClick:w=>{w.stopPropagation(),c(E=>new Set(E).add(f.id))},children:a.memoUnfold(Math.round(f.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:f.html}}),!j&&n.mindmapSlug&&f.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Pa}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:w=>w.stopPropagation()})]})]},f.id)})]},b.label||y)),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:b=>b.stopPropagation(),children:a.memoOpenFull})]})}function Mn({o:e}){var N;const{t:a,lang:r,dispatch:n,caps:o}=Y(),i=da(e),s=kt(e),l=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),h=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(l?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Pt(e)?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:d}].filter(w=>w.n>0),[e,a,o,l,s,c,g,d]),[u,v]=p.useState(""),m=h.some(w=>w.k===u)?u:((N=h[0])==null?void 0:N.k)||"",b=yd(e,m==="eval"||m==="conv");if(!h.length)return null;const y=((b==null?void 0:b.reasoning)||"").length>(e.reasoning||"").length?b.reasoning:e.reasoning||"",f=((b==null?void 0:b.summaryHtml)||"").length>(e.summary||"").length?b.summaryHtml:e.summary||"",j=(b==null?void 0:b.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:h.map(w=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===w.k,"data-tour":"tab-"+w.k,className:m===w.k?"on":"",onClick:E=>{E.stopPropagation(),v(w.k)},children:w.lib},w.k))}),t.jsxs("div",{className:"cdbody",onClick:w=>w.stopPropagation(),children:[m==="eval"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[t.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(Hr,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),y&&y.split(`

`).map((w,E)=>t.jsx("p",{className:"cdtxt",children:w},E)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(jd,{o:e})]}),m==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof j=="number"&&t.jsx(Hr,{v:j,sur:100,k:a.cdConvScore}),tn(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",tn(e.verdictDate,r)]})]}),f&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:hd(f)}})]}),m==="memo"&&t.jsx(kd,{o:e}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(rt,{k:a.cdSector,v:e.sector}),t.jsx(rt,{k:a.cdStage,v:e.stage}),t.jsx(rt,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(rt,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(rt,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(rt,{k:a.cdAngle,v:e.angle}),t.jsx(rt,{k:a.cdDetected,v:tn(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(rt,{k:a.cdName,v:e.contactName}),t.jsx(rt,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(rt,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(rt,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}const ya=new Map;function jd({o:e}){const{t:a,token:r}=Y(),[n,o]=p.useState(!1),[i,s]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const h=`${r}:${e.name.toLowerCase()}`;let u=ya.get(h);u||(u=ao(r,[e.name]).then(m=>m[e.name]||Object.values(m)[0]||null).catch(()=>null),ya.set(h,u),u.then(m=>{(!m||!m.ok)&&ya.delete(h)}));let v=!0;return u.then(m=>{v&&m&&m.ok&&s(m)}),()=>{v=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const h=await Fi(r,e.name,e.website||e.domain||"");s(h),h.ok&&ya.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(h)),o(!1)},c=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],d=g.some(([,h])=>h);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[g.filter(([,h])=>h).map(([h,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:h}),t.jsx("p",{children:u})]},h)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function ca({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let s=!1;const l=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Kn({kind:"op",card:e},g).then(d=>{!s&&d&&i.isConnected&&i.replaceChildren(d)})},c=window.requestAnimationFrame(l);return()=>{s=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let s=!1;Kn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!s&&c&&i.isConnected&&i.replaceChildren(c)});const l=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{s=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Nd=`
...
`;function Ed(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:s,top:l}}function Sd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:s,askEvaluate:l,doAnalyse:c,doDecide:g,doPromote:d,doRepeche:h,doApproach:u,doDeep:v,doOnboard:m,outbound:b,evalBusy:y}=Y(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const j=Pe(f),N=Ae(f),w=kt(f),E=da(f),A=f.kind==="target",C=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Ut.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Nd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Ed(e.popupAnchor,!!f.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(xt(f.date)),Ye(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[f.cc]}),children:(Ht(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Vt(f.amountEur,o)})]}),i.pipe&&A&&t.jsxs("div",{className:"pstat",children:[E&&t.jsx("span",{className:"vd "+(E==="MATCH"?"v-ok":"v-no"),title:n.vt[E],children:E}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[N]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[At(f.engine)," ",t.jsx("b",{children:Ye(f.engine,o)})," — ",Ri(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(wt,{o:f,lg:!0})," ",t.jsx(Ba,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(no(j,o))," · ",n.win7(ro(j,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(ca,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&N>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&A&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&A&&t.jsx(Mn,{o:f})]}),t.jsx(Rn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||s!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[N===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),N===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),N===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),N===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),Pt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(f),a({type:"popup",id:null})},children:n.memoDeep})]}),N===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),N===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Cd(){const{lang:e,token:a,dossiers:r,caps:n}=Y(),o=a||"home",{names:i,verdicts:s}=p.useMemo(()=>{const c=[],g={};return r.forEach(d=>{d.kind!=="target"||!d.name||(c.push(d.name),g[d.name]=Mi(d)||"")}),{names:c,verdicts:g}},[r]);return{diff:p.useMemo(()=>i.length?Oi(o,i,s,e):null,[o,i.length]),names:i,verdicts:s,scope:o,caps:n}}function zd(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:s,caps:l}=Y(),[c,g]=p.useState(!1),[d,h]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!c)return;const N=w=>{u.current&&!u.current.contains(w.target)&&g(!1)};return document.addEventListener("click",N,!0),()=>document.removeEventListener("click",N,!0)},[c]);const v=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!s.length,b=p.useRef({});p.useEffect(()=>{b.current={...r}},[r]);const y=N=>{const w=b.current[N],E=w!==void 0?r[N]-w:0;return t.jsxs("button",{type:"button",className:"step"+(N===3&&r[3]>0?" wait":""),style:{"--c":`var(${aa[N]})`,"--tc":N<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===N,title:n.phelp[N],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:N})},children:[t.jsxs("span",{className:"l",children:[n.plabels[N].toUpperCase(),N===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(E>0?" up":E<0?" down":""),children:[r[N],E!==0&&t.jsxs("em",{className:"delta",children:[E>0?"+":"−",Math.abs(E)]})]})]},N)},f=(N,w,E)=>t.jsxs("button",{type:"button",className:"off"+(w?" view":""),style:{"--c":`var(${aa[N]})`},"aria-selected":e.ptab===N,title:n.phelp[N],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:N})},children:[t.jsx("span",{className:"l",children:E.toUpperCase()}),t.jsx("span",{className:"n",children:r[N]})]},N),j=(N,w,E,A=!1)=>t.jsx("button",{type:"button",className:"tool",title:w,disabled:A,onClick:E,children:N},w);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(y)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[j("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(d?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}h(!0),window.setTimeout(()=>h(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":c,title:n.toolSort,onClick:()=>g(N=>!N),children:"⇅"}),c&&t.jsx("span",{className:"sortmenu",role:"listbox",children:v.map(([N,w])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===N,className:"sortopt"+(e.sort.key===N?" on":""),onClick:()=>a({type:"sort",key:N}),children:[w,t.jsx("i",{children:e.sort.key===N?e.sort.dir===1?"↑":"↓":""})]},N))})]}),j("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),j("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Ad(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:s}=Y(),l=p.useRef(null),[c,g]=p.useState(60);p.useEffect(()=>{let m=0;const b=()=>{var w;const y=l.current;if(!y)return;const f=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!f)return;const j=f.getBoundingClientRect(),N=y.getBoundingClientRect();g(Math.max(20,Math.min(j.left+j.width/2-N.left,N.width-30)))};return m=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",b)}},[e.ptab]);const d=e.ptab;let h=r.tuto[d].p;if(d===3){const m=n.filter(f=>f.kind==="target"&&Ae(f)===3),b=m.filter(f=>ln(f)==="auto").length,y=m.filter(f=>ln(f)==="cd").length;h=r.tutoPending(b,y,m.length)}const u=(()=>{if(s!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(d===1){const m=n.filter(b=>b.kind==="target"&&Ae(b)===1&&!o.has(b.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(b=>b.id)})}}return null})(),v=Di(d);return t.jsxs("div",{ref:l,className:"tuto mini"+(v?"":" on-dark"),style:{"--bg":`var(${aa[d]})`,"--ax":c+"px","--stc":v?"var(--ink)":"#fff","--stt":v?"#fff":"var(--ink)","--tc":v?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:h}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const nn=600,Ct=62,Vr="atl2:fstats";function Td(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Y(),[s,l]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Vr)==="on"}catch{return!1}}),c=r.stats,g=p.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const h=E=>a==="en"?E.slice(5,10):`${E.slice(8,10)}/${E.slice(5,7)}`,u=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),v=g.reduce((E,A)=>Math.max(E,A.s||0),0),m=g.length?nn/g.length:0,b=Math.max(4,m-4),y=g.length>=5&&v>0,f=r.marketEstimate||0,j=h(new Date().toISOString().slice(0,10)),N=E=>[...typeof E=="number"?[[E,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&d&&w.push({cle:"fenetre",periode:e.funPerWindow(h(d),j),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:N(c.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[w.map(E=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:E.periode}),E.etapes.map(([A,C],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(A)}),t.jsx("i",{children:C})]},E.cle+C)),E.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((c.screened||0)/f*100)))})]}),E.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const A=!s;l(A),A&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Vr,A?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},E.cle)),s&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${nn} ${Ct}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((E,A)=>{const C=(E.s||0)/v*(Ct-4),L=(E.m||0)/v*(Ct-4),T=A*m+(m-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${h(E.d)} — ${E.s} ${e.actScreened} · ${E.m} ${e.actKept}`}),t.jsx("rect",{x:T,y:Ct-2-C,width:b,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:T,y:Ct-2-L,width:b,height:L,fill:"#185c38"})]},E.d)}),t.jsx("line",{x1:0,y1:Ct-1.5,x2:nn,y2:Ct-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:h(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Io={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function On({o:e,locked:a=!1}){const{t:r}=Y(),n=da(e),o=kt(e),i=Ae(e),s=ln(e),l=Ii(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Io[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&s==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&s==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(Zs,{o:e})]})}const $t=e=>e.length>22?e.slice(0,21)+"…":e;function la(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Po(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function qd({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const s=()=>{var m,b,y;const l=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const g=l.getBoundingClientRect(),d=c?c.getBoundingClientRect().bottom:g.top;i({top:Math.round(d),left:Math.round(g.left),width:Math.round(g.width)});const h=[...l.querySelectorAll(":scope .grp")];let u=null;for(const f of h){const j=f.querySelector(".grp-h");j&&j.getBoundingClientRect().bottom<=d+2&&(u=f)}if(!u){n(null);return}const v=u.querySelector(".grp-h");if(!v){n(null);return}n({ic:(((m=v.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((b=v.querySelector(".t"))==null?void 0:b.textContent)||"").trim(),s:(((y=v.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return s(),window.addEventListener("scroll",s,{passive:!0}),window.addEventListener("resize",s),()=>{window.removeEventListener("scroll",s),window.removeEventListener("resize",s)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Ld(e){const r=()=>{const n=Po(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Wr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Y(),[i,s]=p.useState(!1);if(p.useEffect(()=>{n||s(!1)},[n]),Be(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn($t(e.name))})]})}function Dn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:s,doPromote:l,doRepeche:c,doApproach:g,dispatch:d,liveMemos:h}=Y(),u=m=>b=>{b.stopPropagation(),m()};if(r.lockActions){const m=u(()=>d({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const b=Ae(e);return b===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn($t(e.name))})]})}):b===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):b===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):b===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):b===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):b===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),la(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(za(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),la(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Wr,{o:e})});const v=Ae(e);if(v===0)return t.jsx("span",{className:"cell",children:t.jsx(Wr,{o:e})});if(v===1){const m=h.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Sa,{item:m,serverOff:h.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:u(()=>i(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(v===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(v===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return v===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):v===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Fd({o:e}){const{t:a,doThumb:r,thumbOf:n}=Y(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Rd({o:e}){const{lang:a}=Y();return Pe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(wt,{o:e}),t.jsx(Ba,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[At(e.engine||"")," ",Ye(e.engine||"",a)]})})}function Md({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:s,fresh:l}){const{dispatch:c,caps:g,markRow:d,markedId:h,favIds:u,toggleFav:v,t:m}=Y(),b=Ae(e),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,j=f<=0?0:f<=7?1:f<=30?2:3,N=g.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][b]:y[j],w=u.has(e.id),E=A=>{if(a)return;if(s){s(e.id);return}if(g.pipe||e.kind==="op"){n();return}const C=A.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(h===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+b:"")+(w?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:E,children:[t.jsx("span",{className:"pt",style:{"--c":N}}),t.jsx(Ho,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),Pe(e)&&t.jsx(wt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:w?1:.35,padding:0,marginRight:4},onClick:A=>{A.stopPropagation(),v(e)},children:w?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[He(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(A=>A&&A!==e.name)||""]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:A=>{A.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",$t(e.acquirer)]}),Ve(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(Od,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Rd,{o:e}),g.pipe&&t.jsx(On,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Dn,{o:e}),g.showThumbs&&t.jsx(Fd,{o:e})]}),r&&!a&&!s&&t.jsx(Pd,{o:e})]})}function Od({o:e}){const{lang:a,caps:r}=Y();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Vt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Dd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Y(),s=(u,v=!1)=>m=>{m.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Vt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Be(e),h=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped})]}):He(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),la(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn($t(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ca,{spec:e.card})})]})}function Id({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Y();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ye(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Dn,{o:e})}),t.jsx(Mn,{o:e})]})}function Bo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:s,caps:l,dossiers:c}=Y(),g=p.useRef(null),d=Ve(e);if(p.useEffect(()=>{if(!d||!(e!=null&&e.decryptHtml))return;const x=g.current;if(!x)return;let q=!1;return rn(()=>import("./fit-BnaWm7z_.js"),[]).then(async H=>{await H.ensureEditoCss(),!(q||!x.isConnected)&&(H.beautifyEditoRows(x),H.mountCardFits(x))}),()=>{q=!0}},[d,e==null?void 0:e.decryptHtml]),!e&&!a){const x=c.find(Ve);if(x)return t.jsx(Bo,{o:x})}const h=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),v=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||h,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),b=e?!!e.noCo:!h||Ca(h),y=(e==null?void 0:e.engine)||"",f=Ve(e),j=e?Vt(e.amountEur,n):"",N=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),w=(()=>{const x=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return x?x[1].replace(/^www\./,"").slice(0,40):""})(),E=c.find(Ve),A=((E==null?void 0:E.url)||"").trim(),C=!!u&&!!A&&(u===A||u.endsWith(A)||A.endsWith(u)),L=(x,q=!1)=>H=>{H.stopPropagation(),q&&s({type:"continent",key:"monde"}),s({type:"filters",patch:x})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const T=()=>{h&&(s({type:"continent",key:"monde"}),s({type:"filters",patch:{search:h}}))},R=()=>{e!=null&&e.sector&&s({type:"filters",patch:{sector:[e.sector]}})},I=()=>{la({url:u,headline:v,tagline:e==null?void 0:e.tagline,name:h})},B=e?Be(e):!1,F=B&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",M=f?r.doEdito.replace(/^📖\s*/,""):y?Ye(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[M,N?` · ${N}`:""]}),t.jsx("h3",{className:"zoom-h",children:v}),u&&!f&&(b||za({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:x=>x.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,w?t.jsx("em",{children:w}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),j&&t.jsx("span",{className:"oc-amt",children:j})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(ca,{spec:m})}),(u&&!C&&!f||E&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!C&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:x=>x.stopPropagation(),children:[r.zoomSrc,w?` · ${w}`:""," ↗"]}),E&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:x=>{x.stopPropagation(),s({type:"focus",id:E.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[B?t.jsxs("span",{className:"verdict",style:{"--c":F?"var(--brand)":"var(--red)"},children:[F?"✓":"✗"," ",t.jsx("b",{children:F?r.kept:r.dropped})]}):!b&&h?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:x=>{x.stopPropagation(),o(e,h)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn($t(h))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(b||za({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!b&&h?" ghost":""),onClick:x=>{x.stopPropagation(),I()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!b&&h&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),R()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:$t(h)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!b&&h&&l.pipe&&t.jsx(Rn,{name:h})]})]})}function Pd({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:s}=Y();return!o.pipe&&e.kind==="op"?t.jsx(Dd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Mn,{o:e}),t.jsx(el,{o:e}),t.jsx(nl,{o:e}),t.jsx(Rn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(On,{o:e})})]}),e.card&&t.jsx(ca,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[At(e.engine||"")," ",Ye(e.engine||"",r)]}),Pe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(wt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function Bd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:s,doDecide:l,lang:c}=Y();if(!s.pipe&&e.kind==="op"){const h=Vt(e.amountEur,c),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),v=(m,b=!1)=>y=>{y.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ca,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:v({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:v({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:v({stage:[e.stage]}),children:e.stage}),h&&t.jsx("span",{className:"damt",children:h})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[At(e.engine||"")," ",Ye(e.engine||"",c)]}),Pe(e)&&t.jsx(wt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Dn,{o:e})})]})}const g=Ae(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":d},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(On,{o:e}),Pe(e)&&t.jsx(wt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&s.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function _d(){const{t:e}=Y(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function $d({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Y(),i=o==="en",s=d=>n.plabels[d]||"",l=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),c=l.includes(0)?0:l.sort((d,h)=>(e[h]||0)-(e[d]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${s(c)}”`:`${g} dossier${g>1?"s":""} dans « ${s(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+s(c)," →"]})]})}function Ud(){var Nt,bt,vt,it,Et;const e=Y(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:s,scopedAll:l,markRow:c,lang:g,sessTally:d,data:h,dossiers:u,source:v,focusExtra:m,byId:b,token:y}=e,f=so(),j=p.useMemo(()=>{var V,ae,xe,ie;if(!y||v==="ops")return null;const z=(((V=f==null?void 0:f.ed)==null?void 0:V.date)||(f==null?void 0:f.day)||"").slice(0,10),U=[(ae=f==null?void 0:f.ed)==null?void 0:ae.html,(xe=f==null?void 0:f.ed)==null?void 0:xe.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((ie=f==null?void 0:f.ed)==null?void 0:ie.date)||z,decryptHtml:U||void 0,date:z,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,v,g,(Nt=f==null?void 0:f.ed)==null?void 0:Nt.html,(bt=f==null?void 0:f.ed)==null?void 0:bt.acquirers_html,(vt=f==null?void 0:f.ed)==null?void 0:vt.date,f==null?void 0:f.day]),N=z=>o.lockRowsAfter!==null||v==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:io,[w,E]=p.useState(new Set);p.useEffect(()=>{E(new Set)},[a.ptab,a.continent]);const[A,C]=p.useState(null);p.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[L,T]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){T(!1);return}const z=document.getElementById("atl2-stage");if(!z){T(!1);return}const U=new IntersectionObserver(([V])=>T(!!V&&V.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return U.observe(z),()=>U.disconnect()},[a.mapFolded]);const R=a.mapFolded||!L,I=z=>E(U=>{const V=new Set(U);return V.has(z)?V.delete(z):V.add(z),V}),B=v==="ops"||o.pipe,[F,M]=p.useState("all"),[x,q]=p.useState(!1),[H,J]=p.useState(null),[_,D]=p.useState(!1),K=p.useRef(!0);p.useEffect(()=>{if(K.current){K.current=!1;return}M("all"),D(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!_)return;const z=U=>{var V,ae;(ae=(V=U.target)==null?void 0:V.closest)!=null&&ae.call(V,".atl2 .doable")||D(!1)};return document.addEventListener("click",z,!0),()=>document.removeEventListener("click",z,!0)},[_]);const W=p.useMemo(()=>{var U;const z=new Map;for(const V of Ps(((U=f==null?void 0:f.ed)==null?void 0:U.html)||""))z.has(V.t)||z.set(V.t,V.html);return z},[(it=f==null?void 0:f.ed)==null?void 0:it.html]),Q=p.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!W.size)return;const U=(z.name||"").trim().toLowerCase();if(U.length<3)return;const V=W.get(U);if(V)return V;for(const[ae,xe]of W)if(ae.includes(U)||U.includes(ae))return xe},[W]),{diff:te}=Cd(),[he,ee]=p.useState(!1),ce=a.filters.win==="1"&&!a.filters.day,[pe,je]=p.useState(!1),be=p.useMemo(()=>new Set(((te==null?void 0:te.added)||[]).map(z=>z.trim().toLowerCase()).filter(Boolean)),[te]),le=p.useMemo(()=>{if(!be.size)return 0;const z={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(U=>!Ve(U)&&be.has((U.name||"").trim().toLowerCase())&&na(U,z,o.pipe)).length},[u,be,a,o.pipe]);p.useEffect(()=>{const z=()=>{je(!1),q(!1),M("all"),D(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",z),()=>window.removeEventListener("ppmap:tunnel",z)},[]),p.useEffect(()=>{je(!1),q(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const ue=p.useMemo(()=>{const z=l.filter(V=>!Ve(V)&&He(V));let U="";for(const V of z){const ae=(V.date||"").slice(0,10);ae&&(!U||ae<U)&&(U=ae)}return{n:z.length,since:U?U.split("-").reverse().slice(0,2).join("/"):""}},[l]),oe=ue.n,$=p.useMemo(()=>{const U=pe&&be.size>0||a.filters.signalOnly||F!=="all"||x?l:s;let V=An(U,a.sort);return V=V.filter(ae=>!Ve(ae)),pe&&be.size&&(V=V.filter(ae=>be.has((ae.name||"").trim().toLowerCase()))),x||F==="explore"?V=V.filter(He):F==="eval"?V=V.filter(ae=>!He(ae)&&!ae.noCo&&(ae.kind==="op"||!Be(ae))):o.pipe&&(V=V.filter(ae=>!He(ae))),V},[s,l,a.sort,F,pe,be,x,o.pipe]),fe=p.useMemo(()=>o.pipe?u.filter(z=>z.kind==="target"&&!Ve(z)&&Pe(z)&&(a.continent==="monde"||z.continent===a.continent)):$.filter(z=>Pe(z)&&!Be(z)),[o.pipe,u,$,a.continent]).length,we=p.useMemo(()=>o.pipe?$:$.filter(z=>!Be(z)&&!z.noCo&&!He(z)),[$,o.pipe]),Ne=v==="ops"?$.filter(He).length:0,ve=pe?"":o.pipe?n.plabels[a.ptab].toLowerCase():v==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,re=a.filters,Te=[];if(re.day)Te.push({k:"day",lib:n.fDay(re.day.slice(8,10)+"/"+re.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(re.win&&re.win!=="all"){const z=["1","7","30"].indexOf(re.win);z>=0&&Te.push({k:"win",lib:n.dates[z],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ke=z=>z.length<=2?z.join(", "):`${z.length} ${n.fSelected}`;for(const z of["sector","country","engine"]){const U=re[z];U&&U.length&&Te.push({k:z,lib:Ke(U),off:()=>r({type:"clearFacet",facet:z})})}re.search&&Te.push({k:"search",lib:"🔍 "+re.search,off:()=>r({type:"filters",patch:{search:""}})}),pe&&be.size&&Te.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>je(!1)}),re.signalOnly&&Te.push({k:"sig",lib:"🔴 "+n.sigDock(fe||re.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const me=(z,U,V="",ae=!1)=>t.jsxs("button",{type:"button","data-s":z,className:V,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:ae?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[U,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),Ee=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const z=new Map;$.forEach(ae=>{const xe=ae.engine||"?";z.has(xe)||z.set(xe,[]),z.get(xe).push(ae)});const U={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},V=on([...z.keys()],g);return[...z.entries()].sort((ae,xe)=>{const ie=U[ae[0]]??10+V.indexOf(ae[0]),De=U[xe[0]]??10+V.indexOf(xe[0]);return ie-De})},[$,o.pipe,a.groupBy,g]),Ft=Ee?Ee.filter(([z])=>ka.has(z)).length:0,Oe=(()=>{var U;return((U=(Ee?Ee.flatMap(([,V])=>V):$)[0])==null?void 0:U.id)??null})(),Ue=p.useRef(!1),Re=p.useMemo(()=>u.find(Ve)||j,[u,j]);p.useEffect(()=>{const z=()=>{Ue.current=!0,je(!1)};return window.addEventListener("ppmap:reveal",z),window.addEventListener("ppmap:focus",z),()=>{window.removeEventListener("ppmap:reveal",z),window.removeEventListener("ppmap:focus",z)}},[]),p.useEffect(()=>{const z=()=>{Re&&r({type:"focus",id:Re.id})};return window.addEventListener("ppmap:edito",z),()=>window.removeEventListener("ppmap:edito",z)},[Re,r]),p.useEffect(()=>{if(!a.focusId)return;J(a.focusId);const z=window.setTimeout(()=>J(null),900);return()=>window.clearTimeout(z)},[a.focusId]),p.useEffect(()=>{if(B&&!(a.focusId&&($.some(z=>z.id===a.focusId)||u.some(z=>z.id===a.focusId)||a.focusId===(Re==null?void 0:Re.id)))&&!m){if(Re){r({type:"focus",id:Re.id});return}Oe&&r({type:"focus",id:Oe})}},[B,a.focusId,$,Oe,m,r,u,v,Re]),p.useEffect(()=>{if(!B||!a.focusId||Re&&a.focusId===Re.id||$.some(U=>U.id===a.focusId))return;const z=u.find(U=>U.id===a.focusId);if(z){if(Ue.current){z.kind==="op"?M(He(z)?"explore":"eval"):F!=="all"&&M("all");return}F!=="all"&&Oe&&r({type:"focus",id:Oe})}},[B,a.focusId,F,$,u,Oe,r,Re]),p.useEffect(()=>{if(!B||!a.focusId||!Ue.current)return;const z=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!z){const xe=$.findIndex(ie=>ie.id===a.focusId);if(xe>=0){const ie=Ee?"":"pt"+a.ptab;if(ie){const De=a.shown[ie]||N();xe>=De&&r({type:"more",group:ie,by:xe-De+8})}}return}Ue.current=!1;const U=Po(),V=z.getBoundingClientRect();V.top>=U-2&&V.bottom<=window.innerHeight-4||Ld(z)},[B,a.focusId,a.ptab,$,a.shown,Ee,r]),p.useEffect(()=>{if(typeof window>"u")return;const z=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),U=document.querySelector(".atl2.ops, .atl2.cibles");if(!z||!U)return;const V=()=>U.style.setProperty("--listhead-h",`${z.offsetHeight}px`);V();const ae=new ResizeObserver(V);return ae.observe(z),()=>ae.disconnect()},[R,a.dens,a.mapFolded]);const tt=p.useMemo(()=>{if(!B||!a.focusId)return null;if(j&&a.focusId===j.id)return j;const z=$.find(V=>V.id===a.focusId)||u.find(V=>V.id===a.focusId)||null;if(!z)return null;const U=Q(z);return U&&U!==z.decryptHtml?{...z,decryptHtml:U}:z},[B,a.focusId,$,u,Q,j]),jt=o.lockRowsAfter;let ot=0;const Se=(z,U)=>{let V=a.shown[U]||N();return z.length-V<=4&&(V=z.length),z.slice(0,V).map(ie=>{const De=jt!==null&&ot>=jt;ot++;const Qe=Q(ie),ye=Qe&&Qe!==ie.decryptHtml?{...ie,decryptHtml:Qe}:ie,st=!B&&a.dens!=="maxi"&&(a.dens==="deplie"||(A?A==="open":!!Qe)),Wt=w.has(ie.id)?!st:st,Rt=B?Ie=>{Ue.current=!0,r({type:"focus",id:Ie});const _e=b.get(Ie);_e&&(He(_e)?la(_e):_e.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:_e.name,url:_e.url||"",website:_e.website||"",domain:_e.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Bd,{o:ye,locked:De,selected:B&&a.focusId===ie.id,onSelect:Rt},ie.id):t.jsx(Md,{o:ye,locked:De,open:Wt,onToggle:()=>I(ie.id),selected:B&&a.focusId===ie.id,echo:H===ie.id,fresh:be.has((ie.name||"").trim().toLowerCase()),onSelect:Rt},ie.id)})},gt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(v==="ops"?" opsl":"")+($.length?"":" list-empty"),Me=t.jsxs(t.Fragment,{children:[Ee?Ee.map(([z,U])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:At(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:z==="ma"?n.grpMa:z==="fundraising"?n.grpLev:ka.has(z)&&Ft<=1?n.grpNews:z==="nominations"?n.grpNom:z==="media"?n.grpNewsOther:z==="recrutements"?n.grpHire:ka.has(z)?n.grpNews+" · "+Ye(z,g):Ye(z,g)}),t.jsx("div",{className:"s",children:n.grpCount(U.filter(V=>!Be(V)).length,U.length)})]})]}),Se(U,z)]},z)):Se($,"pt"+a.ptab),h.loading&&!u.length&&t.jsx(_d,{}),!$.length&&!(h.loading&&!u.length)&&(o.pipe&&F==="all"?t.jsx($d,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),ut=t.jsxs(t.Fragment,{children:[!pe&&!x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+aa[a.ptab]+")"},children:$.length})," ",ve]}),x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+aa[a.ptab]+")"},children:$.length})," ",n.newsWord]}),(!pe||x)&&t.jsx("span",{className:"dot",children:"·"}),R&&t.jsx(Ro,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[R?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),Te.map(z=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:U=>{U.stopPropagation(),z.off()},children:[z.lib,t.jsx("i",{children:"×"})]},z.k)),v==="ops"&&$.length>0&&!R&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",$.length-Ne," ",n.zoomPulseEval,Ne>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",Ne," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),mt=t.jsxs("div",{className:"listhead"+(R?" mapoff":""),children:[R&&t.jsx("div",{className:"lh-tools",children:t.jsx(Fo,{compact:!0})}),o.showFunnel&&he&&ce&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(ol,{}),t.jsx(Td,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:ut}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(zd,{}),t.jsx(Ad,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ce?" on":""),"aria-pressed":ce,title:n.morningDockTitle,onClick:()=>{if(ce){r({type:"filters",patch:{win:"all",day:""}}),ee(!1);return}je(!1),q(!1),M("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),ee(!0)},children:["📊 ",n.morningDock(typeof((Et=h.stats)==null?void 0:Et.screened_today)=="number"?h.stats.screened_today:0)]}),te&&!te.firstVisit&&(te.added.length>0||te.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(pe?" on":""),"aria-pressed":pe,title:n.sinceSub,onClick:()=>{const z=!pe;je(z),q(!1),ee(!1),M("all"),z&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(le),te!=null&&te.lastDate?` · ${n.sinceSince(te.lastDate)}`:""]}),fe>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{je(!1),q(!1),ee(!1),M("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(fe)]}),o.pipe&&oe>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(x?" on":""),"aria-pressed":x,title:n.newsDockHint,onClick:()=>{const z=!x;q(z),je(!1),ee(!1),M("all"),z&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(oe),ue.since?` · ${n.newsSince(ue.since)}`:""]})]}),!o.showFunnel&&ut,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||v==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,U])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:U})]},z))}),!B&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":A==="open",onClick:()=>{C("open"),E(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":A==="closed",onClick:()=>{C("closed"),E(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||v==="ops")&&(()=>{var Qe;const z={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},U=u.filter(ye=>na(ye,z,o.pipe)&&!Ve(ye)),V=U.filter(ye=>!He(ye)&&!ye.noCo&&(ye.kind==="op"||!Be(ye))).length,ae=U.filter(He).length,xe=o.pipe?U.filter(ye=>ye.kind!=="op"&&Ae(ye)===1).length:0,ie=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${xe?` ${xe}`:""}`]]:[],["eval",`${n.doEval}${V?` ${V}`:""}`],["explore",`${n.doExplore}${ae?` ${ae}`:""}`]],De=((Qe=ie.find(([ye])=>ye===F))==null?void 0:Qe[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":_,onClick:()=>D(ye=>!ye),children:[De,t.jsx("i",{children:"▾"})]}),_&&t.jsx("div",{className:"dolist",children:ie.map(([ye,st])=>t.jsx("button",{type:"button","aria-pressed":F===ye,onClick:()=>{if(D(!1),ye==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}M(ye),ye!=="all"&&(je(!1),q(!1),ee(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:st},ye))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([z,U])=>t.jsx("option",{value:z,children:U},z))})]}),o.showChain&&we.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:we.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(we.length):n.chainAll(we.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!B&&mt,a.dens!=="maxi"&&!B&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),me("country",n.colCountry),me("name",n.colCompany),me("amount",n.colAmount,"h-amt",!0),me("stage",n.colStage,"h-stade"),me("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[me("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),me("memo",n.colMemo)]}),o.pipe&&me("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),B?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[mt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),me("country",n.colCountry),me("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[me("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),me("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:gt,children:Me})]}),t.jsxs("aside",{className:"readpane"+((tt?Ve(tt):!m&&Re)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[Re&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===Re.id,onClick:()=>r({type:"focus",id:Re.id}),children:n.doEdito}),j&&a.focusId===j.id?t.jsx("div",{className:"zoom",children:t.jsx(Hs,{})}):tt&&o.pipe?t.jsx(Id,{o:tt}):t.jsx(Bo,{o:tt,extra:tt?null:m})]})]}):t.jsx("div",{className:gt,children:Me}),(()=>{const z=Ee||[["pt"+a.ptab,$]];let U=0,V=0;for(const[xe,ie]of z){V+=ie.length;let De=a.shown[xe]||N();ie.length-De<=4&&(De=ie.length),U+=Math.min(ie.length,De)}const ae=V-U;return ae<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([xe,ie])=>r({type:"more",group:xe,by:ie.length,base:N()})),children:[t.jsx("span",{className:"more-label",children:n.more(ae,ae)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(U,V)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}}),B&&v==="ops"&&a.dens!=="maxi"&&t.jsx(qd,{on:!!Ee,rev:(Ee||[]).map(([z,U])=>z+U.length).join("|")})]})}function Gr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Hd(e,a){const r=Pi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Vd(e,a){const n=[a.head.split("|").map(Gr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",Hd(o,a.plabels),da(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Gr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Wd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Gd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function dt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Yd({o:e,qa:a}){const{t:r,lang:n,fund:o}=Y(),i=(e.cribleStatus||"").trim().toUpperCase()||(da(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=kt(e),l=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(dt,{k:r.cdSector,v:e.sector}),t.jsx(dt,{k:r.cdStage,v:e.stage}),t.jsx(dt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(dt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(dt,{k:r.cdName,v:e.contactName}),t.jsx(dt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(dt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(dt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(dt,{k:r.cdAngle,v:e.angle}),t.jsx(dt,{k:r.cdDetected,v:Gd(e.date,n)})]}),c.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,g])=>g).map(([g,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:d})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Kd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:s}=Y(),[l,c]=p.useState({}),g=25,d=p.useMemo(()=>n.slice(0,g),[n]);p.useEffect(()=>{d.length&&ao(r,d.map(v=>v.name)).then(c)},[r,d]);const h=i.stats,u=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),h&&typeof h.screened=="number"&&t.jsxs("p",{children:[u(h.screened)," ",e.funScreened(""),typeof h.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(h.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(h.screened/i.marketEstimate*100)," %"]})]})]}),d.map(v=>t.jsx(Yd,{o:v,qa:l[v.name]},v.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Qd=50;function In({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Y(),[i,s]=p.useState(null),[l,c]=p.useState(!1),[g,d]=p.useState(""),[h,u]=p.useState(0),[v,m]=p.useState(""),[b,y]=p.useState(!1),[f,j]=p.useState(0),N=p.useRef(null),w=p.useRef(null),E=()=>{j(0),w.current&&window.clearInterval(w.current),w.current=window.setInterval(()=>j(T=>T+1),1e3)},A=()=>{w.current&&(window.clearInterval(w.current),w.current=null)};p.useEffect(()=>()=>{N.current&&window.clearInterval(N.current),w.current&&window.clearInterval(w.current)},[]);const C=async T=>{c(!0),d(""),E();const R=await a();if(c(!1),A(),R.ok){s(R);return}if(R.busy){d(o.alertPreviewBusy);return}if(!T){d(o.alertPreviewFail);return}u(Qd),A(),N.current=window.setInterval(()=>{u(I=>I>1?I-1:(N.current&&window.clearInterval(N.current),C(!1),0))},1e3)},L=async()=>{if(n||b||l)return;y(!0),m(""),E();const T=await r();y(!1),A(),m(T.ok?o.alertTestOk(T.sentTo||""):T.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||b||h>0,onClick:()=>{C(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b||l,onClick:()=>{L()},children:b?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),b&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),h>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(h)}),g&&t.jsx("p",{className:"mnote warn",children:g}),v&&t.jsx("p",{className:"mnote",children:v}),!v&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const It="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function We({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=Y();return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Jd(){const{st:e}=Y();switch(e.modal){case"chain":return t.jsx(Zd,{});case"space":return t.jsx(ec,{});case"alert":return t.jsx(tc,{});case"queue":return t.jsx(ic,{});case"export":return t.jsx(sc,{});case"plug":return t.jsx(cc,{});case"recharge":return t.jsx(uc,{});case"cover":return t.jsx(fc,{});case"dossier":return t.jsx(mc,{});case"crit":return t.jsx(hc,{});case"tuto":return t.jsx(xc,{});case"rdv":return t.jsx(Xd,{});case"memoalert":return t.jsx(lc,{});default:return null}}function Xd(){const{dispatch:e,fund:a,t:r}=Y(),n=a||r.rdvCoFallback;return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:po,children:qn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Ta}`,children:Ta})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],s)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(s+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(ds,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function Zd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:s,evalBusy:l,caps:c,memoQueued:g,doAnalyse:d}=Y(),h=i==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),v=e.chain.idx,m=u[v],b=v>=u.length;return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${v+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:v/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Ht(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(xt(m.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ye(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Vt(m.amountEur,o)})]}),Pe(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(wt,{o:m,lg:!0})," ",t.jsx(Ba,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(h&&Be(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),h&&Be(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":zt(m)==="retenu"?"var(--brand)":zt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:zt(m)==="retenu"?"✓ "+n.kept:zt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&m&&c.pipe&&Ae(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&m&&!(h&&Be(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{s(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function ec(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Y(),i=o==="client",s=p.useMemo(()=>i?r.filter(h=>Be(h)):[],[r,i]),l=p.useMemo(()=>An(s.filter(h=>zt(h)==="retenu"),{key:"signal",dir:-1}),[s]),c=p.useMemo(()=>s.filter(h=>zt(h)==="ecarte"),[s]),g=e.spaceTab==="retenu"?l:c,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(We,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(h=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof h.score=="number"&&h.score>0?h.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:h.name}),t.jsx("div",{className:"rr",children:h.reasoning||h.tagline||""})]})]},h.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function tc(){const{mode:e}=Y();return e==="client"||e==="apercu"?t.jsx(ac,{}):t.jsx(oc,{})}function ac(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Y(),[i,s]=p.useState("d"),l=o!=="client";return t.jsxs(We,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(nc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(rc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(_o,{})]})}function nc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=p.useState(null),[l,c]=p.useState(!1),[g,d]=p.useState(0);p.useEffect(()=>{let L=!0;return c(!1),Xn(a).then(T=>{L&&(T?s(T):c(!0))}),()=>{L=!1}},[a,g]);const h=p.useRef({}),[u,v]=p.useState({}),[m,b]=p.useState(!1),[y,f]=p.useState(!1),j=p.useRef(null);p.useEffect(()=>()=>{j.current&&window.clearTimeout(j.current)},[]);const N=L=>{const T=h.current;Object.keys(T).length&&(b(!0),Xn(a,T).then(R=>{if(!R){b(!1),o(e.actErr);return}if(R.throttled&&L<3){j.current=window.setTimeout(()=>N(L+1),5400);return}if(h.current={},v({}),s(R),b(!1),R.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},w=L=>{r||(h.current={...h.current,...L},v(T=>({...T,...L})),j.current&&window.clearTimeout(j.current),j.current=window.setTimeout(()=>N(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const E={...i,...u},A=L=>!E.sections||E.sections.includes(L),C=L=>{const T=E.sections||e.alertSec.map(([R])=>R);w({sections:A(L)?T.filter(R=>R!==L):[...T,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":E.enabled===!0,disabled:r,style:E.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!E.enabled}),children:E.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>w({hour:Math.max(6,(E.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[E.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>w({hour:Math.min(21,(E.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,T])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:A(L),disabled:r,onChange:()=>C(L)}),t.jsxs("span",{children:[T,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(In,{label:e.alertPreview,readOnly:r,onPreview:()=>Ki(a),onTest:()=>Yi(a)}),E.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),E.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",E.email_lead,E.last_sent?` · ${e.updatedAt(E.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function rc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=p.useState(null),[l,c]=p.useState(!1),[g,d]=p.useState(0);p.useEffect(()=>{let m=!0;return c(!1),Zn(a).then(b=>{m&&(b?s(b):c(!0))}),()=>{m=!1}},[a,g]);const h=m=>{r||Zn(a,m).then(b=>{if(!b){o(e.actErr);return}s(b),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,v=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>h({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>h({dow:Number(m.target.value)}),children:e.alertDow.map((m,b)=>t.jsx("option",{value:b,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[v," h"]}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.min(21,v+1)}),disabled:r,children:"+"})]})]}),t.jsx(In,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Ji(a),onTest:()=>Qi(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function _o(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Y(),[s,l]=p.useState(i||""),[c,g]=p.useState(!1),[d,h]=p.useState(!1);p.useEffect(()=>{i&&l(i)},[i]);const u=e.filters,v=p.useMemo(()=>n.filter(f=>Pe(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(s)||d)){h(!0);try{await fetch(`${Pa}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{h(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Ye(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>Ht(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function oc(){const{t:e}=Y();return t.jsx(We,{title:e.alertTitle,icon:"🔔",children:t.jsx(_o,{})})}function ic(){var I,B;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:s,caps:l,dispatch:c,liveMemos:g}=Y(),[d,h]=p.useState(()=>Ua(r)),[u,v]=p.useState(()=>!Ua(r)),[m,b]=p.useState([]),[y,f]=p.useState(0),j=n==="client",N=p.useMemo(()=>{const F=new Map;return o.forEach(M=>{const x=(M.name||"").trim().toLowerCase();x&&!F.has(x)&&F.set(x,M)}),F},[o]);p.useEffect(()=>{let F=!0;return(!Ua(r)||y>0)&&v(!0),(async()=>{const[M,x]=await Promise.all([Cn(r,y>0),Zr(a)]);F&&(M&&h(M),v(!1),b(x))})(),()=>{F=!1}},[a,r,y]);const w=u&&!d,E=(d==null?void 0:d.per_day)??0,A=((I=d==null?void 0:d.analyzed_today)==null?void 0:I.length)??0,C=d==null?void 0:d.offre,L=(d==null?void 0:d.pool_meta)||[],T=p.useMemo(()=>{const F=new Map;for(const M of(d==null?void 0:d.scheduled)||[])for(const x of M.names||[])F.has(x)||F.set(x,{label:M.day_label,date:M.date});return F},[d==null?void 0:d.scheduled]),R=(d==null?void 0:d.in_progress)||[];return t.jsxs(We,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:w?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(A,A+(((B=d==null?void 0:d.pool_order)==null?void 0:B.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!w&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(E)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(R.length>0||g.items.some(F=>F.status==="boot"||F.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(F=>F.status==="boot"||F.status==="running"||F.status==="error").map(F=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:F.name}),t.jsx("span",{className:"qd",children:F.memoType||""}),t.jsx(Sa,{item:F,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+F.name)),R.filter(F=>!g.liveOf(F.name)).map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.name}),t.jsxs("span",{className:"qd",children:[F.memo_type||"",F.age_min?` · ${Math.round(F.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:F.state||""})]},"ip-"+F.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.company}),t.jsxs("span",{className:"qd",children:[F.memo_type,typeof F.est_min=="number"?` · ~${F.est_min} min`:""]}),t.jsx("span",{className:"qt",children:F.status}),F.url&&t.jsx("a",{className:"qgo",href:F.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(F.memo_type)}),j&&F.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Jn(a,F.company,"retry").then(()=>f(M=>M+1))},children:e.queueRetry}),j&&F.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Jn(a,F.company,"delete").then(()=>f(M=>M+1))},children:e.queueDelete})]},F.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",w?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[w&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!w&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((F,M)=>{const x=T.get(F.name),q=N.get((F.name||"").trim().toLowerCase()),H=g.liveOf(F.name),J=!!(q&&s.has(q.id))||!!(H&&(H.status==="boot"||H.status==="running")),_=!!(q&&Ae(q)===1&&!q.memoUrl)&&!H;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",M+1]}),x?t.jsx("span",{className:"qwhen"+(x.label==="demain"?" soon":""),children:x.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:F.name}),F.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof F.score=="number"&&t.jsx("span",{className:"qs2",children:F.score}),H&&(H.status==="boot"||H.status==="running")&&t.jsx(Sa,{item:H,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),_&&(l.lockActions||!j?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:J,onClick:()=>{i(q),f(D=>D+1)},children:J?e.actAnalyseQueued:e.actAnalyse})),F.excerpt&&t.jsx("span",{className:"qex",children:F.excerpt})]},F.name+":"+M)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([F,M])=>t.jsxs("li",{children:[t.jsx("b",{children:F})," — ",M]},F))})]})}function sc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:s}=Y(),l=`${It}/cibles/list.csv?token=${a}`,c=`${It}/cibles/list.json?token=${a}`,g=`${It}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${l}")`,h=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:d},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:g,href:g}],v=!o.lockActions&&n.length>0,m=()=>{Wd(Vd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(We,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:f,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>h(f),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function lc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Y(),i=o!=="client",[s,l]=p.useState(null),[c,g]=p.useState(!1),[d,h]=p.useState(0),[u,v]=p.useState(!1);p.useEffect(()=>{let f=!0;return g(!1),Qn(a).then(j=>{f&&(j?l(j):g(!0))}),()=>{f=!1}},[a,d]);const m=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=f=>{if(i||!s)return;const j={enabled:f.enabled??!!s.enabled,email:f.email??(s.email||""),sections:f.sections??m()};v(!0),Qn(a,j).then(N=>{if(v(!1),!N){n(e.memoAlertErr);return}l(N),r(e.memoAlertSaved)})};if(c)return t.jsx(We,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>h(f=>f+1),children:e.retry})]})});if(!s)return t.jsx(We,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs(We,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:i||u,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(dc,{value:s.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>b({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:i||u,onChange:()=>b({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:j})]},f))}),t.jsx(In,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>_i(a,y),onTest:()=>Bi(a,y)})]})}function dc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,s]=p.useState(e);p.useEffect(()=>{s(e)},[e]);const l=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>s(g.target.value),onKeyDown:g=>{g.key==="Enter"&&l&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!c,onClick:()=>o(i.trim()),children:n})]})]})}function cc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Y(),[i,s]=p.useState(null),[l,c]=p.useState(!1),[g,d]=p.useState(null),[h,u]=p.useState(""),[v,m]=p.useState(0);p.useEffect(()=>{let N=!0;return c(!1),dn(a).then(w=>{N&&(w?s({configured:w.configured,url_hint:w.url_hint}):c(!0))}),Hi(a).then(w=>{N&&d(w)}),()=>{N=!1}},[a,v]);const b=(N,w)=>{o&&dn(a,N).then(E=>{if(!E||E.ok===!1){n(e.actErr);return}N.test&&E.sent===!1?n(e.plugTestThrottled):r(w),m(A=>A+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',f=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${It}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(We,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(N=>N+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:h,disabled:!o,onChange:N=>u(N.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!h.trim(),onClick:()=>b({url:h.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:f}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(f).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(pc,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function pc(){const{t:e,token:a,lang:r}=Y(),[n,o]=p.useState("valides"),[i,s]=p.useState(!1),[l,c]=p.useState(null),[g,d]=p.useState(null),[h,u]=p.useState(!1),[v,m]=p.useState(!1),[b,y]=p.useState(null),[f,j]=p.useState(null),[N,w]=p.useState(null),E=`atl2:bulk:${a}:${n}`;p.useEffect(()=>{dn(a).then(B=>{j(B&&B.configured?B.url_hint||"webhook":null)})},[a]),p.useEffect(()=>{c(null),d(null),u(!1),y(null);try{const B=JSON.parse(localStorage.getItem(E)||"null");w(B&&Date.now()-Date.parse(B.t)<24*3600*1e3?B:null)}catch{w(null)}},[E]);const A=async()=>{s(!0),u(!1),y(null);const B=await Wi(a,n);c(B),d(B.ok?n:null),s(!1)},C=p.useRef(!1),L=async()=>{if(C.current)return;C.current=!0,m(!0);const B=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let F;try{F=await Gi(a,n,"webhook",void 0,B)}finally{C.current=!1}if(m(!1),u(!1),y(F),F.ok&&(F.pushed||0)>0){const M={t:new Date().toISOString(),n:F.pushed||0};w(M);try{localStorage.setItem(E,JSON.stringify(M))}catch{}}},T=l!=null&&l.ok&&l.ready||0,R=!!(l!=null&&l.ok)&&g===n&&T>0&&!!f&&!N,I=N?new Date(N.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:B=>o(B.target.value),children:e.plugBulkTabs.map(([B,F])=>t.jsx("option",{value:B,children:F},B))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{A()},children:i?"…":e.plugBulkPreview})]}),l&&(l.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(l.ready||0,l.linkedinReady||0,(l.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(l!=null&&l.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),N&&t.jsx("p",{className:"mnote",children:e.bulkLocked(I,N.n)}),!N&&!!(l!=null&&l.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!N&&!l&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),R&&!h&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),R&&h&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(T,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{L()},children:v?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function uc(){const{t:e,data:a,lang:r}=Y(),n=a.credits,o=a.email,i=async s=>{if(!o)return;const l=window.location.href.split("?")[0];try{const g=await(await fetch(`${Pa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:s,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(We,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function mc(){const{t:e}=Y();return t.jsx(We,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Kd,{})})}function fc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:s,flash:l}=Y(),[c,g]=p.useState(null),[d,h]=p.useState(!1);p.useEffect(()=>{let T=!0;if(i)return Cn(i).then(R=>{T&&R&&typeof R.per_day=="number"&&g(R.per_day)}),()=>{T=!1}},[i]);const[u,v]=p.useState(null);p.useEffect(()=>{if(!o)return;let T=!0;return Ui(o).then(R=>{T&&v(R)}),()=>{T=!1}},[o]);const m=r.stats,b=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(T=>T.kind==="target"&&Be(T)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(b/y*100)):null,j=(m==null?void 0:m.window_days)||30,N=b>0?b/j:0,w=y>0?Math.max(0,y-b):0,A=y>0&&N>0&&b>=100?Math.round(w/N):null,C=T=>Math.round(T).toLocaleString(a==="en"?"en-US":"fr-FR"),L=T=>{d||!s||(h(!0),Vi(o,T).then(R=>{if(h(!1),R===null){l(e.actErr);return}g(R),l(e.alertSaved)}))};return t.jsxs(We,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(b))}),y>0&&t.jsx("span",{children:e.covOf(C(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),A!==null&&t.jsx("p",{className:"mnote",children:e.covEta(A)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),N>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(N))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((T,R)=>t.jsxs("tr",{className:T.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[T.code,T.geo?` · ${T.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof T.n=="number"?C(T.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:T.source}),T.elargi&&t.jsx("em",{children:e.covWide(String(T.demande||""))}),T.erreur&&t.jsx("em",{children:e.covMissing})]})]},R)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(u.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),s&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(T=>t.jsx("button",{type:"button",className:c===T?"on":"",disabled:d,onClick:()=>L(T),children:T===0?"⏸":T},T))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function hc(){var f,j,N;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:s,lang:l}=Y(),c=n==="client",g=p.useMemo(()=>{const w=new Set;return a.forEach(E=>{E.angle&&w.add(E.angle)}),[...w]},[a]),[d,h]=p.useState(""),[u,v]=p.useState(""),[m,b]=p.useState(!1),y=async()=>{const w=d.trim();if(!(!w||m||!c)){b(!0),v("");try{const A=await(await fetch(`${It}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&v(String(A.reply)),A.job_id){v(e.critChatRunning);const C=async()=>{const L=await fetch(`${It}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(T=>T.json()).catch(()=>null);if(L&&L.done){v(String(L.reply||L.clarification||L.summary||"✓")),b(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),h("");return}h("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(We,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=i==null?void 0:i.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var E,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((E=w.look)!=null&&E.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((A=w.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},w.title)})]}),!!((N=i==null?void 0:i.gate)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||m,onChange:w=>h(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!d.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx($i,{fund:s,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Io[w]||"v-cons"),children:w}),t.jsx("span",{children:E})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",E]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function xc(){const{t:e,dispatch:a,startTour:r}=Y(),n=o=>{var i,s;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs(We,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+s))})]})}const $o="atl2:mapfold",gc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem($o);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},bc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Uo=p.createContext(null),Y=()=>{const e=p.useContext(Uo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function wt({o:e,lg:a}){const{lang:r}=Y(),n=Pe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:er(n,r),children:[n.emoji," ",er(n,r)]}):null}function Ba({o:e,src:a}){const{lang:r,t:n}=Y(),o=Pe(e);if(!o)return null;const i=ns(o),s=rs(o);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(no(o,r))+" · "+n.win7(ro(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function vc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(s=>(s.url||"")===n);if(i)return i}const o=$e(a);if(o)return e.find(i=>$e(i.name)===o)||e.find(i=>{const s=$e(i.name);return s.length>=3&&(o.includes(s)||s.includes(o))})}function yc(){const{scoped:e,t:a,st:r,dispatch:n}=Y(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,s=e.filter(h=>!Ve(h)),l=s.length,c=s.filter(h=>!h.noCo).length,g=s.filter(h=>!!h.noCo).length,d=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:d?"7":"all"}});else{const h=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:h,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function wc(){const{t:e,lang:a,data:r,dispatch:n}=Y(),o=r.stats,i=l=>l.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const s=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:s>0?e.covOf(i(s)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function Ho({o:e}){const{lang:a}=Y(),r=as(e.cc),n=e.cc?Ht(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Yr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",kc=!1;function jc(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Vo=e=>`atl2:tour:${e||"anon"}`;function Nc(e){try{return localStorage.getItem(Vo(e))==="1"}catch{return!0}}function Kr(e){try{localStorage.setItem(Vo(e),"1")}catch{}}function Ec(e,a,r,n,o,i){const s=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Tc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Mt;const{lang:s}=Xi(),l=ks[s],c=Rs(e,s,a),[g,d]=p.useReducer(Ds,void 0,()=>Ms((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?bc():gc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),h=p.useRef(!0);p.useEffect(()=>{if(h.current){h.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem($o,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const S=()=>{window.innerWidth<=760&&d({type:"mapFold",folded:!0})};return S(),window.addEventListener("resize",S),()=>window.removeEventListener("resize",S)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var S;(S=u.current)==null||S.call(u,g.filters)},[g.filters]);const[v,m]=p.useState(()=>{if(typeof window>"u")return"both";try{const S=localStorage.getItem("atl2:chrome-mode");if(S==="eval"||S==="filt"||S==="both")return S;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[b,y]=p.useState(null),[f,j]=p.useState(null),[N,w]=p.useState(null),[E,A]=p.useState({kept:0,dropped:0}),[C,L]=p.useState(!1),[T,R]=p.useState(""),[I,B]=p.useState(!1),[F,M]=p.useState(null),[x,q]=p.useState(!1),[H,J]=p.useState(!1),[,_]=p.useState(0),D=()=>_(S=>S+1),K=p.useRef([]),W=p.useRef(new Set),Q=p.useRef(new Set),[te,he]=p.useState([]),[ee,ce]=p.useState([]),[pe,je]=p.useState(0),be=p.useRef(new Map),le=p.useRef(null),{mode:ue}=c,oe=p.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),$=oe.pipe,ne=c.session.token||"",fe=ue==="client"&&!e;p.useEffect(()=>{if(!ne||!$)return;let S=!0;const G=async()=>{const P=await os(ne);!S||!P||(ce(P.runs),je(Date.now()/1e3-P.now),he(X=>X.filter(Z=>!P.runs.some(se=>$e(se.company)===$e(Z.name)))))};G();const k=te.length>0||ee.some(P=>P.status==="running"),O=window.setInterval(()=>{G()},k?8e3:25e3);return()=>{S=!1,window.clearInterval(O)}},[ne,$,te.length,ee.some(S=>S.status==="running")]);const we=p.useMemo(()=>{const S=[],G=new Set;for(const k of te){const O=$e(k.name);!O||G.has(O)||(G.add(O),S.push({name:k.name,id:k.id,status:"boot",started:k.started,estMin:k.estMin,memoType:"instant"}))}for(const k of ee){const O=$e(k.company);if(!O||G.has(O))continue;G.add(O);const P=k.status==="error"?"error":k.status==="done"?"done":"running";S.push({name:k.company,status:P,started:k.started||0,estMin:k.est_min||(k.memo_type==="detailed"?40:15),url:k.url,error:k.error,memoType:k.memo_type,note:k.note})}return S},[te,ee]),Ne=S=>we.find(G=>$e(G.name)===$e(S))||null,ve=(S,G)=>{he(k=>k.some(O=>$e(O.name)===$e(S.name))?k:[...k,{name:S.name,id:S.id,started:Date.now()/1e3,estMin:G==="detailed"?40:15}]),W.current.add(S.id),D()};p.useEffect(()=>{if(document.querySelector(`link[href="${Yr}"]`))return;const S=document.createElement("link");S.rel="stylesheet",S.href=Yr,document.head.appendChild(S)},[]);const re=(S,G=!1)=>{R(S),B(G),le.current&&clearTimeout(le.current),le.current=setTimeout(()=>R(""),G?4200:2400)},Te=S=>re(S,!0),Ke=p.useMemo(()=>{const S=new Map;return c.dossiers.forEach(G=>{G.id&&S.set(G.id,G)}),S},[c.dossiers]),me=p.useMemo(()=>c.dossiers.filter(S=>na(S,g,$)),[c.dossiers,g,$]),Ee=p.useRef(!1);p.useEffect(()=>{if(Ee.current||e||c.loading||!c.dossiers.length)return;if(!oe.showFunnel||Nc(c.session.token||"")){Ee.current=!0;return}Ee.current=!0;const S=window.setTimeout(()=>{Kr(c.session.token||""),q(!0)},700);return()=>window.clearTimeout(S)},[e,c.loading,c.dossiers.length,oe.showFunnel,c.session.token]);const Ft=p.useMemo(()=>c.dossiers.filter(S=>Is(S,g,$,c.favIds)),[c.dossiers,g,$,c.favIds]),Oe=p.useMemo(()=>Zi(me.filter(S=>!He(S)),c.favIds),[me,c.favIds]),Ue=p.useRef(!1);p.useEffect(()=>{if(Ue.current)return;if(!$||a==="ops"){Ue.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Ue.current=!0;return}if(c.loading)return;Ue.current=!0;const S=es(Oe);S!==g.ptab&&d({type:"ptab",tab:S})},[$,a,n==null?void 0:n.ptab,c.loading,Oe,g.ptab]);const Re=p.useMemo(()=>{const S=mo(c.dossiers);return S?xt(S)===0?l.tourToday:fo(S,s):l.tourNoRun},[c.dossiers,l,s]),tt=p.useMemo(()=>c.dossiers.some(S=>!!S.memoUrl||!!S.summary||Pt(S)),[c.dossiers]),[jt,ot]=p.useState(!1);p.useEffect(()=>{if(c.loading){ot(!1);return}if(c.dossiers.length>0||c.error){ot(!0);return}const S=window.setTimeout(()=>ot(!0),6e3);return()=>window.clearTimeout(S)},[c.loading,c.dossiers.length,c.error]);const Se=(c.marketEstimate||0)>0||typeof((Mt=c.stats)==null?void 0:Mt.screened)=="number"&&c.stats.screened>0,gt=p.useMemo(()=>[1,0,2,4,5,3].find(S=>(Oe[S]||0)>0)??0,[Oe]),Me=zn.find(S=>S.key===g.continent),ut=g.continent==="monde"?l.contWorld:(s==="fr"?Me==null?void 0:Me.fr:Me==null?void 0:Me.en)||"";p.useEffect(()=>{const S=G=>{var O;const k=(((O=G.detail)==null?void 0:O.name)||"").trim();k&&mt(null,k)};return window.addEventListener("ppmap:evaluate",S),()=>window.removeEventListener("ppmap:evaluate",S)}),p.useEffect(()=>{const S=G=>{const k=G.detail||{},O=String(k.id||"").trim(),P=String(k.name||"").trim(),X=String(k.url||"").trim(),Z=O&&Ke.get(O)||vc(c.dossiers,P,X);if(Z){if(j(null),na(Z,g,$)||(g.continent!=="monde"&&Z.continent!==g.continent&&d({type:"continent",key:Z.continent||"monde"}),d({type:"reset"})),$&&Z.kind!=="op"){const ge=Ae(Z);typeof ge=="number"&&ge!==g.ptab&&d({type:"ptab",tab:ge})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),d({type:"focus",id:Z.id}),(Z.noCo||["media","nominations","recrutements"].includes(Z.engine||""))&&(Z.url||Z.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Z.url||"",text:[Z.headline,Z.tagline].filter(Boolean).join(`
`)}})):Z.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Z.name,url:Z.url||"",website:Z.website||"",domain:Z.domain||""}}));return}!P&&!X||(d({type:"focus",id:O||null}),j({name:P,headline:String(k.text||"").trim()||P,url:X,card:k.card}),X&&(Ca(P)||!P)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:X,text:String(k.text||"").trim()}})):P&&!Ca(P)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:P}})))};return window.addEventListener("ppmap:focus",S),()=>window.removeEventListener("ppmap:focus",S)}),p.useEffect(()=>{const S=O=>{const P={},X=String((O==null?void 0:O.sector)||"").trim();X&&(P.sector=[X]);const Z=String((O==null?void 0:O.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Z)&&(P.day=Z);const se=String((O==null?void 0:O.search)||"").trim();se&&(P.search=se);const ge=String((O==null?void 0:O.dealKind)||"").trim();(ge==="ma"||ge==="levee"||ge==="other")&&(P.dealKind=[ge]),Object.keys(P).length&&d({type:"filters",patch:P})},G=O=>S(O.detail),k=O=>{O.data&&O.data.type==="pp-filter"&&S(O.data)};return window.addEventListener("ppmap:filter",G),window.addEventListener("message",k),()=>{window.removeEventListener("ppmap:filter",G),window.removeEventListener("message",k)}},[]),p.useEffect(()=>{const S=G=>{var P;const k=(((P=G.detail)==null?void 0:P.name)||"").trim().toLowerCase();if(!k)return;const O=c.dossiers.find(X=>(X.name||"").trim().toLowerCase()===k);O&&d(a==="ops"?{type:"focus",id:O.id}:{type:"popup",id:O.id})};return window.addEventListener("ppmap:similar",S),()=>window.removeEventListener("ppmap:similar",S)});const mt=(S,G,k)=>{const O=(k||(S==null?void 0:S.name)||G||"").trim();if(!fe){w({kicker:O});return}!O||C||(L(!0),(async()=>{try{let P=(G||O).trim();const X=((S==null?void 0:S.website)||(S==null?void 0:S.domain)||"").trim();if(!(/^https?:\/\//i.test(P)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(P)&&!/\s/.test(P)))if(X)P=X;else try{const Ce=await sn(O);if(Ce!=null&&Ce.website)P=Ce.website;else if(((Ce==null?void 0:Ce.candidates)||[]).length===1)P=Ce.candidates[0].url;else if(((Ce==null?void 0:Ce.candidates)||[]).length>1){K.current=[{name:O,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(Ce.candidates||[]).slice(0,5)},...K.current].slice(0,8),D();return}}catch{}const se=await to(ne,P,"atelier2"),ge={name:se.company||O,verdict:se.verdict,reason:se.reason||"",remaining:se.remaining??null};K.current=[ge,...K.current].slice(0,8),se.verdict==="kept"&&A(Ce=>({...Ce,kept:Ce.kept+1})),se.verdict==="ruled_out"&&A(Ce=>({...Ce,dropped:Ce.dropped+1}));const qe=S||c.dossiers.find(Ce=>(Ce.name||"").toLowerCase()===O.toLowerCase());qe&&(se.verdict==="kept"?qe.verdict=qe.verdict||"MATCH":se.verdict==="ruled_out"&&(qe.verdict="NO MATCH"),se.reason&&(qe.reasoning=se.reason)),D()}finally{L(!1)}})())},Nt=S=>{if(!fe){w({kicker:S.name});return}ve(S,"instant"),Yt(ne,"fast_request",S.name||"",""),re(l.memoInstantSent(S.name))},bt=S=>be.current.get(S.id)??c.thumbs.get((S.name||"").trim().toLowerCase()),vt=(S,G)=>d({type:"undoPush",entry:{id:S.id,name:S.name,prevCeoStatus:G}}),it=async(S,G,k)=>{const O=S.ceoStatus||"";S.ceoStatus=G,D();const P=await Ha(ne,{status:G,airtable_id:S.airtableId,check_id:S.checkId,company:S.name,...(k==null?void 0:k.note)!==void 0?{note:k.note}:{},...k!=null&&k.via?{via:k.via}:{}});return P.ok?P.skipped?(S.ceoStatus=O,D(),Te(l.actNotPersisted),!1):((k==null?void 0:k.undo)!==!1&&vt(S,O),k!=null&&k.msg&&re(k.msg),(G==="Validé"||G==="Écarté")&&!S.ceoNote&&(k==null?void 0:k.note)===void 0&&M({o:S,yes:G==="Validé"}),!0):(S.ceoStatus=O,D(),Te(l.actErr),!1)},Et=async(S,G)=>{const k=await Ha(ne,{status:S.ceoStatus||"Retenu",airtable_id:S.airtableId,check_id:S.checkId,company:S.name,note:G,via:"note"});return!k.ok||k.skipped?(Te(k.skipped?l.actNotPersisted:l.actErr),!1):(S.ceoNote=G,D(),!0)},z=p.useRef(new Map),U=S=>z.current.has(S.id)?z.current.get(S.id):c.stages.get((S.name||"").trim().toLowerCase()),V=(S,G)=>{z.current.set(S.id,G),D()},ae=(S,G)=>{fe&&it(S,G?"Validé":"Écarté",{msg:G?l.decidedYes(S.name):l.decidedNo(S.name)})},xe=S=>{fe&&it(S,"À trancher",{msg:l.promoted(S.name)})},ie=S=>{fe&&(async()=>{const G=S.ceoStatus||"";S.ceoStatus="Retenu",D();const k=await Ha(ne,{status:"Retenu",check_id:S.checkId,company:S.name});if(!k.ok||k.skipped){S.ceoStatus=G,D(),Te(k.skipped?l.actNotPersisted:l.actErr);return}vt(S,G),re(l.repeched(S.name))})()},De=()=>{const S=g.undo[g.undo.length-1];if(!S){re(l.undoNone);return}const G=Ke.get(S.id);if(!G){d({type:"undoPop"}),re(l.undoNone);return}let k=S.prevCeoStatus;if(!k)if((G.verdict||"").toUpperCase().includes("CALL"))k="À trancher";else{re(l.undoLockedTitle);return}(async()=>await it(G,k,{undo:!1})&&(d({type:"undoPop"}),G.ceoStatus=S.prevCeoStatus,D(),re(l.undoDone(G.name))))()},Qe=S=>{fe&&(Q.current.add(S.id),D(),(async()=>{const G=await is(ne,S.name,"email");if(!G||G.ok===!1){Q.current.delete(S.id),D(),Te(l.actErr);return}Yt(ne,"approach",S.name||"",""),re(l.actApproachSent)})())},ye=(S,G)=>{fe&&(async()=>{if(!(await Yt(ne,G?"yes":"no",S.name||"","")).ok){Te(l.actErr);return}be.current.set(S.id,G?"yes":"no"),D(),re(G?l.thumbUpDone:l.thumbDnDone)})()},st=S=>{!fe||!Pt(S)||(ve(S,"detailed"),Yt(ne,"detailed_request",S.name||"",""),re(l.memoDeepSent(S.name)))},Wt=S=>{const G=new Set(c.favIds),k=G.has(S.id);k?G.delete(S.id):G.add(S.id),c.setFavIds(G),fe&&ss(ne,{id:S.id,co:S.name},k)},Rt=()=>{!fe||H||window.confirm(l.identSyncConfirm)&&(J(!0),(async()=>{const S=await ls(ne);J(!1),S?re(l.identSyncDone):Te(l.actErr)})())},Ie=/proplace/i.test(c.fund||""),_e=S=>{!fe||!Ie||(Yt(ne,"onboard_request",S.name||"",""),re(l.onboardSent(S.name)))},at={st:g,dispatch:d,t:l,lang:s,mode:ue,caps:oe,pipe:$,token:ne,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:ie,thumbOf:bt,canWrite:fe,commitStatus:it,saveNote:Et,stageOf:U,setStage:V,flashErr:Te,startTour:()=>q(!0),dossiers:c.dossiers,scopedAll:me,scoped:Ft,counts:Oe,byId:Ke,contName:ut,favIds:c.favIds,toggleFav:Wt,askEvaluate:mt,doAnalyse:Nt,doDecide:ae,doPromote:xe,doApproach:Qe,doThumb:ye,doDeep:st,doUndo:De,doSync:Rt,doOnboard:_e,outbound:Ie,memoQueued:W.current,liveMemos:{items:we,serverOff:pe,liveOf:Ne},approachDone:Q.current,sessTally:E,evalCards:K.current,evalBusy:C,markRow:y,markedId:b,flash:re,focusExtra:f};p.useEffect(()=>{const S=G=>{G.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",S),()=>window.removeEventListener("keydown",S)},[]);const Gt=S=>ne?t.jsx(_s,{token:ne,children:S}):t.jsx(t.Fragment,{children:S});return t.jsx(Uo.Provider,{value:at,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ne?" cibles":"")+" chrome-"+v,children:[t.jsx("style",{children:Ss}),Gt(t.jsxs("div",{className:"app"+($?" pipe":"")+(ne?" has-thesis":""),children:[oe.showTicker&&t.jsx(nt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ne?" live-stack--cibles":""),children:[t.jsx(Ys,{}),!!ne&&t.jsx($s,{})]})}),oe.showIdent&&t.jsx(nt,{name:"identite",children:t.jsx(il,{})}),!1,kc,oe.showFunnel&&t.jsx(nt,{name:"entonnoir",children:t.jsx(Sc,{})}),!g.mapFolded&&t.jsx(nt,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Ro,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(yc,{}),a!=="ops"&&oe.showFunnel&&t.jsx(wc,{}),t.jsx(rd,{}),t.jsx(Fo,{})]})]})}),oe.showDemand&&$&&t.jsx(nt,{name:"direct",children:t.jsx(ms,{items:we,serverOff:pe,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>d({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([S,G])=>t.jsx("button",{type:"button",role:"tab","aria-selected":v===S,onClick:()=>{m(S);try{localStorage.setItem("atl2:chrome-mode",S)}catch{}},children:G},S))}),oe.showDemand&&t.jsx(nt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(pd,{})})}),oe.showDemand&&g.memoConsole&&t.jsx(nt,{name:"console",children:t.jsx(md,{})}),oe.pipe&&!!ne&&t.jsx(nt,{name:"moteurs",children:t.jsx(vs,{})}),t.jsx(nt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(Ud,{})}),c.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:l.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(nt,{name:"fiche",children:t.jsx(Sd,{})}),t.jsx(nt,{name:"modales",children:t.jsx(Jd,{})}),t.jsx(Js,{}),F&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:F.o.name}),t.jsx(al,{placeholder:F.yes?l.whyYesPh:l.whyNoPh,onDone:S=>{const G=F.o;M(null),S&&Et(G,S).then(k=>{k&&re(l.csNoteSaved)})}})]}),x&&jt&&t.jsx(rl,{steps:Ec(l,Re,tt,gt,Se,Oe[3]||0),onClose:()=>{q(!1),Kr(ne)}}),t.jsx(jc,{}),oe.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:po,children:qn}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${Ta}`,children:Ta})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),T&&t.jsx("div",{className:"flash on"+(I?" err":""),children:T}),N&&t.jsx(ts,{variant:"acquirer",initialCompany:Qr().co,initialWebsite:Qr().site,onClose:()=>w(null)})]})})}function Sc(){const{t:e}=Y(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Qr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Cc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Ho as FlagCell,wt as SigBadge,Ba as SigWin,Tc as default,Cc as fmtShort,Y as useV2};
