...
· Rien ne part tout seul : vous copiez, ou vous ouvrez votre email.`,fhintGoalAt:e=>`Dernier passage des moteurs : **${e}**.
...
· Nothing goes out by itself: you copy, or you open your email.`,fhintGoalAt:e=>`Engines last ran: **${e}**.
...
.atl2 .bulk .side .hint{white-space:nowrap}`,Ps=`
...
`,Bs=Is+Ps+_s;function sn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function $s(){const e=sn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Us(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=$s();return r==="0"?"client":r==="1"||sn("embed")==="1"&&sn("chrome")==="1"?"apercu":"client"}const Hs={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Vs=e=>Hs[e];function Ea(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const St=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!eo(a)||Ea(a))&&(e.noCo=!0)}return Object.assign(e,{continent:ki(e.cc)})};function Va(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ws=60*60*1e3;function Gs(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ws?null:a}catch{return null}}function ca(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ys=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Qs(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:pi(),[e,n]),i=p.useMemo(()=>n?"visiteur":Us(e,o),[e,o,n]),d=p.useMemo(()=>Vs(i),[i]),s=i!=="visiteur",l=Ys(r),[g,c]=p.useState([]),[x,u]=p.useState(""),[b,m]=p.useState(null),[v,w]=p.useState(null),[f,y]=p.useState(null),[j,k]=p.useState(()=>new Map),[N,C]=p.useState(()=>new Map),[S,L]=p.useState(""),[q,I]=p.useState(new Set),[R,B]=p.useState(null),[F,D]=p.useState(!0),[h,A]=p.useState(!1),[$,ee]=p.useState(0),[E,O]=p.useState(0),M=p.useRef(0),V=p.useMemo(()=>{var te;if(i!=="client")return"";try{return((te=ui())==null?void 0:te.email)||""}catch{return""}},[i]);p.useEffect(()=>{const te=++M.current;let ge=!0;const J=()=>ge&&te===M.current,fe=(s&&o.token?o.token:"pub:"+a)+(l?":"+l:""),me=Gs(fe);return me?(c(me.objs.map(St)),me.fund&&u(me.fund),m(me.marketEstimate??null),w(me.criteria??null),y(me.stats??null),L(me.generatedAt||""),D(!1)):D(!0),(async()=>{try{if(r==="ops"){const xe=await Ba(),U=((xe==null?void 0:xe.recent_ops)||[]).map(W=>{const H=va(W.company_name||W.title?W:{...W,title:(W.headline_fr||W.headline||"").slice(0,120)},a),X=String(W.rubrique||"").toLowerCase();return H&&(X==="nominations"||X==="recrutements")&&(H.engine=X),H&&!String(W.company_name||"").trim()&&(H.noCo=!0),H}).filter(W=>!!W).map(W=>(eo((W.name||"").trim())||(W.noCo=!0),W));try{const W=mi(),H=await fi(),X=((H==null?void 0:H.date)||"").slice(0,10),_=W?W.doc:H,ne=hi(_),de=((W==null?void 0:W.day)||(_==null?void 0:_.date)||X||"").slice(0,10);if(de&&ne.length){const ye=new Set;for(const se of U){if((se.date||"").slice(0,10)!==de)continue;const be=$n(ne,ye,se.name,"");be>=0&&(ye.add(be),se.decryptHtml=ne[be].html)}for(const se of U){if(se.decryptHtml||(se.date||"").slice(0,10)!==de)continue;const be=$n(ne,ye,"",se.headline||se.tagline||se.name);be>=0&&(ye.add(be),se.decryptHtml=ne[be].html)}}if(de){const ye=((_==null?void 0:_.title_fr)||"").trim(),se=((_==null?void 0:_.lead_fr)||"").trim(),be=gi(_),ce=((_==null?void 0:_.url)||"").trim();ye&&(be||ce)&&U.unshift({id:`edito:${de}`,kind:"op",name:ye,cc:null,date:de,engine:"edito",dealKind:"other",headline:ye,tagline:se||ye,decryptHtml:be||void 0,url:ce,noCo:!0})}}catch{}if(!J())return;c(U.map(St)),ca(fe,{objs:U})}else if(typeof r=="object"){const U=(await Un()||[]).filter(H=>(H.slug||"")===r.research).map(H=>Hn(H,a)).filter(H=>!!H),W=Va(await Vn(U,a));if(!J())return;c(W.map(St)),ca(fe,{objs:W})}else if(s&&o.token){const xe=xi(o.token),U=Ba(),W=bi(o.token),H=vi(o.token),X=yi(o.token),_=await xe;let ne=_?_.targets:[];J()&&_&&(u(_.fund||""),m(_.marketEstimate??null),w(_.criteria??null),y(_.stats??null),L(_.generatedAt||""),c(ne.map(St)),D(!1),A(!1));const[de,ye,se,be]=await Promise.all([U,W,H,X]),ce=((de==null?void 0:de.recent_ops)||[]).map(ve=>va(ve,a)).filter(ve=>!!ve),ze=new Set(ne.map(ve=>ve.id));if(ne=[...ne,...ce.filter(ve=>!ze.has(ve.id)&&(ze.add(ve.id),!0))],!J())return;c(ne.map(St));const Ke=new Set;for(const ve of ye){const Se=(ve.id||ve.co||"").toString().trim().toLowerCase();Se&&Ke.add(Se.startsWith("t:")?Se:"t:"+Se)}I(Ke),k(se),C(be),_&&ca(fe,{fund:_.fund,marketEstimate:_.marketEstimate,criteria:_.criteria,stats:_.stats,generatedAt:_.generatedAt,objs:ne})}else{const xe=wi(),U=Un(),W=Ba(),H=await xe;J()&&H.length&&(c(Va(H).map(St)),D(!1),A(!1));const[X,_]=await Promise.all([U,W]),ne=(X||[]).map(be=>Hn(be,a)).filter(be=>!!be),de=await Vn(ne,a),ye=((_==null?void 0:_.recent_ops)||[]).map(be=>va(be,a)).filter(be=>!!be),se=Va([...H,...de,...ye]);if(!J())return;c(se.map(St)),ca(fe,{objs:se})}J()&&A(!1)}catch{J()&&!me&&A(!0)}finally{J()&&D(!1)}})(),()=>{ge=!1}},[s,o.token,a,$,l]),p.useEffect(()=>{if(!d.showCredits||!V){B(null);return}let te=!0;return(async()=>{try{const ge=await fetch(`${Da}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:V})});if(!ge.ok)return;const J=await ge.json();te&&J&&J.ok!==!1&&B(J)}catch{}})(),()=>{te=!1}},[d.showCredits,V,E]);const ae=p.useCallback(te=>I(new Set(te)),[]);return{session:o,mode:i,caps:d,fund:x,email:V,marketEstimate:b,generatedAt:S,criteria:v,stats:f,thumbs:j,stages:N,dossiers:g,favIds:q,setFavIds:ae,credits:R,reloadCredits:()=>O(te=>te+1),loading:F,error:h,refresh:()=>ee(te=>te+1)}}function Ge(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ya=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Sa(e){return ya.has(e.engine||"")}function We(e){return!!e.noCo||Sa(e)&&!!e.url}const mo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ks=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...mo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,memoTab:0,undo:[],mapFolded:a}),Js=new Set(["signal","amount","score","crible","memo"]);function Xs(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:mo(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Js.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??fo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const fo=80;function Ca(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Oe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Nn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(gt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&zt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(ao(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function ea(e,a,r){return Ge(e)?Ca(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ca(e,a.filters,r)}function Zs(e,a,r,n){return!(!ea(e,a,r)||r&&!to(e,a.ptab,n))}function zn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-gt(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Ni(o);case"memo":return ji(o);case"signal":{const i=Oe(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const d=n(o),s=n(i);return d<s?-a.dir:d>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const Wa={},lr=(Wa==null?void 0:Wa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function dr(){return new Date().toISOString().slice(0,10)}const An=p.createContext(null);function ho(){return p.useContext(An)}function el(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(l=>l.remove()),s.querySelectorAll("*").forEach(l=>{const g=l.tagName==="A"?l.getAttribute("href"):null;[...l.attributes].forEach(c=>l.removeAttribute(c.name)),g&&/^https?:\/\//i.test(g)&&(l.setAttribute("href",g),l.setAttribute("target","_blank"),l.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:s.outerHTML})}}catch{}return a}function tl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),l=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!s&&!l&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function cr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function pr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function go(){const e=p.useContext(An);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function al({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Q(),[i,d]=p.useState(()=>n.filters.day||dr()),[s,l]=p.useState(null),[g,c]=p.useState(!1),x=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){d(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{d(dr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=w=>{var y;const f=(y=w.detail)==null?void 0:y.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[x]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let v=!1;c(!0);const w=new URLSearchParams({token:e,date:i});return fetch(`${lr}/cibles/edition.json?${w}`).then(f=>f.json()).then(f=>{v||l(f)}).catch(()=>{v||l({ok:!1,error:"network"})}).finally(()=>{v||c(!1)}),()=>{v=!0}},[e,i]);const b=p.useMemo(()=>`${lr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=p.useMemo(()=>({token:e,day:i,ed:s,loading:g,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,g,x,u,n.filters.day,b,o]);return t.jsx(An.Provider,{value:m,children:a})}function nl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=go(),[o,i]=p.useState(()=>n||no());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const d=s=>{var l;return i(!!((l=s.detail)!=null&&l.open))};return window.addEventListener(ja,d),()=>window.removeEventListener(ja,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Ei,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function rl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function ur(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function mr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function ol(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=go(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!d,l=a&&!a.ok,g=p.useRef(null),[c,x]=p.useState("fonds"),[u,b]=p.useState(null),[m,v]=p.useState("idle"),w=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),w.current=!1,x("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||w.current)return;w.current=!0;let N=!0;return v("load"),rl(e).then(C=>{N&&(b(C),v("fait"))}),()=>{N=!1}},[c,e]);const f=p.useMemo(()=>tl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),y=p.useRef(null);p.useEffect(()=>{const N=y.current;if(!N||!f)return;let C=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(C||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{C=!0}},[f]);const j=p.useMemo(()=>cr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>cr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const N=g.current;if(!N||!j)return;let C=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(C||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{C=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&l&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?ur(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:pr(e,!0)}),"."]}):ur(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:pr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&d&&j?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,c==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:y,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:mr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:mr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const il=300,pa=7,sl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},xo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},ll=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ga(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Ai(r)&&r!=="media")return"news:"+r;const n=Oe(e);return n?"sig:"+(n.theme&&xo.fr[n.theme]?n.theme:"other"):"actualites"}function dl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:s}=Q(),l=ho(),g=d==="en",[c,x]=p.useState("all"),[u,b]=p.useState(!1),m=p.useMemo(()=>{var ge;const h=(a.filters.day||"").slice(0,10),A=J=>!(!i&&a.continent!=="monde"&&J.continent!==a.continent||h&&(J.date||"").slice(0,10)!==h),$=e.filter(J=>A(J)&&Oe(J)&&(!i||J.kind!=="target"||Ne(J)!==5)),ee=i&&(((ge=l==null?void 0:l.ed)==null?void 0:ge.ops)||[]).length?l.ed.ops.map(J=>va(J,d)).filter(J=>!!J).map(J=>(J.briefOnly=!0,J)).filter(J=>!h||(J.date||"").slice(0,10)===h):[],E=e.filter(J=>A(J)&&J.kind==="op"&&(h?!0:gt(J.date)<=pa)),O=i?ee.length?ee:E.filter(J=>{const fe=(s||"").trim().toLowerCase();if(!fe)return!1;const me=J.match||null;return me?Object.keys(me).map(xe=>xe.trim().toLowerCase()).includes(fe):!1}):E,M=h||new Date().toISOString().slice(0,10),V=J=>{const fe=Ga(J);return fe==="ma"?0:fe==="levees"?1:2};O.sort((J,fe)=>{const me=V(J)-V(fe);if(me)return me;const xe=(J.date||"").slice(0,10)===M?0:1,U=(fe.date||"").slice(0,10)===M?0:1;return xe!==U?xe-U:(fe.amountEur||0)-(J.amountEur||0)});const ae=new Set,te=[];for(const J of[...O,...zn($,{key:"signal",dir:-1})]){const fe=J.id||J.name;!fe||ae.has(fe)||(ae.add(fe),te.push(J))}return i&&te.length===0?e.filter(fe=>A(fe)&&gt(fe.date)<=pa).sort((fe,me)=>(me.date||"").localeCompare(fe.date||"")).slice(0,80):te},[e,a.continent,a.filters.day,i,s,d,l]),v=p.useMemo(()=>{const h={};for(const A of m){const $=Ga(A);h[$]=(h[$]||0)+1}return h},[m]),w=p.useMemo(()=>c==="all"?m:m.filter(h=>Ga(h)===c),[m,c]),f=p.useMemo(()=>w.slice(0,il),[w]),y=w.length-f.length,j=p.useRef(null);p.useEffect(()=>{var O,M;const h=j.current;if(!h)return;const A=()=>{const V=h.scrollWidth;V<200||(h.style.animationDuration=Math.max(18,Math.round(V/130))+"s")};A();const $=requestAnimationFrame(A),ee=window.setTimeout(A,1200);let E=!0;return(M=(O=document.fonts)==null?void 0:O.ready)==null||M.then(()=>{E&&A()}),()=>{E=!1,cancelAnimationFrame($),window.clearTimeout(ee)}},[f.length,c]);const k=h=>h==="all"?m.length:v[h]||0,N=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return xo[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const A=h.slice(5);return Ci[A]?zi(A,g?"en":"fr"):h}return sl[g?"en":"fr"][h]},C=[{k:"all"}],S=["ma","levees"].filter(h=>k(h)>0||h===c);if(S.length){C.push({g:g?"Deals":"Opérations"});for(const h of S)C.push({k:h})}const L=["nominations","recrutements"].filter(h=>k(h)>0||h===c),q=Si.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>k(h)>0||h===c),I=k("actualites")>0||c==="actualites"?["actualites"]:[];if(L.length||q.length||I.length){C.push({g:g?"News":"Actualités"});for(const h of L)C.push({k:h});for(const h of q)C.push({k:h});for(const h of I)C.push({k:h})}const R=ll.map(h=>"sig:"+h).filter(h=>k(h)>0||h===c);if(R.length){C.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of R)C.push({k:h})}const B=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},F=(()=>{const h=(a.filters.day||"").slice(0,10),A=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(g?`LIVE covers the events of ${B(h)}.`:`Le LIVE regroupe les événements du ${B(h)}.`)+A:(g?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+A})(),D=h=>f.map(A=>t.jsxs("button",{type:"button",className:"tk"+(Pe(A)?" spent":""),onClick:$=>{const ee=A.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:ee?"":A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(ee||n({type:"focus",id:A.id}),a.dens!=="liste"){const E=$.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:E.left+E.width/2,y:E.bottom}})}},title:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(wt,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(ei,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:Yc(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx(Ia,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(A.id||A.name))).concat(y>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${y} more — filter by section to see them`:`+ ${y} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(h=>!h),children:[N(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:F}),C.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===c,onClick:()=>{x(h.k),b(!1)},children:[N(h.k),t.jsx("b",{children:k(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:j,children:[D(0),D(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!l&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!l&&t.jsx(pl,{isEn:g})]})}const cl=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function pl({isEn:e}){const[a,r]=p.useState(()=>no());p.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(ja,o),()=>window.removeEventListener(ja,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>qi(!a),children:cl})}const qn="+33 6 83 10 72 86",za="alexandre@proplace.co",bo=`tel:${qn.replace(/[^\d+]/g,"")}`;function ul(){return null}class rt extends p.Component{constructor(){super(...arguments);Pn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const vo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function fr(e,a){if((kt(e)||"").startsWith("CALL")&&Ne(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ne(e)>=2;return vo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const hr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",ml={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function fl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=Q(),[s,l]=p.useState(""),[g,c]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!x)return;const y=j=>{b.current&&!b.current.contains(j.target)&&(u(!1),c(!1))};return document.addEventListener("click",y,!0),()=>document.removeEventListener("click",y,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),v=async y=>{if(s)return;if(y==="Analysé"&&!e.memoUrl){c(!0);return}l(y);const j=(fr(e,a).find(([N])=>N===y)||[y,y])[1],k=await o(e,y,{msg:a.csMoved(e.name,j)});l(""),k&&(c(!1),u(!1))},w=fr(e,a),f=y=>(w.find(([j])=>j===y)||[])[1]||y;return w.length===2?t.jsx("span",{className:"rstat rst2",onClick:y=>y.stopPropagation(),children:w.map(([y,j])=>t.jsx("button",{type:"button",className:"rsd "+(y==="Validé"?"yes":"no")+(s===y?" busy":""),disabled:!!s,onClick:()=>{v(y)},children:j},y))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:y=>y.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!s,title:a.csLabel,className:"rsel rs-"+hr(m),onClick:()=>{u(y=>!y),c(!1)},children:s?f(s)+"…":m?f(m):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:w.map(([y,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===y,className:"rsopt"+(m===y?" on":"")+(s===y?" busy":""),disabled:!!s,onClick:()=>{if(y===m){u(!1);return}v(y)},children:[t.jsx("i",{className:"pt2",style:{background:ml[hr(y)]}}),j]},y))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),c(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const y=await o(e,"Analysé");l(""),y&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function hl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Q(),[i,d]=p.useState(""),[s,l]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),c=(kt(e)||"").startsWith("CALL")&&Ne(e)===3,x=Ne(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(m);const v=await o(e,m);d(""),v&&(l(!0),setTimeout(()=>l(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:vo.filter(([m])=>!(x&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:v},m)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(gl,{o:e})]})}function gl({o:e}){const{t:a,saveNote:r,flash:n}=Q(),[o,i]=p.useState(e.ceoNote||""),[d,s]=p.useState(!1),[l,g]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!c)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!c,onClick:()=>{x()},children:l?a.csNoteSaved:a.csNoteOk})]})}function xl({placeholder:e,onDone:a}){const{t:r}=Q(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function bl({o:e}){var w;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:s}=Q(),[l,g]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Ne(e)!==4)return null;const c=i(e),x=(c==null?void 0:c.stage)||"todo",u=async f=>{if(l||f===x)return;g(!0);const y=c;d(e,{stage:f,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),gr+=1);gr=j;const k=await Ti(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!k.stale&&(k.ok||(d(e,y),s(a.actErr)))},b=(w=c==null?void 0:c.stamps)==null?void 0:w.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:l,onClick:()=>{u(f)},children:y},f)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let gr=0;const Wt=8,yt=360;function xr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function br({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(xr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(xr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function vl({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Q(),[d,s]=p.useState(0),[l,g]=p.useState(null),[c,x]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=p.useRef(!1);p.useEffect(()=>{const S=b.current;return()=>{m.current||(n({type:"ptab",tab:S.ptab}),n({type:"dens",dens:S.dens}),n({type:"modal",modal:S.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,x(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const v=c[d],w=d>=c.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const S=v.click,L=window.setTimeout(()=>{const q=document.querySelector(S);q&&q.getAttribute("aria-selected")!=="true"&&q.click()},60);return()=>window.clearTimeout(L)}},[d,v]);const f=p.useRef(-1),y=p.useCallback(()=>{if(!v){g(null);return}const S=I=>{if(!I)return null;for(const R of document.querySelectorAll(I)){const B=R.getBoundingClientRect();if(B.width>1&&B.height>1)return R}return null},L=S(v.sel)||S(v.need);if(!L){g(null);return}f.current!==d&&(f.current=d,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const q=L.getBoundingClientRect();g(I=>I&&Math.abs(I.top-q.top)<1&&Math.abs(I.left-q.left)<1&&Math.abs(I.width-q.width)<1&&Math.abs(I.height-q.height)<1?I:q)},[v,d]);p.useLayoutEffect(()=>{y();const S=[90,300,700,1300].map(I=>window.setTimeout(y,I)),L=window.setInterval(y,400),q=()=>y();return window.addEventListener("scroll",q,!0),window.addEventListener("resize",q),()=>{S.forEach(I=>window.clearTimeout(I)),window.clearInterval(L),window.removeEventListener("scroll",q,!0),window.removeEventListener("resize",q)}},[y]);const j=p.useRef(a);if(j.current=a,p.useEffect(()=>{const S=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),j.current()):L.key==="ArrowRight"?s(q=>q+1):L.key==="ArrowLeft"&&s(q=>Math.max(0,q-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!c.length)return null;let k=null;const N=S=>()=>{m.current=!0,n({type:"modal",modal:null}),S()};if(w){const S=o[3]||0;S>0?k={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let C={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:yt};if(!w&&l){const S=l.bottom+14,L=window.innerHeight-S;let q=L>190?S:Math.max(12,l.top-200),I=Math.min(Math.max(12,l.left+l.width/2-yt/2),window.innerWidth-yt-12);L<=190&&l.top<212&&(window.innerWidth-l.right>=yt+40?I=Math.min(l.right+26,window.innerWidth-yt-12):l.left>=yt+40&&(I=Math.max(12,l.left-yt-26)),q=Math.max(12,l.top-Wt)),C={left:I,top:q,width:yt}}return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!w&&l&&t.jsx("div",{className:"tour-hole",style:{left:l.left-Wt,top:l.top-Wt,width:l.width+Wt*2,height:l.height+Wt*2}}),(w||!l)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(w?" fin":""),style:C,children:[w&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(br,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(br,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>s(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(S=>S+1),children:d===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function yo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function wo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function yl(){var L,q;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:s,dispatch:l}=Q(),g=r?a:e,c=p.useMemo(()=>g.filter(I=>gt(I.date)===0&&I.kind==="target"),[g]),x=p.useMemo(()=>r?a.filter(I=>I.kind==="target"&&Ne(I)===0).slice().sort((I,R)=>(R.date||"").localeCompare(I.date||"")):[],[a,r]),u=p.useMemo(()=>c.filter(I=>r?Ne(I)===0:!Pe(I)),[c,r]),b=r?x:u,m=r?a.length-x.length:c.length-u.length,v=r?a.length:c.length,w=v?Math.min(100,m/v*100):100,f=p.useMemo(()=>yo(g),[g]),y=!!f&&gt(f)>0,j=p.useMemo(()=>y?g.filter(I=>(I.date||"").slice(0,10)===f):[],[g,f,y]),k=typeof((L=s.stats)==null?void 0:L.kept_today)=="number"?s.stats.kept_today:null,N=typeof((q=s.stats)==null?void 0:q.screened_today)=="number"?s.stats.screened_today:c.length;let C;y?C=o.morningLast(j.length,x.length,wo(f,d)):r?C=o.morningThesis(N,x.length,k):c.length?m===0?C=o.goalSourced(c.length):m>=c.length?C=o.goalCleared:C=o.goalDone(m,c.length):C=o.goalSourced(0);const S=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&x.length&&l({type:"chainStart",queue:x.map(I=>I.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:C}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:w+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:S,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function wl(){var $,ee;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:d,dossiers:s,mode:l,doSync:g,startTour:c,flash:x,flashErr:u}=Q(),[b,m]=p.useState(null),[v,w]=p.useState(!0),[f,y]=p.useState([]),j=l==="client";p.useEffect(()=>{if(!o||!i)return;let E=!0;return w(!0),(async()=>{const[O,M]=await Promise.all([En(i),ro(o)]);E&&(O&&m(O),w(!1),y(M))})(),()=>{E=!1}},[o,i]);const[k,N]=p.useState(!1),C=()=>{!j||k||!i||(N(!0),Li(i).then(E=>{N(!1),E?x(e.identRepubDone):u(e.actErr)}))},S=(b==null?void 0:b.per_day)??null,L=(($=b==null?void 0:b.pool_order)==null?void 0:$.length)??0,q=f.filter(E=>E.status==="running").length,I=p.useMemo(()=>s.filter(E=>E.kind==="target"&&Pe(E)).length,[s]),R=d.marketEstimate,B=typeof((ee=d.stats)==null?void 0:ee.screened)=="number"?d.stats.screened:I,F=R&&R>0?Math.min(100,Math.round(B/R*100)):null,D=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),h=(i||"P").split(/\s+/).map(E=>E[0]).join("").slice(0,2).toUpperCase(),A=(()=>{const E=Date.parse(d.generatedAt||"");if(Number.isNaN(E))return"";const O=new Date(E),M=V=>String(V).padStart(2,"0");return`${M(O.getDate())}/${M(O.getMonth()+1)} à ${M(O.getHours())}:${M(O.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),A?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(A)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[F===null&&B>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:D(B)})})]}),F!==null&&R&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:F+"%"}})}),t.jsxs("b",{children:[F," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(B,R)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),S!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:S})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),S===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),q>0&&t.jsxs("span",{className:"ev",children:["⏳ ",q]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:E=>{E.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||k,onClick:C,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:E=>n({type:"filters",patch:{search:E.target.value}})})]})]})]})}class qt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,s=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);s&&(r[n++]=s),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*kl(e){for(const a of e)yield*a}function ko(e){return Array.from(kl(e))}var ke=1e-6,he=Math.PI,et=he/2,vr=he/4,at=he*2,mt=180/he,Ye=he/180,Ce=Math.abs,jl=Math.atan,ta=Math.atan2,Te=Math.cos,Le=Math.sin,Nl=Math.sign||function(e){return e>0?1:e<0?-1:0},Lt=Math.sqrt;function El(e){return e>1?0:e<-1?he:Math.acos(e)}function aa(e){return e>1?et:e<-1?-et:Math.asin(e)}function tt(){}function Aa(e,a){e&&wr.hasOwnProperty(e.type)&&wr[e.type](e,a)}var yr={Feature:function(e,a){Aa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Aa(r[n].geometry,a)}},wr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ln(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ln(r[n],a,0)},Polygon:function(e,a){kr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)kr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Aa(r[n],a)}};function ln(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function kr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ln(e[r],a,1);a.polygonEnd()}function Mt(e,a){e&&yr.hasOwnProperty(e.type)?yr[e.type](e,a):Aa(e,a)}function dn(e){return[ta(e[1],e[0]),aa(e[2])]}function Pt(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*Le(a),Le(r)]}function ua(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function qa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ya(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ma(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function cn(e){var a=Lt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function pn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function un(e,a){return Ce(e)>he&&(e-=Math.round(e/at)*at),[e,a]}un.invert=un;function Sl(e,a,r){return(e%=at)?a||r?pn(Nr(e),Er(a,r)):Nr(e):a||r?Er(a,r):un}function jr(e){return function(a,r){return a+=e,Ce(a)>he&&(a-=Math.round(a/at)*at),[a,r]}}function Nr(e){var a=jr(e);return a.invert=jr(-e),a}function Er(e,a){var r=Te(e),n=Le(e),o=Te(a),i=Le(a);function d(s,l){var g=Te(l),c=Te(s)*g,x=Le(s)*g,u=Le(l),b=u*r+c*n;return[ta(x*o-b*i,c*r-u*n),aa(b*o+x*i)]}return d.invert=function(s,l){var g=Te(l),c=Te(s)*g,x=Le(s)*g,u=Le(l),b=u*o-x*i;return[ta(x*o+u*i,c*r+b*n),aa(b*r-c*n)]},d}function Cl(e,a,r,n,o,i){if(r){var d=Te(a),s=Le(a),l=n*r;o==null?(o=a+n*at,i=a-l/2):(o=Sr(d,o),i=Sr(d,i),(n>0?o<i:o>i)&&(o+=n*at));for(var g,c=o;n>0?c>i:c<i;c-=l)g=dn([d,-s*Te(c),-s*Le(c)]),e.point(g[0],g[1])}}function Sr(e,a){a=Pt(a),a[0]-=e,cn(a);var r=El(-a[1]);return((-a[2]<0?-r:r)+at-ke)%at}function jo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:tt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function wa(e,a){return Ce(e[0]-a[0])<ke&&Ce(e[1]-a[1])<ke}function fa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function No(e,a,r,n,o){var i=[],d=[],s,l;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,w=m[0],f=m[v],y;if(wa(w,f)){if(!w[2]&&!f[2]){for(o.lineStart(),s=0;s<v;++s)o.point((w=m[s])[0],w[1]);o.lineEnd();return}f[0]+=2*ke}i.push(y=new fa(w,m,null,!0)),d.push(y.o=new fa(w,null,y,!1)),i.push(y=new fa(f,m,null,!1)),d.push(y.o=new fa(f,null,y,!0))}}),!!i.length){for(d.sort(a),Cr(i),Cr(d),s=0,l=d.length;s<l;++s)d[s].e=r=!r;for(var g=i[0],c,x;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;c=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,l=c.length;s<l;++s)o.point((x=c[s])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(c=u.p.z,s=c.length-1;s>=0;--s)o.point((x=c[s])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Cr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Qa(e){return Ce(e[0])<=he?e[0]:Nl(e[0])*((Ce(e[0])+he)%at-he)}function zl(e,a){var r=Qa(a),n=a[1],o=Le(n),i=[Le(r),-Te(r),0],d=0,s=0,l=new qt;o===1?n=et+ke:o===-1&&(n=-et-ke);for(var g=0,c=e.length;g<c;++g)if(u=(x=e[g]).length)for(var x,u,b=x[u-1],m=Qa(b),v=b[1]/2+vr,w=Le(v),f=Te(v),y=0;y<u;++y,m=k,w=C,f=S,b=j){var j=x[y],k=Qa(j),N=j[1]/2+vr,C=Le(N),S=Te(N),L=k-m,q=L>=0?1:-1,I=q*L,R=I>he,B=w*C;if(l.add(ta(B*q*Le(I),f*S+B*Te(I))),d+=R?L+q*at:L,R^m>=r^k>=r){var F=qa(Pt(b),Pt(j));cn(F);var D=qa(i,F);cn(D);var h=(R^L>=0?-1:1)*aa(D[2]);(n>h||n===h&&(F[0]||F[1]))&&(s+=R^L>=0?1:-1)}}return(d<-ke||d<ke&&l<-1e-12)^s&1}function Eo(e,a,r,n){return function(o){var i=a(o),d=jo(),s=a(d),l=!1,g,c,x,u={point:b,lineStart:v,lineEnd:w,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=j,c=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=w,c=ko(c);var k=zl(g,n);c.length?(l||(o.polygonStart(),l=!0),No(c,ql,k,r,o)):k&&(l||(o.polygonStart(),l=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),l&&(o.polygonEnd(),l=!1),c=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,N){e(k,N)&&o.point(k,N)}function m(k,N){i.point(k,N)}function v(){u.point=m,i.lineStart()}function w(){u.point=b,i.lineEnd()}function f(k,N){x.push([k,N]),s.point(k,N)}function y(){s.lineStart(),x=[]}function j(){f(x[0][0],x[0][1]),s.lineEnd();var k=s.clean(),N=d.result(),C,S=N.length,L,q,I;if(x.pop(),g.push(x),x=null,!!S){if(k&1){if(q=N[0],(L=q.length-1)>0){for(l||(o.polygonStart(),l=!0),o.lineStart(),C=0;C<L;++C)o.point((I=q[C])[0],I[1]);o.lineEnd()}return}S>1&&k&2&&N.push(N.pop().concat(N.shift())),c.push(N.filter(Al))}}return u}}function Al(e){return e.length>1}function ql(e,a){return((e=e.x)[0]<0?e[1]-et-ke:et-e[1])-((a=a.x)[0]<0?a[1]-et-ke:et-a[1])}const zr=Eo(function(){return!0},Tl,Fl,[-he,-et]);function Tl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var s=i>0?he:-he,l=Ce(i-a);Ce(l-he)<ke?(e.point(a,r=(r+d)/2>0?et:-et),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&l>=he&&(Ce(a-n)<ke&&(a-=n*ke),Ce(i-s)<ke&&(i-=s*ke),r=Ll(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=d),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Ll(e,a,r,n){var o,i,d=Le(e-r);return Ce(d)>ke?jl((Le(a)*(i=Te(n))*Le(r)-Le(n)*(o=Te(a))*Le(e))/(o*i*d)):(a+n)/2}function Fl(e,a,r,n){var o;if(e==null)o=r*et,n.point(-he,o),n.point(0,o),n.point(he,o),n.point(he,0),n.point(he,-o),n.point(0,-o),n.point(-he,-o),n.point(-he,0),n.point(-he,o);else if(Ce(e[0]-a[0])>ke){var i=e[0]<a[0]?he:-he;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Rl(e){var a=Te(e),r=2*Ye,n=a>0,o=Ce(a)>ke;function i(c,x,u,b){Cl(b,e,r,u,c,x)}function d(c,x){return Te(c)*Te(x)>a}function s(c){var x,u,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(w,f){var y=[w,f],j,k=d(w,f),N=n?k?0:g(w,f):k?g(w+(w<0?he:-he),f):0;if(!x&&(m=b=k)&&c.lineStart(),k!==b&&(j=l(x,y),(!j||wa(x,j)||wa(y,j))&&(y[2]=1)),k!==b)v=0,k?(c.lineStart(),j=l(y,x),c.point(j[0],j[1])):(j=l(x,y),c.point(j[0],j[1],2),c.lineEnd()),x=j;else if(o&&x&&n^k){var C;!(N&u)&&(C=l(y,x,!0))&&(v=0,n?(c.lineStart(),c.point(C[0][0],C[0][1]),c.point(C[1][0],C[1][1]),c.lineEnd()):(c.point(C[1][0],C[1][1]),c.lineEnd(),c.lineStart(),c.point(C[0][0],C[0][1],3)))}k&&(!x||!wa(x,y))&&c.point(y[0],y[1]),x=y,b=k,u=N},lineEnd:function(){b&&c.lineEnd(),x=null},clean:function(){return v|(m&&b)<<1}}}function l(c,x,u){var b=Pt(c),m=Pt(x),v=[1,0,0],w=qa(b,m),f=ua(w,w),y=w[0],j=f-y*y;if(!j)return!u&&c;var k=a*f/j,N=-a*y/j,C=qa(v,w),S=ma(v,k),L=ma(w,N);Ya(S,L);var q=C,I=ua(S,q),R=ua(q,q),B=I*I-R*(ua(S,S)-1);if(!(B<0)){var F=Lt(B),D=ma(q,(-I-F)/R);if(Ya(D,S),D=dn(D),!u)return D;var h=c[0],A=x[0],$=c[1],ee=x[1],E;A<h&&(E=h,h=A,A=E);var O=A-h,M=Ce(O-he)<ke,V=M||O<ke;if(!M&&ee<$&&(E=$,$=ee,ee=E),V?M?$+ee>0^D[1]<(Ce(D[0]-h)<ke?$:ee):$<=D[1]&&D[1]<=ee:O>he^(h<=D[0]&&D[0]<=A)){var ae=ma(q,(-I+F)/R);return Ya(ae,S),[D,dn(ae)]}}}function g(c,x){var u=n?e:he-e,b=0;return c<-u?b|=1:c>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return Eo(d,s,i,n?[0,-e]:[-he,e-he])}function Ol(e,a,r,n,o,i){var d=e[0],s=e[1],l=a[0],g=a[1],c=0,x=1,u=l-d,b=g-s,m;if(m=r-d,!(!u&&m>0)){if(m/=u,u<0){if(m<c)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>c&&(c=m)}if(m=o-d,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>c&&(c=m)}else if(u>0){if(m<c)return;m<x&&(x=m)}if(m=n-s,!(!b&&m>0)){if(m/=b,b<0){if(m<c)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>c&&(c=m)}if(m=i-s,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>c&&(c=m)}else if(b>0){if(m<c)return;m<x&&(x=m)}return c>0&&(e[0]=d+c*u,e[1]=s+c*b),x<1&&(a[0]=d+x*u,a[1]=s+x*b),!0}}}}}var Gt=1e9,ha=-Gt;function Ml(e,a,r,n){function o(g,c){return e<=g&&g<=r&&a<=c&&c<=n}function i(g,c,x,u){var b=0,m=0;if(g==null||(b=d(g,x))!==(m=d(c,x))||l(g,c)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(c[0],c[1])}function d(g,c){return Ce(g[0]-e)<ke?c>0?0:3:Ce(g[0]-r)<ke?c>0?2:1:Ce(g[1]-a)<ke?c>0?1:0:c>0?3:2}function s(g,c){return l(g.x,c.x)}function l(g,c){var x=d(g,1),u=d(c,1);return x!==u?x-u:x===0?c[1]-g[1]:x===1?g[0]-c[0]:x===2?g[1]-c[1]:c[0]-g[0]}return function(g){var c=g,x=jo(),u,b,m,v,w,f,y,j,k,N,C,S={point:L,lineStart:B,lineEnd:F,polygonStart:I,polygonEnd:R};function L(h,A){o(h,A)&&c.point(h,A)}function q(){for(var h=0,A=0,$=b.length;A<$;++A)for(var ee=b[A],E=1,O=ee.length,M=ee[0],V,ae,te=M[0],ge=M[1];E<O;++E)V=te,ae=ge,M=ee[E],te=M[0],ge=M[1],ae<=n?ge>n&&(te-V)*(n-ae)>(ge-ae)*(e-V)&&++h:ge<=n&&(te-V)*(n-ae)<(ge-ae)*(e-V)&&--h;return h}function I(){c=x,u=[],b=[],C=!0}function R(){var h=q(),A=C&&h,$=(u=ko(u)).length;(A||$)&&(g.polygonStart(),A&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),$&&No(u,s,h,i,g),g.polygonEnd()),c=g,u=b=m=null}function B(){S.point=D,b&&b.push(m=[]),N=!0,k=!1,y=j=NaN}function F(){u&&(D(v,w),f&&k&&x.rejoin(),u.push(x.result())),S.point=L,k&&c.lineEnd()}function D(h,A){var $=o(h,A);if(b&&m.push([h,A]),N)v=h,w=A,f=$,N=!1,$&&(c.lineStart(),c.point(h,A));else if($&&k)c.point(h,A);else{var ee=[y=Math.max(ha,Math.min(Gt,y)),j=Math.max(ha,Math.min(Gt,j))],E=[h=Math.max(ha,Math.min(Gt,h)),A=Math.max(ha,Math.min(Gt,A))];Ol(ee,E,e,a,r,n)?(k||(c.lineStart(),c.point(ee[0],ee[1])),c.point(E[0],E[1]),$||c.lineEnd(),C=!1):$&&(c.lineStart(),c.point(h,A),C=!1)}y=h,j=A,k=$}return S}}const mn=e=>e;var Ka=new qt,fn=new qt,So,Co,hn,gn,ft={point:tt,lineStart:tt,lineEnd:tt,polygonStart:function(){ft.lineStart=Dl,ft.lineEnd=Pl},polygonEnd:function(){ft.lineStart=ft.lineEnd=ft.point=tt,Ka.add(Ce(fn)),fn=new qt},result:function(){var e=Ka/2;return Ka=new qt,e}};function Dl(){ft.point=Il}function Il(e,a){ft.point=zo,So=hn=e,Co=gn=a}function zo(e,a){fn.add(gn*e-hn*a),hn=e,gn=a}function Pl(){zo(So,Co)}var _t=1/0,Ta=_t,na=-_t,La=na,Fa={point:_l,lineStart:tt,lineEnd:tt,polygonStart:tt,polygonEnd:tt,result:function(){var e=[[_t,Ta],[na,La]];return na=La=-(Ta=_t=1/0),e}};function _l(e,a){e<_t&&(_t=e),e>na&&(na=e),a<Ta&&(Ta=a),a>La&&(La=a)}var xn=0,bn=0,Yt=0,Ra=0,Oa=0,Dt=0,vn=0,yn=0,Qt=0,Ao,qo,ct,pt,Ze={point:Tt,lineStart:Ar,lineEnd:qr,polygonStart:function(){Ze.lineStart=Ul,Ze.lineEnd=Hl},polygonEnd:function(){Ze.point=Tt,Ze.lineStart=Ar,Ze.lineEnd=qr},result:function(){var e=Qt?[vn/Qt,yn/Qt]:Dt?[Ra/Dt,Oa/Dt]:Yt?[xn/Yt,bn/Yt]:[NaN,NaN];return xn=bn=Yt=Ra=Oa=Dt=vn=yn=Qt=0,e}};function Tt(e,a){xn+=e,bn+=a,++Yt}function Ar(){Ze.point=Bl}function Bl(e,a){Ze.point=$l,Tt(ct=e,pt=a)}function $l(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Ra+=o*(ct+e)/2,Oa+=o*(pt+a)/2,Dt+=o,Tt(ct=e,pt=a)}function qr(){Ze.point=Tt}function Ul(){Ze.point=Vl}function Hl(){To(Ao,qo)}function Vl(e,a){Ze.point=To,Tt(Ao=ct=e,qo=pt=a)}function To(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Ra+=o*(ct+e)/2,Oa+=o*(pt+a)/2,Dt+=o,o=pt*e-ct*a,vn+=o*(ct+e),yn+=o*(pt+a),Qt+=o*3,Tt(ct=e,pt=a)}function Lo(e){this._context=e}Lo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,at);break}}},result:tt};var wn=new qt,Ja,Fo,Ro,Kt,Jt,ra={point:tt,lineStart:function(){ra.point=Wl},lineEnd:function(){Ja&&Oo(Fo,Ro),ra.point=tt},polygonStart:function(){Ja=!0},polygonEnd:function(){Ja=null},result:function(){var e=+wn;return wn=new qt,e}};function Wl(e,a){ra.point=Oo,Fo=Kt=e,Ro=Jt=a}function Oo(e,a){Kt-=e,Jt-=a,wn.add(Lt(Kt*Kt+Jt*Jt)),Kt=e,Jt=a}let Tr,Ma,Lr,Fr;class Rr{constructor(a){this._append=a==null?Mo:Gl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Lr||this._append!==Ma){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Lr=n,Ma=this._append,Fr=this._,this._=o}this._+=Fr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Mo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Gl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Mo;if(a!==Tr){const r=10**a;Tr=a,Ma=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ma}function Yl(e,a){let r=3,n=4.5,o,i;function d(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Mt(s,o(i))),i.result()}return d.area=function(s){return Mt(s,o(ft)),ft.result()},d.measure=function(s){return Mt(s,o(ra)),ra.result()},d.bounds=function(s){return Mt(s,o(Fa)),Fa.result()},d.centroid=function(s){return Mt(s,o(Ze)),Ze.result()},d.projection=function(s){return arguments.length?(o=s==null?(e=null,mn):(e=s).stream,d):e},d.context=function(s){return arguments.length?(i=s==null?(a=null,new Rr(r)):new Lo(a=s),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),d):n},d.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const l=Math.floor(s);if(!(l>=0))throw new RangeError(`invalid digits: ${s}`);r=l}return a===null&&(i=new Rr(r)),d},d.projection(e).digits(r).context(a)}function Tn(e){return function(a){var r=new kn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function kn(){}kn.prototype={constructor:kn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ln(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Mt(r,e.stream(Fa)),a(Fa.result()),n!=null&&e.clipExtent(n),e}function Do(e,a,r){return Ln(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,l=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([s,l])},r)}function Ql(e,a,r){return Do(e,[[0,0],a],r)}function Kl(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([d,s])},r)}function Jl(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,s])},r)}var Or=16,Xl=Te(30*Ye);function Mr(e,a){return+a?ed(e,a):Zl(e)}function Zl(e){return Tn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ed(e,a){function r(n,o,i,d,s,l,g,c,x,u,b,m,v,w){var f=g-n,y=c-o,j=f*f+y*y;if(j>4*a&&v--){var k=d+u,N=s+b,C=l+m,S=Lt(k*k+N*N+C*C),L=aa(C/=S),q=Ce(Ce(C)-1)<ke||Ce(i-x)<ke?(i+x)/2:ta(N,k),I=e(q,L),R=I[0],B=I[1],F=R-n,D=B-o,h=y*F-f*D;(h*h/j>a||Ce((f*F+y*D)/j-.5)>.3||d*u+s*b+l*m<Xl)&&(r(n,o,i,d,s,l,R,B,q,k/=S,N/=S,C,v,w),w.point(R,B),r(R,B,q,k,N,C,g,c,x,u,b,m,v,w))}}return function(n){var o,i,d,s,l,g,c,x,u,b,m,v,w={point:f,lineStart:y,lineEnd:k,polygonStart:function(){n.polygonStart(),w.lineStart=N},polygonEnd:function(){n.polygonEnd(),w.lineStart=y}};function f(L,q){L=e(L,q),n.point(L[0],L[1])}function y(){x=NaN,w.point=j,n.lineStart()}function j(L,q){var I=Pt([L,q]),R=e(L,q);r(x,u,c,b,m,v,x=R[0],u=R[1],c=L,b=I[0],m=I[1],v=I[2],Or,n),n.point(x,u)}function k(){w.point=f,n.lineEnd()}function N(){y(),w.point=C,w.lineEnd=S}function C(L,q){j(o=L,q),i=x,d=u,s=b,l=m,g=v,w.point=j}function S(){r(x,u,c,b,m,v,i,d,o,s,l,g,Or,n),w.lineEnd=k,k()}return w}}var td=Tn({point:function(e,a){this.stream.point(e*Ye,a*Ye)}});function ad(e){return Tn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function nd(e,a,r,n,o){function i(d,s){return d*=n,s*=o,[a+e*d,r-e*s]}return i.invert=function(d,s){return[(d-a)/e*n,(r-s)/e*o]},i}function Dr(e,a,r,n,o,i){if(!i)return nd(e,a,r,n,o);var d=Te(i),s=Le(i),l=d*e,g=s*e,c=d/e,x=s/e,u=(s*r-d*a)/e,b=(s*a+d*r)/e;function m(v,w){return v*=n,w*=o,[l*v-g*w+a,r-g*v-l*w]}return m.invert=function(v,w){return[n*(c*v-x*w+u),o*(b-x*v-c*w)]},m}function rd(e){return od(function(){return e})()}function od(e){var a,r=150,n=480,o=250,i=0,d=0,s=0,l=0,g=0,c,x=0,u=1,b=1,m=null,v=zr,w=null,f,y,j,k=mn,N=.5,C,S,L,q,I;function R(h){return L(h[0]*Ye,h[1]*Ye)}function B(h){return h=L.invert(h[0],h[1]),h&&[h[0]*mt,h[1]*mt]}R.stream=function(h){return q&&I===h?q:q=td(ad(c)(v(C(k(I=h)))))},R.preclip=function(h){return arguments.length?(v=h,m=void 0,D()):v},R.postclip=function(h){return arguments.length?(k=h,w=f=y=j=null,D()):k},R.clipAngle=function(h){return arguments.length?(v=+h?Rl(m=h*Ye):(m=null,zr),D()):m*mt},R.clipExtent=function(h){return arguments.length?(k=h==null?(w=f=y=j=null,mn):Ml(w=+h[0][0],f=+h[0][1],y=+h[1][0],j=+h[1][1]),D()):w==null?null:[[w,f],[y,j]]},R.scale=function(h){return arguments.length?(r=+h,F()):r},R.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],F()):[n,o]},R.center=function(h){return arguments.length?(i=h[0]%360*Ye,d=h[1]%360*Ye,F()):[i*mt,d*mt]},R.rotate=function(h){return arguments.length?(s=h[0]%360*Ye,l=h[1]%360*Ye,g=h.length>2?h[2]%360*Ye:0,F()):[s*mt,l*mt,g*mt]},R.angle=function(h){return arguments.length?(x=h%360*Ye,F()):x*mt},R.reflectX=function(h){return arguments.length?(u=h?-1:1,F()):u<0},R.reflectY=function(h){return arguments.length?(b=h?-1:1,F()):b<0},R.precision=function(h){return arguments.length?(C=Mr(S,N=h*h),D()):Lt(N)},R.fitExtent=function(h,A){return Do(R,h,A)},R.fitSize=function(h,A){return Ql(R,h,A)},R.fitWidth=function(h,A){return Kl(R,h,A)},R.fitHeight=function(h,A){return Jl(R,h,A)};function F(){var h=Dr(r,0,0,u,b,x).apply(null,a(i,d)),A=Dr(r,n-h[0],o-h[1],u,b,x);return c=Sl(s,l,g),S=pn(a,A),L=pn(c,S),C=Mr(S,N),D()}function D(){return q=I=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&B,F()}}function Io(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Io.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Ce(o)>ke&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function id(){return rd(Io).scale(175.295)}function sd(e){return e}function ld(e){if(e==null)return sd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(s,l){l||(a=r=0);var g=2,c=s.length,x=new Array(c);for(x[0]=(a+=s[0])*n+i,x[1]=(r+=s[1])*o+d;g<c;)x[g]=s[g],++g;return x}}function dd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function cd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Ir(e,r)})}:Ir(e,a)}function Ir(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=pd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function pd(e,a){var r=ld(e.transform),n=e.arcs;function o(c,x){x.length&&x.pop();for(var u=n[c<0?~c:c],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));c<0&&dd(x,m)}function i(c){return r(c)}function d(c){for(var x=[],u=0,b=c.length;u<b;++u)o(c[u],x);return x.length<2&&x.push(x[0]),x}function s(c){for(var x=d(c);x.length<4;)x.push(x[0]);return x}function l(c){return c.map(s)}function g(c){var x=c.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:c.geometries.map(g)};case"Point":u=i(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(i);break;case"LineString":u=d(c.arcs);break;case"MultiLineString":u=c.arcs.map(d);break;case"Polygon":u=l(c.arcs);break;case"MultiPolygon":u=c.arcs.map(l);break;default:return null}return{type:x,coordinates:u}}return g(a)}const Po={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ud=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function md(e,a,r){const n=Po[e];if(!n||!n.length)return-1;const o=ud(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let ga=null;function fd(){return ga||(ga=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=cd(r,n),i=id().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Yl(i),s=(o.features||[]).filter(c=>{var x;return(((x=c.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(c=>{var b;const x=((b=c.properties)==null?void 0:b.name)||"",u=d(c)||"";return u?{i2:Fi(x)||null,n:x,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const l={};for(const[c,x]of Object.entries(Ri)){const u=i(x);u&&(l[c]={x:u[0],y:u[1]})}const g={};for(const[c,x]of Object.entries(Po)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(g[c]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:l,metros:g}}catch{return null}})(),ga)}function hd(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return fd().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const gd="8 40 984 210",xd={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Pr=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function _r(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function bd(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const d=()=>{var g;if(!o)return;const l=(g=e.current)==null?void 0:g.getScreenCTM();l&&l.a>0?n(l.a):i=requestAnimationFrame(d)};d();const s=new ResizeObserver(()=>d());return e.current&&s.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function Br({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function vd(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:s,t:l,data:g,dossiers:c,source:x}=Q(),u=g.loading&&!c.length,b=p.useRef(null),m=p.useRef(null),v=hd(e.continent==="monde"),w=e.continent==="monde"?v:Sn.find(h=>h.key===e.continent)||null,f=bd(b,e.continent+":"+e.mapFolded+":"+!!w),[y,j]=p.useState(new Map),[k,N]=p.useState(null);p.useEffect(()=>{const h=b.current;if(!h)return;const A=new Map;h.querySelectorAll("path[data-i2]").forEach($=>{const ee=$.dataset.i2;if(ee)try{const E=$.getBBox();E.width>0&&A.set(ee,{x:E.x,y:E.y,w:E.width,h:E.height})}catch{}}),j(A)},[e.continent,f,w]);const C=p.useMemo(()=>r.filter(h=>h.cc),[r]),S=p.useMemo(()=>{const h=new Map;return C.forEach(A=>h.set(A.cc,(h.get(A.cc)||0)+1)),h},[C]),L=e.continent==="monde"&&v?v.anchors:null,q=e.continent==="monde"&&v?v.metros:null,I=p.useMemo(()=>C.map(h=>{const A=_r(h.name||h.id||""),$=_r((h.id||h.name||"")+"·y");if(L&&h.cc){const V=q?q[h.cc]:void 0;if(V&&V.length){const te=md(h.cc,h.city,A);if(te>=0&&V[te])return{d:h,x:V[te].x+(A-.5)*5,y:V[te].y+($-.5)*5}}const ae=L[h.cc];if(ae)return{d:h,x:ae.x+(A-.5)*10,y:ae.y+($-.5)*10}}const ee=h.cc?y.get(h.cc):void 0;if(!ee)return null;const E=xd[`${e.continent}:${h.cc||""}`];if(E)return{d:h,x:ee.x+ee.w*(E.fx+(A-.5)*E.sx),y:ee.y+ee.h*(E.fy+($-.5)*E.sy)};const O=(A-.5)*Math.min(ee.w*.55,60),M=($-.5)*Math.min(ee.h*.55,60);return{d:h,x:ee.x+ee.w/2+O,y:ee.y+ee.h/2+M}}).filter(h=>!!h),[C,y,L,q,e.continent]),R=h=>f>0?h/f:h,B=p.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:Pr[h],fr:l.plabels[h],en:l.plabels[h],n:r.filter(A=>A.kind==="target"&&Ne(A)===h).length})).filter(h=>h.n>0):Wn.map((h,A)=>({...h,n:r.filter($=>Gn($)===A).length})),[r,n,l.plabels]),F=i?d.get(i):null,D=F?I.find(h=>h.d.id===F.id):null;return w?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Br,{msgs:l.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?gd:w.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?w.fr:w.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:w.countries.map((h,A)=>t.jsx("g",{className:"ct"+(h.i2&&S.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},A))}),t.jsx("g",{children:I.map(h=>{const A=Wn[Gn(h.d)],$=!!Oe(h.d),ee=h.d.kind==="target",E=n&&ee?Pr[Ne(h.d)]:A.c,O=!n&&Pe(h.d);return t.jsxs("g",{className:"co"+(O?" done":""),onMouseEnter:()=>{var ae,te;const M=(ae=m.current)==null?void 0:ae.getBoundingClientRect(),V=(te=b.current)==null?void 0:te.createSVGPoint();if(V&&b.current&&M){V.x=h.x,V.y=h.y;const ge=V.matrixTransform(b.current.getScreenCTM());N({x:ge.x-M.left,y:ge.y-M.top,label:h.d.name+" · "+(Ut(h.d.cc,s)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var ae;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const M=(ae=b.current)==null?void 0:ae.createSVGPoint();let V=null;if(M&&b.current){M.x=h.x,M.y=h.y;const te=M.matrixTransform(b.current.getScreenCTM());V={x:te.x,y:te.y}}a({type:"popup",id:h.d.id,anchor:V})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:R(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:R(A.px),fill:E,stroke:$?"#E5484D":"#ffffff",strokeWidth:R($?2.2:1.3)})]},h.d.id||h.d.name)})}),D&&t.jsx("circle",{className:"ring on",cx:D.x,cy:D.y,r:R(13),fill:"none",stroke:"#16233A",strokeWidth:R(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:B.map((h,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),s==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},A))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",l.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Br,{msgs:l.loadMsgs})})}function yd(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function _o({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:s}=Q(),l=a.filters,[g,c]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null),m=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(D=>D.continent===a.continent),[n,a.continent]),w=D=>v.filter(h=>D!=="country"&&l.country.length&&!l.country.includes(h.cc||"")?!1:Ca(h,l,i,D==="country"?void 0:D)),f=D=>!i||D.kind!=="op",y=p.useMemo(()=>{const D=w("win").filter(f),h=A=>D.filter($=>($.date?Math.max(0,Math.floor((Date.now()-Date.parse($.date))/864e5)):9999)<=A).length;return[h(0),h(7),h(30),D.length]},[v,l,i]),j=p.useMemo(()=>l.day?w("win").filter(f).filter(D=>(D.date||"").slice(0,10)===l.day).length:0,[v,l,i]),k=(l.signalOnly?1:0)+l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+l.crible.length,N=k+(l.acquirer.trim()?1:0)+(l.day||l.win!=="all"?1:0)+(l.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!g&&!x)return;const D=A=>{var ee,E;const $=A.target;g&&!((ee=b.current)!=null&&ee.contains($))&&c(!1),x&&!((E=m.current)!=null&&E.contains($))&&u(!1)},h=A=>{A.key==="Escape"&&(c(!1),u(!1))};return document.addEventListener("mousedown",D),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",D),document.removeEventListener("keydown",h)}},[g,x]);const C=(D,h,A,$="fbtn")=>t.jsxs("button",{type:"button",className:$,"aria-expanded":a.openFacet===D,onClick:()=>r({type:"openFacet",facet:D}),children:[t.jsx("span",{className:"fl",children:h}),A>0&&t.jsx("span",{className:"n",children:A}),t.jsx("span",{className:"cv",children:"▾"})]},D),S=["1","7","30","all"],L=Math.max(0,S.indexOf(l.win||"all")),q=l.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(yd(l.day,s))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(D=>!D),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:y[L]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:S.map((D,h)=>t.jsxs("button",{type:"button",role:"option","aria-selected":l.win===D,onClick:()=>{r({type:"filters",patch:{win:D}}),u(!1)},children:[o.datesShort[h],t.jsx("span",{className:"n",children:y[h]})]},D))})]}):t.jsx("div",{className:"seg",children:S.map((D,h)=>t.jsxs("button",{type:"button","aria-pressed":l.win===D,onClick:()=>r({type:"filters",patch:{win:D}}),children:[t.jsx("span",{className:"sl",children:o.dates[h]}),t.jsx("b",{children:y[h]})]},D))}),I=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:l.search,onChange:D=>r({type:"filters",patch:{search:D.target.value}})})]}),R=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),l.signalOnly&&t.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),l.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:l.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):C("sec",o.fSector,l.sector.length),C("pay",o.fCountry,l.country.length),C("det",o.fEngine,l.engine.length),C("sta",o.fStage,l.stage.length),i&&C("crib",o.fVerdict,l.crible.length),i&&C("ang","Angle",l.angle.length),i&&C("mem","Mémo",l.memoLevel.length)]}),B=(D=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),D&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),F=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{c(D=>!D),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:R})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(l.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:q}),t.jsxs("div",{className:"fstrip-b",children:[I,F,B(!1)]})]}),a.openFacet&&t.jsx($r,{poolFor:w})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[q,I,R,t.jsx("span",{className:"fgrow"}),B()]}),a.openFacet&&t.jsx($r,{poolFor:w})]})}function $r({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=Q(),s=a.filters,l=a.openFacet,{title:g,cols:c,options:x}=p.useMemo(()=>{if(l==="sig"){const w=e("signal").filter(j=>Oe(j)),f=new Map;w.forEach(j=>{const k=j.engine||"";f.set(k,(f.get(k)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:w.length,html:!0,on:s.signalOnly&&!s.signalEngines.length},...rn([...f.keys()],o).map(j=>({v:j,label:At(j)+" "+Qe(j,o),n:f.get(j)||0,html:!1,on:s.signalOnly&&s.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="crib"){const w=e("crible").filter(y=>!i||to(y,a.ptab,d.favIds)),f=new Map;return w.forEach(y=>{const j=ao(y);j&&j!=="NEW"&&f.set(j,(f.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((y,j)=>(Yn[y[0]]??9)-(Yn[j[0]]??9)||j[1]-y[1]).map(([y,j])=>({v:y,label:'<span class="fdot" style="background:'+(Oi[y]||"#94A3B8")+'"></span>'+y,n:j,html:!0,on:s.crible.includes(y)}))}}if(l==="sec"){const w=e("sector"),f=new Map;return w.forEach(y=>{y.sector&&f.set(y.sector,(f.get(y.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:y,n:j,html:!1,on:s.sector.includes(y)}))}}if(l==="pay"){const w=e("country"),f=new Map;return w.forEach(y=>{y.cc&&f.set(y.cc,(f.get(y.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:Ut(y,o)||y,n:j,html:!1,on:s.country.includes(y)}))}}if(l==="det"){const w=e("engine"),f=new Map;return w.forEach(y=>{y.engine&&f.set(y.engine,(f.get(y.engine)||0)+1)}),{title:n.fEngine,cols:2,options:rn([...f.keys()],o).map(y=>({v:y,label:At(y)+" "+Qe(y,o)+' <span style="color:var(--dim);font-size:10px">· '+Mi(Di(y),o)+"</span>",n:f.get(y)||0,html:!0,on:s.engine.includes(y)}))}}if(l==="ang"){const w=e("angle"),f=new Map;return w.forEach(y=>{y.angle&&f.set(y.angle,(f.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:y.replace(/[_-]+/g," "),n:j,html:!1,on:s.angle.includes(y)}))}}if(l==="mem"){const w=e("memoLevel"),f=new Map;w.forEach(j=>{if(j.kind==="target"){const k=Nn(j);f.set(k,(f.get(k)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:y[j],n:f.get(j)||0,html:!1,on:s.memoLevel.includes(j)}))}}const m=e("stage"),v=new Map;return m.forEach(w=>{w.stage&&v.set(w.stage,(v.get(w.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...v.entries()].sort((w,f)=>f[1]-w[1]).map(([w,f])=>({v:w,label:w,n:f,html:!1,on:s.stage.includes(w)}))}},[l,a,o]),u=m=>{if(l==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(s.signalOnly&&!s.signalEngines.length),signalEngines:[]}});else{const w=s.signalEngines.includes(m)?s.signalEngines.filter(f=>f!==m):[...s.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:w}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage",value:m})},b=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:g}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:x.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>u(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Bo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:s}=Q(),l=p.useMemo(()=>{const b={};return r.forEach(m=>{Ca(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,c]=p.useState(!1),x=p.useRef(null);p.useEffect(()=>{if(!g)return;const b=v=>{var w;(w=x.current)!=null&&w.contains(v.target)||c(!1)},m=v=>{v.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const u=b=>{const m=Sn.find(v=>v.key===b);return b==="monde"?s.contWorld:d==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:l[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Qn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[Qn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})})]})}function jn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function $o(e){return"atl2:evalq:"+(e||"anon")}function wd(e,a){const r=$o(e),n=jn(r),o=new Set(n.map(s=>(s.name||"").trim().toLowerCase())),i=a.map(s=>(s||"").trim()).filter(s=>s&&!o.has(s.toLowerCase())).map(s=>({name:s,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function Uo(){const{t:e,data:a,dossiers:r}=Q(),n=a.session.token||"",o=$o(n),[i,d]=p.useState(()=>jn(o)),s=p.useRef(!1),[l,g]=p.useState(!1);p.useEffect(()=>{try{const E=i.slice(0,30).map(({descBusy:O,evalBusy:M,...V})=>V);localStorage.setItem(o,JSON.stringify(E)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[i,o]),p.useEffect(()=>{const E=()=>{if(s.current)return;const O=jn(o);d(M=>JSON.stringify(M.map(({descBusy:V,evalBusy:ae,...te})=>te))===JSON.stringify(O)?M:O)};return window.addEventListener("atl2:evalq",E),window.addEventListener("storage",E),()=>{window.removeEventListener("atl2:evalq",E),window.removeEventListener("storage",E)}},[o]);const[c,x]=p.useState([]),[u,b]=p.useState(""),[m,v]=p.useState(!1),[w,f]=p.useState(!1),[y,j]=p.useState(""),k=p.useCallback((E,O)=>d(M=>M.map((V,ae)=>ae===E?{...V,...O}:V)),[]),N=p.useCallback((E,O)=>{const M=O.trim();M&&(k(E,{name:M,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Cn(M).then(V=>{const ae=V.candidates||[];V.website?k(E,{site:V.website,status:"ready"}):ae.length===1?k(E,{site:ae[0].url,status:"ready"}):ae.length>1?k(E,{status:"pick",candidates:ae.slice(0,4)}):k(E,{status:"ready"})}).catch(()=>k(E,{status:"ready"})))},[k]),C=p.useCallback((E,O,M)=>{k(E,{descBusy:!0}),oo(n,O,M).then(V=>{if(V.quota){g(!0),k(E,{descBusy:!1,descDone:!0});return}const ae=V.blocs||{},te=(ae.synthese||ae.value_prop||ae.produit||ae.modele||"").trim();k(E,{descBusy:!1,descDone:!0,desc:te})}).catch(()=>k(E,{descBusy:!1,descDone:!0}))},[k,n]);p.useEffect(()=>{const E=i.findIndex(M=>M.auto&&M.name.trim()&&M.status==="");if(E>=0){N(E,i[E].name);return}if(l)return;const O=i.findIndex(M=>M.status==="ready"&&M.site&&!M.descDone&&!M.descBusy);O>=0&&C(O,i[O].name,i[O].site)},[i,N,C,l]);const[S,L]=p.useState(!1),q=p.useCallback(async(E,O)=>{k(E,{evalBusy:!0});const M=await io(n,(O.site||O.name).trim(),"atelier2");return M.verdict==="quota"?(k(E,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:M.reason||"",remaining:0}})),!1):(k(E,{evalBusy:!1,status:M.verdict==="kept"?"kept":"out",reason:M.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:M.company||O.name,verdict:M.verdict,reason:M.reason||"",remaining:M.remaining??null}})),!0)},[k,n]),I=async()=>{if(S)return;const E=i.map((O,M)=>({r:O,i:M})).filter(({r:O})=>O.name.trim()&&O.status!=="kept"&&O.status!=="out"&&O.status!=="resolving");if(E.length){L(!0);for(const{r:O,i:M}of E)if(!await q(M,O))break;L(!1)}},R=p.useMemo(()=>{const E=new Set,O=[];return i.filter(M=>M.status==="kept").forEach(M=>{const V=M.name.trim().toLowerCase();V&&!E.has(V)&&(E.add(V),O.push(M.name.trim()))}),r.filter(M=>Ne(M)>=1&&Ne(M)<=4&&(M.website||M.domain)).forEach(M=>{const V=(M.name||"").trim().toLowerCase();V&&!E.has(V)&&(E.add(V),O.push((M.name||"").trim()))}),O},[i,r]),B=p.useMemo(()=>{const E=new Set;return r.forEach(O=>{const M=(O.name||"").trim().toLowerCase();M&&E.add(M)}),i.forEach(O=>{const M=O.name.trim().toLowerCase();M&&E.add(M)}),E},[r,i]),F=async()=>{if(u||!R.length)return;f(!1);const E=[];for(const O of R.slice(0,2)){b(O);const M=await so(n,O);if(M){if(M.verdict==="quota"){v(!0);break}(M.results||[]).forEach(V=>{const ae=(V.company||"").trim().toLowerCase();!ae||B.has(ae)||E.some(te=>te.name.toLowerCase()===ae)||E.push({name:(V.company||"").trim(),verdict:V.verdict||"",reason:V.reason,from:O})})}}b(""),f(!0),x(O=>[...E,...O].slice(0,24))},D=async(E,O)=>{if(u)return;f(!1),b(E==="thesis"?e.pxThesis:O);const M=await Ii(n,E,O,6);if(b(""),f(!0),!M)return;if(M.verdict==="quota"){v(!0);return}const V=[];(M.results||[]).forEach(ae=>{const te=(ae.company||"").trim().toLowerCase();!te||B.has(te)||V.some(ge=>ge.name.toLowerCase()===te)||V.push({name:(ae.company||"").trim(),verdict:ae.verdict||"",reason:ae.reason,from:E==="thesis"?e.pxThesis:O})}),x(ae=>[...V,...ae].slice(0,24))},h=()=>{const E=y.trim();E.length<3||D(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(E)?"registry":"keyword",E)},A=E=>{d(O=>[...O,{name:E.name,site:"",status:"",auto:!0}].slice(0,30)),x(O=>O.filter(M=>M.name!==E.name))},$=i.filter(E=>E.name.trim()&&E.status!=="kept"&&E.status!=="out").length,ee=E=>E.name.trim()&&E.status!=="kept"&&E.status!=="out"&&E.status!=="resolving"&&!E.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((E,O)=>t.jsxs("div",{className:"eq-row"+(E.status==="kept"?" r-kept":E.status==="out"?" r-out":""),children:[t.jsx("input",{value:E.name,placeholder:e.eqNamePh,onChange:M=>{const V=M.target.value.split(`
`).map(ae=>ae.trim()).filter(Boolean);V.length>1?d(ae=>{const te=[...ae];return te.splice(O,1,...V.map(ge=>({name:ge,site:"",status:"",auto:!0}))),te.slice(0,30)}):k(O,{name:M.target.value})},onBlur:()=>{E.name.trim()&&!E.site&&E.status!=="resolving"&&E.status!=="pick"&&N(O,E.name)},onKeyDown:M=>{M.key==="Enter"&&N(O,E.name)}}),t.jsxs("span",{className:"eq-site",children:[E.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),E.status==="pick"&&(E.candidates||[]).map(M=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>k(O,{site:M.url,status:"ready",candidates:void 0}),children:(M.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},M.url)),E.status!=="resolving"&&E.status!=="pick"&&(E.site?t.jsxs("a",{href:E.site.startsWith("http")?E.site:"https://"+E.site,target:"_blank",rel:"nofollow noopener",children:[E.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:E.name.trim()&&E.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:E.desc||"",children:E.descBusy?t.jsx("i",{children:e.eqDescBusy}):E.desc?E.desc:t.jsx("em",{children:E.descDone?l?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(E.status||"vide"),title:E.reason||"",children:E.status==="kept"?"✓ "+e.kept:E.status==="out"?"✗ "+e.dropped:E.status==="ready"?e.eqReady:E.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!ee(E)||S,onClick:()=>{q(O,E)},children:E.evalBusy?"⏳":"⚡"}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>d(M=>M.filter((V,ae)=>ae!==O)),children:"×"})]},O)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>d(E=>[...E,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]}),t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!u,onClick:()=>{D("thesis","")},children:u===e.pxThesis?e.sgBusy(u):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:y,placeholder:e.pxPlace,onChange:E=>j(E.target.value),onKeyDown:E=>{E.key==="Enter"&&h()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u||y.trim().length<3,onClick:h,children:e.pxGoFree}),!!R.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u,onClick:()=>{F()},children:u&&u!==e.pxThesis&&u!==y?e.sgBusy(u):e.sgGo}),!!R.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(R[0],R.length)}),m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),w&&!c.length&&!m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),c.map(E=>t.jsxs("span",{className:"eq-sc"+(E.verdict==="kept"?" ok":""),title:(E.reason||"")+" — "+e.sgVia(E.from),children:[t.jsx("b",{children:E.name}),E.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>A(E),children:"+"})]},E.name))]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(S?" loading":""),style:{justifyContent:"center"},disabled:S||!$,onClick:()=>{I()},children:[t.jsx("span",{className:"fill"}),S?e.eqRunning:e.eqGo($)]}),t.jsx("span",{className:"hint",children:e.eqHint}),i.some(E=>E.status==="kept"||E.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>d(E=>E.filter(O=>O.status!=="kept"&&O.status!=="out")),children:e.eqClearDone})]})]})}function Ho(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function kd(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Ur({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:s}=Q();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(l=>l.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(l=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:l.name}),l.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),l.line1&&t.jsx("p",{className:"w",children:l.line1}),l.line2&&t.jsx("p",{className:"r",children:l.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(l.name),children:s.rsEvalOne})]},l.name))})]}):null}function Vo({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=Q(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Ur,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Ur,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function jd({card:e,onEvaluate:a,onAddAll:r}){var s,l,g;const{t:n}=Q(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ho(e.summary_md||"").map((c,x)=>t.jsx("p",{children:c},x))})]}),t.jsx(Vo,{card:e,onEvaluate:a,onAddAll:r}),(((l=e.prospective)==null?void 0:l.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(c=>t.jsx("li",{children:c},c))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function Nd(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Ed({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=Q(),s=o,[l,g]=p.useState(null),[c,x]=p.useState(null),[u,b]=p.useState(null),[m,v]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const y=await lo({email:d,cbToken:s});f&&g(y)})(),()=>{f=!1}},[d,s,n]);const w=f=>{x(f),b(null),v(!0),(async()=>{const y=await Pi(f.id);b(y),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&l&&t.jsx("span",{className:"n",children:l.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[l===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),l!==null&&l.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(l||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>w(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Nd(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(jd,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ka=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Xt(e){return/^https?:\/\//i.test((e||"").trim())}function lt(e){const a=(e||"").trim();return a?Xt(a)?a:ka.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Sd(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Cd(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:d,evalBusy:s,evalCards:l,caps:g,data:c,canWrite:x,source:u,dossiers:b,doAnalyse:m,liveMemos:v,pipe:w}=Q(),f=a==="client",y=p.useMemo(()=>r||(u!=="default"?_i():""),[r,u]),[j,k]=p.useState(""),[N,C]=p.useState(!1),[S,L]=p.useState(""),[q,I]=p.useState(""),[R,B]=p.useState(""),[F,D]=p.useState(!1),[h,A]=p.useState(!1),[$,ee]=p.useState([]);p.useEffect(()=>{const P=oe=>{const pe=oe.detail;pe&&ee(re=>[pe,...re].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[E,O]=p.useState(!1),[M,V]=p.useState(!1),[ae,te]=p.useState(!1),ge=p.useRef(!1),[J,fe]=p.useState(""),[me,xe]=p.useState(""),[U,W]=p.useState(!1),[H,X]=p.useState(!1),[_,ne]=p.useState(0),[de,ye]=p.useState(""),[se,be]=p.useState(null),[ce,ze]=p.useState(null),[Ke,ve]=p.useState(!1),[Se,Ft]=p.useState(null),[Me,Je]=p.useState(0),Ae=p.useRef(!1),it=j.trim()?ka.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),oe=(P.get("rs")||"").trim(),pe=(P.get("rstext")||"").trim();oe&&/^https?:\/\//i.test(oe)&&fe(oe),pe&&xe(pe),(oe&&/^https?:\/\//i.test(oe)||pe)&&O(!0)},[]),p.useEffect(()=>{const P=oe=>{const pe=oe.detail||{},re=String(pe.url||"").trim(),je=String(pe.text||"").trim();re&&/^https?:\/\//i.test(re)&&fe(re),je&&xe(je),(re&&/^https?:\/\//i.test(re)||je)&&(O(!0),k(""),L(""),W(!0),window.setTimeout(()=>W(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),p.useEffect(()=>{const P=oe=>{const pe=oe.detail||{},re=String(pe.name||"").trim();if(!re)return;O(!1),k(re),L(re);const je=lt(String(pe.website||pe.domain||""));I(je),B(lt(String(pe.url||""))),D(!je),C(!0),window.setTimeout(()=>C(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),p.useEffect(()=>{const P=(S||"").trim();if(!P||E||q){(q||!P||E)&&D(!1);return}const oe=b.find(je=>$e(je.name)===$e(P)),pe=lt((oe==null?void 0:oe.website)||"")||lt((oe==null?void 0:oe.domain)||"");if(pe){I(pe),D(!1);return}let re=!0;return D(!0),Cn(P).then(je=>{var Ue,qe;if(!re)return;const Ie=lt(je.website||"")||lt(((qe=(Ue=je.candidates)==null?void 0:Ue[0])==null?void 0:qe.url)||"");Ie&&I(Ie)}).catch(()=>{}).finally(()=>{re&&D(!1)}),()=>{re=!1}},[S,E,q,b]),p.useEffect(()=>{const P=oe=>{var re;const pe=String(((re=oe.detail)==null?void 0:re.url)||"").trim();Xt(pe)&&window.open(pe,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),p.useEffect(()=>{if(ge.current===E)return;ge.current=E,te(!0);const P=window.setTimeout(()=>te(!1),560);return()=>window.clearTimeout(P)},[E]),p.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),oe=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!oe)return;const pe=()=>oe.style.setProperty("--demand-h",`${P.offsetHeight}px`);pe();const re=new ResizeObserver(pe);return re.observe(P),()=>re.disconnect()},[u,N,U,h,E,ae,F]),p.useEffect(()=>{if(!x&&!y){Ft(null);return}let P=!0;return(async()=>{const oe=await lo({email:n,cbToken:y});P&&Ft(oe.length)})(),()=>{P=!1}},[x,y,n,Me]);const jt=$.length?$:l,De=c.credits,xt=p.useCallback(P=>{wd(r,P)&&A(!0)},[r]);p.useEffect(()=>{if(!H)return;ne(0);const P=window.setInterval(()=>ne(oe=>oe+1),1e3);return()=>window.clearInterval(P)},[H]);const ut=p.useMemo(()=>{const P=j.trim().toLowerCase();return!P||!w?null:b.find(oe=>$e(oe.name)===P&&Ne(oe)===1)||null},[j,b,w]),Xe=()=>{const P=j.trim();if(P){if(ut){m(ut);return}o(null,P),f&&k("")}},Nt=async()=>{var pe,re,je;if(Ae.current)return;const P=J.trim().replace(/\s+/g,""),oe=me.trim();if(!P&&!oe){ye(e.rsNeed);return}if(!f&&!y){o(null,P||oe.slice(0,80));return}Ae.current=!0,ye(""),be(null),ze(null),X(!0);try{const Ie=await $i({url:P,text:oe,email:n,cbToken:y});if(X(!1),!Ie||Ie.status!=="success"){ye((Ie==null?void 0:Ie.message)||"Erreur");return}be(Ie),O(!1),xt((((pe=Ie.prospective)==null?void 0:pe.companies_to_evaluate)||[]).map(qe=>(qe==null?void 0:qe.name)||"")),ze({state:"pending"});const Ue=await Ui(Ie,{email:n,cbToken:y});ze(Ue.ok?{state:"ok",scopeLabel:((re=Ue.summary)==null?void 0:re.scope_label)||"",scope:((je=Ue.summary)==null?void 0:je.scope)||""}:{state:"fail",msg:Ue.error||""}),Ue.ok&&Je(qe=>qe+1)}finally{Ae.current=!1,X(!1)}},bt=[se==null?void 0:se.industry,...(se==null?void 0:se.market_tags)||[],se==null?void 0:se.author].map(P=>(P||"").trim()).filter(Boolean),vt=(ce==null?void 0:ce.state)==="pending",Rt=ce&&(vt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):ce.state==="ok"?t.jsx("span",{className:"rslink ok",children:ce.scope&&ce.scope!=="public"?e.rsSavedIn(ce.scopeLabel||ce.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:ce.msg,children:e.rsSaveFail})),Et=kd(se).length,Fe=E,nt=(S||j).trim(),T=b.find(P=>$e(P.name)===$e(nt)),G=lt(j)||q||lt((T==null?void 0:T.website)||"")||lt((T==null?void 0:T.domain)||""),K=R||lt((T==null?void 0:T.url)||""),le=ut?e.actAnalyse:nt?e.evalGoOn(nt.length>22?nt.slice(0,21)+"…":nt):e.evalGo,we=H?`${Bi(J.trim())==="youtube"&&J.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(_)}`:vt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Fe?" rs-mode":"")+(S&&j.trim()===S||N||U?" pair":"")+(N||U||ae?" echo":"")+(ae?" swap":""),children:[t.jsxs("div",{className:"drow"+((Fe?U:N)||ae?" flash":"")+((Fe?J.trim():ka.test(j.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Fe?J:j,placeholder:Fe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Fe?600:200,spellCheck:Fe?!1:void 0,inputMode:Fe?"url":void 0,onChange:P=>{if(Fe){fe(P.target.value);return}k(P.target.value),S&&P.target.value.trim()!==S&&(L(""),I(""),B(""),D(!1))},onKeyDown:P=>{P.key==="Enter"&&(Fe?Nt():Xe())}}),t.jsx("span",{className:"detect"+(Fe?" off":"")+(ka.test(j.trim())?" url":""),children:it})]}),t.jsx("span",{className:"dacts",children:Fe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(H?" loading":""),disabled:H||vt||!J.trim()&&!me.trim(),onClick:()=>{Nt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:we})]}),t.jsxs("a",{className:"viewbtn"+(Xt(J)?"":" off"),href:Xt(J)?J.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{Xt(J)||P.preventDefault()},children:[t.jsx(Sd,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ut?" analyse":"")+(s?" loading":""),disabled:s,onClick:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:le})]}),t.jsxs("a",{className:"viewbtn sm"+(F?" searching":G?"":" off"),href:G||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{G||P.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(K?"":" off"),href:K||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{K||P.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&De&&t.jsxs("button",{type:"button",className:"credits"+(De.total_available<=0&&!De.unlimited?" empty":""),onClick:()=>d({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:De.unlimited?"∞":De.total_available}),!De.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",De.daily_grant+De.purchased]}),De.total_available<=0&&!De.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>A(!h),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(E?" on":""),onClick:()=>O(!E),children:e.rsOpen}),Se!==null&&Se>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Ke?" on":""),onClick:()=>ve(!Ke),children:e.rsArchOpen(Se)})]}),Ke&&t.jsx(Ed,{bump:Me,cbToken:y,onClose:()=>ve(!1),onEvaluate:P=>o(null,P),onAddAll:xt}),t.jsx("div",{className:"rsp slim"+(E?" on":" off"),"aria-hidden":!E,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:E?void 0:-1,onClick:()=>V(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:M?"▴":"▾"})]}),M&&t.jsx("textarea",{className:"rstext",value:me,placeholder:e.rsTextPh,tabIndex:E?void 0:-1,onChange:P=>xe(P.target.value)})]})}),de&&t.jsx("div",{className:"rserr",children:de}),se&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:se.title}),se.source_url&&t.jsx("a",{href:se.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{be(null),ze(null)},children:"×"})]}),se.market&&t.jsx("p",{className:"rsmk",children:se.market}),bt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),bt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[se.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${se.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ho(se.summary_md||"").map((P,oe)=>t.jsx("p",{children:P},oe))})]}),t.jsx(Vo,{card:se,onEvaluate:P=>o(null,P),onAddAll:xt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Et)}),Rt]})]}),h&&t.jsx(Uo,{}),jt.slice(0,1).map((P,oe)=>{const pe=P.verdict==="kept",re=P.verdict==="quota",je=P.verdict==="unresolved",Ie=pe?"var(--brand)":re?"var(--bolt)":je?"var(--blue)":"var(--red)",Ue=pe?"var(--brand-l)":re?"#FFF3D6":je?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":Ie,"--bgc":Ue},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:pe?"✓ "+e.kept:re?"⏳":je?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(qe=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:qe.url.startsWith("http")?qe.url:`https://${qe.url}`,target:"_blank",rel:"nofollow noopener",children:[(qe.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,qe.url,P.name),children:e.evalPickGo})]},qe.url))}),!re&&!je&&t.jsx("button",{type:"button",className:"go",onClick:()=>{d({type:"ptab",tab:pe?1:5});const qe=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const _e=[...document.querySelectorAll(".atl2 .list .row")].find(Pa=>{var la;return(((la=Pa.querySelector(".rnm"))==null?void 0:la.textContent)||"").trim().toLowerCase().includes(qe)});_e&&(_e.scrollIntoView({behavior:"smooth",block:"center"}),_e.classList.add("flashrow"),window.setTimeout(()=>_e.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(pe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},oe)}),f&&(i.kept+i.dropped>0||jt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>d({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function zd(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ad(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Q(),i=e.memoConsole?r.get(e.memoConsole):null,d=p.useMemo(()=>i?[i.reasoning||"",zd(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const s=kt(i),l=Nn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:d?d.split(`

`).map((g,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[It(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:l===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Fn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Q(),[d,s]=p.useState(!1),[l,g]=p.useState(null),c=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!c||d)return;s(!0);const u=await so(r,e);if(s(!1),!u){i(a.actErr);return}g(u.results||[])};return p.useEffect(()=>{if(!c)return;const u=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,c]),p.useEffect(()=>{if(c)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,c]),c?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{x()},children:d?a.similarBusy:a.similar}),l&&(l.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:l.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const qd=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),xa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Td(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=xa(a.slice(n));break}r+=xa(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=xa(a.slice(o));break}const d=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(d),l=s?s[2].toLowerCase():"";s&&qd.has(l)?r+=`<${s[1]}${l}>`:r+=xa(a.slice(o,i+1)),n=i+1}return r}const Ld=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),Hr={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function Wo(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(Ld.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const s=d.name.toLowerCase();(!(Hr["*"].has(s)||((r=Hr[o])==null?void 0:r.has(s)))||s.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(s=>s.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(s)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}Wo(n)}}function Xa(e){const a=e.cloneNode(!0);return Wo(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Za=new Map;function Fd(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=Za.get(a);return r||(r=Rd(a).catch(()=>null),r.then(n=>{n||Za.delete(a)}),Za.set(a,r)),r}async function Rd(e){var x,u;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=new DOMParser().parseFromString(await a.text(),"text/html"),n=b=>{var m;return(((m=r.querySelector(b))==null?void 0:m.textContent)||"").trim()},o=r.querySelector(".sb-score"),i=((x=Array.from((o==null?void 0:o.classList)||[]).find(b=>b.startsWith("sb-score-")))==null?void 0:x.slice(9))||"",d=[];let s=null;const l=Array.from(r.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const b of l){if(b.classList.contains("sb-nav-heading")){s={label:(b.textContent||"").trim(),items:[]},d.push(s);continue}const m=b.getAttribute("href")||"";if(!m.startsWith("#"))continue;const v=m.slice(1),w=Od(r,v);w&&(s||(s={label:"",items:[]},d.push(s)),s.items.push({id:v,title:(b.textContent||"").trim(),html:w,poids:w.length}))}const g=((u=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:u[1])||"",c={score:n(".sb-score"),scoreTone:i,tags:Array.from(r.querySelectorAll(".sb-tag")).map(b=>(b.textContent||"").trim()).filter(Boolean),name:n(".sidebar-company-name"),tagline:n(".sidebar-tagline"),desc:n(".meta-desc"),groups:d.filter(b=>b.items.length),mindmapSlug:r.querySelector(".cm-mindmap-png")?g:""};return c.groups.length?c:null}const Vr={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Od(e,a){const r=e.getElementById(a),n=r?Wr(e,r):"";if(n)return n;const o=Vr[a]?e.querySelector(Vr[a]):null;return o&&o!==r?Wr(e,o):""}function Wr(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Xa(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(l=>/^h3$/i.test(l.tagName))[0]===a)for(const l of i){if(l===a)break;/^h2$/i.test(l.tagName)||o.appendChild(l.cloneNode(!0))}let s=a.nextElementSibling;for(;s&&!/^h3$/i.test(s.tagName);)o.appendChild(s.cloneNode(!0)),s=s.nextElementSibling;return o.children.length?Xa(o):""}return Xa(a)}const en=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ot({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Gr(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Yr({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const tn=new Map;function Md(e,a){const{token:r}=Q(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=tn.get(i);d||(d=Hi(r,e.name,e.checkId),tn.set(i,d),d.then(l=>{(!l||!l.reasoning&&!l.summaryHtml)&&tn.delete(i)}));let s=!0;return d.then(l=>{s&&l&&o({id:e.id,d:l})}),()=>{s=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Dd=6e4;function Id({o:e}){const{t:a,doDeep:r}=Q(),[n,o]=p.useState(null),[i,d]=p.useState(e.memoUrl?"load":"off"),[s,l]=p.useState(()=>new Set),[g,c]=p.useState(!1),x=p.useRef(new Map);p.useEffect(()=>{let v=!0;if(l(new Set),c(!1),x.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),Fd(e.memoUrl).then(w=>{v&&(o(w),d(w?"ok":"err"))}),()=>{v=!1}},[e.memoUrl]);const u=kt(e),b=v=>{var w;return(w=x.current.get(v))==null?void 0:w.scrollIntoView({behavior:"smooth",block:"start"})},m=t.jsxs("div",{className:"cdacts",children:[It(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:v=>{v.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const v=[e.reasoning||"",Gr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[v.length?v.join(`

`).split(`

`).map((w,f)=>t.jsx("p",{className:"cdtxt",children:w},f)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),m]})}if(i!=="ok"){const v=[e.reasoning||"",Gr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),v.length>0&&v.join(`

`).split(`

`).map((w,f)=>t.jsx("p",{className:"cdtxt",children:w},f)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:w=>{w.stopPropagation(),c(f=>!f)},children:g?a.memoHideHere:a.memoReadHere})}),g&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:w=>w.stopPropagation()}),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(v=>t.jsx("span",{className:"md-tag",children:v},v)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(v=>v.items.map(w=>t.jsx("button",{type:"button",className:"md-jump",onClick:f=>{f.stopPropagation(),b(w.id)},children:w.title},w.id)))}),n.groups.map((v,w)=>t.jsxs("div",{className:"md-grp",children:[v.label&&t.jsx("div",{className:"md-grp-h",children:v.label}),v.items.map(f=>{const y=f.poids>Dd&&!s.has(f.id),j=f.id==="fiche-contact"||f.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:k=>{k&&x.current.set(f.id,k)},children:[t.jsx("h4",{className:"md-h",children:f.title}),j&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:k=>k.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:"LinkedIn"})]}),y?t.jsx("button",{type:"button",className:"abtn md-more",onClick:k=>{k.stopPropagation(),l(N=>new Set(N).add(f.id))},children:a.memoUnfold(Math.round(f.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:f.html}}),!y&&n.mindmapSlug&&f.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Da}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:k=>k.stopPropagation()})]})]},f.id)})]},v.label||w)),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:a.memoOpenFull})]})}function Pd({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:s}=Q(),[l,g]=p.useState(!1),[c,x]=p.useState(!1),[u,b]=p.useState(!1),[m,v]=p.useState(null),[w,f]=p.useState(""),[y,j]=p.useState(null),[k,N]=p.useState(""),C={airtableId:e.airtableId,checkId:e.checkId},S=!!(e.airtableId||e.checkId),L=m&&m.id===e.id?m.entries:[],q=!!m&&m.id===e.id;if(p.useEffect(()=>{f(""),j(null),b(!1)},[e.id]),p.useEffect(()=>{if(!l||q||!S||!o)return;let R=!0;x(!0),b(!1);const B=e.id;return Kn(r,"list",C).then(F=>{if(!(!R||B!==e.id)){if(x(!1),!F.ok){b(!0);return}v({id:B,entries:F.entries})}}),()=>{R=!1}},[l,q,S,r,e.id,o]),!n.pipe||!o||!S)return null;const I=(R,B)=>{x(!0);const F=e.id;Kn(r,R,C,B).then(D=>{if(F===e.id){if(x(!1),!D.ok){d(a.notesErr);return}v({id:F,entries:D.entries}),b(!1),R==="add"&&(f(""),i(a.notesAdded)),R==="edit"&&j(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":l,onClick:R=>{R.stopPropagation(),g(B=>!B)},children:[t.jsx("b",{children:a.notesT}),L.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(L.length)}),t.jsx("i",{children:l?"▾":"▸"})]}),l&&t.jsxs("div",{className:"dn-b",onClick:R=>R.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),c&&!L.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!c&&!u&&q&&!L.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),L.map(R=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:s==="fr"?R.date.split("-").reverse().join("/"):R.date}),y===R.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:k,rows:3,onChange:B=>N(B.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||!k.trim(),onClick:()=>I("edit",{entryId:R.id,text:k.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>j(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:R.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{j(R.id),N(R.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:c,onClick:()=>{window.confirm(a.notesDelAsk)&&I("delete",{entryId:R.id})},children:a.notesDel})]})]})]},R.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:w,onChange:R=>f(R.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:c||!w.trim(),onClick:()=>I("add",{text:w.trim()}),children:a.notesAdd})]})]})]})}function Rn({o:e}){var k;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i}=Q(),d=ia(e),s=kt(e),l=(e.cribleStatus||"").trim().toUpperCase()||(d==="NO MATCH"?"NO MATCH":d==="MATCH"?"MATCH":""),g=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,c=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,x=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),u=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(l?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||It(e)?1:0},{k:"soc",lib:a.cdSociete,n:g},{k:"ctc",lib:a.cdContact,n:c},{k:"suivi",lib:a.cdSuivi,n:x}].filter(N=>N.n>0),[e,a,o,l,s,g,c,x]),[b,m]=p.useState(""),v=u.some(N=>N.k===b)?b:((k=u[0])==null?void 0:k.k)||"",w=Md(e,v==="eval"||v==="conv");if(!u.length)return null;const f=((w==null?void 0:w.reasoning)||"").length>(e.reasoning||"").length?w.reasoning:e.reasoning||"",y=((w==null?void 0:w.summaryHtml)||"").length>(e.summary||"").length?w.summaryHtml:e.summary||"",j=(w==null?void 0:w.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:u.map(N=>t.jsx("button",{type:"button",role:"tab","aria-selected":v===N.k,"data-tour":"tab-"+N.k,className:v===N.k?"on":"",onClick:C=>{C.stopPropagation(),m(N.k)},children:N.lib},N.k))}),t.jsxs("div",{className:"cdbody",onClick:N=>N.stopPropagation(),children:[v==="eval"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[t.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(Yr,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),f&&f.split(`

`).map((N,C)=>t.jsx("p",{className:"cdtxt",children:N},C)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(_d,{o:e})]}),v==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof j=="number"&&t.jsx(Yr,{v:j,sur:100,k:a.cdConvScore}),en(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",en(e.verdictDate,r)]})]}),y&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:Td(y)}})]}),v==="memo"&&t.jsx(Id,{o:e}),v==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdSector,v:e.sector}),t.jsx(ot,{k:a.cdStage,v:e.stage}),t.jsx(ot,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ot,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(ot,{k:a.cdAngle,v:e.angle}),t.jsx(ot,{k:a.cdDetected,v:en(e.date,r)})]}),v==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdName,v:e.contactName}),t.jsx(ot,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),v==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(ot,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(Pd,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}const ba=new Map;function _d({o:e}){const{t:a,token:r}=Q(),[n,o]=p.useState(!1),[i,d]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const x=`${r}:${e.name.toLowerCase()}`;let u=ba.get(x);u||(u=co(r,[e.name]).then(m=>m[e.name]||Object.values(m)[0]||null).catch(()=>null),ba.set(x,u),u.then(m=>{(!m||!m.ok)&&ba.delete(x)}));let b=!0;return u.then(m=>{b&&m&&m.ok&&d(m)}),()=>{b=!1}},[r,e.id,e.name]);const s=async()=>{if(n)return;o(!0);const x=await oo(r,e.name,e.website||e.domain||"");d(x),x.ok&&ba.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(x)),o(!1)},l=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,l.value_prop],[a.qaProduct,l.produit],[a.qaModel,l.modele],[a.qaSummary,l.synthese]],c=g.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&c&&t.jsxs(t.Fragment,{children:[g.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!c&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function sa({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const s=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Jn({kind:"op",card:e},g).then(c=>{!d&&c&&i.isConnected&&i.replaceChildren(c)})},l=window.requestAnimationFrame(s);return()=>{d=!0,window.cancelAnimationFrame(l),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;Jn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(l=>{!d&&l&&i.isConnected&&i.replaceChildren(l)});const s=l=>{l.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{d=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&$t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Bd=`
...
`;function $d(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:d,top:s}}function Ud(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:s,doAnalyse:l,doDecide:g,doPromote:c,doRepeche:x,doApproach:u,doDeep:b,doOnboard:m,outbound:v,evalBusy:w}=Q(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const y=Oe(f),j=Ne(f),k=kt(f),N=ia(f),C=f.kind==="target",S=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return $t.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Bd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:$d(e.popupAnchor,!!f.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(gt(f.date)),Qe(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[f.cc]}),children:(Ut(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>S({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>S({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Ht(f.amountEur,o)})]}),i.pipe&&C&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[At(f.engine)," ",t.jsx("b",{children:Qe(f.engine,o)})," — ",Vi(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(wt,{o:f,lg:!0})," ",t.jsx(Ia,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(po(y,o))," · ",n.win7(uo(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(sa,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&C&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&C&&t.jsx(Rn,{o:f})]}),t.jsx(Fn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{l(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),It(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:w,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Hd(){const{lang:e,token:a,dossiers:r,caps:n}=Q(),o=a||"home",{names:i,verdicts:d}=p.useMemo(()=>{const l=[],g={};return r.forEach(c=>{c.kind!=="target"||!c.name||(l.push(c.name),g[c.name]=Wi(c)||"")}),{names:l,verdicts:g}},[r]);return{diff:p.useMemo(()=>i.length?Gi(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function Vd(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:s}=Q(),[l,g]=p.useState(!1),[c,x]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!l)return;const j=k=>{u.current&&!u.current.contains(k.target)&&g(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[l]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...s.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!d.length,v=p.useRef({});p.useEffect(()=>{v.current={...r}},[r]);const w=j=>{const k=v.current[j],N=k!==void 0?r[j]-k:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${Zt[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j],j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[j],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},j)},f=(j,k,N)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),style:{"--c":`var(${Zt[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:N}),t.jsx("span",{className:"n",children:r[j]})]},j),y=(j,k,N,C=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:C,onClick:N,children:j},k);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(w)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[y("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(c?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":l,title:n.toolSort,onClick:()=>g(j=>!j),children:"⇅"}),l&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([j,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[k,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),y("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),y("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Wd(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:d}=Q(),s=p.useRef(null),[l,g]=p.useState(60);p.useEffect(()=>{let m=0;const v=()=>{var k;const w=s.current;if(!w)return;const f=(k=w.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!f)return;const y=f.getBoundingClientRect(),j=w.getBoundingClientRect();g(Math.max(20,Math.min(y.left+y.width/2-j.left,j.width-30)))};return m=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",v)}},[e.ptab]);const c=e.ptab;let x=r.tuto[c].p;if(c===3){const m=n.filter(f=>f.kind==="target"&&Ne(f)===3),v=m.filter(f=>on(f)==="auto").length,w=m.filter(f=>on(f)==="cd").length;x=r.tutoPending(v,w,m.length)}const u=(()=>{if(d!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(c===1){const m=n.filter(v=>v.kind==="target"&&Ne(v)===1&&!o.has(v.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(v=>v.id)})}}return null})(),b=Yi(c);return t.jsxs("div",{ref:s,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Zt[c]})`,"--ax":l+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const an=600,Ct=62,Qr="atl2:fstats";function Gd(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Q(),[d,s]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Qr)==="on"}catch{return!1}}),l=r.stats,g=p.useMemo(()=>((l==null?void 0:l.by_day)||[]).slice(-30),[l]),c=(l==null?void 0:l.since)||"";if(!n.showFunnel||!l||typeof l.screened!="number")return null;const x=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,u=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((N,C)=>Math.max(N,C.s||0),0),m=g.length?an/g.length:0,v=Math.max(4,m-4),w=g.length>=5&&b>0,f=r.marketEstimate||0,y=x(new Date().toISOString().slice(0,10)),j=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof l.kept=="number"?[[l.kept,e.funKept]]:[],...typeof l.analyzed=="number"?[[l.analyzed,e.funAnalyzed]]:[],...typeof l.shown=="number"?[[l.shown,e.funShown]]:[]],k=[];return typeof l.screened_window=="number"&&c&&k.push({cle:"fenetre",periode:e.funPerWindow(x(c),y),etapes:[[l.screened_window,e.funScreened("","")]]}),typeof l.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:j(l.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[k.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([C,S],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(C)}),t.jsx("i",{children:S})]},N.cle+S)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((l.screened||0)/f*100)))})]}),N.cle===k[k.length-1].cle&&w&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const C=!d;s(C),C&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Qr,C?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},N.cle)),d&&w&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${an} ${Ct}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((N,C)=>{const S=(N.s||0)/b*(Ct-4),L=(N.m||0)/b*(Ct-4),q=C*m+(m-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:q,y:Ct-2-S,width:v,height:S,fill:"#cfe0d6"}),t.jsx("rect",{x:q,y:Ct-2-L,width:v,height:L,fill:"#0E7F3F"})]},N.d)}),t.jsx("line",{x1:0,y1:Ct-1.5,x2:an,y2:Ct-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Go={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function On({o:e,locked:a=!1}){const{t:r}=Q(),n=ia(e),o=kt(e),i=Ne(e),d=on(e),s=Qi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Go[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(fl,{o:e})]})}const Bt=e=>e.length>22?e.slice(0,21)+"…":e;function oa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Yo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Yd({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const d=()=>{var m,v,w;const s=document.querySelector(".atl2.ops .desk-list"),l=document.querySelector(".atl2.ops .listhead");if(!s){n(null);return}const g=s.getBoundingClientRect(),c=l?l.getBoundingClientRect().bottom:g.top;i({top:Math.round(c),left:Math.round(g.left),width:Math.round(g.width)});const x=[...s.querySelectorAll(":scope .grp")];let u=null;for(const f of x){const y=f.querySelector(".grp-h");y&&y.getBoundingClientRect().bottom<=c+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((w=b.querySelector(".s"))==null?void 0:w.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Qd(e){const r=()=>{const n=Yo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Kr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Q(),[i,d]=p.useState(!1);if(p.useEffect(()=>{n||d(!1)},[n]),Pe(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const l=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(l?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}function Mn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:d,doPromote:s,doRepeche:l,doApproach:g,dispatch:c,liveMemos:x}=Q(),u=m=>v=>{v.stopPropagation(),m()};if(r.lockActions){const m=u(()=>c({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Ne(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Sa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Kr,{o:e})});const b=Ne(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Kr,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Na,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:u(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>d(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>d(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>c({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>c({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>c({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>c({type:"memoConsole",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Kd({o:e}){const{t:a,doThumb:r,thumbOf:n}=Q(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Jd({o:e}){const{lang:a}=Q();return Oe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(wt,{o:e}),t.jsx(Ia,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[At(e.engine||"")," ",Qe(e.engine||"",a)]})})}function Xd({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:s}){const{dispatch:l,caps:g,markRow:c,markedId:x,favIds:u,toggleFav:b,t:m}=Q(),v=Ne(e),w=["#16233A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,y=f<=0?0:f<=7?1:f<=30?2:3,j=g.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][v]:w[y],k=u.has(e.id),N=C=>{if(a)return;if(d){d(e.id);return}if(g.pipe||e.kind==="op"){n();return}const S=C.currentTarget.getBoundingClientRect();l({type:"popup",id:e.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+v:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>c(e.id),onMouseLeave:()=>c(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(ei,{o:e}),t.jsxs("span",{className:"nd",children:[s&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${m.cdEngagement} ${Math.round(e.engagement*10)/10} · ${m.cdEngagementHint}`,children:"🔥"}),Oe(e)&&t.jsx(wt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:C=>{C.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[We(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(C=>C&&C!==e.name)||""]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:C=>{C.stopPropagation(),l({type:"acquirer",value:e.acquirer||""})},children:["← ",Bt(e.acquirer)]}),Ge(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(Zd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Jd,{o:e}),g.pipe&&t.jsx(On,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Mn,{o:e}),g.showThumbs&&t.jsx(Kd,{o:e})]}),r&&!a&&!d&&t.jsx(ac,{o:e})]})}function Zd({o:e}){const{lang:a,caps:r}=Q();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ht(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function ec({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Q(),d=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),l=Ht(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=Pe(e),x=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),l&&t.jsx("span",{className:"oc-amt",children:l}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):We(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),oa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Bt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(sa,{spec:e.card})})]})}function tc({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Q();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Qe(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Mn,{o:e})}),t.jsx(Rn,{o:e})]})}function Qo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:s,dossiers:l}=Q(),g=p.useRef(null),c=Ge(e);if(p.useEffect(()=>{if(!c||!(e!=null&&e.decryptHtml))return;const h=g.current;if(!h)return;let A=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async $=>{await $.ensureEditoCss(),!(A||!h.isConnected)&&($.beautifyEditoRows(h),$.mountCardFits(h))}),()=>{A=!0}},[c,e==null?void 0:e.decryptHtml]),!e&&!a){const h=l.find(Ge);if(h)return t.jsx(Qo,{o:h})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!x||Ea(x),w=(e==null?void 0:e.engine)||"",f=Ge(e),y=e?Ht(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),N=l.find(Ge),C=((N==null?void 0:N.url)||"").trim(),S=!!u&&!!C&&(u===C||u.endsWith(C)||C.endsWith(u)),L=(h,A=!1)=>$=>{$.stopPropagation(),A&&d({type:"continent",key:"monde"}),d({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const q=()=>{x&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:x}}))},I=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},R=()=>{oa({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},B=e?Pe(e):!1,F=B&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",D=f?r.doEdito.replace(/^📖\s*/,""):w?Qe(w,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[D,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(v||Sa({engine:w}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(sa,{spec:m})}),(u&&!S&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!S&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),d({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[B?t.jsxs("span",{className:"verdict",style:{"--c":F?"var(--brand)":"var(--red)"},children:[F?"✓":"✗"," ",t.jsx("b",{children:F?r.kept:r.dropped})]}):!v&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:h=>{h.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Bt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(v||Sa({engine:w}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&x?" ghost":""),onClick:h=>{h.stopPropagation(),R()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!s.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),I()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),q()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Bt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&x&&s.pipe&&t.jsx(Fn,{name:x})]})]})}function ac({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=Q();return!o.pipe&&e.kind==="op"?t.jsx(ec,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Rn,{o:e}),t.jsx(hl,{o:e}),t.jsx(bl,{o:e}),t.jsx(Fn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(On,{o:e})})]}),e.card&&t.jsx(sa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[At(e.engine||"")," ",Qe(e.engine||"",r)]}),Oe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(wt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function nc({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:s,lang:l}=Q();if(!d.pipe&&e.kind==="op"){const x=Ht(e.amountEur,l),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>w=>{w.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(sa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[At(e.engine||"")," ",Qe(e.engine||"",l)]}),Oe(e)&&t.jsx(wt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Mn,{o:e})})]})}const g=Ne(e),c=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":c},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(On,{o:e}),Oe(e)&&t.jsx(wt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>s(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>s(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function rc(){const{t:e}=Q(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function oc({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Q(),i=o==="en",d=c=>n.plabels[c]||"",s=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),l=s.includes(0)?0:s.sort((c,x)=>(e[x]||0)-(e[c]||0))[0];if(l===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[l]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:l===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${d(l)}”`:`${g} dossier${g>1?"s":""} dans « ${d(l)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:l}),children:[(i?"Open ":"Ouvrir ")+d(l)," →"]})]})}function ic(){var vt,Rt,Et,Fe,nt;const e=Q(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:s,markRow:l,lang:g,sessTally:c,data:x,dossiers:u,source:b,focusExtra:m,byId:v,token:w}=e,f=ho(),y=p.useMemo(()=>{var K,le,we,P;if(!w||b==="ops")return null;const T=(((K=f==null?void 0:f.ed)==null?void 0:K.date)||(f==null?void 0:f.day)||"").slice(0,10),G=[(le=f==null?void 0:f.ed)==null?void 0:le.html,(we=f==null?void 0:f.ed)==null?void 0:we.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((P=f==null?void 0:f.ed)==null?void 0:P.date)||T,decryptHtml:G||void 0,date:T,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[w,b,g,(vt=f==null?void 0:f.ed)==null?void 0:vt.html,(Rt=f==null?void 0:f.ed)==null?void 0:Rt.acquirers_html,(Et=f==null?void 0:f.ed)==null?void 0:Et.date,f==null?void 0:f.day]),j=T=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:fo,[k,N]=p.useState(new Set);p.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[C,S]=p.useState(null);p.useEffect(()=>{S(null)},[a.ptab,a.continent]);const[L,q]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){q(!1);return}const T=document.getElementById("atl2-stage");if(!T){q(!1);return}const G=new IntersectionObserver(([K])=>q(!!K&&K.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return G.observe(T),()=>G.disconnect()},[a.mapFolded]);const I=a.mapFolded||!L,R=T=>N(G=>{const K=new Set(G);return K.has(T)?K.delete(T):K.add(T),K}),B=b==="ops"||o.pipe,[F,D]=p.useState("all"),[h,A]=p.useState(!1),[$,ee]=p.useState(null),[E,O]=p.useState(!1),M=p.useRef(!0);p.useEffect(()=>{if(M.current){M.current=!1;return}D("all"),O(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!E)return;const T=G=>{var K,le;(le=(K=G.target)==null?void 0:K.closest)!=null&&le.call(K,".atl2 .doable")||O(!1)};return document.addEventListener("click",T,!0),()=>document.removeEventListener("click",T,!0)},[E]);const V=p.useMemo(()=>{var G;const T=new Map;for(const K of el(((G=f==null?void 0:f.ed)==null?void 0:G.html)||""))T.has(K.t)||T.set(K.t,K.html);return T},[(Fe=f==null?void 0:f.ed)==null?void 0:Fe.html]),ae=p.useCallback(T=>{if(T.decryptHtml)return T.decryptHtml;if(!V.size)return;const G=(T.name||"").trim().toLowerCase();if(G.length<3)return;const K=V.get(G);if(K)return K;for(const[le,we]of V)if(le.includes(G)||G.includes(le))return we},[V]),{diff:te}=Hd(),[ge,J]=p.useState(!1),fe=a.filters.win==="1"&&!a.filters.day,[me,xe]=p.useState(!1),U=p.useMemo(()=>new Set(((te==null?void 0:te.added)||[]).map(T=>T.trim().toLowerCase()).filter(Boolean)),[te]),W=p.useMemo(()=>{if(!U.size)return 0;const T={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(G=>!Ge(G)&&U.has((G.name||"").trim().toLowerCase())&&ea(G,T,o.pipe)).length},[u,U,a,o.pipe]);p.useEffect(()=>{const T=()=>{xe(!1),A(!1),D("all"),O(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",T),()=>window.removeEventListener("ppmap:tunnel",T)},[]),p.useEffect(()=>{xe(!1),A(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const H=p.useMemo(()=>{const T=s.filter(K=>!Ge(K)&&We(K));let G="";for(const K of T){const le=(K.date||"").slice(0,10);le&&(!G||le<G)&&(G=le)}return{n:T.length,since:G?G.split("-").reverse().slice(0,2).join("/"):""}},[s]),X=H.n,_=p.useMemo(()=>{const G=me&&U.size>0||a.filters.signalOnly||F!=="all"||h?s:d;let K=zn(G,a.sort);return K=K.filter(le=>!Ge(le)),me&&U.size&&(K=K.filter(le=>U.has((le.name||"").trim().toLowerCase()))),h||F==="explore"?K=K.filter(We):F==="eval"?K=K.filter(le=>!We(le)&&!le.noCo&&(le.kind==="op"||!Pe(le))):o.pipe&&(K=K.filter(le=>!We(le))),K},[d,s,a.sort,F,me,U,h,o.pipe]),de=p.useMemo(()=>o.pipe?u.filter(T=>T.kind==="target"&&!Ge(T)&&Oe(T)&&(a.continent==="monde"||T.continent===a.continent)):_.filter(T=>Oe(T)&&!Pe(T)),[o.pipe,u,_,a.continent]).length,ye=p.useMemo(()=>o.pipe?_:_.filter(T=>!Pe(T)&&!T.noCo&&!We(T)),[_,o.pipe]),se=b==="ops"?_.filter(We).length:0,be=me?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,ce=a.filters,ze=[];if(ce.day)ze.push({k:"day",lib:n.fDay(ce.day.slice(8,10)+"/"+ce.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(ce.win&&ce.win!=="all"){const T=["1","7","30"].indexOf(ce.win);T>=0&&ze.push({k:"win",lib:n.dates[T],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ke=T=>T.length<=2?T.join(", "):`${T.length} ${n.fSelected}`;for(const T of["sector","country","engine","crible"]){const G=ce[T];G&&G.length&&ze.push({k:T,lib:Ke(G),off:()=>r({type:"clearFacet",facet:T})})}ce.search&&ze.push({k:"search",lib:"🔍 "+ce.search,off:()=>r({type:"filters",patch:{search:""}})}),me&&U.size&&ze.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>xe(!1)}),ce.signalOnly&&ze.push({k:"sig",lib:"🔴 "+n.sigDock(de||ce.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const ve=(T,G,K="",le=!1)=>t.jsxs("button",{type:"button","data-s":T,className:K,"aria-sort":a.sort.key===T?a.sort.dir===1?"ascending":"descending":"none",style:le?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:T}),children:[G,t.jsx("span",{className:"ar",children:a.sort.key===T&&a.sort.dir===1?"▴":"▾"})]},T),Se=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const T=new Map;_.forEach(le=>{const we=le.engine||"?";T.has(we)||T.set(we,[]),T.get(we).push(le)});const G={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},K=rn([...T.keys()],g);return[...T.entries()].sort((le,we)=>{const P=G[le[0]]??10+K.indexOf(le[0]),oe=G[we[0]]??10+K.indexOf(we[0]);return P-oe})},[_,o.pipe,a.groupBy,g]),Ft=Se?Se.filter(([T])=>ya.has(T)).length:0,Me=(()=>{var G;return((G=(Se?Se.flatMap(([,K])=>K):_)[0])==null?void 0:G.id)??null})(),Je=p.useRef(!1),Ae=p.useMemo(()=>u.find(Ge)||y,[u,y]);p.useEffect(()=>{const T=()=>{Je.current=!0,xe(!1)};return window.addEventListener("ppmap:reveal",T),window.addEventListener("ppmap:focus",T),()=>{window.removeEventListener("ppmap:reveal",T),window.removeEventListener("ppmap:focus",T)}},[]),p.useEffect(()=>{const T=()=>{Ae&&r({type:"focus",id:Ae.id})};return window.addEventListener("ppmap:edito",T),()=>window.removeEventListener("ppmap:edito",T)},[Ae,r]),p.useEffect(()=>{if(!a.focusId)return;ee(a.focusId);const T=window.setTimeout(()=>ee(null),900);return()=>window.clearTimeout(T)},[a.focusId]),p.useEffect(()=>{if(B&&!(a.focusId&&(_.some(T=>T.id===a.focusId)||u.some(T=>T.id===a.focusId)||a.focusId===(Ae==null?void 0:Ae.id)))&&!m){if(Ae){r({type:"focus",id:Ae.id});return}Me&&r({type:"focus",id:Me})}},[B,a.focusId,_,Me,m,r,u,b,Ae]),p.useEffect(()=>{if(!B||!a.focusId||Ae&&a.focusId===Ae.id||_.some(G=>G.id===a.focusId))return;const T=u.find(G=>G.id===a.focusId);if(T){if(Je.current){T.kind==="op"?D(We(T)?"explore":"eval"):F!=="all"&&D("all");return}F!=="all"&&Me&&r({type:"focus",id:Me})}},[B,a.focusId,F,_,u,Me,r,Ae]),p.useEffect(()=>{if(!B||!a.focusId||!Je.current)return;const T=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!T){const we=_.findIndex(P=>P.id===a.focusId);if(we>=0){const P=Se?"":"pt"+a.ptab;if(P){const oe=a.shown[P]||j();we>=oe&&r({type:"more",group:P,by:we-oe+8})}}return}Je.current=!1;const G=Yo(),K=T.getBoundingClientRect();K.top>=G-2&&K.bottom<=window.innerHeight-4||Qd(T)},[B,a.focusId,a.ptab,_,a.shown,Se,r]),p.useEffect(()=>{if(typeof window>"u")return;const T=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),G=document.querySelector(".atl2.ops, .atl2.cibles");if(!T||!G)return;const K=()=>G.style.setProperty("--listhead-h",`${T.offsetHeight}px`);K();const le=new ResizeObserver(K);return le.observe(T),()=>le.disconnect()},[I,a.dens,a.mapFolded]);const it=p.useMemo(()=>{if(!B||!a.focusId)return null;if(y&&a.focusId===y.id)return y;const T=_.find(K=>K.id===a.focusId)||u.find(K=>K.id===a.focusId)||null;if(!T)return null;const G=ae(T);return G&&G!==T.decryptHtml?{...T,decryptHtml:G}:T},[B,a.focusId,_,u,ae,y]),jt=o.lockRowsAfter;let De=0;const xt=(T,G)=>{let K=a.shown[G]||j();return T.length-K<=4&&(K=T.length),T.slice(0,K).map(P=>{const oe=jt!==null&&De>=jt;De++;const pe=ae(P),re=pe&&pe!==P.decryptHtml?{...P,decryptHtml:pe}:P,je=!B&&a.dens!=="maxi"&&(a.dens==="deplie"||(C?C==="open":!!pe)),Ie=k.has(P.id)?!je:je,Ue=B?qe=>{Je.current=!0,r({type:"focus",id:qe});const _e=v.get(qe);_e&&(We(_e)?oa(_e):_e.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:_e.name,url:_e.url||"",website:_e.website||"",domain:_e.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(nc,{o:re,locked:oe,selected:B&&a.focusId===P.id,onSelect:Ue},P.id):t.jsx(Xd,{o:re,locked:oe,open:Ie,onToggle:()=>R(P.id),selected:B&&a.focusId===P.id,echo:$===P.id,fresh:U.has((P.name||"").trim().toLowerCase()),onSelect:Ue},P.id)})},ut="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(_.length?"":" list-empty"),Xe=t.jsxs(t.Fragment,{children:[Se?Se.map(([T,G])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:At(T)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:T==="ma"?n.grpMa:T==="fundraising"?n.grpLev:ya.has(T)&&Ft<=1?n.grpNews:T==="nominations"?n.grpNom:T==="media"?n.grpNewsOther:T==="recrutements"?n.grpHire:ya.has(T)?n.grpNews+" · "+Qe(T,g):Qe(T,g)}),t.jsx("div",{className:"s",children:n.grpCount(G.filter(K=>!Pe(K)).length,G.length)})]})]}),xt(G,T)]},T)):xt(_,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(rc,{}),o.pipe&&a.ptab===0&&!h&&!me&&F==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(Uo,{}),!_.length&&!(x.loading&&!u.length)&&(o.pipe&&F==="all"?t.jsx(oc,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),Nt=t.jsxs(t.Fragment,{children:[!me&&!h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:_.length})," ",be]}),h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:_.length})," ",n.newsWord]}),(!me||h)&&t.jsx("span",{className:"dot",children:"·"}),I&&t.jsx(Bo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[I?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ze.map(T=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:G=>{G.stopPropagation(),T.off()},children:[T.lib,t.jsx("i",{children:"×"})]},T.k)),b==="ops"&&_.length>0&&!I&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",_.length-se," ",n.zoomPulseEval,se>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",se," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),bt=t.jsxs("div",{className:"listhead"+(I?" mapoff":""),children:[I&&t.jsx("div",{className:"lh-tools",children:t.jsx(_o,{compact:!0})}),o.showFunnel&&ge&&fe&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(yl,{}),t.jsx(Gd,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:Nt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Vd,{}),t.jsx(Wd,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(fe?" on":""),"aria-pressed":fe,title:n.morningDockTitle,onClick:()=>{if(fe){r({type:"filters",patch:{win:"all",day:""}}),J(!1);return}xe(!1),A(!1),D("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),J(!0)},children:["📊 ",n.morningDock(typeof((nt=x.stats)==null?void 0:nt.screened_today)=="number"?x.stats.screened_today:0)]}),te&&!te.firstVisit&&(te.added.length>0||te.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(me?" on":""),"aria-pressed":me,title:n.sinceSub,onClick:()=>{const T=!me;xe(T),A(!1),J(!1),D("all"),T&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(W),te!=null&&te.lastDate?` · ${n.sinceSince(te.lastDate)}`:""]}),de>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{xe(!1),A(!1),J(!1),D("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(de)]}),o.pipe&&X>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(h?" on":""),"aria-pressed":h,title:n.newsDockHint,onClick:()=>{const T=!h;A(T),xe(!1),J(!1),D("all"),T&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(X),H.since?` · ${n.newsSince(H.since)}`:""]})]}),!o.showFunnel&&Nt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([T,G])=>t.jsxs("button",{type:"button","data-d":T,"aria-pressed":a.dens===T||T==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:T}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:G})]},T))}),!B&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":C==="open",onClick:()=>{S("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":C==="closed",onClick:()=>{S("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var pe;const T={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},G=u.filter(re=>ea(re,T,o.pipe)&&!Ge(re)),K=G.filter(re=>!We(re)&&!re.noCo&&(re.kind==="op"||!Pe(re))).length,le=G.filter(We).length,we=o.pipe?G.filter(re=>re.kind!=="op"&&Ne(re)===1).length:0,P=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${we?` ${we}`:""}`]]:[],["eval",`${n.doEval}${K?` ${K}`:""}`],["explore",`${n.doExplore}${le?` ${le}`:""}`]],oe=((pe=P.find(([re])=>re===F))==null?void 0:pe[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":E,onClick:()=>O(re=>!re),children:[oe,t.jsx("i",{children:"▾"})]}),E&&t.jsx("div",{className:"dolist",children:P.map(([re,je])=>t.jsx("button",{type:"button","aria-pressed":F===re,onClick:()=>{if(O(!1),re==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}D(re),re!=="all"&&(xe(!1),A(!1),J(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:je},re))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:T=>r({type:"sort",key:T.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([T,G])=>t.jsx("option",{value:T,children:G},T))})]}),o.showChain&&ye.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ye.map(T=>T.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ye.length):n.chainAll(ye.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!B&&bt,a.dens!=="maxi"&&!B&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ve("country",n.colCountry),ve("name",n.colCompany),ve("amount",n.colAmount,"h-amt",!0),ve("stage",n.colStage,"h-stade"),ve("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ve("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ve("memo",n.colMemo)]}),o.pipe&&ve("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),B?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[bt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ve("country",n.colCountry),ve("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ve("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ve("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ut,children:Xe})]}),t.jsxs("aside",{className:"readpane"+((it?Ge(it):!m&&Ae)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[Ae&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===Ae.id,onClick:()=>r({type:"focus",id:Ae.id}),children:n.doEdito}),y&&a.focusId===y.id?t.jsx("div",{className:"zoom",children:t.jsx(ol,{})}):it&&o.pipe?t.jsx(tc,{o:it}):t.jsx(Qo,{o:it,extra:it?null:m})]})]}):t.jsx("div",{className:ut,children:Xe}),(()=>{const T=Se||[["pt"+a.ptab,_]];let G=0,K=0;for(const[we,P]of T){K+=P.length;let oe=a.shown[we]||j();P.length-oe<=4&&(oe=P.length),G+=Math.min(P.length,oe)}const le=K-G;return le<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>T.forEach(([we,P])=>r({type:"more",group:we,by:P.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(le,le)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(G,K)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}}),B&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Yd,{on:!!Se,rev:(Se||[]).map(([T,G])=>T+G.length).join("|")})]})}function Jr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function sc(e,a){const r=Ki(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function lc(e,a){const n=[a.head.split("|").map(Jr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",sc(o,a.plabels),ia(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Jr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function dc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const cc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function dt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function pc({o:e,qa:a}){const{t:r,lang:n,fund:o}=Q(),i=(e.cribleStatus||"").trim().toUpperCase()||(ia(e)==="NO MATCH"?"NO MATCH":"MATCH"),d=kt(e),s=(a==null?void 0:a.blocs)||{},l=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,d&&t.jsx("em",{children:d})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(dt,{k:r.cdSector,v:e.sector}),t.jsx(dt,{k:r.cdStage,v:e.stage}),t.jsx(dt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(dt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(dt,{k:r.cdName,v:e.contactName}),t.jsx(dt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(dt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(dt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(dt,{k:r.cdAngle,v:e.angle}),t.jsx(dt,{k:r.cdDetected,v:cc(e.date,n)})]}),l.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),l.filter(([,g])=>g).map(([g,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:c})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function uc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d}=Q(),[s,l]=p.useState({}),g=25,c=p.useMemo(()=>n.slice(0,g),[n]);p.useEffect(()=>{c.length&&co(r,c.map(b=>b.name)).then(l)},[r,c]);const x=i.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(x.screened/i.marketEstimate*100)," %"]})]})]}),c.map(b=>t.jsx(pc,{o:b,qa:s[b.name]},b.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const mc=50;function Dn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Q(),[i,d]=p.useState(null),[s,l]=p.useState(!1),[g,c]=p.useState(""),[x,u]=p.useState(0),[b,m]=p.useState(""),[v,w]=p.useState(!1),[f,y]=p.useState(0),j=p.useRef(null),k=p.useRef(null),N=()=>{y(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>y(q=>q+1),1e3)},C=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};p.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),k.current&&window.clearInterval(k.current)},[]);const S=async q=>{l(!0),c(""),N();const I=await a();if(l(!1),C(),I.ok){d(I);return}if(I.busy){c(o.alertPreviewBusy);return}if(!q){c(o.alertPreviewFail);return}u(mc),C(),j.current=window.setInterval(()=>{u(R=>R>1?R-1:(j.current&&window.clearInterval(j.current),S(!1),0))},1e3)},L=async()=>{if(n||v||s)return;w(!0),m(""),N();const q=await r();w(!1),C(),m(q.ok?o.alertTestOk(q.sentTo||""):q.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||v||x>0,onClick:()=>{S(!0)},children:s?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||s,onClick:()=>{L()},children:v?o.alertBtnTestBusy:o.alertTest})]}),s&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const ht="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ve({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=Q();return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function fc(){const{st:e}=Q();switch(e.modal){case"chain":return t.jsx(gc,{});case"space":return t.jsx(xc,{});case"alert":return t.jsx(bc,{});case"queue":return t.jsx(jc,{});case"export":return t.jsx(Nc,{});case"plug":return t.jsx(Cc,{});case"approach":return t.jsx(zc,{});case"recharge":return t.jsx(Tc,{});case"cover":return t.jsx(Fc,{});case"dossier":return t.jsx(Lc,{});case"crit":return t.jsx(Mc,{});case"tuto":return t.jsx(Dc,{});case"rdv":return t.jsx(hc,{});case"memoalert":return t.jsx(Ec,{});default:return null}}function hc(){const{dispatch:e,fund:a,t:r}=Q(),n=a||r.rdvCoFallback;return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:bo,children:qn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(ks,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function gc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:s,caps:l,memoQueued:g,doAnalyse:c}=Q(),x=i==="client",u=e.chain.queue.map(w=>r.get(w)).filter(w=>!!w),b=e.chain.idx,m=u[b],v=b>=u.length;return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Ut(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(gt(m.date))].filter(Boolean).map(w=>String(w)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Qe(m.engine,o)}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Ht(m.amountEur,o)})]}),Oe(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(wt,{o:m,lg:!0})," ",t.jsx(Ia,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&Pe(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&Pe(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":zt(m)==="retenu"?"var(--brand)":zt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:zt(m)==="retenu"?"✓ "+n.kept:zt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&l.pipe&&Ne(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(x&&Pe(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var w;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(w=document.querySelector(".atl2 .demand"))==null||w.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{d(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function xc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Q(),i=o==="client",d=p.useMemo(()=>i?r.filter(x=>Pe(x)):[],[r,i]),s=p.useMemo(()=>zn(d.filter(x=>zt(x)==="retenu"),{key:"signal",dir:-1}),[d]),l=p.useMemo(()=>d.filter(x=>zt(x)==="ecarte"),[d]),g=e.spaceTab==="retenu"?s:l,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ve,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:l.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function bc(){const{mode:e}=Q();return e==="client"||e==="apercu"?t.jsx(vc,{}):t.jsx(kc,{})}function vc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Q(),[i,d]=p.useState("d"),s=o!=="client";return t.jsxs(Ve,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(yc,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(wc,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(Ko,{})]})}function yc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[s,l]=p.useState(!1),[g,c]=p.useState(0);p.useEffect(()=>{let L=!0;return l(!1),ar(a).then(q=>{L&&(q?d(q):l(!0))}),()=>{L=!1}},[a,g]);const x=p.useRef({}),[u,b]=p.useState({}),[m,v]=p.useState(!1),[w,f]=p.useState(!1),y=p.useRef(null);p.useEffect(()=>()=>{y.current&&window.clearTimeout(y.current)},[]);const j=L=>{const q=x.current;Object.keys(q).length&&(v(!0),ar(a,q).then(I=>{if(!I){v(!1),o(e.actErr);return}if(I.throttled&&L<3){y.current=window.setTimeout(()=>j(L+1),5400);return}if(x.current={},b({}),d(I),v(!1),I.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},k=L=>{r||(x.current={...x.current,...L},b(q=>({...q,...L})),y.current&&window.clearTimeout(y.current),y.current=window.setTimeout(()=>j(1),700))};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...u},C=L=>!N.sections||N.sections.includes(L),S=L=>{const q=N.sections||e.alertSec.map(([I])=>I);k({sections:C(L)?q.filter(I=>I!==L):[...q,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&w&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,q])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:C(L),disabled:r,onChange:()=>S(L)}),t.jsxs("span",{children:[q,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Dn,{label:e.alertPreview,readOnly:r,onPreview:()=>ds(a),onTest:()=>ls(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function wc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[s,l]=p.useState(!1),[g,c]=p.useState(0);p.useEffect(()=>{let m=!0;return l(!1),nr(a).then(v=>{m&&(v?d(v):l(!0))}),()=>{m=!1}},[a,g]);const x=m=>{r||nr(a,m).then(v=>{if(!v){o(e.actErr);return}d(v),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Dn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ps(a),onTest:()=>cs(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ko(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Q(),[d,s]=p.useState(i||""),[l,g]=p.useState(!1),[c,x]=p.useState(!1);p.useEffect(()=>{i&&s(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(f=>Oe(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(d)||c)){x(!0);try{await fetch(`${Da}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},w=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Qe(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>Ut(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return l?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:w.map(([f,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function kc(){const{t:e}=Q();return t.jsx(Ve,{title:e.alertTitle,icon:"🔔",children:t.jsx(Ko,{})})}function jc(){var R,B;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:s,dispatch:l,liveMemos:g}=Q(),[c,x]=p.useState(()=>$a(r)),[u,b]=p.useState(()=>!$a(r)),[m,v]=p.useState([]),[w,f]=p.useState(0),y=n==="client",j=p.useMemo(()=>{const F=new Map;return o.forEach(D=>{const h=(D.name||"").trim().toLowerCase();h&&!F.has(h)&&F.set(h,D)}),F},[o]);p.useEffect(()=>{let F=!0;return(!$a(r)||w>0)&&b(!0),(async()=>{const[D,h]=await Promise.all([En(r,w>0),ro(a)]);F&&(D&&x(D),b(!1),v(h))})(),()=>{F=!1}},[a,r,w]);const k=u&&!c,N=(c==null?void 0:c.per_day)??0,C=((R=c==null?void 0:c.analyzed_today)==null?void 0:R.length)??0,S=c==null?void 0:c.offre,L=(c==null?void 0:c.pool_meta)||[],q=p.useMemo(()=>{const F=new Map;for(const D of(c==null?void 0:c.scheduled)||[])for(const h of D.names||[])F.has(h)||F.set(h,{label:D.day_label,date:D.date});return F},[c==null?void 0:c.scheduled]),I=(c==null?void 0:c.in_progress)||[];return t.jsxs(Ve,{title:e.queueTitle,wide:!0,children:[S&&t.jsxs("div",{className:"qoffre"+(S.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:S.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:S.delai})]}),t.jsx("span",{className:"osp"}),S.rythme>0?t.jsx("span",{className:"or",children:e.qRate(S.rythme)}):S.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(S.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(C,C+(((B=c==null?void 0:c.pool_order)==null?void 0:B.length)??0))}})}),S&&t.jsxs("div",{className:"qeta",children:[S.file===0?e.qEtaDone:S.rythme<=0?e.qEtaPaused:e.qEta(S.file,S.rythme,S.jours_restants),S.en_retard&&t.jsxs("em",{children:[" ",e.qLate(S.delai,S.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(S==null?void 0:S.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(I.length>0||g.items.some(F=>F.status==="boot"||F.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(F=>F.status==="boot"||F.status==="running"||F.status==="error").map(F=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:F.name}),t.jsx("span",{className:"qd",children:F.memoType||""}),t.jsx(Na,{item:F,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+F.name)),I.filter(F=>!g.liveOf(F.name)).map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.name}),t.jsxs("span",{className:"qd",children:[F.memo_type||"",F.age_min?` · ${Math.round(F.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:F.state||""})]},"ip-"+F.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.company}),t.jsxs("span",{className:"qd",children:[F.memo_type,typeof F.est_min=="number"?` · ~${F.est_min} min`:""]}),t.jsx("span",{className:"qt",children:F.status}),F.url&&t.jsx("a",{className:"qgo",href:F.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(F.memo_type)}),y&&F.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{er(a,F.company,"retry").then(()=>f(D=>D+1))},children:e.queueRetry}),y&&F.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{er(a,F.company,"delete").then(()=>f(D=>D+1))},children:e.queueDelete})]},F.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((F,D)=>{const h=q.get(F.name),A=j.get((F.name||"").trim().toLowerCase()),$=g.liveOf(F.name),ee=!!(A&&d.has(A.id))||!!($&&($.status==="boot"||$.status==="running")),E=!!(A&&Ne(A)===1&&!A.memoUrl)&&!$;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",D+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:F.name}),F.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof F.score=="number"&&t.jsx("span",{className:"qs2",children:F.score}),$&&($.status==="boot"||$.status==="running")&&t.jsx(Na,{item:$,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),E&&(s.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>l({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:ee,onClick:()=>{i(A),f(O=>O+1)},children:ee?e.actAnalyseQueued:e.actAnalyse})),F.excerpt&&t.jsx("span",{className:"qex",children:F.excerpt})]},F.name+":"+D)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([F,D])=>t.jsxs("li",{children:[t.jsx("b",{children:F})," — ",D]},F))})]})}function Nc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=Q(),s=`${ht}/cibles/list.csv?token=${a}`,l=`${ht}/cibles/list.json?token=${a}`,g=`${ht}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,x=w=>{var f;(f=navigator.clipboard)==null||f.writeText(w).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:l,href:l},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{dc(lc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:w=>(e.stg.find(([f])=>f===w)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ve,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:w,value:f,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:w[0]}),t.jsxs("div",{children:[t.jsx("b",{children:w[1]}),t.jsx("p",{children:w[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},w[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Ec(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Q(),i=o!=="client",[d,s]=p.useState(null),[l,g]=p.useState(!1),[c,x]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let f=!0;return g(!1),Xn(a).then(y=>{f&&(y?s(y):g(!0))}),()=>{f=!1}},[a,c]);const m=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=f=>{if(i||!d)return;const y={enabled:f.enabled??!!d.enabled,email:f.email??(d.email||""),sections:f.sections??m()};b(!0),Xn(a,y).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(l)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!d)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const w=m();return t.jsxs(Ve,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||u,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(Sc,{value:d.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>v({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!w[f],disabled:i||u,onChange:()=>v({sections:{...w,[f]:!w[f]}})}),t.jsx("span",{children:y})]},f))}),t.jsx(Dn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Xi(a,w),onTest:()=>Ji(a,w)})]})}function Sc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=p.useState(e);p.useEffect(()=>{d(e)},[e]);const s=i.trim()!==e.trim(),l=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>d(g.target.value),onKeyDown:g=>{g.key==="Enter"&&s&&l&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!l,onClick:()=>o(i.trim()),children:n})]})]})}function Cc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Q(),[i,d]=p.useState(null),[s,l]=p.useState(!1),[g,c]=p.useState(null),[x,u]=p.useState(!1),[b,m]=p.useState(""),[v,w]=p.useState(0),[f,y]=p.useState("webhook"),[j,k]=p.useState(""),N=p.useRef(!1);p.useEffect(()=>{let R=!0;return l(!1),Zn(a).then(B=>{R&&(B?d({configured:B.configured,url_hint:B.url_hint}):l(!0))}),as(a).then(B=>{if(R){if(!B){u(!0);return}u(!1),c(B),N.current||(N.current=!0,B.destination==="instantly"&&y(F=>F==="webhook"?"instantly":F),B.campaign_id&&k(F=>F||B.campaign_id||""))}}),()=>{R=!1}},[a,v]);const C=(R,B)=>{o&&Zn(a,R).then(F=>{if(!F||F.ok===!1){n(e.actErr);return}R.test&&F.sent===!1?n(e.plugTestThrottled):r(B),w(D=>D+1)})},S='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',L=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),q=`curl -X POST ${ht}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,I=`curl -X POST ${ht}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`;return t.jsxs(Ve,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>w(R=>R+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:R=>m(R.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>C({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>C({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>C({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(qc,{destKind:f,setDestKind:y,camp:j,setCamp:k,whHint:i!=null&&i.configured?i.url_hint||"webhook":null}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugVarsT}),t.jsx("p",{className:"mnote",children:e.plugVars})]}),t.jsx(Ac,{auto:g,autoKo:x,destKind:f,camp:j,onRetry:()=>w(R=>R+1),onDone:R=>{c(R),u(!1)}}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:q}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(q).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:S}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(S).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:I}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(I).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function zc(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:s}=Q(),l=p.useMemo(()=>r.find(h=>h.id===n.approachId)||null,[r,n.approachId]),[g,c]=p.useState("email"),[x,u]=p.useState(0),[b,m]=p.useState({}),[v,w]=p.useState(!1),[f,y]=p.useState(""),[j,k]=p.useState({});if(p.useEffect(()=>{!l||b[g]||v||(w(!0),y(""),ts(a,l.name,g).then(h=>{if(w(!1),!h||h.ok===!1){y((h==null?void 0:h.error)||e.apprFail);return}m(A=>({...A,[g]:h}))}))},[l,g,a]),!l)return null;const N=b[g],C=(N==null?void 0:N.sequence)||[],S=C[x],L=h=>`${g}|${x}|${h}`,q=h=>{const A=L(h);return A in j?j[A]:String(((S==null?void 0:S[h])??"")||"")},I=(h,A)=>k($=>({...$,[L(h)]:A})),R=L("subject")in j||L("body")in j||L("message")in j,B=q(g==="email"?"body":"message"),F=q("subject"),D=g==="email"&&F?`${F}

${B}`:B;return t.jsxs(Ve,{title:e.apprT(l.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(h=>t.jsx("button",{type:"button",className:"apch"+(g===h?" on":""),"aria-pressed":g===h,onClick:()=>{c(h),u(0)},children:h==="email"?e.apprChEmail:e.apprChLi},h)),t.jsx("span",{className:"sp"}),C.map((h,A)=>t.jsxs("button",{type:"button",className:"apday"+(x===A?" on":""),"aria-pressed":x===A,onClick:()=>u(A),children:[h.day||`J${A}`,[`${g}|${A}|subject`,`${g}|${A}|body`,`${g}|${A}|message`].some($=>$ in j)&&t.jsx("i",{children:"✎"})]},h.day||A))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,N!=null&&N.sender?" · "+e.apprSender(N.sender):""]}),v&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!f&&!v&&t.jsxs("p",{className:"mnote warn",children:[f," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{m(h=>{const A={...h};return delete A[g],A}),y("")},children:e.retry})]}),!v&&!f&&!S&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),S&&t.jsxs(t.Fragment,{children:[g==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:F,onChange:h=>I("subject",h.target.value)})]}),g==="linkedin"&&x===0&&(N==null?void 0:N.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:B,onChange:h=>I(g==="email"?"body":"message",h.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var h;(h=navigator.clipboard)==null||h.writeText(D).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),g==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(l.contactEmail||"")}?subject=${encodeURIComponent(F)}&body=${encodeURIComponent(B)}`,children:e.apprMailto}),R&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Ac({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:s,flash:l,flashErr:g,canWrite:c}=Q(),[x,u]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),v=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,w=()=>{if(x||!c||m)return;u(!0),(b?tr(s,!1):tr(s,!0,r,n.trim()||void 0)).then(y=>{if(u(!1),!y){g(d.actErr);return}o(y),l(y.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!c||!!m,title:m||void 0,onClick:w,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),m===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:m}),v&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function qc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:s,canWrite:l}=Q(),[g,c]=p.useState("valides"),[x,u]=p.useState(!1),[b,m]=p.useState(null),[v,w]=p.useState(null),[f,y]=p.useState(!1),[j,k]=p.useState(!1),[N,C]=p.useState(null),[S,L]=p.useState(null),q=`atl2:bulk:${d}:${g}:${e}`;p.useEffect(()=>{m(null),w(null),y(!1),C(null);try{const O=localStorage.getItem(q)||localStorage.getItem(`atl2:bulk:${d}:${g}`),M=JSON.parse(O||"null");L(M&&Date.now()-Date.parse(M.t)<24*3600*1e3?M:null)}catch{L(null)}},[q,g,d]);const I=e==="instantly"&&!r.trim(),R=`${g}|${e}|${r.trim()}`,B=async()=>{if(I||!l)return;u(!0),y(!1),C(null);const O=await is(d,g,e,r.trim()||void 0);m(O),w(O.ok?R:null),u(!1)},F=p.useRef(!1);if(!l)return null;const D=async()=>{if(F.current||!l)return;F.current=!0,k(!0);const O=`${d}:${g}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await ss(d,g,e,r.trim()||void 0,O)}finally{F.current=!1}if(k(!1),y(!1),C(M),M.ok&&(M.pushed||0)>0){const V={t:new Date().toISOString(),n:M.pushed||0};L(V);try{localStorage.setItem(q,JSON.stringify(V))}catch{}}};f&&v!==null&&v!==R&&y(!1);const h=o,A=b!=null&&b.ok&&b.ready||0,$=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":h||"",ee=!!(b!=null&&b.ok)&&v===R&&A>0&&!!$&&!S,E=S?new Date(S.t).toLocaleString(s==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:g,onChange:O=>c(O.target.value),children:i.plugBulkTabs.map(([O,M])=>t.jsx("option",{value:O,children:M},O))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:O=>a(O.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:O=>n(O.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||I,onClick:()=>{B()},children:x?"…":i.plugBulkPreview})]}),I&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),S&&t.jsx("p",{className:"mnote",children:i.bulkLocked(E,S.n)}),!S&&!!(b!=null&&b.ok)&&!$&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!S&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),ee&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>y(!0),children:i.bulkArm}),ee&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(A,$)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:j,onClick:()=>{D()},children:j?i.bulkSending:i.bulkConfirm($)}),t.jsx("button",{type:"button",className:"abtn",disabled:j,onClick:()=>y(!1),children:i.bulkCancel})]}),N&&(N.ok?N.replayed?t.jsx("p",{className:"mnote",children:N.pending?i.bulkPending:i.bulkReplayed}):(N.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(N.pushed||0,N.linkedinReady||0,N.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:N.error||i.actErr}))]})}function Tc(){const{t:e,data:a,lang:r}=Q(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const s=window.location.href.split("?")[0];try{const g=await(await fetch(`${Da}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ve,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(d.credits,d.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Lc(){const{t:e}=Q();return t.jsx(Ve,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(uc,{})})}function Fc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:s}=Q(),[l,g]=p.useState(null),[c,x]=p.useState(!1);p.useEffect(()=>{let q=!0;if(i)return En(i).then(I=>{q&&I&&typeof I.per_day=="number"&&g(I.per_day)}),()=>{q=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let q=!0;return es(o).then(I=>{q&&b(I)}),()=>{q=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(q=>q.kind==="target"&&Pe(q)).length,w=r.marketEstimate||0,f=w>0?Math.min(100,Math.round(v/w*100)):null,y=(m==null?void 0:m.window_days)||30,j=v>0?v/y:0,k=w>0?Math.max(0,w-v):0,C=w>0&&j>0&&v>=100?Math.round(k/j):null,S=q=>Math.round(q).toLocaleString(a==="en"?"en-US":"fr-FR"),L=q=>{c||!d||(x(!0),rs(o,q).then(I=>{if(x(!1),I===null){s(e.actErr);return}g(I),s(e.alertSaved)}))};return t.jsxs(Ve,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(S(v))}),w>0&&t.jsx("span",{children:e.covOf(S(w))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),C!==null&&t.jsx("p",{className:"mnote",children:e.covEta(C)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(S(j))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((q,I)=>t.jsxs("tr",{className:q.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[q.code,q.geo?` · ${q.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof q.n=="number"?S(q.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:q.source}),q.elargi&&t.jsx("em",{children:e.covWide(String(q.demande||""))}),q.erreur&&t.jsx("em",{children:e.covMissing})]})]},I)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:S(u.total||w)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&l!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(l)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(q=>t.jsx("button",{type:"button",className:l===q?"on":"",disabled:c,onClick:()=>L(q),children:q===0?"⏸":q},q))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function Jo(e,a,r){const n=await fetch(`${ht}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${ht}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Rc(){const{t:e,token:a,canWrite:r}=Q(),[n,o]=p.useState(null),[i,d]=p.useState(""),[s,l]=p.useState(""),[g,c]=p.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=p.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const m=JSON.parse(localStorage.getItem(x)||"null");return!!m&&Date.now()-(m.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(p.useEffect(()=>{if(!r)return;let m=!0;return ns(a).then(v=>{m&&o(v)}),()=>{m=!1}},[a,r]),!r||g||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),Jo(a,n.instruction||"","atelier2-avis").then(m=>{if(d(m.applied?"ok":"ko"),m.applied||l(m.encours?e.propSlow:m.reply),m.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:s||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{c(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Oc(){var N;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=Q(),[i,d]=p.useState(!1),[s,l]=p.useState(null),[g,c]=p.useState(!1),[x,u]=p.useState([]),[b,m]=p.useState(null),[v,w]=p.useState([]);if(!r)return null;const f=()=>{d(!0),c(!1),u([]),w([]),os(a).then(C=>{if(d(!1),!C){c(!0),l(null);return}l(C)})},y=C=>{b||(m(C.title),Jo(a,C.instruction,"atelier2-prop").then(S=>{m(null),S.applied?(w(L=>[...L,C.title]),n(e.propApplied)):S.encours?n(e.propSlow):o(S.reply||e.propApplyFail)}))},j=((s==null?void 0:s.proposals)||[]).filter(C=>!x.includes(C.title)&&!v.includes(C.title)),k=((N=s==null?void 0:s.counts)==null?void 0:N.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:f,children:i?e.propWait:e.propBtn}),!i&&g&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!g&&s&&!(s.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:s.reason==="not_enough_signals"?e.propFew(k):e.propNone}),j.map(C=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[C.section]||C.section}),t.jsx("p",{className:"propt",children:C.title}),C.why&&t.jsx("p",{className:"mnote dim",children:C.why}),C.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",C.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>y(C),children:b===C.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(S=>[...S,C.title]),children:e.propSkip})]})]},C.title))]})}function Mc(){var f,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:s}=Q(),l=n==="client",g=p.useMemo(()=>{const k=new Set;return a.forEach(N=>{N.angle&&k.add(N.angle)}),[...k]},[a]),[c,x]=p.useState(""),[u,b]=p.useState(""),[m,v]=p.useState(!1),w=async()=>{const k=c.trim();if(!(!k||m||!l)){v(!0),b("");try{const C=await(await fetch(`${ht}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(C.reply&&b(String(C.reply)),C.job_id){b(e.critChatRunning);const S=async()=>{const L=await fetch(`${ht}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:C.job_id})}).then(q=>q.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),v(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{S()},8e3)};setTimeout(()=>{S()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||v(!1)}}};return t.jsxs(Ve,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var N,C;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((N=k.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(S=>t.jsx("li",{children:S},S))})]}),!!((C=k.out)!=null&&C.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(S=>t.jsx("li",{children:S},S))})]})]})]},k.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsx(Rc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!l||m,onChange:k=>x(k.target.value),onKeyDown:k=>{k.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!l||m||!c.trim(),onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(Oc,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Zi,{fund:d,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Go[k]||"v-cons"),children:k}),t.jsx("span",{children:N})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",N]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Dc(){const{t:e,dispatch:a,startTour:r}=Q(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Ve,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const Xo="atl2:mapfold",Ic=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Xo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Pc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Zo=p.createContext(null),Q=()=>{const e=p.useContext(Zo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function wt({o:e,lg:a}){const{lang:r}=Q(),n=Oe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:rr(n,r),children:[n.emoji," ",rr(n,r)]}):null}function Ia({o:e,src:a}){const{lang:r,t:n}=Q(),o=Oe(e);if(!o)return null;const i=xs(o),d=bs(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(po(o,r))+" · "+n.win7(uo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,l)=>t.jsx("i",{className:l<i?"on":""},l))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function _c(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=$e(a);if(o)return e.find(i=>$e(i.name)===o)||e.find(i=>{const d=$e(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Bc(){const{scoped:e,t:a,st:r,dispatch:n}=Q(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(x=>!Ge(x)),s=d.length,l=d.filter(x=>!x.noCo).length,g=d.filter(x=>!!x.noCo).length,c=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:c?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:s}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",l," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function $c(){const{t:e,lang:a,data:r,dispatch:n}=Q(),o=r.stats,i=s=>s.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const d=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:d>0?e.covOf(i(d)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function ei({o:e}){const{lang:a}=Q(),r=gs(e.cc),n=e.cc?Ut(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Uc=!1;function Hc(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const ti=e=>`atl2:tour:${e||"anon"}`;function Vc(e){try{return localStorage.getItem(ti(e))==="1"}catch{return!0}}function Xr(e){try{localStorage.setItem(ti(e),"1")}catch{}}function Wc(e,a,r,n,o,i,d){const s=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:s.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:s.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:s.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:s.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Jc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var In;const{lang:d}=us(),s=Ds[d],l=Qs(e,d,a),[g,c]=p.useReducer(Xs,void 0,()=>Ks((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Pc():Ic()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=p.useRef(!0);p.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Xo,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const z=()=>{window.innerWidth<=760&&c({type:"mapFold",folded:!0})};return z(),window.addEventListener("resize",z),()=>window.removeEventListener("resize",z)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var z;(z=u.current)==null||z.call(u,g.filters)},[g.filters]);const[b,m]=p.useState(()=>{if(typeof window>"u")return"both";try{const z=localStorage.getItem("atl2:chrome-mode");if(z==="eval"||z==="filt"||z==="both")return z;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,w]=p.useState(null),[f,y]=p.useState(null),[j,k]=p.useState(null),[N,C]=p.useState({kept:0,dropped:0}),[S,L]=p.useState(!1),[q,I]=p.useState(""),[R,B]=p.useState(!1),[F,D]=p.useState(null),[h,A]=p.useState(!1),[$,ee]=p.useState(!1),[,E]=p.useState(0),O=()=>E(z=>z+1),M=p.useRef([]),V=p.useRef(new Set),ae=p.useRef(new Set),[te,ge]=p.useState([]),[J,fe]=p.useState([]),[me,xe]=p.useState(0),U=p.useRef(new Map),W=p.useRef(null),{mode:H}=l,X=p.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),_=X.pipe,ne=l.session.token||"",de=H==="client"&&!e;p.useEffect(()=>{if(!ne||!_)return;let z=!0;const Z=async()=>{const ue=await vs(ne);!z||!ue||(fe(ue.runs),xe(Date.now()/1e3-ue.now),ge(He=>He.filter(Ee=>!ue.runs.some(Be=>$e(Be.company)===$e(Ee.name)))))};Z();const Y=te.length>0||J.some(ue=>ue.status==="running"),ie=window.setInterval(()=>{Z()},Y?8e3:25e3);return()=>{z=!1,window.clearInterval(ie)}},[ne,_,te.length,J.some(z=>z.status==="running")]);const ye=p.useMemo(()=>{const z=[],Z=new Set;for(const Y of te){const ie=$e(Y.name);!ie||Z.has(ie)||(Z.add(ie),z.push({name:Y.name,id:Y.id,status:"boot",started:Y.started,estMin:Y.estMin,memoType:"instant"}))}for(const Y of J){const ie=$e(Y.company);if(!ie||Z.has(ie))continue;Z.add(ie);const ue=Y.status==="error"?"error":Y.status==="done"?"done":"running";z.push({name:Y.company,status:ue,started:Y.started||0,estMin:Y.est_min||(Y.memo_type==="detailed"?40:15),url:Y.url,error:Y.error,memoType:Y.memo_type,note:Y.note})}return z},[te,J]),se=z=>ye.find(Z=>$e(Z.name)===$e(z))||null,be=(z,Z)=>{ge(Y=>Y.some(ie=>$e(ie.name)===$e(z.name))?Y:[...Y,{name:z.name,id:z.id,started:Date.now()/1e3,estMin:Z==="detailed"?40:15}]),V.current.add(z.id),O()},ce=(z,Z=!1)=>{I(z),B(Z),W.current&&clearTimeout(W.current),W.current=setTimeout(()=>I(""),Z?4200:2400)},ze=z=>ce(z,!0),Ke=p.useMemo(()=>{const z=new Map;return l.dossiers.forEach(Z=>{Z.id&&z.set(Z.id,Z)}),z},[l.dossiers]),ve=p.useMemo(()=>l.dossiers.filter(z=>ea(z,g,_)),[l.dossiers,g,_]),Se=p.useRef(!1);p.useEffect(()=>{if(Se.current||e||l.loading||!l.dossiers.length)return;if(!X.showFunnel||Vc(l.session.token||"")){Se.current=!0;return}Se.current=!0;const z=window.setTimeout(()=>{Xr(l.session.token||""),A(!0)},700);return()=>window.clearTimeout(z)},[e,l.loading,l.dossiers.length,X.showFunnel,l.session.token]);const Ft=p.useMemo(()=>l.dossiers.filter(z=>Zs(z,g,_,l.favIds)),[l.dossiers,g,_,l.favIds]),Me=p.useMemo(()=>ms(ve.filter(z=>!We(z)),l.favIds),[ve,l.favIds]),Je=p.useRef(!1);p.useEffect(()=>{if(Je.current)return;if(!_||a==="ops"){Je.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Je.current=!0;return}if(l.loading)return;Je.current=!0;const z=fs(Me);z!==g.ptab&&c({type:"ptab",tab:z})},[_,a,n==null?void 0:n.ptab,l.loading,Me,g.ptab]);const Ae=p.useMemo(()=>{const z=yo(l.dossiers);return z?gt(z)===0?s.tourToday:wo(z,d):s.tourNoRun},[l.dossiers,s,d]),it=p.useMemo(()=>l.dossiers.some(z=>!!z.memoUrl||!!z.summary||It(z)),[l.dossiers]),[jt,De]=p.useState(!1);p.useEffect(()=>{if(l.loading){De(!1);return}if(l.dossiers.length>0||l.error){De(!0);return}const z=window.setTimeout(()=>De(!0),6e3);return()=>window.clearTimeout(z)},[l.loading,l.dossiers.length,l.error]);const xt=(l.marketEstimate||0)>0||typeof((In=l.stats)==null?void 0:In.screened)=="number"&&l.stats.screened>0,ut=p.useMemo(()=>[1,0,2,4,5,3].find(z=>(Me[z]||0)>0)??0,[Me]),Xe=Sn.find(z=>z.key===g.continent),Nt=g.continent==="monde"?s.contWorld:(d==="fr"?Xe==null?void 0:Xe.fr:Xe==null?void 0:Xe.en)||"";p.useEffect(()=>{const z=Z=>{var ie;const Y=(((ie=Z.detail)==null?void 0:ie.name)||"").trim();Y&&bt(null,Y)};return window.addEventListener("ppmap:evaluate",z),()=>window.removeEventListener("ppmap:evaluate",z)}),p.useEffect(()=>{const z=Z=>{const Y=Z.detail||{},ie=String(Y.id||"").trim(),ue=String(Y.name||"").trim(),He=String(Y.url||"").trim(),Ee=ie&&Ke.get(ie)||_c(l.dossiers,ue,He);if(Ee){if(y(null),ea(Ee,g,_)||(g.continent!=="monde"&&Ee.continent!==g.continent&&c({type:"continent",key:Ee.continent||"monde"}),c({type:"reset"})),_&&Ee.kind!=="op"){const st=Ne(Ee);typeof st=="number"&&st!==g.ptab&&c({type:"ptab",tab:st})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),c({type:"focus",id:Ee.id}),(Ee.noCo||["media","nominations","recrutements"].includes(Ee.engine||""))&&(Ee.url||Ee.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee.url||"",text:[Ee.headline,Ee.tagline].filter(Boolean).join(`
`)}})):Ee.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ee.name,url:Ee.url||"",website:Ee.website||"",domain:Ee.domain||""}}));return}!ue&&!He||(c({type:"focus",id:ie||null}),y({name:ue,headline:String(Y.text||"").trim()||ue,url:He,card:Y.card}),He&&(Ea(ue)||!ue)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:He,text:String(Y.text||"").trim()}})):ue&&!Ea(ue)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ue}})))};return window.addEventListener("ppmap:focus",z),()=>window.removeEventListener("ppmap:focus",z)}),p.useEffect(()=>{const z=ie=>{const ue={},He=String((ie==null?void 0:ie.sector)||"").trim();He&&(ue.sector=[He]);const Ee=String((ie==null?void 0:ie.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ee)&&(ue.day=Ee);const Be=String((ie==null?void 0:ie.search)||"").trim();Be&&(ue.search=Be);const st=String((ie==null?void 0:ie.dealKind)||"").trim();(st==="ma"||st==="levee"||st==="other")&&(ue.dealKind=[st]),Object.keys(ue).length&&c({type:"filters",patch:ue})},Z=ie=>z(ie.detail),Y=ie=>{ie.data&&ie.data.type==="pp-filter"&&z(ie.data)};return window.addEventListener("ppmap:filter",Z),window.addEventListener("message",Y),()=>{window.removeEventListener("ppmap:filter",Z),window.removeEventListener("message",Y)}},[]),p.useEffect(()=>{const z=Z=>{var ue;const Y=(((ue=Z.detail)==null?void 0:ue.name)||"").trim().toLowerCase();if(!Y)return;const ie=l.dossiers.find(He=>(He.name||"").trim().toLowerCase()===Y);ie&&c(a==="ops"?{type:"focus",id:ie.id}:{type:"popup",id:ie.id})};return window.addEventListener("ppmap:similar",z),()=>window.removeEventListener("ppmap:similar",z)});const bt=(z,Z,Y)=>{const ie=(Y||(z==null?void 0:z.name)||Z||"").trim();if(!de){k({kicker:ie});return}!ie||S||(L(!0),(async()=>{try{let ue=(Z||ie).trim();const He=((z==null?void 0:z.website)||(z==null?void 0:z.domain)||"").trim();if(!(/^https?:\/\//i.test(ue)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(ue)&&!/\s/.test(ue)))if(He)ue=He;else try{const Re=await Cn(ie);if(Re!=null&&Re.website)ue=Re.website;else if(((Re==null?void 0:Re.candidates)||[]).length===1)ue=Re.candidates[0].url;else if(((Re==null?void 0:Re.candidates)||[]).length>1){M.current=[{name:ie,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(Re.candidates||[]).slice(0,5)},...M.current].slice(0,8),O();return}}catch{}const Be=await io(ne,ue,"atelier2"),st={name:Be.company||ie,verdict:Be.verdict,reason:Be.reason||"",remaining:Be.remaining??null};M.current=[st,...M.current].slice(0,8),Be.verdict==="kept"&&C(Re=>({...Re,kept:Re.kept+1})),Be.verdict==="ruled_out"&&C(Re=>({...Re,dropped:Re.dropped+1}));const Vt=z||l.dossiers.find(Re=>(Re.name||"").toLowerCase()===ie.toLowerCase());Vt&&(Be.verdict==="kept"?Vt.verdict=Vt.verdict||"MATCH":Be.verdict==="ruled_out"&&(Vt.verdict="NO MATCH"),Be.reason&&(Vt.reasoning=Be.reason)),O()}finally{L(!1)}})())},vt=z=>{if(!de){k({kicker:z.name});return}be(z,"instant"),Ot(ne,"fast_request",z.name||"",""),ce(s.memoInstantSent(z.name))},Rt=z=>U.current.get(z.id)??l.thumbs.get((z.name||"").trim().toLowerCase()),Et=(z,Z)=>c({type:"undoPush",entry:{id:z.id,name:z.name,prevCeoStatus:Z}}),Fe=async(z,Z,Y)=>{const ie=z.ceoStatus||"";z.ceoStatus=Z,O();const ue=await Ua(ne,{status:Z,airtable_id:z.airtableId,check_id:z.checkId,company:z.name,...(Y==null?void 0:Y.note)!==void 0?{note:Y.note}:{},...Y!=null&&Y.via?{via:Y.via}:{}});return ue.ok?ue.skipped?(z.ceoStatus=ie,O(),ze(s.actNotPersisted),!1):((Y==null?void 0:Y.undo)!==!1&&Et(z,ie),Y!=null&&Y.msg&&ce(Y.msg),(Z==="Validé"||Z==="Écarté")&&!z.ceoNote&&(Y==null?void 0:Y.note)===void 0&&D({o:z,yes:Z==="Validé"}),!0):(z.ceoStatus=ie,O(),ze(s.actErr),!1)},nt=async(z,Z)=>{const Y=await Ua(ne,{status:z.ceoStatus||"Retenu",airtable_id:z.airtableId,check_id:z.checkId,company:z.name,note:Z,via:"note"});return!Y.ok||Y.skipped?(ze(Y.skipped?s.actNotPersisted:s.actErr),!1):(z.ceoNote=Z,O(),!0)},T=p.useRef(new Map),G=z=>T.current.has(z.id)?T.current.get(z.id):l.stages.get((z.name||"").trim().toLowerCase()),K=(z,Z)=>{T.current.set(z.id,Z),O()},le=(z,Z)=>{de&&Fe(z,Z?"Validé":"Écarté",{msg:Z?s.decidedYes(z.name):s.decidedNo(z.name)})},we=z=>{de&&Fe(z,"À trancher",{msg:s.promoted(z.name)})},P=z=>{de&&(async()=>{const Z=z.ceoStatus||"";z.ceoStatus="Retenu",O();const Y=await Ua(ne,{status:"Retenu",check_id:z.checkId,company:z.name});if(!Y.ok||Y.skipped){z.ceoStatus=Z,O(),ze(Y.skipped?s.actNotPersisted:s.actErr);return}Et(z,Z),ce(s.repeched(z.name))})()},oe=()=>{const z=g.undo[g.undo.length-1];if(!z){ce(s.undoNone);return}const Z=Ke.get(z.id);if(!Z){c({type:"undoPop"}),ce(s.undoNone);return}let Y=z.prevCeoStatus;if(!Y)if((Z.verdict||"").toUpperCase().includes("CALL"))Y="À trancher";else{ce(s.undoLockedTitle);return}(async()=>await Fe(Z,Y,{undo:!1})&&(c({type:"undoPop"}),Z.ceoStatus=z.prevCeoStatus,O(),ce(s.undoDone(Z.name))))()},pe=z=>{de&&(ae.current.add(z.id),O(),c({type:"approachOpen",id:z.id}),Ot(ne,"approach",z.name||"",""))},re=p.useRef(!1);p.useEffect(()=>{if(!ne||e||!de||re.current)return;re.current=!0;const z=new Date().toISOString().slice(0,10),Z=`atl2:vue:${ne}:${z}`;try{if(localStorage.getItem(Z))return}catch{}Ot(ne,"view","","").then(Y=>{if(!Y.ok){re.current=!1;return}try{localStorage.setItem(Z,"1")}catch{}})},[ne,e]);const je=(z,Z)=>{de&&(async()=>{if(!(await Ot(ne,Z?"yes":"no",z.name||"",(z.ceoNote||"").slice(0,400),z.sector||"")).ok){ze(s.actErr);return}U.current.set(z.id,Z?"yes":"no"),O(),ce(Z?s.thumbUpDone:s.thumbDnDone)})()},Ie=z=>{!de||!It(z)||(be(z,"detailed"),Ot(ne,"detailed_request",z.name||"",""),ce(s.memoDeepSent(z.name)))},Ue=z=>{const Z=new Set(l.favIds),Y=Z.has(z.id);Y?Z.delete(z.id):Z.add(z.id),l.setFavIds(Z),de&&ys(ne,{id:z.id,co:z.name},Y)},qe=()=>{!de||$||window.confirm(s.identSyncConfirm)&&(ee(!0),(async()=>{const z=await ws(ne);ee(!1),z?ce(s.identSyncDone):ze(s.actErr)})())},_e=/proplace/i.test(l.fund||""),Pa=z=>{!de||!_e||(Ot(ne,"onboard_request",z.name||"",""),ce(s.onboardSent(z.name)))},la={st:g,dispatch:c,t:s,lang:d,mode:H,caps:X,pipe:_,token:ne,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:P,thumbOf:Rt,canWrite:de,commitStatus:Fe,saveNote:nt,stageOf:G,setStage:K,flashErr:ze,startTour:()=>A(!0),dossiers:l.dossiers,scopedAll:ve,scoped:Ft,counts:Me,byId:Ke,contName:Nt,favIds:l.favIds,toggleFav:Ue,askEvaluate:bt,doAnalyse:vt,doDecide:le,doPromote:we,doApproach:pe,doThumb:je,doDeep:Ie,doUndo:oe,doSync:qe,doOnboard:Pa,outbound:_e,memoQueued:V.current,liveMemos:{items:ye,serverOff:me,liveOf:se},approachDone:ae.current,sessTally:N,evalCards:M.current,evalBusy:S,markRow:w,markedId:v,flash:ce,focusExtra:f};p.useEffect(()=>{const z=Z=>{Z.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",z),()=>window.removeEventListener("keydown",z)},[]);const ai=z=>ne?t.jsx(al,{token:ne,children:z}):t.jsx(t.Fragment,{children:z});return t.jsx(Zo.Provider,{value:la,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ne?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Bs}),ai(t.jsxs("div",{className:"app"+(_?" pipe":"")+(ne?" has-thesis":""),children:[X.showTicker&&t.jsx(rt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ne?" live-stack--cibles":""),children:[t.jsx(dl,{}),!!ne&&t.jsx(nl,{})]})}),X.showIdent&&t.jsx(rt,{name:"identite",children:t.jsx(wl,{})}),!1,Uc,X.showFunnel&&t.jsx(rt,{name:"entonnoir",children:t.jsx(Gc,{})}),!g.mapFolded&&t.jsx(rt,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Bo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Bc,{}),a!=="ops"&&X.showFunnel&&t.jsx($c,{}),t.jsx(vd,{}),t.jsx(_o,{})]})]})}),X.showDemand&&_&&t.jsx(rt,{name:"direct",children:t.jsx(Ss,{items:ye,serverOff:me,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([z,Z])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===z,onClick:()=>{m(z);try{localStorage.setItem("atl2:chrome-mode",z)}catch{}},children:Z},z))}),X.showDemand&&t.jsx(rt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Cd,{})})}),X.showDemand&&g.memoConsole&&t.jsx(rt,{name:"console",children:t.jsx(Ad,{})}),X.pipe&&!!ne&&t.jsx(rt,{name:"moteurs",children:t.jsx(Rs,{})}),t.jsx(rt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(ic,{})}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(rt,{name:"fiche",children:t.jsx(Ud,{})}),t.jsx(rt,{name:"modales",children:t.jsx(fc,{})}),t.jsx(ul,{}),F&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:F.o.name}),t.jsx(xl,{placeholder:F.yes?s.whyYesPh:s.whyNoPh,onDone:z=>{const Z=F.o;D(null),z&&nt(Z,z).then(Y=>{Y&&ce(s.csNoteSaved)})}})]}),h&&jt&&t.jsx(vl,{steps:Wc(s,Ae,it,ut,xt,Me[3]||0,Me[4]||0),onClose:()=>{A(!1),Xr(ne)}}),t.jsx(Hc,{}),X.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:bo,children:qn}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),q&&t.jsx("div",{className:"flash on"+(R?" err":""),children:q}),j&&t.jsx(hs,{variant:"acquirer",initialCompany:Zr().co,initialWebsite:Zr().site,onClose:()=>k(null)})]})})}function Gc(){const{t:e}=Q(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Zr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Yc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{ei as FlagCell,wt as SigBadge,Ia as SigWin,Jc as default,Yc as fmtShort,Q as useV2};
