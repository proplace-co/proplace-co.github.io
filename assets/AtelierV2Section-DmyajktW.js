...
.atl2 .bulk .side .hint{white-space:nowrap}`,El=`
...
.atl2.ops .contpick .mapbtn{font-family:inherit;font-size:12px;font-weight:600;
  color:#61708A;background:none;border:0;border-left:0;cursor:pointer;
  white-space:nowrap;padding:0 4px;height:auto;min-width:0}
.atl2.ops .conts .side .mapbtn,.atl2.ops .contpick .mapbtn{min-width:132px;
  text-align:right}
.atl2.ops .conts .side button:hover,.atl2.ops .contpick .resetmap:hover,
.atl2.ops .contpick .mapbtn:hover{color:#0E7F3F}

/* Carte encadrée, plus basse que les 460/500 px plein cadre. */
...
.atl2.ops .stage:not(.folded) .mapzone svg{height:360px!important;
  min-height:360px!important;max-height:360px!important}
...
.atl2.ops .ct path{stroke-width:.55}
...
.atl2.ops .readpane{display:flex;flex-direction:column;gap:14px;padding:0}
...
.atl2.ops .readpane.is-edito .zoom{padding:20px;margin:0;border:1px solid #E3E8F0;
  border-radius:14px;background:#fff;max-width:none}
...
/* Cartes / visuels : plus de débordement -28 px, rayon 12, hauteur capée. */
...
.atl2.ops .readpane.is-edito .zoom .opcard.art-mktcard .ppcard-fit{border-left:1px solid #E3E8F0;
  border-right:1px solid #E3E8F0;max-height:200px!important;overflow:hidden;
  border-radius:12px}
...
/* Carte repliée /actualites : même rabat que le cockpit. */
...
.atl2.ops .stage.folded .fbar{position:static;width:auto;flex:1 1 auto;
  min-width:0;border:0;padding:0;background:transparent;box-shadow:none;
  backdrop-filter:none;-webkit-backdrop-filter:none;border-radius:0;
  flex-direction:row;flex-wrap:wrap;align-items:center;gap:8px;max-height:none;
  height:auto!important}
.atl2.ops .stage.folded .fbar .seg button,
.atl2.ops .stage.folded .fbar .fbtn{height:32px;box-sizing:border-box;
  width:auto;border-radius:999px;padding:0 13px;font-size:12.5px;font-weight:600}
@media (max-width:860px){
  .atl2.ops .stage:not(.folded) .mapzone,
  .atl2.ops .stage:not(.folded) .mapzone svg{height:280px!important;
    min-height:280px!important;max-height:280px!important}
}
`,Cl=jl+El+Nl+Sl;function fn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function zl(){const e=fn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Al(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=zl();return r==="0"?"client":r==="1"||fn("embed")==="1"&&fn("chrome")==="1"?"apercu":"client"}const ql={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Tl=e=>ql[e];function La(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Tt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!go(a)||La(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Qi(e.cc)})};function Ja(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ll=60*60*1e3;function Fl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ll?null:a}catch{return null}}function ha(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Rl=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ol(e,a,r="default"){const n=r!=="default",o=c.useMemo(()=>e||n?{mode:"anon"}:Ii(),[e,n]),i=c.useMemo(()=>n?"visiteur":Al(e,o),[e,o,n]),d=c.useMemo(()=>Tl(i),[i]),l=i!=="visiteur",s=Rl(r),[g,p]=c.useState([]),[x,m]=c.useState(""),[b,u]=c.useState(null),[w,k]=c.useState(null),[f,v]=c.useState(null),[j,y]=c.useState(()=>new Map),[N,E]=c.useState(()=>new Map),[S,T]=c.useState(""),[C,L]=c.useState(new Set),[D,H]=c.useState(null),[R,O]=c.useState(!0),[h,q]=c.useState(!1),[M,Q]=c.useState(0),[z,P]=c.useState(0),I=c.useRef(0),U=c.useMemo(()=>{var $;if(i!=="client")return"";try{return(($=Pi())==null?void 0:$.email)||""}catch{return""}},[i]);c.useEffect(()=>{const $=++I.current;let pe=!0;const J=()=>pe&&$===I.current,le=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),ge=Fl(le);return ge?(p(ge.objs.map(Tt)),ge.fund&&m(ge.fund),u(ge.marketEstimate??null),k(ge.criteria??null),v(ge.stats??null),T(ge.generatedAt||""),O(!1)):O(!0),(async()=>{try{if(r==="ops"){const ue=await Ga(),ye=((ue==null?void 0:ue.recent_ops)||[]).map(be=>{const Ee=Ea(be.company_name||be.title?be:{...be,title:(be.headline_fr||be.headline||"").slice(0,120)},a),Fe=String(be.rubrique||"").toLowerCase();return Ee&&(Fe==="nominations"||Fe==="recrutements")&&(Ee.engine=Fe),Ee&&!String(be.company_name||"").trim()&&(Ee.noCo=!0),Ee}).filter(be=>!!be).map(be=>(go((be.name||"").trim())||(be.noCo=!0),be));try{const be=_i(),Ee=await Bi(),Fe=((Ee==null?void 0:Ee.date)||"").slice(0,10),ne=be?be.doc:Ee,Ne=$i(ne),ve=((be==null?void 0:be.day)||(ne==null?void 0:ne.date)||Fe||"").slice(0,10);if(ve&&Ne.length){const ie=new Set;for(const B of ye){if((B.date||"").slice(0,10)!==ve)continue;const W=Xn(Ne,ie,B.name,"");W>=0&&(ie.add(W),B.decryptHtml=Ne[W].html)}for(const B of ye){if(B.decryptHtml||(B.date||"").slice(0,10)!==ve)continue;const W=Xn(Ne,ie,"",B.headline||B.tagline||B.name);W>=0&&(ie.add(W),B.decryptHtml=Ne[W].html)}}if(ve){const ie=((ne==null?void 0:ne.title_fr)||"").trim(),B=((ne==null?void 0:ne.lead_fr)||"").trim(),W=Ui(ne),ee=((ne==null?void 0:ne.url)||"").trim();ie&&(W||ee)&&ye.unshift({id:`edito:${ve}`,kind:"op",name:ie,cc:null,date:ve,engine:"edito",dealKind:"other",headline:ie,tagline:B||ie,decryptHtml:W||void 0,url:ee,noCo:!0})}}catch{}if(!J())return;p(ye.map(Tt)),ha(le,{objs:ye})}else if(typeof r=="object"){const ye=(await Zn()||[]).filter(Ee=>(Ee.slug||"")===r.research).map(Ee=>er(Ee,a)).filter(Ee=>!!Ee),be=Ja(await tr(ye,a));if(!J())return;p(be.map(Tt)),ha(le,{objs:be})}else if(l&&o.token){const ue=Hi(o.token),ye=Ga(),be=Vi(o.token),Ee=Wi(o.token),Fe=Gi(o.token),ne=await ue;let Ne=ne?ne.targets:[];J()&&ne&&(m(ne.fund||""),u(ne.marketEstimate??null),k(ne.criteria??null),v(ne.stats??null),T(ne.generatedAt||""),p(Ne.map(Tt)),O(!1),q(!1));const[ve,ie,B,W]=await Promise.all([ye,be,Ee,Fe]),ee=((ve==null?void 0:ve.recent_ops)||[]).map(re=>Ea(re,a)).filter(re=>!!re),de=new Set(Ne.map(re=>re.id));if(Ne=[...Ne,...ee.filter(re=>!de.has(re.id)&&(de.add(re.id),!0))],!J())return;p(Ne.map(Tt));const ce=new Set;for(const re of ie){const oe=(re.id||re.co||"").toString().trim().toLowerCase();oe&&ce.add(oe.startsWith("t:")?oe:"t:"+oe)}L(ce),y(B),E(W),ne&&ha(le,{fund:ne.fund,marketEstimate:ne.marketEstimate,criteria:ne.criteria,stats:ne.stats,generatedAt:ne.generatedAt,objs:Ne})}else{const ue=Yi(),ye=Zn(),be=Ga(),Ee=await ue;J()&&Ee.length&&(p(Ja(Ee).map(Tt)),O(!1),q(!1));const[Fe,ne]=await Promise.all([ye,be]),Ne=(Fe||[]).map(W=>er(W,a)).filter(W=>!!W),ve=await tr(Ne,a),ie=((ne==null?void 0:ne.recent_ops)||[]).map(W=>Ea(W,a)).filter(W=>!!W),B=Ja([...Ee,...ve,...ie]);if(!J())return;p(B.map(Tt)),ha(le,{objs:B})}J()&&q(!1)}catch{J()&&!ge&&q(!0)}finally{J()&&O(!1)}})(),()=>{pe=!1}},[l,o.token,a,M,s]),c.useEffect(()=>{if(!d.showCredits||!U){H(null);return}let $=!0;return(async()=>{try{const pe=await fetch(`${Ha}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:U})});if(!pe.ok)return;const J=await pe.json();$&&J&&J.ok!==!1&&H(J)}catch{}})(),()=>{$=!1}},[d.showCredits,U,z]);const te=c.useCallback($=>L(new Set($)),[]);return{session:o,mode:i,caps:d,fund:x,email:U,marketEstimate:b,generatedAt:S,criteria:w,thesisMode:String((w==null?void 0:w.mode)||""),stats:f,thumbs:j,stages:N,dossiers:g,patchStatuses:($,pe)=>{p(J=>{let le=!1;const ge=J.map(ue=>{if(!ue.checkId)return ue;const ye=$.get(ue.checkId);return!ye||ye===(ue.ceoStatus||"")||!pe(ue.id)?ue:(le=!0,{...ue,ceoStatus:ye})});return le?ge:J})},favIds:C,setFavIds:te,credits:D,reloadCredits:()=>P($=>$+1),loading:R,error:h,refresh:()=>Q($=>$+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Na=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Fa(e){return Na.has(e.engine||"")}function Je(e){return!!e.noCo||Fa(e)&&!!e.url}const Ro=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ml=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Ro(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Dl=new Set(["signal","amount","score","crible","memo"]);function Il(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Ro(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Dl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Oo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Oo=80;function Ra(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!$e(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ln(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(Et(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Lt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(bo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function oa(e,a,r){return We(e)?Ra(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ra(e,a.filters,r)}function Pl(e,a,r,n){return!(!oa(e,a,r)||r&&!xo(e,a.ptab,n))}function Dn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-Et(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Ji(o)||null;case"memo":return Ki(o)||null;case"signal":{const i=$e(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Xa={},yr=(Xa==null?void 0:Xa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function wr(){return new Date().toISOString().slice(0,10)}const In=c.createContext(null);function Mo(){return c.useContext(In)}function _l(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const g=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(p=>s.removeAttribute(p.name)),g&&/^https?:\/\//i.test(g)&&(s.setAttribute("href",g),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Do(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Bl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Do(r),r.innerHTML):e}catch{return e}}function kr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Do(r),r.innerHTML):e}catch{return e}}function jr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Io(){const e=c.useContext(In);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function $l({token:e,children:a}){const{dispatch:r,st:n,lang:o}=K(),[i,d]=c.useState(()=>n.filters.day||wr()),[l,s]=c.useState(null),[g,p]=c.useState(!1),x=c.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),m=c.useCallback(()=>{d(wr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);c.useEffect(()=>{const w=k=>{var v;const f=(v=k.detail)==null?void 0:v.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),c.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),c.useEffect(()=>{if(!e||!i)return;let w=!1;p(!0);const k=new URLSearchParams({token:e,date:i});return fetch(`${yr}/cibles/edition.json?${k}`).then(f=>f.json()).then(f=>{w||s(f)}).catch(()=>{w||s({ok:!1,error:"network"})}).finally(()=>{w||p(!1)}),()=>{w=!0}},[e,i]);const b=c.useMemo(()=>`${yr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),u=c.useMemo(()=>({token:e,day:i,ed:l,loading:g,pickDay:x,pickWindow:m,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,g,x,m,n.filters.day,b,o]);return t.jsx(In.Provider,{value:u,children:a})}function Ul(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Io(),[o,i]=c.useState(()=>n||vo());return c.useEffect(()=>{n&&i(!0)},[n]),c.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(Aa,d),()=>window.removeEventListener(Aa,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Xi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Hl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Er(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Nr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Vl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Io(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,g=c.useRef(null),[p,x]=c.useState("fonds"),[m,b]=c.useState(null),[u,w]=c.useState("idle"),k=c.useRef(!1);c.useEffect(()=>{b(null),w("idle"),k.current=!1,x("fonds")},[e]),c.useEffect(()=>{if(p!=="jour"||k.current)return;k.current=!0;let N=!0;return w("load"),Hl(e).then(E=>{N&&(b(E),w("fait"))}),()=>{N=!1}},[p,e]);const f=c.useMemo(()=>Bl((m==null?void 0:m.html)||""),[m==null?void 0:m.html]),v=c.useRef(null);c.useEffect(()=>{const N=v.current;if(!N||!f)return;let E=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(E||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{E=!0}},[f]);const j=c.useMemo(()=>kr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),y=c.useMemo(()=>kr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return c.useEffect(()=>{const N=g.current;if(!N||!j)return;let E=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(E||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{E=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const N=(a==null?void 0:a.date)||e,E=/^(\d{4})-(\d{2})-(\d{2})/.exec(N);return E?i?`${E[2]}/${E[3]}/${E[1]}`:`${E[3]}/${E[2]}/${E[1]}`:N})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":p==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":p==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),p==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),p==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p==="fonds"&&s&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),p==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Er(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:jr(e,!0)}),"."]}):Er(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:jr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),p==="fonds"&&d&&j?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,p==="fonds"&&d&&y?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:y}}):null,p==="jour"&&(f?t.jsxs(t.Fragment,{children:[(m==null?void 0:m.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:m.title}),t.jsx("div",{ref:v,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:u==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:u!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Nr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Nr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Wl=300,ga=7,Gl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Po={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Yl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Za(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(as(r)&&r!=="media")return"news:"+r;const n=$e(e);return n?"sig:"+(n.theme&&Po.fr[n.theme]?n.theme:"other"):"actualites"}function Ql(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=K(),s=Mo(),g=d==="en",[p,x]=c.useState("all"),[m,b]=c.useState(!1),u=c.useMemo(()=>{var pe;const h=(a.filters.day||"").slice(0,10),q=J=>!(!i&&a.continent!=="monde"&&J.continent!==a.continent||h&&(J.date||"").slice(0,10)!==h),M=e.filter(J=>q(J)&&$e(J)&&(!i||J.kind!=="target"||Le(J)!==5)),Q=i&&(((pe=s==null?void 0:s.ed)==null?void 0:pe.ops)||[]).length?s.ed.ops.map(J=>Ea(J,d)).filter(J=>!!J).map(J=>(J.briefOnly=!0,J)).filter(J=>!h||(J.date||"").slice(0,10)===h):[],z=e.filter(J=>q(J)&&J.kind==="op"&&(h?!0:Et(J.date)<=ga)),P=i?Q.length?Q:z.filter(J=>{const le=(l||"").trim().toLowerCase();if(!le)return!1;const ge=J.match||null;return ge?Object.keys(ge).map(ue=>ue.trim().toLowerCase()).includes(le):!1}):z,I=h||new Date().toISOString().slice(0,10),U=J=>{const le=Za(J);return le==="ma"?0:le==="levees"?1:2};P.sort((J,le)=>{const ge=U(J)-U(le);if(ge)return ge;const ue=(J.date||"").slice(0,10)===I?0:1,ye=(le.date||"").slice(0,10)===I?0:1;return ue!==ye?ue-ye:(le.amountEur||0)-(J.amountEur||0)});const te=new Set,$=[];for(const J of[...P,...Dn(M,{key:"signal",dir:-1})]){const le=J.id||J.name;!le||te.has(le)||(te.add(le),$.push(J))}return i&&$.length===0?e.filter(le=>q(le)&&Et(le.date)<=ga).sort((le,ge)=>(ge.date||"").localeCompare(le.date||"")).slice(0,80):$},[e,a.continent,a.filters.day,i,l,d,s]),w=c.useMemo(()=>{const h={};for(const q of u){const M=Za(q);h[M]=(h[M]||0)+1}return h},[u]),k=c.useMemo(()=>p==="all"?u:u.filter(h=>Za(h)===p),[u,p]),f=c.useMemo(()=>k.slice(0,Wl),[k]),v=k.length-f.length,j=c.useRef(null);c.useEffect(()=>{var P,I;const h=j.current;if(!h)return;const q=()=>{const U=h.scrollWidth;U<200||(h.style.animationDuration=Math.max(18,Math.round(U/130))+"s")};q();const M=requestAnimationFrame(q),Q=window.setTimeout(q,1200);let z=!0;return(I=(P=document.fonts)==null?void 0:P.ready)==null||I.then(()=>{z&&q()}),()=>{z=!1,cancelAnimationFrame(M),window.clearTimeout(Q)}},[f.length,p]);const y=h=>h==="all"?u.length:w[h]||0,N=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return Po[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const q=h.slice(5);return es[q]?ts(q,g?"en":"fr"):h}return Gl[g?"en":"fr"][h]},E=[{k:"all"}],S=["ma","levees"].filter(h=>y(h)>0||h===p);if(S.length){E.push({g:g?"Deals":"Opérations"});for(const h of S)E.push({k:h})}const T=["nominations","recrutements"].filter(h=>y(h)>0||h===p),C=Zi.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>y(h)>0||h===p),L=y("actualites")>0||p==="actualites"?["actualites"]:[];if(T.length||C.length||L.length){E.push({g:g?"News":"Actualités"});for(const h of T)E.push({k:h});for(const h of C)E.push({k:h});for(const h of L)E.push({k:h})}const D=Yl.map(h=>"sig:"+h).filter(h=>y(h)>0||h===p);if(D.length){E.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of D)E.push({k:h})}const H=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},R=(()=>{const h=(a.filters.day||"").slice(0,10),q=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(g?`LIVE covers the events of ${H(h)}.`:`Le LIVE regroupe les événements du ${H(h)}.`)+q:(g?`LIVE covers the still-open signals and the deals of the last ${ga} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ga} derniers jours.`)+q})(),O=h=>f.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ge(q)?" spent":""),onClick:M=>{const Q=q.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:Q?"":q.id,name:q.name,url:q.url||"",text:q.tagline||q.headline||"",card:q.card}}))}catch{}if(Q||n({type:"focus",id:q.id}),a.dens!=="liste"){const z=M.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:z.left+z.width/2,y:z.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(Ct,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(ji,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Kc(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Va,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(q.id||q.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":m,onClick:()=>b(h=>!h),children:[N(p),t.jsx("b",{children:y(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!m,children:[t.jsx("span",{className:"tkfilscope",children:R}),E.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===p,onClick:()=>{x(h.k),b(!1)},children:[N(h.k),t.jsx("b",{children:y(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:j,children:[O(0),O(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!s&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!s&&t.jsx(Jl,{isEn:g})]})}const Kl=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Jl({isEn:e}){const[a,r]=c.useState(()=>vo());c.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Aa,o),()=>window.removeEventListener(Aa,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>ns(!a),children:Kl})}const Pn="+33 6 83 10 72 86",Oa="alexandre@proplace.co",_o=`tel:${Pn.replace(/[^\d+]/g,"")}`;function Xl(){return null}class dt extends c.Component{constructor(){super(...arguments);Qn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Bo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Sr(e,a){if((zt(e)||"").startsWith("CALL")&&Le(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Le(e)>=2;return Bo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const Cr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",Zl={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function ed({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=K(),[l,s]=c.useState(""),[g,p]=c.useState(!1),[x,m]=c.useState(!1),b=c.useRef(null);if(c.useEffect(()=>{if(!x)return;const v=j=>{b.current&&!b.current.contains(j.target)&&(m(!1),p(!1))};return document.addEventListener("click",v,!0),()=>document.removeEventListener("click",v,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const u=(e.ceoStatus||"").trim(),w=async v=>{if(l)return;if(v==="Analysé"&&!e.memoUrl){p(!0);return}s(v);const j=(Sr(e,a).find(([N])=>N===v)||[v,v])[1],y=await o(e,v,{msg:a.csMoved(e.name,j)});s(""),y&&(p(!1),m(!1))},k=Sr(e,a),f=v=>(k.find(([j])=>j===v)||[])[1]||v;return k.length===2?t.jsx("span",{className:"rstat rst2",onClick:v=>v.stopPropagation(),children:k.map(([v,j])=>t.jsx("button",{type:"button",className:"rsd "+(v==="Validé"?"yes":"no")+(l===v?" busy":""),disabled:!!l,onClick:()=>{w(v)},children:j},v))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:v=>v.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+Cr(u),onClick:()=>{m(v=>!v),p(!1)},children:l?f(l)+"…":u?f(u):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:k.map(([v,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":u===v,className:"rsopt"+(u===v?" on":"")+(l===v?" busy":""),disabled:!!l,onClick:()=>{if(v===u){m(!1);return}w(v)},children:[t.jsx("i",{className:"pt2",style:{background:Zl[Cr(v)]}}),j]},v))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),p(!1),m(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const v=await o(e,"Analysé");s(""),v&&(p(!1),m(!1))})()},children:a.csAnaAnyway})]})})]})}function td({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=K(),[i,d]=c.useState(""),[l,s]=c.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),p=(zt(e)||"").startsWith("CALL")&&Le(e)===3,x=Le(e)>=2,m=async u=>{if(i||u==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(u);const w=await o(e,u);d(""),w&&(s(!0),setTimeout(()=>s(!1),2200))},b=p?[["Validé",a.csYes],["Écarté",a.csNo]]:Bo.filter(([u])=>!(x&&u==="Retenu")).map(([u,w])=>[u,a[w]]);return t.jsxs("div",{className:"csp",onClick:u=>u.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([u,w])=>t.jsx("button",{type:"button",className:"csb"+(g===u?" on":"")+(i===u?" busy":""),disabled:!!i,onClick:()=>{m(u)},children:w},u)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ad,{o:e})]})}function ad({o:e}){const{t:a,saveNote:r,flash:n}=K(),[o,i]=c.useState(e.ceoNote||""),[d,l]=c.useState(!1),[s,g]=c.useState(!1),p=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!p)return;l(!0);const m=await r(e,o.trim());l(!1),m&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:m=>i(m.target.value),onKeyDown:m=>{m.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!p,onClick:()=>{x()},children:s?a.csNoteSaved:a.csNoteOk})]})}function zr({placeholder:e,onDone:a}){const{t:r}=K(),[n,o]=c.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function nd({o:e}){var k;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=K(),[s,g]=c.useState(!1);if(!n.pipe||!o||n.lockActions||Le(e)!==4)return null;const p=i(e),x=(p==null?void 0:p.stage)||"todo",m=async f=>{if(s||f===x)return;g(!0);const v=p;d(e,{stage:f,stamps:(p==null?void 0:p.stamps)||{}});const j=Math.max(Date.now(),Ar+=1);Ar=j;const y=await rs(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!y.stale&&(y.ok||(d(e,v),l(a.actErr)))},b=(k=p==null?void 0:p.stamps)==null?void 0:k.sent,u=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=x==="sent"&&b&&u>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,v])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:s,onClick:()=>{m(f)},children:v},f)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(u)})]})}let Ar=0;const Kt=8,Nt=360;function qr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Tr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(qr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(qr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function rd({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=K(),[d,l]=c.useState(0),[s,g]=c.useState(null),[p,x]=c.useState([]),m=c.useRef(!1),b=c.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),u=c.useRef(!1);c.useEffect(()=>{const S=b.current;return()=>{u.current||(n({type:"ptab",tab:S.ptab}),n({type:"dens",dens:S.dens}),n({type:"modal",modal:S.modal}))}},[]),c.useEffect(()=>{m.current||(m.current=!0,x(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const w=p[d],k=d>=p.length;c.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const S=w.click,T=window.setTimeout(()=>{const C=document.querySelector(S);C&&C.getAttribute("aria-selected")!=="true"&&C.click()},60);return()=>window.clearTimeout(T)}},[d,w]);const f=c.useRef(-1),v=c.useCallback(()=>{if(!w){g(null);return}const S=L=>{if(!L)return null;for(const D of document.querySelectorAll(L)){const H=D.getBoundingClientRect();if(H.width>1&&H.height>1)return D}return null},T=S(w.sel)||S(w.need);if(!T){g(null);return}f.current!==d&&(f.current=d,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const C=T.getBoundingClientRect();g(L=>L&&Math.abs(L.top-C.top)<1&&Math.abs(L.left-C.left)<1&&Math.abs(L.width-C.width)<1&&Math.abs(L.height-C.height)<1?L:C)},[w,d]);c.useLayoutEffect(()=>{v();const S=[90,300,700,1300].map(L=>window.setTimeout(v,L)),T=window.setInterval(v,400),C=()=>v();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{S.forEach(L=>window.clearTimeout(L)),window.clearInterval(T),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[v]);const j=c.useRef(a);if(j.current=a,c.useEffect(()=>{const S=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),j.current()):T.key==="ArrowRight"?l(C=>C+1):T.key==="ArrowLeft"&&l(C=>Math.max(0,C-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!p.length)return null;let y=null;const N=S=>()=>{u.current=!0,n({type:"modal",modal:null}),S()};if(k){const S=o[3]||0;S>0?y={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?y={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?y={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let E={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Nt};if(!k&&s){const S=s.bottom+14,T=window.innerHeight-S;let C=T>190?S:Math.max(12,s.top-200),L=Math.min(Math.max(12,s.left+s.width/2-Nt/2),window.innerWidth-Nt-12);T<=190&&s.top<212&&(window.innerWidth-s.right>=Nt+40?L=Math.min(s.right+26,window.innerWidth-Nt-12):s.left>=Nt+40&&(L=Math.max(12,s.left-Nt-26)),C=Math.max(12,s.top-Kt)),E={left:L,top:C,width:Nt}}return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!k&&s&&t.jsx("div",{className:"tour-hole",style:{left:s.left-Kt,top:s.top-Kt,width:s.width+Kt*2,height:s.height+Kt*2}}),(k||!s)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(k?" fin":""),style:E,children:[k&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(Tr,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(p.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,p.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/p.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(Tr,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(S=>S+1),children:d===p.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function $o(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Uo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function od(){var T,C;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:s}=K(),g=r?a:e,p=c.useMemo(()=>g.filter(L=>Et(L.date)===0&&L.kind==="target"),[g]),x=c.useMemo(()=>r?a.filter(L=>L.kind==="target"&&Le(L)===0).slice().sort((L,D)=>(D.date||"").localeCompare(L.date||"")):[],[a,r]),m=c.useMemo(()=>p.filter(L=>r?Le(L)===0:!Ge(L)),[p,r]),b=r?x:m,u=r?a.length-x.length:p.length-m.length,w=r?a.length:p.length,k=w?Math.min(100,u/w*100):100,f=c.useMemo(()=>$o(g),[g]),v=!!f&&Et(f)>0,j=c.useMemo(()=>v?g.filter(L=>(L.date||"").slice(0,10)===f):[],[g,f,v]),y=typeof((T=l.stats)==null?void 0:T.kept_today)=="number"?l.stats.kept_today:null,N=typeof((C=l.stats)==null?void 0:C.screened_today)=="number"?l.stats.screened_today:p.length;let E;v?E=o.morningLast(j.length,x.length,Uo(f,d)):r?E=o.morningThesis(N,x.length,y):p.length?u===0?E=o.goalSourced(p.length):u>=p.length?E=o.goalCleared:E=o.goalDone(u,p.length):E=o.goalSourced(0);const S=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&x.length&&s({type:"chainStart",queue:x.map(L=>L.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:E}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:k+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:S,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}const id=[0,1,2,3,5,10];function sd(){var te;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:d,scopedAll:l,mode:s,doSync:g,startTour:p,flash:x,flashErr:m}=K(),[b,u]=c.useState(null),[w,k]=c.useState(!0),[f,v]=c.useState([]),j=s==="client";c.useEffect(()=>{if(!o||!i)return;let $=!0;return k(!0),(async()=>{const[pe,J]=await Promise.all([Fn(i),yo(o)]);$&&(pe&&u(pe),k(!1),v(J))})(),()=>{$=!1}},[o,i]);const[y,N]=c.useState(!1),[E,S]=c.useState(""),T=()=>{!j||y||!i||(N(!0),S(""),os(i).then($=>{if(N(!1),$.pending){S(e.refreshSlow);return}if(!$.ok){$.error&&console.warn("[republish]",$.error),S(e.refreshKo);return}const pe=$.entered??0,J=$.left??0;S($.unchanged||!pe&&!J?e.refreshSame:e.refreshDone(pe,J)),d.refresh()}))},C=(b==null?void 0:b.per_day)??null,L=((te=b==null?void 0:b.pool_order)==null?void 0:te.length)??0,D=f.filter($=>$.status==="running").length,[H,R]=c.useState(!1),O=$=>{!j||H||!o||(R(!0),wo(o,$).then(pe=>{if(R(!1),pe===null){m(e.actErr);return}u(J=>J&&{...J,per_day:pe}),x(e.alertSaved)}))},h=d.marketEstimate,q=c.useMemo(()=>l.filter($=>!We($)).length,[l]),M=h&&h>0?Math.min(100,Math.round(q/h*100)):null,Q=$=>$.toLocaleString(a==="en"?"en-US":"fr-FR"),z=b==null?void 0:b.offre,P=z&&z.rythme>0&&z.file>0?z.jours_restants:null,I=(i||"P").split(/\s+/).map($=>$[0]).join("").slice(0,2).toUpperCase(),U=(()=>{const $=Date.parse(d.generatedAt||"");if(Number.isNaN($))return"";const pe=new Date($),J=le=>String(le).padStart(2,"0");return`${J(pe.getDate())}/${J(pe.getMonth()+1)} à ${J(pe.getHours())}:${J(pe.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?I:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),U?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(U)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||y,onClick:T,children:y?"⏳":"📰"}),(y||!!E)&&t.jsxs("span",{className:"repubst",children:[y?e.refreshRun:E,!y&&t.jsx("button",{type:"button",onClick:()=>S(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:g,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:p,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:$=>n({type:"filters",patch:{search:$.target.value}})})]})]}),t.jsxs("div",{className:"idmain",children:[t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),M!==null&&h?t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:M+"%"}})}),t.jsx("b",{children:Q(q)})]}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(q,h)}})]}):t.jsx("span",{className:"ev",children:t.jsx("b",{children:Q(q)})}),z&&t.jsxs("span",{className:"eeta",children:[z.libelle," · ",z.delai,P!=null?` · ${e.identEtaDays(P)}`:C===0?` · ${e.qEtaPaused}`:""]}),C!==null&&t.jsx("span",{className:"ev covrb erate",role:"group","aria-label":e.covRate,onClick:$=>$.stopPropagation(),children:id.map($=>t.jsx("button",{type:"button",className:C===$?"on":"",disabled:!j||H,title:$===0?e.identPauseTitle:e.covRateNow($),onClick:()=>O($),children:$===0?"⏸":$},$))})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),C===0&&t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),D>0&&t.jsxs("span",{className:"ev",children:["⏳ ",D]}),t.jsx("span",{className:"ego",children:w?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:$=>{$.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]})]})]})}class Rt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*ld(e){for(const a of e)yield*a}function Ho(e){return Array.from(ld(e))}var qe=1e-6,Se=Math.PI,ot=Se/2,Lr=Se/4,st=Se*2,yt=180/Se,et=Se/180,Re=Math.abs,dd=Math.atan,ia=Math.atan2,De=Math.cos,Ie=Math.sin,pd=Math.sign||function(e){return e>0?1:e<0?-1:0},Dt=Math.sqrt;function cd(e){return e>1?0:e<-1?Se:Math.acos(e)}function sa(e){return e>1?ot:e<-1?-ot:Math.asin(e)}function it(){}function Ma(e,a){e&&Rr.hasOwnProperty(e.type)&&Rr[e.type](e,a)}var Fr={Feature:function(e,a){Ma(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ma(r[n].geometry,a)}},Rr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){hn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)hn(r[n],a,0)},Polygon:function(e,a){Or(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Or(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ma(r[n],a)}};function hn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Or(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)hn(e[r],a,1);a.polygonEnd()}function _t(e,a){e&&Fr.hasOwnProperty(e.type)?Fr[e.type](e,a):Ma(e,a)}function gn(e){return[ia(e[1],e[0]),sa(e[2])]}function Ut(e){var a=e[0],r=e[1],n=De(r);return[n*De(a),n*Ie(a),Ie(r)]}function xa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Da(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function en(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ba(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function xn(e){var a=Dt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function bn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function vn(e,a){return Re(e)>Se&&(e-=Math.round(e/st)*st),[e,a]}vn.invert=vn;function ud(e,a,r){return(e%=st)?a||r?bn(Dr(e),Ir(a,r)):Dr(e):a||r?Ir(a,r):vn}function Mr(e){return function(a,r){return a+=e,Re(a)>Se&&(a-=Math.round(a/st)*st),[a,r]}}function Dr(e){var a=Mr(e);return a.invert=Mr(-e),a}function Ir(e,a){var r=De(e),n=Ie(e),o=De(a),i=Ie(a);function d(l,s){var g=De(s),p=De(l)*g,x=Ie(l)*g,m=Ie(s),b=m*r+p*n;return[ia(x*o-b*i,p*r-m*n),sa(b*o+x*i)]}return d.invert=function(l,s){var g=De(s),p=De(l)*g,x=Ie(l)*g,m=Ie(s),b=m*o-x*i;return[ia(x*o+m*i,p*r+b*n),sa(b*r-p*n)]},d}function md(e,a,r,n,o,i){if(r){var d=De(a),l=Ie(a),s=n*r;o==null?(o=a+n*st,i=a-s/2):(o=Pr(d,o),i=Pr(d,i),(n>0?o<i:o>i)&&(o+=n*st));for(var g,p=o;n>0?p>i:p<i;p-=s)g=gn([d,-l*De(p),-l*Ie(p)]),e.point(g[0],g[1])}}function Pr(e,a){a=Ut(a),a[0]-=e,xn(a);var r=cd(-a[1]);return((-a[2]<0?-r:r)+st-qe)%st}function Vo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:it,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Sa(e,a){return Re(e[0]-a[0])<qe&&Re(e[1]-a[1])<qe}function va(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Wo(e,a,r,n,o){var i=[],d=[],l,s;if(e.forEach(function(u){if(!((w=u.length-1)<=0)){var w,k=u[0],f=u[w],v;if(Sa(k,f)){if(!k[2]&&!f[2]){for(o.lineStart(),l=0;l<w;++l)o.point((k=u[l])[0],k[1]);o.lineEnd();return}f[0]+=2*qe}i.push(v=new va(k,u,null,!0)),d.push(v.o=new va(k,null,v,!1)),i.push(v=new va(f,u,null,!1)),d.push(v.o=new va(f,null,v,!0))}}),!!i.length){for(d.sort(a),_r(i),_r(d),l=0,s=d.length;l<s;++l)d[l].e=r=!r;for(var g=i[0],p,x;;){for(var m=g,b=!0;m.v;)if((m=m.n)===g)return;p=m.z,o.lineStart();do{if(m.v=m.o.v=!0,m.e){if(b)for(l=0,s=p.length;l<s;++l)o.point((x=p[l])[0],x[1]);else n(m.x,m.n.x,1,o);m=m.n}else{if(b)for(p=m.p.z,l=p.length-1;l>=0;--l)o.point((x=p[l])[0],x[1]);else n(m.x,m.p.x,-1,o);m=m.p}m=m.o,p=m.z,b=!b}while(!m.v);o.lineEnd()}}}function _r(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function tn(e){return Re(e[0])<=Se?e[0]:pd(e[0])*((Re(e[0])+Se)%st-Se)}function fd(e,a){var r=tn(a),n=a[1],o=Ie(n),i=[Ie(r),-De(r),0],d=0,l=0,s=new Rt;o===1?n=ot+qe:o===-1&&(n=-ot-qe);for(var g=0,p=e.length;g<p;++g)if(m=(x=e[g]).length)for(var x,m,b=x[m-1],u=tn(b),w=b[1]/2+Lr,k=Ie(w),f=De(w),v=0;v<m;++v,u=y,k=E,f=S,b=j){var j=x[v],y=tn(j),N=j[1]/2+Lr,E=Ie(N),S=De(N),T=y-u,C=T>=0?1:-1,L=C*T,D=L>Se,H=k*E;if(s.add(ia(H*C*Ie(L),f*S+H*De(L))),d+=D?T+C*st:T,D^u>=r^y>=r){var R=Da(Ut(b),Ut(j));xn(R);var O=Da(i,R);xn(O);var h=(D^T>=0?-1:1)*sa(O[2]);(n>h||n===h&&(R[0]||R[1]))&&(l+=D^T>=0?1:-1)}}return(d<-qe||d<qe&&s<-1e-12)^l&1}function Go(e,a,r,n){return function(o){var i=a(o),d=Vo(),l=a(d),s=!1,g,p,x,m={point:b,lineStart:w,lineEnd:k,polygonStart:function(){m.point=f,m.lineStart=v,m.lineEnd=j,p=[],g=[]},polygonEnd:function(){m.point=b,m.lineStart=w,m.lineEnd=k,p=Ho(p);var y=fd(g,n);p.length?(s||(o.polygonStart(),s=!0),Wo(p,gd,y,r,o)):y&&(s||(o.polygonStart(),s=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),s&&(o.polygonEnd(),s=!1),p=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(y,N){e(y,N)&&o.point(y,N)}function u(y,N){i.point(y,N)}function w(){m.point=u,i.lineStart()}function k(){m.point=b,i.lineEnd()}function f(y,N){x.push([y,N]),l.point(y,N)}function v(){l.lineStart(),x=[]}function j(){f(x[0][0],x[0][1]),l.lineEnd();var y=l.clean(),N=d.result(),E,S=N.length,T,C,L;if(x.pop(),g.push(x),x=null,!!S){if(y&1){if(C=N[0],(T=C.length-1)>0){for(s||(o.polygonStart(),s=!0),o.lineStart(),E=0;E<T;++E)o.point((L=C[E])[0],L[1]);o.lineEnd()}return}S>1&&y&2&&N.push(N.pop().concat(N.shift())),p.push(N.filter(hd))}}return m}}function hd(e){return e.length>1}function gd(e,a){return((e=e.x)[0]<0?e[1]-ot-qe:ot-e[1])-((a=a.x)[0]<0?a[1]-ot-qe:ot-a[1])}const Br=Go(function(){return!0},xd,vd,[-Se,-ot]);function xd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?Se:-Se,s=Re(i-a);Re(s-Se)<qe?(e.point(a,r=(r+d)/2>0?ot:-ot),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&s>=Se&&(Re(a-n)<qe&&(a-=n*qe),Re(i-l)<qe&&(i-=l*qe),r=bd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function bd(e,a,r,n){var o,i,d=Ie(e-r);return Re(d)>qe?dd((Ie(a)*(i=De(n))*Ie(r)-Ie(n)*(o=De(a))*Ie(e))/(o*i*d)):(a+n)/2}function vd(e,a,r,n){var o;if(e==null)o=r*ot,n.point(-Se,o),n.point(0,o),n.point(Se,o),n.point(Se,0),n.point(Se,-o),n.point(0,-o),n.point(-Se,-o),n.point(-Se,0),n.point(-Se,o);else if(Re(e[0]-a[0])>qe){var i=e[0]<a[0]?Se:-Se;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function yd(e){var a=De(e),r=2*et,n=a>0,o=Re(a)>qe;function i(p,x,m,b){md(b,e,r,m,p,x)}function d(p,x){return De(p)*De(x)>a}function l(p){var x,m,b,u,w;return{lineStart:function(){u=b=!1,w=1},point:function(k,f){var v=[k,f],j,y=d(k,f),N=n?y?0:g(k,f):y?g(k+(k<0?Se:-Se),f):0;if(!x&&(u=b=y)&&p.lineStart(),y!==b&&(j=s(x,v),(!j||Sa(x,j)||Sa(v,j))&&(v[2]=1)),y!==b)w=0,y?(p.lineStart(),j=s(v,x),p.point(j[0],j[1])):(j=s(x,v),p.point(j[0],j[1],2),p.lineEnd()),x=j;else if(o&&x&&n^y){var E;!(N&m)&&(E=s(v,x,!0))&&(w=0,n?(p.lineStart(),p.point(E[0][0],E[0][1]),p.point(E[1][0],E[1][1]),p.lineEnd()):(p.point(E[1][0],E[1][1]),p.lineEnd(),p.lineStart(),p.point(E[0][0],E[0][1],3)))}y&&(!x||!Sa(x,v))&&p.point(v[0],v[1]),x=v,b=y,m=N},lineEnd:function(){b&&p.lineEnd(),x=null},clean:function(){return w|(u&&b)<<1}}}function s(p,x,m){var b=Ut(p),u=Ut(x),w=[1,0,0],k=Da(b,u),f=xa(k,k),v=k[0],j=f-v*v;if(!j)return!m&&p;var y=a*f/j,N=-a*v/j,E=Da(w,k),S=ba(w,y),T=ba(k,N);en(S,T);var C=E,L=xa(S,C),D=xa(C,C),H=L*L-D*(xa(S,S)-1);if(!(H<0)){var R=Dt(H),O=ba(C,(-L-R)/D);if(en(O,S),O=gn(O),!m)return O;var h=p[0],q=x[0],M=p[1],Q=x[1],z;q<h&&(z=h,h=q,q=z);var P=q-h,I=Re(P-Se)<qe,U=I||P<qe;if(!I&&Q<M&&(z=M,M=Q,Q=z),U?I?M+Q>0^O[1]<(Re(O[0]-h)<qe?M:Q):M<=O[1]&&O[1]<=Q:P>Se^(h<=O[0]&&O[0]<=q)){var te=ba(C,(-L+R)/D);return en(te,S),[O,gn(te)]}}}function g(p,x){var m=n?e:Se-e,b=0;return p<-m?b|=1:p>m&&(b|=2),x<-m?b|=4:x>m&&(b|=8),b}return Go(d,l,i,n?[0,-e]:[-Se,e-Se])}function wd(e,a,r,n,o,i){var d=e[0],l=e[1],s=a[0],g=a[1],p=0,x=1,m=s-d,b=g-l,u;if(u=r-d,!(!m&&u>0)){if(u/=m,m<0){if(u<p)return;u<x&&(x=u)}else if(m>0){if(u>x)return;u>p&&(p=u)}if(u=o-d,!(!m&&u<0)){if(u/=m,m<0){if(u>x)return;u>p&&(p=u)}else if(m>0){if(u<p)return;u<x&&(x=u)}if(u=n-l,!(!b&&u>0)){if(u/=b,b<0){if(u<p)return;u<x&&(x=u)}else if(b>0){if(u>x)return;u>p&&(p=u)}if(u=i-l,!(!b&&u<0)){if(u/=b,b<0){if(u>x)return;u>p&&(p=u)}else if(b>0){if(u<p)return;u<x&&(x=u)}return p>0&&(e[0]=d+p*m,e[1]=l+p*b),x<1&&(a[0]=d+x*m,a[1]=l+x*b),!0}}}}}var Xt=1e9,ya=-Xt;function kd(e,a,r,n){function o(g,p){return e<=g&&g<=r&&a<=p&&p<=n}function i(g,p,x,m){var b=0,u=0;if(g==null||(b=d(g,x))!==(u=d(p,x))||s(g,p)<0^x>0)do m.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==u);else m.point(p[0],p[1])}function d(g,p){return Re(g[0]-e)<qe?p>0?0:3:Re(g[0]-r)<qe?p>0?2:1:Re(g[1]-a)<qe?p>0?1:0:p>0?3:2}function l(g,p){return s(g.x,p.x)}function s(g,p){var x=d(g,1),m=d(p,1);return x!==m?x-m:x===0?p[1]-g[1]:x===1?g[0]-p[0]:x===2?g[1]-p[1]:p[0]-g[0]}return function(g){var p=g,x=Vo(),m,b,u,w,k,f,v,j,y,N,E,S={point:T,lineStart:H,lineEnd:R,polygonStart:L,polygonEnd:D};function T(h,q){o(h,q)&&p.point(h,q)}function C(){for(var h=0,q=0,M=b.length;q<M;++q)for(var Q=b[q],z=1,P=Q.length,I=Q[0],U,te,$=I[0],pe=I[1];z<P;++z)U=$,te=pe,I=Q[z],$=I[0],pe=I[1],te<=n?pe>n&&($-U)*(n-te)>(pe-te)*(e-U)&&++h:pe<=n&&($-U)*(n-te)<(pe-te)*(e-U)&&--h;return h}function L(){p=x,m=[],b=[],E=!0}function D(){var h=C(),q=E&&h,M=(m=Ho(m)).length;(q||M)&&(g.polygonStart(),q&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),M&&Wo(m,l,h,i,g),g.polygonEnd()),p=g,m=b=u=null}function H(){S.point=O,b&&b.push(u=[]),N=!0,y=!1,v=j=NaN}function R(){m&&(O(w,k),f&&y&&x.rejoin(),m.push(x.result())),S.point=T,y&&p.lineEnd()}function O(h,q){var M=o(h,q);if(b&&u.push([h,q]),N)w=h,k=q,f=M,N=!1,M&&(p.lineStart(),p.point(h,q));else if(M&&y)p.point(h,q);else{var Q=[v=Math.max(ya,Math.min(Xt,v)),j=Math.max(ya,Math.min(Xt,j))],z=[h=Math.max(ya,Math.min(Xt,h)),q=Math.max(ya,Math.min(Xt,q))];wd(Q,z,e,a,r,n)?(y||(p.lineStart(),p.point(Q[0],Q[1])),p.point(z[0],z[1]),M||p.lineEnd(),E=!1):M&&(p.lineStart(),p.point(h,q),E=!1)}v=h,j=q,y=M}return S}}const yn=e=>e;var an=new Rt,wn=new Rt,Yo,Qo,kn,jn,kt={point:it,lineStart:it,lineEnd:it,polygonStart:function(){kt.lineStart=jd,kt.lineEnd=Nd},polygonEnd:function(){kt.lineStart=kt.lineEnd=kt.point=it,an.add(Re(wn)),wn=new Rt},result:function(){var e=an/2;return an=new Rt,e}};function jd(){kt.point=Ed}function Ed(e,a){kt.point=Ko,Yo=kn=e,Qo=jn=a}function Ko(e,a){wn.add(jn*e-kn*a),kn=e,jn=a}function Nd(){Ko(Yo,Qo)}var Ht=1/0,Ia=Ht,la=-Ht,Pa=la,_a={point:Sd,lineStart:it,lineEnd:it,polygonStart:it,polygonEnd:it,result:function(){var e=[[Ht,Ia],[la,Pa]];return la=Pa=-(Ia=Ht=1/0),e}};function Sd(e,a){e<Ht&&(Ht=e),e>la&&(la=e),a<Ia&&(Ia=a),a>Pa&&(Pa=a)}var En=0,Nn=0,Zt=0,Ba=0,$a=0,Bt=0,Sn=0,Cn=0,ea=0,Jo,Xo,mt,ft,rt={point:Ot,lineStart:$r,lineEnd:Ur,polygonStart:function(){rt.lineStart=Ad,rt.lineEnd=qd},polygonEnd:function(){rt.point=Ot,rt.lineStart=$r,rt.lineEnd=Ur},result:function(){var e=ea?[Sn/ea,Cn/ea]:Bt?[Ba/Bt,$a/Bt]:Zt?[En/Zt,Nn/Zt]:[NaN,NaN];return En=Nn=Zt=Ba=$a=Bt=Sn=Cn=ea=0,e}};function Ot(e,a){En+=e,Nn+=a,++Zt}function $r(){rt.point=Cd}function Cd(e,a){rt.point=zd,Ot(mt=e,ft=a)}function zd(e,a){var r=e-mt,n=a-ft,o=Dt(r*r+n*n);Ba+=o*(mt+e)/2,$a+=o*(ft+a)/2,Bt+=o,Ot(mt=e,ft=a)}function Ur(){rt.point=Ot}function Ad(){rt.point=Td}function qd(){Zo(Jo,Xo)}function Td(e,a){rt.point=Zo,Ot(Jo=mt=e,Xo=ft=a)}function Zo(e,a){var r=e-mt,n=a-ft,o=Dt(r*r+n*n);Ba+=o*(mt+e)/2,$a+=o*(ft+a)/2,Bt+=o,o=ft*e-mt*a,Sn+=o*(mt+e),Cn+=o*(ft+a),ea+=o*3,Ot(mt=e,ft=a)}function ei(e){this._context=e}ei.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,st);break}}},result:it};var zn=new Rt,nn,ti,ai,ta,aa,da={point:it,lineStart:function(){da.point=Ld},lineEnd:function(){nn&&ni(ti,ai),da.point=it},polygonStart:function(){nn=!0},polygonEnd:function(){nn=null},result:function(){var e=+zn;return zn=new Rt,e}};function Ld(e,a){da.point=ni,ti=ta=e,ai=aa=a}function ni(e,a){ta-=e,aa-=a,zn.add(Dt(ta*ta+aa*aa)),ta=e,aa=a}let Hr,Ua,Vr,Wr;class Gr{constructor(a){this._append=a==null?ri:Fd(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Vr||this._append!==Ua){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Vr=n,Ua=this._append,Wr=this._,this._=o}this._+=Wr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ri(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Fd(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ri;if(a!==Hr){const r=10**a;Hr=a,Ua=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ua}function Rd(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),_t(l,o(i))),i.result()}return d.area=function(l){return _t(l,o(kt)),kt.result()},d.measure=function(l){return _t(l,o(da)),da.result()},d.bounds=function(l){return _t(l,o(_a)),_a.result()},d.centroid=function(l){return _t(l,o(rt)),rt.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,yn):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new Gr(r)):new ei(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const s=Math.floor(l);if(!(s>=0))throw new RangeError(`invalid digits: ${l}`);r=s}return a===null&&(i=new Gr(r)),d},d.projection(e).digits(r).context(a)}function _n(e){return function(a){var r=new An;for(var n in e)r[n]=e[n];return r.stream=a,r}}function An(){}An.prototype={constructor:An,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Bn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),_t(r,e.stream(_a)),a(_a.result()),n!=null&&e.clipExtent(n),e}function oi(e,a,r){return Bn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,s=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,s])},r)}function Od(e,a,r){return oi(e,[[0,0],a],r)}function Md(e,a,r){return Bn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function Dd(e,a,r){return Bn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var Yr=16,Id=De(30*et);function Qr(e,a){return+a?_d(e,a):Pd(e)}function Pd(e){return _n({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function _d(e,a){function r(n,o,i,d,l,s,g,p,x,m,b,u,w,k){var f=g-n,v=p-o,j=f*f+v*v;if(j>4*a&&w--){var y=d+m,N=l+b,E=s+u,S=Dt(y*y+N*N+E*E),T=sa(E/=S),C=Re(Re(E)-1)<qe||Re(i-x)<qe?(i+x)/2:ia(N,y),L=e(C,T),D=L[0],H=L[1],R=D-n,O=H-o,h=v*R-f*O;(h*h/j>a||Re((f*R+v*O)/j-.5)>.3||d*m+l*b+s*u<Id)&&(r(n,o,i,d,l,s,D,H,C,y/=S,N/=S,E,w,k),k.point(D,H),r(D,H,C,y,N,E,g,p,x,m,b,u,w,k))}}return function(n){var o,i,d,l,s,g,p,x,m,b,u,w,k={point:f,lineStart:v,lineEnd:y,polygonStart:function(){n.polygonStart(),k.lineStart=N},polygonEnd:function(){n.polygonEnd(),k.lineStart=v}};function f(T,C){T=e(T,C),n.point(T[0],T[1])}function v(){x=NaN,k.point=j,n.lineStart()}function j(T,C){var L=Ut([T,C]),D=e(T,C);r(x,m,p,b,u,w,x=D[0],m=D[1],p=T,b=L[0],u=L[1],w=L[2],Yr,n),n.point(x,m)}function y(){k.point=f,n.lineEnd()}function N(){v(),k.point=E,k.lineEnd=S}function E(T,C){j(o=T,C),i=x,d=m,l=b,s=u,g=w,k.point=j}function S(){r(x,m,p,b,u,w,i,d,o,l,s,g,Yr,n),k.lineEnd=y,y()}return k}}var Bd=_n({point:function(e,a){this.stream.point(e*et,a*et)}});function $d(e){return _n({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Ud(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function Kr(e,a,r,n,o,i){if(!i)return Ud(e,a,r,n,o);var d=De(i),l=Ie(i),s=d*e,g=l*e,p=d/e,x=l/e,m=(l*r-d*a)/e,b=(l*a+d*r)/e;function u(w,k){return w*=n,k*=o,[s*w-g*k+a,r-g*w-s*k]}return u.invert=function(w,k){return[n*(p*w-x*k+m),o*(b-x*w-p*k)]},u}function Hd(e){return Vd(function(){return e})()}function Vd(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,s=0,g=0,p,x=0,m=1,b=1,u=null,w=Br,k=null,f,v,j,y=yn,N=.5,E,S,T,C,L;function D(h){return T(h[0]*et,h[1]*et)}function H(h){return h=T.invert(h[0],h[1]),h&&[h[0]*yt,h[1]*yt]}D.stream=function(h){return C&&L===h?C:C=Bd($d(p)(w(E(y(L=h)))))},D.preclip=function(h){return arguments.length?(w=h,u=void 0,O()):w},D.postclip=function(h){return arguments.length?(y=h,k=f=v=j=null,O()):y},D.clipAngle=function(h){return arguments.length?(w=+h?yd(u=h*et):(u=null,Br),O()):u*yt},D.clipExtent=function(h){return arguments.length?(y=h==null?(k=f=v=j=null,yn):kd(k=+h[0][0],f=+h[0][1],v=+h[1][0],j=+h[1][1]),O()):k==null?null:[[k,f],[v,j]]},D.scale=function(h){return arguments.length?(r=+h,R()):r},D.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],R()):[n,o]},D.center=function(h){return arguments.length?(i=h[0]%360*et,d=h[1]%360*et,R()):[i*yt,d*yt]},D.rotate=function(h){return arguments.length?(l=h[0]%360*et,s=h[1]%360*et,g=h.length>2?h[2]%360*et:0,R()):[l*yt,s*yt,g*yt]},D.angle=function(h){return arguments.length?(x=h%360*et,R()):x*yt},D.reflectX=function(h){return arguments.length?(m=h?-1:1,R()):m<0},D.reflectY=function(h){return arguments.length?(b=h?-1:1,R()):b<0},D.precision=function(h){return arguments.length?(E=Qr(S,N=h*h),O()):Dt(N)},D.fitExtent=function(h,q){return oi(D,h,q)},D.fitSize=function(h,q){return Od(D,h,q)},D.fitWidth=function(h,q){return Md(D,h,q)},D.fitHeight=function(h,q){return Dd(D,h,q)};function R(){var h=Kr(r,0,0,m,b,x).apply(null,a(i,d)),q=Kr(r,n-h[0],o-h[1],m,b,x);return p=ud(l,s,g),S=bn(a,q),T=bn(p,S),E=Qr(S,N),O()}function O(){return C=L=null,D}return function(){return a=e.apply(this,arguments),D.invert=a.invert&&H,R()}}function ii(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}ii.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Re(o)>qe&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Wd(){return Hd(ii).scale(175.295)}function Gd(e){return e}function Yd(e){if(e==null)return Gd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,s){s||(a=r=0);var g=2,p=l.length,x=new Array(p);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+d;g<p;)x[g]=l[g],++g;return x}}function Qd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Kd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Jr(e,r)})}:Jr(e,a)}function Jr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Jd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Jd(e,a){var r=Yd(e.transform),n=e.arcs;function o(p,x){x.length&&x.pop();for(var m=n[p<0?~p:p],b=0,u=m.length;b<u;++b)x.push(r(m[b],b));p<0&&Qd(x,u)}function i(p){return r(p)}function d(p){for(var x=[],m=0,b=p.length;m<b;++m)o(p[m],x);return x.length<2&&x.push(x[0]),x}function l(p){for(var x=d(p);x.length<4;)x.push(x[0]);return x}function s(p){return p.map(l)}function g(p){var x=p.type,m;switch(x){case"GeometryCollection":return{type:x,geometries:p.geometries.map(g)};case"Point":m=i(p.coordinates);break;case"MultiPoint":m=p.coordinates.map(i);break;case"LineString":m=d(p.arcs);break;case"MultiLineString":m=p.arcs.map(d);break;case"Polygon":m=s(p.arcs);break;case"MultiPolygon":m=p.arcs.map(s);break;default:return null}return{type:x,coordinates:m}}return g(a)}const si={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Xd=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Zd(e,a,r){const n=si[e];if(!n||!n.length)return-1;const o=Xd(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let wa=null;function ep(){return wa||(wa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Kd(r,n),i=Wd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Rd(i),l=(o.features||[]).filter(p=>{var x;return(((x=p.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(p=>{var b;const x=((b=p.properties)==null?void 0:b.name)||"",m=d(p)||"";return m?{i2:is(x)||null,n:x,d:m}:null}).filter(p=>!!p);if(!l.length)return null;const s={};for(const[p,x]of Object.entries(ss)){const m=i(x);m&&(s[p]={x:m[0],y:m[1]})}const g={};for(const[p,x]of Object.entries(si)){const m=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,u])=>({x:b,y:u}));m.length&&(g[p]=m)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:s,metros:g}}catch{return null}})(),wa)}function tp(e){const[a,r]=c.useState(null);return c.useEffect(()=>{if(!e||a)return;let n=!1;return ep().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const ap="8 40 984 210",np={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Xr=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function Zr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function rp(e,a){const[r,n]=c.useState(1);return c.useEffect(()=>{let o=!0,i=0;const d=()=>{var g;if(!o)return;const s=(g=e.current)==null?void 0:g.getScreenCTM();s&&s.a>0?n(s.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function eo({msgs:e}){const[a,r]=c.useState(0);c.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function op(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:s,data:g,dossiers:p,source:x}=K(),m=g.loading&&!p.length,b=c.useRef(null),u=c.useRef(null),w=tp(e.continent==="monde"),k=e.continent==="monde"?w:Rn.find(h=>h.key===e.continent)||null,f=rp(b,e.continent+":"+e.mapFolded+":"+!!k),[v,j]=c.useState(new Map),[y,N]=c.useState(null);c.useEffect(()=>{const h=b.current;if(!h)return;const q=new Map;h.querySelectorAll("path[data-i2]").forEach(M=>{const Q=M.dataset.i2;if(Q)try{const z=M.getBBox();z.width>0&&q.set(Q,{x:z.x,y:z.y,w:z.width,h:z.height})}catch{}}),j(q)},[e.continent,f,k]);const E=c.useMemo(()=>r.filter(h=>h.cc),[r]),S=c.useMemo(()=>{const h=new Map;return E.forEach(q=>h.set(q.cc,(h.get(q.cc)||0)+1)),h},[E]),T=e.continent==="monde"&&w?w.anchors:null,C=e.continent==="monde"&&w?w.metros:null,L=c.useMemo(()=>E.map(h=>{const q=Zr(h.name||h.id||""),M=Zr((h.id||h.name||"")+"·y");if(T&&h.cc){const U=C?C[h.cc]:void 0;if(U&&U.length){const $=Zd(h.cc,h.city,q);if($>=0&&U[$])return{d:h,x:U[$].x+(q-.5)*5,y:U[$].y+(M-.5)*5}}const te=T[h.cc];if(te)return{d:h,x:te.x+(q-.5)*10,y:te.y+(M-.5)*10}}const Q=h.cc?v.get(h.cc):void 0;if(!Q)return null;const z=np[`${e.continent}:${h.cc||""}`];if(z)return{d:h,x:Q.x+Q.w*(z.fx+(q-.5)*z.sx),y:Q.y+Q.h*(z.fy+(M-.5)*z.sy)};const P=(q-.5)*Math.min(Q.w*.55,60),I=(M-.5)*Math.min(Q.h*.55,60);return{d:h,x:Q.x+Q.w/2+P,y:Q.y+Q.h/2+I}}).filter(h=>!!h),[E,v,T,C,e.continent]),D=h=>f>0?h/f:h,H=c.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:Xr[h],fr:s.plabels[h],en:s.plabels[h],n:r.filter(q=>q.kind==="target"&&Le(q)===h).length})).filter(h=>h.n>0):ar.map((h,q)=>({...h,n:r.filter(M=>nr(M)===q).length})),[r,n,s.plabels]),R=i?d.get(i):null,O=R?L.find(h=>h.d.id===R.id):null;return k?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:u,children:[m&&t.jsx(eo,{msgs:s.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?ap:k.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?k.fr:k.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:k.countries.map((h,q)=>t.jsx("g",{className:"ct"+(h.i2&&S.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},q))}),t.jsx("g",{children:L.map(h=>{const q=ar[nr(h.d)],M=!!$e(h.d),Q=h.d.kind==="target",z=n&&Q?Xr[Le(h.d)]:q.c,P=!n&&Ge(h.d);return t.jsxs("g",{className:"co"+(P?" done":""),onMouseEnter:()=>{var te,$;const I=(te=u.current)==null?void 0:te.getBoundingClientRect(),U=($=b.current)==null?void 0:$.createSVGPoint();if(U&&b.current&&I){U.x=h.x,U.y=h.y;const pe=U.matrixTransform(b.current.getScreenCTM());N({x:pe.x-I.left,y:pe.y-I.top,label:h.d.name+" · "+(Gt(h.d.cc,l)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var te;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const I=(te=b.current)==null?void 0:te.createSVGPoint();let U=null;if(I&&b.current){I.x=h.x,I.y=h.y;const $=I.matrixTransform(b.current.getScreenCTM());U={x:$.x,y:$.y}}a({type:"popup",id:h.d.id,anchor:U})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:D(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:D(q.px),fill:z,stroke:M?"#E5484D":"#ffffff",strokeWidth:D(M?2.2:1.3)})]},h.d.id||h.d.name)})}),O&&t.jsx("circle",{className:"ring on",cx:O.x,cy:O.y,r:D(13),fill:"none",stroke:"#16233A",strokeWidth:D(2)})]}),t.jsx("div",{className:"hov"+(y?" on":""),style:y?{left:y.x,top:y.y}:void 0,children:y==null?void 0:y.label}),t.jsx("div",{className:"legend",children:H.map((h,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),l==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},q))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",s.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:u,children:t.jsx(eo,{msgs:s.loadMsgs})})}function ip(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function li({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=K(),s=a.filters,[g,p]=c.useState(!1),[x,m]=c.useState(!1),b=c.useRef(null),u=c.useRef(null),w=c.useMemo(()=>a.continent==="monde"?n:n.filter(O=>O.continent===a.continent),[n,a.continent]),k=O=>w.filter(h=>O!=="country"&&s.country.length&&!s.country.includes(h.cc||"")?!1:Ra(h,s,i,O==="country"?void 0:O)),f=O=>!i||O.kind!=="op",v=c.useMemo(()=>{const O=k("win").filter(f),h=q=>O.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=q).length;return[h(0),h(7),h(30),O.length]},[w,s,i]),j=c.useMemo(()=>s.day?k("win").filter(f).filter(O=>(O.date||"").slice(0,10)===s.day).length:0,[w,s,i]),y=(s.signalOnly?1:0)+s.sector.length+s.market.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+s.crible.length,N=y+(s.acquirer.trim()?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0);c.useEffect(()=>{a.openFacet&&p(!1)},[a.openFacet]),c.useEffect(()=>{if(!g&&!x)return;const O=q=>{var Q,z;const M=q.target;g&&!((Q=b.current)!=null&&Q.contains(M))&&p(!1),x&&!((z=u.current)!=null&&z.contains(M))&&m(!1)},h=q=>{q.key==="Escape"&&(p(!1),m(!1))};return document.addEventListener("mousedown",O),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",O),document.removeEventListener("keydown",h)}},[g,x]);const E=(O,h,q,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===O,onClick:()=>r({type:"openFacet",facet:O}),children:[t.jsx("span",{className:"fl",children:h}),q>0&&t.jsx("span",{className:"n",children:q}),t.jsx("span",{className:"cv",children:"▾"})]},O),S=["1","7","30","all"],T=Math.max(0,S.indexOf(s.win||"all")),C=s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(ip(s.day,l))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:u,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>m(O=>!O),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:v[T]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:S.map((O,h)=>t.jsxs("button",{type:"button",role:"option","aria-selected":s.win===O,onClick:()=>{r({type:"filters",patch:{win:O}}),m(!1)},children:[o.datesShort[h],t.jsx("span",{className:"n",children:v[h]})]},O))})]}):t.jsx("div",{className:"seg",children:S.map((O,h)=>t.jsxs("button",{type:"button","aria-pressed":s.win===O,onClick:()=>r({type:"filters",patch:{win:O}}),children:[t.jsx("span",{className:"sl",children:o.dates[h]}),t.jsx("b",{children:v[h]})]},O))}),L=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:s.search,onChange:O=>r({type:"filters",patch:{search:O.target.value}})})]}),D=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):E("sec",o.fSector,s.sector.length),(n.some(O=>!!O.market)||s.market.length>0)&&E("mar",o.fMarket,s.market.length),E("pay",o.fCountry,s.country.length),E("det",o.fEngine,s.engine.length),E("sta",o.fStage,s.stage.length),i&&E("crib",o.fVerdict,s.crible.length),i&&E("ang","Angle",s.angle.length),i&&E("mem","Mémo",s.memoLevel.length)]}),H=(O=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),O&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),R=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(y?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{p(O=>!O),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),y>0&&t.jsx("span",{className:"n",children:y}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:D})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(s.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:C}),t.jsxs("div",{className:"fstrip-b",children:[L,R,H(!1)]})]}),a.openFacet&&t.jsx(to,{poolFor:k})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[C,L,D,t.jsx("span",{className:"fgrow"}),H()]}),a.openFacet&&t.jsx(to,{poolFor:k})]})}function to({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=K(),l=a.filters,s=a.openFacet,{title:g,cols:p,options:x}=c.useMemo(()=>{if(s==="sig"){const k=e("signal").filter(j=>$e(j)),f=new Map;k.forEach(j=>{const y=j.engine||"";f.set(y,(f.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:k.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...un([...f.keys()],o).map(j=>({v:j,label:Ft(j)+" "+tt(j,o),n:f.get(j)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(s==="crib"){const k=e("crible").filter(v=>!i||xo(v,a.ptab,d.favIds)),f=new Map;return k.forEach(v=>{const j=bo(v);j&&j!=="NEW"&&f.set(j,(f.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((v,j)=>(rr[v[0]]??9)-(rr[j[0]]??9)||j[1]-v[1]).map(([v,j])=>({v,label:'<span class="fdot" style="background:'+(ls[v]||"#94A3B8")+'"></span>'+v,n:j,html:!0,on:l.crible.includes(v)}))}}if(s==="sec"){const k=e("sector"),f=new Map;return k.forEach(v=>{v.sector&&f.set(v.sector,(f.get(v.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:l.sector.includes(v)}))}}if(s==="mar"){const k=e("market"),f=new Map;return k.forEach(v=>{v.market&&f.set(v.market,(f.get(v.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:l.market.includes(v)}))}}if(s==="pay"){const k=e("country"),f=new Map;return k.forEach(v=>{v.cc&&f.set(v.cc,(f.get(v.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:Gt(v,o)||v,n:j,html:!1,on:l.country.includes(v)}))}}if(s==="det"){const k=e("engine"),f=new Map;return k.forEach(v=>{v.engine&&f.set(v.engine,(f.get(v.engine)||0)+1)}),{title:n.fEngine,cols:2,options:un([...f.keys()],o).map(v=>({v,label:Ft(v)+" "+tt(v,o)+' <span style="color:var(--dim);font-size:10px">· '+ds(ps(v),o)+"</span>",n:f.get(v)||0,html:!0,on:l.engine.includes(v)}))}}if(s==="ang"){const k=e("angle"),f=new Map;return k.forEach(v=>{v.angle&&f.set(v.angle,(f.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v.replace(/[_-]+/g," "),n:j,html:!1,on:l.angle.includes(v)}))}}if(s==="mem"){const k=e("memoLevel"),f=new Map;k.forEach(j=>{if(j.kind==="target"){const y=Ln(j);f.set(y,(f.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:v[j],n:f.get(j)||0,html:!1,on:l.memoLevel.includes(j)}))}}const u=e("stage"),w=new Map;return u.forEach(k=>{k.stage&&w.set(k.stage,(w.get(k.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:k,n:f,html:!1,on:l.stage.includes(k)}))}},[s,a,o]),m=u=>{if(s==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const k=l.signalEngines.includes(u)?l.signalEngines.filter(f=>f!==u):[...l.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:k}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage",value:u})},b=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:g}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>m(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function di({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=K(),s=c.useMemo(()=>{const b={};return r.forEach(u=>{Ra(u,n.filters,i)&&(b.monde=(b.monde||0)+1,u.continent&&(b[u.continent]=(b[u.continent]||0)+1))}),b},[r,n.filters,i]),[g,p]=c.useState(!1),x=c.useRef(null);c.useEffect(()=>{if(!g)return;const b=w=>{var k;(k=x.current)!=null&&k.contains(w.target)||p(!1)},u=w=>{w.key==="Escape"&&p(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",u),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",u)}},[g]);const m=b=>{const u=Rn.find(w=>w.key===b);return b==="monde"?l.contWorld:d==="fr"?u.fr:u.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>p(b=>!b),children:[m(n.continent),t.jsx("span",{className:"n",children:s[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:or.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),p(!1)},children:[m(b),t.jsx("span",{className:"n",children:s[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[or.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[m(b),t.jsx("span",{className:"n",children:s[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]})]})}function qn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function pi(e){return"atl2:evalq:"+(e||"anon")}function sp(e,a){const r=pi(e),n=qn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function lp(){const{t:e,data:a,dossiers:r}=K(),n=a.session.token||"",o=pi(n),[i,d]=c.useState(()=>qn(o)),l=c.useRef(!1),[s,g]=c.useState(!1);c.useEffect(()=>{try{const z=i.slice(0,30).map(({descBusy:P,evalBusy:I,...U})=>U);localStorage.setItem(o,JSON.stringify(z)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[i,o]),c.useEffect(()=>{const z=()=>{if(l.current)return;const P=qn(o);d(I=>JSON.stringify(I.map(({descBusy:U,evalBusy:te,...$})=>$))===JSON.stringify(P)?I:P)};return window.addEventListener("atl2:evalq",z),window.addEventListener("storage",z),()=>{window.removeEventListener("atl2:evalq",z),window.removeEventListener("storage",z)}},[o]);const[p,x]=c.useState([]),[m,b]=c.useState(""),[u,w]=c.useState(!1),[k,f]=c.useState(!1),[v,j]=c.useState(""),y=c.useCallback((z,P)=>d(I=>I.map((U,te)=>te===z?{...U,...P}:U)),[]),N=c.useCallback((z,P)=>{const I=P.trim();I&&(y(z,{name:I,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),On(I).then(U=>{const te=U.candidates||[];U.website?y(z,{site:U.website,status:"ready"}):te.length===1?y(z,{site:te[0].url,status:"ready"}):te.length>1?y(z,{status:"pick",candidates:te.slice(0,6)}):y(z,{status:"ready"})}).catch(()=>y(z,{status:"ready"})))},[y]),E=c.useCallback((z,P,I)=>{y(z,{descBusy:!0}),ko(n,P,I).then(U=>{if(U.quota){g(!0),y(z,{descBusy:!1,descDone:!0});return}const te=U.blocs||{},$=(te.synthese||te.value_prop||te.produit||te.modele||"").trim();y(z,{descBusy:!1,descDone:!0,desc:$})}).catch(()=>y(z,{descBusy:!1,descDone:!0}))},[y,n]);c.useEffect(()=>{const z=i.findIndex(I=>I.auto&&I.name.trim()&&I.status==="");if(z>=0){N(z,i[z].name);return}if(s)return;const P=i.findIndex(I=>I.status==="ready"&&I.site&&!I.descDone&&!I.descBusy);P>=0&&E(P,i[P].name,i[P].site)},[i,N,E,s]);const[S,T]=c.useState(!1),C=c.useCallback(async(z,P)=>{y(z,{evalBusy:!0});const I=await jo(n,(P.site||P.name).trim(),"atelier2");return I.verdict==="quota"?(y(z,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:I.reason||"",remaining:0}})),!1):(y(z,{evalBusy:!1,status:I.verdict==="kept"?"kept":"out",reason:I.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:I.company||P.name,verdict:I.verdict,reason:I.reason||"",remaining:I.remaining??null}})),!0)},[y,n]),L=async()=>{if(S)return;const z=i.map((P,I)=>({r:P,i:I})).filter(({r:P})=>P.name.trim()&&P.status!=="kept"&&P.status!=="out"&&P.status!=="resolving");if(z.length){T(!0);for(const{r:P,i:I}of z)if(!await C(I,P))break;T(!1)}},D=c.useMemo(()=>{const z=new Set,P=[];return i.filter(I=>I.status==="kept").forEach(I=>{const U=I.name.trim().toLowerCase();U&&!z.has(U)&&(z.add(U),P.push(I.name.trim()))}),r.filter(I=>Le(I)>=1&&Le(I)<=4&&(I.website||I.domain)).forEach(I=>{const U=(I.name||"").trim().toLowerCase();U&&!z.has(U)&&(z.add(U),P.push((I.name||"").trim()))}),P},[i,r]),H=c.useMemo(()=>{const z=new Set;return r.forEach(P=>{const I=(P.name||"").trim().toLowerCase();I&&z.add(I)}),i.forEach(P=>{const I=P.name.trim().toLowerCase();I&&z.add(I)}),z},[r,i]),R=async()=>{if(m||!D.length)return;f(!1);const z=[];for(const P of D.slice(0,2)){b(P);const I=await Eo(n,P);if(I){if(I.verdict==="quota"){w(!0);break}(I.results||[]).forEach(U=>{const te=(U.company||"").trim().toLowerCase();!te||H.has(te)||z.some($=>$.name.toLowerCase()===te)||z.push({name:(U.company||"").trim(),verdict:U.verdict||"",reason:U.reason,from:P})})}}b(""),f(!0),x(P=>[...z,...P].slice(0,24))},O=async(z,P)=>{if(m)return;f(!1),b(z==="thesis"?e.pxThesis:P);const I=await cs(n,z,P,6);if(b(""),f(!0),!I)return;if(I.verdict==="quota"){w(!0);return}const U=[];(I.results||[]).forEach(te=>{const $=(te.company||"").trim().toLowerCase();!$||H.has($)||U.some(pe=>pe.name.toLowerCase()===$)||U.push({name:(te.company||"").trim(),verdict:te.verdict||"",reason:te.reason,from:z==="thesis"?e.pxThesis:P})}),x(te=>[...U,...te].slice(0,24))},h=()=>{const z=v.trim();z.length<3||O(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(z)?"registry":"keyword",z)},q=z=>{d(P=>[...P,{name:z.name,site:"",status:"",auto:!0}].slice(0,30)),x(P=>P.filter(I=>I.name!==z.name))},M=i.filter(z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out").length,Q=z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving"&&!z.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((z,P)=>t.jsxs("div",{className:"eq-row"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsx("input",{value:z.name,placeholder:e.eqNamePh,onChange:I=>{const U=I.target.value.split(`
`).map(te=>te.trim()).filter(Boolean);U.length>1?d(te=>{const $=[...te];return $.splice(P,1,...U.map(pe=>({name:pe,site:"",status:"",auto:!0}))),$.slice(0,30)}):y(P,{name:I.target.value})},onBlur:()=>{z.name.trim()&&!z.site&&z.status!=="resolving"&&z.status!=="pick"&&N(P,z.name)},onKeyDown:I=>{I.key==="Enter"&&N(P,z.name)}}),t.jsxs("span",{className:"eq-site",children:[z.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),z.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:I=>{const U=I.target.value;U&&y(P,{site:U,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(z.candidates||[]).map(I=>t.jsx("option",{value:I.url,children:(I.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},I.url))]}),z.status!=="resolving"&&z.status!=="pick"&&(z.site?t.jsxs("a",{href:z.site.startsWith("http")?z.site:"https://"+z.site,target:"_blank",rel:"nofollow noopener",children:[z.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:z.name.trim()&&z.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:z.desc||"",children:z.descBusy?t.jsx("i",{children:e.eqDescBusy}):z.desc?z.desc:t.jsx("em",{children:z.descDone?s?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(z.status||"vide"),title:z.reason||"",children:z.status==="kept"?"✓ "+e.kept:z.status==="out"?"✗ "+e.dropped:z.status==="ready"?e.eqReady:z.status==="pick"?e.eqPick:""}),t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!Q(z)||S,onClick:()=>{C(P,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>d(I=>I.filter((U,te)=>te!==P)),children:"×"})]},P)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>d(z=>[...z,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!m,onClick:()=>{O("thesis","")},children:m===e.pxThesis?e.sgBusy(m):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:v,placeholder:e.pxPlace,onChange:z=>j(z.target.value),onKeyDown:z=>{z.key==="Enter"&&h()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!m||v.trim().length<3,onClick:h,children:e.pxGoFree}),!!D.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!m,onClick:()=>{R()},children:m&&m!==e.pxThesis&&m!==v?e.sgBusy(m):e.sgGo}),!!D.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(D[0],D.length)}),u&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),k&&!p.length&&!u&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),p.map(z=>t.jsxs("span",{className:"eq-sc"+(z.verdict==="kept"?" ok":""),title:(z.reason||"")+" — "+e.sgVia(z.from),children:[t.jsx("b",{children:z.name}),z.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>q(z),children:"+"})]},z.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),i.some(z=>z.status==="kept"||z.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>d(z=>z.filter(P=>P.status!=="kept"&&P.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(S?" loading":""),style:{justifyContent:"center"},disabled:S||!M,onClick:()=>{L()},children:[t.jsx("span",{className:"fill"}),S?e.eqRunning:e.eqGo(M)]})]})]})]})}const dp={deals:"ma-deals",news:"veille"};function ao(e){return(e.url||e.title||"").trim()}function pp(e){const a=(e.title||"").replace(/\s+/g," ").trim();if(!a)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const r=/^(.{2,72}?)[:–—|]/.exec(a);return r?r[1].trim():(a.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||a).slice(0,72).trim()}function cp({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,canWrite:i}=K(),[d,l]=c.useState(null),[s,g]=c.useState({deals:[],news:[]}),[p,x]=c.useState({deals:!1,news:!1}),[m,b]=c.useState(null),[u,w]=c.useState(""),k=c.useRef(!1),f=c.useCallback(async C=>{if(!o)return[];if(p[C])return s[C];b(C),w("");const L=await us(dp[C],o,n);return b(null),!L.ok&&L.error?(w(L.error),[]):(g(D=>({...D,[C]:L.items})),x(D=>({...D,[C]:!0})),L.items)},[o,n,p,s]);c.useEffect(()=>{d&&f(d)},[d,f]);const v=c.useCallback(C=>s[C].map(ao).filter(Boolean),[s]),j=c.useMemo(()=>{var D,H;if(!o)return{deals:[],news:[]};const C={deals:v("deals"),news:v("news")},L=Lo("feed:"+o,C);return{deals:((D=L.deals)==null?void 0:D.noms)||[],news:((H=L.news)==null?void 0:H.noms)||[]}},[o,v]),y=c.useRef(null);c.useEffect(()=>{y.current&&!d&&o&&Fo("feed:"+o,{deals:v("deals"),news:v("news")}),y.current=d},[d,o,v]);const N=C=>{const L=C.map(pp).filter(Boolean);L.length&&(a(L),l(null))},E=(C,L)=>{const D=(C.url||"").trim();if(L==="news"&&D&&/^https?:\/\//i.test(D)){window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:D}})),l(null);return}N([C])},S=async C=>{if(d===C){l(null);return}if(k.current)return;k.current=!0;const L=await f(C);if(k.current=!1,C==="deals"&&L.length){N(L);return}l(C)},T=C=>{const L=s[C],D=new Set(j[C].map(H=>H.toLowerCase()));return t.jsxs("div",{className:"dfpane"+(d===C?" on":""),hidden:d!==C,children:[t.jsx("p",{className:"dfh",children:C==="deals"?r.feedDealsH:r.feedNewsH}),m===C&&t.jsx("p",{className:"dfload",children:n==="en"?"Loading…":"Chargement…"}),d===C&&!!u&&t.jsx("p",{className:"dferr",children:u}),p[C]&&!L.length&&!m&&t.jsx("p",{className:"dfempty",children:C==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!L.length&&t.jsx("ul",{className:"dflist",children:L.map((H,R)=>{const O=ao(H),h=D.has(O.toLowerCase()),q=(H.url||"").trim();return t.jsxs("li",{className:h?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:H.title||q}),t.jsx("span",{children:[H.source,H.sector_fr,(H.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[q&&t.jsx("a",{href:q,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),i&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>E(H,C),children:C==="deals"?r.feedToEval:r.feedToExtract})]})]},O||R)})})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(C=>{const L=j[C].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(C==="deals"?"ddeals":"dnews")+(d===C?" on":""),onClick:()=>{S(C)},children:[C==="deals"?r.feedDeals:r.feedNews,L>0&&t.jsx("em",{title:r.feedHint,children:r.feedNew(L)})]},C)}),d&&T(d)]})}function ci(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function up(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function no({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=K();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(s=>s.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(s=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:s.name}),s.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),s.line1&&t.jsx("p",{className:"w",children:s.line1}),s.line2&&t.jsx("p",{className:"r",children:s.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(s.name),children:l.rsEvalOne})]},s.name))})]}):null}function ui({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=K(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(no,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(no,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function mp({card:e,onEvaluate:a,onAddAll:r}){var l,s,g;const{t:n}=K(),o=[e.industry,...e.market_tags||[],e.author].map(p=>(p||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(p=>p&&p.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(p=>t.jsx("span",{children:p},p))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ci(e.summary_md||"").map((p,x)=>t.jsx("p",{children:p},x))})]}),t.jsx(ui,{card:e,onEvaluate:a,onAddAll:r}),(((s=e.prospective)==null?void 0:s.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(p=>t.jsx("li",{children:p},p))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(p=>t.jsx("a",{href:p.url,target:"_blank",rel:"noopener noreferrer",children:p.label||p.url},p.url))})]})]})}function fp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function hp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=K(),l=o,[s,g]=c.useState(null),[p,x]=c.useState(null),[m,b]=c.useState(null),[u,w]=c.useState(!1);c.useEffect(()=>{let f=!0;return(async()=>{const v=await No({email:d,cbToken:l});f&&g(v)})(),()=>{f=!1}},[d,l,n]);const k=f=>{x(f),b(null),w(!0),(async()=>{const v=await ms(f.id);b(v),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[p?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),p&&t.jsx("span",{className:"ti",children:p.title}),!p&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!p&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(s||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>k(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[fp(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),p&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[p.source_url&&t.jsx("a",{href:p.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),p.published&&p.page_url&&t.jsx("a",{href:p.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(p.published?" on":""),children:p.published?i.rsPub:i.rsPriv})]}),u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!u&&!m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!u&&m&&t.jsx(mp,{card:m,onEvaluate:a,onAddAll:r})]})]})}const Ca=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function na(e){return/^https?:\/\//i.test((e||"").trim())}function pt(e){const a=(e||"").trim();return a?na(a)?a:Ca.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function gp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function xp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:l,evalBusy:s,evalCards:g,caps:p,data:x,canWrite:m,source:b,dossiers:u,doAnalyse:w,liveMemos:k,pipe:f}=K(),v=r==="client",j=c.useMemo(()=>n||(b!=="default"?fs():""),[n,b]),[y,N]=c.useState(""),[E,S]=c.useState(!1),[T,C]=c.useState(""),[L,D]=c.useState(""),[H,R]=c.useState(""),[O,h]=c.useState(!1),[q,M]=c.useState(!1),[Q,z]=c.useState([]);c.useEffect(()=>{const _=ae=>{const Z=ae.detail;Z&&z(fe=>[Z,...fe].slice(0,8))};return window.addEventListener("ppmap:evalcard",_),()=>window.removeEventListener("ppmap:evalcard",_)},[]);const[P,I]=c.useState(!1),[U,te]=c.useState(!1),[$,pe]=c.useState(!1),J=c.useRef(!1),[le,ge]=c.useState(""),[ue,ye]=c.useState(""),[be,Ee]=c.useState(!1),[Fe,ne]=c.useState(!1),[Ne,ve]=c.useState(0),[ie,B]=c.useState(""),[W,ee]=c.useState(null),[de,ce]=c.useState(null),[re,oe]=c.useState(!1),[me,we]=c.useState(null),[Ce,ke]=c.useState(0),je=c.useRef(!1),ht=y.trim()?Ca.test(y.trim())?e.evalUrl:e.evalName:e.evalWaiting;c.useEffect(()=>{if(typeof window>"u")return;const _=new URLSearchParams(window.location.search),ae=(_.get("rs")||"").trim(),Z=(_.get("rstext")||"").trim();ae&&/^https?:\/\//i.test(ae)&&ge(ae),Z&&ye(Z),(ae&&/^https?:\/\//i.test(ae)||Z)&&I(!0)},[]),c.useEffect(()=>{const _=ae=>{const Z=ae.detail||{},fe=String(Z.url||"").trim(),ze=String(Z.text||"").trim();fe&&/^https?:\/\//i.test(fe)&&ge(fe),ze&&ye(ze),(fe&&/^https?:\/\//i.test(fe)||ze)&&(I(!0),N(""),C(""),Ee(!0),window.setTimeout(()=>Ee(!1),900))};return window.addEventListener("ppmap:research",_),()=>window.removeEventListener("ppmap:research",_)},[]),c.useEffect(()=>{const _=ae=>{const Z=ae.detail||{},fe=String(Z.name||"").trim();if(!fe)return;I(!1),N(fe),C(fe);const ze=pt(String(Z.website||Z.domain||""));D(ze),R(pt(String(Z.url||""))),h(!ze),S(!0),window.setTimeout(()=>S(!1),900)};return window.addEventListener("ppmap:prefill",_),()=>window.removeEventListener("ppmap:prefill",_)},[]),c.useEffect(()=>{const _=(T||"").trim();if(!_||P||L){(L||!_||P)&&h(!1);return}const ae=Ue(_),Z=u.find(Oe=>Ue(Oe.name)===ae)||u.find(Oe=>{const Te=Ue(Oe.name);return Te.length>=3&&(ae.includes(Te)||Te.includes(ae))}),fe=pt((Z==null?void 0:Z.website)||"")||pt((Z==null?void 0:Z.domain)||""),ze=pt((Z==null?void 0:Z.url)||"");if(ze&&R(Oe=>Oe||ze),fe){D(fe),h(!1);return}let xe=!0;return h(!0),On(_).then(Oe=>{var nt,vt;if(!xe)return;const Te=pt(Oe.website||"")||pt(((vt=(nt=Oe.candidates)==null?void 0:nt[0])==null?void 0:vt.url)||"");Te&&D(Te)}).catch(()=>{}).finally(()=>{xe&&h(!1)}),()=>{xe=!1}},[T,P,L,u]),c.useEffect(()=>{const _=ae=>{var fe;const Z=String(((fe=ae.detail)==null?void 0:fe.url)||"").trim();na(Z)&&window.open(Z,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",_),()=>window.removeEventListener("ppmap:view",_)},[]),c.useEffect(()=>{if(J.current===P)return;J.current=P,pe(!0);const _=window.setTimeout(()=>pe(!1),560);return()=>window.clearTimeout(_)},[P]),c.useEffect(()=>{if(typeof window>"u")return;const _=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ae=document.querySelector(".atl2.ops, .atl2.cibles");if(!_||!ae)return;const Z=()=>ae.style.setProperty("--demand-h",`${_.offsetHeight}px`);Z();const fe=new ResizeObserver(Z);return fe.observe(_),()=>fe.disconnect()},[b,E,be,q,P,$,O]),c.useEffect(()=>{if(!m&&!j){we(null);return}let _=!0;return(async()=>{const ae=await No({email:o,cbToken:j});_&&we(ae.length)})(),()=>{_=!1}},[m,j,o,Ce]);const gt=Q.length?Q:g,_e=x.credits,lt=c.useCallback(_=>{sp(n,_)&&(M(!1),l({type:"ptab",tab:0}),requestAnimationFrame(()=>{const ae=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!ae)return;const Z=window.scrollY+ae.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,Z),behavior:"smooth"})}))},[n,l]);c.useEffect(()=>{if(!Fe)return;ve(0);const _=window.setInterval(()=>ve(ae=>ae+1),1e3);return()=>window.clearInterval(_)},[Fe]);const xt=c.useMemo(()=>{const _=y.trim().toLowerCase();return!_||!f?null:u.find(ae=>Ue(ae.name)===_&&Le(ae)===1)||null},[y,u,f]),At=()=>{const _=y.trim();if(_){if(xt){w(xt);return}i(null,_),v&&N("")}},at=async()=>{var Z,fe,ze;if(je.current)return;const _=le.trim().replace(/\s+/g,""),ae=ue.trim();if(!_&&!ae){B(e.rsNeed);return}if(!v&&!j){i(null,_||ae.slice(0,80));return}je.current=!0,B(""),ee(null),ce(null),ne(!0);try{const xe=await gs({url:_,text:ae,email:o,cbToken:j});if(ne(!1),!xe||xe.status!=="success"){B((xe==null?void 0:xe.message)||"Erreur");return}ee(xe),I(!1),lt((((Z=xe.prospective)==null?void 0:Z.companies_to_evaluate)||[]).map(Te=>(Te==null?void 0:Te.name)||"")),ce({state:"pending"});const Oe=await xs(xe,{email:o,cbToken:j});ce(Oe.ok?{state:"ok",scopeLabel:((fe=Oe.summary)==null?void 0:fe.scope_label)||"",scope:((ze=Oe.summary)==null?void 0:ze.scope)||""}:{state:"fail",msg:Oe.error||""}),Oe.ok&&ke(Te=>Te+1)}finally{je.current=!1,ne(!1)}},qt=[W==null?void 0:W.industry,...(W==null?void 0:W.market_tags)||[],W==null?void 0:W.author].map(_=>(_||"").trim()).filter(Boolean),bt=(de==null?void 0:de.state)==="pending",It=de&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):de.state==="ok"?t.jsx("span",{className:"rslink ok",children:de.scope&&de.scope!=="public"?e.rsSavedIn(de.scopeLabel||de.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:de.msg,children:e.rsSaveFail})),Pt=up(W).length,Be=P,Xe=(T||y).trim(),Ye=u.find(_=>Ue(_.name)===Ue(Xe)),ct=pt(y)||L||pt((Ye==null?void 0:Ye.website)||"")||pt((Ye==null?void 0:Ye.domain)||""),F=H||pt((Ye==null?void 0:Ye.url)||""),G=xt?e.actAnalyse:Xe?e.evalGoOn(Xe.length>22?Xe.slice(0,21)+"…":Xe):e.evalGo,X=Fe?`${hs(le.trim())==="youtube"&&le.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Ne)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Be?" rs-mode":"")+(T&&y.trim()===T||E||be?" pair":"")+(E||be||$?" echo":"")+($?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((Be?be:E)||$?" flash":"")+((Be?le.trim():Ca.test(y.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Be?le:y,placeholder:Be?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Be?600:200,spellCheck:Be?!1:void 0,inputMode:Be?"url":void 0,onChange:_=>{if(Be){ge(_.target.value);return}N(_.target.value),T&&_.target.value.trim()!==T&&(C(""),D(""),R(""),h(!1))},onKeyDown:_=>{_.key==="Enter"&&(Be?at():At())}}),t.jsx("span",{className:"detect"+(Be?" off":"")+(Ca.test(y.trim())?" url":""),children:ht})]}),t.jsx("span",{className:"dacts",children:Be?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Fe?" loading":""),disabled:Fe||bt||!le.trim()&&!ue.trim(),onClick:()=>{at()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:X})]}),t.jsxs("a",{className:"viewbtn"+(na(le)?"":" off"),href:na(le)?le.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:_=>{na(le)||_.preventDefault()},children:[t.jsx(gp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(xt?" analyse":"")+(s?" loading":""),disabled:s,onClick:At,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:G})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(O?" searching":ct?"":" off"),href:ct||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":O||void 0,title:O?e.viewSiteBusyHint:e.viewSiteHint,onClick:_=>{ct||_.preventDefault()},children:[O&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),O?e.viewSiteBusy:e.viewSite,!O&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(F?"":" off"),href:F||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:_=>{F||_.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),p.showCredits&&_e&&t.jsxs("button",{type:"button",className:"credits"+(_e.total_available<=0&&!_e.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:_e.unlimited?"∞":_e.total_available}),!_e.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",_e.daily_grant+_e.purchased]}),_e.total_available<=0&&!_e.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{l({type:"ptab",tab:0}),M(!1),requestAnimationFrame(()=>{const _=document.querySelector(".atl2.cibles .desk-list");if(!_)return;const ae=window.scrollY+_.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,ae),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(P?" on":""),onClick:()=>I(!P),children:e.rsOpen}),me!==null&&me>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>oe(!re),children:e.rsArchOpen(me)}),p.pipe&&!!n&&t.jsx(cp,{pageToken:j,onAddNames:lt})]}),re&&t.jsx(hp,{bump:Ce,cbToken:j,onClose:()=>oe(!1),onEvaluate:_=>i(null,_),onAddAll:lt}),t.jsx("div",{className:"rsp slim"+(P?" on":" off"),"aria-hidden":!P,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:P?void 0:-1,onClick:()=>te(_=>!_),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:U?"▴":"▾"})]}),U&&t.jsx("textarea",{className:"rstext",value:ue,placeholder:e.rsTextPh,tabIndex:P?void 0:-1,onChange:_=>ye(_.target.value)})]})}),ie&&t.jsx("div",{className:"rserr",children:ie}),W&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:W.title}),W.source_url&&t.jsx("a",{href:W.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ee(null),ce(null)},children:"×"})]}),W.market&&t.jsx("p",{className:"rsmk",children:W.market}),qt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),qt.map(_=>t.jsx("span",{children:_},_))]}),t.jsxs("div",{className:"rsbody",children:[W.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${W.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ci(W.summary_md||"").map((_,ae)=>t.jsx("p",{children:_},ae))})]}),t.jsx(ui,{card:W,onEvaluate:_=>i(null,_),onAddAll:lt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Pt)}),It]})]}),gt.slice(0,1).map((_,ae)=>{const Z=_.verdict==="kept",fe=_.verdict==="quota",ze=_.verdict==="unresolved",xe=Z?"var(--brand)":fe?"var(--bolt)":ze?"var(--blue)":"var(--red)",Oe=Z?"var(--brand-l)":fe?"#FFF3D6":ze?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":xe,"--bgc":Oe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:Z?"✓ "+e.kept:fe?"⏳":ze?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),_.name&&t.jsx("span",{className:"rn",children:_.name}),t.jsx("span",{className:"rr",children:_.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",_.reason]}):null}),!!(_.candidates&&_.candidates.length)&&t.jsx("span",{className:"sitepick",children:_.candidates.map(Te=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Te.url.startsWith("http")?Te.url:`https://${Te.url}`,target:"_blank",rel:"nofollow noopener",children:[(Te.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Te.url,_.name),children:e.evalPickGo})]},Te.url))}),!fe&&!ze&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:Z?1:5});const Te=(_.name||"").trim().toLowerCase();window.setTimeout(()=>{const nt=[...document.querySelectorAll(".atl2 .list .row")].find(vt=>{var Ze;return(((Ze=vt.querySelector(".rnm"))==null?void 0:Ze.textContent)||"").trim().toLowerCase().includes(Te)});nt&&(nt.scrollIntoView({behavior:"smooth",block:"center"}),nt.classList.add("flashrow"),window.setTimeout(()=>nt.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(Z?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),v&&(d.kept+d.dropped>0||gt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function bp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function vp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=K(),i=e.memoConsole?r.get(e.memoConsole):null,d=c.useMemo(()=>i?[i.reasoning||"",bp(i.summary||"")].filter(Boolean).join(`
...
`;function Up(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:d,top:l}}function Hp(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:l,doAnalyse:s,doDecide:g,doPromote:p,doRepeche:x,doApproach:m,doDeep:b,doOnboard:u,outbound:w,evalBusy:k}=K(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const v=$e(f),j=Le(f),y=zt(f),N=ua(f),E=f.kind==="target",S=T=>{a({type:"filters",patch:T}),a({type:"popup",id:null})};return Wt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:$p}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Up(e.popupAnchor,!!f.card),onClick:T=>T.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(Et(f.date)),tt(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[f.cc]}),children:(Gt(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>S({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>S({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Yt(f.amountEur,o)})]}),i.pipe&&E&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ft(f.engine)," ",t.jsx("b",{children:tt(f.engine,o)})," — ",vs(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),v?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ct,{o:f,lg:!0})," ",t.jsx(Va,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Co(v,o))," · ",n.win7(zo(v,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(ma,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&E&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&E&&t.jsx(Un,{o:f})]}),t.jsx($n,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{s(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),$t(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),w&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{u(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var T;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(T=document.querySelector(".atl2 .demand"))==null||T.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:k,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Vp(){const{lang:e,token:a,dossiers:r,caps:n}=K(),o=a||"home",{names:i,verdicts:d}=c.useMemo(()=>{const s=[],g={};return r.forEach(p=>{p.kind!=="target"||!p.name||(s.push(p.name),g[p.name]=ys(p)||"")}),{names:s,verdicts:g}},[r]);return{diff:c.useMemo(()=>i.length?ws(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function Wp(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:l}=K(),[s,g]=c.useState(!1),[p,x]=c.useState(!1),m=c.useRef(null);c.useEffect(()=>{if(!s)return;const j=y=>{m.current&&!m.current.contains(y.target)&&g(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[s]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],u=i.loading&&!d.length,w=c.useRef({});c.useEffect(()=>{w.current={...r}},[r]);const k=j=>{const y=w.current[j],N=y!==void 0?r[j]-y:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${ra[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j],j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[j],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},j)},f=(j,y,N)=>t.jsxs("button",{type:"button",className:"off"+(y?" view":""),"data-off":j,style:{"--c":`var(${ra[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:N}),t.jsx("span",{className:"n",children:r[j]})]},j),v=(j,y,N,E=!1)=>t.jsx("button",{type:"button",className:"tool",title:y,disabled:E,onClick:N,children:j},y);return t.jsxs("div",{className:"funnel"+(u?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(k)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[v("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(p?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"}),a({type:"ptab",tab:1}),a({type:"continent",key:l.pipe?"europe":"monde"}),a({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:m,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":s,title:n.toolSort,onClick:()=>g(j=>!j),children:"⇅"}),s&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([j,y])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[y,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),v("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),v("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Gp(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,doAnalyse:l,mode:s,data:g}=K(),p=c.useRef(null),[x,m]=c.useState(60);c.useEffect(()=>{let y=0;const N=()=>{var L;const E=p.current;if(!E)return;const S=(L=E.parentElement)==null?void 0:L.querySelector('.funnel [aria-selected="true"]');if(!S)return;const T=S.getBoundingClientRect(),C=E.getBoundingClientRect();m(Math.max(20,Math.min(T.left+T.width/2-C.left,C.width-30)))};return y=requestAnimationFrame(N),window.addEventListener("resize",N),()=>{cancelAnimationFrame(y),window.removeEventListener("resize",N)}},[e.ptab]);const b=e.ptab;let u=r.tuto[b].p;if(b===3){const y=i.filter(S=>S.kind==="target"&&Le(S)===3),N=y.filter(S=>mn(S)==="auto").length,E=y.filter(S=>mn(S)==="cd").length;u=r.tutoPending(N,E,y.length)}const w=(()=>{var y;if(s!=="client")return null;if(b===0&&i.length)return{label:r.tuto[0].a,locked:!1,run:()=>a({type:"chainStart",queue:i.map(N=>N.id)})};if(b===1){const N=i.filter(E=>E.kind==="target"&&Le(E)===1&&!d.has(E.id)).slice(0,10);if(N.length){const E=String(((y=g.credits)==null?void 0:y.plan)||"").toLowerCase(),S=E==="enterprise"||E==="entreprise";return{label:r.tuto[1].a,locked:!S,run:()=>{S&&a({type:"chainStart",queue:N.map(T=>T.id)})}}}}return null})(),k=ks(b),f=b===1||b===2,v=r.plabels[b]+" · "+(o[b]??0),j=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:p,className:"tuto mini"+(k?"":" on-dark")+(f?" etape-on":""),style:{"--bg":`var(${ra[b]})`,"--ax":x+"px","--stc":k?"var(--ink)":"#fff","--stt":k?"#fff":"var(--ink)","--tc":k?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:v}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:u}})]})}),w&&t.jsx("button",{type:"button",className:"tprim"+(w.locked?" lock":""),disabled:!!w.locked,title:w.locked?r.analyseLockHint:void 0,onClick:w.run,children:w.locked?"🔒 "+r.analyseLock:w.label}),b!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:j})]})}const pn=600,St=62,co="atl2:fstats";function Yp(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=K(),[d,l]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(co)==="on"}catch{return!1}}),s=r.stats,g=c.useMemo(()=>((s==null?void 0:s.by_day)||[]).slice(-30),[s]),p=(s==null?void 0:s.since)||"";if(!n.showFunnel||!s||typeof s.screened!="number")return null;const x=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,m=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((N,E)=>Math.max(N,E.s||0),0),u=g.length?pn/g.length:0,w=Math.max(4,u-4),k=g.length>=5&&b>0,f=r.marketEstimate||0,v=x(new Date().toISOString().slice(0,10)),j=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof s.kept=="number"?[[s.kept,e.funKept]]:[],...typeof s.analyzed=="number"?[[s.analyzed,e.funAnalyzed]]:[],...typeof s.shown=="number"?[[s.shown,e.funShown]]:[]],y=[];return typeof s.screened_window=="number"&&p&&y.push({cle:"fenetre",periode:e.funPerWindow(x(p),v),etapes:[[s.screened_window,e.funScreened("","")]]}),typeof s.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:j(s.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[y.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([E,S],T)=>t.jsxs("span",{className:"fst-t",children:[T>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:m(E)}),t.jsx("i",{children:S})]},N.cle+S)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(m(f),Math.min(100,Math.round((s.screened||0)/f*100)))})]}),N.cle==="total"&&(s.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),N.cle===y[y.length-1].cle&&k&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const E=!d;l(E),E&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(co,E?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},N.cle)),d&&k&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${pn} ${St}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((N,E)=>{const S=(N.s||0)/b*(St-4),T=(N.m||0)/b*(St-4),C=E*u+(u-w)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===N.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===N.d?{day:"",win:"all"}:{day:N.d,win:"all"}}),onKeyDown:L=>{L.key!=="Enter"&&L.key!==" "||(L.preventDefault(),i({type:"filters",patch:o.filters.day===N.d?{day:"",win:"all"}:{day:N.d,win:"all"}}))},children:[t.jsx("title",{children:`${x(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:C-1,y:0,width:w+2,height:St,fill:"transparent"}),t.jsx("rect",{x:C,y:St-2-S,width:w,height:S,fill:"#cfe0d6"}),t.jsx("rect",{x:C,y:St-2-T,width:w,height:T,fill:"#0E7F3F"})]},N.d)}),t.jsx("line",{x1:0,y1:St-1.5,x2:pn,y2:St-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const gi={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Hn({o:e,locked:a=!1}){const{t:r}=K(),n=ua(e),o=zt(e),i=Le(e),d=mn(e),l=js(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(gi[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(ed,{o:e})]})}const Vt=e=>e.length>22?e.slice(0,21)+"…":e;function ca(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function xi(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .fzone:has(.stage.folded), .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .fzone:has(.stage.folded), .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Qp({on:e,rev:a}){const[r,n]=c.useState(null),[o,i]=c.useState({top:0,left:0,width:0});return c.useEffect(()=>{if(!e){n(null);return}const d=()=>{var u,w,k;const l=document.querySelector(".atl2.ops .desk-list"),s=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const g=l.getBoundingClientRect(),p=s?s.getBoundingClientRect().bottom:g.top;i({top:Math.round(p),left:Math.round(g.left),width:Math.round(g.width)});const x=[...l.querySelectorAll(":scope .grp")];let m=null;for(const f of x){const v=f.querySelector(".grp-h");v&&v.getBoundingClientRect().bottom<=p+2&&(m=f)}if(!m){n(null);return}const b=m.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((u=b.querySelector(".ic"))==null?void 0:u.textContent)||"").trim(),t:(((w=b.querySelector(".t"))==null?void 0:w.textContent)||"").trim(),s:(((k=b.querySelector(".s"))==null?void 0:k.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Kp(e){const r=()=>{const n=xi(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function uo({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=K(),[i,d]=c.useState(!1);if(c.useEffect(()=>{n||d(!1)},[n]),Ge(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const s=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(s?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Vt(e.name))})]})}function Vn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:d,doPromote:l,doRepeche:s,doApproach:g,dispatch:p,liveMemos:x}=K(),m=u=>w=>{w.stopPropagation(),u()};if(r.lockActions){const u=m(()=>p({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:u,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const w=Le(e);return w===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:u,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Vt(e.name))})]})}):w===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:u,children:a.actAnalyse})}):w===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:u,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:u,children:a.actNo})]})}):w===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:u,children:a.actPromote})}):w===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:u,children:a.actApproach})}):w===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:u,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:u,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{u.stopPropagation(),ca(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Fa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{u.stopPropagation(),ca(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(uo,{o:e})});const b=Le(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(uo,{o:e})});if(b===1){const u=x.liveOf(e.name);if(u&&(u.status==="boot"||u.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ta,{item:u,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const w=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:w,onClick:m(()=>i(e)),children:w?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:m(()=>d(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:m(()=>d(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:m(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const u=o.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:u,onClick:m(()=>g(e)),children:u?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:m(()=>p({type:"modal",modal:"plug"})),children:a.actConn}),t.jsx("button",{type:"button",className:"lk sm dsrow",title:a.dsBtn,onClick:m(()=>p({type:"dossierOpen",id:e.id})),children:a.dsBtn})]})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:m(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>s(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:m(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:m(()=>p({type:"focus",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Jp({o:e}){const{t:a,doThumb:r,thumbOf:n}=K(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Xp({o:e}){const{lang:a}=K();return $e(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ct,{o:e}),t.jsx(Va,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ft(e.engine||"")," ",tt(e.engine||"",a)]})})}function Zp({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:l}){const{dispatch:s,caps:g,markRow:p,markedId:x,favIds:m,toggleFav:b,t:u}=K(),w=Le(e),k=["#16233A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=f<=0?0:f<=7?1:f<=30?2:3,j=g.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][w]:k[v],y=m.has(e.id),N=E=>{if(a)return;if(d){d(e.id);return}if(g.pipe||e.kind==="op"){n();return}const S=E.currentTarget.getBoundingClientRect();s({type:"popup",id:e.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return t.jsxs(c.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+w:"")+(y?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>p(e.id),onMouseLeave:()=>p(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(ji,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${u.cdEngagement} ${Math.round(e.engagement*10)/10} · ${u.cdEngagementHint}`,children:"🔥"}),$e(e)&&t.jsx(Ct,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:y?1:.35,padding:0,marginRight:4},onClick:E=>{E.stopPropagation(),b(e)},children:y?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Je(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(E=>E&&E!==e.name)||""]}),g.pipe&&!g.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:E=>E.stopPropagation(),children:[e.website&&t.jsx("a",{href:pa(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":u.rowSite,title:u.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:pa(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":u.rowLi,title:u.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":u.rowMail,title:u.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":u.rowTel,title:u.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:u.acqSee(e.acquirer),onClick:E=>{E.stopPropagation(),s({type:"acquirer",value:e.acquirer||""})},children:["← ",Vt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:u.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:u.zoomNewsMark,children:"📰"}):null]}),t.jsx(ec,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Xp,{o:e}),g.pipe&&t.jsx(Hn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Vn,{o:e}),g.showThumbs&&t.jsx(Jp,{o:e})]}),r&&!a&&!d&&t.jsx(nc,{o:e})]})}function ec({o:e}){const{lang:a,caps:r}=K();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Yt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function tc({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=K(),d=(m,b=!1)=>u=>{u.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})},l=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,40):""})(),s=Yt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),p=Ge(e),x=p&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),s&&t.jsx("span",{className:"oc-amt",children:s}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[p?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Je(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:m=>{m.stopPropagation(),ca(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:m=>{m.stopPropagation(),n(e)},children:a.evalGoOn(Vt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ma,{spec:e.card})})]})}function ac({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=K();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[tt(e.engine||"",r),i?` · ${i}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Vn,{o:e})})]}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx(Un,{o:e})]})}function bi({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:l,dossiers:s}=K(),g=c.useRef(null),p=We(e);if(c.useEffect(()=>{if(!p||!(e!=null&&e.decryptHtml))return;const h=g.current;if(!h)return;let q=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async M=>{await M.ensureEditoCss(),!(q||!h.isConnected)&&(M.beautifyEditoRows(h),M.mountCardFits(h))}),()=>{q=!0}},[p,e==null?void 0:e.decryptHtml]),!e&&!a){const h=s.find(We);if(h)return t.jsx(bi,{o:h})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),m=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),w=e?!!e.noCo:!x||La(x),k=(e==null?void 0:e.engine)||"",f=We(e),v=e?Yt(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),y=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(m);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),N=s.find(We),E=((N==null?void 0:N.url)||"").trim(),S=!!m&&!!E&&(m===E||m.endsWith(E)||E.endsWith(m)),T=(h,q=!1)=>M=>{M.stopPropagation(),q&&d({type:"continent",key:"monde"}),d({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const C=()=>{x&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:x}}))},L=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},D=()=>{ca({url:m,headline:b,tagline:e==null?void 0:e.tagline,name:x})},H=e?Ge(e):!1,R=H&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",O=f?r.doEdito.replace(/^📖\s*/,""):k?tt(k,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[O,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),m&&!f&&(w||Fa({engine:k}))&&t.jsxs("a",{className:"zoom-ext",href:m,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,y?t.jsx("em",{children:y}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:T({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:T({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:T({stage:[e.stage]}),children:e.stage}),v&&t.jsx("span",{className:"oc-amt",children:v})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(ma,{spec:u})}),(m&&!S&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[m&&!S&&!f&&t.jsxs("a",{className:"zoom-src",href:m,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,y?` · ${y}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),d({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[H?t.jsxs("span",{className:"verdict",style:{"--c":R?"var(--brand)":"var(--red)"},children:[R?"✓":"✗"," ",t.jsx("b",{children:R?r.kept:r.dropped})]}):!w&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:h=>{h.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Vt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,m&&!f&&(w||Fa({engine:k}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!w&&x?" ghost":""),onClick:h=>{h.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!w&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),L()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),C()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Vt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!w&&x&&l.pipe&&t.jsx($n,{name:x})]})]})}function nc({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=K();return!o.pipe&&e.kind==="op"?t.jsx(tc,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Un,{o:e}),t.jsx(td,{o:e}),t.jsx(nd,{o:e}),t.jsx($n,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Hn,{o:e})})]}),e.card&&t.jsx(ma,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ft(e.engine||"")," ",tt(e.engine||"",r)]}),$e(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ct,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function rc({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:l,lang:s}=K();if(!d.pipe&&e.kind==="op"){const x=Yt(e.amountEur,s),m=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),b=(u,w=!1)=>k=>{k.stopPropagation(),w&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ma,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Ft(e.engine||"")," ",tt(e.engine||"",s)]}),$e(e)&&t.jsx(Ct,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(m?` · ${m}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Vn,{o:e})})]})}const g=Le(e),p=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":p},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Hn,{o:e}),$e(e)&&t.jsx(Ct,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"focus",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function oc(){const{t:e}=K(),[a,r]=c.useState(0);return c.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function ic({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=K(),i=o==="en",d=p=>n.plabels[p]||"",l=[0,1,2,3,4,5,6,7].filter(p=>p!==a.ptab&&(e[p]||0)>0),s=l.includes(0)?0:l.sort((p,x)=>(e[x]||0)-(e[p]||0))[0];if(s===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[s]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:s===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${d(s)}”`:`${g} dossier${g>1?"s":""} dans « ${d(s)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:s}),children:[(i?"Open ":"Ouvrir ")+d(s)," →"]})]})}function sc(){var Pt,Be,Xe,Ye,ct;const e=K(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:l,markRow:s,lang:g,sessTally:p,data:x,dossiers:m,source:b,focusExtra:u,byId:w,token:k}=e,f=Mo(),v=c.useMemo(()=>{var X,_,ae,Z;if(!k||b==="ops")return null;const F=(((X=f==null?void 0:f.ed)==null?void 0:X.date)||(f==null?void 0:f.day)||"").slice(0,10),G=[(_=f==null?void 0:f.ed)==null?void 0:_.html,(ae=f==null?void 0:f.ed)==null?void 0:ae.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((Z=f==null?void 0:f.ed)==null?void 0:Z.date)||F,decryptHtml:G||void 0,date:F,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[k,b,g,(Pt=f==null?void 0:f.ed)==null?void 0:Pt.html,(Be=f==null?void 0:f.ed)==null?void 0:Be.acquirers_html,(Xe=f==null?void 0:f.ed)==null?void 0:Xe.date,f==null?void 0:f.day]),j=F=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Oo,[y,N]=c.useState(new Set);c.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[E,S]=c.useState(null);c.useEffect(()=>{S(null)},[a.ptab,a.continent]);const[T,C]=c.useState(!a.mapFolded);c.useEffect(()=>{if(a.mapFolded){C(!1);return}const F=document.getElementById("atl2-stage");if(!F){C(!1);return}const G=new IntersectionObserver(([X])=>C(!!X&&X.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return G.observe(F),()=>G.disconnect()},[a.mapFolded]);const L=!a.mapFolded&&!T,D=F=>N(G=>{const X=new Set(G);return X.has(F)?X.delete(F):X.add(F),X}),H=b==="ops"||o.pipe,[R,O]=c.useState("all"),[h,q]=c.useState(!1),[M,Q]=c.useState(null),[z,P]=c.useState(!1),I=c.useRef(!0);c.useEffect(()=>{if(I.current){I.current=!1;return}O("all"),P(!1)},[a.ptab,a.continent]),c.useEffect(()=>{if(!z)return;const F=G=>{var X,_;(_=(X=G.target)==null?void 0:X.closest)!=null&&_.call(X,".atl2 .doable")||P(!1)};return document.addEventListener("click",F,!0),()=>document.removeEventListener("click",F,!0)},[z]);const U=c.useMemo(()=>{var G;const F=new Map;for(const X of _l(((G=f==null?void 0:f.ed)==null?void 0:G.html)||""))F.has(X.t)||F.set(X.t,X.html);return F},[(Ye=f==null?void 0:f.ed)==null?void 0:Ye.html]),te=c.useCallback(F=>{if(F.decryptHtml)return F.decryptHtml;if(!U.size)return;const G=(F.name||"").trim().toLowerCase();if(G.length<3)return;const X=U.get(G);if(X)return X;for(const[_,ae]of U)if(_.includes(G)||G.includes(_))return ae},[U]),{diff:$}=Vp(),[pe,J]=c.useState(!1),le=a.filters.win==="1"&&!a.filters.day,[ge,ue]=c.useState(!1),ye=c.useMemo(()=>new Set((($==null?void 0:$.added)||[]).map(F=>F.trim().toLowerCase()).filter(Boolean)),[$]),be=c.useMemo(()=>{if(!ye.size)return 0;const F={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return m.filter(G=>!We(G)&&ye.has((G.name||"").trim().toLowerCase())&&oa(G,F,o.pipe)).length},[m,ye,a,o.pipe]);c.useEffect(()=>{const F=()=>{ue(!1),q(!1),O("all"),P(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",F),()=>window.removeEventListener("ppmap:tunnel",F)},[]),c.useEffect(()=>{ue(!1),q(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const Ee=c.useMemo(()=>{const F=l.filter(X=>!We(X)&&Je(X));let G="";for(const X of F){const _=(X.date||"").slice(0,10);_&&(!G||_<G)&&(G=_)}return{n:F.length,since:G?G.split("-").reverse().slice(0,2).join("/"):""}},[l]),Fe=Ee.n,ne=c.useMemo(()=>{const G=ge&&ye.size>0||a.filters.signalOnly||R!=="all"||h?l:d;let X=Dn(G,a.sort);return X=X.filter(_=>!We(_)),ge&&ye.size&&(X=X.filter(_=>ye.has((_.name||"").trim().toLowerCase()))),h||R==="explore"?X=X.filter(Je):R==="eval"?X=X.filter(_=>!Je(_)&&!_.noCo&&(_.kind==="op"||!Ge(_))):o.pipe&&(X=X.filter(_=>!Je(_))),X},[d,l,a.sort,R,ge,ye,h,o.pipe]),ve=c.useMemo(()=>o.pipe?m.filter(F=>F.kind==="target"&&!We(F)&&$e(F)&&(a.continent==="monde"||F.continent===a.continent)):ne.filter(F=>$e(F)&&!Ge(F)),[o.pipe,m,ne,a.continent]).length,ie=c.useMemo(()=>o.pipe?ne:ne.filter(F=>!Ge(F)&&!F.noCo&&!Je(F)),[ne,o.pipe]),B=b==="ops"?ne.filter(Je).length:0,W=ge?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,ee=a.filters,de=ee.sector.length+ee.market.length+ee.country.length+ee.engine.length+ee.stage.length+ee.crible.length+ee.angle.length+ee.memoLevel.length+ee.dealKind.length+(ee.signalOnly?1:0)+(ee.acquirer.trim()?1:0)+(ee.search.trim()?1:0),ce=[];if(ee.day)ce.push({k:"day",lib:n.fDay(ee.day.slice(8,10)+"/"+ee.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(ee.win&&ee.win!=="all"){const F=["1","7","30"].indexOf(ee.win);F>=0&&ce.push({k:"win",lib:n.dates[F],off:()=>r({type:"filters",patch:{win:"all"}})})}const re=F=>F.length<=2?F.join(", "):`${F.length} ${n.fSelected}`;for(const F of["sector","market","country","engine","crible"]){const G=ee[F];G&&G.length&&ce.push({k:F,lib:re(G),off:()=>r({type:"clearFacet",facet:F})})}ee.search&&ce.push({k:"search",lib:"🔍 "+ee.search,off:()=>r({type:"filters",patch:{search:""}})}),ge&&ye.size&&ce.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>ue(!1)}),ee.signalOnly&&ce.push({k:"sig",lib:"🔴 "+n.sigDock(ve||ee.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const oe=(F,G,X="",_=!1)=>t.jsxs("button",{type:"button","data-s":F,className:X,"aria-sort":a.sort.key===F?a.sort.dir===1?"ascending":"descending":"none",style:_?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:F}),children:[G,t.jsx("span",{className:"ar",children:a.sort.key===F&&a.sort.dir===1?"▴":"▾"})]},F),me=c.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const F=new Map;ne.forEach(_=>{const ae=_.engine||"?";F.has(ae)||F.set(ae,[]),F.get(ae).push(_)});const G={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},X=un([...F.keys()],g);return[...F.entries()].sort((_,ae)=>{const Z=G[_[0]]??10+X.indexOf(_[0]),fe=G[ae[0]]??10+X.indexOf(ae[0]);return Z-fe})},[ne,o.pipe,a.groupBy,g]),we=me?me.filter(([F])=>Na.has(F)).length:0,Ce=(()=>{var G;return((G=(me?me.flatMap(([,X])=>X):ne)[0])==null?void 0:G.id)??null})(),ke=c.useRef(!1),je=c.useMemo(()=>m.find(We)||v,[m,v]),[ht,gt]=c.useState(!1);c.useEffect(()=>{const F=()=>{ke.current=!0,ue(!1)};return window.addEventListener("ppmap:reveal",F),window.addEventListener("ppmap:focus",F),()=>{window.removeEventListener("ppmap:reveal",F),window.removeEventListener("ppmap:focus",F)}},[]),c.useEffect(()=>{const F=()=>{je&&r({type:"focus",id:je.id})};return window.addEventListener("ppmap:edito",F),()=>window.removeEventListener("ppmap:edito",F)},[je,r]),c.useEffect(()=>{if(!a.focusId)return;Q(a.focusId);const F=window.setTimeout(()=>Q(null),900);return()=>window.clearTimeout(F)},[a.focusId]),c.useEffect(()=>{if(H&&!(a.focusId&&(ne.some(F=>F.id===a.focusId)||m.some(F=>F.id===a.focusId)||a.focusId===(je==null?void 0:je.id)))&&!u){if(je){r({type:"focus",id:je.id});return}Ce&&r({type:"focus",id:Ce})}},[H,a.focusId,ne,Ce,u,r,m,b,je]),c.useEffect(()=>{if(!H||!a.focusId||je&&a.focusId===je.id||ne.some(G=>G.id===a.focusId))return;const F=m.find(G=>G.id===a.focusId);if(F){if(ke.current){F.kind==="op"?O(Je(F)?"explore":"eval"):R!=="all"&&O("all");return}R!=="all"&&Ce&&r({type:"focus",id:Ce})}},[H,a.focusId,R,ne,m,Ce,r,je]),c.useEffect(()=>{if(!H||!a.focusId||!ke.current)return;const F=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!F){const ae=ne.findIndex(Z=>Z.id===a.focusId);if(ae>=0){const Z=me?"":"pt"+a.ptab;if(Z){const fe=a.shown[Z]||j();ae>=fe&&r({type:"more",group:Z,by:ae-fe+8})}}return}ke.current=!1;const G=xi(),X=F.getBoundingClientRect();X.top>=G-2&&X.bottom<=window.innerHeight-4||Kp(F)},[H,a.focusId,a.ptab,ne,a.shown,me,r]),c.useEffect(()=>{if(typeof window>"u")return;const F=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),G=document.querySelector(".atl2.ops, .atl2.cibles");if(!F||!G)return;const X=document.querySelector(".atl2 .fzone"),_=()=>{G.style.setProperty("--listhead-h",`${F.offsetHeight}px`);const Z=!!(X&&X.querySelector(".stage.folded"));G.style.setProperty("--fold-h",Z&&X?`${X.offsetHeight}px`:"0px")};_();const ae=new ResizeObserver(_);return ae.observe(F),X&&ae.observe(X),()=>ae.disconnect()},[L,a.dens,a.mapFolded]);const _e=c.useMemo(()=>{if(!H||!a.focusId)return null;if(v&&a.focusId===v.id)return v;const F=ne.find(X=>X.id===a.focusId)||m.find(X=>X.id===a.focusId)||null;if(!F)return null;const G=te(F);return G&&G!==F.decryptHtml?{...F,decryptHtml:G}:F},[H,a.focusId,ne,m,te,v]),lt=o.lockRowsAfter;let xt=0;const At=(F,G)=>{let X=a.shown[G]||j();return F.length-X<=4&&(X=F.length),F.slice(0,X).map(Z=>{const fe=lt!==null&&xt>=lt;xt++;const ze=te(Z),xe=ze&&ze!==Z.decryptHtml?{...Z,decryptHtml:ze}:Z,Oe=!H&&a.dens!=="maxi"&&(a.dens==="deplie"||(E?E==="open":!!ze)),Te=y.has(Z.id)?!Oe:Oe,nt=H?vt=>{ke.current=!0,r({type:"focus",id:vt});const Ze=w.get(vt);Ze&&(Je(Ze)?ca(Ze):Ze.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ze.name,url:Ze.url||"",website:Ze.website||"",domain:Ze.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(rc,{o:xe,locked:fe,selected:H&&a.focusId===Z.id,onSelect:nt},Z.id):t.jsx(Zp,{o:xe,locked:fe,open:Te,onToggle:()=>D(Z.id),selected:H&&a.focusId===Z.id,echo:M===Z.id,fresh:ye.has((Z.name||"").trim().toLowerCase()),onSelect:nt},Z.id)})},at="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ne.length?"":" list-empty"),qt=t.jsxs(t.Fragment,{children:[me?me.map(([F,G])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ft(F)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:F==="ma"?n.grpMa:F==="fundraising"?n.grpLev:Na.has(F)&&we<=1?n.grpNews:F==="nominations"?n.grpNom:F==="media"?n.grpNewsOther:F==="recrutements"?n.grpHire:Na.has(F)?n.grpNews+" · "+tt(F,g):tt(F,g)}),t.jsx("div",{className:"s",children:n.grpCount(G.filter(X=>!Ge(X)).length,G.length)})]})]}),At(G,F)]},F)):At(ne,"pt"+a.ptab),x.loading&&!m.length&&t.jsx(oc,{}),o.pipe&&a.ptab===0&&!h&&!ge&&R==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(lp,{}),!ne.length&&!(x.loading&&!m.length)&&(o.pipe&&R==="all"?t.jsx(ic,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(ee.win!=="all"||!!ee.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),de>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(de)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),bt=t.jsxs(t.Fragment,{children:[!ge&&!h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ra[a.ptab]+")"},children:ne.length})," ",W]}),h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ra[a.ptab]+")"},children:ne.length})," ",n.newsWord]}),(!ge||h)&&t.jsx("span",{className:"dot",children:"·"}),L&&t.jsx(di,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[L?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ce.map(F=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:G=>{G.stopPropagation(),F.off()},children:[F.lib,t.jsx("i",{children:"×"})]},F.k)),b==="ops"&&ne.length>0&&!L&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ne.length-B," ",n.zoomPulseEval,B>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",B," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),It=t.jsxs("div",{className:"listhead"+(L?" mapoff":""),children:[L&&t.jsx("div",{className:"lh-tools",children:t.jsx(li,{compact:!0})}),o.showFunnel&&pe&&le&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(od,{}),t.jsx(Yp,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:bt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Wp,{}),t.jsx(Gp,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(le?" on":""),"aria-pressed":le,title:n.morningDockTitle,onClick:()=>{if(le){r({type:"filters",patch:{win:"all",day:""}}),J(!1);return}ue(!1),q(!1),O("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),J(!0)},children:["📊 ",n.morningDock(typeof((ct=x.stats)==null?void 0:ct.screened_today)=="number"?x.stats.screened_today:0)]}),$&&!$.firstVisit&&($.added.length>0||$.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(ge?" on":""),"aria-pressed":ge,title:n.sinceSub,onClick:()=>{const F=!ge;ue(F),q(!1),J(!1),O("all"),F&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(be),$!=null&&$.lastDate?` · ${n.sinceSince($.lastDate)}`:""]}),ve>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{ue(!1),q(!1),J(!1),O("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(ve)]}),o.pipe&&Fe>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(h?" on":""),"aria-pressed":h,title:n.newsDockHint,onClick:()=>{const F=!h;q(F),ue(!1),J(!1),O("all"),F&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(Fe),Ee.since?` · ${n.newsSince(Ee.since)}`:""]})]}),!o.showFunnel&&bt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([F,G])=>t.jsxs("button",{type:"button","data-d":F,"aria-pressed":a.dens===F||F==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:F}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:G})]},F))}),!H&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":E==="open",onClick:()=>{S("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":E==="closed",onClick:()=>{S("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var ze;const F={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},G=m.filter(xe=>oa(xe,F,o.pipe)&&!We(xe)),X=G.filter(xe=>!Je(xe)&&!xe.noCo&&(xe.kind==="op"||!Ge(xe))).length,_=G.filter(Je).length,ae=o.pipe?G.filter(xe=>xe.kind!=="op"&&Le(xe)===1).length:0,Z=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ae?` ${ae}`:""}`]]:[],["eval",`${n.doEval}${X?` ${X}`:""}`],["explore",`${n.doExplore}${_?` ${_}`:""}`]],fe=((ze=Z.find(([xe])=>xe===R))==null?void 0:ze[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":z,onClick:()=>P(xe=>!xe),children:[fe,t.jsx("i",{children:"▾"})]}),z&&t.jsx("div",{className:"dolist",children:Z.map(([xe,Oe])=>t.jsx("button",{type:"button","aria-pressed":R===xe,onClick:()=>{if(P(!1),xe==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}O(xe),xe!=="all"&&(ue(!1),q(!1),J(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:Oe},xe))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:F=>r({type:"sort",key:F.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([F,G])=>t.jsx("option",{value:F,children:G},F))})]}),o.showChain&&ie.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ie.map(F=>F.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ie.length):n.chainAll(ie.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!H&&It,a.dens!=="maxi"&&!H&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),oe("country",n.colCountry),oe("name",n.colCompany),oe("amount",n.colAmount,"h-amt",!0),oe("stage",n.colStage,"h-stade"),oe("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[oe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),oe("memo",n.colMemo)]}),o.pipe&&oe("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),H?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[It,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),oe("country",n.colCountry),oe("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[oe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),oe("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:at,children:qt})]}),t.jsxs("aside",{className:"readpane"+((_e?We(_e):!u&&je)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[je&&(()=>{const F=a.focusId===je.id&&!ht,G=(je.headline||je.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":F,onClick:()=>{if(F){gt(!0);return}gt(!1),r({type:"focus",id:je.id})},children:[t.jsx("span",{className:"eg-t",children:g==="en"?"Today’s editorial":"Édito du jour"}),G&&t.jsx("span",{className:"eg-sub",children:G}),t.jsx("span",{className:"eg-chev",children:F?g==="en"?"Collapse ▴":"Replier ▴":g==="en"?"Read ▾":"Lire ▾"})]})})(),v&&a.focusId===v.id&&ht?null:v&&a.focusId===v.id?t.jsx("div",{className:"zoom",children:t.jsx(Vl,{})}):_e&&o.pipe?t.jsx(ac,{o:_e}):t.jsx(bi,{o:_e,extra:_e?null:u})]})]}):t.jsx("div",{className:at,children:qt}),(()=>{const F=me||[["pt"+a.ptab,ne]];let G=0,X=0;for(const[ae,Z]of F){X+=Z.length;let fe=a.shown[ae]||j();Z.length-fe<=4&&(fe=Z.length),G+=Math.min(Z.length,fe)}const _=X-G;return _<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>F.forEach(([ae,Z])=>r({type:"more",group:ae,by:Z.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(_,_)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(G,X)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}}),H&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Qp,{on:!!me,rev:(me||[]).map(([F,G])=>F+G.length).join("|")})]})}function mo(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function lc(e,a){const r=Es(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function dc(e,a){const n=[a.head.split("|").map(mo).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",lc(o,a.plabels),ua(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(mo).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function pc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const cc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Qe({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function Jt({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function uc({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=K(),d=(e.cribleStatus||"").trim().toUpperCase()||(ua(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=zt(e),s=(a==null?void 0:a.blocs)||{},g=[[n.qaVP,s.value_prop],[n.qaProduct,s.produit],[n.qaModel,s.modele],[n.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Qe,{k:n.cdSector,v:e.sector}),t.jsx(Qe,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(Qe,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(Qe,{k:n.cdStage,v:e.stage}),t.jsx(Qe,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Qe,{k:n.cdSite,v:e.domain||e.website}),t.jsx(Qe,{k:n.cdName,v:e.contactName}),t.jsx(Qe,{k:n.cdEmail,v:e.contactEmail}),t.jsx(Qe,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Qe,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Qe,{k:n.cdAngle,v:e.angle}),t.jsx(Qe,{k:n.cdDetected,v:cc(e.date,o)})]}),!!(e.provQuery||e.provUrl||qa(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(Qe,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(Qe,{k:n.cdSrc,v:Tn(e.provUrl||""),href:pa(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(Qe,{k:n.cdAngleSrc,v:qa(e)})]})]}),g.some(([,p])=>p)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),g.filter(([,p])=>p).map(([p,x])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:p}),t.jsx("p",{children:x})]},p))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([p,x,m])=>t.jsxs("div",{className:"dssq "+p,children:[t.jsx("b",{children:x}),t.jsx("ul",{children:m.map(b=>t.jsx("li",{children:b},b))})]},p))})]}),t.jsx(Jt,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function mc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d,st:l}=K(),[s,g]=c.useState({}),[p,x]=c.useState({}),m=25,b=12,u=c.useMemo(()=>{if(l.dossierId){const f=n.find(v=>v.id===l.dossierId)||i.dossiers.find(v=>v.id===l.dossierId);return f?[f]:n.slice(0,m)}return n.slice(0,m)},[n,l.dossierId,i.dossiers]);c.useEffect(()=>{u.length&&So(r,u.map(f=>f.name)).then(g)},[r,u]),c.useEffect(()=>{const f=u.filter(y=>!!y.memoUrl).slice(0,b);if(!f.length){x({});return}let v=!1;const j={};return(async()=>{for(const y of f){if(v)return;try{const N=await hi(y.memoUrl||"");if(v)return;N&&Lp(N.comite)&&(j[y.id]=N.comite,x({...j}))}catch{}}})(),()=>{v=!0}},[u]);const w=i.stats,k=f=>f.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(u.length)}),!l.dossierId&&n.length>m&&t.jsx("span",{className:"mnote dim",children:e.dsCap(m,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),w&&typeof w.screened=="number"&&t.jsxs("p",{children:[k(w.screened)," ",e.funScreened(""),typeof w.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",k(w.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(k(i.marketEstimate)),", ",Math.round(w.screened/i.marketEstimate*100)," %"]})]})]}),u.map(f=>t.jsx(uc,{o:f,qa:s[f.name],comite:p[f.id]},f.id)),!u.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const fc=50;function Wn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=K(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(""),[x,m]=c.useState(0),[b,u]=c.useState(""),[w,k]=c.useState(!1),[f,v]=c.useState(0),j=c.useRef(null),y=c.useRef(null),N=()=>{v(0),y.current&&window.clearInterval(y.current),y.current=window.setInterval(()=>v(C=>C+1),1e3)},E=()=>{y.current&&(window.clearInterval(y.current),y.current=null)};c.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),y.current&&window.clearInterval(y.current)},[]);const S=async C=>{s(!0),p(""),N();const L=await a();if(s(!1),E(),L.ok){d(L);return}if(L.busy){p(o.alertPreviewBusy);return}if(!C){p(o.alertPreviewFail);return}m(fc),E(),j.current=window.setInterval(()=>{m(D=>D>1?D-1:(j.current&&window.clearInterval(j.current),S(!1),0))},1e3)},T=async()=>{if(n||w||l)return;k(!0),u(""),N();const C=await r();k(!1),E(),u(C.ok?o.alertTestOk(C.sentTo||""):C.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||w||x>0,onClick:()=>{S(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||w||l,onClick:()=>{T()},children:w?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),w&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const jt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ke({title:e,icon:a,children:r,wide:n,kind:o,lead:i}){const{dispatch:d}=K(),l=o==="plug"?"min(720px,100%)":"min(760px,100%)";return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:s=>{s.target===s.currentTarget&&d({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard"+(o?" m-"+o:""),style:n?{width:l}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsxs("div",{className:"mh-txt",children:[t.jsx("h2",{children:e}),i&&t.jsx("p",{className:"mh-lead",children:i})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>d({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function hc(){const{st:e}=K();switch(e.modal){case"chain":return t.jsx(xc,{});case"space":return t.jsx(bc,{});case"alert":return t.jsx(vc,{});case"queue":return t.jsx(Ec,{});case"export":return t.jsx(Nc,{});case"plug":return t.jsx(zc,{});case"approach":return t.jsx(Ac,{});case"recharge":return t.jsx(Lc,{});case"cover":return t.jsx(Rc,{});case"dossier":return t.jsx(Fc,{});case"crit":return t.jsx(Ic,{});case"tuto":return t.jsx(Pc,{});case"rdv":return t.jsx(gc,{});case"memoalert":return t.jsx(Sc,{});default:return null}}function gc(){const{dispatch:e,fund:a,t:r}=K(),n=a||r.rdvCoFallback;return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:_o,children:Pn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Xs,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function xc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:l,caps:s,memoQueued:g,doAnalyse:p}=K(),x=i==="client",m=e.chain.queue.map(k=>r.get(k)).filter(k=>!!k),b=e.chain.idx,u=m[b],w=b>=m.length;return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:w?n.finished:`${b+1} / ${m.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(w?100:b/Math.max(1,m.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:w||!u?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(m.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:u.name}),t.jsx("div",{className:"sub",children:[Gt(u.cc,o)||u.countryLabel,u.sector,u.stage,n.daysAgo(Et(u.date))].filter(Boolean).map(k=>String(k)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:tt(u.engine,o)}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{children:Yt(u.amountEur,o)})]}),$e(u)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ct,{o:u,lg:!0})," ",t.jsx(Va,{o:u,src:!0})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&!(x&&Ge(u))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),x&&Ge(u)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Lt(u)==="retenu"?"var(--brand)":Lt(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Lt(u)==="retenu"?"✓ "+n.kept:Lt(u)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!w&&u&&s.pipe&&Le(u)===1&&!g.has(u.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{p(u),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!w&&u&&!(x&&Ge(u))&&(u.noCo&&u.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var k;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"modal",modal:null}),(k=document.querySelector(".atl2 .demand"))==null||k.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{d(u)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(w?{type:"modal",modal:null}:{type:"chainNext"}),children:w?n.closeBtn:n.skip})]})]})})}),document.body)}function bc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=K(),i=o==="client",d=c.useMemo(()=>i?r.filter(x=>Ge(x)):[],[r,i]),l=c.useMemo(()=>Dn(d.filter(x=>Lt(x)==="retenu"),{key:"signal",dir:-1}),[d]),s=c.useMemo(()=>d.filter(x=>Lt(x)==="ecarte"),[d]),g=e.spaceTab==="retenu"?l:s,p=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ke,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:s.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":p},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function vc(){const{mode:e}=K();return e==="client"||e==="apercu"?t.jsx(yc,{}):t.jsx(jc,{})}function yc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=K(),[i,d]=c.useState("d"),l=o!=="client";return t.jsxs(Ke,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(wc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(kc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(vi,{})]})}function wc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(0);c.useEffect(()=>{let T=!0;return s(!1),ur(a).then(C=>{T&&(C?d(C):s(!0))}),()=>{T=!1}},[a,g]);const x=c.useRef({}),[m,b]=c.useState({}),[u,w]=c.useState(!1),[k,f]=c.useState(!1),v=c.useRef(null);c.useEffect(()=>()=>{v.current&&window.clearTimeout(v.current)},[]);const j=T=>{const C=x.current;Object.keys(C).length&&(w(!0),ur(a,C).then(L=>{if(!L){w(!1),o(e.actErr);return}if(L.throttled&&T<3){v.current=window.setTimeout(()=>j(T+1),5400);return}if(x.current={},b({}),d(L),w(!1),L.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},y=T=>{r||(x.current={...x.current,...T},b(C=>({...C,...T})),v.current&&window.clearTimeout(v.current),v.current=window.setTimeout(()=>j(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(T=>T+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...m},E=T=>!N.sections||N.sections.includes(T),S=T=>{const C=N.sections||e.alertSec.map(([L])=>L);y({sections:E(T)?C.filter(L=>L!==T):[...C,T]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>y({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>y({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>y({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>y({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>y({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,u&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!u&&k&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([T,C])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:E(T),disabled:r,onChange:()=>S(T)}),t.jsxs("span",{children:[C,T==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},T))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Wn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ds(a),onTest:()=>Ms(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function kc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(0);c.useEffect(()=>{let u=!0;return s(!1),mr(a).then(w=>{u&&(w?d(w):s(!0))}),()=>{u=!1}},[a,g]);const x=u=>{r||mr(a,u).then(w=>{if(!w){o(e.actErr);return}d(w),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(u=>u+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:m,disabled:r,onChange:u=>x({dow:Number(u.target.value)}),children:e.alertDow.map((u,w)=>t.jsx("option",{value:w,children:u},u))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Wn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Ps(a),onTest:()=>Is(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function vi(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=K(),[d,l]=c.useState(i||""),[s,g]=c.useState(!1),[p,x]=c.useState(!1);c.useEffect(()=>{i&&l(i)},[i]);const m=e.filters,b=c.useMemo(()=>n.filter(f=>$e(f)).length,[n]),u=m.win==="1"?0:m.win==="7"?1:m.win==="30"?2:3,w=async()=>{if(!(!/.+@.+\..+/.test(d)||p)){x(!0);try{await fetch(`${Ha}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:m.sector,countries:m.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},k=[[a.amRows.continent,o],[a.amRows.since,a.amSince[u]],[a.amRows.signal,m.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,m.engine.length?m.engine.map(f=>tt(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,m.sector.length?m.sector.join(", "):a.amAllSectors],[a.amRows.countries,m.country.length?m.country.map(f=>Gt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,m.stage.length?m.stage.join(", "):a.amAllStages]];return s?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:k.map(([f,v])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:v}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function jc(){const{t:e}=K();return t.jsx(Ke,{title:e.alertTitle,icon:"🔔",children:t.jsx(vi,{})})}function Ec(){var D,H;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:l,dispatch:s,liveMemos:g}=K(),[p,x]=c.useState(()=>Ya(r)),[m,b]=c.useState(()=>!Ya(r)),[u,w]=c.useState([]),[k,f]=c.useState(0),v=n==="client",j=c.useMemo(()=>{const R=new Map;return o.forEach(O=>{const h=(O.name||"").trim().toLowerCase();h&&!R.has(h)&&R.set(h,O)}),R},[o]);c.useEffect(()=>{let R=!0;return(!Ya(r)||k>0)&&b(!0),(async()=>{const[O,h]=await Promise.all([Fn(r,k>0),yo(a)]);R&&(O&&x(O),b(!1),w(h))})(),()=>{R=!1}},[a,r,k]);const y=m&&!p,N=(p==null?void 0:p.per_day)??0,E=((D=p==null?void 0:p.analyzed_today)==null?void 0:D.length)??0,S=p==null?void 0:p.offre,T=(p==null?void 0:p.pool_meta)||[],C=c.useMemo(()=>{const R=new Map;for(const O of(p==null?void 0:p.scheduled)||[])for(const h of O.names||[])R.has(h)||R.set(h,{label:O.day_label,date:O.date});return R},[p==null?void 0:p.scheduled]),L=(p==null?void 0:p.in_progress)||[];return t.jsxs(Ke,{title:e.queueTitle,wide:!0,children:[S&&t.jsxs("div",{className:"qoffre"+(S.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:S.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:S.delai})]}),t.jsx("span",{className:"osp"}),S.rythme>0?t.jsx("span",{className:"or",children:e.qRate(S.rythme)}):S.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(S.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:y?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(E,E+(((H=p==null?void 0:p.pool_order)==null?void 0:H.length)??0))}})}),S&&t.jsxs("div",{className:"qeta",children:[S.file===0?e.qEtaDone:S.rythme<=0?e.qEtaPaused:e.qEta(S.file,S.rythme,S.jours_restants),S.en_retard&&t.jsxs("em",{children:[" ",e.qLate(S.delai,S.plafond)]})]}),!y&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(S==null?void 0:S.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(L.length>0||g.items.some(R=>R.status==="boot"||R.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(R=>R.status==="boot"||R.status==="running"||R.status==="error").map(R=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:R.name}),t.jsx("span",{className:"qd",children:R.memoType||""}),t.jsx(Ta,{item:R,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+R.name)),L.filter(R=>!g.liveOf(R.name)).map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.name}),t.jsxs("span",{className:"qd",children:[R.memo_type||"",R.age_min?` · ${Math.round(R.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:R.state||""})]},"ip-"+R.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.company}),t.jsxs("span",{className:"qd",children:[R.memo_type,typeof R.est_min=="number"?` · ~${R.est_min} min`:""]}),t.jsx("span",{className:"qt",children:R.status}),R.url&&t.jsx("a",{className:"qgo",href:R.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(R.memo_type)}),v&&R.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{pr(a,R.company,"retry").then(()=>f(O=>O+1))},children:e.queueRetry}),v&&R.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{pr(a,R.company,"delete").then(()=>f(O=>O+1))},children:e.queueDelete})]},R.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",y?e.qUpNextWait:e.qUpNext(T.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[y&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!y&&T.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),T.map((R,O)=>{const h=C.get(R.name),q=j.get((R.name||"").trim().toLowerCase()),M=g.liveOf(R.name),Q=!!(q&&d.has(q.id))||!!(M&&(M.status==="boot"||M.status==="running")),z=!!(q&&Le(q)===1&&!q.memoUrl)&&!M;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",O+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:R.name}),R.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof R.score=="number"&&t.jsx("span",{className:"qs2",children:R.score}),M&&(M.status==="boot"||M.status==="running")&&t.jsx(Ta,{item:M,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),z&&(l.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>s({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:Q,onClick:()=>{i(q),f(P=>P+1)},children:Q?e.actAnalyseQueued:e.actAnalyse})),R.excerpt&&t.jsx("span",{className:"qex",children:R.excerpt})]},R.name+":"+O)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([R,O])=>t.jsxs("li",{children:[t.jsx("b",{children:R})," — ",O]},R))})]})}function Nc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=K(),l=`${jt}/cibles/list.csv?token=${a}`,s=`${jt}/cibles/list.json?token=${a}`,g=`${jt}/cibles/export.xlsx?token=${a}&scope=full`,p=`=IMPORTDATA("${l}")`,x=k=>{var f;(f=navigator.clipboard)==null||f.writeText(k).then(()=>r(e.exportCopied))},m=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:p},{def:e.exportLive,value:s,href:s},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,u=()=>{pc(dc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:k=>(e.stg.find(([f])=>f===k)||["",""])[1]})),r(e.exportViewDone(n.length))},w=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ke,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:w,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:u,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:m.map(({def:k,value:f,href:v})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:k[0]}),t.jsxs("div",{children:[t.jsx("b",{children:k[1]}),t.jsx("p",{children:k[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),v&&t.jsx("a",{className:"exb",href:v,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},k[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Sc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=K(),i=o!=="client",[d,l]=c.useState(null),[s,g]=c.useState(!1),[p,x]=c.useState(0),[m,b]=c.useState(!1);c.useEffect(()=>{let f=!0;return g(!1),lr(a).then(v=>{f&&(v?l(v):g(!0))}),()=>{f=!1}},[a,p]);const u=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},w=f=>{if(i||!d)return;const v={enabled:f.enabled??!!d.enabled,email:f.email??(d.email||""),sections:f.sections??u()};b(!0),lr(a,v).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}l(j),r(e.memoAlertSaved)})};if(s)return t.jsx(Ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!d)return t.jsx(Ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const k=u();return t.jsxs(Ke,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||m,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(Cc,{value:d.email||"",readOnly:i||m,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>w({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!k[f],disabled:i||m,onChange:()=>w({sections:{...k,[f]:!k[f]}})}),t.jsx("span",{children:v})]},f))}),t.jsx(Wn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Ss(a,k),onTest:()=>Ns(a,k)})]})}function Cc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=c.useState(e);c.useEffect(()=>{d(e)},[e]);const l=i.trim()!==e.trim(),s=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>d(g.target.value),onKeyDown:g=>{g.key==="Enter"&&l&&s&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!s,onClick:()=>o(i.trim()),children:n})]})]})}function zc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=K(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(null),[x,m]=c.useState(!1),[b,u]=c.useState(""),[w,k]=c.useState(0),[f,v]=c.useState("webhook"),[j,y]=c.useState("webhook"),[N,E]=c.useState(""),S=c.useRef(!1);c.useEffect(()=>{let M=!0;return s(!1),dr(a).then(Q=>{M&&(Q?d({configured:Q.configured,url_hint:Q.url_hint}):s(!0))}),qs(a).then(Q=>{if(M){if(!Q){m(!0);return}m(!1),p(Q),S.current||(S.current=!0,Q.destination==="instantly"&&(v(z=>z==="webhook"?"instantly":z),y(z=>z==="webhook"?"instantly":z)),Q.campaign_id&&E(z=>z||Q.campaign_id||""))}}),()=>{M=!1}},[a,w]);const T=(M,Q)=>{o&&dr(a,M).then(z=>{if(!z||z.ok===!1){n(e.actErr);return}M.test&&z.sent===!1?n(e.plugTestThrottled):r(Q),k(P=>P+1)})},C='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',L=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),D=`curl -X POST ${jt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,H=`curl -X POST ${jt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`,R=[{k:"webhook",t:e.plugDestCrm,s:e.plugDestCrmS},{k:"instantly",t:e.plugDestInst,s:e.plugAideInst},{k:"script",t:e.plugDestScript,s:e.plugDestScriptS}],O=j==="instantly"?e.plugStep2Inst:j==="script"?e.plugStep2Script:e.plugStep2Wh,h=j==="instantly"?e.plugAideInst:j==="script"?e.plugAideScript:e.plugAideWh,q=M=>{y(M),M!=="script"&&v(M)};return t.jsxs(Ke,{title:e.plugTitle,icon:"🔌",wide:!0,kind:"plug",lead:e.plugLead,children:[g&&t.jsxs("div",{className:"plugetat"+(g.enabled?" on":""),children:[t.jsx("i",{}),t.jsx("b",{children:g.enabled?e.plugEtatOn:e.plugEtatOff})]}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>k(M=>M+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"1"}),t.jsx("h4",{children:e.plugStep1})]}),t.jsx("div",{className:"plugdests",children:R.map(M=>{const Q=j===M.k;return t.jsxs("button",{type:"button",className:"plugdest"+(Q?" on":""),onClick:()=>q(M.k),children:[t.jsx("span",{className:"pradio","aria-hidden":"true"}),t.jsx("b",{children:M.t}),t.jsx("em",{children:M.s})]},M.k)})}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"2"}),t.jsx("h4",{children:O})]}),j==="script"?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:D}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(D).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}):j==="instantly"?t.jsx("div",{className:"mfield pill",children:t.jsx("input",{type:"text",maxLength:80,placeholder:e.plugCampPh,value:N,disabled:!o,onChange:M=>E(M.target.value)})}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"mfield pill",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:M=>u(M.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>T({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>T({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>T({remove:!0},e.plugRemoved),children:e.plugRemove})]})]}),t.jsx("p",{className:"mnote dim",children:h}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"3"}),t.jsx("h4",{children:e.plugStep3})]}),t.jsx(qc,{auto:g,autoKo:x,destKind:f,camp:N,onRetry:()=>k(M=>M+1),onDone:M=>{p(M),m(!1)}}),t.jsx("p",{className:"mnote dim",children:e.plugHow3}),t.jsxs("details",{className:"plugex plugpay",children:[t.jsxs("summary",{children:[t.jsx("b",{children:e.plugExT}),t.jsx("span",{children:e.plugPayloadSub})]}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult}),t.jsx("p",{className:"mnote dim",children:e.plugVars})]}),t.jsx("div",{"data-tour":"plug-bulk",children:t.jsx(Tc,{destKind:f,setDestKind:M=>{v(M),y(M)},camp:N,setCamp:E,whHint:i!=null&&i.configured?i.url_hint||"webhook":null})}),j!=="script"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:D}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(D).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:C}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(C).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm","data-tour":"plug-crm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:H}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(H).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Ac(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:l}=K(),s=c.useMemo(()=>r.find(h=>h.id===n.approachId)||null,[r,n.approachId]),[g,p]=c.useState("email"),[x,m]=c.useState(0),[b,u]=c.useState({}),[w,k]=c.useState(!1),[f,v]=c.useState(""),[j,y]=c.useState({});if(c.useEffect(()=>{!s||b[g]||w||(k(!0),v(""),As(a,s.name,g).then(h=>{if(k(!1),!h||h.ok===!1){v((h==null?void 0:h.error)||e.apprFail);return}u(q=>({...q,[g]:h}))}))},[s,g,a]),!s)return null;const N=b[g],E=(N==null?void 0:N.sequence)||[],S=E[x],T=h=>`${g}|${x}|${h}`,C=h=>{const q=T(h);return q in j?j[q]:String(((S==null?void 0:S[h])??"")||"")},L=(h,q)=>y(M=>({...M,[T(h)]:q})),D=T("subject")in j||T("body")in j||T("message")in j,H=C(g==="email"?"body":"message"),R=C("subject"),O=g==="email"&&R?`${R}

${H}`:H;return t.jsxs(Ke,{title:e.apprT(s.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(h=>t.jsx("button",{type:"button",className:"apch"+(g===h?" on":""),"aria-pressed":g===h,onClick:()=>{p(h),m(0)},children:h==="email"?e.apprChEmail:e.apprChLi},h)),t.jsx("span",{className:"sp"}),E.map((h,q)=>t.jsxs("button",{type:"button",className:"apday"+(x===q?" on":""),"aria-pressed":x===q,onClick:()=>m(q),children:[h.day||`J${q}`,[`${g}|${q}|subject`,`${g}|${q}|body`,`${g}|${q}|message`].some(M=>M in j)&&t.jsx("i",{children:"✎"})]},h.day||q))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,N!=null&&N.sender?" · "+e.apprSender(N.sender):""]}),w&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!f&&!w&&t.jsxs("p",{className:"mnote warn",children:[f," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{u(h=>{const q={...h};return delete q[g],q}),v("")},children:e.retry})]}),!w&&!f&&!S&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),S&&t.jsxs(t.Fragment,{children:[g==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:R,onChange:h=>L("subject",h.target.value)})]}),g==="linkedin"&&x===0&&(N==null?void 0:N.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:H,onChange:h=>L(g==="email"?"body":"message",h.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var h;(h=navigator.clipboard)==null||h.writeText(O).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),g==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(s.contactEmail||"")}?subject=${encodeURIComponent(R)}&body=${encodeURIComponent(H)}`,children:e.apprMailto}),D&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function qc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:l,flash:s,flashErr:g,canWrite:p}=K(),[x,m]=c.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,u=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),w=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,k=()=>{if(x||!p||u)return;m(!0),(b?cr(l,!1):cr(l,!0,r,n.trim()||void 0)).then(v=>{if(m(!1),!v){g(d.actErr);return}o(v),s(v.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!p||!!u,title:u||void 0,onClick:k,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),u===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:u}),w&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function Tc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:l,canWrite:s}=K(),[g,p]=c.useState("valides"),[x,m]=c.useState(!1),[b,u]=c.useState(null),[w,k]=c.useState(null),[f,v]=c.useState(!1),[j,y]=c.useState(!1),[N,E]=c.useState(null),[S,T]=c.useState(null),C=`atl2:bulk:${d}:${g}:${e}`;c.useEffect(()=>{u(null),k(null),v(!1),E(null);try{const P=localStorage.getItem(C)||localStorage.getItem(`atl2:bulk:${d}:${g}`),I=JSON.parse(P||"null");T(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{T(null)}},[C,g,d]);const L=e==="instantly"&&!r.trim(),D=`${g}|${e}|${r.trim()}`,H=async()=>{if(L||!s)return;m(!0),v(!1),E(null);const P=await Rs(d,g,e,r.trim()||void 0);u(P),k(P.ok?D:null),m(!1)},R=c.useRef(!1);if(!s)return null;const O=async()=>{if(R.current||!s)return;R.current=!0,y(!0);const P=`${d}:${g}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let I;try{I=await Os(d,g,e,r.trim()||void 0,P)}finally{R.current=!1}if(y(!1),v(!1),E(I),I.ok&&(I.pushed||0)>0){const U={t:new Date().toISOString(),n:I.pushed||0};T(U);try{localStorage.setItem(C,JSON.stringify(U))}catch{}}};f&&w!==null&&w!==D&&v(!1);const h=o,q=b!=null&&b.ok&&b.ready||0,M=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":h||"",Q=!!(b!=null&&b.ok)&&w===D&&q>0&&!!M&&!S,z=S?new Date(S.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:g,onChange:P=>p(P.target.value),children:i.plugBulkTabs.map(([P,I])=>t.jsx("option",{value:P,children:I},P))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:P=>a(P.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:P=>n(P.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||L,onClick:()=>{H()},children:x?"…":i.plugBulkPreview})]}),L&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),S&&t.jsx("p",{className:"mnote",children:i.bulkLocked(z,S.n)}),!S&&!!(b!=null&&b.ok)&&!M&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!S&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),Q&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>v(!0),children:i.bulkArm}),Q&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(q,M)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:j,onClick:()=>{O()},children:j?i.bulkSending:i.bulkConfirm(M)}),t.jsx("button",{type:"button",className:"abtn",disabled:j,onClick:()=>v(!1),children:i.bulkCancel})]}),N&&(N.ok?N.replayed?t.jsx("p",{className:"mnote",children:N.pending?i.bulkPending:i.bulkReplayed}):(N.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(N.pushed||0,N.linkedinReady||0,N.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:N.error||i.actErr}))]})}function Lc(){const{t:e,data:a,lang:r}=K(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const l=window.location.href.split("?")[0];try{const g=await(await fetch(`${Ha}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ke,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(d.credits,d.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Fc(){const{t:e}=K();return t.jsx(Ke,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(mc,{})})}function Rc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:l}=K(),[s,g]=c.useState(null),[p,x]=c.useState(!1);c.useEffect(()=>{let C=!0;if(i)return Fn(i).then(L=>{C&&L&&typeof L.per_day=="number"&&g(L.per_day)}),()=>{C=!1}},[i]);const[m,b]=c.useState(null);c.useEffect(()=>{if(!o)return;let C=!0;return zs(o).then(L=>{C&&b(L)}),()=>{C=!1}},[o]);const u=r.stats,w=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(C=>C.kind==="target"&&Ge(C)).length,k=r.marketEstimate||0,f=k>0?Math.min(100,Math.round(w/k*100)):null,v=(u==null?void 0:u.window_days)||30,j=w>0?w/v:0,y=k>0?Math.max(0,k-w):0,E=k>0&&j>0&&w>=100?Math.round(y/j):null,S=C=>Math.round(C).toLocaleString(a==="en"?"en-US":"fr-FR"),T=C=>{p||!d||(x(!0),wo(o,C).then(L=>{if(x(!1),L===null){l(e.actErr);return}g(L),l(e.alertSaved)}))};return t.jsxs(Ke,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(S(w))}),k>0&&t.jsx("span",{children:e.covOf(S(k))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),E!==null&&t.jsx("p",{className:"mnote",children:e.covEta(E)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(S(j))}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&u.shown!==u.kept&&t.jsxs("span",{children:[t.jsx("b",{children:S(u.shown)})," ",e.funShown]})]}),(m==null?void 0:m.ok)&&(m.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),m.perimetre&&t.jsx("p",{className:"mnote",children:m.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(m.detail||[]).map((C,L)=>t.jsxs("tr",{className:C.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[C.code,C.geo?` · ${C.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof C.n=="number"?S(C.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:C.source}),C.elargi&&t.jsx("em",{children:e.covWide(String(C.demande||""))}),C.erreur&&t.jsx("em",{children:e.covMissing})]})]},L)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:S(m.total||k)})}),t.jsx("td",{className:"mks"})]})]})]}),(m.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((m.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(m.sources||[]).join(" · "),m.calcule_le?` — ${e.covComputedAt(m.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:s===C?"on":"",disabled:p,onClick:()=>T(C),children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function yi(e,a,r){const n=await fetch(`${jt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${jt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Oc(){const{t:e,token:a,canWrite:r}=K(),[n,o]=c.useState(null),[i,d]=c.useState(""),[l,s]=c.useState(""),[g,p]=c.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,m=c.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const u=JSON.parse(localStorage.getItem(x)||"null");return!!u&&Date.now()-(u.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(c.useEffect(()=>{if(!r)return;let u=!0;return Ls(a).then(w=>{u&&o(w)}),()=>{u=!1}},[a,r]),!r||g||m||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),yi(a,n.instruction||"","atelier2-avis").then(u=>{if(d(u.applied?"ok":"ko"),u.applied||s(u.encours?e.propSlow:u.reply),u.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:l||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{p(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Mc(){var N;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=K(),[i,d]=c.useState(!1),[l,s]=c.useState(null),[g,p]=c.useState(!1),[x,m]=c.useState([]),[b,u]=c.useState(null),[w,k]=c.useState([]);if(!r)return null;const f=()=>{d(!0),p(!1),m([]),k([]),Fs(a).then(E=>{if(d(!1),!E){p(!0),s(null);return}s(E)})},v=E=>{b||(u(E.title),yi(a,E.instruction,"atelier2-prop").then(S=>{u(null),S.applied?(k(T=>[...T,E.title]),n(e.propApplied)):S.encours?n(e.propSlow):o(S.reply||e.propApplyFail)}))},j=((l==null?void 0:l.proposals)||[]).filter(E=>!x.includes(E.title)&&!w.includes(E.title)),y=((N=l==null?void 0:l.counts)==null?void 0:N.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:f,children:i?e.propWait:e.propBtn}),!i&&g&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!g&&l&&!(l.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:l.reason==="not_enough_signals"?e.propFew(y):e.propNone}),j.map(E=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[E.section]||E.section}),t.jsx("p",{className:"propt",children:E.title}),E.why&&t.jsx("p",{className:"mnote dim",children:E.why}),E.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",E.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>v(E),children:b===E.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>m(S=>[...S,E.title]),children:e.propSkip})]})]},E.title))]})}function Dc(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=K(),[l,s]=c.useState(null),[g,p]=c.useState(!1),[x,m]=c.useState(!1),[b,u]=c.useState(""),[w,k]=c.useState(""),[f,v]=c.useState(!1),j=c.useRef(!1);if(c.useEffect(()=>{if(!a||!r)return;let E=!0;return Ts(a).then(S=>{E&&(p(!0),!(!S||j.current)&&(s(S),u(S.fit),k(S.note)))}),()=>{E=!1}},[a,r]),!r)return null;const y=()=>{if(!(!b||f)){if(l&&l.fit===b&&l.note===w.trim()){m(!1);return}v(!0),wt(a,"thesis_fit",b,w.trim(),"",d.email||"").then(E=>{if(v(!1),!E.ok){o(e.fitKo);return}s({fit:b,note:w.trim(),ts:new Date().toISOString()}),m(!1),n(e.fitSaved)})}},N=E=>E==="yes"?e.fitYes:E==="partial"?e.fitPartial:e.fitNo;if(l&&!x){const E=new Date(String(l.ts||"")),S=Number.isNaN(E.getTime())?"":E.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:N(l.fit)}),l.note?` — ${l.note}`:""]}),!!S&&t.jsx("p",{className:"mnote dim",children:S}),t.jsx("button",{type:"button",className:"lk",onClick:()=>m(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(E=>t.jsx("button",{type:"button","aria-pressed":b===E,className:"fitopt"+(b===E?" on":""),onClick:()=>{j.current=!0,u(E)},children:N(E)},E))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:w,onChange:E=>{j.current=!0,k(E.target.value)},onKeyDown:E=>{E.key==="Enter"&&y()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||f,onClick:y,children:f?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!g&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function Ic(){var f,v,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:l}=K(),s=n==="client",g=c.useMemo(()=>{const y=new Set;return a.forEach(N=>{N.angle&&y.add(N.angle)}),[...y]},[a]),[p,x]=c.useState(""),[m,b]=c.useState(""),[u,w]=c.useState(!1),k=async()=>{const y=p.trim();if(!(!y||u||!s)){w(!0),b("");try{const E=await(await fetch(`${jt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(E.reply&&b(String(E.reply)),E.job_id){b(e.critChatRunning);const S=async()=>{const T=await fetch(`${jt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:E.job_id})}).then(C=>C.json()).catch(()=>null);if(T&&T.done){b(String(T.reply||T.clarification||T.summary||"✓")),w(!1),T.applied&&o(e.alertSaved);return}setTimeout(()=>{S()},8e3)};setTimeout(()=>{S()},8e3),x("");return}x("")}finally{m.startsWith("⏳")||w(!1)}}};return t.jsxs(Ke,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((v=i==null?void 0:i.angles)!=null&&v.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(y=>{var N,E;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((N=y.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(S=>t.jsx("li",{children:S},S))})]}),!!((E=y.out)!=null&&E.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(S=>t.jsx("li",{children:S},S))})]})]})]},y.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsx(Dc,{}),t.jsx(Oc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:p,disabled:!s||u,onChange:y=>x(y.target.value),onKeyDown:y=>{y.key==="Enter"&&k()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},disabled:!s||u||!p.trim(),onClick:()=>void k(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),m&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:m})]}),t.jsx(Mc,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Cs,{fund:d,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(gi[y]||"v-cons"),children:y}),t.jsx("span",{children:N})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",N]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Pc(){const{t:e,dispatch:a,startTour:r}=K(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Ke,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const wi="atl2:mapfold",_c=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(wi);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Bc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},ki=c.createContext(null),K=()=>{const e=c.useContext(ki);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ct({o:e,lg:a}){const{lang:r}=K(),n=$e(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:fr(n,r),children:[n.emoji," ",fr(n,r)]}):null}function Va({o:e,src:a}){const{lang:r,t:n}=K(),o=$e(e);if(!o)return null;const i=Vs(o),d=Ws(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(Co(o,r))+" · "+n.win7(zo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,s)=>t.jsx("i",{className:s<i?"on":""},s))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function $c(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Ue(a);if(o)return e.find(i=>Ue(i.name)===o)||e.find(i=>{const d=Ue(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Uc(){const{scoped:e,t:a,st:r,dispatch:n}=K(),o=c.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(x=>!We(x)),l=d.length,s=d.filter(x=>!x.noCo).length,g=d.filter(x=>!!x.noCo).length,p=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:p?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",s," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function Hc(){var x;const{t:e,lang:a,data:r,dispatch:n,scopedAll:o,counts:i}=K(),d=m=>m.toLocaleString(a==="en"?"en-US":"fr-FR"),s=o.filter(m=>!We(m)).length,g=typeof((x=r.stats)==null?void 0:x.screened)=="number"?r.stats.screened:0;if(s<=0&&g<=0)return null;const p=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:d(s)}),t.jsx("span",{children:p>0?e.covOf(d(p)):e.covScreened("").trim()}),t.jsxs("ul",{children:[t.jsxs("li",{children:["✅ ",d(i[1]||0)," ",e.covKept]}),t.jsxs("li",{children:["⚡ ",d(i[2]||0)," ",e.covAna]})]})]})}function ji({o:e}){const{lang:a}=K(),r=Hs(e.cc),n=e.cc?Gt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:20,height:14,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Vc=!1;function Wc(){const[e,a]=c.useState(!1);return c.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Ei=e=>`atl2:tour:${e||"anon"}`;function Gc(e){try{return localStorage.getItem(Ei(e))==="1"}catch{return!0}}function fo(e){try{localStorage.setItem(Ei(e),"1")}catch{}}function Yc(e,a,r,n,o,i,d,l){const s=e.tourT,g=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:g[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:g[1][0]},{sel:".atl2 .dmulti.ddeals",title:s.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:s.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:s.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:s.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:s.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:s.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-bulk"]',need:".atl2 .ic[data-tour=plug]",title:s.campout,body:e.fhintCampout,modal:"plug"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-crm"]',need:".atl2 .ic[data-tour=plug]",title:s.addcrm,body:e.fhintAddcrm,modal:"plug"}:null,...[2,4,5].filter(p=>(l[p]||0)>0).map(p=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:p===2?s.tabAna:p===4?s.tabValid:s.tabRej,body:p===2?e.fhintTabAna:p===4?e.fhintTabValid:e.fhintTabRej,ptab:p})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:s.rank,body:e.fhintRank},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:s.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:g[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:g[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:s.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:s.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:s.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function Zc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Yn;const{lang:d}=_s(),l=Ol(e,d,a),s=c.useMemo(()=>({...kl[d],...wl(d,l.thesisMode)}),[d,l.thesisMode]),[g,p]=c.useReducer(Il,void 0,()=>Ml((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Bc():_c()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=c.useRef(!0);c.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(wi,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),c.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const A=()=>{window.innerWidth<=760&&p({type:"mapFold",folded:!0})};return A(),window.addEventListener("resize",A),()=>window.removeEventListener("resize",A)},[a]);const m=c.useRef(i);m.current=i,c.useEffect(()=>{var A;(A=m.current)==null||A.call(m,g.filters)},[g.filters]);const[b,u]=c.useState(()=>{if(typeof window>"u")return"both";try{const A=localStorage.getItem("atl2:chrome-mode");if(A==="eval"||A==="filt"||A==="both")return A;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[w,k]=c.useState(null),[f,v]=c.useState(null),[j,y]=c.useState(null),[N,E]=c.useState({kept:0,dropped:0}),[S,T]=c.useState(!1),[C,L]=c.useState(""),[D,H]=c.useState(!1),[R,O]=c.useState(null),[h,q]=c.useState(null),[M,Q]=c.useState(!1),[z,P]=c.useState(!1),[,I]=c.useState(0),U=()=>I(A=>A+1),te=c.useRef([]),$=c.useRef(new Set),pe=c.useRef(new Set),[J,le]=c.useState([]),[ge,ue]=c.useState([]),[ye,be]=c.useState(0),Ee=c.useRef(new Map),Fe=c.useRef(null),{mode:ne}=l,Ne=c.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),ve=Ne.pipe,ie=l.session.token||"",B=ne==="client"&&!e;c.useEffect(()=>{if(!ie||!ve)return;let A=!0;const Y=async()=>{const he=await Gs(ie);!A||!he||(ue(he.runs),be(Date.now()/1e3-he.now),le(Me=>Me.filter(Ae=>!he.runs.some(He=>Ue(He.company)===Ue(Ae.name)))))};Y();const V=J.length>0||ge.some(he=>he.status==="running"),se=window.setInterval(()=>{Y()},V?8e3:25e3);return()=>{A=!1,window.clearInterval(se)}},[ie,ve,J.length,ge.some(A=>A.status==="running")]),c.useEffect(()=>{if(!ie||!ve||!B)return;let A=!0;const Y=async()=>{const se=await Ys(ie);if(!A||!se.length)return;const he=new Map;se.forEach(Me=>{const Ae=String(Me.ceo_status||"").trim();Ae&&Me.check_id&&he.set(String(Me.check_id),Ae)}),l.patchStatuses(he,Me=>Date.now()-(ze.current.get(Me)||0)>9e4)};Y();const V=window.setInterval(()=>{Y()},6e4);return()=>{A=!1,window.clearInterval(V)}},[ie,ve,B]);const W=c.useMemo(()=>{const A=[],Y=new Set;for(const V of J){const se=Ue(V.name);!se||Y.has(se)||(Y.add(se),A.push({name:V.name,id:V.id,status:"boot",started:V.started,estMin:V.estMin,memoType:"instant"}))}for(const V of ge){const se=Ue(V.company);if(!se||Y.has(se))continue;Y.add(se);const he=V.status==="error"?"error":V.status==="done"?"done":"running";A.push({name:V.company,status:he,started:V.started||0,estMin:V.est_min||(V.memo_type==="detailed"?40:15),url:V.url,error:V.error,memoType:V.memo_type,note:V.note})}return A},[J,ge]),ee=A=>W.find(Y=>Ue(Y.name)===Ue(A))||null,de=(A,Y)=>{le(V=>V.some(se=>Ue(se.name)===Ue(A.name))?V:[...V,{name:A.name,id:A.id,started:Date.now()/1e3,estMin:Y==="detailed"?40:15}]),$.current.add(A.id),U()},ce=(A,Y=!1)=>{L(A),H(Y),Fe.current&&clearTimeout(Fe.current),Fe.current=setTimeout(()=>L(""),Y?4200:2400)},re=A=>ce(A,!0),oe=c.useMemo(()=>{const A=new Map;return l.dossiers.forEach(Y=>{Y.id&&A.set(Y.id,Y)}),A},[l.dossiers]),me=c.useMemo(()=>l.dossiers.filter(A=>oa(A,g,ve)),[l.dossiers,g,ve]),we=c.useRef(!1);c.useEffect(()=>{if(we.current||l.loading||!l.dossiers.length)return;if(e&&!l.session.token){we.current=!0;return}if(!Ne.showFunnel||Gc(l.session.token||"")){we.current=!0;return}we.current=!0;const A=window.setTimeout(()=>{fo(l.session.token||""),Q(!0)},700);return()=>window.clearTimeout(A)},[e,l.loading,l.dossiers.length,Ne.showFunnel,l.session.token]);const Ce=c.useMemo(()=>l.dossiers.filter(A=>Pl(A,g,ve,l.favIds)),[l.dossiers,g,ve,l.favIds]),ke=c.useMemo(()=>Bs(me.filter(A=>!Je(A)),l.favIds),[me,l.favIds]),je=c.useRef(!1);c.useEffect(()=>{if(je.current)return;if(!ve||a==="ops"){je.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){je.current=!0;return}if(l.loading)return;je.current=!0;const A=$s(ke);A!==g.ptab&&p({type:"ptab",tab:A})},[ve,a,n==null?void 0:n.ptab,l.loading,ke,g.ptab]);const ht=c.useMemo(()=>{const A=$o(l.dossiers);return A?Et(A)===0?s.tourToday:Uo(A,d):s.tourNoRun},[l.dossiers,s,d]),gt=c.useMemo(()=>l.dossiers.some(A=>!!A.memoUrl||!!A.summary||$t(A)),[l.dossiers]),[_e,lt]=c.useState(!1);c.useEffect(()=>{if(l.loading){lt(!1);return}if(l.dossiers.length>0||l.error){lt(!0);return}const A=window.setTimeout(()=>lt(!0),6e3);return()=>window.clearTimeout(A)},[l.loading,l.dossiers.length,l.error]);const xt=(l.marketEstimate||0)>0||typeof((Yn=l.stats)==null?void 0:Yn.screened)=="number"&&l.stats.screened>0,At=c.useMemo(()=>[1,0,2,4,5,3].find(A=>(ke[A]||0)>0)??0,[ke]),at=Rn.find(A=>A.key===g.continent),qt=g.continent==="monde"?s.contWorld:(d==="fr"?at==null?void 0:at.fr:at==null?void 0:at.en)||"";c.useEffect(()=>{const A=Y=>{var se;const V=(((se=Y.detail)==null?void 0:se.name)||"").trim();V&&bt(null,V)};return window.addEventListener("ppmap:evaluate",A),()=>window.removeEventListener("ppmap:evaluate",A)}),c.useEffect(()=>{const A=Y=>{const V=Y.detail||{},se=String(V.id||"").trim(),he=String(V.name||"").trim(),Me=String(V.url||"").trim(),Ae=se&&oe.get(se)||$c(l.dossiers,he,Me);if(Ae){if(v(null),oa(Ae,g,ve)||(g.continent!=="monde"&&Ae.continent!==g.continent&&p({type:"continent",key:Ae.continent||"monde"}),p({type:"reset"})),ve&&Ae.kind!=="op"){const ut=Le(Ae);typeof ut=="number"&&ut!==g.ptab&&p({type:"ptab",tab:ut})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),p({type:"focus",id:Ae.id}),(Ae.noCo||["media","nominations","recrutements"].includes(Ae.engine||""))&&(Ae.url||Ae.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ae.url||"",text:[Ae.headline,Ae.tagline].filter(Boolean).join(`
`)}})):Ae.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ae.name,url:Ae.url||"",website:Ae.website||"",domain:Ae.domain||""}}));return}!he&&!Me||(p({type:"focus",id:se||null}),v({name:he,headline:String(V.text||"").trim()||he,url:Me,card:V.card}),Me&&(La(he)||!he)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Me,text:String(V.text||"").trim()}})):he&&!La(he)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:he}})))};return window.addEventListener("ppmap:focus",A),()=>window.removeEventListener("ppmap:focus",A)}),c.useEffect(()=>{const A=se=>{const he={},Me=String((se==null?void 0:se.sector)||"").trim();Me&&(he.sector=[Me]);const Ae=String((se==null?void 0:se.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ae)&&(he.day=Ae);const He=String((se==null?void 0:se.search)||"").trim();He&&(he.search=He);const ut=String((se==null?void 0:se.dealKind)||"").trim();(ut==="ma"||ut==="levee"||ut==="other")&&(he.dealKind=[ut]),Object.keys(he).length&&p({type:"filters",patch:he})},Y=se=>A(se.detail),V=se=>{se.data&&se.data.type==="pp-filter"&&A(se.data)};return window.addEventListener("ppmap:filter",Y),window.addEventListener("message",V),()=>{window.removeEventListener("ppmap:filter",Y),window.removeEventListener("message",V)}},[]),c.useEffect(()=>{const A=Y=>{var he;const V=(((he=Y.detail)==null?void 0:he.name)||"").trim().toLowerCase();if(!V)return;const se=l.dossiers.find(Me=>(Me.name||"").trim().toLowerCase()===V);se&&p(a==="ops"?{type:"focus",id:se.id}:{type:"popup",id:se.id})};return window.addEventListener("ppmap:similar",A),()=>window.removeEventListener("ppmap:similar",A)});const bt=(A,Y,V)=>{const se=(V||(A==null?void 0:A.name)||Y||"").trim();if(!B){y({kicker:se});return}!se||S||(T(!0),(async()=>{try{let he=(Y||se).trim();const Me=((A==null?void 0:A.website)||(A==null?void 0:A.domain)||"").trim();if(!(/^https?:\/\//i.test(he)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(he)&&!/\s/.test(he)))if(Me)he=Me;else try{const Pe=await On(se);if(Pe!=null&&Pe.website)he=Pe.website;else if(((Pe==null?void 0:Pe.candidates)||[]).length===1)he=Pe.candidates[0].url;else if(((Pe==null?void 0:Pe.candidates)||[]).length>1){te.current=[{name:se,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(Pe.candidates||[]).slice(0,5)},...te.current].slice(0,8),U();return}}catch{}const He=await jo(ie,he,"atelier2"),ut={name:He.company||se,verdict:He.verdict,reason:He.reason||"",remaining:He.remaining??null};te.current=[ut,...te.current].slice(0,8),He.verdict==="kept"&&E(Pe=>({...Pe,kept:Pe.kept+1})),He.verdict==="ruled_out"&&E(Pe=>({...Pe,dropped:Pe.dropped+1}));const Qt=A||l.dossiers.find(Pe=>(Pe.name||"").toLowerCase()===se.toLowerCase());Qt&&(He.verdict==="kept"?Qt.verdict=Qt.verdict||"MATCH":He.verdict==="ruled_out"&&(Qt.verdict="NO MATCH"),He.reason&&(Qt.reasoning=He.reason)),U()}finally{T(!1)}})())},It=A=>{if(!B){y({kicker:A.name});return}de(A,"instant"),wt(ie,"fast_request",A.name||"",""),ce(s.memoInstantSent(A.name))},Pt=A=>Ee.current.get(A.id)??l.thumbs.get((A.name||"").trim().toLowerCase()),Be=(A,Y)=>p({type:"undoPush",entry:{id:A.id,name:A.name,prevCeoStatus:Y}}),Xe=async(A,Y,V)=>{const se=A.ceoStatus||"";ze.current.set(A.id,Date.now()),A.ceoStatus=Y,U();const he=await Qa(ie,{status:Y,airtable_id:A.airtableId,check_id:A.checkId,company:A.name,...(V==null?void 0:V.note)!==void 0?{note:V.note}:{},...V!=null&&V.via?{via:V.via}:{}});return he.ok?he.skipped?(A.ceoStatus=se,U(),re(s.actNotPersisted),!1):((V==null?void 0:V.undo)!==!1&&Be(A,se),V!=null&&V.msg&&ce(V.msg),(Y==="Validé"||Y==="Écarté")&&!A.ceoNote&&(V==null?void 0:V.note)===void 0&&O({o:A,yes:Y==="Validé"}),!0):(A.ceoStatus=se,U(),re(s.actErr),!1)},Ye=async(A,Y)=>{const V=await Qa(ie,{status:A.ceoStatus||"Retenu",airtable_id:A.airtableId,check_id:A.checkId,company:A.name,note:Y,via:"note"});return!V.ok||V.skipped?(re(V.skipped?s.actNotPersisted:s.actErr),!1):(A.ceoNote=Y,U(),!0)},ct=c.useRef(new Map),F=A=>ct.current.has(A.id)?ct.current.get(A.id):l.stages.get((A.name||"").trim().toLowerCase()),G=(A,Y)=>{ct.current.set(A.id,Y),U()},X=(A,Y)=>{B&&Xe(A,Y?"Validé":"Écarté",{msg:Y?s.decidedYes(A.name):s.decidedNo(A.name)})},_=A=>{B&&Xe(A,"À trancher",{msg:s.promoted(A.name)})},ae=A=>{B&&(async()=>{const Y=A.ceoStatus||"";A.ceoStatus="Retenu",U();const V=await Qa(ie,{status:"Retenu",check_id:A.checkId,company:A.name});if(!V.ok||V.skipped){A.ceoStatus=Y,U(),re(V.skipped?s.actNotPersisted:s.actErr);return}Be(A,Y),ce(s.repeched(A.name))})()},Z=()=>{const A=g.undo[g.undo.length-1];if(!A){ce(s.undoNone);return}const Y=oe.get(A.id);if(!Y){p({type:"undoPop"}),ce(s.undoNone);return}let V=A.prevCeoStatus;if(!V)if((Y.verdict||"").toUpperCase().includes("CALL"))V="À trancher";else{ce(s.undoLockedTitle);return}(async()=>await Xe(Y,V,{undo:!1})&&(p({type:"undoPop"}),Y.ceoStatus=A.prevCeoStatus,U(),ce(s.undoDone(Y.name))))()},fe=A=>{B&&(pe.current.add(A.id),U(),p({type:"approachOpen",id:A.id}),wt(ie,"approach",A.name||"","","",l.email||""))},ze=c.useRef(new Map),xe=c.useRef(!1),[Oe,Te]=c.useState(0);c.useEffect(()=>{if(!ie||e||!B||xe.current)return;xe.current=!0;const A=new Date().toISOString().slice(0,10),Y=l.email||"",V=`cbv_${ie}_${Y}_${A}`,se=`atl2:vue:${ie}:${A}`;try{if(localStorage.getItem(V)||localStorage.getItem(se))return}catch{}wt(ie,"view","","","",Y).then(he=>{if(!he.ok){xe.current=!1;return}try{localStorage.setItem(V,"1")}catch{}})},[ie,e,B,l.email]),c.useEffect(()=>{if(!ie||!ve||e||!B||!l.generatedAt)return;let A=!0;const Y=()=>{document.hidden||Qs(ie,l.generatedAt||"").then(se=>{A&&Te(se)})};Y();const V=window.setInterval(Y,6e4);return()=>{A=!1,window.clearInterval(V)}},[ie,ve,e,l.generatedAt]);const nt=(A,Y)=>{B&&(async()=>{if(!(await wt(ie,Y?"yes":"no",A.name||"",(A.ceoNote||"").slice(0,400),A.sector||"",l.email||"")).ok){re(s.actErr);return}Ee.current.set(A.id,Y?"yes":"no"),U(),ce(Y?s.thumbUpDone:s.thumbDnDone),q({o:A,up:Y})})()},vt=A=>{!B||!$t(A)||(de(A,"detailed"),wt(ie,"detailed_request",A.name||"","","",l.email||""),ce(s.memoDeepSent(A.name)))},Ze=A=>{!B||!A.memoUrl||window.confirm(s.memoRegenAsk(A.name))&&(de(A,"detailed"),wt(ie,"detailed_regen",A.name||"","","",l.email||""),ce(s.memoDeepSent(A.name)))},Ni=A=>{const Y=new Set(l.favIds),V=Y.has(A.id);V?Y.delete(A.id):Y.add(A.id),l.setFavIds(Y),B&&Ks(ie,{id:A.id,co:A.name},V)},Si=()=>{!B||z||window.confirm(s.identSyncConfirm)&&(P(!0),(async()=>{const A=await Js(ie);P(!1),A?ce(s.identSyncDone):re(s.actErr)})())},Gn=/proplace/i.test(l.fund||""),Ci=A=>{!B||!Gn||(wt(ie,"onboard_request",A.name||"",""),ce(s.onboardSent(A.name)))},zi={st:g,dispatch:p,t:s,lang:d,mode:ne,caps:Ne,pipe:ve,token:ie,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:ae,thumbOf:Pt,canWrite:B,commitStatus:Xe,saveNote:Ye,stageOf:F,setStage:G,flashErr:re,startTour:()=>Q(!0),dossiers:l.dossiers,scopedAll:me,scoped:Ce,counts:ke,byId:oe,contName:qt,favIds:l.favIds,toggleFav:Ni,askEvaluate:bt,doAnalyse:It,doDecide:X,doPromote:_,doApproach:fe,doThumb:nt,doDeep:vt,doRegen:Ze,doUndo:Z,doSync:Si,doOnboard:Ci,outbound:Gn,memoQueued:$.current,liveMemos:{items:W,serverOff:ye,liveOf:ee},approachDone:pe.current,sessTally:N,evalCards:te.current,evalBusy:S,markRow:k,markedId:w,flash:ce,focusExtra:f};c.useEffect(()=>{const A=Y=>{Y.key==="Escape"&&(p({type:"popup",id:null}),p({type:"modal",modal:null}),p({type:"openFacet",facet:null}))};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[]);const Ai=A=>ie?t.jsx($l,{token:ie,children:A}):t.jsx(t.Fragment,{children:A});return t.jsx(ki.Provider,{value:zi,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ie?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Cl}),Ai(t.jsxs("div",{className:"app"+(ve?" pipe":"")+(ie?" has-thesis":""),children:[Ne.showTicker&&t.jsx(dt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ie?" live-stack--cibles":""),children:[t.jsx(Ql,{}),!!ie&&t.jsx(Ul,{})]})}),Ne.showIdent&&t.jsx(dt,{name:"identite",children:t.jsx(sd,{})}),!1,Vc,Ne.showFunnel&&t.jsx(dt,{name:"entonnoir",children:t.jsx(Qc,{})}),t.jsx(dt,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(di,{variant:g.mapFolded?"compact":"tabs"}),t.jsxs("div",{className:"stage"+(g.mapFolded?" folded":""),id:"atl2-stage",children:[!g.mapFolded&&a==="ops"&&t.jsx(Uc,{}),!g.mapFolded&&a!=="ops"&&Ne.showFunnel&&t.jsx(Hc,{}),!g.mapFolded&&t.jsx(op,{}),t.jsx(li,{})]})]})}),Ne.showDemand&&ve&&t.jsx(dt,{name:"direct",children:t.jsx(al,{items:W,serverOff:ye,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>p({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([A,Y])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===A,onClick:()=>{u(A);try{localStorage.setItem("atl2:chrome-mode",A)}catch{}},children:Y},A))}),Ne.showDemand&&t.jsx(dt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(xp,{})})}),Ne.showDemand&&g.memoConsole&&t.jsx(dt,{name:"console",children:t.jsx(vp,{})}),Ne.pipe&&!!ie&&t.jsx(dt,{name:"moteurs",children:t.jsx(hl,{})}),Oe>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:s.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Te(0),l.refresh()},children:s.freshGo})]}),t.jsx(dt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(sc,{})}),Ne.pipe&&!!ie&&t.jsx("p",{className:"privnote",children:s.privLink}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(dt,{name:"fiche",children:t.jsx(Hp,{})}),t.jsx(dt,{name:"modales",children:t.jsx(hc,{})}),t.jsx(Xl,{}),h&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:h.o.name}),t.jsx(zr,{placeholder:h.up?s.thumbWhyUpPh:s.thumbWhyDnPh,onDone:A=>{const Y=h.o;q(null),A&&wt(ie,"note",Y.name||"",A,Y.sector||"",l.email||"").then(V=>{V.ok&&ce(s.csNoteSaved)})}})]}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(zr,{placeholder:R.yes?s.whyYesPh:s.whyNoPh,onDone:A=>{const Y=R.o;O(null),A&&Ye(Y,A).then(V=>{V&&ce(s.csNoteSaved)})}})]}),M&&_e&&t.jsx(rd,{steps:Yc(s,ht,gt,At,xt,ke[3]||0,ke[4]||0,ke),onClose:()=>{Q(!1),fo(ie)}}),t.jsx(Wc,{}),Ne.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:_o,children:Pn}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("button",{type:"button",onClick:()=>p({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),C&&t.jsx("div",{className:"flash on"+(D?" err":""),children:C}),j&&t.jsx(Us,{variant:"acquirer",initialCompany:ho().co,initialWebsite:ho().site,onClose:()=>y(null)})]})})}function Qc(){const{t:e}=K(),[a,r]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function ho(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Kc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{ji as FlagCell,Ct as SigBadge,Va as SigWin,Zc as default,Kc as fmtShort,K as useV2};
