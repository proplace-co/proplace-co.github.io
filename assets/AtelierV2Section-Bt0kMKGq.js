...
.atl2 .bulk .side .hint{white-space:nowrap}`,Pi=`
...
`,Di=Fi+Pi;function qa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ii(){const e=qa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function $i(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ii();return r==="0"?"client":r==="1"||qa("embed")==="1"&&qa("chrome")==="1"?"apercu":"client"}const Bi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},_i=e=>Bi[e];function Xa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const lt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!ur(a)||Xa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ao(e.cc)})};function ga(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Ui=60*60*1e3;function Hi(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ui?null:a}catch{return null}}function Ut(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Vi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Wi(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:bo(),[e,n]),o=m.useMemo(()=>n?"visiteur":$i(e,i),[e,i,n]),l=m.useMemo(()=>_i(o),[o]),c=o!=="visiteur",d=Vi(r),[f,s]=m.useState([]),[x,u]=m.useState(""),[g,p]=m.useState(null),[b,v]=m.useState(null),[h,N]=m.useState(null),[E,y]=m.useState(()=>new Map),[z,L]=m.useState(()=>new Map),[q,C]=m.useState(""),[S,j]=m.useState(new Set),[M,D]=m.useState(null),[A,R]=m.useState(!0),[w,O]=m.useState(!1),[W,V]=m.useState(0),[B,Y]=m.useState(0),Z=m.useRef(0),ee=m.useMemo(()=>{var I;if(o!=="client")return"";try{return((I=vo())==null?void 0:I.email)||""}catch{return""}},[o]);m.useEffect(()=>{const I=++Z.current;let ae=!0;const se=()=>ae&&I===Z.current,ze=(c&&i.token?i.token:"pub:"+a)+(d?":"+d:""),ve=Hi(ze);return ve?(s(ve.objs.map(lt)),ve.fund&&u(ve.fund),p(ve.marketEstimate??null),v(ve.criteria??null),N(ve.stats??null),C(ve.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const qe=await xa(),ye=((qe==null?void 0:qe.recent_ops)||[]).map(X=>{const U=Zt(X.company_name||X.title?X:{...X,title:(X.headline_fr||X.headline||"").slice(0,120)},a),K=String(X.rubrique||"").toLowerCase();return U&&(K==="nominations"||K==="recrutements")&&(U.engine=K),U&&!String(X.company_name||"").trim()&&(U.noCo=!0),U}).filter(X=>!!X).map(X=>(ur((X.name||"").trim())||(X.noCo=!0),X));try{const X=yo(),U=X&&X.doc||await wo(),K=ko(U),G=((X==null?void 0:X.day)||(U==null?void 0:U.date)||"").slice(0,10);if(G&&K.length){const me=new Set;for(const ne of ye){if((ne.date||"").slice(0,10)!==G)continue;const xe=xn(K,me,ne.name,"");xe>=0&&(me.add(xe),ne.decryptHtml=K[xe].html)}for(const ne of ye){if(ne.decryptHtml||(ne.date||"").slice(0,10)!==G)continue;const xe=xn(K,me,"",ne.headline||ne.tagline||ne.name);xe>=0&&(me.add(xe),ne.decryptHtml=K[xe].html)}}if(G){const me=((U==null?void 0:U.title_fr)||"").trim(),ne=((U==null?void 0:U.lead_fr)||"").trim(),xe=jo(U),ce=((U==null?void 0:U.url)||"").trim();me&&xe&&ye.unshift({id:`edito:${G}`,kind:"op",name:me,cc:null,date:G,engine:"edito",dealKind:"other",headline:ne||me,tagline:ne||me,decryptHtml:xe,url:ce,noCo:!0})}}catch{}if(!se())return;s(ye.map(lt)),Ut(ze,{objs:ye})}else if(typeof r=="object"){const ye=(await hn()||[]).filter(U=>(U.slug||"")===r.research).map(U=>gn(U,a)).filter(U=>!!U),X=ga(await bn(ye,a));if(!se())return;s(X.map(lt)),Ut(ze,{objs:X})}else if(c&&i.token){const qe=No(i.token),ye=xa(),X=So(i.token),U=Eo(i.token),K=Co(i.token),G=await qe;let me=G?G.targets:[];se()&&G&&(u(G.fund||""),p(G.marketEstimate??null),v(G.criteria??null),N(G.stats??null),C(G.generatedAt||""),s(me.map(lt)),R(!1),O(!1));const[ne,xe,ce,he]=await Promise.all([ye,X,U,K]),Ge=((ne==null?void 0:ne.recent_ops)||[]).map(Le=>Zt(Le,a)).filter(Le=>!!Le);if(me=[...me,...Ge],!se())return;s(me.map(lt));const Ke=new Set;for(const Le of xe){const Qe=(Le.id||Le.co||"").toString().trim().toLowerCase();Qe&&Ke.add(Qe.startsWith("t:")?Qe:"t:"+Qe)}j(Ke),y(ce),L(he),G&&Ut(ze,{fund:G.fund,marketEstimate:G.marketEstimate,criteria:G.criteria,stats:G.stats,generatedAt:G.generatedAt,objs:me})}else{const qe=zo(),ye=hn(),X=xa(),U=await qe;se()&&U.length&&(s(ga(U).map(lt)),R(!1),O(!1));const[K,G]=await Promise.all([ye,X]),me=(K||[]).map(he=>gn(he,a)).filter(he=>!!he),ne=await bn(me,a),xe=((G==null?void 0:G.recent_ops)||[]).map(he=>Zt(he,a)).filter(he=>!!he),ce=ga([...U,...ne,...xe]);if(!se())return;s(ce.map(lt)),Ut(ze,{objs:ce})}se()&&O(!1)}catch{se()&&!ve&&O(!0)}finally{se()&&R(!1)}})(),()=>{ae=!1}},[c,i.token,a,W,d]),m.useEffect(()=>{if(!l.showCredits||!ee){D(null);return}let I=!0;return(async()=>{try{const ae=await fetch(`${Ya}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ee})});if(!ae.ok)return;const se=await ae.json();I&&se&&se.ok!==!1&&D(se)}catch{}})(),()=>{I=!1}},[l.showCredits,ee,B]);const oe=m.useCallback(I=>j(new Set(I)),[]);return{session:i,mode:o,caps:l,fund:x,email:ee,marketEstimate:g,generatedAt:q,criteria:b,stats:h,thumbs:E,stages:z,dossiers:f,favIds:S,setFavIds:oe,credits:M,reloadCredits:()=>Y(I=>I+1),loading:A,error:w,refresh:()=>V(I=>I+1)}}function pt(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const hr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Yi=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...hr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Gi=new Set(["signal","amount","score","crible","memo"]);function Ki(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:hr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Gi.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??gr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const gr=80;function aa(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Te(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ga(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(it(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&dt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function br(e,a,r){return pt(e)?aa(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:aa(e,a.filters,r)}function Qi(e,a,r,n){return!(!br(e,a,r)||r&&!To(e,a.ptab,n))}function Za(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-it(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Lo(i);case"memo":return qo(i);case"signal":{const o=Te(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),c=n(o);return l<c?-a.dir:l>c?a.dir:(i.name||"").localeCompare(o.name||"")})}const ba={},zn=(ba==null?void 0:ba.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function An(){return new Date().toISOString().slice(0,10)}const en=m.createContext(null);function vr(){return m.useContext(en)}function Ji(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const c=n.cloneNode(!0);c.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),c.querySelectorAll("*").forEach(d=>{const f=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(s=>d.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(d.setAttribute("href",f),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:c.outerHTML})}}catch{}return a}function Tn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function yr(){const e=m.useContext(en);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Xi({token:e,children:a}){const{dispatch:r,st:n,lang:i}=$(),[o,l]=m.useState(()=>n.filters.day||An()),[c,d]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l(An());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=v=>{var N;const h=(N=v.detail)==null?void 0:N.day;typeof h=="string"&&x(h)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${zn}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{b||d(h)}).catch(()=>{b||d({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const g=m.useMemo(()=>`${zn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:c,loading:f,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:g,isEn:i==="en"}),[e,o,c,f,x,u,n.filters.day,g,i]);return t.jsx(en.Provider,{value:p,children:a})}function Zi(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=yr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Mo,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})]})}function es(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=yr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),c=(a==null?void 0:a.ok)&&!l,d=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:Tn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:Tn(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const ts=300,Ht=7,as={fr:{ma:"M&A",levees:"Levées de fonds",nominations:"Nominations",recrutements:"Offres d'emploi",actualites:"Presse"},en:{ma:"M&A",levees:"Fundraising",nominations:"Appointments",recrutements:"Job offers",actualites:"Press"}},wr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},ns=["hiring","raised","news","posting","building","community","registry","exodus","other"];function va(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=Te(e);return r?"sig:"+(r.theme&&wr.fr[r.theme]?r.theme:"other"):"actualites"}function rs(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:c}=$(),d=vr(),f=l==="en",[s,x]=m.useState("all"),[u,g]=m.useState(!1),p=m.useMemo(()=>{var oe;const A=(a.filters.day||"").slice(0,10),R=I=>!(!o&&a.continent!=="monde"&&I.continent!==a.continent||A&&(I.date||"").slice(0,10)!==A),w=e.filter(I=>R(I)&&Te(I)&&(!o||I.kind!=="target"||Ce(I)!==5)),O=o&&(((oe=d==null?void 0:d.ed)==null?void 0:oe.ops)||[]).length?d.ed.ops.map(I=>Zt(I,l)).filter(I=>!!I).filter(I=>!A||(I.date||"").slice(0,10)===A):[],W=e.filter(I=>R(I)&&I.kind==="op"&&(A?!0:it(I.date)<=Ht)),V=o?O.length?O:W.filter(I=>{const ae=(c||"").trim().toLowerCase();if(!ae)return!1;const se=I.match||null;return se?Object.keys(se).map(ze=>ze.trim().toLowerCase()).includes(ae):!1}):W,B=A||new Date().toISOString().slice(0,10),Y=I=>{const ae=va(I);return ae==="ma"?0:ae==="levees"?1:2};V.sort((I,ae)=>{const se=Y(I)-Y(ae);if(se)return se;const ze=(I.date||"").slice(0,10)===B?0:1,ve=(ae.date||"").slice(0,10)===B?0:1;return ze!==ve?ze-ve:(ae.amountEur||0)-(I.amountEur||0)});const Z=new Set,ee=[];for(const I of[...V,...Za(w,{key:"signal",dir:-1})]){const ae=I.id||I.name;!ae||Z.has(ae)||(Z.add(ae),ee.push(I))}return o&&ee.length===0?e.filter(ae=>R(ae)&&it(ae.date)<=Ht).sort((ae,se)=>(se.date||"").localeCompare(ae.date||"")).slice(0,80):ee},[e,a.continent,a.filters.day,o,c,l,d]),b=m.useMemo(()=>{const A={};for(const R of p){const w=va(R);A[w]=(A[w]||0)+1}return A},[p]),v=m.useMemo(()=>s==="all"?p:p.filter(A=>va(A)===s),[p,s]),h=m.useMemo(()=>v.slice(0,ts),[v]),N=v.length-h.length,E=m.useRef(null);m.useEffect(()=>{var V,B;const A=E.current;if(!A)return;const R=()=>{const Y=A.scrollWidth;Y<200||(A.style.animationDuration=Math.max(18,Math.round(Y/130))+"s")};R();const w=requestAnimationFrame(R),O=window.setTimeout(R,1200);let W=!0;return(B=(V=document.fonts)==null?void 0:V.ready)==null||B.then(()=>{W&&R()}),()=>{W=!1,cancelAnimationFrame(w),window.clearTimeout(O)}},[h.length,s]);const y=A=>A==="all"?p.length:b[A]||0,z=A=>A==="all"?f?"All":"Tout":A.startsWith("sig:")?wr[f?"en":"fr"][A.slice(4)]||"🔔":as[f?"en":"fr"][A],L=[{k:"all"}],q=["ma","levees"].filter(A=>y(A)>0||A===s);if(q.length){L.push({g:f?"Recent deals":"Opérations récentes"});for(const A of q)L.push({k:A})}const C=["nominations","recrutements","actualites"].filter(A=>y(A)>0||A===s),S=ns.map(A=>"sig:"+A).filter(A=>y(A)>0||A===s);if(C.length||S.length){L.push({g:f?"News (incl. wire)":"Actualités (dont fil)"});for(const A of C)L.push({k:A});for(const A of S)L.push({k:A})}const j=A=>{try{return new Date(A+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return A}},M=(()=>{const A=(a.filters.day||"").slice(0,10),R=!o&&a.continent!=="monde"&&i?f?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return A?(f?`LIVE covers the events of ${j(A)}.`:`Le LIVE regroupe les événements du ${j(A)}.`)+R:(f?`LIVE covers the still-open signals and the deals of the last ${Ht} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Ht} derniers jours.`)+R})(),D=A=>h.map(R=>t.jsxs("button",{type:"button",className:"tk"+(De(R)?" spent":""),onClick:w=>{if(n({type:"focus",id:R.id}),a.dens!=="liste"){const O=w.currentTarget.getBoundingClientRect();n({type:"popup",id:R.id,anchor:{x:O.left+O.width/2,y:O.bottom}})}},title:R.name+(R.tagline?" — "+R.tagline:""),children:[t.jsx(xt,{o:R}),t.jsxs("span",{className:"who",children:[t.jsx(eo,{o:R}),t.jsx("span",{className:"co",children:R.name})]}),typeof R.amountEur=="number"&&R.amountEur>0&&t.jsx("span",{className:"am",children:Ac(R.amountEur)}),R.sector&&t.jsx("span",{className:"mt",children:R.sector}),t.jsx(ma,{o:R}),t.jsx("span",{className:"tkgo",children:"→"})]},A+(R.id||R.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},A+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:A=>{A.currentTarget.contains(A.relatedTarget)||g(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>g(A=>!A),children:[z(s),t.jsx("b",{children:y(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:M}),L.map(A=>"g"in A?t.jsx("span",{className:"tkfilg",children:A.g},A.g):t.jsxs("button",{type:"button","aria-pressed":A.k===s,onClick:()=>{x(A.k),g(!1)},children:[z(A.k),t.jsx("b",{children:y(A.k)})]},A.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:E,children:[D(0),D(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!d&&t.jsx(is,{isEn:f})]})}const os=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function is({isEn:e}){const[a,r]=m.useState(()=>Ro());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(vn,i),()=>window.removeEventListener(vn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Oo(!a),children:os})}const tn="+33 6 83 10 72 86",na="alexandre@proplace.co",kr=`tel:${tn.replace(/[^\d+]/g,"")}`;function ss(){return null}class Re extends m.Component{constructor(){super(...arguments);mn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ya=600,ct=62,qn="atl2:fstats";function ls(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=$(),[l,c]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(qn)==="on"}catch{return!1}}),d=r.stats,f=m.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),s=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const x=z=>a==="en"?z.slice(5,10):`${z.slice(8,10)}/${z.slice(5,7)}`,u=z=>z.toLocaleString(a==="en"?"en-US":"fr-FR"),g=f.reduce((z,L)=>Math.max(z,L.s||0),0),p=f.length?ya/f.length:0,b=Math.max(4,p-4),v=f.length>=5&&g>0,h=r.marketEstimate||0,N=x(new Date().toISOString().slice(0,10)),E=z=>[...typeof z=="number"?[[z,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],y=[];return typeof d.screened_window=="number"&&s&&y.push({cle:"fenetre",periode:e.funPerWindow(x(s),N),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:E(d.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[y.map(z=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:z.periode}),z.etapes.map(([L,q],C)=>t.jsxs("span",{className:"fst-t",children:[C>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(L)}),t.jsx("i",{children:q})]},z.cle+q)),z.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((d.screened||0)/h*100)))})]}),z.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const L=!l;c(L),L&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(qn,L?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},z.cle)),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ya} ${ct}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((z,L)=>{const q=(z.s||0)/g*(ct-4),C=(z.m||0)/g*(ct-4),S=L*p+(p-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(z.d)} — ${z.s} ${e.actScreened} · ${z.m} ${e.actKept}`}),t.jsx("rect",{x:S,y:ct-2-q,width:b,height:q,fill:"#cfe0d6"}),t.jsx("rect",{x:S,y:ct-2-C,width:b,height:C,fill:"#185c38"})]},z.d)}),t.jsx("line",{x1:0,y1:ct-1.5,x2:ya,y2:ct-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const jr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function cs(e,a){if((st(e)||"").startsWith("CALL")&&Ce(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ce(e)>=2;return jr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function ds({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=$(),[c,d]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),p=async b=>{if(f)return;if(b==="Analysé"&&!e.memoUrl){u(!0);return}s(b);const v=await i(e,b);s(""),v&&(d(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(b=>!b),u(!1)},children:[g||a.csNone,t.jsx("i",{children:"▾"})]}),c&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),d(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]}):cs(e,a).map(([b,v])=>t.jsx("button",{type:"button",className:"rsti"+(g===b?" on":"")+(f===b?" busy":""),disabled:!!f,onClick:()=>{p(b)},children:v},b))})]})}function ps({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=$(),[o,l]=m.useState(""),[c,d]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),s=(st(e)||"").startsWith("CALL")&&Ce(e)===3,x=Ce(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const b=await i(e,p);l(""),b&&(d(!0),setTimeout(()=>d(!1),2200))},g=s?[["Validé",a.csYes],["Écarté",a.csNo]]:jr.filter(([p])=>!(x&&p==="Retenu")).map(([p,b])=>[p,a[b]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),g.map(([p,b])=>t.jsx("button",{type:"button",className:"csb"+(f===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:b},p)),c&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(us,{o:e})]})}function us({o:e}){const{t:a,saveNote:r,flash:n}=$(),[i,o]=m.useState(e.ceoNote||""),[l,c]=m.useState(!1),[d,f]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!s)return;c(!0);const u=await r(e,i.trim());c(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{x()},children:d?a.csNoteSaved:a.csNoteOk})]})}function ms({placeholder:e,onDone:a}){const{t:r}=$(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function fs({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:c}=$(),[d,f]=m.useState(!1);if(!n.pipe||!i||n.lockActions||Ce(e)!==4)return null;const s=o(e),x=(s==null?void 0:s.stage)||"todo",u=async h=>{if(d||h===x)return;f(!0);const N=s;l(e,{stage:h,stamps:(s==null?void 0:s.stamps)||{}});const E=Math.max(Date.now(),Ln+=1);Ln=E;const y=await Fo(r,{company:e.name||"",stage:h,cts:E,deal_id:e.airtableId,check_id:e.checkId});f(!1),!y.stale&&(y.ok||(l(e,N),c(a.actErr)))},g=(v=s==null?void 0:s.stamps)==null?void 0:v.sent,p=g?Math.floor((Date.now()-Date.parse(g))/864e5):0,b=x==="sent"&&g&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,N])=>t.jsx("button",{type:"button",className:"stgb"+(x===h?" on":""),disabled:d,onClick:()=>{u(h)},children:N},h)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let Ln=0;const Vt=8,Wt=360;function Mn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Rn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(Mn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(Mn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function xs({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=$(),[l,c]=m.useState(0),[d,f]=m.useState(null),[s,x]=m.useState([]),u=m.useRef(!1),g=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=m.useRef(!1);m.useEffect(()=>{const q=g.current;return()=>{p.current||(n({type:"ptab",tab:q.ptab}),n({type:"dens",dens:q.dens}),n({type:"modal",modal:q.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,x(e.filter(q=>!!document.querySelector(q.need||q.sel))))},[e]);const b=s[l],v=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const q=b.click,C=window.setTimeout(()=>{const S=document.querySelector(q);S&&S.getAttribute("aria-selected")!=="true"&&S.click()},60);return()=>window.clearTimeout(C)}},[l,b]);const h=m.useRef(-1),N=m.useCallback(()=>{if(!b){f(null);return}const q=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!q){f(null);return}h.current!==l&&(h.current=l,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const C=q.getBoundingClientRect();f(S=>S&&Math.abs(S.top-C.top)<1&&Math.abs(S.left-C.left)<1&&Math.abs(S.width-C.width)<1&&Math.abs(S.height-C.height)<1?S:C)},[b,l]);m.useLayoutEffect(()=>{N();const q=[90,300,700,1300].map(S=>window.setTimeout(N,S)),C=()=>N();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{q.forEach(S=>window.clearTimeout(S)),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[N]);const E=m.useRef(a);if(E.current=a,m.useEffect(()=>{const q=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),E.current()):C.key==="ArrowRight"?c(S=>S+1):C.key==="ArrowLeft"&&c(S=>Math.max(0,S-1))};return document.addEventListener("keydown",q,!0),()=>document.removeEventListener("keydown",q,!0)},[]),!s.length)return null;let y=null;const z=q=>()=>{p.current=!0,n({type:"modal",modal:null}),q()};if(v){const q=i[3]||0;q>0?y={title:q===1?r.ahaATitle1:r.ahaATitleN(q),body:r.ahaABody,btn:r.ahaABtn,go:z(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:z(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:z(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:z(()=>{n({type:"modal",modal:"crit"}),a()})}}let L={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Wt};if(!v&&d){const q=d.bottom+14,S=window.innerHeight-q>190?q:Math.max(12,d.top-200);L={left:Math.min(Math.max(12,d.left+d.width/2-Wt/2),window.innerWidth-Wt-12),top:S,width:Wt}}return St.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Vt,top:d.top-Vt,width:d.width+Vt*2,height:d.height+Vt*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:L,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(Rn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>c(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Rn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>c(q=>Math.max(0,q-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>c(q=>q+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Nr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Sr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function hs(){var C,S;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:c,dispatch:d}=$(),f=r?a:e,s=m.useMemo(()=>f.filter(j=>it(j.date)===0&&j.kind==="target"),[f]),x=m.useMemo(()=>r?a.filter(j=>j.kind==="target"&&Ce(j)===0).slice().sort((j,M)=>(M.date||"").localeCompare(j.date||"")):[],[a,r]),u=m.useMemo(()=>s.filter(j=>r?Ce(j)===0:!De(j)),[s,r]),g=r?x:u,p=r?a.length-x.length:s.length-u.length,b=r?a.length:s.length,v=b?Math.min(100,p/b*100):100,h=m.useMemo(()=>Nr(f),[f]),N=!!h&&it(h)>0,E=m.useMemo(()=>N?f.filter(j=>(j.date||"").slice(0,10)===h):[],[f,h,N]),y=typeof((C=c.stats)==null?void 0:C.kept_today)=="number"?c.stats.kept_today:null,z=typeof((S=c.stats)==null?void 0:S.screened_today)=="number"?c.stats.screened_today:s.length;let L;N?L=i.morningLast(E.length,x.length,Sr(h,l)):r?L=i.morningThesis(z,x.length,y):s.length?p===0?L=i.goalSourced(s.length):p>=s.length?L=i.goalCleared:L=i.goalDone(p,s.length):L=i.goalSourced(0);const q=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&x.length&&d({type:"chainStart",queue:x.map(j=>j.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:L}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),g.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:q,children:r?i.morningEval(g.length):o.pileMode?i.goalContinue(g.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function gs(){var W,V;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:c,mode:d,doSync:f,startTour:s,flash:x,flashErr:u}=$(),[g,p]=m.useState(null),[b,v]=m.useState(!0),[h,N]=m.useState([]),E=d==="client";m.useEffect(()=>{if(!i||!o)return;let B=!0;return v(!0),(async()=>{const[Y,Z]=await Promise.all([Ka(o),mr(i)]);B&&(Y&&p(Y),v(!1),N(Z))})(),()=>{B=!1}},[i,o]);const[y,z]=m.useState(!1),L=()=>{!E||y||!o||(z(!0),Po(o).then(B=>{z(!1),B?x(e.identRepubDone):u(e.actErr)}))},q=(g==null?void 0:g.per_day)??null,C=((W=g==null?void 0:g.pool_order)==null?void 0:W.length)??0,S=h.filter(B=>B.status==="running").length,j=m.useMemo(()=>c.filter(B=>B.kind==="target"&&De(B)).length,[c]),M=l.marketEstimate,D=typeof((V=l.stats)==null?void 0:V.screened)=="number"?l.stats.screened:j,A=M&&M>0?Math.min(100,Math.round(D/M*100)):null,R=B=>B.toLocaleString(a==="en"?"en-US":"fr-FR"),w=(o||"P").split(/\s+/).map(B=>B[0]).join("").slice(0,2).toUpperCase(),O=(()=>{const B=Date.parse(l.generatedAt||"");if(Number.isNaN(B))return"";const Y=new Date(B),Z=ee=>String(ee).padStart(2,"0");return`${Z(Y.getDate())}/${Z(Y.getMonth()+1)} à ${Z(Y.getHours())}:${Z(Y.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?w:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),O?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(O)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[A===null&&D>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(D)})})]}),A!==null&&M&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:A+"%"}})}),t.jsxs("b",{children:[A," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(D,M)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),q!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:q})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),q===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),S>0&&t.jsxs("span",{className:"ev",children:["⏳ ",S]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(C)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:B=>{B.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||y,onClick:L,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:B=>n({type:"filters",patch:{search:B.target.value}})})]})]})]})}function bs(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=$(),c=o.loading&&!l.length,d=m.useRef({});m.useEffect(()=>{d.current={...r}},[r]);const f=u=>{const g=d.current[u],p=g!==void 0?r[u]-g:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ea[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},s=(u,g,p)=>t.jsxs("button",{type:"button",className:"off"+(g?" view":""),style:{"--c":`var(${Ea[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),x=(u,g,p,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:g,disabled:b,onClick:p,children:u},g);return t.jsxs("div",{className:"funnel"+(c?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[x("↩",n.toolUndo,i,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function vs(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=$(),c=m.useRef(null),[d,f]=m.useState(60);m.useEffect(()=>{let p=0;const b=()=>{var y;const v=c.current;if(!v)return;const h=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!h)return;const N=h.getBoundingClientRect(),E=v.getBoundingClientRect();f(Math.max(20,Math.min(N.left+N.width/2-E.left,E.width-30)))};return p=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let x=r.tuto[s].p;if(s===3){const p=n.filter(h=>h.kind==="target"&&Ce(h)===3),b=p.filter(h=>Ca(h)==="auto").length,v=p.filter(h=>Ca(h)==="cd").length;x=r.tutoPending(b,v,p.length)}const u=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(s===1){const p=n.filter(b=>b.kind==="target"&&Ce(b)===1&&!i.has(b.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(b=>b.id)})}}return null})(),g=Do(s);return t.jsxs("div",{ref:c,className:"tuto mini"+(g?"":" on-dark"),style:{"--bg":`var(${Ea[s]})`,"--ax":d+"px","--stc":g?"var(--ink)":"#fff","--stt":g?"#fff":"var(--ink)","--tc":g?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class mt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,c=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);c&&(r[n++]=c),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*ys(e){for(const a of e)yield*a}function Er(e){return Array.from(ys(e))}var fe=1e-6,ie=Math.PI,He=ie/2,On=ie/4,Ye=ie*2,rt=180/ie,$e=ie/180,be=Math.abs,ws=Math.atan,Ot=Math.atan2,Ne=Math.cos,Se=Math.sin,ks=Math.sign||function(e){return e>0?1:e<0?-1:0},ht=Math.sqrt;function js(e){return e>1?0:e<-1?ie:Math.acos(e)}function Ft(e){return e>1?He:e<-1?-He:Math.asin(e)}function Ve(){}function ra(e,a){e&&Pn.hasOwnProperty(e.type)&&Pn[e.type](e,a)}var Fn={Feature:function(e,a){ra(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)ra(r[n].geometry,a)}},Pn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){La(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)La(r[n],a,0)},Polygon:function(e,a){Dn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Dn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)ra(r[n],a)}};function La(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Dn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)La(e[r],a,1);a.polygonEnd()}function bt(e,a){e&&Fn.hasOwnProperty(e.type)?Fn[e.type](e,a):ra(e,a)}function Ma(e){return[Ot(e[1],e[0]),Ft(e[2])]}function kt(e){var a=e[0],r=e[1],n=Ne(r);return[n*Ne(a),n*Se(a),Se(r)]}function Yt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function oa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function wa(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Gt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Ra(e){var a=ht(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Oa(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Fa(e,a){return be(e)>ie&&(e-=Math.round(e/Ye)*Ye),[e,a]}Fa.invert=Fa;function Ns(e,a,r){return(e%=Ye)?a||r?Oa($n(e),Bn(a,r)):$n(e):a||r?Bn(a,r):Fa}function In(e){return function(a,r){return a+=e,be(a)>ie&&(a-=Math.round(a/Ye)*Ye),[a,r]}}function $n(e){var a=In(e);return a.invert=In(-e),a}function Bn(e,a){var r=Ne(e),n=Se(e),i=Ne(a),o=Se(a);function l(c,d){var f=Ne(d),s=Ne(c)*f,x=Se(c)*f,u=Se(d),g=u*r+s*n;return[Ot(x*i-g*o,s*r-u*n),Ft(g*i+x*o)]}return l.invert=function(c,d){var f=Ne(d),s=Ne(c)*f,x=Se(c)*f,u=Se(d),g=u*i-x*o;return[Ot(x*i+u*o,s*r+g*n),Ft(g*r-s*n)]},l}function Ss(e,a,r,n,i,o){if(r){var l=Ne(a),c=Se(a),d=n*r;i==null?(i=a+n*Ye,o=a-d/2):(i=_n(l,i),o=_n(l,o),(n>0?i<o:i>o)&&(i+=n*Ye));for(var f,s=i;n>0?s>o:s<o;s-=d)f=Ma([l,-c*Ne(s),-c*Se(s)]),e.point(f[0],f[1])}}function _n(e,a){a=kt(a),a[0]-=e,Ra(a);var r=js(-a[1]);return((-a[2]<0?-r:r)+Ye-fe)%Ye}function Cr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ve,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ea(e,a){return be(e[0]-a[0])<fe&&be(e[1]-a[1])<fe}function Kt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function zr(e,a,r,n,i){var o=[],l=[],c,d;if(e.forEach(function(p){if(!((b=p.length-1)<=0)){var b,v=p[0],h=p[b],N;if(ea(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),c=0;c<b;++c)i.point((v=p[c])[0],v[1]);i.lineEnd();return}h[0]+=2*fe}o.push(N=new Kt(v,p,null,!0)),l.push(N.o=new Kt(v,null,N,!1)),o.push(N=new Kt(h,p,null,!1)),l.push(N.o=new Kt(h,null,N,!0))}}),!!o.length){for(l.sort(a),Un(o),Un(l),c=0,d=l.length;c<d;++c)l[c].e=r=!r;for(var f=o[0],s,x;;){for(var u=f,g=!0;u.v;)if((u=u.n)===f)return;s=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(g)for(c=0,d=s.length;c<d;++c)i.point((x=s[c])[0],x[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(g)for(s=u.p.z,c=s.length-1;c>=0;--c)i.point((x=s[c])[0],x[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,s=u.z,g=!g}while(!u.v);i.lineEnd()}}}function Un(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function ka(e){return be(e[0])<=ie?e[0]:ks(e[0])*((be(e[0])+ie)%Ye-ie)}function Es(e,a){var r=ka(a),n=a[1],i=Se(n),o=[Se(r),-Ne(r),0],l=0,c=0,d=new mt;i===1?n=He+fe:i===-1&&(n=-He-fe);for(var f=0,s=e.length;f<s;++f)if(u=(x=e[f]).length)for(var x,u,g=x[u-1],p=ka(g),b=g[1]/2+On,v=Se(b),h=Ne(b),N=0;N<u;++N,p=y,v=L,h=q,g=E){var E=x[N],y=ka(E),z=E[1]/2+On,L=Se(z),q=Ne(z),C=y-p,S=C>=0?1:-1,j=S*C,M=j>ie,D=v*L;if(d.add(Ot(D*S*Se(j),h*q+D*Ne(j))),l+=M?C+S*Ye:C,M^p>=r^y>=r){var A=oa(kt(g),kt(E));Ra(A);var R=oa(o,A);Ra(R);var w=(M^C>=0?-1:1)*Ft(R[2]);(n>w||n===w&&(A[0]||A[1]))&&(c+=M^C>=0?1:-1)}}return(l<-fe||l<fe&&d<-1e-12)^c&1}function Ar(e,a,r,n){return function(i){var o=a(i),l=Cr(),c=a(l),d=!1,f,s,x,u={point:g,lineStart:b,lineEnd:v,polygonStart:function(){u.point=h,u.lineStart=N,u.lineEnd=E,s=[],f=[]},polygonEnd:function(){u.point=g,u.lineStart=b,u.lineEnd=v,s=Er(s);var y=Es(f,n);s.length?(d||(i.polygonStart(),d=!0),zr(s,zs,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),s=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function g(y,z){e(y,z)&&i.point(y,z)}function p(y,z){o.point(y,z)}function b(){u.point=p,o.lineStart()}function v(){u.point=g,o.lineEnd()}function h(y,z){x.push([y,z]),c.point(y,z)}function N(){c.lineStart(),x=[]}function E(){h(x[0][0],x[0][1]),c.lineEnd();var y=c.clean(),z=l.result(),L,q=z.length,C,S,j;if(x.pop(),f.push(x),x=null,!!q){if(y&1){if(S=z[0],(C=S.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),L=0;L<C;++L)i.point((j=S[L])[0],j[1]);i.lineEnd()}return}q>1&&y&2&&z.push(z.pop().concat(z.shift())),s.push(z.filter(Cs))}}return u}}function Cs(e){return e.length>1}function zs(e,a){return((e=e.x)[0]<0?e[1]-He-fe:He-e[1])-((a=a.x)[0]<0?a[1]-He-fe:He-a[1])}const Hn=Ar(function(){return!0},As,qs,[-ie,-He]);function As(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var c=o>0?ie:-ie,d=be(o-a);be(d-ie)<fe?(e.point(a,r=(r+l)/2>0?He:-He),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(c,r),e.point(o,r),i=0):n!==c&&d>=ie&&(be(a-n)<fe&&(a-=n*fe),be(o-c)<fe&&(o-=c*fe),r=Ts(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(c,r),i=0),e.point(a=o,r=l),n=c},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ts(e,a,r,n){var i,o,l=Se(e-r);return be(l)>fe?ws((Se(a)*(o=Ne(n))*Se(r)-Se(n)*(i=Ne(a))*Se(e))/(i*o*l)):(a+n)/2}function qs(e,a,r,n){var i;if(e==null)i=r*He,n.point(-ie,i),n.point(0,i),n.point(ie,i),n.point(ie,0),n.point(ie,-i),n.point(0,-i),n.point(-ie,-i),n.point(-ie,0),n.point(-ie,i);else if(be(e[0]-a[0])>fe){var o=e[0]<a[0]?ie:-ie;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ls(e){var a=Ne(e),r=2*$e,n=a>0,i=be(a)>fe;function o(s,x,u,g){Ss(g,e,r,u,s,x)}function l(s,x){return Ne(s)*Ne(x)>a}function c(s){var x,u,g,p,b;return{lineStart:function(){p=g=!1,b=1},point:function(v,h){var N=[v,h],E,y=l(v,h),z=n?y?0:f(v,h):y?f(v+(v<0?ie:-ie),h):0;if(!x&&(p=g=y)&&s.lineStart(),y!==g&&(E=d(x,N),(!E||ea(x,E)||ea(N,E))&&(N[2]=1)),y!==g)b=0,y?(s.lineStart(),E=d(N,x),s.point(E[0],E[1])):(E=d(x,N),s.point(E[0],E[1],2),s.lineEnd()),x=E;else if(i&&x&&n^y){var L;!(z&u)&&(L=d(N,x,!0))&&(b=0,n?(s.lineStart(),s.point(L[0][0],L[0][1]),s.point(L[1][0],L[1][1]),s.lineEnd()):(s.point(L[1][0],L[1][1]),s.lineEnd(),s.lineStart(),s.point(L[0][0],L[0][1],3)))}y&&(!x||!ea(x,N))&&s.point(N[0],N[1]),x=N,g=y,u=z},lineEnd:function(){g&&s.lineEnd(),x=null},clean:function(){return b|(p&&g)<<1}}}function d(s,x,u){var g=kt(s),p=kt(x),b=[1,0,0],v=oa(g,p),h=Yt(v,v),N=v[0],E=h-N*N;if(!E)return!u&&s;var y=a*h/E,z=-a*N/E,L=oa(b,v),q=Gt(b,y),C=Gt(v,z);wa(q,C);var S=L,j=Yt(q,S),M=Yt(S,S),D=j*j-M*(Yt(q,q)-1);if(!(D<0)){var A=ht(D),R=Gt(S,(-j-A)/M);if(wa(R,q),R=Ma(R),!u)return R;var w=s[0],O=x[0],W=s[1],V=x[1],B;O<w&&(B=w,w=O,O=B);var Y=O-w,Z=be(Y-ie)<fe,ee=Z||Y<fe;if(!Z&&V<W&&(B=W,W=V,V=B),ee?Z?W+V>0^R[1]<(be(R[0]-w)<fe?W:V):W<=R[1]&&R[1]<=V:Y>ie^(w<=R[0]&&R[0]<=O)){var oe=Gt(S,(-j+A)/M);return wa(oe,q),[R,Ma(oe)]}}}function f(s,x){var u=n?e:ie-e,g=0;return s<-u?g|=1:s>u&&(g|=2),x<-u?g|=4:x>u&&(g|=8),g}return Ar(l,c,o,n?[0,-e]:[-ie,e-ie])}function Ms(e,a,r,n,i,o){var l=e[0],c=e[1],d=a[0],f=a[1],s=0,x=1,u=d-l,g=f-c,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<s)return;p<x&&(x=p)}else if(u>0){if(p>x)return;p>s&&(s=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>x)return;p>s&&(s=p)}else if(u>0){if(p<s)return;p<x&&(x=p)}if(p=n-c,!(!g&&p>0)){if(p/=g,g<0){if(p<s)return;p<x&&(x=p)}else if(g>0){if(p>x)return;p>s&&(s=p)}if(p=o-c,!(!g&&p<0)){if(p/=g,g<0){if(p>x)return;p>s&&(s=p)}else if(g>0){if(p<s)return;p<x&&(x=p)}return s>0&&(e[0]=l+s*u,e[1]=c+s*g),x<1&&(a[0]=l+x*u,a[1]=c+x*g),!0}}}}}var At=1e9,Qt=-At;function Rs(e,a,r,n){function i(f,s){return e<=f&&f<=r&&a<=s&&s<=n}function o(f,s,x,u){var g=0,p=0;if(f==null||(g=l(f,x))!==(p=l(s,x))||d(f,s)<0^x>0)do u.point(g===0||g===3?e:r,g>1?n:a);while((g=(g+x+4)%4)!==p);else u.point(s[0],s[1])}function l(f,s){return be(f[0]-e)<fe?s>0?0:3:be(f[0]-r)<fe?s>0?2:1:be(f[1]-a)<fe?s>0?1:0:s>0?3:2}function c(f,s){return d(f.x,s.x)}function d(f,s){var x=l(f,1),u=l(s,1);return x!==u?x-u:x===0?s[1]-f[1]:x===1?f[0]-s[0]:x===2?f[1]-s[1]:s[0]-f[0]}return function(f){var s=f,x=Cr(),u,g,p,b,v,h,N,E,y,z,L,q={point:C,lineStart:D,lineEnd:A,polygonStart:j,polygonEnd:M};function C(w,O){i(w,O)&&s.point(w,O)}function S(){for(var w=0,O=0,W=g.length;O<W;++O)for(var V=g[O],B=1,Y=V.length,Z=V[0],ee,oe,I=Z[0],ae=Z[1];B<Y;++B)ee=I,oe=ae,Z=V[B],I=Z[0],ae=Z[1],oe<=n?ae>n&&(I-ee)*(n-oe)>(ae-oe)*(e-ee)&&++w:ae<=n&&(I-ee)*(n-oe)<(ae-oe)*(e-ee)&&--w;return w}function j(){s=x,u=[],g=[],L=!0}function M(){var w=S(),O=L&&w,W=(u=Er(u)).length;(O||W)&&(f.polygonStart(),O&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),W&&zr(u,c,w,o,f),f.polygonEnd()),s=f,u=g=p=null}function D(){q.point=R,g&&g.push(p=[]),z=!0,y=!1,N=E=NaN}function A(){u&&(R(b,v),h&&y&&x.rejoin(),u.push(x.result())),q.point=C,y&&s.lineEnd()}function R(w,O){var W=i(w,O);if(g&&p.push([w,O]),z)b=w,v=O,h=W,z=!1,W&&(s.lineStart(),s.point(w,O));else if(W&&y)s.point(w,O);else{var V=[N=Math.max(Qt,Math.min(At,N)),E=Math.max(Qt,Math.min(At,E))],B=[w=Math.max(Qt,Math.min(At,w)),O=Math.max(Qt,Math.min(At,O))];Ms(V,B,e,a,r,n)?(y||(s.lineStart(),s.point(V[0],V[1])),s.point(B[0],B[1]),W||s.lineEnd(),L=!1):W&&(s.lineStart(),s.point(w,O),L=!1)}N=w,E=O,y=W}return q}}const Pa=e=>e;var ja=new mt,Da=new mt,Tr,qr,Ia,$a,ot={point:Ve,lineStart:Ve,lineEnd:Ve,polygonStart:function(){ot.lineStart=Os,ot.lineEnd=Ps},polygonEnd:function(){ot.lineStart=ot.lineEnd=ot.point=Ve,ja.add(be(Da)),Da=new mt},result:function(){var e=ja/2;return ja=new mt,e}};function Os(){ot.point=Fs}function Fs(e,a){ot.point=Lr,Tr=Ia=e,qr=$a=a}function Lr(e,a){Da.add($a*e-Ia*a),Ia=e,$a=a}function Ps(){Lr(Tr,qr)}var jt=1/0,ia=jt,Pt=-jt,sa=Pt,la={point:Ds,lineStart:Ve,lineEnd:Ve,polygonStart:Ve,polygonEnd:Ve,result:function(){var e=[[jt,ia],[Pt,sa]];return Pt=sa=-(ia=jt=1/0),e}};function Ds(e,a){e<jt&&(jt=e),e>Pt&&(Pt=e),a<ia&&(ia=a),a>sa&&(sa=a)}var Ba=0,_a=0,Tt=0,ca=0,da=0,vt=0,Ua=0,Ha=0,qt=0,Mr,Rr,tt,at,Ue={point:ft,lineStart:Vn,lineEnd:Wn,polygonStart:function(){Ue.lineStart=Bs,Ue.lineEnd=_s},polygonEnd:function(){Ue.point=ft,Ue.lineStart=Vn,Ue.lineEnd=Wn},result:function(){var e=qt?[Ua/qt,Ha/qt]:vt?[ca/vt,da/vt]:Tt?[Ba/Tt,_a/Tt]:[NaN,NaN];return Ba=_a=Tt=ca=da=vt=Ua=Ha=qt=0,e}};function ft(e,a){Ba+=e,_a+=a,++Tt}function Vn(){Ue.point=Is}function Is(e,a){Ue.point=$s,ft(tt=e,at=a)}function $s(e,a){var r=e-tt,n=a-at,i=ht(r*r+n*n);ca+=i*(tt+e)/2,da+=i*(at+a)/2,vt+=i,ft(tt=e,at=a)}function Wn(){Ue.point=ft}function Bs(){Ue.point=Us}function _s(){Or(Mr,Rr)}function Us(e,a){Ue.point=Or,ft(Mr=tt=e,Rr=at=a)}function Or(e,a){var r=e-tt,n=a-at,i=ht(r*r+n*n);ca+=i*(tt+e)/2,da+=i*(at+a)/2,vt+=i,i=at*e-tt*a,Ua+=i*(tt+e),Ha+=i*(at+a),qt+=i*3,ft(tt=e,at=a)}function Fr(e){this._context=e}Fr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Ye);break}}},result:Ve};var Va=new mt,Na,Pr,Dr,Lt,Mt,Dt={point:Ve,lineStart:function(){Dt.point=Hs},lineEnd:function(){Na&&Ir(Pr,Dr),Dt.point=Ve},polygonStart:function(){Na=!0},polygonEnd:function(){Na=null},result:function(){var e=+Va;return Va=new mt,e}};function Hs(e,a){Dt.point=Ir,Pr=Lt=e,Dr=Mt=a}function Ir(e,a){Lt-=e,Mt-=a,Va.add(ht(Lt*Lt+Mt*Mt)),Lt=e,Mt=a}let Yn,pa,Gn,Kn;class Qn{constructor(a){this._append=a==null?$r:Vs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Gn||this._append!==pa){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Gn=n,pa=this._append,Kn=this._,this._=i}this._+=Kn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function $r(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Vs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return $r;if(a!==Yn){const r=10**a;Yn=a,pa=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return pa}function Ws(e,a){let r=3,n=4.5,i,o;function l(c){return c&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),bt(c,i(o))),o.result()}return l.area=function(c){return bt(c,i(ot)),ot.result()},l.measure=function(c){return bt(c,i(Dt)),Dt.result()},l.bounds=function(c){return bt(c,i(la)),la.result()},l.centroid=function(c){return bt(c,i(Ue)),Ue.result()},l.projection=function(c){return arguments.length?(i=c==null?(e=null,Pa):(e=c).stream,l):e},l.context=function(c){return arguments.length?(o=c==null?(a=null,new Qn(r)):new Fr(a=c),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(c){return arguments.length?(n=typeof c=="function"?c:(o.pointRadius(+c),+c),l):n},l.digits=function(c){if(!arguments.length)return r;if(c==null)r=null;else{const d=Math.floor(c);if(!(d>=0))throw new RangeError(`invalid digits: ${c}`);r=d}return a===null&&(o=new Qn(r)),l},l.projection(e).digits(r).context(a)}function an(e){return function(a){var r=new Wa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Wa(){}Wa.prototype={constructor:Wa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function nn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),bt(r,e.stream(la)),a(la.result()),n!=null&&e.clipExtent(n),e}function Br(e,a,r){return nn(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),c=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([c,d])},r)}function Ys(e,a,r){return Br(e,[[0,0],a],r)}function Gs(e,a,r){return nn(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,c=-o*n[0][1];e.scale(150*o).translate([l,c])},r)}function Ks(e,a,r){return nn(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],c=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,c])},r)}var Jn=16,Qs=Ne(30*$e);function Xn(e,a){return+a?Xs(e,a):Js(e)}function Js(e){return an({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Xs(e,a){function r(n,i,o,l,c,d,f,s,x,u,g,p,b,v){var h=f-n,N=s-i,E=h*h+N*N;if(E>4*a&&b--){var y=l+u,z=c+g,L=d+p,q=ht(y*y+z*z+L*L),C=Ft(L/=q),S=be(be(L)-1)<fe||be(o-x)<fe?(o+x)/2:Ot(z,y),j=e(S,C),M=j[0],D=j[1],A=M-n,R=D-i,w=N*A-h*R;(w*w/E>a||be((h*A+N*R)/E-.5)>.3||l*u+c*g+d*p<Qs)&&(r(n,i,o,l,c,d,M,D,S,y/=q,z/=q,L,b,v),v.point(M,D),r(M,D,S,y,z,L,f,s,x,u,g,p,b,v))}}return function(n){var i,o,l,c,d,f,s,x,u,g,p,b,v={point:h,lineStart:N,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=z},polygonEnd:function(){n.polygonEnd(),v.lineStart=N}};function h(C,S){C=e(C,S),n.point(C[0],C[1])}function N(){x=NaN,v.point=E,n.lineStart()}function E(C,S){var j=kt([C,S]),M=e(C,S);r(x,u,s,g,p,b,x=M[0],u=M[1],s=C,g=j[0],p=j[1],b=j[2],Jn,n),n.point(x,u)}function y(){v.point=h,n.lineEnd()}function z(){N(),v.point=L,v.lineEnd=q}function L(C,S){E(i=C,S),o=x,l=u,c=g,d=p,f=b,v.point=E}function q(){r(x,u,s,g,p,b,o,l,i,c,d,f,Jn,n),v.lineEnd=y,y()}return v}}var Zs=an({point:function(e,a){this.stream.point(e*$e,a*$e)}});function el(e){return an({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function tl(e,a,r,n,i){function o(l,c){return l*=n,c*=i,[a+e*l,r-e*c]}return o.invert=function(l,c){return[(l-a)/e*n,(r-c)/e*i]},o}function Zn(e,a,r,n,i,o){if(!o)return tl(e,a,r,n,i);var l=Ne(o),c=Se(o),d=l*e,f=c*e,s=l/e,x=c/e,u=(c*r-l*a)/e,g=(c*a+l*r)/e;function p(b,v){return b*=n,v*=i,[d*b-f*v+a,r-f*b-d*v]}return p.invert=function(b,v){return[n*(s*b-x*v+u),i*(g-x*b-s*v)]},p}function al(e){return nl(function(){return e})()}function nl(e){var a,r=150,n=480,i=250,o=0,l=0,c=0,d=0,f=0,s,x=0,u=1,g=1,p=null,b=Hn,v=null,h,N,E,y=Pa,z=.5,L,q,C,S,j;function M(w){return C(w[0]*$e,w[1]*$e)}function D(w){return w=C.invert(w[0],w[1]),w&&[w[0]*rt,w[1]*rt]}M.stream=function(w){return S&&j===w?S:S=Zs(el(s)(b(L(y(j=w)))))},M.preclip=function(w){return arguments.length?(b=w,p=void 0,R()):b},M.postclip=function(w){return arguments.length?(y=w,v=h=N=E=null,R()):y},M.clipAngle=function(w){return arguments.length?(b=+w?Ls(p=w*$e):(p=null,Hn),R()):p*rt},M.clipExtent=function(w){return arguments.length?(y=w==null?(v=h=N=E=null,Pa):Rs(v=+w[0][0],h=+w[0][1],N=+w[1][0],E=+w[1][1]),R()):v==null?null:[[v,h],[N,E]]},M.scale=function(w){return arguments.length?(r=+w,A()):r},M.translate=function(w){return arguments.length?(n=+w[0],i=+w[1],A()):[n,i]},M.center=function(w){return arguments.length?(o=w[0]%360*$e,l=w[1]%360*$e,A()):[o*rt,l*rt]},M.rotate=function(w){return arguments.length?(c=w[0]%360*$e,d=w[1]%360*$e,f=w.length>2?w[2]%360*$e:0,A()):[c*rt,d*rt,f*rt]},M.angle=function(w){return arguments.length?(x=w%360*$e,A()):x*rt},M.reflectX=function(w){return arguments.length?(u=w?-1:1,A()):u<0},M.reflectY=function(w){return arguments.length?(g=w?-1:1,A()):g<0},M.precision=function(w){return arguments.length?(L=Xn(q,z=w*w),R()):ht(z)},M.fitExtent=function(w,O){return Br(M,w,O)},M.fitSize=function(w,O){return Ys(M,w,O)},M.fitWidth=function(w,O){return Gs(M,w,O)},M.fitHeight=function(w,O){return Ks(M,w,O)};function A(){var w=Zn(r,0,0,u,g,x).apply(null,a(o,l)),O=Zn(r,n-w[0],i-w[1],u,g,x);return s=Ns(c,d,f),q=Oa(a,O),C=Oa(s,q),L=Xn(q,z),R()}function R(){return S=j=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&D,A()}}function _r(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}_r.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(be(i)>fe&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function rl(){return al(_r).scale(175.295)}function ol(e){return e}function il(e){if(e==null)return ol;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(c,d){d||(a=r=0);var f=2,s=c.length,x=new Array(s);for(x[0]=(a+=c[0])*n+o,x[1]=(r+=c[1])*i+l;f<s;)x[f]=c[f],++f;return x}}function sl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ll(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return er(e,r)})}:er(e,a)}function er(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=cl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function cl(e,a){var r=il(e.transform),n=e.arcs;function i(s,x){x.length&&x.pop();for(var u=n[s<0?~s:s],g=0,p=u.length;g<p;++g)x.push(r(u[g],g));s<0&&sl(x,p)}function o(s){return r(s)}function l(s){for(var x=[],u=0,g=s.length;u<g;++u)i(s[u],x);return x.length<2&&x.push(x[0]),x}function c(s){for(var x=l(s);x.length<4;)x.push(x[0]);return x}function d(s){return s.map(c)}function f(s){var x=s.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:s.geometries.map(f)};case"Point":u=o(s.coordinates);break;case"MultiPoint":u=s.coordinates.map(o);break;case"LineString":u=l(s.arcs);break;case"MultiLineString":u=s.arcs.map(l);break;case"Polygon":u=d(s.arcs);break;case"MultiPolygon":u=s.arcs.map(d);break;default:return null}return{type:x,coordinates:u}}return f(a)}const Ur={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},dl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function pl(e,a,r){const n=Ur[e];if(!n||!n.length)return-1;const i=dl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Jt=null;function ul(){return Jt||(Jt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ll(r,n),o=rl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Ws(o),c=(i.features||[]).filter(s=>{var x;return(((x=s.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(s=>{var g;const x=((g=s.properties)==null?void 0:g.name)||"",u=l(s)||"";return u?{i2:Io(x)||null,n:x,d:u}:null}).filter(s=>!!s);if(!c.length)return null;const d={};for(const[s,x]of Object.entries($o)){const u=o(x);u&&(d[s]={x:u[0],y:u[1]})}const f={};for(const[s,x]of Object.entries(Ur)){const u=x.map(g=>o(g.ll)).filter(g=>!!g).map(([g,p])=>({x:g,y:p}));u.length&&(f[s]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:c,anchors:d,metros:f}}catch{return null}})(),Jt)}function ml(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return ul().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const fl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},tr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function ar(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function xl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const d=(f=e.current)==null?void 0:f.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(l)};l();const c=new ResizeObserver(()=>l());return e.current&&c.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),c.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function nr({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function hl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:c,t:d,data:f,dossiers:s,source:x}=$(),u=f.loading&&!s.length,g=m.useRef(null),p=m.useRef(null),b=ml(e.continent==="monde"),v=e.continent==="monde"?b:Qa.find(w=>w.key===e.continent)||null,h=xl(g,e.continent+":"+e.mapFolded+":"+!!v),[N,E]=m.useState(new Map),[y,z]=m.useState(null);m.useEffect(()=>{const w=g.current;if(!w)return;const O=new Map;w.querySelectorAll("path[data-i2]").forEach(W=>{const V=W.dataset.i2;if(V)try{const B=W.getBBox();B.width>0&&O.set(V,{x:B.x,y:B.y,w:B.width,h:B.height})}catch{}}),E(O)},[e.continent,h,v]);const L=m.useMemo(()=>r.filter(w=>w.cc),[r]),q=m.useMemo(()=>{const w=new Map;return L.forEach(O=>w.set(O.cc,(w.get(O.cc)||0)+1)),w},[L]),C=e.continent==="monde"&&b?b.anchors:null,S=e.continent==="monde"&&b?b.metros:null,j=m.useMemo(()=>L.map(w=>{const O=ar(w.name||w.id||""),W=ar((w.id||w.name||"")+"·y");if(C&&w.cc){const ee=S?S[w.cc]:void 0;if(ee&&ee.length){const I=pl(w.cc,w.city,O);if(I>=0&&ee[I])return{d:w,x:ee[I].x+(O-.5)*5,y:ee[I].y+(W-.5)*5}}const oe=C[w.cc];if(oe)return{d:w,x:oe.x+(O-.5)*10,y:oe.y+(W-.5)*10}}const V=w.cc?N.get(w.cc):void 0;if(!V)return null;const B=fl[`${e.continent}:${w.cc||""}`];if(B)return{d:w,x:V.x+V.w*(B.fx+(O-.5)*B.sx),y:V.y+V.h*(B.fy+(W-.5)*B.sy)};const Y=(O-.5)*Math.min(V.w*.55,60),Z=(W-.5)*Math.min(V.h*.55,60);return{d:w,x:V.x+V.w/2+Y,y:V.y+V.h/2+Z}}).filter(w=>!!w),[L,N,C,S,e.continent]),M=w=>h>0?w/h:w,D=m.useMemo(()=>n?[0,1,2,3,4,5].map(w=>({c:tr[w],fr:d.plabels[w].toUpperCase(),en:d.plabels[w].toUpperCase(),n:r.filter(O=>O.kind==="target"&&Ce(O)===w).length})).filter(w=>w.n>0):yn.map((w,O)=>({...w,n:r.filter(W=>wn(W)===O).length})),[r,n,d.plabels]),A=o?l.get(o):null,R=A?j.find(w=>w.d.id===A.id):null;return v?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:[u&&t.jsx(nr,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:g,viewBox:v.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":c==="fr"?v.fr:v.en,onMouseLeave:()=>{z(null),i(null)},children:[t.jsx("g",{children:v.countries.map((w,O)=>t.jsx("g",{className:"ct"+(w.i2&&q.get(w.i2)?"":" empty"),children:t.jsx("path",{d:w.d,"data-i2":w.i2||void 0})},O))}),t.jsx("g",{children:j.map(w=>{const O=yn[wn(w.d)],W=!!Te(w.d),V=w.d.kind==="target",B=n&&V?tr[Ce(w.d)]:O.c,Y=!n&&De(w.d);return t.jsxs("g",{className:"co"+(Y?" done":""),onMouseEnter:()=>{var oe,I;const Z=(oe=p.current)==null?void 0:oe.getBoundingClientRect(),ee=(I=g.current)==null?void 0:I.createSVGPoint();if(ee&&g.current&&Z){ee.x=w.x,ee.y=w.y;const ae=ee.matrixTransform(g.current.getScreenCTM());z({x:ae.x-Z.left,y:ae.y-Z.top,label:w.d.name+" · "+(Et(w.d.cc,c)||w.d.countryLabel||"")})}i(w.d.id)},onMouseLeave:()=>{z(null),i(null)},onClick:()=>{var oe;if(x==="ops"){a({type:"focus",id:w.d.id}),w.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:w.d.name}}));return}const Z=(oe=g.current)==null?void 0:oe.createSVGPoint();let ee=null;if(Z&&g.current){Z.x=w.x,Z.y=w.y;const I=Z.matrixTransform(g.current.getScreenCTM());ee={x:I.x,y:I.y}}a({type:"popup",id:w.d.id,anchor:ee})},children:[t.jsx("circle",{className:"h",cx:w.x,cy:w.y,r:M(Math.max(11,O.px+7))}),t.jsx("circle",{className:"v",cx:w.x,cy:w.y,r:M(O.px),fill:B,stroke:W?"#DC2626":"#ffffff",strokeWidth:M(W?2.2:1.3)})]},w.d.id||w.d.name)})}),R&&t.jsx("circle",{className:"ring on",cx:R.x,cy:R.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(y?" on":""),style:y?{left:y.x,top:y.y}:void 0,children:y==null?void 0:y.label}),t.jsx("div",{className:"legend",children:D.map((w,O)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":w.c}}),c==="fr"?w.fr:w.en," ",t.jsx("b",{children:w.n})]},O))}),r.some(w=>!w.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(w=>!w.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:t.jsx(nr,{msgs:d.loadMsgs})})}function gl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Hr({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:c}=$(),d=a.filters,[f,s]=m.useState(!1),x=m.useRef(null),u=m.useMemo(()=>a.continent==="monde"?n:n.filter(C=>C.continent===a.continent),[n,a.continent]),g=C=>u.filter(S=>C!=="country"&&d.country.length&&!d.country.includes(S.cc||"")?!1:aa(S,d,o,C==="country"?void 0:C)),p=m.useMemo(()=>{const C=g("win"),S=j=>C.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=j).length;return[S(0),S(7),S(30),C.length]},[u,d,o]),b=m.useMemo(()=>d.day?g("win").filter(C=>(C.date||"").slice(0,10)===d.day).length:0,[u,d,o]),v=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,h=v+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!f)return;const C=j=>{var M;(M=x.current)!=null&&M.contains(j.target)||s(!1)},S=j=>{j.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",C),document.addEventListener("keydown",S),()=>{document.removeEventListener("mousedown",C),document.removeEventListener("keydown",S)}},[f]);const N=(C,S,j,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===C,onClick:()=>r({type:"openFacet",facet:C}),children:[t.jsx("span",{className:"fl",children:S}),j>0&&t.jsx("span",{className:"n",children:j}),t.jsx("span",{className:"cv",children:"▾"})]},C),E=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(gl(d.day,c))}),t.jsx("b",{children:b})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((C,S)=>t.jsxs("button",{type:"button","aria-pressed":d.win===C,onClick:()=>r({type:"filters",patch:{win:C}}),children:[t.jsx("span",{className:"sl",children:i.dates[S]}),t.jsx("b",{children:p[S]})]},C))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:C=>r({type:"filters",patch:{search:C.target.value}})})]}),z=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",i.fSector,d.sector.length),N("pay",i.fCountry,d.country.length),N("det",i.fEngine,d.engine.length),N("sta",i.fStage,d.stage.length),o&&N("ang","Angle",d.angle.length),o&&N("mem","Mémo",d.memoLevel.length)]}),L=(C=!1)=>t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),C&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),q=t.jsxs("div",{className:"fmenu",ref:x,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{s(C=>!C),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:z})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(d.day?" noday":""),children:[!d.day&&t.jsx("div",{className:"fstrip-a",children:E}),t.jsxs("div",{className:"fstrip-b",children:[y,q,L(a.mapFolded)]})]}),a.openFacet&&t.jsx(rr,{poolFor:g})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[E,y,z,t.jsx("span",{className:"fgrow"}),L()]}),a.openFacet&&t.jsx(rr,{poolFor:g})]})}function rr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=a.filters,l=a.openFacet,{title:c,cols:d,options:f}=m.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(h=>Te(h)),b=new Map;p.forEach(h=>{const N=h.engine||"";b.set(N,(b.get(N)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...za([...b.keys()],i).map(h=>({v:h,label:ut(h)+" "+We(h,i),n:b.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const p=e("sector"),b=new Map;return p.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const p=e("country"),b=new Map;return p.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:Et(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const p=e("engine"),b=new Map;return p.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:za([...b.keys()],i).map(v=>({v,label:ut(v)+" "+We(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Bo(_o(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const p=e("angle"),b=new Map;return p.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const p=e("memoLevel"),b=new Map;p.forEach(h=>{if(h.kind==="target"){const N=Ga(h);b.set(N,(b.get(N)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:b.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),g=new Map;return u.forEach(p=>{p.stage&&g.set(p.stage,(g.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...g.entries()].sort((p,b)=>b[1]-p[1]).map(([p,b])=>({v:p,label:p,n:b,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),s=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:c}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:f.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>s(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Vr({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:c}=$(),d=m.useMemo(()=>{const g={};return r.forEach(p=>{aa(p,n.filters,o)&&(g.monde=(g.monde||0)+1,p.continent&&(g[p.continent]=(g[p.continent]||0)+1))}),g},[r,n.filters,o]),[f,s]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>{if(!f)return;const g=b=>{var v;(v=x.current)!=null&&v.contains(b.target)||s(!1)},p=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",g),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",g),document.removeEventListener("keydown",p)}},[f]);const u=g=>{const p=Qa.find(b=>b.key===g);return g==="monde"?c.contWorld:l==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>s(g=>!g),children:[u(n.continent),t.jsx("span",{className:"n",children:d[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:kn.map(g=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===g,onClick:()=>{i({type:"continent",key:g}),s(!1)},children:[u(g),t.jsx("span",{className:"n",children:d[g]||0})]},g))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?c.showMap:c.hideMap})]}):t.jsxs("div",{className:"conts",children:[kn.map(g=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===g,onClick:()=>i({type:"continent",key:g}),children:[u(g),t.jsx("span",{className:"n",children:d[g]||0})]},g)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?c.showMap:c.hideMap})})]})}function Wr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function bl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function or({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:c}=$();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:c.rsEvalOne})]},d.name))})]}):null}function Yr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=$(),i=((e==null?void 0:e.companies_cited)||[]).filter(c=>c&&(c.name||"").trim()).map(c=>({name:(c.name||"").trim(),line1:(c.what||"").trim(),line2:(c.role||"").trim(),chips:[(c.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(c=>c&&(c.name||"").trim()).map(c=>({name:(c.name||"").trim(),line1:(c.why||"").trim(),chips:[(c.country||"").trim(),(c.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(or,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(or,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function vl({card:e,onEvaluate:a,onAddAll:r}){var c,d,f;const{t:n}=$(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((c=e.prospective)==null?void 0:c.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Wr(e.summary_md||"").map((s,x)=>t.jsx("p",{children:s},x))})]}),t.jsx(Yr,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function yl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function wl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=$(),c=i,[d,f]=m.useState(null),[s,x]=m.useState(null),[u,g]=m.useState(null),[p,b]=m.useState(!1);m.useEffect(()=>{let h=!0;return(async()=>{const N=await fr({email:l,cbToken:c});h&&f(N)})(),()=>{h=!1}},[l,c,n]);const v=h=>{x(h),g(null),b(!0),(async()=>{const N=await Uo(h.id);g(N),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),g(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[yl(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(vl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Sa=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function kl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:c,evalCards:d,caps:f,data:s,canWrite:x,source:u,dossiers:g,doAnalyse:p,liveMemos:b,pipe:v}=$(),h=a==="client",N=m.useMemo(()=>r||(u!=="default"?Ho():""),[r,u]),[E,y]=m.useState(""),[z,L]=m.useState(!1),[q,C]=m.useState(""),[S,j]=m.useState(!1),[M,D]=m.useState(""),[A,R]=m.useState(!1),[w,O]=m.useState(""),[W,V]=m.useState([]),B=m.useRef(!1),[Y,Z]=m.useState(!1),[ee,oe]=m.useState(""),[I,ae]=m.useState(""),[se,ze]=m.useState(!1),[ve,qe]=m.useState(0),[ye,X]=m.useState(""),[U,K]=m.useState(null),[G,me]=m.useState(null),[ne,xe]=m.useState(!1),[ce,he]=m.useState(null),[Ge,Ke]=m.useState(0),Le=m.useRef(!1),Qe=E.trim()?Sa.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting,je=m.useMemo(()=>M.split(`
`).map(F=>F.trim()).filter(Boolean).slice(0,15),[M]);m.useEffect(()=>{if(typeof window>"u")return;const F=new URLSearchParams(window.location.search),te=(F.get("rs")||"").trim(),re=(F.get("rstext")||"").trim();te&&/^https?:\/\//i.test(te)&&oe(te),re&&ae(re),(te&&/^https?:\/\//i.test(te)||re)&&Z(!0)},[]),m.useEffect(()=>{const F=te=>{const re=te.detail||{},ue=String(re.url||"").trim(),Ae=String(re.text||"").trim();ue&&/^https?:\/\//i.test(ue)&&oe(ue),Ae&&ae(Ae),(ue&&/^https?:\/\//i.test(ue)||Ae)&&Z(!0)};return window.addEventListener("ppmap:research",F),()=>window.removeEventListener("ppmap:research",F)},[]),m.useEffect(()=>{const F=te=>{const re=te.detail||{},ue=String(re.name||"").trim();ue&&(y(ue),C(ue),L(!0),window.setTimeout(()=>L(!1),900))};return window.addEventListener("ppmap:prefill",F),()=>window.removeEventListener("ppmap:prefill",F)},[]),m.useEffect(()=>{if(typeof window>"u"||u!=="ops")return;const F=document.querySelector(".atl2.ops .eval-stick")||document.querySelector(".atl2.ops .demand"),te=document.querySelector(".atl2.ops");if(!F||!te)return;const re=()=>te.style.setProperty("--demand-h",`${F.offsetHeight}px`);re();const ue=new ResizeObserver(re);return ue.observe(F),()=>ue.disconnect()},[u,z,S,Y]),m.useEffect(()=>{if(!x&&!N){he(null);return}let F=!0;return(async()=>{const te=await fr({email:n,cbToken:N});F&&he(te.length)})(),()=>{F=!1}},[x,N,n,Ge]);const Xe=W.length?W:d,Me=s.credits,T=m.useCallback(F=>{const te=F.map(re=>(re||"").trim()).filter(Boolean);te.length&&(D(re=>{const ue=re.split(`
...
`)}),j(!0))},[]);m.useEffect(()=>{if(!se)return;qe(0);const F=window.setInterval(()=>qe(te=>te+1),1e3);return()=>window.clearInterval(F)},[se]);const H=m.useMemo(()=>{const F=E.trim().toLowerCase();return!F||!v?null:g.find(te=>_e(te.name)===F&&Ce(te)===1)||null},[E,g,v]),Q=()=>{const F=E.trim();if(F){if(H){p(H);return}i(null,F),h&&y("")}},de=async()=>{if(!h){i(null,je[0]||"");return}if(!je.length||A)return;R(!0),B.current=!1;const F=[];for(let te=0;te<je.length&&!B.current;te++){O(e.evaluating(te+1,je.length,je[te]));const re=await xr(r,je[te],"atelier2");if(F.unshift({name:re.company||je[te],verdict:re.verdict,reason:re.reason||"",remaining:re.remaining??null}),V([...F]),re.verdict==="quota"){F.unshift({name:"",verdict:"quota",reason:e.quota(je.length-te-1),remaining:0}),V([...F]),D(je.slice(te+1).join(`
`)),O(""),R(!1);return}}O(""),D(B.current?je.slice(F.length).join(`
`):""),R(!1)},Ee=async()=>{var re,ue,Ae;if(Le.current)return;const F=ee.trim().replace(/\s+/g,""),te=I.trim();if(!F&&!te){X(e.rsNeed);return}if(!h&&!N){i(null,F||te.slice(0,80));return}Le.current=!0,X(""),K(null),me(null),ze(!0);try{const Pe=await Wo({url:F,text:te,email:n,cbToken:N});if(ze(!1),!Pe||Pe.status!=="success"){X((Pe==null?void 0:Pe.message)||"Erreur");return}K(Pe),Z(!1),T((((re=Pe.prospective)==null?void 0:re.companies_to_evaluate)||[]).map(Be=>(Be==null?void 0:Be.name)||"")),me({state:"pending"});const we=await Yo(Pe,{email:n,cbToken:N});me(we.ok?{state:"ok",scopeLabel:((ue=we.summary)==null?void 0:ue.scope_label)||"",scope:((Ae=we.summary)==null?void 0:Ae.scope)||""}:{state:"fail",msg:we.error||""}),we.ok&&Ke(Be=>Be+1)}finally{Le.current=!1,ze(!1)}},pe=[U==null?void 0:U.industry,...(U==null?void 0:U.market_tags)||[],U==null?void 0:U.author].map(F=>(F||"").trim()).filter(Boolean),Fe=(G==null?void 0:G.state)==="pending",nt=G&&(Fe?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):G.state==="ok"?t.jsx("span",{className:"rslink ok",children:G.scope&&G.scope!=="public"?e.rsSavedIn(G.scopeLabel||G.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:G.msg,children:e.rsSaveFail})),gt=bl(U).length;return t.jsxs("div",{className:"demand"+(q&&E.trim()===q||z?" pair":"")+(z?" echo":""),children:[t.jsxs("div",{className:"drow"+(z?" flash":"")+(Sa.test(E.trim())?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:E,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:F=>{y(F.target.value),q&&F.target.value.trim()!==q&&C("")},onKeyDown:F=>{F.key==="Enter"&&Q()}}),t.jsx("span",{className:"detect"+(Sa.test(E.trim())?" url":""),children:Qe})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(H?" analyse":"")+(c?" loading":""),disabled:c,onClick:Q,children:[t.jsx("span",{className:"fill"}),H?e.actAnalyse:e.evalGo]}),f.showCredits&&Me&&t.jsxs("button",{type:"button",className:"credits"+(Me.total_available<=0&&!Me.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Me.unlimited?"∞":Me.total_available}),!Me.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Me.daily_grant+Me.purchased]}),Me.total_available<=0&&!Me.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(F=>F.status==="boot"||F.status==="running").map(F=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:F.name}),t.jsx(Rt,{item:F,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+F.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>j(!S),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(Y?" on":""),onClick:()=>Z(!Y),children:e.rsOpen}),ce!==null&&ce>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ne?" on":""),onClick:()=>xe(!ne),children:e.rsArchOpen(ce)})]}),ne&&t.jsx(wl,{bump:Ge,cbToken:N,onClose:()=>xe(!1),onEvaluate:F=>i(null,F),onAddAll:T}),Y&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:ee,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:F=>oe(F.target.value),onKeyDown:F=>{F.key==="Enter"&&Ee()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:I,placeholder:e.rsTextPh,onChange:F=>ae(F.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(se?" loading":""),style:{justifyContent:"center"},disabled:se||Fe||!ee.trim()&&!I.trim(),onClick:()=>{Ee()},children:[t.jsx("span",{className:"fill"}),se?`${Vo(ee.trim())==="youtube"&&ee.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ve)}`:Fe?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),ye&&t.jsx("div",{className:"rserr",children:ye}),U&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:U.title}),U.source_url&&t.jsx("a",{href:U.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{K(null),me(null)},children:"×"})]}),U.market&&t.jsx("p",{className:"rsmk",children:U.market}),pe.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),pe.map(F=>t.jsx("span",{children:F},F))]}),t.jsxs("div",{className:"rsbody",children:[U.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${U.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Wr(U.summary_md||"").map((F,te)=>t.jsx("p",{children:F},te))})]}),t.jsx(Yr,{card:U,onEvaluate:F=>i(null,F),onAddAll:T}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(gt)}),nt]})]}),S&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:M,placeholder:e.bulkPh,onChange:F=>D(F.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(A?" loading":""),style:{justifyContent:"center"},disabled:A||!je.length,onClick:()=>{de()},children:[t.jsx("span",{className:"fill"}),A&&w?w:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(je.length)})]})]}),Xe.slice(0,1).map((F,te)=>{const re=F.verdict==="kept",ue=F.verdict==="quota",Ae=re?"var(--brand)":ue?"var(--bolt)":"var(--red)",Pe=re?"var(--brand-l)":ue?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ae,"--bgc":Pe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:re?"✓ "+e.kept:ue?"⏳":"✗ "+e.dropped})}),F.name&&t.jsx("span",{className:"rn",children:F.name}),t.jsx("span",{className:"rr",children:F.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",F.reason]}):null}),!!(F.candidates&&F.candidates.length)&&t.jsx("span",{className:"sitepick",children:F.candidates.map(we=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:we.url.startsWith("http")?we.url:`https://${we.url}`,target:"_blank",rel:"nofollow noopener",children:[(we.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,we.url),children:e.evalPickGo})]},we.url))}),!ue&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:re?1:5});const we=(F.name||"").trim().toLowerCase();window.setTimeout(()=>{const Be=[...document.querySelectorAll(".atl2 .list .row")].find(fa=>{var Bt;return(((Bt=fa.querySelector(".rnm"))==null?void 0:Bt.textContent)||"").trim().toLowerCase().includes(we)});Be&&(Be.scrollIntoView({behavior:"smooth",block:"center"}),Be.classList.add("flashrow"),window.setTimeout(()=>Be.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(re?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},te)}),h&&(o.kept+o.dropped>0||Xe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function jl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Nl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=$(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",jl(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const c=st(o),d=Ga(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),c&&t.jsx("span",{className:"vv",children:c}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((f,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[wt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function rn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=$(),[l,c]=m.useState(!1),[d,f]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,x=async()=>{if(!s||l)return;c(!0);const u=await Go(r,e);if(c(!1),!u){o(a.actErr);return}f(u.results||[])};return m.useEffect(()=>{if(!s)return;const u=g=>{var b;const p=String(((b=g.detail)==null?void 0:b.name)||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,s]),m.useEffect(()=>{if(s)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{x()},children:l?a.similarBusy:a.similar}),d&&(d.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:d.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Sl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Xt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function El(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Xt(a.slice(n));break}r+=Xt(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Xt(a.slice(i));break}const l=a.slice(i+1,o).trim(),c=/^(\/?)([a-zA-Z0-9]+)/.exec(l),d=c?c[2].toLowerCase():"";c&&Sl.has(d)?r+=`<${c[1]}${d}>`:r+=Xt(a.slice(i,o+1)),n=o+1}return r}const ir=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Oe({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Cl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function zl({o:e}){const{t:a,doDeep:r}=$(),[n,i]=m.useState(!1),o=st(e),l=[e.reasoning||"",Cl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((c,d)=>t.jsx("p",{className:"cdtxt",children:c},d)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[wt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:c=>{c.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:c=>{c.stopPropagation(),i(d=>!d)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:c=>c.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:c=>c.stopPropagation()})]})}function on({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=$(),o=It(e),l=st(e),c=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(c?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||wt(e)?1:0}].filter(b=>b.n>0),[e,a,c,l,d,f,s]),[u,g]=m.useState("");if(!x.length)return null;const p=x.some(b=>b.k===u)?u:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===b.k,"data-tour":"tab-"+b.k,className:p===b.k?"on":"",onClick:v=>{v.stopPropagation(),g(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[c&&t.jsxs("div",{className:"cdv1"+(c==="NO MATCH"?" out":""),children:[t.jsx("b",{children:c==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Oe,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Oe,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Oe,{k:a.cdVerdictDate,v:ir(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:El(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Al,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Oe,{k:a.cdSector,v:e.sector}),t.jsx(Oe,{k:a.cdStage,v:e.stage}),t.jsx(Oe,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Oe,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Oe,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Oe,{k:a.cdAngle,v:e.angle}),t.jsx(Oe,{k:a.cdDetected,v:ir(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Oe,{k:a.cdName,v:e.contactName}),t.jsx(Oe,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Oe,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(zl,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Oe,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Oe,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Al({o:e}){const{t:a,token:r}=$(),[n,i]=m.useState(!1),[o,l]=m.useState(null),c=async()=>{n||(i(!0),l(await Ko(r,e.name,e.website||e.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],s=f.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{c()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[f.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function $t({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const c=()=>{const f=Math.max(280,Math.min(560,o.clientWidth||320));jn({kind:"op",card:e},f).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},d=window.requestAnimationFrame(c);return()=>{l=!0,window.cancelAnimationFrame(d),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;jn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(d=>{!l&&d&&o.isConnected&&o.replaceChildren(d)});const c=d=>{d.key==="Escape"&&i(!1)};return document.addEventListener("keydown",c),()=>{l=!0,document.removeEventListener("keydown",c)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&St.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Tl=`
...
`;function ql(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let c=e.y+10;return c+n>o-8&&(c=Math.max(8,e.y-n-14)),c<8&&(c=8),{left:l,top:c}}function Ll(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:c,doAnalyse:d,doDecide:f,doPromote:s,doRepeche:x,doApproach:u,doDeep:g,doOnboard:p,outbound:b,evalBusy:v}=$(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const N=Te(h),E=Ce(h),y=st(h),z=It(h),L=h.kind==="target",q=C=>{a({type:"filters",patch:C}),a({type:"popup",id:null})};return St.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Tl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:ql(e.popupAnchor,!!h.card),onClick:C=>C.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(it(h.date)),We(h.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>q({country:[h.cc]}),children:(Et(h.cc,i)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>q({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>q({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:Ct(h.amountEur,i)})]}),o.pipe&&L&&t.jsxs("div",{className:"pstat",children:[z&&t.jsx("span",{className:"vd "+(z==="MATCH"?"v-ok":"v-no"),title:n.vt[z],children:z}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[ut(h.engine)," ",t.jsx("b",{children:We(h.engine,i)})," — ",Qo(h.engine,i),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),N?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(xt,{o:h,lg:!0})," ",t.jsx(ma,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Ja(N,i))," · ",n.win7(ta(N,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx($t,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),o.pipe&&L&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),o.pipe&&L&&t.jsx(on,{o:h})]}),t.jsx(rn,{name:h.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>c(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(h,!1),a({type:"popup",id:null})},children:n.actNo}),wt(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{g(h),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var C;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(C=document.querySelector(".atl2 .demand"))==null||C.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(h.name),onClick:()=>c(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>c(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}const Ml=8;function Rl(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=$(),[c,d]=m.useState(!1),[f,s]=m.useState(!1),[x,u]=m.useState(!1),g=`atl2:sincemini:${r||"home"}`,[p,b]=m.useState(()=>{try{return localStorage.getItem(g)==="1"}catch{return!1}}),v=()=>{b(C=>{try{localStorage.setItem(g,C?"0":"1")}catch{}return!C})},h=r||"home",{names:N,verdicts:E}=m.useMemo(()=>{const C=[],S={};return n.forEach(j=>{j.kind!=="target"||!j.name||(C.push(j.name),S[j.name]=Jo(j)||"")}),{names:C,verdicts:S}},[n]),y=m.useMemo(()=>N.length?Xo(h,N,E,a):null,[h,N.length]);if(!i.pipe||c||!y||y.firstVisit||!y.added.length&&!y.gone.length)return null;const z=f?y.added:y.added.slice(0,Ml),L=y.added.length-z.length,q=C=>{const S=n.find(j=>j.name===C);S&&(o(S.id),l({type:"popup",id:S.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(y.added.length,y.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:v,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{d(!0),Zo(h,N,E,y.fp,a)},children:"×"})]}),!!y.added.length&&t.jsxs("div",{className:"sg-c",children:[z.map(C=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>q(C),children:t.jsx("b",{children:C})},C)),L>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>s(!0),children:e.sinceMore(L)})]}),!!y.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(C=>!C),children:e.sinceOut(y.gone.length)}),x&&y.gone.slice(0,20).map(C=>t.jsx("span",{className:"gone",children:C},C))]})]})}const Gr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function sn({o:e,locked:a=!1}){const{t:r}=$(),n=It(e),i=st(e),o=Ce(e),l=Ca(e),c=ti(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(Gr[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&c!==null&&t.jsx("span",{className:"wait2 "+(c>10?"hot":c>=5?"warm":""),title:r.waitTitle(c),children:r.waitChip(c)}),!a&&t.jsx(ds,{o:e})]})}const Nt=e=>e.length>22?e.slice(0,21)+"…":e,Ol=new Set(["media","nominations","recrutements"]);function ln(e){return Ol.has(e.engine||"")}function Kr(e){return!!e.noCo||ln(e)&&!!e.url}function ua(e){var n;const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(i=>i&&i!==e.name).join(`
`);if(!(!a&&!r)){try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}(n=document.querySelector(".atl2 .demand"))==null||n.scrollIntoView({behavior:"smooth",block:"start"})}}function sr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=$(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),De(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Nt(e.name))})]})}function cn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:c,doRepeche:d,doApproach:f,dispatch:s,liveMemos:x}=$();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p=>{p.stopPropagation(),s({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),ua(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return ln(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),ua(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(sr,{o:e})});const u=Ce(e),g=p=>b=>{b.stopPropagation(),p()};if(u===0)return t.jsx("span",{className:"cell",children:t.jsx(sr,{o:e})});if(u===1){const p=x.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Rt,{item:p,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:g(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:g(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:g(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(u===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:g(()=>f(e)),children:p?a.actApproachSent:a.actApproach})})}return u===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:g(()=>c(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):u===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:g(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:g(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Fl({o:e}){const{t:a,doThumb:r,thumbOf:n}=$(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Pl({o:e}){const{lang:a}=$();return Te(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(xt,{o:e}),t.jsx(ma,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[ut(e.engine||"")," ",We(e.engine||"",a)]})})}function Dl({o:e,locked:a,open:r,onToggle:n,selected:i,echo:o,onSelect:l}){const{dispatch:c,caps:d,markRow:f,markedId:s,favIds:x,toggleFav:u,t:g}=$(),p=Ce(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],v=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,h=v<=0?0:v<=7?1:v<=30?2:3,N=d.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][p]:b[h],E=x.has(e.id),y=z=>{if(a)return;if(l){l(e.id);return}if(d.pipe||e.kind==="op"){n();return}const L=z.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:L.left+Math.min(280,L.width/3),y:L.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(o?" echo":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>f(e.id),onMouseLeave:()=>f(null),onClick:y,children:[t.jsx("span",{className:"pt",style:{"--c":N}}),t.jsx(eo,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[d.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:E?1:.35,padding:0,marginRight:4},onClick:z=>{z.stopPropagation(),u(e)},children:E?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(z=>z&&z!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:g.acqSee(e.acquirer),onClick:z=>{z.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",Nt(e.acquirer)]}),pt(e)?t.jsx("span",{className:"rdec",title:g.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:g.zoomNewsMark,children:"📰"}):null]}),t.jsx(Il,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Pl,{o:e}),d.pipe&&t.jsx(sn,{o:e,locked:a}),d.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(cn,{o:e}),d.showThumbs&&t.jsx(Fl,{o:e})]}),r&&!a&&!l&&t.jsx(_l,{o:e})]})}function Il({o:e}){const{lang:a,caps:r}=$();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ct(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function $l({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=$(),l=(u,g=!1)=>p=>{p.stopPropagation(),g&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},c=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),d=Ct(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=De(e),x=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Kr(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),ua(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Nt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Nt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(c?` · ${c}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx($t,{spec:e.card})})]})}function Bl({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=$();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[We(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(cn,{o:e})}),t.jsx(on,{o:e})]})}function Qr({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:c,dossiers:d}=$();if(!e&&!a){const A=d.find(pt);if(A)return t.jsx(Qr,{o:A})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),s=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),x=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),g=e?!!e.noCo:!f||Xa(f),p=(e==null?void 0:e.engine)||"",b=pt(e),v=e?Ct(e.amountEur,n):"",h=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),N=(()=>{const A=/https?:\/\/(?:www\.)?([^/]+)/.exec(s);return A?A[1].replace(/^www\./,"").slice(0,40):""})(),E=d.find(pt),y=((E==null?void 0:E.url)||"").trim(),z=!!s&&!!y&&(s===y||s.endsWith(y)||y.endsWith(s)),L=(A,R=!1)=>w=>{w.stopPropagation(),R&&l({type:"continent",key:"monde"}),l({type:"filters",patch:A})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const q=()=>{f&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:f}}))},C=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},S=()=>{ua({url:s,headline:x,tagline:e==null?void 0:e.tagline,name:f})},j=e?De(e):!1,M=j&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",D=b?r.doEdito.replace(/^📖\s*/,""):p?We(p,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[D,h?` · ${h}`:""]}),t.jsx("h3",{className:"zoom-h",children:x}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{className:"ed-decrypt-b zoom-body",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),v&&t.jsx("span",{className:"oc-amt",children:v})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx($t,{spec:u})}),(s&&!z||y)&&t.jsxs("div",{className:"zoom-srcbox",children:[s&&!z&&t.jsxs("a",{className:"zoom-src",href:s,target:"_blank",rel:"nofollow noopener",onClick:A=>A.stopPropagation(),children:[r.zoomSrc,N?` · ${N}`:""," ↗"]}),y&&t.jsxs("a",{className:"zoom-src zoom-src-art",href:y,target:"_blank",rel:"noopener noreferrer",onClick:A=>A.stopPropagation(),children:[r.zoomArt," ↗"]})]}),t.jsxs("div",{className:"zoom-acts",children:[j?t.jsxs("span",{className:"verdict",style:{"--c":M?"var(--brand)":"var(--red)"},children:[M?"✓":"✗"," ",t.jsx("b",{children:M?r.kept:r.dropped})]}):!g&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:o,onClick:A=>{A.stopPropagation(),i(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Nt(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,s&&(g||ln({engine:p}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!g&&f?" ghost":""),onClick:A=>{A.stopPropagation(),S()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!g&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!c.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:A=>{A.stopPropagation(),C()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:A=>{A.stopPropagation(),q()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Nt(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!g&&f&&c.pipe&&t.jsx(rn,{name:f})]})]})}function _l({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=$();return!i.pipe&&e.kind==="op"?t.jsx($l,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(on,{o:e}),t.jsx(ps,{o:e}),t.jsx(fs,{o:e}),t.jsx(rn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(sn,{o:e})})]}),e.card&&t.jsx($t,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[ut(e.engine||"")," ",We(e.engine||"",r)]}),Te(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(xt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Ul({o:e,locked:a,selected:r,onSelect:n}){const{t:i,dispatch:o,caps:l,doDecide:c,lang:d}=$();if(!l.pipe&&e.kind==="op"){const x=Ct(e.amountEur,d),u=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),g=(p,b=!1)=>v=>{v.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx($t,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:g({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:g({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:g({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[ut(e.engine||"")," ",We(e.engine||"",d)]}),Te(e)&&t.jsx(xt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(d==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(cn,{o:e})})]})}const f=Ce(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][f];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(sn,{o:e}),Te(e)&&t.jsx(xt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&f===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>c(e,!0),children:i.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>c(e,!1),children:i.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>o({type:"memoConsole",id:e.id}),children:[i.actMemo," →"]})]})}function Hl(){const{t:e}=$(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Vl({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=i==="en",l=s=>n.plabels[s]||"",c=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),d=c.includes(0)?0:c.sort((s,x)=>(e[x]||0)-(e[s]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${l(d)}”`:`${f} dossier${f>1?"s":""} dans « ${l(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(o?"Open ":"Ouvrir ")+l(d)," →"]})]})}function Wl(){var Xe,Me;const e=$(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:c,markRow:d,lang:f,sessTally:s,data:x,dossiers:u,source:g,focusExtra:p,byId:b}=e,v=T=>i.lockRowsAfter!==null||g==="ops"?Number.MAX_SAFE_INTEGER:gr,[h,N]=m.useState(new Set);m.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[E,y]=m.useState(null);m.useEffect(()=>{y(null)},[a.ptab,a.continent]);const[z,L]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){L(!1);return}const T=document.getElementById("atl2-stage");if(!T){L(!1);return}const H=new IntersectionObserver(([Q])=>L(!!Q&&Q.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return H.observe(T),()=>H.disconnect()},[a.mapFolded]);const q=a.mapFolded||!z,C=T=>N(H=>{const Q=new Set(H);return Q.has(T)?Q.delete(T):Q.add(T),Q}),S=g==="ops"||i.pipe,[j,M]=m.useState("all"),[D,A]=m.useState(null),[R,w]=m.useState(!1),O=m.useRef(!0);m.useEffect(()=>{if(O.current){O.current=!1;return}M("all"),w(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!R)return;const T=H=>{var Q,de;(de=(Q=H.target)==null?void 0:Q.closest)!=null&&de.call(Q,".atl2 .doable")||w(!1)};return document.addEventListener("click",T),()=>document.removeEventListener("click",T)},[R]);const W=vr(),V=m.useMemo(()=>{var H;const T=new Map;for(const Q of Ji(((H=W==null?void 0:W.ed)==null?void 0:H.html)||""))T.has(Q.t)||T.set(Q.t,Q.html);return T},[(Xe=W==null?void 0:W.ed)==null?void 0:Xe.html]),B=m.useCallback(T=>{if(T.decryptHtml)return T.decryptHtml;if(!V.size)return;const H=(T.name||"").trim().toLowerCase();if(H.length<3)return;const Q=V.get(H);if(Q)return Q;for(const[de,Ee]of V)if(de.includes(H)||H.includes(de))return Ee},[V]),Y=m.useMemo(()=>{let T=Za(l,a.sort);return T=T.filter(H=>!pt(H)),j==="explore"?T=T.filter(Kr):j==="eval"&&(T=T.filter(H=>!H.noCo)),T},[l,a.sort,j,B]),Z=m.useMemo(()=>i.pipe?c.filter(T=>Te(T)&&ei(T)):Y.filter(T=>Te(T)&&!De(T)),[i.pipe,c,Y]),ee=Z.length,[oe,I]=m.useState(!1),[ae,se]=m.useState(!1),ze=`atl2:sigmini:${((Me=x.session)==null?void 0:Me.token)||"home"}`,[ve,qe]=m.useState(()=>{try{return localStorage.getItem(ze)==="1"}catch{return!1}}),ye=m.useMemo(()=>i.pipe?Y:Y.filter(T=>!De(T)&&!T.noCo),[Y,i.pipe]),X=g==="ops"?Y.filter(T=>T.noCo).length:0,U=i.pipe?n.plabels[a.ptab].toLowerCase():g==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,K=a.filters,G=[];if(K.day)G.push({k:"day",lib:n.fDay(K.day.slice(8,10)+"/"+K.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(K.win&&K.win!=="all"){const T=["1","7","30"].indexOf(K.win);T>=0&&G.push({k:"win",lib:n.dates[T],off:()=>r({type:"filters",patch:{win:"all"}})})}const me=T=>T.length<=2?T.join(", "):`${T.length} ${n.fSelected}`;for(const T of["sector","country","engine"]){const H=K[T];H&&H.length&&G.push({k:T,lib:me(H),off:()=>r({type:"clearFacet",facet:T})})}K.search&&G.push({k:"search",lib:"🔍 "+K.search,off:()=>r({type:"filters",patch:{search:""}})});const ne=(T,H,Q="",de=!1)=>t.jsxs("button",{type:"button","data-s":T,className:Q,"aria-sort":a.sort.key===T?a.sort.dir===1?"ascending":"descending":"none",style:de?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:T}),children:[H,t.jsx("span",{className:"ar",children:a.sort.key===T&&a.sort.dir===1?"▴":"▾"})]},T),xe=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const T=new Map;Y.forEach(de=>{const Ee=de.engine||"?";T.has(Ee)||T.set(Ee,[]),T.get(Ee).push(de)});const H={ma:0,fundraising:1,nominations:2,media:3,recrutements:4,edito:5},Q=za([...T.keys()],f);return[...T.entries()].sort((de,Ee)=>{const pe=H[de[0]]??10+Q.indexOf(de[0]),Fe=H[Ee[0]]??10+Q.indexOf(Ee[0]);return pe-Fe})},[Y,i.pipe,a.groupBy,f]),ce=(()=>{var H;return((H=(xe?xe.flatMap(([,Q])=>Q):Y)[0])==null?void 0:H.id)??null})();m.useEffect(()=>{if(!a.focusId)return;A(a.focusId);const T=window.setTimeout(()=>A(null),900);return()=>window.clearTimeout(T)},[a.focusId]),m.useEffect(()=>{S&&(a.focusId&&(Y.some(T=>T.id===a.focusId)||u.some(T=>T.id===a.focusId))||p||ce&&r({type:"focus",id:ce}))},[S,a.focusId,Y,ce,p,r,u]),m.useEffect(()=>{!S||!a.focusId||j!=="all"&&!Y.some(T=>T.id===a.focusId)&&u.some(T=>T.id===a.focusId)&&M("all")},[S,a.focusId,j,Y,u]),m.useEffect(()=>{if(!S||!a.focusId)return;const T=document.querySelector(".atl2.ops .row.sel");T==null||T.scrollIntoView({block:"nearest"})},[S,a.focusId]);const he=m.useMemo(()=>{if(!S||!a.focusId)return null;const T=Y.find(Q=>Q.id===a.focusId)||u.find(Q=>Q.id===a.focusId)||null;if(!T)return null;const H=B(T);return H&&H!==T.decryptHtml?{...T,decryptHtml:H}:T},[S,a.focusId,Y,u,B]),Ge=i.lockRowsAfter;let Ke=0;const Le=(T,H)=>{let Q=a.shown[H]||v();return T.length-Q<=4&&(Q=T.length),T.slice(0,Q).map(pe=>{const Fe=Ge!==null&&Ke>=Ge;Ke++;const nt=B(pe),gt=nt&&nt!==pe.decryptHtml?{...pe,decryptHtml:nt}:pe,F=!S&&a.dens!=="maxi"&&(a.dens==="deplie"||(E?E==="open":!!nt)),te=h.has(pe.id)?!F:F,re=S?ue=>{r({type:"focus",id:ue});const Ae=b.get(ue);Ae&&!Ae.noCo&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ae.name}}))}:void 0;return a.dens==="maxi"?t.jsx(Ul,{o:gt,locked:Fe,selected:S&&a.focusId===pe.id,onSelect:re},pe.id):t.jsx(Dl,{o:gt,locked:Fe,open:te,onToggle:()=>C(pe.id),selected:S&&a.focusId===pe.id,echo:D===pe.id,onSelect:re},pe.id)})},Qe="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(g==="ops"?" opsl":"")+(Y.length?"":" list-empty"),je=t.jsxs(t.Fragment,{children:[xe?xe.map(([T,H])=>t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:ut(T)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:T==="ma"?n.grpMa:T==="fundraising"?n.grpLev:T==="nominations"?n.grpNom:T==="media"?n.grpNewsOther:T==="recrutements"?n.grpHire:We(T,f)}),t.jsx("div",{className:"s",children:n.grpCount(H.filter(Q=>!De(Q)).length,H.length)})]})]}),Le(H,T)]},T)):Le(Y,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(Hl,{}),!Y.length&&!(x.loading&&!u.length)&&(i.pipe?t.jsx(Vl,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(q?" mapoff":""),children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:Y.length})," ",U]}),t.jsx("span",{className:"dot",children:"·"}),q&&t.jsx(Vr,{variant:"compact",mapToggle:!0}),t.jsxs("span",{className:"ctx",children:[q?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),G.map(T=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:H=>{H.stopPropagation(),T.off()},children:[T.lib,t.jsx("i",{children:"×"})]},T.k)),g==="ops"&&Y.length>0&&" — "+n.edSplit(Y.length-X,X)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||g==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([T,H])=>t.jsxs("button",{type:"button","data-d":T,"aria-pressed":a.dens===T||T==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:T}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:H})]},T))}),!S&&i.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":E==="open",onClick:()=>{y("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":E==="closed",onClick:()=>{y("closed"),N(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||g==="ops")&&(()=>{var Q;const T=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],H=((Q=T.find(([de])=>de===j))==null?void 0:Q[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":R,onClick:()=>w(de=>!de),children:[H,t.jsx("i",{children:"▾"})]}),R&&t.jsx("div",{className:"dolist",children:T.map(([de,Ee])=>t.jsx("button",{type:"button","aria-pressed":j===de,onClick:()=>{M(de),w(!1)},children:Ee},de))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:T=>r({type:"sort",key:T.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([T,H])=>t.jsx("option",{value:T,children:H},T))})]}),i.showChain&&ye.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:ye.map(T=>T.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(ye.length):n.chainAll(ye.length)]}),q&&t.jsx(Hr,{compact:!0})]}),t.jsx(Rl,{}),ee>0&&!a.filters.signalOnly&&!ae&&t.jsxs("div",{className:"sigstrip"+(ve?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(ee)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!ve,title:ve?n.boxExpand:n.boxCollapse,onClick:()=>qe(T=>{try{localStorage.setItem(ze,T?"0":"1")}catch{}return!T}),children:ve?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>se(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(oe?Z:Z.slice(0,12)).map(T=>{const H=Te(T);return H?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(Ja(H,f),ta(H,f)),onClick:()=>{d(T.id),r({type:"popup",id:T.id})},children:[t.jsx("b",{children:T.name}),t.jsxs("i",{children:[H.emoji," ",Aa(H,f)]}),t.jsx("em",{children:ta(H,f)})]},"sg-"+T.id):null}),!oe&&Z.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>I(!0),children:n.sigStripMore(Z.length-12)})]})]}),a.dens!=="maxi"&&!S&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ne("country",n.colCountry),ne("name",n.colCompany),ne("amount",n.colAmount,"h-amt",!0),ne("stage",n.colStage,"h-stade"),ne("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ne("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ne("memo",n.colMemo)]}),i.pipe&&ne("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),S?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ne("country",n.colCountry),ne("name",n.colCompany),ne("amount",n.colAmount,"h-amt",!0),ne("stage",n.colStage,"h-stade"),ne("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:Qe,children:je})]}),t.jsx("aside",{className:"readpane","aria-label":f==="fr"?"Dossier":"File",children:i.pipe?t.jsx(Bl,{o:he}):t.jsx(Qr,{o:he,extra:he?null:p})})]}):t.jsx("div",{className:Qe,children:je}),(()=>{const T=xe||[["pt"+a.ptab,Y]];let H=0,Q=0;for(const[Ee,pe]of T){Q+=pe.length;let Fe=a.shown[Ee]||v();pe.length-Fe<=4&&(Fe=pe.length),H+=Math.min(pe.length,Fe)}const de=Q-H;return de<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>T.forEach(([Ee,pe])=>r({type:"more",group:Ee,by:pe.length,base:v()})),children:[t.jsx("span",{className:"more-label",children:n.more(de,de)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(H,Q)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}})]})}function lr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Yl(e,a){const r=ai(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Gl(e,a){const n=[a.head.split("|").map(lr).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",Yl(i,a.plabels),It(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(lr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Kl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Ql=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function et({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Jl({o:e,qa:a}){const{t:r,lang:n,fund:i}=$(),o=(e.cribleStatus||"").trim().toUpperCase()||(It(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=st(e),c=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,c.value_prop],[r.qaProduct,c.produit],[r.qaModel,c.modele],[r.qaSummary,c.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(et,{k:r.cdSector,v:e.sector}),t.jsx(et,{k:r.cdStage,v:e.stage}),t.jsx(et,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(et,{k:r.cdSite,v:e.domain||e.website}),t.jsx(et,{k:r.cdName,v:e.contactName}),t.jsx(et,{k:r.cdEmail,v:e.contactEmail}),t.jsx(et,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(et,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(et,{k:r.cdAngle,v:e.angle}),t.jsx(et,{k:r.cdDetected,v:Ql(e.date,n)})]}),d.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,f])=>f).map(([f,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:s})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Xl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=$(),[c,d]=m.useState({}),f=25,s=m.useMemo(()=>n.slice(0,f),[n]);m.useEffect(()=>{s.length&&ni(r,s.map(g=>g.name)).then(d)},[r,s]);const x=o.stats,u=g=>g.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(x.screened/o.marketEstimate*100)," %"]})]})]}),s.map(g=>t.jsx(Jl,{o:g,qa:c[g.name]},g.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Zl=50;function dn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=$(),[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(0),[g,p]=m.useState(""),[b,v]=m.useState(!1),h=m.useRef(null);m.useEffect(()=>()=>{h.current&&window.clearInterval(h.current)},[]);const N=async y=>{d(!0),s("");const z=await a();if(d(!1),z.ok){l(z);return}if(z.busy){s(i.alertPreviewBusy);return}if(!y){s(i.alertPreviewFail);return}u(Zl),h.current=window.setInterval(()=>{u(L=>L>1?L-1:(h.current&&window.clearInterval(h.current),N(!1),0))},1e3)},E=async()=>{if(n||b)return;v(!0),p("");const y=await r();v(!1),p(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||x>0,onClick:()=>{N(!0)},children:c?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{E()},children:b?"…":i.alertTest})]}),x>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(x)}),f&&t.jsx("p",{className:"mnote warn",children:f}),g&&t.jsx("p",{className:"mnote",children:g}),!g&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const yt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ie({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=$();return St.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function ec(){const{st:e}=$();switch(e.modal){case"chain":return t.jsx(ac,{});case"space":return t.jsx(nc,{});case"alert":return t.jsx(rc,{});case"queue":return t.jsx(cc,{});case"export":return t.jsx(dc,{});case"plug":return t.jsx(mc,{});case"recharge":return t.jsx(xc,{});case"cover":return t.jsx(gc,{});case"dossier":return t.jsx(hc,{});case"crit":return t.jsx(bc,{});case"tuto":return t.jsx(vc,{});case"rdv":return t.jsx(tc,{});case"memoalert":return t.jsx(pc,{});default:return null}}function tc(){const{dispatch:e,fund:a,t:r}=$(),n=a||r.rdvCoFallback;return St.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:kr,children:tn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${na}`,children:na})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(zi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function ac(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:c,caps:d,memoQueued:f,doAnalyse:s}=$(),x=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),g=e.chain.idx,p=u[g],b=g>=u.length;return St.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${g+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:g/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[Et(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(it(p.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:We(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:Ct(p.amountEur,i)})]}),Te(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(xt,{o:p,lg:!0})," ",t.jsx(ma,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),x&&De(p)&&t.jsxs("div",{className:"vbox",style:{"--c":dt(p)==="retenu"?"var(--brand)":dt(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:dt(p)==="retenu"?"✓ "+n.kept:dt(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&p&&d.pipe&&Ce(p)===1&&!f.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&p&&!(x&&De(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:c,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function nc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=$(),o=i==="client",l=m.useMemo(()=>o?r.filter(x=>De(x)):[],[r,o]),c=m.useMemo(()=>Za(l.filter(x=>dt(x)==="retenu"),{key:"signal",dir:-1}),[l]),d=m.useMemo(()=>l.filter(x=>dt(x)==="ecarte"),[l]),f=e.spaceTab==="retenu"?c:d,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ie,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:c.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function rc(){const{mode:e}=$();return e==="client"||e==="apercu"?t.jsx(oc,{}):t.jsx(lc,{})}function oc(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),[o,l]=m.useState("d"),c=i!=="client";return t.jsxs(Ie,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(ic,{t:e,token:a,readOnly:c,flash:r,flashErr:n}),o==="w"&&t.jsx(sc,{t:e,token:a,readOnly:c,flash:r,flashErr:n}),o==="m"&&t.jsx(Jr,{})]})}function ic({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return d(!1),En(a).then(b=>{p&&(b?l(b):d(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||En(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(c)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),g=p=>{const b=o.sections||e.alertSec.map(([v])=>v);x({sections:u(p)?b.filter(v=>v!==p):[...b,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>g(p)}),t.jsxs("span",{children:[b,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(dn,{label:e.alertPreview,readOnly:r,onPreview:()=>mi(a),onTest:()=>ui(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function sc({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return d(!1),Cn(a).then(b=>{p&&(b?l(b):d(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||Cn(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(c)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,g=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>x({dow:Number(p.target.value)}),children:e.alertDow.map((p,b)=>t.jsx("option",{value:b,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,g-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[g," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,g+1)}),disabled:r,children:"＋"})]})]}),t.jsx(dn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>xi(a),onTest:()=>fi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Jr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=$(),[l,c]=m.useState(o||""),[d,f]=m.useState(!1),[s,x]=m.useState(!1);m.useEffect(()=>{o&&c(o)},[o]);const u=e.filters,g=m.useMemo(()=>n.filter(h=>Te(h)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){x(!0);try{await fetch(`${Ya}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{x(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>We(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>Et(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([h,N])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:N}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:h=>c(h.target.value),onKeyDown:h=>{h.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,g)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function lc(){const{t:e}=$();return t.jsx(Ie,{title:e.alertTitle,icon:"🔔",children:t.jsx(Jr,{})})}function cc(){var C,S;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:c,dispatch:d,liveMemos:f}=$(),[s,x]=m.useState(null),[u,g]=m.useState([]),[p,b]=m.useState(0),v=n==="client",h=m.useMemo(()=>{const j=new Map;return i.forEach(M=>{const D=(M.name||"").trim().toLowerCase();D&&!j.has(D)&&j.set(D,M)}),j},[i]);m.useEffect(()=>{let j=!0;return(async()=>{const[M,D]=await Promise.all([Ka(r),mr(a)]);j&&(M&&x(M),g(D))})(),()=>{j=!1}},[a,r,p]);const N=(s==null?void 0:s.per_day)??0,E=((C=s==null?void 0:s.analyzed_today)==null?void 0:C.length)??0,y=s==null?void 0:s.offre,z=(s==null?void 0:s.pool_meta)||[],L=m.useMemo(()=>{const j=new Map;for(const M of(s==null?void 0:s.scheduled)||[])for(const D of M.names||[])j.has(D)||j.set(D,{label:M.day_label,date:M.date});return j},[s==null?void 0:s.scheduled]),q=(s==null?void 0:s.in_progress)||[];return t.jsxs(Ie,{title:e.queueTitle,wide:!0,children:[y&&t.jsxs("div",{className:"qoffre"+(y.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:y.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:y.delai})]}),t.jsx("span",{className:"osp"}),y.rythme>0?t.jsx("span",{className:"or",children:e.qRate(y.rythme)}):y.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(y.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(E,E+(((S=s==null?void 0:s.pool_order)==null?void 0:S.length)??0))}})}),y&&t.jsxs("div",{className:"qeta",children:[y.file===0?e.qEtaDone:y.rythme<=0?e.qEtaPaused:e.qEta(y.file,y.rythme,y.jours_restants),y.en_retard&&t.jsxs("em",{children:[" ",e.qLate(y.delai,y.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(y==null?void 0:y.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(q.length>0||f.items.some(j=>j.status==="boot"||j.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[f.items.filter(j=>j.status==="boot"||j.status==="running"||j.status==="error").map(j=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:j.name}),t.jsx("span",{className:"qd",children:j.memoType||""}),t.jsx(Rt,{item:j,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+j.name)),q.filter(j=>!f.liveOf(j.name)).map(j=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:j.name}),t.jsxs("span",{className:"qd",children:[j.memo_type||"",j.age_min?` · ${Math.round(j.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:j.state||""})]},"ip-"+j.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(j=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:j.company}),t.jsxs("span",{className:"qd",children:[j.memo_type,typeof j.est_min=="number"?` · ~${j.est_min} min`:""]}),t.jsx("span",{className:"qt",children:j.status}),j.url&&t.jsx("a",{className:"qgo",href:j.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),v&&j.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Sn(a,j.company,"retry").then(()=>b(M=>M+1))},children:e.queueRetry}),v&&j.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Sn(a,j.company,"delete").then(()=>b(M=>M+1))},children:e.queueDelete})]},j.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(z.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[z.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),z.map((j,M)=>{const D=L.get(j.name),A=h.get((j.name||"").trim().toLowerCase()),R=f.liveOf(j.name),w=!!(A&&l.has(A.id))||!!(R&&(R.status==="boot"||R.status==="running")),O=!!(A&&Ce(A)===1&&!A.memoUrl)&&!R;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",M+1]}),D?t.jsx("span",{className:"qwhen"+(D.label==="demain"?" soon":""),children:D.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:j.name}),j.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof j.score=="number"&&t.jsx("span",{className:"qs2",children:j.score}),R&&(R.status==="boot"||R.status==="running")&&t.jsx(Rt,{item:R,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),O&&(c.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>d({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:w,onClick:()=>{o(A),b(W=>W+1)},children:w?e.actAnalyseQueued:e.actAnalyse})),j.excerpt&&t.jsx("span",{className:"qex",children:j.excerpt})]},j.name+":"+M)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([j,M])=>t.jsxs("li",{children:[t.jsx("b",{children:j})," — ",M]},j))})]})}function dc(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=$(),c=`${yt}/cibles/list.csv?token=${a}`,d=`${yt}/cibles/list.json?token=${a}`,f=`${yt}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${c}")`,x=v=>{var h;(h=navigator.clipboard)==null||h.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:c,href:c},{def:e.exportSheet,value:s},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:f,href:f}],g=!i.lockActions&&n.length>0,p=()=>{Kl(Gl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([h])=>h===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ie,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:h,href:N})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(h),children:e.exportCopy}),N&&t.jsx("a",{className:"exb",href:N,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function pc(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),o=i!=="client",[l,c]=m.useState(null),[d,f]=m.useState(!1),[s,x]=m.useState(0),[u,g]=m.useState(!1);m.useEffect(()=>{let h=!0;return f(!1),Nn(a).then(N=>{h&&(N?c(N):f(!0))}),()=>{h=!1}},[a,s]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=h=>{if(o||!l)return;const N={enabled:h.enabled??!!l.enabled,email:h.email??(l.email||""),sections:h.sections??p()};g(!0),Nn(a,N).then(E=>{if(g(!1),!E){n(e.memoAlertErr);return}c(E),r(e.memoAlertSaved)})};if(d)return t.jsx(Ie,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(h=>h+1),children:e.retry})]})});if(!l)return t.jsx(Ie,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=p();return t.jsxs(Ie,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(uc,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>b({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,N])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[h],disabled:o||u,onChange:()=>b({sections:{...v,[h]:!v[h]}})}),t.jsx("span",{children:N})]},h))}),t.jsx(dn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>oi(a,v),onTest:()=>ri(a,v)})]})}function uc({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const c=o.trim()!==e.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&c&&d&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!c||!d,onClick:()=>i(o.trim()),children:n})]})]})}function mc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=$(),[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(null),[x,u]=m.useState(""),[g,p]=m.useState(0);m.useEffect(()=>{let E=!0;return d(!1),Ta(a).then(y=>{E&&(y?l({configured:y.configured,url_hint:y.url_hint}):d(!0))}),li(a).then(y=>{E&&s(y)}),()=>{E=!1}},[a,g]);const b=(E,y)=>{i&&Ta(a,E).then(z=>{if(!z||z.ok===!1){n(e.actErr);return}E.test&&z.sent===!1?n(e.plugTestThrottled):r(y),p(L=>L+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),N=`curl -X POST ${yt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ie,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),c?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(E=>E+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!i,onChange:E=>u(E.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!x.trim(),onClick:()=>b({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(fc,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:N}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(N).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function fc(){const{t:e,token:a,lang:r}=$(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[c,d]=m.useState(null),[f,s]=m.useState(null),[x,u]=m.useState(!1),[g,p]=m.useState(!1),[b,v]=m.useState(null),[h,N]=m.useState(null),[E,y]=m.useState(null),z=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Ta(a).then(D=>{N(D&&D.configured?D.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{d(null),s(null),u(!1),v(null);try{const D=JSON.parse(localStorage.getItem(z)||"null");y(D&&Date.now()-Date.parse(D.t)<24*3600*1e3?D:null)}catch{y(null)}},[z]);const L=async()=>{l(!0),u(!1),v(null);const D=await di(a,n);d(D),s(D.ok?n:null),l(!1)},q=m.useRef(!1),C=async()=>{if(q.current)return;q.current=!0,p(!0);const D=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let A;try{A=await pi(a,n,"webhook",void 0,D)}finally{q.current=!1}if(p(!1),u(!1),v(A),A.ok&&(A.pushed||0)>0){const R={t:new Date().toISOString(),n:A.pushed||0};y(R);try{localStorage.setItem(z,JSON.stringify(R))}catch{}}},S=c!=null&&c.ok&&c.ready||0,j=!!(c!=null&&c.ok)&&f===n&&S>0&&!!h&&!E,M=E?new Date(E.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:D=>i(D.target.value),children:e.plugBulkTabs.map(([D,A])=>t.jsx("option",{value:D,children:A},D))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{L()},children:o?"…":e.plugBulkPreview})]}),c&&(c.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(c.ready||0,c.linkedinReady||0,(c.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(c!=null&&c.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),E&&t.jsx("p",{className:"mnote",children:e.bulkLocked(M,E.n)}),!E&&!!(c!=null&&c.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!E&&!c&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),j&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),j&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(S,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:g,onClick:()=>{C()},children:g?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:g,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function xc(){const{t:e,data:a,lang:r}=$(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const c=window.location.href.split("?")[0];try{const f=await(await fetch(`${Ya}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:c+"?credits=ok",cancel_url:c+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(Ie,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function hc(){const{t:e}=$();return t.jsx(Ie,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Xl,{})})}function gc(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:c}=$(),[d,f]=m.useState(null),[s,x]=m.useState(!1);m.useEffect(()=>{let S=!0;if(o)return Ka(o).then(j=>{S&&j&&typeof j.per_day=="number"&&f(j.per_day)}),()=>{S=!1}},[o]);const[u,g]=m.useState(null);m.useEffect(()=>{if(!i)return;let S=!0;return si(i).then(j=>{S&&g(j)}),()=>{S=!1}},[i]);const p=r.stats,b=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(S=>S.kind==="target"&&De(S)).length,v=r.marketEstimate||0,h=v>0?Math.min(100,Math.round(b/v*100)):null,N=(p==null?void 0:p.window_days)||30,E=b>0?b/N:0,y=v>0?Math.max(0,v-b):0,L=v>0&&E>0&&b>=100?Math.round(y/E):null,q=S=>Math.round(S).toLocaleString(a==="en"?"en-US":"fr-FR"),C=S=>{s||!l||(x(!0),ci(i,S).then(j=>{if(x(!1),j===null){c(e.actErr);return}f(j),c(e.alertSaved)}))};return t.jsxs(Ie,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(q(b))}),v>0&&t.jsx("span",{children:e.covOf(q(v))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),L!==null&&t.jsx("p",{className:"mnote",children:e.covEta(L)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(q(E))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((S,j)=>t.jsxs("tr",{className:S.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[S.code,S.geo?` · ${S.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof S.n=="number"?q(S.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:S.source}),S.elargi&&t.jsx("em",{children:e.covWide(String(S.demande||""))}),S.erreur&&t.jsx("em",{children:e.covMissing})]})]},j)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:q(u.total||v)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:q(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:q(p.shown)})," ",e.funShown]})]}),l&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(S=>t.jsx("button",{type:"button",className:d===S?"on":"",disabled:s,onClick:()=>C(S),children:S===0?"⏸":S},S))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function bc(){var h,N,E;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:c}=$(),d=n==="client",f=m.useMemo(()=>{const y=new Set;return a.forEach(z=>{z.angle&&y.add(z.angle)}),[...y]},[a]),[s,x]=m.useState(""),[u,g]=m.useState(""),[p,b]=m.useState(!1),v=async()=>{const y=s.trim();if(!(!y||p||!d)){b(!0),g("");try{const L=await(await fetch(`${yt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(L.reply&&g(String(L.reply)),L.job_id){g(e.critChatRunning);const q=async()=>{const C=await fetch(`${yt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:L.job_id})}).then(S=>S.json()).catch(()=>null);if(C&&C.done){g(String(C.reply||C.clarification||C.summary||"✓")),b(!1),C.applied&&i(e.alertSaved);return}setTimeout(()=>{q()},8e3)};setTimeout(()=>{q()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(Ie,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((h=o.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((N=o==null?void 0:o.angles)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var z,L;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((z=y.look)!=null&&z.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(q=>t.jsx("li",{children:q},q))})]}),!!((L=y.out)!=null&&L.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(q=>t.jsx("li",{children:q},q))})]})]})]},y.title)})]}),!!((E=o==null?void 0:o.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!d||p,onChange:y=>x(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!d||p||!s.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ii,{fund:l,lang:c,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Gr[y]||"v-cons"),children:y}),t.jsx("span",{children:z})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",z]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function vc(){const{t:e,dispatch:a,startTour:r}=$(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ie,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:c=>{(c.key==="Enter"||c.key===" ")&&(c.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const Xr="atl2:mapfold",yc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Xr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},wc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},Zr=m.createContext(null),$=()=>{const e=m.useContext(Zr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function xt({o:e,lg:a}){const{lang:r}=$(),n=Te(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Aa(n,r),children:[n.emoji," ",Aa(n,r)]}):null}function ma({o:e,src:a}){const{lang:r,t:n}=$(),i=Te(e);if(!i)return null;const o=wi(i),l=ki(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Ja(i,r))+" · "+n.win7(ta(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(c,d)=>t.jsx("i",{className:d<o?"on":""},d))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:c=>c.stopPropagation(),children:"↗"})]})}function kc(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=_e(a);if(i)return e.find(o=>_e(o.name)===i)||e.find(o=>{const l=_e(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function jc(){const{scoped:e,t:a,st:r,dispatch:n}=$(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.filter(x=>!pt(x)),c=l.length,d=l.filter(x=>!x.noCo).length,f=l.filter(x=>!!x.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const x=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:c}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",d," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",f," ",a.zoomPulseExplore]})]})]})}function eo({o:e}){const{lang:a}=$(),r=yi(e.cc),n=e.cc?Et(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const cr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Nc=!1;function Sc(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const to=e=>`atl2:tour:${e||"anon"}`;function Ec(e){try{return localStorage.getItem(to(e))==="1"}catch{return!0}}function dr(e){try{localStorage.setItem(to(e),"1")}catch{}}function Cc(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Lc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var un;const{lang:l}=hi(),c=Oi[l],d=Wi(e,l,a),[f,s]=m.useReducer(Ki,void 0,()=>Yi((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?wc():yc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=m.useRef(!0);m.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Xr,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e,a]);const u=m.useRef(o);u.current=o,m.useEffect(()=>{var k;(k=u.current)==null||k.call(u,f.filters)},[f.filters]);const[g,p]=m.useState(null),[b,v]=m.useState(null),[h,N]=m.useState(null),[E,y]=m.useState({kept:0,dropped:0}),[z,L]=m.useState(!1),[q,C]=m.useState(""),[S,j]=m.useState(!1),[M,D]=m.useState(null),[A,R]=m.useState(!1),[w,O]=m.useState(!1),[,W]=m.useState(0),V=()=>W(k=>k+1),B=m.useRef([]),Y=m.useRef(new Set),Z=m.useRef(new Set),[ee,oe]=m.useState([]),[I,ae]=m.useState([]),[se,ze]=m.useState(0),ve=m.useRef(new Map),qe=m.useRef(null),{mode:ye}=d,X=m.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),U=X.pipe,K=d.session.token||"",G=ye==="client"&&!e;m.useEffect(()=>{if(!K||!U)return;let k=!0;const _=async()=>{const le=await ji(K);!k||!le||(ae(le.runs),ze(Date.now()/1e3-le.now),oe(ke=>ke.filter(Je=>!le.runs.some(Ze=>_e(Ze.company)===_e(Je.name)))))};_();const P=ee.length>0||I.some(le=>le.status==="running"),J=window.setInterval(()=>{_()},P?8e3:25e3);return()=>{k=!1,window.clearInterval(J)}},[K,U,ee.length,I.some(k=>k.status==="running")]);const me=m.useMemo(()=>{const k=[],_=new Set;for(const P of ee){const J=_e(P.name);!J||_.has(J)||(_.add(J),k.push({name:P.name,id:P.id,status:"boot",started:P.started,estMin:P.estMin,memoType:"instant"}))}for(const P of I){const J=_e(P.company);if(!J||_.has(J))continue;_.add(J);const le=P.status==="error"?"error":P.status==="done"?"done":"running";k.push({name:P.company,status:le,started:P.started||0,estMin:P.est_min||(P.memo_type==="detailed"?40:15),url:P.url,error:P.error,memoType:P.memo_type})}return k},[ee,I]),ne=k=>me.find(_=>_e(_.name)===_e(k))||null,xe=(k,_)=>{oe(P=>P.some(J=>_e(J.name)===_e(k.name))?P:[...P,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:_==="detailed"?40:15}]),Y.current.add(k.id),V()};m.useEffect(()=>{if(document.querySelector(`link[href="${cr}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=cr,document.head.appendChild(k)},[]);const ce=(k,_=!1)=>{C(k),j(_),qe.current&&clearTimeout(qe.current),qe.current=setTimeout(()=>C(""),_?4200:2400)},he=k=>ce(k,!0),Ge=m.useMemo(()=>{const k=new Map;return d.dossiers.forEach(_=>{_.id&&k.set(_.id,_)}),k},[d.dossiers]),Ke=m.useMemo(()=>d.dossiers.filter(k=>br(k,f,U)),[d.dossiers,f,U]),Le=m.useRef(!1);m.useEffect(()=>{if(Le.current||e||d.loading||!d.dossiers.length)return;if(!X.showFunnel||Ec(d.session.token||"")){Le.current=!0;return}Le.current=!0;const k=window.setTimeout(()=>{dr(d.session.token||""),R(!0)},700);return()=>window.clearTimeout(k)},[e,d.loading,d.dossiers.length,X.showFunnel,d.session.token]);const Qe=m.useMemo(()=>d.dossiers.filter(k=>Qi(k,f,U,d.favIds)),[d.dossiers,f,U,d.favIds]),je=m.useMemo(()=>gi(Ke,d.favIds),[Ke,d.favIds]),Xe=m.useRef(!1);m.useEffect(()=>{if(Xe.current)return;if(!U||a==="ops"){Xe.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Xe.current=!0;return}if(d.loading)return;Xe.current=!0;const k=bi(je);k!==f.ptab&&s({type:"ptab",tab:k})},[U,a,n==null?void 0:n.ptab,d.loading,je,f.ptab]);const Me=m.useMemo(()=>{const k=Nr(d.dossiers);return k?it(k)===0?c.tourToday:Sr(k,l):c.tourNoRun},[d.dossiers,c,l]),T=m.useMemo(()=>d.dossiers.some(k=>!!k.memoUrl||!!k.summary||wt(k)),[d.dossiers]),[H,Q]=m.useState(!1);m.useEffect(()=>{if(d.loading){Q(!1);return}if(d.dossiers.length>0||d.error){Q(!0);return}const k=window.setTimeout(()=>Q(!0),6e3);return()=>window.clearTimeout(k)},[d.loading,d.dossiers.length,d.error]);const de=(d.marketEstimate||0)>0||typeof((un=d.stats)==null?void 0:un.screened)=="number"&&d.stats.screened>0,Ee=m.useMemo(()=>[1,0,2,4,5,3].find(k=>(je[k]||0)>0)??0,[je]),pe=Qa.find(k=>k.key===f.continent),Fe=f.continent==="monde"?c.contWorld:(l==="fr"?pe==null?void 0:pe.fr:pe==null?void 0:pe.en)||"";m.useEffect(()=>{const k=_=>{var J;const P=(((J=_.detail)==null?void 0:J.name)||"").trim();P&&nt(null,P)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),m.useEffect(()=>{if(a!=="ops")return;const k=_=>{const P=_.detail||{},J=String(P.id||"").trim(),le=String(P.name||"").trim(),ke=String(P.url||"").trim(),Je=J&&Ge.get(J)||kc(d.dossiers,le,ke);if(Je){v(null),s({type:"focus",id:Je.id}),Je.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Je.name}}));return}!le&&!ke||(s({type:"focus",id:null}),v({name:le,headline:String(P.text||"").trim()||le,url:ke,card:P.card}),le&&!Xa(le)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:le,url:ke}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),m.useEffect(()=>{const k=J=>{const le={},ke=String((J==null?void 0:J.sector)||"").trim();ke&&(le.sector=[ke]);const Je=String((J==null?void 0:J.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Je)&&(le.day=Je);const Ze=String((J==null?void 0:J.search)||"").trim();Ze&&(le.search=Ze);const ge=String((J==null?void 0:J.dealKind)||"").trim();(ge==="ma"||ge==="levee"||ge==="other")&&(le.dealKind=[ge]),Object.keys(le).length&&s({type:"filters",patch:le})},_=J=>k(J.detail),P=J=>{J.data&&J.data.type==="pp-filter"&&k(J.data)};return window.addEventListener("ppmap:filter",_),window.addEventListener("message",P),()=>{window.removeEventListener("ppmap:filter",_),window.removeEventListener("message",P)}},[]),m.useEffect(()=>{const k=_=>{var le;const P=(((le=_.detail)==null?void 0:le.name)||"").trim().toLowerCase();if(!P)return;const J=d.dossiers.find(ke=>(ke.name||"").trim().toLowerCase()===P);J&&s(a==="ops"?{type:"focus",id:J.id}:{type:"popup",id:J.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const nt=(k,_)=>{const P=((k==null?void 0:k.name)||_||"").trim();if(!G){N({kicker:P});return}!P||z||(L(!0),(async()=>{try{let J=P;const le=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(le)J=le;else try{const ge=await Ni(P);if(ge!=null&&ge.website)J=ge.website;else if(((ge==null?void 0:ge.candidates)||[]).length===1)J=ge.candidates[0].url;else if(((ge==null?void 0:ge.candidates)||[]).length>1){B.current=[{name:P,verdict:"unresolved",remaining:null,reason:c.evalPickSite,candidates:(ge.candidates||[]).slice(0,5)},...B.current].slice(0,8),V();return}}catch{}const ke=await xr(K,J,"atelier2"),Je={name:ke.company||P,verdict:ke.verdict,reason:ke.reason||"",remaining:ke.remaining??null};B.current=[Je,...B.current].slice(0,8),ke.verdict==="kept"&&y(ge=>({...ge,kept:ge.kept+1})),ke.verdict==="ruled_out"&&y(ge=>({...ge,dropped:ge.dropped+1}));const Ze=k||d.dossiers.find(ge=>(ge.name||"").toLowerCase()===P.toLowerCase());Ze&&(ke.verdict==="kept"?Ze.verdict=Ze.verdict||"MATCH":ke.verdict==="ruled_out"&&(Ze.verdict="NO MATCH"),ke.reason&&(Ze.reasoning=ke.reason)),V()}finally{L(!1)}})())},gt=k=>{if(!G){N({kicker:k.name});return}xe(k,"instant"),zt(K,"fast_request",k.name||"",""),ce(c.memoInstantSent(k.name))},F=k=>ve.current.get(k.id)??d.thumbs.get((k.name||"").trim().toLowerCase()),te=(k,_)=>s({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:_}}),re=async(k,_,P)=>{const J=k.ceoStatus||"";k.ceoStatus=_,V();const le=await ha(K,{status:_,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(P==null?void 0:P.note)!==void 0?{note:P.note}:{},...P!=null&&P.via?{via:P.via}:{}});return le.ok?le.skipped?(k.ceoStatus=J,V(),he(c.actNotPersisted),!1):((P==null?void 0:P.undo)!==!1&&te(k,J),P!=null&&P.msg&&ce(P.msg),(_==="Validé"||_==="Écarté")&&!k.ceoNote&&(P==null?void 0:P.note)===void 0&&D({o:k,yes:_==="Validé"}),!0):(k.ceoStatus=J,V(),he(c.actErr),!1)},ue=async(k,_)=>{const P=await ha(K,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:_,via:"note"});return!P.ok||P.skipped?(he(P.skipped?c.actNotPersisted:c.actErr),!1):(k.ceoNote=_,V(),!0)},Ae=m.useRef(new Map),Pe=k=>Ae.current.has(k.id)?Ae.current.get(k.id):d.stages.get((k.name||"").trim().toLowerCase()),we=(k,_)=>{Ae.current.set(k.id,_),V()},Be=(k,_)=>{G&&re(k,_?"Validé":"Écarté",{msg:_?c.decidedYes(k.name):c.decidedNo(k.name)})},fa=k=>{G&&re(k,"À trancher",{msg:c.promoted(k.name)})},Bt=k=>{G&&(async()=>{const _=k.ceoStatus||"";k.ceoStatus="Retenu",V();const P=await ha(K,{status:"Retenu",check_id:k.checkId,company:k.name});if(!P.ok||P.skipped){k.ceoStatus=_,V(),he(P.skipped?c.actNotPersisted:c.actErr);return}te(k,_),ce(c.repeched(k.name))})()},ao=()=>{const k=f.undo[f.undo.length-1];if(!k){ce(c.undoNone);return}const _=Ge.get(k.id);if(!_){s({type:"undoPop"}),ce(c.undoNone);return}let P=k.prevCeoStatus;if(!P)if((_.verdict||"").toUpperCase().includes("CALL"))P="À trancher";else{ce(c.undoLockedTitle);return}(async()=>await re(_,P,{undo:!1})&&(s({type:"undoPop"}),_.ceoStatus=k.prevCeoStatus,V(),ce(c.undoDone(_.name))))()},no=k=>{G&&(Z.current.add(k.id),V(),(async()=>{const _=await Si(K,k.name,"email");if(!_||_.ok===!1){Z.current.delete(k.id),V(),he(c.actErr);return}zt(K,"approach",k.name||"",""),ce(c.actApproachSent)})())},ro=(k,_)=>{G&&(async()=>{if(!(await zt(K,_?"yes":"no",k.name||"","")).ok){he(c.actErr);return}ve.current.set(k.id,_?"yes":"no"),V(),ce(_?c.thumbUpDone:c.thumbDnDone)})()},oo=k=>{!G||!wt(k)||(xe(k,"detailed"),zt(K,"detailed_request",k.name||"",""),ce(c.memoDeepSent(k.name)))},io=k=>{const _=new Set(d.favIds),P=_.has(k.id);P?_.delete(k.id):_.add(k.id),d.setFavIds(_),G&&Ei(K,{id:k.id,co:k.name},P)},so=()=>{!G||w||window.confirm(c.identSyncConfirm)&&(O(!0),(async()=>{const k=await Ci(K);O(!1),k?ce(c.identSyncDone):he(c.actErr)})())},pn=/proplace/i.test(d.fund||""),lo=k=>{!G||!pn||(zt(K,"onboard_request",k.name||"",""),ce(c.onboardSent(k.name)))},co={st:f,dispatch:s,t:c,lang:l,mode:ye,caps:X,pipe:U,token:K,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:Bt,thumbOf:F,canWrite:G,commitStatus:re,saveNote:ue,stageOf:Pe,setStage:we,flashErr:he,startTour:()=>R(!0),dossiers:d.dossiers,scopedAll:Ke,scoped:Qe,counts:je,byId:Ge,contName:Fe,favIds:d.favIds,toggleFav:io,askEvaluate:nt,doAnalyse:gt,doDecide:Be,doPromote:fa,doApproach:no,doThumb:ro,doDeep:oo,doUndo:ao,doSync:so,doOnboard:lo,outbound:pn,memoQueued:Y.current,liveMemos:{items:me,serverOff:se,liveOf:ne},approachDone:Z.current,sessTally:E,evalCards:B.current,evalBusy:z,markRow:p,markedId:g,flash:ce,focusExtra:b};m.useEffect(()=>{const k=_=>{_.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const po=k=>K?t.jsx(Xi,{token:K,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(Zr.Provider,{value:co,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(K?" cibles":""),children:[t.jsx("style",{children:Di}),X.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:c.lockbarText}),t.jsxs("span",{className:"lb-c",children:[c.lockbarContactBefore,t.jsx("a",{href:kr,children:tn}),c.lockbarContactMid,t.jsx("a",{href:`mailto:${na}`,children:na})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:c.lockbarCta})]}),po(t.jsxs("div",{className:"app"+(U?" pipe":"")+(K?" has-thesis":""),children:[X.showTicker&&t.jsx(Re,{name:"live",children:t.jsxs("div",{className:"live-stack"+(K?" live-stack--cibles":""),children:[t.jsx(rs,{}),!!K&&t.jsx(Zi,{})]})}),X.showIdent&&t.jsx(Re,{name:"identite",children:t.jsx(gs,{})}),!1,!!K&&t.jsx(Re,{name:"brief",children:t.jsx(es,{})}),Nc,X.showMorning&&t.jsx(Re,{name:"matin",children:t.jsx(hs,{})}),t.jsx(Re,{name:"mesure",children:t.jsx(ls,{})}),X.showFunnel&&t.jsx(Re,{name:"entonnoir",children:t.jsx(zc,{})}),X.showFunnel&&t.jsx(Re,{name:"tunnel",children:t.jsx(bs,{})}),X.showFunnel&&t.jsx(Re,{name:"tuto",children:t.jsx(vs,{})}),!f.mapFolded&&t.jsx(Re,{name:"carte",fallback:t.jsx("div",{className:"void",children:c.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Vr,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(jc,{}),t.jsx(hl,{}),t.jsx(Hr,{})]})]})}),X.showDemand&&U&&t.jsx(Re,{name:"direct",children:t.jsx(Li,{items:me,serverOff:se,labels:{strip:c.liveStrip,boot:c.liveBoot,end:c.liveEnd,open:c.liveOpenQueue,memo:c.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),X.showDemand&&t.jsx(Re,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(kl,{})})}),X.showDemand&&f.memoConsole&&t.jsx(Re,{name:"console",children:t.jsx(Nl,{})}),t.jsx(Re,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[c.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:c.retry})]}),children:t.jsx(Wl,{})}),d.loading&&t.jsx("div",{className:"void",children:c.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[c.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:c.retry})]})]})),f.popupId&&f.dens!=="liste"&&a!=="ops"&&t.jsx(Re,{name:"fiche",children:t.jsx(Ll,{})}),t.jsx(Re,{name:"modales",children:t.jsx(ec,{})}),t.jsx(ss,{}),M&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:M.o.name}),t.jsx(ms,{placeholder:M.yes?c.whyYesPh:c.whyNoPh,onDone:k=>{const _=M.o;D(null),k&&ue(_,k).then(P=>{P&&ce(c.csNoteSaved)})}})]}),A&&H&&t.jsx(xs,{steps:Cc(c,Me,T,Ee,de),onClose:()=>{R(!1),dr(K)}}),t.jsx(Sc,{}),q&&t.jsx("div",{className:"flash on"+(S?" err":""),children:q}),h&&t.jsx(vi,{variant:"acquirer",initialCompany:pr().co,initialWebsite:pr().site,onClose:()=>N(null)})]})})}function zc(){const{t:e}=$(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function pr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ac(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{eo as FlagCell,xt as SigBadge,ma as SigWin,Lc as default,Ac as fmtShort,$ as useV2};
