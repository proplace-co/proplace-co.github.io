...
.atl2 .bulk .side .hint{white-space:nowrap}`,ii=`
...
`,si=oi+ii;function fa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function li(){const e=fa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function ci(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=li();return r==="0"?"client":r==="1"||fa("embed")==="1"&&fa("chrome")==="1"?"apercu":"client"}const di={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},pi=e=>di[e];function ui(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Ke=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Yn(a)||ui(a))&&(e.noCo=!0)}return Object.assign(e,{continent:ro(e.cc)})};function ta(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const mi=60*60*1e3;function fi(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>mi?null:a}catch{return null}}function At(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const xi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function hi(e,a,r="default"){const n=r!=="default",i=x.useMemo(()=>e||n?{mode:"anon"}:Kr(),[e,n]),o=x.useMemo(()=>n?"visiteur":ci(e,i),[e,i,n]),s=x.useMemo(()=>pi(o),[o]),l=o!=="visiteur",c=xi(r),[f,d]=x.useState([]),[m,u]=x.useState(""),[b,p]=x.useState(null),[g,v]=x.useState(null),[h,S]=x.useState(null),[k,y]=x.useState(()=>new Map),[T,R]=x.useState(()=>new Map),[z,N]=x.useState(""),[w,L]=x.useState(new Set),[j,O]=x.useState(null),[$,E]=x.useState(!0),[A,M]=x.useState(!1),[B,V]=x.useState(0),[U,Z]=x.useState(0),Y=x.useRef(0),te=x.useMemo(()=>{var _;if(o!=="client")return"";try{return((_=Qr())==null?void 0:_.email)||""}catch{return""}},[o]);x.useEffect(()=>{const _=++Y.current;let G=!0;const Q=()=>G&&_===Y.current,ee=(l&&i.token?i.token:"pub:"+a)+(c?":"+c:""),le=fi(ee);return le?(d(le.objs.map(Ke)),le.fund&&u(le.fund),p(le.marketEstimate??null),v(le.criteria??null),S(le.stats??null),N(le.generatedAt||""),E(!1)):E(!0),(async()=>{try{if(r==="ops"){const we=await Xt(),ue=((we==null?void 0:we.recent_ops)||[]).map(X=>{const oe=Zt(X.company_name||X.title?X:{...X,title:(X.headline_fr||X.headline||"").slice(0,120)},a),xe=String(X.rubrique||"").toLowerCase();return oe&&(xe==="nominations"||xe==="recrutements")&&(oe.engine=xe),oe&&!String(X.company_name||"").trim()&&(oe.noCo=!0),oe}).filter(X=>!!X).map(X=>(Yn((X.name||"").trim())||(X.noCo=!0),X));try{const X=await Jr(),oe=Xr(X),xe=((X==null?void 0:X.date)||"").slice(0,10);if(oe.length&&xe){const q=new Set;for(const F of ue){if(F.noCo||(F.date||"").slice(0,10)!==xe)continue;const I=Ga(oe,q,F.name,"");I>=0&&(q.add(I),F.decryptHtml=oe[I].html)}for(const F of ue){if(F.decryptHtml||(F.date||"").slice(0,10)!==xe)continue;const I=Ga(oe,q,"",F.headline||F.tagline||F.name);I>=0&&(q.add(I),F.decryptHtml=oe[I].html)}}}catch{}if(!Q())return;d(ue.map(Ke)),At(ee,{objs:ue})}else if(typeof r=="object"){const ue=(await Ka()||[]).filter(oe=>(oe.slug||"")===r.research).map(oe=>Qa(oe,a)).filter(oe=>!!oe),X=ta(await Ja(ue,a));if(!Q())return;d(X.map(Ke)),At(ee,{objs:X})}else if(l&&i.token){const we=Zr(i.token),ue=Xt(),X=eo(i.token),oe=to(i.token),xe=ao(i.token),q=await we;let F=q?q.targets:[];Q()&&q&&(u(q.fund||""),p(q.marketEstimate??null),v(q.criteria??null),S(q.stats??null),N(q.generatedAt||""),d(F.map(Ke)),E(!1),M(!1));const[I,J,ae,ne]=await Promise.all([ue,X,oe,xe]),he=((I==null?void 0:I.recent_ops)||[]).map(ke=>Zt(ke,a)).filter(ke=>!!ke);if(F=[...F,...he],!Q())return;d(F.map(Ke));const Fe=new Set;for(const ke of J){const ze=(ke.id||ke.co||"").toString().trim().toLowerCase();ze&&Fe.add(ze.startsWith("t:")?ze:"t:"+ze)}L(Fe),y(ae),R(ne),q&&At(ee,{fund:q.fund,marketEstimate:q.marketEstimate,criteria:q.criteria,stats:q.stats,generatedAt:q.generatedAt,objs:F})}else{const we=no(),ue=Ka(),X=Xt(),oe=await we;Q()&&oe.length&&(d(ta(oe).map(Ke)),E(!1),M(!1));const[xe,q]=await Promise.all([ue,X]),F=(xe||[]).map(ne=>Qa(ne,a)).filter(ne=>!!ne),I=await Ja(F,a),J=((q==null?void 0:q.recent_ops)||[]).map(ne=>Zt(ne,a)).filter(ne=>!!ne),ae=ta([...oe,...I,...J]);if(!Q())return;d(ae.map(Ke)),At(ee,{objs:ae})}Q()&&M(!1)}catch{Q()&&!le&&M(!0)}finally{Q()&&E(!1)}})(),()=>{G=!1}},[l,i.token,a,B,c]),x.useEffect(()=>{if(!s.showCredits||!te){O(null);return}let _=!0;return(async()=>{try{const G=await fetch(`${za}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:te})});if(!G.ok)return;const Q=await G.json();_&&Q&&Q.ok!==!1&&O(Q)}catch{}})(),()=>{_=!1}},[s.showCredits,te,U]);const K=x.useCallback(_=>L(new Set(_)),[]);return{session:i,mode:o,caps:s,fund:m,email:te,marketEstimate:b,generatedAt:z,criteria:g,stats:h,thumbs:k,stages:T,dossiers:f,favIds:w,setFavIds:K,credits:j,reloadCredits:()=>Z(_=>_+1),loading:$,error:A,refresh:()=>V(_=>_+1)}}const Jn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),gi=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Jn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),bi=new Set(["signal","amount","score","crible","memo"]);function vi(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Jn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:bi.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Xn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Xn=40;function Oa(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ye(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(qa(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(We(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Je(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function Zn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Oa(e,a.filters,r)}function yi(e,a,r,n){return!(!Zn(e,a,r)||r&&!oo(e,a.ptab,n))}function Fa(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-We(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return so(i);case"memo":return io(i);case"signal":{const o=ye(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const s=n(i),l=n(o);return s<l?-a.dir:s>l?a.dir:(i.name||"").localeCompare(o.name||"")})}const wi=["ma","levees","nominations","recrutements","actualites"],ki=300,aa=7,ji={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},er={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Ni=["hiring","raised","news","posting","building","community","registry","exodus","other"];function on(e){const a=ye(e);if(a)return"sig:"+(a.theme&&er.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Si(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:s,fund:l}=P(),c=s==="en",[f,d]=x.useState("all"),[m,u]=x.useState(!1),b=x.useMemo(()=>{const j=(a.filters.day||"").slice(0,10),O=M=>{if(!o&&a.continent!=="monde"&&M.continent!==a.continent||j&&(M.date||"").slice(0,10)!==j)return!1;if(o&&M.kind==="op"){const B=(l||"").trim().toLowerCase();if(!B)return!1;const V=M.match||null;if(!V||!Object.keys(V).map(Z=>Z.trim().toLowerCase()).includes(B))return!1}return!0},$=e.filter(M=>O(M)&&ye(M)&&(!o||M.kind!=="target"||ve(M)!==5)),E=e.filter(M=>O(M)&&M.kind==="op"&&!ye(M)&&(j?!0:We(M.date)<=aa)),A=j||new Date().toISOString().slice(0,10);return E.sort((M,B)=>{const V=(M.date||"").slice(0,10)===A?0:1,U=(B.date||"").slice(0,10)===A?0:1;return V!==U?V-U:(B.amountEur||0)-(M.amountEur||0)}),[...Fa($,{key:"signal",dir:-1}),...E]},[e,a.continent,a.filters.day,o,l]),p=x.useMemo(()=>{const j={};for(const O of b){const $=on(O);j[$]=(j[$]||0)+1}return j},[b]),g=x.useMemo(()=>f==="all"?b:b.filter(j=>on(j)===f),[b,f]),v=x.useMemo(()=>g.slice(0,ki),[g]),h=g.length-v.length,S=x.useRef(null);x.useEffect(()=>{var M,B;const j=S.current;if(!j)return;const O=()=>{const V=j.scrollWidth;V<200||(j.style.animationDuration=Math.max(18,Math.round(V/130))+"s")};O();const $=requestAnimationFrame(O),E=window.setTimeout(O,1200);let A=!0;return(B=(M=document.fonts)==null?void 0:M.ready)==null||B.then(()=>{A&&O()}),()=>{A=!1,cancelAnimationFrame($),window.clearTimeout(E)}},[v.length,f]);const k=j=>j==="all"?b.length:p[j]||0,y=j=>j==="all"?c?"All":"Tout":j.startsWith("sig:")?er[c?"en":"fr"][j.slice(4)]||"🔔":ji[c?"en":"fr"][j],T=[{k:"all"}],R=wi.filter(j=>k(j)>0||j===f);if(R.length){T.push({g:c?"DEALS":"OPÉRATIONS"});for(const j of R)T.push({k:j})}const z=Ni.map(j=>"sig:"+j).filter(j=>k(j)>0||j===f);if(z.length){T.push({g:c?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const j of z)T.push({k:j})}const N=j=>{try{return new Date(j+"T12:00:00Z").toLocaleDateString(c?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return j}},w=(()=>{const j=(a.filters.day||"").slice(0,10),O=!o&&a.continent!=="monde"&&i?c?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return j?(c?`LIVE covers the events of ${N(j)}.`:`Le LIVE regroupe les événements du ${N(j)}.`)+O:(c?`LIVE covers the still-open signals and the deals of the last ${aa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${aa} derniers jours.`)+O})(),L=j=>v.map(O=>t.jsxs("button",{type:"button",className:"tk"+(Te(O)?" spent":""),onClick:$=>{const E=$.currentTarget.getBoundingClientRect();n({type:"popup",id:O.id,anchor:{x:E.left+E.width/2,y:E.bottom}})},title:O.name+(O.tagline?" — "+O.tagline:""),children:[t.jsx(tt,{o:O}),t.jsxs("span",{className:"who",children:[t.jsx(Mr,{o:O}),t.jsx("span",{className:"co",children:O.name})]}),typeof O.amountEur=="number"&&O.amountEur>0&&t.jsx("span",{className:"am",children:Xl(O.amountEur)}),O.sector&&t.jsx("span",{className:"mt",children:O.sector}),t.jsx(Qt,{o:O}),t.jsx("span",{className:"tkgo",children:"→"})]},j+(O.id||O.name))).concat(h>0?[t.jsx("span",{className:"tk quiet",children:c?`+ ${h} more — filter by section to see them`:`+ ${h} autres — filtrez par rubrique pour les voir`},j+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:j=>{j.currentTarget.contains(j.relatedTarget)||u(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":m,onClick:()=>u(j=>!j),children:[y(f),t.jsx("b",{children:k(f)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!m,children:[t.jsx("span",{className:"tkfilscope",children:w}),T.map(j=>"g"in j?t.jsx("span",{className:"tkfilg",children:j.g},j.g):t.jsxs("button",{type:"button","aria-pressed":j.k===f,onClick:()=>{d(j.k),u(!1)},children:[y(j.k),t.jsx("b",{children:k(j.k)})]},j.k))]})]}),t.jsx("div",{className:"win",children:v.length?t.jsxs("div",{className:"run",ref:S,children:[L(0),L(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const Ei="aDx8z7Hzksus",Pa="+33 6 83 10 72 86",It="alexandre@proplace.co",tr=`tel:${Pa.replace(/[^\d+]/g,"")}`,sn="pp-rdv-slot";function Ci(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Ai(){const{t:e,caps:a,fund:r}=P();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:zi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:tr,children:Pa}),e.rdvSubMid,t.jsx("a",{href:`mailto:${It}`,children:It})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],s)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(s+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(ti,{filloutId:Ei,parameters:r?{company_name:r}:void 0})})]})}function Ti(){const[e,a]=x.useState(()=>typeof document>"u"?null:document.getElementById(sn));return x.useEffect(()=>{e||a(document.getElementById(sn))},[e]),e?dt.createPortal(t.jsx(Ai,{}),e):null}const zi=`
...
`;class Ee extends x.Component{constructor(){super(...arguments);Wa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const na=600,Qe=62,ln="atl2:fstats";function qi(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=P(),[s,l]=x.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(ln)==="on"}catch{return!1}}),c=r.stats,f=x.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const m=T=>a==="en"?T.slice(5,10):`${T.slice(8,10)}/${T.slice(5,7)}`,u=T=>T.toLocaleString(a==="en"?"en-US":"fr-FR"),b=f.reduce((T,R)=>Math.max(T,R.s||0),0),p=f.length?na/f.length:0,g=Math.max(4,p-4),v=f.length>=5&&b>0,h=r.marketEstimate||0,S=m(new Date().toISOString().slice(0,10)),k=T=>[...typeof T=="number"?[[T,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],y=[];return typeof c.screened_window=="number"&&d&&y.push({cle:"fenetre",periode:e.funPerWindow(m(d),S),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:k(c.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[y.map(T=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:T.periode}),T.etapes.map(([R,z],N)=>t.jsxs("span",{className:"fst-t",children:[N>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(R)}),t.jsx("i",{children:z})]},T.cle+z)),T.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((c.screened||0)/h*100)))})]}),T.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const R=!s;l(R),R&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(ln,R?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},T.cle)),s&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${na} ${Qe}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((T,R)=>{const z=(T.s||0)/b*(Qe-4),N=(T.m||0)/b*(Qe-4),w=R*p+(p-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(T.d)} — ${T.s} ${e.actScreened} · ${T.m} ${e.actKept}`}),t.jsx("rect",{x:w,y:Qe-2-z,width:g,height:z,fill:"#cfe0d6"}),t.jsx("rect",{x:w,y:Qe-2-N,width:g,height:N,fill:"#185c38"})]},T.d)}),t.jsx("line",{x1:0,y1:Qe-1.5,x2:na,y2:Qe-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const ar=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Li(e,a){if((Ye(e)||"").startsWith("CALL")&&ve(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ve(e)>=2;return ar.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function Ri({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:s}=P(),[l,c]=x.useState(!1),[f,d]=x.useState(""),[m,u]=x.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),p=async g=>{if(f)return;if(g==="Analysé"&&!e.memoUrl){u(!0);return}d(g);const v=await i(e,g);d(""),v&&(c(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:g=>g.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(g=>!g),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),l&&t.jsx("span",{className:"rstm",children:m?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{o(e),u(!1),c(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{d("Analysé");const g=await i(e,"Analysé");d(""),g&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]}):Li(e,a).map(([g,v])=>t.jsx("button",{type:"button",className:"rsti"+(b===g?" on":"")+(f===g?" busy":""),disabled:!!f,onClick:()=>{p(g)},children:v},g))})]})}function Mi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=P(),[o,s]=x.useState(""),[l,c]=x.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),d=(Ye(e)||"").startsWith("CALL")&&ve(e)===3,m=ve(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(p);const g=await i(e,p);s(""),g&&(c(!0),setTimeout(()=>c(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:ar.filter(([p])=>!(m&&p==="Retenu")).map(([p,g])=>[p,a[g]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,g])=>t.jsx("button",{type:"button",className:"csb"+(f===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:g},p)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Oi,{o:e})]})}function Oi({o:e}){const{t:a,saveNote:r,flash:n}=P(),[i,o]=x.useState(e.ceoNote||""),[s,l]=x.useState(!1),[c,f]=x.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(s||!d)return;l(!0);const u=await r(e,i.trim());l(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:s,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:s||!d,onClick:()=>{m()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Fi({placeholder:e,onDone:a}){const{t:r}=P(),[n,i]=x.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Pi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:s,flashErr:l}=P(),[c,f]=x.useState(!1);if(!n.pipe||!i||n.lockActions||ve(e)!==4)return null;const d=o(e),m=(d==null?void 0:d.stage)||"todo",u=async h=>{if(c||h===m)return;f(!0);const S=d;s(e,{stage:h,stamps:(d==null?void 0:d.stamps)||{}});const k=Math.max(Date.now(),cn+=1);cn=k;const y=await lo(r,{company:e.name||"",stage:h,cts:k,deal_id:e.airtableId,check_id:e.checkId});f(!1),!y.stale&&(y.ok||(s(e,S),l(a.actErr)))},b=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=m==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,S])=>t.jsx("button",{type:"button",className:"stgb"+(m===h?" on":""),disabled:c,onClick:()=>{u(h)},children:S},h)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let cn=0;const Tt=8,zt=360;function dn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function pn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(dn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(dn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function Di({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=P(),[s,l]=x.useState(0),[c,f]=x.useState(null),[d,m]=x.useState([]),u=x.useRef(!1),b=x.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=x.useRef(!1);x.useEffect(()=>{const z=b.current;return()=>{p.current||(n({type:"ptab",tab:z.ptab}),n({type:"dens",dens:z.dens}),n({type:"modal",modal:z.modal}))}},[]),x.useEffect(()=>{u.current||(u.current=!0,m(e.filter(z=>!!document.querySelector(z.need||z.sel))))},[e]);const g=d[s],v=s>=d.length;x.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const z=g.click,N=window.setTimeout(()=>{const w=document.querySelector(z);w&&w.getAttribute("aria-selected")!=="true"&&w.click()},60);return()=>window.clearTimeout(N)}},[s,g]);const h=x.useRef(-1),S=x.useCallback(()=>{if(!g){f(null);return}const z=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!z){f(null);return}h.current!==s&&(h.current=s,z.scrollIntoView({block:"nearest",behavior:"smooth"}));const N=z.getBoundingClientRect();f(w=>w&&Math.abs(w.top-N.top)<1&&Math.abs(w.left-N.left)<1&&Math.abs(w.width-N.width)<1&&Math.abs(w.height-N.height)<1?w:N)},[g,s]);x.useLayoutEffect(()=>{S();const z=[90,300,700,1300].map(w=>window.setTimeout(S,w)),N=()=>S();return window.addEventListener("scroll",N,!0),window.addEventListener("resize",N),()=>{z.forEach(w=>window.clearTimeout(w)),window.removeEventListener("scroll",N,!0),window.removeEventListener("resize",N)}},[S]);const k=x.useRef(a);if(k.current=a,x.useEffect(()=>{const z=N=>{N.key==="Escape"?(N.preventDefault(),N.stopPropagation(),k.current()):N.key==="ArrowRight"?l(w=>w+1):N.key==="ArrowLeft"&&l(w=>Math.max(0,w-1))};return document.addEventListener("keydown",z,!0),()=>document.removeEventListener("keydown",z,!0)},[]),!d.length)return null;let y=null;const T=z=>()=>{p.current=!0,n({type:"modal",modal:null}),z()};if(v){const z=i[3]||0;z>0?y={title:z===1?r.ahaATitle1:r.ahaATitleN(z),body:r.ahaABody,btn:r.ahaABtn,go:T(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:T(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:T(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:T(()=>{n({type:"modal",modal:"crit"}),a()})}}let R={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:zt};if(!v&&c){const z=c.bottom+14,w=window.innerHeight-z>190?z:Math.max(12,c.top-200);R={left:Math.min(Math.max(12,c.left+c.width/2-zt/2),window.innerWidth-zt-12),top:w,width:zt}}return dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Tt,top:c.top-Tt,width:c.width+Tt*2,height:c.height+Tt*2}}),(v||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:R,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(pn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(pn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>l(z=>Math.max(0,z-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(z=>z+1),children:s===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function nr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function rr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Ii(){var N,w;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:s,data:l,dispatch:c}=P(),f=r?a:e,d=x.useMemo(()=>f.filter(L=>We(L.date)===0&&L.kind==="target"),[f]),m=x.useMemo(()=>r?a.filter(L=>L.kind==="target"&&ve(L)===0).slice().sort((L,j)=>(j.date||"").localeCompare(L.date||"")):[],[a,r]),u=x.useMemo(()=>d.filter(L=>r?ve(L)===0:!Te(L)),[d,r]),b=r?m:u,p=r?a.length-m.length:d.length-u.length,g=r?a.length:d.length,v=g?Math.min(100,p/g*100):100,h=x.useMemo(()=>nr(f),[f]),S=!!h&&We(h)>0,k=x.useMemo(()=>S?f.filter(L=>(L.date||"").slice(0,10)===h):[],[f,h,S]),y=typeof((N=l.stats)==null?void 0:N.kept_today)=="number"?l.stats.kept_today:null,T=typeof((w=l.stats)==null?void 0:w.screened_today)=="number"?l.stats.screened_today:d.length;let R;S?R=i.morningLast(k.length,m.length,rr(h,s)):r?R=i.morningThesis(T,m.length,y):d.length?p===0?R=i.goalSourced(d.length):p>=d.length?R=i.goalCleared:R=i.goalDone(p,d.length):R=i.goalSourced(0);const z=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&m.length&&c({type:"chainStart",queue:m.map(L=>L.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:R}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:z,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function $i(){var B,V;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:s,dossiers:l,mode:c,doSync:f,startTour:d,flash:m,flashErr:u}=P(),[b,p]=x.useState(null),[g,v]=x.useState(!0),[h,S]=x.useState([]),k=c==="client";x.useEffect(()=>{if(!i||!o)return;let U=!0;return v(!0),(async()=>{const[Z,Y]=await Promise.all([La(o),Gn(i)]);U&&(Z&&p(Z),v(!1),S(Y))})(),()=>{U=!1}},[i,o]);const[y,T]=x.useState(!1),R=()=>{!k||y||!o||(T(!0),co(o).then(U=>{T(!1),U?m(e.identRepubDone):u(e.actErr)}))},z=(b==null?void 0:b.per_day)??null,N=((B=b==null?void 0:b.pool_order)==null?void 0:B.length)??0,w=h.filter(U=>U.status==="running").length,L=x.useMemo(()=>l.filter(U=>U.kind==="target"&&Te(U)).length,[l]),j=s.marketEstimate,O=typeof((V=s.stats)==null?void 0:V.screened)=="number"?s.stats.screened:L,$=j&&j>0?Math.min(100,Math.round(O/j*100)):null,E=U=>U.toLocaleString(a==="en"?"en-US":"fr-FR"),A=(o||"P").split(/\s+/).map(U=>U[0]).join("").slice(0,2).toUpperCase(),M=(()=>{const U=Date.parse(s.generatedAt||"");if(Number.isNaN(U))return"";const Z=new Date(U),Y=te=>String(te).padStart(2,"0");return`${Y(Z.getDate())}/${Y(Z.getMonth()+1)} à ${Y(Z.getHours())}:${Y(Z.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?A:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),M?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(M)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[$===null&&O>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:E(O)})})]}),$!==null&&j&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:$+"%"}})}),t.jsxs("b",{children:[$," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(O,j)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),z!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:z})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),z===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),w>0&&t.jsxs("span",{className:"ev",children:["⏳ ",w]}),t.jsx("span",{className:"ego",children:g?e.identPendingWait:e.identPending(N)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:U=>{U.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!k||y,onClick:R,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!k,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:U=>n({type:"filters",patch:{search:U.target.value}})})]})]})]})}function Bi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:s}=P(),l=o.loading&&!s.length,c=x.useRef({});x.useEffect(()=>{c.current={...r}},[r]);const f=u=>{const b=c.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${ca[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},d=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${ca[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,p,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(l?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function _i(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:s}=P(),l=x.useRef(null),[c,f]=x.useState(60);x.useEffect(()=>{let p=0;const g=()=>{var y;const v=l.current;if(!v)return;const h=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!h)return;const S=h.getBoundingClientRect(),k=v.getBoundingClientRect();f(Math.max(20,Math.min(S.left+S.width/2-k.left,k.width-30)))};return p=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",g)}},[e.ptab]);const d=e.ptab;let m=r.tuto[d].p;if(d===3){const p=n.filter(h=>h.kind==="target"&&ve(h)===3),g=p.filter(h=>da(h)==="auto").length,v=p.filter(h=>da(h)==="cd").length;m=r.tutoPending(g,v,p.length)}const u=(()=>{if(s!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(d===1){const p=n.filter(g=>g.kind==="target"&&ve(g)===1&&!i.has(g.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(g=>g.id)})}}return null})(),b=po(d);return t.jsxs("div",{ref:l,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${ca[d]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Ze{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],s=a+o,l=Math.abs(a)<Math.abs(o)?a-(s-o):o-(s-a);l&&(r[n++]=l),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,i=a[--r],s=n+i,o=i-(s-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=s+i,i==n-s&&(s=n))}return s}}function*Ui(e){for(const a of e)yield*a}function or(e){return Array.from(Ui(e))}var se=1e-6,re=Math.PI,Re=re/2,un=re/4,Oe=re*2,Ue=180/re,Ae=re/180,de=Math.abs,Vi=Math.atan,vt=Math.atan2,me=Math.cos,fe=Math.sin,Hi=Math.sign||function(e){return e>0?1:e<0?-1:0},at=Math.sqrt;function Wi(e){return e>1?0:e<-1?re:Math.acos(e)}function yt(e){return e>1?Re:e<-1?-Re:Math.asin(e)}function Me(){}function $t(e,a){e&&fn.hasOwnProperty(e.type)&&fn[e.type](e,a)}var mn={Feature:function(e,a){$t(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)$t(r[n].geometry,a)}},fn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){xa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)xa(r[n],a,0)},Polygon:function(e,a){xn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)xn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)$t(r[n],a)}};function xa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function xn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)xa(e[r],a,1);a.polygonEnd()}function rt(e,a){e&&mn.hasOwnProperty(e.type)?mn[e.type](e,a):$t(e,a)}function ha(e){return[vt(e[1],e[0]),yt(e[2])]}function lt(e){var a=e[0],r=e[1],n=me(r);return[n*me(a),n*fe(a),fe(r)]}function qt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Bt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ra(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Lt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ga(e){var a=at(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ba(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function va(e,a){return de(e)>re&&(e-=Math.round(e/Oe)*Oe),[e,a]}va.invert=va;function Yi(e,a,r){return(e%=Oe)?a||r?ba(gn(e),bn(a,r)):gn(e):a||r?bn(a,r):va}function hn(e){return function(a,r){return a+=e,de(a)>re&&(a-=Math.round(a/Oe)*Oe),[a,r]}}function gn(e){var a=hn(e);return a.invert=hn(-e),a}function bn(e,a){var r=me(e),n=fe(e),i=me(a),o=fe(a);function s(l,c){var f=me(c),d=me(l)*f,m=fe(l)*f,u=fe(c),b=u*r+d*n;return[vt(m*i-b*o,d*r-u*n),yt(b*i+m*o)]}return s.invert=function(l,c){var f=me(c),d=me(l)*f,m=fe(l)*f,u=fe(c),b=u*i-m*o;return[vt(m*i+u*o,d*r+b*n),yt(b*r-d*n)]},s}function Gi(e,a,r,n,i,o){if(r){var s=me(a),l=fe(a),c=n*r;i==null?(i=a+n*Oe,o=a-c/2):(i=vn(s,i),o=vn(s,o),(n>0?i<o:i>o)&&(i+=n*Oe));for(var f,d=i;n>0?d>o:d<o;d-=c)f=ha([s,-l*me(d),-l*fe(d)]),e.point(f[0],f[1])}}function vn(e,a){a=lt(a),a[0]-=e,ga(a);var r=Wi(-a[1]);return((-a[2]<0?-r:r)+Oe-se)%Oe}function ir(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Me,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Pt(e,a){return de(e[0]-a[0])<se&&de(e[1]-a[1])<se}function Rt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function sr(e,a,r,n,i){var o=[],s=[],l,c;if(e.forEach(function(p){if(!((g=p.length-1)<=0)){var g,v=p[0],h=p[g],S;if(Pt(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),l=0;l<g;++l)i.point((v=p[l])[0],v[1]);i.lineEnd();return}h[0]+=2*se}o.push(S=new Rt(v,p,null,!0)),s.push(S.o=new Rt(v,null,S,!1)),o.push(S=new Rt(h,p,null,!1)),s.push(S.o=new Rt(h,null,S,!0))}}),!!o.length){for(s.sort(a),yn(o),yn(s),l=0,c=s.length;l<c;++l)s[l].e=r=!r;for(var f=o[0],d,m;;){for(var u=f,b=!0;u.v;)if((u=u.n)===f)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,c=d.length;l<c;++l)i.point((m=d[l])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(d=u.p.z,l=d.length-1;l>=0;--l)i.point((m=d[l])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);i.lineEnd()}}}function yn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function oa(e){return de(e[0])<=re?e[0]:Hi(e[0])*((de(e[0])+re)%Oe-re)}function Ki(e,a){var r=oa(a),n=a[1],i=fe(n),o=[fe(r),-me(r),0],s=0,l=0,c=new Ze;i===1?n=Re+se:i===-1&&(n=-Re-se);for(var f=0,d=e.length;f<d;++f)if(u=(m=e[f]).length)for(var m,u,b=m[u-1],p=oa(b),g=b[1]/2+un,v=fe(g),h=me(g),S=0;S<u;++S,p=y,v=R,h=z,b=k){var k=m[S],y=oa(k),T=k[1]/2+un,R=fe(T),z=me(T),N=y-p,w=N>=0?1:-1,L=w*N,j=L>re,O=v*R;if(c.add(vt(O*w*fe(L),h*z+O*me(L))),s+=j?N+w*Oe:N,j^p>=r^y>=r){var $=Bt(lt(b),lt(k));ga($);var E=Bt(o,$);ga(E);var A=(j^N>=0?-1:1)*yt(E[2]);(n>A||n===A&&($[0]||$[1]))&&(l+=j^N>=0?1:-1)}}return(s<-se||s<se&&c<-1e-12)^l&1}function lr(e,a,r,n){return function(i){var o=a(i),s=ir(),l=a(s),c=!1,f,d,m,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=h,u.lineStart=S,u.lineEnd=k,d=[],f=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,d=or(d);var y=Ki(f,n);d.length?(c||(i.polygonStart(),c=!0),sr(d,Ji,y,r,i)):y&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),d=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,T){e(y,T)&&i.point(y,T)}function p(y,T){o.point(y,T)}function g(){u.point=p,o.lineStart()}function v(){u.point=b,o.lineEnd()}function h(y,T){m.push([y,T]),l.point(y,T)}function S(){l.lineStart(),m=[]}function k(){h(m[0][0],m[0][1]),l.lineEnd();var y=l.clean(),T=s.result(),R,z=T.length,N,w,L;if(m.pop(),f.push(m),m=null,!!z){if(y&1){if(w=T[0],(N=w.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),R=0;R<N;++R)i.point((L=w[R])[0],L[1]);i.lineEnd()}return}z>1&&y&2&&T.push(T.pop().concat(T.shift())),d.push(T.filter(Qi))}}return u}}function Qi(e){return e.length>1}function Ji(e,a){return((e=e.x)[0]<0?e[1]-Re-se:Re-e[1])-((a=a.x)[0]<0?a[1]-Re-se:Re-a[1])}const wn=lr(function(){return!0},Xi,es,[-re,-Re]);function Xi(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,s){var l=o>0?re:-re,c=de(o-a);de(c-re)<se?(e.point(a,r=(r+s)/2>0?Re:-Re),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(o,r),i=0):n!==l&&c>=re&&(de(a-n)<se&&(a-=n*se),de(o-l)<se&&(o-=l*se),r=Zi(a,r,o,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),i=0),e.point(a=o,r=s),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Zi(e,a,r,n){var i,o,s=fe(e-r);return de(s)>se?Vi((fe(a)*(o=me(n))*fe(r)-fe(n)*(i=me(a))*fe(e))/(i*o*s)):(a+n)/2}function es(e,a,r,n){var i;if(e==null)i=r*Re,n.point(-re,i),n.point(0,i),n.point(re,i),n.point(re,0),n.point(re,-i),n.point(0,-i),n.point(-re,-i),n.point(-re,0),n.point(-re,i);else if(de(e[0]-a[0])>se){var o=e[0]<a[0]?re:-re;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function ts(e){var a=me(e),r=2*Ae,n=a>0,i=de(a)>se;function o(d,m,u,b){Gi(b,e,r,u,d,m)}function s(d,m){return me(d)*me(m)>a}function l(d){var m,u,b,p,g;return{lineStart:function(){p=b=!1,g=1},point:function(v,h){var S=[v,h],k,y=s(v,h),T=n?y?0:f(v,h):y?f(v+(v<0?re:-re),h):0;if(!m&&(p=b=y)&&d.lineStart(),y!==b&&(k=c(m,S),(!k||Pt(m,k)||Pt(S,k))&&(S[2]=1)),y!==b)g=0,y?(d.lineStart(),k=c(S,m),d.point(k[0],k[1])):(k=c(m,S),d.point(k[0],k[1],2),d.lineEnd()),m=k;else if(i&&m&&n^y){var R;!(T&u)&&(R=c(S,m,!0))&&(g=0,n?(d.lineStart(),d.point(R[0][0],R[0][1]),d.point(R[1][0],R[1][1]),d.lineEnd()):(d.point(R[1][0],R[1][1]),d.lineEnd(),d.lineStart(),d.point(R[0][0],R[0][1],3)))}y&&(!m||!Pt(m,S))&&d.point(S[0],S[1]),m=S,b=y,u=T},lineEnd:function(){b&&d.lineEnd(),m=null},clean:function(){return g|(p&&b)<<1}}}function c(d,m,u){var b=lt(d),p=lt(m),g=[1,0,0],v=Bt(b,p),h=qt(v,v),S=v[0],k=h-S*S;if(!k)return!u&&d;var y=a*h/k,T=-a*S/k,R=Bt(g,v),z=Lt(g,y),N=Lt(v,T);ra(z,N);var w=R,L=qt(z,w),j=qt(w,w),O=L*L-j*(qt(z,z)-1);if(!(O<0)){var $=at(O),E=Lt(w,(-L-$)/j);if(ra(E,z),E=ha(E),!u)return E;var A=d[0],M=m[0],B=d[1],V=m[1],U;M<A&&(U=A,A=M,M=U);var Z=M-A,Y=de(Z-re)<se,te=Y||Z<se;if(!Y&&V<B&&(U=B,B=V,V=U),te?Y?B+V>0^E[1]<(de(E[0]-A)<se?B:V):B<=E[1]&&E[1]<=V:Z>re^(A<=E[0]&&E[0]<=M)){var K=Lt(w,(-L+$)/j);return ra(K,z),[E,ha(K)]}}}function f(d,m){var u=n?e:re-e,b=0;return d<-u?b|=1:d>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return lr(s,l,o,n?[0,-e]:[-re,e-re])}function as(e,a,r,n,i,o){var s=e[0],l=e[1],c=a[0],f=a[1],d=0,m=1,u=c-s,b=f-l,p;if(p=r-s,!(!u&&p>0)){if(p/=u,u<0){if(p<d)return;p<m&&(m=p)}else if(u>0){if(p>m)return;p>d&&(d=p)}if(p=i-s,!(!u&&p<0)){if(p/=u,u<0){if(p>m)return;p>d&&(d=p)}else if(u>0){if(p<d)return;p<m&&(m=p)}if(p=n-l,!(!b&&p>0)){if(p/=b,b<0){if(p<d)return;p<m&&(m=p)}else if(b>0){if(p>m)return;p>d&&(d=p)}if(p=o-l,!(!b&&p<0)){if(p/=b,b<0){if(p>m)return;p>d&&(d=p)}else if(b>0){if(p<d)return;p<m&&(m=p)}return d>0&&(e[0]=s+d*u,e[1]=l+d*b),m<1&&(a[0]=s+m*u,a[1]=l+m*b),!0}}}}}var ft=1e9,Mt=-ft;function ns(e,a,r,n){function i(f,d){return e<=f&&f<=r&&a<=d&&d<=n}function o(f,d,m,u){var b=0,p=0;if(f==null||(b=s(f,m))!==(p=s(d,m))||c(f,d)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==p);else u.point(d[0],d[1])}function s(f,d){return de(f[0]-e)<se?d>0?0:3:de(f[0]-r)<se?d>0?2:1:de(f[1]-a)<se?d>0?1:0:d>0?3:2}function l(f,d){return c(f.x,d.x)}function c(f,d){var m=s(f,1),u=s(d,1);return m!==u?m-u:m===0?d[1]-f[1]:m===1?f[0]-d[0]:m===2?f[1]-d[1]:d[0]-f[0]}return function(f){var d=f,m=ir(),u,b,p,g,v,h,S,k,y,T,R,z={point:N,lineStart:O,lineEnd:$,polygonStart:L,polygonEnd:j};function N(A,M){i(A,M)&&d.point(A,M)}function w(){for(var A=0,M=0,B=b.length;M<B;++M)for(var V=b[M],U=1,Z=V.length,Y=V[0],te,K,_=Y[0],G=Y[1];U<Z;++U)te=_,K=G,Y=V[U],_=Y[0],G=Y[1],K<=n?G>n&&(_-te)*(n-K)>(G-K)*(e-te)&&++A:G<=n&&(_-te)*(n-K)<(G-K)*(e-te)&&--A;return A}function L(){d=m,u=[],b=[],R=!0}function j(){var A=w(),M=R&&A,B=(u=or(u)).length;(M||B)&&(f.polygonStart(),M&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),B&&sr(u,l,A,o,f),f.polygonEnd()),d=f,u=b=p=null}function O(){z.point=E,b&&b.push(p=[]),T=!0,y=!1,S=k=NaN}function $(){u&&(E(g,v),h&&y&&m.rejoin(),u.push(m.result())),z.point=N,y&&d.lineEnd()}function E(A,M){var B=i(A,M);if(b&&p.push([A,M]),T)g=A,v=M,h=B,T=!1,B&&(d.lineStart(),d.point(A,M));else if(B&&y)d.point(A,M);else{var V=[S=Math.max(Mt,Math.min(ft,S)),k=Math.max(Mt,Math.min(ft,k))],U=[A=Math.max(Mt,Math.min(ft,A)),M=Math.max(Mt,Math.min(ft,M))];as(V,U,e,a,r,n)?(y||(d.lineStart(),d.point(V[0],V[1])),d.point(U[0],U[1]),B||d.lineEnd(),R=!1):B&&(d.lineStart(),d.point(A,M),R=!1)}S=A,k=M,y=B}return z}}const ya=e=>e;var ia=new Ze,wa=new Ze,cr,dr,ka,ja,Ve={point:Me,lineStart:Me,lineEnd:Me,polygonStart:function(){Ve.lineStart=rs,Ve.lineEnd=is},polygonEnd:function(){Ve.lineStart=Ve.lineEnd=Ve.point=Me,ia.add(de(wa)),wa=new Ze},result:function(){var e=ia/2;return ia=new Ze,e}};function rs(){Ve.point=os}function os(e,a){Ve.point=pr,cr=ka=e,dr=ja=a}function pr(e,a){wa.add(ja*e-ka*a),ka=e,ja=a}function is(){pr(cr,dr)}var ct=1/0,_t=ct,wt=-ct,Ut=wt,Vt={point:ss,lineStart:Me,lineEnd:Me,polygonStart:Me,polygonEnd:Me,result:function(){var e=[[ct,_t],[wt,Ut]];return wt=Ut=-(_t=ct=1/0),e}};function ss(e,a){e<ct&&(ct=e),e>wt&&(wt=e),a<_t&&(_t=a),a>Ut&&(Ut=a)}var Na=0,Sa=0,xt=0,Ht=0,Wt=0,ot=0,Ea=0,Ca=0,ht=0,ur,mr,$e,Be,Le={point:et,lineStart:kn,lineEnd:jn,polygonStart:function(){Le.lineStart=ds,Le.lineEnd=ps},polygonEnd:function(){Le.point=et,Le.lineStart=kn,Le.lineEnd=jn},result:function(){var e=ht?[Ea/ht,Ca/ht]:ot?[Ht/ot,Wt/ot]:xt?[Na/xt,Sa/xt]:[NaN,NaN];return Na=Sa=xt=Ht=Wt=ot=Ea=Ca=ht=0,e}};function et(e,a){Na+=e,Sa+=a,++xt}function kn(){Le.point=ls}function ls(e,a){Le.point=cs,et($e=e,Be=a)}function cs(e,a){var r=e-$e,n=a-Be,i=at(r*r+n*n);Ht+=i*($e+e)/2,Wt+=i*(Be+a)/2,ot+=i,et($e=e,Be=a)}function jn(){Le.point=et}function ds(){Le.point=us}function ps(){fr(ur,mr)}function us(e,a){Le.point=fr,et(ur=$e=e,mr=Be=a)}function fr(e,a){var r=e-$e,n=a-Be,i=at(r*r+n*n);Ht+=i*($e+e)/2,Wt+=i*(Be+a)/2,ot+=i,i=Be*e-$e*a,Ea+=i*($e+e),Ca+=i*(Be+a),ht+=i*3,et($e=e,Be=a)}function xr(e){this._context=e}xr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Oe);break}}},result:Me};var Aa=new Ze,sa,hr,gr,gt,bt,kt={point:Me,lineStart:function(){kt.point=ms},lineEnd:function(){sa&&br(hr,gr),kt.point=Me},polygonStart:function(){sa=!0},polygonEnd:function(){sa=null},result:function(){var e=+Aa;return Aa=new Ze,e}};function ms(e,a){kt.point=br,hr=gt=e,gr=bt=a}function br(e,a){gt-=e,bt-=a,Aa.add(at(gt*gt+bt*bt)),gt=e,bt=a}let Nn,Yt,Sn,En;class Cn{constructor(a){this._append=a==null?vr:fs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Sn||this._append!==Yt){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Sn=n,Yt=this._append,En=this._,this._=i}this._+=En;break}}}result(){const a=this._;return this._="",a.length?a:null}}function vr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function fs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return vr;if(a!==Nn){const r=10**a;Nn=a,Yt=function(i){let o=1;this._+=i[0];for(const s=i.length;o<s;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Yt}function xs(e,a){let r=3,n=4.5,i,o;function s(l){return l&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),rt(l,i(o))),o.result()}return s.area=function(l){return rt(l,i(Ve)),Ve.result()},s.measure=function(l){return rt(l,i(kt)),kt.result()},s.bounds=function(l){return rt(l,i(Vt)),Vt.result()},s.centroid=function(l){return rt(l,i(Le)),Le.result()},s.projection=function(l){return arguments.length?(i=l==null?(e=null,ya):(e=l).stream,s):e},s.context=function(l){return arguments.length?(o=l==null?(a=null,new Cn(r)):new xr(a=l),typeof n!="function"&&o.pointRadius(n),s):a},s.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(o.pointRadius(+l),+l),s):n},s.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const c=Math.floor(l);if(!(c>=0))throw new RangeError(`invalid digits: ${l}`);r=c}return a===null&&(o=new Cn(r)),s},s.projection(e).digits(r).context(a)}function Da(e){return function(a){var r=new Ta;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Ta(){}Ta.prototype={constructor:Ta,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ia(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),rt(r,e.stream(Vt)),a(Vt.result()),n!=null&&e.clipExtent(n),e}function yr(e,a,r){return Ia(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],s=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),l=+a[0][0]+(i-s*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([l,c])},r)}function hs(e,a,r){return yr(e,[[0,0],a],r)}function gs(e,a,r){return Ia(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),s=(i-o*(n[1][0]+n[0][0]))/2,l=-o*n[0][1];e.scale(150*o).translate([s,l])},r)}function bs(e,a,r){return Ia(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),s=-o*n[0][0],l=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([s,l])},r)}var An=16,vs=me(30*Ae);function Tn(e,a){return+a?ws(e,a):ys(e)}function ys(e){return Da({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ws(e,a){function r(n,i,o,s,l,c,f,d,m,u,b,p,g,v){var h=f-n,S=d-i,k=h*h+S*S;if(k>4*a&&g--){var y=s+u,T=l+b,R=c+p,z=at(y*y+T*T+R*R),N=yt(R/=z),w=de(de(R)-1)<se||de(o-m)<se?(o+m)/2:vt(T,y),L=e(w,N),j=L[0],O=L[1],$=j-n,E=O-i,A=S*$-h*E;(A*A/k>a||de((h*$+S*E)/k-.5)>.3||s*u+l*b+c*p<vs)&&(r(n,i,o,s,l,c,j,O,w,y/=z,T/=z,R,g,v),v.point(j,O),r(j,O,w,y,T,R,f,d,m,u,b,p,g,v))}}return function(n){var i,o,s,l,c,f,d,m,u,b,p,g,v={point:h,lineStart:S,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=T},polygonEnd:function(){n.polygonEnd(),v.lineStart=S}};function h(N,w){N=e(N,w),n.point(N[0],N[1])}function S(){m=NaN,v.point=k,n.lineStart()}function k(N,w){var L=lt([N,w]),j=e(N,w);r(m,u,d,b,p,g,m=j[0],u=j[1],d=N,b=L[0],p=L[1],g=L[2],An,n),n.point(m,u)}function y(){v.point=h,n.lineEnd()}function T(){S(),v.point=R,v.lineEnd=z}function R(N,w){k(i=N,w),o=m,s=u,l=b,c=p,f=g,v.point=k}function z(){r(m,u,d,b,p,g,o,s,i,l,c,f,An,n),v.lineEnd=y,y()}return v}}var ks=Da({point:function(e,a){this.stream.point(e*Ae,a*Ae)}});function js(e){return Da({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Ns(e,a,r,n,i){function o(s,l){return s*=n,l*=i,[a+e*s,r-e*l]}return o.invert=function(s,l){return[(s-a)/e*n,(r-l)/e*i]},o}function zn(e,a,r,n,i,o){if(!o)return Ns(e,a,r,n,i);var s=me(o),l=fe(o),c=s*e,f=l*e,d=s/e,m=l/e,u=(l*r-s*a)/e,b=(l*a+s*r)/e;function p(g,v){return g*=n,v*=i,[c*g-f*v+a,r-f*g-c*v]}return p.invert=function(g,v){return[n*(d*g-m*v+u),i*(b-m*g-d*v)]},p}function Ss(e){return Es(function(){return e})()}function Es(e){var a,r=150,n=480,i=250,o=0,s=0,l=0,c=0,f=0,d,m=0,u=1,b=1,p=null,g=wn,v=null,h,S,k,y=ya,T=.5,R,z,N,w,L;function j(A){return N(A[0]*Ae,A[1]*Ae)}function O(A){return A=N.invert(A[0],A[1]),A&&[A[0]*Ue,A[1]*Ue]}j.stream=function(A){return w&&L===A?w:w=ks(js(d)(g(R(y(L=A)))))},j.preclip=function(A){return arguments.length?(g=A,p=void 0,E()):g},j.postclip=function(A){return arguments.length?(y=A,v=h=S=k=null,E()):y},j.clipAngle=function(A){return arguments.length?(g=+A?ts(p=A*Ae):(p=null,wn),E()):p*Ue},j.clipExtent=function(A){return arguments.length?(y=A==null?(v=h=S=k=null,ya):ns(v=+A[0][0],h=+A[0][1],S=+A[1][0],k=+A[1][1]),E()):v==null?null:[[v,h],[S,k]]},j.scale=function(A){return arguments.length?(r=+A,$()):r},j.translate=function(A){return arguments.length?(n=+A[0],i=+A[1],$()):[n,i]},j.center=function(A){return arguments.length?(o=A[0]%360*Ae,s=A[1]%360*Ae,$()):[o*Ue,s*Ue]},j.rotate=function(A){return arguments.length?(l=A[0]%360*Ae,c=A[1]%360*Ae,f=A.length>2?A[2]%360*Ae:0,$()):[l*Ue,c*Ue,f*Ue]},j.angle=function(A){return arguments.length?(m=A%360*Ae,$()):m*Ue},j.reflectX=function(A){return arguments.length?(u=A?-1:1,$()):u<0},j.reflectY=function(A){return arguments.length?(b=A?-1:1,$()):b<0},j.precision=function(A){return arguments.length?(R=Tn(z,T=A*A),E()):at(T)},j.fitExtent=function(A,M){return yr(j,A,M)},j.fitSize=function(A,M){return hs(j,A,M)},j.fitWidth=function(A,M){return gs(j,A,M)},j.fitHeight=function(A,M){return bs(j,A,M)};function $(){var A=zn(r,0,0,u,b,m).apply(null,a(o,s)),M=zn(r,n-A[0],i-A[1],u,b,m);return d=Yi(l,c,f),z=ba(a,M),N=ba(d,z),R=Tn(z,T),E()}function E(){return w=L=null,j}return function(){return a=e.apply(this,arguments),j.invert=a.invert&&O,$()}}function wr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}wr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,s=o*o;r-=i=(r*(1.007226+o*(.015085+s*(-.044475+.028874*o-.005916*s)))-a)/(1.007226+o*(.015085*3+s*(-.044475*7+.028874*9*o-.005916*11*s)))}while(de(i)>se&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function Cs(){return Ss(wr).scale(175.295)}function As(e){return e}function Ts(e){if(e==null)return As;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],s=e.translate[1];return function(l,c){c||(a=r=0);var f=2,d=l.length,m=new Array(d);for(m[0]=(a+=l[0])*n+o,m[1]=(r+=l[1])*i+s;f<d;)m[f]=l[f],++f;return m}}function zs(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function qs(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return qn(e,r)})}:qn(e,a)}function qn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=Ls(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function Ls(e,a){var r=Ts(e.transform),n=e.arcs;function i(d,m){m.length&&m.pop();for(var u=n[d<0?~d:d],b=0,p=u.length;b<p;++b)m.push(r(u[b],b));d<0&&zs(m,p)}function o(d){return r(d)}function s(d){for(var m=[],u=0,b=d.length;u<b;++u)i(d[u],m);return m.length<2&&m.push(m[0]),m}function l(d){for(var m=s(d);m.length<4;)m.push(m[0]);return m}function c(d){return d.map(l)}function f(d){var m=d.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:d.geometries.map(f)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=s(d.arcs);break;case"MultiLineString":u=d.arcs.map(s);break;case"Polygon":u=c(d.arcs);break;case"MultiPolygon":u=d.arcs.map(c);break;default:return null}return{type:m,coordinates:u}}return f(a)}const kr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Rs=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Ms(e,a,r){const n=kr[e];if(!n||!n.length)return-1;const i=Rs(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(s=>i.includes(s)))return o}return Math.floor(r*n.length)%n.length}let Ot=null;function Os(){return Ot||(Ot=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=qs(r,n),o=Cs().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=xs(o),l=(i.features||[]).filter(d=>{var m;return(((m=d.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(d=>{var b;const m=((b=d.properties)==null?void 0:b.name)||"",u=s(d)||"";return u?{i2:uo(m)||null,n:m,d:u}:null}).filter(d=>!!d);if(!l.length)return null;const c={};for(const[d,m]of Object.entries(mo)){const u=o(m);u&&(c[d]={x:u[0],y:u[1]})}const f={};for(const[d,m]of Object.entries(kr)){const u=m.map(b=>o(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(f[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:l,anchors:c,metros:f}}catch{return null}})(),Ot)}function Fs(e){const[a,r]=x.useState(null);return x.useEffect(()=>{if(!e||a)return;let n=!1;return Os().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const Ps={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Ln=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Rn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Ds(e,a){const[r,n]=x.useState(1);return x.useEffect(()=>{let i=!0,o=0;const s=()=>{var f;if(!i)return;const c=(f=e.current)==null?void 0:f.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(s)};s();const l=new ResizeObserver(()=>s());return e.current&&l.observe(e.current),window.addEventListener("resize",s),()=>{i=!1,cancelAnimationFrame(o),l.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function Mn({msgs:e}){const[a,r]=x.useState(0);x.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],s)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Is(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:s,lang:l,t:c,data:f,dossiers:d}=P(),m=f.loading&&!d.length,u=x.useRef(null),b=x.useRef(null),p=Fs(e.continent==="monde"),g=e.continent==="monde"?p:Ra.find(E=>E.key===e.continent)||null,v=Ds(u,e.continent+":"+e.mapFolded+":"+!!g),[h,S]=x.useState(new Map),[k,y]=x.useState(null);x.useEffect(()=>{const E=u.current;if(!E)return;const A=new Map;E.querySelectorAll("path[data-i2]").forEach(M=>{const B=M.dataset.i2;if(B)try{const V=M.getBBox();V.width>0&&A.set(B,{x:V.x,y:V.y,w:V.width,h:V.height})}catch{}}),S(A)},[e.continent,v,g]);const T=x.useMemo(()=>r.filter(E=>E.cc),[r]),R=x.useMemo(()=>{const E=new Map;return T.forEach(A=>E.set(A.cc,(E.get(A.cc)||0)+1)),E},[T]),z=e.continent==="monde"&&p?p.anchors:null,N=e.continent==="monde"&&p?p.metros:null,w=x.useMemo(()=>T.map(E=>{const A=Rn(E.name||E.id||""),M=Rn((E.id||E.name||"")+"·y");if(z&&E.cc){const Y=N?N[E.cc]:void 0;if(Y&&Y.length){const K=Ms(E.cc,E.city,A);if(K>=0&&Y[K])return{d:E,x:Y[K].x+(A-.5)*5,y:Y[K].y+(M-.5)*5}}const te=z[E.cc];if(te)return{d:E,x:te.x+(A-.5)*10,y:te.y+(M-.5)*10}}const B=E.cc?h.get(E.cc):void 0;if(!B)return null;const V=Ps[`${e.continent}:${E.cc||""}`];if(V)return{d:E,x:B.x+B.w*(V.fx+(A-.5)*V.sx),y:B.y+B.h*(V.fy+(M-.5)*V.sy)};const U=(A-.5)*Math.min(B.w*.55,60),Z=(M-.5)*Math.min(B.h*.55,60);return{d:E,x:B.x+B.w/2+U,y:B.y+B.h/2+Z}}).filter(E=>!!E),[T,h,z,N,e.continent]),L=E=>v>0?E/v:E,j=x.useMemo(()=>n?[0,1,2,3,4,5].map(E=>({c:Ln[E],fr:c.plabels[E].toUpperCase(),en:c.plabels[E].toUpperCase(),n:r.filter(A=>A.kind==="target"&&ve(A)===E).length})).filter(E=>E.n>0):Xa.map((E,A)=>({...E,n:r.filter(M=>Za(M)===A).length})),[r,n,c.plabels]),O=o?s.get(o):null,$=O?w.find(E=>E.d.id===O.id):null;return g?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[m&&t.jsx(Mn,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":l==="fr"?g.fr:g.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:g.countries.map((E,A)=>t.jsx("g",{className:"ct"+(E.i2&&R.get(E.i2)?"":" empty"),children:t.jsx("path",{d:E.d,"data-i2":E.i2||void 0})},A))}),t.jsx("g",{children:w.map(E=>{const A=Xa[Za(E.d)],M=!!ye(E.d),B=E.d.kind==="target",V=n&&B?Ln[ve(E.d)]:A.c,U=!n&&Te(E.d);return t.jsxs("g",{className:"co"+(U?" done":""),onMouseEnter:()=>{var te,K;const Z=(te=b.current)==null?void 0:te.getBoundingClientRect(),Y=(K=u.current)==null?void 0:K.createSVGPoint();if(Y&&u.current&&Z){Y.x=E.x,Y.y=E.y;const _=Y.matrixTransform(u.current.getScreenCTM());y({x:_.x-Z.left,y:_.y-Z.top,label:E.d.name+" · "+(pt(E.d.cc,l)||E.d.countryLabel||"")})}i(E.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var te;const Z=(te=u.current)==null?void 0:te.createSVGPoint();let Y=null;if(Z&&u.current){Z.x=E.x,Z.y=E.y;const K=Z.matrixTransform(u.current.getScreenCTM());Y={x:K.x,y:K.y}}a({type:"popup",id:E.d.id,anchor:Y})},children:[t.jsx("circle",{className:"h",cx:E.x,cy:E.y,r:L(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:E.x,cy:E.y,r:L(A.px),fill:V,stroke:M?"#DC2626":"#ffffff",strokeWidth:L(M?2.2:1.3)})]},E.d.id||E.d.name)})}),$&&t.jsx("circle",{className:"ring on",cx:$.x,cy:$.y,r:L(13),fill:"none",stroke:"#0F172A",strokeWidth:L(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:j.map((E,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":E.c}}),l==="fr"?E.fr:E.en," ",t.jsx("b",{children:E.n})]},A))}),r.some(E=>!E.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(E=>!E.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:t.jsx(Mn,{msgs:c.loadMsgs})})}function $a({mapToggle:e=!0}){const{dossiers:a,st:r,dispatch:n,pipe:i,lang:o,t:s}=P(),l=x.useMemo(()=>{const c={};return a.forEach(f=>{Oa(f,r.filters,i)&&(c.monde=(c.monde||0)+1,f.continent&&(c[f.continent]=(c[f.continent]||0)+1))}),c},[a,r.filters,i]);return t.jsxs("div",{className:"conts",children:[fo.map(c=>{const f=Ra.find(m=>m.key===c),d=c==="monde"?s.contWorld:o==="fr"?f.fr:f.en;return t.jsxs("button",{type:"button",className:"cbtn","aria-selected":r.continent===c,onClick:()=>n({type:"continent",key:c}),children:[d,t.jsx("span",{className:"n",children:l[c]||0})]},c)}),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!r.mapFolded}),children:r.mapFolded?s.showMap:s.hideMap})})]})}function $s(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function jr({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:s,lang:l}=P(),c=a.filters,[f,d]=x.useState(!1),m=x.useRef(null),u=x.useMemo(()=>a.continent==="monde"?n:n.filter(N=>N.continent===a.continent),[n,a.continent]),b=N=>u.filter(w=>N!=="country"&&c.country.length&&!c.country.includes(w.cc||"")?!1:Oa(w,c,o,N==="country"?void 0:N)),p=x.useMemo(()=>{const N=b("win"),w=L=>N.filter(j=>(j.date?Math.max(0,Math.floor((Date.now()-Date.parse(j.date))/864e5)):9999)<=L).length;return[w(0),w(7),w(30),N.length]},[u,c,o]),g=x.useMemo(()=>c.day?b("win").filter(N=>(N.date||"").slice(0,10)===c.day).length:0,[u,c,o]),v=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,h=v+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);x.useEffect(()=>{a.openFacet&&d(!1)},[a.openFacet]),x.useEffect(()=>{if(!f)return;const N=L=>{var j;(j=m.current)!=null&&j.contains(L.target)||d(!1)},w=L=>{L.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",N),document.addEventListener("keydown",w),()=>{document.removeEventListener("mousedown",N),document.removeEventListener("keydown",w)}},[f]);const S=(N,w,L,j="fbtn")=>t.jsxs("button",{type:"button",className:j,"aria-expanded":a.openFacet===N,onClick:()=>r({type:"openFacet",facet:N}),children:[t.jsx("span",{className:"fl",children:w}),L>0&&t.jsx("span",{className:"n",children:L}),t.jsx("span",{className:"cv",children:"▾"})]},N),k=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay($s(c.day,l))}),t.jsx("b",{children:g})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((N,w)=>t.jsxs("button",{type:"button","aria-pressed":c.win===N,onClick:()=>r({type:"filters",patch:{win:N}}),children:[t.jsx("span",{className:"sl",children:i.dates[w]}),t.jsx("b",{children:p[w]})]},N))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:c.search,onChange:N=>r({type:"filters",patch:{search:N.target.value}})})]}),T=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):S("sec",i.fSector,c.sector.length),S("pay",i.fCountry,c.country.length),S("det",i.fEngine,c.engine.length),S("sta",i.fStage,c.stage.length),o&&S("ang","Angle",c.angle.length),o&&S("mem","Mémo",c.memoLevel.length)]}),R=t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn})]}),z=t.jsxs("div",{className:"fmenu",ref:m,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{d(N=>!N),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:T})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip",children:[t.jsxs("div",{className:"fstrip-a",children:[t.jsx($a,{}),k]}),t.jsxs("div",{className:"fstrip-b",children:[y,z,R]})]}),a.openFacet&&t.jsx(On,{poolFor:b})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[k,y,T,t.jsx("span",{className:"fgrow"}),R]}),a.openFacet&&t.jsx(On,{poolFor:b})]})}function On({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=P(),o=a.filters,s=a.openFacet,{title:l,cols:c,options:f}=x.useMemo(()=>{if(s==="sig"){const p=e("signal").filter(h=>ye(h)),g=new Map;p.forEach(h=>{const S=h.engine||"";g.set(S,(g.get(S)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...pa([...g.keys()],i).map(h=>({v:h,label:Xe(h)+" "+_e(h,i),n:g.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(s==="sec"){const p=e("sector"),g=new Map;return p.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(s==="pay"){const p=e("country"),g=new Map;return p.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:pt(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(s==="det"){const p=e("engine"),g=new Map;return p.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:pa([...g.keys()],i).map(v=>({v,label:Xe(v)+" "+_e(v,i)+' <span style="color:var(--dim);font-size:10px">· '+xo(ho(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(s==="ang"){const p=e("angle"),g=new Map;return p.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(s==="mem"){const p=e("memoLevel"),g=new Map;p.forEach(h=>{if(h.kind==="target"){const S=qa(h);g.set(S,(g.get(S)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:g.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,g)=>g[1]-p[1]).map(([p,g])=>({v:p,label:p,n:g,html:!1,on:o.stage.includes(p)}))}},[s,a,i]),d=u=>{if(s==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:u})},m=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:f.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Nr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Bs(e){var i;const a=[],r=new Set,n=o=>{const s=(o||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Fn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:s}){const{t:l}=P();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:l.rsEvalOne})]},c.name))})]}):null}function Sr({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=P(),i=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),o=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Fn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Fn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function _s({card:e,onEvaluate:a,onAddAll:r}){var l,c,f;const{t:n}=P(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Nr(e.summary_md||"").map((d,m)=>t.jsx("p",{children:d},m))})]}),t.jsx(Sr,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Us(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Vs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:s}=P(),l=i,[c,f]=x.useState(null),[d,m]=x.useState(null),[u,b]=x.useState(null),[p,g]=x.useState(!1);x.useEffect(()=>{let h=!0;return(async()=>{const S=await Kn({email:s,cbToken:l});h&&f(S)})(),()=>{h=!1}},[s,l,n]);const v=h=>{m(h),b(null),g(!0),(async()=>{const S=await go(h.id);b(S),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[Us(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(_s,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Pn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Hs(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:s,evalBusy:l,evalCards:c,caps:f,data:d,canWrite:m,source:u}=P(),b=a==="client",p=x.useMemo(()=>r||(u!=="default"?bo():""),[r,u]),[g,v]=x.useState(""),[h,S]=x.useState(!1),[k,y]=x.useState(""),[T,R]=x.useState(!1),[z,N]=x.useState(""),[w,L]=x.useState([]),j=x.useRef(!1),[O,$]=x.useState(!1),[E,A]=x.useState(""),[M,B]=x.useState(""),[V,U]=x.useState(!1),[Z,Y]=x.useState(0),[te,K]=x.useState(""),[_,G]=x.useState(null),[Q,ee]=x.useState(null),[le,we]=x.useState(!1),[ue,X]=x.useState(null),[oe,xe]=x.useState(0),q=x.useRef(!1),F=g.trim()?Pn.test(g.trim())?e.evalUrl:e.evalName:e.evalWaiting,I=x.useMemo(()=>k.split(`
`).map(D=>D.trim()).filter(Boolean).slice(0,15),[k]);x.useEffect(()=>{if(typeof window>"u")return;const D=(new URLSearchParams(window.location.search).get("rs")||"").trim();!D||!/^https?:\/\//i.test(D)||(A(D),$(!0))},[]),x.useEffect(()=>{const D=ie=>{var je;const ce=String(((je=ie.detail)==null?void 0:je.url)||"").trim();!ce||!/^https?:\/\//i.test(ce)||(A(ce),$(!0))};return window.addEventListener("ppmap:research",D),()=>window.removeEventListener("ppmap:research",D)},[]),x.useEffect(()=>{if(!m&&!p){X(null);return}let D=!0;return(async()=>{const ie=await Kn({email:n,cbToken:p});D&&X(ie.length)})(),()=>{D=!1}},[m,p,n,oe]);const J=w.length?w:c,ae=d.credits,ne=x.useCallback(D=>{const ie=D.map(ce=>(ce||"").trim()).filter(Boolean);ie.length&&(y(ce=>{const je=ce.split(`
...
`)}),S(!0))},[]);x.useEffect(()=>{if(!V)return;Y(0);const D=window.setInterval(()=>Y(ie=>ie+1),1e3);return()=>window.clearInterval(D)},[V]);const he=()=>{const D=g.trim();D&&(i(null,D),v(""))},Fe=async()=>{if(!b){i(null,I[0]||"");return}if(!I.length||T)return;R(!0),j.current=!1;const D=[];for(let ie=0;ie<I.length&&!j.current;ie++){N(e.evaluating(ie+1,I.length,I[ie]));const ce=await Qn(r,I[ie],"atelier2");if(D.unshift({name:ce.company||I[ie],verdict:ce.verdict,reason:ce.reason||"",remaining:ce.remaining??null}),L([...D]),ce.verdict==="quota"){D.unshift({name:"",verdict:"quota",reason:e.quota(I.length-ie-1),remaining:0}),L([...D]),y(I.slice(ie+1).join(`
`)),N(""),R(!1);return}}N(""),y(j.current?I.slice(D.length).join(`
`):""),R(!1)},ke=async()=>{var ce,je,He;if(q.current)return;const D=E.trim().replace(/\s+/g,""),ie=M.trim();if(!D&&!ie){K(e.rsNeed);return}if(!b&&!p){i(null,D||ie.slice(0,80));return}q.current=!0,K(""),G(null),ee(null),U(!0);try{const Se=await yo({url:D,text:ie,email:n,cbToken:p});if(U(!1),!Se||Se.status!=="success"){K((Se==null?void 0:Se.message)||"Erreur");return}G(Se),$(!1),ne((((ce=Se.prospective)==null?void 0:ce.companies_to_evaluate)||[]).map(qe=>(qe==null?void 0:qe.name)||"")),ee({state:"pending"});const pe=await wo(Se,{email:n,cbToken:p});ee(pe.ok?{state:"ok",scopeLabel:((je=pe.summary)==null?void 0:je.scope_label)||"",scope:((He=pe.summary)==null?void 0:He.scope)||""}:{state:"fail",msg:pe.error||""}),pe.ok&&xe(qe=>qe+1)}finally{q.current=!1,U(!1)}},ze=[_==null?void 0:_.industry,...(_==null?void 0:_.market_tags)||[],_==null?void 0:_.author].map(D=>(D||"").trim()).filter(Boolean),Ge=(Q==null?void 0:Q.state)==="pending",St=Q&&(Ge?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Q.state==="ok"?t.jsx("span",{className:"rslink ok",children:Q.scope&&Q.scope!=="public"?e.rsSavedIn(Q.scopeLabel||Q.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Q.msg,children:e.rsSaveFail})),nt=Bs(_).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:g,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:D=>v(D.target.value),onKeyDown:D=>{D.key==="Enter"&&he()}}),t.jsx("span",{className:"detect"+(Pn.test(g.trim())?" url":""),children:F})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),disabled:l,onClick:he,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),f.showCredits&&ae&&t.jsxs("button",{type:"button",className:"credits"+(ae.total_available<=0&&!ae.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ae.unlimited?"∞":ae.total_available}),!ae.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ae.daily_grant+ae.purchased]}),ae.total_available<=0&&!ae.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>S(!h),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(O?" on":""),onClick:()=>$(!O),children:e.rsOpen}),ue!==null&&ue>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(le?" on":""),onClick:()=>we(!le),children:e.rsArchOpen(ue)})]}),le&&t.jsx(Vs,{bump:oe,cbToken:p,onClose:()=>we(!1),onEvaluate:D=>i(null,D),onAddAll:ne}),O&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:E,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:D=>A(D.target.value),onKeyDown:D=>{D.key==="Enter"&&ke()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:M,placeholder:e.rsTextPh,onChange:D=>B(D.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(V?" loading":""),style:{justifyContent:"center"},disabled:V||Ge||!E.trim()&&!M.trim(),onClick:()=>{ke()},children:[t.jsx("span",{className:"fill"}),V?`${vo(E.trim())==="youtube"&&E.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Z)}`:Ge?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),te&&t.jsx("div",{className:"rserr",children:te}),_&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:_.title}),_.source_url&&t.jsx("a",{href:_.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{G(null),ee(null)},children:"×"})]}),_.market&&t.jsx("p",{className:"rsmk",children:_.market}),ze.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),ze.map(D=>t.jsx("span",{children:D},D))]}),t.jsxs("div",{className:"rsbody",children:[_.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${_.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Nr(_.summary_md||"").map((D,ie)=>t.jsx("p",{children:D},ie))})]}),t.jsx(Sr,{card:_,onEvaluate:D=>i(null,D),onAddAll:ne}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(nt)}),St]})]}),h&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:k,placeholder:e.bulkPh,onChange:D=>y(D.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(T?" loading":""),style:{justifyContent:"center"},disabled:T||!I.length,onClick:()=>{Fe()},children:[t.jsx("span",{className:"fill"}),T&&z?z:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(I.length)})]})]}),J.slice(0,1).map((D,ie)=>{const ce=D.verdict==="kept",je=D.verdict==="quota",He=ce?"var(--brand)":je?"var(--bolt)":"var(--red)",Se=ce?"var(--brand-l)":je?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":He,"--bgc":Se},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ce?"✓ "+e.kept:je?"⏳":"✗ "+e.dropped})}),D.name&&t.jsx("span",{className:"rn",children:D.name}),t.jsx("span",{className:"rr",children:D.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",D.reason]}):null}),!!(D.candidates&&D.candidates.length)&&t.jsx("span",{className:"sitepick",children:D.candidates.map(pe=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:pe.url.startsWith("http")?pe.url:`https://${pe.url}`,target:"_blank",rel:"nofollow noopener",children:[(pe.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,pe.url),children:e.evalPickGo})]},pe.url))}),!je&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:ce?1:5});const pe=(D.name||"").trim().toLowerCase();window.setTimeout(()=>{const qe=[...document.querySelectorAll(".atl2 .list .row")].find(Jt=>{var Et;return(((Et=Jt.querySelector(".rnm"))==null?void 0:Et.textContent)||"").trim().toLowerCase().includes(pe)});qe&&(qe.scrollIntoView({behavior:"smooth",block:"center"}),qe.classList.add("flashrow"),window.setTimeout(()=>qe.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ce?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ie)}),b&&(o.kept+o.dropped>0||J.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Ws(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ys(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=P(),o=e.memoConsole?r.get(e.memoConsole):null,s=x.useMemo(()=>o?[o.reasoning||"",Ws(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const l=Ye(o),c=qa(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:s?s.split(`

`).map((f,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[st(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const la={},Dn=(la==null?void 0:la.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function In(){return new Date().toISOString().slice(0,10)}const Ba=x.createContext(null);function Gs(){return x.useContext(Ba)}function Ks(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),s=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),l.querySelectorAll("*").forEach(c=>{const f=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(d=>c.removeAttribute(d.name)),f&&/^https?:\/\//i.test(f)&&(c.setAttribute("href",f),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:l.outerHTML})}}catch{}return a}function $n(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${o} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${o} ${r[1]}`}function Er(){const e=x.useContext(Ba);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Qs({token:e,children:a}){const{dispatch:r,st:n,lang:i}=P(),[o,s]=x.useState(()=>n.filters.day||In()),[l,c]=x.useState(null),[f,d]=x.useState(!1),m=x.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){s(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=x.useCallback(()=>{s(In());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);x.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),x.useEffect(()=>{const g=v=>{var S;const h=(S=v.detail)==null?void 0:S.day;typeof h=="string"&&m(h)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[m]),x.useEffect(()=>{n.filters.day&&n.filters.day!==o&&s(n.filters.day)},[n.filters.day]),x.useEffect(()=>{if(!e||!o)return;let g=!1;d(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${Dn}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{g||c(h)}).catch(()=>{g||c({ok:!1,error:"network"})}).finally(()=>{g||d(!1)}),()=>{g=!0}},[e,o]);const b=x.useMemo(()=>`${Dn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=x.useMemo(()=>({token:e,day:o,ed:l,loading:f,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,l,f,m,u,n.filters.day,b,i]);return t.jsx(Ba.Provider,{value:p,children:a})}function Js(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Er(),[i,o]=x.useState(n);return x.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(s=>!s),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(ko,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function Xs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Er(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!s,c=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),l&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:$n(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:$n(e)}),"."]})}),s&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,s&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}function Cr({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=P(),[s,l]=x.useState(!1),[c,f]=x.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const d=async()=>{if(s)return;l(!0);const m=await jo(r,e);if(l(!1),!m){o(a.actErr);return}f(m.results||[])};return t.jsxs("div",{className:"simb",onClick:m=>m.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{d()},children:s?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(m=>t.jsxs("li",{children:[t.jsx("b",{className:m.verdict==="kept"?"ok":"ko",children:m.company}),m.reason&&t.jsx("span",{children:m.reason})]},m.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Zs=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ft=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function el(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Ft(a.slice(n));break}r+=Ft(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Ft(a.slice(i));break}const s=a.slice(i+1,o).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(s),c=l?l[2].toLowerCase():"";l&&Zs.has(c)?r+=`<${l[1]}${c}>`:r+=Ft(a.slice(i,o+1)),n=o+1}return r}const Bn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ne({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function tl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function al({o:e}){const{t:a,doDeep:r}=P(),[n,i]=x.useState(!1),o=Ye(e),s=[e.reasoning||"",tl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),s.length?s.join(`

`).split(`

`).map((l,c)=>t.jsx("p",{className:"cdtxt",children:l},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[st(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:l=>{l.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:l=>{l.stopPropagation(),i(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:l=>l.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:l=>l.stopPropagation()})]})}function Ar({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=P(),o=jt(e),s=Ye(e),l=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),m=x.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.reasoning?1:0)+(s?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||st(e)?1:0}].filter(g=>g.n>0),[e,a,l,s,c,f,d]),[u,b]=x.useState("");if(!m.length)return null;const p=m.some(g=>g.k===u)?u:m[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:m.map(g=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===g.k,"data-tour":"tab-"+g.k,className:p===g.k?"on":"",onClick:v=>{v.stopPropagation(),b(g.k)},children:g.lib},g.k))}),t.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[t.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ne,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Ne,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Ne,{k:a.cdVerdictDate,v:Bn(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:el(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(nl,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ne,{k:a.cdSector,v:e.sector}),t.jsx(Ne,{k:a.cdStage,v:e.stage}),t.jsx(Ne,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ne,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Ne,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Ne,{k:a.cdAngle,v:e.angle}),t.jsx(Ne,{k:a.cdDetected,v:Bn(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ne,{k:a.cdName,v:e.contactName}),t.jsx(Ne,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Ne,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(al,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ne,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Ne,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function nl({o:e}){const{t:a,token:r}=P(),[n,i]=x.useState(!1),[o,s]=x.useState(null),l=async()=>{n||(i(!0),s(await No(r,e.name,e.website||e.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],d=f.some(([,m])=>m);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),o&&d&&t.jsxs(t.Fragment,{children:[f.filter(([,m])=>m).map(([m,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:m}),t.jsx("p",{children:u})]},m)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!d&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Kt({spec:e}){const a=x.useRef(null),r=x.useRef(null),[n,i]=x.useState(!1);return x.useEffect(()=>{const o=a.current;if(!o)return;let s=!1;return en({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(l=>{!s&&l&&o.isConnected&&o.replaceChildren(l)}),()=>{s=!0,o.replaceChildren()}},[e]),x.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let s=!1;en({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!s&&c&&o.isConnected&&o.replaceChildren(c)});const l=c=>{c.key==="Escape"&&i(!1)};return document.addEventListener("keydown",l),()=>{s=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const rl=`
...
`;function ol(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let l=e.y+10;return l+n>o-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:s,top:l}}function il(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:s,askEvaluate:l,doAnalyse:c,doDecide:f,doPromote:d,doRepeche:m,doApproach:u,doDeep:b,doOnboard:p,outbound:g,evalBusy:v}=P(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const S=ye(h),k=ve(h),y=Ye(h),T=jt(h),R=h.kind==="target",z=N=>{a({type:"filters",patch:N}),a({type:"popup",id:null})};return dt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:rl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:ol(e.popupAnchor,!!h.card),onClick:N=>N.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(We(h.date)),_e(h.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>z({country:[h.cc]}),children:(pt(h.cc,i)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>z({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>z({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:Nt(h.amountEur,i)})]}),o.pipe&&R&&t.jsxs("div",{className:"pstat",children:[T&&t.jsx("span",{className:"vd "+(T==="MATCH"?"v-ok":"v-no"),title:n.vt[T],children:T}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[k]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Xe(h.engine)," ",t.jsx("b",{children:_e(h.engine,i)})," — ",So(h.engine,i),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),S?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(tt,{o:h,lg:!0})," ",t.jsx(Qt,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Ma(S,i))," · ",n.win7(Dt(S,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(Kt,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&k>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),o.pipe&&R&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),o.pipe&&R&&t.jsx(Ar,{o:h})]}),t.jsx(Cr,{name:h.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||s!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[k===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>l(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),k===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),k===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),k===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(h,!1),a({type:"popup",id:null})},children:n.actNo}),st(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(h),a({type:"popup",id:null})},children:n.memoDeep})]}),k===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),k===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),g&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var N;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(N=document.querySelector(".atl2 .demand"))==null||N.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(h.name),onClick:()=>l(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>l(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}const sl=8;function ll(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:s}=P(),[l,c]=x.useState(!1),[f,d]=x.useState(!1),[m,u]=x.useState(!1),b=`atl2:sincemini:${r||"home"}`,[p,g]=x.useState(()=>{try{return localStorage.getItem(b)==="1"}catch{return!1}}),v=()=>{g(N=>{try{localStorage.setItem(b,N?"0":"1")}catch{}return!N})},h=r||"home",{names:S,verdicts:k}=x.useMemo(()=>{const N=[],w={};return n.forEach(L=>{L.kind!=="target"||!L.name||(N.push(L.name),w[L.name]=Eo(L)||"")}),{names:N,verdicts:w}},[n]),y=x.useMemo(()=>S.length?Co(h,S,k,a):null,[h,S.length]);if(!i.pipe||l||!y||y.firstVisit||!y.added.length&&!y.gone.length)return null;const T=f?y.added:y.added.slice(0,sl),R=y.added.length-T.length,z=N=>{const w=n.find(L=>L.name===N);w&&(o(w.id),s({type:"popup",id:w.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(y.added.length,y.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:v,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{c(!0),Ao(h,S,k,y.fp,a)},children:"×"})]}),!!y.added.length&&t.jsxs("div",{className:"sg-c",children:[T.map(N=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>z(N),children:t.jsx("b",{children:N})},N)),R>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>d(!0),children:e.sinceMore(R)})]}),!!y.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(N=>!N),children:e.sinceOut(y.gone.length)}),m&&y.gone.slice(0,20).map(N=>t.jsx("span",{className:"gone",children:N},N))]})]})}const Tr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function _a({o:e}){const{t:a}=P(),r=jt(e),n=Ye(e),i=ve(e),o=da(e),s=To(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(Tr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:a.waitTitle(s),children:a.waitChip(s)})]})}const Gt=e=>e.length>22?e.slice(0,21)+"…":e;function _n({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=P(),[o,s]=x.useState(!1);if(x.useEffect(()=>{n||s(!1)},[n]),Te(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Gt(e.name))})]})}function zr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:s,doPromote:l,doRepeche:c,doApproach:f,dispatch:d}=P();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:b=>{b.stopPropagation(),d({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var p;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(p=document.querySelector(".atl2 .demand"))==null||p.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var p;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(p=document.querySelector(".atl2 .demand"))==null||p.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(_n,{o:e})});const m=ve(e),u=b=>p=>{p.stopPropagation(),b()};if(m===0)return t.jsx("span",{className:"cell",children:t.jsx(_n,{o:e})});if(m===1){const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:u(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(m===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(m===4){const b=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:b,onClick:u(()=>f(e)),children:b?a.actApproachSent:a.actApproach})})}return m===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):m===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function cl({o:e}){const{t:a,doThumb:r,thumbOf:n}=P(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function dl({o:e}){const{lang:a}=P();return ye(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(tt,{o:e}),t.jsx(Qt,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Xe(e.engine||"")," ",_e(e.engine||"",a)]})})}function pl({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:s,markRow:l,markedId:c,favIds:f,toggleFav:d,t:m}=P(),u=ve(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],p=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,g=p<=0?0:p<=7?1:p<=30?2:3,v=s.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:b[g],h=f.has(e.id),S=k=>{if(a)return;if(s.pipe||e.kind==="op"){n();return}const y=k.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:y.left+Math.min(280,y.width/3),y:y.bottom}})};return t.jsxs(x.Fragment,{children:[t.jsxs("div",{className:"row"+(c===e.id||r?" on":"")+(r?" open":"")+(a?" tzr":""),onMouseEnter:()=>l(e.id),onMouseLeave:()=>l(null),onClick:S,children:[t.jsx("span",{className:"pt",style:{"--c":v}}),t.jsx(Mr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[s.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:h?1:.35,padding:0,marginRight:4},onClick:k=>{k.stopPropagation(),d(e)},children:h?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(k=>k&&k!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:k=>{k.stopPropagation(),o({type:"acquirer",value:e.acquirer||""})},children:["← ",Gt(e.acquirer)]}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(ul,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(dl,{o:e}),s.pipe&&t.jsx(_a,{o:e}),s.pipe&&!a&&t.jsx(Ri,{o:e}),s.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(zr,{o:e}),s.showThumbs&&t.jsx(cl,{o:e})]}),r&&!a&&t.jsx(fl,{o:e})]})}function ul({o:e}){const{lang:a,caps:r}=P();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Nt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function ml({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=P(),s=(u,b=!1)=>p=>{p.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Nt(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Te(e),m=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},children:[m?"✓":"✗"," ",t.jsx("b",{children:m?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Gt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Gt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Kt,{spec:e.card})})]})}function fl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:s}=P();return!i.pipe&&e.kind==="op"?t.jsx(ml,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Ar,{o:e}),t.jsx(Mi,{o:e}),t.jsx(Pi,{o:e}),t.jsx(Cr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(_a,{o:e})})]}),e.card&&t.jsx(Kt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Xe(e.engine||"")," ",_e(e.engine||"",r)]}),ye(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(tt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function xl({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:s}=P();if(!i.pipe&&e.kind==="op"){const f=Nt(e.amountEur,s),d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),m=(u,b=!1)=>p=>{p.stopPropagation(),b&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Kt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:m({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:m({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:m({stage:[e.stage]}),children:e.stage}),f&&t.jsx("span",{className:"damt",children:f})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Xe(e.engine||"")," ",_e(e.engine||"",s)]}),ye(e)&&t.jsx(tt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(zr,{o:e})})]})}const l=ve(e),c=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return t.jsxs("div",{className:"dcard"+(a?" tzr":""),style:{"--c":c},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(_a,{o:e}),ye(e)&&t.jsx(tt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&l===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function hl(){const{t:e}=P(),[a,r]=x.useState(0);return x.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function gl({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=P(),o=i==="en",s=d=>n.plabels[d]||"",l=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),c=l.includes(0)?0:l.sort((d,m)=>(e[m]||0)-(e[d]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${s(c)}”`:`${f} dossier${f>1?"s":""} dans « ${s(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(o?"Open ":"Ouvrir ")+s(c)," →"]})]})}function bl(){var oe,xe;const e=P(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:s,scopedAll:l,markRow:c,lang:f,sessTally:d,data:m,dossiers:u,source:b}=e,p=i.lockRowsAfter!==null?Number.MAX_SAFE_INTEGER:b==="ops"?8:Xn,[g,v]=x.useState(new Set);x.useEffect(()=>{v(new Set)},[a.ptab,a.continent]);const[h,S]=x.useState(null);x.useEffect(()=>{S(null)},[a.ptab,a.continent]);const k=q=>v(F=>{const I=new Set(F);return I.has(q)?I.delete(q):I.add(q),I}),[y,T]=x.useState("all"),[R,z]=x.useState(!1);x.useEffect(()=>{T("all"),z(!1)},[a.ptab,a.continent]),x.useEffect(()=>{if(!R)return;const q=F=>{var I,J;(J=(I=F.target)==null?void 0:I.closest)!=null&&J.call(I,".atl2 .doable")||z(!1)};return document.addEventListener("click",q),()=>document.removeEventListener("click",q)},[R]);const N=Gs(),w=x.useMemo(()=>{var F;const q=new Map;for(const I of Ks(((F=N==null?void 0:N.ed)==null?void 0:F.html)||""))q.has(I.t)||q.set(I.t,I.html);return q},[(oe=N==null?void 0:N.ed)==null?void 0:oe.html]),L=x.useCallback(q=>{if(q.decryptHtml)return q.decryptHtml;if(!w.size)return;const F=(q.name||"").trim().toLowerCase();if(F.length<3)return;const I=w.get(F);if(I)return I;for(const[J,ae]of w)if(J.includes(F)||F.includes(J))return ae},[w]),j=x.useMemo(()=>{const q=Fa(s,a.sort);return y==="all"?q:q.filter(F=>y==="explore"?!!F.noCo:!F.noCo)},[s,a.sort,b,y]),O=x.useMemo(()=>i.pipe?l.filter(q=>ye(q)&&ve(q)>=1):j.filter(q=>ye(q)&&!Te(q)),[i.pipe,l,j]),$=O.length,[E,A]=x.useState(!1),[M,B]=x.useState(!1),V=`atl2:sigmini:${((xe=m.session)==null?void 0:xe.token)||"home"}`,[U,Z]=x.useState(()=>{try{return localStorage.getItem(V)==="1"}catch{return!1}}),Y=x.useMemo(()=>i.pipe?j:j.filter(q=>!Te(q)&&!q.noCo),[j,i.pipe]),te=b==="ops"?j.filter(q=>q.noCo).length:0,K=i.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,_=a.filters,G=[];if(_.day)G.push({k:"day",lib:n.fDay(_.day.slice(8,10)+"/"+_.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(_.win&&_.win!=="all"){const q=["1","7","30"].indexOf(_.win);q>=0&&G.push({k:"win",lib:n.dates[q],off:()=>r({type:"filters",patch:{win:"all"}})})}const Q=q=>q.length<=2?q.join(", "):`${q.length} ${n.fSelected}`;for(const q of["sector","country","engine"]){const F=_[q];F&&F.length&&G.push({k:q,lib:Q(F),off:()=>r({type:"clearFacet",facet:q})})}_.search&&G.push({k:"search",lib:"🔍 "+_.search,off:()=>r({type:"filters",patch:{search:""}})});const ee=(q,F,I="",J=!1)=>t.jsxs("button",{type:"button","data-s":q,className:I,"aria-sort":a.sort.key===q?a.sort.dir===1?"ascending":"descending":"none",style:J?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:q}),children:[F,t.jsx("span",{className:"ar",children:a.sort.key===q&&a.sort.dir===1?"▴":"▾"})]},q),le=x.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const q=new Map;j.forEach(J=>{const ae=J.engine||"?";q.has(ae)||q.set(ae,[]),q.get(ae).push(J)});const F={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},I=pa([...q.keys()],f);return[...q.entries()].sort((J,ae)=>{const ne=F[J[0]]??10+I.indexOf(J[0]),he=F[ae[0]]??10+I.indexOf(ae[0]);return ne-he})},[j,i.pipe,a.groupBy,f]),we=i.lockRowsAfter;let ue=0;const X=(q,F)=>{let I=a.shown[F]||p;return q.length-I<=4&&(I=q.length),q.slice(0,I).map(ne=>{const he=we!==null&&ue>=we;ue++;const Fe=L(ne),ke=Fe&&Fe!==ne.decryptHtml?{...ne,decryptHtml:Fe}:ne,ze=a.dens!=="maxi"&&(a.dens==="deplie"||(h?h==="open":!!Fe)),Ge=g.has(ne.id)?!ze:ze;return a.dens==="maxi"?t.jsx(xl,{o:ke,locked:he},ne.id):t.jsx(pl,{o:ke,locked:he,open:Ge,onToggle:()=>k(ne.id)},ne.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:j.length})," ",K]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",G.map(q=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:F=>{F.stopPropagation(),q.off()},children:[q.lib,t.jsx("i",{children:"×"})]},q.k)),b==="ops"&&j.length>0&&" — "+n.edSplit(j.length-te,te)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([q,F])=>t.jsxs("button",{type:"button","data-d":q,"aria-pressed":a.dens===q||q==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:q}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:F})]},q))}),(i.showFunnel||b==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":h==="open",onClick:()=>{S("open"),v(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":h==="closed",onClick:()=>{S("closed"),v(new Set)},children:n.foldAllLbl}),b==="ops"&&t.jsxs("button",{type:"button","aria-pressed":h===null,onClick:()=>{S(null),v(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||b==="ops")&&(()=>{var I;const q=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],F=((I=q.find(([J])=>J===y))==null?void 0:I[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":R,onClick:()=>z(J=>!J),children:[F,t.jsx("i",{children:"▾"})]}),R&&t.jsx("div",{className:"dolist",children:q.map(([J,ae])=>t.jsx("button",{type:"button","aria-pressed":y===J,onClick:()=>{T(J),z(!1)},children:ae},J))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:q=>r({type:"sort",key:q.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([q,F])=>t.jsx("option",{value:q,children:F},q))})]}),i.showChain&&Y.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:Y.map(q=>q.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(Y.length):n.chainAll(Y.length)]}),a.mapFolded&&t.jsxs(t.Fragment,{children:[t.jsx($a,{}),t.jsx(jr,{compact:!0})]})]}),t.jsx(ll,{}),$>0&&!a.filters.signalOnly&&!M&&t.jsxs("div",{className:"sigstrip"+(U?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip($)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!U,title:U?n.boxExpand:n.boxCollapse,onClick:()=>Z(q=>{try{localStorage.setItem(V,q?"0":"1")}catch{}return!q}),children:U?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>B(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(E?O:O.slice(0,12)).map(q=>{const F=ye(q);return F?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(Ma(F,f),Dt(F,f)),onClick:()=>{c(q.id),r({type:"popup",id:q.id})},children:[t.jsx("b",{children:q.name}),t.jsxs("i",{children:[F.emoji," ",ua(F,f)]}),t.jsx("em",{children:Dt(F,f)})]},"sg-"+q.id):null}),!E&&O.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>A(!0),children:n.sigStripMore(O.length-12)})]})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ee("country",n.colCountry),ee("name",n.colCompany),ee("amount",n.colAmount,"h-amt",!0),ee("stage",n.colStage,"h-stade"),ee("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ee("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ee("memo",n.colMemo)]}),i.pipe&&ee("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(j.length?"":" list-empty"),children:[le?le.map(([q,F])=>t.jsxs(x.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Xe(q)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:_e(q,f)}),t.jsx("div",{className:"s",children:n.grpCount(F.filter(I=>!Te(I)).length,F.length)})]})]}),X(F,q)]},q)):X(j,"pt"+a.ptab),m.loading&&!u.length&&t.jsx(hl,{}),!j.length&&!(m.loading&&!u.length)&&(i.pipe?t.jsx(gl,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const q=le||[["pt"+a.ptab,j]];let F=0,I=0;for(const[ae,ne]of q){I+=ne.length;let he=a.shown[ae]||p;ne.length-he<=4&&(he=ne.length),F+=Math.min(ne.length,he)}const J=I-F;return J<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>q.forEach(([ae,ne])=>r({type:"more",group:ae,by:ne.length,base:p})),children:[t.jsx("span",{className:"more-label",children:n.more(J,J)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(F,I)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}})]})}function Un(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function vl(e,a){const r=zo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function yl(e,a){const n=[a.head.split("|").map(Un).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",vl(i,a.plabels),jt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Un).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function wl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const kl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ie({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function jl({o:e,qa:a}){const{t:r,lang:n,fund:i}=P(),o=(e.cribleStatus||"").trim().toUpperCase()||(jt(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=Ye(e),l=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Ie,{k:r.cdSector,v:e.sector}),t.jsx(Ie,{k:r.cdStage,v:e.stage}),t.jsx(Ie,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ie,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Ie,{k:r.cdName,v:e.contactName}),t.jsx(Ie,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Ie,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Ie,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Ie,{k:r.cdAngle,v:e.angle}),t.jsx(Ie,{k:r.cdDetected,v:kl(e.date,n)})]}),c.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,f])=>f).map(([f,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:d})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Nl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:s}=P(),[l,c]=x.useState({}),f=25,d=x.useMemo(()=>n.slice(0,f),[n]);x.useEffect(()=>{d.length&&qo(r,d.map(b=>b.name)).then(c)},[r,d]);const m=o.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),m&&typeof m.screened=="number"&&t.jsxs("p",{children:[u(m.screened)," ",e.funScreened(""),typeof m.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(m.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(m.screened/o.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(jl,{o:b,qa:l[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Sl=50;function Ua({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=P(),[o,s]=x.useState(null),[l,c]=x.useState(!1),[f,d]=x.useState(""),[m,u]=x.useState(0),[b,p]=x.useState(""),[g,v]=x.useState(!1),h=x.useRef(null);x.useEffect(()=>()=>{h.current&&window.clearInterval(h.current)},[]);const S=async y=>{c(!0),d("");const T=await a();if(c(!1),T.ok){s(T);return}if(T.busy){d(i.alertPreviewBusy);return}if(!y){d(i.alertPreviewFail);return}u(Sl),h.current=window.setInterval(()=>{u(R=>R>1?R-1:(h.current&&window.clearInterval(h.current),S(!1),0))},1e3)},k=async()=>{if(n||g)return;v(!0),p("");const y=await r();v(!1),p(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||m>0,onClick:()=>{S(!0)},children:l?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||g,onClick:()=>{k()},children:g?"…":i.alertTest})]}),m>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(m)}),f&&t.jsx("p",{className:"mnote warn",children:f}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const it="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ce({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=P();return dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function El(){const{st:e}=P();switch(e.modal){case"chain":return t.jsx(Al,{});case"space":return t.jsx(Tl,{});case"alert":return t.jsx(zl,{});case"queue":return t.jsx(Ol,{});case"export":return t.jsx(Fl,{});case"plug":return t.jsx(Il,{});case"recharge":return t.jsx(Bl,{});case"cover":return t.jsx(Ul,{});case"dossier":return t.jsx(_l,{});case"crit":return t.jsx(Vl,{});case"tuto":return t.jsx(Hl,{});case"rdv":return t.jsx(Cl,{});case"memoalert":return t.jsx(Pl,{});default:return null}}function Cl(){const{dispatch:e,fund:a}=P(),r=typeof document<"u"&&!!document.getElementById("rdv");return x.useEffect(()=>{r&&(e({type:"modal",modal:null}),Ci())},[r,e]),r?null:t.jsx(Mo,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Al(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:s,evalBusy:l,caps:c,memoQueued:f,doAnalyse:d}=P(),m=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,p=u[b],g=b>=u.length;return dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:g?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(g?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:g||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[pt(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(We(p.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:_e(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:Nt(p.amountEur,i)})]}),ye(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(tt,{o:p,lg:!0})," ",t.jsx(Qt,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),m&&Te(p)&&t.jsxs("div",{className:"vbox",style:{"--c":Je(p)==="retenu"?"var(--brand)":Je(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Je(p)==="retenu"?"✓ "+n.kept:Je(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!g&&p&&c.pipe&&ve(p)===1&&!f.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!g&&p&&!(m&&Te(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{s(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(g?{type:"modal",modal:null}:{type:"chainNext"}),children:g?n.closeBtn:n.skip})]})]})})}),document.body)}function Tl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=P(),o=i==="client",s=x.useMemo(()=>o?r.filter(m=>Te(m)):[],[r,o]),l=x.useMemo(()=>Fa(s.filter(m=>Je(m)==="retenu"),{key:"signal",dir:-1}),[s]),c=x.useMemo(()=>s.filter(m=>Je(m)==="ecarte"),[s]),f=e.spaceTab==="retenu"?l:c,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ce,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(m=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof m.score=="number"&&m.score>0?m.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:m.name}),t.jsx("div",{className:"rr",children:m.reasoning||m.tagline||""})]})]},m.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function zl(){const{mode:e}=P();return e==="client"||e==="apercu"?t.jsx(ql,{}):t.jsx(Ml,{})}function ql(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=P(),[o,s]=x.useState("d"),l=i!=="client";return t.jsxs(Ce,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(Ll,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),o==="w"&&t.jsx(Rl,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),o==="m"&&t.jsx(qr,{})]})}function Ll({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,s]=x.useState(null),[l,c]=x.useState(!1),[f,d]=x.useState(0);x.useEffect(()=>{let p=!0;return c(!1),nn(a).then(g=>{p&&(g?s(g):c(!0))}),()=>{p=!1}},[a,f]);const m=p=>{r||nn(a,p).then(g=>{if(!g){i(e.actErr);return}s(g),g.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),b=p=>{const g=o.sections||e.alertSec.map(([v])=>v);m({sections:u(p)?g.filter(v=>v!==p):[...g,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,g])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>b(p)}),t.jsxs("span",{children:[g,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ua,{label:e.alertPreview,readOnly:r,onPreview:()=>_o(a),onTest:()=>Bo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Rl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,s]=x.useState(null),[l,c]=x.useState(!1),[f,d]=x.useState(0);x.useEffect(()=>{let p=!0;return c(!1),rn(a).then(g=>{p&&(g?s(g):c(!0))}),()=>{p=!1}},[a,f]);const m=p=>{r||rn(a,p).then(g=>{if(!g){i(e.actErr);return}s(g),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,b=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>m({dow:Number(p.target.value)}),children:e.alertDow.map((p,g)=>t.jsx("option",{value:g,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ua,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Vo(a),onTest:()=>Uo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function qr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=P(),[s,l]=x.useState(o||""),[c,f]=x.useState(!1),[d,m]=x.useState(!1);x.useEffect(()=>{o&&l(o)},[o]);const u=e.filters,b=x.useMemo(()=>n.filter(h=>ye(h)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(s)||d)){m(!0);try{await fetch(`${za}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{m(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>_e(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>pt(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([h,S])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:S}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!o,onChange:h=>l(h.target.value),onKeyDown:h=>{h.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Ml(){const{t:e}=P();return t.jsx(Ce,{title:e.alertTitle,icon:"🔔",children:t.jsx(qr,{})})}function Ol(){var z,N;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:s,caps:l,dispatch:c}=P(),[f,d]=x.useState(null),[m,u]=x.useState([]),[b,p]=x.useState(0),g=n==="client",v=x.useMemo(()=>{const w=new Map;return i.forEach(L=>{const j=(L.name||"").trim().toLowerCase();j&&!w.has(j)&&w.set(j,L)}),w},[i]);x.useEffect(()=>{let w=!0;return(async()=>{const[L,j]=await Promise.all([La(r),Gn(a)]);w&&(L&&d(L),u(j))})(),()=>{w=!1}},[a,r,b]);const h=(f==null?void 0:f.per_day)??0,S=((z=f==null?void 0:f.analyzed_today)==null?void 0:z.length)??0,k=f==null?void 0:f.offre,y=(f==null?void 0:f.pool_meta)||[],T=x.useMemo(()=>{const w=new Map;for(const L of(f==null?void 0:f.scheduled)||[])for(const j of L.names||[])w.has(j)||w.set(j,{label:L.day_label,date:L.date});return w},[f==null?void 0:f.scheduled]),R=(f==null?void 0:f.in_progress)||[];return t.jsxs(Ce,{title:e.queueTitle,wide:!0,children:[k&&t.jsxs("div",{className:"qoffre"+(k.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:k.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:k.delai})]}),t.jsx("span",{className:"osp"}),k.rythme>0?t.jsx("span",{className:"or",children:e.qRate(k.rythme)}):k.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(k.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(S,S+(((N=f==null?void 0:f.pool_order)==null?void 0:N.length)??0))}})}),k&&t.jsxs("div",{className:"qeta",children:[k.file===0?e.qEtaDone:k.rythme<=0?e.qEtaPaused:e.qEta(k.file,k.rythme,k.jours_restants),k.en_retard&&t.jsxs("em",{children:[" ",e.qLate(k.delai,k.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(h)}),(k==null?void 0:k.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),R.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsx("div",{className:"qrows",children:R.map(w=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:w.name}),t.jsxs("span",{className:"qd",children:[w.memo_type||"",w.age_min?` · ${Math.round(w.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:w.state||""})]},"ip-"+w.name))})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(w=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:w.company}),t.jsxs("span",{className:"qd",children:[w.memo_type,typeof w.est_min=="number"?` · ~${w.est_min} min`:""]}),t.jsx("span",{className:"qt",children:w.status}),w.url&&t.jsx("a",{className:"qgo",href:w.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),g&&w.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{an(a,w.company,"retry").then(()=>p(L=>L+1))},children:e.queueRetry}),g&&w.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{an(a,w.company,"delete").then(()=>p(L=>L+1))},children:e.queueDelete})]},w.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(y.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[y.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),y.map((w,L)=>{const j=T.get(w.name),O=v.get((w.name||"").trim().toLowerCase()),$=!!(O&&s.has(O.id)),E=!!(O&&ve(O)===1&&!O.memoUrl);return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",L+1]}),j?t.jsx("span",{className:"qwhen"+(j.label==="demain"?" soon":""),children:j.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:w.name}),w.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof w.score=="number"&&t.jsx("span",{className:"qs2",children:w.score}),E&&(l.lockActions||!g?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:$,onClick:()=>{o(O),p(A=>A+1)},children:$?e.actAnalyseQueued:e.actAnalyse})),w.excerpt&&t.jsx("span",{className:"qex",children:w.excerpt})]},w.name+":"+L)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([w,L])=>t.jsxs("li",{children:[t.jsx("b",{children:w})," — ",L]},w))})]})}function Fl(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:s}=P(),l=`${it}/cibles/list.csv?token=${a}`,c=`${it}/cibles/list.json?token=${a}`,f=`${it}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${l}")`,m=v=>{var h;(h=navigator.clipboard)==null||h.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:d},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:f,href:f}],b=!i.lockActions&&n.length>0,p=()=>{wl(yl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([h])=>h===v)||["",""])[1]})),r(e.exportViewDone(n.length))},g=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ce,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:g,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:h,href:S})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>m(h),children:e.exportCopy}),S&&t.jsx("a",{className:"exb",href:S,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Pl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=P(),o=i!=="client",[s,l]=x.useState(null),[c,f]=x.useState(!1),[d,m]=x.useState(0),[u,b]=x.useState(!1);x.useEffect(()=>{let h=!0;return f(!1),tn(a).then(S=>{h&&(S?l(S):f(!0))}),()=>{h=!1}},[a,d]);const p=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=h=>{if(o||!s)return;const S={enabled:h.enabled??!!s.enabled,email:h.email??(s.email||""),sections:h.sections??p()};b(!0),tn(a,S).then(k=>{if(b(!1),!k){n(e.memoAlertErr);return}l(k),r(e.memoAlertSaved)})};if(c)return t.jsx(Ce,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(h=>h+1),children:e.retry})]})});if(!s)return t.jsx(Ce,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=p();return t.jsxs(Ce,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:o||u,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(Dl,{value:s.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>g({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,S])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[h],disabled:o||u,onChange:()=>g({sections:{...v,[h]:!v[h]}})}),t.jsx("span",{children:S})]},h))}),t.jsx(Ua,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>Ro(a,v),onTest:()=>Lo(a,v)})]})}function Dl({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,s]=x.useState(e);x.useEffect(()=>{s(e)},[e]);const l=o.trim()!==e.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&l&&c&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!c,onClick:()=>i(o.trim()),children:n})]})]})}function Il(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=P(),[o,s]=x.useState(null),[l,c]=x.useState(!1),[f,d]=x.useState(null),[m,u]=x.useState(""),[b,p]=x.useState(0);x.useEffect(()=>{let k=!0;return c(!1),ma(a).then(y=>{k&&(y?s({configured:y.configured,url_hint:y.url_hint}):c(!0))}),Po(a).then(y=>{k&&d(y)}),()=>{k=!1}},[a,b]);const g=(k,y)=>{i&&ma(a,k).then(T=>{if(!T||T.ok===!1){n(e.actErr);return}k.test&&T.sent===!1?n(e.plugTestThrottled):r(y),p(R=>R+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),S=`curl -X POST ${it}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ce,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(k=>k+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:m,disabled:!i,onChange:k=>u(k.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!m.trim(),onClick:()=>g({url:m.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var k;(k=navigator.clipboard)==null||k.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx($l,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:S}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var k;(k=navigator.clipboard)==null||k.writeText(S).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var k;(k=navigator.clipboard)==null||k.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function $l(){const{t:e,token:a,lang:r}=P(),[n,i]=x.useState("valides"),[o,s]=x.useState(!1),[l,c]=x.useState(null),[f,d]=x.useState(null),[m,u]=x.useState(!1),[b,p]=x.useState(!1),[g,v]=x.useState(null),[h,S]=x.useState(null),[k,y]=x.useState(null),T=`atl2:bulk:${a}:${n}`;x.useEffect(()=>{ma(a).then(O=>{S(O&&O.configured?O.url_hint||"webhook":null)})},[a]),x.useEffect(()=>{c(null),d(null),u(!1),v(null);try{const O=JSON.parse(localStorage.getItem(T)||"null");y(O&&Date.now()-Date.parse(O.t)<24*3600*1e3?O:null)}catch{y(null)}},[T]);const R=async()=>{s(!0),u(!1),v(null);const O=await Io(a,n);c(O),d(O.ok?n:null),s(!1)},z=x.useRef(!1),N=async()=>{if(z.current)return;z.current=!0,p(!0);const O=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let $;try{$=await $o(a,n,"webhook",void 0,O)}finally{z.current=!1}if(p(!1),u(!1),v($),$.ok&&($.pushed||0)>0){const E={t:new Date().toISOString(),n:$.pushed||0};y(E);try{localStorage.setItem(T,JSON.stringify(E))}catch{}}},w=l!=null&&l.ok&&l.ready||0,L=!!(l!=null&&l.ok)&&f===n&&w>0&&!!h&&!k,j=k?new Date(k.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:O=>i(O.target.value),children:e.plugBulkTabs.map(([O,$])=>t.jsx("option",{value:O,children:$},O))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{R()},children:o?"…":e.plugBulkPreview})]}),l&&(l.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(l.ready||0,l.linkedinReady||0,(l.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(l!=null&&l.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),k&&t.jsx("p",{className:"mnote",children:e.bulkLocked(j,k.n)}),!k&&!!(l!=null&&l.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!k&&!l&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),L&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),L&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(w,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{N()},children:b?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),g&&(g.ok?g.replayed?t.jsx("p",{className:"mnote",children:g.pending?e.bulkPending:e.bulkReplayed}):(g.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:g.error||e.actErr}))]})}function Bl(){const{t:e,data:a,lang:r}=P(),n=a.credits,i=a.email,o=async s=>{if(!i)return;const l=window.location.href.split("?")[0];try{const f=await(await fetch(`${za}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:s,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(Ce,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function _l(){const{t:e}=P();return t.jsx(Ce,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Nl,{})})}function Ul(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:s,flash:l}=P(),[c,f]=x.useState(null),[d,m]=x.useState(!1);x.useEffect(()=>{let w=!0;if(o)return La(o).then(L=>{w&&L&&typeof L.per_day=="number"&&f(L.per_day)}),()=>{w=!1}},[o]);const[u,b]=x.useState(null);x.useEffect(()=>{if(!i)return;let w=!0;return Fo(i).then(L=>{w&&b(L)}),()=>{w=!1}},[i]);const p=r.stats,g=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(w=>w.kind==="target"&&Te(w)).length,v=r.marketEstimate||0,h=v>0?Math.min(100,Math.round(g/v*100)):null,S=(p==null?void 0:p.window_days)||30,k=g>0?g/S:0,y=v>0?Math.max(0,v-g):0,R=v>0&&k>0&&g>=100?Math.round(y/k):null,z=w=>Math.round(w).toLocaleString(a==="en"?"en-US":"fr-FR"),N=w=>{d||!s||(m(!0),Do(i,w).then(L=>{if(m(!1),L===null){l(e.actErr);return}f(L),l(e.alertSaved)}))};return t.jsxs(Ce,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(z(g))}),v>0&&t.jsx("span",{children:e.covOf(z(v))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),R!==null&&t.jsx("p",{className:"mnote",children:e.covEta(R)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),k>=1&&t.jsx("p",{className:"mnote",children:e.covPace(z(k))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((w,L)=>t.jsxs("tr",{className:w.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[w.code,w.geo?` · ${w.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof w.n=="number"?z(w.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:w.source}),w.elargi&&t.jsx("em",{children:e.covWide(String(w.demande||""))}),w.erreur&&t.jsx("em",{children:e.covMissing})]})]},L)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:z(u.total||v)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:z(p.shown)})," ",e.funShown]})]}),s&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(w=>t.jsx("button",{type:"button",className:c===w?"on":"",disabled:d,onClick:()=>N(w),children:w===0?"⏸":w},w))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Vl(){var h,S,k;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:s,lang:l}=P(),c=n==="client",f=x.useMemo(()=>{const y=new Set;return a.forEach(T=>{T.angle&&y.add(T.angle)}),[...y]},[a]),[d,m]=x.useState(""),[u,b]=x.useState(""),[p,g]=x.useState(!1),v=async()=>{const y=d.trim();if(!(!y||p||!c)){g(!0),b("");try{const R=await(await fetch(`${it}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(R.reply&&b(String(R.reply)),R.job_id){b(e.critChatRunning);const z=async()=>{const N=await fetch(`${it}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:R.job_id})}).then(w=>w.json()).catch(()=>null);if(N&&N.done){b(String(N.reply||N.clarification||N.summary||"✓")),g(!1),N.applied&&i(e.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),m("");return}m("")}finally{u.startsWith("⏳")||g(!1)}}};return t.jsxs(Ce,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((h=o.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((S=o==null?void 0:o.angles)!=null&&S.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var T,R;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((T=y.look)!=null&&T.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(z=>t.jsx("li",{children:z},z))})]}),!!((R=y.out)!=null&&R.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(z=>t.jsx("li",{children:z},z))})]})]})]},y.title)})]}),!!((k=o==null?void 0:o.gate)!=null&&k.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||p,onChange:y=>m(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!c||p||!d.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Oo,{fund:s,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,T])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Tr[y]||"v-cons"),children:y}),t.jsx("span",{children:T})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,T])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",T]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Hl(){const{t:e,dispatch:a,startTour:r}=P(),n=i=>{var o,s;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs(Ce,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+s))})]})}const Lr="atl2:mapfold",Wl=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Lr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Rr=x.createContext(null),P=()=>{const e=x.useContext(Rr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function tt({o:e,lg:a}){const{lang:r}=P(),n=ye(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:ua(n,r),children:[n.emoji," ",ua(n,r)]}):null}function Qt({o:e,src:a}){const{lang:r,t:n}=P(),i=ye(e);if(!i)return null;const o=Ko(i),s=Qo(i);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(Ma(i,r))+" · "+n.win7(Dt(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,c)=>t.jsx("i",{className:c<o?"on":""},c))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Mr({o:e}){const{lang:a}=P(),r=Go(e.cc),n=e.cc?pt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Vn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Yl=!1;function Gl(){const[e,a]=x.useState(!1);return x.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Or=e=>`atl2:tour:${e||"anon"}`;function Kl(e){try{return localStorage.getItem(Or(e))==="1"}catch{return!0}}function Hn(e){try{localStorage.setItem(Or(e),"1")}catch{}}function Ql(e,a,r,n,i){const o=e.tourT,s=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:s[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:s[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:s[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:s[0][0],modal:"crit"}].filter(Boolean)}function tc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var Ha;const{lang:s}=Ho(),l=ri[s],c=hi(e,s,a),[f,d]=x.useReducer(vi,void 0,()=>gi((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Wl(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),m=x.useRef(!0);x.useEffect(()=>{if(m.current){m.current=!1;return}if(!e)try{localStorage.setItem(Lr,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e]);const u=x.useRef(o);u.current=o,x.useEffect(()=>{var C;(C=u.current)==null||C.call(u,f.filters)},[f.filters]);const[b,p]=x.useState(null),[g,v]=x.useState(null),[h,S]=x.useState({kept:0,dropped:0}),[k,y]=x.useState(!1),[T,R]=x.useState(""),[z,N]=x.useState(!1),[w,L]=x.useState(null),[j,O]=x.useState(!1),[$,E]=x.useState(!1),[,A]=x.useState(0),M=()=>A(C=>C+1),B=x.useRef([]),V=x.useRef(new Set),U=x.useRef(new Set),Z=x.useRef(new Map),Y=x.useRef(null),{mode:te}=c,K=x.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),_=K.pipe,G=c.session.token||"",Q=te==="client"&&!e;x.useEffect(()=>{if(document.querySelector(`link[href="${Vn}"]`))return;const C=document.createElement("link");C.rel="stylesheet",C.href=Vn,document.head.appendChild(C)},[]);const ee=(C,H=!1)=>{R(C),N(H),Y.current&&clearTimeout(Y.current),Y.current=setTimeout(()=>R(""),H?4200:2400)},le=C=>ee(C,!0),we=x.useMemo(()=>{const C=new Map;return c.dossiers.forEach(H=>{H.id&&C.set(H.id,H)}),C},[c.dossiers]),ue=x.useMemo(()=>c.dossiers.filter(C=>Zn(C,f,_)),[c.dossiers,f,_]),X=x.useRef(!1);x.useEffect(()=>{if(X.current||e||c.loading||!c.dossiers.length)return;if(!K.showFunnel||Kl(c.session.token||"")){X.current=!0;return}X.current=!0;const C=window.setTimeout(()=>{Hn(c.session.token||""),O(!0)},700);return()=>window.clearTimeout(C)},[e,c.loading,c.dossiers.length,K.showFunnel,c.session.token]);const oe=x.useMemo(()=>c.dossiers.filter(C=>yi(C,f,_,c.favIds)),[c.dossiers,f,_,c.favIds]),xe=x.useMemo(()=>Wo(ue,c.favIds),[ue,c.favIds]),q=x.useMemo(()=>{const C=nr(c.dossiers);return C?We(C)===0?l.tourToday:rr(C,s):l.tourNoRun},[c.dossiers,l,s]),F=x.useMemo(()=>c.dossiers.some(C=>!!C.memoUrl||!!C.summary||st(C)),[c.dossiers]),[I,J]=x.useState(!1);x.useEffect(()=>{if(c.loading){J(!1);return}if(c.dossiers.length>0||c.error){J(!0);return}const C=window.setTimeout(()=>J(!0),6e3);return()=>window.clearTimeout(C)},[c.loading,c.dossiers.length,c.error]);const ae=(c.marketEstimate||0)>0||typeof((Ha=c.stats)==null?void 0:Ha.screened)=="number"&&c.stats.screened>0,ne=x.useMemo(()=>[1,0,2,4,5,3].find(C=>(xe[C]||0)>0)??0,[xe]),he=Ra.find(C=>C.key===f.continent),Fe=f.continent==="monde"?l.contWorld:(s==="fr"?he==null?void 0:he.fr:he==null?void 0:he.en)||"";x.useEffect(()=>{const C=H=>{var ge;const W=(((ge=H.detail)==null?void 0:ge.name)||"").trim();W&&ke(null,W)};return window.addEventListener("ppmap:evaluate",C),()=>window.removeEventListener("ppmap:evaluate",C)}),x.useEffect(()=>{const C=ge=>{const Pe=String(ge||"").trim();Pe&&d({type:"filters",patch:{sector:[Pe]}})},H=ge=>{var Pe;return C((Pe=ge.detail)==null?void 0:Pe.sector)},W=ge=>{ge.data&&ge.data.type==="pp-filter"&&C(ge.data.sector)};return window.addEventListener("ppmap:filter",H),window.addEventListener("message",W),()=>{window.removeEventListener("ppmap:filter",H),window.removeEventListener("message",W)}},[]);const ke=(C,H)=>{const W=((C==null?void 0:C.name)||H||"").trim();if(!Q){v({kicker:W});return}!W||k||(y(!0),(async()=>{try{let ge=W;const Pe=((C==null?void 0:C.website)||(C==null?void 0:C.domain)||"").trim();if(Pe)ge=Pe;else try{const be=await Jo(W);if(be!=null&&be.website)ge=be.website;else if(((be==null?void 0:be.candidates)||[]).length===1)ge=be.candidates[0].url;else if(((be==null?void 0:be.candidates)||[]).length>1){B.current=[{name:W,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(be.candidates||[]).slice(0,5)},...B.current].slice(0,8),M();return}}catch{}const De=await Qn(G,ge,"atelier2"),_r={name:De.company||W,verdict:De.verdict,reason:De.reason||"",remaining:De.remaining??null};B.current=[_r,...B.current].slice(0,8),De.verdict==="kept"&&S(be=>({...be,kept:be.kept+1})),De.verdict==="ruled_out"&&S(be=>({...be,dropped:be.dropped+1}));const ut=C||c.dossiers.find(be=>(be.name||"").toLowerCase()===W.toLowerCase());ut&&(De.verdict==="kept"?ut.verdict=ut.verdict||"MATCH":De.verdict==="ruled_out"&&(ut.verdict="NO MATCH"),De.reason&&(ut.reasoning=De.reason)),M()}finally{y(!1)}})())},ze=C=>{if(!Q){v({kicker:C.name});return}V.current.add(C.id),mt(G,"fast_request",C.name||"",""),ee(l.memoInstantSent(C.name)),M()},Ge=C=>Z.current.get(C.id)??c.thumbs.get((C.name||"").trim().toLowerCase()),St=(C,H)=>d({type:"undoPush",entry:{id:C.id,name:C.name,prevCeoStatus:H}}),nt=async(C,H,W)=>{const ge=C.ceoStatus||"";C.ceoStatus=H,M();const Pe=await ea(G,{status:H,airtable_id:C.airtableId,check_id:C.checkId,company:C.name,...(W==null?void 0:W.note)!==void 0?{note:W.note}:{},...W!=null&&W.via?{via:W.via}:{}});return Pe.ok?Pe.skipped?(C.ceoStatus=ge,M(),le(l.actNotPersisted),!1):((W==null?void 0:W.undo)!==!1&&St(C,ge),W!=null&&W.msg&&ee(W.msg),(H==="Validé"||H==="Écarté")&&!C.ceoNote&&(W==null?void 0:W.note)===void 0&&L({o:C,yes:H==="Validé"}),!0):(C.ceoStatus=ge,M(),le(l.actErr),!1)},D=async(C,H)=>{const W=await ea(G,{status:C.ceoStatus||"Retenu",airtable_id:C.airtableId,check_id:C.checkId,company:C.name,note:H,via:"note"});return!W.ok||W.skipped?(le(W.skipped?l.actNotPersisted:l.actErr),!1):(C.ceoNote=H,M(),!0)},ie=x.useRef(new Map),ce=C=>ie.current.has(C.id)?ie.current.get(C.id):c.stages.get((C.name||"").trim().toLowerCase()),je=(C,H)=>{ie.current.set(C.id,H),M()},He=(C,H)=>{Q&&nt(C,H?"Validé":"Écarté",{msg:H?l.decidedYes(C.name):l.decidedNo(C.name)})},Se=C=>{Q&&nt(C,"À trancher",{msg:l.promoted(C.name)})},pe=C=>{Q&&(async()=>{const H=C.ceoStatus||"";C.ceoStatus="Retenu",M();const W=await ea(G,{status:"Retenu",check_id:C.checkId,company:C.name});if(!W.ok||W.skipped){C.ceoStatus=H,M(),le(W.skipped?l.actNotPersisted:l.actErr);return}St(C,H),ee(l.repeched(C.name))})()},qe=()=>{const C=f.undo[f.undo.length-1];if(!C){ee(l.undoNone);return}const H=we.get(C.id);if(!H){d({type:"undoPop"}),ee(l.undoNone);return}let W=C.prevCeoStatus;if(!W)if((H.verdict||"").toUpperCase().includes("CALL"))W="À trancher";else{ee(l.undoLockedTitle);return}(async()=>await nt(H,W,{undo:!1})&&(d({type:"undoPop"}),H.ceoStatus=C.prevCeoStatus,M(),ee(l.undoDone(H.name))))()},Jt=C=>{Q&&(U.current.add(C.id),M(),(async()=>{const H=await Xo(G,C.name,"email");if(!H||H.ok===!1){U.current.delete(C.id),M(),le(l.actErr);return}mt(G,"approach",C.name||"",""),ee(l.actApproachSent)})())},Et=(C,H)=>{Q&&(async()=>{if(!(await mt(G,H?"yes":"no",C.name||"","")).ok){le(l.actErr);return}Z.current.set(C.id,H?"yes":"no"),M(),ee(H?l.thumbUpDone:l.thumbDnDone)})()},Fr=C=>{!Q||!st(C)||(mt(G,"detailed_request",C.name||"",""),ee(l.memoDeepSent(C.name)))},Pr=C=>{const H=new Set(c.favIds),W=H.has(C.id);W?H.delete(C.id):H.add(C.id),c.setFavIds(H),Q&&Zo(G,{id:C.id,co:C.name},W)},Dr=()=>{!Q||$||window.confirm(l.identSyncConfirm)&&(E(!0),(async()=>{const C=await ei(G);E(!1),C?ee(l.identSyncDone):le(l.actErr)})())},Va=/proplace/i.test(c.fund||""),Ir=C=>{!Q||!Va||(mt(G,"onboard_request",C.name||"",""),ee(l.onboardSent(C.name)))},$r={st:f,dispatch:d,t:l,lang:s,mode:te,caps:K,pipe:_,token:G,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:pe,thumbOf:Ge,canWrite:Q,commitStatus:nt,saveNote:D,stageOf:ce,setStage:je,flashErr:le,startTour:()=>O(!0),dossiers:c.dossiers,scopedAll:ue,scoped:oe,counts:xe,byId:we,contName:Fe,favIds:c.favIds,toggleFav:Pr,askEvaluate:ke,doAnalyse:ze,doDecide:He,doPromote:Se,doApproach:Jt,doThumb:Et,doDeep:Fr,doUndo:qe,doSync:Dr,doOnboard:Ir,outbound:Va,memoQueued:V.current,approachDone:U.current,sessTally:h,evalCards:B.current,evalBusy:k,markRow:p,markedId:b,flash:ee};x.useEffect(()=>{const C=H=>{H.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[]);const Br=C=>G?t.jsx(Qs,{token:G,children:C}):t.jsx(t.Fragment,{children:C});return t.jsx(Rr.Provider,{value:$r,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:si}),K.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:tr,children:Pa}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${It}`,children:It})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),Br(t.jsxs("div",{className:"app"+(_?" pipe":"")+(G?" has-thesis":""),children:[K.showTicker&&t.jsx(Ee,{name:"live",children:t.jsxs("div",{className:"live-stack"+(G?" live-stack--cibles":""),children:[t.jsx(Si,{}),!!G&&t.jsx(Js,{})]})}),K.showIdent&&t.jsx(Ee,{name:"identite",children:t.jsx($i,{})}),!1,!!G&&t.jsx(Ee,{name:"brief",children:t.jsx(Xs,{})}),Yl,K.showMorning&&t.jsx(Ee,{name:"matin",children:t.jsx(Ii,{})}),t.jsx(Ee,{name:"mesure",children:t.jsx(qi,{})}),K.showFunnel&&t.jsx(Ee,{name:"entonnoir",children:t.jsx(Jl,{})}),K.showFunnel&&t.jsx(Ee,{name:"tunnel",children:t.jsx(Bi,{})}),K.showFunnel&&t.jsx(Ee,{name:"tuto",children:t.jsx(_i,{})}),!f.mapFolded&&t.jsx(Ee,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx($a,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[t.jsx(Is,{}),t.jsx(jr,{})]})]})}),K.showDemand&&t.jsx(Ee,{name:"evaluation",children:t.jsx(Hs,{})}),K.showDemand&&f.memoConsole&&t.jsx(Ee,{name:"console",children:t.jsx(Ys,{})}),t.jsx(Ee,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(bl,{})}),c.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:l.retry})]})]})),f.popupId&&t.jsx(Ee,{name:"fiche",children:t.jsx(il,{})}),t.jsx(Ee,{name:"modales",children:t.jsx(El,{})}),t.jsx(Ti,{}),w&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:w.o.name}),t.jsx(Fi,{placeholder:w.yes?l.whyYesPh:l.whyNoPh,onDone:C=>{const H=w.o;L(null),C&&D(H,C).then(W=>{W&&ee(l.csNoteSaved)})}})]}),j&&I&&t.jsx(Di,{steps:Ql(l,q,F,ne,ae),onClose:()=>{O(!1),Hn(G)}}),t.jsx(Gl,{}),T&&t.jsx("div",{className:"flash on"+(z?" err":""),children:T}),g&&t.jsx(Yo,{variant:"acquirer",initialCompany:Wn().co,initialWebsite:Wn().site,onClose:()=>v(null)})]})})}function Jl(){const{t:e}=P(),[a,r]=x.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Wn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Xl(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Mr as FlagCell,tt as SigBadge,Qt as SigWin,tc as default,Xl as fmtShort,P as useV2};
