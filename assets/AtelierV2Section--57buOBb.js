...
`;class ve extends f.Component{constructor(){super(...arguments);Ua(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const wi=8;function ki(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=P(),[s,p]=f.useState(!1),[g,d]=f.useState(!1),[m,u]=f.useState(!1),b=r||"home",{names:c,verdicts:x}=f.useMemo(()=>{const y=[],C={};return n.forEach(q=>{q.kind!=="target"||!q.name||(y.push(q.name),C[q.name]=to(q)||"")}),{names:y,verdicts:C}},[n]),v=f.useMemo(()=>c.length?ao(b,c,x,a):null,[b,c.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const h=g?v.added:v.added.slice(0,wi),j=v.added.length-h.length,N=y=>{const C=n.find(q=>q.name===y);C&&(o(C.id),l({type:"popup",id:C.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),no(b,c,x,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[h.map(y=>t.jsx("button",{type:"button",onClick:()=>N(y),children:y},y)),j>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(j)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(y=>!y),children:e.sinceOut(v.gone.length)}),m&&v.gone.slice(0,20).map(y=>t.jsx("span",{className:"gone",children:y},y))]})]})}const aa=600,Ge=62,on="atl2:fstats";function ji(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=P(),[l,s]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(on)==="on"}catch{return!1}}),p=r.stats,g=f.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=(p==null?void 0:p.since)||"";if(!n.showFunnel||!p||typeof p.screened!="number")return null;const m=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,u=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((N,y)=>Math.max(N,y.s||0),0),c=g.length?aa/g.length:0,x=Math.max(4,c-4),v=g.length>=5&&b>0,j=[[typeof p.screened_window=="number"?p.screened_window:p.screened,e.funScreened(d?m(d):"",m(new Date().toISOString().slice(0,10))),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[j.map(([N,y,C],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(N)}),t.jsx("i",{children:y}),void 0]},y)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const N=!l;s(N),N&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(on,N?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${aa} ${Ge}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((N,y)=>{const C=(N.s||0)/b*(Ge-4),q=(N.m||0)/b*(Ge-4),T=y*c+(c-x)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:T,y:Ge-2-C,width:x,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:T,y:Ge-2-q,width:x,height:q,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:Ge-1.5,x2:aa,y2:Ge-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const er=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Ni(e,a){if((We(e)||"").startsWith("CALL")&&be(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=be(e)>=2;return er.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function Si({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=P(),[s,p]=f.useState(!1),[g,d]=f.useState(""),[m,u]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),c=async x=>{if(g)return;if(x==="Analysé"&&!e.memoUrl){u(!0);return}d(x);const v=await i(e,x);d(""),v&&(p(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:x=>x.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{p(x=>!x),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),s&&t.jsx("span",{className:"rstm",children:m?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),p(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{d("Analysé");const x=await i(e,"Analysé");d(""),x&&(p(!1),u(!1))})()},children:a.csAnaAnyway})]}):Ni(e,a).map(([x,v])=>t.jsx("button",{type:"button",className:"rsti"+(b===x?" on":"")+(g===x?" busy":""),disabled:!!g,onClick:()=>{c(x)},children:v},x))})]})}function Ci({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=P(),[o,l]=f.useState(""),[s,p]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(We(e)||"").startsWith("CALL")&&be(e)===3,m=be(e)>=2,u=async c=>{if(o||c==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(c);const x=await i(e,c);l(""),x&&(p(!0),setTimeout(()=>p(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:er.filter(([c])=>!(m&&c==="Retenu")).map(([c,x])=>[c,a[x]]);return t.jsxs("div",{className:"csp",onClick:c=>c.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([c,x])=>t.jsx("button",{type:"button",className:"csb"+(g===c?" on":"")+(o===c?" busy":""),disabled:!!o,onClick:()=>{u(c)},children:x},c)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Ei,{o:e})]})}function Ei({o:e}){const{t:a,saveNote:r,flash:n}=P(),[i,o]=f.useState(e.ceoNote||""),[l,s]=f.useState(!1),[p,g]=f.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!d)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{m()},children:p?a.csNoteSaved:a.csNoteOk})]})}function Ai({placeholder:e,onDone:a}){const{t:r}=P(),[n,i]=f.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function zi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=P(),[p,g]=f.useState(!1);if(!n.pipe||!i||n.lockActions||be(e)!==4)return null;const d=o(e),m=(d==null?void 0:d.stage)||"todo",u=async h=>{if(p||h===m)return;g(!0);const j=d;l(e,{stage:h,stamps:(d==null?void 0:d.stamps)||{}});const N=Math.max(Date.now(),sn+=1);sn=N;const y=await ro(r,{company:e.name||"",stage:h,cts:N,deal_id:e.airtableId,check_id:e.checkId});g(!1),!y.stale&&(y.ok||(l(e,j),s(a.actErr)))},b=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,c=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,x=m==="sent"&&b&&c>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,j])=>t.jsx("button",{type:"button",className:"stgb"+(m===h?" on":""),disabled:p,onClick:()=>{u(h)},children:j},h)),x&&t.jsx("span",{className:"stgj4",children:a.j4Badge(c)})]})}let sn=0;const At=8,zt=360;function ln({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function cn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(ln,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(ln,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function Ti({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=P(),[l,s]=f.useState(0),[p,g]=f.useState(null),[d,m]=f.useState([]),u=f.useRef(!1),b=f.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),c=f.useRef(!1);f.useEffect(()=>{const T=b.current;return()=>{c.current||(n({type:"ptab",tab:T.ptab}),n({type:"dens",dens:T.dens}),n({type:"modal",modal:T.modal}))}},[]),f.useEffect(()=>{u.current||(u.current=!0,m(e.filter(T=>!!document.querySelector(T.need||T.sel))))},[e]);const x=d[l],v=l>=d.length;f.useEffect(()=>{if(x&&(x.ptab!==void 0&&o.ptab!==x.ptab&&n({type:"ptab",tab:x.ptab}),x.dens&&o.dens!==x.dens&&n({type:"dens",dens:x.dens}),o.modal!==(x.modal??null)&&n({type:"modal",modal:x.modal??null}),x.click)){const T=x.click,L=window.setTimeout(()=>{const E=document.querySelector(T);E&&E.getAttribute("aria-selected")!=="true"&&E.click()},60);return()=>window.clearTimeout(L)}},[l,x]);const h=f.useRef(-1),j=f.useCallback(()=>{if(!x){g(null);return}const T=document.querySelector(x.sel)||(x.need?document.querySelector(x.need):null);if(!T){g(null);return}h.current!==l&&(h.current=l,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=T.getBoundingClientRect();g(E=>E&&Math.abs(E.top-L.top)<1&&Math.abs(E.left-L.left)<1&&Math.abs(E.width-L.width)<1&&Math.abs(E.height-L.height)<1?E:L)},[x,l]);f.useLayoutEffect(()=>{j();const T=[90,300,700,1300].map(E=>window.setTimeout(j,E)),L=()=>j();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{T.forEach(E=>window.clearTimeout(E)),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[j]);const N=f.useRef(a);if(N.current=a,f.useEffect(()=>{const T=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),N.current()):L.key==="ArrowRight"?s(E=>E+1):L.key==="ArrowLeft"&&s(E=>Math.max(0,E-1))};return document.addEventListener("keydown",T,!0),()=>document.removeEventListener("keydown",T,!0)},[]),!d.length)return null;let y=null;const C=T=>()=>{c.current=!0,n({type:"modal",modal:null}),T()};if(v){const T=i[3]||0;T>0?y={title:T===1?r.ahaATitle1:r.ahaATitleN(T),body:r.ahaABody,btn:r.ahaABtn,go:C(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:C(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:C(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:C(()=>{n({type:"modal",modal:"crit"}),a()})}}let q={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:zt};if(!v&&p){const T=p.bottom+14,E=window.innerHeight-T>190?T:Math.max(12,p.top-200);q={left:Math.min(Math.max(12,p.left+p.width/2-zt/2),window.innerWidth-zt-12),top:E,width:zt}}return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-At,top:p.top-At,width:p.width+At*2,height:p.height+At*2}}),(v||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:q,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(cn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:x==null?void 0:x.title}),t.jsx(cn,{text:(x==null?void 0:x.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(T=>Math.max(0,T-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(T=>T+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function tr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function ar(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function qi(){var T;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:s,dispatch:p}=P(),g=r?a:e,d=f.useMemo(()=>g.filter(L=>He(L.date)===0&&L.kind==="target"),[g]),m=f.useMemo(()=>r?a.filter(L=>be(L)===0).slice().sort((L,E)=>(E.date||"").localeCompare(L.date||"")):[],[a,r]),u=f.useMemo(()=>d.filter(L=>r?be(L)===0:!Ce(L)),[d,r]),b=r?m:u,c=r?a.length-m.length:d.length-u.length,x=r?a.length:d.length,v=x?Math.min(100,c/x*100):100,h=f.useMemo(()=>tr(g),[g]),j=!!h&&He(h)>0,N=f.useMemo(()=>j?g.filter(L=>(L.date||"").slice(0,10)===h):[],[g,h,j]),y=typeof((T=s.stats)==null?void 0:T.kept_today)=="number"?s.stats.kept_today:null;let C;j?C=i.morningLast(N.length,m.length,ar(h,l)):r?C=i.morningThesis(d.length,m.length,y):d.length?c===0?C=i.goalSourced(d.length):c>=d.length?C=i.goalCleared:C=i.goalDone(c,d.length):C=i.goalSourced(0);const q=()=>{if(!r){p({type:"pile",on:!0});return}p({type:"ptab",tab:0}),n==="client"&&m.length&&p({type:"chainStart",queue:m.map(L=>L.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:C}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:q,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Li(){var $,_;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:g,startTour:d}=P(),[m,u]=f.useState(null),[b,c]=f.useState(!0),[x,v]=f.useState([]),h=p==="client";f.useEffect(()=>{if(!i||!o)return;let w=!0;return c(!0),(async()=>{const[k,O]=await Promise.all([Ta(o),Vn(i)]);w&&(k&&u(k),c(!1),v(O))})(),()=>{w=!1}},[i,o]);const j=(m==null?void 0:m.per_day)??null,N=(($=m==null?void 0:m.pool_order)==null?void 0:$.length)??0,y=x.filter(w=>w.status==="running").length,C=f.useMemo(()=>s.filter(w=>w.kind==="target"&&Ce(w)).length,[s]),q=l.marketEstimate,T=typeof((_=l.stats)==null?void 0:_.screened)=="number"?l.stats.screened:C,L=q&&q>0?Math.min(100,Math.round(T/q*100)):null,E=w=>w.toLocaleString(a==="en"?"en-US":"fr-FR"),z=(o||"P").split(/\s+/).map(w=>w[0]).join("").slice(0,2).toUpperCase(),R=(()=>{const w=Date.parse(l.generatedAt||"");if(Number.isNaN(w))return"";const k=new Date(w),O=B=>String(B).padStart(2,"0");return`${O(k.getDate())}/${O(k.getMonth()+1)} à ${O(k.getHours())}:${O(k.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?z:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),R?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(R)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&T>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:E(T)})})]}),L!==null&&q&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(T,q)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),j!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:j})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),j===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(N)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:w=>{w.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!h,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:w=>n({type:"filters",patch:{search:w.target.value}})})]})]})]})}const Ri=["--p0","--p1","--p2","--p3","--p4"];function Mi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=P(),s=o.loading&&!l.length,p=f.useRef({});f.useEffect(()=>{p.current={...r}},[r]);const g=u=>{const b=p.current[u],c=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ri[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(c>0?" up":c<0?" down":""),children:[r[u],c!==0&&t.jsxs("em",{className:"delta",children:[c>0?"+":"−",Math.abs(c)]})]})]},u)},d=(u,b,c)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:c.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,c,x=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:x,onClick:c,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Oi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Fi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=P(),s=f.useRef(null),[p,g]=f.useState(60);f.useEffect(()=>{let b=0;const c=()=>{var N;const x=s.current;if(!x)return;const v=(N=x.parentElement)==null?void 0:N.querySelector('.funnel [aria-selected="true"]');if(!v)return;const h=v.getBoundingClientRect(),j=x.getBoundingClientRect();g(Math.max(20,Math.min(h.left+h.width/2-j.left,j.width-30)))};return b=requestAnimationFrame(c),window.addEventListener("resize",c),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",c)}},[e.ptab]);const d=e.ptab;let m=r.tuto[d].p;if(d===3){const b=n.filter(v=>v.kind==="target"&&be(v)===3),c=b.filter(v=>la(v)==="auto").length,x=b.filter(v=>la(v)==="cd").length;m=r.tutoPending(c,x,b.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(b=>b.id)})};if(d===1){const b=n.filter(c=>c.kind==="target"&&be(c)===1&&!i.has(c.id)).slice(0,10);if(b.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:b.map(c=>c.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Oi[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Je{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Pi(e){for(const a of e)yield*a}function nr(e){return Array.from(Pi(e))}var ne=1e-6,Q=Math.PI,Te=Q/2,dn=Q/4,Le=Q*2,_e=180/Q,Se=Q/180,ie=Math.abs,Di=Math.atan,vt=Math.atan2,pe=Math.cos,ue=Math.sin,Ii=Math.sign||function(e){return e>0?1:e<0?-1:0},et=Math.sqrt;function $i(e){return e>1?0:e<-1?Q:Math.acos(e)}function yt(e){return e>1?Te:e<-1?-Te:Math.asin(e)}function qe(){}function Dt(e,a){e&&un.hasOwnProperty(e.type)&&un[e.type](e,a)}var pn={Feature:function(e,a){Dt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Dt(r[n].geometry,a)}},un={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ua(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ua(r[n],a,0)},Polygon:function(e,a){mn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)mn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Dt(r[n],a)}};function ua(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function mn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ua(e[r],a,1);a.polygonEnd()}function nt(e,a){e&&pn.hasOwnProperty(e.type)?pn[e.type](e,a):Dt(e,a)}function ma(e){return[vt(e[1],e[0]),yt(e[2])]}function it(e){var a=e[0],r=e[1],n=pe(r);return[n*pe(a),n*ue(a),ue(r)]}function Tt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function It(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function na(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function qt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function fa(e){var a=et(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ha(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function xa(e,a){return ie(e)>Q&&(e-=Math.round(e/Le)*Le),[e,a]}xa.invert=xa;function Bi(e,a,r){return(e%=Le)?a||r?ha(hn(e),xn(a,r)):hn(e):a||r?xn(a,r):xa}function fn(e){return function(a,r){return a+=e,ie(a)>Q&&(a-=Math.round(a/Le)*Le),[a,r]}}function hn(e){var a=fn(e);return a.invert=fn(-e),a}function xn(e,a){var r=pe(e),n=ue(e),i=pe(a),o=ue(a);function l(s,p){var g=pe(p),d=pe(s)*g,m=ue(s)*g,u=ue(p),b=u*r+d*n;return[vt(m*i-b*o,d*r-u*n),yt(b*i+m*o)]}return l.invert=function(s,p){var g=pe(p),d=pe(s)*g,m=ue(s)*g,u=ue(p),b=u*i-m*o;return[vt(m*i+u*o,d*r+b*n),yt(b*r-d*n)]},l}function _i(e,a,r,n,i,o){if(r){var l=pe(a),s=ue(a),p=n*r;i==null?(i=a+n*Le,o=a-p/2):(i=gn(l,i),o=gn(l,o),(n>0?i<o:i>o)&&(i+=n*Le));for(var g,d=i;n>0?d>o:d<o;d-=p)g=ma([l,-s*pe(d),-s*ue(d)]),e.point(g[0],g[1])}}function gn(e,a){a=it(a),a[0]-=e,fa(a);var r=$i(-a[1]);return((-a[2]<0?-r:r)+Le-ne)%Le}function rr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:qe,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ft(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Lt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function or(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(c){if(!((x=c.length-1)<=0)){var x,v=c[0],h=c[x],j;if(Ft(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),s=0;s<x;++s)i.point((v=c[s])[0],v[1]);i.lineEnd();return}h[0]+=2*ne}o.push(j=new Lt(v,c,null,!0)),l.push(j.o=new Lt(v,null,j,!1)),o.push(j=new Lt(h,c,null,!1)),l.push(j.o=new Lt(h,null,j,!0))}}),!!o.length){for(l.sort(a),bn(o),bn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var g=o[0],d,m;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,p=d.length;s<p;++s)i.point((m=d[s])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(d=u.p.z,s=d.length-1;s>=0;--s)i.point((m=d[s])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);i.lineEnd()}}}function bn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function ra(e){return ie(e[0])<=Q?e[0]:Ii(e[0])*((ie(e[0])+Q)%Le-Q)}function Ui(e,a){var r=ra(a),n=a[1],i=ue(n),o=[ue(r),-pe(r),0],l=0,s=0,p=new Je;i===1?n=Te+ne:i===-1&&(n=-Te-ne);for(var g=0,d=e.length;g<d;++g)if(u=(m=e[g]).length)for(var m,u,b=m[u-1],c=ra(b),x=b[1]/2+dn,v=ue(x),h=pe(x),j=0;j<u;++j,c=y,v=q,h=T,b=N){var N=m[j],y=ra(N),C=N[1]/2+dn,q=ue(C),T=pe(C),L=y-c,E=L>=0?1:-1,z=E*L,R=z>Q,$=v*q;if(p.add(vt($*E*ue(z),h*T+$*pe(z))),l+=R?L+E*Le:L,R^c>=r^y>=r){var _=It(it(b),it(N));fa(_);var w=It(o,_);fa(w);var k=(R^L>=0?-1:1)*yt(w[2]);(n>k||n===k&&(_[0]||_[1]))&&(s+=R^L>=0?1:-1)}}return(l<-ne||l<ne&&p<-1e-12)^s&1}function ir(e,a,r,n){return function(i){var o=a(i),l=rr(),s=a(l),p=!1,g,d,m,u={point:b,lineStart:x,lineEnd:v,polygonStart:function(){u.point=h,u.lineStart=j,u.lineEnd=N,d=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=x,u.lineEnd=v,d=nr(d);var y=Ui(g,n);d.length?(p||(i.polygonStart(),p=!0),or(d,Hi,y,r,i)):y&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),d=g=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,C){e(y,C)&&i.point(y,C)}function c(y,C){o.point(y,C)}function x(){u.point=c,o.lineStart()}function v(){u.point=b,o.lineEnd()}function h(y,C){m.push([y,C]),s.point(y,C)}function j(){s.lineStart(),m=[]}function N(){h(m[0][0],m[0][1]),s.lineEnd();var y=s.clean(),C=l.result(),q,T=C.length,L,E,z;if(m.pop(),g.push(m),m=null,!!T){if(y&1){if(E=C[0],(L=E.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),q=0;q<L;++q)i.point((z=E[q])[0],z[1]);i.lineEnd()}return}T>1&&y&2&&C.push(C.pop().concat(C.shift())),d.push(C.filter(Vi))}}return u}}function Vi(e){return e.length>1}function Hi(e,a){return((e=e.x)[0]<0?e[1]-Te-ne:Te-e[1])-((a=a.x)[0]<0?a[1]-Te-ne:Te-a[1])}const vn=ir(function(){return!0},Wi,Gi,[-Q,-Te]);function Wi(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?Q:-Q,p=ie(o-a);ie(p-Q)<ne?(e.point(a,r=(r+l)/2>0?Te:-Te),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=Q&&(ie(a-n)<ne&&(a-=n*ne),ie(o-s)<ne&&(o-=s*ne),r=Yi(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Yi(e,a,r,n){var i,o,l=ue(e-r);return ie(l)>ne?Di((ue(a)*(o=pe(n))*ue(r)-ue(n)*(i=pe(a))*ue(e))/(i*o*l)):(a+n)/2}function Gi(e,a,r,n){var i;if(e==null)i=r*Te,n.point(-Q,i),n.point(0,i),n.point(Q,i),n.point(Q,0),n.point(Q,-i),n.point(0,-i),n.point(-Q,-i),n.point(-Q,0),n.point(-Q,i);else if(ie(e[0]-a[0])>ne){var o=e[0]<a[0]?Q:-Q;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ki(e){var a=pe(e),r=2*Se,n=a>0,i=ie(a)>ne;function o(d,m,u,b){_i(b,e,r,u,d,m)}function l(d,m){return pe(d)*pe(m)>a}function s(d){var m,u,b,c,x;return{lineStart:function(){c=b=!1,x=1},point:function(v,h){var j=[v,h],N,y=l(v,h),C=n?y?0:g(v,h):y?g(v+(v<0?Q:-Q),h):0;if(!m&&(c=b=y)&&d.lineStart(),y!==b&&(N=p(m,j),(!N||Ft(m,N)||Ft(j,N))&&(j[2]=1)),y!==b)x=0,y?(d.lineStart(),N=p(j,m),d.point(N[0],N[1])):(N=p(m,j),d.point(N[0],N[1],2),d.lineEnd()),m=N;else if(i&&m&&n^y){var q;!(C&u)&&(q=p(j,m,!0))&&(x=0,n?(d.lineStart(),d.point(q[0][0],q[0][1]),d.point(q[1][0],q[1][1]),d.lineEnd()):(d.point(q[1][0],q[1][1]),d.lineEnd(),d.lineStart(),d.point(q[0][0],q[0][1],3)))}y&&(!m||!Ft(m,j))&&d.point(j[0],j[1]),m=j,b=y,u=C},lineEnd:function(){b&&d.lineEnd(),m=null},clean:function(){return x|(c&&b)<<1}}}function p(d,m,u){var b=it(d),c=it(m),x=[1,0,0],v=It(b,c),h=Tt(v,v),j=v[0],N=h-j*j;if(!N)return!u&&d;var y=a*h/N,C=-a*j/N,q=It(x,v),T=qt(x,y),L=qt(v,C);na(T,L);var E=q,z=Tt(T,E),R=Tt(E,E),$=z*z-R*(Tt(T,T)-1);if(!($<0)){var _=et($),w=qt(E,(-z-_)/R);if(na(w,T),w=ma(w),!u)return w;var k=d[0],O=m[0],B=d[1],H=m[1],Z;O<k&&(Z=k,k=O,O=Z);var re=O-k,G=ie(re-Q)<ne,J=G||re<ne;if(!G&&H<B&&(Z=B,B=H,H=Z),J?G?B+H>0^w[1]<(ie(w[0]-k)<ne?B:H):B<=w[1]&&w[1]<=H:re>Q^(k<=w[0]&&w[0]<=O)){var A=qt(E,(-z+_)/R);return na(A,T),[w,ma(A)]}}}function g(d,m){var u=n?e:Q-e,b=0;return d<-u?b|=1:d>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return ir(l,s,o,n?[0,-e]:[-Q,e-Q])}function Qi(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],g=a[1],d=0,m=1,u=p-l,b=g-s,c;if(c=r-l,!(!u&&c>0)){if(c/=u,u<0){if(c<d)return;c<m&&(m=c)}else if(u>0){if(c>m)return;c>d&&(d=c)}if(c=i-l,!(!u&&c<0)){if(c/=u,u<0){if(c>m)return;c>d&&(d=c)}else if(u>0){if(c<d)return;c<m&&(m=c)}if(c=n-s,!(!b&&c>0)){if(c/=b,b<0){if(c<d)return;c<m&&(m=c)}else if(b>0){if(c>m)return;c>d&&(d=c)}if(c=o-s,!(!b&&c<0)){if(c/=b,b<0){if(c>m)return;c>d&&(d=c)}else if(b>0){if(c<d)return;c<m&&(m=c)}return d>0&&(e[0]=l+d*u,e[1]=s+d*b),m<1&&(a[0]=l+m*u,a[1]=s+m*b),!0}}}}}var mt=1e9,Rt=-mt;function Ji(e,a,r,n){function i(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function o(g,d,m,u){var b=0,c=0;if(g==null||(b=l(g,m))!==(c=l(d,m))||p(g,d)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==c);else u.point(d[0],d[1])}function l(g,d){return ie(g[0]-e)<ne?d>0?0:3:ie(g[0]-r)<ne?d>0?2:1:ie(g[1]-a)<ne?d>0?1:0:d>0?3:2}function s(g,d){return p(g.x,d.x)}function p(g,d){var m=l(g,1),u=l(d,1);return m!==u?m-u:m===0?d[1]-g[1]:m===1?g[0]-d[0]:m===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,m=rr(),u,b,c,x,v,h,j,N,y,C,q,T={point:L,lineStart:$,lineEnd:_,polygonStart:z,polygonEnd:R};function L(k,O){i(k,O)&&d.point(k,O)}function E(){for(var k=0,O=0,B=b.length;O<B;++O)for(var H=b[O],Z=1,re=H.length,G=H[0],J,A,M=G[0],F=G[1];Z<re;++Z)J=M,A=F,G=H[Z],M=G[0],F=G[1],A<=n?F>n&&(M-J)*(n-A)>(F-A)*(e-J)&&++k:F<=n&&(M-J)*(n-A)<(F-A)*(e-J)&&--k;return k}function z(){d=m,u=[],b=[],q=!0}function R(){var k=E(),O=q&&k,B=(u=nr(u)).length;(O||B)&&(g.polygonStart(),O&&(g.lineStart(),o(null,null,1,g),g.lineEnd()),B&&or(u,s,k,o,g),g.polygonEnd()),d=g,u=b=c=null}function $(){T.point=w,b&&b.push(c=[]),C=!0,y=!1,j=N=NaN}function _(){u&&(w(x,v),h&&y&&m.rejoin(),u.push(m.result())),T.point=L,y&&d.lineEnd()}function w(k,O){var B=i(k,O);if(b&&c.push([k,O]),C)x=k,v=O,h=B,C=!1,B&&(d.lineStart(),d.point(k,O));else if(B&&y)d.point(k,O);else{var H=[j=Math.max(Rt,Math.min(mt,j)),N=Math.max(Rt,Math.min(mt,N))],Z=[k=Math.max(Rt,Math.min(mt,k)),O=Math.max(Rt,Math.min(mt,O))];Qi(H,Z,e,a,r,n)?(y||(d.lineStart(),d.point(H[0],H[1])),d.point(Z[0],Z[1]),B||d.lineEnd(),q=!1):B&&(d.lineStart(),d.point(k,O),q=!1)}j=k,N=O,y=B}return T}}const ga=e=>e;var oa=new Je,ba=new Je,sr,lr,va,ya,Ue={point:qe,lineStart:qe,lineEnd:qe,polygonStart:function(){Ue.lineStart=Xi,Ue.lineEnd=es},polygonEnd:function(){Ue.lineStart=Ue.lineEnd=Ue.point=qe,oa.add(ie(ba)),ba=new Je},result:function(){var e=oa/2;return oa=new Je,e}};function Xi(){Ue.point=Zi}function Zi(e,a){Ue.point=cr,sr=va=e,lr=ya=a}function cr(e,a){ba.add(ya*e-va*a),va=e,ya=a}function es(){cr(sr,lr)}var st=1/0,$t=st,wt=-st,Bt=wt,_t={point:ts,lineStart:qe,lineEnd:qe,polygonStart:qe,polygonEnd:qe,result:function(){var e=[[st,$t],[wt,Bt]];return wt=Bt=-($t=st=1/0),e}};function ts(e,a){e<st&&(st=e),e>wt&&(wt=e),a<$t&&($t=a),a>Bt&&(Bt=a)}var wa=0,ka=0,ft=0,Ut=0,Vt=0,rt=0,ja=0,Na=0,ht=0,dr,pr,De,Ie,ze={point:Xe,lineStart:yn,lineEnd:wn,polygonStart:function(){ze.lineStart=rs,ze.lineEnd=os},polygonEnd:function(){ze.point=Xe,ze.lineStart=yn,ze.lineEnd=wn},result:function(){var e=ht?[ja/ht,Na/ht]:rt?[Ut/rt,Vt/rt]:ft?[wa/ft,ka/ft]:[NaN,NaN];return wa=ka=ft=Ut=Vt=rt=ja=Na=ht=0,e}};function Xe(e,a){wa+=e,ka+=a,++ft}function yn(){ze.point=as}function as(e,a){ze.point=ns,Xe(De=e,Ie=a)}function ns(e,a){var r=e-De,n=a-Ie,i=et(r*r+n*n);Ut+=i*(De+e)/2,Vt+=i*(Ie+a)/2,rt+=i,Xe(De=e,Ie=a)}function wn(){ze.point=Xe}function rs(){ze.point=is}function os(){ur(dr,pr)}function is(e,a){ze.point=ur,Xe(dr=De=e,pr=Ie=a)}function ur(e,a){var r=e-De,n=a-Ie,i=et(r*r+n*n);Ut+=i*(De+e)/2,Vt+=i*(Ie+a)/2,rt+=i,i=Ie*e-De*a,ja+=i*(De+e),Na+=i*(Ie+a),ht+=i*3,Xe(De=e,Ie=a)}function mr(e){this._context=e}mr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Le);break}}},result:qe};var Sa=new Je,ia,fr,hr,xt,gt,kt={point:qe,lineStart:function(){kt.point=ss},lineEnd:function(){ia&&xr(fr,hr),kt.point=qe},polygonStart:function(){ia=!0},polygonEnd:function(){ia=null},result:function(){var e=+Sa;return Sa=new Je,e}};function ss(e,a){kt.point=xr,fr=xt=e,hr=gt=a}function xr(e,a){xt-=e,gt-=a,Sa.add(et(xt*xt+gt*gt)),xt=e,gt=a}let kn,Ht,jn,Nn;class Sn{constructor(a){this._append=a==null?gr:ls(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==jn||this._append!==Ht){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,jn=n,Ht=this._append,Nn=this._,this._=i}this._+=Nn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function gr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function ls(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return gr;if(a!==kn){const r=10**a;kn=a,Ht=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Ht}function cs(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),nt(s,i(o))),o.result()}return l.area=function(s){return nt(s,i(Ue)),Ue.result()},l.measure=function(s){return nt(s,i(kt)),kt.result()},l.bounds=function(s){return nt(s,i(_t)),_t.result()},l.centroid=function(s){return nt(s,i(ze)),ze.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,ga):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new Sn(r)):new mr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new Sn(r)),l},l.projection(e).digits(r).context(a)}function Oa(e){return function(a){var r=new Ca;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Ca(){}Ca.prototype={constructor:Ca,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Fa(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),nt(r,e.stream(_t)),a(_t.result()),n!=null&&e.clipExtent(n),e}function br(e,a,r){return Fa(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function ds(e,a,r){return br(e,[[0,0],a],r)}function ps(e,a,r){return Fa(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function us(e,a,r){return Fa(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var Cn=16,ms=pe(30*Se);function En(e,a){return+a?hs(e,a):fs(e)}function fs(e){return Oa({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function hs(e,a){function r(n,i,o,l,s,p,g,d,m,u,b,c,x,v){var h=g-n,j=d-i,N=h*h+j*j;if(N>4*a&&x--){var y=l+u,C=s+b,q=p+c,T=et(y*y+C*C+q*q),L=yt(q/=T),E=ie(ie(q)-1)<ne||ie(o-m)<ne?(o+m)/2:vt(C,y),z=e(E,L),R=z[0],$=z[1],_=R-n,w=$-i,k=j*_-h*w;(k*k/N>a||ie((h*_+j*w)/N-.5)>.3||l*u+s*b+p*c<ms)&&(r(n,i,o,l,s,p,R,$,E,y/=T,C/=T,q,x,v),v.point(R,$),r(R,$,E,y,C,q,g,d,m,u,b,c,x,v))}}return function(n){var i,o,l,s,p,g,d,m,u,b,c,x,v={point:h,lineStart:j,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=C},polygonEnd:function(){n.polygonEnd(),v.lineStart=j}};function h(L,E){L=e(L,E),n.point(L[0],L[1])}function j(){m=NaN,v.point=N,n.lineStart()}function N(L,E){var z=it([L,E]),R=e(L,E);r(m,u,d,b,c,x,m=R[0],u=R[1],d=L,b=z[0],c=z[1],x=z[2],Cn,n),n.point(m,u)}function y(){v.point=h,n.lineEnd()}function C(){j(),v.point=q,v.lineEnd=T}function q(L,E){N(i=L,E),o=m,l=u,s=b,p=c,g=x,v.point=N}function T(){r(m,u,d,b,c,x,o,l,i,s,p,g,Cn,n),v.lineEnd=y,y()}return v}}var xs=Oa({point:function(e,a){this.stream.point(e*Se,a*Se)}});function gs(e){return Oa({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function bs(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function An(e,a,r,n,i,o){if(!o)return bs(e,a,r,n,i);var l=pe(o),s=ue(o),p=l*e,g=s*e,d=l/e,m=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function c(x,v){return x*=n,v*=i,[p*x-g*v+a,r-g*x-p*v]}return c.invert=function(x,v){return[n*(d*x-m*v+u),i*(b-m*x-d*v)]},c}function vs(e){return ys(function(){return e})()}function ys(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,g=0,d,m=0,u=1,b=1,c=null,x=vn,v=null,h,j,N,y=ga,C=.5,q,T,L,E,z;function R(k){return L(k[0]*Se,k[1]*Se)}function $(k){return k=L.invert(k[0],k[1]),k&&[k[0]*_e,k[1]*_e]}R.stream=function(k){return E&&z===k?E:E=xs(gs(d)(x(q(y(z=k)))))},R.preclip=function(k){return arguments.length?(x=k,c=void 0,w()):x},R.postclip=function(k){return arguments.length?(y=k,v=h=j=N=null,w()):y},R.clipAngle=function(k){return arguments.length?(x=+k?Ki(c=k*Se):(c=null,vn),w()):c*_e},R.clipExtent=function(k){return arguments.length?(y=k==null?(v=h=j=N=null,ga):Ji(v=+k[0][0],h=+k[0][1],j=+k[1][0],N=+k[1][1]),w()):v==null?null:[[v,h],[j,N]]},R.scale=function(k){return arguments.length?(r=+k,_()):r},R.translate=function(k){return arguments.length?(n=+k[0],i=+k[1],_()):[n,i]},R.center=function(k){return arguments.length?(o=k[0]%360*Se,l=k[1]%360*Se,_()):[o*_e,l*_e]},R.rotate=function(k){return arguments.length?(s=k[0]%360*Se,p=k[1]%360*Se,g=k.length>2?k[2]%360*Se:0,_()):[s*_e,p*_e,g*_e]},R.angle=function(k){return arguments.length?(m=k%360*Se,_()):m*_e},R.reflectX=function(k){return arguments.length?(u=k?-1:1,_()):u<0},R.reflectY=function(k){return arguments.length?(b=k?-1:1,_()):b<0},R.precision=function(k){return arguments.length?(q=En(T,C=k*k),w()):et(C)},R.fitExtent=function(k,O){return br(R,k,O)},R.fitSize=function(k,O){return ds(R,k,O)},R.fitWidth=function(k,O){return ps(R,k,O)},R.fitHeight=function(k,O){return us(R,k,O)};function _(){var k=An(r,0,0,u,b,m).apply(null,a(o,l)),O=An(r,n-k[0],i-k[1],u,b,m);return d=Bi(s,p,g),T=ha(a,O),L=ha(d,T),q=En(T,C),w()}function w(){return E=z=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&$,_()}}function vr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}vr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ws(){return vs(vr).scale(175.295)}function ks(e){return e}function js(e){if(e==null)return ks;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var g=2,d=s.length,m=new Array(d);for(m[0]=(a+=s[0])*n+o,m[1]=(r+=s[1])*i+l;g<d;)m[g]=s[g],++g;return m}}function Ns(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function Ss(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return zn(e,r)})}:zn(e,a)}function zn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=Cs(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function Cs(e,a){var r=js(e.transform),n=e.arcs;function i(d,m){m.length&&m.pop();for(var u=n[d<0?~d:d],b=0,c=u.length;b<c;++b)m.push(r(u[b],b));d<0&&Ns(m,c)}function o(d){return r(d)}function l(d){for(var m=[],u=0,b=d.length;u<b;++u)i(d[u],m);return m.length<2&&m.push(m[0]),m}function s(d){for(var m=l(d);m.length<4;)m.push(m[0]);return m}function p(d){return d.map(s)}function g(d){var m=d.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:d.geometries.map(g)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=p(d.arcs);break;case"MultiPolygon":u=d.arcs.map(p);break;default:return null}return{type:m,coordinates:u}}return g(a)}const yr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Es=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function As(e,a,r){const n=yr[e];if(!n||!n.length)return-1;const i=Es(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Mt=null;function zs(){return Mt||(Mt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=Ss(r,n),o=ws().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=cs(o),s=(i.features||[]).filter(d=>{var m;return(((m=d.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(d=>{var b;const m=((b=d.properties)==null?void 0:b.name)||"",u=l(d)||"";return u?{i2:oo(m)||null,n:m,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const p={};for(const[d,m]of Object.entries(io)){const u=o(m);u&&(p[d]={x:u[0],y:u[1]})}const g={};for(const[d,m]of Object.entries(yr)){const u=m.map(b=>o(b.ll)).filter(b=>!!b).map(([b,c])=>({x:b,y:c}));u.length&&(g[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:g}}catch{return null}})(),Mt)}function Ts(e){const[a,r]=f.useState(null);return f.useEffect(()=>{if(!e||a)return;let n=!1;return zs().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const qs={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Tn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function qn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Ls(e,a){const[r,n]=f.useState(1);return f.useEffect(()=>{let i=!0,o=0;const l=()=>{var g;if(!i)return;const p=(g=e.current)==null?void 0:g.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Ln({msgs:e}){const[a,r]=f.useState(0);f.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Rs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p,data:g,dossiers:d}=P(),m=g.loading&&!d.length,u=f.useRef(null),b=f.useRef(null),c=Ts(e.continent==="monde"),x=e.continent==="monde"?c:qa.find(w=>w.key===e.continent)||null,v=Ls(u,e.continent+":"+e.mapFolded+":"+!!x),[h,j]=f.useState(new Map),[N,y]=f.useState(null);f.useEffect(()=>{const w=u.current;if(!w)return;const k=new Map;w.querySelectorAll("path[data-i2]").forEach(O=>{const B=O.dataset.i2;if(B)try{const H=O.getBBox();H.width>0&&k.set(B,{x:H.x,y:H.y,w:H.width,h:H.height})}catch{}}),j(k)},[e.continent,v,x]);const C=f.useMemo(()=>r.filter(w=>w.cc),[r]),q=f.useMemo(()=>{const w=new Map;return C.forEach(k=>w.set(k.cc,(w.get(k.cc)||0)+1)),w},[C]),T=e.continent==="monde"&&c?c.anchors:null,L=e.continent==="monde"&&c?c.metros:null,E=f.useMemo(()=>C.map(w=>{const k=qn(w.name||w.id||""),O=qn((w.id||w.name||"")+"·y");if(T&&w.cc){const G=L?L[w.cc]:void 0;if(G&&G.length){const A=As(w.cc,w.city,k);if(A>=0&&G[A])return{d:w,x:G[A].x+(k-.5)*5,y:G[A].y+(O-.5)*5}}const J=T[w.cc];if(J)return{d:w,x:J.x+(k-.5)*10,y:J.y+(O-.5)*10}}const B=w.cc?h.get(w.cc):void 0;if(!B)return null;const H=qs[`${e.continent}:${w.cc||""}`];if(H)return{d:w,x:B.x+B.w*(H.fx+(k-.5)*H.sx),y:B.y+B.h*(H.fy+(O-.5)*H.sy)};const Z=(k-.5)*Math.min(B.w*.55,60),re=(O-.5)*Math.min(B.h*.55,60);return{d:w,x:B.x+B.w/2+Z,y:B.y+B.h/2+re}}).filter(w=>!!w),[C,h,T,L,e.continent]),z=w=>v>0?w/v:w,R=f.useMemo(()=>n?[0,1,2,3,4,5].map(w=>({c:Tn[w],fr:p.plabels[w].toUpperCase(),en:p.plabels[w].toUpperCase(),n:r.filter(k=>k.kind==="target"&&be(k)===w).length})).filter(w=>w.n>0):Ka.map((w,k)=>({...w,n:r.filter(O=>Qa(O)===k).length})),[r,n,p.plabels]),$=o?l.get(o):null,_=$?E.find(w=>w.d.id===$.id):null;return x?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[m&&t.jsx(Ln,{msgs:p.loadMsgs}),t.jsxs("svg",{ref:u,viewBox:x.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?x.fr:x.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:x.countries.map((w,k)=>t.jsx("g",{className:"ct"+(w.i2&&q.get(w.i2)?"":" empty"),children:t.jsx("path",{d:w.d,"data-i2":w.i2||void 0})},k))}),t.jsx("g",{children:E.map(w=>{const k=Ka[Qa(w.d)],O=!!ge(w.d),B=w.d.kind==="target",H=n&&B?Tn[be(w.d)]:k.c,Z=!n&&Ce(w.d);return t.jsxs("g",{className:"co"+(Z?" done":""),onMouseEnter:()=>{var J,A;const re=(J=b.current)==null?void 0:J.getBoundingClientRect(),G=(A=u.current)==null?void 0:A.createSVGPoint();if(G&&u.current&&re){G.x=w.x,G.y=w.y;const M=G.matrixTransform(u.current.getScreenCTM());y({x:M.x-re.left,y:M.y-re.top,label:w.d.name+" · "+(ct(w.d.cc,s)||w.d.countryLabel||"")})}i(w.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var J;const re=(J=u.current)==null?void 0:J.createSVGPoint();let G=null;if(re&&u.current){re.x=w.x,re.y=w.y;const A=re.matrixTransform(u.current.getScreenCTM());G={x:A.x,y:A.y}}a({type:"popup",id:w.d.id,anchor:G})},children:[t.jsx("circle",{className:"h",cx:w.x,cy:w.y,r:z(Math.max(11,k.px+7))}),t.jsx("circle",{className:"v",cx:w.x,cy:w.y,r:z(k.px),fill:H,stroke:O?"#DC2626":"#ffffff",strokeWidth:z(O?2.2:1.3)})]},w.d.id||w.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:z(13),fill:"none",stroke:"#0F172A",strokeWidth:z(2)})]}),t.jsx("div",{className:"hov"+(N?" on":""),style:N?{left:N.x,top:N.y}:void 0,children:N==null?void 0:N.label}),t.jsx("div",{className:"legend",children:R.map((w,k)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":w.c}}),s==="fr"?w.fr:w.en," ",t.jsx("b",{children:w.n})]},k))}),r.some(w=>!w.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(w=>!w.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:t.jsx(Ln,{msgs:p.loadMsgs})})}function Ms(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Os(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=P(),s=e.filters,p=f.useMemo(()=>e.continent==="monde"?r:r.filter(c=>c.continent===e.continent),[r,e.continent]),g=c=>p.filter(x=>c!=="country"&&s.country.length&&!s.country.includes(x.cc||"")?!1:La(x,s,i,c==="country"?void 0:c)),d=f.useMemo(()=>{const c=g("win"),x=v=>c.filter(h=>(h.date?Math.max(0,Math.floor((Date.now()-Date.parse(h.date))/864e5)):9999)<=v).length;return[x(0),x(7),x(30),c.length]},[p,s,i]),m=f.useMemo(()=>s.day?g("win").filter(c=>(c.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=(s.acquirer.trim()?1:0)+s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),b=(c,x,v,h="fbtn")=>t.jsxs("button",{type:"button",className:h,"aria-expanded":e.openFacet===c,onClick:()=>a({type:"openFacet",facet:c}),children:[t.jsx("span",{className:"fl",children:x}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},c);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:n.fDay(Ms(s.day,l))}),t.jsx("b",{children:m})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((c,x)=>t.jsxs("button",{type:"button","aria-pressed":s.win===c,onClick:()=>a({type:"filters",patch:{win:c}}),children:[t.jsx("span",{className:"sl",children:n.dates[x]}),t.jsx("b",{children:d[x]})]},c))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:c=>a({type:"filters",patch:{search:c.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):b("sec",n.fSector,s.sector.length),b("pay",n.fCountry,s.country.length),b("det",n.fEngine,s.engine.length),b("sta",n.fStage,s.stage.length),i&&b("ang","Angle",s.angle.length),i&&b("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Fs,{poolFor:g})]})}function Fs({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=P(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:g}=f.useMemo(()=>{if(l==="sig"){const c=e("signal").filter(h=>ge(h)),x=new Map;c.forEach(h=>{const j=h.engine||"";x.set(j,(x.get(j)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:c.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ca([...x.keys()],i).map(h=>({v:h,label:Qe(h)+" "+$e(h,i),n:x.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const c=e("sector"),x=new Map;return c.forEach(v=>{v.sector&&x.set(v.sector,(x.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...x.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const c=e("country"),x=new Map;return c.forEach(v=>{v.cc&&x.set(v.cc,(x.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...x.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:ct(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const c=e("engine"),x=new Map;return c.forEach(v=>{v.engine&&x.set(v.engine,(x.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ca([...x.keys()],i).map(v=>({v,label:Qe(v)+" "+$e(v,i)+' <span style="color:var(--dim);font-size:10px">· '+so(lo(v),i)+"</span>",n:x.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const c=e("angle"),x=new Map;return c.forEach(v=>{v.angle&&x.set(v.angle,(x.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...x.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const c=e("memoLevel"),x=new Map;c.forEach(h=>{if(h.kind==="target"){const j=za(h);x.set(j,(x.get(j)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:x.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),b=new Map;return u.forEach(c=>{c.stage&&b.set(c.stage,(b.get(c.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((c,x)=>x[1]-c[1]).map(([c,x])=>({v:c,label:c,n:x,html:!1,on:o.stage.includes(c)}))}},[l,a,i]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const c=o.signalEngines.includes(u)?o.signalEngines.filter(x=>x!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:c}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function wr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ps(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Rn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=P();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function kr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=P(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Rn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Rn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Ds({card:e,onEvaluate:a,onAddAll:r}){var s,p,g;const{t:n}=P(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:wr(e.summary_md||"").map((d,m)=>t.jsx("p",{children:d},m))})]}),t.jsx(kr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Is(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function $s({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=P(),s=i,[p,g]=f.useState(null),[d,m]=f.useState(null),[u,b]=f.useState(null),[c,x]=f.useState(!1);f.useEffect(()=>{let h=!0;return(async()=>{const j=await Hn({email:l,cbToken:s});h&&g(j)})(),()=>{h=!1}},[l,s,n]);const v=h=>{m(h),b(null),x(!0),(async()=>{const j=await co(h.id);b(j),x(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[Is(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),c&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!c&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!c&&u&&t.jsx(Ds,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Mn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Bs(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:g,data:d,canWrite:m,source:u}=P(),b=a==="client",c=f.useMemo(()=>r||(u!=="default"?po():""),[r,u]),[x,v]=f.useState(""),[h,j]=f.useState(!1),[N,y]=f.useState(""),[C,q]=f.useState(!1),[T,L]=f.useState(""),[E,z]=f.useState([]),R=f.useRef(!1),[$,_]=f.useState(!1),[w,k]=f.useState(""),[O,B]=f.useState(""),[H,Z]=f.useState(!1),[re,G]=f.useState(0),[J,A]=f.useState(""),[M,F]=f.useState(null),[I,W]=f.useState(null),[Y,se]=f.useState(!1),[le,K]=f.useState(null),[X,he]=f.useState(0),ee=f.useRef(!1),ce=x.trim()?Mn.test(x.trim())?e.evalUrl:e.evalName:e.evalWaiting,ae=f.useMemo(()=>N.split(`
`).map(D=>D.trim()).filter(Boolean).slice(0,15),[N]);f.useEffect(()=>{if(typeof window>"u")return;const D=(new URLSearchParams(window.location.search).get("rs")||"").trim();!D||!/^https?:\/\//i.test(D)||(k(D),_(!0))},[]),f.useEffect(()=>{const D=te=>{var we;const oe=String(((we=te.detail)==null?void 0:we.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(k(oe),_(!0))};return window.addEventListener("ppmap:research",D),()=>window.removeEventListener("ppmap:research",D)},[]),f.useEffect(()=>{if(!m&&!c){K(null);return}let D=!0;return(async()=>{const te=await Hn({email:n,cbToken:c});D&&K(te.length)})(),()=>{D=!1}},[m,c,n,X]);const Oe=E.length?E:p,xe=d.credits,ye=f.useCallback(D=>{const te=D.map(oe=>(oe||"").trim()).filter(Boolean);te.length&&(y(oe=>{const we=oe.split(`
