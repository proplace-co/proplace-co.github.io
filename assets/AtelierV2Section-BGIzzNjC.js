...
/* À évaluer : une carte par société (bordure + bouton « Évaluer Nom »). */
.atl2.cibles .eq-card,.atl2 .eq-card{border:1px solid #C5D0DE;border-radius:12px;
  padding:10px 12px 8px;background:#fff;box-shadow:0 1px 0 #E8EEF5}
.atl2.cibles .evalq .eq-rows{gap:10px}
...
.atl2.cibles .eq-item{border:1px solid #D5DEEA;border-radius:12px;padding:10px 12px 8px;
  background:#fff;box-shadow:0 1px 0 #EEF2F7}
.atl2.cibles .eq-item + .eq-item{margin-top:0}
.atl2.cibles .eq-item.r-kept{border-color:#BBF7D0;background:#F7FCF9}
.atl2.cibles .eq-item.r-out{border-color:#FECACA;background:#FFF8F8}
