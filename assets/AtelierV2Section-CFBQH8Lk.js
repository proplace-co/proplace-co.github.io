...
.atl2 .bulk .side .hint{white-space:nowrap}`,Mo=`
...
.atl2 .mapzone{display:flex;min-height:460px}
.atl2 .mapzone svg{display:block;width:100%;height:auto;min-height:460px;
  flex:1;max-height:none!important;margin:0 auto}
...
.atl2 .row .csp{display:inline-flex!important;flex-wrap:nowrap;align-items:center;
  gap:4px;min-width:0;max-width:100%}
.atl2 .row .csp>*{flex:none;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;
  max-width:120px}
.atl2 .row .c-crible,.atl2 .row .c-memo{white-space:nowrap}
...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,Oo=Ro+Mo;function ia(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function qo(){const e=ia("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Fo(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=qo();return r==="0"?"client":r==="1"||ia("embed")==="1"&&ia("chrome")==="1"?"apercu":"client"}const Po={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Do=e=>Po[e],He=e=>Object.assign(e,{continent:Pr(e.cc)});function Kt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Io=60*60*1e3;function Bo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Io?null:a}catch{return null}}function jt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const $o=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function _o(e,a,r="default"){const n=r!=="default",i=g.useMemo(()=>e||n?{mode:"anon"}:Er(),[e,n]),o=g.useMemo(()=>n?"visiteur":Fo(e,i),[e,i,n]),l=g.useMemo(()=>Do(o),[o]),s=o!=="visiteur",p=$o(r),[h,c]=g.useState([]),[d,u]=g.useState(""),[x,f]=g.useState(null),[b,v]=g.useState(null),[m,y]=g.useState(null),[j,w]=g.useState(()=>new Map),[E,A]=g.useState(()=>new Map),[R,B]=g.useState(""),[S,M]=g.useState(new Set),[q,L]=g.useState(null),[_,k]=g.useState(!0),[N,T]=g.useState(!1),[H,G]=g.useState(0),[Z,z]=g.useState(0),O=g.useRef(0),I=g.useMemo(()=>{var D;if(o!=="client")return"";try{return((D=Ar())==null?void 0:D.email)||""}catch{return""}},[o]);g.useEffect(()=>{const D=++O.current;let U=!0;const W=()=>U&&D===O.current,X=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),oe=Bo(X);return oe?(c(oe.objs.map(He)),oe.fund&&u(oe.fund),f(oe.marketEstimate??null),v(oe.criteria??null),y(oe.stats??null),B(oe.generatedAt||""),k(!1)):k(!0),(async()=>{try{if(r==="ops"){const ue=await Yt(),pe=((ue==null?void 0:ue.recent_ops)||[]).map(Q=>{const te=Wt(Q.company_name||Q.title?Q:{...Q,title:(Q.headline_fr||Q.headline||"").slice(0,120)},a),he=String(Q.rubrique||"").toLowerCase();return te&&(he==="nominations"||he==="recrutements")&&(te.engine=he),te&&!String(Q.company_name||"").trim()&&(te.noCo=!0),te}).filter(Q=>!!Q).map(Q=>(zr((Q.name||"").trim())||(Q.noCo=!0),Q));try{const Q=await Tr(),te=Lr(Q),he=((Q==null?void 0:Q.date)||"").slice(0,10);if(te.length&&he){const K=new Set;for(const se of pe){if(se.noCo||(se.date||"").slice(0,10)!==he)continue;const ee=Fa(te,K,se.name,"");ee>=0&&(K.add(ee),se.decryptHtml=te[ee].html)}for(const se of pe){if(se.decryptHtml||(se.date||"").slice(0,10)!==he)continue;const ee=Fa(te,K,"",se.headline||se.tagline||se.name);ee>=0&&(K.add(ee),se.decryptHtml=te[ee].html)}}}catch{}if(!W())return;c(pe.map(He)),jt(X,{objs:pe})}else if(typeof r=="object"){const pe=(await Pa()||[]).filter(te=>(te.slug||"")===r.research).map(te=>Da(te,a)).filter(te=>!!te),Q=Kt(await Ia(pe,a));if(!W())return;c(Q.map(He)),jt(X,{objs:Q})}else if(s&&i.token){const ue=Rr(i.token),pe=Yt(),Q=Mr(i.token),te=Or(i.token),he=qr(i.token),K=await ue;let se=K?K.targets:[];W()&&K&&(u(K.fund||""),f(K.marketEstimate??null),v(K.criteria??null),y(K.stats??null),B(K.generatedAt||""),c(se.map(He)),k(!1),T(!1));const[ee,Be,fe,xe]=await Promise.all([pe,Q,te,he]),Fe=((ee==null?void 0:ee.recent_ops)||[]).map(Ne=>Wt(Ne,a)).filter(Ne=>!!Ne);if(se=[...se,...Fe],!W())return;c(se.map(He));const Ue=new Set;for(const Ne of Be){const Pe=(Ne.id||Ne.co||"").toString().trim().toLowerCase();Pe&&Ue.add(Pe.startsWith("t:")?Pe:"t:"+Pe)}M(Ue),w(fe),A(xe),K&&jt(X,{fund:K.fund,marketEstimate:K.marketEstimate,criteria:K.criteria,stats:K.stats,generatedAt:K.generatedAt,objs:se})}else{const ue=Fr(),pe=Pa(),Q=Yt(),te=await ue;W()&&te.length&&(c(Kt(te).map(He)),k(!1),T(!1));const[he,K]=await Promise.all([pe,Q]),se=(he||[]).map(xe=>Da(xe,a)).filter(xe=>!!xe),ee=await Ia(se,a),Be=((K==null?void 0:K.recent_ops)||[]).map(xe=>Wt(xe,a)).filter(xe=>!!xe),fe=Kt([...te,...ee,...Be]);if(!W())return;c(fe.map(He)),jt(X,{objs:fe})}W()&&T(!1)}catch{W()&&!oe&&T(!0)}finally{W()&&k(!1)}})(),()=>{U=!1}},[s,i.token,a,H,p]),g.useEffect(()=>{if(!l.showCredits||!I){L(null);return}let D=!0;return(async()=>{try{const U=await fetch(`${ja}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:I})});if(!U.ok)return;const W=await U.json();D&&W&&W.ok!==!1&&L(W)}catch{}})(),()=>{D=!1}},[l.showCredits,I,Z]);const P=g.useCallback(D=>M(new Set(D)),[]);return{session:i,mode:o,caps:l,fund:d,email:I,marketEstimate:x,generatedAt:R,criteria:b,stats:m,thumbs:j,stages:E,dossiers:h,favIds:S,setFavIds:P,credits:q,reloadCredits:()=>z(D=>D+1),loading:_,error:N,refresh:()=>G(D=>D+1)}}const Dn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Uo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Dn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Vo(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Dn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??In)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const In=40;function Ea(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Na(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(rt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&We(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Bn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ea(e,a.filters,r)}function Ho(e,a,r,n){return!(!Bn(e,a,r)||r&&!Dr(e,a.ptab,n))}function Aa(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-rt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=me(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const Yo=["ma","levees","nominations","recrutements","actualites"],Wo=300,Qt=7,Go={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},$n={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Ko=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ga(e){const a=me(e);if(a)return"sig:"+(a.theme&&$n.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Qo(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=F(),s=l==="en",[p,h]=g.useState("all"),[c,d]=g.useState(!1),u=g.useMemo(()=>{const S=(a.filters.day||"").slice(0,10),M=k=>!(!o&&a.continent!=="monde"&&k.continent!==a.continent||S&&(k.date||"").slice(0,10)!==S),q=e.filter(k=>M(k)&&me(k)),L=e.filter(k=>M(k)&&k.kind==="op"&&!me(k)&&(S?!0:rt(k.date)<=Qt)),_=S||new Date().toISOString().slice(0,10);return L.sort((k,N)=>{const T=(k.date||"").slice(0,10)===_?0:1,H=(N.date||"").slice(0,10)===_?0:1;return T!==H?T-H:(N.amountEur||0)-(k.amountEur||0)}),[...Aa(q,{key:"signal",dir:-1}),...L]},[e,a.continent,a.filters.day,o]),x=g.useMemo(()=>{const S={};for(const M of u){const q=Ga(M);S[q]=(S[q]||0)+1}return S},[u]),f=g.useMemo(()=>p==="all"?u:u.filter(S=>Ga(S)===p),[u,p]),b=g.useMemo(()=>f.slice(0,Wo),[f]),v=f.length-b.length,m=S=>S==="all"?u.length:x[S]||0,y=S=>S==="all"?s?"All":"Tout":S.startsWith("sig:")?$n[s?"en":"fr"][S.slice(4)]||"🔔":Go[s?"en":"fr"][S],j=[{k:"all"}],w=Yo.filter(S=>m(S)>0||S===p);if(w.length){j.push({g:s?"DEALS":"OPÉRATIONS"});for(const S of w)j.push({k:S})}const E=Ko.map(S=>"sig:"+S).filter(S=>m(S)>0||S===p);if(E.length){j.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const S of E)j.push({k:S})}const A=S=>{try{return new Date(S+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return S}},R=(()=>{const S=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?s?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return S?(s?`LIVE covers the events of ${A(S)}.`:`Le LIVE regroupe les événements du ${A(S)}.`)+M:(s?`LIVE covers the still-open signals and the deals of the last ${Qt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Qt} derniers jours.`)+M})(),B=S=>b.map(M=>t.jsxs("button",{type:"button",className:"tk"+(ye(M)?" spent":""),onClick:q=>{const L=q.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:L.left+L.width/2,y:L.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(Je,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(gr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Tl(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(Ut,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},S+(M.id||M.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},S+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:S=>{S.currentTarget.contains(S.relatedTarget)||d(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":c,onClick:()=>d(S=>!S),children:[y(p),t.jsx("b",{children:m(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!c,children:[t.jsx("span",{className:"tkfilscope",children:R}),j.map(S=>"g"in S?t.jsx("span",{className:"tkfilg",children:S.g},S.g):t.jsxs("button",{type:"button","aria-pressed":S.k===p,onClick:()=>{h(S.k),d(!1)},children:[y(S.k),t.jsx("b",{children:m(S.k)})]},S.k))]})]}),t.jsx("div",{className:"win",children:b.length?t.jsxs("div",{className:"run",children:[B(0),B(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const Jo="aDx8z7Hzksus",_n="+33 6 83 10 72 86",Ka="alexandre@proplace.co",Xo=`tel:${_n.replace(/[^\d+]/g,"")}`,Qa="pp-rdv-slot";function Zo(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ei(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:ai}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Xo,children:_n}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Ka}`,children:Ka})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Ao,{filloutId:Jo,parameters:r?{company_name:r}:void 0})})]})}function ti(){const[e,a]=g.useState(()=>typeof document>"u"?null:document.getElementById(Qa));return g.useEffect(()=>{e||a(document.getElementById(Qa))},[e]),e?ot.createPortal(t.jsx(ei,{}),e):null}const ai=`
...
`;class ge extends g.Component{constructor(){super(...arguments);Oa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ni=8;function ri(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=F(),[s,p]=g.useState(!1),[h,c]=g.useState(!1),[d,u]=g.useState(!1),x=r||"home",{names:f,verdicts:b}=g.useMemo(()=>{const w=[],E={};return n.forEach(A=>{A.kind!=="target"||!A.name||(w.push(A.name),E[A.name]=Ir(A)||"")}),{names:w,verdicts:E}},[n]),v=g.useMemo(()=>f.length?Br(x,f,b,a):null,[x,f.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const m=h?v.added:v.added.slice(0,ni),y=v.added.length-m.length,j=w=>{const E=n.find(A=>A.name===w);E&&(o(E.id),l({type:"popup",id:E.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),$r(x,f,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[m.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>c(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),d&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Jt=600,Ye=62,Ja="atl2:fstats";function oi(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=F(),[l,s]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Ja)==="on"}catch{return!1}}),p=r.stats,h=g.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),c=g.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const d=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),x=h.reduce((y,j)=>Math.max(y,j.s||0),0),f=h.length?Jt/h.length:0,b=Math.max(4,f-4),v=h.length>=5&&x>0,m=[[p.screened,e.funScreened(d(c)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[m.map(([y,j,w],E)=>t.jsxs("span",{className:"fst-t",children:[E>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:j}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Ja,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Jt} ${Ye}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((y,j)=>{const w=(y.s||0)/x*(Ye-4),E=(y.m||0)/x*(Ye-4),A=j*f+(f-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${d(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:Ye-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:Ye-2-E,width:b,height:E,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Ye-1.5,x2:Jt,y2:Ye-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:d(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const ii=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function si({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=F(),[o,l]=g.useState(""),[s,p]=g.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),c=(Xe(e)||"").startsWith("CALL")&&je(e)===3,d=je(e)>=2,u=async f=>{if(o||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(f);const b=await i(e,f);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},x=c?[["Validé",a.csYes],["Écarté",a.csNo]]:ii.filter(([f])=>!(d&&f==="Retenu")).map(([f,b])=>[f,a[b]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),x.map(([f,b])=>t.jsx("button",{type:"button",className:"csb"+(h===f?" on":"")+(o===f?" busy":""),disabled:!!o,onClick:()=>{u(f)},children:b},f)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(li,{o:e})]})}function li({o:e}){const{t:a,saveNote:r,flash:n}=F(),[i,o]=g.useState(e.ceoNote||""),[l,s]=g.useState(!1),[p,h]=g.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),d=async()=>{if(l||!c)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&d()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{d()},children:p?a.csNoteSaved:a.csNoteOk})]})}function di({placeholder:e,onDone:a}){const{t:r}=F(),[n,i]=g.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ci({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=F(),[p,h]=g.useState(!1);if(!n.pipe||!i||n.lockActions||je(e)!==4)return null;const c=o(e),d=(c==null?void 0:c.stage)||"todo",u=async m=>{if(p||m===d)return;h(!0);const y=c;l(e,{stage:m,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),Xa+=1);Xa=j;const w=await _r(r,{company:e.name||"",stage:m,cts:j,deal_id:e.airtableId,check_id:e.checkId});h(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},x=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,f=x?Math.floor((Date.now()-Date.parse(x))/864e5):0,b=d==="sent"&&x&&f>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(d===m?" on":""),disabled:p,onClick:()=>{u(m)},children:y},m)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let Xa=0;const Nt=8,St=340;function Za({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function pi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=F(),[l,s]=g.useState(0),[p,h]=g.useState(null),[c,d]=g.useState([]),u=g.useRef(!1);g.useEffect(()=>{u.current||(u.current=!0,d(e.filter(j=>!!document.querySelector(j.need||j.sel))))},[e]);const x=c[l],f=l>=c.length;g.useEffect(()=>{x&&(x.ptab!==void 0&&o.ptab!==x.ptab&&n({type:"ptab",tab:x.ptab}),x.dens&&o.dens!==x.dens&&n({type:"dens",dens:x.dens}))},[l,x]);const b=g.useCallback(()=>{if(!x){h(null);return}const j=document.querySelector(x.sel);if(!j){h(null);return}j.scrollIntoView({block:"nearest",behavior:"smooth"}),h(j.getBoundingClientRect())},[x]);g.useLayoutEffect(()=>{b();const j=window.setTimeout(b,260),w=()=>b();return window.addEventListener("scroll",w,!0),window.addEventListener("resize",w),()=>{window.clearTimeout(j),window.removeEventListener("scroll",w,!0),window.removeEventListener("resize",w)}},[b]);const v=g.useRef(a);if(v.current=a,g.useEffect(()=>{const j=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),v.current()):w.key==="ArrowRight"?s(E=>E+1):w.key==="ArrowLeft"&&s(E=>Math.max(0,E-1))};return document.addEventListener("keydown",j,!0),()=>document.removeEventListener("keydown",j,!0)},[]),!c.length)return null;let m=null;if(f){const j=i[3]||0;j>0?m={title:j===1?r.ahaATitle1:r.ahaATitleN(j),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:(i[1]||0)>0?m={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:()=>{n({type:"ptab",tab:1}),a()}}:m={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:St};if(!f&&p){const j=p.bottom+14,E=window.innerHeight-j>190?j:Math.max(12,p.top-200);y={left:Math.min(Math.max(12,p.left+p.width/2-St/2),window.innerWidth-St-12),top:E,width:St}}return ot.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!f&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-Nt,top:p.top-Nt,width:p.width+Nt*2,height:p.height+Nt*2}}),(f||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(f?" fin":""),style:y,children:[f&&m?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:m.title}),t.jsx("p",{children:t.jsx(Za,{text:m.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:m.go,children:m.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(l+1,c.length)}),t.jsx("h3",{children:x==null?void 0:x.title}),t.jsx("p",{children:t.jsx(Za,{text:(x==null?void 0:x.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(j=>Math.max(0,j-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(j=>j+1),children:l===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function ui(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,dispatch:l}=F(),s=r?a:e,p=g.useMemo(()=>s.filter(m=>rt(m.date)===0&&m.kind==="target"),[s]),h=g.useMemo(()=>r?a.filter(m=>je(m)===0).slice().sort((m,y)=>(y.date||"").localeCompare(m.date||"")):[],[a,r]),c=g.useMemo(()=>p.filter(m=>r?je(m)===0:!ye(m)),[p,r]),d=r?h:c,u=r?a.length-h.length:p.length-c.length,x=r?a.length:p.length,f=x?Math.min(100,u/x*100):100;let b;r?b=i.morningThesis(p.length,h.length):p.length?u===0?b=i.goalSourced(p.length):u>=p.length?b=i.goalCleared:b=i.goalDone(u,p.length):b=i.goalSourced(0);const v=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&h.length&&l({type:"chainStart",queue:h.map(m=>m.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:b}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:f+"%"}})}),d.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:v,children:r?i.morningEval(d.length):o.pileMode?i.goalContinue(d.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function fi(){var M,q;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:h,startTour:c}=F(),[d,u]=g.useState(null),[x,f]=g.useState([]),b=p==="client";g.useEffect(()=>{if(!i||!o)return;let L=!0;return(async()=>{const[_,k]=await Promise.all([Sa(o),Mn(i)]);L&&(_&&u(_),f(k))})(),()=>{L=!1}},[i,o]);const v=(d==null?void 0:d.per_day)??null,m=((M=d==null?void 0:d.pool_order)==null?void 0:M.length)??0,y=x.filter(L=>L.status==="running").length,j=g.useMemo(()=>s.filter(L=>L.kind==="target"&&ye(L)).length,[s]),w=l.marketEstimate,E=typeof((q=l.stats)==null?void 0:q.screened)=="number"?l.stats.screened:j,A=w&&w>0?Math.min(100,Math.round(E/w*100)):null,R=L=>L.toLocaleString(a==="en"?"en-US":"fr-FR"),B=(o||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),S=(()=>{const L=Date.parse(l.generatedAt||"");if(Number.isNaN(L))return"";const _=new Date(L),k=N=>String(N).padStart(2,"0");return`${k(_.getDate())}/${k(_.getMonth()+1)} à ${k(_.getHours())}:${k(_.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:B}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),S&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(S)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[A===null&&E>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(E)})})]}),A!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:A+"%"}})}),t.jsxs("b",{children:[A," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(E,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(m)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:h,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function mi(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const xi=["--p0","--p1","--p2","--p3","--p4"];function gi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=F(),s=o.loading&&!l.length,p=g.useRef({});g.useEffect(()=>{p.current={...r}},[r]);const h=u=>{const x=p.current[u],f=x!==void 0?r[u]-x:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${xi[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(f>0?" up":f<0?" down":""),children:[r[u],f!==0&&t.jsxs("em",{className:"delta",children:[f>0?"+":"−",Math.abs(f)]})]})]},u)},c=(u,x,f)=>t.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:f.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),d=(u,x,f,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:x,disabled:b,onClick:f,children:u},x);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(h)}),t.jsxs("div",{className:"offtrack",children:[c(5,!1,n.plabels[5]),c(7,!0,n.plabels[7]),c(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[d("↩",n.toolUndo,i,e.undo.length===0),d("↺",n.toolReset,()=>{a({type:"reset"})}),d("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),d("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),d("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const hi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function bi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=F(),s=g.useRef(null),[p,h]=g.useState(60);g.useEffect(()=>{let x=0;const f=()=>{var j;const b=s.current;if(!b)return;const v=(j=b.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!v)return;const m=v.getBoundingClientRect(),y=b.getBoundingClientRect();h(Math.max(20,Math.min(m.left+m.width/2-y.left,y.width-30)))};return x=requestAnimationFrame(f),window.addEventListener("resize",f),()=>{cancelAnimationFrame(x),window.removeEventListener("resize",f)}},[e.ptab]);const c=e.ptab;let d=r.tuto[c].p;if(c===3){const x=n.filter(v=>v.kind==="target"&&je(v)===3),f=x.filter(v=>na(v)==="auto").length,b=x.filter(v=>na(v)==="cd").length;d=r.tutoPending(f,b,x.length)}const u=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(x=>x.id)})};if(c===1){const x=n.filter(f=>f.kind==="target"&&je(f)===1&&!i.has(f.id)).slice(0,10);if(x.length)return{label:r.tuto[1].a,run:()=>x.forEach(f=>o(f))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":hi[c],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:d}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Ke{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*vi(e){for(const a of e)yield*a}function Un(e){return Array.from(vi(e))}var ne=1e-6,J=Math.PI,Ae=J/2,en=J/4,Te=J*2,De=180/J,Ce=J/180,ie=Math.abs,yi=Math.atan,gt=Math.atan2,de=Math.cos,ce=Math.sin,wi=Math.sign||function(e){return e>0?1:e<0?-1:0},Ze=Math.sqrt;function ki(e){return e>1?0:e<-1?J:Math.acos(e)}function ht(e){return e>1?Ae:e<-1?-Ae:Math.asin(e)}function ze(){}function Mt(e,a){e&&an.hasOwnProperty(e.type)&&an[e.type](e,a)}var tn={Feature:function(e,a){Mt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Mt(r[n].geometry,a)}},an={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){sa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)sa(r[n],a,0)},Polygon:function(e,a){nn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)nn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Mt(r[n],a)}};function sa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function nn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)sa(e[r],a,1);a.polygonEnd()}function et(e,a){e&&tn.hasOwnProperty(e.type)?tn[e.type](e,a):Mt(e,a)}function la(e){return[gt(e[1],e[0]),ht(e[2])]}function at(e){var a=e[0],r=e[1],n=de(r);return[n*de(a),n*ce(a),ce(r)]}function Ct(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ot(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Xt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Et(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function da(e){var a=Ze(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ca(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function pa(e,a){return ie(e)>J&&(e-=Math.round(e/Te)*Te),[e,a]}pa.invert=pa;function ji(e,a,r){return(e%=Te)?a||r?ca(on(e),sn(a,r)):on(e):a||r?sn(a,r):pa}function rn(e){return function(a,r){return a+=e,ie(a)>J&&(a-=Math.round(a/Te)*Te),[a,r]}}function on(e){var a=rn(e);return a.invert=rn(-e),a}function sn(e,a){var r=de(e),n=ce(e),i=de(a),o=ce(a);function l(s,p){var h=de(p),c=de(s)*h,d=ce(s)*h,u=ce(p),x=u*r+c*n;return[gt(d*i-x*o,c*r-u*n),ht(x*i+d*o)]}return l.invert=function(s,p){var h=de(p),c=de(s)*h,d=ce(s)*h,u=ce(p),x=u*i-d*o;return[gt(d*i+u*o,c*r+x*n),ht(x*r-c*n)]},l}function Ni(e,a,r,n,i,o){if(r){var l=de(a),s=ce(a),p=n*r;i==null?(i=a+n*Te,o=a-p/2):(i=ln(l,i),o=ln(l,o),(n>0?i<o:i>o)&&(i+=n*Te));for(var h,c=i;n>0?c>o:c<o;c-=p)h=la([l,-s*de(c),-s*ce(c)]),e.point(h[0],h[1])}}function ln(e,a){a=at(a),a[0]-=e,da(a);var r=ki(-a[1]);return((-a[2]<0?-r:r)+Te-ne)%Te}function Vn(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:ze,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Rt(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function At(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Hn(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(f){if(!((b=f.length-1)<=0)){var b,v=f[0],m=f[b],y;if(Rt(v,m)){if(!v[2]&&!m[2]){for(i.lineStart(),s=0;s<b;++s)i.point((v=f[s])[0],v[1]);i.lineEnd();return}m[0]+=2*ne}o.push(y=new At(v,f,null,!0)),l.push(y.o=new At(v,null,y,!1)),o.push(y=new At(m,f,null,!1)),l.push(y.o=new At(m,null,y,!0))}}),!!o.length){for(l.sort(a),dn(o),dn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var h=o[0],c,d;;){for(var u=h,x=!0;u.v;)if((u=u.n)===h)return;c=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(x)for(s=0,p=c.length;s<p;++s)i.point((d=c[s])[0],d[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(x)for(c=u.p.z,s=c.length-1;s>=0;--s)i.point((d=c[s])[0],d[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,c=u.z,x=!x}while(!u.v);i.lineEnd()}}}function dn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function Zt(e){return ie(e[0])<=J?e[0]:wi(e[0])*((ie(e[0])+J)%Te-J)}function Si(e,a){var r=Zt(a),n=a[1],i=ce(n),o=[ce(r),-de(r),0],l=0,s=0,p=new Ke;i===1?n=Ae+ne:i===-1&&(n=-Ae-ne);for(var h=0,c=e.length;h<c;++h)if(u=(d=e[h]).length)for(var d,u,x=d[u-1],f=Zt(x),b=x[1]/2+en,v=ce(b),m=de(b),y=0;y<u;++y,f=w,v=A,m=R,x=j){var j=d[y],w=Zt(j),E=j[1]/2+en,A=ce(E),R=de(E),B=w-f,S=B>=0?1:-1,M=S*B,q=M>J,L=v*A;if(p.add(gt(L*S*ce(M),m*R+L*de(M))),l+=q?B+S*Te:B,q^f>=r^w>=r){var _=Ot(at(x),at(j));da(_);var k=Ot(o,_);da(k);var N=(q^B>=0?-1:1)*ht(k[2]);(n>N||n===N&&(_[0]||_[1]))&&(s+=q^B>=0?1:-1)}}return(l<-ne||l<ne&&p<-1e-12)^s&1}function Yn(e,a,r,n){return function(i){var o=a(i),l=Vn(),s=a(l),p=!1,h,c,d,u={point:x,lineStart:b,lineEnd:v,polygonStart:function(){u.point=m,u.lineStart=y,u.lineEnd=j,c=[],h=[]},polygonEnd:function(){u.point=x,u.lineStart=b,u.lineEnd=v,c=Un(c);var w=Si(h,n);c.length?(p||(i.polygonStart(),p=!0),Hn(c,Ei,w,r,i)):w&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),c=h=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function x(w,E){e(w,E)&&i.point(w,E)}function f(w,E){o.point(w,E)}function b(){u.point=f,o.lineStart()}function v(){u.point=x,o.lineEnd()}function m(w,E){d.push([w,E]),s.point(w,E)}function y(){s.lineStart(),d=[]}function j(){m(d[0][0],d[0][1]),s.lineEnd();var w=s.clean(),E=l.result(),A,R=E.length,B,S,M;if(d.pop(),h.push(d),d=null,!!R){if(w&1){if(S=E[0],(B=S.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),A=0;A<B;++A)i.point((M=S[A])[0],M[1]);i.lineEnd()}return}R>1&&w&2&&E.push(E.pop().concat(E.shift())),c.push(E.filter(Ci))}}return u}}function Ci(e){return e.length>1}function Ei(e,a){return((e=e.x)[0]<0?e[1]-Ae-ne:Ae-e[1])-((a=a.x)[0]<0?a[1]-Ae-ne:Ae-a[1])}const cn=Yn(function(){return!0},Ai,Ti,[-J,-Ae]);function Ai(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?J:-J,p=ie(o-a);ie(p-J)<ne?(e.point(a,r=(r+l)/2>0?Ae:-Ae),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=J&&(ie(a-n)<ne&&(a-=n*ne),ie(o-s)<ne&&(o-=s*ne),r=zi(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function zi(e,a,r,n){var i,o,l=ce(e-r);return ie(l)>ne?yi((ce(a)*(o=de(n))*ce(r)-ce(n)*(i=de(a))*ce(e))/(i*o*l)):(a+n)/2}function Ti(e,a,r,n){var i;if(e==null)i=r*Ae,n.point(-J,i),n.point(0,i),n.point(J,i),n.point(J,0),n.point(J,-i),n.point(0,-i),n.point(-J,-i),n.point(-J,0),n.point(-J,i);else if(ie(e[0]-a[0])>ne){var o=e[0]<a[0]?J:-J;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Li(e){var a=de(e),r=2*Ce,n=a>0,i=ie(a)>ne;function o(c,d,u,x){Ni(x,e,r,u,c,d)}function l(c,d){return de(c)*de(d)>a}function s(c){var d,u,x,f,b;return{lineStart:function(){f=x=!1,b=1},point:function(v,m){var y=[v,m],j,w=l(v,m),E=n?w?0:h(v,m):w?h(v+(v<0?J:-J),m):0;if(!d&&(f=x=w)&&c.lineStart(),w!==x&&(j=p(d,y),(!j||Rt(d,j)||Rt(y,j))&&(y[2]=1)),w!==x)b=0,w?(c.lineStart(),j=p(y,d),c.point(j[0],j[1])):(j=p(d,y),c.point(j[0],j[1],2),c.lineEnd()),d=j;else if(i&&d&&n^w){var A;!(E&u)&&(A=p(y,d,!0))&&(b=0,n?(c.lineStart(),c.point(A[0][0],A[0][1]),c.point(A[1][0],A[1][1]),c.lineEnd()):(c.point(A[1][0],A[1][1]),c.lineEnd(),c.lineStart(),c.point(A[0][0],A[0][1],3)))}w&&(!d||!Rt(d,y))&&c.point(y[0],y[1]),d=y,x=w,u=E},lineEnd:function(){x&&c.lineEnd(),d=null},clean:function(){return b|(f&&x)<<1}}}function p(c,d,u){var x=at(c),f=at(d),b=[1,0,0],v=Ot(x,f),m=Ct(v,v),y=v[0],j=m-y*y;if(!j)return!u&&c;var w=a*m/j,E=-a*y/j,A=Ot(b,v),R=Et(b,w),B=Et(v,E);Xt(R,B);var S=A,M=Ct(R,S),q=Ct(S,S),L=M*M-q*(Ct(R,R)-1);if(!(L<0)){var _=Ze(L),k=Et(S,(-M-_)/q);if(Xt(k,R),k=la(k),!u)return k;var N=c[0],T=d[0],H=c[1],G=d[1],Z;T<N&&(Z=N,N=T,T=Z);var z=T-N,O=ie(z-J)<ne,I=O||z<ne;if(!O&&G<H&&(Z=H,H=G,G=Z),I?O?H+G>0^k[1]<(ie(k[0]-N)<ne?H:G):H<=k[1]&&k[1]<=G:z>J^(N<=k[0]&&k[0]<=T)){var P=Et(S,(-M+_)/q);return Xt(P,R),[k,la(P)]}}}function h(c,d){var u=n?e:J-e,x=0;return c<-u?x|=1:c>u&&(x|=2),d<-u?x|=4:d>u&&(x|=8),x}return Yn(l,s,o,n?[0,-e]:[-J,e-J])}function Ri(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],h=a[1],c=0,d=1,u=p-l,x=h-s,f;if(f=r-l,!(!u&&f>0)){if(f/=u,u<0){if(f<c)return;f<d&&(d=f)}else if(u>0){if(f>d)return;f>c&&(c=f)}if(f=i-l,!(!u&&f<0)){if(f/=u,u<0){if(f>d)return;f>c&&(c=f)}else if(u>0){if(f<c)return;f<d&&(d=f)}if(f=n-s,!(!x&&f>0)){if(f/=x,x<0){if(f<c)return;f<d&&(d=f)}else if(x>0){if(f>d)return;f>c&&(c=f)}if(f=o-s,!(!x&&f<0)){if(f/=x,x<0){if(f>d)return;f>c&&(c=f)}else if(x>0){if(f<c)return;f<d&&(d=f)}return c>0&&(e[0]=l+c*u,e[1]=s+c*x),d<1&&(a[0]=l+d*u,a[1]=s+d*x),!0}}}}}var ct=1e9,zt=-ct;function Mi(e,a,r,n){function i(h,c){return e<=h&&h<=r&&a<=c&&c<=n}function o(h,c,d,u){var x=0,f=0;if(h==null||(x=l(h,d))!==(f=l(c,d))||p(h,c)<0^d>0)do u.point(x===0||x===3?e:r,x>1?n:a);while((x=(x+d+4)%4)!==f);else u.point(c[0],c[1])}function l(h,c){return ie(h[0]-e)<ne?c>0?0:3:ie(h[0]-r)<ne?c>0?2:1:ie(h[1]-a)<ne?c>0?1:0:c>0?3:2}function s(h,c){return p(h.x,c.x)}function p(h,c){var d=l(h,1),u=l(c,1);return d!==u?d-u:d===0?c[1]-h[1]:d===1?h[0]-c[0]:d===2?h[1]-c[1]:c[0]-h[0]}return function(h){var c=h,d=Vn(),u,x,f,b,v,m,y,j,w,E,A,R={point:B,lineStart:L,lineEnd:_,polygonStart:M,polygonEnd:q};function B(N,T){i(N,T)&&c.point(N,T)}function S(){for(var N=0,T=0,H=x.length;T<H;++T)for(var G=x[T],Z=1,z=G.length,O=G[0],I,P,D=O[0],U=O[1];Z<z;++Z)I=D,P=U,O=G[Z],D=O[0],U=O[1],P<=n?U>n&&(D-I)*(n-P)>(U-P)*(e-I)&&++N:U<=n&&(D-I)*(n-P)<(U-P)*(e-I)&&--N;return N}function M(){c=d,u=[],x=[],A=!0}function q(){var N=S(),T=A&&N,H=(u=Un(u)).length;(T||H)&&(h.polygonStart(),T&&(h.lineStart(),o(null,null,1,h),h.lineEnd()),H&&Hn(u,s,N,o,h),h.polygonEnd()),c=h,u=x=f=null}function L(){R.point=k,x&&x.push(f=[]),E=!0,w=!1,y=j=NaN}function _(){u&&(k(b,v),m&&w&&d.rejoin(),u.push(d.result())),R.point=B,w&&c.lineEnd()}function k(N,T){var H=i(N,T);if(x&&f.push([N,T]),E)b=N,v=T,m=H,E=!1,H&&(c.lineStart(),c.point(N,T));else if(H&&w)c.point(N,T);else{var G=[y=Math.max(zt,Math.min(ct,y)),j=Math.max(zt,Math.min(ct,j))],Z=[N=Math.max(zt,Math.min(ct,N)),T=Math.max(zt,Math.min(ct,T))];Ri(G,Z,e,a,r,n)?(w||(c.lineStart(),c.point(G[0],G[1])),c.point(Z[0],Z[1]),H||c.lineEnd(),A=!1):H&&(c.lineStart(),c.point(N,T),A=!1)}y=N,j=T,w=H}return R}}const ua=e=>e;var ea=new Ke,fa=new Ke,Wn,Gn,ma,xa,Ie={point:ze,lineStart:ze,lineEnd:ze,polygonStart:function(){Ie.lineStart=Oi,Ie.lineEnd=Fi},polygonEnd:function(){Ie.lineStart=Ie.lineEnd=Ie.point=ze,ea.add(ie(fa)),fa=new Ke},result:function(){var e=ea/2;return ea=new Ke,e}};function Oi(){Ie.point=qi}function qi(e,a){Ie.point=Kn,Wn=ma=e,Gn=xa=a}function Kn(e,a){fa.add(xa*e-ma*a),ma=e,xa=a}function Fi(){Kn(Wn,Gn)}var nt=1/0,qt=nt,bt=-nt,Ft=bt,Pt={point:Pi,lineStart:ze,lineEnd:ze,polygonStart:ze,polygonEnd:ze,result:function(){var e=[[nt,qt],[bt,Ft]];return bt=Ft=-(qt=nt=1/0),e}};function Pi(e,a){e<nt&&(nt=e),e>bt&&(bt=e),a<qt&&(qt=a),a>Ft&&(Ft=a)}var ga=0,ha=0,pt=0,Dt=0,It=0,tt=0,ba=0,va=0,ut=0,Qn,Jn,Me,Oe,Ee={point:Qe,lineStart:pn,lineEnd:un,polygonStart:function(){Ee.lineStart=Bi,Ee.lineEnd=$i},polygonEnd:function(){Ee.point=Qe,Ee.lineStart=pn,Ee.lineEnd=un},result:function(){var e=ut?[ba/ut,va/ut]:tt?[Dt/tt,It/tt]:pt?[ga/pt,ha/pt]:[NaN,NaN];return ga=ha=pt=Dt=It=tt=ba=va=ut=0,e}};function Qe(e,a){ga+=e,ha+=a,++pt}function pn(){Ee.point=Di}function Di(e,a){Ee.point=Ii,Qe(Me=e,Oe=a)}function Ii(e,a){var r=e-Me,n=a-Oe,i=Ze(r*r+n*n);Dt+=i*(Me+e)/2,It+=i*(Oe+a)/2,tt+=i,Qe(Me=e,Oe=a)}function un(){Ee.point=Qe}function Bi(){Ee.point=_i}function $i(){Xn(Qn,Jn)}function _i(e,a){Ee.point=Xn,Qe(Qn=Me=e,Jn=Oe=a)}function Xn(e,a){var r=e-Me,n=a-Oe,i=Ze(r*r+n*n);Dt+=i*(Me+e)/2,It+=i*(Oe+a)/2,tt+=i,i=Oe*e-Me*a,ba+=i*(Me+e),va+=i*(Oe+a),ut+=i*3,Qe(Me=e,Oe=a)}function Zn(e){this._context=e}Zn.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Te);break}}},result:ze};var ya=new Ke,ta,er,tr,ft,mt,vt={point:ze,lineStart:function(){vt.point=Ui},lineEnd:function(){ta&&ar(er,tr),vt.point=ze},polygonStart:function(){ta=!0},polygonEnd:function(){ta=null},result:function(){var e=+ya;return ya=new Ke,e}};function Ui(e,a){vt.point=ar,er=ft=e,tr=mt=a}function ar(e,a){ft-=e,mt-=a,ya.add(Ze(ft*ft+mt*mt)),ft=e,mt=a}let fn,Bt,mn,xn;class gn{constructor(a){this._append=a==null?nr:Vi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==mn||this._append!==Bt){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,mn=n,Bt=this._append,xn=this._,this._=i}this._+=xn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function nr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Vi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return nr;if(a!==fn){const r=10**a;fn=a,Bt=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Bt}function Hi(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),et(s,i(o))),o.result()}return l.area=function(s){return et(s,i(Ie)),Ie.result()},l.measure=function(s){return et(s,i(vt)),vt.result()},l.bounds=function(s){return et(s,i(Pt)),Pt.result()},l.centroid=function(s){return et(s,i(Ee)),Ee.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,ua):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new gn(r)):new Zn(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new gn(r)),l},l.projection(e).digits(r).context(a)}function za(e){return function(a){var r=new wa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function wa(){}wa.prototype={constructor:wa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ta(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),et(r,e.stream(Pt)),a(Pt.result()),n!=null&&e.clipExtent(n),e}function rr(e,a,r){return Ta(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function Yi(e,a,r){return rr(e,[[0,0],a],r)}function Wi(e,a,r){return Ta(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Gi(e,a,r){return Ta(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var hn=16,Ki=de(30*Ce);function bn(e,a){return+a?Ji(e,a):Qi(e)}function Qi(e){return za({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Ji(e,a){function r(n,i,o,l,s,p,h,c,d,u,x,f,b,v){var m=h-n,y=c-i,j=m*m+y*y;if(j>4*a&&b--){var w=l+u,E=s+x,A=p+f,R=Ze(w*w+E*E+A*A),B=ht(A/=R),S=ie(ie(A)-1)<ne||ie(o-d)<ne?(o+d)/2:gt(E,w),M=e(S,B),q=M[0],L=M[1],_=q-n,k=L-i,N=y*_-m*k;(N*N/j>a||ie((m*_+y*k)/j-.5)>.3||l*u+s*x+p*f<Ki)&&(r(n,i,o,l,s,p,q,L,S,w/=R,E/=R,A,b,v),v.point(q,L),r(q,L,S,w,E,A,h,c,d,u,x,f,b,v))}}return function(n){var i,o,l,s,p,h,c,d,u,x,f,b,v={point:m,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=E},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function m(B,S){B=e(B,S),n.point(B[0],B[1])}function y(){d=NaN,v.point=j,n.lineStart()}function j(B,S){var M=at([B,S]),q=e(B,S);r(d,u,c,x,f,b,d=q[0],u=q[1],c=B,x=M[0],f=M[1],b=M[2],hn,n),n.point(d,u)}function w(){v.point=m,n.lineEnd()}function E(){y(),v.point=A,v.lineEnd=R}function A(B,S){j(i=B,S),o=d,l=u,s=x,p=f,h=b,v.point=j}function R(){r(d,u,c,x,f,b,o,l,i,s,p,h,hn,n),v.lineEnd=w,w()}return v}}var Xi=za({point:function(e,a){this.stream.point(e*Ce,a*Ce)}});function Zi(e){return za({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function es(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function vn(e,a,r,n,i,o){if(!o)return es(e,a,r,n,i);var l=de(o),s=ce(o),p=l*e,h=s*e,c=l/e,d=s/e,u=(s*r-l*a)/e,x=(s*a+l*r)/e;function f(b,v){return b*=n,v*=i,[p*b-h*v+a,r-h*b-p*v]}return f.invert=function(b,v){return[n*(c*b-d*v+u),i*(x-d*b-c*v)]},f}function ts(e){return as(function(){return e})()}function as(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,h=0,c,d=0,u=1,x=1,f=null,b=cn,v=null,m,y,j,w=ua,E=.5,A,R,B,S,M;function q(N){return B(N[0]*Ce,N[1]*Ce)}function L(N){return N=B.invert(N[0],N[1]),N&&[N[0]*De,N[1]*De]}q.stream=function(N){return S&&M===N?S:S=Xi(Zi(c)(b(A(w(M=N)))))},q.preclip=function(N){return arguments.length?(b=N,f=void 0,k()):b},q.postclip=function(N){return arguments.length?(w=N,v=m=y=j=null,k()):w},q.clipAngle=function(N){return arguments.length?(b=+N?Li(f=N*Ce):(f=null,cn),k()):f*De},q.clipExtent=function(N){return arguments.length?(w=N==null?(v=m=y=j=null,ua):Mi(v=+N[0][0],m=+N[0][1],y=+N[1][0],j=+N[1][1]),k()):v==null?null:[[v,m],[y,j]]},q.scale=function(N){return arguments.length?(r=+N,_()):r},q.translate=function(N){return arguments.length?(n=+N[0],i=+N[1],_()):[n,i]},q.center=function(N){return arguments.length?(o=N[0]%360*Ce,l=N[1]%360*Ce,_()):[o*De,l*De]},q.rotate=function(N){return arguments.length?(s=N[0]%360*Ce,p=N[1]%360*Ce,h=N.length>2?N[2]%360*Ce:0,_()):[s*De,p*De,h*De]},q.angle=function(N){return arguments.length?(d=N%360*Ce,_()):d*De},q.reflectX=function(N){return arguments.length?(u=N?-1:1,_()):u<0},q.reflectY=function(N){return arguments.length?(x=N?-1:1,_()):x<0},q.precision=function(N){return arguments.length?(A=bn(R,E=N*N),k()):Ze(E)},q.fitExtent=function(N,T){return rr(q,N,T)},q.fitSize=function(N,T){return Yi(q,N,T)},q.fitWidth=function(N,T){return Wi(q,N,T)},q.fitHeight=function(N,T){return Gi(q,N,T)};function _(){var N=vn(r,0,0,u,x,d).apply(null,a(o,l)),T=vn(r,n-N[0],i-N[1],u,x,d);return c=ji(s,p,h),R=ca(a,T),B=ca(c,R),A=bn(R,E),k()}function k(){return S=M=null,q}return function(){return a=e.apply(this,arguments),q.invert=a.invert&&L,_()}}function or(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}or.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ns(){return ts(or).scale(175.295)}function rs(e){return e}function os(e){if(e==null)return rs;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var h=2,c=s.length,d=new Array(c);for(d[0]=(a+=s[0])*n+o,d[1]=(r+=s[1])*i+l;h<c;)d[h]=s[h],++h;return d}}function is(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ss(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return yn(e,r)})}:yn(e,a)}function yn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=ls(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function ls(e,a){var r=os(e.transform),n=e.arcs;function i(c,d){d.length&&d.pop();for(var u=n[c<0?~c:c],x=0,f=u.length;x<f;++x)d.push(r(u[x],x));c<0&&is(d,f)}function o(c){return r(c)}function l(c){for(var d=[],u=0,x=c.length;u<x;++u)i(c[u],d);return d.length<2&&d.push(d[0]),d}function s(c){for(var d=l(c);d.length<4;)d.push(d[0]);return d}function p(c){return c.map(s)}function h(c){var d=c.type,u;switch(d){case"GeometryCollection":return{type:d,geometries:c.geometries.map(h)};case"Point":u=o(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(o);break;case"LineString":u=l(c.arcs);break;case"MultiLineString":u=c.arcs.map(l);break;case"Polygon":u=p(c.arcs);break;case"MultiPolygon":u=c.arcs.map(p);break;default:return null}return{type:d,coordinates:u}}return h(a)}const ir={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ds=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function cs(e,a,r){const n=ir[e];if(!n||!n.length)return-1;const i=ds(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Tt=null;function ps(){return Tt||(Tt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ss(r,n),o=ns().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Hi(o),s=(i.features||[]).filter(c=>{var d;return(((d=c.properties)==null?void 0:d.name)||"")!=="Antarctica"}).map(c=>{var x;const d=((x=c.properties)==null?void 0:x.name)||"",u=l(c)||"";return u?{i2:Ur(d)||null,n:d,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const p={};for(const[c,d]of Object.entries(Vr)){const u=o(d);u&&(p[c]={x:u[0],y:u[1]})}const h={};for(const[c,d]of Object.entries(ir)){const u=d.map(x=>o(x.ll)).filter(x=>!!x).map(([x,f])=>({x,y:f}));u.length&&(h[c]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:h}}catch{return null}})(),Tt)}function us(e){const[a,r]=g.useState(null);return g.useEffect(()=>{if(!e||a)return;let n=!1;return ps().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const fs={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},wn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function kn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ms(e,a){const[r,n]=g.useState(1);return g.useEffect(()=>{let i=!0,o=0;const l=()=>{var h;if(!i)return;const p=(h=e.current)==null?void 0:h.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function xs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p,data:h,dossiers:c}=F(),d=h.loading&&!c.length,u=g.useRef(null),x=g.useRef(null),f=us(e.continent==="monde"),b=e.continent==="monde"?f:Ca.find(k=>k.key===e.continent)||null,v=ms(u,e.continent+":"+e.mapFolded+":"+!!b),[m,y]=g.useState(new Map),[j,w]=g.useState(null);g.useEffect(()=>{const k=u.current;if(!k)return;const N=new Map;k.querySelectorAll("path[data-i2]").forEach(T=>{const H=T.dataset.i2;if(H)try{const G=T.getBBox();G.width>0&&N.set(H,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(N)},[e.continent,v,b]);const E=g.useMemo(()=>r.filter(k=>k.cc),[r]),A=g.useMemo(()=>{const k=new Map;return E.forEach(N=>k.set(N.cc,(k.get(N.cc)||0)+1)),k},[E]),R=e.continent==="monde"&&f?f.anchors:null,B=e.continent==="monde"&&f?f.metros:null,S=g.useMemo(()=>E.map(k=>{const N=kn(k.name||k.id||""),T=kn((k.id||k.name||"")+"·y");if(R&&k.cc){const O=B?B[k.cc]:void 0;if(O&&O.length){const P=cs(k.cc,k.city,N);if(P>=0&&O[P])return{d:k,x:O[P].x+(N-.5)*5,y:O[P].y+(T-.5)*5}}const I=R[k.cc];if(I)return{d:k,x:I.x+(N-.5)*10,y:I.y+(T-.5)*10}}const H=k.cc?m.get(k.cc):void 0;if(!H)return null;const G=fs[`${e.continent}:${k.cc||""}`];if(G)return{d:k,x:H.x+H.w*(G.fx+(N-.5)*G.sx),y:H.y+H.h*(G.fy+(T-.5)*G.sy)};const Z=(N-.5)*Math.min(H.w*.55,60),z=(T-.5)*Math.min(H.h*.55,60);return{d:k,x:H.x+H.w/2+Z,y:H.y+H.h/2+z}}).filter(k=>!!k),[E,m,R,B,e.continent]),M=k=>v>0?k/v:k,q=g.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:wn[k],fr:p.plabels[k].toUpperCase(),en:p.plabels[k].toUpperCase(),n:r.filter(N=>N.kind==="target"&&je(N)===k).length})).filter(k=>k.n>0):Ba.map((k,N)=>({...k,n:r.filter(T=>$a(T)===N).length})),[r,n,p.plabels]),L=o?l.get(o):null,_=L?S.find(k=>k.d.id===L.id):null;return b?t.jsxs("div",{className:"mapzone"+(d?" waiting":""),ref:x,children:[t.jsxs("svg",{ref:u,viewBox:b.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?b.fr:b.en,onMouseLeave:()=>{w(null),i(null)},children:[t.jsx("g",{children:b.countries.map((k,N)=>t.jsx("g",{className:"ct"+(k.i2&&A.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},N))}),t.jsx("g",{children:S.map(k=>{const N=Ba[$a(k.d)],T=!!me(k.d),H=k.d.kind==="target",G=n&&H?wn[je(k.d)]:N.c,Z=!n&&ye(k.d);return t.jsxs("g",{className:"co"+(Z?" done":""),onMouseEnter:()=>{var I,P;const z=(I=x.current)==null?void 0:I.getBoundingClientRect(),O=(P=u.current)==null?void 0:P.createSVGPoint();if(O&&u.current&&z){O.x=k.x,O.y=k.y;const D=O.matrixTransform(u.current.getScreenCTM());w({x:D.x-z.left,y:D.y-z.top,label:k.d.name+" · "+(it(k.d.cc,s)||k.d.countryLabel||"")})}i(k.d.id)},onMouseLeave:()=>{w(null),i(null)},onClick:()=>{var I;const z=(I=u.current)==null?void 0:I.createSVGPoint();let O=null;if(z&&u.current){z.x=k.x,z.y=k.y;const P=z.matrixTransform(u.current.getScreenCTM());O={x:P.x,y:P.y}}a({type:"popup",id:k.d.id,anchor:O})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:M(Math.max(11,N.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:M(N.px),fill:G,stroke:T?"#DC2626":"#ffffff",strokeWidth:M(T?2.2:1.3)})]},k.d.id||k.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:q.map((k,N)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},N))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:x})}function gs(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function hs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=F(),s=e.filters,p=g.useMemo(()=>e.continent==="monde"?r:r.filter(f=>f.continent===e.continent),[r,e.continent]),h=f=>p.filter(b=>f!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:Ea(b,s,i,f==="country"?void 0:f)),c=g.useMemo(()=>{const f=h("win"),b=v=>f.filter(m=>(m.date?Math.max(0,Math.floor((Date.now()-Date.parse(m.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),f.length]},[p,s,i]),d=g.useMemo(()=>s.day?h("win").filter(f=>(f.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),x=(f,b,v,m="fbtn")=>t.jsxs("button",{type:"button",className:m,"aria-expanded":e.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},f);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(gs(s.day,l)),t.jsx("b",{children:d})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[n.dates[b],t.jsx("b",{children:c[b]})]},f))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):x("sec",n.fSector,s.sector.length),x("pay",n.fCountry,s.country.length),x("det",n.fEngine,s.engine.length),x("sta",n.fStage,s.stage.length),i&&x("ang","Angle",s.angle.length),i&&x("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(bs,{poolFor:h})]})}function bs({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:h}=g.useMemo(()=>{if(l==="sig"){const f=e("signal").filter(m=>me(m)),b=new Map;f.forEach(m=>{const y=m.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:f.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ra([...b.keys()],i).map(m=>({v:m,label:Ge(m)+" "+qe(m,i),n:b.get(m)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(m)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const f=e("sector"),b=new Map;return f.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v,n:m,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const f=e("country"),b=new Map;return f.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:it(v,i)||v,n:m,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const f=e("engine"),b=new Map;return f.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ra([...b.keys()],i).map(v=>({v,label:Ge(v)+" "+qe(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Hr(Yr(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const f=e("angle"),b=new Map;return f.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v.replace(/[_-]+/g," "),n:m,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const f=e("memoLevel"),b=new Map;f.forEach(m=>{if(m.kind==="target"){const y=Na(m);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(m=>({v:String(m),label:v[m],n:b.get(m)||0,html:!1,on:o.memoLevel.includes(m)}))}}const u=e("stage"),x=new Map;return u.forEach(f=>{f.stage&&x.set(f.stage,(x.get(f.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...x.entries()].sort((f,b)=>b[1]-f[1]).map(([f,b])=>({v:f,label:f,n:b,html:!1,on:o.stage.includes(f)}))}},[l,a,i]),c=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const f=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},d=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:d,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:h.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>c(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function sr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function vs(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function jn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=F();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function lr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=F(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(jn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(jn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function ys({card:e,onEvaluate:a,onAddAll:r}){var s,p,h;const{t:n}=F(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:sr(e.summary_md||"").map((c,d)=>t.jsx("p",{children:c},d))})]}),t.jsx(lr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function ws(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function ks({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=F(),s=i,[p,h]=g.useState(null),[c,d]=g.useState(null),[u,x]=g.useState(null),[f,b]=g.useState(!1);g.useEffect(()=>{let m=!0;return(async()=>{const y=await On({email:l,cbToken:s});m&&h(y)})(),()=>{m=!1}},[l,s,n]);const v=m=>{d(m),x(null),b(!0),(async()=>{const y=await Wr(m.id);x(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{d(null),x(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[ws(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?o.rsPub:o.rsPriv})]},m.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),f&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!f&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!f&&u&&t.jsx(ys,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Nn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function js(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:h,data:c,canWrite:d,source:u}=F(),x=a==="client",f=g.useMemo(()=>r||(u!=="default"?Gr():""),[r,u]),[b,v]=g.useState(""),[m,y]=g.useState(!1),[j,w]=g.useState(""),[E,A]=g.useState(!1),[R,B]=g.useState(""),[S,M]=g.useState([]),q=g.useRef(!1),[L,_]=g.useState(!1),[k,N]=g.useState(""),[T,H]=g.useState(""),[G,Z]=g.useState(!1),[z,O]=g.useState(0),[I,P]=g.useState(""),[D,U]=g.useState(null),[W,X]=g.useState(null),[oe,ue]=g.useState(!1),[pe,Q]=g.useState(null),[te,he]=g.useState(0),K=g.useRef(!1),se=b.trim()?Nn.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,ee=g.useMemo(()=>j.split(`
`).map($=>$.trim()).filter(Boolean).slice(0,15),[j]);g.useEffect(()=>{if(typeof window>"u")return;const $=(new URLSearchParams(window.location.search).get("rs")||"").trim();!$||!/^https?:\/\//i.test($)||(N($),_(!0))},[]),g.useEffect(()=>{const $=ae=>{var be;const le=String(((be=ae.detail)==null?void 0:be.url)||"").trim();!le||!/^https?:\/\//i.test(le)||(N(le),_(!0))};return window.addEventListener("ppmap:research",$),()=>window.removeEventListener("ppmap:research",$)},[]),g.useEffect(()=>{if(!d&&!f){Q(null);return}let $=!0;return(async()=>{const ae=await On({email:n,cbToken:f});$&&Q(ae.length)})(),()=>{$=!1}},[d,f,n,te]);const Be=S.length?S:p,fe=c.credits,xe=g.useCallback($=>{const ae=$.map(le=>(le||"").trim()).filter(Boolean);ae.length&&(w(le=>{const be=le.split(`
...
`)}),y(!0))},[]);g.useEffect(()=>{if(!G)return;O(0);const $=window.setInterval(()=>O(ae=>ae+1),1e3);return()=>window.clearInterval($)},[G]);const Fe=()=>{const $=b.trim();$&&(i(null,$),v(""))},Ue=async()=>{if(!x){i(null,ee[0]||"");return}if(!ee.length||E)return;A(!0),q.current=!1;const $=[];for(let ae=0;ae<ee.length&&!q.current;ae++){B(e.evaluating(ae+1,ee.length,ee[ae]));const le=await qn(r,ee[ae],"atelier2");if($.unshift({name:le.company||ee[ae],verdict:le.verdict,reason:le.reason||"",remaining:le.remaining??null}),M([...$]),le.verdict==="quota"){$.unshift({name:"",verdict:"quota",reason:e.quota(ee.length-ae-1),remaining:0}),M([...$]),w(ee.slice(ae+1).join(`
`)),B(""),A(!1);return}}B(""),w(q.current?ee.slice($.length).join(`
`):""),A(!1)},Ne=async()=>{var le,be,$e;if(K.current)return;const $=k.trim().replace(/\s+/g,""),ae=T.trim();if(!$&&!ae){P(e.rsNeed);return}if(!x&&!f){i(null,$||ae.slice(0,80));return}K.current=!0,P(""),U(null),X(null),Z(!0);try{const we=await Qr({url:$,text:ae,email:n,cbToken:f});if(Z(!1),!we||we.status!=="success"){P((we==null?void 0:we.message)||"Erreur");return}U(we),_(!1),xe((((le=we.prospective)==null?void 0:le.companies_to_evaluate)||[]).map(_e=>(_e==null?void 0:_e.name)||"")),X({state:"pending"});const Se=await Jr(we,{email:n,cbToken:f});X(Se.ok?{state:"ok",scopeLabel:((be=Se.summary)==null?void 0:be.scope_label)||"",scope:(($e=Se.summary)==null?void 0:$e.scope)||""}:{state:"fail",msg:Se.error||""}),Se.ok&&he(_e=>_e+1)}finally{K.current=!1,Z(!1)}},Pe=[D==null?void 0:D.industry,...(D==null?void 0:D.market_tags)||[],D==null?void 0:D.author].map($=>($||"").trim()).filter(Boolean),st=(W==null?void 0:W.state)==="pending",Vt=W&&(st?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):W.state==="ok"?t.jsx("span",{className:"rslink ok",children:W.scope&&W.scope!=="public"?e.rsSavedIn(W.scopeLabel||W.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:W.msg,children:e.rsSaveFail})),Ht=vs(D).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:b,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:$=>v($.target.value),onKeyDown:$=>{$.key==="Enter"&&Fe()}}),t.jsx("span",{className:"detect"+(Nn.test(b.trim())?" url":""),children:se})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:Fe,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),h.showCredits&&fe&&t.jsxs("button",{type:"button",className:"credits"+(fe.total_available<=0&&!fe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:fe.unlimited?"∞":fe.total_available}),!fe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",fe.daily_grant+fe.purchased]}),fe.total_available<=0&&!fe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!m),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(L?" on":""),onClick:()=>_(!L),children:e.rsOpen}),pe!==null&&pe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(oe?" on":""),onClick:()=>ue(!oe),children:e.rsArchOpen(pe)})]}),oe&&t.jsx(ks,{bump:te,cbToken:f,onClose:()=>ue(!1),onEvaluate:$=>i(null,$),onAddAll:xe}),L&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:k,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:$=>N($.target.value),onKeyDown:$=>{$.key==="Enter"&&Ne()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:T,placeholder:e.rsTextPh,onChange:$=>H($.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(G?" loading":""),style:{justifyContent:"center"},disabled:G||st||!k.trim()&&!T.trim(),onClick:()=>{Ne()},children:[t.jsx("span",{className:"fill"}),G?`${Kr(k.trim())==="youtube"&&k.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(z)}`:st?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),I&&t.jsx("div",{className:"rserr",children:I}),D&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:D.title}),D.source_url&&t.jsx("a",{href:D.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{U(null),X(null)},children:"×"})]}),D.market&&t.jsx("p",{className:"rsmk",children:D.market}),Pe.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Pe.map($=>t.jsx("span",{children:$},$))]}),t.jsxs("div",{className:"rsbody",children:[D.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${D.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:sr(D.summary_md||"").map(($,ae)=>t.jsx("p",{children:$},ae))})]}),t.jsx(lr,{card:D,onEvaluate:$=>i(null,$),onAddAll:xe}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Ht)}),Vt]})]}),m&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:j,placeholder:e.bulkPh,onChange:$=>w($.target.value.split(`
`).slice(0,15).join(`
...
`):"",[o]);if(!o)return null;const s=Xe(o),p=Na(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((h,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:h},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[yt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const aa={},Sn=(aa==null?void 0:aa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Cn(){return new Date().toISOString().slice(0,10)}const La=g.createContext(null);function Cs(){return g.useContext(La)}function Es(e){if(!e||typeof DOMParser>"u")return[];try{const r=[...new DOMParser().parseFromString(e,"text/html").querySelectorAll("div,section")].find(i=>/en bref/i.test(i.textContent||"")&&i.querySelector("li"));return(r?[...r.querySelectorAll("li")]:[]).map(i=>(i.textContent||"").replace(/\s+/g," ").trim()).filter(i=>i.length>3).slice(0,4)}catch{return[]}}function As(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(p=>p.remove()),s.querySelectorAll("*").forEach(p=>{const h=p.tagName==="A"?p.getAttribute("href"):null;[...p.attributes].forEach(c=>p.removeAttribute(c.name)),h&&/^https?:\/\//i.test(h)&&(p.setAttribute("href",h),p.setAttribute("target","_blank"),p.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function zs(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Ts(){const{ed:e,isEn:a,day:r,loading:n}=dr(),i=g.useMemo(()=>Es((e==null?void 0:e.html)||""),[e==null?void 0:e.html]);if(n&&!e)return null;const o=zs(r,a);return i.length?t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:(a?"Daily brief · ":"Brief du jour · ")+o}),t.jsx("ul",{children:i.map((l,s)=>t.jsx("li",{children:l},s))})]}):t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:a?"Daily brief":"Brief du jour"}),t.jsx("p",{className:"tlp",children:a?`Edition of ${o}.`:`Édition du ${o}.`})]})}function dr(){const e=g.useContext(La);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ls({token:e,children:a}){const{dispatch:r,st:n,lang:i}=F(),[o,l]=g.useState(()=>n.filters.day||Cn()),[s,p]=g.useState(null),[h,c]=g.useState(!1),d=g.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=g.useCallback(()=>{l(Cn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);g.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),g.useEffect(()=>{const b=v=>{var y;const m=(y=v.detail)==null?void 0:y.day;typeof m=="string"&&d(m)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[d]),g.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),g.useEffect(()=>{if(!e||!o)return;let b=!1;c(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${Sn}/cibles/edition.json?${v}`).then(m=>m.json()).then(m=>{b||p(m)}).catch(()=>{b||p({ok:!1,error:"network"})}).finally(()=>{b||c(!1)}),()=>{b=!0}},[e,o]);const x=g.useMemo(()=>`${Sn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),f=g.useMemo(()=>({token:e,day:o,ed:s,loading:h,pickDay:d,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:x,isEn:i==="en"}),[e,o,s,h,d,u,n.filters.day,x,i]);return t.jsx(La.Provider,{value:f,children:a})}function Rs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=dr();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(Xr,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function cr({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=F(),[l,s]=g.useState(!1),[p,h]=g.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const c=async()=>{if(l)return;s(!0);const d=await Zr(r,e);if(s(!1),!d){o(a.actErr);return}h(d.results||[])};return t.jsxs("div",{className:"simb",onClick:d=>d.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{c()},children:l?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(d=>t.jsxs("li",{children:[t.jsx("b",{className:d.verdict==="kept"?"ok":"ko",children:d.company}),d.reason&&t.jsx("span",{children:d.reason})]},d.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}function _t({spec:e}){const a=g.useRef(null),r=g.useRef(null),[n,i]=g.useState(!1);return g.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;return _a({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)}),()=>{l=!0,o.replaceChildren()}},[e]),g.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;_a({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(p=>{!l&&p&&o.isConnected&&o.replaceChildren(p)});const s=p=>{p.key==="Escape"&&i(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&ot.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Ms=`
...
`;function Os(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function qs(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:p,doDecide:h,doPromote:c,doRepeche:d,doApproach:u,doDeep:x,doOnboard:f,outbound:b,evalBusy:v}=F(),m=e.popupId?r.get(e.popupId):null;if(!m)return null;const y=me(m),j=je(m),w=Xe(m),E=m.kind==="target",A=R=>{a({type:"filters",patch:R}),a({type:"popup",id:null})};return ot.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Ms}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Os(e.popupAnchor,!!m.card),onClick:R=>R.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:m.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(rt(m.date)),qe(m.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[m.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[m.cc]}),children:(it(m.cc,i)||m.countryLabel||"").toUpperCase()}),m.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[m.sector]}),children:m.sector.toUpperCase()}),m.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[m.stage]}),children:m.stage.toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{className:"am2",children:wt(m.amountEur,i)})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ge(m.engine)," ",t.jsx("b",{children:qe(m.engine,i)})," — ",eo(m.engine,i),m.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",m.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Je,{o:m,lg:!0})," ",t.jsx(Ut,{o:m,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Fn(y,i))," · ",n.win7(Pn(y,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),m.card?t.jsx(_t,{spec:m.card}):null,m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),o.pipe&&E&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof m.score=="number"&&m.score>0?" · "+n.score(m.score):""]})})]}),t.jsx(cr,{name:m.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(m,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(m,!1),a({type:"popup",id:null})},children:n.actNo}),yt(m)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{x(m),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),m.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:m.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{f(m),a({type:"popup",id:null})},children:"🚀"})]}):m.engine==="media"&&m.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var R;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"popup",id:null}),(R=document.querySelector(".atl2 .demand"))==null||R.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(m.name),onClick:()=>s(m),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)," →"]}),m.website&&t.jsx("a",{className:"psite",href:m.website.startsWith("http")?m.website:"https://"+m.website,target:"_blank",rel:"noopener noreferrer",title:m.website,children:"🌐"})]})]})]}),document.body)}const Fs=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Lt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Ps(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Lt(a.slice(n));break}r+=Lt(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Lt(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&Fs.has(p)?r+=`<${s[1]}${p}>`:r+=Lt(a.slice(i,o+1)),n=o+1}return r}const En=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ve({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ds(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Is({o:e}){const{t:a,doDeep:r}=F(),n=Xe(e),i=[e.reasoning||"",Ds(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[n&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:n}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),i.length?i.join(`

`).split(`

`).map((o,l)=>t.jsx("p",{className:"cdtxt",children:o},l)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[yt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:o=>{o.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:o=>o.stopPropagation(),children:a.memoOpenFull})]})]})}function Bs({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=F(),o=$t(e),l=Xe(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,h=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,c=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),d=g.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:h},{k:"suivi",lib:a.cdSuivi,n:c},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||yt(e)?1:0}].filter(b=>b.n>0),[e,a,s,l,p,h,c]),[u,x]=g.useState("");if(!d.length)return null;const f=d.some(b=>b.k===u)?u:d[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:d.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":f===b.k,className:f===b.k?"on":"",onClick:v=>{v.stopPropagation(),x(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[f==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(ve,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(ve,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(ve,{k:a.cdVerdictDate,v:En(e.verdictDate,r)})]})]}),f==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Ps(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx($s,{o:e})]}),f==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ve,{k:a.cdSector,v:e.sector}),t.jsx(ve,{k:a.cdStage,v:e.stage}),t.jsx(ve,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ve,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(ve,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(ve,{k:a.cdAngle,v:e.angle}),t.jsx(ve,{k:a.cdDetected,v:En(e.date,r)})]}),f==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ve,{k:a.cdName,v:e.contactName}),t.jsx(ve,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(ve,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),f==="memo"&&t.jsx(Is,{o:e}),f==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(ve,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(ve,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function $s({o:e}){const{t:a,token:r}=F(),[n,i]=g.useState(!1),[o,l]=g.useState(null),s=async()=>{n||(i(!0),l(await to(r,e.name,e.website||e.domain||"")),i(!1))},p=(o==null?void 0:o.blocs)||{},h=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],c=h.some(([,d])=>d);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&c&&t.jsxs(t.Fragment,{children:[h.filter(([,d])=>d).map(([d,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:d}),t.jsx("p",{children:u})]},d)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!c&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const pr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ra({o:e}){const{t:a}=F(),r=$t(e),n=Xe(e),i=je(e),o=na(e),l=ao(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(pr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const ka=e=>e.length>22?e.slice(0,21)+"…":e;function An({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=F(),[o,l]=g.useState(!1);if(g.useEffect(()=>{n||l(!1)},[n]),ye(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(ka(e.name))})]})}function ur({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:p,doApproach:h,dispatch:c}=F();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:x=>{x.stopPropagation(),c({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:x=>{var f;x.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(f=document.querySelector(".atl2 .demand"))==null||f.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(An,{o:e})});const d=je(e),u=x=>f=>{f.stopPropagation(),x()};if(d===0)return t.jsx("span",{className:"cell",children:t.jsx(An,{o:e})});if(d===1){const x=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:x,onClick:u(()=>o(e)),children:x?a.actAnalyseQueued:a.actAnalyse})})}if(d===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})});if(d===4){const x=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:x,onClick:u(()=>h(e)),children:x?a.actApproachSent:a.actApproach})})}return d===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):d===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>c({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function _s({o:e}){const{t:a,doThumb:r,thumbOf:n}=F(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Us({o:e}){const{lang:a}=F();return me(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Je,{o:e}),t.jsx(Ut,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ge(e.engine||"")," ",qe(e.engine||"",a)]})})}function Vs({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:p,favIds:h,toggleFav:c}=F(),d=je(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],x=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,f=x<=0?0:x<=7?1:x<=30?2:3,b=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][d]:u[f],v=h.has(e.id),m=y=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const j=y.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:j.left+Math.min(280,j.width/3),y:j.bottom}})};return t.jsxs(g.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:m,children:[t.jsx("span",{className:"pt",style:{"--c":b}}),t.jsx(gr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:v?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),c(e)},children:v?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(Hs,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Us,{o:e}),l.pipe&&t.jsx(Ra,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(ur,{o:e}),l.showThumbs&&t.jsx(_s,{o:e})]}),r&&!a&&t.jsx(Ws,{o:e})]})}function Hs({o:e}){const{lang:a,caps:r}=F();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=wt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Ys({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=F(),l=(u,x=!1)=>f=>{f.stopPropagation(),x&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),p=wt(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=ye(e),d=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),p&&t.jsx("span",{className:"oc-amt",children:p}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":d?"var(--brand)":"var(--red)"},children:[d?"✓":"✗"," ",t.jsx("b",{children:d?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var x;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(x=document.querySelector(".atl2 .demand"))==null||x.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ka(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ka(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(_t,{spec:e.card})})]})}function Ws({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=F();return!i.pipe&&e.kind==="op"?t.jsx(Ys,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Bs,{o:e}),t.jsx(si,{o:e}),t.jsx(ci,{o:e}),t.jsx(cr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Ra,{o:e})})]}),e.card&&t.jsx(_t,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ge(e.engine||"")," ",qe(e.engine||"",r)]}),me(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Je,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Gs({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:l}=F();if(!i.pipe&&e.kind==="op"){const h=wt(e.amountEur,l),c=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),d=(u,x=!1)=>f=>{f.stopPropagation(),x&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" locked":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(_t,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),h&&t.jsx("span",{className:"damt",children:h})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Ge(e.engine||"")," ",qe(e.engine||"",l)]}),me(e)&&t.jsx(Je,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(c?` · ${c}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(ur,{o:e})})]})}const s=je(e),p=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":p},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Ra,{o:e}),me(e)&&t.jsx(Je,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Ks(){const{t:e}=F(),[a,r]=g.useState(0);return g.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Qs({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=i==="en",l=c=>n.plabels[c]||"",s=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),p=s.includes(0)?0:s.sort((c,d)=>(e[d]||0)-(e[c]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?o?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:o?`${h} ${h>1?"files":"file"} in “${l(p)}”`:`${h} dossier${h>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(o?"Open ":"Ouvrir ")+l(p)," →"]})]})}function Js(){var Z;const e=F(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,lang:s,sessTally:p,data:h,dossiers:c,source:d}=e,u=d==="ops"?8:In,[x,f]=g.useState(new Set);g.useEffect(()=>{f(new Set)},[a.ptab,a.continent]);const[b,v]=g.useState(null);g.useEffect(()=>{v(null)},[a.ptab,a.continent]);const m=z=>f(O=>{const I=new Set(O);return I.has(z)?I.delete(z):I.add(z),I}),[y,j]=g.useState("all"),[w,E]=g.useState(!1);g.useEffect(()=>{j("all"),E(!1)},[a.ptab,a.continent]),g.useEffect(()=>{if(!w)return;const z=O=>{var I,P;(P=(I=O.target)==null?void 0:I.closest)!=null&&P.call(I,".atl2 .doable")||E(!1)};return document.addEventListener("click",z),()=>document.removeEventListener("click",z)},[w]);const A=Cs(),R=g.useMemo(()=>{var O;const z=new Map;for(const I of As(((O=A==null?void 0:A.ed)==null?void 0:O.html)||""))z.has(I.t)||z.set(I.t,I.html);return z},[(Z=A==null?void 0:A.ed)==null?void 0:Z.html]),B=g.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!R.size)return;const O=(z.name||"").trim().toLowerCase();if(O.length<3)return;const I=R.get(O);if(I)return I;for(const[P,D]of R)if(P.includes(O)||O.includes(P))return D},[R]),S=g.useMemo(()=>{const z=Aa(l,a.sort);return y==="all"?z:d==="ops"?z.filter(O=>y==="explore"?!!O.noCo:!O.noCo):z.filter(O=>y==="explore"?ye(O):!ye(O))},[l,a.sort,d,y]),M=g.useMemo(()=>S.filter(z=>me(z)&&!ye(z)).length,[S]),q=g.useMemo(()=>i.pipe?S:S.filter(z=>!ye(z)&&!z.noCo),[S,i.pipe]),L=d==="ops"?S.filter(z=>z.noCo).length:0,_=i.pipe?n.plabels[a.ptab].toLowerCase():d==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,k=(z,O,I="",P=!1)=>t.jsxs("button",{type:"button","data-s":z,className:I,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:P?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[O,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),N=g.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const z=new Map;S.forEach(P=>{const D=P.engine||"?";z.has(D)||z.set(D,[]),z.get(D).push(P)});const O={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},I=ra([...z.keys()],s);return[...z.entries()].sort((P,D)=>{const U=O[P[0]]??10+I.indexOf(P[0]),W=O[D[0]]??10+I.indexOf(D[0]);return U-W})},[S,i.pipe,a.groupBy,s]),T=i.lockRowsAfter;let H=0;const G=(z,O)=>{let I=a.shown[O]||u;return z.length-I<=4&&(I=z.length),z.slice(0,I).map(U=>{const W=T!==null&&H>=T;H++;const X=B(U),oe=X&&X!==U.decryptHtml?{...U,decryptHtml:X}:U,ue=a.dens!=="maxi"&&(a.dens==="deplie"||(b?b==="open":!!X)),pe=x.has(U.id)?!ue:ue;return a.dens==="maxi"?t.jsx(Gs,{o:oe,locked:W},U.id):t.jsx(Vs,{o:oe,locked:W,open:pe,onToggle:()=>m(U.id)},U.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:S.length})," ",_]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",d==="ops"&&S.length>0&&" — "+n.edSplit(S.length-L,L)]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||d==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,O])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:O})]},z))}),(i.showFunnel||d==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":b==="open",onClick:()=>{v("open"),f(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":b==="closed",onClick:()=>{v("closed"),f(new Set)},children:n.foldAllLbl}),d==="ops"&&t.jsxs("button",{type:"button","aria-pressed":b===null,onClick:()=>{v(null),f(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||d==="ops")&&(()=>{var I;const z=[["all",n.doAll],["eval",d==="ops"?n.doEval:n.doTodo],["explore",d==="ops"?n.doExplore:n.doDone]],O=((I=z.find(([P])=>P===y))==null?void 0:I[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":w,onClick:()=>E(P=>!P),children:[O,t.jsx("i",{children:"▾"})]}),w&&t.jsx("div",{className:"dolist",children:z.map(([P,D])=>t.jsx("button",{type:"button","aria-pressed":y===P,onClick:()=>{j(P),E(!1)},children:D},P))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([z,O])=>t.jsx("option",{value:z,children:O},z))})]}),i.showChain&&q.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:q.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(q.length):n.chainAll(q.length)]})]}),M>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(M)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),k("country",n.colCountry),k("name",n.colCompany),k("amount",n.colAmount,"h-amt",!0),k("stage",n.colStage,"h-stade"),k("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&k("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(d==="ops"?" opsl":"")+(S.length?"":" list-empty"),children:[N?N.map(([z,O])=>t.jsxs(g.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ge(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:qe(z,s)}),t.jsx("div",{className:"s",children:n.grpCount(O.filter(I=>!ye(I)).length,O.length)})]})]}),G(O,z)]},z)):G(S,"pt"+a.ptab),h.loading&&!c.length&&t.jsx(Ks,{}),!S.length&&!(h.loading&&!c.length)&&(i.pipe?t.jsx(Qs,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const z=N||[["pt"+a.ptab,S]];let O=0,I=0;for(const[D,U]of z){I+=U.length;let W=a.shown[D]||u;U.length-W<=4&&(W=U.length),O+=Math.min(U.length,W)}const P=I-O;return P<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([D,U])=>r({type:"more",group:D,by:U.length,base:u})),children:[t.jsx("span",{className:"more-label",children:n.more(P,P)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(O,I)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}})]})}function zn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Xs(e,a){const r=no(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Zs(e,a){const n=[a.head.split("|").map(zn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",Xs(i,a.plabels),$t(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(zn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function el(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const tl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Re({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function al({o:e,qa:a}){const{t:r,lang:n,fund:i}=F(),o=(e.cribleStatus||"").trim().toUpperCase()||($t(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Xe(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Re,{k:r.cdSector,v:e.sector}),t.jsx(Re,{k:r.cdStage,v:e.stage}),t.jsx(Re,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Re,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Re,{k:r.cdName,v:e.contactName}),t.jsx(Re,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Re,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Re,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Re,{k:r.cdAngle,v:e.angle}),t.jsx(Re,{k:r.cdDetected,v:tl(e.date,n)})]}),p.some(([,h])=>h)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,h])=>h).map(([h,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:h}),t.jsx("p",{children:c})]},h))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function nl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=F(),[s,p]=g.useState({}),h=25,c=g.useMemo(()=>n.slice(0,h),[n]);g.useEffect(()=>{c.length&&ro(r,c.map(x=>x.name)).then(p)},[r,c]);const d=o.stats,u=x=>x.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>h&&t.jsx("span",{className:"mnote dim",children:e.dsCap(h,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),d&&typeof d.screened=="number"&&t.jsxs("p",{children:[u(d.screened)," ",e.funScreened(""),typeof d.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(d.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(d.screened/o.marketEstimate*100)," %"]})]})]}),c.map(x=>t.jsx(al,{o:x,qa:s[x.name]},x.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const rl=50;function Ma({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=F(),[o,l]=g.useState(null),[s,p]=g.useState(!1),[h,c]=g.useState(""),[d,u]=g.useState(0),[x,f]=g.useState(""),[b,v]=g.useState(!1),m=g.useRef(null);g.useEffect(()=>()=>{m.current&&window.clearInterval(m.current)},[]);const y=async w=>{p(!0),c("");const E=await a();if(p(!1),E.ok){l(E);return}if(E.busy){c(i.alertPreviewBusy);return}if(!w){c(i.alertPreviewFail);return}u(rl),m.current=window.setInterval(()=>{u(A=>A>1?A-1:(m.current&&window.clearInterval(m.current),y(!1),0))},1e3)},j=async()=>{if(n||b)return;v(!0),f("");const w=await r();v(!1),f(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||d>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{j()},children:b?"…":i.alertTest})]}),d>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(d)}),h&&t.jsx("p",{className:"mnote warn",children:h}),x&&t.jsx("p",{className:"mnote",children:x}),!x&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const xt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function ke({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=F();return ot.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function ol(){const{st:e}=F();switch(e.modal){case"chain":return t.jsx(sl,{});case"space":return t.jsx(ll,{});case"alert":return t.jsx(dl,{});case"queue":return t.jsx(ml,{});case"export":return t.jsx(xl,{});case"plug":return t.jsx(bl,{});case"recharge":return t.jsx(yl,{});case"cover":return t.jsx(kl,{});case"dossier":return t.jsx(wl,{});case"crit":return t.jsx(jl,{});case"tuto":return t.jsx(Nl,{});case"rdv":return t.jsx(il,{});case"memoalert":return t.jsx(gl,{});default:return null}}function il(){const{dispatch:e,fund:a}=F(),r=typeof document<"u"&&!!document.getElementById("rdv");return g.useEffect(()=>{r&&(e({type:"modal",modal:null}),Zo())},[r,e]),r?null:t.jsx(so,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function sl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s}=F(),p=o==="client",h=e.chain.queue.map(x=>r.get(x)).filter(x=>!!x),c=e.chain.idx,d=h[c],u=c>=h.length;return ot.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:u?n.finished:`${c+1} / ${h.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(u?100:c/Math.max(1,h.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:u||!d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(h.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:d.name}),t.jsx("div",{className:"sub",children:[it(d.cc,i)||d.countryLabel,d.sector,d.stage,n.daysAgo(rt(d.date))].filter(Boolean).map(x=>String(x).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:qe(d.engine,i).toUpperCase()}),typeof d.amountEur=="number"&&d.amountEur>0&&t.jsx("span",{children:wt(d.amountEur,i)})]}),me(d)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Je,{o:d,lg:!0})," ",t.jsx(Ut,{o:d,src:!0})]}),(d.tagline||d.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:d.tagline||d.headline})]}),d.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:d.reasoning})]}),p&&ye(d)&&t.jsxs("div",{className:"vbox",style:{"--c":We(d)==="retenu"?"var(--brand)":We(d)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:We(d)==="retenu"?"✓ "+n.kept:We(d)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:d.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!u&&d&&!(p&&ye(d))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(d)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(u?{type:"modal",modal:null}:{type:"chainNext"}),children:u?n.closeBtn:n.skip})]})]})})}),document.body)}function ll(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=F(),o=i==="client",l=g.useMemo(()=>o?r.filter(d=>ye(d)):[],[r,o]),s=g.useMemo(()=>Aa(l.filter(d=>We(d)==="retenu"),{key:"signal",dir:-1}),[l]),p=g.useMemo(()=>l.filter(d=>We(d)==="ecarte"),[l]),h=e.spaceTab==="retenu"?s:p,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(ke,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(d=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof d.score=="number"&&d.score>0?d.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:d.name}),t.jsx("div",{className:"rr",children:d.reasoning||d.tagline||""})]})]},d.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function dl(){const{mode:e}=F();return e==="client"||e==="apercu"?t.jsx(cl,{}):t.jsx(fl,{})}function cl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),[o,l]=g.useState("d"),s=i!=="client";return t.jsxs(ke,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(pl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(ul,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(fr,{})]})}function pl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=g.useState(null),[s,p]=g.useState(!1),[h,c]=g.useState(0);g.useEffect(()=>{let f=!0;return p(!1),Ha(a).then(b=>{f&&(b?l(b):p(!0))}),()=>{f=!1}},[a,h]);const d=f=>{r||Ha(a,f).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(f=>f+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=f=>!o.sections||o.sections.includes(f),x=f=>{const b=o.sections||e.alertSec.map(([v])=>v);d({sections:u(f)?b.filter(v=>v!==f):[...b,f]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>d({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>d({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>d({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>d({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([f,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(f),disabled:r,onChange:()=>x(f)}),t.jsxs("span",{children:[b,f==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},f))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ma,{label:e.alertPreview,readOnly:r,onPreview:()=>xo(a),onTest:()=>mo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function ul({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=g.useState(null),[s,p]=g.useState(!1),[h,c]=g.useState(0);g.useEffect(()=>{let f=!0;return p(!1),Ya(a).then(b=>{f&&(b?l(b):p(!0))}),()=>{f=!1}},[a,h]);const d=f=>{r||Ya(a,f).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(f=>f+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,x=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>d({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:f=>d({dow:Number(f.target.value)}),children:e.alertDow.map((f,b)=>t.jsx("option",{value:b,children:f},f))}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.max(6,x-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[x," h"]}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.min(21,x+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ma,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ho(a),onTest:()=>go(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function fr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=F(),[l,s]=g.useState(o||""),[p,h]=g.useState(!1),[c,d]=g.useState(!1);g.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,x=g.useMemo(()=>n.filter(m=>me(m)).length,[n]),f=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||c)){d(!0);try{await fetch(`${ja}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{d(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[f]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(m=>qe(m,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(m=>it(m,r)||m).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([m,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:m}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},m))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:m=>s(m.target.value),onKeyDown:m=>{m.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,x)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function fl(){const{t:e}=F();return t.jsx(ke,{title:e.alertTitle,icon:"🔔",children:t.jsx(fr,{})})}function ml(){var b,v,m;const{t:e,token:a,fund:r,mode:n,flash:i}=F(),[o,l]=g.useState(null),[s,p]=g.useState([]),[h,c]=g.useState(0),d=n==="client";g.useEffect(()=>{let y=!0;return(async()=>{const[j,w]=await Promise.all([Sa(r),Mn(a)]);y&&(j&&l(j),p(w))})(),()=>{y=!1}},[a,r,h]);const u=(o==null?void 0:o.per_day)??2,x=((b=o==null?void 0:o.analyzed_today)==null?void 0:b.length)??0,f=(v=o==null?void 0:o.tomorrow)!=null&&v.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return t.jsxs(ke,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(x,x+(((m=o==null?void 0:o.pool_order)==null?void 0:m.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),d&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Va(a,y.company,"retry").then(()=>c(j=>j+1))},children:e.queueRetry}),d&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Va(a,y.company,"delete").then(()=>c(j=>j+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[f.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),f.slice(0,10).map((y,j)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",j+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function xl(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=F(),s=`${xt}/cibles/list.csv?token=${a}`,p=`${xt}/cibles/list.json?token=${a}`,h=`${xt}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,d=v=>{var m;(m=navigator.clipboard)==null||m.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:h,href:h}],x=!i.lockActions&&n.length>0,f=()=>{el(Zs(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([m])=>m===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(ke,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:f,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:m,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d(m),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function gl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),o=i!=="client",[l,s]=g.useState(null),[p,h]=g.useState(!1),[c,d]=g.useState(0),[u,x]=g.useState(!1);g.useEffect(()=>{let m=!0;return h(!1),Ua(a).then(y=>{m&&(y?s(y):h(!0))}),()=>{m=!1}},[a,c]);const f=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=m=>{if(o||!l)return;const y={enabled:m.enabled??!!l.enabled,email:m.email??(l.email||""),sections:m.sections??f()};x(!0),Ua(a,y).then(j=>{if(x(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(p)return t.jsx(ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]})});if(!l)return t.jsx(ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=f();return t.jsxs(ke,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(hl,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:m=>b({email:m})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([m,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[m],disabled:o||u,onChange:()=>b({sections:{...v,[m]:!v[m]}})}),t.jsx("span",{children:y})]},m))}),t.jsx(Ma,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>io(a,v),onTest:()=>oo(a,v)})]})}function hl({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=g.useState(e);g.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),p=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:h=>l(h.target.value),onKeyDown:h=>{h.key==="Enter"&&s&&p&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>i(o.trim()),children:n})]})]})}function bl(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=F(),[o,l]=g.useState(null),[s,p]=g.useState(!1),[h,c]=g.useState(null),[d,u]=g.useState(""),[x,f]=g.useState(0);g.useEffect(()=>{let m=!0;return p(!1),oa(a).then(y=>{m&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),co(a).then(y=>{m&&c(y)}),()=>{m=!1}},[a,x]);const b=(m,y)=>{i&&oa(a,m).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}m.test&&j.sent===!1?n(e.plugTestThrottled):r(y),f(w=>w+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(ke,{title:e.plugTitle,icon:"🔌",wide:!0,children:[h&&t.jsx("p",{className:"mnote"+(h.enabled?" warn":""),children:h.enabled?e.plugAutoOn(h.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(m=>m+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:d,disabled:!i,onChange:m=>u(m.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!d.trim(),onClick:()=>b({url:d.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(vl,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var m;(m=navigator.clipboard)==null||m.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function vl(){const{t:e,token:a,lang:r}=F(),[n,i]=g.useState("valides"),[o,l]=g.useState(!1),[s,p]=g.useState(null),[h,c]=g.useState(null),[d,u]=g.useState(!1),[x,f]=g.useState(!1),[b,v]=g.useState(null),[m,y]=g.useState(null),[j,w]=g.useState(null),E=`atl2:bulk:${a}:${n}`;g.useEffect(()=>{oa(a).then(L=>{y(L&&L.configured?L.url_hint||"webhook":null)})},[a]),g.useEffect(()=>{p(null),c(null),u(!1),v(null);try{const L=JSON.parse(localStorage.getItem(E)||"null");w(L&&Date.now()-Date.parse(L.t)<24*3600*1e3?L:null)}catch{w(null)}},[E]);const A=async()=>{l(!0),u(!1),v(null);const L=await uo(a,n);p(L),c(L.ok?n:null),l(!1)},R=g.useRef(!1),B=async()=>{if(R.current)return;R.current=!0,f(!0);const L=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await fo(a,n,"webhook",void 0,L)}finally{R.current=!1}if(f(!1),u(!1),v(_),_.ok&&(_.pushed||0)>0){const k={t:new Date().toISOString(),n:_.pushed||0};w(k);try{localStorage.setItem(E,JSON.stringify(k))}catch{}}},S=s!=null&&s.ok&&s.ready||0,M=!!(s!=null&&s.ok)&&h===n&&S>0&&!!m&&!j,q=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:L=>i(L.target.value),children:e.plugBulkTabs.map(([L,_])=>t.jsx("option",{value:L,children:_},L))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{A()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(q,j.n)}),!j&&!!(s!=null&&s.ok)&&!m&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),M&&!d&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),M&&d&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(S,m||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:x,onClick:()=>{B()},children:x?e.bulkSending:e.bulkConfirm(m||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:x,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function yl(){const{t:e,data:a,lang:r}=F(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const h=await(await fetch(`${ja}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(ke,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function wl(){const{t:e}=F();return t.jsx(ke,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(nl,{})})}function kl(){const{t:e,lang:a,data:r,dossiers:n,token:i,canWrite:o,flash:l}=F(),[s,p]=g.useState(null),[h,c]=g.useState(!1);g.useEffect(()=>{let A=!0;return Sa(i).then(R=>{A&&R&&typeof R.per_day=="number"&&p(R.per_day)}),()=>{A=!1}},[i]);const d=r.stats,u=typeof(d==null?void 0:d.screened)=="number"?d.screened:n.filter(A=>A.kind==="target"&&ye(A)).length,x=r.marketEstimate||0,f=x>0?Math.min(100,Math.round(u/x*100)):null,b=(d==null?void 0:d.window_days)||30,v=u>0?u/b:0,m=x>0?Math.max(0,x-u):0,j=x>0&&v>0&&u>=100?Math.round(m/v):null,w=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),E=A=>{h||!o||(c(!0),po(i,A).then(R=>{if(c(!1),R===null){l(e.actErr);return}p(R),l(e.alertSaved)}))};return t.jsxs(ke,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(u))}),x>0&&t.jsx("span",{children:e.covOf(w(x))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),j!==null&&t.jsx("p",{className:"mnote",children:e.covEta(j)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),v>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(v))}),d&&t.jsxs("div",{className:"covf",children:[typeof d.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.kept)})," ",e.covKept]}),typeof d.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.analyzed)})," ",e.covAna]}),typeof d.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.shown)})," ",e.covShown]})]}),o&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:s===A?"on":"",disabled:h,onClick:()=>E(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function jl(){var m,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o}=F(),l=n==="client",s=g.useMemo(()=>{const w=new Set;return a.forEach(E=>{E.angle&&w.add(E.angle)}),[...w]},[a]),[p,h]=g.useState(null);g.useEffect(()=>{let w=!0;return lo(r).then(E=>{w&&h(E.thumbs)}),()=>{w=!1}},[r]);const[c,d]=g.useState(""),[u,x]=g.useState(""),[f,b]=g.useState(!1),v=async()=>{const w=c.trim();if(!(!w||f||!l)){b(!0),x("");try{const A=await(await fetch(`${xt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&x(String(A.reply)),A.job_id){x(e.critChatRunning);const R=async()=>{const B=await fetch(`${xt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(S=>S.json()).catch(()=>null);if(B&&B.done){x(String(B.reply||B.clarification||B.summary||"✓")),b(!1),B.applied&&i(e.alertSaved);return}setTimeout(()=>{R()},8e3)};setTimeout(()=>{R()},8e3),d("");return}d("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(ke,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((m=o.points)!=null&&m.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var E,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((E=w.look)!=null&&E.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(R=>t.jsx("li",{children:R},R))})]}),!!((A=w.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(R=>t.jsx("li",{children:R},R))})]})]})]},w.title)})]}),!!((j=o==null?void 0:o.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!l||f,onChange:w=>d(w.target.value),onKeyDown:w=>{w.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!l||f||!c.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,E)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},E))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(pr[w]||"v-cons"),children:w}),t.jsx("span",{children:E})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",E]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Nl(){const{t:e,dispatch:a,startTour:r}=F(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(ke,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const mr="atl2:mapfold",Sl=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(mr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},xr=g.createContext(null),F=()=>{const e=g.useContext(xr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Je({o:e,lg:a}){const{lang:r}=F(),n=me(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Wa(n,r),children:[n.emoji," ",Wa(n,r)]}):null}function Ut({o:e,src:a}){const{lang:r,t:n}=F(),i=me(e);if(!i)return null;const o=ko(i),l=jo(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Fn(i,r))+" · "+n.win7(Pn(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<o?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function gr({o:e}){const{lang:a}=F(),r=wo(e.cc),n=e.cc?it(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Tn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",hr=e=>`atl2:tour:${e||"anon"}`;function Cl(e){try{return localStorage.getItem(hr(e))==="1"}catch{return!0}}function Ln(e){try{localStorage.setItem(hr(e),"1")}catch{}}function El(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function Ml({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){const{lang:l}=bo(),s=Lo[l],p=_o(e,l,a),[h,c]=g.useReducer(Vo,void 0,()=>Uo((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Sl(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),d=g.useRef(!0);g.useEffect(()=>{if(d.current){d.current=!1;return}if(!e)try{localStorage.setItem(mr,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e]);const u=g.useRef(o);u.current=o,g.useEffect(()=>{var C;(C=u.current)==null||C.call(u,h.filters)},[h.filters]);const[x,f]=g.useState(null),[b,v]=g.useState(null),[m,y]=g.useState({kept:0,dropped:0}),[j,w]=g.useState(!1),[E,A]=g.useState(""),[R,B]=g.useState(!1),[S,M]=g.useState(null),[q,L]=g.useState(!1),[_,k]=g.useState(!1),[,N]=g.useState(0),T=()=>N(C=>C+1),H=g.useRef([]),G=g.useRef(new Set),Z=g.useRef(new Set),z=g.useRef(new Map),O=g.useRef(null),{mode:I}=p,P=g.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[p.caps,i,a]),D=P.pipe,U=p.session.token||"",W=I==="client"&&!e;g.useEffect(()=>{if(document.querySelector(`link[href="${Tn}"]`))return;const C=document.createElement("link");C.rel="stylesheet",C.href=Tn,document.head.appendChild(C)},[]);const X=(C,V=!1)=>{A(C),B(V),O.current&&clearTimeout(O.current),O.current=setTimeout(()=>A(""),V?4200:2400)},oe=C=>X(C,!0),ue=g.useMemo(()=>{const C=new Map;return p.dossiers.forEach(V=>{V.id&&C.set(V.id,V)}),C},[p.dossiers]),pe=g.useMemo(()=>p.dossiers.filter(C=>Bn(C,h,D)),[p.dossiers,h,D]),Q=g.useRef(!1);g.useEffect(()=>{if(Q.current||e||p.loading||!p.dossiers.length)return;if(!P.showFunnel||Cl(p.session.token||"")){Q.current=!0;return}Q.current=!0;const C=window.setTimeout(()=>{Ln(p.session.token||""),L(!0)},700);return()=>window.clearTimeout(C)},[e,p.loading,p.dossiers.length,P.showFunnel,p.session.token]);const te=g.useMemo(()=>p.dossiers.filter(C=>Ho(C,h,D,p.favIds)),[p.dossiers,h,D,p.favIds]),he=g.useMemo(()=>vo(pe,p.favIds),[pe,p.favIds]),K=Ca.find(C=>C.key===h.continent),se=h.continent==="monde"?s.contWorld:(l==="fr"?K==null?void 0:K.fr:K==null?void 0:K.en)||"";g.useEffect(()=>{const C=V=>{var re;const Y=(((re=V.detail)==null?void 0:re.name)||"").trim();Y&&ee(null,Y)};return window.addEventListener("ppmap:evaluate",C),()=>window.removeEventListener("ppmap:evaluate",C)}),g.useEffect(()=>{const C=re=>{const Le=String(re||"").trim();Le&&c({type:"filters",patch:{sector:[Le]}})},V=re=>{var Le;return C((Le=re.detail)==null?void 0:Le.sector)},Y=re=>{re.data&&re.data.type==="pp-filter"&&C(re.data.sector)};return window.addEventListener("ppmap:filter",V),window.addEventListener("message",Y),()=>{window.removeEventListener("ppmap:filter",V),window.removeEventListener("message",Y)}},[]);const ee=(C,V)=>{const Y=((C==null?void 0:C.name)||V||"").trim();if(!W){v({kicker:Y});return}!Y||j||(w(!0),(async()=>{try{const re=await qn(U,Y,"atelier2"),Le={name:re.company||Y,verdict:re.verdict,reason:re.reason||"",remaining:re.remaining??null};H.current=[Le,...H.current].slice(0,8),re.verdict==="kept"&&y(Ve=>({...Ve,kept:Ve.kept+1})),re.verdict==="ruled_out"&&y(Ve=>({...Ve,dropped:Ve.dropped+1}));const lt=C||p.dossiers.find(Ve=>(Ve.name||"").toLowerCase()===Y.toLowerCase());lt&&(re.verdict==="kept"?lt.verdict=lt.verdict||"MATCH":re.verdict==="ruled_out"&&(lt.verdict="NO MATCH"),re.reason&&(lt.reasoning=re.reason)),T()}finally{w(!1)}})())},Be=C=>{if(!W){v({kicker:C.name});return}G.current.add(C.id),dt(U,"fast_request",C.name||"",""),X(s.memoInstantSent(C.name)),T()},fe=C=>z.current.get(C.id)??p.thumbs.get((C.name||"").trim().toLowerCase()),xe=(C,V)=>c({type:"undoPush",entry:{id:C.id,name:C.name,prevCeoStatus:V}}),Fe=async(C,V,Y)=>{const re=C.ceoStatus||"";C.ceoStatus=V,T();const Le=await Gt(U,{status:V,airtable_id:C.airtableId,check_id:C.checkId,company:C.name,...(Y==null?void 0:Y.note)!==void 0?{note:Y.note}:{},...Y!=null&&Y.via?{via:Y.via}:{}});return Le.ok?Le.skipped?(C.ceoStatus=re,T(),oe(s.actNotPersisted),!1):((Y==null?void 0:Y.undo)!==!1&&xe(C,re),Y!=null&&Y.msg&&X(Y.msg),(V==="Validé"||V==="Écarté")&&!C.ceoNote&&(Y==null?void 0:Y.note)===void 0&&M({o:C,yes:V==="Validé"}),!0):(C.ceoStatus=re,T(),oe(s.actErr),!1)},Ue=async(C,V)=>{const Y=await Gt(U,{status:C.ceoStatus||"Retenu",airtable_id:C.airtableId,check_id:C.checkId,company:C.name,note:V,via:"note"});return!Y.ok||Y.skipped?(oe(Y.skipped?s.actNotPersisted:s.actErr),!1):(C.ceoNote=V,T(),!0)},Ne=g.useRef(new Map),Pe=C=>Ne.current.has(C.id)?Ne.current.get(C.id):p.stages.get((C.name||"").trim().toLowerCase()),st=(C,V)=>{Ne.current.set(C.id,V),T()},Vt=(C,V)=>{W&&Fe(C,V?"Validé":"Écarté",{msg:V?s.decidedYes(C.name):s.decidedNo(C.name)})},Ht=C=>{W&&Fe(C,"À trancher",{msg:s.promoted(C.name)})},$=C=>{W&&(async()=>{const V=C.ceoStatus||"";C.ceoStatus="Retenu",T();const Y=await Gt(U,{status:"Retenu",check_id:C.checkId,company:C.name});if(!Y.ok||Y.skipped){C.ceoStatus=V,T(),oe(Y.skipped?s.actNotPersisted:s.actErr);return}xe(C,V),X(s.repeched(C.name))})()},ae=()=>{const C=h.undo[h.undo.length-1];if(!C){X(s.undoNone);return}const V=ue.get(C.id);if(!V){c({type:"undoPop"}),X(s.undoNone);return}let Y=C.prevCeoStatus;if(!Y)if((V.verdict||"").toUpperCase().includes("CALL"))Y="À trancher";else{X(s.undoLockedTitle);return}(async()=>await Fe(V,Y,{undo:!1})&&(c({type:"undoPop"}),V.ceoStatus=C.prevCeoStatus,T(),X(s.undoDone(V.name))))()},le=C=>{W&&(Z.current.add(C.id),T(),(async()=>{const V=await No(U,C.name,"email");if(!V||V.ok===!1){Z.current.delete(C.id),T(),oe(s.actErr);return}dt(U,"approach",C.name||"",""),X(s.actApproachSent)})())},be=(C,V)=>{W&&(async()=>{if(!(await dt(U,V?"yes":"no",C.name||"","")).ok){oe(s.actErr);return}z.current.set(C.id,V?"yes":"no"),T(),X(V?s.thumbUpDone:s.thumbDnDone)})()},$e=C=>{!W||!yt(C)||(dt(U,"detailed_request",C.name||"",""),X(s.memoDeepSent(C.name)))},we=C=>{const V=new Set(p.favIds),Y=V.has(C.id);Y?V.delete(C.id):V.add(C.id),p.setFavIds(V),W&&So(U,{id:C.id,co:C.name},Y)},Se=()=>{!W||_||window.confirm(s.identSyncConfirm)&&(k(!0),(async()=>{const C=await Co(U);k(!1),C?X(s.identSyncDone):oe(s.actErr)})())},_e=/proplace/i.test(p.fund||""),br=C=>{!W||!_e||(dt(U,"onboard_request",C.name||"",""),X(s.onboardSent(C.name)))},vr={st:h,dispatch:c,t:s,lang:l,mode:I,caps:P,pipe:D,token:U,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:$,thumbOf:fe,canWrite:W,commitStatus:Fe,saveNote:Ue,stageOf:Pe,setStage:st,flashErr:oe,startTour:()=>L(!0),dossiers:p.dossiers,scopedAll:pe,scoped:te,counts:he,byId:ue,contName:se,favIds:p.favIds,toggleFav:we,askEvaluate:ee,doAnalyse:Be,doDecide:Vt,doPromote:Ht,doApproach:le,doThumb:be,doDeep:$e,doUndo:ae,doSync:Se,doOnboard:br,outbound:_e,memoQueued:G.current,approachDone:Z.current,sessTally:m,evalCards:H.current,evalBusy:j,markRow:f,markedId:x,flash:X};g.useEffect(()=>{const C=V=>{V.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[]);const yr=C=>U?t.jsx(Ls,{token:U,children:C}):t.jsx(t.Fragment,{children:C});return t.jsx(xr.Provider,{value:vr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Oo}),yr(t.jsxs("div",{className:"app"+(D?" pipe":"")+(U?" has-thesis":""),children:[P.showTicker&&t.jsx(ge,{name:"live",children:t.jsxs("div",{className:"live-stack"+(U?" live-stack--cibles":""),children:[t.jsx(Qo,{}),!!U&&t.jsx(Rs,{})]})}),P.showIdent&&t.jsx(ge,{name:"identite",children:t.jsx(fi,{})}),!!U&&t.jsx(ge,{name:"lead",children:t.jsx(Ts,{})}),P.showOnb&&t.jsx(ge,{name:"onboarding",children:t.jsx(mi,{})}),P.showMorning&&t.jsx(ge,{name:"matin",children:t.jsx(ui,{})}),t.jsx(ge,{name:"fraicheur",children:t.jsx(ri,{})}),t.jsx(ge,{name:"mesure",children:t.jsx(oi,{})}),P.showFunnel&&t.jsx(ge,{name:"entonnoir",children:t.jsx(Al,{})}),P.showFunnel&&t.jsx(ge,{name:"tunnel",children:t.jsx(gi,{})}),P.showFunnel&&t.jsx(ge,{name:"tuto",children:t.jsx(bi,{})}),t.jsx(ge,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(zl,{}),t.jsxs("div",{className:"stage"+(h.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(xs,{}),t.jsx(hs,{})]})]})}),P.showDemand&&t.jsx(ge,{name:"evaluation",children:t.jsx(js,{})}),P.showDemand&&h.memoConsole&&t.jsx(ge,{name:"console",children:t.jsx(Ss,{})}),t.jsx(ge,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(Js,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),P.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),h.popupId&&t.jsx(ge,{name:"fiche",children:t.jsx(qs,{})}),t.jsx(ge,{name:"modales",children:t.jsx(ol,{})}),t.jsx(ti,{}),S&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:S.o.name}),t.jsx(di,{placeholder:S.yes?s.whyYesPh:s.whyNoPh,onDone:C=>{const V=S.o;M(null),C&&Ue(V,C).then(Y=>{Y&&X(s.csNoteSaved)})}})]}),q&&t.jsx(pi,{steps:El(s),onClose:()=>{L(!1),Ln(U)}}),E&&t.jsx("div",{className:"flash on"+(R?" err":""),children:E}),b&&t.jsx(yo,{variant:"acquirer",initialCompany:Rn().co,initialWebsite:Rn().site,onClose:()=>v(null)})]})})}function Al(){const{t:e}=F(),[a,r]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function zl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:i,t:o}=F(),l=g.useMemo(()=>{const s={};return e.forEach(p=>{Ea(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[Eo.map(s=>{const p=Ca.find(c=>c.key===s),h=s==="monde"?o.contWorld:i==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[h,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Rn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Tl(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{gr as FlagCell,Je as SigBadge,Ut as SigWin,Ml as default,Tl as fmtShort,F as useV2};
