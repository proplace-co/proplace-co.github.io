...
`,Nl=wl+kl+jl+El;function fn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Sl(){const e=fn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Cl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Sl();return r==="0"?"client":r==="1"||fn("embed")==="1"&&fn("chrome")==="1"?"apercu":"client"}const zl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Al=e=>zl[e];function La(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const At=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!ho(a)||La(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ki(e.cc)})};function Ja(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const ql=60*60*1e3;function Tl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>ql?null:a}catch{return null}}function ha(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ll=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Rl(e,a,r="default"){const n=r!=="default",o=c.useMemo(()=>e||n?{mode:"anon"}:Pi(),[e,n]),i=c.useMemo(()=>n?"visiteur":Cl(e,o),[e,o,n]),d=c.useMemo(()=>Al(i),[i]),l=i!=="visiteur",s=Ll(r),[g,p]=c.useState([]),[x,u]=c.useState(""),[b,m]=c.useState(null),[w,k]=c.useState(null),[f,y]=c.useState(null),[j,v]=c.useState(()=>new Map),[N,E]=c.useState(()=>new Map),[S,L]=c.useState(""),[q,D]=c.useState(new Set),[B,V]=c.useState(null),[T,F]=c.useState(!0),[h,A]=c.useState(!1),[M,H]=c.useState(0),[C,O]=c.useState(0),_=c.useRef(0),I=c.useMemo(()=>{var G;if(i!=="client")return"";try{return((G=_i())==null?void 0:G.email)||""}catch{return""}},[i]);c.useEffect(()=>{const G=++_.current;let he=!0;const te=()=>he&&G===_.current,le=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),fe=Tl(le);return fe?(p(fe.objs.map(At)),fe.fund&&u(fe.fund),m(fe.marketEstimate??null),k(fe.criteria??null),y(fe.stats??null),L(fe.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const ge=await Ga(),be=((ge==null?void 0:ge.recent_ops)||[]).map(ve=>{const ye=Ea(ve.company_name||ve.title?ve:{...ve,title:(ve.headline_fr||ve.headline||"").slice(0,120)},a),qe=String(ve.rubrique||"").toLowerCase();return ye&&(qe==="nominations"||qe==="recrutements")&&(ye.engine=qe),ye&&!String(ve.company_name||"").trim()&&(ye.noCo=!0),ye}).filter(ve=>!!ve).map(ve=>(ho((ve.name||"").trim())||(ve.noCo=!0),ve));try{const ve=Bi(),ye=await $i(),qe=((ye==null?void 0:ye.date)||"").slice(0,10),ae=ve?ve.doc:ye,ke=Ui(ae),$=((ve==null?void 0:ve.day)||(ae==null?void 0:ae.date)||qe||"").slice(0,10);if($&&ke.length){const U=new Set;for(const Q of be){if((Q.date||"").slice(0,10)!==$)continue;const K=Zn(ke,U,Q.name,"");K>=0&&(U.add(K),Q.decryptHtml=ke[K].html)}for(const Q of be){if(Q.decryptHtml||(Q.date||"").slice(0,10)!==$)continue;const K=Zn(ke,U,"",Q.headline||Q.tagline||Q.name);K>=0&&(U.add(K),Q.decryptHtml=ke[K].html)}}if($){const U=((ae==null?void 0:ae.title_fr)||"").trim(),Q=((ae==null?void 0:ae.lead_fr)||"").trim(),K=Hi(ae),se=((ae==null?void 0:ae.url)||"").trim();U&&(K||se)&&be.unshift({id:`edito:${$}`,kind:"op",name:U,cc:null,date:$,engine:"edito",dealKind:"other",headline:U,tagline:Q||U,decryptHtml:K||void 0,url:se,noCo:!0})}}catch{}if(!te())return;p(be.map(At)),ha(le,{objs:be})}else if(typeof r=="object"){const be=(await er()||[]).filter(ye=>(ye.slug||"")===r.research).map(ye=>tr(ye,a)).filter(ye=>!!ye),ve=Ja(await ar(be,a));if(!te())return;p(ve.map(At)),ha(le,{objs:ve})}else if(l&&o.token){const ge=Vi(o.token),be=Ga(),ve=Wi(o.token),ye=Gi(o.token),qe=Yi(o.token),ae=await ge;let ke=ae?ae.targets:[];te()&&ae&&(u(ae.fund||""),m(ae.marketEstimate??null),k(ae.criteria??null),y(ae.stats??null),L(ae.generatedAt||""),p(ke.map(At)),F(!1),A(!1));const[$,U,Q,K]=await Promise.all([be,ve,ye,qe]),se=(($==null?void 0:$.recent_ops)||[]).map(ce=>Ea(ce,a)).filter(ce=>!!ce),de=new Set(ke.map(ce=>ce.id));if(ke=[...ke,...se.filter(ce=>!de.has(ce.id)&&(de.add(ce.id),!0))],!te())return;p(ke.map(At));const re=new Set;for(const ce of U){const pe=(ce.id||ce.co||"").toString().trim().toLowerCase();pe&&re.add(pe.startsWith("t:")?pe:"t:"+pe)}D(re),v(Q),E(K),ae&&ha(le,{fund:ae.fund,marketEstimate:ae.marketEstimate,criteria:ae.criteria,stats:ae.stats,generatedAt:ae.generatedAt,objs:ke})}else{const ge=Qi(),be=er(),ve=Ga(),ye=await ge;te()&&ye.length&&(p(Ja(ye).map(At)),F(!1),A(!1));const[qe,ae]=await Promise.all([be,ve]),ke=(qe||[]).map(K=>tr(K,a)).filter(K=>!!K),$=await ar(ke,a),U=((ae==null?void 0:ae.recent_ops)||[]).map(K=>Ea(K,a)).filter(K=>!!K),Q=Ja([...ye,...$,...U]);if(!te())return;p(Q.map(At)),ha(le,{objs:Q})}te()&&A(!1)}catch{te()&&!fe&&A(!0)}finally{te()&&F(!1)}})(),()=>{he=!1}},[l,o.token,a,M,s]),c.useEffect(()=>{if(!d.showCredits||!I){V(null);return}let G=!0;return(async()=>{try{const he=await fetch(`${Ha}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:I})});if(!he.ok)return;const te=await he.json();G&&te&&te.ok!==!1&&V(te)}catch{}})(),()=>{G=!1}},[d.showCredits,I,C]);const Y=c.useCallback(G=>D(new Set(G)),[]);return{session:o,mode:i,caps:d,fund:x,email:I,marketEstimate:b,generatedAt:S,criteria:w,thesisMode:String((w==null?void 0:w.mode)||""),stats:f,thumbs:j,stages:N,dossiers:g,patchStatuses:(G,he)=>{p(te=>{let le=!1;const fe=te.map(ge=>{if(!ge.checkId)return ge;const be=G.get(ge.checkId);return!be||be===(ge.ceoStatus||"")||!he(ge.id)?ge:(le=!0,{...ge,ceoStatus:be})});return le?fe:te})},favIds:q,setFavIds:Y,credits:B,reloadCredits:()=>O(G=>G+1),loading:T,error:h,refresh:()=>H(G=>G+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Na=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ra(e){return Na.has(e.engine||"")}function Je(e){return!!e.noCo||Ra(e)&&!!e.url}const Fo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Fl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Fo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Ol=new Set(["signal","amount","score","crible","memo"]);function Ml(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Fo(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Ol.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Oo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Oo=80;function Fa(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Be(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ln(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(wt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&qt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(xo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function oa(e,a,r){return We(e)?Fa(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Fa(e,a.filters,r)}function Dl(e,a,r,n){return!(!oa(e,a,r)||r&&!go(e,a.ptab,n))}function Dn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-wt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Xi(o)||null;case"memo":return Ji(o)||null;case"signal":{const i=Be(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Xa={},vr=(Xa==null?void 0:Xa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function yr(){return new Date().toISOString().slice(0,10)}const In=c.createContext(null);function Mo(){return c.useContext(In)}function Il(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const g=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(p=>s.removeAttribute(p.name)),g&&/^https?:\/\//i.test(g)&&(s.setAttribute("href",g),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Do(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Pl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Do(r),r.innerHTML):e}catch{return e}}function wr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Do(r),r.innerHTML):e}catch{return e}}function kr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Io(){const e=c.useContext(In);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function _l({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Z(),[i,d]=c.useState(()=>n.filters.day||yr()),[l,s]=c.useState(null),[g,p]=c.useState(!1),x=c.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),u=c.useCallback(()=>{d(yr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);c.useEffect(()=>{const w=k=>{var y;const f=(y=k.detail)==null?void 0:y.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),c.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),c.useEffect(()=>{if(!e||!i)return;let w=!1;p(!0);const k=new URLSearchParams({token:e,date:i});return fetch(`${vr}/cibles/edition.json?${k}`).then(f=>f.json()).then(f=>{w||s(f)}).catch(()=>{w||s({ok:!1,error:"network"})}).finally(()=>{w||p(!1)}),()=>{w=!0}},[e,i]);const b=c.useMemo(()=>`${vr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=c.useMemo(()=>({token:e,day:i,ed:l,loading:g,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,g,x,u,n.filters.day,b,o]);return t.jsx(In.Provider,{value:m,children:a})}function Bl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Io(),[o,i]=c.useState(()=>n||bo());return c.useEffect(()=>{n&&i(!0)},[n]),c.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(Aa,d),()=>window.removeEventListener(Aa,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Zi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function $l(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function jr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Er(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Ul(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Io(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,g=c.useRef(null),[p,x]=c.useState("fonds"),[u,b]=c.useState(null),[m,w]=c.useState("idle"),k=c.useRef(!1);c.useEffect(()=>{b(null),w("idle"),k.current=!1,x("fonds")},[e]),c.useEffect(()=>{if(p!=="jour"||k.current)return;k.current=!0;let N=!0;return w("load"),$l(e).then(E=>{N&&(b(E),w("fait"))}),()=>{N=!1}},[p,e]);const f=c.useMemo(()=>Pl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),y=c.useRef(null);c.useEffect(()=>{const N=y.current;if(!N||!f)return;let E=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(E||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{E=!0}},[f]);const j=c.useMemo(()=>wr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),v=c.useMemo(()=>wr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return c.useEffect(()=>{const N=g.current;if(!N||!j)return;let E=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(E||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{E=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const N=(a==null?void 0:a.date)||e,E=/^(\d{4})-(\d{2})-(\d{2})/.exec(N);return E?i?`${E[2]}/${E[3]}/${E[1]}`:`${E[3]}/${E[2]}/${E[1]}`:N})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":p==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":p==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),p==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),p==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p==="fonds"&&s&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),p==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?jr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:kr(e,!0)}),"."]}):jr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:kr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),p==="fonds"&&d&&j?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,p==="fonds"&&d&&v?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:v}}):null,p==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:y,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Er(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Er(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Hl=300,ga=7,Vl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Po={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Wl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Za(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(ns(r)&&r!=="media")return"news:"+r;const n=Be(e);return n?"sig:"+(n.theme&&Po.fr[n.theme]?n.theme:"other"):"actualites"}function Gl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=Z(),s=Mo(),g=d==="en",[p,x]=c.useState("all"),[u,b]=c.useState(!1),m=c.useMemo(()=>{var he;const h=(a.filters.day||"").slice(0,10),A=te=>!(!i&&a.continent!=="monde"&&te.continent!==a.continent||h&&(te.date||"").slice(0,10)!==h),M=e.filter(te=>A(te)&&Be(te)&&(!i||te.kind!=="target"||ze(te)!==5)),H=i&&(((he=s==null?void 0:s.ed)==null?void 0:he.ops)||[]).length?s.ed.ops.map(te=>Ea(te,d)).filter(te=>!!te).map(te=>(te.briefOnly=!0,te)).filter(te=>!h||(te.date||"").slice(0,10)===h):[],C=e.filter(te=>A(te)&&te.kind==="op"&&(h?!0:wt(te.date)<=ga)),O=i?H.length?H:C.filter(te=>{const le=(l||"").trim().toLowerCase();if(!le)return!1;const fe=te.match||null;return fe?Object.keys(fe).map(ge=>ge.trim().toLowerCase()).includes(le):!1}):C,_=h||new Date().toISOString().slice(0,10),I=te=>{const le=Za(te);return le==="ma"?0:le==="levees"?1:2};O.sort((te,le)=>{const fe=I(te)-I(le);if(fe)return fe;const ge=(te.date||"").slice(0,10)===_?0:1,be=(le.date||"").slice(0,10)===_?0:1;return ge!==be?ge-be:(le.amountEur||0)-(te.amountEur||0)});const Y=new Set,G=[];for(const te of[...O,...Dn(M,{key:"signal",dir:-1})]){const le=te.id||te.name;!le||Y.has(le)||(Y.add(le),G.push(te))}return i&&G.length===0?e.filter(le=>A(le)&&wt(le.date)<=ga).sort((le,fe)=>(fe.date||"").localeCompare(le.date||"")).slice(0,80):G},[e,a.continent,a.filters.day,i,l,d,s]),w=c.useMemo(()=>{const h={};for(const A of m){const M=Za(A);h[M]=(h[M]||0)+1}return h},[m]),k=c.useMemo(()=>p==="all"?m:m.filter(h=>Za(h)===p),[m,p]),f=c.useMemo(()=>k.slice(0,Hl),[k]),y=k.length-f.length,j=c.useRef(null);c.useEffect(()=>{var O,_;const h=j.current;if(!h)return;const A=()=>{const I=h.scrollWidth;I<200||(h.style.animationDuration=Math.max(18,Math.round(I/130))+"s")};A();const M=requestAnimationFrame(A),H=window.setTimeout(A,1200);let C=!0;return(_=(O=document.fonts)==null?void 0:O.ready)==null||_.then(()=>{C&&A()}),()=>{C=!1,cancelAnimationFrame(M),window.clearTimeout(H)}},[f.length,p]);const v=h=>h==="all"?m.length:w[h]||0,N=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return Po[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const A=h.slice(5);return ts[A]?as(A,g?"en":"fr"):h}return Vl[g?"en":"fr"][h]},E=[{k:"all"}],S=["ma","levees"].filter(h=>v(h)>0||h===p);if(S.length){E.push({g:g?"Deals":"Opérations"});for(const h of S)E.push({k:h})}const L=["nominations","recrutements"].filter(h=>v(h)>0||h===p),q=es.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>v(h)>0||h===p),D=v("actualites")>0||p==="actualites"?["actualites"]:[];if(L.length||q.length||D.length){E.push({g:g?"News":"Actualités"});for(const h of L)E.push({k:h});for(const h of q)E.push({k:h});for(const h of D)E.push({k:h})}const B=Wl.map(h=>"sig:"+h).filter(h=>v(h)>0||h===p);if(B.length){E.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of B)E.push({k:h})}const V=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},T=(()=>{const h=(a.filters.day||"").slice(0,10),A=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(g?`LIVE covers the events of ${V(h)}.`:`Le LIVE regroupe les événements du ${V(h)}.`)+A:(g?`LIVE covers the still-open signals and the deals of the last ${ga} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ga} derniers jours.`)+A})(),F=h=>f.map(A=>t.jsxs("button",{type:"button",className:"tk"+(Ge(A)?" spent":""),onClick:M=>{const H=A.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:H?"":A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(H||n({type:"focus",id:A.id}),a.dens!=="liste"){const C=M.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:C.left+C.width/2,y:C.bottom}})}},title:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(Et,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(Ei,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:Vc(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx(Va,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(A.id||A.name))).concat(y>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${y} more — filter by section to see them`:`+ ${y} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(h=>!h),children:[N(p),t.jsx("b",{children:v(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:T}),E.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===p,onClick:()=>{x(h.k),b(!1)},children:[N(h.k),t.jsx("b",{children:v(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:j,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!s&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!s&&t.jsx(Ql,{isEn:g})]})}const Yl=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Ql({isEn:e}){const[a,r]=c.useState(()=>bo());c.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Aa,o),()=>window.removeEventListener(Aa,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>rs(!a),children:Yl})}const Pn="+33 6 83 10 72 86",Oa="alexandre@proplace.co",_o=`tel:${Pn.replace(/[^\d+]/g,"")}`;function Kl(){return null}class lt extends c.Component{constructor(){super(...arguments);Kn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Bo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Nr(e,a){if((Nt(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return Bo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const Sr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",Jl={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function Xl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=Z(),[l,s]=c.useState(""),[g,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null);if(c.useEffect(()=>{if(!x)return;const y=j=>{b.current&&!b.current.contains(j.target)&&(u(!1),p(!1))};return document.addEventListener("click",y,!0),()=>document.removeEventListener("click",y,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),w=async y=>{if(l)return;if(y==="Analysé"&&!e.memoUrl){p(!0);return}s(y);const j=(Nr(e,a).find(([N])=>N===y)||[y,y])[1],v=await o(e,y,{msg:a.csMoved(e.name,j)});s(""),v&&(p(!1),u(!1))},k=Nr(e,a),f=y=>(k.find(([j])=>j===y)||[])[1]||y;return k.length===2?t.jsx("span",{className:"rstat rst2",onClick:y=>y.stopPropagation(),children:k.map(([y,j])=>t.jsx("button",{type:"button",className:"rsd "+(y==="Validé"?"yes":"no")+(l===y?" busy":""),disabled:!!l,onClick:()=>{w(y)},children:j},y))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:y=>y.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+Sr(m),onClick:()=>{u(y=>!y),p(!1)},children:l?f(l)+"…":m?f(m):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:k.map(([y,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===y,className:"rsopt"+(m===y?" on":"")+(l===y?" busy":""),disabled:!!l,onClick:()=>{if(y===m){u(!1);return}w(y)},children:[t.jsx("i",{className:"pt2",style:{background:Jl[Sr(y)]}}),j]},y))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),p(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const y=await o(e,"Analysé");s(""),y&&(p(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function Zl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Z(),[i,d]=c.useState(""),[l,s]=c.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),p=(Nt(e)||"").startsWith("CALL")&&ze(e)===3,x=ze(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(m);const w=await o(e,m);d(""),w&&(s(!0),setTimeout(()=>s(!1),2200))},b=p?[["Validé",a.csYes],["Écarté",a.csNo]]:Bo.filter(([m])=>!(x&&m==="Retenu")).map(([m,w])=>[m,a[w]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,w])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:w},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ed,{o:e})]})}function ed({o:e}){const{t:a,saveNote:r,flash:n}=Z(),[o,i]=c.useState(e.ceoNote||""),[d,l]=c.useState(!1),[s,g]=c.useState(!1),p=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!p)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!p,onClick:()=>{x()},children:s?a.csNoteSaved:a.csNoteOk})]})}function Cr({placeholder:e,onDone:a}){const{t:r}=Z(),[n,o]=c.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function td({o:e}){var k;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=Z(),[s,g]=c.useState(!1);if(!n.pipe||!o||n.lockActions||ze(e)!==4)return null;const p=i(e),x=(p==null?void 0:p.stage)||"todo",u=async f=>{if(s||f===x)return;g(!0);const y=p;d(e,{stage:f,stamps:(p==null?void 0:p.stamps)||{}});const j=Math.max(Date.now(),zr+=1);zr=j;const v=await os(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!v.stale&&(v.ok||(d(e,y),l(a.actErr)))},b=(k=p==null?void 0:p.stamps)==null?void 0:k.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:s,onClick:()=>{u(f)},children:y},f)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let zr=0;const Kt=8,kt=360;function Ar({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function qr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Ar,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Ar,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function ad({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Z(),[d,l]=c.useState(0),[s,g]=c.useState(null),[p,x]=c.useState([]),u=c.useRef(!1),b=c.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=c.useRef(!1);c.useEffect(()=>{const S=b.current;return()=>{m.current||(n({type:"ptab",tab:S.ptab}),n({type:"dens",dens:S.dens}),n({type:"modal",modal:S.modal}))}},[]),c.useEffect(()=>{u.current||(u.current=!0,x(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const w=p[d],k=d>=p.length;c.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const S=w.click,L=window.setTimeout(()=>{const q=document.querySelector(S);q&&q.getAttribute("aria-selected")!=="true"&&q.click()},60);return()=>window.clearTimeout(L)}},[d,w]);const f=c.useRef(-1),y=c.useCallback(()=>{if(!w){g(null);return}const S=D=>{if(!D)return null;for(const B of document.querySelectorAll(D)){const V=B.getBoundingClientRect();if(V.width>1&&V.height>1)return B}return null},L=S(w.sel)||S(w.need);if(!L){g(null);return}f.current!==d&&(f.current=d,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const q=L.getBoundingClientRect();g(D=>D&&Math.abs(D.top-q.top)<1&&Math.abs(D.left-q.left)<1&&Math.abs(D.width-q.width)<1&&Math.abs(D.height-q.height)<1?D:q)},[w,d]);c.useLayoutEffect(()=>{y();const S=[90,300,700,1300].map(D=>window.setTimeout(y,D)),L=window.setInterval(y,400),q=()=>y();return window.addEventListener("scroll",q,!0),window.addEventListener("resize",q),()=>{S.forEach(D=>window.clearTimeout(D)),window.clearInterval(L),window.removeEventListener("scroll",q,!0),window.removeEventListener("resize",q)}},[y]);const j=c.useRef(a);if(j.current=a,c.useEffect(()=>{const S=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),j.current()):L.key==="ArrowRight"?l(q=>q+1):L.key==="ArrowLeft"&&l(q=>Math.max(0,q-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!p.length)return null;let v=null;const N=S=>()=>{m.current=!0,n({type:"modal",modal:null}),S()};if(k){const S=o[3]||0;S>0?v={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?v={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?v={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:v={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let E={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:kt};if(!k&&s){const S=s.bottom+14,L=window.innerHeight-S;let q=L>190?S:Math.max(12,s.top-200),D=Math.min(Math.max(12,s.left+s.width/2-kt/2),window.innerWidth-kt-12);L<=190&&s.top<212&&(window.innerWidth-s.right>=kt+40?D=Math.min(s.right+26,window.innerWidth-kt-12):s.left>=kt+40&&(D=Math.max(12,s.left-kt-26)),q=Math.max(12,s.top-Kt)),E={left:D,top:q,width:kt}}return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!k&&s&&t.jsx("div",{className:"tour-hole",style:{left:s.left-Kt,top:s.top-Kt,width:s.width+Kt*2,height:s.height+Kt*2}}),(k||!s)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(k?" fin":""),style:E,children:[k&&v?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:v.title}),t.jsx(qr,{text:v.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(p.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:v.go,children:v.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,p.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/p.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(qr,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(S=>S+1),children:d===p.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function $o(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Uo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function nd(){var L,q;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:s}=Z(),g=r?a:e,p=c.useMemo(()=>g.filter(D=>wt(D.date)===0&&D.kind==="target"),[g]),x=c.useMemo(()=>r?a.filter(D=>D.kind==="target"&&ze(D)===0).slice().sort((D,B)=>(B.date||"").localeCompare(D.date||"")):[],[a,r]),u=c.useMemo(()=>p.filter(D=>r?ze(D)===0:!Ge(D)),[p,r]),b=r?x:u,m=r?a.length-x.length:p.length-u.length,w=r?a.length:p.length,k=w?Math.min(100,m/w*100):100,f=c.useMemo(()=>$o(g),[g]),y=!!f&&wt(f)>0,j=c.useMemo(()=>y?g.filter(D=>(D.date||"").slice(0,10)===f):[],[g,f,y]),v=typeof((L=l.stats)==null?void 0:L.kept_today)=="number"?l.stats.kept_today:null,N=typeof((q=l.stats)==null?void 0:q.screened_today)=="number"?l.stats.screened_today:p.length;let E;y?E=o.morningLast(j.length,x.length,Uo(f,d)):r?E=o.morningThesis(N,x.length,v):p.length?m===0?E=o.goalSourced(p.length):m>=p.length?E=o.goalCleared:E=o.goalDone(m,p.length):E=o.goalSourced(0);const S=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&x.length&&s({type:"chainStart",queue:x.map(D=>D.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:E}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:k+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:S,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}const rd=[0,1,2,3,5,10];function od(){var _;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:d,scoped:l,mode:s,doSync:g,startTour:p,flash:x,flashErr:u}=Z(),[b,m]=c.useState(null),[w,k]=c.useState(!0),[f,y]=c.useState([]),j=s==="client";c.useEffect(()=>{if(!o||!i)return;let I=!0;return k(!0),(async()=>{const[Y,G]=await Promise.all([Rn(i),vo(o)]);I&&(Y&&m(Y),k(!1),y(G))})(),()=>{I=!1}},[o,i]);const[v,N]=c.useState(!1),[E,S]=c.useState(""),L=()=>{!j||v||!i||(N(!0),S(""),is(i).then(I=>{if(N(!1),I.pending){S(e.refreshSlow);return}if(!I.ok){I.error&&console.warn("[republish]",I.error),S(e.refreshKo);return}const Y=I.entered??0,G=I.left??0;S(I.unchanged||!Y&&!G?e.refreshSame:e.refreshDone(Y,G)),d.refresh()}))},q=(b==null?void 0:b.per_day)??null,D=((_=b==null?void 0:b.pool_order)==null?void 0:_.length)??0,B=f.filter(I=>I.status==="running").length,[V,T]=c.useState(!1),F=I=>{!j||V||!o||(T(!0),yo(o,I).then(Y=>{if(T(!1),Y===null){u(e.actErr);return}m(G=>G&&{...G,per_day:Y}),x(e.alertSaved)}))},h=d.marketEstimate,A=c.useMemo(()=>l.filter(I=>!We(I)).length,[l]),M=h&&h>0?Math.min(100,Math.round(A/h*100)):null,H=I=>I.toLocaleString(a==="en"?"en-US":"fr-FR"),C=(i||"P").split(/\s+/).map(I=>I[0]).join("").slice(0,2).toUpperCase(),O=(()=>{const I=Date.parse(d.generatedAt||"");if(Number.isNaN(I))return"";const Y=new Date(I),G=he=>String(he).padStart(2,"0");return`${G(Y.getDate())}/${G(Y.getMonth()+1)} à ${G(Y.getHours())}:${G(Y.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?C:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),O?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(O)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||v,onClick:L,children:v?"⏳":"📰"}),(v||!!E)&&t.jsxs("span",{className:"repubst",children:[v?e.refreshRun:E,!v&&t.jsx("button",{type:"button",onClick:()=>S(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:g,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:p,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:I=>n({type:"filters",patch:{search:I.target.value}})})]})]}),t.jsxs("div",{className:"idmain",children:[t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),M!==null&&h?t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:M+"%"}})}),t.jsx("b",{children:H(A)})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(A,h)}})]}):t.jsx("span",{className:"ev",children:t.jsx("b",{children:H(A)})})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),q!==null&&t.jsx("span",{className:"ev",onClick:I=>I.stopPropagation(),children:t.jsx("span",{className:"covrb erate",role:"group","aria-label":e.covRate,children:rd.map(I=>t.jsx("button",{type:"button",className:q===I?"on":"",disabled:!j||V,title:I===0?e.identPauseTitle:e.covRateNow(I),onClick:()=>F(I),children:I===0?"⏸":I},I))})}),q===0&&t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),B>0&&t.jsxs("span",{className:"ev",children:["⏳ ",B]}),t.jsx("span",{className:"ego",children:w?e.identPendingWait:e.identPending(D)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:I=>{I.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]})]})]})}class Lt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*id(e){for(const a of e)yield*a}function Ho(e){return Array.from(id(e))}var Ce=1e-6,je=Math.PI,rt=je/2,Tr=je/4,it=je*2,xt=180/je,et=je/180,Te=Math.abs,sd=Math.atan,ia=Math.atan2,Fe=Math.cos,Oe=Math.sin,ld=Math.sign||function(e){return e>0?1:e<0?-1:0},Ot=Math.sqrt;function dd(e){return e>1?0:e<-1?je:Math.acos(e)}function sa(e){return e>1?rt:e<-1?-rt:Math.asin(e)}function ot(){}function Ma(e,a){e&&Rr.hasOwnProperty(e.type)&&Rr[e.type](e,a)}var Lr={Feature:function(e,a){Ma(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ma(r[n].geometry,a)}},Rr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){hn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)hn(r[n],a,0)},Polygon:function(e,a){Fr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Fr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ma(r[n],a)}};function hn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Fr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)hn(e[r],a,1);a.polygonEnd()}function _t(e,a){e&&Lr.hasOwnProperty(e.type)?Lr[e.type](e,a):Ma(e,a)}function gn(e){return[ia(e[1],e[0]),sa(e[2])]}function Ut(e){var a=e[0],r=e[1],n=Fe(r);return[n*Fe(a),n*Oe(a),Oe(r)]}function xa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Da(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function en(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ba(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function xn(e){var a=Ot(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function bn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function vn(e,a){return Te(e)>je&&(e-=Math.round(e/it)*it),[e,a]}vn.invert=vn;function pd(e,a,r){return(e%=it)?a||r?bn(Mr(e),Dr(a,r)):Mr(e):a||r?Dr(a,r):vn}function Or(e){return function(a,r){return a+=e,Te(a)>je&&(a-=Math.round(a/it)*it),[a,r]}}function Mr(e){var a=Or(e);return a.invert=Or(-e),a}function Dr(e,a){var r=Fe(e),n=Oe(e),o=Fe(a),i=Oe(a);function d(l,s){var g=Fe(s),p=Fe(l)*g,x=Oe(l)*g,u=Oe(s),b=u*r+p*n;return[ia(x*o-b*i,p*r-u*n),sa(b*o+x*i)]}return d.invert=function(l,s){var g=Fe(s),p=Fe(l)*g,x=Oe(l)*g,u=Oe(s),b=u*o-x*i;return[ia(x*o+u*i,p*r+b*n),sa(b*r-p*n)]},d}function cd(e,a,r,n,o,i){if(r){var d=Fe(a),l=Oe(a),s=n*r;o==null?(o=a+n*it,i=a-s/2):(o=Ir(d,o),i=Ir(d,i),(n>0?o<i:o>i)&&(o+=n*it));for(var g,p=o;n>0?p>i:p<i;p-=s)g=gn([d,-l*Fe(p),-l*Oe(p)]),e.point(g[0],g[1])}}function Ir(e,a){a=Ut(a),a[0]-=e,xn(a);var r=dd(-a[1]);return((-a[2]<0?-r:r)+it-Ce)%it}function Vo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:ot,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Sa(e,a){return Te(e[0]-a[0])<Ce&&Te(e[1]-a[1])<Ce}function va(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Wo(e,a,r,n,o){var i=[],d=[],l,s;if(e.forEach(function(m){if(!((w=m.length-1)<=0)){var w,k=m[0],f=m[w],y;if(Sa(k,f)){if(!k[2]&&!f[2]){for(o.lineStart(),l=0;l<w;++l)o.point((k=m[l])[0],k[1]);o.lineEnd();return}f[0]+=2*Ce}i.push(y=new va(k,m,null,!0)),d.push(y.o=new va(k,null,y,!1)),i.push(y=new va(f,m,null,!1)),d.push(y.o=new va(f,null,y,!0))}}),!!i.length){for(d.sort(a),Pr(i),Pr(d),l=0,s=d.length;l<s;++l)d[l].e=r=!r;for(var g=i[0],p,x;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;p=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,s=p.length;l<s;++l)o.point((x=p[l])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(p=u.p.z,l=p.length-1;l>=0;--l)o.point((x=p[l])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,p=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Pr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function tn(e){return Te(e[0])<=je?e[0]:ld(e[0])*((Te(e[0])+je)%it-je)}function ud(e,a){var r=tn(a),n=a[1],o=Oe(n),i=[Oe(r),-Fe(r),0],d=0,l=0,s=new Lt;o===1?n=rt+Ce:o===-1&&(n=-rt-Ce);for(var g=0,p=e.length;g<p;++g)if(u=(x=e[g]).length)for(var x,u,b=x[u-1],m=tn(b),w=b[1]/2+Tr,k=Oe(w),f=Fe(w),y=0;y<u;++y,m=v,k=E,f=S,b=j){var j=x[y],v=tn(j),N=j[1]/2+Tr,E=Oe(N),S=Fe(N),L=v-m,q=L>=0?1:-1,D=q*L,B=D>je,V=k*E;if(s.add(ia(V*q*Oe(D),f*S+V*Fe(D))),d+=B?L+q*it:L,B^m>=r^v>=r){var T=Da(Ut(b),Ut(j));xn(T);var F=Da(i,T);xn(F);var h=(B^L>=0?-1:1)*sa(F[2]);(n>h||n===h&&(T[0]||T[1]))&&(l+=B^L>=0?1:-1)}}return(d<-Ce||d<Ce&&s<-1e-12)^l&1}function Go(e,a,r,n){return function(o){var i=a(o),d=Vo(),l=a(d),s=!1,g,p,x,u={point:b,lineStart:w,lineEnd:k,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=j,p=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=w,u.lineEnd=k,p=Ho(p);var v=ud(g,n);p.length?(s||(o.polygonStart(),s=!0),Wo(p,fd,v,r,o)):v&&(s||(o.polygonStart(),s=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),s&&(o.polygonEnd(),s=!1),p=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(v,N){e(v,N)&&o.point(v,N)}function m(v,N){i.point(v,N)}function w(){u.point=m,i.lineStart()}function k(){u.point=b,i.lineEnd()}function f(v,N){x.push([v,N]),l.point(v,N)}function y(){l.lineStart(),x=[]}function j(){f(x[0][0],x[0][1]),l.lineEnd();var v=l.clean(),N=d.result(),E,S=N.length,L,q,D;if(x.pop(),g.push(x),x=null,!!S){if(v&1){if(q=N[0],(L=q.length-1)>0){for(s||(o.polygonStart(),s=!0),o.lineStart(),E=0;E<L;++E)o.point((D=q[E])[0],D[1]);o.lineEnd()}return}S>1&&v&2&&N.push(N.pop().concat(N.shift())),p.push(N.filter(md))}}return u}}function md(e){return e.length>1}function fd(e,a){return((e=e.x)[0]<0?e[1]-rt-Ce:rt-e[1])-((a=a.x)[0]<0?a[1]-rt-Ce:rt-a[1])}const _r=Go(function(){return!0},hd,xd,[-je,-rt]);function hd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?je:-je,s=Te(i-a);Te(s-je)<Ce?(e.point(a,r=(r+d)/2>0?rt:-rt),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&s>=je&&(Te(a-n)<Ce&&(a-=n*Ce),Te(i-l)<Ce&&(i-=l*Ce),r=gd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function gd(e,a,r,n){var o,i,d=Oe(e-r);return Te(d)>Ce?sd((Oe(a)*(i=Fe(n))*Oe(r)-Oe(n)*(o=Fe(a))*Oe(e))/(o*i*d)):(a+n)/2}function xd(e,a,r,n){var o;if(e==null)o=r*rt,n.point(-je,o),n.point(0,o),n.point(je,o),n.point(je,0),n.point(je,-o),n.point(0,-o),n.point(-je,-o),n.point(-je,0),n.point(-je,o);else if(Te(e[0]-a[0])>Ce){var i=e[0]<a[0]?je:-je;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function bd(e){var a=Fe(e),r=2*et,n=a>0,o=Te(a)>Ce;function i(p,x,u,b){cd(b,e,r,u,p,x)}function d(p,x){return Fe(p)*Fe(x)>a}function l(p){var x,u,b,m,w;return{lineStart:function(){m=b=!1,w=1},point:function(k,f){var y=[k,f],j,v=d(k,f),N=n?v?0:g(k,f):v?g(k+(k<0?je:-je),f):0;if(!x&&(m=b=v)&&p.lineStart(),v!==b&&(j=s(x,y),(!j||Sa(x,j)||Sa(y,j))&&(y[2]=1)),v!==b)w=0,v?(p.lineStart(),j=s(y,x),p.point(j[0],j[1])):(j=s(x,y),p.point(j[0],j[1],2),p.lineEnd()),x=j;else if(o&&x&&n^v){var E;!(N&u)&&(E=s(y,x,!0))&&(w=0,n?(p.lineStart(),p.point(E[0][0],E[0][1]),p.point(E[1][0],E[1][1]),p.lineEnd()):(p.point(E[1][0],E[1][1]),p.lineEnd(),p.lineStart(),p.point(E[0][0],E[0][1],3)))}v&&(!x||!Sa(x,y))&&p.point(y[0],y[1]),x=y,b=v,u=N},lineEnd:function(){b&&p.lineEnd(),x=null},clean:function(){return w|(m&&b)<<1}}}function s(p,x,u){var b=Ut(p),m=Ut(x),w=[1,0,0],k=Da(b,m),f=xa(k,k),y=k[0],j=f-y*y;if(!j)return!u&&p;var v=a*f/j,N=-a*y/j,E=Da(w,k),S=ba(w,v),L=ba(k,N);en(S,L);var q=E,D=xa(S,q),B=xa(q,q),V=D*D-B*(xa(S,S)-1);if(!(V<0)){var T=Ot(V),F=ba(q,(-D-T)/B);if(en(F,S),F=gn(F),!u)return F;var h=p[0],A=x[0],M=p[1],H=x[1],C;A<h&&(C=h,h=A,A=C);var O=A-h,_=Te(O-je)<Ce,I=_||O<Ce;if(!_&&H<M&&(C=M,M=H,H=C),I?_?M+H>0^F[1]<(Te(F[0]-h)<Ce?M:H):M<=F[1]&&F[1]<=H:O>je^(h<=F[0]&&F[0]<=A)){var Y=ba(q,(-D+T)/B);return en(Y,S),[F,gn(Y)]}}}function g(p,x){var u=n?e:je-e,b=0;return p<-u?b|=1:p>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return Go(d,l,i,n?[0,-e]:[-je,e-je])}function vd(e,a,r,n,o,i){var d=e[0],l=e[1],s=a[0],g=a[1],p=0,x=1,u=s-d,b=g-l,m;if(m=r-d,!(!u&&m>0)){if(m/=u,u<0){if(m<p)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>p&&(p=m)}if(m=o-d,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>p&&(p=m)}else if(u>0){if(m<p)return;m<x&&(x=m)}if(m=n-l,!(!b&&m>0)){if(m/=b,b<0){if(m<p)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>p&&(p=m)}if(m=i-l,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>p&&(p=m)}else if(b>0){if(m<p)return;m<x&&(x=m)}return p>0&&(e[0]=d+p*u,e[1]=l+p*b),x<1&&(a[0]=d+x*u,a[1]=l+x*b),!0}}}}}var Xt=1e9,ya=-Xt;function yd(e,a,r,n){function o(g,p){return e<=g&&g<=r&&a<=p&&p<=n}function i(g,p,x,u){var b=0,m=0;if(g==null||(b=d(g,x))!==(m=d(p,x))||s(g,p)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(p[0],p[1])}function d(g,p){return Te(g[0]-e)<Ce?p>0?0:3:Te(g[0]-r)<Ce?p>0?2:1:Te(g[1]-a)<Ce?p>0?1:0:p>0?3:2}function l(g,p){return s(g.x,p.x)}function s(g,p){var x=d(g,1),u=d(p,1);return x!==u?x-u:x===0?p[1]-g[1]:x===1?g[0]-p[0]:x===2?g[1]-p[1]:p[0]-g[0]}return function(g){var p=g,x=Vo(),u,b,m,w,k,f,y,j,v,N,E,S={point:L,lineStart:V,lineEnd:T,polygonStart:D,polygonEnd:B};function L(h,A){o(h,A)&&p.point(h,A)}function q(){for(var h=0,A=0,M=b.length;A<M;++A)for(var H=b[A],C=1,O=H.length,_=H[0],I,Y,G=_[0],he=_[1];C<O;++C)I=G,Y=he,_=H[C],G=_[0],he=_[1],Y<=n?he>n&&(G-I)*(n-Y)>(he-Y)*(e-I)&&++h:he<=n&&(G-I)*(n-Y)<(he-Y)*(e-I)&&--h;return h}function D(){p=x,u=[],b=[],E=!0}function B(){var h=q(),A=E&&h,M=(u=Ho(u)).length;(A||M)&&(g.polygonStart(),A&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),M&&Wo(u,l,h,i,g),g.polygonEnd()),p=g,u=b=m=null}function V(){S.point=F,b&&b.push(m=[]),N=!0,v=!1,y=j=NaN}function T(){u&&(F(w,k),f&&v&&x.rejoin(),u.push(x.result())),S.point=L,v&&p.lineEnd()}function F(h,A){var M=o(h,A);if(b&&m.push([h,A]),N)w=h,k=A,f=M,N=!1,M&&(p.lineStart(),p.point(h,A));else if(M&&v)p.point(h,A);else{var H=[y=Math.max(ya,Math.min(Xt,y)),j=Math.max(ya,Math.min(Xt,j))],C=[h=Math.max(ya,Math.min(Xt,h)),A=Math.max(ya,Math.min(Xt,A))];vd(H,C,e,a,r,n)?(v||(p.lineStart(),p.point(H[0],H[1])),p.point(C[0],C[1]),M||p.lineEnd(),E=!1):M&&(p.lineStart(),p.point(h,A),E=!1)}y=h,j=A,v=M}return S}}const yn=e=>e;var an=new Lt,wn=new Lt,Yo,Qo,kn,jn,vt={point:ot,lineStart:ot,lineEnd:ot,polygonStart:function(){vt.lineStart=wd,vt.lineEnd=jd},polygonEnd:function(){vt.lineStart=vt.lineEnd=vt.point=ot,an.add(Te(wn)),wn=new Lt},result:function(){var e=an/2;return an=new Lt,e}};function wd(){vt.point=kd}function kd(e,a){vt.point=Ko,Yo=kn=e,Qo=jn=a}function Ko(e,a){wn.add(jn*e-kn*a),kn=e,jn=a}function jd(){Ko(Yo,Qo)}var Ht=1/0,Ia=Ht,la=-Ht,Pa=la,_a={point:Ed,lineStart:ot,lineEnd:ot,polygonStart:ot,polygonEnd:ot,result:function(){var e=[[Ht,Ia],[la,Pa]];return la=Pa=-(Ia=Ht=1/0),e}};function Ed(e,a){e<Ht&&(Ht=e),e>la&&(la=e),a<Ia&&(Ia=a),a>Pa&&(Pa=a)}var En=0,Nn=0,Zt=0,Ba=0,$a=0,Bt=0,Sn=0,Cn=0,ea=0,Jo,Xo,ut,mt,nt={point:Rt,lineStart:Br,lineEnd:$r,polygonStart:function(){nt.lineStart=Cd,nt.lineEnd=zd},polygonEnd:function(){nt.point=Rt,nt.lineStart=Br,nt.lineEnd=$r},result:function(){var e=ea?[Sn/ea,Cn/ea]:Bt?[Ba/Bt,$a/Bt]:Zt?[En/Zt,Nn/Zt]:[NaN,NaN];return En=Nn=Zt=Ba=$a=Bt=Sn=Cn=ea=0,e}};function Rt(e,a){En+=e,Nn+=a,++Zt}function Br(){nt.point=Nd}function Nd(e,a){nt.point=Sd,Rt(ut=e,mt=a)}function Sd(e,a){var r=e-ut,n=a-mt,o=Ot(r*r+n*n);Ba+=o*(ut+e)/2,$a+=o*(mt+a)/2,Bt+=o,Rt(ut=e,mt=a)}function $r(){nt.point=Rt}function Cd(){nt.point=Ad}function zd(){Zo(Jo,Xo)}function Ad(e,a){nt.point=Zo,Rt(Jo=ut=e,Xo=mt=a)}function Zo(e,a){var r=e-ut,n=a-mt,o=Ot(r*r+n*n);Ba+=o*(ut+e)/2,$a+=o*(mt+a)/2,Bt+=o,o=mt*e-ut*a,Sn+=o*(ut+e),Cn+=o*(mt+a),ea+=o*3,Rt(ut=e,mt=a)}function ei(e){this._context=e}ei.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,it);break}}},result:ot};var zn=new Lt,nn,ti,ai,ta,aa,da={point:ot,lineStart:function(){da.point=qd},lineEnd:function(){nn&&ni(ti,ai),da.point=ot},polygonStart:function(){nn=!0},polygonEnd:function(){nn=null},result:function(){var e=+zn;return zn=new Lt,e}};function qd(e,a){da.point=ni,ti=ta=e,ai=aa=a}function ni(e,a){ta-=e,aa-=a,zn.add(Ot(ta*ta+aa*aa)),ta=e,aa=a}let Ur,Ua,Hr,Vr;class Wr{constructor(a){this._append=a==null?ri:Td(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Hr||this._append!==Ua){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Hr=n,Ua=this._append,Vr=this._,this._=o}this._+=Vr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ri(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Td(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ri;if(a!==Ur){const r=10**a;Ur=a,Ua=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ua}function Ld(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),_t(l,o(i))),i.result()}return d.area=function(l){return _t(l,o(vt)),vt.result()},d.measure=function(l){return _t(l,o(da)),da.result()},d.bounds=function(l){return _t(l,o(_a)),_a.result()},d.centroid=function(l){return _t(l,o(nt)),nt.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,yn):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new Wr(r)):new ei(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const s=Math.floor(l);if(!(s>=0))throw new RangeError(`invalid digits: ${l}`);r=s}return a===null&&(i=new Wr(r)),d},d.projection(e).digits(r).context(a)}function _n(e){return function(a){var r=new An;for(var n in e)r[n]=e[n];return r.stream=a,r}}function An(){}An.prototype={constructor:An,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Bn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),_t(r,e.stream(_a)),a(_a.result()),n!=null&&e.clipExtent(n),e}function oi(e,a,r){return Bn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,s=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,s])},r)}function Rd(e,a,r){return oi(e,[[0,0],a],r)}function Fd(e,a,r){return Bn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function Od(e,a,r){return Bn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var Gr=16,Md=Fe(30*et);function Yr(e,a){return+a?Id(e,a):Dd(e)}function Dd(e){return _n({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Id(e,a){function r(n,o,i,d,l,s,g,p,x,u,b,m,w,k){var f=g-n,y=p-o,j=f*f+y*y;if(j>4*a&&w--){var v=d+u,N=l+b,E=s+m,S=Ot(v*v+N*N+E*E),L=sa(E/=S),q=Te(Te(E)-1)<Ce||Te(i-x)<Ce?(i+x)/2:ia(N,v),D=e(q,L),B=D[0],V=D[1],T=B-n,F=V-o,h=y*T-f*F;(h*h/j>a||Te((f*T+y*F)/j-.5)>.3||d*u+l*b+s*m<Md)&&(r(n,o,i,d,l,s,B,V,q,v/=S,N/=S,E,w,k),k.point(B,V),r(B,V,q,v,N,E,g,p,x,u,b,m,w,k))}}return function(n){var o,i,d,l,s,g,p,x,u,b,m,w,k={point:f,lineStart:y,lineEnd:v,polygonStart:function(){n.polygonStart(),k.lineStart=N},polygonEnd:function(){n.polygonEnd(),k.lineStart=y}};function f(L,q){L=e(L,q),n.point(L[0],L[1])}function y(){x=NaN,k.point=j,n.lineStart()}function j(L,q){var D=Ut([L,q]),B=e(L,q);r(x,u,p,b,m,w,x=B[0],u=B[1],p=L,b=D[0],m=D[1],w=D[2],Gr,n),n.point(x,u)}function v(){k.point=f,n.lineEnd()}function N(){y(),k.point=E,k.lineEnd=S}function E(L,q){j(o=L,q),i=x,d=u,l=b,s=m,g=w,k.point=j}function S(){r(x,u,p,b,m,w,i,d,o,l,s,g,Gr,n),k.lineEnd=v,v()}return k}}var Pd=_n({point:function(e,a){this.stream.point(e*et,a*et)}});function _d(e){return _n({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Bd(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function Qr(e,a,r,n,o,i){if(!i)return Bd(e,a,r,n,o);var d=Fe(i),l=Oe(i),s=d*e,g=l*e,p=d/e,x=l/e,u=(l*r-d*a)/e,b=(l*a+d*r)/e;function m(w,k){return w*=n,k*=o,[s*w-g*k+a,r-g*w-s*k]}return m.invert=function(w,k){return[n*(p*w-x*k+u),o*(b-x*w-p*k)]},m}function $d(e){return Ud(function(){return e})()}function Ud(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,s=0,g=0,p,x=0,u=1,b=1,m=null,w=_r,k=null,f,y,j,v=yn,N=.5,E,S,L,q,D;function B(h){return L(h[0]*et,h[1]*et)}function V(h){return h=L.invert(h[0],h[1]),h&&[h[0]*xt,h[1]*xt]}B.stream=function(h){return q&&D===h?q:q=Pd(_d(p)(w(E(v(D=h)))))},B.preclip=function(h){return arguments.length?(w=h,m=void 0,F()):w},B.postclip=function(h){return arguments.length?(v=h,k=f=y=j=null,F()):v},B.clipAngle=function(h){return arguments.length?(w=+h?bd(m=h*et):(m=null,_r),F()):m*xt},B.clipExtent=function(h){return arguments.length?(v=h==null?(k=f=y=j=null,yn):yd(k=+h[0][0],f=+h[0][1],y=+h[1][0],j=+h[1][1]),F()):k==null?null:[[k,f],[y,j]]},B.scale=function(h){return arguments.length?(r=+h,T()):r},B.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],T()):[n,o]},B.center=function(h){return arguments.length?(i=h[0]%360*et,d=h[1]%360*et,T()):[i*xt,d*xt]},B.rotate=function(h){return arguments.length?(l=h[0]%360*et,s=h[1]%360*et,g=h.length>2?h[2]%360*et:0,T()):[l*xt,s*xt,g*xt]},B.angle=function(h){return arguments.length?(x=h%360*et,T()):x*xt},B.reflectX=function(h){return arguments.length?(u=h?-1:1,T()):u<0},B.reflectY=function(h){return arguments.length?(b=h?-1:1,T()):b<0},B.precision=function(h){return arguments.length?(E=Yr(S,N=h*h),F()):Ot(N)},B.fitExtent=function(h,A){return oi(B,h,A)},B.fitSize=function(h,A){return Rd(B,h,A)},B.fitWidth=function(h,A){return Fd(B,h,A)},B.fitHeight=function(h,A){return Od(B,h,A)};function T(){var h=Qr(r,0,0,u,b,x).apply(null,a(i,d)),A=Qr(r,n-h[0],o-h[1],u,b,x);return p=pd(l,s,g),S=bn(a,A),L=bn(p,S),E=Yr(S,N),F()}function F(){return q=D=null,B}return function(){return a=e.apply(this,arguments),B.invert=a.invert&&V,T()}}function ii(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}ii.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Te(o)>Ce&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Hd(){return $d(ii).scale(175.295)}function Vd(e){return e}function Wd(e){if(e==null)return Vd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,s){s||(a=r=0);var g=2,p=l.length,x=new Array(p);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+d;g<p;)x[g]=l[g],++g;return x}}function Gd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Yd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Kr(e,r)})}:Kr(e,a)}function Kr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Qd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Qd(e,a){var r=Wd(e.transform),n=e.arcs;function o(p,x){x.length&&x.pop();for(var u=n[p<0?~p:p],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));p<0&&Gd(x,m)}function i(p){return r(p)}function d(p){for(var x=[],u=0,b=p.length;u<b;++u)o(p[u],x);return x.length<2&&x.push(x[0]),x}function l(p){for(var x=d(p);x.length<4;)x.push(x[0]);return x}function s(p){return p.map(l)}function g(p){var x=p.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:p.geometries.map(g)};case"Point":u=i(p.coordinates);break;case"MultiPoint":u=p.coordinates.map(i);break;case"LineString":u=d(p.arcs);break;case"MultiLineString":u=p.arcs.map(d);break;case"Polygon":u=s(p.arcs);break;case"MultiPolygon":u=p.arcs.map(s);break;default:return null}return{type:x,coordinates:u}}return g(a)}const si={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Kd=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Jd(e,a,r){const n=si[e];if(!n||!n.length)return-1;const o=Kd(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let wa=null;function Xd(){return wa||(wa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Yd(r,n),i=Hd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Ld(i),l=(o.features||[]).filter(p=>{var x;return(((x=p.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(p=>{var b;const x=((b=p.properties)==null?void 0:b.name)||"",u=d(p)||"";return u?{i2:ss(x)||null,n:x,d:u}:null}).filter(p=>!!p);if(!l.length)return null;const s={};for(const[p,x]of Object.entries(ls)){const u=i(x);u&&(s[p]={x:u[0],y:u[1]})}const g={};for(const[p,x]of Object.entries(si)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(g[p]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:s,metros:g}}catch{return null}})(),wa)}function Zd(e){const[a,r]=c.useState(null);return c.useEffect(()=>{if(!e||a)return;let n=!1;return Xd().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const ep="8 40 984 210",tp={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Jr=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function Xr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ap(e,a){const[r,n]=c.useState(1);return c.useEffect(()=>{let o=!0,i=0;const d=()=>{var g;if(!o)return;const s=(g=e.current)==null?void 0:g.getScreenCTM();s&&s.a>0?n(s.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function Zr({msgs:e}){const[a,r]=c.useState(0);c.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function np(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:s,data:g,dossiers:p,source:x}=Z(),u=g.loading&&!p.length,b=c.useRef(null),m=c.useRef(null),w=Zd(e.continent==="monde"),k=e.continent==="monde"?w:Fn.find(h=>h.key===e.continent)||null,f=ap(b,e.continent+":"+e.mapFolded+":"+!!k),[y,j]=c.useState(new Map),[v,N]=c.useState(null);c.useEffect(()=>{const h=b.current;if(!h)return;const A=new Map;h.querySelectorAll("path[data-i2]").forEach(M=>{const H=M.dataset.i2;if(H)try{const C=M.getBBox();C.width>0&&A.set(H,{x:C.x,y:C.y,w:C.width,h:C.height})}catch{}}),j(A)},[e.continent,f,k]);const E=c.useMemo(()=>r.filter(h=>h.cc),[r]),S=c.useMemo(()=>{const h=new Map;return E.forEach(A=>h.set(A.cc,(h.get(A.cc)||0)+1)),h},[E]),L=e.continent==="monde"&&w?w.anchors:null,q=e.continent==="monde"&&w?w.metros:null,D=c.useMemo(()=>E.map(h=>{const A=Xr(h.name||h.id||""),M=Xr((h.id||h.name||"")+"·y");if(L&&h.cc){const I=q?q[h.cc]:void 0;if(I&&I.length){const G=Jd(h.cc,h.city,A);if(G>=0&&I[G])return{d:h,x:I[G].x+(A-.5)*5,y:I[G].y+(M-.5)*5}}const Y=L[h.cc];if(Y)return{d:h,x:Y.x+(A-.5)*10,y:Y.y+(M-.5)*10}}const H=h.cc?y.get(h.cc):void 0;if(!H)return null;const C=tp[`${e.continent}:${h.cc||""}`];if(C)return{d:h,x:H.x+H.w*(C.fx+(A-.5)*C.sx),y:H.y+H.h*(C.fy+(M-.5)*C.sy)};const O=(A-.5)*Math.min(H.w*.55,60),_=(M-.5)*Math.min(H.h*.55,60);return{d:h,x:H.x+H.w/2+O,y:H.y+H.h/2+_}}).filter(h=>!!h),[E,y,L,q,e.continent]),B=h=>f>0?h/f:h,V=c.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:Jr[h],fr:s.plabels[h],en:s.plabels[h],n:r.filter(A=>A.kind==="target"&&ze(A)===h).length})).filter(h=>h.n>0):nr.map((h,A)=>({...h,n:r.filter(M=>rr(M)===A).length})),[r,n,s.plabels]),T=i?d.get(i):null,F=T?D.find(h=>h.d.id===T.id):null;return k?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Zr,{msgs:s.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?ep:k.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?k.fr:k.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:k.countries.map((h,A)=>t.jsx("g",{className:"ct"+(h.i2&&S.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},A))}),t.jsx("g",{children:D.map(h=>{const A=nr[rr(h.d)],M=!!Be(h.d),H=h.d.kind==="target",C=n&&H?Jr[ze(h.d)]:A.c,O=!n&&Ge(h.d);return t.jsxs("g",{className:"co"+(O?" done":""),onMouseEnter:()=>{var Y,G;const _=(Y=m.current)==null?void 0:Y.getBoundingClientRect(),I=(G=b.current)==null?void 0:G.createSVGPoint();if(I&&b.current&&_){I.x=h.x,I.y=h.y;const he=I.matrixTransform(b.current.getScreenCTM());N({x:he.x-_.left,y:he.y-_.top,label:h.d.name+" · "+(Gt(h.d.cc,l)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var Y;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const _=(Y=b.current)==null?void 0:Y.createSVGPoint();let I=null;if(_&&b.current){_.x=h.x,_.y=h.y;const G=_.matrixTransform(b.current.getScreenCTM());I={x:G.x,y:G.y}}a({type:"popup",id:h.d.id,anchor:I})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:B(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:B(A.px),fill:C,stroke:M?"#E5484D":"#ffffff",strokeWidth:B(M?2.2:1.3)})]},h.d.id||h.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:B(13),fill:"none",stroke:"#16233A",strokeWidth:B(2)})]}),t.jsx("div",{className:"hov"+(v?" on":""),style:v?{left:v.x,top:v.y}:void 0,children:v==null?void 0:v.label}),t.jsx("div",{className:"legend",children:V.map((h,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),l==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},A))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",s.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Zr,{msgs:s.loadMsgs})})}function rp(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function li({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=Z(),s=a.filters,[g,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null),m=c.useRef(null),w=c.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),k=F=>w.filter(h=>F!=="country"&&s.country.length&&!s.country.includes(h.cc||"")?!1:Fa(h,s,i,F==="country"?void 0:F)),f=F=>!i||F.kind!=="op",y=c.useMemo(()=>{const F=k("win").filter(f),h=A=>F.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=A).length;return[h(0),h(7),h(30),F.length]},[w,s,i]),j=c.useMemo(()=>s.day?k("win").filter(f).filter(F=>(F.date||"").slice(0,10)===s.day).length:0,[w,s,i]),v=(s.signalOnly?1:0)+s.sector.length+s.market.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+s.crible.length,N=v+(s.acquirer.trim()?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0);c.useEffect(()=>{a.openFacet&&p(!1)},[a.openFacet]),c.useEffect(()=>{if(!g&&!x)return;const F=A=>{var H,C;const M=A.target;g&&!((H=b.current)!=null&&H.contains(M))&&p(!1),x&&!((C=m.current)!=null&&C.contains(M))&&u(!1)},h=A=>{A.key==="Escape"&&(p(!1),u(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",h)}},[g,x]);const E=(F,h,A,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:h}),A>0&&t.jsx("span",{className:"n",children:A}),t.jsx("span",{className:"cv",children:"▾"})]},F),S=["1","7","30","all"],L=Math.max(0,S.indexOf(s.win||"all")),q=s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(rp(s.day,l))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:y[L]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:S.map((F,h)=>t.jsxs("button",{type:"button",role:"option","aria-selected":s.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),u(!1)},children:[o.datesShort[h],t.jsx("span",{className:"n",children:y[h]})]},F))})]}):t.jsx("div",{className:"seg",children:S.map((F,h)=>t.jsxs("button",{type:"button","aria-pressed":s.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:o.dates[h]}),t.jsx("b",{children:y[h]})]},F))}),D=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:s.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),B=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):E("sec",o.fSector,s.sector.length),(n.some(F=>!!F.market)||s.market.length>0)&&E("mar",o.fMarket,s.market.length),E("pay",o.fCountry,s.country.length),E("det",o.fEngine,s.engine.length),E("sta",o.fStage,s.stage.length),i&&E("crib",o.fVerdict,s.crible.length),i&&E("ang","Angle",s.angle.length),i&&E("mem","Mémo",s.memoLevel.length)]}),V=(F=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),T=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{p(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:B})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(s.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:q}),t.jsxs("div",{className:"fstrip-b",children:[D,T,V(!1)]})]}),a.openFacet&&t.jsx(eo,{poolFor:k})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[q,D,B,t.jsx("span",{className:"fgrow"}),V()]}),a.openFacet&&t.jsx(eo,{poolFor:k})]})}function eo({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=Z(),l=a.filters,s=a.openFacet,{title:g,cols:p,options:x}=c.useMemo(()=>{if(s==="sig"){const k=e("signal").filter(j=>Be(j)),f=new Map;k.forEach(j=>{const v=j.engine||"";f.set(v,(f.get(v)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:k.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...un([...f.keys()],o).map(j=>({v:j,label:Tt(j)+" "+tt(j,o),n:f.get(j)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(s==="crib"){const k=e("crible").filter(y=>!i||go(y,a.ptab,d.favIds)),f=new Map;return k.forEach(y=>{const j=xo(y);j&&j!=="NEW"&&f.set(j,(f.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((y,j)=>(or[y[0]]??9)-(or[j[0]]??9)||j[1]-y[1]).map(([y,j])=>({v:y,label:'<span class="fdot" style="background:'+(ds[y]||"#94A3B8")+'"></span>'+y,n:j,html:!0,on:l.crible.includes(y)}))}}if(s==="sec"){const k=e("sector"),f=new Map;return k.forEach(y=>{y.sector&&f.set(y.sector,(f.get(y.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:y,n:j,html:!1,on:l.sector.includes(y)}))}}if(s==="mar"){const k=e("market"),f=new Map;return k.forEach(y=>{y.market&&f.set(y.market,(f.get(y.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...f.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:y,n:j,html:!1,on:l.market.includes(y)}))}}if(s==="pay"){const k=e("country"),f=new Map;return k.forEach(y=>{y.cc&&f.set(y.cc,(f.get(y.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:Gt(y,o)||y,n:j,html:!1,on:l.country.includes(y)}))}}if(s==="det"){const k=e("engine"),f=new Map;return k.forEach(y=>{y.engine&&f.set(y.engine,(f.get(y.engine)||0)+1)}),{title:n.fEngine,cols:2,options:un([...f.keys()],o).map(y=>({v:y,label:Tt(y)+" "+tt(y,o)+' <span style="color:var(--dim);font-size:10px">· '+ps(cs(y),o)+"</span>",n:f.get(y)||0,html:!0,on:l.engine.includes(y)}))}}if(s==="ang"){const k=e("angle"),f=new Map;return k.forEach(y=>{y.angle&&f.set(y.angle,(f.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((y,j)=>j[1]-y[1]).map(([y,j])=>({v:y,label:y.replace(/[_-]+/g," "),n:j,html:!1,on:l.angle.includes(y)}))}}if(s==="mem"){const k=e("memoLevel"),f=new Map;k.forEach(j=>{if(j.kind==="target"){const v=Ln(j);f.set(v,(f.get(v)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:y[j],n:f.get(j)||0,html:!1,on:l.memoLevel.includes(j)}))}}const m=e("stage"),w=new Map;return m.forEach(k=>{k.stage&&w.set(k.stage,(w.get(k.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:k,n:f,html:!1,on:l.stage.includes(k)}))}},[s,a,o]),u=m=>{if(s==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const k=l.signalEngines.includes(m)?l.signalEngines.filter(f=>f!==m):[...l.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:k}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage",value:m})},b=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:g}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>u(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function di({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=Z(),s=c.useMemo(()=>{const b={};return r.forEach(m=>{Fa(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,p]=c.useState(!1),x=c.useRef(null);c.useEffect(()=>{if(!g)return;const b=w=>{var k;(k=x.current)!=null&&k.contains(w.target)||p(!1)},m=w=>{w.key==="Escape"&&p(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const u=b=>{const m=Fn.find(w=>w.key===b);return b==="monde"?l.contWorld:d==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>p(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:s[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:ir.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),p(!1)},children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[ir.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function qn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function pi(e){return"atl2:evalq:"+(e||"anon")}function op(e,a){const r=pi(e),n=qn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function ci(){const{t:e,data:a,dossiers:r}=Z(),n=a.session.token||"",o=pi(n),[i,d]=c.useState(()=>qn(o)),l=c.useRef(!1),[s,g]=c.useState(!1);c.useEffect(()=>{try{const C=i.slice(0,30).map(({descBusy:O,evalBusy:_,...I})=>I);localStorage.setItem(o,JSON.stringify(C)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[i,o]),c.useEffect(()=>{const C=()=>{if(l.current)return;const O=qn(o);d(_=>JSON.stringify(_.map(({descBusy:I,evalBusy:Y,...G})=>G))===JSON.stringify(O)?_:O)};return window.addEventListener("atl2:evalq",C),window.addEventListener("storage",C),()=>{window.removeEventListener("atl2:evalq",C),window.removeEventListener("storage",C)}},[o]);const[p,x]=c.useState([]),[u,b]=c.useState(""),[m,w]=c.useState(!1),[k,f]=c.useState(!1),[y,j]=c.useState(""),v=c.useCallback((C,O)=>d(_=>_.map((I,Y)=>Y===C?{...I,...O}:I)),[]),N=c.useCallback((C,O)=>{const _=O.trim();_&&(v(C,{name:_,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),On(_).then(I=>{const Y=I.candidates||[];I.website?v(C,{site:I.website,status:"ready"}):Y.length===1?v(C,{site:Y[0].url,status:"ready"}):Y.length>1?v(C,{status:"pick",candidates:Y.slice(0,4)}):v(C,{status:"ready"})}).catch(()=>v(C,{status:"ready"})))},[v]),E=c.useCallback((C,O,_)=>{v(C,{descBusy:!0}),wo(n,O,_).then(I=>{if(I.quota){g(!0),v(C,{descBusy:!1,descDone:!0});return}const Y=I.blocs||{},G=(Y.synthese||Y.value_prop||Y.produit||Y.modele||"").trim();v(C,{descBusy:!1,descDone:!0,desc:G})}).catch(()=>v(C,{descBusy:!1,descDone:!0}))},[v,n]);c.useEffect(()=>{const C=i.findIndex(_=>_.auto&&_.name.trim()&&_.status==="");if(C>=0){N(C,i[C].name);return}if(s)return;const O=i.findIndex(_=>_.status==="ready"&&_.site&&!_.descDone&&!_.descBusy);O>=0&&E(O,i[O].name,i[O].site)},[i,N,E,s]);const[S,L]=c.useState(!1),q=c.useCallback(async(C,O)=>{v(C,{evalBusy:!0});const _=await ko(n,(O.site||O.name).trim(),"atelier2");return _.verdict==="quota"?(v(C,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:_.reason||"",remaining:0}})),!1):(v(C,{evalBusy:!1,status:_.verdict==="kept"?"kept":"out",reason:_.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:_.company||O.name,verdict:_.verdict,reason:_.reason||"",remaining:_.remaining??null}})),!0)},[v,n]),D=async()=>{if(S)return;const C=i.map((O,_)=>({r:O,i:_})).filter(({r:O})=>O.name.trim()&&O.status!=="kept"&&O.status!=="out"&&O.status!=="resolving");if(C.length){L(!0);for(const{r:O,i:_}of C)if(!await q(_,O))break;L(!1)}},B=c.useMemo(()=>{const C=new Set,O=[];return i.filter(_=>_.status==="kept").forEach(_=>{const I=_.name.trim().toLowerCase();I&&!C.has(I)&&(C.add(I),O.push(_.name.trim()))}),r.filter(_=>ze(_)>=1&&ze(_)<=4&&(_.website||_.domain)).forEach(_=>{const I=(_.name||"").trim().toLowerCase();I&&!C.has(I)&&(C.add(I),O.push((_.name||"").trim()))}),O},[i,r]),V=c.useMemo(()=>{const C=new Set;return r.forEach(O=>{const _=(O.name||"").trim().toLowerCase();_&&C.add(_)}),i.forEach(O=>{const _=O.name.trim().toLowerCase();_&&C.add(_)}),C},[r,i]),T=async()=>{if(u||!B.length)return;f(!1);const C=[];for(const O of B.slice(0,2)){b(O);const _=await jo(n,O);if(_){if(_.verdict==="quota"){w(!0);break}(_.results||[]).forEach(I=>{const Y=(I.company||"").trim().toLowerCase();!Y||V.has(Y)||C.some(G=>G.name.toLowerCase()===Y)||C.push({name:(I.company||"").trim(),verdict:I.verdict||"",reason:I.reason,from:O})})}}b(""),f(!0),x(O=>[...C,...O].slice(0,24))},F=async(C,O)=>{if(u)return;f(!1),b(C==="thesis"?e.pxThesis:O);const _=await us(n,C,O,6);if(b(""),f(!0),!_)return;if(_.verdict==="quota"){w(!0);return}const I=[];(_.results||[]).forEach(Y=>{const G=(Y.company||"").trim().toLowerCase();!G||V.has(G)||I.some(he=>he.name.toLowerCase()===G)||I.push({name:(Y.company||"").trim(),verdict:Y.verdict||"",reason:Y.reason,from:C==="thesis"?e.pxThesis:O})}),x(Y=>[...I,...Y].slice(0,24))},h=()=>{const C=y.trim();C.length<3||F(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(C)?"registry":"keyword",C)},A=C=>{d(O=>[...O,{name:C.name,site:"",status:"",auto:!0}].slice(0,30)),x(O=>O.filter(_=>_.name!==C.name))},M=i.filter(C=>C.name.trim()&&C.status!=="kept"&&C.status!=="out").length,H=C=>C.name.trim()&&C.status!=="kept"&&C.status!=="out"&&C.status!=="resolving"&&!C.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((C,O)=>t.jsxs("div",{className:"eq-row"+(C.status==="kept"?" r-kept":C.status==="out"?" r-out":""),children:[t.jsx("input",{value:C.name,placeholder:e.eqNamePh,onChange:_=>{const I=_.target.value.split(`
`).map(Y=>Y.trim()).filter(Boolean);I.length>1?d(Y=>{const G=[...Y];return G.splice(O,1,...I.map(he=>({name:he,site:"",status:"",auto:!0}))),G.slice(0,30)}):v(O,{name:_.target.value})},onBlur:()=>{C.name.trim()&&!C.site&&C.status!=="resolving"&&C.status!=="pick"&&N(O,C.name)},onKeyDown:_=>{_.key==="Enter"&&N(O,C.name)}}),t.jsxs("span",{className:"eq-site",children:[C.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),C.status==="pick"&&(C.candidates||[]).map(_=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>v(O,{site:_.url,status:"ready",candidates:void 0}),children:(_.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},_.url)),C.status!=="resolving"&&C.status!=="pick"&&(C.site?t.jsxs("a",{href:C.site.startsWith("http")?C.site:"https://"+C.site,target:"_blank",rel:"nofollow noopener",children:[C.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:C.name.trim()&&C.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:C.desc||"",children:C.descBusy?t.jsx("i",{children:e.eqDescBusy}):C.desc?C.desc:t.jsx("em",{children:C.descDone?s?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(C.status||"vide"),title:C.reason||"",children:C.status==="kept"?"✓ "+e.kept:C.status==="out"?"✗ "+e.dropped:C.status==="ready"?e.eqReady:C.status==="pick"?e.eqPick:""}),t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!H(C)||S,onClick:()=>{q(O,C)},children:[C.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>d(_=>_.filter((I,Y)=>Y!==O)),children:"×"})]},O)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>d(C=>[...C,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!u,onClick:()=>{F("thesis","")},children:u===e.pxThesis?e.sgBusy(u):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:y,placeholder:e.pxPlace,onChange:C=>j(C.target.value),onKeyDown:C=>{C.key==="Enter"&&h()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u||y.trim().length<3,onClick:h,children:e.pxGoFree}),!!B.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u,onClick:()=>{T()},children:u&&u!==e.pxThesis&&u!==y?e.sgBusy(u):e.sgGo}),!!B.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(B[0],B.length)}),m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),k&&!p.length&&!m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),p.map(C=>t.jsxs("span",{className:"eq-sc"+(C.verdict==="kept"?" ok":""),title:(C.reason||"")+" — "+e.sgVia(C.from),children:[t.jsx("b",{children:C.name}),C.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>A(C),children:"+"})]},C.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),i.some(C=>C.status==="kept"||C.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>d(C=>C.filter(O=>O.status!=="kept"&&O.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(S?" loading":""),style:{justifyContent:"center"},disabled:S||!M,onClick:()=>{D()},children:[t.jsx("span",{className:"fill"}),S?e.eqRunning:e.eqGo(M)]})]})]})]})}function ui(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function mi(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function to({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=Z();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(s=>s.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(s=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:s.name}),s.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),s.line1&&t.jsx("p",{className:"w",children:s.line1}),s.line2&&t.jsx("p",{className:"r",children:s.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(s.name),children:l.rsEvalOne})]},s.name))})]}):null}function $n({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=Z(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(to,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(to,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function ip({card:e,onEvaluate:a,onAddAll:r}){var l,s,g;const{t:n}=Z(),o=[e.industry,...e.market_tags||[],e.author].map(p=>(p||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(p=>p&&p.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(p=>t.jsx("span",{children:p},p))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ui(e.summary_md||"").map((p,x)=>t.jsx("p",{children:p},x))})]}),t.jsx($n,{card:e,onEvaluate:a,onAddAll:r}),(((s=e.prospective)==null?void 0:s.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(p=>t.jsx("li",{children:p},p))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(p=>t.jsx("a",{href:p.url,target:"_blank",rel:"noopener noreferrer",children:p.label||p.url},p.url))})]})]})}function sp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function lp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=Z(),l=o,[s,g]=c.useState(null),[p,x]=c.useState(null),[u,b]=c.useState(null),[m,w]=c.useState(!1);c.useEffect(()=>{let f=!0;return(async()=>{const y=await Eo({email:d,cbToken:l});f&&g(y)})(),()=>{f=!1}},[d,l,n]);const k=f=>{x(f),b(null),w(!0),(async()=>{const y=await ms(f.id);b(y),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[p?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),p&&t.jsx("span",{className:"ti",children:p.title}),!p&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!p&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(s||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>k(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[sp(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),p&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[p.source_url&&t.jsx("a",{href:p.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),p.published&&p.page_url&&t.jsx("a",{href:p.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(p.published?" on":""),children:p.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(ip,{card:u,onEvaluate:a,onAddAll:r})]})]})}const dp={deals:"ma-deals",news:"veille"};function ao(e){return(e.url||e.title||"").trim()}function pp({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,email:i,askEvaluate:d,canWrite:l}=Z(),[s,g]=c.useState(null),[p,x]=c.useState({deals:[],news:[]}),[u,b]=c.useState({deals:!1,news:!1}),[m,w]=c.useState(null),[k,f]=c.useState(""),[y,j]=c.useState(""),[v,N]=c.useState(null),E=c.useRef(!1),S=c.useCallback(async T=>{if(!o||u[T])return;w(T),f("");const F=await fs(dp[T],o,n);if(w(null),!F.ok&&F.error){f(F.error);return}x(h=>({...h,[T]:F.items})),b(h=>({...h,[T]:!0}))},[o,n,u]);c.useEffect(()=>{s&&S(s)},[s,S]);const L=c.useCallback(T=>p[T].map(ao).filter(Boolean),[p]),q=c.useMemo(()=>{var h,A;if(!o)return{deals:[],news:[]};const T={deals:L("deals"),news:L("news")},F=Lo("feed:"+o,T);return{deals:((h=F.deals)==null?void 0:h.noms)||[],news:((A=F.news)==null?void 0:A.noms)||[]}},[o,L]),D=c.useRef(null);c.useEffect(()=>{D.current&&!s&&o&&Ro("feed:"+o,{deals:L("deals"),news:L("news")}),D.current=s},[s,o,L]);const B=async T=>{const F=(T.url||"").trim();if(!F||!/^https?:\/\//i.test(F)||E.current)return;E.current=!0,j(F),N(null);const h=await No({url:F,email:i,cbToken:e});E.current=!1,j(""),N(h)},V=T=>{const F=p[T],h=new Set(q[T].map(A=>A.toLowerCase()));return t.jsxs("div",{className:"dfpane"+(s===T?" on":""),hidden:s!==T,children:[t.jsx("p",{className:"dfh",children:T==="deals"?r.feedDealsH:r.feedNewsH}),m===T&&t.jsx("p",{className:"dfload",children:n==="en"?"Loading…":"Chargement…"}),s===T&&!!k&&t.jsx("p",{className:"dferr",children:k}),u[T]&&!F.length&&!m&&t.jsx("p",{className:"dfempty",children:T==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!F.length&&t.jsx("ul",{className:"dflist",children:F.map((A,M)=>{const H=ao(A),C=h.has(H.toLowerCase()),O=(A.url||"").trim();return t.jsxs("li",{className:C?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:A.title||O}),t.jsx("span",{children:[A.source,A.sector_fr,(A.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[O&&t.jsx("a",{href:O,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),O&&/^https?:\/\//i.test(O)&&l&&t.jsx("button",{type:"button",className:"dfan",disabled:!!y,onClick:()=>{B(A)},children:y===O?"…":r.feedAnalyse})]})]},H||M)})})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(T=>{const F=q[T].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(T==="deals"?"ddeals":"dnews")+(s===T?" on":""),onClick:()=>g(s===T?null:T),children:[T==="deals"?r.feedDeals:r.feedNews,F>0&&t.jsx("em",{title:r.feedHint,children:r.feedNew(F)})]},T)}),s&&V(s),v&&t.jsxs("div",{className:"rscard dfrs",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:v.title}),t.jsx("button",{type:"button",className:"rsx",onClick:()=>N(null),children:"×"})]}),t.jsx($n,{card:v,onEvaluate:T=>d(null,T),onAddAll:a}),t.jsx("div",{className:"rsfoot",children:t.jsx("span",{children:r.rsFound(mi(v).length)})})]})]})}const Ca=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function na(e){return/^https?:\/\//i.test((e||"").trim())}function ct(e){const a=(e||"").trim();return a?na(a)?a:Ca.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function cp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function up(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:l,evalBusy:s,evalCards:g,caps:p,data:x,canWrite:u,source:b,dossiers:m,doAnalyse:w,liveMemos:k,pipe:f}=Z(),y=r==="client",j=c.useMemo(()=>n||(b!=="default"?hs():""),[n,b]),[v,N]=c.useState(""),[E,S]=c.useState(!1),[L,q]=c.useState(""),[D,B]=c.useState(""),[V,T]=c.useState(""),[F,h]=c.useState(!1),[A,M]=c.useState(!1),[H,C]=c.useState([]);c.useEffect(()=>{const P=oe=>{const ne=oe.detail;ne&&C(ue=>[ne,...ue].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[O,_]=c.useState(!1),[I,Y]=c.useState(!1),[G,he]=c.useState(!1),te=c.useRef(!1),[le,fe]=c.useState(""),[ge,be]=c.useState(""),[ve,ye]=c.useState(!1),[qe,ae]=c.useState(!1),[ke,$]=c.useState(0),[U,Q]=c.useState(""),[K,se]=c.useState(null),[de,re]=c.useState(null),[ce,pe]=c.useState(!1),[we,Ae]=c.useState(null),[Me,Ie]=c.useState(0),Ne=c.useRef(!1),Mt=v.trim()?Ca.test(v.trim())?e.evalUrl:e.evalName:e.evalWaiting;c.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),oe=(P.get("rs")||"").trim(),ne=(P.get("rstext")||"").trim();oe&&/^https?:\/\//i.test(oe)&&fe(oe),ne&&be(ne),(oe&&/^https?:\/\//i.test(oe)||ne)&&_(!0)},[]),c.useEffect(()=>{const P=oe=>{const ne=oe.detail||{},ue=String(ne.url||"").trim(),Ee=String(ne.text||"").trim();ue&&/^https?:\/\//i.test(ue)&&fe(ue),Ee&&be(Ee),(ue&&/^https?:\/\//i.test(ue)||Ee)&&(_(!0),N(""),q(""),ye(!0),window.setTimeout(()=>ye(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),c.useEffect(()=>{const P=oe=>{const ne=oe.detail||{},ue=String(ne.name||"").trim();if(!ue)return;_(!1),N(ue),q(ue);const Ee=ct(String(ne.website||ne.domain||""));B(Ee),T(ct(String(ne.url||""))),h(!Ee),S(!0),window.setTimeout(()=>S(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),c.useEffect(()=>{const P=(L||"").trim();if(!P||O||D){(D||!P||O)&&h(!1);return}const oe=m.find(Ee=>Ve(Ee.name)===Ve(P)),ne=ct((oe==null?void 0:oe.website)||"")||ct((oe==null?void 0:oe.domain)||"");if(ne){B(ne),h(!1);return}let ue=!0;return h(!0),On(P).then(Ee=>{var $e,Le;if(!ue)return;const xe=ct(Ee.website||"")||ct(((Le=($e=Ee.candidates)==null?void 0:$e[0])==null?void 0:Le.url)||"");xe&&B(xe)}).catch(()=>{}).finally(()=>{ue&&h(!1)}),()=>{ue=!1}},[L,O,D,m]),c.useEffect(()=>{const P=oe=>{var ue;const ne=String(((ue=oe.detail)==null?void 0:ue.url)||"").trim();na(ne)&&window.open(ne,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),c.useEffect(()=>{if(te.current===O)return;te.current=O,he(!0);const P=window.setTimeout(()=>he(!1),560);return()=>window.clearTimeout(P)},[O]),c.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),oe=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!oe)return;const ne=()=>oe.style.setProperty("--demand-h",`${P.offsetHeight}px`);ne();const ue=new ResizeObserver(ne);return ue.observe(P),()=>ue.disconnect()},[b,E,ve,A,O,G,F]),c.useEffect(()=>{if(!u&&!j){Ae(null);return}let P=!0;return(async()=>{const oe=await Eo({email:o,cbToken:j});P&&Ae(oe.length)})(),()=>{P=!1}},[u,j,o,Me]);const St=H.length?H:g,Pe=x.credits,st=c.useCallback(P=>{op(n,P)&&M(!0)},[n]);c.useEffect(()=>{if(!qe)return;$(0);const P=window.setInterval(()=>$(oe=>oe+1),1e3);return()=>window.clearInterval(P)},[qe]);const ft=c.useMemo(()=>{const P=v.trim().toLowerCase();return!P||!f?null:m.find(oe=>Ve(oe.name)===P&&ze(oe)===1)||null},[v,m,f]),Ct=()=>{const P=v.trim();if(P){if(ft){w(ft);return}i(null,P),y&&N("")}},at=async()=>{var ne,ue,Ee;if(Ne.current)return;const P=le.trim().replace(/\s+/g,""),oe=ge.trim();if(!P&&!oe){Q(e.rsNeed);return}if(!y&&!j){i(null,P||oe.slice(0,80));return}Ne.current=!0,Q(""),se(null),re(null),ae(!0);try{const xe=await No({url:P,text:oe,email:o,cbToken:j});if(ae(!1),!xe||xe.status!=="success"){Q((xe==null?void 0:xe.message)||"Erreur");return}se(xe),_(!1),st((((ne=xe.prospective)==null?void 0:ne.companies_to_evaluate)||[]).map(Le=>(Le==null?void 0:Le.name)||"")),re({state:"pending"});const $e=await xs(xe,{email:o,cbToken:j});re($e.ok?{state:"ok",scopeLabel:((ue=$e.summary)==null?void 0:ue.scope_label)||"",scope:((Ee=$e.summary)==null?void 0:Ee.scope)||""}:{state:"fail",msg:$e.error||""}),$e.ok&&Ie(Le=>Le+1)}finally{Ne.current=!1,ae(!1)}},zt=[K==null?void 0:K.industry,...(K==null?void 0:K.market_tags)||[],K==null?void 0:K.author].map(P=>(P||"").trim()).filter(Boolean),ht=(de==null?void 0:de.state)==="pending",Dt=de&&(ht?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):de.state==="ok"?t.jsx("span",{className:"rslink ok",children:de.scope&&de.scope!=="public"?e.rsSavedIn(de.scopeLabel||de.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:de.msg,children:e.rsSaveFail})),It=mi(K).length,_e=O,Xe=(L||v).trim(),Ye=m.find(P=>Ve(P.name)===Ve(Xe)),dt=ct(v)||D||ct((Ye==null?void 0:Ye.website)||"")||ct((Ye==null?void 0:Ye.domain)||""),R=V||ct((Ye==null?void 0:Ye.url)||""),X=ft?e.actAnalyse:Xe?e.evalGoOn(Xe.length>22?Xe.slice(0,21)+"…":Xe):e.evalGo,ee=qe?`${gs(le.trim())==="youtube"&&le.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ke)}`:ht?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(_e?" rs-mode":"")+(L&&v.trim()===L||E||ve?" pair":"")+(E||ve||G?" echo":"")+(G?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((_e?ve:E)||G?" flash":"")+((_e?le.trim():Ca.test(v.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:_e?le:v,placeholder:_e?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:_e?600:200,spellCheck:_e?!1:void 0,inputMode:_e?"url":void 0,onChange:P=>{if(_e){fe(P.target.value);return}N(P.target.value),L&&P.target.value.trim()!==L&&(q(""),B(""),T(""),h(!1))},onKeyDown:P=>{P.key==="Enter"&&(_e?at():Ct())}}),t.jsx("span",{className:"detect"+(_e?" off":"")+(Ca.test(v.trim())?" url":""),children:Mt})]}),t.jsx("span",{className:"dacts",children:_e?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(qe?" loading":""),disabled:qe||ht||!le.trim()&&!ge.trim(),onClick:()=>{at()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ee})]}),t.jsxs("a",{className:"viewbtn"+(na(le)?"":" off"),href:na(le)?le.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{na(le)||P.preventDefault()},children:[t.jsx(cp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ft?" analyse":"")+(s?" loading":""),disabled:s,onClick:Ct,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:X})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(F?" searching":dt?"":" off"),href:dt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{dt||P.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(R?"":" off"),href:R||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{R||P.preventDefault()},children:e.viewSrc})]})]})}),p.showCredits&&Pe&&t.jsxs("button",{type:"button",className:"credits"+(Pe.total_available<=0&&!Pe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Pe.unlimited?"∞":Pe.total_available}),!Pe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Pe.daily_grant+Pe.purchased]}),Pe.total_available<=0&&!Pe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{l({type:"ptab",tab:0}),M(!1),requestAnimationFrame(()=>{const P=document.querySelector(".atl2.cibles .desk-list");if(!P)return;const oe=window.scrollY+P.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,oe),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(O?" on":""),onClick:()=>_(!O),children:e.rsOpen}),we!==null&&we>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ce?" on":""),onClick:()=>pe(!ce),children:e.rsArchOpen(we)}),p.pipe&&!!n&&t.jsx(pp,{pageToken:j,onAddNames:st})]}),ce&&t.jsx(lp,{bump:Me,cbToken:j,onClose:()=>pe(!1),onEvaluate:P=>i(null,P),onAddAll:st}),t.jsx("div",{className:"rsp slim"+(O?" on":" off"),"aria-hidden":!O,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:O?void 0:-1,onClick:()=>Y(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:I?"▴":"▾"})]}),I&&t.jsx("textarea",{className:"rstext",value:ge,placeholder:e.rsTextPh,tabIndex:O?void 0:-1,onChange:P=>be(P.target.value)})]})}),U&&t.jsx("div",{className:"rserr",children:U}),K&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:K.title}),K.source_url&&t.jsx("a",{href:K.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{se(null),re(null)},children:"×"})]}),K.market&&t.jsx("p",{className:"rsmk",children:K.market}),zt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),zt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[K.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${K.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ui(K.summary_md||"").map((P,oe)=>t.jsx("p",{children:P},oe))})]}),t.jsx($n,{card:K,onEvaluate:P=>i(null,P),onAddAll:st}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(It)}),Dt]})]}),A&&t.jsx(ci,{}),St.slice(0,1).map((P,oe)=>{const ne=P.verdict==="kept",ue=P.verdict==="quota",Ee=P.verdict==="unresolved",xe=ne?"var(--brand)":ue?"var(--bolt)":Ee?"var(--blue)":"var(--red)",$e=ne?"var(--brand-l)":ue?"#FFF3D6":Ee?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":xe,"--bgc":$e},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ne?"✓ "+e.kept:ue?"⏳":Ee?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(Le=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Le.url.startsWith("http")?Le.url:`https://${Le.url}`,target:"_blank",rel:"nofollow noopener",children:[(Le.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Le.url,P.name),children:e.evalPickGo})]},Le.url))}),!ue&&!Ee&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:ne?1:5});const Le=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const gt=[...document.querySelectorAll(".atl2 .list .row")].find(Pt=>{var Ze;return(((Ze=Pt.querySelector(".rnm"))==null?void 0:Ze.textContent)||"").trim().toLowerCase().includes(Le)});gt&&(gt.scrollIntoView({behavior:"smooth",block:"center"}),gt.classList.add("flashrow"),window.setTimeout(()=>gt.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ne?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},oe)}),y&&(d.kept+d.dropped>0||St.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function mp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function fp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Z(),i=e.memoConsole?r.get(e.memoConsole):null,d=c.useMemo(()=>i?[i.reasoning||"",mp(i.summary||"")].filter(Boolean).join(`
...
`;function Ip(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:d,top:l}}function Pp(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:l,doAnalyse:s,doDecide:g,doPromote:p,doRepeche:x,doApproach:u,doDeep:b,doOnboard:m,outbound:w,evalBusy:k}=Z(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const y=Be(f),j=ze(f),v=Nt(f),N=ua(f),E=f.kind==="target",S=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Wt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Dp}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Ip(e.popupAnchor,!!f.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(wt(f.date)),tt(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[f.cc]}),children:(Gt(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>S({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>S({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Yt(f.amountEur,o)})]}),i.pipe&&E&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),v&&t.jsx("span",{className:"vd v-cons",title:n.vt[v],children:v}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Tt(f.engine)," ",t.jsx("b",{children:tt(f.engine,o)})," — ",vs(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Et,{o:f,lg:!0})," ",t.jsx(Va,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Co(y,o))," · ",n.win7(zo(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(ma,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&E&&v&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[v,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&E&&t.jsx(Hn,{o:f})]}),t.jsx(Un,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{s(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),$t(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),w&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:k,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function _p(){const{lang:e,token:a,dossiers:r,caps:n}=Z(),o=a||"home",{names:i,verdicts:d}=c.useMemo(()=>{const s=[],g={};return r.forEach(p=>{p.kind!=="target"||!p.name||(s.push(p.name),g[p.name]=ys(p)||"")}),{names:s,verdicts:g}},[r]);return{diff:c.useMemo(()=>i.length?ws(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function Bp(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:l}=Z(),[s,g]=c.useState(!1),[p,x]=c.useState(!1),u=c.useRef(null);c.useEffect(()=>{if(!s)return;const j=v=>{u.current&&!u.current.contains(v.target)&&g(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[s]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!d.length,w=c.useRef({});c.useEffect(()=>{w.current={...r}},[r]);const k=j=>{const v=w.current[j],N=v!==void 0?r[j]-v:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${ra[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j],j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[j],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},j)},f=(j,v,N)=>t.jsxs("button",{type:"button",className:"off"+(v?" view":""),"data-off":j,style:{"--c":`var(${ra[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:N}),t.jsx("span",{className:"n",children:r[j]})]},j),y=(j,v,N,E=!1)=>t.jsx("button",{type:"button",className:"tool",title:v,disabled:E,onClick:N,children:j},v);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(k)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[y("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(p?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":s,title:n.toolSort,onClick:()=>g(j=>!j),children:"⇅"}),s&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([j,v])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[v,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),y("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),y("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function $p(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,doAnalyse:l,mode:s}=Z(),g=c.useRef(null),[p,x]=c.useState(60);c.useEffect(()=>{let j=0;const v=()=>{var q;const N=g.current;if(!N)return;const E=(q=N.parentElement)==null?void 0:q.querySelector('.funnel [aria-selected="true"]');if(!E)return;const S=E.getBoundingClientRect(),L=N.getBoundingClientRect();x(Math.max(20,Math.min(S.left+S.width/2-L.left,L.width-30)))};return j=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(j),window.removeEventListener("resize",v)}},[e.ptab]);const u=e.ptab;let b=r.tuto[u].p;if(u===3){const j=i.filter(E=>E.kind==="target"&&ze(E)===3),v=j.filter(E=>mn(E)==="auto").length,N=j.filter(E=>mn(E)==="cd").length;b=r.tutoPending(v,N,j.length)}const m=(()=>{if(s!=="client")return null;if(u===0&&i.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:i.map(j=>j.id)})};if(u===1){const j=i.filter(v=>v.kind==="target"&&ze(v)===1&&!d.has(v.id)).slice(0,10);if(j.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:j.map(v=>v.id)})}}return null})(),w=ks(u),k=u===1||u===2,f=r.plabels[u]+" · "+(o[u]??0),y=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:g,className:"tuto mini"+(w?"":" on-dark")+(k?" etape-on":""),style:{"--bg":`var(${ra[u]})`,"--ax":p+"px","--stc":w?"var(--ink)":"#fff","--stt":w?"#fff":"var(--ink)","--tc":w?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:f}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label}),u!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:y})]})}const pn=600,jt=62,po="atl2:fstats";function Up(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Z(),[d,l]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(po)==="on"}catch{return!1}}),s=r.stats,g=c.useMemo(()=>((s==null?void 0:s.by_day)||[]).slice(-30),[s]),p=(s==null?void 0:s.since)||"";if(!n.showFunnel||!s||typeof s.screened!="number")return null;const x=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,u=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((N,E)=>Math.max(N,E.s||0),0),m=g.length?pn/g.length:0,w=Math.max(4,m-4),k=g.length>=5&&b>0,f=r.marketEstimate||0,y=x(new Date().toISOString().slice(0,10)),j=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof s.kept=="number"?[[s.kept,e.funKept]]:[],...typeof s.analyzed=="number"?[[s.analyzed,e.funAnalyzed]]:[],...typeof s.shown=="number"?[[s.shown,e.funShown]]:[]],v=[];return typeof s.screened_window=="number"&&p&&v.push({cle:"fenetre",periode:e.funPerWindow(x(p),y),etapes:[[s.screened_window,e.funScreened("","")]]}),typeof s.screened=="number"&&v.push({cle:"total",periode:e.funPerAll,etapes:j(s.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[v.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([E,S],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(E)}),t.jsx("i",{children:S})]},N.cle+S)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((s.screened||0)/f*100)))})]}),N.cle==="total"&&(s.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),N.cle===v[v.length-1].cle&&k&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const E=!d;l(E),E&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(po,E?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},N.cle)),d&&k&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${pn} ${jt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((N,E)=>{const S=(N.s||0)/b*(jt-4),L=(N.m||0)/b*(jt-4),q=E*m+(m-w)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===N.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===N.d?{day:"",win:"all"}:{day:N.d,win:"all"}}),onKeyDown:D=>{D.key!=="Enter"&&D.key!==" "||(D.preventDefault(),i({type:"filters",patch:o.filters.day===N.d?{day:"",win:"all"}:{day:N.d,win:"all"}}))},children:[t.jsx("title",{children:`${x(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:q-1,y:0,width:w+2,height:jt,fill:"transparent"}),t.jsx("rect",{x:q,y:jt-2-S,width:w,height:S,fill:"#cfe0d6"}),t.jsx("rect",{x:q,y:jt-2-L,width:w,height:L,fill:"#0E7F3F"})]},N.d)}),t.jsx("line",{x1:0,y1:jt-1.5,x2:pn,y2:jt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const xi={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Vn({o:e,locked:a=!1}){const{t:r}=Z(),n=ua(e),o=Nt(e),i=ze(e),d=mn(e),l=js(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(xi[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(Xl,{o:e})]})}const Vt=e=>e.length>22?e.slice(0,21)+"…":e;function ca(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function bi(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Hp({on:e,rev:a}){const[r,n]=c.useState(null),[o,i]=c.useState({top:0,left:0,width:0});return c.useEffect(()=>{if(!e){n(null);return}const d=()=>{var m,w,k;const l=document.querySelector(".atl2.ops .desk-list"),s=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const g=l.getBoundingClientRect(),p=s?s.getBoundingClientRect().bottom:g.top;i({top:Math.round(p),left:Math.round(g.left),width:Math.round(g.width)});const x=[...l.querySelectorAll(":scope .grp")];let u=null;for(const f of x){const y=f.querySelector(".grp-h");y&&y.getBoundingClientRect().bottom<=p+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((w=b.querySelector(".t"))==null?void 0:w.textContent)||"").trim(),s:(((k=b.querySelector(".s"))==null?void 0:k.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Vp(e){const r=()=>{const n=bi(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function co({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Z(),[i,d]=c.useState(!1);if(c.useEffect(()=>{n||d(!1)},[n]),Ge(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const s=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(s?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Vt(e.name))})]})}function Wn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:d,doPromote:l,doRepeche:s,doApproach:g,dispatch:p,liveMemos:x}=Z(),u=m=>w=>{w.stopPropagation(),m()};if(r.lockActions){const m=u(()=>p({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const w=ze(e);return w===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Vt(e.name))})]})}):w===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):w===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):w===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):w===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):w===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ca(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Ra(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ca(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(co,{o:e})});const b=ze(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(co,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ta,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const w=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:w,onClick:u(()=>i(e)),children:w?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>d(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>d(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const m=o.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>g(e)),children:m?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:u(()=>p({type:"modal",modal:"plug"})),children:a.actConn}),t.jsx("button",{type:"button",className:"lk sm dsrow",title:a.dsBtn,onClick:u(()=>p({type:"dossierOpen",id:e.id})),children:a.dsBtn})]})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>p({type:"focus",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Wp({o:e}){const{t:a,doThumb:r,thumbOf:n}=Z(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Gp({o:e}){const{lang:a}=Z();return Be(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Et,{o:e}),t.jsx(Va,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Tt(e.engine||"")," ",tt(e.engine||"",a)]})})}function Yp({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:l}){const{dispatch:s,caps:g,markRow:p,markedId:x,favIds:u,toggleFav:b,t:m}=Z(),w=ze(e),k=["#16233A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,y=f<=0?0:f<=7?1:f<=30?2:3,j=g.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][w]:k[y],v=u.has(e.id),N=E=>{if(a)return;if(d){d(e.id);return}if(g.pipe||e.kind==="op"){n();return}const S=E.currentTarget.getBoundingClientRect();s({type:"popup",id:e.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return t.jsxs(c.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+w:"")+(v?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>p(e.id),onMouseLeave:()=>p(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(Ei,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${m.cdEngagement} ${Math.round(e.engagement*10)/10} · ${m.cdEngagementHint}`,children:"🔥"}),Be(e)&&t.jsx(Et,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:v?1:.35,padding:0,marginRight:4},onClick:E=>{E.stopPropagation(),b(e)},children:v?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Je(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(E=>E&&E!==e.name)||""]}),g.pipe&&!g.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:E=>E.stopPropagation(),children:[e.website&&t.jsx("a",{href:pa(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowSite,title:m.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:pa(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowLi,title:m.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":m.rowMail,title:m.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":m.rowTel,title:m.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:E=>{E.stopPropagation(),s({type:"acquirer",value:e.acquirer||""})},children:["← ",Vt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(Qp,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Gp,{o:e}),g.pipe&&t.jsx(Vn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Wn,{o:e}),g.showThumbs&&t.jsx(Wp,{o:e})]}),r&&!a&&!d&&t.jsx(Xp,{o:e})]})}function Qp({o:e}){const{lang:a,caps:r}=Z();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Yt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Kp({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Z(),d=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),s=Yt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),p=Ge(e),x=p&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),s&&t.jsx("span",{className:"oc-amt",children:s}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[p?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Je(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),ca(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Vt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ma,{spec:e.card})})]})}function Jp({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Z();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[tt(e.engine||"",r),i?` · ${i}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Wn,{o:e})})]}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx(Hn,{o:e})]})}function vi({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:l,dossiers:s}=Z(),g=c.useRef(null),p=We(e);if(c.useEffect(()=>{if(!p||!(e!=null&&e.decryptHtml))return;const h=g.current;if(!h)return;let A=!1;return cn(()=>import("./fit-BnaWm7z_.js"),[]).then(async M=>{await M.ensureEditoCss(),!(A||!h.isConnected)&&(M.beautifyEditoRows(h),M.mountCardFits(h))}),()=>{A=!0}},[p,e==null?void 0:e.decryptHtml]),!e&&!a){const h=s.find(We);if(h)return t.jsx(vi,{o:h})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),w=e?!!e.noCo:!x||La(x),k=(e==null?void 0:e.engine)||"",f=We(e),y=e?Yt(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),v=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),N=s.find(We),E=((N==null?void 0:N.url)||"").trim(),S=!!u&&!!E&&(u===E||u.endsWith(E)||E.endsWith(u)),L=(h,A=!1)=>M=>{M.stopPropagation(),A&&d({type:"continent",key:"monde"}),d({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const q=()=>{x&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:x}}))},D=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},B=()=>{ca({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},V=e?Ge(e):!1,T=V&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",F=f?r.doEdito.replace(/^📖\s*/,""):k?tt(k,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[F,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(w||Ra({engine:k}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,v?t.jsx("em",{children:v}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(ma,{spec:m})}),(u&&!S&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!S&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,v?` · ${v}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),d({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[V?t.jsxs("span",{className:"verdict",style:{"--c":T?"var(--brand)":"var(--red)"},children:[T?"✓":"✗"," ",t.jsx("b",{children:T?r.kept:r.dropped})]}):!w&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:h=>{h.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Vt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(w||Ra({engine:k}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!w&&x?" ghost":""),onClick:h=>{h.stopPropagation(),B()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!w&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),q()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Vt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!w&&x&&l.pipe&&t.jsx(Un,{name:x})]})]})}function Xp({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=Z();return!o.pipe&&e.kind==="op"?t.jsx(Kp,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Hn,{o:e}),t.jsx(Zl,{o:e}),t.jsx(td,{o:e}),t.jsx(Un,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Vn,{o:e})})]}),e.card&&t.jsx(ma,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Tt(e.engine||"")," ",tt(e.engine||"",r)]}),Be(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Et,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function Zp({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:l,lang:s}=Z();if(!d.pipe&&e.kind==="op"){const x=Yt(e.amountEur,s),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,w=!1)=>k=>{k.stopPropagation(),w&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ma,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Tt(e.engine||"")," ",tt(e.engine||"",s)]}),Be(e)&&t.jsx(Et,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Wn,{o:e})})]})}const g=ze(e),p=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":p},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Vn,{o:e}),Be(e)&&t.jsx(Et,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"focus",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function ec(){const{t:e}=Z(),[a,r]=c.useState(0);return c.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function tc({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Z(),i=o==="en",d=p=>n.plabels[p]||"",l=[0,1,2,3,4,5,6,7].filter(p=>p!==a.ptab&&(e[p]||0)>0),s=l.includes(0)?0:l.sort((p,x)=>(e[x]||0)-(e[p]||0))[0];if(s===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[s]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:s===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${d(s)}”`:`${g} dossier${g>1?"s":""} dans « ${d(s)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:s}),children:[(i?"Open ":"Ouvrir ")+d(s)," →"]})]})}function ac(){var It,_e,Xe,Ye,dt;const e=Z(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:l,markRow:s,lang:g,sessTally:p,data:x,dossiers:u,source:b,focusExtra:m,byId:w,token:k}=e,f=Mo(),y=c.useMemo(()=>{var ee,P,oe,ne;if(!k||b==="ops")return null;const R=(((ee=f==null?void 0:f.ed)==null?void 0:ee.date)||(f==null?void 0:f.day)||"").slice(0,10),X=[(P=f==null?void 0:f.ed)==null?void 0:P.html,(oe=f==null?void 0:f.ed)==null?void 0:oe.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((ne=f==null?void 0:f.ed)==null?void 0:ne.date)||R,decryptHtml:X||void 0,date:R,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[k,b,g,(It=f==null?void 0:f.ed)==null?void 0:It.html,(_e=f==null?void 0:f.ed)==null?void 0:_e.acquirers_html,(Xe=f==null?void 0:f.ed)==null?void 0:Xe.date,f==null?void 0:f.day]),j=R=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Oo,[v,N]=c.useState(new Set);c.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[E,S]=c.useState(null);c.useEffect(()=>{S(null)},[a.ptab,a.continent]);const[L,q]=c.useState(!a.mapFolded);c.useEffect(()=>{if(a.mapFolded){q(!1);return}const R=document.getElementById("atl2-stage");if(!R){q(!1);return}const X=new IntersectionObserver(([ee])=>q(!!ee&&ee.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return X.observe(R),()=>X.disconnect()},[a.mapFolded]);const D=a.mapFolded||!L,B=R=>N(X=>{const ee=new Set(X);return ee.has(R)?ee.delete(R):ee.add(R),ee}),V=b==="ops"||o.pipe,[T,F]=c.useState("all"),[h,A]=c.useState(!1),[M,H]=c.useState(null),[C,O]=c.useState(!1),_=c.useRef(!0);c.useEffect(()=>{if(_.current){_.current=!1;return}F("all"),O(!1)},[a.ptab,a.continent]),c.useEffect(()=>{if(!C)return;const R=X=>{var ee,P;(P=(ee=X.target)==null?void 0:ee.closest)!=null&&P.call(ee,".atl2 .doable")||O(!1)};return document.addEventListener("click",R,!0),()=>document.removeEventListener("click",R,!0)},[C]);const I=c.useMemo(()=>{var X;const R=new Map;for(const ee of Il(((X=f==null?void 0:f.ed)==null?void 0:X.html)||""))R.has(ee.t)||R.set(ee.t,ee.html);return R},[(Ye=f==null?void 0:f.ed)==null?void 0:Ye.html]),Y=c.useCallback(R=>{if(R.decryptHtml)return R.decryptHtml;if(!I.size)return;const X=(R.name||"").trim().toLowerCase();if(X.length<3)return;const ee=I.get(X);if(ee)return ee;for(const[P,oe]of I)if(P.includes(X)||X.includes(P))return oe},[I]),{diff:G}=_p(),[he,te]=c.useState(!1),le=a.filters.win==="1"&&!a.filters.day,[fe,ge]=c.useState(!1),be=c.useMemo(()=>new Set(((G==null?void 0:G.added)||[]).map(R=>R.trim().toLowerCase()).filter(Boolean)),[G]),ve=c.useMemo(()=>{if(!be.size)return 0;const R={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(X=>!We(X)&&be.has((X.name||"").trim().toLowerCase())&&oa(X,R,o.pipe)).length},[u,be,a,o.pipe]);c.useEffect(()=>{const R=()=>{ge(!1),A(!1),F("all"),O(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",R),()=>window.removeEventListener("ppmap:tunnel",R)},[]),c.useEffect(()=>{ge(!1),A(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const ye=c.useMemo(()=>{const R=l.filter(ee=>!We(ee)&&Je(ee));let X="";for(const ee of R){const P=(ee.date||"").slice(0,10);P&&(!X||P<X)&&(X=P)}return{n:R.length,since:X?X.split("-").reverse().slice(0,2).join("/"):""}},[l]),qe=ye.n,ae=c.useMemo(()=>{const X=fe&&be.size>0||a.filters.signalOnly||T!=="all"||h?l:d;let ee=Dn(X,a.sort);return ee=ee.filter(P=>!We(P)),fe&&be.size&&(ee=ee.filter(P=>be.has((P.name||"").trim().toLowerCase()))),h||T==="explore"?ee=ee.filter(Je):T==="eval"?ee=ee.filter(P=>!Je(P)&&!P.noCo&&(P.kind==="op"||!Ge(P))):o.pipe&&(ee=ee.filter(P=>!Je(P))),ee},[d,l,a.sort,T,fe,be,h,o.pipe]),$=c.useMemo(()=>o.pipe?u.filter(R=>R.kind==="target"&&!We(R)&&Be(R)&&(a.continent==="monde"||R.continent===a.continent)):ae.filter(R=>Be(R)&&!Ge(R)),[o.pipe,u,ae,a.continent]).length,U=c.useMemo(()=>o.pipe?ae:ae.filter(R=>!Ge(R)&&!R.noCo&&!Je(R)),[ae,o.pipe]),Q=b==="ops"?ae.filter(Je).length:0,K=fe?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,se=a.filters,de=se.sector.length+se.market.length+se.country.length+se.engine.length+se.stage.length+se.crible.length+se.angle.length+se.memoLevel.length+se.dealKind.length+(se.signalOnly?1:0)+(se.acquirer.trim()?1:0)+(se.search.trim()?1:0),re=[];if(se.day)re.push({k:"day",lib:n.fDay(se.day.slice(8,10)+"/"+se.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(se.win&&se.win!=="all"){const R=["1","7","30"].indexOf(se.win);R>=0&&re.push({k:"win",lib:n.dates[R],off:()=>r({type:"filters",patch:{win:"all"}})})}const ce=R=>R.length<=2?R.join(", "):`${R.length} ${n.fSelected}`;for(const R of["sector","market","country","engine","crible"]){const X=se[R];X&&X.length&&re.push({k:R,lib:ce(X),off:()=>r({type:"clearFacet",facet:R})})}se.search&&re.push({k:"search",lib:"🔍 "+se.search,off:()=>r({type:"filters",patch:{search:""}})}),fe&&be.size&&re.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>ge(!1)}),se.signalOnly&&re.push({k:"sig",lib:"🔴 "+n.sigDock($||se.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const pe=(R,X,ee="",P=!1)=>t.jsxs("button",{type:"button","data-s":R,className:ee,"aria-sort":a.sort.key===R?a.sort.dir===1?"ascending":"descending":"none",style:P?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:R}),children:[X,t.jsx("span",{className:"ar",children:a.sort.key===R&&a.sort.dir===1?"▴":"▾"})]},R),we=c.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const R=new Map;ae.forEach(P=>{const oe=P.engine||"?";R.has(oe)||R.set(oe,[]),R.get(oe).push(P)});const X={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},ee=un([...R.keys()],g);return[...R.entries()].sort((P,oe)=>{const ne=X[P[0]]??10+ee.indexOf(P[0]),ue=X[oe[0]]??10+ee.indexOf(oe[0]);return ne-ue})},[ae,o.pipe,a.groupBy,g]),Ae=we?we.filter(([R])=>Na.has(R)).length:0,Me=(()=>{var X;return((X=(we?we.flatMap(([,ee])=>ee):ae)[0])==null?void 0:X.id)??null})(),Ie=c.useRef(!1),Ne=c.useMemo(()=>u.find(We)||y,[u,y]),[Mt,St]=c.useState(!1);c.useEffect(()=>{const R=()=>{Ie.current=!0,ge(!1)};return window.addEventListener("ppmap:reveal",R),window.addEventListener("ppmap:focus",R),()=>{window.removeEventListener("ppmap:reveal",R),window.removeEventListener("ppmap:focus",R)}},[]),c.useEffect(()=>{const R=()=>{Ne&&r({type:"focus",id:Ne.id})};return window.addEventListener("ppmap:edito",R),()=>window.removeEventListener("ppmap:edito",R)},[Ne,r]),c.useEffect(()=>{if(!a.focusId)return;H(a.focusId);const R=window.setTimeout(()=>H(null),900);return()=>window.clearTimeout(R)},[a.focusId]),c.useEffect(()=>{if(V&&!(a.focusId&&(ae.some(R=>R.id===a.focusId)||u.some(R=>R.id===a.focusId)||a.focusId===(Ne==null?void 0:Ne.id)))&&!m){if(Ne){r({type:"focus",id:Ne.id});return}Me&&r({type:"focus",id:Me})}},[V,a.focusId,ae,Me,m,r,u,b,Ne]),c.useEffect(()=>{if(!V||!a.focusId||Ne&&a.focusId===Ne.id||ae.some(X=>X.id===a.focusId))return;const R=u.find(X=>X.id===a.focusId);if(R){if(Ie.current){R.kind==="op"?F(Je(R)?"explore":"eval"):T!=="all"&&F("all");return}T!=="all"&&Me&&r({type:"focus",id:Me})}},[V,a.focusId,T,ae,u,Me,r,Ne]),c.useEffect(()=>{if(!V||!a.focusId||!Ie.current)return;const R=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!R){const oe=ae.findIndex(ne=>ne.id===a.focusId);if(oe>=0){const ne=we?"":"pt"+a.ptab;if(ne){const ue=a.shown[ne]||j();oe>=ue&&r({type:"more",group:ne,by:oe-ue+8})}}return}Ie.current=!1;const X=bi(),ee=R.getBoundingClientRect();ee.top>=X-2&&ee.bottom<=window.innerHeight-4||Vp(R)},[V,a.focusId,a.ptab,ae,a.shown,we,r]),c.useEffect(()=>{if(typeof window>"u")return;const R=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),X=document.querySelector(".atl2.ops, .atl2.cibles");if(!R||!X)return;const ee=()=>X.style.setProperty("--listhead-h",`${R.offsetHeight}px`);ee();const P=new ResizeObserver(ee);return P.observe(R),()=>P.disconnect()},[D,a.dens,a.mapFolded]);const Pe=c.useMemo(()=>{if(!V||!a.focusId)return null;if(y&&a.focusId===y.id)return y;const R=ae.find(ee=>ee.id===a.focusId)||u.find(ee=>ee.id===a.focusId)||null;if(!R)return null;const X=Y(R);return X&&X!==R.decryptHtml?{...R,decryptHtml:X}:R},[V,a.focusId,ae,u,Y,y]),st=o.lockRowsAfter;let ft=0;const Ct=(R,X)=>{let ee=a.shown[X]||j();return R.length-ee<=4&&(ee=R.length),R.slice(0,ee).map(ne=>{const ue=st!==null&&ft>=st;ft++;const Ee=Y(ne),xe=Ee&&Ee!==ne.decryptHtml?{...ne,decryptHtml:Ee}:ne,$e=!V&&a.dens!=="maxi"&&(a.dens==="deplie"||(E?E==="open":!!Ee)),Le=v.has(ne.id)?!$e:$e,gt=V?Pt=>{Ie.current=!0,r({type:"focus",id:Pt});const Ze=w.get(Pt);Ze&&(Je(Ze)?ca(Ze):Ze.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ze.name,url:Ze.url||"",website:Ze.website||"",domain:Ze.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Zp,{o:xe,locked:ue,selected:V&&a.focusId===ne.id,onSelect:gt},ne.id):t.jsx(Yp,{o:xe,locked:ue,open:Le,onToggle:()=>B(ne.id),selected:V&&a.focusId===ne.id,echo:M===ne.id,fresh:be.has((ne.name||"").trim().toLowerCase()),onSelect:gt},ne.id)})},at="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ae.length?"":" list-empty"),zt=t.jsxs(t.Fragment,{children:[we?we.map(([R,X])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Tt(R)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:R==="ma"?n.grpMa:R==="fundraising"?n.grpLev:Na.has(R)&&Ae<=1?n.grpNews:R==="nominations"?n.grpNom:R==="media"?n.grpNewsOther:R==="recrutements"?n.grpHire:Na.has(R)?n.grpNews+" · "+tt(R,g):tt(R,g)}),t.jsx("div",{className:"s",children:n.grpCount(X.filter(ee=>!Ge(ee)).length,X.length)})]})]}),Ct(X,R)]},R)):Ct(ae,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(ec,{}),o.pipe&&a.ptab===0&&!h&&!fe&&T==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(ci,{}),!ae.length&&!(x.loading&&!u.length)&&(o.pipe&&T==="all"?t.jsx(tc,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(se.win!=="all"||!!se.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),de>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(de)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),ht=t.jsxs(t.Fragment,{children:[!fe&&!h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ra[a.ptab]+")"},children:ae.length})," ",K]}),h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ra[a.ptab]+")"},children:ae.length})," ",n.newsWord]}),(!fe||h)&&t.jsx("span",{className:"dot",children:"·"}),D&&t.jsx(di,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[D?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),re.map(R=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:X=>{X.stopPropagation(),R.off()},children:[R.lib,t.jsx("i",{children:"×"})]},R.k)),b==="ops"&&ae.length>0&&!D&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ae.length-Q," ",n.zoomPulseEval,Q>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",Q," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),Dt=t.jsxs("div",{className:"listhead"+(D?" mapoff":""),children:[D&&t.jsx("div",{className:"lh-tools",children:t.jsx(li,{compact:!0})}),o.showFunnel&&he&&le&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(nd,{}),t.jsx(Up,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:ht}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Bp,{}),t.jsx($p,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(le?" on":""),"aria-pressed":le,title:n.morningDockTitle,onClick:()=>{if(le){r({type:"filters",patch:{win:"all",day:""}}),te(!1);return}ge(!1),A(!1),F("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),te(!0)},children:["📊 ",n.morningDock(typeof((dt=x.stats)==null?void 0:dt.screened_today)=="number"?x.stats.screened_today:0)]}),G&&!G.firstVisit&&(G.added.length>0||G.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(fe?" on":""),"aria-pressed":fe,title:n.sinceSub,onClick:()=>{const R=!fe;ge(R),A(!1),te(!1),F("all"),R&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(ve),G!=null&&G.lastDate?` · ${n.sinceSince(G.lastDate)}`:""]}),$>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{ge(!1),A(!1),te(!1),F("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock($)]}),o.pipe&&qe>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(h?" on":""),"aria-pressed":h,title:n.newsDockHint,onClick:()=>{const R=!h;A(R),ge(!1),te(!1),F("all"),R&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(qe),ye.since?` · ${n.newsSince(ye.since)}`:""]})]}),!o.showFunnel&&ht,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([R,X])=>t.jsxs("button",{type:"button","data-d":R,"aria-pressed":a.dens===R||R==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:R}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:X})]},R))}),!V&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":E==="open",onClick:()=>{S("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":E==="closed",onClick:()=>{S("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var Ee;const R={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},X=u.filter(xe=>oa(xe,R,o.pipe)&&!We(xe)),ee=X.filter(xe=>!Je(xe)&&!xe.noCo&&(xe.kind==="op"||!Ge(xe))).length,P=X.filter(Je).length,oe=o.pipe?X.filter(xe=>xe.kind!=="op"&&ze(xe)===1).length:0,ne=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${oe?` ${oe}`:""}`]]:[],["eval",`${n.doEval}${ee?` ${ee}`:""}`],["explore",`${n.doExplore}${P?` ${P}`:""}`]],ue=((Ee=ne.find(([xe])=>xe===T))==null?void 0:Ee[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":C,onClick:()=>O(xe=>!xe),children:[ue,t.jsx("i",{children:"▾"})]}),C&&t.jsx("div",{className:"dolist",children:ne.map(([xe,$e])=>t.jsx("button",{type:"button","aria-pressed":T===xe,onClick:()=>{if(O(!1),xe==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}F(xe),xe!=="all"&&(ge(!1),A(!1),te(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:$e},xe))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:R=>r({type:"sort",key:R.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([R,X])=>t.jsx("option",{value:R,children:X},R))})]}),o.showChain&&U.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:U.map(R=>R.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(U.length):n.chainAll(U.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!V&&Dt,a.dens!=="maxi"&&!V&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),pe("country",n.colCountry),pe("name",n.colCompany),pe("amount",n.colAmount,"h-amt",!0),pe("stage",n.colStage,"h-stade"),pe("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[pe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),pe("memo",n.colMemo)]}),o.pipe&&pe("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),V?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[Dt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),pe("country",n.colCountry),pe("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[pe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),pe("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:at,children:zt})]}),t.jsxs("aside",{className:"readpane"+((Pe?We(Pe):!m&&Ne)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[Ne&&(()=>{const R=a.focusId===Ne.id&&!Mt,X=(Ne.headline||Ne.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":R,onClick:()=>{if(R){St(!0);return}St(!1),r({type:"focus",id:Ne.id})},children:[t.jsx("span",{className:"eg-t",children:g==="en"?"Today’s editorial":"Édito du jour"}),X&&t.jsx("span",{className:"eg-sub",children:X}),t.jsx("span",{className:"eg-chev",children:R?g==="en"?"Collapse ▴":"Replier ▴":g==="en"?"Read ▾":"Lire ▾"})]})})(),y&&a.focusId===y.id&&Mt?null:y&&a.focusId===y.id?t.jsx("div",{className:"zoom",children:t.jsx(Ul,{})}):Pe&&o.pipe?t.jsx(Jp,{o:Pe}):t.jsx(vi,{o:Pe,extra:Pe?null:m})]})]}):t.jsx("div",{className:at,children:zt}),(()=>{const R=we||[["pt"+a.ptab,ae]];let X=0,ee=0;for(const[oe,ne]of R){ee+=ne.length;let ue=a.shown[oe]||j();ne.length-ue<=4&&(ue=ne.length),X+=Math.min(ne.length,ue)}const P=ee-X;return P<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>R.forEach(([oe,ne])=>r({type:"more",group:oe,by:ne.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(P,P)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(X,ee)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}}),V&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Hp,{on:!!we,rev:(we||[]).map(([R,X])=>R+X.length).join("|")})]})}function uo(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function nc(e,a){const r=Es(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function rc(e,a){const n=[a.head.split("|").map(uo).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",nc(o,a.plabels),ua(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(uo).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function oc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const ic=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Qe({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function Jt({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function sc({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=Z(),d=(e.cribleStatus||"").trim().toUpperCase()||(ua(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Nt(e),s=(a==null?void 0:a.blocs)||{},g=[[n.qaVP,s.value_prop],[n.qaProduct,s.produit],[n.qaModel,s.modele],[n.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Qe,{k:n.cdSector,v:e.sector}),t.jsx(Qe,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(Qe,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(Qe,{k:n.cdStage,v:e.stage}),t.jsx(Qe,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Qe,{k:n.cdSite,v:e.domain||e.website}),t.jsx(Qe,{k:n.cdName,v:e.contactName}),t.jsx(Qe,{k:n.cdEmail,v:e.contactEmail}),t.jsx(Qe,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Qe,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Qe,{k:n.cdAngle,v:e.angle}),t.jsx(Qe,{k:n.cdDetected,v:ic(e.date,o)})]}),!!(e.provQuery||e.provUrl||qa(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(Qe,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(Qe,{k:n.cdSrc,v:Tn(e.provUrl||""),href:pa(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(Qe,{k:n.cdAngleSrc,v:qa(e)})]})]}),g.some(([,p])=>p)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),g.filter(([,p])=>p).map(([p,x])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:p}),t.jsx("p",{children:x})]},p))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([p,x,u])=>t.jsxs("div",{className:"dssq "+p,children:[t.jsx("b",{children:x}),t.jsx("ul",{children:u.map(b=>t.jsx("li",{children:b},b))})]},p))})]}),t.jsx(Jt,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function lc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d,st:l}=Z(),[s,g]=c.useState({}),[p,x]=c.useState({}),u=25,b=12,m=c.useMemo(()=>{if(l.dossierId){const f=n.find(y=>y.id===l.dossierId)||i.dossiers.find(y=>y.id===l.dossierId);return f?[f]:n.slice(0,u)}return n.slice(0,u)},[n,l.dossierId,i.dossiers]);c.useEffect(()=>{m.length&&So(r,m.map(f=>f.name)).then(g)},[r,m]),c.useEffect(()=>{const f=m.filter(v=>!!v.memoUrl).slice(0,b);if(!f.length){x({});return}let y=!1;const j={};return(async()=>{for(const v of f){if(y)return;try{const N=await gi(v.memoUrl||"");if(y)return;N&&Cp(N.comite)&&(j[v.id]=N.comite,x({...j}))}catch{}}})(),()=>{y=!0}},[m]);const w=i.stats,k=f=>f.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(m.length)}),!l.dossierId&&n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),w&&typeof w.screened=="number"&&t.jsxs("p",{children:[k(w.screened)," ",e.funScreened(""),typeof w.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",k(w.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(k(i.marketEstimate)),", ",Math.round(w.screened/i.marketEstimate*100)," %"]})]})]}),m.map(f=>t.jsx(sc,{o:f,qa:s[f.name],comite:p[f.id]},f.id)),!m.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const dc=50;function Gn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Z(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(""),[x,u]=c.useState(0),[b,m]=c.useState(""),[w,k]=c.useState(!1),[f,y]=c.useState(0),j=c.useRef(null),v=c.useRef(null),N=()=>{y(0),v.current&&window.clearInterval(v.current),v.current=window.setInterval(()=>y(q=>q+1),1e3)},E=()=>{v.current&&(window.clearInterval(v.current),v.current=null)};c.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),v.current&&window.clearInterval(v.current)},[]);const S=async q=>{s(!0),p(""),N();const D=await a();if(s(!1),E(),D.ok){d(D);return}if(D.busy){p(o.alertPreviewBusy);return}if(!q){p(o.alertPreviewFail);return}u(dc),E(),j.current=window.setInterval(()=>{u(B=>B>1?B-1:(j.current&&window.clearInterval(j.current),S(!1),0))},1e3)},L=async()=>{if(n||w||l)return;k(!0),m(""),N();const q=await r();k(!1),E(),m(q.ok?o.alertTestOk(q.sentTo||""):q.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||w||x>0,onClick:()=>{S(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||w||l,onClick:()=>{L()},children:w?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),w&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const yt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ke({title:e,icon:a,children:r,wide:n,kind:o,lead:i}){const{dispatch:d}=Z(),l=o==="plug"?"min(720px,100%)":"min(760px,100%)";return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:s=>{s.target===s.currentTarget&&d({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard"+(o?" m-"+o:""),style:n?{width:l}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsxs("div",{className:"mh-txt",children:[t.jsx("h2",{children:e}),i&&t.jsx("p",{className:"mh-lead",children:i})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>d({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function pc(){const{st:e}=Z();switch(e.modal){case"chain":return t.jsx(uc,{});case"space":return t.jsx(mc,{});case"alert":return t.jsx(fc,{});case"queue":return t.jsx(vc,{});case"export":return t.jsx(yc,{});case"plug":return t.jsx(jc,{});case"approach":return t.jsx(Ec,{});case"recharge":return t.jsx(Cc,{});case"cover":return t.jsx(Ac,{});case"dossier":return t.jsx(zc,{});case"crit":return t.jsx(Rc,{});case"tuto":return t.jsx(Fc,{});case"rdv":return t.jsx(cc,{});case"memoalert":return t.jsx(wc,{});default:return null}}function cc(){const{dispatch:e,fund:a,t:r}=Z(),n=a||r.rdvCoFallback;return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:_o,children:Pn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Xs,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function uc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:l,caps:s,memoQueued:g,doAnalyse:p}=Z(),x=i==="client",u=e.chain.queue.map(k=>r.get(k)).filter(k=>!!k),b=e.chain.idx,m=u[b],w=b>=u.length;return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:w?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(w?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:w||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Gt(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(wt(m.date))].filter(Boolean).map(k=>String(k)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:tt(m.engine,o)}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Yt(m.amountEur,o)})]}),Be(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Et,{o:m,lg:!0})," ",t.jsx(Va,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&Ge(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&Ge(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":qt(m)==="retenu"?"var(--brand)":qt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:qt(m)==="retenu"?"✓ "+n.kept:qt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!w&&m&&s.pipe&&ze(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{p(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!w&&m&&!(x&&Ge(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var k;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(k=document.querySelector(".atl2 .demand"))==null||k.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{d(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(w?{type:"modal",modal:null}:{type:"chainNext"}),children:w?n.closeBtn:n.skip})]})]})})}),document.body)}function mc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Z(),i=o==="client",d=c.useMemo(()=>i?r.filter(x=>Ge(x)):[],[r,i]),l=c.useMemo(()=>Dn(d.filter(x=>qt(x)==="retenu"),{key:"signal",dir:-1}),[d]),s=c.useMemo(()=>d.filter(x=>qt(x)==="ecarte"),[d]),g=e.spaceTab==="retenu"?l:s,p=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ke,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:s.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":p},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function fc(){const{mode:e}=Z();return e==="client"||e==="apercu"?t.jsx(hc,{}):t.jsx(bc,{})}function hc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Z(),[i,d]=c.useState("d"),l=o!=="client";return t.jsxs(Ke,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(gc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(xc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(yi,{})]})}function gc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(0);c.useEffect(()=>{let L=!0;return s(!1),mr(a).then(q=>{L&&(q?d(q):s(!0))}),()=>{L=!1}},[a,g]);const x=c.useRef({}),[u,b]=c.useState({}),[m,w]=c.useState(!1),[k,f]=c.useState(!1),y=c.useRef(null);c.useEffect(()=>()=>{y.current&&window.clearTimeout(y.current)},[]);const j=L=>{const q=x.current;Object.keys(q).length&&(w(!0),mr(a,q).then(D=>{if(!D){w(!1),o(e.actErr);return}if(D.throttled&&L<3){y.current=window.setTimeout(()=>j(L+1),5400);return}if(x.current={},b({}),d(D),w(!1),D.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},v=L=>{r||(x.current={...x.current,...L},b(q=>({...q,...L})),y.current&&window.clearTimeout(y.current),y.current=window.setTimeout(()=>j(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...u},E=L=>!N.sections||N.sections.includes(L),S=L=>{const q=N.sections||e.alertSec.map(([D])=>D);v({sections:E(L)?q.filter(D=>D!==L):[...q,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>v({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>v({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>v({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>v({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&k&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,q])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:E(L),disabled:r,onChange:()=>S(L)}),t.jsxs("span",{children:[q,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Gn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ds(a),onTest:()=>Ms(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function xc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(0);c.useEffect(()=>{let m=!0;return s(!1),fr(a).then(w=>{m&&(w?d(w):s(!0))}),()=>{m=!1}},[a,g]);const x=m=>{r||fr(a,m).then(w=>{if(!w){o(e.actErr);return}d(w),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,w)=>t.jsx("option",{value:w,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Gn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Ps(a),onTest:()=>Is(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function yi(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Z(),[d,l]=c.useState(i||""),[s,g]=c.useState(!1),[p,x]=c.useState(!1);c.useEffect(()=>{i&&l(i)},[i]);const u=e.filters,b=c.useMemo(()=>n.filter(f=>Be(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,w=async()=>{if(!(!/.+@.+\..+/.test(d)||p)){x(!0);try{await fetch(`${Ha}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},k=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>tt(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>Gt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return s?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:k.map(([f,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function bc(){const{t:e}=Z();return t.jsx(Ke,{title:e.alertTitle,icon:"🔔",children:t.jsx(yi,{})})}function vc(){var B,V;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:l,dispatch:s,liveMemos:g}=Z(),[p,x]=c.useState(()=>Ya(r)),[u,b]=c.useState(()=>!Ya(r)),[m,w]=c.useState([]),[k,f]=c.useState(0),y=n==="client",j=c.useMemo(()=>{const T=new Map;return o.forEach(F=>{const h=(F.name||"").trim().toLowerCase();h&&!T.has(h)&&T.set(h,F)}),T},[o]);c.useEffect(()=>{let T=!0;return(!Ya(r)||k>0)&&b(!0),(async()=>{const[F,h]=await Promise.all([Rn(r,k>0),vo(a)]);T&&(F&&x(F),b(!1),w(h))})(),()=>{T=!1}},[a,r,k]);const v=u&&!p,N=(p==null?void 0:p.per_day)??0,E=((B=p==null?void 0:p.analyzed_today)==null?void 0:B.length)??0,S=p==null?void 0:p.offre,L=(p==null?void 0:p.pool_meta)||[],q=c.useMemo(()=>{const T=new Map;for(const F of(p==null?void 0:p.scheduled)||[])for(const h of F.names||[])T.has(h)||T.set(h,{label:F.day_label,date:F.date});return T},[p==null?void 0:p.scheduled]),D=(p==null?void 0:p.in_progress)||[];return t.jsxs(Ke,{title:e.queueTitle,wide:!0,children:[S&&t.jsxs("div",{className:"qoffre"+(S.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:S.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:S.delai})]}),t.jsx("span",{className:"osp"}),S.rythme>0?t.jsx("span",{className:"or",children:e.qRate(S.rythme)}):S.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(S.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:v?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(E,E+(((V=p==null?void 0:p.pool_order)==null?void 0:V.length)??0))}})}),S&&t.jsxs("div",{className:"qeta",children:[S.file===0?e.qEtaDone:S.rythme<=0?e.qEtaPaused:e.qEta(S.file,S.rythme,S.jours_restants),S.en_retard&&t.jsxs("em",{children:[" ",e.qLate(S.delai,S.plafond)]})]}),!v&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(S==null?void 0:S.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(D.length>0||g.items.some(T=>T.status==="boot"||T.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(T=>T.status==="boot"||T.status==="running"||T.status==="error").map(T=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:T.name}),t.jsx("span",{className:"qd",children:T.memoType||""}),t.jsx(Ta,{item:T,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+T.name)),D.filter(T=>!g.liveOf(T.name)).map(T=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:T.name}),t.jsxs("span",{className:"qd",children:[T.memo_type||"",T.age_min?` · ${Math.round(T.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:T.state||""})]},"ip-"+T.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(T=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:T.company}),t.jsxs("span",{className:"qd",children:[T.memo_type,typeof T.est_min=="number"?` · ~${T.est_min} min`:""]}),t.jsx("span",{className:"qt",children:T.status}),T.url&&t.jsx("a",{className:"qgo",href:T.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(T.memo_type)}),y&&T.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{cr(a,T.company,"retry").then(()=>f(F=>F+1))},children:e.queueRetry}),y&&T.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{cr(a,T.company,"delete").then(()=>f(F=>F+1))},children:e.queueDelete})]},T.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",v?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[v&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!v&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((T,F)=>{const h=q.get(T.name),A=j.get((T.name||"").trim().toLowerCase()),M=g.liveOf(T.name),H=!!(A&&d.has(A.id))||!!(M&&(M.status==="boot"||M.status==="running")),C=!!(A&&ze(A)===1&&!A.memoUrl)&&!M;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",F+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:T.name}),T.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof T.score=="number"&&t.jsx("span",{className:"qs2",children:T.score}),M&&(M.status==="boot"||M.status==="running")&&t.jsx(Ta,{item:M,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),C&&(l.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>s({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:H,onClick:()=>{i(A),f(O=>O+1)},children:H?e.actAnalyseQueued:e.actAnalyse})),T.excerpt&&t.jsx("span",{className:"qex",children:T.excerpt})]},T.name+":"+F)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([T,F])=>t.jsxs("li",{children:[t.jsx("b",{children:T})," — ",F]},T))})]})}function yc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=Z(),l=`${yt}/cibles/list.csv?token=${a}`,s=`${yt}/cibles/list.json?token=${a}`,g=`${yt}/cibles/export.xlsx?token=${a}&scope=full`,p=`=IMPORTDATA("${l}")`,x=k=>{var f;(f=navigator.clipboard)==null||f.writeText(k).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:p},{def:e.exportLive,value:s,href:s},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{oc(rc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:k=>(e.stg.find(([f])=>f===k)||["",""])[1]})),r(e.exportViewDone(n.length))},w=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ke,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:w,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:k,value:f,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:k[0]}),t.jsxs("div",{children:[t.jsx("b",{children:k[1]}),t.jsx("p",{children:k[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},k[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function wc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Z(),i=o!=="client",[d,l]=c.useState(null),[s,g]=c.useState(!1),[p,x]=c.useState(0),[u,b]=c.useState(!1);c.useEffect(()=>{let f=!0;return g(!1),dr(a).then(y=>{f&&(y?l(y):g(!0))}),()=>{f=!1}},[a,p]);const m=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},w=f=>{if(i||!d)return;const y={enabled:f.enabled??!!d.enabled,email:f.email??(d.email||""),sections:f.sections??m()};b(!0),dr(a,y).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}l(j),r(e.memoAlertSaved)})};if(s)return t.jsx(Ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!d)return t.jsx(Ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const k=m();return t.jsxs(Ke,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||u,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(kc,{value:d.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>w({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!k[f],disabled:i||u,onChange:()=>w({sections:{...k,[f]:!k[f]}})}),t.jsx("span",{children:y})]},f))}),t.jsx(Gn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Ss(a,k),onTest:()=>Ns(a,k)})]})}function kc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=c.useState(e);c.useEffect(()=>{d(e)},[e]);const l=i.trim()!==e.trim(),s=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>d(g.target.value),onKeyDown:g=>{g.key==="Enter"&&l&&s&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!s,onClick:()=>o(i.trim()),children:n})]})]})}function jc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Z(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[g,p]=c.useState(null),[x,u]=c.useState(!1),[b,m]=c.useState(""),[w,k]=c.useState(0),[f,y]=c.useState("webhook"),[j,v]=c.useState("webhook"),[N,E]=c.useState(""),S=c.useRef(!1);c.useEffect(()=>{let M=!0;return s(!1),pr(a).then(H=>{M&&(H?d({configured:H.configured,url_hint:H.url_hint}):s(!0))}),qs(a).then(H=>{if(M){if(!H){u(!0);return}u(!1),p(H),S.current||(S.current=!0,H.destination==="instantly"&&(y(C=>C==="webhook"?"instantly":C),v(C=>C==="webhook"?"instantly":C)),H.campaign_id&&E(C=>C||H.campaign_id||""))}}),()=>{M=!1}},[a,w]);const L=(M,H)=>{o&&pr(a,M).then(C=>{if(!C||C.ok===!1){n(e.actErr);return}M.test&&C.sent===!1?n(e.plugTestThrottled):r(H),k(O=>O+1)})},q='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',D=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),B=`curl -X POST ${yt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,V=`curl -X POST ${yt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`,T=[{k:"webhook",t:e.plugDestCrm,s:e.plugDestCrmS},{k:"instantly",t:e.plugDestInst,s:e.plugAideInst},{k:"script",t:e.plugDestScript,s:e.plugDestScriptS}],F=j==="instantly"?e.plugStep2Inst:j==="script"?e.plugStep2Script:e.plugStep2Wh,h=j==="instantly"?e.plugAideInst:j==="script"?e.plugAideScript:e.plugAideWh,A=M=>{v(M),M!=="script"&&y(M)};return t.jsxs(Ke,{title:e.plugTitle,icon:"🔌",wide:!0,kind:"plug",lead:e.plugLead,children:[g&&t.jsxs("div",{className:"plugetat"+(g.enabled?" on":""),children:[t.jsx("i",{}),t.jsx("b",{children:g.enabled?e.plugEtatOn:e.plugEtatOff})]}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>k(M=>M+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"1"}),t.jsx("h4",{children:e.plugStep1})]}),t.jsx("div",{className:"plugdests",children:T.map(M=>{const H=j===M.k;return t.jsxs("button",{type:"button",className:"plugdest"+(H?" on":""),onClick:()=>A(M.k),children:[t.jsx("span",{className:"pradio","aria-hidden":"true"}),t.jsx("b",{children:M.t}),t.jsx("em",{children:M.s})]},M.k)})}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"2"}),t.jsx("h4",{children:F})]}),j==="script"?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:B}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(B).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}):j==="instantly"?t.jsx("div",{className:"mfield pill",children:t.jsx("input",{type:"text",maxLength:80,placeholder:e.plugCampPh,value:N,disabled:!o,onChange:M=>E(M.target.value)})}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"mfield pill",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:M=>m(M.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>L({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>L({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>L({remove:!0},e.plugRemoved),children:e.plugRemove})]})]}),t.jsx("p",{className:"mnote dim",children:h}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"3"}),t.jsx("h4",{children:e.plugStep3})]}),t.jsx(Nc,{auto:g,autoKo:x,destKind:f,camp:N,onRetry:()=>k(M=>M+1),onDone:M=>{p(M),u(!1)}}),t.jsx("p",{className:"mnote dim",children:e.plugHow3}),t.jsxs("details",{className:"plugex plugpay",children:[t.jsxs("summary",{children:[t.jsx("b",{children:e.plugExT}),t.jsx("span",{children:e.plugPayloadSub})]}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:D}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(D).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult}),t.jsx("p",{className:"mnote dim",children:e.plugVars})]}),t.jsx("div",{"data-tour":"plug-bulk",children:t.jsx(Sc,{destKind:f,setDestKind:M=>{y(M),v(M)},camp:N,setCamp:E,whHint:i!=null&&i.configured?i.url_hint||"webhook":null})}),j!=="script"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:B}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(B).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:q}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(q).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm","data-tour":"plug-crm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:V}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(V).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Ec(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:l}=Z(),s=c.useMemo(()=>r.find(h=>h.id===n.approachId)||null,[r,n.approachId]),[g,p]=c.useState("email"),[x,u]=c.useState(0),[b,m]=c.useState({}),[w,k]=c.useState(!1),[f,y]=c.useState(""),[j,v]=c.useState({});if(c.useEffect(()=>{!s||b[g]||w||(k(!0),y(""),As(a,s.name,g).then(h=>{if(k(!1),!h||h.ok===!1){y((h==null?void 0:h.error)||e.apprFail);return}m(A=>({...A,[g]:h}))}))},[s,g,a]),!s)return null;const N=b[g],E=(N==null?void 0:N.sequence)||[],S=E[x],L=h=>`${g}|${x}|${h}`,q=h=>{const A=L(h);return A in j?j[A]:String(((S==null?void 0:S[h])??"")||"")},D=(h,A)=>v(M=>({...M,[L(h)]:A})),B=L("subject")in j||L("body")in j||L("message")in j,V=q(g==="email"?"body":"message"),T=q("subject"),F=g==="email"&&T?`${T}

${V}`:V;return t.jsxs(Ke,{title:e.apprT(s.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(h=>t.jsx("button",{type:"button",className:"apch"+(g===h?" on":""),"aria-pressed":g===h,onClick:()=>{p(h),u(0)},children:h==="email"?e.apprChEmail:e.apprChLi},h)),t.jsx("span",{className:"sp"}),E.map((h,A)=>t.jsxs("button",{type:"button",className:"apday"+(x===A?" on":""),"aria-pressed":x===A,onClick:()=>u(A),children:[h.day||`J${A}`,[`${g}|${A}|subject`,`${g}|${A}|body`,`${g}|${A}|message`].some(M=>M in j)&&t.jsx("i",{children:"✎"})]},h.day||A))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,N!=null&&N.sender?" · "+e.apprSender(N.sender):""]}),w&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!f&&!w&&t.jsxs("p",{className:"mnote warn",children:[f," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{m(h=>{const A={...h};return delete A[g],A}),y("")},children:e.retry})]}),!w&&!f&&!S&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),S&&t.jsxs(t.Fragment,{children:[g==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:T,onChange:h=>D("subject",h.target.value)})]}),g==="linkedin"&&x===0&&(N==null?void 0:N.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:V,onChange:h=>D(g==="email"?"body":"message",h.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var h;(h=navigator.clipboard)==null||h.writeText(F).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),g==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(s.contactEmail||"")}?subject=${encodeURIComponent(T)}&body=${encodeURIComponent(V)}`,children:e.apprMailto}),B&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Nc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:l,flash:s,flashErr:g,canWrite:p}=Z(),[x,u]=c.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),w=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,k=()=>{if(x||!p||m)return;u(!0),(b?ur(l,!1):ur(l,!0,r,n.trim()||void 0)).then(y=>{if(u(!1),!y){g(d.actErr);return}o(y),s(y.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!p||!!m,title:m||void 0,onClick:k,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),m===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:m}),w&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function Sc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:l,canWrite:s}=Z(),[g,p]=c.useState("valides"),[x,u]=c.useState(!1),[b,m]=c.useState(null),[w,k]=c.useState(null),[f,y]=c.useState(!1),[j,v]=c.useState(!1),[N,E]=c.useState(null),[S,L]=c.useState(null),q=`atl2:bulk:${d}:${g}:${e}`;c.useEffect(()=>{m(null),k(null),y(!1),E(null);try{const O=localStorage.getItem(q)||localStorage.getItem(`atl2:bulk:${d}:${g}`),_=JSON.parse(O||"null");L(_&&Date.now()-Date.parse(_.t)<24*3600*1e3?_:null)}catch{L(null)}},[q,g,d]);const D=e==="instantly"&&!r.trim(),B=`${g}|${e}|${r.trim()}`,V=async()=>{if(D||!s)return;u(!0),y(!1),E(null);const O=await Fs(d,g,e,r.trim()||void 0);m(O),k(O.ok?B:null),u(!1)},T=c.useRef(!1);if(!s)return null;const F=async()=>{if(T.current||!s)return;T.current=!0,v(!0);const O=`${d}:${g}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await Os(d,g,e,r.trim()||void 0,O)}finally{T.current=!1}if(v(!1),y(!1),E(_),_.ok&&(_.pushed||0)>0){const I={t:new Date().toISOString(),n:_.pushed||0};L(I);try{localStorage.setItem(q,JSON.stringify(I))}catch{}}};f&&w!==null&&w!==B&&y(!1);const h=o,A=b!=null&&b.ok&&b.ready||0,M=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":h||"",H=!!(b!=null&&b.ok)&&w===B&&A>0&&!!M&&!S,C=S?new Date(S.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:g,onChange:O=>p(O.target.value),children:i.plugBulkTabs.map(([O,_])=>t.jsx("option",{value:O,children:_},O))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:O=>a(O.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:O=>n(O.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||D,onClick:()=>{V()},children:x?"…":i.plugBulkPreview})]}),D&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),S&&t.jsx("p",{className:"mnote",children:i.bulkLocked(C,S.n)}),!S&&!!(b!=null&&b.ok)&&!M&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!S&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),H&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>y(!0),children:i.bulkArm}),H&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(A,M)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:j,onClick:()=>{F()},children:j?i.bulkSending:i.bulkConfirm(M)}),t.jsx("button",{type:"button",className:"abtn",disabled:j,onClick:()=>y(!1),children:i.bulkCancel})]}),N&&(N.ok?N.replayed?t.jsx("p",{className:"mnote",children:N.pending?i.bulkPending:i.bulkReplayed}):(N.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(N.pushed||0,N.linkedinReady||0,N.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:N.error||i.actErr}))]})}function Cc(){const{t:e,data:a,lang:r}=Z(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const l=window.location.href.split("?")[0];try{const g=await(await fetch(`${Ha}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ke,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(d.credits,d.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function zc(){const{t:e}=Z();return t.jsx(Ke,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(lc,{})})}function Ac(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:l}=Z(),[s,g]=c.useState(null),[p,x]=c.useState(!1);c.useEffect(()=>{let q=!0;if(i)return Rn(i).then(D=>{q&&D&&typeof D.per_day=="number"&&g(D.per_day)}),()=>{q=!1}},[i]);const[u,b]=c.useState(null);c.useEffect(()=>{if(!o)return;let q=!0;return zs(o).then(D=>{q&&b(D)}),()=>{q=!1}},[o]);const m=r.stats,w=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(q=>q.kind==="target"&&Ge(q)).length,k=r.marketEstimate||0,f=k>0?Math.min(100,Math.round(w/k*100)):null,y=(m==null?void 0:m.window_days)||30,j=w>0?w/y:0,v=k>0?Math.max(0,k-w):0,E=k>0&&j>0&&w>=100?Math.round(v/j):null,S=q=>Math.round(q).toLocaleString(a==="en"?"en-US":"fr-FR"),L=q=>{p||!d||(x(!0),yo(o,q).then(D=>{if(x(!1),D===null){l(e.actErr);return}g(D),l(e.alertSaved)}))};return t.jsxs(Ke,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(S(w))}),k>0&&t.jsx("span",{children:e.covOf(S(k))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),E!==null&&t.jsx("p",{className:"mnote",children:e.covEta(E)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(S(j))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((q,D)=>t.jsxs("tr",{className:q.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[q.code,q.geo?` · ${q.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof q.n=="number"?S(q.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:q.source}),q.elargi&&t.jsx("em",{children:e.covWide(String(q.demande||""))}),q.erreur&&t.jsx("em",{children:e.covMissing})]})]},D)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:S(u.total||k)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(q=>t.jsx("button",{type:"button",className:s===q?"on":"",disabled:p,onClick:()=>L(q),children:q===0?"⏸":q},q))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function wi(e,a,r){const n=await fetch(`${yt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${yt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function qc(){const{t:e,token:a,canWrite:r}=Z(),[n,o]=c.useState(null),[i,d]=c.useState(""),[l,s]=c.useState(""),[g,p]=c.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=c.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const m=JSON.parse(localStorage.getItem(x)||"null");return!!m&&Date.now()-(m.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(c.useEffect(()=>{if(!r)return;let m=!0;return Ls(a).then(w=>{m&&o(w)}),()=>{m=!1}},[a,r]),!r||g||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),wi(a,n.instruction||"","atelier2-avis").then(m=>{if(d(m.applied?"ok":"ko"),m.applied||s(m.encours?e.propSlow:m.reply),m.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:l||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{p(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Tc(){var N;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=Z(),[i,d]=c.useState(!1),[l,s]=c.useState(null),[g,p]=c.useState(!1),[x,u]=c.useState([]),[b,m]=c.useState(null),[w,k]=c.useState([]);if(!r)return null;const f=()=>{d(!0),p(!1),u([]),k([]),Rs(a).then(E=>{if(d(!1),!E){p(!0),s(null);return}s(E)})},y=E=>{b||(m(E.title),wi(a,E.instruction,"atelier2-prop").then(S=>{m(null),S.applied?(k(L=>[...L,E.title]),n(e.propApplied)):S.encours?n(e.propSlow):o(S.reply||e.propApplyFail)}))},j=((l==null?void 0:l.proposals)||[]).filter(E=>!x.includes(E.title)&&!w.includes(E.title)),v=((N=l==null?void 0:l.counts)==null?void 0:N.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:f,children:i?e.propWait:e.propBtn}),!i&&g&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!g&&l&&!(l.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:l.reason==="not_enough_signals"?e.propFew(v):e.propNone}),j.map(E=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[E.section]||E.section}),t.jsx("p",{className:"propt",children:E.title}),E.why&&t.jsx("p",{className:"mnote dim",children:E.why}),E.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",E.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>y(E),children:b===E.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(S=>[...S,E.title]),children:e.propSkip})]})]},E.title))]})}function Lc(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=Z(),[l,s]=c.useState(null),[g,p]=c.useState(!1),[x,u]=c.useState(!1),[b,m]=c.useState(""),[w,k]=c.useState(""),[f,y]=c.useState(!1),j=c.useRef(!1);if(c.useEffect(()=>{if(!a||!r)return;let E=!0;return Ts(a).then(S=>{E&&(p(!0),!(!S||j.current)&&(s(S),m(S.fit),k(S.note)))}),()=>{E=!1}},[a,r]),!r)return null;const v=()=>{if(!(!b||f)){if(l&&l.fit===b&&l.note===w.trim()){u(!1);return}y(!0),bt(a,"thesis_fit",b,w.trim(),"",d.email||"").then(E=>{if(y(!1),!E.ok){o(e.fitKo);return}s({fit:b,note:w.trim(),ts:new Date().toISOString()}),u(!1),n(e.fitSaved)})}},N=E=>E==="yes"?e.fitYes:E==="partial"?e.fitPartial:e.fitNo;if(l&&!x){const E=new Date(String(l.ts||"")),S=Number.isNaN(E.getTime())?"":E.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:N(l.fit)}),l.note?` — ${l.note}`:""]}),!!S&&t.jsx("p",{className:"mnote dim",children:S}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(E=>t.jsx("button",{type:"button","aria-pressed":b===E,className:"fitopt"+(b===E?" on":""),onClick:()=>{j.current=!0,m(E)},children:N(E)},E))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:w,onChange:E=>{j.current=!0,k(E.target.value)},onKeyDown:E=>{E.key==="Enter"&&v()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||f,onClick:v,children:f?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!g&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function Rc(){var f,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:l}=Z(),s=n==="client",g=c.useMemo(()=>{const v=new Set;return a.forEach(N=>{N.angle&&v.add(N.angle)}),[...v]},[a]),[p,x]=c.useState(""),[u,b]=c.useState(""),[m,w]=c.useState(!1),k=async()=>{const v=p.trim();if(!(!v||m||!s)){w(!0),b("");try{const E=await(await fetch(`${yt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:v,who:"atelier2"})})).json().catch(()=>({}));if(E.reply&&b(String(E.reply)),E.job_id){b(e.critChatRunning);const S=async()=>{const L=await fetch(`${yt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:E.job_id})}).then(q=>q.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),w(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{S()},8e3)};setTimeout(()=>{S()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||w(!1)}}};return t.jsxs(Ke,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(v=>t.jsx("li",{children:v},v))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(v=>{var N,E;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:v.title}),v.why&&t.jsx("p",{className:"why",children:v.why}),t.jsxs("div",{className:"lo",children:[!!((N=v.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:v.look.map(S=>t.jsx("li",{children:S},S))})]}),!!((E=v.out)!=null&&E.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:v.out.map(S=>t.jsx("li",{children:S},S))})]})]})]},v.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(v=>t.jsxs("li",{children:[v.k&&t.jsx("b",{children:v.k}),v.t]},v.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(v=>t.jsx("li",{style:{marginBottom:5},children:v.replace(/[_-]+/g," ")},v))})]}),t.jsx(Lc,{}),t.jsx(qc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:p,disabled:!s||m,onChange:v=>x(v.target.value),onKeyDown:v=>{v.key==="Enter"&&k()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!s||m||!p.trim(),onClick:()=>void k(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(Tc,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Cs,{fund:d,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([v,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(xi[v]||"v-cons"),children:v}),t.jsx("span",{children:N})]},v))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([v,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:v}),t.jsxs("span",{children:["← ",N]})]},v))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Fc(){const{t:e,dispatch:a,startTour:r}=Z(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Ke,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const ki="atl2:mapfold",Oc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(ki);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Mc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},ji=c.createContext(null),Z=()=>{const e=c.useContext(ji);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Et({o:e,lg:a}){const{lang:r}=Z(),n=Be(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:hr(n,r),children:[n.emoji," ",hr(n,r)]}):null}function Va({o:e,src:a}){const{lang:r,t:n}=Z(),o=Be(e);if(!o)return null;const i=Vs(o),d=Ws(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(Co(o,r))+" · "+n.win7(zo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,s)=>t.jsx("i",{className:s<i?"on":""},s))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Dc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Ve(a);if(o)return e.find(i=>Ve(i.name)===o)||e.find(i=>{const d=Ve(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Ic(){const{scoped:e,t:a,st:r,dispatch:n}=Z(),o=c.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(x=>!We(x)),l=d.length,s=d.filter(x=>!x.noCo).length,g=d.filter(x=>!!x.noCo).length,p=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:p?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",s," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function Pc(){var x;const{t:e,lang:a,data:r,dispatch:n,scoped:o,counts:i}=Z(),d=u=>u.toLocaleString(a==="en"?"en-US":"fr-FR"),s=o.filter(u=>!We(u)).length,g=typeof((x=r.stats)==null?void 0:x.screened)=="number"?r.stats.screened:0;if(s<=0&&g<=0)return null;const p=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:d(s)}),t.jsx("span",{children:p>0?e.covOf(d(p)):e.covScreened("").trim()}),t.jsxs("ul",{children:[t.jsxs("li",{children:["✅ ",d(i[1]||0)," ",e.covKept]}),t.jsxs("li",{children:["⚡ ",d(i[2]||0)," ",e.covAna]})]})]})}function Ei({o:e}){const{lang:a}=Z(),r=Hs(e.cc),n=e.cc?Gt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:20,height:14,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const _c=!1;function Bc(){const[e,a]=c.useState(!1);return c.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Ni=e=>`atl2:tour:${e||"anon"}`;function $c(e){try{return localStorage.getItem(Ni(e))==="1"}catch{return!0}}function mo(e){try{localStorage.setItem(Ni(e),"1")}catch{}}function Uc(e,a,r,n,o,i,d,l){const s=e.tourT,g=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:g[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:g[1][0]},{sel:".atl2 .dmulti.ddeals",title:s.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:s.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:s.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:s.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:s.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:s.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-bulk"]',need:".atl2 .ic[data-tour=plug]",title:s.campout,body:e.fhintCampout,modal:"plug"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-crm"]',need:".atl2 .ic[data-tour=plug]",title:s.addcrm,body:e.fhintAddcrm,modal:"plug"}:null,...[2,4,5].filter(p=>(l[p]||0)>0).map(p=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:p===2?s.tabAna:p===4?s.tabValid:s.tabRej,body:p===2?e.fhintTabAna:p===4?e.fhintTabValid:e.fhintTabRej,ptab:p})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:s.rank,body:e.fhintRank},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:s.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:g[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:g[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:s.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:s.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:s.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function Yc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Qn;const{lang:d}=_s(),l=Rl(e,d,a),s=c.useMemo(()=>({...yl[d],...vl(d,l.thesisMode)}),[d,l.thesisMode]),[g,p]=c.useReducer(Ml,void 0,()=>Fl((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Mc():Oc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=c.useRef(!0);c.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(ki,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),c.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const z=()=>{window.innerWidth<=760&&p({type:"mapFold",folded:!0})};return z(),window.addEventListener("resize",z),()=>window.removeEventListener("resize",z)},[a]);const u=c.useRef(i);u.current=i,c.useEffect(()=>{var z;(z=u.current)==null||z.call(u,g.filters)},[g.filters]);const[b,m]=c.useState(()=>{if(typeof window>"u")return"both";try{const z=localStorage.getItem("atl2:chrome-mode");if(z==="eval"||z==="filt"||z==="both")return z;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[w,k]=c.useState(null),[f,y]=c.useState(null),[j,v]=c.useState(null),[N,E]=c.useState({kept:0,dropped:0}),[S,L]=c.useState(!1),[q,D]=c.useState(""),[B,V]=c.useState(!1),[T,F]=c.useState(null),[h,A]=c.useState(null),[M,H]=c.useState(!1),[C,O]=c.useState(!1),[,_]=c.useState(0),I=()=>_(z=>z+1),Y=c.useRef([]),G=c.useRef(new Set),he=c.useRef(new Set),[te,le]=c.useState([]),[fe,ge]=c.useState([]),[be,ve]=c.useState(0),ye=c.useRef(new Map),qe=c.useRef(null),{mode:ae}=l,ke=c.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),$=ke.pipe,U=l.session.token||"",Q=ae==="client"&&!e;c.useEffect(()=>{if(!U||!$)return;let z=!0;const J=async()=>{const me=await Gs(U);!z||!me||(ge(me.runs),ve(Date.now()/1e3-me.now),le(Re=>Re.filter(Se=>!me.runs.some(Ue=>Ve(Ue.company)===Ve(Se.name)))))};J();const W=te.length>0||fe.some(me=>me.status==="running"),ie=window.setInterval(()=>{J()},W?8e3:25e3);return()=>{z=!1,window.clearInterval(ie)}},[U,$,te.length,fe.some(z=>z.status==="running")]),c.useEffect(()=>{if(!U||!$||!Q)return;let z=!0;const J=async()=>{const ie=await Ys(U);if(!z||!ie.length)return;const me=new Map;ie.forEach(Re=>{const Se=String(Re.ceo_status||"").trim();Se&&Re.check_id&&me.set(String(Re.check_id),Se)}),l.patchStatuses(me,Re=>Date.now()-(Ee.current.get(Re)||0)>9e4)};J();const W=window.setInterval(()=>{J()},6e4);return()=>{z=!1,window.clearInterval(W)}},[U,$,Q]);const K=c.useMemo(()=>{const z=[],J=new Set;for(const W of te){const ie=Ve(W.name);!ie||J.has(ie)||(J.add(ie),z.push({name:W.name,id:W.id,status:"boot",started:W.started,estMin:W.estMin,memoType:"instant"}))}for(const W of fe){const ie=Ve(W.company);if(!ie||J.has(ie))continue;J.add(ie);const me=W.status==="error"?"error":W.status==="done"?"done":"running";z.push({name:W.company,status:me,started:W.started||0,estMin:W.est_min||(W.memo_type==="detailed"?40:15),url:W.url,error:W.error,memoType:W.memo_type,note:W.note})}return z},[te,fe]),se=z=>K.find(J=>Ve(J.name)===Ve(z))||null,de=(z,J)=>{le(W=>W.some(ie=>Ve(ie.name)===Ve(z.name))?W:[...W,{name:z.name,id:z.id,started:Date.now()/1e3,estMin:J==="detailed"?40:15}]),G.current.add(z.id),I()},re=(z,J=!1)=>{D(z),V(J),qe.current&&clearTimeout(qe.current),qe.current=setTimeout(()=>D(""),J?4200:2400)},ce=z=>re(z,!0),pe=c.useMemo(()=>{const z=new Map;return l.dossiers.forEach(J=>{J.id&&z.set(J.id,J)}),z},[l.dossiers]),we=c.useMemo(()=>l.dossiers.filter(z=>oa(z,g,$)),[l.dossiers,g,$]),Ae=c.useRef(!1);c.useEffect(()=>{if(Ae.current||l.loading||!l.dossiers.length)return;if(e&&!l.session.token){Ae.current=!0;return}if(!ke.showFunnel||$c(l.session.token||"")){Ae.current=!0;return}Ae.current=!0;const z=window.setTimeout(()=>{mo(l.session.token||""),H(!0)},700);return()=>window.clearTimeout(z)},[e,l.loading,l.dossiers.length,ke.showFunnel,l.session.token]);const Me=c.useMemo(()=>l.dossiers.filter(z=>Dl(z,g,$,l.favIds)),[l.dossiers,g,$,l.favIds]),Ie=c.useMemo(()=>Bs(we.filter(z=>!Je(z)),l.favIds),[we,l.favIds]),Ne=c.useRef(!1);c.useEffect(()=>{if(Ne.current)return;if(!$||a==="ops"){Ne.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Ne.current=!0;return}if(l.loading)return;Ne.current=!0;const z=$s(Ie);z!==g.ptab&&p({type:"ptab",tab:z})},[$,a,n==null?void 0:n.ptab,l.loading,Ie,g.ptab]);const Mt=c.useMemo(()=>{const z=$o(l.dossiers);return z?wt(z)===0?s.tourToday:Uo(z,d):s.tourNoRun},[l.dossiers,s,d]),St=c.useMemo(()=>l.dossiers.some(z=>!!z.memoUrl||!!z.summary||$t(z)),[l.dossiers]),[Pe,st]=c.useState(!1);c.useEffect(()=>{if(l.loading){st(!1);return}if(l.dossiers.length>0||l.error){st(!0);return}const z=window.setTimeout(()=>st(!0),6e3);return()=>window.clearTimeout(z)},[l.loading,l.dossiers.length,l.error]);const ft=(l.marketEstimate||0)>0||typeof((Qn=l.stats)==null?void 0:Qn.screened)=="number"&&l.stats.screened>0,Ct=c.useMemo(()=>[1,0,2,4,5,3].find(z=>(Ie[z]||0)>0)??0,[Ie]),at=Fn.find(z=>z.key===g.continent),zt=g.continent==="monde"?s.contWorld:(d==="fr"?at==null?void 0:at.fr:at==null?void 0:at.en)||"";c.useEffect(()=>{const z=J=>{var ie;const W=(((ie=J.detail)==null?void 0:ie.name)||"").trim();W&&ht(null,W)};return window.addEventListener("ppmap:evaluate",z),()=>window.removeEventListener("ppmap:evaluate",z)}),c.useEffect(()=>{const z=J=>{const W=J.detail||{},ie=String(W.id||"").trim(),me=String(W.name||"").trim(),Re=String(W.url||"").trim(),Se=ie&&pe.get(ie)||Dc(l.dossiers,me,Re);if(Se){if(y(null),oa(Se,g,$)||(g.continent!=="monde"&&Se.continent!==g.continent&&p({type:"continent",key:Se.continent||"monde"}),p({type:"reset"})),$&&Se.kind!=="op"){const pt=ze(Se);typeof pt=="number"&&pt!==g.ptab&&p({type:"ptab",tab:pt})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),p({type:"focus",id:Se.id}),(Se.noCo||["media","nominations","recrutements"].includes(Se.engine||""))&&(Se.url||Se.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Se.url||"",text:[Se.headline,Se.tagline].filter(Boolean).join(`
`)}})):Se.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Se.name,url:Se.url||"",website:Se.website||"",domain:Se.domain||""}}));return}!me&&!Re||(p({type:"focus",id:ie||null}),y({name:me,headline:String(W.text||"").trim()||me,url:Re,card:W.card}),Re&&(La(me)||!me)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Re,text:String(W.text||"").trim()}})):me&&!La(me)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:me}})))};return window.addEventListener("ppmap:focus",z),()=>window.removeEventListener("ppmap:focus",z)}),c.useEffect(()=>{const z=ie=>{const me={},Re=String((ie==null?void 0:ie.sector)||"").trim();Re&&(me.sector=[Re]);const Se=String((ie==null?void 0:ie.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Se)&&(me.day=Se);const Ue=String((ie==null?void 0:ie.search)||"").trim();Ue&&(me.search=Ue);const pt=String((ie==null?void 0:ie.dealKind)||"").trim();(pt==="ma"||pt==="levee"||pt==="other")&&(me.dealKind=[pt]),Object.keys(me).length&&p({type:"filters",patch:me})},J=ie=>z(ie.detail),W=ie=>{ie.data&&ie.data.type==="pp-filter"&&z(ie.data)};return window.addEventListener("ppmap:filter",J),window.addEventListener("message",W),()=>{window.removeEventListener("ppmap:filter",J),window.removeEventListener("message",W)}},[]),c.useEffect(()=>{const z=J=>{var me;const W=(((me=J.detail)==null?void 0:me.name)||"").trim().toLowerCase();if(!W)return;const ie=l.dossiers.find(Re=>(Re.name||"").trim().toLowerCase()===W);ie&&p(a==="ops"?{type:"focus",id:ie.id}:{type:"popup",id:ie.id})};return window.addEventListener("ppmap:similar",z),()=>window.removeEventListener("ppmap:similar",z)});const ht=(z,J,W)=>{const ie=(W||(z==null?void 0:z.name)||J||"").trim();if(!Q){v({kicker:ie});return}!ie||S||(L(!0),(async()=>{try{let me=(J||ie).trim();const Re=((z==null?void 0:z.website)||(z==null?void 0:z.domain)||"").trim();if(!(/^https?:\/\//i.test(me)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(me)&&!/\s/.test(me)))if(Re)me=Re;else try{const De=await On(ie);if(De!=null&&De.website)me=De.website;else if(((De==null?void 0:De.candidates)||[]).length===1)me=De.candidates[0].url;else if(((De==null?void 0:De.candidates)||[]).length>1){Y.current=[{name:ie,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(De.candidates||[]).slice(0,5)},...Y.current].slice(0,8),I();return}}catch{}const Ue=await ko(U,me,"atelier2"),pt={name:Ue.company||ie,verdict:Ue.verdict,reason:Ue.reason||"",remaining:Ue.remaining??null};Y.current=[pt,...Y.current].slice(0,8),Ue.verdict==="kept"&&E(De=>({...De,kept:De.kept+1})),Ue.verdict==="ruled_out"&&E(De=>({...De,dropped:De.dropped+1}));const Qt=z||l.dossiers.find(De=>(De.name||"").toLowerCase()===ie.toLowerCase());Qt&&(Ue.verdict==="kept"?Qt.verdict=Qt.verdict||"MATCH":Ue.verdict==="ruled_out"&&(Qt.verdict="NO MATCH"),Ue.reason&&(Qt.reasoning=Ue.reason)),I()}finally{L(!1)}})())},Dt=z=>{if(!Q){v({kicker:z.name});return}de(z,"instant"),bt(U,"fast_request",z.name||"",""),re(s.memoInstantSent(z.name))},It=z=>ye.current.get(z.id)??l.thumbs.get((z.name||"").trim().toLowerCase()),_e=(z,J)=>p({type:"undoPush",entry:{id:z.id,name:z.name,prevCeoStatus:J}}),Xe=async(z,J,W)=>{const ie=z.ceoStatus||"";Ee.current.set(z.id,Date.now()),z.ceoStatus=J,I();const me=await Qa(U,{status:J,airtable_id:z.airtableId,check_id:z.checkId,company:z.name,...(W==null?void 0:W.note)!==void 0?{note:W.note}:{},...W!=null&&W.via?{via:W.via}:{}});return me.ok?me.skipped?(z.ceoStatus=ie,I(),ce(s.actNotPersisted),!1):((W==null?void 0:W.undo)!==!1&&_e(z,ie),W!=null&&W.msg&&re(W.msg),(J==="Validé"||J==="Écarté")&&!z.ceoNote&&(W==null?void 0:W.note)===void 0&&F({o:z,yes:J==="Validé"}),!0):(z.ceoStatus=ie,I(),ce(s.actErr),!1)},Ye=async(z,J)=>{const W=await Qa(U,{status:z.ceoStatus||"Retenu",airtable_id:z.airtableId,check_id:z.checkId,company:z.name,note:J,via:"note"});return!W.ok||W.skipped?(ce(W.skipped?s.actNotPersisted:s.actErr),!1):(z.ceoNote=J,I(),!0)},dt=c.useRef(new Map),R=z=>dt.current.has(z.id)?dt.current.get(z.id):l.stages.get((z.name||"").trim().toLowerCase()),X=(z,J)=>{dt.current.set(z.id,J),I()},ee=(z,J)=>{Q&&Xe(z,J?"Validé":"Écarté",{msg:J?s.decidedYes(z.name):s.decidedNo(z.name)})},P=z=>{Q&&Xe(z,"À trancher",{msg:s.promoted(z.name)})},oe=z=>{Q&&(async()=>{const J=z.ceoStatus||"";z.ceoStatus="Retenu",I();const W=await Qa(U,{status:"Retenu",check_id:z.checkId,company:z.name});if(!W.ok||W.skipped){z.ceoStatus=J,I(),ce(W.skipped?s.actNotPersisted:s.actErr);return}_e(z,J),re(s.repeched(z.name))})()},ne=()=>{const z=g.undo[g.undo.length-1];if(!z){re(s.undoNone);return}const J=pe.get(z.id);if(!J){p({type:"undoPop"}),re(s.undoNone);return}let W=z.prevCeoStatus;if(!W)if((J.verdict||"").toUpperCase().includes("CALL"))W="À trancher";else{re(s.undoLockedTitle);return}(async()=>await Xe(J,W,{undo:!1})&&(p({type:"undoPop"}),J.ceoStatus=z.prevCeoStatus,I(),re(s.undoDone(J.name))))()},ue=z=>{Q&&(he.current.add(z.id),I(),p({type:"approachOpen",id:z.id}),bt(U,"approach",z.name||"","","",l.email||""))},Ee=c.useRef(new Map),xe=c.useRef(!1),[$e,Le]=c.useState(0);c.useEffect(()=>{if(!U||e||!Q||xe.current)return;xe.current=!0;const z=new Date().toISOString().slice(0,10),J=l.email||"",W=`cbv_${U}_${J}_${z}`,ie=`atl2:vue:${U}:${z}`;try{if(localStorage.getItem(W)||localStorage.getItem(ie))return}catch{}bt(U,"view","","","",J).then(me=>{if(!me.ok){xe.current=!1;return}try{localStorage.setItem(W,"1")}catch{}})},[U,e,Q,l.email]),c.useEffect(()=>{if(!U||!$||e||!Q||!l.generatedAt)return;let z=!0;const J=()=>{document.hidden||Qs(U,l.generatedAt||"").then(ie=>{z&&Le(ie)})};J();const W=window.setInterval(J,6e4);return()=>{z=!1,window.clearInterval(W)}},[U,$,e,l.generatedAt]);const gt=(z,J)=>{Q&&(async()=>{if(!(await bt(U,J?"yes":"no",z.name||"",(z.ceoNote||"").slice(0,400),z.sector||"",l.email||"")).ok){ce(s.actErr);return}ye.current.set(z.id,J?"yes":"no"),I(),re(J?s.thumbUpDone:s.thumbDnDone),A({o:z,up:J})})()},Pt=z=>{!Q||!$t(z)||(de(z,"detailed"),bt(U,"detailed_request",z.name||"","","",l.email||""),re(s.memoDeepSent(z.name)))},Ze=z=>{!Q||!z.memoUrl||window.confirm(s.memoRegenAsk(z.name))&&(de(z,"detailed"),bt(U,"detailed_regen",z.name||"","","",l.email||""),re(s.memoDeepSent(z.name)))},Si=z=>{const J=new Set(l.favIds),W=J.has(z.id);W?J.delete(z.id):J.add(z.id),l.setFavIds(J),Q&&Ks(U,{id:z.id,co:z.name},W)},Ci=()=>{!Q||C||window.confirm(s.identSyncConfirm)&&(O(!0),(async()=>{const z=await Js(U);O(!1),z?re(s.identSyncDone):ce(s.actErr)})())},Yn=/proplace/i.test(l.fund||""),zi=z=>{!Q||!Yn||(bt(U,"onboard_request",z.name||"",""),re(s.onboardSent(z.name)))},Ai={st:g,dispatch:p,t:s,lang:d,mode:ae,caps:ke,pipe:$,token:U,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:oe,thumbOf:It,canWrite:Q,commitStatus:Xe,saveNote:Ye,stageOf:R,setStage:X,flashErr:ce,startTour:()=>H(!0),dossiers:l.dossiers,scopedAll:we,scoped:Me,counts:Ie,byId:pe,contName:zt,favIds:l.favIds,toggleFav:Si,askEvaluate:ht,doAnalyse:Dt,doDecide:ee,doPromote:P,doApproach:ue,doThumb:gt,doDeep:Pt,doRegen:Ze,doUndo:ne,doSync:Ci,doOnboard:zi,outbound:Yn,memoQueued:G.current,liveMemos:{items:K,serverOff:be,liveOf:se},approachDone:he.current,sessTally:N,evalCards:Y.current,evalBusy:S,markRow:k,markedId:w,flash:re,focusExtra:f};c.useEffect(()=>{const z=J=>{J.key==="Escape"&&(p({type:"popup",id:null}),p({type:"modal",modal:null}),p({type:"openFacet",facet:null}))};return window.addEventListener("keydown",z),()=>window.removeEventListener("keydown",z)},[]);const qi=z=>U?t.jsx(_l,{token:U,children:z}):t.jsx(t.Fragment,{children:z});return t.jsx(ji.Provider,{value:Ai,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(U?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Nl}),qi(t.jsxs("div",{className:"app"+($?" pipe":"")+(U?" has-thesis":""),children:[ke.showTicker&&t.jsx(lt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(U?" live-stack--cibles":""),children:[t.jsx(Gl,{}),!!U&&t.jsx(Bl,{})]})}),ke.showIdent&&t.jsx(lt,{name:"identite",children:t.jsx(od,{})}),!1,_c,ke.showFunnel&&t.jsx(lt,{name:"entonnoir",children:t.jsx(Hc,{})}),!g.mapFolded&&t.jsx(lt,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(di,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Ic,{}),a!=="ops"&&ke.showFunnel&&t.jsx(Pc,{}),t.jsx(np,{}),t.jsx(li,{})]})]})}),ke.showDemand&&$&&t.jsx(lt,{name:"direct",children:t.jsx(al,{items:K,serverOff:be,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>p({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([z,J])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===z,onClick:()=>{m(z);try{localStorage.setItem("atl2:chrome-mode",z)}catch{}},children:J},z))}),ke.showDemand&&t.jsx(lt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(up,{})})}),ke.showDemand&&g.memoConsole&&t.jsx(lt,{name:"console",children:t.jsx(fp,{})}),ke.pipe&&!!U&&t.jsx(lt,{name:"moteurs",children:t.jsx(ml,{})}),$e>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:s.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Le(0),l.refresh()},children:s.freshGo})]}),t.jsx(lt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(ac,{})}),ke.pipe&&!!U&&t.jsx("p",{className:"privnote",children:s.privLink}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(lt,{name:"fiche",children:t.jsx(Pp,{})}),t.jsx(lt,{name:"modales",children:t.jsx(pc,{})}),t.jsx(Kl,{}),h&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:h.o.name}),t.jsx(Cr,{placeholder:h.up?s.thumbWhyUpPh:s.thumbWhyDnPh,onDone:z=>{const J=h.o;A(null),z&&bt(U,"note",J.name||"",z,J.sector||"",l.email||"").then(W=>{W.ok&&re(s.csNoteSaved)})}})]}),T&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:T.o.name}),t.jsx(Cr,{placeholder:T.yes?s.whyYesPh:s.whyNoPh,onDone:z=>{const J=T.o;F(null),z&&Ye(J,z).then(W=>{W&&re(s.csNoteSaved)})}})]}),M&&Pe&&t.jsx(ad,{steps:Uc(s,Mt,St,Ct,ft,Ie[3]||0,Ie[4]||0,Ie),onClose:()=>{H(!1),mo(U)}}),t.jsx(Bc,{}),ke.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:_o,children:Pn}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("button",{type:"button",onClick:()=>p({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),q&&t.jsx("div",{className:"flash on"+(B?" err":""),children:q}),j&&t.jsx(Us,{variant:"acquirer",initialCompany:fo().co,initialWebsite:fo().site,onClose:()=>v(null)})]})})}function Hc(){const{t:e}=Z(),[a,r]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function fo(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Vc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Ei as FlagCell,Et as SigBadge,Va as SigWin,Yc as default,Vc as fmtShort,Z as useV2};
