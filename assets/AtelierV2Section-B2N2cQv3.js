...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
.atl2 .listhead.mapoff .doable.doable-open{display:inline-flex;gap:6px;margin-left:0;flex:none}
.atl2 .listhead.mapoff .doable.doable-open button{
  background:#fff;border:1px solid var(--line);border-radius:7px;
  padding:6px 10px;font-size:12px;font-weight:650;color:var(--ink)}
.atl2 .listhead.mapoff .doable.doable-open button:hover{border-color:#0E8A4F;color:#0A6B3D}
.atl2 .listhead.mapoff .doable.doable-open button[aria-pressed="true"]{
  color:#0A6B3D;border-color:#0E8A4F;background:#F0FDF4}
...
`,Vi=Ui+Hi;function Va(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Wi(){const e=Va("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Yi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Wi();return r==="0"?"client":r==="1"||Va("embed")==="1"&&Va("chrome")==="1"?"apercu":"client"}const Gi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ki=e=>Gi[e];function fa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const ht=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!jr(a)||fa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:qo(e.cc)})};function La(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Qi=60*60*1e3;function Ji(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Qi?null:a}catch{return null}}function Zt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Xi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Zi(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:wo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Yi(e,i),[e,i,n]),l=m.useMemo(()=>Ki(o),[o]),d=o!=="visiteur",c=Xi(r),[f,s]=m.useState([]),[x,u]=m.useState(""),[g,p]=m.useState(null),[b,y]=m.useState(null),[h,S]=m.useState(null),[j,w]=m.useState(()=>new Map),[C,T]=m.useState(()=>new Map),[A,L]=m.useState(""),[z,N]=m.useState(new Set),[R,I]=m.useState(null),[M,F]=m.useState(!0),[v,q]=m.useState(!1),[H,B]=m.useState(0),[_,V]=m.useState(0),G=m.useRef(0),Z=m.useMemo(()=>{var ae;if(o!=="client")return"";try{return((ae=ko())==null?void 0:ae.email)||""}catch{return""}},[o]);m.useEffect(()=>{const ae=++G.current;let se=!0;const Y=()=>se&&ae===G.current,ce=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),me=Ji(ce);return me?(s(me.objs.map(ht)),me.fund&&u(me.fund),p(me.marketEstimate??null),y(me.criteria??null),S(me.stats??null),L(me.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const ke=await Aa(),ye=((ke==null?void 0:ke.recent_ops)||[]).map(K=>{const Q=da(K.company_name||K.title?K:{...K,title:(K.headline_fr||K.headline||"").slice(0,120)},a),J=String(K.rubrique||"").toLowerCase();return Q&&(J==="nominations"||J==="recrutements")&&(Q.engine=J),Q&&!String(K.company_name||"").trim()&&(Q.noCo=!0),Q}).filter(K=>!!K).map(K=>(jr((K.name||"").trim())||(K.noCo=!0),K));try{const K=jo(),Q=K&&K.doc||await No(),J=So(Q),ee=((K==null?void 0:K.day)||(Q==null?void 0:Q.date)||"").slice(0,10);if(ee&&J.length){const ve=new Set;for(const re of ye){if((re.date||"").slice(0,10)!==ee)continue;const te=En(J,ve,re.name,"");te>=0&&(ve.add(te),re.decryptHtml=J[te].html)}for(const re of ye){if(re.decryptHtml||(re.date||"").slice(0,10)!==ee)continue;const te=En(J,ve,"",re.headline||re.tagline||re.name);te>=0&&(ve.add(te),re.decryptHtml=J[te].html)}}if(ee){const ve=((Q==null?void 0:Q.title_fr)||"").trim(),re=((Q==null?void 0:Q.lead_fr)||"").trim(),te=Eo(Q),fe=((Q==null?void 0:Q.url)||"").trim();ve&&(te||fe)&&ye.unshift({id:`edito:${ee}`,kind:"op",name:ve,cc:null,date:ee,engine:"edito",dealKind:"other",headline:re||ve,tagline:re||ve,decryptHtml:te||void 0,url:fe,noCo:!0})}}catch{}if(!Y())return;s(ye.map(ht)),Zt(ce,{objs:ye})}else if(typeof r=="object"){const ye=(await Cn()||[]).filter(Q=>(Q.slug||"")===r.research).map(Q=>zn(Q,a)).filter(Q=>!!Q),K=La(await An(ye,a));if(!Y())return;s(K.map(ht)),Zt(ce,{objs:K})}else if(d&&i.token){const ke=Co(i.token),ye=Aa(),K=zo(i.token),Q=Ao(i.token),J=To(i.token),ee=await ke;let ve=ee?ee.targets:[];Y()&&ee&&(u(ee.fund||""),p(ee.marketEstimate??null),y(ee.criteria??null),S(ee.stats??null),L(ee.generatedAt||""),s(ve.map(ht)),F(!1),q(!1));const[re,te,fe,oe]=await Promise.all([ye,K,Q,J]),Oe=((re==null?void 0:re.recent_ops)||[]).map(Fe=>da(Fe,a)).filter(Fe=>!!Fe);if(ve=[...ve,...Oe],!Y())return;s(ve.map(ht));const Re=new Set;for(const Fe of te){const Ue=(Fe.id||Fe.co||"").toString().trim().toLowerCase();Ue&&Re.add(Ue.startsWith("t:")?Ue:"t:"+Ue)}N(Re),w(fe),T(oe),ee&&Zt(ce,{fund:ee.fund,marketEstimate:ee.marketEstimate,criteria:ee.criteria,stats:ee.stats,generatedAt:ee.generatedAt,objs:ve})}else{const ke=Lo(),ye=Cn(),K=Aa(),Q=await ke;Y()&&Q.length&&(s(La(Q).map(ht)),F(!1),q(!1));const[J,ee]=await Promise.all([ye,K]),ve=(J||[]).map(oe=>zn(oe,a)).filter(oe=>!!oe),re=await An(ve,a),te=((ee==null?void 0:ee.recent_ops)||[]).map(oe=>da(oe,a)).filter(oe=>!!oe),fe=La([...Q,...re,...te]);if(!Y())return;s(fe.map(ht)),Zt(ce,{objs:fe})}Y()&&q(!1)}catch{Y()&&!me&&q(!0)}finally{Y()&&F(!1)}})(),()=>{se=!1}},[d,i.token,a,H,c]),m.useEffect(()=>{if(!l.showCredits||!Z){I(null);return}let ae=!0;return(async()=>{try{const se=await fetch(`${ln}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Z})});if(!se.ok)return;const Y=await se.json();ae&&Y&&Y.ok!==!1&&I(Y)}catch{}})(),()=>{ae=!1}},[l.showCredits,Z,_]);const de=m.useCallback(ae=>N(new Set(ae)),[]);return{session:i,mode:o,caps:l,fund:x,email:Z,marketEstimate:g,generatedAt:A,criteria:b,stats:h,thumbs:j,stages:C,dossiers:f,favIds:z,setFavIds:de,credits:R,reloadCredits:()=>V(ae=>ae+1),loading:M,error:v,refresh:()=>B(ae=>ae+1)}}function ct(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Cr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),es=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Cr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ts=new Set(["signal","amount","score","crible","memo"]);function as(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Cr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ts.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??zr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const zr=80;function xa(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(dn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(pt(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&bt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function Ar(e,a,r){return ct(e)?xa(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:xa(e,a.filters,r)}function ns(e,a,r,n){return!(!Ar(e,a,r)||r&&!Mo(e,a.ptab,n))}function mn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-pt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Fo(i);case"memo":return Ro(i);case"signal":{const o=Me(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const qa={},In=(qa==null?void 0:qa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Bn(){return new Date().toISOString().slice(0,10)}const fn=m.createContext(null);function Tr(){return m.useContext(fn)}function rs(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const f=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(c.setAttribute("href",f),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function $n(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Lr(){const e=m.useContext(fn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function os({token:e,children:a}){const{dispatch:r,st:n,lang:i}=$(),[o,l]=m.useState(()=>n.filters.day||Bn()),[d,c]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l(Bn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=y=>{var S;const h=(S=y.detail)==null?void 0:S.day;typeof h=="string"&&x(h)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${In}/cibles/edition.json?${y}`).then(h=>h.json()).then(h=>{b||c(h)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const g=m.useMemo(()=>`${In}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:d,loading:f,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:g,isEn:i==="en"}),[e,o,d,f,x,u,n.filters.day,g,i]);return t.jsx(fn.Provider,{value:p,children:a})}function is(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Lr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
