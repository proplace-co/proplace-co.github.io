...
`,ga=xa+ma;function ha(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function ba(t,a){return t||a.mode!=="client"||!a.token?"visiteur":ha("teaser")==="1"?"apercu":"client"}const va={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},ya=t=>va[t],fe=t=>Object.assign(t,{continent:Vt(t.cc)});function De(t){const a=new Set,n=[];for(const r of t){const o=(r.name||"").toLowerCase();!o||a.has(o)||(a.add(o),n.push(r))}return n}const wa=60*60*1e3;function ka(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>wa?null:a}catch{return null}}function ze(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ja=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function Na(t,a,n="default"){const r=n!=="default",o=f.useMemo(()=>t||r?{mode:"anon"}:It(),[t,r]),l=f.useMemo(()=>r?"visiteur":ba(t,o),[t,o,r]),i=f.useMemo(()=>ya(l),[l]),p=l!=="visiteur",c=ja(n),[d,x]=f.useState([]),[s,y]=f.useState(""),[b,g]=f.useState(null),[w,m]=f.useState(null),[u,N]=f.useState(()=>new Map),[j,k]=f.useState(()=>new Map),[C,M]=f.useState(""),[D,v]=f.useState(new Set),[S,F]=f.useState(null),[A,L]=f.useState(!0),[P,O]=f.useState(!1),[q,I]=f.useState(0),[H,B]=f.useState(0),Z=f.useRef(0),U=f.useMemo(()=>{var R;if(l!=="client")return"";try{return((R=Pt())==null?void 0:R.email)||""}catch{return""}},[l]);f.useEffect(()=>{const R=++Z.current;let W=!0;const $=()=>W&&R===Z.current,ie=(p&&o.token?o.token:"pub:"+a)+(c?":"+c:""),ae=ka(ie);return ae?(x(ae.objs.map(fe)),ae.fund&&y(ae.fund),g(ae.marketEstimate??null),m(ae.criteria??null),M(ae.generatedAt||""),L(!1)):L(!0),(async()=>{try{if(n==="ops"){const re=await Le(),ee=((re==null?void 0:re.recent_ops)||[]).map(X=>Me(X,a)).filter(X=>!!X);if(!$())return;x(ee.map(fe)),ze(ie,{objs:ee})}else if(typeof n=="object"){const ee=(await Ke()||[]).filter(K=>(K.slug||"")===n.research).map(K=>Qe(K,a)).filter(K=>!!K),X=De(await Je(ee,a));if(!$())return;x(X.map(fe)),ze(ie,{objs:X})}else if(p&&o.token){const re=Bt(o.token),ee=Le(),X=Ut(o.token),K=_t(o.token),ye=$t(o.token),_=await re;let ne=_?_.targets:[];$()&&_&&(y(_.fund||""),g(_.marketEstimate??null),m(_.criteria??null),M(_.generatedAt||""),x(ne.map(fe)),L(!1),O(!1));const[oe,xe,de,te]=await Promise.all([ee,X,K,ye]),Fe=((oe==null?void 0:oe.recent_ops)||[]).map(pe=>Me(pe,a)).filter(pe=>!!pe);if(ne=[...ne,...Fe],!$())return;x(ne.map(fe));const Ne=new Set;for(const pe of xe){const me=(pe.id||pe.co||"").toString().trim().toLowerCase();me&&Ne.add(me.startsWith("t:")?me:"t:"+me)}v(Ne),N(de),k(te),_&&ze(ie,{fund:_.fund,marketEstimate:_.marketEstimate,criteria:_.criteria,generatedAt:_.generatedAt,objs:ne})}else{const re=Ht(),ee=Ke(),X=Le(),K=await re;$()&&K.length&&(x(De(K).map(fe)),L(!1),O(!1));const[ye,_]=await Promise.all([ee,X]),ne=(ye||[]).map(te=>Qe(te,a)).filter(te=>!!te),oe=await Je(ne,a),xe=((_==null?void 0:_.recent_ops)||[]).map(te=>Me(te,a)).filter(te=>!!te),de=De([...K,...oe,...xe]);if(!$())return;x(de.map(fe)),ze(ie,{objs:de})}$()&&O(!1)}catch{$()&&!ae&&O(!0)}finally{$()&&L(!1)}})(),()=>{W=!1}},[p,o.token,a,q,c]),f.useEffect(()=>{if(!i.showCredits||!U){F(null);return}let R=!0;return(async()=>{try{const W=await fetch(`${Pe}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:U})});if(!W.ok)return;const $=await W.json();R&&$&&$.ok!==!1&&F($)}catch{}})(),()=>{R=!1}},[i.showCredits,U,H]);const G=f.useCallback(R=>v(new Set(R)),[]);return{session:o,mode:l,caps:i,fund:s,email:U,marketEstimate:b,generatedAt:C,criteria:w,thumbs:u,stages:j,dossiers:d,favIds:D,setFavIds:G,credits:S,reloadCredits:()=>B(R=>R+1),loading:A,error:P,refresh:()=>I(R=>R+1)}}const yt=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Ca=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...yt(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Sa(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(o=>o!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(o=>o!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:yt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Ee)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Ee=60;function He(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!Y(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(Be(t)))return!1;if(r!=="win"&&a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(he(t.date)>o)return!1}if(r!=="status"&&!n&&a.status!=="all"&&ce(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(o))return!1}return!0}function wt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:He(t,a.filters,n)}function za(t,a,n,r){return!(!wt(t,a,n)||n&&!Yt(t,a.ptab,r))}function Ve(t,a){const n=a.key,r=o=>{switch(n){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-he(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"signal":{const l=Y(o);return l?100-(l.left??0):-1}}};return[...t].sort((o,l)=>{const i=r(o),p=r(l);return i<p?-a.dir:i>p?a.dir:(o.name||"").localeCompare(l.name||"")})}function Ea(){const{dossiers:t,st:a,t:n,dispatch:r,contName:o,pipe:l}=E(),i=f.useMemo(()=>{const c=s=>l?!0:s.continent===a.continent,d=t.filter(s=>c(s)&&Y(s)),x=t.filter(s=>c(s)&&s.kind==="op"&&!Y(s)&&(s.dealKind==="ma"||s.dealKind==="levee")&&he(s.date)<=2);return x.sort((s,y)=>(y.amountEur||0)-(s.amountEur||0)),[...Ve(d,{key:"signal",dir:-1}),...x].slice(0,40)},[t,a.continent,l]),p=c=>i.map(d=>e.jsxs("button",{type:"button",className:"tk"+(Q(d)?" spent":""),onClick:x=>{const s=x.currentTarget.getBoundingClientRect();r({type:"popup",id:d.id,anchor:{x:s.left+s.width/2,y:s.bottom}})},title:d.name+(d.tagline?" — "+d.tagline:""),children:[e.jsx(ve,{o:d}),e.jsxs("span",{className:"who",children:[e.jsx(Ct,{o:d}),e.jsx("span",{className:"co",children:d.name})]}),typeof d.amountEur=="number"&&d.amountEur>0&&e.jsx("span",{className:"am",children:zr(d.amountEur)}),d.sector&&e.jsx("span",{className:"mt",children:d.sector}),e.jsx(Oe,{o:d}),e.jsx("span",{className:"tkgo",children:"→"})]},c+(d.id||d.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:i.length})]}),e.jsx("div",{className:"win",children:i.length?e.jsxs("div",{className:"run",children:[p(0),p(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(o)})})})]})}const Aa="aDx8z7Hzksus",kt="+33 6 83 10 72 86",ot="alexandre@proplace.co",Ta=`tel:${kt.replace(/[^\d+]/g,"")}`,lt="pp-rdv-slot";function Oa(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Fa(){const{t,caps:a,fund:n}=E(),r=a.showOnb,o=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:Ma}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:Ta,children:kt}),t.rdvSubMid,e.jsx("a",{href:`mailto:${ot}`,children:ot})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(o).map(([l,i],p)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(p+1)}),e.jsx("b",{children:l}),e.jsx("span",{children:i})]},l))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(pa,{filloutId:Aa,parameters:n?{company_name:n}:void 0})})]})}function La(){const[t,a]=f.useState(()=>typeof document>"u"?null:document.getElementById(lt));return f.useEffect(()=>{t||a(document.getElementById(lt))},[t]),t?Ae.createPortal(e.jsx(Fa,{}),t):null}const Ma=`
...
`,Ra=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Da({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:o}=E(),[l,i]=f.useState(""),[p,c]=f.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const d=(t.ceoStatus||"").trim(),x=(Te(t)||"").startsWith("CALL")&&J(t)===3,s=J(t)>=2,y=async g=>{if(l||g==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;i(g);const w=await o(t,g);i(""),w&&(c(!0),setTimeout(()=>c(!1),2200))},b=x?[["Validé",a.csYes],["Écarté",a.csNo]]:Ra.filter(([g])=>!(s&&g==="Retenu")).map(([g,w])=>[g,a[w]]);return e.jsxs("div",{className:"csp",onClick:g=>g.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([g,w])=>e.jsx("button",{type:"button",className:"csb"+(d===g?" on":"")+(l===g?" busy":""),disabled:!!l,onClick:()=>{y(g)},children:w},g)),p&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(qa,{o:t})]})}function qa({o:t}){const{t:a,saveNote:n,flash:r}=E(),[o,l]=f.useState(t.ceoNote||""),[i,p]=f.useState(!1),[c,d]=f.useState(!1),x=o.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(i||!x)return;p(!0);const y=await n(t,o.trim());p(!1),y&&(d(!0),setTimeout(()=>d(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:i,onChange:y=>l(y.target.value),onKeyDown:y=>{y.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:i||!x,onClick:()=>{s()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Ia({placeholder:t,onDone:a}){const{t:n}=E(),[r,o]=f.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:l=>o(l.target.value),onKeyDown:l=>{l.key==="Enter"&&a(r.trim()),l.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Pa({o:t}){var m;const{t:a,token:n,caps:r,canWrite:o,stageOf:l,setStage:i,flashErr:p}=E(),[c,d]=f.useState(!1);if(!r.pipe||!o||r.lockActions||J(t)!==4)return null;const x=l(t),s=(x==null?void 0:x.stage)||"todo",y=async u=>{if(c||u===s)return;d(!0);const N=x;i(t,{stage:u,stamps:(x==null?void 0:x.stamps)||{}});const j=Math.max(Date.now(),it+=1);it=j;const k=await Gt(n,{company:t.name||"",stage:u,cts:j,deal_id:t.airtableId,check_id:t.checkId});d(!1),!k.stale&&(k.ok||(i(t,N),p(a.actErr)))},b=(m=x==null?void 0:x.stamps)==null?void 0:m.sent,g=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=s==="sent"&&b&&g>=4;return e.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,N])=>e.jsx("button",{type:"button",className:"stgb"+(s===u?" on":""),disabled:c,onClick:()=>{y(u)},children:N},u)),w&&e.jsx("span",{className:"stgj4",children:a.j4Badge(g)})]})}let it=0;function Ba(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:o}=E(),l=f.useMemo(()=>t.filter(s=>he(s.date)===0&&s.kind==="target"),[t]),i=f.useMemo(()=>l.filter(s=>a?J(s)===0:!Q(s)),[l,a]),p=l.length-i.length,c=l.length?Math.min(100,p/l.length*100):100;let d;a?d=n.morningThesis(l.length,p,i.length):l.length?p===0?d=n.goalSourced(l.length):p>=l.length?d=n.goalCleared:d=n.goalDone(p,l.length):d=n.goalSourced(0);const x=()=>{a?(o({type:"ptab",tab:0}),o({type:"filters",patch:{win:"1"}})):o({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:d}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:c+"%"}})}),i.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:x,children:a?n.morningEval(i.length):r.pileMode?n.goalContinue(i.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Ua(){var S;const{t,st:a,dispatch:n,token:r,fund:o,data:l,dossiers:i,mode:p,doSync:c}=E(),[d,x]=f.useState(null),[s,y]=f.useState([]),[b,g]=f.useState(!1),w=p==="client";f.useEffect(()=>{if(!r||!o)return;let F=!0;return(async()=>{const[A,L]=await Promise.all([xt(o),mt(r)]);F&&(A&&x(A),y(L))})(),()=>{F=!1}},[r,o]);const m=(d==null?void 0:d.per_day)??null,u=((S=d==null?void 0:d.pool_order)==null?void 0:S.length)??0,N=s.filter(F=>F.status==="running").length,j=F=>{if(!w||m===null||b)return;const A=Math.max(0,Math.min(10,m+F));A!==m&&(g(!0),x(L=>L&&{...L,per_day:A}),gt(r,A).then(L=>{g(!1),x(L===null?P=>P&&{...P,per_day:m}:P=>P&&{...P,per_day:L})}))},k=f.useMemo(()=>i.filter(F=>F.kind==="target"&&Q(F)).length,[i]),C=l.marketEstimate,M=C&&C>0?Math.min(100,Math.round(k/C*100)):null,D=(o||"P").split(/\s+/).map(F=>F[0]).join("").slice(0,2).toUpperCase(),v=(()=>{const F=Date.parse(l.generatedAt||"");if(Number.isNaN(F))return"";const A=new Date(F),L=P=>String(P).padStart(2,"0");return`${L(A.getDate())}/${L(A.getMonth()+1)} à ${L(A.getHours())}:${L(A.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:D}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),v&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(v)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.identTuto,onClick:()=>n({type:"modal",modal:"tuto"}),children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[M!==null&&C&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:M+"%"}})}),e.jsxs("b",{children:[M," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(k,C)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),m!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:F=>{F.stopPropagation(),j(-1)},children:"−"}),e.jsx("b",{className:"q",children:m})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:F=>{F.stopPropagation(),j(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),m===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),N>0&&e.jsxs("span",{className:"ev",children:["⏳ ",N]}),e.jsx("span",{className:"ego",children:t.identPending(u)})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!w,onClick:c,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:F=>n({type:"filters",patch:{search:F.target.value}})})]})]})]})}function _a(){const{t,counts:a,dispatch:n}=E();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,o],l)=>{const i=l===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(i?" go":""),children:[e.jsx("span",{className:"s4n",children:l+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:o}),i&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},l)})})]})}const $a=["--p0","--p1","--p2","--p3","--p4"];function Ha(){const{st:t,dispatch:a,counts:n,t:r,doUndo:o}=E(),l=f.useRef({});f.useEffect(()=>{l.current={...n}},[n]);const i=d=>{const x=l.current[d],s=x!==void 0?n[d]-x:0;return e.jsxs("button",{type:"button",className:"step"+(d===3&&n[3]>0?" wait":""),style:{"--c":`var(${$a[d]})`,"--tc":d<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===d,title:r.phelp[d],onClick:()=>a({type:"ptab",tab:d}),children:[e.jsxs("span",{className:"l",children:[r.plabels[d].toUpperCase(),d===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[d],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},d)},p=(d,x,s)=>e.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":d===5?"var(--p5)":d===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===d,title:r.phelp[d],onClick:()=>a({type:"ptab",tab:d}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[d]})]},d),c=(d,x,s,y=!1)=>e.jsx("button",{type:"button",className:"tool",title:x,disabled:y,onClick:s,children:d},x);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(i)}),e.jsxs("div",{className:"offtrack",children:[p(5,!1,r.plabels[5]),p(7,!0,r.plabels[7]),p(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[c("↩",r.toolUndo,o,t.undo.length===0),c("↺",r.toolReset,()=>{a({type:"reset"})}),c("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),c("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),c("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Va=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Ya(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:o,doAnalyse:l,mode:i}=E(),p=f.useRef(null),[c,d]=f.useState(60);f.useEffect(()=>{let b=0;const g=()=>{var j;const w=p.current;if(!w)return;const m=(j=w.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!m)return;const u=m.getBoundingClientRect(),N=w.getBoundingClientRect();d(Math.max(20,Math.min(u.left+u.width/2-N.left,N.width-30)))};return b=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",g)}},[t.ptab]);const x=t.ptab;let s=n.tuto[x].p;if(x===3){const b=r.filter(m=>m.kind==="target"&&J(m)===3),g=b.filter(m=>qe(m)==="auto").length,w=b.filter(m=>qe(m)==="cd").length;s=n.tutoPending(g,w,b.length)}const y=(()=>{if(i!=="client")return null;if(x===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(x===1){const b=r.filter(g=>g.kind==="target"&&J(g)===1&&!o.has(g.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(g=>l(g))}}return null})();return e.jsxs("div",{ref:p,className:"tuto mini",style:{"--bg":Va[x],"--ax":c+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[x].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),y&&e.jsx("button",{type:"button",className:"tprim",onClick:y.run,children:y.label})]})}const st=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function dt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Ga(t,a){const[n,r]=f.useState(1);return f.useEffect(()=>{let o=!0,l=0;const i=()=>{var d;if(!o)return;const c=(d=t.current)==null?void 0:d.getScreenCTM();c&&c.a>0?r(c.a):l=requestAnimationFrame(i)};i();const p=new ResizeObserver(()=>i());return t.current&&p.observe(t.current),window.addEventListener("resize",i),()=>{o=!1,cancelAnimationFrame(l),p.disconnect(),window.removeEventListener("resize",i)}},[t,a]),n}function Wa(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:o,markedId:l,byId:i,lang:p,t:c}=E(),d=f.useRef(null),x=f.useRef(null),s=Ue.find(v=>v.key===t.continent),y=Ga(d,t.continent+":"+t.mapFolded),[b,g]=f.useState(new Map),[w,m]=f.useState(null);f.useEffect(()=>{const v=d.current;if(!v)return;const S=new Map;v.querySelectorAll("path[data-i2]").forEach(F=>{const A=F.dataset.i2;if(A)try{const L=F.getBBox();L.width>0&&S.set(A,{x:L.x,y:L.y,w:L.width,h:L.height})}catch{}}),g(S)},[t.continent,y]);const u=f.useMemo(()=>n.filter(v=>v.cc),[n]),N=f.useMemo(()=>{const v=new Map;return u.forEach(S=>v.set(S.cc,(v.get(S.cc)||0)+1)),v},[u]),j=f.useMemo(()=>u.map(v=>{const S=v.cc?b.get(v.cc):void 0;if(!S)return null;const F=dt(v.name||v.id||""),A=dt((v.id||v.name||"")+"·y"),L=(F-.5)*Math.min(S.w*.55,60),P=(A-.5)*Math.min(S.h*.55,60);return{d:v,x:S.x+S.w/2+L,y:S.y+S.h/2+P}}).filter(v=>!!v),[u,b]),k=v=>y>0?v/y:v,C=f.useMemo(()=>r?[0,1,2,3,4,5].map(v=>({c:st[v],fr:c.plabels[v].toUpperCase(),en:c.plabels[v].toUpperCase(),n:n.filter(S=>S.kind==="target"&&J(S)===v).length})).filter(v=>v.n>0):Xe.map((v,S)=>({...v,n:n.filter(F=>Ze(F)===S).length})),[n,r,c.plabels]),M=l?i.get(l):null,D=M?j.find(v=>v.d.id===M.id):null;return e.jsxs("div",{className:"mapzone",ref:x,children:[e.jsxs("svg",{ref:d,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":p==="fr"?s.fr:s.en,onMouseLeave:()=>{m(null),o(null)},children:[e.jsx("g",{children:s.countries.map((v,S)=>e.jsx("g",{className:"ct"+(v.i2&&N.get(v.i2)?"":" empty"),children:e.jsx("path",{d:v.d,"data-i2":v.i2||void 0})},S))}),e.jsx("g",{children:j.map(v=>{const S=Xe[Ze(v.d)],F=!!Y(v.d),A=v.d.kind==="target",L=r&&A?st[J(v.d)]:S.c,P=!r&&Q(v.d);return e.jsxs("g",{className:"co"+(P?" done":""),onMouseEnter:()=>{var I,H;const O=(I=x.current)==null?void 0:I.getBoundingClientRect(),q=(H=d.current)==null?void 0:H.createSVGPoint();if(q&&d.current&&O){q.x=v.x,q.y=v.y;const B=q.matrixTransform(d.current.getScreenCTM());m({x:B.x-O.left,y:B.y-O.top,label:v.d.name+" · "+(be(v.d.cc,p)||v.d.countryLabel||"")})}o(v.d.id)},onMouseLeave:()=>{m(null),o(null)},onClick:()=>{var I;const O=(I=d.current)==null?void 0:I.createSVGPoint();let q=null;if(O&&d.current){O.x=v.x,O.y=v.y;const H=O.matrixTransform(d.current.getScreenCTM());q={x:H.x,y:H.y}}a({type:"popup",id:v.d.id,anchor:q})},children:[e.jsx("circle",{className:"h",cx:v.x,cy:v.y,r:k(Math.max(11,S.px+7))}),e.jsx("circle",{className:"v",cx:v.x,cy:v.y,r:k(S.px),fill:L,stroke:F?"#DC2626":"#ffffff",strokeWidth:k(F?2.2:1.3)})]},v.d.id||v.d.name)})}),D&&e.jsx("circle",{className:"ring on",cx:D.x,cy:D.y,r:k(13),fill:"none",stroke:"#0F172A",strokeWidth:k(2)})]}),e.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),e.jsx("div",{className:"legend",children:C.map((v,S)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":v.c}}),p==="fr"?v.fr:v.en," ",e.jsx("b",{children:v.n})]},S))}),n.some(v=>!v.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",c.notLocated," ",e.jsx("b",{children:n.filter(v=>!v.cc).length})]})})]})}function Ka(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:o,contName:l}=E(),i=t.filters,p=f.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),c=b=>p.filter(g=>b!=="country"&&i.country.length&&!i.country.includes(g.cc||"")?!1:He(g,i,o,b==="country"?void 0:b)),d=f.useMemo(()=>{const b=c("win"),g=w=>b.filter(m=>(m.date?Math.max(0,Math.floor((Date.now()-Date.parse(m.date))/864e5)):9999)<=w).length;return[g(0),g(7),g(30),b.length]},[p,i,o]),x=f.useMemo(()=>{if(o)return null;const b=c("status"),g={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(w=>{g[ce(w)]+=1}),g},[p,i,o]),s=i.sector.length+i.country.length+i.engine.length+i.stage.length+i.angle.length+i.memoLevel.length+(i.signalOnly?1:0)+(i.win!=="all"?1:0)+(!o&&i.status!=="all"?1:0)+(i.search.trim()?1:0),y=(b,g,w,m="fbtn")=>e.jsxs("button",{type:"button",className:m,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:g}),w>0&&e.jsx("span",{className:"n",children:w}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,g)=>e.jsxs("button",{type:"button","aria-pressed":i.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[g],e.jsx("b",{children:d[g]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:i.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!o&&x&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,g])=>e.jsxs("button",{type:"button","aria-pressed":i.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[g,e.jsx("b",{children:x[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),i.signalOnly&&e.jsx("span",{className:"n",children:i.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),y("sec",r.fSector,i.sector.length),y("pay",r.fCountry,i.country.length),y("det",r.fEngine,i.engine.length),y("sta",r.fStage,i.stage.length),o&&y("ang","Angle",i.angle.length),o&&y("mem","Mémo",i.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(p.length,l),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(Qa,{poolFor:c})]})}function Qa({poolFor:t}){const{st:a,dispatch:n,t:r,lang:o}=E(),l=a.filters,i=a.openFacet,{title:p,cols:c,options:d}=f.useMemo(()=>{if(i==="sig"){const g=t("signal").filter(u=>Y(u)),w=new Map;g.forEach(u=>{const N=u.engine||"";w.set(N,(w.get(N)||0)+1)});const m=[{v:"*",label:r.fpSigAll,n:g.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...et([...w.keys()],o).map(u=>({v:u,label:ge(u)+" "+se(u,o),n:w.get(u)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(u)}))];return{title:r.fpSigTitle,cols:2,options:m}}if(i==="sec"){const g=t("sector"),w=new Map;return g.forEach(m=>{m.sector&&w.set(m.sector,(w.get(m.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...w.entries()].sort((m,u)=>u[1]-m[1]).map(([m,u])=>({v:m,label:m,n:u,html:!1,on:l.sector.includes(m)}))}}if(i==="pay"){const g=t("country"),w=new Map;return g.forEach(m=>{m.cc&&w.set(m.cc,(w.get(m.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...w.entries()].sort((m,u)=>u[1]-m[1]).map(([m,u])=>({v:m,label:be(m,o)||m,n:u,html:!1,on:l.country.includes(m)}))}}if(i==="det"){const g=t("engine"),w=new Map;return g.forEach(m=>{m.engine&&w.set(m.engine,(w.get(m.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:et([...w.keys()],o).map(m=>({v:m,label:ge(m)+" "+se(m,o)+' <span style="color:var(--dim);font-size:10px">· '+Wt(Kt(m),o)+"</span>",n:w.get(m)||0,html:!0,on:l.engine.includes(m)}))}}if(i==="ang"){const g=t("angle"),w=new Map;return g.forEach(m=>{m.angle&&w.set(m.angle,(w.get(m.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...w.entries()].sort((m,u)=>u[1]-m[1]).map(([m,u])=>({v:m,label:m.replace(/[_-]+/g," "),n:u,html:!1,on:l.angle.includes(m)}))}}if(i==="mem"){const g=t("memoLevel"),w=new Map;g.forEach(u=>{if(u.kind==="target"){const N=Be(u);w.set(N,(w.get(N)||0)+1)}});const m=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(u=>({v:String(u),label:m[u],n:w.get(u)||0,html:!1,on:l.memoLevel.includes(u)}))}}const y=t("stage"),b=new Map;return y.forEach(g=>{g.stage&&b.set(g.stage,(b.get(g.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((g,w)=>w[1]-g[1]).map(([g,w])=>({v:g,label:g,n:w,html:!1,on:l.stage.includes(g)}))}},[i,a,o]),x=y=>{if(i==="sig"){if(y==="*")n({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const g=l.signalEngines.includes(y)?l.signalEngines.filter(w=>w!==y):[...l.signalEngines,y];n({type:"filters",patch:{signalOnly:!0,signalEngines:g}})}return}if(i==="mem"){n({type:"toggleMemoLevel",value:Number(y)});return}n({type:"toggleFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage",value:y})},s=()=>{n(i==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:i==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:p}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(c===2?" two":""),children:d.map(y=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":y.on,onClick:()=>x(y.v),children:[e.jsx("span",{className:"bx"}),y.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:y.label}}):e.jsx("span",{className:"l",children:y.label}),e.jsx("span",{className:"n",children:y.n})]},y.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const pt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Ja(){const{t,mode:a,token:n,askEvaluate:r,sessTally:o,dispatch:l,evalBusy:i,evalCards:p,caps:c,data:d}=E(),x=a==="client",[s,y]=f.useState(""),[b,g]=f.useState(!1),[w,m]=f.useState(""),[u,N]=f.useState(!1),[j,k]=f.useState(""),[C,M]=f.useState([]),D=f.useRef(!1),v=s.trim()?pt.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,S=f.useMemo(()=>w.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[w]),F=C.length?C:p,A=d.credits,L=()=>{const O=s.trim();O&&(r(null,O),y(""))},P=async()=>{if(!x){r(null,S[0]||"");return}if(!S.length||u)return;N(!0),D.current=!1;const O=[];for(let q=0;q<S.length&&!D.current;q++){k(t.evaluating(q+1,S.length,S[q]));const I=await ht(n,S[q],"atelier2");if(O.unshift({name:I.company||S[q],verdict:I.verdict,reason:I.reason||"",remaining:I.remaining??null}),M([...O]),I.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:t.quota(S.length-q-1),remaining:0}),M([...O]);break}}k(""),m(""),N(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:O=>y(O.target.value),onKeyDown:O=>{O.key==="Enter"&&L()}}),e.jsx("span",{className:"detect"+(pt.test(s.trim())?" url":""),children:v})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),disabled:i,onClick:L,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),c.showCredits&&A&&e.jsxs("button",{type:"button",className:"credits"+(A.total_available<=0&&!A.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:A.unlimited?"∞":A.total_available}),!A.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",A.daily_grant+A.purchased]}),A.total_available<=0&&!A.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>g(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:w,placeholder:t.bulkPh,onChange:O=>m(O.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{justifyContent:"center"},disabled:u||!S.length,onClick:()=>{P()},children:[e.jsx("span",{className:"fill"}),u&&j?j:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(S.length)})]})]}),F.slice(0,1).map((O,q)=>{const I=O.verdict==="kept",H=O.verdict==="quota",B=I?"var(--brand)":H?"var(--bolt)":"var(--red)",Z=I?"var(--brand-l)":H?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":B,"--bgc":Z},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:I?"✓ "+t.kept:H?"⏳":"✗ "+t.dropped})}),O.name&&e.jsx("span",{className:"rn",children:O.name}),e.jsx("span",{className:"rr",children:O.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",O.reason]}):null}),!H&&e.jsx("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"space"}),children:t.seeSpace(I?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},q)}),x&&(o.kept+o.dropped>0||F.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(o.kept,o.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Xa(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Za(){const{st:t,dispatch:a,byId:n,t:r,doDeep:o}=E(),l=t.memoConsole?n.get(t.memoConsole):null,i=f.useMemo(()=>l?[l.reasoning||"",Xa(l.summary||"")].filter(Boolean).join(`

`):"",[l]);if(!l)return null;const p=Te(l),c=Be(l);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:l.name}),p&&e.jsx("span",{className:"vv",children:p}),typeof l.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[l.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:r.memoSynth})}),e.jsx("div",{className:"mb2",children:i?i.split(`

`).map((d,x)=>e.jsx("p",{style:{margin:"0 0 10px"},children:d},x)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[_e(l)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>o(l),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:c===2?r.critMemoKinds:""}),l.memoUrl&&e.jsx("a",{className:"go",href:l.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}const jt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ye({o:t}){const{t:a}=E(),n=Ie(t),r=Te(t),o=J(t),l=qe(t),i=Qt(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(jt[r]||"v-cons"),title:a.vt[r],children:r}):o===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,o===3&&l==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),o===3&&l==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),o===3&&i!==null&&e.jsx("span",{className:"wait2 "+(i>10?"hot":i>=5?"warm":""),title:a.waitTitle(i),children:a.waitChip(i)})]})}function ct({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:o}=E(),[l,i]=f.useState(!1);if(f.useEffect(()=>{r||i(!1)},[r]),Q(t)){const d=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":d?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[d?"✓":"✗"," ",e.jsx("b",{children:d?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const c=l&&r;return e.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:r,onClick:d=>{d.stopPropagation(),i(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function er({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:o,doAnalyse:l,doDecide:i,doPromote:p,doRepeche:c,doApproach:d,dispatch:x}=E();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),x({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(ct,{o:t})});const s=J(t),y=b=>g=>{g.stopPropagation(),b()};if(s===0)return e.jsx("span",{className:"cell",children:e.jsx(ct,{o:t})});if(s===1){const b=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:y(()=>l(t)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(s===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:y(()=>i(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:y(()=>i(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:y(()=>x({type:"memoConsole",id:t.id})),children:"📄"})]})});if(s===4){const b=o.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:b,onClick:y(()=>d(t)),children:b?a.actApproachSent:a.actApproach})})}return s===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:y(()=>p(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:y(()=>x({type:"memoConsole",id:t.id})),children:"📄"})]})}):s===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:y(()=>c(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:y(()=>x({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:y(()=>x({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function tr({o:t}){const{t:a,doThumb:n,thumbOf:r}=E(),o=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:l=>{l.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:l=>{l.stopPropagation(),n(t,!1)},children:"👎"})]})}function ar({o:t}){const{lang:a}=E();return Y(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(ve,{o:t}),e.jsx(Oe,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[ge(t.engine||"")," ",se(t.engine||"",a)]})})}function rr({o:t,locked:a,open:n,onToggle:r}){const{st:o,dispatch:l,caps:i,markRow:p,markedId:c,favIds:d,toggleFav:x}=E(),s=J(t),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,g=b<=0?0:b<=7?1:b<=30?2:3,w=i.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][s]:y[g],m=d.has(t.id),u=N=>{if(a)return;if(i.pipe){r();return}const j=N.currentTarget.getBoundingClientRect();l({type:"popup",id:t.id,anchor:{x:j.left+Math.min(280,j.width/3),y:j.bottom}})};return e.jsxs(f.Fragment,{children:[e.jsxs("div",{className:"row"+(c===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>p(t.id),onMouseLeave:()=>p(null),onClick:u,children:[e.jsx("span",{className:"pt",style:{"--c":w}}),e.jsx(Ct,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[i.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:m?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),x(t)},children:m?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(N=>N&&N!==t.name)||""})]}),e.jsx(nr,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(ar,{o:t}),i.pipe&&e.jsx(Ye,{o:t}),i.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(er,{o:t}),i.showThumbs&&e.jsx(tr,{o:t})]}),(n||o.dens==="deplie")&&!a&&e.jsx(or,{o:t})]})}function nr({o:t}){const{lang:a,caps:n}=E();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=$e(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function or({o:t}){const{t:a,lang:n,dispatch:r,caps:o,outbound:l,doOnboard:i}=E();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),t.reasoning&&e.jsxs("div",{className:"dec"+(Ie(t)==="NO MATCH"?" out":""),title:t.reasoning,children:[e.jsx("em",{children:Ie(t)==="NO MATCH"?a.vOut:a.vKept}),t.reasoning.length>340?`${t.reasoning.slice(0,340)}…`:t.reasoning]}),t.ceoNote&&e.jsxs("div",{className:"ceonote",children:["💬 ",e.jsx("i",{children:t.ceoNote})]}),e.jsx(Da,{o:t}),e.jsx(Pa,{o:t}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(Ye,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[ge(t.engine||"")," ",se(t.engine||"",n)]}),Y(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(ve,{o:t})})]}),o.pipe&&(t.memoUrl||l)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),l&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>i(t),children:a.actOnboard})]})]})]})}function lr({o:t,locked:a}){const{t:n,dispatch:r,caps:o,doDecide:l}=E(),i=J(t),p=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][i];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":p},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(Ye,{o:t}),Y(t)&&e.jsx(ve,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&o.pipe&&i===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function ir(){const t=E(),{st:a,dispatch:n,t:r,caps:o,scoped:l,lang:i,sessTally:p}=t,[c,d]=f.useState(new Set);f.useEffect(()=>{d(new Set)},[a.ptab,a.continent]);const x=j=>d(k=>{const C=new Set(k);return C.has(j)?C.delete(j):C.add(j),C}),s=f.useMemo(()=>Ve(l,a.sort),[l,a.sort]),y=f.useMemo(()=>s.filter(j=>Y(j)&&!Q(j)).length,[s]),b=o.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,g=(j,k,C="",M=!1)=>e.jsxs("button",{type:"button","data-s":j,className:C,"aria-sort":a.sort.key===j?a.sort.dir===1?"ascending":"descending":"none",style:M?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:j}),children:[k,e.jsx("span",{className:"ar",children:a.sort.key===j&&a.sort.dir===1?"▴":"▾"})]},j),w=f.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const j=new Map;return s.forEach(k=>{const C=k.engine||"?";j.has(C)||j.set(C,[]),j.get(C).push(k)}),[...j.entries()]},[s,o.pipe,a.groupBy]),m=o.lockRowsAfter;let u=0;const N=(j,k)=>{const C=a.shown[k]||Ee,D=j.slice(0,C).map(v=>{const S=m!==null&&u>=m;return u++,a.dens==="maxi"?e.jsx(lr,{o:v,locked:S},v.id):e.jsx(rr,{o:v,locked:S,open:c.has(v.id),onToggle:()=>x(v.id)},v.id)});return j.length>C&&D.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:k,by:Ee}),children:r.more(Math.min(Ee,j.length-C),j.length-C)},k+":more")),D};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:s.length})," ",b]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,o.pipe&&t.fund?" · "+t.fund:""]}),o.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),o.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([j,k])=>e.jsxs("button",{type:"button","data-d":j,"aria-pressed":a.dens===j,onClick:()=>n({type:"dens",dens:j}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:k})]},j))}),o.showChain&&s.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:s.filter(j=>o.pipe?!0:!Q(j)).map(j=>j.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",o.pipe?r.browse(s.length):r.chainAll(s.filter(j=>!Q(j)).length)]})]}),y>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(y)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),g("country",r.colCountry),g("name",r.colCompany),g("amount",r.colAmount,"h-amt",!0),g("stage",r.colStage,"h-stade"),g("signal",r.colSignal,"h-sig"),o.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),o.pipe&&g("score",r.colScore,"h-sc",!0),e.jsx("span",{}),o.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[w?w.map(([j,k])=>e.jsxs(f.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:ge(j)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:se(j,i)}),e.jsx("div",{className:"s",children:r.grpCount(k.filter(C=>!Q(C)).length,k.length)})]})]}),N(k,j)]},j)):N(s,"pt"+a.ptab),!s.length&&e.jsx("div",{className:"void",children:o.pipe?r.emptyTab:r.emptyScope})]}),o.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(p.kept>0||p.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(p.kept,p.dropped)}})]})}const sr=`
...
`;function dr(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let i=t.y+10;return i+n>o-8&&(i=Math.max(8,t.y-n-14)),i<8&&(i=8),{left:l,top:i}}function pr(){const{st:t,dispatch:a,byId:n,t:r,lang:o,caps:l,mode:i,askEvaluate:p,doAnalyse:c,doDecide:d,doPromote:x,doRepeche:s,doApproach:y,doDeep:b,doOnboard:g,outbound:w,evalBusy:m}=E(),u=t.popupId?n.get(t.popupId):null;if(!u)return null;const N=Y(u),j=J(u),k=Te(u),C=u.kind==="target",M=D=>{a({type:"filters",patch:D}),a({type:"popup",id:null})};return Ae.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:sr}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:dr(t.popupAnchor),onClick:D=>D.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:u.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(he(u.date)),se(u.engine,o))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[u.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>M({country:[u.cc]}),children:(be(u.cc,o)||u.countryLabel||"").toUpperCase()}),u.sector&&e.jsx("button",{type:"button",onClick:()=>M({sector:[u.sector]}),children:u.sector.toUpperCase()}),u.stage&&e.jsx("button",{type:"button",onClick:()=>M({stage:[u.stage]}),children:u.stage.toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{className:"am2",children:$e(u.amountEur,o)})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[ge(u.engine)," ",e.jsx("b",{children:se(u.engine,o)})," — ",Jt(u.engine,o),u.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",u.noteTitle]})]}),N?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(ve,{o:u,lg:!0})," ",e.jsx(Oe,{o:u,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(bt(N,o))," · ",r.win7(vt(N,o))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:l.pipe&&j>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),l.pipe&&C&&k&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[k,typeof u.score=="number"&&u.score>0?" · "+r.score(u.score):""]})})]}),e.jsxs("div",{className:"pf",children:[l.lockActions||i!=="client"&&l.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):l.pipe?e.jsxs(e.Fragment,{children:[j===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:m,onClick:()=>p(u),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),j===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),j===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),j===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(u,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{d(u,!1),a({type:"popup",id:null})},children:r.actNo}),_e(u)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{b(u),a({type:"popup",id:null})},children:r.memoDeep})]}),j===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{y(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),j===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),u.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:u.id}),a({type:"popup",id:null})},children:"📄"}),w&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{g(u),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:m,onClick:()=>p(u),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),u.website&&e.jsx("a",{className:"psite",href:u.website.startsWith("http")?u.website:"https://"+u.website,target:"_blank",rel:"noopener noreferrer",title:u.website,children:"🌐"})]})]})]}),document.body)}const je="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function le({title:t,icon:a,children:n,wide:r}){const{dispatch:o}=E();return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:l=>{l.target===l.currentTarget&&o({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function cr(){const{st:t}=E();switch(t.modal){case"chain":return e.jsx(fr,{});case"space":return e.jsx(xr,{});case"alert":return e.jsx(mr,{});case"queue":return e.jsx(br,{});case"export":return e.jsx(vr,{});case"plug":return e.jsx(yr,{});case"recharge":return e.jsx(wr,{});case"cover":return e.jsx(kr,{});case"crit":return e.jsx(jr,{});case"tuto":return e.jsx(Nr,{});case"rdv":return e.jsx(ur,{});default:return null}}function ur(){const{dispatch:t,fund:a}=E(),n=typeof document<"u"&&!!document.getElementById("rdv");return f.useEffect(()=>{n&&(t({type:"modal",modal:null}),Oa())},[n,t]),n?null:e.jsx(Xt,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function fr(){const{st:t,dispatch:a,byId:n,t:r,lang:o,mode:l,askEvaluate:i,evalBusy:p}=E(),c=l==="client",d=t.chain.queue.map(b=>n.get(b)).filter(b=>!!b),x=t.chain.idx,s=d[x],y=x>=d.length;return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:y?r.finished:`${x+1} / ${d.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(y?100:x/Math.max(1,d.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:y||!s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(d.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:s.name}),e.jsx("div",{className:"sub",children:[be(s.cc,o)||s.countryLabel,s.sector,s.stage,r.daysAgo(he(s.date))].filter(Boolean).map(b=>String(b).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:se(s.engine,o).toUpperCase()}),typeof s.amountEur=="number"&&s.amountEur>0&&e.jsx("span",{children:$e(s.amountEur,o)})]}),Y(s)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(ve,{o:s,lg:!0})," ",e.jsx(Oe,{o:s,src:!0})]}),(s.tagline||s.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:s.tagline||s.headline})]}),s.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:s.reasoning})]}),c&&Q(s)&&e.jsxs("div",{className:"vbox",style:{"--c":ce(s)==="retenu"?"var(--brand)":ce(s)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:ce(s)==="retenu"?"✓ "+r.kept:ce(s)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:s.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!y&&s&&!(c&&Q(s))&&e.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:p,onClick:()=>{i(s)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(y?{type:"modal",modal:null}:{type:"chainNext"}),children:y?r.closeBtn:r.skip})]})]})})}),document.body)}function xr(){const{st:t,dispatch:a,dossiers:n,t:r,mode:o}=E(),l=o==="client",i=f.useMemo(()=>l?n.filter(s=>Q(s)):[],[n,l]),p=f.useMemo(()=>Ve(i.filter(s=>ce(s)==="retenu"),{key:"signal",dir:-1}),[i]),c=f.useMemo(()=>i.filter(s=>ce(s)==="ecarte"),[i]),d=t.spaceTab==="retenu"?p:c,x=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(le,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:p.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:c.length})]})]}),d.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),d.slice(0,40).map(s=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":x},children:typeof s.score=="number"&&s.score>0?s.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:s.name}),e.jsx("div",{className:"rr",children:s.reasoning||s.tagline||""})]})]},s.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function mr(){const{mode:t}=E();return t==="client"||t==="apercu"?e.jsx(gr,{}):e.jsx(hr,{})}function gr(){const{t,token:a,flash:n,mode:r}=E(),[o,l]=f.useState(null),i=r!=="client";f.useEffect(()=>{let c=!0;return rt(a).then(d=>{c&&l(d)}),()=>{c=!1}},[a]);const p=c=>{i||rt(a,c).then(d=>{d&&(l(d),n(t.alertSaved))})};return e.jsx(le,{title:t.alertTitle,icon:"🔔",children:o?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:i,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>p({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>p({hour:Math.max(6,(o.hour??7)-1)}),disabled:i,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>p({hour:Math.min(21,(o.hour??7)+1)}),disabled:i,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:i,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>p({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:i,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>p({days:"daily"}),children:t.alertEveryday})]})]}),o.email_lead&&e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]})]}):e.jsx("div",{className:"sp-empty",children:"…"})})}function hr(){const{st:t,t:a,lang:n,scoped:r,contName:o}=E(),[l,i]=f.useState(""),[p,c]=f.useState(!1),[d,x]=f.useState(!1),s=t.filters,y=f.useMemo(()=>r.filter(m=>Y(m)).length,[r]),b=s.win==="1"?0:s.win==="7"?1:s.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){x(!0);try{await fetch(`${Pe}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:s.sector,countries:s.country,source:"atelier2",website:""})}),c(!0)}finally{x(!1)}}},w=[[a.amRows.continent,o],[a.amRows.since,a.amSince[b]],[a.amRows.signal,s.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,s.engine.length?s.engine.map(m=>se(m,n)).join(", "):a.amAllEngines],[a.amRows.sectors,s.sector.length?s.sector.join(", "):a.amAllSectors],[a.amRows.countries,s.country.length?s.country.map(m=>be(m,n)||m).join(", "):a.amAllCountries],[a.amRows.stages,s.stage.length?s.stage.join(", "):a.amAllStages]];return e.jsx(le,{title:a.alertTitle,icon:"🔔",children:p?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:w.map(([m,u])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:m}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:u}})]},m))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,onChange:m=>i(m.target.value),onKeyDown:m=>{m.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,y)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function br(){var w,m,u;const{t,token:a,fund:n,mode:r,flash:o}=E(),[l,i]=f.useState(null),[p,c]=f.useState([]),[d,x]=f.useState(0),s=r==="client";f.useEffect(()=>{let N=!0;return(async()=>{const[j,k]=await Promise.all([xt(n),mt(a)]);N&&(j&&i(j),c(k))})(),()=>{N=!1}},[a,n,d]);const y=(l==null?void 0:l.per_day)??2,b=((w=l==null?void 0:l.analyzed_today)==null?void 0:w.length)??0,g=(m=l==null?void 0:l.tomorrow)!=null&&m.length?l.tomorrow:((l==null?void 0:l.pool_meta)||[]).slice(0,10);return e.jsxs(le,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(b,b+(((u=l==null?void 0:l.pool_order)==null?void 0:u.length)??0))}})}),e.jsx("div",{className:"qrate",children:t.queueRate}),e.jsx("div",{className:"qrates",children:[1,2,3,5,10].map(N=>e.jsx("button",{type:"button",className:"qr"+(y===N?" on":""),disabled:!s,onClick:()=>{gt(a,N).then(j=>{j!==null&&(x(k=>k+1),o(t.alertSaved))})},children:e.jsxs("b",{children:[N,"/j"]})},N))})]}),p.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:p.map(N=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:N.company}),e.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),e.jsx("span",{className:"qt",children:N.status}),N.url&&e.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),s&&N.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{at(a,N.company,"retry").then(()=>x(j=>j+1))},children:t.queueRetry}),s&&N.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{at(a,N.company,"delete").then(()=>x(j=>j+1))},children:t.queueDelete})]},N.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[g.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),g.slice(0,10).map((N,j)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",j+1]}),e.jsx("b",{children:N.name}),typeof N.score=="number"&&e.jsx("span",{className:"qs2",children:N.score})]},N.name))]})]})}function vr(){const{t,token:a,flash:n}=E(),r=`${je}/cibles/list.csv?token=${a}`,o=`${je}/cibles/list.json?token=${a}`,l=`${je}/cibles/export.xlsx?token=${a}&scope=full`,i=`=IMPORTDATA("${r}")`,p=d=>{var x;(x=navigator.clipboard)==null||x.writeText(d).then(()=>n(t.exportCopied))},c=[{def:t.exportCsv,value:r,href:r},{def:t.exportSheet,value:i},{def:t.exportLive,value:o,href:o},{def:t.exportXlsx,value:l,href:l}];return e.jsxs(le,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),e.jsx("div",{className:"expl",children:c.map(({def:d,value:x,href:s})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:d[0]}),e.jsxs("div",{children:[e.jsx("b",{children:d[1]}),e.jsx("p",{children:d[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>p(x),children:t.exportCopy}),s&&e.jsx("a",{className:"exb",href:s,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},d[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function yr(){const{t,token:a,flash:n,mode:r}=E(),[o,l]=f.useState(null),[i,p]=f.useState(""),c=r==="client";f.useEffect(()=>{let s=!0;return tt(a).then(y=>{s&&y&&l(y)}),()=>{s=!1}},[a]);const d=(s,y)=>{c&&tt(a,s).then(b=>{b&&b.ok!==!1&&(n(y),l({configured:!s.remove&&(s.url?!0:o==null?void 0:o.configured),url_hint:b.url_hint}))})},x='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(le,{title:t.plugTitle,icon:"🔌",children:[e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.plugWebhook}),e.jsxs("p",{children:[t.plugWebhookHint,o!=null&&o.configured?` — ${t.plugConfigured}${o.url_hint?` (${o.url_hint})`:""}`:""]}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:"https://…",value:i,onChange:s=>p(s.target.value),disabled:!c}),e.jsx("button",{type:"button",className:"abtn p",disabled:!c||!i.trim(),onClick:()=>d({url:i.trim()},t.alertSaved),children:t.plugSave}),e.jsx("button",{type:"button",className:"abtn",disabled:!c||!(o!=null&&o.configured),onClick:()=>d({test:!0},t.plugTest+" ✓"),children:t.plugTest}),e.jsx("button",{type:"button",className:"abtn",disabled:!c||!(o!=null&&o.configured),onClick:()=>d({remove:!0},t.plugRemove+" ✓"),children:t.plugRemove})]})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.plugMcp}),e.jsx("p",{children:t.plugMcpHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{readOnly:!0,value:x}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var s;(s=navigator.clipboard)==null||s.writeText(x).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function wr(){const{t,data:a,lang:n}=E(),r=a.credits,o=a.email,l=async i=>{if(!o)return;const p=window.location.href.split("?")[0];try{const d=await(await fetch(`${Pe}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:i,success_url:p+"?credits=ok",cancel_url:p+"?credits=cancel"})})).json();d.url&&(window.location.href=d.url)}catch{}};return e.jsxs(le,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(i=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(i.credits,i.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{l(i.lookup_key)},children:t.rechargeBuy})]},i.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function kr(){const{t,data:a,dossiers:n}=E(),r=n.filter(l=>l.kind==="target"&&Q(l)).length,o=a.marketEstimate||0;return e.jsx(le,{title:t.coverTitle,icon:"🌍",children:o>0?e.jsx("p",{dangerouslySetInnerHTML:{__html:t.coverBody(r,o)}}):e.jsx("p",{children:t.coverScreened(r)})})}function jr(){var u,N,j;const{t,dossiers:a,token:n,mode:r,flash:o,criteria:l}=E(),i=r==="client",p=f.useMemo(()=>{const k=new Set;return a.forEach(C=>{C.angle&&k.add(C.angle)}),[...k]},[a]),[c,d]=f.useState(null);f.useEffect(()=>{let k=!0;return Zt(n).then(C=>{k&&d(C.thumbs)}),()=>{k=!1}},[n]);const[x,s]=f.useState(""),[y,b]=f.useState(""),[g,w]=f.useState(!1),m=async()=>{const k=x.trim();if(!(!k||g||!i)){w(!0),b("");try{const M=await(await fetch(`${je}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:k,who:"atelier2"})})).json().catch(()=>({}));if(M.reply&&b(String(M.reply)),M.job_id){b(t.critChatRunning);const D=async()=>{const v=await fetch(`${je}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:M.job_id})}).then(S=>S.json()).catch(()=>null);if(v&&v.done){b(String(v.reply||v.clarification||v.summary||"✓")),w(!1),v.applied&&o(t.alertSaved);return}setTimeout(()=>{D()},8e3)};setTimeout(()=>{D()},8e3),s("");return}s("")}finally{y.startsWith("⏳")||w(!1)}}};return e.jsxs(le,{title:t.critTitle,icon:"⚙",wide:!0,children:[(l==null?void 0:l.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:l.lead}),!!((u=l.points)!=null&&u.length)&&e.jsx("ul",{className:"critpts",children:l.points.map(k=>e.jsx("li",{children:k},k))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((N=l==null?void 0:l.angles)!=null&&N.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:l.method||t.critProfilsSub}),l.angles.map(k=>{var C,M;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:k.title}),k.why&&e.jsx("p",{className:"why",children:k.why}),e.jsxs("div",{className:"lo",children:[!!((C=k.look)!=null&&C.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:k.look.map(D=>e.jsx("li",{children:D},D))})]}),!!((M=k.out)!=null&&M.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:k.out.map(D=>e.jsx("li",{children:D},D))})]})]})]},k.title)})]}),!!((j=l==null?void 0:l.gate)!=null&&j.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),l.gate.length===1&&!l.gate[0].k?e.jsx("p",{className:"gate1",children:l.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:l.gate.map(k=>e.jsxs("li",{children:[k.k&&e.jsx("b",{children:k.k}),k.t]},k.t))})]}),p.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:p.map(k=>e.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:x,disabled:!i||g,onChange:k=>s(k.target.value),onKeyDown:k=>{k.key==="Enter"&&m()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(g?" loading":""),style:{padding:"12px 18px"},disabled:!i||g||!x.trim(),onClick:()=>void m(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),y&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:y})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),c===null?e.jsx("div",{className:"sp-empty",children:"…"}):c.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:c.slice(0,12).map((k,C)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:k.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:k.company}),e.jsx("span",{className:"qd",children:(k.ts||"").slice(0,10)})]},C))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([k,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(jt[k]||"v-cons"),children:k}),e.jsx("span",{children:C})]},k))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([k,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:k}),e.jsxs("span",{children:["← ",C]})]},k))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function Nr(){const{t}=E();return e.jsx(le,{title:t.tutoTitle,icon:"▶",children:e.jsx("ol",{className:"steps2",children:t.tutoSteps.map(([a,n],r)=>e.jsxs("li",{children:[e.jsx("b",{children:a}),e.jsx("span",{children:n})]},r))})})}const Nt=f.createContext(null),E=()=>{const t=f.useContext(Nt);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function ve({o:t,lg:a}){const{lang:n}=E(),r=Y(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:nt(r,n),children:[r.emoji," ",nt(r,n)]}):null}function Oe({o:t,src:a}){const{lang:n,t:r}=E(),o=Y(t);if(!o)return null;const l=na(o),i=oa(o);return e.jsxs("em",{className:"sigwin"+(i?" hot":""),title:r.signaledOn(bt(o,n))+" · "+r.win7(vt(o,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(p,c)=>e.jsx("i",{className:c<l?"on":""},c))}),e.jsx("span",{className:"lb",children:i?r.lastDay:r.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&e.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:p=>p.stopPropagation(),children:"↗"})]})}function Ct({o:t}){const{lang:a}=E(),n=ra(t.cc),r=t.cc?be(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const ut="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap";function Ar({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:o,onFiltersChange:l}){const{lang:i}=ea(),p=fa[i],c=Na(t,i,a),[d,x]=f.useReducer(Sa,void 0,()=>Ca((r==null?void 0:r.continent)??"europe",t,{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),s=f.useRef(l);s.current=l,f.useEffect(()=>{var h;(h=s.current)==null||h.call(s,d.filters)},[d.filters]);const[y,b]=f.useState(null),[g,w]=f.useState(null),[m,u]=f.useState({kept:0,dropped:0}),[N,j]=f.useState(!1),[k,C]=f.useState(""),[M,D]=f.useState(!1),[v,S]=f.useState(null),[,F]=f.useState(0),A=()=>F(h=>h+1),L=f.useRef([]),P=f.useRef(new Set),O=f.useRef(new Set),q=f.useRef(new Map),I=f.useRef(null),{mode:H}=c,B=f.useMemo(()=>o?{...c.caps,...o}:c.caps,[c.caps,o]),Z=B.pipe,U=c.session.token||"",G=H==="client"&&!t;f.useEffect(()=>{if(document.querySelector(`link[href="${ut}"]`))return;const h=document.createElement("link");h.rel="stylesheet",h.href=ut,document.head.appendChild(h)},[]);const R=(h,z=!1)=>{C(h),D(z),I.current&&clearTimeout(I.current),I.current=setTimeout(()=>C(""),z?4200:2400)},W=h=>R(h,!0),$=f.useMemo(()=>{const h=new Map;return c.dossiers.forEach(z=>{z.id&&h.set(z.id,z)}),h},[c.dossiers]),ie=f.useMemo(()=>c.dossiers.filter(h=>wt(h,d,Z)),[c.dossiers,d,Z]),ae=f.useMemo(()=>c.dossiers.filter(h=>za(h,d,Z,c.favIds)),[c.dossiers,d,Z,c.favIds]),re=f.useMemo(()=>ta(ie,c.favIds),[ie,c.favIds]),ee=Ue.find(h=>h.key===d.continent),X=i==="fr"?ee.fr:ee.en,K=(h,z)=>{const T=((h==null?void 0:h.name)||z||"").trim();if(!G){w({kicker:T});return}!T||N||(j(!0),(async()=>{try{const V=await ht(U,T,"atelier2"),Ce={name:V.company||T,verdict:V.verdict,reason:V.reason||"",remaining:V.remaining??null};L.current=[Ce,...L.current].slice(0,8),V.verdict==="kept"&&u(ue=>({...ue,kept:ue.kept+1})),V.verdict==="ruled_out"&&u(ue=>({...ue,dropped:ue.dropped+1}));const we=h||c.dossiers.find(ue=>(ue.name||"").toLowerCase()===T.toLowerCase());we&&(V.verdict==="kept"?we.verdict=we.verdict||"MATCH":V.verdict==="ruled_out"&&(we.verdict="NO MATCH"),V.reason&&(we.reasoning=V.reason)),A()}finally{j(!1)}})())},ye=h=>{if(!G){w({kicker:h.name});return}P.current.add(h.id),ke(U,"fast_request",h.name||"",""),R(p.memoInstantSent(h.name)),A()},_=h=>q.current.get(h.id)??c.thumbs.get((h.name||"").trim().toLowerCase()),ne=(h,z)=>x({type:"undoPush",entry:{id:h.id,name:h.name,prevCeoStatus:z}}),oe=async(h,z,T)=>{const V=h.ceoStatus||"";h.ceoStatus=z,A();const Ce=await Re(U,{status:z,airtable_id:h.airtableId,check_id:h.checkId,company:h.name,...(T==null?void 0:T.note)!==void 0?{note:T.note}:{},...T!=null&&T.via?{via:T.via}:{}});return Ce.ok?Ce.skipped?(h.ceoStatus=V,A(),W(p.actNotPersisted),!1):((T==null?void 0:T.undo)!==!1&&ne(h,V),T!=null&&T.msg&&R(T.msg),(z==="Validé"||z==="Écarté")&&!h.ceoNote&&(T==null?void 0:T.note)===void 0&&S({o:h,yes:z==="Validé"}),!0):(h.ceoStatus=V,A(),W(p.actErr),!1)},xe=async(h,z)=>{const T=await Re(U,{status:h.ceoStatus||"Retenu",airtable_id:h.airtableId,check_id:h.checkId,company:h.name,note:z,via:"note"});return!T.ok||T.skipped?(W(T.skipped?p.actNotPersisted:p.actErr),!1):(h.ceoNote=z,A(),!0)},de=f.useRef(new Map),te=h=>de.current.has(h.id)?de.current.get(h.id):c.stages.get((h.name||"").trim().toLowerCase()),Fe=(h,z)=>{de.current.set(h.id,z),A()},Ne=(h,z)=>{G&&oe(h,z?"Validé":"Écarté",{msg:z?p.decidedYes(h.name):p.decidedNo(h.name)})},pe=h=>{G&&oe(h,"À trancher",{msg:p.promoted(h.name)})},me=h=>{G&&(async()=>{const z=h.ceoStatus||"";h.ceoStatus="Retenu",A();const T=await Re(U,{status:"Retenu",check_id:h.checkId,company:h.name});if(!T.ok||T.skipped){h.ceoStatus=z,A(),W(T.skipped?p.actNotPersisted:p.actErr);return}ne(h,z),R(p.repeched(h.name))})()},St=()=>{const h=d.undo[d.undo.length-1];if(!h){R(p.undoNone);return}const z=$.get(h.id);if(!z){x({type:"undoPop"}),R(p.undoNone);return}let T=h.prevCeoStatus;if(!T)if((z.verdict||"").toUpperCase().includes("CALL"))T="À trancher";else{R(p.undoLockedTitle);return}(async()=>await oe(z,T,{undo:!1})&&(x({type:"undoPop"}),z.ceoStatus=h.prevCeoStatus,A(),R(p.undoDone(z.name))))()},zt=h=>{G&&(O.current.add(h.id),A(),(async()=>{const z=await la(U,h.name,"email");if(!z||z.ok===!1){O.current.delete(h.id),A(),W(p.actErr);return}ke(U,"approach",h.name||"",""),R(p.actApproachSent)})())},Et=(h,z)=>{G&&(async()=>{if(!(await ke(U,z?"yes":"no",h.name||"","")).ok){W(p.actErr);return}q.current.set(h.id,z?"yes":"no"),A(),R(z?p.thumbUpDone:p.thumbDnDone)})()},At=h=>{!G||!_e(h)||(ke(U,"detailed_request",h.name||"",""),R(p.memoDeepSent(h.name)))},Tt=h=>{const z=new Set(c.favIds),T=z.has(h.id);T?z.delete(h.id):z.add(h.id),c.setFavIds(z),G&&ia(U,{id:h.id,co:h.name},T)},Ot=()=>{G&&(sa(U),R(p.identSyncDone))},Ge=/proplace/i.test(c.fund||""),Ft=h=>{!G||!Ge||(ke(U,"onboard_request",h.name||"",""),R(p.onboardSent(h.name)))},Lt={st:d,dispatch:x,t:p,lang:i,mode:H,caps:B,pipe:Z,token:U,fund:c.fund,email:c.email,criteria:c.criteria,data:c,doRepeche:me,thumbOf:_,canWrite:G,commitStatus:oe,saveNote:xe,stageOf:te,setStage:Fe,flashErr:W,dossiers:c.dossiers,scopedAll:ie,scoped:ae,counts:re,byId:$,contName:X,favIds:c.favIds,toggleFav:Tt,askEvaluate:K,doAnalyse:ye,doDecide:Ne,doPromote:pe,doApproach:zt,doThumb:Et,doDeep:At,doUndo:St,doSync:Ot,doOnboard:Ft,outbound:Ge,memoQueued:P.current,approachDone:O.current,sessTally:m,evalCards:L.current,evalBusy:N,markRow:b,markedId:y,flash:R};return f.useEffect(()=>{const h=z=>{z.key==="Escape"&&(x({type:"popup",id:null}),x({type:"modal",modal:null}),x({type:"openFacet",facet:null}))};return window.addEventListener("keydown",h),()=>window.removeEventListener("keydown",h)},[]),e.jsx(Nt.Provider,{value:Lt,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:ga}),e.jsxs("div",{className:"app"+(Z?" pipe":""),children:[B.showTicker&&e.jsx(Ea,{}),B.showIdent&&e.jsx(Ua,{}),B.showOnb&&e.jsx(_a,{}),e.jsx(Ba,{}),B.showFunnel&&e.jsx(Cr,{}),B.showFunnel&&e.jsx(Ha,{}),B.showFunnel&&e.jsx(Ya,{}),e.jsxs("div",{className:"fzone",children:[e.jsx(Sr,{}),e.jsxs("div",{className:"stage"+(d.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(Wa,{}),e.jsx(Ka,{})]})]}),B.showDemand&&e.jsx(Ja,{}),B.showDemand&&d.memoConsole&&e.jsx(Za,{}),e.jsx(ir,{}),c.loading&&e.jsx("div",{className:"void",children:p.loadingV2}),c.error&&!c.loading&&e.jsxs("div",{className:"void",children:[p.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:p.retry})]})]}),B.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:p.lockbarText}),e.jsx("button",{type:"button",onClick:()=>x({type:"modal",modal:"rdv"}),children:p.lockbarCta})]}),d.popupId&&e.jsx(pr,{}),e.jsx(cr,{}),e.jsx(La,{}),v&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:v.o.name}),e.jsx(Ia,{placeholder:v.yes?p.whyYesPh:p.whyNoPh,onDone:h=>{const z=v.o;S(null),h&&xe(z,h).then(T=>{T&&R(p.csNoteSaved)})}})]}),k&&e.jsx("div",{className:"flash on"+(M?" err":""),children:k}),g&&e.jsx(aa,{variant:"acquirer",initialCompany:ft().co,initialWebsite:ft().site,onClose:()=>w(null)})]})})}function Cr(){const{t}=E(),[a,n]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Sr(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:o,t:l}=E(),i=f.useMemo(()=>{const p={};return t.forEach(c=>{c.continent&&He(c,a.filters,r)&&(p[c.continent]=(p[c.continent]||0)+1)}),p},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[da.map(p=>{const c=Ue.find(d=>d.key===p);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===p,onClick:()=>n({type:"continent",key:p}),children:[o==="fr"?c.fr:c.en,e.jsx("span",{className:"n",children:i[p]||0})]},p)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?l.showMap:l.hideMap})})]})}function ft(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function zr(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{Ct as FlagCell,ve as SigBadge,Oe as SigWin,Ar as default,zr as fmtShort,E as useV2};
