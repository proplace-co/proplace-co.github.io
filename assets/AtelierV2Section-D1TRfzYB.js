...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,Po=qo+Fo;function da(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Do(){const e=da("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Io(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Do();return r==="0"?"client":r==="1"||da("embed")==="1"&&da("chrome")==="1"?"apercu":"client"}const Bo={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},$o=e=>Bo[e],Ye=e=>(e.noCo===void 0&&!Fn((e.name||"").trim())&&(e.noCo=!0),Object.assign(e,{continent:Ir(e.cc)}));function Xt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const _o=60*60*1e3;function Uo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>_o?null:a}catch{return null}}function St(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Vo=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ho(e,a,r="default"){const n=r!=="default",i=h.useMemo(()=>e||n?{mode:"anon"}:Tr(),[e,n]),o=h.useMemo(()=>n?"visiteur":Io(e,i),[e,i,n]),l=h.useMemo(()=>$o(o),[o]),s=o!=="visiteur",p=Vo(r),[g,c]=h.useState([]),[d,u]=h.useState(""),[x,f]=h.useState(null),[b,v]=h.useState(null),[m,y]=h.useState(null),[j,w]=h.useState(()=>new Map),[E,A]=h.useState(()=>new Map),[R,$]=h.useState(""),[C,M]=h.useState(new Set),[O,L]=h.useState(null),[_,k]=h.useState(!0),[N,T]=h.useState(!1),[H,G]=h.useState(0),[Z,z]=h.useState(0),q=h.useRef(0),I=h.useMemo(()=>{var D;if(o!=="client")return"";try{return((D=Lr())==null?void 0:D.email)||""}catch{return""}},[o]);h.useEffect(()=>{const D=++q.current;let U=!0;const W=()=>U&&D===q.current,X=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),re=Uo(X);return re?(c(re.objs.map(Ye)),re.fund&&u(re.fund),f(re.marketEstimate??null),v(re.criteria??null),y(re.stats??null),$(re.generatedAt||""),k(!1)):k(!0),(async()=>{try{if(r==="ops"){const ue=await Kt(),ce=((ue==null?void 0:ue.recent_ops)||[]).map(Q=>{const te=Qt(Q.company_name||Q.title?Q:{...Q,title:(Q.headline_fr||Q.headline||"").slice(0,120)},a),be=String(Q.rubrique||"").toLowerCase();return te&&(be==="nominations"||be==="recrutements")&&(te.engine=be),te&&!String(Q.company_name||"").trim()&&(te.noCo=!0),te}).filter(Q=>!!Q).map(Q=>(Fn((Q.name||"").trim())||(Q.noCo=!0),Q));try{const Q=await Rr(),te=Mr(Q),be=((Q==null?void 0:Q.date)||"").slice(0,10);if(te.length&&be){const K=new Set;for(const se of ce){if(se.noCo||(se.date||"").slice(0,10)!==be)continue;const ee=Ia(te,K,se.name,"");ee>=0&&(K.add(ee),se.decryptHtml=te[ee].html)}for(const se of ce){if(se.decryptHtml||(se.date||"").slice(0,10)!==be)continue;const ee=Ia(te,K,"",se.headline||se.tagline||se.name);ee>=0&&(K.add(ee),se.decryptHtml=te[ee].html)}}}catch{}if(!W())return;c(ce.map(Ye)),St(X,{objs:ce})}else if(typeof r=="object"){const ce=(await Ba()||[]).filter(te=>(te.slug||"")===r.research).map(te=>$a(te,a)).filter(te=>!!te),Q=Xt(await _a(ce,a));if(!W())return;c(Q.map(Ye)),St(X,{objs:Q})}else if(s&&i.token){const ue=Or(i.token),ce=Kt(),Q=qr(i.token),te=Fr(i.token),be=Pr(i.token),K=await ue;let se=K?K.targets:[];W()&&K&&(u(K.fund||""),f(K.marketEstimate??null),v(K.criteria??null),y(K.stats??null),$(K.generatedAt||""),c(se.map(Ye)),k(!1),T(!1));const[ee,Ue,fe,xe]=await Promise.all([ce,Q,te,be]),Ie=((ee==null?void 0:ee.recent_ops)||[]).map(Se=>Qt(Se,a)).filter(Se=>!!Se);if(se=[...se,...Ie],!W())return;c(se.map(Ye));const He=new Set;for(const Se of Ue){const Be=(Se.id||Se.co||"").toString().trim().toLowerCase();Be&&He.add(Be.startsWith("t:")?Be:"t:"+Be)}M(He),w(fe),A(xe),K&&St(X,{fund:K.fund,marketEstimate:K.marketEstimate,criteria:K.criteria,stats:K.stats,generatedAt:K.generatedAt,objs:se})}else{const ue=Dr(),ce=Ba(),Q=Kt(),te=await ue;W()&&te.length&&(c(Xt(te).map(Ye)),k(!1),T(!1));const[be,K]=await Promise.all([ce,Q]),se=(be||[]).map(xe=>$a(xe,a)).filter(xe=>!!xe),ee=await _a(se,a),Ue=((K==null?void 0:K.recent_ops)||[]).map(xe=>Qt(xe,a)).filter(xe=>!!xe),fe=Xt([...te,...ee,...Ue]);if(!W())return;c(fe.map(Ye)),St(X,{objs:fe})}W()&&T(!1)}catch{W()&&!re&&T(!0)}finally{W()&&k(!1)}})(),()=>{U=!1}},[s,i.token,a,H,p]),h.useEffect(()=>{if(!l.showCredits||!I){L(null);return}let D=!0;return(async()=>{try{const U=await fetch(`${Ca}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:I})});if(!U.ok)return;const W=await U.json();D&&W&&W.ok!==!1&&L(W)}catch{}})(),()=>{D=!1}},[l.showCredits,I,Z]);const P=h.useCallback(D=>M(new Set(D)),[]);return{session:i,mode:o,caps:l,fund:d,email:I,marketEstimate:x,generatedAt:R,criteria:b,stats:m,thumbs:j,stages:E,dossiers:g,favIds:C,setFavIds:P,credits:O,reloadCredits:()=>z(D=>D+1),loading:_,error:N,refresh:()=>G(D=>D+1)}}const _n=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Yo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{..._n(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Wo(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:_n(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Un)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Un=40;function Ta(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ea(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ot(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ge(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Vn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ta(e,a.filters,r)}function Go(e,a,r,n){return!(!Vn(e,a,r)||r&&!Br(e,a.ptab,n))}function La(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ot(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=me(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const Ko=["ma","levees","nominations","recrutements","actualites"],Qo=300,Zt=7,Jo={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Hn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Xo=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ja(e){const a=me(e);if(a)return"sig:"+(a.theme&&Hn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Zo(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=F(),s=l==="en",[p,g]=h.useState("all"),[c,d]=h.useState(!1),u=h.useMemo(()=>{const C=(a.filters.day||"").slice(0,10),M=k=>!(!o&&a.continent!=="monde"&&k.continent!==a.continent||C&&(k.date||"").slice(0,10)!==C),O=e.filter(k=>M(k)&&me(k)),L=e.filter(k=>M(k)&&k.kind==="op"&&!me(k)&&(C?!0:ot(k.date)<=Zt)),_=C||new Date().toISOString().slice(0,10);return L.sort((k,N)=>{const T=(k.date||"").slice(0,10)===_?0:1,H=(N.date||"").slice(0,10)===_?0:1;return T!==H?T-H:(N.amountEur||0)-(k.amountEur||0)}),[...La(O,{key:"signal",dir:-1}),...L]},[e,a.continent,a.filters.day,o]),x=h.useMemo(()=>{const C={};for(const M of u){const O=Ja(M);C[O]=(C[O]||0)+1}return C},[u]),f=h.useMemo(()=>p==="all"?u:u.filter(C=>Ja(C)===p),[u,p]),b=h.useMemo(()=>f.slice(0,Qo),[f]),v=f.length-b.length,m=C=>C==="all"?u.length:x[C]||0,y=C=>C==="all"?s?"All":"Tout":C.startsWith("sig:")?Hn[s?"en":"fr"][C.slice(4)]||"🔔":Jo[s?"en":"fr"][C],j=[{k:"all"}],w=Ko.filter(C=>m(C)>0||C===p);if(w.length){j.push({g:s?"DEALS":"OPÉRATIONS"});for(const C of w)j.push({k:C})}const E=Xo.map(C=>"sig:"+C).filter(C=>m(C)>0||C===p);if(E.length){j.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const C of E)j.push({k:C})}const A=C=>{try{return new Date(C+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return C}},R=(()=>{const C=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?s?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return C?(s?`LIVE covers the events of ${A(C)}.`:`Le LIVE regroupe les événements du ${A(C)}.`)+M:(s?`LIVE covers the still-open signals and the deals of the last ${Zt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Zt} derniers jours.`)+M})(),$=C=>b.map(M=>t.jsxs("button",{type:"button",className:"tk"+(Ae(M)?" spent":""),onClick:O=>{const L=O.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:L.left+L.width/2,y:L.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(Xe,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(yr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Ml(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(Ht,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},C+(M.id||M.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},C+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:C=>{C.currentTarget.contains(C.relatedTarget)||d(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":c,onClick:()=>d(C=>!C),children:[y(p),t.jsx("b",{children:m(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!c,children:[t.jsx("span",{className:"tkfilscope",children:R}),j.map(C=>"g"in C?t.jsx("span",{className:"tkfilg",children:C.g},C.g):t.jsxs("button",{type:"button","aria-pressed":C.k===p,onClick:()=>{g(C.k),d(!1)},children:[y(C.k),t.jsx("b",{children:m(C.k)})]},C.k))]})]}),t.jsx("div",{className:"win",children:b.length?t.jsxs("div",{className:"run",children:[$(0),$(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const ei="aDx8z7Hzksus",Yn="+33 6 83 10 72 86",Xa="alexandre@proplace.co",ti=`tel:${Yn.replace(/[^\d+]/g,"")}`,Za="pp-rdv-slot";function ai(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ni(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:oi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:ti,children:Yn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Xa}`,children:Xa})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Lo,{filloutId:ei,parameters:r?{company_name:r}:void 0})})]})}function ri(){const[e,a]=h.useState(()=>typeof document>"u"?null:document.getElementById(Za));return h.useEffect(()=>{e||a(document.getElementById(Za))},[e]),e?it.createPortal(t.jsx(ni,{}),e):null}const oi=`
